...
`,er={genres:[],providerIds:[],decades:[]},en=document.getElementById("root");if(!en)throw Error("Root element #root not found");(0,n.createRoot)(en).render((0,o.jsx)(function({topBarRight:e,apiKey:t}){let[i]=(0,d.xc)();(0,$.zJ)(i.ageMode);let[n,a]=(0,r.useState)(()=>z(t)),[l,s]=(0,r.useState)("discover"),[c,p]=(0,r.useState)(er),[g,x]=(0,r.useState)(!1),[m,u]=(0,r.useState)([]),[M,R]=(0,r.useState)([]),[en,ea]=(0,r.useState)(0),[el,es]=(0,r.useState)(null),ed=(0,r.useCallback)(e=>{e&&(history.pushState({movieDetail:!0},""),(0,d.VF)("movies",{hash:`#/movies?id=${e.id}&type=${e.media_type}`,label:(0,$.rS)(e),icon:"tv"===e.media_type?"\uD83D\uDCFA":"\uD83C\uDFAC",color:"tv"===e.media_type?"#3b82f6":"#f59e0b"})),es(e)},[]);(0,r.useEffect)(()=>{let e=()=>{el&&es(null)};return window.addEventListener("popstate",e),()=>window.removeEventListener("popstate",e)},[el]);let ec=(0,d.fy)(),ep=(0,r.useRef)(null),[eg,ex]=(0,r.useState)(!1),em=ec.id,eu=ec.type,eh=!!em&&("movie"===eu||"tv"===eu),ef=eh&&!el&&!eg;(0,r.useEffect)(()=>{if(!n||!eh)return;let e=`${eu}:${em}`;ep.current!==e&&(ep.current=e,ex(!1),(async()=>{try{let e=await (0,$.Ug)(n,eu,Number(em));ed({...e,genre_ids:e.genres?.map(e=>e.id)??[]})}catch{ex(!0)}})())},[n,eh,em,eu,ed]);let eb=ec.tab,ew=(0,r.useRef)(null);(0,r.useEffect)(()=>{!eb||eh||ew.current===eb||["discover","movies","tv","documentaries","favorites","seen"].includes(eb)&&(ew.current=eb,s(eb))},[eb,eh]);let[ev,ey]=(0,r.useState)(0),[ek,ej]=(0,r.useState)(""),[e$,eS]=(0,r.useState)([]),[eT,eM]=(0,r.useState)(!1),ez=(0,r.useRef)(),eC=(0,r.useRef)(),eR=(0,r.useCallback)(()=>ey(e=>e+1),[]);(0,r.useEffect)(()=>{a(z(t))},[t]),(0,r.useEffect)(()=>{if(!(M.length<2))return eC.current=setInterval(()=>{ea(e=>(e+1)%M.length)},7e3),()=>clearInterval(eC.current)},[M.length]),(0,r.useEffect)(()=>{if(n){if(clearTimeout(ez.current),!ek.trim())return void eS([]);eM(!0),ez.current=setTimeout(async()=>{try{let e=await (0,$.$P)(n,ek.trim());eS(e)}catch{eS([])}finally{eM(!1)}},380)}},[n,ek]);let eI=c.genres.length>0||c.providerIds.length>0||c.decades.length>0,e_=(0,r.useCallback)(async(e,t,i)=>{if("favorites"===t)return void u([{title:"My Favorites",items:(0,S.qx)(),loading:!1}]);if("seen"===t)return void u([{title:"Recently Seen",items:(0,S.GB)(),loading:!1}]);if(i.genres.length>0||i.providerIds.length>0||i.decades.length>0){let o="movies"===t?"movie":"tv"===t?"tv":"documentaries"===t?"movie":"all",r="documentaries"===t?[...i.genres,99]:i.genres,n=r.length>0?r:[28,35,18,878,27,10749,53,16];u(n.map(e=>({title:$.N2[e]??"Other",items:[],loading:!0})));let a=await Promise.all(n.map(t=>(0,$.NE)(e,o,{...i,genres:[t]}))),l=n.map((e,t)=>({title:$.N2[e]??"Other",items:a[t]??[],loading:!1})).filter(e=>e.items.length>0);u(l.length>0?l:[{title:"No Results",items:[],loading:!1}]);return}if("documentaries"===t){u([{title:"Documentaries",items:[],loading:!0}]),u([{title:"Documentaries",items:await (0,$.ag)(e),loading:!1}]);return}if("movies"===t){u([{title:"Popular Movies",items:[],loading:!0},{title:"Top Rated Movies",items:[],loading:!0}]);let[t,i]=await Promise.all([(0,$.Zy)(e),(0,$.Kk)(e,"movie")]);u([{title:"Popular Movies",items:t,loading:!1},{title:"Top Rated Movies",items:i,loading:!1}]);return}if("tv"===t){u([{title:"Popular TV Shows",items:[],loading:!0},{title:"Top Rated TV Shows",items:[],loading:!0}]);let[t,i]=await Promise.all([(0,$.eN)(e),(0,$.Kk)(e,"tv")]);u([{title:"Popular TV Shows",items:t,loading:!1},{title:"Top Rated TV Shows",items:i,loading:!1}]);return}let o=function(e,t=2){let i={};for(let t of e)for(let e of t.genre_ids??[])i[e]=(i[e]??0)+1;return Object.entries(i).sort((e,t)=>Number(t[1])-Number(e[1])).slice(0,t).map(([e])=>Number(e))}([...(0,S.qx)(),...(0,S.GB)()],2);u([{title:"Trending This Week",loading:!0,items:[]},{title:"Popular Movies",loading:!0,items:[]},{title:"Popular TV Shows",loading:!0,items:[]},{title:"Top Rated Movies",loading:!0,items:[]},{title:"Documentaries",loading:!0,items:[]},...o.map(e=>({title:`More ${$.N2[e]??"Great"} Content`,loading:!0,items:[]}))]);let[r,n,a,l,s,...d]=await Promise.all([(0,$._F)(e),(0,$.Zy)(e),(0,$.eN)(e),(0,$.Kk)(e,"movie"),(0,$.ag)(e),...o.map(t=>(0,$.NE)(e,"all",{genres:[t],providerIds:[],decades:[]}))]);R(r.filter(e=>e.backdrop_path).slice(0,5)),ea(0),u([{title:"Trending This Week",items:r,loading:!1},{title:"Popular Movies",items:n,loading:!1},{title:"Popular TV Shows",items:a,loading:!1},{title:"Top Rated Movies",items:l,loading:!1},{title:"Documentaries",items:s,loading:!1},...o.map((e,t)=>({title:`More ${$.N2[e]??"Great"} Content`,items:d[t]??[],loading:!1}))])},[]);(0,r.useEffect)(()=>{!n||ef||("discover"!==l&&R([]),e_(n,l,c).catch(()=>{}))},[n,l,c,e_,ev,i.ageMode,ef]);let eN=(0,r.useCallback)(e=>{s(e),ej("")},[]),eE=(0,r.useCallback)(e=>{p(e)},[]),eP=ek.trim().length>0,eF=M[en]??null,eB=("favorites"===l||"seen"===l)&&!m[0]?.loading&&m[0]?.items.length===0,eA=c.genres.length+c.providerIds.length+c.decades.length;if(!n)return(0,o.jsx)(v.H,{onSave:e=>{try{localStorage.setItem(T,e)}catch{}a(e)}});let eD=(0,o.jsxs)(Z,{children:[(0,o.jsx)(h.A,{size:14,color:d.w4.colors.mainTextMuted}),(0,o.jsx)(H,{placeholder:"Search…",value:ek,onChange:e=>ej(e.target.value)}),ek&&(0,o.jsx)(J,{onClick:()=>ej(""),"aria-label":"Clear",children:(0,o.jsx)(f.A,{size:13})})]});if(ef)return(0,o.jsx)(d.PE,{title:"Movies & Series",sidebar:null,topBarRight:e,children:(0,o.jsx)("div",{style:{flex:1,display:"flex",alignItems:"center",justifyContent:"center",color:d.w4.colors.mainTextMuted,fontFamily:d.w4.typography.fontFamily,fontSize:d.w4.typography.fontSizeSm},children:"Loading…"})});if(el){let t=(0,o.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:8},children:[(0,o.jsxs)("button",{onClick:()=>history.back(),title:"Back",style:{display:"flex",alignItems:"center",gap:6,padding:"5px 14px",background:"none",border:`1px solid ${d.w4.colors.border}`,borderRadius:d.w4.borderRadius.md,color:d.w4.colors.sidebarTextMuted,cursor:"pointer",fontSize:d.w4.typography.fontSizeSm,fontFamily:d.w4.typography.fontFamily,fontWeight:500,transition:"color 0.15s, border-color 0.15s"},onMouseEnter:e=>{e.currentTarget.style.color=d.w4.colors.mainText,e.currentTarget.style.borderColor=d.w4.colors.mainText},onMouseLeave:e=>{e.currentTarget.style.color=d.w4.colors.sidebarTextMuted,e.currentTarget.style.borderColor=d.w4.colors.border},children:[(0,o.jsx)(b.A,{size:14})," Back"]}),e]});return(0,o.jsx)(d.PE,{title:(0,$.rS)(el),sidebar:null,topBarRight:t,children:(0,o.jsx)(k.P,{item:el,apiKey:n,onBack:()=>history.back(),onLibraryChange:eR,onSelect:ed})})}return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(d.PE,{title:"Movies & Series",sidebar:null,topBarRight:(0,o.jsxs)(o.Fragment,{children:[eD,e]}),children:(0,o.jsxs)(I,{children:[(0,o.jsxs)(O,{children:[C.map(({id:e,label:t,Icon:i})=>(0,o.jsxs)(U,{active:l===e,onClick:()=>eN(e),children:[(0,o.jsx)(i,{size:14}),t]},e)),(0,o.jsx)(W,{children:(0,o.jsxs)(q,{hasFilters:eA>0,onClick:()=>x(!0),children:[(0,o.jsx)(w.A,{size:13}),"Filter",eA>0&&(0,o.jsx)(Y,{children:eA})]})})]}),eP?(0,o.jsxs)(Q,{children:[(0,o.jsx)(X,{children:(0,o.jsx)(ee,{children:eT?"Searching…":e$.length>0?`Results for "${ek}"`:`No results for "${ek}"`})}),eT||0!==e$.length?(0,o.jsx)(y.U,{title:"",items:e$,loading:eT,onSelect:ed}):(0,o.jsxs)(et,{children:[(0,o.jsx)("span",{style:{fontSize:44},children:"\uD83D\uDD0D"}),"Nothing found — try a different title"]})]}):(0,o.jsxs)(Q,{children:["discover"===l&&eF&&!eI&&(0,o.jsx)(_,{children:M.map((e,t)=>{let i=e.backdrop_path?`https://image.tmdb.org/t/p/w1280${e.backdrop_path}`:"";return(0,o.jsx)(N,{src:i,active:t===en,children:(0,o.jsxs)(E,{children:[(0,o.jsx)(P,{kind:e.media_type,children:"movie"===e.media_type?"Film":"TV Show"}),(0,o.jsx)(F,{children:(0,$.rS)(e)}),(0,o.jsxs)(B,{children:[(0,o.jsxs)(A,{children:["★ ",e.vote_average.toFixed(1)]}),(e.release_date||e.first_air_date)&&(0,o.jsx)(D,{children:(e.release_date??e.first_air_date??"").slice(0,4)})]}),e.overview&&(0,o.jsx)(V,{children:e.overview}),(0,o.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:12},children:[(0,o.jsx)(K,{onClick:()=>ed(e),children:"▶ More Info"}),(0,o.jsx)(L,{children:M.map((e,t)=>(0,o.jsx)(G,{active:t===en,onClick:()=>{clearInterval(eC.current),ea(t)}},t))})]})]})},e.id)})}),eI&&(0,o.jsxs)(ei,{children:[(0,o.jsx)("span",{style:{fontSize:12,color:d.w4.colors.mainTextMuted},children:"Active filters:"}),c.genres.map(e=>(0,o.jsx)(eo,{children:$.N2[e]??e},e)),c.providerIds.map(e=>(0,o.jsx)(eo,{children:$.Mw.find(t=>t.id===e)?.name??e},e)),c.decades.map(e=>(0,o.jsx)(eo,{children:e},e)),(0,o.jsx)("button",{style:{background:"none",border:"none",color:d.w4.colors.mainTextMuted,fontSize:11,cursor:"pointer",textDecoration:"underline"},onClick:()=>p(er),children:"Clear all"})]}),"discover"!==l&&(0,o.jsx)(X,{children:(0,o.jsx)(ee,{children:C.find(e=>e.id===l)?.label??""})}),eB?(0,o.jsxs)(et,{children:[(0,o.jsx)("span",{style:{fontSize:44},children:"favorites"===l?"❤️":"\uD83D\uDC41️"}),"favorites"===l?"No favorites yet — open any title and hit ❤️":"No seen titles yet — mark a title as seen to track it here"]}):m.map(e=>(0,o.jsx)(y.U,{title:e.title,items:e.items,loading:e.loading,onSelect:ed},e.title))]},l)]})}),g&&(0,o.jsx)(j.K,{filters:c,onChange:eE,onClose:()=>x(!1)})]})},{}))}}]);