"use strict";(self.webpackChunk_atlantis_ask=self.webpackChunk_atlantis_ask||[]).push([["5170"],{20948(o,e,a){a.d(e,{A:()=>t});let t={"ask.title":{en:"Ask",pt:"Perguntar"},"ask.untitled":{en:"Untitled conversation",pt:"Conversa sem t\xedtulo"},"ask.sidebar.new":{en:"New conversation",pt:"Nova conversa"},"ask.sidebar.empty":{en:"No conversations yet.",pt:"Ainda n\xe3o h\xe1 conversas."},"ask.sidebar.delete":{en:"Delete",pt:"Eliminar"},"ask.sidebar.rename":{en:"Rename",pt:"Renomear"},"ask.group.today":{en:"Today",pt:"Hoje"},"ask.group.yesterday":{en:"Yesterday",pt:"Ontem"},"ask.group.last7":{en:"Last 7 days",pt:"\xdaltimos 7 dias"},"ask.group.older":{en:"Older",pt:"Anteriores"},"ask.welcome.title":{en:"What can I help with?",pt:"Sobre o que te posso ajudar?"},"ask.welcome.kicker":{en:"Ask about code, ideas, summaries…",pt:"Pergunta-me sobre c\xf3digo, ideias, resumos…"},"ask.suggestion.1":{en:"Summarize my tasks for today",pt:"Resume as minhas tarefas de hoje"},"ask.suggestion.1.title":{en:"Summarize tasks",pt:"Resumir tarefas"},"ask.suggestion.1.body":{en:"Get a concise overview of what you need to do today",pt:"Obt\xe9m uma vis\xe3o clara do que precisas de fazer hoje"},"ask.suggestion.2":{en:"Review my code",pt:"Rever o meu c\xf3digo"},"ask.suggestion.2.title":{en:"Code review",pt:"Rever c\xf3digo"},"ask.suggestion.2.body":{en:"Paste code and get a thorough review with suggestions",pt:"Cola c\xf3digo e recebe uma revis\xe3o completa com sugest\xf5es"},"ask.suggestion.3":{en:"Explain how something works",pt:"Explica-me como funciona X"},"ask.suggestion.3.title":{en:"Explain a concept",pt:"Explicar um conceito"},"ask.suggestion.3.body":{en:"Break down complex topics into easy-to-follow steps",pt:"Desdobra temas complexos em passos simples"},"ask.suggestion.4":{en:"Write a haiku about…",pt:"Escreve um haiku sobre…"},"ask.suggestion.4.title":{en:"Creative writing",pt:"Escrita criativa"},"ask.suggestion.4.body":{en:"Poetry, stories, scripts — let imagination flow",pt:"Poesia, hist\xf3rias, gui\xf5es — deixa a imagina\xe7\xe3o fluir"},"ask.placeholder":{en:"Message Atlantis…",pt:"Mensagem para o Atlantis…"},"ask.send":{en:"Send",pt:"Enviar"},"ask.stop":{en:"Stop",pt:"Parar"},"ask.retry":{en:"Retry",pt:"Tentar novamente"},"ask.newConversation":{en:"New conversation",pt:"Nova conversa"},"ask.you":{en:"You",pt:"Voc\xea"},"ask.atlantis":{en:"ATLANTIS",pt:"ATLANTIS"},"ask.thinking":{en:"Thinking…",pt:"A pensar…"},"ask.action.copy":{en:"Copy",pt:"Copiar"},"ask.action.regenerate":{en:"Regenerate",pt:"Regenerar"},"ask.action.edit":{en:"Edit message",pt:"Editar mensagem"},"ask.error.generic":{en:"Something went wrong. Try again.",pt:"Algo correu mal. Tenta novamente."},"ask.noKey.title":{en:"Groq API key not configured",pt:"Chave API Groq n\xe3o configurada"},"ask.noKey.body":{en:"To use Ask, add your Groq API key in Settings.",pt:"Para usar o Perguntar, adiciona a tua chave API Groq nas Defini\xe7\xf5es."},"ask.noKey.cta":{en:"Open Settings",pt:"Abrir Defini\xe7\xf5es"},"ask.settings.title":{en:"Conversation settings",pt:"Defini\xe7\xf5es da conversa"},"ask.settings.tone":{en:"Tone",pt:"Tom"},"ask.settings.tone.friendly":{en:"Friendly",pt:"Simp\xe1tico"},"ask.settings.tone.direct":{en:"Direct",pt:"Direto"},"ask.settings.tone.playful":{en:"Playful",pt:"Divertido"},"ask.settings.language":{en:"Language",pt:"Idioma"},"ask.settings.language.auto":{en:"Auto",pt:"Autom\xe1tico"},"ask.settings.language.pt":{en:"Portuguese",pt:"Portugu\xeas"},"ask.settings.language.en":{en:"English",pt:"Ingl\xeas"},"ask.settings.maxTokens":{en:"Response length",pt:"Comprimento da resposta"},"ask.settings.maxTokens.short":{en:"Short (256)",pt:"Curto (256)"},"ask.settings.maxTokens.medium":{en:"Medium (512)",pt:"M\xe9dio (512)"},"ask.settings.maxTokens.long":{en:"Long (1024)",pt:"Longo (1024)"},"ask.settings.maxTokens.xlong":{en:"Extra long (2048)",pt:"Extra longo (2048)"},"ask.hint.send":{en:"send",pt:"enviar"},"ask.hint.newline":{en:"new line",pt:"nova linha"},"ask.hint.newConv":{en:"new conversation",pt:"nova conversa"}}},28170(o,e,a){a.d(e,{Ym:()=>c,Nx:()=>p,aw:()=>g});var t=a(37991),r=a(61798);let n={"time.justNow":{en:"just now",pt:"agora mesmo"},"time.mAgo":{en:"{n}m ago",pt:"h\xe1 {n}m"},"time.hAgo":{en:"{n}h ago",pt:"h\xe1 {n}h"},"time.dAgo":{en:"{n}d ago",pt:"h\xe1 {n}d"},updated:{en:"updated {age}",pt:"atualizado {age}"},refresh:{en:"Refresh",pt:"Atualizar"},loading:{en:"Loading…",pt:"A carregar…"},noData:{en:"No data available",pt:"Sem dados dispon\xedveis"},noDescription:{en:"No description provided.",pt:"Sem descri\xe7\xe3o."},failedToFetch:{en:"Failed to fetch",pt:"Erro ao carregar"},perWeek:{en:"/ wk",pt:"/ sem"},"devtools.heading":{en:"Dev Tools",pt:"Ferramentas"},"devtools.playground":{en:"Playground",pt:"Playground"},"devtools.pad":{en:"Pad",pt:"Pad"},"devtools.charts":{en:"Charts",pt:"Gr\xe1ficos"},"devtools.csv":{en:"CSV",pt:"CSV"},"devtools.regex":{en:"Regex",pt:"Regex"},"devtools.json":{en:"JSON",pt:"JSON"},"devtools.diff":{en:"Diff",pt:"Diferen\xe7as"},"devtools.jwt":{en:"JWT",pt:"JWT"},"devtools.cron":{en:"Cron",pt:"Cron"},"devtools.colors":{en:"Colors",pt:"Cores"},"devtools.api":{en:"API",pt:"API"}},i="atlantis:locale",l="shell:locale";function s(o){return"en"===o||"pt"===o}function d(){try{let o=localStorage.getItem(i);if(s(o))return o}catch{}return"en"}function c(){let[o,e]=(0,t.useState)(d),a=(0,t.useCallback)(o=>{e(o);try{localStorage.setItem(i,o)}catch{}(0,r.Is)(l,o).catch(()=>{}),window.dispatchEvent(new CustomEvent("atlantis:locale-change",{detail:o}))},[]);return(0,t.useEffect)(()=>{let o=o=>{e(o.detail)};return window.addEventListener("atlantis:locale-change",o),()=>window.removeEventListener("atlantis:locale-change",o)},[]),(0,t.useEffect)(()=>{(0,r.PL)(l).then(a=>{if(s(a)&&a!==o){try{localStorage.setItem(i,a)}catch{}e(a)}}).catch(()=>{})},[]),[o,a]}function p(o,e){let a=e?{...n,...e}:n;return(e,t)=>{let r=a[e]?.[o]??e;return t?Object.entries(t).reduce((o,[e,a])=>o.replace(RegExp(`\\{${e}\\}`,"g"),String(a)),r):r}}function g(o,e){let a=Math.floor((Date.now()-new Date(o).getTime())/6e4);if(a<1)return e("time.justNow");if(a<60)return e("time.mAgo",{n:a});let t=Math.floor(a/60);return t<24?e("time.hAgo",{n:t}):e("time.dAgo",{n:Math.floor(t/24)})}(0,r.PL)(l).then(o=>{if(s(o))try{localStorage.setItem(i,o)}catch{}}).catch(()=>{}),a(65723);var m=a(36859),f=a.n(m);f().div`
  display: flex;
  gap: 4px;
...
`},87330(o,e,a){a.d(e,{FlyoutPanel:()=>oR});var t=a(65723),r=a(37991),n=a.n(r),i=a(36859),l=a.n(i),s=a(72799),d=a(20255),c=a(81316),p=a(40814),g=a(36896),m=a(87902),f=a(53013),u=a(32887),x=a(49510),h=a(39848),b=a(37901),y=a(3045),w=a(43775),$=a(41783),z=a(83539),v=a(39416),k=a(1837),M=a(57167),A=a(84494),T=a(82314),S=a(35751),j=a(69633),F=a(92946),B=a(40822),P=a(36720),R=a(57400),C=a(58456),E=a(43317),L=a(52709),H=a(8006),N=a(89301),D=a(37561),I=a(83517),G=a(28207),Y=a(37032),K=a(6949),V=a(8218),O=a(36829),q=a(59591),W=a(15553),_=a(69923),U=a(72820),J=a(14621),Z=a(68479),X=a(72534),Q=a(66673),oo=a(67490),oe=a(49033),oa=a(99038),ot=a(45775),or=a(31365),on=a(62937),oi=a(9821),ol=a(65912),os=a(80158),od=a(88641),oc=a(48607),op=a(83249),og=a(1821),om=a(15889),of=a(89655),ou=a(27170),ox=a(19161),oh=a(71849),ob=a(41604),oy=a(13142),ow=a(61187),o$=a(77747),oz=a(2932),ov=a(24525),ok=a(57230),oM=a(22164);let oA={activity:g.A,"a-large-small":m.A,apple:f.A,"arrow-right":u.A,"bar-chart-2":x.A,book:h.A,"book-open":b.A,briefcase:y.A,calendar:w.A,clock:$.A,"circle-dot":z.A,cloud:v.A,compass:k.A,cpu:M.A,droplets:A.A,feather:T.A,file:d.A,"file-text":S.A,folder:j.A,"git-branch":F.A,github:B.A,globe:P.A,grid:R.A,hand:C.A,hash:E.A,heart:L.A,key:H.A,hexagon:N.A,home:D.A,landmark:I.A,layers:G.A,"layout-grid":Y.A,leaf:K.A,lightbulb:V.A,list:O.A,map:q.A,"map-pin":W.A,"message-circle":_.A,"message-square":U.A,minus:J.A,monitor:Z.A,mountain:X.A,package:Q.A,palette:oo.A,"pen-tool":oe.A,"pie-chart":oa.A,plane:ot.A,plus:or.A,ruler:on.A,shirt:oi.A,slash:ol.A,square:os.A,star:od.A,sun:oc.A,terminal:op.A,thermometer:og.A,triangle:om.A,trophy:of.A,truck:ou.A,type:ox.A,users:oh.A,"volume-2":ob.A,watch:oy.A,waves:ow.A,wind:o$.A,wrench:oz.A,x:ov.A,zap:ok.A,bot:oM.A},oT=(0,s.keyframes)`
...
`,oS=l().div`
  ...
  min-width: 210px;
  overflow-y: auto;
  animation: ${oT} 0.18s cubic-bezier(0.22, 1, 0.36, 1) forwards;
...
`;function oB({iconKey:o}){let e=o?oA[o]??d.A:d.A;return(0,t.jsx)(e,{size:14,strokeWidth:1.75})}function oP({entries:o,activeId:e,onSelect:a}){return(0,t.jsx)(t.Fragment,{children:o.map(o=>o.children?(0,t.jsx)(n().Fragment,{children:(0,t.jsx)(oP,{entries:o.children,activeId:e,onSelect:a})},o.id):(0,t.jsxs)(oF,{active:e===o.id,onClick:()=>a(o),children:[(0,t.jsx)(oB,{iconKey:o.icon}),o.name]},o.id))})}function oR({activeId:o}){let{flyout:e,scheduleFlyoutClose:a,cancelFlyoutClose:r}=(0,p.c)();if(!e)return null;let n=e.entry.icon?oA[e.entry.icon]??d.A:d.A;return(0,t.jsxs)(oS,{anchorY:e.anchorY,onMouseEnter:r,onMouseLeave:a,children:[(0,t.jsxs)(oj,{children:[(0,t.jsx)(n,{size:13,strokeWidth:2}),e.entry.name]}),(0,t.jsx)(oP,{entries:e.entry.children??[],activeId:o,onSelect:o=>{e.onSelect(o),a()}})]})}},40814(o,e,a){a.d(e,{I:()=>r,c:()=>n});var t=a(37991);let r=(0,t.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),n=()=>(0,t.useContext)(r)},61798(o,e,a){a.d(e,{kd:()=>D,Zf:()=>U,w4:()=>t.w4,mZ:()=>H,KL:()=>L,fy:()=>K,Is:()=>I,cL:()=>p.c,Iu:()=>N,hY:()=>_,PE:()=>F,PL:()=>G});var t=a(81316),r=a(65723),n=a(37991),i=a.n(n),l=a(36859),s=a.n(l);s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,s().div`
  position: relative;
`;var d=a(72799),c=a(73661),p=a(40814);let g="260px",m="56px",f=s().header`
  display: flex;
  align-items: center;
...
`,y=s().span`
  ...
  animation: ${h} 10s ease ${({index:o})=>.07*o}s infinite;
...
`,v=s().div`
  ...
  overflow: hidden;
`,k=s().aside`
  width: ${({collapsed:o})=>o?m:g};
  min-width: ${({collapsed:o})=>o?m:g};
  background: ${t.w4.colors.sidebarBg};
  border-right: 1px solid ${t.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,A=s().main`
  ...
  display: flex;
  flex-direction: column;
`,T=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function S(){return(0,r.jsx)(b,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:T.map((o,e)=>(0,r.jsx)(y,{index:e,accent:o.accent,children:o.char},e))})}let j="atlantis:sidebar-collapsed";function F({sidebar:o,children:e,topBarRight:t,title:l="Atlantis",activeId:s=null}){let[d,g]=(0,n.useState)(()=>{try{return"true"===localStorage.getItem(j)}catch{return!1}}),[m,h]=(0,n.useState)(null),b=(0,n.useRef)(),y=()=>g(o=>{let e=!o;try{localStorage.setItem(j,String(e))}catch{}return e}),T=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(a.bind(a,87330)).then(o=>({default:o.FlyoutPanel}))),[]);return(0,r.jsx)(p.I.Provider,{value:{collapsed:d,toggle:y,flyout:m,openFlyout:(o,e,a)=>{clearTimeout(b.current),h({entry:o,anchorY:e,onSelect:a})},scheduleFlyoutClose:()=>{b.current=setTimeout(()=>h(null),160)},cancelFlyoutClose:()=>clearTimeout(b.current)},children:(0,r.jsxs)(v,{children:[(0,r.jsxs)(f,{children:[o&&(0,r.jsx)(u,{children:(0,r.jsx)(x,{onClick:y,title:d?"Expand sidebar":"Collapse sidebar",children:(0,r.jsx)(c.A,{size:17})})}),(0,r.jsx)(S,{}),l&&(0,r.jsx)(w,{children:l}),t&&(0,r.jsx)($,{children:t})]}),(0,r.jsxs)(z,{children:[null!=o&&(0,r.jsx)(k,{collapsed:d,children:(0,r.jsx)(M,{children:o})}),(0,r.jsx)(A,{children:e})]}),m&&(0,r.jsx)(i().Suspense,{fallback:null,children:(0,r.jsx)(T,{activeId:s})})]})})}s().div`
  display: grid;
...
`;let W="atlantis:api-keys";async function _(){try{let o=await G(W);if(o){let e=JSON.parse(o);if(e.groq&&e.groq.length>0)return e.groq}}catch{}let o=function(){if("u"<typeof localStorage)return null;try{let o=localStorage.getItem(W);if(o){let e=JSON.parse(o);if(e.groq&&e.groq.length>0)return e.groq}let e=localStorage.getItem("atlantis:promptlab:keys");if(e){let o=JSON.parse(e);if(o.groq&&o.groq.length>0)return o.groq}}catch{}return null}();if(o)return o;if("u"<typeof process)return null;let e=process.env?.GROK_API_KEY;return e&&0!==e.length?e:null}async function U(o,e){let a="pt"===e.locale?"Portuguese":"English",t=e.system??`You are Atlantis, a concise personal-dashboard assistant.
Answer in ${a}. Stay focused and reasonably concise.
...
around rendered blocks.`,r=(e.history??[]).slice(-6),n=await fetch("https://api.groq.com/openai/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${e.key}`},body:JSON.stringify({model:"llama-3.1-8b-instant",messages:[{role:"system",content:t},...r,{role:"user",content:o}],temperature:.4,max_tokens:e.maxTokens??1024}),signal:e.signal}),i=await n.json();if(!n.ok)throw Error(i.error?.message??`Groq HTTP ${n.status}`);let l=i.choices?.[0]?.message?.content?.trim();if(!l)throw Error("Empty response from Groq");return l}},81316(o,e,a){a.d(e,{w4:()=>n});let t={sidebarBg:"#0c1018",sidebarText:"#c5cdd8",sidebarTextMuted:"#5a6577",sidebarActive:"#6366f1",sidebarActiveBg:"#141820",sidebarHover:"#1a2030",sidebarBorder:"#1e2535",mainBg:"#0a0e14",mainText:"#e8edf5",mainTextMuted:"#9aa5b8",mainTextFaint:"rgba(232,237,245,0.38)",accent:"#6366f1",accentHover:"#818cf8",accentMuted:"rgba(99,102,241,0.18)",codeBg:"#0f1520",codeBorder:"#2a3040",border:"#343c4f",borderStrong:"rgba(255,255,255,0.16)",borderSubtle:"#1e2535",surface:"#141820",surfaceRaised:"#1c2332",surfaceHover:"#1d2138",success:"#34d399",warning:"#fbbf24",danger:"#f87171",shadow:"rgba(0, 0, 0, 0.35)",shadowStrong:"rgba(0, 0, 0, 0.45)",suiteLab:"#8b7bff",suiteVida:"#7fb77e",suiteLearn:"#6aa8d8",suiteGames:"#ff6fa9",suiteEnt:"#e89a5c"},r="--at-",n={colors:function(){let o={};for(let e of Object.keys(t))o[e]=`var(${r}${e})`;return o}(),spacing:{xs:"4px",sm:"8px",md:"16px",lg:"24px",xl:"32px",xxl:"48px"},sidebar:{width:"260px"},topbar:{height:"56px"},typography:{fontFamily:"'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif",fontFamilyMono:"'JetBrains Mono', 'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, monospace",fontFamilySerif:"'Cormorant Garamond', 'Iowan Old Style', 'Palatino Linotype', Palatino, Georgia, serif",fontSizeSm:"13px",fontSizeBase:"14px",fontSizeMd:"16px",fontSizeLg:"20px",fontSizeXl:"24px",fontSizeHero:"32px",lineHeightBase:"1.6"},suites:{lab:`var(${r}suiteLab)`,vida:`var(${r}suiteVida)`,learn:`var(${r}suiteLearn)`,games:`var(${r}suiteGames)`,ent:`var(${r}suiteEnt)`},borderRadius:{sm:"4px",md:"6px",lg:"12px",xl:"16px"},breakpoints:{md:"768px",lg:"1024px",xl:"1280px"},sizes:{fullHeight:"100dvh",md:"768px",lg:"1024px",xl:"1280px"},zIndex:{sticky:100,dropdown:1e3,flyout:1200,modal:1500,tooltip:1600},elevation:{sm:"0 2px 8px var(--at-shadow), 0 1px 2px var(--at-shadow)",md:"0 8px 24px var(--at-shadow), 0 2px 4px var(--at-shadow)",lg:"0 16px 48px var(--at-shadowStrong), 0 4px 12px var(--at-shadow)",glow:"0 0 0 1px rgba(99,102,241,0.30), 0 8px 24px rgba(99,102,241,0.15)"},transitions:{fast:"0.1s cubic-bezier(0.4, 0, 0.2, 1)",base:"0.2s cubic-bezier(0.4, 0, 0.2, 1)",slow:"0.35s cubic-bezier(0.4, 0, 0.2, 1)",easing:"cubic-bezier(0.4, 0, 0.2, 1)"},focusRing:`
  ...
  &:hover:not(:disabled) {
    background: ${({variant:o})=>c[o]};
    color: ${({variant:o})=>m[o]};
    border-color: ${({variant:o})=>"ghost"===o?s.w4.colors.accent:p[o]};
  }
...
`,b=n().forwardRef(function({variant:o="ghost",size:e="md",icon:a,iconRight:r,children:n,...i},l){return(0,t.jsxs)(h,{ref:l,variant:o,size:e,...i,children:[a,n,r]})}),y={default:s.w4.colors.accent,danger:"#f85149"},w={default:s.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"},$=l().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
  ...
  height: 30px;
  padding: 0;
  background: ${({active:o})=>o?`${s.w4.colors.accent}22`:"transparent"};
  border: 1px solid
    ${({active:o})=>o?s.w4.colors.accent:s.w4.colors.border};
  border-radius: ${({shape:o})=>"circle"===o?"999px":s.w4.borderRadius.sm};
  color: ${({active:o})=>o?s.w4.colors.accent:s.w4.colors.mainTextMuted};
  cursor: pointer;
  transition: background ${s.w4.transitions.fast}, border-color ${s.w4.transitions.fast}, color ${s.w4.transitions.fast};

  &:hover:not(:disabled) {
    color: ${({tone:o})=>y[o]};
    background: ${({tone:o})=>w[o]};
    border-color: ${({tone:o})=>y[o]};
  }
  &:focus-visible {
    outline: 2px solid ${s.w4.colors.accent};
    outline-offset: 2px;
...
`,z=n().forwardRef(function({active:o=!1,shape:e="square",tone:a="default",children:r,...n},i){return(0,t.jsx)($,{ref:i,active:o,shape:e,tone:a,...n,children:r})}),v=l().div`
  position: relative;
  display: inline-flex;
`,k=l().div`
  position: absolute;
  ...
  z-index: 2000;
  overflow: hidden;
`;function M({trigger:o,children:e,align:a="right",open:i,onOpenChange:l}){let[s,d]=(0,r.useState)(!1),c=i??s,p=o=>{l&&l(o),void 0===i&&d(o)},g=(0,r.useRef)(null);(0,r.useEffect)(()=>{if(!c)return;let o=o=>{g.current&&!g.current.contains(o.target)&&p(!1)};return document.addEventListener("mousedown",o),()=>document.removeEventListener("mousedown",o)},[c]);let m=n().cloneElement(o,{onClick:e=>{o.props.onClick?.(e),p(!c)},"aria-expanded":c,"aria-haspopup":"menu"});return(0,t.jsxs)(v,{ref:g,children:[m,c&&(0,t.jsx)(k,{align:a,role:"menu",children:e})]})}let A=l().button`
  display: flex;
  align-items: center;
  gap: 10px;
  padding: 8px 12px;
...
`,l().div`
  ...
  gap: 4px;
  flex-wrap: wrap;
`,l()("button",{shouldForwardProp:o=>"active"!==o&&"highlight"!==o})`
  padding: 6px 14px;
  height: 28px;
  border-radius: 999px;
  background: ${({active:o})=>o?s.w4.colors.accentMuted:"transparent"};
  border: 1px solid
    ${({active:o,highlight:e})=>o||e?s.w4.colors.accent:"transparent"};
  color: ${({active:o,highlight:e})=>o||e?s.w4.colors.accent:s.w4.colors.mainTextMuted};
  font-family: ${s.w4.typography.fontFamily};
  font-size: 12px;
  font-weight: 500;
  cursor: pointer;
...
`;var T=a(72799);let S=(0,T.keyframes)`
...
`,l().button`
  ...
  background: ${({open:o})=>o?s.w4.colors.surfaceHover:"transparent"};
  border: 1px solid
    ${({open:o})=>o?s.w4.colors.borderStrong:s.w4.colors.border};
  border-radius: 999px;
  color: ${s.w4.colors.mainTextMuted};
  font-family: ${s.w4.typography.fontFamily};
  font-size: 13px;
...
`,l()("button",{shouldForwardProp:o=>"accent"!==o&&"expanded"!==o})`
  width: 100%;
  display: grid;
  ...
  align-items: center;
  padding: 10px 12px;
  background: ${({expanded:o})=>o?s.w4.colors.surfaceHover:"transparent"};
  border: none;
  border-radius: 10px;
  cursor: pointer;
  font-family: inherit;
  ...
  &:focus-visible { ${s.w4.focusRing} }
`,l()("span",{shouldForwardProp:o=>"accent"!==o})`
  width: 36px;
  height: 36px;
  border-radius: 9px;
...
`;l()("div",{shouldForwardProp:o=>"accentColor"!==o&&"pinned"!==o&&"index"!==o})`
  --acc: ${({accentColor:o})=>o};
  position: relative;
  display: flex;
  flex-direction: column;
  ...
  padding: 0;
  background: ${s.w4.colors.surface};
  border: 1px solid ${({pinned:o})=>o?s.w4.colors.accent:s.w4.colors.border};
  border-radius: 12px;
  overflow: hidden;
  cursor: pointer;
  color: ${s.w4.colors.mainText};
...
`,l().button`
  ...
  border-radius: 8px;
  color: ${({pinned:o})=>o?s.w4.colors.accent:s.w4.colors.mainText};
  opacity: ${({pinned:o})=>+!!o};
  cursor: pointer;
...
`,l().button`
  ...
  border-radius: 999px;
  border: 1.5px solid
    ${({variant:o})=>"default"===o?s.w4.colors.borderStrong:s.w4.colors.accent};
  background: ${({variant:o})=>"filled"===o?s.w4.colors.accentMuted:"transparent"};
  color: ${({variant:o})=>"default"===o?s.w4.colors.mainTextMuted:s.w4.colors.accent};
  font-family: ${s.w4.typography.fontFamily};
  font-size: ${s.w4.typography.fontSizeSm};
  font-weight: 500;
  white-space: nowrap;
  ...
  &:hover:not(:disabled) {
    border-color: ${({variant:o})=>"default"===o?s.w4.colors.mainTextFaint:s.w4.colors.accentHover};
    color: ${({variant:o})=>"default"===o?s.w4.colors.mainText:s.w4.colors.accentHover};
  }
...
`,l().span`
  ...
  background: ${({color:o})=>o};
  display: inline-block;
`;let R={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:s.w4.colors.accentMuted},C={neutral:s.w4.colors.mainTextMuted,live:s.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:s.w4.colors.accent};l().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${s.w4.typography.fontFamilyMono};
  ...
  border-radius: ${({tone:o})=>"film"===o||"tv"===o?s.w4.borderRadius.sm:"3px"};
  background: ${({tone:o})=>R[o]};
  color: ${({tone:o})=>C[o]};
`,l().span`
  width: 6px;
  height: 6px;
...
`;let E=l().kbd`
  ...
  white-space: nowrap;
`;function L({children:o,...e}){return(0,t.jsx)(E,{...e,children:o})}let H=l().div`
  font-family: ${s.w4.typography.fontFamilyMono};
  font-size: 11px;
  ...
  align-items: center;
  gap: 8px;
`;function N({children:o,...e}){return(0,t.jsx)(H,{...e,children:o})}l().label`
  display: flex;
  align-items: center;
  gap: 10px;
...
`,l().div`
  ...
  background: ${s.w4.colors.surface};
  border: 1px solid
    ${({active:o})=>o?s.w4.colors.accent:s.w4.colors.borderSubtle};
  border-radius: ${s.w4.borderRadius.lg};
  color: ${s.w4.colors.mainText};
  font-family: ${s.w4.typography.fontFamily};
  box-shadow: ${({active:o})=>o?`inset 0 0 0 1px ${s.w4.colors.accent}`:"none"};
  transition: border-color ${s.w4.transitions.fast};

  &:hover {
    border-color: ${({active:o})=>o?s.w4.colors.accentHover:s.w4.colors.borderStrong};
  }
`,l().div`
  display: flex;
  align-items: flex-start;
...
`;let D=(0,T.keyframes)`
  from { opacity: 0; transform: translateY(8px); }
  to   { opacity: 1; transform: translateY(0); }
`;l()("div",{shouldForwardProp:o=>"accentColor"!==o&&"index"!==o})`
  --acc: ${({accentColor:o})=>o};
  position: relative;
  display: flex;
  flex-direction: column;
...
`,l()("div",{shouldForwardProp:o=>"accentColor"!==o})`
  --acc: ${({accentColor:o})=>o};
  height: 120px;
  position: relative;
  overflow: hidden;
...
`,l().p`
  ...
  font-size: 12.5px;
  line-height: 1.45;
`;var I=a(11352),G=a(76710),Y=a(4311),K=a(73639),V=a(8411);a(75406),l().nav`padding: ${s.w4.spacing.sm} 0;`,l().div`
...
`,l().button`
  ...
  align-items: center;
  width: 100%;
  padding: ${({collapsed:o})=>o?"10px 0":`7px ${s.w4.spacing.md}`};
  justify-content: ${({collapsed:o})=>o?"center":"space-between"};
  background: none;
  border: none;
  cursor: pointer;
...
`,l().button`
  ...
  background: ${({active:o})=>o?s.w4.colors.sidebarActiveBg:"none"};
  border: none;
  border-left: 2px solid ${({active:o})=>o?s.w4.colors.sidebarActive:"transparent"};
  cursor: pointer;
  color: ${({active:o})=>o?s.w4.colors.sidebarActive:s.w4.colors.sidebarText};
  font-size: ${s.w4.typography.fontSizeBase};
  font-family: ${s.w4.typography.fontFamily};
  text-align: left;
  overflow: hidden;
...
`,l().button`
  ...
  border: none;
  cursor: pointer;
  color: ${({active:o})=>o?"#e3b341":s.w4.colors.sidebarTextMuted};
...
`,W=!1;function _(o){if("u"<typeof window)return o;let e=o.match(/^var\((--[-\w]+)\)$/);return e&&getComputedStyle(document.documentElement).getPropertyValue(e[1]).trim()||o}function U({code:o}){let e=(0,r.useRef)(null),[n,i]=(0,r.useState)(null),[l,d]=(0,r.useState)(!1);return((0,r.useEffect)(()=>{let t=!1;if(i(null),d(!1),!o.trim())return void d(!0);let r=o.trim().split(/\r?\n/)[0]?.trim()??"";return/^(?:---[\s\S]*?---\s*)?(?:graph|flowchart|sequenceDiagram|classDiagram|stateDiagram(?:-v2)?|erDiagram|pie|gantt|journey|mindmap|gitGraph|sankey(?:-beta)?|quadrantChart|requirementDiagram|timeline|xychart-beta|block-beta|C4Context|C4Container|C4Component|C4Dynamic|C4Deployment)\b/.test(r)?(async function(){let r=(await a.e("6087").then(a.bind(a,29738))).default;if(W||(r.initialize({startOnLoad:!1,theme:"dark",themeVariables:{background:_(s.w4.colors.codeBg),primaryColor:_(s.w4.colors.accent),primaryTextColor:_(s.w4.colors.mainText),lineColor:_(s.w4.colors.border)}}),W=!0),e.current&&!t)try{let a=`mermaid-${Math.random().toString(36).slice(2)}`,{svg:n}=await r.render(a,o);if(t||!e.current)return;if(/aria-roledescription="error"|class="error-icon"|>Syntax error/i.test(n))return void d(!0);e.current.innerHTML=n,requestAnimationFrame(()=>{if(t||!e.current)return;let o=e.current.querySelector("svg");if(!o)return void d(!0);let a=o.getBoundingClientRect();(a.width<40||a.height<40)&&d(!0)})}catch(o){t||i(o instanceof Error?o.message:String(o))}}(),()=>{t=!0}):void d(!0)},[o]),n||l)?(0,t.jsx)(q,{children:o.trim()}):(0,t.jsx)(O,{ref:e})}let J=["#388bfd","#3fb950","#d29922","#a371f7","#f87171","#22d3ee","#fb923c","#34d399","#f472b6","#818cf8"],Z=l().div`
  background: ${s.w4.colors.codeBg};
  border: 1px solid ${s.w4.colors.codeBorder};
  border-radius: ${s.w4.borderRadius.md};
  padding: ${s.w4.spacing.lg};
...
`,oa=l().pre`
  ...
  color: ${s.w4.colors.mainTextMuted};
  white-space: pre-wrap;
`;function ot(o){if(o<=0)return 10;let e=Math.pow(10,Math.floor(Math.log10(o)));return Math.ceil(o/e)*e}function or({labels:o,data:e,colors:a}){let r=340,n=176,i=ot(Math.max(...e,1)),l=Math.min(40,r/o.length*.6),d=r/o.length,c=Array.from({length:6},(o,e)=>i/5*e);return(0,t.jsxs)("svg",{viewBox:"0 0 400 240",width:"100%",style:{maxWidth:400},children:[c.map((o,e)=>{let a=16+n-o/i*n;return(0,t.jsxs)("g",{children:[(0,t.jsx)("line",{x1:44,y1:a,x2:384,y2:a,stroke:s.w4.colors.border,strokeWidth:.5,strokeDasharray:0===e?"none":"3,3"}),(0,t.jsx)("text",{x:38,y:a+4,fill:s.w4.colors.mainTextMuted,fontSize:10,textAnchor:"end",fontFamily:s.w4.typography.fontFamily,children:Math.round(o)})]},e)}),e.map((e,r)=>{let c=44+d*r+d/2-l/2,p=e/i*n,g=16+n-p,m=a[r%a.length];return(0,t.jsxs)("g",{children:[(0,t.jsxs)("rect",{x:c,y:g,width:l,height:p,rx:3,fill:m,opacity:.85,children:[(0,t.jsx)("animate",{attributeName:"height",from:"0",to:p,dur:"0.5s",fill:"freeze"}),(0,t.jsx)("animate",{attributeName:"y",from:16+n,to:g,dur:"0.5s",fill:"freeze"})]}),(0,t.jsx)("text",{x:c+l/2,y:g-4,fill:s.w4.colors.mainText,fontSize:10,fontWeight:600,textAnchor:"middle",fontFamily:s.w4.typography.fontFamily,children:e}),(0,t.jsx)("text",{x:44+d*r+d/2,y:208,fill:s.w4.colors.mainTextMuted,fontSize:10,textAnchor:"middle",fontFamily:s.w4.typography.fontFamily,children:o[r].length>8?o[r].slice(0,7)+"…":o[r]})]},r)})]})}function on({labels:o,data:e,colors:a}){let r=e.reduce((o,e)=>o+e,0)||1,n=-Math.PI/2,i=e.map((o,e)=>{let i=o/r*Math.PI*2,l=n,d=n+=i,c=120+90*Math.cos(l),p=120+90*Math.sin(l),g=120+90*Math.cos(d),m=120+90*Math.sin(d),f=+(i>Math.PI),u=l+i/2,x=120+58.5*Math.cos(u),h=120+58.5*Math.sin(u),b=Math.round(o/r*100);return(0,t.jsxs)("g",{children:[(0,t.jsx)("path",{d:`M 120 120 L ${c} ${p} A 90 90 0 ${f} 1 ${g} ${m} Z`,fill:a[e%a.length],stroke:s.w4.colors.codeBg,strokeWidth:2,opacity:.85}),b>=5&&(0,t.jsxs)("text",{x:x,y:h+4,fill:"#fff",fontSize:11,fontWeight:600,textAnchor:"middle",fontFamily:s.w4.typography.fontFamily,children:[b,"%"]})]},e)});return(0,t.jsx)("svg",{viewBox:"0 0 240 240",width:"100%",style:{maxWidth:240},children:i})}function oi({labels:o,data:e,colors:a}){let r=340,n=176,i=ot(Math.max(...e,1)),l=e.length>1?r/(e.length-1):r,d=a[0],c=e.map((o,e)=>({x:44+l*e,y:16+n-o/i*n})),p=c.map((o,e)=>`${0===e?"M":"L"} ${o.x} ${o.y}`).join(" "),g=Array.from({length:6},(o,e)=>i/5*e);return(0,t.jsxs)("svg",{viewBox:"0 0 400 240",width:"100%",style:{maxWidth:400},children:[g.map((o,e)=>{let a=16+n-o/i*n;return(0,t.jsxs)("g",{children:[(0,t.jsx)("line",{x1:44,y1:a,x2:384,y2:a,stroke:s.w4.colors.border,strokeWidth:.5,strokeDasharray:0===e?"none":"3,3"}),(0,t.jsx)("text",{x:38,y:a+4,fill:s.w4.colors.mainTextMuted,fontSize:10,textAnchor:"end",fontFamily:s.w4.typography.fontFamily,children:Math.round(o)})]},e)}),(0,t.jsx)("path",{d:p,fill:"none",stroke:d,strokeWidth:2.5,strokeLinecap:"round",strokeLinejoin:"round"}),c.map((a,r)=>(0,t.jsxs)("g",{children:[(0,t.jsx)("circle",{cx:a.x,cy:a.y,r:4,fill:d,stroke:s.w4.colors.codeBg,strokeWidth:2}),(0,t.jsx)("text",{x:a.x,y:a.y-10,fill:s.w4.colors.mainText,fontSize:10,fontWeight:600,textAnchor:"middle",fontFamily:s.w4.typography.fontFamily,children:e[r]}),(0,t.jsx)("text",{x:a.x,y:208,fill:s.w4.colors.mainTextMuted,fontSize:10,textAnchor:"middle",fontFamily:s.w4.typography.fontFamily,children:o[r].length>8?o[r].slice(0,7)+"…":o[r]})]},r))]})}function ol({code:o}){let e=(0,r.useMemo)(()=>(function(o){let e,a,t=o.trim().split("\n"),r="bar",n=[],i=[];for(let o of t){let[t,...l]=o.split(":"),s=l.join(":").trim();if(s)switch(t.trim().toLowerCase()){case"type":["bar","pie","line"].includes(s.toLowerCase())&&(r=s.toLowerCase());break;case"title":e=s;break;case"labels":n=s.replace(/^\[|\]$/g,"").split(",").map(o=>o.trim());break;case"data":i=s.replace(/^\[|\]$/g,"").split(",").map(o=>parseFloat(o.trim())||0);break;case"colors":a=s.replace(/^\[|\]$/g,"").split(",").map(o=>o.trim())}}return n.length&&i.length?{type:r,title:e,labels:n,data:i,colors:a}:null})(o),[o]);if(!e)return(0,t.jsx)(oa,{children:o.trim()});let a=e.colors??J;return(0,t.jsxs)(Z,{children:[e.title&&(0,t.jsx)(X,{children:e.title}),"bar"===e.type&&(0,t.jsx)(or,{labels:e.labels,data:e.data,colors:a}),"pie"===e.type&&(0,t.jsx)(on,{labels:e.labels,data:e.data,colors:a}),"line"===e.type&&(0,t.jsx)(oi,{labels:e.labels,data:e.data,colors:a}),(0,t.jsx)(Q,{children:e.labels.map((o,e)=>(0,t.jsxs)(oo,{children:[(0,t.jsx)(oe,{color:a[e%a.length]}),o]},e))})]})}l().div`
  background: ${s.w4.colors.codeBg};
  border: 1px solid ${s.w4.colors.codeBorder};
  border-radius: ${s.w4.borderRadius.md};
  padding: ${s.w4.spacing.lg};
...
`,l().button`
  padding: 6px 14px;
  border: 1px solid ${({active:o})=>o?s.w4.colors.accent:s.w4.colors.border};
  border-radius: ${s.w4.borderRadius.md};
  background: ${({active:o})=>o?s.w4.colors.accentMuted:"transparent"};
  color: ${({active:o})=>o?s.w4.colors.accent:s.w4.colors.mainTextMuted};
  font-family: ${s.w4.typography.fontFamily};
...
`,l().span`
  font-size: ${s.w4.typography.fontSizeBase};
  color: ${s.w4.colors.mainTextMuted};
`;var oc=a(17223),op=a(21426),og=a(25609),om=a(20320);let of=l().div`
  margin: ${s.w4.spacing.lg} 0;
  border-radius: ${s.w4.borderRadius.md};
  border: 1px solid ${s.w4.colors.codeBorder};
  overflow: hidden;
...
`,oh=l().button`
  ...
  padding: 3px 8px;
  background: none;
  border: 1px solid ${({copied:o})=>o?"#3fb950":s.w4.colors.border};
  border-radius: ${s.w4.borderRadius.sm};
  color: ${({copied:o})=>o?"#3fb950":s.w4.colors.sidebarTextMuted};
  font-size: 11px;
  font-family: ${s.w4.typography.fontFamily};
  cursor: pointer;
  transition: color 0.15s, border-color 0.15s;
  &:hover { color: ${s.w4.colors.sidebarText}; border-color: ${s.w4.colors.sidebarText}; }
`,ob={...op.A,'pre[class*="language-"]':{...op.A['pre[class*="language-"]'],background:s.w4.colors.codeBg,margin:0,padding:"18px 20px",fontSize:"13px",lineHeight:"1.6",borderRadius:0},'code[class*="language-"]':{...op.A['code[class*="language-"]'],background:"none",fontSize:"13px"}};function oy({lang:o="text",code:e}){let[a,n]=(0,r.useState)(!1);return(0,t.jsxs)(of,{children:[(0,t.jsxs)(ou,{children:[(0,t.jsx)(ox,{children:o}),(0,t.jsxs)(oh,{copied:a,onClick:()=>{navigator.clipboard.writeText(e).then(()=>{n(!0),setTimeout(()=>n(!1),2e3)})},children:[a?(0,t.jsx)(og.A,{size:12}):(0,t.jsx)(om.A,{size:12}),a?"Copied!":"Copy"]})]}),(0,t.jsx)(oc.A,{language:o,style:ob,showLineNumbers:e.split("\n").length>8,lineNumberStyle:{color:"#484f58",minWidth:"2.5em",paddingRight:"1.5em",userSelect:"none",fontSize:"12px"},customStyle:{margin:0,background:s.w4.colors.codeBg},wrapLongLines:!1,children:e})]})}var ow=a(65569),o$=a(8218),oz=a(57230),ov=a(22966),ok=a(21069);let oM={NOTE:{bg:"rgba(88, 166, 255, 0.08)",border:"#58a6ff",icon:ow.A,label:"Note",color:"#58a6ff"},TIP:{bg:"rgba(63, 185, 80, 0.08)",border:"#3fb950",icon:o$.A,label:"Tip",color:"#3fb950"},IMPORTANT:{bg:"rgba(163, 113, 247, 0.08)",border:"#a371f7",icon:oz.A,label:"Important",color:"#a371f7"},WARNING:{bg:"rgba(210, 153, 34, 0.08)",border:"#d29922",icon:ov.A,label:"Warning",color:"#d29922"},CAUTION:{bg:"rgba(248, 81, 73, 0.08)",border:"#f85149",icon:ok.A,label:"Caution",color:"#f85149"}},oA=l().div`
  background: ${({bg:o})=>o};
...
`;function oj({type:o,children:e}){let a=oM[o]??oM.NOTE,r=a.icon;return(0,t.jsxs)(oA,{bg:a.bg,border:a.border,children:[(0,t.jsxs)(oT,{color:a.color,children:[(0,t.jsx)(r,{size:15,strokeWidth:2}),a.label]}),(0,t.jsx)(oS,{children:e})]})}l().nav`
  width: 220px;
  min-width: 220px;
...
`,l().ul`list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 2px;`,l().a`
  ...
  font-size: ${s.w4.typography.fontSizeSm};
  font-family: ${s.w4.typography.fontFamily};
  color: ${({active:o})=>o?s.w4.colors.accent:s.w4.colors.sidebarTextMuted};
  text-decoration: none;
  border-left: 2px solid ${({active:o})=>o?s.w4.colors.accent:"transparent"};
...
`,l().div`
  ...
  font-family: ${s.w4.typography.fontFamily};
`;let oF=(0,T.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,oB=(0,T.keyframes)`
  from { opacity: 0; transform: translateY(16px) scale(0.98); }
  to   { opacity: 1; transform: translateY(0) scale(1); }
`;function oP(){let o=/^\[!(NOTE|TIP|WARNING|CAUTION|IMPORTANT)\]\s*/i;return e=>{function a(e,a,t){let r=a.children?.[0];r?.type==="text"&&(r.value=r.value.replace(o,""),r.value.trim()||1!==a.children.length||a.children.shift()),e.data=e.data??{},e.data.hName="div",e.data.hProperties={"data-callout":t.toUpperCase()}}!function e(t){if("blockquote"===t.type){let e=t.children?.[0];if(e?.type==="paragraph"){let r=e.children?.[0],n=r?.type==="text"&&r.value?.match(o);n&&a(t,e,n[1])}}if("paragraph"===t.type){let e=t.children?.[0],r=e?.type==="text"&&e.value?.match(o);if(r){let e=[...t.children];t.children=[{type:"paragraph",children:e}],a(t,t.children[0],r[1]);let n=e[0];n?.type==="text"&&(n.value=n.value.replace(o,""),n.value.trim()||1!==e.length||e.shift());return}}t.children?.forEach(e)}(e)}}l().div`
  position: fixed;
  inset: 0;
  z-index: 9999;
...
`,l().button`
  ...
  width: 100%;
  padding: 10px 18px;
  background: ${({selected:o})=>o?s.w4.colors.accentMuted:"transparent"};
  border: none;
  cursor: pointer;
  text-align: left;
...
`,l().div`
  ...
  justify-content: center;
  border-radius: ${s.w4.borderRadius.md};
  background: ${({selected:o})=>o?`${s.w4.colors.accent}20`:s.w4.colors.sidebarHover};
  color: ${({selected:o})=>o?s.w4.colors.accent:s.w4.colors.sidebarTextMuted};
  flex-shrink: 0;
  margin-top: 1px;
`,l().div`
  flex: 1;
...
`,l().div`
  display: flex;
  align-items: center;
  color: ${({selected:o})=>o?s.w4.colors.accent:"transparent"};
  margin-top: 8px;
...
`,l().button`
  ...
  letter-spacing: 0.05em;
  transition: background 0.15s, color 0.15s;
  background: ${({active:o})=>o?s.w4.colors.accent:"transparent"};
  color: ${({active:o})=>o?"#0d1117":s.w4.colors.mainTextMuted};
  &:hover {
    color: ${({active:o})=>o?"#0d1117":s.w4.colors.mainText};
  }
`,l().div`
  padding: ${({collapsed:o})=>o?"8px 4px":`8px ${s.w4.spacing.md}`};
  border-bottom: 1px solid ${s.w4.colors.border}60;
`,l().div`
  display: flex;
  align-items: center;
  ...
  justify-content: ${({collapsed:o})=>o?"center":"flex-start"};
  background: ${({focused:o})=>o?`${s.w4.colors.accent}10`:s.w4.colors.sidebarHover};
  border: 1px solid ${({focused:o})=>o?`${s.w4.colors.accent}40`:"transparent"};
  border-radius: ${s.w4.borderRadius.md};
...
`;function oC({children:o}){return(0,t.jsx)(oR,{children:(0,t.jsx)(I.oz,{remarkPlugins:[G.A,Y.A,oP],rehypePlugins:[K.A,V.A],components:{div({node:o,children:e,...a}){let r=a["data-callout"];return r?(0,t.jsx)(oj,{type:r,children:e}):(0,t.jsx)("div",{...a,children:e})},pre:({children:o})=>(0,t.jsx)(t.Fragment,{children:o}),code({className:o,children:e}){let a=/language-(\w+)/.exec(o??"")?.[1],r=String(e).replace(/\n$/,"");return r.trim()?"mermaid"===a?(0,t.jsx)(U,{code:r}):"chart"===a?(0,t.jsx)(ol,{code:r}):a||r.includes("\n")?(0,t.jsx)(oy,{lang:a,code:r}):(0,t.jsx)("code",{className:o,children:e}):null}},children:o})})}l().nav`
  display: flex;
  flex-direction: column;
  gap: 1px;
  padding: ${s.w4.spacing.sm} 0;
