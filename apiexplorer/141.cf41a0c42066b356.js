...
`,l().div`
  position: relative;
`;let op="260px",og="56px",oh="44px",om=l().header`
  display: flex;
  align-items: center;
...
`,oA=l().main`
  ...
  display: flex;
  flex-direction: column;
`;function oT(){return(0,t.jsxs)(ou,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:[(0,t.jsx)(ob,{"aria-hidden":"true",children:"A"}),(0,t.jsx)(oy,{children:"Atlantis"})]})}let oS="atlantis:sidebar-collapsed";function oj({sidebar:o,children:e,topBarRight:n,title:l="Atlantis",activeId:d=null}){let[s,c]=(0,r.useState)(()=>{try{return"true"===localStorage.getItem(oS)}catch{return!1}}),[p,g]=(0,r.useState)(null),h=(0,r.useRef)(),m=()=>c(o=>{let e=!o;try{localStorage.setItem(oS,String(e))}catch{}return e}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(a.bind(a,5816)).then(o=>({default:o.FlyoutPanel}))),[]);return(0,t.jsx)(K.I.Provider,{value:{collapsed:s,toggle:m,flyout:p,openFlyout:(o,e,a)=>{clearTimeout(h.current),g({entry:o,anchorY:e,onSelect:a})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,t.jsxs)(oz,{children:[(0,t.jsxs)(om,{children:[o&&(0,t.jsx)(of,{children:(0,t.jsx)(ox,{onClick:m,title:s?"Expand sidebar":"Collapse sidebar",children:(0,t.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("path",{d:"M9 3v18"})]})})}),(0,t.jsx)(oT,{}),l&&(0,t.jsx)(ow,{children:l}),n&&(0,t.jsx)(o$,{children:n})]}),(0,t.jsxs)(ov,{children:[null!=o&&(0,t.jsx)(oM,{collapsed:s,children:(0,t.jsx)(ok,{children:o})}),(0,t.jsx)(oA,{children:e})]}),p&&(0,t.jsx)(i().Suspense,{fallback:null,children:(0,t.jsx)(f,{activeId:d})})]})})}l().div`
  display: grid;
  grid-template-rows: ${({open:o})=>o?"1fr":"0fr"};
