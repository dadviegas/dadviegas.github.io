"use strict";(self.webpackChunk_atlantis_colorlab=self.webpackChunk_atlantis_colorlab||[]).push([[301],{4914(a,o,e){e.d(o,{FlyoutPanel:()=>y});var n=e(7359),i=e(3233),t=e(7207),r=e(255),l=e(217),m=e(5959),d=e(5185),c=e(5723);const s=t.keyframes`
...
`,i.default.div`
  position: relative;
`,e(5959);const t="260px",r="56px";i.default.header`
  display: flex;
  align-items: center;
  height: ${"48px"};
...
`,i.default.div`
  ...
  overflow: hidden;
`,i.default.aside`
  width: ${({collapsed:a})=>a?r:t};
  min-width: ${({collapsed:a})=>a?r:t};
  background: ${n.w.colors.sidebarBg};
  border-right: 1px solid ${n.w.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`},217(a,o,e){e.d(o,{w:()=>n});const n={colors:{sidebarBg:"#0f1117",sidebarText:"#c9d1d9",sidebarTextMuted:"#6e7681",sidebarActive:"#58a6ff",sidebarActiveBg:"#161b22",sidebarHover:"#21262d",sidebarBorder:"#21262d",mainBg:"#0d1117",mainText:"#e6edf3",mainTextMuted:"#8b949e",accent:"#58a6ff",accentHover:"#79c0ff",codeBg:"#161b22",codeBorder:"#30363d",border:"#30363d",surface:"#161b22"},spacing:{xs:"4px",sm:"8px",md:"16px",lg:"24px",xl:"32px",xxl:"48px"},sidebar:{width:"260px"},topbar:{height:"56px"},typography:{fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif",fontFamilyMono:"'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, monospace",fontSizeSm:"13px",fontSizeBase:"14px",fontSizeMd:"16px",fontSizeLg:"20px",fontSizeXl:"24px",lineHeightBase:"1.6"},borderRadius:{sm:"4px",md:"6px",lg:"12px"},breakpoints:{md:"768px",lg:"1024px",xl:"1280px"},sizes:{fullHeight:"100dvh",md:"768px",lg:"1024px",xl:"1280px"}}},2139(a,o,e){function n(a){const o=a.replace("#","");return 3===o.length?{r:parseInt(o[0]+o[0],16),g:parseInt(o[1]+o[1],16),b:parseInt(o[2]+o[2],16)}:6===o.length?{r:parseInt(o.slice(0,2),16),g:parseInt(o.slice(2,4),16),b:parseInt(o.slice(4,6),16)}:null}function i(a,o,e){return"#"+[a,o,e].map(a=>Math.round(Math.max(0,Math.min(255,a))).toString(16).padStart(2,"0")).join("")}function t(a,o,e){const n=a/255,i=o/255,t=e/255,r=Math.max(n,i,t),l=Math.min(n,i,t),m=(r+l)/2;if(r===l)return{h:0,s:0,l:Math.round(100*m)};const d=r-l,c=m>.5?d/(2-r-l):d/(r+l);let s=0;return s=r===n?((i-t)/d+(i<t?6:0))/6:r===i?((t-n)/d+2)/6:((n-i)/d+4)/6,{h:Math.round(360*s),s:Math.round(100*c),l:Math.round(100*m)}}function r(a,o,e){const n=o/100,i=e/100,t=(1-Math.abs(2*i-1))*n,r=t*(1-Math.abs(a/60%2-1)),l=i-t/2;let m=0,d=0,c=0;return a<60?(m=t,d=r,c=0):a<120?(m=r,d=t,c=0):a<180?(m=0,d=t,c=r):a<240?(m=0,d=r,c=t):a<300?(m=r,d=0,c=t):(m=t,d=0,c=r),{r:Math.round(255*(m+l)),g:Math.round(255*(d+l)),b:Math.round(255*(c+l))}}function l(a,o,e){const n=a=>{const o=a/255;return o<=.04045?o/12.92:Math.pow((o+.055)/1.055,2.4)};return.2126*n(a)+.7152*n(o)+.0722*n(e)}function m(a,o){const e=l(a.r,a.g,a.b),n=l(o.r,o.g,o.b),i=Math.max(e,n),t=Math.min(e,n);return parseFloat(((i+.05)/(t+.05)).toFixed(2))}function d(a,o){return[10,20,30,40,50,60,70,80,90].map(e=>({h:a,s:Math.min(o,90),l:e}))}function c(a,o,e){return{h:(a+180)%360,s:o,l:e}}function s(a,o,e){return[{h:(a+30)%360,s:o,l:e},{h:(a-30+360)%360,s:o,l:e}]}function g(a,o,e){return[{h:a,s:o,l:e},{h:(a+120)%360,s:o,l:e},{h:(a+240)%360,s:o,l:e}]}e.d(o,{E2:()=>n,Hg:()=>c,K6:()=>t,Lt:()=>g,Ob:()=>i,YL:()=>r,eM:()=>m,iW:()=>d,mW:()=>s})}}]);
//# sourceMappingURL=301.a32b3a3ca07e7ce4387b.js.map