"use strict";(self.webpackChunk_atlantis_csvexplorer=self.webpackChunk_atlantis_csvexplorer||[]).push([["708"],{457(o,a,e){function t(o){let a=o.split("\n")[0]??"",e={",":0,"	":0,";":0};for(let o of a)o in e&&e[o]++;let t=Object.entries(e).sort((o,a)=>a[1]-o[1])[0];return t[1]>0?t[0]:","}function r(o,a){let e=a??t(o),r=o.trim().split(/\r?\n/).filter(o=>""!==o.trim());if(0===r.length)return{headers:[],rows:[],stats:[]};let i=o=>{let a=[],t="",r=!1;for(let i=0;i<o.length;i++){let n=o[i];'"'===n?r&&'"'===o[i+1]?(t+='"',i++):r=!r:n!==e||r?t+=n:(a.push(t.trim()),t="")}return a.push(t.trim()),a},n=i(r[0]),l=r.slice(1).map(i),d=n.map((o,a)=>{let e,t,r=l.map(o=>o[a]??""),i=r.filter(o=>""!==o&&null!==o),n=function(o){if(0===o.length)return"text";let a=o.slice(0,20);return a.filter(o=>""!==o&&!isNaN(Number(o))).length/a.length>.8?"number":a.filter(o=>!isNaN(Date.parse(o))&&o.length>4).length/a.length>.7?"date":"text"}(i),d=new Set(r).size;if("number"===n){let o=i.map(Number).filter(o=>!isNaN(o));o.length&&(e=Math.min(...o),t=Math.max(...o))}return{name:o,type:n,count:r.length,nullCount:r.length-i.length,uniqueCount:d,min:e,max:t}});return{headers:n,rows:l,stats:d}}e.d(a,{CO:()=>r,Dt:()=>t})},5151(o,a,e){e.d(a,{k:()=>t});let t=[{label:"People",csv:`name,age,city,salary,active
...
`,of=l().main`
  ...
  display: flex;
  flex-direction: column;
`,ox=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function ou(){return(0,t.jsx)(ol,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:ox.map((o,a)=>(0,t.jsx)(od,{index:a,accent:o.accent,children:o.char},a))})}let ob="atlantis:sidebar-collapsed";function oy({sidebar:o,children:a,topBarRight:n,title:l="Atlantis",activeId:d=null}){let[s,c]=(0,r.useState)(()=>{try{return"true"===localStorage.getItem(ob)}catch{return!1}}),[p,g]=(0,r.useState)(null),h=(0,r.useRef)(),m=()=>c(o=>{let a=!o;try{localStorage.setItem(ob,String(a))}catch{}return a}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(e.bind(e,5816)).then(o=>({default:o.FlyoutPanel}))),[]);return(0,t.jsx)(E.I.Provider,{value:{collapsed:s,toggle:m,flyout:p,openFlyout:(o,a,e)=>{clearTimeout(h.current),g({entry:o,anchorY:a,onSelect:e})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,t.jsxs)(og,{children:[(0,t.jsxs)(ot,{children:[o&&(0,t.jsx)(or,{children:(0,t.jsx)(oi,{onClick:m,title:s?"Expand sidebar":"Collapse sidebar",children:(0,t.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("path",{d:"M9 3v18"})]})})}),(0,t.jsx)(ou,{}),l&&(0,t.jsx)(os,{children:l}),n&&(0,t.jsx)(oc,{children:n})]}),(0,t.jsxs)(op,{children:[null!=o&&(0,t.jsx)(oh,{collapsed:s,children:(0,t.jsx)(om,{children:o})}),(0,t.jsx)(of,{children:a})]}),p&&(0,t.jsx)(i().Suspense,{fallback:null,children:(0,t.jsx)(f,{activeId:d})})]})})}l().div`
  display: grid;
  grid-template-rows: ${({open:o})=>o?"1fr":"0fr"};
