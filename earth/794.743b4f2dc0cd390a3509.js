"use strict";(self.webpackChunk_atlantis_earth=self.webpackChunk_atlantis_earth||[]).push([[794],{4914(a,e,n){n.d(e,{FlyoutPanel:()=>h});var o=n(7359),i=n(3233),t=n(7207),l=n(255),r=n(217),m=n(5959),s=n(5185),d=n(5723);const c=t.keyframes`
...
`;function p({iconKey:a}){const e=a?s.t[a]??l.A:l.A;return(0,d.jsx)(e,{size:14,strokeWidth:1.75})}function y({entries:a,activeId:e,onSelect:n}){return(0,d.jsx)(d.Fragment,{children:a.map(a=>a.children?(0,d.jsx)(o.Fragment,{children:(0,d.jsx)(y,{entries:a.children,activeId:e,onSelect:n})},a.id):(0,d.jsxs)(f,{active:e===a.id,onClick:()=>n(a),children:[(0,d.jsx)(p,{iconKey:a.icon}),a.name]},a.id))})}function h({activeId:a}){const{flyout:e,scheduleFlyoutClose:n,cancelFlyoutClose:o}=(0,m.c)();if(!e)return null;const i=e.entry.icon?s.t[e.entry.icon]??l.A:l.A;return(0,d.jsxs)(g,{anchorY:e.anchorY,onMouseEnter:o,onMouseLeave:n,children:[(0,d.jsxs)(u,{children:[(0,d.jsx)(i,{size:13,strokeWidth:2}),e.entry.name]}),(0,d.jsx)(y,{entries:e.entry.children??[],activeId:a,onSelect:a=>{e.onSelect(a),n()}})]})}},5959(a,e,n){n.d(e,{I:()=>i,c:()=>t});var o=n(7359);const i=(0,o.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),t=()=>(0,o.useContext)(i)},5185(a,e,n){n.d(e,{t:()=>U});var o=n(9510),i=n(9038),t=n(8207),l=n(6896),r=n(7901),m=n(9848),s=n(2164),d=n(3775),c=n(3539),g=n(1783),u=n(1837),f=n(2314),p=n(5751),y=n(255),h=n(9633),z=n(2946),x=n(822),b=n(6720),w=n(3317),A=n(2709),v=n(3517),M=n(7032),$=n(6949),k=n(8218),S=n(6829),j=n(5553),B=n(9591),T=n(2820),C=n(4621),E=n(6673),P=n(9033),L=n(1365),F=n(5912),R=n(8641),G=n(3249),I=n(1821),N=n(9161),K=n(1849),D=n(7747),_=n(2932),H=n(4525),V=n(7230);const U={activity:l.A,"bar-chart-2":o.A,book:m.A,"book-open":r.A,calendar:d.A,clock:g.A,"circle-dot":c.A,feather:f.A,"file-text":p.A,globe:b.A,hash:w.A,heart:A.A,landmark:v.A,layers:t.A,leaf:$.A,map:B.A,package:E.A,compass:u.A,"git-branch":z.A,github:x.A,minus:C.A,terminal:G.A,thermometer:I.A,users:K.A,wind:D.A,"pie-chart":i.A,plus:L.A,slash:F.A,star:R.A,zap:V.A,bot:s.A,lightbulb:k.A,"message-square":T.A,wrench:_.A,x:H.A,"layout-grid":M.A,list:S.A,file:y.A,folder:h.A,"map-pin":j.A,"pen-tool":P.A,type:N.A}},906(a,e,n){n.d(e,{rh:()=>D,PE:()=>v,CD:()=>I,qs:()=>Y,$L:()=>H,w3:()=>_,u6:()=>V,w4:()=>o.w});var o=n(217),i=n(7359),t=n(3233),l=n(5723);t.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,w=t.default.main`
  ...
  display: flex;
  flex-direction: column;
`,A="atlantis:sidebar-collapsed";function v({sidebar:a,children:e,topBarRight:o,title:t="Atlantis",activeId:s=null}){const[d,v]=(0,i.useState)(()=>{try{return"true"===localStorage.getItem(A)}catch{return!1}}),[M,$]=(0,i.useState)(null),k=(0,i.useRef)(),S=()=>v(a=>{const e=!a;try{localStorage.setItem(A,String(e))}catch{}return e}),j=i.useMemo(()=>i.lazy(()=>Promise.resolve().then(n.bind(n,4914)).then(a=>({default:a.FlyoutPanel}))),[]);return(0,l.jsx)(m.I.Provider,{value:{collapsed:d,toggle:S,flyout:M,openFlyout:(a,e,n)=>{clearTimeout(k.current),$({entry:a,anchorY:e,onSelect:n})},scheduleFlyoutClose:()=>{k.current=setTimeout(()=>$(null),160)},cancelFlyoutClose:()=>clearTimeout(k.current)},children:(0,l.jsxs)(z,{children:[(0,l.jsxs)(c,{children:[(0,l.jsx)(g,{children:(0,l.jsx)(u,{onClick:S,title:d?"Expand sidebar":"Collapse sidebar",children:(0,l.jsx)(r.A,{size:17})})}),(0,l.jsxs)(f,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:["Atl",(0,l.jsx)("span",{children:"antis"})]}),t&&(0,l.jsx)(p,{children:t}),o&&(0,l.jsx)(y,{children:o})]}),(0,l.jsxs)(h,{children:[(0,l.jsx)(x,{collapsed:d,children:(0,l.jsx)(b,{children:a})}),(0,l.jsx)(w,{children:e})]}),M&&(0,l.jsx)(i.Suspense,{fallback:null,children:(0,l.jsx)(j,{activeId:s})})]})})}var M=n(255),$=n(9753),k=n(5185);const S=t.default.div`
  display: grid;
...
`;function R({iconKey:a,size:e=16}){if(a&&!(a in k.t))return(0,l.jsx)("span",{style:{fontSize:e,lineHeight:1,display:"flex",alignItems:"center"},children:a});const n=a?k.t[a]??M.A:M.A;return(0,l.jsx)(n,{size:e,strokeWidth:1.75})}function G({entry:a,activeId:e,onSelect:n}){const[o,t]=(0,i.useState)(a.defaultOpen??!0),{collapsed:r,openFlyout:s,scheduleFlyoutClose:d,cancelFlyoutClose:c}=(0,m.c)();return a.children&&a.children.length>0?(0,l.jsxs)(T,{children:[(0,l.jsxs)(C,{collapsed:r,onClick:()=>{r||t(a=>!a)},onMouseEnter:r?e=>{const o=e.currentTarget.getBoundingClientRect();s(a,o.top,n)}:void 0,onMouseLeave:r?d:void 0,children:[(0,l.jsxs)(E,{collapsed:r,children:[(0,l.jsx)(R,{iconKey:a.icon,size:16}),(0,l.jsx)(P,{collapsed:r,children:a.name})]}),(0,l.jsx)(L,{open:o,collapsed:r,children:(0,l.jsx)($.A,{size:13})})]}),(0,l.jsx)(S,{open:o&&!r,children:(0,l.jsx)(j,{children:(0,l.jsx)(B,{children:a.children.map(a=>(0,l.jsx)(G,{entry:a,activeId:e,onSelect:n},a.id))})})})]}):(0,l.jsxs)(F,{active:e===a.id,collapsed:r,onClick:()=>n(a),onMouseEnter:r?e=>{const o=e.currentTarget.getBoundingClientRect();s({id:a.id,name:a.name,icon:a.icon,file:a.file,children:[a]},o.top,n)}:void 0,onMouseLeave:r?d:void 0,children:[(0,l.jsx)(R,{iconKey:a.icon,size:15}),(0,l.jsx)(P,{collapsed:r,children:a.name})]})}function I({entries:a,activeId:e,onSelect:n}){return(0,l.jsx)("div",{children:a.map(a=>(0,l.jsx)(G,{entry:a,activeId:e,onSelect:n},a.id))})}const N=n(7207).keyframes`
...
`,p=i.default.div`
  ...
  flex-shrink: 0;
`,y=[{label:"0–14",color:"#3fb950"},{label:"15–24",color:"#7ee787"},{label:"25–37",color:"#d29922"},{label:"38–49",color:"#f0883e"},{label:"50+",color:"#f85149"}];function h({cx:a,cy:e,deg:n,size:o=7}){return(0,l.jsx)("g",{transform:`translate(${a},${e}) rotate(${n})`,children:(0,l.jsx)("polygon",{points:`0,${-o} ${.55*o},${.6*o} 0,${.2*o} ${.55*-o},${.6*o}`,fill:s,opacity:.85})})}const z=i.default.div`
...
`,x=i.default.div`
  ...
  margin-bottom: 6px;
`;function b({speeds:a}){const e=14,n=28,o=52,i=Math.max(...a,1),t=5*Math.ceil(i/5),r=a.map((e,i)=>({x:n+i/(a.length-1)*232,y:66-e/t*o})),m=function(a,e=.35){if(a.length<2)return"";let n=`M ${a[0].x.toFixed(2)} ${a[0].y.toFixed(2)}`;for(let o=0;o<a.length-1;o++){const i=a[Math.max(o-1,0)],t=a[o],l=a[o+1],r=a[Math.min(o+2,a.length-1)],m=t.x+(l.x-i.x)*e,s=t.y+(l.y-i.y)*e,d=l.x-(r.x-t.x)*e,c=l.y-(r.y-t.y)*e;n+=` C ${m.toFixed(2)} ${s.toFixed(2)} ${d.toFixed(2)} ${c.toFixed(2)} ${l.x.toFixed(2)} ${l.y.toFixed(2)}`}return n}(r),g=`${m} L ${r[r.length-1].x.toFixed(2)} ${66..toFixed(2)} L ${r[0].x.toFixed(2)} ${66..toFixed(2)} Z`,u=[0,6,12,18,23].map(e=>({label:23===e?"24h":`${e}h`,x:n+e/(a.length-1)*232})),f=[{label:`${t}`,y:e},{label:`${Math.round(t/2)}`,y:40},{label:"0",y:66}];return(0,l.jsxs)("svg",{viewBox:"0 0 268 88",width:"100%",style:{display:"block",overflow:"visible"},children:[(0,l.jsx)("defs",{children:(0,l.jsxs)("linearGradient",{id:"windGrad",x1:"0",y1:"0",x2:"0",y2:"1",children:[(0,l.jsx)("stop",{offset:"0%",stopColor:s,stopOpacity:.3}),(0,l.jsx)("stop",{offset:"100%",stopColor:s,stopOpacity:0})]})}),f.map(({y:a})=>(0,l.jsx)("line",{x1:n,y1:a,x2:260,y2:a,stroke:d,strokeWidth:1},a)),(0,l.jsx)("path",{d:g,fill:"url(#windGrad)"}),(0,l.jsx)("path",{d:m,fill:"none",stroke:s,strokeWidth:1.5,strokeLinejoin:"round"}),(()=>{const a=(new Date).getHours(),e=r[Math.min(a,r.length-1)];return(0,l.jsx)("circle",{cx:e.x,cy:e.y,r:3,fill:s})})(),u.map(({label:a,x:e})=>(0,l.jsx)("text",{x:e,y:84,textAnchor:"middle",fill:c,fontSize:9,fontFamily:"monospace",children:a},a)),f.map(({label:a,y:e})=>(0,l.jsx)("text",{x:24,y:e+3,textAnchor:"end",fill:c,fontSize:9,fontFamily:"monospace",children:a},a))]})}function w({speeds:a,directions:e,dayLabels:n}){const o=a.length,i=Math.max(...a,1),t=5*Math.ceil(i/5),r=252/o,m=.28*r;return(0,l.jsxs)(l.Fragment,{children:[(0,l.jsxs)("svg",{viewBox:"0 0 268 110",width:"100%",style:{display:"block",overflow:"visible"},children:[(0,l.jsx)("line",{x1:8,y1:90,x2:260,y2:90,stroke:d,strokeWidth:1}),a.map((a,o)=>{const i=a/t*60,s=8+o*r+m/2,d=r-m,u=90-i,f=s+d/2,p=function(a){let e=g[0].color;for(const n of g){if(!(a>=n.threshold))break;e=n.color}return e}(a);return(0,l.jsxs)("g",{children:[(0,l.jsx)(h,{cx:f,cy:7,deg:e[o],size:6}),(0,l.jsx)("text",{x:f,y:23,textAnchor:"middle",fill:p,fontSize:8,fontWeight:"600",fontFamily:"monospace",children:Math.round(a)}),(0,l.jsx)("rect",{x:s,y:u,width:d,height:i,fill:p,opacity:.85,rx:2}),(0,l.jsx)("text",{x:f,y:106,textAnchor:"middle",fill:c,fontSize:9,fontFamily:"monospace",children:n[o]})]},o)}),(0,l.jsx)("text",{x:260,y:88,textAnchor:"end",fill:c,fontSize:8,fontFamily:"monospace",children:"km/h"})]}),(0,l.jsx)(u,{children:y.map(({label:a,color:e})=>(0,l.jsxs)(f,{children:[(0,l.jsx)(p,{color:e}),a]},a))})]})}const A=i.default.div`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
...
`,V=i.default.div`
  ...
  font-size: ${t.w4.typography.fontSizeSm};
  font-family: ${t.w4.typography.fontFamily};
`;function U({place:a,onClose:e}){const[n,i]=(0,o.useState)(null),[s,d]=(0,o.useState)(!1),[c,g]=(0,o.useState)(null),[u,f]=(0,o.useState)(0);(0,o.useEffect)(()=>{if(!a)return void i(null);d(!0),g(null),i(null);const e=`https://api.open-meteo.com/v1/forecast?latitude=${a.lat}&longitude=${a.lng}&current_weather=true&hourly=windspeed_10m,winddirection_10m&daily=weathercode,temperature_2m_max,temperature_2m_min,precipitation_sum,windspeed_10m_max,winddirection_10m_dominant&timezone=auto&forecast_days=7`;fetch(e).then(a=>{if(!a.ok)throw new Error(`HTTP ${a.status}`);return a.json()}).then(a=>{i(a),d(!1)}).catch(a=>{g(a.message),d(!1)})},[a?.id,u]);const p=n?r(n.current_weather.weathercode):null,y=n?n.hourly.windspeed_10m.slice(0,24):[];return(0,l.jsxs)(A,{visible:!!a,children:[(0,l.jsxs)(v,{children:[(0,l.jsx)(M,{children:a?.name??""}),(0,l.jsx)($,{onClick:e,title:"Close",children:"✕"})]}),(0,l.jsxs)(k,{children:[s&&(0,l.jsx)(V,{children:"Loading weather…"}),c&&(0,l.jsxs)(V,{children:[(0,l.jsx)("div",{children:"Weather unavailable — the API may be temporarily down."}),(0,l.jsx)("button",{onClick:()=>f(a=>a+1),style:{marginTop:12,padding:"6px 16px",cursor:"pointer",background:"none",border:`1px solid ${t.w4.colors.border}`,borderRadius:6,color:t.w4.colors.mainText,fontFamily:"inherit",fontSize:12},children:"Retry"})]}),n&&p&&(0,l.jsxs)(l.Fragment,{children:[(0,l.jsxs)(S,{children:[(0,l.jsxs)(j,{children:[(0,l.jsxs)("div",{children:[(0,l.jsxs)(T,{children:[Math.round(n.current_weather.temperature),"°C"]}),(0,l.jsx)(C,{children:p.label})]}),(0,l.jsx)(B,{children:p.emoji})]}),(0,l.jsxs)(E,{children:[(0,l.jsxs)(P,{children:["💨 ",Math.round(n.current_weather.windspeed)," km/h"]}),(0,l.jsxs)(P,{children:["🌡 ",Math.round(n.daily.temperature_2m_max[0]),"° / ",Math.round(n.daily.temperature_2m_min[0]),"°"]})]})]}),(0,l.jsxs)("div",{children:[(0,l.jsx)(L,{children:"Wind today (hourly)"}),(0,l.jsxs)(z,{children:[(0,l.jsx)(x,{children:"Speed km/h · dot = current hour"}),(0,l.jsx)(b,{speeds:y})]})]}),(0,l.jsxs)("div",{children:[(0,l.jsx)(L,{children:"Wind this week (daily max)"}),(0,l.jsxs)(z,{children:[(0,l.jsx)(x,{children:"Max speed km/h · arrows = dominant direction"}),(0,l.jsx)(w,{speeds:n.daily.windspeed_10m_max,directions:n.daily.winddirection_10m_dominant,dayLabels:n.daily.time.map((a,e)=>0===e?"Today":new Date(a).toLocaleDateString("en-GB",{weekday:"short"}))})]})]}),(0,l.jsxs)("div",{children:[(0,l.jsx)(L,{children:"7-Day Forecast"}),n.daily.time.map((a,e)=>{const{emoji:o,label:i}=r(n.daily.weathercode[e]);return(0,l.jsxs)(F,{children:[(0,l.jsx)(R,{children:o}),(0,l.jsxs)(G,{children:[(0,l.jsx)(I,{children:m(a,e)}),(0,l.jsx)(N,{children:i})]}),(0,l.jsx)(H,{children:n.daily.precipitation_sum[e]>0&&(0,l.jsxs)(l.Fragment,{children:["💧 ",n.daily.precipitation_sum[e].toFixed(1)]})}),(0,l.jsxs)(K,{children:[(0,l.jsxs)(D,{children:[Math.round(n.daily.temperature_2m_max[e]),"°"]}),(0,l.jsxs)(_,{children:[Math.round(n.daily.temperature_2m_min[e]),"°"]})]})]},a)})]})]})]})]})}}}]);
//# sourceMappingURL=794.743b4f2dc0cd390a3509.js.map