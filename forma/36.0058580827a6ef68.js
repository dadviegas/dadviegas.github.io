"use strict";(self.webpackChunk_atlantis_forma=self.webpackChunk_atlantis_forma||[]).push([["36"],{7103(e,o,t){t.d(o,{j:()=>h});var r=t(5723),a=t(7991),i=t(6859),n=t.n(i),s=t(4764),l=t(5030),d=t(6527);let c=n().section`
...
Give 3–5 bullets: what's going well, what to fix, one specific next-meal suggestion.`);await (0,d.askGroqStream)(h,{key:x,locale:t,maxTokens:400,onChunk:e=>u(e)})}catch(e){$(e instanceof Error?e.message:o("forma.ask.error"))}finally{b(!1)}},[e,t,o]);return null===i||!1===i?null:(0,r.jsxs)(c,{children:[(0,r.jsxs)(p,{children:[(0,r.jsxs)(g,{children:["✦ ",o("forma.ask.title")]}),(0,r.jsx)(l.$n,{variant:"accent",icon:(0,r.jsx)(l.In,{name:"message",size:14}),onClick:()=>void v(),disabled:w,children:w?o("forma.ask.loading"):o("forma.ask.button")})]}),y&&(0,r.jsx)(x,{children:y}),(m||w)&&(0,r.jsx)(f,{children:m||"…"}),!m&&!w&&!y&&(0,r.jsx)(f,{style:{color:s.w4.colors.mainTextMuted,fontStyle:"italic"},children:o("forma.ask.hint")})]})}},2552(e,o,t){t.d(o,{k:()=>z});var r=t(5723),a=t(7991),i=t(6859),n=t.n(i),s=t(4764),l=t(5030),d=t(6527);let c="#7fb77e",p=2*Math.PI*95,g=n().div`
  display: flex;
  flex-direction: column;
  align-items: center;
  gap: ${s.w4.spacing.md};
...
`,M=n().span`
  ...
  text-transform: uppercase;
  letter-spacing: 0.16em;
`;function z({data:e,t:o,onStart:t,onStop:i,onEditStart:n}){let j,T,F,S,C,[H,R]=(0,a.useState)(Date.now),A=e.sessions.some(e=>void 0===e.endedAt);(0,a.useEffect)(()=>{if(!A)return;let e=setInterval(()=>R(Date.now()),1e3);return()=>clearInterval(e)},[A]);let L=(0,d.currentFast)(e,H),D=L?.percent??0,E=null!==L,B=L?L.hoursElapsed:0,I=L?L.remainingMs:0,W=L?L.session.targetHours:e.goal.targetHours;return(0,r.jsxs)(g,{children:[(0,r.jsxs)(f,{children:[(0,r.jsxs)(x,{width:200,height:200,viewBox:"0 0 200 200","aria-hidden":"true",children:[(0,r.jsx)("circle",{cx:100,cy:100,r:95,fill:"none",stroke:s.w4.colors.border,strokeWidth:10}),(0,r.jsx)("circle",{cx:100,cy:100,r:95,fill:"none",stroke:c,strokeWidth:10,strokeLinecap:"round",strokeDasharray:p,strokeDashoffset:p*(1-D),style:{transition:"stroke-dashoffset 0.6s ease"}})]}),(0,r.jsx)(h,{children:E?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(m,{children:[B.toFixed(1),"h"]}),(0,r.jsx)(u,{children:o("forma.timer.elapsed")})]}):(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(m,{children:[W,"h"]}),(0,r.jsx)(u,{children:o("forma.hero.notFasting")})]})})]}),E&&L&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(y,{children:[(0,r.jsx)(w,{children:L.session.protocol}),n&&(0,r.jsx)($,{type:"button",onClick:()=>n(L.session),title:o("forma.timer.editStart"),children:o("forma.timer.startedAt",{time:(T=String((j=new Date(L.session.startedAt)).getHours()).padStart(2,"0"),F=String(j.getMinutes()).padStart(2,"0"),`${T}:${F}`)})})]}),(0,r.jsxs)(b,{children:[(0,r.jsxs)(v,{children:[(0,r.jsx)(k,{children:(C=Math.floor((S=Math.floor(I/6e4))/60),`${String(C).padStart(2,"0")}:${String(S%60).padStart(2,"0")}`)}),(0,r.jsx)(M,{children:o("forma.timer.remaining")})]}),(0,r.jsxs)(v,{children:[(0,r.jsxs)(k,{children:[Math.round(100*D),"%"]}),(0,r.jsx)(M,{children:o("forma.timer.complete")})]})]})]}),E&&L?(0,r.jsx)(l.$n,{variant:"danger",onClick:()=>i(L.session),children:o("forma.stop")}):(0,r.jsx)(l.$n,{variant:"success",onClick:t,children:o("forma.start")})]})}},9276(e,o,t){t.d(o,{Y:()=>C});var r=t(5723),a=t(7991),i=t(6859),n=t.n(i),s=t(4764),l=t(5030),d=t(2799);let c=(0,d.keyframes)`
...
`,u=n().div`
  flex: 1;
  min-height: 60px;
`;function w({data:e,t:o,onClick:t}){let i=(0,a.useMemo)(()=>(0,l.weightForecast)(e.weights,60,30),[e.weights]),n=i.history.length>0?i.history[i.history.length-1]:null,c=i.forecast.length>0?i.forecast[i.forecast.length-1]:null,b=n&&c?c.kg-n.kg:0;return(0,r.jsxs)(p,{onClick:t,"aria-label":o("forma.miniWeight.aria"),children:[(0,r.jsxs)(g,{children:[(0,r.jsxs)(f,{children:["◉ ",o("forma.miniWeight.title")]}),c&&(0,r.jsxs)(m,{pos:b>0,children:[b>=0?"+":"",b.toFixed(1),"kg / 30d"]})]}),(0,r.jsxs)(x,{children:[(0,r.jsx)(h,{children:n?n.kg.toFixed(1):"—"}),(0,r.jsx)("span",{style:{color:s.w4.colors.mainTextMuted,fontSize:13,fontFamily:s.w4.typography.fontFamilyMono},children:"kg"}),c&&(0,r.jsxs)("span",{style:{color:s.w4.colors.mainTextMuted,fontSize:12,fontFamily:s.w4.typography.fontFamilyMono},children:["→ ",c.kg.toFixed(1)," kg"]})]}),(0,r.jsx)(u,{children:(0,r.jsx)(d.h,{forecast:i,axes:!1})})]})}},8477(e,o,t){t.d(o,{P:()=>p});var r=t(5723),a=t(6859),i=t.n(a),n=t(4764);let s="#7fb77e",l=["16:8","18:6","20:4","custom"],d=i().div`
  display: flex;
  gap: ${n.w4.spacing.sm};
  overflow-x: auto;
...
`,u=n().span`
  ...
  color: ${d};
  align-self: center;
`;function w({data:e,t:o,onSave:t}){let[i,n]=(0,a.useState)(String(e.goal.proteinG??110)),[s,d]=(0,a.useState)(String(e.goal.kcal??2200)),[b,y]=(0,a.useState)(String(e.goal.walkMin??30)),[$,v]=(0,a.useState)(String(e.goal.weightKg??"")),[k,M]=(0,a.useState)(String(e.goal.targetHours)),[z,j]=(0,a.useState)(String(e.goal.weeklyFasts)),[T,F]=(0,a.useState)(!1),S=async()=>{let o={...e,goal:{targetHours:Number(k)||16,weeklyFasts:Number(z)||5,proteinG:Number(i)||void 0,kcal:Number(s)||void 0,walkMin:Number(b)||void 0,weightKg:$?Number($):void 0}};await t(o),F(!0),setTimeout(()=>F(!1),2e3)};return(0,r.jsxs)(c,{children:[(0,r.jsxs)(p,{children:[(0,r.jsxs)(g,{children:["◉ ",o("forma.settings.foodGoals")]}),(0,r.jsxs)(f,{children:[(0,r.jsx)(x,{children:o("forma.settings.proteinG")}),(0,r.jsx)(h,{type:"number",value:i,onChange:e=>n(e.target.value)})]}),(0,r.jsxs)(f,{children:[(0,r.jsx)(x,{children:o("forma.settings.kcal")}),(0,r.jsx)(h,{type:"number",value:s,onChange:e=>d(e.target.value)})]}),(0,r.jsxs)(f,{children:[(0,r.jsx)(x,{children:o("forma.settings.walkMin")}),(0,r.jsx)(h,{type:"number",value:b,onChange:e=>y(e.target.value)})]}),(0,r.jsxs)(f,{children:[(0,r.jsx)(x,{children:o("forma.settings.weightTarget")}),(0,r.jsx)(h,{type:"number",step:"0.1",value:$,onChange:e=>v(e.target.value)})]})]}),(0,r.jsxs)(p,{children:[(0,r.jsxs)(g,{children:["◉ ",o("forma.settings.fastingGoals")]}),(0,r.jsxs)(f,{children:[(0,r.jsx)(x,{children:o("forma.settings.targetHours")}),(0,r.jsx)(h,{type:"number",value:k,onChange:e=>M(e.target.value)})]}),(0,r.jsxs)(f,{children:[(0,r.jsx)(x,{children:o("forma.settings.weeklyFasts")}),(0,r.jsx)(h,{type:"number",value:z,onChange:e=>j(e.target.value)})]})]}),(0,r.jsxs)(m,{children:[T&&(0,r.jsx)(u,{children:o("forma.settings.saved")}),(0,r.jsx)(l.$n,{variant:"primary",onClick:()=>void S(),children:o("forma.settings.save")})]})]})}},5742(e,o,t){t.d(o,{_:()=>F});var r=t(5723),a=t(6859),i=t.n(a),n=t(4764),s=t(5030),l=t(6527);let d="#7fb77e",c=i().section`
...
`;function g({forecast:e,axes:o=!0}){let t=(0,a.useMemo)(()=>[...e.history,...e.forecast],[e.history,e.forecast]);if(t.length<2)return(0,r.jsx)(d,{children:(0,r.jsx)("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",height:"100%",color:s.w4.colors.mainTextMuted,fontSize:12,fontFamily:s.w4.typography.fontFamilyMono},children:"—"})});let i=o?36:8,n=o?18:4,f=t.map(e=>e.kg),x=Math.min(...f),h=Math.max(...f),m=h-x||1,u=new Date(t[0].date).getTime(),w=new Date(t[t.length-1].date).getTime()-u||1,b=e=>i+(new Date(e).getTime()-u)/w*(600-2*i),y=e=>200-n-(e-x)/m*(200-2*n),$=e.history.map((e,o)=>`${0===o?"M":"L"} ${b(e.date).toFixed(1)} ${y(e.kg).toFixed(1)}`).join(" "),v=e.forecast.length?`M ${b(e.history[e.history.length-1].date).toFixed(1)} ${y(e.history[e.history.length-1].kg).toFixed(1)} `+e.forecast.map(e=>`L ${b(e.date).toFixed(1)} ${y(e.kg).toFixed(1)}`).join(" "):"",k=e.history[e.history.length-1],M=e.forecast[e.forecast.length-1];return(0,r.jsx)(d,{children:(0,r.jsxs)(c,{viewBox:"0 0 600 200",preserveAspectRatio:"none",children:[o&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(p,{x:4,y:n+4,children:h.toFixed(1)}),(0,r.jsx)(p,{x:4,y:200-n+4,children:x.toFixed(1)}),(0,r.jsx)("line",{x1:i,y1:200-n,x2:600-i,y2:200-n,stroke:s.w4.colors.border,strokeWidth:1}),(0,r.jsx)("line",{x1:i,y1:n,x2:i,y2:200-n,stroke:s.w4.colors.border,strokeWidth:1})]}),(0,r.jsx)("path",{d:$,fill:"none",stroke:l,strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"}),v&&(0,r.jsx)("path",{d:v,fill:"none",stroke:l,strokeWidth:2,strokeDasharray:"4 4",strokeLinecap:"round",opacity:.65}),M&&(0,r.jsx)("circle",{cx:b(M.date),cy:y(M.kg),r:3,fill:l,opacity:.7}),k&&(0,r.jsx)("circle",{cx:b(k.date),cy:y(k.kg),r:4,fill:l,stroke:s.w4.colors.surface,strokeWidth:1.5})]})})}},2152(e,o,t){t.d(o,{m:()=>M});var r=t(5723),a=t(7991),i=t(6859),n=t.n(i),s=t(4764),l=t(5030),d=t(6527),c=t(1533);let p="#7fb77e",g=n().section`
  display: flex;
  flex-direction: column;
  gap: ${s.w4.spacing.lg};
`,f=n().div`
