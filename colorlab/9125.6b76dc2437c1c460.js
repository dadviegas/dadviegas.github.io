"use strict";(self.webpackChunk_atlantis_colorlab=self.webpackChunk_atlantis_colorlab||[]).push([["9125"],{5628(o,e,a){function t(o){let e=o.replace("#","");if(3===e.length){let o=parseInt(e[0]+e[0],16);return{r:o,g:parseInt(e[1]+e[1],16),b:parseInt(e[2]+e[2],16)}}if(6===e.length){let o=parseInt(e.slice(0,2),16);return{r:o,g:parseInt(e.slice(2,4),16),b:parseInt(e.slice(4,6),16)}}return null}function r(o,e,a){return"#"+[o,e,a].map(o=>Math.round(Math.max(0,Math.min(255,o))).toString(16).padStart(2,"0")).join("")}function i(o,e,a){let t=o/255,r=e/255,i=a/255,n=Math.max(t,r,i),l=Math.min(t,r,i),s=(n+l)/2;if(n===l)return{h:0,s:0,l:Math.round(100*s)};let d=n-l;return{h:Math.round(360*(n===t?((r-i)/d+6*(r<i))/6:n===r?((i-t)/d+2)/6:((t-r)/d+4)/6)),s:Math.round(100*(s>.5?d/(2-n-l):d/(n+l))),l:Math.round(100*s)}}function n(o,e,a){let t=a/100,r=e/100*(1-Math.abs(2*t-1)),i=r*(1-Math.abs(o/60%2-1)),n=t-r/2,l=0,s=0,d=0;return o<60?(l=r,s=i,d=0):o<120?(l=i,s=r,d=0):o<180?(l=0,s=r,d=i):o<240?(l=0,s=i,d=r):o<300?(l=i,s=0,d=r):(l=r,s=0,d=i),{r:Math.round((l+n)*255),g:Math.round((s+n)*255),b:Math.round((d+n)*255)}}function l(o,e,a){let t=o=>{let e=o/255;return e<=.04045?e/12.92:Math.pow((e+.055)/1.055,2.4)};return .2126*t(o)+.7152*t(e)+.0722*t(a)}function s(o,e){let a=l(o.r,o.g,o.b),t=l(e.r,e.g,e.b);return parseFloat(((Math.max(a,t)+.05)/(Math.min(a,t)+.05)).toFixed(2))}function d(o,e){return[10,20,30,40,50,60,70,80,90].map(a=>({h:o,s:Math.min(e,90),l:a}))}function c(o,e,a){return{h:(o+180)%360,s:e,l:a}}function p(o,e,a){return[{h:(o+30)%360,s:e,l:a},{h:(o-30+360)%360,s:e,l:a}]}function g(o,e,a){return[{h:o,s:e,l:a},{h:(o+120)%360,s:e,l:a},{h:(o+240)%360,s:e,l:a}]}a.d(e,{E2:()=>t,Hg:()=>c,K6:()=>i,Lt:()=>g,Ob:()=>r,YL:()=>n,eM:()=>s,iW:()=>d,mW:()=>p})},7330(o,e,a){a.d(e,{FlyoutPanel:()=>oL});var t=a(5723),r=a(7991),i=a.n(r),n=a(6859),l=a.n(n),s=a(2799),d=a(1316),c=a(814),p=a(6896),g=a(7902),m=a(3013),f=a(2887),x=a(9510),h=a(9848),u=a(7901),b=a(3045),w=a(3775),y=a(1783),$=a(3539),v=a(9416),z=a(1837),k=a(7167),M=a(4494),A=a(2314),T=a(255),S=a(5751),F=a(9633),j=a(2946),B=a(822),H=a(6720),R=a(7400),L=a(8456),C=a(3317),P=a(2709),E=a(8006),V=a(9301),K=a(7561),I=a(3517),D=a(8207),Y=a(7032),N=a(6949),G=a(8218),O=a(6829),_=a(9591),W=a(5553),J=a(9923),Z=a(2820),U=a(4621),q=a(8479),X=a(2534),Q=a(6673),oo=a(7490),oe=a(9033),oa=a(9038),ot=a(5775),or=a(1365),oi=a(2937),on=a(9821),ol=a(5912),os=a(158),od=a(8641),oc=a(8607),op=a(3249),og=a(1821),om=a(5889),of=a(9655),ox=a(7170),oh=a(9161),ou=a(1849),ob=a(1604),ow=a(3142),oy=a(1187),o$=a(7747),ov=a(2932),oz=a(4525),ok=a(7230),oM=a(2164);let oA={activity:p.A,"a-large-small":g.A,apple:m.A,"arrow-right":f.A,"bar-chart-2":x.A,book:h.A,"book-open":u.A,briefcase:b.A,calendar:w.A,clock:y.A,"circle-dot":$.A,cloud:v.A,compass:z.A,cpu:k.A,droplets:M.A,feather:A.A,file:T.A,"file-text":S.A,folder:F.A,"git-branch":j.A,github:B.A,globe:H.A,grid:R.A,hand:L.A,hash:C.A,heart:P.A,key:E.A,hexagon:V.A,home:K.A,landmark:I.A,layers:D.A,"layout-grid":Y.A,leaf:N.A,lightbulb:G.A,list:O.A,map:_.A,"map-pin":W.A,"message-circle":J.A,"message-square":Z.A,minus:U.A,monitor:q.A,mountain:X.A,package:Q.A,palette:oo.A,"pen-tool":oe.A,"pie-chart":oa.A,plane:ot.A,plus:or.A,ruler:oi.A,shirt:on.A,slash:ol.A,square:os.A,star:od.A,sun:oc.A,terminal:op.A,thermometer:og.A,triangle:om.A,trophy:of.A,truck:ox.A,type:oh.A,users:ou.A,"volume-2":ob.A,watch:ow.A,waves:oy.A,wind:o$.A,wrench:ov.A,x:oz.A,zap:ok.A,bot:oM.A},oT=(0,s.keyframes)`
...
`,oB=({size:o=14,strokeWidth:e=1.75})=>(0,t.jsxs)("svg",{width:o,height:o,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:e,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,t.jsx)("polyline",{points:"14 2 14 8 20 8"})]});function oH({iconKey:o}){let e=o?oA[o]:null;return e?(0,t.jsx)(e,{size:14,strokeWidth:1.75}):(0,t.jsx)(oB,{})}function oR({entries:o,activeId:e,onSelect:a}){return(0,t.jsx)(t.Fragment,{children:o.map(o=>o.children?(0,t.jsx)(i().Fragment,{children:(0,t.jsx)(oR,{entries:o.children,activeId:e,onSelect:a})},o.id):(0,t.jsxs)(oj,{active:e===o.id,onClick:()=>a(o),children:[(0,t.jsx)(oH,{iconKey:o.icon}),o.name]},o.id))})}function oL({activeId:o}){let{flyout:e,scheduleFlyoutClose:a,cancelFlyoutClose:r}=(0,c.c)();if(!e)return null;let i=e.entry.icon?oA[e.entry.icon]:null;return(0,t.jsxs)(oS,{anchorY:e.anchorY,onMouseEnter:r,onMouseLeave:a,children:[(0,t.jsxs)(oF,{children:[i?(0,t.jsx)(i,{size:13,strokeWidth:2}):(0,t.jsx)(oB,{size:13,strokeWidth:2}),e.entry.name]}),(0,t.jsx)(oR,{entries:e.entry.children??[],activeId:o,onSelect:o=>{e.onSelect(o),a()}})]})}},814(o,e,a){a.d(e,{I:()=>r,c:()=>i});var t=a(7991);let r=(0,t.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),i=()=>(0,t.useContext)(r)},9874(o,e,a){a.d(e,{w4:()=>t.w4,cL:()=>c.c,PE:()=>j,Is:()=>H.putSetting,PL:()=>H.getSetting});var t=a(1316),r=a(5723),i=a(7991),n=a.n(i),l=a(6859),s=a.n(l);s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
