...
`,s().div`
  position: relative;
`;let I="260px",D="56px",N="44px",G=s().header`
  display: flex;
  align-items: center;
...
`,ob=s().span`
  font-size: ${n.w4.typography.fontSizeBase};
  color: ${n.w4.colors.mainTextMuted};
`;function oy({code:e}){let o=e.split("\n").map(e=>e.trim()).filter(e=>e&&e.includes("|")).map(e=>{let[o,a]=e.split("|").map(e=>e.trim());return{en:o??"",pt:a??""}}).filter(e=>e.en&&e.pt),a=(0,r.useRef)(null),i=(0,r.useRef)(!1),n=(0,r.useCallback)(e=>{a.current={x:e.touches[0].clientX,y:e.touches[0].clientY}},[]),l=(0,r.useCallback)((e,o)=>t=>{if(!a.current)return;let r=Math.abs(t.changedTouches[0].clientX-a.current.x),n=Math.abs(t.changedTouches[0].clientY-a.current.y);a.current=null,r>8||n>8||(i.current=!0,ol(e,o))},[]),s=(0,r.useCallback)((e,o)=>()=>{if(i.current){i.current=!1;return}ol(e,o)},[]);return o.length?(0,t.jsxs)(od,{children:[(0,t.jsxs)(oc,{children:[(0,t.jsx)(z,{name:"volume-2",size:12}),"Words to Listen / Palavras para Ouvir"]}),(0,t.jsx)(op,{children:o.map(e=>(0,t.jsxs)(og,{children:[(0,t.jsxs)(om,{accentColor:"#58a6ff",onTouchStart:n,onTouchEnd:l(e.en,"en"),onClick:s(e.en,"en"),title:`Listen: ${e.en}`,children:[(0,t.jsx)(ox,{accentColor:"#58a6ff",children:(0,t.jsx)(z,{name:"volume-2",size:16})}),(0,t.jsx)(ou,{children:e.en})]}),(0,t.jsxs)(of,{accentColor:"#3fb950",onTouchStart:n,onTouchEnd:l(e.pt,"pt"),onClick:s(e.pt,"pt"),title:`Ouvir: ${e.pt}`,children:[(0,t.jsx)(ox,{accentColor:"#3fb950",children:(0,t.jsx)(z,{name:"volume-2",size:16})}),(0,t.jsx)(ob,{children:e.pt})]})]},e.en))})]}):null}var ow=a(7223),o$=a(1426);let ov=s().div`
  margin: ${n.w4.spacing.lg} 0;
  border-radius: ${n.w4.borderRadius.md};
  border: 1px solid ${n.w4.colors.codeBorder};
  overflow: hidden;
...
`;function oF({type:e,children:o}){let a=oT[e]??oT.NOTE;return(0,t.jsxs)(oS,{bg:a.bg,border:a.border,children:[(0,t.jsxs)(oC,{color:a.color,children:[(0,t.jsx)(z,{name:a.icon,size:15,strokeWidth:2}),a.label]}),(0,t.jsx)(oB,{children:o})]})}let oL=s().nav`
  width: 220px;
  min-width: 220px;
...
`,o2=s().div`
  ...
  overflow-y: auto;
  overflow-x: hidden;
`;function o4({open:e,title:o,onClose:a,children:i}){return((0,r.useEffect)(()=>{if(!e)return;let o=e=>{"Escape"===e.key&&a()};return window.addEventListener("keydown",o),()=>window.removeEventListener("keydown",o)},[e,a]),e)?(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(oX,{onClick:a}),(0,t.jsxs)(oQ,{role:"dialog","aria-modal":"true","aria-label":o,children:[(0,t.jsxs)(o1,{children:[(0,t.jsx)(o0,{children:o}),(0,t.jsx)(w,{onClick:a,title:"Close menu","aria-label":"Close menu",children:(0,t.jsx)(z,{name:"close",size:14})})]}),(0,t.jsx)(o2,{children:i})]})]}):null}function o5(e,o){for(let a of e){if(a.id===o)return a;if(a.children){let e=o5(a.children,o);if(e)return e}}}function o3(e){return e.flatMap(e=>e.children?o3(e.children):e.file?[e]:[])}let o6=s().div`
  display: flex;
  align-items: center;
  justify-content: center;
  height: 100%;
