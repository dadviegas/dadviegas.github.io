"use strict";(self.webpackChunk_atlantis_cosmos=self.webpackChunk_atlantis_cosmos||[]).push([["765"],{8859(a,o,e){e.d(o,{FlyoutPanel:()=>x});var n=e(5723),i=e(7991),t=e.n(i),r=e(6859),l=e.n(r),c=e(2799),m=e(1316),d=e(814),s=e(6140);let g=(0,c.keyframes)`
...
`,u=l().div`
  ...
  z-index: 1200;
  background: ${m.w4.colors.surfaceRaised};
  border: 1px solid ${m.w4.colors.accentMuted};
  border-radius: ${m.w4.borderRadius.lg};
  box-shadow:
    0 0 0 1px ${m.w4.colors.borderSubtle},
...
`,p=l().div`
  ...
  border-bottom: 1px solid ${m.w4.colors.borderSubtle};
...
`,h=l().button`
  ...
  width: 100%;
  padding: 8px 14px;
  background: ${({active:a})=>a?m.w4.colors.accentMuted:"none"};
  border: none;
  box-shadow: inset 2px 0 0 ${({active:a})=>a?m.w4.colors.accent:"transparent"};
  color: ${({active:a})=>a?m.w4.colors.accent:m.w4.colors.sidebarText};
...
`,M=c().div`
  ...
  overflow: hidden;
`,A=c().aside`
  width: ${({collapsed:a})=>a?g:s};
  min-width: ${({collapsed:a})=>a?g:s};
  background: ${n.w4.colors.sidebarBg};
  border-right: 1px solid ${n.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,$=c().main`
  ...
  display: flex;
  flex-direction: column;
`,S=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function j(){return(0,i.jsx)(y,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:S.map((a,o)=>(0,i.jsx)(x,{index:o,accent:a.accent,children:a.char},o))})}let B="atlantis:sidebar-collapsed";function L({sidebar:a,children:o,topBarRight:n,title:l="Atlantis",activeId:c=null}){let[m,s]=(0,t.useState)(()=>{try{return"true"===localStorage.getItem(B)}catch{return!1}}),[g,u]=(0,t.useState)(null),z=(0,t.useRef)(),y=()=>s(a=>{let o=!a;try{localStorage.setItem(B,String(o))}catch{}return o}),x=r().useMemo(()=>r().lazy(()=>Promise.resolve().then(e.bind(e,8859)).then(a=>({default:a.FlyoutPanel}))),[]);return(0,i.jsx)(d.I.Provider,{value:{collapsed:m,toggle:y,flyout:g,openFlyout:(a,o,e)=>{clearTimeout(z.current),u({entry:a,anchorY:o,onSelect:e})},scheduleFlyoutClose:()=>{z.current=setTimeout(()=>u(null),160)},cancelFlyoutClose:()=>clearTimeout(z.current)},children:(0,i.jsxs)(M,{children:[(0,i.jsxs)(p,{children:[a&&(0,i.jsx)(h,{children:(0,i.jsx)(f,{onClick:y,title:m?"Expand sidebar":"Collapse sidebar",children:(0,i.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,i.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,i.jsx)("path",{d:"M9 3v18"})]})})}),(0,i.jsx)(j,{}),l&&(0,i.jsx)(b,{children:l}),n&&(0,i.jsx)(w,{children:n})]}),(0,i.jsxs)(v,{children:[null!=a&&(0,i.jsx)(A,{collapsed:m,children:(0,i.jsx)(k,{children:a})}),(0,i.jsx)($,{children:o})]}),g&&(0,i.jsx)(r().Suspense,{fallback:null,children:(0,i.jsx)(x,{activeId:c})})]})})}var T=e(6140);let E=c().div`
  display: grid;
...
`;function N({iconKey:a,size:o=16}){let e=a?T.X[a]:void 0;return e?(0,i.jsx)("svg",{width:o,height:o,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,dangerouslySetInnerHTML:{__html:e}}):a?(0,i.jsx)("span",{style:{fontSize:o,lineHeight:1,display:"flex",alignItems:"center"},children:a}):(0,i.jsxs)("svg",{width:o,height:o,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,children:[(0,i.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,i.jsx)("polyline",{points:"14 2 14 8 20 8"})]})}function D({entry:a,activeId:o,onSelect:e}){let[n,r]=(0,t.useState)(a.defaultOpen??!0),{collapsed:l,openFlyout:c,scheduleFlyoutClose:m,cancelFlyoutClose:s}=(0,d.c)();return a.children&&a.children.length>0?(0,i.jsxs)(H,{children:[(0,i.jsxs)(V,{collapsed:l,onClick:()=>{l||r(a=>!a)},onMouseEnter:l?o=>{c(a,o.currentTarget.getBoundingClientRect().top,e)}:void 0,onMouseLeave:l?m:void 0,children:[(0,i.jsxs)(R,{collapsed:l,children:[(0,i.jsx)(N,{iconKey:a.icon,size:16}),(0,i.jsx)(I,{collapsed:l,children:a.name})]}),(0,i.jsx)(F,{open:n,collapsed:l,children:(0,i.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round",children:(0,i.jsx)("path",{d:"M9 6l6 6-6 6"})})})]}),(0,i.jsx)(E,{open:n&&!l,children:(0,i.jsx)(C,{children:(0,i.jsx)(P,{children:a.children.map(a=>(0,i.jsx)(D,{entry:a,activeId:o,onSelect:e},a.id))})})})]}):(0,i.jsxs)(K,{active:o===a.id,collapsed:l,onClick:()=>e(a),onMouseEnter:l?o=>{let n=o.currentTarget.getBoundingClientRect();c({id:a.id,name:a.name,icon:a.icon,file:a.file,children:[a]},n.top,e)}:void 0,onMouseLeave:l?m:void 0,children:[(0,i.jsx)(N,{iconKey:a.icon,size:15}),(0,i.jsx)(I,{collapsed:l,children:a.name})]})}function G({entries:a,activeId:o,onSelect:e}){return(0,i.jsx)("div",{children:a.map(a=>(0,i.jsx)(D,{entry:a,activeId:o,onSelect:e},a.id))})}e(8859),c().button`
  display: flex;
  align-items: center;
  justify-content: center;
  width: 32px;
