...
`,b=t.default.div`
  ...
  opacity: 0;
  transition: opacity 0.15s;
`;function h({item:o,onSelect:a,onDelete:e}){const t=function(o){const a=`https://image.pollinations.ai/prompt/${encodeURIComponent(o.prompt)}?width=200&height=200&seed=${o.seed}&model=${o.model}&nologo=true`,[e,t]=(0,n.useState)(a);return(0,n.useEffect)(()=>{let a=null;return(0,s.if)(o.id).then(o=>{o&&(a=o,t(o))}),()=>{a&&URL.revokeObjectURL(a)}},[o.id]),e}(o);return(0,c.jsxs)(f,{onClick:a,children:[(0,c.jsx)(p,{src:t,alt:o.prompt,loading:"lazy",referrerPolicy:"no-referrer"}),(0,c.jsx)(y,{className:"delete-btn",role:"button",onClick:o=>{o.stopPropagation(),e()},children:(0,c.jsx)(l.A,{size:12})}),(0,c.jsx)(b,{className:"prompt-label",children:o.prompt})]})}function z({items:o,onSelect:a,onDelete:e}){return 0===o.length?null:(0,c.jsxs)(m,{children:[(0,c.jsx)(g,{children:"Recent Generations"}),(0,c.jsx)(u,{children:o.map(o=>(0,c.jsx)(h,{item:o,onSelect:()=>a(o),onDelete:()=>e(o.id)},o.id))})]})}},6345(o,a,e){e.d(a,{e:()=>A});var n=e(3233),t=e(7207),i=e(6879),r=e(153),l=e(889),s=e(9421),c=e(5723);const d=t.keyframes`
...
`;function A({url:o,status:a,width:e,height:n,onLoad:t,onError:i,onReroll:d,onRetry:m}){const A=e/n;return(0,c.jsxs)(g,{children:[(0,c.jsx)(u,{ratio:A,children:(0,c.jsxs)(f,{children:["idle"===a&&(0,c.jsxs)(b,{children:[(0,c.jsx)("span",{style:{fontSize:40,opacity:.3},children:"🎨"}),"Generate an image to get started"]}),"loading"===a&&(0,c.jsx)(p,{}),"error"===a&&(0,c.jsxs)(h,{children:[(0,c.jsx)(r.A,{size:32}),"Failed to generate image",(0,c.jsx)(w,{onClick:m,children:"Try Again"})]}),o&&("loaded"===a||"loading"===a)&&(0,c.jsx)(y,{src:o,alt:"Generated image",crossOrigin:"anonymous",referrerPolicy:"no-referrer",onLoad:o=>t(o.currentTarget),onError:i,style:{display:"loaded"===a?"block":"none"}})]})}),"loaded"===a&&(0,c.jsxs)(z,{className:"overlay",children:[(0,c.jsxs)(x,{onClick:()=>{o&&window.open(o,"_blank","noopener")},children:[(0,c.jsx)(l.A,{size:14})," Download"]}),(0,c.jsxs)(x,{onClick:d,children:[(0,c.jsx)(s.A,{size:14})," New Variation"]})]})]})}},2057(o,a,e){e.d(a,{q:()=>w});var n=e(3233),t=e(7207),i=e(6879),r=e(7071),l=e(3482),s=e(2569),c=e(5723);const d=t.keyframes`
