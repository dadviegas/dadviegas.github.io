...
`,w=i.default.main`
  ...
  display: flex;
  flex-direction: column;
`,v="atlantis:sidebar-collapsed";function $({sidebar:e,children:a,topBarRight:n,title:i="Atlantis",activeId:s=null}){const[c,$]=(0,t.useState)(()=>{try{return"true"===localStorage.getItem(v)}catch{return!1}}),[A,k]=(0,t.useState)(null),j=(0,t.useRef)(),S=()=>$(e=>{const a=!e;try{localStorage.setItem(v,String(a))}catch{}return a}),M=t.useMemo(()=>t.lazy(()=>Promise.resolve().then(o.bind(o,4914)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(d.I.Provider,{value:{collapsed:c,toggle:S,flyout:A,openFlyout:(e,a,o)=>{clearTimeout(j.current),k({entry:e,anchorY:a,onSelect:o})},scheduleFlyoutClose:()=>{j.current=setTimeout(()=>k(null),160)},cancelFlyoutClose:()=>clearTimeout(j.current)},children:(0,r.jsxs)(b,{children:[(0,r.jsxs)(m,{children:[(0,r.jsx)(g,{children:(0,r.jsx)(u,{onClick:S,title:c?"Expand sidebar":"Collapse sidebar",children:(0,r.jsx)(l.A,{size:17})})}),(0,r.jsxs)(p,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:["Atl",(0,r.jsx)("span",{children:"antis"})]}),i&&(0,r.jsx)(f,{children:i}),n&&(0,r.jsx)(y,{children:n})]}),(0,r.jsxs)(x,{children:[(0,r.jsx)(h,{collapsed:c,children:(0,r.jsx)(z,{children:e})}),(0,r.jsx)(w,{children:a})]}),A&&(0,r.jsx)(t.Suspense,{fallback:null,children:(0,r.jsx)(M,{activeId:s})})]})})}var A=o(255),k=o(9753),j=o(5185);const S=i.default.div`
  display: grid;
