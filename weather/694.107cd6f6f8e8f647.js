"use strict";(self.webpackChunk_atlantis_weather=self.webpackChunk_atlantis_weather||[]).push([["694"],{8859(a,e,o){o.d(e,{FlyoutPanel:()=>h});var n=o(5723),i=o(7991),t=o.n(i),r=o(6859),l=o.n(r),m=o(2799),s=o(255),c=o(1316),g=o(814),d=o(6140);let f=(0,m.keyframes)`
...
`;function z({iconKey:a}){let e=a?d.t[a]??s.A:s.A;return(0,n.jsx)(e,{size:14,strokeWidth:1.75})}function b({entries:a,activeId:e,onSelect:o}){return(0,n.jsx)(n.Fragment,{children:a.map(a=>a.children?(0,n.jsx)(t().Fragment,{children:(0,n.jsx)(b,{entries:a.children,activeId:e,onSelect:o})},a.id):(0,n.jsxs)(y,{active:e===a.id,onClick:()=>o(a),children:[(0,n.jsx)(z,{iconKey:a.icon}),a.name]},a.id))})}function h({activeId:a}){let{flyout:e,scheduleFlyoutClose:o,cancelFlyoutClose:i}=(0,g.c)();if(!e)return null;let t=e.entry.icon?d.t[e.entry.icon]??s.A:s.A;return(0,n.jsxs)(u,{anchorY:e.anchorY,onMouseEnter:i,onMouseLeave:o,children:[(0,n.jsxs)(p,{children:[(0,n.jsx)(t,{size:13,strokeWidth:2}),e.entry.name]}),(0,n.jsx)(b,{entries:e.entry.children??[],activeId:a,onSelect:a=>{e.onSelect(a),o()}})]})}},814(a,e,o){o.d(e,{I:()=>i,c:()=>t});var n=o(7991);let i=(0,n.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),t=()=>(0,n.useContext)(i)},6140(a,e,o){o.d(e,{t:()=>ab});var n=o(6896),i=o(7902),t=o(3013),r=o(2887),l=o(9510),m=o(9848),s=o(7901),c=o(3045),g=o(3775),d=o(1783),f=o(3539),u=o(9416),p=o(1837),y=o(7167),z=o(4494),b=o(2314),h=o(255),x=o(5751),w=o(9633),A=o(2946),$=o(822),v=o(6720),k=o(7400),S=o(8456),M=o(3317),B=o(2709),T=o(8006),E=o(9301),C=o(7561),j=o(3517),P=o(8207),L=o(7032),R=o(6949),G=o(8218),N=o(6829),F=o(9591),K=o(5553),I=o(9923),D=o(2820),H=o(4621),V=o(8479),Y=o(2534),U=o(6673),O=o(7490),_=o(9033),Z=o(9038),J=o(5775),W=o(1365),Q=o(2937),q=o(9821),X=o(5912),aa=o(158),ae=o(8641),ao=o(8607),an=o(3249),ai=o(1821),at=o(5889),ar=o(9655),al=o(7170),am=o(9161),as=o(1849),ac=o(1604),ag=o(3142),ad=o(1187),af=o(7747),au=o(2932),ap=o(4525),ay=o(7230),az=o(2164);let ab={activity:n.A,"a-large-small":i.A,apple:t.A,"arrow-right":r.A,"bar-chart-2":l.A,book:m.A,"book-open":s.A,briefcase:c.A,calendar:g.A,clock:d.A,"circle-dot":f.A,cloud:u.A,compass:p.A,cpu:y.A,droplets:z.A,feather:b.A,file:h.A,"file-text":x.A,folder:w.A,"git-branch":A.A,github:$.A,globe:v.A,grid:k.A,hand:S.A,hash:M.A,heart:B.A,key:T.A,hexagon:E.A,home:C.A,landmark:j.A,layers:P.A,"layout-grid":L.A,leaf:R.A,lightbulb:G.A,list:N.A,map:F.A,"map-pin":K.A,"message-circle":I.A,"message-square":D.A,minus:H.A,monitor:V.A,mountain:Y.A,package:U.A,palette:O.A,"pen-tool":_.A,"pie-chart":Z.A,plane:J.A,plus:W.A,ruler:Q.A,shirt:q.A,slash:X.A,square:aa.A,star:ae.A,sun:ao.A,terminal:an.A,thermometer:ai.A,triangle:at.A,trophy:ar.A,truck:al.A,type:am.A,users:as.A,"volume-2":ac.A,watch:ag.A,waves:ad.A,wind:af.A,wrench:au.A,x:ap.A,zap:ay.A,bot:az.A}},4117(a,e,o){o.d(e,{CD:()=>O,rh:()=>J,qs:()=>Q,PE:()=>C,rz:()=>aa});var n=o(1316),i=o(5723),t=o(7991),r=o.n(t),l=o(6859),m=o.n(l);m().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,m().div`
  position: relative;
`;var s=o(2799),c=o(3661),g=o(814);let d="260px",f="56px",u="48px",p=m().header`
  display: flex;
  align-items: center;
...
`,v=m().div`
  ...
  overflow: hidden;
`,k=m().aside`
  width: ${({collapsed:a})=>a?f:d};
  min-width: ${({collapsed:a})=>a?f:d};
  background: ${n.w4.colors.sidebarBg};
  border-right: 1px solid ${n.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,M=m().main`
  ...
  display: flex;
  flex-direction: column;
`,B=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function T(){return(0,i.jsx)(h,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:B.map((a,e)=>(0,i.jsx)(x,{index:e,accent:a.accent,children:a.char},e))})}let E="atlantis:sidebar-collapsed";function C({sidebar:a,children:e,topBarRight:n,title:l="Atlantis",activeId:m=null}){let[s,d]=(0,t.useState)(()=>{try{return"true"===localStorage.getItem(E)}catch{return!1}}),[f,u]=(0,t.useState)(null),b=(0,t.useRef)(),h=()=>d(a=>{let e=!a;try{localStorage.setItem(E,String(e))}catch{}return e}),x=r().useMemo(()=>r().lazy(()=>Promise.resolve().then(o.bind(o,8859)).then(a=>({default:a.FlyoutPanel}))),[]);return(0,i.jsx)(g.I.Provider,{value:{collapsed:s,toggle:h,flyout:f,openFlyout:(a,e,o)=>{clearTimeout(b.current),u({entry:a,anchorY:e,onSelect:o})},scheduleFlyoutClose:()=>{b.current=setTimeout(()=>u(null),160)},cancelFlyoutClose:()=>clearTimeout(b.current)},children:(0,i.jsxs)(v,{children:[(0,i.jsxs)(p,{children:[a&&(0,i.jsx)(y,{children:(0,i.jsx)(z,{onClick:h,title:s?"Expand sidebar":"Collapse sidebar",children:(0,i.jsx)(c.A,{size:17})})}),(0,i.jsx)(T,{}),l&&(0,i.jsx)(w,{children:l}),n&&(0,i.jsx)(A,{children:n})]}),(0,i.jsxs)($,{children:[null!=a&&(0,i.jsx)(k,{collapsed:s,children:(0,i.jsx)(S,{children:a})}),(0,i.jsx)(M,{children:e})]}),f&&(0,i.jsx)(r().Suspense,{fallback:null,children:(0,i.jsx)(x,{activeId:m})})]})})}var j=o(255),P=o(9753),L=o(6140);let R=m().div`
  display: grid;
...
`;function Y({iconKey:a,size:e=16}){if(a&&!(a in L.t))return(0,i.jsx)("span",{style:{fontSize:e,lineHeight:1,display:"flex",alignItems:"center"},children:a});let o=a?L.t[a]??j.A:j.A;return(0,i.jsx)(o,{size:e,strokeWidth:1.75})}function U({entry:a,activeId:e,onSelect:o}){let[n,r]=(0,t.useState)(a.defaultOpen??!0),{collapsed:l,openFlyout:m,scheduleFlyoutClose:s,cancelFlyoutClose:c}=(0,g.c)();return a.children&&a.children.length>0?(0,i.jsxs)(F,{children:[(0,i.jsxs)(K,{collapsed:l,onClick:()=>{l||r(a=>!a)},onMouseEnter:l?e=>{m(a,e.currentTarget.getBoundingClientRect().top,o)}:void 0,onMouseLeave:l?s:void 0,children:[(0,i.jsxs)(I,{collapsed:l,children:[(0,i.jsx)(Y,{iconKey:a.icon,size:16}),(0,i.jsx)(D,{collapsed:l,children:a.name})]}),(0,i.jsx)(H,{open:n,collapsed:l,children:(0,i.jsx)(P.A,{size:13})})]}),(0,i.jsx)(R,{open:n&&!l,children:(0,i.jsx)(G,{children:(0,i.jsx)(N,{children:a.children.map(a=>(0,i.jsx)(U,{entry:a,activeId:e,onSelect:o},a.id))})})})]}):(0,i.jsxs)(V,{active:e===a.id,collapsed:l,onClick:()=>o(a),onMouseEnter:l?e=>{let n=e.currentTarget.getBoundingClientRect();m({id:a.id,name:a.name,icon:a.icon,file:a.file,children:[a]},n.top,o)}:void 0,onMouseLeave:l?s:void 0,children:[(0,i.jsx)(Y,{iconKey:a.icon,size:15}),(0,i.jsx)(D,{collapsed:l,children:a.name})]})}function O({entries:a,activeId:e,onSelect:o}){return(0,i.jsx)("div",{children:a.map(a=>(0,i.jsx)(U,{entry:a,activeId:e,onSelect:o},a.id))})}let _=(0,s.keyframes)`
...
`;function aa(a,e=8){let[o,n]=(0,t.useState)(()=>(function(a){try{return JSON.parse(localStorage.getItem(a)??"[]")}catch{return[]}})(a));return{recent:o,addRecent:(0,t.useCallback)(o=>{n(n=>{let i=[o,...n.filter(a=>a!==o)].slice(0,e);try{localStorage.setItem(a,JSON.stringify(i))}catch{}return i})},[a,e])}}m().div`
  position: fixed;
  inset: 0;
...
`;m().div`
  ...
  background: ${n.w4.colors.mainBg};
  font-family: ${n.w4.typography.fontFamily};
  animation: ${ae} 0.4s ease 0.15s both;
`,m().div`
  position: relative;
  width: 56px;
  height: 56px;
...
`,m().div`
  position: absolute;
  inset: 0;
  animation: ${ao} 1.4s cubic-bezier(0.4, 0, 0.2, 1) infinite;
