"use strict";(self.webpackChunk_atlantis_forma=self.webpackChunk_atlantis_forma||[]).push([["512"],{90429(e,t,a){a.d(t,{N:()=>S});var r=a(65723),o=a(37991),i=a(36859),n=a.n(i),s=a(72799),l=a(6063),d=a(63236),c=a(69454);let p="#7fb77e",h={month:30,"3m":90,"6m":183,year:365,all:null},g=(0,s.keyframes)`
...
`,M=n().div`
  ...
  font-variant-numeric: tabular-nums;
  color: ${p};
`;function j({data:e,t,locale:a}){let[i,n]=(0,o.useState)("1m"),[s,g]=(0,o.useState)(void 0),[z,T]=(0,o.useState)(!1);(0,o.useEffect)(()=>{(0,l.PL)(h).then(e=>{("1m"===e||"3m"===e||"6m"===e||"1y"===e)&&n(e),T(!0)}).catch(()=>T(!0))},[]);let S=(0,o.useCallback)(e=>{n(e),g(void 0),(0,l.Is)(h,e).catch(()=>{})},[]),F=(0,o.useMemo)(()=>(function(e,t){let a=d.zA[t],r=Array(a).fill(0),o=new Date;for(let t=0;t<a;t++){let[i,n,s]=(0,d.x)(t,a,o).split("-").map(e=>parseInt(e,10)),l=new Date(i,(n??1)-1,s??1).getTime(),c=l+864e5,p=0;for(let t of e.sessions){let e=t.startedAt,a=Math.min(t.endedAt??Date.now(),c)-Math.max(e,l);a>0&&(p+=a/36e5)}let h=0;p>=16?h=4:p>=12?h=3:p>=8?h=2:p>0&&(h=1),r[t]=h}return r})(e,i),[e,i]),C=d.zA[i],A=void 0!==s?(0,d.x)(s,C):null,D=(0,o.useMemo)(()=>A?(0,c.Af)(e,A,t,a):null,[e,A,t,a]),L=(0,o.useMemo)(()=>{let t=new Date,a=[];for(let e=0;e<C;e++)a.push((0,d.x)(e,C,t));let r=a[0]??"",o=a[a.length-1]??"",i=0;for(let t of e.sessions){let e=t.startedAt,a=t.endedAt??Date.now(),n=new Date(r).getTime(),s=Math.min(a,new Date(o).getTime()+864e5)-Math.max(e,n);s>0&&(i+=s/36e5)}let n={};for(let t of e.meals)t.date>=r&&t.date<=o&&(n[t.date]=(n[t.date]??0)+(t.proteinG??0));let s=Object.keys(n).length,l=Object.values(n).reduce((e,t)=>e+t,0),c=e.weights.filter(e=>e.date>=r&&e.date<=o).sort((e,t)=>e.date.localeCompare(t.date));return{totalFastHours:i,avgProtein:s>0?l/s:0,weightDelta:c.length>=2?(c[c.length-1]?.kg??0)-(c[0]?.kg??0):null,totalWalkMins:e.walks.filter(e=>e.date>=r&&e.date<=o).reduce((e,t)=>e+t.minutes,0)}},[e,i,C]),R=(0,o.useMemo)(()=>({"1m":t("forma.timeline.range.1m"),"3m":t("forma.timeline.range.3m"),"6m":t("forma.timeline.range.6m"),"1y":t("forma.timeline.range.1y")}),[t]),H=(0,o.useCallback)((r,o)=>{if(0===o)return;let i=(0,d.x)(r,C);return(0,c.Af)(e,i,t,a)},[e,C,t,a]);return z?(0,r.jsxs)(m,{children:[(0,r.jsxs)(f,{children:[(0,r.jsx)(x,{children:t("forma.timeline.title")}),(0,r.jsx)(d.zy,{range:i,onChange:S,labels:R})]}),(0,r.jsx)(u,{children:(0,r.jsx)(d.RT,{data:F,locale:a,showMonthLabels:!0,accent:p,selectedIndex:s,onCellClick:e=>g(t=>t===e?void 0:e),tooltip:H})}),null!==D&&(0,r.jsxs)(w,{children:[(0,r.jsx)(y,{children:t("forma.timeline.selectedDay.title")}),(0,r.jsx)(b,{children:D})]}),(0,r.jsxs)($,{children:[(0,r.jsxs)(v,{children:[(0,r.jsx)(k,{children:t("forma.timeline.kpi.fastHours")}),(0,r.jsxs)(M,{children:[L.totalFastHours.toFixed(0),"h"]})]}),(0,r.jsxs)(v,{children:[(0,r.jsx)(k,{children:t("forma.timeline.kpi.avgProtein")}),(0,r.jsxs)(M,{children:[L.avgProtein.toFixed(0),"g"]})]}),(0,r.jsxs)(v,{children:[(0,r.jsx)(k,{children:t("forma.timeline.kpi.weightDelta")}),(0,r.jsx)(M,{children:null!==L.weightDelta?`${L.weightDelta>=0?"+":""}${L.weightDelta.toFixed(1)} kg`:"—"})]}),(0,r.jsxs)(v,{children:[(0,r.jsx)(k,{children:t("forma.timeline.kpi.walks")}),(0,r.jsxs)(M,{children:[L.totalWalkMins," min"]})]})]})]}):(0,r.jsx)(m,{})}},84964(e,t,a){a.d(t,{Q:()=>e4});var r=a(65723),o=a(37991),i=a(36859),n=a.n(i),s=a(72799),l=a(6063),d=a(73014),c=a(69454),p=a(4406),h=a(1609);let g="#7fb77e";function m(e){return[parseInt(e.slice(1,3),16),parseInt(e.slice(3,5),16),parseInt(e.slice(5,7),16)]}let f=m("#1d2230"),x=m(g);function u(e){let t=Math.round(f[0]+(x[0]-f[0])*e),a=Math.round(f[1]+(x[1]-f[1])*e),r=Math.round(f[2]+(x[2]-f[2])*e);return`rgb(${t},${a},${r})`}let w=new Set([0,4,8,12,16,20]),y=["Mo","Tu","We","Th","Fr","Sa","Su"],b=["Se","Te","Qa","Qi","Sx","S\xe1","Do"],$=n().section`
  background: ${l.w4.colors.surface};
  border: 1px solid ${l.w4.colors.border};
...
`,H=n().div`
  ...
  color: ${l.w4.colors.mainTextMuted};
  margin-top: 2px;
`;function I({data:e,t,locale:a}){let[i,n]=(0,o.useState)(null),s=(0,o.useMemo)(()=>(0,d.mealDayHourMatrix)(e.meals),[e.meals]),l=(0,o.useMemo)(()=>(0,d.mealKcalByHour)(e.meals),[e.meals]),c=(0,o.useMemo)(()=>{let e=0;for(let t of s)for(let a of t)a>e&&(e=a);return e},[s]),p=(0,o.useMemo)(()=>Math.max(0,...l),[l]),g=(0,o.useMemo)(()=>l.reduce((e,t)=>e+t,0),[l]),m="pt"===a?b:y;return(0,r.jsxs)($,{children:[(0,r.jsx)(v,{children:t("forma.mealHeatmap.title")}),(0,r.jsxs)(k,{children:[(0,r.jsxs)(M,{children:[(0,r.jsx)(z,{}),Array.from({length:24},(e,t)=>(0,r.jsx)(j,{children:w.has(t)?String(t).padStart(2,"0"):""},t))]}),s.map((o,s)=>(0,r.jsxs)(T,{children:[(0,r.jsx)(S,{children:m[s]}),o.map((o,l)=>{let d=null!==i&&i.day===s&&i.hour===l;return(0,r.jsx)(F,{type:"button",bg:0===c?u(0):u(o/c),selected:d,"aria-pressed":d,onClick:()=>n(e=>e&&e.day===s&&e.hour===l?null:{day:s,hour:l}),title:(0,h.Cl)(e,s,l,t,a)},l)})]},s)),(0,r.jsxs)(D,{children:[(0,r.jsx)(z,{}),(0,r.jsx)(L,{children:l.map((e,t)=>(0,r.jsx)(R,{pct:0===p?0:e/p},t))})]}),(0,r.jsxs)(H,{children:[(0,r.jsx)("span",{children:"0"}),(0,r.jsxs)("span",{children:[Math.round(g).toLocaleString()," kcal"]})]})]}),i&&(0,r.jsxs)(C,{role:"status","aria-live":"polite",children:[(0,r.jsx)("span",{children:(0,h.Cl)(e,i.day,i.hour,t,a)}),(0,r.jsx)(A,{type:"button",onClick:()=>n(null),"aria-label":t("forma.month.summary.close"),children:"\xd7"})]})]})}var P=a(63236);let B="#7fb77e",W="#1d2230";function E(){let e=new Date;return{year:e.getFullYear(),month:e.getMonth()}}function N(e,t){let a=new Date(e.year,e.month+t,1);return{year:a.getFullYear(),month:a.getMonth()}}function O(e,t){let a=String(e.month+1).padStart(2,"0"),r=String(t).padStart(2,"0");return`${e.year}-${a}-${r}`}function Y(e){return[parseInt(e.slice(1,3),16),parseInt(e.slice(3,5),16),parseInt(e.slice(5,7),16)]}let G=Y(W),K=Y(B),V=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,q=n().section`
  display: flex;
...
`,ey=n().div`
  ...
  font-family: ${l.w4.typography.fontFamilyMono};
  color: ${l.w4.colors.mainTextMuted};
`;function eb({data:e,t,locale:a}){let[i,n]=(0,o.useState)(()=>E()),[s,l]=(0,o.useState)(null),d=(0,o.useCallback)(()=>n(e=>N(e,-1)),[]),p=(0,o.useCallback)(()=>n(e=>N(e,1)),[]),h=(0,o.useCallback)(()=>n(E()),[]),g=(0,o.useMemo)(()=>{let e=E();return i.year===e.year&&i.month===e.month},[i]),{fastHours:m,proteinByDayMap:f,weightByDayMap:x,walkByDayMap:u,checkInDays:w}=(0,o.useMemo)(()=>{let t=function(e,t){let a={};for(let r of e.sessions){if(void 0===r.endedAt)continue;let e=r.startedAt,o=r.endedAt;for(;e<o;){let r=new Date(e);if(r.getFullYear()===t.year&&r.getMonth()===t.month){let i=new Date(r.getFullYear(),r.getMonth(),r.getDate()).getTime()+864e5,n=Math.min(o,i)-e,s=O(t,r.getDate());a[s]=(a[s]??0)+n/36e5,e=i}else e=new Date(r.getFullYear(),r.getMonth(),r.getDate()).getTime()+864e5}}return a}(e,i),a=`${i.year}-${String(i.month+1).padStart(2,"0")}-`,r={};for(let t of e.meals)t.date.startsWith(a)&&(r[t.date]=(r[t.date]??0)+(t.proteinG??0));let o={};for(let t of e.weights)t.date.startsWith(a)&&(o[t.date]=t.kg);let n={};for(let t of e.walks)t.date.startsWith(a)&&(n[t.date]=(n[t.date]??0)+t.minutes);return{fastHours:t,proteinByDayMap:r,weightByDayMap:o,walkByDayMap:n,checkInDays:new Set(e.checkIns.filter(e=>e.date.startsWith(a)).map(e=>e.date))}},[e,i]),y=new Date(i.year,i.month+1,0).getDate(),b=new Date().toISOString().slice(0,10),$=(0,o.useMemo)(()=>Object.values(m).reduce((e,t)=>e+t,0),[m]),v=e.goal.proteinG??110,k=Object.values(f),M=k.length?k.reduce((e,t)=>e+t,0)/k.length:0,j=(0,o.useMemo)(()=>{let t=Object.keys(x).sort(),a=String(i.month+1).padStart(2,"0"),r=`${i.year}-${a}-01`,o=e.weights.filter(e=>e.date<r).sort((e,t)=>e.date.localeCompare(t.date)),n=o[o.length-1]?.kg;if(0===t.length&&void 0===n)return{kind:"none"};if(0===t.length)return{kind:"absolute",value:n};let s=x[t[t.length-1]];if(void 0===s)return{kind:"none"};if(void 0!==n)return{kind:"delta",value:s-n};if(t.length>=2){let e=x[t[0]];if(void 0!==e)return{kind:"delta",value:s-e}}return{kind:"absolute",value:s}},[x,e.weights,i]),z=(0,o.useMemo)(()=>Object.values(u).reduce((e,t)=>e+t,0),[u]),T=(new Date(i.year,i.month,1).getDay()+6)%7,S=[];for(let e=0;e<T;e++)S.push({key:`lead-${e}`,day:null,iso:null});for(let e=1;e<=y;e++){let t=O(i,e);S.push({key:t,day:e,iso:t})}for(;S.length%7!=0;)S.push({key:`tail-${S.length}`,day:null,iso:null});let F=Math.max(18,...Object.values(m)),C=[];for(let e=1;e<=y;e++)C.push(f[O(i,e)]??0);for(;C.length<31;)C.push(0);let A=[];for(let e=1;e<=y;e++){let t=x[O(i,e)];void 0!==t&&A.push(t)}return(0,r.jsxs)(q,{children:[(0,r.jsxs)(_,{children:[(0,r.jsx)(J,{children:new Date(i.year,i.month,1).toLocaleDateString("pt"===a?"pt-PT":"en-US",{month:"long",year:"numeric"})}),(0,r.jsxs)(Q,{children:[(0,r.jsx)(U,{onClick:d,"aria-label":t("forma.month.prev"),children:(0,r.jsx)(P.In,{name:"chevron-left",size:16})}),(0,r.jsx)(X,{onClick:h,disabled:g,"aria-label":t("forma.month.today"),children:t("forma.month.today")}),(0,r.jsx)(U,{onClick:p,disabled:g,"aria-label":t("forma.month.next"),children:(0,r.jsx)(P.In,{name:"chevron-right",size:16})})]})]}),(0,r.jsxs)(Z,{children:[(0,r.jsxs)(ee,{children:[(0,r.jsx)(et,{children:t("forma.month.kpi.fastHours")}),(0,r.jsxs)(ea,{children:[$.toFixed(0),(0,r.jsx)(er,{children:"h"})]})]}),(0,r.jsxs)(ee,{children:[(0,r.jsx)(et,{children:t("forma.month.kpi.avgProtein")}),(0,r.jsxs)(ea,{children:[M.toFixed(0),(0,r.jsxs)(er,{children:["g / ",v,"g"]})]})]}),(0,r.jsxs)(ee,{children:[(0,r.jsx)(et,{children:t("delta"===j.kind?"forma.month.kpi.weightDelta":"forma.month.kpi.weight")}),(0,r.jsxs)(ea,{children:["none"===j.kind?"—":"delta"===j.kind?`${j.value>0?"+":""}${j.value.toFixed(1)}`:j.value.toFixed(1),(0,r.jsx)(er,{children:"kg"})]})]}),(0,r.jsxs)(ee,{children:[(0,r.jsx)(et,{children:t("forma.month.kpi.walks")}),(0,r.jsxs)(ea,{children:[z,(0,r.jsx)(er,{children:"min"})]})]})]}),(0,r.jsxs)(eo,{children:[(0,r.jsxs)(ei,{children:["◉ ",t("forma.month.calendar.title")]}),(0,r.jsxs)(es,{children:[("pt"===a?["S","T","Q","Q","S","S","D"]:["M","T","W","T","F","S","S"]).map((e,t)=>(0,r.jsx)(el,{children:e},`h-${t}`)),S.map(e=>{if(null===e.day||null===e.iso)return(0,r.jsx)(ec,{},e.key);let t=m[e.iso]??0,a=Math.min(1,t/F),o=void 0!==x[e.iso],i=w.has(e.iso),n=(u[e.iso]??0)>0,d=e.iso;return(0,r.jsxs)(ed,{type:"button",bg:function(e){if(e<=0)return W;let t=Math.round(G[0]+(K[0]-G[0])*e),a=Math.round(G[1]+(K[1]-G[1])*e),r=Math.round(G[2]+(K[2]-G[2])*e);return`rgb(${t},${a},${r})`}(a),today:d===b,selected:d===s,onClick:()=>l(e=>e===d?null:d),"aria-pressed":d===s,"aria-label":`${d} \xb7 ${t.toFixed(1)}h fast`,title:`${d} \xb7 ${t.toFixed(1)}h fast`,children:[e.day,(0,r.jsxs)(ef,{children:[o&&(0,r.jsx)(ex,{color:"#58a6ff"}),i&&(0,r.jsx)(ex,{color:"#a371f7"}),n&&(0,r.jsx)(ex,{color:"#d29922"})]})]},e.key)})]}),s&&(0,r.jsxs)(ep,{role:"status","aria-live":"polite",children:[(0,r.jsx)(eh,{children:s}),(0,r.jsxs)(eg,{children:[(0,r.jsxs)("span",{children:[(m[s]??0).toFixed(1),"h"]}),(0,r.jsx)("em",{children:t("forma.month.kpi.fastHours")})]}),(0,r.jsxs)(eg,{children:[(0,r.jsxs)("span",{children:[Math.round(f[s]??0),"g"]}),(0,r.jsx)("em",{children:t("forma.month.kpi.avgProtein")})]}),void 0!==x[s]&&(0,r.jsxs)(eg,{children:[(0,r.jsxs)("span",{children:[x[s].toFixed(1),"kg"]}),(0,r.jsx)("em",{children:t("forma.month.kpi.weight")})]}),(u[s]??0)>0&&(0,r.jsxs)(eg,{children:[(0,r.jsxs)("span",{children:[u[s],"min"]}),(0,r.jsx)("em",{children:t("forma.month.kpi.walks")})]}),w.has(s)&&(0,r.jsxs)(eg,{children:[(0,r.jsx)("span",{"aria-hidden":"true",children:"●"}),(0,r.jsx)("em",{children:t("forma.month.summary.checkIn")})]}),(0,r.jsx)(em,{type:"button",onClick:()=>l(null),"aria-label":t("forma.month.summary.close"),children:"\xd7"})]})]}),(0,r.jsxs)(en,{children:[(0,r.jsxs)(eo,{children:[(0,r.jsxs)(ei,{children:["◉ ",t("forma.month.protein.title")]}),0===k.length?(0,r.jsx)(c.YG,{mode:"empty",label:t("forma.analytics.empty")}):(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(eu,{children:C.slice(0,y).map((e,t)=>(0,r.jsx)(ew,{h:Math.min(100,e/(1.2*v)*100),over:e>=v,title:`${O(i,t+1)} \xb7 ${e.toFixed(0)}g`},t))}),(0,r.jsxs)(ey,{children:[(0,r.jsx)("span",{children:"1"}),(0,r.jsx)("span",{children:Math.ceil(y/2)}),(0,r.jsx)("span",{children:y})]})]})]}),(0,r.jsxs)(eo,{children:[(0,r.jsxs)(ei,{children:["◉ ",t("forma.month.weight.title")]}),A.length<2?(0,r.jsx)(c.YG,{mode:"empty",label:t("forma.analytics.empty")}):(0,r.jsx)(c.OW,{points:A,accent:B,width:260,height:100,fluid:!0})]})]})]})}let e$="#7fb77e",ev="#58a6ff",ek="#d29922",eM="#7fb77e",ej=["Mo","Tu","We","Th","Fr","Sa","Su"],ez=["Se","Te","Qa","Qi","Sx","S\xe1","Do"],eT=new Set([0,4,8,12,16,20]);function eS(e){return[parseInt(e.slice(1,3),16),parseInt(e.slice(3,5),16),parseInt(e.slice(5,7),16)]}let eF=eS("#1d2230"),eC=eS(e$);function eA(e){let t=Math.round(eF[0]+(eC[0]-eF[0])*e),a=Math.round(eF[1]+(eC[1]-eF[1])*e),r=Math.round(eF[2]+(eC[2]-eF[2])*e);return`rgb(${t},${a},${r})`}let eD=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,eL=n().div`
  background: ${l.w4.colors.surface};
...
`,eW=n().span`
  ...
  font-family: ${l.w4.typography.fontFamilyMono};
  font-variant-numeric: tabular-nums;
  color: ${({positive:e})=>e?l.w4.colors.danger:e$};
  background: ${({positive:e})=>e?`${l.w4.colors.danger}18`:`${e$}18`};
  border-radius: ${l.w4.borderRadius.sm};
  padding: 2px 6px;
`,eE=n().div`
  overflow-x: auto;
...
`,eQ=n().div`
  ...
  background: ${({color:e})=>e};
  flex-shrink: 0;
`,eU={positive:"#7fb77e",warn:"#facc15",info:l.w4.colors.mainTextMuted},eX=n().div`
  display: flex;
  flex-direction: column;
  gap: ${l.w4.spacing.sm};
`,eZ=n().div`
...
`,e1=n().span`
  font-size: 13px;
  color: ${l.w4.colors.mainTextMuted};
`;function e4({data:e,t,locale:a}){let i=new Date().toISOString().slice(0,10),[n,s]=(0,o.useState)(null),[l,g]=(0,o.useState)(null),m=(0,o.useMemo)(()=>(function(e){let t={};for(let a of e){if(!a.endedAt)continue;let e=a.startedAt,r=a.endedAt,o=e;for(;o<r;){let e=new Date(o),a=new Date(e.getFullYear(),e.getMonth(),e.getDate(),0,0,0,0).getTime()+864e5,i=Math.min(r,a)-o,n=e.toISOString().slice(0,10);t[n]=(t[n]??0)+i/36e5,o=a}}let a=[];for(let e=89;e>=0;e--){let r=t[function(e){let t=new Date;return t.setDate(t.getDate()-e),t.toISOString().slice(0,10)}(e)]??0,o=0;r>=18?o=4:r>=14?o=3:r>=8?o=2:r>0&&(o=1),a.push(o)}return a})(e.sessions),[e.sessions]),f=(0,o.useMemo)(()=>(0,d.weightTrend)(e.weights,60),[e.weights]),x=(0,o.useMemo)(()=>[...e.weights].sort((e,t)=>t.date.localeCompare(e.date))[0]??null,[e.weights]),u=(0,o.useMemo)(()=>(0,d.proteinByDay)(e.meals,i),[e.meals,i]),w=(0,o.useMemo)(()=>e.goal.proteinG??110,[e.goal.proteinG]),y=(0,o.useMemo)(()=>(function(e){let t=[],a=new Date,r=new Date(a),o=(a.getDay()+6)%7;r.setDate(a.getDate()-o),r.setHours(0,0,0,0);for(let a=5;a>=0;a--){let o=new Date(r);o.setDate(r.getDate()-7*a);let i=new Date(o);i.setDate(o.getDate()+7);let n=o.toISOString().slice(0,10),s=i.toISOString().slice(0,10),l=e.filter(e=>e.date>=n&&e.date<s),d=l.filter(e=>"lunch"===e.slot).reduce((e,t)=>e+(t.proteinG??0),0),c=l.filter(e=>"snack"===e.slot).reduce((e,t)=>e+(t.proteinG??0),0),p=l.filter(e=>"dinner"===e.slot).reduce((e,t)=>e+(t.proteinG??0),0),h=`${String(o.getDate()).padStart(2,"0")}/${String(o.getMonth()+1).padStart(2,"0")}`;t.push({label:h,segments:[{id:"lunch",value:d,color:ev},{id:"snack",value:c,color:ek},{id:"dinner",value:p,color:eM}]})}return t})(e.meals),[e.meals]),b=(0,o.useMemo)(()=>(0,d.dayHourFastMatrix)(e.sessions),[e.sessions]),$=(0,o.useMemo)(()=>{let e=0;for(let t of b)for(let a of t)a>e&&(e=a);return e},[b]),v=(0,o.useMemo)(()=>(0,d.generateFormaInsights)(e),[e]),k="pt"===a?ez:ej,M=e.weights.length>=2,j=e.meals.length>0,z=e.sessions.some(e=>void 0!==e.endedAt),T=[{id:"insights",defaultSize:"lg",render:()=>(0,r.jsxs)(eL,{children:[(0,r.jsxs)(eR,{children:["◉ ",t("forma.insights.title")]}),0===v.length?(0,r.jsx)(c.YG,{mode:"empty",label:t("forma.insights.empty")}):(0,r.jsx)(eX,{children:v.map(e=>{let a;return"string"==typeof(a={...e.vars??{}}).dayKey&&(a.day=t(a.dayKey)),(0,r.jsxs)(eZ,{accent:eU[e.severity],children:[(0,r.jsx)(e0,{children:t(e.titleKey)}),(0,r.jsx)(e1,{children:t(e.bodyKey,a)})]},e.id)})})]})},{id:"fast-heatmap",defaultSize:"lg",render:()=>(0,r.jsxs)(eL,{children:[(0,r.jsxs)(eR,{children:["◉ ",t("forma.analytics.heatmap.title")]}),z?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(c.RT,{data:m,cellSize:11,gap:2,locale:a,selectedIndex:n??void 0,onCellClick:e=>s(t=>t===e?null:e),tooltip:r=>(0,h.Af)(e,(0,h.EQ)(r,m.length),t,a)}),(0,r.jsxs)(e_,{children:[(0,r.jsxs)(eJ,{children:[(0,r.jsx)(eQ,{color:eA(0)}),(0,r.jsx)("span",{children:t("forma.analytics.heatmap.none")})]}),(0,r.jsxs)(eJ,{children:[(0,r.jsx)(eQ,{color:eA(.25)}),(0,r.jsx)("span",{children:"<8h"})]}),(0,r.jsxs)(eJ,{children:[(0,r.jsx)(eQ,{color:eA(.5)}),(0,r.jsx)("span",{children:"8–14h"})]}),(0,r.jsxs)(eJ,{children:[(0,r.jsx)(eQ,{color:eA(.75)}),(0,r.jsx)("span",{children:"14–18h"})]}),(0,r.jsxs)(eJ,{children:[(0,r.jsx)(eQ,{color:eA(1)}),(0,r.jsx)("span",{children:"≥18h"})]})]}),null!==n&&(0,r.jsxs)(eV,{role:"status","aria-live":"polite",children:[(0,r.jsx)("span",{children:(0,h.Af)(e,(0,h.EQ)(n,m.length),t,a)}),(0,r.jsx)(eq,{type:"button",onClick:()=>s(null),"aria-label":t("forma.month.summary.close"),children:"\xd7"})]})]}):(0,r.jsx)(c.YG,{mode:"empty",label:t("forma.analytics.empty")})]})},{id:"weight-trend",defaultSize:"md",render:()=>(0,r.jsxs)(eL,{children:[(0,r.jsxs)(eR,{children:["◉ ",t("forma.analytics.weight.title")]}),M?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(eB,{children:[(0,r.jsx)(eH,{children:x?x.kg.toFixed(1):"—"}),(0,r.jsx)(eP,{children:"kg"}),0!==f.delta&&(0,r.jsxs)(eW,{positive:f.delta>0,children:[f.delta>0?"+":"",f.delta.toFixed(1)," kg"]})]}),void 0!==e.goal.weightKg&&(0,r.jsxs)(eB,{children:[(0,r.jsx)(eI,{children:e.goal.weightKg.toFixed(1)}),(0,r.jsxs)(eP,{children:["kg ",t("forma.weight.target")]})]}),(0,r.jsx)(eP,{children:t("forma.analytics.weight.delta")}),(0,r.jsx)(c.OW,{points:f.ema.length>=2?f.ema:e.weights.map(e=>e.kg),accent:e$,width:260,height:60,fluid:!0})]}):(0,r.jsx)(c.YG,{mode:"empty",label:t("forma.analytics.empty")})]})},{id:"protein-burn",defaultSize:"md",render:()=>(0,r.jsxs)(eL,{children:[(0,r.jsxs)(eR,{children:["◉ ",t("forma.analytics.protein.title")]}),(0,r.jsxs)(eB,{children:[(0,r.jsx)(eH,{children:u.toFixed(0)}),(0,r.jsxs)(eP,{children:["/ ",w,"g ",t("forma.analytics.protein.target")]})]}),j?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(c.kl,{spent:w-u,budget:w,height:60}),(0,r.jsx)(eP,{children:u>=w?t("forma.analytics.protein.achieved"):`${(w-u).toFixed(0)}g ${t("forma.analytics.protein.remaining")}`})]}):(0,r.jsx)(c.YG,{mode:"empty",label:t("forma.analytics.empty")})]})},{id:"weekly-protein",defaultSize:"lg",render:()=>(0,r.jsxs)(eL,{children:[(0,r.jsxs)(eR,{children:["◉ ",t("forma.analytics.weekly.title")]}),j?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(c.ik,{data:y,budget:7*w,height:160}),(0,r.jsxs)(e_,{children:[(0,r.jsxs)(eJ,{children:[(0,r.jsx)(eQ,{color:ev}),(0,r.jsx)("span",{children:t("forma.meal.lunch")})]}),(0,r.jsxs)(eJ,{children:[(0,r.jsx)(eQ,{color:ek}),(0,r.jsx)("span",{children:t("forma.meal.snack")})]}),(0,r.jsxs)(eJ,{children:[(0,r.jsx)(eQ,{color:eM}),(0,r.jsx)("span",{children:t("forma.meal.dinner")})]})]})]}):(0,r.jsx)(c.YG,{mode:"empty",label:t("forma.analytics.empty")})]})},{id:"meal-heatmap",defaultSize:"lg",render:()=>(0,r.jsx)(I,{data:e,t:t,locale:a})},{id:"fast-times",defaultSize:"lg",render:()=>(0,r.jsxs)(eL,{children:[(0,r.jsxs)(eR,{children:["◉ ",t("forma.analytics.fastTimes.title")]}),z?(0,r.jsxs)(eE,{children:[(0,r.jsxs)(eN,{children:[(0,r.jsx)("div",{}),Array.from({length:24},(e,t)=>(0,r.jsx)(eO,{children:eT.has(t)?String(t).padStart(2,"0"):""},t))]}),b.map((o,i)=>(0,r.jsxs)(eY,{children:[(0,r.jsx)(eG,{children:k[i]}),o.map((o,n)=>{let s=null!==l&&l.day===i&&l.hour===n;return(0,r.jsx)(eK,{type:"button",bg:0===$?eA(0):eA(o/$),selected:s,"aria-pressed":s,onClick:()=>g(e=>e&&e.day===i&&e.hour===n?null:{day:i,hour:n}),title:(0,h.Cl)(e,i,n,t,a)},n)})]},i))]}):(0,r.jsx)(c.YG,{mode:"empty",label:t("forma.analytics.empty")}),l&&(0,r.jsxs)(eV,{role:"status","aria-live":"polite",children:[(0,r.jsx)("span",{children:(0,h.Cl)(e,l.day,l.hour,t,a)}),(0,r.jsx)(eq,{type:"button",onClick:()=>g(null),"aria-label":t("forma.month.summary.close"),children:"\xd7"})]})]})}];return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(eb,{data:e,t:t,locale:a}),(0,r.jsx)(p.C,{t:t,cards:T,storageKey:"forma:layout:analytics"})]})}},69568(e,t,a){a.d(t,{c:()=>S});var r=a(65723),o=a(37991),i=a(36859),n=a.n(i),s=a(72799),l=a(6063),d=a(63236),c=a(73014);let p="#7fb77e",h=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,g=n().section`
  display: flex;
...
`,T=n().p`
  ...
  margin: 0;
  text-align: center;
`;function S({t:e,locale:t}){let{comments:a,addComment:i,updateAnswer:n,removeComment:s}=(0,c.useAskComments)(),[l,h]=(0,o.useState)(""),[F,C]=(0,o.useState)(null),[A,D]=(0,o.useState)(null),L=(0,o.useRef)(null);(0,o.useEffect)(()=>{(0,c.resolveGroqKey)().then(D)},[]);let R=(0,o.useCallback)(async()=>{let e=l.trim();if(!e||!A||F)return;h("");let a=await i(e);if(!a)return;C(a),L.current=new AbortController;let r=`You are a fasting and diet coach assistant for the Forma app.
Answer questions about intermittent fasting, nutrition, weight loss, and wellness.
Be concise, practical, and supportive. Respond in ${"pt"===t?"Portuguese (PT)":"English"}.`;try{let o="";await (0,c.askGroqStream)(e,{key:A,locale:t,system:r,maxTokens:512,signal:L.current.signal,onChunk:e=>{o=e,n(a,e)}}),await n(a,o)}catch{}finally{C(null),L.current=null}},[l,A,F,i,n,t]),H=[...a].reverse();return(0,r.jsxs)(g,{children:[(0,r.jsx)(m,{children:e("forma.ask.title")}),A?(0,r.jsxs)(f,{children:[(0,r.jsx)(x,{value:l,onChange:e=>h(e.target.value),onKeyDown:e=>{"Enter"!==e.key||e.shiftKey||(e.preventDefault(),R())},placeholder:e("forma.ask.chat.placeholder"),disabled:!!F,rows:1}),(0,r.jsx)(d.$n,{variant:"primary",onClick:()=>{R()},disabled:!l.trim()||!!F,children:(0,r.jsx)(d.In,{name:"send",size:14})})]}):(0,r.jsx)(T,{children:e("forma.ask.noKey")}),0===H.length?(0,r.jsx)(z,{children:e("forma.ask.chat.empty")}):(0,r.jsx)(u,{children:H.map(e=>(0,r.jsxs)(w,{children:[(0,r.jsxs)(y,{children:[(0,r.jsx)(b,{children:(0,r.jsx)(d.In,{name:"user",size:12,color:p})}),(0,r.jsx)($,{children:e.question})]}),e.id!==F||e.answer?e.answer?(0,r.jsx)(v,{children:(0,r.jsx)(d.mQ,{children:e.answer})}):null:(0,r.jsx)(v,{children:(0,r.jsxs)(k,{children:[(0,r.jsx)(M,{delay:0}),(0,r.jsx)(M,{delay:200}),(0,r.jsx)(M,{delay:400})]})}),(0,r.jsx)(j,{children:(0,r.jsx)(d.$n,{variant:"ghost",onClick:()=>{s(e.id)},disabled:e.id===F,children:(0,r.jsx)(d.In,{name:"trash",size:13})})})]},e.id))})]})}},37103(e,t,a){a.d(t,{j:()=>u});var r=a(65723),o=a(37991),i=a(36859),n=a.n(i),s=a(6063),l=a(63236),d=a(73014);let c=n().section`
...
Give 3–5 bullets: what's going well, what to fix, one specific next-meal suggestion.`),w=await (0,d.askGroqStream)(u,{key:f,locale:a,maxTokens:400,onChunk:e=>v(e)}),y=Date.now();M(y),(0,s.pJ)(x,JSON.stringify({text:w,ts:y}))}catch(e){S(e instanceof Error?e.message:t("forma.ask.error"))}finally{z(!1)}},[e,a,t]);if(null===y||!1===y)return null;let C=!!$;return(0,r.jsxs)(c,{children:[(0,r.jsxs)(p,{children:[(0,r.jsxs)(h,{children:["✦ ",t("forma.ask.title")]}),(0,r.jsx)(l.$n,{variant:"accent",icon:(0,r.jsx)(l.In,{name:C?"refresh":"message",size:14}),onClick:()=>void F(),disabled:j,children:j?t("forma.ask.loading"):C?t("forma.ask.regenerate"):t("forma.ask.button")})]}),T&&(0,r.jsx)(m,{children:T}),($||j)&&(0,r.jsx)(g,{children:$?(0,r.jsx)(l.mQ,{children:$}):"…"}),null!==k&&!j&&C&&(0,r.jsxs)(f,{children:[t("forma.ask.generatedAt")," \xb7 ",(i=new Date(k),n=e=>String(e).padStart(2,"0"),w=i.toLocaleDateString("pt"===a?"pt-PT":"en-GB",{day:"2-digit",month:"short"}),`${w}, ${n(i.getHours())}:${n(i.getMinutes())}`)]}),!$&&!j&&!T&&(0,r.jsx)(g,{style:{color:s.w4.colors.mainTextMuted,fontStyle:"italic"},children:t("forma.ask.hint")})]})}},82167(e,t,a){a.d(t,{X:()=>x});var r=a(65723),o=a(37991),i=a(36859),n=a.n(i),s=a(72799),l=a(6063);let d=(0,s.keyframes)`
...
`,$=n().div`
  ...
  gap: ${s.w4.spacing.sm};
  justify-content: flex-end;
`,v=[1,2,3,4,5];function k({open:e,onClose:t,t:a}){let{checkIn:i,saveCheckIn:n}=(0,d.useCheckIn)(),[s,p]=(0,o.useState)(i?.hunger??3),[M,j]=(0,o.useState)(i?.energy??3),[z,T]=(0,o.useState)(i?.adherence??!0),[S,F]=(0,o.useState)(i?.note??""),[C,A]=(0,o.useState)(!1),D=(0,o.useCallback)(async()=>{A(!0);try{await n({hunger:s,energy:M,adherence:z,note:S.trim()||void 0}),t()}finally{A(!1)}},[n,s,M,z,S,t]);return(0,r.jsx)(c.X,{open:e,onClose:t,ariaLabel:a("forma.checkin.title"),children:(0,r.jsxs)(h,{children:[(0,r.jsx)(g,{children:a("forma.checkin.title")}),(0,r.jsxs)(m,{children:[(0,r.jsx)(f,{children:a("forma.checkin.hunger")}),(0,r.jsx)(x,{children:v.map(e=>(0,r.jsx)(u,{active:s===e,onClick:()=>p(e),"aria-pressed":s===e,children:e},e))})]}),(0,r.jsxs)(m,{children:[(0,r.jsx)(f,{children:a("forma.checkin.energy")}),(0,r.jsx)(x,{children:v.map(e=>(0,r.jsx)(u,{active:M===e,onClick:()=>j(e),"aria-pressed":M===e,children:e},e))})]}),(0,r.jsxs)(m,{children:[(0,r.jsx)(f,{children:a("forma.checkin.adherence")}),(0,r.jsxs)(w,{children:[(0,r.jsxs)(y,{active:z,onClick:()=>T(!0),"aria-pressed":z,children:[(0,r.jsx)(l.In,{name:"check",size:14}),a("forma.checkin.adherenceYes")]}),(0,r.jsxs)(y,{active:!z,danger:!0,onClick:()=>T(!1),"aria-pressed":!z,children:[(0,r.jsx)(l.In,{name:"close",size:14}),a("forma.checkin.adherenceNo")]})]})]}),(0,r.jsxs)(m,{children:[(0,r.jsx)(f,{children:a("forma.checkin.note")}),(0,r.jsx)(b,{value:S,onChange:e=>F(e.target.value),placeholder:a("forma.checkin.notePlaceholder"),rows:2})]}),(0,r.jsxs)($,{children:[(0,r.jsx)(l.$n,{variant:"ghost",onClick:t,disabled:C,children:a("forma.checkin.cancel")}),(0,r.jsx)(l.$n,{variant:"success",onClick:()=>{D()},disabled:C,children:a("forma.checkin.save")})]})]})})}},24470(e,t,a){a.d(t,{s:()=>v});var r=a(65723),o=a(37991),i=a(36859),n=a.n(i),s=a(72799),l=a(6063),d=a(63236),c=a(73014);let p="#7fb77e",h=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,g=n().section`
  background: ${l.w4.colors.surface};
...
`;function v({t:e}){var t;let{output:a,refresh:i}=(0,c.useCoach)(),[n,s]=(0,o.useState)(!1),h=(0,o.useCallback)(async()=>{s(!0);try{await i()}finally{s(!1)}},[i]),k=()=>{h()};if(!a)return(0,r.jsxs)(g,{accent:p,children:[(0,r.jsx)(m,{children:(0,r.jsx)(f,{children:e("forma.coach.title")})}),(0,r.jsxs)(y,{children:[(0,r.jsx)(d.In,{name:"message",size:24,color:l.w4.colors.mainTextMuted}),(0,r.jsx)(b,{children:e("forma.coach.empty")}),(0,r.jsx)(d.$n,{variant:"accent",onClick:k,disabled:n,children:e("forma.coach.generate")})]})]});let M=(t=a.messageKey,/lowAdherence|hunger/.test(t)?"#f87171":/stall|lowEnergy/.test(t)?"#facc15":p);return(0,r.jsxs)(g,{accent:M,children:[(0,r.jsx)(m,{children:(0,r.jsx)(f,{children:e("forma.coach.title")})}),(0,r.jsx)(x,{children:e(a.messageKey,a.vars)}),a.adjustments.length>0&&(0,r.jsx)(u,{children:a.adjustments.map((t,a)=>(0,r.jsx)(w,{accent:M,children:e(t.reasonKey)},a))}),(0,r.jsx)($,{children:(0,r.jsxs)(d.$n,{variant:"ghost",onClick:k,disabled:n,children:[(0,r.jsx)(d.In,{name:"rotate-cw",size:13}),e("forma.coach.refresh")]})})]})}},72552(e,t,a){a.d(t,{k:()=>j});var r=a(65723),o=a(37991),i=a(36859),n=a.n(i),s=a(6063),l=a(63236),d=a(73014);let c="#7fb77e",p=2*Math.PI*95,h=n().div`
  display: flex;
  flex-direction: column;
  align-items: center;
  gap: ${s.w4.spacing.md};
...
`,M=n().span`
  ...
  text-transform: uppercase;
  letter-spacing: 0.16em;
`;function j({data:e,t,onStart:a,onStop:i,onEditStart:n}){let z,T,S,F,C,[A,D]=(0,o.useState)(Date.now),L=e.sessions.some(e=>void 0===e.endedAt);(0,o.useEffect)(()=>{if(!L)return;let e=setInterval(()=>D(Date.now()),1e3);return()=>clearInterval(e)},[L]);let R=(0,d.currentFast)(e,A),H=R?.percent??0,I=null!==R,P=R?R.hoursElapsed:0,B=R?R.remainingMs:0,W=R?R.session.targetHours:e.goal.targetHours;return(0,r.jsxs)(h,{children:[(0,r.jsxs)(g,{children:[(0,r.jsxs)(m,{width:200,height:200,viewBox:"0 0 200 200","aria-hidden":"true",children:[(0,r.jsx)("circle",{cx:100,cy:100,r:95,fill:"none",stroke:s.w4.colors.border,strokeWidth:10}),(0,r.jsx)("circle",{cx:100,cy:100,r:95,fill:"none",stroke:c,strokeWidth:10,strokeLinecap:"round",strokeDasharray:p,strokeDashoffset:p*(1-H),style:{transition:"stroke-dashoffset 0.6s ease"}})]}),(0,r.jsx)(f,{children:I?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(x,{children:[P.toFixed(1),"h"]}),(0,r.jsx)(u,{children:t("forma.timer.elapsed")})]}):(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(x,{children:[W,"h"]}),(0,r.jsx)(u,{children:t("forma.hero.notFasting")})]})})]}),I&&R&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(b,{children:[(0,r.jsx)(w,{children:R.session.protocol}),n&&(0,r.jsx)($,{type:"button",onClick:()=>n(R.session),title:t("forma.timer.editStart"),children:t("forma.timer.startedAt",{time:(T=String((z=new Date(R.session.startedAt)).getHours()).padStart(2,"0"),S=String(z.getMinutes()).padStart(2,"0"),`${T}:${S}`)})})]}),(0,r.jsxs)(y,{children:[(0,r.jsxs)(v,{children:[(0,r.jsx)(k,{children:(C=Math.floor((F=Math.floor(B/6e4))/60),`${String(C).padStart(2,"0")}:${String(F%60).padStart(2,"0")}`)}),(0,r.jsx)(M,{children:t("forma.timer.remaining")})]}),(0,r.jsxs)(v,{children:[(0,r.jsxs)(k,{children:[Math.round(100*H),"%"]}),(0,r.jsx)(M,{children:t("forma.timer.complete")})]})]})]}),I&&R?(0,r.jsx)(l.$n,{variant:"danger",onClick:()=>i(R.session),children:t("forma.stop")}):(0,r.jsx)(l.$n,{variant:"success",onClick:a,children:t("forma.start")})]})}},4406(e,t,a){a.d(t,{C:()=>w});var r=a(65723),o=a(37991),i=a(36859),n=a.n(i),s=a(6063),l=a(63236);let d="#7fb77e",c=n().div`
  display: grid;
...
`,u=n().div`
  flex: 1;
  min-height: 60px;
`;function w({data:e,t,onClick:a}){let i=(0,o.useMemo)(()=>(0,l.weightForecast)(e.weights,60,30),[e.weights]),n=i.history.length>0?i.history[i.history.length-1]:null,c=i.forecast.length>0?i.forecast[i.forecast.length-1]:null,y=n&&c?c.kg-n.kg:0;return(0,r.jsxs)(p,{onClick:a,"aria-label":t("forma.miniWeight.aria"),children:[(0,r.jsxs)(h,{children:[(0,r.jsxs)(g,{children:["◉ ",t("forma.miniWeight.title")]}),c&&(0,r.jsxs)(x,{pos:y>0,children:[y>=0?"+":"",y.toFixed(1),"kg / 30d"]})]}),(0,r.jsxs)(m,{children:[(0,r.jsx)(f,{children:n?n.kg.toFixed(1):"—"}),(0,r.jsx)("span",{style:{color:s.w4.colors.mainTextMuted,fontSize:13,fontFamily:s.w4.typography.fontFamilyMono},children:"kg"}),c&&(0,r.jsxs)("span",{style:{color:s.w4.colors.mainTextMuted,fontSize:12,fontFamily:s.w4.typography.fontFamilyMono},children:["→ ",c.kg.toFixed(1)," kg"]})]}),(0,r.jsx)(u,{children:(0,r.jsx)(d.h,{forecast:i,axes:!1,goalKg:e.goal.weightKg})})]})}},86704(e,t,a){a.d(t,{g:()=>z});var r=a(65723),o=a(37991),i=a(36859),n=a.n(i),s=a(72799),l=a(6063),d=a(63236),c=a(73014);let p="#7fb77e",h=new Date().toISOString().slice(0,10),g=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,m=n().section`
  display: flex;
...
`;function p({t:e,active:t,onChange:a}){return(0,r.jsx)(d,{role:"group","aria-label":e("forma.rail.title"),children:l.map(o=>(0,r.jsx)(c,{active:t===o,onClick:()=>a(o),"aria-pressed":t===o,children:e(`forma.protocol.${o}`)},o))})}},71589(e,t,a){a.d(t,{B:()=>m});var r=a(65723),o=a(36859),i=a.n(o),n=a(6063);let s="#7fb77e",l=[{id:"16:8",fastH:16,windowH:8},{id:"18:6",fastH:18,windowH:6},{id:"20:4",fastH:20,windowH:4},{id:"custom",fastH:0,windowH:0}],d=i().aside`
  width: 260px;
  flex-shrink: 0;
...
`,g=i().span`
  ...
  font-family: ${n.w4.typography.fontFamilyMono};
  color: ${n.w4.colors.mainTextMuted};
`;function m({t:e,active:t,onChange:a}){return(0,r.jsxs)(d,{"aria-label":e("forma.rail.title"),children:[(0,r.jsx)(c,{children:e("forma.rail.title")}),l.map(o=>(0,r.jsxs)(p,{active:t===o.id,onClick:()=>a(o.id),"aria-pressed":t===o.id,children:[(0,r.jsx)(h,{active:t===o.id,children:e(`forma.protocol.${o.id}`)}),o.fastH>0&&(0,r.jsxs)(g,{children:[e("forma.rail.hours",{n:o.fastH})," \xb7 ",e("forma.rail.window",{n:o.windowH})]})]},o.id))]})}},25405(e,t,a){a.d(t,{F:()=>p});var r=a(65723),o=a(37991),i=a(36859),n=a.n(i),s=a(6063);let l=n().form`
  display: flex;
  align-items: center;
  gap: ${s.w4.spacing.sm};
  padding: ${s.w4.spacing.sm} ${s.w4.spacing.md};
...
`,b=n().p`
  ...
  color: ${c};
  margin: 0;
`;function $({data:e,t,onSave:a}){let[i,n]=(0,o.useState)(String(e.goal.proteinG??110)),[s,c]=(0,o.useState)(String(e.goal.kcal??2200)),[v,k]=(0,o.useState)(String(e.goal.walkMin??30)),[M,j]=(0,o.useState)(String(e.goal.weightKg??"")),[z,T]=(0,o.useState)(String(e.goal.targetHours)),[S,F]=(0,o.useState)(String(e.goal.weeklyFasts)),[C,A]=(0,o.useState)(!1),[D,L]=(0,o.useState)(!1),{plan:R,dayNumber:H,startProgram:I,clearProgram:P}=(0,d.useProgram)(),B=(0,o.useCallback)(async()=>{let e=new Date().toISOString().slice(0,10);await I({...d.SEED_PLAN_TUNA_30,startDate:e})},[I]),W=(0,o.useCallback)(async()=>{L(!1),await P()},[P]),E=async()=>{let t={...e,goal:{targetHours:Number(z)||16,weeklyFasts:Number(S)||5,proteinG:Number(i)||void 0,kcal:Number(s)||void 0,walkMin:Number(v)||void 0,weightKg:M?Number(M):void 0}};await a(t),A(!0),setTimeout(()=>A(!1),2e3)};return(0,r.jsxs)(p,{children:[(0,r.jsxs)(h,{children:[(0,r.jsxs)(g,{children:["◉ ",t("forma.settings.foodGoals")]}),(0,r.jsxs)(m,{children:[(0,r.jsx)(f,{children:t("forma.settings.proteinG")}),(0,r.jsx)(x,{type:"number",value:i,onChange:e=>n(e.target.value)})]}),(0,r.jsxs)(m,{children:[(0,r.jsx)(f,{children:t("forma.settings.kcal")}),(0,r.jsx)(x,{type:"number",value:s,onChange:e=>c(e.target.value)})]}),(0,r.jsxs)(m,{children:[(0,r.jsx)(f,{children:t("forma.settings.walkMin")}),(0,r.jsx)(x,{type:"number",value:v,onChange:e=>k(e.target.value)})]}),(0,r.jsxs)(m,{children:[(0,r.jsx)(f,{children:t("forma.settings.weightTarget")}),(0,r.jsx)(x,{type:"number",step:"0.1",value:M,onChange:e=>j(e.target.value)})]})]}),(0,r.jsxs)(h,{children:[(0,r.jsxs)(g,{children:["◉ ",t("forma.settings.fastingGoals")]}),(0,r.jsxs)(m,{children:[(0,r.jsx)(f,{children:t("forma.settings.targetHours")}),(0,r.jsx)(x,{type:"number",value:z,onChange:e=>T(e.target.value)})]}),(0,r.jsxs)(m,{children:[(0,r.jsx)(f,{children:t("forma.settings.weeklyFasts")}),(0,r.jsx)(x,{type:"number",value:S,onChange:e=>F(e.target.value)})]})]}),(0,r.jsxs)(h,{children:[(0,r.jsx)(g,{children:t("forma.program.title")}),R?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(b,{children:t("forma.program.active",{n:H??0})}),(0,r.jsx)(u,{style:{justifyContent:"flex-start"},children:(0,r.jsx)(l.$n,{variant:"danger",onClick:()=>L(!0),children:t("forma.program.clear")})})]}):(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(y,{children:t("forma.program.noProgram")}),(0,r.jsx)(u,{style:{justifyContent:"flex-start"},children:(0,r.jsx)(l.$n,{variant:"accent",onClick:()=>void B(),children:t("forma.program.start")})})]})]}),(0,r.jsxs)(u,{children:[C&&(0,r.jsx)(w,{children:t("forma.settings.saved")}),(0,r.jsx)(l.$n,{variant:"primary",onClick:()=>void E(),children:t("forma.settings.save")})]}),(0,r.jsx)(l.TM,{open:D,title:t("forma.program.confirmClear"),message:t("forma.program.confirmClearBody"),confirmLabel:t("forma.program.clear"),cancelLabel:t("forma.checkin.cancel"),onConfirm:()=>void W(),onCancel:()=>L(!1),danger:!0})]})}},22684(e,t,a){a.d(t,{q:()=>L});var r=a(65723),o=a(37991),i=a(36859),n=a.n(i),s=a(72799),l=a(6063),d=a(63236),c=a(73014);let p="#7fb77e",h="#facc15",g=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,m=n().section`
  background: ${l.w4.colors.surface};
...
`,D=n().p`
  ...
  line-height: 1.5;
  margin: 0;
`;function L({t:e,onOpenCheckIn:t,onOpenSettings:a}){let{plan:i,today:n,dayNumber:s}=(0,c.useProgram)(),{checkIn:p}=(0,c.useCheckIn)(),h=(0,o.useMemo)(()=>{if(!n)return"";let t=[`${n.oatsG}g`];return n.banana&&t.push(e("forma.program.breakfast.banana")),t.join(" + ")},[n,e]),g=(0,o.useMemo)(()=>n?e(n.dinnerKey):"",[n,e]);if(!i||null===n||null===s)return(0,r.jsxs)(C,{children:[(0,r.jsx)(w,{children:e("forma.program.title")}),(0,r.jsx)(A,{children:e("forma.program.startTitle")}),(0,r.jsx)(D,{children:e("forma.program.startBody")}),(0,r.jsx)("div",{children:(0,r.jsx)(d.$n,{variant:"primary",onClick:a,children:e("forma.program.start")})})]});let R=Array.from({length:30},(e,t)=>{let a=t+1;return a===s?"today":a<s?"past":"future"});return(0,r.jsxs)(m,{children:[(0,r.jsxs)(f,{children:[(0,r.jsx)(x,{children:s}),(0,r.jsxs)(u,{children:[(0,r.jsx)(w,{children:e("forma.program.dayOf",{n:30})}),(0,r.jsx)(y,{children:e("forma.program.title")}),n.refeed&&(0,r.jsx)(b,{children:e("forma.program.refeed")})]})]}),(0,r.jsx)($,{children:R.map((e,t)=>(0,r.jsx)(v,{state:e},t))}),(0,r.jsxs)(k,{children:[(0,r.jsxs)(M,{children:[(0,r.jsx)(j,{children:(0,r.jsx)(d.In,{name:"leaf",size:16})}),(0,r.jsx)(z,{children:e("forma.program.shake")}),(0,r.jsx)(T,{children:h})]}),(0,r.jsxs)(M,{children:[(0,r.jsx)(j,{children:(0,r.jsx)(d.In,{name:"utensils",size:16})}),(0,r.jsx)(z,{children:e("forma.program.dinner")}),(0,r.jsx)(T,{children:g})]}),(0,r.jsxs)(M,{children:[(0,r.jsx)(j,{children:(0,r.jsx)(d.In,{name:"heart",size:16})}),(0,r.jsx)(z,{children:e("forma.program.walkLabel")}),(0,r.jsx)(T,{children:e("forma.program.walk",{min:n.walkMin})})]})]}),(0,r.jsxs)(S,{children:[p?(0,r.jsxs)(F,{children:[(0,r.jsx)(d.In,{name:"check-circle",size:16}),e("forma.checkin.done")]}):(0,r.jsx)("span",{style:{fontSize:13,color:l.w4.colors.mainTextMuted},children:e("forma.checkin.prompt")}),(0,r.jsx)(d.$n,{variant:p?"ghost":"accent",onClick:t,children:p?e("forma.checkin.update"):e("forma.checkin.title")})]})]})}},19652(e,t,a){a.d(t,{_:()=>er});var r=a(65723),o=a(37991),i=a(36859),n=a.n(i),s=a(6063),l=a(63236),d=a(73014);let c="#7fb77e",p="#58a6ff",h="#facc15",g="#22d3ee",m=84.5,f=68.5,x=52.5,u=36.5,w=n().div`
  display: flex;
  align-items: center;
  gap: ${s.w4.spacing.lg};
  flex-wrap: wrap;
...
`,j=n().dd`
  ...
  margin: 0;
  white-space: nowrap;
`;function z({radius:e,pct:t,color:a}){let o=2*Math.PI*e,i=Math.min(1,Math.max(0,t));return(0,r.jsxs)("g",{children:[(0,r.jsx)("circle",{cx:92,cy:92,r:e,fill:"none",stroke:a,strokeOpacity:.18,strokeWidth:11}),(0,r.jsx)("circle",{cx:92,cy:92,r:e,fill:"none",stroke:a,strokeWidth:11,strokeDasharray:o,strokeDashoffset:o*(1-i),strokeLinecap:"round",transform:"rotate(-90 92 92)",style:{transition:"stroke-dashoffset 0.6s ease"}})]})}function T(e){return .5>Math.abs(e)?"flat":e>0?"up":"down"}function S(e,t,a=0){if(.5>Math.abs(e))return"\xb7";let r=Math.abs(e);return`${e>0?"+":"−"}${r.toFixed(a)}${t}`}function F({t:e,fastPct:t,fastHours:a,fastTargetHours:o,protein:i,proteinTarget:n,proteinYesterday:l,kcal:d,kcalTarget:C,kcalYesterday:A,waterMl:D,waterTargetMl:L,waterYesterdayMl:R}){let H=C>0?d/C:0,I=d>C&&C>0,P=I?h:"#f59e0b",B=i-l,W=d-A,E=D-R;return(0,r.jsxs)(w,{children:[(0,r.jsx)(y,{children:(0,r.jsxs)("svg",{width:184,height:184,viewBox:"0 0 184 184","aria-hidden":"true",children:[(0,r.jsx)(z,{radius:m,pct:t,color:c}),(0,r.jsx)(z,{radius:f,pct:n>0?i/n:0,color:p}),(0,r.jsx)(z,{radius:x,pct:Math.min(1,H),color:P}),(0,r.jsx)(z,{radius:u,pct:L>0?D/L:0,color:g})]})}),(0,r.jsxs)(b,{children:[(0,r.jsxs)($,{children:[(0,r.jsx)(v,{color:c}),(0,r.jsx)(k,{children:e("forma.today.fast")}),(0,r.jsxs)(j,{children:[a>0?a.toFixed(1):"0",(0,r.jsxs)("span",{style:{color:s.w4.colors.mainTextMuted},children:[" / ",o,"h"]})]})]}),(0,r.jsxs)($,{children:[(0,r.jsx)(v,{color:p}),(0,r.jsxs)(k,{children:[e("forma.today.protein"),(0,r.jsx)(M,{tone:T(B),children:S(B,"g")})]}),(0,r.jsxs)(j,{children:[Math.round(i),(0,r.jsxs)("span",{style:{color:s.w4.colors.mainTextMuted},children:[" / ",n,"g"]})]})]}),(0,r.jsxs)($,{children:[(0,r.jsx)(v,{color:P}),(0,r.jsxs)(k,{children:[e(I?"forma.today.kcalOver":"forma.today.kcal"),(0,r.jsx)(M,{tone:T(-W),children:S(W,"")})]}),(0,r.jsxs)(j,{style:{color:I?h:void 0},children:[Math.round(d),(0,r.jsxs)("span",{style:{color:s.w4.colors.mainTextMuted},children:[" / ",C,"kcal"]})]})]}),(0,r.jsxs)($,{children:[(0,r.jsx)(v,{color:g}),(0,r.jsxs)(k,{children:[e("forma.today.water"),(0,r.jsx)(M,{tone:T(E),children:S(E,"ml")})]}),(0,r.jsxs)(j,{children:[D,(0,r.jsxs)("span",{style:{color:s.w4.colors.mainTextMuted},children:[" / ",L,"ml"]})]})]})]})]})}let C="#7fb77e",A=n().section`
  background: ${s.w4.colors.surface};
  border: 1px solid ${s.w4.colors.border};
  border-left: 2px solid ${C};
  border-radius: ${s.w4.borderRadius.lg};
...
`,R=n().div`
  ...
  border: 1px solid ${({active:e})=>e?"rgba(249, 115, 22, 0.4)":s.w4.colors.border};
...
`,ea=n().div`
  ...
  font-family: ${s.w4.typography.fontFamilyMono};
  font-variant-numeric: tabular-nums;
`;function er({data:e,t,onLogMeal:a,onLogWalk:i,onLogWeight:n,onLogWater:c,onDeleteMeal:p,onEditMeal:h,onTapTemplate:g}){var m;let f=new Date().toISOString().slice(0,10),x=new Date(Date.now()-864e5).toISOString().slice(0,10),u=(0,d.proteinByDay)(e.meals,f),w=(0,d.proteinByDay)(e.meals,x),y=(0,d.kcalByDay)(e.meals,f),b=(0,d.kcalByDay)(e.meals,x),$=(0,d.kcalTargetForDate)(e,f),v=(m=e.walks,m.filter(e=>e.date===f).reduce((e,t)=>e+t.minutes,0)),k=(0,d.waterByDay)(e.water??[],f),M=(0,d.waterByDay)(e.water??[],x),j=e.goal.waterMl??2e3,z=e.meals.filter(e=>e.date===f).sort((e,t)=>e.createdAt-t.createdAt),T=e.goal.proteinG??110,S=(0,d.currentFast)(e),C=e.goal.targetHours??16,eo=S?.percent??0,ei=S?.hoursElapsed??0,en=(0,d.streakDays)(e.sessions,C),es=new Date().getDay(),el=new Set(z.map(e=>e.templateId).filter(e=>!!e)),ed=e.templates.filter(e=>e.weekday===es&&!el.has(e.id)).sort((e,t)=>("lunch"===e.slot?-1:1)-("lunch"===t.slot?-1:1)),[ec,ep]=(0,o.useState)(!1),[eh,eg]=(0,o.useState)(""),em=(0,o.useCallback)(()=>{let e=parseInt(eh,10);!isNaN(e)&&e>0&&(c(e),eg(""),ep(!1))},[eh,c]);return(0,r.jsxs)(A,{children:[(0,r.jsxs)(D,{children:[(0,r.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:s.w4.spacing.sm,flexWrap:"wrap"},children:[(0,r.jsxs)(L,{children:["◉ ",t("forma.today.title")]}),(0,r.jsxs)(R,{active:en>0,title:en>0?t("forma.streak",{n:en}):t("forma.streak.none"),children:[(0,r.jsx)("span",{"aria-hidden":"true",children:en>0?"\uD83D\uDD25":"\xb7"}),(0,r.jsx)(H,{children:en}),(0,r.jsx)("span",{children:t("forma.today.streakShort")})]})]}),(0,r.jsx)(L,{children:new Date().toLocaleDateString(void 0,{weekday:"long",day:"numeric",month:"short"})})]}),(0,r.jsx)(F,{t:t,fastPct:eo,fastHours:ei,fastTargetHours:C,protein:u,proteinTarget:T,proteinYesterday:w,kcal:y,kcalTarget:$,kcalYesterday:b,waterMl:k,waterTargetMl:j,waterYesterdayMl:M}),(0,r.jsxs)(G,{children:[(0,r.jsx)(l.$n,{variant:"primary",icon:(0,r.jsx)(l.In,{name:"plus",size:14}),onClick:a,children:t("forma.action.logMeal")}),(0,r.jsx)(l.$n,{variant:"ghost",icon:(0,r.jsx)(l.In,{name:"plus",size:14}),onClick:i,children:t("forma.action.logWalk")}),(0,r.jsx)(l.$n,{variant:"ghost",icon:(0,r.jsx)(l.In,{name:"plus",size:14}),onClick:n,children:t("forma.action.logWeight")})]}),(0,r.jsx)(K,{children:ec?(0,r.jsxs)("div",{style:{display:"flex",gap:s.w4.spacing.xs},children:[(0,r.jsx)("input",{type:"number",min:1,placeholder:"ml",value:eh,onChange:e=>eg(e.target.value),onKeyDown:e=>{"Enter"===e.key&&em()},style:{flex:1,height:44,background:s.w4.colors.surface,border:`1px solid ${s.w4.colors.border}`,borderRadius:s.w4.borderRadius.md,color:s.w4.colors.mainText,fontSize:13,fontFamily:s.w4.typography.fontFamilyMono,padding:`0 ${s.w4.spacing.sm}`},autoFocus:!0}),(0,r.jsx)(l.$n,{variant:"accent",onClick:em,children:t("forma.sheet.save")}),(0,r.jsx)(l.$n,{variant:"ghost",onClick:()=>ep(!1),children:t("forma.sheet.cancel")})]}):(0,r.jsxs)(V,{children:[(0,r.jsx)(q,{onClick:()=>c(250),children:t("forma.water.add250")}),(0,r.jsx)(q,{onClick:()=>c(500),children:t("forma.water.add500")}),(0,r.jsx)(q,{onClick:()=>c(1e3),children:t("forma.water.add1000")}),(0,r.jsx)(q,{onClick:()=>ep(!0),children:t("forma.water.addCustom")})]})}),g&&ed.length>0&&(0,r.jsxs)(I,{children:[(0,r.jsx)(L,{children:t("forma.today.tapToLog")}),(0,r.jsx)(P,{children:ed.map(e=>(0,r.jsxs)(B,{onClick:()=>g(e),title:t("forma.today.tapToLog"),children:[(0,r.jsx)(W,{children:(0,l.n6)(e.icon)?(0,r.jsx)(l.In,{name:e.icon,size:14}):(0,r.jsx)("span",{children:e.icon})}),(0,r.jsxs)(E,{children:[(0,r.jsx)(N,{children:t(e.nameKey)}),(0,r.jsxs)(O,{children:[e.proteinG,"g \xb7 ",e.kcal,"kcal"]})]}),(0,r.jsx)(Y,{children:t(`forma.meal.${e.slot}`)})]},e.id))})]}),0===z.length?(0,r.jsx)(et,{children:t("forma.today.noMealsYet")}):(0,r.jsx)(_,{children:z.map(e=>(0,r.jsxs)(J,{onClick:h?()=>h(e.id):void 0,style:{cursor:h?"pointer":"default"},title:h?t("forma.action.edit"):void 0,children:[(0,r.jsx)(Q,{tone:"lunch"===e.slot?"#58a6ff":"dinner"===e.slot?"#f59e0b":"#a371f7",title:t(`forma.meal.${e.slot}`),"aria-label":t(`forma.meal.${e.slot}`),children:(0,r.jsx)(l.In,{name:"lunch"===e.slot?"utensils":"dinner"===e.slot?"flame":"apple",size:12})}),(0,r.jsx)(U,{children:new Date(e.createdAt).toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit"})}),(0,r.jsx)(X,{children:e.notes||"—"}),(0,r.jsxs)(Z,{children:[e.proteinG??0,"g \xb7 ",e.kcal??0,"kcal"]}),(0,r.jsx)(ee,{onClick:t=>{t.stopPropagation(),p(e.id)},"aria-label":t("forma.action.delete"),children:(0,r.jsx)(l.In,{name:"trash",size:14})})]},e.id))}),v>0&&(0,r.jsx)(ea,{children:(0,r.jsx)("span",{children:t("forma.today.walkSummary",{min:v})})})]})}},20483(e,t,a){a.d(t,{v:()=>v});var r=a(65723),o=a(36859),i=a.n(o),n=a(72799),s=a(6063),l=a(63236);let d="#7fb77e",c=(0,n.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,p=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],h=["Dom","Seg","Ter","Qua","Qui","Sex","S\xe1b"];function g(e){return e.toISOString().slice(0,10)}let m=i().div`
...
`,$=i().div`
  ...
  border-radius: 50%;
  background: ${s.w4.colors.border};
`;function v({data:e,t,locale:a,onTapTemplate:o}){let i,n,s,d=(n=new Date(i=new Date),s=(i.getDay()+6)%7,n.setDate(i.getDate()-s),n.setHours(0,0,0,0),Array.from({length:7},(e,t)=>{let a=new Date(n);return a.setDate(n.getDate()+t),{date:g(a),weekday:a.getDay()}})),c=g(new Date),k="pt"===a?h:p,M=new Map;for(let t of e.templates)M.set(t.weekday,t);return(0,r.jsxs)(m,{children:[(0,r.jsx)(f,{children:t("forma.week.title")}),(0,r.jsx)(x,{children:d.map(({date:a,weekday:i})=>{let n=a===c,s=e.meals.some(e=>e.date===a),d=e.sessions.some(e=>void 0!==e.endedAt&&g(new Date(e.startedAt))===a),p=s||d,h=M.get(i),m=n&&void 0!==h&&void 0!==o&&!s;return(0,r.jsxs)(u,{isToday:n,isDone:p,tappable:m,onClick:()=>{m&&h&&o?.(h)},type:"button",title:m?t("forma.week.tapToLog"):void 0,"aria-label":m?t("forma.week.tapToLog"):void 0,children:[(0,r.jsx)(w,{isToday:n,children:k[i]}),p?(0,r.jsx)(b,{"aria-label":t("forma.week.done"),children:(0,r.jsx)(l.In,{name:"check-circle",size:14})}):h?(0,r.jsx)($,{title:t("forma.week.planned")}):null,h&&(0,r.jsx)(y,{children:t(h.nameKey)})]},a)})})]})}},11533(e,t,a){a.d(t,{h:()=>m});var r=a(65723),o=a(37991),i=a(36859),n=a.n(i),s=a(6063);let l="#7fb77e",d="#58a6ff",c=n().div`
  position: relative;
  width: 100%;
  height: 100%;
  min-height: 160px;
...
`,g=n().text`
  ...
  font-family: ${s.w4.typography.fontFamilyMono};
  fill: ${d};
`;function m({forecast:e,axes:t=!0,goalKg:a}){let i=e.history,n=(0,o.useMemo)(()=>(function(e){if(0===e.length)return[];let t=e[0].kg,a=[];for(let r of e)t=.25*r.kg+.75*t,a.push(t);return a})(i),[i]);if(0===i.length)return(0,r.jsx)(c,{children:(0,r.jsx)("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",height:"100%",color:s.w4.colors.mainTextMuted,fontSize:12,fontFamily:s.w4.typography.fontFamilyMono},children:"—"})});let f=t?40:8,x=t?22:6,u=i.map(e=>e.kg);void 0!==a&&u.push(a);let w=Math.min(...u),y=Math.max(...u),b=Math.max(2,y-w),$=w-.15*b,v=y+.15*b,k=v-$,M=new Date(i[0].date).getTime(),j=new Date(i[i.length-1].date).getTime(),z=Math.max(e.forecast.length?new Date(e.forecast[e.forecast.length-1].date).getTime():j,M+6048e5)-M||1,T=e=>f+(new Date(e).getTime()-M)/z*(600-2*f),S=e=>200-x-(e-$)/k*(200-2*x),F=i.length>=2?i.map((e,t)=>`${0===t?"M":"L"} ${T(e.date).toFixed(1)} ${S(n[t]).toFixed(1)}`).join(" "):"",C=e.forecast.length?`M ${T(i[i.length-1].date).toFixed(1)} ${S(n[n.length-1]).toFixed(1)} `+e.forecast.map(e=>`L ${T(e.date).toFixed(1)} ${S(e.kg).toFixed(1)}`).join(" "):"",A=i[i.length-1],D=e.forecast[e.forecast.length-1];return(0,r.jsx)(c,{children:(0,r.jsxs)(p,{viewBox:"0 0 600 200",preserveAspectRatio:"xMidYMid meet",children:[t&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(h,{x:4,y:x+4,children:v.toFixed(1)}),(0,r.jsx)(h,{x:4,y:200-x+4,children:$.toFixed(1)}),(0,r.jsx)("line",{x1:f,y1:200-x,x2:600-f,y2:200-x,stroke:s.w4.colors.border,strokeWidth:1}),(0,r.jsx)("line",{x1:f,y1:x,x2:f,y2:200-x,stroke:s.w4.colors.border,strokeWidth:1})]}),void 0!==a&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)("line",{x1:f,y1:S(a),x2:600-f,y2:S(a),stroke:d,strokeWidth:1,strokeDasharray:"2 4",opacity:.7}),t&&(0,r.jsx)(g,{x:600-f+4,y:S(a)+3,children:a.toFixed(1)})]}),F&&(0,r.jsx)("path",{d:F,fill:"none",stroke:l,strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"}),C&&(0,r.jsx)("path",{d:C,fill:"none",stroke:l,strokeWidth:2,strokeDasharray:"4 4",strokeLinecap:"round",opacity:.55}),i.map(e=>(0,r.jsx)("circle",{cx:T(e.date),cy:S(e.kg),r:3,fill:s.w4.colors.surface,stroke:l,strokeWidth:1.5,children:(0,r.jsx)("title",{children:`${e.date} \xb7 ${e.kg.toFixed(1)} kg`})},e.date)),D&&(0,r.jsx)("circle",{cx:T(D.date),cy:S(D.kg),r:3,fill:l,opacity:.6}),A&&(0,r.jsx)("circle",{cx:T(A.date),cy:S(A.kg),r:5,fill:l,stroke:s.w4.colors.surface,strokeWidth:1.5})]})})}},92152(e,t,a){a.d(t,{m:()=>M});var r=a(65723),o=a(37991),i=a(36859),n=a.n(i),s=a(6063),l=a(63236),d=a(73014),c=a(11533);let p="#7fb77e",h=n().section`
  display: flex;
  flex-direction: column;
  gap: ${s.w4.spacing.lg};
`,g=n().div`
...
`,z=s().span`
  ...
  line-height: 1;
  letter-spacing: 0;
`,T=["#3b82f6","#8b5cf6","#ec4899","#10b981","#f59e0b","#06b6d4"],S=0,F=new Map;function C({member:e,size:t=24}){var a,o;let i,n="shared"===e.id||"shared"===e.role,s=Math.floor(.55*t),d=t<=18?8:t<=22?9:t<=28?11:12;if(n)return(0,r.jsx)(j,{size:t,bg:l.w4.colors.surface,ring:!0,"aria-label":"Shared",title:"Shared",style:{color:l.w4.colors.mainTextMuted},children:(0,r.jsx)(M,{name:"home",size:s,"aria-hidden":!0})});let c=(a=e.id,(o=e.color)?o:(!F.has(a)&&(F.set(a,T[S%T.length]),S++),F.get(a))),p="adult"===e.role,h=(i=e.name.trim().split(/\s+/),((i[0]?.[0]??"")+(i[1]?.[0]??"")).toUpperCase().slice(0,2));return(0,r.jsx)(j,{size:t,bg:c,ring:p,title:e.name,children:(0,r.jsx)(z,{fontSize:d,children:h})})}s().img`
  width: ${({size:e})=>e}px;
  height: ${({size:e})=>e}px;
  border-radius: 50%;
  object-fit: cover;
...
`;function J({title:e,accessory:t,accentColor:a,error:o,errorLabel:i,children:n}){return(0,r.jsxs)(Y,{accentColor:a,"data-widget-shell":!0,children:[(0,r.jsxs)(G,{children:[(0,r.jsx)(O,{children:e}),t&&(0,r.jsx)(K,{children:t})]}),o?(0,r.jsxs)(q,{role:"alert",children:[(0,r.jsx)(_,{children:i??"Error"}),(0,r.jsx)("div",{children:o})]}):(0,r.jsx)(V,{children:n})]})}s().div`
  position: relative;
  display: flex;
  flex-direction: column;
  height: 100%;
...
`,s().div`
  position: relative;
`;let e9="260px",te="56px",tt="48px",ta=s().header`
  display: flex;
  align-items: center;
...
`,ts=s().span`
  ...
  animation: ${ti} 10s ease ${({index:e})=>.07*e}s infinite;
...
`,tm=s().main`
  ...
  display: flex;
  flex-direction: column;
`,tf=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function tx(){return(0,r.jsx)(tn,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:tf.map((e,t)=>(0,r.jsx)(ts,{index:t,accent:e.accent,children:e.char},t))})}let tu="atlantis:sidebar-collapsed";function tw({sidebar:e,children:t,topBarRight:n,title:s="Atlantis",activeId:l=null}){let[d,c]=(0,o.useState)(()=>{try{return"true"===localStorage.getItem(tu)}catch{return!1}}),[p,h]=(0,o.useState)(null),g=(0,o.useRef)(),m=()=>c(e=>{let t=!e;try{localStorage.setItem(tu,String(t))}catch{}return t}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(a.bind(a,45816)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(eq.I.Provider,{value:{collapsed:d,toggle:m,flyout:p,openFlyout:(e,t,a)=>{clearTimeout(g.current),h({entry:e,anchorY:t,onSelect:a})},scheduleFlyoutClose:()=>{g.current=setTimeout(()=>h(null),160)},cancelFlyoutClose:()=>clearTimeout(g.current)},children:(0,r.jsxs)(tp,{children:[(0,r.jsxs)(ta,{children:[e&&(0,r.jsx)(tr,{children:(0,r.jsx)(to,{onClick:m,title:d?"Expand sidebar":"Collapse sidebar",children:(0,r.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,r.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,r.jsx)("path",{d:"M9 3v18"})]})})}),(0,r.jsx)(tx,{}),s&&(0,r.jsx)(tl,{children:s}),n&&(0,r.jsx)(td,{children:n})]}),(0,r.jsxs)(tc,{children:[null!=e&&(0,r.jsx)(th,{collapsed:d,children:(0,r.jsx)(tg,{children:e})}),(0,r.jsx)(tm,{children:t})]}),p&&(0,r.jsx)(i().Suspense,{fallback:null,children:(0,r.jsx)(f,{activeId:l})})]})})}s().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
...
`,s().div`
  flex: 1;
`;let ty={"1m":30,"3m":90,"6m":180,"1y":365};function tb(e,t,a){let r=new Date(a??new Date);return r.setDate(r.getDate()-(t-1-e)),r.toISOString().slice(0,10)}let t$=["#1a2420","#2a4535","#4a7a5a","#6fa77a","#7fb77e"],tv="'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, monospace",tk=["S","T","Q","Q","S","S","D"],tM=["S","M","T","W","T","F","S"];function tj({data:e,cellSize:t=10,gap:a=2,locale:i="pt",tooltip:n,showMonthLabels:s=!1,accent:d,selectedIndex:c,onCellClick:p}){let h=(0,o.useId)();if(!e.length)return null;let g=!!p,m=d??l.w4.colors.accent,f=Math.ceil(e.length/7),x=14*!!s,u=24+f*(t+a),w=x+14+7*(t+a),y=[];if(s&&e.length>0){let r=new Date,o=-1;for(let n=0;n<e.length;n++){let s=Math.floor(n/7);if(0!=n%7)continue;let l=new Date(tb(n,e.length,r)),d=l.getMonth();if(d!==o){o=d;let e=new Intl.DateTimeFormat("pt"===i?"pt-PT":"en-US",{month:"short"}).format(l),r=18+s*(t+a);y.push({label:e.charAt(0).toUpperCase()+e.slice(1),x:r})}}}let b=x+2;return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)("style",{children:`
        @keyframes ${h}_fade { from { opacity: 0; } to { opacity: 1; } }
      `}),(0,r.jsxs)("svg",{viewBox:`0 0 ${u} ${w}`,preserveAspectRatio:"xMidYMid meet",style:{width:"100%",height:"auto",maxHeight:220,display:"block"},"aria-hidden":g?void 0:"true",role:g?"grid":void 0,"aria-label":void 0,children:[s&&(0,r.jsx)("g",{fontFamily:tv,fontSize:"8",fill:l.w4.colors.mainTextMuted,children:y.map(({label:e,x:t},a)=>(0,r.jsx)("text",{x:t,y:10,children:e},a))}),(0,r.jsx)("g",{fontFamily:tv,fontSize:"8",fill:l.w4.colors.mainTextMuted,children:("pt"===i?tk:tM).map((e,o)=>(0,r.jsx)("text",{x:"0",y:b+8+o*(t+a),children:e},o))}),e.map((e,o)=>{let i=18+Math.floor(o/7)*(t+a),s=b+o%7*(t+a),l=t$[Math.max(0,Math.min(4,e))]??t$[0],d=n?.(o,e),f=c===o;return g?(0,r.jsx)("rect",{x:i,y:s,width:t,height:t,fill:l,rx:"1",stroke:f?m:"none",strokeWidth:1.5*!!f,role:"button",tabIndex:0,style:{animation:`${h}_fade 0.3s ease-out ${8*o}ms both`,cursor:"pointer",outline:"none"},onClick:()=>p?.(o,e),onKeyDown:t=>{("Enter"===t.key||" "===t.key)&&(t.preventDefault(),p?.(o,e))},children:d?(0,r.jsx)("title",{children:d}):null},o):(0,r.jsx)("rect",{x:i,y:s,width:t,height:t,fill:l,rx:"1",stroke:f?m:"none",strokeWidth:1.5*!!f,style:{animation:`${h}_fade 0.3s ease-out ${8*o}ms both`},children:d?(0,r.jsx)("title",{children:d}):null},o)})]})]})}let tz=["1m","3m","6m","1y"];function tT({range:e,onChange:t,labels:a}){return(0,r.jsx)("div",{style:{display:"flex",gap:4,flexWrap:"wrap"},children:tz.map(o=>{let i=o===e,n=a?.[o]??o;return(0,r.jsx)("button",{onClick:()=>t(o),style:{height:28,padding:"0 10px",fontSize:11,fontFamily:tv,fontWeight:600,textTransform:"uppercase",letterSpacing:"0.1em",borderRadius:4,border:`1px solid ${i?l.w4.colors.accent:l.w4.colors.border}`,background:i?`${l.w4.colors.accent}18`:"transparent",color:i?l.w4.colors.accent:l.w4.colors.mainTextMuted,cursor:"pointer",transition:"border-color 0.14s ease, color 0.14s ease, background 0.14s ease",outline:"none"},onFocus:e=>{e.currentTarget.style.outline=`2px solid ${l.w4.colors.accent}`,e.currentTarget.style.outlineOffset="2px"},onBlur:e=>{e.currentTarget.style.outline="none"},"aria-pressed":i,children:n},o)})})}},9391(e,t,a){a.d(t,{O:()=>n});var r=a(65723);a(37991);var o=a(63236);let i={sm:20,md:24,lg:28};function n({member:e,size:t="md"}){let a="number"==typeof t?t:i[t];return(0,r.jsx)(o.eu,{member:e,size:a})}},85043(e,t,a){a.d(t,{Y:()=>p});var r=a(65723),o=a(36859),i=a.n(o),n=a(6063);let s=i().div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
`,d().span`
  ...
  flex-shrink: 0;
  text-align: right;
`,a(83090);let c="'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, monospace";function p({data:e,budget:t,height:a=200,animation:r="rise"}){let s=(0,i.useId)();if(!e.length)return null;let l=1.1*Math.max(...e.map(e=>e.segments.reduce((e,t)=>e+t.value,0)+(e.over??0)),t??0)||1,d=472,h=a-20-24,g=472/e.length*.58,m=d/e.length,f="rise"===r?{transformOrigin:"bottom",animation:`${s}_rise 0.45s ease-out both`}:{};return(0,o.jsxs)(o.Fragment,{children:["rise"===r&&(0,o.jsx)("style",{children:`
          @keyframes ${s}_rise {
            from { transform: scaleY(0); }
            to   { transform: scaleY(1); }
          }
        `}),(0,o.jsxs)("svg",{viewBox:`0 0 520 ${a}`,style:{width:"100%",height:a},preserveAspectRatio:"xMidYMid meet","aria-hidden":"true",children:[null!=t?(0,o.jsxs)("g",{children:[(0,o.jsx)("line",{x1:40,x2:40+d,y1:20+h-t/l*h,y2:20+h-t/l*h,stroke:n.w4.colors.border,strokeDasharray:"3 3",strokeWidth:"1"}),(0,o.jsxs)("text",{x:36,y:20+h-t/l*h+3,textAnchor:"end",fontFamily:c,fontSize:"9",fill:n.w4.colors.mainTextMuted,children:["€",t]})]}):null,e.map((e,t)=>{let r,i=40+t*m+(m-g)/2,s=20+h;return(0,o.jsxs)("g",{style:f,children:[e.segments.map(e=>{let t=e.value/l*h;return s-=t,(0,o.jsx)("rect",{x:i,y:s,width:g,height:t,fill:e.color,opacity:.85},e.id)}),null!=e.over&&e.over>0?(r=e.over/l*h,s-=r,(0,o.jsx)("rect",{x:i,y:s,width:g,height:r,fill:"#f85149",opacity:.7},"over")):null,(0,o.jsx)("text",{x:i+g/2,y:a-6,textAnchor:"middle",fontFamily:c,fontSize:"10",fill:n.w4.colors.mainTextMuted,children:e.label})]},e.label)})]})]})}var h=a(63236);function g(e){let t=0;for(let a=1;a<e.length;a++){let r=e[a][0]-e[a-1][0],o=e[a][1]-e[a-1][1];t+=Math.sqrt(r*r+o*o)}return t}function m({spent:e,budget:t,height:a=60}){let r=(0,i.useId)(),s=1.05*t||1,l=Array.from({length:8},(e,a)=>t-t/7*a),d=Math.min(e/(t||1),1),c=Array.from({length:8},(e,a)=>Math.max(0,t-a/7*t*d*1.1)),p=l.map((e,t)=>[320*t/7,a-e/s*(a-5)]),h=c.map((e,t)=>[320*t/7,a-e/s*(a-5)]),f=p.map(e=>e.join(",")).join(" "),x=h.map(e=>e.join(",")).join(" "),u=g(p).toFixed(1),w=g(h).toFixed(1);return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)("style",{children:`
