...
`,l().div`
  position: relative;
`;let N="260px",O="56px",W="48px",G=l().header`
  display: flex;
  align-items: center;
...
`,er=l().div`
  ...
  overflow: hidden;
`,et=l().aside`
  width: ${({collapsed:e})=>e?O:N};
  min-width: ${({collapsed:e})=>e?O:N};
  background: ${s.w4.colors.sidebarBg};
  border-right: 1px solid ${s.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
