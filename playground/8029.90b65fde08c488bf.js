...
`,oB=({size:o=14,strokeWidth:e=1.75})=>(0,a.jsxs)("svg",{width:o,height:o,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:e,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,a.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,a.jsx)("polyline",{points:"14 2 14 8 20 8"})]});function oC({iconKey:o}){let e=o?oA[o]:null;return e?(0,a.jsx)(e,{size:14,strokeWidth:1.75}):(0,a.jsx)(oB,{})}function oR({entries:o,activeId:e,onSelect:t}){return(0,a.jsx)(a.Fragment,{children:o.map(o=>o.children?(0,a.jsx)(n().Fragment,{children:(0,a.jsx)(oR,{entries:o.children,activeId:e,onSelect:t})},o.id):(0,a.jsxs)(oF,{active:e===o.id,onClick:()=>t(o),children:[(0,a.jsx)(oC,{iconKey:o.icon}),o.name]},o.id))})}function oL({activeId:o}){let{flyout:e,scheduleFlyoutClose:t,cancelFlyoutClose:r}=(0,c.c)();if(!e)return null;let n=e.entry.icon?oA[e.entry.icon]:null;return(0,a.jsxs)(oS,{anchorY:e.anchorY,onMouseEnter:r,onMouseLeave:t,children:[(0,a.jsxs)(oj,{children:[n?(0,a.jsx)(n,{size:13,strokeWidth:2}):(0,a.jsx)(oB,{size:13,strokeWidth:2}),e.entry.name]}),(0,a.jsx)(oR,{entries:e.entry.children??[],activeId:o,onSelect:o=>{e.onSelect(o),t()}})]})}},814(o,e,t){t.d(e,{I:()=>r,c:()=>n});var a=t(7991);let r=(0,a.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),n=()=>(0,a.useContext)(r)},3930(o,e,t){t.d(e,{PL:()=>C.getSetting,MJ:()=>N,mZ:()=>C.updateDoc,KL:()=>C.saveDoc,cL:()=>c.c,Is:()=>C.putSetting,UO:()=>oe,PE:()=>F,w4:()=>a.w4});var a=t(1316),r=t(5723),n=t(7991),i=t.n(n),l=t(6859),s=t.n(l);s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,s().div`
  position: relative;
`;var d=t(2799),c=t(814);let p="260px",g="56px",m="48px",f=s().header`
  display: flex;
  align-items: center;
...
`,V=s().div`
  ...
  color: ${a.w4.colors.sidebarTextMuted};
  font-family: ${a.w4.typography.fontFamily};
`;function N({onSave:o,onUpdate:e,onCancel:t,existingDoc:a}){let[i,l]=(0,n.useState)(a?.name??""),s=(0,n.useRef)(null);return(0,n.useEffect)(()=>{s.current?.focus(),a&&s.current?.select()},[a]),(0,r.jsx)(R,{onClick:t,children:(0,r.jsxs)(L,{onClick:o=>o.stopPropagation(),children:[(0,r.jsx)(H,{children:"Save document"}),a&&e&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(V,{children:"Update the current version or save as a new one."}),(0,r.jsxs)(P,{children:[(0,r.jsx)(D,{onClick:t,children:"Cancel"}),(0,r.jsxs)(D,{danger:!0,onClick:e,children:['Update "',a.name,'"']})]}),(0,r.jsx)(I,{})]}),(0,r.jsx)(E,{ref:s,value:i,onChange:o=>l(o.target.value),onKeyDown:r=>{"Enter"===r.key&&i.trim()&&(a&&i.trim()===a.name&&e?e():o(i.trim())),"Escape"===r.key&&t()},placeholder:a?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,r.jsxs)(P,{children:[!a&&(0,r.jsx)(D,{onClick:t,children:"Cancel"}),(0,r.jsx)(D,{primary:!0,disabled:!i.trim(),onClick:()=>o(i.trim()),children:"Save as new"})]})]})})}let K=(0,d.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,Y=(0,d.keyframes)`
...
`;function oe({appId:o,onLoad:e}){let[t,a]=(0,n.useState)(!1),[i,l]=(0,n.useState)([]),s=(0,n.useRef)(null),d=(0,n.useCallback)(()=>{(0,C.listDocs)(o).then(l).catch(()=>{})},[o]);(0,n.useEffect)(()=>{if(!t)return;d();let o=o=>{s.current&&!s.current.contains(o.target)&&a(!1)};return document.addEventListener("mousedown",o),()=>document.removeEventListener("mousedown",o)},[t,d]);let c=async(o,e)=>{o.stopPropagation(),await (0,C.deleteDoc)(e),l(o=>o.filter(o=>o.id!==e))};return(0,r.jsxs)(G,{ref:s,children:[(0,r.jsxs)(O,{onClick:()=>a(o=>!o),children:[(0,r.jsx)("svg",{width:14,height:14,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:(0,r.jsx)("path",{d:"M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"})}),"Saved",(0,r.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",style:{marginLeft:2},children:(0,r.jsx)("path",{d:"M6 9l6 6 6-6"})})]}),(0,r.jsxs)(W,{open:t,children:[(0,r.jsx)(_,{children:"Saved versions"}),(0,r.jsx)(J,{children:0===i.length?(0,r.jsx)(U,{children:"No saved documents yet."}):i.map(o=>{var t;return(0,r.jsxs)(Z,{children:[(0,r.jsxs)(q,{onClick:()=>{e(o.content,o.id,o.name),a(!1)},children:[(0,r.jsx)(X,{children:o.name}),(0,r.jsx)(Q,{children:(t=o.savedAt,new Intl.DateTimeFormat(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}).format(new Date(t)))})]}),(0,r.jsx)(oo,{onClick:e=>c(e,o.id),title:"Delete",children:(0,r.jsxs)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,r.jsx)("polyline",{points:"3 6 5 6 21 6"}),(0,r.jsx)("path",{d:"M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6M10 11v6M14 11v6"}),(0,r.jsx)("path",{d:"M9 6V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2"})]})})]},o.id)})})]})]})}s().div`
...
`;s().div`
  ...
  background: ${a.w4.colors.mainBg};
  font-family: ${a.w4.typography.fontFamily};
  animation: ${ot} 0.4s ease 0.15s both;
`,s().div`
  position: relative;
  width: 56px;
  height: 56px;
...
`,s().div`
  position: absolute;
  inset: 0;
  animation: ${oa} 1.4s cubic-bezier(0.4, 0, 0.2, 1) infinite;
