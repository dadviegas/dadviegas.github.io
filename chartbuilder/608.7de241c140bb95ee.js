"use strict";(self.webpackChunk_atlantis_chartbuilder=self.webpackChunk_atlantis_chartbuilder||[]).push([["608"],{1317(o,a,e){e.d(a,{Cd:()=>n,LH:()=>t,Qh:()=>r,YH:()=>l,YL:()=>i,aT:()=>d});let t={Default:["#388bfd","#3fb950","#d29922","#a371f7","#f87171","#22d3ee","#fb923c","#34d399"],Sunset:["#f97316","#ef4444","#ec4899","#a855f7","#8b5cf6","#6366f1","#f59e0b","#10b981"],Ocean:["#06b6d4","#0ea5e9","#3b82f6","#6366f1","#8b5cf6","#a855f7","#0891b2","#1d4ed8"],Forest:["#22c55e","#16a34a","#15803d","#86efac","#4ade80","#bbf7d0","#166534","#14532d"]};function r(o){let a=o.trim().split("\n").filter(o=>o.trim());return a.length<2?{headers:[],rows:[]}:{headers:a[0].split(",").map(o=>o.trim()),rows:a.slice(1).map(o=>{let a=o.split(",").map(o=>o.trim());return{label:a[0]??"",values:a.slice(1).map(o=>parseFloat(o)||0)}})}}function i(o,a){let e={top:30,right:20,bottom:50,left:60};return{pad:e,w:o-e.left-e.right,h:a-e.top-e.bottom}}function n(o){if(o<=0)return 10;let a=Math.pow(10,Math.floor(Math.log10(o)));return Math.ceil(o/a)*a}function l(o,a=5){let e=n(o)/a;return Array.from({length:a+1},(o,a)=>a*e)}function d(o){return Math.abs(o)>=1e6?(o/1e6).toFixed(1)+"M":Math.abs(o)>=1e3?(o/1e3).toFixed(0)+"k":String(Math.round(10*o)/10)}},5151(o,a,e){e.d(a,{k:()=>t});let t=[{label:"Monthly Revenue (Bar)",type:"bar",xCol:"Month",yCols:["Revenue"],title:"Monthly Revenue 2024",csv:`Month,Revenue
Jan,42500
Feb,38200
Mar,51300
Apr,47800
