"use strict";(self.webpackChunk_atlantis_regexlab=self.webpackChunk_atlantis_regexlab||[]).push([[188],{188(e,o,r){var n=r(7359),t=r(8997),s=r(3233),a=r(5723),l=r(6480),i=r(679),d=r(2534),c=r(947),p=r(9336),g=r(8104);const x=[{bg:"rgba(56,139,253,0.25)",border:"#388bfd",label:"#388bfd"},{bg:"rgba(63,185,80,0.25)",border:"#3fb950",label:"#3fb950"},{bg:"rgba(210,153,34,0.25)",border:"#d29922",label:"#d29922"},{bg:"rgba(163,113,247,0.25)",border:"#a371f7",label:"#a371f7"},{bg:"rgba(248,113,113,0.25)",border:"#f87171",label:"#f87171"},{bg:"rgba(34,211,238,0.25)",border:"#22d3ee",label:"#22d3ee"}],u=["g","i","m","s","u"],f=s.default.div`
  display: flex;
...
//# sourceMappingURL=188.91783a2730e81705dd5d.js.map