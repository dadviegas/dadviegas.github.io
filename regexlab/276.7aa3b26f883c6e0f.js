...
`,l().div`
  position: relative;
`;let os="260px",oc="56px",op="48px",og=l().header`
  display: flex;
  align-items: center;
...
`,o$=l().div`
  ...
  overflow: hidden;
`,ov=l().aside`
  width: ${({collapsed:o})=>o?oc:os};
  min-width: ${({collapsed:o})=>o?oc:os};
  background: ${d.w4.colors.sidebarBg};
  border-right: 1px solid ${d.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,oM=l().main`
  ...
  display: flex;
  flex-direction: column;
`,ok=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function oA(){return(0,t.jsx)(ox,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:ok.map((o,e)=>(0,t.jsx)(ou,{index:e,accent:o.accent,children:o.char},e))})}let oT="atlantis:sidebar-collapsed";function oS({sidebar:o,children:e,topBarRight:n,title:l="Atlantis",activeId:d=null}){let[s,c]=(0,r.useState)(()=>{try{return"true"===localStorage.getItem(oT)}catch{return!1}}),[p,g]=(0,r.useState)(null),h=(0,r.useRef)(),m=()=>c(o=>{let e=!o;try{localStorage.setItem(oT,String(e))}catch{}return e}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(a.bind(a,5816)).then(o=>({default:o.FlyoutPanel}))),[]);return(0,t.jsx)(E.I.Provider,{value:{collapsed:s,toggle:m,flyout:p,openFlyout:(o,e,a)=>{clearTimeout(h.current),g({entry:o,anchorY:e,onSelect:a})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,t.jsxs)(o$,{children:[(0,t.jsxs)(og,{children:[o&&(0,t.jsx)(oh,{children:(0,t.jsx)(om,{onClick:m,title:s?"Expand sidebar":"Collapse sidebar",children:(0,t.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("path",{d:"M9 3v18"})]})})}),(0,t.jsx)(oA,{}),l&&(0,t.jsx)(ob,{children:l}),n&&(0,t.jsx)(oy,{children:n})]}),(0,t.jsxs)(ow,{children:[null!=o&&(0,t.jsx)(ov,{collapsed:s,children:(0,t.jsx)(oz,{children:o})}),(0,t.jsx)(oM,{children:e})]}),p&&(0,t.jsx)(i().Suspense,{fallback:null,children:(0,t.jsx)(f,{activeId:d})})]})})}l().div`
  display: grid;
  grid-template-rows: ${({open:o})=>o?"1fr":"0fr"};
