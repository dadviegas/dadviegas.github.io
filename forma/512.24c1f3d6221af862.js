...
`,em=n().div`
  ...
  font-family: ${l.w4.typography.fontFamilyMono};
  color: ${l.w4.colors.mainTextMuted};
`;function eg({data:e,t,locale:a}){let[i,n]=(0,o.useState)(()=>B()),s=(0,o.useCallback)(()=>n(e=>E(e,-1)),[]),l=(0,o.useCallback)(()=>n(e=>E(e,1)),[]),d=(0,o.useCallback)(()=>n(B()),[]),p=(0,o.useMemo)(()=>{let e=B();return i.year===e.year&&i.month===e.month},[i]),{fastHours:h,proteinByDayMap:m,weightByDayMap:g,walkByDayMap:f,checkInDays:x}=(0,o.useMemo)(()=>{let t=function(e,t){let a={};for(let r of e.sessions){if(void 0===r.endedAt)continue;let e=r.startedAt,o=r.endedAt;for(;e<o;){let r=new Date(e);if(r.getFullYear()===t.year&&r.getMonth()===t.month){let i=new Date(r.getFullYear(),r.getMonth(),r.getDate()).getTime()+864e5,n=Math.min(o,i)-e,s=W(t,r.getDate());a[s]=(a[s]??0)+n/36e5,e=i}else e=new Date(r.getFullYear(),r.getMonth(),r.getDate()).getTime()+864e5}}return a}(e,i),a=`${i.year}-${String(i.month+1).padStart(2,"0")}-`,r={};for(let t of e.meals)t.date.startsWith(a)&&(r[t.date]=(r[t.date]??0)+(t.proteinG??0));let o={};for(let t of e.weights)t.date.startsWith(a)&&(o[t.date]=t.kg);let n={};for(let t of e.walks)t.date.startsWith(a)&&(n[t.date]=(n[t.date]??0)+t.minutes);return{fastHours:t,proteinByDayMap:r,weightByDayMap:o,walkByDayMap:n,checkInDays:new Set(e.checkIns.filter(e=>e.date.startsWith(a)).map(e=>e.date))}},[e,i]),u=new Date(i.year,i.month+1,0).getDate(),w=new Date().toISOString().slice(0,10),y=(0,o.useMemo)(()=>Object.values(h).reduce((e,t)=>e+t,0),[h]),b=e.goal.proteinG??110,$=Object.values(m),v=$.length?$.reduce((e,t)=>e+t,0)/$.length:0,k=(0,o.useMemo)(()=>{let e=Object.keys(g).sort();if(e.length<2)return 0;let t=g[e[0]],a=g[e[e.length-1]];return void 0===t||void 0===a?0:a-t},[g]),M=(0,o.useMemo)(()=>Object.values(f).reduce((e,t)=>e+t,0),[f]),j=(new Date(i.year,i.month,1).getDay()+6)%7,z=[];for(let e=0;e<j;e++)z.push({key:`lead-${e}`,day:null,iso:null});for(let e=1;e<=u;e++){let t=W(i,e);z.push({key:t,day:e,iso:t})}for(;z.length%7!=0;)z.push({key:`tail-${z.length}`,day:null,iso:null});let T=Math.max(18,...Object.values(h)),S=[];for(let e=1;e<=u;e++)S.push(m[W(i,e)]??0);for(;S.length<31;)S.push(0);let F=[];for(let e=1;e<=u;e++){let t=g[W(i,e)];void 0!==t&&F.push(t)}return(0,r.jsxs)(K,{children:[(0,r.jsxs)(V,{children:[(0,r.jsx)(q,{children:new Date(i.year,i.month,1).toLocaleDateString("pt"===a?"pt-PT":"en-US",{month:"long",year:"numeric"})}),(0,r.jsxs)(_,{children:[(0,r.jsx)(J,{onClick:s,"aria-label":t("forma.month.prev"),children:(0,r.jsx)(R.In,{name:"chevron-left",size:16})}),(0,r.jsx)(Q,{onClick:d,disabled:p,"aria-label":t("forma.month.today"),children:t("forma.month.today")}),(0,r.jsx)(J,{onClick:l,disabled:p,"aria-label":t("forma.month.next"),children:(0,r.jsx)(R.In,{name:"chevron-right",size:16})})]})]}),(0,r.jsxs)(U,{children:[(0,r.jsxs)(X,{children:[(0,r.jsx)(Z,{children:t("forma.month.kpi.fastHours")}),(0,r.jsxs)(ee,{children:[y.toFixed(0),(0,r.jsx)(et,{children:"h"})]})]}),(0,r.jsxs)(X,{children:[(0,r.jsx)(Z,{children:t("forma.month.kpi.avgProtein")}),(0,r.jsxs)(ee,{children:[v.toFixed(0),(0,r.jsxs)(et,{children:["g / ",b,"g"]})]})]}),(0,r.jsxs)(X,{children:[(0,r.jsx)(Z,{children:t("forma.month.kpi.weightDelta")}),(0,r.jsxs)(ee,{children:[0===k?"—":`${k>0?"+":""}${k.toFixed(1)}`,(0,r.jsx)(et,{children:"kg"})]})]}),(0,r.jsxs)(X,{children:[(0,r.jsx)(Z,{children:t("forma.month.kpi.walks")}),(0,r.jsxs)(ee,{children:[M,(0,r.jsx)(et,{children:"min"})]})]})]}),(0,r.jsxs)(ea,{children:[(0,r.jsxs)(er,{children:["◉ ",t("forma.month.calendar.title")]}),(0,r.jsxs)(ei,{children:[("pt"===a?["S","T","Q","Q","S","S","D"]:["M","T","W","T","F","S","S"]).map((e,t)=>(0,r.jsx)(en,{children:e},`h-${t}`)),z.map(e=>{if(null===e.day||null===e.iso)return(0,r.jsx)(el,{},e.key);let t=h[e.iso]??0,a=Math.min(1,t/T),o=void 0!==g[e.iso],i=x.has(e.iso),n=(f[e.iso]??0)>0;return(0,r.jsxs)(es,{bg:function(e){if(e<=0)return P;let t=Math.round(O[0]+(Y[0]-O[0])*e),a=Math.round(O[1]+(Y[1]-O[1])*e),r=Math.round(O[2]+(Y[2]-O[2])*e);return`rgb(${t},${a},${r})`}(a),today:e.iso===w,title:`${e.iso} \xb7 ${t.toFixed(1)}h fast`,children:[e.day,(0,r.jsxs)(ed,{children:[o&&(0,r.jsx)(ec,{color:"#58a6ff"}),i&&(0,r.jsx)(ec,{color:"#a371f7"}),n&&(0,r.jsx)(ec,{color:"#d29922"})]})]},e.key)})]})]}),(0,r.jsxs)(eo,{children:[(0,r.jsxs)(ea,{children:[(0,r.jsxs)(er,{children:["◉ ",t("forma.month.protein.title")]}),0===$.length?(0,r.jsx)(c.YG,{mode:"empty",label:t("forma.analytics.empty")}):(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(ep,{children:S.slice(0,u).map((e,t)=>(0,r.jsx)(eh,{h:Math.min(100,e/(1.2*b)*100),over:e>=b,title:`${W(i,t+1)} \xb7 ${e.toFixed(0)}g`},t))}),(0,r.jsxs)(em,{children:[(0,r.jsx)("span",{children:"1"}),(0,r.jsx)("span",{children:Math.ceil(u/2)}),(0,r.jsx)("span",{children:u})]})]})]}),(0,r.jsxs)(ea,{children:[(0,r.jsxs)(er,{children:["◉ ",t("forma.month.weight.title")]}),F.length<2?(0,r.jsx)(c.YG,{mode:"empty",label:t("forma.analytics.empty")}):(0,r.jsx)(c.OW,{points:F,accent:I,width:260,height:100,fluid:!0})]})]})]})}let ef="#7fb77e",ex="#58a6ff",eu="#d29922",ew="#7fb77e",ey=["Mo","Tu","We","Th","Fr","Sa","Su"],eb=["Se","Te","Qa","Qi","Sx","S\xe1","Do"],e$=new Set([0,4,8,12,16,20]);function ev(e){return[parseInt(e.slice(1,3),16),parseInt(e.slice(3,5),16),parseInt(e.slice(5,7),16)]}let ek=ev("#1d2230"),eM=ev(ef);function ej(e){let t=Math.round(ek[0]+(eM[0]-ek[0])*e),a=Math.round(ek[1]+(eM[1]-ek[1])*e),r=Math.round(ek[2]+(eM[2]-ek[2])*e);return`rgb(${t},${a},${r})`}let ez=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,eT=n().div`
  background: ${l.w4.colors.surface};
...
`,u=n().div`
  flex: 1;
  min-height: 60px;
`;function w({data:e,t,onClick:a}){let i=(0,o.useMemo)(()=>(0,l.weightForecast)(e.weights,60,30),[e.weights]),n=i.history.length>0?i.history[i.history.length-1]:null,c=i.forecast.length>0?i.forecast[i.forecast.length-1]:null,y=n&&c?c.kg-n.kg:0;return(0,r.jsxs)(p,{onClick:a,"aria-label":t("forma.miniWeight.aria"),children:[(0,r.jsxs)(h,{children:[(0,r.jsxs)(m,{children:["◉ ",t("forma.miniWeight.title")]}),c&&(0,r.jsxs)(x,{pos:y>0,children:[y>=0?"+":"",y.toFixed(1),"kg / 30d"]})]}),(0,r.jsxs)(g,{children:[(0,r.jsx)(f,{children:n?n.kg.toFixed(1):"—"}),(0,r.jsx)("span",{style:{color:s.w4.colors.mainTextMuted,fontSize:13,fontFamily:s.w4.typography.fontFamilyMono},children:"kg"}),c&&(0,r.jsxs)("span",{style:{color:s.w4.colors.mainTextMuted,fontSize:12,fontFamily:s.w4.typography.fontFamilyMono},children:["→ ",c.kg.toFixed(1)," kg"]})]}),(0,r.jsx)(u,{children:(0,r.jsx)(d.h,{forecast:i,axes:!1})})]})}},86704(e,t,a){a.d(t,{g:()=>z});var r=a(65723),o=a(37991),i=a(36859),n=a.n(i),s=a(72799),l=a(6063),d=a(63236),c=a(16736);let p="#7fb77e",h=new Date().toISOString().slice(0,10),m=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,g=n().section`
  display: flex;
...
`,v=n().dd`
  ...
  margin: 0;
  white-space: nowrap;
`;function k({radius:e,pct:t,color:a}){let o=2*Math.PI*e,i=Math.min(1,Math.max(0,t));return(0,r.jsxs)("g",{children:[(0,r.jsx)("circle",{cx:90,cy:90,r:e,fill:"none",stroke:a,strokeOpacity:.18,strokeWidth:14}),(0,r.jsx)("circle",{cx:90,cy:90,r:e,fill:"none",stroke:a,strokeWidth:14,strokeDasharray:o,strokeDashoffset:o*(1-i),strokeLinecap:"round",transform:"rotate(-90 90 90)",style:{transition:"stroke-dashoffset 0.6s ease"}})]})}function M({t:e,fastPct:t,fastHours:a,fastTargetHours:o,protein:i,proteinTarget:n,kcal:l,kcalTarget:d}){let j=d>0?l/d:0,z=l>d&&d>0,T=z?h:"#f59e0b";return(0,r.jsxs)(x,{children:[(0,r.jsx)(u,{children:(0,r.jsxs)("svg",{width:180,height:180,viewBox:"0 0 180 180","aria-hidden":"true",children:[(0,r.jsx)(k,{radius:m,pct:t,color:c}),(0,r.jsx)(k,{radius:g,pct:n>0?i/n:0,color:p}),(0,r.jsx)(k,{radius:f,pct:Math.min(1,j),color:T})]})}),(0,r.jsxs)(w,{children:[(0,r.jsxs)(y,{children:[(0,r.jsx)(b,{color:c}),(0,r.jsx)($,{children:e("forma.today.fast")}),(0,r.jsxs)(v,{children:[a>0?a.toFixed(1):"0",(0,r.jsxs)("span",{style:{color:s.w4.colors.mainTextMuted},children:[" / ",o,"h"]})]})]}),(0,r.jsxs)(y,{children:[(0,r.jsx)(b,{color:p}),(0,r.jsx)($,{children:e("forma.today.protein")}),(0,r.jsxs)(v,{children:[Math.round(i),(0,r.jsxs)("span",{style:{color:s.w4.colors.mainTextMuted},children:[" / ",n,"g"]})]})]}),(0,r.jsxs)(y,{children:[(0,r.jsx)(b,{color:T}),(0,r.jsx)($,{children:e(z?"forma.today.kcalOver":"forma.today.kcal")}),(0,r.jsxs)(v,{style:{color:z?h:void 0},children:[Math.round(l),(0,r.jsxs)("span",{style:{color:s.w4.colors.mainTextMuted},children:[" / ",d,"kcal"]})]})]})]})]})}let j="#7fb77e",z=n().section`
  background: ${s.w4.colors.surface};
  border: 1px solid ${s.w4.colors.border};
...
`,Z=n().div`
  ...
  font-family: ${s.w4.typography.fontFamilyMono};
  font-variant-numeric: tabular-nums;
`;function ee({data:e,t,onLogMeal:a,onLogWalk:i,onLogWeight:n,onLogWater:c,onDeleteMeal:p,onEditMeal:h,onTapTemplate:m}){var g;let f=new Date().toISOString().slice(0,10),x=(0,d.proteinByDay)(e.meals,f),u=(0,d.kcalByDay)(e.meals,f),w=(0,d.kcalTargetForDate)(e,f),y=(g=e.walks,g.filter(e=>e.date===f).reduce((e,t)=>e+t.minutes,0)),b=(0,d.waterByDay)(e.water??[],f),$=e.goal.waterMl??2e3,v=e.meals.filter(e=>e.date===f).sort((e,t)=>e.createdAt-t.createdAt),k=e.goal.proteinG??110,j=(0,d.currentFast)(e),et=e.goal.targetHours??16,ea=j?.percent??0,er=j?.hoursElapsed??0,eo=(0,d.streakDays)(e.sessions,et),ei=new Date().getDay(),en=new Set(v.map(e=>e.templateId).filter(e=>!!e)),es=e.templates.filter(e=>e.weekday===ei&&!en.has(e.id)).sort((e,t)=>("lunch"===e.slot?-1:1)-("lunch"===t.slot?-1:1)),[el,ed]=(0,o.useState)(!1),[ec,ep]=(0,o.useState)(""),eh=(0,o.useCallback)(()=>{let e=parseInt(ec,10);!isNaN(e)&&e>0&&(c(e),ep(""),ed(!1))},[ec,c]);return(0,r.jsxs)(z,{children:[(0,r.jsxs)(T,{children:[(0,r.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:s.w4.spacing.sm,flexWrap:"wrap"},children:[(0,r.jsxs)(S,{children:["◉ ",t("forma.today.title")]}),(0,r.jsxs)(F,{active:eo>0,title:eo>0?t("forma.streak",{n:eo}):t("forma.streak.none"),children:[(0,r.jsx)("span",{"aria-hidden":"true",children:eo>0?"\uD83D\uDD25":"\xb7"}),(0,r.jsx)(C,{children:eo}),(0,r.jsx)("span",{children:t("forma.today.streakShort")})]})]}),(0,r.jsx)(S,{children:new Date().toLocaleDateString(void 0,{weekday:"long",day:"numeric",month:"short"})})]}),(0,r.jsx)(M,{t:t,fastPct:ea,fastHours:er,fastTargetHours:et,protein:x,proteinTarget:k,kcal:u,kcalTarget:w}),(0,r.jsxs)(N,{children:[(0,r.jsx)(l.$n,{variant:"primary",icon:(0,r.jsx)(l.In,{name:"plus",size:14}),onClick:a,children:t("forma.action.logMeal")}),(0,r.jsx)(l.$n,{variant:"ghost",icon:(0,r.jsx)(l.In,{name:"plus",size:14}),onClick:i,children:t("forma.action.logWalk")}),(0,r.jsx)(l.$n,{variant:"ghost",icon:(0,r.jsx)(l.In,{name:"plus",size:14}),onClick:n,children:t("forma.action.logWeight")})]}),(0,r.jsxs)(O,{children:[(0,r.jsxs)(Y,{children:[(0,r.jsxs)(S,{children:[(0,r.jsx)(l.In,{name:"droplets",size:12,style:{verticalAlign:"middle",marginRight:4}}),t("forma.today.water")]}),(0,r.jsxs)("span",{style:{fontSize:11,fontFamily:s.w4.typography.fontFamilyMono,fontVariantNumeric:"tabular-nums",color:s.w4.colors.mainTextMuted},children:[b," / ",$," ml"]})]}),(0,r.jsx)(E,{children:(0,r.jsx)(W,{pct:b/$*100})}),el?(0,r.jsxs)("div",{style:{display:"flex",gap:s.w4.spacing.xs},children:[(0,r.jsx)("input",{type:"number",min:1,placeholder:"ml",value:ec,onChange:e=>ep(e.target.value),onKeyDown:e=>{"Enter"===e.key&&eh()},style:{flex:1,height:44,background:s.w4.colors.surface,border:`1px solid ${s.w4.colors.border}`,borderRadius:s.w4.borderRadius.md,color:s.w4.colors.mainText,fontSize:13,fontFamily:s.w4.typography.fontFamilyMono,padding:`0 ${s.w4.spacing.sm}`},autoFocus:!0}),(0,r.jsx)(l.$n,{variant:"accent",onClick:eh,children:t("forma.sheet.save")}),(0,r.jsx)(l.$n,{variant:"ghost",onClick:()=>ed(!1),children:t("forma.sheet.cancel")})]}):(0,r.jsxs)(G,{children:[(0,r.jsx)(K,{onClick:()=>c(250),children:t("forma.water.add250")}),(0,r.jsx)(K,{onClick:()=>c(500),children:t("forma.water.add500")}),(0,r.jsx)(K,{onClick:()=>c(1e3),children:t("forma.water.add1000")}),(0,r.jsx)(K,{onClick:()=>ed(!0),children:t("forma.water.addCustom")})]})]}),m&&es.length>0&&(0,r.jsxs)(A,{children:[(0,r.jsx)(S,{children:t("forma.today.tapToLog")}),(0,r.jsx)(D,{children:es.map(e=>(0,r.jsxs)(L,{onClick:()=>m(e),title:t("forma.today.tapToLog"),children:[(0,r.jsx)(H,{children:(0,l.n6)(e.icon)?(0,r.jsx)(l.In,{name:e.icon,size:14}):(0,r.jsx)("span",{children:e.icon})}),(0,r.jsxs)(R,{children:[(0,r.jsx)(I,{children:t(e.nameKey)}),(0,r.jsxs)(P,{children:[e.proteinG,"g \xb7 ",e.kcal,"kcal"]})]}),(0,r.jsx)(B,{children:t(`forma.meal.${e.slot}`)})]},e.id))})]}),0===v.length?(0,r.jsx)(X,{children:t("forma.today.noMealsYet")}):(0,r.jsx)(V,{children:v.map(e=>(0,r.jsxs)(q,{onClick:h?()=>h(e.id):void 0,style:{cursor:h?"pointer":"default"},title:h?t("forma.action.edit"):void 0,children:[(0,r.jsx)(_,{children:t(`forma.meal.${e.slot}`)}),(0,r.jsx)(J,{children:e.notes||"—"}),(0,r.jsxs)(Q,{children:[e.proteinG??0,"g \xb7 ",e.kcal??0,"kcal"]}),(0,r.jsx)(U,{onClick:t=>{t.stopPropagation(),p(e.id)},"aria-label":t("forma.action.delete"),children:(0,r.jsx)(l.In,{name:"trash",size:14})})]},e.id))}),y>0&&(0,r.jsx)(Z,{children:(0,r.jsx)("span",{children:t("forma.today.walkSummary",{min:y})})})]})}},20483(e,t,a){a.d(t,{v:()=>v});var r=a(65723),o=a(36859),i=a.n(o),n=a(72799),s=a(6063),l=a(63236);let d="#7fb77e",c=(0,n.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
...
`,E=s().span`
  ...
  display: inline-block;
`;function W({tone:e="neutral",dot:t,children:a,...o}){return(0,r.jsxs)(B,{tone:e,...o,children:[(t??"live"===e)&&(0,r.jsx)(E,{}),a]})}s().kbd`
  font-family: ${l.w4.typography.fontFamilyMono};
  font-size: 10px;
  padding: 2px 6px;
  border: 1px solid ${l.w4.colors.border};
...
`;function eN({type:e,children:t}){let a=eP[e]??eP.NOTE;return(0,r.jsxs)(eB,{bg:a.bg,border:a.border,children:[(0,r.jsxs)(eE,{color:a.color,children:[(0,r.jsx)(M,{name:a.icon,size:15,strokeWidth:2}),a.label]}),(0,r.jsx)(eW,{children:t})]})}s().nav`
  width: 220px;
  min-width: 220px;
