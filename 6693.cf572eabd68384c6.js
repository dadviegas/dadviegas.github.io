...
`,P=o().div`
  ...
  white-space: nowrap;
`;function E({locale:e}){var t;let i=(0,n.useMemo)(()=>(0,c.Nx)("pt"===e?"pt":"en",p.A),[e]),{forecast:a,failed:o}=(0,x.useWeather)({lat:f,lon:w,current:"temperature_2m,apparent_temperature,relative_humidity_2m,weather_code,wind_speed_10m,is_day",daily:"temperature_2m_max,temperature_2m_min,sunrise,sunset,uv_index_max",timezone:"auto",cacheKey:"weather-lisbon-v3"}),s=()=>(0,l.VJ)("earth",{placeId:"lisbon"}),h=a&&a.current?a.current:null,j=a&&a.daily?a.daily:null,_=null!==h&&null!==j,k=h?.temperature_2m??0,I=h?.apparent_temperature??k,R=h?.relative_humidity_2m??0,W=h?.weather_code??0,K=h?.wind_speed_10m??0,B=h?.is_day===1,J=_?(t=W,B?0===t?"#fbbf24":1===t?"#fcd34d":2===t?"#60a5fa":3===t?"#94a3b8":t>=95?"#c084fc":t>=51?"#38bdf8":t>=45?"#cbd5e1":"#60a5fa":t>=95?"#a78bfa":t>=51?"#60a5fa":"#818cf8"):m.A.accentColor,O=Math.round(j?.temperature_2m_max?.[0]??k),U=Math.round(j?.temperature_2m_min?.[0]??k),V=Math.round(j?.uv_index_max?.[0]??0),q=j?.sunrise?.[0],Q=j?.sunset?.[0],X=Q?new Date(Q).getTime():NaN,Z=Number.isFinite(X)&&Date.now()<X?"sunset":"sunrise",ee="sunset"===Z?Q:j?.sunrise?.[1]??q;return(0,r.jsx)(d.rl,{title:i("weather.city.lisbon"),accessory:(0,r.jsx)(z,{children:i("weather.openInEarth")}),accentColor:J,error:o&&!_?i("widget.error.body"):void 0,errorLabel:o&&!_?i("widget.error.label"):void 0,children:_||o?_?(0,r.jsxs)($,{role:"link",tabIndex:0,onClick:s,onKeyDown:e=>{("Enter"===e.key||" "===e.key)&&(e.preventDefault(),s())},children:[(0,r.jsxs)(M,{children:[(0,r.jsx)(C,{accent:J,children:(0,r.jsx)(T,{children:!B&&W in v?v[W]:g[W]??"\uD83C\uDF21️"})}),(0,r.jsxs)(N,{children:[(0,r.jsxs)(D,{children:[(0,r.jsxs)(L,{accent:J,children:[Math.round(k),"\xb0"]}),(0,r.jsxs)(S,{children:[(0,r.jsxs)("div",{children:["▲ ",(0,r.jsxs)("span",{children:[O,"\xb0"]})]}),(0,r.jsxs)("div",{children:["▼ ",(0,r.jsxs)("span",{children:[U,"\xb0"]})]})]})]}),(0,r.jsx)(A,{children:("pt"===e?b:y)[W]??("pt"===e?"Desconhecido":"Unknown")}),(0,r.jsx)(F,{children:i("weather.feelsLike",{t:Math.round(I)})})]})]}),(0,r.jsxs)(G,{children:[(0,r.jsxs)(Y,{children:[(0,r.jsxs)(H,{children:["\uD83D\uDCA7 ",i("weather.humidity")]}),(0,r.jsxs)(P,{children:[R,"%"]})]}),(0,r.jsxs)(Y,{children:[(0,r.jsxs)(H,{children:["\uD83D\uDCA8 ",i("weather.wind")]}),(0,r.jsxs)(P,{children:[Math.round(K)," km/h"]})]}),(0,r.jsxs)(Y,{children:[(0,r.jsxs)(H,{children:["☀️ ",i("weather.uv")]}),(0,r.jsx)(P,{children:V})]}),(0,r.jsxs)(Y,{children:[(0,r.jsxs)(H,{children:["sunset"===Z?"\uD83C\uDF07":"\uD83C\uDF05"," ",i("sunset"===Z?"weather.sunset":"weather.sunrise")]}),(0,r.jsx)(P,{children:ee?new Date(ee).toLocaleTimeString("pt"===e?"pt-PT":"en-GB",{hour:"2-digit",minute:"2-digit"}):"—"})]})]})]}):null:(0,r.jsx)(u.YG,{mode:"loading",label:i("widget.loading")})})}}}]);