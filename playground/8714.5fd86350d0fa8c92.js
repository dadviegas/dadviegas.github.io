...
`,J=s().div`
  ...
  color: ${a.w4.colors.sidebarTextMuted};
  font-family: ${a.w4.typography.fontFamily};
`;function U({onSave:o,onUpdate:e,onCancel:t,existingDoc:a}){let[i,l]=(0,n.useState)(a?.name??""),s=(0,n.useRef)(null);return(0,n.useEffect)(()=>{s.current?.focus(),a&&s.current?.select()},[a]),(0,r.jsx)(K,{onClick:t,children:(0,r.jsxs)(V,{onClick:o=>o.stopPropagation(),children:[(0,r.jsx)(Y,{children:"Save document"}),a&&e&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(J,{children:"Update the current version or save as a new one."}),(0,r.jsxs)(_,{children:[(0,r.jsx)(O,{onClick:t,children:"Cancel"}),(0,r.jsxs)(O,{danger:!0,onClick:e,children:['Update "',a.name,'"']})]}),(0,r.jsx)(W,{})]}),(0,r.jsx)(G,{ref:s,value:i,onChange:o=>l(o.target.value),onKeyDown:r=>{"Enter"===r.key&&i.trim()&&(a&&i.trim()===a.name&&e?e():o(i.trim())),"Escape"===r.key&&t()},placeholder:a?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,r.jsxs)(_,{children:[!a&&(0,r.jsx)(O,{onClick:t,children:"Cancel"}),(0,r.jsx)(O,{primary:!0,disabled:!i.trim(),onClick:()=>o(i.trim()),children:"Save as new"})]})]})})}let q=(0,d.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,Z=(0,d.keyframes)`
