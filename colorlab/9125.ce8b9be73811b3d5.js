"use strict";(self.webpackChunk_atlantis_colorlab=self.webpackChunk_atlantis_colorlab||[]).push([["9125"],{5628(o,e,a){function t(o){let e=o.replace("#","");if(3===e.length){let o=parseInt(e[0]+e[0],16);return{r:o,g:parseInt(e[1]+e[1],16),b:parseInt(e[2]+e[2],16)}}if(6===e.length){let o=parseInt(e.slice(0,2),16);return{r:o,g:parseInt(e.slice(2,4),16),b:parseInt(e.slice(4,6),16)}}return null}function r(o,e,a){return"#"+[o,e,a].map(o=>Math.round(Math.max(0,Math.min(255,o))).toString(16).padStart(2,"0")).join("")}function i(o,e,a){let t=o/255,r=e/255,i=a/255,n=Math.max(t,r,i),l=Math.min(t,r,i),d=(n+l)/2;if(n===l)return{h:0,s:0,l:Math.round(100*d)};let s=n-l;return{h:Math.round(360*(n===t?((r-i)/s+6*(r<i))/6:n===r?((i-t)/s+2)/6:((t-r)/s+4)/6)),s:Math.round(100*(d>.5?s/(2-n-l):s/(n+l))),l:Math.round(100*d)}}function n(o,e,a){let t=a/100,r=e/100*(1-Math.abs(2*t-1)),i=r*(1-Math.abs(o/60%2-1)),n=t-r/2,l=0,d=0,s=0;return o<60?(l=r,d=i,s=0):o<120?(l=i,d=r,s=0):o<180?(l=0,d=r,s=i):o<240?(l=0,d=i,s=r):o<300?(l=i,d=0,s=r):(l=r,d=0,s=i),{r:Math.round((l+n)*255),g:Math.round((d+n)*255),b:Math.round((s+n)*255)}}function l(o,e,a){let t=o=>{let e=o/255;return e<=.04045?e/12.92:Math.pow((e+.055)/1.055,2.4)};return .2126*t(o)+.7152*t(e)+.0722*t(a)}function d(o,e){let a=l(o.r,o.g,o.b),t=l(e.r,e.g,e.b);return parseFloat(((Math.max(a,t)+.05)/(Math.min(a,t)+.05)).toFixed(2))}function s(o,e){return[10,20,30,40,50,60,70,80,90].map(a=>({h:o,s:Math.min(e,90),l:a}))}function c(o,e,a){return{h:(o+180)%360,s:e,l:a}}function p(o,e,a){return[{h:(o+30)%360,s:e,l:a},{h:(o-30+360)%360,s:e,l:a}]}function g(o,e,a){return[{h:o,s:e,l:a},{h:(o+120)%360,s:e,l:a},{h:(o+240)%360,s:e,l:a}]}a.d(e,{E2:()=>t,Hg:()=>c,K6:()=>i,Lt:()=>g,Ob:()=>r,YL:()=>n,eM:()=>d,iW:()=>s,mW:()=>p})},7330(o,e,a){a.d(e,{FlyoutPanel:()=>oL});var t=a(5723),r=a(7991),i=a.n(r),n=a(6859),l=a.n(n),d=a(2799),s=a(1316),c=a(814),p=a(6896),g=a(7902),m=a(3013),f=a(2887),x=a(9510),h=a(9848),u=a(7901),b=a(3045),w=a(3775),y=a(1783),$=a(3539),v=a(9416),z=a(1837),k=a(7167),M=a(4494),A=a(2314),T=a(255),S=a(5751),F=a(9633),j=a(2946),B=a(822),H=a(6720),R=a(7400),L=a(8456),C=a(3317),P=a(2709),E=a(8006),V=a(9301),K=a(7561),I=a(3517),D=a(8207),N=a(7032),Y=a(6949),G=a(8218),O=a(6829),_=a(9591),W=a(5553),J=a(9923),Z=a(2820),U=a(4621),q=a(8479),X=a(2534),Q=a(6673),oo=a(7490),oe=a(9033),oa=a(9038),ot=a(5775),or=a(1365),oi=a(2937),on=a(9821),ol=a(5912),od=a(158),os=a(8641),oc=a(8607),op=a(3249),og=a(1821),om=a(5889),of=a(9655),ox=a(7170),oh=a(9161),ou=a(1849),ob=a(1604),ow=a(3142),oy=a(1187),o$=a(7747),ov=a(2932),oz=a(4525),ok=a(7230),oM=a(2164);let oA={activity:p.A,"a-large-small":g.A,apple:m.A,"arrow-right":f.A,"bar-chart-2":x.A,book:h.A,"book-open":u.A,briefcase:b.A,calendar:w.A,clock:y.A,"circle-dot":$.A,cloud:v.A,compass:z.A,cpu:k.A,droplets:M.A,feather:A.A,file:T.A,"file-text":S.A,folder:F.A,"git-branch":j.A,github:B.A,globe:H.A,grid:R.A,hand:L.A,hash:C.A,heart:P.A,key:E.A,hexagon:V.A,home:K.A,landmark:I.A,layers:D.A,"layout-grid":N.A,leaf:Y.A,lightbulb:G.A,list:O.A,map:_.A,"map-pin":W.A,"message-circle":J.A,"message-square":Z.A,minus:U.A,monitor:q.A,mountain:X.A,package:Q.A,palette:oo.A,"pen-tool":oe.A,"pie-chart":oa.A,plane:ot.A,plus:or.A,ruler:oi.A,shirt:on.A,slash:ol.A,square:od.A,star:os.A,sun:oc.A,terminal:op.A,thermometer:og.A,triangle:om.A,trophy:of.A,truck:ox.A,type:oh.A,users:ou.A,"volume-2":ob.A,watch:ow.A,waves:oy.A,wind:o$.A,wrench:ov.A,x:oz.A,zap:ok.A,bot:oM.A},oT=(0,d.keyframes)`
...
`,d().div`
  position: relative;
`;var s=a(2799),c=a(814);let p="260px",g="56px",m="48px",f=d().header`
  display: flex;
  align-items: center;
