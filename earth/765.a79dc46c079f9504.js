"use strict";(self.webpackChunk_atlantis_earth=self.webpackChunk_atlantis_earth||[]).push([["765"],{8859(a,e,n){n.d(e,{FlyoutPanel:()=>x});var o=n(5723),i=n(7991),t=n.n(i),l=n(6859),r=n.n(l),m=n(2799),c=n(1316),d=n(814),g=n(6140);let s=(0,m.keyframes)`
...
`,u=r().div`
  ...
  min-width: 210px;
  overflow-y: auto;
  animation: ${s} 0.18s cubic-bezier(0.22, 1, 0.36, 1) forwards;
...
`,x=m().span`
  ...
  animation: ${z} 10s ease ${({index:a})=>.07*a}s infinite;
...
`,v=m().div`
  ...
  overflow: hidden;
`,A=m().aside`
  width: ${({collapsed:a})=>a?s:g};
  min-width: ${({collapsed:a})=>a?s:g};
  background: ${o.w4.colors.sidebarBg};
  border-right: 1px solid ${o.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,S=m().main`
  ...
  display: flex;
  flex-direction: column;
`,$=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function B(){return(0,i.jsx)(y,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:$.map((a,e)=>(0,i.jsx)(x,{index:e,accent:a.accent,children:a.char},e))})}let L="atlantis:sidebar-collapsed";function T({sidebar:a,children:e,topBarRight:o,title:r="Atlantis",activeId:m=null}){let[c,g]=(0,t.useState)(()=>{try{return"true"===localStorage.getItem(L)}catch{return!1}}),[s,u]=(0,t.useState)(null),z=(0,t.useRef)(),y=()=>g(a=>{let e=!a;try{localStorage.setItem(L,String(e))}catch{}return e}),x=l().useMemo(()=>l().lazy(()=>Promise.resolve().then(n.bind(n,8859)).then(a=>({default:a.FlyoutPanel}))),[]);return(0,i.jsx)(d.I.Provider,{value:{collapsed:c,toggle:y,flyout:s,openFlyout:(a,e,n)=>{clearTimeout(z.current),u({entry:a,anchorY:e,onSelect:n})},scheduleFlyoutClose:()=>{z.current=setTimeout(()=>u(null),160)},cancelFlyoutClose:()=>clearTimeout(z.current)},children:(0,i.jsxs)(v,{children:[(0,i.jsxs)(f,{children:[a&&(0,i.jsx)(p,{children:(0,i.jsx)(h,{onClick:y,title:c?"Expand sidebar":"Collapse sidebar",children:(0,i.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,i.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,i.jsx)("path",{d:"M9 3v18"})]})})}),(0,i.jsx)(B,{}),r&&(0,i.jsx)(b,{children:r}),o&&(0,i.jsx)(w,{children:o})]}),(0,i.jsxs)(M,{children:[null!=a&&(0,i.jsx)(A,{collapsed:c,children:(0,i.jsx)(k,{children:a})}),(0,i.jsx)(S,{children:e})]}),s&&(0,i.jsx)(l().Suspense,{fallback:null,children:(0,i.jsx)(x,{activeId:m})})]})})}var C=n(6140);let j=m().div`
  display: grid;
...
`;function K({iconKey:a,size:e=16}){let n=a?C.X[a]:void 0;return n?(0,i.jsx)("svg",{width:e,height:e,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,dangerouslySetInnerHTML:{__html:n}}):a?(0,i.jsx)("span",{style:{fontSize:e,lineHeight:1,display:"flex",alignItems:"center"},children:a}):(0,i.jsxs)("svg",{width:e,height:e,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,children:[(0,i.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,i.jsx)("polyline",{points:"14 2 14 8 20 8"})]})}function D({entry:a,activeId:e,onSelect:n}){let[o,l]=(0,t.useState)(a.defaultOpen??!0),{collapsed:r,openFlyout:m,scheduleFlyoutClose:c,cancelFlyoutClose:g}=(0,d.c)();return a.children&&a.children.length>0?(0,i.jsxs)(R,{children:[(0,i.jsxs)(G,{collapsed:r,onClick:()=>{r||l(a=>!a)},onMouseEnter:r?e=>{m(a,e.currentTarget.getBoundingClientRect().top,n)}:void 0,onMouseLeave:r?c:void 0,children:[(0,i.jsxs)(H,{collapsed:r,children:[(0,i.jsx)(K,{iconKey:a.icon,size:16}),(0,i.jsx)(N,{collapsed:r,children:a.name})]}),(0,i.jsx)(I,{open:o,collapsed:r,children:(0,i.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round",children:(0,i.jsx)("path",{d:"M9 6l6 6-6 6"})})})]}),(0,i.jsx)(j,{open:o&&!r,children:(0,i.jsx)(E,{children:(0,i.jsx)(P,{children:a.children.map(a=>(0,i.jsx)(D,{entry:a,activeId:e,onSelect:n},a.id))})})})]}):(0,i.jsxs)(V,{active:e===a.id,collapsed:r,onClick:()=>n(a),onMouseEnter:r?e=>{let o=e.currentTarget.getBoundingClientRect();m({id:a.id,name:a.name,icon:a.icon,file:a.file,children:[a]},o.top,n)}:void 0,onMouseLeave:r?c:void 0,children:[(0,i.jsx)(K,{iconKey:a.icon,size:15}),(0,i.jsx)(N,{collapsed:r,children:a.name})]})}function F({entries:a,activeId:e,onSelect:n}){return(0,i.jsx)("div",{children:a.map(a=>(0,i.jsx)(D,{entry:a,activeId:e,onSelect:n},a.id))})}n(8859),m().button`
  display: flex;
  align-items: center;
  justify-content: center;
  width: 32px;
