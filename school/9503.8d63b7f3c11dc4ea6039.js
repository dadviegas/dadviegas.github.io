"use strict";(self.webpackChunk_atlantis_school=self.webpackChunk_atlantis_school||[]).push([[9503],{9752(e,a,o){o.d(a,{WO:()=>Za});var n=o(27359),i=o(4901),t=o(53233),r=o(17681),l=o(69753),s=o(88641),c=o(41783),d=o(65723);function m(e){try{return JSON.parse(localStorage.getItem(e)??"[]")}catch{return[]}}const u=t.default.nav`padding: ${i.w4.spacing.sm} 0;`,p=t.default.div`
...
`,t.default.span`
  ...
  font-weight: 600;
  margin-left: auto;
`,new Map},30894(e,a,o){o.d(a,{Ym:()=>c});var n=o(27359),i=o(4901);const t="atlantis:locale",r="shell:locale";function l(e){return"en"===e||"pt"===e}function s(){try{const e=localStorage.getItem(t);if(l(e))return e}catch{}return"en"}function c(){const[e,a]=(0,n.useState)(s),o=(0,n.useCallback)(e=>{a(e),function(e){try{localStorage.setItem(t,e)}catch{}(0,i.Is)(r,e).catch(()=>{})}(e),window.dispatchEvent(new CustomEvent("atlantis:locale-change",{detail:e}))},[]);return(0,n.useEffect)(()=>{const e=e=>{const o=e.detail;a(o)};return window.addEventListener("atlantis:locale-change",e),()=>window.removeEventListener("atlantis:locale-change",e)},[]),(0,n.useEffect)(()=>{(0,i.PL)(r).then(o=>{if(l(o)&&o!==e){try{localStorage.setItem(t,o)}catch{}a(o)}}).catch(()=>{})},[]),[e,o]}(0,i.PL)(r).then(e=>{if(l(e))try{localStorage.setItem(t,e)}catch{}}).catch(()=>{});var d=o(53233);o(65723),d.default.div`
  display: flex;
  gap: 4px;
  background: ${i.w4.colors.surface};
  border: 1px solid ${i.w4.colors.border};
