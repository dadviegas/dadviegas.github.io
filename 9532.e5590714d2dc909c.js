"use strict";(self.webpackChunk_atlantis_shell=self.webpackChunk_atlantis_shell||[]).push([["9532"],{22247(e,t,i){i.d(t,{AskSessionsWidget:()=>$});var n=i(65723),a=i(37991),r=i(36859),s=i.n(r),l=i(72799),o=i(6063),c=i(63236),p=i(28170),d=i(98975);let g=(0,l.keyframes)`
...
`,x=s().p`
  ...
  max-width: 240px;
  margin: 0;
`;function $({locale:e}){let t=(0,a.useMemo)(()=>(0,p.Nx)("pt"===e?"pt":"en",d.A),[e]),[i,r]=(0,a.useState)([]),[s,l]=(0,a.useState)(!1),g=(0,a.useCallback)(async()=>{r((await (0,o.Iu)("ask")).map(e=>(function(e,t){let i,n=[];try{let t=JSON.parse(e.content);Array.isArray(t.turns)&&(n=t.turns)}catch{return null}if(0===n.length)return null;let a=n.find(e=>"user"===e.role),r=[...n].reverse().find(e=>"assistant"===e.role),s=e.name?.trim()||a?.content?.slice(0,50)||t("ask.widget.untitled");i=r?r.content.replace(/```[\s\S]*?```/g,"").replace(/`[^`]*`/g,"").replace(/#{1,6}\s+/g,"").replace(/\*\*([^*]+)\*\*/g,"$1").replace(/__([^_]+)__/g,"$1").replace(/\*([^*]+)\*/g,"$1").replace(/_([^_]+)_/g,"$1").replace(/\[([^\]]+)\]\([^)]+\)/g,"$1").replace(/^>\s+/gm,"").replace(/^[-*+]\s+/gm,"").replace(/^\d+\.\s+/gm,"").replace(/^-{3,}$/gm,"").replace(/\s+/g," ").trim().slice(0,80):a?`> ${a.content.slice(0,77)}`:"";let l=(0,p.aw)(new Date(e.savedAt).toISOString(),t);return{doc:e,title:s,preview:i,age:l}})(e,t)).filter(e=>null!==e).slice(0,3)),l(!0)},[t]);return((0,a.useEffect)(()=>{g()},[g]),(0,a.useEffect)(()=>{let e=()=>{"visible"===document.visibilityState&&g()};return document.addEventListener("visibilitychange",e),()=>document.removeEventListener("visibilitychange",e)},[g]),s)?(0,n.jsx)(c.rl,{title:t("ask.widget.title"),accentColor:o.w4.suites.lab,children:0===i.length?(0,n.jsxs)(y,{children:[(0,n.jsx)(x,{children:t("ask.widget.empty")}),(0,n.jsx)(c.$n,{variant:"ghost",icon:(0,n.jsx)(c.In,{name:"sparkle",size:13}),onClick:()=>{window.dispatchEvent(new CustomEvent("atlantis:open-palette",{detail:{scope:"ask"}}))},children:t("ask.widget.emptyCta")})]}):(0,n.jsx)(m,{children:i.map(({doc:e,title:t,preview:i,age:a})=>(0,n.jsxs)(u,{onClick:()=>(0,o.VJ)("ask",{session:String(e.id)}),title:t,children:[(0,n.jsx)(w,{children:t}),(0,n.jsx)(f,{children:a}),i&&(0,n.jsx)(h,{children:i})]},e.id))})}):null}}}]);