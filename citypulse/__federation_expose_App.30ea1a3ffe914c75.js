"use strict";(self.webpackChunk_atlantis_citypulse=self.webpackChunk_atlantis_citypulse||[]).push([["6362"],{3935(e,i,a){a.r(i),a.d(i,{default:()=>w});var n=a(5723),t=a(7991),r=a(6859),l=a.n(r),s=a(9874),o=a(3819),d=a(9522),c=a(1951),h=a(751),p=a(7912),x=a(5332),u=a(4439);let m=[{id:"dashboard",name:"Dashboard",icon:"layout-grid",children:[{id:"overview",name:"City Overview",icon:"map-pin"},{id:"weather",name:"Weather Timeline",icon:"thermometer"},{id:"air-quality",name:"Air Quality",icon:"wind"},{id:"compare",name:"Compare Cities",icon:"bar-chart-2"}]}],y=l().h2`
