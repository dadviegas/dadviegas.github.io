...
`;function O({topBarRight:e}){const[r,o]=(0,t.useState)(x.k[0].token),[s,b]=(0,t.useState)(!1),m=(0,t.useRef)(null);(0,t.useEffect)(()=>{const e=e=>{m.current&&!m.current.contains(e.target)&&b(!1)};return document.addEventListener("mousedown",e),()=>document.removeEventListener("mousedown",e)},[]);const{decoded:w,error:O}=(0,t.useMemo)(()=>function(e){const r=e.trim().split(".");if(3!==r.length)return{decoded:null,error:"JWT must have exactly 3 parts separated by dots."};try{return{decoded:{header:JSON.parse(f(r[0])),payload:JSON.parse(f(r[1])),signature:r[2],raw:{header:r[0],payload:r[1],signature:r[2]}},error:null}}catch(e){return{decoded:null,error:"Failed to decode: "+e.message}}}(r),[r]),P=w?.header.alg,I=w?.payload.exp,D=w?.payload.iat,N=(new TextEncoder).encode(r).length,q=(0,u.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:"8px"},children:[(0,u.jsxs)(W,{ref:m,children:[(0,u.jsxs)(L,{onClick:()=>b(e=>!e),children:["Examples ",(0,u.jsx)(l.A,{size:12})]}),s&&(0,u.jsx)(_,{children:x.k.map(e=>(0,u.jsx)(B,{onClick:()=>{o(e.token),b(!1)},children:e.label},e.label))})]}),e]});return(0,u.jsx)(n.PE,{title:"JWT Inspector",sidebar:null,topBarRight:q,children:(0,u.jsxs)(j,{children:[(0,u.jsx)($,{value:r,onChange:e=>o(e.target.value),placeholder:"Paste a JWT token here…",spellCheck:!1}),r.trim()&&(0,u.jsxs)(k,{children:[O?(0,u.jsxs)(v,{ok:!1,children:[(0,u.jsx)(i.A,{size:13})," Invalid JWT"]}):(0,u.jsxs)(v,{ok:!0,children:[(0,u.jsx)(a.A,{size:13})," Valid structure"]}),w&&(0,u.jsxs)(u.Fragment,{children:[P&&(0,u.jsxs)(z,{children:["alg: ",P]}),D&&(0,u.jsxs)(z,{children:[(0,u.jsx)(d.A,{size:11})," ",g(D)]}),I&&(()=>{const{text:e,expired:r}=h(I);return(0,u.jsxs)(E,{expired:r,children:[r?(0,u.jsx)(c.A,{size:11}):(0,u.jsx)(p.A,{size:11}),e]})})(),(0,u.jsxs)(z,{children:[N," bytes"]})]})]}),O&&r.trim()&&(0,u.jsxs)(C,{children:[(0,u.jsx)(i.A,{size:15})," ",O]}),w?(0,u.jsxs)(T,{children:[(0,u.jsx)(y,{data:w.header,title:"Header"}),(0,u.jsx)(y,{data:w.payload,title:"Payload"}),(0,u.jsxs)(M,{children:[(0,u.jsx)(A,{children:"Signature"}),(0,u.jsxs)(S,{children:[(0,u.jsx)(R,{children:w.raw.signature}),(0,u.jsx)(F,{children:"Signature verification requires the secret key or public key and must be done server-side. This tool only decodes the token structure."})]})]})]}):r.trim()?null:(0,u.jsxs)(J,{children:[(0,u.jsx)(p.A,{size:40,strokeWidth:1}),"Paste a JWT token above to inspect it"]})]})})}}}]);
//# sourceMappingURL=36.5aad71feb2b9b1dd7380.js.map