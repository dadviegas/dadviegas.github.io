"use strict";(self.webpackChunk_atlantis_pad=self.webpackChunk_atlantis_pad||[]).push([["6362"],{73935(e,r,t){t.r(r),t.d(r,{default:()=>v});var o=t(65723),n=t(37991),a=t(36859),l=t.n(a),i=t(71344),s=t(76480),c=t(60246),d=t(8581),u=t(53804),p=t(2099),m=t(65320),g=t(7279),w=t(56666);function x(){let e=window.location.hash.toLowerCase();return e.startsWith("#/mermaidpad")||e.startsWith("#/mermaid")?"mermaid":"markdown"}let f=l().button`
  display: flex;
  align-items: center;
  gap: 6px;
  padding: 5px 12px;
