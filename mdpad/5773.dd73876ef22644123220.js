...
`;function x({onSave:a,onCancel:n}){const[e,o]=(0,i.useState)(""),t=(0,i.useRef)(null);return(0,i.useEffect)(()=>{t.current?.focus()},[]),(0,r.jsx)(g,{onClick:n,children:(0,r.jsxs)(p,{onClick:a=>a.stopPropagation(),children:[(0,r.jsx)(f,{children:"Save document"}),(0,r.jsx)(b,{ref:t,value:e,onChange:a=>o(a.target.value),onKeyDown:o=>{"Enter"===o.key&&e.trim()&&a(e.trim()),"Escape"===o.key&&n()},placeholder:"Give this version a name…",maxLength:80}),(0,r.jsxs)(y,{children:[(0,r.jsx)(h,{onClick:n,children:"Cancel"}),(0,r.jsx)(h,{primary:!0,disabled:!e.trim(),onClick:()=>a(e.trim()),children:"Save"})]})]})})}var z=e(18006),w=e(70679),$=e(54872);const A=t.default.div`
  position: relative;
`,v=t.default.button`
  display: flex;
  align-items: center;
...
`;function R({appId:a,onLoad:n}){const[e,o]=(0,i.useState)(!1),[t,l]=(0,i.useState)([]),s=(0,i.useRef)(null),d=(0,i.useCallback)(()=>{(async function(a){const n=await m();return new Promise((e,o)=>{const i=n.transaction(c,"readonly").objectStore(c).index("appId").getAll(a);i.onsuccess=()=>e(i.result.reverse()),i.onerror=()=>o(i.error)})})(a).then(l).catch(()=>{})},[a]);(0,i.useEffect)(()=>{if(!e)return;d();const a=a=>{s.current&&!s.current.contains(a.target)&&o(!1)};return document.addEventListener("mousedown",a),()=>document.removeEventListener("mousedown",a)},[e,d]);return(0,r.jsxs)(A,{ref:s,children:[(0,r.jsxs)(v,{onClick:()=>o(a=>!a),children:[(0,r.jsx)(z.A,{size:14}),"Saved",(0,r.jsx)(w.A,{size:13,style:{marginLeft:2}})]}),(0,r.jsxs)(k,{open:e,children:[(0,r.jsx)(S,{children:"Saved versions"}),(0,r.jsx)(T,{children:0===t.length?(0,r.jsx)(M,{children:"No saved documents yet."}):t.map(a=>{return(0,r.jsxs)(B,{children:[(0,r.jsxs)(C,{onClick:()=>{n(a.content),o(!1)},children:[(0,r.jsx)(j,{children:a.name}),(0,r.jsx)(E,{children:(e=a.savedAt,new Intl.DateTimeFormat(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}).format(new Date(e)))})]}),(0,r.jsx)(P,{onClick:n=>(async(a,n)=>{a.stopPropagation(),await async function(a){const n=await m();return new Promise((e,o)=>{const i=n.transaction(c,"readwrite").objectStore(c).delete(a);i.onsuccess=()=>e(),i.onerror=()=>o(i.error)})}(n),l(a=>a.filter(a=>a.id!==n))})(n,a.id),title:"Delete",children:(0,r.jsx)($.A,{size:13})})]},a.id);var e})})]})]})}},217(a,n,e){e.d(n,{w:()=>o});const o={colors:{sidebarBg:"#0f1117",sidebarText:"#c9d1d9",sidebarTextMuted:"#6e7681",sidebarActive:"#58a6ff",sidebarActiveBg:"#161b22",sidebarHover:"#21262d",sidebarBorder:"#21262d",mainBg:"#0d1117",mainText:"#e6edf3",mainTextMuted:"#8b949e",accent:"#58a6ff",accentHover:"#79c0ff",codeBg:"#161b22",codeBorder:"#30363d",border:"#30363d",surface:"#161b22"},spacing:{xs:"4px",sm:"8px",md:"16px",lg:"24px",xl:"32px",xxl:"48px"},sidebar:{width:"260px"},topbar:{height:"56px"},typography:{fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif",fontFamilyMono:"'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, monospace",fontSizeSm:"13px",fontSizeBase:"14px",fontSizeMd:"16px",fontSizeLg:"20px",fontSizeXl:"24px",lineHeightBase:"1.6"},borderRadius:{sm:"4px",md:"6px",lg:"12px"},breakpoints:{md:"768px",lg:"1024px",xl:"1280px"}}},78967(a,n,e){e.d(n,{M:()=>f}),e(27359);var o=e(53233),i=e(15496),t=e(51530),r=e(24079),l=e(65723);const s=o.default.div`
  display: flex;
  flex-direction: column;
