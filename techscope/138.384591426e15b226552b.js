...
`;function H({iconKey:e,size:a=16}){if(e&&!(e in B.t))return(0,r.jsx)("span",{style:{fontSize:a,lineHeight:1,display:"flex",alignItems:"center"},children:e});const o=e?B.t[e]??T.A:T.A;return(0,r.jsx)(o,{size:a,strokeWidth:1.75})}function K({entry:e,activeId:a,onSelect:o}){const[t,i]=(0,n.useState)(e.defaultOpen??!0),{collapsed:l,openFlyout:s,scheduleFlyoutClose:c,cancelFlyoutClose:p}=(0,d.c)();return e.children&&e.children.length>0?(0,r.jsxs)(D,{children:[(0,r.jsxs)(E,{collapsed:l,onClick:()=>{l||i(e=>!e)},onMouseEnter:l?a=>{const t=a.currentTarget.getBoundingClientRect();s(e,t.top,o)}:void 0,onMouseLeave:l?c:void 0,children:[(0,r.jsxs)(I,{collapsed:l,children:[(0,r.jsx)(H,{iconKey:e.icon,size:16}),(0,r.jsx)(L,{collapsed:l,children:e.name})]}),(0,r.jsx)(_,{open:t,collapsed:l,children:(0,r.jsx)(P.A,{size:13})})]}),(0,r.jsx)(F,{open:t&&!l,children:(0,r.jsx)(R,{children:(0,r.jsx)(C,{children:e.children.map(e=>(0,r.jsx)(K,{entry:e,activeId:a,onSelect:o},e.id))})})})]}):(0,r.jsxs)(N,{active:a===e.id,collapsed:l,onClick:()=>o(e),onMouseEnter:l?a=>{const t=a.currentTarget.getBoundingClientRect();s({id:e.id,name:e.name,icon:e.icon,file:e.file,children:[e]},t.top,o)}:void 0,onMouseLeave:l?c:void 0,children:[(0,r.jsx)(H,{iconKey:e.icon,size:15}),(0,r.jsx)(L,{collapsed:l,children:e.name})]})}function G({entries:e,activeId:a,onSelect:o}){return(0,r.jsx)("div",{children:e.map(e=>(0,r.jsx)(K,{entry:e,activeId:a,onSelect:o},e.id))})}const Y=l.keyframes`
...
`,o(4914);var U=o(1920),V=o(8607),O=o(8479);i.default.button`
  display: flex;
  align-items: center;
  justify-content: center;
  width: 32px;
...
`,new Set([10751]),new Set([27]);const ee=i.default.div`
...
`;i.default.div`
  ...
  background: ${t.w4.colors.mainBg};
  font-family: ${t.w4.typography.fontFamily};
  animation: ${ne} 0.4s ease 0.15s both;
`,i.default.div`
  position: relative;
  width: 56px;
  height: 56px;
...
`,i.default.div`
  position: absolute;
  inset: 0;
  animation: ${ie} 1.4s cubic-bezier(0.4, 0, 0.2, 1) infinite;
...
`,D=i.default.div`
  ...
  font-size: ${t.w4.typography.fontSizeSm};
  text-align: center;
`;function E({t:e}){const a=`https://api.github.com/search/repositories?q=created:>${(0,l.VF)(7)}&sort=stars&order=desc&per_page=8`,{data:o,loading:t,lastUpdated:n,refresh:i}=(0,l.st)(a);return(0,m.jsxs)("div",{children:[(0,m.jsx)(v,{title:e("nav.livePulse"),color:j,lastUpdated:n,loading:t,onRefresh:i,t:e}),o?.items?.length?(0,m.jsx)(A,{children:o.items.map(a=>(0,m.jsxs)(S,{href:a.html_url,target:"_blank",rel:"noopener noreferrer",children:[(0,m.jsx)(M,{title:a.full_name,children:a.full_name}),(0,m.jsx)(T,{children:a.description??e("noDescription")}),(0,m.jsxs)(P,{children:[a.language&&(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(F,{lang:a.language}),(0,m.jsx)(R,{children:a.language})]}),(0,m.jsx)(C,{}),(0,m.jsxs)(B,{children:[(0,m.jsx)(r.A,{size:12}),(0,l.Bz)(a.stargazers_count)]})]})]},a.id))}):(0,m.jsx)(D,{children:e(t?"livePulse.loading":"noData")})]})}var I=o(5046);const L="#bc8cff",_={TypeScript:"#3178c6",JavaScript:"#f1e05a",Python:"#3572A5",Go:"#00ADD8",Rust:"#dea584",Java:"#b07219","C++":"#f34b7d","C#":"#178600",Ruby:"#701516",Swift:"#F05138",Kotlin:"#A97BFF",Shell:"#89e051",HTML:"#e34c26",CSS:"#563d7c",Dart:"#00B4AB",Zig:"#ec915c",Nix:"#7e7eff",Lua:"#000080"},N=i.default.div`
  display: grid;
...
`,H=i.default.a`
  ...
  gap: 10px;
  padding: ${t.w4.spacing.md};
  background: linear-gradient(168deg, ${L}10 0%, ${t.w4.colors.surface} 44%, ${t.w4.colors.surface} 100%);
  border: 1px solid ${L}2d;
  border-radius: ${t.w4.borderRadius.md};
  text-decoration: none;
  transition: border-color 0.25s, background 0.25s, transform 0.25s, box-shadow 0.25s;
  position: relative;
  ...
  &:hover {
    border-color: ${L}66;
    background: linear-gradient(168deg, ${L}1c 0%, ${t.w4.colors.surfaceRaised} 44%, ${t.w4.colors.surfaceRaised} 100%);
    box-shadow: 0 0 18px ${L}24, 0 10px 26px rgba(0, 0, 0, 0.28);
    transform: translateY(-2px);
  }
...
`,Z=i.default.span`
  ...
  height: 10px;
  border-radius: 50%;
  background: ${({lang:e})=>_[e]??t.w4.colors.mainTextMuted};
  flex-shrink: 0;
`,X=i.default.span`
  font-size: ${t.w4.typography.fontSizeSm};
  color: ${t.w4.colors.mainTextMuted};
...
`,ee=i.default.div`
  ...
  font-size: ${t.w4.typography.fontSizeSm};
  text-align: center;
`;function ae({t:e}){const a=`https://api.github.com/search/repositories?q=created:>${(0,l.VF)(30)}+stars:50..500+fork:false&sort=stars&order=desc&per_page=8`,{data:o,loading:t,lastUpdated:n,refresh:i}=(0,l.st)(a);return(0,m.jsxs)("div",{children:[(0,m.jsx)(v,{title:e("nav.experimentZone"),color:L,lastUpdated:n,loading:t,onRefresh:i,t:e}),o?.items?.length?(0,m.jsx)(N,{children:o.items.map(a=>(0,m.jsxs)(H,{href:a.html_url,target:"_blank",rel:"noopener noreferrer",children:[(0,m.jsxs)(K,{children:[(0,m.jsx)(G,{title:a.full_name,children:a.full_name}),(0,m.jsx)(Y,{children:(0,p.aw)(a.created_at,e)})]}),(0,m.jsx)(U,{children:a.description??e("noDescription")}),a.topics.length>0&&(0,m.jsx)(V,{children:a.topics.slice(0,4).map(e=>(0,m.jsx)(O,{children:e},e))}),(0,m.jsxs)(q,{children:[a.language&&(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(Z,{lang:a.language}),(0,m.jsx)(X,{children:a.language})]}),(0,m.jsx)(Q,{}),(0,m.jsxs)(J,{children:[(0,m.jsx)(r.A,{size:12}),(0,l.Bz)(a.stargazers_count)]}),(0,m.jsxs)(W,{children:[(0,m.jsx)(I.A,{size:12}),(0,l.Bz)(a.forks_count)]})]})]},a.id))}):(0,m.jsx)(ee,{children:e(t?"experiment.loading":"noData")})]})}var oe=o(4368),te=o(2820);const ne="#d29922",ie=i.default.ol`
  list-style: none;
  display: flex;
  flex-direction: column;
  gap: 2px;
...
`,Re=i.default.button`
  ...
  font-size: 12px;
  border-radius: 20px;
  border: 1px solid ${({active:e})=>e?Pe:t.w4.colors.border};
  background: ${({active:e})=>e?"rgba(255,99,20,0.15)":"transparent"};
  color: ${({active:e})=>e?Pe:t.w4.colors.mainTextMuted};
  cursor: pointer;
...
`,Ue=i.default.div`
  ...
  font-size: ${t.w4.typography.fontSizeSm};
  text-align: center;
`;function Ve(){const[e,a]=(0,n.useState)(Be[0]),o=Math.floor((Date.now()-2592e5)/1e3),t=`https://hn.algolia.com/api/v1/search?query=${encodeURIComponent(e.query)}&tags=story&hitsPerPage=10&numericFilters=created_at_i>${o}`,{data:i,loading:r,lastUpdated:s,refresh:d}=(0,l.st)(t),c=i?.hits??[];return(0,m.jsxs)("div",{children:[(0,m.jsx)(v,{title:"Community Feed",color:Pe,description:"Top stories from Hacker News in the last 72 hours, filtered by dev topic.",lastUpdated:s,loading:r,onRefresh:d}),(0,m.jsx)(Fe,{children:Be.map(o=>(0,m.jsx)(Re,{active:e.id===o.id,onClick:()=>a(o),children:o.label},o.id))}),c.length?(0,m.jsx)(Ce,{children:c.map(e=>{const a=e.url??`https://news.ycombinator.com/item?id=${e.objectID}`;return(0,m.jsxs)(De,{href:a,target:"_blank",rel:"noopener noreferrer",children:[(0,m.jsx)(Ee,{children:(0,m.jsx)(he.A,{size:13})}),(0,m.jsxs)(Ie,{children:[(0,m.jsx)(Le,{children:e.title}),(0,m.jsxs)(_e,{children:[(0,m.jsxs)(Ne,{children:[(0,m.jsx)(oe.A,{size:11}),(0,l.aT)(e.points??0)," pts"]}),(0,m.jsxs)(He,{children:[(0,m.jsx)(te.A,{size:11}),e.num_comments??0]}),(0,m.jsxs)(Ke,{children:["by ",e.author]}),(0,m.jsx)(Ge,{children:(0,l.FB)(e.url)}),(0,m.jsx)(Ye,{children:(0,l.fF)(e.created_at)})]})]})]},e.objectID)})}):(0,m.jsx)(Ue,{children:r?"Loading stories...":"No stories in the last 72h"})]})}var Oe=o(6673);const qe="#f7c948",We=[{id:"react",label:"React",query:"react component"},{id:"cli",label:"CLI",query:"cli tool command"},{id:"typescript",label:"TypeScript",query:"typescript types"},{id:"testing",label:"Testing",query:"test jest vitest"},{id:"build",label:"Build",query:"bundler build vite webpack"}],Je=i.default.div`
  display: flex;
  gap: 6px;
  margin-bottom: ${t.w4.spacing.lg};
  flex-wrap: wrap;
`,Ze=i.default.button`
  ...
  font-size: 12px;
  border-radius: 20px;
  border: 1px solid ${({active:e})=>e?qe:t.w4.colors.border};
  background: ${({active:e})=>e?"rgba(247,201,72,0.15)":"transparent"};
  color: ${({active:e})=>e?qe:t.w4.colors.mainTextMuted};
  cursor: pointer;
  transition: all 0.15s;
  font-family: ${t.w4.typography.fontFamilyMono};
...
`,Qe=i.default.a`
  ...
  gap: 10px;
  padding: ${t.w4.spacing.md};
  background: linear-gradient(168deg, ${qe}0c 0%, ${t.w4.colors.surface} 44%, ${t.w4.colors.surface} 100%);
  border: 1px solid ${qe}2e;
  border-radius: ${t.w4.borderRadius.md};
  text-decoration: none;
  ...
  &::before {
    ...
    right: 0;
    height: 2px;
    background: linear-gradient(90deg, transparent, ${qe}, transparent);
    opacity: 0.3;
    transition: opacity 0.2s;
  }
  ...
  &:hover {
    border-color: ${qe}66;
    background: linear-gradient(168deg, ${qe}18 0%, ${t.w4.colors.surfaceRaised} 44%, ${t.w4.colors.surfaceRaised} 100%);
    box-shadow: 0 0 18px ${qe}20, 0 8px 24px rgba(0, 0, 0, 0.25);
    transform: translateY(-2px);
  }
...
`,Na=i.default.div`
  ...
  font-size: ${t.w4.typography.fontSizeSm};
  text-align: center;
`;function Ha(){const[e,a]=(0,n.useState)(Aa[0].id),o=`https://dev.to/api/articles?tag=${e}&top=7&per_page=8`,{data:t,loading:i,lastUpdated:r,refresh:s}=(0,l.st)(o),d=t??[];return(0,m.jsxs)("div",{children:[(0,m.jsx)(v,{title:"Tech Articles",color:ka,description:"Popular articles from Dev.to across frontend, AI, and systems topics.",lastUpdated:r,loading:i,onRefresh:s}),(0,m.jsx)(Ma,{children:Aa.map(o=>(0,m.jsxs)(Ta,{active:e===o.id,onClick:()=>a(o.id),children:["#",o.label]},o.id))}),d.length?(0,m.jsx)(Sa,{children:d.map(e=>(0,m.jsxs)(Pa,{href:e.url,target:"_blank",rel:"noopener noreferrer",children:[(0,m.jsx)(Ba,{children:e.title}),e.description&&(0,m.jsx)(Fa,{children:e.description}),e.tag_list.length>0&&(0,m.jsx)(Ra,{children:e.tag_list.slice(0,3).map(e=>(0,m.jsxs)(Ca,{children:["#",e]},e))}),(0,m.jsxs)(Da,{children:[(0,m.jsxs)(Ea,{children:[(0,m.jsx)($a.A,{size:11}),(0,l.aT)(e.public_reactions_count)]}),(0,m.jsxs)(Ia,{children:[(0,m.jsx)(te.A,{size:11}),e.comments_count]}),(0,m.jsxs)(La,{children:[(0,m.jsx)(va.A,{size:10}),e.user.name]}),(0,m.jsxs)(_a,{children:[(0,m.jsx)(ja.A,{size:11}),e.reading_time_minutes,"m"]})]})]},e.id))}):(0,m.jsx)(Na,{children:i?"Loading articles...":"No articles found"})]})}var Ka=o(140);const Ga="#f48024",Ya=[{id:"",label:"All"},{id:"javascript",label:"JS"},{id:"typescript",label:"TS"},{id:"python",label:"Python"},{id:"react",label:"React"}],Ua=i.default.div`
  display: flex;
  gap: 6px;
  margin-bottom: ${t.w4.spacing.lg};
  flex-wrap: wrap;
`,Va=i.default.button`
  ...
  font-size: 12px;
  border-radius: 20px;
  border: 1px solid ${({active:e})=>e?Ga:t.w4.colors.border};
  background: ${({active:e})=>e?"rgba(244,128,36,0.15)":"transparent"};
  color: ${({active:e})=>e?Ga:t.w4.colors.mainTextMuted};
  cursor: pointer;
  transition: all 0.15s;
  font-family: ${t.w4.typography.fontFamilyMono};
  letter-spacing: 0.01em;
