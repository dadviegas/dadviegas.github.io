"use strict";(self.webpackChunk_atlantis_finance=self.webpackChunk_atlantis_finance||[]).push([["875"],{8501(e,t,o){o.d(t,{J:()=>P});var n=o(5723),a=o(7991),r=o(6859),i=o.n(r),s=o(2799),l=o(4764),c=o(8170),d=o(5030),p=o(1496),f=o(2385),g=o(948);let u="#fb923c",m="#f85149",h="#facc15",x=(0,s.keyframes)`
...
`,w=i().div`
  ...
  color: ${({tone:e})=>"overdue"===e?m:"upcoming"===e?h:l.w4.colors.mainTextMuted};
...
`,H=i().button`
  ...
  &:focus-visible { outline: 2px solid ${l.w4.colors.accent}; outline-offset: 2px; }
`;function N({data:e,onSave:t,onCancel:o,t:r,locale:i}){let[s,l]=(0,a.useState)(""),[c,d]=(0,a.useState)(""),[p,g]=(0,a.useState)(""),[u,m]=(0,a.useState)(""),[h,x]=(0,a.useState)(""),[b,y]=(0,a.useState)("");async function w(){let o=parseFloat(c);if(!s.trim()||isNaN(o)||o<=0||!p)return;let n=(0,f.addBill)(e,{payee:s.trim(),amount:o,dueDate:p,categoryId:u||void 0,memberId:h||void 0,notes:b.trim()||void 0});(0,f.pushUndo)({id:`bill-add-${Date.now()}`,snapshot:e,labelKey:"finance.undo.label.added",ts:Date.now()}),await t(n)}let $=s.trim().length>0&&parseFloat(c)>0&&p.length>0;return(0,n.jsxs)(F,{children:[(0,n.jsxs)(A,{children:[(0,n.jsx)(D,{type:"text",placeholder:r("finance.bills.payee"),value:s,onChange:e=>l(e.target.value),autoFocus:!0,"aria-label":r("finance.bills.payee")}),(0,n.jsx)(D,{type:"number",min:"0.01",step:"0.01",placeholder:r("finance.bills.amount"),value:c,onChange:e=>d(e.target.value),"aria-label":r("finance.bills.amount"),style:{maxWidth:120}})]}),(0,n.jsxs)(A,{children:[(0,n.jsx)(D,{type:"date",placeholder:r("finance.bills.dueDate"),value:p,onChange:e=>g(e.target.value),"aria-label":r("finance.bills.dueDate"),min:new Date().toISOString().slice(0,10)}),(0,n.jsxs)(E,{value:u,onChange:e=>m(e.target.value),"aria-label":r("finance.bills.category"),children:[(0,n.jsx)("option",{value:"",children:r("finance.bills.category")}),f.DEFAULT_CATEGORIES.map(e=>(0,n.jsx)("option",{value:e.id,children:(0,f.categoryLabel)(e,i)},e.id))]})]}),e.familyMembers.length>0&&(0,n.jsxs)(A,{children:[(0,n.jsxs)(E,{value:h,onChange:e=>x(e.target.value),"aria-label":r("finance.bills.member"),children:[(0,n.jsx)("option",{value:"",children:r("finance.bills.member")}),e.familyMembers.map(e=>(0,n.jsx)("option",{value:e.id,children:e.name},e.id))]}),(0,n.jsx)(D,{type:"text",placeholder:r("finance.bills.notes"),value:b,onChange:e=>y(e.target.value),"aria-label":r("finance.bills.notes")})]}),(0,n.jsxs)(B,{children:[(0,n.jsx)(I,{type:"button",onClick:o,children:r("finance.bills.cancel")}),(0,n.jsx)(I,{type:"button",primary:!0,disabled:!$,onClick:()=>{w()},children:r("finance.bills.save")})]})]})}function L({bill:e,data:t,onSave:o,t:a}){let r,i=(0,f.daysUntilDue)(e);async function s(){let n=(0,f.markBillPaid)(t,e.id);(0,f.pushUndo)({id:`bill-paid-${Date.now()}`,snapshot:t,labelKey:"finance.undo.label.edited",ts:Date.now()}),await o(n)}async function l(){let n=(0,f.deleteBill)(t,e.id);(0,f.pushUndo)({id:`bill-del-${Date.now()}`,snapshot:t,labelKey:"finance.undo.label.deleted",ts:Date.now()}),await o(n)}return(0,n.jsxs)($,{children:[(0,n.jsxs)(v,{children:[(0,n.jsx)(k,{children:e.payee}),(0,n.jsxs)(M,{children:[(0,n.jsx)(d.Ex,{tone:"neutral",style:i<0?{color:m,borderColor:`${m}44`}:0===i?{color:h,borderColor:`${h}44`}:i<=3?{color:u,borderColor:`${u}44`}:{},children:(r=(0,f.daysUntilDue)(e))<0?a("finance.bills.overdueBy",{n:Math.abs(r)}):0===r?a("finance.bills.dueToday"):1===r?a("finance.bills.due1"):3===r?a("finance.bills.due3"):e.dueDate}),e.paid&&(0,n.jsx)(d.Ex,{tone:"accent",children:a("finance.bills.paid")})]})]}),(0,n.jsxs)(z,{children:[(0,n.jsxs)(j,{children:["€",e.amount.toFixed(2)]}),!e.paid&&(0,n.jsx)(T,{type:"button",onClick:()=>{s()},"aria-label":`${a("finance.bills.markPaid")} — ${e.payee}`,children:a("finance.bills.markPaid")}),(0,n.jsx)(S,{type:"button",className:"bill-delete",title:a("finance.bills.delete"),"aria-label":`${a("finance.bills.delete")} — ${e.payee}`,onClick:()=>{l()},children:(0,n.jsx)(d.In,{name:"trash",size:13})})]})]})}function P(){let[e]=(0,c.Ym)(),t=(0,a.useMemo)(()=>(0,c.Nx)(e,g.A),[e]),{data:o,loaded:r,save:i}=(0,f.useFinance)(),[s,l]=(0,a.useState)(!1),[u,h]=(0,a.useState)(!1);if(!r||null===o)return(0,n.jsxs)(b,{children:[(0,n.jsx)(d.YZ,{children:t("finance.bills.title")}),(0,n.jsx)(p.YG,{mode:"loading",label:t("loading")})]});let x=o.bills??[],$=new Date,v=(0,f.overdueBills)(x,$),k=(0,f.upcomingBills)(x,$),M=x.filter(e=>!e.paid).sort((e,t)=>e.dueDate.localeCompare(t.dueDate)),j=x.filter(e=>e.paid).sort((e,t)=>(t.paidAt??0)-(e.paidAt??0)),z=M.filter(e=>!v.find(t=>t.id===e.id)&&!k.find(t=>t.id===e.id));async function T(e){await i(e)}let S=x.length>0;return(0,n.jsxs)(b,{children:[(0,n.jsxs)(y,{children:[(0,n.jsx)(d.YZ,{children:t("finance.bills.title")}),v.length>0&&(0,n.jsx)(d.Ex,{tone:"neutral",style:{color:m,borderColor:`${m}44`},children:v.length})]}),S||s?(0,n.jsxs)(n.Fragment,{children:[v.length>0&&(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(w,{tone:"overdue",children:t("finance.bills.overdue")}),v.map(e=>(0,n.jsx)(L,{bill:e,data:o,onSave:T,t:t},e.id))]}),k.length>0&&(0,n.jsxs)(n.Fragment,{children:[v.length>0&&(0,n.jsx)(C,{}),(0,n.jsx)(w,{tone:"upcoming",children:t("finance.bills.upcoming")}),k.map(e=>(0,n.jsx)(L,{bill:e,data:o,onSave:T,t:t},e.id))]}),(z.length>0||j.length>0)&&(0,n.jsxs)(n.Fragment,{children:[(v.length>0||k.length>0)&&(0,n.jsx)(C,{}),(0,n.jsxs)(R,{type:"button",onClick:()=>h(e=>!e),"aria-expanded":u,children:[u?"▾":"▸"," ",t("finance.bills.all")," (",z.length+j.length,")"]}),u&&(0,n.jsxs)(n.Fragment,{children:[z.map(e=>(0,n.jsx)(L,{bill:e,data:o,onSave:T,t:t},e.id)),j.map(e=>(0,n.jsx)(L,{bill:e,data:o,onSave:T,t:t},e.id))]})]})]}):(0,n.jsx)(p.YG,{mode:"empty",label:t("finance.bills.empty")}),s?(0,n.jsx)(N,{data:o,onSave:async e=>{await T(e),l(!1)},onCancel:()=>l(!1),t:t,locale:e}):(0,n.jsxs)(H,{type:"button",onClick:()=>l(!0),children:[(0,n.jsx)(d.In,{name:"plus",size:14,"aria-hidden":!0}),t("finance.bills.add")]})]})}},2167(e,t,o){o.d(t,{X:()=>h});var n=o(5723),a=o(7991),r=o(6859),i=o.n(r),s=o(2799),l=o(4764);let c=(0,s.keyframes)`
...
`,m=i().div`
  ...
  min-height: 0;
  overflow-y: auto;
`;function h({open:e,onClose:t,children:o,maxWidth:r=480,ariaLabel:i}){let s=(0,a.useRef)(null);(0,a.useEffect)(()=>{if(!e)return;let o=e=>{"Escape"===e.key&&t()};return window.addEventListener("keydown",o),()=>window.removeEventListener("keydown",o)},[e,t]),(0,a.useEffect)(()=>{if(!e||!s.current)return;let t=s.current.querySelector('button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])');t?.focus()},[e]);let l=(0,a.useRef)(null),c=(0,a.useCallback)(e=>{l.current={y:e.touches[0].clientY}},[]),d=(0,a.useCallback)(e=>{if(!l.current||!s.current)return;let o=e.changedTouches[0].clientY-l.current.y;l.current=null,o<=0||o/s.current.getBoundingClientRect().height>.3&&t()},[t]),x=(0,a.useRef)(null),b=(0,a.useCallback)(e=>{x.current={y:e.clientY}},[]),y=(0,a.useCallback)(e=>{if(!x.current||!s.current)return;let o=e.clientY-x.current.y;x.current=null,o<=0||o/s.current.getBoundingClientRect().height>.3&&t()},[t]);return e?(0,n.jsx)(p,{onClick:t,role:"dialog","aria-modal":"true","aria-label":i,children:(0,n.jsxs)(f,{ref:s,maxWidth:r,onClick:e=>e.stopPropagation(),children:[(0,n.jsx)(g,{onTouchStart:c,onTouchEnd:d,onPointerDown:b,onPointerUp:y,"aria-hidden":"true",children:(0,n.jsx)(u,{})}),(0,n.jsx)(m,{children:o})]})}):null}},6376(e,t,o){o.d(t,{S:()=>S});var n=o(5723),a=o(7991),r=o(6859),i=o.n(r),s=o(2799),l=o(4764),c=o(5030),d=o(2385);let p=(0,s.keyframes)`
...
`,T=i().div`
  ...
  color: ${l.w4.colors.mainText};
  line-height: 1.5;
`;function S({selectionCount:e,visibleIds:t,selectedIds:o,categories:r,locale:i,t:s,onCancel:p,onSelectAll:C,onCategorise:R,onDelete:F,onMarkReimbursed:A}){let[D,E]=(0,a.useState)(!1),[B,I]=(0,a.useState)(""),[H,N]=(0,a.useState)(!1),[L,P]=(0,a.useState)(!1),[W,O]=(0,a.useState)(!1),Y=(0,a.useRef)(null);(0,a.useEffect)(()=>{D||I("")},[D]),(0,a.useEffect)(()=>{let e=e=>{if("Escape"===e.key){if(D)return void E(!1);if(H)return void N(!1);L&&P(!1)}};return window.addEventListener("keydown",e),()=>window.removeEventListener("keydown",e)},[D,H,L]);let K=(0,a.useCallback)(()=>{B&&(R(B),E(!1))},[B,R]),V=(0,a.useCallback)(()=>{F(),N(!1)},[F]),G=(0,a.useCallback)(()=>{A(),P(!1)},[A]),U=t.length>0&&t.every(e=>o.has(e));return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(f,{role:"toolbar","aria-label":s("finance.bulk.barLabel"),children:(0,n.jsxs)(g,{children:[(0,n.jsx)(u,{children:s("finance.bulk.selected",{n:e})}),(0,n.jsx)(c.$n,{variant:"ghost",style:{height:36,fontSize:12},onClick:U?p:C,children:s(U?"finance.bulk.deselectAll":"finance.bulk.selectAll")}),(0,n.jsx)(m,{}),(0,n.jsx)(c.$n,{variant:"ghost",style:{height:36,fontSize:12},disabled:0===e,onClick:()=>E(!0),children:s("finance.bulk.categorise")}),(0,n.jsx)(c.$n,{variant:"ghost",style:{height:36,fontSize:12},disabled:0===e,onClick:()=>P(!0),children:s("finance.bulk.reimburse")}),(0,n.jsxs)(h,{onMouseEnter:()=>O(!0),onMouseLeave:()=>O(!1),onFocus:()=>O(!0),onBlur:()=>O(!1),children:[(0,n.jsx)("button",{ref:Y,type:"button",disabled:!0,style:{height:36,padding:"0 12px",background:"transparent",border:`1px solid ${l.w4.colors.border}`,borderRadius:l.w4.borderRadius.md,color:l.w4.colors.mainTextMuted,fontSize:12,fontFamily:l.w4.typography.fontFamily,cursor:"not-allowed",opacity:.45},"aria-label":s("finance.bulk.tagComingSoon"),children:s("finance.bulk.tag")}),W&&(0,n.jsx)(x,{role:"tooltip",children:s("finance.bulk.tagComingSoon")})]}),(0,n.jsx)(c.$n,{variant:"danger",style:{height:36,fontSize:12},disabled:0===e,onClick:()=>N(!0),children:s("finance.bulk.delete")}),(0,n.jsx)(c.$n,{variant:"ghost",style:{height:36,fontSize:12},onClick:p,children:s("finance.bulk.cancel")})]})}),D&&(0,n.jsx)(b,{onClick:()=>E(!1),children:(0,n.jsxs)(y,{onClick:e=>e.stopPropagation(),children:[(0,n.jsx)(w,{children:s("finance.bulk.categoriseTitle")}),(0,n.jsx)($,{children:r.map(e=>(0,n.jsxs)(v,{type:"button",selected:B===e.id,catColor:e.color,onClick:()=>I(e.id),children:[(0,n.jsx)(k,{"aria-hidden":!0,children:(0,c.n6)(e.icon)?(0,n.jsx)(c.In,{name:e.icon,size:16,"aria-hidden":!0}):e.icon}),(0,n.jsx)(M,{children:(0,d.categoryLabel)(e,i)})]},e.id))}),(0,n.jsxs)(j,{children:[(0,n.jsx)(c.$n,{variant:"ghost",onClick:()=>E(!1),style:{height:36},children:s("finance.member.cancel")}),(0,n.jsx)(c.$n,{variant:"primary",disabled:!B,onClick:K,style:{height:36},children:s("finance.bulk.applyCategory")})]})]})}),H&&(0,n.jsx)(b,{onClick:()=>N(!1),children:(0,n.jsxs)(z,{onClick:e=>e.stopPropagation(),children:[(0,n.jsx)(w,{children:s("finance.bulk.deleteTitle")}),(0,n.jsx)(T,{children:s("finance.bulk.deleteConfirm",{n:e})}),(0,n.jsxs)(j,{children:[(0,n.jsx)(c.$n,{variant:"ghost",onClick:()=>N(!1),style:{height:36},children:s("finance.member.cancel")}),(0,n.jsx)(c.$n,{variant:"danger",onClick:V,style:{height:36},children:s("finance.bulk.deleteConfirmBtn")})]})]})}),L&&(0,n.jsx)(b,{onClick:()=>P(!1),children:(0,n.jsxs)(z,{onClick:e=>e.stopPropagation(),children:[(0,n.jsx)(w,{children:s("finance.bulk.reimburseTitle")}),(0,n.jsx)(T,{children:s("finance.bulk.reimburseConfirm",{n:e})}),(0,n.jsxs)(j,{children:[(0,n.jsx)(c.$n,{variant:"ghost",onClick:()=>P(!1),style:{height:36},children:s("finance.member.cancel")}),(0,n.jsx)(c.$n,{variant:"primary",onClick:G,style:{height:36},children:s("finance.bulk.reimburseConfirmBtn")})]})]})})]})}},9419(e,t,o){o.d(t,{b:()=>h});var n=o(5723),a=o(7991),r=o(6859),i=o.n(r),s=o(4764);let l="#58a6ff",c="#facc15",d="'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, monospace",p=i().div`
  display: flex;
  flex-direction: column;
  gap: ${s.w4.spacing.sm};
`,f=i().div`
...
`;function m(e){let t=Math.abs(e);return(e<0?"-":"")+(t>=1e3?`€${(t/1e3).toFixed(1)}k`:`€${Math.round(t)}`)}function h({forecast:e,firstNegDate:t,t:o,locale:r,height:i=120}){let x=(0,a.useId)();if(0===e.length)return null;let b=344,y=i-12-28,w=e.map(e=>e.balance),$=Math.min(...w,0),v=Math.max(...w,0)-$||1;function k(e){return 12+y-(e-$)/v*y}let M=b/Math.max(e.length-1,1),j=e.filter(e=>!e.isProjected),z=e.filter(e=>e.isProjected),T=j.length-1,S=e.map((e,t)=>[8+t*M,k(e.balance)]),C=S.slice(0,j.length).map(e=>e.join(",")).join(" "),R=S.slice(Math.max(T,0)).map(e=>e.join(",")).join(" "),F=k(0),A=(0,a.useMemo)(()=>{let t=e.slice(Math.max(T,0));if(t.length<2)return null;let o=Math.max(T,0),n=t.map((e,t)=>[8+(o+t)*M,k(e.balance)]);if(!t.some(e=>e.balance<0))return null;let a=[],r=!1;for(let e=0;e<n.length;e++){let[o,i]=n[e],s=t[e]?.balance??0;if(s<0&&!r){let l=t[e-1]?.balance??0,c=n[e-1]?.[0]??o;if(l>=0&&e>0){let e=c+l/(l-s)*(o-c);a.push(`M${e},${F} L${o},${i}`)}else a.push(`M${o},${i}`);r=!0}else if(s<0&&r)a.push(`L${o},${i}`);else if(s>=0&&r){let i=t[e-1]?.balance??0,l=n[e-1]?.[0]??o;if(i<0){let e=l+Math.abs(i)/(Math.abs(i)+s)*(o-l);a.push(`L${e},${F}`)}r=!1}}if(r){let e=n[n.length-1];e&&a.push(`L${e[0]},${F}`)}return a.join(" ")},[e,T]),D=(0,a.useMemo)(()=>{let t=new Set,o=[];return(e.forEach((e,n)=>{let a=e.date.slice(0,7);!t.has(a)&&(t.add(a),o.push({x:8+n*M,label:function(e,t){let[o,n]=e.split("-").map(Number);return new Date(o,n-1,1).toLocaleDateString("pt"===t?"pt-PT":"en-GB",{month:"short"})}(e.date,r),key:a}))}),o.length>=9)?o.filter((e,t)=>t%2==0):o},[e,r]),E=T>=0?8+T*M:null,B=j[j.length-1]?.balance??0,I=z[z.length-1]?.balance??B;return(0,n.jsxs)(p,{children:[t&&(0,n.jsxs)(f,{role:"alert",children:["⚠ ",o("finance.forecast.projectedNegative")," ",function(e,t){let[o,n,a]=e.split("-").map(Number);return new Date(o,n-1,a).toLocaleDateString("pt"===t?"pt-PT":"en-GB",{day:"2-digit",month:"2-digit"})}(t,r)]}),(0,n.jsxs)("svg",{viewBox:`0 0 360 ${i}`,style:{width:"100%",height:i,display:"block"},preserveAspectRatio:"none","aria-hidden":"true",children:[(0,n.jsx)("defs",{children:(0,n.jsx)("clipPath",{id:`${x}-clip`,children:(0,n.jsx)("rect",{x:0,y:0,width:360,height:i})})}),A&&(0,n.jsx)("path",{d:A,fill:c,opacity:.12,clipPath:`url(#${x}-clip)`}),null!==E&&(0,n.jsx)("rect",{x:E,y:12,width:360-E-8,height:y,fill:s.w4.colors.accent,opacity:.03}),$<0&&(0,n.jsx)("line",{x1:8,x2:8+b,y1:F,y2:F,stroke:c,strokeWidth:"0.75",strokeDasharray:"3 3",opacity:.5}),(0,n.jsx)("line",{x1:8,x2:8+b,y1:12+y,y2:12+y,stroke:s.w4.colors.border,strokeWidth:"1"}),C&&(0,n.jsx)("polyline",{points:C,stroke:l,strokeWidth:"1.5",fill:"none",strokeLinecap:"round",strokeLinejoin:"round",clipPath:`url(#${x}-clip)`}),R&&z.length>0&&(0,n.jsx)("polyline",{points:R,stroke:l,strokeWidth:"1.5",fill:"none",strokeLinecap:"round",strokeLinejoin:"round",strokeDasharray:"4 3",opacity:.75,clipPath:`url(#${x}-clip)`}),null!==E&&(0,n.jsx)("line",{x1:E,x2:E,y1:12,y2:12+y,stroke:s.w4.colors.border,strokeWidth:"1",strokeDasharray:"2 3"}),(0,n.jsx)("g",{fontFamily:d,fontSize:"9",fill:"#8b949e",style:{fontVariantNumeric:"tabular-nums"},children:D.map(e=>(0,n.jsx)("text",{x:e.x,y:i-6,textAnchor:"middle",children:e.label},e.key))}),(0,n.jsx)("text",{fontFamily:d,fontSize:"9",fill:l,x:null!==E?E-3:8,y:20,textAnchor:"end",style:{fontVariantNumeric:"tabular-nums"},children:m(B)}),z.length>0&&(0,n.jsx)("text",{fontFamily:d,fontSize:"9",fill:I<0?c:l,x:8+b,y:Math.max(20,Math.min(12+y-2,k(I)-3)),textAnchor:"end",style:{fontVariantNumeric:"tabular-nums"},children:m(I)})]}),(0,n.jsxs)(g,{children:[(0,n.jsx)(u,{color:l,children:o("finance.forecast.historical")}),(0,n.jsx)(u,{color:l,dashed:!0,children:o("finance.forecast.projected")})]})]})}},341(e,t,o){o.d(t,{z:()=>Q});var n=o(5723),a=o(7991),r=o(6859),i=o.n(r),s=o(2799),l=o(4764),c=o(8170),d=o(5030),p=o(1496),f=o(2385),g=o(948);let u="#7fb77e",m="#facc15",h="#f85149",x=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,b=i().div`
  background: ${l.w4.colors.surface};
...
`,F=i().span`
  ...
  ${({status:e})=>"over"===e?`background: ${h}22; color: ${h};`:"warn"===e?`background: ${m}22; color: ${m};`:`background: ${u}18; color: ${u};`}
`,A=i().div`
  margin-top: 5px;
  height: 4px;
  border-radius: 2px;
...
`,D=i().div`
  ...
  border-radius: 2px;
  background: ${({status:e})=>"over"===e?h:"warn"===e?m:u};
...
`;function _(e,t){let o=f.DEFAULT_CATEGORIES.find(t=>t.id===e);return o?(0,f.categoryLabel)(o,t):e}function Z(e){return f.DEFAULT_CATEGORIES.find(t=>t.id===e)?.icon??"coins"}function X({progress:e,locale:t,t:o,onSave:r,onRemove:i}){let{categoryId:s,spent:c,budget:p,carryover:f,percent:g,status:u}=e,[m,h]=(0,a.useState)(!1),[x,b]=(0,a.useState)(String(p-f)),[y,w]=(0,a.useState)(!1),[$,v]=(0,a.useState)(!1),k=(0,a.useCallback)(()=>{$||(b(String(p-f)),v(!0)),h(e=>!e)},[$,p,f]),W=(0,a.useCallback)(()=>{let e=parseFloat(x.replace(",","."));isNaN(e)||e<0||(r(s,{amount:e,rollover:y}),h(!1))},[x,y,s,r]),O=_(s,t),Y=Z(s);return(0,n.jsxs)(M,{over:"over"===u,onClick:m?void 0:k,children:[(0,n.jsxs)(j,{children:[(0,n.jsx)(z,{children:(0,d.n6)(Y)?(0,n.jsx)(d.In,{name:Y,size:16,"aria-hidden":!0}):(0,n.jsx)("span",{"aria-hidden":!0,children:Y})}),(0,n.jsx)(T,{children:O}),(0,n.jsxs)(S,{children:[(0,n.jsxs)(C,{children:["€",Math.round(c)]}),(0,n.jsx)(R,{children:"/"}),(0,n.jsxs)(C,{muted:!0,children:["€",Math.round(p)]}),(0,n.jsx)(F,{status:u,children:o("over"===u?"finance.categoryBudgets.statusOver":"warn"===u?"finance.categoryBudgets.statusWarn":"finance.categoryBudgets.statusGood")}),(0,n.jsx)("span",{style:{cursor:"pointer",color:l.w4.colors.mainTextMuted,fontSize:12},onClick:e=>{e.stopPropagation(),k()},"aria-label":o("finance.categoryBudgets.edit"),children:m?"▴":"▾"})]})]}),(0,n.jsx)(A,{children:(0,n.jsx)(D,{pct:g,status:u})}),f>0&&(0,n.jsxs)(E,{children:["+€",f.toFixed(2)," ",o("finance.categoryBudgets.carryoverNote")]}),m&&(0,n.jsxs)(B,{onClick:e=>e.stopPropagation(),children:[(0,n.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:6},children:[(0,n.jsx)("span",{style:{fontSize:13,color:l.w4.colors.mainTextMuted},children:"€"}),(0,n.jsx)(I,{type:"number",min:"0",step:"10",value:x,onChange:e=>b(e.target.value),"aria-label":o("finance.categoryBudgets.amount"),autoFocus:!0})]}),(0,n.jsxs)(H,{children:[(0,n.jsx)("input",{type:"checkbox",checked:y,onChange:e=>w(e.target.checked)}),o("finance.categoryBudgets.rollover")]}),(0,n.jsxs)(N,{children:[(0,n.jsx)(L,{type:"button",danger:!0,onClick:()=>{i(s),h(!1)},children:o("finance.categoryBudgets.remove")}),(0,n.jsx)(L,{type:"button",onClick:()=>h(!1),children:o("finance.categoryBudgets.cancel")}),(0,n.jsx)(P,{type:"button",onClick:W,children:o("finance.categoryBudgets.save")})]})]})]})}function J({catId:e,entry:t,locale:o,t:r,onChange:i,onRemove:s}){let l,[c,p]=(0,a.useState)(String(t.amount)),[f,g]=(0,a.useState)(t.rollover??!1),m=(0,a.useCallback)((t,o)=>{let n=parseFloat(t.replace(",","."));!isNaN(n)&&n>=0&&i(e,{amount:n,rollover:o})},[e,i]);return(0,n.jsxs)("tr",{children:[(0,n.jsxs)("td",{children:[(l=Z(e),(0,d.n6)(l)?(0,n.jsx)(d.In,{name:l,size:14,"aria-hidden":!0,style:{marginRight:6,verticalAlign:"middle"}}):(0,n.jsx)("span",{style:{marginRight:6},"aria-hidden":!0,children:l})),_(e,o)]}),(0,n.jsx)("td",{children:(0,n.jsx)(I,{type:"number",min:"0",step:"10",value:c,onChange:e=>{p(e.target.value),m(e.target.value,f)},"aria-label":r("finance.categoryBudgets.amount"),style:{width:80}})}),(0,n.jsx)("td",{style:{textAlign:"center"},children:(0,n.jsx)("input",{type:"checkbox",checked:f,style:{accentColor:u},onChange:e=>{g(e.target.checked),m(c,e.target.checked)},"aria-label":r("finance.categoryBudgets.rollover")})}),(0,n.jsx)("td",{style:{textAlign:"right"},children:(0,n.jsx)(L,{type:"button",danger:!0,onClick:()=>s(e),children:"\xd7"})})]})}function Q(){let{data:e,loaded:t,save:o}=(0,f.useFinance)(),[r]=(0,c.Ym)(),i=(0,a.useMemo)(()=>(0,c.Nx)(r,g.A),[r]),s=(0,f.thisMonthKey)(),[u,m]=(0,a.useState)(!1),[h,x]=(0,a.useState)(!1),[M,j]=(0,a.useState)(null),z=(0,a.useMemo)(()=>e?(0,f.allCategoryProgress)(e,s):[],[e,s]),T=(0,a.useMemo)(()=>new Set(Object.keys(e?.budget.categoryBudgets??{})),[e]),S=(0,a.useMemo)(()=>f.DEFAULT_CATEGORIES.filter(e=>!T.has(e.id)),[T]),C=(0,a.useCallback)(async(t,n)=>{e&&((0,f.pushUndo)({id:`catbudget-${t}-${Date.now()}`,snapshot:e,labelKey:"finance.undo.label.edited",ts:Date.now()}),await o((0,f.setCategoryBudget)(e,t,n)))},[e,o]),R=(0,a.useCallback)(async t=>{e&&((0,f.pushUndo)({id:`catbudget-rm-${t}-${Date.now()}`,snapshot:e,labelKey:"finance.undo.label.deleted",ts:Date.now()}),await o((0,f.removeCategoryBudget)(e,t)))},[e,o]),F=(0,a.useCallback)(async t=>{e&&(await o((0,f.setCategoryBudget)(e,t,{amount:0,rollover:!1})),x(!1))},[e,o]),A=(0,a.useCallback)(()=>{if(!e)return;let t={};for(let[o,n]of Object.entries(e.budget.categoryBudgets))t[o]="number"==typeof n?{amount:n,rollover:!1}:n;j(t),m(!0)},[e]),D=(0,a.useCallback)((e,t)=>{j(o=>({...o??{},[e]:t}))},[]),E=(0,a.useCallback)(e=>{j(t=>{if(!t)return t;let o={...t};return delete o[e],o})},[]),B=(0,a.useCallback)(async()=>{if(!e||!M)return;(0,f.pushUndo)({id:`catbudget-bulk-${Date.now()}`,snapshot:e,labelKey:"finance.undo.label.edited",ts:Date.now()});let t={...e,budget:{...e.budget,categoryBudgets:M}};await o(t),m(!1),j(null)},[e,M,o]),I=(0,a.useCallback)(()=>{m(!1),j(null)},[]);if(!t)return(0,n.jsxs)(b,{children:[(0,n.jsx)(y,{children:(0,n.jsx)(d.YZ,{children:i("finance.categoryBudgets.title")})}),(0,n.jsx)(k,{children:(0,n.jsx)(p.YG,{mode:"loading",label:i("loading")})})]});let H=e?(0,f.formatMonthLabel)(s,r):"";return(0,n.jsxs)(b,{children:[(0,n.jsxs)(y,{children:[(0,n.jsx)(d.YZ,{children:i("finance.categoryBudgets.title")}),(0,n.jsxs)(w,{children:[(0,n.jsx)("span",{style:{fontFamily:l.w4.typography.fontFamilyMono,fontSize:11,color:l.w4.colors.mainTextMuted,letterSpacing:"0.05em"},children:H}),(0,n.jsx)($,{type:"button",className:u?"active":"",onClick:u?I:A,children:u?i("finance.categoryBudgets.cancelEdit"):i("finance.categoryBudgets.editBudgets")})]})]}),(0,n.jsxs)(k,{children:[!u&&0===z.length&&(0,n.jsx)("div",{style:{textAlign:"center",padding:`${l.w4.spacing.md} 0`},children:(0,n.jsx)(p.YG,{mode:"empty",label:i("finance.categoryBudgets.empty")})}),!u&&z.map(e=>(0,n.jsx)(X,{progress:e,locale:r,t:i,onSave:C,onRemove:R},e.categoryId)),u&&M&&(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(W,{children:(0,n.jsxs)(O,{children:[(0,n.jsx)(Y,{children:(0,n.jsxs)("tr",{children:[(0,n.jsx)("th",{children:i("finance.categoryBudgets.category")}),(0,n.jsx)("th",{children:i("finance.categoryBudgets.amount")}),(0,n.jsx)("th",{style:{textAlign:"center"},children:i("finance.categoryBudgets.rollover")}),(0,n.jsx)("th",{})]})}),(0,n.jsx)(K,{children:Object.keys(M).map(e=>(0,n.jsx)(J,{catId:e,entry:M[e]??{amount:0,rollover:!1},locale:r,t:i,onChange:D,onRemove:E},e))})]})}),(0,n.jsxs)(V,{children:[(0,n.jsx)(L,{type:"button",onClick:I,children:i("finance.categoryBudgets.cancel")}),(0,n.jsx)(P,{type:"button",onClick:B,children:i("finance.categoryBudgets.saveAll")})]})]})]}),!u&&S.length>0&&(0,n.jsxs)(G,{children:[(0,n.jsxs)(v,{type:"button",onClick:()=>x(e=>!e),children:[h?"▴ ":"▾ ",i("finance.categoryBudgets.addBudget")]}),h&&(0,n.jsx)(U,{children:S.map(e=>(0,n.jsxs)(q,{type:"button",onClick:()=>F(e.id),children:[(0,d.n6)(e.icon)?(0,n.jsx)(d.In,{name:e.icon,size:14,"aria-hidden":!0}):(0,n.jsx)("span",{"aria-hidden":!0,children:e.icon}),(0,n.jsx)("span",{style:{fontSize:12,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:(0,f.categoryLabel)(e,r)})]},e.id))})]})]})}},9378(e,t,o){o.d(t,{K:()=>Y});var n=o(5723),a=o(7991),r=o(6859),i=o.n(r),s=o(2799),l=o(4764),c=o(8170),d=o(5030),p=o(1496),f=o(2385),g=o(948),u=o(4041);let m="#7fb77e",h="#f85149",x=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,b=i().div`
  background: ${l.w4.colors.surface};
...
`,W=i().button`
  ...
  &:focus-visible { outline: 2px solid ${l.w4.colors.accent}; outline-offset: 2px; }
`;function O(){return{match:"",matchKind:"substring",categoryId:"other",memberId:""}}function Y(){let[e]=(0,c.Ym)(),t=(0,a.useMemo)(()=>(0,c.Nx)(e,g.A),[e]),{data:o,loaded:r,save:i}=(0,f.useFinance)(),[s,m]=(0,a.useState)(!1),[h,x]=(0,a.useState)(null),[Y,K]=(0,a.useState)(O),V=(0,a.useMemo)(()=>o?.categoryRules??[],[o]),G=Y.match.trim().length>0&&!(0,f.isValidPattern)(Y.match,Y.matchKind),U=Y.match.trim().length>0&&!G,q=(0,a.useCallback)(()=>{x(null),K(O()),m(!0)},[]),_=(0,a.useCallback)(e=>{x(e.id),K({match:e.match,matchKind:e.matchKind,categoryId:e.categoryId,memberId:e.memberId??""}),m(!0)},[]),Z=(0,a.useCallback)(()=>{m(!1),x(null)},[]),X=(0,a.useCallback)(async()=>{if(!o||!U)return;let e=Date.now();if(h){let t=(o.categoryRules??[]).find(e=>e.id===h);if(!t)return;let n={...t,match:Y.match.trim(),matchKind:Y.matchKind,categoryId:Y.categoryId,memberId:Y.memberId||void 0};(0,f.pushUndo)({id:(0,u.z)(),snapshot:o,labelKey:"finance.undo.label.edited",ts:e}),await i({...o,categoryRules:(o.categoryRules??[]).map(e=>e.id===n.id?n:e)})}else{let t={id:(0,u.z)(),match:Y.match.trim(),matchKind:Y.matchKind,categoryId:Y.categoryId,memberId:Y.memberId||void 0,createdAt:e};(0,f.pushUndo)({id:(0,u.z)(),snapshot:o,labelKey:"finance.undo.label.added",ts:e}),await i({...o,categoryRules:[t,...o.categoryRules??[]]})}Z()},[o,Y,h,U,i,Z]),J=(0,a.useCallback)(async e=>{o&&((0,f.pushUndo)({id:(0,u.z)(),snapshot:o,labelKey:"finance.undo.label.deleted",ts:Date.now()}),await i({...o,categoryRules:(o.categoryRules??[]).filter(t=>t.id!==e)}))},[o,i]),Q=(0,a.useCallback)(async(e,t)=>{o&&await i(function(e,t,o){let n=[...e.categoryRules??[]],a=n.findIndex(e=>e.id===t);if(a<0)return e;let r="up"===o?a-1:a+1;return r<0||r>=n.length?e:([n[a],n[r]]=[n[r],n[a]],{...e,categoryRules:n})}(o,e,t))},[o,i]);return r?(0,n.jsxs)(b,{children:[(0,n.jsxs)(y,{children:[(0,n.jsx)(d.YZ,{children:t("finance.categoryRules.title")}),(0,n.jsx)("span",{style:{fontSize:11,fontFamily:l.w4.typography.fontFamilyMono,color:l.w4.colors.mainTextMuted},children:t("finance.categoryRules.orderNote")})]}),0===V.length&&!s&&(0,n.jsx)(p.YG,{mode:"empty",label:t("finance.categoryRules.empty")}),V.map((o,a)=>{let r=f.DEFAULT_CATEGORIES.find(e=>e.id===o.categoryId),i=r?(0,f.categoryLabel)(r,e):o.categoryId;return(0,n.jsxs)(w,{children:[(0,n.jsxs)("div",{style:{display:"flex",flexDirection:"column",gap:1},children:[(0,n.jsx)(W,{type:"button",disabled:0===a,title:t("finance.categoryRules.moveUp"),"aria-label":t("finance.categoryRules.moveUp"),onClick:()=>{Q(o.id,"up")},children:(0,n.jsx)(d.In,{name:"chevron-up",size:12})}),(0,n.jsx)(W,{type:"button",disabled:a===V.length-1,title:t("finance.categoryRules.moveDown"),"aria-label":t("finance.categoryRules.moveDown"),onClick:()=>{Q(o.id,"down")},children:(0,n.jsx)(d.In,{name:"chevron-down",size:12})})]}),(0,n.jsxs)($,{children:[(0,n.jsx)(v,{children:o.match}),(0,n.jsxs)(k,{children:[(0,n.jsx)(M,{children:"regex"===o.matchKind?t("finance.categoryRules.kindRegex"):t("finance.categoryRules.kindSubstring")}),(0,n.jsx)(j,{children:"→"}),(0,n.jsxs)(M,{accent:!0,children:[r?.icon??""," ",i]}),o.memberId&&(0,n.jsxs)(j,{children:["@ ",o.memberId]})]})]}),(0,n.jsxs)(z,{className:"rule-actions",children:[(0,n.jsx)(T,{type:"button",title:t("finance.categoryRules.edit"),"aria-label":t("finance.categoryRules.edit"),onClick:()=>_(o),children:(0,n.jsx)(d.In,{name:"edit",size:14})}),(0,n.jsx)(T,{type:"button",danger:!0,title:t("finance.categoryRules.delete"),"aria-label":t("finance.categoryRules.delete"),onClick:()=>{J(o.id)},children:(0,n.jsx)(d.In,{name:"trash",size:14})})]})]},o.id)}),s&&(0,n.jsxs)(C,{children:[(0,n.jsx)(R,{children:h?t("finance.categoryRules.editTitle"):t("finance.categoryRules.addTitle")}),(0,n.jsxs)(D,{children:[(0,n.jsxs)(A,{style:{flex:2,minWidth:160},children:[(0,n.jsx)(F,{htmlFor:"cr-match",children:t("finance.categoryRules.match")}),(0,n.jsx)(E,{id:"cr-match",invalid:G,value:Y.match,onChange:e=>K(t=>({...t,match:e.target.value})),placeholder:"regex"===Y.matchKind?"^continente":"continente"}),G&&(0,n.jsx)(N,{children:t("finance.categoryRules.invalidRegex")})]}),(0,n.jsxs)(A,{children:[(0,n.jsx)(F,{children:t("finance.categoryRules.matchKind")}),(0,n.jsxs)(I,{children:[(0,n.jsx)(H,{type:"button",active:"substring"===Y.matchKind,onClick:()=>K(e=>({...e,matchKind:"substring"})),children:t("finance.categoryRules.kindSubstring")}),(0,n.jsx)(H,{type:"button",active:"regex"===Y.matchKind,onClick:()=>K(e=>({...e,matchKind:"regex"})),children:t("finance.categoryRules.kindRegex")})]})]})]}),(0,n.jsxs)(D,{children:[(0,n.jsxs)(A,{style:{flex:1,minWidth:120},children:[(0,n.jsx)(F,{htmlFor:"cr-category",children:t("finance.categoryRules.categorize")}),(0,n.jsx)(B,{id:"cr-category",value:Y.categoryId,onChange:e=>K(t=>({...t,categoryId:e.target.value})),children:f.DEFAULT_CATEGORIES.map(t=>(0,n.jsx)("option",{value:t.id,children:(0,f.categoryLabel)(t,e)},t.id))})]}),o&&o.familyMembers.length>0&&(0,n.jsxs)(A,{style:{flex:1,minWidth:120},children:[(0,n.jsx)(F,{htmlFor:"cr-member",children:t("finance.categoryRules.asMember")}),(0,n.jsxs)(B,{id:"cr-member",value:Y.memberId,onChange:e=>K(t=>({...t,memberId:e.target.value})),children:[(0,n.jsx)("option",{value:"",children:t("finance.categoryRules.noMember")}),o.familyMembers.map(e=>(0,n.jsx)("option",{value:e.id,children:e.name},e.id))]})]})]}),(0,n.jsxs)(L,{children:[(0,n.jsx)(P,{type:"button",onClick:Z,children:t("finance.categoryRules.cancel")}),(0,n.jsx)(P,{type:"button",primary:!0,disabled:!U,onClick:()=>{X()},children:t("finance.categoryRules.save")})]})]}),!s&&(0,n.jsxs)(S,{type:"button",onClick:q,children:[(0,n.jsx)(d.In,{name:"plus",size:14}),t("finance.categoryRules.addRule")]})]}):(0,n.jsxs)(b,{children:[(0,n.jsx)(d.YZ,{children:t("finance.categoryRules.title")}),(0,n.jsx)(p.YG,{mode:"loading",label:t("loading")})]})}},2405(e,t,o){o.d(t,{D:()=>C});var n=o(5723),a=o(7991),r=o(6859),i=o.n(r),s=o(2799),l=o(4764);let c=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,d=i().div`
  display: flex;
...
`,$=i().div`
  ...
  border-radius: 1px;
  background: ${({bg:e})=>e};
`,v=new Set([0,4,8,12,16,20]);function k(e){return[parseInt(e.slice(1,3),16),parseInt(e.slice(3,5),16),parseInt(e.slice(5,7),16)]}let M=k("#1d2230"),j=k("#f59e0b");function z(e){let t=Math.round(M[0]+(j[0]-M[0])*e),o=Math.round(M[1]+(j[1]-M[1])*e),n=Math.round(M[2]+(j[2]-M[2])*e);return`rgb(${t},${o},${n})`}let T=function(e=5){return Array.from({length:e},(t,o)=>z(o/(e-1)))}(5),S=["finance.dayHourHeatmap.day.mon","finance.dayHourHeatmap.day.tue","finance.dayHourHeatmap.day.wed","finance.dayHourHeatmap.day.thu","finance.dayHourHeatmap.day.fri","finance.dayHourHeatmap.day.sat","finance.dayHourHeatmap.day.sun"];function C({matrix:e,t}){let o=(0,a.useMemo)(()=>{let t=0;for(let o of e)for(let e of o)e>t&&(t=e);return t},[e]);return 0===o?(0,n.jsx)(x,{children:t("finance.dayHourHeatmap.empty")}):(0,n.jsxs)(d,{children:[(0,n.jsxs)(p,{children:[(0,n.jsx)(g,{}),Array.from({length:24},(e,t)=>(0,n.jsx)(f,{children:v.has(t)?String(t).padStart(2,"0"):""},t))]}),e.map((e,a)=>(0,n.jsxs)(u,{children:[(0,n.jsx)(m,{children:t(S[a]??"finance.dayHourHeatmap.day.mon")}),e.map((e,r)=>{let i=z(o>0?e/o:0),s=e>0?`€${e.toFixed(2)}`:"—",l=`${String(r).padStart(2,"0")}:00`,c=t(S[a]??"finance.dayHourHeatmap.day.mon");return(0,n.jsx)(h,{bg:i,title:t("finance.dayHourHeatmap.tooltip",{day:c,hour:l,amount:s}),"aria-label":`${c} ${l} — ${s}`},r)})]},a)),(0,n.jsxs)(b,{children:[(0,n.jsx)(y,{children:"0"}),(0,n.jsx)(w,{children:T.map((e,t)=>(0,n.jsx)($,{bg:e},t))}),(0,n.jsxs)(y,{children:["€",o.toFixed(0)]})]})]})}},8635(e,t,o){o.d(t,{f:()=>O,z:()=>Y});var n=o(5723),a=o(7991),r=o(6859),i=o.n(r),s=o(2799),l=o(4764),c=o(8170),d=o(5030),p=o(1496),f=o(2385),g=o(948);let u="#7fb77e",m="#f85149",h=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,x=i().div`
  background: ${l.w4.colors.surface};
...
`,I=i().div`
  ...
  color: ${l.w4.colors.mainTextMuted};
  margin-bottom: ${l.w4.spacing.xs};
`;function H({percent:e,color:t,size:o=36}){let a=(o-3)/2,r=2*Math.PI*a,i=r*(1-Math.min(e,1));return(0,n.jsxs)("svg",{width:o,height:o,viewBox:`0 0 ${o} ${o}`,"aria-hidden":!0,style:{flexShrink:0,transform:"rotate(-90deg)"},children:[(0,n.jsx)("circle",{cx:o/2,cy:o/2,r:a,fill:"none",stroke:l.w4.colors.border,strokeWidth:3}),(0,n.jsx)("circle",{cx:o/2,cy:o/2,r:a,fill:"none",stroke:t,strokeWidth:3,strokeDasharray:r,strokeDashoffset:i,strokeLinecap:"round",style:{transition:"stroke-dashoffset 0.4s ease"}})]})}function N({status:e,t}){return"achieved"===e?(0,n.jsx)(d.Ex,{tone:"accent",children:t("finance.goals.achieved")}):"behind"===e?(0,n.jsx)(d.Ex,{tone:"neutral",style:{color:m,borderColor:`${m}44`},children:t("finance.goals.behind")}):(0,n.jsx)(d.Ex,{tone:"neutral",style:{color:u,borderColor:`${u}44`},children:t("finance.goals.onTrack")})}function L(){return new Date().toISOString().slice(0,10)}function P({data:e,onSave:t,onCancel:o,t:r}){let[i,s]=(0,a.useState)(""),[l,c]=(0,a.useState)(""),[d,p]=(0,a.useState)(""),[g,u]=(0,a.useState)("");async function m(){let o=parseFloat(l);if(!i.trim()||isNaN(o)||o<=0)return;let n=(0,f.addGoal)(e,{name:i.trim(),target:o,deadline:d||void 0,memberId:g||void 0});await t(n)}let h=i.trim().length>0&&parseFloat(l)>0;return(0,n.jsxs)(T,{children:[(0,n.jsxs)(S,{children:[(0,n.jsx)(C,{type:"text",placeholder:r("finance.goals.name"),value:i,onChange:e=>s(e.target.value),autoFocus:!0,"aria-label":r("finance.goals.name")}),(0,n.jsx)(C,{type:"number",min:"1",placeholder:r("finance.goals.target"),value:l,onChange:e=>c(e.target.value),"aria-label":r("finance.goals.target"),style:{maxWidth:130}})]}),(0,n.jsxs)(S,{children:[(0,n.jsx)(C,{type:"date",placeholder:r("finance.goals.deadline"),value:d,onChange:e=>p(e.target.value),"aria-label":r("finance.goals.deadline"),min:L()}),e.familyMembers.length>0&&(0,n.jsxs)(R,{value:g,onChange:e=>u(e.target.value),"aria-label":r("finance.goals.member"),children:[(0,n.jsx)("option",{value:"",children:r("finance.goals.member")}),e.familyMembers.map(e=>(0,n.jsx)("option",{value:e.id,children:e.name},e.id))]})]}),(0,n.jsxs)(F,{children:[(0,n.jsx)(A,{type:"button",onClick:o,children:r("finance.goals.cancel")}),(0,n.jsx)(A,{type:"button",primary:!0,disabled:!h,onClick:()=>{m()},children:r("finance.goals.save")})]})]})}function W({goal:e,data:t,onSave:o,onClose:r,t:i}){let[s,c]=(0,a.useState)("");async function d(){let n=parseFloat(s);if(isNaN(n)||n<=0)return;let a=(0,f.contributeToGoal)(t,e.id,n,L());await o(a),r()}let p=parseFloat(s)>0;return(0,n.jsx)(E,{onClick:r,children:(0,n.jsxs)(B,{onClick:e=>e.stopPropagation(),children:[(0,n.jsx)(I,{children:i("finance.goals.contribute")}),(0,n.jsx)("div",{style:{fontSize:16,fontWeight:600,color:l.w4.colors.mainText},children:e.name}),(0,n.jsx)(C,{type:"number",min:"0.01",step:"0.01",placeholder:i("finance.goals.amount"),value:s,onChange:e=>c(e.target.value),autoFocus:!0,"aria-label":i("finance.goals.amount"),style:{width:"100%",maxWidth:"100%"}}),(0,n.jsxs)(F,{children:[(0,n.jsx)(A,{type:"button",onClick:r,children:i("finance.goals.cancel")}),(0,n.jsx)(A,{type:"button",primary:!0,disabled:!p,onClick:()=>{d()},children:i("finance.goals.contribute")})]})]})})}function O(){let[e]=(0,c.Ym)(),t=(0,a.useMemo)(()=>(0,c.Nx)(e,g.A),[e]),{data:o,loaded:r,save:i}=(0,f.useFinance)(),[s,l]=(0,a.useState)(!1),[h,T]=(0,a.useState)(null);if(!r||null===o)return(0,n.jsxs)(x,{children:[(0,n.jsx)(d.YZ,{children:t("finance.goals.title")}),(0,n.jsx)(p.YG,{mode:"loading",label:t("loading")})]});let S=(0,f.recomputeGoalCurrents)(o),C=S.goals;async function R(e){(0,f.pushUndo)({id:`goal-${Date.now()}`,snapshot:o,labelKey:"finance.undo.label.edited",ts:Date.now()}),await i(e)}async function F(e){let t=(0,f.deleteGoal)(S,e);(0,f.pushUndo)({id:`goal-del-${Date.now()}`,snapshot:S,labelKey:"finance.undo.label.deleted",ts:Date.now()}),await i(t)}return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsxs)(x,{children:[(0,n.jsx)(b,{children:(0,n.jsx)(d.YZ,{children:t("finance.goals.title")})}),0!==C.length||s?C.map(e=>{let o=(0,f.goalProgress)(e),a=(0,f.goalStatus)(e),r=e.color??("achieved"===a?u:"behind"===a?m:u),i=Math.round(100*o.percent);return(0,n.jsxs)(y,{children:[(0,n.jsx)(H,{percent:o.percent,color:r}),(0,n.jsxs)(w,{children:[(0,n.jsx)($,{children:e.name}),(0,n.jsxs)(v,{children:[(0,n.jsxs)(k,{children:[i,"% ",t("finance.goals.progress",{pct:i,target:Math.round(e.target)}).replace(String(i)+"% ","")]}),(0,n.jsx)(N,{status:a,t:t}),void 0!==o.monthlyNeeded&&(0,n.jsx)(k,{children:t("finance.goals.monthlyNeeded",{n:o.monthlyNeeded})})]})]}),(0,n.jsxs)(M,{children:["achieved"!==a&&(0,n.jsx)(j,{type:"button",onClick:()=>T(e),"aria-label":`${t("finance.goals.contribute")} — ${e.name}`,children:t("finance.goals.contribute")}),(0,n.jsx)(z,{type:"button",className:"goal-delete",title:t("finance.goals.delete"),"aria-label":`${t("finance.goals.delete")} — ${e.name}`,onClick:()=>{F(e.id)},children:(0,n.jsx)(d.In,{name:"trash",size:13})})]})]},e.id)}):(0,n.jsx)(p.YG,{mode:"empty",label:t("finance.goals.empty")}),s?(0,n.jsx)(P,{data:o,onSave:async e=>{await R(e),l(!1)},onCancel:()=>l(!1),t:t}):(0,n.jsxs)(D,{type:"button",onClick:()=>l(!0),children:[(0,n.jsx)(d.In,{name:"plus",size:14,"aria-hidden":!0}),t("finance.goals.add")]})]}),null!==h&&(0,n.jsx)(W,{goal:h,data:o,onSave:R,onClose:()=>T(null),t:t})]})}function Y({percent:e,color:t,label:o}){let a=2*Math.PI*5,r=a*(1-Math.min(e,1));return(0,n.jsxs)("svg",{width:12,height:12,viewBox:"0 0 12 12","aria-label":o,style:{flexShrink:0,transform:"rotate(-90deg)"},children:[(0,n.jsx)("circle",{cx:6,cy:6,r:5,fill:"none",stroke:l.w4.colors.border,strokeWidth:2}),(0,n.jsx)("circle",{cx:6,cy:6,r:5,fill:"none",stroke:t,strokeWidth:2,strokeDasharray:a,strokeDashoffset:r,strokeLinecap:"round"})]})}},719(e,t,o){o.d(t,{TA:()=>E,a8:()=>g,jb:()=>B});var n=o(5723),a=o(7991),r=o(6859),i=o.n(r),s=o(4764),l=o(5030),c=o(1496),d=o(2385),p=o(8635);let f=["#3b82f6","#8b5cf6","#ec4899","#10b981","#f59e0b","#06b6d4"];function g(e,t){return e.color??f[t%f.length]}let u="#7fb77e",m=i().nav`
  display: flex;
  flex-direction: column;
  width: 100%;
  height: 100%;
...
`,h=i().button`
  ...
  background: transparent;
  border: none;
  border-left: 2px solid ${({active:e})=>e?u:"transparent"};
  cursor: pointer;
  transition: background 120ms ease, border-color 120ms ease;
  text-align: left;
  width: 100%;
...
`,b=i().div`
  font-size: 13px;
  font-weight: 500;
  color: ${({active:e})=>e?u:s.w4.colors.mainText};
  white-space: nowrap;
  overflow: hidden;
  text-overflow: ellipsis;
`,y=i().div`
...
`,z=i().button`
  ...
  min-height: 44px;
  border-radius: ${s.w4.borderRadius.md};
  border: 1px solid ${({active:e})=>e?u:s.w4.colors.border};
  background: ${({active:e})=>e?`${u}22`:s.w4.colors.mainBg};
  color: ${({active:e})=>e?u:s.w4.colors.mainTextMuted};
  font-size: 13px;
  cursor: pointer;
  transition: all 120ms ease;
`,T=i().div`
...
`,R=i().button`
  ...
  min-height: 44px;
  border-radius: ${s.w4.borderRadius.md};
  border: 1px solid ${({primary:e})=>e?u:s.w4.colors.border};
  background: ${({primary:e})=>e?`${u}22`:"transparent"};
  color: ${({primary:e})=>e?u:s.w4.colors.mainTextMuted};
  font-size: 13px;
  cursor: pointer;
  transition: all 120ms ease;
`,F=i().div`
...
`,D=i().span`
  ...
  font-variant-numeric: tabular-nums;
  color: ${s.w4.colors.mainTextMuted};
`;function E({data:e,activeMemberId:t,onSelectMember:o,onSaveData:r,t:i,locale:u}){let[F,A]=(0,a.useState)(!1),[D,B]=(0,a.useState)(""),[I,H]=(0,a.useState)("adult"),[N,L]=(0,a.useState)(f[0]),P=(0,d.thisMonthKey)(),W=(()=>{let[e,t]=P.split("-").map(Number),o=new Date(e,t-2,1);return`${o.getFullYear()}-${String(o.getMonth()+1).padStart(2,"0")}`})(),O=[{id:"all",name:i("finance.member.all"),role:"shared",color:void 0},{id:"shared",name:i("finance.member.shared"),role:"shared",color:void 0},...e.familyMembers.map((e,t)=>({...e,color:g(e,t)}))];return(0,n.jsxs)(m,{"aria-label":i("finance.nav.ariaLabel"),children:[O.map(a=>{var r;let i,f,g=a.id===t,m=a.color??s.w4.colors.mainTextMuted,v=(0,d.monthlyTotalByMember)(e,a.id,P),k=(r=a.id,i=(0,d.monthlyTotalByMember)(e,r,P),0===(f=(0,d.monthlyTotalByMember)(e,r,W))?0:Math.round((i-f)/f*100)),M=function(e,t){let o=new Date,n=[];for(let a=5;a>=0;a--){let r=new Date(o);r.setDate(o.getDate()-7*a-o.getDay()),r.setHours(0,0,0,0);let i=new Date(r);i.setDate(r.getDate()+7);let s=(0,d.expensesForMember)(e.expenses,t).filter(e=>{let t=new Date(e.date+"T00:00:00");return t>=r&&t<i}).reduce((e,t)=>e+t.amount,0);n.push(s)}return n}(e,a.id),j={id:a.id,name:a.name,role:a.role,color:a.color},z=(0,d.recomputeGoalCurrents)(e).goals.find(e=>e.memberId===a.id),T=z?(0,d.goalProgress)(z):null,S=z?(0,d.goalStatus)(z):null,C=z&&"behind"===S?"#f85149":"#7fb77e";return(0,n.jsxs)(h,{active:g,onClick:()=>o(a.id),type:"button","aria-pressed":g,children:[(0,n.jsxs)("div",{style:{position:"relative",flexShrink:0},children:[(0,n.jsx)(l.eu,{member:j,size:26}),null!==T&&(0,n.jsx)("div",{style:{position:"absolute",bottom:-2,right:-2},children:(0,n.jsx)(p.z,{percent:T.percent,color:C,label:z?.name??""})})]}),(0,n.jsxs)(x,{children:[(0,n.jsx)(b,{active:g,children:a.name}),(0,n.jsxs)(y,{children:[(0,n.jsx)(w,{children:`€${Math.round(v).toLocaleString("pt"===u?"pt-PT":"en-GB")}`}),0!==k&&(0,n.jsxs)($,{positive:k>0,children:[k>0?"↑":"↓",Math.abs(k),"%"]})]})]}),M.some(e=>e>0)&&(0,n.jsx)(c.OW,{points:M,accent:m,width:48,height:24})]},a.id)}),F?(0,n.jsxs)(k,{children:[(0,n.jsx)(M,{type:"text",placeholder:i("finance.member.name"),value:D,onChange:e=>B(e.target.value),autoFocus:!0,"aria-label":i("finance.member.name")}),(0,n.jsxs)(j,{children:[(0,n.jsx)(z,{type:"button",active:"adult"===I,onClick:()=>H("adult"),children:i("finance.member.role.adult")}),(0,n.jsx)(z,{type:"button",active:"child"===I,onClick:()=>H("child"),children:i("finance.member.role.child")})]}),(0,n.jsx)(T,{children:f.map(e=>(0,n.jsx)(S,{type:"button",bg:e,active:N===e,onClick:()=>L(e),"aria-label":e},e))}),(0,n.jsxs)(C,{children:[(0,n.jsx)(R,{type:"button",onClick:()=>A(!1),children:i("finance.member.cancel")}),(0,n.jsx)(R,{type:"button",primary:!0,onClick:function(){if(!D.trim())return;let t={id:`m_${Date.now()}`,name:D.trim(),role:I,color:N};r({...e,familyMembers:[...e.familyMembers,t]}),B(""),H("adult"),L(f[0]),A(!1)},disabled:!D.trim(),children:i("finance.member.save")})]})]}):(0,n.jsxs)(v,{type:"button",onClick:()=>A(!0),children:[(0,n.jsx)(l.In,{name:"user-plus",size:14,"aria-hidden":!0}),i("finance.member.add")]})]})}function B({data:e,activeMemberId:t,onSelectMember:o,t:a,locale:r}){let i=(0,d.thisMonthKey)(),c=[{id:"all",name:a("finance.member.all"),role:"shared",color:void 0},{id:"shared",name:a("finance.member.shared"),role:"shared",color:void 0},...e.familyMembers.map((e,t)=>({...e,color:g(e,t)}))];return(0,n.jsx)(F,{role:"tablist","aria-label":a("finance.nav.ariaLabel"),children:c.map(a=>{let c=a.id===t,p=a.color??s.w4.colors.mainTextMuted,f=(0,d.monthlyTotalByMember)(e,a.id,i),g={id:a.id,name:a.name,role:a.role,color:a.color};return(0,n.jsxs)(A,{active:c,color:p,onClick:()=>o(a.id),type:"button",role:"tab","aria-selected":c,children:[(0,n.jsx)(l.eu,{member:g,size:20}),(0,n.jsx)("span",{children:a.name}),(0,n.jsx)(D,{children:`€${Math.round(f).toLocaleString("pt"===r?"pt-PT":"en-GB")}`})]},a.id)})})}},1255(e,t,o){o.d(t,{R:()=>M});var n=o(5723),a=o(7991),r=o(6859),i=o.n(r),s=o(2799),l=o(4764),c=o(5030),d=o(1496),p=o(2385);let f=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,g=i().div`
  display: grid;
...
`,k=i().div`
  ...
  color: ${l.w4.colors.mainTextMuted};
  padding: ${l.w4.spacing.xs} 0;
`;function M({expenses:e,familyMembers:t,getMemberColor:o,t:r,locale:i}){let s=(0,a.useMemo)(()=>(0,p.thisMonthKey)(),[]),f=(0,a.useMemo)(()=>{let n=[],a=(0,p.memberMonthlyTotals)(e,"shared",6);if(a.reduce((e,t)=>e+t.total,0)>0){let t=(0,p.memberMonthlyTotals)(e,"shared",1)[0]?.total??0;n.push({id:"shared",label:r("finance.income.member.shared"),color:l.w4.colors.mainTextMuted,idx:-1,sparkPoints:(0,p.memberSparkline)(e,"shared",8),currentMonthTotal:t,deltaVsLastMonth:(0,p.memberDeltaVsLastMonth)(e,"shared",s),monthlyTotals:a})}return t.forEach((t,a)=>{let r=(0,p.memberMonthlyTotals)(e,t.id,6);if(0===r.reduce((e,t)=>e+t.total,0))return;let i=(0,p.memberMonthlyTotals)(e,t.id,1)[0]?.total??0;n.push({id:t.id,label:t.name,color:o(t,a),role:t.role,memberId:t,idx:a,sparkPoints:(0,p.memberSparkline)(e,t.id,8),currentMonthTotal:i,deltaVsLastMonth:(0,p.memberDeltaVsLastMonth)(e,t.id,s),monthlyTotals:r})}),n},[e,t,o,s,r]);if(0===f.length)return(0,n.jsx)(k,{children:r("finance.smallMultiples.empty")});let j=function(e,t){let[o,n]=e.split("-").map(Number);return new Date(o,n-1,1).toLocaleDateString("pt"===t?"pt-PT":"en-GB",{month:"short"})}(s,i);return(0,n.jsx)(g,{children:f.map(e=>(0,n.jsxs)(u,{accentColor:e.color,children:[(0,n.jsxs)(m,{children:["shared"===e.id?(0,n.jsx)(c.In,{name:"users",size:14,color:e.color}):e.memberId?(0,n.jsx)(c.eu,{member:{id:e.memberId.id,name:e.memberId.name,role:e.memberId.role,color:e.color},size:16}):(0,n.jsx)(c.In,{name:"user",size:14,color:e.color}),(0,n.jsx)(h,{style:{color:e.color},children:e.label})]}),e.sparkPoints.some(e=>e>0)&&(0,n.jsx)(w,{children:(0,n.jsx)(d.OW,{points:e.sparkPoints,accent:e.color,width:160,height:28})}),(0,n.jsxs)(b,{children:[(0,n.jsxs)(x,{children:["€",Math.round(e.currentMonthTotal).toLocaleString("pt-PT")]}),(0,n.jsx)(y,{children:j})]}),(0,n.jsxs)($,{children:[(0,n.jsx)(v,{children:r("finance.smallMultiples.vsLastMonth")}),(0,n.jsx)(d.Ru,{value:e.deltaVsLastMonth,format:"abs",decimals:0})]})]},e.id))})}},8989(e,t,o){o.d(t,{f:()=>b});var n=o(5723),a=o(7991),r=o(6859),i=o.n(r),s=o(4764),l=o(2385);function c(e,t){let[o,n]=e.split("-"),a=new Date(parseInt(o),parseInt(n)-1,1),r=a.toLocaleDateString("pt"===t?"pt-PT":"en-GB",{month:"short"}),i=r.charAt(0).toUpperCase()+r.slice(1).replace(".","");return 0===a.getMonth()?`${i} '${String(a.getFullYear()).slice(2)}`:i}let d=i().div`
  background: ${s.w4.colors.mainBg};
  border-bottom: 1px solid ${s.w4.colors.border};
  flex-shrink: 0;
  overflow: hidden;
...
`,x=i().div`
  ...
  opacity: 0.4;
  pointer-events: none;
`;function b({data:e,selectedMonth:t,onSelectMonth:o,locale:r}){let i=(0,a.useRef)(null),y=(0,a.useRef)(null),w=(0,a.useMemo)(()=>(function(){let e=[],t=new Date;for(let o=11;o>=0;o--){let n=new Date(t.getFullYear(),t.getMonth()-o,1);e.push(`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,"0")}`)}return e})(),[]),$=(0,a.useMemo)(()=>w.map(t=>(0,l.expensesForMonth)(e.expenses,t).reduce((e,t)=>e+t.amount,0)),[w,e.expenses]),v=e.budget.monthlyBudget,k=(0,a.useMemo)(()=>Math.max(...$,0),[$]),M=(0,a.useMemo)(()=>0===k||v<=0?-1:22+Math.round(28*Math.min(v/k,1)),[k,v]);return(0,a.useEffect)(()=>{let e=y.current,t=i.current;if(!e||!t)return;let o=e.offsetLeft,n=o+e.offsetWidth,a=t.scrollLeft,r=a+t.clientWidth;(o<a||n>r)&&t.scrollTo({left:o-t.clientWidth/2+e.offsetWidth/2,behavior:"smooth"})},[t]),(0,n.jsx)(d,{role:"navigation","aria-label":"Month picker",children:(0,n.jsxs)(p,{ref:i,children:[M>=0&&(0,n.jsx)(x,{bottom:M,role:"presentation","aria-hidden":!0}),w.map((e,a)=>{let i=$[a]??0,l=e===t,d=i>v&&v>0,p=k>0?Math.round(i/k*28):0,x=0;return d&&k>0&&v>0&&(x=Math.max(0,p-Math.round(v/k*28))),(0,n.jsxs)(f,{active:l,ref:l?y:void 0,onClick:()=>o(e),"aria-label":`${c(e,r)} — €${Math.round(i)}`,"aria-pressed":l,type:"button",children:[(0,n.jsx)(g,{"aria-hidden":!0,children:p>0?(0,n.jsx)(u,{height:p,color:"#7fb77e",active:l,children:x>0&&(0,n.jsx)(m,{height:x})}):(0,n.jsx)("div",{style:{width:"100%",height:2,background:s.w4.colors.border,borderRadius:2}})}),(0,n.jsx)(h,{active:l,children:c(e,r)})]},e)})]})})}},216(e,t,o){o.d(t,{S:()=>en});var n=o(5723),a=o(7991),r=o(6859),i=o.n(r),s=o(2799),l=o(4764),c=o(8170),d=o(5030),p=o(1496),f=o(2385),g=o(948);let u="#7fb77e",m="#f85149",h="#58a6ff",x=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,b=i().div`
  background: ${l.w4.colors.surface};
...
`,X=i().button`
  ...
  &:disabled { opacity: 0.4; cursor: not-allowed; }
  &:focus-visible { outline: 2px solid ${l.w4.colors.accent}; outline-offset: 2px; }
`;function J(){return new Date().toISOString().slice(0,10)}function Q(e,t){let o=Math.abs(e);return`${e<0?"−":""}€${Math.round(o).toLocaleString("pt"===t?"pt-PT":"en-GB")}`}function ee({series:e,locale:t,t:o}){let a,r;if(!e.some(e=>!e.estimated||0!==e.net))return(0,n.jsx)(R,{children:o("finance.netWorth.noSnapshots")});let i=e.length,s=e.map(e=>e.net),c=e.map(e=>e.assets),d=e.map(e=>e.liabilities),p=[...s,...c,...d],f=Math.min(0,...p),g=Math.max(0,...p),x=g-f||1,b=e=>0+e/(i-1)*400,y=e=>6+(g-e)/x*70;function w(e){return e.map((e,t)=>`${b(t)},${y(e)}`).join(" ")}let $=y(0);return(0,n.jsxs)(T,{children:[(0,n.jsxs)("svg",{viewBox:"0 0 400 80",preserveAspectRatio:"none",style:{width:"100%",height:"80px",display:"block",overflow:"visible"},"aria-label":o("finance.netWorth.change12m"),children:[f<0&&g>0&&(0,n.jsx)("line",{x1:0,y1:$,x2:400,y2:$,stroke:l.w4.colors.border,strokeWidth:1,strokeDasharray:"3 3"}),(0,n.jsx)("polyline",{points:w(c),fill:"none",stroke:`${u}88`,strokeWidth:1.5,strokeLinejoin:"round",strokeLinecap:"round"}),(0,n.jsx)("polyline",{points:w(d),fill:"none",stroke:`${m}88`,strokeWidth:1.5,strokeLinejoin:"round",strokeLinecap:"round"}),(0,n.jsx)("polyline",{points:w(s),fill:"none",stroke:h,strokeWidth:2,strokeLinejoin:"round",strokeLinecap:"round"}),(r=s[a=i-1],(0,n.jsx)("circle",{cx:b(a),cy:y(r),r:3,fill:h,stroke:l.w4.colors.surface,strokeWidth:1}))]}),(0,n.jsx)(S,{children:e.filter((e,t)=>0===t||t===Math.floor(i/2)||t===i-1).map(e=>(0,n.jsx)(C,{children:function(e,t){let[o,n]=e.split("-"),a=new Date(parseInt(o),parseInt(n)-1,1),r=a.toLocaleDateString("pt"===t?"pt-PT":"en-GB",{month:"short"}),i=r.charAt(0).toUpperCase()+r.slice(1).replace(".","");return 0===a.getMonth()?`${i}'${String(a.getFullYear()).slice(2)}`:i}(e.month,t)},e.month))})]})}function et({kind:e,data:t,onSave:o,onCancel:r,t:i}){let[s,l]=(0,a.useState)("");async function c(){if(!s.trim())return;let n=(0,f.addNetWorthItem)(t,{label:s.trim(),kind:e});await o(n),r()}return(0,n.jsxs)(B,{children:[(0,n.jsx)(I,{type:"text",autoFocus:!0,placeholder:i("finance.netWorth.itemName"),value:s,onChange:e=>l(e.target.value),onKeyDown:e=>{"Enter"===e.key&&c(),"Escape"===e.key&&r()},"aria-label":i("finance.netWorth.itemName")}),(0,n.jsx)(X,{type:"button",onClick:r,children:i("finance.netWorth.cancel")}),(0,n.jsx)(X,{type:"button",primary:!0,disabled:!s.trim(),onClick:()=>{c()},children:i("finance.netWorth.save")})]})}function eo({data:e,onSave:t,onClose:o,t:r}){let[i,s]=(0,a.useState)(J),[l,c]=(0,a.useState)(""),d=(0,a.useMemo)(()=>e.netWorthSnapshots[e.netWorthSnapshots.length-1],[e.netWorthSnapshots]),[p,g]=(0,a.useState)(()=>{let t={};for(let o of e.netWorthItems)t[o.id]=d?String(d.values[o.id]??""):"";return t});function u(e,t){g(o=>({...o,[e]:t}))}async function m(){let n={};for(let t of e.netWorthItems){let e=parseFloat(p[t.id]??"");!isNaN(e)&&e>=0&&(n[t.id]=e)}let a={date:i,values:n,notes:l.trim()||void 0,createdAt:Date.now()},r=(0,f.addOrUpdateSnapshot)(e,a);await t(r),o()}let h=e.netWorthItems.filter(e=>"asset"===e.kind),x=e.netWorthItems.filter(e=>"liability"===e.kind),b=e.netWorthItems.length>0;return(0,n.jsx)(P,{onClick:o,children:(0,n.jsxs)(W,{onClick:e=>e.stopPropagation(),children:[(0,n.jsx)(O,{children:r("finance.netWorth.updateSnapshot")}),(0,n.jsxs)(Y,{children:[(0,n.jsx)(K,{htmlFor:"nw-snap-date",children:r("finance.netWorth.snapshotDate")}),(0,n.jsx)(V,{id:"nw-snap-date",type:"date",value:i,onChange:e=>s(e.target.value),max:J()})]}),h.length>0&&(0,n.jsxs)(Y,{children:[(0,n.jsx)(K,{children:r("finance.netWorth.assets")}),h.map(e=>(0,n.jsxs)(U,{children:[(0,n.jsx)(q,{kind:"asset",children:e.label}),(0,n.jsx)(_,{type:"number",min:"0",step:"0.01",placeholder:"0",value:p[e.id]??"",onChange:t=>u(e.id,t.target.value),"aria-label":e.label})]},e.id))]}),x.length>0&&(0,n.jsxs)(Y,{children:[(0,n.jsx)(K,{children:r("finance.netWorth.liabilities")}),x.map(e=>(0,n.jsxs)(U,{children:[(0,n.jsx)(q,{kind:"liability",children:e.label}),(0,n.jsx)(_,{type:"number",min:"0",step:"0.01",placeholder:"0",value:p[e.id]??"",onChange:t=>u(e.id,t.target.value),"aria-label":e.label})]},e.id))]}),(0,n.jsxs)(Y,{children:[(0,n.jsx)(K,{htmlFor:"nw-snap-notes",children:r("finance.netWorth.notes")}),(0,n.jsx)(G,{id:"nw-snap-notes",placeholder:r("finance.netWorth.notes"),value:l,onChange:e=>c(e.target.value)})]}),(0,n.jsxs)(Z,{children:[(0,n.jsx)(X,{type:"button",onClick:o,children:r("finance.netWorth.cancel")}),(0,n.jsx)(X,{type:"button",primary:!0,disabled:!b||!i,onClick:()=>{m()},children:r("finance.netWorth.save")})]})]})})}function en(){let[e]=(0,c.Ym)(),t=(0,a.useMemo)(()=>(0,c.Nx)(e,g.A),[e]),{data:o,loaded:r,save:i}=(0,f.useFinance)(),[s,l]=(0,a.useState)(null),[u,m]=(0,a.useState)(!1),h=(0,a.useCallback)(async e=>{o&&((0,f.pushUndo)({id:`nw-${Date.now()}`,snapshot:o,labelKey:"finance.undo.label.edited",ts:Date.now()}),await i(e))},[o,i]);if(!r||null===o)return(0,n.jsxs)(b,{children:[(0,n.jsx)(d.YZ,{children:t("finance.netWorth.title")}),(0,n.jsx)(p.YG,{mode:"loading",label:t("loading")})]});let x=o.netWorthItems,T=o.netWorthSnapshots,S=x.filter(e=>"asset"===e.kind),C=x.filter(e=>"liability"===e.kind),R=(0,f.netWorthSeries)(T,x),B=T[T.length-1],I=B?(0,f.currentNetWorth)(B,x):null,P=async e=>{let t=(0,f.removeNetWorthItem)(o,e);(0,f.pushUndo)({id:`nw-del-${Date.now()}`,snapshot:o,labelKey:"finance.undo.label.deleted",ts:Date.now()}),await i(t)},W=0===x.length;return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsxs)(b,{children:[(0,n.jsxs)(y,{children:[(0,n.jsxs)(w,{children:[(0,n.jsx)(d.YZ,{children:t("finance.netWorth.title")}),null!==I&&(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)($,{positive:I.net>=0,children:Q(I.net,e)}),(0,n.jsx)(v,{children:t("finance.netWorth.current")})]})]}),null!==I&&(0,n.jsxs)(k,{children:[(0,n.jsxs)(M,{children:[(0,n.jsx)(j,{children:t("finance.netWorth.assets")}),(0,n.jsx)(z,{kind:"asset",children:Q(I.assets,e)})]}),(0,n.jsxs)(M,{children:[(0,n.jsx)(j,{children:t("finance.netWorth.liabilities")}),(0,n.jsx)(z,{kind:"liability",children:Q(I.liabilities,e)})]})]})]}),!W&&(0,n.jsx)(ee,{series:R,locale:e,t:t}),W&&(0,n.jsx)(p.YG,{mode:"empty",label:t("finance.netWorth.empty")}),!W&&(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(N,{}),(0,n.jsx)(F,{children:t("finance.netWorth.assets")}),S.map(e=>(0,n.jsxs)(A,{children:[(0,n.jsx)(D,{children:e.label}),(0,n.jsx)(E,{type:"button",className:"nw-delete",title:t("finance.netWorth.delete"),"aria-label":`${t("finance.netWorth.delete")} — ${e.label}`,onClick:()=>{P(e.id)},children:(0,n.jsx)(d.In,{name:"trash",size:13})})]},e.id))]}),"asset"===s?(0,n.jsx)(et,{kind:"asset",data:o,onSave:h,onCancel:()=>l(null),t:t}):(0,n.jsx)(H,{kind:"asset",type:"button",onClick:()=>l("asset"),children:t("finance.netWorth.addAsset")}),!W&&(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(N,{}),(0,n.jsx)(F,{children:t("finance.netWorth.liabilities")}),C.map(e=>(0,n.jsxs)(A,{children:[(0,n.jsx)(D,{children:e.label}),(0,n.jsx)(E,{type:"button",className:"nw-delete",title:t("finance.netWorth.delete"),"aria-label":`${t("finance.netWorth.delete")} — ${e.label}`,onClick:()=>{P(e.id)},children:(0,n.jsx)(d.In,{name:"trash",size:13})})]},e.id))]}),"liability"===s?(0,n.jsx)(et,{kind:"liability",data:o,onSave:h,onCancel:()=>l(null),t:t}):(0,n.jsx)(H,{kind:"liability",type:"button",onClick:()=>l("liability"),children:t("finance.netWorth.addLiability")}),(0,n.jsxs)(L,{type:"button",onClick:()=>m(!0),children:[(0,n.jsx)(d.In,{name:"save",size:13,"aria-hidden":!0}),t("finance.netWorth.updateSnapshot")]})]}),u&&(0,n.jsx)(eo,{data:o,onSave:h,onClose:()=>m(!1),t:t})]})}},6579(e,t,o){o.d(t,{J:()=>f,j:()=>d});var n=o(5723),a=o(7991),r=o(6859),i=o.n(r),s=o(4764),l=o(5030),c=o(2385);function d(e,t=6,o=60){let n,a=((n=new Date).setDate(n.getDate()-o),n.toISOString().slice(0,10)),r={};for(let t of e)t.date>=a&&(r[t.categoryId]=(r[t.categoryId]??0)+1);let i=[...Object.entries(r).sort(([,e],[,t])=>t-e).map(([e])=>e)];for(let e of c.DEFAULT_CATEGORIES){if(i.length>=t)break;i.includes(e.id)||i.push(e.id)}return i.slice(0,t)}let p=i().div`
  display: flex;
  gap: ${s.w4.spacing.xs};
  overflow-x: auto;
...
`;function f({expenses:e,storedOrder:t,lockedCategoryId:o,onToggle:r,locale:i,groupLabel:s}){let g=(0,a.useMemo)(()=>(t&&t.length>0?t:d(e)).map(e=>c.DEFAULT_CATEGORIES.find(t=>t.id===e)).filter(e=>void 0!==e),[t,e]);return 0===g.length?null:(0,n.jsx)(p,{role:"group","aria-label":s,children:g.map(e=>{let t=o===e.id,a=(0,c.categoryLabel)(e,i),s="pt"===i?" — selecionado":" — selected";return(0,n.jsxs)(l.vu,{variant:t?"selected":"default",dotColor:e.color,onClick:()=>r(e.id),"aria-pressed":t,"aria-label":`${a}${t?s:""}`,title:a,children:[(0,l.n6)(e.icon)?(0,n.jsx)(l.In,{name:e.icon,size:14,"aria-hidden":!0,style:{marginRight:4}}):(0,n.jsx)("span",{"aria-hidden":!0,style:{marginRight:2},children:e.icon}),a]},e.id)})})}},1789(e,t,o){o.d(t,{b:()=>Q});var n=o(5723),a=o(7991),r=o(6859),i=o.n(r),s=o(2799),l=o(4764),c=o(8170),d=o(5030),p=o(1496),f=o(2385),g=o(948),u=o(4041);let m="#7fb77e",h="#f85149",x=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,b=i().div`
  background: ${l.w4.colors.surface};
...
`,U=i().button`
  ...
  &:disabled { opacity: 0.4; cursor: not-allowed; }
  &:focus-visible { outline: 2px solid ${l.w4.colors.accent}; outline-offset: 2px; }
`;function q(e){return e.toFixed(2)}function _(e){return new Date(e).toLocaleDateString(void 0,{day:"2-digit",month:"short",year:"2-digit"})}function Z(e){let t=new Date(e),o=t.getFullYear(),n=String(t.getMonth()+1).padStart(2,"0"),a=String(t.getDate()).padStart(2,"0");return`${o}-${n}-${a}`}function X(e){return new Date(e+"T00:00:00").getTime()}function J(e){return{description:"",amount:"",categoryId:"other",cadence:"monthly",nextDueAt:Z(e),endsAt:"",memberId:""}}function Q(){let[e]=(0,c.Ym)(),t=(0,a.useMemo)(()=>(0,c.Nx)(e,g.A),[e]),{data:o,loaded:r,save:i}=(0,f.useFinance)(),[s,m]=(0,a.useState)(!1),[h,x]=(0,a.useState)(null),[Q,ee]=(0,a.useState)(()=>J(Date.now())),[et,eo]=(0,a.useState)(!1),[en,ea]=(0,a.useState)(new Set),er=(0,a.useMemo)(()=>(o?.recurringRules??[]).slice().sort((e,t)=>t.createdAt-e.createdAt),[o]),ei=(0,a.useMemo)(()=>o?(0,f.proposeRecurringRules)(o):[],[o]),es=(0,a.useCallback)(()=>{x(null),ee(J(Date.now())),m(!0),eo(!1)},[]),el=(0,a.useCallback)(e=>{x(e.id),ee({description:e.description,amount:q(e.amount),categoryId:e.categoryId,cadence:e.cadence,nextDueAt:Z(e.nextDueAt),endsAt:e.endsAt?Z(e.endsAt):"",memberId:e.memberId??""}),m(!0),eo(!1)},[]),ec=(0,a.useCallback)(()=>{m(!1),x(null)},[]),ed=(0,a.useCallback)(async()=>{if(!o)return;let e=parseFloat(Q.amount);if(!Q.description.trim()||isNaN(e)||e<=0)return;let t=Date.now(),n=Q.nextDueAt?X(Q.nextDueAt):t,a=Q.endsAt?X(Q.endsAt):void 0;if(h){let r=(o.recurringRules??[]).find(e=>e.id===h);if(!r)return;let s={...r,description:Q.description.trim(),amount:e,categoryId:Q.categoryId,cadence:Q.cadence,nextDueAt:n,endsAt:a,memberId:Q.memberId||void 0};(0,f.pushUndo)({id:(0,u.z)(),snapshot:o,labelKey:"finance.undo.label.edited",ts:t}),await i({...o,recurringRules:(o.recurringRules??[]).map(e=>e.id===s.id?s:e)})}else{let r={id:(0,u.z)(),description:Q.description.trim(),amount:e,categoryId:Q.categoryId,cadence:Q.cadence,nextDueAt:n,endsAt:a,memberId:Q.memberId||void 0,createdAt:t};(0,f.pushUndo)({id:(0,u.z)(),snapshot:o,labelKey:"finance.undo.label.added",ts:t}),await i({...o,recurringRules:[r,...o.recurringRules??[]]})}ec()},[o,Q,h,i,ec]),ep=(0,a.useCallback)(async e=>{if(!o)return;let t=Date.now();(0,f.pushUndo)({id:(0,u.z)(),snapshot:o,labelKey:"finance.undo.label.deleted",ts:t}),await i({...o,recurringRules:(o.recurringRules??[]).filter(t=>t.id!==e)})},[o,i]),ef=(0,a.useCallback)(async e=>{o&&await i({...o,recurringRules:(o.recurringRules??[]).map(t=>t.id===e?{...t,paused:!t.paused}:t)})},[o,i]),eg=(0,a.useCallback)(async()=>{let e;if(!o||0===en.size)return;let t=ei.filter(e=>en.has(e.id)),n=Date.now();(0,f.pushUndo)({id:(0,u.z)(),snapshot:o,labelKey:"finance.undo.label.added",ts:n}),await i((e=t.map(e=>({id:(0,u.z)(),description:e.merchant,amount:e.amount,categoryId:e.categoryId,cadence:e.cadence,nextDueAt:e.suggestedNextDueAt,memberId:e.memberId,createdAt:n})),{...o,recurringRules:[...e,...o.recurringRules??[]]})),ea(new Set),eo(!1)},[o,ei,en,i]),eu=(0,a.useCallback)(e=>{ea(t=>{let o=new Set(t);return o.has(e)?o.delete(e):o.add(e),o})},[]);return r?(0,n.jsxs)(b,{children:[(0,n.jsxs)(y,{children:[(0,n.jsx)(d.YZ,{children:t("finance.recurring.title")}),(0,n.jsx)(w,{children:ei.length>0&&(0,n.jsx)($,{type:"button",onClick:()=>{eo(e=>!e),m(!1)},"aria-expanded":et,children:t("finance.recurring.proposeFromHistory")})})]}),0===er.length&&!s&&(0,n.jsx)(p.YG,{mode:"empty",label:t("finance.recurring.empty")}),er.map(e=>{var o;return(0,n.jsxs)(v,{paused:e.paused,children:[(0,n.jsxs)(k,{children:[(0,n.jsx)(M,{children:e.description}),(0,n.jsxs)(j,{children:[(0,n.jsx)(d.Ex,{tone:"neutral",children:t("weekly"===(o=e.cadence)?"finance.recurring.cadence.weekly":"yearly"===o?"finance.recurring.cadence.yearly":"finance.recurring.cadence.monthly")}),(0,n.jsxs)(z,{children:[t("finance.recurring.nextDue")," ",_(e.nextDueAt)]}),e.paused&&(0,n.jsx)(d.Ex,{tone:"neutral",style:{color:"#facc15"},children:t("finance.recurring.paused")})]})]}),(0,n.jsxs)(T,{children:["€",q(e.amount)]}),(0,n.jsxs)(S,{className:"rule-actions",children:[(0,n.jsx)(C,{type:"button",title:t("finance.recurring.edit"),"aria-label":t("finance.recurring.edit"),onClick:()=>el(e),children:(0,n.jsx)(d.In,{name:"edit",size:14})}),(0,n.jsx)(C,{type:"button",title:e.paused?t("finance.recurring.resume"):t("finance.recurring.pause"),"aria-label":e.paused?t("finance.recurring.resume"):t("finance.recurring.pause"),onClick:()=>{ef(e.id)},children:(0,n.jsx)(d.In,{name:e.paused?"play":"pause",size:14})}),(0,n.jsx)(C,{type:"button",danger:!0,title:t("finance.recurring.delete"),"aria-label":t("finance.recurring.delete"),onClick:()=>{ep(e.id)},children:(0,n.jsx)(d.In,{name:"trash",size:14})})]})]},e.id)}),s&&(0,n.jsxs)(R,{children:[(0,n.jsx)(L,{children:h?t("finance.recurring.editTitle"):t("finance.recurring.newTitle")}),(0,n.jsxs)(D,{children:[(0,n.jsxs)(A,{style:{flex:2,minWidth:160},children:[(0,n.jsx)(F,{htmlFor:"rec-desc",children:t("finance.recurring.description")}),(0,n.jsx)(E,{id:"rec-desc",value:Q.description,onChange:e=>ee(t=>({...t,description:e.target.value})),placeholder:"Continente, Netflix…"})]}),(0,n.jsxs)(A,{style:{flex:1,minWidth:100},children:[(0,n.jsx)(F,{htmlFor:"rec-amount",children:t("finance.recurring.amount")}),(0,n.jsx)(E,{id:"rec-amount",type:"number",min:"0.01",step:"0.01",value:Q.amount,onChange:e=>ee(t=>({...t,amount:e.target.value})),placeholder:"12.50",style:{fontFamily:l.w4.typography.fontFamilyMono}})]})]}),(0,n.jsxs)(D,{children:[(0,n.jsxs)(A,{style:{flex:1,minWidth:120},children:[(0,n.jsx)(F,{htmlFor:"rec-cadence",children:t("finance.recurring.frequency")}),(0,n.jsxs)(B,{id:"rec-cadence",value:Q.cadence,onChange:e=>ee(t=>({...t,cadence:e.target.value})),children:[(0,n.jsx)("option",{value:"weekly",children:t("finance.recurring.cadence.weekly")}),(0,n.jsx)("option",{value:"monthly",children:t("finance.recurring.cadence.monthly")}),(0,n.jsx)("option",{value:"yearly",children:t("finance.recurring.cadence.yearly")})]})]}),(0,n.jsxs)(A,{style:{flex:1,minWidth:120},children:[(0,n.jsx)(F,{htmlFor:"rec-category",children:t("finance.recurring.category")}),(0,n.jsx)(B,{id:"rec-category",value:Q.categoryId,onChange:e=>ee(t=>({...t,categoryId:e.target.value})),children:f.DEFAULT_CATEGORIES.map(t=>(0,n.jsx)("option",{value:t.id,children:(0,f.categoryLabel)(t,e)},t.id))})]})]}),(0,n.jsxs)(D,{children:[(0,n.jsxs)(A,{style:{flex:1,minWidth:120},children:[(0,n.jsx)(F,{htmlFor:"rec-nextdue",children:t("finance.recurring.nextDue")}),(0,n.jsx)(E,{id:"rec-nextdue",type:"date",value:Q.nextDueAt,onChange:e=>ee(t=>({...t,nextDueAt:e.target.value}))})]}),(0,n.jsxs)(A,{style:{flex:1,minWidth:120},children:[(0,n.jsx)(F,{htmlFor:"rec-endsat",children:t("finance.recurring.endsAt")}),(0,n.jsx)(E,{id:"rec-endsat",type:"date",value:Q.endsAt,onChange:e=>ee(t=>({...t,endsAt:e.target.value}))})]})]}),(0,n.jsxs)(I,{children:[(0,n.jsx)(H,{type:"button",onClick:ec,children:t("finance.recurring.cancel")}),(0,n.jsx)(H,{type:"button",primary:!0,onClick:()=>{ed()},disabled:!Q.description.trim()||!parseFloat(Q.amount),children:t("finance.recurring.save")})]})]}),!s&&(0,n.jsxs)(N,{type:"button",onClick:es,children:[(0,n.jsx)(d.In,{name:"plus",size:14}),t("finance.recurring.addRule")]}),et&&(0,n.jsxs)(P,{children:[(0,n.jsx)(L,{children:t("finance.recurring.proposeTitle")}),0===ei.length?(0,n.jsx)(p.YG,{mode:"empty",label:t("finance.recurring.proposeEmpty")}):(0,n.jsxs)(n.Fragment,{children:[ei.map(e=>(0,n.jsxs)(W,{children:[(0,n.jsx)(O,{type:"checkbox",id:`prop-${e.id}`,checked:en.has(e.id),onChange:()=>eu(e.id)}),(0,n.jsxs)(Y,{children:[(0,n.jsx)(K,{children:e.merchant}),(0,n.jsxs)(V,{children:[(0,n.jsx)(z,{children:t("finance.recurring.occurrences",{n:e.occurrences})}),(0,n.jsx)(z,{children:t("finance.recurring.lastSeen",{date:_(e.lastSeen)})})]})]}),(0,n.jsxs)(G,{children:["€",q(e.amount)]})]},e.id)),(0,n.jsxs)(U,{type:"button",disabled:0===en.size,onClick:()=>{eg()},children:[t("finance.recurring.accept")," (",en.size,")"]})]})]})]}):(0,n.jsxs)(b,{children:[(0,n.jsx)(d.YZ,{children:t("finance.recurring.title")}),(0,n.jsx)(p.YG,{mode:"loading",label:t("loading")})]})}},1423(e,t,o){o.d(t,{p:()=>M});var n=o(5723),a=o(7991),r=o(6859),i=o.n(r),s=o(2799),l=o(4764),c=o(5030),d=o(2385);let p=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,f=i().div`
  display: flex;
...
`,k=i().div`
  ...
  color: ${l.w4.colors.mainTextMuted};
  padding: ${l.w4.spacing.xs} 0;
`;function M({expenses:e,familyMembers:t,getMemberColor:o,t:r,locale:i}){let[s,p]=(0,a.useState)(null),j=(0,a.useMemo)(()=>(0,d.pendingByMember)(e),[e]),z=(0,a.useMemo)(()=>{let t={};for(let o of e){if(!o.isReimbursable||o.reimbursed)continue;let e=o.childId??"shared";t[e]||(t[e]=[]),t[e].push(o)}return t},[e]);return 0===j.length?(0,n.jsx)(k,{children:r("finance.reimbursables.empty")}):(0,n.jsx)(f,{children:j.map(({memberId:e,count:a,total:d})=>{let f="shared"===e,k=t.find(t=>t.id===e),M=t.findIndex(t=>t.id===e),j=k?o(k,M):l.w4.colors.mainTextMuted,T=k?.name??r("finance.income.member.shared"),S=s===e,C=z[e]??[];return(0,n.jsxs)("div",{children:[(0,n.jsxs)(g,{type:"button",expanded:S,onClick:()=>p(S?null:e),"aria-expanded":S,"aria-label":`${T} — ${a} — €${d.toFixed(2)}`,children:[f?(0,n.jsx)(c.In,{name:"users",size:16,color:j}):k?(0,n.jsx)(c.eu,{member:{id:k.id,name:k.name,role:k.role,color:j},size:18}):(0,n.jsx)(c.In,{name:"user",size:16,color:j}),(0,n.jsx)(u,{style:{color:j},children:T}),(0,n.jsx)(m,{children:a}),(0,n.jsxs)(h,{children:["€",d.toLocaleString("pt-PT",{minimumFractionDigits:2,maximumFractionDigits:2})]}),(0,n.jsx)(x,{expanded:S,"aria-hidden":"true",children:(0,n.jsx)(c.In,{name:"chevron-right",size:14,color:l.w4.colors.mainTextMuted})})]}),S&&(0,n.jsx)(b,{children:C.slice().sort((e,t)=>t.date.localeCompare(e.date)).map(e=>(0,n.jsxs)(y,{children:[(0,n.jsx)(w,{children:function(e,t){let[o,n,a]=e.split("-").map(Number);return new Date(o,n-1,a).toLocaleDateString("pt"===t?"pt-PT":"en-GB",{day:"2-digit",month:"2-digit"})}(e.date,i)}),(0,n.jsx)($,{title:e.description,children:e.description}),(0,n.jsxs)(v,{children:["€",e.amount.toFixed(2)]})]},e.id))})]},e)})})}},5854(e,t,o){o.d(t,{m:()=>M});var n=o(5723),a=o(7991),r=o(2727),i=o.n(r),s=o(6859),l=o.n(s),c=o(2799),d=o(4764),p=o(5030);let f=(0,c.keyframes)`
...
`,k=[{key:"n",descKey:"finance.shortcuts.newExpense"},{key:"/",descKey:"finance.shortcuts.search"},{key:"m",descKey:"finance.shortcuts.changeMember"},{key:"g",descKey:"finance.shortcuts.goToMonth"},{key:"?",descKey:"finance.shortcuts.openOverlay"},{key:"Esc",descKey:"finance.shortcuts.close"}];function M({t:e,onClose:t}){let o=(0,a.useRef)(null);return(0,a.useEffect)(()=>{let e=e=>{"Escape"===e.key&&(e.preventDefault(),e.stopPropagation(),t())};return document.addEventListener("keydown",e,!0),()=>document.removeEventListener("keydown",e,!0)},[t]),(0,a.useEffect)(()=>{o.current?.querySelector("[data-autofocus]")?.focus()},[]),i().createPortal((0,n.jsx)(g,{role:"dialog","aria-modal":"true","aria-label":e("finance.shortcuts.title"),onClick:e=>{e.target===e.currentTarget&&t()},children:(0,n.jsxs)(u,{ref:o,children:[(0,n.jsxs)(m,{children:[(0,n.jsx)(h,{children:e("finance.shortcuts.title")}),(0,n.jsx)(x,{onClick:t,"aria-label":e("finance.shortcuts.closeBtn"),"data-autofocus":"",children:"\xd7"})]}),(0,n.jsx)(v,{}),(0,n.jsx)(b,{children:k.map(({key:t,descKey:o})=>(0,n.jsxs)(y,{children:[(0,n.jsx)(w,{children:e(o)}),(0,n.jsx)($,{children:(0,n.jsx)(p.ue,{children:t})})]},t))}),(0,n.jsx)(v,{}),(0,n.jsx)("div",{style:{fontSize:11,fontFamily:d.w4.typography.fontFamilyMono,color:d.w4.colors.mainTextMuted,textTransform:"uppercase",letterSpacing:"0.12em"},children:e("finance.shortcuts.note")})]})}),document.body)}},7737(e,t,o){o.d(t,{n:()=>S});var n=o(5723),a=o(7991),r=o(6859),i=o.n(r),s=o(2799),l=o(4764),c=o(8170),d=o(5030),p=o(1496),f=o(2385),g=o(948);let u=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,m=i().div`
  background: ${l.w4.colors.surface};
...
`;function j(e){return e.toFixed(2)}function z(e){return 7===e?"finance.subs.cadence.weekly":365===e?"finance.subs.cadence.yearly":"finance.subs.cadence.monthly"}function T(e){return e.amount*(30/e.cadenceDays)}function S(){let[e]=(0,c.Ym)(),t=(0,a.useMemo)(()=>(0,c.Nx)(e,g.A),[e]),{candidates:o,monthlyTotal:r,cancelCandidates:i,loaded:s}=(0,f.useSubscriptions)();if(!s)return(0,n.jsxs)(m,{children:[(0,n.jsx)(d.YZ,{children:t("finance.subs.title")}),(0,n.jsx)(p.YG,{mode:"loading",label:t("loading")})]});if(0===o.length)return(0,n.jsxs)(m,{children:[(0,n.jsx)(d.YZ,{children:t("finance.subs.title")}),(0,n.jsx)(p.YG,{mode:"empty",label:t("finance.subs.empty")})]});let u=o.filter(e=>e.staleDays<=60).sort((e,t)=>T(t)-T(e)).slice(0,5);return(0,n.jsxs)(m,{children:[(0,n.jsxs)(h,{children:[(0,n.jsxs)("div",{children:[(0,n.jsx)(d.YZ,{children:t("finance.subs.title")}),(0,n.jsx)(b,{children:t("finance.subs.monthlyTotal")})]}),(0,n.jsxs)(x,{children:["€",j(r)]})]}),u.length>0&&(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(y,{children:t("finance.subs.activeHeader")}),u.map(e=>(0,n.jsx)(p.$8,{label:e.description,sub:(0,n.jsx)(d.Ex,{tone:"neutral",children:t(z(e.cadenceDays))}),value:(0,n.jsxs)(v,{children:["€",j(T(e)),(0,n.jsx)("span",{style:{fontSize:10,color:l.w4.colors.mainTextMuted},children:"/mo"})]})},e.id))]}),i.length>0&&(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(M,{}),(0,n.jsx)(w,{children:t("finance.subs.staleHeader")}),i.slice(0,5).map(e=>(0,n.jsx)(p.$8,{label:e.description,sub:(0,n.jsx)(d.Ex,{tone:"neutral",children:t(z(e.cadenceDays))}),value:(0,n.jsxs)($,{children:[(0,n.jsx)(k,{children:t("finance.subs.staleDays",{n:e.staleDays})}),(0,n.jsxs)(v,{children:["€",j(e.amount)]})]})},e.id))]})]})}},9546(e,t,o){o.d(t,{S:()=>m});var n=o(5723),a=o(7991),r=o(6859),i=o.n(r),s=o(2799),l=o(4764);let c=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(12px); }
  to   { opacity: 1; transform: translateY(0); }
`,d=(0,s.keyframes)`
...
`,b=r().forwardRef(function({variant:e="ghost",size:t="md",icon:o,iconRight:a,children:r,...i},s){return(0,n.jsxs)(x,{ref:s,variant:e,size:t,...i,children:[o,r,a]})}),y={default:l.w4.colors.accent,danger:"#f85149"},w={default:l.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"},$=s().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`,v=r().forwardRef(function({active:e=!1,shape:t="square",tone:o="default",children:a,...r},i){return(0,n.jsx)($,{ref:i,active:e,shape:t,tone:o,...r,children:a})}),k=s().div`
  position: relative;
  display: inline-flex;
`,M=s().div`
  position: absolute;
...
`,B=s().span`
  ...
  line-height: 1;
  letter-spacing: 0;
`,I=["#3b82f6","#8b5cf6","#ec4899","#10b981","#f59e0b","#06b6d4"],H=0,N=new Map;function L({member:e,size:t=24}){var o,a;let r,i="shared"===e.id||"shared"===e.role,s=Math.floor(.55*t),c=t<=18?8:t<=22?9:t<=28?11:12;if(i)return(0,n.jsx)(E,{size:t,bg:l.w4.colors.surface,ring:!0,"aria-label":"Shared",title:"Shared",style:{color:l.w4.colors.mainTextMuted},children:(0,n.jsx)(D,{name:"home",size:s,"aria-hidden":!0})});let d=(o=e.id,(a=e.color)?a:(!N.has(o)&&(N.set(o,I[H%I.length]),H++),N.get(o))),p="adult"===e.role,f=(r=e.name.trim().split(/\s+/),((r[0]?.[0]??"")+(r[1]?.[0]??"")).toUpperCase().slice(0,2));return(0,n.jsx)(E,{size:t,bg:d,ring:p,title:e.name,children:(0,n.jsx)(B,{fontSize:c,children:f})})}s().img`
  width: ${({size:e})=>e}px;
  height: ${({size:e})=>e}px;
  border-radius: 50%;
  object-fit: cover;
...
`,Y=s().span`
  ...
  background: ${({color:e})=>e};
  display: inline-block;
`,K=r().forwardRef(function({variant:e="default",dotColor:t,children:o,onClick:a,...r},i){return(0,n.jsxs)(O,{ref:i,variant:e,clickable:!!a,onClick:a,type:r.type??"button",...r,children:[t&&(0,n.jsx)(Y,{color:t}),o]})}),V={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:l.w4.colors.accentMuted},G={neutral:l.w4.colors.mainTextMuted,live:l.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:l.w4.colors.accent},U=s().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${l.w4.typography.fontFamilyMono};
...
`,q=s().span`
  ...
  display: inline-block;
`;function _({tone:e="neutral",dot:t,children:o,...a}){return(0,n.jsxs)(U,{tone:e,...a,children:[(t??"live"===e)&&(0,n.jsx)(q,{}),o]})}let Z=s().kbd`
  font-family: ${l.w4.typography.fontFamilyMono};
  font-size: 10px;
  padding: 2px 6px;
  border: 1px solid ${l.w4.colors.border};
  ...
  white-space: nowrap;
`;function X({children:e,...t}){return(0,n.jsx)(Z,{...t,children:e})}let J=s().div`
  font-family: ${l.w4.typography.fontFamilyMono};
  font-size: 11px;
  letter-spacing: 0.16em;
  text-transform: uppercase;
  ...
  align-items: center;
  gap: 8px;
`;function Q({children:e,...t}){return(0,n.jsx)(J,{...t,children:e})}s().label`
  display: flex;
  align-items: center;
  gap: 10px;
...
`;function ei({title:e,accessory:t,accentColor:o,error:a,errorLabel:r,children:i}){return(0,n.jsxs)(ee,{accentColor:o,"data-widget-shell":!0,children:[(0,n.jsxs)(et,{children:[(0,n.jsx)(Q,{children:e}),t&&(0,n.jsx)(eo,{children:t})]}),a?(0,n.jsxs)(ea,{role:"alert",children:[(0,n.jsx)(er,{children:r??"Error"}),(0,n.jsx)("div",{children:a})]}):(0,n.jsx)(en,{children:i})]})}s().div`
  position: relative;
  display: flex;
  flex-direction: column;
  height: 100%;
...
`;function eM({size:e}){return(0,n.jsxs)("svg",{width:14,height:14,viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:[(0,n.jsx)("rect",{x:1.5,y:4.5,width:11,height:5,rx:1,stroke:"currentColor",strokeWidth:1,opacity:.4}),(0,n.jsx)("rect",{x:2,y:5,width:"sm"===e?4:"md"===e?7:11,height:4,rx:.5,fill:"currentColor"})]})}let ej={sm:1,md:2,lg:"full"};function ez({items:e,onReorder:t,onCycleSize:o,onRemove:a,renderPanel:r,renderAccessory:i,showGrip:s=!0,labels:l,accentColor:c}){return(0,n.jsx)(ex,{children:e.map((d,p)=>{let f=ej[d.size],g="full"===f,u=d.minHeight??160,m=c?.(d),h=(d.availableSizes??["sm","md","lg"]).length>1,x=i?.(d);return(0,n.jsxs)(eb,{colSpan:g?1:f,fullWidth:g,children:[x&&(0,n.jsx)(ey,{children:x}),(0,n.jsxs)(ew,{minH:u,accent:m,"data-grip":s?"true":"false",children:[(0,n.jsxs)(e$,{className:"panel-controls",children:[p>0&&(0,n.jsx)(ev,{type:"button",title:l.moveLeft,onClick:()=>t(d.id,-1),children:(0,n.jsx)(D,{name:"chevron-left",size:14})}),p<e.length-1&&(0,n.jsx)(ev,{type:"button",title:l.moveRight,onClick:()=>t(d.id,1),children:(0,n.jsx)(D,{name:"chevron-right",size:14})}),h&&(0,n.jsx)(ev,{type:"button",title:`${l.cycleSize} \xb7 ${d.size.toUpperCase()}`,onClick:()=>o(d.id),children:(0,n.jsx)(eM,{size:d.size})}),a&&l.remove&&(0,n.jsx)(ek,{type:"button",title:l.remove,onClick:()=>a(d.id),children:(0,n.jsx)(D,{name:"close",size:14})})]}),r(d)]})]},d.id)})})}let eT=(0,C.keyframes)`
...
`,s().div`
  position: relative;
`},2188(e,t,o){o.d(t,{OW:()=>g,$8:()=>v,ik:()=>M,Xj:()=>I,Ru:()=>m,kl:()=>A,RT:()=>R,RJ:()=>z,YG:()=>p});var n=o(5723),a=o(6859),r=o.n(a),i=o(4764);let s=r().div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
`,c=r().p`
  ...
  margin: 0;
  line-height: 1.5;
`,d={loading:"◌ Loading",empty:"◎ Empty",error:"◎ Offline"};function p({mode:e,label:t,body:o}){return(0,n.jsxs)(s,{children:[(0,n.jsx)(l,{mode:e,children:t??d[e]}),o&&(0,n.jsx)(c,{children:o})]})}var f=o(7991);function g({points:e,accent:t=i.w4.colors.accent,width:o=60,height:a=28,strokeWidth:r=1.5}){let s=(0,f.useMemo)(()=>{if(e.length<2)return"";let t=Math.min(...e),n=Math.max(...e)-t||1,i=o-2*r,s=a-2*r;return e.map((o,a)=>{let l=r+a/(e.length-1)*i,c=r+s-(o-t)/n*s;return`${0===a?"M":"L"} ${l.toFixed(1)} ${c.toFixed(1)}`}).join(" ")},[e,o,a,r]),l=(0,f.useMemo)(()=>{if(e.length<1)return null;let t=e[e.length-1],n=Math.min(...e),i=o-2*r,s=a-2*r;return{x:r+i,y:r+s-(t-n)/(Math.max(...e)-n||1)*s}},[e,o,a,r]);return s?(0,n.jsxs)("svg",{width:o,height:a,viewBox:`0 0 ${o} ${a}`,"aria-hidden":"true",style:{display:"block",flexShrink:0},children:[(0,n.jsx)("path",{d:s,fill:"none",stroke:t,strokeWidth:r,strokeLinecap:"round",strokeLinejoin:"round",opacity:.7}),l&&(0,n.jsx)("circle",{cx:l.x,cy:l.y,r:r+1,fill:t})]}):null}let u=r().span`
  font-family: ${i.w4.typography.fontFamilyMono};
  font-size: 11px;
  font-weight: 500;
  font-variant-numeric: tabular-nums;
  ...
  white-space: nowrap;
`;function m({value:e,format:t="pct",decimals:o=2}){let a=e>0?"pos":e<0?"neg":"zero",r=Math.abs(e).toFixed(o);return(0,n.jsxs)(u,{sign:a,children:["pos"===a?"▲":"neg"===a?"▼":"—"," ",r,"pct"===t?"%":""]})}let h=r().div`
  display: flex;
  align-items: baseline;
  justify-content: space-between;
  gap: ${i.w4.spacing.sm};
...
`,$=r().span`
  ...
  flex-shrink: 0;
  text-align: right;
`;function v({label:e,value:t,sub:o,href:a,onClick:r}){let i=(0,n.jsxs)(n.Fragment,{children:[(0,n.jsxs)(b,{children:[(0,n.jsx)(y,{children:e}),o&&(0,n.jsx)(w,{children:o})]}),void 0!==t&&(0,n.jsx)($,{children:t})]});return a?(0,n.jsx)(x,{href:a,target:"_blank",rel:"noopener noreferrer",children:i}):(0,n.jsx)(h,{onClick:r,children:i})}o(3090);let k="'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, monospace";function M({data:e,budget:t,height:o=200,animation:a="rise"}){let r=(0,f.useId)();if(!e.length)return null;let s=1.1*Math.max(...e.map(e=>e.segments.reduce((e,t)=>e+t.value,0)+(e.over??0)),t??0)||1,l=472,c=o-20-24,d=472/e.length*.58,p=l/e.length,g="rise"===a?{transformOrigin:"bottom",animation:`${r}_rise 0.45s ease-out both`}:{};return(0,n.jsxs)(n.Fragment,{children:["rise"===a&&(0,n.jsx)("style",{children:`
          @keyframes ${r}_rise {
            from { transform: scaleY(0); }
            to   { transform: scaleY(1); }
          }
        `}),(0,n.jsxs)("svg",{viewBox:`0 0 520 ${o}`,style:{width:"100%",height:o},preserveAspectRatio:"xMidYMid meet","aria-hidden":"true",children:[null!=t?(0,n.jsxs)("g",{children:[(0,n.jsx)("line",{x1:40,x2:40+l,y1:20+c-t/s*c,y2:20+c-t/s*c,stroke:i.w4.colors.border,strokeDasharray:"3 3",strokeWidth:"1"}),(0,n.jsxs)("text",{x:36,y:20+c-t/s*c+3,textAnchor:"end",fontFamily:k,fontSize:"9",fill:i.w4.colors.mainTextMuted,children:["€",t]})]}):null,e.map((e,t)=>{let a,r=40+t*p+(p-d)/2,l=20+c;return(0,n.jsxs)("g",{style:g,children:[e.segments.map(e=>{let t=e.value/s*c;return l-=t,(0,n.jsx)("rect",{x:r,y:l,width:d,height:t,fill:e.color,opacity:.85},e.id)}),null!=e.over&&e.over>0?(a=e.over/s*c,l-=a,(0,n.jsx)("rect",{x:r,y:l,width:d,height:a,fill:"#f85149",opacity:.7},"over")):null,(0,n.jsx)("text",{x:r+d/2,y:o-6,textAnchor:"middle",fontFamily:k,fontSize:"10",fill:i.w4.colors.mainTextMuted,children:e.label})]},e.label)})]})]})}let j="'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, monospace";function z({data:e,total:t,size:o=110,thickness:a=14,centerLabel:r,centerValue:s}){let l=(0,f.useId)(),c=o/2-a/2-2,d=2*Math.PI*c,p=e.reduce((e,t)=>e+t.value,0)||1,g=0;return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)("style",{children:`
        @keyframes ${l}_dash {
          from { stroke-dasharray: 0 ${d.toFixed(1)}; }
        }
      `}),(0,n.jsxs)("svg",{viewBox:`0 0 ${o} ${o}`,style:{width:o,height:o,flexShrink:0},"aria-hidden":"true",children:[(0,n.jsx)("circle",{cx:o/2,cy:o/2,r:c,fill:"none",stroke:i.w4.colors.border,strokeWidth:a}),e.map((e,t)=>{let r=e.value/p*d,i=60*t,s=(0,n.jsx)("circle",{cx:o/2,cy:o/2,r:c,fill:"none",stroke:e.color,strokeWidth:a,strokeDasharray:`${r.toFixed(1)} ${d.toFixed(1)}`,strokeDashoffset:(-g).toFixed(1),transform:`rotate(-90 ${o/2} ${o/2})`,style:{animation:`${l}_dash 0.45s ease-out ${i}ms both`}},t);return g+=r,s}),r?(0,n.jsx)("text",{x:o/2,y:o/2-4,textAnchor:"middle",fontFamily:j,fontSize:"9",fill:i.w4.colors.mainTextMuted,letterSpacing:"0.12em",textDecoration:"none",children:r.toUpperCase()}):null,s?(0,n.jsx)("text",{x:o/2,y:r?o/2+11:o/2+4,textAnchor:"middle",fontFamily:j,fontSize:"13",fontWeight:"700",fill:i.w4.colors.mainText,children:s}):null]})]})}let T=["#1a2420","#2a4535","#4a7a5a","#6fa77a","#7fb77e"],S=["S","T","Q","Q","S","S","D"],C=["S","M","T","W","T","F","S"];function R({data:e,cellSize:t=10,gap:o=2,locale:a="pt",tooltip:r}){let s=(0,f.useId)();if(!e.length)return null;let l=24+Math.ceil(e.length/7)*(t+o),c=14+7*(t+o);return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)("style",{children:`
        @keyframes ${s}_fade { from { opacity: 0; } to { opacity: 1; } }
      `}),(0,n.jsxs)("svg",{viewBox:`0 0 ${l} ${c}`,preserveAspectRatio:"xMidYMid meet",style:{width:"100%",height:"auto",maxHeight:220,display:"block"},"aria-hidden":"true",children:[(0,n.jsx)("g",{fontFamily:"'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, monospace",fontSize:"8",fill:i.w4.colors.mainTextMuted,children:("pt"===a?S:C).map((e,a)=>(0,n.jsx)("text",{x:"0",y:10+a*(t+o),children:e},a))}),e.map((e,a)=>{let i=18+Math.floor(a/7)*(t+o),l=2+a%7*(t+o),c=T[Math.max(0,Math.min(4,e))]??T[0],d=r?.(a,e);return(0,n.jsx)("rect",{x:i,y:l,width:t,height:t,fill:c,rx:"1",style:{animation:`${s}_fade 0.3s ease-out ${8*a}ms both`},children:d?(0,n.jsx)("title",{children:d}):null},a)})]})]})}function F(e){let t=0;for(let o=1;o<e.length;o++){let n=e[o][0]-e[o-1][0],a=e[o][1]-e[o-1][1];t+=Math.sqrt(n*n+a*a)}return t}function A({spent:e,budget:t,height:o=60}){let a=(0,f.useId)(),r=1.05*t||1,s=Array.from({length:8},(e,o)=>t-t/7*o),l=Math.min(e/(t||1),1),c=Array.from({length:8},(e,o)=>Math.max(0,t-o/7*t*l*1.1)),d=s.map((e,t)=>[320*t/7,o-e/r*(o-5)]),p=c.map((e,t)=>[320*t/7,o-e/r*(o-5)]),g=d.map(e=>e.join(",")).join(" "),u=p.map(e=>e.join(",")).join(" "),m=F(d).toFixed(1),h=F(p).toFixed(1);return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)("style",{children:`
        @keyframes ${a}_i { from { stroke-dashoffset: ${m}; } }
        @keyframes ${a}_a { from { stroke-dashoffset: ${h}; } }
      `}),(0,n.jsxs)("svg",{viewBox:`0 0 320 ${o}`,style:{width:"100%",height:o},preserveAspectRatio:"none","aria-hidden":"true",children:[(0,n.jsx)("line",{x1:"0",x2:320,y1:o-5,y2:o-5,stroke:i.w4.colors.border,strokeDasharray:"3 3",strokeWidth:"1"}),(0,n.jsx)("polyline",{points:g,stroke:i.w4.colors.mainTextMuted,strokeWidth:"1",strokeDasharray:`${m} ${m}`,strokeDashoffset:"0",fill:"none",style:{strokeDasharray:"2 3",animation:`${a}_i 0.45s ease-out both`}}),(0,n.jsx)("polyline",{points:u,stroke:"#7fb77e",strokeWidth:"1.5",strokeDasharray:`${h} ${h}`,strokeDashoffset:"0",fill:"none",strokeLinecap:"round",style:{animation:`${a}_a 0.45s ease-out 0.08s both`}})]})]})}let D=r().div`
  position: relative;
  height: 6px;
...
`,B=r().div`
  ...
  opacity: 0.7;
  transition: width 400ms ease;
`;function I({pct:e,over:t=0,color:o="#7fb77e"}){let a=Math.min(100,e),r=100-t;return(0,n.jsxs)(D,{children:[(0,n.jsx)(E,{pct:a,color:o}),t>0&&(0,n.jsx)(B,{left:Math.max(0,r),width:t})]})}o(5030),r().button`
  display: inline-flex;
  align-items: center;
  gap: 6px;
  padding: 0 10px;
...
`,r().span`
  ...
  font-variant-numeric: tabular-nums;
  color: ${i.w4.colors.mainTextMuted};
`},3090(e,t,o){o.d(t,{B:()=>a});var n=o(2385);function a(e){let t=(0,n.cacheBackedProducer)({id:e.id,category:e.category,cacheKey:e.cacheKey,parse:e.parse});return{id:e.id,category:e.category,labelKey:e.labelKey,defaultEnabled:e.defaultEnabled,producer:t,start(){},stop(){}}}},7517(e,t,o){o.d(t,{A:()=>n});let n={id:"habits",load:()=>Promise.all([o.e("44"),o.e("45")]).then(o.bind(o,6780)).then(e=>({default:e.HabitsWidget})),labels:{en:"Habits Grid",pt:"Grelha de H\xe1bitos"},descriptions:{en:"Your last 7 days of missions",pt:"Os teus \xfaltimas 7 dias de miss\xf5es"},icon:"\uD83C\uDFAF",accentColor:"#fb923c",defaultSize:"sm",defaultCols:1,maxCols:2,minHeight:200,suite:"vida",defaultOnDashboard:!0,sources:[{id:"daily-progress",kind:"bll-hook",cacheKey:"daily:progress",labelKey:"sources.dailyProgress"}],notifications:[{id:"daily",category:"daily.overdue",labelKey:"notifications.source.daily",producer:(0,o(2385).dailyProducer)({category:"daily.overdue"}),start(){},stop(){}}],persistedKeys:["daily:progress"]}},2013(e,t,o){o.d(t,{A:()=>r});var n=o(9927),a=o(2385);let r={id:"hackernews-hot",load:()=>Promise.all([o.e("44"),o.e("390")]).then(o.bind(o,3565)).then(e=>({default:e.HackerNewsHotWidget})),labels:{en:"Hacker News Hot",pt:"Em Alta no HN"},descriptions:{en:"Top stories from Hacker News",pt:"Hist\xf3rias em destaque no Hacker News"},icon:"\uD83D\uDD25",accentColor:"#f97316",defaultSize:"sm",defaultCols:1,maxCols:1,minHeight:200,suite:"learn",defaultOnDashboard:!1,sources:[{id:"hn-firebase",kind:"dal-client",cacheKey:"internet-hn-ids",labelKey:"sources.hackerNews",notifiable:!0}],notifications:[{id:"hn-front-page",category:"hn.frontPage",labelKey:"notifications.source.hnFrontPage",producer:{id:"hn-front-page",category:"hn.frontPage",async poll(){if((0,a.isMutedNow)("hn.frontPage"))return[];let e=await (0,n.fetchHnFrontPage)(5);if(!e?.hits)return[];let t=[];for(let o of e.hits){let e=o.created_at_i??(o.created_at?Date.parse(o.created_at)/1e3:NaN);Number.isFinite(e)&&t.push({id:`hn-front:${o.objectID}`,category:"hn.frontPage",ts:1e3*e,title:o.title,link:o.url??`https://news.ycombinator.com/item?id=${o.objectID}`,meta:{points:o.points,comments:o.num_comments}})}return t}},start(){},stop(){}}],persistedKeys:["widget-cache:internet-hn-ids"]}},1496(e,t,o){o.d(t,{OW:()=>n.OW,$8:()=>n.$8,ik:()=>n.ik,Xj:()=>n.Xj,Ru:()=>n.Ru,kl:()=>n.kl,RT:()=>n.RT,RJ:()=>n.RJ,YG:()=>n.YG}),o(7517),o(2013),o(9603),o(2026),o(5471),o(5417),o(4200),o(2306),o(9780);var n=o(2188);o(5723),o(7991);var a=o(6859),r=o.n(a),i=o(2799),s=o(4764);o(5030),o(8170);let l=(0,i.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to { opacity: 1; transform: translateY(0); }
`;r().div`
  display: grid;
...
`,r().div`
  ...
  text-align: center;
  line-height: 1.5;
`},9603(e,t,o){o.d(t,{A:()=>i});var n=o(2385),a=o(3090);function r(e){return function(t){if(!t?.items)return[];let o=[];return t.items.forEach(t=>{let a=Date.parse(t.pubDate);if(Number.isNaN(a)||(0,n.classifyPtNewsItem)(t.title,t.description)!==e)return;let r=t.link||t.title;o.push({id:`news-pt-${e}:${r}`,ts:a,title:t.title,link:t.link})}),o}}let i={id:"news-pt",load:()=>Promise.all([o.e("44"),o.e("392")]).then(o.bind(o,1507)).then(e=>({default:e.NewsPortugalWidget})),labels:{en:"PT News",pt:"Not\xedcias PT"},descriptions:{en:"Latest news from RTP",pt:"\xdaltimas not\xedcias da RTP"},icon:"\uD83D\uDCF0",accentColor:"#2da44e",defaultSize:"sm",defaultCols:1,maxCols:1,minHeight:200,suite:"vida",defaultOnDashboard:!1,sources:[{id:"rtp-rss",kind:"cache-key",cacheKey:"news-portugal",labelKey:"sources.rtp",notifiable:!0}],notifications:[(0,a.B)({id:"news-pt-tech",category:"news.pt.tech",labelKey:"notifications.source.newsPtTech",badgeColor:"#a371f7",cacheKey:"news-portugal",parse:r("tech")}),(0,a.B)({id:"news-pt-sports",category:"news.pt.sports",labelKey:"notifications.source.newsPtSports",badgeColor:"#3fb950",cacheKey:"news-portugal",parse:r("sports")}),(0,a.B)({id:"news-pt-business",category:"news.pt.business",labelKey:"notifications.source.newsPtBusiness",badgeColor:"#d29922",cacheKey:"news-portugal",parse:r("business")}),(0,a.B)({id:"news-pt-general",category:"news.pt.general",labelKey:"notifications.source.newsPtGeneral",badgeColor:"#2da44e",cacheKey:"news-portugal",parse:r("general")})],persistedKeys:["widget-cache:news-portugal"]}},2026(e,t,o){o.d(t,{A:()=>n});let n={id:"news-world",load:()=>Promise.all([o.e("44"),o.e("566")]).then(o.bind(o,4925)).then(e=>({default:e.NewsWorldWidget})),labels:{en:"World News",pt:"Not\xedcias Mundo"},descriptions:{en:"Latest news from CNN",pt:"\xdaltimas not\xedcias da CNN"},icon:"\uD83C\uDF0D",accentColor:"#cc0000",defaultSize:"sm",defaultCols:1,maxCols:1,minHeight:200,suite:"vida",defaultOnDashboard:!1,sources:[{id:"cnn-rss",kind:"cache-key",cacheKey:"news-world",labelKey:"sources.cnn",notifiable:!0}],notifications:[(0,o(3090).B)({id:"news-world",category:"news.world",labelKey:"notifications.source.newsWorld",badgeColor:"#cc0000",cacheKey:"news-world",parse:function(e){if(!e?.items)return[];let t=[];return e.items.forEach((e,o)=>{let n=Date.parse(e.pubDate);Number.isNaN(n)||t.push({id:`${n}-${o}`,ts:n,title:e.title,link:e.link})}),t}})],persistedKeys:["widget-cache:news-world"]}},5471(e,t,o){o.d(t,{A:()=>a});var n=o(3090);let a={id:"seismic",load:()=>Promise.all([o.e("44"),o.e("773")]).then(o.bind(o,8108)).then(e=>({default:e.SeismicWidget})),labels:{en:"PT Seismic",pt:"Sismicidade PT"},descriptions:{en:"Recent seismic activity in Portugal",pt:"Atividade s\xedsmica recente em Portugal"},icon:"\uD83C\uDF0B",accentColor:"#f97316",defaultSize:"sm",defaultCols:1,maxCols:1,minHeight:200,suite:"vida",defaultOnDashboard:!1,sources:[{id:"ipma",kind:"dal-client",cacheKey:"seismic-pt",labelKey:"sources.ipma",notifiable:!0},{id:"usgs",kind:"dal-client",cacheKey:"seismic-world",labelKey:"sources.usgs",notifiable:!0}],notifications:[(0,n.B)({id:"seismic-pt",category:"seismic.pt",labelKey:"notifications.source.seismicPt",badgeColor:"#f97316",cacheKey:"seismic-pt",parse:function(e){if(!Array.isArray(e))return[];let t=[];return e.forEach((e,o)=>{let n=Date.parse(e.time);if(Number.isNaN(n))return;let a=e.local||e.obsRegion||"?";t.push({id:`pt-${n}-${o}`,ts:n,title:`M ${e.mag.toFixed(1)} — ${a}`})}),t}}),(0,n.B)({id:"seismic-world",category:"seismic.world",labelKey:"notifications.source.seismicWorld",badgeColor:"#ea580c",cacheKey:"seismic-world",parse:function(e){return e?.features?e.features.map(e=>({id:e.id,ts:e.properties.time,title:`M ${e.properties.mag.toFixed(1)} — ${e.properties.place}`,link:e.properties.url})):[]}})],persistedKeys:["widget-cache:seismic-pt","widget-cache:seismic-world"]}},5417(e,t,o){o.d(t,{A:()=>r});var n=o(9927),a=o(2385);let r={id:"techscope",load:()=>Promise.all([o.e("44"),o.e("923")]).then(o.bind(o,4942)).then(e=>({default:e.TechScopeLiveWidget})),labels:{en:"TechScope Live",pt:"TechScope Ao Vivo"},descriptions:{en:"Trending GitHub repos and Hacker News stories",pt:"Reposit\xf3rios GitHub e hist\xf3rias do Hacker News em alta"},icon:"⚡",accentColor:"#a371f7",defaultSize:"lg",defaultCols:2,maxCols:2,minHeight:240,suite:"learn",defaultOnDashboard:!0,sources:[{id:"github-trending",kind:"cache-key",cacheKey:"techscope-gh",labelKey:"sources.github",notifiable:!0},{id:"hn-algolia",kind:"cache-key",cacheKey:"techscope-hn",labelKey:"sources.hackerNews",notifiable:!0}],notifications:[{id:"github-trending",category:"github.trending",labelKey:"notifications.source.githubTrending",producer:{id:"github-trending",category:"github.trending",async poll(){if((0,a.isMutedNow)("github.trending"))return[];let e=await (0,n.fetchTrendingRepos)({days:7,perPage:5});if(!e?.items)return[];let t=[];for(let o of e.items){let e=o.created_at?Date.parse(o.created_at):NaN;if(!Number.isFinite(e))continue;let n=o.stargazers_count,a=o.language?` \xb7 ${o.language}`:"";t.push({id:`gh-trending:${o.id}`,category:"github.trending",ts:e,title:`${o.full_name} — ${n.toLocaleString()}★${a}`,link:o.html_url,meta:{stars:n,language:o.language,description:o.description}})}return t}},start(){},stop(){}},{id:"devto-weekly",category:"devto.weekly",labelKey:"notifications.source.devto",producer:{id:"devto-weekly",category:"devto.weekly",async poll(){if((0,a.isMutedNow)("devto.weekly"))return[];let e=await (0,n.fetchDevToArticles)({top:7,perPage:5});if(!e)return[];let t=[];for(let o of e){let e=Date.parse(o.published_at);if(!Number.isFinite(e))continue;let n=o.public_reactions_count??0,a=o.user?.name||o.user?.username,r=a?` — ${a}`:"";t.push({id:`devto:${o.id}`,category:"devto.weekly",ts:e,title:`${o.title}${r}`,link:o.url,meta:{reactions:n,comments:o.comments_count??0,readingTime:o.reading_time_minutes??null,tags:o.tag_list??[]}})}return t}},start(){},stop(){}}],persistedKeys:["widget-cache:techscope-gh","widget-cache:techscope-hn"]}},4200(e,t,o){o.d(t,{A:()=>n});let n={id:"trending-searches",load:()=>Promise.all([o.e("44"),o.e("346")]).then(o.bind(o,2065)).then(e=>({default:e.TrendingSearchesWidget})),labels:{en:"Trending Searches",pt:"Pesquisas em Alta"},descriptions:{en:"Top Google trending searches right now",pt:"As pesquisas mais populares no Google agora"},icon:"\uD83D\uDD0D",accentColor:"#e233ff",defaultSize:"sm",defaultCols:1,maxCols:1,minHeight:200,suite:"learn",defaultOnDashboard:!1,sources:[{id:"google-trends-rss",kind:"cache-key",cacheKey:"internet-trends",labelKey:"sources.googleTrends",notifiable:!0}],notifications:[(0,o(3090).B)({id:"trending-daily",category:"trending.daily",labelKey:"notifications.source.trending",badgeColor:"#e233ff",cacheKey:"internet-trends",parse:function(e){let t=e?.items?.[0];return t?[{id:new Date().toISOString().slice(0,10),ts:Date.now(),title:t.title,link:t.link}]:[]},defaultEnabled:!1})],persistedKeys:["widget-cache:internet-trends"]}},2306(e,t,o){o.d(t,{A:()=>i});var n=o(3090);let a={yellow:"\uD83D\uDFE1",orange:"\uD83D\uDFE0",red:"\uD83D\uDD34"},r={yellow:"Yellow",orange:"Orange",red:"Red"},i={id:"weather",load:()=>Promise.all([o.e("44"),o.e("693")]).then(o.bind(o,5940)).then(e=>({default:e.WeatherWidget})),labels:{en:"Weather",pt:"Meteorologia"},descriptions:{en:"Current weather for Lisbon",pt:"Meteorologia atual em Lisboa"},icon:"\uD83C\uDF24️",accentColor:"#58a6ff",defaultSize:"sm",defaultCols:1,maxCols:1,minHeight:280,suite:"vida",defaultOnDashboard:!0,sources:[{id:"openMeteo",kind:"cache-key",cacheKey:"weather-lisbon",labelKey:"sources.openMeteo",notifiable:!0}],notifications:[(0,n.B)({id:"ipma-warnings",category:"weather.pt.warnings",labelKey:"notifications.source.weatherPt",badgeColor:"#facc15",cacheKey:"ipma-warnings",parse:function(e){if(!Array.isArray(e))return[];let t=Date.now(),o=[];return e.forEach((e,n)=>{if("green"===e.awarenessLevelID||"yellow"===e.awarenessLevelID)return;let i=Date.parse(e.endTime);if(Number.isNaN(i)||i<t)return;let s=Date.parse(e.startTime);if(Number.isNaN(s))return;let l=e.awarenessLevelID,c=a[l]??"⚠",d=r[l]??e.awarenessLevelID.toUpperCase(),p=e.idAreaAviso||"Portugal",f=e.awarenessTypeName?e.awarenessTypeName.toLowerCase():"weather";o.push({id:`ipma-warn:${p}-${s}-${n}`,ts:s,title:`${c} ${d} ${f} warning — ${p}`,link:"https://www.ipma.pt/en/otempo/prev-sam/"})}),o}})]}},9780(e,t,o){o.d(t,{A:()=>i});var n=o(3090);let a=new Set(["Main_Page","Special:Search","Wikipedia:Featured_pictures","-","Special:Watchlist","Portal:Current_events"]);function r(){return new Date(Date.now()-864e5).toISOString().slice(0,10)}let i={id:"wiki-most-read",load:()=>Promise.all([o.e("44"),o.e("545")]).then(o.bind(o,5464)).then(e=>({default:e.WikiMostReadWidget})),labels:{en:"Wikipedia Top",pt:"Mais Lido na Wikip\xe9dia"},descriptions:{en:"Most read articles on Wikipedia today",pt:"Artigos mais lidos na Wikip\xe9dia hoje"},icon:"\uD83D\uDCD6",accentColor:"#58a6ff",defaultSize:"sm",defaultCols:1,maxCols:1,minHeight:200,suite:"learn",defaultOnDashboard:!1,sources:[{id:"wikipedia-pageviews",kind:"cache-key",labelKey:"sources.wikipedia",notifiable:!0}],notifications:[(0,n.B)({id:"wiki-top-read",category:"wiki.topRead",labelKey:"notifications.source.wikiTopRead",badgeColor:"#58a6ff",cacheKey:()=>`internet-wiki-${r()}`,parse:function(e){let t=(e?.items?.[0]?.articles??[]).find(e=>!a.has(e.article));if(!t)return[];let o=r(),n=t.article.replace(/_/g," ");return[{id:o,ts:Date.now(),title:n,link:`https://en.wikipedia.org/wiki/${encodeURIComponent(t.article)}`}]},defaultEnabled:!1})]}}}]);