"use strict";(self.webpackChunk_atlantis_school=self.webpackChunk_atlantis_school||[]).push([["3390"],{61318(e,a,o){o.d(a,{WO:()=>aN});var i=o(65723),n=o(37991),t=o(29336),r=o(36859),l=o.n(r),s=o(17681),c=o(69753),d=o(88641),m=o(41783);function p(e){try{return JSON.parse(localStorage.getItem(e)??"[]")}catch{return[]}}let u=l().nav`padding: ${t.w4.spacing.sm} 0;`,g=l().div`
...
`,w=l().div`overflow: hidden;`,z=l().div`
  display: flex;
  align-items: center;
...
`;function k({title:e,icon:a,entries:o,activeId:t,onSelect:r,favorites:l,onToggleFav:s,collapsed:m}){let[p,u]=(0,n.useState)(!1);return o.length?(0,i.jsxs)(g,{children:[(0,i.jsxs)(f,{collapsed:m,onClick:()=>{m||u(e=>!e)},children:[(0,i.jsxs)(y,{collapsed:m,children:[a,(0,i.jsx)(h,{collapsed:m,children:e})]}),(0,i.jsx)(x,{open:p,collapsed:m,children:(0,i.jsx)(c.A,{size:12})})]}),(0,i.jsx)(b,{open:p&&!m,children:(0,i.jsx)(w,{children:o.map(e=>{let a=l.some(a=>a.id===e.id);return(0,i.jsxs)(z,{children:[(0,i.jsx)($,{active:t===e.id,onClick:()=>r(e),children:e.name}),(0,i.jsx)(v,{active:a,title:a?"Remover dos favoritos":"Adicionar aos favoritos",onClick:a=>{a.stopPropagation(),s(e)},children:(0,i.jsx)(d.A,{size:12,fill:a?"currentColor":"none"})})]},e.id)})})})]}):null}function A({config:e,activeId:a,onSelect:o,hashPrefix:r}){let l=`atlantis-recent-${r}`,s=`atlantis-fav-${r}`,{collapsed:c}=(0,t.cL)(),[g,f]=(0,n.useState)(()=>p(l)),[y,h]=(0,n.useState)(()=>p(s)),x=(0,n.useCallback)(e=>{e.file&&f(a=>{let o;return o=[e,...a.filter(a=>a.id!==e.id)].slice(0,10),localStorage.setItem(l,JSON.stringify(o)),o}),o(e)},[o,l]),b=(0,n.useCallback)(e=>{h(a=>{let o;return o=a.some(a=>a.id===e.id)?a.filter(a=>a.id!==e.id):[...a,e],localStorage.setItem(s,JSON.stringify(o)),o})},[s]);return(0,i.jsxs)(u,{children:[(0,i.jsx)(k,{title:"Recentes",icon:(0,i.jsx)(m.A,{size:13}),entries:g,activeId:a,onSelect:x,favorites:y,onToggleFav:b,collapsed:c}),(0,i.jsx)(k,{title:"Favoritos",icon:(0,i.jsx)(d.A,{size:13}),entries:y,activeId:a,onSelect:x,favorites:y,onToggleFav:b,collapsed:c}),(0,i.jsx)(t.CD,{entries:e.entries,activeId:a,onSelect:x})]})}var j=o(11352),S=o(76710),M=o(66225),T=o(302),C=o(73639),B=o(8411),E=o(4311);let P=l().div`
...
`,R=!1;function L(e){if("u"<typeof window)return e;let a=e.match(/^var\((--[-\w]+)\)$/);return a&&getComputedStyle(document.documentElement).getPropertyValue(a[1]).trim()||e}function O({code:e}){let a=(0,n.useRef)(null),[r,l]=(0,n.useState)(null),[s,c]=(0,n.useState)(!1);return((0,n.useEffect)(()=>{let i=!1;if(l(null),c(!1),!e.trim())return void c(!0);let n=e.trim().split(/\r?\n/)[0]?.trim()??"";return/^(?:---[\s\S]*?---\s*)?(?:graph|flowchart|sequenceDiagram|classDiagram|stateDiagram(?:-v2)?|erDiagram|pie|gantt|journey|mindmap|gitGraph|sankey(?:-beta)?|quadrantChart|requirementDiagram|timeline|xychart-beta|block-beta|C4Context|C4Container|C4Component|C4Dynamic|C4Deployment)\b/.test(n)?(async function(){let n=(await o.e("6087").then(o.bind(o,29738))).default;if(R||(n.initialize({startOnLoad:!1,theme:"dark",themeVariables:{background:L(t.w4.colors.codeBg),primaryColor:L(t.w4.colors.accent),primaryTextColor:L(t.w4.colors.mainText),lineColor:L(t.w4.colors.border)}}),R=!0),a.current&&!i)try{let o=`mermaid-${Math.random().toString(36).slice(2)}`,{svg:t}=await n.render(o,e);if(i||!a.current)return;if(/aria-roledescription="error"|class="error-icon"|>Syntax error/i.test(t))return void c(!0);a.current.innerHTML=t,requestAnimationFrame(()=>{if(i||!a.current)return;let e=a.current.querySelector("svg");if(!e)return void c(!0);let o=e.getBoundingClientRect();(o.width<40||o.height<40)&&c(!0)})}catch(e){i||l(e instanceof Error?e.message:String(e))}}(),()=>{i=!0}):void c(!0)},[e]),r||s)?(0,i.jsx)(F,{children:e.trim()}):(0,i.jsx)(P,{ref:a})}let N=["#388bfd","#3fb950","#d29922","#a371f7","#f87171","#22d3ee","#fb923c","#34d399","#f472b6","#818cf8"],D=l().div`
  background: ${t.w4.colors.codeBg};
  border: 1px solid ${t.w4.colors.codeBorder};
  border-radius: ${t.w4.borderRadius.md};
  padding: ${t.w4.spacing.lg};
...
`,eo=l().div`
  ...
  color: ${t.w4.colors.mainText};
  text-align: center;
`;function ei(e){return e.toString().padStart(2,"0")}function en({hours:e,minutes:a,seconds:o}){let n=e=>e*Math.PI/180,r=o/60*360-90,l=a/60*360+o/60*6-90,s=e%12/12*360+a/60*30-90,c=100+61*Math.cos(n(r)),d=100+61*Math.sin(n(r)),m=100+65*Math.cos(n(l)),p=100+65*Math.sin(n(l)),u=100+45*Math.cos(n(s)),g=100+45*Math.sin(n(s));return(0,i.jsxs)("svg",{viewBox:"0 0 200 200",width:200,height:200,children:[(0,i.jsx)("circle",{cx:100,cy:100,r:85,fill:t.w4.colors.surface,stroke:t.w4.colors.border,strokeWidth:2}),Array.from({length:12},(e,a)=>{let o=a+1,r=o/12*360-90,l=100+69*Math.cos(n(r)),s=100+69*Math.sin(n(r));return(0,i.jsx)("text",{x:l,y:s+4,fill:t.w4.colors.mainText,fontSize:14,fontWeight:600,textAnchor:"middle",fontFamily:t.w4.typography.fontFamily,children:o},o)}),Array.from({length:60},(e,a)=>{let o=a/60*360-90,r=a%5==0,l=r?75:79;return(0,i.jsx)("line",{x1:100+l*Math.cos(n(o)),y1:100+l*Math.sin(n(o)),x2:100+83*Math.cos(n(o)),y2:100+83*Math.sin(n(o)),stroke:r?t.w4.colors.mainTextMuted:t.w4.colors.border,strokeWidth:r?2:1},a)}),(0,i.jsx)("line",{x1:100,y1:100,x2:u,y2:g,stroke:t.w4.colors.mainText,strokeWidth:4,strokeLinecap:"round"}),(0,i.jsx)("line",{x1:100,y1:100,x2:m,y2:p,stroke:t.w4.colors.accent,strokeWidth:2.5,strokeLinecap:"round"}),(0,i.jsx)("line",{x1:100-12*Math.cos(n(r)),y1:100-12*Math.sin(n(r)),x2:c,y2:d,stroke:"#f87171",strokeWidth:1.2,strokeLinecap:"round"}),(0,i.jsx)("circle",{cx:100,cy:100,r:4,fill:t.w4.colors.accent}),(0,i.jsx)("circle",{cx:100,cy:100,r:2,fill:"#f87171"})]})}function et({code:e}){let a=function(e){let a="pt";for(let o of e.trim().split("\n")){let[e,...i]=o.split(":"),n=i.join(":").trim();"locale"===e.trim().toLowerCase()&&(a=n.toLowerCase())}return{locale:a}}(e),[o,t]=(0,n.useState)("live"),[r,l]=(0,n.useState)(()=>new Date().getHours()),[s,c]=(0,n.useState)(()=>new Date().getMinutes()),[d,m]=(0,n.useState)(()=>new Date().getSeconds());(0,n.useEffect)(()=>{if("live"!==o)return;let e=()=>{let e=new Date;l(e.getHours()),c(e.getMinutes()),m(e.getSeconds())};e();let a=setInterval(e,1e3);return()=>clearInterval(a)},[o]);let p=(0,n.useCallback)(e=>{t("manual"),m(0),l(a=>((a+e)%24+24)%24)},[]),u=(0,n.useCallback)(e=>{t("manual"),m(0),c(a=>((a+e)%60+60)%60)},[]),g=(0,n.useCallback)(()=>t("live"),[]);return(0,i.jsxs)(q,{children:[(0,i.jsxs)(Z,{children:[(0,i.jsx)(en,{hours:r,minutes:s,seconds:d}),(0,i.jsxs)("div",{children:[(0,i.jsxs)(X,{children:[ei(r),":",ei(s),(0,i.jsxs)("span",{style:{fontSize:"24px",opacity:.5},children:[":",ei(d)]})]}),(0,i.jsx)(eo,{children:function(e,a,o){if("pt"===o){let o=1===e?"1 hora":`${e} horas`;return 0===a?o:15===a?`${o} e um quarto`:30===a?`${o} e meia`:45===a?`um quarto para as ${12===e?1:e+1}`:`${o} e ${a} minutos`}let i=e<12?"AM":"PM",n=e%12||12;return 0===a?`${n} o'clock ${i}`:15===a?`quarter past ${n} ${i}`:30===a?`half past ${n} ${i}`:45===a?`quarter to ${n%12+1} ${i}`:`${n}:${ei(a)} ${i}`}(r%12||12,s,a.locale)})]})]}),(0,i.jsxs)(Q,{children:[(0,i.jsx)(ee,{onClick:()=>p(-1),children:"−1h"}),(0,i.jsx)(ee,{onClick:()=>p(1),children:"+1h"}),(0,i.jsx)(ee,{onClick:()=>u(-15),children:"−15m"}),(0,i.jsx)(ee,{onClick:()=>u(15),children:"+15m"}),(0,i.jsx)(ee,{onClick:()=>u(-5),children:"−5m"}),(0,i.jsx)(ee,{onClick:()=>u(5),children:"+5m"}),(0,i.jsx)(ee,{active:"live"===o,onClick:g,children:"pt"===a.locale?"Agora":"Now"})]}),(0,i.jsx)(ea,{children:"pt"===a.locale?"Usa os bot\xf5es para mudar as horas e os minutos!":"Use the buttons to change the hours and minutes!"}),(0,i.jsx)(Q,{children:[{label:"3:00",h:3,m:0},{label:"6:30",h:6,m:30},{label:"9:15",h:9,m:15},{label:"12:00",h:12,m:0},{label:"13:45",h:13,m:45},{label:"15:30",h:15,m:30},{label:"19:00",h:19,m:0},{label:"23:15",h:23,m:15}].map(e=>(0,i.jsx)(ee,{onClick:()=>{t("manual"),l(e.h),c(e.m)},children:e.label},e.label))})]})}var er=o(72799),el=o(41604);let es=["Samantha","Karen","Daniel","Moira","Rishi","Google UK English Female","Google US English"],ec=["Joana","Luciana","Catarina","Google portugu\xeas do Brasil"];function ed(e,a){if(!window.speechSynthesis)return;window.speechSynthesis.cancel();let o=new SpeechSynthesisUtterance(e);o.lang="pt"===a?"pt-PT":"en-US",o.rate=1,o.pitch=1;let i=function(e,a){let o="en"===a?"en":"pt";for(let i of"en"===a?es:ec){let a=e.find(e=>e.name.includes(i)&&e.lang.startsWith(o));if(a)return a}return e.find(e=>e.lang.startsWith(o))}(window.speechSynthesis.getVoices(),a);i&&(o.voice=i,o.lang=i.lang),window.speechSynthesis.speak(o)}let em=(0,er.keyframes)`
...
`,ez=l().span`
  font-size: ${t.w4.typography.fontSizeBase};
  color: ${t.w4.colors.mainTextMuted};
`;function e$({code:e}){let a=e.split("\n").map(e=>e.trim()).filter(e=>e&&e.includes("|")).map(e=>{let[a,o]=e.split("|").map(e=>e.trim());return{en:a??"",pt:o??""}}).filter(e=>e.en&&e.pt),o=(0,n.useRef)(null),t=(0,n.useRef)(!1),r=(0,n.useCallback)(e=>{o.current={x:e.touches[0].clientX,y:e.touches[0].clientY}},[]),l=(0,n.useCallback)((e,a)=>i=>{if(!o.current)return;let n=Math.abs(i.changedTouches[0].clientX-o.current.x),r=Math.abs(i.changedTouches[0].clientY-o.current.y);o.current=null,n>8||r>8||(t.current=!0,ed(e,a))},[]),s=(0,n.useCallback)((e,a)=>()=>{if(t.current){t.current=!1;return}ed(e,a)},[]);return a.length?(0,i.jsxs)(ep,{children:[(0,i.jsxs)(eu,{children:[(0,i.jsx)(el.A,{size:12}),"Words to Listen / Palavras para Ouvir"]}),(0,i.jsx)(eg,{children:a.map(e=>(0,i.jsxs)(ef,{children:[(0,i.jsxs)(eh,{accentColor:"#58a6ff",onTouchStart:r,onTouchEnd:l(e.en,"en"),onClick:s(e.en,"en"),title:`Listen: ${e.en}`,children:[(0,i.jsx)(eb,{accentColor:"#58a6ff",children:(0,i.jsx)(el.A,{size:16})}),(0,i.jsx)(ew,{children:e.en})]}),(0,i.jsxs)(ex,{accentColor:"#3fb950",onTouchStart:r,onTouchEnd:l(e.pt,"pt"),onClick:s(e.pt,"pt"),title:`Ouvir: ${e.pt}`,children:[(0,i.jsx)(eb,{accentColor:"#3fb950",children:(0,i.jsx)(el.A,{size:16})}),(0,i.jsx)(ez,{children:e.pt})]})]},e.en))})]}):null}var ev=o(17223),ek=o(21426),eA=o(25609),ej=o(20320);let eS=l().div`
  margin: ${t.w4.spacing.lg} 0;
  border-radius: ${t.w4.borderRadius.md};
  border: 1px solid ${t.w4.colors.codeBorder};
  overflow: hidden;
...
`,eB={...ek.A,'pre[class*="language-"]':{...ek.A['pre[class*="language-"]'],background:t.w4.colors.codeBg,margin:0,padding:"18px 20px",fontSize:"13px",lineHeight:"1.6",borderRadius:0},'code[class*="language-"]':{...ek.A['code[class*="language-"]'],background:"none",fontSize:"13px"}};function eE({lang:e="text",code:a}){let[o,r]=(0,n.useState)(!1);return(0,i.jsxs)(eS,{children:[(0,i.jsxs)(eM,{children:[(0,i.jsx)(eT,{children:e}),(0,i.jsxs)(eC,{copied:o,onClick:()=>{navigator.clipboard.writeText(a).then(()=>{r(!0),setTimeout(()=>r(!1),2e3)})},children:[o?(0,i.jsx)(eA.A,{size:12}):(0,i.jsx)(ej.A,{size:12}),o?"Copied!":"Copy"]})]}),(0,i.jsx)(ev.A,{language:e,style:eB,showLineNumbers:a.split("\n").length>8,lineNumberStyle:{color:"#484f58",minWidth:"2.5em",paddingRight:"1.5em",userSelect:"none",fontSize:"12px"},customStyle:{margin:0,background:t.w4.colors.codeBg},wrapLongLines:!1,children:a})]})}var eP=o(65569),eF=o(8218),eR=o(57230),eL=o(22966),eO=o(21069);let eN={NOTE:{bg:"rgba(88, 166, 255, 0.08)",border:"#58a6ff",icon:eP.A,label:"Note",color:"#58a6ff"},TIP:{bg:"rgba(63, 185, 80, 0.08)",border:"#3fb950",icon:eF.A,label:"Tip",color:"#3fb950"},IMPORTANT:{bg:"rgba(163, 113, 247, 0.08)",border:"#a371f7",icon:eR.A,label:"Important",color:"#a371f7"},WARNING:{bg:"rgba(210, 153, 34, 0.08)",border:"#d29922",icon:eL.A,label:"Warning",color:"#d29922"},CAUTION:{bg:"rgba(248, 81, 73, 0.08)",border:"#f85149",icon:eO.A,label:"Caution",color:"#f85149"}},eD=l().div`
  background: ${({bg:e})=>e};
...
`;function eG({type:e,children:a}){let o=eN[e]??eN.NOTE,n=o.icon;return(0,i.jsxs)(eD,{bg:o.bg,border:o.border,children:[(0,i.jsxs)(eI,{color:o.color,children:[(0,i.jsx)(n,{size:15,strokeWidth:2}),o.label]}),(0,i.jsx)(eH,{children:a})]})}let eW=l().nav`
  width: 220px;
  min-width: 220px;
...
`,eY=l().div`
  ...
  font-family: ${t.w4.typography.fontFamily};
  margin-bottom: ${t.w4.spacing.md};
`,eV=l().ul`list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 2px;`,eK=l().a`
  display: block;
  padding: 4px 8px;
...
`;function e_({headings:e,activeId:a}){return e.length<2?null:(0,i.jsxs)(eW,{children:[(0,i.jsx)(eY,{children:"On this page"}),(0,i.jsx)(eV,{children:e.map(e=>(0,i.jsx)("li",{children:(0,i.jsx)(eK,{href:`#${e.id}`,active:a===e.id,level:e.level,onClick:a=>{a.preventDefault(),document.getElementById(e.id)?.scrollIntoView({behavior:"smooth",block:"start"})},children:e.text})},e.id))})]})}function eJ(e){return e.toLowerCase().replace(/[*_`[\]()#]/g,"").replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-").trim()}function eU(){return e=>{!function e(a){if("blockquote"===a.type){let e=a.children?.[0];if(e?.type==="paragraph"){let o=e.children?.[0];if(o?.type==="text"){let i=o.value?.match(/^\[!(NOTE|TIP|WARNING|CAUTION|IMPORTANT)\]\s*/i);i&&(o.value=o.value.slice(i[0].length),o.value.trim()||1!==e.children.length||a.children.shift(),a.data=a.data??{},a.data.hName="div",a.data.hProperties={"data-callout":i[1].toUpperCase()})}}}a.children?.forEach(e)}(e)}}let eq=l().div`
  display: flex;
...
`,eZ=l().div`flex: 1; min-width: 0;`,eX=l().article`
...
`,e2=l().div`
  ...
  font-family: ${t.w4.typography.fontFamily};
`;function e3(e){return function({children:a,...o}){let t=`h${e}`,r=function e(a){return n.Children.toArray(a).map(a=>"string"==typeof a?a:"number"==typeof a?String(a):(0,n.isValidElement)(a)?e(a.props.children??""):"").join("")}(a),l=eJ(r);return(0,i.jsxs)(t,{id:l,...o,children:[a,(0,i.jsx)("a",{className:"heading-anchor",href:`#${l}`,"aria-label":`Link to "${r}"`,children:(0,i.jsx)(M.A,{size:14})})]})}}function e5({file:e,prevEntry:a,nextEntry:t,onNavigate:r,scrollToId:l,onScrolled:s}){let[d,m]=(0,n.useState)(null),[p,u]=(0,n.useState)(null),g=(0,n.useRef)(null);if((0,n.useEffect)(()=>{m(null),fetch(`${o.p}content/${e}`).then(e=>{if(!e.ok)throw Error(`${e.status} ${e.statusText}`);return e.text()}).then(m).catch(a=>m(`> **Error loading \`${e}\`:** ${a.message}`))},[e]),(0,n.useEffect)(()=>{if(!l||!d||!g.current)return;let e=setTimeout(()=>{let e=g.current?.querySelector(`#${CSS.escape(l)}`);e&&(e.scrollIntoView({behavior:"smooth",block:"start"}),u(l),s?.())},150);return()=>clearTimeout(e)},[l,d,s]),(0,n.useEffect)(()=>{if(!d||!g.current)return;let e=g.current,a=Array.from(e.querySelectorAll("h2[id], h3[id]"));if(!a.length)return;let o=e.parentElement;for(;o;){let{overflowY:e}=getComputedStyle(o);if(("auto"===e||"scroll"===e)&&o.scrollHeight>o.clientHeight)break;o=o.parentElement}let i=o??window,n=()=>{let e=a[0].id;for(let o of a)if(o.getBoundingClientRect().top-120<=0)e=o.id;else break;u(e)};return n(),i.addEventListener("scroll",n,{passive:!0}),window.addEventListener("resize",n),()=>{i.removeEventListener("scroll",n),window.removeEventListener("resize",n)}},[d]),null===d)return(0,i.jsx)(e2,{children:"Loading…"});let f=function(e){let a,o=[],i=/^(#{2,3})\s+(.+)$/gm;for(;null!==(a=i.exec(e));){let e=a[1].length,i=a[2].trim().replace(/\*\*(.+?)\*\*/g,"$1").replace(/\*(.+?)\*/g,"$1").replace(/`(.+?)`/g,"$1").replace(/\[(.+?)\]\(.+?\)/g,"$1");o.push({level:e,text:i,id:eJ(i)})}return o}(d),y=a||t;return(0,i.jsxs)(eq,{children:[(0,i.jsxs)(eZ,{children:[(0,i.jsx)(eX,{ref:g,children:(0,i.jsx)(j.oz,{remarkPlugins:[S.A,E.A,eU],rehypePlugins:[C.A,B.A],components:{div({node:e,children:a,...o}){let n=o["data-callout"];return n?(0,i.jsx)(eG,{type:n,children:a}):(0,i.jsx)("div",{...o,children:a})},h1:e3(1),h2:e3(2),h3:e3(3),h4:e3(4),pre:({children:e})=>(0,i.jsx)(i.Fragment,{children:e}),code({className:e,children:a}){let o=/language-(\w+)/.exec(e??"")?.[1],n=String(a).replace(/\n$/,"");return"mermaid"===o?(0,i.jsx)(O,{code:n}):"chart"===o?(0,i.jsx)(U,{code:n}):"clock"===o?(0,i.jsx)(et,{code:n}):"vocabulary"===o?(0,i.jsx)(e$,{code:n}):o||n.includes("\n")?(0,i.jsx)(eE,{lang:o,code:n}):(0,i.jsx)("code",{className:e,children:a})}},children:d})}),y&&(0,i.jsxs)(eQ,{children:[a?(0,i.jsxs)(e0,{align:"left",onClick:()=>r?.(a),children:[(0,i.jsxs)(e1,{children:[(0,i.jsx)(T.A,{size:13})," Previous"]}),(0,i.jsx)(e4,{children:a.name})]}):(0,i.jsx)("div",{style:{flex:1}}),t?(0,i.jsxs)(e0,{align:"right",onClick:()=>r?.(t),children:[(0,i.jsxs)(e1,{children:["Next ",(0,i.jsx)(c.A,{size:13})]}),(0,i.jsx)(e4,{children:t.name})]}):(0,i.jsx)("div",{style:{flex:1}})]})]}),(0,i.jsx)(e_,{headings:f,activeId:p})]})}var e6=o(24525),e8=o(87071),e9=o(35751),e7=o(32887);let ae=(0,er.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,aa=(0,er.keyframes)`
...
`,aw=l().div`
  ...
  font-size: ${t.w4.typography.fontSizeSm};
  text-align: center;
`,az=new Map;async function a$(e){let a=az.get(e);if(void 0!==a)return a;try{let a=await fetch(`${o.p}content/${e}`);if(!a.ok)return"";let i=await a.text();return az.set(e,i),i}catch{return az.set(e,""),""}}function av(e){return e.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,"")}function ak({open:e,onClose:a,entries:o,activeId:r,onSelect:l}){let[c,d]=(0,n.useState)(""),[m,p]=(0,n.useState)([]),[u,g]=(0,n.useState)(!1),[f,y]=(0,n.useState)(0),h=(0,n.useRef)(null),x=(0,n.useRef)(),b=(0,n.useMemo)(()=>(function e(a,o=""){return a.flatMap(a=>a.children?e(a.children,a.name):a.file?[{entry:a,parentName:o}]:[])})(o),[o]);(0,n.useEffect)(()=>{e&&(d(""),p([]),y(0),setTimeout(()=>h.current?.focus(),50))},[e]),(0,n.useEffect)(()=>{if(!e)return;let o=e=>{"Escape"===e.key&&(e.preventDefault(),a())};return window.addEventListener("keydown",o),()=>window.removeEventListener("keydown",o)},[e,a]);let w=(0,n.useCallback)(async e=>{if(e.length<2){p([]),g(!1);return}g(!0);let a=await Promise.all(b.map(async({entry:e,parentName:a})=>{let o=await a$(e.file);return{entry:e,parentName:a,text:o}})),o=[];for(let{entry:i,parentName:n,text:t}of a){let a=av(i.name),r=av(t),l=av(e);if(!a.includes(l)&&!r.includes(l))continue;let{snippet:s,count:c,headingSlug:d,headingText:m}=function(e,a){let o=av(e),i=av(a),n=e.split("\n"),t=0,r=0;for(;-1!==(r=o.indexOf(i,r));)t++,r+=i.length;let l=null;for(let e of n){let o=e.match(/^#{1,4}\s+(.+)/);if(o&&(l=o[1].trim()),!e.trim()||e.startsWith("```")||e.startsWith("|--"))continue;let n=e.replace(/^#{1,6}\s*/,"").replace(/[*_`|]/g,"").trim(),r=n.normalize("NFD"),s=[],c=0;for(let e=0;e<r.length;e++){let a=r.charCodeAt(e);(!(a>=768)||!(a<=879))&&(s.push(c),c++)}s.push(c);let d=av(n).indexOf(i);if(-1===d)continue;let m=s[d]??d,p=s[d+i.length]??m+a.length,u=Math.max(0,m-50),g=Math.min(n.length,p+70),f=u>0?"…":"",y=g<n.length?"…":"",h=n.slice(u,m),x=n.slice(m,p),b=n.slice(p,g);return{snippet:`${f}${h}<mark>${x}</mark>${b}${y}`,count:t,headingSlug:l?l.toLowerCase().replace(/[*_`[\]()#]/g,"").replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-").trim():null,headingText:l}}return{snippet:"",count:t,headingSlug:null,headingText:null}}(t,e),p=a.includes(l);o.push({entry:i,parentName:n,snippet:s||(p?i.name:""),matchCount:c+10*!!p,headingSlug:d,headingText:m})}o.sort((e,a)=>a.matchCount-e.matchCount),p(o),y(0),g(!1)},[b]);(0,n.useEffect)(()=>(clearTimeout(x.current),c.trim())?(x.current=setTimeout(()=>w(c.trim()),250),()=>clearTimeout(x.current)):void p([]),[c,w]);let z=(0,n.useCallback)(e=>{"ArrowDown"===e.key?(e.preventDefault(),y(e=>Math.min(e+1,m.length-1))):"ArrowUp"===e.key?(e.preventDefault(),y(e=>Math.max(e-1,0))):"Enter"===e.key&&m[f]&&(e.preventDefault(),l(m[f].entry,m[f].headingSlug),a())},[m,f,l,a]);return e?(0,i.jsx)(ao,{onClick:e=>{e.target===e.currentTarget&&a()},children:(0,i.jsxs)(ai,{onKeyDown:z,children:[(0,i.jsxs)(an,{children:[(0,i.jsx)(s.A,{size:18,color:t.w4.colors.accent,style:{flexShrink:0}}),(0,i.jsx)(at,{ref:h,placeholder:"Pesquisar em todo o conte\xfado…",value:c,onChange:e=>d(e.target.value)}),(0,i.jsx)(ar,{onClick:a,title:"Fechar (Esc)",children:(0,i.jsx)(e6.A,{size:14})})]}),(0,i.jsxs)(al,{children:[u&&(0,i.jsxs)(as,{children:[(0,i.jsx)(ac,{children:(0,i.jsx)(e8.A,{size:14})}),"A pesquisar ",b.length," ficheiros…"]}),!u&&c.length>=2&&m.length>0&&(0,i.jsxs)(as,{children:[(0,i.jsx)(e9.A,{size:13}),m.length," ",1===m.length?"resultado":"resultados"," encontrados"]}),!u&&c.length>=2&&0===m.length&&(0,i.jsxs)(aw,{children:[(0,i.jsx)(s.A,{size:32,strokeWidth:1.2}),'Nenhum resultado para "',(0,i.jsx)("strong",{children:c}),'"']}),!u&&c.length<2&&(0,i.jsxs)(aw,{children:[(0,i.jsx)(s.A,{size:32,strokeWidth:1.2}),"Escreve pelo menos 2 caracteres para pesquisar"]}),m.map((e,o)=>(0,i.jsxs)(ad,{selected:o===f,onClick:()=>{l(e.entry,e.headingSlug),a()},onMouseEnter:()=>y(o),children:[(0,i.jsx)(am,{selected:o===f,children:(0,i.jsx)(e9.A,{size:15})}),(0,i.jsxs)(ap,{children:[(0,i.jsxs)(au,{children:[e.entry.name,e.matchCount>0&&(0,i.jsx)(af,{children:e.matchCount>10?e.matchCount-10:e.matchCount})]}),(e.parentName||e.headingText)&&(0,i.jsxs)(ag,{children:[e.parentName,e.parentName&&e.headingText?" › ":"",e.headingText]}),e.snippet&&(0,i.jsx)(ay,{dangerouslySetInnerHTML:{__html:e.snippet}})]}),(0,i.jsx)(ah,{selected:o===f,children:(0,i.jsx)(e7.A,{size:14})})]},e.entry.id))]}),(0,i.jsxs)(ax,{children:[(0,i.jsxs)("span",{children:[(0,i.jsx)(ab,{children:"↑"})," ",(0,i.jsx)(ab,{children:"↓"})," navegar"]}),(0,i.jsxs)("span",{children:[(0,i.jsx)(ab,{children:"↵"})," abrir"]}),(0,i.jsxs)("span",{children:[(0,i.jsx)(ab,{children:"esc"})," fechar"]})]})]})}):null}function aA(e,a){for(let o of e){if(o.id===a)return o;if(o.children){let e=aA(o.children,a);if(e)return e}}}function aj(e){return e.flatMap(e=>e.children?aj(e.children):e.file?[e]:[])}let aS=l().div`
  display: flex;
  align-items: center;
  justify-content: center;
  height: 100%;
...
`,aR={en:"Browse the sidebar",pt:"Explora o menu lateral"};function aL({title:e,sub:a,lang:o}){return(0,i.jsxs)(aS,{children:[(0,i.jsx)(aT,{}),(0,i.jsx)(aM,{size:500,x:10,y:-10,hue:210,dur:7}),(0,i.jsx)(aM,{size:400,x:60,y:50,hue:270,dur:9}),(0,i.jsx)(aM,{size:300,x:30,y:70,hue:190,dur:6}),(0,i.jsxs)(aC,{children:[(0,i.jsx)(aB,{children:e}),(0,i.jsx)(aE,{children:a}),(0,i.jsxs)(aP,{children:[(0,i.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round",children:(0,i.jsx)("polyline",{points:"15 18 9 12 15 6"})}),aR[o]??aR.en]})]})]})}function aO(e,a,o){return"string"==typeof e?e:e[a]??e[o]??Object.values(e)[0]??""}function aN({navigation:e,languages:a,defaultLang:o,locale:r,hashPrefix:l,topBarRight:c,welcomeTitle:d="Blog",welcomeSub:m="Notes, guides, and references — pick a topic from the sidebar to get started."}){let p=a?Object.keys(a):[];p.length;let[u,g]=(0,n.useState)(()=>o??p[0]??"");(0,n.useEffect)(()=>{r&&p.includes(r)&&r!==u&&g(r)},[r]);let f=(0,n.useMemo)(()=>a&&u?a[u].navigation:e??{entries:[]},[a,e,u]);(0,n.useMemo)(()=>aj(f.entries),[f]);let y=(0,n.useCallback)(e=>{let a=e.match(RegExp(`^#\\/${l}\\/(.+)$`));if(a)return aA(f.entries,a[1])},[f,l]),[h,x]=(0,n.useState)(()=>y(window.location.hash)??null);(0,n.useEffect)(()=>{h&&x(aA(f.entries,h.id)??null)},[u,f]),(0,n.useEffect)(()=>{let e=()=>{let e=y(window.location.hash);e&&x(e)};return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[y]);let b=(0,n.useCallback)(e=>{e.file&&(x(e),window.location.hash=`#/${l}/${e.id}`)},[l]),w=(0,n.useMemo)(()=>aj(f.entries),[f]),z=w.findIndex(e=>e.id===h?.id),$=z>0?w[z-1]:null,v=z<w.length-1?w[z+1]:null,[k,j]=(0,n.useState)(!1),[S,M]=(0,n.useState)(null);(0,n.useEffect)(()=>{let e=e=>{(e.metaKey||e.ctrlKey)&&"f"===e.key&&(e.preventDefault(),j(!0))};return window.addEventListener("keydown",e),()=>window.removeEventListener("keydown",e)},[]);let T=h?.label??h?.name??l,C=aO(d,u,o??p[0]??""),B=aO(m,u,o??p[0]??""),E=(0,i.jsxs)(aF,{onClick:()=>j(!0),title:"Pesquisar (Ctrl+F)",children:[(0,i.jsx)(s.A,{size:14}),(0,i.jsx)("span",{children:"Pesquisar"}),(0,i.jsx)("kbd",{children:"⌘F"})]}),P=(0,i.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:"8px"},children:[E,c]});return(0,i.jsxs)(t.PE,{title:T,activeId:h?.id??null,topBarRight:P,sidebar:(0,i.jsx)(A,{config:f,activeId:h?.id??null,onSelect:b,hashPrefix:l}),children:[h?.file?(0,i.jsx)(e5,{file:h.file,prevEntry:$,nextEntry:v,onNavigate:b,scrollToId:S,onScrolled:()=>M(null)}):(0,i.jsx)(aL,{title:C,sub:B,lang:u}),(0,i.jsx)(ak,{open:k,onClose:()=>j(!1),entries:f.entries,activeId:h?.id??null,onSelect:(e,a)=>{b(e),M(a??null)}})]})}l().div`
  display: flex;
  gap: 4px;
  background: ${t.w4.colors.surface};
  border: 1px solid ${t.w4.colors.border};
...
`},48859(e,a,o){o.d(a,{FlyoutPanel:()=>b});var i=o(65723),n=o(37991),t=o.n(n),r=o(36859),l=o.n(r),s=o(72799),c=o(20255),d=o(81316),m=o(40814),p=o(96140);let u=(0,s.keyframes)`
...
`;function h({iconKey:e}){let a=e?p.t[e]??c.A:c.A;return(0,i.jsx)(a,{size:14,strokeWidth:1.75})}function x({entries:e,activeId:a,onSelect:o}){return(0,i.jsx)(i.Fragment,{children:e.map(e=>e.children?(0,i.jsx)(t().Fragment,{children:(0,i.jsx)(x,{entries:e.children,activeId:a,onSelect:o})},e.id):(0,i.jsxs)(y,{active:a===e.id,onClick:()=>o(e),children:[(0,i.jsx)(h,{iconKey:e.icon}),e.name]},e.id))})}function b({activeId:e}){let{flyout:a,scheduleFlyoutClose:o,cancelFlyoutClose:n}=(0,m.c)();if(!a)return null;let t=a.entry.icon?p.t[a.entry.icon]??c.A:c.A;return(0,i.jsxs)(g,{anchorY:a.anchorY,onMouseEnter:n,onMouseLeave:o,children:[(0,i.jsxs)(f,{children:[(0,i.jsx)(t,{size:13,strokeWidth:2}),a.entry.name]}),(0,i.jsx)(x,{entries:a.entry.children??[],activeId:e,onSelect:e=>{a.onSelect(e),o()}})]})}},40814(e,a,o){o.d(a,{I:()=>n,c:()=>t});var i=o(37991);let n=(0,i.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),t=()=>(0,i.useContext)(n)},96140(e,a,o){o.d(a,{t:()=>ex});var i=o(36896),n=o(87902),t=o(53013),r=o(32887),l=o(49510),s=o(39848),c=o(37901),d=o(3045),m=o(43775),p=o(41783),u=o(83539),g=o(39416),f=o(1837),y=o(57167),h=o(84494),x=o(82314),b=o(20255),w=o(35751),z=o(69633),$=o(92946),v=o(40822),k=o(36720),A=o(57400),j=o(58456),S=o(43317),M=o(52709),T=o(8006),C=o(89301),B=o(37561),E=o(83517),P=o(28207),F=o(37032),R=o(6949),L=o(8218),O=o(36829),N=o(59591),D=o(15553),I=o(69923),H=o(72820),G=o(14621),W=o(68479),Y=o(72534),V=o(66673),K=o(67490),_=o(49033),J=o(99038),U=o(45775),q=o(31365),Z=o(62937),X=o(9821),Q=o(65912),ee=o(80158),ea=o(88641),eo=o(48607),ei=o(83249),en=o(1821),et=o(15889),er=o(89655),el=o(27170),es=o(19161),ec=o(71849),ed=o(41604),em=o(13142),ep=o(61187),eu=o(77747),eg=o(2932),ef=o(24525),ey=o(57230),eh=o(22164);let ex={activity:i.A,"a-large-small":n.A,apple:t.A,"arrow-right":r.A,"bar-chart-2":l.A,book:s.A,"book-open":c.A,briefcase:d.A,calendar:m.A,clock:p.A,"circle-dot":u.A,cloud:g.A,compass:f.A,cpu:y.A,droplets:h.A,feather:x.A,file:b.A,"file-text":w.A,folder:z.A,"git-branch":$.A,github:v.A,globe:k.A,grid:A.A,hand:j.A,hash:S.A,heart:M.A,key:T.A,hexagon:C.A,home:B.A,landmark:E.A,layers:P.A,"layout-grid":F.A,leaf:R.A,lightbulb:L.A,list:O.A,map:N.A,"map-pin":D.A,"message-circle":I.A,"message-square":H.A,minus:G.A,monitor:W.A,mountain:Y.A,package:V.A,palette:K.A,"pen-tool":_.A,"pie-chart":J.A,plane:U.A,plus:q.A,ruler:Z.A,shirt:X.A,slash:Q.A,square:ee.A,star:ea.A,sun:eo.A,terminal:ei.A,thermometer:en.A,triangle:et.A,trophy:er.A,truck:el.A,type:es.A,users:ec.A,"volume-2":ed.A,watch:em.A,waves:ep.A,wind:eu.A,wrench:eg.A,x:ef.A,zap:ey.A,bot:eh.A}},29336(e,a,o){o.d(a,{w4:()=>i.w4,cL:()=>m.c,CD:()=>V,PE:()=>C,Is:()=>Z,PL:()=>X});var i=o(81316),n=o(65723),t=o(37991),r=o.n(t),l=o(36859),s=o.n(l);s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,s().div`
  position: relative;
`;var c=o(72799),d=o(73661),m=o(40814);let p="260px",u="56px",g=s().header`
  display: flex;
  align-items: center;
...
`,v=s().div`
  ...
  overflow: hidden;
`,k=s().aside`
  width: ${({collapsed:e})=>e?u:p};
  min-width: ${({collapsed:e})=>e?u:p};
  background: ${i.w4.colors.sidebarBg};
  border-right: 1px solid ${i.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,j=s().main`
  ...
  display: flex;
  flex-direction: column;
`,S=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function M(){return(0,n.jsx)(x,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:S.map((e,a)=>(0,n.jsx)(b,{index:a,accent:e.accent,children:e.char},a))})}let T="atlantis:sidebar-collapsed";function C({sidebar:e,children:a,topBarRight:i,title:l="Atlantis",activeId:s=null}){let[c,p]=(0,t.useState)(()=>{try{return"true"===localStorage.getItem(T)}catch{return!1}}),[u,h]=(0,t.useState)(null),x=(0,t.useRef)(),b=()=>p(e=>{let a=!e;try{localStorage.setItem(T,String(a))}catch{}return a}),S=r().useMemo(()=>r().lazy(()=>Promise.resolve().then(o.bind(o,48859)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,n.jsx)(m.I.Provider,{value:{collapsed:c,toggle:b,flyout:u,openFlyout:(e,a,o)=>{clearTimeout(x.current),h({entry:e,anchorY:a,onSelect:o})},scheduleFlyoutClose:()=>{x.current=setTimeout(()=>h(null),160)},cancelFlyoutClose:()=>clearTimeout(x.current)},children:(0,n.jsxs)(v,{children:[(0,n.jsxs)(g,{children:[e&&(0,n.jsx)(f,{children:(0,n.jsx)(y,{onClick:b,title:c?"Expand sidebar":"Collapse sidebar",children:(0,n.jsx)(d.A,{size:17})})}),(0,n.jsx)(M,{}),l&&(0,n.jsx)(w,{children:l}),i&&(0,n.jsx)(z,{children:i})]}),(0,n.jsxs)($,{children:[null!=e&&(0,n.jsx)(k,{collapsed:c,children:(0,n.jsx)(A,{children:e})}),(0,n.jsx)(j,{children:a})]}),u&&(0,n.jsx)(r().Suspense,{fallback:null,children:(0,n.jsx)(S,{activeId:s})})]})})}var B=o(20255),E=o(69753),P=o(96140);let F=s().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
...
`;function W({iconKey:e,size:a=16}){if(e&&!(e in P.t))return(0,n.jsx)("span",{style:{fontSize:a,lineHeight:1,display:"flex",alignItems:"center"},children:e});let o=e?P.t[e]??B.A:B.A;return(0,n.jsx)(o,{size:a,strokeWidth:1.75})}function Y({entry:e,activeId:a,onSelect:o}){let[i,r]=(0,t.useState)(e.defaultOpen??!0),{collapsed:l,openFlyout:s,scheduleFlyoutClose:c,cancelFlyoutClose:d}=(0,m.c)();return e.children&&e.children.length>0?(0,n.jsxs)(O,{children:[(0,n.jsxs)(N,{collapsed:l,onClick:()=>{l||r(e=>!e)},onMouseEnter:l?a=>{s(e,a.currentTarget.getBoundingClientRect().top,o)}:void 0,onMouseLeave:l?c:void 0,children:[(0,n.jsxs)(D,{collapsed:l,children:[(0,n.jsx)(W,{iconKey:e.icon,size:16}),(0,n.jsx)(I,{collapsed:l,children:e.name})]}),(0,n.jsx)(H,{open:i,collapsed:l,children:(0,n.jsx)(E.A,{size:13})})]}),(0,n.jsx)(F,{open:i&&!l,children:(0,n.jsx)(R,{children:(0,n.jsx)(L,{children:e.children.map(e=>(0,n.jsx)(Y,{entry:e,activeId:a,onSelect:o},e.id))})})})]}):(0,n.jsxs)(G,{active:a===e.id,collapsed:l,onClick:()=>o(e),onMouseEnter:l?a=>{let i=a.currentTarget.getBoundingClientRect();s({id:e.id,name:e.name,icon:e.icon,file:e.file,children:[e]},i.top,o)}:void 0,onMouseLeave:l?c:void 0,children:[(0,n.jsx)(W,{iconKey:e.icon,size:15}),(0,n.jsx)(I,{collapsed:l,children:e.name})]})}function V({entries:e,activeId:a,onSelect:o}){return(0,n.jsx)("div",{children:e.map(e=>(0,n.jsx)(Y,{entry:e,activeId:a,onSelect:o},e.id))})}let K=(0,c.keyframes)`
...
`,s().div`
  position: absolute;
  inset: 0;
  animation: ${ee} 1.4s cubic-bezier(0.4, 0, 0.2, 1) infinite;
