"use strict";(self.webpackChunk_atlantis_regexlab=self.webpackChunk_atlantis_regexlab||[]).push([[28],{4914(a,e,o){o.d(e,{FlyoutPanel:()=>b});var n=o(7359),t=o(3233),i=o(7207),r=o(255),l=o(217),s=o(5959),c=o(5185),d=o(5723);const m=i.keyframes`
...
`,J=i.default.div`
  ...
  color: ${n.w4.colors.sidebarTextMuted};
  font-family: ${n.w4.typography.fontFamily};
`;function W({onSave:a,onUpdate:e,onCancel:o,existingDoc:n}){const[i,l]=(0,t.useState)(n?.name??""),s=(0,t.useRef)(null);return(0,t.useEffect)(()=>{s.current?.focus(),n&&s.current?.select()},[n]),(0,r.jsx)(K,{onClick:o,children:(0,r.jsxs)(H,{onClick:a=>a.stopPropagation(),children:[(0,r.jsx)(Y,{children:"Save document"}),n&&e&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(J,{children:"Update the current version or save as a new one."}),(0,r.jsxs)(_,{children:[(0,r.jsx)(O,{onClick:o,children:"Cancel"}),(0,r.jsxs)(O,{danger:!0,onClick:e,children:['Update "',n.name,'"']})]}),(0,r.jsx)(U,{})]}),(0,r.jsx)(V,{ref:s,value:i,onChange:a=>l(a.target.value),onKeyDown:t=>{"Enter"===t.key&&i.trim()&&(n&&i.trim()===n.name&&e?e():a(i.trim())),"Escape"===t.key&&o()},placeholder:n?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,r.jsxs)(_,{children:[!n&&(0,r.jsx)(O,{onClick:o,children:"Cancel"}),(0,r.jsx)(O,{primary:!0,disabled:!i.trim(),onClick:()=>a(i.trim()),children:"Save as new"})]})]})})}var Z=o(5625),X=o(679),q=o(4872);const Q=i.default.div`
  position: relative;
`,aa=i.default.button`
  display: flex;
  align-items: center;
