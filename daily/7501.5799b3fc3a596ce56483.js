...
`,a(4914);var B=a(1920),j=a(8607),R=a(8479);r.default.button`
  display: flex;
  align-items: center;
  justify-content: center;
  width: 32px;
...
`;const N="shell:profile",I="atlantis:profile-change",Y=["tech","movies","learning","games","news","space"],K={interests:[],ageMode:"adult"};function G(o){if(!o||"object"!=typeof o)return K;const e=o;return{interests:Array.isArray(e.interests)?e.interests.filter(o=>Y.includes(o)):[],ageMode:"kid"===e.ageMode||"teen"===e.ageMode||"adult"===e.ageMode?e.ageMode:"adult"}}function V(){const[o,e]=(0,n.useState)(K);return(0,n.useEffect)(()=>{let o=!1;H(N).then(a=>{if(!o&&a)try{e(G(JSON.parse(a)))}catch{}});const a=o=>{const a=o.detail;a&&e(a)};return window.addEventListener(I,a),()=>{o=!0,window.removeEventListener(I,a)}},[]),[o,(0,n.useCallback)(o=>{const a=G(o);e(a),D(N,JSON.stringify(a)),window.dispatchEvent(new CustomEvent(I,{detail:a}))},[])]}new Set([10751]),new Set([27]),r.default.div`
...
`,n.default.p`
  ...
  font-size: 12.5px;
  line-height: 1.45;
`,n.default.nav`padding: ${r.w4.spacing.sm} 0;`,n.default.div`
...
`,R.A,R.A['pre[class*="language-"]'],r.w4.colors.codeBg,R.A['code[class*="language-"]'];var P=a(5569),E=a(8218),C=a(7230),L=a(2966),D=a(1069);P.A,E.A,C.A,L.A,D.A,n.default.div`
  background: ${({bg:o})=>o};
