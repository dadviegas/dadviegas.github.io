...
`,U.A,U.A['pre[class*="language-"]'],s.w4.colors.codeBg,U.A['code[class*="language-"]'],l().div`
  background: ${({bg:e})=>e};
...
`,X=l().span`
  ...
  line-height: 1;
  letter-spacing: 0;
`,Q=["#3b82f6","#8b5cf6","#ec4899","#10b981","#f59e0b","#06b6d4"],ee=0,eo=new Map;function ea({member:e,size:o=24}){var a,r;let i,n="shared"===e.id||"shared"===e.role,l=Math.floor(.55*o),d=o<=18?8:o<=22?9:o<=28?11:12;if(n)return(0,t.jsx)(Z,{size:o,bg:s.w4.colors.surface,ring:!0,"aria-label":"Shared",title:"Shared",style:{color:s.w4.colors.mainTextMuted},children:(0,t.jsx)(S,{name:"home",size:l,"aria-hidden":!0})});let c=(a=e.id,(r=e.color)?r:(!eo.has(a)&&(eo.set(a,Q[ee%Q.length]),ee++),eo.get(a))),p="adult"===e.role,g=(i=e.name.trim().split(/\s+/),((i[0]?.[0]??"")+(i[1]?.[0]??"")).toUpperCase().slice(0,2));return(0,t.jsx)(Z,{size:o,bg:c,ring:p,title:e.name,children:(0,t.jsx)(X,{fontSize:d,children:g})})}},4041(e,o,a){a.d(o,{z:()=>t});function t(){return"u">typeof crypto&&"function"==typeof crypto.randomUUID?crypto.randomUUID().replace(/-/g,"").slice(0,8):Math.random().toString(36).slice(2,10).padEnd(8,"0")}},8908(e,o,a){a.d(o,{uj:()=>z,OW:()=>m,ik:()=>x,Xj:()=>R,Ru:()=>u,kl:()=>j,RT:()=>T,RJ:()=>y,YG:()=>p});var t=a(5723),r=a(6859),i=a.n(r),n=a(3930);let l=i().div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
