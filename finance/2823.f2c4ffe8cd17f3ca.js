"use strict";(self.webpackChunk_atlantis_finance=self.webpackChunk_atlantis_finance||[]).push([["2823"],{719(e,o,a){a.d(o,{TA:()=>R,a8:()=>g,jb:()=>H});var t=a(5723),r=a(7991),n=a(6859),i=a.n(n),l=a(9874),s=a(8395),d=a(1496),c=a(3711);let p=["#3b82f6","#8b5cf6","#ec4899","#10b981","#f59e0b","#06b6d4"];function g(e,o){return e.color??p[o%p.length]}let m="#7fb77e",f=i().nav`
  display: flex;
...
`,j=l().span`
  ...
  line-height: 1;
  letter-spacing: 0;
`,F=["#3b82f6","#8b5cf6","#ec4899","#10b981","#f59e0b","#06b6d4"],B=0,C=new Map;function R({member:e,size:o=24}){var a,r;let n,i="shared"===e.id||"shared"===e.role,l=Math.floor(.55*o),d=o<=18?8:o<=22?9:o<=28?11:12;if(i)return(0,t.jsx)(S,{size:o,bg:s.w4.colors.surface,ring:!0,"aria-label":"Shared",title:"Shared",style:{color:s.w4.colors.mainTextMuted},children:(0,t.jsx)(T,{name:"home",size:l,"aria-hidden":!0})});let c=(a=e.id,(r=e.color)?r:(!C.has(a)&&(C.set(a,F[B%F.length]),B++),C.get(a))),p="adult"===e.role,g=(n=e.name.trim().split(/\s+/),((n[0]?.[0]??"")+(n[1]?.[0]??"")).toUpperCase().slice(0,2));return(0,t.jsx)(S,{size:o,bg:c,ring:p,title:e.name,children:(0,t.jsx)(j,{fontSize:d,children:g})})}l().img`
  width: ${({size:e})=>e}px;
  height: ${({size:e})=>e}px;
  border-radius: 50%;
  object-fit: cover;
...
`,l().span`
  ...
  background: ${({color:e})=>e};
  display: inline-block;
`;let D={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:s.w4.colors.accentMuted},E={neutral:s.w4.colors.mainTextMuted,live:s.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:s.w4.colors.accent},N=l().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${s.w4.typography.fontFamilyMono};
...
`,K=l().span`
  ...
  display: inline-block;
`;function I({tone:e="neutral",dot:o,children:a,...r}){return(0,t.jsxs)(N,{tone:e,...r,children:[(o??"live"===e)&&(0,t.jsx)(K,{}),a]})}l().kbd`
  font-family: ${s.w4.typography.fontFamilyMono};
  font-size: 10px;
  padding: 2px 6px;
  border: 1px solid ${s.w4.colors.border};
...
`;let V=l().div`
  ...
  align-items: center;
  gap: 8px;
`;function O({children:e,...o}){return(0,t.jsx)(V,{...o,children:e})}l().label`
  display: flex;
  align-items: center;
  gap: 10px;
...
`;function J({title:e,accessory:o,accentColor:a,error:r,errorLabel:n,children:i}){return(0,t.jsxs)(W,{accentColor:a,"data-widget-shell":!0,children:[(0,t.jsxs)(_,{children:[(0,t.jsx)(O,{children:e}),o&&(0,t.jsx)(Y,{children:o})]}),r?(0,t.jsxs)(U,{role:"alert",children:[(0,t.jsx)(q,{children:n??"Error"}),(0,t.jsx)("div",{children:r})]}):(0,t.jsx)(G,{children:i})]})}l().div`
  position: relative;
  display: flex;
  flex-direction: column;
  height: 100%;
...
`,ea.A,ea.A['pre[class*="language-"]'],s.w4.colors.codeBg,ea.A['code[class*="language-"]'],l().div`
  background: ${({bg:e})=>e};
...
`},4041(e,o,a){a.d(o,{z:()=>t});function t(){return"u">typeof crypto&&"function"==typeof crypto.randomUUID?crypto.randomUUID().replace(/-/g,"").slice(0,8):Math.random().toString(36).slice(2,10).padEnd(8,"0")}},8908(e,o,a){a.d(o,{uj:()=>z,OW:()=>m,ik:()=>x,Xj:()=>R,Ru:()=>u,kl:()=>j,RT:()=>T,RJ:()=>y,YG:()=>p});var t=a(5723),r=a(6859),n=a.n(r),i=a(9874);let l=n().div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
