"use strict";(self.webpackChunk_atlantis_mathblog=self.webpackChunk_atlantis_mathblog||[]).push([[2943],{1312(e,o,a){a.d(o,{WO:()=>mo});var n=a(27359),i=a(217),t=a(53233),r=a(65723);t.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,w=t.default.main`
  ...
  display: flex;
  flex-direction: column;
`,$="atlantis:sidebar-collapsed";function v({sidebar:e,children:o,topBarRight:i,title:t="Atlantis",activeId:d=null}){const[c,v]=(0,n.useState)(()=>{try{return"true"===localStorage.getItem($)}catch{return!1}}),[A,k]=(0,n.useState)(null),j=(0,n.useRef)(),S=()=>v(e=>{const o=!e;try{localStorage.setItem($,String(o))}catch{}return o}),T=n.useMemo(()=>n.lazy(()=>Promise.resolve().then(a.bind(a,74914)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(s.I.Provider,{value:{collapsed:c,toggle:S,flyout:A,openFlyout:(e,o,a)=>{clearTimeout(j.current),k({entry:e,anchorY:o,onSelect:a})},scheduleFlyoutClose:()=>{j.current=setTimeout(()=>k(null),160)},cancelFlyoutClose:()=>clearTimeout(j.current)},children:(0,r.jsxs)(h,{children:[(0,r.jsxs)(m,{children:[(0,r.jsx)(g,{children:(0,r.jsx)(u,{onClick:S,title:c?"Expand sidebar":"Collapse sidebar",children:(0,r.jsx)(l.A,{size:17})})}),(0,r.jsxs)(p,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:["Atl",(0,r.jsx)("span",{children:"antis"})]}),t&&(0,r.jsx)(f,{children:t}),i&&(0,r.jsx)(y,{children:i})]}),(0,r.jsxs)(b,{children:[(0,r.jsx)(x,{collapsed:c,children:(0,r.jsx)(z,{children:e})}),(0,r.jsx)(w,{children:o})]}),A&&(0,r.jsx)(n.Suspense,{fallback:null,children:(0,r.jsx)(T,{activeId:d})})]})})}var A=a(20255),k=a(69753),j=a(65185);const S=t.default.div`
  display: grid;
...
`;var K=a(88641),H=a(41783);function G(e){try{return JSON.parse(localStorage.getItem(e)??"[]")}catch{return[]}}const O=t.default.nav`padding: ${i.w.spacing.sm} 0;`,Y=t.default.div`
...
`;let ce=!1;function me({code:e}){const o=(0,n.useRef)(null),[t,l]=(0,n.useState)(null);return(0,n.useEffect)(()=>{let n=!1;return async function(){const t=(await a.e(774).then(a.bind(a,30774))).default;if(ce||(t.initialize({startOnLoad:!1,theme:"dark",themeVariables:{background:i.w.colors.codeBg,primaryColor:i.w.colors.accent,primaryTextColor:i.w.colors.mainText,lineColor:i.w.colors.border}}),ce=!0),o.current&&!n)try{const a=`mermaid-${Math.random().toString(36).slice(2)}`,{svg:i}=await t.render(a,e);!n&&o.current&&(o.current.innerHTML=i)}catch(e){n||l(e instanceof Error?e.message:String(e))}}(),()=>{n=!0}},[e]),t?(0,r.jsx)(se,{children:(0,r.jsxs)(de,{children:["Mermaid error: ",t]})}):(0,r.jsx)(se,{ref:o})}var ge=a(68383),ue=a(21426),pe=a(25609),fe=a(20320);const ye=t.default.div`
  margin: ${i.w.spacing.lg} 0;
  border-radius: ${i.w.borderRadius.md};
  border: 1px solid ${i.w.colors.codeBorder};
  overflow: hidden;
...
`;function Fe({headings:e,activeId:o}){return e.length<2?null:(0,r.jsxs)(Ce,{children:[(0,r.jsx)(Pe,{children:"On this page"}),(0,r.jsx)(Ne,{children:e.map(e=>(0,r.jsx)("li",{children:(0,r.jsx)(Re,{href:`#${e.id}`,active:o===e.id,level:e.level,onClick:o=>{o.preventDefault(),document.getElementById(e.id)?.scrollIntoView({behavior:"smooth",block:"start"})},children:e.text})},e.id))})]})}function Le(e){return e.toLowerCase().replace(/[*_`[\]()#]/g,"").replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-").trim()}function Ie(e){const{Children:o,isValidElement:n}=a(27359);return o.toArray(e).map(e=>"string"==typeof e?e:"number"==typeof e?String(e):n(e)?Ie(e.props.children??""):"").join("")}function De(){return e=>{!function e(o){if("blockquote"===o.type){const e=o.children?.[0];if("paragraph"===e?.type){const a=e.children?.[0];if("text"===a?.type){const n=a.value?.match(/^\[!(NOTE|TIP|WARNING|CAUTION|IMPORTANT)\]\s*/i);n&&(a.value=a.value.slice(n[0].length),a.value.trim()||1!==e.children.length||o.children.shift(),o.data=o.data??{},o.data.hName="div",o.data.hProperties={"data-callout":n[1].toUpperCase()})}}}o.children?.forEach(e)}(e)}}const Ke=t.default.div`
  ...
  width: 100%;
  box-sizing: border-box;
`,He=t.default.div`flex: 1; min-width: 0;`,Ge=t.default.article`
...
`;function so({title:e,sub:o}){return(0,r.jsxs)(oo,{children:[(0,r.jsx)(no,{}),(0,r.jsx)(ao,{size:500,x:10,y:-10,hue:210,dur:7}),(0,r.jsx)(ao,{size:400,x:60,y:50,hue:270,dur:9}),(0,r.jsx)(ao,{size:300,x:30,y:70,hue:190,dur:6}),(0,r.jsxs)(io,{children:[(0,r.jsx)(to,{children:e}),(0,r.jsx)(ro,{children:o}),(0,r.jsxs)(lo,{children:[(0,r.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round",children:(0,r.jsx)("polyline",{points:"15 18 9 12 15 6"})}),"Browse the sidebar"]})]})]})}function co(e,o,a){return"string"==typeof e?e:e[o]??e[a]??Object.values(e)[0]??""}function mo({navigation:e,languages:o,defaultLang:a,hashPrefix:i,topBarRight:t,welcomeTitle:l="Blog",welcomeSub:s="Notes, guides, and references — pick a topic from the sidebar to get started."}){const d=o?Object.keys(o):[],c=d.length>1,[m,g]=(0,n.useState)(()=>a??d[0]??""),u=(0,n.useMemo)(()=>o&&m?o[m].navigation:e??{entries:[]},[o,e,m]),p=((0,n.useMemo)(()=>eo(u.entries),[u]),(0,n.useCallback)(e=>{const o=e.match(new RegExp(`^#\\/${i}\\/(.+)$`));if(o)return Qe(u.entries,o[1])},[u,i])),[f,y]=(0,n.useState)(()=>p(window.location.hash)??null);(0,n.useEffect)(()=>{y(null)},[m]),(0,n.useEffect)(()=>{const e=()=>{const e=p(window.location.hash);e&&y(e)};return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[p]);const b=(0,n.useCallback)(e=>{e.file&&(y(e),window.location.hash=`#/${i}/${e.id}`)},[i]),h=(0,n.useMemo)(()=>eo(u.entries),[u]),x=h.findIndex(e=>e.id===f?.id),z=x>0?h[x-1]:null,w=x<h.length-1?h[x+1]:null,$=f?.label??f?.name??i,A=co(l,m,a??d[0]??""),k=co(s,m,a??d[0]??""),j=c&&o?(0,r.jsx)(qe,{languages:Object.fromEntries(d.map(e=>[e,{label:o[e].label}])),activeLang:m,onChange:g}):null;return(0,r.jsx)(v,{title:$,activeId:f?.id??null,topBarRight:(0,r.jsxs)(r.Fragment,{children:[j,t]}),sidebar:(0,r.jsx)(ee,{config:u,activeId:f?.id??null,onSelect:b,hashPrefix:i}),children:f?.file?(0,r.jsx)(Ue,{file:f.file,prevEntry:z,nextEntry:w,onNavigate:b}):(0,r.jsx)(so,{title:A,sub:k})})}},74914(e,o,a){a.d(o,{FlyoutPanel:()=>b});var n=a(27359),i=a(53233),t=a(77207),r=a(20255),l=a(217),s=a(15959),d=a(65185),c=a(65723);const m=t.keyframes`
