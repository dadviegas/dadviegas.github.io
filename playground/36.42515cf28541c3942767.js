"use strict";(self.webpackChunk_atlantis_playground=self.webpackChunk_atlantis_playground||[]).push([[36],{6036(e,t,r){r.r(t),r.d(t,{default:()=>W});var o=r(7359),s=r(3233),n=r(7207),a=r(894),i=r(7071),l=r(5496),c=r(1530),d=r(3482),p=r(679),u=r(5426),f=r(9881),m=r(6135),h=r(9421),g=r(6480),x=r(9336),b=r(7293),w=r(5723);const y=n.keyframes`from{transform:rotate(0deg)}to{transform:rotate(360deg)}`,$=(0,s.default)(i.A)`animation: ${y} 1s linear infinite;`,k=s.default.div`
  display: flex;
  align-items: center;
  gap: ${a.w4.spacing.sm};
...
//# sourceMappingURL=36.42515cf28541c3942767.js.map