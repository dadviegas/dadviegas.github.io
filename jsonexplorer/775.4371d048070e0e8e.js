...
`,l()("button",{shouldForwardProp:e=>"active"!==e&&"highlight"!==e})`
  ...
  border: 1px solid
    ${({active:e,highlight:a})=>e||a?d.w4.colors.accent:"transparent"};
  color: ${({active:e,highlight:a})=>e||a?d.w4.colors.accent:d.w4.colors.mainTextMuted};
  font-family: ${d.w4.typography.fontFamily};
  font-size: 12px;
  font-weight: 500;
  cursor: pointer;
...
`;let S={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:d.w4.colors.accentMuted},F={neutral:d.w4.colors.mainTextMuted,live:d.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:d.w4.colors.accent};l().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${d.w4.typography.fontFamilyMono};
...
`;function W({activeAppId:e}){let{collapsed:a}=(0,K.c)(),[o]=function(){let[e,a]=(0,r.useState)(T),o=(0,r.useCallback)(e=>{a(e);try{localStorage.setItem(M,e)}catch{}(0,d.Is)(k,e).catch(()=>{}),window.dispatchEvent(new CustomEvent("atlantis:locale-change",{detail:e}))},[]);return(0,r.useEffect)(()=>{let e=e=>{a(e.detail)};return window.addEventListener("atlantis:locale-change",e),()=>window.removeEventListener("atlantis:locale-change",e)},[]),(0,r.useEffect)(()=>{(0,d.PL)(k).then(o=>{if(A(o)&&o!==e){try{localStorage.setItem(M,o)}catch{}a(o)}}).catch(()=>{})},[]),[e,o]}(),i=(0,r.useMemo)(()=>(e,a)=>{let t=function(e,a){if(!a||!e.includes("|"))return e;let o=null;for(let e of Object.values(a))if("number"==typeof e&&Number.isFinite(e)){o=e;break}if(null===o)return e;let t=e.indexOf("|"),r=e.slice(0,t),i=e.slice(t+1);return 1===o?r:i}(z[e]?.[o]??e,a);return a?Object.entries(a).reduce((e,[a,o])=>e.replace(RegExp(`\\{${a}\\}`,"g"),String(o)),t):t},[o]),n=(0,r.useRef)(null),l=e=>{n.current!==e&&(n.current=e,document.activeElement?.blur(),window.location.hash=e,setTimeout(()=>{n.current=null},50))};return(0,t.jsxs)(I,{children:[(0,t.jsx)(Y,{collapsed:a,children:i("devtools.heading")}),N.map(o=>{let r=i(o.labelKey);return(0,t.jsxs)(G,{active:e===o.id,collapsed:a,onPointerDown:e=>{0===e.button&&l(o.hash)},onClick:()=>l(o.hash),title:r,children:[(0,t.jsx)(O,{children:(0,t.jsx)(v,{name:o.icon,size:16})}),(0,t.jsx)(_,{collapsed:a,children:r})]},o.id)})]})}let J=(0,y.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`;l().div`
  display: grid;
...
`,eo=l().button`
  ...
  border-radius: 20px;
  background: ${({primary:e,danger:a})=>a?"rgba(248,81,73,0.12)":e?d.w4.colors.accent:"none"};
  color: ${({primary:e,danger:a})=>a?d.w4.colors.danger:e?"#fff":d.w4.colors.mainText};
  border: 1px solid ${({primary:e,danger:a})=>a?d.w4.colors.danger:e?d.w4.colors.accent:d.w4.colors.border};
...
`,er=l().div`
  ...
  color: ${d.w4.colors.sidebarTextMuted};
  font-family: ${d.w4.typography.fontFamily};
`;function ei({onSave:e,onUpdate:a,onCancel:o,existingDoc:i}){let[n,l]=(0,r.useState)(i?.name??""),d=(0,r.useRef)(null);return(0,r.useEffect)(()=>{d.current?.focus(),i&&d.current?.select()},[i]),(0,t.jsx)(Z,{onClick:o,children:(0,t.jsxs)(X,{onClick:e=>e.stopPropagation(),children:[(0,t.jsx)(Q,{children:"Save document"}),i&&a&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(er,{children:"Update the current version or save as a new one."}),(0,t.jsxs)(ea,{children:[(0,t.jsx)(eo,{onClick:o,children:"Cancel"}),(0,t.jsxs)(eo,{danger:!0,onClick:a,children:['Update "',i.name,'"']})]}),(0,t.jsx)(et,{})]}),(0,t.jsx)(ee,{ref:d,value:n,onChange:e=>l(e.target.value),onKeyDown:t=>{"Enter"===t.key&&n.trim()&&(i&&n.trim()===i.name&&a?a():e(n.trim())),"Escape"===t.key&&o()},placeholder:i?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,t.jsxs)(ea,{children:[!i&&(0,t.jsx)(eo,{onClick:o,children:"Cancel"}),(0,t.jsx)(eo,{primary:!0,disabled:!n.trim(),onClick:()=>e(n.trim()),children:"Save as new"})]})]})})}let en=(0,y.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,el=(0,y.keyframes)`
...
`,l().button`
  ...
  background: ${({primary:e,danger:a})=>a?d.w4.colors.danger:e?d.w4.colors.accent:"transparent"};
  color: ${({primary:e,danger:a})=>a||e?"#fff":d.w4.colors.mainText};
  border: 1px solid
    ${({primary:e,danger:a})=>a?d.w4.colors.danger:e?d.w4.colors.accent:d.w4.colors.border};
...
`,eA=l().main`
  ...
  display: flex;
  flex-direction: column;
`;function eT(){return(0,t.jsxs)(eu,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:[(0,t.jsx)(eb,{"aria-hidden":"true",children:"A"}),(0,t.jsx)(ey,{children:"Atlantis"})]})}let ej="atlantis:sidebar-collapsed";function eS({sidebar:e,children:a,topBarRight:n,title:l="Atlantis",activeId:d=null}){let[s,c]=(0,r.useState)(()=>{try{return"true"===localStorage.getItem(ej)}catch{return!1}}),[p,g]=(0,r.useState)(null),h=(0,r.useRef)(),m=()=>c(e=>{let a=!e;try{localStorage.setItem(ej,String(a))}catch{}return a}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(o.bind(o,5816)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,t.jsx)(K.I.Provider,{value:{collapsed:s,toggle:m,flyout:p,openFlyout:(e,a,o)=>{clearTimeout(h.current),g({entry:e,anchorY:a,onSelect:o})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,t.jsxs)(ez,{children:[(0,t.jsxs)(em,{children:[e&&(0,t.jsx)(ef,{children:(0,t.jsx)(ex,{onClick:m,title:s?"Expand sidebar":"Collapse sidebar",children:(0,t.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("path",{d:"M9 3v18"})]})})}),(0,t.jsx)(eT,{}),l&&(0,t.jsx)(ew,{children:l}),n&&(0,t.jsx)(ev,{children:n})]}),(0,t.jsxs)(e$,{children:[null!=e&&(0,t.jsx)(eM,{collapsed:s,children:(0,t.jsx)(ek,{children:e})}),(0,t.jsx)(eA,{children:a})]}),p&&(0,t.jsx)(i().Suspense,{fallback:null,children:(0,t.jsx)(f,{activeId:d})})]})})}l().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
