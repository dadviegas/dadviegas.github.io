...
`,v=i.default.div`
  ...
  color: ${n.w.colors.sidebarTextMuted};
  font-family: ${n.w.typography.fontFamily};
`;function k({onSave:a,onUpdate:o,onCancel:e,existingDoc:n}){const[i,l]=(0,t.useState)(n?.name??""),m=(0,t.useRef)(null);return(0,t.useEffect)(()=>{m.current?.focus(),n&&m.current?.select()},[n]),(0,r.jsx)(z,{onClick:e,children:(0,r.jsxs)(y,{onClick:a=>a.stopPropagation(),children:[(0,r.jsx)(b,{children:"Save document"}),n&&o&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(v,{children:"Update the current version or save as a new one."}),(0,r.jsxs)(x,{children:[(0,r.jsx)(A,{onClick:e,children:"Cancel"}),(0,r.jsxs)(A,{danger:!0,onClick:o,children:['Update "',n.name,'"']})]}),(0,r.jsx)(w,{})]}),(0,r.jsx)(h,{ref:m,value:i,onChange:a=>l(a.target.value),onKeyDown:t=>{"Enter"===t.key&&i.trim()&&(n&&i.trim()===n.name&&o?o():a(i.trim())),"Escape"===t.key&&e()},placeholder:n?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,r.jsxs)(x,{children:[!n&&(0,r.jsx)(A,{onClick:e,children:"Cancel"}),(0,r.jsx)(A,{primary:!0,disabled:!i.trim(),onClick:()=>a(i.trim()),children:"Save as new"})]})]})})}var $=e(8006),S=e(679),B=e(4872);const E=i.default.div`
  position: relative;
`,M=i.default.button`
  display: flex;
  align-items: center;
