...
`,at=l().button`
  ...
  &:focus-visible { ${c.w4.focusRing} }
`;function aa({apps:e,recentAppIds:t,pinnedAppIds:a,onTogglePin:r,onMovePinned:n,onSelect:s,user:l,onSignOut:d,onPreferences:h,onClearData:f,onOpenPalette:b,notifications:y}){let v,M,j,[S]=(0,u.useProfile)(),C=(0,o.useMemo)(()=>e.filter(e=>{if(tC.has(e.id))return!1;let t=tS[e.id];return!t||!(0,u.hasInterests)(S)||!t.interest||!!S.interests.includes(t.interest)}),[e,S]),[T,A]=(0,o.useState)("home"),[F,L]=(0,o.useState)("All"),[N,P]=(0,o.useState)(null),[I,D]=(0,o.useState)(()=>new Date),{forecast:R}=(0,u.useWeather)({lat:g.j.lisbon.lat,lon:g.j.lisbon.lon,current:"temperature_2m,apparent_temperature,relative_humidity_2m,weather_code,wind_speed_10m,is_day",daily:"temperature_2m_max,temperature_2m_min,sunrise,sunset,uv_index_max",timezone:g.j.lisbon.timezone,cacheKey:"weather-lisbon-v3"}),[H,E]=(0,o.useState)(!0);(0,o.useEffect)(()=>{let e=!1;return(0,c.PL)("shell:onboarding-dismissed").then(t=>{e||E("true"===t)}).catch(()=>void 0),()=>{e=!0}},[]);let O=(0,o.useCallback)(()=>{E(!0),(0,c.Is)("shell:onboarding-dismissed","true").catch(()=>void 0)},[]);(0,o.useEffect)(()=>{let e=setInterval(()=>D(new Date),6e4),t=()=>{document.hidden||D(new Date)};return document.addEventListener("visibilitychange",t),window.addEventListener("focus",t),()=>{clearInterval(e),document.removeEventListener("visibilitychange",t),window.removeEventListener("focus",t)}},[]);let K=(0,o.useCallback)(()=>{A("home"),L("All"),P(null),(0,c.Is)("shell:home-mode","dashboard")},[]),q=(0,o.useCallback)(()=>{A("retreat"),L("All"),P(null),(0,c.Is)("shell:home-mode","retreat")},[]),B=(0,o.useCallback)(e=>{A("apps"),P(e),L("All")},[]),G=(0,o.useMemo)(()=>({live:"Live",lab:"AI Lab",vida:"Life Dashboard",learn:"Learning Hub",games:"Game Room",ent:"Entertainment"}),[]);(0,o.useEffect)(()=>{let e=()=>{let e=window.location.hash,t=e.indexOf("?");if(t<0)return;let a=new URLSearchParams(e.slice(t+1)).get("suite");if(!a)return;let i=G[a];i&&(A("apps"),P(i),L("All"))};return e(),window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[G]);let[W,Y]=(0,o.useState)(()=>{try{let e=localStorage.getItem("shell:suites-collapsed");return null===e||"true"===e}catch{return!0}}),[_,V]=(0,o.useState)(()=>{try{return"true"===localStorage.getItem("shell:home-sidebar-hidden")}catch{return!1}}),[U]=(0,o.useState)(()=>{try{return"1"===sessionStorage.getItem(eH)}catch{return!1}});(0,o.useEffect)(()=>{let e=!1;return(async()=>{let[t,a,i]=await Promise.all([(0,c.PL)("shell:suites-collapsed"),(0,c.PL)("shell:home-mode"),(0,c.PL)("shell:home-sidebar-hidden")]);if(!e){if(null!==t){Y("true"===t);try{localStorage.setItem("shell:suites-collapsed",t)}catch{}}if(null!==i){V("true"===i);try{localStorage.setItem("shell:home-sidebar-hidden",i)}catch{}}U?(A("home"),(0,c.Is)("shell:home-mode","dashboard").catch(()=>void 0)):"retreat"===a&&A("retreat")}})(),()=>{e=!0}},[U]),(0,o.useEffect)(()=>{let e=()=>{A("home"),L("All"),P(null)};return window.addEventListener("atlantis:open-widget-picker",e),()=>window.removeEventListener("atlantis:open-widget-picker",e)},[]);let J=(0,o.useCallback)(()=>{Y(e=>{let t=!e;try{localStorage.setItem("shell:suites-collapsed",String(t))}catch{}return(0,c.Is)("shell:suites-collapsed",String(t)),t})},[]),Q=(0,o.useCallback)(()=>{V(e=>{let t=!e;try{localStorage.setItem("shell:home-sidebar-hidden",String(t))}catch{}return(0,c.Is)("shell:home-sidebar-hidden",String(t)).catch(()=>void 0),t})},[]),[X,Z]=(0,m.Ym)(),ee=(0,o.useMemo)(()=>(0,m.Nx)(X,el),[X]),et=(0,o.useMemo)(()=>{let e={};for(let t of C){let a=tS[t.id];a&&(e[t.id]={icon:a.icon,label:ee(a.labelKey),description:ee(a.descriptionKey),color:a.color,category:$(a.category,X),hash:a.hash,needsAuth:!!a.needsAuth})}return e},[C,ee,X]),ea=(0,o.useMemo)(()=>C.filter(e=>{let t=tS[e.id],i="All"===F||t?.category===F,o=!N||t?.suite===N,r="All"===F&&!N&&a.includes(e.id);return i&&o&&!r}),[C,F,N,a]),ei=(0,o.useMemo)(()=>{if("All"!==F)return null;if(N){let e={};for(let t of ea){let a=tS[t.id]?.category??"Other";e[a]||(e[a]=[]),e[a].push(t)}return{type:"category",groups:e}}let e={};for(let t of ea){let a=tS[t.id]?.suite??"Other";e[a]||(e[a]=[]),e[a].push(t)}return{type:"suite",groups:e}},[ea,F,N]),eo=(0,o.useMemo)(()=>{let e={};for(let t of C){let a=tS[t.id]?.suite;a&&(e[a]=(e[a]??0)+1)}return e["AI Lab"]=(e["AI Lab"]??0)+1,e},[C]),er=(0,o.useMemo)(()=>a.flatMap(e=>C.filter(t=>t.id===e)),[a,C]),en=(0,o.useMemo)(()=>t.filter(e=>!a.includes(e)).flatMap(e=>C.filter(t=>t.id===e)).slice(0,6),[t,a,C]),es=0,ed=(e,t,o)=>{let l=tS[e.id],d=a.includes(e.id),u=l?ee(l.descriptionKey):"",m=l?.color??c.w4.colors.accent,g=l?$(l.category,X):"",h=o&&o.total>1?(0,i.jsxs)(i.Fragment,{children:[o.pinIdx>0&&(0,i.jsx)(t8,{type:"button",title:ee("pinned.moveLeft"),onClick:t=>{t.stopPropagation(),n(e.id,-1)},children:(0,i.jsx)(p.In,{name:"chevron-left",size:13})}),o.pinIdx<o.total-1&&(0,i.jsx)(t8,{type:"button",title:ee("pinned.moveRight"),onClick:t=>{t.stopPropagation(),n(e.id,1)},children:(0,i.jsx)(p.In,{name:"chevron-right",size:13})})]}):void 0;return(0,i.jsx)(p.SV,{vizId:e.id,label:e.label,description:u,hash:l?.hash??e.hash,category:g,accentColor:m,needsAuth:l?.needsAuth,pinned:d,index:t,onClick:()=>s(e),onHoverIntent:()=>x(e.id),onTogglePin:()=>r(e.id),reorderControls:h},e.id)},ec=e=>{let t=a.includes("devtools");return(0,i.jsx)(p.SV,{vizId:"devtools",label:ee("apps.devtools.label"),description:ee("apps.devtools.description"),hash:"#/playground",category:$("Create",X),accentColor:"#facc15",pinned:t,index:e,onClick:()=>{window.location.hash="#/playground"},onHoverIntent:()=>x("playground"),onTogglePin:()=>r("devtools")})};return(0,i.jsx)(i.Fragment,{children:(0,i.jsxs)(tR,{children:[(0,i.jsxs)(tH,{children:[(0,i.jsx)(tO,{children:(0,i.jsx)(p.K0,{onClick:Q,title:_?ee("sidebar.show"):ee("sidebar.hide"),"aria-label":_?ee("sidebar.show"):ee("sidebar.hide"),"aria-pressed":_,children:(0,i.jsx)(p.In,{name:"panel-left",size:16})})}),(0,i.jsxs)(tE,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:[(0,i.jsx)("span",{children:"Atl"}),(0,i.jsx)("span",{className:"logo-accent",children:"antis"})]}),(0,i.jsx)(tK,{children:(0,i.jsx)(p.Yw,{locale:X,onLocaleChange:Z,notifications:y,onOpenPalette:b,paletteLabel:ee("palette.search"),user:l?{name:l.name,email:l.email,avatarUrl:l.avatarUrl}:void 0,userMenuItems:l?[...h?[{label:ee("userMenu.preferences"),icon:(0,i.jsx)(p.In,{name:"user-cog",size:14}),onClick:h}]:[],{label:ee("userMenu.settings"),icon:(0,i.jsx)(p.In,{name:"settings",size:14}),onClick:()=>{window.location.hash="#/settings"}},...f?[{label:ee("userMenu.clearData"),icon:(0,i.jsx)(p.In,{name:"trash",size:14}),onClick:f,danger:!0}]:[],...d?[{label:ee("userMenu.signOut"),icon:(0,i.jsx)(p.In,{name:"log-out",size:14}),onClick:d,danger:!0}]:[]]:[],userMenuControlLabels:{language:ee("userMenu.language"),theme:ee("userMenu.theme"),themeLight:ee("userMenu.themeLight"),themeDark:ee("userMenu.themeDark"),themeSystem:ee("userMenu.themeSystem")},onSignIn:()=>{window.location.hash="#/home"}})})]}),(0,i.jsxs)(tq,{children:[(0,i.jsxs)(tB,{collapsed:_,children:[(0,i.jsx)(tU,{active:"home"===T,onClick:K,children:(0,i.jsxs)("span",{style:{display:"flex",alignItems:"center",gap:"8px"},children:[(0,i.jsx)(p.In,{name:"home",size:14}),ee("sidebar.home")]})}),(0,i.jsx)(tU,{active:"retreat"===T,onClick:q,children:(0,i.jsxs)("span",{style:{display:"flex",alignItems:"center",gap:"8px"},children:[(0,i.jsx)(p.In,{name:"moon",size:14}),ee("sidebar.retreat")]})}),(0,i.jsx)(tQ,{}),tL.length>0&&(0,i.jsxs)(i.Fragment,{children:[W?(0,i.jsx)(tV,{type:"button",onClick:J,children:ee("sidebar.showSuites")}):(0,i.jsxs)(i.Fragment,{children:[(0,i.jsxs)(tG,{onClick:J,children:[k("suites",X),(0,i.jsx)(tW,{collapsed:W,children:(0,i.jsx)(p.In,{name:"chevron-down",size:14})})]}),(0,i.jsx)(tY,{collapsed:W,children:(0,i.jsx)(t_,{children:tL.map(e=>{let t,a=(t=z.find(t=>t.yamlSuite===e))?{icon:t.icon,color:t.color}:void 0,o="apps"===T&&N===e;return(0,i.jsxs)(tU,{active:o,onClick:()=>B(e),children:[a&&(0,i.jsx)("span",{style:{display:"inline-flex",color:o?c.w4.colors.accent:a.color,flexShrink:0},children:(0,i.jsx)(p.In,{name:a.icon,size:16,"aria-hidden":"true"})}),(0,i.jsx)("span",{style:{flex:1,textAlign:"left"},children:w[e]?.[X]??e}),(0,i.jsx)(tJ,{active:o,children:eo[e]??0})]},e)})})})]}),(0,i.jsx)(tQ,{})]})]}),(0,i.jsx)(tX,{bleed:"retreat"===T,children:"retreat"===T?(0,i.jsx)(ti,{locale:X,greeting:tN(X,I),userName:l?.name,pinnedApps:er,onSelect:s,t:ee}):(0,i.jsxs)(i.Fragment,{children:[(0,i.jsxs)(tZ,{children:[(0,i.jsxs)(t0,{children:[(0,i.jsx)(t1,{children:(v=I.toLocaleDateString("pt"===X?"pt-PT":"en-GB",{weekday:"long"}),M=I.getDate(),j=I.toLocaleDateString("pt"===X?"pt-PT":"en-GB",{month:"long"}),`${v} \xb7 ${M} ${j}`.toUpperCase())}),R?.current&&(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(t4,{children:"\xb7"}),(0,i.jsxs)(t2,{children:[(0,i.jsx)("span",{className:"ico",children:(R.current.is_day?tP[R.current.weather_code??0]:tI[R.current.weather_code??0]??tP[R.current.weather_code??0])??"\xb7"}),(0,i.jsxs)("span",{className:"temp",children:[Math.round(R.current.temperature_2m??0),"\xb0"]}),(0,i.jsx)("span",{className:"lbl",children:k("home.weather.city",X)})]})]})]}),(0,i.jsxs)(t5,{children:[tN(X,I),l?.name?(0,i.jsxs)(i.Fragment,{children:[", ",(0,i.jsx)("span",{className:"accent",children:l.name.split(" ")[0]})]}):null,"."]})]}),"home"===T&&!H&&0===er.length&&0===en.length&&(0,i.jsx)(tz,{t:ee,onDismiss:O,onOpenPalette:b,onOpenPreferences:h}),"home"===T&&(0,i.jsx)(e8,{locale:X,pinnedAppIds:a,recentAppIds:t,apps:C,appMeta:et,onSelectApp:s,onTogglePin:r}),"apps"===T&&(0,i.jsxs)(i.Fragment,{children:[0===ea.length&&(null!==N||"All"!==F||(0,u.hasInterests)(S))&&(0,i.jsxs)(t7,{children:[(0,i.jsx)(t9,{children:k("home.emptyFiltered.title",X)}),(0,i.jsx)(ae,{children:k("home.emptyFiltered.desc",X)}),(0,i.jsxs)("div",{style:{display:"flex",gap:c.w4.spacing.sm},children:[(null!==N||"All"!==F)&&(0,i.jsx)(at,{type:"button",onClick:()=>{P(null),L("All")},style:{background:"transparent",color:c.w4.colors.accent,border:`1px solid ${c.w4.colors.border}`},children:k("home.emptyFiltered.clear",X)}),h&&(0,i.jsx)(at,{type:"button",onClick:h,children:k("home.emptyFiltered.cta",X)})]})]}),"All"===F&&!N&&er.length>0&&(0,i.jsxs)("div",{children:[(0,i.jsx)(t3,{children:k("pinned",X)}),(0,i.jsx)(t6,{children:er.map((e,t)=>ed(e,es++,{pinIdx:t,total:er.length}))})]}),"All"===F&&!N&&en.length>0&&(0,i.jsxs)("div",{children:[(0,i.jsx)(t3,{children:k("recentlyUsed",X)}),(0,i.jsx)(t6,{children:en.map(e=>ed(e,es++))})]}),ei?[..."suite"===ei.type?tF:tA.slice(1),"Other"].filter(e=>ei.groups[e]?.length>0).map(e=>(0,i.jsxs)("div",{children:[(0,i.jsx)(t3,{children:"suite"===ei.type?w[e]?.[X]??e:$(e,X)}),(0,i.jsxs)(t6,{children:[ei.groups[e].map(e=>ed(e,es++)),("suite"===ei.type&&"AI Lab"===e||"category"===ei.type&&"Lab"===e)&&ec(es++)]})]},e)):(0,i.jsxs)(t6,{children:[ea.map(e=>ed(e,es++)),"Lab"===F&&ec(es++)]})]})]})})]})]})})}let ai=(0,a(82791).U)("https://eqvzakschpdemcgexjyy.supabase.co","sb_publishable_D_UOsNIA7qD3929ZzReWLw_k8d8MxWL");function ao(){return ai.auth.signInWithOAuth({provider:"google",options:{redirectTo:window.location.origin}})}function ar(){return ai.auth.signOut()}let an=(0,d.keyframes)`
...
`;let ep=(0,C.keyframes)`
  from { opacity: 0; transform: translateY(8px); }
  to   { opacity: 1; transform: translateY(0); }
`,eu=s()("div",{shouldForwardProp:e=>"accentColor"!==e&&"pinned"!==e&&"index"!==e})`
  --acc: ${({accentColor:e})=>e};
  position: relative;
  display: flex;
  flex-direction: column;
