...
`,s().p`
  ...
  font-size: 12.5px;
  line-height: 1.45;
`;var e3=a(11352),e8=a(76710),e6=a(4311),e7=a(73639),e9=a(8411);a(75406),s().nav`padding: ${l.w4.spacing.sm} 0;`,s().div`
...
`;var te=a(54041);let tt="#7fb77e",ta=(0,C.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,ti=s().div`
  position: relative;
...
`,tr=!1,tn=/^(?:---[\s\S]*?---\s*)?(?:graph|flowchart|sequenceDiagram|classDiagram|stateDiagram(?:-v2)?|erDiagram|pie|gantt|journey|mindmap|gitGraph|sankey(?:-beta)?|quadrantChart|requirementDiagram|timeline|xychart-beta|block-beta|C4Context|C4Container|C4Component|C4Dynamic|C4Deployment)\b/;function ts({code:e}){let[t,r]=(0,o.useState)(""),[n,s]=(0,o.useState)(!1);return((0,o.useEffect)(()=>{let t=!1;s(!1),r("");let i=e.trim();if(!i)return void s(!0);let o=i.split(/\r?\n/)[0]?.trim()??"";return tn.test(o)?((async()=>{try{let e=(await a.e("6087").then(a.bind(a,29738))).default;if(!tr){let t="#141820",a="#1c2332",i="#343c4f",o="#e8edf5",r="#9aa5b8",n="#7fb77e",s="#6aa8d8",l="#8b7bff",d="#e89a5c",c="#f87171";e.initialize({startOnLoad:!1,theme:"base",securityLevel:"loose",themeVariables:{fontFamily:"-apple-system, BlinkMacSystemFont, Segoe UI, Helvetica, Arial, sans-serif",background:t,mainBkg:a,primaryColor:n,primaryTextColor:o,primaryBorderColor:n,secondaryColor:l,secondaryTextColor:o,secondaryBorderColor:l,tertiaryColor:s,tertiaryTextColor:o,tertiaryBorderColor:s,lineColor:r,textColor:o,nodeBorder:i,clusterBkg:t,clusterBorder:i,edgeLabelBackground:a,labelBackground:a,labelBorder:i,relationLabelBackground:a,relationLabelColor:o,pie1:n,pie2:l,pie3:s,pie4:d,pie5:"#ff6fa9",pie6:"#2dd4bf",pie7:c,pie8:n,pieStrokeColor:t,pieStrokeWidth:"2px",pieTitleTextSize:"18px",pieSectionTextSize:"13px",pieLegendTextSize:"13px",actorBkg:n,actorBorder:n,actorTextColor:t,signalColor:o,signalTextColor:o,labelBoxBkgColor:a,labelBoxBorderColor:i,labelTextColor:o,loopTextColor:o,noteBkgColor:d,noteBorderColor:d,noteTextColor:t,stateBkg:a,altBackground:t,attributeBackgroundColorOdd:a,attributeBackgroundColorEven:t,rowOdd:a,rowEven:t,gridColor:i,sectionBkgColor:a,sectionBkgColor2:t,taskBkgColor:l,taskTextColor:o,taskTextDarkColor:o,taskTextLightColor:o,taskTextOutsideColor:o,activeTaskBkgColor:n,activeTaskBorderColor:n,doneTaskBkgColor:r,doneTaskBorderColor:r,critBkgColor:c,critBorderColor:c}}),tr=!0}let{svg:o}=await e.render(`mermaid-${(0,te.z)()}`,i);if(t)return;if(!o||/aria-roledescription="error"/i.test(o))return void s(!0);r(o)}catch(e){console.error("[MermaidBlock] render failed",e),t||s(!0)}})(),()=>{t=!0}):void s(!0)},[e]),n)?(0,i.jsx)(to,{children:e.trim()}):(0,i.jsx)(ti,{dangerouslySetInnerHTML:{__html:t}})}let tl=["#388bfd","#3fb950","#d29922","#a371f7","#f87171","#22d3ee","#fb923c","#34d399","#f472b6","#818cf8"],td=s().div`
  background: ${l.w4.colors.codeBg};
  border: 1px solid ${l.w4.colors.codeBorder};
  border-radius: ${l.w4.borderRadius.md};
...
`,s().span`
  font-size: ${l.w4.typography.fontSizeBase};
  color: ${l.w4.colors.mainTextMuted};
`;var tk=a(17223),t$=a(21426),tj=a(25609),tM=a(20320);let tS=s().div`
  margin: ${l.w4.spacing.lg} 0;
  border-radius: ${l.w4.borderRadius.md};
  border: 1px solid ${l.w4.colors.codeBorder};
  overflow: hidden;
...
`,tA={...t$.A,'pre[class*="language-"]':{...t$.A['pre[class*="language-"]'],background:l.w4.colors.codeBg,margin:0,padding:"18px 20px",fontSize:"13px",lineHeight:"1.6",borderRadius:0},'code[class*="language-"]':{...t$.A['code[class*="language-"]'],background:"none",fontSize:"13px"}};function tL({lang:e="text",code:t}){let[a,r]=(0,o.useState)(!1);return(0,i.jsxs)(tS,{children:[(0,i.jsxs)(tz,{children:[(0,i.jsx)(tC,{children:e}),(0,i.jsxs)(tT,{copied:a,onClick:()=>{navigator.clipboard.writeText(t).then(()=>{r(!0),setTimeout(()=>r(!1),2e3)})},children:[a?(0,i.jsx)(tj.A,{size:12}):(0,i.jsx)(tM.A,{size:12}),a?"Copied!":"Copy"]})]}),(0,i.jsx)(tk.A,{language:e,style:tA,showLineNumbers:t.split("\n").length>8,lineNumberStyle:{color:"#484f58",minWidth:"2.5em",paddingRight:"1.5em",userSelect:"none",fontSize:"12px"},customStyle:{margin:0,background:l.w4.colors.codeBg},wrapLongLines:!1,children:t})]})}var tF=a(65569),tN=a(8218),tP=a(57230),tI=a(22966),tD=a(21069);let tR={NOTE:{bg:"rgba(88, 166, 255, 0.08)",border:"#58a6ff",icon:tF.A,label:"Note",color:"#58a6ff"},TIP:{bg:"rgba(63, 185, 80, 0.08)",border:"#3fb950",icon:tN.A,label:"Tip",color:"#3fb950"},IMPORTANT:{bg:"rgba(163, 113, 247, 0.08)",border:"#a371f7",icon:tP.A,label:"Important",color:"#a371f7"},WARNING:{bg:"rgba(210, 153, 34, 0.08)",border:"#d29922",icon:tI.A,label:"Warning",color:"#d29922"},CAUTION:{bg:"rgba(248, 81, 73, 0.08)",border:"#f85149",icon:tD.A,label:"Caution",color:"#f85149"}},tH=s().div`
  background: ${({bg:e})=>e};
...
`;function tK({type:e,children:t}){let a=tR[e]??tR.NOTE,o=a.icon;return(0,i.jsxs)(tH,{bg:a.bg,border:a.border,children:[(0,i.jsxs)(tE,{color:a.color,children:[(0,i.jsx)(o,{size:15,strokeWidth:2}),a.label]}),(0,i.jsx)(tO,{children:t})]})}s().nav`
  width: 220px;
  min-width: 220px;
...
`;function tY({children:e}){return(0,i.jsx)(tG,{children:(0,i.jsx)(e3.oz,{remarkPlugins:[e8.A,e6.A,tW],rehypePlugins:[e7.A,e9.A],components:{div({node:e,children:t,...a}){let o=a["data-callout"];return o?(0,i.jsx)(tK,{type:o,children:t}):(0,i.jsx)("div",{...a,children:t})},pre:({children:e})=>(0,i.jsx)(i.Fragment,{children:e}),code({className:e,children:t}){let a=/language-(\w+)/.exec(e??"")?.[1],o=String(t).replace(/\n$/,"");return o.trim()?"mermaid"===a?(0,i.jsx)(ts,{code:o}):"chart"===a?(0,i.jsx)(ty,{code:o}):a||o.includes("\n")?(0,i.jsx)(tL,{lang:a,code:o}):(0,i.jsx)("code",{className:e,children:t}):null}},children:e})})}s().nav`
  display: flex;
  flex-direction: column;
  gap: 1px;
  padding: ${l.w4.spacing.sm} 0;
...
`,d=r().p`
  ...
  margin: 0;
  line-height: 1.5;
`,c={loading:"◌ Loading",empty:"◎ Empty",error:"◎ Offline"};function p({mode:e,label:t,body:a}){return(0,i.jsxs)(s,{children:[(0,i.jsx)(l,{mode:e,children:t??c[e]}),a&&(0,i.jsx)(d,{children:a})]})}},38628(e,t,a){a.d(t,{YG:()=>i.Y});var i=a(85043);a(65723),a(37991);var o=a(89874),r=a(36859),n=a.n(r);n().span`
  font-family: ${o.w4.typography.fontFamilyMono};
  font-size: 11px;
  font-weight: 500;
  font-variant-numeric: tabular-nums;
