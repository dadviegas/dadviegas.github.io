"use strict";(self.webpackChunk_atlantis_codediff=self.webpackChunk_atlantis_codediff||[]).push([[7438],{4914(o,e,a){a.d(e,{FlyoutPanel:()=>b});var t=a(7359),n=a(3233),r=a(7207),i=a(255),l=a(217),d=a(5959),s=a(5185),c=a(5723);const p=r.keyframes`
...
`,J=r.default.div`
  ...
  color: ${t.w4.colors.sidebarTextMuted};
  font-family: ${t.w4.typography.fontFamily};
`;function W({onSave:o,onUpdate:e,onCancel:a,existingDoc:t}){const[r,l]=(0,n.useState)(t?.name??""),d=(0,n.useRef)(null);return(0,n.useEffect)(()=>{d.current?.focus(),t&&d.current?.select()},[t]),(0,i.jsx)(K,{onClick:a,children:(0,i.jsxs)(Y,{onClick:o=>o.stopPropagation(),children:[(0,i.jsx)(_,{children:"Save document"}),t&&e&&(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(J,{children:"Update the current version or save as a new one."}),(0,i.jsxs)(G,{children:[(0,i.jsx)(U,{onClick:a,children:"Cancel"}),(0,i.jsxs)(U,{danger:!0,onClick:e,children:['Update "',t.name,'"']})]}),(0,i.jsx)(O,{})]}),(0,i.jsx)(V,{ref:d,value:r,onChange:o=>l(o.target.value),onKeyDown:n=>{"Enter"===n.key&&r.trim()&&(t&&r.trim()===t.name&&e?e():o(r.trim())),"Escape"===n.key&&a()},placeholder:t?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,i.jsxs)(G,{children:[!t&&(0,i.jsx)(U,{onClick:a,children:"Cancel"}),(0,i.jsx)(U,{primary:!0,disabled:!r.trim(),onClick:()=>o(r.trim()),children:"Save as new"})]})]})})}var Z=a(5625),q=a(679),X=a(4872);const Q=r.default.div`
  position: relative;
`,oo=r.default.button`
  display: flex;
  align-items: center;
...
`,P.A,P.A['pre[class*="language-"]'],r.w4.colors.codeBg,P.A['code[class*="language-"]'];var L=a(5569),R=a(8218),E=a(7230),H=a(2966),N=a(1069);L.A,R.A,E.A,H.A,N.A,n.default.div`
  background: ${({bg:o})=>o};
