...
`,l().p`
  ...
  font-size: 12.5px;
  line-height: 1.45;
`;var Y=o(1352),q=o(6710),N=o(4311),W=o(3639),D=o(80);o(5406),l().nav`padding: ${s.w4.spacing.sm} 0;`,l().div`
...
`;var O=o(4041);let G="https://cdn.jsdelivr.net/npm/mermaid@11.14.0/dist/mermaid.min.js",X=null,_="#7fb77e",K=(0,j.keyframes)`
...
`;function eS({type:e,children:t}){let o=ez[e]??ez.NOTE;return(0,r.jsxs)(eT,{bg:o.bg,border:o.border,children:[(0,r.jsxs)(ej,{color:o.color,children:[(0,r.jsx)(S,{name:o.icon,size:15,strokeWidth:2}),o.label]}),(0,r.jsx)(eF,{children:t})]})}l().nav`
  width: 220px;
  min-width: 220px;
...
`;l().div`
  ...
  background: ${s.w4.colors.mainBg};
  font-family: ${s.w4.typography.fontFamily};
  animation: ${eq} 0.4s ease 0.15s both;
`,l().div`
  position: relative;
  width: 56px;
  height: 56px;
...
`,l().div`
  position: relative;
`;let eD="260px",eO="56px",eG="48px",eX=l().header`
  display: flex;
  align-items: center;
...
`,e2=l().div`
  ...
  overflow: hidden;
`,e4=l().aside`
  width: ${({collapsed:e})=>e?eO:eD};
  min-width: ${({collapsed:e})=>e?eO:eD};
  background: ${s.w4.colors.sidebarBg};
  border-right: 1px solid ${s.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
