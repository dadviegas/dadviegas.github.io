"use strict";(self.webpackChunk_atlantis_estudodomeio=self.webpackChunk_atlantis_estudodomeio||[]).push([[2943],{1312(e,a,o){o.d(a,{WO:()=>ca});var n=o(27359),i=o(217),t=o(53233),r=o(65723);t.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,w=t.default.main`
  ...
  display: flex;
  flex-direction: column;
`,$="atlantis:sidebar-collapsed";function A({sidebar:e,children:a,topBarRight:i,title:t="Atlantis",activeId:d=null}){const[c,A]=(0,n.useState)(()=>{try{return"true"===localStorage.getItem($)}catch{return!1}}),[v,k]=(0,n.useState)(null),j=(0,n.useRef)(),S=()=>A(e=>{const a=!e;try{localStorage.setItem($,String(a))}catch{}return a}),M=n.useMemo(()=>n.lazy(()=>Promise.resolve().then(o.bind(o,74914)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(s.I.Provider,{value:{collapsed:c,toggle:S,flyout:v,openFlyout:(e,a,o)=>{clearTimeout(j.current),k({entry:e,anchorY:a,onSelect:o})},scheduleFlyoutClose:()=>{j.current=setTimeout(()=>k(null),160)},cancelFlyoutClose:()=>clearTimeout(j.current)},children:(0,r.jsxs)(b,{children:[(0,r.jsxs)(m,{children:[(0,r.jsx)(g,{children:(0,r.jsx)(u,{onClick:S,title:c?"Expand sidebar":"Collapse sidebar",children:(0,r.jsx)(l.A,{size:17})})}),(0,r.jsxs)(p,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:["Atl",(0,r.jsx)("span",{children:"antis"})]}),t&&(0,r.jsx)(f,{children:t}),i&&(0,r.jsx)(y,{children:i})]}),(0,r.jsxs)(h,{children:[(0,r.jsx)(x,{collapsed:c,children:(0,r.jsx)(z,{children:e})}),(0,r.jsx)(w,{children:a})]}),v&&(0,r.jsx)(n.Suspense,{fallback:null,children:(0,r.jsx)(M,{activeId:d})})]})})}var v=o(20255),k=o(69753),j=o(65185);const S=t.default.div`
  display: grid;
...
`;let ce=!1;function me({code:e}){const a=(0,n.useRef)(null),[t,l]=(0,n.useState)(null);return(0,n.useEffect)(()=>{let n=!1;return async function(){const t=(await o.e(774).then(o.bind(o,30774))).default;if(ce||(t.initialize({startOnLoad:!1,theme:"dark",themeVariables:{background:i.w.colors.codeBg,primaryColor:i.w.colors.accent,primaryTextColor:i.w.colors.mainText,lineColor:i.w.colors.border}}),ce=!0),a.current&&!n)try{const o=`mermaid-${Math.random().toString(36).slice(2)}`,{svg:i}=await t.render(o,e);!n&&a.current&&(a.current.innerHTML=i)}catch(e){n||l(e instanceof Error?e.message:String(e))}}(),()=>{n=!0}},[e]),t?(0,r.jsx)(se,{children:(0,r.jsxs)(de,{children:["Mermaid error: ",t]})}):(0,r.jsx)(se,{ref:a})}var ge=o(68383),ue=o(21426),pe=o(25609),fe=o(20320);const ye=t.default.div`
  margin: ${i.w.spacing.lg} 0;
  border-radius: ${i.w.borderRadius.md};
  border: 1px solid ${i.w.colors.codeBorder};
  overflow: hidden;
