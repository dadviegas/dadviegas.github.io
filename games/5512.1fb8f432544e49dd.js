...
`,H=s().div`
  ...
  align-items: center;
  gap: ${d.w4.spacing.sm};
`,Y=[{x:3,y:5,size:1.5,delay:0,dur:3.2},{x:8,y:35,size:2,delay:1.8,dur:3.4},{x:12,y:70,size:1.5,delay:.6,dur:4.1},{x:18,y:15,size:2.5,delay:2.4,dur:3},{x:22,y:55,size:1.5,delay:.3,dur:4.5},{x:28,y:88,size:2,delay:1.1,dur:3.6},{x:33,y:25,size:1.5,delay:2.8,dur:4},{x:40,y:60,size:2,delay:.9,dur:3.3},{x:45,y:8,size:2.5,delay:1.5,dur:3.8},{x:50,y:45,size:1.5,delay:2.1,dur:4.3},{x:55,y:78,size:2,delay:.4,dur:3.1},{x:60,y:18,size:1.5,delay:1.7,dur:4.6},{x:65,y:50,size:2.5,delay:2.6,dur:3.5},{x:70,y:85,size:1.5,delay:.2,dur:3.9},{x:75,y:30,size:2,delay:1.3,dur:4.2},{x:80,y:65,size:1.5,delay:2.9,dur:3.7},{x:85,y:10,size:2,delay:.7,dur:3.4},{x:88,y:42,size:2.5,delay:1.9,dur:4.4},{x:92,y:75,size:1.5,delay:.5,dur:3.2},{x:96,y:22,size:2,delay:2.3,dur:3.8}],Z=document.getElementById("root");if(!Z)throw Error("Root element #root not found");(0,i.createRoot)(Z).render((0,o.jsx)(function({topBarRight:e,isAuthenticated:a=!1}){let[t,i]=(0,n.useState)(E),[r,s]=(0,n.useState)("all"),[l]=(0,c.Ym)(),M="pt"===l?"pt":"en";if((0,n.useEffect)(()=>{document.activeElement?.blur()},[t]),(0,n.useEffect)(()=>{let e=()=>i(E());return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[]),!t)return(0,o.jsx)(d.PE,{title:"pt"===M?"Jogos":"Games",sidebar:null,topBarRight:e,children:(0,o.jsxs)(A,{children:[Y.map((e,a)=>(0,o.jsx)(q,{x:e.x,y:e.y,size:e.size,delay:e.delay,dur:e.dur},a)),(0,o.jsx)(D,{top:15,delay:12}),(0,o.jsx)(D,{top:55,delay:25}),(0,o.jsx)(F,{children:"pt"===M?"Vamos jogar!":"Let’s play!"}),(0,o.jsx)(J,{children:"pt"===M?"Escolhe um jogo para come\xe7ar":"Pick a game to get started"}),(0,o.jsxs)(I,{children:[(0,o.jsxs)(Q,{active:"all"===r,onClick:()=>s("all"),children:["\uD83C\uDFAE ","pt"===M?"Todos":"All"]}),(0,o.jsx)(Q,{active:"online"===r,chipColor:"#3fb950",onClick:()=>s("online"),children:"\uD83C\uDF10 Online"}),(0,o.jsxs)(Q,{active:"multiplayer"===r,chipColor:"#d2a8ff",onClick:()=>s("multiplayer"),children:["\uD83D\uDC65 3+ ","pt"===M?"Jogadores":"Players"]}),(0,o.jsxs)(Q,{active:"solo"===r,chipColor:"#f59e0b",onClick:()=>s("solo"),children:["\uD83C\uDFAF ","pt"===M?"Sozinho":"Solo"]})]}),(0,o.jsx)(R,{children:O.filter(e=>"online"===r?e.online:"multiplayer"===r?e.maxPlayers>=3:"solo"!==r||1===e.maxPlayers).map((e,t)=>{let n=1===e.maxPlayers?"pt"===M?"JOGO \xb7 SOLO":"GAME \xb7 SOLO":2===e.maxPlayers?"pt"===M?"JOGO \xb7 2P":"GAME \xb7 2P":"pt"===M?`JOGO \xb7 2-${e.maxPlayers}P`:`GAME \xb7 2-${e.maxPlayers}P`,r=e.maxPlayers>1?2===e.maxPlayers?"2":`2-${e.maxPlayers}`:void 0,s=T[e.id]?.[M];return(0,o.jsx)(p.Xl,{label:e.label[M],description:e.description[M],emoji:e.emoji,hash:e.hash,category:n,accentColor:e.color,playerCount:r,online:a&&e.online,onlineLabel:"ONLINE",vizId:e.id,vizLabel:s,index:t,onClick:()=>{i(e.id),window.location.hash=e.hash,(0,d.VF)("games",{hash:e.hash,label:e.label[M]??e.label.en,icon:e.emoji,color:e.color})}},e.id)})})]})});let W=(0,o.jsxs)(H,{children:[(0,o.jsxs)(X,{onClick:()=>{i(null),window.location.hash="#/games"},children:["← ","pt"===M?"Jogos":"Games"]}),e]}),L=O.find(e=>e.id===t),G=()=>{i(null),window.location.hash="#/games"};if("lebem"===t)return(0,o.jsx)(d.PE,{title:"L\xeaBem",sidebar:null,topBarRight:W,children:(0,o.jsx)(m.f,{onBack:G})});let Z={tictactoe:(0,o.jsx)(h.t,{lang:M,onBack:G,canOnline:a}),soundhunter:(0,o.jsx)(u.m,{lang:M,onBack:G}),familyquiz:(0,o.jsx)(x.i,{lang:M,onBack:G,canOnline:a}),adventure:(0,o.jsx)(y.a,{lang:M,onBack:G}),pixelboard:(0,o.jsx)(b.H,{lang:M,onBack:G}),stopgame:(0,o.jsx)(g.z,{lang:M,onBack:G,canOnline:a}),spotit:(0,o.jsx)(f.O,{lang:M,onBack:G,canOnline:a}),memory:(0,o.jsx)(w.Y,{lang:M,onBack:G,canOnline:a}),tapit:(0,o.jsx)(j.n,{lang:M,onBack:G,canOnline:a}),jumpparty:(0,o.jsx)(k.v,{lang:M,onBack:G}),drawguess:(0,o.jsx)(z.c,{lang:M,onBack:G,canOnline:a}),animalarena:(0,o.jsx)(v.m,{lang:M,onBack:G}),crazykitchen:(0,o.jsx)(P.A,{lang:M,onBack:G}),miniparty:(0,o.jsx)($.k,{lang:M,onBack:G}),hideseek:(0,o.jsx)(B.p,{lang:M,onBack:G}),buttonmayhem:(0,o.jsx)(S.M,{lang:M,onBack:G}),bombbrawl:(0,o.jsx)(C.$,{lang:M,onBack:G,canOnline:a})};return(0,o.jsx)(d.PE,{title:L.title[M],sidebar:null,topBarRight:W,children:Z[t]})},{}))}}]);