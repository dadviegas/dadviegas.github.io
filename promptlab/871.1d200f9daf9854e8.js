"use strict";(self.webpackChunk_atlantis_promptlab=self.webpackChunk_atlantis_promptlab||[]).push([["871"],{3758(o,e,r){r.d(e,{L:()=>a});var t=r(2906);async function a(o,e,r,a,i,n,l){let d="",s=o=>{o.length<=d.length||(n(o.slice(d.length)),d=o)};"groq"===o?await (0,t.askGroqStream)(i,{key:e,model:r,system:a,onChunk:s,signal:l}):await (0,t.streamGemini)(i,{key:e,model:r,system:a,onChunk:s,signal:l})}},7613(o,e,r){r.d(e,{H:()=>v});var t=r(5723),a=r(7991),i=r(6859),n=r.n(i),l=r(4764),d=r(18),s=r(8035);let p=n().div`
  display: flex;
...
`,h=n().div`
  ...
  text-transform: uppercase;
  letter-spacing: 0.06em;
`;function b({systemPrompt:o,userPrompt:e,onSystemChange:r,onUserChange:i,onRun:n,running:l,canRun:c}){let[m,w]=(0,a.useState)(!!o);return(0,t.jsxs)(s,{children:[(0,t.jsxs)(p,{onClick:()=>w(o=>!o),children:[m?(0,t.jsx)(d.In,{name:"chevron-down",size:14}):(0,t.jsx)(d.In,{name:"chevron-right",size:14}),"System Prompt"]}),m&&(0,t.jsx)(g,{placeholder:"Optional system prompt...",value:o,onChange:o=>r(o.target.value)}),(0,t.jsx)(h,{children:"User Prompt"}),(0,t.jsx)(x,{placeholder:"Enter your prompt here...",value:e,onChange:o=>i(o.target.value),onKeyDown:o=>{"Enter"===o.key&&(o.metaKey||o.ctrlKey)&&c&&!l&&(o.preventDefault(),n())}}),(0,t.jsxs)(f,{disabled:!c||l,onClick:n,children:[(0,t.jsx)(d.In,{name:"play",size:14}),l?"Running...":"Run"]})]})}},6220(o,e,r){r.d(e,{c:()=>z});var t=r(5723),a=r(6859),i=r.n(a),n=r(2799),l=r(4764),d=r(18),s=r(7991),p=r(8035);let c=(0,n.keyframes)`
  0%, 100% { opacity: 1; }
  50% { opacity: 0; }
`,g=i().div`
  display: flex;
...
`,k={groq:"#f55036",gemini:"#4285f4"};function z({run:o}){let[e,r]=(0,s.useState)(!1),a=p.L.find(e=>e.id===o.modelId),i=a?.label??o.modelId,n=k[o.provider]??l.w4.colors.accent,c=async()=>{o.output&&(await navigator.clipboard.writeText(o.output),r(!0),setTimeout(()=>r(!1),1500))};return(0,t.jsxs)(g,{children:[(0,t.jsxs)(x,{children:[(0,t.jsxs)(f,{accentColor:n,children:[(0,t.jsx)(h,{children:o.provider}),i]}),(0,t.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:"8px"},children:["done"===o.status&&null!=o.durationMs&&(0,t.jsxs)(b,{children:[(o.durationMs/1e3).toFixed(1),"s"]}),o.output&&(0,t.jsx)(M,{onClick:c,title:"Copy output",children:e?(0,t.jsx)(d.In,{name:"check",size:13}):(0,t.jsx)(d.In,{name:"copy",size:13})})]})]}),(0,t.jsxs)(m,{children:["idle"===o.status&&(0,t.jsx)(u,{children:"Response will appear here..."}),"error"===o.status&&o.error?.includes("rate limit")&&(0,t.jsxs)($,{children:[(0,t.jsx)(v,{children:"⚠️"}),(0,t.jsx)("div",{children:o.error})]}),"error"===o.status&&!o.error?.includes("rate limit")&&(0,t.jsx)(y,{children:o.error}),("streaming"===o.status||"done"===o.status)&&(0,t.jsx)(w,{streaming:"streaming"===o.status,children:o.output})]})]})}},7871(o,e,r){r.d(e,{Vc:()=>i,cR:()=>n,yr:()=>l});var t=r(2906);let a={groq:"",gemini:""};function i(){let o=(0,t.loadApiKeysSync)();return{...a,groq:o.groq??"",gemini:o.gemini??""}}function n(o){(0,t.saveApiKeys)({groq:o.groq,gemini:o.gemini})}function l(o){return!!(o.groq||o.gemini)}},8035(o,e,r){r.d(e,{L:()=>i,x:()=>a});var t=r(2906);let a=[{id:"groq",label:"Groq",url:"https://console.groq.com"},{id:"gemini",label:"Google Gemini",url:"https://aistudio.google.com/apikey"}],i=[...t.GROQ_MODELS.map(o=>({provider:"groq",id:o.id,label:o.label})),...t.GEMINI_MODELS.map(o=>({provider:"gemini",id:o.id,label:o.label}))]},18(o,e,r){r.d(e,{MJ:()=>D,In:()=>y});var t=r(5723),a=r(7991),i=r(6859),n=r.n(i),l=r(4764);let d={ghost:"transparent",accent:"transparent",primary:l.w4.colors.accent,success:"#238636",danger:"#da3633"},s={ghost:l.w4.colors.sidebarHover,accent:"rgba(88,166,255,0.10)",primary:l.w4.colors.accentHover,success:"#2ea043",danger:"#f85149"},p={ghost:l.w4.colors.border,accent:l.w4.colors.accent,primary:l.w4.colors.accent,success:"#238636",danger:"#da3633"},c={ghost:l.w4.colors.mainTextMuted,accent:l.w4.colors.accent,primary:"#fff",success:"#fff",danger:"#fff"},g={ghost:l.w4.colors.mainText,accent:l.w4.colors.accent,primary:"#fff",success:"#fff",danger:"#fff"},x={sm:"28px",md:"30px"},f={sm:"0 10px",md:"0 12px"},h={sm:"12px",md:"12px"};n().button`
  display: inline-flex;
  align-items: center;
  justify-content: center;
  gap: 6px;
...
`,n().p`
  ...
  font-size: 12.5px;
  line-height: 1.45;
`,r(5406),n().nav`padding: ${l.w4.spacing.sm} 0;`,n().div`
...
`,K=n().div`
  ...
  color: ${l.w4.colors.sidebarTextMuted};
  font-family: ${l.w4.typography.fontFamily};
`;function D({onSave:o,onUpdate:e,onCancel:r,existingDoc:i}){let[n,l]=(0,a.useState)(i?.name??""),d=(0,a.useRef)(null);return(0,a.useEffect)(()=>{d.current?.focus(),i&&d.current?.select()},[i]),(0,t.jsx)(Y,{onClick:r,children:(0,t.jsxs)(q,{onClick:o=>o.stopPropagation(),children:[(0,t.jsx)(P,{children:"Save document"}),i&&e&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(K,{children:"Update the current version or save as a new one."}),(0,t.jsxs)(G,{children:[(0,t.jsx)(O,{onClick:r,children:"Cancel"}),(0,t.jsxs)(O,{danger:!0,onClick:e,children:['Update "',i.name,'"']})]}),(0,t.jsx)(E,{})]}),(0,t.jsx)(I,{ref:d,value:n,onChange:o=>l(o.target.value),onKeyDown:t=>{"Enter"===t.key&&n.trim()&&(i&&n.trim()===i.name&&e?e():o(n.trim())),"Escape"===t.key&&r()},placeholder:i?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,t.jsxs)(G,{children:[!i&&(0,t.jsx)(O,{onClick:r,children:"Cancel"}),(0,t.jsx)(O,{primary:!0,disabled:!n.trim(),onClick:()=>o(n.trim()),children:"Save as new"})]})]})})}let X=(0,w.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,_=(0,w.keyframes)`
