"use strict";(self.webpackChunk_atlantis_mathblog=self.webpackChunk_atlantis_mathblog||[]).push([[9749],{28834(e,a,o){o.d(a,{WO:()=>da});var n=o(27359),i=o(217),t=o(53233),r=o(65723);t.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,Ne=t.default.ul`list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 2px;`,Le=t.default.a`
  display: block;
  padding: 4px 8px;
...
`;function Re({headings:e,activeId:a}){return e.length<2?null:(0,r.jsxs)(Ce,{children:[(0,r.jsx)(Pe,{children:"On this page"}),(0,r.jsx)(Ne,{children:e.map(e=>(0,r.jsx)("li",{children:(0,r.jsx)(Le,{href:`#${e.id}`,active:a===e.id,level:e.level,onClick:a=>{a.preventDefault(),document.getElementById(e.id)?.scrollIntoView({behavior:"smooth",block:"start"})},children:e.text})},e.id))})]})}function Fe(e){return e.toLowerCase().replace(/[*_`[\]()#]/g,"").replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-").trim()}function Ie(e){const{Children:a,isValidElement:n}=o(27359);return a.toArray(e).map(e=>"string"==typeof e?e:"number"==typeof e?String(e):n(e)?Ie(e.props.children??""):"").join("")}function De(){return e=>{!function e(a){if("blockquote"===a.type){const e=a.children?.[0];if("paragraph"===e?.type){const o=e.children?.[0];if("text"===o?.type){const n=o.value?.match(/^\[!(NOTE|TIP|WARNING|CAUTION|IMPORTANT)\]\s*/i);n&&(o.value=o.value.slice(n[0].length),o.value.trim()||1!==e.children.length||a.children.shift(),a.data=a.data??{},a.data.hName="div",a.data.hProperties={"data-callout":n[1].toUpperCase()})}}}a.children?.forEach(e)}(e)}}const Ke=t.default.div`
  display: flex;
