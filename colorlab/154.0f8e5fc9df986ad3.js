...
`,x=({size:o=14,strokeWidth:a=1.75})=>(0,t.jsxs)("svg",{width:o,height:o,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:a,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,t.jsx)("polyline",{points:"14 2 14 8 20 8"})]});function u({iconKey:o}){let a=o?p[o]:void 0;return a?(0,t.jsx)("svg",{width:14,height:14,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,dangerouslySetInnerHTML:{__html:a}}):(0,t.jsx)(x,{})}function b({entries:o,activeId:a,onSelect:e}){return(0,t.jsx)(t.Fragment,{children:o.map(o=>o.children?(0,t.jsx)(i().Fragment,{children:(0,t.jsx)(b,{entries:o.children,activeId:a,onSelect:e})},o.id):(0,t.jsxs)(f,{active:a===o.id,onClick:()=>e(o),children:[(0,t.jsx)(u,{iconKey:o.icon}),o.name]},o.id))})}function w({activeId:o}){let{flyout:a,scheduleFlyoutClose:e,cancelFlyoutClose:r}=(0,c.c)();if(!a)return null;let i=a.entry.icon?p[a.entry.icon]:void 0;return(0,t.jsxs)(m,{anchorY:a.anchorY,onMouseEnter:r,onMouseLeave:e,children:[(0,t.jsxs)(h,{children:[i?(0,t.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,dangerouslySetInnerHTML:{__html:i}}):(0,t.jsx)(x,{size:13,strokeWidth:2}),a.entry.name]}),(0,t.jsx)(b,{entries:a.entry.children??[],activeId:o,onSelect:o=>{a.onSelect(o),e()}})]})}},814(o,a,e){e.d(a,{I:()=>r,c:()=>i});var t=e(7991);let r=(0,t.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),i=()=>(0,t.useContext)(r)},4764(o,a,e){e.d(a,{w4:()=>t.w4,cL:()=>c.c,PE:()=>j,Is:()=>B.putSetting,PL:()=>B.getSetting});var t=e(1316),r=e(5723),i=e(7991),n=e.n(i),l=e(6859),d=e.n(l),s=e(2799),c=e(814);let p="260px",g="56px",m="48px",h=d().header`
  display: flex;
  align-items: center;
...
`,A=d().main`
  ...
  display: flex;
  flex-direction: column;
`,T=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function S(){return(0,r.jsx)(b,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:T.map((o,a)=>(0,r.jsx)(w,{index:a,accent:o.accent,children:o.char},a))})}let F="atlantis:sidebar-collapsed";function j({sidebar:o,children:a,topBarRight:t,title:l="Atlantis",activeId:d=null}){let[s,p]=(0,i.useState)(()=>{try{return"true"===localStorage.getItem(F)}catch{return!1}}),[g,m]=(0,i.useState)(null),u=(0,i.useRef)(),b=()=>p(o=>{let a=!o;try{localStorage.setItem(F,String(a))}catch{}return a}),w=n().useMemo(()=>n().lazy(()=>Promise.resolve().then(e.bind(e,7330)).then(o=>({default:o.FlyoutPanel}))),[]);return(0,r.jsx)(c.I.Provider,{value:{collapsed:s,toggle:b,flyout:g,openFlyout:(o,a,e)=>{clearTimeout(u.current),m({entry:o,anchorY:a,onSelect:e})},scheduleFlyoutClose:()=>{u.current=setTimeout(()=>m(null),160)},cancelFlyoutClose:()=>clearTimeout(u.current)},children:(0,r.jsxs)(z,{children:[(0,r.jsxs)(h,{children:[o&&(0,r.jsx)(f,{children:(0,r.jsx)(x,{onClick:b,title:s?"Expand sidebar":"Collapse sidebar",children:(0,r.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,r.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,r.jsx)("path",{d:"M9 3v18"})]})})}),(0,r.jsx)(S,{}),l&&(0,r.jsx)(y,{children:l}),t&&(0,r.jsx)($,{children:t})]}),(0,r.jsxs)(v,{children:[null!=o&&(0,r.jsx)(M,{collapsed:s,children:(0,r.jsx)(k,{children:o})}),(0,r.jsx)(A,{children:a})]}),g&&(0,r.jsx)(n().Suspense,{fallback:null,children:(0,r.jsx)(w,{activeId:d})})]})})}d().div`
  display: grid;
...
`,n()("button",{shouldForwardProp:o=>"active"!==o&&"highlight"!==o})`
  ...
  border: 1px solid
    ${({active:o,highlight:a})=>o||a?l.w4.colors.accent:"transparent"};
  color: ${({active:o,highlight:a})=>o||a?l.w4.colors.accent:l.w4.colors.mainTextMuted};
  font-family: ${l.w4.typography.fontFamily};
  font-size: 12px;
  font-weight: 500;
  cursor: pointer;
...
`;function _({activeAppId:o}){let{collapsed:a}=(0,l.cL)(),[e]=function(){let[o,a]=(0,r.useState)(A),e=(0,r.useCallback)(o=>{a(o);try{localStorage.setItem(z,o)}catch{}(0,l.Is)(M,o).catch(()=>{}),window.dispatchEvent(new CustomEvent("atlantis:locale-change",{detail:o}))},[]);return(0,r.useEffect)(()=>{let o=o=>{a(o.detail)};return window.addEventListener("atlantis:locale-change",o),()=>window.removeEventListener("atlantis:locale-change",o)},[]),(0,r.useEffect)(()=>{(0,l.PL)(M).then(e=>{if(k(e)&&e!==o){try{localStorage.setItem(z,e)}catch{}a(e)}}).catch(()=>{})},[]),[o,e]}(),i=(0,r.useMemo)(()=>(o,a)=>{let t=function(o,a){if(!a||!o.includes("|"))return o;let e=null;for(let o of Object.values(a))if("number"==typeof o&&Number.isFinite(o)){e=o;break}if(null===e)return o;let t=o.indexOf("|"),r=o.slice(0,t),i=o.slice(t+1);return 1===e?r:i}(v[o]?.[e]??o,a);return a?Object.entries(a).reduce((o,[a,e])=>o.replace(RegExp(`\\{${a}\\}`,"g"),String(e)),t):t},[e]),n=(0,r.useRef)(null),d=o=>{n.current!==o&&(n.current=o,document.activeElement?.blur(),window.location.hash=o,setTimeout(()=>{n.current=null},50))};return(0,t.jsxs)(K,{children:[(0,t.jsx)(Y,{collapsed:a,children:i("devtools.heading")}),I.map(e=>{let r=i(e.labelKey);return(0,t.jsxs)(D,{active:o===e.id,collapsed:a,onPointerDown:o=>{0===o.button&&d(e.hash)},onClick:()=>d(e.hash),title:r,children:[(0,t.jsx)(N,{children:(0,t.jsx)(y,{name:e.icon,size:16})}),(0,t.jsx)(G,{collapsed:a,children:r})]},e.id)})]})}let O=(0,b.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`;n().div`
  display: grid;
...
`,n().button`
  ...
  border-radius: 20px;
  background: ${({primary:o,danger:a})=>a?"rgba(248,81,73,0.12)":o?l.w4.colors.accent:"none"};
  color: ${({primary:o,danger:a})=>a?l.w4.colors.danger:o?"#fff":l.w4.colors.mainText};
  border: 1px solid ${({primary:o,danger:a})=>a?l.w4.colors.danger:o?l.w4.colors.accent:l.w4.colors.border};
...
`,n().button`
  ...
  background: ${({primary:o,danger:a})=>a?l.w4.colors.danger:o?l.w4.colors.accent:"transparent"};
  color: ${({primary:o,danger:a})=>a||o?"#fff":l.w4.colors.mainText};
  border: 1px solid
    ${({primary:o,danger:a})=>a?l.w4.colors.danger:o?l.w4.colors.accent:l.w4.colors.border};
