...
`;let u={default:n.w4.colors.accent,danger:"#f85149"},b={default:n.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"},y=s().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`;let j={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:n.w4.colors.accentMuted},S={neutral:n.w4.colors.mainTextMuted,live:n.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:n.w4.colors.accent};s().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${n.w4.typography.fontFamilyMono};
...
`,s().div`
  position: relative;
`;let I="260px",D="56px",N="44px",W=s().header`
  display: flex;
  align-items: center;
...
`,Z=s().div`
  ...
  overflow: hidden;
`,X=s().aside`
  width: ${({collapsed:e})=>e?D:I};
  min-width: ${({collapsed:e})=>e?D:I};
  background: ${n.w4.colors.sidebarBg};
  border-right: 1px solid ${n.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,ee=s().main`
  ...
  display: flex;
  flex-direction: column;
`;function ea(){return(0,t.jsxs)(Y,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:[(0,t.jsx)(K,{"aria-hidden":"true",children:"A"}),(0,t.jsx)(_,{children:"Atlantis"})]})}let eo="atlantis:sidebar-collapsed";function et({sidebar:e,children:a,topBarRight:n,title:l="Atlantis",activeId:s=null}){let[c,d]=(0,r.useState)(()=>{try{return"true"===localStorage.getItem(eo)}catch{return!1}}),[p,g]=(0,r.useState)(null),h=(0,r.useRef)(),m=()=>d(e=>{let a=!e;try{localStorage.setItem(eo,String(a))}catch{}return a}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(o.bind(o,2787)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,t.jsx)(C.I.Provider,{value:{collapsed:c,toggle:m,flyout:p,openFlyout:(e,a,o)=>{clearTimeout(h.current),g({entry:e,anchorY:a,onSelect:o})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,t.jsxs)(Z,{children:[(0,t.jsxs)(W,{children:[e&&(0,t.jsx)(G,{children:(0,t.jsx)(O,{onClick:m,title:c?"Expand sidebar":"Collapse sidebar",children:(0,t.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("path",{d:"M9 3v18"})]})})}),(0,t.jsx)(ea,{}),l&&(0,t.jsx)(q,{children:l}),n&&(0,t.jsx)(U,{children:n})]}),(0,t.jsxs)(J,{children:[null!=e&&(0,t.jsx)(X,{collapsed:c,children:(0,t.jsx)(Q,{children:e})}),(0,t.jsx)(ee,{children:a})]}),p&&(0,t.jsx)(i().Suspense,{fallback:null,children:(0,t.jsx)(f,{activeId:s})})]})})}var er=o(4971);let ei=s().div`
  display: grid;
...
`;function em({iconKey:e,size:a=16}){let o=e?er.X[e]:void 0;return o?(0,t.jsx)("svg",{width:a,height:a,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,dangerouslySetInnerHTML:{__html:o}}):e?(0,t.jsx)("span",{style:{fontSize:a,lineHeight:1,display:"flex",alignItems:"center"},children:e}):(0,t.jsxs)("svg",{width:a,height:a,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,children:[(0,t.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,t.jsx)("polyline",{points:"14 2 14 8 20 8"})]})}function ef({entry:e,activeId:a,onSelect:o}){let[i,n]=(0,r.useState)(e.defaultOpen??!0),{collapsed:l,openFlyout:s,scheduleFlyoutClose:c,cancelFlyoutClose:d}=(0,C.c)();return e.children&&e.children.length>0?(0,t.jsxs)(es,{children:[(0,t.jsxs)(ec,{collapsed:l,onClick:()=>{l||n(e=>!e)},onMouseEnter:l?a=>{s(e,a.currentTarget.getBoundingClientRect().top,o)}:void 0,onMouseLeave:l?c:void 0,children:[(0,t.jsxs)(ed,{collapsed:l,children:[(0,t.jsx)(em,{iconKey:e.icon,size:16}),(0,t.jsx)(ep,{collapsed:l,children:e.name})]}),(0,t.jsx)(eg,{open:i,collapsed:l,children:(0,t.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round",children:(0,t.jsx)("path",{d:"M9 6l6 6-6 6"})})})]}),(0,t.jsx)(ei,{open:i&&!l,children:(0,t.jsx)(en,{children:(0,t.jsx)(el,{children:e.children.map(e=>(0,t.jsx)(ef,{entry:e,activeId:a,onSelect:o},e.id))})})})]}):(0,t.jsxs)(eh,{active:a===e.id,collapsed:l,onClick:()=>o(e),onMouseEnter:l?a=>{let t=a.currentTarget.getBoundingClientRect();s({id:e.id,name:e.name,icon:e.icon,file:e.file,children:[e]},t.top,o)}:void 0,onMouseLeave:l?c:void 0,children:[(0,t.jsx)(em,{iconKey:e.icon,size:15}),(0,t.jsx)(ep,{collapsed:l,children:e.name})]})}function ex({entries:e,activeId:a,onSelect:o}){return(0,t.jsx)("div",{children:e.map(e=>(0,t.jsx)(ef,{entry:e,activeId:a,onSelect:o},e.id))})}function eu(e){try{return JSON.parse(localStorage.getItem(e)??"[]")}catch{return[]}}o(2787),s().div`
...
`,ek=s().div`overflow: hidden;`,ej=s().div`
  display: flex;
  align-items: center;
...
`,aH=s().div`
  ...
  font-family: ${n.w4.typography.fontFamily};
  margin-bottom: ${n.w4.spacing.md};
`,aR=s().ul`list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 2px;`,aP=s().a`
  display: block;
  padding: 4px 8px;
...
`;function aE({headings:e,activeId:a}){return e.length<2?null:(0,t.jsxs)(aL,{children:[(0,t.jsx)(aH,{children:"On this page"}),(0,t.jsx)(aR,{children:e.map(e=>(0,t.jsx)("li",{children:(0,t.jsx)(aP,{href:`#${e.id}`,active:a===e.id,level:e.level,onClick:a=>{a.preventDefault(),document.getElementById(e.id)?.scrollIntoView({behavior:"smooth",block:"start"})},children:e.text})},e.id))})]})}function aV(){let e=new Map;return a=>{let o=a.toLowerCase().replace(/[*_`[\]()#]/g,"").replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-").trim(),t=(e.get(o)??0)+1;return e.set(o,t),1===t?o:`${o}-${t}`}}function aI(){return e=>{!function e(a){if("blockquote"===a.type){let e=a.children?.[0];if(e?.type==="paragraph"){let o=e.children?.[0];if(o?.type==="text"){let t=o.value?.match(/^\[!(NOTE|TIP|WARNING|CAUTION|IMPORTANT)\]\s*/i);t&&(o.value=o.value.slice(t[0].length),o.value.trim()||1!==e.children.length||a.children.shift(),a.data=a.data??{},a.data.hName="div",a.data.hProperties={"data-callout":t[1].toUpperCase()})}}}a.children?.forEach(e)}(e)}}let aD=s().div`
  display: flex;
  align-items: flex-start;
  max-width: 1200px;
  margin: 0 auto;
...
`,a_=s().div`
  ...
  font-family: ${n.w4.typography.fontFamily};
`;function aq(e,a){return function({children:o,...i}){let n=`h${e}`,l=function e(a){return r.Children.toArray(a).map(a=>"string"==typeof a?a:"number"==typeof a?String(a):(0,r.isValidElement)(a)?e(a.props.children??""):"").join("")}(o),s=a(l);return(0,t.jsxs)(n,{id:s,...i,children:[o,(0,t.jsx)("a",{className:"heading-anchor",href:`#${s}`,"aria-label":`Link to "${l}"`,children:(0,t.jsx)(M,{name:"link",size:14})})]})}}function aU({file:e,prevEntry:a,nextEntry:i,onNavigate:n}){let[l,s]=(0,r.useState)(null),[c,d]=(0,r.useState)(null),p=(0,r.useRef)(null);if((0,r.useEffect)(()=>{s(null),fetch(`${o.p}content/${e}`).then(e=>{if(!e.ok)throw Error(`${e.status} ${e.statusText}`);return e.text()}).then(s).catch(a=>s(`> **Error loading \`${e}\`:** ${a.message}`))},[e]),(0,r.useEffect)(()=>{if(!l||!p.current)return;let e=p.current,a=Array.from(e.querySelectorAll("h2[id], h3[id]"));if(!a.length)return;let o=e.parentElement;for(;o;){let{overflowY:e}=getComputedStyle(o);if(("auto"===e||"scroll"===e)&&o.scrollHeight>o.clientHeight)break;o=o.parentElement}let t=o??window,r=()=>{let e=a[0].id;for(let o of a)if(o.getBoundingClientRect().top-120<=0)e=o.id;else break;d(e)};return r(),t.addEventListener("scroll",r,{passive:!0}),window.addEventListener("resize",r),()=>{t.removeEventListener("scroll",r),window.removeEventListener("resize",r)}},[l]),null===l)return(0,t.jsx)(a_,{children:"Loading…"});let g=function(e){let a,o=[],t=/^(#{2,3})\s+(.+)$/gm,r=aV();for(;null!==(a=t.exec(e));){let e=a[1].length,t=a[2].trim().replace(/\*\*(.+?)\*\*/g,"$1").replace(/\*(.+?)\*/g,"$1").replace(/`(.+?)`/g,"$1").replace(/\[(.+?)\]\(.+?\)/g,"$1");o.push({level:e,text:t,id:r(t)})}return o}(l),h=a||i,m=aV();return(0,t.jsxs)(aD,{children:[(0,t.jsxs)(aN,{children:[(0,t.jsx)(aW,{ref:p,children:(0,t.jsx)(eB.oz,{remarkPlugins:[eF.A,eR.A,aI],rehypePlugins:[eL.A,eH.A],components:{div({node:e,children:a,...o}){let r=o["data-callout"];return r?(0,t.jsx)(aF,{type:r,children:a}):(0,t.jsx)("div",{...o,children:a})},h1:aq(1,m),h2:aq(2,m),h3:aq(3,m),h4:aq(4,m),pre:({children:e})=>(0,t.jsx)(t.Fragment,{children:e}),code({className:e,children:a}){let o=/language-(\w+)/.exec(e??"")?.[1],r=String(a).replace(/\n$/,"");return"mermaid"===o?(0,t.jsx)(eY,{code:r}):"chart"===o?(0,t.jsx)(e5,{code:r}):"clock"===o?(0,t.jsx)(ar,{code:r}):"vocabulary"===o?(0,t.jsx)(ay,{code:r}):o||r.includes("\n")?(0,t.jsx)(aS,{lang:o,code:r}):(0,t.jsx)("code",{className:e,children:a})}},children:l})}),h&&(0,t.jsxs)(aG,{children:[a?(0,t.jsxs)(aO,{align:"left",onClick:()=>n?.(a),children:[(0,t.jsxs)(aY,{children:[(0,t.jsx)(M,{name:"chevron-left",size:13})," Previous"]}),(0,t.jsx)(aK,{children:a.name})]}):(0,t.jsx)("div",{style:{flex:1}}),i?(0,t.jsxs)(aO,{align:"right",onClick:()=>n?.(i),children:[(0,t.jsxs)(aY,{children:["Next ",(0,t.jsx)(M,{name:"chevron-right",size:13})]}),(0,t.jsx)(aK,{children:i.name})]}):(0,t.jsx)("div",{style:{flex:1}})]})]}),(0,t.jsx)(aE,{headings:g,activeId:c})]})}let aJ=(0,v.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,aZ=(0,v.keyframes)`
...
`,aQ=s().aside`
  ...
  display: flex;
  flex-direction: column;
  animation: ${aZ} 0.22s cubic-bezier(0.4, 0, 0.2, 1) both;
...
`;function on({title:e,sub:a,lang:o}){return(0,t.jsxs)(a6,{children:[(0,t.jsx)(a7,{}),(0,t.jsx)(a8,{size:500,x:10,y:-10,hue:210,dur:7}),(0,t.jsx)(a8,{size:400,x:60,y:50,hue:270,dur:9}),(0,t.jsx)(a8,{size:300,x:30,y:70,hue:190,dur:6}),(0,t.jsxs)(a9,{children:[(0,t.jsx)(oe,{children:e}),(0,t.jsx)(oa,{children:a}),(0,t.jsxs)(oo,{children:[(0,t.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round",children:(0,t.jsx)("polyline",{points:"15 18 9 12 15 6"})}),ot[o]??ot.en]})]})]})}function ol(e,a,o){return"string"==typeof e?e:e[a]??e[o]??Object.values(e)[0]??""}function os({navigation:e,languages:a,defaultLang:o,locale:i,hashPrefix:n,topBarRight:l,welcomeTitle:s="Blog",welcomeSub:c="Notes, guides, and references — pick a topic from the sidebar to get started."}){let d=a?Object.keys(a):[];d.length;let[p,g]=(0,r.useState)(()=>o??d[0]??"");(0,r.useEffect)(()=>{i&&d.includes(i)&&i!==p&&g(i)},[i]);let h=(0,r.useMemo)(()=>a&&p?a[p].navigation:e??{entries:[]},[a,e,p]);(0,r.useMemo)(()=>a3(h.entries),[h]);let m=(0,r.useCallback)(e=>{let a=e.match(RegExp(`^#\\/${n}\\/(.+)$`));if(a)return a5(h.entries,a[1])},[h,n]),[f,x]=(0,r.useState)(()=>m(window.location.hash)??null),[u,b]=(0,r.useState)(!1);(0,r.useEffect)(()=>{f&&x(a5(h.entries,f.id)??null)},[p,h]),(0,r.useEffect)(()=>{let e=()=>{let e=m(window.location.hash);e&&x(e)};return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[m]);let y=(0,r.useCallback)(e=>{e.file&&(x(e),b(!1),window.location.hash=`#/${n}/${e.id}`)},[n]),v=o??d[0]??"",$=or[p]??or[v]??"Menu",z=(0,t.jsx)(oi,{children:(0,t.jsx)(w,{onClick:()=>b(!0),title:$,"aria-label":$,children:(0,t.jsx)(M,{name:"menu",size:16})})}),k=(0,r.useMemo)(()=>a3(h.entries),[h]),j=k.findIndex(e=>e.id===f?.id),S=j>0?k[j-1]:null,T=j<k.length-1?k[j+1]:null,A=f?.label??f?.name??n,C=ol(s,p,o??d[0]??""),B=ol(c,p,o??d[0]??"");return(0,t.jsxs)(et,{title:A,activeId:f?.id??null,topBarRight:(0,t.jsxs)(t.Fragment,{children:[z,l]}),sidebar:(0,t.jsx)(eC,{config:h,activeId:f?.id??null,onSelect:y,hashPrefix:n}),children:[f?.file?(0,t.jsx)(aU,{file:f.file,prevEntry:S,nextEntry:T,onNavigate:y}):(0,t.jsx)(on,{title:C,sub:B,lang:p}),(0,t.jsx)(a4,{open:u,title:$,onClose:()=>b(!1),children:(0,t.jsx)(eC,{config:h,activeId:f?.id??null,onSelect:y,hashPrefix:n})})]})}s().div`
  display: flex;
  gap: 4px;
  background: ${n.w4.colors.surface};
  border: 1px solid ${n.w4.colors.border};
