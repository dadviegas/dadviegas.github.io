...
`;function G({iconKey:e,size:a=16}){if(e&&!(e in B.t))return(0,r.jsx)("span",{style:{fontSize:a,lineHeight:1,display:"flex",alignItems:"center"},children:e});const n=e?B.t[e]??T.A:T.A;return(0,r.jsx)(n,{size:a,strokeWidth:1.75})}function K({entry:e,activeId:a,onSelect:n}){const[o,i]=(0,t.useState)(e.defaultOpen??!0),{collapsed:l,openFlyout:s,scheduleFlyoutClose:d,cancelFlyoutClose:m}=(0,c.c)();return e.children&&e.children.length>0?(0,r.jsxs)(P,{children:[(0,r.jsxs)(R,{collapsed:l,onClick:()=>{l||i(e=>!e)},onMouseEnter:l?a=>{const o=a.currentTarget.getBoundingClientRect();s(e,o.top,n)}:void 0,onMouseLeave:l?d:void 0,children:[(0,r.jsxs)(I,{collapsed:l,children:[(0,r.jsx)(G,{iconKey:e.icon,size:16}),(0,r.jsx)(D,{collapsed:l,children:e.name})]}),(0,r.jsx)(_,{open:o,collapsed:l,children:(0,r.jsx)(C.A,{size:13})})]}),(0,r.jsx)(E,{open:o&&!l,children:(0,r.jsx)(L,{children:(0,r.jsx)(F,{children:e.children.map(e=>(0,r.jsx)(K,{entry:e,activeId:a,onSelect:n},e.id))})})})]}):(0,r.jsxs)(N,{active:a===e.id,collapsed:l,onClick:()=>n(e),onMouseEnter:l?a=>{const o=a.currentTarget.getBoundingClientRect();s({id:e.id,name:e.name,icon:e.icon,file:e.file,children:[e]},o.top,n)}:void 0,onMouseLeave:l?d:void 0,children:[(0,r.jsx)(G,{iconKey:e.icon,size:15}),(0,r.jsx)(D,{collapsed:l,children:e.name})]})}function H({entries:e,activeId:a,onSelect:n}){return(0,r.jsx)("div",{children:e.map(e=>(0,r.jsx)(K,{entry:e,activeId:a,onSelect:n},e.id))})}const O=l.keyframes`
...
`,ge=i.default.div`
  ...
  color: ${o.w4.colors.sidebarTextMuted};
  font-family: ${o.w4.typography.fontFamily};
`;function pe({onSave:e,onUpdate:a,onCancel:n,existingDoc:o}){const[i,l]=(0,t.useState)(o?.name??""),s=(0,t.useRef)(null);return(0,t.useEffect)(()=>{s.current?.focus(),o&&s.current?.select()},[o]),(0,r.jsx)(le,{onClick:n,children:(0,r.jsxs)(se,{onClick:e=>e.stopPropagation(),children:[(0,r.jsx)(ce,{children:"Save document"}),o&&a&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(ge,{children:"Update the current version or save as a new one."}),(0,r.jsxs)(me,{children:[(0,r.jsx)(ue,{onClick:n,children:"Cancel"}),(0,r.jsxs)(ue,{danger:!0,onClick:a,children:['Update "',o.name,'"']})]}),(0,r.jsx)(fe,{})]}),(0,r.jsx)(de,{ref:s,value:i,onChange:e=>l(e.target.value),onKeyDown:t=>{"Enter"===t.key&&i.trim()&&(o&&i.trim()===o.name&&a?a():e(i.trim())),"Escape"===t.key&&n()},placeholder:o?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,r.jsxs)(me,{children:[!o&&(0,r.jsx)(ue,{onClick:n,children:"Cancel"}),(0,r.jsx)(ue,{primary:!0,disabled:!i.trim(),onClick:()=>e(i.trim()),children:"Save as new"})]})]})})}var he=n(5625),ye=n(679),xe=n(4872);const be=i.default.div`
  position: relative;
`,we=i.default.button`
  display: flex;
  align-items: center;
...
`;function Ce({appId:e,onLoad:a}){const[n,o]=(0,t.useState)(!1),[i,l]=(0,t.useState)([]),s=(0,t.useRef)(null),c=(0,t.useCallback)(()=>{(function(e){return te.listDocs(e)})(e).then(l).catch(()=>{})},[e]);(0,t.useEffect)(()=>{if(!n)return;c();const e=e=>{s.current&&!s.current.contains(e.target)&&o(!1)};return document.addEventListener("mousedown",e),()=>document.removeEventListener("mousedown",e)},[n,c]);return(0,r.jsxs)(be,{ref:s,children:[(0,r.jsxs)(we,{onClick:()=>o(e=>!e),children:[(0,r.jsx)(he.A,{size:14}),"Saved",(0,r.jsx)(ye.A,{size:13,style:{marginLeft:2}})]}),(0,r.jsxs)(ze,{open:n,children:[(0,r.jsx)(ve,{children:"Saved versions"}),(0,r.jsx)($e,{children:0===i.length?(0,r.jsx)(Ae,{children:"No saved documents yet."}):i.map(e=>{return(0,r.jsxs)(ke,{children:[(0,r.jsxs)(Me,{onClick:()=>{a(e.content,e.id,e.name),o(!1)},children:[(0,r.jsx)(je,{children:e.name}),(0,r.jsx)(Se,{children:(n=e.savedAt,new Intl.DateTimeFormat(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}).format(new Date(n)))})]}),(0,r.jsx)(Te,{onClick:a=>(async(e,a)=>{e.stopPropagation(),await function(e){return te.deleteDoc(e)}(a),l(e=>e.filter(e=>e.id!==a))})(a,e.id),title:"Delete",children:(0,r.jsx)(xe.A,{size:13})})]},e.id);var n})})]})]})}function Be(e,a=8){const[n,o]=(0,t.useState)(()=>function(e){try{return JSON.parse(localStorage.getItem(e)??"[]")}catch{return[]}}(e));return{recent:n,addRecent:(0,t.useCallback)(n=>{o(o=>{const t=[n,...o.filter(e=>e!==n)].slice(0,a);return function(e,a){try{localStorage.setItem(e,JSON.stringify(a))}catch{}}(e,t),t})},[e,a])}}function Ee(){const e="undefined"!=typeof window?window.location.hash:"",a=e.indexOf("?");if(-1===a)return{};const n={};for(const o of e.slice(a+1).split("&")){if(!o)continue;const e=o.indexOf("=");-1===e?n[decodeURIComponent(o)]="":n[decodeURIComponent(o.slice(0,e))]=decodeURIComponent(o.slice(e+1))}return n}function Le(){const[e,a]=(0,t.useState)(Ee);return(0,t.useEffect)(()=>{const e=()=>a(Ee());return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[]),e}i.default.div`
...
`;i.default.div`
  ...
  background: ${o.w4.colors.mainBg};
  font-family: ${o.w4.typography.fontFamily};
  animation: ${Fe} 0.4s ease 0.15s both;
`,i.default.div`
  position: relative;
  width: 56px;
  height: 56px;
...
`,i.default.div`
  position: absolute;
  inset: 0;
  animation: ${Pe} 1.4s cubic-bezier(0.4, 0, 0.2, 1) infinite;
