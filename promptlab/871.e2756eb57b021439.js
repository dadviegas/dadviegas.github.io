"use strict";(self.webpackChunk_atlantis_promptlab=self.webpackChunk_atlantis_promptlab||[]).push([["871"],{3758(o,r,e){e.d(r,{L:()=>a});var t=e(8113);async function a(o,r,e,a,i,n,l){let s="",d=o=>{o.length<=s.length||(n(o.slice(s.length)),s=o)};"groq"===o?await (0,t.askGroqStream)(i,{key:r,model:e,system:a,onChunk:d,signal:l}):await (0,t.streamGemini)(i,{key:r,model:e,system:a,onChunk:d,signal:l})}},7613(o,r,e){e.d(r,{H:()=>v});var t=e(5723),a=e(7991),i=e(6859),n=e.n(i),l=e(4764),s=e(18),d=e(8035);let p=n().div`
  display: flex;
...
`,k={groq:"#f55036",gemini:"#4285f4"};function z({run:o}){let[r,e]=(0,d.useState)(!1),a=p.L.find(r=>r.id===o.modelId),i=a?.label??o.modelId,n=k[o.provider]??l.w4.colors.accent,c=async()=>{o.output&&(await navigator.clipboard.writeText(o.output),e(!0),setTimeout(()=>e(!1),1500))};return(0,t.jsxs)(g,{children:[(0,t.jsxs)(x,{children:[(0,t.jsxs)(f,{accentColor:n,children:[(0,t.jsx)(h,{children:o.provider}),i]}),(0,t.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:"8px"},children:["done"===o.status&&null!=o.durationMs&&(0,t.jsxs)(b,{children:[(o.durationMs/1e3).toFixed(1),"s"]}),o.output&&(0,t.jsx)(M,{onClick:c,title:"Copy output",children:r?(0,t.jsx)(s.In,{name:"check",size:13}):(0,t.jsx)(s.In,{name:"copy",size:13})})]})]}),(0,t.jsxs)(m,{children:["idle"===o.status&&(0,t.jsx)(u,{children:"Response will appear here..."}),"error"===o.status&&o.error?.includes("rate limit")&&(0,t.jsxs)($,{children:[(0,t.jsx)(v,{children:"⚠️"}),(0,t.jsx)("div",{children:o.error})]}),"error"===o.status&&!o.error?.includes("rate limit")&&(0,t.jsx)(y,{children:o.error}),("streaming"===o.status||"done"===o.status)&&(0,t.jsx)(w,{streaming:"streaming"===o.status,children:o.output})]})]})}},7871(o,r,e){e.d(r,{Vc:()=>i,cR:()=>n,yr:()=>l});var t=e(8113);let a={groq:"",gemini:""};function i(){let o=(0,t.loadApiKeysSync)();return{...a,groq:o.groq??"",gemini:o.gemini??""}}function n(o){(0,t.saveApiKeys)({groq:o.groq,gemini:o.gemini})}function l(o){return!!(o.groq||o.gemini)}},8035(o,r,e){e.d(r,{L:()=>i,x:()=>a});var t=e(8113);let a=[{id:"groq",label:"Groq",url:"https://console.groq.com"},{id:"gemini",label:"Google Gemini",url:"https://aistudio.google.com/apikey"}],i=[...t.GROQ_MODELS.map(o=>({provider:"groq",id:o.id,label:o.label})),...t.GEMINI_MODELS.map(o=>({provider:"gemini",id:o.id,label:o.label}))]},18(o,r,e){e.d(r,{MJ:()=>D,In:()=>y});var t=e(5723),a=e(7991),i=e(6859),n=e.n(i),l=e(4764);let s={ghost:"transparent",accent:"transparent",primary:l.w4.colors.accent,success:"#238636",danger:"#da3633"},d={ghost:l.w4.colors.sidebarHover,accent:"rgba(88,166,255,0.10)",primary:l.w4.colors.accentHover,success:"#2ea043",danger:"#f85149"},p={ghost:l.w4.colors.border,accent:l.w4.colors.accent,primary:l.w4.colors.accent,success:"#238636",danger:"#da3633"},c={ghost:l.w4.colors.mainTextMuted,accent:l.w4.colors.accent,primary:"#fff",success:"#fff",danger:"#fff"},g={ghost:l.w4.colors.mainText,accent:l.w4.colors.accent,primary:"#fff",success:"#fff",danger:"#fff"},x={sm:"28px",md:"30px"},f={sm:"0 10px",md:"0 12px"},h={sm:"12px",md:"12px"};n().button`
  display: inline-flex;
  align-items: center;
  justify-content: center;
  gap: 6px;
...
`,n().span`
  ...
  display: inline-block;
`;let k={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:l.w4.colors.accentMuted},z={neutral:l.w4.colors.mainTextMuted,live:l.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:l.w4.colors.accent};n().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${l.w4.typography.fontFamilyMono};
...
`,K=n().div`
  ...
  color: ${l.w4.colors.sidebarTextMuted};
  font-family: ${l.w4.typography.fontFamily};
`;function D({onSave:o,onUpdate:r,onCancel:e,existingDoc:i}){let[n,l]=(0,a.useState)(i?.name??""),s=(0,a.useRef)(null);return(0,a.useEffect)(()=>{s.current?.focus(),i&&s.current?.select()},[i]),(0,t.jsx)(Y,{onClick:e,children:(0,t.jsxs)(q,{onClick:o=>o.stopPropagation(),children:[(0,t.jsx)(I,{children:"Save document"}),i&&r&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(K,{children:"Update the current version or save as a new one."}),(0,t.jsxs)(G,{children:[(0,t.jsx)(O,{onClick:e,children:"Cancel"}),(0,t.jsxs)(O,{danger:!0,onClick:r,children:['Update "',i.name,'"']})]}),(0,t.jsx)(E,{})]}),(0,t.jsx)(P,{ref:s,value:n,onChange:o=>l(o.target.value),onKeyDown:t=>{"Enter"===t.key&&n.trim()&&(i&&n.trim()===i.name&&r?r():o(n.trim())),"Escape"===t.key&&e()},placeholder:i?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,t.jsxs)(G,{children:[!i&&(0,t.jsx)(O,{onClick:e,children:"Cancel"}),(0,t.jsx)(O,{primary:!0,disabled:!n.trim(),onClick:()=>o(n.trim()),children:"Save as new"})]})]})})}let X=(0,w.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,_=(0,w.keyframes)`
