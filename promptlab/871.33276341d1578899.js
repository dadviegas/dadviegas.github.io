"use strict";(self.webpackChunk_atlantis_promptlab=self.webpackChunk_atlantis_promptlab||[]).push([["871"],{3758(e,o,r){r.d(o,{L:()=>a});var t=r(4659);async function a(e,o,r,a,i,n,l){let s="",d=e=>{e.length<=s.length||(n(e.slice(s.length)),s=e)};"groq"===e?await (0,t.askGroqStream)(i,{key:o,model:r,system:a,onChunk:d,signal:l}):await (0,t.streamGemini)(i,{key:o,model:r,system:a,onChunk:d,signal:l})}},7613(e,o,r){r.d(o,{H:()=>v});var t=r(5723),a=r(7991),i=r(6859),n=r.n(i),l=r(6063),s=r(3501),d=r(8035);let c=n().div`
  display: flex;
...
`;let m={default:s.w4.colors.accent,danger:"#f85149"},w={default:s.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"};l().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`,_=l().div`
  ...
  color: ${s.w4.colors.sidebarTextMuted};
  font-family: ${s.w4.typography.fontFamily};
`;function K({onSave:e,onUpdate:o,onCancel:r,existingDoc:i}){let[n,l]=(0,a.useState)(i?.name??""),s=(0,a.useRef)(null);return(0,a.useEffect)(()=>{s.current?.focus(),i&&s.current?.select()},[i]),(0,t.jsx)(Y,{onClick:r,children:(0,t.jsxs)(I,{onClick:e=>e.stopPropagation(),children:[(0,t.jsx)(q,{children:"Save document"}),i&&o&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(_,{children:"Update the current version or save as a new one."}),(0,t.jsxs)(E,{children:[(0,t.jsx)(G,{onClick:r,children:"Cancel"}),(0,t.jsxs)(G,{danger:!0,onClick:o,children:['Update "',i.name,'"']})]}),(0,t.jsx)(O,{})]}),(0,t.jsx)(P,{ref:s,value:n,onChange:e=>l(e.target.value),onKeyDown:t=>{"Enter"===t.key&&n.trim()&&(i&&n.trim()===i.name&&o?o():e(n.trim())),"Escape"===t.key&&r()},placeholder:i?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,t.jsxs)(E,{children:[!i&&(0,t.jsx)(G,{onClick:r,children:"Cancel"}),(0,t.jsx)(G,{primary:!0,disabled:!n.trim(),onClick:()=>e(n.trim()),children:"Save as new"})]})]})})}let X=(0,u.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,D=(0,u.keyframes)`
...
`,l().div`
  position: relative;
`;let N="260px",Q="56px",J="48px",ee=l().header`
  display: flex;
  align-items: center;
...
`,ei=l().span`
  ...
  animation: ${et} 10s ease ${({index:e})=>.07*e}s infinite;
...
`,ed=l().div`
  ...
  overflow: hidden;
`,ec=l().aside`
  width: ${({collapsed:e})=>e?Q:N};
  min-width: ${({collapsed:e})=>e?Q:N};
  background: ${s.w4.colors.sidebarBg};
  border-right: 1px solid ${s.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,eg=l().main`
  ...
  display: flex;
  flex-direction: column;
`,eh=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function ex(){return(0,t.jsx)(ea,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:eh.map((e,o)=>(0,t.jsx)(ei,{index:o,accent:e.accent,children:e.char},o))})}let ef="atlantis:sidebar-collapsed";function eb({sidebar:e,children:o,topBarRight:n,title:l="Atlantis",activeId:s=null}){let[d,c]=(0,a.useState)(()=>{try{return"true"===localStorage.getItem(ef)}catch{return!1}}),[p,g]=(0,a.useState)(null),h=(0,a.useRef)(),x=()=>c(e=>{let o=!e;try{localStorage.setItem(ef,String(o))}catch{}return o}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(r.bind(r,5816)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,t.jsx)(B.I.Provider,{value:{collapsed:d,toggle:x,flyout:p,openFlyout:(e,o,r)=>{clearTimeout(h.current),g({entry:e,anchorY:o,onSelect:r})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,t.jsxs)(ed,{children:[(0,t.jsxs)(ee,{children:[e&&(0,t.jsx)(eo,{children:(0,t.jsx)(er,{onClick:x,title:d?"Expand sidebar":"Collapse sidebar",children:(0,t.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("path",{d:"M9 3v18"})]})})}),(0,t.jsx)(ex,{}),l&&(0,t.jsx)(en,{children:l}),n&&(0,t.jsx)(el,{children:n})]}),(0,t.jsxs)(es,{children:[null!=e&&(0,t.jsx)(ec,{collapsed:d,children:(0,t.jsx)(ep,{children:e})}),(0,t.jsx)(eg,{children:o})]}),p&&(0,t.jsx)(i().Suspense,{fallback:null,children:(0,t.jsx)(f,{activeId:s})})]})})}l().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
