...
`,i.default.div`
  background: ${t.w.colors.sidebarBg};
  border: 1px solid ${t.w.colors.sidebarBorder};
  border-radius: ${t.w.borderRadius.lg};
  padding: 24px;
  width: 360px;
  ...
  gap: 16px;
`,i.default.div`
  font-size: ${t.w.typography.fontSizeMd};
  font-weight: 700;
  color: ${t.w.colors.mainText};
  font-family: ${t.w.typography.fontFamily};
`,i.default.input`
  ...
  color: ${t.w.colors.mainText};
  font-size: ${t.w.typography.fontSizeBase};
  font-family: ${t.w.typography.fontFamilyMono};
  outline: none;
  box-sizing: border-box;
  transition: border-color 0.15s;

  &:focus { border-color: ${t.w.colors.accent}; }
  &::placeholder { color: ${t.w.colors.sidebarTextMuted}; }
`,i.default.div`
  display: flex;
  gap: 10px;
  justify-content: flex-end;
`,i.default.button`
  ...
  background: ${({primary:e,danger:o})=>o?"rgba(248,81,73,0.15)":e?t.w.colors.accent:"none"};
  color: ${({primary:e,danger:o})=>o?"#f85149":e?"#fff":t.w.colors.mainText};
  border: 1px solid ${({primary:e,danger:o})=>o?"#f85149":e?t.w.colors.accent:t.w.colors.border};

  &:hover { opacity: 0.85; }
  &:disabled { opacity: 0.4; cursor: default; }
`,i.default.div`
  height: 1px;
  background: ${t.w.colors.border};
  margin: 0 -4px;
`,i.default.div`
  font-size: 11px;
  color: ${t.w.colors.sidebarTextMuted};
...
`,i.default.button`
  ...
  background: none;
  border: none;
  border-radius: ${t.w.borderRadius.sm};
  cursor: pointer;
  color: ${t.w.colors.sidebarTextMuted};
...
`,$=t.default.div`
  ...
  font-weight: 700;
  color: #a78bfa;
`,S=t.default.div`padding: 20px 16px 0;`,C=t.default.button`
  display: flex;
  align-items: center;
  width: 100%;
  padding: 18px 20px;
...
`,M=t.default.span`font-size: 36px;`,T=t.default.div`
  flex: 1;
  text-align: left;
`,B=t.default.div`
  font-size: 18px;
...
`,N=t.default.div`
  ...
  justify-content: space-between;
  margin-bottom: 10px;
`,I=t.default.div`font-size: 48px; line-height: 1; filter: drop-shadow(0 2px 6px #00000040);`,D=t.default.div`
  font-size: 11px;
  font-weight: 800;
  color: ${({color:e})=>e};
  background: ${({color:e})=>e}25;
...
`,H=i.default.div`font-size: 42px; line-height: 1;`,_=i.default.div`
  font-size: 30px;
  font-weight: 900;
  color: ${({color:e})=>e};
`,W=i.default.div`
