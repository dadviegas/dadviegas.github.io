...
`},87330(e,o,a){a.d(o,{FlyoutPanel:()=>eR});var t=a(65723),r=a(37991),n=a.n(r),i=a(36859),l=a.n(i),s=a(72799),d=a(20255),c=a(81316),p=a(40814),g=a(36896),m=a(87902),f=a(53013),u=a(32887),x=a(49510),h=a(39848),b=a(37901),w=a(3045),y=a(43775),$=a(41783),v=a(83539),z=a(39416),k=a(1837),M=a(57167),A=a(84494),T=a(82314),S=a(35751),j=a(69633),F=a(92946),B=a(40822),C=a(36720),R=a(57400),P=a(58456),E=a(43317),L=a(52709),H=a(8006),N=a(89301),D=a(37561),I=a(83517),V=a(28207),G=a(37032),Y=a(6949),K=a(8218),O=a(36829),q=a(59591),W=a(15553),_=a(69923),U=a(72820),J=a(14621),Z=a(68479),X=a(72534),Q=a(66673),ee=a(67490),eo=a(49033),ea=a(99038),et=a(45775),er=a(31365),en=a(62937),ei=a(9821),el=a(65912),es=a(80158),ed=a(88641),ec=a(48607),ep=a(83249),eg=a(1821),em=a(15889),ef=a(89655),eu=a(27170),ex=a(19161),eh=a(71849),eb=a(41604),ew=a(13142),ey=a(61187),e$=a(77747),ev=a(2932),ez=a(24525),ek=a(57230),eM=a(22164);let eA={activity:g.A,"a-large-small":m.A,apple:f.A,"arrow-right":u.A,"bar-chart-2":x.A,book:h.A,"book-open":b.A,briefcase:w.A,calendar:y.A,clock:$.A,"circle-dot":v.A,cloud:z.A,compass:k.A,cpu:M.A,droplets:A.A,feather:T.A,file:d.A,"file-text":S.A,folder:j.A,"git-branch":F.A,github:B.A,globe:C.A,grid:R.A,hand:P.A,hash:E.A,heart:L.A,key:H.A,hexagon:N.A,home:D.A,landmark:I.A,layers:V.A,"layout-grid":G.A,leaf:Y.A,lightbulb:K.A,list:O.A,map:q.A,"map-pin":W.A,"message-circle":_.A,"message-square":U.A,minus:J.A,monitor:Z.A,mountain:X.A,package:Q.A,palette:ee.A,"pen-tool":eo.A,"pie-chart":ea.A,plane:et.A,plus:er.A,ruler:en.A,shirt:ei.A,slash:el.A,square:es.A,star:ed.A,sun:ec.A,terminal:ep.A,thermometer:eg.A,triangle:em.A,trophy:ef.A,truck:eu.A,type:ex.A,users:eh.A,"volume-2":eb.A,watch:ew.A,waves:ey.A,wind:e$.A,wrench:ev.A,x:ez.A,zap:ek.A,bot:eM.A},eT=(0,s.keyframes)`
...
`;function eB({iconKey:e}){let o=e?eA[e]??d.A:d.A;return(0,t.jsx)(o,{size:14,strokeWidth:1.75})}function eC({entries:e,activeId:o,onSelect:a}){return(0,t.jsx)(t.Fragment,{children:e.map(e=>e.children?(0,t.jsx)(n().Fragment,{children:(0,t.jsx)(eC,{entries:e.children,activeId:o,onSelect:a})},e.id):(0,t.jsxs)(eF,{active:o===e.id,onClick:()=>a(e),children:[(0,t.jsx)(eB,{iconKey:e.icon}),e.name]},e.id))})}function eR({activeId:e}){let{flyout:o,scheduleFlyoutClose:a,cancelFlyoutClose:r}=(0,p.c)();if(!o)return null;let n=o.entry.icon?eA[o.entry.icon]??d.A:d.A;return(0,t.jsxs)(eS,{anchorY:o.anchorY,onMouseEnter:r,onMouseLeave:a,children:[(0,t.jsxs)(ej,{children:[(0,t.jsx)(n,{size:13,strokeWidth:2}),o.entry.name]}),(0,t.jsx)(eC,{entries:o.entry.children??[],activeId:e,onSelect:e=>{o.onSelect(e),a()}})]})}},40814(e,o,a){a.d(o,{I:()=>r,c:()=>n});var t=a(37991);let r=(0,t.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),n=()=>(0,t.useContext)(r)},41749(e,o,a){a.d(o,{kd:()=>I,Zf:()=>X,w4:()=>t.w4,mZ:()=>N,KL:()=>H,fy:()=>q,Is:()=>V,cL:()=>p.c,Iu:()=>D,hY:()=>Z,PE:()=>B,PL:()=>G});var t=a(81316),r=a(65723),n=a(37991),i=a.n(n),l=a(36859),s=a.n(l);s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,T=s().main`
  ...
  display: flex;
  flex-direction: column;
`,S=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function j(){return(0,r.jsx)(w,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:S.map((e,o)=>(0,r.jsx)(y,{index:o,accent:e.accent,children:e.char},o))})}let F="atlantis:sidebar-collapsed";function B({sidebar:e,children:o,topBarRight:t,title:l="Atlantis",activeId:s=null}){let[d,g]=(0,n.useState)(()=>{try{return"true"===localStorage.getItem(F)}catch{return!1}}),[m,f]=(0,n.useState)(null),b=(0,n.useRef)(),w=()=>g(e=>{let o=!e;try{localStorage.setItem(F,String(o))}catch{}return o}),y=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(a.bind(a,87330)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(p.I.Provider,{value:{collapsed:d,toggle:w,flyout:m,openFlyout:(e,o,a)=>{clearTimeout(b.current),f({entry:e,anchorY:o,onSelect:a})},scheduleFlyoutClose:()=>{b.current=setTimeout(()=>f(null),160)},cancelFlyoutClose:()=>clearTimeout(b.current)},children:(0,r.jsxs)(k,{children:[(0,r.jsxs)(u,{children:[e&&(0,r.jsx)(x,{children:(0,r.jsx)(h,{onClick:w,title:d?"Expand sidebar":"Collapse sidebar",children:(0,r.jsx)(c.A,{size:17})})}),(0,r.jsx)(j,{}),l&&(0,r.jsx)($,{children:l}),t&&(0,r.jsx)(v,{children:t})]}),(0,r.jsxs)(z,{children:[null!=e&&(0,r.jsx)(M,{collapsed:d,children:(0,r.jsx)(A,{children:e})}),(0,r.jsx)(T,{children:o})]}),m&&(0,r.jsx)(i().Suspense,{fallback:null,children:(0,r.jsx)(y,{activeId:s})})]})})}s().div`
  display: grid;
...
`;function O(){let e="u">typeof window?window.location.hash:"",o=e.indexOf("?");if(-1===o)return{};let a={};for(let t of e.slice(o+1).split("&")){if(!t)continue;let e=t.indexOf("=");-1===e?a[decodeURIComponent(t)]="":a[decodeURIComponent(t.slice(0,e))]=decodeURIComponent(t.slice(e+1))}return a}function q(){let[e,o]=(0,n.useState)(O);return(0,n.useEffect)(()=>{let e=()=>o(O());return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[]),e}s().div`
  position: fixed;
  inset: 0;
...
`,s().div`
  ...
  flex-direction: column;
  gap: 14px;
  animation: ${K} 0.18s cubic-bezier(0.22, 1, 0.36, 1) both;
`,s().div`
  font-size: ${t.w4.typography.fontSizeMd};
  font-weight: 700;
...
`;let J="atlantis:api-keys";async function Z(){try{let e=await G(J);if(e){let o=JSON.parse(e);if(o.groq&&o.groq.length>0)return o.groq}}catch{}let e=function(){if("u"<typeof localStorage)return null;try{let e=localStorage.getItem(J);if(e){let o=JSON.parse(e);if(o.groq&&o.groq.length>0)return o.groq}let o=localStorage.getItem("atlantis:promptlab:keys");if(o){let e=JSON.parse(o);if(e.groq&&e.groq.length>0)return e.groq}}catch{}return null}();if(e)return e;if("u"<typeof process)return null;let o=process.env?.GROK_API_KEY;return o&&0!==o.length?o:null}async function X(e,o){let a="pt"===o.locale?"Portuguese":"English",t=o.system??`You are Atlantis, a concise personal-dashboard assistant.
...
`,b=n().forwardRef(function({variant:e="ghost",size:o="md",icon:a,iconRight:r,children:n,...i},l){return(0,t.jsxs)(h,{ref:l,variant:e,size:o,...i,children:[a,n,r]})}),w={default:s.w4.colors.accent,danger:"#f85149"},y={default:s.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"},$=l().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`,v=n().forwardRef(function({active:e=!1,shape:o="square",tone:a="default",children:r,...n},i){return(0,t.jsx)($,{ref:i,active:e,shape:o,tone:a,...n,children:r})}),z=l().div`
  position: relative;
  display: inline-flex;
`,k=l().div`
  position: absolute;
  ...
  z-index: 2000;
  overflow: hidden;
`;function M({trigger:e,children:o,align:a="right",open:i,onOpenChange:l}){let[s,d]=(0,r.useState)(!1),c=i??s,p=e=>{l&&l(e),void 0===i&&d(e)},g=(0,r.useRef)(null);(0,r.useEffect)(()=>{if(!c)return;let e=e=>{g.current&&!g.current.contains(e.target)&&p(!1)};return document.addEventListener("mousedown",e),()=>document.removeEventListener("mousedown",e)},[c]);let m=n().cloneElement(e,{onClick:o=>{e.props.onClick?.(o),p(!c)},"aria-expanded":c,"aria-haspopup":"menu"});return(0,t.jsxs)(z,{ref:g,children:[m,c&&(0,t.jsx)(k,{align:a,role:"menu",children:o})]})}let A=l().button`
  display: flex;
  align-items: center;
  gap: 10px;
  padding: 8px 12px;
...
`;let E=l().kbd`
  ...
  white-space: nowrap;
`;function L({children:e,...o}){return(0,t.jsx)(E,{...o,children:e})}let H=l().div`
  font-family: ${s.w4.typography.fontFamilyMono};
  font-size: 11px;
  ...
  align-items: center;
  gap: 8px;
`;function N({children:e,...o}){return(0,t.jsx)(H,{...o,children:e})}l().label`
  display: flex;
  align-items: center;
  gap: 10px;
...
`,W=!1;function _(e){if("u"<typeof window)return e;let o=e.match(/^var\((--[-\w]+)\)$/);return o&&getComputedStyle(document.documentElement).getPropertyValue(o[1]).trim()||e}function U({code:e}){let o=(0,r.useRef)(null),[n,i]=(0,r.useState)(null),[l,d]=(0,r.useState)(!1);return((0,r.useEffect)(()=>{let t=!1;if(i(null),d(!1),!e.trim())return void d(!0);let r=e.trim().split(/\r?\n/)[0]?.trim()??"";return/^(?:---[\s\S]*?---\s*)?(?:graph|flowchart|sequenceDiagram|classDiagram|stateDiagram(?:-v2)?|erDiagram|pie|gantt|journey|mindmap|gitGraph|sankey(?:-beta)?|quadrantChart|requirementDiagram|timeline|xychart-beta|block-beta|C4Context|C4Container|C4Component|C4Dynamic|C4Deployment)\b/.test(r)?(async function(){let r=(await a.e("6087").then(a.bind(a,29738))).default;if(W||(r.initialize({startOnLoad:!1,theme:"dark",themeVariables:{background:_(s.w4.colors.codeBg),primaryColor:_(s.w4.colors.accent),primaryTextColor:_(s.w4.colors.mainText),lineColor:_(s.w4.colors.border)}}),W=!0),o.current&&!t)try{let a=`mermaid-${Math.random().toString(36).slice(2)}`,{svg:n}=await r.render(a,e);if(t||!o.current)return;if(/aria-roledescription="error"|class="error-icon"|>Syntax error/i.test(n))return void d(!0);o.current.innerHTML=n,requestAnimationFrame(()=>{if(t||!o.current)return;let e=o.current.querySelector("svg");if(!e)return void d(!0);let a=e.getBoundingClientRect();(a.width<40||a.height<40)&&d(!0)})}catch(e){t||i(e instanceof Error?e.message:String(e))}}(),()=>{t=!0}):void d(!0)},[e]),n||l)?(0,t.jsx)(q,{children:e.trim()}):(0,t.jsx)(O,{ref:o})}let J=["#388bfd","#3fb950","#d29922","#a371f7","#f87171","#22d3ee","#fb923c","#34d399","#f472b6","#818cf8"],Z=l().div`
  background: ${s.w4.colors.codeBg};
  border: 1px solid ${s.w4.colors.codeBorder};
  border-radius: ${s.w4.borderRadius.md};
  padding: ${s.w4.spacing.lg};
...
`,ea=l().pre`
  ...
  color: ${s.w4.colors.mainTextMuted};
  white-space: pre-wrap;
`;function et(e){if(e<=0)return 10;let o=Math.pow(10,Math.floor(Math.log10(e)));return Math.ceil(e/o)*o}function er({labels:e,data:o,colors:a}){let r=340,n=176,i=et(Math.max(...o,1)),l=Math.min(40,r/e.length*.6),d=r/e.length,c=Array.from({length:6},(e,o)=>i/5*o);return(0,t.jsxs)("svg",{viewBox:"0 0 400 240",width:"100%",style:{maxWidth:400},children:[c.map((e,o)=>{let a=16+n-e/i*n;return(0,t.jsxs)("g",{children:[(0,t.jsx)("line",{x1:44,y1:a,x2:384,y2:a,stroke:s.w4.colors.border,strokeWidth:.5,strokeDasharray:0===o?"none":"3,3"}),(0,t.jsx)("text",{x:38,y:a+4,fill:s.w4.colors.mainTextMuted,fontSize:10,textAnchor:"end",fontFamily:s.w4.typography.fontFamily,children:Math.round(e)})]},o)}),o.map((o,r)=>{let c=44+d*r+d/2-l/2,p=o/i*n,g=16+n-p,m=a[r%a.length];return(0,t.jsxs)("g",{children:[(0,t.jsxs)("rect",{x:c,y:g,width:l,height:p,rx:3,fill:m,opacity:.85,children:[(0,t.jsx)("animate",{attributeName:"height",from:"0",to:p,dur:"0.5s",fill:"freeze"}),(0,t.jsx)("animate",{attributeName:"y",from:16+n,to:g,dur:"0.5s",fill:"freeze"})]}),(0,t.jsx)("text",{x:c+l/2,y:g-4,fill:s.w4.colors.mainText,fontSize:10,fontWeight:600,textAnchor:"middle",fontFamily:s.w4.typography.fontFamily,children:o}),(0,t.jsx)("text",{x:44+d*r+d/2,y:208,fill:s.w4.colors.mainTextMuted,fontSize:10,textAnchor:"middle",fontFamily:s.w4.typography.fontFamily,children:e[r].length>8?e[r].slice(0,7)+"…":e[r]})]},r)})]})}function en({labels:e,data:o,colors:a}){let r=o.reduce((e,o)=>e+o,0)||1,n=-Math.PI/2,i=o.map((e,o)=>{let i=e/r*Math.PI*2,l=n,d=n+=i,c=120+90*Math.cos(l),p=120+90*Math.sin(l),g=120+90*Math.cos(d),m=120+90*Math.sin(d),f=+(i>Math.PI),u=l+i/2,x=120+58.5*Math.cos(u),h=120+58.5*Math.sin(u),b=Math.round(e/r*100);return(0,t.jsxs)("g",{children:[(0,t.jsx)("path",{d:`M 120 120 L ${c} ${p} A 90 90 0 ${f} 1 ${g} ${m} Z`,fill:a[o%a.length],stroke:s.w4.colors.codeBg,strokeWidth:2,opacity:.85}),b>=5&&(0,t.jsxs)("text",{x:x,y:h+4,fill:"#fff",fontSize:11,fontWeight:600,textAnchor:"middle",fontFamily:s.w4.typography.fontFamily,children:[b,"%"]})]},o)});return(0,t.jsx)("svg",{viewBox:"0 0 240 240",width:"100%",style:{maxWidth:240},children:i})}function ei({labels:e,data:o,colors:a}){let r=340,n=176,i=et(Math.max(...o,1)),l=o.length>1?r/(o.length-1):r,d=a[0],c=o.map((e,o)=>({x:44+l*o,y:16+n-e/i*n})),p=c.map((e,o)=>`${0===o?"M":"L"} ${e.x} ${e.y}`).join(" "),g=Array.from({length:6},(e,o)=>i/5*o);return(0,t.jsxs)("svg",{viewBox:"0 0 400 240",width:"100%",style:{maxWidth:400},children:[g.map((e,o)=>{let a=16+n-e/i*n;return(0,t.jsxs)("g",{children:[(0,t.jsx)("line",{x1:44,y1:a,x2:384,y2:a,stroke:s.w4.colors.border,strokeWidth:.5,strokeDasharray:0===o?"none":"3,3"}),(0,t.jsx)("text",{x:38,y:a+4,fill:s.w4.colors.mainTextMuted,fontSize:10,textAnchor:"end",fontFamily:s.w4.typography.fontFamily,children:Math.round(e)})]},o)}),(0,t.jsx)("path",{d:p,fill:"none",stroke:d,strokeWidth:2.5,strokeLinecap:"round",strokeLinejoin:"round"}),c.map((a,r)=>(0,t.jsxs)("g",{children:[(0,t.jsx)("circle",{cx:a.x,cy:a.y,r:4,fill:d,stroke:s.w4.colors.codeBg,strokeWidth:2}),(0,t.jsx)("text",{x:a.x,y:a.y-10,fill:s.w4.colors.mainText,fontSize:10,fontWeight:600,textAnchor:"middle",fontFamily:s.w4.typography.fontFamily,children:o[r]}),(0,t.jsx)("text",{x:a.x,y:208,fill:s.w4.colors.mainTextMuted,fontSize:10,textAnchor:"middle",fontFamily:s.w4.typography.fontFamily,children:e[r].length>8?e[r].slice(0,7)+"…":e[r]})]},r))]})}function el({code:e}){let o=(0,r.useMemo)(()=>(function(e){let o,a,t=e.trim().split("\n"),r="bar",n=[],i=[];for(let e of t){let[t,...l]=e.split(":"),s=l.join(":").trim();if(s)switch(t.trim().toLowerCase()){case"type":["bar","pie","line"].includes(s.toLowerCase())&&(r=s.toLowerCase());break;case"title":o=s;break;case"labels":n=s.replace(/^\[|\]$/g,"").split(",").map(e=>e.trim());break;case"data":i=s.replace(/^\[|\]$/g,"").split(",").map(e=>parseFloat(e.trim())||0);break;case"colors":a=s.replace(/^\[|\]$/g,"").split(",").map(e=>e.trim())}}return n.length&&i.length?{type:r,title:o,labels:n,data:i,colors:a}:null})(e),[e]);if(!o)return(0,t.jsx)(ea,{children:e.trim()});let a=o.colors??J;return(0,t.jsxs)(Z,{children:[o.title&&(0,t.jsx)(X,{children:o.title}),"bar"===o.type&&(0,t.jsx)(er,{labels:o.labels,data:o.data,colors:a}),"pie"===o.type&&(0,t.jsx)(en,{labels:o.labels,data:o.data,colors:a}),"line"===o.type&&(0,t.jsx)(ei,{labels:o.labels,data:o.data,colors:a}),(0,t.jsx)(Q,{children:o.labels.map((e,o)=>(0,t.jsxs)(ee,{children:[(0,t.jsx)(eo,{color:a[o%a.length]}),e]},o))})]})}l().div`
  background: ${s.w4.colors.codeBg};
  border: 1px solid ${s.w4.colors.codeBorder};
  border-radius: ${s.w4.borderRadius.md};
  padding: ${s.w4.spacing.lg};
...
`,l().span`
  font-size: ${s.w4.typography.fontSizeBase};
  color: ${s.w4.colors.mainTextMuted};
`;var ec=a(17223),ep=a(21426),eg=a(25609),em=a(20320);let ef=l().div`
  margin: ${s.w4.spacing.lg} 0;
  border-radius: ${s.w4.borderRadius.md};
  border: 1px solid ${s.w4.colors.codeBorder};
  overflow: hidden;
...
`,eb={...ep.A,'pre[class*="language-"]':{...ep.A['pre[class*="language-"]'],background:s.w4.colors.codeBg,margin:0,padding:"18px 20px",fontSize:"13px",lineHeight:"1.6",borderRadius:0},'code[class*="language-"]':{...ep.A['code[class*="language-"]'],background:"none",fontSize:"13px"}};function ew({lang:e="text",code:o}){let[a,n]=(0,r.useState)(!1);return(0,t.jsxs)(ef,{children:[(0,t.jsxs)(eu,{children:[(0,t.jsx)(ex,{children:e}),(0,t.jsxs)(eh,{copied:a,onClick:()=>{navigator.clipboard.writeText(o).then(()=>{n(!0),setTimeout(()=>n(!1),2e3)})},children:[a?(0,t.jsx)(eg.A,{size:12}):(0,t.jsx)(em.A,{size:12}),a?"Copied!":"Copy"]})]}),(0,t.jsx)(ec.A,{language:e,style:eb,showLineNumbers:o.split("\n").length>8,lineNumberStyle:{color:"#484f58",minWidth:"2.5em",paddingRight:"1.5em",userSelect:"none",fontSize:"12px"},customStyle:{margin:0,background:s.w4.colors.codeBg},wrapLongLines:!1,children:o})]})}var ey=a(65569),e$=a(8218),ev=a(57230),ez=a(22966),ek=a(21069);let eM={NOTE:{bg:"rgba(88, 166, 255, 0.08)",border:"#58a6ff",icon:ey.A,label:"Note",color:"#58a6ff"},TIP:{bg:"rgba(63, 185, 80, 0.08)",border:"#3fb950",icon:e$.A,label:"Tip",color:"#3fb950"},IMPORTANT:{bg:"rgba(163, 113, 247, 0.08)",border:"#a371f7",icon:ev.A,label:"Important",color:"#a371f7"},WARNING:{bg:"rgba(210, 153, 34, 0.08)",border:"#d29922",icon:ez.A,label:"Warning",color:"#d29922"},CAUTION:{bg:"rgba(248, 81, 73, 0.08)",border:"#f85149",icon:ek.A,label:"Caution",color:"#f85149"}},eA=l().div`
  background: ${({bg:e})=>e};
...
`;function ej({type:e,children:o}){let a=eM[e]??eM.NOTE,r=a.icon;return(0,t.jsxs)(eA,{bg:a.bg,border:a.border,children:[(0,t.jsxs)(eT,{color:a.color,children:[(0,t.jsx)(r,{size:15,strokeWidth:2}),a.label]}),(0,t.jsx)(eS,{children:o})]})}l().nav`
  width: 220px;
  min-width: 220px;
...
`,l().div`
  ...
  font-family: ${s.w4.typography.fontFamily};
`;let eF=(0,T.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,eB=(0,T.keyframes)`
  from { opacity: 0; transform: translateY(16px) scale(0.98); }
  to   { opacity: 1; transform: translateY(0) scale(1); }
`;function eC(){let e=/^\[!(NOTE|TIP|WARNING|CAUTION|IMPORTANT)\]\s*/i;return o=>{function a(o,a,t){let r=a.children?.[0];r?.type==="text"&&(r.value=r.value.replace(e,""),r.value.trim()||1!==a.children.length||a.children.shift()),o.data=o.data??{},o.data.hName="div",o.data.hProperties={"data-callout":t.toUpperCase()}}!function o(t){if("blockquote"===t.type){let o=t.children?.[0];if(o?.type==="paragraph"){let r=o.children?.[0],n=r?.type==="text"&&r.value?.match(e);n&&a(t,o,n[1])}}if("paragraph"===t.type){let o=t.children?.[0],r=o?.type==="text"&&o.value?.match(e);if(r){let o=[...t.children];t.children=[{type:"paragraph",children:o}],a(t,t.children[0],r[1]);let n=o[0];n?.type==="text"&&(n.value=n.value.replace(e,""),n.value.trim()||1!==o.length||o.shift());return}}t.children?.forEach(o)}(o)}}l().div`
  position: fixed;
  inset: 0;
  z-index: 9999;
...
`;function eP({children:e}){return(0,t.jsx)(eR,{children:(0,t.jsx)(I.oz,{remarkPlugins:[V.A,G.A,eC],rehypePlugins:[Y.A,K.A],components:{div({node:e,children:o,...a}){let r=a["data-callout"];return r?(0,t.jsx)(ej,{type:r,children:o}):(0,t.jsx)("div",{...a,children:o})},pre:({children:e})=>(0,t.jsx)(t.Fragment,{children:e}),code({className:e,children:o}){let a=/language-(\w+)/.exec(e??"")?.[1],r=String(o).replace(/\n$/,"");return r.trim()?"mermaid"===a?(0,t.jsx)(U,{code:r}):"chart"===a?(0,t.jsx)(el,{code:r}):a||r.includes("\n")?(0,t.jsx)(ew,{lang:a,code:r}):(0,t.jsx)("code",{className:e,children:o}):null}},children:e})})}l().nav`
  display: flex;
  flex-direction: column;
  gap: 1px;
  padding: ${s.w4.spacing.sm} 0;
