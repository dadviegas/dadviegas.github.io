"use strict";(self.webpackChunk_atlantis_pad=self.webpackChunk_atlantis_pad||[]).push([["5237"],{53804(o,e,a){a.d(e,{M:()=>x});var r=a(65723);a(37991);var t=a(36859),i=a.n(t),n=a(94764),l=a(42907);let s=i().div`
  display: flex;
  ...
  transition: flex ${n.w4.transitions.slow},
              min-width ${n.w4.transitions.slow};
  position: relative;
`,d=i().div`
  display: flex;
  align-items: center;
...
`,g=i().textarea`
  ...
  line-height: 1.7;
  tab-size: 2;
  caret-color: ${n.w4.colors.accent};
  overflow-y: scroll;
...
`,m=i().button`
  ...
  cursor: pointer;
  color: ${n.w4.colors.sidebarTextMuted};
  transition: color ${n.w4.transitions.fast}, background ${n.w4.transitions.fast};
  z-index: 10;
...
`;function x({value:o,onChange:e,collapsed:a,onToggleCollapse:t,scrollRef:i,onScroll:n}){return a?(0,r.jsx)("div",{style:{position:"relative",flexShrink:0},children:(0,r.jsxs)(m,{onClick:t,title:"Show editor",children:[(0,r.jsx)(l.In,{name:"panel-left-open",size:14}),(0,r.jsx)(f,{children:"Editor"})]})}):(0,r.jsxs)(s,{collapsed:!1,children:[(0,r.jsxs)(d,{children:[(0,r.jsx)(c,{children:"Editor"}),(0,r.jsx)(p,{onClick:t,title:"Collapse editor",children:(0,r.jsx)(l.In,{name:"panel-left-close",size:15})})]}),(0,r.jsx)(g,{ref:i,value:o,onChange:o=>e(o.target.value),onScroll:n,placeholder:"Write markdown here…",spellCheck:!1,autoCorrect:"off",autoCapitalize:"off",autoComplete:"off"})]})}},7279(o,e,a){a.d(e,{H:()=>u});var r=a(65723),t=a(37991),i=a(36859),n=a.n(i),l=a(94764),s=a(42907);let d=[{id:"showcase",label:"Full Showcase",description:"All supported features in one document",content:`# Markdown Editor — Feature Showcase
...
`,h=n().div`
  position: relative;
`;function u({onSelect:o}){let[e,a]=(0,t.useState)(!1),i=(0,t.useRef)(null);return(0,t.useEffect)(()=>{if(!e)return;let o=o=>{i.current&&!i.current.contains(o.target)&&a(!1)};return document.addEventListener("mousedown",o),()=>document.removeEventListener("mousedown",o)},[e]),(0,r.jsxs)(h,{ref:i,children:[(0,r.jsxs)(c,{onClick:()=>a(o=>!o),children:[(0,r.jsx)(s.In,{name:"book-open",size:14}),"Examples",(0,r.jsx)(s.In,{name:"chevron-down",size:13,style:{marginLeft:2}})]}),(0,r.jsxs)(p,{open:e,children:[(0,r.jsx)(g,{children:"Load an example"}),d.map(e=>(0,r.jsxs)(m,{onClick:()=>{o(e.content),a(!1)},children:[(0,r.jsx)(f,{children:e.label}),(0,r.jsx)(x,{children:e.description})]},e.id))]})]})}},56666(o,e,a){a.d(e,{C:()=>x});var r=a(65723),t=a(37991),i=a(36859),n=a.n(i),l=a(94764),s=a(42907);let d=[{label:"Flowchart",code:`flowchart TD
   ...
   commit id: "v1.0.0" tag: "v1.0.0"`}],c=n().button`
  display: flex;
  align-items: center;
  gap: 6px;
  padding: 5px 12px;
...
`,f=n().div`
  position: relative;
`;function x({onSelect:o}){let[e,a]=(0,t.useState)(!1),i=(0,t.useRef)(null);return(0,t.useEffect)(()=>{if(!e)return;let o=o=>{i.current&&!i.current.contains(o.target)&&a(!1)};return document.addEventListener("mousedown",o),()=>document.removeEventListener("mousedown",o)},[e]),(0,r.jsxs)(f,{ref:i,children:[(0,r.jsxs)(c,{onClick:()=>a(o=>!o),children:[(0,r.jsx)(s.In,{name:"book-open",size:14}),"Examples",(0,r.jsx)(s.In,{name:"chevron-down",size:13,style:{marginLeft:2}})]}),(0,r.jsxs)(p,{open:e,children:[(0,r.jsx)(g,{children:"Load a diagram"}),d.map(e=>(0,r.jsx)(m,{onClick:()=>{o(e.code),a(!1)},children:e.label},e.label))]})]})}},65320(o,e,a){a.d(e,{u:()=>w});var r=a(65723),t=a(37991),i=a(36859),n=a.n(i),l=a(94764),s=a(42907),d=a(29738);d.A.initialize({startOnLoad:!1,theme:"dark",securityLevel:"loose"});let c=`
...
`,f=n().button`
  ...
  &:hover { background: ${l.w4.colors.sidebarHover}; color: ${l.w4.colors.sidebarText}; }
`,x=n().div`
  flex: 1;
  overflow: auto;
  display: flex;
...
`,b=n().span`
  ...
  font-family: ${l.w4.typography.fontFamily};
  writing-mode: vertical-rl;
`;function w({code:o,collapsed:e,onToggleCollapse:a}){let[i,n]=(0,t.useState)(""),[l,c]=(0,t.useState)(null),y=(0,t.useRef)(0),$=(0,t.useCallback)(async o=>{if(!o.trim()){n(""),c(null);return}let e=++y.current;try{let a="mermaid-"+Date.now(),{svg:r}=await d.A.render(a,o);y.current===e&&(n(r),c(null))}catch(o){y.current===e&&(c(o instanceof Error?o.message:String(o)),n(""))}},[]);return((0,t.useEffect)(()=>{let e=setTimeout(()=>$(o),300);return()=>clearTimeout(e)},[o,$]),e)?(0,r.jsxs)(u,{onClick:a,title:"Show preview",children:[(0,r.jsx)(s.In,{name:"panel-right-open",size:14}),(0,r.jsx)(b,{children:"Preview"})]}):(0,r.jsxs)(p,{children:[(0,r.jsxs)(g,{children:[(0,r.jsx)(m,{children:"Preview"}),(0,r.jsx)(f,{onClick:a,title:"Collapse preview",children:(0,r.jsx)(s.In,{name:"panel-right-close",size:15})})]}),l&&(0,r.jsxs)(h,{children:[(0,r.jsx)(s.In,{name:"alert-circle",size:14,style:{flexShrink:0,marginTop:1}}),l]}),(0,r.jsx)(x,{dangerouslySetInnerHTML:{__html:i}})]})}},2099(o,e,a){a.d(e,{r:()=>z});var r=a(65723);a(37991);var t=a(11352),i=a(76710),n=a(4311),l=a(73639),s=a(8411);a(75406);var d=a(36859),c=a.n(d),p=a(94764),g=a(42907),m=a(49685);function f(){return o=>{!function o(e){if("blockquote"===e.type){let o=e.children?.[0];if(o?.type==="paragraph"){let a=o.children?.[0];if(a?.type==="text"){let r=a.value?.match(/^\[!(NOTE|TIP|WARNING|CAUTION|IMPORTANT)\]\s*/i);r&&(a.value=a.value.slice(r[0].length),a.value.trim()||1!==o.children.length||e.children.shift(),e.data=e.data??{},e.data.hName="div",e.data.hProperties={"data-callout":r[1].toUpperCase()})}}}e.children?.forEach(o)}(o)}}let x=c().div`
  display: flex;
  flex-direction: column;
  flex: 1;
  min-width: 0;
...
`,$=c().button`
  ...
  cursor: pointer;
  color: ${p.w4.colors.sidebarTextMuted};
  transition: color ${p.w4.transitions.fast}, background ${p.w4.transitions.fast};
  align-self: center;
...
`,v=c().span`
  ...
  font-family: ${p.w4.typography.fontFamily};
  writing-mode: vertical-rl;
`;function z({content:o,collapsed:e,onToggleCollapse:a,scrollRef:d,onScroll:c}){return e?(0,r.jsxs)($,{onClick:a,title:"Show preview",children:[(0,r.jsx)(g.In,{name:"panel-right-open",size:14}),(0,r.jsx)(v,{children:"Preview"})]}):(0,r.jsxs)(x,{children:[(0,r.jsxs)(h,{children:[(0,r.jsx)(u,{children:"Preview"}),(0,r.jsx)(b,{onClick:a,title:"Collapse preview",children:(0,r.jsx)(g.In,{name:"panel-right-close",size:15})})]}),(0,r.jsx)(w,{ref:d,onScroll:c,children:(0,r.jsx)(y,{children:(0,r.jsx)(t.oz,{remarkPlugins:[i.A,n.A,f],rehypePlugins:[l.A,s.A],components:{div({node:o,children:e,...a}){let t=a["data-callout"];return t?(0,r.jsx)("div",{"data-callout":t,children:e}):(0,r.jsx)("div",{...a,children:e})},pre:({children:o})=>(0,r.jsx)(r.Fragment,{children:o}),code({className:o,children:e}){let a=/language-(\w+)/.exec(o??"")?.[1],t=String(e).replace(/\n$/,"");return"mermaid"===a?(0,r.jsx)(m.t,{code:t}):"chart"===a?(0,r.jsx)(m.MX,{code:t}):"clock"===a?(0,r.jsx)(m.sc,{code:t}):a||t.includes("\n")?(0,r.jsx)(m.NG,{lang:a,code:t}):(0,r.jsx)("code",{className:o,children:e})}},children:o})})})]})}},49685(o,e,a){a.d(e,{MX:()=>B,t:()=>b,sc:()=>N,NG:()=>X});var r=a(65723),t=a(37991),i=a(94764),n=a(36859),l=a.n(n);l().nav`padding: ${i.w4.spacing.sm} 0;`,l().div`
...
`,l().button`
  ...
  align-items: center;
  width: 100%;
  padding: ${({collapsed:o})=>o?"10px 0":`7px ${i.w4.spacing.md}`};
...
`,l().button`
  ...
  background: ${({active:o})=>o?i.w4.colors.sidebarActiveBg:"none"};
  border: none;
  border-left: 2px solid ${({active:o})=>o?i.w4.colors.sidebarActive:"transparent"};
  cursor: pointer;
  color: ${({active:o})=>o?i.w4.colors.sidebarActive:i.w4.colors.sidebarText};
...
`,l().button`
  ...
  border: none;
  cursor: pointer;
  color: ${({active:o})=>o?"#e3b341":i.w4.colors.sidebarTextMuted};
  transition: opacity 0.15s, color 0.15s;
  flex-shrink: 0;

  &:hover { color: #e3b341; opacity: 1; }
`;var s=a(72799);let d="https://cdn.jsdelivr.net/npm/mermaid@11.14.0/dist/mermaid.min.js",c=null,p="#7fb77e",g=(0,s.keyframes)`
...
`,h=!1,u=/^(?:---[\s\S]*?---\s*)?(?:graph|flowchart|sequenceDiagram|classDiagram|stateDiagram(?:-v2)?|erDiagram|pie|gantt|journey|mindmap|gitGraph|sankey(?:-beta)?|quadrantChart|requirementDiagram|timeline|xychart-beta|block-beta|C4Context|C4Container|C4Component|C4Dynamic|C4Deployment)\b/;function b({code:o}){let[e,a]=(0,t.useState)(""),[i,n]=(0,t.useState)(!1);return((0,t.useEffect)(()=>{let e=!1;n(!1),a("");let r=o.trim();if(!r)return void n(!0);let t=r.split(/\r?\n/)[0]?.trim()??"";if(!u.test(t))return void n(!0);let i=setTimeout(()=>{e||(console.error("[MermaidBlock] render timed out after 5s"),n(!0))},5e3);return(async()=>{try{let o=await (c||(c=new Promise((o,e)=>{let a=globalThis.mermaid;if(a)return void o(a);let r=document.createElement("script");r.src=d,r.async=!0,r.onload=()=>{let a=globalThis.mermaid;a?o(a):e(Error("mermaid loaded but globalThis.mermaid missing"))},r.onerror=()=>e(Error(`failed to load ${d}`)),document.head.appendChild(r)})));if(console.debug("[MermaidBlock] mermaid ready",{initialized:h}),!h){let e="#141820",a="#1c2332",r="#343c4f",t="#e8edf5",i="#9aa5b8",n="#7fb77e",l="#6aa8d8",s="#8b7bff",d="#e89a5c",c="#f87171";o.initialize({startOnLoad:!1,theme:"base",securityLevel:"loose",themeVariables:{fontFamily:"-apple-system, BlinkMacSystemFont, Segoe UI, Helvetica, Arial, sans-serif",background:e,mainBkg:a,primaryColor:n,primaryTextColor:t,primaryBorderColor:n,secondaryColor:s,secondaryTextColor:t,secondaryBorderColor:s,tertiaryColor:l,tertiaryTextColor:t,tertiaryBorderColor:l,lineColor:i,textColor:t,nodeBorder:r,clusterBkg:e,clusterBorder:r,edgeLabelBackground:a,labelBackground:a,labelBorder:r,relationLabelBackground:a,relationLabelColor:t,pie1:n,pie2:s,pie3:l,pie4:d,pie5:"#ff6fa9",pie6:"#2dd4bf",pie7:c,pie8:n,pieStrokeColor:e,pieStrokeWidth:"2px",pieTitleTextSize:"18px",pieSectionTextSize:"13px",pieLegendTextSize:"13px",actorBkg:n,actorBorder:n,actorTextColor:e,signalColor:t,signalTextColor:t,labelBoxBkgColor:a,labelBoxBorderColor:r,labelTextColor:t,loopTextColor:t,noteBkgColor:d,noteBorderColor:d,noteTextColor:e,stateBkg:a,altBackground:e,attributeBackgroundColorOdd:a,attributeBackgroundColorEven:e,rowOdd:a,rowEven:e,gridColor:r,sectionBkgColor:a,sectionBkgColor2:e,taskBkgColor:s,taskTextColor:t,taskTextDarkColor:t,taskTextLightColor:t,taskTextOutsideColor:t,activeTaskBkgColor:n,activeTaskBorderColor:n,doneTaskBkgColor:i,doneTaskBorderColor:i,critBkgColor:c,critBorderColor:c}}),h=!0}console.debug("[MermaidBlock] calling mermaid.render");let{svg:t}=await o.render(`mermaid-${"u">typeof crypto&&"function"==typeof crypto.randomUUID?crypto.randomUUID().replace(/-/g,"").slice(0,8):Math.random().toString(36).slice(2,10).padEnd(8,"0")}`,r);if(clearTimeout(i),console.debug("[MermaidBlock] render returned",{length:t?.length??0}),e)return;if(!t||/aria-roledescription="error"/i.test(t))return void n(!0);a(t)}catch(o){clearTimeout(i),console.error("[MermaidBlock] render failed",o),e||n(!0)}})(),()=>{e=!0,clearTimeout(i)}},[o]),i)?(0,r.jsx)(x,{children:o.trim()}):e?(0,r.jsx)(m,{dangerouslySetInnerHTML:{__html:e}}):(0,r.jsx)(m,{children:(0,r.jsx)(f,{"aria-hidden":!0})})}let w=["#388bfd","#3fb950","#d29922","#a371f7","#f87171","#22d3ee","#fb923c","#34d399","#f472b6","#818cf8"],y=l().div`
  background: ${i.w4.colors.codeBg};
  border: 1px solid ${i.w4.colors.codeBorder};
  border-radius: ${i.w4.borderRadius.md};
...
`,M=l().pre`
  ...
  color: ${i.w4.colors.mainTextMuted};
  white-space: pre-wrap;
`;function A(o){if(o<=0)return 10;let e=Math.pow(10,Math.floor(Math.log10(o)));return Math.ceil(o/e)*e}function T({labels:o,data:e,colors:a}){let t=340,n=176,l=A(Math.max(...e,1)),s=Math.min(40,t/o.length*.6),d=t/o.length,c=Array.from({length:6},(o,e)=>l/5*e);return(0,r.jsxs)("svg",{viewBox:"0 0 400 240",width:"100%",style:{maxWidth:400},children:[c.map((o,e)=>{let a=16+n-o/l*n;return(0,r.jsxs)("g",{children:[(0,r.jsx)("line",{x1:44,y1:a,x2:384,y2:a,stroke:i.w4.colors.border,strokeWidth:.5,strokeDasharray:0===e?"none":"3,3"}),(0,r.jsx)("text",{x:38,y:a+4,fill:i.w4.colors.mainTextMuted,fontSize:10,textAnchor:"end",fontFamily:i.w4.typography.fontFamily,children:Math.round(o)})]},e)}),e.map((e,t)=>{let c=44+d*t+d/2-s/2,p=e/l*n,g=16+n-p,m=a[t%a.length];return(0,r.jsxs)("g",{children:[(0,r.jsxs)("rect",{x:c,y:g,width:s,height:p,rx:3,fill:m,opacity:.85,children:[(0,r.jsx)("animate",{attributeName:"height",from:"0",to:p,dur:"0.5s",fill:"freeze"}),(0,r.jsx)("animate",{attributeName:"y",from:16+n,to:g,dur:"0.5s",fill:"freeze"})]}),(0,r.jsx)("text",{x:c+s/2,y:g-4,fill:i.w4.colors.mainText,fontSize:10,fontWeight:600,textAnchor:"middle",fontFamily:i.w4.typography.fontFamily,children:e}),(0,r.jsx)("text",{x:44+d*t+d/2,y:208,fill:i.w4.colors.mainTextMuted,fontSize:10,textAnchor:"middle",fontFamily:i.w4.typography.fontFamily,children:o[t].length>8?o[t].slice(0,7)+"…":o[t]})]},t)})]})}function j({labels:o,data:e,colors:a}){let t=e.reduce((o,e)=>o+e,0)||1,n=-Math.PI/2,l=e.map((o,e)=>{let l=o/t*Math.PI*2,s=n,d=n+=l,c=120+90*Math.cos(s),p=120+90*Math.sin(s),g=120+90*Math.cos(d),m=120+90*Math.sin(d),f=+(l>Math.PI),x=s+l/2,h=120+58.5*Math.cos(x),u=120+58.5*Math.sin(x),b=Math.round(o/t*100);return(0,r.jsxs)("g",{children:[(0,r.jsx)("path",{d:`M 120 120 L ${c} ${p} A 90 90 0 ${f} 1 ${g} ${m} Z`,fill:a[e%a.length],stroke:i.w4.colors.codeBg,strokeWidth:2,opacity:.85}),b>=5&&(0,r.jsxs)("text",{x:h,y:u+4,fill:"#fff",fontSize:11,fontWeight:600,textAnchor:"middle",fontFamily:i.w4.typography.fontFamily,children:[b,"%"]})]},e)});return(0,r.jsx)("svg",{viewBox:"0 0 240 240",width:"100%",style:{maxWidth:240},children:l})}function S({labels:o,data:e,colors:a}){let t=340,n=176,l=A(Math.max(...e,1)),s=e.length>1?t/(e.length-1):t,d=a[0],c=e.map((o,e)=>({x:44+s*e,y:16+n-o/l*n})),p=c.map((o,e)=>`${0===e?"M":"L"} ${o.x} ${o.y}`).join(" "),g=Array.from({length:6},(o,e)=>l/5*e);return(0,r.jsxs)("svg",{viewBox:"0 0 400 240",width:"100%",style:{maxWidth:400},children:[g.map((o,e)=>{let a=16+n-o/l*n;return(0,r.jsxs)("g",{children:[(0,r.jsx)("line",{x1:44,y1:a,x2:384,y2:a,stroke:i.w4.colors.border,strokeWidth:.5,strokeDasharray:0===e?"none":"3,3"}),(0,r.jsx)("text",{x:38,y:a+4,fill:i.w4.colors.mainTextMuted,fontSize:10,textAnchor:"end",fontFamily:i.w4.typography.fontFamily,children:Math.round(o)})]},e)}),(0,r.jsx)("path",{d:p,fill:"none",stroke:d,strokeWidth:2.5,strokeLinecap:"round",strokeLinejoin:"round"}),c.map((a,t)=>(0,r.jsxs)("g",{children:[(0,r.jsx)("circle",{cx:a.x,cy:a.y,r:4,fill:d,stroke:i.w4.colors.codeBg,strokeWidth:2}),(0,r.jsx)("text",{x:a.x,y:a.y-10,fill:i.w4.colors.mainText,fontSize:10,fontWeight:600,textAnchor:"middle",fontFamily:i.w4.typography.fontFamily,children:e[t]}),(0,r.jsx)("text",{x:a.x,y:208,fill:i.w4.colors.mainTextMuted,fontSize:10,textAnchor:"middle",fontFamily:i.w4.typography.fontFamily,children:o[t].length>8?o[t].slice(0,7)+"…":o[t]})]},t))]})}function B({code:o}){let e=(0,t.useMemo)(()=>(function(o){let e,a,r=o.trim().split("\n"),t="bar",i=[],n=[];for(let o of r){let[r,...l]=o.split(":"),s=l.join(":").trim();if(s)switch(r.trim().toLowerCase()){case"type":["bar","pie","line"].includes(s.toLowerCase())&&(t=s.toLowerCase());break;case"title":e=s;break;case"labels":i=s.replace(/^\[|\]$/g,"").split(",").map(o=>o.trim());break;case"data":n=s.replace(/^\[|\]$/g,"").split(",").map(o=>parseFloat(o.trim())||0);break;case"colors":a=s.replace(/^\[|\]$/g,"").split(",").map(o=>o.trim())}}return i.length&&n.length?{type:t,title:e,labels:i,data:n,colors:a}:null})(o),[o]);if(!e)return(0,r.jsx)(M,{children:o.trim()});let a=e.colors??w;return(0,r.jsxs)(y,{children:[e.title&&(0,r.jsx)($,{children:e.title}),"bar"===e.type&&(0,r.jsx)(T,{labels:e.labels,data:e.data,colors:a}),"pie"===e.type&&(0,r.jsx)(j,{labels:e.labels,data:e.data,colors:a}),"line"===e.type&&(0,r.jsx)(S,{labels:e.labels,data:e.data,colors:a}),(0,r.jsx)(v,{children:e.labels.map((o,e)=>(0,r.jsxs)(z,{children:[(0,r.jsx)(k,{color:a[e%a.length]}),o]},e))})]})}let C=l().div`
  background: ${i.w4.colors.codeBg};
  border: 1px solid ${i.w4.colors.codeBorder};
  border-radius: ${i.w4.borderRadius.md};
  padding: ${i.w4.spacing.lg};
...
`,E=l().button`
  ...
  border-radius: ${i.w4.borderRadius.md};
  background: ${({active:o})=>o?i.w4.colors.accentMuted:"transparent"};
...
`,H=l().div`
  ...
  color: ${i.w4.colors.mainText};
  text-align: center;
`;function D(o){return o.toString().padStart(2,"0")}function I({hours:o,minutes:e,seconds:a}){let t=o=>o*Math.PI/180,n=a/60*360-90,l=e/60*360+a/60*6-90,s=o%12/12*360+e/60*30-90,d=100+61*Math.cos(t(n)),c=100+61*Math.sin(t(n)),p=100+65*Math.cos(t(l)),g=100+65*Math.sin(t(l)),m=100+45*Math.cos(t(s)),f=100+45*Math.sin(t(s));return(0,r.jsxs)("svg",{viewBox:"0 0 200 200",width:200,height:200,children:[(0,r.jsx)("circle",{cx:100,cy:100,r:85,fill:i.w4.colors.surface,stroke:i.w4.colors.border,strokeWidth:2}),Array.from({length:12},(o,e)=>{let a=e+1,n=a/12*360-90,l=100+69*Math.cos(t(n)),s=100+69*Math.sin(t(n));return(0,r.jsx)("text",{x:l,y:s+4,fill:i.w4.colors.mainText,fontSize:14,fontWeight:600,textAnchor:"middle",fontFamily:i.w4.typography.fontFamily,children:a},a)}),Array.from({length:60},(o,e)=>{let a=e/60*360-90,n=e%5==0,l=n?75:79;return(0,r.jsx)("line",{x1:100+l*Math.cos(t(a)),y1:100+l*Math.sin(t(a)),x2:100+83*Math.cos(t(a)),y2:100+83*Math.sin(t(a)),stroke:n?i.w4.colors.mainTextMuted:i.w4.colors.border,strokeWidth:n?2:1},e)}),(0,r.jsx)("line",{x1:100,y1:100,x2:m,y2:f,stroke:i.w4.colors.mainText,strokeWidth:4,strokeLinecap:"round"}),(0,r.jsx)("line",{x1:100,y1:100,x2:p,y2:g,stroke:i.w4.colors.accent,strokeWidth:2.5,strokeLinecap:"round"}),(0,r.jsx)("line",{x1:100-12*Math.cos(t(n)),y1:100-12*Math.sin(t(n)),x2:d,y2:c,stroke:"#f87171",strokeWidth:1.2,strokeLinecap:"round"}),(0,r.jsx)("circle",{cx:100,cy:100,r:4,fill:i.w4.colors.accent}),(0,r.jsx)("circle",{cx:100,cy:100,r:2,fill:"#f87171"})]})}function N({code:o}){let e=function(o){let e="pt";for(let a of o.trim().split("\n")){let[o,...r]=a.split(":"),t=r.join(":").trim();"locale"===o.trim().toLowerCase()&&(e=t.toLowerCase())}return{locale:e}}(o),[a,i]=(0,t.useState)("live"),[n,l]=(0,t.useState)(()=>new Date().getHours()),[s,d]=(0,t.useState)(()=>new Date().getMinutes()),[c,p]=(0,t.useState)(()=>new Date().getSeconds());(0,t.useEffect)(()=>{if("live"!==a)return;let o=()=>{let o=new Date;l(o.getHours()),d(o.getMinutes()),p(o.getSeconds())};o();let e=setInterval(o,1e3);return()=>clearInterval(e)},[a]);let g=(0,t.useCallback)(o=>{i("manual"),p(0),l(e=>((e+o)%24+24)%24)},[]),m=(0,t.useCallback)(o=>{i("manual"),p(0),d(e=>((e+o)%60+60)%60)},[]),f=(0,t.useCallback)(()=>i("live"),[]);return(0,r.jsxs)(C,{children:[(0,r.jsxs)(F,{children:[(0,r.jsx)(I,{hours:n,minutes:s,seconds:c}),(0,r.jsxs)("div",{children:[(0,r.jsxs)(L,{children:[D(n),":",D(s),(0,r.jsxs)("span",{style:{fontSize:"24px",opacity:.5},children:[":",D(c)]})]}),(0,r.jsx)(H,{children:function(o,e,a){if("pt"===a){let a=1===o?"1 hora":`${o} horas`;return 0===e?a:15===e?`${a} e um quarto`:30===e?`${a} e meia`:45===e?`um quarto para as ${12===o?1:o+1}`:`${a} e ${e} minutos`}let r=o<12?"AM":"PM",t=o%12||12;return 0===e?`${t} o'clock ${r}`:15===e?`quarter past ${t} ${r}`:30===e?`half past ${t} ${r}`:45===e?`quarter to ${t%12+1} ${r}`:`${t}:${D(e)} ${r}`}(n%12||12,s,e.locale)})]})]}),(0,r.jsxs)(R,{children:[(0,r.jsx)(E,{onClick:()=>g(-1),children:"−1h"}),(0,r.jsx)(E,{onClick:()=>g(1),children:"+1h"}),(0,r.jsx)(E,{onClick:()=>m(-15),children:"−15m"}),(0,r.jsx)(E,{onClick:()=>m(15),children:"+15m"}),(0,r.jsx)(E,{onClick:()=>m(-5),children:"−5m"}),(0,r.jsx)(E,{onClick:()=>m(5),children:"+5m"}),(0,r.jsx)(E,{active:"live"===a,onClick:f,children:"pt"===e.locale?"Agora":"Now"})]}),(0,r.jsx)(P,{children:"pt"===e.locale?"Usa os bot\xf5es para mudar as horas e os minutos!":"Use the buttons to change the hours and minutes!"}),(0,r.jsx)(R,{children:[{label:"3:00",h:3,m:0},{label:"6:30",h:6,m:30},{label:"9:15",h:9,m:15},{label:"12:00",h:12,m:0},{label:"13:45",h:13,m:45},{label:"15:30",h:15,m:30},{label:"19:00",h:19,m:0},{label:"23:15",h:23,m:15}].map(o=>(0,r.jsx)(E,{onClick:()=>{i("manual"),l(o.h),d(o.m)},children:o.label},o.label))})]})}let V=(0,s.keyframes)`
...
`,l().span`
  font-size: ${i.w4.typography.fontSizeBase};
  color: ${i.w4.colors.mainTextMuted};
`;var Y=a(17223),G=a(21426),W=a(25609),O=a(20320);let U=l().div`
  margin: ${i.w4.spacing.lg} 0;
  border-radius: ${i.w4.borderRadius.md};
  border: 1px solid ${i.w4.colors.codeBorder};
  overflow: hidden;
...
`,J=l().button`
  ...
  padding: 3px 8px;
  background: none;
  border: 1px solid ${({copied:o})=>o?"#3fb950":i.w4.colors.border};
  border-radius: ${i.w4.borderRadius.sm};
  color: ${({copied:o})=>o?"#3fb950":i.w4.colors.sidebarTextMuted};
  font-size: 11px;
  font-family: ${i.w4.typography.fontFamily};
  cursor: pointer;
  transition: color 0.15s, border-color 0.15s;
  &:hover { color: ${i.w4.colors.sidebarText}; border-color: ${i.w4.colors.sidebarText}; }
`,Z={...G.A,'pre[class*="language-"]':{...G.A['pre[class*="language-"]'],background:i.w4.colors.codeBg,margin:0,padding:"18px 20px",fontSize:"13px",lineHeight:"1.6",borderRadius:0},'code[class*="language-"]':{...G.A['code[class*="language-"]'],background:"none",fontSize:"13px"}};function X({lang:o="text",code:e}){let[a,n]=(0,t.useState)(!1);return(0,r.jsxs)(U,{children:[(0,r.jsxs)(_,{children:[(0,r.jsx)(q,{children:o}),(0,r.jsxs)(J,{copied:a,onClick:()=>{navigator.clipboard.writeText(e).then(()=>{n(!0),setTimeout(()=>n(!1),2e3)})},children:[a?(0,r.jsx)(W.A,{size:12}):(0,r.jsx)(O.A,{size:12}),a?"Copied!":"Copy"]})]}),(0,r.jsx)(Y.A,{language:o,style:Z,showLineNumbers:e.split("\n").length>8,lineNumberStyle:{color:"#484f58",minWidth:"2.5em",paddingRight:"1.5em",userSelect:"none",fontSize:"12px"},customStyle:{margin:0,background:i.w4.colors.codeBg},wrapLongLines:!1,children:e})]})}l().div`
  background: ${({bg:o})=>o};
...
`,l().ul`list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 2px;`,l().a`
  ...
  font-size: ${i.w4.typography.fontSizeSm};
  font-family: ${i.w4.typography.fontFamily};
  color: ${({active:o})=>o?i.w4.colors.accent:i.w4.colors.sidebarTextMuted};
  text-decoration: none;
  border-left: 2px solid ${({active:o})=>o?i.w4.colors.accent:"transparent"};
...
`,l().button`
  ...
  width: 100%;
  padding: 10px 18px;
  background: ${({selected:o})=>o?i.w4.colors.accentMuted:"transparent"};
  border: none;
  cursor: pointer;
  text-align: left;
...
`,l().div`
  ...
  justify-content: center;
  border-radius: ${i.w4.borderRadius.md};
  background: ${({selected:o})=>o?`${i.w4.colors.accent}20`:i.w4.colors.sidebarHover};
  color: ${({selected:o})=>o?i.w4.colors.accent:i.w4.colors.sidebarTextMuted};
  flex-shrink: 0;
  margin-top: 1px;
`,l().div`
  flex: 1;
...
`,l().div`
  display: flex;
  align-items: center;
  color: ${({selected:o})=>o?i.w4.colors.accent:"transparent"};
  margin-top: 8px;
...
`,l().button`
  ...
  background: ${({active:o})=>o?i.w4.colors.accent:"transparent"};
  color: ${({active:o})=>o?"#0d1117":i.w4.colors.mainTextMuted};
  &:hover {
    color: ${({active:o})=>o?"#0d1117":i.w4.colors.mainText};
  }
`,l().div`
  padding: ${({collapsed:o})=>o?"8px 4px":`8px ${i.w4.spacing.md}`};
  border-bottom: 1px solid ${i.w4.colors.border}60;
`,l().div`
  display: flex;
  align-items: center;
  ...
  background: ${({focused:o})=>o?`${i.w4.colors.accent}10`:i.w4.colors.sidebarHover};
  border: 1px solid ${({focused:o})=>o?`${i.w4.colors.accent}40`:"transparent"};
  border-radius: ${i.w4.borderRadius.md};
...
`,l().span`
  ...
  font-weight: 600;
  margin-left: auto;
`},87330(o,e,a){a.d(e,{FlyoutPanel:()=>oE});var r=a(65723),t=a(37991),i=a.n(t),n=a(36859),l=a.n(n),s=a(72799),d=a(81316),c=a(40814),p=a(36896),g=a(87902),m=a(53013),f=a(32887),x=a(49510),h=a(39848),u=a(37901),b=a(3045),w=a(43775),y=a(41783),$=a(83539),v=a(39416),z=a(1837),k=a(57167),M=a(84494),A=a(82314),T=a(20255),j=a(35751),S=a(69633),B=a(92946),C=a(40822),F=a(36720),L=a(57400),R=a(58456),E=a(43317),P=a(52709),H=a(8006),D=a(89301),I=a(37561),N=a(83517),V=a(28207),K=a(37032),Y=a(6949),G=a(8218),W=a(36829),O=a(59591),U=a(15553),_=a(69923),q=a(72820),J=a(14621),Z=a(68479),X=a(72534),Q=a(66673),oo=a(67490),oe=a(49033),oa=a(99038),or=a(45775),ot=a(31365),oi=a(74893),on=a(62937),ol=a(9821),os=a(65912),od=a(80158),oc=a(88641),op=a(48607),og=a(83249),om=a(1821),of=a(15889),ox=a(89655),oh=a(27170),ou=a(19161),ob=a(71849),ow=a(41604),oy=a(13142),o$=a(61187),ov=a(77747),oz=a(2932),ok=a(24525),oM=a(57230),oA=a(22164);let oT={activity:p.A,"a-large-small":g.A,apple:m.A,"arrow-right":f.A,"bar-chart-2":x.A,book:h.A,"book-open":u.A,briefcase:b.A,calendar:w.A,clock:y.A,"circle-dot":$.A,cloud:v.A,compass:z.A,cpu:k.A,droplets:M.A,feather:A.A,file:T.A,"file-text":j.A,folder:S.A,"git-branch":B.A,github:C.A,globe:F.A,grid:L.A,hand:R.A,hash:E.A,heart:P.A,key:H.A,hexagon:D.A,home:I.A,landmark:N.A,layers:V.A,"layout-grid":K.A,leaf:Y.A,lightbulb:G.A,list:W.A,map:O.A,"map-pin":U.A,"message-circle":_.A,"message-square":q.A,minus:J.A,monitor:Z.A,mountain:X.A,package:Q.A,palette:oo.A,"pen-tool":oe.A,"pie-chart":oa.A,plane:or.A,plus:ot.A,puzzle:oi.A,ruler:on.A,shirt:ol.A,slash:os.A,square:od.A,star:oc.A,sun:op.A,terminal:og.A,thermometer:om.A,triangle:of.A,trophy:ox.A,truck:oh.A,type:ou.A,users:ob.A,"volume-2":ow.A,watch:oy.A,waves:o$.A,wind:ov.A,wrench:oz.A,x:ok.A,zap:oM.A,bot:oA.A},oj=(0,s.keyframes)`
...
`,oS=l().div`
  ...
  min-width: 210px;
  overflow-y: auto;
  animation: ${oj} 0.18s cubic-bezier(0.22, 1, 0.36, 1) forwards;
...
`,oF=({size:o=14,strokeWidth:e=1.75})=>(0,r.jsxs)("svg",{width:o,height:o,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:e,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,r.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,r.jsx)("polyline",{points:"14 2 14 8 20 8"})]});function oL({iconKey:o}){let e=o?oT[o]:null;return e?(0,r.jsx)(e,{size:14,strokeWidth:1.75}):(0,r.jsx)(oF,{})}function oR({entries:o,activeId:e,onSelect:a}){return(0,r.jsx)(r.Fragment,{children:o.map(o=>o.children?(0,r.jsx)(i().Fragment,{children:(0,r.jsx)(oR,{entries:o.children,activeId:e,onSelect:a})},o.id):(0,r.jsxs)(oC,{active:e===o.id,onClick:()=>a(o),children:[(0,r.jsx)(oL,{iconKey:o.icon}),o.name]},o.id))})}function oE({activeId:o}){let{flyout:e,scheduleFlyoutClose:a,cancelFlyoutClose:t}=(0,c.c)();if(!e)return null;let i=e.entry.icon?oT[e.entry.icon]:null;return(0,r.jsxs)(oS,{anchorY:e.anchorY,onMouseEnter:t,onMouseLeave:a,children:[(0,r.jsxs)(oB,{children:[i?(0,r.jsx)(i,{size:13,strokeWidth:2}):(0,r.jsx)(oF,{size:13,strokeWidth:2}),e.entry.name]}),(0,r.jsx)(oR,{entries:e.entry.children??[],activeId:o,onSelect:o=>{e.onSelect(o),a()}})]})}},40814(o,e,a){a.d(e,{I:()=>t,c:()=>i});var r=a(37991);let t=(0,r.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),i=()=>(0,r.useContext)(t)},94764(o,e,a){a.d(e,{PL:()=>C.getSetting,mZ:()=>C.updateDoc,KL:()=>C.saveDoc,cL:()=>c.c,Is:()=>C.putSetting,UO:()=>Y,PE:()=>B,w4:()=>r.w4});var r=a(81316),t=a(65723),i=a(37991),n=a.n(i),l=a(36859),s=a.n(l),d=a(72799),c=a(40814);let p="260px",g="56px",m="48px",f=s().header`
  display: flex;
  align-items: center;
...
`,A=s().main`
  ...
  display: flex;
  flex-direction: column;
`,T=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function j(){return(0,t.jsx)(b,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:T.map((o,e)=>(0,t.jsx)(w,{index:e,accent:o.accent,children:o.char},e))})}let S="atlantis:sidebar-collapsed";function B({sidebar:o,children:e,topBarRight:r,title:l="Atlantis",activeId:s=null}){let[d,p]=(0,i.useState)(()=>{try{return"true"===localStorage.getItem(S)}catch{return!1}}),[g,m]=(0,i.useState)(null),u=(0,i.useRef)(),b=()=>p(o=>{let e=!o;try{localStorage.setItem(S,String(e))}catch{}return e}),w=n().useMemo(()=>n().lazy(()=>Promise.resolve().then(a.bind(a,87330)).then(o=>({default:o.FlyoutPanel}))),[]);return(0,t.jsx)(c.I.Provider,{value:{collapsed:d,toggle:b,flyout:g,openFlyout:(o,e,a)=>{clearTimeout(u.current),m({entry:o,anchorY:e,onSelect:a})},scheduleFlyoutClose:()=>{u.current=setTimeout(()=>m(null),160)},cancelFlyoutClose:()=>clearTimeout(u.current)},children:(0,t.jsxs)(z,{children:[(0,t.jsxs)(f,{children:[o&&(0,t.jsx)(x,{children:(0,t.jsx)(h,{onClick:b,title:d?"Expand sidebar":"Collapse sidebar",children:(0,t.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("path",{d:"M9 3v18"})]})})}),(0,t.jsx)(j,{}),l&&(0,t.jsx)(y,{children:l}),r&&(0,t.jsx)($,{children:r})]}),(0,t.jsxs)(v,{children:[null!=o&&(0,t.jsx)(k,{collapsed:d,children:(0,t.jsx)(M,{children:o})}),(0,t.jsx)(A,{children:e})]}),g&&(0,t.jsx)(n().Suspense,{fallback:null,children:(0,t.jsx)(w,{activeId:s})})]})})}s().div`
  display: grid;
  grid-template-rows: ${({open:o})=>o?"1fr":"0fr"};
...
`,s().button`
  ...
  align-items: center;
  width: 100%;
  padding: ${({collapsed:o})=>o?"10px 0":`${r.w4.spacing.sm} ${r.w4.spacing.md}`};
  justify-content: ${({collapsed:o})=>o?"center":"space-between"};
  gap: ${({collapsed:o})=>o?"0":r.w4.spacing.sm};
  background: none;
  border: none;
  cursor: pointer;
  color: ${r.w4.colors.sidebarTextMuted};
...
`,s().button`
  ...
  align-items: center;
  width: 100%;
  padding: ${({collapsed:o})=>o?"9px 0":`7px ${r.w4.spacing.md}`};
  justify-content: ${({collapsed:o})=>o?"center":"flex-start"};
  gap: ${({collapsed:o})=>o?"0":"8px"};
  background: ${({active:o})=>o?r.w4.colors.accentMuted:"none"};
  border: none;
  border-left: ${({collapsed:o})=>o?"none":"2px"} solid
    ${({active:o})=>o?r.w4.colors.sidebarActive:"transparent"};
  cursor: pointer;
  ...
  font-family: ${r.w4.typography.fontFamily};
  text-align: left;
  border-radius: ${({collapsed:o})=>o?"0":`0 ${r.w4.borderRadius.md} ${r.w4.borderRadius.md} 0`};
...
`;function Y({appId:o,onLoad:e}){let[a,r]=(0,i.useState)(!1),[n,l]=(0,i.useState)([]),s=(0,i.useRef)(null),d=(0,i.useCallback)(()=>{(0,C.listDocs)(o).then(l).catch(()=>{})},[o]);(0,i.useEffect)(()=>{if(!a)return;d();let o=o=>{s.current&&!s.current.contains(o.target)&&r(!1)};return document.addEventListener("mousedown",o),()=>document.removeEventListener("mousedown",o)},[a,d]);let c=async(o,e)=>{o.stopPropagation(),await (0,C.deleteDoc)(e),l(o=>o.filter(o=>o.id!==e))};return(0,t.jsxs)(F,{ref:s,children:[(0,t.jsxs)(L,{onClick:()=>r(o=>!o),children:[(0,t.jsx)("svg",{width:14,height:14,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:(0,t.jsx)("path",{d:"M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"})}),"Saved",(0,t.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",style:{marginLeft:2},children:(0,t.jsx)("path",{d:"M6 9l6 6 6-6"})})]}),(0,t.jsxs)(R,{open:a,children:[(0,t.jsx)(E,{children:"Saved versions"}),(0,t.jsx)(P,{children:0===n.length?(0,t.jsx)(H,{children:"No saved documents yet."}):n.map(o=>{var a;return(0,t.jsxs)(D,{children:[(0,t.jsxs)(I,{onClick:()=>{e(o.content,o.id,o.name),r(!1)},children:[(0,t.jsx)(N,{children:o.name}),(0,t.jsx)(V,{children:(a=o.savedAt,new Intl.DateTimeFormat(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}).format(new Date(a)))})]}),(0,t.jsx)(K,{onClick:e=>c(e,o.id),title:"Delete",children:(0,t.jsxs)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("polyline",{points:"3 6 5 6 21 6"}),(0,t.jsx)("path",{d:"M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6M10 11v6M14 11v6"}),(0,t.jsx)("path",{d:"M9 6V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2"})]})})]},o.id)})})]})]})}s().div`
...
`;let h={default:l.w4.colors.accent,danger:"#f85149"},u={default:l.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"};n().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`,n().span`
  ...
  background: ${({color:o})=>o};
  display: inline-block;
`;let S={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:l.w4.colors.accentMuted},B={neutral:l.w4.colors.mainTextMuted,live:l.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:l.w4.colors.accent};n().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${l.w4.typography.fontFamilyMono};
...
`;function D({activeAppId:o}){let{collapsed:e}=(0,l.cL)(),[a]=function(){let[o,e]=(0,t.useState)(A),a=(0,t.useCallback)(o=>{e(o);try{localStorage.setItem(z,o)}catch{}(0,l.Is)(k,o).catch(()=>{}),window.dispatchEvent(new CustomEvent("atlantis:locale-change",{detail:o}))},[]);return(0,t.useEffect)(()=>{let o=o=>{e(o.detail)};return window.addEventListener("atlantis:locale-change",o),()=>window.removeEventListener("atlantis:locale-change",o)},[]),(0,t.useEffect)(()=>{(0,l.PL)(k).then(a=>{if(M(a)&&a!==o){try{localStorage.setItem(z,a)}catch{}e(a)}}).catch(()=>{})},[]),[o,a]}(),i=(0,t.useMemo)(()=>(o,e)=>{let r=function(o,e){if(!e||!o.includes("|"))return o;let a=null;for(let o of Object.values(e))if("number"==typeof o&&Number.isFinite(o)){a=o;break}if(null===a)return o;let r=o.indexOf("|"),t=o.slice(0,r),i=o.slice(r+1);return 1===a?t:i}(v[o]?.[a]??o,e);return e?Object.entries(e).reduce((o,[e,a])=>o.replace(RegExp(`\\{${e}\\}`,"g"),String(a)),r):r},[a]),n=(0,t.useRef)(null),s=o=>{n.current!==o&&(n.current=o,document.activeElement?.blur(),window.location.hash=o,setTimeout(()=>{n.current=null},50))};return(0,r.jsxs)(L,{children:[(0,r.jsx)(R,{collapsed:e,children:i("devtools.heading")}),F.map(a=>{let t=i(a.labelKey);return(0,r.jsxs)(E,{active:o===a.id,collapsed:e,onPointerDown:o=>{0===o.button&&s(a.hash)},onClick:()=>s(a.hash),title:t,children:[(0,r.jsx)(P,{children:(0,r.jsx)(y,{name:a.icon,size:16})}),(0,r.jsx)(H,{collapsed:e,children:t})]},a.id)})]})}let I=(0,b.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`;n().div`
  display: grid;
...
`,q=n().div`
  ...
  color: ${l.w4.colors.sidebarTextMuted};
  font-family: ${l.w4.typography.fontFamily};
`;function J({onSave:o,onUpdate:e,onCancel:a,existingDoc:i}){let[n,l]=(0,t.useState)(i?.name??""),s=(0,t.useRef)(null);return(0,t.useEffect)(()=>{s.current?.focus(),i&&s.current?.select()},[i]),(0,r.jsx)(K,{onClick:a,children:(0,r.jsxs)(Y,{onClick:o=>o.stopPropagation(),children:[(0,r.jsx)(G,{children:"Save document"}),i&&e&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(q,{children:"Update the current version or save as a new one."}),(0,r.jsxs)(O,{children:[(0,r.jsx)(U,{onClick:a,children:"Cancel"}),(0,r.jsxs)(U,{danger:!0,onClick:e,children:['Update "',i.name,'"']})]}),(0,r.jsx)(_,{})]}),(0,r.jsx)(W,{ref:s,value:n,onChange:o=>l(o.target.value),onKeyDown:r=>{"Enter"===r.key&&n.trim()&&(i&&n.trim()===i.name&&e?e():o(n.trim())),"Escape"===r.key&&a()},placeholder:i?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,r.jsxs)(O,{children:[!i&&(0,r.jsx)(U,{onClick:a,children:"Cancel"}),(0,r.jsx)(U,{primary:!0,disabled:!n.trim(),onClick:()=>o(n.trim()),children:"Save as new"})]})]})})}let Z=(0,b.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,X=(0,b.keyframes)`
...
`,n().div`
  position: absolute;
  inset: 0;
  animation: ${oo} 1.4s cubic-bezier(0.4, 0, 0.2, 1) infinite;
