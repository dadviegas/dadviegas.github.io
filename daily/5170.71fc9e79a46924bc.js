...
`},7330(o,e,a){a.d(e,{FlyoutPanel:()=>oR});var t=a(5723),r=a(7991),n=a.n(r),i=a(6859),l=a.n(i),s=a(2799),d=a(255),c=a(1316),p=a(814),g=a(6896),m=a(7902),f=a(3013),u=a(2887),x=a(9510),b=a(9848),w=a(7901),y=a(3045),h=a(3775),$=a(1783),z=a(3539),v=a(9416),k=a(1837),A=a(7167),M=a(4494),T=a(2314),S=a(5751),F=a(9633),j=a(2946),B=a(822),P=a(6720),R=a(7400),E=a(8456),C=a(3317),D=a(2709),L=a(8006),H=a(9301),N=a(7561),I=a(3517),Y=a(8207),G=a(7032),K=a(6949),O=a(8218),V=a(6829),_=a(9591),J=a(5553),W=a(9923),U=a(2820),Z=a(4621),q=a(8479),X=a(2534),Q=a(6673),oo=a(7490),oe=a(9033),oa=a(9038),ot=a(5775),or=a(1365),on=a(2937),oi=a(9821),ol=a(5912),os=a(158),od=a(8641),oc=a(8607),op=a(3249),og=a(1821),om=a(5889),of=a(9655),ou=a(7170),ox=a(9161),ob=a(1849),ow=a(1604),oy=a(3142),oh=a(1187),o$=a(7747),oz=a(2932),ov=a(4525),ok=a(7230),oA=a(2164);let oM={activity:g.A,"a-large-small":m.A,apple:f.A,"arrow-right":u.A,"bar-chart-2":x.A,book:b.A,"book-open":w.A,briefcase:y.A,calendar:h.A,clock:$.A,"circle-dot":z.A,cloud:v.A,compass:k.A,cpu:A.A,droplets:M.A,feather:T.A,file:d.A,"file-text":S.A,folder:F.A,"git-branch":j.A,github:B.A,globe:P.A,grid:R.A,hand:E.A,hash:C.A,heart:D.A,key:L.A,hexagon:H.A,home:N.A,landmark:I.A,layers:Y.A,"layout-grid":G.A,leaf:K.A,lightbulb:O.A,list:V.A,map:_.A,"map-pin":J.A,"message-circle":W.A,"message-square":U.A,minus:Z.A,monitor:q.A,mountain:X.A,package:Q.A,palette:oo.A,"pen-tool":oe.A,"pie-chart":oa.A,plane:ot.A,plus:or.A,ruler:on.A,shirt:oi.A,slash:ol.A,square:os.A,star:od.A,sun:oc.A,terminal:op.A,thermometer:og.A,triangle:om.A,trophy:of.A,truck:ou.A,type:ox.A,users:ob.A,"volume-2":ow.A,watch:oy.A,waves:oh.A,wind:o$.A,wrench:oz.A,x:ov.A,zap:ok.A,bot:oA.A},oT=(0,s.keyframes)`
...
`;function oB({iconKey:o}){let e=o?oM[o]??d.A:d.A;return(0,t.jsx)(e,{size:14,strokeWidth:1.75})}function oP({entries:o,activeId:e,onSelect:a}){return(0,t.jsx)(t.Fragment,{children:o.map(o=>o.children?(0,t.jsx)(n().Fragment,{children:(0,t.jsx)(oP,{entries:o.children,activeId:e,onSelect:a})},o.id):(0,t.jsxs)(oj,{active:e===o.id,onClick:()=>a(o),children:[(0,t.jsx)(oB,{iconKey:o.icon}),o.name]},o.id))})}function oR({activeId:o}){let{flyout:e,scheduleFlyoutClose:a,cancelFlyoutClose:r}=(0,p.c)();if(!e)return null;let n=e.entry.icon?oM[e.entry.icon]??d.A:d.A;return(0,t.jsxs)(oS,{anchorY:e.anchorY,onMouseEnter:r,onMouseLeave:a,children:[(0,t.jsxs)(oF,{children:[(0,t.jsx)(n,{size:13,strokeWidth:2}),e.entry.name]}),(0,t.jsx)(oP,{entries:e.entry.children??[],activeId:o,onSelect:o=>{e.onSelect(o),a()}})]})}},814(o,e,a){a.d(e,{I:()=>r,c:()=>n});var t=a(7991);let r=(0,t.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),n=()=>(0,t.useContext)(r)},4486(o,e,a){a.d(e,{WD:()=>ot,w4:()=>t.w4,sg:()=>or,Up:()=>oo,pJ:()=>L,Fy:()=>oe,Is:()=>N,yI:()=>oa,dR:()=>Q,xc:()=>W,PE:()=>B,qj:()=>H,PL:()=>I});var t=a(1316),r=a(5723),n=a(7991),i=a.n(n),l=a(6859),s=a.n(l);s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,h=s().span`
  ...
  animation: ${w} 10s ease ${({index:o})=>.07*o}s infinite;
...
`,T=s().main`
  ...
  display: flex;
  flex-direction: column;
`,S=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function F(){return(0,r.jsx)(y,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:S.map((o,e)=>(0,r.jsx)(h,{index:e,accent:o.accent,children:o.char},e))})}let j="atlantis:sidebar-collapsed";function B({sidebar:o,children:e,topBarRight:t,title:l="Atlantis",activeId:s=null}){let[d,g]=(0,n.useState)(()=>{try{return"true"===localStorage.getItem(j)}catch{return!1}}),[m,f]=(0,n.useState)(null),w=(0,n.useRef)(),y=()=>g(o=>{let e=!o;try{localStorage.setItem(j,String(e))}catch{}return e}),h=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(a.bind(a,7330)).then(o=>({default:o.FlyoutPanel}))),[]);return(0,r.jsx)(p.I.Provider,{value:{collapsed:d,toggle:y,flyout:m,openFlyout:(o,e,a)=>{clearTimeout(w.current),f({entry:o,anchorY:e,onSelect:a})},scheduleFlyoutClose:()=>{w.current=setTimeout(()=>f(null),160)},cancelFlyoutClose:()=>clearTimeout(w.current)},children:(0,r.jsxs)(k,{children:[(0,r.jsxs)(u,{children:[o&&(0,r.jsx)(x,{children:(0,r.jsx)(b,{onClick:y,title:d?"Expand sidebar":"Collapse sidebar",children:(0,r.jsx)(c.A,{size:17})})}),(0,r.jsx)(F,{}),l&&(0,r.jsx)($,{children:l}),t&&(0,r.jsx)(z,{children:t})]}),(0,r.jsxs)(v,{children:[null!=o&&(0,r.jsx)(A,{collapsed:d,children:(0,r.jsx)(M,{children:o})}),(0,r.jsx)(T,{children:e})]}),m&&(0,r.jsx)(i().Suspense,{fallback:null,children:(0,r.jsx)(h,{activeId:s})})]})})}s().div`
  display: grid;
...
`;let K="shell:profile",O="atlantis:profile-change",V=["tech","movies","learning","games","news","space"],_={interests:[],ageMode:"adult"};function J(o){return o&&"object"==typeof o?{interests:Array.isArray(o.interests)?o.interests.filter(o=>V.includes(o)):[],ageMode:"kid"===o.ageMode||"teen"===o.ageMode||"adult"===o.ageMode?o.ageMode:"adult"}:_}function W(){let[o,e]=(0,n.useState)(_);return(0,n.useEffect)(()=>{let o=!1;I(K).then(a=>{if(!o&&a)try{e(J(JSON.parse(a)))}catch{}});let a=o=>{let a=o.detail;a&&e(a)};return window.addEventListener(O,a),()=>{o=!0,window.removeEventListener(O,a)}},[]),[o,(0,n.useCallback)(async o=>{let a=J(o);e(a),window.dispatchEvent(new CustomEvent(O,{detail:a})),await N(K,JSON.stringify(a))},[])]}s().div`
...
`,w=n().forwardRef(function({variant:o="ghost",size:e="md",icon:a,iconRight:r,children:n,...i},l){return(0,t.jsxs)(b,{ref:l,variant:o,size:e,...i,children:[a,n,r]})}),y={default:s.w4.colors.accent,danger:"#f85149"},h={default:s.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"},$=l().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`,l().span`
  ...
  background: ${({color:o})=>o};
  display: inline-block;
`;let T={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:s.w4.colors.accentMuted},S={neutral:s.w4.colors.mainTextMuted,live:s.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:s.w4.colors.accent};l().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${s.w4.typography.fontFamilyMono};
...
`;let F=l().div`
  ...
  align-items: center;
  gap: 8px;
`;function j({children:o,...e}){return(0,t.jsx)(F,{...e,children:o})}l().label`
  display: flex;
  align-items: center;
  gap: 10px;
...
`,E.A,E.A['pre[class*="language-"]'],s.w4.colors.codeBg,E.A['code[class*="language-"]'],l().div`
  background: ${({bg:o})=>o};
