...
`;function ec(){let e="u">typeof window?window.location.hash:"",o=e.indexOf("?");if(-1===o)return{};let a={};for(let t of e.slice(o+1).split("&")){if(!t)continue;let e=t.indexOf("=");-1===e?a[decodeURIComponent(t)]="":a[decodeURIComponent(t.slice(0,e))]=decodeURIComponent(t.slice(e+1))}return a}function ep(){let[e,o]=(0,n.useState)(ec);return(0,n.useEffect)(()=>{let e=()=>o(ec());return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[]),e}s().div`
  position: fixed;
  inset: 0;
...
`,R.A,R.A['pre[class*="language-"]'],s.w4.colors.codeBg,R.A['code[class*="language-"]'],l().div`
  background: ${({bg:e})=>e};
