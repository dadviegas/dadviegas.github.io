...
`,t$=l()("button",{shouldForwardProp:e=>"active"!==e&&"chipColor"!==e})`
  display: inline-flex;
  align-items: center;
  gap: 6px;
  height: 28px;
...
`,o9=[{id:"groq",label:"Groq",placeholder:"gsk_...",help:"Used by Prompt Lab and Image Gen (enhance)",linkUrl:"https://console.groq.com/keys",linkLabel:"Get key"},{id:"gemini",label:"Google Gemini",placeholder:"AIza...",help:"Used by Prompt Lab",linkUrl:"https://aistudio.google.com/apikey",linkLabel:"Get key"},{id:"finnhub",label:"Finnhub",placeholder:"pk_...",help:"Stock quotes for the Markets widget",linkUrl:"https://finnhub.io/dashboard",linkLabel:"Get key"},{id:"tmdb",label:"TMDB (The Movie Database)",placeholder:"eyJhbGci...",help:"Movies & Series app — Read Access Token (v4 auth)",linkUrl:"https://www.themoviedb.org/settings/api",linkLabel:"Get key"},{id:"youtube",label:"YouTube Data API v3",placeholder:"AIza...",help:"YouTube Safe Feed app — free quota, no billing required",linkUrl:"https://console.cloud.google.com/apis/credentials",linkLabel:"Get key"}],re="atlantis:api-keys",rt="atlantis:promptlab:keys",ra=[{widgetId:"shell",ruleId:"sync.error",labelKey:"notifications.source.syncError",defaultEnabled:!0},{widgetId:"shell",ruleId:"daily.achievement",labelKey:"notifications.source.dailyAchievement",defaultEnabled:!0},{widgetId:"shell",ruleId:"finance.budget",labelKey:"notifications.source.financeBudget",defaultEnabled:!0}],ri={groq:"",gemini:"",finnhub:"",tmdb:"",youtube:""};function ro(e,t){return`notifications:${e}:${t}:enabled`}function rr({lang:e}){let[t,a]=(0,o.useState)(ri),[r,n]=(0,o.useState)({}),[s,l]=(0,o.useState)(!1),[d,m]=(0,o.useState)(!1),[u,f]=(0,o.useState)({}),[x,b]=(0,o.useState)([]),[y,w]=(0,o.useState)({muteAll:!1,windows:[]}),[v,$]=(0,o.useState)([]),k=(0,o.useMemo)(()=>(0,g.Nx)(e,tr),[e]),M="pt"===e;(0,o.useEffect)(()=>{let e=function(){try{let e=localStorage.getItem(re);if(e)return{...ri,...JSON.parse(e)};let t=localStorage.getItem(rt);if(t)return{...ri,...JSON.parse(t)}}catch{}return{...ri}}();a(e),(0,c.PL)(re).then(t=>{if(t)try{let i={...ri,...JSON.parse(t)},o={groq:e.groq||i.groq,gemini:e.gemini||i.gemini,finnhub:e.finnhub||i.finnhub,tmdb:e.tmdb||i.tmdb,youtube:e.youtube||i.youtube};a(o)}catch{}}),(0,h.loadSchedule)().then(e=>w(e)),(0,c.PL)("shell:dashboard-widgets").then(async e=>{let t=[];try{e&&(t=JSON.parse(e))}catch{}let a=new Set(t.map(e=>e.widgetId)),i=tt.filter(e=>a.has(e.id)&&e.notifications&&e.notifications.length>0);b(i);let o=i.flatMap(e=>(e.notifications??[]).map(e=>e.category)),r=ra.map(e=>e.ruleId),n=new Set,s=[];for(let e of[...o,...r])n.has(e)||(n.add(e),s.push(e));$(s);let l={};await Promise.all(i.flatMap(e=>(e.notifications??[]).map(async t=>{let a=ro(e.id,t.id),i=await (0,c.PL)(a),o=!1!==t.defaultEnabled;l[`${e.id}:${t.id}`]=null===i?o:"false"!==i}))),await Promise.all(ra.map(async e=>{let t=ro(e.widgetId,e.ruleId),a=await (0,c.PL)(t);l[`${e.widgetId}:${e.ruleId}`]=null===a?e.defaultEnabled:"false"!==a})),f(l)})},[]);let j=(0,o.useCallback)((e,t)=>{a(a=>({...a,[e]:t})),m(!0),l(!1)},[]),z=(0,o.useCallback)(e=>{a(t=>({...t,[e]:""})),m(!0),l(!1)},[]),S=(0,o.useCallback)(()=>{let e;e=JSON.stringify(t),localStorage.setItem(re,e),localStorage.setItem(rt,e),(0,c.Is)(re,e),window.dispatchEvent(new CustomEvent("atlantis:api-keys-changed")),m(!1),l(!0),setTimeout(()=>l(!1),2500)},[t]),C=(0,o.useCallback)((e,t,a)=>{let i=`${e}:${t}`;f(e=>({...e,[i]:a})),(0,c.Is)(ro(e,t),a?"true":"false")},[]),T=(0,o.useCallback)(e=>{let t={...y,muteAll:e};w(t),(0,h.saveSchedule)(t)},[y]),A=(0,o.useCallback)(()=>{let e={...y,windows:[...y.windows,{categoryId:"*",start:"22:00",end:"08:00"}]};w(e),(0,h.saveSchedule)(e)},[y]),F=(0,o.useCallback)(e=>{let t={...y,windows:y.windows.filter((t,a)=>a!==e)};w(t),(0,h.saveSchedule)(t)},[y]),L=(0,o.useCallback)((e,t)=>{let a={...y,windows:y.windows.map((a,i)=>i===e?{...a,...t}:a)};w(a),(0,h.saveSchedule)(a)},[y]),N=(0,o.useCallback)(e=>{if("*"===e)return k("notifications.settings.quietHours.global");for(let t of x)for(let a of t.notifications??[])if(a.category===e&&a.labelKey)return k(a.labelKey);for(let t of ra)if(t.ruleId===e)return k(t.labelKey);return e},[k,x]);return(0,i.jsx)(ow,{children:(0,i.jsxs)(ov,{children:[(0,i.jsxs)(o$,{children:[(0,i.jsx)(ok,{children:M?"Defini\xe7\xf5es":"Settings"}),(0,i.jsx)(oM,{children:M?"Gere as tuas chaves de API para os servi\xe7os de IA. As chaves s\xe3o guardadas no teu browser e sincronizadas com a tua conta.":"Manage your API keys for AI services. Keys are stored in your browser and synced with your account."})]}),(0,i.jsxs)(oj,{children:[(0,i.jsxs)(oz,{children:[(0,i.jsx)(p.In,{name:"key",size:16}),M?"Chaves de API":"API Keys"]}),(0,i.jsx)(oS,{children:M?"Estas chaves s\xe3o usadas pelo Prompt Lab e Image Gen. Cada servi\xe7o tem um plano gratuito.":"These keys are used by Prompt Lab and Image Gen. Each service has a free tier."}),o9.map(e=>{let a=t[e.id],o=r[e.id]??!1;return(0,i.jsxs)(oC,{children:[(0,i.jsxs)(oT,{children:[e.label,(0,i.jsx)(oA,{active:!!a,children:a?M?"ativa":"active":M?"vazia":"empty"}),(0,i.jsxs)(oF,{children:["— ",e.help]})]}),(0,i.jsxs)(oL,{children:[(0,i.jsxs)(oN,{children:[(0,i.jsx)(oP,{type:o?"text":"password",value:a,onChange:t=>j(e.id,t.target.value),placeholder:e.placeholder,spellCheck:!1,autoComplete:"off"}),(0,i.jsx)(oI,{onClick:()=>n(t=>({...t,[e.id]:!o})),title:o?"Hide":"Show",children:o?(0,i.jsx)(p.In,{name:"eye-off",size:13}):(0,i.jsx)(p.In,{name:"eye",size:13})})]}),(0,i.jsx)(oR,{danger:!0,onClick:()=>z(e.id),title:M?"Limpar":"Clear",children:(0,i.jsx)(p.In,{name:"trash",size:13})}),(0,i.jsx)("a",{href:e.linkUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:(0,i.jsx)(oR,{title:e.linkLabel,children:(0,i.jsx)(p.In,{name:"external-link",size:13})})})]})]},e.id)}),(0,i.jsxs)(oD,{children:[s?(0,i.jsx)(oE,{children:M?"✓ Guardado":"✓ Saved"}):(0,i.jsx)("span",{}),(0,i.jsxs)(oH,{onClick:S,disabled:!d,children:[(0,i.jsx)(p.In,{name:"save",size:13}),M?"Guardar":"Save"]})]})]}),(0,i.jsxs)(oj,{children:[(0,i.jsxs)(oz,{children:[(0,i.jsx)(p.In,{name:"bell",size:16}),k("notifications.settings.title")]}),(0,i.jsx)(oS,{children:k("notifications.settings.desc")}),(0,i.jsxs)(oU,{children:[(0,i.jsxs)(oJ,{children:[(0,i.jsx)(oQ,{children:k("notifications.settings.muteAll")}),(0,i.jsx)(oX,{children:k("notifications.settings.muteAll.desc")})]}),(0,i.jsxs)(oY,{checked:y.muteAll,onClick:()=>T(!y.muteAll),title:k("notifications.settings.muteAll"),children:[(0,i.jsx)("input",{type:"checkbox",checked:y.muteAll,onChange:()=>{},"aria-label":k("notifications.settings.muteAll")}),(0,i.jsx)("span",{className:"track"}),(0,i.jsx)("span",{className:"thumb"})]})]}),0===x.length?(0,i.jsx)(o_,{style:{marginTop:"16px"},children:k("notifications.settings.noWidgets")}):x.map(t=>(0,i.jsxs)(oq,{children:[(0,i.jsxs)(oB,{children:[(0,i.jsx)(oK,{children:t.icon}),(0,i.jsx)(oW,{children:"pt"===e?t.labels.pt:t.labels.en})]}),(t.notifications??[]).map(e=>{let a=`${t.id}:${e.id}`,o=!1!==e.defaultEnabled,r=u[a]??o,n=e.labelKey?k(e.labelKey):e.category;return(0,i.jsxs)(oG,{children:[(0,i.jsx)(oV,{className:"rule-label",children:n}),(0,i.jsxs)(oY,{checked:r,onClick:()=>C(t.id,e.id,!r),title:k("notifications.settings.enable"),children:[(0,i.jsx)("input",{type:"checkbox",checked:r,onChange:()=>{},"aria-label":n}),(0,i.jsx)("span",{className:"track"}),(0,i.jsx)("span",{className:"thumb"})]})]},e.id)})]},t.id)),(0,i.jsxs)(oq,{style:{marginTop:"12px"},children:[(0,i.jsxs)(oB,{children:[(0,i.jsx)(oK,{children:"\uD83D\uDD14"}),(0,i.jsx)(oW,{children:k("notifications.settings.shell.title")})]}),(0,i.jsx)("div",{style:{fontSize:"11px",fontFamily:c.w4.typography.fontFamilyMono,color:c.w4.colors.mainTextMuted,marginBottom:"4px"},children:k("notifications.settings.shell.desc")}),ra.map(e=>{let t=u[`${e.widgetId}:${e.ruleId}`]??e.defaultEnabled,a=k(e.labelKey);return(0,i.jsxs)(oG,{children:[(0,i.jsx)(oV,{className:"rule-label",children:a}),(0,i.jsxs)(oY,{checked:t,onClick:()=>C(e.widgetId,e.ruleId,!t),title:k("notifications.settings.enable"),children:[(0,i.jsx)("input",{type:"checkbox",checked:t,onChange:()=>{},"aria-label":a}),(0,i.jsx)("span",{className:"track"}),(0,i.jsx)("span",{className:"thumb"})]})]},e.ruleId)})]}),(0,i.jsxs)(oZ,{children:[(0,i.jsx)(o0,{children:k("notifications.settings.quietHours")}),(0,i.jsx)(o1,{children:k("notifications.settings.quietHours.desc")}),y.windows.map((e,t)=>(0,i.jsxs)(o4,{children:[(0,i.jsxs)(o3,{value:e.categoryId,onChange:e=>L(t,{categoryId:e.target.value}),"aria-label":k("notifications.settings.quietHours.category"),children:[(0,i.jsx)("option",{value:"*",children:k("notifications.settings.quietHours.global")}),v.map(e=>(0,i.jsx)("option",{value:e,children:N(e)},e))]}),(0,i.jsxs)(o6,{children:[(0,i.jsx)("input",{type:"checkbox",checked:e.allDay??!1,onChange:e=>L(t,{allDay:e.target.checked})}),k("notifications.settings.quietHours.allDay")]}),!e.allDay&&(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(o2,{children:k("notifications.settings.quietHours.from")}),(0,i.jsx)(o5,{type:"time",value:e.start,onChange:e=>L(t,{start:e.target.value})}),(0,i.jsx)(o2,{children:k("notifications.settings.quietHours.to")}),(0,i.jsx)(o5,{type:"time",value:e.end,onChange:e=>L(t,{end:e.target.value})})]}),(0,i.jsx)(o7,{type:"button",title:k("notifications.settings.quietHours.remove"),onClick:()=>F(t),children:(0,i.jsx)(p.In,{name:"close",size:13})})]},t)),(0,i.jsxs)(o8,{type:"button",onClick:A,children:[(0,i.jsx)(p.In,{name:"plus",size:13}),k("notifications.settings.quietHours.add")]})]})]}),(0,i.jsxs)(oO,{children:[(0,i.jsx)(p.In,{name:"shield",size:14,style:{flexShrink:0,marginTop:2}}),(0,i.jsx)("span",{children:M?"As chaves s\xe3o enviadas diretamente do teu browser para o servi\xe7o de IA — nunca passam pelos nossos servidores. Podes remov\xea-las a qualquer momento.":"Keys are sent directly from your browser to the AI provider — they never pass through our servers. You can remove them at any time."})]})]})})}let rn=(0,d.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,rs=(0,d.keyframes)`
...
`,eF=s().span`
  ...
  background: currentColor;
  display: inline-block;
`;function eL({tone:e="neutral",dot:t,children:a,...o}){return(0,i.jsxs)(eA,{tone:e,...o,children:[(t??"live"===e)&&(0,i.jsx)(eF,{}),a]})}let eN=s().kbd`
  font-family: ${l.w4.typography.fontFamilyMono};
  font-size: 10px;
  padding: 2px 6px;
  border: 1px solid ${l.w4.colors.border};
  ...
  white-space: nowrap;
`;function eP({children:e,...t}){return(0,i.jsx)(eN,{...t,children:e})}let eI=s().div`
  font-family: ${l.w4.typography.fontFamilyMono};
  font-size: 11px;
  letter-spacing: 0.16em;
  text-transform: uppercase;
