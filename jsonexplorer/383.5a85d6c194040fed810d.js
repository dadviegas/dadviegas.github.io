"use strict";(self.webpackChunk_atlantis_jsonexplorer=self.webpackChunk_atlantis_jsonexplorer||[]).push([[383],{4914(a,o,e){e.d(o,{FlyoutPanel:()=>z});var n=e(7359),t=e(3233),i=e(7207),r=e(255),l=e(217),s=e(5959),c=e(5185),m=e(5723);const d=i.keyframes`
...
`,A=i.default.div`
  ...
  color: ${n.w.colors.sidebarTextMuted};
  font-family: ${n.w.typography.fontFamily};
`;function v({onSave:a,onUpdate:o,onCancel:e,existingDoc:n}){const[i,l]=(0,t.useState)(n?.name??""),s=(0,t.useRef)(null);return(0,t.useEffect)(()=>{s.current?.focus(),n&&s.current?.select()},[n]),(0,r.jsx)(p,{onClick:e,children:(0,r.jsxs)(y,{onClick:a=>a.stopPropagation(),children:[(0,r.jsx)(z,{children:"Save document"}),n&&o&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(A,{children:"Update the current version or save as a new one."}),(0,r.jsxs)(h,{children:[(0,r.jsx)(x,{onClick:e,children:"Cancel"}),(0,r.jsxs)(x,{danger:!0,onClick:o,children:['Update "',n.name,'"']})]}),(0,r.jsx)(w,{})]}),(0,r.jsx)(b,{ref:s,value:i,onChange:a=>l(a.target.value),onKeyDown:t=>{"Enter"===t.key&&i.trim()&&(n&&i.trim()===n.name&&o?o():a(i.trim())),"Escape"===t.key&&e()},placeholder:n?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,r.jsxs)(h,{children:[!n&&(0,r.jsx)(x,{onClick:e,children:"Cancel"}),(0,r.jsx)(x,{primary:!0,disabled:!i.trim(),onClick:()=>a(i.trim()),children:"Save as new"})]})]})})}var k=e(8006),$=e(679),S=e(4872);const j=i.default.div`
  position: relative;
`,B=i.default.button`
  display: flex;
  align-items: center;
