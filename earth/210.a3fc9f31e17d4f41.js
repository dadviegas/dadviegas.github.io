...
`,m=n().div`
  ...
  flex-shrink: 0;
`,b=[{label:"0–14",color:"#3fb950"},{label:"15–24",color:"#7ee787"},{label:"25–37",color:"#d29922"},{label:"38–49",color:"#f0883e"},{label:"50+",color:"#f85149"}];function w(e,o=.35){if(e.length<2)return"";let t=`M ${e[0].x.toFixed(2)} ${e[0].y.toFixed(2)}`;for(let r=0;r<e.length-1;r++){let a=e[Math.max(r-1,0)],i=e[r],n=e[r+1],l=e[Math.min(r+2,e.length-1)],s=i.x+(n.x-a.x)*o,d=i.y+(n.y-a.y)*o,c=n.x-(l.x-i.x)*o,p=n.y-(l.y-i.y)*o;t+=` C ${s.toFixed(2)} ${d.toFixed(2)} ${c.toFixed(2)} ${p.toFixed(2)} ${n.x.toFixed(2)} ${n.y.toFixed(2)}`}return t}function y({cx:e,cy:o,deg:t,size:a=7}){return(0,r.jsx)("g",{transform:`translate(${e},${o}) rotate(${t})`,children:(0,r.jsx)("polygon",{points:`0,${-a} ${.55*a},${.6*a} 0,${.2*a} ${-(.55*a)},${.6*a}`,fill:c,opacity:.85})})}function $({temps:e,feelsLike:o}){let t=228,a=52,i=[...e,...o],n=5*Math.floor(Math.min(...i)/5),l=5*Math.ceil(Math.max(...i)/5),s=l-n||1,d=e=>e.map((o,r)=>({x:32+r/(e.length-1)*t,y:14+a-(o-n)/s*a})),h=d(e),b=d(o),y=w(h),v=w(b),M=`${y} L ${h[h.length-1].x.toFixed(2)} ${(14+a).toFixed(2)} L ${h[0].x.toFixed(2)} ${(14+a).toFixed(2)} Z`,k=[0,6,12,18,23].map(o=>({label:23===o?"24h":`${o}h`,x:32+o/(e.length-1)*t})),z=[{label:`${l}\xb0`,y:14},{label:`${Math.round((l+n)/2)}\xb0`,y:14+a/2},{label:`${n}\xb0`,y:14+a}],T=h[Math.min(new Date().getHours(),h.length-1)];return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)("svg",{viewBox:"0 0 268 88",width:"100%",style:{display:"block",overflow:"visible"},children:[(0,r.jsx)("defs",{children:(0,r.jsxs)("linearGradient",{id:"tempGrad",x1:"0",y1:"0",x2:"0",y2:"1",children:[(0,r.jsx)("stop",{offset:"0%",stopColor:c,stopOpacity:.25}),(0,r.jsx)("stop",{offset:"100%",stopColor:c,stopOpacity:0})]})}),z.map(({y:e})=>(0,r.jsx)("line",{x1:32,y1:e,x2:32+t,y2:e,stroke:g,strokeWidth:1},e)),(0,r.jsx)("path",{d:M,fill:"url(#tempGrad)"}),(0,r.jsx)("path",{d:v,fill:"none",stroke:p,strokeWidth:1,strokeDasharray:"3 4",opacity:.6}),(0,r.jsx)("path",{d:y,fill:"none",stroke:c,strokeWidth:1.5,strokeLinejoin:"round"}),(0,r.jsx)("circle",{cx:T.x,cy:T.y,r:3,fill:c}),k.map(({label:e,x:o})=>(0,r.jsx)("text",{x:o,y:84,textAnchor:"middle",fill:x,fontSize:9,fontFamily:"monospace",children:e},e)),z.map(({label:e,y:o})=>(0,r.jsx)("text",{x:28,y:o+3,textAnchor:"end",fill:x,fontSize:9,fontFamily:"monospace",children:e},e))]}),(0,r.jsxs)(f,{children:[(0,r.jsxs)(u,{children:[(0,r.jsx)(m,{color:c})," Actual"]}),(0,r.jsxs)(u,{style:{marginLeft:4},children:[(0,r.jsx)(m,{color:p,style:{opacity:.6}})," Feels like"]})]})]})}function v({speeds:e}){let o,t=232,a=52,i=5*Math.ceil(Math.max(...e,1)/5),n=e.map((o,r)=>({x:28+r/(e.length-1)*t,y:14+a-o/i*a})),l=w(n),s=`${l} L ${n[n.length-1].x.toFixed(2)} ${(14+a).toFixed(2)} L ${n[0].x.toFixed(2)} ${(14+a).toFixed(2)} Z`,d=[0,6,12,18,23].map(o=>({label:23===o?"24h":`${o}h`,x:28+o/(e.length-1)*t})),p=[{label:`${i}`,y:14},{label:`${Math.round(i/2)}`,y:14+a/2},{label:"0",y:14+a}];return(0,r.jsxs)("svg",{viewBox:"0 0 268 88",width:"100%",style:{display:"block",overflow:"visible"},children:[(0,r.jsx)("defs",{children:(0,r.jsxs)("linearGradient",{id:"windGrad",x1:"0",y1:"0",x2:"0",y2:"1",children:[(0,r.jsx)("stop",{offset:"0%",stopColor:c,stopOpacity:.3}),(0,r.jsx)("stop",{offset:"100%",stopColor:c,stopOpacity:0})]})}),p.map(({y:e})=>(0,r.jsx)("line",{x1:28,y1:e,x2:28+t,y2:e,stroke:g,strokeWidth:1},e)),(0,r.jsx)("path",{d:s,fill:"url(#windGrad)"}),(0,r.jsx)("path",{d:l,fill:"none",stroke:c,strokeWidth:1.5,strokeLinejoin:"round"}),(o=n[Math.min(new Date().getHours(),n.length-1)],(0,r.jsx)("circle",{cx:o.x,cy:o.y,r:3,fill:c})),d.map(({label:e,x:o})=>(0,r.jsx)("text",{x:o,y:84,textAnchor:"middle",fill:x,fontSize:9,fontFamily:"monospace",children:e},e)),p.map(({label:e,y:o})=>(0,r.jsx)("text",{x:24,y:o+3,textAnchor:"end",fill:x,fontSize:9,fontFamily:"monospace",children:e},e))]})}function M({speeds:e,directions:o,dayLabels:t}){let a=e.length,i=5*Math.ceil(Math.max(...e,1)/5),n=252/a,l=.28*n;return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)("svg",{viewBox:"0 0 268 110",width:"100%",style:{display:"block",overflow:"visible"},children:[(0,r.jsx)("line",{x1:8,y1:90,x2:260,y2:90,stroke:g,strokeWidth:1}),e.map((e,a)=>{let s=e/i*60,d=8+a*n+l/2,c=n-l,p=d+c/2,g=function(e){let o=h[0].color;for(let t of h)if(e>=t.threshold)o=t.color;else break;return o}(e);return(0,r.jsxs)("g",{children:[(0,r.jsx)(y,{cx:p,cy:7,deg:o[a],size:6}),(0,r.jsx)("text",{x:p,y:23,textAnchor:"middle",fill:g,fontSize:8,fontWeight:"600",fontFamily:"monospace",children:Math.round(e)}),(0,r.jsx)("rect",{x:d,y:90-s,width:c,height:s,fill:g,opacity:.85,rx:2}),(0,r.jsx)("text",{x:p,y:106,textAnchor:"middle",fill:x,fontSize:9,fontFamily:"monospace",children:t[a]})]},a)}),(0,r.jsx)("text",{x:260,y:88,textAnchor:"end",fill:x,fontSize:8,fontFamily:"monospace",children:"km/h"})]}),(0,r.jsx)(f,{children:b.map(({label:e,color:o})=>(0,r.jsxs)(u,{children:[(0,r.jsx)(m,{color:o}),e]},e))})]})}let k=n().div`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
...
`,P=n().span`font-size: 20px; width: 28px; text-align: center; flex-shrink: 0;`,Y=n().div`flex: 1; min-width: 0;`,q=n().div`font-size: ${l.w4.typography.fontSizeSm}; font-weight: 500; color: ${l.w4.colors.mainText}; font-family: ${l.w4.typography.fontFamily};`,D=n().div`font-size: 11px; color: ${l.w4.colors.sidebarTextMuted}; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;`,O=n().div`display: flex; flex-direction: column; align-items: flex-end; gap: 1px; flex-shrink: 0;`,W=n().span`font-size: ${l.w4.typography.fontSizeSm}; font-weight: 600; color: ${l.w4.colors.mainText}; font-family: ${l.w4.typography.fontFamilyMono};`,G=n().span`font-size: 11px; color: ${l.w4.colors.sidebarTextMuted}; font-family: ${l.w4.typography.fontFamilyMono};`,K=n().div`display: flex; align-items: center; gap: 2px; font-size: 11px; color: ${l.w4.colors.sidebarTextMuted}; font-family: ${l.w4.typography.fontFamilyMono}; flex-shrink: 0; width: 36px; justify-content: flex-end;`,N=n().div`
  padding: ${l.w4.spacing.lg};
  text-align: center;
  color: ${l.w4.colors.sidebarTextMuted};
  font-size: ${l.w4.typography.fontSizeSm};
  font-family: ${l.w4.typography.fontFamily};
`;function U({place:e,onClose:o}){var t;let[i,n]=(0,a.useState)(null),[c,p]=(0,a.useState)(null),[g,x]=(0,a.useState)(!1),[h,f]=(0,a.useState)(null),[u,m]=(0,a.useState)(0);(0,a.useEffect)(()=>{if(!e){n(null),p(null);return}x(!0),f(null),n(null),p(null);let o=`https://api.open-meteo.com/v1/forecast?latitude=${e.lat}&longitude=${e.lng}&current_weather=true&hourly=temperature_2m,apparent_temperature,relativehumidity_2m,windspeed_10m,winddirection_10m&daily=weathercode,temperature_2m_max,temperature_2m_min,precipitation_sum,windspeed_10m_max,winddirection_10m_dominant&timezone=auto&forecast_days=7`,t=`https://air-quality-api.open-meteo.com/v1/air-quality?latitude=${e.lat}&longitude=${e.lng}&current=pm2_5,pm10,european_aqi,us_aqi`;Promise.all([fetch(o).then(e=>{if(!e.ok)throw Error(`HTTP ${e.status}`);return e.json()}),fetch(t).then(e=>e.ok?e.json():null).catch(()=>null)]).then(([e,o])=>{n(e),p(o),x(!1)}).catch(e=>{f(e.message),x(!1)})},[e?.id,u]);let b=i?d(i.current_weather.weathercode):null,w=i?i.hourly.windspeed_10m.slice(0,24):[],y=i?i.hourly.temperature_2m.slice(0,24):[],X=i?i.hourly.apparent_temperature.slice(0,24):[],Z=new Date().getHours(),Q=i?i.hourly.relativehumidity_2m[Z]:null,J=i?i.hourly.apparent_temperature[Z]:null,ee=c?(t=c.current.us_aqi)<=50?{label:"Good",color:"#3fb950"}:t<=100?{label:"Moderate",color:"#d29922"}:t<=150?{label:"Unhealthy (sensitive)",color:"#f0883e"}:t<=200?{label:"Unhealthy",color:"#f85149"}:{label:"Hazardous",color:"#b44ac0"}:null;return(0,r.jsxs)(k,{visible:!!e,children:[(0,r.jsxs)(z,{children:[(0,r.jsx)(T,{children:e?.name??""}),(0,r.jsx)(s.K0,{onClick:o,title:"Close",children:(0,r.jsx)(s.In,{name:"close",size:14})})]}),(0,r.jsxs)(F,{children:[g&&(0,r.jsx)(N,{children:"Loading weather…"}),h&&(0,r.jsxs)(N,{children:[(0,r.jsx)("div",{children:"Weather unavailable — the API may be temporarily down."}),(0,r.jsx)("button",{onClick:()=>m(e=>e+1),style:{marginTop:12,padding:"6px 16px",cursor:"pointer",background:"none",border:`1px solid ${l.w4.colors.border}`,borderRadius:6,color:l.w4.colors.mainText,fontFamily:"inherit",fontSize:12},children:"Retry"})]}),i&&b&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(j,{children:[(0,r.jsxs)(S,{children:[(0,r.jsxs)("div",{children:[(0,r.jsxs)(H,{children:[Math.round(i.current_weather.temperature),"\xb0C"]}),(0,r.jsx)(L,{children:b.label})]}),(0,r.jsx)(R,{children:b.emoji})]}),(0,r.jsxs)(C,{children:[(0,r.jsxs)(B,{children:["\uD83D\uDCA8 ",Math.round(i.current_weather.windspeed)," km/h"]}),(0,r.jsxs)(B,{children:["\uD83C\uDF21 ",Math.round(i.daily.temperature_2m_max[0]),"\xb0 / ",Math.round(i.daily.temperature_2m_min[0]),"\xb0"]}),null!=J&&(0,r.jsxs)(B,{children:["\uD83C\uDF2C Feels ",Math.round(J),"\xb0"]}),null!=Q&&(0,r.jsxs)(B,{children:["\uD83D\uDCA7 ",Q,"% RH"]})]}),ee&&c&&(0,r.jsxs)(A,{color:ee.color,children:["\uD83C\uDFED AQI ",c.current.us_aqi," \xb7 ",ee.label]})]}),y.length>0&&(0,r.jsxs)("div",{children:[(0,r.jsx)(V,{children:"Temperature today (hourly)"}),(0,r.jsxs)(_,{children:[(0,r.jsx)(E,{children:"\xb0C \xb7 dot = current hour"}),(0,r.jsx)($,{temps:y,feelsLike:X})]})]}),(0,r.jsxs)("div",{children:[(0,r.jsx)(V,{children:"Wind today (hourly)"}),(0,r.jsxs)(_,{children:[(0,r.jsx)(E,{children:"Speed km/h \xb7 dot = current hour"}),(0,r.jsx)(v,{speeds:w})]})]}),(0,r.jsxs)("div",{children:[(0,r.jsx)(V,{children:"Wind this week (daily max)"}),(0,r.jsxs)(_,{children:[(0,r.jsx)(E,{children:"Max speed km/h \xb7 arrows = dominant direction"}),(0,r.jsx)(M,{speeds:i.daily.windspeed_10m_max,directions:i.daily.winddirection_10m_dominant,dayLabels:i.daily.time.map((e,o)=>0===o?"Today":new Date(e).toLocaleDateString("en-GB",{weekday:"short"}))})]})]}),(0,r.jsxs)("div",{children:[(0,r.jsx)(V,{children:"7-Day Forecast"}),i.daily.time.map((e,o)=>{let{emoji:t,label:a}=d(i.daily.weathercode[o]);return(0,r.jsxs)(I,{children:[(0,r.jsx)(P,{children:t}),(0,r.jsxs)(Y,{children:[(0,r.jsx)(q,{children:0===o?"Today":1===o?"Tomorrow":new Date(e).toLocaleDateString("en-GB",{weekday:"short",month:"short",day:"numeric"})}),(0,r.jsx)(D,{children:a})]}),(0,r.jsx)(K,{children:i.daily.precipitation_sum[o]>0&&(0,r.jsxs)(r.Fragment,{children:["\uD83D\uDCA7 ",i.daily.precipitation_sum[o].toFixed(1)]})}),(0,r.jsxs)(O,{children:[(0,r.jsxs)(W,{children:[Math.round(i.daily.temperature_2m_max[o]),"\xb0"]}),(0,r.jsxs)(G,{children:[Math.round(i.daily.temperature_2m_min[o]),"\xb0"]})]})]},e)})]})]})]})]})}},1112(e,o,t){t.d(o,{xy:()=>c});var r=t(7991);function a(e){return e*Math.PI/180}var i=t(6107);function n(e){return e<20?"#00e676":e<40?"#69ff47":e<60?"#b2ff59":e<80?"#ffea00":"#ff6d00"}function l(e){return null==e||e<1e3?"#8b949e":e<1e4?"#f0883e":e<25e3?"#d29922":"#58a6ff"}function s(e){let o=l(e.altFt),t=null!=e.altFt?`${Math.round(.3048*e.altFt).toLocaleString()} m`:"—",r=null!=e.speedKts?`${Math.round(1.852*e.speedKts)} km/h`:"—",a=null!=e.heading?`${Math.round(e.heading)}\xb0`:"—",i=null!=e.vrateFpm?`${e.vrateFpm>0?"↑":"↓"} ${Math.abs(Math.round(.00508*e.vrateFpm))} m/s`:"—";return`
    <div style="font-family:monospace;font-size:12px;line-height:1.75;min-width:180px;">
      ...
      <div style="margin-top:6px">
        <button
    ...
    </div>`}let d=new Map([{id:"night",label:"\uD83C\uDF11 Night",title:"Day/night terminator",defaultEnabled:!1,component:function({map:e,enabled:o}){let t=(0,r.useRef)(null),i=(0,r.useRef)(),n=(0,r.useCallback)(()=>{clearInterval(i.current),t.current?.remove(),t.current=null},[]),l=(0,r.useCallback)(()=>{if(!e||!o)return;let r=function(e){let o,t,r,i,n,l,s,d=(r=a((280.46+.9856474*(t=(o=e.getTime()/864e5+2440587.5)-2451545))%360),i=a((357.528+.9856003*t)%360),n=r+a(1.915*Math.sin(i)+.02*Math.sin(2*i)),s=Math.atan2(Math.cos(l=a(23.439-4e-7*t))*Math.sin(n),Math.cos(n)),{ra:s,dec:Math.asin(Math.sin(l)*Math.sin(n)),gmst:a((280.46061837+360.98564736629*(o-2451545))%360)}),c=[];for(let e=-180;e<=180;e++){var p;let o=(p=a(e),Math.atan(-Math.cos(d.gmst+p-d.ra)/Math.tan(d.dec)));c.push([180*o/Math.PI,e])}let g=d.dec>0?-90:90;return c.push([g,180]),c.push([g,-180]),c}(new Date);t.current?t.current.setLatLngs(r):t.current=window.L.polygon(r,{color:"transparent",fillColor:"#000",fillOpacity:.3,interactive:!1}).addTo(e)},[e,o]);return(0,r.useEffect)(()=>e&&o?(l(),i.current=setInterval(l,3e4),n):void n(),[e,o,l,n]),null}},{id:"aurora",label:"\uD83C\uDF0C Aurora",title:"Aurora forecast — NOAA SWPC",defaultEnabled:!1,component:function({map:e,enabled:o}){let t=(0,r.useRef)([]),a=(0,r.useRef)(null),l=(0,r.useCallback)(()=>{t.current.forEach(e=>e.remove()),t.current=[],a.current&&(a.current.remove(),a.current=null)},[]),s=(0,r.useCallback)(async()=>{if(!e||!o)return;let[r,l]=await Promise.all([(0,i.fetchAuroraOvation)(),(0,i.fetchPlanetaryKIndex)()]);if(!r||!l||!e||!o)return;let s=l[l.length-1]?.kp_index??0,d=window.L;for(let[o,a,i]of(t.current.forEach(e=>e.remove()),t.current=[],r.coordinates)){if(i<5||45>Math.abs(a))continue;let r=d.circleMarker([a,o],{radius:3,color:n(i),fillColor:n(i),fillOpacity:Math.min(.85,.15+i/100*.7),weight:0,interactive:!1});r.addTo(e),t.current.push(r)}a.current&&a.current.remove();let c=s>=7?"#f85149":s>=5?"#f0883e":s>=3?"#d29922":"#3fb950";a.current=new(d.Control.extend({onAdd(){let e=d.DomUtil.create("div");return e.innerHTML=`
          <div style="
          ...
          </div>`,e},onRemove(){}}))({position:"bottomleft"}),a.current.addTo(e)},[e,o]);return(0,r.useEffect)(()=>{if(!o)return void l();s();let e=setInterval(s,3e5);return()=>{clearInterval(e),l()}},[o,s,l]),null}},{id:"iss",label:"\uD83D\uDEF8 ISS",title:"ISS live position + footprint",defaultEnabled:!1,component:function({map:e,enabled:o}){let t=(0,r.useRef)(null),a=(0,r.useRef)(null),n=(0,r.useRef)(null),l=(0,r.useRef)([]),s=(0,r.useCallback)(()=>{t.current?.remove(),t.current=null,a.current?.remove(),a.current=null,n.current?.remove(),n.current=null,l.current=[]},[]),d=(0,r.useCallback)(async()=>{if(!e||!o)return;let r=await (0,i.fetchIssPosition)();if(!r||!e||!o)return;let s=window.L,d=r.latitude,c=r.longitude,p=l.current;if(p.length>0){let[,e]=p[p.length-1];Math.abs(c-e)>180&&(l.current=[])}l.current=[...l.current,[d,c]].slice(-80);let g=`<div style="
        font-size:22px;
        filter:drop-shadow(0 0 8px rgba(255,210,0,.9));
        line-height:1;
      ">🛸</div>`,x=s.divIcon({html:g,className:"",iconSize:[24,24],iconAnchor:[12,12]}),h=`
        ...
        </div>`;t.current?(t.current.setLatLng([d,c]),t.current.getPopup()?.setContent(h)):t.current=s.marker([d,c],{icon:x,zIndexOffset:2e3}).bindPopup(h,{maxWidth:220}).addTo(e),a.current?a.current.setLatLngs(l.current):a.current=s.polyline(l.current,{color:"#f0c040",weight:1.5,opacity:.55,dashArray:"3 7"}).addTo(e),n.current?n.current.setLatLng([d,c]):n.current=s.circle([d,c],{radius:2316e3,color:"#f0c040",fillColor:"#f0c040",fillOpacity:.04,weight:1,opacity:.25,dashArray:"5 8",interactive:!1}).addTo(e)},[e,o]);return(0,r.useEffect)(()=>{let e;if(!o)return void s();let t=!1,r=async()=>{await d(),t||(e=setTimeout(r,5e3))};return r(),()=>{t=!0,clearTimeout(e),s()}},[o,d,s]),null}},{id:"quakes",label:"\uD83C\uDF0D Quakes",title:"Earthquakes — USGS past month",defaultEnabled:!1,component:function({map:e,enabled:o}){let t=(0,r.useRef)(new Map),a=(0,r.useCallback)(()=>{t.current.forEach(e=>e.remove()),t.current.clear()},[]),n=(0,r.useCallback)(async()=>{if(!e||!o)return;let r=await (0,i.fetchUsgsQuakes)("all_month","seismic-world-all_month");if(!r?.features||!e||!o)return;let a=window.L,n=Date.now(),l=new Set;for(let o of r.features){let[r,i,s]=o.geometry.coordinates,{mag:d,place:c,time:p,type:g}=o.properties;if("earthquake"!==g||null==d||null==i||null==r)continue;l.add(o.id);let x=n-p,h=d<2?"#3fb950":d<3?"#7ee787":d<4?"#d29922":d<5?"#f0883e":d<6?"#f85149":"#ff4444",f=Math.min(40,Math.max(3,1.5*Math.pow(2,d-1)));if(t.current.has(o.id))continue;let u=a.circleMarker([i,r],{radius:f,color:h,fillColor:h,fillOpacity:Math.max(.25,.7-x/2592e6),weight:1});u.bindPopup(`
        <div style="font-family:monospace;font-size:12px;line-height:1.75;min-width:190px;">
          <div style="font-weight:700;font-size:13px;color:${h};margin-bottom:4px">
            M${d.toFixed(1)} Earthquake
          </div>
          <div>📍 ${c}</div>
          <div>🕐 ${function(e){let o=Math.round(e/36e5);return o<1?"<1 h ago":o<24?`${o} h ago`:`${Math.round(o/24)} d ago`}(x)}</div>
          <div>↓ Depth: ${Math.round(s)} km</div>
        </div>`,{maxWidth:250}),u.addTo(e),t.current.set(o.id,u)}t.current.forEach((e,o)=>{l.has(o)||(e.remove(),t.current.delete(o))})},[e,o]);return(0,r.useEffect)(()=>{if(!o)return void a();n();let e=setInterval(n,6e5);return()=>{clearInterval(e),a()}},[o,n,a]),null}},{id:"fires",label:"\uD83D\uDD25 Fires",title:"Active wildfires — NASA EONET",defaultEnabled:!1,component:function({map:e,enabled:o}){let t=(0,r.useRef)(new Map),a=(0,r.useCallback)(()=>{t.current.forEach(e=>e.remove()),t.current.clear()},[]),n=(0,r.useCallback)(async()=>{if(!e||!o)return;let r=await (0,i.fetchEonetEvents)({category:"wildfires",status:"open",limit:500});if(!r||!e||!o)return;let a=window.L,n=new Set;for(let o of r.events){var l;let r=o.geometry[o.geometry.length-1];if(!r||"Point"!==r.type)continue;let[i,s]=r.coordinates;if(n.add(o.id),t.current.has(o.id))continue;let d=(l=r.date,Date.now()-new Date(l).getTime()),c=Math.max(.4,1-d/2592e6),p=o.title.replace(/^Wildfire\s*[-–]\s*/i,""),g=a.divIcon({html:`<div style="
          font-size:16px;line-height:1;
          opacity:${c.toFixed(2)};
          filter:drop-shadow(0 0 5px rgba(255,90,0,.85));
          cursor:pointer;
        ">🔥</div>`,className:"",iconSize:[16,16],iconAnchor:[8,8]}),x=a.marker([s,i],{icon:g});x.bindPopup(`
        ...
        </div>`,{maxWidth:240}),x.addTo(e),t.current.set(o.id,x)}t.current.forEach((e,o)=>{n.has(o)||(e.remove(),t.current.delete(o))})},[e,o]);return(0,r.useEffect)(()=>{if(!o)return void a();n();let e=setInterval(n,18e5);return()=>{clearInterval(e),a()}},[o,n,a]),null}},{id:"radar",label:"\uD83C\uDF27 Radar",title:"Weather radar — RainViewer",defaultEnabled:!1,component:function({map:e,enabled:o}){let t=(0,r.useRef)(null),a=(0,r.useCallback)(()=>{t.current?.remove(),t.current=null},[]),n=(0,r.useCallback)(async()=>{if(!e||!o)return;let r=await (0,i.fetchRainViewerManifest)();if(!r||!e||!o)return;let a=r.radar.past;if(!a?.length)return;let n=a[a.length-1],l=(0,i.rainViewerTileUrl)(r.host,n);t.current?.remove(),t.current=window.L.tileLayer(l,{opacity:.6,attribution:'<a href="https://www.rainviewer.com">RainViewer</a>'}).addTo(e)},[e,o]);return(0,r.useEffect)(()=>{if(!o)return void a();n();let e=setInterval(n,3e5);return()=>{clearInterval(e),a()}},[o,n,a]),null}},{id:"flights",label:"✈ Flights",title:"Live flight traffic — altitude-coded",defaultEnabled:!1,component:function({map:e,enabled:o,zoom:t}){let a=(0,r.useRef)(new Map),n=(0,r.useRef)(new Map),d=(0,r.useRef)(new Map),c=(0,r.useRef)(new Map),p=(0,r.useRef)(new Map),g=(0,r.useRef)(null),x=(0,r.useRef)(null);(0,r.useEffect)(()=>(window.__atlantisFlightFollow=e=>{x.current=x.current===e?null:e},()=>{delete window.__atlantisFlightFollow}),[]);let h=(0,r.useCallback)(()=>{a.current.forEach(e=>e.remove()),a.current.clear(),n.current.forEach(e=>e.remove()),n.current.clear(),d.current.forEach(e=>e.remove()),d.current.clear(),c.current.clear(),p.current.clear(),x.current=null},[]),f=(0,r.useCallback)(async()=>{let r,h,f,u,m,b;if(!e||!o||t<5)return;let w=e.getCenter(),y=(r=e.getBounds(),h=e.getCenter(),f=r.getNorthEast(),u=h.lat*Math.PI/180,m=f.lat*Math.PI/180,Math.min(Math.ceil(6880.13*Math.atan2(Math.sqrt(b=Math.sin((f.lat-h.lat)*Math.PI/180/2)**2+Math.cos(u)*Math.cos(m)*Math.sin((f.lng-h.lng)*Math.PI/180/2)**2),Math.sqrt(1-b))),250));g.current?.abort(),g.current=new AbortController;try{let t=await (0,i.fetchAdsbPoint)({lat:w.lat,lon:w.lng,radiusNm:y,signal:g.current.signal});if(!t||!e||!o)return;let r=window.L,h=Date.now();for(let o of t.ac??[]){let t=null==o.lat||null==o.lon?null:{icao24:o.hex,callsign:o.flight?.trim()||null,lat:o.lat,lon:o.lon,altFt:"number"==typeof o.alt_baro?o.alt_baro:null,speedKts:o.gs??null,heading:o.track??null,vrateFpm:o.baro_rate??null,reg:o.r??null,type:o.t??null};if(!t||null==t.altFt)continue;let i=t.heading??0,g=l(t.altFt),f=x.current===t.icao24,u=r.divIcon({html:function(e,o,t){let r=t?`filter:drop-shadow(0 0 5px ${o}) drop-shadow(0 0 10px ${o});`:"filter:drop-shadow(0 1px 3px rgba(0,0,0,.9));";return`<div style="
  ...
  </div>`}(i,g,f),className:"",iconSize:[22,22],iconAnchor:[11,11]}),m=[...c.current.get(t.icao24)??[],[t.lat,t.lon]].slice(-15);c.current.set(t.icao24,m),p.current.set(t.icao24,h);let b=null!=t.speedKts&&null!=t.heading,w=b?1.852*t.speedKts*.5:0,[y,$]=b?function(e,o,t,r){let a=r/6371,i=e*Math.PI/180,n=t*Math.PI/180,l=Math.asin(Math.sin(i)*Math.cos(a)+Math.cos(i)*Math.sin(a)*Math.cos(n)),s=o*Math.PI/180+Math.atan2(Math.sin(n)*Math.sin(a)*Math.cos(i),Math.cos(a)-Math.sin(i)*Math.sin(l));return[180*l/Math.PI,180*s/Math.PI]}(t.lat,t.lon,t.heading,w):[t.lat,t.lon],v=a.current.get(t.icao24);if(v)v.setLatLng([t.lat,t.lon]),v.setIcon(u),v.getPopup()?.setContent(s(t)),n.current.get(t.icao24)?.setLatLngs([[t.lat,t.lon],[y,$]]),d.current.get(t.icao24)?.setLatLngs(m);else{let o=r.marker([t.lat,t.lon],{icon:u});if(o.bindPopup(s(t),{maxWidth:240}),o.addTo(e),a.current.set(t.icao24,o),b){let o=r.polyline([[t.lat,t.lon],[y,$]],{color:g,weight:1.5,opacity:.35,dashArray:"4 7",interactive:!1});o.addTo(e),n.current.set(t.icao24,o)}if(m.length>1){let o=r.polyline(m,{color:g,weight:1.5,opacity:.45,interactive:!1});o.addTo(e),d.current.set(t.icao24,o)}}}if(a.current.forEach((e,o)=>{let t=p.current.get(o)??0;h-t>5e4&&(e.remove(),a.current.delete(o),n.current.get(o)?.remove(),n.current.delete(o),d.current.get(o)?.remove(),d.current.delete(o),c.current.delete(o),p.current.delete(o),x.current===o&&(x.current=null))}),x.current){let o=a.current.get(x.current);o&&e.panTo(o.getLatLng(),{animate:!0,duration:.5})}}catch(e){if(e instanceof Error&&"AbortError"===e.name)return}},[e,o,t]);return(0,r.useEffect)(()=>{let e;if(!o||t<5)return void h();let r=!1,a=async()=>{await f(),r||(e=setTimeout(a,2e4))};return a(),()=>{r=!0,clearTimeout(e)}},[o,f,h]),(0,r.useEffect)(()=>{let t;if(!e||!o)return;let r=()=>{clearTimeout(t),t=setTimeout(f,1200)};return e.on("moveend",r),()=>{clearTimeout(t),e.off("moveend",r)}},[e,o,f]),null}},{id:"measure",label:"\uD83D\uDCCF Measure",title:"Click two points to measure great-circle distance",defaultEnabled:!1,component:function({map:e,enabled:o}){let t=(0,r.useRef)([]),a=(0,r.useRef)([]),i=(0,r.useRef)([]),n=(0,r.useRef)(null),l=(0,r.useCallback)(()=>{a.current.forEach(e=>e.remove()),a.current=[],i.current.forEach(e=>e.remove()),i.current=[],n.current?.remove(),n.current=null,t.current=[]},[]);return(0,r.useEffect)(()=>{if(!e||!o)return void l();let r=window.L,s=r.divIcon({html:`<div style="
        width:10px;height:10px;
        background:#58a6ff;
        border:2px solid #fff;
        border-radius:50%;
        box-shadow:0 0 6px rgba(88,166,255,.85);
      "></div>`,className:"",iconSize:[10,10],iconAnchor:[5,5]}),d=o=>{let{lat:d,lng:c}=o.latlng;t.current.length>=2&&l(),t.current=[...t.current,[d,c]];let p=r.marker([d,c],{icon:s,interactive:!1}).addTo(e);if(a.current.push(p),2===t.current.length){var g,x,h;let o,[a,l]=t.current,s=r.polyline([a,l],{color:"#58a6ff",weight:2,dashArray:"6 5",opacity:.85,interactive:!1}).addTo(e);i.current.push(s);let d=(g=a[0],x=a[1],12742*Math.atan2(Math.sqrt(o=Math.sin(((h=l[0])-g)*Math.PI/180/2)**2+Math.cos(g*Math.PI/180)*Math.cos(h*Math.PI/180)*Math.sin((l[1]-x)*Math.PI/180/2)**2),Math.sqrt(1-o))),c=(a[0]+l[0])/2,p=(a[1]+l[1])/2;n.current=r.popup({closeButton:!0,autoClose:!1,className:"",offset:[0,-4]}).setLatLng([c,p]).setContent(`
...
`,y=i().forwardRef(function({active:e=!1,shape:o="square",tone:t="default",children:a,...i},n){return(0,r.jsx)(w,{ref:n,active:e,shape:o,tone:t,...i,children:a})});l().div`
  position: relative;
  display: inline-flex;
`,l().div`
  position: absolute;
...
`,l().span`
  ...
  background: ${({color:e})=>e};
  display: inline-block;
`;let F={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:s.w4.colors.accentMuted},j={neutral:s.w4.colors.mainTextMuted,live:s.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:s.w4.colors.accent};l().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${s.w4.typography.fontFamilyMono};
...
`,K=l().div`
  ...
  color: ${s.w4.colors.sidebarTextMuted};
  font-family: ${s.w4.typography.fontFamily};
`;function N({onSave:e,onUpdate:o,onCancel:t,existingDoc:i}){let[n,l]=(0,a.useState)(i?.name??""),s=(0,a.useRef)(null);return(0,a.useEffect)(()=>{s.current?.focus(),i&&s.current?.select()},[i]),(0,r.jsx)(P,{onClick:t,children:(0,r.jsxs)(Y,{onClick:e=>e.stopPropagation(),children:[(0,r.jsx)(q,{children:"Save document"}),i&&o&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(K,{children:"Update the current version or save as a new one."}),(0,r.jsxs)(O,{children:[(0,r.jsx)(W,{onClick:t,children:"Cancel"}),(0,r.jsxs)(W,{danger:!0,onClick:o,children:['Update "',i.name,'"']})]}),(0,r.jsx)(G,{})]}),(0,r.jsx)(D,{ref:s,value:n,onChange:e=>l(e.target.value),onKeyDown:r=>{"Enter"===r.key&&n.trim()&&(i&&n.trim()===i.name&&o?o():e(n.trim())),"Escape"===r.key&&t()},placeholder:i?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,r.jsxs)(O,{children:[!i&&(0,r.jsx)(W,{onClick:t,children:"Cancel"}),(0,r.jsx)(W,{primary:!0,disabled:!n.trim(),onClick:()=>e(n.trim()),children:"Save as new"})]})]})})}let U=(0,$.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,X=(0,$.keyframes)`
