"use strict";(self.webpackChunk_atlantis_csvexplorer=self.webpackChunk_atlantis_csvexplorer||[]).push([[36],{6036(e,o,r){r.r(o),r.d(o,{default:()=>G});var s=r(7359),t=r(3233),n=r(9178),l=r(3775),i=r(679),a=r(5426),d=r(668),c=r(1344),p=r(3317),u=r(9161),x=r(4525),h=r(4490),m=r(9336),f=r(5723);const w=`&::-webkit-scrollbar{width:6px;height:6px}&::-webkit-scrollbar-track{background:transparent}&::-webkit-scrollbar-thumb{background:${n.w4.colors.border};border-radius:3px}scrollbar-width:thin;scrollbar-color:${n.w4.colors.border} transparent;`,g=t.default.div`display:flex;flex:1;overflow:hidden;`,b=t.default.div`
...
//# sourceMappingURL=36.16b9b8d0309869569f4b.js.map