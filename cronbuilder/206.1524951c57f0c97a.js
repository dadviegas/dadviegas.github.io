...
`,ea=l().div`
  ...
  color: ${s.w4.colors.sidebarTextMuted};
  font-family: ${s.w4.typography.fontFamily};
`;function et({onSave:e,onUpdate:o,onCancel:a,existingDoc:i}){let[n,l]=(0,r.useState)(i?.name??""),s=(0,r.useRef)(null);return(0,r.useEffect)(()=>{s.current?.focus(),i&&s.current?.select()},[i]),(0,t.jsx)(U,{onClick:a,children:(0,t.jsxs)(Z,{onClick:e=>e.stopPropagation(),children:[(0,t.jsx)(q,{children:"Save document"}),i&&o&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(ea,{children:"Update the current version or save as a new one."}),(0,t.jsxs)(Q,{children:[(0,t.jsx)(ee,{onClick:a,children:"Cancel"}),(0,t.jsxs)(ee,{danger:!0,onClick:o,children:['Update "',i.name,'"']})]}),(0,t.jsx)(eo,{})]}),(0,t.jsx)(X,{ref:s,value:n,onChange:e=>l(e.target.value),onKeyDown:t=>{"Enter"===t.key&&n.trim()&&(i&&n.trim()===i.name&&o?o():e(n.trim())),"Escape"===t.key&&a()},placeholder:i?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,t.jsxs)(Q,{children:[!i&&(0,t.jsx)(ee,{onClick:a,children:"Cancel"}),(0,t.jsx)(ee,{primary:!0,disabled:!n.trim(),onClick:()=>e(n.trim()),children:"Save as new"})]})]})})}let er=(0,y.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,ei=(0,y.keyframes)`
...
`,l().div`
  position: relative;
`;let ed="260px",ec="56px",ep="48px",eg=l().header`
  display: flex;
  align-items: center;
  height: calc(${ep} + env(safe-area-inset-top, 0px));
  ...
  @media (max-width: ${s.w4.breakpoints.md}) {
    flex-wrap: wrap;
    height: auto;
    min-height: calc(${ep} + env(safe-area-inset-top, 0px));
  }
`,em=l().div`
  width: ${ec};
  min-width: ${ec};
...
`,eu=l().span`
  ...
  animation: ${ef} 10s ease ${({index:e})=>.07*e}s infinite;
...
`,e$=l().div`
  ...
  overflow: hidden;
`,ev=l().aside`
  width: ${({collapsed:e})=>e?ec:ed};
  min-width: ${({collapsed:e})=>e?ec:ed};
  background: ${s.w4.colors.sidebarBg};
  border-right: 1px solid ${s.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,eM=l().main`
  ...
  display: flex;
  flex-direction: column;
`,ek=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function eA(){return(0,t.jsx)(ex,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:ek.map((e,o)=>(0,t.jsx)(eu,{index:o,accent:e.accent,children:e.char},o))})}let eT="atlantis:sidebar-collapsed";function eS({sidebar:e,children:o,topBarRight:n,title:l="Atlantis",activeId:s=null}){let[d,c]=(0,r.useState)(()=>{try{return"true"===localStorage.getItem(eT)}catch{return!1}}),[p,g]=(0,r.useState)(null),m=(0,r.useRef)(),h=()=>c(e=>{let o=!e;try{localStorage.setItem(eT,String(o))}catch{}return o}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(a.bind(a,5816)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,t.jsx)(E.I.Provider,{value:{collapsed:d,toggle:h,flyout:p,openFlyout:(e,o,a)=>{clearTimeout(m.current),g({entry:e,anchorY:o,onSelect:a})},scheduleFlyoutClose:()=>{m.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(m.current)},children:(0,t.jsxs)(e$,{children:[(0,t.jsxs)(eg,{children:[e&&(0,t.jsx)(em,{children:(0,t.jsx)(eh,{onClick:h,title:d?"Expand sidebar":"Collapse sidebar",children:(0,t.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("path",{d:"M9 3v18"})]})})}),(0,t.jsx)(eA,{}),l&&(0,t.jsx)(eb,{children:l}),n&&(0,t.jsx)(ey,{children:n})]}),(0,t.jsxs)(ew,{children:[null!=e&&(0,t.jsx)(ev,{collapsed:d,children:(0,t.jsx)(ez,{children:e})}),(0,t.jsx)(eM,{children:o})]}),p&&(0,t.jsx)(i().Suspense,{fallback:null,children:(0,t.jsx)(f,{activeId:s})})]})})}l().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
