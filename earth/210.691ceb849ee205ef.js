...
`,G=l().div`
  ...
  color: ${s.w4.colors.sidebarTextMuted};
  font-family: ${s.w4.typography.fontFamily};
`;function K({onSave:e,onUpdate:t,onCancel:r,existingDoc:i}){let[n,l]=(0,a.useState)(i?.name??""),s=(0,a.useRef)(null);return(0,a.useEffect)(()=>{s.current?.focus(),i&&s.current?.select()},[i]),(0,o.jsx)(E,{onClick:r,children:(0,o.jsxs)(P,{onClick:e=>e.stopPropagation(),children:[(0,o.jsx)(Y,{children:"Save document"}),i&&t&&(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(G,{children:"Update the current version or save as a new one."}),(0,o.jsxs)(q,{children:[(0,o.jsx)(D,{onClick:r,children:"Cancel"}),(0,o.jsxs)(D,{danger:!0,onClick:t,children:['Update "',i.name,'"']})]}),(0,o.jsx)(O,{})]}),(0,o.jsx)(W,{ref:s,value:n,onChange:e=>l(e.target.value),onKeyDown:o=>{"Enter"===o.key&&n.trim()&&(i&&n.trim()===i.name&&t?t():e(n.trim())),"Escape"===o.key&&r()},placeholder:i?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,o.jsxs)(q,{children:[!i&&(0,o.jsx)(D,{onClick:r,children:"Cancel"}),(0,o.jsx)(D,{primary:!0,disabled:!n.trim(),onClick:()=>e(n.trim()),children:"Save as new"})]})]})})}let X=(0,$.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,N=(0,$.keyframes)`
...
`,l().div`
  position: relative;
`;let J="260px",ee="56px",et="48px",er=l().header`
  display: flex;
  align-items: center;
  height: calc(${et} + env(safe-area-inset-top, 0px));
  ...
  @media (max-width: ${s.w4.breakpoints.md}) {
    flex-wrap: wrap;
    height: auto;
    min-height: calc(${et} + env(safe-area-inset-top, 0px));
  }
`,eo=l().div`
  width: ${ee};
  min-width: ${ee};
...
`,el=l().span`
  ...
  animation: ${ei} 10s ease ${({index:e})=>.07*e}s infinite;
...
`,ex=l().main`
  ...
  display: flex;
  flex-direction: column;
`,ef=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function eu(){return(0,o.jsx)(en,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:ef.map((e,t)=>(0,o.jsx)(el,{index:t,accent:e.accent,children:e.char},t))})}let em="atlantis:sidebar-collapsed";function eb({sidebar:e,children:t,topBarRight:n,title:l="Atlantis",activeId:s=null}){let[d,c]=(0,a.useState)(()=>{try{return"true"===localStorage.getItem(em)}catch{return!1}}),[p,h]=(0,a.useState)(null),g=(0,a.useRef)(),x=()=>c(e=>{let t=!e;try{localStorage.setItem(em,String(t))}catch{}return t}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(r.bind(r,2787)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,o.jsx)(V.I.Provider,{value:{collapsed:d,toggle:x,flyout:p,openFlyout:(e,t,r)=>{clearTimeout(g.current),h({entry:e,anchorY:t,onSelect:r})},scheduleFlyoutClose:()=>{g.current=setTimeout(()=>h(null),160)},cancelFlyoutClose:()=>clearTimeout(g.current)},children:(0,o.jsxs)(ep,{children:[(0,o.jsxs)(er,{children:[e&&(0,o.jsx)(eo,{children:(0,o.jsx)(ea,{onClick:x,title:d?"Expand sidebar":"Collapse sidebar",children:(0,o.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,o.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,o.jsx)("path",{d:"M9 3v18"})]})})}),(0,o.jsx)(eu,{}),l&&(0,o.jsx)(es,{children:l}),n&&(0,o.jsx)(ed,{children:n})]}),(0,o.jsxs)(ec,{children:[null!=e&&(0,o.jsx)(eh,{collapsed:d,children:(0,o.jsx)(eg,{children:e})}),(0,o.jsx)(ex,{children:t})]}),p&&(0,o.jsx)(i().Suspense,{fallback:null,children:(0,o.jsx)(f,{activeId:s})})]})})}var ew=r(4971);let ey=l().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
...
`;function eS({iconKey:e,size:t=16}){let r=e?ew.X[e]:void 0;return r?(0,o.jsx)("svg",{width:t,height:t,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,dangerouslySetInnerHTML:{__html:r}}):e?(0,o.jsx)("span",{style:{fontSize:t,lineHeight:1,display:"flex",alignItems:"center"},children:e}):(0,o.jsxs)("svg",{width:t,height:t,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,children:[(0,o.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,o.jsx)("polyline",{points:"14 2 14 8 20 8"})]})}function eL({entry:e,activeId:t,onSelect:r}){let[i,n]=(0,a.useState)(e.defaultOpen??!0),{collapsed:l,openFlyout:s,scheduleFlyoutClose:d,cancelFlyoutClose:c}=(0,V.c)();return e.children&&e.children.length>0?(0,o.jsxs)(eM,{children:[(0,o.jsxs)(ek,{collapsed:l,onClick:()=>{l||n(e=>!e)},onMouseEnter:l?t=>{s(e,t.currentTarget.getBoundingClientRect().top,r)}:void 0,onMouseLeave:l?d:void 0,children:[(0,o.jsxs)(ez,{collapsed:l,children:[(0,o.jsx)(eS,{iconKey:e.icon,size:16}),(0,o.jsx)(ej,{collapsed:l,children:e.name})]}),(0,o.jsx)(eF,{open:i,collapsed:l,children:(0,o.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round",children:(0,o.jsx)("path",{d:"M9 6l6 6-6 6"})})})]}),(0,o.jsx)(ey,{open:i&&!l,children:(0,o.jsx)(e$,{children:(0,o.jsx)(ev,{children:e.children.map(e=>(0,o.jsx)(eL,{entry:e,activeId:t,onSelect:r},e.id))})})})]}):(0,o.jsxs)(eT,{active:t===e.id,collapsed:l,onClick:()=>r(e),onMouseEnter:l?t=>{let o=t.currentTarget.getBoundingClientRect();s({id:e.id,name:e.name,icon:e.icon,file:e.file,children:[e]},o.top,r)}:void 0,onMouseLeave:l?d:void 0,children:[(0,o.jsx)(eS,{iconKey:e.icon,size:15}),(0,o.jsx)(ej,{collapsed:l,children:e.name})]})}function eH({entries:e,activeId:t,onSelect:r}){return(0,o.jsx)("div",{children:e.map(e=>(0,o.jsx)(eL,{entry:e,activeId:t,onSelect:r},e.id))})}r(2787),l().div`
