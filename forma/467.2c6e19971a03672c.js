"use strict";(self.webpackChunk_atlantis_forma=self.webpackChunk_atlantis_forma||[]).push([["467"],{7103(e,o,t){t.d(o,{j:()=>x});var r=t(5723),a=t(7991),i=t(6859),n=t.n(i),s=t(4764),l=t(5030),d=t(8837);let c=n().section`
...
`;function x({data:e,t:o,locale:t}){let[i,n]=(0,a.useState)(null),[m,u]=(0,a.useState)(""),[w,b]=(0,a.useState)(!1),[y,$]=(0,a.useState)(null);(0,a.useEffect)(()=>{(0,d.resolveGroqKey)().then(e=>n(!!e))},[]);let v=(0,a.useCallback)(async()=>{b(!0),$(null),u("");try{let r,a,i,n,s,l,c,p,g,f,h=await (0,d.resolveGroqKey)();if(!h){$(o("forma.ask.noKey")),b(!1);return}let x=(r=new Date().toISOString().slice(0,10),a=(0,d.proteinByDay)(e.meals,r),i=e.meals.filter(e=>e.date===r).reduce((e,o)=>e+(o.kcal??0),0),n=e.walks.filter(e=>e.date===r).reduce((e,o)=>e+o.minutes,0),s=(function(){let e=[],o=new Date;for(let t=6;t>=0;t-=1){let r=new Date(o);r.setDate(o.getDate()-t),e.push(r.toISOString().slice(0,10))}return e})().map(o=>({date:o,protein:(0,d.proteinByDay)(e.meals,o),kcal:e.meals.filter(e=>e.date===o).reduce((e,o)=>e+(o.kcal??0),0),walk:e.walks.filter(e=>e.date===o).reduce((e,o)=>e+o.minutes,0)})),(l=new Date).setDate(l.getDate()-6),c=(0,d.weeklyAdherence)(e.sessions,l,e.goal.weeklyFasts),p=(0,d.streakDays)(e.sessions,e.goal.targetHours),g=(0,d.avgFastDuration)(e.sessions,30),f=e.meals.filter(e=>e.date>=s[0].date).slice(-15).map(e=>`${e.date} ${e.slot} \xb7 ${e.proteinG??0}g protein \xb7 ${e.kcal??0}kcal \xb7 ${e.notes||""}`).join("\n"),`You are a concise nutrition + habit coach. Reply in ${"pt"===t?"Portuguese (PT-PT)":"English"}, max 5 short bullet points.
...
Give 3–5 bullets: what's going well, what to fix, one specific next-meal suggestion.`);await (0,d.askGroqStream)(x,{key:h,locale:t,maxTokens:400,onChunk:e=>u(e)})}catch(e){$(e instanceof Error?e.message:o("forma.ask.error"))}finally{b(!1)}},[e,t,o]);return null===i||!1===i?null:(0,r.jsxs)(c,{children:[(0,r.jsxs)(p,{children:[(0,r.jsxs)(g,{children:["✦ ",o("forma.ask.title")]}),(0,r.jsx)(l.$n,{variant:"accent",icon:(0,r.jsx)(l.In,{name:"message",size:14}),onClick:()=>void v(),disabled:w,children:w?o("forma.ask.loading"):o("forma.ask.button")})]}),y&&(0,r.jsx)(h,{children:y}),(m||w)&&(0,r.jsx)(f,{children:m||"…"}),!m&&!w&&!y&&(0,r.jsx)(f,{style:{color:s.w4.colors.mainTextMuted,fontStyle:"italic"},children:o("forma.ask.hint")})]})}},2552(e,o,t){t.d(o,{k:()=>z});var r=t(5723),a=t(7991),i=t(6859),n=t.n(i),s=t(4764),l=t(5030),d=t(8837);let c="#7fb77e",p=2*Math.PI*95,g=n().div`
  display: flex;
  flex-direction: column;
  align-items: center;
  gap: ${s.w4.spacing.md};
...
`,M=n().span`
  ...
  text-transform: uppercase;
  letter-spacing: 0.16em;
`;function z({data:e,t:o,onStart:t,onStop:i,onEditStart:n}){let j,T,F,S,C,[H,R]=(0,a.useState)(Date.now),L=e.sessions.some(e=>void 0===e.endedAt);(0,a.useEffect)(()=>{if(!L)return;let e=setInterval(()=>R(Date.now()),1e3);return()=>clearInterval(e)},[L]);let A=(0,d.currentFast)(e,H),D=A?.percent??0,E=null!==A,I=A?A.hoursElapsed:0,B=A?A.remainingMs:0,W=A?A.session.targetHours:e.goal.targetHours;return(0,r.jsxs)(g,{children:[(0,r.jsxs)(f,{children:[(0,r.jsxs)(h,{width:200,height:200,viewBox:"0 0 200 200","aria-hidden":"true",children:[(0,r.jsx)("circle",{cx:100,cy:100,r:95,fill:"none",stroke:s.w4.colors.border,strokeWidth:10}),(0,r.jsx)("circle",{cx:100,cy:100,r:95,fill:"none",stroke:c,strokeWidth:10,strokeLinecap:"round",strokeDasharray:p,strokeDashoffset:p*(1-D),style:{transition:"stroke-dashoffset 0.6s ease"}})]}),(0,r.jsx)(x,{children:E?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(m,{children:[I.toFixed(1),"h"]}),(0,r.jsx)(u,{children:o("forma.timer.elapsed")})]}):(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(m,{children:[W,"h"]}),(0,r.jsx)(u,{children:o("forma.hero.notFasting")})]})})]}),E&&A&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(y,{children:[(0,r.jsx)(w,{children:A.session.protocol}),n&&(0,r.jsx)($,{type:"button",onClick:()=>n(A.session),title:o("forma.timer.editStart"),children:o("forma.timer.startedAt",{time:(T=String((j=new Date(A.session.startedAt)).getHours()).padStart(2,"0"),F=String(j.getMinutes()).padStart(2,"0"),`${T}:${F}`)})})]}),(0,r.jsxs)(b,{children:[(0,r.jsxs)(v,{children:[(0,r.jsx)(k,{children:(C=Math.floor((S=Math.floor(B/6e4))/60),`${String(C).padStart(2,"0")}:${String(S%60).padStart(2,"0")}`)}),(0,r.jsx)(M,{children:o("forma.timer.remaining")})]}),(0,r.jsxs)(v,{children:[(0,r.jsxs)(k,{children:[Math.round(100*D),"%"]}),(0,r.jsx)(M,{children:o("forma.timer.complete")})]})]})]}),E&&A?(0,r.jsx)(l.$n,{variant:"danger",onClick:()=>i(A.session),children:o("forma.stop")}):(0,r.jsx)(l.$n,{variant:"success",onClick:t,children:o("forma.start")})]})}},4406(e,o,t){t.d(o,{C:()=>u});var r=t(5723),a=t(7991),i=t(6859),n=t.n(i),s=t(4764),l=t(5030);let d="#7fb77e",c="forma:layout",p=n().div`
  display: grid;
...
`;function u({cards:e,t:o}){let[t,i]=(0,a.useState)(null);(0,a.useEffect)(()=>{let o=!1;return(async()=>{let t=await (0,s.PL)(c),r=null;if(t)try{r=JSON.parse(t)}catch{r=null}o||i(function(e,o){let t=new Set(o.map(e=>e.id)),r=new Set,a=[];if(e)for(let o of e)t.has(o.id)&&(a.push(o),r.add(o.id));for(let e of o)r.has(e.id)||a.push({id:e.id,size:e.defaultSize??"sm",hidden:!1});return a}(r,e))})(),()=>{o=!0}},[e.map(e=>e.id).join("|")]);let n=(0,a.useCallback)(e=>{i(e),(0,s.Is)(c,JSON.stringify(e))},[]),d=(0,a.useCallback)((e,o)=>{if(!t)return;let r=t.filter(e=>!e.hidden),a=r.findIndex(o=>o.id===e);if(-1===a)return;let i=a+o;if(i<0||i>=r.length)return;let s=r[i],l=t.findIndex(o=>o.id===e),d=t.findIndex(e=>e.id===s.id),c=[...t];[c[l],c[d]]=[c[d],c[l]],n(c)},[t,n]),w=(0,a.useCallback)(e=>{t&&n(t.map(o=>{var t;return o.id===e?{...o,size:"sm"===(t=o.size)?"md":"md"===t?"lg":"sm"}:o}))},[t,n]),b=(0,a.useCallback)(e=>{t&&n(t.map(o=>o.id===e?{...o,hidden:!0}:o))},[t,n]),y=(0,a.useCallback)(e=>{t&&n(t.map(o=>o.id===e?{...o,hidden:!1}:o))},[t,n]),$=(0,a.useMemo)(()=>{let o=new Map;for(let t of e)o.set(t.id,t);return o},[e]);if(!t)return(0,r.jsx)(p,{});let v=t.filter(e=>!e.hidden),k=t.filter(e=>e.hidden);return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(p,{children:v.map((e,t)=>{let a=$.get(e.id);return a?(0,r.jsxs)(g,{size:e.size,children:[a.render(),(0,r.jsxs)(f,{className:"forma-grid-controls",children:[(0,r.jsx)(h,{onClick:()=>d(e.id,-1),disabled:0===t,title:o("forma.grid.moveLeft"),"aria-label":o("forma.grid.moveLeft"),children:(0,r.jsx)(l.In,{name:"chevron-left",size:14})}),(0,r.jsx)(h,{onClick:()=>d(e.id,1),disabled:t===v.length-1,title:o("forma.grid.moveRight"),"aria-label":o("forma.grid.moveRight"),children:(0,r.jsx)(l.In,{name:"chevron-right",size:14})}),(0,r.jsx)(h,{onClick:()=>w(e.id),title:o("forma.grid.resize",{size:e.size.toUpperCase()}),"aria-label":o("forma.grid.resize",{size:e.size.toUpperCase()}),children:(0,r.jsx)(l.In,{name:"grid",size:14})}),(0,r.jsx)(h,{onClick:()=>b(e.id),title:o("forma.grid.hide"),"aria-label":o("forma.grid.hide"),children:(0,r.jsx)(l.In,{name:"close",size:14})})]})]},e.id):null})}),k.length>0&&(0,r.jsxs)(x,{children:[(0,r.jsx)("span",{style:{fontSize:11,fontFamily:s.w4.typography.fontFamilyMono,color:s.w4.colors.mainTextMuted,textTransform:"uppercase",letterSpacing:"0.16em",alignSelf:"center",marginRight:8},children:o("forma.grid.hiddenLabel")}),k.map(e=>(0,r.jsxs)(m,{onClick:()=>y(e.id),children:["+ ",o(`forma.grid.card.${e.id}`)]},e.id))]})]})}},9276(e,o,t){t.d(o,{Y:()=>C});var r=t(5723),a=t(7991),i=t(6859),n=t.n(i),s=t(4764),l=t(5030),d=t(2799);let c=(0,d.keyframes)`
...
`,m=n().div`
  ...
  min-height: 0;
  overflow-y: auto;
`;function u({open:e,onClose:o,children:t,maxWidth:i=480,ariaLabel:n}){let s=(0,a.useRef)(null);(0,a.useEffect)(()=>{if(!e)return;let t=e=>{"Escape"===e.key&&o()};return window.addEventListener("keydown",t),()=>window.removeEventListener("keydown",t)},[e,o]),(0,a.useEffect)(()=>{if(!e||!s.current)return;let o=s.current.querySelector('button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])');o?.focus()},[e]);let l=(0,a.useRef)(null),d=(0,a.useCallback)(e=>{l.current={y:e.touches[0].clientY}},[]),c=(0,a.useCallback)(e=>{if(!l.current||!s.current)return;let t=e.changedTouches[0].clientY-l.current.y;l.current=null,t<=0||t/s.current.getBoundingClientRect().height>.3&&o()},[o]),p=(0,a.useRef)(null),w=(0,a.useCallback)(e=>{p.current={y:e.clientY}},[]),b=(0,a.useCallback)(e=>{if(!p.current||!s.current)return;let t=e.clientY-p.current.y;p.current=null,t<=0||t/s.current.getBoundingClientRect().height>.3&&o()},[o]);return e?(0,r.jsx)(g,{onClick:o,role:"dialog","aria-modal":"true","aria-label":n,children:(0,r.jsxs)(f,{ref:s,maxWidth:i,onClick:e=>e.stopPropagation(),children:[(0,r.jsx)(h,{onTouchStart:d,onTouchEnd:c,onPointerDown:w,onPointerUp:b,"aria-hidden":"true",children:(0,r.jsx)(x,{})}),(0,r.jsx)(m,{children:t})]})}):null}function w(){return new Date().toISOString().slice(0,10)}let b="#7fb77e",y=n().div`
...
`;function C({open:e,onClose:o,data:t,t:i,initialMode:n,editing:s,onStartFast:d,onStopFast:c,onLogMeal:p,onEditMeal:g,onLogWeight:f,onEditWeight:h,onLogWalk:x,onEditWalk:m}){let[b,H]=(0,a.useState)(n??null),[R,L]=(0,a.useState)("16:8"),[A,D]=(0,a.useState)("16"),[E,I]=(0,a.useState)("dinner"),[B,W]=(0,a.useState)(""),[P,V]=(0,a.useState)(""),[Y,O]=(0,a.useState)(""),[N,G]=(0,a.useState)(w),[q,K]=(0,a.useState)(""),[J,Z]=(0,a.useState)(w),[X,_]=(0,a.useState)(""),[Q,U]=(0,a.useState)(w);(0,a.useEffect)(()=>{if(e)if(s?.kind==="meal"){let e=s.entry;H("meal"),I(e.slot),W(String(e.proteinG??"")),V(String(e.kcal??"")),O(e.notes??""),G(e.date)}else s?.kind==="weight"?(H("weight"),K(String(s.entry.kg)),Z(s.entry.date)):s?.kind==="walk"?(H("walk"),_(String(s.entry.minutes)),U(s.entry.date)):n&&(H(n),"meal"===n?(I("dinner"),W(""),V(""),O(""),G(w())):"weight"===n?(K(""),Z(w())):"walk"===n&&(_(""),U(w())))},[e,s,n]);let ee=t.sessions.some(e=>void 0===e.endedAt),eo=s?.kind??("startFast"===n?"fast":"meal"===n?"meal":"weight"===n?"weight":"walk"===n?"walk":null),et=null===eo||"fast"===eo,er=null===eo||"meal"===eo,ea=null===eo||"weight"===eo,ei=null===eo||"walk"===eo,en=(0,a.useCallback)(()=>{H(null)},[]),es=(0,a.useCallback)(()=>{en(),o()},[en,o]),el=(0,a.useCallback)(()=>{let e=parseInt(A,10);isNaN(e)||e<1||(d(R,e),es())},[R,A,d,es]),ed=(0,a.useCallback)(()=>{let e=parseFloat(B)||0,o=parseFloat(P)||0;s?.kind==="meal"&&g?g(s.entry.id,E,e,o,Y.trim(),N):p(E,e,o,Y.trim(),N),es()},[s,g,E,B,P,Y,N,p,es]),ec=(0,a.useCallback)(()=>{let e=parseFloat(q.replace(",","."));isNaN(e)||e<=0||(s?.kind==="weight"&&h?h(J,e):f(e,J),es())},[s,h,q,J,f,es]),ep=(0,a.useCallback)(()=>{let e=parseInt(X,10);isNaN(e)||e<=0||(s?.kind==="walk"&&m?m(s.entry.id,e,Q):x(e,Q),es())},[s,m,X,Q,x,es]);return(0,r.jsx)(u,{open:e,onClose:es,maxWidth:520,ariaLabel:i("forma.sheet.ariaLabel"),children:(0,r.jsxs)(y,{children:[(0,r.jsx)(l.YZ,{children:i(s?.kind==="meal"?"forma.sheet.titleEditMeal":s?.kind==="weight"?"forma.sheet.titleEditWeight":s?.kind==="walk"?"forma.sheet.titleEditWalk":"meal"===n?"forma.sheet.titleAddMeal":"weight"===n?"forma.sheet.titleAddWeight":"walk"===n?"forma.sheet.titleAddWalk":"forma.sheet.title")}),et&&(0,r.jsx)(v,{children:(0,r.jsx)(l.YZ,{children:i("forma.sheet.fastSection")})}),et&&(ee?(0,r.jsx)(l.$n,{variant:"danger",onClick:()=>{c(),es()},children:i("forma.stop")}):"startFast"===b?(0,r.jsxs)($,{children:[(0,r.jsxs)(k,{children:[(0,r.jsx)(M,{htmlFor:"fast-protocol",children:i("forma.rail.title")}),(0,r.jsxs)(j,{id:"fast-protocol",value:R,onChange:e=>{let o=e.target.value;L(o),"custom"!==o&&D(o.split(":")[0])},children:[(0,r.jsx)("option",{value:"16:8",children:"16:8"}),(0,r.jsx)("option",{value:"18:6",children:"18:6"}),(0,r.jsx)("option",{value:"20:4",children:"20:4"}),(0,r.jsx)("option",{value:"custom",children:i("forma.protocol.custom")})]})]}),"custom"===R&&(0,r.jsxs)(k,{children:[(0,r.jsx)(M,{htmlFor:"fast-hours",children:i("forma.timer.target")}),(0,r.jsx)(z,{id:"fast-hours",type:"number",value:A,min:1,max:72,onChange:e=>D(e.target.value)})]}),(0,r.jsxs)(S,{children:[(0,r.jsx)(l.$n,{variant:"success",onClick:el,children:i("forma.start")}),(0,r.jsx)(l.$n,{variant:"ghost",onClick:en,children:i("forma.sheet.cancel")})]})]}):(0,r.jsxs)(F,{onClick:()=>H("startFast"),children:[(0,r.jsx)(l.In,{name:"play",size:16}),i("forma.start")]})),er&&(0,r.jsx)(v,{children:(0,r.jsx)(l.YZ,{children:i("forma.sheet.mealSection")})}),er&&("meal"===b?(0,r.jsxs)($,{children:[(0,r.jsxs)(k,{children:[(0,r.jsx)(M,{htmlFor:"meal-slot",children:i("forma.meal.lunch")}),(0,r.jsxs)(T,{id:"meal-slot",value:E,onChange:e=>I(e.target.value),children:[(0,r.jsx)("option",{value:"lunch",children:i("forma.meal.lunch")}),(0,r.jsx)("option",{value:"dinner",children:i("forma.meal.dinner")}),(0,r.jsx)("option",{value:"snack",children:i("forma.meal.snack")})]})]}),(0,r.jsxs)(k,{children:[(0,r.jsx)(M,{htmlFor:"meal-protein",children:i("forma.sheet.proteinLabel")}),(0,r.jsx)(z,{id:"meal-protein",type:"number",value:B,min:0,placeholder:"0",onChange:e=>W(e.target.value)})]}),(0,r.jsxs)(k,{children:[(0,r.jsx)(M,{htmlFor:"meal-kcal",children:i("forma.sheet.kcalLabel")}),(0,r.jsx)(z,{id:"meal-kcal",type:"number",value:P,min:0,placeholder:"0",onChange:e=>V(e.target.value)})]}),(0,r.jsxs)(k,{children:[(0,r.jsx)(M,{htmlFor:"meal-notes",children:i("forma.meal.template")}),(0,r.jsx)(z,{id:"meal-notes",type:"text",value:Y,placeholder:"ovos, frango…",onChange:e=>O(e.target.value)})]}),(0,r.jsxs)(k,{children:[(0,r.jsx)(M,{htmlFor:"meal-date",children:i("forma.sheet.dateLabel")}),(0,r.jsx)(z,{id:"meal-date",type:"date",value:N,max:w(),onChange:e=>G(e.target.value)})]}),(0,r.jsxs)(S,{children:[(0,r.jsx)(l.$n,{variant:"primary",onClick:ed,children:i(s?.kind==="meal"?"forma.sheet.saveEdit":"forma.sheet.save")}),(0,r.jsx)(l.$n,{variant:"ghost",onClick:en,children:i("forma.sheet.cancel")})]})]}):(0,r.jsxs)(F,{onClick:()=>H("meal"),children:[(0,r.jsx)(l.In,{name:"utensils",size:16}),i("forma.sheet.logMeal")]})),ea&&(0,r.jsx)(v,{children:(0,r.jsx)(l.YZ,{children:i("forma.sheet.weightSection")})}),ea&&("weight"===b?(0,r.jsxs)($,{children:[(0,r.jsxs)(k,{children:[(0,r.jsx)(M,{htmlFor:"weight-kg",children:i("forma.sheet.weightLabel")}),(0,r.jsx)(z,{id:"weight-kg",type:"number",value:q,min:20,max:300,step:.1,placeholder:"84.2",onChange:e=>K(e.target.value)})]}),(0,r.jsxs)(k,{children:[(0,r.jsx)(M,{htmlFor:"weight-date",children:i("forma.sheet.dateLabel")}),(0,r.jsx)(z,{id:"weight-date",type:"date",value:J,max:w(),onChange:e=>Z(e.target.value)})]}),(0,r.jsxs)(S,{children:[(0,r.jsx)(l.$n,{variant:"primary",onClick:ec,children:i(s?.kind==="weight"?"forma.sheet.saveEdit":"forma.sheet.save")}),(0,r.jsx)(l.$n,{variant:"ghost",onClick:en,children:i("forma.sheet.cancel")})]})]}):(0,r.jsxs)(F,{onClick:()=>H("weight"),children:[(0,r.jsx)(l.In,{name:"trending-up",size:16}),i("forma.sheet.logWeight")]})),ei&&(0,r.jsx)(v,{children:(0,r.jsx)(l.YZ,{children:i("forma.sheet.walkSection")})}),ei&&("walk"===b?(0,r.jsxs)($,{children:[(0,r.jsxs)(k,{children:[(0,r.jsx)(M,{htmlFor:"walk-min",children:i("forma.sheet.walkLabel")}),(0,r.jsx)(z,{id:"walk-min",type:"number",value:X,min:1,max:600,placeholder:"30",onChange:e=>_(e.target.value)})]}),(0,r.jsxs)(k,{children:[(0,r.jsx)(M,{htmlFor:"walk-date",children:i("forma.sheet.dateLabel")}),(0,r.jsx)(z,{id:"walk-date",type:"date",value:Q,max:w(),onChange:e=>U(e.target.value)})]}),(0,r.jsxs)(S,{children:[(0,r.jsx)(l.$n,{variant:"primary",onClick:ep,children:i(s?.kind==="walk"?"forma.sheet.saveEdit":"forma.sheet.save")}),(0,r.jsx)(l.$n,{variant:"ghost",onClick:en,children:i("forma.sheet.cancel")})]})]}):(0,r.jsxs)(F,{onClick:()=>H("walk"),children:[(0,r.jsx)(l.In,{name:"activity",size:16}),i("forma.sheet.logWalk")]}))]})})}},950(e,o,t){t.d(o,{M:()=>S});var r=t(5723),a=t(7991),i=t(6859),n=t.n(i),s=t(4764),l=t(8837);let d="#7fb77e";function c(e){return[parseInt(e.slice(1,3),16),parseInt(e.slice(3,5),16),parseInt(e.slice(5,7),16)]}let p=c("#1d2230"),g=c(d);function f(e){let o=Math.round(p[0]+(g[0]-p[0])*e),t=Math.round(p[1]+(g[1]-p[1])*e),r=Math.round(p[2]+(g[2]-p[2])*e);return`rgb(${o},${t},${r})`}let h=new Set([0,4,8,12,16,20]),x=["Mo","Tu","We","Th","Fr","Sa","Su"],m=["Se","Te","Qa","Qi","Sx","S\xe1","Do"],u=n().section`
  background: ${s.w4.colors.surface};
  border: 1px solid ${s.w4.colors.border};
...
`,F=n().div`
  ...
  color: ${s.w4.colors.mainTextMuted};
  margin-top: 2px;
`;function S({data:e,t:o,locale:t}){let i=(0,a.useMemo)(()=>(0,l.mealDayHourMatrix)(e.meals),[e.meals]),n=(0,a.useMemo)(()=>(0,l.mealKcalByHour)(e.meals),[e.meals]),s=(0,a.useMemo)(()=>{let e=0;for(let o of i)for(let t of o)t>e&&(e=t);return e},[i]),d=(0,a.useMemo)(()=>Math.max(0,...n),[n]),c=(0,a.useMemo)(()=>n.reduce((e,o)=>e+o,0),[n]),p="pt"===t?m:x;return(0,r.jsxs)(u,{children:[(0,r.jsx)(w,{children:o("forma.mealHeatmap.title")}),(0,r.jsxs)(b,{children:[(0,r.jsx)($,{}),Array.from({length:24},(e,o)=>(0,r.jsx)(y,{children:h.has(o)?String(o).padStart(2,"0"):""},o))]}),i.map((e,o)=>(0,r.jsxs)(v,{children:[(0,r.jsx)(k,{children:p[o]}),e.map((e,t)=>(0,r.jsx)(M,{bg:0===s?f(0):f(e/s),title:e>0?`${p[o]} ${String(t).padStart(2,"0")}:00 — ${Math.round(e)} kcal`:void 0},t))]},o)),(0,r.jsxs)(z,{children:[(0,r.jsx)($,{}),(0,r.jsx)(j,{children:n.map((e,o)=>(0,r.jsx)(T,{pct:0===d?0:e/d},o))})]}),(0,r.jsxs)(F,{children:[(0,r.jsx)("span",{children:"0"}),(0,r.jsxs)("span",{children:[Math.round(c).toLocaleString()," kcal"]})]})]})}},2128(e,o,t){t.d(o,{g:()=>w});var r=t(5723),a=t(7991),i=t(6859),n=t.n(i),s=t(4764),l=t(8837);let d="#7fb77e",c=n().button`
  display: flex;
  align-items: center;
  gap: ${s.w4.spacing.md};
  background: ${s.w4.colors.surface};
...
`,m=n().span`
  ...
  font-family: ${s.w4.typography.fontFamilyMono};
  color: ${s.w4.colors.mainTextFaint??s.w4.colors.mainTextMuted};
`,u=2*Math.PI*22;function w({data:e,t:o,onClick:t}){let[i,n]=(0,a.useState)(Date.now),b=e.sessions.some(e=>void 0===e.endedAt);(0,a.useEffect)(()=>{if(!b)return;let e=setInterval(()=>n(Date.now()),3e4);return()=>clearInterval(e)},[b]);let y=(0,l.currentFast)(e,i),$=y?.percent??0,v=y?Math.max(0,y.session.targetHours-y.hoursElapsed):0,k=y?`${v.toFixed(1)}h ${o("forma.timer.remaining")}`:o("forma.hero.notFasting");return(0,r.jsxs)(c,{onClick:t,"aria-label":o("forma.miniFast.aria"),children:[(0,r.jsxs)(p,{children:[(0,r.jsxs)("svg",{width:48,height:48,viewBox:"0 0 48 48",style:{transform:"rotate(-90deg)"},children:[(0,r.jsx)("circle",{cx:24,cy:24,r:22,fill:"none",stroke:s.w4.colors.border,strokeWidth:4}),y&&(0,r.jsx)("circle",{cx:24,cy:24,r:22,fill:"none",stroke:d,strokeWidth:4,strokeLinecap:"round",strokeDasharray:u,strokeDashoffset:u*(1-$),style:{transition:"stroke-dashoffset 0.6s ease"}})]}),(0,r.jsx)(g,{children:y?`${Math.round(100*$)}%`:"—"})]}),(0,r.jsxs)(f,{children:[(0,r.jsxs)(h,{children:["◉ ",o("forma.miniFast.title")]}),(0,r.jsx)(x,{children:y?`${y.hoursElapsed.toFixed(1)}h / ${y.session.targetHours}h`:o("forma.miniFast.noActive")}),(0,r.jsx)(m,{children:k})]})]})}},9446(e,o,t){t.d(o,{S:()=>w});var r=t(5723),a=t(7991),i=t(6859),n=t.n(i),s=t(4764),l=t(8837),d=t(1533);let c="#7fb77e",p=n().button`
  display: flex;
  flex-direction: column;
  gap: ${s.w4.spacing.sm};
  background: ${s.w4.colors.surface};
...
`,u=n().div`
  flex: 1;
  min-height: 60px;
`;function w({data:e,t:o,onClick:t}){let i=(0,a.useMemo)(()=>(0,l.weightForecast)(e.weights,60,30),[e.weights]),n=i.history.length>0?i.history[i.history.length-1]:null,c=i.forecast.length>0?i.forecast[i.forecast.length-1]:null,b=n&&c?c.kg-n.kg:0;return(0,r.jsxs)(p,{onClick:t,"aria-label":o("forma.miniWeight.aria"),children:[(0,r.jsxs)(g,{children:[(0,r.jsxs)(f,{children:["◉ ",o("forma.miniWeight.title")]}),c&&(0,r.jsxs)(m,{pos:b>0,children:[b>=0?"+":"",b.toFixed(1),"kg / 30d"]})]}),(0,r.jsxs)(h,{children:[(0,r.jsx)(x,{children:n?n.kg.toFixed(1):"—"}),(0,r.jsx)("span",{style:{color:s.w4.colors.mainTextMuted,fontSize:13,fontFamily:s.w4.typography.fontFamilyMono},children:"kg"}),c&&(0,r.jsxs)("span",{style:{color:s.w4.colors.mainTextMuted,fontSize:12,fontFamily:s.w4.typography.fontFamilyMono},children:["→ ",c.kg.toFixed(1)," kg"]})]}),(0,r.jsx)(u,{children:(0,r.jsx)(d.h,{forecast:i,axes:!1})})]})}},8477(e,o,t){t.d(o,{P:()=>p});var r=t(5723),a=t(6859),i=t.n(a),n=t(4764);let s="#7fb77e",l=["16:8","18:6","20:4","custom"],d=i().div`
  display: flex;
  gap: ${n.w4.spacing.sm};
  overflow-x: auto;
...
`;function p({t:e,active:o,onChange:t}){return(0,r.jsx)(d,{role:"group","aria-label":e("forma.rail.title"),children:l.map(a=>(0,r.jsx)(c,{active:o===a,onClick:()=>t(a),"aria-pressed":o===a,children:e(`forma.protocol.${a}`)},a))})}},1589(e,o,t){t.d(o,{B:()=>h});var r=t(5723),a=t(6859),i=t.n(a),n=t(4764);let s="#7fb77e",l=[{id:"16:8",fastH:16,windowH:8},{id:"18:6",fastH:18,windowH:6},{id:"20:4",fastH:20,windowH:4},{id:"custom",fastH:0,windowH:0}],d=i().aside`
  width: 260px;
  flex-shrink: 0;
...
`,f=i().span`
  ...
  font-family: ${n.w4.typography.fontFamilyMono};
  color: ${n.w4.colors.mainTextMuted};
`;function h({t:e,active:o,onChange:t}){return(0,r.jsxs)(d,{"aria-label":e("forma.rail.title"),children:[(0,r.jsx)(c,{children:e("forma.rail.title")}),l.map(a=>(0,r.jsxs)(p,{active:o===a.id,onClick:()=>t(a.id),"aria-pressed":o===a.id,children:[(0,r.jsx)(g,{active:o===a.id,children:e(`forma.protocol.${a.id}`)}),a.fastH>0&&(0,r.jsxs)(f,{children:[e("forma.rail.hours",{n:a.fastH})," \xb7 ",e("forma.rail.window",{n:a.windowH})]})]},a.id))]})}},5405(e,o,t){t.d(o,{F:()=>p});var r=t(5723),a=t(7991),i=t(6859),n=t.n(i),s=t(4764);let l=n().form`
  display: flex;
  align-items: center;
  gap: ${s.w4.spacing.sm};
  padding: ${s.w4.spacing.sm} ${s.w4.spacing.md};
...
`,c=n().span`
  ...
  color: ${s.w4.colors.mainTextMuted};
  white-space: nowrap;
`;function p({t:e,onParsed:o}){let[t,i]=(0,a.useState)(""),[n,s]=(0,a.useState)(!1),g=(0,a.useCallback)(e=>{e.preventDefault();let r=function(e){let o=e.trim().toLowerCase();if(!o)return null;let t=o.match(/^(?:peso|weight)\s+(\d+(?:[.,]\d+)?)/);if(t){let e=parseFloat(t[1].replace(",","."));if(!isNaN(e))return{kind:"weight",weightKg:e}}let r=o.match(/^(?:caminhei|walked|walk|caminhada)\s+(\d+)/);if(r){let e=parseInt(r[1],10);if(!isNaN(e))return{kind:"walk",walkMinutes:e}}let a=o.match(/^(?:jejum|fast)\s+(\d+)/);if(a){let e=parseInt(a[1],10);if(!isNaN(e))return{kind:"fast",fastHours:e,fastProtocol:16===e?"16:8":18===e?"18:6":20===e?"20:4":"custom"}}let i=o.match(/^(jantar|almoço|almoco|dinner|snack|lanche|lunch)\s+(.*)/);if(i){let e=i[1];return{kind:"meal",mealSlot:"jantar"===e||"dinner"===e?"dinner":"almo\xe7o"===e||"almoco"===e||"lunch"===e?"lunch":"snack",mealDesc:i[2].trim()}}return null}(t);if(!r){s(!0),setTimeout(()=>s(!1),1200);return}o(r),i("")},[t,o]);return(0,r.jsxs)(l,{onSubmit:g,children:[(0,r.jsx)(d,{value:t,onChange:e=>i(e.target.value),placeholder:e("forma.quickadd.placeholder"),style:{borderColor:n?"#f85149":void 0},"aria-label":e("forma.quickadd.hint")}),(0,r.jsx)(c,{children:e("forma.quickadd.hint")})]})}},429(e,o,t){t.d(o,{f:()=>w});var r=t(5723),a=t(7991),i=t(6859),n=t.n(i),s=t(4764),l=t(5030);let d="#7fb77e",c=n().section`
  display: flex;
  flex-direction: column;
  gap: ${s.w4.spacing.lg};
  max-width: 560px;
...
`,u=n().span`
  ...
  color: ${d};
  align-self: center;
`;function w({data:e,t:o,onSave:t}){let[i,n]=(0,a.useState)(String(e.goal.proteinG??110)),[s,d]=(0,a.useState)(String(e.goal.kcal??2200)),[b,y]=(0,a.useState)(String(e.goal.walkMin??30)),[$,v]=(0,a.useState)(String(e.goal.weightKg??"")),[k,M]=(0,a.useState)(String(e.goal.targetHours)),[z,j]=(0,a.useState)(String(e.goal.weeklyFasts)),[T,F]=(0,a.useState)(!1),S=async()=>{let o={...e,goal:{targetHours:Number(k)||16,weeklyFasts:Number(z)||5,proteinG:Number(i)||void 0,kcal:Number(s)||void 0,walkMin:Number(b)||void 0,weightKg:$?Number($):void 0}};await t(o),F(!0),setTimeout(()=>F(!1),2e3)};return(0,r.jsxs)(c,{children:[(0,r.jsxs)(p,{children:[(0,r.jsxs)(g,{children:["◉ ",o("forma.settings.foodGoals")]}),(0,r.jsxs)(f,{children:[(0,r.jsx)(h,{children:o("forma.settings.proteinG")}),(0,r.jsx)(x,{type:"number",value:i,onChange:e=>n(e.target.value)})]}),(0,r.jsxs)(f,{children:[(0,r.jsx)(h,{children:o("forma.settings.kcal")}),(0,r.jsx)(x,{type:"number",value:s,onChange:e=>d(e.target.value)})]}),(0,r.jsxs)(f,{children:[(0,r.jsx)(h,{children:o("forma.settings.walkMin")}),(0,r.jsx)(x,{type:"number",value:b,onChange:e=>y(e.target.value)})]}),(0,r.jsxs)(f,{children:[(0,r.jsx)(h,{children:o("forma.settings.weightTarget")}),(0,r.jsx)(x,{type:"number",step:"0.1",value:$,onChange:e=>v(e.target.value)})]})]}),(0,r.jsxs)(p,{children:[(0,r.jsxs)(g,{children:["◉ ",o("forma.settings.fastingGoals")]}),(0,r.jsxs)(f,{children:[(0,r.jsx)(h,{children:o("forma.settings.targetHours")}),(0,r.jsx)(x,{type:"number",value:k,onChange:e=>M(e.target.value)})]}),(0,r.jsxs)(f,{children:[(0,r.jsx)(h,{children:o("forma.settings.weeklyFasts")}),(0,r.jsx)(x,{type:"number",value:z,onChange:e=>j(e.target.value)})]})]}),(0,r.jsxs)(m,{children:[T&&(0,r.jsx)(u,{children:o("forma.settings.saved")}),(0,r.jsx)(l.$n,{variant:"primary",onClick:()=>void S(),children:o("forma.settings.save")})]})]})}},5742(e,o,t){t.d(o,{_:()=>F});var r=t(5723),a=t(6859),i=t.n(a),n=t(4764),s=t(5030),l=t(8837);let d="#7fb77e",c=i().section`
...
`,T=i().div`
  ...
  font-family: ${n.w4.typography.fontFamilyMono};
  font-variant-numeric: tabular-nums;
`;function F({data:e,t:o,onLogMeal:t,onLogWalk:a,onLogWeight:i,onDeleteMeal:d,onEditMeal:S}){var C,H;let R=new Date().toISOString().slice(0,10),L=(0,l.proteinByDay)(e.meals,R),A=(C=e.meals,C.filter(e=>e.date===R).reduce((e,o)=>e+(o.kcal??0),0)),D=(H=e.walks,H.filter(e=>e.date===R).reduce((e,o)=>e+o.minutes,0)),E=e.meals.filter(e=>e.date===R).sort((e,o)=>e.createdAt-o.createdAt),I=e.goal.proteinG??110;return(0,r.jsxs)(c,{children:[(0,r.jsxs)(p,{children:[(0,r.jsxs)(g,{children:["◉ ",o("forma.today.title")]}),(0,r.jsx)(g,{children:new Date().toLocaleDateString(void 0,{weekday:"long",day:"numeric",month:"short"})})]}),(0,r.jsxs)(f,{children:[(0,r.jsxs)(h,{children:[(0,r.jsxs)(x,{children:[Math.round(L),(0,r.jsxs)("span",{style:{fontSize:14,color:n.w4.colors.mainTextMuted,marginLeft:4},children:["/ ",I,"g"]})]}),(0,r.jsx)(m,{children:o("forma.today.protein")})]}),(0,r.jsxs)(h,{children:[(0,r.jsx)(x,{children:Math.round(A)}),(0,r.jsx)(m,{children:o("forma.today.kcal")})]}),(0,r.jsxs)(h,{children:[(0,r.jsxs)(x,{children:[D,(0,r.jsx)("span",{style:{fontSize:14,color:n.w4.colors.mainTextMuted,marginLeft:4},children:"min"})]}),(0,r.jsx)(m,{children:o("forma.today.walk")})]})]}),(0,r.jsx)(u,{children:(0,r.jsx)(w,{pct:L/I*100})}),(0,r.jsxs)(b,{children:[(0,r.jsx)(s.$n,{variant:"primary",icon:(0,r.jsx)(s.In,{name:"plus",size:14}),onClick:t,children:o("forma.action.logMeal")}),(0,r.jsx)(s.$n,{variant:"ghost",icon:(0,r.jsx)(s.In,{name:"plus",size:14}),onClick:a,children:o("forma.action.logWalk")}),(0,r.jsx)(s.$n,{variant:"ghost",icon:(0,r.jsx)(s.In,{name:"plus",size:14}),onClick:i,children:o("forma.action.logWeight")})]}),0===E.length?(0,r.jsx)(j,{children:o("forma.today.noMealsYet")}):(0,r.jsx)(y,{children:E.map(e=>(0,r.jsxs)($,{onClick:S?()=>S(e.id):void 0,style:{cursor:S?"pointer":"default"},title:S?o("forma.action.edit"):void 0,children:[(0,r.jsx)(v,{children:o(`forma.meal.${e.slot}`)}),(0,r.jsx)(k,{children:e.notes||"—"}),(0,r.jsxs)(M,{children:[e.proteinG??0,"g \xb7 ",e.kcal??0,"kcal"]}),(0,r.jsx)(z,{onClick:o=>{o.stopPropagation(),d(e.id)},"aria-label":o("forma.action.delete"),children:(0,r.jsx)(s.In,{name:"trash",size:14})})]},e.id))}),D>0&&(0,r.jsx)(T,{children:(0,r.jsx)("span",{children:o("forma.today.walkSummary",{min:D})})})]})}},483(e,o,t){t.d(o,{v:()=>v});var r=t(5723),a=t(6859),i=t.n(a),n=t(2799),s=t(4764),l=t(5030);let d="#7fb77e",c=(0,n.keyframes)`
...
`,u=i().button`
  ...
  background: ${({isDone:e,isToday:o})=>e?`${d}10`:o?`${s.w4.colors.surface}`:"transparent"};
...
`;function v({data:e,t:o,locale:t,onTapTemplate:a}){let i,n,s,d=(n=new Date(i=new Date),s=(i.getDay()+6)%7,n.setDate(i.getDate()-s),n.setHours(0,0,0,0),Array.from({length:7},(e,o)=>{let t=new Date(n);return t.setDate(n.getDate()+o),{date:f(t),weekday:t.getDay()}})),c=f(new Date),k="pt"===t?g:p,M=new Map;for(let o of e.templates)M.set(o.weekday,o);return(0,r.jsxs)(h,{children:[(0,r.jsx)(x,{children:o("forma.week.title")}),(0,r.jsx)(m,{children:d.map(({date:t,weekday:i})=>{let n=t===c,s=e.meals.some(e=>e.date===t),d=e.sessions.some(e=>void 0!==e.endedAt&&f(new Date(e.startedAt))===t),p=s||d,g=M.get(i),h=n&&void 0!==g&&void 0!==a&&!s;return(0,r.jsxs)(u,{isToday:n,isDone:p,tappable:h,onClick:()=>{h&&g&&a?.(g)},type:"button",title:h?o("forma.week.tapToLog"):void 0,"aria-label":h?o("forma.week.tapToLog"):void 0,children:[(0,r.jsx)(w,{isToday:n,children:k[i]}),p?(0,r.jsx)(y,{"aria-label":o("forma.week.done"),children:(0,r.jsx)(l.In,{name:"check-circle",size:14})}):g?(0,r.jsx)($,{title:o("forma.week.planned")}):null,g&&(0,r.jsx)(b,{children:o(g.nameKey)})]},t)})})]})}},1533(e,o,t){t.d(o,{h:()=>g});var r=t(5723),a=t(7991),i=t(6859),n=t.n(i),s=t(4764);let l="#7fb77e",d=n().div`
  position: relative;
  width: 100%;
  height: 100%;
  min-height: 140px;
...
`;function g({forecast:e,axes:o=!0}){let t=(0,a.useMemo)(()=>[...e.history,...e.forecast],[e.history,e.forecast]);if(t.length<2)return(0,r.jsx)(d,{children:(0,r.jsx)("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",height:"100%",color:s.w4.colors.mainTextMuted,fontSize:12,fontFamily:s.w4.typography.fontFamilyMono},children:"—"})});let i=o?36:8,n=o?18:4,f=t.map(e=>e.kg),h=Math.min(...f),x=Math.max(...f),m=x-h||1,u=new Date(t[0].date).getTime(),w=new Date(t[t.length-1].date).getTime()-u||1,b=e=>i+(new Date(e).getTime()-u)/w*(600-2*i),y=e=>200-n-(e-h)/m*(200-2*n),$=e.history.map((e,o)=>`${0===o?"M":"L"} ${b(e.date).toFixed(1)} ${y(e.kg).toFixed(1)}`).join(" "),v=e.forecast.length?`M ${b(e.history[e.history.length-1].date).toFixed(1)} ${y(e.history[e.history.length-1].kg).toFixed(1)} `+e.forecast.map(e=>`L ${b(e.date).toFixed(1)} ${y(e.kg).toFixed(1)}`).join(" "):"",k=e.history[e.history.length-1],M=e.forecast[e.forecast.length-1];return(0,r.jsx)(d,{children:(0,r.jsxs)(c,{viewBox:"0 0 600 200",preserveAspectRatio:"none",children:[o&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(p,{x:4,y:n+4,children:x.toFixed(1)}),(0,r.jsx)(p,{x:4,y:200-n+4,children:h.toFixed(1)}),(0,r.jsx)("line",{x1:i,y1:200-n,x2:600-i,y2:200-n,stroke:s.w4.colors.border,strokeWidth:1}),(0,r.jsx)("line",{x1:i,y1:n,x2:i,y2:200-n,stroke:s.w4.colors.border,strokeWidth:1})]}),(0,r.jsx)("path",{d:$,fill:"none",stroke:l,strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"}),v&&(0,r.jsx)("path",{d:v,fill:"none",stroke:l,strokeWidth:2,strokeDasharray:"4 4",strokeLinecap:"round",opacity:.65}),M&&(0,r.jsx)("circle",{cx:b(M.date),cy:y(M.kg),r:3,fill:l,opacity:.7}),k&&(0,r.jsx)("circle",{cx:b(k.date),cy:y(k.kg),r:4,fill:l,stroke:s.w4.colors.surface,strokeWidth:1.5})]})})}},2152(e,o,t){t.d(o,{m:()=>M});var r=t(5723),a=t(7991),i=t(6859),n=t.n(i),s=t(4764),l=t(5030),d=t(8837),c=t(1533);let p="#7fb77e",g=n().section`
  display: flex;
  flex-direction: column;
  gap: ${s.w4.spacing.lg};
`,f=n().div`
...
`,w=i().forwardRef(function({variant:e="ghost",size:o="md",icon:t,iconRight:a,children:i,...n},s){return(0,r.jsxs)(u,{ref:s,variant:e,size:o,...n,children:[t,i,a]})}),b={default:l.w4.colors.accent,danger:"#f85149"},y={default:l.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"};s().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`;let j={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:l.w4.colors.accentMuted},T={neutral:l.w4.colors.mainTextMuted,live:l.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:l.w4.colors.accent};s().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${l.w4.typography.fontFamilyMono};
...
`;let F=s().div`
  ...
  align-items: center;
  gap: 8px;
`;function S({children:e,...o}){return(0,r.jsx)(F,{...o,children:e})}s().label`
  display: flex;
  align-items: center;
  gap: 10px;
...
`,E.A,E.A['pre[class*="language-"]'],l.w4.colors.codeBg,E.A['code[class*="language-"]'],s().div`
  background: ${({bg:e})=>e};
...
`;s().div`
  ...
  background: ${l.w4.colors.mainBg};
  font-family: ${l.w4.typography.fontFamily};
  animation: ${N} 0.4s ease 0.15s both;
`,s().div`
  position: relative;
  width: 56px;
  height: 56px;
