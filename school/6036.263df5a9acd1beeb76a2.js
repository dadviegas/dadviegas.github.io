...
`),D=i.default.div`
  ...
  align-items: center;
  gap: ${s.w4.spacing.sm};
`,q={pt:"O que vamos aprender hoje?",en:"What shall we learn today?"},A={pt:"Escolhe uma disciplina para começar",en:"Pick a subject to get started"};function G({topBarRight:e}){const[a,t]=(0,o.useState)(y),[i]=(0,l.Ym)(),r="pt"===i?"pt":"en";if((0,o.useEffect)(()=>{const e=()=>t(y());return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[]),!a)return(0,h.jsx)(s.PE,{title:"School",sidebar:null,topBarRight:e,children:(0,h.jsxs)(k,{children:[B.map((e,a)=>(0,h.jsx)(E,{x:e.x,y:e.y,size:e.size,delay:e.delay,dur:e.dur},a)),(0,h.jsx)(R,{top:15,delay:12}),(0,h.jsx)(R,{top:55,delay:25}),(0,h.jsx)(v,{children:q[r]}),(0,h.jsx)(j,{children:A[r]}),(0,h.jsx)(S,{children:"pt"===r?"Disciplinas":"Subjects"}),(0,h.jsx)(T,{columns:3,children:f.map((e,a)=>(0,h.jsxs)(N,{accentColor:e.color,onClick:()=>{t(e.key),window.location.hash=`#/${e.hashPrefix}`},children:[(0,h.jsx)(W,{className:"card-emoji",delay:.4*a,children:e.emoji}),(0,h.jsx)(O,{children:e.label[r]}),(0,h.jsx)(_,{children:e.description[r]})]},e.key))}),(0,h.jsxs)(Y,{children:[L.map((e,a)=>(0,h.jsx)(E,{x:e.x,y:e.y,size:e.size,delay:e.delay,dur:e.dur},a)),(0,h.jsx)(X,{children:"pt"===r?"Jogos":"Games"}),(0,h.jsx)(T,{columns:3,children:(0,h.jsxs)(N,{accentColor:"#f97583",onClick:()=>{t("lebem"),window.location.hash="#/lebem"},children:[(0,h.jsx)(W,{className:"card-emoji",delay:1.2,children:"🎮"}),(0,h.jsx)(O,{children:"pt"===r?"Ler a Brincar":"Read & Play"}),(0,h.jsx)(_,{children:"pt"===r?"Aprende a ler com jogos divertidos":"Learn to read with fun games"})]})})]})]})});const d=(0,h.jsxs)(D,{children:[(0,h.jsxs)(F,{onClick:()=>{t(null),window.location.hash="#/school"},children:["← ","pt"===r?"Disciplinas":"Subjects"]}),e]});if("lebem"===a)return(0,h.jsx)(s.PE,{title:"LêBem",sidebar:null,topBarRight:d,children:(0,h.jsx)(g.f,{onBack:()=>{t(null),window.location.hash="#/school"}})});const c=f.find(e=>e.key===a);return(0,h.jsx)(n.WO,{hashPrefix:c.hashPrefix,defaultLang:"pt",locale:i,languages:c.languages,welcomeTitle:c.welcomeTitle,welcomeSub:c.welcomeSub,topBarRight:d},a)}}}]);
//# sourceMappingURL=6036.263df5a9acd1beeb76a2.js.map