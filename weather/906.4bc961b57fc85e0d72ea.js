"use strict";(self.webpackChunk_atlantis_weather=self.webpackChunk_atlantis_weather||[]).push([[906],{4914(a,e,n){n.d(e,{FlyoutPanel:()=>y});var o=n(7359),i=n(3233),l=n(7207),t=n(255),r=n(217),m=n(5959),g=n(5185),c=n(5723);const s=l.keyframes`
...
`;function z({iconKey:a}){const e=a?g.t[a]??t.A:t.A;return(0,c.jsx)(e,{size:14,strokeWidth:1.75})}function p({entries:a,activeId:e,onSelect:n}){return(0,c.jsx)(c.Fragment,{children:a.map(a=>a.children?(0,c.jsx)(o.Fragment,{children:(0,c.jsx)(p,{entries:a.children,activeId:e,onSelect:n})},a.id):(0,c.jsxs)(f,{active:e===a.id,onClick:()=>n(a),children:[(0,c.jsx)(z,{iconKey:a.icon}),a.name]},a.id))})}function y({activeId:a}){const{flyout:e,scheduleFlyoutClose:n,cancelFlyoutClose:o}=(0,m.c)();if(!e)return null;const i=e.entry.icon?g.t[e.entry.icon]??t.A:t.A;return(0,c.jsxs)(d,{anchorY:e.anchorY,onMouseEnter:o,onMouseLeave:n,children:[(0,c.jsxs)(u,{children:[(0,c.jsx)(i,{size:13,strokeWidth:2}),e.entry.name]}),(0,c.jsx)(p,{entries:e.entry.children??[],activeId:a,onSelect:a=>{e.onSelect(a),n()}})]})}},5959(a,e,n){n.d(e,{I:()=>i,c:()=>l});var o=n(7359);const i=(0,o.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),l=()=>(0,o.useContext)(i)},5185(a,e,n){n.d(e,{t:()=>Y});var o=n(9510),i=n(9038),l=n(8207),t=n(6896),r=n(7901),m=n(9848),g=n(2164),c=n(3775),s=n(3539),d=n(1783),u=n(1837),f=n(2314),z=n(5751),p=n(255),y=n(9633),b=n(2946),h=n(822),A=n(6720),x=n(3317),w=n(2709),S=n(3517),k=n(7032),v=n(6949),M=n(8218),B=n(6829),T=n(5553),C=n(9591),E=n(2820),P=n(4621),$=n(6673),j=n(9033),L=n(1365),N=n(5912),G=n(8641),R=n(3249),K=n(1821),I=n(9161),D=n(1849),F=n(7747),H=n(2932),V=n(4525),U=n(7230);const Y={activity:t.A,"bar-chart-2":o.A,book:m.A,"book-open":r.A,calendar:c.A,clock:d.A,"circle-dot":s.A,feather:f.A,"file-text":z.A,globe:A.A,hash:x.A,heart:w.A,landmark:S.A,layers:l.A,leaf:v.A,map:C.A,package:$.A,compass:u.A,"git-branch":b.A,github:h.A,minus:P.A,terminal:R.A,thermometer:K.A,users:D.A,wind:F.A,"pie-chart":i.A,plus:L.A,slash:N.A,star:G.A,zap:U.A,bot:g.A,lightbulb:M.A,"message-square":E.A,wrench:H.A,x:V.A,"layout-grid":k.A,list:B.A,file:p.A,folder:y.A,"map-pin":T.A,"pen-tool":j.A,type:I.A}},906(a,e,n){n.d(e,{rh:()=>F,PE:()=>S,CD:()=>K,qs:()=>V});var o=n(217),i=n(7359),l=n(3233),t=n(5723);l.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,l.default.span`
  ...
  margin-right: 6px;
  flex-shrink: 0;
`;var r=n(3661),m=n(5959);const g="260px",c="56px",s=l.default.header`
  display: flex;
  align-items: center;
  height: ${"48px"};
...
`,x=l.default.main`
  ...
  display: flex;
  flex-direction: column;
`,w="atlantis:sidebar-collapsed";function S({sidebar:a,children:e,topBarRight:o,title:l="Atlantis",activeId:g=null}){const[c,S]=(0,i.useState)(()=>{try{return"true"===localStorage.getItem(w)}catch{return!1}}),[k,v]=(0,i.useState)(null),M=(0,i.useRef)(),B=()=>S(a=>{const e=!a;try{localStorage.setItem(w,String(e))}catch{}return e}),T=i.useMemo(()=>i.lazy(()=>Promise.resolve().then(n.bind(n,4914)).then(a=>({default:a.FlyoutPanel}))),[]);return(0,t.jsx)(m.I.Provider,{value:{collapsed:c,toggle:B,flyout:k,openFlyout:(a,e,n)=>{clearTimeout(M.current),v({entry:a,anchorY:e,onSelect:n})},scheduleFlyoutClose:()=>{M.current=setTimeout(()=>v(null),160)},cancelFlyoutClose:()=>clearTimeout(M.current)},children:(0,t.jsxs)(b,{children:[(0,t.jsxs)(s,{children:[(0,t.jsx)(d,{children:(0,t.jsx)(u,{onClick:B,title:c?"Expand sidebar":"Collapse sidebar",children:(0,t.jsx)(r.A,{size:17})})}),(0,t.jsxs)(f,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:["Atl",(0,t.jsx)("span",{children:"antis"})]}),l&&(0,t.jsx)(z,{children:l}),o&&(0,t.jsx)(p,{children:o})]}),(0,t.jsxs)(y,{children:[(0,t.jsx)(h,{collapsed:c,children:(0,t.jsx)(A,{children:a})}),(0,t.jsx)(x,{children:e})]}),k&&(0,t.jsx)(i.Suspense,{fallback:null,children:(0,t.jsx)(T,{activeId:g})})]})})}var k=n(255),v=n(9753),M=n(5185);const B=l.default.div`
  display: grid;
...
`;function G({iconKey:a,size:e=16}){if(a&&!(a in M.t))return(0,t.jsx)("span",{style:{fontSize:e,lineHeight:1,display:"flex",alignItems:"center"},children:a});const n=a?M.t[a]??k.A:k.A;return(0,t.jsx)(n,{size:e,strokeWidth:1.75})}function R({entry:a,activeId:e,onSelect:n}){const[o,l]=(0,i.useState)(a.defaultOpen??!0),{collapsed:r,openFlyout:g,scheduleFlyoutClose:c,cancelFlyoutClose:s}=(0,m.c)();return a.children&&a.children.length>0?(0,t.jsxs)(E,{children:[(0,t.jsxs)(P,{collapsed:r,onClick:()=>{r||l(a=>!a)},onMouseEnter:r?e=>{const o=e.currentTarget.getBoundingClientRect();g(a,o.top,n)}:void 0,onMouseLeave:r?c:void 0,children:[(0,t.jsxs)($,{collapsed:r,children:[(0,t.jsx)(G,{iconKey:a.icon,size:16}),(0,t.jsx)(j,{collapsed:r,children:a.name})]}),(0,t.jsx)(L,{open:o,collapsed:r,children:(0,t.jsx)(v.A,{size:13})})]}),(0,t.jsx)(B,{open:o&&!r,children:(0,t.jsx)(T,{children:(0,t.jsx)(C,{children:a.children.map(a=>(0,t.jsx)(R,{entry:a,activeId:e,onSelect:n},a.id))})})})]}):(0,t.jsxs)(N,{active:e===a.id,collapsed:r,onClick:()=>n(a),onMouseEnter:r?e=>{const o=e.currentTarget.getBoundingClientRect();g({id:a.id,name:a.name,icon:a.icon,file:a.file,children:[a]},o.top,n)}:void 0,onMouseLeave:r?c:void 0,children:[(0,t.jsx)(G,{iconKey:a.icon,size:15}),(0,t.jsx)(j,{collapsed:r,children:a.name})]})}function K({entries:a,activeId:e,onSelect:n}){return(0,t.jsx)("div",{children:a.map(a=>(0,t.jsx)(R,{entry:a,activeId:e,onSelect:n},a.id))})}const I=n(7207).keyframes`
