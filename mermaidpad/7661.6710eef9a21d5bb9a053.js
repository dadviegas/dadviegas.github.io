"use strict";(self.webpackChunk_atlantis_mermaidpad=self.webpackChunk_atlantis_mermaidpad||[]).push([[7661],{4914(a,o,n){n.d(o,{FlyoutPanel:()=>y});var e=n(7359),i=n(3233),t=n(7207),l=n(255),r=n(217),m=n(5959),c=n(5185),d=n(5723);const g=t.keyframes`
...
`;function z({iconKey:a}){const o=a?c.t[a]??l.A:l.A;return(0,d.jsx)(o,{size:14,strokeWidth:1.75})}function p({entries:a,activeId:o,onSelect:n}){return(0,d.jsx)(d.Fragment,{children:a.map(a=>a.children?(0,d.jsx)(e.Fragment,{children:(0,d.jsx)(p,{entries:a.children,activeId:o,onSelect:n})},a.id):(0,d.jsxs)(f,{active:o===a.id,onClick:()=>n(a),children:[(0,d.jsx)(z,{iconKey:a.icon}),a.name]},a.id))})}function y({activeId:a}){const{flyout:o,scheduleFlyoutClose:n,cancelFlyoutClose:e}=(0,m.c)();if(!o)return null;const i=o.entry.icon?c.t[o.entry.icon]??l.A:l.A;return(0,d.jsxs)(s,{anchorY:o.anchorY,onMouseEnter:e,onMouseLeave:n,children:[(0,d.jsxs)(u,{children:[(0,d.jsx)(i,{size:13,strokeWidth:2}),o.entry.name]}),(0,d.jsx)(p,{entries:o.entry.children??[],activeId:a,onSelect:a=>{o.onSelect(a),n()}})]})}},5959(a,o,n){n.d(o,{c:()=>t});var e=n(7359);const i=(0,e.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),t=()=>(0,e.useContext)(i)},5185(a,o,n){n.d(o,{t:()=>O});var e=n(9510),i=n(9038),t=n(8207),l=n(6896),r=n(7901),m=n(9848),c=n(2164),d=n(3775),g=n(3539),s=n(1783),u=n(1837),f=n(2314),z=n(5751),p=n(255),y=n(9633),b=n(2946),A=n(822),h=n(6720),x=n(3317),w=n(2709),k=n(3517),v=n(7032),S=n(6949),B=n(8218),E=n(6829),M=n(5553),$=n(9591),P=n(2820),T=n(4621),C=n(6673),D=n(9033),L=n(1365),R=n(5912),j=n(8641),I=n(3249),K=n(1821),F=n(9161),N=n(1849),G=n(7747),_=n(2932),Y=n(4525),H=n(7230);const O={activity:l.A,"bar-chart-2":e.A,book:m.A,"book-open":r.A,calendar:d.A,clock:s.A,"circle-dot":g.A,feather:f.A,"file-text":z.A,globe:h.A,hash:x.A,heart:w.A,landmark:k.A,layers:t.A,leaf:S.A,map:$.A,package:C.A,compass:u.A,"git-branch":b.A,github:A.A,minus:T.A,terminal:I.A,thermometer:K.A,users:N.A,wind:G.A,"pie-chart":i.A,plus:L.A,slash:R.A,star:j.A,zap:H.A,bot:c.A,lightbulb:B.A,"message-square":P.A,wrench:_.A,x:Y.A,"layout-grid":v.A,list:E.A,file:p.A,folder:y.A,"map-pin":M.A,"pen-tool":D.A,type:F.A}},906(a,o,n){n.d(o,{w4:()=>e.w});var e=n(217),i=(n(7359),n(3233));n(5723),i.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
