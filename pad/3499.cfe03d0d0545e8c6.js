...
`,U=s().div`
  ...
  color: ${r.w4.colors.sidebarTextMuted};
  font-family: ${r.w4.typography.fontFamily};
`;function q({onSave:e,onUpdate:o,onCancel:a,existingDoc:r}){let[n,l]=(0,i.useState)(r?.name??""),s=(0,i.useRef)(null);return(0,i.useEffect)(()=>{s.current?.focus(),r&&s.current?.select()},[r]),(0,t.jsx)(K,{onClick:a,children:(0,t.jsxs)(G,{onClick:e=>e.stopPropagation(),children:[(0,t.jsx)(V,{children:"Save document"}),r&&o&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(U,{children:"Update the current version or save as a new one."}),(0,t.jsxs)(W,{children:[(0,t.jsx)(O,{onClick:a,children:"Cancel"}),(0,t.jsxs)(O,{danger:!0,onClick:o,children:['Update "',r.name,'"']})]}),(0,t.jsx)(_,{})]}),(0,t.jsx)(Y,{ref:s,value:n,onChange:e=>l(e.target.value),onKeyDown:t=>{"Enter"===t.key&&n.trim()&&(r&&n.trim()===r.name&&o?o():e(n.trim())),"Escape"===t.key&&a()},placeholder:r?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,t.jsxs)(W,{children:[!r&&(0,t.jsx)(O,{onClick:a,children:"Cancel"}),(0,t.jsx)(O,{primary:!0,disabled:!n.trim(),onClick:()=>e(n.trim()),children:"Save as new"})]})]})})}let J=(0,d.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,X=(0,d.keyframes)`
