...
`,K=l().div`
  ...
  color: ${s.w4.colors.sidebarTextMuted};
  font-family: ${s.w4.typography.fontFamily};
`;function N({onSave:e,onUpdate:t,onCancel:r,existingDoc:i}){let[n,l]=(0,a.useState)(i?.name??""),s=(0,a.useRef)(null);return(0,a.useEffect)(()=>{s.current?.focus(),i&&s.current?.select()},[i]),(0,o.jsx)(q,{onClick:r,children:(0,o.jsxs)(Y,{onClick:e=>e.stopPropagation(),children:[(0,o.jsx)(W,{children:"Save document"}),i&&t&&(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(K,{children:"Update the current version or save as a new one."}),(0,o.jsxs)(O,{children:[(0,o.jsx)(X,{onClick:r,children:"Cancel"}),(0,o.jsxs)(X,{danger:!0,onClick:t,children:['Update "',i.name,'"']})]}),(0,o.jsx)(G,{})]}),(0,o.jsx)(D,{ref:s,value:n,onChange:e=>l(e.target.value),onKeyDown:o=>{"Enter"===o.key&&n.trim()&&(i&&n.trim()===i.name&&t?t():e(n.trim())),"Escape"===o.key&&r()},placeholder:i?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,o.jsxs)(O,{children:[!i&&(0,o.jsx)(X,{onClick:r,children:"Cancel"}),(0,o.jsx)(X,{primary:!0,disabled:!n.trim(),onClick:()=>e(n.trim()),children:"Save as new"})]})]})})}let U=(0,$.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,Z=(0,$.keyframes)`
