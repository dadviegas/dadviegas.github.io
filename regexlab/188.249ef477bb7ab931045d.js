"use strict";(self.webpackChunk_atlantis_regexlab=self.webpackChunk_atlantis_regexlab||[]).push([[188],{188(e,r,o){var n=o(7359),t=o(8997),s=o(3233),a=o(5723),l=o(6480),i=o(679),d=o(153),c=o(947),p=o(9336),g=o(8104);const u=[{bg:"rgba(56,139,253,0.25)",border:"#388bfd",label:"#388bfd"},{bg:"rgba(63,185,80,0.25)",border:"#3fb950",label:"#3fb950"},{bg:"rgba(210,153,34,0.25)",border:"#d29922",label:"#d29922"},{bg:"rgba(163,113,247,0.25)",border:"#a371f7",label:"#a371f7"},{bg:"rgba(248,113,113,0.25)",border:"#f87171",label:"#f87171"},{bg:"rgba(34,211,238,0.25)",border:"#22d3ee",label:"#22d3ee"}],x=["g","i","m","s","u"],f=s.default.button`display:flex;align-items:center;gap:6px;padding:5px 12px;background:none;border:1px solid ${a.w4.colors.accent};border-radius:${a.w4.borderRadius.md};color:${a.w4.colors.accent};font-size:${a.w4.typography.fontSizeBase};font-family:${a.w4.typography.fontFamily};font-weight:600;cursor:pointer;transition:background 0.15s;white-space:nowrap;&:hover{background:rgba(88,166,255,0.1);}`,h=s.default.div`
  display: flex;
...
`,A=s.default.span`
  ...
  padding: 1px 6px;
  color: ${a.w4.colors.mainText};
  background: ${e=>u[e.colorIndex%u.length].bg};
  border: 1px solid ${e=>u[e.colorIndex%u.length].border};
  font-size: 11px;
`,L=s.default.span`
  font-size: 10px;
  color: ${e=>u[e.colorIndex%u.length].label};
  font-weight: 600;
`,J=s.default.div`
  position: relative;
`,O=s.default.button`
