...
`,U=s().div`
  ...
  color: ${t.w4.colors.sidebarTextMuted};
  font-family: ${t.w4.typography.fontFamily};
`;function W({onSave:o,onUpdate:e,onCancel:a,existingDoc:t}){let[i,l]=(0,n.useState)(t?.name??""),s=(0,n.useRef)(null);return(0,n.useEffect)(()=>{s.current?.focus(),t&&s.current?.select()},[t]),(0,r.jsx)(N,{onClick:a,children:(0,r.jsxs)(G,{onClick:o=>o.stopPropagation(),children:[(0,r.jsx)(V,{children:"Save document"}),t&&e&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(U,{children:"Update the current version or save as a new one."}),(0,r.jsxs)(_,{children:[(0,r.jsx)(O,{onClick:a,children:"Cancel"}),(0,r.jsxs)(O,{danger:!0,onClick:e,children:['Update "',t.name,'"']})]}),(0,r.jsx)(J,{})]}),(0,r.jsx)(Y,{ref:s,value:i,onChange:o=>l(o.target.value),onKeyDown:r=>{"Enter"===r.key&&i.trim()&&(t&&i.trim()===t.name&&e?e():o(i.trim())),"Escape"===r.key&&a()},placeholder:t?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,r.jsxs)(_,{children:[!t&&(0,r.jsx)(O,{onClick:a,children:"Cancel"}),(0,r.jsx)(O,{primary:!0,disabled:!i.trim(),onClick:()=>o(i.trim()),children:"Save as new"})]})]})})}let Z=(0,d.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,q=(0,d.keyframes)`
