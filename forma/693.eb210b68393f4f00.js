...
`,D=r().div`
  ...
  white-space: nowrap;
`;function k({locale:e}){var a;let t=(0,s.useMemo)(()=>(0,p.Nx)("pt"===e?"pt":"en",c.A),[e]),{forecast:i,failed:r}=(0,u.useWeather)({lat:_,lon:b,current:"temperature_2m,apparent_temperature,relative_humidity_2m,weather_code,wind_speed_10m,is_day",daily:"temperature_2m_max,temperature_2m_min,sunrise,sunset,uv_index_max",timezone:"auto",cacheKey:"weather-lisbon-v3"}),n=()=>(0,o.VJ)("earth",{placeId:"lisbon"}),f=i&&i.current?i.current:null,E=i&&i.daily?i.daily:null,C=null!==f&&null!==E,F=f?.temperature_2m??0,G=f?.apparent_temperature??F,$=f?.relative_humidity_2m??0,P=f?.weather_code??0,H=f?.wind_speed_10m??0,V=f?.is_day===1,W=C?(a=P,V?0===a?"#fbbf24":1===a?"#fcd34d":2===a?"#60a5fa":3===a?"#94a3b8":a>=95?"#c084fc":a>=51?"#38bdf8":a>=45?"#cbd5e1":"#60a5fa":a>=95?"#a78bfa":a>=51?"#60a5fa":"#818cf8"):h.A.accentColor,q=Math.round(E?.temperature_2m_max?.[0]??F),K=Math.round(E?.temperature_2m_min?.[0]??F),Y=Math.round(E?.uv_index_max?.[0]??0),Q=E?.sunrise?.[0],X=E?.sunset?.[0],J=X?new Date(X).getTime():NaN,Z=Number.isFinite(J)&&Date.now()<J?"sunset":"sunrise",ee="sunset"===Z?X:E?.sunrise?.[1]??Q;return(0,l.jsx)(d.rl,{title:t("weather.city.lisbon"),accessory:(0,l.jsx)(x,{children:t("weather.openInEarth")}),accentColor:W,error:r&&!C?t("widget.error.body"):void 0,errorLabel:r&&!C?t("widget.error.label"):void 0,children:C||r?C?(0,l.jsxs)(L,{role:"link",tabIndex:0,onClick:n,onKeyDown:e=>{("Enter"===e.key||" "===e.key)&&(e.preventDefault(),n())},children:[(0,l.jsxs)(S,{children:[(0,l.jsx)(v,{accent:W,children:(0,l.jsx)(w,{children:!V&&P in g?g[P]:T[P]??"\uD83C\uDF21️"})}),(0,l.jsxs)(A,{children:[(0,l.jsxs)(y,{children:[(0,l.jsxs)(j,{accent:W,children:[Math.round(F),"\xb0"]}),(0,l.jsxs)(O,{children:[(0,l.jsxs)("div",{children:["▲ ",(0,l.jsxs)("span",{children:[q,"\xb0"]})]}),(0,l.jsxs)("div",{children:["▼ ",(0,l.jsxs)("span",{children:[K,"\xb0"]})]})]})]}),(0,l.jsx)(I,{children:("pt"===e?M:U)[P]??("pt"===e?"Desconhecido":"Unknown")}),(0,l.jsx)(B,{children:t("weather.feelsLike",{t:Math.round(G)})})]})]}),(0,l.jsxs)(N,{children:[(0,l.jsxs)(R,{children:[(0,l.jsxs)(z,{children:["\uD83D\uDCA7 ",t("weather.humidity")]}),(0,l.jsxs)(D,{children:[$,"%"]})]}),(0,l.jsxs)(R,{children:[(0,l.jsxs)(z,{children:["\uD83D\uDCA8 ",t("weather.wind")]}),(0,l.jsxs)(D,{children:[Math.round(H)," km/h"]})]}),(0,l.jsxs)(R,{children:[(0,l.jsxs)(z,{children:["☀️ ",t("weather.uv")]}),(0,l.jsx)(D,{children:Y})]}),(0,l.jsxs)(R,{children:[(0,l.jsxs)(z,{children:["sunset"===Z?"\uD83C\uDF07":"\uD83C\uDF05"," ",t("sunset"===Z?"weather.sunset":"weather.sunrise")]}),(0,l.jsx)(D,{children:ee?new Date(ee).toLocaleTimeString("pt"===e?"pt-PT":"en-GB",{hour:"2-digit",minute:"2-digit"}):"—"})]})]})]}):null:(0,l.jsx)(m.YG,{mode:"loading",label:t("widget.loading")})})}}}]);