"use strict";(self.webpackChunk_atlantis_citypulse=self.webpackChunk_atlantis_citypulse||[]).push([["182"],{3819(e,o,a){a.d(o,{Mq:()=>r,QH:()=>i});var t=a(6063);let r=["lisbon","ponta-delgada","lourinha","new-york","san-francisco","london","paris","berlin","tokyo","dubai","singapore","sao-paulo","sydney"].map(e=>t.rh.find(o=>o.id===e)).filter(e=>void 0!==e).map(function(e){return{id:e.id,name:e.name,country:e.country,lat:e.lat,lon:e.lng,timezone:e.timezone}});function i(e){return e<=20?{label:"Good",color:"#3fb950"}:e<=40?{label:"Fair",color:"#d29922"}:e<=60?{label:"Moderate",color:"#f0883e"}:e<=80?{label:"Poor",color:"#f85149"}:{label:"Very Poor",color:"#8957e5"}}},5332(e,o,a){a.d(o,{A:()=>f});var t=a(5723),r=a(7991),i=a.n(r),n=a(6859),l=a.n(n),d=a(6063),s=a(3819);let c=l().div`
  display: flex;
...
`,x=l().div`
  ...
  white-space: nowrap;
  z-index: 10;
`;function f({airQuality:e,loading:o}){let[a,n]=i().useState(null),l=i().useRef(null),u=(0,r.useMemo)(()=>{if(!e)return[];let o=e.european_aqi,a=Math.max(...o.filter(Boolean),1),t=114,r=792/o.length;return o.map((o,i)=>{let n=o??0,l=n/Math.max(a,80)*t;return{x:4+i*r+.1*r,y:22+t-l,w:.8*r,h:l,val:n,color:(0,s.QH)(n).color,time:e.time[i]?.slice(11,16)??""}})},[e]);return(0,t.jsxs)(c,{children:[(0,t.jsx)("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"baseline"},children:(0,t.jsx)(p,{children:"Air Quality (EU AQI)"})}),(0,t.jsx)(g,{children:[0,21,41,61,81].map(e=>{let{label:o,color:a}=(0,s.QH)(e);return(0,t.jsx)(h,{color:a,children:o},o)})}),o?(0,t.jsx)(m,{}):(0,t.jsxs)("div",{style:{position:"relative"},children:[(0,t.jsxs)("svg",{ref:l,viewBox:"0 0 800 160",width:"100%",height:160,style:{display:"block",cursor:"crosshair"},onMouseLeave:()=>n(null),children:[[.5,1].map(e=>(0,t.jsx)("line",{x1:4,y1:22+114*(1-e),x2:796,y2:22+114*(1-e),stroke:d.w4.colors.border,strokeWidth:1},e)),u.map((e,o)=>(0,t.jsxs)("g",{children:[(0,t.jsx)("rect",{x:e.x,y:e.y,width:e.w,height:e.h,rx:2,fill:e.color,opacity:a?.i===o?1:.75,onMouseEnter:()=>{if(!l.current)return;let a=l.current.getBoundingClientRect(),t=a.width/800;n({i:o,x:(e.x+e.w/2)*t,y:e.y*(a.height/160)})}}),e.val>0&&(0,t.jsx)("text",{x:e.x+e.w/2,y:Math.max(18,e.y-4),textAnchor:"middle",fontSize:9,fontWeight:"600",fill:e.color,children:e.val})]},o)),[0,6,12,18,23].map(e=>u[e]?(0,t.jsx)("text",{x:u[e].x+u[e].w/2,y:156,textAnchor:"middle",fontSize:10,fill:d.w4.colors.mainTextMuted,children:u[e].time},e):null)]}),a&&u[a.i]&&(0,t.jsxs)(x,{x:a.x,y:a.y,children:[u[a.i].time," — AQI ",u[a.i].val," (",(0,s.QH)(u[a.i].val).label,")"]})]})]})}},4439(e,o,a){a.d(o,{A:()=>M});var t=a(5723),r=a(7991),i=a.n(r),n=a(6859),l=a.n(n),d=a(6063),s=a(3819),c=a(9522),p=a(1951);let g=l().div`
  display: flex;
  flex-direction: column;
  gap: ${d.w4.spacing.lg};
`,h=l().h3`
...
`;function z({city:e}){let{snapshot:o,loading:a}=(0,c.n)(e),r=o?[{label:"Temperature",value:`${o.currentTemp}\xb0C`,pct:(o.currentTemp+20)/70*100,color:"#58a6ff"},{label:"Air Quality (AQI)",value:`${o.currentAqi}`,pct:o.currentAqi/100*100,color:(0,s.QH)(o.currentAqi).color},{label:"Wind Speed",value:`${o.currentWind} km/h`,pct:o.currentWind/120*100,color:"#d29922"},{label:"Rain Probability",value:`${o.precipProb}%`,pct:o.precipProb,color:"#79c0ff"}]:[];return(0,t.jsxs)(x,{children:[(0,t.jsxs)(f,{children:[(0,t.jsx)(u,{children:e.name}),(0,t.jsx)("span",{style:{fontSize:d.w4.typography.fontSizeSm,color:d.w4.colors.mainTextMuted},children:e.country})]}),a?[1,2,3,4].map(e=>(0,t.jsxs)(b,{children:[(0,t.jsx)(y,{children:(0,t.jsx)("span",{children:"Loading…"})}),(0,t.jsx)(v,{})]},e)):r.map(e=>(0,t.jsxs)(b,{children:[(0,t.jsxs)(y,{children:[(0,t.jsx)("span",{children:e.label}),(0,t.jsx)("span",{style:{color:d.w4.colors.mainText,fontWeight:600},children:e.value})]}),(0,t.jsx)(w,{children:(0,t.jsx)($,{pct:e.pct,color:e.color})})]},e.label))]})}function M(){let[e,o]=i().useState(s.Mq["0"]),[a,r]=i().useState(s.Mq["1"]);return(0,t.jsxs)(g,{children:[(0,t.jsx)(h,{children:"City Comparison"}),(0,t.jsxs)(m,{children:[(0,t.jsxs)("div",{style:{display:"flex",flexDirection:"column",gap:d.w4.spacing.md},children:[(0,t.jsx)(p.A,{value:e.id,onChange:o}),(0,t.jsx)(z,{city:e})]}),(0,t.jsxs)("div",{style:{display:"flex",flexDirection:"column",gap:d.w4.spacing.md},children:[(0,t.jsx)(p.A,{value:a.id,onChange:r}),(0,t.jsx)(z,{city:a})]})]})]})}},6305(e,o,a){a.d(o,{A:()=>x});var t=a(5723);a(7991);var r=a(6859),i=a.n(r),n=a(132),l=a(6063),d=a(3819);let s=i().div`
  display: grid;
...
`,c=i().div`
  ...
  &::before {
    ...
    right: 0;
    height: 2px;
    background: ${({accentColor:e})=>e??l.w4.colors.accent};
  }
`,p=i().div`
...
`;function x({snapshot:e,loading:o}){let a=e?(0,d.QH)(e.currentAqi):null;return(0,t.jsxs)(s,{children:[(0,t.jsxs)(c,{accentColor:"#58a6ff",children:[(0,t.jsxs)(p,{children:[(0,t.jsx)(n.In,{name:"thermometer",size:14})," Temperature"]}),o?(0,t.jsx)(m,{}):(0,t.jsxs)(g,{children:[e?.currentTemp,"\xb0C"]}),!o&&(0,t.jsxs)(h,{children:["Feels like ",e?.apparentTemp,"\xb0C"]})]}),(0,t.jsxs)(c,{accentColor:a?.color??"#3fb950",children:[(0,t.jsxs)(p,{children:[(0,t.jsx)(n.In,{name:"activity",size:14})," Air Quality (EU AQI)"]}),o?(0,t.jsx)(m,{}):(0,t.jsx)(g,{style:{color:a?.color},children:e?.currentAqi}),!o&&(0,t.jsx)(h,{children:a?.label})]}),(0,t.jsxs)(c,{accentColor:"#d29922",children:[(0,t.jsxs)(p,{children:[(0,t.jsx)(n.In,{name:"wind",size:14})," Wind Speed"]}),o?(0,t.jsx)(m,{}):(0,t.jsx)(g,{children:e?.currentWind}),!o&&(0,t.jsx)(h,{children:"km/h"})]}),(0,t.jsxs)(c,{accentColor:"#79c0ff",children:[(0,t.jsxs)(p,{children:[(0,t.jsx)(n.In,{name:"droplets",size:14})," Precipitation"]}),o?(0,t.jsx)(m,{}):(0,t.jsxs)(g,{children:[e?.precipProb,"%"]}),!o&&(0,t.jsx)(h,{children:"Chance of rain"})]})]})}},1951(e,o,a){a.d(o,{A:()=>s});var t=a(5723);a(7991);var r=a(6859),i=a.n(r),n=a(6063),l=a(3819);let d=i().select`
...
`;function s({value:e,onChange:o}){return(0,t.jsx)(d,{value:e,onChange:e=>o(l.Mq.find(o=>o.id===e.target.value)),children:l.Mq.map(e=>(0,t.jsxs)("option",{value:e.id,children:[e.name,", ",e.country]},e.id))})}},7912(e,o,a){a.d(o,{A:()=>m});var t=a(5723),r=a(7991),i=a(6859),n=a.n(i),l=a(6063);let d=n().div`
  display: flex;
  flex-direction: column;
  gap: ${l.w4.spacing.md};
`,s=n().h3`
...
`},2787(e,o,a){a.d(o,{FlyoutPanel:()=>y});var t=a(5723),r=a(7991),i=a.n(r),n=a(6859),l=a.n(n),d=a(2799),s=a(6063),c=a(7993),p=a(4971);let g=(0,d.keyframes)`
...
`,l().div`
  position: relative;
`;let K="260px",N="56px",q="48px",W=l().header`
  display: flex;
  align-items: center;
...
`,X=l().span`
  ...
  animation: ${Z} 10s ease ${({index:e})=>.07*e}s infinite;
...
`,ea=l().div`
  ...
  overflow: hidden;
`,et=l().aside`
  width: ${({collapsed:e})=>e?N:K};
  min-width: ${({collapsed:e})=>e?N:K};
  background: ${d.w4.colors.sidebarBg};
  border-right: 1px solid ${d.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,ei=l().main`
  ...
  display: flex;
  flex-direction: column;
`,en=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function el(){return(0,t.jsx)(Q,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:en.map((e,o)=>(0,t.jsx)(X,{index:o,accent:e.accent,children:e.char},o))})}let ed="atlantis:sidebar-collapsed";function es({sidebar:e,children:o,topBarRight:n,title:l="Atlantis",activeId:d=null}){let[s,c]=(0,r.useState)(()=>{try{return"true"===localStorage.getItem(ed)}catch{return!1}}),[p,g]=(0,r.useState)(null),h=(0,r.useRef)(),m=()=>c(e=>{let o=!e;try{localStorage.setItem(ed,String(o))}catch{}return o}),x=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(a.bind(a,2787)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,t.jsx)(R.I.Provider,{value:{collapsed:s,toggle:m,flyout:p,openFlyout:(e,o,a)=>{clearTimeout(h.current),g({entry:e,anchorY:o,onSelect:a})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,t.jsxs)(ea,{children:[(0,t.jsxs)(W,{children:[e&&(0,t.jsx)(O,{children:(0,t.jsx)(U,{onClick:m,title:s?"Expand sidebar":"Collapse sidebar",children:(0,t.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("path",{d:"M9 3v18"})]})})}),(0,t.jsx)(el,{}),l&&(0,t.jsx)(J,{children:l}),n&&(0,t.jsx)(ee,{children:n})]}),(0,t.jsxs)(eo,{children:[null!=e&&(0,t.jsx)(et,{collapsed:s,children:(0,t.jsx)(er,{children:e})}),(0,t.jsx)(ei,{children:o})]}),p&&(0,t.jsx)(i().Suspense,{fallback:null,children:(0,t.jsx)(x,{activeId:d})})]})})}var ec=a(4971);let ep=l().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
...
`;function ew({iconKey:e,size:o=16}){let a=e?ec.X[e]:void 0;return a?(0,t.jsx)("svg",{width:o,height:o,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,dangerouslySetInnerHTML:{__html:a}}):e?(0,t.jsx)("span",{style:{fontSize:o,lineHeight:1,display:"flex",alignItems:"center"},children:e}):(0,t.jsxs)("svg",{width:o,height:o,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,children:[(0,t.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,t.jsx)("polyline",{points:"14 2 14 8 20 8"})]})}function e$({entry:e,activeId:o,onSelect:a}){let[i,n]=(0,r.useState)(e.defaultOpen??!0),{collapsed:l,openFlyout:d,scheduleFlyoutClose:s,cancelFlyoutClose:c}=(0,R.c)();return e.children&&e.children.length>0?(0,t.jsxs)(em,{children:[(0,t.jsxs)(ex,{collapsed:l,onClick:()=>{l||n(e=>!e)},onMouseEnter:l?o=>{d(e,o.currentTarget.getBoundingClientRect().top,a)}:void 0,onMouseLeave:l?s:void 0,children:[(0,t.jsxs)(ef,{collapsed:l,children:[(0,t.jsx)(ew,{iconKey:e.icon,size:16}),(0,t.jsx)(eu,{collapsed:l,children:e.name})]}),(0,t.jsx)(eb,{open:i,collapsed:l,children:(0,t.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round",children:(0,t.jsx)("path",{d:"M9 6l6 6-6 6"})})})]}),(0,t.jsx)(ep,{open:i&&!l,children:(0,t.jsx)(eg,{children:(0,t.jsx)(eh,{children:e.children.map(e=>(0,t.jsx)(e$,{entry:e,activeId:o,onSelect:a},e.id))})})})]}):(0,t.jsxs)(ey,{active:o===e.id,collapsed:l,onClick:()=>a(e),onMouseEnter:l?o=>{let t=o.currentTarget.getBoundingClientRect();d({id:e.id,name:e.name,icon:e.icon,file:e.file,children:[e]},t.top,a)}:void 0,onMouseLeave:l?s:void 0,children:[(0,t.jsx)(ew,{iconKey:e.icon,size:15}),(0,t.jsx)(eu,{collapsed:l,children:e.name})]})}function ev({entries:e,activeId:o,onSelect:a}){return(0,t.jsx)("div",{children:e.map(e=>(0,t.jsx)(e$,{entry:e,activeId:o,onSelect:a},e.id))})}function ez({title:e,sections:o,topBarRight:a,children:i}){let[n,l]=(0,r.useState)(null),d=(0,r.useCallback)(e=>{l(e.id),document.getElementById(e.id)?.scrollIntoView({behavior:"smooth",block:"start"})},[]),s=(0,t.jsx)(ev,{entries:o,activeId:n,onSelect:d});return(0,t.jsx)(es,{title:e,sidebar:s,activeId:n,topBarRight:a,children:i})}a(2787);let eM=l().div`
