"use strict";(self.webpackChunk_atlantis_finance=self.webpackChunk_atlantis_finance||[]).push([["2823"],{719(e,o,a){a.d(o,{TA:()=>R,a8:()=>g,jb:()=>H});var t=a(5723),r=a(7991),n=a(6859),i=a.n(n),l=a(3930),s=a(8395),d=a(1496),c=a(7293);let p=["#3b82f6","#8b5cf6","#ec4899","#10b981","#f59e0b","#06b6d4"];function g(e,o){return e.color??p[o%p.length]}let m="#7fb77e",f=i().nav`
  display: flex;
...
`,x=i().div`
  font-size: 13px;
  font-weight: 500;
  color: ${({active:e})=>e?m:l.w4.colors.mainText};
  white-space: nowrap;
  overflow: hidden;
...
`,M=i().button`
  ...
  height: 32px;
  border-radius: ${l.w4.borderRadius.md};
  border: 1px solid ${({active:e})=>e?m:l.w4.colors.border};
  background: ${({active:e})=>e?`${m}22`:l.w4.colors.mainBg};
...
`,T=i().button`
  ...
  border-radius: 50%;
  background: ${({bg:e})=>e};
  border: 2px solid ${({active:e})=>e?l.w4.colors.mainText:"transparent"};
  cursor: pointer;
...
`,B=i().button`
  ...
  height: 36px;
  border-radius: 999px;
  border: 1px solid ${({active:e,color:o})=>e?o:l.w4.colors.border};
  background: ${({active:e,color:o})=>e?`${o}22`:l.w4.colors.surface};
  color: ${l.w4.colors.mainText};
  font-size: 13px;
  cursor: pointer;
  white-space: nowrap;
...
`},7330(e,o,a){a.d(o,{FlyoutPanel:()=>eH});var t=a(5723),r=a(7991),n=a.n(r),i=a(6859),l=a.n(i),s=a(2799),d=a(1316),c=a(814),p=a(6896),g=a(7902),m=a(3013),f=a(2887),u=a(9510),h=a(9848),x=a(7901),b=a(3045),y=a(3775),w=a(1783),$=a(3539),v=a(9416),z=a(1837),k=a(7167),M=a(4494),A=a(2314),T=a(255),S=a(5751),j=a(9633),F=a(2946),B=a(822),C=a(6720),R=a(7400),H=a(8456),P=a(3317),L=a(2709),D=a(8006),E=a(9301),N=a(7561),K=a(3517),I=a(8207),V=a(7032),O=a(6949),W=a(8218),_=a(6829),Y=a(9591),G=a(5553),U=a(9923),q=a(2820),J=a(4621),Z=a(8479),X=a(2534),Q=a(6673),ee=a(7490),eo=a(9033),ea=a(9038),et=a(5775),er=a(1365),en=a(2937),ei=a(9821),el=a(5912),es=a(158),ed=a(8641),ec=a(8607),ep=a(3249),eg=a(1821),em=a(5889),ef=a(9655),eu=a(7170),eh=a(9161),ex=a(1849),eb=a(1604),ey=a(3142),ew=a(1187),e$=a(7747),ev=a(2932),ez=a(4525),ek=a(7230),eM=a(2164);let eA={activity:p.A,"a-large-small":g.A,apple:m.A,"arrow-right":f.A,"bar-chart-2":u.A,book:h.A,"book-open":x.A,briefcase:b.A,calendar:y.A,clock:w.A,"circle-dot":$.A,cloud:v.A,compass:z.A,cpu:k.A,droplets:M.A,feather:A.A,file:T.A,"file-text":S.A,folder:j.A,"git-branch":F.A,github:B.A,globe:C.A,grid:R.A,hand:H.A,hash:P.A,heart:L.A,key:D.A,hexagon:E.A,home:N.A,landmark:K.A,layers:I.A,"layout-grid":V.A,leaf:O.A,lightbulb:W.A,list:_.A,map:Y.A,"map-pin":G.A,"message-circle":U.A,"message-square":q.A,minus:J.A,monitor:Z.A,mountain:X.A,package:Q.A,palette:ee.A,"pen-tool":eo.A,"pie-chart":ea.A,plane:et.A,plus:er.A,ruler:en.A,shirt:ei.A,slash:el.A,square:es.A,star:ed.A,sun:ec.A,terminal:ep.A,thermometer:eg.A,triangle:em.A,trophy:ef.A,truck:eu.A,type:eh.A,users:ex.A,"volume-2":eb.A,watch:ey.A,waves:ew.A,wind:e$.A,wrench:ev.A,x:ez.A,zap:ek.A,bot:eM.A},eT=(0,s.keyframes)`
...
`,eB=({size:e=14,strokeWidth:o=1.75})=>(0,t.jsxs)("svg",{width:e,height:e,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:o,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,t.jsx)("polyline",{points:"14 2 14 8 20 8"})]});function eC({iconKey:e}){let o=e?eA[e]:null;return o?(0,t.jsx)(o,{size:14,strokeWidth:1.75}):(0,t.jsx)(eB,{})}function eR({entries:e,activeId:o,onSelect:a}){return(0,t.jsx)(t.Fragment,{children:e.map(e=>e.children?(0,t.jsx)(n().Fragment,{children:(0,t.jsx)(eR,{entries:e.children,activeId:o,onSelect:a})},e.id):(0,t.jsxs)(eF,{active:o===e.id,onClick:()=>a(e),children:[(0,t.jsx)(eC,{iconKey:e.icon}),e.name]},e.id))})}function eH({activeId:e}){let{flyout:o,scheduleFlyoutClose:a,cancelFlyoutClose:r}=(0,c.c)();if(!o)return null;let n=o.entry.icon?eA[o.entry.icon]:null;return(0,t.jsxs)(eS,{anchorY:o.anchorY,onMouseEnter:r,onMouseLeave:a,children:[(0,t.jsxs)(ej,{children:[n?(0,t.jsx)(n,{size:13,strokeWidth:2}):(0,t.jsx)(eB,{size:13,strokeWidth:2}),o.entry.name]}),(0,t.jsx)(eR,{entries:o.entry.children??[],activeId:e,onSelect:e=>{o.onSelect(e),a()}})]})}},814(e,o,a){a.d(o,{I:()=>r,c:()=>n});var t=a(7991);let r=(0,t.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),n=()=>(0,t.useContext)(r)},3930(e,o,a){a.d(o,{w4:()=>t.w4,VJ:()=>P,PE:()=>F,Is:()=>C.putSetting,PL:()=>C.getSetting});var t=a(1316),r=a(5723),n=a(7991),i=a.n(n),l=a(6859),s=a.n(l);s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,A=s().main`
  ...
  display: flex;
  flex-direction: column;
`,T=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function S(){return(0,r.jsx)(b,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:T.map((e,o)=>(0,r.jsx)(y,{index:o,accent:e.accent,children:e.char},o))})}let j="atlantis:sidebar-collapsed";function F({sidebar:e,children:o,topBarRight:t,title:l="Atlantis",activeId:s=null}){let[d,p]=(0,n.useState)(()=>{try{return"true"===localStorage.getItem(j)}catch{return!1}}),[g,m]=(0,n.useState)(null),x=(0,n.useRef)(),b=()=>p(e=>{let o=!e;try{localStorage.setItem(j,String(o))}catch{}return o}),y=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(a.bind(a,7330)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(c.I.Provider,{value:{collapsed:d,toggle:b,flyout:g,openFlyout:(e,o,a)=>{clearTimeout(x.current),m({entry:e,anchorY:o,onSelect:a})},scheduleFlyoutClose:()=>{x.current=setTimeout(()=>m(null),160)},cancelFlyoutClose:()=>clearTimeout(x.current)},children:(0,r.jsxs)(z,{children:[(0,r.jsxs)(f,{children:[e&&(0,r.jsx)(u,{children:(0,r.jsx)(h,{onClick:b,title:d?"Expand sidebar":"Collapse sidebar",children:(0,r.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,r.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,r.jsx)("path",{d:"M9 3v18"})]})})}),(0,r.jsx)(S,{}),l&&(0,r.jsx)(w,{children:l}),t&&(0,r.jsx)($,{children:t})]}),(0,r.jsxs)(v,{children:[null!=e&&(0,r.jsx)(k,{collapsed:d,children:(0,r.jsx)(M,{children:e})}),(0,r.jsx)(A,{children:o})]}),g&&(0,r.jsx)(i().Suspense,{fallback:null,children:(0,r.jsx)(y,{activeId:s})})]})})}s().div`
  display: grid;
...
`;function P(e,o){let a=o?Object.entries(o).filter(([,e])=>void 0!==e&&""!==e).map(([e,o])=>`${encodeURIComponent(e)}=${encodeURIComponent(String(o))}`).join("&"):"";window.location.hash=a?`#/${e}?${a}`:`#/${e}`}s().div`
  position: fixed;
  inset: 0;
...
`,s().div`
  ...
  flex-direction: column;
  gap: 14px;
  animation: ${H} 0.18s cubic-bezier(0.22, 1, 0.36, 1) both;
`,s().div`
  font-size: ${t.w4.typography.fontSizeMd};
  font-weight: 700;
...
`,b=n().forwardRef(function({variant:e="ghost",size:o="md",icon:a,iconRight:r,children:n,...i},l){return(0,t.jsxs)(x,{ref:l,variant:e,size:o,...i,children:[a,n,r]})}),y={default:s.w4.colors.accent,danger:"#f85149"},w={default:s.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"};l().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`;let $=l().div`
  ...
  gap: 4px;
  flex-wrap: wrap;
`,v=l()("button",{shouldForwardProp:e=>"active"!==e&&"highlight"!==e})`
  padding: 6px 14px;
  height: 28px;
  border-radius: 999px;
...
`;function z({tabs:e,value:o,onChange:a,className:r,"aria-label":n}){return(0,t.jsx)($,{role:"tablist","aria-label":n,className:r,children:e.map(e=>{let r=e.value===o;return(0,t.jsx)(v,{type:"button",role:"tab","aria-selected":r,active:r,highlight:e.highlight,disabled:e.disabled,onClick:()=>a(e.value),children:e.label},e.value)})})}a(2727);var k=a(2799);let M=(0,k.keyframes)`
...
`,l().span`
  ...
  background: ${({color:e})=>e};
  display: inline-block;
`;let B={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:s.w4.colors.accentMuted},C={neutral:s.w4.colors.mainTextMuted,live:s.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:s.w4.colors.accent},R=l().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${s.w4.typography.fontFamilyMono};
...
`,H=l().span`
  ...
  display: inline-block;
`;function P({tone:e="neutral",dot:o,children:a,...r}){return(0,t.jsxs)(R,{tone:e,...r,children:[(o??"live"===e)&&(0,t.jsx)(H,{}),a]})}l().kbd`
  font-family: ${s.w4.typography.fontFamilyMono};
  font-size: 10px;
  padding: 2px 6px;
  border: 1px solid ${s.w4.colors.border};
...
`;let L=l().div`
  ...
  align-items: center;
  gap: 8px;
`;function D({children:e,...o}){return(0,t.jsx)(L,{...o,children:e})}l().label`
  display: flex;
  align-items: center;
  gap: 10px;
...
`;function W({title:e,accessory:o,accentColor:a,error:r,errorLabel:n,children:i}){return(0,t.jsxs)(E,{accentColor:a,"data-widget-shell":!0,children:[(0,t.jsxs)(N,{children:[(0,t.jsx)(D,{children:e}),o&&(0,t.jsx)(K,{children:o})]}),r?(0,t.jsxs)(V,{role:"alert",children:[(0,t.jsx)(O,{children:n??"Error"}),(0,t.jsx)("div",{children:r})]}):(0,t.jsx)(I,{children:i})]})}l().div`
  position: relative;
  display: flex;
  flex-direction: column;
  height: 100%;
...
`,J.A,J.A['pre[class*="language-"]'],s.w4.colors.codeBg,J.A['code[class*="language-"]'],l().div`
  background: ${({bg:e})=>e};
...
`,ee=l().span`
  ...
  line-height: 1;
  letter-spacing: 0;
`,eo=["#3b82f6","#8b5cf6","#ec4899","#10b981","#f59e0b","#06b6d4"],ea=0,et=new Map;function er({member:e,size:o=24}){var a,r;let n,i="shared"===e.id||"shared"===e.role,l=Math.floor(.55*o),d=o<=18?8:o<=22?9:o<=28?11:12;if(i)return(0,t.jsx)(Q,{size:o,bg:s.w4.colors.surface,ring:!0,"aria-label":"Shared",title:"Shared",style:{color:s.w4.colors.mainTextMuted},children:(0,t.jsx)(S,{name:"home",size:l,"aria-hidden":!0})});let c=(a=e.id,(r=e.color)?r:(!et.has(a)&&(et.set(a,eo[ea%eo.length]),ea++),et.get(a))),p="adult"===e.role,g=(n=e.name.trim().split(/\s+/),((n[0]?.[0]??"")+(n[1]?.[0]??"")).toUpperCase().slice(0,2));return(0,t.jsx)(Q,{size:o,bg:c,ring:p,title:e.name,children:(0,t.jsx)(ee,{fontSize:d,children:g})})}},4041(e,o,a){a.d(o,{z:()=>t});function t(){return"u">typeof crypto&&"function"==typeof crypto.randomUUID?crypto.randomUUID().replace(/-/g,"").slice(0,8):Math.random().toString(36).slice(2,10).padEnd(8,"0")}},8908(e,o,a){a.d(o,{uj:()=>z,OW:()=>m,ik:()=>x,Xj:()=>R,Ru:()=>u,kl:()=>j,RT:()=>T,RJ:()=>y,YG:()=>p});var t=a(5723),r=a(6859),n=a.n(r),i=a(3930);let l=n().div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
`,d=n().p`
  ...
  margin: 0;
  line-height: 1.5;
`,c={loading:"◌ Loading",empty:"◎ Empty",error:"◎ Offline"};function p({mode:e,label:o,body:a}){return(0,t.jsxs)(l,{children:[(0,t.jsx)(s,{mode:e,children:o??c[e]}),a&&(0,t.jsx)(d,{children:a})]})}var g=a(7991);function m({points:e,accent:o=i.w4.colors.accent,width:a=60,height:r=28,strokeWidth:n=1.5}){let l=(0,g.useMemo)(()=>{if(e.length<2)return"";let o=Math.min(...e),t=Math.max(...e)-o||1,i=a-2*n,l=r-2*n;return e.map((a,r)=>{let s=n+r/(e.length-1)*i,d=n+l-(a-o)/t*l;return`${0===r?"M":"L"} ${s.toFixed(1)} ${d.toFixed(1)}`}).join(" ")},[e,a,r,n]),s=(0,g.useMemo)(()=>{if(e.length<1)return null;let o=e[e.length-1],t=Math.min(...e),i=a-2*n,l=r-2*n;return{x:n+i,y:n+l-(o-t)/(Math.max(...e)-t||1)*l}},[e,a,r,n]);return l?(0,t.jsxs)("svg",{width:a,height:r,viewBox:`0 0 ${a} ${r}`,"aria-hidden":"true",style:{display:"block",flexShrink:0},children:[(0,t.jsx)("path",{d:l,fill:"none",stroke:o,strokeWidth:n,strokeLinecap:"round",strokeLinejoin:"round",opacity:.7}),s&&(0,t.jsx)("circle",{cx:s.x,cy:s.y,r:n+1,fill:o})]}):null}let f=n().span`
  font-family: ${i.w4.typography.fontFamilyMono};
  font-size: 11px;
  font-weight: 500;
  font-variant-numeric: tabular-nums;
  ...
  white-space: nowrap;
`;function u({value:e,format:o="pct",decimals:a=2}){let r=e>0?"pos":e<0?"neg":"zero",n=Math.abs(e).toFixed(a);return(0,t.jsxs)(f,{sign:r,children:["pos"===r?"▲":"neg"===r?"▼":"—"," ",n,"pct"===o?"%":""]})}n().div`
  display: flex;
  align-items: baseline;
  justify-content: space-between;
  gap: ${i.w4.spacing.sm};
...
`,n().span`
  ...
  flex-shrink: 0;
  text-align: right;
`,a(3090);let h="'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, monospace";function x({data:e,budget:o,height:a=200,animation:r="rise"}){let n=(0,g.useId)();if(!e.length)return null;let l=1.1*Math.max(...e.map(e=>e.segments.reduce((e,o)=>e+o.value,0)+(e.over??0)),o??0)||1,s=472,d=a-20-24,c=472/e.length*.58,p=s/e.length,m="rise"===r?{transformOrigin:"bottom",animation:`${n}_rise 0.45s ease-out both`}:{};return(0,t.jsxs)(t.Fragment,{children:["rise"===r&&(0,t.jsx)("style",{children:`
          @keyframes ${n}_rise {
            from { transform: scaleY(0); }
            to   { transform: scaleY(1); }
          }
        `}),(0,t.jsxs)("svg",{viewBox:`0 0 520 ${a}`,style:{width:"100%",height:a},preserveAspectRatio:"xMidYMid meet","aria-hidden":"true",children:[null!=o?(0,t.jsxs)("g",{children:[(0,t.jsx)("line",{x1:40,x2:40+s,y1:20+d-o/l*d,y2:20+d-o/l*d,stroke:i.w4.colors.border,strokeDasharray:"3 3",strokeWidth:"1"}),(0,t.jsxs)("text",{x:36,y:20+d-o/l*d+3,textAnchor:"end",fontFamily:h,fontSize:"9",fill:i.w4.colors.mainTextMuted,children:["€",o]})]}):null,e.map((e,o)=>{let r,n=40+o*p+(p-c)/2,s=20+d;return(0,t.jsxs)("g",{style:m,children:[e.segments.map(e=>{let o=e.value/l*d;return s-=o,(0,t.jsx)("rect",{x:n,y:s,width:c,height:o,fill:e.color,opacity:.85},e.id)}),null!=e.over&&e.over>0?(r=e.over/l*d,s-=r,(0,t.jsx)("rect",{x:n,y:s,width:c,height:r,fill:"#f85149",opacity:.7},"over")):null,(0,t.jsx)("text",{x:n+c/2,y:a-6,textAnchor:"middle",fontFamily:h,fontSize:"10",fill:i.w4.colors.mainTextMuted,children:e.label})]},e.label)})]})]})}let b="'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, monospace";function y({data:e,total:o,size:a=110,thickness:r=14,centerLabel:n,centerValue:l}){let s=(0,g.useId)(),d=a/2-r/2-2,c=2*Math.PI*d,p=e.reduce((e,o)=>e+o.value,0)||1,m=0;return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)("style",{children:`
        @keyframes ${s}_dash {
          from { stroke-dasharray: 0 ${c.toFixed(1)}; }
        }
      `}),(0,t.jsxs)("svg",{viewBox:`0 0 ${a} ${a}`,style:{width:a,height:a,flexShrink:0},"aria-hidden":"true",children:[(0,t.jsx)("circle",{cx:a/2,cy:a/2,r:d,fill:"none",stroke:i.w4.colors.border,strokeWidth:r}),e.map((e,o)=>{let n=e.value/p*c,i=60*o,l=(0,t.jsx)("circle",{cx:a/2,cy:a/2,r:d,fill:"none",stroke:e.color,strokeWidth:r,strokeDasharray:`${n.toFixed(1)} ${c.toFixed(1)}`,strokeDashoffset:(-m).toFixed(1),transform:`rotate(-90 ${a/2} ${a/2})`,style:{animation:`${s}_dash 0.45s ease-out ${i}ms both`}},o);return m+=n,l}),n?(0,t.jsx)("text",{x:a/2,y:a/2-4,textAnchor:"middle",fontFamily:b,fontSize:"9",fill:i.w4.colors.mainTextMuted,letterSpacing:"0.12em",textDecoration:"none",children:n.toUpperCase()}):null,l?(0,t.jsx)("text",{x:a/2,y:n?a/2+11:a/2+4,textAnchor:"middle",fontFamily:b,fontSize:"13",fontWeight:"700",fill:i.w4.colors.mainText,children:l}):null]})]})}let w="#7fb77e",$="#f85149";function v(e){let o=0;for(let a=1;a<e.length;a++){let t=e[a][0]-e[a-1][0],r=e[a][1]-e[a-1][1];o+=Math.sqrt(t*t+r*r)}return o}function z({data:e,height:o=170,legendIn:a,legendOut:r}){let n=(0,g.useId)();if(!e.length)return null;let l=288,s=o-10-32,d=1.1*Math.max(...e.map(e=>e.inc),...e.map(e=>e.exp))||1,c=l/Math.max(e.length-1,1),p=(0,g.useMemo)(()=>e.map((e,o)=>[6+o*c,10+s-e.inc/d*s]),[e,o]),m=(0,g.useMemo)(()=>e.map((e,o)=>[6+o*c,10+s-e.exp/d*s]),[e,o]),f=p.map(e=>e.join(",")).join(" "),u=m.map(e=>e.join(",")).join(" "),h=[`M${p[0][0]},${10+s}`,...p.map(e=>`L${e[0]},${e[1]}`),`L${p[p.length-1][0]},${10+s}`,"Z"].join(" "),x=v(p).toFixed(1),b=v(m).toFixed(1),y=e.reduce((e,o)=>e+o.inc,0),k=e.reduce((e,o)=>e+o.exp,0),M=e=>e>=1e3?`€${(e/1e3).toFixed(1)}k`:`€${Math.round(e)}`;return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)("style",{children:`
        @keyframes ${n}_inc { from { stroke-dashoffset: ${x}; } }
        @keyframes ${n}_exp { from { stroke-dashoffset: ${b}; } }
      `}),(0,t.jsxs)("svg",{viewBox:`0 0 300 ${o}`,style:{width:"100%",height:o},preserveAspectRatio:"none","aria-hidden":"true",children:[(0,t.jsx)("path",{d:h,fill:w,opacity:.1}),(0,t.jsx)("polyline",{points:f,stroke:w,strokeWidth:"1.25",fill:"none",strokeLinecap:"round",strokeLinejoin:"round",strokeDasharray:x,strokeDashoffset:"0",style:{animation:`${n}_inc 0.5s ease-out both`}}),(0,t.jsx)("polyline",{points:u,stroke:$,strokeWidth:"1.25",fill:"none",strokeLinecap:"round",strokeLinejoin:"round",strokeDasharray:b,strokeDashoffset:"0",style:{animation:`${n}_exp 0.5s ease-out 0.1s both`}}),(0,t.jsx)("line",{x1:6,x2:6+l,y1:10+s,y2:10+s,stroke:i.w4.colors.border,strokeWidth:"1"}),(0,t.jsxs)("g",{fontFamily:"'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, monospace",fontSize:"10",style:{fontVariantNumeric:"tabular-nums"},children:[(0,t.jsxs)("text",{x:6,y:o-14,fill:w,children:["● ",a??"in"," ",M(y)]}),(0,t.jsxs)("text",{x:6+l/2+4,y:o-14,fill:$,children:["● ",r??"out"," ",M(k)]}),(0,t.jsx)("text",{x:6,y:o-2,fill:i.w4.colors.mainTextMuted,children:"90D"})]})]})]})}let k=["#1a2420","#2a4535","#4a7a5a","#6fa77a","#7fb77e"],M=["S","T","Q","Q","S","S","D"],A=["S","M","T","W","T","F","S"];function T({data:e,cellSize:o=10,gap:a=2,locale:r="pt"}){let n=(0,g.useId)();if(!e.length)return null;let l=24+Math.ceil(e.length/7)*(o+a),s=14+7*(o+a);return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)("style",{children:`
        @keyframes ${n}_fade { from { opacity: 0; } to { opacity: 1; } }
      `}),(0,t.jsxs)("svg",{viewBox:`0 0 ${l} ${s}`,style:{width:"100%",height:"auto",maxHeight:s+4},"aria-hidden":"true",children:[(0,t.jsx)("g",{fontFamily:"'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, monospace",fontSize:"8",fill:i.w4.colors.mainTextMuted,children:("pt"===r?M:A).map((e,r)=>(0,t.jsx)("text",{x:"0",y:10+r*(o+a),children:e},r))}),e.map((e,r)=>{let i=18+Math.floor(r/7)*(o+a),l=2+r%7*(o+a),s=k[Math.max(0,Math.min(4,e))]??k[0];return(0,t.jsx)("rect",{x:i,y:l,width:o,height:o,fill:s,rx:"1",style:{animation:`${n}_fade 0.3s ease-out ${8*r}ms both`}},r)})]})]})}function S(e){let o=0;for(let a=1;a<e.length;a++){let t=e[a][0]-e[a-1][0],r=e[a][1]-e[a-1][1];o+=Math.sqrt(t*t+r*r)}return o}function j({spent:e,budget:o,height:a=60}){let r=(0,g.useId)(),n=1.05*o||1,l=Array.from({length:8},(e,a)=>o-o/7*a),s=Math.min(e/(o||1),1),d=Array.from({length:8},(e,a)=>Math.max(0,o-a/7*o*s*1.1)),c=l.map((e,o)=>[320*o/7,a-e/n*(a-5)]),p=d.map((e,o)=>[320*o/7,a-e/n*(a-5)]),m=c.map(e=>e.join(",")).join(" "),f=p.map(e=>e.join(",")).join(" "),u=S(c).toFixed(1),h=S(p).toFixed(1);return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)("style",{children:`
        @keyframes ${r}_i { from { stroke-dashoffset: ${u}; } }
        @keyframes ${r}_a { from { stroke-dashoffset: ${h}; } }
      `}),(0,t.jsxs)("svg",{viewBox:`0 0 320 ${a}`,style:{width:"100%",height:a},preserveAspectRatio:"none","aria-hidden":"true",children:[(0,t.jsx)("line",{x1:"0",x2:320,y1:a-5,y2:a-5,stroke:i.w4.colors.border,strokeDasharray:"3 3",strokeWidth:"1"}),(0,t.jsx)("polyline",{points:m,stroke:i.w4.colors.mainTextMuted,strokeWidth:"1",strokeDasharray:`${u} ${u}`,strokeDashoffset:"0",fill:"none",style:{strokeDasharray:"2 3",animation:`${r}_i 0.45s ease-out both`}}),(0,t.jsx)("polyline",{points:f,stroke:"#7fb77e",strokeWidth:"1.5",strokeDasharray:`${h} ${h}`,strokeDashoffset:"0",fill:"none",strokeLinecap:"round",style:{animation:`${r}_a 0.45s ease-out 0.08s both`}})]})]})}let F=n().div`
  position: relative;
  height: 6px;
...
`,C=n().div`
  ...
  opacity: 0.7;
  transition: width 400ms ease;
`;function R({pct:e,over:o=0,color:a="#7fb77e"}){let r=Math.min(100,e),n=100-o;return(0,t.jsxs)(F,{children:[(0,t.jsx)(B,{pct:r,color:a}),o>0&&(0,t.jsx)(C,{left:Math.max(0,n),width:o})]})}},3090(e,o,a){a.d(o,{B:()=>r});var t=a(7293);function r(e){let o=(0,t.cacheBackedProducer)({id:e.id,category:e.category,cacheKey:e.cacheKey,parse:e.parse});return{id:e.id,category:e.category,labelKey:e.labelKey,producer:o,start(){},stop(){}}}},7517(e,o,a){a.d(o,{A:()=>t});let t={id:"habits",load:()=>Promise.all([a.e("7044"),a.e("2045")]).then(a.bind(a,6780)).then(e=>({default:e.HabitsWidget})),labels:{en:"Habits Grid",pt:"Grelha de H\xe1bitos"},descriptions:{en:"Your last 7 days of missions",pt:"Os teus \xfaltimas 7 dias de miss\xf5es"},icon:"\uD83C\uDFAF",accentColor:"#fb923c",defaultSize:"sm",defaultCols:1,maxCols:2,minHeight:200,suite:"vida",defaultOnDashboard:!0,sources:[{id:"daily-progress",kind:"bll-hook",cacheKey:"daily:progress",labelKey:"sources.dailyProgress"}],notifications:[{id:"daily",category:"daily.overdue",labelKey:"notifications.source.daily",producer:(0,a(7293).dailyProducer)({category:"daily.overdue"}),start(){},stop(){}}],persistedKeys:["daily:progress"]}},2013(e,o,a){a.d(o,{A:()=>r});var t=a(9815);let r={id:"hackernews-hot",load:()=>Promise.all([a.e("7044"),a.e("9390")]).then(a.bind(a,3565)).then(e=>({default:e.HackerNewsHotWidget})),labels:{en:"Hacker News Hot",pt:"Em Alta no HN"},descriptions:{en:"Top stories from Hacker News",pt:"Hist\xf3rias em destaque no Hacker News"},icon:"\uD83D\uDD25",accentColor:"#f97316",defaultSize:"sm",defaultCols:1,maxCols:1,minHeight:200,suite:"learn",defaultOnDashboard:!1,sources:[{id:"hn-firebase",kind:"dal-client",cacheKey:"internet-hn-ids",labelKey:"sources.hackerNews",notifiable:!0}],notifications:[{id:"hn-front-page",category:"hn.frontPage",labelKey:"notifications.source.hnFrontPage",producer:{id:"hn-front-page",category:"hn.frontPage",async poll(){let e=await (0,t.fetchHnFrontPage)(5);if(!e?.hits)return[];let o=[];for(let a of e.hits){let e=a.created_at_i??(a.created_at?Date.parse(a.created_at)/1e3:NaN);Number.isFinite(e)&&o.push({id:`hn-front:${a.objectID}`,category:"hn.frontPage",ts:1e3*e,title:a.title,link:a.url??`https://news.ycombinator.com/item?id=${a.objectID}`,meta:{points:a.points,comments:a.num_comments}})}return o}},start(){},stop(){}}],persistedKeys:["widget-cache:internet-hn-ids"]}},1496(e,o,a){a.d(o,{uj:()=>t.uj,OW:()=>t.OW,ik:()=>t.ik,Xj:()=>t.Xj,Ru:()=>t.Ru,kl:()=>t.kl,RT:()=>t.RT,RJ:()=>t.RJ}),a(7517),a(2013),a(9603),a(2026),a(5471),a(5417),a(4200),a(2306),a(9780);var t=a(8908);a(5723),a(7991);var r=a(6859),n=a.n(r),i=a(2799),l=a(3930);a(8395),a(8170);let s=(0,i.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to { opacity: 1; transform: translateY(0); }
`;n().div`
  display: grid;
...
`,n().div`
  ...
  text-align: center;
  line-height: 1.5;
`},9603(e,o,a){a.d(o,{A:()=>t});let t={id:"news-pt",load:()=>Promise.all([a.e("7044"),a.e("9392")]).then(a.bind(a,1507)).then(e=>({default:e.NewsPortugalWidget})),labels:{en:"PT News",pt:"Not\xedcias PT"},descriptions:{en:"Latest news from RTP",pt:"\xdaltimas not\xedcias da RTP"},icon:"\uD83D\uDCF0",accentColor:"#2da44e",defaultSize:"sm",defaultCols:1,maxCols:1,minHeight:200,suite:"vida",defaultOnDashboard:!1,sources:[{id:"rtp-rss",kind:"cache-key",cacheKey:"news-portugal",labelKey:"sources.rtp",notifiable:!0}],notifications:[(0,a(3090).B)({id:"news-pt",category:"news.pt",labelKey:"notifications.source.newsPt",badgeColor:"#2da44e",cacheKey:"news-portugal",parse:function(e){if(!e?.items)return[];let o=[];return e.items.forEach((e,a)=>{let t=Date.parse(e.pubDate);Number.isNaN(t)||o.push({id:`${t}-${a}`,ts:t,title:e.title,link:e.link})}),o}})],persistedKeys:["widget-cache:news-portugal"]}},2026(e,o,a){a.d(o,{A:()=>t});let t={id:"news-world",load:()=>Promise.all([a.e("7044"),a.e("7566")]).then(a.bind(a,4925)).then(e=>({default:e.NewsWorldWidget})),labels:{en:"World News",pt:"Not\xedcias Mundo"},descriptions:{en:"Latest news from CNN",pt:"\xdaltimas not\xedcias da CNN"},icon:"\uD83C\uDF0D",accentColor:"#cc0000",defaultSize:"sm",defaultCols:1,maxCols:1,minHeight:200,suite:"vida",defaultOnDashboard:!1,sources:[{id:"cnn-rss",kind:"cache-key",cacheKey:"news-world",labelKey:"sources.cnn",notifiable:!0}],notifications:[(0,a(3090).B)({id:"news-world",category:"news.world",labelKey:"notifications.source.newsWorld",badgeColor:"#cc0000",cacheKey:"news-world",parse:function(e){if(!e?.items)return[];let o=[];return e.items.forEach((e,a)=>{let t=Date.parse(e.pubDate);Number.isNaN(t)||o.push({id:`${t}-${a}`,ts:t,title:e.title,link:e.link})}),o}})],persistedKeys:["widget-cache:news-world"]}},5471(e,o,a){a.d(o,{A:()=>r});var t=a(3090);let r={id:"seismic",load:()=>Promise.all([a.e("7044"),a.e("5773")]).then(a.bind(a,8108)).then(e=>({default:e.SeismicWidget})),labels:{en:"PT Seismic",pt:"Sismicidade PT"},descriptions:{en:"Recent seismic activity in Portugal",pt:"Atividade s\xedsmica recente em Portugal"},icon:"\uD83C\uDF0B",accentColor:"#f97316",defaultSize:"sm",defaultCols:1,maxCols:1,minHeight:200,suite:"vida",defaultOnDashboard:!1,sources:[{id:"ipma",kind:"dal-client",cacheKey:"seismic-pt",labelKey:"sources.ipma",notifiable:!0},{id:"usgs",kind:"dal-client",cacheKey:"seismic-world",labelKey:"sources.usgs",notifiable:!0}],notifications:[(0,t.B)({id:"seismic-pt",category:"seismic.pt",labelKey:"notifications.source.seismicPt",badgeColor:"#f97316",cacheKey:"seismic-pt",parse:function(e){if(!Array.isArray(e))return[];let o=[];return e.forEach((e,a)=>{let t=Date.parse(e.time);if(Number.isNaN(t))return;let r=e.local||e.obsRegion||"?";o.push({id:`pt-${t}-${a}`,ts:t,title:`M ${e.mag.toFixed(1)} — ${r}`})}),o}}),(0,t.B)({id:"seismic-world",category:"seismic.world",labelKey:"notifications.source.seismicWorld",badgeColor:"#ea580c",cacheKey:"seismic-world",parse:function(e){return e?.features?e.features.map(e=>({id:e.id,ts:e.properties.time,title:`M ${e.properties.mag.toFixed(1)} — ${e.properties.place}`,link:e.properties.url})):[]}})],persistedKeys:["widget-cache:seismic-pt","widget-cache:seismic-world"]}},5417(e,o,a){a.d(o,{A:()=>r});var t=a(9815);let r={id:"techscope",load:()=>Promise.all([a.e("7044"),a.e("7923")]).then(a.bind(a,4942)).then(e=>({default:e.TechScopeLiveWidget})),labels:{en:"TechScope Live",pt:"TechScope Ao Vivo"},descriptions:{en:"Trending GitHub repos and Hacker News stories",pt:"Reposit\xf3rios GitHub e hist\xf3rias do Hacker News em alta"},icon:"⚡",accentColor:"#a371f7",defaultSize:"lg",defaultCols:2,maxCols:2,minHeight:240,suite:"learn",defaultOnDashboard:!0,sources:[{id:"github-trending",kind:"cache-key",cacheKey:"techscope-gh",labelKey:"sources.github",notifiable:!0},{id:"hn-algolia",kind:"cache-key",cacheKey:"techscope-hn",labelKey:"sources.hackerNews",notifiable:!0}],notifications:[{id:"github-trending",category:"github.trending",labelKey:"notifications.source.githubTrending",producer:{id:"github-trending",category:"github.trending",async poll(){let e=await (0,t.fetchTrendingRepos)({days:7,perPage:5});if(!e?.items)return[];let o=[];for(let a of e.items){let e=a.created_at?Date.parse(a.created_at):NaN;if(!Number.isFinite(e))continue;let t=a.stargazers_count,r=a.language?` \xb7 ${a.language}`:"";o.push({id:`gh-trending:${a.id}`,category:"github.trending",ts:e,title:`${a.full_name} — ${t.toLocaleString()}★${r}`,link:a.html_url,meta:{stars:t,language:a.language,description:a.description}})}return o}},start(){},stop(){}},{id:"devto-weekly",category:"devto.weekly",labelKey:"notifications.source.devto",producer:{id:"devto-weekly",category:"devto.weekly",async poll(){let e=await (0,t.fetchDevToArticles)({top:7,perPage:5});if(!e)return[];let o=[];for(let a of e){let e=Date.parse(a.published_at);if(!Number.isFinite(e))continue;let t=a.public_reactions_count??0,r=a.user?.name||a.user?.username,n=r?` — ${r}`:"";o.push({id:`devto:${a.id}`,category:"devto.weekly",ts:e,title:`${a.title}${n}`,link:a.url,meta:{reactions:t,comments:a.comments_count??0,readingTime:a.reading_time_minutes??null,tags:a.tag_list??[]}})}return o}},start(){},stop(){}}],persistedKeys:["widget-cache:techscope-gh","widget-cache:techscope-hn"]}},4200(e,o,a){a.d(o,{A:()=>t});let t={id:"trending-searches",load:()=>Promise.all([a.e("7044"),a.e("346")]).then(a.bind(a,2065)).then(e=>({default:e.TrendingSearchesWidget})),labels:{en:"Trending Searches",pt:"Pesquisas em Alta"},descriptions:{en:"Top Google trending searches right now",pt:"As pesquisas mais populares no Google agora"},icon:"\uD83D\uDD0D",accentColor:"#e233ff",defaultSize:"sm",defaultCols:1,maxCols:1,minHeight:200,suite:"learn",defaultOnDashboard:!1,sources:[{id:"google-trends-rss",kind:"cache-key",cacheKey:"internet-trends",labelKey:"sources.googleTrends",notifiable:!0}],notifications:[(0,a(3090).B)({id:"trending-daily",category:"trending.daily",labelKey:"notifications.source.trending",badgeColor:"#e233ff",cacheKey:"internet-trends",parse:function(e){let o=e?.items?.[0];return o?[{id:new Date().toISOString().slice(0,10),ts:Date.now(),title:o.title,link:o.link}]:[]}})],persistedKeys:["widget-cache:internet-trends"]}},2306(e,o,a){a.d(o,{A:()=>i});var t=a(3090);let r={yellow:"\uD83D\uDFE1",orange:"\uD83D\uDFE0",red:"\uD83D\uDD34"},n={yellow:"Yellow",orange:"Orange",red:"Red"},i={id:"weather",load:()=>Promise.all([a.e("7044"),a.e("6693")]).then(a.bind(a,5940)).then(e=>({default:e.WeatherWidget})),labels:{en:"Weather",pt:"Meteorologia"},descriptions:{en:"Current weather for Lisbon",pt:"Meteorologia atual em Lisboa"},icon:"\uD83C\uDF24️",accentColor:"#58a6ff",defaultSize:"sm",defaultCols:1,maxCols:1,minHeight:280,suite:"vida",defaultOnDashboard:!0,sources:[{id:"openMeteo",kind:"cache-key",cacheKey:"weather-lisbon",labelKey:"sources.openMeteo",notifiable:!0}],notifications:[(0,t.B)({id:"ipma-warnings",category:"weather.pt.warnings",labelKey:"notifications.source.weatherPt",badgeColor:"#facc15",cacheKey:"ipma-warnings",parse:function(e){if(!Array.isArray(e))return[];let o=Date.now(),a=[];return e.forEach((e,t)=>{if("green"===e.awarenessLevelID||"yellow"===e.awarenessLevelID)return;let i=Date.parse(e.endTime);if(Number.isNaN(i)||i<o)return;let l=Date.parse(e.startTime);if(Number.isNaN(l))return;let s=e.awarenessLevelID,d=r[s]??"⚠",c=n[s]??e.awarenessLevelID.toUpperCase(),p=e.idAreaAviso||"Portugal",g=e.awarenessTypeName?e.awarenessTypeName.toLowerCase():"weather";a.push({id:`ipma-warn:${p}-${l}-${t}`,ts:l,title:`${d} ${c} ${g} warning — ${p}`,link:"https://www.ipma.pt/en/otempo/prev-sam/"})}),a}})]}},9780(e,o,a){a.d(o,{A:()=>i});var t=a(3090);let r=new Set(["Main_Page","Special:Search","Wikipedia:Featured_pictures","-","Special:Watchlist","Portal:Current_events"]);function n(){return new Date(Date.now()-864e5).toISOString().slice(0,10)}let i={id:"wiki-most-read",load:()=>Promise.all([a.e("7044"),a.e("545")]).then(a.bind(a,5464)).then(e=>({default:e.WikiMostReadWidget})),labels:{en:"Wikipedia Top",pt:"Mais Lido na Wikip\xe9dia"},descriptions:{en:"Most read articles on Wikipedia today",pt:"Artigos mais lidos na Wikip\xe9dia hoje"},icon:"\uD83D\uDCD6",accentColor:"#58a6ff",defaultSize:"sm",defaultCols:1,maxCols:1,minHeight:200,suite:"learn",defaultOnDashboard:!1,sources:[{id:"wikipedia-pageviews",kind:"cache-key",labelKey:"sources.wikipedia",notifiable:!0}],notifications:[(0,t.B)({id:"wiki-top-read",category:"wiki.topRead",labelKey:"notifications.source.wikiTopRead",badgeColor:"#58a6ff",cacheKey:()=>`internet-wiki-${n()}`,parse:function(e){let o=(e?.items?.[0]?.articles??[]).find(e=>!r.has(e.article));if(!o)return[];let a=n(),t=o.article.replace(/_/g," ");return[{id:a,ts:Date.now(),title:t,link:`https://en.wikipedia.org/wiki/${encodeURIComponent(o.article)}`}]}})]}}}]);