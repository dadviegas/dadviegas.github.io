"use strict";(self.webpackChunk_atlantis_shell=self.webpackChunk_atlantis_shell||[]).push([["4519"],{30522(e,a,o){o.d(a,{C:()=>c,j:()=>m});let t={dal:{tmdb:{baseUrl:"https://api.themoviedb.org/3",imageBaseUrl:"https://image.tmdb.org/t/p",defaultTtlMs:18e5},wikipedia:{contentBaseUrl:"https://en.wikipedia.org/api/rest_v1",analyticsBaseUrl:"https://wikimedia.org/api/rest_v1",defaultTtlMs:36e5},sunriseSunset:{baseUrl:"https://api.sunrise-sunset.org/json",defaultTtlMs:864e5},openLibrary:{searchUrl:"https://openlibrary.org/search.json",coverBaseUrl:"https://covers.openlibrary.org/b/id",defaultTtlMs:2592e6},coinGecko:{baseUrl:"https://api.coingecko.com/api/v3",defaultTtlMs:3e5},openMeteo:{baseUrl:"https://api.open-meteo.com/v1",defaultTtlMs:9e5},hn:{algoliaBaseUrl:"https://hn.algolia.com/api/v1",firebaseBaseUrl:"https://hacker-news.firebaseio.com/v0",defaultTtlMs:3e5},github:{baseUrl:"https://api.github.com",defaultTtlMs:3e5},rss:{baseUrl:"https://api.rss2json.com/v1/api.json",defaultTtlMs:6e5},ipma:{baseUrl:"https://api.ipma.pt/open-data/observation/seismic",defaultTtlMs:18e5},usgs:{baseUrl:"https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary",defaultTtlMs:18e5},noaaSwpc:{baseUrl:"https://services.swpc.noaa.gov/json",defaultTtlMs:3e5},nasaEonet:{baseUrl:"https://eonet.gsfc.nasa.gov/api/v3",defaultTtlMs:18e5},airplanesLive:{baseUrl:"https://api.airplanes.live/v2",defaultTtlMs:15e3},rainViewer:{manifestUrl:"https://api.rainviewer.com/public/weather-maps.json",defaultTtlMs:3e5},npms:{baseUrl:"https://api.npms.io/v2",defaultTtlMs:3e5},npmRegistry:{baseUrl:"https://api.npmjs.org",defaultTtlMs:36e5},devTo:{baseUrl:"https://dev.to/api",defaultTtlMs:6e5},stackExchange:{baseUrl:"https://api.stackexchange.com/2.3",defaultTtlMs:6e5},itunesSearch:{baseUrl:"https://itunes.apple.com/search",defaultTtlMs:864e5},whereIsTheIss:{baseUrl:"https://api.wheretheiss.at/v1/satellites",defaultTtlMs:5e3},tle:{baseUrl:"https://tle.ivanstanojevic.me/api/tle",defaultTtlMs:36e5},groq:{chatCompletionsUrl:"https://api.groq.com/openai/v1/chat/completions",defaultModel:"llama-3.1-8b-instant",models:[{id:"llama-3.1-8b-instant",label:"Llama 3.1 \xb7 8B \xb7 instant",hint:"Fast default — good for short answers",vision:!1},{id:"llama-3.3-70b-versatile",label:"Llama 3.3 \xb7 70B \xb7 versatile",hint:"Slower but stronger reasoning",vision:!1},{id:"openai/gpt-oss-120b",label:"GPT-OSS \xb7 120B",hint:"Largest open-weights option",vision:!1},{id:"meta-llama/llama-4-scout-17b-16e-instruct",label:"Llama 4 \xb7 Scout \xb7 17B",hint:"Vision capable — analyzes images",vision:!0},{id:"meta-llama/llama-4-maverick-17b-128e-instruct",label:"Llama 4 \xb7 Maverick \xb7 17B",hint:"Vision capable — stronger multi-modal",vision:!0}]},gemini:{baseUrl:"https://generativelanguage.googleapis.com/v1beta/models",defaultModel:"gemini-2.0-flash",models:[{id:"gemini-2.0-flash",label:"Gemini 2.0 \xb7 Flash",hint:"Fast default — balanced quality"},{id:"gemini-2.0-flash-lite",label:"Gemini 2.0 \xb7 Flash Lite",hint:"Cheapest option"},{id:"gemini-1.5-flash",label:"Gemini 1.5 \xb7 Flash",hint:"Legacy — still supported"}]},pollinations:{imageBaseUrl:"https://image.pollinations.ai/prompt",defaultModel:"flux",models:[{id:"flux",label:"Flux"},{id:"flux-realism",label:"Flux \xb7 Realism"},{id:"flux-anime",label:"Flux \xb7 Anime"},{id:"flux-3d",label:"Flux \xb7 3D"},{id:"any-dark",label:"Any Dark"},{id:"turbo",label:"Turbo"}]}},locations:{lisbon:{lat:38.7223,lon:-9.1393,label:"Lisboa",timezone:"Europe/Lisbon"}}};function n(e){try{return"u">typeof process?process.env[e]:void 0}catch{return}}function i(e,a){let o=e;for(let e of a){if(!o||"object"!=typeof o)throw Error(`appConfig: missing path ${a.join(".")}`);o=o[e]}return o}function r(e,a){let o=n(a);if(o)return o;let r=i(t,e);if("string"!=typeof r)throw Error(`appConfig: expected string at ${e.join(".")}`);return r}function l(e,a){let o=n(a);if(void 0!==o&&""!==o){let e=Number(o);if(Number.isFinite(e))return e}let r=i(t,e);if("number"!=typeof r)throw Error(`appConfig: expected number at ${e.join(".")}`);return r}function s(e,a){let o=i(t,e);if(!Array.isArray(o))throw Error(`appConfig: expected array at ${e.join(".")}`);return Object.freeze(o.map((o,t)=>{try{return a(o)}catch(a){throw Error(`appConfig: invalid row at ${e.join(".")}[${t}]: ${a.message}`)}}))}function d(e){if("string"!=typeof e.id||"string"!=typeof e.label||"string"!=typeof e.hint)throw Error("expected { id, label, hint } strings");let a="boolean"==typeof e.vision?e.vision:void 0;return Object.freeze({id:e.id,label:e.label,hint:e.hint,...void 0!==a?{vision:a}:{}})}let c=Object.freeze({tmdb:Object.freeze({baseUrl:r(["dal","tmdb","baseUrl"],"TMDB_BASE_URL"),imageBaseUrl:r(["dal","tmdb","imageBaseUrl"],"TMDB_IMAGE_BASE_URL"),defaultTtlMs:l(["dal","tmdb","defaultTtlMs"],"TMDB_DEFAULT_TTL_MS")}),wikipedia:Object.freeze({contentBaseUrl:r(["dal","wikipedia","contentBaseUrl"],"WIKIPEDIA_CONTENT_BASE_URL"),analyticsBaseUrl:r(["dal","wikipedia","analyticsBaseUrl"],"WIKIPEDIA_ANALYTICS_BASE_URL"),defaultTtlMs:l(["dal","wikipedia","defaultTtlMs"],"WIKIPEDIA_DEFAULT_TTL_MS")}),sunriseSunset:Object.freeze({baseUrl:r(["dal","sunriseSunset","baseUrl"],"SUNRISE_SUNSET_BASE_URL"),defaultTtlMs:l(["dal","sunriseSunset","defaultTtlMs"],"SUNRISE_SUNSET_DEFAULT_TTL_MS")}),openLibrary:Object.freeze({searchUrl:r(["dal","openLibrary","searchUrl"],"OPEN_LIBRARY_SEARCH_URL"),coverBaseUrl:r(["dal","openLibrary","coverBaseUrl"],"OPEN_LIBRARY_COVER_BASE_URL"),defaultTtlMs:l(["dal","openLibrary","defaultTtlMs"],"OPEN_LIBRARY_DEFAULT_TTL_MS")}),coinGecko:Object.freeze({baseUrl:r(["dal","coinGecko","baseUrl"],"COINGECKO_BASE_URL"),defaultTtlMs:l(["dal","coinGecko","defaultTtlMs"],"COINGECKO_DEFAULT_TTL_MS")}),openMeteo:Object.freeze({baseUrl:r(["dal","openMeteo","baseUrl"],"OPEN_METEO_BASE_URL"),defaultTtlMs:l(["dal","openMeteo","defaultTtlMs"],"OPEN_METEO_DEFAULT_TTL_MS")}),hn:Object.freeze({algoliaBaseUrl:r(["dal","hn","algoliaBaseUrl"],"HN_ALGOLIA_BASE_URL"),firebaseBaseUrl:r(["dal","hn","firebaseBaseUrl"],"HN_FIREBASE_BASE_URL"),defaultTtlMs:l(["dal","hn","defaultTtlMs"],"HN_DEFAULT_TTL_MS")}),github:Object.freeze({baseUrl:r(["dal","github","baseUrl"],"GITHUB_BASE_URL"),defaultTtlMs:l(["dal","github","defaultTtlMs"],"GITHUB_DEFAULT_TTL_MS")}),rss:Object.freeze({baseUrl:r(["dal","rss","baseUrl"],"RSS_BASE_URL"),defaultTtlMs:l(["dal","rss","defaultTtlMs"],"RSS_DEFAULT_TTL_MS")}),ipma:Object.freeze({baseUrl:r(["dal","ipma","baseUrl"],"IPMA_BASE_URL"),defaultTtlMs:l(["dal","ipma","defaultTtlMs"],"IPMA_DEFAULT_TTL_MS")}),usgs:Object.freeze({baseUrl:r(["dal","usgs","baseUrl"],"USGS_BASE_URL"),defaultTtlMs:l(["dal","usgs","defaultTtlMs"],"USGS_DEFAULT_TTL_MS")}),whereIsTheIss:Object.freeze({baseUrl:r(["dal","whereIsTheIss","baseUrl"],"WHERE_IS_THE_ISS_BASE_URL"),defaultTtlMs:l(["dal","whereIsTheIss","defaultTtlMs"],"WHERE_IS_THE_ISS_DEFAULT_TTL_MS")}),tle:Object.freeze({baseUrl:r(["dal","tle","baseUrl"],"TLE_BASE_URL"),defaultTtlMs:l(["dal","tle","defaultTtlMs"],"TLE_DEFAULT_TTL_MS")}),groq:Object.freeze({chatCompletionsUrl:r(["dal","groq","chatCompletionsUrl"],"GROQ_CHAT_COMPLETIONS_URL"),defaultModel:r(["dal","groq","defaultModel"],"GROQ_DEFAULT_MODEL"),models:s(["dal","groq","models"],d)}),gemini:Object.freeze({baseUrl:r(["dal","gemini","baseUrl"],"GEMINI_BASE_URL"),defaultModel:r(["dal","gemini","defaultModel"],"GEMINI_DEFAULT_MODEL"),models:s(["dal","gemini","models"],d)}),pollinations:Object.freeze({imageBaseUrl:r(["dal","pollinations","imageBaseUrl"],"POLLINATIONS_IMAGE_BASE_URL"),defaultModel:r(["dal","pollinations","defaultModel"],"POLLINATIONS_DEFAULT_MODEL"),models:s(["dal","pollinations","models"],function(e){if("string"!=typeof e.id||"string"!=typeof e.label)throw Error("expected { id, label } strings");return Object.freeze({id:e.id,label:e.label})})}),noaaSwpc:Object.freeze({baseUrl:r(["dal","noaaSwpc","baseUrl"],"NOAA_SWPC_BASE_URL"),defaultTtlMs:l(["dal","noaaSwpc","defaultTtlMs"],"NOAA_SWPC_DEFAULT_TTL_MS")}),nasaEonet:Object.freeze({baseUrl:r(["dal","nasaEonet","baseUrl"],"NASA_EONET_BASE_URL"),defaultTtlMs:l(["dal","nasaEonet","defaultTtlMs"],"NASA_EONET_DEFAULT_TTL_MS")}),airplanesLive:Object.freeze({baseUrl:r(["dal","airplanesLive","baseUrl"],"AIRPLANES_LIVE_BASE_URL"),defaultTtlMs:l(["dal","airplanesLive","defaultTtlMs"],"AIRPLANES_LIVE_DEFAULT_TTL_MS")}),rainViewer:Object.freeze({manifestUrl:r(["dal","rainViewer","manifestUrl"],"RAIN_VIEWER_MANIFEST_URL"),defaultTtlMs:l(["dal","rainViewer","defaultTtlMs"],"RAIN_VIEWER_DEFAULT_TTL_MS")}),npms:Object.freeze({baseUrl:r(["dal","npms","baseUrl"],"NPMS_BASE_URL"),defaultTtlMs:l(["dal","npms","defaultTtlMs"],"NPMS_DEFAULT_TTL_MS")}),npmRegistry:Object.freeze({baseUrl:r(["dal","npmRegistry","baseUrl"],"NPM_REGISTRY_BASE_URL"),defaultTtlMs:l(["dal","npmRegistry","defaultTtlMs"],"NPM_REGISTRY_DEFAULT_TTL_MS")}),devTo:Object.freeze({baseUrl:r(["dal","devTo","baseUrl"],"DEV_TO_BASE_URL"),defaultTtlMs:l(["dal","devTo","defaultTtlMs"],"DEV_TO_DEFAULT_TTL_MS")}),stackExchange:Object.freeze({baseUrl:r(["dal","stackExchange","baseUrl"],"STACK_EXCHANGE_BASE_URL"),defaultTtlMs:l(["dal","stackExchange","defaultTtlMs"],"STACK_EXCHANGE_DEFAULT_TTL_MS")}),itunesSearch:Object.freeze({baseUrl:r(["dal","itunesSearch","baseUrl"],"ITUNES_SEARCH_BASE_URL"),defaultTtlMs:l(["dal","itunesSearch","defaultTtlMs"],"ITUNES_SEARCH_DEFAULT_TTL_MS")})}),m=Object.freeze({lisbon:Object.freeze({lat:l(["locations","lisbon","lat"],"LOCATION_LISBON_LAT"),lon:l(["locations","lisbon","lon"],"LOCATION_LISBON_LON"),label:r(["locations","lisbon","label"],"LOCATION_LISBON_LABEL"),timezone:r(["locations","lisbon","timezone"],"LOCATION_LISBON_TIMEZONE")})})},87330(e,a,o){o.d(a,{FlyoutPanel:()=>eR});var t=o(65723),n=o(37991),i=o.n(n),r=o(36859),l=o.n(r),s=o(72799),d=o(81316),c=o(40814),m=o(36896),g=o(87902),u=o(53013),f=o(32887),p=o(49510),b=o(39848),h=o(37901),y=o(3045),z=o(43775),x=o(41783),w=o(83539),A=o(39416),v=o(1837),T=o(57167),k=o(84494),M=o(82314),$=o(20255),S=o(35751),E=o(69633),_=o(92946),L=o(40822),B=o(36720),U=o(57400),j=o(58456),R=o(43317),I=o(52709),C=o(8006),P=o(89301),N=o(37561),F=o(83517),O=o(28207),D=o(37032),G=o(6949),H=o(8218),K=o(36829),V=o(59591),Y=o(15553),W=o(69923),J=o(72820),Z=o(14621),q=o(68479),X=o(72534),Q=o(66673),ee=o(67490),ea=o(49033),eo=o(99038),et=o(45775),en=o(31365),ei=o(74893),er=o(62937),el=o(9821),es=o(65912),ed=o(80158),ec=o(88641),em=o(48607),eg=o(83249),eu=o(1821),ef=o(15889),ep=o(89655),eb=o(27170),eh=o(19161),ey=o(71849),ez=o(41604),ex=o(13142),ew=o(61187),eA=o(77747),ev=o(2932),eT=o(24525),ek=o(57230),eM=o(22164);let e$={activity:m.A,"a-large-small":g.A,apple:u.A,"arrow-right":f.A,"bar-chart-2":p.A,book:b.A,"book-open":h.A,briefcase:y.A,calendar:z.A,clock:x.A,"circle-dot":w.A,cloud:A.A,compass:v.A,cpu:T.A,droplets:k.A,feather:M.A,file:$.A,"file-text":S.A,folder:E.A,"git-branch":_.A,github:L.A,globe:B.A,grid:U.A,hand:j.A,hash:R.A,heart:I.A,key:C.A,hexagon:P.A,home:N.A,landmark:F.A,layers:O.A,"layout-grid":D.A,leaf:G.A,lightbulb:H.A,list:K.A,map:V.A,"map-pin":Y.A,"message-circle":W.A,"message-square":J.A,minus:Z.A,monitor:q.A,mountain:X.A,package:Q.A,palette:ee.A,"pen-tool":ea.A,"pie-chart":eo.A,plane:et.A,plus:en.A,puzzle:ei.A,ruler:er.A,shirt:el.A,slash:es.A,square:ed.A,star:ec.A,sun:em.A,terminal:eg.A,thermometer:eu.A,triangle:ef.A,trophy:ep.A,truck:eb.A,type:eh.A,users:ey.A,"volume-2":ez.A,watch:ex.A,waves:ew.A,wind:eA.A,wrench:ev.A,x:eT.A,zap:ek.A,bot:eM.A},eS=(0,s.keyframes)`
...
`,eB=({size:e=14,strokeWidth:a=1.75})=>(0,t.jsxs)("svg",{width:e,height:e,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:a,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,t.jsx)("polyline",{points:"14 2 14 8 20 8"})]});function eU({iconKey:e}){let a=e?e$[e]:null;return a?(0,t.jsx)(a,{size:14,strokeWidth:1.75}):(0,t.jsx)(eB,{})}function ej({entries:e,activeId:a,onSelect:o}){return(0,t.jsx)(t.Fragment,{children:e.map(e=>e.children?(0,t.jsx)(i().Fragment,{children:(0,t.jsx)(ej,{entries:e.children,activeId:a,onSelect:o})},e.id):(0,t.jsxs)(eL,{active:a===e.id,onClick:()=>o(e),children:[(0,t.jsx)(eU,{iconKey:e.icon}),e.name]},e.id))})}function eR({activeId:e}){let{flyout:a,scheduleFlyoutClose:o,cancelFlyoutClose:n}=(0,c.c)();if(!a)return null;let i=a.entry.icon?e$[a.entry.icon]:null;return(0,t.jsxs)(eE,{anchorY:a.anchorY,onMouseEnter:n,onMouseLeave:o,children:[(0,t.jsxs)(e_,{children:[i?(0,t.jsx)(i,{size:13,strokeWidth:2}):(0,t.jsx)(eB,{size:13,strokeWidth:2}),a.entry.name]}),(0,t.jsx)(ej,{entries:a.entry.children??[],activeId:e,onSelect:e=>{a.onSelect(e),o()}})]})}},40814(e,a,o){o.d(a,{I:()=>n,c:()=>i});var t=o(37991);let n=(0,t.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),i=()=>(0,t.useContext)(n)},89874(e,a,o){o.d(a,{jv:()=>K.listSettingsByPrefix,NP:()=>C,Fm:()=>K.setStorageProvider,Iu:()=>K.listDocs,TM:()=>ee,eP:()=>P,PL:()=>K.getSetting,xx:()=>ec,VJ:()=>ea,UW:()=>H,Is:()=>K.putSetting,sW:()=>K.clearSettingsByPrefix,PE:()=>_,bg:()=>K.deleteLocalSetting,w4:()=>t.w4});var t=o(81316),n=o(65723),i=o(37991),r=o.n(i),l=o(36859),s=o.n(l);s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,s().div`
  position: relative;
`;var d=o(72799),c=o(40814);let m="260px",g="56px",u="48px",f=s().header`
  display: flex;
  align-items: center;
...
`,M=s().main`
  ...
  display: flex;
  flex-direction: column;
`,$=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function S(){return(0,n.jsx)(y,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:$.map((e,a)=>(0,n.jsx)(z,{index:a,accent:e.accent,children:e.char},a))})}let E="atlantis:sidebar-collapsed";function _({sidebar:e,children:a,topBarRight:t,title:l="Atlantis",activeId:s=null}){let[d,m]=(0,i.useState)(()=>{try{return"true"===localStorage.getItem(E)}catch{return!1}}),[g,u]=(0,i.useState)(null),h=(0,i.useRef)(),y=()=>m(e=>{let a=!e;try{localStorage.setItem(E,String(a))}catch{}return a}),z=r().useMemo(()=>r().lazy(()=>Promise.resolve().then(o.bind(o,87330)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,n.jsx)(c.I.Provider,{value:{collapsed:d,toggle:y,flyout:g,openFlyout:(e,a,o)=>{clearTimeout(h.current),u({entry:e,anchorY:a,onSelect:o})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>u(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,n.jsxs)(v,{children:[(0,n.jsxs)(f,{children:[e&&(0,n.jsx)(p,{children:(0,n.jsx)(b,{onClick:y,title:d?"Expand sidebar":"Collapse sidebar",children:(0,n.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,n.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,n.jsx)("path",{d:"M9 3v18"})]})})}),(0,n.jsx)(S,{}),l&&(0,n.jsx)(x,{children:l}),t&&(0,n.jsx)(w,{children:t})]}),(0,n.jsxs)(A,{children:[null!=e&&(0,n.jsx)(T,{collapsed:d,children:(0,n.jsx)(k,{children:e})}),(0,n.jsx)(M,{children:a})]}),g&&(0,n.jsx)(r().Suspense,{fallback:null,children:(0,n.jsx)(z,{activeId:s})})]})})}s().div`
  display: grid;
...
`,o(87330);let B=(0,i.createContext)({mode:"dark",resolvedMode:"dark",setMode:()=>{}}),U="atlantis:theme-mode";function j(){return"u"<typeof window?"dark":window.matchMedia("(prefers-color-scheme: light)").matches?"light":"dark"}let R="atlantis-webfonts";function I({resolvedMode:e}){let a=(0,i.useMemo)(()=>(0,t.EE)(e),[e]);return(0,n.jsx)(d.Global,{styles:(0,d.css)`
        :root {
          ${a}
        }
      ...
      `})}function C({children:e}){let[a,o]=(0,i.useState)(()=>{try{let e=localStorage.getItem(U);if("dark"===e||"light"===e||"system"===e)return e}catch{}return"dark"}),[t,r]=(0,i.useState)(()=>"system"===a?j():a),l=(0,i.useCallback)(e=>{o(e);try{localStorage.setItem(U,e)}catch{}},[]);(0,i.useEffect)(()=>{if("system"!==a)return void r(a);r(j());let e=window.matchMedia("(prefers-color-scheme: light)"),o=e=>{r(e.matches?"light":"dark")};return e.addEventListener("change",o),()=>e.removeEventListener("change",o)},[a]),(0,i.useEffect)(()=>{document.documentElement.setAttribute("data-theme",t)},[t]),(0,i.useEffect)(()=>{!function(){if("u"<typeof document||document.getElementById(R))return;let e=document.createElement("link");e.id=R,e.rel="stylesheet",e.href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&family=JetBrains+Mono:wght@400;500;600&family=Cormorant+Garamond:wght@400;500;600;700&display=swap",document.head.appendChild(e)}()},[]);let s=(0,i.useMemo)(()=>({mode:a,resolvedMode:t,setMode:l}),[a,t,l]);return(0,n.jsxs)(B.Provider,{value:s,children:[(0,n.jsx)(I,{resolvedMode:t}),e]})}function P(){return(0,i.useContext)(B)}let N=s().button`
  display: flex;
  align-items: center;
  justify-content: center;
  width: 32px;
...
`,Q=s().button`
  ...
  background: ${({primary:e,danger:a})=>a?t.w4.colors.danger:e?t.w4.colors.accent:"transparent"};
  color: ${({primary:e,danger:a})=>a||e?"#fff":t.w4.colors.mainText};
  border: 1px solid
    ${({primary:e,danger:a})=>a?t.w4.colors.danger:e?t.w4.colors.accent:t.w4.colors.border};

  &:hover { opacity: 0.88; }
  &:focus-visible { ${t.w4.focusRing} }
`;function ee({open:e,title:a,message:o,confirmLabel:t,cancelLabel:r,onConfirm:l,onCancel:s,danger:d=!1}){return((0,i.useEffect)(()=>{if(!e)return;let a=e=>{"Escape"===e.key&&s(),"Enter"===e.key&&l()};return document.addEventListener("keydown",a),()=>document.removeEventListener("keydown",a)},[e,s,l]),e)?(0,n.jsx)(W,{onClick:s,role:"dialog","aria-modal":"true","aria-label":a,children:(0,n.jsxs)(J,{danger:d,onClick:e=>e.stopPropagation(),children:[(0,n.jsx)(Z,{danger:d,children:a}),(0,n.jsx)(q,{children:o}),(0,n.jsxs)(X,{children:[(0,n.jsx)(Q,{onClick:s,children:r}),(0,n.jsx)(Q,{danger:d,primary:!d,onClick:l,autoFocus:!0,children:t})]})]})}):null}function ea(e,a){let o=a?Object.entries(a).filter(([,e])=>void 0!==e&&""!==e).map(([e,a])=>`${encodeURIComponent(e)}=${encodeURIComponent(String(a))}`).join("&"):"";window.location.hash=o?`#/${e}?${o}`:`#/${e}`}s().div`
  position: relative;
`,s().button`
  display: flex;
  align-items: center;
