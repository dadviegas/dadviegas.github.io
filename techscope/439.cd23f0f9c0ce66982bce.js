...
`},4914(e,a,o){o.d(a,{FlyoutPanel:()=>h});var n=o(7359),t=o(3233),i=o(7207),r=o(255),l=o(217),s=o(5959),d=o(5185),c=o(5723);const m=i.keyframes`
...
`;function f({iconKey:e}){const a=e?d.t[e]??r.A:r.A;return(0,c.jsx)(a,{size:14,strokeWidth:1.75})}function y({entries:e,activeId:a,onSelect:o}){return(0,c.jsx)(c.Fragment,{children:e.map(e=>e.children?(0,c.jsx)(n.Fragment,{children:(0,c.jsx)(y,{entries:e.children,activeId:a,onSelect:o})},e.id):(0,c.jsxs)(p,{active:a===e.id,onClick:()=>o(e),children:[(0,c.jsx)(f,{iconKey:e.icon}),e.name]},e.id))})}function h({activeId:e}){const{flyout:a,scheduleFlyoutClose:o,cancelFlyoutClose:n}=(0,s.c)();if(!a)return null;const t=a.entry.icon?d.t[a.entry.icon]??r.A:r.A;return(0,c.jsxs)(g,{anchorY:a.anchorY,onMouseEnter:n,onMouseLeave:o,children:[(0,c.jsxs)(u,{children:[(0,c.jsx)(t,{size:13,strokeWidth:2}),a.entry.name]}),(0,c.jsx)(y,{entries:a.entry.children??[],activeId:e,onSelect:e=>{a.onSelect(e),o()}})]})}},5959(e,a,o){o.d(a,{I:()=>t,c:()=>i});var n=o(7359);const t=(0,n.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),i=()=>(0,n.useContext)(t)},5185(e,a,o){o.d(a,{t:()=>V});var n=o(9510),t=o(9038),i=o(8207),r=o(6896),l=o(7901),s=o(9848),d=o(2164),c=o(3775),m=o(3539),g=o(1783),u=o(1837),p=o(2314),f=o(5751),y=o(255),h=o(9633),x=o(2946),z=o(822),b=o(6720),w=o(3317),A=o(2709),$=o(3517),v=o(7032),k=o(6949),j=o(8218),S=o(6829),M=o(5553),T=o(9591),B=o(2820),P=o(4621),E=o(6673),F=o(9033),R=o(1365),C=o(5912),D=o(8641),L=o(3249),I=o(1821),N=o(9161),_=o(1849),K=o(7747),H=o(2932),G=o(4525),U=o(7230);const V={activity:r.A,"bar-chart-2":n.A,book:s.A,"book-open":l.A,calendar:c.A,clock:g.A,"circle-dot":m.A,feather:p.A,"file-text":f.A,globe:b.A,hash:w.A,heart:A.A,landmark:$.A,layers:i.A,leaf:k.A,map:T.A,package:E.A,compass:u.A,"git-branch":x.A,github:z.A,minus:P.A,terminal:L.A,thermometer:I.A,users:_.A,wind:K.A,"pie-chart":t.A,plus:R.A,slash:C.A,star:D.A,zap:U.A,bot:d.A,lightbulb:j.A,"message-square":B.A,wrench:H.A,x:G.A,"layout-grid":v.A,list:S.A,file:y.A,folder:h.A,"map-pin":M.A,"pen-tool":F.A,type:N.A}},4191(e,a,o){o.d(a,{PE:()=>$,CD:()=>I,PL:()=>J,Is:()=>O,w4:()=>n.w4});var n=o(217),t=o(7359),i=o(3233),r=o(5723);i.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,w=i.default.main`
  ...
  display: flex;
  flex-direction: column;
`,A="atlantis:sidebar-collapsed";function $({sidebar:e,children:a,topBarRight:n,title:i="Atlantis",activeId:d=null}){const[c,$]=(0,t.useState)(()=>{try{return"true"===localStorage.getItem(A)}catch{return!1}}),[v,k]=(0,t.useState)(null),j=(0,t.useRef)(),S=()=>$(e=>{const a=!e;try{localStorage.setItem(A,String(a))}catch{}return a}),M=t.useMemo(()=>t.lazy(()=>Promise.resolve().then(o.bind(o,4914)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(s.I.Provider,{value:{collapsed:c,toggle:S,flyout:v,openFlyout:(e,a,o)=>{clearTimeout(j.current),k({entry:e,anchorY:a,onSelect:o})},scheduleFlyoutClose:()=>{j.current=setTimeout(()=>k(null),160)},cancelFlyoutClose:()=>clearTimeout(j.current)},children:(0,r.jsxs)(x,{children:[(0,r.jsxs)(m,{children:[e&&(0,r.jsx)(g,{children:(0,r.jsx)(u,{onClick:S,title:c?"Expand sidebar":"Collapse sidebar",children:(0,r.jsx)(l.A,{size:17})})}),(0,r.jsxs)(p,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:["Atl",(0,r.jsx)("span",{children:"antis"})]}),i&&(0,r.jsx)(f,{children:i}),n&&(0,r.jsx)(y,{children:n})]}),(0,r.jsxs)(h,{children:[null!=e&&(0,r.jsx)(z,{collapsed:c,children:(0,r.jsx)(b,{children:e})}),(0,r.jsx)(w,{children:a})]}),v&&(0,r.jsx)(t.Suspense,{fallback:null,children:(0,r.jsx)(M,{activeId:d})})]})})}var v=o(255),k=o(9753),j=o(5185);const S=i.default.div`
  display: grid;
...
`;function D({iconKey:e,size:a=16}){if(e&&!(e in j.t))return(0,r.jsx)("span",{style:{fontSize:a,lineHeight:1,display:"flex",alignItems:"center"},children:e});const o=e?j.t[e]??v.A:v.A;return(0,r.jsx)(o,{size:a,strokeWidth:1.75})}function L({entry:e,activeId:a,onSelect:o}){const[n,i]=(0,t.useState)(e.defaultOpen??!0),{collapsed:l,openFlyout:d,scheduleFlyoutClose:c,cancelFlyoutClose:m}=(0,s.c)();return e.children&&e.children.length>0?(0,r.jsxs)(B,{children:[(0,r.jsxs)(P,{collapsed:l,onClick:()=>{l||i(e=>!e)},onMouseEnter:l?a=>{const n=a.currentTarget.getBoundingClientRect();d(e,n.top,o)}:void 0,onMouseLeave:l?c:void 0,children:[(0,r.jsxs)(E,{collapsed:l,children:[(0,r.jsx)(D,{iconKey:e.icon,size:16}),(0,r.jsx)(F,{collapsed:l,children:e.name})]}),(0,r.jsx)(R,{open:n,collapsed:l,children:(0,r.jsx)(k.A,{size:13})})]}),(0,r.jsx)(S,{open:n&&!l,children:(0,r.jsx)(M,{children:(0,r.jsx)(T,{children:e.children.map(e=>(0,r.jsx)(L,{entry:e,activeId:a,onSelect:o},e.id))})})})]}):(0,r.jsxs)(C,{active:a===e.id,collapsed:l,onClick:()=>o(e),onMouseEnter:l?a=>{const n=a.currentTarget.getBoundingClientRect();d({id:e.id,name:e.name,icon:e.icon,file:e.file,children:[e]},n.top,o)}:void 0,onMouseLeave:l?c:void 0,children:[(0,r.jsx)(D,{iconKey:e.icon,size:15}),(0,r.jsx)(F,{collapsed:l,children:e.name})]})}function I({entries:e,activeId:a,onSelect:o}){return(0,r.jsx)("div",{children:e.map(e=>(0,r.jsx)(L,{entry:e,activeId:a,onSelect:o},e.id))})}const N=o(7207).keyframes`
...
`,o(4914);var _=o(1920),K=o(8607),H=o(8479);i.default.button`
  display: flex;
  align-items: center;
  justify-content: center;
  width: 32px;
...
`,$=t.default.div`
  ...
  margin: 2px 0;
`;function v({t:e}){const a=`https://hn.algolia.com/api/v1/search?query=AI+LLM+model+open+source&tags=story&hitsPerPage=8&numericFilters=created_at_i>${Math.floor((Date.now()-1728e5)/1e3)}`,{data:o,loading:t,lastUpdated:s,refresh:v}=(0,c.st)(a),k=o?.hits??[];return(0,g.jsxs)("div",{children:[(0,g.jsx)(m.X,{title:e("nav.aiRadar"),color:u,lastUpdated:s,loading:t,onRefresh:v,t:e}),k.length?(0,g.jsx)(p,{children:k.map((a,o)=>{const t=a.url??`https://news.ycombinator.com/item?id=${a.objectID}`;return(0,g.jsxs)(n.Fragment,{children:[o>0&&(0,g.jsx)($,{}),(0,g.jsxs)(f,{href:t,target:"_blank",rel:"noopener noreferrer",children:[(0,g.jsxs)(y,{children:[(0,g.jsx)(h,{children:(0,g.jsx)(i.A,{size:12})}),a.title]}),(0,g.jsxs)(x,{children:[(0,g.jsxs)(z,{children:[(0,g.jsx)(l.A,{size:11}),a.points??0]}),(0,g.jsxs)(b,{children:[(0,g.jsx)(r.A,{size:11}),a.num_comments??0]}),(0,g.jsx)(w,{children:(0,c.FB)(a.url)}),(0,g.jsx)("span",{style:{marginLeft:"auto"},children:(0,d.aw)(a.created_at,e)})]})]})]},a.objectID)})}):(0,g.jsx)(A,{children:e(t?"aiRadar.loading":"aiRadar.empty")})]})}},7401(e,a,o){o.d(a,{A:()=>M}),o(7359);var n=o(3233),t=o(5046),i=o(8641),r=o(4191),l=o(894),s=o(8447),d=o(7454),c=o(5723);const m="#bc8cff",g={TypeScript:"#3178c6",JavaScript:"#f1e05a",Python:"#3572A5",Go:"#00ADD8",Rust:"#dea584",Java:"#b07219","C++":"#f34b7d","C#":"#178600",Ruby:"#701516",Swift:"#F05138",Kotlin:"#A97BFF",Shell:"#89e051",HTML:"#e34c26",CSS:"#563d7c",Dart:"#00B4AB",Zig:"#ec915c",Nix:"#7e7eff",Lua:"#000080"},u=n.default.div`
  display: grid;
...
`,b=n.default.div`
  ...
  font-size: ${i.w4.typography.fontSizeSm};
  text-align: center;
`;function w({t:e}){const a=`https://api.github.com/search/repositories?q=created:>${(0,r.VF)(7)}&sort=stars&order=desc&per_page=8`,{data:o,loading:n,lastUpdated:i,refresh:c}=(0,r.st)(a);return(0,s.jsxs)("div",{children:[(0,s.jsx)(l.X,{title:e("nav.livePulse"),color:d,lastUpdated:i,loading:n,onRefresh:c,t:e}),o?.items?.length?(0,s.jsx)(m,{children:o.items.map(a=>(0,s.jsxs)(g,{href:a.html_url,target:"_blank",rel:"noopener noreferrer",children:[(0,s.jsx)(u,{title:a.full_name,children:a.full_name}),(0,s.jsx)(p,{children:a.description??e("noDescription")}),(0,s.jsxs)(f,{children:[a.language&&(0,s.jsxs)(s.Fragment,{children:[(0,s.jsx)(h,{lang:a.language}),(0,s.jsx)(x,{children:a.language})]}),(0,s.jsx)(z,{}),(0,s.jsxs)(y,{children:[(0,s.jsx)(t.A,{size:12}),(0,r.Bz)(a.stargazers_count)]})]})]},a.id))}):(0,s.jsx)(b,{children:e(n?"livePulse.loading":"noData")})]})}},3019(e,a,o){o.d(a,{A:()=>x}),o(7359);var n=o(3233),t=o(4191),i=o(8447),r=o(7454),l=o(5723);const s="#f97316",d=["react","typescript","lodash","axios","express","next","vue","vite","tailwindcss","eslint","prettier","webpack"].join(","),c=n.default.div`
  display: flex;
  flex-direction: column;
  gap: 6px;
`,m=n.default.a`
...
`,h=n.default.div`
  ...
  font-size: ${t.w4.typography.fontSizeSm};
  text-align: center;
`;function x({t:e}){const a=`https://api.npmjs.org/downloads/point/last-week/${d}`,{data:o,loading:n,lastUpdated:t,refresh:x}=(0,i.st)(a),z=o?Object.values(o).filter(e=>e.downloads>0).map(e=>({name:e.package,downloads:e.downloads})).sort((e,a)=>a.downloads-e.downloads):[],b=z[0]?.downloads??1;return(0,l.jsxs)("div",{children:[(0,l.jsx)(r.X,{title:e("nav.npmPulse"),color:s,lastUpdated:t,loading:n,onRefresh:x,t:e}),z.length?(0,l.jsx)(c,{children:z.map((a,o)=>{return(0,l.jsxs)(m,{href:`https://www.npmjs.com/package/${a.name}`,target:"_blank",rel:"noopener noreferrer",children:[(0,l.jsx)(g,{children:o+1}),(0,l.jsx)(u,{children:a.name}),(0,l.jsx)(p,{children:(0,l.jsx)(f,{pct:Math.round(a.downloads/b*100)})}),(0,l.jsxs)(y,{children:[(n=a.downloads,n>=1e9?`${(n/1e9).toFixed(1)}B`:n>=1e6?`${(n/1e6).toFixed(1)}M`:n>=1e3?`${(n/1e3).toFixed(1)}k`:String(n))," ",e("perWeek")]})]},a.name);var n})}):(0,l.jsx)(h,{children:e(n?"npm.loading":"noData")})]})}},7454(e,a,o){o.d(a,{X:()=>h}),o(7359);var n=o(3233),t=o(7207),i=o(9421),r=o(4191),l=o(894),s=o(5723);const d=t.keyframes`
  0%, 100% { opacity: 1; }
  50% { opacity: 0.3; }
`,c=t.keyframes`
...
`;function h({title:e,color:a,lastUpdated:o,loading:n,onRefresh:t,t:r}){const d=o?(0,l.lw)(o,r):null;return(0,s.jsxs)(m,{children:[(0,s.jsxs)(g,{children:[(0,s.jsx)(u,{color:a}),(0,s.jsx)(p,{children:e})]}),d&&(0,s.jsx)(f,{children:r("updated",{age:d})}),(0,s.jsx)(y,{spinning:n,onClick:t,title:r("refresh"),children:(0,s.jsx)(i.A,{size:13})})]})}},7018(e,a,o){o.d(a,{A:()=>A}),o(7359);var n=o(3233),t=o(2820),i=o(4368),r=o(4191),l=o(8447),s=o(7454),d=o(5723);const c="#d29922",m=n.default.ol`
  list-style: none;
  display: flex;
  flex-direction: column;
  gap: 2px;
