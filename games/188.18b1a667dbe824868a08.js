...
`,R=n.default.h1`
  ...
  animation: ${W} 0.5s ease both, ${F} 6s linear infinite;
`,G=n.default.p`
  ...
  position: relative;
  z-index: 1;
  animation: ${W} 0.5s ease 0.1s both;
`,Y=n.default.div`
  display: grid;
  ...
  position: relative;
  z-index: 1;
  animation: ${W} 0.5s ease 0.2s both;
...
`,V=n.default.div`
  ...
  position: relative;
  z-index: 1;
  animation: ${W} 0.5s ease 0.15s both;
`,N=n.default.button`
  padding: 8px 16px;
  border-radius: 20px;
...
`,Z=n.default.div`
  ...
  align-items: center;
  gap: ${s.w4.spacing.sm};
`,ee=[{x:3,y:5,size:1.5,delay:0,dur:3.2},{x:8,y:35,size:2,delay:1.8,dur:3.4},{x:12,y:70,size:1.5,delay:.6,dur:4.1},{x:18,y:15,size:2.5,delay:2.4,dur:3},{x:22,y:55,size:1.5,delay:.3,dur:4.5},{x:28,y:88,size:2,delay:1.1,dur:3.6},{x:33,y:25,size:1.5,delay:2.8,dur:4},{x:40,y:60,size:2,delay:.9,dur:3.3},{x:45,y:8,size:2.5,delay:1.5,dur:3.8},{x:50,y:45,size:1.5,delay:2.1,dur:4.3},{x:55,y:78,size:2,delay:.4,dur:3.1},{x:60,y:18,size:1.5,delay:1.7,dur:4.6},{x:65,y:50,size:2.5,delay:2.6,dur:3.5},{x:70,y:85,size:1.5,delay:.2,dur:3.9},{x:75,y:30,size:2,delay:1.3,dur:4.2},{x:80,y:65,size:1.5,delay:2.9,dur:3.7},{x:85,y:10,size:2,delay:.7,dur:3.4},{x:88,y:42,size:2.5,delay:1.9,dur:4.4},{x:92,y:75,size:1.5,delay:.5,dur:3.2},{x:96,y:22,size:2,delay:2.3,dur:3.8}];function ae({topBarRight:e,isAuthenticated:a=!1}){const[t,o]=(0,i.useState)(S),[n,r]=(0,i.useState)("all"),[M]=(0,l.Ym)(),W="pt"===M?"pt":"en";if((0,i.useEffect)(()=>{const e=()=>o(S());return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[]),!t)return(0,C.jsx)(s.PE,{title:"pt"===W?"Jogos":"Games",sidebar:null,topBarRight:e,children:(0,C.jsxs)(L,{children:[ee.map((e,a)=>(0,C.jsx)(X,{x:e.x,y:e.y,size:e.size,delay:e.delay,dur:e.dur},a)),(0,C.jsx)(D,{top:15,delay:12}),(0,C.jsx)(D,{top:55,delay:25}),(0,C.jsx)(R,{children:"pt"===W?"Vamos jogar!":"Let’s play!"}),(0,C.jsx)(G,{children:"pt"===W?"Escolhe um jogo para começar":"Pick a game to get started"}),(0,C.jsxs)(V,{children:[(0,C.jsxs)(N,{active:"all"===n,onClick:()=>r("all"),children:["🎮 ","pt"===W?"Todos":"All"]}),(0,C.jsx)(N,{active:"online"===n,chipColor:"#3fb950",onClick:()=>r("online"),children:"🌐 Online"}),(0,C.jsxs)(N,{active:"multiplayer"===n,chipColor:"#d2a8ff",onClick:()=>r("multiplayer"),children:["👥 3+ ","pt"===W?"Jogadores":"Players"]}),(0,C.jsxs)(N,{active:"solo"===n,chipColor:"#f59e0b",onClick:()=>r("solo"),children:["🎯 ","pt"===W?"Sozinho":"Solo"]})]}),(0,C.jsx)(Y,{children:T.filter(e=>"online"===n?e.online:"multiplayer"===n?e.maxPlayers>=3:"solo"!==n||1===e.maxPlayers).map((e,t)=>(0,C.jsxs)(H,{accentColor:e.color,onClick:()=>{o(e.id),window.location.hash=e.hash},children:[a&&e.online&&(0,C.jsx)(_,{children:"🌐 Online"}),e.maxPlayers>1&&(0,C.jsxs)(K,{children:["👥 ",2===e.maxPlayers?"2":`2-${e.maxPlayers}`]}),(0,C.jsx)(q,{className:"card-emoji",delay:.4*t,children:e.emoji}),(0,C.jsx)(I,{children:e.label[W]}),(0,C.jsx)(Q,{children:e.description[W]})]},e.id))})]})});const E=(0,C.jsxs)(Z,{children:[(0,C.jsxs)(U,{onClick:()=>{o(null),window.location.hash="#/games"},children:["← ","pt"===W?"Jogos":"Games"]}),e]}),A=T.find(e=>e.id===t),F=()=>{o(null),window.location.hash="#/games"};if("lebem"===t)return(0,C.jsx)(s.PE,{title:"LêBem",sidebar:null,topBarRight:E,children:(0,C.jsx)(d.f,{onBack:F})});const O={tictactoe:(0,C.jsx)(p.t,{lang:W,onBack:F,canOnline:a}),soundhunter:(0,C.jsx)(c.m,{lang:W,onBack:F}),familyquiz:(0,C.jsx)(m.i,{lang:W,onBack:F,canOnline:a}),adventure:(0,C.jsx)(h.a,{lang:W,onBack:F}),missions:(0,C.jsx)(u.K,{lang:W,onBack:F}),pixelboard:(0,C.jsx)(x.H,{lang:W,onBack:F}),stopgame:(0,C.jsx)(y.z,{lang:W,onBack:F,canOnline:a}),spotit:(0,C.jsx)(g.O,{lang:W,onBack:F,canOnline:a}),memory:(0,C.jsx)(f.Y,{lang:W,onBack:F,canOnline:a}),tapit:(0,C.jsx)(b.n,{lang:W,onBack:F,canOnline:a}),jumpparty:(0,C.jsx)(w.v,{lang:W,onBack:F}),drawguess:(0,C.jsx)(k.c,{lang:W,onBack:F,canOnline:a}),animalarena:(0,C.jsx)(j.m,{lang:W,onBack:F}),crazykitchen:(0,C.jsx)($.A,{lang:W,onBack:F}),miniparty:(0,C.jsx)(z.k,{lang:W,onBack:F}),hideseek:(0,C.jsx)(v.p,{lang:W,onBack:F}),buttonmayhem:(0,C.jsx)(P.M,{lang:W,onBack:F}),bombbrawl:(0,C.jsx)(B.$,{lang:W,onBack:F,canOnline:a})};return(0,C.jsx)(s.PE,{title:A.title[W],sidebar:null,topBarRight:E,children:O[t]})}const te=document.getElementById("root");if(!te)throw new Error("Root element #root not found");(0,o.H)(te).render((0,C.jsx)(ae,{}))},8997(e,a,t){var o=t(8991);a.H=o.createRoot,o.hydrateRoot}}]);
//# sourceMappingURL=188.18b1a667dbe824868a08.js.map