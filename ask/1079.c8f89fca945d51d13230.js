"use strict";(self.webpackChunk_atlantis_ask=self.webpackChunk_atlantis_ask||[]).push([[1079],{30894(o,e,a){a.d(e,{Nx:()=>p,aw:()=>g,Ym:()=>c});var t=a(27359),r=a(26879);const n={"time.justNow":{en:"just now",pt:"agora mesmo"},"time.mAgo":{en:"{n}m ago",pt:"há {n}m"},"time.hAgo":{en:"{n}h ago",pt:"há {n}h"},"time.dAgo":{en:"{n}d ago",pt:"há {n}d"},updated:{en:"updated {age}",pt:"atualizado {age}"},refresh:{en:"Refresh",pt:"Atualizar"},loading:{en:"Loading…",pt:"A carregar…"},noData:{en:"No data available",pt:"Sem dados disponíveis"},noDescription:{en:"No description provided.",pt:"Sem descrição."},failedToFetch:{en:"Failed to fetch",pt:"Erro ao carregar"},perWeek:{en:"/ wk",pt:"/ sem"}},i="atlantis:locale",l="shell:locale";function s(o){return"en"===o||"pt"===o}function d(){try{const o=localStorage.getItem(i);if(s(o))return o}catch{}return"en"}function c(){const[o,e]=(0,t.useState)(d),a=(0,t.useCallback)(o=>{e(o),function(o){try{localStorage.setItem(i,o)}catch{}(0,r.Is)(l,o).catch(()=>{})}(o),window.dispatchEvent(new CustomEvent("atlantis:locale-change",{detail:o}))},[]);return(0,t.useEffect)(()=>{const o=o=>{const a=o.detail;e(a)};return window.addEventListener("atlantis:locale-change",o),()=>window.removeEventListener("atlantis:locale-change",o)},[]),(0,t.useEffect)(()=>{(0,r.PL)(l).then(a=>{if(s(a)&&a!==o){try{localStorage.setItem(i,a)}catch{}e(a)}}).catch(()=>{})},[]),[o,a]}function p(o,e){const a=e?{...n,...e}:n;return(e,t)=>{const r=a[e]?.[o]??e;return t?Object.entries(t).reduce((o,[e,a])=>o.replace(new RegExp(`\\{${e}\\}`,"g"),String(a)),r):r}}function g(o,e){const a=Date.now()-new Date(o).getTime(),t=Math.floor(a/6e4);if(t<1)return e("time.justNow");if(t<60)return e("time.mAgo",{n:t});const r=Math.floor(t/60);return r<24?e("time.hAgo",{n:r}):e("time.dAgo",{n:Math.floor(r/24)})}(0,r.PL)(l).then(o=>{if(s(o))try{localStorage.setItem(i,o)}catch{}}).catch(()=>{});var f=a(53233);a(65723),f.default.div`
  display: flex;
  gap: 4px;
...
`},74914(o,e,a){a.d(e,{FlyoutPanel:()=>h});var t=a(27359),r=a(53233),n=a(77207),i=a(20255),l=a(217),s=a(15959),d=a(65185),c=a(65723);const p=n.keyframes`
...
`;function u({iconKey:o}){const e=o?d.t[o]??i.A:i.A;return(0,c.jsx)(e,{size:14,strokeWidth:1.75})}function x({entries:o,activeId:e,onSelect:a}){return(0,c.jsx)(c.Fragment,{children:o.map(o=>o.children?(0,c.jsx)(t.Fragment,{children:(0,c.jsx)(x,{entries:o.children,activeId:e,onSelect:a})},o.id):(0,c.jsxs)(m,{active:e===o.id,onClick:()=>a(o),children:[(0,c.jsx)(u,{iconKey:o.icon}),o.name]},o.id))})}function h({activeId:o}){const{flyout:e,scheduleFlyoutClose:a,cancelFlyoutClose:t}=(0,s.c)();if(!e)return null;const r=e.entry.icon?d.t[e.entry.icon]??i.A:i.A;return(0,c.jsxs)(g,{anchorY:e.anchorY,onMouseEnter:t,onMouseLeave:a,children:[(0,c.jsxs)(f,{children:[(0,c.jsx)(r,{size:13,strokeWidth:2}),e.entry.name]}),(0,c.jsx)(x,{entries:e.entry.children??[],activeId:o,onSelect:o=>{e.onSelect(o),a()}})]})}},15959(o,e,a){a.d(e,{I:()=>r,c:()=>n});var t=a(27359);const r=(0,t.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),n=()=>(0,t.useContext)(r)},65185(o,e,a){a.d(e,{t:()=>yo});var t=a(49510),r=a(99038),n=a(57400),i=a(37561),l=a(28207),s=a(87902),d=a(36896),c=a(53013),p=a(32887),g=a(37901),f=a(39848),m=a(22164),u=a(3045),x=a(43775),h=a(83539),b=a(41783),y=a(39416),w=a(1837),$=a(57167),z=a(84494),v=a(82314),k=a(35751),M=a(20255),A=a(69633),T=a(92946),S=a(40822),j=a(36720),F=a(58456),B=a(43317),C=a(52709),P=a(89301),R=a(8006),E=a(83517),L=a(37032),H=a(6949),N=a(8218),I=a(36829),D=a(15553),Y=a(59591),G=a(69923),K=a(72820),V=a(14621),O=a(68479),W=a(72534),q=a(66673),_=a(67490),U=a(49033),Z=a(45775),J=a(31365),X=a(62937),Q=a(9821),oo=a(65912),eo=a(80158),ao=a(88641),to=a(48607),ro=a(83249),no=a(1821),io=a(15889),lo=a(89655),so=a(27170),co=a(19161),po=a(71849),go=a(41604),fo=a(13142),mo=a(61187),uo=a(77747),xo=a(2932),ho=a(24525),bo=a(57230);const yo={activity:d.A,"a-large-small":s.A,apple:c.A,"arrow-right":p.A,"bar-chart-2":t.A,book:f.A,"book-open":g.A,briefcase:u.A,calendar:x.A,clock:b.A,"circle-dot":h.A,cloud:y.A,compass:w.A,cpu:$.A,droplets:z.A,feather:v.A,file:M.A,"file-text":k.A,folder:A.A,"git-branch":T.A,github:S.A,globe:j.A,grid:n.A,hand:F.A,hash:B.A,heart:C.A,key:R.A,hexagon:P.A,home:i.A,landmark:E.A,layers:l.A,"layout-grid":L.A,leaf:H.A,lightbulb:N.A,list:I.A,map:Y.A,"map-pin":D.A,"message-circle":G.A,"message-square":K.A,minus:V.A,monitor:O.A,mountain:W.A,package:q.A,palette:_.A,"pen-tool":U.A,"pie-chart":r.A,plane:Z.A,plus:J.A,ruler:X.A,shirt:Q.A,slash:oo.A,square:eo.A,star:ao.A,sun:to.A,terminal:ro.A,thermometer:no.A,triangle:io.A,trophy:lo.A,truck:so.A,type:co.A,users:po.A,"volume-2":go.A,watch:fo.A,waves:mo.A,wind:uo.A,wrench:xo.A,x:ho.A,zap:bo.A,bot:m.A}},26879(o,e,a){a.d(e,{PE:()=>S,Zf:()=>q,kd:()=>D,PL:()=>G,Iu:()=>I,Is:()=>Y,hY:()=>W,KL:()=>H,w4:()=>t.w4,mZ:()=>N});var t=a(217),r=a(27359),n=a(53233),i=a(65723);n.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,k=n.default.main`
  ...
  display: flex;
  flex-direction: column;
`,M=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function A(){return(0,i.jsx)(x,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:M.map((o,e)=>(0,i.jsx)(h,{index:e,accent:o.accent,children:o.char},e))})}const T="atlantis:sidebar-collapsed";function S({sidebar:o,children:e,topBarRight:t,title:n="Atlantis",activeId:l=null}){const[c,p]=(0,r.useState)(()=>{try{return"true"===localStorage.getItem(T)}catch{return!1}}),[u,x]=(0,r.useState)(null),h=(0,r.useRef)(),M=()=>p(o=>{const e=!o;try{localStorage.setItem(T,String(e))}catch{}return e}),S=r.useMemo(()=>r.lazy(()=>Promise.resolve().then(a.bind(a,74914)).then(o=>({default:o.FlyoutPanel}))),[]);return(0,i.jsx)(d.I.Provider,{value:{collapsed:c,toggle:M,flyout:u,openFlyout:(o,e,a)=>{clearTimeout(h.current),x({entry:o,anchorY:e,onSelect:a})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>x(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,i.jsxs)($,{children:[(0,i.jsxs)(g,{children:[o&&(0,i.jsx)(f,{children:(0,i.jsx)(m,{onClick:M,title:c?"Expand sidebar":"Collapse sidebar",children:(0,i.jsx)(s.A,{size:17})})}),(0,i.jsx)(A,{}),n&&(0,i.jsx)(b,{children:n}),t&&(0,i.jsx)(y,{children:t})]}),(0,i.jsxs)(w,{children:[null!=o&&(0,i.jsx)(z,{collapsed:c,children:(0,i.jsx)(v,{children:o})}),(0,i.jsx)(k,{children:e})]}),u&&(0,i.jsx)(r.Suspense,{fallback:null,children:(0,i.jsx)(S,{activeId:l})})]})})}a(65185),n.default.div`
  display: grid;
...
`;async function W(){try{const o=await G("atlantis:api-keys");if(!o)return null;const e=JSON.parse(o);if(e.groq&&e.groq.length>0)return e.groq}catch{}return null}async function q(o,e){const a="pt"===e.locale?"Portuguese":"English",t=e.system??["You are Atlantis, a concise personal-dashboard assistant.",`Answer in ${a}. Stay focused and reasonably concise.`,"If you don't know, say so plainly.","","Responses render as rich Markdown in the Atlantis UI. Use these blocks when","they fit the answer:","- Headings, bold/italic, bullet & numbered lists, GFM tables and task lists.","- Fenced code blocks with a language tag (```ts / ```py / ```sql …).","- Callouts as blockquotes: `> [!NOTE]`, `> [!TIP]`, `> [!IMPORTANT]`,","  `> [!WARNING]`, `> [!CAUTION]`.","- Diagrams / flowcharts / sequence / pie / gantt: fenced ```mermaid block","  (Mermaid 11 syntax).","- Numeric charts: fenced ```chart block with `type: bar|pie|line`,","  `labels: [..]`, `data: [..]`, optional `title:` and `colors:`.","","Default to Mermaid for relationships/flows and `chart` for quantitative","data the user provided. Never use Mermaid for time-series or numeric","trends (value per year / month / category) — those are always `chart`.","Never emit an empty fenced block. Keep caption text short around rendered blocks."].join("\n"),r=(e.history??[]).slice(-6),n=await fetch("https://api.groq.com/openai/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${e.key}`},body:JSON.stringify({model:"llama-3.1-8b-instant",messages:[{role:"system",content:t},...r,{role:"user",content:o}],temperature:.4,max_tokens:e.maxTokens??1024}),signal:e.signal}),i=await n.json();if(!n.ok)throw new Error(i.error?.message??`Groq HTTP ${n.status}`);const l=i.choices?.[0]?.message?.content?.trim();if(!l)throw new Error("Empty response from Groq");return l}n.default.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
  ...
  background: ${t.w4.colors.mainBg};
  font-family: ${t.w4.typography.fontFamily};
  animation: ${K} 0.4s ease 0.15s both;
`,n.default.div`
  position: relative;
  width: 56px;
  height: 56px;
...
`},217(o,e,a){a.d(e,{w4:()=>n});const t={sidebarBg:"#0c1018",sidebarText:"#c5cdd8",sidebarTextMuted:"#5a6577",sidebarActive:"#6366f1",sidebarActiveBg:"#141820",sidebarHover:"#1a2030",sidebarBorder:"#1e2535",mainBg:"#0a0e14",mainText:"#e8edf5",mainTextMuted:"#9aa5b8",mainTextFaint:"rgba(232,237,245,0.38)",accent:"#6366f1",accentHover:"#818cf8",accentMuted:"rgba(99,102,241,0.18)",codeBg:"#0f1520",codeBorder:"#2a3040",border:"#343c4f",borderStrong:"rgba(255,255,255,0.16)",borderSubtle:"#1e2535",surface:"#141820",surfaceRaised:"#1c2332",surfaceHover:"#1d2138",success:"#34d399",warning:"#fbbf24",danger:"#f87171",shadow:"rgba(0, 0, 0, 0.35)",shadowStrong:"rgba(0, 0, 0, 0.45)",suiteLab:"#8b7bff",suiteVida:"#7fb77e",suiteLearn:"#6aa8d8",suiteGames:"#ff6fa9",suiteEnt:"#e89a5c"},r="--at-",n={colors:function(){const o={};for(const e of Object.keys(t))o[e]=`var(${r}${e})`;return o}(),spacing:{xs:"4px",sm:"8px",md:"16px",lg:"24px",xl:"32px",xxl:"48px"},sidebar:{width:"260px"},topbar:{height:"56px"},typography:{fontFamily:"'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif",fontFamilyMono:"'JetBrains Mono', 'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, monospace",fontFamilySerif:"'Cormorant Garamond', 'Iowan Old Style', 'Palatino Linotype', Palatino, Georgia, serif",fontSizeSm:"13px",fontSizeBase:"14px",fontSizeMd:"16px",fontSizeLg:"20px",fontSizeXl:"24px",fontSizeHero:"32px",lineHeightBase:"1.6"},suites:{lab:`var(${r}suiteLab)`,vida:`var(${r}suiteVida)`,learn:`var(${r}suiteLearn)`,games:`var(${r}suiteGames)`,ent:`var(${r}suiteEnt)`},borderRadius:{sm:"4px",md:"6px",lg:"12px",xl:"16px"},breakpoints:{md:"768px",lg:"1024px",xl:"1280px"},sizes:{fullHeight:"100dvh",md:"768px",lg:"1024px",xl:"1280px"},zIndex:{sticky:100,dropdown:1e3,flyout:1200,modal:1500,tooltip:1600},elevation:{sm:"0 2px 8px var(--at-shadow), 0 1px 2px var(--at-shadow)",md:"0 8px 24px var(--at-shadow), 0 2px 4px var(--at-shadow)",lg:"0 16px 48px var(--at-shadowStrong), 0 4px 12px var(--at-shadow)",glow:"0 0 0 1px rgba(99,102,241,0.30), 0 8px 24px rgba(99,102,241,0.15)"},transitions:{fast:"0.1s cubic-bezier(0.4, 0, 0.2, 1)",base:"0.2s cubic-bezier(0.4, 0, 0.2, 1)",slow:"0.35s cubic-bezier(0.4, 0, 0.2, 1)",easing:"cubic-bezier(0.4, 0, 0.2, 1)"},focusRing:"\n    outline: 2px solid var(--at-accent);\n    outline-offset: 2px;\n  "}},30005(o,e,a){a.d(e,{$n:()=>x,YZ:()=>C,In:()=>k,K0:()=>w,ue:()=>F,mQ:()=>To});var t=a(27359),r=a(53233),n=a(26879),i=a(65723);const l={ghost:"transparent",accent:"transparent",primary:n.w4.colors.accent,success:"#238636",danger:"#da3633"},s={ghost:n.w4.colors.sidebarHover,accent:"rgba(88,166,255,0.10)",primary:n.w4.colors.accentHover,success:"#2ea043",danger:"#f85149"},d={ghost:n.w4.colors.border,accent:n.w4.colors.accent,primary:n.w4.colors.accent,success:"#238636",danger:"#da3633"},c={ghost:n.w4.colors.mainTextMuted,accent:n.w4.colors.accent,primary:"#fff",success:"#fff",danger:"#fff"},p={ghost:n.w4.colors.mainText,accent:n.w4.colors.accent,primary:"#fff",success:"#fff",danger:"#fff"},g={sm:"28px",md:"30px"},f={sm:"0 10px",md:"0 12px"},m={sm:"12px",md:"12px"},u=r.default.button`
  ...
  &:hover:not(:disabled) {
    ...
    color: ${({variant:o})=>p[o]};
    border-color: ${({variant:o})=>"ghost"===o?n.w4.colors.accent:d[o]};
  }
...
`,x=t.forwardRef(function({variant:o="ghost",size:e="md",icon:a,iconRight:t,children:r,...n},l){return(0,i.jsxs)(u,{ref:l,variant:o,size:e,...n,children:[a,r,t]})}),h={default:n.w4.colors.accent,danger:"#f85149"},b={default:n.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"},y=r.default.button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
  ...
  height: 30px;
  padding: 0;
  background: ${({active:o})=>o?`${n.w4.colors.accent}22`:"transparent"};
  border: 1px solid
    ${({active:o})=>o?n.w4.colors.accent:n.w4.colors.border};
  border-radius: ${({shape:o})=>"circle"===o?"999px":n.w4.borderRadius.sm};
  color: ${({active:o})=>o?n.w4.colors.accent:n.w4.colors.mainTextMuted};
  cursor: pointer;
  transition: background 0.15s, border-color 0.15s, color 0.15s;
...
`,w=t.forwardRef(function({active:o=!1,shape:e="square",tone:a="default",children:t,...r},n){return(0,i.jsx)(y,{ref:n,active:o,shape:e,tone:a,...r,children:t})});r.default.div`
  position: relative;
  display: inline-flex;
`,r.default.div`
  position: absolute;
...
`,r.default.button`
  ...
  background: ${({open:o})=>o?n.w4.colors.surfaceHover:"transparent"};
  border: 1px solid
    ${({open:o})=>o?n.w4.colors.borderStrong:n.w4.colors.border};
  border-radius: 999px;
  color: ${n.w4.colors.mainTextMuted};
  font-family: ${n.w4.typography.fontFamily};
  font-size: 13px;
...
`,(0,r.default)("button",{shouldForwardProp:o=>"accent"!==o&&"expanded"!==o})`
  width: 100%;
  display: grid;
  ...
  align-items: center;
  padding: 10px 12px;
  background: ${({expanded:o})=>o?n.w4.colors.surfaceHover:"transparent"};
  border: none;
  border-radius: 10px;
  cursor: pointer;
  font-family: inherit;
  ...
  &:focus-visible { ${n.w4.focusRing} }
`,(0,r.default)("span",{shouldForwardProp:o=>"accent"!==o})`
  width: 36px;
  height: 36px;
  border-radius: 9px;
...
`;(0,r.default)("div",{shouldForwardProp:o=>"accentColor"!==o&&"pinned"!==o&&"index"!==o})`
  --acc: ${({accentColor:o})=>o};
  position: relative;
  display: flex;
  flex-direction: column;
  ...
  padding: 0;
  background: ${n.w4.colors.surface};
  border: 1px solid ${({pinned:o})=>o?n.w4.colors.accent:n.w4.colors.border};
  border-radius: 12px;
  overflow: hidden;
  cursor: pointer;
  color: ${n.w4.colors.mainText};
...
`,r.default.button`
  ...
  border-radius: 8px;
  color: ${({pinned:o})=>o?n.w4.colors.accent:n.w4.colors.mainText};
...
`,r.default.button`
  ...
  border-radius: 999px;
  border: 1.5px solid
    ${({variant:o})=>"default"===o?n.w4.colors.borderStrong:n.w4.colors.accent};
  background: ${({variant:o})=>"filled"===o?n.w4.colors.accentMuted:"transparent"};
  color: ${({variant:o})=>"default"===o?n.w4.colors.mainTextMuted:n.w4.colors.accent};
  font-family: ${n.w4.typography.fontFamily};
  font-size: ${n.w4.typography.fontSizeSm};
  font-weight: 500;
  white-space: nowrap;
  ...
  &:hover:not(:disabled) {
    border-color: ${({variant:o})=>"default"===o?n.w4.colors.mainTextFaint:n.w4.colors.accentHover};
    color: ${({variant:o})=>"default"===o?n.w4.colors.mainText:n.w4.colors.accentHover};
  }
...
`,r.default.span`
  ...
  background: ${({color:o})=>o};
  display: inline-block;
`;const T={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:n.w4.colors.accentMuted},S={neutral:n.w4.colors.mainTextMuted,live:n.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:n.w4.colors.accent};r.default.span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${n.w4.typography.fontFamilyMono};
  ...
  border-radius: ${({tone:o})=>"film"===o||"tv"===o?n.w4.borderRadius.sm:"3px"};
  background: ${({tone:o})=>T[o]};
  color: ${({tone:o})=>S[o]};
`,r.default.span`
  width: 6px;
  height: 6px;
...
`;const j=r.default.kbd`
  ...
  white-space: nowrap;
`;function F({children:o,...e}){return(0,i.jsx)(j,{...e,children:o})}const B=r.default.div`
  font-family: ${n.w4.typography.fontFamilyMono};
  font-size: 11px;
  ...
  align-items: center;
  gap: 8px;
`;function C({children:o,...e}){return(0,i.jsx)(B,{...e,children:o})}r.default.label`
  display: flex;
  align-items: center;
  gap: 10px;
...
`,r.default.div`
  ...
  background: ${n.w4.colors.surface};
  border: 1px solid
    ${({active:o})=>o?n.w4.colors.accent:n.w4.colors.borderSubtle};
  border-radius: ${n.w4.borderRadius.lg};
  color: ${n.w4.colors.mainText};
  font-family: ${n.w4.typography.fontFamily};
  box-shadow: ${({active:o})=>o?`inset 0 0 0 1px ${n.w4.colors.accent}`:"none"};
  transition: border-color ${n.w4.transitions.fast};

  &:hover {
    border-color: ${({active:o})=>o?n.w4.colors.accentHover:n.w4.colors.borderStrong};
  }
`,r.default.div`
  display: flex;
...
`;const P=$.keyframes`
  from { opacity: 0; transform: translateY(8px); }
  to   { opacity: 1; transform: translateY(0); }
`;(0,r.default)("div",{shouldForwardProp:o=>"accentColor"!==o&&"index"!==o})`
  --acc: ${({accentColor:o})=>o};
  position: relative;
  display: flex;
  flex-direction: column;
...
`,(0,r.default)("div",{shouldForwardProp:o=>"accentColor"!==o})`
  --acc: ${({accentColor:o})=>o};
  height: 120px;
  position: relative;
  overflow: hidden;
...
`,r.default.p`
  ...
  font-size: 12.5px;
  line-height: 1.45;
`;var R=a(28976),E=a(35143),L=a(98808);r.default.nav`padding: ${n.w4.spacing.sm} 0;`,r.default.div`
...
`,r.default.button`
  ...
  align-items: center;
  width: 100%;
  padding: ${({collapsed:o})=>o?"10px 0":`7px ${n.w4.spacing.md}`};
  justify-content: ${({collapsed:o})=>o?"center":"space-between"};
  background: none;
  border: none;
  cursor: pointer;
...
`,r.default.button`
  ...
  background: ${({active:o})=>o?n.w4.colors.sidebarActiveBg:"none"};
  border: none;
  border-left: 2px solid ${({active:o})=>o?n.w4.colors.sidebarActive:"transparent"};
  cursor: pointer;
...
`,r.default.button`
  ...
  border: none;
  cursor: pointer;
  color: ${({active:o})=>o?"#e3b341":n.w4.colors.sidebarTextMuted};
...
`,I=r.default.pre`
  ...
  color: ${n.w4.colors.mainTextMuted};
  white-space: pre-wrap;
`;let D=!1;function Y({code:o}){const e=(0,t.useRef)(null),[r,l]=(0,t.useState)(null),[s,d]=(0,t.useState)(!1);return(0,t.useEffect)(()=>{let t=!1;if(l(null),d(!1),!o.trim())return void d(!0);const r=o.trim().split(/\r?\n/)[0]?.trim()??"";if(/^(?:---[\s\S]*?---\s*)?(?:graph|flowchart|sequenceDiagram|classDiagram|stateDiagram(?:-v2)?|erDiagram|pie|gantt|journey|mindmap|gitGraph|sankey(?:-beta)?|quadrantChart|requirementDiagram|timeline|xychart-beta|block-beta|C4Context|C4Container|C4Component|C4Dynamic|C4Deployment)\b/.test(r))return async function(){const r=(await a.e(774).then(a.bind(a,30774))).default;if(D||(r.initialize({startOnLoad:!1,theme:"dark",themeVariables:{background:n.w4.colors.codeBg,primaryColor:n.w4.colors.accent,primaryTextColor:n.w4.colors.mainText,lineColor:n.w4.colors.border}}),D=!0),e.current&&!t)try{const a=`mermaid-${Math.random().toString(36).slice(2)}`,{svg:n}=await r.render(a,o);if(t||!e.current)return;e.current.innerHTML=n,requestAnimationFrame(()=>{if(t||!e.current)return;const o=e.current.querySelector("svg");if(!o)return void d(!0);const a=o.getBoundingClientRect();(a.width<40||a.height<40)&&d(!0)})}catch(o){t||l(o instanceof Error?o.message:String(o))}}(),()=>{t=!0};d(!0)},[o]),r?(0,i.jsx)(H,{children:(0,i.jsxs)(N,{children:["Mermaid error: ",r]})}):s?(0,i.jsx)(I,{children:o.trim()}):(0,i.jsx)(H,{ref:e})}const G=["#388bfd","#3fb950","#d29922","#a371f7","#f87171","#22d3ee","#fb923c","#34d399","#f472b6","#818cf8"],K=r.default.div`
  background: ${n.w4.colors.codeBg};
  border: 1px solid ${n.w4.colors.codeBorder};
  border-radius: ${n.w4.borderRadius.md};
  padding: ${n.w4.spacing.lg};
...
`,_=r.default.div`
  ...
  font-family: ${n.w4.typography.fontFamilyMono};
  font-size: ${n.w4.typography.fontSizeSm};
`;function U(o){if(o<=0)return 10;const e=Math.pow(10,Math.floor(Math.log10(o)));return Math.ceil(o/e)*e}function Z({labels:o,data:e,colors:a}){const t=176,r=U(Math.max(...e,1)),l=Math.min(40,340/o.length*.6),s=340/o.length,d=Array.from({length:6},(o,e)=>r/5*e);return(0,i.jsxs)("svg",{viewBox:"0 0 400 240",width:"100%",style:{maxWidth:400},children:[d.map((o,e)=>{const a=192-o/r*t;return(0,i.jsxs)("g",{children:[(0,i.jsx)("line",{x1:44,y1:a,x2:384,y2:a,stroke:n.w4.colors.border,strokeWidth:.5,strokeDasharray:0===e?"none":"3,3"}),(0,i.jsx)("text",{x:38,y:a+4,fill:n.w4.colors.mainTextMuted,fontSize:10,textAnchor:"end",fontFamily:n.w4.typography.fontFamily,children:Math.round(o)})]},e)}),e.map((e,d)=>{const c=44+s*d+s/2-l/2,p=e/r*t,g=192-p,f=a[d%a.length];return(0,i.jsxs)("g",{children:[(0,i.jsxs)("rect",{x:c,y:g,width:l,height:p,rx:3,fill:f,opacity:.85,children:[(0,i.jsx)("animate",{attributeName:"height",from:"0",to:p,dur:"0.5s",fill:"freeze"}),(0,i.jsx)("animate",{attributeName:"y",from:192,to:g,dur:"0.5s",fill:"freeze"})]}),(0,i.jsx)("text",{x:c+l/2,y:g-4,fill:n.w4.colors.mainText,fontSize:10,fontWeight:600,textAnchor:"middle",fontFamily:n.w4.typography.fontFamily,children:e}),(0,i.jsx)("text",{x:44+s*d+s/2,y:208,fill:n.w4.colors.mainTextMuted,fontSize:10,textAnchor:"middle",fontFamily:n.w4.typography.fontFamily,children:o[d].length>8?o[d].slice(0,7)+"…":o[d]})]},d)})]})}function J({labels:o,data:e,colors:a}){const t=e.reduce((o,e)=>o+e,0)||1;let r=-Math.PI/2;const l=e.map((o,e)=>{const l=o/t*Math.PI*2,s=r;r+=l;const d=r,c=120+90*Math.cos(s),p=120+90*Math.sin(s),g=120+90*Math.cos(d),f=120+90*Math.sin(d),m=l>Math.PI?1:0,u=s+l/2,x=120+58.5*Math.cos(u),h=120+58.5*Math.sin(u),b=Math.round(o/t*100);return(0,i.jsxs)("g",{children:[(0,i.jsx)("path",{d:`M 120 120 L ${c} ${p} A 90 90 0 ${m} 1 ${g} ${f} Z`,fill:a[e%a.length],stroke:n.w4.colors.codeBg,strokeWidth:2,opacity:.85}),b>=5&&(0,i.jsxs)("text",{x,y:h+4,fill:"#fff",fontSize:11,fontWeight:600,textAnchor:"middle",fontFamily:n.w4.typography.fontFamily,children:[b,"%"]})]},e)});return(0,i.jsx)("svg",{viewBox:"0 0 240 240",width:"100%",style:{maxWidth:240},children:l})}function X({labels:o,data:e,colors:a}){const t=176,r=U(Math.max(...e,1)),l=e.length>1?340/(e.length-1):340,s=a[0],d=e.map((o,e)=>({x:44+l*e,y:192-o/r*t})),c=d.map((o,e)=>`${0===e?"M":"L"} ${o.x} ${o.y}`).join(" "),p=Array.from({length:6},(o,e)=>r/5*e);return(0,i.jsxs)("svg",{viewBox:"0 0 400 240",width:"100%",style:{maxWidth:400},children:[p.map((o,e)=>{const a=192-o/r*t;return(0,i.jsxs)("g",{children:[(0,i.jsx)("line",{x1:44,y1:a,x2:384,y2:a,stroke:n.w4.colors.border,strokeWidth:.5,strokeDasharray:0===e?"none":"3,3"}),(0,i.jsx)("text",{x:38,y:a+4,fill:n.w4.colors.mainTextMuted,fontSize:10,textAnchor:"end",fontFamily:n.w4.typography.fontFamily,children:Math.round(o)})]},e)}),(0,i.jsx)("path",{d:c,fill:"none",stroke:s,strokeWidth:2.5,strokeLinecap:"round",strokeLinejoin:"round"}),d.map((a,t)=>(0,i.jsxs)("g",{children:[(0,i.jsx)("circle",{cx:a.x,cy:a.y,r:4,fill:s,stroke:n.w4.colors.codeBg,strokeWidth:2}),(0,i.jsx)("text",{x:a.x,y:a.y-10,fill:n.w4.colors.mainText,fontSize:10,fontWeight:600,textAnchor:"middle",fontFamily:n.w4.typography.fontFamily,children:e[t]}),(0,i.jsx)("text",{x:a.x,y:208,fill:n.w4.colors.mainTextMuted,fontSize:10,textAnchor:"middle",fontFamily:n.w4.typography.fontFamily,children:o[t].length>8?o[t].slice(0,7)+"…":o[t]})]},t))]})}function Q({code:o}){const e=(0,t.useMemo)(()=>function(o){const e=o.trim().split("\n");let a,t,r="bar",n=[],i=[];for(const o of e){const[e,...l]=o.split(":"),s=l.join(":").trim();if(s)switch(e.trim().toLowerCase()){case"type":["bar","pie","line"].includes(s.toLowerCase())&&(r=s.toLowerCase());break;case"title":a=s;break;case"labels":n=s.replace(/^\[|\]$/g,"").split(",").map(o=>o.trim());break;case"data":i=s.replace(/^\[|\]$/g,"").split(",").map(o=>parseFloat(o.trim())||0);break;case"colors":t=s.replace(/^\[|\]$/g,"").split(",").map(o=>o.trim())}}return n.length&&i.length?{type:r,title:a,labels:n,data:i,colors:t}:null}(o),[o]);if(!e)return(0,i.jsx)(K,{children:(0,i.jsx)(_,{children:"Invalid chart data"})});const a=e.colors??G;return(0,i.jsxs)(K,{children:[e.title&&(0,i.jsx)(V,{children:e.title}),"bar"===e.type&&(0,i.jsx)(Z,{labels:e.labels,data:e.data,colors:a}),"pie"===e.type&&(0,i.jsx)(J,{labels:e.labels,data:e.data,colors:a}),"line"===e.type&&(0,i.jsx)(X,{labels:e.labels,data:e.data,colors:a}),(0,i.jsx)(O,{children:e.labels.map((o,e)=>(0,i.jsxs)(W,{children:[(0,i.jsx)(q,{color:a[e%a.length]}),o]},e))})]})}r.default.div`
  background: ${n.w4.colors.codeBg};
  border: 1px solid ${n.w4.colors.codeBorder};
  border-radius: ${n.w4.borderRadius.md};
  padding: ${n.w4.spacing.lg};
...
`,r.default.button`
  padding: 6px 14px;
  border: 1px solid ${({active:o})=>o?n.w4.colors.accent:n.w4.colors.border};
  border-radius: ${n.w4.borderRadius.md};
...
`,r.default.span`
  font-size: ${n.w4.typography.fontSizeBase};
  color: ${n.w4.colors.mainTextMuted};
`;var ao=a(68383),to=a(21426),ro=a(25609),no=a(20320);const io=r.default.div`
  margin: ${n.w4.spacing.lg} 0;
  border-radius: ${n.w4.borderRadius.md};
  border: 1px solid ${n.w4.colors.codeBorder};
  overflow: hidden;
...
`,co=r.default.button`
  ...
  padding: 3px 8px;
  background: none;
  border: 1px solid ${({copied:o})=>o?"#3fb950":n.w4.colors.border};
  border-radius: ${n.w4.borderRadius.sm};
  color: ${({copied:o})=>o?"#3fb950":n.w4.colors.sidebarTextMuted};
  font-size: 11px;
  font-family: ${n.w4.typography.fontFamily};
  cursor: pointer;
  transition: color 0.15s, border-color 0.15s;
  &:hover { color: ${n.w4.colors.sidebarText}; border-color: ${n.w4.colors.sidebarText}; }
`,po={...to.A,'pre[class*="language-"]':{...to.A['pre[class*="language-"]'],background:n.w4.colors.codeBg,margin:0,padding:"18px 20px",fontSize:"13px",lineHeight:"1.6",borderRadius:0},'code[class*="language-"]':{...to.A['code[class*="language-"]'],background:"none",fontSize:"13px"}};function go({lang:o="text",code:e}){const[a,r]=(0,t.useState)(!1);return(0,i.jsxs)(io,{children:[(0,i.jsxs)(lo,{children:[(0,i.jsx)(so,{children:o}),(0,i.jsxs)(co,{copied:a,onClick:()=>{navigator.clipboard.writeText(e).then(()=>{r(!0),setTimeout(()=>r(!1),2e3)})},children:[a?(0,i.jsx)(ro.A,{size:12}):(0,i.jsx)(no.A,{size:12}),a?"Copied!":"Copy"]})]}),(0,i.jsx)(ao.A,{language:o,style:po,showLineNumbers:e.split("\n").length>8,lineNumberStyle:{color:"#484f58",minWidth:"2.5em",paddingRight:"1.5em",userSelect:"none",fontSize:"12px"},customStyle:{margin:0,background:n.w4.colors.codeBg},wrapLongLines:!1,children:e})]})}var fo=a(65569),mo=a(8218),uo=a(57230),xo=a(22966),ho=a(21069);const bo={NOTE:{bg:"rgba(88, 166, 255, 0.08)",border:"#58a6ff",icon:fo.A,label:"Note",color:"#58a6ff"},TIP:{bg:"rgba(63, 185, 80, 0.08)",border:"#3fb950",icon:mo.A,label:"Tip",color:"#3fb950"},IMPORTANT:{bg:"rgba(163, 113, 247, 0.08)",border:"#a371f7",icon:uo.A,label:"Important",color:"#a371f7"},WARNING:{bg:"rgba(210, 153, 34, 0.08)",border:"#d29922",icon:xo.A,label:"Warning",color:"#d29922"},CAUTION:{bg:"rgba(248, 81, 73, 0.08)",border:"#f85149",icon:ho.A,label:"Caution",color:"#f85149"}},yo=r.default.div`
  background: ${({bg:o})=>o};
...
`;function zo({type:o,children:e}){const a=bo[o]??bo.NOTE,t=a.icon;return(0,i.jsxs)(yo,{bg:a.bg,border:a.border,children:[(0,i.jsxs)(wo,{color:a.color,children:[(0,i.jsx)(t,{size:15,strokeWidth:2}),a.label]}),(0,i.jsx)($o,{children:e})]})}r.default.nav`
  width: 220px;
  min-width: 220px;
...
`,r.default.ul`list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 2px;`,r.default.a`
  ...
  font-size: ${n.w4.typography.fontSizeSm};
  font-family: ${n.w4.typography.fontFamily};
  color: ${({active:o})=>o?n.w4.colors.accent:n.w4.colors.sidebarTextMuted};
  text-decoration: none;
  border-left: 2px solid ${({active:o})=>o?n.w4.colors.accent:"transparent"};
...
`;function Mo(){const o=/^\[!(NOTE|TIP|WARNING|CAUTION|IMPORTANT)\]\s*/i;return e=>{function a(e,a,t){const r=a.children?.[0];"text"===r?.type&&(r.value=r.value.replace(o,""),r.value.trim()||1!==a.children.length||a.children.shift()),e.data=e.data??{},e.data.hName="div",e.data.hProperties={"data-callout":t.toUpperCase()}}!function e(t){if("blockquote"===t.type){const e=t.children?.[0];if("paragraph"===e?.type){const r=e.children?.[0],n="text"===r?.type&&r.value?.match(o);n&&a(t,e,n[1])}}if("paragraph"===t.type){const e=t.children?.[0],r="text"===e?.type&&e.value?.match(o);if(r){const e=[...t.children];t.children=[{type:"paragraph",children:e}],a(t,t.children[0],r[1]);const n=e[0];return void("text"===n?.type&&(n.value=n.value.replace(o,""),n.value.trim()||1!==e.length||e.shift()))}}t.children?.forEach(e)}(e)}}r.default.div`
  position: fixed;
  inset: 0;
  z-index: 9999;
...
`,r.default.button`
  ...
  width: 100%;
  padding: 10px 18px;
  background: ${({selected:o})=>o?n.w4.colors.accentMuted:"transparent"};
  border: none;
  cursor: pointer;
  text-align: left;
...
`,r.default.div`
  ...
  justify-content: center;
  border-radius: ${n.w4.borderRadius.md};
  background: ${({selected:o})=>o?`${n.w4.colors.accent}20`:n.w4.colors.sidebarHover};
  color: ${({selected:o})=>o?n.w4.colors.accent:n.w4.colors.sidebarTextMuted};
  flex-shrink: 0;
  margin-top: 1px;
`,r.default.div`
  flex: 1;
...
`,r.default.div`
  display: flex;
  align-items: center;
  color: ${({selected:o})=>o?n.w4.colors.accent:"transparent"};
  margin-top: 8px;
...
`,r.default.div`
  padding: ${({collapsed:o})=>o?"8px 4px":`8px ${n.w4.spacing.md}`};
  border-bottom: 1px solid ${n.w4.colors.border}60;
`,r.default.div`
  display: flex;
  align-items: center;
  ...
  justify-content: ${({collapsed:o})=>o?"center":"flex-start"};
  background: ${({focused:o})=>o?`${n.w4.colors.accent}10`:n.w4.colors.sidebarHover};
  border: 1px solid ${({focused:o})=>o?`${n.w4.colors.accent}40`:"transparent"};
  border-radius: ${n.w4.borderRadius.md};
...
`,r.default.span`
  ...
  font-weight: 600;
  margin-left: auto;
`,new Map;const Ao=r.default.div`
  font-size: 14px;
  color: ${n.w4.colors.mainText};
  line-height: 1.65;
...
`;function To({children:o}){return(0,i.jsx)(Ao,{children:(0,i.jsx)(R.oz,{remarkPlugins:[E.A,Mo],rehypePlugins:[L.A],components:{div({node:o,children:e,...a}){const t=a["data-callout"];return t?(0,i.jsx)(zo,{type:t,children:e}):(0,i.jsx)("div",{...a,children:e})},pre:({children:o})=>(0,i.jsx)(i.Fragment,{children:o}),code({className:o,children:e}){const a=/language-(\w+)/.exec(o??"")?.[1],t=String(e).replace(/\n$/,"");return t.trim()?"mermaid"===a?(0,i.jsx)(Y,{code:t}):"chart"===a?(0,i.jsx)(Q,{code:t}):a||t.includes("\n")?(0,i.jsx)(go,{lang:a,code:t}):(0,i.jsx)("code",{className:o,children:e}):null}},children:o})})}},38887(o,e,a){a.d(e,{A:()=>t});const t={"ask.title":{en:"Ask",pt:"Perguntar"},"ask.untitled":{en:"Untitled conversation",pt:"Conversa sem título"},"ask.sidebar.new":{en:"New conversation",pt:"Nova conversa"},"ask.sidebar.empty":{en:"No conversations yet.",pt:"Ainda não há conversas."},"ask.sidebar.delete":{en:"Delete",pt:"Eliminar"},"ask.sidebar.rename":{en:"Rename",pt:"Renomear"},"ask.group.today":{en:"Today",pt:"Hoje"},"ask.group.yesterday":{en:"Yesterday",pt:"Ontem"},"ask.group.last7":{en:"Last 7 days",pt:"Últimos 7 dias"},"ask.group.older":{en:"Older",pt:"Anteriores"},"ask.welcome.title":{en:"What can I help with?",pt:"Sobre o que te posso ajudar?"},"ask.welcome.kicker":{en:"Ask about code, ideas, summaries…",pt:"Pergunta-me sobre código, ideias, resumos…"},"ask.suggestion.1":{en:"Summarize my tasks for today",pt:"Resume as minhas tarefas de hoje"},"ask.suggestion.1.title":{en:"Summarize tasks",pt:"Resumir tarefas"},"ask.suggestion.1.body":{en:"Get a concise overview of what you need to do today",pt:"Obtém uma visão clara do que precisas de fazer hoje"},"ask.suggestion.2":{en:"Review my code",pt:"Rever o meu código"},"ask.suggestion.2.title":{en:"Code review",pt:"Rever código"},"ask.suggestion.2.body":{en:"Paste code and get a thorough review with suggestions",pt:"Cola código e recebe uma revisão completa com sugestões"},"ask.suggestion.3":{en:"Explain how something works",pt:"Explica-me como funciona X"},"ask.suggestion.3.title":{en:"Explain a concept",pt:"Explicar um conceito"},"ask.suggestion.3.body":{en:"Break down complex topics into easy-to-follow steps",pt:"Desdobra temas complexos em passos simples"},"ask.suggestion.4":{en:"Write a haiku about…",pt:"Escreve um haiku sobre…"},"ask.suggestion.4.title":{en:"Creative writing",pt:"Escrita criativa"},"ask.suggestion.4.body":{en:"Poetry, stories, scripts — let imagination flow",pt:"Poesia, histórias, guiões — deixa a imaginação fluir"},"ask.placeholder":{en:"Message Atlantis…",pt:"Mensagem para o Atlantis…"},"ask.send":{en:"Send",pt:"Enviar"},"ask.stop":{en:"Stop",pt:"Parar"},"ask.retry":{en:"Retry",pt:"Tentar novamente"},"ask.newConversation":{en:"New conversation",pt:"Nova conversa"},"ask.you":{en:"You",pt:"Você"},"ask.atlantis":{en:"ATLANTIS",pt:"ATLANTIS"},"ask.thinking":{en:"Thinking…",pt:"A pensar…"},"ask.action.copy":{en:"Copy",pt:"Copiar"},"ask.action.regenerate":{en:"Regenerate",pt:"Regenerar"},"ask.action.edit":{en:"Edit message",pt:"Editar mensagem"},"ask.error.generic":{en:"Something went wrong. Try again.",pt:"Algo correu mal. Tenta novamente."},"ask.noKey.title":{en:"Groq API key not configured",pt:"Chave API Groq não configurada"},"ask.noKey.body":{en:"To use Ask, add your Groq API key in Settings.",pt:"Para usar o Perguntar, adiciona a tua chave API Groq nas Definições."},"ask.noKey.cta":{en:"Open Settings",pt:"Abrir Definições"},"ask.settings.title":{en:"Conversation settings",pt:"Definições da conversa"},"ask.settings.tone":{en:"Tone",pt:"Tom"},"ask.settings.tone.friendly":{en:"Friendly",pt:"Simpático"},"ask.settings.tone.direct":{en:"Direct",pt:"Direto"},"ask.settings.tone.playful":{en:"Playful",pt:"Divertido"},"ask.settings.language":{en:"Language",pt:"Idioma"},"ask.settings.language.auto":{en:"Auto",pt:"Automático"},"ask.settings.language.pt":{en:"Portuguese",pt:"Português"},"ask.settings.language.en":{en:"English",pt:"Inglês"},"ask.settings.maxTokens":{en:"Response length",pt:"Comprimento da resposta"},"ask.settings.maxTokens.short":{en:"Short (256)",pt:"Curto (256)"},"ask.settings.maxTokens.medium":{en:"Medium (512)",pt:"Médio (512)"},"ask.settings.maxTokens.long":{en:"Long (1024)",pt:"Longo (1024)"},"ask.settings.maxTokens.xlong":{en:"Extra long (2048)",pt:"Extra longo (2048)"},"ask.hint.send":{en:"send",pt:"enviar"},"ask.hint.newline":{en:"new line",pt:"nova linha"},"ask.hint.newConv":{en:"new conversation",pt:"nova conversa"}}}}]);
//# sourceMappingURL=1079.c8f89fca945d51d13230.js.map