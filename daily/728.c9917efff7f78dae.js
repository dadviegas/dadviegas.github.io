...
`,l().div`
  position: relative;
`;let Z="260px",K="56px",U="48px",J=l().header`
  display: flex;
  align-items: center;
...
`,el=l().div`
  ...
  overflow: hidden;
`,es=l().aside`
  width: ${({collapsed:e})=>e?K:Z};
  min-width: ${({collapsed:e})=>e?K:Z};
  background: ${s.w4.colors.sidebarBg};
  border-right: 1px solid ${s.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,ep=l().main`
  ...
  display: flex;
  flex-direction: column;
`,ec=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function eg(){return(0,r.jsx)(et,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:ec.map((e,o)=>(0,r.jsx)(er,{index:o,accent:e.accent,children:e.char},o))})}let eh="atlantis:sidebar-collapsed";function ex({sidebar:e,children:o,topBarRight:n,title:l="Atlantis",activeId:s=null}){let[d,p]=(0,a.useState)(()=>{try{return"true"===localStorage.getItem(eh)}catch{return!1}}),[c,g]=(0,a.useState)(null),h=(0,a.useRef)(),x=()=>p(e=>{let o=!e;try{localStorage.setItem(eh,String(o))}catch{}return o}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(t.bind(t,5816)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(D.I.Provider,{value:{collapsed:d,toggle:x,flyout:c,openFlyout:(e,o,t)=>{clearTimeout(h.current),g({entry:e,anchorY:o,onSelect:t})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,r.jsxs)(el,{children:[(0,r.jsxs)(J,{children:[e&&(0,r.jsx)(Q,{children:(0,r.jsx)(ee,{onClick:x,title:d?"Expand sidebar":"Collapse sidebar",children:(0,r.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,r.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,r.jsx)("path",{d:"M9 3v18"})]})})}),(0,r.jsx)(eg,{}),l&&(0,r.jsx)(ea,{children:l}),n&&(0,r.jsx)(ei,{children:n})]}),(0,r.jsxs)(en,{children:[null!=e&&(0,r.jsx)(es,{collapsed:d,children:(0,r.jsx)(ed,{children:e})}),(0,r.jsx)(ep,{children:o})]}),c&&(0,r.jsx)(i().Suspense,{fallback:null,children:(0,r.jsx)(f,{activeId:s})})]})})}l().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
