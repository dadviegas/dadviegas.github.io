...
`;var s=a(72799);let d="#7fb77e",c=(0,s.keyframes)`
...
`,p=l().div`
  ...
  padding: ${i.w4.spacing.xl} ${i.w4.spacing.lg} ${i.w4.spacing.lg};
...
`,m=!1,f=/^(?:---[\s\S]*?---\s*)?(?:graph|flowchart|sequenceDiagram|classDiagram|stateDiagram(?:-v2)?|erDiagram|pie|gantt|journey|mindmap|gitGraph|sankey(?:-beta)?|quadrantChart|requirementDiagram|timeline|xychart-beta|block-beta|C4Context|C4Container|C4Component|C4Dynamic|C4Deployment)\b/;function x({code:e}){let[o,i]=(0,t.useState)(""),[n,l]=(0,t.useState)(!1);return((0,t.useEffect)(()=>{let o=!1;l(!1),i("");let r=e.trim();if(!r)return void l(!0);let t=r.split(/\r?\n/)[0]?.trim()??"";return f.test(t)?((async()=>{try{let e=(await Promise.resolve().then(a.bind(a,29738))).default;if(!m){let o="#141820",a="#1c2332",r="#343c4f",t="#e8edf5",i="#9aa5b8",n="#7fb77e",l="#6aa8d8",s="#8b7bff",d="#e89a5c",c="#f87171";e.initialize({startOnLoad:!1,theme:"base",securityLevel:"loose",themeVariables:{fontFamily:"-apple-system, BlinkMacSystemFont, Segoe UI, Helvetica, Arial, sans-serif",background:o,mainBkg:a,primaryColor:n,primaryTextColor:t,primaryBorderColor:n,secondaryColor:s,secondaryTextColor:t,secondaryBorderColor:s,tertiaryColor:l,tertiaryTextColor:t,tertiaryBorderColor:l,lineColor:i,textColor:t,nodeBorder:r,clusterBkg:o,clusterBorder:r,edgeLabelBackground:a,labelBackground:a,labelBorder:r,relationLabelBackground:a,relationLabelColor:t,pie1:n,pie2:s,pie3:l,pie4:d,pie5:"#ff6fa9",pie6:"#2dd4bf",pie7:c,pie8:n,pieStrokeColor:o,pieStrokeWidth:"2px",pieTitleTextSize:"18px",pieSectionTextSize:"13px",pieLegendTextSize:"13px",actorBkg:n,actorBorder:n,actorTextColor:o,signalColor:t,signalTextColor:t,labelBoxBkgColor:a,labelBoxBorderColor:r,labelTextColor:t,loopTextColor:t,noteBkgColor:d,noteBorderColor:d,noteTextColor:o,stateBkg:a,altBackground:o,attributeBackgroundColorOdd:a,attributeBackgroundColorEven:o,rowOdd:a,rowEven:o,gridColor:r,sectionBkgColor:a,sectionBkgColor2:o,taskBkgColor:s,taskTextColor:t,taskTextDarkColor:t,taskTextLightColor:t,taskTextOutsideColor:t,activeTaskBkgColor:n,activeTaskBorderColor:n,doneTaskBkgColor:i,doneTaskBorderColor:i,critBkgColor:c,critBorderColor:c}}),m=!0}let{svg:t}=await e.render(`mermaid-${"u">typeof crypto&&"function"==typeof crypto.randomUUID?crypto.randomUUID().replace(/-/g,"").slice(0,8):Math.random().toString(36).slice(2,10).padEnd(8,"0")}`,r);if(o)return;if(!t||/aria-roledescription="error"/i.test(t))return void l(!0);i(t)}catch(e){console.error("[MermaidBlock] render failed",e),o||l(!0)}})(),()=>{o=!0}):void l(!0)},[e]),n)?(0,r.jsx)(g,{children:e.trim()}):(0,r.jsx)(p,{dangerouslySetInnerHTML:{__html:o}})}let h=["#388bfd","#3fb950","#d29922","#a371f7","#f87171","#22d3ee","#fb923c","#34d399","#f472b6","#818cf8"],u=l().div`
  background: ${i.w4.colors.codeBg};
  border: 1px solid ${i.w4.colors.codeBorder};
  border-radius: ${i.w4.borderRadius.md};
...
`,l().span`
  font-size: ${i.w4.typography.fontSizeBase};
  color: ${i.w4.colors.mainTextMuted};
`;var N=a(17223),V=a(21426),K=a(25609),G=a(20320);let W=l().div`
  margin: ${i.w4.spacing.lg} 0;
  border-radius: ${i.w4.borderRadius.md};
  border: 1px solid ${i.w4.colors.codeBorder};
  overflow: hidden;
...
`,_={...V.A,'pre[class*="language-"]':{...V.A['pre[class*="language-"]'],background:i.w4.colors.codeBg,margin:0,padding:"18px 20px",fontSize:"13px",lineHeight:"1.6",borderRadius:0},'code[class*="language-"]':{...V.A['code[class*="language-"]'],background:"none",fontSize:"13px"}};function q({lang:e="text",code:o}){let[a,n]=(0,t.useState)(!1);return(0,r.jsxs)(W,{children:[(0,r.jsxs)(O,{children:[(0,r.jsx)(Y,{children:e}),(0,r.jsxs)(U,{copied:a,onClick:()=>{navigator.clipboard.writeText(o).then(()=>{n(!0),setTimeout(()=>n(!1),2e3)})},children:[a?(0,r.jsx)(K.A,{size:12}):(0,r.jsx)(G.A,{size:12}),a?"Copied!":"Copy"]})]}),(0,r.jsx)(N.A,{language:e,style:_,showLineNumbers:o.split("\n").length>8,lineNumberStyle:{color:"#484f58",minWidth:"2.5em",paddingRight:"1.5em",userSelect:"none",fontSize:"12px"},customStyle:{margin:0,background:i.w4.colors.codeBg},wrapLongLines:!1,children:o})]})}l().div`
  background: ${({bg:e})=>e};
...
`,N=s().div`
  ...
  color: ${r.w4.colors.sidebarTextMuted};
  font-family: ${r.w4.typography.fontFamily};
`;function V({onSave:e,onUpdate:o,onCancel:a,existingDoc:r}){let[n,l]=(0,i.useState)(r?.name??""),s=(0,i.useRef)(null);return(0,i.useEffect)(()=>{s.current?.focus(),r&&s.current?.select()},[r]),(0,t.jsx)(L,{onClick:a,children:(0,t.jsxs)(R,{onClick:e=>e.stopPropagation(),children:[(0,t.jsx)(P,{children:"Save document"}),r&&o&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(N,{children:"Update the current version or save as a new one."}),(0,t.jsxs)(H,{children:[(0,t.jsx)(D,{onClick:a,children:"Cancel"}),(0,t.jsxs)(D,{danger:!0,onClick:o,children:['Update "',r.name,'"']})]}),(0,t.jsx)(I,{})]}),(0,t.jsx)(E,{ref:s,value:n,onChange:e=>l(e.target.value),onKeyDown:t=>{"Enter"===t.key&&n.trim()&&(r&&n.trim()===r.name&&o?o():e(n.trim())),"Escape"===t.key&&a()},placeholder:r?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,t.jsxs)(H,{children:[!r&&(0,t.jsx)(D,{onClick:a,children:"Cancel"}),(0,t.jsx)(D,{primary:!0,disabled:!n.trim(),onClick:()=>e(n.trim()),children:"Save as new"})]})]})})}let K=(0,d.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,G=(0,d.keyframes)`
