...
`,w=t.default.main`
  ...
  display: flex;
  flex-direction: column;
`,A="atlantis:sidebar-collapsed";function v({sidebar:e,children:a,topBarRight:n,title:t="Atlantis",activeId:d=null}){const[c,v]=(0,i.useState)(()=>{try{return"true"===localStorage.getItem(A)}catch{return!1}}),[$,j]=(0,i.useState)(null),k=(0,i.useRef)(),S=()=>v(e=>{const a=!e;try{localStorage.setItem(A,String(a))}catch{}return a}),M=i.useMemo(()=>i.lazy(()=>Promise.resolve().then(o.bind(o,4914)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(s.I.Provider,{value:{collapsed:c,toggle:S,flyout:$,openFlyout:(e,a,o)=>{clearTimeout(k.current),j({entry:e,anchorY:a,onSelect:o})},scheduleFlyoutClose:()=>{k.current=setTimeout(()=>j(null),160)},cancelFlyoutClose:()=>clearTimeout(k.current)},children:(0,r.jsxs)(x,{children:[(0,r.jsxs)(m,{children:[(0,r.jsx)(g,{children:(0,r.jsx)(u,{onClick:S,title:c?"Expand sidebar":"Collapse sidebar",children:(0,r.jsx)(l.A,{size:17})})}),(0,r.jsxs)(p,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:["Atl",(0,r.jsx)("span",{children:"antis"})]}),t&&(0,r.jsx)(f,{children:t}),n&&(0,r.jsx)(h,{children:n})]}),(0,r.jsxs)(y,{children:[(0,r.jsx)(b,{collapsed:c,children:(0,r.jsx)(z,{children:e})}),(0,r.jsx)(w,{children:a})]}),$&&(0,r.jsx)(i.Suspense,{fallback:null,children:(0,r.jsx)(M,{activeId:d})})]})})}var $=o(255),j=o(9753),k=o(5185);const S=t.default.div`
  display: grid;
