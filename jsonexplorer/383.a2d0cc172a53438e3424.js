"use strict";(self.webpackChunk_atlantis_jsonexplorer=self.webpackChunk_atlantis_jsonexplorer||[]).push([[383],{4914(a,o,e){e.d(o,{FlyoutPanel:()=>z});var n=e(7359),t=e(3233),i=e(7207),r=e(255),l=e(217),s=e(5959),m=e(5185),c=e(5723);const d=i.keyframes`
...
`;function p({iconKey:a}){const o=a?m.t[a]??r.A:r.A;return(0,c.jsx)(o,{size:14,strokeWidth:1.75})}function y({entries:a,activeId:o,onSelect:e}){return(0,c.jsx)(c.Fragment,{children:a.map(a=>a.children?(0,c.jsx)(n.Fragment,{children:(0,c.jsx)(y,{entries:a.children,activeId:o,onSelect:e})},a.id):(0,c.jsxs)(f,{active:o===a.id,onClick:()=>e(a),children:[(0,c.jsx)(p,{iconKey:a.icon}),a.name]},a.id))})}function z({activeId:a}){const{flyout:o,scheduleFlyoutClose:e,cancelFlyoutClose:n}=(0,s.c)();if(!o)return null;const t=o.entry.icon?m.t[o.entry.icon]??r.A:r.A;return(0,c.jsxs)(u,{anchorY:o.anchorY,onMouseEnter:n,onMouseLeave:e,children:[(0,c.jsxs)(g,{children:[(0,c.jsx)(t,{size:13,strokeWidth:2}),o.entry.name]}),(0,c.jsx)(y,{entries:o.entry.children??[],activeId:a,onSelect:a=>{o.onSelect(a),e()}})]})}},5959(a,o,e){e.d(o,{c:()=>i});var n=e(7359);const t=(0,n.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),i=()=>(0,n.useContext)(t)},5185(a,o,e){e.d(o,{t:()=>Y});var n=e(9510),t=e(9038),i=e(8207),r=e(6896),l=e(7901),s=e(9848),m=e(2164),c=e(3775),d=e(3539),u=e(1783),g=e(1837),f=e(2314),p=e(5751),y=e(255),z=e(9633),b=e(2946),h=e(822),x=e(6720),A=e(3317),w=e(2709),v=e(3517),k=e(7032),$=e(6949),S=e(8218),j=e(6829),B=e(5553),M=e(9591),E=e(2820),P=e(4621),T=e(6673),C=e(9033),L=e(1365),D=e(5912),N=e(8641),F=e(3249),R=e(1821),K=e(9161),I=e(1849),G=e(7747),_=e(2932),H=e(4525),O=e(7230);const Y={activity:r.A,"bar-chart-2":n.A,book:s.A,"book-open":l.A,calendar:c.A,clock:u.A,"circle-dot":d.A,feather:f.A,"file-text":p.A,globe:x.A,hash:A.A,heart:w.A,landmark:v.A,layers:i.A,leaf:$.A,map:M.A,package:T.A,compass:g.A,"git-branch":b.A,github:h.A,minus:P.A,terminal:F.A,thermometer:R.A,users:I.A,wind:G.A,"pie-chart":t.A,plus:L.A,slash:D.A,star:N.A,zap:O.A,bot:m.A,lightbulb:S.A,"message-square":E.A,wrench:_.A,x:H.A,"layout-grid":k.A,list:j.A,file:y.A,folder:z.A,"map-pin":B.A,"pen-tool":C.A,type:K.A}},4079(a,o,e){e.d(o,{UO:()=>K,MJ:()=>k,KL:()=>f,w4:()=>n.w,mZ:()=>p});var n=e(217),t=e(7359),i=e(3233),r=e(5723);i.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,i.default.div`
  position: relative;
`,e(5959);const l="260px",s="56px";i.default.header`
  display: flex;
  align-items: center;
  height: ${"48px"};
...
`,A=i.default.button`
  ...
  background: ${({primary:a,danger:o})=>o?"rgba(248,81,73,0.15)":a?n.w.colors.accent:"none"};
  color: ${({primary:a,danger:o})=>o?"#f85149":a?"#fff":n.w.colors.mainText};
  border: 1px solid ${({primary:a,danger:o})=>o?"#f85149":a?n.w.colors.accent:n.w.colors.border};
...
`,v=i.default.div`
  ...
  color: ${n.w.colors.sidebarTextMuted};
  font-family: ${n.w.typography.fontFamily};
`;function k({onSave:a,onUpdate:o,onCancel:e,existingDoc:n}){const[i,l]=(0,t.useState)(n?.name??""),s=(0,t.useRef)(null);return(0,t.useEffect)(()=>{s.current?.focus(),n&&s.current?.select()},[n]),(0,r.jsx)(y,{onClick:e,children:(0,r.jsxs)(z,{onClick:a=>a.stopPropagation(),children:[(0,r.jsx)(b,{children:"Save document"}),n&&o&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(v,{children:"Update the current version or save as a new one."}),(0,r.jsxs)(x,{children:[(0,r.jsx)(A,{onClick:e,children:"Cancel"}),(0,r.jsxs)(A,{danger:!0,onClick:o,children:['Update "',n.name,'"']})]}),(0,r.jsx)(w,{})]}),(0,r.jsx)(h,{ref:s,value:i,onChange:a=>l(a.target.value),onKeyDown:t=>{"Enter"===t.key&&i.trim()&&(n&&i.trim()===n.name&&o?o():a(i.trim())),"Escape"===t.key&&e()},placeholder:n?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,r.jsxs)(x,{children:[!n&&(0,r.jsx)(A,{onClick:e,children:"Cancel"}),(0,r.jsx)(A,{primary:!0,disabled:!i.trim(),onClick:()=>a(i.trim()),children:"Save as new"})]})]})})}var $=e(8006),S=e(679),j=e(4872);const B=i.default.div`
  position: relative;
`,M=i.default.button`
  display: flex;
  align-items: center;
