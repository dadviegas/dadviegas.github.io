...
`,w=i.default.main`
  ...
  display: flex;
  flex-direction: column;
`,v="atlantis:sidebar-collapsed";function A({sidebar:e,children:a,topBarRight:o,title:i="Atlantis",activeId:c=null}){const[d,A]=(0,t.useState)(()=>{try{return"true"===localStorage.getItem(v)}catch{return!1}}),[$,M]=(0,t.useState)(null),k=(0,t.useRef)(),S=()=>A(e=>{const a=!e;try{localStorage.setItem(v,String(a))}catch{}return a}),j=t.useMemo(()=>t.lazy(()=>Promise.resolve().then(n.bind(n,4914)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(s.I.Provider,{value:{collapsed:d,toggle:S,flyout:$,openFlyout:(e,a,n)=>{clearTimeout(k.current),M({entry:e,anchorY:a,onSelect:n})},scheduleFlyoutClose:()=>{k.current=setTimeout(()=>M(null),160)},cancelFlyoutClose:()=>clearTimeout(k.current)},children:(0,r.jsxs)(x,{children:[(0,r.jsxs)(m,{children:[(0,r.jsx)(u,{children:(0,r.jsx)(f,{onClick:S,title:d?"Expand sidebar":"Collapse sidebar",children:(0,r.jsx)(l.A,{size:17})})}),(0,r.jsxs)(g,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:["Atl",(0,r.jsx)("span",{children:"antis"})]}),i&&(0,r.jsx)(p,{children:i}),o&&(0,r.jsx)(h,{children:o})]}),(0,r.jsxs)(y,{children:[(0,r.jsx)(b,{collapsed:d,children:(0,r.jsx)(z,{children:e})}),(0,r.jsx)(w,{children:a})]}),$&&(0,r.jsx)(t.Suspense,{fallback:null,children:(0,r.jsx)(j,{activeId:c})})]})})}var $=n(255),M=n(9753),k=n(5185);const S=i.default.div`
  display: grid;
...
`;function te({onSave:e,onCancel:a}){const[n,o]=(0,t.useState)(""),i=(0,t.useRef)(null);return(0,t.useEffect)(()=>{i.current?.focus()},[]),(0,r.jsx)(Q,{onClick:a,children:(0,r.jsxs)(X,{onClick:e=>e.stopPropagation(),children:[(0,r.jsx)(ee,{children:"Save document"}),(0,r.jsx)(ae,{ref:i,value:n,onChange:e=>o(e.target.value),onKeyDown:o=>{"Enter"===o.key&&n.trim()&&e(n.trim()),"Escape"===o.key&&a()},placeholder:"Give this version a name…",maxLength:80}),(0,r.jsxs)(ne,{children:[(0,r.jsx)(oe,{onClick:a,children:"Cancel"}),(0,r.jsx)(oe,{primary:!0,disabled:!n.trim(),onClick:()=>e(n.trim()),children:"Save"})]})]})})}i.default.div`
  position: relative;
`,i.default.button`
  display: flex;
  align-items: center;
