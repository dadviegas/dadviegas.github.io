...
`,E="atlantis:earth:recent";function F(){try{return JSON.parse(localStorage.getItem(E)??"[]")}catch{return[]}}function T(e,t){const r=[t,...e.filter(e=>e!==t)].slice(0,8);return function(e){try{localStorage.setItem(E,JSON.stringify(e))}catch{}}(r),r}function M(e,t){return`${Math.abs(e).toFixed(3)}°${e>=0?"N":"S"}, ${Math.abs(t).toFixed(3)}°${t>=0?"E":"W"}`}function C({topBarRight:e}){const t=(0,o.useRef)(null),r=(0,o.useRef)(null),n=(0,o.useRef)(new Map),a=(0,o.useRef)(null),[E,C]=(0,o.useState)({lat:0,lng:0,zoom:2}),[R,I]=(0,o.useState)(!1),[L,A]=(0,o.useState)(null),[B,N]=(0,o.useState)(null),[O,H]=(0,o.useState)(F),[W,_]=(0,o.useState)(()=>new Date),[D,J]=(0,o.useState)(null),[P,q]=(0,o.useState)(!1),[G,Z]=(0,o.useState)(!1),[K,U]=(0,o.useState)(null),[Q,V]=(0,o.useState)(!0),[X,Y]=(0,o.useState)(!1),[ee,te]=(0,o.useState)(u),re=(0,o.useCallback)(e=>{te(t=>{const r=new Set(t);return r.has(e)?r.delete(e):r.add(e),r})},[]);(0,o.useEffect)(()=>{const e=setInterval(()=>_(new Date),1e3);return()=>clearInterval(e)},[]),(0,o.useEffect)(()=>{!async function(){try{if((await(0,l.Iu)(d)).length>0)return;const e={version:2,enabled:["night"],satellite:!1,showFlags:!0,note:'Earth — Layer Enhancements\n\nNEW LAYERS\n  🌌 Aurora    NOAA SWPC aurora oval + live Kp index badge\n  🔥 Fires     NASA EONET active wildfire markers (30-min refresh)\n  📏 Measure   Click 2 points → great-circle distance (km / nm / mi)\n\nFLIGHTS  ✈\n  Altitude color   grey = ground  orange = <10k ft  amber = <25k ft  blue = cruise\n  Position trail   last 15 positions drawn behind each aircraft\n  Stale pruning    aircraft auto-removed after ~50 s without a ping\n  Follow mode      "📍 Follow" in popup — map pans to track the plane\n\nISS  🛸\n  Footprint circle   ~2 316 km radius showing who can currently see the ISS\n\nWEATHER PANEL\n  Temperature chart  hourly actual + feels-like dual-line SVG chart\n  Feels-like + RH    current-hour apparent temperature & relative humidity\n  AQI badge          US Air Quality Index from Open-Meteo (color-coded)\n\nMAP\n  🛰 Satellite   ESRI World Imagery tiles (dark-mode filter auto-disabled)\n  Right-click    instant weather panel for any coordinate on the map\n'};await(0,l.KL)(d,"Earth Changelog — Apr 2026",JSON.stringify(e))}catch{}}()},[]);const oe=(0,o.useCallback)(async e=>{const t={version:2,enabled:Array.from(ee),satellite:X,showFlags:Q};await(0,l.KL)(d,e,JSON.stringify(t)),Z(!1)},[ee,X,Q]),ne=((0,o.useCallback)(e=>{try{const t=JSON.parse(e);if(2===t.version){const e=t;Y(e.satellite),V(e.showFlags),te(new Set(e.enabled)),e.note&&U(e.note)}else if(1===t.version){const e=t.layers;Y(Boolean(e.satellite)),V(Boolean(e.showFlags));const r=new Set;for(const t of["night","aurora","iss","quakes","fires","radar","flights","measure"])e[t]&&r.add(t);te(r),t.note&&U(t.note)}}catch{}},[]),(0,o.useCallback)(e=>{const t=l.rh.find(t=>t.id===e);t&&r.current&&(r.current.flyTo([t.lat,t.lng],t.zoom,{duration:1.2}),A(e),N({id:t.id,name:`${t.flag} ${t.name}`,lat:t.lat,lng:t.lng}),H(t=>T(t,e)))},[]));(0,o.useEffect)(()=>{a.current&&a.current.setUrl(X?"https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}":p)},[X]),(0,o.useEffect)(()=>{n.current.forEach((e,t)=>{const r=e.getElement()?.querySelector(".flag-marker");r&&r.classList.toggle("active",t===L)})},[L]),(0,o.useEffect)(()=>{D&&n.current.forEach(e=>{Q?e.addTo(D):e.remove()})},[Q,D]),(0,o.useEffect)(()=>{!function(e){if(document.querySelector(`link[href="${e}"]`))return;const t=document.createElement("link");t.rel="stylesheet",t.href=e,document.head.appendChild(t)}("https://unpkg.com/leaflet@1.9.4/dist/leaflet.css"),function(e){return new Promise((t,r)=>{if(document.querySelector(`script[src="${e}"]`))return void t();const o=document.createElement("script");o.src=e,o.onload=()=>t(),o.onerror=r,document.head.appendChild(o)})}("https://unpkg.com/leaflet@1.9.4/dist/leaflet.js").then(()=>I(!0))},[]),(0,o.useEffect)(()=>{if(!R||!t.current||r.current)return;const e=window.L,o=e.map(t.current,{center:[20,0],zoom:2,zoomControl:!0,attributionControl:!1}),i=e.tileLayer(p,{attribution:'&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a>',maxZoom:19}).addTo(o);return a.current=i,o.on("mousemove",e=>{C(t=>({...t,lat:e.latlng.lat,lng:e.latlng.lng}))}),o.on("zoomend",()=>{C(e=>({...e,zoom:o.getZoom()}))}),o.on("contextmenu",e=>{const{lat:t,lng:r}=e.latlng,o=`custom-${t.toFixed(4)}-${r.toFixed(4)}`;A(null),N({id:o,name:M(t,r),lat:t,lng:r}),q(!0),setTimeout(()=>q(!1),3200)}),l.rh.forEach(t=>{const r=e.divIcon({html:`<div class="flag-marker">${t.flag}</div>`,className:"",iconSize:[28,28],iconAnchor:[14,14]}),a=e.marker([t.lat,t.lng],{icon:r});a.on("click",()=>{o.flyTo([t.lat,t.lng],t.zoom,{duration:1.2}),A(t.id),N({id:t.id,name:`${t.flag} ${t.name}`,lat:t.lat,lng:t.lng}),H(e=>T(e,t.id))}),a.addTo(o),n.current.set(t.id,a)}),r.current=o,J(o),()=>{n.current.clear(),a.current=null,o.remove(),r.current=null,J(null)}},[R]);const ae=(0,o.useMemo)(()=>L?l.rh.find(e=>e.id===L)??null:null,[L]),le=(0,o.useMemo)(()=>(0,l.qs)(O),[O]),ie=E.zoom>=5,se=(0,o.useMemo)(()=>(0,s.xy)(),[]),ce=[{label:"🛰 Satellite",active:X,toggle:()=>Y(e=>!e),title:"Switch to satellite imagery"},{label:"🚩 Flags",active:Q,toggle:()=>V(e=>!e),title:"Toggle place markers"},...se.map(e=>{const t=ee.has(e.id),r="flights"===e.id&&t&&!ie;return{label:r?"✈ Zoom in":"measure"===e.id&&t?"📏 Measuring…":e.label,active:t,toggle:()=>re(e.id),title:r?"Zoom to level 5+ to see flights":e.title}})],de=(0,c.jsx)(c.Fragment,{children:(0,c.jsxs)(y,{onClick:()=>Z(!0),title:"Save current view",children:[(0,c.jsxs)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,c.jsx)("path",{d:"M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2z"}),(0,c.jsx)("polyline",{points:"17 21 17 13 7 13 7 21"}),(0,c.jsx)("polyline",{points:"7 3 7 8 15 8"})]}),"Save"]})}),ue=(0,c.jsxs)(w,{onClick:()=>{r.current?.flyTo([20,0],2,{duration:1.2}),A(null),N(null)},title:"Reset to world view",children:[(0,c.jsxs)("svg",{width:14,height:14,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,c.jsx)("circle",{cx:"12",cy:"12",r:"10"}),(0,c.jsx)("line",{x1:"2",y1:"12",x2:"22",y2:"12"}),(0,c.jsx)("path",{d:"M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"})]}),"World"]}),pe=(0,c.jsx)(l.CD,{entries:le,activeId:L,onSelect:function(e){e.id.startsWith("country-")||"__recent__"===e.id||ne(e.id)}});return(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)(l.PE,{title:"Earth",sidebar:pe,activeId:L,topBarRight:(0,c.jsxs)(c.Fragment,{children:[ce.map(e=>(0,c.jsx)(b,{active:e.active,onClick:e.toggle,title:e.title,children:e.label},e.label)),ue,de,e]}),children:(0,c.jsxs)(m,{children:[(0,c.jsxs)(x,{children:[(0,c.jsx)(f,{satellite:X,children:(0,c.jsx)("div",{ref:t,style:{height:"100%",width:"100%"}})}),se.map(e=>{const t=e.component,r="flights"===e.id?{zoom:E.zoom}:{};return(0,c.jsx)(t,{map:D,enabled:ee.has(e.id),...r},e.id)}),P&&(0,c.jsx)(z,{children:"Right-click anywhere for instant weather"}),(0,c.jsxs)(v,{visible:!!K,children:[(0,c.jsxs)(k,{children:[(0,c.jsx)($,{children:"Document note"}),(0,c.jsx)(S,{onClick:()=>U(null),children:"✕"})]}),(0,c.jsx)(j,{children:K??""})]}),(0,c.jsx)(i.v,{place:B,onClose:()=>{A(null),N(null)}})]}),(0,c.jsxs)(h,{children:[(0,c.jsxs)("span",{children:["Lat: ",E.lat.toFixed(4)]}),(0,c.jsxs)("span",{children:["Lng: ",E.lng.toFixed(4)]}),(0,c.jsxs)("span",{children:["Zoom: ",E.zoom]}),(0,c.jsx)(g,{children:"|"}),(0,c.jsxs)("span",{children:["UTC ",(0,l.u6)(W)]}),ae&&(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)(g,{children:"·"}),(0,c.jsxs)("span",{children:[ae.flag," ",ae.name," ",(0,l.w3)(W,ae.timezone)]}),(0,c.jsx)(g,{children:"·"}),(0,c.jsx)("span",{children:(0,l.$L)(W,ae.timezone)})]}),(0,c.jsx)("span",{style:{marginLeft:"auto"},children:X?"© Esri, DigitalGlobe, GeoEye":"© OpenStreetMap contributors"})]})]})}),G&&(0,c.jsx)(l.MJ,{onSave:oe,onCancel:()=>Z(!1)})]})}const R=document.getElementById("root");if(!R)throw new Error("Root element #root not found");(0,n.H)(R).render((0,c.jsx)(C,{}))},8997(e,t,r){var o=r(8991);t.H=o.createRoot,o.hydrateRoot}}]);
//# sourceMappingURL=188.9d379cc0d40bb556aa49.js.map