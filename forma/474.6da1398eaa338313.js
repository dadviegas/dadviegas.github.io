"use strict";(self.webpackChunk_atlantis_forma=self.webpackChunk_atlantis_forma||[]).push([["474"],{7103(e,o,r){r.d(o,{j:()=>h});var t=r(5723),a=r(7991),i=r(6859),n=r.n(i),l=r(4764),s=r(5030),d=r(6107);let c=n().section`
...
`;function h({data:e,t:o,locale:r}){let[i,n]=(0,a.useState)(null),[m,u]=(0,a.useState)(""),[b,w]=(0,a.useState)(!1),[y,$]=(0,a.useState)(null);(0,a.useEffect)(()=>{(0,d.resolveGroqKey)().then(e=>n(!!e))},[]);let v=(0,a.useCallback)(async()=>{w(!0),$(null),u("");try{let t,a,i,n,l,s,c,p,g,f,x=await (0,d.resolveGroqKey)();if(!x){$(o("forma.ask.noKey")),w(!1);return}let h=(t=new Date().toISOString().slice(0,10),a=(0,d.proteinByDay)(e.meals,t),i=e.meals.filter(e=>e.date===t).reduce((e,o)=>e+(o.kcal??0),0),n=e.walks.filter(e=>e.date===t).reduce((e,o)=>e+o.minutes,0),l=(function(){let e=[],o=new Date;for(let r=6;r>=0;r-=1){let t=new Date(o);t.setDate(o.getDate()-r),e.push(t.toISOString().slice(0,10))}return e})().map(o=>({date:o,protein:(0,d.proteinByDay)(e.meals,o),kcal:e.meals.filter(e=>e.date===o).reduce((e,o)=>e+(o.kcal??0),0),walk:e.walks.filter(e=>e.date===o).reduce((e,o)=>e+o.minutes,0)})),(s=new Date).setDate(s.getDate()-6),c=(0,d.weeklyAdherence)(e.sessions,s,e.goal.weeklyFasts),p=(0,d.streakDays)(e.sessions,e.goal.targetHours),g=(0,d.avgFastDuration)(e.sessions,30),f=e.meals.filter(e=>e.date>=l[0].date).slice(-15).map(e=>`${e.date} ${e.slot} \xb7 ${e.proteinG??0}g protein \xb7 ${e.kcal??0}kcal \xb7 ${e.notes||""}`).join("\n"),`You are a concise nutrition + habit coach. Reply in ${"pt"===r?"Portuguese (PT-PT)":"English"}, max 5 short bullet points.
...
Give 3–5 bullets: what's going well, what to fix, one specific next-meal suggestion.`);await (0,d.askGroqStream)(h,{key:x,locale:r,maxTokens:400,onChunk:e=>u(e)})}catch(e){$(e instanceof Error?e.message:o("forma.ask.error"))}finally{w(!1)}},[e,r,o]);return null===i||!1===i?null:(0,t.jsxs)(c,{children:[(0,t.jsxs)(p,{children:[(0,t.jsxs)(g,{children:["✦ ",o("forma.ask.title")]}),(0,t.jsx)(s.$n,{variant:"accent",icon:(0,t.jsx)(s.In,{name:"message",size:14}),onClick:()=>void v(),disabled:b,children:b?o("forma.ask.loading"):o("forma.ask.button")})]}),y&&(0,t.jsx)(x,{children:y}),(m||b)&&(0,t.jsx)(f,{children:m||"…"}),!m&&!b&&!y&&(0,t.jsx)(f,{style:{color:l.w4.colors.mainTextMuted,fontStyle:"italic"},children:o("forma.ask.hint")})]})}},2552(e,o,r){r.d(o,{k:()=>z});var t=r(5723),a=r(7991),i=r(6859),n=r.n(i),l=r(4764),s=r(5030),d=r(6107);let c="#7fb77e",p=2*Math.PI*95,g=n().div`
  display: flex;
  flex-direction: column;
  align-items: center;
  gap: ${l.w4.spacing.md};
...
`,M=n().span`
  ...
  text-transform: uppercase;
  letter-spacing: 0.16em;
`;function z({data:e,t:o,onStart:r,onStop:i,onEditStart:n}){let j,T,F,S,C,[H,R]=(0,a.useState)(Date.now),L=e.sessions.some(e=>void 0===e.endedAt);(0,a.useEffect)(()=>{if(!L)return;let e=setInterval(()=>R(Date.now()),1e3);return()=>clearInterval(e)},[L]);let A=(0,d.currentFast)(e,H),B=A?.percent??0,D=null!==A,V=A?A.hoursElapsed:0,Y=A?A.remainingMs:0,P=A?A.session.targetHours:e.goal.targetHours;return(0,t.jsxs)(g,{children:[(0,t.jsxs)(f,{children:[(0,t.jsxs)(x,{width:200,height:200,viewBox:"0 0 200 200","aria-hidden":"true",children:[(0,t.jsx)("circle",{cx:100,cy:100,r:95,fill:"none",stroke:l.w4.colors.border,strokeWidth:10}),(0,t.jsx)("circle",{cx:100,cy:100,r:95,fill:"none",stroke:c,strokeWidth:10,strokeLinecap:"round",strokeDasharray:p,strokeDashoffset:p*(1-B),style:{transition:"stroke-dashoffset 0.6s ease"}})]}),(0,t.jsx)(h,{children:D?(0,t.jsxs)(t.Fragment,{children:[(0,t.jsxs)(m,{children:[V.toFixed(1),"h"]}),(0,t.jsx)(u,{children:o("forma.timer.elapsed")})]}):(0,t.jsxs)(t.Fragment,{children:[(0,t.jsxs)(m,{children:[P,"h"]}),(0,t.jsx)(u,{children:o("forma.hero.notFasting")})]})})]}),D&&A&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsxs)(y,{children:[(0,t.jsx)(b,{children:A.session.protocol}),n&&(0,t.jsx)($,{type:"button",onClick:()=>n(A.session),title:o("forma.timer.editStart"),children:o("forma.timer.startedAt",{time:(T=String((j=new Date(A.session.startedAt)).getHours()).padStart(2,"0"),F=String(j.getMinutes()).padStart(2,"0"),`${T}:${F}`)})})]}),(0,t.jsxs)(w,{children:[(0,t.jsxs)(v,{children:[(0,t.jsx)(k,{children:(C=Math.floor((S=Math.floor(Y/6e4))/60),`${String(C).padStart(2,"0")}:${String(S%60).padStart(2,"0")}`)}),(0,t.jsx)(M,{children:o("forma.timer.remaining")})]}),(0,t.jsxs)(v,{children:[(0,t.jsxs)(k,{children:[Math.round(100*B),"%"]}),(0,t.jsx)(M,{children:o("forma.timer.complete")})]})]})]}),D&&A?(0,t.jsx)(s.$n,{variant:"danger",onClick:()=>i(A.session),children:o("forma.stop")}):(0,t.jsx)(s.$n,{variant:"success",onClick:r,children:o("forma.start")})]})}},9276(e,o,r){r.d(o,{Y:()=>S});var t=r(5723),a=r(7991),i=r(6859),n=r.n(i),l=r(4764),s=r(5030),d=r(2799);let c=(0,d.keyframes)`
...
`,m=n().div`
  ...
  min-height: 0;
  overflow-y: auto;
`;function u({open:e,onClose:o,children:r,maxWidth:i=480,ariaLabel:n}){let l=(0,a.useRef)(null);(0,a.useEffect)(()=>{if(!e)return;let r=e=>{"Escape"===e.key&&o()};return window.addEventListener("keydown",r),()=>window.removeEventListener("keydown",r)},[e,o]),(0,a.useEffect)(()=>{if(!e||!l.current)return;let o=l.current.querySelector('button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])');o?.focus()},[e]);let s=(0,a.useRef)(null),d=(0,a.useCallback)(e=>{s.current={y:e.touches[0].clientY}},[]),c=(0,a.useCallback)(e=>{if(!s.current||!l.current)return;let r=e.changedTouches[0].clientY-s.current.y;s.current=null,r<=0||r/l.current.getBoundingClientRect().height>.3&&o()},[o]),p=(0,a.useRef)(null),b=(0,a.useCallback)(e=>{p.current={y:e.clientY}},[]),w=(0,a.useCallback)(e=>{if(!p.current||!l.current)return;let r=e.clientY-p.current.y;p.current=null,r<=0||r/l.current.getBoundingClientRect().height>.3&&o()},[o]);return e?(0,t.jsx)(g,{onClick:o,role:"dialog","aria-modal":"true","aria-label":n,children:(0,t.jsxs)(f,{ref:l,maxWidth:i,onClick:e=>e.stopPropagation(),children:[(0,t.jsx)(x,{onTouchStart:d,onTouchEnd:c,onPointerDown:b,onPointerUp:w,"aria-hidden":"true",children:(0,t.jsx)(h,{})}),(0,t.jsx)(m,{children:r})]})}):null}let b="#7fb77e",w=n().div`
...
`;function S({open:e,onClose:o,data:r,t:i,onStartFast:n,onStopFast:l,onLogMeal:d,onLogWeight:c,onLogWalk:p}){let[g,f]=(0,a.useState)(null),[x,h]=(0,a.useState)("16:8"),[m,b]=(0,a.useState)("16"),[C,H]=(0,a.useState)("dinner"),[R,L]=(0,a.useState)(""),[A,B]=(0,a.useState)(""),[D,V]=(0,a.useState)(""),[Y,P]=(0,a.useState)(""),[I,E]=(0,a.useState)(""),O=r.sessions.some(e=>void 0===e.endedAt),W=(0,a.useCallback)(()=>{f(null)},[]),N=(0,a.useCallback)(()=>{W(),o()},[W,o]),q=(0,a.useCallback)(()=>{let e=parseInt(m,10);isNaN(e)||e<1||(n(x,e),N())},[x,m,n,N]),G=(0,a.useCallback)(()=>{d(C,parseFloat(R)||0,parseFloat(A)||0,D.trim()),N()},[C,R,A,D,d,N]),K=(0,a.useCallback)(()=>{let e=parseFloat(Y.replace(",","."));isNaN(e)||e<=0||(c(e),N())},[Y,c,N]),Z=(0,a.useCallback)(()=>{let e=parseInt(I,10);isNaN(e)||e<=0||(p(e),N())},[I,p,N]);return(0,t.jsx)(u,{open:e,onClose:N,maxWidth:520,ariaLabel:i("forma.sheet.ariaLabel"),children:(0,t.jsxs)(w,{children:[(0,t.jsx)(s.YZ,{children:i("forma.sheet.title")}),(0,t.jsx)($,{children:(0,t.jsx)(s.YZ,{children:i("forma.sheet.fastSection")})}),O?(0,t.jsx)(s.$n,{variant:"danger",onClick:()=>{l(),N()},children:i("forma.stop")}):"startFast"===g?(0,t.jsxs)(y,{children:[(0,t.jsxs)(v,{children:[(0,t.jsx)(k,{htmlFor:"fast-protocol",children:i("forma.rail.title")}),(0,t.jsxs)(z,{id:"fast-protocol",value:x,onChange:e=>{let o=e.target.value;h(o),"custom"!==o&&b(o.split(":")[0])},children:[(0,t.jsx)("option",{value:"16:8",children:"16:8"}),(0,t.jsx)("option",{value:"18:6",children:"18:6"}),(0,t.jsx)("option",{value:"20:4",children:"20:4"}),(0,t.jsx)("option",{value:"custom",children:i("forma.protocol.custom")})]})]}),"custom"===x&&(0,t.jsxs)(v,{children:[(0,t.jsx)(k,{htmlFor:"fast-hours",children:i("forma.timer.target")}),(0,t.jsx)(M,{id:"fast-hours",type:"number",value:m,min:1,max:72,onChange:e=>b(e.target.value)})]}),(0,t.jsxs)(F,{children:[(0,t.jsx)(s.$n,{variant:"success",onClick:q,children:i("forma.start")}),(0,t.jsx)(s.$n,{variant:"ghost",onClick:W,children:i("forma.sheet.cancel")})]})]}):(0,t.jsxs)(T,{onClick:()=>f("startFast"),children:[(0,t.jsx)(s.In,{name:"play",size:16}),i("forma.start")]}),(0,t.jsx)($,{children:(0,t.jsx)(s.YZ,{children:i("forma.sheet.mealSection")})}),"meal"===g?(0,t.jsxs)(y,{children:[(0,t.jsxs)(v,{children:[(0,t.jsx)(k,{htmlFor:"meal-slot",children:i("forma.meal.lunch")}),(0,t.jsxs)(j,{id:"meal-slot",value:C,onChange:e=>H(e.target.value),children:[(0,t.jsx)("option",{value:"lunch",children:i("forma.meal.lunch")}),(0,t.jsx)("option",{value:"dinner",children:i("forma.meal.dinner")}),(0,t.jsx)("option",{value:"snack",children:i("forma.meal.snack")})]})]}),(0,t.jsxs)(v,{children:[(0,t.jsx)(k,{htmlFor:"meal-protein",children:i("forma.sheet.proteinLabel")}),(0,t.jsx)(M,{id:"meal-protein",type:"number",value:R,min:0,placeholder:"0",onChange:e=>L(e.target.value)})]}),(0,t.jsxs)(v,{children:[(0,t.jsx)(k,{htmlFor:"meal-kcal",children:i("forma.sheet.kcalLabel")}),(0,t.jsx)(M,{id:"meal-kcal",type:"number",value:A,min:0,placeholder:"0",onChange:e=>B(e.target.value)})]}),(0,t.jsxs)(v,{children:[(0,t.jsx)(k,{htmlFor:"meal-notes",children:i("forma.meal.template")}),(0,t.jsx)(M,{id:"meal-notes",type:"text",value:D,placeholder:"ovos, frango…",onChange:e=>V(e.target.value)})]}),(0,t.jsxs)(F,{children:[(0,t.jsx)(s.$n,{variant:"primary",onClick:G,children:i("forma.sheet.save")}),(0,t.jsx)(s.$n,{variant:"ghost",onClick:W,children:i("forma.sheet.cancel")})]})]}):(0,t.jsxs)(T,{onClick:()=>f("meal"),children:[(0,t.jsx)(s.In,{name:"utensils",size:16}),i("forma.sheet.logMeal")]}),(0,t.jsx)($,{children:(0,t.jsx)(s.YZ,{children:i("forma.sheet.weightSection")})}),"weight"===g?(0,t.jsxs)(y,{children:[(0,t.jsxs)(v,{children:[(0,t.jsx)(k,{htmlFor:"weight-kg",children:i("forma.sheet.weightLabel")}),(0,t.jsx)(M,{id:"weight-kg",type:"number",value:Y,min:20,max:300,step:.1,placeholder:"84.2",onChange:e=>P(e.target.value)})]}),(0,t.jsxs)(F,{children:[(0,t.jsx)(s.$n,{variant:"primary",onClick:K,children:i("forma.sheet.save")}),(0,t.jsx)(s.$n,{variant:"ghost",onClick:W,children:i("forma.sheet.cancel")})]})]}):(0,t.jsxs)(T,{onClick:()=>f("weight"),children:[(0,t.jsx)(s.In,{name:"trending-up",size:16}),i("forma.sheet.logWeight")]}),(0,t.jsx)($,{children:(0,t.jsx)(s.YZ,{children:i("forma.sheet.walkSection")})}),"walk"===g?(0,t.jsxs)(y,{children:[(0,t.jsxs)(v,{children:[(0,t.jsx)(k,{htmlFor:"walk-min",children:i("forma.sheet.walkLabel")}),(0,t.jsx)(M,{id:"walk-min",type:"number",value:I,min:1,max:600,placeholder:"30",onChange:e=>E(e.target.value)})]}),(0,t.jsxs)(F,{children:[(0,t.jsx)(s.$n,{variant:"primary",onClick:Z,children:i("forma.sheet.save")}),(0,t.jsx)(s.$n,{variant:"ghost",onClick:W,children:i("forma.sheet.cancel")})]})]}):(0,t.jsxs)(T,{onClick:()=>f("walk"),children:[(0,t.jsx)(s.In,{name:"activity",size:16}),i("forma.sheet.logWalk")]})]})})}},8477(e,o,r){r.d(o,{P:()=>p});var t=r(5723),a=r(6859),i=r.n(a),n=r(4764);let l="#7fb77e",s=["16:8","18:6","20:4","custom"],d=i().div`
  display: flex;
  gap: ${n.w4.spacing.sm};
  overflow-x: auto;
...
`,c=i().button`
  ...
  padding: 4px 12px;
  border-radius: 20px;
  border: 1px solid ${({active:e})=>e?l:n.w4.colors.border};
  background: ${({active:e})=>e?`${l}18`:"transparent"};
  color: ${({active:e})=>e?l:n.w4.colors.mainTextMuted};
  font-size: 13px;
...
`;function p({t:e,active:o,onChange:r}){return(0,t.jsx)(d,{role:"group","aria-label":e("forma.rail.title"),children:s.map(a=>(0,t.jsx)(c,{active:o===a,onClick:()=>r(a),"aria-pressed":o===a,children:e(`forma.protocol.${a}`)},a))})}},1589(e,o,r){r.d(o,{B:()=>x});var t=r(5723),a=r(6859),i=r.n(a),n=r(4764);let l="#7fb77e",s=[{id:"16:8",fastH:16,windowH:8},{id:"18:6",fastH:18,windowH:6},{id:"20:4",fastH:20,windowH:4},{id:"custom",fastH:0,windowH:0}],d=i().aside`
  width: 260px;
  flex-shrink: 0;
...
`,p=i().button`
  ...
  border-left: 2px solid ${({active:e})=>e?l:"transparent"};
  cursor: pointer;
  text-align: left;
...
`,g=i().span`
  font-size: 13px;
  font-weight: 600;
  color: ${({active:e})=>e?l:n.w4.colors.mainText};
`,f=i().span`
  font-size: 11px;
  font-family: ${n.w4.typography.fontFamilyMono};
  color: ${n.w4.colors.mainTextMuted};
`;function x({t:e,active:o,onChange:r}){return(0,t.jsxs)(d,{"aria-label":e("forma.rail.title"),children:[(0,t.jsx)(c,{children:e("forma.rail.title")}),s.map(a=>(0,t.jsxs)(p,{active:o===a.id,onClick:()=>r(a.id),"aria-pressed":o===a.id,children:[(0,t.jsx)(g,{active:o===a.id,children:e(`forma.protocol.${a.id}`)}),a.fastH>0&&(0,t.jsxs)(f,{children:[e("forma.rail.hours",{n:a.fastH})," \xb7 ",e("forma.rail.window",{n:a.windowH})]})]},a.id))]})}},5405(e,o,r){r.d(o,{F:()=>p});var t=r(5723),a=r(7991),i=r(6859),n=r.n(i),l=r(4764);let s=n().form`
  display: flex;
  align-items: center;
  gap: ${l.w4.spacing.sm};
  padding: ${l.w4.spacing.sm} ${l.w4.spacing.md};
...
`,c=n().span`
  ...
  color: ${l.w4.colors.mainTextMuted};
  white-space: nowrap;
`;function p({t:e,onParsed:o}){let[r,i]=(0,a.useState)(""),[n,l]=(0,a.useState)(!1),g=(0,a.useCallback)(e=>{e.preventDefault();let t=function(e){let o=e.trim().toLowerCase();if(!o)return null;let r=o.match(/^(?:peso|weight)\s+(\d+(?:[.,]\d+)?)/);if(r){let e=parseFloat(r[1].replace(",","."));if(!isNaN(e))return{kind:"weight",weightKg:e}}let t=o.match(/^(?:caminhei|walked|walk|caminhada)\s+(\d+)/);if(t){let e=parseInt(t[1],10);if(!isNaN(e))return{kind:"walk",walkMinutes:e}}let a=o.match(/^(?:jejum|fast)\s+(\d+)/);if(a){let e=parseInt(a[1],10);if(!isNaN(e))return{kind:"fast",fastHours:e,fastProtocol:16===e?"16:8":18===e?"18:6":20===e?"20:4":"custom"}}let i=o.match(/^(jantar|almoço|almoco|dinner|snack|lanche|lunch)\s+(.*)/);if(i){let e=i[1];return{kind:"meal",mealSlot:"jantar"===e||"dinner"===e?"dinner":"almo\xe7o"===e||"almoco"===e||"lunch"===e?"lunch":"snack",mealDesc:i[2].trim()}}return null}(r);if(!t){l(!0),setTimeout(()=>l(!1),1200);return}o(t),i("")},[r,o]);return(0,t.jsxs)(s,{onSubmit:g,children:[(0,t.jsx)(d,{value:r,onChange:e=>i(e.target.value),placeholder:e("forma.quickadd.placeholder"),style:{borderColor:n?"#f85149":void 0},"aria-label":e("forma.quickadd.hint")}),(0,t.jsx)(c,{children:e("forma.quickadd.hint")})]})}},5742(e,o,r){r.d(o,{_:()=>F});var t=r(5723),a=r(6859),i=r.n(a),n=r(4764),l=r(5030),s=r(6107);let d="#7fb77e",c=i().section`
...
`,T=i().div`
  ...
  font-family: ${n.w4.typography.fontFamilyMono};
  font-variant-numeric: tabular-nums;
`;function F({data:e,t:o,proteinTargetG:r=110,onLogMeal:a,onLogWalk:i,onLogWeight:d,onDeleteMeal:S}){var C,H;let R=new Date().toISOString().slice(0,10),L=(0,s.proteinByDay)(e.meals,R),A=(C=e.meals,C.filter(e=>e.date===R).reduce((e,o)=>e+(o.kcal??0),0)),B=(H=e.walks,H.filter(e=>e.date===R).reduce((e,o)=>e+o.minutes,0)),D=e.meals.filter(e=>e.date===R).sort((e,o)=>e.createdAt-o.createdAt);return(0,t.jsxs)(c,{children:[(0,t.jsxs)(p,{children:[(0,t.jsxs)(g,{children:["◉ ",o("forma.today.title")]}),(0,t.jsx)(g,{children:new Date().toLocaleDateString(void 0,{weekday:"long",day:"numeric",month:"short"})})]}),(0,t.jsxs)(f,{children:[(0,t.jsxs)(x,{children:[(0,t.jsxs)(h,{children:[Math.round(L),(0,t.jsxs)("span",{style:{fontSize:14,color:n.w4.colors.mainTextMuted,marginLeft:4},children:["/ ",r,"g"]})]}),(0,t.jsx)(m,{children:o("forma.today.protein")})]}),(0,t.jsxs)(x,{children:[(0,t.jsx)(h,{children:Math.round(A)}),(0,t.jsx)(m,{children:o("forma.today.kcal")})]}),(0,t.jsxs)(x,{children:[(0,t.jsxs)(h,{children:[B,(0,t.jsx)("span",{style:{fontSize:14,color:n.w4.colors.mainTextMuted,marginLeft:4},children:"min"})]}),(0,t.jsx)(m,{children:o("forma.today.walk")})]})]}),(0,t.jsx)(u,{children:(0,t.jsx)(b,{pct:L/r*100})}),(0,t.jsxs)(w,{children:[(0,t.jsx)(l.$n,{variant:"primary",icon:(0,t.jsx)(l.In,{name:"plus",size:14}),onClick:a,children:o("forma.action.logMeal")}),(0,t.jsx)(l.$n,{variant:"ghost",icon:(0,t.jsx)(l.In,{name:"plus",size:14}),onClick:i,children:o("forma.action.logWalk")}),(0,t.jsx)(l.$n,{variant:"ghost",icon:(0,t.jsx)(l.In,{name:"plus",size:14}),onClick:d,children:o("forma.action.logWeight")})]}),0===D.length?(0,t.jsx)(j,{children:o("forma.today.noMealsYet")}):(0,t.jsx)(y,{children:D.map(e=>(0,t.jsxs)($,{children:[(0,t.jsx)(v,{children:o(`forma.meal.${e.slot}`)}),(0,t.jsx)(k,{children:e.notes||"—"}),(0,t.jsxs)(M,{children:[e.proteinG??0,"g \xb7 ",e.kcal??0,"kcal"]}),(0,t.jsx)(z,{onClick:()=>S(e.id),"aria-label":o("forma.action.delete"),children:(0,t.jsx)(l.In,{name:"trash",size:14})})]},e.id))}),B>0&&(0,t.jsx)(T,{children:(0,t.jsx)("span",{children:o("forma.today.walkSummary",{min:B})})})]})}},483(e,o,r){r.d(o,{v:()=>v});var t=r(5723),a=r(6859),i=r.n(a),n=r(2799),l=r(4764),s=r(5030);let d="#7fb77e",c=(0,n.keyframes)`
...
`,u=i().div`
  ...
  align-items: center;
  gap: 4px;
  padding: ${l.w4.spacing.sm} ${l.w4.spacing.xs};
  border-radius: ${l.w4.borderRadius.md};
  border: 1px solid ${({isDone:e})=>e?`${d}40`:l.w4.colors.border};
  background: ${({isDone:e,isToday:o})=>e?`${d}10`:o?`${l.w4.colors.surface}`:"transparent"};
...
`,b=i().forwardRef(function({variant:e="ghost",size:o="md",icon:r,iconRight:a,children:i,...n},l){return(0,t.jsxs)(u,{ref:l,variant:e,size:o,...n,children:[r,i,a]})}),w={default:s.w4.colors.accent,danger:"#f85149"},y={default:s.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"};l().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`;let S=l().div`
  ...
  align-items: center;
  gap: 8px;
`;function C({children:e,...o}){return(0,t.jsx)(S,{...o,children:e})}l().label`
  display: flex;
  align-items: center;
  gap: 10px;
...
`,D.A,D.A['pre[class*="language-"]'],s.w4.colors.codeBg,D.A['code[class*="language-"]'],l().div`
  background: ${({bg:e})=>e};
