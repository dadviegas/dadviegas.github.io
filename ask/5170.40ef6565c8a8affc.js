...
`},87330(o,e,a){a.d(e,{FlyoutPanel:()=>oR});var t=a(65723),r=a(37991),n=a.n(r),i=a(36859),l=a.n(i),s=a(72799),d=a(20255),c=a(81316),p=a(40814),g=a(36896),m=a(87902),f=a(53013),u=a(32887),x=a(49510),h=a(39848),b=a(37901),y=a(3045),w=a(43775),$=a(41783),v=a(83539),z=a(39416),k=a(1837),M=a(57167),A=a(84494),T=a(82314),S=a(35751),j=a(69633),F=a(92946),B=a(40822),C=a(36720),R=a(57400),P=a(58456),E=a(43317),L=a(52709),H=a(8006),N=a(89301),D=a(37561),I=a(83517),V=a(28207),G=a(37032),Y=a(6949),K=a(8218),O=a(36829),q=a(59591),W=a(15553),_=a(69923),U=a(72820),J=a(14621),Z=a(68479),X=a(72534),Q=a(66673),oo=a(67490),oe=a(49033),oa=a(99038),ot=a(45775),or=a(31365),on=a(62937),oi=a(9821),ol=a(65912),os=a(80158),od=a(88641),oc=a(48607),op=a(83249),og=a(1821),om=a(15889),of=a(89655),ou=a(27170),ox=a(19161),oh=a(71849),ob=a(41604),oy=a(13142),ow=a(61187),o$=a(77747),ov=a(2932),oz=a(24525),ok=a(57230),oM=a(22164);let oA={activity:g.A,"a-large-small":m.A,apple:f.A,"arrow-right":u.A,"bar-chart-2":x.A,book:h.A,"book-open":b.A,briefcase:y.A,calendar:w.A,clock:$.A,"circle-dot":v.A,cloud:z.A,compass:k.A,cpu:M.A,droplets:A.A,feather:T.A,file:d.A,"file-text":S.A,folder:j.A,"git-branch":F.A,github:B.A,globe:C.A,grid:R.A,hand:P.A,hash:E.A,heart:L.A,key:H.A,hexagon:N.A,home:D.A,landmark:I.A,layers:V.A,"layout-grid":G.A,leaf:Y.A,lightbulb:K.A,list:O.A,map:q.A,"map-pin":W.A,"message-circle":_.A,"message-square":U.A,minus:J.A,monitor:Z.A,mountain:X.A,package:Q.A,palette:oo.A,"pen-tool":oe.A,"pie-chart":oa.A,plane:ot.A,plus:or.A,ruler:on.A,shirt:oi.A,slash:ol.A,square:os.A,star:od.A,sun:oc.A,terminal:op.A,thermometer:og.A,triangle:om.A,trophy:of.A,truck:ou.A,type:ox.A,users:oh.A,"volume-2":ob.A,watch:oy.A,waves:ow.A,wind:o$.A,wrench:ov.A,x:oz.A,zap:ok.A,bot:oM.A},oT=(0,s.keyframes)`
...
`;function oB({iconKey:o}){let e=o?oA[o]??d.A:d.A;return(0,t.jsx)(e,{size:14,strokeWidth:1.75})}function oC({entries:o,activeId:e,onSelect:a}){return(0,t.jsx)(t.Fragment,{children:o.map(o=>o.children?(0,t.jsx)(n().Fragment,{children:(0,t.jsx)(oC,{entries:o.children,activeId:e,onSelect:a})},o.id):(0,t.jsxs)(oF,{active:e===o.id,onClick:()=>a(o),children:[(0,t.jsx)(oB,{iconKey:o.icon}),o.name]},o.id))})}function oR({activeId:o}){let{flyout:e,scheduleFlyoutClose:a,cancelFlyoutClose:r}=(0,p.c)();if(!e)return null;let n=e.entry.icon?oA[e.entry.icon]??d.A:d.A;return(0,t.jsxs)(oS,{anchorY:e.anchorY,onMouseEnter:r,onMouseLeave:a,children:[(0,t.jsxs)(oj,{children:[(0,t.jsx)(n,{size:13,strokeWidth:2}),e.entry.name]}),(0,t.jsx)(oC,{entries:e.entry.children??[],activeId:o,onSelect:o=>{e.onSelect(o),a()}})]})}},40814(o,e,a){a.d(e,{I:()=>r,c:()=>n});var t=a(37991);let r=(0,t.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),n=()=>(0,t.useContext)(r)},60246(o,e,a){a.d(e,{kd:()=>R.deleteDoc,Zf:()=>Y,w4:()=>t.w4,mZ:()=>R.updateDoc,KL:()=>R.saveDoc,fy:()=>H,Is:()=>R.putSetting,cL:()=>p.c,Iu:()=>R.listDocs,hY:()=>G,PE:()=>B,PL:()=>R.getSetting});var t=a(81316),r=a(65723),n=a(37991),i=a.n(n),l=a(36859),s=a.n(l);s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,s().div`
  position: relative;
`;var d=a(72799),c=a(73661),p=a(40814);let g="260px",m="56px",f="48px",u=s().header`
  display: flex;
  align-items: center;
...
`,w=s().span`
  ...
  animation: ${b} 10s ease ${({index:o})=>.07*o}s infinite;
...
`,T=s().main`
  ...
  display: flex;
  flex-direction: column;
`,S=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function j(){return(0,r.jsx)(y,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:S.map((o,e)=>(0,r.jsx)(w,{index:e,accent:o.accent,children:o.char},e))})}let F="atlantis:sidebar-collapsed";function B({sidebar:o,children:e,topBarRight:t,title:l="Atlantis",activeId:s=null}){let[d,g]=(0,n.useState)(()=>{try{return"true"===localStorage.getItem(F)}catch{return!1}}),[m,f]=(0,n.useState)(null),b=(0,n.useRef)(),y=()=>g(o=>{let e=!o;try{localStorage.setItem(F,String(e))}catch{}return e}),w=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(a.bind(a,87330)).then(o=>({default:o.FlyoutPanel}))),[]);return(0,r.jsx)(p.I.Provider,{value:{collapsed:d,toggle:y,flyout:m,openFlyout:(o,e,a)=>{clearTimeout(b.current),f({entry:o,anchorY:e,onSelect:a})},scheduleFlyoutClose:()=>{b.current=setTimeout(()=>f(null),160)},cancelFlyoutClose:()=>clearTimeout(b.current)},children:(0,r.jsxs)(k,{children:[(0,r.jsxs)(u,{children:[o&&(0,r.jsx)(x,{children:(0,r.jsx)(h,{onClick:y,title:d?"Expand sidebar":"Collapse sidebar",children:(0,r.jsx)(c.A,{size:17})})}),(0,r.jsx)(j,{}),l&&(0,r.jsx)($,{children:l}),t&&(0,r.jsx)(v,{children:t})]}),(0,r.jsxs)(z,{children:[null!=o&&(0,r.jsx)(M,{collapsed:d,children:(0,r.jsx)(A,{children:o})}),(0,r.jsx)(T,{children:e})]}),m&&(0,r.jsx)(i().Suspense,{fallback:null,children:(0,r.jsx)(w,{activeId:s})})]})})}s().div`
  display: grid;
...
`;function L(){let o="u">typeof window?window.location.hash:"",e=o.indexOf("?");if(-1===e)return{};let a={};for(let t of o.slice(e+1).split("&")){if(!t)continue;let o=t.indexOf("=");-1===o?a[decodeURIComponent(t)]="":a[decodeURIComponent(t.slice(0,o))]=decodeURIComponent(t.slice(o+1))}return a}function H(){let[o,e]=(0,n.useState)(L);return(0,n.useEffect)(()=>{let o=()=>e(L());return window.addEventListener("hashchange",o),()=>window.removeEventListener("hashchange",o)},[]),o}s().div`
  position: fixed;
  inset: 0;
...
`;let V="atlantis:api-keys";async function G(){try{let o=await (0,R.getSetting)(V);if(o){let e=JSON.parse(o);if(e.groq&&e.groq.length>0)return e.groq}}catch{}let o=function(){if("u"<typeof localStorage)return null;try{let o=localStorage.getItem(V);if(o){let e=JSON.parse(o);if(e.groq&&e.groq.length>0)return e.groq}let e=localStorage.getItem("atlantis:promptlab:keys");if(e){let o=JSON.parse(e);if(o.groq&&o.groq.length>0)return o.groq}}catch{}return null}();if(o)return o;if("u"<typeof process)return null;let e=process.env?.GROK_API_KEY;return e&&0!==e.length?e:null}async function Y(o,e){let a="pt"===e.locale?"Portuguese":"English",t=e.system??`You are Atlantis, a concise personal-dashboard assistant.
...
`,l().span`
  ...
  background: ${({color:o})=>o};
  display: inline-block;
`;let R={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:s.w4.colors.accentMuted},P={neutral:s.w4.colors.mainTextMuted,live:s.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:s.w4.colors.accent};l().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${s.w4.typography.fontFamilyMono};
...
`,l().p`
  ...
  font-size: 12.5px;
  line-height: 1.45;
`;var I=a(11352),V=a(76710),G=a(4311),Y=a(73639),K=a(8411);a(75406),l().nav`padding: ${s.w4.spacing.sm} 0;`,l().div`
