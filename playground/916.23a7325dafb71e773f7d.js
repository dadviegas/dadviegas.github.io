...
`;function h({onSave:n,onCancel:a}){const[o,e]=(0,t.useState)(""),i=(0,t.useRef)(null);return(0,t.useEffect)(()=>{i.current?.focus()},[]),(0,r.jsx)(f,{onClick:a,children:(0,r.jsxs)(p,{onClick:n=>n.stopPropagation(),children:[(0,r.jsx)(y,{children:"Save document"}),(0,r.jsx)(z,{ref:i,value:o,onChange:n=>e(n.target.value),onKeyDown:e=>{"Enter"===e.key&&o.trim()&&n(o.trim()),"Escape"===e.key&&a()},placeholder:"Give this version a name…",maxLength:80}),(0,r.jsxs)(b,{children:[(0,r.jsx)(x,{onClick:a,children:"Cancel"}),(0,r.jsx)(x,{primary:!0,disabled:!o.trim(),onClick:()=>n(o.trim()),children:"Save"})]})]})})}var w=o(8006),A=o(679),v=o(4872);const k=i.default.div`
  position: relative;
`,$=i.default.button`
  display: flex;
  align-items: center;
