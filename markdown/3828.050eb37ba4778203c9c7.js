...
`;function K({iconKey:e,size:o=16}){if(e&&!(e in C.t))return(0,r.jsx)("span",{style:{fontSize:o,lineHeight:1,display:"flex",alignItems:"center"},children:e});const a=e?C.t[e]??T.A:T.A;return(0,r.jsx)(a,{size:o,strokeWidth:1.75})}function G({entry:e,activeId:o,onSelect:a}){const[n,i]=(0,t.useState)(e.defaultOpen??!0),{collapsed:l,openFlyout:s,scheduleFlyoutClose:d,cancelFlyoutClose:m}=(0,c.c)();return e.children&&e.children.length>0?(0,r.jsxs)(L,{children:[(0,r.jsxs)(R,{collapsed:l,onClick:()=>{l||i(e=>!e)},onMouseEnter:l?o=>{const t=o.currentTarget.getBoundingClientRect();s(e,t.top,a)}:void 0,onMouseLeave:l?d:void 0,children:[(0,r.jsxs)(I,{collapsed:l,children:[(0,r.jsx)(K,{iconKey:e.icon,size:16}),(0,r.jsx)(N,{collapsed:l,children:e.name})]}),(0,r.jsx)(D,{open:n,collapsed:l,children:(0,r.jsx)(B.A,{size:13})})]}),(0,r.jsx)(E,{open:n&&!l,children:(0,r.jsx)(F,{children:(0,r.jsx)(P,{children:e.children.map(e=>(0,r.jsx)(G,{entry:e,activeId:o,onSelect:a},e.id))})})})]}):(0,r.jsxs)(H,{active:o===e.id,collapsed:l,onClick:()=>a(e),onMouseEnter:l?o=>{const t=o.currentTarget.getBoundingClientRect();s({id:e.id,name:e.name,icon:e.icon,file:e.file,children:[e]},t.top,a)}:void 0,onMouseLeave:l?d:void 0,children:[(0,r.jsx)(K,{iconKey:e.icon,size:15}),(0,r.jsx)(N,{collapsed:l,children:e.name})]})}function W({entries:e,activeId:o,onSelect:a}){return(0,r.jsx)("div",{children:e.map(e=>(0,r.jsx)(G,{entry:e,activeId:o,onSelect:a},e.id))})}const O=l.keyframes`
