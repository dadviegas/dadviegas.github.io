"use strict";(self.webpackChunk_atlantis_shell=self.webpackChunk_atlantis_shell||[]).push([["4232"],{88571(e,o,t){t.d(o,{MusicaWidget:()=>z});var r=t(65723),i=t(37991),a=t(36859),l=t.n(a),n=t(72799),s=t(23930),c=t(48294),d=t(2938),p=t(28170),m=t(98975),u=t(53);let x=(0,n.keyframes)`
...
`,C=l().div`
  ...
  font-size: 13px;
  padding: 8px 0;
`;function z({locale:e}){let o="pt"===e?"pt":"en",t=(0,i.useMemo)(()=>(0,p.Nx)(o,m.A),[o]),{tracks:a,loaded:l,add:n,remove:x}=(0,c.useMusic)(),[F,T]=(0,i.useState)(""),M=(0,i.useCallback)(()=>{let e=F.trim();e&&(n(e),T(""))},[F,n]),_=(0,i.useCallback)(e=>{x(e)},[x]);return l?(0,r.jsx)(d.rl,{title:t("music.title"),accessory:(0,r.jsx)("span",{style:{fontSize:11,fontFamily:s.w4.typography.fontFamilyMono,color:s.w4.colors.mainTextFaint},children:t("music.subtitle")}),accentColor:u.A.accentColor,children:(0,r.jsxs)(f,{children:[(0,r.jsxs)(b,{onSubmit:e=>{e.preventDefault(),M()},children:[(0,r.jsx)(h,{type:"text",value:F,onChange:e=>T(e.target.value),placeholder:t("music.placeholder")}),(0,r.jsx)(w,{type:"submit",disabled:0===F.trim().length,children:t("music.add")})]}),0===a.length?(0,r.jsx)(C,{children:t("music.empty")}):(0,r.jsx)(y,{children:a.map((e,o)=>{let i=e.artist?`${e.title} ${e.artist}`:e.title;return(0,r.jsxs)(g,{delay:o,href:`music://music.apple.com/search?term=${encodeURIComponent(i)}`,target:"_blank",rel:"noreferrer","aria-label":t("music.search.label"),children:[(0,r.jsxs)($,{children:[(0,r.jsx)(v,{children:e.title}),e.artist&&(0,r.jsx)(k,{children:e.artist})]}),(0,r.jsx)(j,{className:"remove-btn",type:"button","aria-label":t("music.remove"),title:t("music.remove"),onClick:o=>{o.preventDefault(),o.stopPropagation(),_(e.id)},children:(0,r.jsx)(d.In,{name:"close",size:12})})]},e.id)})})]})}):null}}}]);