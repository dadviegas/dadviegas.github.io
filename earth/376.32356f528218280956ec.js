...
`;function Ce({appId:e,onLoad:a}){const[n,o]=(0,t.useState)(!1),[i,l]=(0,t.useState)([]),s=(0,t.useRef)(null),c=(0,t.useCallback)(()=>{(function(e){return te.listDocs(e)})(e).then(l).catch(()=>{})},[e]);(0,t.useEffect)(()=>{if(!n)return;c();const e=e=>{s.current&&!s.current.contains(e.target)&&o(!1)};return document.addEventListener("mousedown",e),()=>document.removeEventListener("mousedown",e)},[n,c]);return(0,r.jsxs)(be,{ref:s,children:[(0,r.jsxs)(we,{onClick:()=>o(e=>!e),children:[(0,r.jsx)(he.A,{size:14}),"Saved",(0,r.jsx)(ye.A,{size:13,style:{marginLeft:2}})]}),(0,r.jsxs)(ze,{open:n,children:[(0,r.jsx)(ve,{children:"Saved versions"}),(0,r.jsx)($e,{children:0===i.length?(0,r.jsx)(Ae,{children:"No saved documents yet."}):i.map(e=>{return(0,r.jsxs)(ke,{children:[(0,r.jsxs)(Me,{onClick:()=>{a(e.content,e.id,e.name),o(!1)},children:[(0,r.jsx)(je,{children:e.name}),(0,r.jsx)(Se,{children:(n=e.savedAt,new Intl.DateTimeFormat(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}).format(new Date(n)))})]}),(0,r.jsx)(Te,{onClick:a=>(async(e,a)=>{e.stopPropagation(),await function(e){return te.deleteDoc(e)}(a),l(e=>e.filter(e=>e.id!==a))})(a,e.id),title:"Delete",children:(0,r.jsx)(xe.A,{size:13})})]},e.id);var n})})]})]})}function Be(e,a=8){const[n,o]=(0,t.useState)(()=>function(e){try{return JSON.parse(localStorage.getItem(e)??"[]")}catch{return[]}}(e));return{recent:n,addRecent:(0,t.useCallback)(n=>{o(o=>{const t=[n,...o.filter(e=>e!==n)].slice(0,a);return function(e,a){try{localStorage.setItem(e,JSON.stringify(a))}catch{}}(e,t),t})},[e,a])}}i.default.div`
...
`,i.default.div`
  position: absolute;
  inset: 0;
  animation: ${Le} 1.4s cubic-bezier(0.4, 0, 0.2, 1) infinite;
