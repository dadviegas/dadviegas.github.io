...
`;let L=l().kbd`
  ...
  white-space: nowrap;
`;function P({children:e,...o}){return(0,r.jsx)(L,{...o,children:e})}let V=l().div`
  font-family: ${s.w4.typography.fontFamilyMono};
  font-size: 11px;
  ...
  align-items: center;
  gap: 8px;
`;function E({children:e,...o}){return(0,r.jsx)(V,{...o,children:e})}l().label`
  display: flex;
  align-items: center;
  gap: 10px;
...
`,l().p`
  ...
  font-size: 12.5px;
  line-height: 1.45;
`;var N=t(11352),D=t(76710),O=t(4311),W=t(73639),Y=t(40080);t(75406),l().nav`padding: ${s.w4.spacing.sm} 0;`,l().div`
...
`;var q=t(54041);let G="https://cdn.jsdelivr.net/npm/mermaid@11.14.0/dist/mermaid.min.js",_=null,K="#7fb77e",U=(0,F.keyframes)`
...
`,l().span`
  font-size: ${s.w4.typography.fontSizeBase};
  color: ${s.w4.colors.mainTextMuted};
`;var em=t(17223),eb=t(21426),eu=t(25609),ew=t(20320);let ey=l().div`
  margin: ${s.w4.spacing.lg} 0;
  border-radius: ${s.w4.borderRadius.md};
  border: 1px solid ${s.w4.colors.codeBorder};
  overflow: hidden;
...
`,eM={...eb.A,'pre[class*="language-"]':{...eb.A['pre[class*="language-"]'],background:s.w4.colors.codeBg,margin:0,padding:"18px 20px",fontSize:"13px",lineHeight:"1.6",borderRadius:0},'code[class*="language-"]':{...eb.A['code[class*="language-"]'],background:"none",fontSize:"13px"}};function ez({lang:e="text",code:o}){let[t,i]=(0,a.useState)(!1);return(0,r.jsxs)(ey,{children:[(0,r.jsxs)(e$,{children:[(0,r.jsx)(ev,{children:e}),(0,r.jsxs)(ek,{copied:t,onClick:()=>{navigator.clipboard.writeText(o).then(()=>{i(!0),setTimeout(()=>i(!1),2e3)})},children:[t?(0,r.jsx)(eu.A,{size:12}):(0,r.jsx)(ew.A,{size:12}),t?"Copied!":"Copy"]})]}),(0,r.jsx)(em.A,{language:e,style:eM,showLineNumbers:o.split("\n").length>8,lineNumberStyle:{color:"#484f58",minWidth:"2.5em",paddingRight:"1.5em",userSelect:"none",fontSize:"12px"},customStyle:{margin:0,background:s.w4.colors.codeBg},wrapLongLines:!1,children:o})]})}var eT=t(65569),eF=t(8218),ej=t(57230),eS=t(22966),eC=t(21069);let eB={NOTE:{bg:"rgba(88, 166, 255, 0.08)",border:"#58a6ff",icon:eT.A,label:"Note",color:"#58a6ff"},TIP:{bg:"rgba(63, 185, 80, 0.08)",border:"#3fb950",icon:eF.A,label:"Tip",color:"#3fb950"},IMPORTANT:{bg:"rgba(163, 113, 247, 0.08)",border:"#a371f7",icon:ej.A,label:"Important",color:"#a371f7"},WARNING:{bg:"rgba(210, 153, 34, 0.08)",border:"#d29922",icon:eS.A,label:"Warning",color:"#d29922"},CAUTION:{bg:"rgba(248, 81, 73, 0.08)",border:"#f85149",icon:eC.A,label:"Caution",color:"#f85149"}},eA=l().div`
  background: ${({bg:e})=>e};
...
`;function eL({type:e,children:o}){let t=eB[e]??eB.NOTE,a=t.icon;return(0,r.jsxs)(eA,{bg:t.bg,border:t.border,children:[(0,r.jsxs)(eH,{color:t.color,children:[(0,r.jsx)(a,{size:15,strokeWidth:2}),t.label]}),(0,r.jsx)(eR,{children:o})]})}l().nav`
  width: 220px;
  min-width: 220px;
...
`;function eN({children:e}){return(0,r.jsx)(eI,{children:(0,r.jsx)(N.oz,{remarkPlugins:[D.A,O.A,eE],rehypePlugins:[W.A,Y.A],components:{div({node:e,children:o,...t}){let a=t["data-callout"];return a?(0,r.jsx)(eL,{type:a,children:o}):(0,r.jsx)("div",{...t,children:o})},pre:({children:e})=>(0,r.jsx)(r.Fragment,{children:e}),code({className:e,children:o}){let t=/language-(\w+)/.exec(e??"")?.[1],a=String(o).replace(/\n$/,"");return a.trim()?"mermaid"===t?(0,r.jsx)(eo,{code:a}):"chart"===t?(0,r.jsx)(ex,{code:a}):t||a.includes("\n")?(0,r.jsx)(ez,{lang:t,code:a}):(0,r.jsx)("code",{className:e,children:o}):null}},children:e})})}l().nav`
  display: flex;
  flex-direction: column;
  gap: 1px;
  padding: ${s.w4.spacing.sm} 0;
