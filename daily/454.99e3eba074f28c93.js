...
`,l().span`
  ...
  display: inline-block;
`;let j={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:d.w4.colors.accentMuted},R={neutral:d.w4.colors.mainTextMuted,live:d.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:d.w4.colors.accent};l().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${d.w4.typography.fontFamilyMono};
...
`;let C=l().div`
  ...
  align-items: center;
  gap: 8px;
`;function B({children:o,...e}){return(0,t.jsx)(C,{...e,children:o})}l().label`
  display: flex;
  align-items: center;
  gap: 10px;
