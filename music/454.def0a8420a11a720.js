...
`;let B=l().div`
  ...
  align-items: center;
  gap: 8px;
`;function H({children:o,...e}){return(0,t.jsx)(B,{...e,children:o})}let L=l().label`
  display: flex;
  align-items: center;
  gap: 10px;
...
`,R=l().span`
  ...
  color: ${d.w4.colors.mainTextMuted};
  flex-shrink: 0;
`,P=i().forwardRef(function({before:o,after:e,...a},r){return(0,t.jsxs)(L,{children:[o&&(0,t.jsx)(R,{children:o}),(0,t.jsx)(C,{ref:r,...a}),e&&(0,t.jsx)(R,{children:e})]})});l().div`
  position: relative;
  display: flex;
  flex-direction: column;
  height: 100%;
