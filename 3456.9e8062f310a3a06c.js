...
`,iY=l().span`
  ...
  font-size: 11px;
  color: ${c.w4.colors.mainTextFaint};
`,iV=l()("div",{shouldForwardProp:e=>"selected"!==e})`
  display: flex;
  align-items: center;
  gap: 14px;
  padding: 10px 22px;
...
`;s().div`
  ...
  pointer-events: none;
  z-index: 200;
  animation: ${tV} 0.16s cubic-bezier(0.4, 0, 0.2, 1) forwards;
...
`,s().div`
  position: relative;
`;let aa="260px",ai="56px",ao="48px",ar=s().header`
  display: flex;
  align-items: center;
...
`,ac=s().span`
  ...
  animation: ${al} 10s ease ${({index:e})=>.07*e}s infinite;
...
`,ax=s().main`
  ...
  display: flex;
  flex-direction: column;
`,ab=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function ay(){return(0,i.jsx)(ad,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:ab.map((e,t)=>(0,i.jsx)(ac,{index:t,accent:e.accent,children:e.char},t))})}let aw="atlantis:sidebar-collapsed";function av({sidebar:e,children:t,topBarRight:n,title:s="Atlantis",activeId:l=null}){let[d,c]=(0,o.useState)(()=>{try{return"true"===localStorage.getItem(aw)}catch{return!1}}),[p,h]=(0,o.useState)(null),g=(0,o.useRef)(),m=()=>c(e=>{let t=!e;try{localStorage.setItem(aw,String(t))}catch{}return t}),u=r().useMemo(()=>r().lazy(()=>Promise.resolve().then(a.bind(a,45816)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,i.jsx)(tI.I.Provider,{value:{collapsed:d,toggle:m,flyout:p,openFlyout:(e,t,a)=>{clearTimeout(g.current),h({entry:e,anchorY:t,onSelect:a})},scheduleFlyoutClose:()=>{g.current=setTimeout(()=>h(null),160)},cancelFlyoutClose:()=>clearTimeout(g.current)},children:(0,i.jsxs)(am,{children:[(0,i.jsxs)(ar,{children:[e&&(0,i.jsx)(an,{children:(0,i.jsx)(as,{onClick:m,title:d?"Expand sidebar":"Collapse sidebar",children:(0,i.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,i.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,i.jsx)("path",{d:"M9 3v18"})]})})}),(0,i.jsx)(ay,{}),s&&(0,i.jsx)(ap,{children:s}),n&&(0,i.jsx)(ah,{children:n})]}),(0,i.jsxs)(ag,{children:[null!=e&&(0,i.jsx)(au,{collapsed:d,children:(0,i.jsx)(af,{children:e})}),(0,i.jsx)(ax,{children:t})]}),p&&(0,i.jsx)(r().Suspense,{fallback:null,children:(0,i.jsx)(u,{activeId:l})})]})})}s().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
