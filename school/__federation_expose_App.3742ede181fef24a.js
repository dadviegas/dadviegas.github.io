...
`,R=n().div`
  ...
  align-items: center;
  gap: ${d.w4.spacing.sm};
`,X={pt:"O que vamos aprender hoje?",en:"What shall we learn today?"},N={pt:"Escolhe uma disciplina para come\xe7ar",en:"Pick a subject to get started"};function C({topBarRight:e}){let[a,t]=(0,r.useState)(m),[i]=(0,c.Ym)(),n="pt"===i?"pt":"en";if((0,r.useEffect)(()=>{let e=()=>t(m());return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[]),!a)return(0,o.jsx)(d.PE,{title:"School",sidebar:null,topBarRight:e,children:(0,o.jsxs)(f,{children:[T.map((e,a)=>(0,o.jsx)(k,{x:e.x,y:e.y,size:e.size,delay:e.delay,dur:e.dur},a)),(0,o.jsx)(j,{top:15,delay:12}),(0,o.jsx)(j,{top:55,delay:25}),(0,o.jsx)(w,{children:X[n]}),(0,o.jsx)(y,{children:N[n]}),(0,o.jsx)($,{children:"pt"===n?"Disciplinas":"Subjects"}),(0,o.jsx)(b,{columns:4,children:p.map((e,a)=>(0,o.jsxs)(S,{accentColor:e.color,onClick:()=>{t(e.key),window.location.hash=`#/${e.hashPrefix}`},children:[(0,o.jsx)(P,{className:"card-emoji",delay:.4*a,children:e.emoji}),(0,o.jsx)(E,{children:e.label[n]}),(0,o.jsx)(M,{children:e.description[n]})]},e.key))})]})});let s=(0,o.jsxs)(R,{children:[(0,o.jsxs)(Y,{onClick:()=>{t(null),window.location.hash="#/school"},children:["← ","pt"===n?"Disciplinas":"Subjects"]}),e]}),g=p.find(e=>e.key===a);return(0,o.jsx)(l.WO,{hashPrefix:g.hashPrefix,defaultLang:"pt",locale:i,languages:g.languages,welcomeTitle:g.welcomeTitle,welcomeSub:g.welcomeSub,topBarRight:s},a)}}}]);