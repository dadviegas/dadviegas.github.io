"use strict";(self.webpackChunk_atlantis_forma=self.webpackChunk_atlantis_forma||[]).push([["27"],{90429(e,t,o){o.d(t,{N:()=>S});var r=o(65723),a=o(37991),i=o(36859),n=o.n(i),s=o(72799),l=o(6063),d=o(44e3),c=o(69454);let p="#7fb77e",h={month:30,"3m":90,"6m":183,year:365,all:null},g=(0,s.keyframes)`
...
`,j={fast:p,meal:"#58a6ff",weight:"#d29922",walk:"#a371f7"},z={fast:"flame",meal:"utensils",weight:"gauge",walk:"activity"};function T(e){let[t,o,r]=e.split("-").map(e=>parseInt(e,10));return new Date(t,(o??1)-1,r??1).getTime()}function S({data:e,t,locale:o,onEditFast:i,onEditMeal:n,onEditWeight:s,onDeleteFast:l,onDeleteMeal:p,onDeleteWeight:g,onDeleteWalk:F}){let[C,A]=(0,a.useState)("all"),[H,L]=(0,a.useState)("month"),D=(0,a.useMemo)(()=>(function(e,t){let o=[];for(let r of e.sessions){let e=r.endedAt?(r.endedAt-r.startedAt)/36e5:(Date.now()-r.startedAt)/36e5;o.push({kind:"fast",ts:r.startedAt,id:r.id,editable:!0,primary:r.endedAt?`${t("forma.activities.fast.completed")} \xb7 ${e.toFixed(1)}h`:`${t("forma.activities.fast.inProgress")} \xb7 ${e.toFixed(1)}h`,meta:`${r.protocol} \xb7 ${t("forma.activities.fast.target")} ${r.targetHours}h`})}for(let r of e.meals){let e="forma.meal."+r.slot,a=[];r.proteinG&&a.push(`${r.proteinG}g ${t("forma.activities.protein")}`),r.kcal&&a.push(`${r.kcal} kcal`),o.push({kind:"meal",ts:r.createdAt??T(r.date),id:r.id,editable:!0,primary:`${t(e)}${r.notes?` \xb7 ${r.notes}`:""}`,meta:a.length>0?a.join(" \xb7 "):"—"})}for(let r of e.weights)o.push({kind:"weight",ts:T(r.date),id:r.date,editable:!0,primary:`${r.kg.toFixed(1)} kg`,meta:t("forma.activities.weight.entry")});for(let r of e.walks)o.push({kind:"walk",ts:T(r.date),id:r.date,editable:!1,primary:`${r.minutes} min`,meta:t("forma.activities.walk.entry")});return o.sort((e,t)=>t.ts-e.ts),o})(e,t),[e,t]),R=(0,a.useMemo)(()=>{let e=h[H];return null===e?0:Date.now()-864e5*e},[H]),B=(0,a.useMemo)(()=>D.filter(e=>e.ts>=R),[D,R]),P=(0,a.useMemo)(()=>"all"===C?B:B.filter(e=>e.kind===C),[B,C]),I=(0,a.useMemo)(()=>{let e={all:B.length,fast:0,meal:0,weight:0,walk:0};for(let t of B)e[t.kind]+=1;return e},[B]),W=(e,o)=>(0,r.jsxs)(d.vu,{variant:C===e?"selected":"default",dotColor:"all"===e?void 0:j[e],onClick:()=>A(e),children:[t(o)," ",I[e]>0&&`(${I[e]})`]},e);return(0,r.jsxs)(f,{children:[(0,r.jsx)(m,{children:["month","3m","6m","year","all"].map(e=>(0,r.jsx)(d.vu,{variant:H===e?"selected":"default",onClick:()=>L(e),children:t("forma.activities.range."+e)},e))}),(0,r.jsxs)(m,{children:[W("all","forma.activities.filter.all"),W("fast","forma.activities.filter.fast"),W("meal","forma.activities.filter.meal"),W("weight","forma.activities.filter.weight"),W("walk","forma.activities.filter.walk")]}),0===P.length?(0,r.jsx)(c.YG,{mode:"empty",label:t("forma.activities.empty")}):(0,r.jsx)(x,{children:P.map(a=>(0,r.jsxs)(u,{children:[(0,r.jsx)(w,{color:j[a.kind],children:(0,r.jsx)(d.In,{name:z[a.kind],size:14})}),(0,r.jsxs)(b,{children:[(0,r.jsx)(y,{children:a.primary}),(0,r.jsx)($,{children:a.meta})]}),(0,r.jsx)(v,{children:function(e,t,o){let r=new Date(e),a=r.toLocaleDateString("pt"===t?"pt-PT":"en-GB",{day:"2-digit",month:"short"});if(!o)return a;let i=r.toLocaleTimeString("pt"===t?"pt-PT":"en-GB",{hour:"2-digit",minute:"2-digit"});return`${a} ${i}`}(a.ts,o,"fast"===a.kind||"meal"===a.kind)}),(0,r.jsxs)(k,{children:[a.editable&&(0,r.jsx)(M,{onClick:()=>(t=>{if(t.editable){if("fast"===t.kind){let o=e.sessions.find(e=>e.id===t.id);o&&i(o)}else if("meal"===t.kind){let o=e.meals.find(e=>e.id===t.id);o&&n(o)}else if("weight"===t.kind){let o=e.weights.find(e=>e.date===t.id);o&&s(o)}}})(a),title:t("forma.activities.edit"),"aria-label":t("forma.activities.edit"),children:(0,r.jsx)(d.In,{name:"edit",size:14})}),(0,r.jsx)(M,{onClick:()=>{let e;return e="forma.activities.confirmDelete."+a.kind,void(window.confirm(t(e))&&("fast"===a.kind&&l(a.id),"meal"===a.kind&&p(a.id),"weight"===a.kind&&g(a.id),"walk"===a.kind&&F(a.id)))},title:t("forma.activities.delete"),"aria-label":t("forma.activities.delete"),children:(0,r.jsx)(d.In,{name:"trash",size:14})})]})]},`${a.kind}:${a.id}`))})]})}},63709(e,t,o){o.d(t,{Q:()=>ep});var r=o(65723),a=o(37991),i=o(36859),n=o.n(i),s=o(72799),l=o(6063),d=o(14659),c=o(69454),p=o(4406);let h=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],g=["Seg","Ter","Qua","Qui","Sex","S\xe1b","Dom"];function f(e,t,o,r,a){let i=[`${("pt"===a?g:h)[t]} ${String(o).padStart(2,"0")}:00`],n=(t+1)%7,s=e.sessions.filter(e=>{let t=new Date(e.startedAt);return t.getDay()===n&&t.getHours()===o});s.length>0&&i.push(`🔥 ${s.length}\xd7 ${r("forma.activities.fast.target").toLowerCase()} \xb7 ${r("forma.activities.filter.fast")}`);let l=e.meals.filter(e=>{let t=new Date(e.createdAt??Date.parse(e.date));return t.getDay()===n&&t.getHours()===o});if(l.length>0){let e=l.reduce((e,t)=>e+(t.proteinG??0),0),t=l.reduce((e,t)=>e+(t.kcal??0),0);i.push(`🍽 ${l.length}\xd7 ${r("forma.activities.filter.meal")}`+(e?` \xb7 ${e}g`:"")+(t?` \xb7 ${t} kcal`:""))}return 1===i.length&&i.push(`— ${r("forma.activities.empty")}`),i.join("\n")}let m="#7fb77e";function x(e){return[parseInt(e.slice(1,3),16),parseInt(e.slice(3,5),16),parseInt(e.slice(5,7),16)]}let u=x("#1d2230"),w=x(m);function b(e){let t=Math.round(u[0]+(w[0]-u[0])*e),o=Math.round(u[1]+(w[1]-u[1])*e),r=Math.round(u[2]+(w[2]-u[2])*e);return`rgb(${t},${o},${r})`}let y=new Set([0,4,8,12,16,20]),$=["Mo","Tu","We","Th","Fr","Sa","Su"],v=["Se","Te","Qa","Qi","Sx","S\xe1","Do"],k=n().section`
  background: ${l.w4.colors.surface};
  border: 1px solid ${l.w4.colors.border};
...
`,R=n().div`
  ...
  color: ${l.w4.colors.mainTextMuted};
  margin-top: 2px;
`;function B({data:e,t,locale:o}){let i=(0,a.useMemo)(()=>(0,d.mealDayHourMatrix)(e.meals),[e.meals]),n=(0,a.useMemo)(()=>(0,d.mealKcalByHour)(e.meals),[e.meals]),s=(0,a.useMemo)(()=>{let e=0;for(let t of i)for(let o of t)o>e&&(e=o);return e},[i]),l=(0,a.useMemo)(()=>Math.max(0,...n),[n]),c=(0,a.useMemo)(()=>n.reduce((e,t)=>e+t,0),[n]),p="pt"===o?v:$;return(0,r.jsxs)(k,{children:[(0,r.jsx)(M,{children:t("forma.mealHeatmap.title")}),(0,r.jsxs)(j,{children:[(0,r.jsxs)(z,{children:[(0,r.jsx)(S,{}),Array.from({length:24},(e,t)=>(0,r.jsx)(T,{children:y.has(t)?String(t).padStart(2,"0"):""},t))]}),i.map((a,i)=>(0,r.jsxs)(F,{children:[(0,r.jsx)(C,{children:p[i]}),a.map((a,n)=>(0,r.jsx)(A,{bg:0===s?b(0):b(a/s),title:f(e,i,n,t,o)},n))]},i)),(0,r.jsxs)(H,{children:[(0,r.jsx)(S,{}),(0,r.jsx)(L,{children:n.map((e,t)=>(0,r.jsx)(D,{pct:0===l?0:e/l},t))})]}),(0,r.jsxs)(R,{children:[(0,r.jsx)("span",{children:"0"}),(0,r.jsxs)("span",{children:[Math.round(c).toLocaleString()," kcal"]})]})]})]})}let P="#7fb77e",I="#58a6ff",W="#d29922",N="#7fb77e",E=["Mo","Tu","We","Th","Fr","Sa","Su"],O=["Se","Te","Qa","Qi","Sx","S\xe1","Do"],Y=new Set([0,4,8,12,16,20]);function V(e){return[parseInt(e.slice(1,3),16),parseInt(e.slice(3,5),16),parseInt(e.slice(5,7),16)]}let G=V("#1d2230"),K=V(P);function _(e){let t=Math.round(G[0]+(K[0]-G[0])*e),o=Math.round(G[1]+(K[1]-G[1])*e),r=Math.round(G[2]+(K[2]-G[2])*e);return`rgb(${t},${o},${r})`}let q=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,J=n().div`
  background: ${l.w4.colors.surface};
...
`,ec=n().div`
  ...
  flex-shrink: 0;
`;function ep({data:e,t,locale:o}){let i=new Date().toISOString().slice(0,10),n=(0,a.useMemo)(()=>(function(e){let t={};for(let o of e){if(!o.endedAt)continue;let e=o.startedAt,r=o.endedAt,a=e;for(;a<r;){let e=new Date(a),o=new Date(e.getFullYear(),e.getMonth(),e.getDate(),0,0,0,0).getTime()+864e5,i=Math.min(r,o)-a,n=e.toISOString().slice(0,10);t[n]=(t[n]??0)+i/36e5,a=o}}let o=[];for(let e=89;e>=0;e--){let r=t[function(e){let t=new Date;return t.setDate(t.getDate()-e),t.toISOString().slice(0,10)}(e)]??0,a=0;r>=18?a=4:r>=14?a=3:r>=8?a=2:r>0&&(a=1),o.push(a)}return o})(e.sessions),[e.sessions]),s=(0,a.useMemo)(()=>(0,d.weightTrend)(e.weights,60),[e.weights]),l=(0,a.useMemo)(()=>[...e.weights].sort((e,t)=>t.date.localeCompare(e.date))[0]??null,[e.weights]),h=(0,a.useMemo)(()=>(0,d.proteinByDay)(e.meals,i),[e.meals,i]),g=(0,a.useMemo)(()=>e.goal.proteinG??110,[e.goal.proteinG]),m=(0,a.useMemo)(()=>(function(e){let t=[],o=new Date,r=new Date(o),a=(o.getDay()+6)%7;r.setDate(o.getDate()-a),r.setHours(0,0,0,0);for(let o=5;o>=0;o--){let a=new Date(r);a.setDate(r.getDate()-7*o);let i=new Date(a);i.setDate(a.getDate()+7);let n=a.toISOString().slice(0,10),s=i.toISOString().slice(0,10),l=e.filter(e=>e.date>=n&&e.date<s),d=l.filter(e=>"lunch"===e.slot).reduce((e,t)=>e+(t.proteinG??0),0),c=l.filter(e=>"snack"===e.slot).reduce((e,t)=>e+(t.proteinG??0),0),p=l.filter(e=>"dinner"===e.slot).reduce((e,t)=>e+(t.proteinG??0),0),h=`${String(a.getDate()).padStart(2,"0")}/${String(a.getMonth()+1).padStart(2,"0")}`;t.push({label:h,segments:[{id:"lunch",value:d,color:I},{id:"snack",value:c,color:W},{id:"dinner",value:p,color:N}]})}return t})(e.meals),[e.meals]),x=(0,a.useMemo)(()=>(0,d.dayHourFastMatrix)(e.sessions),[e.sessions]),u=(0,a.useMemo)(()=>{let e=0;for(let t of x)for(let o of t)o>e&&(e=o);return e},[x]),w="pt"===o?O:E,b=e.weights.length>=2,y=e.meals.length>0,$=e.sessions.some(e=>void 0!==e.endedAt),v=[{id:"fast-heatmap",defaultSize:"lg",render:()=>(0,r.jsxs)(J,{children:[(0,r.jsxs)(Q,{children:["◉ ",t("forma.analytics.heatmap.title")]}),$?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(c.RT,{data:n,cellSize:11,gap:2,locale:o,tooltip:r=>{var a;let i;return function(e,t,o,r){let a=[function(e,t){let[o,r,a]=e.split("-").map(e=>parseInt(e,10));return new Date(o,(r??1)-1,a??1).toLocaleDateString("pt"===t?"pt-PT":"en-GB",{day:"2-digit",month:"short",year:"numeric"})}(t,r)],{count:i,hours:n}=function(e,t){let[o,r,a]=t.split("-").map(e=>parseInt(e,10)),i=new Date(o,(r??1)-1,a??1).getTime(),n=i+864e5,s=0,l=0;for(let t of e.sessions){let e=t.startedAt,o=Math.min(t.endedAt??Date.now(),n)-Math.max(e,i);o>0&&(s+=1,l+=o/36e5)}return{count:s,hours:l}}(e,t);i>0&&a.push(`🔥 ${i}\xd7 ${o("forma.activities.filter.fast")} \xb7 ${n.toFixed(1)}h`);let s=e.meals.filter(e=>e.date===t);if(s.length>0){let e=s.reduce((e,t)=>e+(t.proteinG??0),0),t=s.reduce((e,t)=>e+(t.kcal??0),0);a.push(`🍽 ${s.length}\xd7 ${o("forma.activities.filter.meal")}`+(e?` \xb7 ${e}g ${o("forma.activities.protein")}`:"")+(t?` \xb7 ${t} kcal`:""))}let l=e.weights.find(e=>e.date===t);l&&a.push(`⚖ ${l.kg.toFixed(1)} kg`);let d=e.walks.filter(e=>e.date===t);if(d.length>0){let e=d.reduce((e,t)=>e+t.minutes,0);a.push(`🚶 ${e} min`)}return 1===a.length&&a.push(`— ${o("forma.activities.empty")}`),a.join("\n")}(e,(a=n.length,(i=new Date).setDate(i.getDate()-(a-1-r)),i.toISOString().slice(0,10)),t,o)}}),(0,r.jsxs)(el,{children:[(0,r.jsxs)(ed,{children:[(0,r.jsx)(ec,{color:_(0)}),(0,r.jsx)("span",{children:t("forma.analytics.heatmap.none")})]}),(0,r.jsxs)(ed,{children:[(0,r.jsx)(ec,{color:_(.25)}),(0,r.jsx)("span",{children:"<8h"})]}),(0,r.jsxs)(ed,{children:[(0,r.jsx)(ec,{color:_(.5)}),(0,r.jsx)("span",{children:"8–14h"})]}),(0,r.jsxs)(ed,{children:[(0,r.jsx)(ec,{color:_(.75)}),(0,r.jsx)("span",{children:"14–18h"})]}),(0,r.jsxs)(ed,{children:[(0,r.jsx)(ec,{color:_(1)}),(0,r.jsx)("span",{children:"≥18h"})]})]})]}):(0,r.jsx)(c.YG,{mode:"empty",label:t("forma.analytics.empty")})]})},{id:"weight-trend",defaultSize:"md",render:()=>(0,r.jsxs)(J,{children:[(0,r.jsxs)(Q,{children:["◉ ",t("forma.analytics.weight.title")]}),b?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(ee,{children:[(0,r.jsx)(U,{children:l?l.kg.toFixed(1):"—"}),(0,r.jsx)(Z,{children:"kg"}),0!==s.delta&&(0,r.jsxs)(et,{positive:s.delta>0,children:[s.delta>0?"+":"",s.delta.toFixed(1)," kg"]})]}),void 0!==e.goal.weightKg&&(0,r.jsxs)(ee,{children:[(0,r.jsx)(X,{children:e.goal.weightKg.toFixed(1)}),(0,r.jsxs)(Z,{children:["kg ",t("forma.weight.target")]})]}),(0,r.jsx)(Z,{children:t("forma.analytics.weight.delta")}),(0,r.jsx)(c.OW,{points:s.ema.length>=2?s.ema:e.weights.map(e=>e.kg),accent:P,width:260,height:60,fluid:!0})]}):(0,r.jsx)(c.YG,{mode:"empty",label:t("forma.analytics.empty")})]})},{id:"protein-burn",defaultSize:"md",render:()=>(0,r.jsxs)(J,{children:[(0,r.jsxs)(Q,{children:["◉ ",t("forma.analytics.protein.title")]}),(0,r.jsxs)(ee,{children:[(0,r.jsx)(U,{children:h.toFixed(0)}),(0,r.jsxs)(Z,{children:["/ ",g,"g ",t("forma.analytics.protein.target")]})]}),y?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(c.kl,{spent:g-h,budget:g,height:60}),(0,r.jsx)(Z,{children:h>=g?t("forma.analytics.protein.achieved"):`${(g-h).toFixed(0)}g ${t("forma.analytics.protein.remaining")}`})]}):(0,r.jsx)(c.YG,{mode:"empty",label:t("forma.analytics.empty")})]})},{id:"weekly-protein",defaultSize:"lg",render:()=>(0,r.jsxs)(J,{children:[(0,r.jsxs)(Q,{children:["◉ ",t("forma.analytics.weekly.title")]}),y?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(c.ik,{data:m,budget:7*g,height:160}),(0,r.jsxs)(el,{children:[(0,r.jsxs)(ed,{children:[(0,r.jsx)(ec,{color:I}),(0,r.jsx)("span",{children:t("forma.meal.lunch")})]}),(0,r.jsxs)(ed,{children:[(0,r.jsx)(ec,{color:W}),(0,r.jsx)("span",{children:t("forma.meal.snack")})]}),(0,r.jsxs)(ed,{children:[(0,r.jsx)(ec,{color:N}),(0,r.jsx)("span",{children:t("forma.meal.dinner")})]})]})]}):(0,r.jsx)(c.YG,{mode:"empty",label:t("forma.analytics.empty")})]})},{id:"meal-heatmap",defaultSize:"lg",render:()=>(0,r.jsx)(B,{data:e,t:t,locale:o})},{id:"fast-times",defaultSize:"lg",render:()=>(0,r.jsxs)(J,{children:[(0,r.jsxs)(Q,{children:["◉ ",t("forma.analytics.fastTimes.title")]}),$?(0,r.jsxs)(eo,{children:[(0,r.jsxs)(er,{children:[(0,r.jsx)("div",{}),Array.from({length:24},(e,t)=>(0,r.jsx)(ea,{children:Y.has(t)?String(t).padStart(2,"0"):""},t))]}),x.map((a,i)=>(0,r.jsxs)(ei,{children:[(0,r.jsx)(en,{children:w[i]}),a.map((a,n)=>(0,r.jsx)(es,{bg:0===u?_(0):_(a/u),title:f(e,i,n,t,o)},n))]},i))]}):(0,r.jsx)(c.YG,{mode:"empty",label:t("forma.analytics.empty")})]})}];return(0,r.jsx)(p.C,{t:t,cards:v,storageKey:"forma:layout:analytics"})}},37103(e,t,o){o.d(t,{j:()=>u});var r=o(65723),a=o(37991),i=o(36859),n=o.n(i),s=o(6063),l=o(44e3),d=o(14659);let c=n().section`
...
`,x="forma:ask:last";function u({data:e,t,locale:o}){let i,n,w,[b,y]=(0,a.useState)(null),[$,v]=(0,a.useState)(""),[k,M]=(0,a.useState)(null),[j,z]=(0,a.useState)(!1),[T,S]=(0,a.useState)(null);(0,a.useEffect)(()=>{(0,d.resolveGroqKey)().then(e=>y(!!e))},[]),(0,a.useEffect)(()=>{(0,s.qj)(x).then(e=>{if(e)try{let t=JSON.parse(e);t.text&&t.ts&&(v(t.text),M(t.ts))}catch{}})},[]);let F=(0,a.useCallback)(async()=>{z(!0),S(null),v("");try{let r,a,i,n,l,c,p,h,g,f,m=await (0,d.resolveGroqKey)();if(!m){S(t("forma.ask.noKey")),z(!1);return}let u=(r=new Date().toISOString().slice(0,10),a=(0,d.proteinByDay)(e.meals,r),i=e.meals.filter(e=>e.date===r).reduce((e,t)=>e+(t.kcal??0),0),n=e.walks.filter(e=>e.date===r).reduce((e,t)=>e+t.minutes,0),l=(function(){let e=[],t=new Date;for(let o=6;o>=0;o-=1){let r=new Date(t);r.setDate(t.getDate()-o),e.push(r.toISOString().slice(0,10))}return e})().map(t=>({date:t,protein:(0,d.proteinByDay)(e.meals,t),kcal:e.meals.filter(e=>e.date===t).reduce((e,t)=>e+(t.kcal??0),0),walk:e.walks.filter(e=>e.date===t).reduce((e,t)=>e+t.minutes,0)})),(c=new Date).setDate(c.getDate()-6),p=(0,d.weeklyAdherence)(e.sessions,c,e.goal.weeklyFasts),h=(0,d.streakDays)(e.sessions,e.goal.targetHours),g=(0,d.avgFastDuration)(e.sessions,30),f=e.meals.filter(e=>e.date>=l[0].date).slice(-15).map(e=>`${e.date} ${e.slot} \xb7 ${e.proteinG??0}g protein \xb7 ${e.kcal??0}kcal \xb7 ${e.notes||""}`).join("\n"),`You are a concise nutrition + habit coach. Reply in ${"pt"===o?"Portuguese (PT-PT)":"English"}, max 5 short bullet points.
...
Give 3–5 bullets: what's going well, what to fix, one specific next-meal suggestion.`),w=await (0,d.askGroqStream)(u,{key:m,locale:o,maxTokens:400,onChunk:e=>v(e)}),b=Date.now();M(b),(0,s.pJ)(x,JSON.stringify({text:w,ts:b}))}catch(e){S(e instanceof Error?e.message:t("forma.ask.error"))}finally{z(!1)}},[e,o,t]);if(null===b||!1===b)return null;let C=!!$;return(0,r.jsxs)(c,{children:[(0,r.jsxs)(p,{children:[(0,r.jsxs)(h,{children:["✦ ",t("forma.ask.title")]}),(0,r.jsx)(l.$n,{variant:"accent",icon:(0,r.jsx)(l.In,{name:C?"refresh":"message",size:14}),onClick:()=>void F(),disabled:j,children:j?t("forma.ask.loading"):C?t("forma.ask.regenerate"):t("forma.ask.button")})]}),T&&(0,r.jsx)(f,{children:T}),($||j)&&(0,r.jsx)(g,{children:$?(0,r.jsx)(l.mQ,{children:$}):"…"}),null!==k&&!j&&C&&(0,r.jsxs)(m,{children:[t("forma.ask.generatedAt")," \xb7 ",(i=new Date(k),n=e=>String(e).padStart(2,"0"),w=i.toLocaleDateString("pt"===o?"pt-PT":"en-GB",{day:"2-digit",month:"short"}),`${w}, ${n(i.getHours())}:${n(i.getMinutes())}`)]}),!$&&!j&&!T&&(0,r.jsx)(g,{style:{color:s.w4.colors.mainTextMuted,fontStyle:"italic"},children:t("forma.ask.hint")})]})}},72552(e,t,o){o.d(t,{k:()=>j});var r=o(65723),a=o(37991),i=o(36859),n=o.n(i),s=o(6063),l=o(44e3),d=o(14659);let c="#7fb77e",p=2*Math.PI*95,h=n().div`
  display: flex;
  flex-direction: column;
  align-items: center;
  gap: ${s.w4.spacing.md};
...
`,M=n().span`
  ...
  text-transform: uppercase;
  letter-spacing: 0.16em;
`;function j({data:e,t,onStart:o,onStop:i,onEditStart:n}){let z,T,S,F,C,[A,H]=(0,a.useState)(Date.now),L=e.sessions.some(e=>void 0===e.endedAt);(0,a.useEffect)(()=>{if(!L)return;let e=setInterval(()=>H(Date.now()),1e3);return()=>clearInterval(e)},[L]);let D=(0,d.currentFast)(e,A),R=D?.percent??0,B=null!==D,P=D?D.hoursElapsed:0,I=D?D.remainingMs:0,W=D?D.session.targetHours:e.goal.targetHours;return(0,r.jsxs)(h,{children:[(0,r.jsxs)(g,{children:[(0,r.jsxs)(f,{width:200,height:200,viewBox:"0 0 200 200","aria-hidden":"true",children:[(0,r.jsx)("circle",{cx:100,cy:100,r:95,fill:"none",stroke:s.w4.colors.border,strokeWidth:10}),(0,r.jsx)("circle",{cx:100,cy:100,r:95,fill:"none",stroke:c,strokeWidth:10,strokeLinecap:"round",strokeDasharray:p,strokeDashoffset:p*(1-R),style:{transition:"stroke-dashoffset 0.6s ease"}})]}),(0,r.jsx)(m,{children:B?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(x,{children:[P.toFixed(1),"h"]}),(0,r.jsx)(u,{children:t("forma.timer.elapsed")})]}):(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(x,{children:[W,"h"]}),(0,r.jsx)(u,{children:t("forma.hero.notFasting")})]})})]}),B&&D&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(y,{children:[(0,r.jsx)(w,{children:D.session.protocol}),n&&(0,r.jsx)($,{type:"button",onClick:()=>n(D.session),title:t("forma.timer.editStart"),children:t("forma.timer.startedAt",{time:(T=String((z=new Date(D.session.startedAt)).getHours()).padStart(2,"0"),S=String(z.getMinutes()).padStart(2,"0"),`${T}:${S}`)})})]}),(0,r.jsxs)(b,{children:[(0,r.jsxs)(v,{children:[(0,r.jsx)(k,{children:(C=Math.floor((F=Math.floor(I/6e4))/60),`${String(C).padStart(2,"0")}:${String(F%60).padStart(2,"0")}`)}),(0,r.jsx)(M,{children:t("forma.timer.remaining")})]}),(0,r.jsxs)(v,{children:[(0,r.jsxs)(k,{children:[Math.round(100*R),"%"]}),(0,r.jsx)(M,{children:t("forma.timer.complete")})]})]})]}),B&&D?(0,r.jsx)(l.$n,{variant:"danger",onClick:()=>i(D.session),children:t("forma.stop")}):(0,r.jsx)(l.$n,{variant:"success",onClick:o,children:t("forma.start")})]})}},4406(e,t,o){o.d(t,{C:()=>w});var r=o(65723),a=o(37991),i=o(36859),n=o.n(i),s=o(6063),l=o(44e3);let d="#7fb77e",c=n().div`
  display: grid;
...
`;function m({size:e}){return(0,r.jsxs)("svg",{width:14,height:14,viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:[(0,r.jsx)("rect",{x:1.5,y:4.5,width:11,height:5,rx:1,stroke:"currentColor",strokeWidth:1,opacity:.4}),(0,r.jsx)("rect",{x:2,y:5,width:"sm"===e?4:"md"===e?7:11,height:4,rx:.5,fill:"currentColor"})]})}let x=n().div`
  display: flex;
  flex-wrap: wrap;
  gap: ${s.w4.spacing.xs};
...
`;function w({cards:e,t,storageKey:o="forma:layout"}){let[i,n]=(0,a.useState)(null);(0,a.useEffect)(()=>{let t=!1;return(async()=>{let r=await (0,s.PL)(o),a=null;if(r)try{a=JSON.parse(r)}catch{a=null}t||n(function(e,t){let o=new Set(t.map(e=>e.id)),r=new Set,a=[];if(e)for(let t of e)o.has(t.id)&&(a.push(t),r.add(t.id));for(let e of t)r.has(e.id)||a.push({id:e.id,size:e.defaultSize??"sm",hidden:!1});return a}(a,e))})(),()=>{t=!0}},[o,e.map(e=>e.id).join("|")]);let d=(0,a.useCallback)(e=>{n(e),(0,s.Is)(o,JSON.stringify(e))},[o]),b=(0,a.useCallback)((e,t)=>{if(!i)return;let o=i.filter(e=>!e.hidden),r=o.findIndex(t=>t.id===e);if(-1===r)return;let a=r+t;if(a<0||a>=o.length)return;let n=o[a],s=i.findIndex(t=>t.id===e),l=i.findIndex(e=>e.id===n.id),c=[...i];[c[s],c[l]]=[c[l],c[s]],d(c)},[i,d]),y=(0,a.useCallback)(e=>{i&&d(i.map(t=>{var o;return t.id===e?{...t,size:"sm"===(o=t.size)?"md":"md"===o?"lg":"sm"}:t}))},[i,d]),$=(0,a.useCallback)(e=>{i&&d(i.map(t=>t.id===e?{...t,hidden:!0}:t))},[i,d]),v=(0,a.useCallback)(e=>{i&&d(i.map(t=>t.id===e?{...t,hidden:!1}:t))},[i,d]),k=(0,a.useMemo)(()=>{let t=new Map;for(let o of e)t.set(o.id,o);return t},[e]);if(!i)return(0,r.jsx)(c,{});let M=i.filter(e=>!e.hidden),j=i.filter(e=>e.hidden);return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(c,{children:M.map((e,o)=>{let a=k.get(e.id);return a?(0,r.jsxs)(p,{size:e.size,children:[a.render(),(0,r.jsxs)(h,{className:"forma-grid-controls",children:[o>0&&(0,r.jsx)(g,{onClick:()=>b(e.id,-1),title:t("forma.grid.moveLeft"),"aria-label":t("forma.grid.moveLeft"),children:(0,r.jsx)(l.In,{name:"chevron-left",size:14})}),o<M.length-1&&(0,r.jsx)(g,{onClick:()=>b(e.id,1),title:t("forma.grid.moveRight"),"aria-label":t("forma.grid.moveRight"),children:(0,r.jsx)(l.In,{name:"chevron-right",size:14})}),(0,r.jsx)(g,{onClick:()=>y(e.id),title:t("forma.grid.resize",{size:e.size.toUpperCase()}),"aria-label":t("forma.grid.resize",{size:e.size.toUpperCase()}),children:(0,r.jsx)(m,{size:e.size})}),(0,r.jsx)(f,{onClick:()=>$(e.id),title:t("forma.grid.hide"),"aria-label":t("forma.grid.hide"),children:(0,r.jsx)(l.In,{name:"close",size:14})})]})]},e.id):null})}),j.length>0&&(0,r.jsxs)(x,{children:[(0,r.jsx)("span",{style:{fontSize:11,fontFamily:s.w4.typography.fontFamilyMono,color:s.w4.colors.mainTextMuted,textTransform:"uppercase",letterSpacing:"0.16em",alignSelf:"center",marginRight:8},children:t("forma.grid.hiddenLabel")}),j.map(e=>(0,r.jsxs)(u,{onClick:()=>v(e.id),children:["+ ",t(`forma.grid.card.${e.id}`)]},e.id))]})]})}},39276(e,t,o){o.d(t,{Y:()=>L});var r=o(65723),a=o(37991),i=o(36859),n=o.n(i),s=o(6063),l=o(44e3),d=o(72799);let c=(0,d.keyframes)`
...
`;function L({open:e,onClose:t,data:o,t:i,initialMode:n,editing:d,onStartFast:c,onStopFast:p,onLogPastFast:h,onEditFast:g,onLogMeal:f,onEditMeal:m,onLogWeight:x,onEditWeight:v,onLogWalk:D,onEditWalk:R}){let[B,P]=(0,a.useState)(n??null),[I,W]=(0,a.useState)("16:8"),[N,E]=(0,a.useState)("16"),[O,Y]=(0,a.useState)("16:8"),[V,G]=(0,a.useState)("16"),[K,_]=(0,a.useState)(y),[q,J]=(0,a.useState)(""),[Q,U]=(0,a.useState)(null),[X,Z]=(0,a.useState)("dinner"),[ee,et]=(0,a.useState)(""),[eo,er]=(0,a.useState)(""),[ea,ei]=(0,a.useState)(""),[en,es]=(0,a.useState)(w),[el,ed]=(0,a.useState)(""),[ec,ep]=(0,a.useState)(w),[eh,eg]=(0,a.useState)(""),[ef,em]=(0,a.useState)(w);(0,a.useEffect)(()=>{if(e)if(U(null),d?.kind==="fast"){let e=d.entry;P("pastFast"),Y(e.protocol),G(String(e.targetHours)),_(b(e.startedAt)),J(e.endedAt?b(e.endedAt):"")}else if(d?.kind==="meal"){let e=d.entry;P("meal"),Z(e.slot),et(String(e.proteinG??"")),er(String(e.kcal??"")),ei(e.notes??""),es(e.date)}else d?.kind==="weight"?(P("weight"),ed(String(d.entry.kg)),ep(d.entry.date)):d?.kind==="walk"?(P("walk"),eg(String(d.entry.minutes)),em(d.entry.date)):n&&(P(n),"pastFast"===n?(Y("16:8"),G("16"),_(y()),J("")):"meal"===n?(Z("dinner"),et(""),er(""),ei(""),es(w())):"weight"===n?(ed(""),ep(w())):"walk"===n&&(eg(""),em(w())))},[e,d,n]);let ex=o.sessions.some(e=>void 0===e.endedAt),eu=d?.kind??("startFast"===n||"pastFast"===n?"fast":"meal"===n?"meal":"weight"===n?"weight":"walk"===n?"walk":null),ew=null===eu||"fast"===eu,eb=null===eu||"meal"===eu,ey=null===eu||"weight"===eu,e$=null===eu||"walk"===eu,ev=(0,a.useCallback)(()=>{P(null)},[]),ek=(0,a.useCallback)(()=>{ev(),t()},[ev,t]),eM=(0,a.useCallback)(()=>{let e=$(K);if(null===e)return;let t=q.trim(),o=t?$(t):null;if(t&&null===o)return;if(null!==o&&o<=e)return void U(i("forma.sheet.fastInvalidRange"));let r=parseInt(V,10),a=isNaN(r)||r<1?16:r;d?.kind==="fast"&&g?g(d.entry.id,O,a,e,o??void 0):h&&h(O,a,e,o??void 0),ek()},[d,g,h,O,V,K,q,i,ek]),ej=(0,a.useCallback)(()=>{let e=parseInt(N,10);isNaN(e)||e<1||(c(I,e),ek())},[I,N,c,ek]),ez=(0,a.useCallback)(()=>{let e=parseFloat(ee)||0,t=parseFloat(eo)||0;d?.kind==="meal"&&m?m(d.entry.id,X,e,t,ea.trim(),en):f(X,e,t,ea.trim(),en),ek()},[d,m,X,ee,eo,ea,en,f,ek]),eT=(0,a.useCallback)(()=>{let e=parseFloat(el.replace(",","."));isNaN(e)||e<=0||(d?.kind==="weight"&&v?v(ec,e):x(e,ec),ek())},[d,v,el,ec,x,ek]),eS=(0,a.useCallback)(()=>{let e=parseInt(eh,10);isNaN(e)||e<=0||(d?.kind==="walk"&&R?R(d.entry.id,e,ef):D(e,ef),ek())},[d,R,eh,ef,D,ek]);return(0,r.jsx)(u,{open:e,onClose:ek,maxWidth:520,ariaLabel:i("forma.sheet.ariaLabel"),children:(0,r.jsxs)(k,{children:[(0,r.jsx)(l.YZ,{children:d?.kind==="fast"?i("forma.sheet.titleEditFast"):d?.kind==="meal"?i("forma.sheet.titleEditMeal"):d?.kind==="weight"?i("forma.sheet.titleEditWeight"):d?.kind==="walk"?i("forma.sheet.titleEditWalk"):"pastFast"===n?i("forma.sheet.titleAddFast"):"meal"===n?i("forma.sheet.titleAddMeal"):"weight"===n?i("forma.sheet.titleAddWeight"):"walk"===n?i("forma.sheet.titleAddWalk"):i("forma.sheet.title")}),ew&&(0,r.jsx)(j,{children:(0,r.jsx)(l.YZ,{children:i("forma.sheet.fastSection")})}),ew&&("pastFast"===B?(0,r.jsxs)(M,{children:[(0,r.jsxs)(z,{children:[(0,r.jsx)(T,{htmlFor:"past-fast-protocol",children:i("forma.rail.title")}),(0,r.jsxs)(F,{id:"past-fast-protocol",value:O,onChange:e=>{let t=e.target.value;Y(t),"custom"!==t&&G(t.split(":")[0])},children:[(0,r.jsx)("option",{value:"16:8",children:"16:8"}),(0,r.jsx)("option",{value:"18:6",children:"18:6"}),(0,r.jsx)("option",{value:"20:4",children:"20:4"}),(0,r.jsx)("option",{value:"custom",children:i("forma.protocol.custom")})]})]}),"custom"===O&&(0,r.jsxs)(z,{children:[(0,r.jsx)(T,{htmlFor:"past-fast-target",children:i("forma.sheet.fastTargetLabel")}),(0,r.jsx)(S,{id:"past-fast-target",type:"number",value:V,min:1,max:72,onChange:e=>G(e.target.value)})]}),(0,r.jsxs)(z,{children:[(0,r.jsx)(T,{htmlFor:"past-fast-start",children:i("forma.sheet.fastStartLabel")}),(0,r.jsx)(S,{id:"past-fast-start",type:"datetime-local",value:K,max:y(),onChange:e=>{_(e.target.value),U(null)}})]}),(0,r.jsxs)(z,{children:[(0,r.jsx)(T,{htmlFor:"past-fast-end",children:i("forma.sheet.fastEndLabel")}),(0,r.jsx)(S,{id:"past-fast-end",type:"datetime-local",value:q,max:y(),placeholder:i("forma.sheet.fastEndHint"),onChange:e=>{J(e.target.value),U(null)}})]}),Q&&(0,r.jsx)("div",{style:{fontSize:11,fontFamily:s.w4.typography.fontFamilyMono,color:s.w4.colors.danger},children:Q}),(0,r.jsxs)(H,{children:[(0,r.jsx)(l.$n,{variant:"primary",onClick:eM,children:d?.kind==="fast"?i("forma.sheet.saveEdit"):i("forma.sheet.save")}),(0,r.jsx)(l.$n,{variant:"ghost",onClick:ev,children:i("forma.sheet.cancel")})]})]}):ex?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(l.$n,{variant:"danger",onClick:()=>{p(),ek()},children:i("forma.stop")}),(0,r.jsxs)(A,{onClick:()=>P("pastFast"),children:[(0,r.jsx)(l.In,{name:"clock",size:16}),i("forma.sheet.logPastFast")]})]}):"startFast"===B?(0,r.jsxs)(M,{children:[(0,r.jsxs)(z,{children:[(0,r.jsx)(T,{htmlFor:"fast-protocol",children:i("forma.rail.title")}),(0,r.jsxs)(F,{id:"fast-protocol",value:I,onChange:e=>{let t=e.target.value;W(t),"custom"!==t&&E(t.split(":")[0])},children:[(0,r.jsx)("option",{value:"16:8",children:"16:8"}),(0,r.jsx)("option",{value:"18:6",children:"18:6"}),(0,r.jsx)("option",{value:"20:4",children:"20:4"}),(0,r.jsx)("option",{value:"custom",children:i("forma.protocol.custom")})]})]}),"custom"===I&&(0,r.jsxs)(z,{children:[(0,r.jsx)(T,{htmlFor:"fast-hours",children:i("forma.timer.target")}),(0,r.jsx)(S,{id:"fast-hours",type:"number",value:N,min:1,max:72,onChange:e=>E(e.target.value)})]}),(0,r.jsxs)(H,{children:[(0,r.jsx)(l.$n,{variant:"success",onClick:ej,children:i("forma.start")}),(0,r.jsx)(l.$n,{variant:"ghost",onClick:ev,children:i("forma.sheet.cancel")})]})]}):(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(A,{onClick:()=>P("startFast"),children:[(0,r.jsx)(l.In,{name:"play",size:16}),i("forma.start")]}),(0,r.jsxs)(A,{onClick:()=>P("pastFast"),children:[(0,r.jsx)(l.In,{name:"clock",size:16}),i("forma.sheet.logPastFast")]})]})),eb&&(0,r.jsx)(j,{children:(0,r.jsx)(l.YZ,{children:i("forma.sheet.mealSection")})}),eb&&("meal"===B?(0,r.jsxs)(M,{children:[(0,r.jsxs)(z,{children:[(0,r.jsx)(T,{htmlFor:"meal-slot",children:i("forma.meal.lunch")}),(0,r.jsxs)(C,{id:"meal-slot",value:X,onChange:e=>Z(e.target.value),children:[(0,r.jsx)("option",{value:"lunch",children:i("forma.meal.lunch")}),(0,r.jsx)("option",{value:"dinner",children:i("forma.meal.dinner")}),(0,r.jsx)("option",{value:"snack",children:i("forma.meal.snack")})]})]}),(0,r.jsxs)(z,{children:[(0,r.jsx)(T,{htmlFor:"meal-protein",children:i("forma.sheet.proteinLabel")}),(0,r.jsx)(S,{id:"meal-protein",type:"number",value:ee,min:0,placeholder:"0",onChange:e=>et(e.target.value)})]}),(0,r.jsxs)(z,{children:[(0,r.jsx)(T,{htmlFor:"meal-kcal",children:i("forma.sheet.kcalLabel")}),(0,r.jsx)(S,{id:"meal-kcal",type:"number",value:eo,min:0,placeholder:"0",onChange:e=>er(e.target.value)})]}),(0,r.jsxs)(z,{children:[(0,r.jsx)(T,{htmlFor:"meal-notes",children:i("forma.meal.template")}),(0,r.jsx)(S,{id:"meal-notes",type:"text",value:ea,placeholder:"ovos, frango…",onChange:e=>ei(e.target.value)})]}),(0,r.jsxs)(z,{children:[(0,r.jsx)(T,{htmlFor:"meal-date",children:i("forma.sheet.dateLabel")}),(0,r.jsx)(S,{id:"meal-date",type:"date",value:en,max:w(),onChange:e=>es(e.target.value)})]}),(0,r.jsxs)(H,{children:[(0,r.jsx)(l.$n,{variant:"primary",onClick:ez,children:d?.kind==="meal"?i("forma.sheet.saveEdit"):i("forma.sheet.save")}),(0,r.jsx)(l.$n,{variant:"ghost",onClick:ev,children:i("forma.sheet.cancel")})]})]}):(0,r.jsxs)(A,{onClick:()=>P("meal"),children:[(0,r.jsx)(l.In,{name:"utensils",size:16}),i("forma.sheet.logMeal")]})),ey&&(0,r.jsx)(j,{children:(0,r.jsx)(l.YZ,{children:i("forma.sheet.weightSection")})}),ey&&("weight"===B?(0,r.jsxs)(M,{children:[(0,r.jsxs)(z,{children:[(0,r.jsx)(T,{htmlFor:"weight-kg",children:i("forma.sheet.weightLabel")}),(0,r.jsx)(S,{id:"weight-kg",type:"number",value:el,min:20,max:300,step:.1,placeholder:"84.2",onChange:e=>ed(e.target.value)})]}),(0,r.jsxs)(z,{children:[(0,r.jsx)(T,{htmlFor:"weight-date",children:i("forma.sheet.dateLabel")}),(0,r.jsx)(S,{id:"weight-date",type:"date",value:ec,max:w(),onChange:e=>ep(e.target.value)})]}),(0,r.jsxs)(H,{children:[(0,r.jsx)(l.$n,{variant:"primary",onClick:eT,children:d?.kind==="weight"?i("forma.sheet.saveEdit"):i("forma.sheet.save")}),(0,r.jsx)(l.$n,{variant:"ghost",onClick:ev,children:i("forma.sheet.cancel")})]})]}):(0,r.jsxs)(A,{onClick:()=>P("weight"),children:[(0,r.jsx)(l.In,{name:"trending-up",size:16}),i("forma.sheet.logWeight")]})),e$&&(0,r.jsx)(j,{children:(0,r.jsx)(l.YZ,{children:i("forma.sheet.walkSection")})}),e$&&("walk"===B?(0,r.jsxs)(M,{children:[(0,r.jsxs)(z,{children:[(0,r.jsx)(T,{htmlFor:"walk-min",children:i("forma.sheet.walkLabel")}),(0,r.jsx)(S,{id:"walk-min",type:"number",value:eh,min:1,max:600,placeholder:"30",onChange:e=>eg(e.target.value)})]}),(0,r.jsxs)(z,{children:[(0,r.jsx)(T,{htmlFor:"walk-date",children:i("forma.sheet.dateLabel")}),(0,r.jsx)(S,{id:"walk-date",type:"date",value:ef,max:w(),onChange:e=>em(e.target.value)})]}),(0,r.jsxs)(H,{children:[(0,r.jsx)(l.$n,{variant:"primary",onClick:eS,children:d?.kind==="walk"?i("forma.sheet.saveEdit"):i("forma.sheet.save")}),(0,r.jsx)(l.$n,{variant:"ghost",onClick:ev,children:i("forma.sheet.cancel")})]})]}):(0,r.jsxs)(A,{onClick:()=>P("walk"),children:[(0,r.jsx)(l.In,{name:"activity",size:16}),i("forma.sheet.logWalk")]}))]})})}},52128(e,t,o){o.d(t,{g:()=>y});var r=o(65723),a=o(37991),i=o(36859),n=o.n(i),s=o(6063),l=o(14659);let d="#7fb77e",c=n().button`
  display: flex;
  flex-direction: column;
  gap: ${s.w4.spacing.sm};
  background: ${s.w4.colors.surface};
...
`;function y({data:e,t,onClick:o}){let[i,n]=(0,a.useState)(Date.now),s=e.sessions.some(e=>void 0===e.endedAt);(0,a.useEffect)(()=>{if(!s)return;let e=setInterval(()=>n(Date.now()),3e4);return()=>clearInterval(e)},[s]);let d=(0,l.currentFast)(e,i),$=d?.percent??0,v=d?Math.max(0,d.session.targetHours-d.hoursElapsed):0,k=d?`${v.toFixed(1)}h ${t("forma.timer.remaining")}`:t("forma.miniFast.noActive");return(0,r.jsxs)(c,{onClick:o,"aria-label":t("forma.miniFast.aria"),children:[(0,r.jsxs)(p,{children:[(0,r.jsxs)(h,{children:["◉ ",t("forma.miniFast.title")]}),d&&(0,r.jsxs)(g,{children:[Math.round(100*$),"%"]})]}),(0,r.jsxs)(f,{children:[(0,r.jsx)(m,{children:d?d.hoursElapsed.toFixed(1):"—"}),(0,r.jsx)(x,{children:d?`h / ${d.session.targetHours}h`:t("forma.miniFast.noActive")})]}),(0,r.jsx)(w,{children:(0,r.jsx)(b,{pct:$})}),(0,r.jsx)(u,{children:k})]})}},59446(e,t,o){o.d(t,{S:()=>w});var r=o(65723),a=o(37991),i=o(36859),n=o.n(i),s=o(6063),l=o(14659),d=o(11533);let c="#7fb77e",p=n().button`
  display: flex;
  flex-direction: column;
  gap: ${s.w4.spacing.sm};
  background: ${s.w4.colors.surface};
...
`,u=n().div`
  flex: 1;
  min-height: 60px;
`;function w({data:e,t,onClick:o}){let i=(0,a.useMemo)(()=>(0,l.weightForecast)(e.weights,60,30),[e.weights]),n=i.history.length>0?i.history[i.history.length-1]:null,c=i.forecast.length>0?i.forecast[i.forecast.length-1]:null,b=n&&c?c.kg-n.kg:0;return(0,r.jsxs)(p,{onClick:o,"aria-label":t("forma.miniWeight.aria"),children:[(0,r.jsxs)(h,{children:[(0,r.jsxs)(g,{children:["◉ ",t("forma.miniWeight.title")]}),c&&(0,r.jsxs)(x,{pos:b>0,children:[b>=0?"+":"",b.toFixed(1),"kg / 30d"]})]}),(0,r.jsxs)(f,{children:[(0,r.jsx)(m,{children:n?n.kg.toFixed(1):"—"}),(0,r.jsx)("span",{style:{color:s.w4.colors.mainTextMuted,fontSize:13,fontFamily:s.w4.typography.fontFamilyMono},children:"kg"}),c&&(0,r.jsxs)("span",{style:{color:s.w4.colors.mainTextMuted,fontSize:12,fontFamily:s.w4.typography.fontFamilyMono},children:["→ ",c.kg.toFixed(1)," kg"]})]}),(0,r.jsx)(u,{children:(0,r.jsx)(d.h,{forecast:i,axes:!1})})]})}},68477(e,t,o){o.d(t,{P:()=>p});var r=o(65723),a=o(36859),i=o.n(a),n=o(6063);let s="#7fb77e",l=["16:8","18:6","20:4","custom"],d=i().div`
  display: flex;
  gap: ${n.w4.spacing.sm};
  overflow-x: auto;
...
`;function p({t:e,active:t,onChange:o}){return(0,r.jsx)(d,{role:"group","aria-label":e("forma.rail.title"),children:l.map(a=>(0,r.jsx)(c,{active:t===a,onClick:()=>o(a),"aria-pressed":t===a,children:e(`forma.protocol.${a}`)},a))})}},71589(e,t,o){o.d(t,{B:()=>f});var r=o(65723),a=o(36859),i=o.n(a),n=o(6063);let s="#7fb77e",l=[{id:"16:8",fastH:16,windowH:8},{id:"18:6",fastH:18,windowH:6},{id:"20:4",fastH:20,windowH:4},{id:"custom",fastH:0,windowH:0}],d=i().aside`
  width: 260px;
  flex-shrink: 0;
...
`,g=i().span`
  ...
  font-family: ${n.w4.typography.fontFamilyMono};
  color: ${n.w4.colors.mainTextMuted};
`;function f({t:e,active:t,onChange:o}){return(0,r.jsxs)(d,{"aria-label":e("forma.rail.title"),children:[(0,r.jsx)(c,{children:e("forma.rail.title")}),l.map(a=>(0,r.jsxs)(p,{active:t===a.id,onClick:()=>o(a.id),"aria-pressed":t===a.id,children:[(0,r.jsx)(h,{active:t===a.id,children:e(`forma.protocol.${a.id}`)}),a.fastH>0&&(0,r.jsxs)(g,{children:[e("forma.rail.hours",{n:a.fastH})," \xb7 ",e("forma.rail.window",{n:a.windowH})]})]},a.id))]})}},25405(e,t,o){o.d(t,{F:()=>p});var r=o(65723),a=o(37991),i=o(36859),n=o.n(i),s=o(6063);let l=n().form`
  display: flex;
  align-items: center;
  gap: ${s.w4.spacing.sm};
  padding: ${s.w4.spacing.sm} ${s.w4.spacing.md};
...
`,c=n().span`
  ...
  color: ${s.w4.colors.mainTextMuted};
  white-space: nowrap;
`;function p({t:e,onParsed:t}){let[o,i]=(0,a.useState)(""),[n,s]=(0,a.useState)(!1),h=(0,a.useCallback)(e=>{e.preventDefault();let r=function(e){let t=e.trim().toLowerCase();if(!t)return null;let o=t.match(/^(?:peso|weight)\s+(\d+(?:[.,]\d+)?)/);if(o){let e=parseFloat(o[1].replace(",","."));if(!isNaN(e))return{kind:"weight",weightKg:e}}let r=t.match(/^(?:caminhei|walked|walk|caminhada)\s+(\d+)/);if(r){let e=parseInt(r[1],10);if(!isNaN(e))return{kind:"walk",walkMinutes:e}}let a=t.match(/^(?:jejum|fast)\s+(\d+)/);if(a){let e=parseInt(a[1],10);if(!isNaN(e))return{kind:"fast",fastHours:e,fastProtocol:16===e?"16:8":18===e?"18:6":20===e?"20:4":"custom"}}let i=t.match(/^(jantar|almoço|almoco|dinner|snack|lanche|lunch)\s+(.*)/);if(i){let e=i[1];return{kind:"meal",mealSlot:"jantar"===e||"dinner"===e?"dinner":"almo\xe7o"===e||"almoco"===e||"lunch"===e?"lunch":"snack",mealDesc:i[2].trim()}}return null}(o);if(!r){s(!0),setTimeout(()=>s(!1),1200);return}t(r),i("")},[o,t]);return(0,r.jsxs)(l,{onSubmit:h,children:[(0,r.jsx)(d,{value:o,onChange:e=>i(e.target.value),placeholder:e("forma.quickadd.placeholder"),style:{borderColor:n?"#f85149":void 0},"aria-label":e("forma.quickadd.hint")}),(0,r.jsx)(c,{children:e("forma.quickadd.hint")})]})}},20429(e,t,o){o.d(t,{f:()=>w});var r=o(65723),a=o(37991),i=o(36859),n=o.n(i),s=o(6063),l=o(44e3);let d="#7fb77e",c=n().section`
  display: flex;
  flex-direction: column;
  gap: ${s.w4.spacing.lg};
  max-width: 560px;
...
`,u=n().span`
  ...
  color: ${d};
  align-self: center;
`;function w({data:e,t,onSave:o}){let[i,n]=(0,a.useState)(String(e.goal.proteinG??110)),[s,d]=(0,a.useState)(String(e.goal.kcal??2200)),[b,y]=(0,a.useState)(String(e.goal.walkMin??30)),[$,v]=(0,a.useState)(String(e.goal.weightKg??"")),[k,M]=(0,a.useState)(String(e.goal.targetHours)),[j,z]=(0,a.useState)(String(e.goal.weeklyFasts)),[T,S]=(0,a.useState)(!1),F=async()=>{let t={...e,goal:{targetHours:Number(k)||16,weeklyFasts:Number(j)||5,proteinG:Number(i)||void 0,kcal:Number(s)||void 0,walkMin:Number(b)||void 0,weightKg:$?Number($):void 0}};await o(t),S(!0),setTimeout(()=>S(!1),2e3)};return(0,r.jsxs)(c,{children:[(0,r.jsxs)(p,{children:[(0,r.jsxs)(h,{children:["◉ ",t("forma.settings.foodGoals")]}),(0,r.jsxs)(g,{children:[(0,r.jsx)(f,{children:t("forma.settings.proteinG")}),(0,r.jsx)(m,{type:"number",value:i,onChange:e=>n(e.target.value)})]}),(0,r.jsxs)(g,{children:[(0,r.jsx)(f,{children:t("forma.settings.kcal")}),(0,r.jsx)(m,{type:"number",value:s,onChange:e=>d(e.target.value)})]}),(0,r.jsxs)(g,{children:[(0,r.jsx)(f,{children:t("forma.settings.walkMin")}),(0,r.jsx)(m,{type:"number",value:b,onChange:e=>y(e.target.value)})]}),(0,r.jsxs)(g,{children:[(0,r.jsx)(f,{children:t("forma.settings.weightTarget")}),(0,r.jsx)(m,{type:"number",step:"0.1",value:$,onChange:e=>v(e.target.value)})]})]}),(0,r.jsxs)(p,{children:[(0,r.jsxs)(h,{children:["◉ ",t("forma.settings.fastingGoals")]}),(0,r.jsxs)(g,{children:[(0,r.jsx)(f,{children:t("forma.settings.targetHours")}),(0,r.jsx)(m,{type:"number",value:k,onChange:e=>M(e.target.value)})]}),(0,r.jsxs)(g,{children:[(0,r.jsx)(f,{children:t("forma.settings.weeklyFasts")}),(0,r.jsx)(m,{type:"number",value:j,onChange:e=>z(e.target.value)})]})]}),(0,r.jsxs)(x,{children:[T&&(0,r.jsx)(u,{children:t("forma.settings.saved")}),(0,r.jsx)(l.$n,{variant:"primary",onClick:()=>void F(),children:t("forma.settings.save")})]})]})}},15742(e,t,o){o.d(t,{_:()=>S});var r=o(65723),a=o(36859),i=o.n(a),n=o(6063),s=o(44e3),l=o(14659);let d="#7fb77e",c=i().section`
...
`,T=i().div`
  ...
  font-family: ${n.w4.typography.fontFamilyMono};
  font-variant-numeric: tabular-nums;
`;function S({data:e,t,onLogMeal:o,onLogWalk:a,onLogWeight:i,onDeleteMeal:d,onEditMeal:F}){var C,A;let H=new Date().toISOString().slice(0,10),L=(0,l.proteinByDay)(e.meals,H),D=(C=e.meals,C.filter(e=>e.date===H).reduce((e,t)=>e+(t.kcal??0),0)),R=(A=e.walks,A.filter(e=>e.date===H).reduce((e,t)=>e+t.minutes,0)),B=e.meals.filter(e=>e.date===H).sort((e,t)=>e.createdAt-t.createdAt),P=e.goal.proteinG??110;return(0,r.jsxs)(c,{children:[(0,r.jsxs)(p,{children:[(0,r.jsxs)(h,{children:["◉ ",t("forma.today.title")]}),(0,r.jsx)(h,{children:new Date().toLocaleDateString(void 0,{weekday:"long",day:"numeric",month:"short"})})]}),(0,r.jsxs)(g,{children:[(0,r.jsxs)(f,{children:[(0,r.jsxs)(m,{children:[Math.round(L),(0,r.jsxs)("span",{style:{fontSize:14,color:n.w4.colors.mainTextMuted,marginLeft:4},children:["/ ",P,"g"]})]}),(0,r.jsx)(x,{children:t("forma.today.protein")})]}),(0,r.jsxs)(f,{children:[(0,r.jsx)(m,{children:Math.round(D)}),(0,r.jsx)(x,{children:t("forma.today.kcal")})]}),(0,r.jsxs)(f,{children:[(0,r.jsxs)(m,{children:[R,(0,r.jsx)("span",{style:{fontSize:14,color:n.w4.colors.mainTextMuted,marginLeft:4},children:"min"})]}),(0,r.jsx)(x,{children:t("forma.today.walk")})]})]}),(0,r.jsx)(u,{children:(0,r.jsx)(w,{pct:L/P*100})}),(0,r.jsxs)(b,{children:[(0,r.jsx)(s.$n,{variant:"primary",icon:(0,r.jsx)(s.In,{name:"plus",size:14}),onClick:o,children:t("forma.action.logMeal")}),(0,r.jsx)(s.$n,{variant:"ghost",icon:(0,r.jsx)(s.In,{name:"plus",size:14}),onClick:a,children:t("forma.action.logWalk")}),(0,r.jsx)(s.$n,{variant:"ghost",icon:(0,r.jsx)(s.In,{name:"plus",size:14}),onClick:i,children:t("forma.action.logWeight")})]}),0===B.length?(0,r.jsx)(z,{children:t("forma.today.noMealsYet")}):(0,r.jsx)(y,{children:B.map(e=>(0,r.jsxs)($,{onClick:F?()=>F(e.id):void 0,style:{cursor:F?"pointer":"default"},title:F?t("forma.action.edit"):void 0,children:[(0,r.jsx)(v,{children:t(`forma.meal.${e.slot}`)}),(0,r.jsx)(k,{children:e.notes||"—"}),(0,r.jsxs)(M,{children:[e.proteinG??0,"g \xb7 ",e.kcal??0,"kcal"]}),(0,r.jsx)(j,{onClick:t=>{t.stopPropagation(),d(e.id)},"aria-label":t("forma.action.delete"),children:(0,r.jsx)(s.In,{name:"trash",size:14})})]},e.id))}),R>0&&(0,r.jsx)(T,{children:(0,r.jsx)("span",{children:t("forma.today.walkSummary",{min:R})})})]})}},20483(e,t,o){o.d(t,{v:()=>v});var r=o(65723),a=o(36859),i=o.n(a),n=o(72799),s=o(6063),l=o(44e3);let d="#7fb77e",c=(0,n.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
...
`,$=i().div`
  ...
  border-radius: 50%;
  background: ${s.w4.colors.border};
`;function v({data:e,t,locale:o,onTapTemplate:a}){let i,n,s,d=(n=new Date(i=new Date),s=(i.getDay()+6)%7,n.setDate(i.getDate()-s),n.setHours(0,0,0,0),Array.from({length:7},(e,t)=>{let o=new Date(n);return o.setDate(n.getDate()+t),{date:g(o),weekday:o.getDay()}})),c=g(new Date),k="pt"===o?h:p,M=new Map;for(let t of e.templates)M.set(t.weekday,t);return(0,r.jsxs)(f,{children:[(0,r.jsx)(m,{children:t("forma.week.title")}),(0,r.jsx)(x,{children:d.map(({date:o,weekday:i})=>{let n=o===c,s=e.meals.some(e=>e.date===o),d=e.sessions.some(e=>void 0!==e.endedAt&&g(new Date(e.startedAt))===o),p=s||d,h=M.get(i),f=n&&void 0!==h&&void 0!==a&&!s;return(0,r.jsxs)(u,{isToday:n,isDone:p,tappable:f,onClick:()=>{f&&h&&a?.(h)},type:"button",title:f?t("forma.week.tapToLog"):void 0,"aria-label":f?t("forma.week.tapToLog"):void 0,children:[(0,r.jsx)(w,{isToday:n,children:k[i]}),p?(0,r.jsx)(y,{"aria-label":t("forma.week.done"),children:(0,r.jsx)(l.In,{name:"check-circle",size:14})}):h?(0,r.jsx)($,{title:t("forma.week.planned")}):null,h&&(0,r.jsx)(b,{children:t(h.nameKey)})]},o)})})]})}},11533(e,t,o){o.d(t,{h:()=>h});var r=o(65723),a=o(37991),i=o(36859),n=o.n(i),s=o(6063);let l="#7fb77e",d=n().div`
  position: relative;
  width: 100%;
  height: 100%;
  min-height: 140px;
...
`;function h({forecast:e,axes:t=!0}){let o=(0,a.useMemo)(()=>[...e.history,...e.forecast],[e.history,e.forecast]);if(o.length<2)return(0,r.jsx)(d,{children:(0,r.jsx)("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",height:"100%",color:s.w4.colors.mainTextMuted,fontSize:12,fontFamily:s.w4.typography.fontFamilyMono},children:"—"})});let i=t?36:8,n=t?18:4,g=o.map(e=>e.kg),f=Math.min(...g),m=Math.max(...g),x=m-f||1,u=new Date(o[0].date).getTime(),w=new Date(o[o.length-1].date).getTime()-u||1,b=e=>i+(new Date(e).getTime()-u)/w*(600-2*i),y=e=>200-n-(e-f)/x*(200-2*n),$=e.history.map((e,t)=>`${0===t?"M":"L"} ${b(e.date).toFixed(1)} ${y(e.kg).toFixed(1)}`).join(" "),v=e.forecast.length?`M ${b(e.history[e.history.length-1].date).toFixed(1)} ${y(e.history[e.history.length-1].kg).toFixed(1)} `+e.forecast.map(e=>`L ${b(e.date).toFixed(1)} ${y(e.kg).toFixed(1)}`).join(" "):"",k=e.history[e.history.length-1],M=e.forecast[e.forecast.length-1];return(0,r.jsx)(d,{children:(0,r.jsxs)(c,{viewBox:"0 0 600 200",preserveAspectRatio:"none",children:[t&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(p,{x:4,y:n+4,children:m.toFixed(1)}),(0,r.jsx)(p,{x:4,y:200-n+4,children:f.toFixed(1)}),(0,r.jsx)("line",{x1:i,y1:200-n,x2:600-i,y2:200-n,stroke:s.w4.colors.border,strokeWidth:1}),(0,r.jsx)("line",{x1:i,y1:n,x2:i,y2:200-n,stroke:s.w4.colors.border,strokeWidth:1})]}),(0,r.jsx)("path",{d:$,fill:"none",stroke:l,strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"}),v&&(0,r.jsx)("path",{d:v,fill:"none",stroke:l,strokeWidth:2,strokeDasharray:"4 4",strokeLinecap:"round",opacity:.65}),M&&(0,r.jsx)("circle",{cx:b(M.date),cy:y(M.kg),r:3,fill:l,opacity:.7}),k&&(0,r.jsx)("circle",{cx:b(k.date),cy:y(k.kg),r:4,fill:l,stroke:s.w4.colors.surface,strokeWidth:1.5})]})})}},92152(e,t,o){o.d(t,{m:()=>M});var r=o(65723),a=o(37991),i=o(36859),n=o.n(i),s=o(6063),l=o(44e3),d=o(14659),c=o(11533);let p="#7fb77e",h=n().section`
  display: flex;
  flex-direction: column;
  gap: ${s.w4.spacing.lg};
`,g=n().div`
...
`,x=({size:e=14,strokeWidth:t=1.75})=>(0,r.jsxs)("svg",{width:e,height:e,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:t,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,r.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,r.jsx)("polyline",{points:"14 2 14 8 20 8"})]});function u({iconKey:e}){let t=e?p[e]:void 0;return t?(0,r.jsx)("svg",{width:14,height:14,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,dangerouslySetInnerHTML:{__html:t}}):(0,r.jsx)(x,{})}function w({entries:e,activeId:t,onSelect:o}){return(0,r.jsx)(r.Fragment,{children:e.map(e=>e.children?(0,r.jsx)(i().Fragment,{children:(0,r.jsx)(w,{entries:e.children,activeId:t,onSelect:o})},e.id):(0,r.jsxs)(m,{active:t===e.id,onClick:()=>o(e),children:[(0,r.jsx)(u,{iconKey:e.icon}),e.name]},e.id))})}function b({activeId:e}){let{flyout:t,scheduleFlyoutClose:o,cancelFlyoutClose:a}=(0,c.c)();if(!t)return null;let i=t.entry.icon?p[t.entry.icon]:void 0;return(0,r.jsxs)(g,{anchorY:t.anchorY,onMouseEnter:a,onMouseLeave:o,children:[(0,r.jsxs)(f,{children:[i?(0,r.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,dangerouslySetInnerHTML:{__html:i}}):(0,r.jsx)(x,{size:13,strokeWidth:2}),t.entry.name]}),(0,r.jsx)(w,{entries:t.entry.children??[],activeId:e,onSelect:e=>{t.onSelect(e),o()}})]})}},37993(e,t,o){o.d(t,{I:()=>a,c:()=>i});var r=o(37991);let a=(0,r.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),i=()=>(0,r.useContext)(a)},44e3(e,t,o){o.d(t,{vu:()=>R,Ex:()=>N,$n:()=>w,YZ:()=>O,n6:()=>k,In:()=>M,rl:()=>J,mQ:()=>eV,PE:()=>td,eu:()=>C});var r=o(65723),a=o(37991),i=o.n(a),n=o(36859),s=o.n(n),l=o(6063);let d={ghost:"transparent",accent:"transparent",primary:l.w4.colors.accent,success:"#238636",danger:"#da3633"},c={ghost:l.w4.colors.sidebarHover,accent:"rgba(88,166,255,0.10)",primary:l.w4.colors.accentHover,success:"#2ea043",danger:"#f85149"},p={ghost:l.w4.colors.border,accent:l.w4.colors.accent,primary:l.w4.colors.accent,success:"#238636",danger:"#da3633"},h={ghost:l.w4.colors.mainTextMuted,accent:l.w4.colors.accent,primary:"#fff",success:"#fff",danger:"#fff"},g={ghost:l.w4.colors.mainText,accent:l.w4.colors.accent,primary:"#fff",success:"#fff",danger:"#fff"},f={sm:"28px",md:"30px"},m={sm:"0 10px",md:"0 12px"},x={sm:"12px",md:"12px"},u=s().button`
  display: inline-flex;
  align-items: center;
  justify-content: center;
  gap: 6px;
...
`,z=s().span`
  ...
  line-height: 1;
  letter-spacing: 0;
`,T=["#3b82f6","#8b5cf6","#ec4899","#10b981","#f59e0b","#06b6d4"],S=0,F=new Map;function C({member:e,size:t=24}){var o,a;let i,n="shared"===e.id||"shared"===e.role,s=Math.floor(.55*t),d=t<=18?8:t<=22?9:t<=28?11:12;if(n)return(0,r.jsx)(j,{size:t,bg:l.w4.colors.surface,ring:!0,"aria-label":"Shared",title:"Shared",style:{color:l.w4.colors.mainTextMuted},children:(0,r.jsx)(M,{name:"home",size:s,"aria-hidden":!0})});let c=(o=e.id,(a=e.color)?a:(!F.has(o)&&(F.set(o,T[S%T.length]),S++),F.get(o))),p="adult"===e.role,h=(i=e.name.trim().split(/\s+/),((i[0]?.[0]??"")+(i[1]?.[0]??"")).toUpperCase().slice(0,2));return(0,r.jsx)(j,{size:t,bg:c,ring:p,title:e.name,children:(0,r.jsx)(z,{fontSize:d,children:h})})}s().img`
  width: ${({size:e})=>e}px;
  height: ${({size:e})=>e}px;
  border-radius: 50%;
  object-fit: cover;
...
`,R=i().forwardRef(function({variant:e="default",dotColor:t,children:o,onClick:a,...i},n){return(0,r.jsxs)(L,{ref:n,variant:e,clickable:!!a,onClick:a,type:i.type??"button",...i,children:[t&&(0,r.jsx)(D,{color:t}),o]})}),B={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:l.w4.colors.accentMuted},P={neutral:l.w4.colors.mainTextMuted,live:l.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:l.w4.colors.accent},I=s().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${l.w4.typography.fontFamilyMono};
...
`,W=s().span`
  ...
  display: inline-block;
`;function N({tone:e="neutral",dot:t,children:o,...a}){return(0,r.jsxs)(I,{tone:e,...a,children:[(t??"live"===e)&&(0,r.jsx)(W,{}),o]})}s().kbd`
  font-family: ${l.w4.typography.fontFamilyMono};
  font-size: 10px;
  padding: 2px 6px;
  border: 1px solid ${l.w4.colors.border};
...
`;let E=s().div`
  ...
  align-items: center;
  gap: 8px;
`;function O({children:e,...t}){return(0,r.jsx)(E,{...t,children:e})}s().label`
  display: flex;
  align-items: center;
  gap: 10px;
...
`;function J({title:e,accessory:t,accentColor:o,error:a,errorLabel:i,children:n}){return(0,r.jsxs)(Y,{accentColor:o,"data-widget-shell":!0,children:[(0,r.jsxs)(V,{children:[(0,r.jsx)(O,{children:e}),t&&(0,r.jsx)(G,{children:t})]}),a?(0,r.jsxs)(_,{role:"alert",children:[(0,r.jsx)(q,{children:i??"Error"}),(0,r.jsx)("div",{children:a})]}):(0,r.jsx)(K,{children:n})]})}s().div`
  position: relative;
  display: flex;
  flex-direction: column;
  height: 100%;
...
`,s().p`
  ...
  font-size: 12.5px;
  line-height: 1.45;
`;var X=o(11352),Z=o(76710),ee=o(4311),et=o(73639),eo=o(40080);o(75406),s().nav`padding: ${l.w4.spacing.sm} 0;`,s().div`
...
`;var er=o(54041);let ea="https://cdn.jsdelivr.net/npm/mermaid@11.14.0/dist/mermaid.min.js",ei=null,en="#7fb77e",es=(0,$.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,el=s().div`
  position: relative;
...
`,ep=!1,eh=/^(?:---[\s\S]*?---\s*)?(?:graph|flowchart|sequenceDiagram|classDiagram|stateDiagram(?:-v2)?|erDiagram|pie|gantt|journey|mindmap|gitGraph|sankey(?:-beta)?|quadrantChart|requirementDiagram|timeline|xychart-beta|block-beta|C4Context|C4Container|C4Component|C4Dynamic|C4Deployment)\b/;function eg({code:e}){let[t,o]=(0,a.useState)(""),[i,n]=(0,a.useState)(!1);return((0,a.useEffect)(()=>{let t=!1;n(!1),o("");let r=e.trim();if(!r)return void n(!0);let a=r.split(/\r?\n/)[0]?.trim()??"";if(!eh.test(a))return void n(!0);let i=setTimeout(()=>{t||(console.error("[MermaidBlock] render timed out after 5s"),n(!0))},5e3);return(async()=>{try{let e=await (ei||(ei=new Promise((e,t)=>{let o=globalThis.mermaid;if(o)return void e(o);let r=document.createElement("script");r.src=ea,r.async=!0,r.onload=()=>{let o=globalThis.mermaid;o?e(o):t(Error("mermaid loaded but globalThis.mermaid missing"))},r.onerror=()=>t(Error(`failed to load ${ea}`)),document.head.appendChild(r)})));if(console.debug("[MermaidBlock] mermaid ready",{initialized:ep}),!ep){let t="#141820",o="#1c2332",r="#343c4f",a="#e8edf5",i="#9aa5b8",n="#7fb77e",s="#6aa8d8",l="#8b7bff",d="#e89a5c",c="#f87171";e.initialize({startOnLoad:!1,theme:"base",securityLevel:"loose",themeVariables:{fontFamily:"-apple-system, BlinkMacSystemFont, Segoe UI, Helvetica, Arial, sans-serif",background:t,mainBkg:o,primaryColor:n,primaryTextColor:a,primaryBorderColor:n,secondaryColor:l,secondaryTextColor:a,secondaryBorderColor:l,tertiaryColor:s,tertiaryTextColor:a,tertiaryBorderColor:s,lineColor:i,textColor:a,nodeBorder:r,clusterBkg:t,clusterBorder:r,edgeLabelBackground:o,labelBackground:o,labelBorder:r,relationLabelBackground:o,relationLabelColor:a,pie1:n,pie2:l,pie3:s,pie4:d,pie5:"#ff6fa9",pie6:"#2dd4bf",pie7:c,pie8:n,pieStrokeColor:t,pieStrokeWidth:"2px",pieTitleTextSize:"18px",pieSectionTextSize:"13px",pieLegendTextSize:"13px",actorBkg:n,actorBorder:n,actorTextColor:t,signalColor:a,signalTextColor:a,labelBoxBkgColor:o,labelBoxBorderColor:r,labelTextColor:a,loopTextColor:a,noteBkgColor:d,noteBorderColor:d,noteTextColor:t,stateBkg:o,altBackground:t,attributeBackgroundColorOdd:o,attributeBackgroundColorEven:t,rowOdd:o,rowEven:t,gridColor:r,sectionBkgColor:o,sectionBkgColor2:t,taskBkgColor:l,taskTextColor:a,taskTextDarkColor:a,taskTextLightColor:a,taskTextOutsideColor:a,activeTaskBkgColor:n,activeTaskBorderColor:n,doneTaskBkgColor:i,doneTaskBorderColor:i,critBkgColor:c,critBorderColor:c}}),ep=!0}console.debug("[MermaidBlock] calling mermaid.render");let{svg:a}=await e.render(`mermaid-${(0,er.z)()}`,r);if(clearTimeout(i),console.debug("[MermaidBlock] render returned",{length:a?.length??0}),t)return;let s=/aria-roledescription="error"/i.test(a)||/class="error-(?:icon|text)"/i.test(a)||/>Syntax error in text</i.test(a);if(!a||s)return void n(!0);o(a)}catch(e){clearTimeout(i),console.error("[MermaidBlock] render failed",e),t||n(!0)}})(),()=>{t=!0,clearTimeout(i)}},[e]),i)?(0,r.jsx)(ec,{children:e.trim()}):t?(0,r.jsx)(el,{dangerouslySetInnerHTML:{__html:t}}):(0,r.jsx)(el,{children:(0,r.jsx)(ed,{"aria-hidden":!0})})}let ef=["#388bfd","#3fb950","#d29922","#a371f7","#f87171","#22d3ee","#fb923c","#34d399","#f472b6","#818cf8"],em=s().div`
  background: ${l.w4.colors.codeBg};
  border: 1px solid ${l.w4.colors.codeBorder};
  border-radius: ${l.w4.borderRadius.md};
...
`,ey=s().pre`
  ...
  color: ${l.w4.colors.mainTextMuted};
  white-space: pre-wrap;
`;function e$(e){if(e<=0)return 10;let t=Math.pow(10,Math.floor(Math.log10(e)));return Math.ceil(e/t)*t}function ev(e,t,o){let r=Math.max(1,Math.ceil(o/8));return 0!==t&&t!==o-1&&t%r!=0?"":e.length>12?e.slice(0,11)+"…":e}function ek({labels:e,data:t,colors:o}){let a=340,i=176,n=e$(Math.max(...t,1)),s=Math.min(40,a/e.length*.6),d=a/e.length,c=Array.from({length:6},(e,t)=>n/5*t);return(0,r.jsxs)("svg",{viewBox:"0 0 400 240",width:"100%",style:{maxWidth:400},children:[c.map((e,t)=>{let o=16+i-e/n*i;return(0,r.jsxs)("g",{children:[(0,r.jsx)("line",{x1:44,y1:o,x2:384,y2:o,stroke:l.w4.colors.border,strokeWidth:.5,strokeDasharray:0===t?"none":"3,3"}),(0,r.jsx)("text",{x:38,y:o+4,fill:l.w4.colors.mainTextMuted,fontSize:10,textAnchor:"end",fontFamily:l.w4.typography.fontFamily,children:Math.round(e)})]},t)}),t.map((t,a)=>{let c=44+d*a+d/2-s/2,p=t/n*i,h=16+i-p,g=o[a%o.length];return(0,r.jsxs)("g",{children:[(0,r.jsxs)("rect",{x:c,y:h,width:s,height:p,rx:3,fill:g,opacity:.85,children:[(0,r.jsx)("animate",{attributeName:"height",from:"0",to:p,dur:"0.5s",fill:"freeze"}),(0,r.jsx)("animate",{attributeName:"y",from:16+i,to:h,dur:"0.5s",fill:"freeze"})]}),(0,r.jsx)("text",{x:c+s/2,y:h-4,fill:l.w4.colors.mainText,fontSize:10,fontWeight:600,textAnchor:"middle",fontFamily:l.w4.typography.fontFamily,children:t}),(0,r.jsx)("text",{x:44+d*a+d/2,y:208,fill:l.w4.colors.mainTextMuted,fontSize:10,textAnchor:"middle",fontFamily:l.w4.typography.fontFamily,children:ev(e[a],a,e.length)})]},a)})]})}function eM({labels:e,data:t,colors:o}){let a=t.reduce((e,t)=>e+t,0)||1,i=-Math.PI/2,n=t.map((e,t)=>{let n=e/a*Math.PI*2,s=i,d=i+=n,c=120+90*Math.cos(s),p=120+90*Math.sin(s),h=120+90*Math.cos(d),g=120+90*Math.sin(d),f=+(n>Math.PI),m=s+n/2,x=120+58.5*Math.cos(m),u=120+58.5*Math.sin(m),w=Math.round(e/a*100);return(0,r.jsxs)("g",{children:[(0,r.jsx)("path",{d:`M 120 120 L ${c} ${p} A 90 90 0 ${f} 1 ${h} ${g} Z`,fill:o[t%o.length],stroke:l.w4.colors.codeBg,strokeWidth:2,opacity:.85}),w>=5&&(0,r.jsxs)("text",{x:x,y:u+4,fill:"#fff",fontSize:11,fontWeight:600,textAnchor:"middle",fontFamily:l.w4.typography.fontFamily,children:[w,"%"]})]},t)});return(0,r.jsx)("svg",{viewBox:"0 0 240 240",width:"100%",style:{maxWidth:240},children:n})}function ej({labels:e,data:t,colors:o}){let a=340,i=176,n=e$(Math.max(...t,1)),s=t.length>1?a/(t.length-1):a,d=o[0],c=t.map((e,t)=>({x:44+s*t,y:16+i-e/n*i})),p=c.map((e,t)=>`${0===t?"M":"L"} ${e.x} ${e.y}`).join(" "),h=Array.from({length:6},(e,t)=>n/5*t);return(0,r.jsxs)("svg",{viewBox:"0 0 400 240",width:"100%",style:{maxWidth:400},children:[h.map((e,t)=>{let o=16+i-e/n*i;return(0,r.jsxs)("g",{children:[(0,r.jsx)("line",{x1:44,y1:o,x2:384,y2:o,stroke:l.w4.colors.border,strokeWidth:.5,strokeDasharray:0===t?"none":"3,3"}),(0,r.jsx)("text",{x:38,y:o+4,fill:l.w4.colors.mainTextMuted,fontSize:10,textAnchor:"end",fontFamily:l.w4.typography.fontFamily,children:Math.round(e)})]},t)}),(0,r.jsx)("path",{d:p,fill:"none",stroke:d,strokeWidth:2.5,strokeLinecap:"round",strokeLinejoin:"round"}),c.map((o,a)=>(0,r.jsxs)("g",{children:[(0,r.jsx)("circle",{cx:o.x,cy:o.y,r:4,fill:d,stroke:l.w4.colors.codeBg,strokeWidth:2}),(0,r.jsx)("text",{x:o.x,y:o.y-10,fill:l.w4.colors.mainText,fontSize:10,fontWeight:600,textAnchor:"middle",fontFamily:l.w4.typography.fontFamily,children:t[a]}),(0,r.jsx)("text",{x:o.x,y:208,fill:l.w4.colors.mainTextMuted,fontSize:10,textAnchor:"middle",fontFamily:l.w4.typography.fontFamily,children:ev(e[a],a,e.length)})]},a))]})}function ez({code:e}){let t=(0,a.useMemo)(()=>(function(e){let t,o,r=e.trim().split("\n"),a="bar",i=[],n=[];for(let e of r){let[r,...s]=e.split(":"),l=s.join(":").trim();if(l)switch(r.trim().toLowerCase()){case"type":["bar","pie","line"].includes(l.toLowerCase())&&(a=l.toLowerCase());break;case"title":t=l;break;case"labels":i=l.replace(/^\[|\]$/g,"").split(",").map(e=>e.trim()).filter(Boolean);break;case"data":n=l.replace(/^\[|\]$/g,"").split(",").map(e=>e.trim()).filter(Boolean).map(e=>parseFloat(e)||0);break;case"colors":{let e=l.replace(/^\[|\]$/g,"").split(",").map(e=>e.trim()).filter(Boolean);o=e.length?e:void 0}}}return i.length&&n.length?{type:a,title:t,labels:i,data:n,colors:o}:null})(e),[e]);if(!t)return(0,r.jsx)(ey,{children:e.trim()});let o=t.colors??ef;return(0,r.jsxs)(em,{children:[t.title&&(0,r.jsx)(ex,{children:t.title}),"bar"===t.type&&(0,r.jsx)(ek,{labels:t.labels,data:t.data,colors:o}),"pie"===t.type&&(0,r.jsx)(eM,{labels:t.labels,data:t.data,colors:o}),"line"===t.type&&(0,r.jsx)(ej,{labels:t.labels,data:t.data,colors:o}),(0,r.jsx)(eu,{children:t.labels.map((e,t)=>(0,r.jsxs)(ew,{children:[(0,r.jsx)(eb,{color:o[t%o.length]}),e]},t))})]})}s().div`
  background: ${l.w4.colors.codeBg};
  border: 1px solid ${l.w4.colors.codeBorder};
  border-radius: ${l.w4.borderRadius.md};
  padding: ${l.w4.spacing.lg};
...
`,s().span`
  font-size: ${l.w4.typography.fontSizeBase};
  color: ${l.w4.colors.mainTextMuted};
`;var eF=o(17223),eC=o(21426);let eA=s().div`
  margin: ${l.w4.spacing.lg} 0;
  border-radius: ${l.w4.borderRadius.md};
  border: 1px solid ${l.w4.colors.codeBorder};
  overflow: hidden;
...
`;function eE({type:e,children:t}){let o=eP[e]??eP.NOTE;return(0,r.jsxs)(eI,{bg:o.bg,border:o.border,children:[(0,r.jsxs)(eW,{color:o.color,children:[(0,r.jsx)(M,{name:o.icon,size:15,strokeWidth:2}),o.label]}),(0,r.jsx)(eN,{children:t})]})}function eO(){let e=/^\[!(NOTE|TIP|WARNING|CAUTION|IMPORTANT)\]\s*/i;return t=>{function o(t,o,r){let a=o.children?.[0];a?.type==="text"&&(a.value=a.value.replace(e,""),a.value.trim()||1!==o.children.length||o.children.shift()),t.data=t.data??{},t.data.hName="div",t.data.hProperties={"data-callout":r.toUpperCase()}}!function t(r){if("blockquote"===r.type){let t=r.children?.[0];if(t?.type==="paragraph"){let a=t.children?.[0],i=a?.type==="text"&&a.value?.match(e);i&&o(r,t,i[1])}}if("paragraph"===r.type){let t=r.children?.[0],a=t?.type==="text"&&t.value?.match(e);if(a){let t=[...r.children];r.children=[{type:"paragraph",children:t}],o(r,r.children[0],a[1]);let i=t[0];i?.type==="text"&&(i.value=i.value.replace(e,""),i.value.trim()||1!==t.length||t.shift());return}}r.children?.forEach(t)}(t)}}s().nav`
  width: 220px;
  min-width: 220px;
...
`;function eV({children:e}){return(0,r.jsx)(eY,{children:(0,r.jsx)(X.oz,{remarkPlugins:[Z.A,ee.A,eO],rehypePlugins:[et.A,eo.A],components:{div({node:e,children:t,...o}){let a=o["data-callout"];return a?(0,r.jsx)(eE,{type:a,children:t}):(0,r.jsx)("div",{...o,children:t})},pre:({children:e})=>(0,r.jsx)(r.Fragment,{children:e}),code({className:e,children:t}){let o=/language-(\w+)/.exec(e??"")?.[1],a=String(t).replace(/\n$/,"");return a.trim()?"mermaid"===o?(0,r.jsx)(eg,{code:a}):"chart"===o?(0,r.jsx)(ez,{code:a}):o||a.includes("\n")?(0,r.jsx)(eB,{lang:o,code:a}):(0,r.jsx)("code",{className:e,children:t}):null}},children:e})})}var eG=o(37993);s().nav`
  display: flex;
  flex-direction: column;
  gap: 1px;
  padding: ${l.w4.spacing.sm} 0;
...
`,s().div`
  ...
  flex-direction: column;
  gap: 14px;
  animation: ${eQ} 0.18s cubic-bezier(0.22, 1, 0.36, 1) both;
`,s().div`
  font-size: ${l.w4.typography.fontSizeMd};
  font-weight: 700;
...
`,s().div`
  position: absolute;
  inset: 0;
  animation: ${eX} 1.4s cubic-bezier(0.4, 0, 0.2, 1) infinite;
...
`,s().div`
  position: relative;
`;let e0="260px",e1="56px",e2="48px",e4=s().header`
  display: flex;
  align-items: center;
  height: calc(${e2} + env(safe-area-inset-top, 0px));
  ...
  @media (max-width: ${l.w4.breakpoints.md}) {
    flex-wrap: wrap;
    height: auto;
    min-height: calc(${e2} + env(safe-area-inset-top, 0px));
  }
`,e5=s().div`
  width: ${e1};
  min-width: ${e1};
...
`,e7=s().span`
  ...
  animation: ${e6} 10s ease ${({index:e})=>.07*e}s infinite;
...
`,to=s().div`
  ...
  overflow: hidden;
`,tr=s().aside`
  width: ${({collapsed:e})=>e?e1:e0};
  min-width: ${({collapsed:e})=>e?e1:e0};
  background: ${l.w4.colors.sidebarBg};
  border-right: 1px solid ${l.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,ti=s().main`
  ...
  display: flex;
  flex-direction: column;
`,tn=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function ts(){return(0,r.jsx)(e8,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:tn.map((e,t)=>(0,r.jsx)(e7,{index:t,accent:e.accent,children:e.char},t))})}let tl="atlantis:sidebar-collapsed";function td({sidebar:e,children:t,topBarRight:n,title:s="Atlantis",activeId:l=null}){let[d,c]=(0,a.useState)(()=>{try{return"true"===localStorage.getItem(tl)}catch{return!1}}),[p,h]=(0,a.useState)(null),g=(0,a.useRef)(),f=()=>c(e=>{let t=!e;try{localStorage.setItem(tl,String(t))}catch{}return t}),m=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(o.bind(o,45816)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(eG.I.Provider,{value:{collapsed:d,toggle:f,flyout:p,openFlyout:(e,t,o)=>{clearTimeout(g.current),h({entry:e,anchorY:t,onSelect:o})},scheduleFlyoutClose:()=>{g.current=setTimeout(()=>h(null),160)},cancelFlyoutClose:()=>clearTimeout(g.current)},children:(0,r.jsxs)(to,{children:[(0,r.jsxs)(e4,{children:[e&&(0,r.jsx)(e5,{children:(0,r.jsx)(e3,{onClick:f,title:d?"Expand sidebar":"Collapse sidebar",children:(0,r.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,r.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,r.jsx)("path",{d:"M9 3v18"})]})})}),(0,r.jsx)(ts,{}),s&&(0,r.jsx)(e9,{children:s}),n&&(0,r.jsx)(te,{children:n})]}),(0,r.jsxs)(tt,{children:[null!=e&&(0,r.jsx)(tr,{collapsed:d,children:(0,r.jsx)(ta,{children:e})}),(0,r.jsx)(ti,{children:t})]}),p&&(0,r.jsx)(i().Suspense,{fallback:null,children:(0,r.jsx)(m,{activeId:l})})]})})}s().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
...
`,s().div`
  flex: 1;
`},9391(e,t,o){o.d(t,{O:()=>n});var r=o(65723);o(37991);var a=o(44e3);let i={sm:20,md:24,lg:28};function n({member:e,size:t="md"}){let o="number"==typeof t?t:i[t];return(0,r.jsx)(a.eu,{member:e,size:o})}},85043(e,t,o){o.d(t,{Y:()=>p});var r=o(65723),a=o(36859),i=o.n(a),n=o(6063);let s=i().div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
`,d=i().p`
  ...
  margin: 0;
  line-height: 1.5;
`,c={loading:"◌ Loading",empty:"◎ Empty",error:"◎ Offline"};function p({mode:e,label:t,body:o}){return(0,r.jsxs)(s,{children:[(0,r.jsx)(l,{mode:e,children:t??c[e]}),o&&(0,r.jsx)(d,{children:o})]})}},96246(e,t,o){o.d(t,{OW:()=>s,ik:()=>p,kl:()=>u,RT:()=>m,YG:()=>r.Y});var r=o(85043),a=o(65723),i=o(37991),n=o(6063);function s({points:e,accent:t=n.w4.colors.accent,width:o=60,height:r=28,strokeWidth:l=1.5,fluid:d=!1}){let c=(0,i.useMemo)(()=>{if(e.length<2)return"";let t=Math.min(...e),a=Math.max(...e)-t||1,i=o-2*l,n=r-2*l;return e.map((o,r)=>{let s=l+r/(e.length-1)*i,d=l+n-(o-t)/a*n;return`${0===r?"M":"L"} ${s.toFixed(1)} ${d.toFixed(1)}`}).join(" ")},[e,o,r,l]),p=(0,i.useMemo)(()=>{if(e.length<1)return null;let t=e[e.length-1],a=Math.min(...e),i=o-2*l,n=r-2*l;return{x:l+i,y:l+n-(t-a)/(Math.max(...e)-a||1)*n}},[e,o,r,l]);return c?(0,a.jsxs)("svg",{width:d?"100%":o,height:d?"auto":r,viewBox:`0 0 ${o} ${r}`,preserveAspectRatio:"xMidYMid meet","aria-hidden":"true",style:{display:"block",flexShrink:+!!d},children:[(0,a.jsx)("path",{d:c,fill:"none",stroke:t,strokeWidth:l,strokeLinecap:"round",strokeLinejoin:"round",opacity:.7}),p&&(0,a.jsx)("circle",{cx:p.x,cy:p.y,r:l+1,fill:t})]}):null}var l=o(36859),d=o.n(l);d().span`
  font-family: ${n.w4.typography.fontFamilyMono};
  font-size: 11px;
  font-weight: 500;
  font-variant-numeric: tabular-nums;
...
`,d().span`
  ...
  flex-shrink: 0;
  text-align: right;
`,o(83090);let c="'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, monospace";function p({data:e,budget:t,height:o=200,animation:r="rise"}){let s=(0,i.useId)();if(!e.length)return null;let l=1.1*Math.max(...e.map(e=>e.segments.reduce((e,t)=>e+t.value,0)+(e.over??0)),t??0)||1,d=472,h=o-20-24,g=472/e.length*.58,f=d/e.length,m="rise"===r?{transformOrigin:"bottom",animation:`${s}_rise 0.45s ease-out both`}:{};return(0,a.jsxs)(a.Fragment,{children:["rise"===r&&(0,a.jsx)("style",{children:`
          @keyframes ${s}_rise {
            from { transform: scaleY(0); }
            to   { transform: scaleY(1); }
          }
        `}),(0,a.jsxs)("svg",{viewBox:`0 0 520 ${o}`,style:{width:"100%",height:o},preserveAspectRatio:"xMidYMid meet","aria-hidden":"true",children:[null!=t?(0,a.jsxs)("g",{children:[(0,a.jsx)("line",{x1:40,x2:40+d,y1:20+h-t/l*h,y2:20+h-t/l*h,stroke:n.w4.colors.border,strokeDasharray:"3 3",strokeWidth:"1"}),(0,a.jsxs)("text",{x:36,y:20+h-t/l*h+3,textAnchor:"end",fontFamily:c,fontSize:"9",fill:n.w4.colors.mainTextMuted,children:["€",t]})]}):null,e.map((e,t)=>{let r,i=40+t*f+(f-g)/2,s=20+h;return(0,a.jsxs)("g",{style:m,children:[e.segments.map(e=>{let t=e.value/l*h;return s-=t,(0,a.jsx)("rect",{x:i,y:s,width:g,height:t,fill:e.color,opacity:.85},e.id)}),null!=e.over&&e.over>0?(r=e.over/l*h,s-=r,(0,a.jsx)("rect",{x:i,y:s,width:g,height:r,fill:"#f85149",opacity:.7},"over")):null,(0,a.jsx)("text",{x:i+g/2,y:o-6,textAnchor:"middle",fontFamily:c,fontSize:"10",fill:n.w4.colors.mainTextMuted,children:e.label})]},e.label)})]})]})}let h=["#1a2420","#2a4535","#4a7a5a","#6fa77a","#7fb77e"],g=["S","T","Q","Q","S","S","D"],f=["S","M","T","W","T","F","S"];function m({data:e,cellSize:t=10,gap:o=2,locale:r="pt",tooltip:s}){let l=(0,i.useId)();if(!e.length)return null;let d=24+Math.ceil(e.length/7)*(t+o),c=14+7*(t+o);return(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)("style",{children:`
        @keyframes ${l}_fade { from { opacity: 0; } to { opacity: 1; } }
      `}),(0,a.jsxs)("svg",{viewBox:`0 0 ${d} ${c}`,preserveAspectRatio:"xMidYMid meet",style:{width:"100%",height:"auto",maxHeight:220,display:"block"},"aria-hidden":"true",children:[(0,a.jsx)("g",{fontFamily:"'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, monospace",fontSize:"8",fill:n.w4.colors.mainTextMuted,children:("pt"===r?g:f).map((e,r)=>(0,a.jsx)("text",{x:"0",y:10+r*(t+o),children:e},r))}),e.map((e,r)=>{let i=18+Math.floor(r/7)*(t+o),n=2+r%7*(t+o),d=h[Math.max(0,Math.min(4,e))]??h[0],c=s?.(r,e);return(0,a.jsx)("rect",{x:i,y:n,width:t,height:t,fill:d,rx:"1",style:{animation:`${l}_fade 0.3s ease-out ${8*r}ms both`},children:c?(0,a.jsx)("title",{children:c}):null},r)})]})]})}function x(e){let t=0;for(let o=1;o<e.length;o++){let r=e[o][0]-e[o-1][0],a=e[o][1]-e[o-1][1];t+=Math.sqrt(r*r+a*a)}return t}function u({spent:e,budget:t,height:o=60}){let r=(0,i.useId)(),s=1.05*t||1,l=Array.from({length:8},(e,o)=>t-t/7*o),d=Math.min(e/(t||1),1),c=Array.from({length:8},(e,o)=>Math.max(0,t-o/7*t*d*1.1)),p=l.map((e,t)=>[320*t/7,o-e/s*(o-5)]),h=c.map((e,t)=>[320*t/7,o-e/s*(o-5)]),g=p.map(e=>e.join(",")).join(" "),f=h.map(e=>e.join(",")).join(" "),m=x(p).toFixed(1),w=x(h).toFixed(1);return(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)("style",{children:`
        @keyframes ${r}_i { from { stroke-dashoffset: ${m}; } }
        @keyframes ${r}_a { from { stroke-dashoffset: ${w}; } }
      `}),(0,a.jsxs)("svg",{viewBox:`0 0 320 ${o}`,style:{width:"100%",height:o},preserveAspectRatio:"none","aria-hidden":"true",children:[(0,a.jsx)("line",{x1:"0",x2:320,y1:o-5,y2:o-5,stroke:n.w4.colors.border,strokeDasharray:"3 3",strokeWidth:"1"}),(0,a.jsx)("polyline",{points:g,stroke:n.w4.colors.mainTextMuted,strokeWidth:"1",strokeDasharray:`${m} ${m}`,strokeDashoffset:"0",fill:"none",style:{strokeDasharray:"2 3",animation:`${r}_i 0.45s ease-out both`}}),(0,a.jsx)("polyline",{points:f,stroke:"#7fb77e",strokeWidth:"1.5",strokeDasharray:`${w} ${w}`,strokeDashoffset:"0",fill:"none",strokeLinecap:"round",style:{animation:`${r}_a 0.45s ease-out 0.08s both`}})]})]})}d().div`
  position: relative;
  height: 6px;
  background: ${n.w4.colors.border};
  border-radius: 3px;
