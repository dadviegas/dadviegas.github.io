"use strict";(self.webpackChunk_atlantis_csvexplorer=self.webpackChunk_atlantis_csvexplorer||[]).push([["655"],{457(o,e,a){function t(o){let e=o.split("\n")[0]??"",a={",":0,"	":0,";":0};for(let o of e)o in a&&a[o]++;let t=Object.entries(a).sort((o,e)=>e[1]-o[1])[0];return t[1]>0?t[0]:","}function r(o,e){let a=e??t(o),r=o.trim().split(/\r?\n/).filter(o=>""!==o.trim());if(0===r.length)return{headers:[],rows:[],stats:[]};let i=o=>{let e=[],t="",r=!1;for(let i=0;i<o.length;i++){let n=o[i];'"'===n?r&&'"'===o[i+1]?(t+='"',i++):r=!r:n!==a||r?t+=n:(e.push(t.trim()),t="")}return e.push(t.trim()),e},n=i(r[0]),l=r.slice(1).map(i),d=n.map((o,e)=>{let a,t,r=l.map(o=>o[e]??""),i=r.filter(o=>""!==o&&null!==o),n=function(o){if(0===o.length)return"text";let e=o.slice(0,20);return e.filter(o=>""!==o&&!isNaN(Number(o))).length/e.length>.8?"number":e.filter(o=>!isNaN(Date.parse(o))&&o.length>4).length/e.length>.7?"date":"text"}(i),d=new Set(r).size;if("number"===n){let o=i.map(Number).filter(o=>!isNaN(o));o.length&&(a=Math.min(...o),t=Math.max(...o))}return{name:o,type:n,count:r.length,nullCount:r.length-i.length,uniqueCount:d,min:a,max:t}});return{headers:n,rows:l,stats:d}}a.d(e,{CO:()=>r,Dt:()=>t})},5151(o,e,a){a.d(e,{k:()=>t});let t=[{label:"People",csv:`name,age,city,salary,active
...
`,l().div`
  position: relative;
`;let oa="260px",ot="56px",or="48px",oi=l().header`
  display: flex;
  align-items: center;
...
`,om=l().div`
  ...
  overflow: hidden;
`,of=l().aside`
  width: ${({collapsed:o})=>o?ot:oa};
  min-width: ${({collapsed:o})=>o?ot:oa};
  background: ${d.w4.colors.sidebarBg};
  border-right: 1px solid ${d.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,ou=l().main`
  ...
  display: flex;
  flex-direction: column;
`,ob=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function oy(){return(0,t.jsx)(os,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:ob.map((o,e)=>(0,t.jsx)(oc,{index:e,accent:o.accent,children:o.char},e))})}let ow="atlantis:sidebar-collapsed";function o$({sidebar:o,children:e,topBarRight:n,title:l="Atlantis",activeId:d=null}){let[s,c]=(0,r.useState)(()=>{try{return"true"===localStorage.getItem(ow)}catch{return!1}}),[p,g]=(0,r.useState)(null),h=(0,r.useRef)(),m=()=>c(o=>{let e=!o;try{localStorage.setItem(ow,String(e))}catch{}return e}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(a.bind(a,5816)).then(o=>({default:o.FlyoutPanel}))),[]);return(0,t.jsx)(N.I.Provider,{value:{collapsed:s,toggle:m,flyout:p,openFlyout:(o,e,a)=>{clearTimeout(h.current),g({entry:o,anchorY:e,onSelect:a})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,t.jsxs)(om,{children:[(0,t.jsxs)(oi,{children:[o&&(0,t.jsx)(on,{children:(0,t.jsx)(ol,{onClick:m,title:s?"Expand sidebar":"Collapse sidebar",children:(0,t.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("path",{d:"M9 3v18"})]})})}),(0,t.jsx)(oy,{}),l&&(0,t.jsx)(op,{children:l}),n&&(0,t.jsx)(og,{children:n})]}),(0,t.jsxs)(oh,{children:[null!=o&&(0,t.jsx)(of,{collapsed:s,children:(0,t.jsx)(ox,{children:o})}),(0,t.jsx)(ou,{children:e})]}),p&&(0,t.jsx)(i().Suspense,{fallback:null,children:(0,t.jsx)(f,{activeId:d})})]})})}l().div`
  display: grid;
  grid-template-rows: ${({open:o})=>o?"1fr":"0fr"};
