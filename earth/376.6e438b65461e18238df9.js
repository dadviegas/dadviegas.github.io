"use strict";(self.webpackChunk_atlantis_earth=self.webpackChunk_atlantis_earth||[]).push([[376],{4914(e,a,n){n.d(a,{FlyoutPanel:()=>y});var o=n(7359),t=n(3233),i=n(7207),r=n(255),l=n(217),s=n(5959),c=n(5185),d=n(8104);const m=i.keyframes`
...
`;function p({iconKey:e}){const a=e?c.t[e]??r.A:r.A;return(0,d.jsx)(a,{size:14,strokeWidth:1.75})}function h({entries:e,activeId:a,onSelect:n}){return(0,d.jsx)(d.Fragment,{children:e.map(e=>e.children?(0,d.jsx)(o.Fragment,{children:(0,d.jsx)(h,{entries:e.children,activeId:a,onSelect:n})},e.id):(0,d.jsxs)(g,{active:a===e.id,onClick:()=>n(e),children:[(0,d.jsx)(p,{iconKey:e.icon}),e.name]},e.id))})}function y({activeId:e}){const{flyout:a,scheduleFlyoutClose:n,cancelFlyoutClose:o}=(0,s.c)();if(!a)return null;const t=a.entry.icon?c.t[a.entry.icon]??r.A:r.A;return(0,d.jsxs)(u,{anchorY:a.anchorY,onMouseEnter:o,onMouseLeave:n,children:[(0,d.jsxs)(f,{children:[(0,d.jsx)(t,{size:13,strokeWidth:2}),a.entry.name]}),(0,d.jsx)(h,{entries:a.entry.children??[],activeId:e,onSelect:e=>{a.onSelect(e),n()}})]})}},5959(e,a,n){n.d(a,{I:()=>t,c:()=>i});var o=n(7359);const t=(0,o.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),i=()=>(0,o.useContext)(t)},5185(e,a,n){n.d(a,{t:()=>oe});var o=n(9510),t=n(9038),i=n(7400),r=n(8207),l=n(7902),s=n(6896),c=n(7901),d=n(9848),m=n(2164),u=n(3045),f=n(3775),g=n(3539),p=n(1783),h=n(1837),y=n(4494),x=n(2314),b=n(5751),w=n(255),z=n(9633),v=n(2946),$=n(822),A=n(6720),k=n(3317),M=n(2709),j=n(9301),S=n(3517),T=n(7032),C=n(6949),B=n(8218),E=n(6829),L=n(5553),F=n(9591),P=n(2820),R=n(4621),I=n(2534),D=n(6673),_=n(9033),N=n(1365),G=n(2937),K=n(5912),H=n(158),O=n(8641),V=n(8607),U=n(3249),W=n(1821),Y=n(5889),Z=n(7170),J=n(9161),q=n(1849),Q=n(1187),X=n(7747),ee=n(2932),ae=n(4525),ne=n(7230);const oe={activity:s.A,"a-large-small":l.A,"bar-chart-2":o.A,book:d.A,"book-open":c.A,briefcase:u.A,calendar:f.A,clock:p.A,"circle-dot":g.A,compass:h.A,droplets:y.A,feather:x.A,file:w.A,"file-text":b.A,folder:z.A,"git-branch":v.A,github:$.A,globe:A.A,grid:i.A,hash:k.A,heart:M.A,hexagon:j.A,landmark:S.A,layers:r.A,"layout-grid":T.A,leaf:C.A,lightbulb:B.A,list:E.A,map:F.A,"map-pin":L.A,"message-square":P.A,minus:R.A,mountain:I.A,package:D.A,"pen-tool":_.A,"pie-chart":t.A,plus:N.A,ruler:G.A,slash:K.A,square:H.A,star:O.A,sun:V.A,terminal:U.A,thermometer:W.A,triangle:Y.A,truck:Z.A,type:J.A,users:q.A,waves:Q.A,wind:X.A,wrench:ee.A,x:ae.A,zap:ne.A,bot:m.A}},5723(e,a,n){n.d(a,{rh:()=>Z,UO:()=>Ce,PE:()=>S,CD:()=>H,MJ:()=>pe,qs:()=>ee,$L:()=>q,w3:()=>J,u6:()=>Q,KL:()=>ie,w4:()=>o.w4,mZ:()=>re,rz:()=>Be});var o=n(217),t=n(7359),i=n(3233),r=n(8104);i.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,ge=i.default.div`
  ...
  color: ${o.w4.colors.sidebarTextMuted};
  font-family: ${o.w4.typography.fontFamily};
`;function pe({onSave:e,onUpdate:a,onCancel:n,existingDoc:o}){const[i,l]=(0,t.useState)(o?.name??""),s=(0,t.useRef)(null);return(0,t.useEffect)(()=>{s.current?.focus(),o&&s.current?.select()},[o]),(0,r.jsx)(le,{onClick:n,children:(0,r.jsxs)(se,{onClick:e=>e.stopPropagation(),children:[(0,r.jsx)(ce,{children:"Save document"}),o&&a&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(ge,{children:"Update the current version or save as a new one."}),(0,r.jsxs)(me,{children:[(0,r.jsx)(ue,{onClick:n,children:"Cancel"}),(0,r.jsxs)(ue,{danger:!0,onClick:a,children:['Update "',o.name,'"']})]}),(0,r.jsx)(fe,{})]}),(0,r.jsx)(de,{ref:s,value:i,onChange:e=>l(e.target.value),onKeyDown:t=>{"Enter"===t.key&&i.trim()&&(o&&i.trim()===o.name&&a?a():e(i.trim())),"Escape"===t.key&&n()},placeholder:o?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,r.jsxs)(me,{children:[!o&&(0,r.jsx)(ue,{onClick:n,children:"Cancel"}),(0,r.jsx)(ue,{primary:!0,disabled:!i.trim(),onClick:()=>e(i.trim()),children:"Save as new"})]})]})})}var he=n(8006),ye=n(679),xe=n(4872);const be=i.default.div`
  position: relative;
`,we=i.default.button`
  display: flex;
  align-items: center;
...
//# sourceMappingURL=376.6e438b65461e18238df9.js.map