...
`;function z({iconKey:a}){const o=a?c.t[a]??l.A:l.A;return(0,g.jsx)(o,{size:14,strokeWidth:1.75})}function p({entries:a,activeId:o,onSelect:n}){return(0,g.jsx)(g.Fragment,{children:a.map(a=>a.children?(0,g.jsx)(e.Fragment,{children:(0,g.jsx)(p,{entries:a.children,activeId:o,onSelect:n})},a.id):(0,g.jsxs)(f,{active:o===a.id,onClick:()=>n(a),children:[(0,g.jsx)(z,{iconKey:a.icon}),a.name]},a.id))})}function y({activeId:a}){const{flyout:o,scheduleFlyoutClose:n,cancelFlyoutClose:e}=(0,m.c)();if(!o)return null;const i=o.entry.icon?c.t[o.entry.icon]??l.A:l.A;return(0,g.jsxs)(s,{anchorY:o.anchorY,onMouseEnter:e,onMouseLeave:n,children:[(0,g.jsxs)(u,{children:[(0,g.jsx)(i,{size:13,strokeWidth:2}),o.entry.name]}),(0,g.jsx)(p,{entries:o.entry.children??[],activeId:a,onSelect:a=>{o.onSelect(a),n()}})]})}},5959(a,o,n){n.d(o,{c:()=>t});var e=n(7359);const i=(0,e.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),t=()=>(0,e.useContext)(i)},5185(a,o,n){n.d(o,{t:()=>R});var e=n(9038),i=n(6896),t=n(7901),l=n(9848),r=n(2164),m=n(3539),c=n(1783),g=n(1837),d=n(2314),s=n(5751),u=n(255),f=n(9633),z=n(2946),p=n(822),y=n(3317),b=n(2709),h=n(3517),A=n(7032),x=n(6949),w=n(8218),k=n(6829),v=n(5553),M=n(9591),S=n(2820),$=n(4621),B=n(6673),E=n(9033),P=n(1365),T=n(5912),j=n(8641),C=n(3249),L=n(9161),K=n(2932),N=n(4525),D=n(7230);const R={activity:i.A,book:l.A,clock:c.A,"book-open":t.A,"circle-dot":m.A,feather:d.A,"file-text":s.A,hash:y.A,heart:b.A,landmark:h.A,leaf:x.A,map:M.A,package:B.A,compass:g.A,"git-branch":z.A,github:p.A,minus:$.A,terminal:C.A,"pie-chart":e.A,plus:P.A,slash:T.A,star:j.A,zap:D.A,bot:r.A,lightbulb:w.A,"message-square":S.A,wrench:K.A,x:N.A,"layout-grid":A.A,list:k.A,file:u.A,folder:f.A,"map-pin":v.A,"pen-tool":E.A,type:L.A}},906(a,o,n){n.d(o,{w4:()=>e.w});var e=n(217),i=(n(7359),n(3233));n(5723),i.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
//# sourceMappingURL=440.612cef8811d08e3a2fbf.js.map