...
`;function eP({children:e,...t}){return(0,i.jsx)(eL,{...t,children:e})}let eI=s().div`
  ...
  align-items: center;
  gap: 8px;
`;function eD({children:e,...t}){return(0,i.jsx)(eI,{...t,children:e})}let eR=s().label`
  display: flex;
  align-items: center;
  gap: 10px;
...
`,eE=s().span`
  ...
  color: ${l.w4.colors.mainTextMuted};
  flex-shrink: 0;
`,eO=r().forwardRef(function({before:e,after:t,...a},o){return(0,i.jsxs)(eR,{children:[e&&(0,i.jsx)(eE,{children:e}),(0,i.jsx)(eH,{ref:o,...a}),t&&(0,i.jsx)(eE,{children:t})]})}),eq=s().div`
  position: relative;
  display: flex;
  flex-direction: column;
  height: 100%;
