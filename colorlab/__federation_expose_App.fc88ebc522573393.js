"use strict";(self.webpackChunk_atlantis_colorlab=self.webpackChunk_atlantis_colorlab||[]).push([["6362"],{3935(r,e,s){s.r(e),s.d(e,{default:()=>S});var o=s(5723),i=s(7991),l=s(6859),t=s.n(l),n=s(3930),a=s(1638),d=s(5609),c=s(320),x=s(5628);let h=`
...
`,f=t().div`padding: ${n.w4.spacing.md}; display: flex; flex-direction: column; gap: ${n.w4.spacing.sm};`,w=t().div`font-size: 11px; font-weight: 700; letter-spacing: 0.06em; text-transform: uppercase; color: ${n.w4.colors.mainTextMuted};`,j=t().div`display: flex; align-items: center; gap: ${n.w4.spacing.sm};`,m=t().input`
  ...
  outline: none; transition: border-color ${n.w4.transitions.base};
...
`,y=t().button`
  ...
  cursor: pointer; flex-shrink: 0; transition: all ${n.w4.transitions.base};
...
`,C=t().div`font-size: 11px; font-weight: 700; letter-spacing: 0.07em; text-transform: uppercase; color: ${n.w4.colors.mainTextMuted}; margin-bottom: ${n.w4.spacing.sm};`,z=t().div`display: flex; gap: 6px; flex-wrap: wrap;`,A=t().button`
  ...
  cursor: pointer; transition: transform ${n.w4.transitions.fast}, border-color ${n.w4.transitions.base}; flex-shrink: 0;
