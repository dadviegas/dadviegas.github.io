"use strict";(self.webpackChunk_atlantis_music=self.webpackChunk_atlantis_music||[]).push([["544"],{948(e,a,o){o.d(a,{A:()=>t});let t={"nav.search":{en:"Search",pt:"Pesquisar"},"nav.history":{en:"History",pt:"Hist\xf3rico"},"nav.playlists":{en:"Playlists",pt:"Playlists"},"search.heading":{en:"Search Apple Music",pt:"Pesquisar no Apple Music"},"search.placeholder":{en:"Song, artist or album…",pt:"M\xfasica, artista ou \xe1lbum…"},"search.button":{en:"Search",pt:"Pesquisar"},"search.open":{en:"Open in Apple Music",pt:"Abrir no Apple Music"},"search.empty":{en:"Type something to search.",pt:"Escreve algo para pesquisar."},"history.heading":{en:"History",pt:"Hist\xf3rico"},"history.searches":{en:"Recent Searches",pt:"Pesquisas Recentes"},"history.tracks":{en:"Recent Tracks",pt:"M\xfasicas Recentes"},"history.empty":{en:"No history yet.",pt:"Sem hist\xf3rico ainda."},"history.clear":{en:"Clear all",pt:"Limpar tudo"},"history.remove":{en:"Remove",pt:"Remover"},"history.openMusic":{en:"Open in Apple Music",pt:"Abrir no Apple Music"},"playlists.heading":{en:"Playlists",pt:"Playlists"},"playlists.new":{en:"New Playlist",pt:"Nova Playlist"},"playlists.empty":{en:"No playlists yet. Create one to get started.",pt:"Sem playlists ainda. Cria uma para come\xe7ar."},"playlists.delete":{en:"Delete",pt:"Eliminar"},"playlists.edit":{en:"Edit name",pt:"Editar nome"},"playlists.namePlaceholder":{en:"Playlist name…",pt:"Nome da playlist…"},"playlists.save":{en:"Save",pt:"Guardar"},"playlists.cancel":{en:"Cancel",pt:"Cancelar"},"playlists.create":{en:"Create",pt:"Criar"},"playlists.addTrack":{en:"Add track…",pt:"Adicionar m\xfasica…"},"playlists.trackPlaceholder":{en:"Song — Artist",pt:"M\xfasica — Artista"},"playlists.add":{en:"Add",pt:"Adicionar"},"playlists.removeTrack":{en:"Remove track",pt:"Remover m\xfasica"},"playlists.openTrack":{en:"Open in Apple Music",pt:"Abrir no Apple Music"},"playlists.tracksCount":{en:"{n} track|tracks",pt:"{n} m\xfasica|m\xfasicas"},"playlists.emptyTracks":{en:"No tracks yet.",pt:"Sem m\xfasicas ainda."},"playlists.confirmDelete":{en:"Delete this playlist?",pt:"Eliminar esta playlist?"}}},8170(e,a,o){o.d(a,{Ym:()=>c,Nx:()=>p});var t=o(7991),r=o(6063);let i={"time.justNow":{en:"just now",pt:"agora mesmo"},"time.mAgo":{en:"{n}m ago",pt:"h\xe1 {n}m"},"time.hAgo":{en:"{n}h ago",pt:"h\xe1 {n}h"},"time.dAgo":{en:"{n}d ago",pt:"h\xe1 {n}d"},updated:{en:"updated {age}",pt:"atualizado {age}"},refresh:{en:"Refresh",pt:"Atualizar"},loading:{en:"Loading…",pt:"A carregar…"},noData:{en:"No data available",pt:"Sem dados dispon\xedveis"},noDescription:{en:"No description provided.",pt:"Sem descri\xe7\xe3o."},failedToFetch:{en:"Failed to fetch",pt:"Erro ao carregar"},perWeek:{en:"/ wk",pt:"/ sem"},"devtools.heading":{en:"Dev Tools",pt:"Ferramentas"},"devtools.playground":{en:"Playground",pt:"Playground"},"devtools.pad":{en:"Pad",pt:"Pad"},"devtools.charts":{en:"Charts",pt:"Gr\xe1ficos"},"devtools.csv":{en:"CSV",pt:"CSV"},"devtools.regex":{en:"Regex",pt:"Regex"},"devtools.json":{en:"JSON",pt:"JSON"},"devtools.diff":{en:"Diff",pt:"Diferen\xe7as"},"devtools.jwt":{en:"JWT",pt:"JWT"},"devtools.cron":{en:"Cron",pt:"Cron"},"devtools.colors":{en:"Colors",pt:"Cores"},"devtools.api":{en:"API",pt:"API"}},n="atlantis:locale",l="shell:locale";function d(e){return"en"===e||"pt"===e}function s(){try{let e=localStorage.getItem(n);if(d(e))return e}catch{}return"en"}function c(){let[e,a]=(0,t.useState)(s),o=(0,t.useCallback)(e=>{a(e);try{localStorage.setItem(n,e)}catch{}(0,r.Is)(l,e).catch(()=>{}),window.dispatchEvent(new CustomEvent("atlantis:locale-change",{detail:e}))},[]);return(0,t.useEffect)(()=>{let e=e=>{a(e.detail)};return window.addEventListener("atlantis:locale-change",e),()=>window.removeEventListener("atlantis:locale-change",e)},[]),(0,t.useEffect)(()=>{(0,r.PL)(l).then(o=>{if(d(o)&&o!==e){try{localStorage.setItem(n,o)}catch{}a(o)}}).catch(()=>{})},[]),[e,o]}function p(e,a){let o=a?{...i,...a}:i;return(a,t)=>{let r=function(e,a){if(!a||!e.includes("|"))return e;let o=null;for(let e of Object.values(a))if("number"==typeof e&&Number.isFinite(e)){o=e;break}if(null===o)return e;let t=e.indexOf("|"),r=e.slice(0,t),i=e.slice(t+1);return 1===o?r:i}(o[a]?.[e]??a,t);return t?Object.entries(t).reduce((e,[a,o])=>e.replace(RegExp(`\\{${a}\\}`,"g"),String(o)),r):r}}(0,r.PL)(l).then(e=>{if(d(e))try{localStorage.setItem(n,e)}catch{}}).catch(()=>{}),o(5723);var g=o(6859),h=o.n(g);h().div`
  display: flex;
  gap: 4px;
...
`},2787(e,a,o){o.d(a,{FlyoutPanel:()=>y});var t=o(5723),r=o(7991),i=o.n(r),n=o(6859),l=o.n(n),d=o(2799),s=o(6063),c=o(7993),p=o(4971);let g=(0,d.keyframes)`
...
`,b=i().forwardRef(function({variant:e="ghost",size:a="md",icon:o,iconRight:r,children:i,...n},l){return(0,t.jsxs)(u,{ref:l,variant:e,size:a,...n,children:[o,i,r]})}),y={default:d.w4.colors.accent,danger:"#f85149"},w={default:d.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"},$=l().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`,v=i().forwardRef(function({active:e=!1,shape:a="square",tone:o="default",children:r,...i},n){return(0,t.jsx)($,{ref:n,active:e,shape:a,tone:o,...i,children:r})});l().div`
  position: relative;
  display: inline-flex;
`,l().div`
  position: absolute;
...
`;let F=l().div`
  ...
  align-items: center;
  gap: 8px;
`;function B({children:e,...a}){return(0,t.jsx)(F,{...a,children:e})}let H=l().label`
  display: flex;
  align-items: center;
  gap: 10px;
...
`,C=l().span`
  ...
  color: ${d.w4.colors.mainTextMuted};
  flex-shrink: 0;
`,R=i().forwardRef(function({before:e,after:a,...o},r){return(0,t.jsxs)(H,{children:[e&&(0,t.jsx)(C,{children:e}),(0,t.jsx)(L,{ref:r,...o}),a&&(0,t.jsx)(C,{children:a})]})});l().div`
  position: relative;
  display: flex;
  flex-direction: column;
  height: 100%;
...
`,l().div`
  position: relative;
`;let ee="260px",ea="56px",eo="44px",et=l().header`
  display: flex;
  align-items: center;
...
`,eg=l().div`
  ...
  overflow: hidden;
`,eh=l().aside`
  width: ${({collapsed:e})=>e?ea:ee};
  min-width: ${({collapsed:e})=>e?ea:ee};
  background: ${d.w4.colors.sidebarBg};
  border-right: 1px solid ${d.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,ef=l().main`
  ...
  display: flex;
  flex-direction: column;
`;function ex(){return(0,t.jsxs)(en,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:[(0,t.jsx)(el,{"aria-hidden":"true",children:"A"}),(0,t.jsx)(ed,{children:"Atlantis"})]})}let eu="atlantis:sidebar-collapsed";function eb({sidebar:e,children:a,topBarRight:n,title:l="Atlantis",activeId:d=null}){let[s,c]=(0,r.useState)(()=>{try{return"true"===localStorage.getItem(eu)}catch{return!1}}),[p,g]=(0,r.useState)(null),h=(0,r.useRef)(),m=()=>c(e=>{let a=!e;try{localStorage.setItem(eu,String(a))}catch{}return a}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(o.bind(o,2787)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,t.jsx)(_.I.Provider,{value:{collapsed:s,toggle:m,flyout:p,openFlyout:(e,a,o)=>{clearTimeout(h.current),g({entry:e,anchorY:a,onSelect:o})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,t.jsxs)(eg,{children:[(0,t.jsxs)(et,{children:[e&&(0,t.jsx)(er,{children:(0,t.jsx)(ei,{onClick:m,title:s?"Expand sidebar":"Collapse sidebar",children:(0,t.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("path",{d:"M9 3v18"})]})})}),(0,t.jsx)(ex,{}),l&&(0,t.jsx)(es,{children:l}),n&&(0,t.jsx)(ec,{children:n})]}),(0,t.jsxs)(ep,{children:[null!=e&&(0,t.jsx)(eh,{collapsed:s,children:(0,t.jsx)(em,{children:e})}),(0,t.jsx)(ef,{children:a})]}),p&&(0,t.jsx)(i().Suspense,{fallback:null,children:(0,t.jsx)(f,{activeId:d})})]})})}var ey=o(4971);let ew=l().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
...
`;function ej({iconKey:e,size:a=16}){let o=e?ey.X[e]:void 0;return o?(0,t.jsx)("svg",{width:a,height:a,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,dangerouslySetInnerHTML:{__html:o}}):e?(0,t.jsx)("span",{style:{fontSize:a,lineHeight:1,display:"flex",alignItems:"center"},children:e}):(0,t.jsxs)("svg",{width:a,height:a,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,children:[(0,t.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,t.jsx)("polyline",{points:"14 2 14 8 20 8"})]})}function eF({entry:e,activeId:a,onSelect:o}){let[i,n]=(0,r.useState)(e.defaultOpen??!0),{collapsed:l,openFlyout:d,scheduleFlyoutClose:s,cancelFlyoutClose:c}=(0,_.c)();return e.children&&e.children.length>0?(0,t.jsxs)(ez,{children:[(0,t.jsxs)(eM,{collapsed:l,onClick:()=>{l||n(e=>!e)},onMouseEnter:l?a=>{d(e,a.currentTarget.getBoundingClientRect().top,o)}:void 0,onMouseLeave:l?s:void 0,children:[(0,t.jsxs)(ek,{collapsed:l,children:[(0,t.jsx)(ej,{iconKey:e.icon,size:16}),(0,t.jsx)(eA,{collapsed:l,children:e.name})]}),(0,t.jsx)(eT,{open:i,collapsed:l,children:(0,t.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round",children:(0,t.jsx)("path",{d:"M9 6l6 6-6 6"})})})]}),(0,t.jsx)(ew,{open:i&&!l,children:(0,t.jsx)(e$,{children:(0,t.jsx)(ev,{children:e.children.map(e=>(0,t.jsx)(eF,{entry:e,activeId:a,onSelect:o},e.id))})})})]}):(0,t.jsxs)(eS,{active:a===e.id,collapsed:l,onClick:()=>o(e),onMouseEnter:l?a=>{let t=a.currentTarget.getBoundingClientRect();d({id:e.id,name:e.name,icon:e.icon,file:e.file,children:[e]},t.top,o)}:void 0,onMouseLeave:l?s:void 0,children:[(0,t.jsx)(ej,{iconKey:e.icon,size:15}),(0,t.jsx)(eA,{collapsed:l,children:e.name})]})}function eB({entries:e,activeId:a,onSelect:o}){return(0,t.jsx)("div",{children:e.map(e=>(0,t.jsx)(eF,{entry:e,activeId:a,onSelect:o},e.id))})}o(2787),l().div`
