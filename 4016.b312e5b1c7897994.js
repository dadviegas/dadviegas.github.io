...
`;function x({locale:e,onChange:a}){return(0,g.jsxs)(f,{children:[(0,g.jsx)(b,{active:"pt"===e,onClick:()=>a("pt"),children:"PT"}),(0,g.jsx)(b,{active:"en"===e,onClick:()=>a("en"),children:"EN"})]})}},87330(e,a,t){t.d(a,{FlyoutPanel:()=>eE});var o=t(65723),i=t(37991),n=t.n(i),r=t(36859),s=t.n(r),l=t(72799),d=t(81316),c=t(40814),p=t(36896),m=t(87902),g=t(53013),u=t(32887),h=t(49510),f=t(39848),b=t(37901),x=t(3045),y=t(43775),w=t(41783),v=t(83539),k=t(39416),$=t(1837),z=t(57167),M=t(84494),j=t(82314),S=t(20255),A=t(35751),T=t(69633),C=t(92946),L=t(40822),F=t(36720),N=t(57400),E=t(58456),P=t(43317),I=t(52709),R=t(8006),D=t(89301),O=t(37561),B=t(83517),H=t(28207),_=t(37032),K=t(6949),U=t(8218),q=t(36829),G=t(59591),W=t(15553),Y=t(69923),V=t(72820),J=t(14621),Q=t(68479),Z=t(72534),X=t(66673),ee=t(67490),ea=t(49033),et=t(99038),eo=t(45775),ei=t(31365),en=t(62937),er=t(9821),es=t(65912),el=t(80158),ed=t(88641),ec=t(48607),ep=t(83249),em=t(1821),eg=t(15889),eu=t(89655),eh=t(27170),ef=t(19161),eb=t(71849),ex=t(41604),ey=t(13142),ew=t(61187),ev=t(77747),ek=t(2932),e$=t(24525),ez=t(57230),eM=t(22164);let ej={activity:p.A,"a-large-small":m.A,apple:g.A,"arrow-right":u.A,"bar-chart-2":h.A,book:f.A,"book-open":b.A,briefcase:x.A,calendar:y.A,clock:w.A,"circle-dot":v.A,cloud:k.A,compass:$.A,cpu:z.A,droplets:M.A,feather:j.A,file:S.A,"file-text":A.A,folder:T.A,"git-branch":C.A,github:L.A,globe:F.A,grid:N.A,hand:E.A,hash:P.A,heart:I.A,key:R.A,hexagon:D.A,home:O.A,landmark:B.A,layers:H.A,"layout-grid":_.A,leaf:K.A,lightbulb:U.A,list:q.A,map:G.A,"map-pin":W.A,"message-circle":Y.A,"message-square":V.A,minus:J.A,monitor:Q.A,mountain:Z.A,package:X.A,palette:ee.A,"pen-tool":ea.A,"pie-chart":et.A,plane:eo.A,plus:ei.A,ruler:en.A,shirt:er.A,slash:es.A,square:el.A,star:ed.A,sun:ec.A,terminal:ep.A,thermometer:em.A,triangle:eg.A,trophy:eu.A,truck:eh.A,type:ef.A,users:eb.A,"volume-2":ex.A,watch:ey.A,waves:ew.A,wind:ev.A,wrench:ek.A,x:e$.A,zap:ez.A,bot:eM.A},eS=(0,l.keyframes)`
...
`;function ew({locale:e,onLocaleChange:a,user:t,userMenuItems:i=[],userMenuControlLabels:n,suites:r,onPreferences:s,notifications:d,onOpenPalette:c,paletteLabel:p="Search",onSignIn:m,signInLabel:g="Sign in",before:u,after:h}){let f=function(){if("u"<typeof navigator)return"Ctrl";let e=navigator,a=e.userAgentData?.platform??navigator.platform??navigator.userAgent??"";return/Mac|iPod|iPhone|iPad/i.test(a)?"⌘":"Ctrl"}(),b="⌘"===f?`${f}K`:`${f}+K`;return(0,o.jsxs)(eu,{children:[u,r&&r.entries.length>0&&(0,o.jsx)(eg,{label:r.label,ariaLabel:r.ariaLabel,appsLabel:r.appsLabel,suites:r.entries}),c&&(0,o.jsxs)(ef,{onClick:c,"aria-label":p,title:`${p} (${b})`,children:[(0,o.jsx)(Q,{name:"search",size:14}),(0,o.jsx)("span",{className:"kbd header-kbd",children:b})]}),!t&&(0,o.jsx)(Y.Fd,{locale:e,onChange:a}),!t&&(0,o.jsx)("span",{className:"header-hide-md",children:(0,o.jsx)(l.UW,{})}),d&&(0,o.jsxs)(eb,{children:[(0,o.jsx)(eh,{onClick:d.onClick,"aria-label":d.label,title:d.label,children:(0,o.jsx)(Q,{name:"bell",size:16})}),d.count>0&&(0,o.jsx)(ex,{"aria-hidden":"true",children:d.count>9?"9+":d.count})]}),s&&(0,o.jsx)("span",{className:"header-hide-md",children:(0,o.jsx)(eh,{onClick:s,"aria-label":"User preferences",title:"Preferences",children:(0,o.jsx)(Q,{name:"user-cog",size:16})})}),t?(0,o.jsx)(W,{user:t,items:i,locale:e,onLocaleChange:a,controlLabels:n}):m?(0,o.jsxs)(ey,{onClick:m,"aria-label":g,children:[(0,o.jsx)(Q,{name:"log-in",size:14}),g]}):null,h]})}s().div`
  position: fixed;
  inset: 0;
  pointer-events: none;
  z-index: 900;
...
`,s().span`
  ...
  background: ${({color:e})=>e};
  display: inline-block;
`;let eD={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:l.w4.colors.accentMuted},eO={neutral:l.w4.colors.mainTextMuted,live:l.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:l.w4.colors.accent},eB=s().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${l.w4.typography.fontFamilyMono};
...
`,eH=s().span`
  ...
  background: currentColor;
  display: inline-block;
`;function e_({tone:e="neutral",dot:a,children:t,...i}){return(0,o.jsxs)(eB,{tone:e,...i,children:[(a??"live"===e)&&(0,o.jsx)(eH,{}),t]})}let eK=s().kbd`
  font-family: ${l.w4.typography.fontFamilyMono};
  font-size: 10px;
  padding: 2px 6px;
  border: 1px solid ${l.w4.colors.border};
...
`,ao=!1;function ai(e){if("u"<typeof window)return e;let a=e.match(/^var\((--[-\w]+)\)$/);return a&&getComputedStyle(document.documentElement).getPropertyValue(a[1]).trim()||e}function an({code:e}){let a=(0,i.useRef)(null),[n,r]=(0,i.useState)(null),[s,d]=(0,i.useState)(!1);return((0,i.useEffect)(()=>{let o=!1;if(r(null),d(!1),!e.trim())return void d(!0);let i=e.trim().split(/\r?\n/)[0]?.trim()??"";return/^(?:---[\s\S]*?---\s*)?(?:graph|flowchart|sequenceDiagram|classDiagram|stateDiagram(?:-v2)?|erDiagram|pie|gantt|journey|mindmap|gitGraph|sankey(?:-beta)?|quadrantChart|requirementDiagram|timeline|xychart-beta|block-beta|C4Context|C4Container|C4Component|C4Dynamic|C4Deployment)\b/.test(i)?(async function(){let i=(await t.e("6087").then(t.bind(t,29738))).default;if(ao||(i.initialize({startOnLoad:!1,theme:"dark",themeVariables:{background:ai(l.w4.colors.codeBg),primaryColor:ai(l.w4.colors.accent),primaryTextColor:ai(l.w4.colors.mainText),lineColor:ai(l.w4.colors.border)}}),ao=!0),a.current&&!o)try{let t=`mermaid-${(0,ae.z)()}`,{svg:n}=await i.render(t,e);if(o||!a.current)return;if(/aria-roledescription="error"/i.test(n))return void d(!0);a.current.innerHTML=n,requestAnimationFrame(()=>{if(o||!a.current)return;let e=a.current.querySelector("svg");if(!e)return void d(!0);let t=e.getBoundingClientRect();t.width<2&&t.height<2&&d(!0)})}catch(e){o||r(e instanceof Error?e.message:String(e))}}(),()=>{o=!0}):void d(!0)},[e]),n||s)?(0,o.jsx)(at,{children:e.trim()}):(0,o.jsx)(aa,{ref:a})}let ar=["#388bfd","#3fb950","#d29922","#a371f7","#f87171","#22d3ee","#fb923c","#34d399","#f472b6","#818cf8"],as=s().div`
  background: ${l.w4.colors.codeBg};
  border: 1px solid ${l.w4.colors.codeBorder};
  border-radius: ${l.w4.borderRadius.md};
  padding: ${l.w4.spacing.lg};
...
`,s().span`
  font-size: ${l.w4.typography.fontSizeBase};
  color: ${l.w4.colors.mainTextMuted};
`;var aw=t(17223),av=t(21426),ak=t(25609),a$=t(20320);let az=s().div`
  margin: ${l.w4.spacing.lg} 0;
  border-radius: ${l.w4.borderRadius.md};
  border: 1px solid ${l.w4.colors.codeBorder};
  overflow: hidden;
...
`,aA={...av.A,'pre[class*="language-"]':{...av.A['pre[class*="language-"]'],background:l.w4.colors.codeBg,margin:0,padding:"18px 20px",fontSize:"13px",lineHeight:"1.6",borderRadius:0},'code[class*="language-"]':{...av.A['code[class*="language-"]'],background:"none",fontSize:"13px"}};function aT({lang:e="text",code:a}){let[t,n]=(0,i.useState)(!1);return(0,o.jsxs)(az,{children:[(0,o.jsxs)(aM,{children:[(0,o.jsx)(aj,{children:e}),(0,o.jsxs)(aS,{copied:t,onClick:()=>{navigator.clipboard.writeText(a).then(()=>{n(!0),setTimeout(()=>n(!1),2e3)})},children:[t?(0,o.jsx)(ak.A,{size:12}):(0,o.jsx)(a$.A,{size:12}),t?"Copied!":"Copy"]})]}),(0,o.jsx)(aw.A,{language:e,style:aA,showLineNumbers:a.split("\n").length>8,lineNumberStyle:{color:"#484f58",minWidth:"2.5em",paddingRight:"1.5em",userSelect:"none",fontSize:"12px"},customStyle:{margin:0,background:l.w4.colors.codeBg},wrapLongLines:!1,children:a})]})}var aC=t(65569),aL=t(8218),aF=t(57230),aN=t(22966),aE=t(21069);let aP={NOTE:{bg:"rgba(88, 166, 255, 0.08)",border:"#58a6ff",icon:aC.A,label:"Note",color:"#58a6ff"},TIP:{bg:"rgba(63, 185, 80, 0.08)",border:"#3fb950",icon:aL.A,label:"Tip",color:"#3fb950"},IMPORTANT:{bg:"rgba(163, 113, 247, 0.08)",border:"#a371f7",icon:aF.A,label:"Important",color:"#a371f7"},WARNING:{bg:"rgba(210, 153, 34, 0.08)",border:"#d29922",icon:aN.A,label:"Warning",color:"#d29922"},CAUTION:{bg:"rgba(248, 81, 73, 0.08)",border:"#f85149",icon:aE.A,label:"Caution",color:"#f85149"}},aI=s().div`
  background: ${({bg:e})=>e};
...
`;function aO({type:e,children:a}){let t=aP[e]??aP.NOTE,i=t.icon;return(0,o.jsxs)(aI,{bg:t.bg,border:t.border,children:[(0,o.jsxs)(aR,{color:t.color,children:[(0,o.jsx)(i,{size:15,strokeWidth:2}),t.label]}),(0,o.jsx)(aD,{children:a})]})}s().nav`
  width: 220px;
  min-width: 220px;
...
`;function aU({children:e}){return(0,o.jsx)(aK,{children:(0,o.jsx)(e3.oz,{remarkPlugins:[e8.A,e6.A,a_],rehypePlugins:[e7.A,e9.A],components:{div({node:e,children:a,...t}){let i=t["data-callout"];return i?(0,o.jsx)(aO,{type:i,children:a}):(0,o.jsx)("div",{...t,children:a})},pre:({children:e})=>(0,o.jsx)(o.Fragment,{children:e}),code({className:e,children:a}){let t=/language-(\w+)/.exec(e??"")?.[1],i=String(a).replace(/\n$/,"");return i.trim()?"mermaid"===t?(0,o.jsx)(an,{code:i}):"chart"===t?(0,o.jsx)(ab,{code:i}):t||i.includes("\n")?(0,o.jsx)(aT,{lang:t,code:i}):(0,o.jsx)("code",{className:e,children:a}):null}},children:e})})}s().nav`
  display: flex;
  flex-direction: column;
  gap: 1px;
  padding: ${l.w4.spacing.sm} 0;
...
`,d=n().p`
  ...
  margin: 0;
  line-height: 1.5;
`,c={loading:"◌ Loading",empty:"◎ Empty",error:"◎ Offline"};function p({mode:e,label:a,body:t}){return(0,o.jsxs)(s,{children:[(0,o.jsx)(l,{mode:e,children:a??c[e]}),t&&(0,o.jsx)(d,{children:t})]})}},38628(e,a,t){t.d(a,{YG:()=>o.Y});var o=t(85043);t(65723),t(37991);var i=t(23930),n=t(36859),r=t.n(n);r().span`
  font-family: ${i.w4.typography.fontFamilyMono};
  font-size: 11px;
  font-weight: 500;
  font-variant-numeric: tabular-nums;
