...
`,A=s().main`
  ...
  display: flex;
  flex-direction: column;
`,T=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function S(){return(0,r.jsx)(h,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:T.map((o,e)=>(0,r.jsx)(y,{index:e,accent:o.accent,children:o.char},e))})}let j="atlantis:sidebar-collapsed";function F({sidebar:o,children:e,topBarRight:t,title:l="Atlantis",activeId:s=null}){let[d,g]=(0,n.useState)(()=>{try{return"true"===localStorage.getItem(j)}catch{return!1}}),[m,b]=(0,n.useState)(null),h=(0,n.useRef)(),y=()=>g(o=>{let e=!o;try{localStorage.setItem(j,String(e))}catch{}return e}),T=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(a.bind(a,7330)).then(o=>({default:o.FlyoutPanel}))),[]);return(0,r.jsx)(p.I.Provider,{value:{collapsed:d,toggle:y,flyout:m,openFlyout:(o,e,a)=>{clearTimeout(h.current),b({entry:o,anchorY:e,onSelect:a})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>b(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,r.jsxs)(z,{children:[(0,r.jsxs)(f,{children:[o&&(0,r.jsx)(u,{children:(0,r.jsx)(x,{onClick:y,title:d?"Expand sidebar":"Collapse sidebar",children:(0,r.jsx)(c.A,{size:17})})}),(0,r.jsx)(S,{}),l&&(0,r.jsx)(w,{children:l}),t&&(0,r.jsx)($,{children:t})]}),(0,r.jsxs)(v,{children:[null!=o&&(0,r.jsx)(k,{collapsed:d,children:(0,r.jsx)(M,{children:o})}),(0,r.jsx)(A,{children:e})]}),m&&(0,r.jsx)(i().Suspense,{fallback:null,children:(0,r.jsx)(T,{activeId:s})})]})})}s().div`
  display: grid;
...
`,J=s().div`
  ...
  color: ${t.w4.colors.sidebarTextMuted};
  font-family: ${t.w4.typography.fontFamily};
`;function O({onSave:o,onUpdate:e,onCancel:a,existingDoc:t}){let[i,l]=(0,n.useState)(t?.name??""),s=(0,n.useRef)(null);return(0,n.useEffect)(()=>{s.current?.focus(),t&&s.current?.select()},[t]),(0,r.jsx)(N,{onClick:a,children:(0,r.jsxs)(I,{onClick:o=>o.stopPropagation(),children:[(0,r.jsx)(K,{children:"Save document"}),t&&e&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(J,{children:"Update the current version or save as a new one."}),(0,r.jsxs)(Y,{children:[(0,r.jsx)(G,{onClick:a,children:"Cancel"}),(0,r.jsxs)(G,{danger:!0,onClick:e,children:['Update "',t.name,'"']})]}),(0,r.jsx)(_,{})]}),(0,r.jsx)(V,{ref:s,value:i,onChange:o=>l(o.target.value),onKeyDown:r=>{"Enter"===r.key&&i.trim()&&(t&&i.trim()===t.name&&e?e():o(i.trim())),"Escape"===r.key&&a()},placeholder:t?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,r.jsxs)(Y,{children:[!t&&(0,r.jsx)(G,{onClick:a,children:"Cancel"}),(0,r.jsx)(G,{primary:!0,disabled:!i.trim(),onClick:()=>o(i.trim()),children:"Save as new"})]})]})})}var W=a(5625),U=a(679),Z=a(4872);let X=s().div`
  position: relative;
`,q=s().button`
  display: flex;
  align-items: center;
...
`;function os({appId:o,onLoad:e}){let[a,t]=(0,n.useState)(!1),[i,l]=(0,n.useState)([]),s=(0,n.useRef)(null),d=(0,n.useCallback)(()=>{H.listDocs(o).then(l).catch(()=>{})},[o]);(0,n.useEffect)(()=>{if(!a)return;d();let o=o=>{s.current&&!s.current.contains(o.target)&&t(!1)};return document.addEventListener("mousedown",o),()=>document.removeEventListener("mousedown",o)},[a,d]);let c=async(o,e)=>{o.stopPropagation(),await H.deleteDoc(e),l(o=>o.filter(o=>o.id!==e))};return(0,r.jsxs)(X,{ref:s,children:[(0,r.jsxs)(q,{onClick:()=>t(o=>!o),children:[(0,r.jsx)(W.A,{size:14}),"Saved",(0,r.jsx)(U.A,{size:13,style:{marginLeft:2}})]}),(0,r.jsxs)(Q,{open:a,children:[(0,r.jsx)(oo,{children:"Saved versions"}),(0,r.jsx)(oe,{children:0===i.length?(0,r.jsx)(oa,{children:"No saved documents yet."}):i.map(o=>{var a;return(0,r.jsxs)(ot,{children:[(0,r.jsxs)(or,{onClick:()=>{e(o.content,o.id,o.name),t(!1)},children:[(0,r.jsx)(on,{children:o.name}),(0,r.jsx)(oi,{children:(a=o.savedAt,new Intl.DateTimeFormat(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}).format(new Date(a)))})]}),(0,r.jsx)(ol,{onClick:e=>c(e,o.id),title:"Delete",children:(0,r.jsx)(Z.A,{size:13})})]},o.id)})})]})]})}s().div`
...
`;s().div`
  ...
  background: ${t.w4.colors.mainBg};
  font-family: ${t.w4.typography.fontFamily};
  animation: ${od} 0.4s ease 0.15s both;
`,s().div`
  position: relative;
  width: 56px;
  height: 56px;
...
`,s().div`
  position: absolute;
  inset: 0;
  animation: ${oc} 1.4s cubic-bezier(0.4, 0, 0.2, 1) infinite;
...
`;var h=a(2799);let y=(0,h.keyframes)`
...
`,E.A,E.A['pre[class*="language-"]'],l.w4.colors.codeBg,E.A['code[class*="language-"]'],i().div`
  background: ${({bg:o})=>o};
