...
`,m=n().div`
  ...
  flex-shrink: 0;
`,b=[{label:"0–14",color:"#3fb950"},{label:"15–24",color:"#7ee787"},{label:"25–37",color:"#d29922"},{label:"38–49",color:"#f0883e"},{label:"50+",color:"#f85149"}];function w(e,t=.35){if(e.length<2)return"";let r=`M ${e[0].x.toFixed(2)} ${e[0].y.toFixed(2)}`;for(let o=0;o<e.length-1;o++){let a=e[Math.max(o-1,0)],i=e[o],n=e[o+1],l=e[Math.min(o+2,e.length-1)],d=i.x+(n.x-a.x)*t,s=i.y+(n.y-a.y)*t,c=n.x-(l.x-i.x)*t,p=n.y-(l.y-i.y)*t;r+=` C ${d.toFixed(2)} ${s.toFixed(2)} ${c.toFixed(2)} ${p.toFixed(2)} ${n.x.toFixed(2)} ${n.y.toFixed(2)}`}return r}function y({cx:e,cy:t,deg:r,size:a=7}){return(0,o.jsx)("g",{transform:`translate(${e},${t}) rotate(${r})`,children:(0,o.jsx)("polygon",{points:`0,${-a} ${.55*a},${.6*a} 0,${.2*a} ${-(.55*a)},${.6*a}`,fill:c,opacity:.85})})}function $({temps:e,feelsLike:t}){let r=228,a=52,i=[...e,...t],n=5*Math.floor(Math.min(...i)/5),l=5*Math.ceil(Math.max(...i)/5),d=l-n||1,s=e=>e.map((t,o)=>({x:32+o/(e.length-1)*r,y:14+a-(t-n)/d*a})),x=s(e),b=s(t),y=w(x),v=w(b),M=`${y} L ${x[x.length-1].x.toFixed(2)} ${(14+a).toFixed(2)} L ${x[0].x.toFixed(2)} ${(14+a).toFixed(2)} Z`,k=[0,6,12,18,23].map(t=>({label:23===t?"24h":`${t}h`,x:32+t/(e.length-1)*r})),z=[{label:`${l}\xb0`,y:14},{label:`${Math.round((l+n)/2)}\xb0`,y:14+a/2},{label:`${n}\xb0`,y:14+a}],j=x[Math.min(new Date().getHours(),x.length-1)];return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsxs)("svg",{viewBox:"0 0 268 88",width:"100%",style:{display:"block",overflow:"visible"},children:[(0,o.jsx)("defs",{children:(0,o.jsxs)("linearGradient",{id:"tempGrad",x1:"0",y1:"0",x2:"0",y2:"1",children:[(0,o.jsx)("stop",{offset:"0%",stopColor:c,stopOpacity:.25}),(0,o.jsx)("stop",{offset:"100%",stopColor:c,stopOpacity:0})]})}),z.map(({y:e})=>(0,o.jsx)("line",{x1:32,y1:e,x2:32+r,y2:e,stroke:h,strokeWidth:1},e)),(0,o.jsx)("path",{d:M,fill:"url(#tempGrad)"}),(0,o.jsx)("path",{d:v,fill:"none",stroke:p,strokeWidth:1,strokeDasharray:"3 4",opacity:.6}),(0,o.jsx)("path",{d:y,fill:"none",stroke:c,strokeWidth:1.5,strokeLinejoin:"round"}),(0,o.jsx)("circle",{cx:j.x,cy:j.y,r:3,fill:c}),k.map(({label:e,x:t})=>(0,o.jsx)("text",{x:t,y:84,textAnchor:"middle",fill:g,fontSize:9,fontFamily:"monospace",children:e},e)),z.map(({label:e,y:t})=>(0,o.jsx)("text",{x:28,y:t+3,textAnchor:"end",fill:g,fontSize:9,fontFamily:"monospace",children:e},e))]}),(0,o.jsxs)(f,{children:[(0,o.jsxs)(u,{children:[(0,o.jsx)(m,{color:c})," Actual"]}),(0,o.jsxs)(u,{style:{marginLeft:4},children:[(0,o.jsx)(m,{color:p,style:{opacity:.6}})," Feels like"]})]})]})}function v({speeds:e}){let t,r=232,a=52,i=5*Math.ceil(Math.max(...e,1)/5),n=e.map((t,o)=>({x:28+o/(e.length-1)*r,y:14+a-t/i*a})),l=w(n),d=`${l} L ${n[n.length-1].x.toFixed(2)} ${(14+a).toFixed(2)} L ${n[0].x.toFixed(2)} ${(14+a).toFixed(2)} Z`,s=[0,6,12,18,23].map(t=>({label:23===t?"24h":`${t}h`,x:28+t/(e.length-1)*r})),p=[{label:`${i}`,y:14},{label:`${Math.round(i/2)}`,y:14+a/2},{label:"0",y:14+a}];return(0,o.jsxs)("svg",{viewBox:"0 0 268 88",width:"100%",style:{display:"block",overflow:"visible"},children:[(0,o.jsx)("defs",{children:(0,o.jsxs)("linearGradient",{id:"windGrad",x1:"0",y1:"0",x2:"0",y2:"1",children:[(0,o.jsx)("stop",{offset:"0%",stopColor:c,stopOpacity:.3}),(0,o.jsx)("stop",{offset:"100%",stopColor:c,stopOpacity:0})]})}),p.map(({y:e})=>(0,o.jsx)("line",{x1:28,y1:e,x2:28+r,y2:e,stroke:h,strokeWidth:1},e)),(0,o.jsx)("path",{d:d,fill:"url(#windGrad)"}),(0,o.jsx)("path",{d:l,fill:"none",stroke:c,strokeWidth:1.5,strokeLinejoin:"round"}),(t=n[Math.min(new Date().getHours(),n.length-1)],(0,o.jsx)("circle",{cx:t.x,cy:t.y,r:3,fill:c})),s.map(({label:e,x:t})=>(0,o.jsx)("text",{x:t,y:84,textAnchor:"middle",fill:g,fontSize:9,fontFamily:"monospace",children:e},e)),p.map(({label:e,y:t})=>(0,o.jsx)("text",{x:24,y:t+3,textAnchor:"end",fill:g,fontSize:9,fontFamily:"monospace",children:e},e))]})}function M({speeds:e,directions:t,dayLabels:r}){let a=e.length,i=5*Math.ceil(Math.max(...e,1)/5),n=252/a,l=.28*n;return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsxs)("svg",{viewBox:"0 0 268 110",width:"100%",style:{display:"block",overflow:"visible"},children:[(0,o.jsx)("line",{x1:8,y1:90,x2:260,y2:90,stroke:h,strokeWidth:1}),e.map((e,a)=>{let d=e/i*60,s=8+a*n+l/2,c=n-l,p=s+c/2,h=function(e){let t=x[0].color;for(let r of x)if(e>=r.threshold)t=r.color;else break;return t}(e);return(0,o.jsxs)("g",{children:[(0,o.jsx)(y,{cx:p,cy:7,deg:t[a],size:6}),(0,o.jsx)("text",{x:p,y:23,textAnchor:"middle",fill:h,fontSize:8,fontWeight:"600",fontFamily:"monospace",children:Math.round(e)}),(0,o.jsx)("rect",{x:s,y:90-d,width:c,height:d,fill:h,opacity:.85,rx:2}),(0,o.jsx)("text",{x:p,y:106,textAnchor:"middle",fill:g,fontSize:9,fontFamily:"monospace",children:r[a]})]},a)}),(0,o.jsx)("text",{x:260,y:88,textAnchor:"end",fill:g,fontSize:8,fontFamily:"monospace",children:"km/h"})]}),(0,o.jsx)(f,{children:b.map(({label:e,color:t})=>(0,o.jsxs)(u,{children:[(0,o.jsx)(m,{color:t}),e]},e))})]})}let k=n().div`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
...
`;function N({place:e,onClose:t}){var r;let[i,n]=(0,a.useState)(null),[c,p]=(0,a.useState)(null),[h,g]=(0,a.useState)(!1),[x,f]=(0,a.useState)(null),[u,m]=(0,a.useState)(0);(0,a.useEffect)(()=>{if(!e){n(null),p(null);return}g(!0),f(null),n(null),p(null);let t=`https://api.open-meteo.com/v1/forecast?latitude=${e.lat}&longitude=${e.lng}&current_weather=true&hourly=temperature_2m,apparent_temperature,relativehumidity_2m,windspeed_10m,winddirection_10m&daily=weathercode,temperature_2m_max,temperature_2m_min,precipitation_sum,windspeed_10m_max,winddirection_10m_dominant&timezone=auto&forecast_days=7`,r=`https://air-quality-api.open-meteo.com/v1/air-quality?latitude=${e.lat}&longitude=${e.lng}&current=pm2_5,pm10,european_aqi,us_aqi`;Promise.all([fetch(t).then(e=>{if(!e.ok)throw Error(`HTTP ${e.status}`);return e.json()}),fetch(r).then(e=>e.ok?e.json():null).catch(()=>null)]).then(([e,t])=>{n(e),p(t),g(!1)}).catch(e=>{f(e.message),g(!1)})},[e?.id,u]);let b=i?s(i.current_weather.weathercode):null,w=i?i.hourly.windspeed_10m.slice(0,24):[],y=i?i.hourly.temperature_2m.slice(0,24):[],U=i?i.hourly.apparent_temperature.slice(0,24):[],Z=new Date().getHours(),Q=i?i.hourly.relativehumidity_2m[Z]:null,J=i?i.hourly.apparent_temperature[Z]:null,ee=c?(r=c.current.us_aqi)<=50?{label:"Good",color:"#3fb950"}:r<=100?{label:"Moderate",color:"#d29922"}:r<=150?{label:"Unhealthy (sensitive)",color:"#f0883e"}:r<=200?{label:"Unhealthy",color:"#f85149"}:{label:"Hazardous",color:"#b44ac0"}:null;return(0,o.jsxs)(k,{visible:!!e,children:[(0,o.jsxs)(z,{children:[(0,o.jsx)(j,{children:e?.name??""}),(0,o.jsx)(d.K0,{onClick:t,title:"Close",children:(0,o.jsx)(d.In,{name:"close",size:14})})]}),(0,o.jsxs)(F,{children:[h&&(0,o.jsx)(K,{children:"Loading weather…"}),x&&(0,o.jsxs)(K,{children:[(0,o.jsx)("div",{children:"Weather unavailable — the API may be temporarily down."}),(0,o.jsx)("button",{onClick:()=>m(e=>e+1),style:{marginTop:12,padding:"6px 16px",cursor:"pointer",background:"none",border:`1px solid ${l.w4.colors.border}`,borderRadius:6,color:l.w4.colors.mainText,fontFamily:"inherit",fontSize:12},children:"Retry"})]}),i&&b&&(0,o.jsxs)(o.Fragment,{children:[(0,o.jsxs)(T,{children:[(0,o.jsxs)(S,{children:[(0,o.jsxs)("div",{children:[(0,o.jsxs)(H,{children:[Math.round(i.current_weather.temperature),"\xb0C"]}),(0,o.jsx)(C,{children:b.label})]}),(0,o.jsx)(L,{children:b.emoji})]}),(0,o.jsxs)(R,{children:[(0,o.jsxs)(B,{children:["\uD83D\uDCA8 ",Math.round(i.current_weather.windspeed)," km/h"]}),(0,o.jsxs)(B,{children:["\uD83C\uDF21 ",Math.round(i.daily.temperature_2m_max[0]),"\xb0 / ",Math.round(i.daily.temperature_2m_min[0]),"\xb0"]}),null!=J&&(0,o.jsxs)(B,{children:["\uD83C\uDF2C Feels ",Math.round(J),"\xb0"]}),null!=Q&&(0,o.jsxs)(B,{children:["\uD83D\uDCA7 ",Q,"% RH"]})]}),ee&&c&&(0,o.jsxs)(V,{color:ee.color,children:["\uD83C\uDFED AQI ",c.current.us_aqi," \xb7 ",ee.label]})]}),y.length>0&&(0,o.jsxs)("div",{children:[(0,o.jsx)(A,{children:"Temperature today (hourly)"}),(0,o.jsxs)(_,{children:[(0,o.jsx)(I,{children:"\xb0C \xb7 dot = current hour"}),(0,o.jsx)($,{temps:y,feelsLike:U})]})]}),(0,o.jsxs)("div",{children:[(0,o.jsx)(A,{children:"Wind today (hourly)"}),(0,o.jsxs)(_,{children:[(0,o.jsx)(I,{children:"Speed km/h \xb7 dot = current hour"}),(0,o.jsx)(v,{speeds:w})]})]}),(0,o.jsxs)("div",{children:[(0,o.jsx)(A,{children:"Wind this week (daily max)"}),(0,o.jsxs)(_,{children:[(0,o.jsx)(I,{children:"Max speed km/h \xb7 arrows = dominant direction"}),(0,o.jsx)(M,{speeds:i.daily.windspeed_10m_max,directions:i.daily.winddirection_10m_dominant,dayLabels:i.daily.time.map((e,t)=>0===t?"Today":new Date(e).toLocaleDateString("en-GB",{weekday:"short"}))})]})]}),(0,o.jsxs)("div",{children:[(0,o.jsx)(A,{children:"7-Day Forecast"}),i.daily.time.map((e,t)=>{let{emoji:r,label:a}=s(i.daily.weathercode[t]);return(0,o.jsxs)(E,{children:[(0,o.jsx)(P,{children:r}),(0,o.jsxs)(q,{children:[(0,o.jsx)(Y,{children:0===t?"Today":1===t?"Tomorrow":new Date(e).toLocaleDateString("en-GB",{weekday:"short",month:"short",day:"numeric"})}),(0,o.jsx)(W,{children:a})]}),(0,o.jsx)(G,{children:i.daily.precipitation_sum[t]>0&&(0,o.jsxs)(o.Fragment,{children:["\uD83D\uDCA7 ",i.daily.precipitation_sum[t].toFixed(1)]})}),(0,o.jsxs)(D,{children:[(0,o.jsxs)(O,{children:[Math.round(i.daily.temperature_2m_max[t]),"\xb0"]}),(0,o.jsxs)(X,{children:[Math.round(i.daily.temperature_2m_min[t]),"\xb0"]})]})]},e)})]})]})]})]})}},1112(e,t,r){r.d(t,{xy:()=>c});var o=r(7991);function a(e){return e*Math.PI/180}var i=r(5004);function n(e){return e<20?"#00e676":e<40?"#69ff47":e<60?"#b2ff59":e<80?"#ffea00":"#ff6d00"}function l(e){return null==e||e<1e3?"#8b949e":e<1e4?"#f0883e":e<25e3?"#d29922":"#58a6ff"}function d(e){let t=l(e.altFt),r=null!=e.altFt?`${Math.round(.3048*e.altFt).toLocaleString()} m`:"—",o=null!=e.speedKts?`${Math.round(1.852*e.speedKts)} km/h`:"—",a=null!=e.heading?`${Math.round(e.heading)}\xb0`:"—",i=null!=e.vrateFpm?`${e.vrateFpm>0?"↑":"↓"} ${Math.abs(Math.round(.00508*e.vrateFpm))} m/s`:"—";return`
    <div style="font-family:monospace;font-size:12px;line-height:1.75;min-width:180px;">
      ...
      <div style="margin-top:6px">
        <button
    ...
    </div>`}let s=new Map([{id:"night",label:"\uD83C\uDF11 Night",title:"Day/night terminator",defaultEnabled:!1,component:function({map:e,enabled:t}){let r=(0,o.useRef)(null),i=(0,o.useRef)(),n=(0,o.useCallback)(()=>{clearInterval(i.current),r.current?.remove(),r.current=null},[]),l=(0,o.useCallback)(()=>{if(!e||!t)return;let o=function(e){let t,r,o,i,n,l,d,s=(o=a((280.46+.9856474*(r=(t=e.getTime()/864e5+2440587.5)-2451545))%360),i=a((357.528+.9856003*r)%360),n=o+a(1.915*Math.sin(i)+.02*Math.sin(2*i)),d=Math.atan2(Math.cos(l=a(23.439-4e-7*r))*Math.sin(n),Math.cos(n)),{ra:d,dec:Math.asin(Math.sin(l)*Math.sin(n)),gmst:a((280.46061837+360.98564736629*(t-2451545))%360)}),c=[];for(let e=-180;e<=180;e++){var p;let t=(p=a(e),Math.atan(-Math.cos(s.gmst+p-s.ra)/Math.tan(s.dec)));c.push([180*t/Math.PI,e])}let h=s.dec>0?-90:90;return c.push([h,180]),c.push([h,-180]),c}(new Date);r.current?r.current.setLatLngs(o):r.current=window.L.polygon(o,{color:"transparent",fillColor:"#000",fillOpacity:.3,interactive:!1}).addTo(e)},[e,t]);return(0,o.useEffect)(()=>e&&t?(l(),i.current=setInterval(l,3e4),n):void n(),[e,t,l,n]),null}},{id:"aurora",label:"\uD83C\uDF0C Aurora",title:"Aurora forecast — NOAA SWPC",defaultEnabled:!1,component:function({map:e,enabled:t}){let r=(0,o.useRef)([]),a=(0,o.useRef)(null),l=(0,o.useCallback)(()=>{r.current.forEach(e=>e.remove()),r.current=[],a.current&&(a.current.remove(),a.current=null)},[]),d=(0,o.useCallback)(async()=>{if(!e||!t)return;let[o,l]=await Promise.all([(0,i.fetchAuroraOvation)(),(0,i.fetchPlanetaryKIndex)()]);if(!o||!l||!e||!t)return;let d=l[l.length-1]?.kp_index??0,s=window.L;for(let[t,a,i]of(r.current.forEach(e=>e.remove()),r.current=[],o.coordinates)){if(i<5||45>Math.abs(a))continue;let o=s.circleMarker([a,t],{radius:3,color:n(i),fillColor:n(i),fillOpacity:Math.min(.85,.15+i/100*.7),weight:0,interactive:!1});o.addTo(e),r.current.push(o)}a.current&&a.current.remove();let c=d>=7?"#f85149":d>=5?"#f0883e":d>=3?"#d29922":"#3fb950";a.current=new(s.Control.extend({onAdd(){let e=s.DomUtil.create("div");return e.innerHTML=`
          <div style="
          ...
          </div>`,e},onRemove(){}}))({position:"bottomleft"}),a.current.addTo(e)},[e,t]);return(0,o.useEffect)(()=>{if(!t)return void l();d();let e=setInterval(d,3e5);return()=>{clearInterval(e),l()}},[t,d,l]),null}},{id:"iss",label:"\uD83D\uDEF8 ISS",title:"ISS live position + footprint",defaultEnabled:!1,component:function({map:e,enabled:t}){let r=(0,o.useRef)(null),a=(0,o.useRef)(null),n=(0,o.useRef)(null),l=(0,o.useRef)([]),d=(0,o.useCallback)(()=>{r.current?.remove(),r.current=null,a.current?.remove(),a.current=null,n.current?.remove(),n.current=null,l.current=[]},[]),s=(0,o.useCallback)(async()=>{if(!e||!t)return;let o=await (0,i.fetchIssPosition)();if(!o||!e||!t)return;let d=window.L,s=o.latitude,c=o.longitude,p=l.current;if(p.length>0){let[,e]=p[p.length-1];Math.abs(c-e)>180&&(l.current=[])}l.current=[...l.current,[s,c]].slice(-80);let h=`<div style="
        font-size:22px;
        filter:drop-shadow(0 0 8px rgba(255,210,0,.9));
        line-height:1;
      ">🛸</div>`,g=d.divIcon({html:h,className:"",iconSize:[24,24],iconAnchor:[12,12]}),x=`
        ...
        </div>`;r.current?(r.current.setLatLng([s,c]),r.current.getPopup()?.setContent(x)):r.current=d.marker([s,c],{icon:g,zIndexOffset:2e3}).bindPopup(x,{maxWidth:220}).addTo(e),a.current?a.current.setLatLngs(l.current):a.current=d.polyline(l.current,{color:"#f0c040",weight:1.5,opacity:.55,dashArray:"3 7"}).addTo(e),n.current?n.current.setLatLng([s,c]):n.current=d.circle([s,c],{radius:2316e3,color:"#f0c040",fillColor:"#f0c040",fillOpacity:.04,weight:1,opacity:.25,dashArray:"5 8",interactive:!1}).addTo(e)},[e,t]);return(0,o.useEffect)(()=>{let e;if(!t)return void d();let r=!1,o=async()=>{await s(),r||(e=setTimeout(o,5e3))};return o(),()=>{r=!0,clearTimeout(e),d()}},[t,s,d]),null}},{id:"quakes",label:"\uD83C\uDF0D Quakes",title:"Earthquakes — USGS past month",defaultEnabled:!1,component:function({map:e,enabled:t}){let r=(0,o.useRef)(new Map),a=(0,o.useCallback)(()=>{r.current.forEach(e=>e.remove()),r.current.clear()},[]),n=(0,o.useCallback)(async()=>{if(!e||!t)return;let o=await (0,i.fetchUsgsQuakes)("all_month","seismic-world-all_month");if(!o?.features||!e||!t)return;let a=window.L,n=Date.now(),l=new Set;for(let t of o.features){let[o,i,d]=t.geometry.coordinates,{mag:s,place:c,time:p,type:h}=t.properties;if("earthquake"!==h||null==s||null==i||null==o)continue;l.add(t.id);let g=n-p,x=s<2?"#3fb950":s<3?"#7ee787":s<4?"#d29922":s<5?"#f0883e":s<6?"#f85149":"#ff4444",f=Math.min(40,Math.max(3,1.5*Math.pow(2,s-1)));if(r.current.has(t.id))continue;let u=a.circleMarker([i,o],{radius:f,color:x,fillColor:x,fillOpacity:Math.max(.25,.7-g/2592e6),weight:1});u.bindPopup(`
  ...
  ">
    <svg width="16" height="16" viewBox="0 0 24 24" fill="${t}">
      ...
      "></div>`,className:"",iconSize:[10,10],iconAnchor:[5,5]}),s=t=>{let{lat:s,lng:c}=t.latlng;r.current.length>=2&&l(),r.current=[...r.current,[s,c]];let p=o.marker([s,c],{icon:d,interactive:!1}).addTo(e);if(a.current.push(p),2===r.current.length){var h,g,x;let t,[a,l]=r.current,d=o.polyline([a,l],{color:"#58a6ff",weight:2,dashArray:"6 5",opacity:.85,interactive:!1}).addTo(e);i.current.push(d);let s=(h=a[0],g=a[1],12742*Math.atan2(Math.sqrt(t=Math.sin(((x=l[0])-h)*Math.PI/180/2)**2+Math.cos(h*Math.PI/180)*Math.cos(x*Math.PI/180)*Math.sin((l[1]-g)*Math.PI/180/2)**2),Math.sqrt(1-t))),c=(a[0]+l[0])/2,p=(a[1]+l[1])/2;n.current=o.popup({closeButton:!0,autoClose:!1,className:"",offset:[0,-4]}).setLatLng([c,p]).setContent(`
            ...
            </div>`).addTo(e)}};return e.on("click",s),e.getContainer().style.cursor="crosshair",()=>{e.off("click",s),e.getContainer().style.cursor="",l()}},[e,t,l]),null}}].map(e=>[e.id,e]));function c(){return Array.from(s.values())}},2787(e,t,r){r.d(t,{FlyoutPanel:()=>w});var o=r(5723),a=r(7991),i=r.n(a),n=r(6859),l=r.n(n),d=r(2799),s=r(6063),c=r(7993),p=r(4971);let h=(0,d.keyframes)`
...
`;let j={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:d.w4.colors.accentMuted},F={neutral:d.w4.colors.mainTextMuted,live:d.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:d.w4.colors.accent};l().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${d.w4.typography.fontFamilyMono};
...
`,K=l().div`
  ...
  color: ${d.w4.colors.sidebarTextMuted};
  font-family: ${d.w4.typography.fontFamily};
`;function N({onSave:e,onUpdate:t,onCancel:r,existingDoc:i}){let[n,l]=(0,a.useState)(i?.name??""),d=(0,a.useRef)(null);return(0,a.useEffect)(()=>{d.current?.focus(),i&&d.current?.select()},[i]),(0,o.jsx)(q,{onClick:r,children:(0,o.jsxs)(Y,{onClick:e=>e.stopPropagation(),children:[(0,o.jsx)(W,{children:"Save document"}),i&&t&&(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(K,{children:"Update the current version or save as a new one."}),(0,o.jsxs)(O,{children:[(0,o.jsx)(X,{onClick:r,children:"Cancel"}),(0,o.jsxs)(X,{danger:!0,onClick:t,children:['Update "',i.name,'"']})]}),(0,o.jsx)(G,{})]}),(0,o.jsx)(D,{ref:d,value:n,onChange:e=>l(e.target.value),onKeyDown:o=>{"Enter"===o.key&&n.trim()&&(i&&n.trim()===i.name&&t?t():e(n.trim())),"Escape"===o.key&&r()},placeholder:i?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,o.jsxs)(O,{children:[!i&&(0,o.jsx)(X,{onClick:r,children:"Cancel"}),(0,o.jsx)(X,{primary:!0,disabled:!n.trim(),onClick:()=>e(n.trim()),children:"Save as new"})]})]})})}let U=(0,$.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,Z=(0,$.keyframes)`
...
`,l().div`
  position: relative;
`;let et="260px",er="56px",eo="44px",ea=l().header`
  display: flex;
  align-items: center;
...
`,eu=l().main`
  ...
  display: flex;
  flex-direction: column;
`;function em(){return(0,o.jsxs)(el,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:[(0,o.jsx)(ed,{"aria-hidden":"true",children:"A"}),(0,o.jsx)(es,{children:"Atlantis"})]})}let eb="atlantis:sidebar-collapsed";function ew({sidebar:e,children:t,topBarRight:n,title:l="Atlantis",activeId:d=null}){let[s,c]=(0,a.useState)(()=>{try{return"true"===localStorage.getItem(eb)}catch{return!1}}),[p,h]=(0,a.useState)(null),g=(0,a.useRef)(),x=()=>c(e=>{let t=!e;try{localStorage.setItem(eb,String(t))}catch{}return t}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(r.bind(r,2787)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,o.jsx)(_.I.Provider,{value:{collapsed:s,toggle:x,flyout:p,openFlyout:(e,t,r)=>{clearTimeout(g.current),h({entry:e,anchorY:t,onSelect:r})},scheduleFlyoutClose:()=>{g.current=setTimeout(()=>h(null),160)},cancelFlyoutClose:()=>clearTimeout(g.current)},children:(0,o.jsxs)(eg,{children:[(0,o.jsxs)(ea,{children:[e&&(0,o.jsx)(ei,{children:(0,o.jsx)(en,{onClick:x,title:s?"Expand sidebar":"Collapse sidebar",children:(0,o.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,o.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,o.jsx)("path",{d:"M9 3v18"})]})})}),(0,o.jsx)(em,{}),l&&(0,o.jsx)(ec,{children:l}),n&&(0,o.jsx)(ep,{children:n})]}),(0,o.jsxs)(eh,{children:[null!=e&&(0,o.jsx)(ex,{collapsed:s,children:(0,o.jsx)(ef,{children:e})}),(0,o.jsx)(eu,{children:t})]}),p&&(0,o.jsx)(i().Suspense,{fallback:null,children:(0,o.jsx)(f,{activeId:d})})]})})}var ey=r(4971);let e$=l().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
...
`;function eL({iconKey:e,size:t=16}){let r=e?ey.X[e]:void 0;return r?(0,o.jsx)("svg",{width:t,height:t,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,dangerouslySetInnerHTML:{__html:r}}):e?(0,o.jsx)("span",{style:{fontSize:t,lineHeight:1,display:"flex",alignItems:"center"},children:e}):(0,o.jsxs)("svg",{width:t,height:t,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,children:[(0,o.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,o.jsx)("polyline",{points:"14 2 14 8 20 8"})]})}function eH({entry:e,activeId:t,onSelect:r}){let[i,n]=(0,a.useState)(e.defaultOpen??!0),{collapsed:l,openFlyout:d,scheduleFlyoutClose:s,cancelFlyoutClose:c}=(0,_.c)();return e.children&&e.children.length>0?(0,o.jsxs)(ek,{children:[(0,o.jsxs)(ez,{collapsed:l,onClick:()=>{l||n(e=>!e)},onMouseEnter:l?t=>{d(e,t.currentTarget.getBoundingClientRect().top,r)}:void 0,onMouseLeave:l?s:void 0,children:[(0,o.jsxs)(ej,{collapsed:l,children:[(0,o.jsx)(eL,{iconKey:e.icon,size:16}),(0,o.jsx)(eF,{collapsed:l,children:e.name})]}),(0,o.jsx)(eT,{open:i,collapsed:l,children:(0,o.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round",children:(0,o.jsx)("path",{d:"M9 6l6 6-6 6"})})})]}),(0,o.jsx)(e$,{open:i&&!l,children:(0,o.jsx)(ev,{children:(0,o.jsx)(eM,{children:e.children.map(e=>(0,o.jsx)(eH,{entry:e,activeId:t,onSelect:r},e.id))})})})]}):(0,o.jsxs)(eS,{active:t===e.id,collapsed:l,onClick:()=>r(e),onMouseEnter:l?t=>{let o=t.currentTarget.getBoundingClientRect();d({id:e.id,name:e.name,icon:e.icon,file:e.file,children:[e]},o.top,r)}:void 0,onMouseLeave:l?s:void 0,children:[(0,o.jsx)(eL,{iconKey:e.icon,size:15}),(0,o.jsx)(eF,{collapsed:l,children:e.name})]})}function eC({entries:e,activeId:t,onSelect:r}){return(0,o.jsx)("div",{children:e.map(e=>(0,o.jsx)(eH,{entry:e,activeId:t,onSelect:r},e.id))})}r(2787),l().div`
