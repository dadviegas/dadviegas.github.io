"use strict";(self.webpackChunk_atlantis_regexlab=self.webpackChunk_atlantis_regexlab||[]).push([[5379],{4914(o,e,a){a.d(e,{FlyoutPanel:()=>b});var t=a(7359),r=a(3233),n=a(7207),i=a(255),l=a(217),d=a(5959),s=a(5185),c=a(5723);const p=n.keyframes`
...
`,R.A,R.A['pre[class*="language-"]'],n.w4.colors.codeBg,R.A['code[class*="language-"]'];var P=a(5569),E=a(8218),H=a(7230),L=a(2966),D=a(1069);P.A,E.A,H.A,L.A,D.A,r.default.div`
  background: ${({bg:o})=>o};
...
`;function J({activeAppId:o}){const{collapsed:e}=(0,n.cL)(),[a]=function(){const[o,e]=(0,t.useState)(z),a=(0,t.useCallback)(o=>{e(o),function(o){try{localStorage.setItem(w,o)}catch{}(0,n.Is)($,o).catch(()=>{})}(o),window.dispatchEvent(new CustomEvent("atlantis:locale-change",{detail:o}))},[]);return(0,t.useEffect)(()=>{const o=o=>{const a=o.detail;e(a)};return window.addEventListener("atlantis:locale-change",o),()=>window.removeEventListener("atlantis:locale-change",o)},[]),(0,t.useEffect)(()=>{(0,n.PL)($).then(a=>{if(v(a)&&a!==o){try{localStorage.setItem(w,a)}catch{}e(a)}}).catch(()=>{})},[]),[o,a]}(),r=(0,t.useMemo)(()=>function(o){const e=y;return(a,t)=>{const r=e[a]?.[o]??a;return t?Object.entries(t).reduce((o,[e,a])=>o.replace(new RegExp(`\\{${e}\\}`,"g"),String(a)),r):r}}(a),[a]),l=(0,t.useRef)(null),d=o=>{l.current!==o&&(l.current=o,document.activeElement?.blur(),window.location.hash=o,setTimeout(()=>{l.current=null},50))};return(0,i.jsxs)(Y,{children:[(0,i.jsx)(G,{collapsed:e,children:r("devtools.heading")}),N.map(a=>{const t=r(a.labelKey);return(0,i.jsxs)(V,{active:o===a.id,collapsed:e,onPointerDown:o=>{0===o.button&&d(a.hash)},onClick:()=>d(a.hash),title:t,children:[(0,i.jsx)(_,{children:(0,i.jsx)(M,{name:a.icon,size:16})}),(0,i.jsx)(O,{collapsed:e,children:t})]},a.id)})]})}},9336(o,e,a){a.d(e,{k:()=>t});const t=[{label:"Email addresses",pattern:"([\\w.+-]+)@([\\w-]+)\\.([\\w.]+)",flags:"gi",text:"Contact us at hello@example.com or support@atlantis.dev for assistance.\nInvalid ones: @nouser.com, noatsign.org"},{label:"URLs",pattern:"https?:\\/\\/(www\\.)?([\\w-]+)\\.([\\w.]{2,})(\\S*)",flags:"gi",text:"Visit https://www.example.com/path?q=1 or http://atlantis.dev for more.\nAlso check https://github.com/atlantis/project#readme"},{label:"ISO dates",pattern:"(\\d{4})-(0[1-9]|1[0-2])-(0[1-9]|[12]\\d|3[01])",flags:"g",text:"Events: 2024-01-15, launch on 2024-03-22, deadline 2024-12-31.\nInvalid: 2024-13-01, 2024-00-10"},{label:"Hex colors",pattern:"#([0-9a-fA-F]{3}){1,2}\\b",flags:"gi",text:"CSS colors: #fff, #000000, #3fb950, #FF6347, #abc.\nNot colors: #GGGGGG, #12345"},{label:"IP addresses",pattern:"\\b(25[0-5]|2[0-4]\\d|[01]?\\d\\d?)\\.(25[0-5]|2[0-4]\\d|[01]?\\d\\d?)\\.(25[0-5]|2[0-4]\\d|[01]?\\d\\d?)\\.(25[0-5]|2[0-4]\\d|[01]?\\d\\d?)\\b",flags:"g",text:"Servers: 192.168.1.1, 10.0.0.255, 172.16.254.1\nInvalid: 256.100.1.1, 192.168.1"},{label:"Named groups — date parse",pattern:"(?<year>\\d{4})-(?<month>\\d{2})-(?<day>\\d{2})",flags:"g",text:"Release dates: 2024-01-15, 2025-06-30, 2023-12-01"},{label:"Duplicate words",pattern:"\\b(\\w+)\\s+\\1\\b",flags:"gi",text:"This is is a test test of duplicate duplicate words in in a sentence."}]}}]);