"use strict";(self.webpackChunk_atlantis_finance=self.webpackChunk_atlantis_finance||[]).push([["58"],{6376(e,t,o){o.d(t,{S:()=>j});var r=o(5723),a=o(7991),n=o(6859),i=o.n(n),s=o(2799),l=o(9874),d=o(8395);let c=(0,s.keyframes)`
...
`},2188(e,t,o){o.d(t,{uj:()=>k,OW:()=>f,ik:()=>m,Xj:()=>D,Ru:()=>x,kl:()=>F,RT:()=>j,RJ:()=>w,YG:()=>p});var r=o(5723),a=o(6859),n=o.n(a),i=o(9874);let s=n().div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
`,R=n().div`
  ...
  opacity: 0.7;
  transition: width 400ms ease;
`;function D({pct:e,over:t=0,color:o="#7fb77e"}){let a=Math.min(100,e),n=100-t;return(0,r.jsxs)(C,{children:[(0,r.jsx)(A,{pct:a,color:o}),t>0&&(0,r.jsx)(R,{left:Math.max(0,n),width:t})]})}o(8395),n().button`
  display: inline-flex;
  align-items: center;
  gap: 6px;
  padding: 0 10px;
