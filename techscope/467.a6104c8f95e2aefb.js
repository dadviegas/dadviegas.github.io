"use strict";(self.webpackChunk_atlantis_techscope=self.webpackChunk_atlantis_techscope||[]).push([["467"],{5748(e,o,a){a.d(o,{W:()=>oZ});var n=a(5723),t=a(9336),i=a(7991),r=a.n(i),l=a(6859),s=a.n(l),d=a(8641),c=a(9522),p=a(2799),m=a(5569),g=a(9421),u=a(8170);let f=(0,p.keyframes)`
  0%, 100% { opacity: 1; }
  50% { opacity: 0.3; }
`,x=(0,p.keyframes)`
...
`;function k({title:e,color:o,description:a,lastUpdated:t,loading:i,onRefresh:r,t:l}){let s,d=t?l?(0,u.lw)(t,l):(s=Math.floor((Date.now()-t.getTime())/6e4))<1?"just now":s<60?`${s}m ago`:`${Math.floor(s/60)}h ago`:null,c=d?l?l("updated",{age:d}):`updated ${d}`:null;return(0,n.jsxs)(h,{children:[(0,n.jsxs)(y,{children:[(0,n.jsx)(w,{color:o}),(0,n.jsx)(b,{children:e}),a&&(0,n.jsxs)($,{children:[(0,n.jsx)(m.A,{size:13}),(0,n.jsx)(v,{children:a})]})]}),c&&(0,n.jsx)(z,{children:c}),(0,n.jsx)(j,{spinning:i,onClick:r,title:l?l("refresh"):"Refresh",children:(0,n.jsx)(g.A,{size:13})})]})}let A="#3fb950",S={TypeScript:"#3178c6",JavaScript:"#f1e05a",Python:"#3572A5",Go:"#00ADD8",Rust:"#dea584",Java:"#b07219","C++":"#f34b7d","C#":"#178600",Ruby:"#701516",Swift:"#F05138",Kotlin:"#A97BFF",Shell:"#89e051",HTML:"#e34c26",CSS:"#563d7c",Dart:"#00B4AB",Zig:"#ec915c",Nix:"#7e7eff",Lua:"#000080","Jupyter Notebook":"#DA5B0B"},M=s().div`
  display: grid;
...
`,eh=s().div`
  ...
  font-size: ${t.w4.typography.fontSizeSm};
  text-align: center;
`;function ey({t:e}){let{data:o,loading:a,lastUpdated:t,refresh:i}=(0,c.st)("https://hn.algolia.com/api/v1/search?tags=front_page&hitsPerPage=12"),r=o?.hits??[];return(0,n.jsxs)("div",{children:[(0,n.jsx)(k,{title:e("nav.todayInTech"),color:er,lastUpdated:t,loading:a,onRefresh:i,t:e}),r.length?(0,n.jsx)(el,{children:r.map((e,o)=>{let a=e.url??`https://news.ycombinator.com/item?id=${e.objectID}`;return(0,n.jsx)(es,{children:(0,n.jsxs)(ed,{href:a,target:"_blank",rel:"noopener noreferrer",children:[(0,n.jsxs)(ec,{children:[o+1,"."]}),(0,n.jsxs)(ep,{children:[(0,n.jsx)(em,{children:e.title}),(0,n.jsxs)(eg,{children:[(0,n.jsxs)(eu,{children:[(0,n.jsx)(et.A,{size:11}),e.points??0]}),(0,n.jsxs)(ef,{children:[(0,n.jsx)(ei.A,{size:11}),e.num_comments??0]}),(0,n.jsx)(ex,{children:(0,c.FB)(e.url)})]})]})]})},e.objectID)})}):(0,n.jsx)(eh,{children:e(a?"todayInTech.loading":"todayInTech.empty")})]})}var ew=a(2743);let eb="#58a6ff",ez=s().div`
  display: flex;
  flex-direction: column;
  gap: 2px;
`,e$=s().a`
  ...
  border: 1px solid ${eb}18;
  border-radius: ${t.w4.borderRadius.sm};
  background: linear-gradient(165deg, ${eb}0b 0%, ${t.w4.colors.surface} 55%, ${t.w4.colors.surface} 100%);
  text-decoration: none;
  transition: background 0.2s, border-color 0.2s, transform 0.2s;

  &:hover {
    background: linear-gradient(165deg, ${eb}14 0%, ${t.w4.colors.surfaceRaised} 55%, ${t.w4.colors.surfaceRaised} 100%);
    border-color: ${eb}5c;
    transform: translateX(2px);
  }
`,ev=s().div`
...
`,eP=s().div`
  ...
  background: ${eb}2a;
  margin: 2px 0;
`;function eB({t:e}){let o=Math.floor((Date.now()-1728e5)/1e3),a=`https://hn.algolia.com/api/v1/search?query=AI+LLM+model+open+source&tags=story&hitsPerPage=8&numericFilters=created_at_i>${o}`,{data:t,loading:i,lastUpdated:l,refresh:s}=(0,c.st)(a),d=t?.hits??[];return(0,n.jsxs)("div",{children:[(0,n.jsx)(k,{title:e("nav.aiRadar"),color:eb,lastUpdated:l,loading:i,onRefresh:s,t:e}),d.length?(0,n.jsx)(ez,{children:d.map((o,a)=>{let t=o.url??`https://news.ycombinator.com/item?id=${o.objectID}`;return(0,n.jsxs)(r().Fragment,{children:[a>0&&(0,n.jsx)(eP,{}),(0,n.jsxs)(e$,{href:t,target:"_blank",rel:"noopener noreferrer",children:[(0,n.jsxs)(ev,{children:[(0,n.jsx)(ej,{children:(0,n.jsx)(ew.A,{size:12})}),o.title]}),(0,n.jsxs)(ek,{children:[(0,n.jsxs)(eA,{children:[(0,n.jsx)(et.A,{size:11}),o.points??0]}),(0,n.jsxs)(eS,{children:[(0,n.jsx)(ei.A,{size:11}),o.num_comments??0]}),(0,n.jsx)(eM,{children:(0,c.FB)(o.url)}),(0,n.jsx)("span",{style:{marginLeft:"auto"},children:(0,u.aw)(o.created_at,e)})]})]})]},o.objectID)})}):(0,n.jsx)(eT,{children:i?e("aiRadar.loading"):e("aiRadar.empty")})]})}let eF="#ff6314",eR=[{id:"webdev",label:"webdev",query:"web frontend css html"},{id:"javascript",label:"JavaScript",query:"javascript node npm"},{id:"rust",label:"Rust",query:"rust lang cargo"},{id:"python",label:"Python",query:"python django fastapi"},{id:"devops",label:"DevOps",query:"docker kubernetes devops cloud"}],eD=s().div`
  display: flex;
  gap: 6px;
  margin-bottom: ${t.w4.spacing.lg};
  flex-wrap: wrap;
...
`,oB=s().div`
  ...
  font-size: ${t.w4.typography.fontSizeSm};
  text-align: center;
`;function oF(){let[e,o]=(0,i.useState)(oh[0].id),a=`https://dev.to/api/articles?tag=${e}&top=7&per_page=8`,{data:t,loading:r,lastUpdated:l,refresh:s}=(0,c.st)(a),d=t??[];return(0,n.jsxs)("div",{children:[(0,n.jsx)(k,{title:"Tech Articles",color:ox,description:"Popular articles from Dev.to across frontend, AI, and systems topics.",lastUpdated:l,loading:r,onRefresh:s}),(0,n.jsx)(ow,{children:oh.map(a=>(0,n.jsxs)(ob,{active:e===a.id,onClick:()=>o(a.id),children:["#",a.label]},a.id))}),d.length?(0,n.jsx)(oy,{children:d.map(e=>(0,n.jsxs)(oz,{href:e.url,target:"_blank",rel:"noopener noreferrer",children:[(0,n.jsx)(o$,{children:e.title}),e.description&&(0,n.jsx)(ov,{children:e.description}),e.tag_list.length>0&&(0,n.jsx)(oj,{children:e.tag_list.slice(0,3).map(e=>(0,n.jsxs)(ok,{children:["#",e]},e))}),(0,n.jsxs)(oA,{children:[(0,n.jsxs)(oS,{children:[(0,n.jsx)(og.A,{size:11}),(0,c.aT)(e.public_reactions_count)]}),(0,n.jsxs)(oM,{children:[(0,n.jsx)(ei.A,{size:11}),e.comments_count]}),(0,n.jsxs)(oT,{children:[(0,n.jsx)(ou.A,{size:10}),e.user.name]}),(0,n.jsxs)(oP,{children:[(0,n.jsx)(of.A,{size:11}),e.reading_time_minutes,"m"]})]})]},e.id))}):(0,n.jsx)(oB,{children:r?"Loading articles...":"No articles found"})]})}var oR=a(140);let oD="#f48024",oC=[{id:"",label:"All"},{id:"javascript",label:"JS"},{id:"typescript",label:"TS"},{id:"python",label:"Python"},{id:"react",label:"React"}],oE=s().div`
  display: flex;
  gap: 6px;
  margin-bottom: ${t.w4.spacing.lg};
  flex-wrap: wrap;
...
`,oJ=s().div`
  ...
  font-size: ${t.w4.typography.fontSizeSm};
  text-align: center;
`;function oU(){let[e,o]=(0,i.useState)(""),a=e?`&tagged=${e}`:"",t=`https://api.stackexchange.com/2.3/questions?order=desc&sort=hot&site=stackoverflow&pagesize=10&filter=default${a}`,{data:r,loading:l,lastUpdated:s,refresh:d}=(0,c.st)(t),p=r?.items??[];return(0,n.jsxs)("div",{children:[(0,n.jsx)(k,{title:"Dev Pulse",color:oD,description:"Hot questions from Stack Overflow sorted by activity, filterable by language or framework.",lastUpdated:s,loading:l,onRefresh:d}),(0,n.jsx)(oE,{children:oC.map(a=>(0,n.jsx)(oL,{active:e===a.id,onClick:()=>o(a.id),children:a.label},a.id))}),p.length?(0,n.jsx)(oI,{children:p.map(e=>{let o=new Date(1e3*e.creation_date).toISOString();return(0,n.jsxs)(o_,{href:e.link,target:"_blank",rel:"noopener noreferrer",children:[(0,n.jsx)(oN,{answered:e.is_answered,children:e.is_answered?"✓":"?"}),(0,n.jsxs)(oH,{children:[(0,n.jsx)(oK,{children:(0,c.iT)(e.title)}),(0,n.jsxs)(oG,{children:[(0,n.jsxs)(oV,{negative:e.score<0,children:[e.score>0?"+":"",(0,c.aT)(e.score)," votes"]}),(0,n.jsxs)("span",{children:[e.answer_count," ans"]}),(0,n.jsxs)(oY,{children:[(0,n.jsx)(oR.A,{size:10}),(0,c.aT)(e.view_count)]}),(0,n.jsx)(oO,{children:e.tags.slice(0,3).map(e=>(0,n.jsx)(oq,{children:e},e))}),(0,n.jsx)(oW,{children:(0,c.fF)(o)})]})]})]},e.question_id)})}):(0,n.jsx)(oJ,{children:l?"Fetching hot questions...":"No questions found"})]})}function oZ({category:e,t:o}){return(0,n.jsxs)(t.wi,{children:["github"===e&&(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(t.KW,{id:"live-pulse",children:(0,n.jsx)(t.PH,{children:(0,n.jsx)(I,{t:o})})}),(0,n.jsx)(t.KW,{id:"experiment-zone",children:(0,n.jsx)(t.PH,{children:(0,n.jsx)(en,{t:o})})})]}),"hackernews"===e&&(0,n.jsxs)(n.Fragment,{children:[(0,n.jsxs)(t.pB,{children:[(0,n.jsx)(t.KW,{id:"today-in-tech",children:(0,n.jsx)(t.PH,{style:{height:"100%"},children:(0,n.jsx)(ey,{t:o})})}),(0,n.jsx)(t.KW,{id:"ai-radar",children:(0,n.jsx)(t.PH,{style:{height:"100%"},children:(0,n.jsx)(eB,{t:o})})})]}),(0,n.jsx)(t.KW,{id:"community-feed",children:(0,n.jsx)(t.PH,{children:(0,n.jsx)(eW,{})})})]}),"packages"===e&&(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(t.KW,{id:"package-radar",children:(0,n.jsx)(t.PH,{children:(0,n.jsx)(oa,{})})}),(0,n.jsx)(t.KW,{id:"npm-trends",children:(0,n.jsx)(t.PH,{children:(0,n.jsx)(om,{t:o})})})]}),"devcommunity"===e&&(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(t.KW,{id:"tech-articles",children:(0,n.jsx)(t.PH,{children:(0,n.jsx)(oF,{})})}),(0,n.jsx)(t.KW,{id:"dev-pulse",children:(0,n.jsx)(t.PH,{children:(0,n.jsx)(oU,{})})})]})]})}},8108(e,o,a){a.d(o,{A:()=>ed});var n=a(5723),t=a(7991),i=a(6859),r=a.n(i),l=a(2799),s=a(7230),d=a(8641),c=a(2743),p=a(9753),m=a(9336),g=a(9522);let u=(0,l.keyframes)`
...
`,b=r().span`
  ...
  color: ${({color:e})=>e};
  text-align: right;
`;function z({bars:e}){let o=Math.max(...e.map(e=>e.value),1);return(0,n.jsx)(f,{children:e.map((e,a)=>(0,n.jsxs)(x,{children:[(0,n.jsx)(h,{children:e.label}),(0,n.jsx)(y,{children:(0,n.jsx)(w,{pct:Math.round(e.value/o*100),color:e.color,delay:.1*a})}),(0,n.jsx)(b,{color:e.color,children:e.value})]},e.label))})}let $=[{id:"github",label:"GitHub",color:"#3fb950",panels:["live-pulse","experiment-zone"],desc:"Trending repos & rising projects"},{id:"hackernews",label:"Hacker News",color:"#ff6600",panels:["today-in-tech","ai-radar","community-feed"],desc:"Front page, AI & community"},{id:"packages",label:"Packages",color:"#cb3837",panels:["package-radar","npm-trends"],desc:"npm search & download stats"},{id:"devcommunity",label:"Dev Community",color:"#7c3aed",panels:["tech-articles","dev-pulse"],desc:"Articles & hot questions"}],v=(0,l.keyframes)`
  0%, 100% { opacity: 1; }
  50% { opacity: 0.4; }
`,j=(0,l.keyframes)`
...
`},8859(e,o,a){a.d(o,{FlyoutPanel:()=>w});var n=a(5723),t=a(7991),i=a.n(t),r=a(6859),l=a.n(r),s=a(2799),d=a(255),c=a(1316),p=a(814),m=a(6140);let g=(0,s.keyframes)`
...
`;function h({iconKey:e}){let o=e?m.t[e]??d.A:d.A;return(0,n.jsx)(o,{size:14,strokeWidth:1.75})}function y({entries:e,activeId:o,onSelect:a}){return(0,n.jsx)(n.Fragment,{children:e.map(e=>e.children?(0,n.jsx)(i().Fragment,{children:(0,n.jsx)(y,{entries:e.children,activeId:o,onSelect:a})},e.id):(0,n.jsxs)(x,{active:o===e.id,onClick:()=>a(e),children:[(0,n.jsx)(h,{iconKey:e.icon}),e.name]},e.id))})}function w({activeId:e}){let{flyout:o,scheduleFlyoutClose:a,cancelFlyoutClose:t}=(0,p.c)();if(!o)return null;let i=o.entry.icon?m.t[o.entry.icon]??d.A:d.A;return(0,n.jsxs)(u,{anchorY:o.anchorY,onMouseEnter:t,onMouseLeave:a,children:[(0,n.jsxs)(f,{children:[(0,n.jsx)(i,{size:13,strokeWidth:2}),o.entry.name]}),(0,n.jsx)(y,{entries:o.entry.children??[],activeId:e,onSelect:e=>{o.onSelect(e),a()}})]})}},814(e,o,a){a.d(o,{I:()=>t,c:()=>i});var n=a(7991);let t=(0,n.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),i=()=>(0,n.useContext)(t)},6140(e,o,a){a.d(o,{t:()=>ey});var n=a(6896),t=a(7902),i=a(3013),r=a(2887),l=a(9510),s=a(9848),d=a(7901),c=a(3045),p=a(3775),m=a(1783),g=a(3539),u=a(9416),f=a(1837),x=a(7167),h=a(4494),y=a(2314),w=a(255),b=a(5751),z=a(9633),$=a(2946),v=a(822),j=a(6720),k=a(7400),A=a(8456),S=a(3317),M=a(2709),T=a(8006),P=a(9301),B=a(7561),F=a(3517),R=a(8207),D=a(7032),C=a(6949),E=a(8218),L=a(6829),I=a(9591),_=a(5553),N=a(9923),H=a(2820),K=a(4621),G=a(8479),V=a(2534),Y=a(6673),O=a(7490),q=a(9033),W=a(9038),J=a(5775),U=a(1365),Z=a(2937),X=a(9821),Q=a(5912),ee=a(158),eo=a(8641),ea=a(8607),en=a(3249),et=a(1821),ei=a(5889),er=a(9655),el=a(7170),es=a(9161),ed=a(1849),ec=a(1604),ep=a(3142),em=a(1187),eg=a(7747),eu=a(2932),ef=a(4525),ex=a(7230),eh=a(2164);let ey={activity:n.A,"a-large-small":t.A,apple:i.A,"arrow-right":r.A,"bar-chart-2":l.A,book:s.A,"book-open":d.A,briefcase:c.A,calendar:p.A,clock:m.A,"circle-dot":g.A,cloud:u.A,compass:f.A,cpu:x.A,droplets:h.A,feather:y.A,file:w.A,"file-text":b.A,folder:z.A,"git-branch":$.A,github:v.A,globe:j.A,grid:k.A,hand:A.A,hash:S.A,heart:M.A,key:T.A,hexagon:P.A,home:B.A,landmark:F.A,layers:R.A,"layout-grid":D.A,leaf:C.A,lightbulb:E.A,list:L.A,map:I.A,"map-pin":_.A,"message-circle":N.A,"message-square":H.A,minus:K.A,monitor:G.A,mountain:V.A,package:Y.A,palette:O.A,"pen-tool":q.A,"pie-chart":W.A,plane:J.A,plus:U.A,ruler:Z.A,shirt:X.A,slash:Q.A,square:ee.A,star:eo.A,sun:ea.A,terminal:en.A,thermometer:et.A,triangle:ei.A,trophy:er.A,truck:el.A,type:es.A,users:ed.A,"volume-2":ec.A,watch:ep.A,waves:em.A,wind:eg.A,wrench:eu.A,x:ef.A,zap:ex.A,bot:eh.A}},9336(e,o,a){a.d(o,{w4:()=>n.w4,CD:()=>Y,Is:()=>Z,pB:()=>ea,wi:()=>Q,PH:()=>eo,KW:()=>ee,PE:()=>P,PL:()=>X});var n=a(1316),t=a(5723),i=a(7991),r=a.n(i),l=a(6859),s=a.n(l);s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,s().div`
  position: relative;
`;var d=a(2799),c=a(3661),p=a(814);let m="260px",g="56px",u=s().header`
  display: flex;
  align-items: center;
...
`,A=s().main`
  ...
  display: flex;
  flex-direction: column;
`,S=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function M(){return(0,t.jsx)(y,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:S.map((e,o)=>(0,t.jsx)(w,{index:o,accent:e.accent,children:e.char},o))})}let T="atlantis:sidebar-collapsed";function P({sidebar:e,children:o,topBarRight:n,title:l="Atlantis",activeId:s=null}){let[d,m]=(0,i.useState)(()=>{try{return"true"===localStorage.getItem(T)}catch{return!1}}),[g,h]=(0,i.useState)(null),y=(0,i.useRef)(),w=()=>m(e=>{let o=!e;try{localStorage.setItem(T,String(o))}catch{}return o}),S=r().useMemo(()=>r().lazy(()=>Promise.resolve().then(a.bind(a,8859)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,t.jsx)(p.I.Provider,{value:{collapsed:d,toggle:w,flyout:g,openFlyout:(e,o,a)=>{clearTimeout(y.current),h({entry:e,anchorY:o,onSelect:a})},scheduleFlyoutClose:()=>{y.current=setTimeout(()=>h(null),160)},cancelFlyoutClose:()=>clearTimeout(y.current)},children:(0,t.jsxs)(v,{children:[(0,t.jsxs)(u,{children:[e&&(0,t.jsx)(f,{children:(0,t.jsx)(x,{onClick:w,title:d?"Expand sidebar":"Collapse sidebar",children:(0,t.jsx)(c.A,{size:17})})}),(0,t.jsx)(M,{}),l&&(0,t.jsx)(b,{children:l}),n&&(0,t.jsx)(z,{children:n})]}),(0,t.jsxs)($,{children:[null!=e&&(0,t.jsx)(j,{collapsed:d,children:(0,t.jsx)(k,{children:e})}),(0,t.jsx)(A,{children:o})]}),g&&(0,t.jsx)(r().Suspense,{fallback:null,children:(0,t.jsx)(S,{activeId:s})})]})})}var B=a(255),F=a(9753),R=a(6140);let D=s().div`
  display: grid;
...
`;function G({iconKey:e,size:o=16}){if(e&&!(e in R.t))return(0,t.jsx)("span",{style:{fontSize:o,lineHeight:1,display:"flex",alignItems:"center"},children:e});let a=e?R.t[e]??B.A:B.A;return(0,t.jsx)(a,{size:o,strokeWidth:1.75})}function V({entry:e,activeId:o,onSelect:a}){let[n,r]=(0,i.useState)(e.defaultOpen??!0),{collapsed:l,openFlyout:s,scheduleFlyoutClose:d,cancelFlyoutClose:c}=(0,p.c)();return e.children&&e.children.length>0?(0,t.jsxs)(L,{children:[(0,t.jsxs)(I,{collapsed:l,onClick:()=>{l||r(e=>!e)},onMouseEnter:l?o=>{s(e,o.currentTarget.getBoundingClientRect().top,a)}:void 0,onMouseLeave:l?d:void 0,children:[(0,t.jsxs)(_,{collapsed:l,children:[(0,t.jsx)(G,{iconKey:e.icon,size:16}),(0,t.jsx)(N,{collapsed:l,children:e.name})]}),(0,t.jsx)(H,{open:n,collapsed:l,children:(0,t.jsx)(F.A,{size:13})})]}),(0,t.jsx)(D,{open:n&&!l,children:(0,t.jsx)(C,{children:(0,t.jsx)(E,{children:e.children.map(e=>(0,t.jsx)(V,{entry:e,activeId:o,onSelect:a},e.id))})})})]}):(0,t.jsxs)(K,{active:o===e.id,collapsed:l,onClick:()=>a(e),onMouseEnter:l?o=>{let n=o.currentTarget.getBoundingClientRect();s({id:e.id,name:e.name,icon:e.icon,file:e.file,children:[e]},n.top,a)}:void 0,onMouseLeave:l?d:void 0,children:[(0,t.jsx)(G,{iconKey:e.icon,size:15}),(0,t.jsx)(N,{collapsed:l,children:e.name})]})}function Y({entries:e,activeId:o,onSelect:a}){return(0,t.jsx)("div",{children:e.map(e=>(0,t.jsx)(V,{entry:e,activeId:o,onSelect:a},e.id))})}let O=(0,d.keyframes)`
