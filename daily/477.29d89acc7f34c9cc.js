"use strict";(self.webpackChunk_atlantis_daily=self.webpackChunk_atlantis_daily||[]).push([["477"],{5198(e,o,t){t.d(o,{R:()=>m});var r=t(5723),a=t(7991),i=t(6859),n=t.n(i),l=t(2799),s=t(6063),d=t(1275);let p=t(8085).default.color,c=(0,l.keyframes)`
...
`,h=n().div`
  ...
  padding: ${s.w4.spacing.lg} ${s.w4.spacing.md};
...
`,w=i().forwardRef(function({variant:e="ghost",size:o="md",icon:t,iconRight:a,children:i,...n},l){return(0,r.jsxs)(m,{ref:l,variant:e,size:o,...n,children:[t,i,a]})}),u={default:s.w4.colors.accent,danger:"#f85149"},y={default:s.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"},$=l().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`;let S={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:s.w4.colors.accentMuted},H={neutral:s.w4.colors.mainTextMuted,live:s.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:s.w4.colors.accent};l().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${s.w4.typography.fontFamilyMono};
...
`;let R=l().div`
  ...
  align-items: center;
  gap: 8px;
`;function C({children:e,...o}){return(0,r.jsx)(R,{...o,children:e})}l().label`
  display: flex;
  align-items: center;
  gap: 10px;
...
`,eg=l().main`
  ...
  display: flex;
  flex-direction: column;
`;function eh(){return(0,r.jsxs)(er,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:[(0,r.jsx)(ea,{"aria-hidden":"true",children:"A"}),(0,r.jsx)(ei,{children:"Atlantis"})]})}let ex="atlantis:sidebar-collapsed";function ef({sidebar:e,children:o,topBarRight:n,title:l="Atlantis",activeId:s=null}){let[d,p]=(0,a.useState)(()=>{try{return"true"===localStorage.getItem(ex)}catch{return!1}}),[c,g]=(0,a.useState)(null),h=(0,a.useRef)(),x=()=>p(e=>{let o=!e;try{localStorage.setItem(ex,String(o))}catch{}return o}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(t.bind(t,5816)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(I.I.Provider,{value:{collapsed:d,toggle:x,flyout:c,openFlyout:(e,o,t)=>{clearTimeout(h.current),g({entry:e,anchorY:o,onSelect:t})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,r.jsxs)(ed,{children:[(0,r.jsxs)(ee,{children:[e&&(0,r.jsx)(eo,{children:(0,r.jsx)(et,{onClick:x,title:d?"Expand sidebar":"Collapse sidebar",children:(0,r.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,r.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,r.jsx)("path",{d:"M9 3v18"})]})})}),(0,r.jsx)(eh,{}),l&&(0,r.jsx)(en,{children:l}),n&&(0,r.jsx)(el,{children:n})]}),(0,r.jsxs)(es,{children:[null!=e&&(0,r.jsx)(ep,{collapsed:d,children:(0,r.jsx)(ec,{children:e})}),(0,r.jsx)(eg,{children:o})]}),c&&(0,r.jsx)(i().Suspense,{fallback:null,children:(0,r.jsx)(f,{activeId:s})})]})})}l().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
