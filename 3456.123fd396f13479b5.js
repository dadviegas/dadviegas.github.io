...
`,d=r().div`
  ...
  opacity: 0.7;
  transition: width 400ms ease;
`;function c({pct:e,over:t=0,color:a="#7fb77e"}){let o=Math.min(100,e),r=100-t;return(0,i.jsxs)(s,{children:[(0,i.jsx)(l,{pct:o,color:a}),t>0&&(0,i.jsx)(d,{left:Math.max(0,r),width:t})]})}},9391(e,t,a){a.d(t,{O:()=>n});var i=a(65723);a(37991);var o=a(80884);let r={sm:20,md:24,lg:28};function n({member:e,size:t="md"}){let a="number"==typeof t?t:r[t];return(0,i.jsx)(o.eu,{member:e,size:a})}},64392(e,t,a){a.d(t,{$:()=>m});var i=a(65723),o=a(36859),r=a.n(o),n=a(6063);let s=r().div`
  display: flex;
  align-items: baseline;
  justify-content: space-between;
  gap: ${n.w4.spacing.sm};
...
`,c={loading:"◌ Loading",empty:"◎ Empty",error:"◎ Offline"};function p({mode:e,label:t,body:a}){return(0,i.jsxs)(s,{children:[(0,i.jsx)(l,{mode:e,children:t??c[e]}),a&&(0,i.jsx)(d,{children:a})]})}},64443(e,t,a){a.d(t,{YG:()=>i.Y});var i=a(85043);a(65723),a(37991);var o=a(6063),r=a(36859),n=a.n(r);n().span`
  ...
  white-space: nowrap;
`,a(64392),a(83090),a(74170),a(9391),n().button`
  display: inline-flex;
  align-items: center;
  gap: 6px;
  padding: 0 10px;
