...
`,er=l().div`
  ...
  color: ${d.w4.colors.sidebarTextMuted};
  font-family: ${d.w4.typography.fontFamily};
`;function ei({onSave:e,onUpdate:o,onCancel:a,existingDoc:i}){let[n,l]=(0,r.useState)(i?.name??""),d=(0,r.useRef)(null);return(0,r.useEffect)(()=>{d.current?.focus(),i&&d.current?.select()},[i]),(0,t.jsx)(Z,{onClick:a,children:(0,t.jsxs)(X,{onClick:e=>e.stopPropagation(),children:[(0,t.jsx)(Q,{children:"Save document"}),i&&o&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(er,{children:"Update the current version or save as a new one."}),(0,t.jsxs)(eo,{children:[(0,t.jsx)(ea,{onClick:a,children:"Cancel"}),(0,t.jsxs)(ea,{danger:!0,onClick:o,children:['Update "',i.name,'"']})]}),(0,t.jsx)(et,{})]}),(0,t.jsx)(ee,{ref:d,value:n,onChange:e=>l(e.target.value),onKeyDown:t=>{"Enter"===t.key&&n.trim()&&(i&&n.trim()===i.name&&o?o():e(n.trim())),"Escape"===t.key&&a()},placeholder:i?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,t.jsxs)(eo,{children:[!i&&(0,t.jsx)(ea,{onClick:a,children:"Cancel"}),(0,t.jsx)(ea,{primary:!0,disabled:!n.trim(),onClick:()=>e(n.trim()),children:"Save as new"})]})]})})}let en=(0,y.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,el=(0,y.keyframes)`
...
`;l().div`
  ...
  background: ${d.w4.colors.mainBg};
  font-family: ${d.w4.typography.fontFamily};
  animation: ${ed} 0.4s ease 0.15s both;
`,l().div`
  position: relative;
  width: 56px;
  height: 56px;
...
`,l().div`
  position: relative;
`;let ep="260px",eg="56px",eh="44px",em=l().header`
  display: flex;
  align-items: center;
  height: calc(${eh} + env(safe-area-inset-top, 0px));
  padding-top: env(safe-area-inset-top, 0px);
  ...
  @media (max-width: ${d.w4.breakpoints.md}) {
    flex-wrap: wrap;
    height: auto;
    min-height: calc(${eh} + env(safe-area-inset-top, 0px));
  }
`,ef=l().div`
  width: ${eg};
  min-width: ${eg};
...
`,eA=l().main`
  ...
  display: flex;
  flex-direction: column;
`;function eT(){return(0,t.jsxs)(eu,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:[(0,t.jsx)(eb,{"aria-hidden":"true",children:"A"}),(0,t.jsx)(ey,{children:"Atlantis"})]})}let eS="atlantis:sidebar-collapsed";function ej({sidebar:e,children:o,topBarRight:n,title:l="Atlantis",activeId:d=null}){let[s,c]=(0,r.useState)(()=>{try{return"true"===localStorage.getItem(eS)}catch{return!1}}),[p,g]=(0,r.useState)(null),h=(0,r.useRef)(),m=()=>c(e=>{let o=!e;try{localStorage.setItem(eS,String(o))}catch{}return o}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(a.bind(a,5816)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,t.jsx)(N.I.Provider,{value:{collapsed:s,toggle:m,flyout:p,openFlyout:(e,o,a)=>{clearTimeout(h.current),g({entry:e,anchorY:o,onSelect:a})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,t.jsxs)(ez,{children:[(0,t.jsxs)(em,{children:[e&&(0,t.jsx)(ef,{children:(0,t.jsx)(ex,{onClick:m,title:s?"Expand sidebar":"Collapse sidebar",children:(0,t.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("path",{d:"M9 3v18"})]})})}),(0,t.jsx)(eT,{}),l&&(0,t.jsx)(ew,{children:l}),n&&(0,t.jsx)(ev,{children:n})]}),(0,t.jsxs)(e$,{children:[null!=e&&(0,t.jsx)(eM,{collapsed:s,children:(0,t.jsx)(ek,{children:e})}),(0,t.jsx)(eA,{children:o})]}),p&&(0,t.jsx)(i().Suspense,{fallback:null,children:(0,t.jsx)(f,{activeId:d})})]})})}l().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
