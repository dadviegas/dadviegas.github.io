"use strict";(self.webpackChunk_atlantis_pad=self.webpackChunk_atlantis_pad||[]).push([["3499"],{53804(o,e,a){a.d(e,{M:()=>u});var t=a(65723);a(37991);var r=a(36859),i=a.n(r),n=a(51530),l=a(15496),s=a(23930);let d=i().div`
  display: flex;
  ...
  transition: flex ${s.w4.transitions.slow},
              min-width ${s.w4.transitions.slow};
  position: relative;
`,c=i().div`
  display: flex;
  align-items: center;
...
`,f=i().button`
  ...
  cursor: pointer;
  color: ${s.w4.colors.sidebarTextMuted};
  transition: color ${s.w4.transitions.fast}, background ${s.w4.transitions.fast};
  z-index: 10;
...
`;function u({value:o,onChange:e,collapsed:a,onToggleCollapse:r,scrollRef:i,onScroll:s}){return a?(0,t.jsx)("div",{style:{position:"relative",flexShrink:0},children:(0,t.jsxs)(f,{onClick:r,title:"Show editor",children:[(0,t.jsx)(n.A,{size:14}),(0,t.jsx)(x,{children:"Editor"})]})}):(0,t.jsxs)(d,{collapsed:!1,children:[(0,t.jsxs)(c,{children:[(0,t.jsx)(p,{children:"Editor"}),(0,t.jsx)(g,{onClick:r,title:"Collapse editor",children:(0,t.jsx)(l.A,{size:15})})]}),(0,t.jsx)(m,{ref:i,value:o,onChange:o=>e(o.target.value),onScroll:s,placeholder:"Write markdown here…",spellCheck:!1})]})}},7279(o,e,a){a.d(e,{H:()=>b});var t=a(65723),r=a(37991),i=a(36859),n=a.n(i),l=a(37901),s=a(70679),d=a(23930);let c=[{id:"showcase",label:"Full Showcase",description:"All supported features in one document",content:`# Markdown Editor — Feature Showcase
...
`}],p=n().button`
  ...
  cursor: pointer;
  transition: background ${d.w4.transitions.base}, border-color ${d.w4.transitions.base};
  white-space: nowrap;
...
`,x=n().div`
  position: relative;
`;function u({onSelect:o}){let[e,a]=(0,r.useState)(!1),i=(0,r.useRef)(null);return(0,r.useEffect)(()=>{if(!e)return;let o=o=>{i.current&&!i.current.contains(o.target)&&a(!1)};return document.addEventListener("mousedown",o),()=>document.removeEventListener("mousedown",o)},[e]),(0,t.jsxs)(x,{ref:i,children:[(0,t.jsxs)(p,{onClick:()=>a(o=>!o),children:[(0,t.jsx)(l.A,{size:14}),"Examples",(0,t.jsx)(s.A,{size:13,style:{marginLeft:2}})]}),(0,t.jsxs)(g,{open:e,children:[(0,t.jsx)(m,{children:"Load a diagram"}),c.map(e=>(0,t.jsx)(f,{onClick:()=>{o(e.code),a(!1)},children:e.label},e.label))]})]})}},65320(o,e,a){a.d(e,{u:()=>$});var t=a(65723),r=a(37991),i=a(36859),n=a.n(i),l=a(49881),s=a(13045),d=a(52534),c=a(23930),p=a(29738);p.default.initialize({startOnLoad:!1,theme:"dark",securityLevel:"loose"});let g=`
...
`,y=n().span`
  ...
  font-family: ${c.w4.typography.fontFamily};
  writing-mode: vertical-rl;
`;function $({code:o,collapsed:e,onToggleCollapse:a}){let[i,n]=(0,r.useState)(""),[c,g]=(0,r.useState)(null),v=(0,r.useRef)(0),z=(0,r.useCallback)(async o=>{if(!o.trim()){n(""),g(null);return}let e=++v.current;try{let a="mermaid-"+Date.now(),{svg:t}=await p.default.render(a,o);v.current===e&&(n(t),g(null))}catch(o){v.current===e&&(g(o instanceof Error?o.message:String(o)),n(""))}},[]);return((0,r.useEffect)(()=>{let e=setTimeout(()=>z(o),300);return()=>clearTimeout(e)},[o,z]),e)?(0,t.jsxs)(w,{onClick:a,title:"Show preview",children:[(0,t.jsx)(l.A,{size:14}),(0,t.jsx)(y,{children:"Preview"})]}):(0,t.jsxs)(m,{children:[(0,t.jsxs)(f,{children:[(0,t.jsx)(x,{children:"Preview"}),(0,t.jsx)(u,{onClick:a,title:"Collapse preview",children:(0,t.jsx)(s.A,{size:15})})]}),c&&(0,t.jsxs)(b,{children:[(0,t.jsx)(d.A,{size:14,style:{flexShrink:0,marginTop:1}}),c]}),(0,t.jsx)(h,{dangerouslySetInnerHTML:{__html:i}})]})}},2099(o,e,a){a.d(e,{r:()=>k});var t=a(65723);a(37991);var r=a(11352),i=a(76710),n=a(4311),l=a(73639),s=a(8411);a(75406);var d=a(36859),c=a.n(d),p=a(49881),g=a(13045),m=a(23930),f=a(49685);function x(){return o=>{!function o(e){if("blockquote"===e.type){let o=e.children?.[0];if(o?.type==="paragraph"){let a=o.children?.[0];if(a?.type==="text"){let t=a.value?.match(/^\[!(NOTE|TIP|WARNING|CAUTION|IMPORTANT)\]\s*/i);t&&(a.value=a.value.slice(t[0].length),a.value.trim()||1!==o.children.length||e.children.shift(),e.data=e.data??{},e.data.hName="div",e.data.hProperties={"data-callout":t[1].toUpperCase()})}}}e.children?.forEach(o)}(o)}}let u=c().div`
  display: flex;
  flex-direction: column;
  flex: 1;
  min-width: 0;
...
`,v=c().button`
  ...
  cursor: pointer;
  color: ${m.w4.colors.sidebarTextMuted};
  transition: color ${m.w4.transitions.fast}, background ${m.w4.transitions.fast};
  align-self: center;
...
`,z=c().span`
  ...
  font-family: ${m.w4.typography.fontFamily};
  writing-mode: vertical-rl;
`;function k({content:o,collapsed:e,onToggleCollapse:a,scrollRef:d,onScroll:c}){return e?(0,t.jsxs)(v,{onClick:a,title:"Show preview",children:[(0,t.jsx)(p.A,{size:14}),(0,t.jsx)(z,{children:"Preview"})]}):(0,t.jsxs)(u,{children:[(0,t.jsxs)(h,{children:[(0,t.jsx)(b,{children:"Preview"}),(0,t.jsx)(w,{onClick:a,title:"Collapse preview",children:(0,t.jsx)(g.A,{size:15})})]}),(0,t.jsx)(y,{ref:d,onScroll:c,children:(0,t.jsx)($,{children:(0,t.jsx)(r.oz,{remarkPlugins:[i.A,n.A,x],rehypePlugins:[l.A,s.A],components:{div({node:o,children:e,...a}){let r=a["data-callout"];return r?(0,t.jsx)("div",{"data-callout":r,children:e}):(0,t.jsx)("div",{...a,children:e})},pre:({children:o})=>(0,t.jsx)(t.Fragment,{children:o}),code({className:o,children:e}){let a=/language-(\w+)/.exec(o??"")?.[1],r=String(e).replace(/\n$/,"");return"mermaid"===a?(0,t.jsx)(f.t,{code:r}):"chart"===a?(0,t.jsx)(f.MX,{code:r}):"clock"===a?(0,t.jsx)(f.sc,{code:r}):a||r.includes("\n")?(0,t.jsx)(f.NG,{lang:a,code:r}):(0,t.jsx)("code",{className:o,children:e})}},children:o})})})]})}},49685(o,e,a){a.d(e,{MX:()=>k,t:()=>g,sc:()=>P,NG:()=>U});var t=a(65723),r=a(37991),i=a(23930),n=a(36859),l=a.n(n);l().nav`padding: ${i.w4.spacing.sm} 0;`,l().div`
...
`,l().span`
  ...
  font-weight: 600;
  margin-left: auto;
`},87330(o,e,a){a.d(e,{FlyoutPanel:()=>oR});var t=a(65723),r=a(37991),i=a.n(r),n=a(36859),l=a.n(n),s=a(72799),d=a(20255),c=a(81316),p=a(40814),g=a(36896),m=a(87902),f=a(53013),x=a(32887),u=a(49510),h=a(39848),b=a(37901),w=a(3045),y=a(43775),$=a(41783),v=a(83539),z=a(39416),k=a(1837),M=a(57167),A=a(84494),T=a(82314),j=a(35751),S=a(69633),F=a(92946),B=a(40822),C=a(36720),R=a(57400),P=a(58456),E=a(43317),L=a(52709),H=a(8006),D=a(89301),I=a(37561),N=a(83517),K=a(28207),G=a(37032),V=a(6949),Y=a(8218),W=a(36829),O=a(59591),U=a(15553),_=a(69923),q=a(72820),J=a(14621),X=a(68479),Z=a(72534),Q=a(66673),oo=a(67490),oe=a(49033),oa=a(99038),ot=a(45775),or=a(31365),oi=a(62937),on=a(9821),ol=a(65912),os=a(80158),od=a(88641),oc=a(48607),op=a(83249),og=a(1821),om=a(15889),of=a(89655),ox=a(27170),ou=a(19161),oh=a(71849),ob=a(41604),ow=a(13142),oy=a(61187),o$=a(77747),ov=a(2932),oz=a(24525),ok=a(57230),oM=a(22164);let oA={activity:g.A,"a-large-small":m.A,apple:f.A,"arrow-right":x.A,"bar-chart-2":u.A,book:h.A,"book-open":b.A,briefcase:w.A,calendar:y.A,clock:$.A,"circle-dot":v.A,cloud:z.A,compass:k.A,cpu:M.A,droplets:A.A,feather:T.A,file:d.A,"file-text":j.A,folder:S.A,"git-branch":F.A,github:B.A,globe:C.A,grid:R.A,hand:P.A,hash:E.A,heart:L.A,key:H.A,hexagon:D.A,home:I.A,landmark:N.A,layers:K.A,"layout-grid":G.A,leaf:V.A,lightbulb:Y.A,list:W.A,map:O.A,"map-pin":U.A,"message-circle":_.A,"message-square":q.A,minus:J.A,monitor:X.A,mountain:Z.A,package:Q.A,palette:oo.A,"pen-tool":oe.A,"pie-chart":oa.A,plane:ot.A,plus:or.A,ruler:oi.A,shirt:on.A,slash:ol.A,square:os.A,star:od.A,sun:oc.A,terminal:op.A,thermometer:og.A,triangle:om.A,trophy:of.A,truck:ox.A,type:ou.A,users:oh.A,"volume-2":ob.A,watch:ow.A,waves:oy.A,wind:o$.A,wrench:ov.A,x:oz.A,zap:ok.A,bot:oM.A},oT=(0,s.keyframes)`
...
`,T=s().main`
  ...
  display: flex;
  flex-direction: column;
`,j=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function S(){return(0,r.jsx)(w,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:j.map((o,e)=>(0,r.jsx)(y,{index:e,accent:o.accent,children:o.char},e))})}let F="atlantis:sidebar-collapsed";function B({sidebar:o,children:e,topBarRight:t,title:l="Atlantis",activeId:s=null}){let[d,g]=(0,i.useState)(()=>{try{return"true"===localStorage.getItem(F)}catch{return!1}}),[m,f]=(0,i.useState)(null),b=(0,i.useRef)(),w=()=>g(o=>{let e=!o;try{localStorage.setItem(F,String(e))}catch{}return e}),y=n().useMemo(()=>n().lazy(()=>Promise.resolve().then(a.bind(a,87330)).then(o=>({default:o.FlyoutPanel}))),[]);return(0,r.jsx)(p.I.Provider,{value:{collapsed:d,toggle:w,flyout:m,openFlyout:(o,e,a)=>{clearTimeout(b.current),f({entry:o,anchorY:e,onSelect:a})},scheduleFlyoutClose:()=>{b.current=setTimeout(()=>f(null),160)},cancelFlyoutClose:()=>clearTimeout(b.current)},children:(0,r.jsxs)(k,{children:[(0,r.jsxs)(x,{children:[o&&(0,r.jsx)(u,{children:(0,r.jsx)(h,{onClick:w,title:d?"Expand sidebar":"Collapse sidebar",children:(0,r.jsx)(c.A,{size:17})})}),(0,r.jsx)(S,{}),l&&(0,r.jsx)($,{children:l}),t&&(0,r.jsx)(v,{children:t})]}),(0,r.jsxs)(z,{children:[null!=o&&(0,r.jsx)(M,{collapsed:d,children:(0,r.jsx)(A,{children:o})}),(0,r.jsx)(T,{children:e})]}),m&&(0,r.jsx)(n().Suspense,{fallback:null,children:(0,r.jsx)(y,{activeId:s})})]})})}s().div`
  display: grid;
  grid-template-rows: ${({open:o})=>o?"1fr":"0fr"};
...
`,K=s().div`
  ...
  color: ${t.w4.colors.sidebarTextMuted};
  font-family: ${t.w4.typography.fontFamily};
`;function G({onSave:o,onUpdate:e,onCancel:a,existingDoc:t}){let[n,l]=(0,i.useState)(t?.name??""),s=(0,i.useRef)(null);return(0,i.useEffect)(()=>{s.current?.focus(),t&&s.current?.select()},[t]),(0,r.jsx)(P,{onClick:a,children:(0,r.jsxs)(E,{onClick:o=>o.stopPropagation(),children:[(0,r.jsx)(L,{children:"Save document"}),t&&e&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(K,{children:"Update the current version or save as a new one."}),(0,r.jsxs)(D,{children:[(0,r.jsx)(I,{onClick:a,children:"Cancel"}),(0,r.jsxs)(I,{danger:!0,onClick:e,children:['Update "',t.name,'"']})]}),(0,r.jsx)(N,{})]}),(0,r.jsx)(H,{ref:s,value:n,onChange:o=>l(o.target.value),onKeyDown:r=>{"Enter"===r.key&&n.trim()&&(t&&n.trim()===t.name&&e?e():o(n.trim())),"Escape"===r.key&&a()},placeholder:t?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,r.jsxs)(D,{children:[!t&&(0,r.jsx)(I,{onClick:a,children:"Cancel"}),(0,r.jsx)(I,{primary:!0,disabled:!n.trim(),onClick:()=>o(n.trim()),children:"Save as new"})]})]})})}let V=(0,d.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,Y=(0,d.keyframes)`
...
`;var W=a(18006),O=a(70679),U=a(54872);let _=s().div`
  position: relative;
`,q=s().button`
  display: flex;
  align-items: center;
...
`;function oi({appId:o,onLoad:e}){let[a,t]=(0,i.useState)(!1),[n,l]=(0,i.useState)([]),s=(0,i.useRef)(null),d=(0,i.useCallback)(()=>{(0,R.listDocs)(o).then(l).catch(()=>{})},[o]);(0,i.useEffect)(()=>{if(!a)return;d();let o=o=>{s.current&&!s.current.contains(o.target)&&t(!1)};return document.addEventListener("mousedown",o),()=>document.removeEventListener("mousedown",o)},[a,d]);let c=async(o,e)=>{o.stopPropagation(),await (0,R.deleteDoc)(e),l(o=>o.filter(o=>o.id!==e))};return(0,r.jsxs)(_,{ref:s,children:[(0,r.jsxs)(q,{onClick:()=>t(o=>!o),children:[(0,r.jsx)(W.A,{size:14}),"Saved",(0,r.jsx)(O.A,{size:13,style:{marginLeft:2}})]}),(0,r.jsxs)(J,{open:a,children:[(0,r.jsx)(X,{children:"Saved versions"}),(0,r.jsx)(Z,{children:0===n.length?(0,r.jsx)(Q,{children:"No saved documents yet."}):n.map(o=>{var a;return(0,r.jsxs)(oo,{children:[(0,r.jsxs)(oe,{onClick:()=>{e(o.content,o.id,o.name),t(!1)},children:[(0,r.jsx)(oa,{children:o.name}),(0,r.jsx)(ot,{children:(a=o.savedAt,new Intl.DateTimeFormat(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}).format(new Date(a)))})]}),(0,r.jsx)(or,{onClick:e=>c(e,o.id),title:"Delete",children:(0,r.jsx)(U.A,{size:13})})]},o.id)})})]})]})}s().div`
...
`;s().div`
  ...
  background: ${t.w4.colors.mainBg};
  font-family: ${t.w4.typography.fontFamily};
  animation: ${on} 0.4s ease 0.15s both;
`,s().div`
  position: relative;
  width: 56px;
  height: 56px;
...
`,s().div`
  position: absolute;
  inset: 0;
  animation: ${ol} 1.4s cubic-bezier(0.4, 0, 0.2, 1) infinite;
