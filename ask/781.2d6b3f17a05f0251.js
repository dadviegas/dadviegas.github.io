...
`,v=i().forwardRef(function({active:e=!1,shape:t="square",tone:o="default",children:a,...i},n){return(0,r.jsx)($,{ref:n,active:e,shape:t,tone:o,...i,children:a})}),M=l().div`
  position: relative;
  display: inline-flex;
`,k=l().div`
  position: absolute;
  ...
  z-index: 2000;
  overflow: hidden;
`;function z({trigger:e,children:t,align:o="right",open:n,onOpenChange:l}){let[s,d]=(0,a.useState)(!1),c=n??s,p=e=>{l&&l(e),void 0===n&&d(e)},g=(0,a.useRef)(null);(0,a.useEffect)(()=>{if(!c)return;let e=e=>{g.current&&!g.current.contains(e.target)&&p(!1)};return document.addEventListener("mousedown",e),()=>document.removeEventListener("mousedown",e)},[c]);let h=i().cloneElement(e,{onClick:t=>{e.props.onClick?.(t),p(!c)},"aria-expanded":c,"aria-haspopup":"menu"});return(0,r.jsxs)(M,{ref:g,children:[h,c&&(0,r.jsx)(k,{align:o,role:"menu",children:t})]})}let T=l().button`
  display: flex;
  align-items: center;
  gap: 10px;
  padding: 8px 12px;
...
`;let H={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:s.w4.colors.accentMuted},A={neutral:s.w4.colors.mainTextMuted,live:s.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:s.w4.colors.accent};l().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${s.w4.typography.fontFamilyMono};
...
`;let L=l().kbd`
  ...
  white-space: nowrap;
`;function R({children:e,...t}){return(0,r.jsx)(L,{...t,children:e})}let V=l().div`
  font-family: ${s.w4.typography.fontFamilyMono};
  font-size: 11px;
  ...
  align-items: center;
  gap: 8px;
`;function P({children:e,...t}){return(0,r.jsx)(V,{...t,children:e})}l().label`
  display: flex;
  align-items: center;
  gap: 10px;
...
`,l().p`
  ...
  font-size: 12.5px;
  line-height: 1.45;
`;var Y=o(1352),N=o(6710),W=o(4311),D=o(3639),O=o(80);o(5406),l().nav`padding: ${s.w4.spacing.sm} 0;`,l().div`
...
`;var q=o(4041);let G="https://cdn.jsdelivr.net/npm/mermaid@11.14.0/dist/mermaid.min.js",X=null,_="#7fb77e",K=(0,j.keyframes)`
...
`,Q=!1,ee=/^(?:---[\s\S]*?---\s*)?(?:graph|flowchart|sequenceDiagram|classDiagram|stateDiagram(?:-v2)?|erDiagram|pie|gantt|journey|mindmap|gitGraph|sankey(?:-beta)?|quadrantChart|requirementDiagram|timeline|xychart-beta|block-beta|C4Context|C4Container|C4Component|C4Dynamic|C4Deployment)\b/;function et({code:e}){let[t,o]=(0,a.useState)(""),[i,n]=(0,a.useState)(!1);return((0,a.useEffect)(()=>{let t=!1;n(!1),o("");let r=e.trim();if(!r)return void n(!0);let a=r.split(/\r?\n/)[0]?.trim()??"";if(!ee.test(a))return void n(!0);let i=setTimeout(()=>{t||(console.error("[MermaidBlock] render timed out after 5s"),n(!0))},5e3);return(async()=>{try{let e=await (X||(X=new Promise((e,t)=>{let o=globalThis.mermaid;if(o)return void e(o);let r=document.createElement("script");r.src=G,r.async=!0,r.onload=()=>{let o=globalThis.mermaid;o?e(o):t(Error("mermaid loaded but globalThis.mermaid missing"))},r.onerror=()=>t(Error(`failed to load ${G}`)),document.head.appendChild(r)})));if(console.debug("[MermaidBlock] mermaid ready",{initialized:Q}),!Q){let t="#141820",o="#1c2332",r="#343c4f",a="#e8edf5",i="#9aa5b8",n="#7fb77e",l="#6aa8d8",s="#8b7bff",d="#e89a5c",c="#f87171";e.initialize({startOnLoad:!1,theme:"base",securityLevel:"loose",themeVariables:{fontFamily:"-apple-system, BlinkMacSystemFont, Segoe UI, Helvetica, Arial, sans-serif",background:t,mainBkg:o,primaryColor:n,primaryTextColor:a,primaryBorderColor:n,secondaryColor:s,secondaryTextColor:a,secondaryBorderColor:s,tertiaryColor:l,tertiaryTextColor:a,tertiaryBorderColor:l,lineColor:i,textColor:a,nodeBorder:r,clusterBkg:t,clusterBorder:r,edgeLabelBackground:o,labelBackground:o,labelBorder:r,relationLabelBackground:o,relationLabelColor:a,pie1:n,pie2:s,pie3:l,pie4:d,pie5:"#ff6fa9",pie6:"#2dd4bf",pie7:c,pie8:n,pieStrokeColor:t,pieStrokeWidth:"2px",pieTitleTextSize:"18px",pieSectionTextSize:"13px",pieLegendTextSize:"13px",actorBkg:n,actorBorder:n,actorTextColor:t,signalColor:a,signalTextColor:a,labelBoxBkgColor:o,labelBoxBorderColor:r,labelTextColor:a,loopTextColor:a,noteBkgColor:d,noteBorderColor:d,noteTextColor:t,stateBkg:o,altBackground:t,attributeBackgroundColorOdd:o,attributeBackgroundColorEven:t,rowOdd:o,rowEven:t,gridColor:r,sectionBkgColor:o,sectionBkgColor2:t,taskBkgColor:s,taskTextColor:a,taskTextDarkColor:a,taskTextLightColor:a,taskTextOutsideColor:a,activeTaskBkgColor:n,activeTaskBorderColor:n,doneTaskBkgColor:i,doneTaskBorderColor:i,critBkgColor:c,critBorderColor:c}}),Q=!0}console.debug("[MermaidBlock] calling mermaid.render");let{svg:a}=await e.render(`mermaid-${(0,q.z)()}`,r);if(clearTimeout(i),console.debug("[MermaidBlock] render returned",{length:a?.length??0}),t)return;let l=/aria-roledescription="error"/i.test(a)||/class="error-(?:icon|text)"/i.test(a)||/>Syntax error in text</i.test(a);if(!a||l)return void n(!0);o(a)}catch(e){clearTimeout(i),console.error("[MermaidBlock] render failed",e),t||n(!0)}})(),()=>{t=!0,clearTimeout(i)}},[e]),i)?(0,r.jsx)(J,{children:e.trim()}):t?(0,r.jsx)(Z,{dangerouslySetInnerHTML:{__html:t}}):(0,r.jsx)(Z,{children:(0,r.jsx)(U,{"aria-hidden":!0})})}let eo=["#388bfd","#3fb950","#d29922","#a371f7","#f87171","#22d3ee","#fb923c","#34d399","#f472b6","#818cf8"],er=l().div`
  background: ${s.w4.colors.codeBg};
  border: 1px solid ${s.w4.colors.codeBorder};
  border-radius: ${s.w4.borderRadius.md};
...
`,es=l().pre`
  ...
  color: ${s.w4.colors.mainTextMuted};
  white-space: pre-wrap;
`;function ed(e){if(e<=0)return 10;let t=Math.pow(10,Math.floor(Math.log10(e)));return Math.ceil(e/t)*t}function ec(e,t,o){let r=Math.max(1,Math.ceil(o/8));return 0!==t&&t!==o-1&&t%r!=0?"":e.length>12?e.slice(0,11)+"…":e}function ep({labels:e,data:t,colors:o}){let a=340,i=176,n=ed(Math.max(...t,1)),l=Math.min(40,a/e.length*.6),d=a/e.length,c=Array.from({length:6},(e,t)=>n/5*t);return(0,r.jsxs)("svg",{viewBox:"0 0 400 240",width:"100%",style:{maxWidth:400},children:[c.map((e,t)=>{let o=16+i-e/n*i;return(0,r.jsxs)("g",{children:[(0,r.jsx)("line",{x1:44,y1:o,x2:384,y2:o,stroke:s.w4.colors.border,strokeWidth:.5,strokeDasharray:0===t?"none":"3,3"}),(0,r.jsx)("text",{x:38,y:o+4,fill:s.w4.colors.mainTextMuted,fontSize:10,textAnchor:"end",fontFamily:s.w4.typography.fontFamily,children:Math.round(e)})]},t)}),t.map((t,a)=>{let c=44+d*a+d/2-l/2,p=t/n*i,g=16+i-p,h=o[a%o.length];return(0,r.jsxs)("g",{children:[(0,r.jsxs)("rect",{x:c,y:g,width:l,height:p,rx:3,fill:h,opacity:.85,children:[(0,r.jsx)("animate",{attributeName:"height",from:"0",to:p,dur:"0.5s",fill:"freeze"}),(0,r.jsx)("animate",{attributeName:"y",from:16+i,to:g,dur:"0.5s",fill:"freeze"})]}),(0,r.jsx)("text",{x:c+l/2,y:g-4,fill:s.w4.colors.mainText,fontSize:10,fontWeight:600,textAnchor:"middle",fontFamily:s.w4.typography.fontFamily,children:t}),(0,r.jsx)("text",{x:44+d*a+d/2,y:208,fill:s.w4.colors.mainTextMuted,fontSize:10,textAnchor:"middle",fontFamily:s.w4.typography.fontFamily,children:ec(e[a],a,e.length)})]},a)})]})}function eg({labels:e,data:t,colors:o}){let a=t.reduce((e,t)=>e+t,0)||1,i=-Math.PI/2,n=t.map((e,t)=>{let n=e/a*Math.PI*2,l=i,d=i+=n,c=120+90*Math.cos(l),p=120+90*Math.sin(l),g=120+90*Math.cos(d),h=120+90*Math.sin(d),x=+(n>Math.PI),f=l+n/2,m=120+58.5*Math.cos(f),b=120+58.5*Math.sin(f),u=Math.round(e/a*100);return(0,r.jsxs)("g",{children:[(0,r.jsx)("path",{d:`M 120 120 L ${c} ${p} A 90 90 0 ${x} 1 ${g} ${h} Z`,fill:o[t%o.length],stroke:s.w4.colors.codeBg,strokeWidth:2,opacity:.85}),u>=5&&(0,r.jsxs)("text",{x:m,y:b+4,fill:"#fff",fontSize:11,fontWeight:600,textAnchor:"middle",fontFamily:s.w4.typography.fontFamily,children:[u,"%"]})]},t)});return(0,r.jsx)("svg",{viewBox:"0 0 240 240",width:"100%",style:{maxWidth:240},children:n})}function eh({labels:e,data:t,colors:o}){let a=340,i=176,n=ed(Math.max(...t,1)),l=t.length>1?a/(t.length-1):a,d=o[0],c=t.map((e,t)=>({x:44+l*t,y:16+i-e/n*i})),p=c.map((e,t)=>`${0===t?"M":"L"} ${e.x} ${e.y}`).join(" "),g=Array.from({length:6},(e,t)=>n/5*t);return(0,r.jsxs)("svg",{viewBox:"0 0 400 240",width:"100%",style:{maxWidth:400},children:[g.map((e,t)=>{let o=16+i-e/n*i;return(0,r.jsxs)("g",{children:[(0,r.jsx)("line",{x1:44,y1:o,x2:384,y2:o,stroke:s.w4.colors.border,strokeWidth:.5,strokeDasharray:0===t?"none":"3,3"}),(0,r.jsx)("text",{x:38,y:o+4,fill:s.w4.colors.mainTextMuted,fontSize:10,textAnchor:"end",fontFamily:s.w4.typography.fontFamily,children:Math.round(e)})]},t)}),(0,r.jsx)("path",{d:p,fill:"none",stroke:d,strokeWidth:2.5,strokeLinecap:"round",strokeLinejoin:"round"}),c.map((o,a)=>(0,r.jsxs)("g",{children:[(0,r.jsx)("circle",{cx:o.x,cy:o.y,r:4,fill:d,stroke:s.w4.colors.codeBg,strokeWidth:2}),(0,r.jsx)("text",{x:o.x,y:o.y-10,fill:s.w4.colors.mainText,fontSize:10,fontWeight:600,textAnchor:"middle",fontFamily:s.w4.typography.fontFamily,children:t[a]}),(0,r.jsx)("text",{x:o.x,y:208,fill:s.w4.colors.mainTextMuted,fontSize:10,textAnchor:"middle",fontFamily:s.w4.typography.fontFamily,children:ec(e[a],a,e.length)})]},a))]})}function ex({code:e}){let t=(0,a.useMemo)(()=>(function(e){let t,o,r=e.trim().split("\n"),a="bar",i=[],n=[];for(let e of r){let[r,...l]=e.split(":"),s=l.join(":").trim();if(s)switch(r.trim().toLowerCase()){case"type":["bar","pie","line"].includes(s.toLowerCase())&&(a=s.toLowerCase());break;case"title":t=s;break;case"labels":i=s.replace(/^\[|\]$/g,"").split(",").map(e=>e.trim()).filter(Boolean);break;case"data":n=s.replace(/^\[|\]$/g,"").split(",").map(e=>e.trim()).filter(Boolean).map(e=>parseFloat(e)||0);break;case"colors":{let e=s.replace(/^\[|\]$/g,"").split(",").map(e=>e.trim()).filter(Boolean);o=e.length?e:void 0}}}return i.length&&n.length?{type:a,title:t,labels:i,data:n,colors:o}:null})(e),[e]);if(!t)return(0,r.jsx)(es,{children:e.trim()});let o=t.colors??eo;return(0,r.jsxs)(er,{children:[t.title&&(0,r.jsx)(ea,{children:t.title}),"bar"===t.type&&(0,r.jsx)(ep,{labels:t.labels,data:t.data,colors:o}),"pie"===t.type&&(0,r.jsx)(eg,{labels:t.labels,data:t.data,colors:o}),"line"===t.type&&(0,r.jsx)(eh,{labels:t.labels,data:t.data,colors:o}),(0,r.jsx)(ei,{children:t.labels.map((e,t)=>(0,r.jsxs)(en,{children:[(0,r.jsx)(el,{color:o[t%o.length]}),e]},t))})]})}l().div`
  background: ${s.w4.colors.codeBg};
  border: 1px solid ${s.w4.colors.codeBorder};
  border-radius: ${s.w4.borderRadius.md};
  padding: ${s.w4.spacing.lg};
...
`,l().span`
  font-size: ${s.w4.typography.fontSizeBase};
  color: ${s.w4.colors.mainTextMuted};
`;var eb=o(7223),eu=o(1426);let ew=l().div`
  margin: ${s.w4.spacing.lg} 0;
  border-radius: ${s.w4.borderRadius.md};
  border: 1px solid ${s.w4.colors.codeBorder};
  overflow: hidden;
...
`,eM={...eu.A,'pre[class*="language-"]':{...eu.A['pre[class*="language-"]'],background:s.w4.colors.codeBg,margin:0,padding:"18px 20px",fontSize:"13px",lineHeight:"1.6",borderRadius:0},'code[class*="language-"]':{...eu.A['code[class*="language-"]'],background:"none",fontSize:"13px"}};function ek({lang:e="text",code:t}){let[o,i]=(0,a.useState)(!1);return(0,r.jsxs)(ew,{children:[(0,r.jsxs)(ey,{children:[(0,r.jsx)(e$,{children:e}),(0,r.jsxs)(ev,{copied:o,onClick:()=>{navigator.clipboard.writeText(t).then(()=>{i(!0),setTimeout(()=>i(!1),2e3)})},children:[o?(0,r.jsx)(F,{name:"check",size:12}):(0,r.jsx)(F,{name:"copy",size:12}),o?"Copied!":"Copy"]})]}),(0,r.jsx)(eb.A,{language:e,style:eM,showLineNumbers:t.split("\n").length>8,lineNumberStyle:{color:"#484f58",minWidth:"2.5em",paddingRight:"1.5em",userSelect:"none",fontSize:"12px"},customStyle:{margin:0,background:s.w4.colors.codeBg},wrapLongLines:!1,children:t})]})}let ez={NOTE:{bg:"rgba(88, 166, 255, 0.08)",border:"#58a6ff",icon:"info",label:"Note",color:"#58a6ff"},TIP:{bg:"rgba(63, 185, 80, 0.08)",border:"#3fb950",icon:"lightbulb",label:"Tip",color:"#3fb950"},IMPORTANT:{bg:"rgba(163, 113, 247, 0.08)",border:"#a371f7",icon:"zap",label:"Important",color:"#a371f7"},WARNING:{bg:"rgba(210, 153, 34, 0.08)",border:"#d29922",icon:"alert-triangle",label:"Warning",color:"#d29922"},CAUTION:{bg:"rgba(248, 81, 73, 0.08)",border:"#f85149",icon:"alert-octagon",label:"Caution",color:"#f85149"}},eT=l().div`
  background: ${({bg:e})=>e};
...
`;function eF({type:e,children:t}){let o=ez[e]??ez.NOTE;return(0,r.jsxs)(eT,{bg:o.bg,border:o.border,children:[(0,r.jsxs)(ej,{color:o.color,children:[(0,r.jsx)(F,{name:o.icon,size:15,strokeWidth:2}),o.label]}),(0,r.jsx)(eS,{children:t})]})}l().nav`
  width: 220px;
  min-width: 220px;
...
`,l().aside`
  ...
  display: flex;
  flex-direction: column;
  animation: ${eB} 0.22s cubic-bezier(0.4, 0, 0.2, 1) both;
...
`;function eL({children:e}){return(0,r.jsx)(eA,{children:(0,r.jsx)(Y.oz,{remarkPlugins:[N.A,W.A,eH],rehypePlugins:[D.A,O.A],components:{div({node:e,children:t,...o}){let a=o["data-callout"];return a?(0,r.jsx)(eF,{type:a,children:t}):(0,r.jsx)("div",{...o,children:t})},pre:({children:e})=>(0,r.jsx)(r.Fragment,{children:e}),code({className:e,children:t}){let o=/language-(\w+)/.exec(e??"")?.[1],a=String(t).replace(/\n$/,"");return a.trim()?"mermaid"===o?(0,r.jsx)(et,{code:a}):"chart"===o?(0,r.jsx)(ex,{code:a}):o||a.includes("\n")?(0,r.jsx)(ek,{lang:o,code:a}):(0,r.jsx)("code",{className:e,children:t}):null}},children:e})})}var eR=o(7993);l().nav`
  display: flex;
  flex-direction: column;
  gap: 1px;
...
`;l().div`
  ...
  pointer-events: none;
  z-index: 200;
  animation: ${eI} 0.16s cubic-bezier(0.4, 0, 0.2, 1) forwards;
...
`,l().div`
  ...
  flex-direction: column;
  gap: 14px;
  animation: ${eY} 0.18s cubic-bezier(0.22, 1, 0.36, 1) both;
`,l().div`
  font-size: ${s.w4.typography.fontSizeMd};
  font-weight: 700;
...
`,l().div`
  position: relative;
`;let eO="260px",eq="56px",eG="48px",eX=l().header`
  display: flex;
  align-items: center;
  height: calc(${eG} + env(safe-area-inset-top, 0px));
  padding-top: env(safe-area-inset-top, 0px);
  ...
  @media (max-width: ${s.w4.breakpoints.md}) {
    flex-wrap: wrap;
    height: auto;
    min-height: calc(${eG} + env(safe-area-inset-top, 0px));
  }
`,e_=l().div`
  width: ${eq};
  min-width: ${eq};
...
`,eJ=l().span`
  ...
  animation: ${eZ} 10s ease ${({index:e})=>.07*e}s infinite;
...
`,e2=l().div`
  ...
  overflow: hidden;
`,e4=l().aside`
  width: ${({collapsed:e})=>e?eq:eO};
  min-width: ${({collapsed:e})=>e?eq:eO};
  background: ${s.w4.colors.sidebarBg};
  border-right: 1px solid ${s.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,e3=l().main`
  ...
  display: flex;
  flex-direction: column;
`,e6=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function e8(){return(0,r.jsx)(eU,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:e6.map((e,t)=>(0,r.jsx)(eJ,{index:t,accent:e.accent,children:e.char},t))})}let e7="atlantis:sidebar-collapsed";function e9({sidebar:e,children:t,topBarRight:n,title:l="Atlantis",activeId:s=null}){let[d,c]=(0,a.useState)(()=>{try{return"true"===localStorage.getItem(e7)}catch{return!1}}),[p,g]=(0,a.useState)(null),h=(0,a.useRef)(),x=()=>c(e=>{let t=!e;try{localStorage.setItem(e7,String(t))}catch{}return t}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(o.bind(o,5816)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(eR.I.Provider,{value:{collapsed:d,toggle:x,flyout:p,openFlyout:(e,t,o)=>{clearTimeout(h.current),g({entry:e,anchorY:t,onSelect:o})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,r.jsxs)(e2,{children:[(0,r.jsxs)(eX,{children:[e&&(0,r.jsx)(e_,{children:(0,r.jsx)(eK,{onClick:x,title:d?"Expand sidebar":"Collapse sidebar",children:(0,r.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,r.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,r.jsx)("path",{d:"M9 3v18"})]})})}),(0,r.jsx)(e8,{}),l&&(0,r.jsx)(eQ,{children:l}),n&&(0,r.jsx)(e0,{children:n})]}),(0,r.jsxs)(e1,{children:[null!=e&&(0,r.jsx)(e4,{collapsed:d,children:(0,r.jsx)(e5,{children:e})}),(0,r.jsx)(e3,{children:t})]}),p&&(0,r.jsx)(i().Suspense,{fallback:null,children:(0,r.jsx)(f,{activeId:s})})]})})}l().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
