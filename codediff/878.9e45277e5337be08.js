...
`,ea=l().div`
  ...
  color: ${d.w4.colors.sidebarTextMuted};
  font-family: ${d.w4.typography.fontFamily};
`;function et({onSave:e,onUpdate:o,onCancel:a,existingDoc:i}){let[n,l]=(0,r.useState)(i?.name??""),d=(0,r.useRef)(null);return(0,r.useEffect)(()=>{d.current?.focus(),i&&d.current?.select()},[i]),(0,t.jsx)(J,{onClick:a,children:(0,t.jsxs)(q,{onClick:e=>e.stopPropagation(),children:[(0,t.jsx)(Z,{children:"Save document"}),i&&o&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(ea,{children:"Update the current version or save as a new one."}),(0,t.jsxs)(Q,{children:[(0,t.jsx)(ee,{onClick:a,children:"Cancel"}),(0,t.jsxs)(ee,{danger:!0,onClick:o,children:['Update "',i.name,'"']})]}),(0,t.jsx)(eo,{})]}),(0,t.jsx)(X,{ref:d,value:n,onChange:e=>l(e.target.value),onKeyDown:t=>{"Enter"===t.key&&n.trim()&&(i&&n.trim()===i.name&&o?o():e(n.trim())),"Escape"===t.key&&a()},placeholder:i?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,t.jsxs)(Q,{children:[!i&&(0,t.jsx)(ee,{onClick:a,children:"Cancel"}),(0,t.jsx)(ee,{primary:!0,disabled:!n.trim(),onClick:()=>e(n.trim()),children:"Save as new"})]})]})})}let er=(0,y.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,ei=(0,y.keyframes)`
...
`,l().div`
  position: relative;
`;let es="260px",ec="56px",ep="48px",eg=l().header`
  display: flex;
  align-items: center;
...
`,e$=l().div`
  ...
  overflow: hidden;
`,ev=l().aside`
  width: ${({collapsed:e})=>e?ec:es};
  min-width: ${({collapsed:e})=>e?ec:es};
  background: ${d.w4.colors.sidebarBg};
  border-right: 1px solid ${d.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,eM=l().main`
  ...
  display: flex;
  flex-direction: column;
`,ek=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function eA(){return(0,t.jsx)(ex,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:ek.map((e,o)=>(0,t.jsx)(eu,{index:o,accent:e.accent,children:e.char},o))})}let eT="atlantis:sidebar-collapsed";function eS({sidebar:e,children:o,topBarRight:n,title:l="Atlantis",activeId:d=null}){let[s,c]=(0,r.useState)(()=>{try{return"true"===localStorage.getItem(eT)}catch{return!1}}),[p,g]=(0,r.useState)(null),h=(0,r.useRef)(),m=()=>c(e=>{let o=!e;try{localStorage.setItem(eT,String(o))}catch{}return o}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(a.bind(a,5816)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,t.jsx)(E.I.Provider,{value:{collapsed:s,toggle:m,flyout:p,openFlyout:(e,o,a)=>{clearTimeout(h.current),g({entry:e,anchorY:o,onSelect:a})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,t.jsxs)(e$,{children:[(0,t.jsxs)(eg,{children:[e&&(0,t.jsx)(eh,{children:(0,t.jsx)(em,{onClick:m,title:s?"Expand sidebar":"Collapse sidebar",children:(0,t.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("path",{d:"M9 3v18"})]})})}),(0,t.jsx)(eA,{}),l&&(0,t.jsx)(eb,{children:l}),n&&(0,t.jsx)(ey,{children:n})]}),(0,t.jsxs)(ew,{children:[null!=e&&(0,t.jsx)(ev,{collapsed:s,children:(0,t.jsx)(ez,{children:e})}),(0,t.jsx)(eM,{children:o})]}),p&&(0,t.jsx)(i().Suspense,{fallback:null,children:(0,t.jsx)(f,{activeId:d})})]})})}l().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
