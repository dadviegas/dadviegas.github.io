...
`,w=t.default.main`
  ...
  display: flex;
  flex-direction: column;
`,$="atlantis:sidebar-collapsed";function A({sidebar:e,children:a,topBarRight:i,title:t="Atlantis",activeId:s=null}){const[c,A]=(0,n.useState)(()=>{try{return"true"===localStorage.getItem($)}catch{return!1}}),[v,k]=(0,n.useState)(null),j=(0,n.useRef)(),S=()=>A(e=>{const a=!e;try{localStorage.setItem($,String(a))}catch{}return a}),M=n.useMemo(()=>n.lazy(()=>Promise.resolve().then(o.bind(o,74914)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(d.I.Provider,{value:{collapsed:c,toggle:S,flyout:v,openFlyout:(e,a,o)=>{clearTimeout(j.current),k({entry:e,anchorY:a,onSelect:o})},scheduleFlyoutClose:()=>{j.current=setTimeout(()=>k(null),160)},cancelFlyoutClose:()=>clearTimeout(j.current)},children:(0,r.jsxs)(b,{children:[(0,r.jsxs)(m,{children:[e&&(0,r.jsx)(g,{children:(0,r.jsx)(u,{onClick:S,title:c?"Expand sidebar":"Collapse sidebar",children:(0,r.jsx)(l.A,{size:17})})}),(0,r.jsxs)(f,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:["Atl",(0,r.jsx)("span",{children:"antis"})]}),t&&(0,r.jsx)(p,{children:t}),i&&(0,r.jsx)(y,{children:i})]}),(0,r.jsxs)(h,{children:[null!=e&&(0,r.jsx)(x,{collapsed:c,children:(0,r.jsx)(z,{children:e})}),(0,r.jsx)(w,{children:a})]}),v&&(0,r.jsx)(n.Suspense,{fallback:null,children:(0,r.jsx)(M,{activeId:s})})]})})}var v=o(20255),k=o(69753),j=o(65185);const S=t.default.div`
  display: grid;
