...
`,d=r().p`
  ...
  margin: 0;
  line-height: 1.5;
`,c={loading:"◌ Loading",empty:"◎ Empty",error:"◎ Offline"};function p({mode:e,label:t,body:a}){return(0,i.jsxs)(s,{children:[(0,i.jsx)(l,{mode:e,children:t??c[e]}),a&&(0,i.jsx)(d,{children:a})]})}},64443(e,t,a){a.d(t,{YG:()=>i.Y});var i=a(85043);a(65723),a(37991);var o=a(6063),r=a(36859),n=a.n(r);n().span`
  font-family: ${o.w4.typography.fontFamilyMono};
  font-size: 11px;
  font-weight: 500;
  font-variant-numeric: tabular-nums;
  ...
  white-space: nowrap;
`,a(64392),a(83090),a(63236),a(74170),a(9391),n().button`
  display: inline-flex;
  align-items: center;
  gap: 6px;
  padding: 0 10px;
