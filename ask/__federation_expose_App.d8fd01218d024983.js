...
`,em=r().div`
  ...
  max-width: 340px;
  line-height: 1.55;
`,ef=["sparkle","code","book","message"];function ew({topBarRight:e}){let[t]=(0,p.Ym)(),n=(0,i.useMemo)(()=>(0,p.Nx)(t,h.A),[t]),[s,r]=(0,i.useState)(null),[o,y]=(0,i.useState)(!1);(0,i.useEffect)(()=>{(0,c.resolveGroqKey)().then(e=>{r(e),y(!0)}).catch(()=>y(!0))},[]);let[b,v]=(0,i.useState)({tone:"friendly",language:"auto",maxTokens:1024}),[ey,eb]=(0,i.useState)(!1),ek=(0,i.useRef)(null);(0,i.useEffect)(()=>{Promise.all([(0,l.PL)(x),(0,l.PL)(m),(0,l.PL)(f)]).then(([e,t,n])=>{v({tone:e??"friendly",language:t??"auto",maxTokens:n?parseInt(n,10):1024})}).catch(()=>void 0)},[]);let ev=(0,i.useCallback)(async e=>{v({...b,...e}),void 0!==e.tone&&await (0,l.Is)(x,e.tone),void 0!==e.language&&await (0,l.Is)(m,e.language),void 0!==e.maxTokens&&await (0,l.Is)(f,String(e.maxTokens))},[b]);(0,i.useEffect)(()=>{if(!ey)return;let e=e=>{let t=e.target;!t||ek.current?.contains(t)||t.closest?.('[role="menu"]')||eb(!1)};return document.addEventListener("click",e),()=>document.removeEventListener("click",e)},[ey]);let[e$,ej]=(0,i.useState)([]),[eT,eS]=(0,i.useState)(null),[eC,eI]=(0,i.useState)([]),[eA,eE]=(0,i.useState)(""),ez=(0,i.useRef)([]);(0,i.useEffect)(()=>{ez.current=eC},[eC]);let eM=(0,i.useCallback)(async()=>{let e=await (0,l.Iu)("ask");return ej(e),e},[]),eR=(0,l.fy)(),eD=(0,i.useRef)(null);function eO(e){try{let t=JSON.parse(e.content);eI(t.turns??[])}catch{eI([])}eS(e.id),eE(e.name),(0,l.Is)(g,e.id).catch(()=>void 0)}function eL(){eI([]),eS(null),eE(""),(0,l.Is)(g,"").catch(()=>void 0)}(0,i.useEffect)(()=>{(async()=>{let e=await eM(),t=eR.session,n=await (0,l.PL)(g),a=t??n,i=a?e.find(e=>e.id===a):null;i&&(eO(i),eD.current=t??null)})().catch(()=>void 0)},[]),(0,i.useEffect)(()=>{let e=eR.session;if(!e||eD.current===e)return;let t=e$.find(t=>t.id===e);t&&(eD.current=e,eO(t))},[eR.session,e$]);let eN=(0,i.useCallback)(async(e,t,a)=>{let i=JSON.stringify({turns:e}),s=a??(e.find(e=>"user"===e.role)?e.find(e=>"user"===e.role).content.slice(0,50):n("ask.untitled"));if(t)await (0,l.mZ)(t,s,i);else{let e=await (0,l.KL)("ask",s,i);return eS(e),await (0,l.Is)(g,e),e}return t},[n]),eF=(0,i.useCallback)(async e=>{await (0,l.kd)(e),e===eT&&eL(),await eM()},[eT,eM]),[eP,eU]=(0,i.useState)(""),[eK,eq]=(0,i.useState)(!1),[eG,eH]=(0,i.useState)(null),[eY,eB]=(0,i.useState)(!1),eJ=(0,i.useRef)(null),eQ=(0,i.useRef)(null),e_=(0,i.useRef)(null);(0,i.useLayoutEffect)(()=>{let e=eQ.current;e&&(e.style.height="auto",e.style.height=`${Math.min(e.scrollHeight,192)}px`)},[eP]),(0,i.useEffect)(()=>{e_.current?.scrollIntoView({behavior:"smooth"})},[eC,eK]);let eV=(0,i.useCallback)(async(e,a)=>{let i,r;if(!s||eK)return;if(a?.replay===!0){let e=ez.current.filter(e=>!("loading"in e)),t=-1;for(let n=e.length-1;n>=0;n--)if("user"===e[n].role){t=n;break}if(t<0)return;let n=e[t];if("user"!==n.role)return;i=n.content,r=e.slice(0,t+1)}else{if(!e.trim())return;i=e.trim(),eU("");let t={role:"user",content:i,ts:Date.now()};r=[...ez.current.filter(e=>!("loading"in e)),t]}eH(null);let o={role:"assistant",content:"",loading:!0,ts:Date.now()};eI([...r,o]),eq(!0);let l=r.filter(e=>!("loading"in e)).slice(0,-1).map(e=>({role:e.role,content:e.content})).slice(-6),d="auto"===b.language?t:b.language;eJ.current?.abort();let p=new AbortController;eJ.current=p;let h=Date.now();try{var u,g;let e=await (0,c.askGroqStream)(i,{key:s,system:(u=b.tone,g=b.language,`You are Atlantis, a personal-dashboard assistant.
