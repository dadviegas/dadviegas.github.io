...
`,$=t.default.div`
  ...
  color: ${o.w.colors.sidebarTextMuted};
  font-family: ${o.w.typography.fontFamily};
`;function A({onSave:a,onUpdate:n,onCancel:e,existingDoc:o}){const[t,l]=(0,i.useState)(o?.name??""),s=(0,i.useRef)(null);return(0,i.useEffect)(()=>{s.current?.focus(),o&&s.current?.select()},[o]),(0,r.jsx)(f,{onClick:e,children:(0,r.jsxs)(b,{onClick:a=>a.stopPropagation(),children:[(0,r.jsx)(y,{children:"Save document"}),o&&n&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)($,{children:"Update the current version or save as a new one."}),(0,r.jsxs)(x,{children:[(0,r.jsx)(z,{onClick:e,children:"Cancel"}),(0,r.jsxs)(z,{danger:!0,onClick:n,children:['Update "',o.name,'"']})]}),(0,r.jsx)(w,{})]}),(0,r.jsx)(h,{ref:s,value:t,onChange:a=>l(a.target.value),onKeyDown:i=>{"Enter"===i.key&&t.trim()&&(o&&t.trim()===o.name&&n?n():a(t.trim())),"Escape"===i.key&&e()},placeholder:o?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,r.jsxs)(x,{children:[!o&&(0,r.jsx)(z,{onClick:e,children:"Cancel"}),(0,r.jsx)(z,{primary:!0,disabled:!t.trim(),onClick:()=>a(t.trim()),children:"Save as new"})]})]})})}var v=e(18006),k=e(70679),S=e(54872);const T=t.default.div`
  position: relative;
`,M=t.default.button`
  display: flex;
  align-items: center;
...
//# sourceMappingURL=5773.370f04b5aacdc30f0225.js.map