"use strict";(self.webpackChunk_atlantis_codediff=self.webpackChunk_atlantis_codediff||[]).push([["4451"],{1315(o,e,a){function t(o,e){let a=o.split("\n"),t=e.split("\n");if(a.length>2e3||t.length>2e3){var r=a,n=t;let o=[],e=Math.max(r.length,n.length);for(let a=0;a<e;a++)a>=r.length?o.push({type:"insert",oldLine:null,newLine:n[a],oldNum:null,newNum:a+1}):a>=n.length?o.push({type:"delete",oldLine:r[a],newLine:null,oldNum:a+1,newNum:null}):r[a]===n[a]?o.push({type:"equal",oldLine:r[a],newLine:n[a],oldNum:a+1,newNum:a+1}):o.push({type:"replace",oldLine:r[a],newLine:n[a],oldNum:a+1,newNum:a+1});return o}let i=function o(e,a,t,r,n){return 0===r&&0===n?[]:r>0&&n>0&&a[r-1]===t[n-1]?[...o(e,a,t,r-1,n-1),{type:"equal",oldLine:a[r-1],newLine:t[n-1],oldNum:r,newNum:n}]:n>0&&(0===r||e[r][n-1]>=e[r-1][n])?[...o(e,a,t,r,n-1),{type:"insert",oldLine:null,newLine:t[n-1],oldNum:null,newNum:n}]:[...o(e,a,t,r-1,n),{type:"delete",oldLine:a[r-1],newLine:null,oldNum:r,newNum:null}]}(function(o,e){let a=o.length,t=e.length,r=Array.from({length:a+1},()=>Array(t+1).fill(0));for(let n=1;n<=a;n++)for(let a=1;a<=t;a++)o[n-1]===e[a-1]?r[n][a]=r[n-1][a-1]+1:r[n][a]=Math.max(r[n-1][a],r[n][a-1]);return r}(a,t),a,t,a.length,t.length),l=[],s=0;for(;s<i.length;)"delete"===i[s].type&&s+1<i.length&&"insert"===i[s+1].type?(l.push({type:"replace",oldLine:i[s].oldLine,newLine:i[s+1].newLine,oldNum:i[s].oldNum,newNum:i[s+1].newNum}),s+=2):(l.push(i[s]),s++);return l}function r(o){let e=0,a=0,t=0;for(let r of o)"insert"===r.type?e++:"delete"===r.type?a++:"replace"===r.type&&t++;return{added:e,removed:a,changed:t}}a.d(e,{P:()=>t,h:()=>r})},5151(o,e,a){a.d(e,{k:()=>t});let t=[{label:"TypeScript function refactor",original:`function fetchUser(id) {
...
class Database:
    ...
    def query(self, sql: str, params: tuple = ()) -> list:
        ...
        return cursor.fetchall()`}]},7330(o,e,a){a.d(e,{FlyoutPanel:()=>oR});var t=a(5723),r=a(7991),n=a.n(r),i=a(6859),l=a.n(i),s=a(2799),d=a(255),c=a(1316),p=a(814),g=a(6896),m=a(7902),f=a(3013),x=a(2887),u=a(9510),b=a(9848),h=a(7901),w=a(3045),y=a(3775),$=a(1783),z=a(3539),v=a(9416),k=a(1837),M=a(7167),A=a(4494),T=a(2314),S=a(5751),j=a(9633),F=a(2946),B=a(822),P=a(6720),R=a(7400),L=a(8456),C=a(3317),E=a(2709),H=a(8006),N=a(9301),D=a(7561),K=a(3517),I=a(8207),V=a(7032),Y=a(6949),_=a(8218),G=a(6829),U=a(9591),O=a(5553),J=a(9923),q=a(2820),W=a(4621),Z=a(8479),X=a(2534),Q=a(6673),oo=a(7490),oe=a(9033),oa=a(9038),ot=a(5775),or=a(1365),on=a(2937),oi=a(9821),ol=a(5912),os=a(158),od=a(8641),oc=a(8607),op=a(3249),og=a(1821),om=a(5889),of=a(9655),ox=a(7170),ou=a(9161),ob=a(1849),oh=a(1604),ow=a(3142),oy=a(1187),o$=a(7747),oz=a(2932),ov=a(4525),ok=a(7230),oM=a(2164);let oA={activity:g.A,"a-large-small":m.A,apple:f.A,"arrow-right":x.A,"bar-chart-2":u.A,book:b.A,"book-open":h.A,briefcase:w.A,calendar:y.A,clock:$.A,"circle-dot":z.A,cloud:v.A,compass:k.A,cpu:M.A,droplets:A.A,feather:T.A,file:d.A,"file-text":S.A,folder:j.A,"git-branch":F.A,github:B.A,globe:P.A,grid:R.A,hand:L.A,hash:C.A,heart:E.A,key:H.A,hexagon:N.A,home:D.A,landmark:K.A,layers:I.A,"layout-grid":V.A,leaf:Y.A,lightbulb:_.A,list:G.A,map:U.A,"map-pin":O.A,"message-circle":J.A,"message-square":q.A,minus:W.A,monitor:Z.A,mountain:X.A,package:Q.A,palette:oo.A,"pen-tool":oe.A,"pie-chart":oa.A,plane:ot.A,plus:or.A,ruler:on.A,shirt:oi.A,slash:ol.A,square:os.A,star:od.A,sun:oc.A,terminal:op.A,thermometer:og.A,triangle:om.A,trophy:of.A,truck:ox.A,type:ou.A,users:ob.A,"volume-2":oh.A,watch:ow.A,waves:oy.A,wind:o$.A,wrench:oz.A,x:ov.A,zap:ok.A,bot:oM.A},oT=(0,s.keyframes)`
...
`,J=s().div`
  ...
  color: ${t.w4.colors.sidebarTextMuted};
  font-family: ${t.w4.typography.fontFamily};
`;function q({onSave:o,onUpdate:e,onCancel:a,existingDoc:t}){let[i,l]=(0,n.useState)(t?.name??""),s=(0,n.useRef)(null);return(0,n.useEffect)(()=>{s.current?.focus(),t&&s.current?.select()},[t]),(0,r.jsx)(I,{onClick:a,children:(0,r.jsxs)(V,{onClick:o=>o.stopPropagation(),children:[(0,r.jsx)(Y,{children:"Save document"}),t&&e&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(J,{children:"Update the current version or save as a new one."}),(0,r.jsxs)(G,{children:[(0,r.jsx)(U,{onClick:a,children:"Cancel"}),(0,r.jsxs)(U,{danger:!0,onClick:e,children:['Update "',t.name,'"']})]}),(0,r.jsx)(O,{})]}),(0,r.jsx)(_,{ref:s,value:i,onChange:o=>l(o.target.value),onKeyDown:r=>{"Enter"===r.key&&i.trim()&&(t&&i.trim()===t.name&&e?e():o(i.trim())),"Escape"===r.key&&a()},placeholder:t?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,r.jsxs)(G,{children:[!t&&(0,r.jsx)(U,{onClick:a,children:"Cancel"}),(0,r.jsx)(U,{primary:!0,disabled:!i.trim(),onClick:()=>o(i.trim()),children:"Save as new"})]})]})})}let W=(0,d.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,Z=(0,d.keyframes)`
...
`;function og({appId:o,onLoad:e}){let[a,t]=(0,n.useState)(!1),[i,l]=(0,n.useState)([]),s=(0,n.useRef)(null),d=(0,n.useCallback)(()=>{E.listDocs(o).then(l).catch(()=>{})},[o]);(0,n.useEffect)(()=>{if(!a)return;d();let o=o=>{s.current&&!s.current.contains(o.target)&&t(!1)};return document.addEventListener("mousedown",o),()=>document.removeEventListener("mousedown",o)},[a,d]);let c=async(o,e)=>{o.stopPropagation(),await E.deleteDoc(e),l(o=>o.filter(o=>o.id!==e))};return(0,r.jsxs)(oe,{ref:s,children:[(0,r.jsxs)(oa,{onClick:()=>t(o=>!o),children:[(0,r.jsx)(X.A,{size:14}),"Saved",(0,r.jsx)(Q.A,{size:13,style:{marginLeft:2}})]}),(0,r.jsxs)(ot,{open:a,children:[(0,r.jsx)(or,{children:"Saved versions"}),(0,r.jsx)(on,{children:0===i.length?(0,r.jsx)(oi,{children:"No saved documents yet."}):i.map(o=>{var a;return(0,r.jsxs)(ol,{children:[(0,r.jsxs)(os,{onClick:()=>{e(o.content,o.id,o.name),t(!1)},children:[(0,r.jsx)(od,{children:o.name}),(0,r.jsx)(oc,{children:(a=o.savedAt,new Intl.DateTimeFormat(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}).format(new Date(a)))})]}),(0,r.jsx)(op,{onClick:e=>c(e,o.id),title:"Delete",children:(0,r.jsx)(oo.A,{size:13})})]},o.id)})})]})]})}s().div`
...
`;let u={default:l.w4.colors.accent,danger:"#f85149"},b={default:l.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"};i().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`,L.A,L.A['pre[class*="language-"]'],l.w4.colors.codeBg,L.A['code[class*="language-"]'],i().div`
  background: ${({bg:o})=>o};
...
`;function Y({activeAppId:o}){let{collapsed:e}=(0,l.cL)(),[a]=function(){let[o,e]=(0,r.useState)(k),a=(0,r.useCallback)(o=>{e(o);try{localStorage.setItem($,o)}catch{}(0,l.Is)(z,o).catch(()=>{}),window.dispatchEvent(new CustomEvent("atlantis:locale-change",{detail:o}))},[]);return(0,r.useEffect)(()=>{let o=o=>{e(o.detail)};return window.addEventListener("atlantis:locale-change",o),()=>window.removeEventListener("atlantis:locale-change",o)},[]),(0,r.useEffect)(()=>{(0,l.PL)(z).then(a=>{if(v(a)&&a!==o){try{localStorage.setItem($,a)}catch{}e(a)}}).catch(()=>{})},[]),[o,a]}(),n=(0,r.useMemo)(()=>(o,e)=>{let t=y[o]?.[a]??o;return e?Object.entries(e).reduce((o,[e,a])=>o.replace(RegExp(`\\{${e}\\}`,"g"),String(a)),t):t},[a]),i=(0,r.useRef)(null),s=o=>{i.current!==o&&(i.current=o,document.activeElement?.blur(),window.location.hash=o,setTimeout(()=>{i.current=null},50))};return(0,t.jsxs)(N,{children:[(0,t.jsx)(D,{collapsed:e,children:n("devtools.heading")}),H.map(a=>{let r=n(a.labelKey);return(0,t.jsxs)(K,{active:o===a.id,collapsed:e,onPointerDown:o=>{0===o.button&&s(a.hash)},onClick:()=>s(a.hash),title:r,children:[(0,t.jsx)(I,{children:(0,t.jsx)(A,{name:a.icon,size:16})}),(0,t.jsx)(V,{collapsed:e,children:r})]},a.id)})]})}}}]);