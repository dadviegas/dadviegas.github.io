"use strict";(self.webpackChunk_atlantis_shell=self.webpackChunk_atlantis_shell||[]).push([["6091"],{31382(e,t,o){o.d(t,{AgendaWidget:()=>_});var n=o(65723),a=o(37991),r=o(36859),i=o.n(r),s=o(72799),l=o(23930),d=o(48294),c=o(2938),p=o(28170),u=o(98975),x=o(10312);let g={personal:l.w4.suites.ent,team:l.w4.suites.lab,work:l.w4.suites.learn},b=d.AGENDA_TAG_ORDER,m=(0,s.keyframes)`
...
`,C=i().span`
  ...
  ${({active:e})=>e?`animation: ${f} 2.2s ease-in-out infinite;`:""}
`,R=i().button`
  background: none;
  border: none;
  padding: 0;
...
`,I=i().button`
  ...
  &:focus-visible { ${l.w4.focusRing} }
`;function _({locale:e}){let t="pt"===e?"pt":"en",o=(0,a.useMemo)(()=>(0,p.Nx)(t,u.A),[t]),{store:r,loaded:i,add:s,toggleDone:m,remove:f}=(0,d.useAgenda)(),[N,O]=(0,a.useState)(!1),[Y,G]=(0,a.useState)(""),[B,P]=(0,a.useState)(()=>(0,d.currentHHMM)()),[W,q]=(0,a.useState)(""),[J,K]=(0,a.useState)("personal"),[L,Q]=(0,a.useState)(()=>{let e=new Date;return 60*e.getHours()+e.getMinutes()}),U=(0,d.todayISO)(),V=(0,a.useMemo)(()=>(0,d.sortEvents)(r[U]??[]),[r,U]);(0,a.useEffect)(()=>{let e=setInterval(()=>{let e=new Date;Q(60*e.getHours()+e.getMinutes())},6e4);return()=>clearInterval(e)},[]);let X=(0,a.useCallback)(async()=>{await s(U,{title:Y,time:B,end:W,tag:J})&&(G(""),q(""),K("personal"),P((0,d.currentHHMM)()),O(!1))},[Y,B,W,J,U,s]),Z=(0,a.useCallback)(e=>{m(U,e)},[U,m]),ee=(0,a.useCallback)(e=>{f(U,e)},[U,f]);if(!i)return null;let et=Y.trim().length>0&&/^\d{2}:\d{2}$/.test(B),eo=1===V.length?o("agenda.countOne"):o("agenda.count",{n:V.length});return(0,n.jsx)(c.rl,{title:o("agenda.title"),accessory:(0,n.jsxs)(h,{children:[V.length>0&&(0,n.jsx)("span",{children:eo}),(0,n.jsx)(y,{type:"button",active:N,onClick:()=>O(e=>!e),"aria-label":o("agenda.addEvent"),title:o("agenda.addEvent"),children:(0,n.jsx)(c.In,{name:"plus",size:12})})]}),accentColor:x.A.accentColor,children:(0,n.jsxs)(w,{children:[N&&(0,n.jsxs)(z,{onSubmit:e=>{e.preventDefault(),X()},children:[(0,n.jsxs)(S,{children:[(0,n.jsx)(E,{type:"time",value:B,onChange:e=>P(e.target.value),"aria-label":o("agenda.timeStart")}),(0,n.jsx)(E,{type:"text",value:Y,onChange:e=>G(e.target.value),placeholder:o("agenda.titlePlaceholder"),autoFocus:!0}),(0,n.jsx)(E,{type:"time",value:W,onChange:e=>q(e.target.value),placeholder:o("agenda.timeEnd"),"aria-label":o("agenda.timeEnd")})]}),(0,n.jsx)(A,{children:b.map(e=>(0,n.jsx)(D,{type:"button",color:g[e],selected:J===e,onClick:()=>K(e),children:o(`agenda.tag.${e}`)},e))}),(0,n.jsxs)(H,{children:[(0,n.jsx)(I,{type:"button",onClick:()=>O(!1),children:o("agenda.cancel")}),(0,n.jsx)(I,{type:"submit",primary:!0,disabled:!et,children:o("agenda.save")})]})]}),0===V.length?(0,n.jsxs)(F,{children:[(0,n.jsx)("div",{children:o("agenda.empty")}),!N&&(0,n.jsxs)(T,{type:"button",onClick:()=>O(!0),children:[(0,n.jsx)(c.In,{name:"plus",size:12}),o("agenda.emptyCta")]})]}):(0,n.jsxs)($,{children:[(0,n.jsx)(v,{}),V.map((e,t)=>{let a=(0,d.toMinutes)(e.time),r=e.end?(0,d.toMinutes)(e.end):a+30,i=r<L&&!e.done||!!e.done,s=!e.done&&a<=L&&L<r,p=e.done?l.w4.colors.mainTextFaint:g[e.tag];return(0,n.jsxs)(j,{delay:t,past:i,children:[(0,n.jsx)(k,{type:"button",active:s,past:i,onClick:()=>Z(e.id),"aria-label":o("agenda.toggleDone"),children:s?o("agenda.now"):e.time}),(0,n.jsxs)(M,{type:"button",done:!!e.done,onClick:()=>Z(e.id),children:[(0,n.jsx)(C,{color:p,active:s}),(0,n.jsx)("div",{className:"title",children:e.title}),(0,n.jsxs)("div",{className:"meta",style:{color:g[e.tag]},children:[o(`agenda.tag.${e.tag}`),e.end?` \xb7 ${e.time}–${e.end}`:` \xb7 ${e.time}`]})]}),(0,n.jsx)(R,{className:"delete-btn",type:"button",onClick:()=>ee(e.id),"aria-label":o("agenda.delete"),title:o("agenda.delete"),children:(0,n.jsx)(c.In,{name:"close",size:12})})]},e.id)})]})]})})}}}]);