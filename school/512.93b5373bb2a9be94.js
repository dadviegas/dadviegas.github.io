...
`,$=s().p`
  ...
  position: relative;
  z-index: 1;
  animation: ${x} 0.5s ease 0.1s both;
`,k=s().div`
  display: grid;
  ...
  position: relative;
  z-index: 1;
  animation: ${x} 0.5s ease 0.2s both;
...
`,v=s().h2`
  ...
  position: relative;
  z-index: 1;
  animation: ${x} 0.5s ease 0.25s both;
`,z=(0,l.keyframes)`
...
`,j=s().div`
  ...
  border-radius: 50%;
  background: white;
  animation: ${z} ${({dur:e})=>e}s ease-in-out infinite;
...
`,E=s().div`
  ...
  opacity: 0;
  pointer-events: none;
  animation: ${T} ${({delay:e})=>e}s ease-out infinite;
...
`,S=[{x:3,y:5,size:1.5,delay:0,dur:3.2},{x:8,y:35,size:2,delay:1.8,dur:3.4},{x:12,y:70,size:1.5,delay:.6,dur:4.1},{x:18,y:15,size:2.5,delay:2.4,dur:3},{x:22,y:55,size:1.5,delay:.3,dur:4.5},{x:28,y:88,size:2,delay:1.1,dur:3.6},{x:33,y:25,size:1.5,delay:2.8,dur:4},{x:40,y:60,size:2,delay:.9,dur:3.3},{x:45,y:8,size:2.5,delay:1.5,dur:3.8},{x:50,y:45,size:1.5,delay:2.1,dur:4.3},{x:55,y:78,size:2,delay:.4,dur:3.1},{x:60,y:18,size:1.5,delay:1.7,dur:4.6},{x:65,y:50,size:2.5,delay:2.6,dur:3.5},{x:70,y:85,size:1.5,delay:.2,dur:3.9},{x:75,y:30,size:2,delay:1.3,dur:4.2},{x:80,y:65,size:1.5,delay:2.9,dur:3.7},{x:85,y:10,size:2,delay:.7,dur:3.4},{x:88,y:42,size:2.5,delay:1.9,dur:4.4},{x:92,y:75,size:1.5,delay:.5,dur:3.2},{x:96,y:22,size:2,delay:2.3,dur:3.8}],P=s().button`
  ...
  position: relative;
  overflow: hidden;
  transition: border-color ${c.w4.transitions.slow}, transform 0.3s cubic-bezier(0.34, 1.56, 0.64, 1), box-shadow ${c.w4.transitions.slow};
  ...
  &::before {
    ...
    opacity: 0.5;
    transition: opacity ${c.w4.transitions.slow};
  }
...
`,R=s().span`
  ...
  transition: filter ${c.w4.transitions.slow};
`,M=s().span`
  font-size: ${c.w4.typography.fontSizeMd};
  font-weight: 700;
  color: ${c.w4.colors.mainText};
...
`,s().button`
  ...
  font-family: ${c.w4.typography.fontFamily};
  cursor: pointer;
  transition: background ${c.w4.transitions.base}, color ${c.w4.transitions.base}, box-shadow ${c.w4.transitions.base};
  white-space: nowrap;
...
`;let X=s().button`
  ...
  font-family: ${c.w4.typography.fontFamily};
  cursor: pointer;
  transition: border-color ${c.w4.transitions.base}, color ${c.w4.transitions.base};
...
`,N=s().div`
  ...
  align-items: center;
  gap: ${c.w4.spacing.sm};
`,C={pt:"O que vamos aprender hoje?",en:"What shall we learn today?"},L={pt:"Escolhe uma disciplina para come\xe7ar",en:"Pick a subject to get started"},W=document.getElementById("root");if(!W)throw Error("Root element #root not found");(0,i.createRoot)(W).render((0,o.jsx)(function({topBarRight:e}){let[a,t]=(0,r.useState)(u),[i]=(0,m.Ym)(),n="pt"===i?"pt":"en";if((0,r.useEffect)(()=>{let e=()=>t(u());return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[]),!a)return(0,o.jsx)(p.PE,{title:"School",sidebar:null,topBarRight:e,children:(0,o.jsxs)(b,{children:[S.map((e,a)=>(0,o.jsx)(j,{x:e.x,y:e.y,size:e.size,delay:e.delay,dur:e.dur},a)),(0,o.jsx)(E,{top:15,delay:12}),(0,o.jsx)(E,{top:55,delay:25}),(0,o.jsx)(y,{children:C[n]}),(0,o.jsx)($,{children:L[n]}),(0,o.jsx)(v,{children:"pt"===n?"Disciplinas":"Subjects"}),(0,o.jsx)(k,{columns:4,children:g.map((e,a)=>(0,o.jsxs)(P,{accentColor:e.color,onClick:()=>{t(e.key),window.location.hash=`#/${e.hashPrefix}`},children:[(0,o.jsx)(R,{className:"card-emoji",delay:.4*a,children:e.emoji}),(0,o.jsx)(M,{children:e.label[n]}),(0,o.jsx)(Y,{children:e.description[n]})]},e.key))})]})});let s=(0,o.jsxs)(N,{children:[(0,o.jsxs)(X,{onClick:()=>{t(null),window.location.hash="#/school"},children:["←",(0,o.jsxs)("span",{className:"back-label",children:[" ","pt"===n?"Disciplinas":"Subjects"]})]}),e]}),l=g.find(e=>e.key===a);return(0,o.jsx)(d.WO,{hashPrefix:l.hashPrefix,defaultLang:"pt",locale:i,languages:l.languages,welcomeTitle:l.welcomeTitle,welcomeSub:l.welcomeSub,topBarRight:s},a)},{}))}}]);