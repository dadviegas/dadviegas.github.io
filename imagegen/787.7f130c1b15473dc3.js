...
`;function y({url:e,status:o,width:r,height:a,onLoad:i,onError:n,onReroll:l,onRetry:s}){return(0,t.jsxs)(p,{children:[(0,t.jsx)(g,{ratio:r/a,children:(0,t.jsxs)(h,{children:["idle"===o&&(0,t.jsxs)(b,{children:[(0,t.jsx)("span",{style:{fontSize:40,opacity:.3},children:"\uD83C\uDFA8"}),"Generate an image to get started"]}),"loading"===o&&(0,t.jsx)(x,{}),"error"===o&&(0,t.jsxs)(m,{children:[(0,t.jsx)(d.In,{name:"alert-circle",size:32}),"Failed to generate image",(0,t.jsx)(d.$n,{variant:"ghost",size:"sm",onClick:s,children:"Try Again"})]}),e&&("loaded"===o||"loading"===o)&&(0,t.jsx)(f,{src:e,alt:"Generated image",crossOrigin:"anonymous",referrerPolicy:"no-referrer",onLoad:e=>i(e.currentTarget),onError:n,style:{display:"loaded"===o?"block":"none"}})]})}),"loaded"===o&&(0,t.jsxs)(w,{className:"overlay",children:[(0,t.jsxs)(u,{onClick:()=>{e&&window.open(e,"_blank","noopener")},children:[(0,t.jsx)(d.In,{name:"download",size:14})," Download"]}),(0,t.jsxs)(u,{onClick:l,children:[(0,t.jsx)(d.In,{name:"refresh-cw",size:14})," New Variation"]})]})]})}},6396(e,o,r){r.d(o,{q:()=>u});var t=r(5723),a=r(6859),i=r.n(a),n=r(2799),l=r(6063),d=r(132),s=r(2004);let c=(0,n.keyframes)`
...
`,w=i().forwardRef(function({variant:e="ghost",size:o="md",icon:r,iconRight:a,children:i,...n},l){return(0,t.jsxs)(m,{ref:l,variant:e,size:o,...n,children:[r,i,a]})}),u={default:d.w4.colors.accent,danger:"#f85149"},y={default:d.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"};l().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`,F=i().forwardRef(function({variant:e="default",dotColor:o,children:r,onClick:a,...i},n){return(0,t.jsxs)(T,{ref:n,variant:e,clickable:!!a,onClick:a,type:i.type??"button",...i,children:[o&&(0,t.jsx)(j,{color:o}),r]})}),S={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:d.w4.colors.accentMuted},H={neutral:d.w4.colors.mainTextMuted,live:d.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:d.w4.colors.accent};l().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${d.w4.typography.fontFamilyMono};
...
`,l().div`
  position: relative;
`;let Z="260px",U="56px",J="44px",K=l().header`
  display: flex;
  align-items: center;
...
`,el=l().div`
  ...
  overflow: hidden;
`,ed=l().aside`
  width: ${({collapsed:e})=>e?U:Z};
  min-width: ${({collapsed:e})=>e?U:Z};
  background: ${d.w4.colors.sidebarBg};
  border-right: 1px solid ${d.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,ec=l().main`
  ...
  display: flex;
  flex-direction: column;
`;function ep(){return(0,t.jsxs)(eo,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:[(0,t.jsx)(er,{"aria-hidden":"true",children:"A"}),(0,t.jsx)(et,{children:"Atlantis"})]})}let eg="atlantis:sidebar-collapsed";function eh({sidebar:e,children:o,topBarRight:n,title:l="Atlantis",activeId:d=null}){let[s,c]=(0,a.useState)(()=>{try{return"true"===localStorage.getItem(eg)}catch{return!1}}),[p,g]=(0,a.useState)(null),h=(0,a.useRef)(),x=()=>c(e=>{let o=!e;try{localStorage.setItem(eg,String(o))}catch{}return o}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(r.bind(r,5816)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,t.jsx)(q.I.Provider,{value:{collapsed:s,toggle:x,flyout:p,openFlyout:(e,o,r)=>{clearTimeout(h.current),g({entry:e,anchorY:o,onSelect:r})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,t.jsxs)(el,{children:[(0,t.jsxs)(K,{children:[e&&(0,t.jsx)(Q,{children:(0,t.jsx)(ee,{onClick:x,title:s?"Expand sidebar":"Collapse sidebar",children:(0,t.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("path",{d:"M9 3v18"})]})})}),(0,t.jsx)(ep,{}),l&&(0,t.jsx)(ea,{children:l}),n&&(0,t.jsx)(ei,{children:n})]}),(0,t.jsxs)(en,{children:[null!=e&&(0,t.jsx)(ed,{collapsed:s,children:(0,t.jsx)(es,{children:e})}),(0,t.jsx)(ec,{children:o})]}),p&&(0,t.jsx)(i().Suspense,{fallback:null,children:(0,t.jsx)(f,{activeId:d})})]})})}l().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
