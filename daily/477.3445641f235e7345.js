"use strict";(self.webpackChunk_atlantis_daily=self.webpackChunk_atlantis_daily||[]).push([["477"],{5198(e,o,t){t.d(o,{R:()=>m});var r=t(5723),a=t(7991),i=t(6859),n=t.n(i),l=t(2799),d=t(6063),s=t(8856);let p=t(8085).default.color,c=(0,l.keyframes)`
...
`,h=n().div`
  ...
  background: radial-gradient(ellipse at center, #0d2818 0%, #0f1220 100%);
  ...
  &::before {
    ...
    background: radial-gradient(ellipse at 50% 60%, rgba(52, 211, 153, 0.05), transparent 70%);
    pointer-events: none;
  }
`,x=n().div`
  position: relative;
...
`,f=n().div`
  ...
  z-index: 10;
  animation: ${({active:e})=>e?`${g} 1.6s ease-in-out infinite`:"none"};
`,b=n().div`
...
`,b=({size:e=14,strokeWidth:o=1.75})=>(0,r.jsxs)("svg",{width:e,height:e,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:o,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,r.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,r.jsx)("polyline",{points:"14 2 14 8 20 8"})]});function m({iconKey:e}){let o=e?c[e]:void 0;return o?(0,r.jsx)("svg",{width:14,height:14,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,dangerouslySetInnerHTML:{__html:o}}):(0,r.jsx)(b,{})}function w({entries:e,activeId:o,onSelect:t}){return(0,r.jsx)(r.Fragment,{children:e.map(e=>e.children?(0,r.jsx)(i().Fragment,{children:(0,r.jsx)(w,{entries:e.children,activeId:o,onSelect:t})},e.id):(0,r.jsxs)(f,{active:o===e.id,onClick:()=>t(e),children:[(0,r.jsx)(m,{iconKey:e.icon}),e.name]},e.id))})}function u({activeId:e}){let{flyout:o,scheduleFlyoutClose:t,cancelFlyoutClose:a}=(0,p.c)();if(!o)return null;let i=o.entry.icon?c[o.entry.icon]:void 0;return(0,r.jsxs)(h,{anchorY:o.anchorY,onMouseEnter:a,onMouseLeave:t,children:[(0,r.jsxs)(x,{children:[i?(0,r.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,dangerouslySetInnerHTML:{__html:i}}):(0,r.jsx)(b,{size:13,strokeWidth:2}),o.entry.name]}),(0,r.jsx)(w,{entries:o.entry.children??[],activeId:e,onSelect:e=>{o.onSelect(e),t()}})]})}},7993(e,o,t){t.d(o,{I:()=>a,c:()=>i});var r=t(7991);let a=(0,r.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),i=()=>(0,r.useContext)(a)},3236(e,o,t){t.d(o,{K0:()=>v,YZ:()=>R,$n:()=>w,PE:()=>ef,n6:()=>z,In:()=>T});var r=t(5723),a=t(7991),i=t.n(a),n=t(6859),l=t.n(n),d=t(6063);let s={ghost:"transparent",accent:"transparent",primary:d.w4.colors.accent,success:"#238636",danger:"#da3633"},p={ghost:d.w4.colors.sidebarHover,accent:"rgba(88,166,255,0.10)",primary:d.w4.colors.accentHover,success:"#2ea043",danger:"#f85149"},c={ghost:d.w4.colors.border,accent:d.w4.colors.accent,primary:d.w4.colors.accent,success:"#238636",danger:"#da3633"},g={ghost:d.w4.colors.mainTextMuted,accent:d.w4.colors.accent,primary:"#fff",success:"#fff",danger:"#fff"},h={ghost:d.w4.colors.mainText,accent:d.w4.colors.accent,primary:"#fff",success:"#fff",danger:"#fff"},x={sm:"28px",md:"30px"},f={sm:"0 10px",md:"0 12px"},b={sm:"12px",md:"12px"},m=l().button`
  display: inline-flex;
  align-items: center;
  justify-content: center;
  gap: 6px;
  ...
  &:hover:not(:disabled) {
    ...
    color: ${({variant:e})=>h[e]};
    border-color: ${({variant:e})=>"ghost"===e?d.w4.colors.accent:c[e]};
  }
...
`,w=i().forwardRef(function({variant:e="ghost",size:o="md",icon:t,iconRight:a,children:i,...n},l){return(0,r.jsxs)(m,{ref:l,variant:e,size:o,...n,children:[t,i,a]})}),u={default:d.w4.colors.accent,danger:"#f85149"},y={default:d.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"},$=l().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`,v=i().forwardRef(function({active:e=!1,shape:o="square",tone:t="default",children:a,...i},n){return(0,r.jsx)($,{ref:n,active:e,shape:o,tone:t,...i,children:a})});l().div`
  position: relative;
  display: inline-flex;
`,l().div`
  position: absolute;
...
`;let S={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:d.w4.colors.accentMuted},H={neutral:d.w4.colors.mainTextMuted,live:d.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:d.w4.colors.accent};l().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${d.w4.typography.fontFamilyMono};
...
`;let L=l().div`
  ...
  align-items: center;
  gap: 8px;
`;function R({children:e,...o}){return(0,r.jsx)(L,{...o,children:e})}l().label`
  display: flex;
  align-items: center;
  gap: 10px;
...
`,Y.A,Y.A['pre[class*="language-"]'],d.w4.colors.codeBg,Y.A['code[class*="language-"]'],l().div`
  background: ${({bg:e})=>e};
...
`,l().div`
  position: relative;
`;let U="260px",J="56px",Q="44px",ee=l().header`
  display: flex;
  align-items: center;
...
`,es=l().div`
  ...
  overflow: hidden;
`,ep=l().aside`
  width: ${({collapsed:e})=>e?J:U};
  min-width: ${({collapsed:e})=>e?J:U};
  background: ${d.w4.colors.sidebarBg};
  border-right: 1px solid ${d.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,eg=l().main`
  ...
  display: flex;
  flex-direction: column;
`;function eh(){return(0,r.jsxs)(er,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:[(0,r.jsx)(ea,{"aria-hidden":"true",children:"A"}),(0,r.jsx)(ei,{children:"Atlantis"})]})}let ex="atlantis:sidebar-collapsed";function ef({sidebar:e,children:o,topBarRight:n,title:l="Atlantis",activeId:d=null}){let[s,p]=(0,a.useState)(()=>{try{return"true"===localStorage.getItem(ex)}catch{return!1}}),[c,g]=(0,a.useState)(null),h=(0,a.useRef)(),x=()=>p(e=>{let o=!e;try{localStorage.setItem(ex,String(o))}catch{}return o}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(t.bind(t,5816)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(I.I.Provider,{value:{collapsed:s,toggle:x,flyout:c,openFlyout:(e,o,t)=>{clearTimeout(h.current),g({entry:e,anchorY:o,onSelect:t})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,r.jsxs)(es,{children:[(0,r.jsxs)(ee,{children:[e&&(0,r.jsx)(eo,{children:(0,r.jsx)(et,{onClick:x,title:s?"Expand sidebar":"Collapse sidebar",children:(0,r.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,r.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,r.jsx)("path",{d:"M9 3v18"})]})})}),(0,r.jsx)(eh,{}),l&&(0,r.jsx)(en,{children:l}),n&&(0,r.jsx)(el,{children:n})]}),(0,r.jsxs)(ed,{children:[null!=e&&(0,r.jsx)(ep,{collapsed:s,children:(0,r.jsx)(ec,{children:e})}),(0,r.jsx)(eg,{children:o})]}),c&&(0,r.jsx)(i().Suspense,{fallback:null,children:(0,r.jsx)(f,{activeId:d})})]})})}l().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
