...
`,E=l.default.span`color: #79c0ff;`,J=l.default.span`color: #a5d6ff;`,R=l.default.span`color: #f78166;`,A=l.default.span`color: #d2a8ff;`,B=l.default.span`color: ${t.w4.colors.mainTextMuted}; font-style: italic;`,L=l.default.span`color: ${t.w4.colors.mainTextMuted};`,P=l.default.span`
  font-size: 10px;
  color: ${t.w4.colors.mainTextMuted};
  margin-left: 4px;
`,_=l.default.div`
