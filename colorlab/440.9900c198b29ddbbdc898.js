...
`;function z({iconKey:a}){const o=a?c.t[a]??l.A:l.A;return(0,g.jsx)(o,{size:14,strokeWidth:1.75})}function p({entries:a,activeId:o,onSelect:n}){return(0,g.jsx)(g.Fragment,{children:a.map(a=>a.children?(0,g.jsx)(e.Fragment,{children:(0,g.jsx)(p,{entries:a.children,activeId:o,onSelect:n})},a.id):(0,g.jsxs)(f,{active:o===a.id,onClick:()=>n(a),children:[(0,g.jsx)(z,{iconKey:a.icon}),a.name]},a.id))})}function y({activeId:a}){const{flyout:o,scheduleFlyoutClose:n,cancelFlyoutClose:e}=(0,m.c)();if(!o)return null;const i=o.entry.icon?c.t[o.entry.icon]??l.A:l.A;return(0,g.jsxs)(s,{anchorY:o.anchorY,onMouseEnter:e,onMouseLeave:n,children:[(0,g.jsxs)(u,{children:[(0,g.jsx)(i,{size:13,strokeWidth:2}),o.entry.name]}),(0,g.jsx)(p,{entries:o.entry.children??[],activeId:a,onSelect:a=>{o.onSelect(a),n()}})]})}},5959(a,o,n){n.d(o,{c:()=>t});var e=n(7359);const i=(0,e.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),t=()=>(0,e.useContext)(i)},5185(a,o,n){n.d(o,{t:()=>N});var e=n(9038),i=n(6896),t=n(7901),l=n(9848),r=n(2164),m=n(3539),c=n(1837),g=n(2314),d=n(5751),s=n(255),u=n(9633),f=n(2946),z=n(822),p=n(3317),y=n(2709),b=n(3517),h=n(7032),A=n(6949),x=n(8218),w=n(6829),k=n(5553),v=n(9591),M=n(2820),S=n(4621),$=n(6673),B=n(9033),E=n(1365),P=n(5912),T=n(3249),j=n(9161),C=n(2932),L=n(4525),K=n(7230);const N={activity:i.A,book:l.A,"book-open":t.A,"circle-dot":m.A,feather:g.A,"file-text":d.A,hash:p.A,heart:y.A,landmark:b.A,leaf:A.A,map:v.A,package:$.A,compass:c.A,"git-branch":f.A,github:z.A,minus:S.A,terminal:T.A,"pie-chart":e.A,plus:E.A,slash:P.A,zap:K.A,bot:r.A,lightbulb:x.A,"message-square":M.A,wrench:C.A,x:L.A,"layout-grid":h.A,list:w.A,file:s.A,folder:u.A,"map-pin":k.A,"pen-tool":B.A,type:j.A}},906(a,o,n){n.d(o,{w4:()=>e.w});var e=n(217),i=(n(7359),n(3233));n(5723),i.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
//# sourceMappingURL=440.9900c198b29ddbbdc898.js.map