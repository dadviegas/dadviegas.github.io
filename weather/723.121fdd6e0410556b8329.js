...
`;function p({iconKey:a}){const e=a?c.t[a]??l.A:l.A;return(0,s.jsx)(e,{size:14,strokeWidth:1.75})}function y({entries:a,activeId:e,onSelect:o}){return(0,s.jsx)(s.Fragment,{children:a.map(a=>a.children?(0,s.jsx)(n.Fragment,{children:(0,s.jsx)(y,{entries:a.children,activeId:e,onSelect:o})},a.id):(0,s.jsxs)(u,{active:e===a.id,onClick:()=>o(a),children:[(0,s.jsx)(p,{iconKey:a.icon}),a.name]},a.id))})}function z({activeId:a}){const{flyout:e,scheduleFlyoutClose:o,cancelFlyoutClose:n}=(0,m.c)();if(!e)return null;const i=e.entry.icon?c.t[e.entry.icon]??l.A:l.A;return(0,s.jsxs)(g,{anchorY:e.anchorY,onMouseEnter:n,onMouseLeave:o,children:[(0,s.jsxs)(f,{children:[(0,s.jsx)(i,{size:13,strokeWidth:2}),e.entry.name]}),(0,s.jsx)(y,{entries:e.entry.children??[],activeId:a,onSelect:a=>{e.onSelect(a),o()}})]})}},5959(a,e,o){o.d(e,{I:()=>i,c:()=>t});var n=o(7359);const i=(0,n.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),t=()=>(0,n.useContext)(i)},5185(a,e,o){o.d(e,{t:()=>na});var n=o(9510),i=o(9038),t=o(7400),l=o(8207),r=o(7902),m=o(6896),c=o(7901),s=o(9848),d=o(2164),g=o(3045),f=o(3775),u=o(3539),p=o(1783),y=o(1837),z=o(4494),b=o(2314),h=o(5751),x=o(255),w=o(9633),A=o(2946),v=o(822),$=o(6720),k=o(3317),S=o(2709),M=o(9301),B=o(3517),T=o(7032),C=o(6949),E=o(8218),j=o(6829),P=o(5553),L=o(9591),R=o(2820),N=o(4621),G=o(2534),K=o(6673),I=o(9033),F=o(1365),D=o(2937),H=o(5912),V=o(158),Y=o(8641),U=o(8607),O=o(3249),_=o(1821),Z=o(5889),J=o(7170),W=o(9161),Q=o(1849),q=o(1187),X=o(7747),aa=o(2932),ea=o(4525),oa=o(7230);const na={activity:m.A,"a-large-small":r.A,"bar-chart-2":n.A,book:s.A,"book-open":c.A,briefcase:g.A,calendar:f.A,clock:p.A,"circle-dot":u.A,compass:y.A,droplets:z.A,feather:b.A,file:x.A,"file-text":h.A,folder:w.A,"git-branch":A.A,github:v.A,globe:$.A,grid:t.A,hash:k.A,heart:S.A,hexagon:M.A,landmark:B.A,layers:l.A,"layout-grid":T.A,leaf:C.A,lightbulb:E.A,list:j.A,map:L.A,"map-pin":P.A,"message-square":R.A,minus:N.A,mountain:G.A,package:K.A,"pen-tool":I.A,"pie-chart":i.A,plus:F.A,ruler:D.A,slash:H.A,square:V.A,star:Y.A,sun:U.A,terminal:O.A,thermometer:_.A,triangle:Z.A,truck:J.A,type:W.A,users:Q.A,waves:q.A,wind:X.A,wrench:aa.A,x:ea.A,zap:oa.A,bot:d.A}},5723(a,e,o){o.d(e,{rh:()=>J,PE:()=>B,CD:()=>V,qs:()=>Q,rz:()=>q});var n=o(217),i=o(7359),t=o(3233),l=o(8104);t.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
//# sourceMappingURL=723.121fdd6e0410556b8329.js.map