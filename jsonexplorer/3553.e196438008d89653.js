...
`;function oB({iconKey:o}){let e=o?oA[o]??d.A:d.A;return(0,t.jsx)(e,{size:14,strokeWidth:1.75})}function oR({entries:o,activeId:e,onSelect:a}){return(0,t.jsx)(t.Fragment,{children:o.map(o=>o.children?(0,t.jsx)(i().Fragment,{children:(0,t.jsx)(oR,{entries:o.children,activeId:e,onSelect:a})},o.id):(0,t.jsxs)(oF,{active:e===o.id,onClick:()=>a(o),children:[(0,t.jsx)(oB,{iconKey:o.icon}),o.name]},o.id))})}function oP({activeId:o}){let{flyout:e,scheduleFlyoutClose:a,cancelFlyoutClose:r}=(0,p.c)();if(!e)return null;let i=e.entry.icon?oA[e.entry.icon]??d.A:d.A;return(0,t.jsxs)(oS,{anchorY:e.anchorY,onMouseEnter:r,onMouseLeave:a,children:[(0,t.jsxs)(oj,{children:[(0,t.jsx)(i,{size:13,strokeWidth:2}),e.entry.name]}),(0,t.jsx)(oR,{entries:e.entry.children??[],activeId:o,onSelect:o=>{e.onSelect(o),a()}})]})}},814(o,e,a){a.d(e,{I:()=>r,c:()=>i});var t=a(7991);let r=(0,t.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),i=()=>(0,t.useContext)(r)},5726(o,e,a){a.d(e,{PL:()=>K,MJ:()=>W,mZ:()=>D,KL:()=>L,cL:()=>p.c,Is:()=>N,UO:()=>og,PE:()=>B,w4:()=>t.w4});var t=a(1316),r=a(5723),i=a(7991),n=a.n(i),l=a(6859),s=a.n(l);s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,U=s().div`
  ...
  color: ${t.w4.colors.sidebarTextMuted};
  font-family: ${t.w4.typography.fontFamily};
`;function W({onSave:o,onUpdate:e,onCancel:a,existingDoc:t}){let[n,l]=(0,i.useState)(t?.name??""),s=(0,i.useRef)(null);return(0,i.useEffect)(()=>{s.current?.focus(),t&&s.current?.select()},[t]),(0,r.jsx)(I,{onClick:a,children:(0,r.jsxs)(V,{onClick:o=>o.stopPropagation(),children:[(0,r.jsx)(Y,{children:"Save document"}),t&&e&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(U,{children:"Update the current version or save as a new one."}),(0,r.jsxs)(_,{children:[(0,r.jsx)(O,{onClick:a,children:"Cancel"}),(0,r.jsxs)(O,{danger:!0,onClick:e,children:['Update "',t.name,'"']})]}),(0,r.jsx)(J,{})]}),(0,r.jsx)(G,{ref:s,value:n,onChange:o=>l(o.target.value),onKeyDown:r=>{"Enter"===r.key&&n.trim()&&(t&&n.trim()===t.name&&e?e():o(n.trim())),"Escape"===r.key&&a()},placeholder:t?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,r.jsxs)(_,{children:[!t&&(0,r.jsx)(O,{onClick:a,children:"Cancel"}),(0,r.jsx)(O,{primary:!0,disabled:!n.trim(),onClick:()=>o(n.trim()),children:"Save as new"})]})]})})}let Z=(0,d.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,q=(0,d.keyframes)`
