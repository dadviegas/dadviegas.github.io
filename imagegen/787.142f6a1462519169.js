"use strict";(self.webpackChunk_atlantis_imagegen=self.webpackChunk_atlantis_imagegen||[]).push([["787"],{3758(o,a,e){function n(o){let a=encodeURIComponent(o.prompt),e=new URLSearchParams({width:String(o.width),height:String(o.height),seed:String(o.seed),model:o.model,nologo:"true"});return`https://image.pollinations.ai/prompt/${a}?${e}`}async function t(o,a){let e=await fetch("https://api.groq.com/openai/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${o}`},body:JSON.stringify({model:"llama-3.1-8b-instant",messages:[{role:"system",content:"You are an expert at writing image generation prompts. Enhance the user's prompt to be more descriptive and visually compelling. Include details about lighting, style, composition, and mood. Return ONLY the enhanced prompt text, no explanation or quotes."},{role:"user",content:a}],stream:!1,max_tokens:200})});if(!e.ok){let o=await e.text();throw Error(`Groq ${e.status}: ${o}`)}let n=await e.json();return n.choices?.[0]?.message?.content?.trim()??a}function i(){try{let o=localStorage.getItem("atlantis:promptlab:keys");if(!o)return"";return JSON.parse(o).groq??""}catch{return""}}e.d(a,{Vi:()=>i,fG:()=>t,i4:()=>n})},3487(o,a,e){e.d(a,{Z:()=>z});var n=e(5723),t=e(7991),i=e(6859),r=e.n(i),l=e(2799),s=e(4117),c=e(4525),d=e(6665);let m=(0,l.keyframes)`
...
`,h=r().div`
  ...
  opacity: 0;
  transition: opacity 0.15s;
`;function x({item:o,onSelect:a,onDelete:e}){let i=function(o){let a=`https://image.pollinations.ai/prompt/${encodeURIComponent(o.prompt)}?width=200&height=200&seed=${o.seed}&model=${o.model}&nologo=true`,[e,n]=(0,t.useState)(a);return(0,t.useEffect)(()=>{let a=null;return(0,d.if)(o.id).then(o=>{o&&(a=o,n(o))}),()=>{a&&URL.revokeObjectURL(a)}},[o.id]),e}(o);return(0,n.jsxs)(f,{onClick:a,children:[(0,n.jsx)(b,{src:i,alt:o.prompt,loading:"lazy",referrerPolicy:"no-referrer"}),(0,n.jsx)(y,{className:"delete-btn",role:"button",onClick:o=>{o.stopPropagation(),e()},children:(0,n.jsx)(c.A,{size:12})}),(0,n.jsx)(h,{className:"prompt-label",children:o.prompt})]})}function z({items:o,onSelect:a,onDelete:e}){return 0===o.length?null:(0,n.jsxs)(g,{children:[(0,n.jsx)(u,{children:"Recent Generations"}),(0,n.jsx)(p,{children:o.map(o=>(0,n.jsx)(x,{item:o,onSelect:()=>a(o),onDelete:()=>e(o.id)},o.id))})]})}},9610(o,a,e){e.d(a,{e:()=>A});var n=e(5723),t=e(6859),i=e.n(t),r=e(2799),l=e(4117),s=e(153),c=e(889),d=e(9421);let m=(0,r.keyframes)`
...
`;function A({url:o,status:a,width:e,height:t,onLoad:i,onError:r,onReroll:l,onRetry:m}){return(0,n.jsxs)(u,{children:[(0,n.jsx)(p,{ratio:e/t,children:(0,n.jsxs)(f,{children:["idle"===a&&(0,n.jsxs)(h,{children:[(0,n.jsx)("span",{style:{fontSize:40,opacity:.3},children:"\uD83C\uDFA8"}),"Generate an image to get started"]}),"loading"===a&&(0,n.jsx)(b,{}),"error"===a&&(0,n.jsxs)(x,{children:[(0,n.jsx)(s.A,{size:32}),"Failed to generate image",(0,n.jsx)($,{onClick:m,children:"Try Again"})]}),o&&("loaded"===a||"loading"===a)&&(0,n.jsx)(y,{src:o,alt:"Generated image",crossOrigin:"anonymous",referrerPolicy:"no-referrer",onLoad:o=>i(o.currentTarget),onError:r,style:{display:"loaded"===a?"block":"none"}})]})}),"loaded"===a&&(0,n.jsxs)(z,{className:"overlay",children:[(0,n.jsxs)(w,{onClick:()=>{o&&window.open(o,"_blank","noopener")},children:[(0,n.jsx)(c.A,{size:14})," Download"]}),(0,n.jsxs)(w,{onClick:l,children:[(0,n.jsx)(d.A,{size:14})," New Variation"]})]})]})}},6396(o,a,e){e.d(a,{q:()=>$});var n=e(5723),t=e(6859),i=e.n(t),r=e(2799),l=e(4117),s=e(7071),c=e(3482),d=e(2569);let m=(0,r.keyframes)`
...
`,f=i().button`
  ...
  gap: 6px;
  padding: 10px 16px;
  background: ${({variant:o,disabled:a})=>a?l.w4.colors.border:"accent"===o?l.w4.colors.accent:l.w4.colors.surface};
  color: ${({variant:o,disabled:a})=>a?l.w4.colors.mainTextMuted:"accent"===o?"#fff":l.w4.colors.mainText};
  border: 1px solid ${({variant:o,disabled:a})=>a?l.w4.colors.border:"accent"===o?l.w4.colors.accent:l.w4.colors.border};
  border-radius: ${l.w4.borderRadius.md};
  font-size: 14px;
  font-weight: 600;
  ...
  white-space: nowrap;
  &:hover {
    background: ${({variant:o,disabled:a})=>a?l.w4.colors.border:"accent"===o?l.w4.colors.accentHover:l.w4.colors.sidebarHover};
  }
`,b=i()(s.A)`
...
`,h=i().button`
  ...
  background: ${({active:o})=>o?`${l.w4.colors.accent}20`:l.w4.colors.surface};
...
`,x=i().select`
  ...
  cursor: pointer;
  outline: none;
`,z=[{label:"Square 1:1",w:1024,h:1024},{label:"Landscape 16:9",w:1344,h:768},{label:"Portrait 9:16",w:768,h:1344},{label:"Wide 21:9",w:1344,h:576}],w=[{id:"flux",label:"Flux"},{id:"turbo",label:"Turbo"},{id:"flux-realism",label:"Flux Realism"}];function $({prompt:o,onPromptChange:a,width:e,height:t,model:i,onSizeChange:r,onModelChange:l,onGenerate:s,onEnhance:m,generating:A,enhancing:v,canEnhance:k}){let S=!!o.trim()&&!A;return(0,n.jsxs)(g,{children:[(0,n.jsxs)(u,{children:[(0,n.jsx)(p,{placeholder:"Describe the image you want to create...",value:o,onChange:o=>a(o.target.value),onKeyDown:o=>{"Enter"===o.key&&S&&(o.preventDefault(),s())}}),(0,n.jsxs)(f,{variant:"subtle",disabled:!k||v||!o.trim(),onClick:m,title:k?"Enhance prompt with AI":"Add a Groq key in Prompt Lab to enable",children:[v?(0,n.jsx)(b,{size:14}):(0,n.jsx)(c.A,{size:14}),"Enhance"]}),(0,n.jsxs)(f,{variant:"accent",disabled:!S,onClick:s,children:[A?(0,n.jsx)(b,{size:14}):(0,n.jsx)(d.A,{size:14}),"Generate"]})]}),(0,n.jsxs)(y,{children:[z.map(o=>(0,n.jsx)(h,{active:e===o.w&&t===o.h,onClick:()=>r(o.w,o.h),children:o.label},o.label)),(0,n.jsx)(x,{value:i,onChange:o=>l(o.target.value),children:w.map(o=>(0,n.jsx)("option",{value:o.id,children:o.label},o.id))})]})]})}},6665(o,a,e){e.d(a,{CJ:()=>i,XZ:()=>l,if:()=>r});let n="images";function t(){return new Promise((o,a)=>{let e=indexedDB.open("atlantis-imagegen-cache",1);e.onupgradeneeded=()=>{let o=e.result;o.objectStoreNames.contains(n)||o.createObjectStore(n,{keyPath:"id"})},e.onsuccess=()=>o(e.result),e.onerror=()=>a(e.error)})}async function i(o,a){try{let e=await new Promise(o=>{try{let e=document.createElement("canvas");e.width=a.naturalWidth,e.height=a.naturalHeight;let n=e.getContext("2d");if(!n)return void o(null);n.drawImage(a,0,0),e.toBlob(a=>o(a),"image/png")}catch{o(null)}});if(!e)return;let i=await t(),r=i.transaction(n,"readwrite").objectStore(n);r.put({id:o,blob:e,cachedAt:Date.now()});let l=r.getAll();l.onsuccess=()=>{let o=l.result;if(o.length>10)for(let a of(o.sort((o,a)=>a.cachedAt-o.cachedAt),o.slice(10)))r.delete(a.id)},i.close()}catch{}}async function r(o){try{let a=await t();return new Promise(e=>{let t=a.transaction(n,"readonly").objectStore(n).get(o);t.onsuccess=()=>{a.close();let o=t.result;o?.blob?e(URL.createObjectURL(o.blob)):e(null)},t.onerror=()=>{a.close(),e(null)}})}catch{return null}}async function l(o){try{let a=await t();a.transaction(n,"readwrite").objectStore(n).delete(o),a.close()}catch{}}},7871(o,a,e){e.d(a,{$5:()=>t,DZ:()=>d,M5:()=>c,Qd:()=>i,vI:()=>r});let n="atlantis:imagegen:gallery";function t(){try{return JSON.parse(localStorage.getItem(n)??"[]")}catch{return[]}}function i(o){let a=t().filter(a=>a.id!==o.id),e=[o,...a].slice(0,50);try{localStorage.setItem(n,JSON.stringify(e))}catch{}return e}function r(o){let a=t().filter(a=>a.id!==o);try{localStorage.setItem(n,JSON.stringify(a))}catch{}return a}let l={width:1024,height:1024,model:"flux"},s="atlantis:imagegen:settings";function c(){try{return{...l,...JSON.parse(localStorage.getItem(s)??"{}")}}catch{return l}}function d(o){try{localStorage.setItem(s,JSON.stringify(o))}catch{}}},7330(o,a,e){e.d(a,{FlyoutPanel:()=>oC});var n=e(5723),t=e(7991),i=e.n(t),r=e(6859),l=e.n(r),s=e(2799),c=e(255),d=e(1316),m=e(814),g=e(6896),u=e(7902),p=e(3013),f=e(2887),b=e(9510),y=e(9848),h=e(7901),x=e(3045),z=e(3775),w=e(1783),$=e(3539),A=e(9416),v=e(1837),k=e(7167),S=e(4494),j=e(2314),M=e(5751),B=e(9633),T=e(2946),P=e(822),E=e(6720),C=e(7400),R=e(8456),L=e(3317),F=e(2709),N=e(8006),D=e(9301),G=e(7561),I=e(3517),K=e(8207),H=e(7032),Y=e(6949),_=e(8218),O=e(6829),V=e(9591),J=e(5553),U=e(9923),Z=e(2820),W=e(4621),q=e(8479),X=e(2534),Q=e(6673),oo=e(7490),oa=e(9033),oe=e(9038),on=e(5775),ot=e(1365),oi=e(2937),or=e(9821),ol=e(5912),os=e(158),oc=e(8641),od=e(8607),om=e(3249),og=e(1821),ou=e(5889),op=e(9655),of=e(7170),ob=e(9161),oy=e(1849),oh=e(1604),ox=e(3142),oz=e(1187),ow=e(7747),o$=e(2932),oA=e(4525),ov=e(7230),ok=e(2164);let oS={activity:g.A,"a-large-small":u.A,apple:p.A,"arrow-right":f.A,"bar-chart-2":b.A,book:y.A,"book-open":h.A,briefcase:x.A,calendar:z.A,clock:w.A,"circle-dot":$.A,cloud:A.A,compass:v.A,cpu:k.A,droplets:S.A,feather:j.A,file:c.A,"file-text":M.A,folder:B.A,"git-branch":T.A,github:P.A,globe:E.A,grid:C.A,hand:R.A,hash:L.A,heart:F.A,key:N.A,hexagon:D.A,home:G.A,landmark:I.A,layers:K.A,"layout-grid":H.A,leaf:Y.A,lightbulb:_.A,list:O.A,map:V.A,"map-pin":J.A,"message-circle":U.A,"message-square":Z.A,minus:W.A,monitor:q.A,mountain:X.A,package:Q.A,palette:oo.A,"pen-tool":oa.A,"pie-chart":oe.A,plane:on.A,plus:ot.A,ruler:oi.A,shirt:or.A,slash:ol.A,square:os.A,star:oc.A,sun:od.A,terminal:om.A,thermometer:og.A,triangle:ou.A,trophy:op.A,truck:of.A,type:ob.A,users:oy.A,"volume-2":oh.A,watch:ox.A,waves:oz.A,wind:ow.A,wrench:o$.A,x:oA.A,zap:ov.A,bot:ok.A},oj=(0,s.keyframes)`
...
`;function oP({iconKey:o}){let a=o?oS[o]??c.A:c.A;return(0,n.jsx)(a,{size:14,strokeWidth:1.75})}function oE({entries:o,activeId:a,onSelect:e}){return(0,n.jsx)(n.Fragment,{children:o.map(o=>o.children?(0,n.jsx)(i().Fragment,{children:(0,n.jsx)(oE,{entries:o.children,activeId:a,onSelect:e})},o.id):(0,n.jsxs)(oT,{active:a===o.id,onClick:()=>e(o),children:[(0,n.jsx)(oP,{iconKey:o.icon}),o.name]},o.id))})}function oC({activeId:o}){let{flyout:a,scheduleFlyoutClose:e,cancelFlyoutClose:t}=(0,m.c)();if(!a)return null;let i=a.entry.icon?oS[a.entry.icon]??c.A:c.A;return(0,n.jsxs)(oM,{anchorY:a.anchorY,onMouseEnter:t,onMouseLeave:e,children:[(0,n.jsxs)(oB,{children:[(0,n.jsx)(i,{size:13,strokeWidth:2}),a.entry.name]}),(0,n.jsx)(oE,{entries:a.entry.children??[],activeId:o,onSelect:o=>{a.onSelect(o),e()}})]})}},814(o,a,e){e.d(a,{I:()=>t,c:()=>i});var n=e(7991);let t=(0,n.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),i=()=>(0,n.useContext)(t)},4117(o,a,e){e.d(a,{PE:()=>P,w4:()=>n.w4});var n=e(1316),t=e(5723),i=e(7991),r=e.n(i),l=e(6859),s=e.n(l);s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,s().div`
  position: relative;
`;var c=e(2799),d=e(3661),m=e(814);let g="260px",u="56px",p="48px",f=s().header`
  display: flex;
  align-items: center;
...
`,j=s().main`
  ...
  display: flex;
  flex-direction: column;
`,M=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function B(){return(0,t.jsx)(x,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:M.map((o,a)=>(0,t.jsx)(z,{index:a,accent:o.accent,children:o.char},a))})}let T="atlantis:sidebar-collapsed";function P({sidebar:o,children:a,topBarRight:n,title:l="Atlantis",activeId:s=null}){let[c,g]=(0,i.useState)(()=>{try{return"true"===localStorage.getItem(T)}catch{return!1}}),[u,p]=(0,i.useState)(null),h=(0,i.useRef)(),x=()=>g(o=>{let a=!o;try{localStorage.setItem(T,String(a))}catch{}return a}),z=r().useMemo(()=>r().lazy(()=>Promise.resolve().then(e.bind(e,7330)).then(o=>({default:o.FlyoutPanel}))),[]);return(0,t.jsx)(m.I.Provider,{value:{collapsed:c,toggle:x,flyout:u,openFlyout:(o,a,e)=>{clearTimeout(h.current),p({entry:o,anchorY:a,onSelect:e})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>p(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,t.jsxs)(v,{children:[(0,t.jsxs)(f,{children:[o&&(0,t.jsx)(b,{children:(0,t.jsx)(y,{onClick:x,title:c?"Expand sidebar":"Collapse sidebar",children:(0,t.jsx)(d.A,{size:17})})}),(0,t.jsx)(B,{}),l&&(0,t.jsx)(w,{children:l}),n&&(0,t.jsx)($,{children:n})]}),(0,t.jsxs)(A,{children:[null!=o&&(0,t.jsx)(k,{collapsed:c,children:(0,t.jsx)(S,{children:o})}),(0,t.jsx)(j,{children:a})]}),u&&(0,t.jsx)(r().Suspense,{fallback:null,children:(0,t.jsx)(z,{activeId:s})})]})})}s().div`
  display: grid;
...
`,s().button`
  ...
  background: ${({primary:o,danger:a})=>a?n.w4.colors.danger:o?n.w4.colors.accent:"transparent"};
  color: ${({primary:o,danger:a})=>a||o?"#fff":n.w4.colors.mainText};
  border: 1px solid
    ${({primary:o,danger:a})=>a?n.w4.colors.danger:o?n.w4.colors.accent:n.w4.colors.border};
