...
`,l().aside`
  ...
  display: flex;
  flex-direction: column;
  animation: ${I} 0.22s cubic-bezier(0.4, 0, 0.2, 1) both;
...
`,l().div`
  position: relative;
`;let oe="260px",ot="56px",or="48px",oi=l().header`
  display: flex;
  align-items: center;
  height: calc(${or} + env(safe-area-inset-top, 0px));
  ...
  @media (max-width: ${d.w4.breakpoints.md}) {
    flex-wrap: wrap;
    height: auto;
    min-height: calc(${or} + env(safe-area-inset-top, 0px));
  }
`,on=l().div`
  width: ${ot};
  min-width: ${ot};
...
`,oc=l().span`
  ...
  animation: ${od} 10s ease ${({index:o})=>.07*o}s infinite;
...
`,oh=l().div`
  ...
  overflow: hidden;
`,of=l().aside`
  width: ${({collapsed:o})=>o?ot:oe};
  min-width: ${({collapsed:o})=>o?ot:oe};
  background: ${d.w4.colors.sidebarBg};
  border-right: 1px solid ${d.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,ou=l().main`
  ...
  display: flex;
  flex-direction: column;
`,ob=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function oy(){return(0,t.jsx)(os,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:ob.map((o,a)=>(0,t.jsx)(oc,{index:a,accent:o.accent,children:o.char},a))})}let ow="atlantis:sidebar-collapsed";function o$({sidebar:o,children:a,topBarRight:n,title:l="Atlantis",activeId:d=null}){let[s,c]=(0,r.useState)(()=>{try{return"true"===localStorage.getItem(ow)}catch{return!1}}),[p,g]=(0,r.useState)(null),m=(0,r.useRef)(),h=()=>c(o=>{let a=!o;try{localStorage.setItem(ow,String(a))}catch{}return a}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(e.bind(e,5816)).then(o=>({default:o.FlyoutPanel}))),[]);return(0,t.jsx)(K.I.Provider,{value:{collapsed:s,toggle:h,flyout:p,openFlyout:(o,a,e)=>{clearTimeout(m.current),g({entry:o,anchorY:a,onSelect:e})},scheduleFlyoutClose:()=>{m.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(m.current)},children:(0,t.jsxs)(oh,{children:[(0,t.jsxs)(oi,{children:[o&&(0,t.jsx)(on,{children:(0,t.jsx)(ol,{onClick:h,title:s?"Expand sidebar":"Collapse sidebar",children:(0,t.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("path",{d:"M9 3v18"})]})})}),(0,t.jsx)(oy,{}),l&&(0,t.jsx)(op,{children:l}),n&&(0,t.jsx)(og,{children:n})]}),(0,t.jsxs)(om,{children:[null!=o&&(0,t.jsx)(of,{collapsed:s,children:(0,t.jsx)(ox,{children:o})}),(0,t.jsx)(ou,{children:a})]}),p&&(0,t.jsx)(i().Suspense,{fallback:null,children:(0,t.jsx)(f,{activeId:d})})]})})}l().div`
  display: grid;
  grid-template-rows: ${({open:o})=>o?"1fr":"0fr"};
