"use strict";(self.webpackChunk_atlantis_music=self.webpackChunk_atlantis_music||[]).push([["544"],{948(e,o,a){a.d(o,{A:()=>t});let t={"nav.search":{en:"Search",pt:"Pesquisar"},"nav.history":{en:"History",pt:"Hist\xf3rico"},"nav.playlists":{en:"Playlists",pt:"Playlists"},"search.heading":{en:"Search Apple Music",pt:"Pesquisar no Apple Music"},"search.placeholder":{en:"Song, artist or album…",pt:"M\xfasica, artista ou \xe1lbum…"},"search.button":{en:"Search",pt:"Pesquisar"},"search.open":{en:"Open in Apple Music",pt:"Abrir no Apple Music"},"search.empty":{en:"Type something to search.",pt:"Escreve algo para pesquisar."},"history.heading":{en:"History",pt:"Hist\xf3rico"},"history.searches":{en:"Recent Searches",pt:"Pesquisas Recentes"},"history.tracks":{en:"Recent Tracks",pt:"M\xfasicas Recentes"},"history.empty":{en:"No history yet.",pt:"Sem hist\xf3rico ainda."},"history.clear":{en:"Clear all",pt:"Limpar tudo"},"history.remove":{en:"Remove",pt:"Remover"},"history.openMusic":{en:"Open in Apple Music",pt:"Abrir no Apple Music"},"playlists.heading":{en:"Playlists",pt:"Playlists"},"playlists.new":{en:"New Playlist",pt:"Nova Playlist"},"playlists.empty":{en:"No playlists yet. Create one to get started.",pt:"Sem playlists ainda. Cria uma para come\xe7ar."},"playlists.delete":{en:"Delete",pt:"Eliminar"},"playlists.edit":{en:"Edit name",pt:"Editar nome"},"playlists.namePlaceholder":{en:"Playlist name…",pt:"Nome da playlist…"},"playlists.save":{en:"Save",pt:"Guardar"},"playlists.cancel":{en:"Cancel",pt:"Cancelar"},"playlists.create":{en:"Create",pt:"Criar"},"playlists.addTrack":{en:"Add track…",pt:"Adicionar m\xfasica…"},"playlists.trackPlaceholder":{en:"Song — Artist",pt:"M\xfasica — Artista"},"playlists.add":{en:"Add",pt:"Adicionar"},"playlists.removeTrack":{en:"Remove track",pt:"Remover m\xfasica"},"playlists.openTrack":{en:"Open in Apple Music",pt:"Abrir no Apple Music"},"playlists.tracksCount":{en:"{n} track|tracks",pt:"{n} m\xfasica|m\xfasicas"},"playlists.emptyTracks":{en:"No tracks yet.",pt:"Sem m\xfasicas ainda."},"playlists.confirmDelete":{en:"Delete this playlist?",pt:"Eliminar esta playlist?"}}},8170(e,o,a){a.d(o,{Ym:()=>c,Nx:()=>p});var t=a(7991),r=a(6063);let i={"time.justNow":{en:"just now",pt:"agora mesmo"},"time.mAgo":{en:"{n}m ago",pt:"h\xe1 {n}m"},"time.hAgo":{en:"{n}h ago",pt:"h\xe1 {n}h"},"time.dAgo":{en:"{n}d ago",pt:"h\xe1 {n}d"},updated:{en:"updated {age}",pt:"atualizado {age}"},refresh:{en:"Refresh",pt:"Atualizar"},loading:{en:"Loading…",pt:"A carregar…"},noData:{en:"No data available",pt:"Sem dados dispon\xedveis"},noDescription:{en:"No description provided.",pt:"Sem descri\xe7\xe3o."},failedToFetch:{en:"Failed to fetch",pt:"Erro ao carregar"},perWeek:{en:"/ wk",pt:"/ sem"},"devtools.heading":{en:"Dev Tools",pt:"Ferramentas"},"devtools.playground":{en:"Playground",pt:"Playground"},"devtools.pad":{en:"Pad",pt:"Pad"},"devtools.charts":{en:"Charts",pt:"Gr\xe1ficos"},"devtools.csv":{en:"CSV",pt:"CSV"},"devtools.regex":{en:"Regex",pt:"Regex"},"devtools.json":{en:"JSON",pt:"JSON"},"devtools.diff":{en:"Diff",pt:"Diferen\xe7as"},"devtools.jwt":{en:"JWT",pt:"JWT"},"devtools.cron":{en:"Cron",pt:"Cron"},"devtools.colors":{en:"Colors",pt:"Cores"},"devtools.api":{en:"API",pt:"API"}},n="atlantis:locale",l="shell:locale";function d(e){return"en"===e||"pt"===e}function s(){try{let e=localStorage.getItem(n);if(d(e))return e}catch{}return"en"}function c(){let[e,o]=(0,t.useState)(s),a=(0,t.useCallback)(e=>{o(e);try{localStorage.setItem(n,e)}catch{}(0,r.Is)(l,e).catch(()=>{}),window.dispatchEvent(new CustomEvent("atlantis:locale-change",{detail:e}))},[]);return(0,t.useEffect)(()=>{let e=e=>{o(e.detail)};return window.addEventListener("atlantis:locale-change",e),()=>window.removeEventListener("atlantis:locale-change",e)},[]),(0,t.useEffect)(()=>{(0,r.PL)(l).then(a=>{if(d(a)&&a!==e){try{localStorage.setItem(n,a)}catch{}o(a)}}).catch(()=>{})},[]),[e,a]}function p(e,o){let a=o?{...i,...o}:i;return(o,t)=>{let r=function(e,o){if(!o||!e.includes("|"))return e;let a=null;for(let e of Object.values(o))if("number"==typeof e&&Number.isFinite(e)){a=e;break}if(null===a)return e;let t=e.indexOf("|"),r=e.slice(0,t),i=e.slice(t+1);return 1===a?r:i}(a[o]?.[e]??o,t);return t?Object.entries(t).reduce((e,[o,a])=>e.replace(RegExp(`\\{${o}\\}`,"g"),String(a)),r):r}}(0,r.PL)(l).then(e=>{if(d(e))try{localStorage.setItem(n,e)}catch{}}).catch(()=>{}),a(5723);var g=a(6859),h=a.n(g);h().div`
  display: flex;
  gap: 4px;
...
`,b=i().forwardRef(function({variant:e="ghost",size:o="md",icon:a,iconRight:r,children:i,...n},l){return(0,t.jsxs)(u,{ref:l,variant:e,size:o,...n,children:[a,i,r]})}),y={default:d.w4.colors.accent,danger:"#f85149"},w={default:d.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"},$=l().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`,v=i().forwardRef(function({active:e=!1,shape:o="square",tone:a="default",children:r,...i},n){return(0,t.jsx)($,{ref:n,active:e,shape:o,tone:a,...i,children:r})});l().div`
  position: relative;
  display: inline-flex;
`,l().div`
  position: absolute;
...
`;let F=l().div`
  ...
  align-items: center;
  gap: 8px;
`;function B({children:e,...o}){return(0,t.jsx)(F,{...o,children:e})}let H=l().label`
  display: flex;
  align-items: center;
  gap: 10px;
...
`,C=l().span`
  ...
  color: ${d.w4.colors.mainTextMuted};
  flex-shrink: 0;
`,R=i().forwardRef(function({before:e,after:o,...a},r){return(0,t.jsxs)(H,{children:[e&&(0,t.jsx)(C,{children:e}),(0,t.jsx)(L,{ref:r,...a}),o&&(0,t.jsx)(C,{children:o})]})});l().div`
  position: relative;
  display: flex;
  flex-direction: column;
  height: 100%;
...
`,l().div`
  position: relative;
`;let ee="260px",eo="56px",ea="48px",et=l().header`
  display: flex;
  align-items: center;
  height: calc(${ea} + env(safe-area-inset-top, 0px));
  padding-top: env(safe-area-inset-top, 0px);
  ...
  @media (max-width: ${d.w4.breakpoints.md}) {
    flex-wrap: wrap;
    height: auto;
    min-height: calc(${ea} + env(safe-area-inset-top, 0px));
  }
`,er=l().div`
  width: ${eo};
  min-width: ${eo};
...
`,eg=l().div`
  ...
  overflow: hidden;
`,eh=l().aside`
  width: ${({collapsed:e})=>e?eo:ee};
  min-width: ${({collapsed:e})=>e?eo:ee};
  background: ${d.w4.colors.sidebarBg};
  border-right: 1px solid ${d.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,ef=l().main`
  ...
  display: flex;
  flex-direction: column;
`,ex=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function eu(){return(0,t.jsx)(el,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:ex.map((e,o)=>(0,t.jsx)(ed,{index:o,accent:e.accent,children:e.char},o))})}let eb="atlantis:sidebar-collapsed";function ey({sidebar:e,children:o,topBarRight:n,title:l="Atlantis",activeId:d=null}){let[s,c]=(0,r.useState)(()=>{try{return"true"===localStorage.getItem(eb)}catch{return!1}}),[p,g]=(0,r.useState)(null),h=(0,r.useRef)(),m=()=>c(e=>{let o=!e;try{localStorage.setItem(eb,String(o))}catch{}return o}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(a.bind(a,2787)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,t.jsx)(_.I.Provider,{value:{collapsed:s,toggle:m,flyout:p,openFlyout:(e,o,a)=>{clearTimeout(h.current),g({entry:e,anchorY:o,onSelect:a})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,t.jsxs)(eg,{children:[(0,t.jsxs)(et,{children:[e&&(0,t.jsx)(er,{children:(0,t.jsx)(ei,{onClick:m,title:s?"Expand sidebar":"Collapse sidebar",children:(0,t.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("path",{d:"M9 3v18"})]})})}),(0,t.jsx)(eu,{}),l&&(0,t.jsx)(es,{children:l}),n&&(0,t.jsx)(ec,{children:n})]}),(0,t.jsxs)(ep,{children:[null!=e&&(0,t.jsx)(eh,{collapsed:s,children:(0,t.jsx)(em,{children:e})}),(0,t.jsx)(ef,{children:o})]}),p&&(0,t.jsx)(i().Suspense,{fallback:null,children:(0,t.jsx)(f,{activeId:d})})]})})}var ew=a(4971);let e$=l().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
...
`;function eF({iconKey:e,size:o=16}){let a=e?ew.X[e]:void 0;return a?(0,t.jsx)("svg",{width:o,height:o,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,dangerouslySetInnerHTML:{__html:a}}):e?(0,t.jsx)("span",{style:{fontSize:o,lineHeight:1,display:"flex",alignItems:"center"},children:e}):(0,t.jsxs)("svg",{width:o,height:o,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,children:[(0,t.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,t.jsx)("polyline",{points:"14 2 14 8 20 8"})]})}function eB({entry:e,activeId:o,onSelect:a}){let[i,n]=(0,r.useState)(e.defaultOpen??!0),{collapsed:l,openFlyout:d,scheduleFlyoutClose:s,cancelFlyoutClose:c}=(0,_.c)();return e.children&&e.children.length>0?(0,t.jsxs)(eM,{children:[(0,t.jsxs)(ek,{collapsed:l,onClick:()=>{l||n(e=>!e)},onMouseEnter:l?o=>{d(e,o.currentTarget.getBoundingClientRect().top,a)}:void 0,onMouseLeave:l?s:void 0,children:[(0,t.jsxs)(eA,{collapsed:l,children:[(0,t.jsx)(eF,{iconKey:e.icon,size:16}),(0,t.jsx)(eT,{collapsed:l,children:e.name})]}),(0,t.jsx)(eS,{open:i,collapsed:l,children:(0,t.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round",children:(0,t.jsx)("path",{d:"M9 6l6 6-6 6"})})})]}),(0,t.jsx)(e$,{open:i&&!l,children:(0,t.jsx)(ev,{children:(0,t.jsx)(ez,{children:e.children.map(e=>(0,t.jsx)(eB,{entry:e,activeId:o,onSelect:a},e.id))})})})]}):(0,t.jsxs)(ej,{active:o===e.id,collapsed:l,onClick:()=>a(e),onMouseEnter:l?o=>{let t=o.currentTarget.getBoundingClientRect();d({id:e.id,name:e.name,icon:e.icon,file:e.file,children:[e]},t.top,a)}:void 0,onMouseLeave:l?s:void 0,children:[(0,t.jsx)(eF,{iconKey:e.icon,size:15}),(0,t.jsx)(eT,{collapsed:l,children:e.name})]})}function eH({entries:e,activeId:o,onSelect:a}){return(0,t.jsx)("div",{children:e.map(e=>(0,t.jsx)(eB,{entry:e,activeId:o,onSelect:a},e.id))})}a(2787),l().div`
