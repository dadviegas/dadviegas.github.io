"use strict";(self.webpackChunk_atlantis_portugues=self.webpackChunk_atlantis_portugues||[]).push([[9749],{28834(e,a,o){o.d(a,{WO:()=>Xe});var n=o(27359),i=o(217),t=o(53233),r=o(65723);t.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,w=t.default.main`
  ...
  display: flex;
  flex-direction: column;
`,A="atlantis:sidebar-collapsed";function $({sidebar:e,children:a,topBarRight:i,title:t="Atlantis",activeId:d=null}){const[s,$]=(0,n.useState)(()=>{try{return"true"===localStorage.getItem(A)}catch{return!1}}),[v,k]=(0,n.useState)(null),j=(0,n.useRef)(),S=()=>$(e=>{const a=!e;try{localStorage.setItem(A,String(a))}catch{}return a}),T=n.useMemo(()=>n.lazy(()=>Promise.resolve().then(o.bind(o,74914)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(c.I.Provider,{value:{collapsed:s,toggle:S,flyout:v,openFlyout:(e,a,o)=>{clearTimeout(j.current),k({entry:e,anchorY:a,onSelect:o})},scheduleFlyoutClose:()=>{j.current=setTimeout(()=>k(null),160)},cancelFlyoutClose:()=>clearTimeout(j.current)},children:(0,r.jsxs)(h,{children:[(0,r.jsxs)(m,{children:[(0,r.jsx)(g,{children:(0,r.jsx)(u,{onClick:S,title:s?"Expand sidebar":"Collapse sidebar",children:(0,r.jsx)(l.A,{size:17})})}),(0,r.jsxs)(f,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:["Atl",(0,r.jsx)("span",{children:"antis"})]}),t&&(0,r.jsx)(p,{children:t}),i&&(0,r.jsx)(y,{children:i})]}),(0,r.jsxs)(b,{children:[(0,r.jsx)(z,{collapsed:s,children:(0,r.jsx)(x,{children:e})}),(0,r.jsx)(w,{children:a})]}),v&&(0,r.jsx)(n.Suspense,{fallback:null,children:(0,r.jsx)(T,{activeId:d})})]})})}var v=o(20255),k=o(69753),j=o(65185);const S=t.default.div`
  display: grid;
...
`;function N({iconKey:e,size:a=16}){if(e&&!(e in j.t))return(0,r.jsx)("span",{style:{fontSize:a,lineHeight:1,display:"flex",alignItems:"center"},children:e});const o=e?j.t[e]??v.A:v.A;return(0,r.jsx)(o,{size:a,strokeWidth:1.75})}function I({entry:e,activeId:a,onSelect:o}){const[i,t]=(0,n.useState)(e.defaultOpen??!0),{collapsed:l,openFlyout:d,scheduleFlyoutClose:s,cancelFlyoutClose:m}=(0,c.c)();return e.children&&e.children.length>0?(0,r.jsxs)(B,{children:[(0,r.jsxs)(E,{collapsed:l,onClick:()=>{l||t(e=>!e)},onMouseEnter:l?a=>{const n=a.currentTarget.getBoundingClientRect();d(e,n.top,o)}:void 0,onMouseLeave:l?s:void 0,children:[(0,r.jsxs)(C,{collapsed:l,children:[(0,r.jsx)(N,{iconKey:e.icon,size:16}),(0,r.jsx)(P,{collapsed:l,children:e.name})]}),(0,r.jsx)(L,{open:i,collapsed:l,children:(0,r.jsx)(k.A,{size:13})})]}),(0,r.jsx)(S,{open:i&&!l,children:(0,r.jsx)(T,{children:(0,r.jsx)(M,{children:e.children.map(e=>(0,r.jsx)(I,{entry:e,activeId:a,onSelect:o},e.id))})})})]}):(0,r.jsxs)(R,{active:a===e.id,collapsed:l,onClick:()=>o(e),onMouseEnter:l?a=>{const n=a.currentTarget.getBoundingClientRect();d({id:e.id,name:e.name,icon:e.icon,file:e.file,children:[e]},n.top,o)}:void 0,onMouseLeave:l?s:void 0,children:[(0,r.jsx)(N,{iconKey:e.icon,size:15}),(0,r.jsx)(P,{collapsed:l,children:e.name})]})}function F({entries:e,activeId:a,onSelect:o}){return(0,r.jsx)("div",{children:e.map(e=>(0,r.jsx)(I,{entry:e,activeId:a,onSelect:o},e.id))})}const K=o(77207).keyframes`
...
`;function he({type:e,children:a}){const o=fe[e]??fe.NOTE,n=o.icon;return(0,r.jsxs)(pe,{bg:o.bg,border:o.border,children:[(0,r.jsxs)(ye,{color:o.color,children:[(0,r.jsx)(n,{size:15,strokeWidth:2}),o.label]}),(0,r.jsx)(be,{children:a})]})}const ze=t.default.nav`
  width: 220px;
  min-width: 220px;
...
`,Te=t.default.div`flex: 1; min-width: 0;`,Me=t.default.article`
...
`;function Ke({languages:e,activeLang:a,onChange:o}){return(0,r.jsx)(Ie,{children:Object.entries(e).map(([e,{label:n}])=>(0,r.jsx)(Fe,{active:a===e,onClick:()=>o(e),children:n},e))})}function Ge(e,a){for(const o of e){if(o.id===a)return o;if(o.children){const e=Ge(o.children,a);if(e)return e}}}function De(e){return e.flatMap(e=>e.children?De(e.children):e.file?[e]:[])}const Ve=t.default.div`
  display: flex;
  align-items: center;
  justify-content: center;
  height: 100%;
...
`;function Je({title:e,sub:a}){return(0,r.jsxs)(Ve,{children:[(0,r.jsx)(Oe,{}),(0,r.jsx)(He,{size:500,x:10,y:-10,hue:210,dur:7}),(0,r.jsx)(He,{size:400,x:60,y:50,hue:270,dur:9}),(0,r.jsx)(He,{size:300,x:30,y:70,hue:190,dur:6}),(0,r.jsxs)(_e,{children:[(0,r.jsx)(Ye,{children:e}),(0,r.jsx)(We,{children:a}),(0,r.jsxs)(Ue,{children:[(0,r.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round",children:(0,r.jsx)("polyline",{points:"15 18 9 12 15 6"})}),"Browse the sidebar"]})]})]})}function Ze(e,a,o){return"string"==typeof e?e:e[a]??e[o]??Object.values(e)[0]??""}function Xe({navigation:e,languages:a,defaultLang:o,hashPrefix:i,topBarRight:t,welcomeTitle:l="Blog",welcomeSub:c="Notes, guides, and references — pick a topic from the sidebar to get started."}){const d=a?Object.keys(a):[],s=d.length>1,[m,g]=(0,n.useState)(()=>o??d[0]??""),u=(0,n.useMemo)(()=>a&&m?a[m].navigation:e??{entries:[]},[a,e,m]),f=((0,n.useMemo)(()=>De(u.entries),[u]),(0,n.useCallback)(e=>{const a=e.match(new RegExp(`^#\\/${i}\\/(.+)$`));if(a)return Ge(u.entries,a[1])},[u,i])),[p,y]=(0,n.useState)(()=>f(window.location.hash)??null);(0,n.useEffect)(()=>{y(null)},[m]),(0,n.useEffect)(()=>{const e=()=>{const e=f(window.location.hash);e&&y(e)};return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[f]);const b=(0,n.useCallback)(e=>{e.file&&(y(e),window.location.hash=`#/${i}/${e.id}`)},[i]),h=(0,n.useMemo)(()=>De(u.entries),[u]),z=h.findIndex(e=>e.id===p?.id),x=z>0?h[z-1]:null,w=z<h.length-1?h[z+1]:null,A=p?.label??p?.name??i,v=Ze(l,m,o??d[0]??""),k=Ze(c,m,o??d[0]??""),j=s&&a?(0,r.jsx)(Ke,{languages:Object.fromEntries(d.map(e=>[e,{label:a[e].label}])),activeLang:m,onChange:g}):null;return(0,r.jsx)($,{title:A,activeId:p?.id??null,topBarRight:(0,r.jsxs)(r.Fragment,{children:[j,t]}),sidebar:(0,r.jsx)(D,{config:u,activeId:p?.id??null,onSelect:b}),children:p?.file?(0,r.jsx)(Ne,{file:p.file,prevEntry:x,nextEntry:w,onNavigate:b}):(0,r.jsx)(Je,{title:v,sub:k})})}},74914(e,a,o){o.d(a,{FlyoutPanel:()=>b});var n=o(27359),i=o(53233),t=o(77207),r=o(20255),l=o(217),c=o(15959),d=o(65185),s=o(65723);const m=t.keyframes`
