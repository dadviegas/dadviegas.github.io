"use strict";(self.webpackChunk_atlantis_csvexplorer=self.webpackChunk_atlantis_csvexplorer||[]).push([[188],{188(e,o,r){var s=r(7359),t=r(8997),n=r(3233),l=r(9200),i=r(3857),a=r(3317),d=r(3775),c=r(9161),p=r(1344),u=r(679),x=r(4525),h=r(5426),m=r(668),w=r(4490),f=r(9336),g=r(5723);const b=`&::-webkit-scrollbar{width:6px;height:6px}&::-webkit-scrollbar-track{background:transparent}&::-webkit-scrollbar-thumb{background:${l.w4.colors.border};border-radius:3px}scrollbar-width:thin;scrollbar-color:${l.w4.colors.border} transparent;`,$=n.default.div`display:flex;flex:1;overflow:hidden;`,j=n.default.div`
