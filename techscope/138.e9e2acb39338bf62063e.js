...
`,H=i.default.a`
  ...
  gap: 10px;
  padding: ${t.w4.spacing.md};
  background: linear-gradient(168deg, ${_}10 0%, ${t.w4.colors.surface} 44%, ${t.w4.colors.surface} 100%);
  border: 1px solid ${_}2d;
  border-radius: ${t.w4.borderRadius.md};
  text-decoration: none;
  transition: border-color 0.25s, background 0.25s, transform 0.25s, box-shadow 0.25s;
  position: relative;
  ...
  &::before {
    ...
    right: 0;
    height: 2px;
    background: linear-gradient(90deg, transparent, ${_}, transparent);
    opacity: 0.45;
    transition: opacity 0.2s;
  }
  ...
  &:hover {
    border-color: ${_}66;
    background: linear-gradient(168deg, ${_}1c 0%, ${t.w4.colors.surfaceRaised} 44%, ${t.w4.colors.surfaceRaised} 100%);
    box-shadow: 0 0 18px ${_}24, 0 10px 26px rgba(0, 0, 0, 0.28);
    transform: translateY(-2px);
  }
