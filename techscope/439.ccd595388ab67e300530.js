...
`;function f({iconKey:e}){const a=e?d.t[e]??r.A:r.A;return(0,c.jsx)(a,{size:14,strokeWidth:1.75})}function h({entries:e,activeId:a,onSelect:o}){return(0,c.jsx)(c.Fragment,{children:e.map(e=>e.children?(0,c.jsx)(n.Fragment,{children:(0,c.jsx)(h,{entries:e.children,activeId:a,onSelect:o})},e.id):(0,c.jsxs)(p,{active:a===e.id,onClick:()=>o(e),children:[(0,c.jsx)(f,{iconKey:e.icon}),e.name]},e.id))})}function y({activeId:e}){const{flyout:a,scheduleFlyoutClose:o,cancelFlyoutClose:n}=(0,s.c)();if(!a)return null;const t=a.entry.icon?d.t[a.entry.icon]??r.A:r.A;return(0,c.jsxs)(g,{anchorY:a.anchorY,onMouseEnter:n,onMouseLeave:o,children:[(0,c.jsxs)(u,{children:[(0,c.jsx)(t,{size:13,strokeWidth:2}),a.entry.name]}),(0,c.jsx)(h,{entries:a.entry.children??[],activeId:e,onSelect:e=>{a.onSelect(e),o()}})]})}},5959(e,a,o){o.d(a,{I:()=>t,c:()=>i});var n=o(7359);const t=(0,n.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),i=()=>(0,n.useContext)(t)},5185(e,a,o){o.d(a,{t:()=>ne});var n=o(9510),t=o(9038),i=o(7400),r=o(8207),l=o(7902),s=o(6896),d=o(7901),c=o(9848),m=o(2164),g=o(3045),u=o(3775),p=o(3539),f=o(1783),h=o(1837),y=o(4494),x=o(2314),b=o(5751),w=o(255),z=o(9633),$=o(2946),A=o(822),v=o(6720),k=o(3317),j=o(2709),S=o(9301),M=o(3517),T=o(7032),B=o(6949),P=o(8218),R=o(6829),E=o(5553),F=o(9591),C=o(2820),D=o(4621),I=o(2534),L=o(6673),N=o(9033),_=o(1365),K=o(2937),H=o(5912),G=o(158),Y=o(8641),V=o(8607),U=o(3249),O=o(1821),J=o(5889),Z=o(7170),W=o(9161),X=o(1849),q=o(1187),Q=o(7747),ee=o(2932),ae=o(4525),oe=o(7230);const ne={activity:s.A,"a-large-small":l.A,"bar-chart-2":n.A,book:c.A,"book-open":d.A,briefcase:g.A,calendar:u.A,clock:f.A,"circle-dot":p.A,compass:h.A,droplets:y.A,feather:x.A,file:w.A,"file-text":b.A,folder:z.A,"git-branch":$.A,github:A.A,globe:v.A,grid:i.A,hash:k.A,heart:j.A,hexagon:S.A,landmark:M.A,layers:r.A,"layout-grid":T.A,leaf:B.A,lightbulb:P.A,list:R.A,map:F.A,"map-pin":E.A,"message-square":C.A,minus:D.A,mountain:I.A,package:L.A,"pen-tool":N.A,"pie-chart":t.A,plus:_.A,ruler:K.A,slash:H.A,square:G.A,star:Y.A,sun:V.A,terminal:U.A,thermometer:O.A,triangle:J.A,truck:Z.A,type:W.A,users:X.A,waves:q.A,wind:Q.A,wrench:ee.A,x:ae.A,zap:oe.A,bot:m.A}},5723(e,a,o){o.d(a,{wi:()=>ae,pB:()=>te,PH:()=>ne,KW:()=>oe,NI:()=>ee,PL:()=>Q,Is:()=>q,w4:()=>n.w4});var n=o(217),t=o(7359),i=o(3233),r=o(8104);i.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
//# sourceMappingURL=439.ccd595388ab67e300530.js.map