"use strict";(self.webpackChunk_atlantis_shell=self.webpackChunk_atlantis_shell||[]).push([["6818"],{79753(e,t,n){n.d(t,{FinanceBudgetWidget:()=>j});var i=n(65723),o=n(37991),a=n(36859),r=n.n(a),l=n(72799),s=n(89874),d=n(28170),c=n(48294),p=n(98975),u=n(85043);let f=(0,l.keyframes)`
...
`,k=r().span`
  ...
  text-align: right;
`;function j({locale:e}){let t=(0,o.useMemo)(()=>(0,d.Nx)(e,p.A),[e]),{data:n,loaded:a}=(0,c.useFinance)(),r=(0,o.useMemo)(()=>{if(!n)return[];let t=Object.entries(n.budget.categoryBudgets??{}).filter(([,e])=>("number"==typeof e?e:e.amount)>0);if(0===t.length)return[];let i=(0,c.expensesForMonth)(n.expenses,(0,c.thisMonthKey)()),o=(0,c.spendingByCategory)(i),a=new Map(c.DEFAULT_CATEGORIES.map(e=>[e.id,e]));return t.map(([t,n])=>{let i="number"==typeof n?n:n.amount,r=a.get(t),l=o[t]??0,s=i>0?l/i*100:0;return{id:t,icon:r?.icon??"\uD83D\uDCB8",label:"pt"===e?r?.labelPt??t:r?.labelEn??t,spent:l,cap:i,pct:s,tone:s>=100?"over":s>=80?"warn":"ok"}}).sort((e,t)=>t.pct-e.pct)},[n,e]);return a?n&&0!==r.length?(0,i.jsx)(x,{children:r.map(e=>(0,i.jsxs)(g,{onClick:()=>(0,s.VJ)("finance",{categoryId:e.id}),"aria-label":`${e.label} — €${e.spent.toFixed(2)} / €${e.cap.toFixed(0)}`,children:[(0,i.jsx)(h,{"aria-hidden":"true",children:e.icon}),(0,i.jsxs)(m,{children:[(0,i.jsx)(b,{children:e.label}),(0,i.jsx)(w,{children:(0,i.jsx)(y,{pct:e.pct,tone:e.tone})})]}),(0,i.jsxs)($,{children:[(0,i.jsxs)(v,{tone:e.tone,children:["€",e.spent.toFixed(0)]}),(0,i.jsxs)(k,{children:["/ €",e.cap.toFixed(0)]})]})]},e.id))}):(0,i.jsx)(u.Y,{mode:"empty",label:t("finance.budget.widget.empty")}):(0,i.jsx)(u.Y,{mode:"loading",label:t("finance.budget.widget.loading")})}}}]);