"use strict";(self.webpackChunk_atlantis_pad=self.webpackChunk_atlantis_pad||[]).push([["5237"],{53804(e,o,a){a.d(o,{M:()=>x});var r=a(65723);a(37991);var t=a(36859),i=a.n(t),n=a(23930),l=a(85399);let s=i().div`
  display: flex;
...
`;function D({activeAppId:e}){let{collapsed:o}=(0,l.cL)(),[a]=function(){let[e,o]=(0,t.useState)(k),a=(0,t.useCallback)(e=>{o(e);try{localStorage.setItem($,e)}catch{}(0,l.Is)(v,e).catch(()=>{}),window.dispatchEvent(new CustomEvent("atlantis:locale-change",{detail:e}))},[]);return(0,t.useEffect)(()=>{let e=e=>{o(e.detail)};return window.addEventListener("atlantis:locale-change",e),()=>window.removeEventListener("atlantis:locale-change",e)},[]),(0,t.useEffect)(()=>{(0,l.PL)(v).then(a=>{if(z(a)&&a!==e){try{localStorage.setItem($,a)}catch{}o(a)}}).catch(()=>{})},[]),[e,a]}(),i=(0,t.useMemo)(()=>(e,o)=>{let r=function(e,o){if(!o||!e.includes("|"))return e;let a=null;for(let e of Object.values(o))if("number"==typeof e&&Number.isFinite(e)){a=e;break}if(null===a)return e;let r=e.indexOf("|"),t=e.slice(0,r),i=e.slice(r+1);return 1===a?t:i}(y[e]?.[a]??e,o);return o?Object.entries(o).reduce((e,[o,a])=>e.replace(RegExp(`\\{${o}\\}`,"g"),String(a)),r):r},[a]),n=(0,t.useRef)(null),s=e=>{n.current!==e&&(n.current=e,document.activeElement?.blur(),window.location.hash=e,setTimeout(()=>{n.current=null},50))};return(0,r.jsxs)(L,{children:[(0,r.jsx)(R,{collapsed:o,children:i("devtools.heading")}),F.map(a=>{let t=i(a.labelKey);return(0,r.jsxs)(P,{active:e===a.id,collapsed:o,onPointerDown:e=>{0===e.button&&s(a.hash)},onClick:()=>s(a.hash),title:t,children:[(0,r.jsx)(E,{children:(0,r.jsx)(A,{name:a.icon,size:16})}),(0,r.jsx)(H,{collapsed:o,children:t})]},a.id)})]})}n().span`
  display: inline-flex;
  align-items: center;
  justify-content: center;
  width: ${({size:e})=>e}px;
