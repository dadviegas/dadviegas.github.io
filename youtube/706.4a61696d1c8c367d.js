...
`,l().div`
  position: relative;
`;let E="260px",D="56px",N="48px",W=l().header`
  display: flex;
  align-items: center;
...
`,ee=l().div`
  ...
  overflow: hidden;
`,eo=l().aside`
  width: ${({collapsed:e})=>e?D:E};
  min-width: ${({collapsed:e})=>e?D:E};
  background: ${d.w4.colors.sidebarBg};
  border-right: 1px solid ${d.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,er=l().main`
  ...
  display: flex;
  flex-direction: column;
`,ea=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function ei(){return(0,r.jsx)(G,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:ea.map((e,o)=>(0,r.jsx)(Z,{index:o,accent:e.accent,children:e.char},o))})}let en="atlantis:sidebar-collapsed";function el({sidebar:e,children:o,topBarRight:n,title:l="Atlantis",activeId:d=null}){let[s,c]=(0,a.useState)(()=>{try{return"true"===localStorage.getItem(en)}catch{return!1}}),[p,g]=(0,a.useState)(null),h=(0,a.useRef)(),x=()=>c(e=>{let o=!e;try{localStorage.setItem(en,String(o))}catch{}return o}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(t.bind(t,5816)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(L.I.Provider,{value:{collapsed:s,toggle:x,flyout:p,openFlyout:(e,o,t)=>{clearTimeout(h.current),g({entry:e,anchorY:o,onSelect:t})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,r.jsxs)(ee,{children:[(0,r.jsxs)(W,{children:[e&&(0,r.jsx)(X,{children:(0,r.jsx)(_,{onClick:x,title:s?"Expand sidebar":"Collapse sidebar",children:(0,r.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,r.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,r.jsx)("path",{d:"M9 3v18"})]})})}),(0,r.jsx)(ei,{}),l&&(0,r.jsx)(J,{children:l}),n&&(0,r.jsx)(U,{children:n})]}),(0,r.jsxs)(Q,{children:[null!=e&&(0,r.jsx)(eo,{collapsed:s,children:(0,r.jsx)(et,{children:e})}),(0,r.jsx)(er,{children:o})]}),p&&(0,r.jsx)(i().Suspense,{fallback:null,children:(0,r.jsx)(f,{activeId:d})})]})})}l().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
