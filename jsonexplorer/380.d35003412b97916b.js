...
`,oa=l().div`
  ...
  color: ${s.w4.colors.sidebarTextMuted};
  font-family: ${s.w4.typography.fontFamily};
`;function ot({onSave:o,onUpdate:e,onCancel:a,existingDoc:i}){let[n,l]=(0,r.useState)(i?.name??""),s=(0,r.useRef)(null);return(0,r.useEffect)(()=>{s.current?.focus(),i&&s.current?.select()},[i]),(0,t.jsx)(U,{onClick:a,children:(0,t.jsxs)(Z,{onClick:o=>o.stopPropagation(),children:[(0,t.jsx)(q,{children:"Save document"}),i&&e&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(oa,{children:"Update the current version or save as a new one."}),(0,t.jsxs)(Q,{children:[(0,t.jsx)(oo,{onClick:a,children:"Cancel"}),(0,t.jsxs)(oo,{danger:!0,onClick:e,children:['Update "',i.name,'"']})]}),(0,t.jsx)(oe,{})]}),(0,t.jsx)(X,{ref:s,value:n,onChange:o=>l(o.target.value),onKeyDown:t=>{"Enter"===t.key&&n.trim()&&(i&&n.trim()===i.name&&e?e():o(n.trim())),"Escape"===t.key&&a()},placeholder:i?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,t.jsxs)(Q,{children:[!i&&(0,t.jsx)(oo,{onClick:a,children:"Cancel"}),(0,t.jsx)(oo,{primary:!0,disabled:!n.trim(),onClick:()=>o(n.trim()),children:"Save as new"})]})]})})}let or=(0,y.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,oi=(0,y.keyframes)`
...
`,l().div`
  ...
  flex-direction: column;
  gap: 14px;
  animation: ${oi} 0.18s cubic-bezier(0.22, 1, 0.36, 1) both;
`,l().div`
  font-size: ${s.w4.typography.fontSizeMd};
  font-weight: 700;
...
`,l().div`
  position: relative;
`;let od="260px",oc="56px",op="48px",og=l().header`
  display: flex;
  align-items: center;
  height: calc(${op} + env(safe-area-inset-top, 0px));
  ...
  @media (max-width: ${s.w4.breakpoints.md}) {
    flex-wrap: wrap;
    height: auto;
    min-height: calc(${op} + env(safe-area-inset-top, 0px));
  }
`,om=l().div`
  width: ${oc};
  min-width: ${oc};
...
`,ou=l().span`
  ...
  animation: ${of} 10s ease ${({index:o})=>.07*o}s infinite;
...
`,o$=l().div`
  ...
  overflow: hidden;
`,ov=l().aside`
  width: ${({collapsed:o})=>o?oc:od};
  min-width: ${({collapsed:o})=>o?oc:od};
  background: ${s.w4.colors.sidebarBg};
  border-right: 1px solid ${s.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,oM=l().main`
  ...
  display: flex;
  flex-direction: column;
`,ok=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function oA(){return(0,t.jsx)(ox,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:ok.map((o,e)=>(0,t.jsx)(ou,{index:e,accent:o.accent,children:o.char},e))})}let oT="atlantis:sidebar-collapsed";function oj({sidebar:o,children:e,topBarRight:n,title:l="Atlantis",activeId:s=null}){let[d,c]=(0,r.useState)(()=>{try{return"true"===localStorage.getItem(oT)}catch{return!1}}),[p,g]=(0,r.useState)(null),m=(0,r.useRef)(),h=()=>c(o=>{let e=!o;try{localStorage.setItem(oT,String(e))}catch{}return e}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(a.bind(a,5816)).then(o=>({default:o.FlyoutPanel}))),[]);return(0,t.jsx)(E.I.Provider,{value:{collapsed:d,toggle:h,flyout:p,openFlyout:(o,e,a)=>{clearTimeout(m.current),g({entry:o,anchorY:e,onSelect:a})},scheduleFlyoutClose:()=>{m.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(m.current)},children:(0,t.jsxs)(o$,{children:[(0,t.jsxs)(og,{children:[o&&(0,t.jsx)(om,{children:(0,t.jsx)(oh,{onClick:h,title:d?"Expand sidebar":"Collapse sidebar",children:(0,t.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("path",{d:"M9 3v18"})]})})}),(0,t.jsx)(oA,{}),l&&(0,t.jsx)(ob,{children:l}),n&&(0,t.jsx)(oy,{children:n})]}),(0,t.jsxs)(ow,{children:[null!=o&&(0,t.jsx)(ov,{collapsed:d,children:(0,t.jsx)(oz,{children:o})}),(0,t.jsx)(oM,{children:e})]}),p&&(0,t.jsx)(i().Suspense,{fallback:null,children:(0,t.jsx)(f,{activeId:s})})]})})}l().div`
  display: grid;
  grid-template-rows: ${({open:o})=>o?"1fr":"0fr"};
