"use strict";(self.webpackChunk_atlantis_estudodomeio=self.webpackChunk_atlantis_estudodomeio||[]).push([[2402],{2161(e,a,o){o.d(a,{WO:()=>ca});var n=o(27359),i=o(217),t=o(53233),r=o(65723);t.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,t.default.div`
  position: relative;
`;var l=o(73661),s=o(15959);const d="260px",c="56px",m=t.default.header`
  display: flex;
  align-items: center;
  height: ${"48px"};
...
`,w=t.default.main`
  ...
  display: flex;
  flex-direction: column;
`,$="atlantis:sidebar-collapsed";function A({sidebar:e,children:a,topBarRight:i,title:t="Atlantis",activeId:d=null}){const[c,A]=(0,n.useState)(()=>{try{return"true"===localStorage.getItem($)}catch{return!1}}),[v,k]=(0,n.useState)(null),j=(0,n.useRef)(),S=()=>A(e=>{const a=!e;try{localStorage.setItem($,String(a))}catch{}return a}),M=n.useMemo(()=>n.lazy(()=>Promise.resolve().then(o.bind(o,74914)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(s.I.Provider,{value:{collapsed:c,toggle:S,flyout:v,openFlyout:(e,a,o)=>{clearTimeout(j.current),k({entry:e,anchorY:a,onSelect:o})},scheduleFlyoutClose:()=>{j.current=setTimeout(()=>k(null),160)},cancelFlyoutClose:()=>clearTimeout(j.current)},children:(0,r.jsxs)(b,{children:[(0,r.jsxs)(m,{children:[e&&(0,r.jsx)(g,{children:(0,r.jsx)(u,{onClick:S,title:c?"Expand sidebar":"Collapse sidebar",children:(0,r.jsx)(l.A,{size:17})})}),(0,r.jsxs)(f,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:["Atl",(0,r.jsx)("span",{children:"antis"})]}),t&&(0,r.jsx)(p,{children:t}),i&&(0,r.jsx)(y,{children:i})]}),(0,r.jsxs)(h,{children:[null!=e&&(0,r.jsx)(x,{collapsed:c,children:(0,r.jsx)(z,{children:e})}),(0,r.jsx)(w,{children:a})]}),v&&(0,r.jsx)(n.Suspense,{fallback:null,children:(0,r.jsx)(M,{activeId:d})})]})})}var v=o(20255),k=o(69753),j=o(65185);const S=t.default.div`
  display: grid;
...
`;function L({iconKey:e,size:a=16}){if(e&&!(e in j.t))return(0,r.jsx)("span",{style:{fontSize:a,lineHeight:1,display:"flex",alignItems:"center"},children:e});const o=e?j.t[e]??v.A:v.A;return(0,r.jsx)(o,{size:a,strokeWidth:1.75})}function N({entry:e,activeId:a,onSelect:o}){const[i,t]=(0,n.useState)(e.defaultOpen??!0),{collapsed:l,openFlyout:d,scheduleFlyoutClose:c,cancelFlyoutClose:m}=(0,s.c)();return e.children&&e.children.length>0?(0,r.jsxs)(B,{children:[(0,r.jsxs)(E,{collapsed:l,onClick:()=>{l||t(e=>!e)},onMouseEnter:l?a=>{const n=a.currentTarget.getBoundingClientRect();d(e,n.top,o)}:void 0,onMouseLeave:l?c:void 0,children:[(0,r.jsxs)(C,{collapsed:l,children:[(0,r.jsx)(L,{iconKey:e.icon,size:16}),(0,r.jsx)(P,{collapsed:l,children:e.name})]}),(0,r.jsx)(R,{open:i,collapsed:l,children:(0,r.jsx)(k.A,{size:13})})]}),(0,r.jsx)(S,{open:i&&!l,children:(0,r.jsx)(M,{children:(0,r.jsx)(T,{children:e.children.map(e=>(0,r.jsx)(N,{entry:e,activeId:a,onSelect:o},e.id))})})})]}):(0,r.jsxs)(F,{active:a===e.id,collapsed:l,onClick:()=>o(e),onMouseEnter:l?a=>{const n=a.currentTarget.getBoundingClientRect();d({id:e.id,name:e.name,icon:e.icon,file:e.file,children:[e]},n.top,o)}:void 0,onMouseLeave:l?c:void 0,children:[(0,r.jsx)(L,{iconKey:e.icon,size:15}),(0,r.jsx)(P,{collapsed:l,children:e.name})]})}function I({entries:e,activeId:a,onSelect:o}){return(0,r.jsx)("div",{children:e.map(e=>(0,r.jsx)(N,{entry:e,activeId:a,onSelect:o},e.id))})}const H=o(77207).keyframes`
...
`;var K=o(88641),O=o(41783);function D(e){try{return JSON.parse(localStorage.getItem(e)??"[]")}catch{return[]}}const G=t.default.nav`padding: ${i.w.spacing.sm} 0;`,Y=t.default.div`
...
`;function Q({title:e,icon:a,entries:o,activeId:i,onSelect:t,favorites:l,onToggleFav:s}){const[d,c]=(0,n.useState)(!1);return o.length?(0,r.jsxs)(Y,{children:[(0,r.jsxs)(_,{onClick:()=>c(e=>!e),children:[(0,r.jsxs)(V,{children:[a,e]}),(0,r.jsx)(W,{open:d,children:(0,r.jsx)(k.A,{size:12})})]}),(0,r.jsx)(J,{open:d,children:(0,r.jsx)(U,{children:o.map(e=>{const a=l.some(a=>a.id===e.id);return(0,r.jsxs)(Z,{children:[(0,r.jsx)(X,{active:i===e.id,onClick:()=>t(e),children:e.name}),(0,r.jsx)(q,{active:a,title:a?"Remover dos favoritos":"Adicionar aos favoritos",onClick:a=>{a.stopPropagation(),s(e)},children:(0,r.jsx)(K.A,{size:12,fill:a?"currentColor":"none"})})]},e.id)})})})]}):null}function ee({config:e,activeId:a,onSelect:o,hashPrefix:i}){const t=`atlantis-recent-${i}`,l=`atlantis-fav-${i}`,[s,d]=(0,n.useState)(()=>D(t)),[c,m]=(0,n.useState)(()=>D(l)),g=(0,n.useCallback)(e=>{e.file&&d(a=>function(e,a,o){const n=[a,...o.filter(e=>e.id!==a.id)].slice(0,10);return localStorage.setItem(e,JSON.stringify(n)),n}(t,e,a)),o(e)},[o,t]),u=(0,n.useCallback)(e=>{m(a=>function(e,a,o){const n=o.some(e=>e.id===a.id)?o.filter(e=>e.id!==a.id):[...o,a];return localStorage.setItem(e,JSON.stringify(n)),n}(l,e,a))},[l]);return(0,r.jsxs)(G,{children:[(0,r.jsx)(Q,{title:"Recentes",icon:(0,r.jsx)(O.A,{size:13}),entries:s,activeId:a,onSelect:g,favorites:c,onToggleFav:u}),(0,r.jsx)(Q,{title:"Favoritos",icon:(0,r.jsx)(K.A,{size:13}),entries:c,activeId:a,onSelect:g,favorites:c,onToggleFav:u}),(0,r.jsx)(I,{entries:e.entries,activeId:a,onSelect:g})]})}var ae=o(28976),oe=o(18055),ne=o(66225),ie=o(302),te=o(39895),re=o(6930),le=o(14944);const se=t.default.div`
...
`;let ce=!1;function me({code:e}){const a=(0,n.useRef)(null),[t,l]=(0,n.useState)(null);return(0,n.useEffect)(()=>{let n=!1;return async function(){const t=(await o.e(774).then(o.bind(o,30774))).default;if(ce||(t.initialize({startOnLoad:!1,theme:"dark",themeVariables:{background:i.w.colors.codeBg,primaryColor:i.w.colors.accent,primaryTextColor:i.w.colors.mainText,lineColor:i.w.colors.border}}),ce=!0),a.current&&!n)try{const o=`mermaid-${Math.random().toString(36).slice(2)}`,{svg:i}=await t.render(o,e);!n&&a.current&&(a.current.innerHTML=i)}catch(e){n||l(e instanceof Error?e.message:String(e))}}(),()=>{n=!0}},[e]),t?(0,r.jsx)(se,{children:(0,r.jsxs)(de,{children:["Mermaid error: ",t]})}):(0,r.jsx)(se,{ref:a})}var ge=o(68383),ue=o(21426),fe=o(25609),pe=o(20320);const ye=t.default.div`
  margin: ${i.w.spacing.lg} 0;
  border-radius: ${i.w.borderRadius.md};
  border: 1px solid ${i.w.colors.codeBorder};
  overflow: hidden;
...
`,Re=t.default.ul`list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 2px;`,Fe=t.default.a`
  display: block;
  padding: 4px 8px;
...
`;function sa({title:e,sub:a}){return(0,r.jsxs)(aa,{children:[(0,r.jsx)(na,{}),(0,r.jsx)(oa,{size:500,x:10,y:-10,hue:210,dur:7}),(0,r.jsx)(oa,{size:400,x:60,y:50,hue:270,dur:9}),(0,r.jsx)(oa,{size:300,x:30,y:70,hue:190,dur:6}),(0,r.jsxs)(ia,{children:[(0,r.jsx)(ta,{children:e}),(0,r.jsx)(ra,{children:a}),(0,r.jsxs)(la,{children:[(0,r.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round",children:(0,r.jsx)("polyline",{points:"15 18 9 12 15 6"})}),"Browse the sidebar"]})]})]})}function da(e,a,o){return"string"==typeof e?e:e[a]??e[o]??Object.values(e)[0]??""}function ca({navigation:e,languages:a,defaultLang:o,hashPrefix:i,topBarRight:t,welcomeTitle:l="Blog",welcomeSub:s="Notes, guides, and references — pick a topic from the sidebar to get started."}){const d=a?Object.keys(a):[],c=d.length>1,[m,g]=(0,n.useState)(()=>o??d[0]??""),u=(0,n.useMemo)(()=>a&&m?a[m].navigation:e??{entries:[]},[a,e,m]),f=((0,n.useMemo)(()=>ea(u.entries),[u]),(0,n.useCallback)(e=>{const a=e.match(new RegExp(`^#\\/${i}\\/(.+)$`));if(a)return Qe(u.entries,a[1])},[u,i])),[p,y]=(0,n.useState)(()=>f(window.location.hash)??null);(0,n.useEffect)(()=>{y(null)},[m]),(0,n.useEffect)(()=>{const e=()=>{const e=f(window.location.hash);e&&y(e)};return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[f]);const h=(0,n.useCallback)(e=>{e.file&&(y(e),window.location.hash=`#/${i}/${e.id}`)},[i]),b=(0,n.useMemo)(()=>ea(u.entries),[u]),x=b.findIndex(e=>e.id===p?.id),z=x>0?b[x-1]:null,w=x<b.length-1?b[x+1]:null,$=p?.label??p?.name??i,v=da(l,m,o??d[0]??""),k=da(s,m,o??d[0]??""),j=c&&a?(0,r.jsx)(qe,{languages:Object.fromEntries(d.map(e=>[e,{label:a[e].label}])),activeLang:m,onChange:g}):null;return(0,r.jsx)(A,{title:$,activeId:p?.id??null,topBarRight:(0,r.jsxs)(r.Fragment,{children:[j,t]}),sidebar:(0,r.jsx)(ee,{config:u,activeId:p?.id??null,onSelect:h,hashPrefix:i}),children:p?.file?(0,r.jsx)(Ue,{file:p.file,prevEntry:z,nextEntry:w,onNavigate:h}):(0,r.jsx)(sa,{title:v,sub:k})})}},74914(e,a,o){o.d(a,{FlyoutPanel:()=>h});var n=o(27359),i=o(53233),t=o(77207),r=o(20255),l=o(217),s=o(15959),d=o(65185),c=o(65723);const m=t.keyframes`
