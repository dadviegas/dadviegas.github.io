"use strict";(self.webpackChunk_atlantis_apiexplorer=self.webpackChunk_atlantis_apiexplorer||[]).push([[723],{4914(a,o,e){e.d(o,{FlyoutPanel:()=>z});var n=e(7359),t=e(3233),i=e(7207),r=e(255),l=e(217),c=e(5959),s=e(5185),m=e(8104);const d=i.keyframes`
...
`,i.default.div`
  position: relative;
`;var l=e(7207);e(5959);const c="260px",s="56px",m=(i.default.header`
  display: flex;
  align-items: center;
...
`,i.default.div`
  ...
  overflow: hidden;
`,i.default.aside`
  width: ${({collapsed:a})=>a?s:c};
  min-width: ${({collapsed:a})=>a?s:c};
  background: ${n.w4.colors.sidebarBg};
  border-right: 1px solid ${n.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,B=i.default.div`
  ...
  color: ${n.w4.colors.sidebarTextMuted};
  font-family: ${n.w4.typography.fontFamily};
`;function j({onSave:a,onUpdate:o,onCancel:e,existingDoc:n}){const[i,l]=(0,t.useState)(n?.name??""),c=(0,t.useRef)(null);return(0,t.useEffect)(()=>{c.current?.focus(),n&&c.current?.select()},[n]),(0,r.jsx)(w,{onClick:e,children:(0,r.jsxs)(A,{onClick:a=>a.stopPropagation(),children:[(0,r.jsx)(v,{children:"Save document"}),n&&o&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(B,{children:"Update the current version or save as a new one."}),(0,r.jsxs)(k,{children:[(0,r.jsx)(S,{onClick:e,children:"Cancel"}),(0,r.jsxs)(S,{danger:!0,onClick:o,children:['Update "',n.name,'"']})]}),(0,r.jsx)(M,{})]}),(0,r.jsx)($,{ref:c,value:i,onChange:a=>l(a.target.value),onKeyDown:t=>{"Enter"===t.key&&i.trim()&&(n&&i.trim()===n.name&&o?o():a(i.trim())),"Escape"===t.key&&e()},placeholder:n?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,r.jsxs)(k,{children:[!n&&(0,r.jsx)(S,{onClick:e,children:"Cancel"}),(0,r.jsx)(S,{primary:!0,disabled:!i.trim(),onClick:()=>a(i.trim()),children:"Save as new"})]})]})})}var T=e(8006),P=e(679),E=e(4872);const C=i.default.div`
  position: relative;
`,L=i.default.button`
  display: flex;
  align-items: center;
...
//# sourceMappingURL=723.9b3a788873fd80aee8a5.js.map