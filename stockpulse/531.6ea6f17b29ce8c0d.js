"use strict";(self.webpackChunk_atlantis_stockpulse=self.webpackChunk_atlantis_stockpulse||[]).push([["531"],{9855(e,o,r){r.d(o,{A:()=>I});var t=r(5723),a=r(7991),i=r(6859),n=r.n(i),l=r(2799),s=r(18),d=r(4764),p=r(9522);let c=(0,l.keyframes)`0%,100%{opacity:1}50%{opacity:.4}`,g=n().div`
  display: flex;
...
`,C=[{symbol:"AAPL",label:"Apple (AAPL)"},{symbol:"MSFT",label:"Microsoft (MSFT)"},{symbol:"NVDA",label:"NVIDIA (NVDA)"},{symbol:"GOOGL",label:"Alphabet (GOOGL)"},{symbol:"TSM",label:"TSMC (TSM)"},{symbol:"ASML",label:"ASML (ASML)"}];function B(e){return new Date(e+"T12:00:00Z").toLocaleDateString("en-US",{month:"short",day:"numeric",timeZone:"UTC"})}function D({bar:e}){let[o,r]=(0,a.useState)(!1);return(0,t.jsxs)(M,{bg:(0,p.yv)(e.changePct),onMouseEnter:()=>r(!0),onMouseLeave:()=>r(!1),children:[o&&(0,t.jsxs)(H,{children:[(0,t.jsx)("div",{style:{fontWeight:600,marginBottom:4},children:B(e.date)}),(0,t.jsxs)("div",{children:["Open  ",(0,p.Sc)(e.open,e.open>100?0:2)]}),(0,t.jsxs)("div",{children:["Close ",(0,p.Sc)(e.close,e.close>100?0:2)]}),(0,t.jsxs)("div",{children:["High  ",(0,p.Sc)(e.high,e.high>100?0:2)]}),(0,t.jsxs)("div",{children:["Low   ",(0,p.Sc)(e.low,e.low>100?0:2)]}),(0,t.jsx)("div",{style:{marginTop:4,color:e.changePct>=0?"#3fb950":"#f85149",fontWeight:600},children:(0,p.pT)(e.changePct)})]}),(0,t.jsx)(k,{children:B(e.date)}),(0,t.jsx)(z,{children:(0,p.pT)(e.changePct)})]})}function I(){let[e,o]=(0,a.useState)("1mo"),[r,i]=(0,a.useState)("AAPL"),{bars:n,loading:l}=(0,p.W6)(r,e),c=function(e){if(0===e.length)return[];let o=[],r=[],t=-1;return e.forEach(e=>{var a;let i,n,l=((i=new Date(Date.UTC((a=new Date(e.date+"T12:00:00Z")).getUTCFullYear(),a.getUTCMonth(),a.getUTCDate()))).setUTCDate(i.getUTCDate()+4-(i.getUTCDay()||7)),n=new Date(Date.UTC(i.getUTCFullYear(),0,1)),Math.ceil(((i.getTime()-n.getTime())/864e5+1)/7));l!==t&&r.length>0&&(o.push(r),r=[]),r.push(e),t=l}),r.length>0&&o.push(r),o.slice(-8)}(n),k=n.filter(e=>e.changePct>0),z=n.filter(e=>e.changePct<0),H=n.reduce((e,o)=>e.changePct>o.changePct?e:o,n[0]),I=n.reduce((e,o)=>e.changePct<o.changePct?e:o,n[0]),V=n.length>1?(n[n.length-1].close-n[0].close)/n[0].close*100:0;return(0,t.jsxs)(g,{children:[(0,t.jsxs)(x,{children:[(0,t.jsxs)(f,{children:[(0,t.jsx)(s.In,{name:"calendar",size:18,color:"#e3b341"}),"Good & Bad Days"]}),(0,t.jsxs)(h,{children:[(0,t.jsx)(b,{value:r,onChange:e=>i(e.target.value),children:C.map(e=>(0,t.jsx)("option",{value:e.symbol,children:e.label},e.symbol))}),["5d","1mo","3mo"].map(r=>(0,t.jsx)(m,{active:e===r,onClick:()=>o(r),children:"5d"===r?"1W":"1mo"===r?"1M":"3M"},r))]})]}),(0,t.jsxs)(w,{children:[(0,t.jsxs)(u,{children:[(0,t.jsx)($,{children:["Mon","Tue","Wed","Thu","Fri"].map(e=>(0,t.jsx)(v,{children:e},e))}),l?Array.from({length:4}).map((e,o)=>(0,t.jsx)(y,{children:Array.from({length:5}).map((e,o)=>(0,t.jsx)(j,{},o))},o)):c.map((e,o)=>{let r=[null,null,null,null,null];return e.forEach(e=>{let o=new Date(e.date+"T12:00:00Z").getUTCDay()-1;o>=0&&o<5&&(r[o]=e)}),(0,t.jsx)(y,{children:r.map((e,o)=>e?(0,t.jsx)(D,{bar:e},o):(0,t.jsx)(M,{bg:"transparent",empty:!0},o))},o)}),(0,t.jsxs)(L,{style:{marginTop:d.w4.spacing.sm},children:[(0,t.jsx)("span",{children:"−4%"}),(0,t.jsx)(P,{}),(0,t.jsx)("span",{children:"+4%"})]})]}),(0,t.jsxs)(T,{children:[(0,t.jsxs)(S,{children:[(0,t.jsx)(F,{children:"Period Return"}),(0,t.jsx)(A,{positive:V>=0,children:(0,p.pT)(V)}),(0,t.jsxs)(R,{children:[n.length," trading days"]})]}),(0,t.jsxs)(S,{children:[(0,t.jsx)(F,{children:"Up Days"}),(0,t.jsxs)(A,{positive:!0,children:[k.length,(0,t.jsxs)("span",{style:{fontSize:13,fontWeight:400,color:d.w4.colors.mainTextMuted},children:[" ","/ ",n.length]})]}),(0,t.jsxs)(R,{children:[n.length>0?Math.round(k.length/n.length*100):0,"% of trading days"]})]}),(0,t.jsxs)(S,{children:[(0,t.jsx)(F,{children:"Down Days"}),(0,t.jsxs)(A,{positive:!1,children:[z.length,(0,t.jsxs)("span",{style:{fontSize:13,fontWeight:400,color:d.w4.colors.mainTextMuted},children:[" ","/ ",n.length]})]}),(0,t.jsxs)(R,{children:[n.length>0?Math.round(z.length/n.length*100):0,"% of trading days"]})]}),H&&(0,t.jsxs)(S,{children:[(0,t.jsx)(F,{children:"Best Day"}),(0,t.jsxs)(A,{positive:!0,children:[(0,t.jsx)(s.In,{name:"trending-up",size:14,style:{marginRight:4}}),(0,p.pT)(H.changePct)]}),(0,t.jsx)(R,{children:B(H.date)})]}),I&&(0,t.jsxs)(S,{children:[(0,t.jsx)(F,{children:"Worst Day"}),(0,t.jsxs)(A,{positive:!1,children:[(0,t.jsx)(s.In,{name:"trending-down",size:14,style:{marginRight:4}}),(0,p.pT)(I.changePct)]}),(0,t.jsx)(R,{children:B(I.date)})]}),(0,t.jsxs)(S,{children:[(0,t.jsx)(F,{children:"How to read"}),(0,t.jsx)("div",{style:{fontSize:11,color:d.w4.colors.mainTextMuted,lineHeight:1.5},children:"Each cell is one trading day. Dark green = strong up day. Dark red = strong down day. Hover any cell for open, close, high, low, and % change."})]})]})]})]})}},6104(e,o,r){r.d(o,{A:()=>I});var t=r(5723);r(7991);var a=r(6859),i=r.n(a),n=r(2799),l=r(4764),s=r(18),d=r(9522);let p=(0,n.keyframes)`0%,100%{opacity:1}50%{opacity:.4}`,c=i().div`
  display: flex;
  flex-direction: column;
  gap: ${l.w4.spacing.lg};
`,g=i().div`
...
`,i().span`
  ...
  background: ${({color:e})=>e};
  display: inline-block;
`;let M={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:n.w4.colors.accentMuted},k={neutral:n.w4.colors.mainTextMuted,live:n.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:n.w4.colors.accent};i().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${n.w4.typography.fontFamilyMono};
