...
`,oH=s().div`
  ...
  font-family: ${n.w4.typography.fontFamily};
  margin-bottom: ${n.w4.spacing.md};
`,oR=s().ul`list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 2px;`,oE=s().a`
  display: block;
  padding: 4px 8px;
...
`;function oP({headings:e,activeId:o}){return e.length<2?null:(0,t.jsxs)(oL,{children:[(0,t.jsx)(oH,{children:"On this page"}),(0,t.jsx)(oR,{children:e.map(e=>(0,t.jsx)("li",{children:(0,t.jsx)(oE,{href:`#${e.id}`,active:o===e.id,level:e.level,onClick:o=>{o.preventDefault(),document.getElementById(e.id)?.scrollIntoView({behavior:"smooth",block:"start"})},children:e.text})},e.id))})]})}function oV(e){return e.toLowerCase().replace(/[*_`[\]()#]/g,"").replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-").trim()}function oI(){return e=>{!function e(o){if("blockquote"===o.type){let e=o.children?.[0];if(e?.type==="paragraph"){let a=e.children?.[0];if(a?.type==="text"){let t=a.value?.match(/^\[!(NOTE|TIP|WARNING|CAUTION|IMPORTANT)\]\s*/i);t&&(a.value=a.value.slice(t[0].length),a.value.trim()||1!==e.children.length||o.children.shift(),o.data=o.data??{},o.data.hName="div",o.data.hProperties={"data-callout":t[1].toUpperCase()})}}}o.children?.forEach(e)}(e)}}let oD=s().div`
  display: flex;
  align-items: flex-start;
  max-width: 1200px;
  margin: 0 auto;
