"use strict";(self.webpackChunk_atlantis_codediff=self.webpackChunk_atlantis_codediff||[]).push([[12],{4914(a,o,n){n.d(o,{FlyoutPanel:()=>y});var e=n(7359),i=n(3233),t=n(7207),l=n(255),r=n(217),m=n(5959),c=n(5185),s=n(5723);const d=t.keyframes`
...
`;function p({iconKey:a}){const o=a?c.t[a]??l.A:l.A;return(0,s.jsx)(o,{size:14,strokeWidth:1.75})}function z({entries:a,activeId:o,onSelect:n}){return(0,s.jsx)(s.Fragment,{children:a.map(a=>a.children?(0,s.jsx)(e.Fragment,{children:(0,s.jsx)(z,{entries:a.children,activeId:o,onSelect:n})},a.id):(0,s.jsxs)(f,{active:o===a.id,onClick:()=>n(a),children:[(0,s.jsx)(p,{iconKey:a.icon}),a.name]},a.id))})}function y({activeId:a}){const{flyout:o,scheduleFlyoutClose:n,cancelFlyoutClose:e}=(0,m.c)();if(!o)return null;const i=o.entry.icon?c.t[o.entry.icon]??l.A:l.A;return(0,s.jsxs)(g,{anchorY:o.anchorY,onMouseEnter:e,onMouseLeave:n,children:[(0,s.jsxs)(u,{children:[(0,s.jsx)(i,{size:13,strokeWidth:2}),o.entry.name]}),(0,s.jsx)(z,{entries:o.entry.children??[],activeId:a,onSelect:a=>{o.onSelect(a),n()}})]})}},5959(a,o,n){n.d(o,{c:()=>t});var e=n(7359);const i=(0,e.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),t=()=>(0,e.useContext)(i)},5185(a,o,n){n.d(o,{t:()=>V});var e=n(9510),i=n(9038),t=n(8207),l=n(6896),r=n(7901),m=n(9848),c=n(2164),s=n(3775),d=n(3539),g=n(1783),u=n(1837),f=n(2314),p=n(5751),z=n(255),y=n(9633),b=n(2946),h=n(822),A=n(6720),x=n(3317),w=n(2709),k=n(3517),v=n(7032),S=n(6949),$=n(8218),M=n(6829),B=n(5553),T=n(9591),P=n(2820),E=n(4621),L=n(6673),N=n(9033),j=n(1365),C=n(5912),D=n(8641),_=n(3249),K=n(1821),R=n(9161),F=n(1849),G=n(7747),H=n(2932),I=n(4525),U=n(7230);const V={activity:l.A,"bar-chart-2":e.A,book:m.A,"book-open":r.A,calendar:s.A,clock:g.A,"circle-dot":d.A,feather:f.A,"file-text":p.A,globe:A.A,hash:x.A,heart:w.A,landmark:k.A,layers:t.A,leaf:S.A,map:T.A,package:L.A,compass:u.A,"git-branch":b.A,github:h.A,minus:E.A,terminal:_.A,thermometer:K.A,users:F.A,wind:G.A,"pie-chart":i.A,plus:j.A,slash:C.A,star:D.A,zap:U.A,bot:c.A,lightbulb:$.A,"message-square":P.A,wrench:H.A,x:I.A,"layout-grid":v.A,list:M.A,file:z.A,folder:y.A,"map-pin":B.A,"pen-tool":N.A,type:R.A}},906(a,o,n){n.d(o,{w4:()=>e.w});var e=n(217),i=(n(7359),n(3233));n(5723),i.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
