"use strict";(self.webpackChunk_atlantis_citypulse=self.webpackChunk_atlantis_citypulse||[]).push([["206"],{3819(o,e,a){a.d(e,{Mq:()=>t,QH:()=>i});var r=a(9874);let t=["lisbon","ponta-delgada","lourinha","new-york","san-francisco","london","paris","berlin","tokyo","dubai","singapore","sao-paulo","sydney"].map(o=>r.rh.find(e=>e.id===o)).filter(o=>void 0!==o).map(function(o){return{id:o.id,name:o.name,country:o.country,lat:o.lat,lon:o.lng,timezone:o.timezone}});function i(o){return o<=20?{label:"Good",color:"#3fb950"}:o<=40?{label:"Fair",color:"#d29922"}:o<=60?{label:"Moderate",color:"#f0883e"}:o<=80?{label:"Poor",color:"#f85149"}:{label:"Very Poor",color:"#8957e5"}}},5332(o,e,a){a.d(e,{A:()=>h});var r=a(5723),t=a(7991),i=a.n(t),n=a(6859),l=a.n(n),s=a(9874),d=a(3819);let c=l().div`
  display: flex;
...
`,x=l().div`
  ...
  white-space: nowrap;
  z-index: 10;
`;function h({airQuality:o,loading:e}){let[a,n]=i().useState(null),l=i().useRef(null),u=(0,t.useMemo)(()=>{if(!o)return[];let e=o.european_aqi,a=Math.max(...e.filter(Boolean),1),r=114,t=792/e.length;return e.map((e,i)=>{let n=e??0,l=n/Math.max(a,80)*r;return{x:4+i*t+.1*t,y:22+r-l,w:.8*t,h:l,val:n,color:(0,d.QH)(n).color,time:o.time[i]?.slice(11,16)??""}})},[o]);return(0,r.jsxs)(c,{children:[(0,r.jsx)("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"baseline"},children:(0,r.jsx)(p,{children:"Air Quality (EU AQI)"})}),(0,r.jsx)(g,{children:[0,21,41,61,81].map(o=>{let{label:e,color:a}=(0,d.QH)(o);return(0,r.jsx)(m,{color:a,children:e},e)})}),e?(0,r.jsx)(f,{}):(0,r.jsxs)("div",{style:{position:"relative"},children:[(0,r.jsxs)("svg",{ref:l,viewBox:"0 0 800 160",width:"100%",height:160,style:{display:"block",cursor:"crosshair"},onMouseLeave:()=>n(null),children:[[.5,1].map(o=>(0,r.jsx)("line",{x1:4,y1:22+114*(1-o),x2:796,y2:22+114*(1-o),stroke:s.w4.colors.border,strokeWidth:1},o)),u.map((o,e)=>(0,r.jsxs)("g",{children:[(0,r.jsx)("rect",{x:o.x,y:o.y,width:o.w,height:o.h,rx:2,fill:o.color,opacity:a?.i===e?1:.75,onMouseEnter:()=>{if(!l.current)return;let a=l.current.getBoundingClientRect(),r=a.width/800;n({i:e,x:(o.x+o.w/2)*r,y:o.y*(a.height/160)})}}),o.val>0&&(0,r.jsx)("text",{x:o.x+o.w/2,y:Math.max(18,o.y-4),textAnchor:"middle",fontSize:9,fontWeight:"600",fill:o.color,children:o.val})]},e)),[0,6,12,18,23].map(o=>u[o]?(0,r.jsx)("text",{x:u[o].x+u[o].w/2,y:156,textAnchor:"middle",fontSize:10,fill:s.w4.colors.mainTextMuted,children:u[o].time},o):null)]}),a&&u[a.i]&&(0,r.jsxs)(x,{x:a.x,y:a.y,children:[u[a.i].time," — AQI ",u[a.i].val," (",(0,d.QH)(u[a.i].val).label,")"]})]})]})}},4439(o,e,a){a.d(e,{A:()=>k});var r=a(5723),t=a(7991),i=a.n(t),n=a(6859),l=a.n(n),s=a(9874),d=a(3819),c=a(9522),p=a(1951);let g=l().div`
  display: flex;
  flex-direction: column;
  gap: ${s.w4.spacing.lg};
`,m=l().h3`
...
`,h=({size:o=14,strokeWidth:e=1.75})=>(0,r.jsxs)("svg",{width:o,height:o,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:e,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,r.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,r.jsx)("polyline",{points:"14 2 14 8 20 8"})]});function u({iconKey:o}){let e=o?p.t[o]:null;return e?(0,r.jsx)(e,{size:14,strokeWidth:1.75}):(0,r.jsx)(h,{})}function b({entries:o,activeId:e,onSelect:a}){return(0,r.jsx)(r.Fragment,{children:o.map(o=>o.children?(0,r.jsx)(i().Fragment,{children:(0,r.jsx)(b,{entries:o.children,activeId:e,onSelect:a})},o.id):(0,r.jsxs)(x,{active:e===o.id,onClick:()=>a(o),children:[(0,r.jsx)(u,{iconKey:o.icon}),o.name]},o.id))})}function y({activeId:o}){let{flyout:e,scheduleFlyoutClose:a,cancelFlyoutClose:t}=(0,c.c)();if(!e)return null;let i=e.entry.icon?p.t[e.entry.icon]:null;return(0,r.jsxs)(m,{anchorY:e.anchorY,onMouseEnter:t,onMouseLeave:a,children:[(0,r.jsxs)(f,{children:[i?(0,r.jsx)(i,{size:13,strokeWidth:2}):(0,r.jsx)(h,{size:13,strokeWidth:2}),e.entry.name]}),(0,r.jsx)(b,{entries:e.entry.children??[],activeId:o,onSelect:o=>{e.onSelect(o),a()}})]})}},814(o,e,a){a.d(e,{I:()=>t,c:()=>i});var r=a(7991);let t=(0,r.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),i=()=>(0,r.useContext)(t)},6140(o,e,a){a.d(e,{t:()=>oy});var r=a(6896),t=a(7902),i=a(3013),n=a(2887),l=a(9510),s=a(9848),d=a(7901),c=a(3045),p=a(3775),g=a(1783),m=a(3539),f=a(9416),x=a(1837),h=a(7167),u=a(4494),b=a(2314),y=a(255),w=a(5751),$=a(9633),v=a(2946),z=a(822),k=a(6720),M=a(7400),A=a(8456),j=a(3317),T=a(2709),S=a(8006),F=a(9301),B=a(7561),C=a(3517),H=a(8207),R=a(7032),L=a(6949),P=a(8218),E=a(6829),V=a(9591),I=a(5553),Y=a(9923),D=a(2820),_=a(4621),G=a(8479),K=a(2534),N=a(6673),W=a(7490),O=a(9033),q=a(9038),U=a(5775),Q=a(1365),Z=a(4893),J=a(2937),X=a(9821),oo=a(5912),oe=a(158),oa=a(8641),or=a(8607),ot=a(3249),oi=a(1821),on=a(5889),ol=a(9655),os=a(7170),od=a(9161),oc=a(1849),op=a(1604),og=a(3142),om=a(1187),of=a(7747),ox=a(2932),oh=a(4525),ou=a(7230),ob=a(2164);let oy={activity:r.A,"a-large-small":t.A,apple:i.A,"arrow-right":n.A,"bar-chart-2":l.A,book:s.A,"book-open":d.A,briefcase:c.A,calendar:p.A,clock:g.A,"circle-dot":m.A,cloud:f.A,compass:x.A,cpu:h.A,droplets:u.A,feather:b.A,file:y.A,"file-text":w.A,folder:$.A,"git-branch":v.A,github:z.A,globe:k.A,grid:M.A,hand:A.A,hash:j.A,heart:T.A,key:S.A,hexagon:F.A,home:B.A,landmark:C.A,layers:H.A,"layout-grid":R.A,leaf:L.A,lightbulb:P.A,list:E.A,map:V.A,"map-pin":I.A,"message-circle":Y.A,"message-square":D.A,minus:_.A,monitor:G.A,mountain:K.A,package:N.A,palette:W.A,"pen-tool":O.A,"pie-chart":q.A,plane:U.A,plus:Q.A,puzzle:Z.A,ruler:J.A,shirt:X.A,slash:oo.A,square:oe.A,star:oa.A,sun:or.A,terminal:ot.A,thermometer:oi.A,triangle:on.A,trophy:ol.A,truck:os.A,type:od.A,users:oc.A,"volume-2":op.A,watch:og.A,waves:om.A,wind:of.A,wrench:ox.A,x:oh.A,zap:ou.A,bot:ob.A}},9874(o,e,a){a.d(e,{wi:()=>Q,PH:()=>J,NI:()=>U,rh:()=>N,w4:()=>r.w4,KW:()=>Z,PL:()=>W.getSetting});var r=a(1316),t=a(5723),i=a(7991),n=a.n(i),l=a(6859),s=a.n(l);s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
