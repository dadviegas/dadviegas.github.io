...
`;let F=l().div`
  ...
  align-items: center;
  gap: 8px;
`;function B({children:o,...e}){return(0,t.jsx)(F,{...e,children:o})}let H=l().label`
  display: flex;
  align-items: center;
  gap: 10px;
...
`,l().div`
  position: relative;
`;let X="260px",Q="56px",oo="48px",oe=l().header`
  display: flex;
  align-items: center;
  height: calc(${oo} + env(safe-area-inset-top, 0px));
  ...
  @media (max-width: ${s.w4.breakpoints.md}) {
    flex-wrap: wrap;
    height: auto;
    min-height: calc(${oo} + env(safe-area-inset-top, 0px));
  }
`,oa=l().div`
  width: ${Q};
  min-width: ${Q};
...
`,on=l().span`
  ...
  animation: ${or} 10s ease ${({index:o})=>.07*o}s infinite;
...
`,oc=l().div`
  ...
  overflow: hidden;
`,op=l().aside`
  width: ${({collapsed:o})=>o?Q:X};
  min-width: ${({collapsed:o})=>o?Q:X};
  background: ${s.w4.colors.sidebarBg};
  border-right: 1px solid ${s.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,om=l().main`
  ...
  display: flex;
  flex-direction: column;
`,oh=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function of(){return(0,t.jsx)(oi,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:oh.map((o,e)=>(0,t.jsx)(on,{index:e,accent:o.accent,children:o.char},e))})}let ox="atlantis:sidebar-collapsed";function ou({sidebar:o,children:e,topBarRight:n,title:l="Atlantis",activeId:s=null}){let[d,c]=(0,r.useState)(()=>{try{return"true"===localStorage.getItem(ox)}catch{return!1}}),[p,g]=(0,r.useState)(null),m=(0,r.useRef)(),h=()=>c(o=>{let e=!o;try{localStorage.setItem(ox,String(e))}catch{}return e}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(a.bind(a,2787)).then(o=>({default:o.FlyoutPanel}))),[]);return(0,t.jsx)(G.I.Provider,{value:{collapsed:d,toggle:h,flyout:p,openFlyout:(o,e,a)=>{clearTimeout(m.current),g({entry:o,anchorY:e,onSelect:a})},scheduleFlyoutClose:()=>{m.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(m.current)},children:(0,t.jsxs)(oc,{children:[(0,t.jsxs)(oe,{children:[o&&(0,t.jsx)(oa,{children:(0,t.jsx)(ot,{onClick:h,title:d?"Expand sidebar":"Collapse sidebar",children:(0,t.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("path",{d:"M9 3v18"})]})})}),(0,t.jsx)(of,{}),l&&(0,t.jsx)(ol,{children:l}),n&&(0,t.jsx)(os,{children:n})]}),(0,t.jsxs)(od,{children:[null!=o&&(0,t.jsx)(op,{collapsed:d,children:(0,t.jsx)(og,{children:o})}),(0,t.jsx)(om,{children:e})]}),p&&(0,t.jsx)(i().Suspense,{fallback:null,children:(0,t.jsx)(f,{activeId:s})})]})})}var ob=a(4971);let oy=l().div`
  display: grid;
  grid-template-rows: ${({open:o})=>o?"1fr":"0fr"};
...
`;function oS({iconKey:o,size:e=16}){let a=o?ob.X[o]:void 0;return a?(0,t.jsx)("svg",{width:e,height:e,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,dangerouslySetInnerHTML:{__html:a}}):o?(0,t.jsx)("span",{style:{fontSize:e,lineHeight:1,display:"flex",alignItems:"center"},children:o}):(0,t.jsxs)("svg",{width:e,height:e,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,children:[(0,t.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,t.jsx)("polyline",{points:"14 2 14 8 20 8"})]})}function oj({entry:o,activeId:e,onSelect:a}){let[i,n]=(0,r.useState)(o.defaultOpen??!0),{collapsed:l,openFlyout:s,scheduleFlyoutClose:d,cancelFlyoutClose:c}=(0,G.c)();return o.children&&o.children.length>0?(0,t.jsxs)(ov,{children:[(0,t.jsxs)(oz,{collapsed:l,onClick:()=>{l||n(o=>!o)},onMouseEnter:l?e=>{s(o,e.currentTarget.getBoundingClientRect().top,a)}:void 0,onMouseLeave:l?d:void 0,children:[(0,t.jsxs)(oM,{collapsed:l,children:[(0,t.jsx)(oS,{iconKey:o.icon,size:16}),(0,t.jsx)(ok,{collapsed:l,children:o.name})]}),(0,t.jsx)(oA,{open:i,collapsed:l,children:(0,t.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round",children:(0,t.jsx)("path",{d:"M9 6l6 6-6 6"})})})]}),(0,t.jsx)(oy,{open:i&&!l,children:(0,t.jsx)(ow,{children:(0,t.jsx)(o$,{children:o.children.map(o=>(0,t.jsx)(oj,{entry:o,activeId:e,onSelect:a},o.id))})})})]}):(0,t.jsxs)(oT,{active:e===o.id,collapsed:l,onClick:()=>a(o),onMouseEnter:l?e=>{let t=e.currentTarget.getBoundingClientRect();s({id:o.id,name:o.name,icon:o.icon,file:o.file,children:[o]},t.top,a)}:void 0,onMouseLeave:l?d:void 0,children:[(0,t.jsx)(oS,{iconKey:o.icon,size:15}),(0,t.jsx)(ok,{collapsed:l,children:o.name})]})}function oF({entries:o,activeId:e,onSelect:a}){return(0,t.jsx)("div",{children:o.map(o=>(0,t.jsx)(oj,{entry:o,activeId:e,onSelect:a},o.id))})}a(2787),l().div`
