...
`;function g({iconKey:e}){const t=e?d.t[e]??n.A:n.A;return(0,c.jsx)(t,{size:14,strokeWidth:1.75})}function x({entries:e,activeId:t,onSelect:a}){return(0,c.jsx)(c.Fragment,{children:e.map(e=>e.children?(0,c.jsx)(o.Fragment,{children:(0,c.jsx)(x,{entries:e.children,activeId:t,onSelect:a})},e.id):(0,c.jsxs)(h,{active:t===e.id,onClick:()=>a(e),children:[(0,c.jsx)(g,{iconKey:e.icon}),e.name]},e.id))})}function m({activeId:e}){const{flyout:t,scheduleFlyoutClose:a,cancelFlyoutClose:o}=(0,s.c)();if(!t)return null;const i=t.entry.icon?d.t[t.entry.icon]??n.A:n.A;return(0,c.jsxs)(f,{anchorY:t.anchorY,onMouseEnter:o,onMouseLeave:a,children:[(0,c.jsxs)(u,{children:[(0,c.jsx)(i,{size:13,strokeWidth:2}),t.entry.name]}),(0,c.jsx)(x,{entries:t.entry.children??[],activeId:e,onSelect:e=>{t.onSelect(e),a()}})]})}},5959(e,t,a){a.d(t,{I:()=>i,c:()=>r});var o=a(7359);const i=(0,o.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),r=()=>(0,o.useContext)(i)},5185(e,t,a){a.d(t,{t:()=>w});var o=a(7901),i=a(2164),r=a(1837),n=a(5751),l=a(255),s=a(9633),d=a(2946),c=a(822),p=a(7032),f=a(8218),u=a(5553),h=a(2820),g=a(6673),x=a(3249),m=a(2932),b=a(7230);const w={"book-open":o.A,"file-text":n.A,package:g.A,compass:r.A,"git-branch":d.A,github:c.A,terminal:x.A,zap:b.A,bot:i.A,lightbulb:f.A,"message-square":h.A,wrench:m.A,"layout-grid":p.A,file:l.A,folder:s.A,"map-pin":u.A}},3188(e,t,a){a.d(t,{PE:()=>j,CD:()=>D,w4:()=>o.w});var o=a(217),i=a(7359),r=a(3233),n=a(5723);r.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 30px;
...
`,$=r.default.main`
  ...
  display: flex;
  flex-direction: column;
`,v="atlantis:sidebar-collapsed";function j({sidebar:e,children:t,topBarRight:o,title:r="Atlantis",activeId:d=null}){const[c,j]=(0,i.useState)(()=>{try{return"true"===localStorage.getItem(v)}catch{return!1}}),[S,k]=(0,i.useState)(null),M=(0,i.useRef)(),z=()=>j(e=>{const t=!e;try{localStorage.setItem(v,String(t))}catch{}return t}),T=i.useMemo(()=>i.lazy(()=>Promise.resolve().then(a.bind(a,4914)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,n.jsx)(s.I.Provider,{value:{collapsed:c,toggle:z,flyout:S,openFlyout:(e,t,a)=>{clearTimeout(M.current),k({entry:e,anchorY:t,onSelect:a})},scheduleFlyoutClose:()=>{M.current=setTimeout(()=>k(null),160)},cancelFlyoutClose:()=>clearTimeout(M.current)},children:(0,n.jsxs)(b,{children:[(0,n.jsxs)(p,{children:[(0,n.jsx)(f,{children:(0,n.jsx)(u,{onClick:z,title:c?"Expand sidebar":"Collapse sidebar",children:(0,n.jsx)(l.A,{size:17})})}),(0,n.jsxs)(h,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:["Atl",(0,n.jsx)("span",{children:"antis"})]}),r&&(0,n.jsx)(g,{children:r}),o&&(0,n.jsx)(x,{children:o})]}),(0,n.jsxs)(m,{children:[(0,n.jsx)(w,{collapsed:c,children:(0,n.jsx)(y,{children:e})}),(0,n.jsx)($,{children:t})]}),S&&(0,n.jsx)(i.Suspense,{fallback:null,children:(0,n.jsx)(T,{activeId:d})})]})})}var S=a(255),k=a(9753),M=a(5185);const z=r.default.div`
  display: grid;
...
`;function B({iconKey:e,size:t=16}){const a=e?M.t[e]??S.A:S.A;return(0,n.jsx)(a,{size:t,strokeWidth:1.75})}function L({entry:e,activeId:t,onSelect:a}){const[o,r]=(0,i.useState)(!0),{collapsed:l,openFlyout:d,scheduleFlyoutClose:c,cancelFlyoutClose:p}=(0,s.c)();return e.children&&e.children.length>0?(0,n.jsxs)(I,{children:[(0,n.jsxs)(C,{collapsed:l,onClick:()=>{l||r(e=>!e)},onMouseEnter:l?t=>{const o=t.currentTarget.getBoundingClientRect();d(e,o.top,a)}:void 0,onMouseLeave:l?c:void 0,children:[(0,n.jsxs)(F,{collapsed:l,children:[(0,n.jsx)(B,{iconKey:e.icon,size:16}),(0,n.jsx)(P,{collapsed:l,children:e.name})]}),(0,n.jsx)(E,{open:o,collapsed:l,children:(0,n.jsx)(k.A,{size:13})})]}),(0,n.jsx)(z,{open:o&&!l,children:(0,n.jsx)(T,{children:(0,n.jsx)(A,{children:e.children.map(e=>(0,n.jsx)(L,{entry:e,activeId:t,onSelect:a},e.id))})})})]}):(0,n.jsxs)(R,{active:t===e.id,collapsed:l,onClick:()=>a(e),onMouseEnter:l?t=>{const o=t.currentTarget.getBoundingClientRect();d({id:e.id,name:e.name,icon:e.icon,file:e.file,children:[e]},o.top,a)}:void 0,onMouseLeave:l?c:void 0,children:[(0,n.jsx)(B,{iconKey:e.icon,size:15}),(0,n.jsx)(P,{collapsed:l,children:e.name})]})}function D({entries:e,activeId:t,onSelect:a}){return(0,n.jsx)("div",{children:e.map(e=>(0,n.jsx)(L,{entry:e,activeId:t,onSelect:a},e.id))})}const G=a(7207).keyframes`
