...
`,l().div`
  position: relative;
`;let X="260px",W="56px",U="48px",Z=l().header`
  display: flex;
  align-items: center;
...
`,eo=l().span`
  ...
  animation: ${Q} 10s ease ${({index:e})=>.07*e}s infinite;
...
`,ei=l().div`
  ...
  overflow: hidden;
`,en=l().aside`
  width: ${({collapsed:e})=>e?W:X};
  min-width: ${({collapsed:e})=>e?W:X};
  background: ${s.w4.colors.sidebarBg};
  border-right: 1px solid ${s.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,es=l().main`
  ...
  display: flex;
  flex-direction: column;
`,ed=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function ec(){return(0,t.jsx)(ee,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:ed.map((e,o)=>(0,t.jsx)(eo,{index:o,accent:e.accent,children:e.char},o))})}let ep="atlantis:sidebar-collapsed";function eg({sidebar:e,children:o,topBarRight:n,title:l="Atlantis",activeId:s=null}){let[d,c]=(0,a.useState)(()=>{try{return"true"===localStorage.getItem(ep)}catch{return!1}}),[p,g]=(0,a.useState)(null),h=(0,a.useRef)(),x=()=>c(e=>{let o=!e;try{localStorage.setItem(ep,String(o))}catch{}return o}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(r.bind(r,5816)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,t.jsx)(Y.I.Provider,{value:{collapsed:d,toggle:x,flyout:p,openFlyout:(e,o,r)=>{clearTimeout(h.current),g({entry:e,anchorY:o,onSelect:r})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,t.jsxs)(ei,{children:[(0,t.jsxs)(Z,{children:[e&&(0,t.jsx)(J,{children:(0,t.jsx)(K,{onClick:x,title:d?"Expand sidebar":"Collapse sidebar",children:(0,t.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("path",{d:"M9 3v18"})]})})}),(0,t.jsx)(ec,{}),l&&(0,t.jsx)(er,{children:l}),n&&(0,t.jsx)(et,{children:n})]}),(0,t.jsxs)(ea,{children:[null!=e&&(0,t.jsx)(en,{collapsed:d,children:(0,t.jsx)(el,{children:e})}),(0,t.jsx)(es,{children:o})]}),p&&(0,t.jsx)(i().Suspense,{fallback:null,children:(0,t.jsx)(f,{activeId:s})})]})})}l().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
