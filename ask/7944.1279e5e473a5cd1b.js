...
`},87330(o,e,a){a.d(e,{FlyoutPanel:()=>oL});var t=a(65723),r=a(37991),n=a.n(r),i=a(36859),l=a.n(i),s=a(72799),d=a(81316),c=a(40814),p=a(36896),g=a(87902),m=a(53013),f=a(32887),x=a(49510),u=a(39848),h=a(37901),b=a(3045),y=a(43775),w=a(41783),$=a(83539),v=a(39416),z=a(1837),k=a(57167),M=a(84494),A=a(82314),T=a(20255),S=a(35751),j=a(69633),F=a(92946),B=a(40822),C=a(36720),R=a(57400),L=a(58456),P=a(43317),H=a(52709),E=a(8006),N=a(89301),I=a(37561),D=a(83517),V=a(28207),Y=a(37032),G=a(6949),K=a(8218),O=a(36829),W=a(59591),_=a(15553),U=a(69923),q=a(72820),Z=a(14621),J=a(68479),X=a(72534),Q=a(66673),oo=a(67490),oe=a(49033),oa=a(99038),ot=a(45775),or=a(31365),on=a(62937),oi=a(9821),ol=a(65912),os=a(80158),od=a(88641),oc=a(48607),op=a(83249),og=a(1821),om=a(15889),of=a(89655),ox=a(27170),ou=a(19161),oh=a(71849),ob=a(41604),oy=a(13142),ow=a(61187),o$=a(77747),ov=a(2932),oz=a(24525),ok=a(57230),oM=a(22164);let oA={activity:p.A,"a-large-small":g.A,apple:m.A,"arrow-right":f.A,"bar-chart-2":x.A,book:u.A,"book-open":h.A,briefcase:b.A,calendar:y.A,clock:w.A,"circle-dot":$.A,cloud:v.A,compass:z.A,cpu:k.A,droplets:M.A,feather:A.A,file:T.A,"file-text":S.A,folder:j.A,"git-branch":F.A,github:B.A,globe:C.A,grid:R.A,hand:L.A,hash:P.A,heart:H.A,key:E.A,hexagon:N.A,home:I.A,landmark:D.A,layers:V.A,"layout-grid":Y.A,leaf:G.A,lightbulb:K.A,list:O.A,map:W.A,"map-pin":_.A,"message-circle":U.A,"message-square":q.A,minus:Z.A,monitor:J.A,mountain:X.A,package:Q.A,palette:oo.A,"pen-tool":oe.A,"pie-chart":oa.A,plane:ot.A,plus:or.A,ruler:on.A,shirt:oi.A,slash:ol.A,square:os.A,star:od.A,sun:oc.A,terminal:op.A,thermometer:og.A,triangle:om.A,trophy:of.A,truck:ox.A,type:ou.A,users:oh.A,"volume-2":ob.A,watch:oy.A,waves:ow.A,wind:o$.A,wrench:ov.A,x:oz.A,zap:ok.A,bot:oM.A},oT=(0,s.keyframes)`
...
`,oB=({size:o=14,strokeWidth:e=1.75})=>(0,t.jsxs)("svg",{width:o,height:o,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:e,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,t.jsx)("polyline",{points:"14 2 14 8 20 8"})]});function oC({iconKey:o}){let e=o?oA[o]:null;return e?(0,t.jsx)(e,{size:14,strokeWidth:1.75}):(0,t.jsx)(oB,{})}function oR({entries:o,activeId:e,onSelect:a}){return(0,t.jsx)(t.Fragment,{children:o.map(o=>o.children?(0,t.jsx)(n().Fragment,{children:(0,t.jsx)(oR,{entries:o.children,activeId:e,onSelect:a})},o.id):(0,t.jsxs)(oF,{active:e===o.id,onClick:()=>a(o),children:[(0,t.jsx)(oC,{iconKey:o.icon}),o.name]},o.id))})}function oL({activeId:o}){let{flyout:e,scheduleFlyoutClose:a,cancelFlyoutClose:r}=(0,c.c)();if(!e)return null;let n=e.entry.icon?oA[e.entry.icon]:null;return(0,t.jsxs)(oS,{anchorY:e.anchorY,onMouseEnter:r,onMouseLeave:a,children:[(0,t.jsxs)(oj,{children:[n?(0,t.jsx)(n,{size:13,strokeWidth:2}):(0,t.jsx)(oB,{size:13,strokeWidth:2}),e.entry.name]}),(0,t.jsx)(oR,{entries:e.entry.children??[],activeId:o,onSelect:o=>{e.onSelect(o),a()}})]})}},40814(o,e,a){a.d(e,{I:()=>r,c:()=>n});var t=a(37991);let r=(0,t.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),n=()=>(0,t.useContext)(r)},23930(o,e,a){a.d(e,{kd:()=>C.deleteDoc,PL:()=>C.getSetting,mZ:()=>C.updateDoc,KL:()=>C.saveDoc,cL:()=>c.c,Is:()=>C.putSetting,Iu:()=>C.listDocs,PE:()=>F,fy:()=>H,w4:()=>t.w4});var t=a(81316),r=a(65723),n=a(37991),i=a.n(n),l=a(36859),s=a.n(l);s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`;function H({children:o,...e}){return(0,t.jsx)(P,{...e,children:o})}let E=l().div`
  ...
  align-items: center;
  gap: 8px;
`;function N({children:o,...e}){return(0,t.jsx)(E,{...e,children:o})}l().label`
  display: flex;
  align-items: center;
  gap: 10px;
...
`,l().p`
  ...
  font-size: 12.5px;
  line-height: 1.45;
`;var D=a(11352),V=a(76710),Y=a(4311),G=a(73639),K=a(8411);a(75406),l().nav`padding: ${s.w4.spacing.sm} 0;`,l().div`
...
`,U=!1;function q(o){if("u"<typeof window)return o;let e=o.match(/^var\((--[-\w]+)\)$/);return e&&getComputedStyle(document.documentElement).getPropertyValue(e[1]).trim()||o}function Z({code:o}){let e=(0,r.useRef)(null),[n,i]=(0,r.useState)(null),[l,d]=(0,r.useState)(!1);return((0,r.useEffect)(()=>{let t=!1;if(i(null),d(!1),!o.trim())return void d(!0);let r=o.trim().split(/\r?\n/)[0]?.trim()??"";return/^(?:---[\s\S]*?---\s*)?(?:graph|flowchart|sequenceDiagram|classDiagram|stateDiagram(?:-v2)?|erDiagram|pie|gantt|journey|mindmap|gitGraph|sankey(?:-beta)?|quadrantChart|requirementDiagram|timeline|xychart-beta|block-beta|C4Context|C4Container|C4Component|C4Dynamic|C4Deployment)\b/.test(r)?(async function(){let r=(await a.e("6087").then(a.bind(a,29738))).default;if(U||(r.initialize({startOnLoad:!1,theme:"dark",themeVariables:{background:q(s.w4.colors.codeBg),primaryColor:q(s.w4.colors.accent),primaryTextColor:q(s.w4.colors.mainText),lineColor:q(s.w4.colors.border)}}),U=!0),e.current&&!t)try{let a=`mermaid-${(0,O.z)()}`,{svg:n}=await r.render(a,o);if(t||!e.current)return;if(/aria-roledescription="error"/i.test(n))return void d(!0);e.current.innerHTML=n,requestAnimationFrame(()=>{if(t||!e.current)return;let o=e.current.querySelector("svg");if(!o)return void d(!0);let a=o.getBoundingClientRect();a.width<2&&a.height<2&&d(!0)})}catch(o){t||i(o instanceof Error?o.message:String(o))}}(),()=>{t=!0}):void d(!0)},[o]),n||l)?(0,t.jsx)(_,{children:o.trim()}):(0,t.jsx)(W,{ref:e})}let J=["#388bfd","#3fb950","#d29922","#a371f7","#f87171","#22d3ee","#fb923c","#34d399","#f472b6","#818cf8"],X=l().div`
  background: ${s.w4.colors.codeBg};
  border: 1px solid ${s.w4.colors.codeBorder};
  border-radius: ${s.w4.borderRadius.md};
  padding: ${s.w4.spacing.lg};
...
`,l().span`
  font-size: ${s.w4.typography.fontSizeBase};
  color: ${s.w4.colors.mainTextMuted};
`;var op=a(17223),og=a(21426),om=a(25609),of=a(20320);let ox=l().div`
  margin: ${s.w4.spacing.lg} 0;
  border-radius: ${s.w4.borderRadius.md};
  border: 1px solid ${s.w4.colors.codeBorder};
  overflow: hidden;
...
`,oy={...og.A,'pre[class*="language-"]':{...og.A['pre[class*="language-"]'],background:s.w4.colors.codeBg,margin:0,padding:"18px 20px",fontSize:"13px",lineHeight:"1.6",borderRadius:0},'code[class*="language-"]':{...og.A['code[class*="language-"]'],background:"none",fontSize:"13px"}};function ow({lang:o="text",code:e}){let[a,n]=(0,r.useState)(!1);return(0,t.jsxs)(ox,{children:[(0,t.jsxs)(ou,{children:[(0,t.jsx)(oh,{children:o}),(0,t.jsxs)(ob,{copied:a,onClick:()=>{navigator.clipboard.writeText(e).then(()=>{n(!0),setTimeout(()=>n(!1),2e3)})},children:[a?(0,t.jsx)(om.A,{size:12}):(0,t.jsx)(of.A,{size:12}),a?"Copied!":"Copy"]})]}),(0,t.jsx)(op.A,{language:o,style:oy,showLineNumbers:e.split("\n").length>8,lineNumberStyle:{color:"#484f58",minWidth:"2.5em",paddingRight:"1.5em",userSelect:"none",fontSize:"12px"},customStyle:{margin:0,background:s.w4.colors.codeBg},wrapLongLines:!1,children:e})]})}var o$=a(65569),ov=a(8218),oz=a(57230),ok=a(22966),oM=a(21069);let oA={NOTE:{bg:"rgba(88, 166, 255, 0.08)",border:"#58a6ff",icon:o$.A,label:"Note",color:"#58a6ff"},TIP:{bg:"rgba(63, 185, 80, 0.08)",border:"#3fb950",icon:ov.A,label:"Tip",color:"#3fb950"},IMPORTANT:{bg:"rgba(163, 113, 247, 0.08)",border:"#a371f7",icon:oz.A,label:"Important",color:"#a371f7"},WARNING:{bg:"rgba(210, 153, 34, 0.08)",border:"#d29922",icon:ok.A,label:"Warning",color:"#d29922"},CAUTION:{bg:"rgba(248, 81, 73, 0.08)",border:"#f85149",icon:oM.A,label:"Caution",color:"#f85149"}},oT=l().div`
  background: ${({bg:o})=>o};
...
`;function oF({type:o,children:e}){let a=oA[o]??oA.NOTE,r=a.icon;return(0,t.jsxs)(oT,{bg:a.bg,border:a.border,children:[(0,t.jsxs)(oS,{color:a.color,children:[(0,t.jsx)(r,{size:15,strokeWidth:2}),a.label]}),(0,t.jsx)(oj,{children:e})]})}l().nav`
  width: 220px;
  min-width: 220px;
...
`;function oP({children:o}){return(0,t.jsx)(oL,{children:(0,t.jsx)(D.oz,{remarkPlugins:[V.A,Y.A,oR],rehypePlugins:[G.A,K.A],components:{div({node:o,children:e,...a}){let r=a["data-callout"];return r?(0,t.jsx)(oF,{type:r,children:e}):(0,t.jsx)("div",{...a,children:e})},pre:({children:o})=>(0,t.jsx)(t.Fragment,{children:o}),code({className:o,children:e}){let a=/language-(\w+)/.exec(o??"")?.[1],r=String(e).replace(/\n$/,"");return r.trim()?"mermaid"===a?(0,t.jsx)(Z,{code:r}):"chart"===a?(0,t.jsx)(os,{code:r}):a||r.includes("\n")?(0,t.jsx)(ow,{lang:a,code:r}):(0,t.jsx)("code",{className:o,children:e}):null}},children:o})})}l().nav`
  display: flex;
  flex-direction: column;
  gap: 1px;
  padding: ${s.w4.spacing.sm} 0;
