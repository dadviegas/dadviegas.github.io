"use strict";(self.webpackChunk_atlantis_apiexplorer=self.webpackChunk_atlantis_apiexplorer||[]).push([[8608],{4914(o,e,a){a.d(e,{FlyoutPanel:()=>b});var t=a(7359),r=a(3233),n=a(7207),i=a(255),l=a(217),d=a(5959),s=a(5185),c=a(5723);const p=n.keyframes`
...
`;function J({activeAppId:o}){const{collapsed:e}=(0,n.cL)(),[a]=function(){const[o,e]=(0,t.useState)(v),a=(0,t.useCallback)(o=>{e(o),function(o){try{localStorage.setItem(w,o)}catch{}(0,n.Is)($,o).catch(()=>{})}(o),window.dispatchEvent(new CustomEvent("atlantis:locale-change",{detail:o}))},[]);return(0,t.useEffect)(()=>{const o=o=>{const a=o.detail;e(a)};return window.addEventListener("atlantis:locale-change",o),()=>window.removeEventListener("atlantis:locale-change",o)},[]),(0,t.useEffect)(()=>{(0,n.PL)($).then(a=>{if(z(a)&&a!==o){try{localStorage.setItem(w,a)}catch{}e(a)}}).catch(()=>{})},[]),[o,a]}(),r=(0,t.useMemo)(()=>function(o){const e=y;return(a,t)=>{const r=e[a]?.[o]??a;return t?Object.entries(t).reduce((o,[e,a])=>o.replace(new RegExp(`\\{${e}\\}`,"g"),String(a)),r):r}}(a),[a]),l=(0,t.useRef)(null),d=o=>{l.current!==o&&(l.current=o,document.activeElement?.blur(),window.location.hash=o,setTimeout(()=>{l.current=null},50))};return(0,i.jsxs)(Y,{children:[(0,i.jsx)(V,{collapsed:e,children:r("devtools.heading")}),N.map(a=>{const t=r(a.labelKey);return(0,i.jsxs)(G,{active:o===a.id,collapsed:e,onPointerDown:o=>{0===o.button&&d(a.hash)},onClick:()=>d(a.hash),title:t,children:[(0,i.jsx)(_,{children:(0,i.jsx)(M,{name:a.icon,size:16})}),(0,i.jsx)(O,{collapsed:e,children:t})]},a.id)})]})}}}]);