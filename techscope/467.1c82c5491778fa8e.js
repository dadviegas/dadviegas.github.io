"use strict";(self.webpackChunk_atlantis_techscope=self.webpackChunk_atlantis_techscope||[]).push([["467"],{5748(e,o,t){t.d(o,{W:()=>oY});var r=t(5723),a=t(3236),i=t(7991),n=t.n(i),s=t(6859),l=t.n(s),d=t(6063),p=t(3019),c=t(9522),g=t(2799),x=t(8170);let h=(0,g.keyframes)`
  0%, 100% { opacity: 1; }
  50% { opacity: 0.3; }
`,f=(0,g.keyframes)`
...
`,s().div`
  position: relative;
`;let N="260px",W="56px",O="56px",X=s().header`
  display: flex;
  align-items: center;
