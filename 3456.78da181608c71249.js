...
`,tp=l().div`
  ...
  padding: 8vh 16px;
  animation: ${td} ${c.w4.transitions.fast};
`,th=l().div`
  width: 760px;
  max-width: 100%;
  max-height: 84vh;
  ...
  animation: ${tc} ${c.w4.transitions.base};
  display: flex;
...
`,tv=l()("button",{shouldForwardProp:e=>"active"!==e&&"chipColor"!==e})`
  display: inline-flex;
  align-items: center;
  gap: 6px;
  height: 28px;
...
`,t$=l().div`
  ...
  gap: 12px;
`,tk=l()("button",{shouldForwardProp:e=>"added"!==e})`
  position: relative;
  display: flex;
  flex-direction: column;
  gap: 8px;
...
`,tA=l()("span",{shouldForwardProp:e=>"swatchColor"!==e})`
  width: 6px;
  height: 6px;
  border-radius: 50%;
...
`,tF=l().div`
  ...
  color: ${c.w4.colors.mainTextMuted};
  font-size: 13px;
`;function tL({open:e,activeIds:t,locale:a,onAdd:n,onRemove:r,onRemoveAll:s,onClose:l}){let d=(0,o.useMemo)(()=>(0,g.Nx)(a,to),[a]),[c,h]=(0,o.useState)(""),[m,u]=(0,o.useState)("all"),[f,x]=(0,o.useState)(!1),b=(0,o.useRef)(null);(0,o.useEffect)(()=>{e&&(h(""),u("all"),requestAnimationFrame(()=>b.current?.focus()))},[e]),(0,o.useEffect)(()=>{if(!e)return;let t=e=>{"Escape"===e.key&&l()};return document.addEventListener("keydown",t),()=>document.removeEventListener("keydown",t)},[e,l]);let y=(0,o.useMemo)(()=>{let e=c.trim().toLowerCase();return te.filter(t=>{if("all"!==m&&t.suite!==m)return!1;if(!e)return!0;let i="pt"===a?t.labels.pt:t.labels.en,o="pt"===a?t.descriptions.pt:t.descriptions.en;return i.toLowerCase().includes(e)||o.toLowerCase().includes(e)||t.id.toLowerCase().includes(e)||t.suite.toLowerCase().includes(e)})},[c,m,a]);return e?tr().createPortal((0,i.jsxs)(tp,{onClick:l,children:[(0,i.jsxs)(th,{onClick:e=>e.stopPropagation(),role:"dialog","aria-label":d("widgets.picker.title"),children:[(0,i.jsxs)(tg,{children:[(0,i.jsxs)(tm,{children:[(0,i.jsx)(p.YZ,{children:d("widgets.picker.eyebrow")}),(0,i.jsx)(tx,{onClick:l,"aria-label":d("widgets.picker.close"),children:(0,i.jsx)(p.In,{name:"close",size:14,"aria-hidden":"true"})})]}),(0,i.jsx)(tu,{children:d("widgets.picker.title")}),(0,i.jsx)(tf,{children:d("widgets.picker.subtitle")})]}),(0,i.jsxs)(tb,{children:[(0,i.jsx)(p.pd,{ref:b,placeholder:d("widgets.picker.searchPlaceholder"),value:c,onChange:e=>h(e.target.value),before:(0,i.jsx)(p.In,{name:"search",size:14,"aria-hidden":"true"})}),(0,i.jsxs)(ty,{role:"tablist",children:[ts.map(e=>(0,i.jsxs)(tv,{active:m===e.id,chipColor:e.color,onClick:()=>u(e.id),role:"tab","aria-selected":m===e.id,children:[e.color&&(0,i.jsx)("span",{className:"dot"}),d(e.labelKey)]},e.id)),t.size>0&&(0,i.jsxs)(tw,{type:"button",onClick:()=>x(!0),"aria-label":d("widgets.picker.removeAll"),children:[(0,i.jsx)(p.In,{name:"trash",size:12,"aria-hidden":"true"}),d("widgets.picker.removeAll",{n:t.size})]})]})]}),(0,i.jsx)(t$,{children:0===y.length?(0,i.jsx)(tF,{children:d("widgets.picker.empty")}):y.map(e=>{let o=t.has(e.id),s="pt"===a?e.labels.pt:e.labels.en,l="pt"===a?e.descriptions.pt:e.descriptions.en,c=tl[e.suite],h=ts.find(t=>t.id===e.suite);return(0,i.jsxs)(tk,{added:o,onClick:()=>{o?r(e.id):n(e.id)},children:[(0,i.jsxs)(tM,{children:[(0,i.jsx)(tj,{children:e.icon}),(0,i.jsx)(tz,{children:s}),o&&(0,i.jsxs)(tS,{children:[(0,i.jsx)(p.In,{name:"check",size:10,"aria-hidden":"true"}),d("widgets.picker.added")]})]}),(0,i.jsx)(tC,{children:l}),(0,i.jsxs)(tT,{children:[(0,i.jsx)(tA,{swatchColor:c}),h?d(h.labelKey):e.suite]})]},e.id)})})]}),(0,i.jsx)(p.TM,{open:f,title:d("widgets.picker.removeAll",{n:t.size}),message:d("widgets.picker.removeAllConfirm"),confirmLabel:d("widgets.picker.removeAll",{n:t.size}),cancelLabel:d("widgets.picker.close"),danger:!0,onCancel:()=>x(!1),onConfirm:()=>{x(!1),s?s():Array.from(t).forEach(e=>r(e))}})]}),document.body):null}let tN="shell:dashboard-widgets",tP="shell:pending-open-widget-picker",tI=[{id:"w-ask-sessions",widgetId:"ask-sessions"},{id:"w-daily-feed",widgetId:"daily-feed"},{id:"w-techscope",widgetId:"techscope"},{id:"w-weather",widgetId:"weather"},{id:"w-clock",widgetId:"clock"}],tD=(0,d.keyframes)`
...
`,tJ=l().button`
  ...
  &:focus-visible { ${c.w4.focusRing} }
`,tQ=new Set(eT.filter(e=>"Developer Toolkit"===e.suite).map(e=>e.id)),tX="pin:";function tZ(e){return e.widgetId.startsWith(tX)}function t0(e){return e.widgetId.slice(tX.length)}let t1=new Set(["games","movies","devtools"]);function t4({instance:e,appId:t,meta:a,app:o,idx:n,totalCount:r,tShell:s,recentsOverride:l,onMove:d,onRemove:c,onSelectApp:g}){let m=(0,h.useRecents)(t),u=r>1?(0,i.jsxs)(i.Fragment,{children:[n>0&&(0,i.jsx)(tB,{type:"button",title:s("widgets.moveLeft"),onClick:t=>{t.stopPropagation(),d(e.id,-1)},children:(0,i.jsx)(p.In,{name:"chevron-left",size:13})}),n<r-1&&(0,i.jsx)(tB,{type:"button",title:s("widgets.moveRight"),onClick:t=>{t.stopPropagation(),d(e.id,1)},children:(0,i.jsx)(p.In,{name:"chevron-right",size:13})})]}):void 0;return(0,i.jsx)(p.SV,{vizId:t,label:a.label,description:a.description,hash:o?.hash??a.hash,category:a.category,accentColor:a.color,needsAuth:a.needsAuth,pinned:!0,index:n,onClick:()=>{o?g(o):window.location.hash=a.hash},onHoverIntent:o?()=>b(t):void 0,onTogglePin:()=>c(e.id),reorderControls:u,extra:t1.has(t)?function(e,t,a,o){if(0===e.length)return null;let n=e.slice(0,3);return(0,i.jsxs)(tq,{children:[(0,i.jsx)(tK,{children:a("pinnedCard.recent.label")}),(0,i.jsx)(tG,{children:n.map(e=>{let a,n,r;return(0,i.jsxs)(tW,{type:"button",tintColor:e.color??t,title:e.label,onClick:t=>{t.stopPropagation(),window.location.hash=e.hash},children:[(a=function(e){if(e)return eL[e.split("?")[0]]??eL[e]}(e.hash),n=a?.iconName??e.iconName??o,r=a?.color??e.color??t,n?(0,i.jsx)("span",{className:"glyph","aria-hidden":"true",style:{color:r},children:(0,i.jsx)(p.In,{name:n,size:14})}):e.icon?(0,i.jsx)("span",{className:"glyph","aria-hidden":"true",children:e.icon}):null),(0,i.jsx)("span",{className:"label",children:e.label})]},e.hash)})})]})}(l??m,a.color,s,a.icon):null})}function t2({locale:e,pinnedAppIds:t,recentAppIds:a,apps:n,appMeta:r,onSelectApp:s,onTogglePin:l}){let d=(0,o.useMemo)(()=>(0,g.Nx)(e,to),[e]),[m,u]=(0,o.useState)([]),[f,x]=(0,o.useState)(!1),[b,y]=(0,o.useState)(!1);(0,o.useEffect)(()=>{let e=()=>{try{sessionStorage.removeItem(tP)}catch{}y(!0)};window.addEventListener("atlantis:open-widget-picker",e);let t=!1;try{t="1"===sessionStorage.getItem(tP)}catch{}if(t){try{sessionStorage.removeItem(tP)}catch{}y(!0)}return()=>window.removeEventListener("atlantis:open-widget-picker",e)},[]),(0,o.useEffect)(()=>{let e=!1;return(async()=>{let t=await (0,c.PL)(tN);if(!e){if(t)try{let e=JSON.parse(t),a=function(e){if(!e.some(e=>"internet-now"===e.widgetId))return e;let t=[];for(let a of e)if("internet-now"===a.widgetId){let e=Date.now();t.push({id:`w-trending-${e}`,widgetId:"trending-searches"},{id:`w-wiki-${e+1}`,widgetId:"wiki-most-read"},{id:`w-hn-${e+2}`,widgetId:"hackernews-hot"})}else t.push(a);return t}(e);u(a),a!==e&&(0,c.Is)(tN,JSON.stringify(a))}catch{u(tI)}else u(tI);x(!0)}})(),()=>{e=!0}},[]),(0,o.useEffect)(()=>{f&&u(e=>{let a=new Set(t),i=new Set(e.filter(tZ).map(t0)),o=e.filter(e=>!tZ(e)||a.has(t0(e)));for(let e of t)i.has(e)||(o=[...o,{id:`pin-${e}`,widgetId:`${tX}${e}`}]);return o.length!==e.length||o.some((t,a)=>t.id!==e[a]?.id)?((0,c.Is)(tN,JSON.stringify(o)),o):e})},[t,f]);let w=(0,o.useRef)(new Set);(0,o.useEffect)(()=>{if(!f)return;let e=new Set(m.filter(e=>!tZ(e)).map(e=>e.widgetId)),t=w.current;for(let a of e){if(t.has(a))continue;let e=tt(a);if(e?.notifications?.length){for(let t of e.notifications)h.events.registerCategory({id:t.category,labelKey:t.labelKey??`notifications.source.${t.id}`,badgeColor:e.accentColor??c.w4.colors.mainTextMuted});h.events.registerRules(e.notifications)}}for(let a of t){if(e.has(a))continue;let t=tt(a);if(t){if(t.notifications?.length){h.events.unregisterRules(t.notifications.map(e=>e.id));let e=new Set(t.notifications.map(e=>e.category));for(let t of h.events.getItems())e.has(t.category)&&h.events.dismiss(t.id)}for(let e of t.sources.filter(e=>e.cacheKey).map(e=>`widget-cache:${e.cacheKey}`))(0,c.bg)(e);if(t.persistedKeys)for(let e of t.persistedKeys)(0,c.bg)(e);(0,c.jv)(`notifications:${a}:`).then(e=>{for(let t of e)(0,c.bg)(t)}),t.cleanup&&t.cleanup().catch(()=>{})}}w.current=e},[m,f]);let v=(0,o.useCallback)(e=>{u(e),(0,c.Is)(tN,JSON.stringify(e))},[]),k=(0,o.useCallback)(e=>{v([...m,{id:`w-${e}-${Date.now()}`,widgetId:e}])},[m,v]),M=(0,o.useCallback)(e=>{let t=m.find(t=>t.id===e);t&&tZ(t)?l(t0(t)):v(m.filter(t=>t.id!==e))},[m,v,l]),j=(0,o.useCallback)(()=>{m.filter(tZ).forEach(e=>l(t0(e))),v([])},[m,v,l]),z=(0,o.useCallback)((e,t)=>{let a=m.findIndex(t=>t.id===e);if(a<0)return;let i=a+t;if(i<0||i>=m.length)return;let o=[...m];[o[a],o[i]]=[o[i],o[a]],v(o)},[m,v]),S=(0,o.useCallback)(e=>{let t=m.findIndex(t=>t.id===e);if(t<0)return;let a=m[t];if(tZ(a))return;let i=tt(a.widgetId);if(!i)return;let o=i.availableSizes??["sm","md","lg"],n=a.size??i.defaultSize,r=o.indexOf(n),s=o[(r+1)%o.length],l=[...m];l[t]={...a,size:s},v(l)},[m,v]),C=(0,o.useMemo)(()=>new Set(m.filter(e=>!tZ(e)).map(e=>e.widgetId)),[m]),T=(0,o.useMemo)(()=>new Map,[]);return((0,o.useEffect)(()=>{},[]),f)?(0,i.jsxs)(tR,{children:[(0,i.jsxs)(tH,{children:[(0,i.jsx)(tE,{children:d("widgets.dashboard")}),(0,i.jsxs)(tO,{active:b,onClick:()=>y(!b),children:[(0,i.jsx)(p.In,{name:"plus",size:14}),d("widgets.addWidget")]})]}),(0,i.jsx)(tL,{open:b,activeIds:C,locale:e,onAdd:e=>{k(e)},onRemove:e=>{let t=m.find(t=>!tZ(t)&&t.widgetId===e);t&&M(t.id)},onRemoveAll:j,onClose:()=>y(!1)}),0===m.length?(0,i.jsxs)(tY,{children:[(0,i.jsx)(tV,{children:"✨"}),(0,i.jsx)(t_,{children:d("widgets.empty.title")}),(0,i.jsx)(tU,{children:d("widgets.empty.body")}),(0,i.jsxs)(tJ,{onClick:()=>y(!0),children:[(0,i.jsx)(p.In,{name:"plus",size:14}),d("widgets.empty.cta")]})]}):(0,i.jsx)(p.dO,{items:m.flatMap(e=>{if(tZ(e))return[{id:e.id,size:"sm",availableSizes:["sm"],minHeight:160}];let t=tt(e.widgetId);return t?[{id:e.id,size:e.size??t.defaultSize,availableSizes:t.availableSizes??["sm","md","lg"],minHeight:t.minHeight??160}]:[]}),onReorder:(e,t)=>z(e,t),onCycleSize:e=>S(e),onRemove:e=>M(e),accentColor:e=>{let t=m.find(t=>t.id===e.id);if(!(!t||tZ(t)))return tt(t.widgetId)?.accentColor},labels:{moveLeft:d("widgets.moveLeft"),moveRight:d("widgets.moveRight"),cycleSize:d("widgets.cycleSize",{size:""}).trim(),remove:d("widgets.remove")},renderPanel:l=>{let c=m.find(e=>e.id===l.id);if(!c)return null;if(tZ(c)){let t=t0(c),o="devtools"===t,l=o?{icon:"terminal",label:d("apps.devtools.label"),description:d("apps.devtools.description"),color:"#facc15",category:$("Create",e),hash:"#/playground",needsAuth:!1}:r[t];if(!l)return null;let p=o?null:n.find(e=>e.id===t)??null,h=m.findIndex(e=>e.id===c.id),g=o?a.filter(e=>tQ.has(e)).map(e=>{let t=r[e];return{hash:t?.hash??`#/${e}`,label:t?.label??e,iconName:t?.icon,color:t?.color,ts:0}}):void 0;return(0,i.jsx)(t4,{instance:c,appId:t,meta:l,app:p,locale:e,idx:h,totalCount:m.length,tShell:d,recentsOverride:g,onMove:z,onRemove:M,onSelectApp:s})}if("quicklinks"===c.widgetId)return(0,i.jsx)(ti.QuickLinksWidget,{locale:e,pinnedAppIds:t,recentAppIds:a,apps:n,appMeta:r,onSelectApp:s});let p=tt(c.widgetId);if(!p)return null;T.has(c.widgetId)||T.set(c.widgetId,(0,o.lazy)(p.load));let h=T.get(c.widgetId);return(0,i.jsx)(o.Suspense,{fallback:null,children:(0,i.jsx)(h,{locale:e})})},showGrip:!1})]}):null}let t5={0:"☀️",1:"\uD83C\uDF24️",2:"⛅",3:"☁️",45:"\uD83C\uDF2B️",48:"\uD83C\uDF2B️",51:"\uD83C\uDF26️",53:"\uD83C\uDF26️",55:"\uD83C\uDF27️",61:"\uD83C\uDF27️",63:"\uD83C\uDF27️",65:"\uD83C\uDF27️",71:"\uD83C\uDF28️",73:"\uD83C\uDF28️",75:"\uD83C\uDF28️",80:"\uD83C\uDF26️",81:"\uD83C\uDF27️",82:"\uD83C\uDF27️",95:"⛈️",96:"⛈️",99:"⛈️"},t3={0:"\uD83C\uDF19",1:"\uD83C\uDF19",2:"☁️",3:"☁️"},t6=Object.fromEntries(eT.map(e=>[e.id,e.icon])),t8=Object.fromEntries(eT.map(e=>[e.id,e.color]));function t7(e){return e<10?`0${e}`:String(e)}function t9({locale:e,greeting:t,userName:a,pinnedApps:n,onSelect:r,t:s}){let[l,d]=(0,o.useState)(()=>new Date),{forecast:c}=(0,h.useWeather)({lat:m.j.lisbon.lat,lon:m.j.lisbon.lon,current:"temperature_2m,apparent_temperature,relative_humidity_2m,weather_code,wind_speed_10m,is_day",daily:"temperature_2m_max,temperature_2m_min,sunrise,sunset,uv_index_max",timezone:m.j.lisbon.timezone,cacheKey:"weather-lisbon-v3"});(0,o.useEffect)(()=>{let e=setInterval(()=>d(new Date),3e4);return()=>clearInterval(e)},[]);let g=`${t7(l.getHours())} : ${t7(l.getMinutes())}`,u=(0,o.useMemo)(()=>{let t,a,i;return t=l.toLocaleDateString("pt"===e?"pt-PT":"en-GB",{weekday:"long"}),a=l.getDate(),i=l.toLocaleDateString("pt"===e?"pt-PT":"en-GB",{month:"long"}),`${t} \xb7 ${a} ${i}`.toUpperCase()},[l,e]),f=n.slice(0,5),x=c?.current?(c.current.is_day?t5[c.current.weather_code??0]:t3[c.current.weather_code??0]??t5[c.current.weather_code??0])??"\xb7":null;return(0,i.jsxs)(at,{children:[c?.current&&(0,i.jsxs)(al,{children:[(0,i.jsx)("span",{className:"ico",children:x}),(0,i.jsxs)("span",{className:"temp",children:[Math.round(c.current.temperature_2m??0),"\xb0"]}),(0,i.jsx)("span",{className:"lbl",children:s("retreat.weather.city")})]}),(0,i.jsxs)(aa,{children:[(0,i.jsx)(ai,{children:u}),(0,i.jsxs)(ao,{children:[t,a?(0,i.jsxs)(i.Fragment,{children:[", ",(0,i.jsx)("span",{className:"name",children:a.split(" ")[0]})]}):null,"."]}),(0,i.jsx)(an,{children:g}),(0,i.jsxs)(ar,{"aria-hidden":!0,children:[(0,i.jsx)("span",{className:"caret",children:"⌘K"}),(0,i.jsx)("span",{className:"txt",children:s("retreat.prompt")})]}),f.length>0&&(0,i.jsx)(as,{children:f.map((e,t)=>(0,i.jsxs)(ad,{onClick:()=>r(e),title:`${t+1} \xb7 ${e.label}`,"aria-label":e.label,children:[(0,i.jsx)("span",{className:"ico",style:{color:t8[e.id]},children:t6[e.id]?(0,i.jsx)(p.In,{name:t6[e.id],size:18,"aria-hidden":"true"}):"\xb7"}),(0,i.jsx)("span",{className:"n",children:t+1})]},e.id))})]})]})}let ae=(0,d.keyframes)`
...
`,ap=l().div`
  ...
  animation: ${ac} 0.25s ${c.w4.transitions.easing} both;
...
`,av=l().div`
  ...
  color: ${c.w4.colors.mainTextMuted};
  line-height: 1.45;
`;function a$({t:e,onDismiss:t,onOpenPalette:a,onOpenPreferences:o}){let n=[{iconName:"search",titleKey:"onboarding.tip.palette.title",bodyKey:"onboarding.tip.palette.body",kbd:"⌘K",onClick:a},{iconName:"settings",titleKey:"onboarding.tip.preferences.title",bodyKey:"onboarding.tip.preferences.body",onClick:o},{iconName:"check",titleKey:"onboarding.tip.daily.title",bodyKey:"onboarding.tip.daily.body",onClick:()=>{window.location.hash="#/daily"}}];return(0,i.jsxs)(ap,{role:"region","aria-label":e("onboarding.aria"),children:[(0,i.jsxs)(ah,{children:[(0,i.jsxs)(ag,{children:[(0,i.jsx)(p.YZ,{children:e("onboarding.eyebrow")}),(0,i.jsx)(am,{children:e("onboarding.title")}),(0,i.jsx)(au,{children:e("onboarding.subtitle")})]}),(0,i.jsx)(af,{type:"button",title:e("onboarding.dismiss"),"aria-label":e("onboarding.dismiss"),onClick:t,children:(0,i.jsx)(p.In,{name:"close",size:14})})]}),(0,i.jsx)(ax,{children:n.map(t=>(0,i.jsxs)(ab,{type:"button",onClick:t.onClick,disabled:!t.onClick,children:[(0,i.jsx)(ay,{"aria-hidden":!0,children:(0,i.jsx)(p.In,{name:t.iconName,size:18})}),(0,i.jsxs)(aw,{children:[e(t.titleKey),t.kbd&&(0,i.jsx)(p.ue,{children:t.kbd})]}),(0,i.jsx)(av,{children:e(t.bodyKey)})]},t.titleKey))})]})}let ak=Object.fromEntries(eT.map(({id:e,icon:t,labelKey:a,descriptionKey:i,color:o,category:n,suite:r,interest:s,needsAuth:l,hash:d})=>[e,{icon:t,labelKey:a,descriptionKey:i,color:o,category:n,suite:r,interest:s,needsAuth:l,hash:d}])),aM=new Set(eT.filter(e=>"default"!==eC(e)).map(e=>e.id)),aj=eT.filter(e=>e.enabled&&"default"===eC(e)),az=["All","Live","School","Explore","Create","Inspect","Connect","Content","Fun","Lab","Tools"],aS=["Live","AI Lab","Data Studio","Life Dashboard","Learning Hub","Game Room","Entertainment"],aC=aS.filter(e=>aj.some(t=>ak[t.id]?.suite===e));function aT(e,t=new Date){let a=t.getHours();return k(a<12?"greeting.morning":a<19?"greeting.afternoon":"greeting.evening",e)}let aA={0:"☀️",1:"\uD83C\uDF24️",2:"⛅",3:"☁️",45:"\uD83C\uDF2B️",48:"\uD83C\uDF2B️",51:"\uD83C\uDF26️",53:"\uD83C\uDF26️",55:"\uD83C\uDF27️",61:"\uD83C\uDF27️",63:"\uD83C\uDF27️",65:"\uD83C\uDF27️",71:"\uD83C\uDF28️",73:"\uD83C\uDF28️",75:"\uD83C\uDF28️",80:"\uD83C\uDF26️",81:"\uD83C\uDF27️",82:"\uD83C\uDF27️",95:"⛈️",96:"⛈️",99:"⛈️"},aF={0:"\uD83C\uDF19",1:"\uD83C\uDF19",2:"☁️",3:"☁️"},aL=(0,d.keyframes)`
  from { opacity: 0; transform: translateY(8px); }
  to   { opacity: 1; transform: translateY(0); }
`,aN=l().div`
  display: flex;
...
`,aE=l()("nav",{shouldForwardProp:e=>"collapsed"!==e})`
...
`,aO=l()("button",{shouldForwardProp:e=>"collapsed"!==e})`
  display: flex;
  align-items: center;
  justify-content: space-between;
  width: 100%;
...
`,aB=l().span`
  ...
  flex-shrink: 0;
`,aq=l()("div",{shouldForwardProp:e=>"collapsed"!==e})`
  display: grid;
...
`,a8=l().button`
  ...
  &:focus-visible { ${c.w4.focusRing} }
`;function a7({apps:e,recentAppIds:t,pinnedAppIds:a,onTogglePin:n,onMovePinned:r,onSelect:s,user:l,onSignOut:d,onPreferences:u,onClearData:f,onOpenPalette:x,notifications:y}){let v,M,j,[z]=(0,h.useProfile)(),S=(0,o.useMemo)(()=>e.filter(e=>{if(aM.has(e.id))return!1;let t=ak[e.id];return!t||!(0,h.hasInterests)(z)||!t.interest||!!z.interests.includes(t.interest)}),[e,z]),[C,T]=(0,o.useState)("home"),[A,F]=(0,o.useState)("All"),[L,N]=(0,o.useState)(null),[P,I]=(0,o.useState)(()=>new Date),{forecast:D}=(0,h.useWeather)({lat:m.j.lisbon.lat,lon:m.j.lisbon.lon,current:"temperature_2m,apparent_temperature,relative_humidity_2m,weather_code,wind_speed_10m,is_day",daily:"temperature_2m_max,temperature_2m_min,sunrise,sunset,uv_index_max",timezone:m.j.lisbon.timezone,cacheKey:"weather-lisbon-v3"}),[R,H]=(0,o.useState)(!0);(0,o.useEffect)(()=>{let e=!1;return(0,c.PL)("shell:onboarding-dismissed").then(t=>{e||H("true"===t)}).catch(()=>void 0),()=>{e=!0}},[]);let E=(0,o.useCallback)(()=>{H(!0),(0,c.Is)("shell:onboarding-dismissed","true").catch(()=>void 0)},[]);(0,o.useEffect)(()=>{let e=setInterval(()=>I(new Date),6e4),t=()=>{document.hidden||I(new Date)};return document.addEventListener("visibilitychange",t),window.addEventListener("focus",t),()=>{clearInterval(e),document.removeEventListener("visibilitychange",t),window.removeEventListener("focus",t)}},[]);let O=(0,o.useCallback)(()=>{T("home"),F("All"),N(null),(0,c.Is)("shell:home-mode","dashboard")},[]),B=(0,o.useCallback)(()=>{T("retreat"),F("All"),N(null),(0,c.Is)("shell:home-mode","retreat")},[]),q=(0,o.useCallback)(e=>{T("apps"),N(e),F("All")},[]),K=(0,o.useMemo)(()=>({live:"Live",lab:"AI Lab",vida:"Life Dashboard",learn:"Learning Hub",games:"Game Room",ent:"Entertainment"}),[]);(0,o.useEffect)(()=>{let e=()=>{let e=window.location.hash,t=e.indexOf("?");if(t<0)return;let a=new URLSearchParams(e.slice(t+1)).get("suite");if(!a)return;let i=K[a];i&&(T("apps"),N(i),F("All"))};return e(),window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[K]);let[G,W]=(0,o.useState)(()=>{try{let e=localStorage.getItem("shell:suites-collapsed");return null===e||"true"===e}catch{return!0}}),[Y,V]=(0,o.useState)(()=>{try{return"true"===localStorage.getItem("shell:home-sidebar-hidden")}catch{return!1}}),[_]=(0,o.useState)(()=>{try{return"1"===sessionStorage.getItem(tP)}catch{return!1}});(0,o.useEffect)(()=>{let e=!1;return(async()=>{let[t,a,i]=await Promise.all([(0,c.PL)("shell:suites-collapsed"),(0,c.PL)("shell:home-mode"),(0,c.PL)("shell:home-sidebar-hidden")]);if(!e){if(null!==t){W("true"===t);try{localStorage.setItem("shell:suites-collapsed",t)}catch{}}if(null!==i){V("true"===i);try{localStorage.setItem("shell:home-sidebar-hidden",i)}catch{}}_?(T("home"),(0,c.Is)("shell:home-mode","dashboard").catch(()=>void 0)):"retreat"===a&&T("retreat")}})(),()=>{e=!0}},[_]),(0,o.useEffect)(()=>{let e=()=>{T("home"),F("All"),N(null)};return window.addEventListener("atlantis:open-widget-picker",e),()=>window.removeEventListener("atlantis:open-widget-picker",e)},[]);let U=(0,o.useCallback)(()=>{W(e=>{let t=!e;try{localStorage.setItem("shell:suites-collapsed",String(t))}catch{}return(0,c.Is)("shell:suites-collapsed",String(t)),t})},[]),J=(0,o.useCallback)(()=>{V(e=>{let t=!e;try{localStorage.setItem("shell:home-sidebar-hidden",String(t))}catch{}return(0,c.Is)("shell:home-sidebar-hidden",String(t)).catch(()=>void 0),t})},[]),[Q,X]=(0,g.Ym)(),Z=(0,o.useMemo)(()=>(0,g.Nx)(Q,to),[Q]),ee=(0,o.useMemo)(()=>{let e={};for(let t of S){let a=ak[t.id];a&&(e[t.id]={icon:a.icon,label:Z(a.labelKey),description:Z(a.descriptionKey),color:a.color,category:$(a.category,Q),hash:a.hash,needsAuth:!!a.needsAuth})}return e},[S,Z,Q]),et=(0,o.useMemo)(()=>S.filter(e=>{let t=ak[e.id],i="All"===A||t?.category===A,o=!L||t?.suite===L,n="All"===A&&!L&&a.includes(e.id);return i&&o&&!n}),[S,A,L,a]),ea=(0,o.useMemo)(()=>{if("All"!==A)return null;if(L){let e={};for(let t of et){let a=ak[t.id]?.category??"Other";e[a]||(e[a]=[]),e[a].push(t)}return{type:"category",groups:e}}let e={};for(let t of et){let a=ak[t.id]?.suite??"Other";e[a]||(e[a]=[]),e[a].push(t)}return{type:"suite",groups:e}},[et,A,L]),ei=(0,o.useMemo)(()=>{let e={};for(let t of S){let a=ak[t.id]?.suite;a&&(e[a]=(e[a]??0)+1)}return e["AI Lab"]=(e["AI Lab"]??0)+1,e},[S]),eo=(0,o.useMemo)(()=>a.flatMap(e=>S.filter(t=>t.id===e)),[a,S]),en=(0,o.useMemo)(()=>t.filter(e=>!a.includes(e)).flatMap(e=>S.filter(t=>t.id===e)).slice(0,6),[t,a,S]),er=0,es=(e,t,o)=>{let l=ak[e.id],d=a.includes(e.id),h=l?Z(l.descriptionKey):"",g=l?.color??c.w4.colors.accent,m=l?$(l.category,Q):"",u=o&&o.total>1?(0,i.jsxs)(i.Fragment,{children:[o.pinIdx>0&&(0,i.jsx)(a2,{type:"button",title:Z("pinned.moveLeft"),onClick:t=>{t.stopPropagation(),r(e.id,-1)},children:(0,i.jsx)(p.In,{name:"chevron-left",size:13})}),o.pinIdx<o.total-1&&(0,i.jsx)(a2,{type:"button",title:Z("pinned.moveRight"),onClick:t=>{t.stopPropagation(),r(e.id,1)},children:(0,i.jsx)(p.In,{name:"chevron-right",size:13})})]}):void 0;return(0,i.jsx)(p.SV,{vizId:e.id,label:e.label,description:h,hash:l?.hash??e.hash,category:m,accentColor:g,needsAuth:l?.needsAuth,pinned:d,index:t,onClick:()=>s(e),onHoverIntent:()=>b(e.id),onTogglePin:()=>n(e.id),reorderControls:u},e.id)},el=e=>{let t=a.includes("devtools");return(0,i.jsx)(p.SV,{vizId:"devtools",label:Z("apps.devtools.label"),description:Z("apps.devtools.description"),hash:"#/playground",category:$("Create",Q),accentColor:"#facc15",pinned:t,index:e,onClick:()=>{window.location.hash="#/playground"},onHoverIntent:()=>b("playground"),onTogglePin:()=>n("devtools")})};return(0,i.jsx)(i.Fragment,{children:(0,i.jsxs)(aN,{children:[(0,i.jsxs)(aP,{children:[(0,i.jsx)(aD,{children:(0,i.jsx)(p.K0,{onClick:J,title:Y?Z("sidebar.show"):Z("sidebar.hide"),"aria-label":Y?Z("sidebar.show"):Z("sidebar.hide"),"aria-pressed":Y,children:(0,i.jsx)(p.In,{name:"panel-left",size:16})})}),(0,i.jsxs)(aI,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:[(0,i.jsx)("span",{children:"Atl"}),(0,i.jsx)("span",{className:"logo-accent",children:"antis"})]}),(0,i.jsx)(aR,{children:(0,i.jsx)(p.Yw,{locale:Q,onLocaleChange:X,notifications:y,onOpenPalette:x,paletteLabel:Z("palette.search"),user:l?{name:l.name,email:l.email,avatarUrl:l.avatarUrl}:void 0,userMenuItems:l?[...u?[{label:Z("userMenu.preferences"),icon:(0,i.jsx)(p.In,{name:"user-cog",size:14}),onClick:u}]:[],{label:Z("userMenu.settings"),icon:(0,i.jsx)(p.In,{name:"settings",size:14}),onClick:()=>{window.location.hash="#/settings"}},...f?[{label:Z("userMenu.clearData"),icon:(0,i.jsx)(p.In,{name:"trash",size:14}),onClick:f,danger:!0}]:[],...d?[{label:Z("userMenu.signOut"),icon:(0,i.jsx)(p.In,{name:"log-out",size:14}),onClick:d,danger:!0}]:[]]:[],userMenuControlLabels:{language:Z("userMenu.language"),theme:Z("userMenu.theme"),themeLight:Z("userMenu.themeLight"),themeDark:Z("userMenu.themeDark"),themeSystem:Z("userMenu.themeSystem")},onSignIn:()=>{window.location.hash="#/home"}})})]}),(0,i.jsxs)(aH,{children:[(0,i.jsxs)(aE,{collapsed:Y,children:[(0,i.jsx)(aW,{active:"home"===C,onClick:O,children:(0,i.jsxs)("span",{style:{display:"flex",alignItems:"center",gap:"8px"},children:[(0,i.jsx)(p.In,{name:"home",size:14}),Z("sidebar.home")]})}),(0,i.jsx)(aW,{active:"retreat"===C,onClick:B,children:(0,i.jsxs)("span",{style:{display:"flex",alignItems:"center",gap:"8px"},children:[(0,i.jsx)(p.In,{name:"moon",size:14}),Z("sidebar.retreat")]})}),(0,i.jsx)(aV,{}),aC.length>0&&(0,i.jsxs)(i.Fragment,{children:[G?(0,i.jsx)(aG,{type:"button",onClick:U,children:Z("sidebar.showSuites")}):(0,i.jsxs)(i.Fragment,{children:[(0,i.jsxs)(aO,{onClick:U,children:[k("suites",Q),(0,i.jsx)(aB,{collapsed:G,children:(0,i.jsx)(p.In,{name:"chevron-down",size:14})})]}),(0,i.jsx)(aq,{collapsed:G,children:(0,i.jsx)(aK,{children:aC.map(e=>{let t,a=(t=eA.find(t=>t.yamlSuite===e))?{icon:t.icon,color:t.color}:void 0,o="apps"===C&&L===e;return(0,i.jsxs)(aW,{active:o,onClick:()=>q(e),children:[a&&(0,i.jsx)("span",{style:{display:"inline-flex",color:o?c.w4.colors.accent:a.color,flexShrink:0},children:(0,i.jsx)(p.In,{name:a.icon,size:16,"aria-hidden":"true"})}),(0,i.jsx)("span",{style:{flex:1,textAlign:"left"},children:w[e]?.[Q]??e}),(0,i.jsx)(aY,{active:o,children:ei[e]??0})]},e)})})})]}),(0,i.jsx)(aV,{})]})]}),(0,i.jsx)(a_,{bleed:"retreat"===C,children:"retreat"===C?(0,i.jsx)(t9,{locale:Q,greeting:aT(Q,P),userName:l?.name,pinnedApps:eo,onSelect:s,t:Z}):(0,i.jsxs)(i.Fragment,{children:[(0,i.jsxs)(aU,{children:[(0,i.jsxs)(aJ,{children:[(0,i.jsx)(aQ,{children:(v=P.toLocaleDateString("pt"===Q?"pt-PT":"en-GB",{weekday:"long"}),M=P.getDate(),j=P.toLocaleDateString("pt"===Q?"pt-PT":"en-GB",{month:"long"}),`${v} \xb7 ${M} ${j}`.toUpperCase())}),D?.current&&(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(aX,{children:"\xb7"}),(0,i.jsxs)(aZ,{children:[(0,i.jsx)("span",{className:"ico",children:(D.current.is_day?aA[D.current.weather_code??0]:aF[D.current.weather_code??0]??aA[D.current.weather_code??0])??"\xb7"}),(0,i.jsxs)("span",{className:"temp",children:[Math.round(D.current.temperature_2m??0),"\xb0"]}),(0,i.jsx)("span",{className:"lbl",children:k("home.weather.city",Q)})]})]})]}),(0,i.jsxs)(a0,{children:[aT(Q,P),l?.name?(0,i.jsxs)(i.Fragment,{children:[", ",(0,i.jsx)("span",{className:"accent",children:l.name.split(" ")[0]})]}):null,"."]})]}),"home"===C&&!R&&0===eo.length&&0===en.length&&(0,i.jsx)(a$,{t:Z,onDismiss:E,onOpenPalette:x,onOpenPreferences:u}),"home"===C&&(0,i.jsx)(t2,{locale:Q,pinnedAppIds:a,recentAppIds:t,apps:S,appMeta:ee,onSelectApp:s,onTogglePin:n}),"apps"===C&&(0,i.jsxs)(i.Fragment,{children:[0===et.length&&(null!==L||"All"!==A||(0,h.hasInterests)(z))&&(0,i.jsxs)(a5,{children:[(0,i.jsx)(a3,{children:k("home.emptyFiltered.title",Q)}),(0,i.jsx)(a6,{children:k("home.emptyFiltered.desc",Q)}),(0,i.jsxs)("div",{style:{display:"flex",gap:c.w4.spacing.sm},children:[(null!==L||"All"!==A)&&(0,i.jsx)(a8,{type:"button",onClick:()=>{N(null),F("All")},style:{background:"transparent",color:c.w4.colors.accent,border:`1px solid ${c.w4.colors.border}`},children:k("home.emptyFiltered.clear",Q)}),u&&(0,i.jsx)(a8,{type:"button",onClick:u,children:k("home.emptyFiltered.cta",Q)})]})]}),"All"===A&&!L&&eo.length>0&&(0,i.jsxs)("div",{children:[(0,i.jsx)(a1,{children:k("pinned",Q)}),(0,i.jsx)(a4,{children:eo.map((e,t)=>es(e,er++,{pinIdx:t,total:eo.length}))})]}),"All"===A&&!L&&en.length>0&&(0,i.jsxs)("div",{children:[(0,i.jsx)(a1,{children:k("recentlyUsed",Q)}),(0,i.jsx)(a4,{children:en.map(e=>es(e,er++))})]}),ea?[..."suite"===ea.type?aS:az.slice(1),"Other"].filter(e=>ea.groups[e]?.length>0).map(e=>(0,i.jsxs)("div",{children:[(0,i.jsx)(a1,{children:"suite"===ea.type?w[e]?.[Q]??e:$(e,Q)}),(0,i.jsxs)(a4,{children:[ea.groups[e].map(e=>es(e,er++)),("suite"===ea.type&&"AI Lab"===e||"category"===ea.type&&"Lab"===e)&&el(er++)]})]},e)):(0,i.jsxs)(a4,{children:[et.map(e=>es(e,er++)),"Lab"===A&&el(er++)]})]})]})})]})]})})}let a9=(0,a(82791).U)("https://eqvzakschpdemcgexjyy.supabase.co","sb_publishable_D_UOsNIA7qD3929ZzReWLw_k8d8MxWL");function ie(){return a9.auth.signInWithOAuth({provider:"google",options:{redirectTo:window.location.origin}})}function it(){return a9.auth.signOut()}let ia=(0,d.keyframes)`
...
`,ic=()=>(0,i.jsxs)("svg",{width:"18",height:"18",viewBox:"0 0 48 48",children:[(0,i.jsx)("path",{fill:"#EA4335",d:"M24 9.5c3.14 0 5.95 1.08 8.17 2.86l6.1-6.1C34.46 3.19 29.53 1 24 1 14.82 1 7.07 6.48 3.88 14.22l7.1 5.52C12.68 13.55 17.9 9.5 24 9.5z"}),(0,i.jsx)("path",{fill:"#4285F4",d:"M46.52 24.5c0-1.64-.15-3.22-.42-4.75H24v9h12.67c-.55 2.94-2.18 5.44-4.65 7.12l7.19 5.59C43.39 37.48 46.52 31.47 46.52 24.5z"}),(0,i.jsx)("path",{fill:"#FBBC05",d:"M10.98 28.26A14.57 14.57 0 0 1 9.5 24c0-1.48.25-2.91.68-4.26l-7.1-5.52A23.93 23.93 0 0 0 .5 24c0 3.87.93 7.52 2.58 10.74l7.9-6.48z"}),(0,i.jsx)("path",{fill:"#34A853",d:"M24 47c5.52 0 10.15-1.83 13.53-4.97l-7.19-5.59C28.47 37.82 26.36 38.5 24 38.5c-6.1 0-11.32-4.05-13.02-9.74l-7.9 6.48C6.07 42.54 14.45 47 24 47z"})]}),ip=l().button`
  background: none;
  border: none;
  color: ${c.w4.colors.mainTextMuted};
  font-family: ${c.w4.typography.fontFamily};
...
`,iI=l().div`
  ...
  justify-content: center;
  padding-top: 10vh;
  animation: ${iN} ${c.w4.transitions.fast};
...
`,iD=l().div`
  ...
  overflow: hidden;
  box-shadow: ${c.w4.elevation.lg};
  animation: ${iP} ${c.w4.transitions.base};
  font-family: ${c.w4.typography.fontFamily};
  color: ${c.w4.colors.mainText};
  display: flex;
  flex-direction: column;
...
`,iV=l()("div",{shouldForwardProp:e=>"tintColor"!==e&&"selected"!==e})`
  width: 36px;
  height: 36px;
  border-radius: 9px;
  display: flex;
  ...
  transition: ${c.w4.transitions.fast};
`,i_=l()("div",{shouldForwardProp:e=>"tintColor"!==e})`
  width: 36px;
  height: 36px;
  border-radius: 9px;
...
`,iU=l().div`
  ...
  background: transparent;
  flex-shrink: 0;
`,iJ=l()("div",{shouldForwardProp:e=>"tintColor"!==e})`
  width: 36px;
  height: 36px;
  border-radius: 9px;
  display: flex;
...
`,iQ=l().div`
  flex: 1;
  min-width: 0;
`,iX=l()("div",{shouldForwardProp:e=>"selected"!==e})`
  font-size: 14px;
  font-weight: 500;
...
`,os=l().span`
  ...
  font-size: 11px;
  color: ${c.w4.colors.mainTextMuted};
`;function ol(e,t){if(!t)return!0;let a=t.toLowerCase();return e.label.toLowerCase().includes(a)||(e.meta?.toLowerCase().includes(a)??!1)}async function od(){let e;try{e=await h.forma.load()}catch{return null}if(!e)return null;let t=new Date().toISOString().slice(0,10),a=(0,h.proteinByDay)(e.meals,t),i=e.meals.filter(e=>e.date===t).reduce((e,t)=>e+(t.kcal??0),0),o=e.walks.filter(e=>e.date===t).reduce((e,t)=>e+t.minutes,0),n=[];for(let e=6;e>=0;e-=1){let t=new Date;t.setDate(t.getDate()-e),n.push(t.toISOString().slice(0,10))}let r=n.map(t=>({date:t,protein:(0,h.proteinByDay)(e.meals,t),kcal:e.meals.filter(e=>e.date===t).reduce((e,t)=>e+(t.kcal??0),0),walk:e.walks.filter(e=>e.date===t).reduce((e,t)=>e+t.minutes,0)})),s=new Date;s.setDate(s.getDate()-6);let l=(0,h.weeklyAdherence)(e.sessions,s,e.goal.weeklyFasts),d=(0,h.streakDays)(e.sessions,e.goal.targetHours),c=(0,h.avgFastDuration)(e.sessions,30),p=e.meals.filter(e=>e.date>=n[0]).slice(-10).map(e=>`${e.date} ${e.slot} \xb7 ${e.proteinG??0}g protein \xb7 ${e.kcal??0}kcal`).join("\n");return["FORMA (fasting + diet tracker) snapshot for this user — use it when the question is about meals, protein, weight, fasting, walks, streak, or daily routine:",`TODAY (${t}): ${Math.round(a)}g protein \xb7 ${Math.round(i)}kcal \xb7 walk ${o}min`,"LAST 7 DAYS:",r.map(e=>`- ${e.date}: ${Math.round(e.protein)}g \xb7 ${Math.round(e.kcal)}kcal \xb7 walk ${e.walk}min`).join("\n"),`Weekly fast adherence: ${Math.round(100*l)}% (target ${e.goal.weeklyFasts}/wk) \xb7 streak ${d}d \xb7 avg fast (30d) ${c.toFixed(1)}h`,`Recent meals:
${p||"(none)"}`].join("\n")}function oc({apps:e,recentIds:t,suites:a=[],games:r=[],actions:s=[],hasAsk:l=!1,groqKey:d,locale:m,initialScope:u,onNavigate:f,onClose:x}){let b=(0,o.useMemo)(()=>(0,g.Nx)(m,to),[m]),[y,w]=(0,o.useState)(""),[v,$]=(0,o.useState)(()=>"ask"!==u||l?u??"all":"all"),[k,M]=(0,o.useState)(0),[j,z]=(0,o.useState)([]),[S,C]=(0,o.useState)(!1),T=(0,o.useRef)([]),A=(0,o.useRef)(null),F=(0,o.useRef)(null),L=(0,o.useRef)(null),N=(0,o.useRef)(null),[P,I]=(0,o.useState)([]),D=(0,o.useRef)(null);(0,o.useEffect)(()=>{if("ask"!==v)return(null!==D.current&&clearTimeout(D.current),y.trim())?(D.current=setTimeout(()=>{iF(y).then(I)},200),()=>{null!==D.current&&clearTimeout(D.current)}):void I([])},[y,v]),(0,o.useEffect)(()=>(A.current?.focus(),()=>{N.current?.abort()}),[]),(0,o.useEffect)(()=>{T.current=j},[j]),(0,o.useEffect)(()=>{L.current?.scrollIntoView({behavior:"smooth"})},[j,S]);let R=(0,o.useMemo)(()=>{let i=new Set(t),o=e.map(e=>({id:`app:${e.id}`,kind:"app",label:e.label,meta:e.description,isRecent:i.has(e.id),appIcon:{iconName:e.icon,color:e.color},onConfirm:()=>{f(e.hash),x()}}));return[...a.map(e=>({id:`suite:${e.id}`,kind:"suite",label:e.name,meta:e.sub,glyphIcon:{iconName:e.iconName,color:e.color},shortcut:e.shortcut,onConfirm:()=>{e.onConfirm(),x()}})),...o,...r.map(e=>({id:`game:${e.id}`,kind:"game",label:e.name,meta:b("palette.meta.game"),gameGlyph:{iconName:e.iconName,color:e.color},hash:e.hash,onConfirm:()=>{f(e.hash),x()}})),...s.map(e=>({id:`action:${e.id}`,kind:"action",label:e.label,meta:e.meta,glyphIcon:{iconName:e.iconName,color:e.color??c.w4.colors.accent},shortcut:e.shortcut,onConfirm:()=>{e.onClick(),x()}}))]},[e,a,r,s,t,f,x,b]),H=(0,o.useMemo)(()=>P.map(e=>({id:e.id,kind:"action",label:e.label,meta:e.subtitle,glyphIcon:e.iconName?{iconName:e.iconName,color:c.w4.colors.mainTextMuted}:void 0,hash:e.hash,onConfirm:()=>{f(e.hash),x()}})),[P,f,x]),E=(0,o.useMemo)(()=>{if("ask"===v)return[];let e=R.filter(e=>ol(e,y)),a=[],i=(e,t,i)=>{if(0!==i.length)for(let o of(a.push({kind:"header",label:b(t),key:e,count:i.length}),i))a.push({kind:"item",item:o})};return"recent"===v?i("recent","palette.recent",R.filter(e=>"app"===e.kind&&e.isRecent&&ol(e,y)).sort((e,a)=>t.indexOf(e.id.slice(4))-t.indexOf(a.id.slice(4)))):"jump"===v?(i("suites","palette.section.suites",e.filter(e=>"suite"===e.kind)),i("apps","palette.section.apps",e.filter(e=>"app"===e.kind)),i("games","palette.section.games",e.filter(e=>"game"===e.kind))):"actions"===v?(i("actions","palette.section.actions",e.filter(e=>"action"===e.kind)),i("content","palette.section.content",H)):(i("jump","palette.section.jump",e.filter(e=>"suite"===e.kind||"app"===e.kind||"game"===e.kind)),i("actions","palette.section.actions",e.filter(e=>"action"===e.kind)),i("content","palette.section.content",H),l&&d&&i("ask","palette.section.ask",iL.map((e,t)=>({id:`suggest:${t}`,kind:"suggest",label:b(e),meta:b("palette.ask.suggestMeta"),shortcut:["↵"],onConfirm:()=>{$("ask"),setTimeout(()=>{B(b(e))},0)}})))),a},[v,y,R,t,b,l,d,H]),O=(0,o.useMemo)(()=>E.filter(e=>"item"===e.kind),[E]);(0,o.useEffect)(()=>{M(0)},[v,y]),(0,o.useEffect)(()=>{let e=F.current;if(!e)return;let t=e.querySelectorAll("[data-selectable]");t[k]?.scrollIntoView({block:"nearest"})},[k]);let B=(0,o.useCallback)(async e=>{if(!d||!e.trim())return;let t=e.trim(),a=`turn-${Date.now()}`;z(e=>[...e,{id:a,question:t}]),C(!0),w("");let i=[];for(let e of T.current)e.answer&&(i.push({role:"user",content:e.question}),i.push({role:"assistant",content:e.answer}));N.current?.abort();let o=new AbortController;N.current=o;try{let e=await od(),n="pt"===m?"Portuguese":"English",r=["You are Atlantis, a personal-dashboard assistant in the command palette.",`Be concise and direct. Answer in ${n}. Markdown is rendered — use bullets, **bold**, and `,"`> [!TIP]` callouts. Skip headings unless the answer is long.",e?`
${e}`:""].join("\n"),s=await (0,h.askGroq)(t,{key:d,locale:"pt"===m?"pt":"en",signal:o.signal,history:i,system:r});o.signal.aborted||z(e=>e.map(e=>e.id===a?{...e,answer:s}:e))}catch(t){if(o.signal.aborted)return;let e=t instanceof Error?t.message:String(t);z(t=>t.map(t=>t.id===a?{...t,error:e}:t))}finally{o.signal.aborted||C(!1)}},[d,m]),q=(0,o.useCallback)(e=>{if("Escape"===e.key){if("ask"===v&&y.trim())return void w("");if("ask"===v&&j.length>0){N.current?.abort(),C(!1),z([]);return}return void x()}if("ask"===v){"Enter"===e.key&&y.trim()&&(e.preventDefault(),B(y.trim()));return}if("ArrowDown"===e.key)e.preventDefault(),M(e=>Math.min(e+1,O.length-1));else if("ArrowUp"===e.key)e.preventDefault(),M(e=>Math.max(e-1,0));else if("Enter"===e.key){let e=O[k];e&&e.item.onConfirm()}},[v,y,j.length,O,k,x,B]),K=(0,o.useCallback)(e=>{e.target===e.currentTarget&&x()},[x]),G="ask"===v?j.length>0?b("palette.ask.followUp"):b("palette.ask.placeholder"):b("palette.placeholder"),W=(0,o.useMemo)(()=>{let e=[{value:"all",label:b("palette.scope.all")},{value:"jump",label:b("palette.scope.jump")},{value:"actions",label:b("palette.scope.actions")}];return l&&d&&e.push({value:"ask",label:b("palette.scope.ask"),highlight:!0}),e.push({value:"recent",label:b("palette.scope.recent")}),e},[b,l,d]),Y=-1;return tr().createPortal((0,i.jsx)(iI,{onClick:K,children:(0,i.jsxs)(iD,{onClick:e=>e.stopPropagation(),children:[(0,i.jsxs)(iR,{children:[(0,i.jsx)(iH,{active:"ask"===v,children:(0,i.jsx)(p.In,{name:"ask"===v?"sparkle":"search",size:20,"aria-hidden":"true"})}),(0,i.jsx)(iE,{ref:A,placeholder:G,value:y,onChange:e=>w(e.target.value),onKeyDown:q,"aria-label":b("palette.search")}),(0,i.jsx)(iO,{children:"esc"})]}),(0,i.jsx)(iB,{children:(0,i.jsx)(p.tU,{tabs:W,value:v,onChange:$,"aria-label":b("palette.scope.ariaLabel")})}),"ask"===v?(0,i.jsx)(i2,{children:0!==j.length||S?(0,i.jsxs)(i7,{children:[j.map(e=>(0,i.jsxs)(n().Fragment,{children:[(0,i.jsxs)(i9,{children:[(0,i.jsx)(oe,{children:b("palette.ask.you")}),(0,i.jsx)(ot,{children:e.question})]}),(0,i.jsxs)(i9,{children:[(0,i.jsx)(oe,{children:b("palette.ask.atlantis")}),void 0!==e.answer?(0,i.jsx)(p.mQ,{children:e.answer}):void 0!==e.error?(0,i.jsx)(oo,{children:e.error}):(0,i.jsxs)(oi,{"aria-label":b("palette.ask.thinking"),children:[(0,i.jsx)("span",{}),(0,i.jsx)("span",{}),(0,i.jsx)("span",{})]})]})]},e.id)),(0,i.jsx)("div",{ref:L})]}):(0,i.jsxs)(i5,{children:[(0,i.jsx)(i3,{children:b("palette.ask.suggestionsTitle")}),(0,i.jsx)(i6,{children:iL.map(e=>(0,i.jsx)(i8,{onClick:()=>{B(b(e))},type:"button",children:b(e)},e))}),(0,i.jsx)(i3,{style:{marginTop:4},children:b("palette.ask.hint")})]})}):(0,i.jsx)(iq,{ref:F,children:0===O.length?(0,i.jsxs)(on,{children:[(0,i.jsx)("div",{className:"icon",children:(0,i.jsx)(p.In,{name:"search",size:16,"aria-hidden":"true"})}),(0,i.jsxs)("div",{className:"title",children:[b("palette.noMatch")," ",y&&(0,i.jsxs)("span",{className:"query",children:["“",y,"”"]})]}),(0,i.jsx)("div",{className:"hint",children:b("palette.emptyHint")})]}):E.map((e,t)=>{if("header"===e.kind)return(0,i.jsxs)(iK,{children:[(0,i.jsx)(iG,{children:e.label}),(0,i.jsx)(iW,{children:e.count})]},`h-${e.key}`);let a=Y+=1,o=a===k,n=e.item;return(0,i.jsxs)(iY,{selected:o,"data-selectable":!0,onMouseEnter:()=>M(a),onClick:()=>n.onConfirm(),children:[n.appIcon&&(0,i.jsx)(iV,{tintColor:n.appIcon.color,selected:o,children:(0,i.jsx)(p.In,{name:n.appIcon.iconName,size:18,"aria-hidden":"true",color:n.appIcon.color})}),n.glyphIcon&&(0,i.jsx)(i_,{tintColor:n.glyphIcon.color,children:(0,i.jsx)(p.In,{name:n.glyphIcon.iconName,size:18,"aria-hidden":"true"})}),n.gameGlyph&&(0,i.jsx)(iJ,{tintColor:n.gameGlyph.color,children:(0,i.jsx)(p.In,{name:n.gameGlyph.iconName,size:18,"aria-hidden":"true",color:n.gameGlyph.color})}),"suggest"===n.kind&&(0,i.jsx)(iU,{children:(0,i.jsx)(p.In,{name:"sparkle",size:18,"aria-hidden":"true"})}),(0,i.jsxs)(iQ,{children:[(0,i.jsx)(iX,{selected:o,children:n.label}),n.meta&&(0,i.jsx)(iZ,{children:n.meta})]}),n.hash&&(0,i.jsx)(i0,{children:n.hash}),n.shortcut&&n.shortcut.length>0&&(0,i.jsx)(i1,{children:n.shortcut.map((e,t)=>(0,i.jsx)(i4,{children:e},t))})]},n.id+"-"+t)})}),(0,i.jsx)(or,{children:"ask"===v?(0,i.jsxs)(i.Fragment,{children:[(0,i.jsxs)(os,{children:[(0,i.jsx)(i4,{children:"↵"}),b("palette.hint.ask")]}),(0,i.jsxs)(os,{children:[(0,i.jsx)(i4,{children:"esc"}),b("palette.hint.close")]})]}):(0,i.jsxs)(i.Fragment,{children:[(0,i.jsxs)(os,{children:[(0,i.jsx)(i4,{children:"↑"}),(0,i.jsx)(i4,{children:"↓"}),b("palette.hint.navigate")]}),(0,i.jsxs)(os,{children:[(0,i.jsx)(i4,{children:"↵"}),b("palette.hint.open")]}),(0,i.jsxs)(os,{children:[(0,i.jsx)(i4,{children:"esc"}),b("palette.hint.close")]})]})})]})}),document.body)}let op="shell:cmdk-hint-dismissed",oh=(0,d.keyframes)`
  from { opacity: 0; transform: translateY(6px); }
  to   { opacity: 1; transform: translateY(0); }
`,og=l().div`
  position: fixed;
  ...
  overflow: hidden;
  animation: ${oh} 0.25s ${c.w4.transitions.easing} both;
  animation-delay: 1s;
  transition:
    border-color ${c.w4.transitions.fast},
    transform ${c.w4.transitions.fast};
...
`,ou=l().button`
  ...
  &:hover { color: ${c.w4.colors.mainText}; }
  &:focus-visible { ${c.w4.focusRing} }
`;function of({onOpenPalette:e,t}){let[a,n]=(0,o.useState)(()=>{try{return"1"===localStorage.getItem(op)}catch{return!1}});return((0,o.useEffect)(()=>{let e=e=>{e.key===op&&n("1"===e.newValue)};return window.addEventListener("storage",e),()=>window.removeEventListener("storage",e)},[]),a)?null:tr().createPortal((0,i.jsxs)(og,{children:[(0,i.jsxs)(om,{type:"button","aria-label":t("cmdk.hint.aria"),onClick:e,children:[(0,i.jsx)(p.ue,{children:"⌘K"}),(0,i.jsx)("span",{className:"hint-label",children:t("cmdk.hint.label")})]}),(0,i.jsx)(ou,{type:"button",className:"dismiss","aria-label":t("cmdk.hint.dismiss"),title:t("cmdk.hint.dismiss"),onClick:e=>{e.stopPropagation();try{localStorage.setItem(op,"1")}catch{}n(!0)},children:"\xd7"})]}),document.body)}var ox=a(54989);let ob=(0,d.keyframes)`
...
`,o7=[{id:"groq",label:"Groq",placeholder:"gsk_...",help:"Used by Prompt Lab and Image Gen (enhance)",linkUrl:"https://console.groq.com/keys",linkLabel:"Get key"},{id:"gemini",label:"Google Gemini",placeholder:"AIza...",help:"Used by Prompt Lab",linkUrl:"https://aistudio.google.com/apikey",linkLabel:"Get key"},{id:"finnhub",label:"Finnhub",placeholder:"pk_...",help:"Stock quotes for the Markets widget",linkUrl:"https://finnhub.io/dashboard",linkLabel:"Get key"},{id:"tmdb",label:"TMDB (The Movie Database)",placeholder:"eyJhbGci...",help:"Movies & Series app — Read Access Token (v4 auth)",linkUrl:"https://www.themoviedb.org/settings/api",linkLabel:"Get key"},{id:"youtube",label:"YouTube Data API v3",placeholder:"AIza...",help:"YouTube Safe Feed app — free quota, no billing required",linkUrl:"https://console.cloud.google.com/apis/credentials",linkLabel:"Get key"}],o9="atlantis:api-keys",ne="atlantis:promptlab:keys",nt=[{widgetId:"shell",ruleId:"sync.error",labelKey:"notifications.source.syncError",defaultEnabled:!0},{widgetId:"shell",ruleId:"daily.achievement",labelKey:"notifications.source.dailyAchievement",defaultEnabled:!0},{widgetId:"shell",ruleId:"finance.budget",labelKey:"notifications.source.financeBudget",defaultEnabled:!0}],na={groq:"",gemini:"",finnhub:"",tmdb:"",youtube:""};function ni(e,t){return`notifications:${e}:${t}:enabled`}function no({lang:e}){let[t,a]=(0,o.useState)(na),[n,r]=(0,o.useState)({}),[s,l]=(0,o.useState)(!1),[d,m]=(0,o.useState)(!1),[u,f]=(0,o.useState)({}),[x,b]=(0,o.useState)([]),[y,w]=(0,o.useState)({muteAll:!1,windows:[]}),[v,$]=(0,o.useState)([]),k=(0,o.useMemo)(()=>(0,g.Nx)(e,to),[e]),M="pt"===e;(0,o.useEffect)(()=>{let e=function(){try{let e=localStorage.getItem(o9);if(e)return{...na,...JSON.parse(e)};let t=localStorage.getItem(ne);if(t)return{...na,...JSON.parse(t)}}catch{}return{...na}}();a(e),(0,c.PL)(o9).then(t=>{if(t)try{let i={...na,...JSON.parse(t)},o={groq:e.groq||i.groq,gemini:e.gemini||i.gemini,finnhub:e.finnhub||i.finnhub,tmdb:e.tmdb||i.tmdb,youtube:e.youtube||i.youtube};a(o)}catch{}}),(0,h.loadSchedule)().then(e=>w(e)),(0,c.PL)("shell:dashboard-widgets").then(async e=>{let t=[];try{e&&(t=JSON.parse(e))}catch{}let a=new Set(t.map(e=>e.widgetId)),i=te.filter(e=>a.has(e.id)&&e.notifications&&e.notifications.length>0);b(i);let o=i.flatMap(e=>(e.notifications??[]).map(e=>e.category)),n=nt.map(e=>e.ruleId),r=new Set,s=[];for(let e of[...o,...n])r.has(e)||(r.add(e),s.push(e));$(s);let l={};await Promise.all(i.flatMap(e=>(e.notifications??[]).map(async t=>{let a=ni(e.id,t.id),i=await (0,c.PL)(a),o=!1!==t.defaultEnabled;l[`${e.id}:${t.id}`]=null===i?o:"false"!==i}))),await Promise.all(nt.map(async e=>{let t=ni(e.widgetId,e.ruleId),a=await (0,c.PL)(t);l[`${e.widgetId}:${e.ruleId}`]=null===a?e.defaultEnabled:"false"!==a})),f(l)})},[]);let j=(0,o.useCallback)((e,t)=>{a(a=>({...a,[e]:t})),m(!0),l(!1)},[]),z=(0,o.useCallback)(e=>{a(t=>({...t,[e]:""})),m(!0),l(!1)},[]),S=(0,o.useCallback)(()=>{let e;e=JSON.stringify(t),localStorage.setItem(o9,e),localStorage.setItem(ne,e),(0,c.Is)(o9,e),window.dispatchEvent(new CustomEvent("atlantis:api-keys-changed")),m(!1),l(!0),setTimeout(()=>l(!1),2500)},[t]),C=(0,o.useCallback)((e,t,a)=>{let i=`${e}:${t}`;f(e=>({...e,[i]:a})),(0,c.Is)(ni(e,t),a?"true":"false")},[]),T=(0,o.useCallback)(e=>{let t={...y,muteAll:e};w(t),(0,h.saveSchedule)(t)},[y]),A=(0,o.useCallback)(()=>{let e={...y,windows:[...y.windows,{categoryId:"*",start:"22:00",end:"08:00"}]};w(e),(0,h.saveSchedule)(e)},[y]),F=(0,o.useCallback)(e=>{let t={...y,windows:y.windows.filter((t,a)=>a!==e)};w(t),(0,h.saveSchedule)(t)},[y]),L=(0,o.useCallback)((e,t)=>{let a={...y,windows:y.windows.map((a,i)=>i===e?{...a,...t}:a)};w(a),(0,h.saveSchedule)(a)},[y]),N=(0,o.useCallback)(e=>{if("*"===e)return k("notifications.settings.quietHours.global");for(let t of x)for(let a of t.notifications??[])if(a.category===e&&a.labelKey)return k(a.labelKey);for(let t of nt)if(t.ruleId===e)return k(t.labelKey);return e},[k,x]);return(0,i.jsx)(oy,{children:(0,i.jsxs)(ow,{children:[(0,i.jsxs)(ov,{children:[(0,i.jsx)(o$,{children:M?"Defini\xe7\xf5es":"Settings"}),(0,i.jsx)(ok,{children:M?"Gere as tuas chaves de API para os servi\xe7os de IA. As chaves s\xe3o guardadas no teu browser e sincronizadas com a tua conta.":"Manage your API keys for AI services. Keys are stored in your browser and synced with your account."})]}),(0,i.jsxs)(oM,{children:[(0,i.jsxs)(oj,{children:[(0,i.jsx)(p.In,{name:"key",size:16}),M?"Chaves de API":"API Keys"]}),(0,i.jsx)(oz,{children:M?"Estas chaves s\xe3o usadas pelo Prompt Lab e Image Gen. Cada servi\xe7o tem um plano gratuito.":"These keys are used by Prompt Lab and Image Gen. Each service has a free tier."}),o7.map(e=>{let a=t[e.id],o=n[e.id]??!1;return(0,i.jsxs)(oS,{children:[(0,i.jsxs)(oC,{children:[e.label,(0,i.jsx)(oT,{active:!!a,children:a?M?"ativa":"active":M?"vazia":"empty"}),(0,i.jsxs)(oA,{children:["— ",e.help]})]}),(0,i.jsxs)(oF,{children:[(0,i.jsxs)(oL,{children:[(0,i.jsx)(oN,{type:o?"text":"password",value:a,onChange:t=>j(e.id,t.target.value),placeholder:e.placeholder,spellCheck:!1,autoComplete:"off"}),(0,i.jsx)(oP,{onClick:()=>r(t=>({...t,[e.id]:!o})),title:o?"Hide":"Show",children:o?(0,i.jsx)(p.In,{name:"eye-off",size:13}):(0,i.jsx)(p.In,{name:"eye",size:13})})]}),(0,i.jsx)(oI,{danger:!0,onClick:()=>z(e.id),title:M?"Limpar":"Clear",children:(0,i.jsx)(p.In,{name:"trash",size:13})}),(0,i.jsx)("a",{href:e.linkUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:(0,i.jsx)(oI,{title:e.linkLabel,children:(0,i.jsx)(p.In,{name:"external-link",size:13})})})]})]},e.id)}),(0,i.jsxs)(oD,{children:[s?(0,i.jsx)(oH,{children:M?"✓ Guardado":"✓ Saved"}):(0,i.jsx)("span",{}),(0,i.jsxs)(oR,{onClick:S,disabled:!d,children:[(0,i.jsx)(p.In,{name:"save",size:13}),M?"Guardar":"Save"]})]})]}),(0,i.jsxs)(oM,{children:[(0,i.jsxs)(oj,{children:[(0,i.jsx)(p.In,{name:"bell",size:16}),k("notifications.settings.title")]}),(0,i.jsx)(oz,{children:k("notifications.settings.desc")}),(0,i.jsxs)(o_,{children:[(0,i.jsxs)(oU,{children:[(0,i.jsx)(oJ,{children:k("notifications.settings.muteAll")}),(0,i.jsx)(oQ,{children:k("notifications.settings.muteAll.desc")})]}),(0,i.jsxs)(oY,{checked:y.muteAll,onClick:()=>T(!y.muteAll),title:k("notifications.settings.muteAll"),children:[(0,i.jsx)("input",{type:"checkbox",checked:y.muteAll,onChange:()=>{},"aria-label":k("notifications.settings.muteAll")}),(0,i.jsx)("span",{className:"track"}),(0,i.jsx)("span",{className:"thumb"})]})]}),0===x.length?(0,i.jsx)(oV,{style:{marginTop:"16px"},children:k("notifications.settings.noWidgets")}):x.map(t=>(0,i.jsxs)(oO,{children:[(0,i.jsxs)(oB,{children:[(0,i.jsx)(oq,{children:t.icon}),(0,i.jsx)(oK,{children:"pt"===e?t.labels.pt:t.labels.en})]}),(t.notifications??[]).map(e=>{let a=`${t.id}:${e.id}`,o=!1!==e.defaultEnabled,n=u[a]??o,r=e.labelKey?k(e.labelKey):e.category;return(0,i.jsxs)(oG,{children:[(0,i.jsx)(oW,{className:"rule-label",children:r}),(0,i.jsxs)(oY,{checked:n,onClick:()=>C(t.id,e.id,!n),title:k("notifications.settings.enable"),children:[(0,i.jsx)("input",{type:"checkbox",checked:n,onChange:()=>{},"aria-label":r}),(0,i.jsx)("span",{className:"track"}),(0,i.jsx)("span",{className:"thumb"})]})]},e.id)})]},t.id)),(0,i.jsxs)(oO,{style:{marginTop:"12px"},children:[(0,i.jsxs)(oB,{children:[(0,i.jsx)(oq,{children:"\uD83D\uDD14"}),(0,i.jsx)(oK,{children:k("notifications.settings.shell.title")})]}),(0,i.jsx)("div",{style:{fontSize:"11px",fontFamily:c.w4.typography.fontFamilyMono,color:c.w4.colors.mainTextMuted,marginBottom:"4px"},children:k("notifications.settings.shell.desc")}),nt.map(e=>{let t=u[`${e.widgetId}:${e.ruleId}`]??e.defaultEnabled,a=k(e.labelKey);return(0,i.jsxs)(oG,{children:[(0,i.jsx)(oW,{className:"rule-label",children:a}),(0,i.jsxs)(oY,{checked:t,onClick:()=>C(e.widgetId,e.ruleId,!t),title:k("notifications.settings.enable"),children:[(0,i.jsx)("input",{type:"checkbox",checked:t,onChange:()=>{},"aria-label":a}),(0,i.jsx)("span",{className:"track"}),(0,i.jsx)("span",{className:"thumb"})]})]},e.ruleId)})]}),(0,i.jsxs)(oX,{children:[(0,i.jsx)(oZ,{children:k("notifications.settings.quietHours")}),(0,i.jsx)(o0,{children:k("notifications.settings.quietHours.desc")}),y.windows.map((e,t)=>(0,i.jsxs)(o1,{children:[(0,i.jsxs)(o5,{value:e.categoryId,onChange:e=>L(t,{categoryId:e.target.value}),"aria-label":k("notifications.settings.quietHours.category"),children:[(0,i.jsx)("option",{value:"*",children:k("notifications.settings.quietHours.global")}),v.map(e=>(0,i.jsx)("option",{value:e,children:N(e)},e))]}),(0,i.jsxs)(o3,{children:[(0,i.jsx)("input",{type:"checkbox",checked:e.allDay??!1,onChange:e=>L(t,{allDay:e.target.checked})}),k("notifications.settings.quietHours.allDay")]}),!e.allDay&&(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(o4,{children:k("notifications.settings.quietHours.from")}),(0,i.jsx)(o2,{type:"time",value:e.start,onChange:e=>L(t,{start:e.target.value})}),(0,i.jsx)(o4,{children:k("notifications.settings.quietHours.to")}),(0,i.jsx)(o2,{type:"time",value:e.end,onChange:e=>L(t,{end:e.target.value})})]}),(0,i.jsx)(o8,{type:"button",title:k("notifications.settings.quietHours.remove"),onClick:()=>F(t),children:(0,i.jsx)(p.In,{name:"close",size:13})})]},t)),(0,i.jsxs)(o6,{type:"button",onClick:A,children:[(0,i.jsx)(p.In,{name:"plus",size:13}),k("notifications.settings.quietHours.add")]})]})]}),(0,i.jsxs)(oE,{children:[(0,i.jsx)(p.In,{name:"shield",size:14,style:{flexShrink:0,marginTop:2}}),(0,i.jsx)("span",{children:M?"As chaves s\xe3o enviadas diretamente do teu browser para o servi\xe7o de IA — nunca passam pelos nossos servidores. Podes remov\xea-las a qualquer momento.":"Keys are sent directly from your browser to the AI provider — they never pass through our servers. You can remove them at any time."})]})]})})}let nn=(0,d.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,nr=(0,d.keyframes)`
...
`;function nv({open:e,onClose:t,locale:a}){let[n,r]=(0,h.useProfile)(),[s,l]=(0,o.useState)(n),d=(0,o.useMemo)(()=>(0,g.Nx)("pt"===a?"pt":"en",to),[a]);if((0,o.useEffect)(()=>{e&&l(n)},[e,n]),(0,o.useEffect)(()=>{if(!e)return;let a=e=>{"Escape"===e.key&&t()};return window.addEventListener("keydown",a),()=>window.removeEventListener("keydown",a)},[e,t]),!e)return null;let m=async()=>{let e=s.ageMode!==n.ageMode||s.interests.length!==n.interests.length||s.interests.some(e=>!n.interests.includes(e));await r(s),t(),e&&(await (0,c.sW)("widget-cache:"),window.location.reload())},u="pt"===a?h.INTEREST_LABELS_PT:h.INTEREST_LABELS_EN,f="pt"===a?h.AGE_MODE_LABELS_PT:h.AGE_MODE_LABELS_EN;return tr().createPortal((0,i.jsx)(ns,{onClick:e=>{e.target===e.currentTarget&&t()},children:(0,i.jsxs)(nl,{role:"dialog","aria-modal":"true","aria-labelledby":"profile-title",children:[(0,i.jsxs)(nd,{children:[(0,i.jsx)(nc,{id:"profile-title",children:d("profile.title")}),(0,i.jsx)(np,{onClick:t,"aria-label":d("profile.close"),children:(0,i.jsx)(p.In,{name:"close",size:16})})]}),(0,i.jsxs)(nh,{children:[(0,i.jsxs)(ng,{children:[(0,i.jsx)(nm,{children:d("profile.interests")}),(0,i.jsx)(nu,{children:d("profile.interestsHint")}),(0,i.jsx)(nf,{children:h.ALL_INTERESTS.map(e=>(0,i.jsx)(nx,{active:s.interests.includes(e),onClick:()=>{l(t=>({...t,interests:t.interests.includes(e)?t.interests.filter(t=>t!==e):[...t.interests,e]}))},"aria-pressed":s.interests.includes(e),children:u[e]},e))})]}),(0,i.jsxs)(ng,{children:[(0,i.jsx)(nm,{children:d("profile.ageMode")}),(0,i.jsx)(nu,{children:d("profile.ageModeHint")}),(0,i.jsx)(nf,{children:["kid","teen","adult"].map(e=>(0,i.jsx)(nx,{active:s.ageMode===e,onClick:()=>{l(t=>({...t,ageMode:e}))},"aria-pressed":s.ageMode===e,children:f[e]},e))})]})]}),(0,i.jsxs)(nb,{children:[(0,i.jsx)(ny,{onClick:t,children:d("profile.cancel")}),(0,i.jsx)(nw,{onClick:m,children:d("profile.save")})]})]})}),document.body)}var n$=a(68360);let nk=(0,d.keyframes)`
  from { opacity: 0; transform: translateY(-6px); }
  to   { opacity: 1; transform: translateY(0); }
`,nM=l().div`
  position: fixed;
...
`,nO=l().span`
  ...
  text-align: right;
  white-space: nowrap;
`;function nB({locale:e,state:t,anchor:a}){let n=(0,o.useMemo)(()=>(0,g.Nx)(e,to),[e]),{open:r,close:s,items:l,markAllRead:d,dismiss:m}=t;if(!r||!a)return null;let u=Math.round(a.bottom+8),f=Math.max(12,Math.round(window.innerWidth-a.right)),x=()=>{s(),window.location.hash="#/daily"};return tr().createPortal((0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(nM,{onClick:s}),(0,i.jsxs)(nj,{style:{top:u,right:f},role:"dialog","aria-label":n("notifications.title"),children:[(0,i.jsxs)(nz,{children:[(0,i.jsx)(nS,{children:n("notifications.title")}),(0,i.jsx)(nC,{onClick:d,disabled:0===l.length,children:n("notifications.markAllRead")})]}),(0,i.jsx)(nT,{children:0===l.length?(0,i.jsx)(nR,{children:n("notifications.empty")}):l.slice(0,5).map(e=>{let t=h.defaultStore.getCategory(e.category)?.badgeColor??c.w4.colors.mainTextMuted,a=h.defaultStore.getCategory(e.category)?.labelKey,o=a?n(a):e.category;if("daily.overdue"===e.category){let a=e.meta,r=a?.count??0,s=(a?.missions??[]).slice(0,4),l=1===r?n("notifications.daily.group.one"):n("notifications.daily.group.many",{count:r});return(0,i.jsxs)(nF,{children:[(0,i.jsxs)(nL,{as:"button",type:"button",onClick:x,children:[(0,i.jsxs)(nP,{color:t,children:[(0,i.jsx)("span",{className:"dot"}),o,(0,i.jsx)("span",{className:"time",children:(0,n$.e)(e.ts)})]}),(0,i.jsxs)(nI,{children:[(0,i.jsx)(nD,{children:s.map(e=>(0,p.n6)(e.emoji)?(0,i.jsx)(p.In,{name:e.emoji,size:14,style:{color:e.color??t}},e.id):(0,i.jsx)("span",{children:e.emoji},e.id))}),l]})]}),(0,i.jsx)(nN,{type:"button",className:"dismiss","aria-label":n("notifications.dismiss"),title:n("notifications.dismiss"),onClick:t=>{t.stopPropagation(),m(e.id)},children:"\xd7"})]},e.id)}if("finance.digest.weekly"===e.category){let a=e.meta,r=a?.spend??0,l=a?.budget??0,d=a?.topCategories??[],c=a?.members??[],p=a?.pendingReimbursables??0,h=a?.weekKey??"";return(0,i.jsxs)(nF,{children:[(0,i.jsxs)(nL,{href:"#/finance",onClick:()=>{s(),m(e.id)},children:[(0,i.jsxs)(nP,{color:t,children:[(0,i.jsx)("span",{className:"dot"}),o,(0,i.jsx)("span",{className:"time",children:h})]}),(0,i.jsx)(nI,{children:n("notifications.finance.digest.title")}),(0,i.jsxs)(nH,{children:[(0,i.jsx)(nE,{children:n("notifications.finance.digest.spend")}),(0,i.jsxs)(nO,{children:["€",r.toFixed(2)]}),(0,i.jsx)(nE,{children:n("notifications.finance.digest.budget")}),(0,i.jsxs)(nO,{children:["€",l.toFixed(2)]}),d.length>0&&(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(nE,{children:n("notifications.finance.digest.topCategories")}),(0,i.jsx)(nO,{children:d.map(e=>`€${e.total.toFixed(0)}`).join(" \xb7 ")})]}),c.length>0&&(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(nE,{children:n("notifications.finance.digest.members")}),(0,i.jsx)(nO,{children:c.map(e=>`€${e.total.toFixed(0)}`).join(" \xb7 ")})]}),p>0&&(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(nE,{children:n("notifications.finance.digest.pending")}),(0,i.jsx)(nO,{children:p})]})]})]}),(0,i.jsx)(nN,{type:"button",className:"dismiss","aria-label":n("notifications.dismiss"),title:n("notifications.dismiss"),onClick:t=>{t.stopPropagation(),m(e.id)},children:"\xd7"})]},e.id)}let r=e.link?{href:e.link,target:"_blank",rel:"noopener noreferrer",onClick:()=>{m(e.id)}}:{as:"button",type:"button",onClick:()=>{m(e.id)}};return(0,i.jsxs)(nF,{children:[(0,i.jsxs)(nL,{...r,children:[(0,i.jsxs)(nP,{color:t,children:[(0,i.jsx)("span",{className:"dot"}),o,(0,i.jsx)("span",{className:"time",children:(0,g.aw)(new Date(e.ts).toISOString(),n)})]}),(0,i.jsx)(nI,{children:e.title})]}),(0,i.jsx)(nN,{type:"button",className:"dismiss","aria-label":n("notifications.dismiss"),title:n("notifications.dismiss"),onClick:t=>{t.stopPropagation(),m(e.id)},children:"\xd7"})]},e.id)})}),l.length>0&&(0,i.jsxs)(nA,{type:"button",onClick:()=>{s(),window.location.hash="#/notifications"},children:[(0,i.jsx)("span",{children:n("notifications.seeAll")}),(0,i.jsx)("span",{className:"count",children:l.length>5?`+${l.length-5}`:l.length})]})]})]}),document.body)}let nq=(0,d.keyframes)`
...
`;function n4({locale:e}){let t=(0,o.useMemo)(()=>(0,g.Nx)(e,to),[e]),a=(0,h.useRegisteredCategories)(),{items:n,byCategory:r}=(0,h.useEvents)({channels:a}),s=(0,o.useMemo)(()=>{let e=new Map;for(let t of a){let a=r[t];a&&a.length>0&&e.set(t,a)}return e},[r,a]),l=(0,o.useCallback)(()=>{h.defaultStore.markAllRead()},[]),d=(0,o.useCallback)(e=>{h.defaultStore.dismiss(e)},[]),p=(0,o.useCallback)(()=>{window.location.hash="#/home"},[]);return(0,i.jsxs)(nK,{children:[(0,i.jsxs)(nG,{children:[(0,i.jsx)(nW,{children:t("notifications.page.title")}),(0,i.jsx)(nY,{children:t("notifications.page.subtitle")}),(0,i.jsxs)(nV,{children:[(0,i.jsxs)(n_,{onClick:p,children:["← ",t("error.remote.goHome")]}),(0,i.jsx)(n_,{onClick:l,disabled:0===n.length,children:t("notifications.markAllRead")})]})]}),0===n.length?(0,i.jsx)(nU,{children:t("notifications.empty")}):Array.from(s.entries()).map(([e,a])=>{let o;return(0,i.jsxs)("section",{children:[(0,i.jsx)(nJ,{children:(o=h.defaultStore.getCategory(e),o?.labelKey?t(o.labelKey):e)}),a.map(a=>{let o=h.defaultStore.getCategory(e)?.badgeColor??c.w4.colors.mainTextMuted;return(0,i.jsxs)(nQ,{color:o,children:[(0,i.jsxs)(nX,{href:a.link,target:a.link?"_blank":void 0,rel:a.link?"noopener noreferrer":void 0,children:[(0,i.jsx)(nZ,{children:a.title}),(0,i.jsx)(n0,{children:(0,g.aw)(new Date(a.ts).toISOString(),t)})]}),(0,i.jsx)(n1,{type:"button","aria-label":t("notifications.dismiss"),title:t("notifications.dismiss"),onClick:()=>d(a.id),children:"\xd7"})]},a.id)})]},e)})]})}h.events.registerCategory({id:"sync.error",labelKey:"notifications.source.syncError",badgeColor:c.w4.colors.danger}),h.events.registerCategory({id:"daily.achievement",labelKey:"notifications.source.dailyAchievement",badgeColor:"#fb923c"}),h.events.registerCategory({id:"finance.budget",labelKey:"notifications.source.financeBudget",badgeColor:c.w4.colors.warning}),h.events.registerCategory({id:"finance.bills",labelKey:"notifications.source.financeBills",badgeColor:"#fb923c"}),h.events.registerRules([h.billsRule]),h.events.registerCategory({id:"weather.pt.forecast",labelKey:"notifications.source.weatherForecast",badgeColor:"#3b82f6"}),h.events.registerRules([h.ipmaForecastDetailRule]),(0,h.loadSchedule)();{let e=new Map;(0,ox.subscribeRequests)(t=>{if(!t.host)return;if(t.ok)return void e.delete(t.host);let a=(e.get(t.host)??0)+1;if(e.set(t.host,a),3===a){let e=new Date().toISOString().slice(0,10);h.events.push({id:`sync.error:${t.host}:${e}`,category:"sync.error",ts:t.ts,title:`${t.host} — ${t.error??"failed"}`,meta:{host:t.host,status:t.status}})}})}let n2={movies:e=>({apiKey:e.tmdbKey}),youtube:e=>({apiKey:e.youtubeKey}),games:e=>({isAuthenticated:!!e.user})},n5=l().div`
...
`,n8=l().span`
  ...
  flex-shrink: 0;
  animation: ${n3} 2s ease-in-out infinite;
`,n7={techscope:9,weather:1,citypulse:1};function n9({count:e}){return(0,i.jsxs)(n6,{title:`${e} live ${1===e?"feed":"feeds"}`,children:[(0,i.jsx)(n8,{}),e,(0,i.jsx)("span",{style:{opacity:.65,fontSize:10},children:"LIVE"})]})}let re=l().div`
  flex: 1;
  display: flex;
  flex-direction: column;
  align-items: center;
...
`;function rn({name:e,error:t,topBarRight:a,onRetry:n}){let[r]=(0,g.Ym)(),s=(0,o.useMemo)(()=>(0,g.Nx)(r,to),[r]),l=t.message??"",d=l.startsWith("REMOTE_LOAD_FAILED:"),h=d?l.slice(19):e,m=`apps.${h}.label`,u=s(m),f=u&&u!==m?u:h;return(0,i.jsx)(p.PE,{title:f,sidebar:null,topBarRight:a,children:(0,i.jsxs)(re,{children:[(0,i.jsx)(rt,{children:"⚠"}),(0,i.jsx)(ra,{children:s("error.remote.title",{name:f})}),(0,i.jsx)(ri,{children:s(d?"error.remote.prodHint":"error.remote.generic")}),d&&!1,(0,i.jsxs)("div",{style:{display:"flex",gap:c.w4.spacing.sm},children:[(0,i.jsx)(ro,{onClick:n,children:s("error.remote.retry")}),(0,i.jsx)(ro,{onClick:()=>{window.location.hash="#/home"},children:s("error.remote.goHome")})]})]})})}class rr extends n().Component{static getDerivedStateFromError(e){return{error:e}}componentDidCatch(e){console.error(`[RemoteErrorBoundary] "${this.props.name}" threw:`,e)}componentDidUpdate(e){e.name!==this.props.name&&this.state.error&&this.setState({error:null})}render(){return this.state.error?(0,i.jsx)(rn,{name:this.props.name,error:this.state.error,topBarRight:this.props.topBarRight,onRetry:()=>this.setState({error:null})}):this.props.children}constructor(...e){super(...e),function(e,t,a){t in e?Object.defineProperty(e,t,{value:a,enumerable:!0,configurable:!0,writable:!0}):e[t]=a}(this,"state",{error:null})}}let rs=(()=>{let e={settings:"settings"};for(let t of eT)for(let a of(e[t.hash.replace(/^#\//,"")]=t.id,t.hashAliases??[]))e[a]=t.id;return e})();function rl(e){let t=e.replace(/^#\/?/,"");if(!t||"home"===t)return"home";let a=t.split("/")[0].split("?")[0];return"notifications"===a?"notifications":rs[a]??"home"}let rd="shell:recent",rc="shell:pinned",rp="shell:last-app";function rh(){let e=window.location.hash;if(!e||"#"===e||"#/"===e)try{let e=localStorage.getItem(rp);if(e&&"home"!==e&&f[e]){let t=eT.find(t=>t.id===e);if(t)return history.replaceState(null,"",t.hash),e}}catch{}return rl(e)}function rg(e){try{return JSON.parse(e??"[]")}catch{return[]}}let rm=new Set(eT.filter(e=>e.needsAuth).map(e=>e.id)),ru="true"===process.env.MOCK_USER?{id:"mock-user",email:"dev@atlantis.local",user_metadata:{full_name:"Dev User",avatar_url:""}}:null,rf=process.env.YOUTUBE_API_KEY||"",rx=document.getElementById("root");if(!rx)throw Error("Root element #root not found");(0,r.createRoot)(rx).render((0,i.jsx)(function(){let e,[t,a]=(0,o.useState)(rh),[n,r]=(0,o.useState)([]),[s,l]=(0,o.useState)([]),[d,m]=(0,o.useState)(ru),[u,x]=(0,o.useState)(!!ru),[b,y]=(0,o.useState)(!1),[w,v]=(0,o.useState)(void 0),[$,k]=(0,o.useState)(!1),[M,j]=(0,o.useState)(!1),[z,S]=(0,g.Ym)(),C=(0,o.useMemo)(()=>(0,g.Nx)(z,to),[z]),T=function(e={}){let t=(0,h.useRegisteredCategories)(),a=(0,h.useEventBell)({channels:t}),[i,n]=(0,o.useState)(!1),r=(0,o.useRef)(null),s=(0,o.useRef)(e.formatDailyReminder);(0,o.useEffect)(()=>{s.current=e.formatDailyReminder},[e.formatDailyReminder]),(0,o.useEffect)(()=>{let e=()=>{h.defaultStore.refresh()};window.addEventListener("focus",e);let t=h.dailyStore.subscribe(e);return()=>{window.removeEventListener("focus",e),t()}},[]),(0,o.useEffect)(()=>{if("u"<typeof window||!("Notification"in window)||"granted"!==Notification.permission)return;let e=a.items.find(e=>"daily.overdue"===e.category),t=(0,h.todayISO)();if(!e||r.current===t)return;let i=e.meta,o=i?.missions?.[0],n=o?s.current?.(o):void 0;if(n){r.current=t;try{new Notification(n.title,{body:n.body,tag:`atlantis-daily-${t}`,icon:"/manifest-icon.png"})}catch{}}},[a.items]);let l=(0,o.useCallback)(()=>n(e=>!e),[]),d=(0,o.useCallback)(()=>n(!1),[]);return{...a,open:i,toggle:l,close:d}}({formatDailyReminder:(0,o.useCallback)(e=>{let t=(0,h.missionLabel)(e,z),a=e.emoji?`${e.emoji} ${t}`.trim():t;return{title:C("notifications.source.daily"),body:C("notifications.daily.body",{time:e.time??"",name:a})}},[C,z])}),[A,F]=(0,o.useState)(null);(0,o.useEffect)(()=>{if(ru){h.session.setUser(ru),(0,h.resolveApiKeys)().then(e=>h.session.setApiKeys(e));return}a9.auth.getSession().then(({data:e})=>{let t=e.session?.user??null;m(t),(0,c.Fm)(t?ig:null),h.session.setUser(t),(0,h.resolveApiKeys)().then(e=>h.session.setApiKeys(e)),x(!0)});let{data:{subscription:e}}=a9.auth.onAuthStateChange((e,t)=>{let a=t?.user??null;m(a),(0,c.Fm)(a?ig:null),h.session.setUser(a),(0,h.resolveApiKeys)().then(e=>h.session.setApiKeys(e))});return()=>e.unsubscribe()},[]),(0,o.useEffect)(()=>{let e=()=>{(0,h.resolveApiKeys)().then(e=>h.session.setApiKeys(e))};return window.addEventListener("atlantis:api-keys-changed",e),()=>window.removeEventListener("atlantis:api-keys-changed",e)},[]),(0,o.useEffect)(()=>{h.session.setLocale(z)},[z]),(0,o.useEffect)(()=>{(0,c.PL)(rd).then(e=>r(rg(e))),(0,c.PL)(rc).then(e=>l(rg(e)))},[]),(0,o.useEffect)(()=>{let e=e=>{(e.metaKey||e.ctrlKey)&&"k"===e.key&&(e.preventDefault(),v(void 0),y(e=>!e))};return window.addEventListener("keydown",e),()=>window.removeEventListener("keydown",e)},[]),(0,o.useEffect)(()=>{let e=e=>{let t=e.detail;v(t?.scope),y(!0)};return window.addEventListener("atlantis:open-palette",e),()=>window.removeEventListener("atlantis:open-palette",e)},[]),(0,o.useEffect)(()=>{let e=()=>a(rl(window.location.hash));return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[]),(0,o.useEffect)(()=>{if(t&&"home"!==t){try{localStorage.setItem(rp,t)}catch{}r(e=>{let a=[t,...e.filter(e=>e!==t)].slice(0,8);return(0,c.Is)(rd,JSON.stringify(a)),a})}},[t]);let L=(0,o.useCallback)(e=>{window.location.hash=e,y(!1),v(void 0)},[]),N=(0,o.useCallback)(e=>{window.location.hash=`#/home?suite=${encodeURIComponent(e)}`},[]),[P]=(0,h.useProfile)(),I=(0,o.useMemo)(()=>eT.filter(e=>e.flag?(0,h.resolveFlag)(e.flag):e.enabled).filter(e=>"hidden"!==eC(e)).filter(e=>!(0,h.hasInterests)(P)||!e.interest||P.interests.includes(e.interest)),[P]),D=(0,o.useMemo)(()=>{let e=eF.map(e=>({id:e.id,name:C(e.labelKey),iconName:e.iconName,hash:e.hash,accentColor:e.color,onClick:()=>{window.location.hash=e.hash}}));return eA.map(t=>{let a=I.filter(e=>e.suite===t.yamlSuite),i="games"===t.id;return{id:t.id,name:C(t.nameKey),subtitle:C(t.subKey),color:t.color,icon:t.icon,count:i?eF.length:a.length,onClick:i?void 0:()=>N(t.id),children:i?e:void 0}})},[I,C,N]),R=(0,o.useMemo)(()=>D.filter(e=>e.count>0),[D]),H=(0,o.useMemo)(()=>R.map(e=>({id:e.id,name:e.name,sub:e.subtitle,color:e.color,iconName:e.icon,onConfirm:()=>N(e.id)})),[R,N]),E=(0,o.useMemo)(()=>eF.map(e=>({id:e.id,name:C(e.labelKey),iconName:e.iconName,hash:e.hash,color:e.color})),[C]),O=(0,o.useMemo)(()=>[{id:"add-widget",label:C("palette.action.addWidget"),meta:C("palette.action.addWidget.meta"),iconName:"plus",color:c.w4.colors.accent,onClick:()=>{window.location.hash="#/home";try{sessionStorage.setItem(tP,"1")}catch{}window.dispatchEvent(new CustomEvent("atlantis:open-widget-picker"))}},{id:"preferences",label:C("palette.action.preferences"),meta:C("palette.action.preferences.meta"),iconName:"settings",onClick:()=>k(!0)},{id:"settings",label:C("palette.action.settings"),meta:C("palette.action.settings.meta"),iconName:"sparkle",onClick:()=>{window.location.hash="#/settings"}},{id:"language",label:C("palette.action.language"),meta:C("palette.action.language.meta"),iconName:"globe",onClick:()=>S("pt"===z?"en":"pt")},...T.count>0?[{id:"clear-notifications",label:C("palette.action.clearNotifications"),meta:C("palette.action.clearNotifications.meta",{n:T.count}),iconName:"bell",color:c.w4.colors.accent,onClick:()=>{T.markAllRead()}}]:[],...d?[{id:"signout",label:C("palette.action.signout"),meta:d.email??"",iconName:"arrow-up-right",color:c.w4.colors.danger,onClick:()=>{it()}}]:[]],[C,z,S,d,T]),[B,q]=(0,o.useState)(null);(0,o.useEffect)(()=>{(0,h.resolveGroqKey)().then(q)},[]);let K=(0,h.hasEnvGroqKey)()||!!B,G=(0,o.useMemo)(()=>I.map(({id:e,labelKey:t,hash:a})=>({id:e,label:C(t),hash:a})),[I,C]),W=(0,o.useMemo)(()=>I.map(({id:e,labelKey:t,descriptionKey:a,hash:i,icon:o,color:n,category:r})=>({id:e,label:C(t),description:C(a),hash:i,icon:o,color:n,category:r})),[I,C]),Y=(e=eT.find(e=>e.id===t))?C(e.labelKey):t;if(!u)return(0,i.jsx)(c.NP,{children:(0,i.jsx)(p.xx,{})});if(rm.has(t)&&!d)return(0,i.jsx)(c.NP,{children:(0,i.jsx)(ih,{appLabel:Y,onBack:()=>{window.location.hash="#/home"}})});let V=n7[t],_=e=>{F(e.currentTarget.getBoundingClientRect()),T.toggle()},U=(0,i.jsx)(p.Yw,{locale:z,onLocaleChange:S,before:null!=V?(0,i.jsx)(n9,{count:V}):void 0,notifications:{count:T.count,onClick:_,label:C("notifications.bell")},onOpenPalette:()=>{v(void 0),y(!0)},paletteLabel:C("palette.search"),user:d?{name:d.user_metadata?.full_name,email:d.email??"",avatarUrl:d.user_metadata?.avatar_url}:void 0,userMenuItems:d?[{label:C("userMenu.preferences"),icon:(0,i.jsx)(p.In,{name:"user-cog",size:14}),onClick:()=>k(!0)},{label:C("userMenu.settings"),icon:(0,i.jsx)(p.In,{name:"settings",size:14}),onClick:()=>{window.location.hash="#/settings"}},{label:C("userMenu.clearData"),icon:(0,i.jsx)(p.In,{name:"trash",size:14}),onClick:()=>j(!0),danger:!0},{label:C("userMenu.signOut"),icon:(0,i.jsx)(p.In,{name:"log-out",size:14}),onClick:it,danger:!0}]:[],userMenuControlLabels:{language:C("userMenu.language"),theme:C("userMenu.theme"),themeLight:C("userMenu.themeLight"),themeDark:C("userMenu.themeDark"),themeSystem:C("userMenu.themeSystem")},onSignIn:()=>{window.location.hash="#/home"}}),J=b&&(0,i.jsx)(oc,{apps:W,recentIds:n,suites:H,games:E,actions:O,hasAsk:K,groqKey:B??void 0,locale:z,initialScope:w,onNavigate:L,onClose:()=>{y(!1),v(void 0)}}),Q=!b&&(0,i.jsx)(of,{t:C,onOpenPalette:()=>{v(void 0),y(!0)}}),X=(0,i.jsx)(nv,{open:$,onClose:()=>k(!1),locale:z}),Z=(0,i.jsx)(p.TM,{open:M,title:C("userMenu.clearData"),message:C("userMenu.clearDataConfirm"),confirmLabel:C("userMenu.clearData"),cancelLabel:C("common.cancel"),danger:!0,onCancel:()=>j(!1),onConfirm:async()=>{j(!1),await (0,c.sW)(""),window.location.reload()}}),ee=(0,i.jsx)(nB,{locale:z,state:T,anchor:A});if("home"===t)return(0,i.jsxs)(c.NP,{children:[(0,i.jsx)(n5,{children:(0,i.jsx)(a7,{apps:G,recentAppIds:n,pinnedAppIds:s,onTogglePin:e=>{l(t=>{let a=t.includes(e)?t.filter(t=>t!==e):[...t,e];return(0,c.Is)(rc,JSON.stringify(a)),a})},onMovePinned:(e,t)=>{l(a=>{let i=a.indexOf(e);if(i<0)return a;let o=i+t;if(o<0||o>=a.length)return a;let n=[...a];return[n[i],n[o]]=[n[o],n[i]],(0,c.Is)(rc,JSON.stringify(n)),n})},onSelect:e=>{window.location.hash=e.hash},user:d?{name:d.user_metadata?.full_name,email:d.email??"",avatarUrl:d.user_metadata?.avatar_url}:null,onSignOut:it,onPreferences:()=>k(!0),onClearData:()=>j(!0),onOpenPalette:()=>{v(void 0),y(!0)},notifications:{count:T.count,onClick:_,label:C("notifications.bell")}})},"home"),J,Q,X,Z,ee]});let et=f[t],ea=n2[t]?.({user:d,tmdbKey:"9b6f2645abf1725625c843aa71e3efd5",youtubeKey:rf})??{};return(0,i.jsxs)(c.NP,{children:[(0,i.jsx)(rr,{name:t,topBarRight:U,children:(0,i.jsx)(o.Suspense,{fallback:(0,i.jsx)(p.xx,{}),children:(0,i.jsxs)(n5,{children:[et&&(0,i.jsx)(et,{topBarRight:U,...ea}),"settings"===t&&(0,i.jsx)(p.PE,{title:"Settings",sidebar:null,topBarRight:U,children:(0,i.jsx)(no,{lang:"pt"===z?"pt":"en"})}),"notifications"===t&&(0,i.jsx)(p.PE,{title:C("notifications.page.title"),sidebar:null,topBarRight:U,children:(0,i.jsx)(n4,{locale:z})})]},t)})}),J,Q,X,Z,ee]})},{}))},28170(e,t,a){a.d(t,{Ym:()=>c,Nx:()=>p,Fd:()=>b,aw:()=>h});var i=a(37991),o=a(6063);let n={"time.justNow":{en:"just now",pt:"agora mesmo"},"time.mAgo":{en:"{n}m ago",pt:"h\xe1 {n}m"},"time.hAgo":{en:"{n}h ago",pt:"h\xe1 {n}h"},"time.dAgo":{en:"{n}d ago",pt:"h\xe1 {n}d"},updated:{en:"updated {age}",pt:"atualizado {age}"},refresh:{en:"Refresh",pt:"Atualizar"},loading:{en:"Loading…",pt:"A carregar…"},noData:{en:"No data available",pt:"Sem dados dispon\xedveis"},noDescription:{en:"No description provided.",pt:"Sem descri\xe7\xe3o."},failedToFetch:{en:"Failed to fetch",pt:"Erro ao carregar"},perWeek:{en:"/ wk",pt:"/ sem"},"devtools.heading":{en:"Dev Tools",pt:"Ferramentas"},"devtools.playground":{en:"Playground",pt:"Playground"},"devtools.pad":{en:"Pad",pt:"Pad"},"devtools.charts":{en:"Charts",pt:"Gr\xe1ficos"},"devtools.csv":{en:"CSV",pt:"CSV"},"devtools.regex":{en:"Regex",pt:"Regex"},"devtools.json":{en:"JSON",pt:"JSON"},"devtools.diff":{en:"Diff",pt:"Diferen\xe7as"},"devtools.jwt":{en:"JWT",pt:"JWT"},"devtools.cron":{en:"Cron",pt:"Cron"},"devtools.colors":{en:"Colors",pt:"Cores"},"devtools.api":{en:"API",pt:"API"}},r="atlantis:locale",s="shell:locale";function l(e){return"en"===e||"pt"===e}function d(){try{let e=localStorage.getItem(r);if(l(e))return e}catch{}return"en"}function c(){let[e,t]=(0,i.useState)(d),a=(0,i.useCallback)(e=>{t(e);try{localStorage.setItem(r,e)}catch{}(0,o.Is)(s,e).catch(()=>{}),window.dispatchEvent(new CustomEvent("atlantis:locale-change",{detail:e}))},[]);return(0,i.useEffect)(()=>{let e=e=>{t(e.detail)};return window.addEventListener("atlantis:locale-change",e),()=>window.removeEventListener("atlantis:locale-change",e)},[]),(0,i.useEffect)(()=>{(0,o.PL)(s).then(a=>{if(l(a)&&a!==e){try{localStorage.setItem(r,a)}catch{}t(a)}}).catch(()=>{})},[]),[e,a]}function p(e,t){let a=t?{...n,...t}:n;return(t,i)=>{let o=function(e,t){if(!t||!e.includes("|"))return e;let a=null;for(let e of Object.values(t))if("number"==typeof e&&Number.isFinite(e)){a=e;break}if(null===a)return e;let i=e.indexOf("|"),o=e.slice(0,i),n=e.slice(i+1);return 1===a?o:n}(a[t]?.[e]??t,i);return i?Object.entries(i).reduce((e,[t,a])=>e.replace(RegExp(`\\{${t}\\}`,"g"),String(a)),o):o}}function h(e,t){let a=Math.floor((Date.now()-new Date(e).getTime())/6e4);if(a<1)return t("time.justNow");if(a<60)return t("time.mAgo",{n:a});let i=Math.floor(a/60);return i<24?t("time.hAgo",{n:i}):t("time.dAgo",{n:Math.floor(i/24)})}(0,o.PL)(s).then(e=>{if(l(e))try{localStorage.setItem(r,e)}catch{}}).catch(()=>{});var g=a(65723),m=a(36859),u=a.n(m);let f=u().div`
  display: flex;
  gap: 4px;
...
`,f=({size:e=14,strokeWidth:t=1.75})=>(0,i.jsxs)("svg",{width:e,height:e,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:t,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,i.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,i.jsx)("polyline",{points:"14 2 14 8 20 8"})]});function x({iconKey:e}){let t=e?p[e]:void 0;return t?(0,i.jsx)("svg",{width:14,height:14,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,dangerouslySetInnerHTML:{__html:t}}):(0,i.jsx)(f,{})}function b({entries:e,activeId:t,onSelect:a}){return(0,i.jsx)(i.Fragment,{children:e.map(e=>e.children?(0,i.jsx)(n().Fragment,{children:(0,i.jsx)(b,{entries:e.children,activeId:t,onSelect:a})},e.id):(0,i.jsxs)(u,{active:t===e.id,onClick:()=>a(e),children:[(0,i.jsx)(x,{iconKey:e.icon}),e.name]},e.id))})}function y({activeId:e}){let{flyout:t,scheduleFlyoutClose:a,cancelFlyoutClose:o}=(0,c.c)();if(!t)return null;let n=t.entry.icon?p[t.entry.icon]:void 0;return(0,i.jsxs)(g,{anchorY:t.anchorY,onMouseEnter:o,onMouseLeave:a,children:[(0,i.jsxs)(m,{children:[n?(0,i.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,dangerouslySetInnerHTML:{__html:n}}):(0,i.jsx)(f,{size:13,strokeWidth:2}),t.entry.name]}),(0,i.jsx)(b,{entries:t.entry.children??[],activeId:e,onSelect:e=>{t.onSelect(e),a()}})]})}},37993(e,t,a){a.d(t,{I:()=>o,c:()=>n});var i=a(37991);let o=(0,i.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),n=()=>(0,i.useContext)(o)},44e3(e,t,a){a.d(t,{YZ:()=>eD,n6:()=>A,Yw:()=>ec,SV:()=>eS,rl:()=>eV,dO:()=>tG,mQ:()=>tL,TM:()=>t0,pd:()=>eO,tU:()=>j,xx:()=>t9,ue:()=>eP,Ex:()=>eL,$n:()=>b,In:()=>F,K0:()=>$,PE:()=>ay,eu:()=>O});var i=a(65723),o=a(37991),n=a.n(o),r=a(36859),s=a.n(r),l=a(6063);let d={ghost:"transparent",accent:"transparent",primary:l.w4.colors.accent,success:"#238636",danger:"#da3633"},c={ghost:l.w4.colors.sidebarHover,accent:"rgba(88,166,255,0.10)",primary:l.w4.colors.accentHover,success:"#2ea043",danger:"#f85149"},p={ghost:l.w4.colors.border,accent:l.w4.colors.accent,primary:l.w4.colors.accent,success:"#238636",danger:"#da3633"},h={ghost:l.w4.colors.mainTextMuted,accent:l.w4.colors.accent,primary:"#fff",success:"#fff",danger:"#fff"},g={ghost:l.w4.colors.mainText,accent:l.w4.colors.accent,primary:"#fff",success:"#fff",danger:"#fff"},m={sm:"28px",md:"30px"},u={sm:"0 10px",md:"0 12px"},f={sm:"12px",md:"12px"},x=s().button`
  display: inline-flex;
  align-items: center;
  justify-content: center;
  gap: 6px;
...
`,b=n().forwardRef(function({variant:e="ghost",size:t="md",icon:a,iconRight:o,children:n,...r},s){return(0,i.jsxs)(x,{ref:s,variant:e,size:t,...r,children:[a,n,o]})}),y={default:l.w4.colors.accent,danger:"#f85149"},w={default:l.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"},v=s().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`,$=n().forwardRef(function({active:e=!1,shape:t="square",tone:a="default",children:o,...n},r){return(0,i.jsx)(v,{ref:r,active:e,shape:t,tone:a,...n,children:o})});s().div`
  position: relative;
  display: inline-flex;
`,s().div`
  position: absolute;
...
`;function E({name:e,email:t,avatarUrl:a,size:o=26}){let n=e??t.split("@")[0]??t;if(a)return(0,i.jsx)(R,{src:a,alt:n,size:o});let r=((e??t.split("@")[0]??"")[0]??"?").toUpperCase();return(0,i.jsx)(H,{size:o,"aria-label":n,title:n,children:r})}function O({member:e,size:t=24}){var a,o;let n,r="shared"===e.id||"shared"===e.role,s=Math.floor(.55*t),d=t<=18?8:t<=22?9:t<=28?11:12;if(r)return(0,i.jsx)(L,{size:t,bg:l.w4.colors.surface,ring:!0,"aria-label":"Shared",title:"Shared",style:{color:l.w4.colors.mainTextMuted},children:(0,i.jsx)(F,{name:"home",size:s,"aria-hidden":!0})});let c=(a=e.id,(o=e.color)?o:(!D.has(a)&&(D.set(a,P[I%P.length]),I++),D.get(a))),p="adult"===e.role,h=(n=e.name.trim().split(/\s+/),((n[0]?.[0]??"")+(n[1]?.[0]??"")).toUpperCase().slice(0,2));return(0,i.jsx)(L,{size:t,bg:c,ring:p,title:e.name,children:(0,i.jsx)(N,{fontSize:d,children:h})})}let B=(0,C.keyframes)`
...
`;function et({labels:e}){let{mode:t,setMode:a}=(0,l.eP)(),o=[{value:"light",label:e?.themeLight??"Light"},{value:"dark",label:e?.themeDark??"Dark"},{value:"system",label:e?.themeSystem??"System"}];return(0,i.jsxs)(J,{children:[(0,i.jsx)(Q,{children:e?.theme??"Theme"}),(0,i.jsx)(X,{role:"radiogroup","aria-label":e?.theme??"Theme",children:o.map(({value:e,label:o})=>(0,i.jsx)(Z,{active:t===e,onClick:()=>a(e),role:"radio","aria-checked":t===e,children:o},e))})]})}function ea({user:e,items:t,compact:a=!1,locale:n,onLocaleChange:r,controlLabels:s,showThemeControl:l=!0}){let[d,c]=(0,o.useState)(!1),[p,h]=(0,o.useState)(null),g=(0,o.useRef)(null),m=(0,o.useRef)(null),u=(0,o.useRef)(null);(0,o.useEffect)(()=>{if(!d)return;let e=e=>{let t=e.target;g.current?.contains(t)||u.current?.contains(t)||c(!1)};return document.addEventListener("mousedown",e),()=>document.removeEventListener("mousedown",e)},[d]),(0,o.useEffect)(()=>{d?m.current&&h(m.current.getBoundingClientRect()):h(null)},[d]);let f=e.name??e.email.split("@")[0],x=p?{top:Math.round(p.bottom+8),right:Math.max(12,Math.round(window.innerWidth-p.right))}:{top:0,right:12};return(0,i.jsxs)(q,{ref:g,children:[(0,i.jsxs)(K,{ref:m,onClick:()=>c(e=>!e),children:[(0,i.jsx)(E,{name:e.name,email:e.email,avatarUrl:e.avatarUrl,size:26}),!a&&(0,i.jsx)(G,{children:f})]}),d&&S().createPortal((0,i.jsxs)(W,{ref:u,style:x,children:[(0,i.jsxs)(Y,{children:[(0,i.jsx)(V,{children:(0,i.jsx)(E,{name:e.name,email:e.email,avatarUrl:e.avatarUrl,size:40})}),(0,i.jsx)(_,{children:f}),(0,i.jsx)(U,{children:e.email})]}),void 0!==n&&r&&(0,i.jsxs)(J,{children:[(0,i.jsx)(Q,{children:s?.language??"Language"}),(0,i.jsxs)(X,{role:"radiogroup","aria-label":s?.language??"Language",children:[(0,i.jsx)(Z,{active:"pt"===n,onClick:()=>r("pt"),role:"radio","aria-checked":"pt"===n,children:"Portugu\xeas"}),(0,i.jsx)(Z,{active:"en"===n,onClick:()=>r("en"),role:"radio","aria-checked":"en"===n,children:"English"})]})]}),l&&(0,i.jsx)(et,{labels:s}),t.map((e,t)=>(0,i.jsxs)(ee,{danger:e.danger,onClick:()=>{c(!1),e.onClick()},children:[e.icon,e.label]},t))]}),document.body)]})}var ei=a(28170);let eo=s().div`
  display: flex;
  align-items: center;
  gap: ${l.w4.spacing.sm};
...
`;function ec({locale:e,onLocaleChange:t,user:a,userMenuItems:o=[],userMenuControlLabels:n,onPreferences:r,notifications:s,onOpenPalette:d,paletteLabel:c="Search",onSignIn:p,signInLabel:h="Sign in",before:g,after:m}){let u=function(){if("u"<typeof navigator)return"Ctrl";let e=navigator,t=e.userAgentData?.platform??navigator.platform??navigator.userAgent??"";return/Mac|iPod|iPhone|iPad/i.test(t)?"⌘":"Ctrl"}(),f="⌘"===u?`${u}K`:`${u}+K`;return(0,i.jsxs)(eo,{children:[g,d&&(0,i.jsxs)(er,{onClick:d,"aria-label":c,title:`${c} (${f})`,children:[(0,i.jsx)(F,{name:"search",size:14}),(0,i.jsx)("span",{className:"label",children:c}),(0,i.jsx)("span",{className:"kbd header-kbd",children:f})]}),!a&&(0,i.jsx)(ei.Fd,{locale:e,onChange:t}),!a&&(0,i.jsx)("span",{className:"header-hide-md",children:(0,i.jsx)(l.UW,{})}),s&&(0,i.jsxs)(es,{children:[(0,i.jsx)(en,{onClick:s.onClick,"aria-label":s.label,title:s.label,children:(0,i.jsx)(F,{name:"bell",size:16})}),s.count>0&&(0,i.jsx)(el,{"aria-hidden":"true",children:s.count>9?"9+":s.count})]}),r&&(0,i.jsx)("span",{className:"header-hide-md",children:(0,i.jsx)(en,{onClick:r,"aria-label":"User preferences",title:"Preferences",children:(0,i.jsx)(F,{name:"user-cog",size:16})})}),a?(0,i.jsx)(ea,{user:a,items:o,locale:e,onLocaleChange:t,controlLabels:n}):p?(0,i.jsxs)(ed,{onClick:p,"aria-label":h,children:[(0,i.jsx)(F,{name:"log-in",size:14}),h]}):null,m]})}s().div`
  position: fixed;
  inset: 0;
  pointer-events: none;
  z-index: 900;
...
`,eE=s().span`
  ...
  color: ${l.w4.colors.mainTextMuted};
  flex-shrink: 0;
`,eO=n().forwardRef(function({before:e,after:t,...a},o){return(0,i.jsxs)(eR,{children:[e&&(0,i.jsx)(eE,{children:e}),(0,i.jsx)(eH,{ref:o,...a}),t&&(0,i.jsx)(eE,{children:t})]})}),eB=s().div`
  position: relative;
  display: flex;
  flex-direction: column;
  height: 100%;
...
`;function eV({title:e,accessory:t,accentColor:a,error:o,errorLabel:n,children:r}){return(0,i.jsxs)(eB,{accentColor:a,"data-widget-shell":!0,children:[(0,i.jsxs)(eq,{children:[(0,i.jsx)(eD,{children:e}),t&&(0,i.jsx)(eK,{children:t})]}),o?(0,i.jsxs)(eW,{role:"alert",children:[(0,i.jsx)(eY,{children:n??"Error"}),(0,i.jsx)("div",{children:o})]}):(0,i.jsx)(eG,{children:r})]})}s().div`
  position: relative;
  display: flex;
  flex-direction: column;
  height: 100%;
...
`,e9=!1,te=/^(?:---[\s\S]*?---\s*)?(?:graph|flowchart|sequenceDiagram|classDiagram|stateDiagram(?:-v2)?|erDiagram|pie|gantt|journey|mindmap|gitGraph|sankey(?:-beta)?|quadrantChart|requirementDiagram|timeline|xychart-beta|block-beta|C4Context|C4Container|C4Component|C4Dynamic|C4Deployment)\b/;function tt({code:e}){let[t,a]=(0,o.useState)(""),[n,r]=(0,o.useState)(!1);return((0,o.useEffect)(()=>{let t=!1;r(!1),a("");let i=e.trim();if(!i)return void r(!0);let o=i.split(/\r?\n/)[0]?.trim()??"";if(!te.test(o))return void r(!0);let n=setTimeout(()=>{t||(console.error("[MermaidBlock] render timed out after 5s"),r(!0))},5e3);return(async()=>{try{let e=await (e2||(e2=new Promise((e,t)=>{let a=globalThis.mermaid;if(a)return void e(a);let i=document.createElement("script");i.src=e4,i.async=!0,i.onload=()=>{let a=globalThis.mermaid;a?e(a):t(Error("mermaid loaded but globalThis.mermaid missing"))},i.onerror=()=>t(Error(`failed to load ${e4}`)),document.head.appendChild(i)})));if(console.debug("[MermaidBlock] mermaid ready",{initialized:e9}),!e9){let t="#141820",a="#1c2332",i="#343c4f",o="#e8edf5",n="#9aa5b8",r="#7fb77e",s="#6aa8d8",l="#8b7bff",d="#e89a5c",c="#f87171";e.initialize({startOnLoad:!1,theme:"base",securityLevel:"loose",themeVariables:{fontFamily:"-apple-system, BlinkMacSystemFont, Segoe UI, Helvetica, Arial, sans-serif",background:t,mainBkg:a,primaryColor:r,primaryTextColor:o,primaryBorderColor:r,secondaryColor:l,secondaryTextColor:o,secondaryBorderColor:l,tertiaryColor:s,tertiaryTextColor:o,tertiaryBorderColor:s,lineColor:n,textColor:o,nodeBorder:i,clusterBkg:t,clusterBorder:i,edgeLabelBackground:a,labelBackground:a,labelBorder:i,relationLabelBackground:a,relationLabelColor:o,pie1:r,pie2:l,pie3:s,pie4:d,pie5:"#ff6fa9",pie6:"#2dd4bf",pie7:c,pie8:r,pieStrokeColor:t,pieStrokeWidth:"2px",pieTitleTextSize:"18px",pieSectionTextSize:"13px",pieLegendTextSize:"13px",actorBkg:r,actorBorder:r,actorTextColor:t,signalColor:o,signalTextColor:o,labelBoxBkgColor:a,labelBoxBorderColor:i,labelTextColor:o,loopTextColor:o,noteBkgColor:d,noteBorderColor:d,noteTextColor:t,stateBkg:a,altBackground:t,attributeBackgroundColorOdd:a,attributeBackgroundColorEven:t,rowOdd:a,rowEven:t,gridColor:i,sectionBkgColor:a,sectionBkgColor2:t,taskBkgColor:l,taskTextColor:o,taskTextDarkColor:o,taskTextLightColor:o,taskTextOutsideColor:o,activeTaskBkgColor:r,activeTaskBorderColor:r,doneTaskBkgColor:n,doneTaskBorderColor:n,critBkgColor:c,critBorderColor:c}}),e9=!0}console.debug("[MermaidBlock] calling mermaid.render");let{svg:o}=await e.render(`mermaid-${(0,e1.z)()}`,i);if(clearTimeout(n),console.debug("[MermaidBlock] render returned",{length:o?.length??0}),t)return;let s=/aria-roledescription="error"/i.test(o)||/class="error-(?:icon|text)"/i.test(o)||/>Syntax error in text</i.test(o);if(!o||s)return void r(!0);a(o)}catch(e){clearTimeout(n),console.error("[MermaidBlock] render failed",e),t||r(!0)}})(),()=>{t=!0,clearTimeout(n)}},[e]),n)?(0,i.jsx)(e7,{children:e.trim()}):t?(0,i.jsx)(e6,{dangerouslySetInnerHTML:{__html:t}}):(0,i.jsx)(e6,{children:(0,i.jsx)(e8,{"aria-hidden":!0})})}let ta=["#388bfd","#3fb950","#d29922","#a371f7","#f87171","#22d3ee","#fb923c","#34d399","#f472b6","#818cf8"],ti=s().div`
  background: ${l.w4.colors.codeBg};
  border: 1px solid ${l.w4.colors.codeBorder};
  border-radius: ${l.w4.borderRadius.md};
...
`;function tT({type:e,children:t}){let a=tj[e]??tj.NOTE;return(0,i.jsxs)(tz,{bg:a.bg,border:a.border,children:[(0,i.jsxs)(tS,{color:a.color,children:[(0,i.jsx)(F,{name:a.icon,size:15,strokeWidth:2}),a.label]}),(0,i.jsx)(tC,{children:t})]})}function tA(){let e=/^\[!(NOTE|TIP|WARNING|CAUTION|IMPORTANT)\]\s*/i;return t=>{function a(t,a,i){let o=a.children?.[0];o?.type==="text"&&(o.value=o.value.replace(e,""),o.value.trim()||1!==a.children.length||a.children.shift()),t.data=t.data??{},t.data.hName="div",t.data.hProperties={"data-callout":i.toUpperCase()}}!function t(i){if("blockquote"===i.type){let t=i.children?.[0];if(t?.type==="paragraph"){let o=t.children?.[0],n=o?.type==="text"&&o.value?.match(e);n&&a(i,t,n[1])}}if("paragraph"===i.type){let t=i.children?.[0],o=t?.type==="text"&&t.value?.match(e);if(o){let t=[...i.children];i.children=[{type:"paragraph",children:t}],a(i,i.children[0],o[1]);let n=t[0];n?.type==="text"&&(n.value=n.value.replace(e,""),n.value.trim()||1!==t.length||t.shift());return}}i.children?.forEach(t)}(t)}}s().nav`
  width: 220px;
  min-width: 220px;
...
`;function tq({size:e}){return(0,i.jsxs)("svg",{width:14,height:14,viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:[(0,i.jsx)("rect",{x:1.5,y:4.5,width:11,height:5,rx:1,stroke:"currentColor",strokeWidth:1,opacity:.4}),(0,i.jsx)("rect",{x:2,y:5,width:"sm"===e?4:"md"===e?7:11,height:4,rx:.5,fill:"currentColor"})]})}let tK={sm:1,md:2,lg:"full"};function tG({items:e,onReorder:t,onCycleSize:a,onRemove:o,renderPanel:n,renderAccessory:r,showGrip:s=!0,labels:l,accentColor:d}){return(0,i.jsx)(tI,{children:e.map((c,p)=>{let h=tK[c.size],g="full"===h,m=c.minHeight??160,u=d?.(c),f=(c.availableSizes??["sm","md","lg"]).length>1,x=r?.(c);return(0,i.jsxs)(tD,{colSpan:g?1:h,fullWidth:g,children:[x&&(0,i.jsx)(tR,{children:x}),(0,i.jsxs)(tH,{minH:m,accent:u,"data-grip":s?"true":"false",children:[(0,i.jsxs)(tE,{className:"panel-controls",children:[p>0&&(0,i.jsx)(tO,{type:"button",title:l.moveLeft,onClick:()=>t(c.id,-1),children:(0,i.jsx)(F,{name:"chevron-left",size:14})}),p<e.length-1&&(0,i.jsx)(tO,{type:"button",title:l.moveRight,onClick:()=>t(c.id,1),children:(0,i.jsx)(F,{name:"chevron-right",size:14})}),f&&(0,i.jsx)(tO,{type:"button",title:`${l.cycleSize} \xb7 ${c.size.toUpperCase()}`,onClick:()=>a(c.id),children:(0,i.jsx)(tq,{size:c.size})}),o&&l.remove&&(0,i.jsx)(tB,{type:"button",title:l.remove,onClick:()=>o(c.id),children:(0,i.jsx)(F,{name:"close",size:14})})]}),n(c)]})]},c.id)})})}let tW=(0,C.keyframes)`
...
`;s().div`
  ...
  pointer-events: none;
  z-index: 200;
  animation: ${tW} 0.16s cubic-bezier(0.4, 0, 0.2, 1) forwards;
...
`,tU=s().div`
  ...
  flex-direction: column;
  gap: 14px;
  animation: ${tV} 0.18s cubic-bezier(0.22, 1, 0.36, 1) both;
`,tJ=s().div`
  font-size: ${l.w4.typography.fontSizeMd};
  font-weight: 700;
...
`,tZ=s().button`
  ...
  &:hover { opacity: 0.88; }
  &:focus-visible { ${l.w4.focusRing} }
`;function t0({open:e,title:t,message:a,confirmLabel:n,cancelLabel:r,onConfirm:s,onCancel:l,danger:d=!1}){return((0,o.useEffect)(()=>{if(!e)return;let t=e=>{"Escape"===e.key&&l(),"Enter"===e.key&&s()};return document.addEventListener("keydown",t),()=>document.removeEventListener("keydown",t)},[e,l,s]),e)?(0,i.jsx)(t_,{onClick:l,role:"dialog","aria-modal":"true","aria-label":t,children:(0,i.jsxs)(tU,{danger:d,onClick:e=>e.stopPropagation(),children:[(0,i.jsx)(tJ,{danger:d,children:t}),(0,i.jsx)(tQ,{children:a}),(0,i.jsxs)(tX,{children:[(0,i.jsx)(tZ,{onClick:l,children:r}),(0,i.jsx)(tZ,{danger:d,primary:!d,onClick:s,autoFocus:!0,children:n})]})]})}):null}let t1=(0,C.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,t4=(0,C.keyframes)`
...
`,t5=s().div`
  ...
  background: ${l.w4.colors.mainBg};
  font-family: ${l.w4.typography.fontFamily};
  animation: ${t1} 0.4s ease 0.15s both;
`,t3=s().div`
  position: relative;
  width: 56px;
  height: 56px;
...
`,t6=s().div`
  position: absolute;
  inset: 0;
  animation: ${t4} 1.4s cubic-bezier(0.4, 0, 0.2, 1) infinite;
...
`,t8=s().div`
  ...
  border-radius: 50%;
  background: ${l.w4.colors.border};
  animation: ${t2} 1.4s ease-in-out infinite;
`,t7=s().span`
  color: ${l.w4.colors.mainTextMuted};
  font-size: ${l.w4.typography.fontSizeSm};
  letter-spacing: 0.04em;
`;function t9({label:e="Loading…"}){return(0,i.jsxs)(t5,{children:[(0,i.jsxs)(t3,{children:[(0,i.jsx)(t6,{delay:0,size:8,color:l.w4.colors.accent}),(0,i.jsx)(t6,{delay:-.45,size:6,color:"#bc8cff"}),(0,i.jsx)(t6,{delay:-.9,size:5,color:"#3fb950"}),(0,i.jsx)(t8,{})]}),(0,i.jsx)(t7,{children:e})]})}s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,s().div`
  position: relative;
`;let ae="260px",at="56px",aa="48px",ai=s().header`
  display: flex;
  align-items: center;
  height: calc(${aa} + env(safe-area-inset-top, 0px));
  padding-top: env(safe-area-inset-top, 0px);
  padding-left: env(safe-area-inset-left, 0px);
  padding-right: env(safe-area-inset-right, 0px);
  background: ${l.w4.colors.sidebarBg};
  ...
  @media (max-width: ${l.w4.breakpoints.md}) {
    flex-wrap: wrap;
    height: auto;
    min-height: calc(${aa} + env(safe-area-inset-top, 0px));
  }
`,ao=s().div`
  width: ${at};
  min-width: ${at};
...
`,al=s().span`
  ...
  animation: ${ar} 10s ease ${({index:e})=>.07*e}s infinite;
...
`,ah=s().div`
  ...
  overflow: hidden;
`,ag=s().aside`
  width: ${({collapsed:e})=>e?at:ae};
  min-width: ${({collapsed:e})=>e?at:ae};
  background: ${l.w4.colors.sidebarBg};
  border-right: 1px solid ${l.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,au=s().main`
  ...
  display: flex;
  flex-direction: column;
`,af=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function ax(){return(0,i.jsx)(as,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:af.map((e,t)=>(0,i.jsx)(al,{index:t,accent:e.accent,children:e.char},t))})}let ab="atlantis:sidebar-collapsed";function ay({sidebar:e,children:t,topBarRight:r,title:s="Atlantis",activeId:l=null}){let[d,c]=(0,o.useState)(()=>{try{return"true"===localStorage.getItem(ab)}catch{return!1}}),[p,h]=(0,o.useState)(null),g=(0,o.useRef)(),m=()=>c(e=>{let t=!e;try{localStorage.setItem(ab,String(t))}catch{}return t}),u=n().useMemo(()=>n().lazy(()=>Promise.resolve().then(a.bind(a,45816)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,i.jsx)(tN.I.Provider,{value:{collapsed:d,toggle:m,flyout:p,openFlyout:(e,t,a)=>{clearTimeout(g.current),h({entry:e,anchorY:t,onSelect:a})},scheduleFlyoutClose:()=>{g.current=setTimeout(()=>h(null),160)},cancelFlyoutClose:()=>clearTimeout(g.current)},children:(0,i.jsxs)(ah,{children:[(0,i.jsxs)(ai,{children:[e&&(0,i.jsx)(ao,{children:(0,i.jsx)(an,{onClick:m,title:d?"Expand sidebar":"Collapse sidebar",children:(0,i.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,i.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,i.jsx)("path",{d:"M9 3v18"})]})})}),(0,i.jsx)(ax,{}),s&&(0,i.jsx)(ad,{children:s}),r&&(0,i.jsx)(ac,{children:r})]}),(0,i.jsxs)(ap,{children:[null!=e&&(0,i.jsx)(ag,{collapsed:d,children:(0,i.jsx)(am,{children:e})}),(0,i.jsx)(au,{children:t})]}),p&&(0,i.jsx)(n().Suspense,{fallback:null,children:(0,i.jsx)(u,{activeId:l})})]})})}s().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
...
`,s().div`
  flex: 1;
`},9391(e,t,a){a.d(t,{O:()=>r});var i=a(65723);a(37991);var o=a(44e3);let n={sm:20,md:24,lg:28};function r({member:e,size:t="md"}){let a="number"==typeof t?t:n[t];return(0,i.jsx)(o.eu,{member:e,size:a})}},85043(e,t,a){a.d(t,{Y:()=>p});var i=a(65723),o=a(36859),n=a.n(o),r=a(6063);let s=n().div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
`,d=n().p`
  ...
  margin: 0;
  line-height: 1.5;
`,c={loading:"◌ Loading",empty:"◎ Empty",error:"◎ Offline"};function p({mode:e,label:t,body:a}){return(0,i.jsxs)(s,{children:[(0,i.jsx)(l,{mode:e,children:t??c[e]}),a&&(0,i.jsx)(d,{children:a})]})}},96246(e,t,a){a.d(t,{YG:()=>i.Y});var i=a(85043);a(65723),a(37991);var o=a(6063),n=a(36859),r=a.n(n);r().span`
  font-family: ${o.w4.typography.fontFamilyMono};
  font-size: 11px;
  font-weight: 500;
  font-variant-numeric: tabular-nums;
