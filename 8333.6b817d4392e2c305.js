...
`,t9=s().span`
  ...
  font-size: ${l.w4.typography.fontSizeSm};
  letter-spacing: 0.04em;
`;function ae({label:e="Loading…"}){return(0,i.jsxs)(t3,{children:[(0,i.jsxs)(t8,{children:[(0,i.jsx)(t6,{delay:0,size:8,color:l.w4.colors.accent}),(0,i.jsx)(t6,{delay:-.45,size:6,color:"#bc8cff"}),(0,i.jsx)(t6,{delay:-.9,size:5,color:"#3fb950"}),(0,i.jsx)(t7,{})]}),(0,i.jsx)(t9,{children:e})]})}s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
