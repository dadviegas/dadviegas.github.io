...
`;let u={default:n.w4.colors.accent,danger:"#f85149"},b={default:n.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"};s().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`;let M={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:n.w4.colors.accentMuted},k={neutral:n.w4.colors.mainTextMuted,live:n.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:n.w4.colors.accent};s().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${n.w4.typography.fontFamilyMono};
...
`,s().div`
  ...
  flex-direction: column;
  gap: 14px;
  animation: ${L} 0.18s cubic-bezier(0.22, 1, 0.36, 1) both;
`,s().div`
  font-size: ${n.w4.typography.fontSizeMd};
  font-weight: 700;
...
`,s().div`
  position: relative;
`;let E="260px",V="56px",I="48px",D=s().header`
  display: flex;
  align-items: center;
  height: calc(${I} + env(safe-area-inset-top, 0px));
  ...
  @media (max-width: ${n.w4.breakpoints.md}) {
    flex-wrap: wrap;
    height: auto;
    min-height: calc(${I} + env(safe-area-inset-top, 0px));
  }
`,N=s().div`
  width: ${V};
  min-width: ${V};
...
`,q=s().div`
  ...
  overflow: hidden;
`,J=s().aside`
  width: ${({collapsed:e})=>e?V:E};
  min-width: ${({collapsed:e})=>e?V:E};
  background: ${n.w4.colors.sidebarBg};
  border-right: 1px solid ${n.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,X=s().main`
  ...
  display: flex;
  flex-direction: column;
`,Q=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function ee(){return(0,t.jsx)(K,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:Q.map((e,o)=>(0,t.jsx)(Y,{index:o,accent:e.accent,children:e.char},o))})}let eo="atlantis:sidebar-collapsed";function ea({sidebar:e,children:o,topBarRight:n,title:l="Atlantis",activeId:s=null}){let[d,c]=(0,r.useState)(()=>{try{return"true"===localStorage.getItem(eo)}catch{return!1}}),[p,g]=(0,r.useState)(null),h=(0,r.useRef)(),m=()=>c(e=>{let o=!e;try{localStorage.setItem(eo,String(o))}catch{}return o}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(a.bind(a,2787)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,t.jsx)(T.I.Provider,{value:{collapsed:d,toggle:m,flyout:p,openFlyout:(e,o,a)=>{clearTimeout(h.current),g({entry:e,anchorY:o,onSelect:a})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,t.jsxs)(q,{children:[(0,t.jsxs)(D,{children:[e&&(0,t.jsx)(N,{children:(0,t.jsx)(G,{onClick:m,title:d?"Expand sidebar":"Collapse sidebar",children:(0,t.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("path",{d:"M9 3v18"})]})})}),(0,t.jsx)(ee,{}),l&&(0,t.jsx)(O,{children:l}),n&&(0,t.jsx)(_,{children:n})]}),(0,t.jsxs)(U,{children:[null!=e&&(0,t.jsx)(J,{collapsed:d,children:(0,t.jsx)(Z,{children:e})}),(0,t.jsx)(X,{children:o})]}),p&&(0,t.jsx)(i().Suspense,{fallback:null,children:(0,t.jsx)(f,{activeId:s})})]})})}var et=a(4971);let er=s().div`
  display: grid;
...
`;function eh({iconKey:e,size:o=16}){let a=e?et.X[e]:void 0;return a?(0,t.jsx)("svg",{width:o,height:o,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,dangerouslySetInnerHTML:{__html:a}}):e?(0,t.jsx)("span",{style:{fontSize:o,lineHeight:1,display:"flex",alignItems:"center"},children:e}):(0,t.jsxs)("svg",{width:o,height:o,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,children:[(0,t.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,t.jsx)("polyline",{points:"14 2 14 8 20 8"})]})}function em({entry:e,activeId:o,onSelect:a}){let[i,n]=(0,r.useState)(e.defaultOpen??!0),{collapsed:l,openFlyout:s,scheduleFlyoutClose:d,cancelFlyoutClose:c}=(0,T.c)();return e.children&&e.children.length>0?(0,t.jsxs)(el,{children:[(0,t.jsxs)(es,{collapsed:l,onClick:()=>{l||n(e=>!e)},onMouseEnter:l?o=>{s(e,o.currentTarget.getBoundingClientRect().top,a)}:void 0,onMouseLeave:l?d:void 0,children:[(0,t.jsxs)(ed,{collapsed:l,children:[(0,t.jsx)(eh,{iconKey:e.icon,size:16}),(0,t.jsx)(ec,{collapsed:l,children:e.name})]}),(0,t.jsx)(ep,{open:i,collapsed:l,children:(0,t.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round",children:(0,t.jsx)("path",{d:"M9 6l6 6-6 6"})})})]}),(0,t.jsx)(er,{open:i&&!l,children:(0,t.jsx)(ei,{children:(0,t.jsx)(en,{children:e.children.map(e=>(0,t.jsx)(em,{entry:e,activeId:o,onSelect:a},e.id))})})})]}):(0,t.jsxs)(eg,{active:o===e.id,collapsed:l,onClick:()=>a(e),onMouseEnter:l?o=>{let t=o.currentTarget.getBoundingClientRect();s({id:e.id,name:e.name,icon:e.icon,file:e.file,children:[e]},t.top,a)}:void 0,onMouseLeave:l?d:void 0,children:[(0,t.jsx)(eh,{iconKey:e.icon,size:15}),(0,t.jsx)(ec,{collapsed:l,children:e.name})]})}function ef({entries:e,activeId:o,onSelect:a}){return(0,t.jsx)("div",{children:e.map(e=>(0,t.jsx)(em,{entry:e,activeId:o,onSelect:a},e.id))})}function ex(e){try{return JSON.parse(localStorage.getItem(e)??"[]")}catch{return[]}}a(2787),s().div`
...
`,s().div`
  flex: 1;
`;let eu=s().nav`padding: ${n.w4.spacing.sm} 0;`,eb=s().div`
...
`,eM=s().div`overflow: hidden;`,ek=s().div`
  display: flex;
  align-items: center;
...
`;function eT({title:e,icon:o,entries:a,activeId:i,onSelect:n,favorites:l,onToggleFav:s,collapsed:d}){let[c,p]=(0,r.useState)(!1);return a.length?(0,t.jsxs)(eb,{children:[(0,t.jsxs)(ey,{collapsed:d,onClick:()=>{d||p(e=>!e)},children:[(0,t.jsxs)(ew,{collapsed:d,children:[o,(0,t.jsx)(e$,{collapsed:d,children:e})]}),(0,t.jsx)(ev,{open:c,collapsed:d,children:(0,t.jsx)($,{name:"chevron-right",size:12})})]}),(0,t.jsx)(ez,{open:c&&!d,children:(0,t.jsx)(eM,{children:a.map(e=>{let o=l.some(o=>o.id===e.id);return(0,t.jsxs)(ek,{children:[(0,t.jsx)(ej,{active:i===e.id,onClick:()=>n(e),children:e.name}),(0,t.jsx)(eA,{active:o,title:o?"Remover dos favoritos":"Adicionar aos favoritos",onClick:o=>{o.stopPropagation(),s(e)},children:(0,t.jsx)($,{name:"star",size:12})})]},e.id)})})})]}):null}function eS({config:e,activeId:o,onSelect:a,hashPrefix:i}){let n=`atlantis-recent-${i}`,l=`atlantis-fav-${i}`,{collapsed:s}=(0,T.c)(),[d,c]=(0,r.useState)(()=>ex(n)),[p,g]=(0,r.useState)(()=>ex(l)),h=(0,r.useCallback)(e=>{e.file&&c(o=>{let a;return a=[e,...o.filter(o=>o.id!==e.id)].slice(0,10),localStorage.setItem(n,JSON.stringify(a)),a}),a(e)},[a,n]),m=(0,r.useCallback)(e=>{g(o=>{let a;return a=o.some(o=>o.id===e.id)?o.filter(o=>o.id!==e.id):[...o,e],localStorage.setItem(l,JSON.stringify(a)),a})},[l]);return(0,t.jsxs)(eu,{children:[(0,t.jsx)(eT,{title:"Recentes",icon:(0,t.jsx)($,{name:"clock",size:13}),entries:d,activeId:o,onSelect:h,favorites:p,onToggleFav:m,collapsed:s}),(0,t.jsx)(eT,{title:"Favoritos",icon:(0,t.jsx)($,{name:"star",size:13}),entries:p,activeId:o,onSelect:h,favorites:p,onToggleFav:m,collapsed:s}),(0,t.jsx)(ef,{entries:e.entries,activeId:o,onSelect:h})]})}var eC=a(1352),eB=a(6710),eF=a(3639),eL=a(80),eH=a(4311);let eR="https://cdn.jsdelivr.net/npm/mermaid@11.14.0/dist/mermaid.min.js",eP=null,eE="#7fb77e",eV=(0,y.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,eI=s().div`
  position: relative;
...
`,eG=!1,eW=/^(?:---[\s\S]*?---\s*)?(?:graph|flowchart|sequenceDiagram|classDiagram|stateDiagram(?:-v2)?|erDiagram|pie|gantt|journey|mindmap|gitGraph|sankey(?:-beta)?|quadrantChart|requirementDiagram|timeline|xychart-beta|block-beta|C4Context|C4Container|C4Component|C4Dynamic|C4Deployment)\b/;function eK({code:e}){let[o,a]=(0,r.useState)(""),[i,n]=(0,r.useState)(!1);return((0,r.useEffect)(()=>{let o=!1;n(!1),a("");let t=e.trim();if(!t)return void n(!0);let r=t.split(/\r?\n/)[0]?.trim()??"";if(!eW.test(r))return void n(!0);let i=setTimeout(()=>{o||(console.error("[MermaidBlock] render timed out after 5s"),n(!0))},5e3);return(async()=>{try{let e=await (eP||(eP=new Promise((e,o)=>{let a=globalThis.mermaid;if(a)return void e(a);let t=document.createElement("script");t.src=eR,t.async=!0,t.onload=()=>{let a=globalThis.mermaid;a?e(a):o(Error("mermaid loaded but globalThis.mermaid missing"))},t.onerror=()=>o(Error(`failed to load ${eR}`)),document.head.appendChild(t)})));if(console.debug("[MermaidBlock] mermaid ready",{initialized:eG}),!eG){let o="#141820",a="#1c2332",t="#343c4f",r="#e8edf5",i="#9aa5b8",n="#7fb77e",l="#6aa8d8",s="#8b7bff",d="#e89a5c",c="#f87171";e.initialize({startOnLoad:!1,theme:"base",securityLevel:"loose",themeVariables:{fontFamily:"-apple-system, BlinkMacSystemFont, Segoe UI, Helvetica, Arial, sans-serif",background:o,mainBkg:a,primaryColor:n,primaryTextColor:r,primaryBorderColor:n,secondaryColor:s,secondaryTextColor:r,secondaryBorderColor:s,tertiaryColor:l,tertiaryTextColor:r,tertiaryBorderColor:l,lineColor:i,textColor:r,nodeBorder:t,clusterBkg:o,clusterBorder:t,edgeLabelBackground:a,labelBackground:a,labelBorder:t,relationLabelBackground:a,relationLabelColor:r,pie1:n,pie2:s,pie3:l,pie4:d,pie5:"#ff6fa9",pie6:"#2dd4bf",pie7:c,pie8:n,pieStrokeColor:o,pieStrokeWidth:"2px",pieTitleTextSize:"18px",pieSectionTextSize:"13px",pieLegendTextSize:"13px",actorBkg:n,actorBorder:n,actorTextColor:o,signalColor:r,signalTextColor:r,labelBoxBkgColor:a,labelBoxBorderColor:t,labelTextColor:r,loopTextColor:r,noteBkgColor:d,noteBorderColor:d,noteTextColor:o,stateBkg:a,altBackground:o,attributeBackgroundColorOdd:a,attributeBackgroundColorEven:o,rowOdd:a,rowEven:o,gridColor:t,sectionBkgColor:a,sectionBkgColor2:o,taskBkgColor:s,taskTextColor:r,taskTextDarkColor:r,taskTextLightColor:r,taskTextOutsideColor:r,activeTaskBkgColor:n,activeTaskBorderColor:n,doneTaskBkgColor:i,doneTaskBorderColor:i,critBkgColor:c,critBorderColor:c}}),eG=!0}console.debug("[MermaidBlock] calling mermaid.render");let{svg:r}=await e.render(`mermaid-${"u">typeof crypto&&"function"==typeof crypto.randomUUID?crypto.randomUUID().replace(/-/g,"").slice(0,8):Math.random().toString(36).slice(2,10).padEnd(8,"0")}`,t);if(clearTimeout(i),console.debug("[MermaidBlock] render returned",{length:r?.length??0}),o)return;let l=/aria-roledescription="error"/i.test(r)||/class="error-(?:icon|text)"/i.test(r)||/>Syntax error in text</i.test(r);if(!r||l)return void n(!0);a(r)}catch(e){clearTimeout(i),console.error("[MermaidBlock] render failed",e),o||n(!0)}})(),()=>{o=!0,clearTimeout(i)}},[e]),i)?(0,t.jsx)(eN,{children:e.trim()}):o?(0,t.jsx)(eI,{dangerouslySetInnerHTML:{__html:o}}):(0,t.jsx)(eI,{children:(0,t.jsx)(eD,{"aria-hidden":!0})})}let eY=["#388bfd","#3fb950","#d29922","#a371f7","#f87171","#22d3ee","#fb923c","#34d399","#f472b6","#818cf8"],eO=s().div`
  background: ${n.w4.colors.codeBg};
  border: 1px solid ${n.w4.colors.codeBorder};
  border-radius: ${n.w4.borderRadius.md};
  padding: ${n.w4.spacing.lg};
...
`,ou=s().span`
  font-size: ${n.w4.typography.fontSizeBase};
  color: ${n.w4.colors.mainTextMuted};
`;function ob({code:e}){let o=e.split("\n").map(e=>e.trim()).filter(e=>e&&e.includes("|")).map(e=>{let[o,a]=e.split("|").map(e=>e.trim());return{en:o??"",pt:a??""}}).filter(e=>e.en&&e.pt),a=(0,r.useRef)(null),i=(0,r.useRef)(!1),n=(0,r.useCallback)(e=>{a.current={x:e.touches[0].clientX,y:e.touches[0].clientY}},[]),l=(0,r.useCallback)((e,o)=>t=>{if(!a.current)return;let r=Math.abs(t.changedTouches[0].clientX-a.current.x),n=Math.abs(t.changedTouches[0].clientY-a.current.y);a.current=null,r>8||n>8||(i.current=!0,on(e,o))},[]),s=(0,r.useCallback)((e,o)=>()=>{if(i.current){i.current=!1;return}on(e,o)},[]);return o.length?(0,t.jsxs)(os,{children:[(0,t.jsxs)(od,{children:[(0,t.jsx)($,{name:"volume-2",size:12}),"Words to Listen / Palavras para Ouvir"]}),(0,t.jsx)(oc,{children:o.map(e=>(0,t.jsxs)(op,{children:[(0,t.jsxs)(oh,{accentColor:"#58a6ff",onTouchStart:n,onTouchEnd:l(e.en,"en"),onClick:s(e.en,"en"),title:`Listen: ${e.en}`,children:[(0,t.jsx)(of,{accentColor:"#58a6ff",children:(0,t.jsx)($,{name:"volume-2",size:16})}),(0,t.jsx)(ox,{children:e.en})]}),(0,t.jsxs)(om,{accentColor:"#3fb950",onTouchStart:n,onTouchEnd:l(e.pt,"pt"),onClick:s(e.pt,"pt"),title:`Ouvir: ${e.pt}`,children:[(0,t.jsx)(of,{accentColor:"#3fb950",children:(0,t.jsx)($,{name:"volume-2",size:16})}),(0,t.jsx)(ou,{children:e.pt})]})]},e.en))})]}):null}var oy=a(7223),ow=a(1426);let o$=s().div`
  margin: ${n.w4.spacing.lg} 0;
  border-radius: ${n.w4.borderRadius.md};
  border: 1px solid ${n.w4.colors.codeBorder};
  overflow: hidden;
...
`;function oB({type:e,children:o}){let a=oA[e]??oA.NOTE;return(0,t.jsxs)(oT,{bg:a.bg,border:a.border,children:[(0,t.jsxs)(oS,{color:a.color,children:[(0,t.jsx)($,{name:a.icon,size:15,strokeWidth:2}),a.label]}),(0,t.jsx)(oC,{children:o})]})}let oF=s().nav`
  width: 220px;
  min-width: 220px;
...
`;function oP({headings:e,activeId:o}){return e.length<2?null:(0,t.jsxs)(oF,{children:[(0,t.jsx)(oL,{children:"On this page"}),(0,t.jsx)(oH,{children:e.map(e=>(0,t.jsx)("li",{children:(0,t.jsx)(oR,{href:`#${e.id}`,active:o===e.id,level:e.level,onClick:o=>{o.preventDefault(),document.getElementById(e.id)?.scrollIntoView({behavior:"smooth",block:"start"})},children:e.text})},e.id))})]})}function oE(e){return e.toLowerCase().replace(/[*_`[\]()#]/g,"").replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-").trim()}function oV(){return e=>{!function e(o){if("blockquote"===o.type){let e=o.children?.[0];if(e?.type==="paragraph"){let a=e.children?.[0];if(a?.type==="text"){let t=a.value?.match(/^\[!(NOTE|TIP|WARNING|CAUTION|IMPORTANT)\]\s*/i);t&&(a.value=a.value.slice(t[0].length),a.value.trim()||1!==e.children.length||o.children.shift(),o.data=o.data??{},o.data.hName="div",o.data.hProperties={"data-callout":t[1].toUpperCase()})}}}o.children?.forEach(e)}(e)}}let oI=s().div`
  display: flex;
  align-items: flex-start;
  max-width: 1200px;
  margin: 0 auto;
...
`,oO=s().div`
  ...
  font-family: ${n.w4.typography.fontFamily};
`;function o_(e){return function({children:o,...a}){let i=`h${e}`,n=function e(o){return r.Children.toArray(o).map(o=>"string"==typeof o?o:"number"==typeof o?String(o):(0,r.isValidElement)(o)?e(o.props.children??""):"").join("")}(o),l=oE(n);return(0,t.jsxs)(i,{id:l,...a,children:[o,(0,t.jsx)("a",{className:"heading-anchor",href:`#${l}`,"aria-label":`Link to "${n}"`,children:(0,t.jsx)($,{name:"link",size:14})})]})}}function oU({file:e,prevEntry:o,nextEntry:i,onNavigate:n}){let[l,s]=(0,r.useState)(null),[d,c]=(0,r.useState)(null),p=(0,r.useRef)(null);if((0,r.useEffect)(()=>{s(null),fetch(`${a.p}content/${e}`).then(e=>{if(!e.ok)throw Error(`${e.status} ${e.statusText}`);return e.text()}).then(s).catch(o=>s(`> **Error loading \`${e}\`:** ${o.message}`))},[e]),(0,r.useEffect)(()=>{if(!l||!p.current)return;let e=p.current,o=Array.from(e.querySelectorAll("h2[id], h3[id]"));if(!o.length)return;let a=e.parentElement;for(;a;){let{overflowY:e}=getComputedStyle(a);if(("auto"===e||"scroll"===e)&&a.scrollHeight>a.clientHeight)break;a=a.parentElement}let t=a??window,r=()=>{let e=o[0].id;for(let a of o)if(a.getBoundingClientRect().top-120<=0)e=a.id;else break;c(e)};return r(),t.addEventListener("scroll",r,{passive:!0}),window.addEventListener("resize",r),()=>{t.removeEventListener("scroll",r),window.removeEventListener("resize",r)}},[l]),null===l)return(0,t.jsx)(oO,{children:"Loading…"});let g=function(e){let o,a=[],t=/^(#{2,3})\s+(.+)$/gm;for(;null!==(o=t.exec(e));){let e=o[1].length,t=o[2].trim().replace(/\*\*(.+?)\*\*/g,"$1").replace(/\*(.+?)\*/g,"$1").replace(/`(.+?)`/g,"$1").replace(/\[(.+?)\]\(.+?\)/g,"$1");a.push({level:e,text:t,id:oE(t)})}return a}(l),h=o||i;return(0,t.jsxs)(oI,{children:[(0,t.jsxs)(oD,{children:[(0,t.jsx)(oN,{ref:p,children:(0,t.jsx)(eC.oz,{remarkPlugins:[eB.A,eH.A,oV],rehypePlugins:[eF.A,eL.A],components:{div({node:e,children:o,...a}){let r=a["data-callout"];return r?(0,t.jsx)(oB,{type:r,children:o}):(0,t.jsx)("div",{...a,children:o})},h1:o_(1),h2:o_(2),h3:o_(3),h4:o_(4),pre:({children:e})=>(0,t.jsx)(t.Fragment,{children:e}),code({className:e,children:o}){let a=/language-(\w+)/.exec(e??"")?.[1],r=String(o).replace(/\n$/,"");return"mermaid"===a?(0,t.jsx)(eK,{code:r}):"chart"===a?(0,t.jsx)(e4,{code:r}):"clock"===a?(0,t.jsx)(ot,{code:r}):"vocabulary"===a?(0,t.jsx)(ob,{code:r}):a||r.includes("\n")?(0,t.jsx)(oj,{lang:a,code:r}):(0,t.jsx)("code",{className:e,children:o})}},children:l})}),h&&(0,t.jsxs)(oG,{children:[o?(0,t.jsxs)(oW,{align:"left",onClick:()=>n?.(o),children:[(0,t.jsxs)(oK,{children:[(0,t.jsx)($,{name:"chevron-left",size:13})," Previous"]}),(0,t.jsx)(oY,{children:o.name})]}):(0,t.jsx)("div",{style:{flex:1}}),i?(0,t.jsxs)(oW,{align:"right",onClick:()=>n?.(i),children:[(0,t.jsxs)(oK,{children:["Next ",(0,t.jsx)($,{name:"chevron-right",size:13})]}),(0,t.jsx)(oY,{children:i.name})]}):(0,t.jsx)("div",{style:{flex:1}})]})]}),(0,t.jsx)(oP,{headings:g,activeId:d})]})}function oq(e,o){for(let a of e){if(a.id===o)return a;if(a.children){let e=oq(a.children,o);if(e)return e}}}function oJ(e){return e.flatMap(e=>e.children?oJ(e.children):e.file?[e]:[])}let oZ=s().div`
  display: flex;
  align-items: center;
  justify-content: center;
  height: 100%;
...
`,o5={en:"Browse the sidebar",pt:"Explora o menu lateral"};function o3({title:e,sub:o,lang:a}){return(0,t.jsxs)(oZ,{children:[(0,t.jsx)(oQ,{}),(0,t.jsx)(oX,{size:500,x:10,y:-10,hue:210,dur:7}),(0,t.jsx)(oX,{size:400,x:60,y:50,hue:270,dur:9}),(0,t.jsx)(oX,{size:300,x:30,y:70,hue:190,dur:6}),(0,t.jsxs)(o1,{children:[(0,t.jsx)(o0,{children:e}),(0,t.jsx)(o2,{children:o}),(0,t.jsxs)(o4,{children:[(0,t.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round",children:(0,t.jsx)("polyline",{points:"15 18 9 12 15 6"})}),o5[a]??o5.en]})]})]})}function o6(e,o,a){return"string"==typeof e?e:e[o]??e[a]??Object.values(e)[0]??""}function o8({navigation:e,languages:o,defaultLang:a,locale:i,hashPrefix:n,topBarRight:l,welcomeTitle:s="Blog",welcomeSub:d="Notes, guides, and references — pick a topic from the sidebar to get started."}){let c=o?Object.keys(o):[];c.length;let[p,g]=(0,r.useState)(()=>a??c[0]??"");(0,r.useEffect)(()=>{i&&c.includes(i)&&i!==p&&g(i)},[i]);let h=(0,r.useMemo)(()=>o&&p?o[p].navigation:e??{entries:[]},[o,e,p]);(0,r.useMemo)(()=>oJ(h.entries),[h]);let m=(0,r.useCallback)(e=>{let o=e.match(RegExp(`^#\\/${n}\\/(.+)$`));if(o)return oq(h.entries,o[1])},[h,n]),[f,x]=(0,r.useState)(()=>m(window.location.hash)??null);(0,r.useEffect)(()=>{f&&x(oq(h.entries,f.id)??null)},[p,h]),(0,r.useEffect)(()=>{let e=()=>{let e=m(window.location.hash);e&&x(e)};return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[m]);let u=(0,r.useCallback)(e=>{e.file&&(x(e),window.location.hash=`#/${n}/${e.id}`)},[n]),b=(0,r.useMemo)(()=>oJ(h.entries),[h]),y=b.findIndex(e=>e.id===f?.id),w=y>0?b[y-1]:null,$=y<b.length-1?b[y+1]:null,v=f?.label??f?.name??n,z=o6(s,p,a??c[0]??""),M=o6(d,p,a??c[0]??"");return(0,t.jsx)(ea,{title:v,activeId:f?.id??null,topBarRight:l,sidebar:(0,t.jsx)(eS,{config:h,activeId:f?.id??null,onSelect:u,hashPrefix:n}),children:f?.file?(0,t.jsx)(oU,{file:f.file,prevEntry:w,nextEntry:$,onNavigate:u}):(0,t.jsx)(o3,{title:z,sub:M,lang:p})})}s().div`
  display: flex;
  gap: 4px;
  background: ${n.w4.colors.surface};
  border: 1px solid ${n.w4.colors.border};
