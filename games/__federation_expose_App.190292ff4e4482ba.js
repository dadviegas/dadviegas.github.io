...
`,X=r().div`
  ...
  align-items: center;
  gap: ${l.w4.spacing.sm};
`,H=[{x:3,y:5,size:1.5,delay:0,dur:3.2},{x:8,y:35,size:2,delay:1.8,dur:3.4},{x:12,y:70,size:1.5,delay:.6,dur:4.1},{x:18,y:15,size:2.5,delay:2.4,dur:3},{x:22,y:55,size:1.5,delay:.3,dur:4.5},{x:28,y:88,size:2,delay:1.1,dur:3.6},{x:33,y:25,size:1.5,delay:2.8,dur:4},{x:40,y:60,size:2,delay:.9,dur:3.3},{x:45,y:8,size:2.5,delay:1.5,dur:3.8},{x:50,y:45,size:1.5,delay:2.1,dur:4.3},{x:55,y:78,size:2,delay:.4,dur:3.1},{x:60,y:18,size:1.5,delay:1.7,dur:4.6},{x:65,y:50,size:2.5,delay:2.6,dur:3.5},{x:70,y:85,size:1.5,delay:.2,dur:3.9},{x:75,y:30,size:2,delay:1.3,dur:4.2},{x:80,y:65,size:1.5,delay:2.9,dur:3.7},{x:85,y:10,size:2,delay:.7,dur:3.4},{x:88,y:42,size:2.5,delay:1.9,dur:4.4},{x:92,y:75,size:1.5,delay:.5,dur:3.2},{x:96,y:22,size:2,delay:2.3,dur:3.8}];function Y({topBarRight:e,isAuthenticated:a=!1}){let[t,n]=(0,i.useState)(C),[r,s]=(0,i.useState)("all"),[l]=(0,p.Ym)(),E="pt"===l?"pt":"en";if((0,i.useEffect)(()=>{document.activeElement?.blur()},[t]),(0,i.useEffect)(()=>{let e=()=>n(C());return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[]),!t)return(0,o.jsx)(c.PE,{title:"pt"===E?"Jogos":"Games",sidebar:null,topBarRight:e,children:(0,o.jsxs)(G,{children:[H.map((e,a)=>(0,o.jsx)(q,{x:e.x,y:e.y,size:e.size,delay:e.delay,dur:e.dur},a)),(0,o.jsx)(D,{top:15,delay:12}),(0,o.jsx)(D,{top:55,delay:25}),(0,o.jsx)(J,{children:"pt"===E?"Vamos jogar!":"Let’s play!"}),(0,o.jsx)(A,{children:"pt"===E?"Escolhe um jogo para come\xe7ar":"Pick a game to get started"}),(0,o.jsxs)(I,{children:[(0,o.jsxs)(Q,{active:"all"===r,onClick:()=>s("all"),children:["\uD83C\uDFAE ","pt"===E?"Todos":"All"]}),(0,o.jsx)(Q,{active:"online"===r,chipColor:"#3fb950",onClick:()=>s("online"),children:"\uD83C\uDF10 Online"}),(0,o.jsxs)(Q,{active:"multiplayer"===r,chipColor:"#d2a8ff",onClick:()=>s("multiplayer"),children:["\uD83D\uDC65 3+ ","pt"===E?"Jogadores":"Players"]}),(0,o.jsxs)(Q,{active:"solo"===r,chipColor:"#f59e0b",onClick:()=>s("solo"),children:["\uD83C\uDFAF ","pt"===E?"Sozinho":"Solo"]})]}),(0,o.jsx)(F,{children:L.filter(e=>"online"===r?e.online:"multiplayer"===r?e.maxPlayers>=3:"solo"!==r||1===e.maxPlayers).map((e,t)=>{let i=1===e.maxPlayers?"pt"===E?"JOGO \xb7 SOLO":"GAME \xb7 SOLO":2===e.maxPlayers?"pt"===E?"JOGO \xb7 2P":"GAME \xb7 2P":"pt"===E?`JOGO \xb7 2-${e.maxPlayers}P`:`GAME \xb7 2-${e.maxPlayers}P`,r=e.maxPlayers>1?2===e.maxPlayers?"2":`2-${e.maxPlayers}`:void 0,s=N[e.id]?.[E];return(0,o.jsx)(c.Xl,{label:e.label[E],description:e.description[E],iconName:e.iconName,hash:e.hash,category:i,accentColor:e.color,playerCount:r,online:a&&e.online,onlineLabel:"ONLINE",vizId:e.id,vizLabel:s,heroId:e.id,heroLabel:e.heroLabel?.[E],index:t,onClick:()=>{n(e.id),window.location.hash=e.hash,d.recents.record("games",{hash:e.hash,label:e.label[E]??e.label.en,iconName:e.iconName,color:e.color})}},e.id)})})]})});let T=(0,o.jsxs)(X,{children:[(0,o.jsxs)(R,{onClick:()=>{n(null),window.location.hash="#/games"},children:["←",(0,o.jsxs)("span",{className:"back-label",children:[" ","pt"===E?"Jogos":"Games"]})]}),e]}),M=L.find(e=>e.id===t),W=()=>{n(null),window.location.hash="#/games"};if("lebem"===t)return(0,o.jsx)(c.PE,{title:"L\xeaBem",sidebar:null,topBarRight:T,children:(0,o.jsx)(m.f,{onBack:W})});let Z={tictactoe:(0,o.jsx)(h.t,{lang:E,onBack:W,canOnline:a}),soundhunter:(0,o.jsx)(u.m,{lang:E,onBack:W}),familyquiz:(0,o.jsx)(x.i,{lang:E,onBack:W,canOnline:a}),adventure:(0,o.jsx)(y.a,{lang:E,onBack:W}),pixelboard:(0,o.jsx)(b.H,{lang:E,onBack:W}),stopgame:(0,o.jsx)(g.z,{lang:E,onBack:W,canOnline:a}),spotit:(0,o.jsx)(f.O,{lang:E,onBack:W,canOnline:a}),memory:(0,o.jsx)(w.Y,{lang:E,onBack:W,canOnline:a}),tapit:(0,o.jsx)(k.n,{lang:E,onBack:W,canOnline:a}),jumpparty:(0,o.jsx)(j.v,{lang:E,onBack:W}),drawguess:(0,o.jsx)(z.c,{lang:E,onBack:W,canOnline:a}),animalarena:(0,o.jsx)(v.m,{lang:E,onBack:W}),crazykitchen:(0,o.jsx)(P.A,{lang:E,onBack:W}),miniparty:(0,o.jsx)($.k,{lang:E,onBack:W}),hideseek:(0,o.jsx)(B.p,{lang:E,onBack:W}),buttonmayhem:(0,o.jsx)(O.M,{lang:E,onBack:W}),bombbrawl:(0,o.jsx)(S.$,{lang:E,onBack:W,canOnline:a})};return(0,o.jsx)(c.PE,{title:M.title[E],sidebar:null,topBarRight:T,children:Z[t]})}}}]);