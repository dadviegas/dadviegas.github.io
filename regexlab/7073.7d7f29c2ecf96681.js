...
`,J=s().div`
  ...
  color: ${t.w4.colors.sidebarTextMuted};
  font-family: ${t.w4.typography.fontFamily};
`;function U({onSave:o,onUpdate:e,onCancel:a,existingDoc:t}){let[i,l]=(0,n.useState)(t?.name??""),s=(0,n.useRef)(null);return(0,n.useEffect)(()=>{s.current?.focus(),t&&s.current?.select()},[t]),(0,r.jsx)(K,{onClick:a,children:(0,r.jsxs)(N,{onClick:o=>o.stopPropagation(),children:[(0,r.jsx)(G,{children:"Save document"}),t&&e&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(J,{children:"Update the current version or save as a new one."}),(0,r.jsxs)(Y,{children:[(0,r.jsx)(_,{onClick:a,children:"Cancel"}),(0,r.jsxs)(_,{danger:!0,onClick:e,children:['Update "',t.name,'"']})]}),(0,r.jsx)(O,{})]}),(0,r.jsx)(V,{ref:s,value:i,onChange:o=>l(o.target.value),onKeyDown:r=>{"Enter"===r.key&&i.trim()&&(t&&i.trim()===t.name&&e?e():o(i.trim())),"Escape"===r.key&&a()},placeholder:t?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,r.jsxs)(Y,{children:[!t&&(0,r.jsx)(_,{onClick:a,children:"Cancel"}),(0,r.jsx)(_,{primary:!0,disabled:!i.trim(),onClick:()=>o(i.trim()),children:"Save as new"})]})]})})}var W=a(5625),Z=a(679),q=a(4872);let X=s().div`
  position: relative;
`,Q=s().button`
  display: flex;
  align-items: center;
