"use strict";(self.webpackChunk_atlantis_colorlab=self.webpackChunk_atlantis_colorlab||[]).push([[440],{4914(a,o,n){n.d(o,{FlyoutPanel:()=>y});var e=n(7359),i=n(3233),t=n(7207),l=n(255),r=n(217),m=n(5959),c=n(5185),g=n(5723);const d=t.keyframes`
...
`;function z({iconKey:a}){const o=a?c.t[a]??l.A:l.A;return(0,g.jsx)(o,{size:14,strokeWidth:1.75})}function p({entries:a,activeId:o,onSelect:n}){return(0,g.jsx)(g.Fragment,{children:a.map(a=>a.children?(0,g.jsx)(e.Fragment,{children:(0,g.jsx)(p,{entries:a.children,activeId:o,onSelect:n})},a.id):(0,g.jsxs)(f,{active:o===a.id,onClick:()=>n(a),children:[(0,g.jsx)(z,{iconKey:a.icon}),a.name]},a.id))})}function y({activeId:a}){const{flyout:o,scheduleFlyoutClose:n,cancelFlyoutClose:e}=(0,m.c)();if(!o)return null;const i=o.entry.icon?c.t[o.entry.icon]??l.A:l.A;return(0,g.jsxs)(s,{anchorY:o.anchorY,onMouseEnter:e,onMouseLeave:n,children:[(0,g.jsxs)(u,{children:[(0,g.jsx)(i,{size:13,strokeWidth:2}),o.entry.name]}),(0,g.jsx)(p,{entries:o.entry.children??[],activeId:a,onSelect:a=>{o.onSelect(a),n()}})]})}},5959(a,o,n){n.d(o,{c:()=>t});var e=n(7359);const i=(0,e.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),t=()=>(0,e.useContext)(i)},5185(a,o,n){n.d(o,{t:()=>V});var e=n(9510),i=n(9038),t=n(8207),l=n(6896),r=n(7901),m=n(9848),c=n(2164),g=n(3775),d=n(3539),s=n(1783),u=n(1837),f=n(2314),z=n(5751),p=n(255),y=n(9633),b=n(2946),h=n(822),A=n(6720),x=n(3317),w=n(2709),k=n(3517),v=n(7032),M=n(6949),S=n(8218),$=n(6829),B=n(5553),E=n(9591),P=n(2820),T=n(4621),j=n(6673),C=n(9033),L=n(1365),K=n(5912),N=n(8641),D=n(3249),R=n(1821),F=n(9161),G=n(1849),I=n(7747),H=n(2932),_=n(4525),Y=n(7230);const V={activity:l.A,"bar-chart-2":e.A,book:m.A,"book-open":r.A,calendar:g.A,clock:s.A,"circle-dot":d.A,feather:f.A,"file-text":z.A,globe:A.A,hash:x.A,heart:w.A,landmark:k.A,layers:t.A,leaf:M.A,map:E.A,package:j.A,compass:u.A,"git-branch":b.A,github:h.A,minus:T.A,terminal:D.A,thermometer:R.A,users:G.A,wind:I.A,"pie-chart":i.A,plus:L.A,slash:K.A,star:N.A,zap:Y.A,bot:c.A,lightbulb:S.A,"message-square":P.A,wrench:H.A,x:_.A,"layout-grid":v.A,list:$.A,file:p.A,folder:y.A,"map-pin":B.A,"pen-tool":C.A,type:F.A}},906(a,o,n){n.d(o,{w4:()=>e.w});var e=n(217),i=(n(7359),n(3233));n(5723),i.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,i.default.button`
  ...
  background: ${({active:a})=>a?e.w.colors.sidebarActiveBg:"transparent"};
  border: none;
  color: ${({active:a})=>a?e.w.colors.accent:e.w.colors.mainText};
  font-family: ${e.w.typography.fontFamily};
  font-size: ${e.w.typography.fontSizeSm};
...
`,i.default.span`
  ...
  height: 6px;
  border-radius: 50%;
  background: ${({active:a})=>a?e.w.colors.accent:e.w.colors.sidebarTextMuted};
  margin-right: 6px;
  flex-shrink: 0;
`,n(5959);const t="260px",l="56px";i.default.header`
  display: flex;
  align-items: center;
  height: ${"48px"};
...
`,i.default.div`
  ...
  overflow: hidden;
`,i.default.aside`
  width: ${({collapsed:a})=>a?l:t};
  min-width: ${({collapsed:a})=>a?l:t};
  background: ${e.w.colors.sidebarBg};
  border-right: 1px solid ${e.w.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,i.default.button`
  ...
  align-items: center;
  width: 100%;
  padding: ${({collapsed:a})=>a?"10px 0":`${e.w.spacing.sm} ${e.w.spacing.md}`};
  ...
  gap: ${({collapsed:a})=>a?"0":e.w.spacing.sm};
  background: none;
  border: none;
  cursor: pointer;
  color: ${e.w.colors.sidebarTextMuted};
...
`,i.default.button`
  ...
  align-items: center;
  width: 100%;
  padding: ${({collapsed:a})=>a?"9px 0":`6px ${e.w.spacing.md}`};
  justify-content: ${({collapsed:a})=>a?"center":"flex-start"};
  gap: ${({collapsed:a})=>a?"0":"8px"};
  background: ${({active:a})=>a?e.w.colors.sidebarActiveBg:"none"};
  border: none;
  border-left: ${({collapsed:a})=>a?"none":"2px"} solid
    ${({active:a})=>a?e.w.colors.sidebarActive:"transparent"};
  cursor: pointer;
  color: ${({active:a})=>a?e.w.colors.sidebarActive:e.w.colors.sidebarText};
  font-size: ${e.w.typography.fontSizeBase};
  font-family: ${e.w.typography.fontFamily};
  text-align: left;
  border-radius: ${({collapsed:a})=>a?"0":`0 ${e.w.borderRadius.sm} ${e.w.borderRadius.sm} 0`};
  transition: background 0.12s, color 0.12s;

  &:hover {
    background: ${e.w.colors.sidebarHover};
  }
`;const r=n(7207).keyframes`
