"use strict";(self.webpackChunk_atlantis_colorlab=self.webpackChunk_atlantis_colorlab||[]).push([[1203],{4914(o,e,a){a.d(e,{FlyoutPanel:()=>b});var t=a(7359),r=a(3233),n=a(7207),i=a(255),l=a(217),d=a(5959),s=a(5185),c=a(5723);const p=n.keyframes`
...
`;function u({iconKey:o}){const e=o?s.t[o]??i.A:i.A;return(0,c.jsx)(e,{size:14,strokeWidth:1.75})}function x({entries:o,activeId:e,onSelect:a}){return(0,c.jsx)(c.Fragment,{children:o.map(o=>o.children?(0,c.jsx)(t.Fragment,{children:(0,c.jsx)(x,{entries:o.children,activeId:e,onSelect:a})},o.id):(0,c.jsxs)(m,{active:e===o.id,onClick:()=>a(o),children:[(0,c.jsx)(u,{iconKey:o.icon}),o.name]},o.id))})}function b({activeId:o}){const{flyout:e,scheduleFlyoutClose:a,cancelFlyoutClose:t}=(0,d.c)();if(!e)return null;const r=e.entry.icon?s.t[e.entry.icon]??i.A:i.A;return(0,c.jsxs)(g,{anchorY:e.anchorY,onMouseEnter:t,onMouseLeave:a,children:[(0,c.jsxs)(f,{children:[(0,c.jsx)(r,{size:13,strokeWidth:2}),e.entry.name]}),(0,c.jsx)(x,{entries:e.entry.children??[],activeId:o,onSelect:o=>{e.onSelect(o),a()}})]})}},5959(o,e,a){a.d(e,{I:()=>r,c:()=>n});var t=a(7359);const r=(0,t.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),n=()=>(0,t.useContext)(r)},5185(o,e,a){a.d(e,{t:()=>wo});var t=a(9510),r=a(9038),n=a(7400),i=a(7561),l=a(8207),d=a(7902),s=a(6896),c=a(3013),p=a(2887),g=a(7901),f=a(9848),m=a(2164),u=a(3045),x=a(3775),b=a(3539),h=a(1783),w=a(9416),y=a(1837),$=a(7167),z=a(4494),v=a(2314),k=a(5751),M=a(255),A=a(9633),T=a(2946),S=a(822),F=a(6720),j=a(8456),B=a(3317),R=a(2709),P=a(9301),C=a(8006),H=a(3517),E=a(7032),L=a(6949),I=a(8218),K=a(6829),D=a(5553),N=a(9591),Y=a(9923),V=a(2820),G=a(4621),_=a(8479),O=a(2534),W=a(6673),J=a(7490),Z=a(9033),U=a(5775),q=a(1365),X=a(2937),Q=a(9821),oo=a(5912),eo=a(158),ao=a(8641),to=a(8607),ro=a(3249),no=a(1821),io=a(5889),lo=a(9655),so=a(7170),co=a(9161),po=a(1849),go=a(1604),fo=a(3142),mo=a(1187),uo=a(7747),xo=a(2932),bo=a(4525),ho=a(7230);const wo={activity:s.A,"a-large-small":d.A,apple:c.A,"arrow-right":p.A,"bar-chart-2":t.A,book:f.A,"book-open":g.A,briefcase:u.A,calendar:x.A,clock:h.A,"circle-dot":b.A,cloud:w.A,compass:y.A,cpu:$.A,droplets:z.A,feather:v.A,file:M.A,"file-text":k.A,folder:A.A,"git-branch":T.A,github:S.A,globe:F.A,grid:n.A,hand:j.A,hash:B.A,heart:R.A,key:C.A,hexagon:P.A,home:i.A,landmark:H.A,layers:l.A,"layout-grid":E.A,leaf:L.A,lightbulb:I.A,list:K.A,map:N.A,"map-pin":D.A,"message-circle":Y.A,"message-square":V.A,minus:G.A,monitor:_.A,mountain:O.A,package:W.A,palette:J.A,"pen-tool":Z.A,"pie-chart":r.A,plane:U.A,plus:q.A,ruler:X.A,shirt:Q.A,slash:oo.A,square:eo.A,star:ao.A,sun:to.A,terminal:ro.A,thermometer:no.A,triangle:io.A,trophy:lo.A,truck:so.A,type:co.A,users:po.A,"volume-2":go.A,watch:fo.A,waves:mo.A,wind:uo.A,wrench:xo.A,x:bo.A,zap:ho.A,bot:m.A}},4901(o,e,a){a.d(e,{PE:()=>S,PL:()=>I,Is:()=>L,w4:()=>t.w4,cL:()=>s.c});var t=a(217),r=a(7359),n=a(3233),i=a(5723);n.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,a(4914);var j=a(1920),B=a(8607),R=a(8479);n.default.button`
  display: flex;
  align-items: center;
  justify-content: center;
  width: 32px;
...
`,r.default.span`
  ...
  background: ${({color:o})=>o};
  display: inline-block;
`;const S={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:n.w4.colors.accentMuted},F={neutral:n.w4.colors.mainTextMuted,live:n.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:n.w4.colors.accent};r.default.span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${n.w4.typography.fontFamilyMono};
...
`,P.A,P.A['pre[class*="language-"]'],n.w4.colors.codeBg,P.A['code[class*="language-"]'];var C=a(5569),H=a(8218),E=a(7230),L=a(2966),I=a(1069);C.A,H.A,E.A,L.A,I.A,r.default.div`
  background: ${({bg:o})=>o};
...
`;function W({activeAppId:o}){const{collapsed:e}=(0,n.cL)(),[a]=function(){const[o,e]=(0,t.useState)(v),a=(0,t.useCallback)(o=>{e(o),function(o){try{localStorage.setItem(y,o)}catch{}(0,n.Is)($,o).catch(()=>{})}(o),window.dispatchEvent(new CustomEvent("atlantis:locale-change",{detail:o}))},[]);return(0,t.useEffect)(()=>{const o=o=>{const a=o.detail;e(a)};return window.addEventListener("atlantis:locale-change",o),()=>window.removeEventListener("atlantis:locale-change",o)},[]),(0,t.useEffect)(()=>{(0,n.PL)($).then(a=>{if(z(a)&&a!==o){try{localStorage.setItem(y,a)}catch{}e(a)}}).catch(()=>{})},[]),[o,a]}(),r=(0,t.useMemo)(()=>function(o){const e=w;return(a,t)=>{const r=e[a]?.[o]??a;return t?Object.entries(t).reduce((o,[e,a])=>o.replace(new RegExp(`\\{${e}\\}`,"g"),String(a)),r):r}}(a),[a]),l=(0,t.useRef)(null),d=o=>{l.current!==o&&(l.current=o,document.activeElement?.blur(),window.location.hash=o,setTimeout(()=>{l.current=null},50))};return(0,i.jsxs)(Y,{children:[(0,i.jsx)(V,{collapsed:e,children:r("devtools.heading")}),N.map(a=>{const t=r(a.labelKey);return(0,i.jsxs)(G,{active:o===a.id,collapsed:e,onPointerDown:o=>{0===o.button&&d(a.hash)},onClick:()=>d(a.hash),title:t,children:[(0,i.jsx)(_,{children:(0,i.jsx)(M,{name:a.icon,size:16})}),(0,i.jsx)(O,{collapsed:e,children:t})]},a.id)})]})}},2139(o,e,a){function t(o){const e=o.replace("#","");return 3===e.length?{r:parseInt(e[0]+e[0],16),g:parseInt(e[1]+e[1],16),b:parseInt(e[2]+e[2],16)}:6===e.length?{r:parseInt(e.slice(0,2),16),g:parseInt(e.slice(2,4),16),b:parseInt(e.slice(4,6),16)}:null}function r(o,e,a){return"#"+[o,e,a].map(o=>Math.round(Math.max(0,Math.min(255,o))).toString(16).padStart(2,"0")).join("")}function n(o,e,a){const t=o/255,r=e/255,n=a/255,i=Math.max(t,r,n),l=Math.min(t,r,n),d=(i+l)/2;if(i===l)return{h:0,s:0,l:Math.round(100*d)};const s=i-l,c=d>.5?s/(2-i-l):s/(i+l);let p=0;return p=i===t?((r-n)/s+(r<n?6:0))/6:i===r?((n-t)/s+2)/6:((t-r)/s+4)/6,{h:Math.round(360*p),s:Math.round(100*c),l:Math.round(100*d)}}function i(o,e,a){const t=e/100,r=a/100,n=(1-Math.abs(2*r-1))*t,i=n*(1-Math.abs(o/60%2-1)),l=r-n/2;let d=0,s=0,c=0;return o<60?(d=n,s=i,c=0):o<120?(d=i,s=n,c=0):o<180?(d=0,s=n,c=i):o<240?(d=0,s=i,c=n):o<300?(d=i,s=0,c=n):(d=n,s=0,c=i),{r:Math.round(255*(d+l)),g:Math.round(255*(s+l)),b:Math.round(255*(c+l))}}function l(o,e,a){const t=o=>{const e=o/255;return e<=.04045?e/12.92:Math.pow((e+.055)/1.055,2.4)};return.2126*t(o)+.7152*t(e)+.0722*t(a)}function d(o,e){const a=l(o.r,o.g,o.b),t=l(e.r,e.g,e.b),r=Math.max(a,t),n=Math.min(a,t);return parseFloat(((r+.05)/(n+.05)).toFixed(2))}function s(o,e){return[10,20,30,40,50,60,70,80,90].map(a=>({h:o,s:Math.min(e,90),l:a}))}function c(o,e,a){return{h:(o+180)%360,s:e,l:a}}function p(o,e,a){return[{h:(o+30)%360,s:e,l:a},{h:(o-30+360)%360,s:e,l:a}]}function g(o,e,a){return[{h:o,s:e,l:a},{h:(o+120)%360,s:e,l:a},{h:(o+240)%360,s:e,l:a}]}a.d(e,{E2:()=>t,Hg:()=>c,K6:()=>n,Lt:()=>g,Ob:()=>r,YL:()=>i,eM:()=>d,iW:()=>s,mW:()=>p})}}]);