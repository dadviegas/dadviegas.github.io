"use strict";(self.webpackChunk_atlantis_techscope=self.webpackChunk_atlantis_techscope||[]).push([["2467"],{5748(e,o,r){r.d(o,{W:()=>oY});var t=r(5723),a=r(9874),i=r(7991),n=r.n(i),s=r(6859),l=r.n(s),d=r(8395),p=r(2695),c=r(9522),g=r(2799),x=r(8170);let f=(0,g.keyframes)`
  0%, 100% { opacity: 1; }
  50% { opacity: 0.3; }
`,h=(0,g.keyframes)`
...
`,I=l().div`
  ...
  font-size: ${a.w4.typography.fontSizeSm};
  text-align: center;
`;function L({t:e}){let{result:o,loading:r,lastUpdated:a,refresh:i}=(0,p.useRepoSearch)({query:`created:>${(0,c.VF)(7)}`,sort:"stars",perPage:8,cacheKey:"techscope-live-pulse"});return(0,t.jsxs)("div",{children:[(0,t.jsx)(M,{title:e("nav.livePulse"),color:z,lastUpdated:a,loading:r,onRefresh:i,t:e}),o?.items?.length?(0,t.jsx)(T,{children:o.items.map(o=>(0,t.jsxs)(S,{href:o.html_url,target:"_blank",rel:"noopener noreferrer",children:[(0,t.jsx)(F,{title:o.full_name,children:o.full_name}),(0,t.jsx)(R,{children:o.description??e("noDescription")}),(0,t.jsxs)(H,{children:[o.language&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(B,{lang:o.language}),(0,t.jsx)(P,{children:o.language})]}),(0,t.jsx)(C,{}),(0,t.jsxs)(A,{children:[(0,t.jsx)(d.In,{name:"star",size:12}),(0,c.Bz)(o.stargazers_count)]})]})]},o.id))}):(0,t.jsx)(I,{children:r?e("livePulse.loading"):e("noData")})]})}let D="#bc8cff",_={TypeScript:"#3178c6",JavaScript:"#f1e05a",Python:"#3572A5",Go:"#00ADD8",Rust:"#dea584",Java:"#b07219","C++":"#f34b7d","C#":"#178600",Ruby:"#701516",Swift:"#F05138",Kotlin:"#A97BFF",Shell:"#89e051",HTML:"#e34c26",CSS:"#563d7c",Dart:"#00B4AB",Zig:"#ec915c",Nix:"#7e7eff",Lua:"#000080"},V=l().div`
  display: grid;
...
`,q=l().a`
  ...
  gap: 10px;
  padding: ${a.w4.spacing.md};
  background: linear-gradient(168deg, ${D}10 0%, ${a.w4.colors.surface} 44%, ${a.w4.colors.surface} 100%);
  ...
  &:hover {
    border-color: ${D}66;
    background: linear-gradient(168deg, ${D}1c 0%, ${a.w4.colors.surfaceRaised} 44%, ${a.w4.colors.surfaceRaised} 100%);
...
`,Z=l().span`
  ...
  height: 10px;
  border-radius: 50%;
  background: ${({lang:e})=>_[e]??a.w4.colors.mainTextMuted};
  flex-shrink: 0;
`,G=l().span`
  font-size: ${a.w4.typography.fontSizeSm};
  color: ${a.w4.colors.mainTextMuted};
...
`,e3=l().div`
  ...
  font-size: ${a.w4.typography.fontSizeSm};
  text-align: center;
`;function e8(){let[e,o]=(0,i.useState)(eO[0]),{results:r,loading:a,lastUpdated:n,refresh:s}=(0,p.useNpmSearch)({query:e.query,size:12,cacheKey:`techscope-packages-${e.id}`}),l=r??[];return(0,t.jsxs)("div",{children:[(0,t.jsx)(M,{title:"Package Radar",color:eK,description:"Trending npm packages ranked by quality, popularity, and maintenance. Filtered by topic.",lastUpdated:n,loading:a,onRefresh:s}),(0,t.jsx)(eW,{children:eO.map(r=>(0,t.jsx)(eE,{active:e.id===r.id,onClick:()=>o(r),children:r.label},r.id))}),l.length?(0,t.jsx)(eX,{children:l.map(({package:e,score:o})=>(0,t.jsxs)(eJ,{href:e.links?.npm??`https://www.npmjs.com/package/${e.name}`,target:"_blank",rel:"noopener noreferrer",children:[(0,t.jsxs)(eU,{title:e.name,children:[(0,t.jsx)(d.In,{name:"package",size:13}),e.name,(0,t.jsxs)(eZ,{children:["v",e.version]})]}),(0,t.jsx)(eG,{children:e.description||"No description."}),e.keywords&&e.keywords.length>0&&(0,t.jsx)(eQ,{children:e.keywords.slice(0,3).map(e=>(0,t.jsx)(e0,{children:e},e))}),(0,t.jsxs)(e1,{children:[(0,t.jsxs)(e5,{children:["@",e.publisher?.username??"unknown"]}),(0,t.jsx)(e4,{value:o.final,title:`Score: ${Math.round(100*o.final)}%`})]}),(0,t.jsxs)(e2,{children:[(0,t.jsxs)("span",{title:"Quality",children:["Q:",Math.round(100*o.detail.quality),"%"]}),(0,t.jsxs)("span",{title:"Popularity",children:["P:",Math.round(100*o.detail.popularity),"%"]}),(0,t.jsxs)("span",{title:"Maintenance",children:["M:",Math.round(100*o.detail.maintenance),"%"]})]})]},e.name))}):(0,t.jsx)(e3,{children:a?"Scanning npm registry...":"No packages found"})]})}let e6="#f97316",e7=["react","typescript","lodash","axios","express","next","vue","vite","tailwindcss","eslint","prettier","webpack"],e9=l().div`
  display: flex;
  flex-direction: column;
  gap: 6px;
`,oe=l().a`
  ...
  border-radius: ${a.w4.borderRadius.sm};
  background: linear-gradient(165deg, ${e6}0a 0%, ${a.w4.colors.surface} 62%, ${a.w4.colors.surface} 100%);
  text-decoration: none;
  transition: background ${a.w4.transitions.base}, border-color ${a.w4.transitions.base}, transform ${a.w4.transitions.base};

  &:hover {
    background: linear-gradient(165deg, ${e6}13 0%, ${a.w4.colors.surfaceRaised} 62%, ${a.w4.colors.surfaceRaised} 100%);
    border-color: ${e6}5a;
    transform: translateX(2px);
  }
...
`,ok=l().div`
  ...
  font-size: ${a.w4.typography.fontSizeSm};
  text-align: center;
`;function oM(){let[e,o]=(0,i.useState)(od[0].id),{articles:r,loading:a,lastUpdated:n,refresh:s}=(0,p.useDevToArticles)({tag:e,top:7,perPage:8,cacheKey:`techscope-tech-articles-${e}`}),l=r??[];return(0,t.jsxs)("div",{children:[(0,t.jsx)(M,{title:"Tech Articles",color:ol,description:"Popular articles from Dev.to across frontend, AI, and systems topics.",lastUpdated:n,loading:a,onRefresh:s}),(0,t.jsx)(oc,{children:od.map(r=>(0,t.jsxs)(og,{active:e===r.id,onClick:()=>o(r.id),children:["#",r.label]},r.id))}),l.length?(0,t.jsx)(op,{children:l.map(e=>{let o=e.tag_list??[];return(0,t.jsxs)(ox,{href:e.url,target:"_blank",rel:"noopener noreferrer",children:[(0,t.jsx)(of,{children:e.title}),e.description&&(0,t.jsx)(oh,{children:e.description}),o.length>0&&(0,t.jsx)(om,{children:o.slice(0,3).map(e=>(0,t.jsxs)(ob,{children:["#",e]},e))}),(0,t.jsxs)(ow,{children:[(0,t.jsxs)(ou,{children:[(0,t.jsx)(d.In,{name:"heart",size:11}),(0,c.aT)(e.public_reactions_count??0)]}),(0,t.jsxs)(oy,{children:[(0,t.jsx)(MessageSquare,{size:11}),e.comments_count??0]}),(0,t.jsxs)(o$,{children:[(0,t.jsx)(d.In,{name:"user",size:10}),e.user?.name??"unknown"]}),(0,t.jsxs)(ov,{children:[(0,t.jsx)(d.In,{name:"book-open",size:11}),e.reading_time_minutes??0,"m"]})]})]},e.id)})}):(0,t.jsx)(ok,{children:a?"Loading articles...":"No articles found"})]})}let oz="#f48024",oj=[{id:"",label:"All"},{id:"javascript",label:"JS"},{id:"typescript",label:"TS"},{id:"python",label:"Python"},{id:"react",label:"React"}],oT=l().div`
  display: flex;
  gap: 6px;
  margin-bottom: ${a.w4.spacing.lg};
  flex-wrap: wrap;
...
`,oV=l().div`
  ...
  font-size: ${a.w4.typography.fontSizeSm};
  text-align: center;
`;function oq(){let[e,o]=(0,i.useState)(""),{questions:r,loading:a,lastUpdated:n,refresh:s}=(0,p.useStackExchangeHot)({tagged:e||void 0,pageSize:10,sort:"hot",order:"desc",cacheKey:`techscope-dev-pulse-${e||"all"}`}),l=r??[];return(0,t.jsxs)("div",{children:[(0,t.jsx)(M,{title:"Dev Pulse",color:oz,description:"Hot questions from Stack Overflow sorted by activity, filterable by language or framework.",lastUpdated:n,loading:a,onRefresh:s}),(0,t.jsx)(oT,{children:oj.map(r=>(0,t.jsx)(oS,{active:e===r.id,onClick:()=>o(r.id),children:r.label},r.id))}),l.length?(0,t.jsx)(oF,{children:l.map(e=>{let o=e.creation_date?new Date(1e3*e.creation_date).toISOString():"",r=e.is_answered??!1;return(0,t.jsxs)(oR,{href:e.link,target:"_blank",rel:"noopener noreferrer",children:[(0,t.jsx)(oH,{answered:r,children:r?"✓":"?"}),(0,t.jsxs)(oA,{children:[(0,t.jsx)(oB,{children:(0,c.iT)(e.title)}),(0,t.jsxs)(oP,{children:[(0,t.jsxs)(oC,{negative:e.score<0,children:[e.score>0?"+":"",(0,c.aT)(e.score)," votes"]}),(0,t.jsxs)("span",{children:[e.answer_count??0," ans"]}),(0,t.jsxs)(oI,{children:[(0,t.jsx)(d.In,{name:"eye",size:10}),(0,c.aT)(e.view_count??0)]}),(0,t.jsx)(oL,{children:(e.tags??[]).slice(0,3).map(e=>(0,t.jsx)(oD,{children:e},e))}),(0,t.jsx)(o_,{children:o?(0,c.fF)(o):""})]})]})]},e.question_id)})}):(0,t.jsx)(oV,{children:a?"Fetching hot questions...":"No questions found"})]})}function oY({category:e,t:o}){return(0,t.jsxs)(a.wi,{children:["github"===e&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(a.KW,{id:"live-pulse",children:(0,t.jsx)(a.PH,{children:(0,t.jsx)(L,{t:o})})}),(0,t.jsx)(a.KW,{id:"experiment-zone",children:(0,t.jsx)(a.PH,{children:(0,t.jsx)(eo,{t:o})})})]}),"hackernews"===e&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsxs)(a.pB,{children:[(0,t.jsx)(a.KW,{id:"today-in-tech",children:(0,t.jsx)(a.PH,{style:{height:"100%"},children:(0,t.jsx)(ef,{t:o})})}),(0,t.jsx)(a.KW,{id:"ai-radar",children:(0,t.jsx)(a.PH,{style:{height:"100%"},children:(0,t.jsx)(ej,{t:o})})})]}),(0,t.jsx)(a.KW,{id:"community-feed",children:(0,t.jsx)(a.PH,{children:(0,t.jsx)(eN,{})})})]}),"packages"===e&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(a.KW,{id:"package-radar",children:(0,t.jsx)(a.PH,{children:(0,t.jsx)(e8,{})})}),(0,t.jsx)(a.KW,{id:"npm-trends",children:(0,t.jsx)(a.PH,{children:(0,t.jsx)(os,{t:o})})})]}),"devcommunity"===e&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(a.KW,{id:"tech-articles",children:(0,t.jsx)(a.PH,{children:(0,t.jsx)(oM,{})})}),(0,t.jsx)(a.KW,{id:"dev-pulse",children:(0,t.jsx)(a.PH,{children:(0,t.jsx)(oq,{})})})]})]})}},8108(e,o,r){r.d(o,{A:()=>es});var t=r(5723),a=r(7991),i=r(6859),n=r.n(i),s=r(2799),l=r(8395),d=r(9874),p=r(2695),c=r(9522);let g=(0,s.keyframes)`
