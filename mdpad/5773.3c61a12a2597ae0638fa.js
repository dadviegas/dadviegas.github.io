...
`;function z({onSave:a,onCancel:n}){const[e,o]=(0,i.useState)(""),t=(0,i.useRef)(null);return(0,i.useEffect)(()=>{t.current?.focus()},[]),(0,r.jsx)(p,{onClick:n,children:(0,r.jsxs)(f,{onClick:a=>a.stopPropagation(),children:[(0,r.jsx)(b,{children:"Save document"}),(0,r.jsx)(y,{ref:t,value:e,onChange:a=>o(a.target.value),onKeyDown:o=>{"Enter"===o.key&&e.trim()&&a(e.trim()),"Escape"===o.key&&n()},placeholder:"Give this version a name…",maxLength:80}),(0,r.jsxs)(h,{children:[(0,r.jsx)(x,{onClick:n,children:"Cancel"}),(0,r.jsx)(x,{primary:!0,disabled:!e.trim(),onClick:()=>a(e.trim()),children:"Save"})]})]})})}var w=e(18006),$=e(70679),A=e(54872);const v=t.default.div`
  position: relative;
`,k=t.default.button`
  display: flex;
  align-items: center;
...
//# sourceMappingURL=5773.3c61a12a2597ae0638fa.js.map