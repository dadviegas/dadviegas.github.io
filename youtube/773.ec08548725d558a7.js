...
`},8395(o,e,r){r.d(e,{In:()=>w});var t=r(5723);r(7991);var a=r(6859),i=r.n(a),n=r(9874);let l={ghost:"transparent",accent:"transparent",primary:n.w4.colors.accent,success:"#238636",danger:"#da3633"},d={ghost:n.w4.colors.sidebarHover,accent:"rgba(88,166,255,0.10)",primary:n.w4.colors.accentHover,success:"#2ea043",danger:"#f85149"},p={ghost:n.w4.colors.border,accent:n.w4.colors.accent,primary:n.w4.colors.accent,success:"#238636",danger:"#da3633"},s={ghost:n.w4.colors.mainTextMuted,accent:n.w4.colors.accent,primary:"#fff",success:"#fff",danger:"#fff"},c={ghost:n.w4.colors.mainText,accent:n.w4.colors.accent,primary:"#fff",success:"#fff",danger:"#fff"},g={sm:"28px",md:"30px"},x={sm:"0 10px",md:"0 12px"},f={sm:"12px",md:"12px"};i().button`
  ...
  &:hover:not(:disabled) {
    ...
    color: ${({variant:o})=>c[o]};
    border-color: ${({variant:o})=>"ghost"===o?n.w4.colors.accent:p[o]};
  }
