...
`;function J({title:e,sections:a,topBarRight:o,children:n}){let[r,l]=(0,i.useState)(null),s=(0,i.useCallback)(e=>{l(e.id),document.getElementById(e.id)?.scrollIntoView({behavior:"smooth",block:"start"})},[]),c=(0,t.jsx)(W,{entries:a,activeId:r,onSelect:s});return(0,t.jsx)(E,{title:e,sidebar:c,activeId:r,topBarRight:o,children:n})}s().div`
  position: fixed;
  inset: 0;
