"use strict";(self.webpackChunk_atlantis_movies=self.webpackChunk_atlantis_movies||[]).push([["268"],{7613(e,o,a){a.d(o,{H:()=>b});var t=a(5723),n=a(7991),r=a(6859),i=a.n(r),l=a(9336);let s=i().div`
  display: flex;
...
`,h=i().p`
  ...
  text-align: center;
  margin: 0;
`;function b({onSave:e}){let[o,a]=(0,n.useState)(""),[r,i]=(0,n.useState)(!1),[l,y]=(0,n.useState)(""),w=async()=>{let a=o.trim();if(a){i(!0),y("");try{if(!(await fetch(`https://api.themoviedb.org/3/configuration?api_key=${a}`)).ok)throw Error("Invalid key");e(a)}catch{y("Could not validate API key. Check it and try again.")}finally{i(!1)}}};return(0,t.jsx)(s,{children:(0,t.jsxs)(c,{children:[(0,t.jsx)(d,{children:"\uD83C\uDFAC"}),(0,t.jsx)(m,{children:"Movies & Series"}),(0,t.jsxs)(p,{children:["This app uses the free"," ",(0,t.jsx)(g,{href:"https://www.themoviedb.org/settings/api",target:"_blank",rel:"noreferrer",children:"TMDB API"})," ","to browse movies, TV shows, and documentaries — including where to stream them.",(0,t.jsx)("br",{}),(0,t.jsx)("br",{}),"Create a free account on TMDB and paste your ",(0,t.jsx)("strong",{children:"API Key (v3)"})," below."]}),(0,t.jsxs)("div",{style:{display:"flex",flexDirection:"column",gap:8},children:[(0,t.jsx)(u,{htmlFor:"apikey",children:"TMDB API Key (v3)"}),(0,t.jsx)(f,{id:"apikey",type:"password",placeholder:"e.g. a1b2c3d4e5f6...",value:o,onChange:e=>a(e.target.value),onKeyDown:e=>"Enter"===e.key&&w(),autoFocus:!0})]}),l&&(0,t.jsx)(h,{children:l}),(0,t.jsx)(x,{onClick:w,disabled:!o.trim()||r,children:r?"Validating…":"Connect"})]})})}},6250(e,o,a){a.d(o,{U:()=>q});var t=a(5723),n=a(7991),r=a(6859),i=a.n(r),l=a(9336),s=a(302),c=a(9753),d=a(2727),m=a.n(d),p=a(2799),g=a(8641),u=a(5569),f=a(140),x=a(1801);let h=i().div`
  position: relative;
  width: 150px;
  flex-shrink: 0;
  cursor: pointer;
...
`;function N({item:e,rect:o,onOpen:a,onMouseEnter:n,onMouseLeave:r,withBackdrop:i,onBackdropTap:l}){let s=function(e){let o=window.innerWidth,a=window.innerHeight;if(o<500){let t=Math.max(8,(o-300)/2);return{top:Math.max(8,Math.min(e.bottom+8,a-310-8)),left:t}}let t=e.right+10;t+300>o-8&&(t=e.left-300-10),t=Math.max(8,Math.min(t,o-300-8));let n=e.top+e.height/2-155;return{top:n=Math.max(8,Math.min(n,a-310-8)),left:t}}(o),c=(0,x.rS)(e),d=(0,x.Ox)(e),p=(0,x.U7)(e.backdrop_path,"w780");return m().createPortal((0,t.jsxs)(t.Fragment,{children:[i&&(0,t.jsx)("div",{style:{position:"fixed",inset:0,zIndex:9998},onClick:l}),(0,t.jsxs)(T,{top:s.top,left:s.left,onMouseEnter:n,onMouseLeave:r,onClick:a,style:{cursor:"pointer"},children:[p?(0,t.jsx)(_,{src:p}):(0,t.jsx)(C,{}),(0,t.jsxs)(B,{children:[(0,t.jsx)(E,{children:c}),(0,t.jsxs)(P,{children:[(0,t.jsxs)(R,{children:[(0,t.jsx)(g.A,{size:11,fill:"currentColor"}),e.vote_average.toFixed(1)]}),d&&(0,t.jsx)(F,{children:d}),(0,t.jsx)(D,{kind:e.media_type,children:"movie"===e.media_type?"Film":"TV"})]}),e.overview&&(0,t.jsx)(I,{children:e.overview}),(0,t.jsxs)(L,{onClick:a,children:[(0,t.jsx)(u.A,{size:13}),"More Info"]})]})]})]}),document.body)}function H({item:e,onClick:o}){let a=(0,x.rS)(e),r=(0,x.Ox)(e),i=(0,x.HD)(e.poster_path),l=(0,n.useRef)(null),s=(0,n.useRef)(),c=(0,n.useRef)(),d=(0,n.useRef)(null),m=(0,n.useRef)(!1),[p,u]=(0,n.useState)(!1),[M,T]=(0,n.useState)(null),[_,C]=(0,n.useState)(!1);(0,n.useEffect)(()=>()=>{clearTimeout(s.current),clearTimeout(c.current)},[]);let B=(0,n.useCallback)((e,o)=>{T(e),u(!0),C(o)},[]),E=(0,n.useCallback)(()=>{u(!1),T(null),C(!1)},[]),P=(0,n.useCallback)(()=>{E(),o(e)},[e,o,E]),R=(0,n.useCallback)(()=>{clearTimeout(c.current)},[]),F=(0,n.useCallback)(()=>{clearTimeout(s.current),c.current=setTimeout(E,180)},[E]),D=(0,n.useCallback)(()=>{clearTimeout(c.current)},[]),I=(0,n.useCallback)(()=>{E()},[E]),L=(0,n.useCallback)(e=>{p||(d.current={x:e.touches[0].clientX,y:e.touches[0].clientY})},[p]),K=(0,n.useCallback)(a=>{if(p||!d.current)return;let t=a.changedTouches[0],n=Math.abs(t.clientX-d.current.x),r=Math.abs(t.clientY-d.current.y);if(d.current=null,n>8||r>8)return;if(m.current=!0,window.innerWidth<768)return void o(e);let i=l.current?.getBoundingClientRect();i&&B(i,!0)},[p,e,o,B]),U=(0,n.useCallback)(()=>{if(m.current){m.current=!1;return}p||_||P()},[p,_,P]);return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsxs)(h,{ref:l,onClick:U,onMouseEnter:R,onMouseLeave:F,onTouchStart:L,onTouchEnd:K,title:a,role:"button",tabIndex:0,onKeyDown:e=>{("Enter"===e.key||" "===e.key)&&P()},children:[(0,t.jsx)(j,{kind:e.media_type,children:"movie"===e.media_type?"Film":"TV"}),(0,t.jsx)(S,{"data-eye":!0,onClick:e=>{e.stopPropagation();let o=l.current?.getBoundingClientRect();o&&B(o,!1)},title:"Preview",children:(0,t.jsx)(f.A,{size:14})}),i?(0,t.jsx)(b,{src:i,alt:a,loading:"lazy"}):(0,t.jsxs)(y,{children:["\uD83C\uDFAC",(0,t.jsx)(w,{children:a})]}),(0,t.jsxs)(z,{children:[(0,t.jsx)(v,{children:a}),(0,t.jsxs)(k,{children:[(0,t.jsxs)($,{children:[(0,t.jsx)(g.A,{size:9,fill:"currentColor"}),e.vote_average.toFixed(1)]}),r&&(0,t.jsx)(A,{children:r})]})]})]}),p&&M&&(0,t.jsx)(N,{item:e,rect:M,onOpen:P,onMouseEnter:D,onMouseLeave:I,withBackdrop:_,onBackdropTap:E})]})}let K=i().div`
  display: flex;
  flex-direction: column;
  gap: ${l.w4.spacing.md};
...
`,j=s().main`
  ...
  display: flex;
  flex-direction: column;
`,S=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function M(){return(0,n.jsx)(b,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:S.map((e,o)=>(0,n.jsx)(y,{index:o,accent:e.accent,children:e.char},o))})}let T="atlantis:sidebar-collapsed";function _({sidebar:e,children:o,topBarRight:t,title:l="Atlantis",activeId:s=null}){let[c,p]=(0,r.useState)(()=>{try{return"true"===localStorage.getItem(T)}catch{return!1}}),[g,h]=(0,r.useState)(null),b=(0,r.useRef)(),y=()=>p(e=>{let o=!e;try{localStorage.setItem(T,String(o))}catch{}return o}),S=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(a.bind(a,7330)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,n.jsx)(m.I.Provider,{value:{collapsed:c,toggle:y,flyout:g,openFlyout:(e,o,a)=>{clearTimeout(b.current),h({entry:e,anchorY:o,onSelect:a})},scheduleFlyoutClose:()=>{b.current=setTimeout(()=>h(null),160)},cancelFlyoutClose:()=>clearTimeout(b.current)},children:(0,n.jsxs)(k,{children:[(0,n.jsxs)(u,{children:[e&&(0,n.jsx)(f,{children:(0,n.jsx)(x,{onClick:y,title:c?"Expand sidebar":"Collapse sidebar",children:(0,n.jsx)(d.A,{size:17})})}),(0,n.jsx)(M,{}),l&&(0,n.jsx)(w,{children:l}),t&&(0,n.jsx)(z,{children:t})]}),(0,n.jsxs)(v,{children:[null!=e&&(0,n.jsx)($,{collapsed:c,children:(0,n.jsx)(A,{children:e})}),(0,n.jsx)(j,{children:o})]}),g&&(0,n.jsx)(i().Suspense,{fallback:null,children:(0,n.jsx)(S,{activeId:s})})]})})}s().div`
  display: grid;
...
`;let B="documents",E="settings";function P(){return new Promise((e,o)=>{let a=indexedDB.open("atlantis-tools",2);a.onupgradeneeded=e=>{let o=e.target.result;o.objectStoreNames.contains(B)||o.createObjectStore(B,{keyPath:"id",autoIncrement:!0}).createIndex("appId","appId",{unique:!1}),o.objectStoreNames.contains(E)||o.createObjectStore(E,{keyPath:"key"})},a.onsuccess=()=>e(a.result),a.onerror=()=>o(a.error)})}let R={async saveDoc(e,o,a){let t=await P(),n={appId:e,name:o,content:a,savedAt:Date.now()};return new Promise((e,o)=>{let a=t.transaction(B,"readwrite").objectStore(B).add(n);a.onsuccess=()=>e(String(a.result)),a.onerror=()=>o(a.error)})},async updateDoc(e,o,a){let t=await P();return new Promise((n,r)=>{let i=t.transaction(B,"readwrite").objectStore(B),l=i.get(Number(e));l.onsuccess=()=>{let e=l.result;if(!e)return void r(Error("Doc not found"));let t=i.put({...e,name:o,content:a,savedAt:Date.now()});t.onsuccess=()=>n(),t.onerror=()=>r(t.error)},l.onerror=()=>r(l.error)})},async listDocs(e){let o=await P();return new Promise((a,t)=>{let n=o.transaction(B,"readonly").objectStore(B).index("appId").getAll(e);n.onsuccess=()=>a(n.result.map(e=>({...e,id:String(e.id)})).reverse()),n.onerror=()=>t(n.error)})},async deleteDoc(e){let o=await P();return new Promise((a,t)=>{let n=o.transaction(B,"readwrite").objectStore(B).delete(Number(e));n.onsuccess=()=>a(),n.onerror=()=>t(n.error)})},async putSetting(e,o){let a=await P();return new Promise((t,n)=>{let r=a.transaction(E,"readwrite").objectStore(E).put({key:e,value:o});r.onsuccess=()=>t(),r.onerror=()=>n(r.error)})},async getSetting(e){let o=await P();return new Promise((a,t)=>{let n=o.transaction(E,"readonly").objectStore(E).get(e);n.onsuccess=()=>a(n.result?n.result.value:null),n.onerror=()=>t(n.error)})}};function F(e){return`app-recents:${e}`}async function D(e){var o;let a=await (o=F(e),R.getSetting(o));if(!a)return[];try{let e=JSON.parse(a);return Array.isArray(e)?e:[]}catch{return[]}}async function I(e,o){var a,t;let n=(await D(e)).filter(e=>e.hash!==o.hash),r=[{...o,ts:Date.now()},...n].slice(0,10);await (a=F(e),t=JSON.stringify(r),R.putSetting(a,t));try{window.dispatchEvent(new CustomEvent("atlantis:app-recents-change",{detail:{appId:e,entries:r}}))}catch{}}function L(){let e="u">typeof window?window.location.hash:"",o=e.indexOf("?");if(-1===o)return{};let a={};for(let t of e.slice(o+1).split("&")){if(!t)continue;let e=t.indexOf("=");-1===e?a[decodeURIComponent(t)]="":a[decodeURIComponent(t.slice(0,e))]=decodeURIComponent(t.slice(e+1))}return a}function N(){let[e,o]=(0,r.useState)(L);return(0,r.useEffect)(()=>{let e=()=>o(L());return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[]),e}let H="shell:profile",K="atlantis:profile-change",U=["tech","movies","learning","games","news","space"],Y={interests:[],ageMode:"adult"};function V(e){return e&&"object"==typeof e?{interests:Array.isArray(e.interests)?e.interests.filter(e=>U.includes(e)):[],ageMode:"kid"===e.ageMode||"teen"===e.ageMode||"adult"===e.ageMode?e.ageMode:"adult"}:Y}function G(){let[e,o]=(0,r.useState)(Y);return(0,r.useEffect)(()=>{let e=!1;R.getSetting(H).then(a=>{if(!e&&a)try{o(V(JSON.parse(a)))}catch{}});let a=e=>{let a=e.detail;a&&o(a)};return window.addEventListener(K,a),()=>{e=!0,window.removeEventListener(K,a)}},[]),[e,(0,r.useCallback)(async e=>{var a;let t=V(e);o(t),window.dispatchEvent(new CustomEvent(K,{detail:t})),await (a=JSON.stringify(t),R.putSetting(H,a))},[])]}let O=new Set([27]);function W(e,o){if("adult"===o)return e;let a=e.filter(e=>!0!==e.adult);return"teen"===o?a.filter(e=>!(e.genre_ids??[]).some(e=>O.has(e))):a.filter(e=>(e.genre_ids??[]).includes(10751))}s().div`
