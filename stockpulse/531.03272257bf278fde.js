"use strict";(self.webpackChunk_atlantis_stockpulse=self.webpackChunk_atlantis_stockpulse||[]).push([["531"],{9855(e,o,a){a.d(o,{A:()=>I});var n=a(5723),i=a(7991),t=a(6859),r=a.n(t),l=a(2799),s=a(3775),c=a(4368),d=a(9121),m=a(246),g=a(9522);let p=(0,l.keyframes)`0%,100%{opacity:1}50%{opacity:.4}`,u=r().div`
  display: flex;
...
`;function O({iconKey:e,size:o=16}){if(e&&!(e in C.t))return(0,i.jsx)("span",{style:{fontSize:o,lineHeight:1,display:"flex",alignItems:"center"},children:e});let a=e?C.t[e]??E.A:E.A;return(0,i.jsx)(a,{size:o,strokeWidth:1.75})}function V({entry:e,activeId:o,onSelect:a}){let[n,r]=(0,t.useState)(e.defaultOpen??!0),{collapsed:l,openFlyout:s,scheduleFlyoutClose:c,cancelFlyoutClose:d}=(0,m.c)();return e.children&&e.children.length>0?(0,i.jsxs)(N,{children:[(0,i.jsxs)(G,{collapsed:l,onClick:()=>{l||r(e=>!e)},onMouseEnter:l?o=>{s(e,o.currentTarget.getBoundingClientRect().top,a)}:void 0,onMouseLeave:l?c:void 0,children:[(0,i.jsxs)(I,{collapsed:l,children:[(0,i.jsx)(O,{iconKey:e.icon,size:16}),(0,i.jsx)(H,{collapsed:l,children:e.name})]}),(0,i.jsx)(U,{open:n,collapsed:l,children:(0,i.jsx)(L.A,{size:13})})]}),(0,i.jsx)(R,{open:n&&!l,children:(0,i.jsx)(F,{children:(0,i.jsx)(D,{children:e.children.map(e=>(0,i.jsx)(V,{entry:e,activeId:o,onSelect:a},e.id))})})})]}):(0,i.jsxs)(K,{active:o===e.id,collapsed:l,onClick:()=>a(e),onMouseEnter:l?o=>{let n=o.currentTarget.getBoundingClientRect();s({id:e.id,name:e.name,icon:e.icon,file:e.file,children:[e]},n.top,a)}:void 0,onMouseLeave:l?c:void 0,children:[(0,i.jsx)(O,{iconKey:e.icon,size:15}),(0,i.jsx)(H,{collapsed:l,children:e.name})]})}function W({entries:e,activeId:o,onSelect:a}){return(0,i.jsx)("div",{children:e.map(e=>(0,i.jsx)(V,{entry:e,activeId:o,onSelect:a},e.id))})}let Y=(0,c.keyframes)`
