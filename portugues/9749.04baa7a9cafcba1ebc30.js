"use strict";(self.webpackChunk_atlantis_portugues=self.webpackChunk_atlantis_portugues||[]).push([[9749],{28834(e,a,o){o.d(a,{WO:()=>da});var n=o(27359),i=o(217),t=o(53233),r=o(65723);t.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,t.default.span`
  ...
  margin-right: 6px;
  flex-shrink: 0;
`;var l=o(73661),c=o(15959);const s="260px",d="56px",m=t.default.header`
  display: flex;
  align-items: center;
  height: ${"48px"};
...
`,w=t.default.main`
  ...
  display: flex;
  flex-direction: column;
`,A="atlantis:sidebar-collapsed";function v({sidebar:e,children:a,topBarRight:i,title:t="Atlantis",activeId:s=null}){const[d,v]=(0,n.useState)(()=>{try{return"true"===localStorage.getItem(A)}catch{return!1}}),[$,k]=(0,n.useState)(null),j=(0,n.useRef)(),S=()=>v(e=>{const a=!e;try{localStorage.setItem(A,String(a))}catch{}return a}),T=n.useMemo(()=>n.lazy(()=>Promise.resolve().then(o.bind(o,74914)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(c.I.Provider,{value:{collapsed:d,toggle:S,flyout:$,openFlyout:(e,a,o)=>{clearTimeout(j.current),k({entry:e,anchorY:a,onSelect:o})},scheduleFlyoutClose:()=>{j.current=setTimeout(()=>k(null),160)},cancelFlyoutClose:()=>clearTimeout(j.current)},children:(0,r.jsxs)(b,{children:[(0,r.jsxs)(m,{children:[(0,r.jsx)(g,{children:(0,r.jsx)(u,{onClick:S,title:d?"Expand sidebar":"Collapse sidebar",children:(0,r.jsx)(l.A,{size:17})})}),(0,r.jsxs)(f,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:["Atl",(0,r.jsx)("span",{children:"antis"})]}),t&&(0,r.jsx)(p,{children:t}),i&&(0,r.jsx)(y,{children:i})]}),(0,r.jsxs)(h,{children:[(0,r.jsx)(x,{collapsed:d,children:(0,r.jsx)(z,{children:e})}),(0,r.jsx)(w,{children:a})]}),$&&(0,r.jsx)(n.Suspense,{fallback:null,children:(0,r.jsx)(T,{activeId:s})})]})})}var $=o(20255),k=o(69753),j=o(65185);const S=t.default.div`
  display: grid;
...
`;function N({iconKey:e,size:a=16}){if(e&&!(e in j.t))return(0,r.jsx)("span",{style:{fontSize:a,lineHeight:1,display:"flex",alignItems:"center"},children:e});const o=e?j.t[e]??$.A:$.A;return(0,r.jsx)(o,{size:a,strokeWidth:1.75})}function I({entry:e,activeId:a,onSelect:o}){const[i,t]=(0,n.useState)(e.defaultOpen??!0),{collapsed:l,openFlyout:s,scheduleFlyoutClose:d,cancelFlyoutClose:m}=(0,c.c)();return e.children&&e.children.length>0?(0,r.jsxs)(B,{children:[(0,r.jsxs)(E,{collapsed:l,onClick:()=>{l||t(e=>!e)},onMouseEnter:l?a=>{const n=a.currentTarget.getBoundingClientRect();s(e,n.top,o)}:void 0,onMouseLeave:l?d:void 0,children:[(0,r.jsxs)(C,{collapsed:l,children:[(0,r.jsx)(N,{iconKey:e.icon,size:16}),(0,r.jsx)(P,{collapsed:l,children:e.name})]}),(0,r.jsx)(L,{open:i,collapsed:l,children:(0,r.jsx)(k.A,{size:13})})]}),(0,r.jsx)(S,{open:i&&!l,children:(0,r.jsx)(T,{children:(0,r.jsx)(M,{children:e.children.map(e=>(0,r.jsx)(I,{entry:e,activeId:a,onSelect:o},e.id))})})})]}):(0,r.jsxs)(R,{active:a===e.id,collapsed:l,onClick:()=>o(e),onMouseEnter:l?a=>{const n=a.currentTarget.getBoundingClientRect();s({id:e.id,name:e.name,icon:e.icon,file:e.file,children:[e]},n.top,o)}:void 0,onMouseLeave:l?d:void 0,children:[(0,r.jsx)(N,{iconKey:e.icon,size:15}),(0,r.jsx)(P,{collapsed:l,children:e.name})]})}function F({entries:e,activeId:a,onSelect:o}){return(0,r.jsx)("div",{children:e.map(e=>(0,r.jsx)(I,{entry:e,activeId:a,onSelect:o},e.id))})}const K=o(77207).keyframes`
...
`;function Q({title:e,icon:a,entries:o,activeId:i,onSelect:t,favorites:l,onToggleFav:c}){const[s,d]=(0,n.useState)(!1);return o.length?(0,r.jsxs)(V,{children:[(0,r.jsxs)(Y,{onClick:()=>d(e=>!e),children:[(0,r.jsxs)(_,{children:[a,e]}),(0,r.jsx)(W,{open:s,children:(0,r.jsx)(k.A,{size:12})})]}),(0,r.jsx)(J,{open:s,children:(0,r.jsx)(U,{children:o.map(e=>{const a=l.some(a=>a.id===e.id);return(0,r.jsxs)(Z,{children:[(0,r.jsx)(X,{active:i===e.id,onClick:()=>t(e),children:e.name}),(0,r.jsx)(q,{active:a,title:a?"Remover dos favoritos":"Adicionar aos favoritos",onClick:a=>{a.stopPropagation(),c(e)},children:(0,r.jsx)(G.A,{size:12,fill:a?"currentColor":"none"})})]},e.id)})})})]}):null}function ee({config:e,activeId:a,onSelect:o,hashPrefix:i}){const t=`atlantis-recent-${i}`,l=`atlantis-fav-${i}`,[c,s]=(0,n.useState)(()=>O(t)),[d,m]=(0,n.useState)(()=>O(l)),g=(0,n.useCallback)(e=>{e.file&&s(a=>function(e,a,o){const n=[a,...o.filter(e=>e.id!==a.id)].slice(0,10);return localStorage.setItem(e,JSON.stringify(n)),n}(t,e,a)),o(e)},[o,t]),u=(0,n.useCallback)(e=>{m(a=>function(e,a,o){const n=o.some(e=>e.id===a.id)?o.filter(e=>e.id!==a.id):[...o,a];return localStorage.setItem(e,JSON.stringify(n)),n}(l,e,a))},[l]);return(0,r.jsxs)(H,{children:[(0,r.jsx)(Q,{title:"Recentes",icon:(0,r.jsx)(D.A,{size:13}),entries:c,activeId:a,onSelect:g,favorites:d,onToggleFav:u}),(0,r.jsx)(Q,{title:"Favoritos",icon:(0,r.jsx)(G.A,{size:13}),entries:d,activeId:a,onSelect:g,favorites:d,onToggleFav:u}),(0,r.jsx)(F,{entries:e.entries,activeId:a,onSelect:g})]})}var ae=o(28976),oe=o(18055),ne=o(66225),ie=o(302),te=o(39895),re=o(6930),le=o(14944);const ce=t.default.div`
...
`;let de=!1;function me({code:e}){const a=(0,n.useRef)(null),[t,l]=(0,n.useState)(null);return(0,n.useEffect)(()=>{let n=!1;return async function(){const t=(await o.e(774).then(o.bind(o,30774))).default;if(de||(t.initialize({startOnLoad:!1,theme:"dark",themeVariables:{background:i.w.colors.codeBg,primaryColor:i.w.colors.accent,primaryTextColor:i.w.colors.mainText,lineColor:i.w.colors.border}}),de=!0),a.current&&!n)try{const o=`mermaid-${Math.random().toString(36).slice(2)}`,{svg:i}=await t.render(o,e);!n&&a.current&&(a.current.innerHTML=i)}catch(e){n||l(e instanceof Error?e.message:String(e))}}(),()=>{n=!0}},[e]),t?(0,r.jsx)(ce,{children:(0,r.jsxs)(se,{children:["Mermaid error: ",t]})}):(0,r.jsx)(ce,{ref:a})}var ge=o(68383),ue=o(21426),fe=o(25609),pe=o(20320);const ye=t.default.div`
  margin: ${i.w.spacing.lg} 0;
  border-radius: ${i.w.borderRadius.md};
  border: 1px solid ${i.w.colors.codeBorder};
  overflow: hidden;
...
`;function Ne({headings:e,activeId:a}){return e.length<2?null:(0,r.jsxs)(Ce,{children:[(0,r.jsx)(Pe,{children:"On this page"}),(0,r.jsx)(Le,{children:e.map(e=>(0,r.jsx)("li",{children:(0,r.jsx)(Re,{href:`#${e.id}`,active:a===e.id,level:e.level,onClick:a=>{a.preventDefault(),document.getElementById(e.id)?.scrollIntoView({behavior:"smooth",block:"start"})},children:e.text})},e.id))})]})}function Ie(e){return e.toLowerCase().replace(/[*_`[\]()#]/g,"").replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-").trim()}function Fe(e){const{Children:a,isValidElement:n}=o(27359);return a.toArray(e).map(e=>"string"==typeof e?e:"number"==typeof e?String(e):n(e)?Fe(e.props.children??""):"").join("")}function Ke(){return e=>{!function e(a){if("blockquote"===a.type){const e=a.children?.[0];if("paragraph"===e?.type){const o=e.children?.[0];if("text"===o?.type){const n=o.value?.match(/^\[!(NOTE|TIP|WARNING|CAUTION|IMPORTANT)\]\s*/i);n&&(o.value=o.value.slice(n[0].length),o.value.trim()||1!==e.children.length||a.children.shift(),a.data=a.data??{},a.data.hName="div",a.data.hProperties={"data-callout":n[1].toUpperCase()})}}}a.children?.forEach(e)}(e)}}const Ge=t.default.div`
  display: flex;
...
`,De=t.default.div`flex: 1; min-width: 0;`,Oe=t.default.article`
...
`,We=t.default.div`
  ...
  font-family: ${i.w.typography.fontFamily};
`;function Je(e){return function({children:a,...o}){const n=`h${e}`,i=Fe(a),t=Ie(i);return(0,r.jsxs)(n,{id:t,...o,children:[a,(0,r.jsx)("a",{className:"heading-anchor",href:`#${t}`,"aria-label":`Link to "${i}"`,children:(0,r.jsx)(ne.A,{size:14})})]})}}function Ue({file:e,prevEntry:a,nextEntry:i,onNavigate:t}){const[l,c]=(0,n.useState)(null),[s,d]=(0,n.useState)(null),m=(0,n.useRef)(null);if((0,n.useEffect)(()=>{c(null),fetch(`${o.p}content/${e}`).then(e=>{if(!e.ok)throw new Error(`${e.status} ${e.statusText}`);return e.text()}).then(c).catch(a=>c(`> **Error loading \`${e}\`:** ${a.message}`))},[e]),(0,n.useEffect)(()=>{if(!l||!m.current)return;const e=m.current.querySelectorAll("h2[id], h3[id]");if(!e.length)return;const a=new IntersectionObserver(e=>{const a=e.filter(e=>e.isIntersecting);a.length&&d(a[0].target.id)},{rootMargin:"-10% 0% -60% 0%",threshold:0});return e.forEach(e=>a.observe(e)),()=>a.disconnect()},[l]),null===l)return(0,r.jsx)(We,{children:"Loading…"});const g=function(e){const a=[],o=/^(#{2,3})\s+(.+)$/gm;let n;for(;null!==(n=o.exec(e));){const e=n[1].length,o=n[2].trim().replace(/\*\*(.+?)\*\*/g,"$1").replace(/\*(.+?)\*/g,"$1").replace(/`(.+?)`/g,"$1").replace(/\[(.+?)\]\(.+?\)/g,"$1");a.push({level:e,text:o,id:Ie(o)})}return a}(l),u=a||i;return(0,r.jsxs)(Ge,{children:[(0,r.jsxs)(De,{children:[(0,r.jsx)(Oe,{ref:m,children:(0,r.jsx)(ae.oz,{remarkPlugins:[oe.A,le.A,Ke],rehypePlugins:[te.A,re.A],components:{div({node:e,children:a,...o}){const n=o["data-callout"];return n?(0,r.jsx)(Ee,{type:n,children:a}):(0,r.jsx)("div",{...o,children:a})},h1:Je(1),h2:Je(2),h3:Je(3),h4:Je(4),pre:({children:e})=>(0,r.jsx)(r.Fragment,{children:e}),code({className:e,children:a}){const o=/language-(\w+)/.exec(e??"")?.[1],n=String(a).replace(/\n$/,"");return"mermaid"===o?(0,r.jsx)(me,{code:n}):o||n.includes("\n")?(0,r.jsx)(we,{lang:o,code:n}):(0,r.jsx)("code",{className:e,children:a})}},children:l})}),u&&(0,r.jsxs)(He,{children:[a?(0,r.jsxs)(Ve,{align:"left",onClick:()=>t?.(a),children:[(0,r.jsxs)(Ye,{children:[(0,r.jsx)(ie.A,{size:13})," Previous"]}),(0,r.jsx)(_e,{children:a.name})]}):(0,r.jsx)("div",{style:{flex:1}}),i?(0,r.jsxs)(Ve,{align:"right",onClick:()=>t?.(i),children:[(0,r.jsxs)(Ye,{children:["Next ",(0,r.jsx)(k.A,{size:13})]}),(0,r.jsx)(_e,{children:i.name})]}):(0,r.jsx)("div",{style:{flex:1}})]})]}),(0,r.jsx)(Ne,{headings:g,activeId:s})]})}const Ze=t.default.div`
  display: flex;
  gap: 4px;
  background: ${i.w.colors.surface};
  border: 1px solid ${i.w.colors.border};
...
`;function ca({title:e,sub:a}){return(0,r.jsxs)(aa,{children:[(0,r.jsx)(na,{}),(0,r.jsx)(oa,{size:500,x:10,y:-10,hue:210,dur:7}),(0,r.jsx)(oa,{size:400,x:60,y:50,hue:270,dur:9}),(0,r.jsx)(oa,{size:300,x:30,y:70,hue:190,dur:6}),(0,r.jsxs)(ia,{children:[(0,r.jsx)(ta,{children:e}),(0,r.jsx)(ra,{children:a}),(0,r.jsxs)(la,{children:[(0,r.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round",children:(0,r.jsx)("polyline",{points:"15 18 9 12 15 6"})}),"Browse the sidebar"]})]})]})}function sa(e,a,o){return"string"==typeof e?e:e[a]??e[o]??Object.values(e)[0]??""}function da({navigation:e,languages:a,defaultLang:o,hashPrefix:i,topBarRight:t,welcomeTitle:l="Blog",welcomeSub:c="Notes, guides, and references — pick a topic from the sidebar to get started."}){const s=a?Object.keys(a):[],d=s.length>1,[m,g]=(0,n.useState)(()=>o??s[0]??""),u=(0,n.useMemo)(()=>a&&m?a[m].navigation:e??{entries:[]},[a,e,m]),f=((0,n.useMemo)(()=>ea(u.entries),[u]),(0,n.useCallback)(e=>{const a=e.match(new RegExp(`^#\\/${i}\\/(.+)$`));if(a)return Qe(u.entries,a[1])},[u,i])),[p,y]=(0,n.useState)(()=>f(window.location.hash)??null);(0,n.useEffect)(()=>{y(null)},[m]),(0,n.useEffect)(()=>{const e=()=>{const e=f(window.location.hash);e&&y(e)};return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[f]);const h=(0,n.useCallback)(e=>{e.file&&(y(e),window.location.hash=`#/${i}/${e.id}`)},[i]),b=(0,n.useMemo)(()=>ea(u.entries),[u]),x=b.findIndex(e=>e.id===p?.id),z=x>0?b[x-1]:null,w=x<b.length-1?b[x+1]:null,A=p?.label??p?.name??i,$=sa(l,m,o??s[0]??""),k=sa(c,m,o??s[0]??""),j=d&&a?(0,r.jsx)(qe,{languages:Object.fromEntries(s.map(e=>[e,{label:a[e].label}])),activeLang:m,onChange:g}):null;return(0,r.jsx)(v,{title:A,activeId:p?.id??null,topBarRight:(0,r.jsxs)(r.Fragment,{children:[j,t]}),sidebar:(0,r.jsx)(ee,{config:u,activeId:p?.id??null,onSelect:h,hashPrefix:i}),children:p?.file?(0,r.jsx)(Ue,{file:p.file,prevEntry:z,nextEntry:w,onNavigate:h}):(0,r.jsx)(ca,{title:$,sub:k})})}},74914(e,a,o){o.d(a,{FlyoutPanel:()=>h});var n=o(27359),i=o(53233),t=o(77207),r=o(20255),l=o(217),c=o(15959),s=o(65185),d=o(65723);const m=t.keyframes`
