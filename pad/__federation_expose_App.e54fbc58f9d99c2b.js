"use strict";(self.webpackChunk_atlantis_pad=self.webpackChunk_atlantis_pad||[]).push([["6362"],{73935(e,r,t){t.r(r),t.d(r,{default:()=>k});var n=t(65723),o=t(37991),a=t(36859),i=t.n(a),l=t(89874),s=t(85399),c=t(53804),d=t(2099),u=t(65320),p=t(7279),m=t(56666);function w(){let e=window.location.hash.toLowerCase();return e.startsWith("#/mermaidpad")||e.startsWith("#/mermaid")?"mermaid":"markdown"}let g=i().button`
  display: flex;
  align-items: center;
  gap: 6px;
  padding: 5px 12px;
