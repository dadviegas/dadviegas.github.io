...
`;l().div`
  ...
  pointer-events: none;
  z-index: 200;
  animation: ${ea} 0.16s cubic-bezier(0.4, 0, 0.2, 1) forwards;
...
`,ep=l().div`
  ...
  color: ${d.w4.colors.sidebarTextMuted};
  font-family: ${d.w4.typography.fontFamily};
`;function eg({onSave:e,onUpdate:o,onCancel:t,existingDoc:i}){let[n,l]=(0,r.useState)(i?.name??""),d=(0,r.useRef)(null);return(0,r.useEffect)(()=>{d.current?.focus(),i&&d.current?.select()},[i]),(0,a.jsx)(er,{onClick:t,children:(0,a.jsxs)(ei,{onClick:e=>e.stopPropagation(),children:[(0,a.jsx)(en,{children:"Save document"}),i&&o&&(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(ep,{children:"Update the current version or save as a new one."}),(0,a.jsxs)(ed,{children:[(0,a.jsx)(es,{onClick:t,children:"Cancel"}),(0,a.jsxs)(es,{danger:!0,onClick:o,children:['Update "',i.name,'"']})]}),(0,a.jsx)(ec,{})]}),(0,a.jsx)(el,{ref:d,value:n,onChange:e=>l(e.target.value),onKeyDown:a=>{"Enter"===a.key&&n.trim()&&(i&&n.trim()===i.name&&o?o():e(n.trim())),"Escape"===a.key&&t()},placeholder:i?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,a.jsxs)(ed,{children:[!i&&(0,a.jsx)(es,{onClick:t,children:"Cancel"}),(0,a.jsx)(es,{primary:!0,disabled:!n.trim(),onClick:()=>e(n.trim()),children:"Save as new"})]})]})})}let eh=(0,S.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,em=(0,S.keyframes)`
...
`,l().div`
  position: relative;
`;let eb="260px",ey="56px",ew="48px",ev=l().header`
  display: flex;
  align-items: center;
...
`,eA=l().span`
  ...
  animation: ${eM} 10s ease ${({index:e})=>.07*e}s infinite;
...
`,eB=l().div`
  ...
  overflow: hidden;
`,eC=l().aside`
  width: ${({collapsed:e})=>e?ey:eb};
  min-width: ${({collapsed:e})=>e?ey:eb};
  background: ${d.w4.colors.sidebarBg};
  border-right: 1px solid ${d.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,eL=l().main`
  ...
  display: flex;
  flex-direction: column;
`,eH=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function eR(){return(0,a.jsx)(ek,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:eH.map((e,o)=>(0,a.jsx)(eA,{index:o,accent:e.accent,children:e.char},o))})}let eE="atlantis:sidebar-collapsed";function eP({sidebar:e,children:o,topBarRight:n,title:l="Atlantis",activeId:d=null}){let[s,c]=(0,r.useState)(()=>{try{return"true"===localStorage.getItem(eE)}catch{return!1}}),[p,g]=(0,r.useState)(null),h=(0,r.useRef)(),m=()=>c(e=>{let o=!e;try{localStorage.setItem(eE,String(o))}catch{}return o}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(t.bind(t,5816)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,a.jsx)(_.I.Provider,{value:{collapsed:s,toggle:m,flyout:p,openFlyout:(e,o,t)=>{clearTimeout(h.current),g({entry:e,anchorY:o,onSelect:t})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,a.jsxs)(eB,{children:[(0,a.jsxs)(ev,{children:[e&&(0,a.jsx)(e$,{children:(0,a.jsx)(ez,{onClick:m,title:s?"Expand sidebar":"Collapse sidebar",children:(0,a.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,a.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,a.jsx)("path",{d:"M9 3v18"})]})})}),(0,a.jsx)(eR,{}),l&&(0,a.jsx)(eT,{children:l}),n&&(0,a.jsx)(eS,{children:n})]}),(0,a.jsxs)(ej,{children:[null!=e&&(0,a.jsx)(eC,{collapsed:s,children:(0,a.jsx)(eF,{children:e})}),(0,a.jsx)(eL,{children:o})]}),p&&(0,a.jsx)(i().Suspense,{fallback:null,children:(0,a.jsx)(f,{activeId:d})})]})})}l().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
