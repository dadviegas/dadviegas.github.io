"use strict";(self.webpackChunk_atlantis_playground=self.webpackChunk_atlantis_playground||[]).push([[868],{4914(n,e,o){o.d(e,{FlyoutPanel:()=>y});var a=o(7359),t=o(3233),i=o(7207),r=o(255),l=o(217),s=o(5959),c=o(5185),d=o(5723);const m=i.keyframes`
...
`,k=i.default.main`
  ...
  display: flex;
  flex-direction: column;
`,$=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function S(){return(0,r.jsx)(x,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:$.map((n,e)=>(0,r.jsx)(y,{index:e,accent:n.accent,children:n.char},e))})}const j="atlantis:sidebar-collapsed";function M({sidebar:n,children:e,topBarRight:a,title:i="Atlantis",activeId:l=null}){const[d,m]=(0,t.useState)(()=>{try{return"true"===localStorage.getItem(j)}catch{return!1}}),[f,x]=(0,t.useState)(null),y=(0,t.useRef)(),$=()=>m(n=>{const e=!n;try{localStorage.setItem(j,String(e))}catch{}return e}),M=t.useMemo(()=>t.lazy(()=>Promise.resolve().then(o.bind(o,4914)).then(n=>({default:n.FlyoutPanel}))),[]);return(0,r.jsx)(c.I.Provider,{value:{collapsed:d,toggle:$,flyout:f,openFlyout:(n,e,o)=>{clearTimeout(y.current),x({entry:n,anchorY:e,onSelect:o})},scheduleFlyoutClose:()=>{y.current=setTimeout(()=>x(null),160)},cancelFlyoutClose:()=>clearTimeout(y.current)},children:(0,r.jsxs)(w,{children:[(0,r.jsxs)(u,{children:[n&&(0,r.jsx)(g,{children:(0,r.jsx)(p,{onClick:$,title:d?"Expand sidebar":"Collapse sidebar",children:(0,r.jsx)(s.A,{size:17})})}),(0,r.jsx)(S,{}),i&&(0,r.jsx)(b,{children:i}),a&&(0,r.jsx)(h,{children:a})]}),(0,r.jsxs)(z,{children:[null!=n&&(0,r.jsx)(v,{collapsed:d,children:(0,r.jsx)(A,{children:n})}),(0,r.jsx)(k,{children:e})]}),f&&(0,r.jsx)(t.Suspense,{fallback:null,children:(0,r.jsx)(M,{activeId:l})})]})})}o(5185),i.default.div`
  display: grid;
...
`,V=i.default.div`
  ...
  color: ${a.w4.colors.sidebarTextMuted};
  font-family: ${a.w4.typography.fontFamily};
`;function W({onSave:n,onUpdate:e,onCancel:o,existingDoc:a}){const[i,l]=(0,t.useState)(a?.name??""),s=(0,t.useRef)(null);return(0,t.useEffect)(()=>{s.current?.focus(),a&&s.current?.select()},[a]),(0,r.jsx)(N,{onClick:o,children:(0,r.jsxs)(K,{onClick:n=>n.stopPropagation(),children:[(0,r.jsx)(H,{children:"Save document"}),a&&e&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(V,{children:"Update the current version or save as a new one."}),(0,r.jsxs)(Y,{children:[(0,r.jsx)(_,{onClick:o,children:"Cancel"}),(0,r.jsxs)(_,{danger:!0,onClick:e,children:['Update "',a.name,'"']})]}),(0,r.jsx)(O,{})]}),(0,r.jsx)(G,{ref:s,value:i,onChange:n=>l(n.target.value),onKeyDown:t=>{"Enter"===t.key&&i.trim()&&(a&&i.trim()===a.name&&e?e():n(i.trim())),"Escape"===t.key&&o()},placeholder:a?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,r.jsxs)(Y,{children:[!a&&(0,r.jsx)(_,{onClick:o,children:"Cancel"}),(0,r.jsx)(_,{primary:!0,disabled:!i.trim(),onClick:()=>n(i.trim()),children:"Save as new"})]})]})})}var U=o(5625),J=o(679),Z=o(4872);const q=i.default.div`
  position: relative;
`,Q=i.default.button`
  display: flex;
  align-items: center;
