...
`;function f({iconKey:e}){const a=e?c.t[e]??r.A:r.A;return(0,d.jsx)(a,{size:14,strokeWidth:1.75})}function h({entries:e,activeId:a,onSelect:o}){return(0,d.jsx)(d.Fragment,{children:e.map(e=>e.children?(0,d.jsx)(n.Fragment,{children:(0,d.jsx)(h,{entries:e.children,activeId:a,onSelect:o})},e.id):(0,d.jsxs)(u,{active:a===e.id,onClick:()=>o(e),children:[(0,d.jsx)(f,{iconKey:e.icon}),e.name]},e.id))})}function x({activeId:e}){const{flyout:a,scheduleFlyoutClose:o,cancelFlyoutClose:n}=(0,s.c)();if(!a)return null;const t=a.entry.icon?c.t[a.entry.icon]??r.A:r.A;return(0,d.jsxs)(g,{anchorY:a.anchorY,onMouseEnter:n,onMouseLeave:o,children:[(0,d.jsxs)(p,{children:[(0,d.jsx)(t,{size:13,strokeWidth:2}),a.entry.name]}),(0,d.jsx)(h,{entries:a.entry.children??[],activeId:e,onSelect:e=>{a.onSelect(e),o()}})]})}},5959(e,a,o){o.d(a,{I:()=>t,c:()=>i});var n=o(7359);const t=(0,n.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),i=()=>(0,n.useContext)(t)},5185(e,a,o){o.d(a,{t:()=>ne});var n=o(9510),t=o(9038),i=o(7400),r=o(8207),l=o(7902),s=o(6896),c=o(7901),d=o(9848),m=o(2164),g=o(3045),p=o(3775),u=o(3539),f=o(1783),h=o(1837),x=o(4494),y=o(2314),b=o(5751),w=o(255),z=o(9633),A=o(2946),$=o(822),v=o(6720),j=o(3317),k=o(2709),S=o(9301),M=o(3517),T=o(7032),P=o(6949),B=o(8218),E=o(6829),C=o(5553),L=o(9591),R=o(2820),F=o(4621),D=o(2534),N=o(6673),I=o(9033),G=o(1365),H=o(2937),U=o(5912),K=o(158),O=o(8641),V=o(8607),Y=o(3249),W=o(1821),_=o(5889),J=o(7170),q=o(9161),Z=o(1849),X=o(1187),Q=o(7747),ee=o(2932),ae=o(4525),oe=o(7230);const ne={activity:s.A,"a-large-small":l.A,"bar-chart-2":n.A,book:d.A,"book-open":c.A,briefcase:g.A,calendar:p.A,clock:f.A,"circle-dot":u.A,compass:h.A,droplets:x.A,feather:y.A,file:w.A,"file-text":b.A,folder:z.A,"git-branch":A.A,github:$.A,globe:v.A,grid:i.A,hash:j.A,heart:k.A,hexagon:S.A,landmark:M.A,layers:r.A,"layout-grid":T.A,leaf:P.A,lightbulb:B.A,list:E.A,map:L.A,"map-pin":C.A,"message-square":R.A,minus:F.A,mountain:D.A,package:N.A,"pen-tool":I.A,"pie-chart":t.A,plus:G.A,ruler:H.A,slash:U.A,square:K.A,star:O.A,sun:V.A,terminal:Y.A,thermometer:W.A,triangle:_.A,truck:J.A,type:q.A,users:Z.A,waves:X.A,wind:Q.A,wrench:ee.A,x:ae.A,zap:oe.A,bot:m.A}},5723(e,a,o){o.d(a,{PE:()=>M,CD:()=>K,w4:()=>n.w4});var n=o(217),t=o(7359),i=o(3233),r=o(8104);i.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
//# sourceMappingURL=136.3c1c66c387ce7e722f6b.js.map