"use strict";(self.webpackChunk_atlantis_school=self.webpackChunk_atlantis_school||[]).push([[8021],{9752(e,a,o){o.d(a,{WO:()=>Za});var n=o(27359),i=o(26879),t=o(53233),r=o(17681),l=o(69753),s=o(88641),c=o(41783),d=o(65723);function m(e){try{return JSON.parse(localStorage.getItem(e)??"[]")}catch{return[]}}const u=t.default.nav`padding: ${i.w4.spacing.sm} 0;`,p=t.default.div`
...
`,P=t.default.pre`
  ...
  white-space: pre-wrap;
`;let R=!1;function O({code:e}){const a=(0,n.useRef)(null),[t,r]=(0,n.useState)(null),[l,s]=(0,n.useState)(!1);return(0,n.useEffect)(()=>{let n=!1;if(r(null),s(!1),!e.trim())return void s(!0);const t=e.trim().split(/\r?\n/)[0]?.trim()??"";if(/^(?:---[\s\S]*?---\s*)?(?:graph|flowchart|sequenceDiagram|classDiagram|stateDiagram(?:-v2)?|erDiagram|pie|gantt|journey|mindmap|gitGraph|sankey(?:-beta)?|quadrantChart|requirementDiagram|timeline|xychart-beta|block-beta|C4Context|C4Container|C4Component|C4Dynamic|C4Deployment)\b/.test(t))return async function(){const t=(await o.e(774).then(o.bind(o,30774))).default;if(R||(t.initialize({startOnLoad:!1,theme:"dark",themeVariables:{background:i.w4.colors.codeBg,primaryColor:i.w4.colors.accent,primaryTextColor:i.w4.colors.mainText,lineColor:i.w4.colors.border}}),R=!0),a.current&&!n)try{const o=`mermaid-${Math.random().toString(36).slice(2)}`,{svg:i}=await t.render(o,e);if(n||!a.current)return;a.current.innerHTML=i,requestAnimationFrame(()=>{if(n||!a.current)return;const e=a.current.querySelector("svg");if(!e)return void s(!0);const o=e.getBoundingClientRect();(o.width<40||o.height<40)&&s(!0)})}catch(e){n||r(e instanceof Error?e.message:String(e))}}(),()=>{n=!0};s(!0)},[e]),t?(0,d.jsx)(E,{children:(0,d.jsxs)(F,{children:["Mermaid error: ",t]})}):l?(0,d.jsx)(P,{children:e.trim()}):(0,d.jsx)(E,{ref:a})}const L=["#388bfd","#3fb950","#d29922","#a371f7","#f87171","#22d3ee","#fb923c","#34d399","#f472b6","#818cf8"],N=t.default.div`
  background: ${i.w4.colors.codeBg};
  border: 1px solid ${i.w4.colors.codeBorder};
  border-radius: ${i.w4.borderRadius.md};
  padding: ${i.w4.spacing.lg};
...
`,t.default.span`
  ...
  font-weight: 600;
  margin-left: auto;
`,new Map},30894(e,a,o){o.d(a,{Ym:()=>c});var n=o(27359),i=o(26879);const t="atlantis:locale",r="shell:locale";function l(e){return"en"===e||"pt"===e}function s(){try{const e=localStorage.getItem(t);if(l(e))return e}catch{}return"en"}function c(){const[e,a]=(0,n.useState)(s),o=(0,n.useCallback)(e=>{a(e),function(e){try{localStorage.setItem(t,e)}catch{}(0,i.Is)(r,e).catch(()=>{})}(e),window.dispatchEvent(new CustomEvent("atlantis:locale-change",{detail:e}))},[]);return(0,n.useEffect)(()=>{const e=e=>{const o=e.detail;a(o)};return window.addEventListener("atlantis:locale-change",e),()=>window.removeEventListener("atlantis:locale-change",e)},[]),(0,n.useEffect)(()=>{(0,i.PL)(r).then(o=>{if(l(o)&&o!==e){try{localStorage.setItem(t,o)}catch{}a(o)}}).catch(()=>{})},[]),[e,o]}(0,i.PL)(r).then(e=>{if(l(e))try{localStorage.setItem(t,e)}catch{}}).catch(()=>{});var d=o(53233);o(65723),d.default.div`
  display: flex;
  gap: 4px;
  background: ${i.w4.colors.surface};
  border: 1px solid ${i.w4.colors.border};
...
`;function H({iconKey:e,size:a=16}){if(e&&!(e in B.t))return(0,r.jsx)("span",{style:{fontSize:a,lineHeight:1,display:"flex",alignItems:"center"},children:e});const o=e?B.t[e]??T.A:T.A;return(0,r.jsx)(o,{size:a,strokeWidth:1.75})}function G({entry:e,activeId:a,onSelect:o}){const[n,t]=(0,i.useState)(e.defaultOpen??!0),{collapsed:l,openFlyout:s,scheduleFlyoutClose:d,cancelFlyoutClose:m}=(0,c.c)();return e.children&&e.children.length>0?(0,r.jsxs)(R,{children:[(0,r.jsxs)(O,{collapsed:l,onClick:()=>{l||t(e=>!e)},onMouseEnter:l?a=>{const n=a.currentTarget.getBoundingClientRect();s(e,n.top,o)}:void 0,onMouseLeave:l?d:void 0,children:[(0,r.jsxs)(L,{collapsed:l,children:[(0,r.jsx)(H,{iconKey:e.icon,size:16}),(0,r.jsx)(N,{collapsed:l,children:e.name})]}),(0,r.jsx)(I,{open:n,collapsed:l,children:(0,r.jsx)(C.A,{size:13})})]}),(0,r.jsx)(E,{open:n&&!l,children:(0,r.jsx)(F,{children:(0,r.jsx)(P,{children:e.children.map(e=>(0,r.jsx)(G,{entry:e,activeId:a,onSelect:o},e.id))})})})]}):(0,r.jsxs)(D,{active:a===e.id,collapsed:l,onClick:()=>o(e),onMouseEnter:l?a=>{const n=a.currentTarget.getBoundingClientRect();s({id:e.id,name:e.name,icon:e.icon,file:e.file,children:[e]},n.top,o)}:void 0,onMouseLeave:l?d:void 0,children:[(0,r.jsx)(H,{iconKey:e.icon,size:15}),(0,r.jsx)(N,{collapsed:l,children:e.name})]})}function W({entries:e,activeId:a,onSelect:o}){return(0,r.jsx)("div",{children:e.map(e=>(0,r.jsx)(G,{entry:e,activeId:a,onSelect:o},e.id))})}const Y=l.keyframes`
...
//# sourceMappingURL=8021.e3cdc711fe7a3e0004c3.js.map