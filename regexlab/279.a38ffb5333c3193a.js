...
`,P.A,P.A['pre[class*="language-"]'],d.w4.colors.codeBg,P.A['code[class*="language-"]'],l().div`
  background: ${({bg:o})=>o};
...
`;function W({activeAppId:o}){let{collapsed:e}=(0,I.c)(),[a]=function(){let[o,e]=(0,r.useState)(T),a=(0,r.useCallback)(o=>{e(o);try{localStorage.setItem(M,o)}catch{}(0,d.Is)(k,o).catch(()=>{}),window.dispatchEvent(new CustomEvent("atlantis:locale-change",{detail:o}))},[]);return(0,r.useEffect)(()=>{let o=o=>{e(o.detail)};return window.addEventListener("atlantis:locale-change",o),()=>window.removeEventListener("atlantis:locale-change",o)},[]),(0,r.useEffect)(()=>{(0,d.PL)(k).then(a=>{if(A(a)&&a!==o){try{localStorage.setItem(M,a)}catch{}e(a)}}).catch(()=>{})},[]),[o,a]}(),i=(0,r.useMemo)(()=>(o,e)=>{let t=function(o,e){if(!e||!o.includes("|"))return o;let a=null;for(let o of Object.values(e))if("number"==typeof o&&Number.isFinite(o)){a=o;break}if(null===a)return o;let t=o.indexOf("|"),r=o.slice(0,t),i=o.slice(t+1);return 1===a?r:i}(z[o]?.[a]??o,e);return e?Object.entries(e).reduce((o,[e,a])=>o.replace(RegExp(`\\{${e}\\}`,"g"),String(a)),t):t},[a]),n=(0,r.useRef)(null),l=o=>{n.current!==o&&(n.current=o,document.activeElement?.blur(),window.location.hash=o,setTimeout(()=>{n.current=null},50))};return(0,t.jsxs)(G,{children:[(0,t.jsx)(N,{collapsed:e,children:i("devtools.heading")}),K.map(a=>{let r=i(a.labelKey);return(0,t.jsxs)(Y,{active:o===a.id,collapsed:e,onPointerDown:o=>{0===o.button&&l(a.hash)},onClick:()=>l(a.hash),title:r,children:[(0,t.jsx)(O,{children:(0,t.jsx)($,{name:a.icon,size:16})}),(0,t.jsx)(_,{collapsed:e,children:r})]},a.id)})]})}let J=(0,y.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`;l().div`
  display: grid;
...
`,or=l().div`
  ...
  color: ${d.w4.colors.sidebarTextMuted};
  font-family: ${d.w4.typography.fontFamily};
`;function oi({onSave:o,onUpdate:e,onCancel:a,existingDoc:i}){let[n,l]=(0,r.useState)(i?.name??""),d=(0,r.useRef)(null);return(0,r.useEffect)(()=>{d.current?.focus(),i&&d.current?.select()},[i]),(0,t.jsx)(q,{onClick:a,children:(0,t.jsxs)(X,{onClick:o=>o.stopPropagation(),children:[(0,t.jsx)(Q,{children:"Save document"}),i&&e&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(or,{children:"Update the current version or save as a new one."}),(0,t.jsxs)(oe,{children:[(0,t.jsx)(oa,{onClick:a,children:"Cancel"}),(0,t.jsxs)(oa,{danger:!0,onClick:e,children:['Update "',i.name,'"']})]}),(0,t.jsx)(ot,{})]}),(0,t.jsx)(oo,{ref:d,value:n,onChange:o=>l(o.target.value),onKeyDown:t=>{"Enter"===t.key&&n.trim()&&(i&&n.trim()===i.name&&e?e():o(n.trim())),"Escape"===t.key&&a()},placeholder:i?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,t.jsxs)(oe,{children:[!i&&(0,t.jsx)(oa,{onClick:a,children:"Cancel"}),(0,t.jsx)(oa,{primary:!0,disabled:!n.trim(),onClick:()=>o(n.trim()),children:"Save as new"})]})]})})}let on=(0,y.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,ol=(0,y.keyframes)`
...
`,l().div`
  position: absolute;
  inset: 0;
  animation: ${os} 1.4s cubic-bezier(0.4, 0, 0.2, 1) infinite;
...
`,l().div`
  position: relative;
`;let op="260px",og="56px",oh="48px",om=l().header`
  display: flex;
  align-items: center;
  height: calc(${oh} + env(safe-area-inset-top, 0px));
  padding-top: env(safe-area-inset-top, 0px);
  ...
  @media (max-width: ${d.w4.breakpoints.md}) {
    flex-wrap: wrap;
    height: auto;
    min-height: calc(${oh} + env(safe-area-inset-top, 0px));
  }
`,of=l().div`
  width: ${og};
  min-width: ${og};
...
`,oA=l().main`
  ...
  display: flex;
  flex-direction: column;
`,oT=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function oS(){return(0,t.jsx)(ob,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:oT.map((o,e)=>(0,t.jsx)(oy,{index:e,accent:o.accent,children:o.char},e))})}let oj="atlantis:sidebar-collapsed";function oF({sidebar:o,children:e,topBarRight:n,title:l="Atlantis",activeId:d=null}){let[s,c]=(0,r.useState)(()=>{try{return"true"===localStorage.getItem(oj)}catch{return!1}}),[p,g]=(0,r.useState)(null),h=(0,r.useRef)(),m=()=>c(o=>{let e=!o;try{localStorage.setItem(oj,String(e))}catch{}return e}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(a.bind(a,5816)).then(o=>({default:o.FlyoutPanel}))),[]);return(0,t.jsx)(I.I.Provider,{value:{collapsed:s,toggle:m,flyout:p,openFlyout:(o,e,a)=>{clearTimeout(h.current),g({entry:o,anchorY:e,onSelect:a})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,t.jsxs)(oz,{children:[(0,t.jsxs)(om,{children:[o&&(0,t.jsx)(of,{children:(0,t.jsx)(ox,{onClick:m,title:s?"Expand sidebar":"Collapse sidebar",children:(0,t.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("path",{d:"M9 3v18"})]})})}),(0,t.jsx)(oS,{}),l&&(0,t.jsx)(ow,{children:l}),n&&(0,t.jsx)(o$,{children:n})]}),(0,t.jsxs)(ov,{children:[null!=o&&(0,t.jsx)(oM,{collapsed:s,children:(0,t.jsx)(ok,{children:o})}),(0,t.jsx)(oA,{children:e})]}),p&&(0,t.jsx)(i().Suspense,{fallback:null,children:(0,t.jsx)(f,{activeId:d})})]})})}l().div`
  display: grid;
  grid-template-rows: ${({open:o})=>o?"1fr":"0fr"};
