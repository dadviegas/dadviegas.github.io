"use strict";(self.webpackChunk_atlantis_school=self.webpackChunk_atlantis_school||[]).push([["3390"],{61318(e,a,o){o.d(a,{WO:()=>aN});var i=o(65723),n=o(37991),t=o(60246),r=o(36859),l=o.n(r),s=o(17681),c=o(69753),d=o(88641),m=o(41783);function p(e){try{return JSON.parse(localStorage.getItem(e)??"[]")}catch{return[]}}let g=l().nav`padding: ${t.w4.spacing.sm} 0;`,u=l().div`
...
`,P=!1;function L(e){if("u"<typeof window)return e;let a=e.match(/^var\((--[-\w]+)\)$/);return a&&getComputedStyle(document.documentElement).getPropertyValue(a[1]).trim()||e}function O({code:e}){let a=(0,n.useRef)(null),[r,l]=(0,n.useState)(null),[s,c]=(0,n.useState)(!1);return((0,n.useEffect)(()=>{let i=!1;if(l(null),c(!1),!e.trim())return void c(!0);let n=e.trim().split(/\r?\n/)[0]?.trim()??"";return/^(?:---[\s\S]*?---\s*)?(?:graph|flowchart|sequenceDiagram|classDiagram|stateDiagram(?:-v2)?|erDiagram|pie|gantt|journey|mindmap|gitGraph|sankey(?:-beta)?|quadrantChart|requirementDiagram|timeline|xychart-beta|block-beta|C4Context|C4Container|C4Component|C4Dynamic|C4Deployment)\b/.test(n)?(async function(){let n=(await o.e("6087").then(o.bind(o,29738))).default;if(P||(n.initialize({startOnLoad:!1,theme:"dark",themeVariables:{background:L(t.w4.colors.codeBg),primaryColor:L(t.w4.colors.accent),primaryTextColor:L(t.w4.colors.mainText),lineColor:L(t.w4.colors.border)}}),P=!0),a.current&&!i)try{let o=`mermaid-${Math.random().toString(36).slice(2)}`,{svg:t}=await n.render(o,e);if(i||!a.current)return;if(/aria-roledescription="error"|class="error-icon"|>Syntax error/i.test(t))return void c(!0);a.current.innerHTML=t,requestAnimationFrame(()=>{if(i||!a.current)return;let e=a.current.querySelector("svg");if(!e)return void c(!0);let o=e.getBoundingClientRect();(o.width<40||o.height<40)&&c(!0)})}catch(e){i||l(e instanceof Error?e.message:String(e))}}(),()=>{i=!0}):void c(!0)},[e]),r||s)?(0,i.jsx)(R,{children:e.trim()}):(0,i.jsx)(F,{ref:a})}let N=["#388bfd","#3fb950","#d29922","#a371f7","#f87171","#22d3ee","#fb923c","#34d399","#f472b6","#818cf8"],D=l().div`
  background: ${t.w4.colors.codeBg};
  border: 1px solid ${t.w4.colors.codeBorder};
  border-radius: ${t.w4.borderRadius.md};
  padding: ${t.w4.spacing.lg};
...
`;function eG({type:e,children:a}){let o=eN[e]??eN.NOTE,n=o.icon;return(0,i.jsxs)(eD,{bg:o.bg,border:o.border,children:[(0,i.jsxs)(eH,{color:o.color,children:[(0,i.jsx)(n,{size:15,strokeWidth:2}),o.label]}),(0,i.jsx)(eI,{children:a})]})}let eW=l().nav`
  width: 220px;
  min-width: 220px;
...
`,aP={en:"Browse the sidebar",pt:"Explora o menu lateral"};function aL({title:e,sub:a,lang:o}){return(0,i.jsxs)(aS,{children:[(0,i.jsx)(aT,{}),(0,i.jsx)(aM,{size:500,x:10,y:-10,hue:210,dur:7}),(0,i.jsx)(aM,{size:400,x:60,y:50,hue:270,dur:9}),(0,i.jsx)(aM,{size:300,x:30,y:70,hue:190,dur:6}),(0,i.jsxs)(aC,{children:[(0,i.jsx)(aB,{children:e}),(0,i.jsx)(aE,{children:a}),(0,i.jsxs)(aF,{children:[(0,i.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round",children:(0,i.jsx)("polyline",{points:"15 18 9 12 15 6"})}),aP[o]??aP.en]})]})]})}function aO(e,a,o){return"string"==typeof e?e:e[a]??e[o]??Object.values(e)[0]??""}function aN({navigation:e,languages:a,defaultLang:o,locale:r,hashPrefix:l,topBarRight:c,welcomeTitle:d="Blog",welcomeSub:m="Notes, guides, and references — pick a topic from the sidebar to get started."}){let p=a?Object.keys(a):[];p.length;let[g,u]=(0,n.useState)(()=>o??p[0]??"");(0,n.useEffect)(()=>{r&&p.includes(r)&&r!==g&&u(r)},[r]);let f=(0,n.useMemo)(()=>a&&g?a[g].navigation:e??{entries:[]},[a,e,g]);(0,n.useMemo)(()=>aj(f.entries),[f]);let y=(0,n.useCallback)(e=>{let a=e.match(RegExp(`^#\\/${l}\\/(.+)$`));if(a)return aA(f.entries,a[1])},[f,l]),[h,x]=(0,n.useState)(()=>y(window.location.hash)??null);(0,n.useEffect)(()=>{h&&x(aA(f.entries,h.id)??null)},[g,f]),(0,n.useEffect)(()=>{let e=()=>{let e=y(window.location.hash);e&&x(e)};return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[y]);let b=(0,n.useCallback)(e=>{e.file&&(x(e),window.location.hash=`#/${l}/${e.id}`)},[l]),w=(0,n.useMemo)(()=>aj(f.entries),[f]),$=w.findIndex(e=>e.id===h?.id),z=$>0?w[$-1]:null,v=$<w.length-1?w[$+1]:null,[k,j]=(0,n.useState)(!1),[S,M]=(0,n.useState)(null);(0,n.useEffect)(()=>{let e=e=>{(e.metaKey||e.ctrlKey)&&"f"===e.key&&(e.preventDefault(),j(!0))};return window.addEventListener("keydown",e),()=>window.removeEventListener("keydown",e)},[]);let T=h?.label??h?.name??l,C=aO(d,g,o??p[0]??""),B=aO(m,g,o??p[0]??""),E=(0,i.jsxs)(aR,{onClick:()=>j(!0),title:"Pesquisar (Ctrl+F)",children:[(0,i.jsx)(s.A,{size:14}),(0,i.jsx)("span",{children:"Pesquisar"}),(0,i.jsx)("kbd",{children:"⌘F"})]}),F=(0,i.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:"8px"},children:[E,c]});return(0,i.jsxs)(t.PE,{title:T,activeId:h?.id??null,topBarRight:F,sidebar:(0,i.jsx)(A,{config:f,activeId:h?.id??null,onSelect:b,hashPrefix:l}),children:[h?.file?(0,i.jsx)(e5,{file:h.file,prevEntry:z,nextEntry:v,onNavigate:b,scrollToId:S,onScrolled:()=>M(null)}):(0,i.jsx)(aL,{title:C,sub:B,lang:g}),(0,i.jsx)(ak,{open:k,onClose:()=>j(!1),entries:f.entries,activeId:h?.id??null,onSelect:(e,a)=>{b(e),M(a??null)}})]})}l().div`
  display: flex;
  gap: 4px;
  background: ${t.w4.colors.surface};
  border: 1px solid ${t.w4.colors.border};
...
`},48859(e,a,o){o.d(a,{FlyoutPanel:()=>b});var i=o(65723),n=o(37991),t=o.n(n),r=o(36859),l=o.n(r),s=o(72799),c=o(20255),d=o(81316),m=o(40814),p=o(96140);let g=(0,s.keyframes)`
...
`;function h({iconKey:e}){let a=e?p.t[e]??c.A:c.A;return(0,i.jsx)(a,{size:14,strokeWidth:1.75})}function x({entries:e,activeId:a,onSelect:o}){return(0,i.jsx)(i.Fragment,{children:e.map(e=>e.children?(0,i.jsx)(t().Fragment,{children:(0,i.jsx)(x,{entries:e.children,activeId:a,onSelect:o})},e.id):(0,i.jsxs)(y,{active:a===e.id,onClick:()=>o(e),children:[(0,i.jsx)(h,{iconKey:e.icon}),e.name]},e.id))})}function b({activeId:e}){let{flyout:a,scheduleFlyoutClose:o,cancelFlyoutClose:n}=(0,m.c)();if(!a)return null;let t=a.entry.icon?p.t[a.entry.icon]??c.A:c.A;return(0,i.jsxs)(u,{anchorY:a.anchorY,onMouseEnter:n,onMouseLeave:o,children:[(0,i.jsxs)(f,{children:[(0,i.jsx)(t,{size:13,strokeWidth:2}),a.entry.name]}),(0,i.jsx)(x,{entries:a.entry.children??[],activeId:e,onSelect:e=>{a.onSelect(e),o()}})]})}},40814(e,a,o){o.d(a,{I:()=>n,c:()=>t});var i=o(37991);let n=(0,i.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),t=()=>(0,i.useContext)(n)},96140(e,a,o){o.d(a,{t:()=>ex});var i=o(36896),n=o(87902),t=o(53013),r=o(32887),l=o(49510),s=o(39848),c=o(37901),d=o(3045),m=o(43775),p=o(41783),g=o(83539),u=o(39416),f=o(1837),y=o(57167),h=o(84494),x=o(82314),b=o(20255),w=o(35751),$=o(69633),z=o(92946),v=o(40822),k=o(36720),A=o(57400),j=o(58456),S=o(43317),M=o(52709),T=o(8006),C=o(89301),B=o(37561),E=o(83517),F=o(28207),R=o(37032),P=o(6949),L=o(8218),O=o(36829),N=o(59591),D=o(15553),H=o(69923),I=o(72820),G=o(14621),W=o(68479),Y=o(72534),V=o(66673),K=o(67490),_=o(49033),J=o(99038),U=o(45775),q=o(31365),Z=o(62937),X=o(9821),Q=o(65912),ee=o(80158),ea=o(88641),eo=o(48607),ei=o(83249),en=o(1821),et=o(15889),er=o(89655),el=o(27170),es=o(19161),ec=o(71849),ed=o(41604),em=o(13142),ep=o(61187),eg=o(77747),eu=o(2932),ef=o(24525),ey=o(57230),eh=o(22164);let ex={activity:i.A,"a-large-small":n.A,apple:t.A,"arrow-right":r.A,"bar-chart-2":l.A,book:s.A,"book-open":c.A,briefcase:d.A,calendar:m.A,clock:p.A,"circle-dot":g.A,cloud:u.A,compass:f.A,cpu:y.A,droplets:h.A,feather:x.A,file:b.A,"file-text":w.A,folder:$.A,"git-branch":z.A,github:v.A,globe:k.A,grid:A.A,hand:j.A,hash:S.A,heart:M.A,key:T.A,hexagon:C.A,home:B.A,landmark:E.A,layers:F.A,"layout-grid":R.A,leaf:P.A,lightbulb:L.A,list:O.A,map:N.A,"map-pin":D.A,"message-circle":H.A,"message-square":I.A,minus:G.A,monitor:W.A,mountain:Y.A,package:V.A,palette:K.A,"pen-tool":_.A,"pie-chart":J.A,plane:U.A,plus:q.A,ruler:Z.A,shirt:X.A,slash:Q.A,square:ee.A,star:ea.A,sun:eo.A,terminal:ei.A,thermometer:en.A,triangle:et.A,trophy:er.A,truck:el.A,type:es.A,users:ec.A,"volume-2":ed.A,watch:em.A,waves:ep.A,wind:eg.A,wrench:eu.A,x:ef.A,zap:ey.A,bot:eh.A}},60246(e,a,o){o.d(a,{w4:()=>i.w4,cL:()=>m.c,CD:()=>K,PE:()=>B,Is:()=>J.putSetting,PL:()=>J.getSetting});var i=o(81316),n=o(65723),t=o(37991),r=o.n(t),l=o(36859),s=o.n(l);s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,s().div`
  position: relative;
`;var c=o(72799),d=o(73661),m=o(40814);let p="260px",g="56px",u="48px",f=s().header`
  display: flex;
  align-items: center;
...
`,S=s().main`
  ...
  display: flex;
  flex-direction: column;
`,M=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function T(){return(0,n.jsx)(b,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:M.map((e,a)=>(0,n.jsx)(w,{index:a,accent:e.accent,children:e.char},a))})}let C="atlantis:sidebar-collapsed";function B({sidebar:e,children:a,topBarRight:i,title:l="Atlantis",activeId:s=null}){let[c,p]=(0,t.useState)(()=>{try{return"true"===localStorage.getItem(C)}catch{return!1}}),[g,u]=(0,t.useState)(null),x=(0,t.useRef)(),b=()=>p(e=>{let a=!e;try{localStorage.setItem(C,String(a))}catch{}return a}),w=r().useMemo(()=>r().lazy(()=>Promise.resolve().then(o.bind(o,48859)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,n.jsx)(m.I.Provider,{value:{collapsed:c,toggle:b,flyout:g,openFlyout:(e,a,o)=>{clearTimeout(x.current),u({entry:e,anchorY:a,onSelect:o})},scheduleFlyoutClose:()=>{x.current=setTimeout(()=>u(null),160)},cancelFlyoutClose:()=>clearTimeout(x.current)},children:(0,n.jsxs)(k,{children:[(0,n.jsxs)(f,{children:[e&&(0,n.jsx)(y,{children:(0,n.jsx)(h,{onClick:b,title:c?"Expand sidebar":"Collapse sidebar",children:(0,n.jsx)(d.A,{size:17})})}),(0,n.jsx)(T,{}),l&&(0,n.jsx)($,{children:l}),i&&(0,n.jsx)(z,{children:i})]}),(0,n.jsxs)(v,{children:[null!=e&&(0,n.jsx)(A,{collapsed:c,children:(0,n.jsx)(j,{children:e})}),(0,n.jsx)(S,{children:a})]}),g&&(0,n.jsx)(r().Suspense,{fallback:null,children:(0,n.jsx)(w,{activeId:s})})]})})}var E=o(20255),F=o(69753),R=o(96140);let P=s().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
...
`;function Y({iconKey:e,size:a=16}){if(e&&!(e in R.t))return(0,n.jsx)("span",{style:{fontSize:a,lineHeight:1,display:"flex",alignItems:"center"},children:e});let o=e?R.t[e]??E.A:E.A;return(0,n.jsx)(o,{size:a,strokeWidth:1.75})}function V({entry:e,activeId:a,onSelect:o}){let[i,r]=(0,t.useState)(e.defaultOpen??!0),{collapsed:l,openFlyout:s,scheduleFlyoutClose:c,cancelFlyoutClose:d}=(0,m.c)();return e.children&&e.children.length>0?(0,n.jsxs)(N,{children:[(0,n.jsxs)(D,{collapsed:l,onClick:()=>{l||r(e=>!e)},onMouseEnter:l?a=>{s(e,a.currentTarget.getBoundingClientRect().top,o)}:void 0,onMouseLeave:l?c:void 0,children:[(0,n.jsxs)(H,{collapsed:l,children:[(0,n.jsx)(Y,{iconKey:e.icon,size:16}),(0,n.jsx)(I,{collapsed:l,children:e.name})]}),(0,n.jsx)(G,{open:i,collapsed:l,children:(0,n.jsx)(F.A,{size:13})})]}),(0,n.jsx)(P,{open:i&&!l,children:(0,n.jsx)(L,{children:(0,n.jsx)(O,{children:e.children.map(e=>(0,n.jsx)(V,{entry:e,activeId:a,onSelect:o},e.id))})})})]}):(0,n.jsxs)(W,{active:a===e.id,collapsed:l,onClick:()=>o(e),onMouseEnter:l?a=>{let i=a.currentTarget.getBoundingClientRect();s({id:e.id,name:e.name,icon:e.icon,file:e.file,children:[e]},i.top,o)}:void 0,onMouseLeave:l?c:void 0,children:[(0,n.jsx)(Y,{iconKey:e.icon,size:15}),(0,n.jsx)(I,{collapsed:l,children:e.name})]})}function K({entries:e,activeId:a,onSelect:o}){return(0,n.jsx)("div",{children:e.map(e=>(0,n.jsx)(V,{entry:e,activeId:a,onSelect:o},e.id))})}let _=(0,c.keyframes)`
...
`;s().div`
  ...
  background: ${i.w4.colors.mainBg};
  font-family: ${i.w4.typography.fontFamily};
  animation: ${Z} 0.4s ease 0.15s both;
`,s().div`
  position: relative;
  width: 56px;
  height: 56px;
