...
`,l().aside`
  ...
  display: flex;
  flex-direction: column;
  animation: ${J} 0.22s cubic-bezier(0.4, 0, 0.2, 1) both;
...
`,em=l().div`
  ...
  color: ${d.w4.colors.sidebarTextMuted};
  font-family: ${d.w4.typography.fontFamily};
`;function eh({onSave:e,onUpdate:o,onCancel:t,existingDoc:i}){let[n,l]=(0,r.useState)(i?.name??""),d=(0,r.useRef)(null);return(0,r.useEffect)(()=>{d.current?.focus(),i&&d.current?.select()},[i]),(0,a.jsx)(en,{onClick:t,children:(0,a.jsxs)(el,{onClick:e=>e.stopPropagation(),children:[(0,a.jsx)(ed,{children:"Save document"}),i&&o&&(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(em,{children:"Update the current version or save as a new one."}),(0,a.jsxs)(ec,{children:[(0,a.jsx)(ep,{onClick:t,children:"Cancel"}),(0,a.jsxs)(ep,{danger:!0,onClick:o,children:['Update "',i.name,'"']})]}),(0,a.jsx)(eg,{})]}),(0,a.jsx)(es,{ref:d,value:n,onChange:e=>l(e.target.value),onKeyDown:a=>{"Enter"===a.key&&n.trim()&&(i&&n.trim()===i.name&&o?o():e(n.trim())),"Escape"===a.key&&t()},placeholder:i?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,a.jsxs)(ec,{children:[!i&&(0,a.jsx)(ep,{onClick:t,children:"Cancel"}),(0,a.jsx)(ep,{primary:!0,disabled:!n.trim(),onClick:()=>e(n.trim()),children:"Save as new"})]})]})})}let ef=(0,S.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,ex=(0,S.keyframes)`
...
`,l().div`
  position: relative;
`;let ew="260px",ev="56px",e$="48px",ez=l().header`
  display: flex;
  align-items: center;
...
`,eS=l().span`
  ...
  animation: ${eA} 10s ease ${({index:e})=>.07*e}s infinite;
...
`,eR=l().main`
  ...
  display: flex;
  flex-direction: column;
`,eE=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function eP(){return(0,a.jsx)(eT,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:eE.map((e,o)=>(0,a.jsx)(eS,{index:o,accent:e.accent,children:e.char},o))})}let eV="atlantis:sidebar-collapsed";function eD({sidebar:e,children:o,topBarRight:n,title:l="Atlantis",activeId:d=null}){let[s,c]=(0,r.useState)(()=>{try{return"true"===localStorage.getItem(eV)}catch{return!1}}),[p,g]=(0,r.useState)(null),m=(0,r.useRef)(),h=()=>c(e=>{let o=!e;try{localStorage.setItem(eV,String(o))}catch{}return o}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(t.bind(t,5816)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,a.jsx)(U.I.Provider,{value:{collapsed:s,toggle:h,flyout:p,openFlyout:(e,o,t)=>{clearTimeout(m.current),g({entry:e,anchorY:o,onSelect:t})},scheduleFlyoutClose:()=>{m.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(m.current)},children:(0,a.jsxs)(eF,{children:[(0,a.jsxs)(ez,{children:[e&&(0,a.jsx)(eM,{children:(0,a.jsx)(ek,{onClick:h,title:s?"Expand sidebar":"Collapse sidebar",children:(0,a.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,a.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,a.jsx)("path",{d:"M9 3v18"})]})})}),(0,a.jsx)(eP,{}),l&&(0,a.jsx)(ej,{children:l}),n&&(0,a.jsx)(eB,{children:n})]}),(0,a.jsxs)(eC,{children:[null!=e&&(0,a.jsx)(eL,{collapsed:s,children:(0,a.jsx)(eH,{children:e})}),(0,a.jsx)(eR,{children:o})]}),p&&(0,a.jsx)(i().Suspense,{fallback:null,children:(0,a.jsx)(f,{activeId:d})})]})})}l().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
