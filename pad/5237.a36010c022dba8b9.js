"use strict";(self.webpackChunk_atlantis_pad=self.webpackChunk_atlantis_pad||[]).push([["5237"],{53804(e,o,a){a.d(o,{M:()=>x});var t=a(65723);a(37991);var r=a(36859),i=a.n(r),n=a(23930),l=a(85399);let s=i().div`
  display: flex;
...
`;function x({value:e,onChange:o,collapsed:a,onToggleCollapse:r,scrollRef:i,onScroll:n}){return a?(0,t.jsx)("div",{style:{position:"relative",flexShrink:0},children:(0,t.jsxs)(m,{onClick:r,title:"Show editor",children:[(0,t.jsx)(l.In,{name:"panel-left-open",size:14}),(0,t.jsx)(f,{children:"Editor"})]})}):(0,t.jsxs)(s,{collapsed:!1,children:[(0,t.jsxs)(d,{children:[(0,t.jsx)(c,{children:"Editor"}),(0,t.jsx)(p,{onClick:r,title:"Collapse editor",children:(0,t.jsx)(l.In,{name:"panel-left-close",size:15})})]}),(0,t.jsx)(g,{ref:i,value:e,onChange:e=>o(e.target.value),onScroll:n,placeholder:"Write markdown here…",spellCheck:!1})]})}},7279(e,o,a){a.d(o,{H:()=>u});var t=a(65723),r=a(37991),i=a(36859),n=a.n(i),l=a(23930),s=a(85399);let d=[{id:"showcase",label:"Full Showcase",description:"All supported features in one document",content:`# Markdown Editor — Feature Showcase
...
`,f=n().div`
  position: relative;
`;function x({onSelect:e}){let[o,a]=(0,r.useState)(!1),i=(0,r.useRef)(null);return(0,r.useEffect)(()=>{if(!o)return;let e=e=>{i.current&&!i.current.contains(e.target)&&a(!1)};return document.addEventListener("mousedown",e),()=>document.removeEventListener("mousedown",e)},[o]),(0,t.jsxs)(f,{ref:i,children:[(0,t.jsxs)(c,{onClick:()=>a(e=>!e),children:[(0,t.jsx)(s.In,{name:"book-open",size:14}),"Examples",(0,t.jsx)(s.In,{name:"chevron-down",size:13,style:{marginLeft:2}})]}),(0,t.jsxs)(p,{open:o,children:[(0,t.jsx)(g,{children:"Load a diagram"}),d.map(o=>(0,t.jsx)(m,{onClick:()=>{e(o.code),a(!1)},children:o.label},o.label))]})]})}},65320(e,o,a){a.d(o,{u:()=>w});var t=a(65723),r=a(37991),i=a(36859),n=a.n(i),l=a(23930),s=a(85399),d=a(29738);d.default.initialize({startOnLoad:!1,theme:"dark",securityLevel:"loose"});let c=`
...
`,b=n().span`
  ...
  font-family: ${l.w4.typography.fontFamily};
  writing-mode: vertical-rl;
`;function w({code:e,collapsed:o,onToggleCollapse:a}){let[i,n]=(0,r.useState)(""),[l,c]=(0,r.useState)(null),y=(0,r.useRef)(0),$=(0,r.useCallback)(async e=>{if(!e.trim()){n(""),c(null);return}let o=++y.current;try{let a="mermaid-"+Date.now(),{svg:t}=await d.default.render(a,e);y.current===o&&(n(t),c(null))}catch(e){y.current===o&&(c(e instanceof Error?e.message:String(e)),n(""))}},[]);return((0,r.useEffect)(()=>{let o=setTimeout(()=>$(e),300);return()=>clearTimeout(o)},[e,$]),o)?(0,t.jsxs)(u,{onClick:a,title:"Show preview",children:[(0,t.jsx)(s.In,{name:"panel-right-open",size:14}),(0,t.jsx)(b,{children:"Preview"})]}):(0,t.jsxs)(p,{children:[(0,t.jsxs)(g,{children:[(0,t.jsx)(m,{children:"Preview"}),(0,t.jsx)(f,{onClick:a,title:"Collapse preview",children:(0,t.jsx)(s.In,{name:"panel-right-close",size:15})})]}),l&&(0,t.jsxs)(h,{children:[(0,t.jsx)(s.In,{name:"alert-circle",size:14,style:{flexShrink:0,marginTop:1}}),l]}),(0,t.jsx)(x,{dangerouslySetInnerHTML:{__html:i}})]})}},2099(e,o,a){a.d(o,{r:()=>z});var t=a(65723);a(37991);var r=a(11352),i=a(76710),n=a(4311),l=a(73639),s=a(8411);a(75406);var d=a(36859),c=a.n(d),p=a(23930),g=a(85399),m=a(49685);function f(){return e=>{!function e(o){if("blockquote"===o.type){let e=o.children?.[0];if(e?.type==="paragraph"){let a=e.children?.[0];if(a?.type==="text"){let t=a.value?.match(/^\[!(NOTE|TIP|WARNING|CAUTION|IMPORTANT)\]\s*/i);t&&(a.value=a.value.slice(t[0].length),a.value.trim()||1!==e.children.length||o.children.shift(),o.data=o.data??{},o.data.hName="div",o.data.hProperties={"data-callout":t[1].toUpperCase()})}}}o.children?.forEach(e)}(e)}}let x=c().div`
  display: flex;
  flex-direction: column;
  flex: 1;
  min-width: 0;
...
`,c=!1;function p(e){if("u"<typeof window)return e;let o=e.match(/^var\((--[-\w]+)\)$/);return o&&getComputedStyle(document.documentElement).getPropertyValue(o[1]).trim()||e}function g({code:e}){let o=(0,r.useRef)(null),[n,l]=(0,r.useState)(null),[m,f]=(0,r.useState)(!1);return((0,r.useEffect)(()=>{let t=!1;if(l(null),f(!1),!e.trim())return void f(!0);let r=e.trim().split(/\r?\n/)[0]?.trim()??"";return/^(?:---[\s\S]*?---\s*)?(?:graph|flowchart|sequenceDiagram|classDiagram|stateDiagram(?:-v2)?|erDiagram|pie|gantt|journey|mindmap|gitGraph|sankey(?:-beta)?|quadrantChart|requirementDiagram|timeline|xychart-beta|block-beta|C4Context|C4Container|C4Component|C4Dynamic|C4Deployment)\b/.test(r)?(async function(){let r=(await Promise.resolve().then(a.bind(a,29738))).default;if(c||(r.initialize({startOnLoad:!1,theme:"dark",themeVariables:{background:p(i.w4.colors.codeBg),primaryColor:p(i.w4.colors.accent),primaryTextColor:p(i.w4.colors.mainText),lineColor:p(i.w4.colors.border)}}),c=!0),o.current&&!t)try{let a=`mermaid-${"u">typeof crypto&&"function"==typeof crypto.randomUUID?crypto.randomUUID().replace(/-/g,"").slice(0,8):Math.random().toString(36).slice(2,10).padEnd(8,"0")}`,{svg:i}=await r.render(a,e);if(t||!o.current)return;if(/aria-roledescription="error"/i.test(i))return void f(!0);o.current.innerHTML=i,requestAnimationFrame(()=>{if(t||!o.current)return;let e=o.current.querySelector("svg");if(!e)return void f(!0);let a=e.getBoundingClientRect();a.width<2&&a.height<2&&f(!0)})}catch(e){t||l(e instanceof Error?e.message:String(e))}}(),()=>{t=!0}):void f(!0)},[e]),n||m)?(0,t.jsx)(d,{children:e.trim()}):(0,t.jsx)(s,{ref:o})}let m=["#388bfd","#3fb950","#d29922","#a371f7","#f87171","#22d3ee","#fb923c","#34d399","#f472b6","#818cf8"],f=l().div`
  background: ${i.w4.colors.codeBg};
  border: 1px solid ${i.w4.colors.codeBorder};
  border-radius: ${i.w4.borderRadius.md};
  padding: ${i.w4.spacing.lg};
...
`,B=l().div`
  ...
  color: ${i.w4.colors.mainText};
  text-align: center;
`;function C(e){return e.toString().padStart(2,"0")}function R({hours:e,minutes:o,seconds:a}){let r=e=>e*Math.PI/180,n=a/60*360-90,l=o/60*360+a/60*6-90,s=e%12/12*360+o/60*30-90,d=100+61*Math.cos(r(n)),c=100+61*Math.sin(r(n)),p=100+65*Math.cos(r(l)),g=100+65*Math.sin(r(l)),m=100+45*Math.cos(r(s)),f=100+45*Math.sin(r(s));return(0,t.jsxs)("svg",{viewBox:"0 0 200 200",width:200,height:200,children:[(0,t.jsx)("circle",{cx:100,cy:100,r:85,fill:i.w4.colors.surface,stroke:i.w4.colors.border,strokeWidth:2}),Array.from({length:12},(e,o)=>{let a=o+1,n=a/12*360-90,l=100+69*Math.cos(r(n)),s=100+69*Math.sin(r(n));return(0,t.jsx)("text",{x:l,y:s+4,fill:i.w4.colors.mainText,fontSize:14,fontWeight:600,textAnchor:"middle",fontFamily:i.w4.typography.fontFamily,children:a},a)}),Array.from({length:60},(e,o)=>{let a=o/60*360-90,n=o%5==0,l=n?75:79;return(0,t.jsx)("line",{x1:100+l*Math.cos(r(a)),y1:100+l*Math.sin(r(a)),x2:100+83*Math.cos(r(a)),y2:100+83*Math.sin(r(a)),stroke:n?i.w4.colors.mainTextMuted:i.w4.colors.border,strokeWidth:n?2:1},o)}),(0,t.jsx)("line",{x1:100,y1:100,x2:m,y2:f,stroke:i.w4.colors.mainText,strokeWidth:4,strokeLinecap:"round"}),(0,t.jsx)("line",{x1:100,y1:100,x2:p,y2:g,stroke:i.w4.colors.accent,strokeWidth:2.5,strokeLinecap:"round"}),(0,t.jsx)("line",{x1:100-12*Math.cos(r(n)),y1:100-12*Math.sin(r(n)),x2:d,y2:c,stroke:"#f87171",strokeWidth:1.2,strokeLinecap:"round"}),(0,t.jsx)("circle",{cx:100,cy:100,r:4,fill:i.w4.colors.accent}),(0,t.jsx)("circle",{cx:100,cy:100,r:2,fill:"#f87171"})]})}function L({code:e}){let o=function(e){let o="pt";for(let a of e.trim().split("\n")){let[e,...t]=a.split(":"),r=t.join(":").trim();"locale"===e.trim().toLowerCase()&&(o=r.toLowerCase())}return{locale:o}}(e),[a,i]=(0,r.useState)("live"),[n,l]=(0,r.useState)(()=>new Date().getHours()),[s,d]=(0,r.useState)(()=>new Date().getMinutes()),[c,p]=(0,r.useState)(()=>new Date().getSeconds());(0,r.useEffect)(()=>{if("live"!==a)return;let e=()=>{let e=new Date;l(e.getHours()),d(e.getMinutes()),p(e.getSeconds())};e();let o=setInterval(e,1e3);return()=>clearInterval(o)},[a]);let g=(0,r.useCallback)(e=>{i("manual"),p(0),l(o=>((o+e)%24+24)%24)},[]),m=(0,r.useCallback)(e=>{i("manual"),p(0),d(o=>((o+e)%60+60)%60)},[]),f=(0,r.useCallback)(()=>i("live"),[]);return(0,t.jsxs)(M,{children:[(0,t.jsxs)(A,{children:[(0,t.jsx)(R,{hours:n,minutes:s,seconds:c}),(0,t.jsxs)("div",{children:[(0,t.jsxs)(j,{children:[C(n),":",C(s),(0,t.jsxs)("span",{style:{fontSize:"24px",opacity:.5},children:[":",C(c)]})]}),(0,t.jsx)(B,{children:function(e,o,a){if("pt"===a){let a=1===e?"1 hora":`${e} horas`;return 0===o?a:15===o?`${a} e um quarto`:30===o?`${a} e meia`:45===o?`um quarto para as ${12===e?1:e+1}`:`${a} e ${o} minutos`}let t=e<12?"AM":"PM",r=e%12||12;return 0===o?`${r} o'clock ${t}`:15===o?`quarter past ${r} ${t}`:30===o?`half past ${r} ${t}`:45===o?`quarter to ${r%12+1} ${t}`:`${r}:${C(o)} ${t}`}(n%12||12,s,o.locale)})]})]}),(0,t.jsxs)(T,{children:[(0,t.jsx)(S,{onClick:()=>g(-1),children:"−1h"}),(0,t.jsx)(S,{onClick:()=>g(1),children:"+1h"}),(0,t.jsx)(S,{onClick:()=>m(-15),children:"−15m"}),(0,t.jsx)(S,{onClick:()=>m(15),children:"+15m"}),(0,t.jsx)(S,{onClick:()=>m(-5),children:"−5m"}),(0,t.jsx)(S,{onClick:()=>m(5),children:"+5m"}),(0,t.jsx)(S,{active:"live"===a,onClick:f,children:"pt"===o.locale?"Agora":"Now"})]}),(0,t.jsx)(F,{children:"pt"===o.locale?"Usa os bot\xf5es para mudar as horas e os minutos!":"Use the buttons to change the hours and minutes!"}),(0,t.jsx)(T,{children:[{label:"3:00",h:3,m:0},{label:"6:30",h:6,m:30},{label:"9:15",h:9,m:15},{label:"12:00",h:12,m:0},{label:"13:45",h:13,m:45},{label:"15:30",h:15,m:30},{label:"19:00",h:19,m:0},{label:"23:15",h:23,m:15}].map(e=>(0,t.jsx)(S,{onClick:()=>{i("manual"),l(e.h),d(e.m)},children:e.label},e.label))})]})}var P=a(72799);let E=(0,P.keyframes)`
...
`,l().span`
  font-size: ${i.w4.typography.fontSizeBase};
  color: ${i.w4.colors.mainTextMuted};
`;var D=a(17223),I=a(21426),N=a(25609),V=a(20320);let K=l().div`
  margin: ${i.w4.spacing.lg} 0;
  border-radius: ${i.w4.borderRadius.md};
  border: 1px solid ${i.w4.colors.codeBorder};
  overflow: hidden;
...
`,Y={...I.A,'pre[class*="language-"]':{...I.A['pre[class*="language-"]'],background:i.w4.colors.codeBg,margin:0,padding:"18px 20px",fontSize:"13px",lineHeight:"1.6",borderRadius:0},'code[class*="language-"]':{...I.A['code[class*="language-"]'],background:"none",fontSize:"13px"}};function U({lang:e="text",code:o}){let[a,n]=(0,r.useState)(!1);return(0,t.jsxs)(K,{children:[(0,t.jsxs)(W,{children:[(0,t.jsx)(G,{children:e}),(0,t.jsxs)(O,{copied:a,onClick:()=>{navigator.clipboard.writeText(o).then(()=>{n(!0),setTimeout(()=>n(!1),2e3)})},children:[a?(0,t.jsx)(N.A,{size:12}):(0,t.jsx)(V.A,{size:12}),a?"Copied!":"Copy"]})]}),(0,t.jsx)(D.A,{language:e,style:Y,showLineNumbers:o.split("\n").length>8,lineNumberStyle:{color:"#484f58",minWidth:"2.5em",paddingRight:"1.5em",userSelect:"none",fontSize:"12px"},customStyle:{margin:0,background:i.w4.colors.codeBg},wrapLongLines:!1,children:o})]})}l().div`
  background: ${({bg:e})=>e};
...
`,l().span`
  ...
  font-weight: 600;
  margin-left: auto;
`},87330(e,o,a){a.d(o,{FlyoutPanel:()=>eL});var t=a(65723),r=a(37991),i=a.n(r),n=a(36859),l=a.n(n),s=a(72799),d=a(81316),c=a(40814),p=a(36896),g=a(87902),m=a(53013),f=a(32887),x=a(49510),h=a(39848),u=a(37901),b=a(3045),w=a(43775),y=a(41783),$=a(83539),v=a(39416),z=a(1837),k=a(57167),M=a(84494),A=a(82314),j=a(20255),T=a(35751),S=a(69633),F=a(92946),B=a(40822),C=a(36720),R=a(57400),L=a(58456),P=a(43317),E=a(52709),H=a(8006),D=a(89301),I=a(37561),N=a(83517),V=a(28207),K=a(37032),W=a(6949),G=a(8218),O=a(36829),Y=a(59591),U=a(15553),_=a(69923),q=a(72820),J=a(14621),Z=a(68479),X=a(72534),Q=a(66673),ee=a(67490),eo=a(49033),ea=a(99038),et=a(45775),er=a(31365),ei=a(62937),en=a(9821),el=a(65912),es=a(80158),ed=a(88641),ec=a(48607),ep=a(83249),eg=a(1821),em=a(15889),ef=a(89655),ex=a(27170),eh=a(19161),eu=a(71849),eb=a(41604),ew=a(13142),ey=a(61187),e$=a(77747),ev=a(2932),ez=a(24525),ek=a(57230),eM=a(22164);let eA={activity:p.A,"a-large-small":g.A,apple:m.A,"arrow-right":f.A,"bar-chart-2":x.A,book:h.A,"book-open":u.A,briefcase:b.A,calendar:w.A,clock:y.A,"circle-dot":$.A,cloud:v.A,compass:z.A,cpu:k.A,droplets:M.A,feather:A.A,file:j.A,"file-text":T.A,folder:S.A,"git-branch":F.A,github:B.A,globe:C.A,grid:R.A,hand:L.A,hash:P.A,heart:E.A,key:H.A,hexagon:D.A,home:I.A,landmark:N.A,layers:V.A,"layout-grid":K.A,leaf:W.A,lightbulb:G.A,list:O.A,map:Y.A,"map-pin":U.A,"message-circle":_.A,"message-square":q.A,minus:J.A,monitor:Z.A,mountain:X.A,package:Q.A,palette:ee.A,"pen-tool":eo.A,"pie-chart":ea.A,plane:et.A,plus:er.A,ruler:ei.A,shirt:en.A,slash:el.A,square:es.A,star:ed.A,sun:ec.A,terminal:ep.A,thermometer:eg.A,triangle:em.A,trophy:ef.A,truck:ex.A,type:eh.A,users:eu.A,"volume-2":eb.A,watch:ew.A,waves:ey.A,wind:e$.A,wrench:ev.A,x:ez.A,zap:ek.A,bot:eM.A},ej=(0,s.keyframes)`
...
`,eT=l().div`
  ...
  min-width: 210px;
  overflow-y: auto;
  animation: ${ej} 0.18s cubic-bezier(0.22, 1, 0.36, 1) forwards;
...
`,eB=({size:e=14,strokeWidth:o=1.75})=>(0,t.jsxs)("svg",{width:e,height:e,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:o,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,t.jsx)("polyline",{points:"14 2 14 8 20 8"})]});function eC({iconKey:e}){let o=e?eA[e]:null;return o?(0,t.jsx)(o,{size:14,strokeWidth:1.75}):(0,t.jsx)(eB,{})}function eR({entries:e,activeId:o,onSelect:a}){return(0,t.jsx)(t.Fragment,{children:e.map(e=>e.children?(0,t.jsx)(i().Fragment,{children:(0,t.jsx)(eR,{entries:e.children,activeId:o,onSelect:a})},e.id):(0,t.jsxs)(eF,{active:o===e.id,onClick:()=>a(e),children:[(0,t.jsx)(eC,{iconKey:e.icon}),e.name]},e.id))})}function eL({activeId:e}){let{flyout:o,scheduleFlyoutClose:a,cancelFlyoutClose:r}=(0,c.c)();if(!o)return null;let i=o.entry.icon?eA[o.entry.icon]:null;return(0,t.jsxs)(eT,{anchorY:o.anchorY,onMouseEnter:r,onMouseLeave:a,children:[(0,t.jsxs)(eS,{children:[i?(0,t.jsx)(i,{size:13,strokeWidth:2}):(0,t.jsx)(eB,{size:13,strokeWidth:2}),o.entry.name]}),(0,t.jsx)(eR,{entries:o.entry.children??[],activeId:e,onSelect:e=>{o.onSelect(e),a()}})]})}},40814(e,o,a){a.d(o,{I:()=>r,c:()=>i});var t=a(37991);let r=(0,t.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),i=()=>(0,t.useContext)(r)},23930(e,o,a){a.d(o,{PL:()=>C.getSetting,MJ:()=>V,mZ:()=>C.updateDoc,KL:()=>C.saveDoc,cL:()=>c.c,Is:()=>C.putSetting,UO:()=>eo,PE:()=>F,w4:()=>t.w4});var t=a(81316),r=a(65723),i=a(37991),n=a.n(i),l=a(36859),s=a.n(l);s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,N=s().div`
  ...
  color: ${t.w4.colors.sidebarTextMuted};
  font-family: ${t.w4.typography.fontFamily};
`;function V({onSave:e,onUpdate:o,onCancel:a,existingDoc:t}){let[n,l]=(0,i.useState)(t?.name??""),s=(0,i.useRef)(null);return(0,i.useEffect)(()=>{s.current?.focus(),t&&s.current?.select()},[t]),(0,r.jsx)(R,{onClick:a,children:(0,r.jsxs)(L,{onClick:e=>e.stopPropagation(),children:[(0,r.jsx)(P,{children:"Save document"}),t&&o&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(N,{children:"Update the current version or save as a new one."}),(0,r.jsxs)(H,{children:[(0,r.jsx)(D,{onClick:a,children:"Cancel"}),(0,r.jsxs)(D,{danger:!0,onClick:o,children:['Update "',t.name,'"']})]}),(0,r.jsx)(I,{})]}),(0,r.jsx)(E,{ref:s,value:n,onChange:e=>l(e.target.value),onKeyDown:r=>{"Enter"===r.key&&n.trim()&&(t&&n.trim()===t.name&&o?o():e(n.trim())),"Escape"===r.key&&a()},placeholder:t?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,r.jsxs)(H,{children:[!t&&(0,r.jsx)(D,{onClick:a,children:"Cancel"}),(0,r.jsx)(D,{primary:!0,disabled:!n.trim(),onClick:()=>e(n.trim()),children:"Save as new"})]})]})})}let K=(0,d.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,W=(0,d.keyframes)`
...
`;function eo({appId:e,onLoad:o}){let[a,t]=(0,i.useState)(!1),[n,l]=(0,i.useState)([]),s=(0,i.useRef)(null),d=(0,i.useCallback)(()=>{(0,C.listDocs)(e).then(l).catch(()=>{})},[e]);(0,i.useEffect)(()=>{if(!a)return;d();let e=e=>{s.current&&!s.current.contains(e.target)&&t(!1)};return document.addEventListener("mousedown",e),()=>document.removeEventListener("mousedown",e)},[a,d]);let c=async(e,o)=>{e.stopPropagation(),await (0,C.deleteDoc)(o),l(e=>e.filter(e=>e.id!==o))};return(0,r.jsxs)(G,{ref:s,children:[(0,r.jsxs)(O,{onClick:()=>t(e=>!e),children:[(0,r.jsx)("svg",{width:14,height:14,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:(0,r.jsx)("path",{d:"M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"})}),"Saved",(0,r.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",style:{marginLeft:2},children:(0,r.jsx)("path",{d:"M6 9l6 6 6-6"})})]}),(0,r.jsxs)(Y,{open:a,children:[(0,r.jsx)(U,{children:"Saved versions"}),(0,r.jsx)(_,{children:0===n.length?(0,r.jsx)(q,{children:"No saved documents yet."}):n.map(e=>{var a;return(0,r.jsxs)(J,{children:[(0,r.jsxs)(Z,{onClick:()=>{o(e.content,e.id,e.name),t(!1)},children:[(0,r.jsx)(X,{children:e.name}),(0,r.jsx)(Q,{children:(a=e.savedAt,new Intl.DateTimeFormat(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}).format(new Date(a)))})]}),(0,r.jsx)(ee,{onClick:o=>c(o,e.id),title:"Delete",children:(0,r.jsxs)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,r.jsx)("polyline",{points:"3 6 5 6 21 6"}),(0,r.jsx)("path",{d:"M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6M10 11v6M14 11v6"}),(0,r.jsx)("path",{d:"M9 6V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2"})]})})]},e.id)})})]})]})}s().div`
...
`;s().div`
  ...
  background: ${t.w4.colors.mainBg};
  font-family: ${t.w4.typography.fontFamily};
  animation: ${ea} 0.4s ease 0.15s both;
`,s().div`
  position: relative;
  width: 56px;
  height: 56px;
...
`,s().div`
  position: absolute;
  inset: 0;
  animation: ${et} 1.4s cubic-bezier(0.4, 0, 0.2, 1) infinite;
...
`;function D({activeAppId:e}){let{collapsed:o}=(0,l.cL)(),[a]=function(){let[e,o]=(0,r.useState)(k),a=(0,r.useCallback)(e=>{o(e);try{localStorage.setItem($,e)}catch{}(0,l.Is)(v,e).catch(()=>{}),window.dispatchEvent(new CustomEvent("atlantis:locale-change",{detail:e}))},[]);return(0,r.useEffect)(()=>{let e=e=>{o(e.detail)};return window.addEventListener("atlantis:locale-change",e),()=>window.removeEventListener("atlantis:locale-change",e)},[]),(0,r.useEffect)(()=>{(0,l.PL)(v).then(a=>{if(z(a)&&a!==e){try{localStorage.setItem($,a)}catch{}o(a)}}).catch(()=>{})},[]),[e,a]}(),i=(0,r.useMemo)(()=>(e,o)=>{let t=function(e,o){if(!o||!e.includes("|"))return e;let a=null;for(let e of Object.values(o))if("number"==typeof e&&Number.isFinite(e)){a=e;break}if(null===a)return e;let t=e.indexOf("|"),r=e.slice(0,t),i=e.slice(t+1);return 1===a?r:i}(y[e]?.[a]??e,o);return o?Object.entries(o).reduce((e,[o,a])=>e.replace(RegExp(`\\{${o}\\}`,"g"),String(a)),t):t},[a]),n=(0,r.useRef)(null),s=e=>{n.current!==e&&(n.current=e,document.activeElement?.blur(),window.location.hash=e,setTimeout(()=>{n.current=null},50))};return(0,t.jsxs)(R,{children:[(0,t.jsx)(L,{collapsed:o,children:i("devtools.heading")}),C.map(a=>{let r=i(a.labelKey);return(0,t.jsxs)(P,{active:e===a.id,collapsed:o,onPointerDown:e=>{0===e.button&&s(a.hash)},onClick:()=>s(a.hash),title:r,children:[(0,t.jsx)(E,{children:(0,t.jsx)(A,{name:a.icon,size:16})}),(0,t.jsx)(H,{collapsed:o,children:r})]},a.id)})]})}n().span`
  display: inline-flex;
  align-items: center;
  justify-content: center;
  width: ${({size:e})=>e}px;
