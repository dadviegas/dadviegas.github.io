...
`,l().span`
  font-size: ${i.w4.typography.fontSizeBase};
  color: ${i.w4.colors.mainTextMuted};
`;var W=a(17223),Y=a(21426);let U=l().div`
  margin: ${i.w4.spacing.lg} 0;
  border-radius: ${i.w4.borderRadius.md};
  border: 1px solid ${i.w4.colors.codeBorder};
  overflow: hidden;
...
`;let S={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:s.w4.colors.accentMuted},B={neutral:s.w4.colors.mainTextMuted,live:s.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:s.w4.colors.accent};l().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${s.w4.typography.fontFamilyMono};
...
`,X=l().div`
  ...
  color: ${s.w4.colors.sidebarTextMuted};
  font-family: ${s.w4.typography.fontFamily};
`;function Z({onSave:e,onUpdate:o,onCancel:a,existingDoc:i}){let[n,l]=(0,r.useState)(i?.name??""),s=(0,r.useRef)(null);return(0,r.useEffect)(()=>{s.current?.focus(),i&&s.current?.select()},[i]),(0,t.jsx)(O,{onClick:a,children:(0,t.jsxs)(W,{onClick:e=>e.stopPropagation(),children:[(0,t.jsx)(Y,{children:"Save document"}),i&&o&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(X,{children:"Update the current version or save as a new one."}),(0,t.jsxs)(_,{children:[(0,t.jsx)(q,{onClick:a,children:"Cancel"}),(0,t.jsxs)(q,{danger:!0,onClick:o,children:['Update "',i.name,'"']})]}),(0,t.jsx)(J,{})]}),(0,t.jsx)(U,{ref:s,value:n,onChange:e=>l(e.target.value),onKeyDown:t=>{"Enter"===t.key&&n.trim()&&(i&&n.trim()===i.name&&o?o():e(n.trim())),"Escape"===t.key&&a()},placeholder:i?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,t.jsxs)(_,{children:[!i&&(0,t.jsx)(q,{onClick:a,children:"Cancel"}),(0,t.jsx)(q,{primary:!0,disabled:!n.trim(),onClick:()=>e(n.trim()),children:"Save as new"})]})]})})}let Q=(0,w.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,ee=(0,w.keyframes)`
