...
`},8859(o,e,a){a.d(e,{FlyoutPanel:()=>y});var t=a(5723),r=a(7991),i=a.n(r),n=a(6859),l=a.n(n),d=a(2799),s=a(1316),c=a(814),p=a(6140);let g=(0,d.keyframes)`
...
`,b=i().forwardRef(function({variant:o="ghost",size:e="md",icon:a,iconRight:r,children:i,...n},l){return(0,t.jsxs)(u,{ref:l,variant:o,size:e,...n,children:[a,i,r]})}),y={default:d.w4.colors.accent,danger:"#f85149"},w={default:d.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"},$=l().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`,l().span`
  ...
  display: inline-block;
`;let S={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:d.w4.colors.accentMuted},j={neutral:d.w4.colors.mainTextMuted,live:d.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:d.w4.colors.accent};l().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${d.w4.typography.fontFamilyMono};
...
`,D.A,D.A['pre[class*="language-"]'],d.w4.colors.codeBg,D.A['code[class*="language-"]'],l().div`
  background: ${({bg:o})=>o};
