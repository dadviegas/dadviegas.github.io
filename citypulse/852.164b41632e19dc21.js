...
`,i().div`
  ...
  height: 20px;
`,i().div`
  --panel-accent: ${({accent:o})=>o??n.w4.colors.accent};
  position: relative;
  display: flex;
  flex-direction: column;
...
`;function O({snapshot:o,loading:e}){let a=o?(0,D.QH)(o.currentAqi):null;return(0,r.jsxs)(G,{children:[(0,r.jsxs)(_,{accentColor:"#58a6ff",children:[(0,r.jsxs)(K,{children:[(0,r.jsx)(w,{name:"thermometer",size:14})," Temperature"]}),e?(0,r.jsx)(q,{}):(0,r.jsxs)(N,{children:[o?.currentTemp,"\xb0C"]}),!e&&(0,r.jsxs)(W,{children:["Feels like ",o?.apparentTemp,"\xb0C"]})]}),(0,r.jsxs)(_,{accentColor:a?.color??"#3fb950",children:[(0,r.jsxs)(K,{children:[(0,r.jsx)(w,{name:"activity",size:14})," Air Quality (EU AQI)"]}),e?(0,r.jsx)(q,{}):(0,r.jsx)(N,{style:{color:a?.color},children:o?.currentAqi}),!e&&(0,r.jsx)(W,{children:a?.label})]}),(0,r.jsxs)(_,{accentColor:"#d29922",children:[(0,r.jsxs)(K,{children:[(0,r.jsx)(w,{name:"wind",size:14})," Wind Speed"]}),e?(0,r.jsx)(q,{}):(0,r.jsx)(N,{children:o?.currentWind}),!e&&(0,r.jsx)(W,{children:"km/h"})]}),(0,r.jsxs)(_,{accentColor:"#79c0ff",children:[(0,r.jsxs)(K,{children:[(0,r.jsx)(w,{name:"droplets",size:14})," Precipitation"]}),e?(0,r.jsx)(q,{}):(0,r.jsxs)(N,{children:[o?.precipProb,"%"]}),!e&&(0,r.jsx)(W,{children:"Chance of rain"})]})]})}},1951(o,e,a){a.d(e,{A:()=>d});var r=a(5723);a(7991);var t=a(6859),i=a.n(t),n=a(4764),l=a(3819);let s=i().select`
  background: ${n.w4.colors.surface};
  border: 1px solid ${n.w4.colors.border};
  border-radius: ${n.w4.borderRadius.md};
  color: ${n.w4.colors.mainText};
...
`;function d({value:o,onChange:e}){return(0,r.jsx)(s,{value:o,onChange:o=>e(l.Mq.find(e=>e.id===o.target.value)),children:l.Mq.map(o=>(0,r.jsxs)("option",{value:o.id,children:[o.name,", ",o.country]},o.id))})}},7912(o,e,a){a.d(e,{A:()=>f});var r=a(5723),t=a(7991),i=a(6859),n=a.n(i),l=a(4764);let s=n().div`
  display: flex;
  flex-direction: column;
  gap: ${l.w4.spacing.md};
`,d=n().h3`
...
`,h=({size:o=14,strokeWidth:e=1.75})=>(0,r.jsxs)("svg",{width:o,height:o,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:e,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,r.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,r.jsx)("polyline",{points:"14 2 14 8 20 8"})]});function u({iconKey:o}){let e=o?p.t[o]:null;return e?(0,r.jsx)(e,{size:14,strokeWidth:1.75}):(0,r.jsx)(h,{})}function b({entries:o,activeId:e,onSelect:a}){return(0,r.jsx)(r.Fragment,{children:o.map(o=>o.children?(0,r.jsx)(i().Fragment,{children:(0,r.jsx)(b,{entries:o.children,activeId:e,onSelect:a})},o.id):(0,r.jsxs)(x,{active:e===o.id,onClick:()=>a(o),children:[(0,r.jsx)(u,{iconKey:o.icon}),o.name]},o.id))})}function w({activeId:o}){let{flyout:e,scheduleFlyoutClose:a,cancelFlyoutClose:t}=(0,c.c)();if(!e)return null;let i=e.entry.icon?p.t[e.entry.icon]:null;return(0,r.jsxs)(m,{anchorY:e.anchorY,onMouseEnter:t,onMouseLeave:a,children:[(0,r.jsxs)(f,{children:[i?(0,r.jsx)(i,{size:13,strokeWidth:2}):(0,r.jsx)(h,{size:13,strokeWidth:2}),e.entry.name]}),(0,r.jsx)(b,{entries:e.entry.children??[],activeId:o,onSelect:o=>{e.onSelect(o),a()}})]})}},814(o,e,a){a.d(e,{I:()=>t,c:()=>i});var r=a(7991);let t=(0,r.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),i=()=>(0,r.useContext)(t)},6140(o,e,a){a.d(e,{t:()=>ow});var r=a(6896),t=a(7902),i=a(3013),n=a(2887),l=a(9510),s=a(9848),d=a(7901),c=a(3045),p=a(3775),g=a(1783),m=a(3539),f=a(9416),x=a(1837),h=a(7167),u=a(4494),b=a(2314),w=a(255),y=a(5751),$=a(9633),v=a(2946),z=a(822),k=a(6720),M=a(7400),A=a(8456),j=a(3317),T=a(2709),S=a(8006),F=a(9301),B=a(7561),C=a(3517),H=a(8207),R=a(7032),L=a(6949),P=a(8218),E=a(6829),V=a(9591),I=a(5553),Y=a(9923),D=a(2820),G=a(4621),_=a(8479),K=a(2534),N=a(6673),W=a(7490),q=a(9033),O=a(9038),U=a(5775),Q=a(1365),Z=a(4893),J=a(2937),X=a(9821),oo=a(5912),oe=a(158),oa=a(8641),or=a(8607),ot=a(3249),oi=a(1821),on=a(5889),ol=a(9655),os=a(7170),od=a(9161),oc=a(1849),op=a(1604),og=a(3142),om=a(1187),of=a(7747),ox=a(2932),oh=a(4525),ou=a(7230),ob=a(2164);let ow={activity:r.A,"a-large-small":t.A,apple:i.A,"arrow-right":n.A,"bar-chart-2":l.A,book:s.A,"book-open":d.A,briefcase:c.A,calendar:p.A,clock:g.A,"circle-dot":m.A,cloud:f.A,compass:x.A,cpu:h.A,droplets:u.A,feather:b.A,file:w.A,"file-text":y.A,folder:$.A,"git-branch":v.A,github:z.A,globe:k.A,grid:M.A,hand:A.A,hash:j.A,heart:T.A,key:S.A,hexagon:F.A,home:B.A,landmark:C.A,layers:H.A,"layout-grid":R.A,leaf:L.A,lightbulb:P.A,list:E.A,map:V.A,"map-pin":I.A,"message-circle":Y.A,"message-square":D.A,minus:G.A,monitor:_.A,mountain:K.A,package:N.A,palette:W.A,"pen-tool":q.A,"pie-chart":O.A,plane:U.A,plus:Q.A,puzzle:Z.A,ruler:J.A,shirt:X.A,slash:oo.A,square:oe.A,star:oa.A,sun:or.A,terminal:ot.A,thermometer:oi.A,triangle:on.A,trophy:ol.A,truck:os.A,type:od.A,users:oc.A,"volume-2":op.A,watch:og.A,waves:om.A,wind:of.A,wrench:ox.A,x:oh.A,zap:ou.A,bot:ob.A}},4764(o,e,a){a.d(e,{wi:()=>q,PH:()=>U,NI:()=>W,rh:()=>K,w4:()=>r.w4,KW:()=>O,PL:()=>N.getSetting});var r=a(1316),t=a(5723),i=a(7991),n=a.n(i),l=a(6859),s=a.n(l),d=a(2799),c=a(814);let p="260px",g="56px",m="48px",f=s().header`
  display: flex;
  align-items: center;
