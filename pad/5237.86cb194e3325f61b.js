...
`,l().span`
  font-size: ${i.w4.typography.fontSizeBase};
  color: ${i.w4.colors.mainTextMuted};
`;var G=a(17223),W=a(21426);let O=l().div`
  margin: ${i.w4.spacing.lg} 0;
  border-radius: ${i.w4.borderRadius.md};
  border: 1px solid ${i.w4.colors.codeBorder};
  overflow: hidden;
...
`,J={...W.A,'pre[class*="language-"]':{...W.A['pre[class*="language-"]'],background:i.w4.colors.codeBg,margin:0,padding:"18px 20px",fontSize:"13px",lineHeight:"1.6",borderRadius:0},'code[class*="language-"]':{...W.A['code[class*="language-"]'],background:"none",fontSize:"13px"}};function Z({lang:e="text",code:o}){let[a,n]=(0,r.useState)(!1);return(0,t.jsxs)(O,{children:[(0,t.jsxs)(U,{children:[(0,t.jsx)(_,{children:e}),(0,t.jsxs)(q,{copied:a,onClick:()=>{navigator.clipboard.writeText(o).then(()=>{n(!0),setTimeout(()=>n(!1),2e3)})},children:[a?(0,t.jsx)(s.In,{name:"check",size:12}):(0,t.jsx)(s.In,{name:"copy",size:12}),a?"Copied!":"Copy"]})]}),(0,t.jsx)(G.A,{language:e,style:J,showLineNumbers:o.split("\n").length>8,lineNumberStyle:{color:"#484f58",minWidth:"2.5em",paddingRight:"1.5em",userSelect:"none",fontSize:"12px"},customStyle:{margin:0,background:i.w4.colors.codeBg},wrapLongLines:!1,children:o})]})}l().div`
  background: ${({bg:e})=>e};
...
`,n().span`
  ...
  background: ${({color:e})=>e};
  display: inline-block;
`;let A={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:l.w4.colors.accentMuted},C={neutral:l.w4.colors.mainTextMuted,live:l.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:l.w4.colors.accent};n().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${l.w4.typography.fontFamilyMono};
