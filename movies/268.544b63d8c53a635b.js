"use strict";(self.webpackChunk_atlantis_movies=self.webpackChunk_atlantis_movies||[]).push([["268"],{7613(e,r,o){o.d(r,{H:()=>u});var t=o(5723),a=o(7991),i=o(6859),n=o.n(i),l=o(6063);let s=n().div`
  display: flex;
...
`,m=n().p`
  ...
  text-align: center;
  margin: 0;
`;function u({onSave:e}){let[r,o]=(0,a.useState)(""),[i,n]=(0,a.useState)(!1),[l,w]=(0,a.useState)(""),y=async()=>{let o=r.trim();if(o){n(!0),w("");try{if(!(await fetch(`https://api.themoviedb.org/3/configuration?api_key=${o}`)).ok)throw Error("Invalid key");e(o)}catch{w("Could not validate API key. Check it and try again.")}finally{n(!1)}}};return(0,t.jsx)(s,{children:(0,t.jsxs)(d,{children:[(0,t.jsx)(c,{children:"\uD83C\uDFAC"}),(0,t.jsx)(p,{children:"Movies & Series"}),(0,t.jsxs)(h,{children:["This app uses the free"," ",(0,t.jsx)(x,{href:"https://www.themoviedb.org/settings/api",target:"_blank",rel:"noreferrer",children:"TMDB API"})," ","to browse movies, TV shows, and documentaries — including where to stream them.",(0,t.jsx)("br",{}),(0,t.jsx)("br",{}),"Create a free account on TMDB and paste your ",(0,t.jsx)("strong",{children:"API Key (v3)"})," below."]}),(0,t.jsxs)("div",{style:{display:"flex",flexDirection:"column",gap:8},children:[(0,t.jsx)(g,{htmlFor:"apikey",children:"TMDB API Key (v3)"}),(0,t.jsx)(f,{id:"apikey",type:"password",placeholder:"e.g. a1b2c3d4e5f6...",value:r,onChange:e=>o(e.target.value),onKeyDown:e=>"Enter"===e.key&&y(),autoFocus:!0})]}),l&&(0,t.jsx)(m,{children:l}),(0,t.jsx)(b,{onClick:y,disabled:!r.trim()||i,children:i?"Validating…":"Connect"})]})})}},6250(e,r,o){o.d(r,{U:()=>N});var t=o(5723),a=o(7991),i=o(6859),n=o.n(i),l=o(6063),s=o(3501),d=o(2727),c=o.n(d),p=o(2799),h=o(1801);let x=n().div`
  position: relative;
  width: 150px;
  flex-shrink: 0;
  cursor: pointer;
...
`;function V({item:e,rect:r,onOpen:o,onMouseEnter:a,onMouseLeave:i,withBackdrop:n,onBackdropTap:l}){let d=function(e){let r=window.innerWidth,o=window.innerHeight;if(r<500){let t=Math.max(8,(r-300)/2);return{top:Math.max(8,Math.min(e.bottom+8,o-310-8)),left:t}}let t=e.right+10;t+300>r-8&&(t=e.left-300-10),t=Math.max(8,Math.min(t,r-300-8));let a=e.top+e.height/2-155;return{top:a=Math.max(8,Math.min(a,o-310-8)),left:t}}(r),p=(0,h.rS)(e),x=(0,h.Ox)(e),g=(0,h.U7)(e.backdrop_path,"w780");return c().createPortal((0,t.jsxs)(t.Fragment,{children:[n&&(0,t.jsx)("div",{style:{position:"fixed",inset:0,zIndex:9998},onClick:l}),(0,t.jsxs)(z,{top:d.top,left:d.left,onMouseEnter:a,onMouseLeave:i,onClick:o,style:{cursor:"pointer"},children:[g?(0,t.jsx)(j,{src:g}):(0,t.jsx)(T,{}),(0,t.jsxs)(F,{children:[(0,t.jsx)(S,{children:p}),(0,t.jsxs)(C,{children:[(0,t.jsxs)(H,{children:[(0,t.jsx)(s.In,{name:"star",size:11,fill:"currentColor"}),e.vote_average.toFixed(1)]}),x&&(0,t.jsx)(_,{children:x}),(0,t.jsx)(B,{kind:e.media_type,children:"movie"===e.media_type?"Film":"TV"})]}),e.overview&&(0,t.jsx)(R,{children:e.overview}),(0,t.jsxs)(A,{onClick:o,children:[(0,t.jsx)(s.In,{name:"info",size:13}),"More Info"]})]})]})]}),document.body)}function L({item:e,onClick:r}){let o=(0,h.rS)(e),i=(0,h.Ox)(e),n=(0,h.HD)(e.poster_path),l=(0,a.useRef)(null),d=(0,a.useRef)(),c=(0,a.useRef)(),p=(0,a.useRef)(null),k=(0,a.useRef)(!1),[z,j]=(0,a.useState)(!1),[T,F]=(0,a.useState)(null),[S,C]=(0,a.useState)(!1);(0,a.useEffect)(()=>()=>{clearTimeout(d.current),clearTimeout(c.current)},[]);let H=(0,a.useCallback)((e,r)=>{F(e),j(!0),C(r)},[]),_=(0,a.useCallback)(()=>{j(!1),F(null),C(!1)},[]),B=(0,a.useCallback)(()=>{_(),r(e)},[e,r,_]),R=(0,a.useCallback)(()=>{clearTimeout(c.current)},[]),A=(0,a.useCallback)(()=>{clearTimeout(d.current),c.current=setTimeout(_,180)},[_]),I=(0,a.useCallback)(()=>{clearTimeout(c.current)},[]),P=(0,a.useCallback)(()=>{_()},[_]),Y=(0,a.useCallback)(e=>{z||(p.current={x:e.touches[0].clientX,y:e.touches[0].clientY})},[z]),D=(0,a.useCallback)(o=>{if(z||!p.current)return;let t=o.changedTouches[0],a=Math.abs(t.clientX-p.current.x),i=Math.abs(t.clientY-p.current.y);if(p.current=null,a>8||i>8)return;if(k.current=!0,window.innerWidth<768)return void r(e);let n=l.current?.getBoundingClientRect();n&&H(n,!0)},[z,e,r,H]),E=(0,a.useCallback)(()=>{if(k.current){k.current=!1;return}z||S||B()},[z,S,B]);return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsxs)(x,{ref:l,onClick:E,onMouseEnter:R,onMouseLeave:A,onTouchStart:Y,onTouchEnd:D,title:o,role:"button",tabIndex:0,onKeyDown:e=>{("Enter"===e.key||" "===e.key)&&B()},children:[(0,t.jsx)($,{kind:e.media_type,children:"movie"===e.media_type?"Film":"TV"}),(0,t.jsx)(M,{"data-eye":!0,onClick:e=>{e.stopPropagation();let r=l.current?.getBoundingClientRect();r&&H(r,!1)},title:"Preview",children:(0,t.jsx)(s.In,{name:"eye",size:14})}),n?(0,t.jsx)(g,{src:n,alt:o,loading:"lazy"}):(0,t.jsxs)(f,{children:["\uD83C\uDFAC",(0,t.jsx)(b,{children:o})]}),(0,t.jsxs)(m,{children:[(0,t.jsx)(u,{children:o}),(0,t.jsxs)(w,{children:[(0,t.jsxs)(y,{children:[(0,t.jsx)(s.In,{name:"star",size:9,fill:"currentColor"}),e.vote_average.toFixed(1)]}),i&&(0,t.jsx)(v,{children:i})]})]})]}),z&&T&&(0,t.jsx)(V,{item:e,rect:T,onOpen:B,onMouseEnter:I,onMouseLeave:P,withBackdrop:S,onBackdropTap:_})]})}let I=n().div`
  display: flex;
  flex-direction: column;
  gap: ${l.w4.spacing.md};
...
`;function X(e){return Math.max(320,Math.round(.85*e.clientWidth))}function N({title:e,items:r,loading:o,onSelect:i}){let n=(0,a.useRef)(null),[l,d]=(0,a.useState)(!1),[c,p]=(0,a.useState)(!0),h=(0,a.useCallback)(()=>{let e=n.current;e&&(d(e.scrollLeft>0),p(e.scrollLeft+e.clientWidth<e.scrollWidth-4))},[]);(0,a.useEffect)(()=>{h();let e=()=>h();return window.addEventListener("resize",e),()=>window.removeEventListener("resize",e)},[r,h]);let x=()=>{let e=n.current;e&&e.scrollBy({left:-X(e),behavior:"smooth"})},g=()=>{let e=n.current;e&&e.scrollBy({left:X(e),behavior:"smooth"})};return(0,t.jsxs)(I,{children:[(0,t.jsxs)(P,{children:[(0,t.jsx)(Y,{children:e}),(0,t.jsxs)(D,{children:[(0,t.jsx)(E,{onClick:x,disabled:!l,"aria-label":"Scroll left",children:(0,t.jsx)(s.In,{name:"chevron-left",size:16})}),(0,t.jsx)(E,{onClick:g,disabled:!c||0===r.length,"aria-label":"Scroll right",children:(0,t.jsx)(s.In,{name:"chevron-right",size:16})})]})]}),(0,t.jsx)(U,{children:o?(0,t.jsx)(W,{children:Array.from({length:10}).map((e,r)=>(0,t.jsx)(q,{},r))}):0===r.length?(0,t.jsx)(O,{children:"No results found"}):(0,t.jsx)(W,{ref:n,onScroll:h,onKeyDown:e=>{if("ArrowRight"===e.key)e.preventDefault(),g();else if("ArrowLeft"===e.key)e.preventDefault(),x();else if("Home"===e.key)e.preventDefault(),n.current?.scrollTo({left:0,behavior:"smooth"});else if("End"===e.key){e.preventDefault();let r=n.current;r&&r.scrollTo({left:r.scrollWidth,behavior:"smooth"})}},tabIndex:0,role:"region","aria-label":e,children:r.map(e=>(0,t.jsx)(L,{item:e,onClick:i},`${e.media_type}-${e.id}`))})})]})}},2819(e,r,o){o.d(r,{P:()=>ec});var t=o(5723),a=o(7991),i=o(6859),n=o.n(i),l=o(2799),s=o(6063),d=o(3501),c=o(1801),p=o(4956);let h=(0,l.keyframes)`
...
`,f=n().div`
  ...
  display: flex;
  flex-direction: column;
  animation: ${h} 0.3s cubic-bezier(0.22, 1, 0.36, 1);
`,b=n().div`
  position: relative;
  width: 100%;
...
`,es=n().div`
  ...
  color: ${s.w4.colors.mainTextMuted};
  padding: 12px 0;
`;function ed({provider:e,title:r,appleTVUrl:o}){let a=c.RY[e.provider_name]??s.w4.colors.surface,i=(0,c.$8)(e,r,o);return(0,t.jsxs)(Q,{bg:a,href:i,target:"_blank",rel:"noreferrer",children:[e.logo_path&&(0,t.jsx)(ee,{src:(0,c.vo)(e.logo_path),alt:e.provider_name}),(0,t.jsxs)(er,{children:[(0,t.jsx)(eo,{children:e.provider_name}),(0,t.jsxs)(et,{children:[(0,t.jsx)(d.In,{name:"external-link",size:9}),(0,c.mS)(e.provider_id)?"Open in Apple TV":`Open in ${e.provider_name}`]})]})]})}function ec({item:e,apiKey:r,onBack:o,onLibraryChange:i,onSelect:n}){let[l,h]=(0,a.useState)(null),[x,u]=(0,a.useState)([]),[Q,ee]=(0,a.useState)(null),[er,et]=(0,a.useState)([]),[ep,eh]=(0,a.useState)([]),[ex,eg]=(0,a.useState)(!0),[ef,eb]=(0,a.useState)(null),[em,eu]=(0,a.useState)(!1),ew=(0,a.useRef)(null),[ey,ev]=(0,a.useState)(()=>(0,p.BA)(e)),[e$,eM]=(0,a.useState)(()=>(0,p.U4)(e)),ek=(0,c.rS)(e),ez=(0,c.Ox)(e);(0,a.useEffect)(()=>{let e=e=>{"Escape"===e.key&&(em?eu(!1):o())};return document.addEventListener("keydown",e),()=>document.removeEventListener("keydown",e)},[o,em]),(0,a.useEffect)(()=>{ew.current?.scrollTo({top:0,behavior:"instant"})},[e.id]),(0,a.useEffect)(()=>{eg(!0),eu(!1),Promise.all([(0,c.Ug)(r,e.media_type,e.id),(0,c.fY)(r,e.media_type,e.id),(0,c.Mt)(r,e.media_type,e.id),(0,c.Pg)(r,e.media_type,e.id),(0,c.Dz)(r,e.media_type,e.id)]).then(([e,r,o,t,a])=>{h(e),u(r),ee(o),et(t),eh(a),eg(!1)}).catch(()=>eg(!1)),(0,c.Su)(ek,e.media_type,ez).then(eb)},[e.id,e.media_type,r,ek,ez]);let ej=x.find(e=>"YouTube"===e.site&&("Trailer"===e.type||"Teaser"===e.type)&&e.official)??x.find(e=>"YouTube"===e.site&&"Trailer"===e.type)??x.find(e=>"YouTube"===e.site),eT=(0,a.useCallback)(()=>{(0,p.dw)(e),ev(e=>!e),i?.()},[e,i]),eF=(0,a.useCallback)(()=>{(0,p.w0)(e),eM(e=>!e),i?.()},[e,i]),eS=[...Q?.flatrate??[]].filter((e,r,o)=>o.findIndex(r=>r.provider_id===e.provider_id)===r),eC=(Q?.rent??[]).filter(e=>!eS.find(r=>r.provider_id===e.provider_id)),eH=eS[0],e_=eH?(0,c.$8)(eH,ek,ef):ef??`https://tv.apple.com/search?term=${encodeURIComponent(ek)}`,eB=(0,c.U7)(e.backdrop_path??l?.backdrop_path??null,"w1280");return(0,t.jsxs)(g,{ref:ew,children:[ex&&(0,t.jsx)(w,{children:(0,t.jsx)(y,{})}),(0,t.jsxs)(f,{children:[(0,t.jsx)(b,{src:eB,children:(0,t.jsxs)(m,{children:[(0,t.jsx)(v,{children:ek}),l?.tagline&&(0,t.jsxs)($,{children:['"',l.tagline,'"']}),(0,t.jsxs)(M,{children:[(0,t.jsxs)(k,{children:[(0,t.jsx)(d.In,{name:"star",size:15,fill:"currentColor"}),e.vote_average.toFixed(1)]}),ez&&(0,t.jsxs)(z,{children:[(0,t.jsx)(d.In,{name:"calendar",size:13}),ez]}),l?.runtime&&(0,t.jsxs)(z,{children:[(0,t.jsx)(d.In,{name:"clock",size:13}),Math.floor(l.runtime/60),"h ",l.runtime%60,"m"]}),l?.number_of_seasons&&(0,t.jsxs)(z,{children:[(0,t.jsx)(d.In,{name:"monitor",size:13}),l.number_of_seasons," season",1!==l.number_of_seasons?"s":""]})]}),l?.genres&&l.genres.length>0&&(0,t.jsx)(j,{children:l.genres.map(e=>(0,t.jsx)(T,{children:e.name},e.id))}),(0,t.jsxs)(F,{children:[(0,t.jsxs)(S,{href:e_,target:"_blank",rel:"noreferrer",children:[(0,t.jsx)(d.In,{name:"play",size:16,fill:"black"}),"Watch Now"]}),ej&&(0,t.jsxs)(L,{onClick:()=>eu(!0),children:[(0,t.jsx)(d.In,{name:"film",size:15}),"Trailer"]}),(0,t.jsxs)(C,{active:ey,onClick:eT,children:[(0,t.jsx)(d.In,{name:"heart",size:14,fill:ey?"currentColor":"none"}),ey?"Favorited":"Favorite"]}),(0,t.jsxs)(C,{active:e$,onClick:eF,children:[e$?(0,t.jsx)(d.In,{name:"eye-off",size:14}):(0,t.jsx)(d.In,{name:"eye",size:14}),e$?"Unseen":"Mark Seen"]}),(ey||e$)&&(0,t.jsx)(C,{danger:!0,onClick:()=>{ey&&((0,p.dw)(e),ev(!1)),e$&&((0,p.w0)(e),eM(!1)),i?.()},children:(0,t.jsx)(d.In,{name:"trash",size:14})})]})]})}),(0,t.jsxs)(H,{children:[ex?(0,t.jsx)(es,{children:"Loading…"}):(0,t.jsx)(_,{children:e.overview}),ej&&em&&(0,t.jsx)(I,{onClick:e=>{e.target===e.currentTarget&&eu(!1)},children:(0,t.jsxs)(P,{children:[(0,t.jsxs)(D,{onClick:()=>eu(!1),children:[(0,t.jsx)(d.In,{name:"close",size:14})," Close"]}),(0,t.jsx)(Y,{children:(0,t.jsx)("iframe",{src:`https://www.youtube.com/embed/${ej.key}?autoplay=1&rel=0&modestbranding=1`,title:ej.name,allowFullScreen:!0,allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"})})]})}),(ex||er.length>0)&&(0,t.jsxs)(B,{children:[(0,t.jsxs)(R,{children:[(0,t.jsx)(A,{children:(0,t.jsx)(d.In,{name:"users",size:15})}),(0,t.jsx)(V,{children:"Cast"})]}),ex?(0,t.jsx)(es,{children:"Loading cast…"}):(0,t.jsx)(E,{children:er.map(e=>(0,t.jsxs)(U,{children:[e.profile_path?(0,t.jsx)(W,{src:(0,c.DW)(e.profile_path,"w185"),alt:e.name,loading:"lazy"}):(0,t.jsx)(O,{children:"\uD83D\uDC64"}),(0,t.jsxs)(q,{children:[(0,t.jsx)(X,{children:e.name}),e.character&&(0,t.jsx)(N,{children:e.character})]})]},e.id))})]}),(0,t.jsxs)(B,{children:[(0,t.jsxs)(R,{children:[(0,t.jsx)(A,{children:(0,t.jsx)(d.In,{name:"monitor",size:15})}),(0,t.jsx)(V,{children:"Where to Watch"})]}),ex?(0,t.jsx)(es,{children:"Loading streaming info…"}):eS.length>0?(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(J,{children:eS.map(e=>(0,t.jsx)(ed,{provider:e,title:ek,appleTVUrl:ef},e.provider_id))}),eC.length>0&&(0,t.jsxs)("div",{style:{marginTop:8},children:[(0,t.jsx)(en,{children:"Also available to rent"}),(0,t.jsx)(J,{children:eC.map(e=>(0,t.jsxs)(ea,{bg:c.RY[e.provider_name]??s.w4.colors.surface,children:[e.logo_path&&(0,t.jsx)(ei,{src:(0,c.vo)(e.logo_path),alt:e.provider_name}),(0,t.jsx)(eo,{style:{color:"#fff"},children:e.provider_name})]},e.provider_id))})]})]}):(Q?.rent??[]).length>0?(0,t.jsxs)("div",{children:[(0,t.jsx)(el,{children:"Not on any streaming subscription right now."}),(0,t.jsx)(en,{style:{marginTop:12},children:"Available to rent"}),(0,t.jsx)(J,{children:(Q?.rent??[]).map(e=>(0,t.jsxs)(ea,{bg:c.RY[e.provider_name]??s.w4.colors.surface,children:[e.logo_path&&(0,t.jsx)(ei,{src:(0,c.vo)(e.logo_path),alt:e.provider_name}),(0,t.jsx)(eo,{style:{color:"#fff"},children:e.provider_name})]},e.provider_id))})]}):(0,t.jsx)(el,{children:"No streaming info available for your region (US)."})]}),ep.length>0&&(0,t.jsxs)(B,{children:[(0,t.jsxs)(R,{children:[(0,t.jsx)(A,{children:(0,t.jsx)(d.In,{name:"star",size:15})}),(0,t.jsx)(V,{children:"You Might Also Like"})]}),(0,t.jsx)(E,{children:ep.map(e=>(0,t.jsxs)(K,{onClick:()=>n?.(e),children:[(0,c.HD)(e.poster_path)?(0,t.jsx)(G,{src:(0,c.HD)(e.poster_path,"w185"),alt:(0,c.rS)(e),loading:"lazy"}):(0,t.jsx)(Z,{children:"\uD83C\uDFAC"}),(0,t.jsxs)(q,{children:[(0,t.jsx)(X,{children:(0,c.rS)(e)}),(0,t.jsxs)(N,{children:[(0,t.jsx)(d.In,{name:"star",size:9,fill:"#e3b341",color:"#e3b341",style:{verticalAlign:-1}})," ",e.vote_average.toFixed(1)," \xb7 ",(0,c.Ox)(e)]})]})]},e.id))})]})]})]})]})}},1620(e,r,o){o.d(r,{K:()=>V});var t=o(5723),a=o(7991),i=o.n(a),n=o(2727),l=o.n(n),s=o(6859),d=o.n(s),c=o(2799),p=o(6063),h=o(3501),x=o(1801);let g=(0,c.keyframes)`
...
`,b=({size:e=14,strokeWidth:r=1.75})=>(0,t.jsxs)("svg",{width:e,height:e,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:r,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,t.jsx)("polyline",{points:"14 2 14 8 20 8"})]});function m({iconKey:e}){let r=e?p[e]:void 0;return r?(0,t.jsx)("svg",{width:14,height:14,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,dangerouslySetInnerHTML:{__html:r}}):(0,t.jsx)(b,{})}function u({entries:e,activeId:r,onSelect:o}){return(0,t.jsx)(t.Fragment,{children:e.map(e=>e.children?(0,t.jsx)(i().Fragment,{children:(0,t.jsx)(u,{entries:e.children,activeId:r,onSelect:o})},e.id):(0,t.jsxs)(f,{active:r===e.id,onClick:()=>o(e),children:[(0,t.jsx)(m,{iconKey:e.icon}),e.name]},e.id))})}function w({activeId:e}){let{flyout:r,scheduleFlyoutClose:o,cancelFlyoutClose:a}=(0,c.c)();if(!r)return null;let i=r.entry.icon?p[r.entry.icon]:void 0;return(0,t.jsxs)(x,{anchorY:r.anchorY,onMouseEnter:a,onMouseLeave:o,children:[(0,t.jsxs)(g,{children:[i?(0,t.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,dangerouslySetInnerHTML:{__html:i}}):(0,t.jsx)(b,{size:13,strokeWidth:2}),r.entry.name]}),(0,t.jsx)(u,{entries:r.entry.children??[],activeId:e,onSelect:e=>{r.onSelect(e),o()}})]})}},7993(e,r,o){o.d(r,{I:()=>a,c:()=>i});var t=o(7991);let a=(0,t.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),i=()=>(0,t.useContext)(a)},3501(e,r,o){o.d(r,{PE:()=>el,In:()=>v});var t=o(5723),a=o(7991),i=o.n(a),n=o(6859),l=o.n(n),s=o(6063);let d={ghost:"transparent",accent:"transparent",primary:s.w4.colors.accent,success:"#238636",danger:"#da3633"},c={ghost:s.w4.colors.sidebarHover,accent:"rgba(88,166,255,0.10)",primary:s.w4.colors.accentHover,success:"#2ea043",danger:"#f85149"},p={ghost:s.w4.colors.border,accent:s.w4.colors.accent,primary:s.w4.colors.accent,success:"#238636",danger:"#da3633"},h={ghost:s.w4.colors.mainTextMuted,accent:s.w4.colors.accent,primary:"#fff",success:"#fff",danger:"#fff"},x={ghost:s.w4.colors.mainText,accent:s.w4.colors.accent,primary:"#fff",success:"#fff",danger:"#fff"},g={sm:"28px",md:"30px"},f={sm:"0 10px",md:"0 12px"},b={sm:"12px",md:"12px"};l().button`
  display: inline-flex;
  align-items: center;
  justify-content: center;
  gap: 6px;
...
`,l().div`
  position: relative;
`;let E="260px",U="56px",W="48px",O=l().header`
  display: flex;
  align-items: center;
  height: calc(${W} + env(safe-area-inset-top, 0px));
  ...
  @media (max-width: ${s.w4.breakpoints.md}) {
    flex-wrap: wrap;
    height: auto;
    min-height: calc(${W} + env(safe-area-inset-top, 0px));
  }
`,q=l().div`
  width: ${U};
  min-width: ${U};
...
`,G=l().span`
  ...
  animation: ${N} 10s ease ${({index:e})=>.07*e}s infinite;
...
`,ee=l().div`
  ...
  overflow: hidden;
`,er=l().aside`
  width: ${({collapsed:e})=>e?U:E};
  min-width: ${({collapsed:e})=>e?U:E};
  background: ${s.w4.colors.sidebarBg};
  border-right: 1px solid ${s.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,et=l().main`
  ...
  display: flex;
  flex-direction: column;
`,ea=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function ei(){return(0,t.jsx)(K,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:ea.map((e,r)=>(0,t.jsx)(G,{index:r,accent:e.accent,children:e.char},r))})}let en="atlantis:sidebar-collapsed";function el({sidebar:e,children:r,topBarRight:n,title:l="Atlantis",activeId:s=null}){let[d,c]=(0,a.useState)(()=>{try{return"true"===localStorage.getItem(en)}catch{return!1}}),[p,h]=(0,a.useState)(null),x=(0,a.useRef)(),g=()=>c(e=>{let r=!e;try{localStorage.setItem(en,String(r))}catch{}return r}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(o.bind(o,5816)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,t.jsx)(B.I.Provider,{value:{collapsed:d,toggle:g,flyout:p,openFlyout:(e,r,o)=>{clearTimeout(x.current),h({entry:e,anchorY:r,onSelect:o})},scheduleFlyoutClose:()=>{x.current=setTimeout(()=>h(null),160)},cancelFlyoutClose:()=>clearTimeout(x.current)},children:(0,t.jsxs)(ee,{children:[(0,t.jsxs)(O,{children:[e&&(0,t.jsx)(q,{children:(0,t.jsx)(X,{onClick:g,title:d?"Expand sidebar":"Collapse sidebar",children:(0,t.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("path",{d:"M9 3v18"})]})})}),(0,t.jsx)(ei,{}),l&&(0,t.jsx)(Z,{children:l}),n&&(0,t.jsx)(J,{children:n})]}),(0,t.jsxs)(Q,{children:[null!=e&&(0,t.jsx)(er,{collapsed:d,children:(0,t.jsx)(eo,{children:e})}),(0,t.jsx)(et,{children:r})]}),p&&(0,t.jsx)(i().Suspense,{fallback:null,children:(0,t.jsx)(f,{activeId:s})})]})})}l().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
