...
`,eE=s().span`
  ...
  color: ${l.w4.colors.mainTextMuted};
  flex-shrink: 0;
`,eO=r().forwardRef(function({before:e,after:t,...a},o){return(0,i.jsxs)(eR,{children:[e&&(0,i.jsx)(eE,{children:e}),(0,i.jsx)(eH,{ref:o,...a}),t&&(0,i.jsx)(eE,{children:t})]})}),eK=s().div`
  position: relative;
  display: flex;
  flex-direction: column;
  height: 100%;
...
`;function tB({size:e}){return(0,i.jsxs)("svg",{width:14,height:14,viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:[(0,i.jsx)("rect",{x:1.5,y:4.5,width:11,height:5,rx:1,stroke:"currentColor",strokeWidth:1,opacity:.4}),(0,i.jsx)("rect",{x:2,y:5,width:"sm"===e?4:"md"===e?7:11,height:4,rx:.5,fill:"currentColor"})]})}let tG={sm:1,md:2,lg:"full"};function tW({items:e,onReorder:t,onCycleSize:a,onRemove:o,renderPanel:r,renderAccessory:n,showGrip:s=!0,labels:l,accentColor:d}){return(0,i.jsx)(tD,{children:e.map((c,p)=>{let m=tG[c.size],g="full"===m,u=c.minHeight??160,h=d?.(c),f=(c.availableSizes??["sm","md","lg"]).length>1,b=n?.(c);return(0,i.jsxs)(tR,{colSpan:g?1:m,fullWidth:g,children:[b&&(0,i.jsx)(tH,{children:b}),(0,i.jsxs)(tE,{minH:u,accent:h,"data-grip":s?"true":"false",children:[(0,i.jsxs)(tO,{className:"panel-controls",children:[p>0&&(0,i.jsx)(tK,{type:"button",title:l.moveLeft,onClick:()=>t(c.id,-1),children:(0,i.jsx)(F,{name:"chevron-left",size:14})}),p<e.length-1&&(0,i.jsx)(tK,{type:"button",title:l.moveRight,onClick:()=>t(c.id,1),children:(0,i.jsx)(F,{name:"chevron-right",size:14})}),f&&(0,i.jsx)(tK,{type:"button",title:`${l.cycleSize} \xb7 ${c.size.toUpperCase()}`,onClick:()=>a(c.id),children:(0,i.jsx)(tB,{size:c.size})}),o&&l.remove&&(0,i.jsx)(tq,{type:"button",title:l.remove,onClick:()=>o(c.id),children:(0,i.jsx)(F,{name:"close",size:14})})]}),r(c)]})]},c.id)})})}let tY=(0,C.keyframes)`
