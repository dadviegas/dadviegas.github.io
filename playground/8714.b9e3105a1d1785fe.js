...
ReactDOM.createRoot(document.getElementById('root')!).render(<App />);`}]},7330(o,e,t){t.d(e,{FlyoutPanel:()=>oR});var a=t(5723),r=t(7991),n=t.n(r),i=t(6859),l=t.n(i),s=t(2799),d=t(255),c=t(1316),p=t(814),g=t(6896),m=t(7902),f=t(3013),x=t(2887),u=t(9510),b=t(9848),h=t(7901),w=t(3045),y=t(3775),$=t(1783),v=t(3539),z=t(9416),k=t(1837),M=t(7167),A=t(4494),T=t(2314),S=t(5751),j=t(9633),F=t(2946),B=t(822),C=t(6720),R=t(7400),E=t(8456),L=t(3317),P=t(2709),H=t(8006),D=t(9301),I=t(7561),K=t(3517),N=t(8207),V=t(7032),Y=t(6949),G=t(8218),_=t(6829),O=t(9591),W=t(5553),J=t(9923),U=t(2820),Z=t(4621),q=t(8479),X=t(2534),Q=t(6673),oo=t(7490),oe=t(9033),ot=t(9038),oa=t(5775),or=t(1365),on=t(2937),oi=t(9821),ol=t(5912),os=t(158),od=t(8641),oc=t(8607),op=t(3249),og=t(1821),om=t(5889),of=t(9655),ox=t(7170),ou=t(9161),ob=t(1849),oh=t(1604),ow=t(3142),oy=t(1187),o$=t(7747),ov=t(2932),oz=t(4525),ok=t(7230),oM=t(2164);let oA={activity:g.A,"a-large-small":m.A,apple:f.A,"arrow-right":x.A,"bar-chart-2":u.A,book:b.A,"book-open":h.A,briefcase:w.A,calendar:y.A,clock:$.A,"circle-dot":v.A,cloud:z.A,compass:k.A,cpu:M.A,droplets:A.A,feather:T.A,file:d.A,"file-text":S.A,folder:j.A,"git-branch":F.A,github:B.A,globe:C.A,grid:R.A,hand:E.A,hash:L.A,heart:P.A,key:H.A,hexagon:D.A,home:I.A,landmark:K.A,layers:N.A,"layout-grid":V.A,leaf:Y.A,lightbulb:G.A,list:_.A,map:O.A,"map-pin":W.A,"message-circle":J.A,"message-square":U.A,minus:Z.A,monitor:q.A,mountain:X.A,package:Q.A,palette:oo.A,"pen-tool":oe.A,"pie-chart":ot.A,plane:oa.A,plus:or.A,ruler:on.A,shirt:oi.A,slash:ol.A,square:os.A,star:od.A,sun:oc.A,terminal:op.A,thermometer:og.A,triangle:om.A,trophy:of.A,truck:ox.A,type:ou.A,users:ob.A,"volume-2":oh.A,watch:ow.A,waves:oy.A,wind:o$.A,wrench:ov.A,x:oz.A,zap:ok.A,bot:oM.A},oT=(0,s.keyframes)`
...
`,l().span`
  ...
  background: ${({color:o})=>o};
  display: inline-block;
`;let I={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:s.w4.colors.accentMuted},K={neutral:s.w4.colors.mainTextMuted,live:s.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:s.w4.colors.accent};l().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${s.w4.typography.fontFamilyMono};
