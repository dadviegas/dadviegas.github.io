"use strict";(self.webpackChunk_atlantis_leitor=self.webpackChunk_atlantis_leitor||[]).push([[170],{4914(e,o,a){a.d(o,{FlyoutPanel:()=>x});var i=a(7359),t=a(3233),n=a(7207),r=a(255),l=a(217),s=a(5959),d=a(5185),c=a(5723);const m=n.keyframes`
...
`;function p({iconKey:e}){const o=e?d.t[e]??r.A:r.A;return(0,c.jsx)(o,{size:14,strokeWidth:1.75})}function h({entries:e,activeId:o,onSelect:a}){return(0,c.jsx)(c.Fragment,{children:e.map(e=>e.children?(0,c.jsx)(i.Fragment,{children:(0,c.jsx)(h,{entries:e.children,activeId:o,onSelect:a})},e.id):(0,c.jsxs)(f,{active:o===e.id,onClick:()=>a(e),children:[(0,c.jsx)(p,{iconKey:e.icon}),e.name]},e.id))})}function x({activeId:e}){const{flyout:o,scheduleFlyoutClose:a,cancelFlyoutClose:i}=(0,s.c)();if(!o)return null;const t=o.entry.icon?d.t[o.entry.icon]??r.A:r.A;return(0,c.jsxs)(u,{anchorY:o.anchorY,onMouseEnter:i,onMouseLeave:a,children:[(0,c.jsxs)(g,{children:[(0,c.jsx)(t,{size:13,strokeWidth:2}),o.entry.name]}),(0,c.jsx)(h,{entries:o.entry.children??[],activeId:e,onSelect:e=>{o.onSelect(e),a()}})]})}},5959(e,o,a){a.d(o,{c:()=>n});var i=a(7359);const t=(0,i.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),n=()=>(0,i.useContext)(t)},5185(e,o,a){a.d(o,{t:()=>N});var i=a(9038),t=a(6896),n=a(7901),r=a(9848),l=a(2164),s=a(3539),d=a(1783),c=a(1837),m=a(2314),u=a(5751),g=a(255),f=a(9633),p=a(2946),h=a(822),x=a(3317),b=a(2709),z=a(3517),y=a(7032),w=a(6949),j=a(8218),v=a(6829),A=a(5553),k=a(9591),S=a(2820),$=a(4621),C=a(6673),M=a(9033),T=a(1365),B=a(5912),L=a(8641),E=a(3249),P=a(9161),O=a(2932),R=a(4525),F=a(7230);const N={activity:t.A,book:r.A,clock:d.A,"book-open":n.A,"circle-dot":s.A,feather:m.A,"file-text":u.A,hash:x.A,heart:b.A,landmark:z.A,leaf:w.A,map:k.A,package:C.A,compass:c.A,"git-branch":p.A,github:h.A,minus:$.A,terminal:E.A,"pie-chart":i.A,plus:T.A,slash:B.A,star:L.A,zap:F.A,bot:l.A,lightbulb:j.A,"message-square":S.A,wrench:O.A,x:R.A,"layout-grid":y.A,list:v.A,file:g.A,folder:f.A,"map-pin":A.A,"pen-tool":M.A,type:P.A}},906(e,o,a){a.d(o,{w4:()=>i.w});var i=a(217),t=(a(7359),a(3233));a(5723),t.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,t.default.span`
  ...
  margin-right: 6px;
  flex-shrink: 0;
`,a(5959);const n="260px",r="56px";t.default.header`
  display: flex;
  align-items: center;
  height: ${"48px"};
...
`,t.default.div`
  ...
  overflow: hidden;
`,t.default.aside`
  width: ${({collapsed:e})=>e?r:n};
  min-width: ${({collapsed:e})=>e?r:n};
  background: ${i.w.colors.sidebarBg};
  border-right: 1px solid ${i.w.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,S=i.default.div`
  ...
  font-size: 16px;
  text-align: center;
`;function $({progress:e,onBack:o,onToggleFavorite:a}){const i=[];for(const o of e.favorites){const[e,a]=o.split(":"),t=d.Yq.find(o=>o.id===e),n=t?.cards.find(e=>e.id===a);t&&n&&i.push({cardKey:o,card:n,color:t.color})}return(0,m.jsxs)(g,{children:[(0,m.jsxs)(f,{children:[(0,m.jsx)(p,{onClick:o,children:(0,m.jsx)(n.A,{size:18})}),(0,m.jsx)(h,{children:"❤️ Favoritos"}),(0,m.jsxs)(x,{children:[i.length," guardados"]})]}),(0,m.jsx)(b,{children:0===i.length?(0,m.jsxs)(S,{children:[(0,m.jsx)("span",{style:{fontSize:64},children:"💔"}),(0,m.jsx)("span",{children:"Ainda não tens favoritos."}),(0,m.jsx)("span",{style:{fontSize:14},children:"Toca no ❤️ nas lições para guardar."})]}):(0,m.jsx)(z,{children:i.map(({cardKey:e,card:o,color:i},t)=>(0,m.jsxs)(y,{color:i,index:t,children:[(0,m.jsx)(w,{onClick:()=>(0,c.Lr)(o.word),children:o.emoji}),(0,m.jsx)(j,{color:i,children:o.letter}),(0,m.jsx)(v,{children:o.word}),(0,m.jsxs)(A,{children:[(0,m.jsx)(k,{type:"button",title:"Ouvir",onClick:()=>(0,c.Lr)(o.word),children:(0,m.jsx)(l.A,{size:16})}),(0,m.jsx)(k,{type:"button",title:"Remover dos favoritos",onClick:()=>a(e),style:{color:"#ef4444",borderColor:"#ef444440"},children:(0,m.jsx)(r.A,{size:16,fill:"#ef4444"})})]})]},e))})})]})}},5586(e,o,a){a.d(o,{u:()=>q}),a(7359);var i=a(3233),t=a(7207),n=a(9753),r=a(63),l=a(5723);const s=t.keyframes`
...
`,g=i.default.div`
  background: linear-gradient(135deg, #1a0533 0%, #0f1a3d 50%, #0a1a2e 100%);
  ...
  &::before {
    ...
    inset: 0;
    background:
      radial-gradient(ellipse 60% 80% at 20% 30%, #7c3aed40 0%, transparent 70%),
      radial-gradient(ellipse 40% 60% at 80% 70%, #3b82f640 0%, transparent 70%);
    pointer-events: none;
  }
`,f=i.default.div`position: relative; z-index: 1;`,p=i.default.div`
  display: flex;
...
`,y=i.default.div`
  ...
  border-radius: 24px;
  padding: 7px 14px;
`,w=i.default.span`font-size: 16px;`,j=i.default.span`
  font-size: 15px;
  font-weight: 800;
  color: #f1f5f9;
`,v=i.default.span`
...
`,S=i.default.div`
  ...
  font-size: 11px;
  color: #64748b;
`,$=i.default.div`padding: 20px 16px 0;`,C=i.default.button`
  display: flex;
  align-items: center;
  width: 100%;
  padding: 14px 18px;
  background: linear-gradient(135deg, #be185d20, #9333ea20);
  border: 1.5px solid #be185d50;
  border-radius: 18px;
  cursor: pointer;
  gap: 12px;
  margin-bottom: 20px;
  transition: transform 0.15s, box-shadow 0.15s;
  animation: ${s} 0.3s ease both;

  &:hover {
    transform: translateY(-2px);
    box-shadow: 0 8px 24px #be185d30;
  }
`,M=i.default.span`font-size: 28px;`,T=i.default.div`
  flex: 1;
  text-align: left;
`,B=i.default.div`
  font-size: 15px;
  font-weight: 700;
  color: #f1f5f9;
`,L=i.default.div`font-size: 12px; color: #94a3b8;`,E=i.default.div`color: #be185d;`,P=(i.default.div`
...
`,F=i.default.button`
  ...
  background: ${({color:e,done:o})=>o?`linear-gradient(135deg, ${e}30, ${e}18)`:"linear-gradient(135deg, #1e2235, #161929)"};
  border: 1.5px solid ${({color:e,done:o})=>o?e+"60":"#ffffff12"};
  border-radius: 20px;
  cursor: pointer;
  text-align: left;
  ...
  &:hover {
    ...
    border-color: ${({color:e})=>e}90;
    box-shadow: 0 10px 28px ${({color:e})=>e}25;
  }
...
`,N=i.default.div`
  ...
  justify-content: space-between;
  margin-bottom: 8px;
`,I=i.default.div`font-size: 36px; line-height: 1;`,D=i.default.div`
  font-size: 10px;
  font-weight: 700;
  color: ${({color:e})=>e};
...
`,K=i.default.span`
  ...
  filter: ${({lit:e,color:o})=>e?`drop-shadow(0 0 5px ${o})`:"none"};
...
`,W=i.default.div`
  ...
  border-radius: 14px;
  padding: 8px 12px;
`,J=i.default.span`font-size: 20px;`,Z=i.default.span`
  font-size: 12px;
  font-weight: 600;
  color: #cbd5e1;
`;function q({progress:e,speechDebug:o,onSelectLesson:a,onOpenFavorites:i,onSpeechTest:t}){const s=r.Yq.length,d=Object.values(e.lessons).filter(e=>e.completed).length,c=Math.round(d/s*100);return(0,l.jsxs)(u,{children:[(0,l.jsx)(g,{children:(0,l.jsxs)(f,{children:[(0,l.jsxs)(p,{children:[(0,l.jsxs)("div",{children:[(0,l.jsx)(h,{children:"LêBem"}),(0,l.jsx)(x,{children:"A aprender a ler! 🚀"})]}),(0,l.jsx)(b,{children:"🦉"})]}),(0,l.jsxs)(z,{children:[(0,l.jsxs)(y,{color:"#f59e0b",children:[(0,l.jsx)(w,{children:"⭐"}),(0,l.jsx)(j,{children:e.totalStars}),(0,l.jsx)(v,{children:"estrelas"})]}),(0,l.jsxs)(y,{color:"#7c3aed",children:[(0,l.jsx)(w,{children:"🏆"}),(0,l.jsxs)(j,{children:["Nível ",e.level]})]}),(0,l.jsxs)(y,{color:"#10b981",children:[(0,l.jsx)(w,{children:"🔥"}),(0,l.jsx)(j,{children:e.streak}),(0,l.jsx)(v,{children:"dias"})]})]}),(0,l.jsx)(A,{children:(0,l.jsx)(k,{pct:c})}),(0,l.jsxs)(S,{children:[(0,l.jsxs)("span",{children:[d," de ",s," lições"]}),(0,l.jsxs)("span",{children:[c,"% completo"]})]})]})}),(0,l.jsxs)($,{children:[!1,(0,l.jsxs)(C,{onClick:i,children:[(0,l.jsx)(M,{children:"❤️"}),(0,l.jsxs)(T,{children:[(0,l.jsx)(B,{children:"Os meus Favoritos"}),(0,l.jsxs)(L,{children:[e.favorites.length," cartões guardados"]})]}),(0,l.jsx)(E,{children:(0,l.jsx)(n.A,{size:20})})]}),r.wC.map((o,i)=>{const t=o.ids.map(e=>r.Yq.find(o=>o.id===e)).filter(Boolean);return(0,l.jsxs)(P,{index:i,children:[(0,l.jsx)(O,{children:o.label}),(0,l.jsx)(R,{children:t.map(o=>{const i=e.lessons[o.id],t=i?.stars??0,n=i?.completed??!1;return(0,l.jsxs)(F,{color:o.color,done:n,onClick:()=>a(o.id),children:[(0,l.jsxs)(N,{children:[(0,l.jsx)(I,{children:o.icon}),n&&(0,l.jsx)(D,{color:o.color,children:"✓ Feito"})]}),(0,l.jsx)(V,{children:o.title}),(0,l.jsx)(G,{children:o.subtitle}),(0,l.jsxs)(U,{children:[[1,2,3].map(e=>(0,l.jsx)(K,{lit:t>=e,color:o.color,delay:80*e,children:"⭐"},e)),(0,l.jsxs)(Y,{children:[o.cards.length," cartões"]})]})]},o.id)})})]},o.label)}),e.badges.length>0&&(0,l.jsxs)(H,{children:[(0,l.jsx)(O,{children:"🏅 Conquistas"}),(0,l.jsx)(_,{children:e.badges.map(e=>{const o=r.hc[e];return o?(0,l.jsxs)(W,{title:o.desc,children:[(0,l.jsx)(J,{children:o.emoji}),(0,l.jsx)(Z,{children:o.label})]},e):null})})]})]})]})}},8903(e,o,a){a.d(o,{R:()=>ae});var i=a(7359),t=a(3233),n=a(7207),r=a(947),l=a(6680),s=a(7180),d=a(2887),c=a(2709),m=a(1604),u=a(906),g=a(63),f=a(7661),p=a(5723);n.keyframes`from { opacity: 0; transform: scale(0.95); } to { opacity: 1; transform: scale(1); }`;const h=n.keyframes`0%,100%{ transform: translateX(0); } 25%{ transform: translateX(-10px); } 75%{ transform: translateX(10px); }`,x=n.keyframes`0%{ transform: scale(1); } 50%{ transform: scale(1.2); } 100%{ transform: scale(1); }`,b=n.keyframes`from{ transform: translateY(0) scale(1); opacity: 1; } to{ transform: translateY(-120px) scale(0.3) rotate(360deg); opacity: 0; }`,z=n.keyframes`0%,100%{ transform: translateY(0); } 50%{ transform: translateY(-12px); }`,y=t.default.div`
  display: flex;
  flex-direction: column;
  height: 100vh;
...
`,$=t.default.div`
  ...
  line-height: 1;
  cursor: pointer;
  animation: ${z} 2.5s ease-in-out infinite;
...
`,V=t.default.div`font-size: 80px; line-height: 1;`,G=t.default.div`
  font-size: 20px;
  font-weight: 700;
  color: ${u.w4.colors.mainText};
`,U=t.default.div`
...
`,H=t.default.div`font-size: 42px; line-height: 1;`,_=t.default.div`
  font-size: 30px;
  font-weight: 900;
  color: ${({color:e})=>e};
`,W=t.default.div`
...
`,oe=t.default.button`
  ...
  transition: opacity 0.15s, transform 0.15s;
  &:hover { opacity: 0.9; transform: translateY(-2px); }
`;function ae({lessonId:e,progress:o,onBack:a,onComplete:t,onToggleFavorite:n}){const u=(0,g.db)(e),[h,x]=(0,i.useState)("learn"),[b,z]=(0,i.useState)(0),[ae,ie]=(0,i.useState)([]),[te,ne]=(0,i.useState)(0),[re,le]=(0,i.useState)([]),[se,de]=(0,i.useState)(null),[ce,me]=(0,i.useState)(0),[ue,ge]=(0,i.useState)(!1),[fe,pe]=(0,i.useState)(!1),[he,xe]=(0,i.useState)(!1),be=(0,i.useCallback)(e=>{(0,f.Lr)(e),xe(!0),setTimeout(()=>xe(!1),1200)},[]),ze=(0,i.useCallback)(()=>{const e=(0,g.GV)(u);ie(e),ne(0),le([]),de(null),me(0),x("quiz")},[u]),ye=(0,i.useCallback)(e=>{if(null!==se||!ae[te])return;const o=e===ae[te].correctIndex;de(e),o?(me(e=>e+1),le(e=>[...e,"correct"]),setTimeout(()=>(0,f.Lr)(ae[te]?.promptWord??ae[te]?.promptLetter??""),200)):(ge(!0),le(e=>[...e,"wrong"]),setTimeout(()=>ge(!1),500)),setTimeout(()=>{te+1>=ae.length?(x("result"),pe(!0)):(ne(e=>e+1),de(null))},900)},[se,ae,te]),we=(0,i.useCallback)(()=>{t(e,ce,ae.length)},[e,ce,ae.length,t]);if(!u)return null;const je=u.cards[b],ve=`${e}:${je?.id}`,Ae=o.favorites.includes(ve),ke=ce>=ae.length?3:ce>=ae.length-1?2:ce>=Math.ceil(ae.length/2)?1:0;if("learn"===h)return(0,p.jsxs)(y,{children:[(0,p.jsxs)(w,{children:[(0,p.jsx)(j,{onClick:a,children:(0,p.jsx)(s.A,{size:18})}),(0,p.jsx)(v,{children:u.title}),(0,p.jsx)(A,{children:u.cards.map((e,o)=>(0,p.jsx)(k,{active:o===b,done:o<b,color:u.color},o))})]}),(0,p.jsxs)(S,{children:[(0,p.jsx)($,{color:u.color,onClick:()=>be(je.word),children:je.emoji}),(0,p.jsx)(C,{color:u.color,children:je.letter}),(0,p.jsx)(M,{children:je.word}),je.hint&&(0,p.jsx)(T,{children:je.hint}),(0,p.jsxs)(B,{children:[(0,p.jsx)(L,{type:"button",color:"#f59e0b",active:he,title:"Ouvir",onClick:()=>be(je.word),children:(0,p.jsx)(m.A,{size:22,color:"#f59e0b"})}),(0,p.jsx)(L,{type:"button",color:"#ef4444",active:Ae,title:Ae?"Remover dos favoritos":"Adicionar aos favoritos",onClick:()=>n(ve),children:(0,p.jsx)(c.A,{size:22,fill:Ae?"#ef4444":"none",color:"#ef4444"})})]})]}),(0,p.jsxs)(E,{children:[(0,p.jsxs)(P,{color:u.color,disabled:0===b,onClick:()=>{b>0&&z(e=>e-1)},children:[(0,p.jsx)(s.A,{size:18})," Anterior"]}),b<u.cards.length-1?(0,p.jsxs)(P,{color:u.color,onClick:()=>{z(e=>e+1),be(u.cards[b+1].word)},children:["Próxima ",(0,p.jsx)(d.A,{size:18})]}):(0,p.jsx)(O,{color:u.color,onClick:ze,children:"Fazer Quiz 🎯"})]})]});if("quiz"===h){const e=ae[te];return e?(0,p.jsxs)(y,{children:[(0,p.jsxs)(w,{children:[(0,p.jsx)(j,{onClick:a,children:(0,p.jsx)(s.A,{size:18})}),(0,p.jsxs)(v,{children:["Quiz — ",u.title]})]}),(0,p.jsxs)(R,{children:[(0,p.jsx)(F,{children:ae.map((e,o)=>(0,p.jsx)(N,{color:u.color,state:o<re.length?re[o]:o===te?"current":"pending"},o))}),(0,p.jsx)(I,{children:e.label}),(0,p.jsxs)(D,{isShaking:ue,color:u.color,children:[e.promptEmoji&&(0,p.jsx)(V,{children:e.promptEmoji}),e.promptWord&&"word-to-emoji"!==e.type&&(0,p.jsx)(G,{children:e.promptWord}),"word-to-emoji"===e.type&&(0,p.jsx)(U,{color:u.color,children:e.promptWord}),e.promptLetter&&(0,p.jsx)(U,{color:u.color,children:e.promptLetter})]}),(0,p.jsx)(K,{count:e.options.length,children:e.options.map((o,a)=>{const i=null===se?"idle":a===e.correctIndex?"correct":a===se&&se!==e.correctIndex?"wrong":"idle";return(0,p.jsxs)(Y,{state:i,isShaking:"wrong"===i&&ue,disabled:null!==se,onClick:()=>ye(a),children:[o.emoji&&(0,p.jsx)(H,{children:o.emoji}),o.letter&&(0,p.jsx)(_,{color:u.color,children:o.letter})]},a)})}),(0,p.jsxs)(W,{children:[null!==se&&se===e.correctIndex&&(0,p.jsxs)(p.Fragment,{children:[(0,p.jsx)(r.A,{size:22,color:"#10b981"})," ",(0,p.jsx)("span",{style:{color:"#10b981"},children:"Muito bem! 🎉"})]}),null!==se&&se!==e.correctIndex&&(0,p.jsxs)(p.Fragment,{children:[(0,p.jsx)(l.A,{size:22,color:"#ef4444"})," ",(0,p.jsxs)("span",{style:{color:"#ef4444"},children:["Era ",e.options[e.correctIndex]?.letter??e.options[e.correctIndex]?.emoji,"!"]})]})]})]})]}):null}const Se=ke>0?["⭐","✨","🌟","💫","⭐","✨"].map((e,o)=>({emoji:e,x:10+15*o,delay:.15*o})):[];return(0,p.jsxs)(y,{children:[(0,p.jsxs)(w,{children:[(0,p.jsx)(j,{onClick:a,children:(0,p.jsx)(s.A,{size:18})}),(0,p.jsx)(v,{children:"Resultado"})]}),(0,p.jsxs)(J,{children:[fe&&Se.map((e,o)=>(0,p.jsx)(Z,{x:e.x,delay:e.delay,children:e.emoji},o)),(0,p.jsx)(q,{children:3===ke?"🏆":2===ke?"🎉":1===ke?"👍":"😅"}),(0,p.jsx)(Q,{color:u.color,children:3===ke?"Perfeito!":2===ke?"Muito bem!":1===ke?"Bom esforço!":"Continua a tentar!"}),(0,p.jsxs)(X,{children:[ce," de ",ae.length," acertos"]}),(0,p.jsx)(ee,{children:[1,2,3].map(e=>(0,p.jsx)("span",{style:{opacity:ke>=e?1:.2},children:"⭐"},e))}),(0,p.jsx)(oe,{color:u.color,onClick:we,children:"Continuar →"})]})]})}},7661(e,o,a){a.d(o,{Gq:()=>z,Lr:()=>w,d:()=>b,dq:()=>x,tl:()=>j});let i=null,t=null,n=[],r=!1,l=null,s="idle",d=null;const c=new Set,m=["Joana","Luciana","Eddy","Flo","Grandma","Grandpa","Reed","Rocko","Sandy","Shelley"];function u(){return/Chrome/i.test(window.navigator.userAgent)&&!/Edg|OPR|CriOS/i.test(window.navigator.userAgent)}function g(){const e=b();for(const o of c)o(e)}function f(){return 0===n.length&&(n=window.speechSynthesis.getVoices()),n}function p(){if(n=window.speechSynthesis.getVoices(),d&&n.length>0){const e=d;d=null,window.setTimeout(()=>y(e),0)}return g(),n}function h(){const e=f();if(u())return e.find(e=>e.default&&e.lang.toLowerCase().startsWith("pt"))??e.find(e=>"pt-br"===e.lang.toLowerCase())??e.find(e=>"pt-pt"===e.lang.toLowerCase())??e.find(e=>e.lang.toLowerCase().startsWith("pt"))??null;for(const o of m){const a=e.find(e=>e.name.toLowerCase()===o.toLowerCase());if(a)return a}return e.find(e=>"pt-pt"===e.lang.toLowerCase())??e.find(e=>"pt-br"===e.lang.toLowerCase())??e.find(e=>e.lang.toLowerCase().startsWith("pt"))??e.find(e=>e.default)??null}function x(){"speechSynthesis"in window&&(p(),r||(window.speechSynthesis.addEventListener("voiceschanged",p),r=!0,g()))}function b(){if(!("speechSynthesis"in window))return{supported:!1,voicesCount:0,preferredVoiceName:null,preferredVoiceLang:null,availableVoiceNames:[],speaking:!1,pending:!1,paused:!1,lastEvent:s,lastError:l};const e=window.speechSynthesis,o=h(),a=f();return{supported:!0,voicesCount:a.length,preferredVoiceName:o?.name??null,preferredVoiceLang:o?.lang??null,availableVoiceNames:a.filter(e=>e.lang.toLowerCase().startsWith("pt")).slice(0,6).map(e=>`${e.name} (${e.lang})`),speaking:e.speaking,pending:e.pending,paused:e.paused,lastEvent:s,lastError:l}}function z(e){return c.add(e),e(b()),()=>{c.delete(e)}}function y(e){const o=window.speechSynthesis,a=e.trim(),n=f();if(!a)return;if(0===n.length)return d=a,s="waiting-for-voices",g(),void window.setTimeout(()=>{d===a&&(d=null,y(a))},400);null!==t&&(window.clearTimeout(t),t=null),l=null,s="queued",i=new SpeechSynthesisUtterance(a),i.lang=u()?"pt-BR":"pt-PT",i.rate=.8,i.pitch=1.1;const r=h();r&&!u()?(i.voice=r,i.lang=r.lang):r&&(i.lang=r.lang),i.onstart=()=>{s="start",g()},i.onend=()=>{i=null,s="end",g()},i.onerror=e=>{i=null,s="error",l=e.error,g()},o.resume(),o.speak(i),g()}function w(e){if(!("speechSynthesis"in window))return;const o=window.speechSynthesis,a=e.trim();if(a){if(null!==t&&(window.clearTimeout(t),t=null),o.speaking||o.pending)return s="cancel",o.cancel(),t=window.setTimeout(()=>y(a),150),void g();y(a)}}function j(){w("Ola, teste de voz do LeBem. Esta e a voz do leitor.")}},4698(e,o,a){a.d(o,{$s:()=>l,FB:()=>r,K7:()=>n,dw:()=>s,fm:()=>c});const i="atlantis-leitor-progress",t={totalStars:0,level:1,streak:0,lastPlayedDate:"",lessons:{},favorites:[],badges:[]};function n(){try{const e=localStorage.getItem(i);return e?{...t,...JSON.parse(e)}:{...t}}catch{return{...t}}}function r(e){try{localStorage.setItem(i,JSON.stringify(e))}catch{}}function l(e,o,a,i){a>=i||a>=i-1||Math.ceil(i/2);const t=e.lessons[o],n=Math.max(t?.bestScore??0,a),r=n>=i?3:n>=i-1?2:n>=Math.ceil(i/2)?1:0,l=Math.max(0,r-(t?.stars??0)),s=(new Date).toISOString().split("T")[0],d=(()=>{if(!e.lastPlayedDate)return!1;const o=new Date(e.lastPlayedDate);return 1==(new Date(s).getTime()-o.getTime())/864e5})();return{...e,totalStars:e.totalStars+l,level:Math.floor((e.totalStars+l)/5)+1,streak:e.lastPlayedDate===s?e.streak:d?e.streak+1:1,lastPlayedDate:s,lessons:{...e.lessons,[o]:{stars:r,bestScore:n,completed:r>0}}}}function s(e,o){const a=e.favorites.includes(o);return{...e,favorites:a?e.favorites.filter(e=>e!==o):[...e.favorites,o]}}function d(e,o){return e.badges.includes(o)?e:{...e,badges:[...e.badges,o]}}function c(e){let o=e;return o.totalStars>=1&&!o.badges.includes("primeira-estrela")&&(o=d(o,"primeira-estrela")),Object.values(o.lessons).filter(e=>e.completed).length>=1&&!o.badges.includes("primeira-licao")&&(o=d(o,"primeira-licao")),Object.values(o.lessons).some(e=>3===e.stars)&&!o.badges.includes("tres-estrelas")&&(o=d(o,"tres-estrelas")),o.favorites.length>=10&&!o.badges.includes("coleccionador")&&(o=d(o,"coleccionador")),3!==o.lessons.vogais?.stars||o.badges.includes("vogais-mestre")||(o=d(o,"vogais-mestre")),["silabas-b","silabas-c","silabas-d","silabas-f","silabas-g","silabas-l","silabas-m","silabas-n","silabas-p","silabas-r","silabas-s","silabas-t","silabas-v"].every(e=>o.lessons[e]?.completed)&&!o.badges.includes("leitor")&&(o=d(o,"leitor")),["animais","cores","numeros","corpo","familia"].every(e=>o.lessons[e]?.completed)&&!o.badges.includes("explorador")&&(o=d(o,"explorador")),3!==o.lessons.numeros?.stars||o.badges.includes("numeros-mestre")||(o=d(o,"numeros-mestre")),o}}}]);
//# sourceMappingURL=170.111e9baf0abcabd7fb2b.js.map