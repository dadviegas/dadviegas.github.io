...
`;function eF({type:e,children:t}){let o=ez[e]??ez.NOTE;return(0,r.jsxs)(eT,{bg:o.bg,border:o.border,children:[(0,r.jsxs)(ej,{color:o.color,children:[(0,r.jsx)(F,{name:o.icon,size:15,strokeWidth:2}),o.label]}),(0,r.jsx)(eS,{children:t})]})}function eC(){let e=/^\[!(NOTE|TIP|WARNING|CAUTION|IMPORTANT)\]\s*/i;return t=>{function o(t,o,r){let a=o.children?.[0];a?.type==="text"&&(a.value=a.value.replace(e,""),a.value.trim()||1!==o.children.length||o.children.shift()),t.data=t.data??{},t.data.hName="div",t.data.hProperties={"data-callout":r.toUpperCase()}}!function t(r){if("blockquote"===r.type){let t=r.children?.[0];if(t?.type==="paragraph"){let a=t.children?.[0],i=a?.type==="text"&&a.value?.match(e);i&&o(r,t,i[1])}}if("paragraph"===r.type){let t=r.children?.[0],a=t?.type==="text"&&t.value?.match(e);if(a){let t=[...r.children];r.children=[{type:"paragraph",children:t}],o(r,r.children[0],a[1]);let i=t[0];i?.type==="text"&&(i.value=i.value.replace(e,""),i.value.trim()||1!==t.length||t.shift());return}}r.children?.forEach(t)}(t)}}l().nav`
  width: 220px;
  min-width: 220px;
...
`;l().div`
  ...
  pointer-events: none;
  z-index: 200;
  animation: ${eV} 0.16s cubic-bezier(0.4, 0, 0.2, 1) forwards;
...
`,l().div`
  ...
  flex-direction: column;
  gap: 14px;
  animation: ${eI} 0.18s cubic-bezier(0.22, 1, 0.36, 1) both;
`,l().div`
  font-size: ${s.w4.typography.fontSizeMd};
  font-weight: 700;
...
`,l().div`
  position: relative;
`;let eW="260px",eD="56px",eO="48px",eq=l().header`
  display: flex;
  align-items: center;
...
`,eZ=l().span`
  ...
  animation: ${e_} 10s ease ${({index:e})=>.07*e}s infinite;
...
`,e0=l().div`
  ...
  overflow: hidden;
`,e1=l().aside`
  width: ${({collapsed:e})=>e?eD:eW};
  min-width: ${({collapsed:e})=>e?eD:eW};
  background: ${s.w4.colors.sidebarBg};
  border-right: 1px solid ${s.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,e4=l().main`
  ...
  display: flex;
  flex-direction: column;
`,e5=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function e3(){return(0,r.jsx)(eK,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:e5.map((e,t)=>(0,r.jsx)(eZ,{index:t,accent:e.accent,children:e.char},t))})}let e6="atlantis:sidebar-collapsed";function e8({sidebar:e,children:t,topBarRight:n,title:l="Atlantis",activeId:s=null}){let[d,c]=(0,a.useState)(()=>{try{return"true"===localStorage.getItem(e6)}catch{return!1}}),[p,g]=(0,a.useState)(null),h=(0,a.useRef)(),x=()=>c(e=>{let t=!e;try{localStorage.setItem(e6,String(t))}catch{}return t}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(o.bind(o,5816)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(eA.I.Provider,{value:{collapsed:d,toggle:x,flyout:p,openFlyout:(e,t,o)=>{clearTimeout(h.current),g({entry:e,anchorY:t,onSelect:o})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,r.jsxs)(e0,{children:[(0,r.jsxs)(eq,{children:[e&&(0,r.jsx)(eG,{children:(0,r.jsx)(eX,{onClick:x,title:d?"Expand sidebar":"Collapse sidebar",children:(0,r.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,r.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,r.jsx)("path",{d:"M9 3v18"})]})})}),(0,r.jsx)(e3,{}),l&&(0,r.jsx)(eU,{children:l}),n&&(0,r.jsx)(eJ,{children:n})]}),(0,r.jsxs)(eQ,{children:[null!=e&&(0,r.jsx)(e1,{collapsed:d,children:(0,r.jsx)(e2,{children:e})}),(0,r.jsx)(e4,{children:t})]}),p&&(0,r.jsx)(i().Suspense,{fallback:null,children:(0,r.jsx)(f,{activeId:s})})]})})}l().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
