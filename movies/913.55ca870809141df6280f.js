...
`,w=i.default.main`
  ...
  display: flex;
  flex-direction: column;
`,v="atlantis:sidebar-collapsed";function k({sidebar:e,children:o,topBarRight:n,title:i="Atlantis",activeId:d=null}){const[c,k]=(0,t.useState)(()=>{try{return"true"===localStorage.getItem(v)}catch{return!1}}),[A,$]=(0,t.useState)(null),j=(0,t.useRef)(),S=()=>k(e=>{const o=!e;try{localStorage.setItem(v,String(o))}catch{}return o}),M=t.useMemo(()=>t.lazy(()=>Promise.resolve().then(a.bind(a,4914)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(s.I.Provider,{value:{collapsed:c,toggle:S,flyout:A,openFlyout:(e,o,a)=>{clearTimeout(j.current),$({entry:e,anchorY:o,onSelect:a})},scheduleFlyoutClose:()=>{j.current=setTimeout(()=>$(null),160)},cancelFlyoutClose:()=>clearTimeout(j.current)},children:(0,r.jsxs)(b,{children:[(0,r.jsxs)(m,{children:[e&&(0,r.jsx)(u,{children:(0,r.jsx)(p,{onClick:S,title:c?"Expand sidebar":"Collapse sidebar",children:(0,r.jsx)(l.A,{size:17})})}),(0,r.jsxs)(g,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:["Atl",(0,r.jsx)("span",{children:"antis"})]}),i&&(0,r.jsx)(f,{children:i}),n&&(0,r.jsx)(x,{children:n})]}),(0,r.jsxs)(h,{children:[null!=e&&(0,r.jsx)(y,{collapsed:c,children:(0,r.jsx)(z,{children:e})}),(0,r.jsx)(w,{children:o})]}),A&&(0,r.jsx)(t.Suspense,{fallback:null,children:(0,r.jsx)(M,{activeId:d})})]})})}a(5185),i.default.div`
  display: grid;
...
`,R=300;function L({item:e,rect:o,onOpen:a,onMouseEnter:n,onMouseLeave:t,withBackdrop:i,onBackdropTap:r}){const l=function(e){const o=window.innerWidth,a=window.innerHeight;if(o<500){const n=Math.max(8,(o-R)/2);return{top:Math.max(8,Math.min(e.bottom+8,a-310-8)),left:n}}let n=e.right+10;n+R>o-8&&(n=e.left-R-10),n=Math.max(8,Math.min(n,o-R-8));let t=e.top+e.height/2-155;return t=Math.max(8,Math.min(t,a-310-8)),{top:t,left:n}}(o),d=(0,u.rS)(e),g=(0,u.Ox)(e),f=(0,u.U7)(e.backdrop_path,"w780");return s.createPortal((0,p.jsxs)(p.Fragment,{children:[i&&(0,p.jsx)("div",{style:{position:"fixed",inset:0,zIndex:9998},onClick:r}),(0,p.jsxs)($,{top:l.top,left:l.left,onMouseEnter:n,onMouseLeave:t,onClick:a,style:{cursor:"pointer"},children:[f?(0,p.jsx)(j,{src:f}):(0,p.jsx)(S,{}),(0,p.jsxs)(M,{children:[(0,p.jsx)(T,{children:d}),(0,p.jsxs)(C,{children:[(0,p.jsxs)(_,{children:[(0,p.jsx)(c.A,{size:11,fill:"currentColor"}),e.vote_average.toFixed(1)]}),g&&(0,p.jsx)(B,{children:g}),(0,p.jsx)(P,{kind:e.media_type,children:"movie"===e.media_type?"Film":"TV"})]}),e.overview&&(0,p.jsx)(E,{children:e.overview}),(0,p.jsxs)(F,{onClick:a,children:[(0,p.jsx)(m.A,{size:13}),"More Info"]})]})]})]}),document.body)}function D({item:e,onClick:o}){const a=(0,u.rS)(e),t=(0,u.Ox)(e),i=(0,u.HD)(e.poster_path),r=(0,n.useRef)(null),l=(0,n.useRef)(),s=(0,n.useRef)(),d=(0,n.useRef)(null),m=(0,n.useRef)(!1),[A,$]=(0,n.useState)(!1),[j,S]=(0,n.useState)(!1),[M,T]=(0,n.useState)(null),[C,_]=(0,n.useState)(!1);(0,n.useEffect)(()=>()=>{clearTimeout(l.current),clearTimeout(s.current)},[]);const B=(0,n.useCallback)((e,o)=>{T(e),S(!0),_(o)},[]),P=(0,n.useCallback)(()=>{S(!1),T(null),_(!1)},[]),E=(0,n.useCallback)(()=>{P(),o(e)},[e,o,P]),F=(0,n.useCallback)(()=>{$(!0),clearTimeout(s.current),l.current=setTimeout(()=>{const e=r.current?.getBoundingClientRect();e&&B(e,!1)},400)},[B]),R=(0,n.useCallback)(()=>{$(!1),clearTimeout(l.current),s.current=setTimeout(P,180)},[P]),D=(0,n.useCallback)(()=>{clearTimeout(s.current)},[]),I=(0,n.useCallback)(()=>{P()},[P]),N=(0,n.useCallback)(e=>{j||(d.current={x:e.touches[0].clientX,y:e.touches[0].clientY})},[j]),K=(0,n.useCallback)(a=>{if(j||!d.current)return;const n=a.changedTouches[0],t=Math.abs(n.clientX-d.current.x),i=Math.abs(n.clientY-d.current.y);if(d.current=null,t>8||i>8)return;if(m.current=!0,window.innerWidth<768)return void o(e);const l=r.current?.getBoundingClientRect();l&&B(l,!0)},[j,e,o,B]),U=(0,n.useCallback)(()=>{m.current?m.current=!1:j||C||E()},[j,C,E]);return(0,p.jsxs)(p.Fragment,{children:[(0,p.jsxs)(g,{ref:r,onClick:U,onMouseEnter:F,onMouseLeave:R,onTouchStart:N,onTouchEnd:K,title:a,role:"button",tabIndex:0,onKeyDown:e=>{"Enter"!==e.key&&" "!==e.key||E()},children:[(0,p.jsx)(k,{kind:e.media_type,children:"movie"===e.media_type?"Film":"TV"}),i?(0,p.jsx)(f,{src:i,alt:a,loading:"lazy"}):(0,p.jsxs)(x,{children:["🎬",(0,p.jsx)(h,{children:a})]}),(0,p.jsxs)(b,{visible:A,children:[(0,p.jsx)(y,{children:a}),(0,p.jsxs)(z,{children:[(0,p.jsxs)(w,{children:[(0,p.jsx)(c.A,{size:9,fill:"currentColor"}),e.vote_average.toFixed(1)]}),t&&(0,p.jsx)(v,{children:t})]})]})]}),j&&M&&(0,p.jsx)(L,{item:e,rect:M,onOpen:E,onMouseEnter:D,onMouseLeave:I,withBackdrop:C,onBackdropTap:P})]})}const I=t.default.div`
  display: flex;
  flex-direction: column;
  gap: ${i.w4.spacing.md};
...
`,ge=t.default.div`
  ...
  color: ${r.w4.colors.mainTextMuted};
  padding: 12px 0;
`;function fe({provider:e,title:o,appleTVUrl:a}){const n=w.RY[e.provider_name]??r.w4.colors.surface,t=(0,w.$8)(e,o,a);return(0,k.jsxs)(ie,{bg:n,href:t,target:"_blank",rel:"noreferrer",children:[e.logo_path&&(0,k.jsx)(re,{src:(0,w.vo)(e.logo_path),alt:e.provider_name}),(0,k.jsxs)(le,{children:[(0,k.jsx)(se,{children:e.provider_name}),(0,k.jsxs)(de,{children:[(0,k.jsx)(m.A,{size:9}),(0,w.mS)(e.provider_id)?"Open in Apple TV":`Open in ${e.provider_name}`]})]})]})}function xe({item:e,apiKey:o,onBack:a,onLibraryChange:t}){const[i,m]=(0,n.useState)(null),[A,$]=(0,n.useState)([]),[j,ie]=(0,n.useState)(null),[re,le]=(0,n.useState)([]),[de,xe]=(0,n.useState)(!0),[he,be]=(0,n.useState)(null),[ye,ze]=(0,n.useState)(!1),[we,ve]=(0,n.useState)(()=>(0,v.BA)(e)),[ke,Ae]=(0,n.useState)(()=>(0,v.U4)(e)),$e=(0,w.rS)(e),je=(0,w.Ox)(e);(0,n.useEffect)(()=>{const e=e=>{"Escape"===e.key&&a()};return document.addEventListener("keydown",e),()=>document.removeEventListener("keydown",e)},[a]),(0,n.useEffect)(()=>{xe(!0),ze(!1),Promise.all([(0,w.Ug)(o,e.media_type,e.id),(0,w.fY)(o,e.media_type,e.id),(0,w.Mt)(o,e.media_type,e.id),(0,w.Pg)(o,e.media_type,e.id)]).then(([e,o,a,n])=>{m(e),$(o),ie(a),le(n),xe(!1)}).catch(()=>xe(!1)),(0,w.Su)($e,e.media_type,je).then(be)},[e.id,e.media_type,o,$e,je]);const Se=A.find(e=>"YouTube"===e.site&&("Trailer"===e.type||"Teaser"===e.type)&&e.official)??A.find(e=>"YouTube"===e.site&&"Trailer"===e.type)??A.find(e=>"YouTube"===e.site),Me=(0,n.useCallback)(()=>{(0,v.dw)(e),ve(e=>!e),t?.()},[e,t]),Te=(0,n.useCallback)(()=>{(0,v.w0)(e),Ae(e=>!e),t?.()},[e,t]),Ce=[...j?.flatrate??[]].filter((e,o,a)=>a.findIndex(o=>o.provider_id===e.provider_id)===o),_e=(j?.rent??[]).filter(e=>!Ce.find(o=>o.provider_id===e.provider_id)),Be=Ce[0],Pe=Be?(0,w.$8)(Be,$e,he):he??`https://tv.apple.com/search?term=${encodeURIComponent($e)}`,Ee=(0,w.U7)(e.backdrop_path??i?.backdrop_path??null,"w1280"),Fe=Se?`https://i.ytimg.com/vi/${Se.key}/maxresdefault.jpg`:"";return(0,k.jsx)(S,{children:(0,k.jsxs)(M,{children:[(0,k.jsxs)(T,{src:Ee,children:[(0,k.jsxs)(_,{onClick:a,children:[(0,k.jsx)(l.A,{size:15}),"Back"]}),(0,k.jsxs)(C,{children:[(0,k.jsx)(B,{children:$e}),i?.tagline&&(0,k.jsxs)(P,{children:['"',i.tagline,'"']}),(0,k.jsxs)(E,{children:[(0,k.jsxs)(F,{children:[(0,k.jsx)(h.A,{size:15,fill:"currentColor"}),e.vote_average.toFixed(1)]}),je&&(0,k.jsxs)(R,{children:[(0,k.jsx)(s.A,{size:13}),je]}),i?.runtime&&(0,k.jsxs)(R,{children:[(0,k.jsx)(c.A,{size:13}),Math.floor(i.runtime/60),"h ",i.runtime%60,"m"]}),i?.number_of_seasons&&(0,k.jsxs)(R,{children:[(0,k.jsx)(y.A,{size:13}),i.number_of_seasons," season",1!==i.number_of_seasons?"s":""]})]}),i?.genres&&i.genres.length>0&&(0,k.jsx)(L,{children:i.genres.map(e=>(0,k.jsx)(D,{children:e.name},e.id))}),(0,k.jsxs)(I,{children:[(0,k.jsxs)(N,{href:Pe,target:"_blank",rel:"noreferrer",children:[(0,k.jsx)(x.A,{size:16,fill:"black"}),"Watch Now"]}),(0,k.jsxs)(K,{active:we,onClick:Me,children:[(0,k.jsx)(g.A,{size:14,fill:we?"currentColor":"none"}),we?"Favorited":"Favorite"]}),(0,k.jsxs)(K,{active:ke,onClick:Te,children:[ke?(0,k.jsx)(u.A,{size:14}):(0,k.jsx)(p.A,{size:14}),ke?"Unseen":"Mark Seen"]}),(we||ke)&&(0,k.jsx)(K,{danger:!0,onClick:()=>{we&&((0,v.dw)(e),ve(!1)),ke&&((0,v.w0)(e),Ae(!1)),t?.()},children:(0,k.jsx)(b.A,{size:14})})]})]})]}),(0,k.jsxs)(U,{children:[de?(0,k.jsx)(ge,{children:"Loading…"}):(0,k.jsx)(H,{children:e.overview}),Se&&(0,k.jsxs)(Y,{children:[(0,k.jsxs)(V,{children:[(0,k.jsx)(G,{children:(0,k.jsx)(d.A,{size:15})}),(0,k.jsx)(O,{children:"Trailer"})]}),(0,k.jsxs)(W,{children:[ye&&(0,k.jsx)("iframe",{src:`https://www.youtube.com/embed/${Se.key}?autoplay=1&rel=0&modestbranding=1`,title:Se.name,allowFullScreen:!0,allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"}),(0,k.jsx)(J,{src:Fe,loaded:ye,onClick:()=>ze(!0),children:(0,k.jsx)(Z,{className:"play-circle",children:(0,k.jsx)(x.A,{size:24,fill:"white",style:{marginLeft:3}})})})]})]}),(de||re.length>0)&&(0,k.jsxs)(Y,{children:[(0,k.jsxs)(V,{children:[(0,k.jsx)(G,{children:(0,k.jsx)(z.A,{size:15})}),(0,k.jsx)(O,{children:"Cast"})]}),de?(0,k.jsx)(ge,{children:"Loading cast…"}):(0,k.jsx)(X,{children:re.map(e=>(0,k.jsxs)(q,{children:[e.profile_path?(0,k.jsx)(Q,{src:(0,w.DW)(e.profile_path,"w185"),alt:e.name,loading:"lazy"}):(0,k.jsx)(ee,{children:"👤"}),(0,k.jsxs)(oe,{children:[(0,k.jsx)(ae,{children:e.name}),e.character&&(0,k.jsx)(ne,{children:e.character})]})]},e.id))})]}),(0,k.jsxs)(Y,{children:[(0,k.jsxs)(V,{children:[(0,k.jsx)(G,{children:(0,k.jsx)(f.A,{size:15})}),(0,k.jsx)(O,{children:"Where to Watch"})]}),de?(0,k.jsx)(ge,{children:"Loading streaming info…"}):Ce.length>0?(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(te,{children:Ce.map(e=>(0,k.jsx)(fe,{provider:e,title:$e,appleTVUrl:he},e.provider_id))}),_e.length>0&&(0,k.jsxs)("div",{style:{marginTop:8},children:[(0,k.jsx)(ue,{children:"Also available to rent"}),(0,k.jsx)(te,{children:_e.map(e=>(0,k.jsxs)(ce,{bg:w.RY[e.provider_name]??r.w4.colors.surface,children:[e.logo_path&&(0,k.jsx)(me,{src:(0,w.vo)(e.logo_path),alt:e.provider_name}),(0,k.jsx)(se,{style:{color:"#fff"},children:e.provider_name})]},e.provider_id))})]})]}):(j?.rent??[]).length>0?(0,k.jsxs)("div",{children:[(0,k.jsx)(pe,{children:"Not on any streaming subscription right now."}),(0,k.jsx)(ue,{style:{marginTop:12},children:"Available to rent"}),(0,k.jsx)(te,{children:(j?.rent??[]).map(e=>(0,k.jsxs)(ce,{bg:w.RY[e.provider_name]??r.w4.colors.surface,children:[e.logo_path&&(0,k.jsx)(me,{src:(0,w.vo)(e.logo_path),alt:e.provider_name}),(0,k.jsx)(se,{style:{color:"#fff"},children:e.provider_name})]},e.provider_id))})]}):(0,k.jsx)(pe,{children:"No streaming info available for your region (US)."})]})]})]})})}},1385(e,o,a){a.d(o,{K:()=>F});var n=a(7359),t=a(8991),i=a(3233),r=a(7207),l=a(4079),s=a(5609),d=a(7408),c=a(4525),m=a(7390),u=a(5723);const p=r.keyframes`
