"use strict";(self.webpackChunk_atlantis_apiexplorer=self.webpackChunk_atlantis_apiexplorer||[]).push([["8427"],{7330(o,e,a){a.d(e,{FlyoutPanel:()=>oP});var r=a(5723),t=a(7991),n=a.n(t),i=a(6859),l=a.n(i),s=a(2799),d=a(255),c=a(1316),p=a(814),g=a(6896),m=a(7902),f=a(3013),x=a(2887),u=a(9510),b=a(9848),h=a(7901),w=a(3045),y=a(3775),$=a(1783),z=a(3539),v=a(9416),k=a(1837),M=a(7167),A=a(4494),T=a(2314),S=a(5751),j=a(9633),F=a(2946),B=a(822),R=a(6720),P=a(7400),C=a(8456),E=a(3317),H=a(2709),L=a(8006),D=a(9301),K=a(7561),N=a(3517),I=a(8207),V=a(7032),Y=a(6949),G=a(8218),_=a(6829),O=a(9591),J=a(5553),W=a(9923),U=a(2820),Z=a(4621),q=a(8479),X=a(2534),Q=a(6673),oo=a(7490),oe=a(9033),oa=a(9038),or=a(5775),ot=a(1365),on=a(2937),oi=a(9821),ol=a(5912),os=a(158),od=a(8641),oc=a(8607),op=a(3249),og=a(1821),om=a(5889),of=a(9655),ox=a(7170),ou=a(9161),ob=a(1849),oh=a(1604),ow=a(3142),oy=a(1187),o$=a(7747),oz=a(2932),ov=a(4525),ok=a(7230),oM=a(2164);let oA={activity:g.A,"a-large-small":m.A,apple:f.A,"arrow-right":x.A,"bar-chart-2":u.A,book:b.A,"book-open":h.A,briefcase:w.A,calendar:y.A,clock:$.A,"circle-dot":z.A,cloud:v.A,compass:k.A,cpu:M.A,droplets:A.A,feather:T.A,file:d.A,"file-text":S.A,folder:j.A,"git-branch":F.A,github:B.A,globe:R.A,grid:P.A,hand:C.A,hash:E.A,heart:H.A,key:L.A,hexagon:D.A,home:K.A,landmark:N.A,layers:I.A,"layout-grid":V.A,leaf:Y.A,lightbulb:G.A,list:_.A,map:O.A,"map-pin":J.A,"message-circle":W.A,"message-square":U.A,minus:Z.A,monitor:q.A,mountain:X.A,package:Q.A,palette:oo.A,"pen-tool":oe.A,"pie-chart":oa.A,plane:or.A,plus:ot.A,ruler:on.A,shirt:oi.A,slash:ol.A,square:os.A,star:od.A,sun:oc.A,terminal:op.A,thermometer:og.A,triangle:om.A,trophy:of.A,truck:ox.A,type:ou.A,users:ob.A,"volume-2":oh.A,watch:ow.A,waves:oy.A,wind:o$.A,wrench:oz.A,x:ov.A,zap:ok.A,bot:oM.A},oT=(0,s.keyframes)`
...
`,W=s().div`
  ...
  color: ${r.w4.colors.sidebarTextMuted};
  font-family: ${r.w4.typography.fontFamily};
`;function U({onSave:o,onUpdate:e,onCancel:a,existingDoc:r}){let[i,l]=(0,n.useState)(r?.name??""),s=(0,n.useRef)(null);return(0,n.useEffect)(()=>{s.current?.focus(),r&&s.current?.select()},[r]),(0,t.jsx)(I,{onClick:a,children:(0,t.jsxs)(V,{onClick:o=>o.stopPropagation(),children:[(0,t.jsx)(Y,{children:"Save document"}),r&&e&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(W,{children:"Update the current version or save as a new one."}),(0,t.jsxs)(_,{children:[(0,t.jsx)(O,{onClick:a,children:"Cancel"}),(0,t.jsxs)(O,{danger:!0,onClick:e,children:['Update "',r.name,'"']})]}),(0,t.jsx)(J,{})]}),(0,t.jsx)(G,{ref:s,value:i,onChange:o=>l(o.target.value),onKeyDown:t=>{"Enter"===t.key&&i.trim()&&(r&&i.trim()===r.name&&e?e():o(i.trim())),"Escape"===t.key&&a()},placeholder:r?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,t.jsxs)(_,{children:[!r&&(0,t.jsx)(O,{onClick:a,children:"Cancel"}),(0,t.jsx)(O,{primary:!0,disabled:!i.trim(),onClick:()=>o(i.trim()),children:"Save as new"})]})]})})}let Z=(0,d.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,q=(0,d.keyframes)`
...
`;function Y({activeAppId:o}){let{collapsed:e}=(0,l.cL)(),[a]=function(){let[o,e]=(0,t.useState)(k),a=(0,t.useCallback)(o=>{e(o);try{localStorage.setItem($,o)}catch{}(0,l.Is)(z,o).catch(()=>{}),window.dispatchEvent(new CustomEvent("atlantis:locale-change",{detail:o}))},[]);return(0,t.useEffect)(()=>{let o=o=>{e(o.detail)};return window.addEventListener("atlantis:locale-change",o),()=>window.removeEventListener("atlantis:locale-change",o)},[]),(0,t.useEffect)(()=>{(0,l.PL)(z).then(a=>{if(v(a)&&a!==o){try{localStorage.setItem($,a)}catch{}e(a)}}).catch(()=>{})},[]),[o,a]}(),n=(0,t.useMemo)(()=>(o,e)=>{let r=y[o]?.[a]??o;return e?Object.entries(e).reduce((o,[e,a])=>o.replace(RegExp(`\\{${e}\\}`,"g"),String(a)),r):r},[a]),i=(0,t.useRef)(null),s=o=>{i.current!==o&&(i.current=o,document.activeElement?.blur(),window.location.hash=o,setTimeout(()=>{i.current=null},50))};return(0,r.jsxs)(D,{children:[(0,r.jsx)(K,{collapsed:e,children:n("devtools.heading")}),L.map(a=>{let t=n(a.labelKey);return(0,r.jsxs)(N,{active:o===a.id,collapsed:e,onPointerDown:o=>{0===o.button&&s(a.hash)},onClick:()=>s(a.hash),title:t,children:[(0,r.jsx)(I,{children:(0,r.jsx)(A,{name:a.icon,size:16})}),(0,r.jsx)(V,{collapsed:e,children:t})]},a.id)})]})}}}]);