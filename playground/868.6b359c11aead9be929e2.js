...
`,T=i.default.div`
  ...
  color: ${a.w4.colors.sidebarTextMuted};
  font-family: ${a.w4.typography.fontFamily};
`;function B({onSave:n,onUpdate:e,onCancel:o,existingDoc:a}){const[i,l]=(0,t.useState)(a?.name??""),s=(0,t.useRef)(null);return(0,t.useEffect)(()=>{s.current?.focus(),a&&s.current?.select()},[a]),(0,r.jsx)(w,{onClick:o,children:(0,r.jsxs)(v,{onClick:n=>n.stopPropagation(),children:[(0,r.jsx)(A,{children:"Save document"}),a&&e&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(T,{children:"Update the current version or save as a new one."}),(0,r.jsxs)($,{children:[(0,r.jsx)(S,{onClick:o,children:"Cancel"}),(0,r.jsxs)(S,{danger:!0,onClick:e,children:['Update "',a.name,'"']})]}),(0,r.jsx)(M,{})]}),(0,r.jsx)(k,{ref:s,value:i,onChange:n=>l(n.target.value),onKeyDown:t=>{"Enter"===t.key&&i.trim()&&(a&&i.trim()===a.name&&e?e():n(i.trim())),"Escape"===t.key&&o()},placeholder:a?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,r.jsxs)($,{children:[!a&&(0,r.jsx)(S,{onClick:o,children:"Cancel"}),(0,r.jsx)(S,{primary:!0,disabled:!i.trim(),onClick:()=>n(i.trim()),children:"Save as new"})]})]})})}var j=o(8006),C=o(679),E=o(4872);const P=i.default.div`
  position: relative;
`,R=i.default.button`
  display: flex;
  align-items: center;
...
//# sourceMappingURL=868.6b359c11aead9be929e2.js.map