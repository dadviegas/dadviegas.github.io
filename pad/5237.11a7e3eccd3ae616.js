...
`,l().button`
  ...
  border: none;
  cursor: pointer;
  color: ${({active:e})=>e?"#facc15":i.w4.colors.sidebarTextMuted};
...
`,l().button`
  ...
  &:hover { border-color: ${i.w4.colors.accent}; background: ${i.w4.colors.surfaceRaised}; }
`,l().div`
  display: flex; align-items: center; gap: 4px;
  font-size: 11px; color: ${i.w4.colors.sidebarTextMuted}; font-family: ${i.w4.typography.fontFamilyMono};
...
`,Z=l().div`
  ...
  color: ${s.w4.colors.sidebarTextMuted};
  font-family: ${s.w4.typography.fontFamily};
`;function X({onSave:e,onUpdate:o,onCancel:a,existingDoc:i}){let[n,l]=(0,r.useState)(i?.name??""),s=(0,r.useRef)(null);return(0,r.useEffect)(()=>{s.current?.focus(),i&&s.current?.select()},[i]),(0,t.jsx)(O,{onClick:a,children:(0,t.jsxs)(W,{onClick:e=>e.stopPropagation(),children:[(0,t.jsx)(Y,{children:"Save document"}),i&&o&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(Z,{children:"Update the current version or save as a new one."}),(0,t.jsxs)(U,{children:[(0,t.jsx)(_,{onClick:a,children:"Cancel"}),(0,t.jsxs)(_,{danger:!0,onClick:o,children:['Update "',i.name,'"']})]}),(0,t.jsx)(J,{})]}),(0,t.jsx)(q,{ref:s,value:n,onChange:e=>l(e.target.value),onKeyDown:t=>{"Enter"===t.key&&n.trim()&&(i&&n.trim()===i.name&&o?o():e(n.trim())),"Escape"===t.key&&a()},placeholder:i?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,t.jsxs)(U,{children:[!i&&(0,t.jsx)(_,{onClick:a,children:"Cancel"}),(0,t.jsx)(_,{primary:!0,disabled:!n.trim(),onClick:()=>e(n.trim()),children:"Save as new"})]})]})})}let Q=(0,w.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,ee=(0,w.keyframes)`
