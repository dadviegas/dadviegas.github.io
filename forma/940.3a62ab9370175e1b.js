...
`,M=n().span`
  ...
  font-variant-numeric: tabular-nums;
  color: ${l.w4.colors.mainText};
`;function z({t:e}){var t;let{output:a,refresh:i}=(0,c.useCoach)(),{data:n}=(0,c.useForma)(),[s,g]=(0,o.useState)(!1),T=n?(0,c.sleepBeforeFastAvg)(n):null,F=(0,o.useCallback)(async()=>{g(!0);try{await i()}finally{g(!1)}},[i]),S=()=>{F()};if(!a)return(0,r.jsxs)(h,{accent:p.Js,children:[(0,r.jsx)(f,{children:(0,r.jsx)(x,{children:e("forma.coach.title")})}),(0,r.jsxs)(y,{children:[(0,r.jsx)(d.In,{name:"message",size:24,color:l.w4.colors.mainTextMuted}),(0,r.jsx)($,{children:e("forma.coach.empty")}),(0,r.jsx)(d.$n,{variant:"accent",onClick:S,disabled:s,children:e("forma.coach.generate")})]}),(0,r.jsx)(m.I,{variant:"compact"})]});let C=(t=a.messageKey,/lowAdherence|hunger/.test(t)?"#f87171":/stall|lowEnergy/.test(t)?"#facc15":p.Js);return(0,r.jsxs)(h,{accent:C,children:[(0,r.jsx)(f,{children:(0,r.jsx)(x,{children:e("forma.coach.title")})}),(0,r.jsx)(u,{children:e(a.messageKey,a.vars)}),a.adjustments.length>0&&(0,r.jsx)(w,{children:a.adjustments.map((t,a)=>(0,r.jsx)(b,{accent:C,children:e(t.reasonKey)},a))}),null!==T&&(0,r.jsxs)(k,{children:[(0,r.jsx)(j,{children:e("forma.sleep.fastCorrelation.label")}),(0,r.jsxs)(M,{children:[T.toFixed(1),e("forma.sleep.h")]})]}),(0,r.jsx)(v,{children:(0,r.jsxs)(d.$n,{variant:"ghost",onClick:S,disabled:s,children:[(0,r.jsx)(d.In,{name:"rotate-cw",size:13}),e("forma.coach.refresh")]})}),(0,r.jsx)(m.I,{variant:"compact"})]})}},78531(e,t,a){a.d(t,{F:()=>$});var r=a(65723),o=a(37991),i=a(36859),n=a.n(i),s=a(72799),l=a(6063),d=a(25004),c=a(21571);let p=(0,s.keyframes)`
