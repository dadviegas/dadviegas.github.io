"use strict";(self.webpackChunk_atlantis_playground=self.webpackChunk_atlantis_playground||[]).push([[6036],{6036(e,t,r){r.r(t),r.d(t,{default:()=>X});var s=r(7359),o=r(3233),n=r(7207),a=r(4901),i=r(3857),l=r(7071),c=r(5496),d=r(1530),p=r(3482),u=r(679),f=r(5426),h=r(9881),m=r(6135),x=r(9421),g=r(6480),b=r(9336),w=r(7293),y=r(5723);const $=n.keyframes`from{transform:rotate(0deg)}to{transform:rotate(360deg)}`,j=(0,o.default)(l.A)`animation: ${$} 1s linear infinite;`,k=o.default.div`
  display: flex;
  align-items: center;
  gap: ${a.w4.spacing.sm};
