"use strict";(self.webpackChunk_atlantis_techscope=self.webpackChunk_atlantis_techscope||[]).push([["467"],{5748(e,o,r){r.d(o,{W:()=>oY});var t=r(5723),a=r(9874),i=r(7991),n=r.n(i),s=r(6859),l=r.n(s),d=r(8395),p=r(6455),c=r(9522),g=r(2799),x=r(8170);let f=(0,g.keyframes)`
  0%, 100% { opacity: 1; }
  50% { opacity: 0.3; }
`,h=(0,g.keyframes)`
...
`,Z=l().span`
  ...
  height: 10px;
  border-radius: 50%;
  background: ${({lang:e})=>V[e]??a.w4.colors.mainTextMuted};
  flex-shrink: 0;
`,G=l().span`
  font-size: ${a.w4.typography.fontSizeSm};
  color: ${a.w4.colors.mainTextMuted};
