"use strict";(self.webpackChunk_atlantis_markdown=self.webpackChunk_atlantis_markdown||[]).push([[6102],{16710(e,o,a){a.d(o,{WO:()=>fo});var n=a(27359),t=a(217),i=a(53233),r=a(65723);i.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`;function Re({type:e,children:o}){const a=Be[e]??Be.NOTE,n=a.icon;return(0,r.jsxs)(Ce,{bg:a.bg,border:a.border,children:[(0,r.jsxs)(Ee,{color:a.color,children:[(0,r.jsx)(n,{size:15,strokeWidth:2}),a.label]}),(0,r.jsx)(Pe,{children:o})]})}const Le=i.default.nav`
  width: 220px;
  min-width: 220px;
...
`;function go({title:e,sub:o}){return(0,r.jsxs)(to,{children:[(0,r.jsx)(ro,{}),(0,r.jsx)(io,{size:500,x:10,y:-10,hue:210,dur:7}),(0,r.jsx)(io,{size:400,x:60,y:50,hue:270,dur:9}),(0,r.jsx)(io,{size:300,x:30,y:70,hue:190,dur:6}),(0,r.jsxs)(lo,{children:[(0,r.jsx)(so,{children:e}),(0,r.jsx)(co,{children:o}),(0,r.jsxs)(mo,{children:[(0,r.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round",children:(0,r.jsx)("polyline",{points:"15 18 9 12 15 6"})}),"Browse the sidebar"]})]})]})}function uo(e,o,a){return"string"==typeof e?e:e[o]??e[a]??Object.values(e)[0]??""}function fo({navigation:e,languages:o,defaultLang:a,hashPrefix:t,topBarRight:i,welcomeTitle:l="Blog",welcomeSub:s="Notes, guides, and references — pick a topic from the sidebar to get started."}){const c=o?Object.keys(o):[],d=c.length>1,[m,g]=(0,n.useState)(()=>a??c[0]??""),u=(0,n.useMemo)(()=>o&&m?o[m].navigation:e??{entries:[]},[o,e,m]),f=((0,n.useMemo)(()=>no(u.entries),[u]),(0,n.useCallback)(e=>{const o=e.match(new RegExp(`^#\\/${t}\\/(.+)$`));if(o)return ao(u.entries,o[1])},[u,t])),[p,y]=(0,n.useState)(()=>f(window.location.hash)??null);(0,n.useEffect)(()=>{y(null)},[m]),(0,n.useEffect)(()=>{const e=()=>{const e=f(window.location.hash);e&&y(e)};return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[f]);const b=(0,n.useCallback)(e=>{e.file&&(y(e),window.location.hash=`#/${t}/${e.id}`)},[t]),h=(0,n.useMemo)(()=>no(u.entries),[u]),x=h.findIndex(e=>e.id===p?.id),z=x>0?h[x-1]:null,w=x<h.length-1?h[x+1]:null,$=p?.label??p?.name??t,A=uo(l,m,a??c[0]??""),k=uo(s,m,a??c[0]??""),j=d&&o?(0,r.jsx)(oo,{languages:Object.fromEntries(c.map(e=>[e,{label:o[e].label}])),activeLang:m,onChange:g}):null;return(0,r.jsx)(v,{title:$,activeId:p?.id??null,topBarRight:(0,r.jsxs)(r.Fragment,{children:[j,i]}),sidebar:(0,r.jsx)(ne,{config:u,activeId:p?.id??null,onSelect:b,hashPrefix:t}),children:p?.file?(0,r.jsx)(qe,{file:p.file,prevEntry:z,nextEntry:w,onNavigate:b}):(0,r.jsx)(go,{title:A,sub:k})})}},74914(e,o,a){a.d(o,{FlyoutPanel:()=>b});var n=a(27359),t=a(53233),i=a(77207),r=a(20255),l=a(217),s=a(15959),c=a(65185),d=a(65723);const m=i.keyframes`
