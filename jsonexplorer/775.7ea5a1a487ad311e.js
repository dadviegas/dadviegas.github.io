...
`,eA=l().main`
  ...
  display: flex;
  flex-direction: column;
`,eT=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function ej(){return(0,t.jsx)(eb,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:eT.map((e,o)=>(0,t.jsx)(ey,{index:o,accent:e.accent,children:e.char},o))})}let eS="atlantis:sidebar-collapsed";function eF({sidebar:e,children:o,topBarRight:n,title:l="Atlantis",activeId:s=null}){let[d,c]=(0,r.useState)(()=>{try{return"true"===localStorage.getItem(eS)}catch{return!1}}),[p,g]=(0,r.useState)(null),m=(0,r.useRef)(),h=()=>c(e=>{let o=!e;try{localStorage.setItem(eS,String(o))}catch{}return o}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(a.bind(a,5816)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,t.jsx)(K.I.Provider,{value:{collapsed:d,toggle:h,flyout:p,openFlyout:(e,o,a)=>{clearTimeout(m.current),g({entry:e,anchorY:o,onSelect:a})},scheduleFlyoutClose:()=>{m.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(m.current)},children:(0,t.jsxs)(ez,{children:[(0,t.jsxs)(eh,{children:[e&&(0,t.jsx)(ef,{children:(0,t.jsx)(ex,{onClick:h,title:d?"Expand sidebar":"Collapse sidebar",children:(0,t.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("path",{d:"M9 3v18"})]})})}),(0,t.jsx)(ej,{}),l&&(0,t.jsx)(ew,{children:l}),n&&(0,t.jsx)(e$,{children:n})]}),(0,t.jsxs)(ev,{children:[null!=e&&(0,t.jsx)(eM,{collapsed:d,children:(0,t.jsx)(ek,{children:e})}),(0,t.jsx)(eA,{children:o})]}),p&&(0,t.jsx)(i().Suspense,{fallback:null,children:(0,t.jsx)(f,{activeId:s})})]})})}l().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
