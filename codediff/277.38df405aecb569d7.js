...
`,V.A,V.A['pre[class*="language-"]'],d.w4.colors.codeBg,V.A['code[class*="language-"]'],l().div`
  background: ${({bg:e})=>e};
...
`,eA=l().main`
  ...
  display: flex;
  flex-direction: column;
`,eT=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function eS(){return(0,t.jsx)(eb,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:eT.map((e,o)=>(0,t.jsx)(ey,{index:o,accent:e.accent,children:e.char},o))})}let ej="atlantis:sidebar-collapsed";function eF({sidebar:e,children:o,topBarRight:n,title:l="Atlantis",activeId:d=null}){let[s,c]=(0,r.useState)(()=>{try{return"true"===localStorage.getItem(ej)}catch{return!1}}),[p,g]=(0,r.useState)(null),h=(0,r.useRef)(),m=()=>c(e=>{let o=!e;try{localStorage.setItem(ej,String(o))}catch{}return o}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(a.bind(a,5816)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,t.jsx)(D.I.Provider,{value:{collapsed:s,toggle:m,flyout:p,openFlyout:(e,o,a)=>{clearTimeout(h.current),g({entry:e,anchorY:o,onSelect:a})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,t.jsxs)(ez,{children:[(0,t.jsxs)(em,{children:[e&&(0,t.jsx)(ef,{children:(0,t.jsx)(ex,{onClick:m,title:s?"Expand sidebar":"Collapse sidebar",children:(0,t.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("path",{d:"M9 3v18"})]})})}),(0,t.jsx)(eS,{}),l&&(0,t.jsx)(ew,{children:l}),n&&(0,t.jsx)(e$,{children:n})]}),(0,t.jsxs)(ev,{children:[null!=e&&(0,t.jsx)(eM,{collapsed:s,children:(0,t.jsx)(ek,{children:e})}),(0,t.jsx)(eA,{children:o})]}),p&&(0,t.jsx)(i().Suspense,{fallback:null,children:(0,t.jsx)(f,{activeId:d})})]})})}l().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
