...
`},2787(o,e,a){a.d(e,{FlyoutPanel:()=>y});var t=a(5723),r=a(7991),i=a.n(r),n=a(6859),l=a.n(n),s=a(2799),d=a(6063),c=a(7993),p=a(4971);let g=(0,s.keyframes)`
...
`;let B=l().div`
  ...
  align-items: center;
  gap: 8px;
`;function F({children:o,...e}){return(0,t.jsx)(B,{...e,children:o})}let H=l().label`
  display: flex;
  align-items: center;
  gap: 10px;
...
`,C=l().span`
  ...
  color: ${s.w4.colors.mainTextMuted};
  flex-shrink: 0;
`,R=i().forwardRef(function({before:o,after:e,...a},r){return(0,t.jsxs)(H,{children:[o&&(0,t.jsx)(C,{children:o}),(0,t.jsx)(L,{ref:r,...a}),e&&(0,t.jsx)(C,{children:e})]})});l().div`
  position: relative;
  display: flex;
  flex-direction: column;
  height: 100%;
...
`,Y.A,Y.A['pre[class*="language-"]'],s.w4.colors.codeBg,Y.A['code[class*="language-"]'],l().div`
  background: ${({bg:o})=>o};
...
`,l().aside`
  ...
  display: flex;
  flex-direction: column;
  animation: ${K} 0.22s cubic-bezier(0.4, 0, 0.2, 1) both;
...
`,l().div`
  position: relative;
`;let oo="260px",oe="56px",oa="48px",ot=l().header`
  display: flex;
  align-items: center;
  height: calc(${oa} + env(safe-area-inset-top, 0px));
  ...
  @media (max-width: ${s.w4.breakpoints.md}) {
    flex-wrap: wrap;
    height: auto;
    min-height: calc(${oa} + env(safe-area-inset-top, 0px));
  }
`,or=l().div`
  width: ${oe};
  min-width: ${oe};
...
`,os=l().span`
  ...
  animation: ${on} 10s ease ${({index:o})=>.07*o}s infinite;
...
`,og=l().div`
  ...
  overflow: hidden;
`,om=l().aside`
  width: ${({collapsed:o})=>o?oe:oo};
  min-width: ${({collapsed:o})=>o?oe:oo};
  background: ${s.w4.colors.sidebarBg};
  border-right: 1px solid ${s.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,of=l().main`
  ...
  display: flex;
  flex-direction: column;
`,ox=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function ou(){return(0,t.jsx)(ol,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:ox.map((o,e)=>(0,t.jsx)(os,{index:e,accent:o.accent,children:o.char},e))})}let ob="atlantis:sidebar-collapsed";function oy({sidebar:o,children:e,topBarRight:n,title:l="Atlantis",activeId:s=null}){let[d,c]=(0,r.useState)(()=>{try{return"true"===localStorage.getItem(ob)}catch{return!1}}),[p,g]=(0,r.useState)(null),m=(0,r.useRef)(),h=()=>c(o=>{let e=!o;try{localStorage.setItem(ob,String(e))}catch{}return e}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(a.bind(a,2787)).then(o=>({default:o.FlyoutPanel}))),[]);return(0,t.jsx)(_.I.Provider,{value:{collapsed:d,toggle:h,flyout:p,openFlyout:(o,e,a)=>{clearTimeout(m.current),g({entry:o,anchorY:e,onSelect:a})},scheduleFlyoutClose:()=>{m.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(m.current)},children:(0,t.jsxs)(og,{children:[(0,t.jsxs)(ot,{children:[o&&(0,t.jsx)(or,{children:(0,t.jsx)(oi,{onClick:h,title:d?"Expand sidebar":"Collapse sidebar",children:(0,t.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("path",{d:"M9 3v18"})]})})}),(0,t.jsx)(ou,{}),l&&(0,t.jsx)(od,{children:l}),n&&(0,t.jsx)(oc,{children:n})]}),(0,t.jsxs)(op,{children:[null!=o&&(0,t.jsx)(om,{collapsed:d,children:(0,t.jsx)(oh,{children:o})}),(0,t.jsx)(of,{children:e})]}),p&&(0,t.jsx)(i().Suspense,{fallback:null,children:(0,t.jsx)(f,{activeId:s})})]})})}var ow=a(4971);let o$=l().div`
  display: grid;
  grid-template-rows: ${({open:o})=>o?"1fr":"0fr"};
...
`;function oB({iconKey:o,size:e=16}){let a=o?ow.X[o]:void 0;return a?(0,t.jsx)("svg",{width:e,height:e,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,dangerouslySetInnerHTML:{__html:a}}):o?(0,t.jsx)("span",{style:{fontSize:e,lineHeight:1,display:"flex",alignItems:"center"},children:o}):(0,t.jsxs)("svg",{width:e,height:e,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,children:[(0,t.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,t.jsx)("polyline",{points:"14 2 14 8 20 8"})]})}function oF({entry:o,activeId:e,onSelect:a}){let[i,n]=(0,r.useState)(o.defaultOpen??!0),{collapsed:l,openFlyout:s,scheduleFlyoutClose:d,cancelFlyoutClose:c}=(0,_.c)();return o.children&&o.children.length>0?(0,t.jsxs)(oM,{children:[(0,t.jsxs)(ok,{collapsed:l,onClick:()=>{l||n(o=>!o)},onMouseEnter:l?e=>{s(o,e.currentTarget.getBoundingClientRect().top,a)}:void 0,onMouseLeave:l?d:void 0,children:[(0,t.jsxs)(oA,{collapsed:l,children:[(0,t.jsx)(oB,{iconKey:o.icon,size:16}),(0,t.jsx)(oT,{collapsed:l,children:o.name})]}),(0,t.jsx)(oS,{open:i,collapsed:l,children:(0,t.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round",children:(0,t.jsx)("path",{d:"M9 6l6 6-6 6"})})})]}),(0,t.jsx)(o$,{open:i&&!l,children:(0,t.jsx)(ov,{children:(0,t.jsx)(oz,{children:o.children.map(o=>(0,t.jsx)(oF,{entry:o,activeId:e,onSelect:a},o.id))})})})]}):(0,t.jsxs)(oj,{active:e===o.id,collapsed:l,onClick:()=>a(o),onMouseEnter:l?e=>{let t=e.currentTarget.getBoundingClientRect();s({id:o.id,name:o.name,icon:o.icon,file:o.file,children:[o]},t.top,a)}:void 0,onMouseLeave:l?d:void 0,children:[(0,t.jsx)(oB,{iconKey:o.icon,size:15}),(0,t.jsx)(oT,{collapsed:l,children:o.name})]})}function oH({entries:o,activeId:e,onSelect:a}){return(0,t.jsx)("div",{children:o.map(o=>(0,t.jsx)(oF,{entry:o,activeId:e,onSelect:a},o.id))})}a(2787),l().div`
