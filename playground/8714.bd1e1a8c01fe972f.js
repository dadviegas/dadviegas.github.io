...
ReactDOM.createRoot(document.getElementById('root')!).render(<App />);`}]},7330(o,e,t){t.d(e,{FlyoutPanel:()=>oR});var a=t(5723),r=t(7991),n=t.n(r),i=t(6859),l=t.n(i),s=t(2799),d=t(255),c=t(1316),p=t(814),g=t(6896),m=t(7902),f=t(3013),u=t(2887),x=t(9510),b=t(9848),h=t(7901),y=t(3045),w=t(3775),$=t(1783),v=t(3539),z=t(9416),k=t(1837),M=t(7167),A=t(4494),T=t(2314),S=t(5751),j=t(9633),F=t(2946),B=t(822),C=t(6720),R=t(7400),E=t(8456),P=t(3317),L=t(2709),H=t(8006),D=t(9301),I=t(7561),N=t(3517),K=t(8207),Y=t(7032),V=t(6949),G=t(8218),_=t(6829),O=t(9591),W=t(5553),J=t(9923),U=t(2820),Z=t(4621),q=t(8479),X=t(2534),Q=t(6673),oo=t(7490),oe=t(9033),ot=t(9038),oa=t(5775),or=t(1365),on=t(2937),oi=t(9821),ol=t(5912),os=t(158),od=t(8641),oc=t(8607),op=t(3249),og=t(1821),om=t(5889),of=t(9655),ou=t(7170),ox=t(9161),ob=t(1849),oh=t(1604),oy=t(3142),ow=t(1187),o$=t(7747),ov=t(2932),oz=t(4525),ok=t(7230),oM=t(2164);let oA={activity:g.A,"a-large-small":m.A,apple:f.A,"arrow-right":u.A,"bar-chart-2":x.A,book:b.A,"book-open":h.A,briefcase:y.A,calendar:w.A,clock:$.A,"circle-dot":v.A,cloud:z.A,compass:k.A,cpu:M.A,droplets:A.A,feather:T.A,file:d.A,"file-text":S.A,folder:j.A,"git-branch":F.A,github:B.A,globe:C.A,grid:R.A,hand:E.A,hash:P.A,heart:L.A,key:H.A,hexagon:D.A,home:I.A,landmark:N.A,layers:K.A,"layout-grid":Y.A,leaf:V.A,lightbulb:G.A,list:_.A,map:O.A,"map-pin":W.A,"message-circle":J.A,"message-square":U.A,minus:Z.A,monitor:q.A,mountain:X.A,package:Q.A,palette:oo.A,"pen-tool":oe.A,"pie-chart":ot.A,plane:oa.A,plus:or.A,ruler:on.A,shirt:oi.A,slash:ol.A,square:os.A,star:od.A,sun:oc.A,terminal:op.A,thermometer:og.A,triangle:om.A,trophy:of.A,truck:ou.A,type:ox.A,users:ob.A,"volume-2":oh.A,watch:oy.A,waves:ow.A,wind:o$.A,wrench:ov.A,x:oz.A,zap:ok.A,bot:oM.A},oT=(0,s.keyframes)`
...
`,s().div`
  position: relative;
`;var d=t(2799),c=t(3661),p=t(814);let g="260px",m="56px",f=s().header`
  display: flex;
  align-items: center;
...
`,A=s().main`
  ...
  display: flex;
  flex-direction: column;
`,T=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function S(){return(0,r.jsx)(h,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:T.map((o,e)=>(0,r.jsx)(y,{index:e,accent:o.accent,children:o.char},e))})}let j="atlantis:sidebar-collapsed";function F({sidebar:o,children:e,topBarRight:a,title:l="Atlantis",activeId:s=null}){let[d,g]=(0,n.useState)(()=>{try{return"true"===localStorage.getItem(j)}catch{return!1}}),[m,b]=(0,n.useState)(null),h=(0,n.useRef)(),y=()=>g(o=>{let e=!o;try{localStorage.setItem(j,String(e))}catch{}return e}),T=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(t.bind(t,7330)).then(o=>({default:o.FlyoutPanel}))),[]);return(0,r.jsx)(p.I.Provider,{value:{collapsed:d,toggle:y,flyout:m,openFlyout:(o,e,t)=>{clearTimeout(h.current),b({entry:o,anchorY:e,onSelect:t})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>b(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,r.jsxs)(z,{children:[(0,r.jsxs)(f,{children:[o&&(0,r.jsx)(u,{children:(0,r.jsx)(x,{onClick:y,title:d?"Expand sidebar":"Collapse sidebar",children:(0,r.jsx)(c.A,{size:17})})}),(0,r.jsx)(S,{}),l&&(0,r.jsx)(w,{children:l}),a&&(0,r.jsx)($,{children:a})]}),(0,r.jsxs)(v,{children:[null!=o&&(0,r.jsx)(k,{collapsed:d,children:(0,r.jsx)(M,{children:o})}),(0,r.jsx)(A,{children:e})]}),m&&(0,r.jsx)(i().Suspense,{fallback:null,children:(0,r.jsx)(T,{activeId:s})})]})})}s().div`
  display: grid;
...
`,W=s().div`
  ...
  color: ${a.w4.colors.sidebarTextMuted};
  font-family: ${a.w4.typography.fontFamily};
`;function J({onSave:o,onUpdate:e,onCancel:t,existingDoc:a}){let[i,l]=(0,n.useState)(a?.name??""),s=(0,n.useRef)(null);return(0,n.useEffect)(()=>{s.current?.focus(),a&&s.current?.select()},[a]),(0,r.jsx)(N,{onClick:t,children:(0,r.jsxs)(K,{onClick:o=>o.stopPropagation(),children:[(0,r.jsx)(Y,{children:"Save document"}),a&&e&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(W,{children:"Update the current version or save as a new one."}),(0,r.jsxs)(G,{children:[(0,r.jsx)(_,{onClick:t,children:"Cancel"}),(0,r.jsxs)(_,{danger:!0,onClick:e,children:['Update "',a.name,'"']})]}),(0,r.jsx)(O,{})]}),(0,r.jsx)(V,{ref:s,value:i,onChange:o=>l(o.target.value),onKeyDown:r=>{"Enter"===r.key&&i.trim()&&(a&&i.trim()===a.name&&e?e():o(i.trim())),"Escape"===r.key&&t()},placeholder:a?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,r.jsxs)(G,{children:[!a&&(0,r.jsx)(_,{onClick:t,children:"Cancel"}),(0,r.jsx)(_,{primary:!0,disabled:!i.trim(),onClick:()=>o(i.trim()),children:"Save as new"})]})]})})}var U=t(5625),Z=t(679),q=t(4872);let X=s().div`
  position: relative;
`,Q=s().button`
  display: flex;
  align-items: center;
...
`;function od({appId:o,onLoad:e}){let[t,a]=(0,n.useState)(!1),[i,l]=(0,n.useState)([]),s=(0,n.useRef)(null),d=(0,n.useCallback)(()=>{P.listDocs(o).then(l).catch(()=>{})},[o]);(0,n.useEffect)(()=>{if(!t)return;d();let o=o=>{s.current&&!s.current.contains(o.target)&&a(!1)};return document.addEventListener("mousedown",o),()=>document.removeEventListener("mousedown",o)},[t,d]);let c=async(o,e)=>{o.stopPropagation(),await P.deleteDoc(e),l(o=>o.filter(o=>o.id!==e))};return(0,r.jsxs)(X,{ref:s,children:[(0,r.jsxs)(Q,{onClick:()=>a(o=>!o),children:[(0,r.jsx)(U.A,{size:14}),"Saved",(0,r.jsx)(Z.A,{size:13,style:{marginLeft:2}})]}),(0,r.jsxs)(oo,{open:t,children:[(0,r.jsx)(oe,{children:"Saved versions"}),(0,r.jsx)(ot,{children:0===i.length?(0,r.jsx)(oa,{children:"No saved documents yet."}):i.map(o=>{var t;return(0,r.jsxs)(or,{children:[(0,r.jsxs)(on,{onClick:()=>{e(o.content,o.id,o.name),a(!1)},children:[(0,r.jsx)(oi,{children:o.name}),(0,r.jsx)(ol,{children:(t=o.savedAt,new Intl.DateTimeFormat(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}).format(new Date(t)))})]}),(0,r.jsx)(os,{onClick:e=>c(e,o.id),title:"Delete",children:(0,r.jsx)(q.A,{size:13})})]},o.id)})})]})]})}s().div`
...
`,h=n().forwardRef(function({variant:o="ghost",size:e="md",icon:t,iconRight:r,children:n,...i},l){return(0,a.jsxs)(b,{ref:l,variant:o,size:e,...i,children:[t,n,r]})}),y={default:s.w4.colors.accent,danger:"#f85149"},w={default:s.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"},$=l().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`;var S=t(2799);let j=(0,S.keyframes)`
