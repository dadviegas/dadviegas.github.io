...
`,V=s().div`
  ...
  color: ${t.w4.colors.sidebarTextMuted};
  font-family: ${t.w4.typography.fontFamily};
`;function I({onSave:o,onUpdate:e,onCancel:a,existingDoc:t}){let[i,l]=(0,n.useState)(t?.name??""),s=(0,n.useRef)(null);return(0,n.useEffect)(()=>{s.current?.focus(),t&&s.current?.select()},[t]),(0,r.jsx)(E,{onClick:a,children:(0,r.jsxs)(H,{onClick:o=>o.stopPropagation(),children:[(0,r.jsx)(P,{children:"Save document"}),t&&e&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(V,{children:"Update the current version or save as a new one."}),(0,r.jsxs)(D,{children:[(0,r.jsx)(N,{onClick:a,children:"Cancel"}),(0,r.jsxs)(N,{danger:!0,onClick:e,children:['Update "',t.name,'"']})]}),(0,r.jsx)(K,{})]}),(0,r.jsx)(L,{ref:s,value:i,onChange:o=>l(o.target.value),onKeyDown:r=>{"Enter"===r.key&&i.trim()&&(t&&i.trim()===t.name&&e?e():o(i.trim())),"Escape"===r.key&&a()},placeholder:t?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,r.jsxs)(D,{children:[!t&&(0,r.jsx)(N,{onClick:a,children:"Cancel"}),(0,r.jsx)(N,{primary:!0,disabled:!i.trim(),onClick:()=>o(i.trim()),children:"Save as new"})]})]})})}let Y=(0,d.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,G=(0,d.keyframes)`
...
`;var _=a(5625),O=a(679),J=a(4872);let W=s().div`
  position: relative;
`,U=s().button`
  display: flex;
  align-items: center;
...
`;function on({appId:o,onLoad:e}){let[a,t]=(0,n.useState)(!1),[i,l]=(0,n.useState)([]),s=(0,n.useRef)(null),d=(0,n.useCallback)(()=>{(0,C.listDocs)(o).then(l).catch(()=>{})},[o]);(0,n.useEffect)(()=>{if(!a)return;d();let o=o=>{s.current&&!s.current.contains(o.target)&&t(!1)};return document.addEventListener("mousedown",o),()=>document.removeEventListener("mousedown",o)},[a,d]);let c=async(o,e)=>{o.stopPropagation(),await (0,C.deleteDoc)(e),l(o=>o.filter(o=>o.id!==e))};return(0,r.jsxs)(W,{ref:s,children:[(0,r.jsxs)(U,{onClick:()=>t(o=>!o),children:[(0,r.jsx)(_.A,{size:14}),"Saved",(0,r.jsx)(O.A,{size:13,style:{marginLeft:2}})]}),(0,r.jsxs)(Z,{open:a,children:[(0,r.jsx)(X,{children:"Saved versions"}),(0,r.jsx)(q,{children:0===i.length?(0,r.jsx)(Q,{children:"No saved documents yet."}):i.map(o=>{var a;return(0,r.jsxs)(oo,{children:[(0,r.jsxs)(oe,{onClick:()=>{e(o.content,o.id,o.name),t(!1)},children:[(0,r.jsx)(oa,{children:o.name}),(0,r.jsx)(ot,{children:(a=o.savedAt,new Intl.DateTimeFormat(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}).format(new Date(a)))})]}),(0,r.jsx)(or,{onClick:e=>c(e,o.id),title:"Delete",children:(0,r.jsx)(J.A,{size:13})})]},o.id)})})]})]})}s().div`
