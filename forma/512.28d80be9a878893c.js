"use strict";(self.webpackChunk_atlantis_forma=self.webpackChunk_atlantis_forma||[]).push([["512"],{90429(e,t,a){a.d(t,{N:()=>S});var o=a(65723),r=a(37991),i=a(36859),n=a.n(i),s=a(72799),l=a(6063),d=a(63236),c=a(69454);let p="#7fb77e",h={month:30,"3m":90,"6m":183,year:365,all:null},m=(0,s.keyframes)`
...
`,j={fast:p,meal:"#58a6ff",weight:"#d29922",walk:"#a371f7"},z={fast:"flame",meal:"utensils",weight:"gauge",walk:"activity"};function T(e){let[t,a,o]=e.split("-").map(e=>parseInt(e,10));return new Date(t,(a??1)-1,o??1).getTime()}function S({data:e,t,locale:a,onEditFast:i,onEditMeal:n,onDuplicateMeal:s,onEditWeight:l,onDeleteFast:p,onDeleteMeal:m,onDeleteWeight:F,onDeleteWalk:C}){let[A,D]=(0,r.useState)("all"),[L,R]=(0,r.useState)("month"),H=(0,r.useMemo)(()=>(function(e,t){let a=[];for(let o of e.sessions){let e=o.endedAt?(o.endedAt-o.startedAt)/36e5:(Date.now()-o.startedAt)/36e5;a.push({kind:"fast",ts:o.startedAt,id:o.id,editable:!0,primary:o.endedAt?`${t("forma.activities.fast.completed")} \xb7 ${e.toFixed(1)}h`:`${t("forma.activities.fast.inProgress")} \xb7 ${e.toFixed(1)}h`,meta:`${o.protocol} \xb7 ${t("forma.activities.fast.target")} ${o.targetHours}h`})}for(let o of e.meals){let e="forma.meal."+o.slot,r=[];o.proteinG&&r.push(`${o.proteinG}g ${t("forma.activities.protein")}`),o.kcal&&r.push(`${o.kcal} kcal`),a.push({kind:"meal",ts:o.createdAt??T(o.date),id:o.id,editable:!0,primary:`${t(e)}${o.notes?` \xb7 ${o.notes}`:""}`,meta:r.length>0?r.join(" \xb7 "):"—"})}for(let o of e.weights)a.push({kind:"weight",ts:T(o.date),id:o.date,editable:!0,primary:`${o.kg.toFixed(1)} kg`,meta:t("forma.activities.weight.entry")});for(let o of e.walks)a.push({kind:"walk",ts:T(o.date),id:o.date,editable:!1,primary:`${o.minutes} min`,meta:t("forma.activities.walk.entry")});return a.sort((e,t)=>t.ts-e.ts),a})(e,t),[e,t]),I=(0,r.useMemo)(()=>{let e=h[L];return null===e?0:Date.now()-864e5*e},[L]),P=(0,r.useMemo)(()=>H.filter(e=>e.ts>=I),[H,I]),B=(0,r.useMemo)(()=>"all"===A?P:P.filter(e=>e.kind===A),[P,A]),E=(0,r.useMemo)(()=>{let e={all:P.length,fast:0,meal:0,weight:0,walk:0};for(let t of P)e[t.kind]+=1;return e},[P]),W=(e,a)=>(0,o.jsxs)(d.vu,{variant:A===e?"selected":"default",dotColor:"all"===e?void 0:j[e],onClick:()=>D(e),children:[t(a)," ",E[e]>0&&`(${E[e]})`]},e);return(0,o.jsxs)(g,{children:[(0,o.jsx)(f,{children:["month","3m","6m","year","all"].map(e=>(0,o.jsx)(d.vu,{variant:L===e?"selected":"default",onClick:()=>R(e),children:t("forma.activities.range."+e)},e))}),(0,o.jsxs)(f,{children:[W("all","forma.activities.filter.all"),W("fast","forma.activities.filter.fast"),W("meal","forma.activities.filter.meal"),W("weight","forma.activities.filter.weight"),W("walk","forma.activities.filter.walk")]}),0===B.length?(0,o.jsx)(c.YG,{mode:"empty",label:t("forma.activities.empty")}):(0,o.jsx)(x,{children:B.map(r=>(0,o.jsxs)(u,{children:[(0,o.jsx)(w,{color:j[r.kind],children:(0,o.jsx)(d.In,{name:z[r.kind],size:14})}),(0,o.jsxs)(y,{children:[(0,o.jsx)(b,{children:r.primary}),(0,o.jsx)($,{children:r.meta})]}),(0,o.jsx)(v,{children:function(e,t,a){let o=new Date(e),r=o.toLocaleDateString("pt"===t?"pt-PT":"en-GB",{day:"2-digit",month:"short"});if(!a)return r;let i=o.toLocaleTimeString("pt"===t?"pt-PT":"en-GB",{hour:"2-digit",minute:"2-digit"});return`${r} ${i}`}(r.ts,a,"fast"===r.kind||"meal"===r.kind)}),(0,o.jsxs)(k,{children:["meal"===r.kind&&s&&(0,o.jsx)(M,{onClick:()=>(t=>{if("meal"!==t.kind||!s)return;let a=e.meals.find(e=>e.id===t.id);a&&s(a)})(r),title:t("forma.activities.duplicateToToday"),"aria-label":t("forma.activities.duplicateToToday"),children:(0,o.jsx)(d.In,{name:"copy",size:14})}),r.editable&&(0,o.jsx)(M,{onClick:()=>(t=>{if(t.editable){if("fast"===t.kind){let a=e.sessions.find(e=>e.id===t.id);a&&i(a)}else if("meal"===t.kind){let a=e.meals.find(e=>e.id===t.id);a&&n(a)}else if("weight"===t.kind){let a=e.weights.find(e=>e.date===t.id);a&&l(a)}}})(r),title:t("forma.activities.edit"),"aria-label":t("forma.activities.edit"),children:(0,o.jsx)(d.In,{name:"edit",size:14})}),(0,o.jsx)(M,{onClick:()=>{let e;return e="forma.activities.confirmDelete."+r.kind,void(window.confirm(t(e))&&("fast"===r.kind&&p(r.id),"meal"===r.kind&&m(r.id),"weight"===r.kind&&F(r.id),"walk"===r.kind&&C(r.id)))},title:t("forma.activities.delete"),"aria-label":t("forma.activities.delete"),children:(0,o.jsx)(d.In,{name:"trash",size:14})})]})]},`${r.kind}:${r.id}`))})]})}},84391(e,t,a){a.d(t,{v:()=>j});var o=a(65723),r=a(37991),i=a(36859),n=a.n(i),s=a(72799),l=a(6063),d=a(69454),c=a(1609);let p="#7fb77e",h="forma:timeline:range",m=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,g=n().div`
  display: flex;
...
`,M=n().div`
  ...
  font-variant-numeric: tabular-nums;
  color: ${p};
`;function j({data:e,t,locale:a}){let[i,n]=(0,r.useState)("1m"),[s,m]=(0,r.useState)(void 0),[z,T]=(0,r.useState)(!1);(0,r.useEffect)(()=>{(0,l.PL)(h).then(e=>{("1m"===e||"3m"===e||"6m"===e||"1y"===e)&&n(e),T(!0)}).catch(()=>T(!0))},[]);let S=(0,r.useCallback)(e=>{n(e),m(void 0),(0,l.Is)(h,e).catch(()=>{})},[]),F=(0,r.useMemo)(()=>(function(e,t){let a=d.zA[t],o=Array(a).fill(0),r=new Date;for(let t=0;t<a;t++){let[i,n,s]=(0,d.x)(t,a,r).split("-").map(e=>parseInt(e,10)),l=new Date(i,(n??1)-1,s??1).getTime(),c=l+864e5,p=0;for(let t of e.sessions){let e=t.startedAt,a=Math.min(t.endedAt??Date.now(),c)-Math.max(e,l);a>0&&(p+=a/36e5)}let h=0;p>=16?h=4:p>=12?h=3:p>=8?h=2:p>0&&(h=1),o[t]=h}return o})(e,i),[e,i]),C=d.zA[i],A=void 0!==s?(0,d.x)(s,C):null,D=(0,r.useMemo)(()=>A?(0,c.Af)(e,A,t,a):null,[e,A,t,a]),L=(0,r.useMemo)(()=>{let t=new Date,a=[];for(let e=0;e<C;e++)a.push((0,d.x)(e,C,t));let o=a[0]??"",r=a[a.length-1]??"",i=0;for(let t of e.sessions){let e=t.startedAt,a=t.endedAt??Date.now(),n=new Date(o).getTime(),s=Math.min(a,new Date(r).getTime()+864e5)-Math.max(e,n);s>0&&(i+=s/36e5)}let n={};for(let t of e.meals)t.date>=o&&t.date<=r&&(n[t.date]=(n[t.date]??0)+(t.proteinG??0));let s=Object.keys(n).length,l=Object.values(n).reduce((e,t)=>e+t,0),c=e.weights.filter(e=>e.date>=o&&e.date<=r).sort((e,t)=>e.date.localeCompare(t.date));return{totalFastHours:i,avgProtein:s>0?l/s:0,weightDelta:c.length>=2?(c[c.length-1]?.kg??0)-(c[0]?.kg??0):null,totalWalkMins:e.walks.filter(e=>e.date>=o&&e.date<=r).reduce((e,t)=>e+t.minutes,0)}},[e,i,C]),R=(0,r.useMemo)(()=>({"1m":t("forma.timeline.range.1m"),"3m":t("forma.timeline.range.3m"),"6m":t("forma.timeline.range.6m"),"1y":t("forma.timeline.range.1y")}),[t]),H=(0,r.useCallback)((o,r)=>{if(0===r)return;let i=(0,d.x)(o,C);return(0,c.Af)(e,i,t,a)},[e,C,t,a]);return z?(0,o.jsxs)(g,{children:[(0,o.jsxs)(f,{children:[(0,o.jsx)(x,{children:t("forma.timeline.title")}),(0,o.jsx)(d.zy,{range:i,onChange:S,labels:R})]}),(0,o.jsx)(u,{children:(0,o.jsx)(d.RT,{data:F,locale:a,showMonthLabels:!0,accent:p,selectedIndex:s,onCellClick:e=>m(t=>t===e?void 0:e),tooltip:H})}),null!==D&&(0,o.jsxs)(w,{children:[(0,o.jsx)(y,{children:t("forma.timeline.selectedDay.title")}),(0,o.jsx)(b,{children:D})]}),(0,o.jsxs)($,{children:[(0,o.jsxs)(v,{children:[(0,o.jsx)(k,{children:t("forma.timeline.kpi.fastHours")}),(0,o.jsxs)(M,{children:[L.totalFastHours.toFixed(0),"h"]})]}),(0,o.jsxs)(v,{children:[(0,o.jsx)(k,{children:t("forma.timeline.kpi.avgProtein")}),(0,o.jsxs)(M,{children:[L.avgProtein.toFixed(0),"g"]})]}),(0,o.jsxs)(v,{children:[(0,o.jsx)(k,{children:t("forma.timeline.kpi.weightDelta")}),(0,o.jsx)(M,{children:null!==L.weightDelta?`${L.weightDelta>=0?"+":""}${L.weightDelta.toFixed(1)} kg`:"—"})]}),(0,o.jsxs)(v,{children:[(0,o.jsx)(k,{children:t("forma.timeline.kpi.walks")}),(0,o.jsxs)(M,{children:[L.totalWalkMins," min"]})]})]})]}):(0,o.jsx)(g,{})}},84964(e,t,a){a.d(t,{Q:()=>e4});var o=a(65723),r=a(37991),i=a(36859),n=a.n(i),s=a(72799),l=a(6063),d=a(26506),c=a(69454),p=a(4406),h=a(1609);let m="#7fb77e";function g(e){return[parseInt(e.slice(1,3),16),parseInt(e.slice(3,5),16),parseInt(e.slice(5,7),16)]}let f=g("#1d2230"),x=g(m);function u(e){let t=Math.round(f[0]+(x[0]-f[0])*e),a=Math.round(f[1]+(x[1]-f[1])*e),o=Math.round(f[2]+(x[2]-f[2])*e);return`rgb(${t},${a},${o})`}let w=new Set([0,4,8,12,16,20]),y=["Mo","Tu","We","Th","Fr","Sa","Su"],b=["Se","Te","Qa","Qi","Sx","S\xe1","Do"],$=n().section`
  background: ${l.w4.colors.surface};
  border: 1px solid ${l.w4.colors.border};
...
`,H=n().div`
  ...
  color: ${l.w4.colors.mainTextMuted};
  margin-top: 2px;
`;function I({data:e,t,locale:a}){let[i,n]=(0,r.useState)(null),s=(0,r.useMemo)(()=>(0,d.mealDayHourMatrix)(e.meals),[e.meals]),l=(0,r.useMemo)(()=>(0,d.mealKcalByHour)(e.meals),[e.meals]),c=(0,r.useMemo)(()=>{let e=0;for(let t of s)for(let a of t)a>e&&(e=a);return e},[s]),p=(0,r.useMemo)(()=>Math.max(0,...l),[l]),m=(0,r.useMemo)(()=>l.reduce((e,t)=>e+t,0),[l]),g="pt"===a?b:y;return(0,o.jsxs)($,{children:[(0,o.jsx)(v,{children:t("forma.mealHeatmap.title")}),(0,o.jsxs)(k,{children:[(0,o.jsxs)(M,{children:[(0,o.jsx)(z,{}),Array.from({length:24},(e,t)=>(0,o.jsx)(j,{children:w.has(t)?String(t).padStart(2,"0"):""},t))]}),s.map((r,s)=>(0,o.jsxs)(T,{children:[(0,o.jsx)(S,{children:g[s]}),r.map((r,l)=>{let d=null!==i&&i.day===s&&i.hour===l;return(0,o.jsx)(F,{type:"button",bg:0===c?u(0):u(r/c),selected:d,"aria-pressed":d,onClick:()=>n(e=>e&&e.day===s&&e.hour===l?null:{day:s,hour:l}),title:(0,h.Cl)(e,s,l,t,a)},l)})]},s)),(0,o.jsxs)(D,{children:[(0,o.jsx)(z,{}),(0,o.jsx)(L,{children:l.map((e,t)=>(0,o.jsx)(R,{pct:0===p?0:e/p},t))})]}),(0,o.jsxs)(H,{children:[(0,o.jsx)("span",{children:"0"}),(0,o.jsxs)("span",{children:[Math.round(m).toLocaleString()," kcal"]})]})]}),i&&(0,o.jsxs)(C,{role:"status","aria-live":"polite",children:[(0,o.jsx)("span",{children:(0,h.Cl)(e,i.day,i.hour,t,a)}),(0,o.jsx)(A,{type:"button",onClick:()=>n(null),"aria-label":t("forma.month.summary.close"),children:"\xd7"})]})]})}var P=a(63236);let B="#7fb77e",E="#1d2230";function W(){let e=new Date;return{year:e.getFullYear(),month:e.getMonth()}}function N(e,t){let a=new Date(e.year,e.month+t,1);return{year:a.getFullYear(),month:a.getMonth()}}function O(e,t){let a=String(e.month+1).padStart(2,"0"),o=String(t).padStart(2,"0");return`${e.year}-${a}-${o}`}function Y(e){return[parseInt(e.slice(1,3),16),parseInt(e.slice(3,5),16),parseInt(e.slice(5,7),16)]}let G=Y(E),K=Y(B),V=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,q=n().section`
  display: flex;
...
`,ey=n().div`
  ...
  font-family: ${l.w4.typography.fontFamilyMono};
  color: ${l.w4.colors.mainTextMuted};
`;function eb({data:e,t,locale:a}){let[i,n]=(0,r.useState)(()=>W()),[s,l]=(0,r.useState)(null),d=(0,r.useCallback)(()=>n(e=>N(e,-1)),[]),p=(0,r.useCallback)(()=>n(e=>N(e,1)),[]),h=(0,r.useCallback)(()=>n(W()),[]),m=(0,r.useMemo)(()=>{let e=W();return i.year===e.year&&i.month===e.month},[i]),{fastHours:g,proteinByDayMap:f,weightByDayMap:x,walkByDayMap:u,checkInDays:w}=(0,r.useMemo)(()=>{let t=function(e,t){let a={};for(let o of e.sessions){if(void 0===o.endedAt)continue;let e=o.startedAt,r=o.endedAt;for(;e<r;){let o=new Date(e);if(o.getFullYear()===t.year&&o.getMonth()===t.month){let i=new Date(o.getFullYear(),o.getMonth(),o.getDate()).getTime()+864e5,n=Math.min(r,i)-e,s=O(t,o.getDate());a[s]=(a[s]??0)+n/36e5,e=i}else e=new Date(o.getFullYear(),o.getMonth(),o.getDate()).getTime()+864e5}}return a}(e,i),a=`${i.year}-${String(i.month+1).padStart(2,"0")}-`,o={};for(let t of e.meals)t.date.startsWith(a)&&(o[t.date]=(o[t.date]??0)+(t.proteinG??0));let r={};for(let t of e.weights)t.date.startsWith(a)&&(r[t.date]=t.kg);let n={};for(let t of e.walks)t.date.startsWith(a)&&(n[t.date]=(n[t.date]??0)+t.minutes);return{fastHours:t,proteinByDayMap:o,weightByDayMap:r,walkByDayMap:n,checkInDays:new Set(e.checkIns.filter(e=>e.date.startsWith(a)).map(e=>e.date))}},[e,i]),y=new Date(i.year,i.month+1,0).getDate(),b=new Date().toISOString().slice(0,10),$=(0,r.useMemo)(()=>Object.values(g).reduce((e,t)=>e+t,0),[g]),v=e.goal.proteinG??110,k=Object.values(f),M=k.length?k.reduce((e,t)=>e+t,0)/k.length:0,j=(0,r.useMemo)(()=>{let t=Object.keys(x).sort(),a=String(i.month+1).padStart(2,"0"),o=`${i.year}-${a}-01`,r=e.weights.filter(e=>e.date<o).sort((e,t)=>e.date.localeCompare(t.date)),n=r[r.length-1]?.kg;if(0===t.length&&void 0===n)return{kind:"none"};if(0===t.length)return{kind:"absolute",value:n};let s=x[t[t.length-1]];if(void 0===s)return{kind:"none"};if(void 0!==n)return{kind:"delta",value:s-n};if(t.length>=2){let e=x[t[0]];if(void 0!==e)return{kind:"delta",value:s-e}}return{kind:"absolute",value:s}},[x,e.weights,i]),z=(0,r.useMemo)(()=>Object.values(u).reduce((e,t)=>e+t,0),[u]),T=(new Date(i.year,i.month,1).getDay()+6)%7,S=[];for(let e=0;e<T;e++)S.push({key:`lead-${e}`,day:null,iso:null});for(let e=1;e<=y;e++){let t=O(i,e);S.push({key:t,day:e,iso:t})}for(;S.length%7!=0;)S.push({key:`tail-${S.length}`,day:null,iso:null});let F=Math.max(18,...Object.values(g)),C=[];for(let e=1;e<=y;e++)C.push(f[O(i,e)]??0);for(;C.length<31;)C.push(0);let A=[];for(let e=1;e<=y;e++){let t=x[O(i,e)];void 0!==t&&A.push(t)}return(0,o.jsxs)(q,{children:[(0,o.jsxs)(_,{children:[(0,o.jsx)(J,{children:new Date(i.year,i.month,1).toLocaleDateString("pt"===a?"pt-PT":"en-US",{month:"long",year:"numeric"})}),(0,o.jsxs)(Q,{children:[(0,o.jsx)(U,{onClick:d,"aria-label":t("forma.month.prev"),children:(0,o.jsx)(P.In,{name:"chevron-left",size:16})}),(0,o.jsx)(X,{onClick:h,disabled:m,"aria-label":t("forma.month.today"),children:t("forma.month.today")}),(0,o.jsx)(U,{onClick:p,disabled:m,"aria-label":t("forma.month.next"),children:(0,o.jsx)(P.In,{name:"chevron-right",size:16})})]})]}),(0,o.jsxs)(Z,{children:[(0,o.jsxs)(ee,{children:[(0,o.jsx)(et,{children:t("forma.month.kpi.fastHours")}),(0,o.jsxs)(ea,{children:[$.toFixed(0),(0,o.jsx)(eo,{children:"h"})]})]}),(0,o.jsxs)(ee,{children:[(0,o.jsx)(et,{children:t("forma.month.kpi.avgProtein")}),(0,o.jsxs)(ea,{children:[M.toFixed(0),(0,o.jsxs)(eo,{children:["g / ",v,"g"]})]})]}),(0,o.jsxs)(ee,{children:[(0,o.jsx)(et,{children:t("delta"===j.kind?"forma.month.kpi.weightDelta":"forma.month.kpi.weight")}),(0,o.jsxs)(ea,{children:["none"===j.kind?"—":"delta"===j.kind?`${j.value>0?"+":""}${j.value.toFixed(1)}`:j.value.toFixed(1),(0,o.jsx)(eo,{children:"kg"})]})]}),(0,o.jsxs)(ee,{children:[(0,o.jsx)(et,{children:t("forma.month.kpi.walks")}),(0,o.jsxs)(ea,{children:[z,(0,o.jsx)(eo,{children:"min"})]})]})]}),(0,o.jsxs)(er,{children:[(0,o.jsxs)(ei,{children:["◉ ",t("forma.month.calendar.title")]}),(0,o.jsxs)(es,{children:[("pt"===a?["S","T","Q","Q","S","S","D"]:["M","T","W","T","F","S","S"]).map((e,t)=>(0,o.jsx)(el,{children:e},`h-${t}`)),S.map(e=>{if(null===e.day||null===e.iso)return(0,o.jsx)(ec,{},e.key);let t=g[e.iso]??0,a=Math.min(1,t/F),r=void 0!==x[e.iso],i=w.has(e.iso),n=(u[e.iso]??0)>0,d=e.iso;return(0,o.jsxs)(ed,{type:"button",bg:function(e){if(e<=0)return E;let t=Math.round(G[0]+(K[0]-G[0])*e),a=Math.round(G[1]+(K[1]-G[1])*e),o=Math.round(G[2]+(K[2]-G[2])*e);return`rgb(${t},${a},${o})`}(a),today:d===b,selected:d===s,onClick:()=>l(e=>e===d?null:d),"aria-pressed":d===s,"aria-label":`${d} \xb7 ${t.toFixed(1)}h fast`,title:`${d} \xb7 ${t.toFixed(1)}h fast`,children:[e.day,(0,o.jsxs)(ef,{children:[r&&(0,o.jsx)(ex,{color:"#58a6ff"}),i&&(0,o.jsx)(ex,{color:"#a371f7"}),n&&(0,o.jsx)(ex,{color:"#d29922"})]})]},e.key)})]}),s&&(0,o.jsxs)(ep,{role:"status","aria-live":"polite",children:[(0,o.jsx)(eh,{children:s}),(0,o.jsxs)(em,{children:[(0,o.jsxs)("span",{children:[(g[s]??0).toFixed(1),"h"]}),(0,o.jsx)("em",{children:t("forma.month.kpi.fastHours")})]}),(0,o.jsxs)(em,{children:[(0,o.jsxs)("span",{children:[Math.round(f[s]??0),"g"]}),(0,o.jsx)("em",{children:t("forma.month.kpi.avgProtein")})]}),void 0!==x[s]&&(0,o.jsxs)(em,{children:[(0,o.jsxs)("span",{children:[x[s].toFixed(1),"kg"]}),(0,o.jsx)("em",{children:t("forma.month.kpi.weight")})]}),(u[s]??0)>0&&(0,o.jsxs)(em,{children:[(0,o.jsxs)("span",{children:[u[s],"min"]}),(0,o.jsx)("em",{children:t("forma.month.kpi.walks")})]}),w.has(s)&&(0,o.jsxs)(em,{children:[(0,o.jsx)("span",{"aria-hidden":"true",children:"●"}),(0,o.jsx)("em",{children:t("forma.month.summary.checkIn")})]}),(0,o.jsx)(eg,{type:"button",onClick:()=>l(null),"aria-label":t("forma.month.summary.close"),children:"\xd7"})]})]}),(0,o.jsxs)(en,{children:[(0,o.jsxs)(er,{children:[(0,o.jsxs)(ei,{children:["◉ ",t("forma.month.protein.title")]}),0===k.length?(0,o.jsx)(c.YG,{mode:"empty",label:t("forma.analytics.empty")}):(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(eu,{children:C.slice(0,y).map((e,t)=>(0,o.jsx)(ew,{h:Math.min(100,e/(1.2*v)*100),over:e>=v,title:`${O(i,t+1)} \xb7 ${e.toFixed(0)}g`},t))}),(0,o.jsxs)(ey,{children:[(0,o.jsx)("span",{children:"1"}),(0,o.jsx)("span",{children:Math.ceil(y/2)}),(0,o.jsx)("span",{children:y})]})]})]}),(0,o.jsxs)(er,{children:[(0,o.jsxs)(ei,{children:["◉ ",t("forma.month.weight.title")]}),A.length<2?(0,o.jsx)(c.YG,{mode:"empty",label:t("forma.analytics.empty")}):(0,o.jsx)(c.OW,{points:A,accent:B,width:260,height:100,fluid:!0})]})]})]})}let e$="#7fb77e",ev="#58a6ff",ek="#d29922",eM="#7fb77e",ej=["Mo","Tu","We","Th","Fr","Sa","Su"],ez=["Se","Te","Qa","Qi","Sx","S\xe1","Do"],eT=new Set([0,4,8,12,16,20]);function eS(e){return[parseInt(e.slice(1,3),16),parseInt(e.slice(3,5),16),parseInt(e.slice(5,7),16)]}let eF=eS("#1d2230"),eC=eS(e$);function eA(e){let t=Math.round(eF[0]+(eC[0]-eF[0])*e),a=Math.round(eF[1]+(eC[1]-eF[1])*e),o=Math.round(eF[2]+(eC[2]-eF[2])*e);return`rgb(${t},${a},${o})`}let eD=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,eL=n().div`
  background: ${l.w4.colors.surface};
...
`,e1=n().span`
  font-size: 13px;
  color: ${l.w4.colors.mainTextMuted};
`;function e4({data:e,t,locale:a}){let i=new Date().toISOString().slice(0,10),[n,s]=(0,r.useState)(null),[l,m]=(0,r.useState)(null),g=(0,r.useMemo)(()=>(function(e){let t={};for(let a of e){if(!a.endedAt)continue;let e=a.startedAt,o=a.endedAt,r=e;for(;r<o;){let e=new Date(r),a=new Date(e.getFullYear(),e.getMonth(),e.getDate(),0,0,0,0).getTime()+864e5,i=Math.min(o,a)-r,n=e.toISOString().slice(0,10);t[n]=(t[n]??0)+i/36e5,r=a}}let a=[];for(let e=89;e>=0;e--){let o=t[function(e){let t=new Date;return t.setDate(t.getDate()-e),t.toISOString().slice(0,10)}(e)]??0,r=0;o>=18?r=4:o>=14?r=3:o>=8?r=2:o>0&&(r=1),a.push(r)}return a})(e.sessions),[e.sessions]),f=(0,r.useMemo)(()=>(0,d.weightTrend)(e.weights,60),[e.weights]),x=(0,r.useMemo)(()=>[...e.weights].sort((e,t)=>t.date.localeCompare(e.date))[0]??null,[e.weights]),u=(0,r.useMemo)(()=>(0,d.proteinByDay)(e.meals,i),[e.meals,i]),w=(0,r.useMemo)(()=>e.goal.proteinG??110,[e.goal.proteinG]),y=(0,r.useMemo)(()=>(function(e){let t=[],a=new Date,o=new Date(a),r=(a.getDay()+6)%7;o.setDate(a.getDate()-r),o.setHours(0,0,0,0);for(let a=5;a>=0;a--){let r=new Date(o);r.setDate(o.getDate()-7*a);let i=new Date(r);i.setDate(r.getDate()+7);let n=r.toISOString().slice(0,10),s=i.toISOString().slice(0,10),l=e.filter(e=>e.date>=n&&e.date<s),d=l.filter(e=>"lunch"===e.slot).reduce((e,t)=>e+(t.proteinG??0),0),c=l.filter(e=>"snack"===e.slot).reduce((e,t)=>e+(t.proteinG??0),0),p=l.filter(e=>"dinner"===e.slot).reduce((e,t)=>e+(t.proteinG??0),0),h=`${String(r.getDate()).padStart(2,"0")}/${String(r.getMonth()+1).padStart(2,"0")}`;t.push({label:h,segments:[{id:"lunch",value:d,color:ev},{id:"snack",value:c,color:ek},{id:"dinner",value:p,color:eM}]})}return t})(e.meals),[e.meals]),b=(0,r.useMemo)(()=>(0,d.dayHourFastMatrix)(e.sessions),[e.sessions]),$=(0,r.useMemo)(()=>{let e=0;for(let t of b)for(let a of t)a>e&&(e=a);return e},[b]),v=(0,r.useMemo)(()=>(0,d.generateFormaInsights)(e),[e]),k="pt"===a?ez:ej,M=e.weights.length>=2,j=e.meals.length>0,z=e.sessions.some(e=>void 0!==e.endedAt),T=[{id:"insights",defaultSize:"lg",render:()=>(0,o.jsxs)(eL,{children:[(0,o.jsxs)(eR,{children:["◉ ",t("forma.insights.title")]}),0===v.length?(0,o.jsx)(c.YG,{mode:"empty",label:t("forma.insights.empty")}):(0,o.jsx)(eX,{children:v.map(e=>{let a;return"string"==typeof(a={...e.vars??{}}).dayKey&&(a.day=t(a.dayKey)),(0,o.jsxs)(eZ,{accent:eU[e.severity],children:[(0,o.jsx)(e0,{children:t(e.titleKey)}),(0,o.jsx)(e1,{children:t(e.bodyKey,a)})]},e.id)})})]})},{id:"fast-heatmap",defaultSize:"lg",render:()=>(0,o.jsxs)(eL,{children:[(0,o.jsxs)(eR,{children:["◉ ",t("forma.analytics.heatmap.title")]}),z?(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(c.RT,{data:g,cellSize:11,gap:2,locale:a,selectedIndex:n??void 0,onCellClick:e=>s(t=>t===e?null:e),tooltip:o=>(0,h.Af)(e,(0,h.EQ)(o,g.length),t,a)}),(0,o.jsxs)(e_,{children:[(0,o.jsxs)(eJ,{children:[(0,o.jsx)(eQ,{color:eA(0)}),(0,o.jsx)("span",{children:t("forma.analytics.heatmap.none")})]}),(0,o.jsxs)(eJ,{children:[(0,o.jsx)(eQ,{color:eA(.25)}),(0,o.jsx)("span",{children:"<8h"})]}),(0,o.jsxs)(eJ,{children:[(0,o.jsx)(eQ,{color:eA(.5)}),(0,o.jsx)("span",{children:"8–14h"})]}),(0,o.jsxs)(eJ,{children:[(0,o.jsx)(eQ,{color:eA(.75)}),(0,o.jsx)("span",{children:"14–18h"})]}),(0,o.jsxs)(eJ,{children:[(0,o.jsx)(eQ,{color:eA(1)}),(0,o.jsx)("span",{children:"≥18h"})]})]}),null!==n&&(0,o.jsxs)(eV,{role:"status","aria-live":"polite",children:[(0,o.jsx)("span",{children:(0,h.Af)(e,(0,h.EQ)(n,g.length),t,a)}),(0,o.jsx)(eq,{type:"button",onClick:()=>s(null),"aria-label":t("forma.month.summary.close"),children:"\xd7"})]})]}):(0,o.jsx)(c.YG,{mode:"empty",label:t("forma.analytics.empty")})]})},{id:"weight-trend",defaultSize:"md",render:()=>(0,o.jsxs)(eL,{children:[(0,o.jsxs)(eR,{children:["◉ ",t("forma.analytics.weight.title")]}),M?(0,o.jsxs)(o.Fragment,{children:[(0,o.jsxs)(eB,{children:[(0,o.jsx)(eH,{children:x?x.kg.toFixed(1):"—"}),(0,o.jsx)(eP,{children:"kg"}),0!==f.delta&&(0,o.jsxs)(eE,{positive:f.delta>0,children:[f.delta>0?"+":"",f.delta.toFixed(1)," kg"]})]}),void 0!==e.goal.weightKg&&(0,o.jsxs)(eB,{children:[(0,o.jsx)(eI,{children:e.goal.weightKg.toFixed(1)}),(0,o.jsxs)(eP,{children:["kg ",t("forma.weight.target")]})]}),(0,o.jsx)(eP,{children:t("forma.analytics.weight.delta")}),(0,o.jsx)(c.OW,{points:f.ema.length>=2?f.ema:e.weights.map(e=>e.kg),accent:e$,width:260,height:60,fluid:!0})]}):(0,o.jsx)(c.YG,{mode:"empty",label:t("forma.analytics.empty")})]})},{id:"protein-burn",defaultSize:"md",render:()=>(0,o.jsxs)(eL,{children:[(0,o.jsxs)(eR,{children:["◉ ",t("forma.analytics.protein.title")]}),(0,o.jsxs)(eB,{children:[(0,o.jsx)(eH,{children:u.toFixed(0)}),(0,o.jsxs)(eP,{children:["/ ",w,"g ",t("forma.analytics.protein.target")]})]}),j?(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(c.kl,{spent:w-u,budget:w,height:60}),(0,o.jsx)(eP,{children:u>=w?t("forma.analytics.protein.achieved"):`${(w-u).toFixed(0)}g ${t("forma.analytics.protein.remaining")}`})]}):(0,o.jsx)(c.YG,{mode:"empty",label:t("forma.analytics.empty")})]})},{id:"weekly-protein",defaultSize:"lg",render:()=>(0,o.jsxs)(eL,{children:[(0,o.jsxs)(eR,{children:["◉ ",t("forma.analytics.weekly.title")]}),j?(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(c.ik,{data:y,budget:7*w,height:160}),(0,o.jsxs)(e_,{children:[(0,o.jsxs)(eJ,{children:[(0,o.jsx)(eQ,{color:ev}),(0,o.jsx)("span",{children:t("forma.meal.lunch")})]}),(0,o.jsxs)(eJ,{children:[(0,o.jsx)(eQ,{color:ek}),(0,o.jsx)("span",{children:t("forma.meal.snack")})]}),(0,o.jsxs)(eJ,{children:[(0,o.jsx)(eQ,{color:eM}),(0,o.jsx)("span",{children:t("forma.meal.dinner")})]})]})]}):(0,o.jsx)(c.YG,{mode:"empty",label:t("forma.analytics.empty")})]})},{id:"meal-heatmap",defaultSize:"lg",render:()=>(0,o.jsx)(I,{data:e,t:t,locale:a})},{id:"fast-times",defaultSize:"lg",render:()=>(0,o.jsxs)(eL,{children:[(0,o.jsxs)(eR,{children:["◉ ",t("forma.analytics.fastTimes.title")]}),z?(0,o.jsxs)(eW,{children:[(0,o.jsxs)(eN,{children:[(0,o.jsx)("div",{}),Array.from({length:24},(e,t)=>(0,o.jsx)(eO,{children:eT.has(t)?String(t).padStart(2,"0"):""},t))]}),b.map((r,i)=>(0,o.jsxs)(eY,{children:[(0,o.jsx)(eG,{children:k[i]}),r.map((r,n)=>{let s=null!==l&&l.day===i&&l.hour===n;return(0,o.jsx)(eK,{type:"button",bg:0===$?eA(0):eA(r/$),selected:s,"aria-pressed":s,onClick:()=>m(e=>e&&e.day===i&&e.hour===n?null:{day:i,hour:n}),title:(0,h.Cl)(e,i,n,t,a)},n)})]},i))]}):(0,o.jsx)(c.YG,{mode:"empty",label:t("forma.analytics.empty")}),l&&(0,o.jsxs)(eV,{role:"status","aria-live":"polite",children:[(0,o.jsx)("span",{children:(0,h.Cl)(e,l.day,l.hour,t,a)}),(0,o.jsx)(eq,{type:"button",onClick:()=>m(null),"aria-label":t("forma.month.summary.close"),children:"\xd7"})]})]})}];return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(eb,{data:e,t:t,locale:a}),(0,o.jsx)(p.C,{t:t,cards:T,storageKey:"forma:layout:analytics"})]})}},69568(e,t,a){a.d(t,{c:()=>S});var o=a(65723),r=a(37991),i=a(36859),n=a.n(i),s=a(72799),l=a(6063),d=a(63236),c=a(26506);let p="#7fb77e",h=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,m=n().section`
  display: flex;
...
`,T=n().p`
  ...
  margin: 0;
  text-align: center;
`;function S({t:e,locale:t}){let{comments:a,addComment:i,updateAnswer:n,removeComment:s}=(0,c.useAskComments)(),[l,h]=(0,r.useState)(""),[F,C]=(0,r.useState)(null),[A,D]=(0,r.useState)(null),L=(0,r.useRef)(null);(0,r.useEffect)(()=>{(0,c.resolveGroqKey)().then(D)},[]);let R=(0,r.useCallback)(async()=>{let e=l.trim();if(!e||!A||F)return;h("");let a=await i(e);if(!a)return;C(a),L.current=new AbortController;let o=`You are a fasting and diet coach assistant for the Forma app.
Answer questions about intermittent fasting, nutrition, weight loss, and wellness.
Be concise, practical, and supportive. Respond in ${"pt"===t?"Portuguese (PT)":"English"}.`;try{let r="";await (0,c.askGroqStream)(e,{key:A,locale:t,system:o,maxTokens:512,signal:L.current.signal,onChunk:e=>{r=e,n(a,e)}}),await n(a,r)}catch{}finally{C(null),L.current=null}},[l,A,F,i,n,t]),H=[...a].reverse();return(0,o.jsxs)(m,{children:[(0,o.jsx)(g,{children:e("forma.ask.title")}),A?(0,o.jsxs)(f,{children:[(0,o.jsx)(x,{value:l,onChange:e=>h(e.target.value),onKeyDown:e=>{"Enter"!==e.key||e.shiftKey||(e.preventDefault(),R())},placeholder:e("forma.ask.chat.placeholder"),disabled:!!F,rows:1}),(0,o.jsx)(d.$n,{variant:"primary",onClick:()=>{R()},disabled:!l.trim()||!!F,children:(0,o.jsx)(d.In,{name:"send",size:14})})]}):(0,o.jsx)(T,{children:e("forma.ask.noKey")}),0===H.length?(0,o.jsx)(z,{children:e("forma.ask.chat.empty")}):(0,o.jsx)(u,{children:H.map(e=>(0,o.jsxs)(w,{children:[(0,o.jsxs)(y,{children:[(0,o.jsx)(b,{children:(0,o.jsx)(d.In,{name:"user",size:12,color:p})}),(0,o.jsx)($,{children:e.question})]}),e.id!==F||e.answer?e.answer?(0,o.jsx)(v,{children:(0,o.jsx)(d.mQ,{children:e.answer})}):null:(0,o.jsx)(v,{children:(0,o.jsxs)(k,{children:[(0,o.jsx)(M,{delay:0}),(0,o.jsx)(M,{delay:200}),(0,o.jsx)(M,{delay:400})]})}),(0,o.jsx)(j,{children:(0,o.jsx)(d.$n,{variant:"ghost",onClick:()=>{s(e.id)},disabled:e.id===F,children:(0,o.jsx)(d.In,{name:"trash",size:13})})})]},e.id))})]})}},37103(e,t,a){a.d(t,{j:()=>u});var o=a(65723),r=a(37991),i=a(36859),n=a.n(i),s=a(6063),l=a(63236),d=a(26506);let c=n().section`
...
Give 3–5 bullets: what's going well, what to fix, one specific next-meal suggestion.`),w=await (0,d.askGroqStream)(u,{key:f,locale:a,maxTokens:400,onChunk:e=>v(e)}),y=Date.now();M(y),(0,s.pJ)(x,JSON.stringify({text:w,ts:y}))}catch(e){S(e instanceof Error?e.message:t("forma.ask.error"))}finally{z(!1)}},[e,a,t]);if(null===y||!1===y)return null;let C=!!$;return(0,o.jsxs)(c,{children:[(0,o.jsxs)(p,{children:[(0,o.jsxs)(h,{children:["✦ ",t("forma.ask.title")]}),(0,o.jsx)(l.$n,{variant:"accent",icon:(0,o.jsx)(l.In,{name:C?"refresh":"message",size:14}),onClick:()=>void F(),disabled:j,children:j?t("forma.ask.loading"):C?t("forma.ask.regenerate"):t("forma.ask.button")})]}),T&&(0,o.jsx)(g,{children:T}),($||j)&&(0,o.jsx)(m,{children:$?(0,o.jsx)(l.mQ,{children:$}):"…"}),null!==k&&!j&&C&&(0,o.jsxs)(f,{children:[t("forma.ask.generatedAt")," \xb7 ",(i=new Date(k),n=e=>String(e).padStart(2,"0"),w=i.toLocaleDateString("pt"===a?"pt-PT":"en-GB",{day:"2-digit",month:"short"}),`${w}, ${n(i.getHours())}:${n(i.getMinutes())}`)]}),!$&&!j&&!T&&(0,o.jsx)(m,{style:{color:s.w4.colors.mainTextMuted,fontStyle:"italic"},children:t("forma.ask.hint")})]})}},82167(e,t,a){a.d(t,{X:()=>x});var o=a(65723),r=a(37991),i=a(36859),n=a.n(i),s=a(72799),l=a(6063);let d=(0,s.keyframes)`
...
`,f=n().div`
  ...
  min-height: 0;
  overflow-y: auto;
`;function x({open:e,onClose:t,children:a,maxWidth:i=480,ariaLabel:n}){let s=(0,r.useRef)(null);(0,r.useEffect)(()=>{if(!e)return;let a=e=>{"Escape"===e.key&&t()};return window.addEventListener("keydown",a),()=>window.removeEventListener("keydown",a)},[e,t]),(0,r.useEffect)(()=>{if(!e||!s.current)return;let t=s.current.querySelector('button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])');t?.focus()},[e]);let l=(0,r.useRef)(null),d=(0,r.useCallback)(e=>{l.current={y:e.touches[0].clientY}},[]),c=(0,r.useCallback)(e=>{if(!l.current||!s.current)return;let a=e.changedTouches[0].clientY-l.current.y;l.current=null,a>=0||-a/s.current.getBoundingClientRect().height>.3&&t()},[t]),u=(0,r.useRef)(null),w=(0,r.useCallback)(e=>{u.current={y:e.clientY}},[]),y=(0,r.useCallback)(e=>{if(!u.current||!s.current)return;let a=e.clientY-u.current.y;u.current=null,a>=0||-a/s.current.getBoundingClientRect().height>.3&&t()},[t]);return e?(0,o.jsx)(p,{onClick:t,role:"dialog","aria-modal":"true","aria-label":n,children:(0,o.jsxs)(h,{ref:s,maxWidth:i,onClick:e=>e.stopPropagation(),children:[(0,o.jsx)(m,{onTouchStart:d,onTouchEnd:c,onPointerDown:w,onPointerUp:y,"aria-hidden":"true",children:(0,o.jsx)(g,{})}),(0,o.jsx)(f,{children:a})]})}):null}},33499(e,t,a){a.d(t,{N:()=>k});var o=a(65723),r=a(37991),i=a(36859),n=a.n(i),s=a(6063),l=a(63236),d=a(26506),c=a(82167);let p="#7fb77e",h=n().div`
  display: flex;
  flex-direction: column;
  gap: ${s.w4.spacing.lg};
...
`,$=n().div`
  ...
  gap: ${s.w4.spacing.sm};
  justify-content: flex-end;
`,v=[1,2,3,4,5];function k({open:e,onClose:t,t:a}){let{checkIn:i,saveCheckIn:n}=(0,d.useCheckIn)(),[s,p]=(0,r.useState)(i?.hunger??3),[M,j]=(0,r.useState)(i?.energy??3),[z,T]=(0,r.useState)(i?.adherence??!0),[S,F]=(0,r.useState)(i?.note??""),[C,A]=(0,r.useState)(!1),D=(0,r.useCallback)(async()=>{A(!0);try{await n({hunger:s,energy:M,adherence:z,note:S.trim()||void 0}),t()}finally{A(!1)}},[n,s,M,z,S,t]);return(0,o.jsx)(c.X,{open:e,onClose:t,ariaLabel:a("forma.checkin.title"),children:(0,o.jsxs)(h,{children:[(0,o.jsx)(m,{children:a("forma.checkin.title")}),(0,o.jsxs)(g,{children:[(0,o.jsx)(f,{children:a("forma.checkin.hunger")}),(0,o.jsx)(x,{children:v.map(e=>(0,o.jsx)(u,{active:s===e,onClick:()=>p(e),"aria-pressed":s===e,children:e},e))})]}),(0,o.jsxs)(g,{children:[(0,o.jsx)(f,{children:a("forma.checkin.energy")}),(0,o.jsx)(x,{children:v.map(e=>(0,o.jsx)(u,{active:M===e,onClick:()=>j(e),"aria-pressed":M===e,children:e},e))})]}),(0,o.jsxs)(g,{children:[(0,o.jsx)(f,{children:a("forma.checkin.adherence")}),(0,o.jsxs)(w,{children:[(0,o.jsxs)(y,{active:z,onClick:()=>T(!0),"aria-pressed":z,children:[(0,o.jsx)(l.In,{name:"check",size:14}),a("forma.checkin.adherenceYes")]}),(0,o.jsxs)(y,{active:!z,danger:!0,onClick:()=>T(!1),"aria-pressed":!z,children:[(0,o.jsx)(l.In,{name:"close",size:14}),a("forma.checkin.adherenceNo")]})]})]}),(0,o.jsxs)(g,{children:[(0,o.jsx)(f,{children:a("forma.checkin.note")}),(0,o.jsx)(b,{value:S,onChange:e=>F(e.target.value),placeholder:a("forma.checkin.notePlaceholder"),rows:2})]}),(0,o.jsxs)($,{children:[(0,o.jsx)(l.$n,{variant:"ghost",onClick:t,disabled:C,children:a("forma.checkin.cancel")}),(0,o.jsx)(l.$n,{variant:"success",onClick:()=>{D()},disabled:C,children:a("forma.checkin.save")})]})]})})}},24470(e,t,a){a.d(t,{s:()=>v});var o=a(65723),r=a(37991),i=a(36859),n=a.n(i),s=a(72799),l=a(6063),d=a(63236),c=a(26506);let p="#7fb77e",h=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,m=n().section`
  background: ${l.w4.colors.surface};
...
`;function v({t:e}){var t;let{output:a,refresh:i}=(0,c.useCoach)(),[n,s]=(0,r.useState)(!1),h=(0,r.useCallback)(async()=>{s(!0);try{await i()}finally{s(!1)}},[i]),k=()=>{h()};if(!a)return(0,o.jsxs)(m,{accent:p,children:[(0,o.jsx)(g,{children:(0,o.jsx)(f,{children:e("forma.coach.title")})}),(0,o.jsxs)(y,{children:[(0,o.jsx)(d.In,{name:"message",size:24,color:l.w4.colors.mainTextMuted}),(0,o.jsx)(b,{children:e("forma.coach.empty")}),(0,o.jsx)(d.$n,{variant:"accent",onClick:k,disabled:n,children:e("forma.coach.generate")})]})]});let M=(t=a.messageKey,/lowAdherence|hunger/.test(t)?"#f87171":/stall|lowEnergy/.test(t)?"#facc15":p);return(0,o.jsxs)(m,{accent:M,children:[(0,o.jsx)(g,{children:(0,o.jsx)(f,{children:e("forma.coach.title")})}),(0,o.jsx)(x,{children:e(a.messageKey,a.vars)}),a.adjustments.length>0&&(0,o.jsx)(u,{children:a.adjustments.map((t,a)=>(0,o.jsx)(w,{accent:M,children:e(t.reasonKey)},a))}),(0,o.jsx)($,{children:(0,o.jsxs)(d.$n,{variant:"ghost",onClick:k,disabled:n,children:[(0,o.jsx)(d.In,{name:"rotate-cw",size:13}),e("forma.coach.refresh")]})})]})}},72552(e,t,a){a.d(t,{k:()=>j});var o=a(65723),r=a(37991),i=a(36859),n=a.n(i),s=a(6063),l=a(63236),d=a(26506);let c="#7fb77e",p=2*Math.PI*95,h=n().div`
  display: flex;
  flex-direction: column;
  align-items: center;
  gap: ${s.w4.spacing.md};
...
`,M=n().span`
  ...
  text-transform: uppercase;
  letter-spacing: 0.16em;
`;function j({data:e,t,onStart:a,onStop:i,onEditStart:n}){let z,T,S,F,C,[A,D]=(0,r.useState)(Date.now),L=e.sessions.some(e=>void 0===e.endedAt);(0,r.useEffect)(()=>{if(!L)return;let e=setInterval(()=>D(Date.now()),1e3);return()=>clearInterval(e)},[L]);let R=(0,d.currentFast)(e,A),H=R?.percent??0,I=null!==R,P=R?R.hoursElapsed:0,B=R?R.remainingMs:0,E=R?R.session.targetHours:e.goal.targetHours;return(0,o.jsxs)(h,{children:[(0,o.jsxs)(m,{children:[(0,o.jsxs)(g,{width:200,height:200,viewBox:"0 0 200 200","aria-hidden":"true",children:[(0,o.jsx)("circle",{cx:100,cy:100,r:95,fill:"none",stroke:s.w4.colors.border,strokeWidth:10}),(0,o.jsx)("circle",{cx:100,cy:100,r:95,fill:"none",stroke:c,strokeWidth:10,strokeLinecap:"round",strokeDasharray:p,strokeDashoffset:p*(1-H),style:{transition:"stroke-dashoffset 0.6s ease"}})]}),(0,o.jsx)(f,{children:I?(0,o.jsxs)(o.Fragment,{children:[(0,o.jsxs)(x,{children:[P.toFixed(1),"h"]}),(0,o.jsx)(u,{children:t("forma.timer.elapsed")})]}):(0,o.jsxs)(o.Fragment,{children:[(0,o.jsxs)(x,{children:[E,"h"]}),(0,o.jsx)(u,{children:t("forma.hero.notFasting")})]})})]}),I&&R&&(0,o.jsxs)(o.Fragment,{children:[(0,o.jsxs)(b,{children:[(0,o.jsx)(w,{children:R.session.protocol}),n&&(0,o.jsx)($,{type:"button",onClick:()=>n(R.session),title:t("forma.timer.editStart"),children:t("forma.timer.startedAt",{time:(T=String((z=new Date(R.session.startedAt)).getHours()).padStart(2,"0"),S=String(z.getMinutes()).padStart(2,"0"),`${T}:${S}`)})})]}),(0,o.jsxs)(y,{children:[(0,o.jsxs)(v,{children:[(0,o.jsx)(k,{children:(C=Math.floor((F=Math.floor(B/6e4))/60),`${String(C).padStart(2,"0")}:${String(F%60).padStart(2,"0")}`)}),(0,o.jsx)(M,{children:t("forma.timer.remaining")})]}),(0,o.jsxs)(v,{children:[(0,o.jsxs)(k,{children:[Math.round(100*H),"%"]}),(0,o.jsx)(M,{children:t("forma.timer.complete")})]})]})]}),I&&R?(0,o.jsx)(l.$n,{variant:"danger",onClick:()=>i(R.session),children:t("forma.stop")}):(0,o.jsx)(l.$n,{variant:"success",onClick:a,children:t("forma.start")})]})}},4406(e,t,a){a.d(t,{C:()=>w});var o=a(65723),r=a(37991),i=a(36859),n=a.n(i),s=a(6063),l=a(63236);let d="#7fb77e",c=n().div`
  display: grid;
...
`;function f({size:e}){return(0,o.jsxs)("svg",{width:14,height:14,viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:[(0,o.jsx)("rect",{x:1.5,y:4.5,width:11,height:5,rx:1,stroke:"currentColor",strokeWidth:1,opacity:.4}),(0,o.jsx)("rect",{x:2,y:5,width:"sm"===e?4:"md"===e?7:11,height:4,rx:.5,fill:"currentColor"})]})}let x=n().div`
  display: flex;
  flex-wrap: wrap;
  gap: ${s.w4.spacing.xs};
...
`;function w({cards:e,t,storageKey:a="forma:layout"}){let[i,n]=(0,r.useState)(null);(0,r.useEffect)(()=>{let t=!1;return(async()=>{let o=await (0,s.PL)(a),r=null;if(o)try{r=JSON.parse(o)}catch{r=null}t||n(function(e,t){let a=new Set(t.map(e=>e.id)),o=new Set,r=[];if(e)for(let t of e)a.has(t.id)&&(r.push(t),o.add(t.id));for(let e of t)o.has(e.id)||r.push({id:e.id,size:e.defaultSize??"sm",hidden:!1});return r}(r,e))})(),()=>{t=!0}},[a,e.map(e=>e.id).join("|")]);let d=(0,r.useCallback)(e=>{n(e),(0,s.Is)(a,JSON.stringify(e))},[a]),y=(0,r.useCallback)((e,t)=>{if(!i)return;let a=i.filter(e=>!e.hidden),o=a.findIndex(t=>t.id===e);if(-1===o)return;let r=o+t;if(r<0||r>=a.length)return;let n=a[r],s=i.findIndex(t=>t.id===e),l=i.findIndex(e=>e.id===n.id),c=[...i];[c[s],c[l]]=[c[l],c[s]],d(c)},[i,d]),b=(0,r.useCallback)(e=>{i&&d(i.map(t=>{var a;return t.id===e?{...t,size:"sm"===(a=t.size)?"md":"md"===a?"lg":"sm"}:t}))},[i,d]),$=(0,r.useCallback)(e=>{i&&d(i.map(t=>t.id===e?{...t,hidden:!0}:t))},[i,d]),v=(0,r.useCallback)(e=>{i&&d(i.map(t=>t.id===e?{...t,hidden:!1}:t))},[i,d]),k=(0,r.useMemo)(()=>{let t=new Map;for(let a of e)t.set(a.id,a);return t},[e]);if(!i)return(0,o.jsx)(c,{});let M=i.filter(e=>!e.hidden),j=i.filter(e=>e.hidden);return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(c,{children:M.map((e,a)=>{let r=k.get(e.id);return r?(0,o.jsxs)(p,{size:e.size,children:[r.render(),(0,o.jsxs)(h,{className:"forma-grid-controls",children:[a>0&&(0,o.jsx)(m,{onClick:()=>y(e.id,-1),title:t("forma.grid.moveLeft"),"aria-label":t("forma.grid.moveLeft"),children:(0,o.jsx)(l.In,{name:"chevron-left",size:14})}),a<M.length-1&&(0,o.jsx)(m,{onClick:()=>y(e.id,1),title:t("forma.grid.moveRight"),"aria-label":t("forma.grid.moveRight"),children:(0,o.jsx)(l.In,{name:"chevron-right",size:14})}),(0,o.jsx)(m,{onClick:()=>b(e.id),title:t("forma.grid.resize",{size:e.size.toUpperCase()}),"aria-label":t("forma.grid.resize",{size:e.size.toUpperCase()}),children:(0,o.jsx)(f,{size:e.size})}),(0,o.jsx)(g,{onClick:()=>$(e.id),title:t("forma.grid.hide"),"aria-label":t("forma.grid.hide"),children:(0,o.jsx)(l.In,{name:"close",size:14})})]})]},e.id):null})}),j.length>0&&(0,o.jsxs)(x,{children:[(0,o.jsx)("span",{style:{fontSize:11,fontFamily:s.w4.typography.fontFamilyMono,color:s.w4.colors.mainTextMuted,textTransform:"uppercase",letterSpacing:"0.16em",alignSelf:"center",marginRight:8},children:t("forma.grid.hiddenLabel")}),j.map(e=>(0,o.jsxs)(u,{onClick:()=>v(e.id),children:["+ ",t(`forma.grid.card.${e.id}`)]},e.id))]})]})}},17102(e,t,a){a.d(t,{Y:()=>S});var o=a(65723),r=a(37991),i=a(36859),n=a.n(i),s=a(6063),l=a(63236),d=a(26506),c=a(82167);function p(){return new Date().toISOString().slice(0,10)}function h(e){let t=new Date(e),a=e=>String(e).padStart(2,"0");return`${t.getFullYear()}-${a(t.getMonth()+1)}-${a(t.getDate())}T${a(t.getHours())}:${a(t.getMinutes())}`}function m(){return h(Date.now())}function g(e){if(!e)return null;let t=new Date(e).getTime();return Number.isNaN(t)?null:t}let f="#7fb77e",x=n().div`
  padding: ${s.w4.spacing.md};
  display: flex;
  flex-direction: column;
  gap: ${s.w4.spacing.md};
...
`;function S({open:e,onClose:t,data:a,t:i,initialMode:n,editing:f,onStartFast:F,onStopFast:C,onLogPastFast:A,onEditFast:D,onLogMeal:L,onEditMeal:R,onLogWeight:H,onEditWeight:I,onLogWalk:P,onEditWalk:B,onLogWater:E,onEditWater:W}){let[N,O]=(0,r.useState)(n??null),[Y,G]=(0,r.useState)("16:8"),[K,V]=(0,r.useState)("16"),[q,_]=(0,r.useState)("16:8"),[J,Q]=(0,r.useState)("16"),[U,X]=(0,r.useState)(m),[Z,ee]=(0,r.useState)(""),[et,ea]=(0,r.useState)(null),[eo,er]=(0,r.useState)("dinner"),[ei,en]=(0,r.useState)(""),[es,el]=(0,r.useState)(""),[ed,ec]=(0,r.useState)(""),[ep,eh]=(0,r.useState)(p),[em,eg]=(0,r.useState)(""),[ef,ex]=(0,r.useState)(p),[eu,ew]=(0,r.useState)(""),[ey,eb]=(0,r.useState)(p),[e$,ev]=(0,r.useState)(""),[ek,eM]=(0,r.useState)(p);(0,r.useEffect)(()=>{if(e)if(ea(null),f?.kind==="fast"){let e=f.entry;O("pastFast"),_(e.protocol),Q(String(e.targetHours)),X(h(e.startedAt)),ee(e.endedAt?h(e.endedAt):"")}else if(f?.kind==="meal"){let e=f.entry;O("meal"),er(e.slot),en(String(e.proteinG??"")),el(String(e.kcal??"")),ec(e.notes??""),eh(e.date)}else f?.kind==="weight"?(O("weight"),eg(String(f.entry.kg)),ex(f.entry.date)):f?.kind==="walk"?(O("walk"),ew(String(f.entry.minutes)),eb(f.entry.date)):f?.kind==="water"?(O("water"),ev(String(f.entry.ml)),eM(f.entry.date)):n&&(O(n),"pastFast"===n?(_("16:8"),Q("16"),X(m()),ee("")):"meal"===n?(er("dinner"),en(""),el(""),ec(""),eh(p())):"weight"===n?(eg(""),ex(p())):"walk"===n?(ew(""),eb(p())):"water"===n&&(ev(""),eM(p())))},[e,f,n]);let ej=a.sessions.some(e=>void 0===e.endedAt),ez=f?.kind??("startFast"===n||"pastFast"===n?"fast":"meal"===n?"meal":"weight"===n?"weight":"walk"===n?"walk":"water"===n?"water":null),eT=null===ez||"fast"===ez,eS=null===ez||"meal"===ez,eF=null===ez||"weight"===ez,eC=null===ez||"walk"===ez,eA=null===ez||"water"===ez,eD=(0,r.useCallback)(()=>{O(null)},[]),eL=(0,r.useCallback)(()=>{eD(),t()},[eD,t]),eR=(0,r.useCallback)(()=>{let e=g(U);if(null===e)return;let t=Z.trim(),a=t?g(t):null;if(t&&null===a)return;if(null!==a&&a<=e)return void ea(i("forma.sheet.fastInvalidRange"));let o=parseInt(J,10),r=isNaN(o)||o<1?16:o;f?.kind==="fast"&&D?D(f.entry.id,q,r,e,a??void 0):A&&A(q,r,e,a??void 0),eL()},[f,D,A,q,J,U,Z,i,eL]),eH=(0,r.useCallback)(()=>{let e=parseInt(K,10);isNaN(e)||e<1||(F(Y,e),eL())},[Y,K,F,eL]),eI=(0,r.useMemo)(()=>(0,d.estimateNutrition)(ed),[ed]),eP=(0,r.useCallback)(()=>{let e=""===ei.trim()?eI.proteinG:parseFloat(ei)||0,t=""===es.trim()?eI.kcal:parseFloat(es)||0;f?.kind==="meal"&&R?R(f.entry.id,eo,e,t,ed.trim(),ep):L(eo,e,t,ed.trim(),ep),eL()},[f,R,eo,ei,es,eI,ed,ep,L,eL]),eB=(0,r.useCallback)(()=>{let e=parseFloat(em.replace(",","."));isNaN(e)||e<=0||(f?.kind==="weight"&&I?I(ef,e):H(e,ef),eL())},[f,I,em,ef,H,eL]),eE=(0,r.useCallback)(()=>{let e=parseInt(eu,10);isNaN(e)||e<=0||(f?.kind==="walk"&&B?B(f.entry.id,e,ey):P(e,ey),eL())},[f,B,eu,ey,P,eL]),eW=(0,r.useCallback)(()=>{let e=parseInt(e$,10);isNaN(e)||e<=0||(f?.kind==="water"&&W?W(f.entry.id,e,ek):E(e,ek),eL())},[f,W,e$,ek,E,eL]);return(0,o.jsx)(c.X,{open:e,onClose:eL,maxWidth:520,ariaLabel:i("forma.sheet.ariaLabel"),children:(0,o.jsxs)(x,{children:[(0,o.jsx)(l.YZ,{children:f?.kind==="fast"?i("forma.sheet.titleEditFast"):f?.kind==="meal"?i("forma.sheet.titleEditMeal"):f?.kind==="weight"?i("forma.sheet.titleEditWeight"):f?.kind==="walk"?i("forma.sheet.titleEditWalk"):f?.kind==="water"?i("forma.sheet.titleEditWater"):"pastFast"===n?i("forma.sheet.titleAddFast"):"meal"===n?i("forma.sheet.titleAddMeal"):"weight"===n?i("forma.sheet.titleAddWeight"):"walk"===n?i("forma.sheet.titleAddWalk"):"water"===n?i("forma.sheet.titleAddWater"):i("forma.sheet.title")}),eT&&(0,o.jsx)(w,{children:(0,o.jsx)(l.YZ,{children:i("forma.sheet.fastSection")})}),eT&&("pastFast"===N?(0,o.jsxs)(u,{children:[(0,o.jsxs)(y,{children:[(0,o.jsx)(b,{htmlFor:"past-fast-protocol",children:i("forma.rail.title")}),(0,o.jsxs)(v,{id:"past-fast-protocol",value:q,onChange:e=>{let t=e.target.value;_(t),"custom"!==t&&Q(t.split(":")[0])},children:[(0,o.jsx)("option",{value:"16:8",children:"16:8"}),(0,o.jsx)("option",{value:"18:6",children:"18:6"}),(0,o.jsx)("option",{value:"20:4",children:"20:4"}),(0,o.jsx)("option",{value:"custom",children:i("forma.protocol.custom")})]})]}),"custom"===q&&(0,o.jsxs)(y,{children:[(0,o.jsx)(b,{htmlFor:"past-fast-target",children:i("forma.sheet.fastTargetLabel")}),(0,o.jsx)($,{id:"past-fast-target",type:"number",value:J,min:1,max:72,onChange:e=>Q(e.target.value)})]}),(0,o.jsxs)(y,{children:[(0,o.jsx)(b,{htmlFor:"past-fast-start",children:i("forma.sheet.fastStartLabel")}),(0,o.jsx)($,{id:"past-fast-start",type:"datetime-local",value:U,max:m(),onChange:e=>{X(e.target.value),ea(null)}})]}),(0,o.jsxs)(y,{children:[(0,o.jsx)(b,{htmlFor:"past-fast-end",children:i("forma.sheet.fastEndLabel")}),(0,o.jsx)($,{id:"past-fast-end",type:"datetime-local",value:Z,max:m(),placeholder:i("forma.sheet.fastEndHint"),onChange:e=>{ee(e.target.value),ea(null)}})]}),et&&(0,o.jsx)("div",{style:{fontSize:11,fontFamily:s.w4.typography.fontFamilyMono,color:s.w4.colors.danger},children:et}),(0,o.jsxs)(T,{children:[(0,o.jsx)(l.$n,{variant:"primary",onClick:eR,children:f?.kind==="fast"?i("forma.sheet.saveEdit"):i("forma.sheet.save")}),(0,o.jsx)(l.$n,{variant:"ghost",onClick:eD,children:i("forma.sheet.cancel")})]})]}):ej?(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(l.$n,{variant:"danger",onClick:()=>{C(),eL()},children:i("forma.stop")}),(0,o.jsxs)(M,{onClick:()=>O("pastFast"),children:[(0,o.jsx)(l.In,{name:"clock",size:16}),i("forma.sheet.logPastFast")]})]}):"startFast"===N?(0,o.jsxs)(u,{children:[(0,o.jsxs)(y,{children:[(0,o.jsx)(b,{htmlFor:"fast-protocol",children:i("forma.rail.title")}),(0,o.jsxs)(v,{id:"fast-protocol",value:Y,onChange:e=>{let t=e.target.value;G(t),"custom"!==t&&V(t.split(":")[0])},children:[(0,o.jsx)("option",{value:"16:8",children:"16:8"}),(0,o.jsx)("option",{value:"18:6",children:"18:6"}),(0,o.jsx)("option",{value:"20:4",children:"20:4"}),(0,o.jsx)("option",{value:"custom",children:i("forma.protocol.custom")})]})]}),"custom"===Y&&(0,o.jsxs)(y,{children:[(0,o.jsx)(b,{htmlFor:"fast-hours",children:i("forma.timer.target")}),(0,o.jsx)($,{id:"fast-hours",type:"number",value:K,min:1,max:72,onChange:e=>V(e.target.value)})]}),(0,o.jsxs)(T,{children:[(0,o.jsx)(l.$n,{variant:"success",onClick:eH,children:i("forma.start")}),(0,o.jsx)(l.$n,{variant:"ghost",onClick:eD,children:i("forma.sheet.cancel")})]})]}):(0,o.jsxs)(o.Fragment,{children:[(0,o.jsxs)(M,{onClick:()=>O("startFast"),children:[(0,o.jsx)(l.In,{name:"play",size:16}),i("forma.start")]}),(0,o.jsxs)(M,{onClick:()=>O("pastFast"),children:[(0,o.jsx)(l.In,{name:"clock",size:16}),i("forma.sheet.logPastFast")]})]})),eS&&(0,o.jsx)(w,{children:(0,o.jsx)(l.YZ,{children:i("forma.sheet.mealSection")})}),eS&&("meal"===N?(0,o.jsxs)(u,{children:[(0,o.jsxs)(y,{children:[(0,o.jsx)(b,{htmlFor:"meal-slot",children:i("forma.meal.lunch")}),(0,o.jsxs)(k,{id:"meal-slot",value:eo,onChange:e=>er(e.target.value),children:[(0,o.jsx)("option",{value:"lunch",children:i("forma.meal.lunch")}),(0,o.jsx)("option",{value:"dinner",children:i("forma.meal.dinner")}),(0,o.jsx)("option",{value:"snack",children:i("forma.meal.snack")})]})]}),(0,o.jsxs)(y,{children:[(0,o.jsx)(b,{htmlFor:"meal-notes",children:i("forma.meal.template")}),(0,o.jsx)($,{id:"meal-notes",type:"text",value:ed,placeholder:"3 ovos, 100g atum, salada…",onChange:e=>ec(e.target.value)})]}),eI.matched.length>0&&(0,o.jsxs)(j,{children:[i("forma.sheet.estimateHint",{protein:eI.proteinG,kcal:eI.kcal}),eI.unmatched.length>0&&(0,o.jsxs)(z,{children:[" \xb7 ",i("forma.sheet.estimateUnmatched",{items:eI.unmatched.join(", ")})]})]}),(0,o.jsxs)(y,{children:[(0,o.jsx)(b,{htmlFor:"meal-protein",children:i("forma.sheet.proteinLabel")}),(0,o.jsx)($,{id:"meal-protein",type:"number",value:ei,min:0,placeholder:eI.proteinG>0?`≈ ${eI.proteinG}`:"0",onChange:e=>en(e.target.value)})]}),(0,o.jsxs)(y,{children:[(0,o.jsx)(b,{htmlFor:"meal-kcal",children:i("forma.sheet.kcalLabel")}),(0,o.jsx)($,{id:"meal-kcal",type:"number",value:es,min:0,placeholder:eI.kcal>0?`≈ ${eI.kcal}`:"0",onChange:e=>el(e.target.value)})]}),(0,o.jsxs)(y,{children:[(0,o.jsx)(b,{htmlFor:"meal-date",children:i("forma.sheet.dateLabel")}),(0,o.jsx)($,{id:"meal-date",type:"date",value:ep,max:p(),onChange:e=>eh(e.target.value)})]}),(0,o.jsxs)(T,{children:[(0,o.jsx)(l.$n,{variant:"primary",onClick:eP,children:f?.kind==="meal"?i("forma.sheet.saveEdit"):i("forma.sheet.save")}),(0,o.jsx)(l.$n,{variant:"ghost",onClick:eD,children:i("forma.sheet.cancel")})]})]}):(0,o.jsxs)(M,{onClick:()=>O("meal"),children:[(0,o.jsx)(l.In,{name:"utensils",size:16}),i("forma.sheet.logMeal")]})),eF&&(0,o.jsx)(w,{children:(0,o.jsx)(l.YZ,{children:i("forma.sheet.weightSection")})}),eF&&("weight"===N?(0,o.jsxs)(u,{children:[(0,o.jsxs)(y,{children:[(0,o.jsx)(b,{htmlFor:"weight-kg",children:i("forma.sheet.weightLabel")}),(0,o.jsx)($,{id:"weight-kg",type:"number",value:em,min:20,max:300,step:.1,placeholder:"84.2",onChange:e=>eg(e.target.value)})]}),(0,o.jsxs)(y,{children:[(0,o.jsx)(b,{htmlFor:"weight-date",children:i("forma.sheet.dateLabel")}),(0,o.jsx)($,{id:"weight-date",type:"date",value:ef,max:p(),onChange:e=>ex(e.target.value)})]}),(0,o.jsxs)(T,{children:[(0,o.jsx)(l.$n,{variant:"primary",onClick:eB,children:f?.kind==="weight"?i("forma.sheet.saveEdit"):i("forma.sheet.save")}),(0,o.jsx)(l.$n,{variant:"ghost",onClick:eD,children:i("forma.sheet.cancel")})]})]}):(0,o.jsxs)(M,{onClick:()=>O("weight"),children:[(0,o.jsx)(l.In,{name:"trending-up",size:16}),i("forma.sheet.logWeight")]})),eC&&(0,o.jsx)(w,{children:(0,o.jsx)(l.YZ,{children:i("forma.sheet.walkSection")})}),eC&&("walk"===N?(0,o.jsxs)(u,{children:[(0,o.jsxs)(y,{children:[(0,o.jsx)(b,{htmlFor:"walk-min",children:i("forma.sheet.walkLabel")}),(0,o.jsx)($,{id:"walk-min",type:"number",value:eu,min:1,max:600,placeholder:"30",onChange:e=>ew(e.target.value)})]}),(0,o.jsxs)(y,{children:[(0,o.jsx)(b,{htmlFor:"walk-date",children:i("forma.sheet.dateLabel")}),(0,o.jsx)($,{id:"walk-date",type:"date",value:ey,max:p(),onChange:e=>eb(e.target.value)})]}),(0,o.jsxs)(T,{children:[(0,o.jsx)(l.$n,{variant:"primary",onClick:eE,children:f?.kind==="walk"?i("forma.sheet.saveEdit"):i("forma.sheet.save")}),(0,o.jsx)(l.$n,{variant:"ghost",onClick:eD,children:i("forma.sheet.cancel")})]})]}):(0,o.jsxs)(M,{onClick:()=>O("walk"),children:[(0,o.jsx)(l.In,{name:"activity",size:16}),i("forma.sheet.logWalk")]})),eA&&(0,o.jsx)(w,{children:(0,o.jsx)(l.YZ,{children:i("forma.today.water")})}),eA&&("water"===N?(0,o.jsxs)(u,{children:[(0,o.jsxs)(y,{children:[(0,o.jsx)(b,{htmlFor:"water-ml",children:i("forma.sheet.waterLabel")}),(0,o.jsx)($,{id:"water-ml",type:"number",value:e$,min:1,max:5e3,placeholder:i("forma.sheet.waterPlaceholder"),onChange:e=>ev(e.target.value)})]}),(0,o.jsxs)(y,{children:[(0,o.jsx)(b,{htmlFor:"water-date",children:i("forma.sheet.dateLabel")}),(0,o.jsx)($,{id:"water-date",type:"date",value:ek,max:p(),onChange:e=>eM(e.target.value)})]}),(0,o.jsxs)(T,{children:[(0,o.jsx)(l.$n,{variant:"primary",onClick:eW,children:f?.kind==="water"?i("forma.sheet.saveEdit"):i("forma.sheet.save")}),(0,o.jsx)(l.$n,{variant:"ghost",onClick:eD,children:i("forma.sheet.cancel")})]})]}):(0,o.jsxs)(M,{onClick:()=>O("water"),children:[(0,o.jsx)(l.In,{name:"droplets",size:16}),i("forma.water.add250")]}))]})})}},52128(e,t,a){a.d(t,{g:()=>b});var o=a(65723),r=a(37991),i=a(36859),n=a.n(i),s=a(6063),l=a(26506);let d="#7fb77e",c=n().button`
  display: flex;
  flex-direction: column;
  gap: ${s.w4.spacing.sm};
  background: ${s.w4.colors.surface};
...
`;function b({data:e,t,onClick:a}){let[i,n]=(0,r.useState)(Date.now),s=e.sessions.some(e=>void 0===e.endedAt);(0,r.useEffect)(()=>{if(!s)return;let e=setInterval(()=>n(Date.now()),3e4);return()=>clearInterval(e)},[s]);let d=(0,l.currentFast)(e,i),$=d?.percent??0,v=d?Math.max(0,d.session.targetHours-d.hoursElapsed):0,k=d?`${v.toFixed(1)}h ${t("forma.timer.remaining")}`:t("forma.miniFast.noActive");return(0,o.jsxs)(c,{onClick:a,"aria-label":t("forma.miniFast.aria"),children:[(0,o.jsxs)(p,{children:[(0,o.jsxs)(h,{children:["◉ ",t("forma.miniFast.title")]}),d&&(0,o.jsxs)(m,{children:[Math.round(100*$),"%"]})]}),(0,o.jsxs)(g,{children:[(0,o.jsx)(f,{children:d?d.hoursElapsed.toFixed(1):"—"}),(0,o.jsx)(x,{children:d?`h / ${d.session.targetHours}h`:t("forma.miniFast.noActive")})]}),(0,o.jsx)(w,{children:(0,o.jsx)(y,{pct:$})}),(0,o.jsx)(u,{children:k})]})}},59446(e,t,a){a.d(t,{S:()=>w});var o=a(65723),r=a(37991),i=a(36859),n=a.n(i),s=a(6063),l=a(26506),d=a(11533);let c="#7fb77e",p=n().button`
  display: flex;
  flex-direction: column;
  gap: ${s.w4.spacing.sm};
  background: ${s.w4.colors.surface};
...
`,u=n().div`
  flex: 1;
  min-height: 60px;
`;function w({data:e,t,onClick:a}){let i=(0,r.useMemo)(()=>(0,l.weightForecast)(e.weights,60,30),[e.weights]),n=i.history.length>0?i.history[i.history.length-1]:null,c=i.forecast.length>0?i.forecast[i.forecast.length-1]:null,y=n&&c?c.kg-n.kg:0;return(0,o.jsxs)(p,{onClick:a,"aria-label":t("forma.miniWeight.aria"),children:[(0,o.jsxs)(h,{children:[(0,o.jsxs)(m,{children:["◉ ",t("forma.miniWeight.title")]}),c&&(0,o.jsxs)(x,{pos:y>0,children:[y>=0?"+":"",y.toFixed(1),"kg / 30d"]})]}),(0,o.jsxs)(g,{children:[(0,o.jsx)(f,{children:n?n.kg.toFixed(1):"—"}),(0,o.jsx)("span",{style:{color:s.w4.colors.mainTextMuted,fontSize:13,fontFamily:s.w4.typography.fontFamilyMono},children:"kg"}),c&&(0,o.jsxs)("span",{style:{color:s.w4.colors.mainTextMuted,fontSize:12,fontFamily:s.w4.typography.fontFamilyMono},children:["→ ",c.kg.toFixed(1)," kg"]})]}),(0,o.jsx)(u,{children:(0,o.jsx)(d.h,{forecast:i,axes:!1})})]})}},86704(e,t,a){a.d(t,{g:()=>z});var o=a(65723),r=a(37991),i=a(36859),n=a.n(i),s=a(72799),l=a(6063),d=a(63236),c=a(26506);let p="#7fb77e",h=new Date().toISOString().slice(0,10),m=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,g=n().section`
  display: flex;
...
`,j=n().p`
  ...
  line-height: 1.5;
  margin: 0;
`;function z({t:e}){let{plan:t,dayNumber:a}=(0,c.useProgram)(),{data:i}=(0,c.useForma)(),n=(0,r.useMemo)(()=>i?new Set(i.checkIns.map(e=>e.date)):new Set,[i]);if(!t)return(0,o.jsxs)(M,{children:[(0,o.jsx)(d.In,{name:"calendar",size:24,color:l.w4.colors.mainTextMuted}),(0,o.jsx)(j,{children:e("forma.program.noProgram")})]});let s=t.days.filter(e=>{let a=T(t.startDate,e.day-1);return n.has(a)&&a<h}).length;return(0,o.jsxs)(g,{children:[(0,o.jsxs)(f,{children:[(0,o.jsx)(x,{children:e("forma.program.title")}),(0,o.jsxs)(u,{children:[s," / 30 ",e("forma.program.daysCompleted",{n:s})]})]}),(0,o.jsx)(w,{children:t.days.map(a=>{let r=T(t.startDate,a.day-1),i=r<h,s=r===h,l=n.has(r);return(0,o.jsxs)(y,{isToday:s,isPast:i,hasCheckIn:l,isRefeed:!0===a.refeed,children:[(0,o.jsx)(b,{isToday:s,children:a.day}),(0,o.jsxs)($,{children:[a.walkMin,"m"]}),a.refeed&&(0,o.jsx)(v,{title:e("forma.program.refeed")}),(0,o.jsx)(k,{done:l,children:l&&(0,o.jsx)("svg",{width:"8",height:"8",viewBox:"0 0 8 8",fill:"none",children:(0,o.jsx)("path",{d:"M1.5 4L3.5 6L6.5 2",stroke:"white",strokeWidth:"1.5",strokeLinecap:"round"})})})]},a.day)})})]})}function T(e,t){let a=new Date(e);return a.setDate(a.getDate()+t),a.toISOString().slice(0,10)}},68477(e,t,a){a.d(t,{P:()=>p});var o=a(65723),r=a(36859),i=a.n(r),n=a(6063);let s="#7fb77e",l=["16:8","18:6","20:4","custom"],d=i().div`
  display: flex;
  gap: ${n.w4.spacing.sm};
  overflow-x: auto;
...
`;function p({t:e,active:t,onChange:a}){return(0,o.jsx)(d,{role:"group","aria-label":e("forma.rail.title"),children:l.map(r=>(0,o.jsx)(c,{active:t===r,onClick:()=>a(r),"aria-pressed":t===r,children:e(`forma.protocol.${r}`)},r))})}},71589(e,t,a){a.d(t,{B:()=>g});var o=a(65723),r=a(36859),i=a.n(r),n=a(6063);let s="#7fb77e",l=[{id:"16:8",fastH:16,windowH:8},{id:"18:6",fastH:18,windowH:6},{id:"20:4",fastH:20,windowH:4},{id:"custom",fastH:0,windowH:0}],d=i().aside`
  width: 260px;
  flex-shrink: 0;
...
`,m=i().span`
  ...
  font-family: ${n.w4.typography.fontFamilyMono};
  color: ${n.w4.colors.mainTextMuted};
`;function g({t:e,active:t,onChange:a}){return(0,o.jsxs)(d,{"aria-label":e("forma.rail.title"),children:[(0,o.jsx)(c,{children:e("forma.rail.title")}),l.map(r=>(0,o.jsxs)(p,{active:t===r.id,onClick:()=>a(r.id),"aria-pressed":t===r.id,children:[(0,o.jsx)(h,{active:t===r.id,children:e(`forma.protocol.${r.id}`)}),r.fastH>0&&(0,o.jsxs)(m,{children:[e("forma.rail.hours",{n:r.fastH})," \xb7 ",e("forma.rail.window",{n:r.windowH})]})]},r.id))]})}},25405(e,t,a){a.d(t,{F:()=>p});var o=a(65723),r=a(37991),i=a(36859),n=a.n(i),s=a(6063);let l=n().form`
  display: flex;
  align-items: center;
  gap: ${s.w4.spacing.sm};
  padding: ${s.w4.spacing.sm} ${s.w4.spacing.md};
...
`,c=n().span`
  ...
  color: ${s.w4.colors.mainTextMuted};
  white-space: nowrap;
`;function p({t:e,onParsed:t}){let[a,i]=(0,r.useState)(""),[n,s]=(0,r.useState)(!1),h=(0,r.useCallback)(e=>{e.preventDefault();let o=function(e){let t=e.trim().toLowerCase();if(!t)return null;let a=t.match(/^(?:agua|água|water|bebi)\s+(\d+)/);if(a){let e=parseInt(a[1],10);if(!isNaN(e)&&e>0)return{kind:"water",waterMl:e}}let o=t.match(/^(?:peso|weight)\s+(\d+(?:[.,]\d+)?)/);if(o){let e=parseFloat(o[1].replace(",","."));if(!isNaN(e))return{kind:"weight",weightKg:e}}let r=t.match(/^(?:caminhei|walked|walk|caminhada)\s+(\d+)/);if(r){let e=parseInt(r[1],10);if(!isNaN(e))return{kind:"walk",walkMinutes:e}}let i=t.match(/^(?:jejum|fast)\s+(\d+)/);if(i){let e=parseInt(i[1],10);if(!isNaN(e))return{kind:"fast",fastHours:e,fastProtocol:16===e?"16:8":18===e?"18:6":20===e?"20:4":"custom"}}let n=t.match(/^(jantar|almoço|almoco|dinner|snack|lanche|lunch)\s+(.*)/);if(n){let e=n[1];return{kind:"meal",mealSlot:"jantar"===e||"dinner"===e?"dinner":"almo\xe7o"===e||"almoco"===e||"lunch"===e?"lunch":"snack",mealDesc:n[2].trim()}}return null}(a);if(!o){s(!0),setTimeout(()=>s(!1),1200);return}t(o),i("")},[a,t]);return(0,o.jsxs)(l,{onSubmit:h,children:[(0,o.jsx)(d,{value:a,onChange:e=>i(e.target.value),placeholder:e("forma.quickadd.placeholder"),style:{borderColor:n?"#f85149":void 0},"aria-label":e("forma.quickadd.hint")}),(0,o.jsx)(c,{children:e("forma.quickadd.hint")})]})}},20429(e,t,a){a.d(t,{f:()=>$});var o=a(65723),r=a(37991),i=a(36859),n=a.n(i),s=a(6063),l=a(63236),d=a(26506);let c="#7fb77e",p=n().section`
  display: flex;
  flex-direction: column;
  gap: ${s.w4.spacing.lg};
  max-width: 560px;
...
`,b=n().p`
  ...
  color: ${c};
  margin: 0;
`;function $({data:e,t,onSave:a}){let[i,n]=(0,r.useState)(String(e.goal.proteinG??110)),[s,c]=(0,r.useState)(String(e.goal.kcal??2200)),[v,k]=(0,r.useState)(String(e.goal.walkMin??30)),[M,j]=(0,r.useState)(String(e.goal.weightKg??"")),[z,T]=(0,r.useState)(String(e.goal.targetHours)),[S,F]=(0,r.useState)(String(e.goal.weeklyFasts)),[C,A]=(0,r.useState)(!1),[D,L]=(0,r.useState)(!1),{plan:R,dayNumber:H,startProgram:I,clearProgram:P}=(0,d.useProgram)(),B=(0,r.useCallback)(async()=>{let e=new Date().toISOString().slice(0,10);await I({...d.SEED_PLAN_TUNA_30,startDate:e})},[I]),E=(0,r.useCallback)(async()=>{L(!1),await P()},[P]),W=async()=>{let t={...e,goal:{targetHours:Number(z)||16,weeklyFasts:Number(S)||5,proteinG:Number(i)||void 0,kcal:Number(s)||void 0,walkMin:Number(v)||void 0,weightKg:M?Number(M):void 0}};await a(t),A(!0),setTimeout(()=>A(!1),2e3)};return(0,o.jsxs)(p,{children:[(0,o.jsxs)(h,{children:[(0,o.jsxs)(m,{children:["◉ ",t("forma.settings.foodGoals")]}),(0,o.jsxs)(g,{children:[(0,o.jsx)(f,{children:t("forma.settings.proteinG")}),(0,o.jsx)(x,{type:"number",value:i,onChange:e=>n(e.target.value)})]}),(0,o.jsxs)(g,{children:[(0,o.jsx)(f,{children:t("forma.settings.kcal")}),(0,o.jsx)(x,{type:"number",value:s,onChange:e=>c(e.target.value)})]}),(0,o.jsxs)(g,{children:[(0,o.jsx)(f,{children:t("forma.settings.walkMin")}),(0,o.jsx)(x,{type:"number",value:v,onChange:e=>k(e.target.value)})]}),(0,o.jsxs)(g,{children:[(0,o.jsx)(f,{children:t("forma.settings.weightTarget")}),(0,o.jsx)(x,{type:"number",step:"0.1",value:M,onChange:e=>j(e.target.value)})]})]}),(0,o.jsxs)(h,{children:[(0,o.jsxs)(m,{children:["◉ ",t("forma.settings.fastingGoals")]}),(0,o.jsxs)(g,{children:[(0,o.jsx)(f,{children:t("forma.settings.targetHours")}),(0,o.jsx)(x,{type:"number",value:z,onChange:e=>T(e.target.value)})]}),(0,o.jsxs)(g,{children:[(0,o.jsx)(f,{children:t("forma.settings.weeklyFasts")}),(0,o.jsx)(x,{type:"number",value:S,onChange:e=>F(e.target.value)})]})]}),(0,o.jsxs)(h,{children:[(0,o.jsx)(m,{children:t("forma.program.title")}),R?(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(b,{children:t("forma.program.active",{n:H??0})}),(0,o.jsx)(u,{style:{justifyContent:"flex-start"},children:(0,o.jsx)(l.$n,{variant:"danger",onClick:()=>L(!0),children:t("forma.program.clear")})})]}):(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(y,{children:t("forma.program.noProgram")}),(0,o.jsx)(u,{style:{justifyContent:"flex-start"},children:(0,o.jsx)(l.$n,{variant:"accent",onClick:()=>void B(),children:t("forma.program.start")})})]})]}),(0,o.jsxs)(u,{children:[C&&(0,o.jsx)(w,{children:t("forma.settings.saved")}),(0,o.jsx)(l.$n,{variant:"primary",onClick:()=>void W(),children:t("forma.settings.save")})]}),(0,o.jsx)(l.TM,{open:D,title:t("forma.program.confirmClear"),message:t("forma.program.confirmClearBody"),confirmLabel:t("forma.program.clear"),cancelLabel:t("forma.checkin.cancel"),onConfirm:()=>void E(),onCancel:()=>L(!1),danger:!0})]})}},22684(e,t,a){a.d(t,{q:()=>L});var o=a(65723),r=a(37991),i=a(36859),n=a.n(i),s=a(72799),l=a(6063),d=a(63236),c=a(26506);let p="#7fb77e",h="#facc15",m=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,g=n().section`
  background: ${l.w4.colors.surface};
...
`,D=n().p`
  ...
  line-height: 1.5;
  margin: 0;
`;function L({t:e,onOpenCheckIn:t,onOpenSettings:a}){let{plan:i,today:n,dayNumber:s}=(0,c.useProgram)(),{checkIn:p}=(0,c.useCheckIn)(),h=(0,r.useMemo)(()=>{if(!n)return"";let t=[`${n.oatsG}g`];return n.banana&&t.push(e("forma.program.breakfast.banana")),t.join(" + ")},[n,e]),m=(0,r.useMemo)(()=>n?e(n.dinnerKey):"",[n,e]);if(!i||null===n||null===s)return(0,o.jsxs)(C,{children:[(0,o.jsx)(w,{children:e("forma.program.title")}),(0,o.jsx)(A,{children:e("forma.program.startTitle")}),(0,o.jsx)(D,{children:e("forma.program.startBody")}),(0,o.jsx)("div",{children:(0,o.jsx)(d.$n,{variant:"primary",onClick:a,children:e("forma.program.start")})})]});let R=Array.from({length:30},(e,t)=>{let a=t+1;return a===s?"today":a<s?"past":"future"});return(0,o.jsxs)(g,{children:[(0,o.jsxs)(f,{children:[(0,o.jsx)(x,{children:s}),(0,o.jsxs)(u,{children:[(0,o.jsx)(w,{children:e("forma.program.dayOf",{n:30})}),(0,o.jsx)(y,{children:e("forma.program.title")}),n.refeed&&(0,o.jsx)(b,{children:e("forma.program.refeed")})]})]}),(0,o.jsx)($,{children:R.map((e,t)=>(0,o.jsx)(v,{state:e},t))}),(0,o.jsxs)(k,{children:[(0,o.jsxs)(M,{children:[(0,o.jsx)(j,{children:(0,o.jsx)(d.In,{name:"leaf",size:16})}),(0,o.jsx)(z,{children:e("forma.program.shake")}),(0,o.jsx)(T,{children:h})]}),(0,o.jsxs)(M,{children:[(0,o.jsx)(j,{children:(0,o.jsx)(d.In,{name:"utensils",size:16})}),(0,o.jsx)(z,{children:e("forma.program.dinner")}),(0,o.jsx)(T,{children:m})]}),(0,o.jsxs)(M,{children:[(0,o.jsx)(j,{children:(0,o.jsx)(d.In,{name:"heart",size:16})}),(0,o.jsx)(z,{children:e("forma.program.walkLabel")}),(0,o.jsx)(T,{children:e("forma.program.walk",{min:n.walkMin})})]})]}),(0,o.jsxs)(S,{children:[p?(0,o.jsxs)(F,{children:[(0,o.jsx)(d.In,{name:"check-circle",size:16}),e("forma.checkin.done")]}):(0,o.jsx)("span",{style:{fontSize:13,color:l.w4.colors.mainTextMuted},children:e("forma.checkin.prompt")}),(0,o.jsx)(d.$n,{variant:p?"ghost":"accent",onClick:t,children:p?e("forma.checkin.update"):e("forma.checkin.title")})]})]})}},19652(e,t,a){a.d(t,{_:()=>eo});var o=a(65723),r=a(37991),i=a(36859),n=a.n(i),s=a(6063),l=a(63236),d=a(26506);let c="#7fb77e",p="#58a6ff",h="#facc15",m="#22d3ee",g=84.5,f=68.5,x=52.5,u=36.5,w=n().div`
  display: flex;
  align-items: center;
  gap: ${s.w4.spacing.lg};
  flex-wrap: wrap;
...
`,j=n().dd`
  ...
  margin: 0;
  white-space: nowrap;
`;function z({radius:e,pct:t,color:a}){let r=2*Math.PI*e,i=Math.min(1,Math.max(0,t));return(0,o.jsxs)("g",{children:[(0,o.jsx)("circle",{cx:92,cy:92,r:e,fill:"none",stroke:a,strokeOpacity:.18,strokeWidth:11}),(0,o.jsx)("circle",{cx:92,cy:92,r:e,fill:"none",stroke:a,strokeWidth:11,strokeDasharray:r,strokeDashoffset:r*(1-i),strokeLinecap:"round",transform:"rotate(-90 92 92)",style:{transition:"stroke-dashoffset 0.6s ease"}})]})}function T(e){return .5>Math.abs(e)?"flat":e>0?"up":"down"}function S(e,t,a=0){if(.5>Math.abs(e))return"\xb7";let o=Math.abs(e);return`${e>0?"+":"−"}${o.toFixed(a)}${t}`}function F({t:e,fastPct:t,fastHours:a,fastTargetHours:r,protein:i,proteinTarget:n,proteinYesterday:l,kcal:d,kcalTarget:C,kcalYesterday:A,waterMl:D,waterTargetMl:L,waterYesterdayMl:R}){let H=C>0?d/C:0,I=d>C&&C>0,P=I?h:"#f59e0b",B=i-l,E=d-A,W=D-R;return(0,o.jsxs)(w,{children:[(0,o.jsx)(y,{children:(0,o.jsxs)("svg",{width:184,height:184,viewBox:"0 0 184 184","aria-hidden":"true",children:[(0,o.jsx)(z,{radius:g,pct:t,color:c}),(0,o.jsx)(z,{radius:f,pct:n>0?i/n:0,color:p}),(0,o.jsx)(z,{radius:x,pct:Math.min(1,H),color:P}),(0,o.jsx)(z,{radius:u,pct:L>0?D/L:0,color:m})]})}),(0,o.jsxs)(b,{children:[(0,o.jsxs)($,{children:[(0,o.jsx)(v,{color:c}),(0,o.jsx)(k,{children:e("forma.today.fast")}),(0,o.jsxs)(j,{children:[a>0?a.toFixed(1):"0",(0,o.jsxs)("span",{style:{color:s.w4.colors.mainTextMuted},children:[" / ",r,"h"]})]})]}),(0,o.jsxs)($,{children:[(0,o.jsx)(v,{color:p}),(0,o.jsxs)(k,{children:[e("forma.today.protein"),(0,o.jsx)(M,{tone:T(B),children:S(B,"g")})]}),(0,o.jsxs)(j,{children:[Math.round(i),(0,o.jsxs)("span",{style:{color:s.w4.colors.mainTextMuted},children:[" / ",n,"g"]})]})]}),(0,o.jsxs)($,{children:[(0,o.jsx)(v,{color:P}),(0,o.jsxs)(k,{children:[e(I?"forma.today.kcalOver":"forma.today.kcal"),(0,o.jsx)(M,{tone:T(-E),children:S(E,"")})]}),(0,o.jsxs)(j,{style:{color:I?h:void 0},children:[Math.round(d),(0,o.jsxs)("span",{style:{color:s.w4.colors.mainTextMuted},children:[" / ",C,"kcal"]})]})]}),(0,o.jsxs)($,{children:[(0,o.jsx)(v,{color:m}),(0,o.jsxs)(k,{children:[e("forma.today.water"),(0,o.jsx)(M,{tone:T(W),children:S(W,"ml")})]}),(0,o.jsxs)(j,{children:[D,(0,o.jsxs)("span",{style:{color:s.w4.colors.mainTextMuted},children:[" / ",L,"ml"]})]})]})]})]})}let C="#7fb77e",A=n().section`
  background: ${s.w4.colors.surface};
  border: 1px solid ${s.w4.colors.border};
  border-left: 2px solid ${C};
  border-radius: ${s.w4.borderRadius.lg};
...
`,ea=n().div`
  ...
  font-family: ${s.w4.typography.fontFamilyMono};
  font-variant-numeric: tabular-nums;
`;function eo({data:e,t,onLogMeal:a,onLogWalk:i,onLogWeight:n,onLogWater:c,onDeleteMeal:p,onEditMeal:h,onTapTemplate:m}){var g;let f=new Date().toISOString().slice(0,10),x=new Date(Date.now()-864e5).toISOString().slice(0,10),u=(0,d.proteinByDay)(e.meals,f),w=(0,d.proteinByDay)(e.meals,x),y=(0,d.kcalByDay)(e.meals,f),b=(0,d.kcalByDay)(e.meals,x),$=(0,d.kcalTargetForDate)(e,f),v=(g=e.walks,g.filter(e=>e.date===f).reduce((e,t)=>e+t.minutes,0)),k=(0,d.waterByDay)(e.water??[],f),M=(0,d.waterByDay)(e.water??[],x),j=e.goal.waterMl??2e3,z=e.meals.filter(e=>e.date===f).sort((e,t)=>e.createdAt-t.createdAt),T=e.goal.proteinG??110,S=(0,d.currentFast)(e),C=e.goal.targetHours??16,er=S?.percent??0,ei=S?.hoursElapsed??0,en=(0,d.streakDays)(e.sessions,C),es=new Date().getDay(),el=new Set(z.map(e=>e.templateId).filter(e=>!!e)),ed=e.templates.filter(e=>e.weekday===es&&!el.has(e.id)).sort((e,t)=>("lunch"===e.slot?-1:1)-("lunch"===t.slot?-1:1)),[ec,ep]=(0,r.useState)(!1),[eh,em]=(0,r.useState)(""),eg=(0,r.useCallback)(()=>{let e=parseInt(eh,10);!isNaN(e)&&e>0&&(c(e),em(""),ep(!1))},[eh,c]);return(0,o.jsxs)(A,{children:[(0,o.jsxs)(D,{children:[(0,o.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:s.w4.spacing.sm,flexWrap:"wrap"},children:[(0,o.jsxs)(L,{children:["◉ ",t("forma.today.title")]}),(0,o.jsxs)(R,{active:en>0,title:en>0?t("forma.streak",{n:en}):t("forma.streak.none"),children:[(0,o.jsx)("span",{"aria-hidden":"true",children:en>0?"\uD83D\uDD25":"\xb7"}),(0,o.jsx)(H,{children:en}),(0,o.jsx)("span",{children:t("forma.today.streakShort")})]})]}),(0,o.jsx)(L,{children:new Date().toLocaleDateString(void 0,{weekday:"long",day:"numeric",month:"short"})})]}),(0,o.jsx)(F,{t:t,fastPct:er,fastHours:ei,fastTargetHours:C,protein:u,proteinTarget:T,proteinYesterday:w,kcal:y,kcalTarget:$,kcalYesterday:b,waterMl:k,waterTargetMl:j,waterYesterdayMl:M}),(0,o.jsxs)(G,{children:[(0,o.jsx)(l.$n,{variant:"primary",icon:(0,o.jsx)(l.In,{name:"plus",size:14}),onClick:a,children:t("forma.action.logMeal")}),(0,o.jsx)(l.$n,{variant:"ghost",icon:(0,o.jsx)(l.In,{name:"plus",size:14}),onClick:i,children:t("forma.action.logWalk")}),(0,o.jsx)(l.$n,{variant:"ghost",icon:(0,o.jsx)(l.In,{name:"plus",size:14}),onClick:n,children:t("forma.action.logWeight")})]}),(0,o.jsx)(K,{children:ec?(0,o.jsxs)("div",{style:{display:"flex",gap:s.w4.spacing.xs},children:[(0,o.jsx)("input",{type:"number",min:1,placeholder:"ml",value:eh,onChange:e=>em(e.target.value),onKeyDown:e=>{"Enter"===e.key&&eg()},style:{flex:1,height:44,background:s.w4.colors.surface,border:`1px solid ${s.w4.colors.border}`,borderRadius:s.w4.borderRadius.md,color:s.w4.colors.mainText,fontSize:13,fontFamily:s.w4.typography.fontFamilyMono,padding:`0 ${s.w4.spacing.sm}`},autoFocus:!0}),(0,o.jsx)(l.$n,{variant:"accent",onClick:eg,children:t("forma.sheet.save")}),(0,o.jsx)(l.$n,{variant:"ghost",onClick:()=>ep(!1),children:t("forma.sheet.cancel")})]}):(0,o.jsxs)(V,{children:[(0,o.jsx)(q,{onClick:()=>c(250),children:t("forma.water.add250")}),(0,o.jsx)(q,{onClick:()=>c(500),children:t("forma.water.add500")}),(0,o.jsx)(q,{onClick:()=>c(1e3),children:t("forma.water.add1000")}),(0,o.jsx)(q,{onClick:()=>ep(!0),children:t("forma.water.addCustom")})]})}),m&&ed.length>0&&(0,o.jsxs)(I,{children:[(0,o.jsx)(L,{children:t("forma.today.tapToLog")}),(0,o.jsx)(P,{children:ed.map(e=>(0,o.jsxs)(B,{onClick:()=>m(e),title:t("forma.today.tapToLog"),children:[(0,o.jsx)(E,{children:(0,l.n6)(e.icon)?(0,o.jsx)(l.In,{name:e.icon,size:14}):(0,o.jsx)("span",{children:e.icon})}),(0,o.jsxs)(W,{children:[(0,o.jsx)(N,{children:t(e.nameKey)}),(0,o.jsxs)(O,{children:[e.proteinG,"g \xb7 ",e.kcal,"kcal"]})]}),(0,o.jsx)(Y,{children:t(`forma.meal.${e.slot}`)})]},e.id))})]}),0===z.length?(0,o.jsx)(et,{children:t("forma.today.noMealsYet")}):(0,o.jsx)(_,{children:z.map(e=>(0,o.jsxs)(J,{onClick:h?()=>h(e.id):void 0,style:{cursor:h?"pointer":"default"},title:h?t("forma.action.edit"):void 0,children:[(0,o.jsx)(Q,{tone:"lunch"===e.slot?"#58a6ff":"dinner"===e.slot?"#f59e0b":"#a371f7",title:t(`forma.meal.${e.slot}`),"aria-label":t(`forma.meal.${e.slot}`),children:(0,o.jsx)(l.In,{name:"lunch"===e.slot?"utensils":"dinner"===e.slot?"flame":"apple",size:12})}),(0,o.jsx)(U,{children:new Date(e.createdAt).toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit"})}),(0,o.jsx)(X,{children:e.notes||"—"}),(0,o.jsxs)(Z,{children:[e.proteinG??0,"g \xb7 ",e.kcal??0,"kcal"]}),(0,o.jsx)(ee,{onClick:t=>{t.stopPropagation(),p(e.id)},"aria-label":t("forma.action.delete"),children:(0,o.jsx)(l.In,{name:"trash",size:14})})]},e.id))}),v>0&&(0,o.jsx)(ea,{children:(0,o.jsx)("span",{children:t("forma.today.walkSummary",{min:v})})})]})}},20483(e,t,a){a.d(t,{v:()=>v});var o=a(65723),r=a(36859),i=a.n(r),n=a(72799),s=a(6063),l=a(63236);let d="#7fb77e",c=(0,n.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
...
`,$=i().div`
  ...
  border-radius: 50%;
  background: ${s.w4.colors.border};
`;function v({data:e,t,locale:a,onTapTemplate:r}){let i,n,s,d=(n=new Date(i=new Date),s=(i.getDay()+6)%7,n.setDate(i.getDate()-s),n.setHours(0,0,0,0),Array.from({length:7},(e,t)=>{let a=new Date(n);return a.setDate(n.getDate()+t),{date:m(a),weekday:a.getDay()}})),c=m(new Date),k="pt"===a?h:p,M=new Map;for(let t of e.templates)M.set(t.weekday,t);return(0,o.jsxs)(g,{children:[(0,o.jsx)(f,{children:t("forma.week.title")}),(0,o.jsx)(x,{children:d.map(({date:a,weekday:i})=>{let n=a===c,s=e.meals.some(e=>e.date===a),d=e.sessions.some(e=>void 0!==e.endedAt&&m(new Date(e.startedAt))===a),p=s||d,h=M.get(i),g=n&&void 0!==h&&void 0!==r&&!s;return(0,o.jsxs)(u,{isToday:n,isDone:p,tappable:g,onClick:()=>{g&&h&&r?.(h)},type:"button",title:g?t("forma.week.tapToLog"):void 0,"aria-label":g?t("forma.week.tapToLog"):void 0,children:[(0,o.jsx)(w,{isToday:n,children:k[i]}),p?(0,o.jsx)(b,{"aria-label":t("forma.week.done"),children:(0,o.jsx)(l.In,{name:"check-circle",size:14})}):h?(0,o.jsx)($,{title:t("forma.week.planned")}):null,h&&(0,o.jsx)(y,{children:t(h.nameKey)})]},a)})})]})}},11533(e,t,a){a.d(t,{h:()=>h});var o=a(65723),r=a(37991),i=a(36859),n=a.n(i),s=a(6063);let l="#7fb77e",d=n().div`
  position: relative;
  width: 100%;
  height: 100%;
  min-height: 140px;
...
`;function h({forecast:e,axes:t=!0}){let a=(0,r.useMemo)(()=>[...e.history,...e.forecast],[e.history,e.forecast]);if(a.length<2)return(0,o.jsx)(d,{children:(0,o.jsx)("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",height:"100%",color:s.w4.colors.mainTextMuted,fontSize:12,fontFamily:s.w4.typography.fontFamilyMono},children:"—"})});let i=t?36:8,n=t?18:4,m=a.map(e=>e.kg),g=Math.min(...m),f=Math.max(...m),x=f-g||1,u=new Date(a[0].date).getTime(),w=new Date(a[a.length-1].date).getTime()-u||1,y=e=>i+(new Date(e).getTime()-u)/w*(600-2*i),b=e=>200-n-(e-g)/x*(200-2*n),$=e.history.map((e,t)=>`${0===t?"M":"L"} ${y(e.date).toFixed(1)} ${b(e.kg).toFixed(1)}`).join(" "),v=e.forecast.length?`M ${y(e.history[e.history.length-1].date).toFixed(1)} ${b(e.history[e.history.length-1].kg).toFixed(1)} `+e.forecast.map(e=>`L ${y(e.date).toFixed(1)} ${b(e.kg).toFixed(1)}`).join(" "):"",k=e.history[e.history.length-1],M=e.forecast[e.forecast.length-1];return(0,o.jsx)(d,{children:(0,o.jsxs)(c,{viewBox:"0 0 600 200",preserveAspectRatio:"none",children:[t&&(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(p,{x:4,y:n+4,children:f.toFixed(1)}),(0,o.jsx)(p,{x:4,y:200-n+4,children:g.toFixed(1)}),(0,o.jsx)("line",{x1:i,y1:200-n,x2:600-i,y2:200-n,stroke:s.w4.colors.border,strokeWidth:1}),(0,o.jsx)("line",{x1:i,y1:n,x2:i,y2:200-n,stroke:s.w4.colors.border,strokeWidth:1})]}),(0,o.jsx)("path",{d:$,fill:"none",stroke:l,strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"}),v&&(0,o.jsx)("path",{d:v,fill:"none",stroke:l,strokeWidth:2,strokeDasharray:"4 4",strokeLinecap:"round",opacity:.65}),M&&(0,o.jsx)("circle",{cx:y(M.date),cy:b(M.kg),r:3,fill:l,opacity:.7}),k&&(0,o.jsx)("circle",{cx:y(k.date),cy:b(k.kg),r:4,fill:l,stroke:s.w4.colors.surface,strokeWidth:1.5})]})})}},92152(e,t,a){a.d(t,{m:()=>M});var o=a(65723),r=a(37991),i=a(36859),n=a.n(i),s=a(6063),l=a(63236),d=a(26506),c=a(11533);let p="#7fb77e",h=n().section`
  display: flex;
  flex-direction: column;
  gap: ${s.w4.spacing.lg};
`,m=n().div`
...
`,w=i().forwardRef(function({variant:e="ghost",size:t="md",icon:a,iconRight:r,children:i,...n},s){return(0,o.jsxs)(u,{ref:s,variant:e,size:t,...n,children:[a,i,r]})}),y={default:l.w4.colors.accent,danger:"#f85149"},b={default:l.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"};s().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`,R=s().span`
  ...
  background: ${({color:e})=>e};
  display: inline-block;
`,H=i().forwardRef(function({variant:e="default",dotColor:t,children:a,onClick:r,...i},n){return(0,o.jsxs)(L,{ref:n,variant:e,clickable:!!r,onClick:r,type:i.type??"button",...i,children:[t&&(0,o.jsx)(R,{color:t}),a]})}),I={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:l.w4.colors.accentMuted},P={neutral:l.w4.colors.mainTextMuted,live:l.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:l.w4.colors.accent},B=s().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${l.w4.typography.fontFamilyMono};
...
`,E=s().span`
  ...
  display: inline-block;
`;function W({tone:e="neutral",dot:t,children:a,...r}){return(0,o.jsxs)(B,{tone:e,...r,children:[(t??"live"===e)&&(0,o.jsx)(E,{}),a]})}s().kbd`
  font-family: ${l.w4.typography.fontFamilyMono};
  font-size: 10px;
  padding: 2px 6px;
  border: 1px solid ${l.w4.colors.border};
...
`;function J({title:e,accessory:t,accentColor:a,error:r,errorLabel:i,children:n}){return(0,o.jsxs)(Y,{accentColor:a,"data-widget-shell":!0,children:[(0,o.jsxs)(G,{children:[(0,o.jsx)(O,{children:e}),t&&(0,o.jsx)(K,{children:t})]}),r?(0,o.jsxs)(q,{role:"alert",children:[(0,o.jsx)(_,{children:i??"Error"}),(0,o.jsx)("div",{children:r})]}):(0,o.jsx)(V,{children:n})]})}s().div`
  position: relative;
  display: flex;
  flex-direction: column;
  height: 100%;
...
`;function eN({type:e,children:t}){let a=eP[e]??eP.NOTE;return(0,o.jsxs)(eB,{bg:a.bg,border:a.border,children:[(0,o.jsxs)(eE,{color:a.color,children:[(0,o.jsx)(M,{name:a.icon,size:15,strokeWidth:2}),a.label]}),(0,o.jsx)(eW,{children:t})]})}s().nav`
  width: 220px;
  min-width: 220px;
...
`;function eV({children:e}){return(0,o.jsx)(eK,{children:(0,o.jsx)(X.oz,{remarkPlugins:[Z.A,ee.A,eG],rehypePlugins:[et.A,ea.A],components:{div({node:e,children:t,...a}){let r=a["data-callout"];return r?(0,o.jsx)(eN,{type:r,children:t}):(0,o.jsx)("div",{...a,children:t})},pre:({children:e})=>(0,o.jsx)(o.Fragment,{children:e}),code({className:e,children:t}){let a=/language-(\w+)/.exec(e??"")?.[1],r=String(t).replace(/\n$/,"");return r.trim()?"mermaid"===a?(0,o.jsx)(em,{code:r}):"chart"===a?(0,o.jsx)(ez,{code:r}):a||r.includes("\n")?(0,o.jsx)(eI,{lang:a,code:r}):(0,o.jsx)("code",{className:e,children:t}):null}},children:e})})}var eq=a(37993);s().nav`
  display: flex;
  flex-direction: column;
  gap: 1px;
  padding: ${l.w4.spacing.sm} 0;
...
`,e5=s().button`
  ...
  &:hover { opacity: 0.88; }
  &:focus-visible { ${l.w4.focusRing} }
`;function e3({open:e,title:t,message:a,confirmLabel:i,cancelLabel:n,onConfirm:s,onCancel:l,danger:d=!1}){return((0,r.useEffect)(()=>{if(!e)return;let t=e=>{"Escape"===e.key&&l(),"Enter"===e.key&&s()};return document.addEventListener("keydown",t),()=>document.removeEventListener("keydown",t)},[e,l,s]),e)?(0,o.jsx)(eZ,{onClick:l,role:"dialog","aria-modal":"true","aria-label":t,children:(0,o.jsxs)(e0,{danger:d,onClick:e=>e.stopPropagation(),children:[(0,o.jsx)(e1,{danger:d,children:t}),(0,o.jsx)(e4,{children:a}),(0,o.jsxs)(e2,{children:[(0,o.jsx)(e5,{onClick:l,children:n}),(0,o.jsx)(e5,{danger:d,primary:!d,onClick:s,autoFocus:!0,children:i})]})]})}):null}let e6=(0,$.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,e8=(0,$.keyframes)`
...
`,tg=s().main`
  ...
  display: flex;
  flex-direction: column;
`,tf=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function tx(){return(0,o.jsx)(tn,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:tf.map((e,t)=>(0,o.jsx)(ts,{index:t,accent:e.accent,children:e.char},t))})}let tu="atlantis:sidebar-collapsed";function tw({sidebar:e,children:t,topBarRight:n,title:s="Atlantis",activeId:l=null}){let[d,c]=(0,r.useState)(()=>{try{return"true"===localStorage.getItem(tu)}catch{return!1}}),[p,h]=(0,r.useState)(null),m=(0,r.useRef)(),g=()=>c(e=>{let t=!e;try{localStorage.setItem(tu,String(t))}catch{}return t}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(a.bind(a,45816)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,o.jsx)(eq.I.Provider,{value:{collapsed:d,toggle:g,flyout:p,openFlyout:(e,t,a)=>{clearTimeout(m.current),h({entry:e,anchorY:t,onSelect:a})},scheduleFlyoutClose:()=>{m.current=setTimeout(()=>h(null),160)},cancelFlyoutClose:()=>clearTimeout(m.current)},children:(0,o.jsxs)(tp,{children:[(0,o.jsxs)(ta,{children:[e&&(0,o.jsx)(to,{children:(0,o.jsx)(tr,{onClick:g,title:d?"Expand sidebar":"Collapse sidebar",children:(0,o.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,o.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,o.jsx)("path",{d:"M9 3v18"})]})})}),(0,o.jsx)(tx,{}),s&&(0,o.jsx)(tl,{children:s}),n&&(0,o.jsx)(td,{children:n})]}),(0,o.jsxs)(tc,{children:[null!=e&&(0,o.jsx)(th,{collapsed:d,children:(0,o.jsx)(tm,{children:e})}),(0,o.jsx)(tg,{children:t})]}),p&&(0,o.jsx)(i().Suspense,{fallback:null,children:(0,o.jsx)(f,{activeId:l})})]})})}s().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
...
`,s().div`
  flex: 1;
`;let ty={"1m":30,"3m":90,"6m":180,"1y":365};function tb(e,t,a){let o=new Date(a??new Date);return o.setDate(o.getDate()-(t-1-e)),o.toISOString().slice(0,10)}let t$=["#1a2420","#2a4535","#4a7a5a","#6fa77a","#7fb77e"],tv="'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, monospace",tk=["S","T","Q","Q","S","S","D"],tM=["S","M","T","W","T","F","S"];function tj({data:e,cellSize:t=10,gap:a=2,locale:i="pt",tooltip:n,showMonthLabels:s=!1,accent:d,selectedIndex:c,onCellClick:p}){let h=(0,r.useId)();if(!e.length)return null;let m=!!p,g=d??l.w4.colors.accent,f=Math.ceil(e.length/7),x=14*!!s,u=24+f*(t+a),w=x+14+7*(t+a),y=[];if(s&&e.length>0){let o=new Date,r=-1;for(let n=0;n<e.length;n++){let s=Math.floor(n/7);if(0!=n%7)continue;let l=new Date(tb(n,e.length,o)),d=l.getMonth();if(d!==r){r=d;let e=new Intl.DateTimeFormat("pt"===i?"pt-PT":"en-US",{month:"short"}).format(l),o=18+s*(t+a);y.push({label:e.charAt(0).toUpperCase()+e.slice(1),x:o})}}}let b=x+2;return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)("style",{children:`
        @keyframes ${h}_fade { from { opacity: 0; } to { opacity: 1; } }
      `}),(0,o.jsxs)("svg",{viewBox:`0 0 ${u} ${w}`,preserveAspectRatio:"xMidYMid meet",style:{width:"100%",height:"auto",maxHeight:220,display:"block"},"aria-hidden":m?void 0:"true",role:m?"grid":void 0,"aria-label":void 0,children:[s&&(0,o.jsx)("g",{fontFamily:tv,fontSize:"8",fill:l.w4.colors.mainTextMuted,children:y.map(({label:e,x:t},a)=>(0,o.jsx)("text",{x:t,y:10,children:e},a))}),(0,o.jsx)("g",{fontFamily:tv,fontSize:"8",fill:l.w4.colors.mainTextMuted,children:("pt"===i?tk:tM).map((e,r)=>(0,o.jsx)("text",{x:"0",y:b+8+r*(t+a),children:e},r))}),e.map((e,r)=>{let i=18+Math.floor(r/7)*(t+a),s=b+r%7*(t+a),l=t$[Math.max(0,Math.min(4,e))]??t$[0],d=n?.(r,e),f=c===r;return m?(0,o.jsx)("rect",{x:i,y:s,width:t,height:t,fill:l,rx:"1",stroke:f?g:"none",strokeWidth:1.5*!!f,role:"button",tabIndex:0,style:{animation:`${h}_fade 0.3s ease-out ${8*r}ms both`,cursor:"pointer",outline:"none"},onClick:()=>p?.(r,e),onKeyDown:t=>{("Enter"===t.key||" "===t.key)&&(t.preventDefault(),p?.(r,e))},children:d?(0,o.jsx)("title",{children:d}):null},r):(0,o.jsx)("rect",{x:i,y:s,width:t,height:t,fill:l,rx:"1",stroke:f?g:"none",strokeWidth:1.5*!!f,style:{animation:`${h}_fade 0.3s ease-out ${8*r}ms both`},children:d?(0,o.jsx)("title",{children:d}):null},r)})]})]})}let tz=["1m","3m","6m","1y"];function tT({range:e,onChange:t,labels:a}){return(0,o.jsx)("div",{style:{display:"flex",gap:4,flexWrap:"wrap"},children:tz.map(r=>{let i=r===e,n=a?.[r]??r;return(0,o.jsx)("button",{onClick:()=>t(r),style:{height:28,padding:"0 10px",fontSize:11,fontFamily:tv,fontWeight:600,textTransform:"uppercase",letterSpacing:"0.1em",borderRadius:4,border:`1px solid ${i?l.w4.colors.accent:l.w4.colors.border}`,background:i?`${l.w4.colors.accent}18`:"transparent",color:i?l.w4.colors.accent:l.w4.colors.mainTextMuted,cursor:"pointer",transition:"border-color 0.14s ease, color 0.14s ease, background 0.14s ease",outline:"none"},onFocus:e=>{e.currentTarget.style.outline=`2px solid ${l.w4.colors.accent}`,e.currentTarget.style.outlineOffset="2px"},onBlur:e=>{e.currentTarget.style.outline="none"},"aria-pressed":i,children:n},r)})})}},9391(e,t,a){a.d(t,{O:()=>n});var o=a(65723);a(37991);var r=a(63236);let i={sm:20,md:24,lg:28};function n({member:e,size:t="md"}){let a="number"==typeof t?t:i[t];return(0,o.jsx)(r.eu,{member:e,size:a})}},85043(e,t,a){a.d(t,{Y:()=>p});var o=a(65723),r=a(36859),i=a.n(r),n=a(6063);let s=i().div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
`,d().span`
  ...
  flex-shrink: 0;
  text-align: right;
`,a(83090);let c="'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, monospace";function p({data:e,budget:t,height:a=200,animation:o="rise"}){let s=(0,i.useId)();if(!e.length)return null;let l=1.1*Math.max(...e.map(e=>e.segments.reduce((e,t)=>e+t.value,0)+(e.over??0)),t??0)||1,d=472,h=a-20-24,m=472/e.length*.58,g=d/e.length,f="rise"===o?{transformOrigin:"bottom",animation:`${s}_rise 0.45s ease-out both`}:{};return(0,r.jsxs)(r.Fragment,{children:["rise"===o&&(0,r.jsx)("style",{children:`
          @keyframes ${s}_rise {
            from { transform: scaleY(0); }
            to   { transform: scaleY(1); }
          }
        `}),(0,r.jsxs)("svg",{viewBox:`0 0 520 ${a}`,style:{width:"100%",height:a},preserveAspectRatio:"xMidYMid meet","aria-hidden":"true",children:[null!=t?(0,r.jsxs)("g",{children:[(0,r.jsx)("line",{x1:40,x2:40+d,y1:20+h-t/l*h,y2:20+h-t/l*h,stroke:n.w4.colors.border,strokeDasharray:"3 3",strokeWidth:"1"}),(0,r.jsxs)("text",{x:36,y:20+h-t/l*h+3,textAnchor:"end",fontFamily:c,fontSize:"9",fill:n.w4.colors.mainTextMuted,children:["€",t]})]}):null,e.map((e,t)=>{let o,i=40+t*g+(g-m)/2,s=20+h;return(0,r.jsxs)("g",{style:f,children:[e.segments.map(e=>{let t=e.value/l*h;return s-=t,(0,r.jsx)("rect",{x:i,y:s,width:m,height:t,fill:e.color,opacity:.85},e.id)}),null!=e.over&&e.over>0?(o=e.over/l*h,s-=o,(0,r.jsx)("rect",{x:i,y:s,width:m,height:o,fill:"#f85149",opacity:.7},"over")):null,(0,r.jsx)("text",{x:i+m/2,y:a-6,textAnchor:"middle",fontFamily:c,fontSize:"10",fill:n.w4.colors.mainTextMuted,children:e.label})]},e.label)})]})]})}var h=a(63236);function m(e){let t=0;for(let a=1;a<e.length;a++){let o=e[a][0]-e[a-1][0],r=e[a][1]-e[a-1][1];t+=Math.sqrt(o*o+r*r)}return t}function g({spent:e,budget:t,height:a=60}){let o=(0,i.useId)(),s=1.05*t||1,l=Array.from({length:8},(e,a)=>t-t/7*a),d=Math.min(e/(t||1),1),c=Array.from({length:8},(e,a)=>Math.max(0,t-a/7*t*d*1.1)),p=l.map((e,t)=>[320*t/7,a-e/s*(a-5)]),h=c.map((e,t)=>[320*t/7,a-e/s*(a-5)]),f=p.map(e=>e.join(",")).join(" "),x=h.map(e=>e.join(",")).join(" "),u=m(p).toFixed(1),w=m(h).toFixed(1);return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)("style",{children:`
        @keyframes ${o}_i { from { stroke-dashoffset: ${u}; } }
        @keyframes ${o}_a { from { stroke-dashoffset: ${w}; } }
      `}),(0,r.jsxs)("svg",{viewBox:`0 0 320 ${a}`,style:{width:"100%",height:a},preserveAspectRatio:"none","aria-hidden":"true",children:[(0,r.jsx)("line",{x1:"0",x2:320,y1:a-5,y2:a-5,stroke:n.w4.colors.border,strokeDasharray:"3 3",strokeWidth:"1"}),(0,r.jsx)("polyline",{points:f,stroke:n.w4.colors.mainTextMuted,strokeWidth:"1",strokeDasharray:`${u} ${u}`,strokeDashoffset:"0",fill:"none",style:{strokeDasharray:"2 3",animation:`${o}_i 0.45s ease-out both`}}),(0,r.jsx)("polyline",{points:x,stroke:"#7fb77e",strokeWidth:"1.5",strokeDasharray:`${w} ${w}`,strokeDashoffset:"0",fill:"none",strokeLinecap:"round",style:{animation:`${o}_a 0.45s ease-out 0.08s both`}})]})]})}d().div`
  position: relative;
  height: 6px;
