...
`,h=n().div`
  position: relative;
`;function f({onSelect:e}){let[o,a]=(0,r.useState)(!1),i=(0,r.useRef)(null);return(0,r.useEffect)(()=>{if(!o)return;let e=e=>{i.current&&!i.current.contains(e.target)&&a(!1)};return document.addEventListener("mousedown",e),()=>document.removeEventListener("mousedown",e)},[o]),(0,t.jsxs)(h,{ref:i,children:[(0,t.jsxs)(c,{onClick:()=>a(e=>!e),children:[(0,t.jsx)(s.In,{name:"book-open",size:14}),"Examples",(0,t.jsx)(s.In,{name:"chevron-down",size:13,style:{marginLeft:2}})]}),(0,t.jsxs)(p,{open:o,children:[(0,t.jsx)(g,{children:"Load a diagram"}),d.map(o=>(0,t.jsx)(m,{onClick:()=>{e(o.code),a(!1)},children:o.label},o.label))]})]})}},65320(e,o,a){a.d(o,{u:()=>w});var t=a(65723),r=a(37991),i=a(36859),n=a.n(i),l=a(94764),s=a(42907),d=a(29738);d.A.initialize({startOnLoad:!1,theme:"dark",securityLevel:"loose"});let c=`
...
`,b=n().span`
  ...
  font-family: ${l.w4.typography.fontFamily};
  writing-mode: vertical-rl;
`;function w({code:e,collapsed:o,onToggleCollapse:a}){let[i,n]=(0,r.useState)(""),[l,c]=(0,r.useState)(null),y=(0,r.useRef)(0),$=(0,r.useCallback)(async e=>{if(!e.trim()){n(""),c(null);return}let o=++y.current;try{let a="mermaid-"+Date.now(),{svg:t}=await d.A.render(a,e);y.current===o&&(n(t),c(null))}catch(e){y.current===o&&(c(e instanceof Error?e.message:String(e)),n(""))}},[]);return((0,r.useEffect)(()=>{let o=setTimeout(()=>$(e),300);return()=>clearTimeout(o)},[e,$]),o)?(0,t.jsxs)(u,{onClick:a,title:"Show preview",children:[(0,t.jsx)(s.In,{name:"panel-right-open",size:14}),(0,t.jsx)(b,{children:"Preview"})]}):(0,t.jsxs)(p,{children:[(0,t.jsxs)(g,{children:[(0,t.jsx)(m,{children:"Preview"}),(0,t.jsx)(h,{onClick:a,title:"Collapse preview",children:(0,t.jsx)(s.In,{name:"panel-right-close",size:15})})]}),l&&(0,t.jsxs)(x,{children:[(0,t.jsx)(s.In,{name:"alert-circle",size:14,style:{flexShrink:0,marginTop:1}}),l]}),(0,t.jsx)(f,{dangerouslySetInnerHTML:{__html:i}})]})}},2099(e,o,a){a.d(o,{r:()=>z});var t=a(65723);a(37991);var r=a(11352),i=a(76710),n=a(4311),l=a(73639),s=a(8411);a(75406);var d=a(36859),c=a.n(d),p=a(94764),g=a(42907),m=a(49685);function h(){return e=>{!function e(o){if("blockquote"===o.type){let e=o.children?.[0];if(e?.type==="paragraph"){let a=e.children?.[0];if(a?.type==="text"){let t=a.value?.match(/^\[!(NOTE|TIP|WARNING|CAUTION|IMPORTANT)\]\s*/i);t&&(a.value=a.value.slice(t[0].length),a.value.trim()||1!==e.children.length||o.children.shift(),o.data=o.data??{},o.data.hName="div",o.data.hProperties={"data-callout":t[1].toUpperCase()})}}}o.children?.forEach(e)}(e)}}let f=c().div`
  display: flex;
  flex-direction: column;
  flex: 1;
  min-width: 0;
...
`;var d=a(72799);let c="https://cdn.jsdelivr.net/npm/mermaid@11.14.0/dist/mermaid.min.js",p=null,g="#7fb77e",m=(0,d.keyframes)`
