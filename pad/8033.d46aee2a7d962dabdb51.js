"use strict";(self.webpackChunk_atlantis_pad=self.webpackChunk_atlantis_pad||[]).push([[8033],{9752(e,o,a){a.d(o,{MX:()=>z,sc:()=>P,NG:()=>U,t:()=>p});var t=a(27359),r=a(59200),n=a(53233),i=a(65723);n.default.nav`padding: ${r.w4.spacing.sm} 0;`,n.default.div`
...
`,_=n.default.div`
  ...
  color: ${t.w4.colors.sidebarTextMuted};
  font-family: ${t.w4.typography.fontFamily};
`;function q({onSave:e,onUpdate:o,onCancel:a,existingDoc:t}){const[n,l]=(0,r.useState)(t?.name??""),s=(0,r.useRef)(null);return(0,r.useEffect)(()=>{s.current?.focus(),t&&s.current?.select()},[t]),(0,i.jsx)(K,{onClick:a,children:(0,i.jsxs)(G,{onClick:e=>e.stopPropagation(),children:[(0,i.jsx)(Y,{children:"Save document"}),t&&o&&(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(_,{children:"Update the current version or save as a new one."}),(0,i.jsxs)(O,{children:[(0,i.jsx)(V,{onClick:a,children:"Cancel"}),(0,i.jsxs)(V,{danger:!0,onClick:o,children:['Update "',t.name,'"']})]}),(0,i.jsx)(U,{})]}),(0,i.jsx)(W,{ref:s,value:n,onChange:e=>l(e.target.value),onKeyDown:r=>{"Enter"===r.key&&n.trim()&&(t&&n.trim()===t.name&&o?o():e(n.trim())),"Escape"===r.key&&a()},placeholder:t?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,i.jsxs)(O,{children:[!t&&(0,i.jsx)(V,{onClick:a,children:"Cancel"}),(0,i.jsx)(V,{primary:!0,disabled:!n.trim(),onClick:()=>e(n.trim()),children:"Save as new"})]})]})})}var J=a(18006),X=a(70679),Z=a(54872);const Q=n.default.div`
  position: relative;
`,ee=n.default.button`
  display: flex;
  align-items: center;
