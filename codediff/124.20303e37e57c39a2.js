"use strict";(self.webpackChunk_atlantis_codediff=self.webpackChunk_atlantis_codediff||[]).push([["124"],{1315(o,e,a){function t(o,e){let a=o.split("\n"),t=e.split("\n");if(a.length>2e3||t.length>2e3){var r=a,i=t;let o=[],e=Math.max(r.length,i.length);for(let a=0;a<e;a++)a>=r.length?o.push({type:"insert",oldLine:null,newLine:i[a],oldNum:null,newNum:a+1}):a>=i.length?o.push({type:"delete",oldLine:r[a],newLine:null,oldNum:a+1,newNum:null}):r[a]===i[a]?o.push({type:"equal",oldLine:r[a],newLine:i[a],oldNum:a+1,newNum:a+1}):o.push({type:"replace",oldLine:r[a],newLine:i[a],oldNum:a+1,newNum:a+1});return o}let n=function o(e,a,t,r,i){return 0===r&&0===i?[]:r>0&&i>0&&a[r-1]===t[i-1]?[...o(e,a,t,r-1,i-1),{type:"equal",oldLine:a[r-1],newLine:t[i-1],oldNum:r,newNum:i}]:i>0&&(0===r||e[r][i-1]>=e[r-1][i])?[...o(e,a,t,r,i-1),{type:"insert",oldLine:null,newLine:t[i-1],oldNum:null,newNum:i}]:[...o(e,a,t,r-1,i),{type:"delete",oldLine:a[r-1],newLine:null,oldNum:r,newNum:null}]}(function(o,e){let a=o.length,t=e.length,r=Array.from({length:a+1},()=>Array(t+1).fill(0));for(let i=1;i<=a;i++)for(let a=1;a<=t;a++)o[i-1]===e[a-1]?r[i][a]=r[i-1][a-1]+1:r[i][a]=Math.max(r[i-1][a],r[i][a-1]);return r}(a,t),a,t,a.length,t.length),l=[],s=0;for(;s<n.length;)"delete"===n[s].type&&s+1<n.length&&"insert"===n[s+1].type?(l.push({type:"replace",oldLine:n[s].oldLine,newLine:n[s+1].newLine,oldNum:n[s].oldNum,newNum:n[s+1].newNum}),s+=2):(l.push(n[s]),s++);return l}function r(o){let e=0,a=0,t=0;for(let r of o)"insert"===r.type?e++:"delete"===r.type?a++:"replace"===r.type&&t++;return{added:e,removed:a,changed:t}}a.d(e,{P:()=>t,h:()=>r})},5151(o,e,a){a.d(e,{k:()=>t});let t=[{label:"TypeScript function refactor",original:`function fetchUser(id) {
...
class Database:
    ...
    def query(self, sql: str, params: tuple = ()) -> list:
        ...
        return cursor.fetchall()`}]},7330(o,e,a){a.d(e,{FlyoutPanel:()=>oR});var t=a(5723),r=a(7991),i=a.n(r),n=a(6859),l=a.n(n),s=a(2799),d=a(1316),c=a(814),p=a(6896),g=a(7902),m=a(3013),f=a(2887),x=a(9510),h=a(9848),u=a(7901),b=a(3045),w=a(3775),y=a(1783),$=a(3539),v=a(9416),z=a(1837),k=a(7167),M=a(4494),A=a(2314),T=a(255),S=a(5751),j=a(9633),F=a(2946),B=a(822),L=a(6720),C=a(7400),H=a(8456),R=a(3317),P=a(2709),E=a(8006),N=a(9301),V=a(7561),D=a(3517),K=a(8207),I=a(7032),Y=a(6949),_=a(8218),G=a(6829),O=a(9591),U=a(5553),W=a(9923),J=a(2820),Z=a(4621),q=a(8479),X=a(2534),Q=a(6673),oo=a(7490),oe=a(9033),oa=a(9038),ot=a(5775),or=a(1365),oi=a(4893),on=a(2937),ol=a(9821),os=a(5912),od=a(158),oc=a(8641),op=a(8607),og=a(3249),om=a(1821),of=a(5889),ox=a(9655),oh=a(7170),ou=a(9161),ob=a(1849),ow=a(1604),oy=a(3142),o$=a(1187),ov=a(7747),oz=a(2932),ok=a(4525),oM=a(7230),oA=a(2164);let oT={activity:p.A,"a-large-small":g.A,apple:m.A,"arrow-right":f.A,"bar-chart-2":x.A,book:h.A,"book-open":u.A,briefcase:b.A,calendar:w.A,clock:y.A,"circle-dot":$.A,cloud:v.A,compass:z.A,cpu:k.A,droplets:M.A,feather:A.A,file:T.A,"file-text":S.A,folder:j.A,"git-branch":F.A,github:B.A,globe:L.A,grid:C.A,hand:H.A,hash:R.A,heart:P.A,key:E.A,hexagon:N.A,home:V.A,landmark:D.A,layers:K.A,"layout-grid":I.A,leaf:Y.A,lightbulb:_.A,list:G.A,map:O.A,"map-pin":U.A,"message-circle":W.A,"message-square":J.A,minus:Z.A,monitor:q.A,mountain:X.A,package:Q.A,palette:oo.A,"pen-tool":oe.A,"pie-chart":oa.A,plane:ot.A,plus:or.A,puzzle:oi.A,ruler:on.A,shirt:ol.A,slash:os.A,square:od.A,star:oc.A,sun:op.A,terminal:og.A,thermometer:om.A,triangle:of.A,trophy:ox.A,truck:oh.A,type:ou.A,users:ob.A,"volume-2":ow.A,watch:oy.A,waves:o$.A,wind:ov.A,wrench:oz.A,x:ok.A,zap:oM.A,bot:oA.A},oS=(0,s.keyframes)`
...
`,oL=({size:o=14,strokeWidth:e=1.75})=>(0,t.jsxs)("svg",{width:o,height:o,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:e,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,t.jsx)("polyline",{points:"14 2 14 8 20 8"})]});function oC({iconKey:o}){let e=o?oT[o]:null;return e?(0,t.jsx)(e,{size:14,strokeWidth:1.75}):(0,t.jsx)(oL,{})}function oH({entries:o,activeId:e,onSelect:a}){return(0,t.jsx)(t.Fragment,{children:o.map(o=>o.children?(0,t.jsx)(i().Fragment,{children:(0,t.jsx)(oH,{entries:o.children,activeId:e,onSelect:a})},o.id):(0,t.jsxs)(oB,{active:e===o.id,onClick:()=>a(o),children:[(0,t.jsx)(oC,{iconKey:o.icon}),o.name]},o.id))})}function oR({activeId:o}){let{flyout:e,scheduleFlyoutClose:a,cancelFlyoutClose:r}=(0,c.c)();if(!e)return null;let i=e.entry.icon?oT[e.entry.icon]:null;return(0,t.jsxs)(oj,{anchorY:e.anchorY,onMouseEnter:r,onMouseLeave:a,children:[(0,t.jsxs)(oF,{children:[i?(0,t.jsx)(i,{size:13,strokeWidth:2}):(0,t.jsx)(oL,{size:13,strokeWidth:2}),e.entry.name]}),(0,t.jsx)(oH,{entries:e.entry.children??[],activeId:o,onSelect:o=>{e.onSelect(o),a()}})]})}},814(o,e,a){a.d(e,{I:()=>r,c:()=>i});var t=a(7991);let r=(0,t.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),i=()=>(0,t.useContext)(r)},9874(o,e,a){a.d(e,{PL:()=>L.getSetting,MJ:()=>K,mZ:()=>L.updateDoc,KL:()=>L.saveDoc,cL:()=>c.c,Is:()=>L.putSetting,UO:()=>oe,PE:()=>F,w4:()=>t.w4});var t=a(1316),r=a(5723),i=a(7991),n=a.n(i),l=a(6859),s=a.n(l);s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,D=s().div`
  ...
  color: ${t.w4.colors.sidebarTextMuted};
  font-family: ${t.w4.typography.fontFamily};
`;function K({onSave:o,onUpdate:e,onCancel:a,existingDoc:t}){let[n,l]=(0,i.useState)(t?.name??""),s=(0,i.useRef)(null);return(0,i.useEffect)(()=>{s.current?.focus(),t&&s.current?.select()},[t]),(0,r.jsx)(C,{onClick:a,children:(0,r.jsxs)(H,{onClick:o=>o.stopPropagation(),children:[(0,r.jsx)(R,{children:"Save document"}),t&&e&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(D,{children:"Update the current version or save as a new one."}),(0,r.jsxs)(E,{children:[(0,r.jsx)(N,{onClick:a,children:"Cancel"}),(0,r.jsxs)(N,{danger:!0,onClick:e,children:['Update "',t.name,'"']})]}),(0,r.jsx)(V,{})]}),(0,r.jsx)(P,{ref:s,value:n,onChange:o=>l(o.target.value),onKeyDown:r=>{"Enter"===r.key&&n.trim()&&(t&&n.trim()===t.name&&e?e():o(n.trim())),"Escape"===r.key&&a()},placeholder:t?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,r.jsxs)(E,{children:[!t&&(0,r.jsx)(N,{onClick:a,children:"Cancel"}),(0,r.jsx)(N,{primary:!0,disabled:!n.trim(),onClick:()=>o(n.trim()),children:"Save as new"})]})]})})}let I=(0,d.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,Y=(0,d.keyframes)`
