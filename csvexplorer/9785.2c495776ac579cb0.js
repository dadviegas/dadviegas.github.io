"use strict";(self.webpackChunk_atlantis_csvexplorer=self.webpackChunk_atlantis_csvexplorer||[]).push([["9785"],{457(o,e,a){function r(o){let e=o.split("\n")[0]??"",a={",":0,"	":0,";":0};for(let o of e)o in a&&a[o]++;let r=Object.entries(a).sort((o,e)=>e[1]-o[1])[0];return r[1]>0?r[0]:","}function t(o,e){let a=e??r(o),t=o.trim().split(/\r?\n/).filter(o=>""!==o.trim());if(0===t.length)return{headers:[],rows:[],stats:[]};let n=o=>{let e=[],r="",t=!1;for(let n=0;n<o.length;n++){let i=o[n];'"'===i?t&&'"'===o[n+1]?(r+='"',n++):t=!t:i!==a||t?r+=i:(e.push(r.trim()),r="")}return e.push(r.trim()),e},i=n(t[0]),l=t.slice(1).map(n),s=i.map((o,e)=>{let a,r,t=l.map(o=>o[e]??""),n=t.filter(o=>""!==o&&null!==o),i=function(o){if(0===o.length)return"text";let e=o.slice(0,20);return e.filter(o=>""!==o&&!isNaN(Number(o))).length/e.length>.8?"number":e.filter(o=>!isNaN(Date.parse(o))&&o.length>4).length/e.length>.7?"date":"text"}(n),s=new Set(t).size;if("number"===i){let o=n.map(Number).filter(o=>!isNaN(o));o.length&&(a=Math.min(...o),r=Math.max(...o))}return{name:o,type:i,count:t.length,nullCount:t.length-n.length,uniqueCount:s,min:a,max:r}});return{headers:i,rows:l,stats:s}}a.d(e,{CO:()=>t,Dt:()=>r})},5151(o,e,a){a.d(e,{k:()=>r});let r=[{label:"People",csv:`name,age,city,salary,active
...
Oct,68500,521,-3.8
Nov,82300,634,20.1
Dec,94700,721,15.1`}]},7330(o,e,a){a.d(e,{FlyoutPanel:()=>oP});var r=a(5723),t=a(7991),n=a.n(t),i=a(6859),l=a.n(i),s=a(2799),d=a(255),c=a(1316),p=a(814),g=a(6896),m=a(7902),f=a(3013),x=a(2887),u=a(9510),b=a(9848),h=a(7901),w=a(3045),y=a(3775),$=a(1783),z=a(3539),v=a(9416),k=a(1837),M=a(7167),A=a(4494),T=a(2314),S=a(5751),F=a(9633),j=a(2946),B=a(822),R=a(6720),P=a(7400),H=a(8456),C=a(3317),E=a(2709),L=a(8006),D=a(9301),N=a(7561),K=a(3517),I=a(8207),Y=a(7032),V=a(6949),G=a(8218),_=a(6829),J=a(9591),O=a(5553),W=a(9923),Z=a(2820),U=a(4621),q=a(8479),X=a(2534),Q=a(6673),oo=a(7490),oe=a(9033),oa=a(9038),or=a(5775),ot=a(1365),on=a(2937),oi=a(9821),ol=a(5912),os=a(158),od=a(8641),oc=a(8607),op=a(3249),og=a(1821),om=a(5889),of=a(9655),ox=a(7170),ou=a(9161),ob=a(1849),oh=a(1604),ow=a(3142),oy=a(1187),o$=a(7747),oz=a(2932),ov=a(4525),ok=a(7230),oM=a(2164);let oA={activity:g.A,"a-large-small":m.A,apple:f.A,"arrow-right":x.A,"bar-chart-2":u.A,book:b.A,"book-open":h.A,briefcase:w.A,calendar:y.A,clock:$.A,"circle-dot":z.A,cloud:v.A,compass:k.A,cpu:M.A,droplets:A.A,feather:T.A,file:d.A,"file-text":S.A,folder:F.A,"git-branch":j.A,github:B.A,globe:R.A,grid:P.A,hand:H.A,hash:C.A,heart:E.A,key:L.A,hexagon:D.A,home:N.A,landmark:K.A,layers:I.A,"layout-grid":Y.A,leaf:V.A,lightbulb:G.A,list:_.A,map:J.A,"map-pin":O.A,"message-circle":W.A,"message-square":Z.A,minus:U.A,monitor:q.A,mountain:X.A,package:Q.A,palette:oo.A,"pen-tool":oe.A,"pie-chart":oa.A,plane:or.A,plus:ot.A,ruler:on.A,shirt:oi.A,slash:ol.A,square:os.A,star:od.A,sun:oc.A,terminal:op.A,thermometer:og.A,triangle:om.A,trophy:of.A,truck:ox.A,type:ou.A,users:ob.A,"volume-2":oh.A,watch:ow.A,waves:oy.A,wind:o$.A,wrench:oz.A,x:ov.A,zap:ok.A,bot:oM.A},oT=(0,s.keyframes)`
