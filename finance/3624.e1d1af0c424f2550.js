"use strict";(self.webpackChunk_atlantis_finance=self.webpackChunk_atlantis_finance||[]).push([["3624"],{719(e,t,o){o.d(t,{TA:()=>H,a8:()=>g,jb:()=>D});var r=o(5723),a=o(7991),i=o(6859),n=o.n(i),s=o(9874),l=o(8395),d=o(1496),c=o(7723);let p=["#3b82f6","#8b5cf6","#ec4899","#10b981","#f59e0b","#06b6d4"];function g(e,t){return e.color??p[t%p.length]}let f="#7fb77e",h=n().nav`
  display: flex;
...
`,R=n().span`
  ...
  font-variant-numeric: tabular-nums;
  color: ${s.w4.colors.mainTextMuted};
`;function H({data:e,activeMemberId:t,onSelectMember:o,onSaveData:i,t:n,locale:f}){let[A,C]=(0,a.useState)(!1),[R,D]=(0,a.useState)(""),[B,L]=(0,a.useState)("adult"),[N,P]=(0,a.useState)(p[0]),K=(0,c.thisMonthKey)(),O=(()=>{let[e,t]=K.split("-").map(Number),o=new Date(e,t-2,1);return`${o.getFullYear()}-${String(o.getMonth()+1).padStart(2,"0")}`})(),V=[{id:"all",name:n("finance.member.all"),role:"shared",color:void 0},{id:"shared",name:n("finance.member.shared"),role:"shared",color:void 0},...e.familyMembers.map((e,t)=>({...e,color:g(e,t)}))];return(0,r.jsxs)(h,{"aria-label":n("finance.nav.ariaLabel"),children:[V.map(a=>{var i;let n,p,g=a.id===t,h=a.color??s.w4.colors.mainTextMuted,$=(0,c.monthlyTotalByMember)(e,a.id,K),v=(i=a.id,n=(0,c.monthlyTotalByMember)(e,i,K),0===(p=(0,c.monthlyTotalByMember)(e,i,O))?0:Math.round((n-p)/p*100)),k=function(e,t){let o=new Date,r=[];for(let a=5;a>=0;a--){let i=new Date(o);i.setDate(o.getDate()-7*a-o.getDay()),i.setHours(0,0,0,0);let n=new Date(i);n.setDate(i.getDate()+7);let s=(0,c.expensesForMember)(e.expenses,t).filter(e=>{let t=new Date(e.date+"T00:00:00");return t>=i&&t<n}).reduce((e,t)=>e+t.amount,0);r.push(s)}return r}(e,a.id),M={id:a.id,name:a.name,role:a.role,color:a.color};return(0,r.jsxs)(x,{active:g,onClick:()=>o(a.id),type:"button","aria-pressed":g,children:[(0,r.jsx)(l.eu,{member:M,size:26}),(0,r.jsxs)(m,{children:[(0,r.jsx)(u,{active:g,children:a.name}),(0,r.jsxs)(b,{children:[(0,r.jsx)(w,{children:`€${Math.round($).toLocaleString("pt"===f?"pt-PT":"en-GB")}`}),0!==v&&(0,r.jsxs)(y,{positive:v>0,children:[v>0?"↑":"↓",Math.abs(v),"%"]})]})]}),k.some(e=>e>0)&&(0,r.jsx)(d.OW,{points:k,accent:h,width:48,height:24})]},a.id)}),A?(0,r.jsxs)(v,{children:[(0,r.jsx)(k,{type:"text",placeholder:n("finance.member.name"),value:R,onChange:e=>D(e.target.value),autoFocus:!0,"aria-label":n("finance.member.name")}),(0,r.jsxs)(M,{children:[(0,r.jsx)(z,{type:"button",active:"adult"===B,onClick:()=>L("adult"),children:n("finance.member.role.adult")}),(0,r.jsx)(z,{type:"button",active:"child"===B,onClick:()=>L("child"),children:n("finance.member.role.child")})]}),(0,r.jsx)(T,{children:p.map(e=>(0,r.jsx)(j,{type:"button",bg:e,active:N===e,onClick:()=>P(e),"aria-label":e},e))}),(0,r.jsxs)(F,{children:[(0,r.jsx)(S,{type:"button",onClick:()=>C(!1),children:n("finance.member.cancel")}),(0,r.jsx)(S,{type:"button",primary:!0,onClick:function(){if(!R.trim())return;let t={id:`m_${Date.now()}`,name:R.trim(),role:B,color:N};i({...e,familyMembers:[...e.familyMembers,t]}),D(""),L("adult"),P(p[0]),C(!1)},disabled:!R.trim(),children:n("finance.member.save")})]})]}):(0,r.jsxs)($,{type:"button",onClick:()=>C(!0),children:[(0,r.jsx)(l.In,{name:"user-plus",size:14,"aria-hidden":!0}),n("finance.member.add")]})]})}function D({data:e,activeMemberId:t,onSelectMember:o,t:a,locale:i}){let n=(0,c.thisMonthKey)(),d=[{id:"all",name:a("finance.member.all"),role:"shared",color:void 0},{id:"shared",name:a("finance.member.shared"),role:"shared",color:void 0},...e.familyMembers.map((e,t)=>({...e,color:g(e,t)}))];return(0,r.jsx)(A,{role:"tablist","aria-label":a("finance.nav.ariaLabel"),children:d.map(a=>{let d=a.id===t,p=a.color??s.w4.colors.mainTextMuted,g=(0,c.monthlyTotalByMember)(e,a.id,n),f={id:a.id,name:a.name,role:a.role,color:a.color};return(0,r.jsxs)(C,{active:d,color:p,onClick:()=>o(a.id),type:"button",role:"tab","aria-selected":d,children:[(0,r.jsx)(l.eu,{member:f,size:20}),(0,r.jsx)("span",{children:a.name}),(0,r.jsx)(R,{children:`€${Math.round(g).toLocaleString("pt"===i?"pt-PT":"en-GB")}`})]},a.id)})})}},9546(e,t,o){o.d(t,{S:()=>x});var r=o(5723),a=o(7991),i=o(6859),n=o.n(i),s=o(2799),l=o(9874);let d=(0,s.keyframes)`
...
`,b=i().forwardRef(function({variant:e="ghost",size:t="md",icon:o,iconRight:a,children:i,...n},s){return(0,r.jsxs)(u,{ref:s,variant:e,size:t,...n,children:[o,i,a]})}),w={default:l.w4.colors.accent,danger:"#f85149"},y={default:l.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"},$=s().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`,v=i().forwardRef(function({active:e=!1,shape:t="square",tone:o="default",children:a,...i},n){return(0,r.jsx)($,{ref:n,active:e,shape:t,tone:o,...i,children:a})});s().div`
  position: relative;
  display: inline-flex;
`,s().div`
  position: absolute;
...
`,C=s().span`
  ...
  line-height: 1;
  letter-spacing: 0;
`,R=["#3b82f6","#8b5cf6","#ec4899","#10b981","#f59e0b","#06b6d4"],H=0,D=new Map;function B({member:e,size:t=24}){var o,a;let i,n="shared"===e.id||"shared"===e.role,s=Math.floor(.55*t),d=t<=18?8:t<=22?9:t<=28?11:12;if(n)return(0,r.jsx)(A,{size:t,bg:l.w4.colors.surface,ring:!0,"aria-label":"Shared",title:"Shared",style:{color:l.w4.colors.mainTextMuted},children:(0,r.jsx)(S,{name:"home",size:s,"aria-hidden":!0})});let c=(o=e.id,(a=e.color)?a:(!D.has(o)&&(D.set(o,R[H%R.length]),H++),D.get(o))),p="adult"===e.role,g=(i=e.name.trim().split(/\s+/),((i[0]?.[0]??"")+(i[1]?.[0]??"")).toUpperCase().slice(0,2));return(0,r.jsx)(A,{size:t,bg:c,ring:p,title:e.name,children:(0,r.jsx)(C,{fontSize:d,children:g})})}s().img`
  width: ${({size:e})=>e}px;
  height: ${({size:e})=>e}px;
  border-radius: 50%;
  object-fit: cover;
...
`,s().span`
  ...
  display: inline-block;
`;let K={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:l.w4.colors.accentMuted},O={neutral:l.w4.colors.mainTextMuted,live:l.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:l.w4.colors.accent},V=s().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${l.w4.typography.fontFamilyMono};
...
`,W=s().span`
  ...
  display: inline-block;
`;function E({tone:e="neutral",dot:t,children:o,...a}){return(0,r.jsxs)(V,{tone:e,...a,children:[(t??"live"===e)&&(0,r.jsx)(W,{}),o]})}s().kbd`
  font-family: ${l.w4.typography.fontFamilyMono};
  font-size: 10px;
  padding: 2px 6px;
  border: 1px solid ${l.w4.colors.border};
...
`;let I=s().div`
  ...
  align-items: center;
  gap: 8px;
`;function _({children:e,...t}){return(0,r.jsx)(I,{...t,children:e})}s().label`
  display: flex;
  align-items: center;
  gap: 10px;
...
`;function Z({title:e,accessory:t,accentColor:o,error:a,errorLabel:i,children:n}){return(0,r.jsxs)(Y,{accentColor:o,"data-widget-shell":!0,children:[(0,r.jsxs)(q,{children:[(0,r.jsx)(_,{children:e}),t&&(0,r.jsx)(G,{children:t})]}),a?(0,r.jsxs)(X,{role:"alert",children:[(0,r.jsx)(J,{children:i??"Error"}),(0,r.jsx)("div",{children:a})]}):(0,r.jsx)(U,{children:n})]})}s().div`
  position: relative;
  display: flex;
  flex-direction: column;
  height: 100%;
...
`;let ee="#7fb77e",et=(0,T.keyframes)`
...
`,ea.A,ea.A['pre[class*="language-"]'],l.w4.colors.codeBg,ea.A['code[class*="language-"]'],s().div`
  background: ${({bg:e})=>e};
...
`},8908(e,t,o){o.d(t,{uj:()=>k,OW:()=>f,ik:()=>u,Xj:()=>H,Ru:()=>x,kl:()=>S,RT:()=>j,RJ:()=>w,YG:()=>p});var r=o(5723),a=o(6859),i=o.n(a),n=o(9874);let s=i().div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
`,c={loading:"◌ Loading",empty:"◎ Empty",error:"◎ Offline"};function p({mode:e,label:t,body:o}){return(0,r.jsxs)(s,{children:[(0,r.jsx)(l,{mode:e,children:t??c[e]}),o&&(0,r.jsx)(d,{children:o})]})}var g=o(7991);function f({points:e,accent:t=n.w4.colors.accent,width:o=60,height:a=28,strokeWidth:i=1.5}){let s=(0,g.useMemo)(()=>{if(e.length<2)return"";let t=Math.min(...e),r=Math.max(...e)-t||1,n=o-2*i,s=a-2*i;return e.map((o,a)=>{let l=i+a/(e.length-1)*n,d=i+s-(o-t)/r*s;return`${0===a?"M":"L"} ${l.toFixed(1)} ${d.toFixed(1)}`}).join(" ")},[e,o,a,i]),l=(0,g.useMemo)(()=>{if(e.length<1)return null;let t=e[e.length-1],r=Math.min(...e),n=o-2*i,s=a-2*i;return{x:i+n,y:i+s-(t-r)/(Math.max(...e)-r||1)*s}},[e,o,a,i]);return s?(0,r.jsxs)("svg",{width:o,height:a,viewBox:`0 0 ${o} ${a}`,"aria-hidden":"true",style:{display:"block",flexShrink:0},children:[(0,r.jsx)("path",{d:s,fill:"none",stroke:t,strokeWidth:i,strokeLinecap:"round",strokeLinejoin:"round",opacity:.7}),l&&(0,r.jsx)("circle",{cx:l.x,cy:l.y,r:i+1,fill:t})]}):null}let h=i().span`
  ...
  white-space: nowrap;
`;function x({value:e,format:t="pct",decimals:o=2}){let a=e>0?"pos":e<0?"neg":"zero",i=Math.abs(e).toFixed(o);return(0,r.jsxs)(h,{sign:a,children:["pos"===a?"▲":"neg"===a?"▼":"—"," ",i,"pct"===t?"%":""]})}i().div`
  display: flex;
  align-items: baseline;
  justify-content: space-between;
  gap: ${n.w4.spacing.sm};
...
`,i().span`
  ...
  flex-shrink: 0;
  text-align: right;
`,o(3090);let m="'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, monospace";function u({data:e,budget:t,height:o=200,animation:a="rise"}){let i=(0,g.useId)();if(!e.length)return null;let s=1.1*Math.max(...e.map(e=>e.segments.reduce((e,t)=>e+t.value,0)+(e.over??0)),t??0)||1,l=472,d=o-20-24,c=472/e.length*.58,p=l/e.length,f="rise"===a?{transformOrigin:"bottom",animation:`${i}_rise 0.45s ease-out both`}:{};return(0,r.jsxs)(r.Fragment,{children:["rise"===a&&(0,r.jsx)("style",{children:`
          @keyframes ${i}_rise {
            from { transform: scaleY(0); }
            to   { transform: scaleY(1); }
          }
        `}),(0,r.jsxs)("svg",{viewBox:`0 0 520 ${o}`,style:{width:"100%",height:o},preserveAspectRatio:"xMidYMid meet","aria-hidden":"true",children:[null!=t?(0,r.jsxs)("g",{children:[(0,r.jsx)("line",{x1:40,x2:40+l,y1:20+d-t/s*d,y2:20+d-t/s*d,stroke:n.w4.colors.border,strokeDasharray:"3 3",strokeWidth:"1"}),(0,r.jsxs)("text",{x:36,y:20+d-t/s*d+3,textAnchor:"end",fontFamily:m,fontSize:"9",fill:n.w4.colors.mainTextMuted,children:["€",t]})]}):null,e.map((e,t)=>{let a,i=40+t*p+(p-c)/2,l=20+d;return(0,r.jsxs)("g",{style:f,children:[e.segments.map(e=>{let t=e.value/s*d;return l-=t,(0,r.jsx)("rect",{x:i,y:l,width:c,height:t,fill:e.color,opacity:.85},e.id)}),null!=e.over&&e.over>0?(a=e.over/s*d,l-=a,(0,r.jsx)("rect",{x:i,y:l,width:c,height:a,fill:"#f85149",opacity:.7},"over")):null,(0,r.jsx)("text",{x:i+c/2,y:o-6,textAnchor:"middle",fontFamily:m,fontSize:"10",fill:n.w4.colors.mainTextMuted,children:e.label})]},e.label)})]})]})}let b="'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, monospace";function w({data:e,total:t,size:o=110,thickness:a=14,centerLabel:i,centerValue:s}){let l=(0,g.useId)(),d=o/2-a/2-2,c=2*Math.PI*d,p=e.reduce((e,t)=>e+t.value,0)||1,f=0;return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)("style",{children:`
        @keyframes ${l}_dash {
          from { stroke-dasharray: 0 ${c.toFixed(1)}; }
        }
      `}),(0,r.jsxs)("svg",{viewBox:`0 0 ${o} ${o}`,style:{width:o,height:o,flexShrink:0},"aria-hidden":"true",children:[(0,r.jsx)("circle",{cx:o/2,cy:o/2,r:d,fill:"none",stroke:n.w4.colors.border,strokeWidth:a}),e.map((e,t)=>{let i=e.value/p*c,n=60*t,s=(0,r.jsx)("circle",{cx:o/2,cy:o/2,r:d,fill:"none",stroke:e.color,strokeWidth:a,strokeDasharray:`${i.toFixed(1)} ${c.toFixed(1)}`,strokeDashoffset:(-f).toFixed(1),transform:`rotate(-90 ${o/2} ${o/2})`,style:{animation:`${l}_dash 0.45s ease-out ${n}ms both`}},t);return f+=i,s}),i?(0,r.jsx)("text",{x:o/2,y:o/2-4,textAnchor:"middle",fontFamily:b,fontSize:"9",fill:n.w4.colors.mainTextMuted,letterSpacing:"0.12em",textDecoration:"none",children:i.toUpperCase()}):null,s?(0,r.jsx)("text",{x:o/2,y:i?o/2+11:o/2+4,textAnchor:"middle",fontFamily:b,fontSize:"13",fontWeight:"700",fill:n.w4.colors.mainText,children:s}):null]})]})}let y="#7fb77e",$="#f85149";function v(e){let t=0;for(let o=1;o<e.length;o++){let r=e[o][0]-e[o-1][0],a=e[o][1]-e[o-1][1];t+=Math.sqrt(r*r+a*a)}return t}function k({data:e,height:t=170,legendIn:o,legendOut:a}){let i=(0,g.useId)();if(!e.length)return null;let s=288,l=t-10-32,d=1.1*Math.max(...e.map(e=>e.inc),...e.map(e=>e.exp))||1,c=s/Math.max(e.length-1,1),p=(0,g.useMemo)(()=>e.map((e,t)=>[6+t*c,10+l-e.inc/d*l]),[e,t]),f=(0,g.useMemo)(()=>e.map((e,t)=>[6+t*c,10+l-e.exp/d*l]),[e,t]),h=p.map(e=>e.join(",")).join(" "),x=f.map(e=>e.join(",")).join(" "),m=[`M${p[0][0]},${10+l}`,...p.map(e=>`L${e[0]},${e[1]}`),`L${p[p.length-1][0]},${10+l}`,"Z"].join(" "),u=v(p).toFixed(1),b=v(f).toFixed(1),w=e.reduce((e,t)=>e+t.inc,0),M=e.reduce((e,t)=>e+t.exp,0),z=e=>e>=1e3?`€${(e/1e3).toFixed(1)}k`:`€${Math.round(e)}`;return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)("style",{children:`
        @keyframes ${i}_inc { from { stroke-dashoffset: ${u}; } }
        @keyframes ${i}_exp { from { stroke-dashoffset: ${b}; } }
      `}),(0,r.jsxs)("svg",{viewBox:`0 0 300 ${t}`,style:{width:"100%",height:t},preserveAspectRatio:"none","aria-hidden":"true",children:[(0,r.jsx)("path",{d:m,fill:y,opacity:.1}),(0,r.jsx)("polyline",{points:h,stroke:y,strokeWidth:"1.25",fill:"none",strokeLinecap:"round",strokeLinejoin:"round",strokeDasharray:u,strokeDashoffset:"0",style:{animation:`${i}_inc 0.5s ease-out both`}}),(0,r.jsx)("polyline",{points:x,stroke:$,strokeWidth:"1.25",fill:"none",strokeLinecap:"round",strokeLinejoin:"round",strokeDasharray:b,strokeDashoffset:"0",style:{animation:`${i}_exp 0.5s ease-out 0.1s both`}}),(0,r.jsx)("line",{x1:6,x2:6+s,y1:10+l,y2:10+l,stroke:n.w4.colors.border,strokeWidth:"1"}),(0,r.jsxs)("g",{fontFamily:"'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, monospace",fontSize:"10",style:{fontVariantNumeric:"tabular-nums"},children:[(0,r.jsxs)("text",{x:6,y:t-14,fill:y,children:["● ",o??"in"," ",z(w)]}),(0,r.jsxs)("text",{x:6+s/2+4,y:t-14,fill:$,children:["● ",a??"out"," ",z(M)]}),(0,r.jsx)("text",{x:6,y:t-2,fill:n.w4.colors.mainTextMuted,children:"90D"})]})]})]})}let M=["#1a2420","#2a4535","#4a7a5a","#6fa77a","#7fb77e"],z=["S","T","Q","Q","S","S","D"],T=["S","M","T","W","T","F","S"];function j({data:e,cellSize:t=10,gap:o=2,locale:a="pt"}){let i=(0,g.useId)();if(!e.length)return null;let s=24+Math.ceil(e.length/7)*(t+o),l=14+7*(t+o);return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)("style",{children:`
        @keyframes ${i}_fade { from { opacity: 0; } to { opacity: 1; } }
      `}),(0,r.jsxs)("svg",{viewBox:`0 0 ${s} ${l}`,style:{width:"100%",height:"auto",maxHeight:l+4},"aria-hidden":"true",children:[(0,r.jsx)("g",{fontFamily:"'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, monospace",fontSize:"8",fill:n.w4.colors.mainTextMuted,children:("pt"===a?z:T).map((e,a)=>(0,r.jsx)("text",{x:"0",y:10+a*(t+o),children:e},a))}),e.map((e,a)=>{let n=18+Math.floor(a/7)*(t+o),s=2+a%7*(t+o),l=M[Math.max(0,Math.min(4,e))]??M[0];return(0,r.jsx)("rect",{x:n,y:s,width:t,height:t,fill:l,rx:"1",style:{animation:`${i}_fade 0.3s ease-out ${8*a}ms both`}},a)})]})]})}function F(e){let t=0;for(let o=1;o<e.length;o++){let r=e[o][0]-e[o-1][0],a=e[o][1]-e[o-1][1];t+=Math.sqrt(r*r+a*a)}return t}function S({spent:e,budget:t,height:o=60}){let a=(0,g.useId)(),i=1.05*t||1,s=Array.from({length:8},(e,o)=>t-t/7*o),l=Math.min(e/(t||1),1),d=Array.from({length:8},(e,o)=>Math.max(0,t-o/7*t*l*1.1)),c=s.map((e,t)=>[320*t/7,o-e/i*(o-5)]),p=d.map((e,t)=>[320*t/7,o-e/i*(o-5)]),f=c.map(e=>e.join(",")).join(" "),h=p.map(e=>e.join(",")).join(" "),x=F(c).toFixed(1),m=F(p).toFixed(1);return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)("style",{children:`
        @keyframes ${a}_i { from { stroke-dashoffset: ${x}; } }
        @keyframes ${a}_a { from { stroke-dashoffset: ${m}; } }
      `}),(0,r.jsxs)("svg",{viewBox:`0 0 320 ${o}`,style:{width:"100%",height:o},preserveAspectRatio:"none","aria-hidden":"true",children:[(0,r.jsx)("line",{x1:"0",x2:320,y1:o-5,y2:o-5,stroke:n.w4.colors.border,strokeDasharray:"3 3",strokeWidth:"1"}),(0,r.jsx)("polyline",{points:f,stroke:n.w4.colors.mainTextMuted,strokeWidth:"1",strokeDasharray:`${x} ${x}`,strokeDashoffset:"0",fill:"none",style:{strokeDasharray:"2 3",animation:`${a}_i 0.45s ease-out both`}}),(0,r.jsx)("polyline",{points:h,stroke:"#7fb77e",strokeWidth:"1.5",strokeDasharray:`${m} ${m}`,strokeDashoffset:"0",fill:"none",strokeLinecap:"round",style:{animation:`${a}_a 0.45s ease-out 0.08s both`}})]})]})}let A=i().div`
  position: relative;
  height: 6px;
