...
`;function h({onSave:a,onCancel:o}){const[e,n]=(0,t.useState)(""),i=(0,t.useRef)(null);return(0,t.useEffect)(()=>{i.current?.focus()},[]),(0,r.jsx)(u,{onClick:o,children:(0,r.jsxs)(f,{onClick:a=>a.stopPropagation(),children:[(0,r.jsx)(p,{children:"Save document"}),(0,r.jsx)(y,{ref:i,value:e,onChange:a=>n(a.target.value),onKeyDown:n=>{"Enter"===n.key&&e.trim()&&a(e.trim()),"Escape"===n.key&&o()},placeholder:"Give this version a name…",maxLength:80}),(0,r.jsxs)(z,{children:[(0,r.jsx)(b,{onClick:o,children:"Cancel"}),(0,r.jsx)(b,{primary:!0,disabled:!e.trim(),onClick:()=>a(e.trim()),children:"Save"})]})]})})}var x=e(8006),A=e(679),w=e(4872);const v=i.default.div`
  position: relative;
`,k=i.default.button`
  display: flex;
  align-items: center;
