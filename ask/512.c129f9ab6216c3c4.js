"use strict";(self.webpackChunk_atlantis_ask=self.webpackChunk_atlantis_ask||[]).push([["512"],{8997(e,t,n){var a=n(2727);t.createRoot=a.createRoot,a.hydrateRoot},3611(e,t,n){var a=n(5723),i=n(8997),s=n(7991),r=n(6859),o=n.n(r),l=n(2799),c=n(6063),d=n(2775),p=n(3236),h=n(8170),u=n(948);let g={256:"short",512:"medium",1024:"long",2048:"xlong"},x="ask:active-conversation",m="ask:tone",f="ask:language",w="ask:max-tokens",y="ask:model-id";function b(e,t){return(0,h.aw)(new Date(e).toISOString(),t)}let k=(0,l.keyframes)`
...
`;function S({expanded:e,onNew:t,newLabel:n}){let{collapsed:i}=(0,p.cL)();return i?(0,a.jsx)(j,{children:(0,a.jsx)(p.K0,{title:n,onClick:t,children:(0,a.jsx)(p.In,{name:"plus",size:14})})}):(0,a.jsx)(a.Fragment,{children:e})}let T=o().div`
