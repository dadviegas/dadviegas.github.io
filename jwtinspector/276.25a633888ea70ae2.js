...
`,I.A,I.A['pre[class*="language-"]'],d.w4.colors.codeBg,I.A['code[class*="language-"]'],l().div`
  background: ${({bg:o})=>o};
...
`,of=l().main`
  ...
  display: flex;
  flex-direction: column;
`,ox=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function ou(){return(0,t.jsx)(ol,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:ox.map((o,a)=>(0,t.jsx)(od,{index:a,accent:o.accent,children:o.char},a))})}let ob="atlantis:sidebar-collapsed";function oy({sidebar:o,children:a,topBarRight:n,title:l="Atlantis",activeId:d=null}){let[c,s]=(0,r.useState)(()=>{try{return"true"===localStorage.getItem(ob)}catch{return!1}}),[p,g]=(0,r.useState)(null),m=(0,r.useRef)(),h=()=>s(o=>{let a=!o;try{localStorage.setItem(ob,String(a))}catch{}return a}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(e.bind(e,5816)).then(o=>({default:o.FlyoutPanel}))),[]);return(0,t.jsx)(P.I.Provider,{value:{collapsed:c,toggle:h,flyout:p,openFlyout:(o,a,e)=>{clearTimeout(m.current),g({entry:o,anchorY:a,onSelect:e})},scheduleFlyoutClose:()=>{m.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(m.current)},children:(0,t.jsxs)(og,{children:[(0,t.jsxs)(ot,{children:[o&&(0,t.jsx)(or,{children:(0,t.jsx)(oi,{onClick:h,title:c?"Expand sidebar":"Collapse sidebar",children:(0,t.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("path",{d:"M9 3v18"})]})})}),(0,t.jsx)(ou,{}),l&&(0,t.jsx)(oc,{children:l}),n&&(0,t.jsx)(os,{children:n})]}),(0,t.jsxs)(op,{children:[null!=o&&(0,t.jsx)(om,{collapsed:c,children:(0,t.jsx)(oh,{children:o})}),(0,t.jsx)(of,{children:a})]}),p&&(0,t.jsx)(i().Suspense,{fallback:null,children:(0,t.jsx)(f,{activeId:d})})]})})}l().div`
  display: grid;
  grid-template-rows: ${({open:o})=>o?"1fr":"0fr"};
