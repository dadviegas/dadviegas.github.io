...
`,x=r().div`
  ...
  text-transform: uppercase;
  letter-spacing: 0.06em;
`;function b({systemPrompt:o,userPrompt:e,onSystemChange:a,onUserChange:t,onRun:r,running:l,canRun:u}){let[h,z]=(0,i.useState)(!!o);return(0,n.jsxs)(m,{children:[(0,n.jsxs)(g,{onClick:()=>z(o=>!o),children:[h?(0,n.jsx)(s.A,{size:14}):(0,n.jsx)(c.A,{size:14}),"System Prompt"]}),h&&(0,n.jsx)(p,{placeholder:"Optional system prompt...",value:o,onChange:o=>a(o.target.value)}),(0,n.jsx)(x,{children:"User Prompt"}),(0,n.jsx)(f,{placeholder:"Enter your prompt here...",value:e,onChange:o=>t(o.target.value),onKeyDown:o=>{"Enter"===o.key&&(o.metaKey||o.ctrlKey)&&u&&!l&&(o.preventDefault(),r())}}),(0,n.jsxs)(y,{disabled:!u||l,onClick:r,children:[(0,n.jsx)(d.A,{size:14}),l?"Running...":"Run"]})]})}},6220(o,e,a){a.d(e,{c:()=>j});var n=a(5723),i=a(6859),t=a.n(i),r=a(2799),l=a(3930),s=a(5609),c=a(320),d=a(7991),m=a(8035);let g=(0,r.keyframes)`
  0%, 100% { opacity: 1; }
  50% { opacity: 0; }
`,u=t().div`
  display: flex;
...
`,k={groq:"#f55036",gemini:"#4285f4"};function j({run:o}){let[e,a]=(0,d.useState)(!1),i=m.L.find(e=>e.id===o.modelId),t=i?.label??o.modelId,r=k[o.provider]??l.w4.colors.accent,g=async()=>{o.output&&(await navigator.clipboard.writeText(o.output),a(!0),setTimeout(()=>a(!1),1500))};return(0,n.jsxs)(u,{children:[(0,n.jsxs)(p,{children:[(0,n.jsxs)(f,{accentColor:r,children:[(0,n.jsx)(y,{children:o.provider}),t]}),(0,n.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:"8px"},children:["done"===o.status&&null!=o.durationMs&&(0,n.jsxs)(x,{children:[(o.durationMs/1e3).toFixed(1),"s"]}),o.output&&(0,n.jsx)(v,{onClick:g,title:"Copy output",children:e?(0,n.jsx)(s.A,{size:13}):(0,n.jsx)(c.A,{size:13})})]})]}),(0,n.jsxs)(b,{children:["idle"===o.status&&(0,n.jsx)(z,{children:"Response will appear here..."}),"error"===o.status&&o.error?.includes("rate limit")&&(0,n.jsxs)($,{children:[(0,n.jsx)(A,{children:"⚠️"}),(0,n.jsx)("div",{children:o.error})]}),"error"===o.status&&!o.error?.includes("rate limit")&&(0,n.jsx)(w,{children:o.error}),("streaming"===o.status||"done"===o.status)&&(0,n.jsx)(h,{streaming:"streaming"===o.status,children:o.output})]})]})}},7871(o,e,a){a.d(e,{Vc:()=>t,cR:()=>r,yr:()=>l});var n=a(8294);let i={groq:"",gemini:""};function t(){let o=(0,n.loadApiKeysSync)();return{...i,groq:o.groq??"",gemini:o.gemini??""}}function r(o){(0,n.saveApiKeys)({groq:o.groq,gemini:o.gemini})}function l(o){return!!(o.groq||o.gemini)}},8035(o,e,a){a.d(e,{L:()=>t,x:()=>i});var n=a(8294);let i=[{id:"groq",label:"Groq",url:"https://console.groq.com"},{id:"gemini",label:"Google Gemini",url:"https://aistudio.google.com/apikey"}],t=[...n.GROQ_MODELS.map(o=>({provider:"groq",id:o.id,label:o.label})),...n.GEMINI_MODELS.map(o=>({provider:"gemini",id:o.id,label:o.label}))]},7330(o,e,a){a.d(e,{FlyoutPanel:()=>oP});var n=a(5723),i=a(7991),t=a.n(i),r=a(6859),l=a.n(r),s=a(2799),c=a(255),d=a(1316),m=a(814),g=a(6896),u=a(7902),p=a(3013),f=a(2887),y=a(9510),x=a(9848),b=a(7901),h=a(3045),z=a(3775),w=a(1783),$=a(3539),A=a(9416),v=a(1837),k=a(7167),j=a(4494),S=a(2314),M=a(5751),B=a(9633),T=a(2946),E=a(822),C=a(6720),P=a(7400),L=a(8456),R=a(3317),F=a(2709),D=a(8006),G=a(9301),K=a(7561),N=a(3517),I=a(8207),H=a(7032),_=a(6949),Y=a(8218),V=a(6829),O=a(9591),U=a(5553),q=a(9923),J=a(2820),W=a(4621),Z=a(8479),X=a(2534),Q=a(6673),oo=a(7490),oe=a(9033),oa=a(9038),on=a(5775),oi=a(1365),ot=a(2937),or=a(9821),ol=a(5912),os=a(158),oc=a(8641),od=a(8607),om=a(3249),og=a(1821),ou=a(5889),op=a(9655),of=a(7170),oy=a(9161),ox=a(1849),ob=a(1604),oh=a(3142),oz=a(1187),ow=a(7747),o$=a(2932),oA=a(4525),ov=a(7230),ok=a(2164);let oj={activity:g.A,"a-large-small":u.A,apple:p.A,"arrow-right":f.A,"bar-chart-2":y.A,book:x.A,"book-open":b.A,briefcase:h.A,calendar:z.A,clock:w.A,"circle-dot":$.A,cloud:A.A,compass:v.A,cpu:k.A,droplets:j.A,feather:S.A,file:c.A,"file-text":M.A,folder:B.A,"git-branch":T.A,github:E.A,globe:C.A,grid:P.A,hand:L.A,hash:R.A,heart:F.A,key:D.A,hexagon:G.A,home:K.A,landmark:N.A,layers:I.A,"layout-grid":H.A,leaf:_.A,lightbulb:Y.A,list:V.A,map:O.A,"map-pin":U.A,"message-circle":q.A,"message-square":J.A,minus:W.A,monitor:Z.A,mountain:X.A,package:Q.A,palette:oo.A,"pen-tool":oe.A,"pie-chart":oa.A,plane:on.A,plus:oi.A,ruler:ot.A,shirt:or.A,slash:ol.A,square:os.A,star:oc.A,sun:od.A,terminal:om.A,thermometer:og.A,triangle:ou.A,trophy:op.A,truck:of.A,type:oy.A,users:ox.A,"volume-2":ob.A,watch:oh.A,waves:oz.A,wind:ow.A,wrench:o$.A,x:oA.A,zap:ov.A,bot:ok.A},oS=(0,s.keyframes)`
...
`;function oE({iconKey:o}){let e=o?oj[o]??c.A:c.A;return(0,n.jsx)(e,{size:14,strokeWidth:1.75})}function oC({entries:o,activeId:e,onSelect:a}){return(0,n.jsx)(n.Fragment,{children:o.map(o=>o.children?(0,n.jsx)(t().Fragment,{children:(0,n.jsx)(oC,{entries:o.children,activeId:e,onSelect:a})},o.id):(0,n.jsxs)(oT,{active:e===o.id,onClick:()=>a(o),children:[(0,n.jsx)(oE,{iconKey:o.icon}),o.name]},o.id))})}function oP({activeId:o}){let{flyout:e,scheduleFlyoutClose:a,cancelFlyoutClose:i}=(0,m.c)();if(!e)return null;let t=e.entry.icon?oj[e.entry.icon]??c.A:c.A;return(0,n.jsxs)(oM,{anchorY:e.anchorY,onMouseEnter:i,onMouseLeave:a,children:[(0,n.jsxs)(oB,{children:[(0,n.jsx)(t,{size:13,strokeWidth:2}),e.entry.name]}),(0,n.jsx)(oC,{entries:e.entry.children??[],activeId:o,onSelect:o=>{e.onSelect(o),a()}})]})}},814(o,e,a){a.d(e,{I:()=>i,c:()=>t});var n=a(7991);let i=(0,n.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),t=()=>(0,n.useContext)(i)},3930(o,e,a){a.d(e,{UO:()=>ot,MJ:()=>H,mZ:()=>P.updateDoc,KL:()=>P.saveDoc,PE:()=>E,w4:()=>n.w4});var n=a(1316),i=a(5723),t=a(7991),r=a.n(t),l=a(6859),s=a.n(l);s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,S=s().main`
  ...
  display: flex;
  flex-direction: column;
`,M=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function B(){return(0,i.jsx)(h,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:M.map((o,e)=>(0,i.jsx)(z,{index:e,accent:o.accent,children:o.char},e))})}let T="atlantis:sidebar-collapsed";function E({sidebar:o,children:e,topBarRight:n,title:l="Atlantis",activeId:s=null}){let[c,g]=(0,t.useState)(()=>{try{return"true"===localStorage.getItem(T)}catch{return!1}}),[u,p]=(0,t.useState)(null),b=(0,t.useRef)(),h=()=>g(o=>{let e=!o;try{localStorage.setItem(T,String(e))}catch{}return e}),z=r().useMemo(()=>r().lazy(()=>Promise.resolve().then(a.bind(a,7330)).then(o=>({default:o.FlyoutPanel}))),[]);return(0,i.jsx)(m.I.Provider,{value:{collapsed:c,toggle:h,flyout:u,openFlyout:(o,e,a)=>{clearTimeout(b.current),p({entry:o,anchorY:e,onSelect:a})},scheduleFlyoutClose:()=>{b.current=setTimeout(()=>p(null),160)},cancelFlyoutClose:()=>clearTimeout(b.current)},children:(0,i.jsxs)(v,{children:[(0,i.jsxs)(f,{children:[o&&(0,i.jsx)(y,{children:(0,i.jsx)(x,{onClick:h,title:c?"Expand sidebar":"Collapse sidebar",children:(0,i.jsx)(d.A,{size:17})})}),(0,i.jsx)(B,{}),l&&(0,i.jsx)(w,{children:l}),n&&(0,i.jsx)($,{children:n})]}),(0,i.jsxs)(A,{children:[null!=o&&(0,i.jsx)(k,{collapsed:c,children:(0,i.jsx)(j,{children:o})}),(0,i.jsx)(S,{children:e})]}),u&&(0,i.jsx)(r().Suspense,{fallback:null,children:(0,i.jsx)(z,{activeId:s})})]})})}s().div`
  display: grid;
...
`,I=s().div`
  ...
  color: ${n.w4.colors.sidebarTextMuted};
  font-family: ${n.w4.typography.fontFamily};
`;function H({onSave:o,onUpdate:e,onCancel:a,existingDoc:n}){let[r,l]=(0,t.useState)(n?.name??""),s=(0,t.useRef)(null);return(0,t.useEffect)(()=>{s.current?.focus(),n&&s.current?.select()},[n]),(0,i.jsx)(L,{onClick:a,children:(0,i.jsxs)(R,{onClick:o=>o.stopPropagation(),children:[(0,i.jsx)(F,{children:"Save document"}),n&&e&&(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(I,{children:"Update the current version or save as a new one."}),(0,i.jsxs)(G,{children:[(0,i.jsx)(K,{onClick:a,children:"Cancel"}),(0,i.jsxs)(K,{danger:!0,onClick:e,children:['Update "',n.name,'"']})]}),(0,i.jsx)(N,{})]}),(0,i.jsx)(D,{ref:s,value:r,onChange:o=>l(o.target.value),onKeyDown:i=>{"Enter"===i.key&&r.trim()&&(n&&r.trim()===n.name&&e?e():o(r.trim())),"Escape"===i.key&&a()},placeholder:n?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,i.jsxs)(G,{children:[!n&&(0,i.jsx)(K,{onClick:a,children:"Cancel"}),(0,i.jsx)(K,{primary:!0,disabled:!r.trim(),onClick:()=>o(r.trim()),children:"Save as new"})]})]})})}let _=(0,c.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,Y=(0,c.keyframes)`
...
`;var V=a(5625),O=a(679),U=a(4872);let q=s().div`
  position: relative;
`,J=s().button`
  display: flex;
  align-items: center;
...
`;function ot({appId:o,onLoad:e}){let[a,n]=(0,t.useState)(!1),[r,l]=(0,t.useState)([]),s=(0,t.useRef)(null),c=(0,t.useCallback)(()=>{(0,P.listDocs)(o).then(l).catch(()=>{})},[o]);(0,t.useEffect)(()=>{if(!a)return;c();let o=o=>{s.current&&!s.current.contains(o.target)&&n(!1)};return document.addEventListener("mousedown",o),()=>document.removeEventListener("mousedown",o)},[a,c]);let d=async(o,e)=>{o.stopPropagation(),await (0,P.deleteDoc)(e),l(o=>o.filter(o=>o.id!==e))};return(0,i.jsxs)(q,{ref:s,children:[(0,i.jsxs)(J,{onClick:()=>n(o=>!o),children:[(0,i.jsx)(V.A,{size:14}),"Saved",(0,i.jsx)(O.A,{size:13,style:{marginLeft:2}})]}),(0,i.jsxs)(W,{open:a,children:[(0,i.jsx)(Z,{children:"Saved versions"}),(0,i.jsx)(X,{children:0===r.length?(0,i.jsx)(Q,{children:"No saved documents yet."}):r.map(o=>{var a;return(0,i.jsxs)(oo,{children:[(0,i.jsxs)(oe,{onClick:()=>{e(o.content,o.id,o.name),n(!1)},children:[(0,i.jsx)(oa,{children:o.name}),(0,i.jsx)(on,{children:(a=o.savedAt,new Intl.DateTimeFormat(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}).format(new Date(a)))})]}),(0,i.jsx)(oi,{onClick:e=>d(e,o.id),title:"Delete",children:(0,i.jsx)(U.A,{size:13})})]},o.id)})})]})]})}s().div`
