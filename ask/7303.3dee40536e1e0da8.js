...
`;function P({children:e,...o}){return(0,r.jsx)(L,{...o,children:e})}let V=l().div`
  ...
  align-items: center;
  gap: 8px;
`;function I({children:e,...o}){return(0,r.jsx)(V,{...o,children:e})}l().label`
  display: flex;
  align-items: center;
  gap: 10px;
...
`,l().p`
  ...
  font-size: 12.5px;
  line-height: 1.45;
`;var N=t(11352),D=t(76710),O=t(4311),W=t(73639),Y=t(8411);t(75406),l().nav`padding: ${s.w4.spacing.sm} 0;`,l().div`
...
`;var q=t(54041);let G="#7fb77e",_=(0,F.keyframes)`
...
`,l().span`
  font-size: ${s.w4.typography.fontSizeBase};
  color: ${s.w4.colors.mainTextMuted};
`;var ex=t(17223),ef=t(21426),eh=t(25609),em=t(20320);let eb=l().div`
  margin: ${s.w4.spacing.lg} 0;
  border-radius: ${s.w4.borderRadius.md};
  border: 1px solid ${s.w4.colors.codeBorder};
  overflow: hidden;
...
`,e$={...ef.A,'pre[class*="language-"]':{...ef.A['pre[class*="language-"]'],background:s.w4.colors.codeBg,margin:0,padding:"18px 20px",fontSize:"13px",lineHeight:"1.6",borderRadius:0},'code[class*="language-"]':{...ef.A['code[class*="language-"]'],background:"none",fontSize:"13px"}};function ev({lang:e="text",code:o}){let[t,i]=(0,a.useState)(!1);return(0,r.jsxs)(eb,{children:[(0,r.jsxs)(eu,{children:[(0,r.jsx)(ew,{children:e}),(0,r.jsxs)(ey,{copied:t,onClick:()=>{navigator.clipboard.writeText(o).then(()=>{i(!0),setTimeout(()=>i(!1),2e3)})},children:[t?(0,r.jsx)(eh.A,{size:12}):(0,r.jsx)(em.A,{size:12}),t?"Copied!":"Copy"]})]}),(0,r.jsx)(ex.A,{language:e,style:e$,showLineNumbers:o.split("\n").length>8,lineNumberStyle:{color:"#484f58",minWidth:"2.5em",paddingRight:"1.5em",userSelect:"none",fontSize:"12px"},customStyle:{margin:0,background:s.w4.colors.codeBg},wrapLongLines:!1,children:o})]})}var ek=t(65569),eM=t(8218),ez=t(57230),eT=t(22966),eF=t(21069);let eS={NOTE:{bg:"rgba(88, 166, 255, 0.08)",border:"#58a6ff",icon:ek.A,label:"Note",color:"#58a6ff"},TIP:{bg:"rgba(63, 185, 80, 0.08)",border:"#3fb950",icon:eM.A,label:"Tip",color:"#3fb950"},IMPORTANT:{bg:"rgba(163, 113, 247, 0.08)",border:"#a371f7",icon:ez.A,label:"Important",color:"#a371f7"},WARNING:{bg:"rgba(210, 153, 34, 0.08)",border:"#d29922",icon:eT.A,label:"Warning",color:"#d29922"},CAUTION:{bg:"rgba(248, 81, 73, 0.08)",border:"#f85149",icon:eF.A,label:"Caution",color:"#f85149"}},ej=l().div`
  background: ${({bg:e})=>e};
...
`;function eB({type:e,children:o}){let t=eS[e]??eS.NOTE,a=t.icon;return(0,r.jsxs)(ej,{bg:t.bg,border:t.border,children:[(0,r.jsxs)(eC,{color:t.color,children:[(0,r.jsx)(a,{size:15,strokeWidth:2}),t.label]}),(0,r.jsx)(eA,{children:o})]})}l().nav`
  width: 220px;
  min-width: 220px;
...
`;function eV({children:e}){return(0,r.jsx)(eP,{children:(0,r.jsx)(N.oz,{remarkPlugins:[D.A,O.A,eL],rehypePlugins:[W.A,Y.A],components:{div({node:e,children:o,...t}){let a=t["data-callout"];return a?(0,r.jsx)(eB,{type:a,children:o}):(0,r.jsx)("div",{...t,children:o})},pre:({children:e})=>(0,r.jsx)(r.Fragment,{children:e}),code({className:e,children:o}){let t=/language-(\w+)/.exec(e??"")?.[1],a=String(o).replace(/\n$/,"");return a.trim()?"mermaid"===t?(0,r.jsx)(J,{code:a}):"chart"===t?(0,r.jsx)(ep,{code:a}):t||a.includes("\n")?(0,r.jsx)(ev,{lang:t,code:a}):(0,r.jsx)("code",{className:e,children:o}):null}},children:e})})}l().nav`
  display: flex;
  flex-direction: column;
  gap: 1px;
  padding: ${s.w4.spacing.sm} 0;
