"use strict";(self.webpackChunk_atlantis_movies=self.webpackChunk_atlantis_movies||[]).push([["3268"],{7613(e,o,a){a.d(o,{H:()=>b});var r=a(5723),t=a(7991),i=a(6859),n=a.n(i),l=a(9874);let s=n().div`
  display: flex;
...
`,h=n().p`
  ...
  text-align: center;
  margin: 0;
`;function b({onSave:e}){let[o,a]=(0,t.useState)(""),[i,n]=(0,t.useState)(!1),[l,w]=(0,t.useState)(""),y=async()=>{let a=o.trim();if(a){n(!0),w("");try{if(!(await fetch(`https://api.themoviedb.org/3/configuration?api_key=${a}`)).ok)throw Error("Invalid key");e(a)}catch{w("Could not validate API key. Check it and try again.")}finally{n(!1)}}};return(0,r.jsx)(s,{children:(0,r.jsxs)(d,{children:[(0,r.jsx)(c,{children:"\uD83C\uDFAC"}),(0,r.jsx)(p,{children:"Movies & Series"}),(0,r.jsxs)(g,{children:["This app uses the free"," ",(0,r.jsx)(f,{href:"https://www.themoviedb.org/settings/api",target:"_blank",rel:"noreferrer",children:"TMDB API"})," ","to browse movies, TV shows, and documentaries — including where to stream them.",(0,r.jsx)("br",{}),(0,r.jsx)("br",{}),"Create a free account on TMDB and paste your ",(0,r.jsx)("strong",{children:"API Key (v3)"})," below."]}),(0,r.jsxs)("div",{style:{display:"flex",flexDirection:"column",gap:8},children:[(0,r.jsx)(m,{htmlFor:"apikey",children:"TMDB API Key (v3)"}),(0,r.jsx)(x,{id:"apikey",type:"password",placeholder:"e.g. a1b2c3d4e5f6...",value:o,onChange:e=>a(e.target.value),onKeyDown:e=>"Enter"===e.key&&y(),autoFocus:!0})]}),l&&(0,r.jsx)(h,{children:l}),(0,r.jsx)(u,{onClick:y,disabled:!o.trim()||i,children:i?"Validating…":"Connect"})]})})}},6250(e,o,a){a.d(o,{U:()=>W});var r=a(5723),t=a(7991),i=a(6859),n=a.n(i),l=a(9874),s=a(8311),d=a(2727),c=a.n(d),p=a(2799),g=a(1801);let f=n().div`
  position: relative;
  width: 150px;
  flex-shrink: 0;
  cursor: pointer;
...
`;function P({item:e,rect:o,onOpen:a,onMouseEnter:t,onMouseLeave:i,withBackdrop:n,onBackdropTap:l}){let d=function(e){let o=window.innerWidth,a=window.innerHeight;if(o<500){let r=Math.max(8,(o-300)/2);return{top:Math.max(8,Math.min(e.bottom+8,a-310-8)),left:r}}let r=e.right+10;r+300>o-8&&(r=e.left-300-10),r=Math.max(8,Math.min(r,o-300-8));let t=e.top+e.height/2-155;return{top:t=Math.max(8,Math.min(t,a-310-8)),left:r}}(o),p=(0,g.rS)(e),f=(0,g.Ox)(e),m=(0,g.U7)(e.backdrop_path,"w780");return c().createPortal((0,r.jsxs)(r.Fragment,{children:[n&&(0,r.jsx)("div",{style:{position:"fixed",inset:0,zIndex:9998},onClick:l}),(0,r.jsxs)(M,{top:d.top,left:d.left,onMouseEnter:t,onMouseLeave:i,onClick:a,style:{cursor:"pointer"},children:[m?(0,r.jsx)(j,{src:m}):(0,r.jsx)(A,{}),(0,r.jsxs)(T,{children:[(0,r.jsx)(S,{children:p}),(0,r.jsxs)(F,{children:[(0,r.jsxs)(B,{children:[(0,r.jsx)(s.In,{name:"star",size:11,fill:"currentColor"}),e.vote_average.toFixed(1)]}),f&&(0,r.jsx)(C,{children:f}),(0,r.jsx)(R,{kind:e.media_type,children:"movie"===e.media_type?"Film":"TV"})]}),e.overview&&(0,r.jsx)(_,{children:e.overview}),(0,r.jsxs)(H,{onClick:a,children:[(0,r.jsx)(s.In,{name:"info",size:13}),"More Info"]})]})]})]}),document.body)}function L({item:e,onClick:o}){let a=(0,g.rS)(e),i=(0,g.Ox)(e),n=(0,g.HD)(e.poster_path),l=(0,t.useRef)(null),d=(0,t.useRef)(),c=(0,t.useRef)(),p=(0,t.useRef)(null),k=(0,t.useRef)(!1),[M,j]=(0,t.useState)(!1),[A,T]=(0,t.useState)(null),[S,F]=(0,t.useState)(!1);(0,t.useEffect)(()=>()=>{clearTimeout(d.current),clearTimeout(c.current)},[]);let B=(0,t.useCallback)((e,o)=>{T(e),j(!0),F(o)},[]),C=(0,t.useCallback)(()=>{j(!1),T(null),F(!1)},[]),R=(0,t.useCallback)(()=>{C(),o(e)},[e,o,C]),_=(0,t.useCallback)(()=>{clearTimeout(c.current)},[]),H=(0,t.useCallback)(()=>{clearTimeout(d.current),c.current=setTimeout(C,180)},[C]),E=(0,t.useCallback)(()=>{clearTimeout(c.current)},[]),I=(0,t.useCallback)(()=>{C()},[C]),D=(0,t.useCallback)(e=>{M||(p.current={x:e.touches[0].clientX,y:e.touches[0].clientY})},[M]),V=(0,t.useCallback)(a=>{if(M||!p.current)return;let r=a.changedTouches[0],t=Math.abs(r.clientX-p.current.x),i=Math.abs(r.clientY-p.current.y);if(p.current=null,t>8||i>8)return;if(k.current=!0,window.innerWidth<768)return void o(e);let n=l.current?.getBoundingClientRect();n&&B(n,!0)},[M,e,o,B]),Y=(0,t.useCallback)(()=>{if(k.current){k.current=!1;return}M||S||R()},[M,S,R]);return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(f,{ref:l,onClick:Y,onMouseEnter:_,onMouseLeave:H,onTouchStart:D,onTouchEnd:V,title:a,role:"button",tabIndex:0,onKeyDown:e=>{("Enter"===e.key||" "===e.key)&&R()},children:[(0,r.jsx)(v,{kind:e.media_type,children:"movie"===e.media_type?"Film":"TV"}),(0,r.jsx)(z,{"data-eye":!0,onClick:e=>{e.stopPropagation();let o=l.current?.getBoundingClientRect();o&&B(o,!1)},title:"Preview",children:(0,r.jsx)(s.In,{name:"eye",size:14})}),n?(0,r.jsx)(m,{src:n,alt:a,loading:"lazy"}):(0,r.jsxs)(x,{children:["\uD83C\uDFAC",(0,r.jsx)(u,{children:a})]}),(0,r.jsxs)(h,{children:[(0,r.jsx)(b,{children:a}),(0,r.jsxs)(w,{children:[(0,r.jsxs)(y,{children:[(0,r.jsx)(s.In,{name:"star",size:9,fill:"currentColor"}),e.vote_average.toFixed(1)]}),i&&(0,r.jsx)($,{children:i})]})]})]}),M&&A&&(0,r.jsx)(P,{item:e,rect:A,onOpen:R,onMouseEnter:E,onMouseLeave:I,withBackdrop:S,onBackdropTap:C})]})}let E=n().div`
  display: flex;
  flex-direction: column;
  gap: ${l.w4.spacing.md};
...
`;function O(e){return Math.max(320,Math.round(.85*e.clientWidth))}function W({title:e,items:o,loading:a,onSelect:i}){let n=(0,t.useRef)(null),[l,d]=(0,t.useState)(!1),[c,p]=(0,t.useState)(!0),g=(0,t.useCallback)(()=>{let e=n.current;e&&(d(e.scrollLeft>0),p(e.scrollLeft+e.clientWidth<e.scrollWidth-4))},[]);(0,t.useEffect)(()=>{g();let e=()=>g();return window.addEventListener("resize",e),()=>window.removeEventListener("resize",e)},[o,g]);let f=()=>{let e=n.current;e&&e.scrollBy({left:-O(e),behavior:"smooth"})},m=()=>{let e=n.current;e&&e.scrollBy({left:O(e),behavior:"smooth"})};return(0,r.jsxs)(E,{children:[(0,r.jsxs)(I,{children:[(0,r.jsx)(D,{children:e}),(0,r.jsxs)(V,{children:[(0,r.jsx)(Y,{onClick:f,disabled:!l,"aria-label":"Scroll left",children:(0,r.jsx)(s.In,{name:"chevron-left",size:16})}),(0,r.jsx)(Y,{onClick:m,disabled:!c||0===o.length,"aria-label":"Scroll right",children:(0,r.jsx)(s.In,{name:"chevron-right",size:16})})]})]}),(0,r.jsx)(N,{children:a?(0,r.jsx)(K,{children:Array.from({length:10}).map((e,o)=>(0,r.jsx)(G,{},o))}):0===o.length?(0,r.jsx)(U,{children:"No results found"}):(0,r.jsx)(K,{ref:n,onScroll:g,onKeyDown:e=>{if("ArrowRight"===e.key)e.preventDefault(),m();else if("ArrowLeft"===e.key)e.preventDefault(),f();else if("Home"===e.key)e.preventDefault(),n.current?.scrollTo({left:0,behavior:"smooth"});else if("End"===e.key){e.preventDefault();let o=n.current;o&&o.scrollTo({left:o.scrollWidth,behavior:"smooth"})}},tabIndex:0,role:"region","aria-label":e,children:o.map(e=>(0,r.jsx)(L,{item:e,onClick:i},`${e.media_type}-${e.id}`))})})]})}},2819(e,o,a){a.d(o,{P:()=>ec});var r=a(5723),t=a(7991),i=a(6859),n=a.n(i),l=a(2799),s=a(9874),d=a(8311),c=a(1801),p=a(4956);let g=(0,l.keyframes)`
...
`,es=n().div`
  ...
  color: ${s.w4.colors.mainTextMuted};
  padding: 12px 0;
`;function ed({provider:e,title:o,appleTVUrl:a}){let t=c.RY[e.provider_name]??s.w4.colors.surface,i=(0,c.$8)(e,o,a);return(0,r.jsxs)(Q,{bg:t,href:i,target:"_blank",rel:"noreferrer",children:[e.logo_path&&(0,r.jsx)(ee,{src:(0,c.vo)(e.logo_path),alt:e.provider_name}),(0,r.jsxs)(eo,{children:[(0,r.jsx)(ea,{children:e.provider_name}),(0,r.jsxs)(er,{children:[(0,r.jsx)(d.In,{name:"external-link",size:9}),(0,c.mS)(e.provider_id)?"Open in Apple TV":`Open in ${e.provider_name}`]})]})]})}function ec({item:e,apiKey:o,onBack:a,onLibraryChange:i,onSelect:n}){let[l,g]=(0,t.useState)(null),[f,b]=(0,t.useState)([]),[Q,ee]=(0,t.useState)(null),[eo,er]=(0,t.useState)([]),[ep,eg]=(0,t.useState)([]),[ef,em]=(0,t.useState)(!0),[ex,eu]=(0,t.useState)(null),[eh,eb]=(0,t.useState)(!1),ew=(0,t.useRef)(null),[ey,e$]=(0,t.useState)(()=>(0,p.BA)(e)),[ev,ez]=(0,t.useState)(()=>(0,p.U4)(e)),ek=(0,c.rS)(e),eM=(0,c.Ox)(e);(0,t.useEffect)(()=>{let e=e=>{"Escape"===e.key&&(eh?eb(!1):a())};return document.addEventListener("keydown",e),()=>document.removeEventListener("keydown",e)},[a,eh]),(0,t.useEffect)(()=>{ew.current?.scrollTo({top:0,behavior:"instant"})},[e.id]),(0,t.useEffect)(()=>{em(!0),eb(!1),Promise.all([(0,c.Ug)(o,e.media_type,e.id),(0,c.fY)(o,e.media_type,e.id),(0,c.Mt)(o,e.media_type,e.id),(0,c.Pg)(o,e.media_type,e.id),(0,c.Dz)(o,e.media_type,e.id)]).then(([e,o,a,r,t])=>{g(e),b(o),ee(a),er(r),eg(t),em(!1)}).catch(()=>em(!1)),(0,c.Su)(ek,e.media_type,eM).then(eu)},[e.id,e.media_type,o,ek,eM]);let ej=f.find(e=>"YouTube"===e.site&&("Trailer"===e.type||"Teaser"===e.type)&&e.official)??f.find(e=>"YouTube"===e.site&&"Trailer"===e.type)??f.find(e=>"YouTube"===e.site),eA=(0,t.useCallback)(()=>{(0,p.dw)(e),e$(e=>!e),i?.()},[e,i]),eT=(0,t.useCallback)(()=>{(0,p.w0)(e),ez(e=>!e),i?.()},[e,i]),eS=[...Q?.flatrate??[]].filter((e,o,a)=>a.findIndex(o=>o.provider_id===e.provider_id)===o),eF=(Q?.rent??[]).filter(e=>!eS.find(o=>o.provider_id===e.provider_id)),eB=eS[0],eC=eB?(0,c.$8)(eB,ek,ex):ex??`https://tv.apple.com/search?term=${encodeURIComponent(ek)}`,eR=(0,c.U7)(e.backdrop_path??l?.backdrop_path??null,"w1280");return(0,r.jsxs)(m,{ref:ew,children:[ef&&(0,r.jsx)(w,{children:(0,r.jsx)(y,{})}),(0,r.jsxs)(x,{children:[(0,r.jsx)(u,{src:eR,children:(0,r.jsxs)(h,{children:[(0,r.jsx)($,{children:ek}),l?.tagline&&(0,r.jsxs)(v,{children:['"',l.tagline,'"']}),(0,r.jsxs)(z,{children:[(0,r.jsxs)(k,{children:[(0,r.jsx)(d.In,{name:"star",size:15,fill:"currentColor"}),e.vote_average.toFixed(1)]}),eM&&(0,r.jsxs)(M,{children:[(0,r.jsx)(d.In,{name:"calendar",size:13}),eM]}),l?.runtime&&(0,r.jsxs)(M,{children:[(0,r.jsx)(d.In,{name:"clock",size:13}),Math.floor(l.runtime/60),"h ",l.runtime%60,"m"]}),l?.number_of_seasons&&(0,r.jsxs)(M,{children:[(0,r.jsx)(d.In,{name:"monitor",size:13}),l.number_of_seasons," season",1!==l.number_of_seasons?"s":""]})]}),l?.genres&&l.genres.length>0&&(0,r.jsx)(j,{children:l.genres.map(e=>(0,r.jsx)(A,{children:e.name},e.id))}),(0,r.jsxs)(T,{children:[(0,r.jsxs)(S,{href:eC,target:"_blank",rel:"noreferrer",children:[(0,r.jsx)(d.In,{name:"play",size:16,fill:"black"}),"Watch Now"]}),ej&&(0,r.jsxs)(L,{onClick:()=>eb(!0),children:[(0,r.jsx)(d.In,{name:"film",size:15}),"Trailer"]}),(0,r.jsxs)(F,{active:ey,onClick:eA,children:[(0,r.jsx)(d.In,{name:"heart",size:14,fill:ey?"currentColor":"none"}),ey?"Favorited":"Favorite"]}),(0,r.jsxs)(F,{active:ev,onClick:eT,children:[ev?(0,r.jsx)(d.In,{name:"eye-off",size:14}):(0,r.jsx)(d.In,{name:"eye",size:14}),ev?"Unseen":"Mark Seen"]}),(ey||ev)&&(0,r.jsx)(F,{danger:!0,onClick:()=>{ey&&((0,p.dw)(e),e$(!1)),ev&&((0,p.w0)(e),ez(!1)),i?.()},children:(0,r.jsx)(d.In,{name:"trash",size:14})})]})]})}),(0,r.jsxs)(B,{children:[ef?(0,r.jsx)(es,{children:"Loading…"}):(0,r.jsx)(C,{children:e.overview}),ej&&eh&&(0,r.jsx)(E,{onClick:e=>{e.target===e.currentTarget&&eb(!1)},children:(0,r.jsxs)(I,{children:[(0,r.jsxs)(V,{onClick:()=>eb(!1),children:[(0,r.jsx)(d.In,{name:"close",size:14})," Close"]}),(0,r.jsx)(D,{children:(0,r.jsx)("iframe",{src:`https://www.youtube.com/embed/${ej.key}?autoplay=1&rel=0&modestbranding=1`,title:ej.name,allowFullScreen:!0,allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"})})]})}),(ef||eo.length>0)&&(0,r.jsxs)(R,{children:[(0,r.jsxs)(_,{children:[(0,r.jsx)(H,{children:(0,r.jsx)(d.In,{name:"users",size:15})}),(0,r.jsx)(P,{children:"Cast"})]}),ef?(0,r.jsx)(es,{children:"Loading cast…"}):(0,r.jsx)(Y,{children:eo.map(e=>(0,r.jsxs)(N,{children:[e.profile_path?(0,r.jsx)(K,{src:(0,c.DW)(e.profile_path,"w185"),alt:e.name,loading:"lazy"}):(0,r.jsx)(U,{children:"\uD83D\uDC64"}),(0,r.jsxs)(G,{children:[(0,r.jsx)(O,{children:e.name}),e.character&&(0,r.jsx)(W,{children:e.character})]})]},e.id))})]}),(0,r.jsxs)(R,{children:[(0,r.jsxs)(_,{children:[(0,r.jsx)(H,{children:(0,r.jsx)(d.In,{name:"monitor",size:15})}),(0,r.jsx)(P,{children:"Where to Watch"})]}),ef?(0,r.jsx)(es,{children:"Loading streaming info…"}):eS.length>0?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(X,{children:eS.map(e=>(0,r.jsx)(ed,{provider:e,title:ek,appleTVUrl:ex},e.provider_id))}),eF.length>0&&(0,r.jsxs)("div",{style:{marginTop:8},children:[(0,r.jsx)(en,{children:"Also available to rent"}),(0,r.jsx)(X,{children:eF.map(e=>(0,r.jsxs)(et,{bg:c.RY[e.provider_name]??s.w4.colors.surface,children:[e.logo_path&&(0,r.jsx)(ei,{src:(0,c.vo)(e.logo_path),alt:e.provider_name}),(0,r.jsx)(ea,{style:{color:"#fff"},children:e.provider_name})]},e.provider_id))})]})]}):(Q?.rent??[]).length>0?(0,r.jsxs)("div",{children:[(0,r.jsx)(el,{children:"Not on any streaming subscription right now."}),(0,r.jsx)(en,{style:{marginTop:12},children:"Available to rent"}),(0,r.jsx)(X,{children:(Q?.rent??[]).map(e=>(0,r.jsxs)(et,{bg:c.RY[e.provider_name]??s.w4.colors.surface,children:[e.logo_path&&(0,r.jsx)(ei,{src:(0,c.vo)(e.logo_path),alt:e.provider_name}),(0,r.jsx)(ea,{style:{color:"#fff"},children:e.provider_name})]},e.provider_id))})]}):(0,r.jsx)(el,{children:"No streaming info available for your region (US)."})]}),ep.length>0&&(0,r.jsxs)(R,{children:[(0,r.jsxs)(_,{children:[(0,r.jsx)(H,{children:(0,r.jsx)(d.In,{name:"star",size:15})}),(0,r.jsx)(P,{children:"You Might Also Like"})]}),(0,r.jsx)(Y,{children:ep.map(e=>(0,r.jsxs)(Z,{onClick:()=>n?.(e),children:[(0,c.HD)(e.poster_path)?(0,r.jsx)(J,{src:(0,c.HD)(e.poster_path,"w185"),alt:(0,c.rS)(e),loading:"lazy"}):(0,r.jsx)(q,{children:"\uD83C\uDFAC"}),(0,r.jsxs)(G,{children:[(0,r.jsx)(O,{children:(0,c.rS)(e)}),(0,r.jsxs)(W,{children:[(0,r.jsx)(d.In,{name:"star",size:9,fill:"#e3b341",color:"#e3b341",style:{verticalAlign:-1}})," ",e.vote_average.toFixed(1)," \xb7 ",(0,c.Ox)(e)]})]})]},e.id))})]})]})]})]})}},1620(e,o,a){a.d(o,{K:()=>P});var r=a(5723),t=a(7991),i=a.n(t),n=a(2727),l=a.n(n),s=a(6859),d=a.n(s),c=a(2799),p=a(9874),g=a(8311),f=a(1801);let m=(0,c.keyframes)`
...
`,b=d().div`
  ...
  z-index: 1101;
  animation: ${m} 0.28s cubic-bezier(0.22, 1, 0.36, 1);
  overflow: hidden;
...
`,R={8:"#E50914",337:"#113CCF",9:"#00A8E0",350:"#555",1899:"#002BE7",15:"#3DBB3D",386:"#D0A42C",531:"#0064FF",283:"#F47521",11:"#5C3317"},_=[[28,"Action"],[12,"Adventure"],[16,"Animation"],[35,"Comedy"],[80,"Crime"],[18,"Drama"],[14,"Fantasy"],[27,"Horror"],[9648,"Mystery"],[10749,"Romance"],[878,"Sci-Fi"],[53,"Thriller"],[37,"Western"],[99,"Documentary"]];function H(e,o){return e.includes(o)?e.filter(e=>e!==o):[...e,o]}function P({filters:e,onChange:o,onClose:a}){let[n,s]=i().useState(()=>({genres:[...e.genres],providerIds:[...e.providerIds],decades:[...e.decades]})),d=n.genres.length+n.providerIds.length+n.decades.length,c=(0,t.useCallback)(()=>{s({genres:[],providerIds:[],decades:[]})},[]),p=(0,t.useCallback)(()=>{o(n),a()},[o,a,n]),m=(0,t.useCallback)(e=>{e.target===e.currentTarget&&a()},[a]);return l().createPortal((0,r.jsx)(h,{onClick:m,children:(0,r.jsxs)(b,{children:[(0,r.jsxs)(w,{children:[(0,r.jsxs)(y,{children:["Filter",d>0?` \xb7 ${d}`:""]}),(0,r.jsxs)($,{children:[d>0&&(0,r.jsxs)(v,{onClick:c,children:[(0,r.jsx)(g.In,{name:"rotate-ccw",size:12}),"Reset"]}),(0,r.jsx)(z,{onClick:a,"aria-label":"Close filters",children:(0,r.jsx)(g.In,{name:"close",size:16})})]})]}),(0,r.jsxs)(k,{children:[(0,r.jsxs)(M,{children:[(0,r.jsx)(j,{children:"Genre"}),(0,r.jsx)(A,{children:_.map(([e,o])=>(0,r.jsxs)(T,{active:n.genres.includes(e),onClick:()=>s(o=>({...o,genres:H(o.genres,e)})),children:[n.genres.includes(e)&&(0,r.jsx)(g.In,{name:"check",size:10}),o]},e))})]}),(0,r.jsxs)(M,{children:[(0,r.jsx)(j,{children:"Streaming Platform"}),(0,r.jsx)(A,{children:f.Mw.map(e=>{let o=R[e.id]??"#888",a=n.providerIds.includes(e.id);return(0,r.jsxs)(S,{active:a,color:o,onClick:()=>s(o=>({...o,providerIds:H(o.providerIds,e.id)})),children:[(0,r.jsx)(F,{bg:o}),e.name,a&&(0,r.jsx)(g.In,{name:"check",size:10})]},e.id)})})]}),(0,r.jsxs)(M,{children:[(0,r.jsx)(j,{children:"Era / Decade"}),(0,r.jsx)(A,{children:f.c0.map(e=>(0,r.jsxs)(T,{active:n.decades.includes(e),onClick:()=>s(o=>({...o,decades:H(o.decades,e)})),children:[n.decades.includes(e)&&(0,r.jsx)(g.In,{name:"check",size:10}),e]},e))})]})]}),(0,r.jsx)(B,{children:(0,r.jsx)(C,{hasFilters:d>0,onClick:p,children:d>0?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(g.In,{name:"check",size:15})," Apply ",d," filter",1!==d?"s":""]}):"No filters active"})})]})}),document.body)}},1801(e,o,a){a.d(o,{$8:()=>u,$P:()=>S,DW:()=>l,Dz:()=>_,HD:()=>t,Kk:()=>A,Mt:()=>C,Mw:()=>c,N2:()=>d,NE:()=>v,Ox:()=>b,Pg:()=>R,RY:()=>p,Su:()=>g,U7:()=>i,Ug:()=>F,Zy:()=>M,_F:()=>k,ag:()=>T,c0:()=>y,eN:()=>j,fY:()=>B,mS:()=>m,rS:()=>h,vo:()=>n,zJ:()=>r.setMoviesAgeMode});var r=a(3711);let t=(e,o="w342")=>(0,r.tmdbPosterUrl)(e,o),i=(e,o="w1280")=>(0,r.tmdbBackdropUrl)(e,o),n=(e,o="w92")=>(0,r.tmdbLogoUrl)(e,o),l=(e,o="w185")=>(0,r.tmdbProfileUrl)(e,o);function s(e){return{apiKey:e,includeAdult:"adult"===(0,r.getMoviesAgeMode)()}}let d={28:"Action",12:"Adventure",16:"Animation",35:"Comedy",80:"Crime",99:"Documentary",18:"Drama",10751:"Family",14:"Fantasy",36:"History",27:"Horror",10402:"Music",9648:"Mystery",10749:"Romance",878:"Sci-Fi",53:"Thriller",10752:"War",37:"Western",10759:"Action & Adventure",10762:"Kids",10765:"Sci-Fi & Fantasy",10768:"War & Politics",10766:"Soap",10767:"Talk",10763:"News",10764:"Reality"},c=[{id:8,name:"Netflix"},{id:337,name:"Disney+"},{id:9,name:"Amazon Prime"},{id:350,name:"Apple TV+"},{id:384,name:"HBO Max"},{id:1899,name:"Max"},{id:15,name:"Hulu"},{id:386,name:"Peacock"},{id:531,name:"Paramount+"},{id:283,name:"Crunchyroll"},{id:11,name:"MUBI"}],p={Netflix:"#E50914","Disney Plus":"#113CCF","Disney+":"#113CCF","Amazon Prime Video":"#00A8E0","Prime Video":"#00A8E0","Apple TV Plus":"#1C1C1E","Apple TV+":"#1C1C1E","HBO Max":"#552093",Max:"#002BE7",Hulu:"#3DBB3D",Peacock:"#D0A42C","Paramount Plus":"#0064FF","Paramount+":"#0064FF",Crunchyroll:"#F47521",Mubi:"#5C3317"};async function g(e,o,a){let t=await (0,r.searchItunes)({term:e,country:"us",media:"movie"===o?"movie":"tvShow",entity:"movie"===o?"movie":"tvSeason",limit:5}),i=t?.results??[];if(!i.length)return`https://tv.apple.com/search?term=${encodeURIComponent(e)}`;let n=i[0];if(a){let e=parseInt(a,10),o=i.find(o=>String(o.releaseDate??"").startsWith(String(e)));o&&(n=o)}return n.trackViewUrl??n.collectionViewUrl??`https://tv.apple.com/search?term=${encodeURIComponent(e)}`}let f=new Set([337,9,350,384,1899,386]);function m(e){return f.has(e)}let x={8:e=>`https://www.netflix.com/search?q=${encodeURIComponent(e)}`,15:e=>`https://www.hulu.com/search?q=${encodeURIComponent(e)}`,531:e=>`https://www.paramountplus.com/search/?q=${encodeURIComponent(e)}`,283:e=>`https://www.crunchyroll.com/search?q=${encodeURIComponent(e)}`,11:e=>`https://mubi.com/en/search?query=${encodeURIComponent(e)}`};function u(e,o,a){let r=x[e.provider_id];return r?r(o):(f.has(e.provider_id),a??`https://tv.apple.com/search?term=${encodeURIComponent(o)}`)}function h(e){return e.title??e.name??"Unknown"}function b(e){return(e.release_date??e.first_air_date??"").slice(0,4)}let w={"2020s":[2020,2029],"2010s":[2010,2019],"2000s":[2e3,2009],"1990s":[1990,1999],"1980s":[1980,1989],Classic:[1900,1979]},y=Object.keys(w);function $(e,o){return(e?.results??[]).map(e=>({...e,media_type:o}))}async function v(e,o,a){let t={sort_by:"popularity.desc"};a.genres.length&&(t.with_genres=a.genres.join("|")),a.providerIds.length&&(t.with_watch_providers=a.providerIds.join("|"),t.watch_region="US");let{from:i,to:n}=function(e){if(!e.length)return{};let o=e.map(e=>w[e]).filter(Boolean);return{from:Math.min(...o.map(([e])=>e)),to:Math.max(...o.map(([,e])=>e))}}(a.decades);if(i&&(t["primary_release_date.gte"]=`${i}-01-01`,t["first_air_date.gte"]=`${i}-01-01`),n&&(t["primary_release_date.lte"]=`${n}-12-31`,t["first_air_date.lte"]=`${n}-12-31`),"all"===o){let[o,a]=await Promise.all([(0,r.fetchTmdbDiscover)("movie",s(e),t),(0,r.fetchTmdbDiscover)("tv",s(e),t)]),i=[...$(o,"movie"),...$(a,"tv")].sort((e,o)=>(o.popularity??0)-(e.popularity??0)||o.vote_average-e.vote_average);return(0,r.filterMoviesByAge)(i)}let l=await (0,r.fetchTmdbDiscover)(o,s(e),t);return(0,r.filterMoviesByAge)($(l,o))}let z={with_genres:"10751",sort_by:"popularity.desc","vote_count.gte":"50"};async function k(e){if("kid"===(0,r.getMoviesAgeMode)()){let[o,a]=await Promise.all([(0,r.fetchTmdbDiscover)("movie",s(e),z),(0,r.fetchTmdbDiscover)("tv",s(e),z)]),t=[...$(o,"movie"),...$(a,"tv")].sort((e,o)=>(o.popularity??0)-(e.popularity??0));return(0,r.filterMoviesByAge)(t)}let o=await (0,r.fetchTmdbTrending)(s(e)),a=o?.results??[];return(0,r.filterMoviesByAge)(a.filter(e=>"movie"===e.media_type||"tv"===e.media_type).map(e=>e))}async function M(e){let o="kid"===(0,r.getMoviesAgeMode)()?await (0,r.fetchTmdbDiscover)("movie",s(e),z):await (0,r.fetchTmdbPopular)("movie",s(e));return(0,r.filterMoviesByAge)($(o,"movie"))}async function j(e){let o="kid"===(0,r.getMoviesAgeMode)()?await (0,r.fetchTmdbDiscover)("tv",s(e),z):await (0,r.fetchTmdbPopular)("tv",s(e));return(0,r.filterMoviesByAge)($(o,"tv"))}async function A(e,o){let a="kid"===(0,r.getMoviesAgeMode)()?await (0,r.fetchTmdbDiscover)(o,s(e),{...z,sort_by:"vote_average.desc","vote_count.gte":"500"}):await (0,r.fetchTmdbTopRated)(o,s(e));return(0,r.filterMoviesByAge)($(a,o))}async function T(e){let[o,a]=await Promise.all([(0,r.fetchTmdbDiscover)("movie",s(e),{with_genres:"99",sort_by:"popularity.desc"}),(0,r.fetchTmdbDiscover)("tv",s(e),{with_genres:"99",sort_by:"popularity.desc"})]),t=[...$(o,"movie"),...$(a,"tv")].sort((e,o)=>o.vote_average-e.vote_average);return(0,r.filterMoviesByAge)(t)}async function S(e,o){let a=await (0,r.fetchTmdbSearchMulti)(o,s(e)),t=a?.results??[];return(0,r.filterMoviesByAge)(t.filter(e=>"movie"===e.media_type||"tv"===e.media_type).map(e=>e))}async function F(e,o,a){let t=await (0,r.fetchTmdbDetail)(o,a,s(e));if(!t)throw Error(`TMDB detail failed for ${o}/${a}`);return{...t,media_type:o}}async function B(e,o,a){let t=await (0,r.fetchTmdbVideos)(o,a,s(e));return t?.results??[]}async function C(e,o,a,t="US"){let i=await (0,r.fetchTmdbWatchProviders)(o,a,s(e));return i?.results?.[t]??{}}async function R(e,o,a){let t=await (0,r.fetchTmdbCredits)(o,a,s(e));return(t?.cast??[]).sort((e,o)=>e.order-o.order).slice(0,20)}async function _(e,o,a){let t=await (0,r.fetchTmdbRecommendations)(o,a,s(e));return(t?.results??[]).filter(e=>e.poster_path).map(e=>({...e,media_type:e.media_type??o})).slice(0,15)}},4956(e,o,a){a.d(o,{BA:()=>s,GB:()=>c,U4:()=>p,dw:()=>d,qx:()=>l,w0:()=>g});let r="atlantis:movies:favorites",t="atlantis:movies:seen";function i(e){try{return JSON.parse(localStorage.getItem(e)??"[]")}catch{return[]}}function n(e,o){try{localStorage.setItem(e,JSON.stringify(o))}catch{}}function l(){return i(r)}function s(e){return l().some(o=>o.id===e.id&&o.media_type===e.media_type)}function d(e){let o=l(),a=o.some(o=>o.id===e.id&&o.media_type===e.media_type)?o.filter(o=>o.id!==e.id||o.media_type!==e.media_type):[e,...o];return n(r,a),a}function c(){return i(t)}function p(e){return c().some(o=>o.id===e.id&&o.media_type===e.media_type)}function g(e){let o,a,r;return p(e)?(n(t,o=c().filter(o=>o.id!==e.id||o.media_type!==e.media_type)),o):(a=c().filter(o=>o.id!==e.id||o.media_type!==e.media_type),n(t,r=[e,...a].slice(0,15)),r)}},7330(e,o,a){a.d(o,{FlyoutPanel:()=>e_});var r=a(5723),t=a(7991),i=a.n(t),n=a(6859),l=a.n(n),s=a(2799),d=a(1316),c=a(814),p=a(6896),g=a(7902),f=a(3013),m=a(2887),x=a(9510),u=a(9848),h=a(7901),b=a(3045),w=a(3775),y=a(1783),$=a(3539),v=a(9416),z=a(1837),k=a(7167),M=a(4494),j=a(2314),A=a(255),T=a(5751),S=a(9633),F=a(2946),B=a(822),C=a(6720),R=a(7400),_=a(8456),H=a(3317),P=a(2709),L=a(8006),E=a(9301),I=a(7561),D=a(3517),V=a(8207),Y=a(7032),N=a(6949),K=a(8218),U=a(6829),G=a(9591),O=a(5553),W=a(9923),Z=a(2820),J=a(4621),q=a(8479),X=a(2534),Q=a(6673),ee=a(7490),eo=a(9033),ea=a(9038),er=a(5775),et=a(1365),ei=a(2937),en=a(9821),el=a(5912),es=a(158),ed=a(8641),ec=a(8607),ep=a(3249),eg=a(1821),ef=a(5889),em=a(9655),ex=a(7170),eu=a(9161),eh=a(1849),eb=a(1604),ew=a(3142),ey=a(1187),e$=a(7747),ev=a(2932),ez=a(4525),ek=a(7230),eM=a(2164);let ej={activity:p.A,"a-large-small":g.A,apple:f.A,"arrow-right":m.A,"bar-chart-2":x.A,book:u.A,"book-open":h.A,briefcase:b.A,calendar:w.A,clock:y.A,"circle-dot":$.A,cloud:v.A,compass:z.A,cpu:k.A,droplets:M.A,feather:j.A,file:A.A,"file-text":T.A,folder:S.A,"git-branch":F.A,github:B.A,globe:C.A,grid:R.A,hand:_.A,hash:H.A,heart:P.A,key:L.A,hexagon:E.A,home:I.A,landmark:D.A,layers:V.A,"layout-grid":Y.A,leaf:N.A,lightbulb:K.A,list:U.A,map:G.A,"map-pin":O.A,"message-circle":W.A,"message-square":Z.A,minus:J.A,monitor:q.A,mountain:X.A,package:Q.A,palette:ee.A,"pen-tool":eo.A,"pie-chart":ea.A,plane:er.A,plus:et.A,ruler:ei.A,shirt:en.A,slash:el.A,square:es.A,star:ed.A,sun:ec.A,terminal:ep.A,thermometer:eg.A,triangle:ef.A,trophy:em.A,truck:ex.A,type:eu.A,users:eh.A,"volume-2":eb.A,watch:ew.A,waves:ey.A,wind:e$.A,wrench:ev.A,x:ez.A,zap:ek.A,bot:eM.A},eA=(0,s.keyframes)`
...
`,eB=({size:e=14,strokeWidth:o=1.75})=>(0,r.jsxs)("svg",{width:e,height:e,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:o,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,r.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,r.jsx)("polyline",{points:"14 2 14 8 20 8"})]});function eC({iconKey:e}){let o=e?ej[e]:null;return o?(0,r.jsx)(o,{size:14,strokeWidth:1.75}):(0,r.jsx)(eB,{})}function eR({entries:e,activeId:o,onSelect:a}){return(0,r.jsx)(r.Fragment,{children:e.map(e=>e.children?(0,r.jsx)(i().Fragment,{children:(0,r.jsx)(eR,{entries:e.children,activeId:o,onSelect:a})},e.id):(0,r.jsxs)(eF,{active:o===e.id,onClick:()=>a(e),children:[(0,r.jsx)(eC,{iconKey:e.icon}),e.name]},e.id))})}function e_({activeId:e}){let{flyout:o,scheduleFlyoutClose:a,cancelFlyoutClose:t}=(0,c.c)();if(!o)return null;let i=o.entry.icon?ej[o.entry.icon]:null;return(0,r.jsxs)(eT,{anchorY:o.anchorY,onMouseEnter:t,onMouseLeave:a,children:[(0,r.jsxs)(eS,{children:[i?(0,r.jsx)(i,{size:13,strokeWidth:2}):(0,r.jsx)(eB,{size:13,strokeWidth:2}),o.entry.name]}),(0,r.jsx)(eR,{entries:o.entry.children??[],activeId:e,onSelect:e=>{o.onSelect(e),a()}})]})}},814(e,o,a){a.d(o,{I:()=>t,c:()=>i});var r=a(7991);let t=(0,r.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),i=()=>(0,r.useContext)(t)},9874(e,o,a){a.d(o,{PL:()=>C.getSetting,PE:()=>F,fy:()=>P,w4:()=>r.w4});var r=a(1316),t=a(5723),i=a(7991),n=a.n(i),l=a(6859),s=a.n(l);s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,j=s().main`
  ...
  display: flex;
  flex-direction: column;
`,A=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function T(){return(0,t.jsx)(b,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:A.map((e,o)=>(0,t.jsx)(w,{index:o,accent:e.accent,children:e.char},o))})}let S="atlantis:sidebar-collapsed";function F({sidebar:e,children:o,topBarRight:r,title:l="Atlantis",activeId:s=null}){let[d,p]=(0,i.useState)(()=>{try{return"true"===localStorage.getItem(S)}catch{return!1}}),[g,f]=(0,i.useState)(null),h=(0,i.useRef)(),b=()=>p(e=>{let o=!e;try{localStorage.setItem(S,String(o))}catch{}return o}),w=n().useMemo(()=>n().lazy(()=>Promise.resolve().then(a.bind(a,7330)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,t.jsx)(c.I.Provider,{value:{collapsed:d,toggle:b,flyout:g,openFlyout:(e,o,a)=>{clearTimeout(h.current),f({entry:e,anchorY:o,onSelect:a})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>f(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,t.jsxs)(z,{children:[(0,t.jsxs)(m,{children:[e&&(0,t.jsx)(x,{children:(0,t.jsx)(u,{onClick:b,title:d?"Expand sidebar":"Collapse sidebar",children:(0,t.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("path",{d:"M9 3v18"})]})})}),(0,t.jsx)(T,{}),l&&(0,t.jsx)(y,{children:l}),r&&(0,t.jsx)($,{children:r})]}),(0,t.jsxs)(v,{children:[null!=e&&(0,t.jsx)(k,{collapsed:d,children:(0,t.jsx)(M,{children:e})}),(0,t.jsx)(j,{children:o})]}),g&&(0,t.jsx)(n().Suspense,{fallback:null,children:(0,t.jsx)(w,{activeId:s})})]})})}s().div`
  display: grid;
...
`,_=(0,d.keyframes)`
  ...
  to   { opacity: 1; transform: scale(1)    translateY(0);   }
`;function H(){let e="u">typeof window?window.location.hash:"",o=e.indexOf("?");if(-1===o)return{};let a={};for(let r of e.slice(o+1).split("&")){if(!r)continue;let e=r.indexOf("=");-1===e?a[decodeURIComponent(r)]="":a[decodeURIComponent(r.slice(0,e))]=decodeURIComponent(r.slice(e+1))}return a}function P(){let[e,o]=(0,i.useState)(H);return(0,i.useEffect)(()=>{let e=()=>o(H());return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[]),e}s().div`
  position: fixed;
  inset: 0;
...
`;let x={default:n.w4.colors.accent,danger:"#f85149"},u={default:n.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"};i().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
