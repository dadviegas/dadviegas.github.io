...
`,l().div`
  position: relative;
`;let N="260px",O="56px",W="44px",G=l().header`
  display: flex;
  align-items: center;
...
`;function eu({iconKey:e,size:o=16}){let r=e?ed.X[e]:void 0;return r?(0,t.jsx)("svg",{width:o,height:o,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,dangerouslySetInnerHTML:{__html:r}}):e?(0,t.jsx)("span",{style:{fontSize:o,lineHeight:1,display:"flex",alignItems:"center"},children:e}):(0,t.jsxs)("svg",{width:o,height:o,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,children:[(0,t.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,t.jsx)("polyline",{points:"14 2 14 8 20 8"})]})}function ey({entry:e,activeId:o,onSelect:r}){let[i,n]=(0,a.useState)(e.defaultOpen??!0),{collapsed:l,openFlyout:s,scheduleFlyoutClose:d,cancelFlyoutClose:c}=(0,B.c)();return e.children&&e.children.length>0?(0,t.jsxs)(eh,{children:[(0,t.jsxs)(ex,{collapsed:l,onClick:()=>{l||n(e=>!e)},onMouseEnter:l?o=>{s(e,o.currentTarget.getBoundingClientRect().top,r)}:void 0,onMouseLeave:l?d:void 0,children:[(0,t.jsxs)(ef,{collapsed:l,children:[(0,t.jsx)(eu,{iconKey:e.icon,size:16}),(0,t.jsx)(em,{collapsed:l,children:e.name})]}),(0,t.jsx)(eb,{open:i,collapsed:l,children:(0,t.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round",children:(0,t.jsx)("path",{d:"M9 6l6 6-6 6"})})})]}),(0,t.jsx)(ec,{open:i&&!l,children:(0,t.jsx)(ep,{children:(0,t.jsx)(eg,{children:e.children.map(e=>(0,t.jsx)(ey,{entry:e,activeId:o,onSelect:r},e.id))})})})]}):(0,t.jsxs)(ew,{active:o===e.id,collapsed:l,onClick:()=>r(e),onMouseEnter:l?o=>{let t=o.currentTarget.getBoundingClientRect();s({id:e.id,name:e.name,icon:e.icon,file:e.file,children:[e]},t.top,r)}:void 0,onMouseLeave:l?d:void 0,children:[(0,t.jsx)(eu,{iconKey:e.icon,size:15}),(0,t.jsx)(em,{collapsed:l,children:e.name})]})}function e$({entries:e,activeId:o,onSelect:r}){return(0,t.jsx)("div",{children:e.map(e=>(0,t.jsx)(ey,{entry:e,activeId:o,onSelect:r},e.id))})}r(2787),l().div`
