...
`},7330(o,e,a){a.d(e,{FlyoutPanel:()=>oR});var t=a(5723),r=a(7991),n=a.n(r),i=a(6859),l=a.n(i),s=a(2799),d=a(255),c=a(1316),p=a(814),g=a(6896),m=a(7902),f=a(3013),u=a(2887),x=a(9510),b=a(9848),y=a(7901),w=a(3045),h=a(3775),$=a(1783),z=a(3539),v=a(9416),k=a(1837),A=a(7167),M=a(4494),T=a(2314),S=a(5751),F=a(9633),j=a(2946),B=a(822),P=a(6720),R=a(7400),E=a(8456),C=a(3317),D=a(2709),L=a(8006),H=a(9301),N=a(7561),I=a(3517),Y=a(8207),G=a(7032),K=a(6949),O=a(8218),V=a(6829),_=a(9591),J=a(5553),W=a(9923),U=a(2820),Z=a(4621),q=a(8479),X=a(2534),Q=a(6673),oo=a(7490),oe=a(9033),oa=a(9038),ot=a(5775),or=a(1365),on=a(2937),oi=a(9821),ol=a(5912),os=a(158),od=a(8641),oc=a(8607),op=a(3249),og=a(1821),om=a(5889),of=a(9655),ou=a(7170),ox=a(9161),ob=a(1849),oy=a(1604),ow=a(3142),oh=a(1187),o$=a(7747),oz=a(2932),ov=a(4525),ok=a(7230),oA=a(2164);let oM={activity:g.A,"a-large-small":m.A,apple:f.A,"arrow-right":u.A,"bar-chart-2":x.A,book:b.A,"book-open":y.A,briefcase:w.A,calendar:h.A,clock:$.A,"circle-dot":z.A,cloud:v.A,compass:k.A,cpu:A.A,droplets:M.A,feather:T.A,file:d.A,"file-text":S.A,folder:F.A,"git-branch":j.A,github:B.A,globe:P.A,grid:R.A,hand:E.A,hash:C.A,heart:D.A,key:L.A,hexagon:H.A,home:N.A,landmark:I.A,layers:Y.A,"layout-grid":G.A,leaf:K.A,lightbulb:O.A,list:V.A,map:_.A,"map-pin":J.A,"message-circle":W.A,"message-square":U.A,minus:Z.A,monitor:q.A,mountain:X.A,package:Q.A,palette:oo.A,"pen-tool":oe.A,"pie-chart":oa.A,plane:ot.A,plus:or.A,ruler:on.A,shirt:oi.A,slash:ol.A,square:os.A,star:od.A,sun:oc.A,terminal:op.A,thermometer:og.A,triangle:om.A,trophy:of.A,truck:ou.A,type:ox.A,users:ob.A,"volume-2":oy.A,watch:ow.A,waves:oh.A,wind:o$.A,wrench:oz.A,x:ov.A,zap:ok.A,bot:oA.A},oT=(0,s.keyframes)`
...
`,s().div`
  position: relative;
`;var d=a(2799),c=a(3661),p=a(814);let g="260px",m="56px",f=s().header`
  display: flex;
  align-items: center;
...
`,M=s().main`
  ...
  display: flex;
  flex-direction: column;
`,T=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function S(){return(0,r.jsx)(y,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:T.map((o,e)=>(0,r.jsx)(w,{index:e,accent:o.accent,children:o.char},e))})}let F="atlantis:sidebar-collapsed";function j({sidebar:o,children:e,topBarRight:t,title:l="Atlantis",activeId:s=null}){let[d,g]=(0,n.useState)(()=>{try{return"true"===localStorage.getItem(F)}catch{return!1}}),[m,b]=(0,n.useState)(null),y=(0,n.useRef)(),w=()=>g(o=>{let e=!o;try{localStorage.setItem(F,String(e))}catch{}return e}),T=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(a.bind(a,7330)).then(o=>({default:o.FlyoutPanel}))),[]);return(0,r.jsx)(p.I.Provider,{value:{collapsed:d,toggle:w,flyout:m,openFlyout:(o,e,a)=>{clearTimeout(y.current),b({entry:o,anchorY:e,onSelect:a})},scheduleFlyoutClose:()=>{y.current=setTimeout(()=>b(null),160)},cancelFlyoutClose:()=>clearTimeout(y.current)},children:(0,r.jsxs)(v,{children:[(0,r.jsxs)(f,{children:[o&&(0,r.jsx)(u,{children:(0,r.jsx)(x,{onClick:w,title:d?"Expand sidebar":"Collapse sidebar",children:(0,r.jsx)(c.A,{size:17})})}),(0,r.jsx)(S,{}),l&&(0,r.jsx)(h,{children:l}),t&&(0,r.jsx)($,{children:t})]}),(0,r.jsxs)(z,{children:[null!=o&&(0,r.jsx)(k,{collapsed:d,children:(0,r.jsx)(A,{children:o})}),(0,r.jsx)(M,{children:e})]}),m&&(0,r.jsx)(i().Suspense,{fallback:null,children:(0,r.jsx)(T,{activeId:s})})]})})}s().div`
  display: grid;
...
`;let I="shell:profile",Y="atlantis:profile-change",G=["tech","movies","learning","games","news","space"],K={interests:[],ageMode:"adult"};function O(o){return o&&"object"==typeof o?{interests:Array.isArray(o.interests)?o.interests.filter(o=>G.includes(o)):[],ageMode:"kid"===o.ageMode||"teen"===o.ageMode||"adult"===o.ageMode?o.ageMode:"adult"}:K}function V(){let[o,e]=(0,n.useState)(K);return(0,n.useEffect)(()=>{let o=!1;N(I).then(a=>{if(!o&&a)try{e(O(JSON.parse(a)))}catch{}});let a=o=>{let a=o.detail;a&&e(a)};return window.addEventListener(Y,a),()=>{o=!0,window.removeEventListener(Y,a)}},[]),[o,(0,n.useCallback)(async o=>{let a=O(o);e(a),window.dispatchEvent(new CustomEvent(Y,{detail:a})),await H(I,JSON.stringify(a))},[])]}s().div`
...
`,y=n().forwardRef(function({variant:o="ghost",size:e="md",icon:a,iconRight:r,children:n,...i},l){return(0,t.jsxs)(b,{ref:l,variant:o,size:e,...i,children:[a,n,r]})}),w={default:s.w4.colors.accent,danger:"#f85149"},h={default:s.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"},$=l().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`;var v=a(2799);let k=(0,v.keyframes)`
