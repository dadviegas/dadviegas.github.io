"use strict";(self.webpackChunk_atlantis_playground=self.webpackChunk_atlantis_playground||[]).push([[916],{4914(n,a,o){o.d(a,{FlyoutPanel:()=>z});var e=o(7359),t=o(3233),i=o(7207),r=o(255),l=o(217),s=o(5959),c=o(5185),d=o(5723);const m=i.keyframes`
...
`;function p({iconKey:n}){const a=n?c.t[n]??r.A:r.A;return(0,d.jsx)(a,{size:14,strokeWidth:1.75})}function y({entries:n,activeId:a,onSelect:o}){return(0,d.jsx)(d.Fragment,{children:n.map(n=>n.children?(0,d.jsx)(e.Fragment,{children:(0,d.jsx)(y,{entries:n.children,activeId:a,onSelect:o})},n.id):(0,d.jsxs)(f,{active:a===n.id,onClick:()=>o(n),children:[(0,d.jsx)(p,{iconKey:n.icon}),n.name]},n.id))})}function z({activeId:n}){const{flyout:a,scheduleFlyoutClose:o,cancelFlyoutClose:e}=(0,s.c)();if(!a)return null;const t=a.entry.icon?c.t[a.entry.icon]??r.A:r.A;return(0,d.jsxs)(g,{anchorY:a.anchorY,onMouseEnter:e,onMouseLeave:o,children:[(0,d.jsxs)(u,{children:[(0,d.jsx)(t,{size:13,strokeWidth:2}),a.entry.name]}),(0,d.jsx)(y,{entries:a.entry.children??[],activeId:n,onSelect:n=>{a.onSelect(n),o()}})]})}},5959(n,a,o){o.d(a,{c:()=>i});var e=o(7359);const t=(0,e.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),i=()=>(0,e.useContext)(t)},5185(n,a,o){o.d(a,{t:()=>V});var e=o(9510),t=o(9038),i=o(8207),r=o(6896),l=o(7901),s=o(9848),c=o(2164),d=o(3775),m=o(3539),g=o(1783),u=o(1837),f=o(2314),p=o(5751),y=o(255),z=o(9633),b=o(2946),x=o(822),h=o(6720),w=o(3317),A=o(2709),v=o(3517),k=o(7032),$=o(6949),S=o(8218),M=o(6829),B=o(5553),j=o(9591),E=o(2820),T=o(4621),P=o(6673),C=o(9033),L=o(1365),D=o(5912),R=o(8641),I=o(3249),F=o(1821),N=o(9161),K=o(1849),H=o(7747),G=o(2932),_=o(4525),Y=o(7230);const V={activity:r.A,"bar-chart-2":e.A,book:s.A,"book-open":l.A,calendar:d.A,clock:g.A,"circle-dot":m.A,feather:f.A,"file-text":p.A,globe:h.A,hash:w.A,heart:A.A,landmark:v.A,layers:i.A,leaf:$.A,map:j.A,package:P.A,compass:u.A,"git-branch":b.A,github:x.A,minus:T.A,terminal:I.A,thermometer:F.A,users:K.A,wind:H.A,"pie-chart":t.A,plus:L.A,slash:D.A,star:R.A,zap:Y.A,bot:c.A,lightbulb:S.A,"message-square":E.A,wrench:G.A,x:_.A,"layout-grid":k.A,list:M.A,file:y.A,folder:z.A,"map-pin":B.A,"pen-tool":C.A,type:N.A}},4079(n,a,o){o.d(a,{UO:()=>N,MJ:()=>k,KL:()=>f,w4:()=>e.w,mZ:()=>p});var e=o(217),t=o(7359),i=o(3233),r=o(5723);i.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,x=i.default.input`
  ...
  &:focus { border-color: ${e.w.colors.accent}; }
  &::placeholder { color: ${e.w.colors.sidebarTextMuted}; }
`,h=i.default.div`
  display: flex;
  gap: 10px;
  justify-content: flex-end;
`,w=i.default.button`
  ...
  background: ${({primary:n,danger:a})=>a?"rgba(248,81,73,0.15)":n?e.w.colors.accent:"none"};
  color: ${({primary:n,danger:a})=>a?"#f85149":n?"#fff":e.w.colors.mainText};
  border: 1px solid ${({primary:n,danger:a})=>a?"#f85149":n?e.w.colors.accent:e.w.colors.border};

  &:hover { opacity: 0.85; }
  &:disabled { opacity: 0.4; cursor: default; }
`,A=i.default.div`
  height: 1px;
  background: ${e.w.colors.border};
  margin: 0 -4px;
`,v=i.default.div`
  font-size: 11px;
  color: ${e.w.colors.sidebarTextMuted};
  font-family: ${e.w.typography.fontFamily};
`;function k({onSave:n,onUpdate:a,onCancel:o,existingDoc:e}){const[i,l]=(0,t.useState)(e?.name??""),s=(0,t.useRef)(null);return(0,t.useEffect)(()=>{s.current?.focus(),e&&s.current?.select()},[e]),(0,r.jsx)(y,{onClick:o,children:(0,r.jsxs)(z,{onClick:n=>n.stopPropagation(),children:[(0,r.jsx)(b,{children:"Save document"}),e&&a&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(v,{children:"Update the current version or save as a new one."}),(0,r.jsxs)(h,{children:[(0,r.jsx)(w,{onClick:o,children:"Cancel"}),(0,r.jsxs)(w,{danger:!0,onClick:a,children:['Update "',e.name,'"']})]}),(0,r.jsx)(A,{})]}),(0,r.jsx)(x,{ref:s,value:i,onChange:n=>l(n.target.value),onKeyDown:t=>{"Enter"===t.key&&i.trim()&&(e&&i.trim()===e.name&&a?a():n(i.trim())),"Escape"===t.key&&o()},placeholder:e?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,r.jsxs)(h,{children:[!e&&(0,r.jsx)(w,{onClick:o,children:"Cancel"}),(0,r.jsx)(w,{primary:!0,disabled:!i.trim(),onClick:()=>n(i.trim()),children:"Save as new"})]})]})})}var $=o(8006),S=o(679),M=o(4872);const B=i.default.div`
  position: relative;
`,j=i.default.button`
  display: flex;
  align-items: center;
