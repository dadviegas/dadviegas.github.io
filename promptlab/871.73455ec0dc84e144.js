"use strict";(self.webpackChunk_atlantis_promptlab=self.webpackChunk_atlantis_promptlab||[]).push([["871"],{3758(e,o,r){r.d(o,{L:()=>a});var t=r(5908);async function a(e,o,r,a,i,n,l){let d="",s=e=>{e.length<=d.length||(n(e.slice(d.length)),d=e)};"groq"===e?await (0,t.askGroqStream)(i,{key:o,model:r,system:a,onChunk:s,signal:l}):await (0,t.streamGemini)(i,{key:o,model:r,system:a,onChunk:s,signal:l})}},7613(e,o,r){r.d(o,{H:()=>v});var t=r(5723),a=r(7991),i=r(6859),n=r.n(i),l=r(6063),d=r(132),s=r(8035);let c=n().div`
  display: flex;
