"use strict";(self.webpackChunk_atlantis_pad=self.webpackChunk_atlantis_pad||[]).push([[3735],{74914(e,o,a){a.d(o,{FlyoutPanel:()=>b});var n=a(27359),t=a(53233),r=a(77207),i=a(20255),l=a(217),s=a(15959),d=a(65185),c=a(65723);const p=r.keyframes`
...
`,w=t.default.span`
  ...
  font-family: ${s.w4.typography.fontFamily};
  writing-mode: vertical-rl;
`;function y({code:e,collapsed:o,onToggleCollapse:a}){const[t,s]=(0,n.useState)(""),[p,y]=(0,n.useState)(null),$=(0,n.useRef)(0),z=(0,n.useCallback)(async e=>{if(!e.trim())return s(""),void y(null);const o=++$.current;try{const a="mermaid-"+Date.now(),{svg:n}=await d.default.render(a,e);$.current===o&&(s(n),y(null))}catch(e){$.current===o&&(y(e instanceof Error?e.message:String(e)),s(""))}},[]);return(0,n.useEffect)(()=>{const o=setTimeout(()=>z(e),300);return()=>clearTimeout(o)},[e,z]),o?(0,c.jsxs)(h,{onClick:a,title:"Show preview",children:[(0,c.jsx)(l.A,{size:14}),(0,c.jsx)(w,{children:"Preview"})]}):(0,c.jsxs)(m,{children:[(0,c.jsxs)(g,{children:[(0,c.jsx)(u,{children:"Preview"}),(0,c.jsx)(f,{onClick:a,title:"Collapse preview",children:(0,c.jsx)(i.A,{size:15})})]}),p&&(0,c.jsxs)(b,{children:[(0,c.jsx)(r.A,{size:14,style:{flexShrink:0,marginTop:1}}),p]}),(0,c.jsx)(x,{dangerouslySetInnerHTML:{__html:t}})]})}},51036(e,o,a){a.d(o,{r:()=>xe});var n=a(27359),t=a(28976),r=a(18055),i=a(14944),l=a(39895),s=a(6930),d=(a(61385),a(53233)),c=a(49881),p=a(13045),m=a(60894),g=a(65723);d.default.nav`padding: ${m.w4.spacing.sm} 0;`,d.default.div`
...
`;let x=!1;function b({code:e}){const o=(0,n.useRef)(null),[t,r]=(0,n.useState)(null);return(0,n.useEffect)(()=>{let n=!1;return async function(){const t=(await Promise.resolve().then(a.bind(a,30774))).default;if(x||(t.initialize({startOnLoad:!1,theme:"dark",themeVariables:{background:m.w4.colors.codeBg,primaryColor:m.w4.colors.accent,primaryTextColor:m.w4.colors.mainText,lineColor:m.w4.colors.border}}),x=!0),o.current&&!n)try{const a=`mermaid-${Math.random().toString(36).slice(2)}`,{svg:r}=await t.render(a,e);!n&&o.current&&(o.current.innerHTML=r)}catch(e){n||r(e instanceof Error?e.message:String(e))}}(),()=>{n=!0}},[e]),t?(0,g.jsx)(u,{children:(0,g.jsxs)(f,{children:["Mermaid error: ",t]})}):(0,g.jsx)(u,{ref:o})}const h=["#388bfd","#3fb950","#d29922","#a371f7","#f87171","#22d3ee","#fb923c","#34d399","#f472b6","#818cf8"],w=d.default.div`
  background: ${m.w4.colors.codeBg};
  border: 1px solid ${m.w4.colors.codeBorder};
  border-radius: ${m.w4.borderRadius.md};
  padding: ${m.w4.spacing.lg};
...
//# sourceMappingURL=3735.205b8dd1363a41974b4a.js.map