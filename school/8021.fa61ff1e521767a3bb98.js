"use strict";(self.webpackChunk_atlantis_school=self.webpackChunk_atlantis_school||[]).push([[8021],{9752(e,a,o){o.d(a,{WO:()=>qa});var n=o(27359),i=o(99178),t=o(53233),r=o(17681),l=o(69753),s=o(88641),c=o(41783),d=o(65723);function m(e){try{return JSON.parse(localStorage.getItem(e)??"[]")}catch{return[]}}const u=t.default.nav`padding: ${i.w4.spacing.sm} 0;`,p=t.default.div`
...
`;let F=!1;function R({code:e}){const a=(0,n.useRef)(null),[t,r]=(0,n.useState)(null);return(0,n.useEffect)(()=>{let n=!1;return async function(){const t=(await o.e(774).then(o.bind(o,30774))).default;if(F||(t.initialize({startOnLoad:!1,theme:"dark",themeVariables:{background:i.w4.colors.codeBg,primaryColor:i.w4.colors.accent,primaryTextColor:i.w4.colors.mainText,lineColor:i.w4.colors.border}}),F=!0),a.current&&!n)try{const o=`mermaid-${Math.random().toString(36).slice(2)}`,{svg:i}=await t.render(o,e);!n&&a.current&&(a.current.innerHTML=i)}catch(e){n||r(e instanceof Error?e.message:String(e))}}(),()=>{n=!0}},[e]),t?(0,d.jsx)(E,{children:(0,d.jsxs)(P,{children:["Mermaid error: ",t]})}):(0,d.jsx)(E,{ref:a})}const O=["#388bfd","#3fb950","#d29922","#a371f7","#f87171","#22d3ee","#fb923c","#34d399","#f472b6","#818cf8"],N=t.default.div`
  background: ${i.w4.colors.codeBg};
  border: 1px solid ${i.w4.colors.codeBorder};
  border-radius: ${i.w4.borderRadius.md};
  padding: ${i.w4.spacing.lg};
...
`,ee=t.default.div`
  ...
  color: ${i.w4.colors.mainText};
  text-align: center;
`;function ae(e){return e.toString().padStart(2,"0")}function oe(e,a,o){if("pt"===o){const o=1===e?"1 hora":`${e} horas`;return 0===a?o:15===a?`${o} e um quarto`:30===a?`${o} e meia`:45===a?`um quarto para as ${12===e?1:e+1}`:`${o} e ${a} minutos`}const n=e<12?"AM":"PM",i=e%12||12;return 0===a?`${i} o'clock ${n}`:15===a?`quarter past ${i} ${n}`:30===a?`half past ${i} ${n}`:45===a?`quarter to ${i%12+1} ${n}`:`${i}:${ae(a)} ${n}`}function ne({hours:e,minutes:a,seconds:o}){const n=100,t=100,r=e=>e*Math.PI/180,l=o/60*360-90,s=a/60*360+o/60*6-90,c=e%12/12*360+a/60*30-90,m=n+61*Math.cos(r(l)),u=t+61*Math.sin(r(l)),p=n+65*Math.cos(r(s)),f=t+65*Math.sin(r(s)),g=n+45*Math.cos(r(c)),y=t+45*Math.sin(r(c));return(0,d.jsxs)("svg",{viewBox:"0 0 200 200",width:200,height:200,children:[(0,d.jsx)("circle",{cx:n,cy:t,r:85,fill:i.w4.colors.surface,stroke:i.w4.colors.border,strokeWidth:2}),Array.from({length:12},(e,a)=>{const o=a+1,l=o/12*360-90,s=n+69*Math.cos(r(l)),c=t+69*Math.sin(r(l));return(0,d.jsx)("text",{x:s,y:c+4,fill:i.w4.colors.mainText,fontSize:14,fontWeight:600,textAnchor:"middle",fontFamily:i.w4.typography.fontFamily,children:o},o)}),Array.from({length:60},(e,a)=>{const o=a/60*360-90,l=a%5==0,s=l?75:79;return(0,d.jsx)("line",{x1:n+s*Math.cos(r(o)),y1:t+s*Math.sin(r(o)),x2:n+83*Math.cos(r(o)),y2:t+83*Math.sin(r(o)),stroke:l?i.w4.colors.mainTextMuted:i.w4.colors.border,strokeWidth:l?2:1},a)}),(0,d.jsx)("line",{x1:n,y1:t,x2:g,y2:y,stroke:i.w4.colors.mainText,strokeWidth:4,strokeLinecap:"round"}),(0,d.jsx)("line",{x1:n,y1:t,x2:p,y2:f,stroke:i.w4.colors.accent,strokeWidth:2.5,strokeLinecap:"round"}),(0,d.jsx)("line",{x1:n-12*Math.cos(r(l)),y1:t-12*Math.sin(r(l)),x2:m,y2:u,stroke:"#f87171",strokeWidth:1.2,strokeLinecap:"round"}),(0,d.jsx)("circle",{cx:n,cy:t,r:4,fill:i.w4.colors.accent}),(0,d.jsx)("circle",{cx:n,cy:t,r:2,fill:"#f87171"})]})}function ie({code:e}){const a=function(e){let a="pt";for(const o of e.trim().split("\n")){const[e,...n]=o.split(":"),i=n.join(":").trim();"locale"===e.trim().toLowerCase()&&(a=i.toLowerCase())}return{locale:a}}(e),[o,i]=(0,n.useState)("live"),[t,r]=(0,n.useState)(()=>(new Date).getHours()),[l,s]=(0,n.useState)(()=>(new Date).getMinutes()),[c,m]=(0,n.useState)(()=>(new Date).getSeconds());(0,n.useEffect)(()=>{if("live"!==o)return;const e=()=>{const e=new Date;r(e.getHours()),s(e.getMinutes()),m(e.getSeconds())};e();const a=setInterval(e,1e3);return()=>clearInterval(a)},[o]);const u=(0,n.useCallback)(e=>{i("manual"),m(0),r(a=>((a+e)%24+24)%24)},[]),p=(0,n.useCallback)(e=>{i("manual"),m(0),s(a=>((a+e)%60+60)%60)},[]),f=(0,n.useCallback)(()=>i("live"),[]);return(0,d.jsxs)(J,{children:[(0,d.jsxs)(U,{children:[(0,d.jsx)(ne,{hours:t,minutes:l,seconds:c}),(0,d.jsxs)("div",{children:[(0,d.jsxs)(q,{children:[ae(t),":",ae(l),(0,d.jsxs)("span",{style:{fontSize:"24px",opacity:.5},children:[":",ae(c)]})]}),(0,d.jsx)(ee,{children:oe(t%12||12,l,a.locale)})]})]}),(0,d.jsxs)(Z,{children:[(0,d.jsx)(X,{onClick:()=>u(-1),children:"−1h"}),(0,d.jsx)(X,{onClick:()=>u(1),children:"+1h"}),(0,d.jsx)(X,{onClick:()=>p(-15),children:"−15m"}),(0,d.jsx)(X,{onClick:()=>p(15),children:"+15m"}),(0,d.jsx)(X,{onClick:()=>p(-5),children:"−5m"}),(0,d.jsx)(X,{onClick:()=>p(5),children:"+5m"}),(0,d.jsx)(X,{active:"live"===o,onClick:f,children:"pt"===a.locale?"Agora":"Now"})]}),(0,d.jsx)(Q,{children:"pt"===a.locale?"Usa os botões para mudar as horas e os minutos!":"Use the buttons to change the hours and minutes!"}),(0,d.jsx)(Z,{children:[{label:"3:00",h:3,m:0},{label:"6:30",h:6,m:30},{label:"9:15",h:9,m:15},{label:"12:00",h:12,m:0},{label:"13:45",h:13,m:45},{label:"15:30",h:15,m:30},{label:"19:00",h:19,m:0},{label:"23:15",h:23,m:15}].map(e=>(0,d.jsx)(X,{onClick:()=>{i("manual"),r(e.h),s(e.m)},children:e.label},e.label))})]})}var te=o(77207),re=o(41604);const le=["Samantha","Karen","Daniel","Moira","Rishi","Google UK English Female","Google US English"],se=["Joana","Luciana","Catarina","Google português do Brasil"];function ce(e,a){if(!window.speechSynthesis)return;window.speechSynthesis.cancel();const o=new SpeechSynthesisUtterance(e);o.lang="pt"===a?"pt-PT":"en-US",o.rate=1,o.pitch=1;const n=function(e,a){const o="en"===a?le:se,n="en"===a?"en":"pt";for(const a of o){const o=e.find(e=>e.name.includes(a)&&e.lang.startsWith(n));if(o)return o}return e.find(e=>e.lang.startsWith(n))}(window.speechSynthesis.getVoices(),a);n&&(o.voice=n,o.lang=n.lang),window.speechSynthesis.speak(o)}const de=te.keyframes`
...
`,he=(0,t.default)(ge)``,xe=t.default.span`
  display: flex;
  align-items: center;
  justify-content: center;
  width: 36px;
...
`,we=t.default.span`
  font-size: ${i.w4.typography.fontSizeBase};
  color: ${i.w4.colors.mainTextMuted};
`;function ze({code:e}){const a=function(e){return e.split("\n").map(e=>e.trim()).filter(e=>e&&e.includes("|")).map(e=>{const[a,o]=e.split("|").map(e=>e.trim());return{en:a??"",pt:o??""}}).filter(e=>e.en&&e.pt)}(e),o=(0,n.useRef)(null),i=(0,n.useRef)(!1),t=(0,n.useCallback)(e=>{o.current={x:e.touches[0].clientX,y:e.touches[0].clientY}},[]),r=(0,n.useCallback)((e,a)=>n=>{if(!o.current)return;const t=Math.abs(n.changedTouches[0].clientX-o.current.x),r=Math.abs(n.changedTouches[0].clientY-o.current.y);o.current=null,t>8||r>8||(i.current=!0,ce(e,a))},[]),l=(0,n.useCallback)((e,a)=>()=>{i.current?i.current=!1:ce(e,a)},[]);return a.length?(0,d.jsxs)(me,{children:[(0,d.jsxs)(ue,{children:[(0,d.jsx)(re.A,{size:12}),"Words to Listen / Palavras para Ouvir"]}),(0,d.jsx)(pe,{children:a.map(e=>(0,d.jsxs)(fe,{children:[(0,d.jsxs)(ye,{accentColor:"#58a6ff",onTouchStart:t,onTouchEnd:r(e.en,"en"),onClick:l(e.en,"en"),title:`Listen: ${e.en}`,children:[(0,d.jsx)(xe,{accentColor:"#58a6ff",children:(0,d.jsx)(re.A,{size:16})}),(0,d.jsx)(be,{children:e.en})]}),(0,d.jsxs)(he,{accentColor:"#3fb950",onTouchStart:t,onTouchEnd:r(e.pt,"pt"),onClick:l(e.pt,"pt"),title:`Ouvir: ${e.pt}`,children:[(0,d.jsx)(xe,{accentColor:"#3fb950",children:(0,d.jsx)(re.A,{size:16})}),(0,d.jsx)(we,{children:e.pt})]})]},e.en))})]}):null}var $e=o(68383),ve=o(21426),ke=o(25609),Ae=o(20320);const je=t.default.div`
  margin: ${i.w4.spacing.lg} 0;
  border-radius: ${i.w4.borderRadius.md};
  border: 1px solid ${i.w4.colors.codeBorder};
  overflow: hidden;
...
`,Ce={...ve.A,'pre[class*="language-"]':{...ve.A['pre[class*="language-"]'],background:i.w4.colors.codeBg,margin:0,padding:"18px 20px",fontSize:"13px",lineHeight:"1.6",borderRadius:0},'code[class*="language-"]':{...ve.A['code[class*="language-"]'],background:"none",fontSize:"13px"}};function Be({lang:e="text",code:a}){const[o,t]=(0,n.useState)(!1);return(0,d.jsxs)(je,{children:[(0,d.jsxs)(Se,{children:[(0,d.jsx)(Me,{children:e}),(0,d.jsxs)(Te,{copied:o,onClick:()=>{navigator.clipboard.writeText(a).then(()=>{t(!0),setTimeout(()=>t(!1),2e3)})},children:[o?(0,d.jsx)(ke.A,{size:12}):(0,d.jsx)(Ae.A,{size:12}),o?"Copied!":"Copy"]})]}),(0,d.jsx)($e.A,{language:e,style:Ce,showLineNumbers:a.split("\n").length>8,lineNumberStyle:{color:"#484f58",minWidth:"2.5em",paddingRight:"1.5em",userSelect:"none",fontSize:"12px"},customStyle:{margin:0,background:i.w4.colors.codeBg},wrapLongLines:!1,children:a})]})}var Ee=o(65569),Pe=o(8218),Fe=o(57230),Re=o(22966),Oe=o(21069);const Ne={NOTE:{bg:"rgba(88, 166, 255, 0.08)",border:"#58a6ff",icon:Ee.A,label:"Note",color:"#58a6ff"},TIP:{bg:"rgba(63, 185, 80, 0.08)",border:"#3fb950",icon:Pe.A,label:"Tip",color:"#3fb950"},IMPORTANT:{bg:"rgba(163, 113, 247, 0.08)",border:"#a371f7",icon:Fe.A,label:"Important",color:"#a371f7"},WARNING:{bg:"rgba(210, 153, 34, 0.08)",border:"#d29922",icon:Re.A,label:"Warning",color:"#d29922"},CAUTION:{bg:"rgba(248, 81, 73, 0.08)",border:"#f85149",icon:Oe.A,label:"Caution",color:"#f85149"}},Le=t.default.div`
  background: ${({bg:e})=>e};
...
`;function He({type:e,children:a}){const o=Ne[e]??Ne.NOTE,n=o.icon;return(0,d.jsxs)(Le,{bg:o.bg,border:o.border,children:[(0,d.jsxs)(Ie,{color:o.color,children:[(0,d.jsx)(n,{size:15,strokeWidth:2}),o.label]}),(0,d.jsx)(De,{children:a})]})}const Ge=t.default.nav`
  width: 220px;
  min-width: 220px;
...
`,We=t.default.div`
  ...
  font-family: ${i.w4.typography.fontFamily};
  margin-bottom: ${i.w4.spacing.md};
`,Ye=t.default.ul`list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 2px;`,Ke=t.default.a`
  display: block;
  padding: 4px 8px;
...
`;function Ve({headings:e,activeId:a}){return e.length<2?null:(0,d.jsxs)(Ge,{children:[(0,d.jsx)(We,{children:"On this page"}),(0,d.jsx)(Ye,{children:e.map(e=>(0,d.jsx)("li",{children:(0,d.jsx)(Ke,{href:`#${e.id}`,active:a===e.id,level:e.level,onClick:a=>{a.preventDefault(),document.getElementById(e.id)?.scrollIntoView({behavior:"smooth",block:"start"})},children:e.text})},e.id))})]})}function _e(e){return e.toLowerCase().replace(/[*_`[\]()#]/g,"").replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-").trim()}function Je(e){return n.Children.toArray(e).map(e=>"string"==typeof e?e:"number"==typeof e?String(e):(0,n.isValidElement)(e)?Je(e.props.children??""):"").join("")}function Ue(){return e=>{!function e(a){if("blockquote"===a.type){const e=a.children?.[0];if("paragraph"===e?.type){const o=e.children?.[0];if("text"===o?.type){const n=o.value?.match(/^\[!(NOTE|TIP|WARNING|CAUTION|IMPORTANT)\]\s*/i);n&&(o.value=o.value.slice(n[0].length),o.value.trim()||1!==e.children.length||a.children.shift(),a.data=a.data??{},a.data.hName="div",a.data.hProperties={"data-callout":n[1].toUpperCase()})}}}a.children?.forEach(e)}(e)}}const qe=t.default.div`
  display: flex;
...
`,Ze=t.default.div`flex: 1; min-width: 0;`,Xe=t.default.article`
...
`,na=t.default.div`
  ...
  font-family: ${i.w4.typography.fontFamily};
`;function ia(e){return function({children:a,...o}){const n=`h${e}`,i=Je(a),t=_e(i);return(0,d.jsxs)(n,{id:t,...o,children:[a,(0,d.jsx)("a",{className:"heading-anchor",href:`#${t}`,"aria-label":`Link to "${i}"`,children:(0,d.jsx)(S.A,{size:14})})]})}}function ta({file:e,prevEntry:a,nextEntry:i,onNavigate:t,scrollToId:r,onScrolled:s}){const[c,m]=(0,n.useState)(null),[u,p]=(0,n.useState)(null),f=(0,n.useRef)(null);if((0,n.useEffect)(()=>{m(null),fetch(`${o.p}content/${e}`).then(e=>{if(!e.ok)throw new Error(`${e.status} ${e.statusText}`);return e.text()}).then(m).catch(a=>m(`> **Error loading \`${e}\`:** ${a.message}`))},[e]),(0,n.useEffect)(()=>{if(!r||!c||!f.current)return;const e=setTimeout(()=>{const e=f.current?.querySelector(`#${CSS.escape(r)}`);e&&(e.scrollIntoView({behavior:"smooth",block:"start"}),p(r),s?.())},150);return()=>clearTimeout(e)},[r,c,s]),(0,n.useEffect)(()=>{if(!c||!f.current)return;const e=f.current.querySelectorAll("h2[id], h3[id]");if(!e.length)return;const a=new IntersectionObserver(e=>{const a=e.filter(e=>e.isIntersecting);a.length&&p(a[0].target.id)},{rootMargin:"-10% 0% -60% 0%",threshold:0});return e.forEach(e=>a.observe(e)),()=>a.disconnect()},[c]),null===c)return(0,d.jsx)(na,{children:"Loading…"});const g=function(e){const a=[],o=/^(#{2,3})\s+(.+)$/gm;let n;for(;null!==(n=o.exec(e));){const e=n[1].length,o=n[2].trim().replace(/\*\*(.+?)\*\*/g,"$1").replace(/\*(.+?)\*/g,"$1").replace(/`(.+?)`/g,"$1").replace(/\[(.+?)\]\(.+?\)/g,"$1");a.push({level:e,text:o,id:_e(o)})}return a}(c),y=a||i;return(0,d.jsxs)(qe,{children:[(0,d.jsxs)(Ze,{children:[(0,d.jsx)(Xe,{ref:f,children:(0,d.jsx)(A.oz,{remarkPlugins:[j.A,B.A,Ue],rehypePlugins:[T.A,C.A],components:{div({node:e,children:a,...o}){const n=o["data-callout"];return n?(0,d.jsx)(He,{type:n,children:a}):(0,d.jsx)("div",{...o,children:a})},h1:ia(1),h2:ia(2),h3:ia(3),h4:ia(4),pre:({children:e})=>(0,d.jsx)(d.Fragment,{children:e}),code({className:e,children:a}){const o=/language-(\w+)/.exec(e??"")?.[1],n=String(a).replace(/\n$/,"");return"mermaid"===o?(0,d.jsx)(R,{code:n}):"chart"===o?(0,d.jsx)(_,{code:n}):"clock"===o?(0,d.jsx)(ie,{code:n}):"vocabulary"===o?(0,d.jsx)(ze,{code:n}):o||n.includes("\n")?(0,d.jsx)(Be,{lang:o,code:n}):(0,d.jsx)("code",{className:e,children:a})}},children:c})}),y&&(0,d.jsxs)(Qe,{children:[a?(0,d.jsxs)(ea,{align:"left",onClick:()=>t?.(a),children:[(0,d.jsxs)(aa,{children:[(0,d.jsx)(M.A,{size:13})," Previous"]}),(0,d.jsx)(oa,{children:a.name})]}):(0,d.jsx)("div",{style:{flex:1}}),i?(0,d.jsxs)(ea,{align:"right",onClick:()=>t?.(i),children:[(0,d.jsxs)(aa,{children:["Next ",(0,d.jsx)(l.A,{size:13})]}),(0,d.jsx)(oa,{children:i.name})]}):(0,d.jsx)("div",{style:{flex:1}})]})]}),(0,d.jsx)(Ve,{headings:g,activeId:u})]})}var ra=o(24525),la=o(87071),sa=o(35751),ca=o(32887);const da=te.keyframes`
  from { opacity: 0; }
  to   { opacity: 1; }
`,ma=te.keyframes`
...
`,Ca=t.default.div`
  ...
  font-size: ${i.w4.typography.fontSizeSm};
  text-align: center;
`;function Ba(e){return e.toLowerCase().replace(/[*_`[\]()#]/g,"").replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-").trim()}const Ea=new Map;function Pa(e){return e.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,"")}function Fa(e,a=""){return e.flatMap(e=>e.children?Fa(e.children,e.name):e.file?[{entry:e,parentName:a}]:[])}function Ra(e,a){const o=Pa(e),n=Pa(a),i=e.split("\n");let t=0,r=0;for(;-1!==(r=o.indexOf(n,r));)t++,r+=n.length;let l=null;for(const e of i){const o=e.match(/^#{1,4}\s+(.+)/);if(o&&(l=o[1].trim()),!e.trim()||e.startsWith("```")||e.startsWith("|--"))continue;const i=e.replace(/^#{1,6}\s*/,"").replace(/[*_`|]/g,"").trim(),r=i.normalize("NFD"),s=[];let c=0;for(let e=0;e<r.length;e++){const a=r.charCodeAt(e);a>=768&&a<=879||(s.push(c),c++)}s.push(c);const d=Pa(i).indexOf(n);if(-1===d)continue;const m=s[d]??d,u=s[d+n.length]??m+a.length,p=Math.max(0,m-50),f=Math.min(i.length,u+70),g=p>0?"…":"",y=f<i.length?"…":"";return{snippet:`${g}${i.slice(p,m)}<mark>${i.slice(m,u)}</mark>${i.slice(u,f)}${y}`,count:t,headingSlug:l?Ba(l):null,headingText:l}}return{snippet:"",count:t,headingSlug:null,headingText:null}}function Oa({open:e,onClose:a,entries:t,activeId:l,onSelect:s}){const[c,m]=(0,n.useState)(""),[u,p]=(0,n.useState)([]),[f,g]=(0,n.useState)(!1),[y,h]=(0,n.useState)(0),x=(0,n.useRef)(null),b=(0,n.useRef)(),w=(0,n.useMemo)(()=>Fa(t),[t]);(0,n.useEffect)(()=>{e&&(m(""),p([]),h(0),setTimeout(()=>x.current?.focus(),50))},[e]),(0,n.useEffect)(()=>{if(!e)return;const o=e=>{"Escape"===e.key&&(e.preventDefault(),a())};return window.addEventListener("keydown",o),()=>window.removeEventListener("keydown",o)},[e,a]);const z=(0,n.useCallback)(async e=>{if(e.length<2)return p([]),void g(!1);g(!0);const a=await Promise.all(w.map(async({entry:e,parentName:a})=>({entry:e,parentName:a,text:await async function(e){const a=Ea.get(e);if(void 0!==a)return a;try{const a=await fetch(`${o.p}content/${e}`);if(!a.ok)return"";const n=await a.text();return Ea.set(e,n),n}catch{return Ea.set(e,""),""}}(e.file)}))),n=[];for(const{entry:o,parentName:i,text:t}of a){const a=Pa(o.name),r=Pa(t),l=Pa(e);if(!a.includes(l)&&!r.includes(l))continue;const{snippet:s,count:c,headingSlug:d,headingText:m}=Ra(t,e),u=a.includes(l);n.push({entry:o,parentName:i,snippet:s||(u?o.name:""),matchCount:c+(u?10:0),headingSlug:d,headingText:m})}n.sort((e,a)=>a.matchCount-e.matchCount),p(n),h(0),g(!1)},[w]);(0,n.useEffect)(()=>{if(clearTimeout(b.current),c.trim())return b.current=setTimeout(()=>z(c.trim()),250),()=>clearTimeout(b.current);p([])},[c,z]);const $=(0,n.useCallback)(e=>{"ArrowDown"===e.key?(e.preventDefault(),h(e=>Math.min(e+1,u.length-1))):"ArrowUp"===e.key?(e.preventDefault(),h(e=>Math.max(e-1,0))):"Enter"===e.key&&u[y]&&(e.preventDefault(),s(u[y].entry,u[y].headingSlug),a())},[u,y,s,a]);return e?(0,d.jsx)(ua,{onClick:e=>{e.target===e.currentTarget&&a()},children:(0,d.jsxs)(pa,{onKeyDown:$,children:[(0,d.jsxs)(fa,{children:[(0,d.jsx)(r.A,{size:18,color:i.w4.colors.accent,style:{flexShrink:0}}),(0,d.jsx)(ga,{ref:x,placeholder:"Pesquisar em todo o conteúdo…",value:c,onChange:e=>m(e.target.value)}),(0,d.jsx)(ya,{onClick:a,title:"Fechar (Esc)",children:(0,d.jsx)(ra.A,{size:14})})]}),(0,d.jsxs)(ha,{children:[f&&(0,d.jsxs)(xa,{children:[(0,d.jsx)(ba,{children:(0,d.jsx)(la.A,{size:14})}),"A pesquisar ",w.length," ficheiros…"]}),!f&&c.length>=2&&u.length>0&&(0,d.jsxs)(xa,{children:[(0,d.jsx)(sa.A,{size:13}),u.length," ",1===u.length?"resultado":"resultados"," encontrados"]}),!f&&c.length>=2&&0===u.length&&(0,d.jsxs)(Ca,{children:[(0,d.jsx)(r.A,{size:32,strokeWidth:1.2}),'Nenhum resultado para "',(0,d.jsx)("strong",{children:c}),'"']}),!f&&c.length<2&&(0,d.jsxs)(Ca,{children:[(0,d.jsx)(r.A,{size:32,strokeWidth:1.2}),"Escreve pelo menos 2 caracteres para pesquisar"]}),u.map((e,o)=>(0,d.jsxs)(wa,{selected:o===y,onClick:()=>{s(e.entry,e.headingSlug),a()},onMouseEnter:()=>h(o),children:[(0,d.jsx)(za,{selected:o===y,children:(0,d.jsx)(sa.A,{size:15})}),(0,d.jsxs)($a,{children:[(0,d.jsxs)(va,{children:[e.entry.name,e.matchCount>0&&(0,d.jsx)(Aa,{children:e.matchCount>10?e.matchCount-10:e.matchCount})]}),(e.parentName||e.headingText)&&(0,d.jsxs)(ka,{children:[e.parentName,e.parentName&&e.headingText?" › ":"",e.headingText]}),e.snippet&&(0,d.jsx)(ja,{dangerouslySetInnerHTML:{__html:e.snippet}})]}),(0,d.jsx)(Sa,{selected:o===y,children:(0,d.jsx)(ca.A,{size:14})})]},e.entry.id))]}),(0,d.jsxs)(Ma,{children:[(0,d.jsxs)("span",{children:[(0,d.jsx)(Ta,{children:"↑"})," ",(0,d.jsx)(Ta,{children:"↓"})," navegar"]}),(0,d.jsxs)("span",{children:[(0,d.jsx)(Ta,{children:"↵"})," abrir"]}),(0,d.jsxs)("span",{children:[(0,d.jsx)(Ta,{children:"esc"})," fechar"]})]})]})}):null}function Na(e,a){for(const o of e){if(o.id===a)return o;if(o.children){const e=Na(o.children,a);if(e)return e}}}function La(e){return e.flatMap(e=>e.children?La(e.children):e.file?[e]:[])}const Ia=t.default.div`
  display: flex;
  align-items: center;
  justify-content: center;
  height: 100%;
...
`,_a={en:"Browse the sidebar",pt:"Explora o menu lateral"};function Ja({title:e,sub:a,lang:o}){return(0,d.jsxs)(Ia,{children:[(0,d.jsx)(Ha,{}),(0,d.jsx)(Da,{size:500,x:10,y:-10,hue:210,dur:7}),(0,d.jsx)(Da,{size:400,x:60,y:50,hue:270,dur:9}),(0,d.jsx)(Da,{size:300,x:30,y:70,hue:190,dur:6}),(0,d.jsxs)(Ga,{children:[(0,d.jsx)(Wa,{children:e}),(0,d.jsx)(Ya,{children:a}),(0,d.jsxs)(Ka,{children:[(0,d.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round",children:(0,d.jsx)("polyline",{points:"15 18 9 12 15 6"})}),_a[o]??_a.en]})]})]})}function Ua(e,a,o){return"string"==typeof e?e:e[a]??e[o]??Object.values(e)[0]??""}function qa({navigation:e,languages:a,defaultLang:o,locale:t,hashPrefix:l,topBarRight:s,welcomeTitle:c="Blog",welcomeSub:m="Notes, guides, and references — pick a topic from the sidebar to get started."}){const u=a?Object.keys(a):[],[p,f]=(u.length,(0,n.useState)(()=>o??u[0]??""));(0,n.useEffect)(()=>{t&&u.includes(t)&&t!==p&&f(t)},[t]);const g=(0,n.useMemo)(()=>a&&p?a[p].navigation:e??{entries:[]},[a,e,p]),y=((0,n.useMemo)(()=>La(g.entries),[g]),(0,n.useCallback)(e=>{const a=e.match(new RegExp(`^#\\/${l}\\/(.+)$`));if(a)return Na(g.entries,a[1])},[g,l])),[h,x]=(0,n.useState)(()=>y(window.location.hash)??null);(0,n.useEffect)(()=>{if(!h)return;const e=Na(g.entries,h.id);x(e??null)},[p,g]),(0,n.useEffect)(()=>{const e=()=>{const e=y(window.location.hash);e&&x(e)};return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[y]);const b=(0,n.useCallback)(e=>{e.file&&(x(e),window.location.hash=`#/${l}/${e.id}`)},[l]),w=(0,n.useMemo)(()=>La(g.entries),[g]),z=w.findIndex(e=>e.id===h?.id),$=z>0?w[z-1]:null,v=z<w.length-1?w[z+1]:null,[A,j]=(0,n.useState)(!1),[S,M]=(0,n.useState)(null);(0,n.useEffect)(()=>{const e=e=>{(e.metaKey||e.ctrlKey)&&"f"===e.key&&(e.preventDefault(),j(!0))};return window.addEventListener("keydown",e),()=>window.removeEventListener("keydown",e)},[]);const T=h?.label??h?.name??l,C=Ua(c,p,o??u[0]??""),B=Ua(m,p,o??u[0]??""),E=(0,d.jsxs)(Va,{onClick:()=>j(!0),title:"Pesquisar (Ctrl+F)",children:[(0,d.jsx)(r.A,{size:14}),(0,d.jsx)("span",{children:"Pesquisar"}),(0,d.jsx)("kbd",{children:"⌘F"})]}),P=(0,d.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:"8px"},children:[E,s]});return(0,d.jsxs)(i.PE,{title:T,activeId:h?.id??null,topBarRight:P,sidebar:(0,d.jsx)(k,{config:g,activeId:h?.id??null,onSelect:b,hashPrefix:l}),children:[h?.file?(0,d.jsx)(ta,{file:h.file,prevEntry:$,nextEntry:v,onNavigate:b,scrollToId:S,onScrolled:()=>M(null)}):(0,d.jsx)(Ja,{title:C,sub:B,lang:p}),(0,d.jsx)(Oa,{open:A,onClose:()=>j(!1),entries:g.entries,activeId:h?.id??null,onSelect:(e,a)=>{b(e),M(a??null)}})]})}t.default.div`
  display: flex;
  gap: 4px;
  background: ${i.w4.colors.surface};
  border: 1px solid ${i.w4.colors.border};
...
`,t.default.span`
  ...
  font-weight: 600;
  margin-left: auto;
`,new Map},30894(e,a,o){o.d(a,{Ym:()=>c});var n=o(27359),i=o(99178);const t="atlantis:locale",r="shell:locale";function l(e){return"en"===e||"pt"===e}function s(){try{const e=localStorage.getItem(t);if(l(e))return e}catch{}return"en"}function c(){const[e,a]=(0,n.useState)(s),o=(0,n.useCallback)(e=>{a(e),function(e){try{localStorage.setItem(t,e)}catch{}(0,i.Is)(r,e).catch(()=>{})}(e),window.dispatchEvent(new CustomEvent("atlantis:locale-change",{detail:e}))},[]);return(0,n.useEffect)(()=>{const e=e=>{const o=e.detail;a(o)};return window.addEventListener("atlantis:locale-change",e),()=>window.removeEventListener("atlantis:locale-change",e)},[]),(0,n.useEffect)(()=>{(0,i.PL)(r).then(o=>{if(l(o)&&o!==e){try{localStorage.setItem(t,o)}catch{}a(o)}}).catch(()=>{})},[]),[e,o]}(0,i.PL)(r).then(e=>{if(l(e))try{localStorage.setItem(t,e)}catch{}}).catch(()=>{});var d=o(53233);o(65723),d.default.div`
  display: flex;
  gap: 4px;
  background: ${i.w4.colors.surface};
  border: 1px solid ${i.w4.colors.border};
