"use strict";(self.webpackChunk_atlantis_school=self.webpackChunk_atlantis_school||[]).push([["3390"],{61318(e,a,o){o.d(a,{WO:()=>aN});var i=o(65723),n=o(37991),t=o(15726),r=o(36859),l=o.n(r),s=o(17681),c=o(69753),d=o(88641),m=o(41783);function p(e){try{return JSON.parse(localStorage.getItem(e)??"[]")}catch{return[]}}let u=l().nav`padding: ${t.w4.spacing.sm} 0;`,g=l().div`
...
`,s().div`
  position: relative;
`;var c=o(72799),d=o(73661),m=o(40814);let p="260px",u="56px",g="48px",f=s().header`
  display: flex;
  align-items: center;
...
`,S=s().main`
  ...
  display: flex;
  flex-direction: column;
`,M=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function T(){return(0,n.jsx)(b,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:M.map((e,a)=>(0,n.jsx)(w,{index:a,accent:e.accent,children:e.char},a))})}let C="atlantis:sidebar-collapsed";function B({sidebar:e,children:a,topBarRight:i,title:l="Atlantis",activeId:s=null}){let[c,p]=(0,t.useState)(()=>{try{return"true"===localStorage.getItem(C)}catch{return!1}}),[u,g]=(0,t.useState)(null),x=(0,t.useRef)(),b=()=>p(e=>{let a=!e;try{localStorage.setItem(C,String(a))}catch{}return a}),w=r().useMemo(()=>r().lazy(()=>Promise.resolve().then(o.bind(o,48859)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,n.jsx)(m.I.Provider,{value:{collapsed:c,toggle:b,flyout:u,openFlyout:(e,a,o)=>{clearTimeout(x.current),g({entry:e,anchorY:a,onSelect:o})},scheduleFlyoutClose:()=>{x.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(x.current)},children:(0,n.jsxs)(k,{children:[(0,n.jsxs)(f,{children:[e&&(0,n.jsx)(y,{children:(0,n.jsx)(h,{onClick:b,title:c?"Expand sidebar":"Collapse sidebar",children:(0,n.jsx)(d.A,{size:17})})}),(0,n.jsx)(T,{}),l&&(0,n.jsx)($,{children:l}),i&&(0,n.jsx)(z,{children:i})]}),(0,n.jsxs)(v,{children:[null!=e&&(0,n.jsx)(A,{collapsed:c,children:(0,n.jsx)(j,{children:e})}),(0,n.jsx)(S,{children:a})]}),u&&(0,n.jsx)(r().Suspense,{fallback:null,children:(0,n.jsx)(w,{activeId:s})})]})})}var E=o(20255),P=o(69753),F=o(96140);let R=s().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
...
`;function Y({iconKey:e,size:a=16}){if(e&&!(e in F.t))return(0,n.jsx)("span",{style:{fontSize:a,lineHeight:1,display:"flex",alignItems:"center"},children:e});let o=e?F.t[e]??E.A:E.A;return(0,n.jsx)(o,{size:a,strokeWidth:1.75})}function V({entry:e,activeId:a,onSelect:o}){let[i,r]=(0,t.useState)(e.defaultOpen??!0),{collapsed:l,openFlyout:s,scheduleFlyoutClose:c,cancelFlyoutClose:d}=(0,m.c)();return e.children&&e.children.length>0?(0,n.jsxs)(N,{children:[(0,n.jsxs)(D,{collapsed:l,onClick:()=>{l||r(e=>!e)},onMouseEnter:l?a=>{s(e,a.currentTarget.getBoundingClientRect().top,o)}:void 0,onMouseLeave:l?c:void 0,children:[(0,n.jsxs)(I,{collapsed:l,children:[(0,n.jsx)(Y,{iconKey:e.icon,size:16}),(0,n.jsx)(H,{collapsed:l,children:e.name})]}),(0,n.jsx)(G,{open:i,collapsed:l,children:(0,n.jsx)(P.A,{size:13})})]}),(0,n.jsx)(R,{open:i&&!l,children:(0,n.jsx)(L,{children:(0,n.jsx)(O,{children:e.children.map(e=>(0,n.jsx)(V,{entry:e,activeId:a,onSelect:o},e.id))})})})]}):(0,n.jsxs)(W,{active:a===e.id,collapsed:l,onClick:()=>o(e),onMouseEnter:l?a=>{let i=a.currentTarget.getBoundingClientRect();s({id:e.id,name:e.name,icon:e.icon,file:e.file,children:[e]},i.top,o)}:void 0,onMouseLeave:l?c:void 0,children:[(0,n.jsx)(Y,{iconKey:e.icon,size:15}),(0,n.jsx)(H,{collapsed:l,children:e.name})]})}function K({entries:e,activeId:a,onSelect:o}){return(0,n.jsx)("div",{children:e.map(e=>(0,n.jsx)(V,{entry:e,activeId:a,onSelect:o},e.id))})}let _=(0,c.keyframes)`
...
`;s().div`
  ...
  background: ${i.w4.colors.mainBg};
  font-family: ${i.w4.typography.fontFamily};
  animation: ${eo} 0.4s ease 0.15s both;
`,s().div`
  position: relative;
  width: 56px;
  height: 56px;
