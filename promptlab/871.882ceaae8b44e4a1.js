"use strict";(self.webpackChunk_atlantis_promptlab=self.webpackChunk_atlantis_promptlab||[]).push([["871"],{3758(o,e,a){a.d(e,{L:()=>i});var n=a(3711);async function i(o,e,a,i,t,r,l){let s="",c=o=>{o.length<=s.length||(r(o.slice(s.length)),s=o)};"groq"===o?await (0,n.askGroqStream)(t,{key:e,model:a,system:i,onChunk:c,signal:l}):await (0,n.streamGemini)(t,{key:e,model:a,system:i,onChunk:c,signal:l})}},7613(o,e,a){a.d(e,{H:()=>$});var n=a(5723),i=a(7991),t=a(6859),r=a.n(t),l=a(9874),s=a(2743),c=a(8035);let d=r().div`
  display: flex;
