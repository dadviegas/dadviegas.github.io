...
`,v=i().forwardRef(function({active:e=!1,shape:o="square",tone:t="default",children:a,...i},n){return(0,r.jsx)($,{ref:n,active:e,shape:o,tone:t,...i,children:a})}),k=l().div`
  position: relative;
  display: inline-flex;
`,M=l().div`
  position: absolute;
...
`;let A=l().kbd`
  ...
  white-space: nowrap;
`;function L({children:e,...o}){return(0,r.jsx)(A,{...o,children:e})}let V=l().div`
  font-family: ${s.w4.typography.fontFamilyMono};
  font-size: 11px;
...
`,l().p`
  ...
  font-size: 12.5px;
  line-height: 1.45;
`;var Y=t(1352),N=t(6710),D=t(4311),O=t(3639),W=t(80);t(5406),l().nav`padding: ${s.w4.spacing.sm} 0;`,l().div`
...
`;var q=t(4041);let G="https://cdn.jsdelivr.net/npm/mermaid@11.14.0/dist/mermaid.min.js",X=null,_="#7fb77e",K=(0,S.keyframes)`
...
`,es=l().pre`
  ...
  color: ${s.w4.colors.mainTextMuted};
  white-space: pre-wrap;
`;function ed(e){if(e<=0)return 10;let o=Math.pow(10,Math.floor(Math.log10(e)));return Math.ceil(e/o)*o}function ep(e,o,t){let r=Math.max(1,Math.ceil(t/8));return 0!==o&&o!==t-1&&o%r!=0?"":e.length>12?e.slice(0,11)+"…":e}function ec({labels:e,data:o,colors:t}){let a=340,i=176,n=ed(Math.max(...o,1)),l=Math.min(40,a/e.length*.6),d=a/e.length,p=Array.from({length:6},(e,o)=>n/5*o);return(0,r.jsxs)("svg",{viewBox:"0 0 400 240",width:"100%",style:{maxWidth:400},children:[p.map((e,o)=>{let t=16+i-e/n*i;return(0,r.jsxs)("g",{children:[(0,r.jsx)("line",{x1:44,y1:t,x2:384,y2:t,stroke:s.w4.colors.border,strokeWidth:.5,strokeDasharray:0===o?"none":"3,3"}),(0,r.jsx)("text",{x:38,y:t+4,fill:s.w4.colors.mainTextMuted,fontSize:10,textAnchor:"end",fontFamily:s.w4.typography.fontFamily,children:Math.round(e)})]},o)}),o.map((o,a)=>{let p=44+d*a+d/2-l/2,c=o/n*i,g=16+i-c,x=t[a%t.length];return(0,r.jsxs)("g",{children:[(0,r.jsxs)("rect",{x:p,y:g,width:l,height:c,rx:3,fill:x,opacity:.85,children:[(0,r.jsx)("animate",{attributeName:"height",from:"0",to:c,dur:"0.5s",fill:"freeze"}),(0,r.jsx)("animate",{attributeName:"y",from:16+i,to:g,dur:"0.5s",fill:"freeze"})]}),(0,r.jsx)("text",{x:p+l/2,y:g-4,fill:s.w4.colors.mainText,fontSize:10,fontWeight:600,textAnchor:"middle",fontFamily:s.w4.typography.fontFamily,children:o}),(0,r.jsx)("text",{x:44+d*a+d/2,y:208,fill:s.w4.colors.mainTextMuted,fontSize:10,textAnchor:"middle",fontFamily:s.w4.typography.fontFamily,children:ep(e[a],a,e.length)})]},a)})]})}function eg({labels:e,data:o,colors:t}){let a=o.reduce((e,o)=>e+o,0)||1,i=-Math.PI/2,n=o.map((e,o)=>{let n=e/a*Math.PI*2,l=i,d=i+=n,p=120+90*Math.cos(l),c=120+90*Math.sin(l),g=120+90*Math.cos(d),x=120+90*Math.sin(d),h=+(n>Math.PI),f=l+n/2,m=120+58.5*Math.cos(f),b=120+58.5*Math.sin(f),u=Math.round(e/a*100);return(0,r.jsxs)("g",{children:[(0,r.jsx)("path",{d:`M 120 120 L ${p} ${c} A 90 90 0 ${h} 1 ${g} ${x} Z`,fill:t[o%t.length],stroke:s.w4.colors.codeBg,strokeWidth:2,opacity:.85}),u>=5&&(0,r.jsxs)("text",{x:m,y:b+4,fill:"#fff",fontSize:11,fontWeight:600,textAnchor:"middle",fontFamily:s.w4.typography.fontFamily,children:[u,"%"]})]},o)});return(0,r.jsx)("svg",{viewBox:"0 0 240 240",width:"100%",style:{maxWidth:240},children:n})}function ex({labels:e,data:o,colors:t}){let a=340,i=176,n=ed(Math.max(...o,1)),l=o.length>1?a/(o.length-1):a,d=t[0],p=o.map((e,o)=>({x:44+l*o,y:16+i-e/n*i})),c=p.map((e,o)=>`${0===o?"M":"L"} ${e.x} ${e.y}`).join(" "),g=Array.from({length:6},(e,o)=>n/5*o);return(0,r.jsxs)("svg",{viewBox:"0 0 400 240",width:"100%",style:{maxWidth:400},children:[g.map((e,o)=>{let t=16+i-e/n*i;return(0,r.jsxs)("g",{children:[(0,r.jsx)("line",{x1:44,y1:t,x2:384,y2:t,stroke:s.w4.colors.border,strokeWidth:.5,strokeDasharray:0===o?"none":"3,3"}),(0,r.jsx)("text",{x:38,y:t+4,fill:s.w4.colors.mainTextMuted,fontSize:10,textAnchor:"end",fontFamily:s.w4.typography.fontFamily,children:Math.round(e)})]},o)}),(0,r.jsx)("path",{d:c,fill:"none",stroke:d,strokeWidth:2.5,strokeLinecap:"round",strokeLinejoin:"round"}),p.map((t,a)=>(0,r.jsxs)("g",{children:[(0,r.jsx)("circle",{cx:t.x,cy:t.y,r:4,fill:d,stroke:s.w4.colors.codeBg,strokeWidth:2}),(0,r.jsx)("text",{x:t.x,y:t.y-10,fill:s.w4.colors.mainText,fontSize:10,fontWeight:600,textAnchor:"middle",fontFamily:s.w4.typography.fontFamily,children:o[a]}),(0,r.jsx)("text",{x:t.x,y:208,fill:s.w4.colors.mainTextMuted,fontSize:10,textAnchor:"middle",fontFamily:s.w4.typography.fontFamily,children:ep(e[a],a,e.length)})]},a))]})}function eh({code:e}){let o=(0,a.useMemo)(()=>(function(e){let o,t,r=e.trim().split("\n"),a="bar",i=[],n=[];for(let e of r){let[r,...l]=e.split(":"),s=l.join(":").trim();if(s)switch(r.trim().toLowerCase()){case"type":["bar","pie","line"].includes(s.toLowerCase())&&(a=s.toLowerCase());break;case"title":o=s;break;case"labels":i=s.replace(/^\[|\]$/g,"").split(",").map(e=>e.trim()).filter(Boolean);break;case"data":n=s.replace(/^\[|\]$/g,"").split(",").map(e=>e.trim()).filter(Boolean).map(e=>parseFloat(e)||0);break;case"colors":{let e=s.replace(/^\[|\]$/g,"").split(",").map(e=>e.trim()).filter(Boolean);t=e.length?e:void 0}}}return i.length&&n.length?{type:a,title:o,labels:i,data:n,colors:t}:null})(e),[e]);if(!o)return(0,r.jsx)(es,{children:e.trim()});let t=o.colors??et;return(0,r.jsxs)(er,{children:[o.title&&(0,r.jsx)(ea,{children:o.title}),"bar"===o.type&&(0,r.jsx)(ec,{labels:o.labels,data:o.data,colors:t}),"pie"===o.type&&(0,r.jsx)(eg,{labels:o.labels,data:o.data,colors:t}),"line"===o.type&&(0,r.jsx)(ex,{labels:o.labels,data:o.data,colors:t}),(0,r.jsx)(ei,{children:o.labels.map((e,o)=>(0,r.jsxs)(en,{children:[(0,r.jsx)(el,{color:t[o%t.length]}),e]},o))})]})}l().div`
  background: ${s.w4.colors.codeBg};
  border: 1px solid ${s.w4.colors.codeBorder};
  border-radius: ${s.w4.borderRadius.md};
  padding: ${s.w4.spacing.lg};
...
`;function ej({type:e,children:o}){let t=ez[e]??ez.NOTE;return(0,r.jsxs)(eT,{bg:t.bg,border:t.border,children:[(0,r.jsxs)(eS,{color:t.color,children:[(0,r.jsx)(j,{name:t.icon,size:15,strokeWidth:2}),t.label]}),(0,r.jsx)(eF,{children:o})]})}l().nav`
  width: 220px;
  min-width: 220px;
...
`;function eA({children:e}){return(0,r.jsx)(eH,{children:(0,r.jsx)(Y.oz,{remarkPlugins:[N.A,D.A,eR],rehypePlugins:[O.A,W.A],components:{div({node:e,children:o,...t}){let a=t["data-callout"];return a?(0,r.jsx)(ej,{type:a,children:o}):(0,r.jsx)("div",{...t,children:o})},pre:({children:e})=>(0,r.jsx)(r.Fragment,{children:e}),code({className:e,children:o}){let t=/language-(\w+)/.exec(e??"")?.[1],a=String(o).replace(/\n$/,"");return a.trim()?"mermaid"===t?(0,r.jsx)(eo,{code:a}):"chart"===t?(0,r.jsx)(eh,{code:a}):t||a.includes("\n")?(0,r.jsx)(eM,{lang:t,code:a}):(0,r.jsx)("code",{className:e,children:o}):null}},children:e})})}l().nav`
  display: flex;
  flex-direction: column;
  gap: 1px;
  padding: ${s.w4.spacing.sm} 0;
