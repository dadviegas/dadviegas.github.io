...
`,l().span`
  ...
  display: inline-block;
`;let R={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:s.w4.colors.accentMuted},A={neutral:s.w4.colors.mainTextMuted,live:s.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:s.w4.colors.accent};l().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${s.w4.typography.fontFamilyMono};
...
`;let L=l().kbd`
  ...
  white-space: nowrap;
`;function V({children:e,...o}){return(0,r.jsx)(L,{...o,children:e})}let P=l().div`
  font-family: ${s.w4.typography.fontFamilyMono};
  font-size: 11px;
  ...
  align-items: center;
  gap: 8px;
`;function E({children:e,...o}){return(0,r.jsx)(P,{...o,children:e})}l().label`
  display: flex;
  align-items: center;
  gap: 10px;
