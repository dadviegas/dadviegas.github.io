"use strict";(self.webpackChunk_atlantis_earth=self.webpackChunk_atlantis_earth||[]).push([["362"],{3935(e,t,r){r.r(t),r.d(t,{default:()=>q});var o=r(5723),n=r(7991),i=r.n(n),a=r(6859),s=r.n(a),l=r(4764),d=r(7711),c=r(18),p=r(158),u=r(1112);let x="earth";function f(){return new Set((0,u.xy)().filter(e=>e.defaultEnabled).map(e=>e.id))}let h="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",g=s().div`
  flex: 1;
  min-height: 0;
  height: 100%;
  width: 100%;
