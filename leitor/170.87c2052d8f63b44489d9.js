...
`;function p({iconKey:e}){const o=e?d.t[e]??r.A:r.A;return(0,c.jsx)(o,{size:14,strokeWidth:1.75})}function h({entries:e,activeId:o,onSelect:a}){return(0,c.jsx)(c.Fragment,{children:e.map(e=>e.children?(0,c.jsx)(i.Fragment,{children:(0,c.jsx)(h,{entries:e.children,activeId:o,onSelect:a})},e.id):(0,c.jsxs)(f,{active:o===e.id,onClick:()=>a(e),children:[(0,c.jsx)(p,{iconKey:e.icon}),e.name]},e.id))})}function x({activeId:e}){const{flyout:o,scheduleFlyoutClose:a,cancelFlyoutClose:i}=(0,s.c)();if(!o)return null;const t=o.entry.icon?d.t[o.entry.icon]??r.A:r.A;return(0,c.jsxs)(u,{anchorY:o.anchorY,onMouseEnter:i,onMouseLeave:a,children:[(0,c.jsxs)(g,{children:[(0,c.jsx)(t,{size:13,strokeWidth:2}),o.entry.name]}),(0,c.jsx)(h,{entries:o.entry.children??[],activeId:e,onSelect:e=>{o.onSelect(e),a()}})]})}},5959(e,o,a){a.d(o,{c:()=>n});var i=a(7359);const t=(0,i.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),n=()=>(0,i.useContext)(t)},5185(e,o,a){a.d(o,{t:()=>Y});var i=a(9510),t=a(9038),n=a(8207),r=a(6896),l=a(7901),s=a(9848),d=a(2164),c=a(3775),m=a(3539),u=a(1783),g=a(1837),f=a(2314),p=a(5751),h=a(255),x=a(9633),b=a(2946),z=a(822),y=a(6720),w=a(3317),j=a(2709),v=a(3517),A=a(7032),k=a(6949),S=a(8218),$=a(6829),C=a(5553),M=a(9591),T=a(2820),B=a(4621),L=a(6673),E=a(9033),P=a(1365),O=a(5912),R=a(8641),N=a(3249),F=a(1821),I=a(9161),D=a(1849),V=a(7747),G=a(2932),U=a(4525),K=a(7230);const Y={activity:r.A,"bar-chart-2":i.A,book:s.A,"book-open":l.A,calendar:c.A,clock:u.A,"circle-dot":m.A,feather:f.A,"file-text":p.A,globe:y.A,hash:w.A,heart:j.A,landmark:v.A,layers:n.A,leaf:k.A,map:M.A,package:L.A,compass:g.A,"git-branch":b.A,github:z.A,minus:B.A,terminal:N.A,thermometer:F.A,users:D.A,wind:V.A,"pie-chart":t.A,plus:P.A,slash:O.A,star:R.A,zap:K.A,bot:d.A,lightbulb:S.A,"message-square":T.A,wrench:G.A,x:U.A,"layout-grid":A.A,list:$.A,file:h.A,folder:x.A,"map-pin":C.A,"pen-tool":E.A,type:I.A}},906(e,o,a){a.d(o,{w4:()=>i.w});var i=a(217),t=(a(7359),a(3233));a(5723),t.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,y=i.default.div`
  ...
  border-radius: 32px;
  padding: 8px 16px;
`,w=i.default.span`font-size: 20px;`,j=i.default.span`
  font-size: 18px;
  font-weight: 900;
  color: #fff;
`,v=i.default.span`
...
`,M=i.default.span`font-size: 36px;`,T=i.default.div`
  flex: 1;
  text-align: left;
`,B=i.default.div`
  font-size: 18px;
  font-weight: 900;
  color: #fff;
`,L=i.default.div`font-size: 14px; font-weight: 600; color: #f9a8d4;`,E=i.default.div`color: #fb7185; font-size: 24px;`,P=(i.default.div`
...
`,F=i.default.div`
  ...
  justify-content: space-between;
  margin-bottom: 10px;
`,I=i.default.div`font-size: 48px; line-height: 1; filter: drop-shadow(0 2px 6px #00000040);`,D=i.default.div`
  font-size: 11px;
  font-weight: 800;
  color: ${({color:e})=>e};
  background: ${({color:e})=>e}25;
