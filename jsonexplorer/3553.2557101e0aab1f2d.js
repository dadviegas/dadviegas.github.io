"use strict";(self.webpackChunk_atlantis_jsonexplorer=self.webpackChunk_atlantis_jsonexplorer||[]).push([["3553"],{5151(o,e,a){a.d(e,{k:()=>t});let t=[{label:"GitHub API response",json:JSON.stringify({id:1296269,name:"atlantis",full_name:"octocat/atlantis",owner:{login:"octocat",id:1,type:"User"},private:!1,description:"A monorepo of mini web apps",fork:!1,created_at:"2024-01-15T12:00:00Z",stargazers_count:42,watchers_count:42,language:"TypeScript",topics:["react","typescript","webpack","module-federation"],license:{key:"mit",name:"MIT License"}},null,2)},{label:"Users list",json:JSON.stringify({total:3,page:1,users:[{id:1,name:"Alice",email:"alice@example.com",role:"admin",active:!0,score:98.5},{id:2,name:"Bob",email:"bob@example.com",role:"user",active:!0,score:74.2},{id:3,name:"Charlie",email:"charlie@example.com",role:"user",active:!1,score:61}],meta:{hasNext:!1,hasPrev:!1}},null,2)},{label:"Config file",json:JSON.stringify({app:{name:"Atlantis",version:"1.0.0",env:"production"},server:{host:"0.0.0.0",port:3e3,cors:!0},database:{primary:{host:"db.example.com",port:5432,name:"atlantis_prod"},replica:{host:"replica.example.com",port:5432,name:"atlantis_prod"}},features:{darkMode:!0,analytics:!1,betaFeatures:["newDashboard","aiSuggestions"]},limits:{maxUploadMB:100,rateLimit:1e3,timeout:3e4}},null,2)},{label:"Package.json",json:JSON.stringify({name:"@atlantis/shell",version:"1.0.0",scripts:{dev:"webpack serve",build:"webpack",typecheck:"tsc --noEmit"},dependencies:{"@atlantis/shared":"workspace:*",react:"^18.3.1","react-dom":"^18.3.1"},devDependencies:{typescript:"^5.7.3",webpack:"^5.97.1"}},null,2)},{label:"Nested deep object",json:JSON.stringify({level1:{level2:{level3:{level4:{value:"deep nested value",array:[1,2,{nested:!0,items:[null,!1,"string"]}]}}},siblings:[{id:"a",data:[1,2,3]},{id:"b",data:[4,5,6]}]},metadata:{created:"2024-01-01",tags:["a","b","c"],active:null}},null,2)}]},3173(o,e,a){a.d(e,{Y:()=>t});function t(o,e){if(!(e=e.trim())||"$"===e)return[{path:"$",value:o}];let a=[];return!function o(e,t,r){if(!t)return void a.push({path:r,value:e});if(t.startsWith("..")){let a=t.slice(2);if(o(e,"."+a,r),Array.isArray(e))e.forEach((e,t)=>o(e,".."+a,`${r}[${t}]`));else if(null!==e&&"object"==typeof e)for(let t of Object.keys(e))o(e[t],".."+a,`${r}.${t}`);return}let n=t.match(/^\.(\*|[^.[*\]]+)(.*)/s);if(n){let[,a,t]=n;if("*"===a){if(Array.isArray(e))e.forEach((e,a)=>o(e,t,`${r}[${a}]`));else if(null!==e&&"object"==typeof e)for(let a of Object.keys(e))o(e[a],t,`${r}.${a}`)}else if(null===e||"object"!=typeof e||Array.isArray(e))Array.isArray(e)&&e.forEach((e,n)=>{if(null!==e&&"object"==typeof e&&!Array.isArray(e)){let i=e[a];void 0!==i&&o(i,t,`${r}[${n}].${a}`)}});else{let n=e[a];void 0!==n&&o(n,t,`${r}.${a}`)}return}let i=t.match(/^\[(\*|\d+|'[^']*'|"[^"]*")\](.*)/s);if(i){let[,a,t]=i;if("*"===a){if(Array.isArray(e))e.forEach((e,a)=>o(e,t,`${r}[${a}]`));else if(null!==e&&"object"==typeof e)for(let a of Object.keys(e))o(e[a],t,`${r}['${a}']`)}else if(/^\d+$/.test(a)){let n=parseInt(a,10);Array.isArray(e)&&n<e.length&&o(e[n],t,`${r}[${n}]`)}else{let n=a.slice(1,-1);if(null!==e&&"object"==typeof e&&!Array.isArray(e)){let a=e[n];void 0!==a&&o(a,t,`${r}['${n}']`)}}return}}(o,e.startsWith("$")?e.slice(1):e,"$"),a}},7330(o,e,a){a.d(e,{FlyoutPanel:()=>oR});var t=a(5723),r=a(7991),n=a.n(r),i=a(6859),l=a.n(i),s=a(2799),d=a(255),c=a(1316),p=a(814),g=a(6896),m=a(7902),f=a(3013),u=a(2887),x=a(9510),b=a(9848),h=a(7901),y=a(3045),w=a(3775),$=a(1783),z=a(3539),v=a(9416),k=a(1837),M=a(7167),A=a(4494),T=a(2314),S=a(5751),j=a(9633),F=a(2946),B=a(822),P=a(6720),R=a(7400),E=a(8456),C=a(3317),H=a(2709),L=a(8006),D=a(9301),N=a(7561),K=a(3517),I=a(8207),V=a(7032),Y=a(6949),G=a(8218),_=a(6829),O=a(9591),J=a(5553),U=a(9923),W=a(2820),Z=a(4621),q=a(8479),X=a(2534),Q=a(6673),oo=a(7490),oe=a(9033),oa=a(9038),ot=a(5775),or=a(1365),on=a(2937),oi=a(9821),ol=a(5912),os=a(158),od=a(8641),oc=a(8607),op=a(3249),og=a(1821),om=a(5889),of=a(9655),ou=a(7170),ox=a(9161),ob=a(1849),oh=a(1604),oy=a(3142),ow=a(1187),o$=a(7747),oz=a(2932),ov=a(4525),ok=a(7230),oM=a(2164);let oA={activity:g.A,"a-large-small":m.A,apple:f.A,"arrow-right":u.A,"bar-chart-2":x.A,book:b.A,"book-open":h.A,briefcase:y.A,calendar:w.A,clock:$.A,"circle-dot":z.A,cloud:v.A,compass:k.A,cpu:M.A,droplets:A.A,feather:T.A,file:d.A,"file-text":S.A,folder:j.A,"git-branch":F.A,github:B.A,globe:P.A,grid:R.A,hand:E.A,hash:C.A,heart:H.A,key:L.A,hexagon:D.A,home:N.A,landmark:K.A,layers:I.A,"layout-grid":V.A,leaf:Y.A,lightbulb:G.A,list:_.A,map:O.A,"map-pin":J.A,"message-circle":U.A,"message-square":W.A,minus:Z.A,monitor:q.A,mountain:X.A,package:Q.A,palette:oo.A,"pen-tool":oe.A,"pie-chart":oa.A,plane:ot.A,plus:or.A,ruler:on.A,shirt:oi.A,slash:ol.A,square:os.A,star:od.A,sun:oc.A,terminal:op.A,thermometer:og.A,triangle:om.A,trophy:of.A,truck:ou.A,type:ox.A,users:ob.A,"volume-2":oh.A,watch:oy.A,waves:ow.A,wind:o$.A,wrench:oz.A,x:ov.A,zap:ok.A,bot:oM.A},oT=(0,s.keyframes)`
...
`,J=s().div`
  ...
  color: ${t.w4.colors.sidebarTextMuted};
  font-family: ${t.w4.typography.fontFamily};
`;function U({onSave:o,onUpdate:e,onCancel:a,existingDoc:t}){let[i,l]=(0,n.useState)(t?.name??""),s=(0,n.useRef)(null);return(0,n.useEffect)(()=>{s.current?.focus(),t&&s.current?.select()},[t]),(0,r.jsx)(K,{onClick:a,children:(0,r.jsxs)(I,{onClick:o=>o.stopPropagation(),children:[(0,r.jsx)(V,{children:"Save document"}),t&&e&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(J,{children:"Update the current version or save as a new one."}),(0,r.jsxs)(G,{children:[(0,r.jsx)(_,{onClick:a,children:"Cancel"}),(0,r.jsxs)(_,{danger:!0,onClick:e,children:['Update "',t.name,'"']})]}),(0,r.jsx)(O,{})]}),(0,r.jsx)(Y,{ref:s,value:i,onChange:o=>l(o.target.value),onKeyDown:r=>{"Enter"===r.key&&i.trim()&&(t&&i.trim()===t.name&&e?e():o(i.trim())),"Escape"===r.key&&a()},placeholder:t?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,r.jsxs)(G,{children:[!t&&(0,r.jsx)(_,{onClick:a,children:"Cancel"}),(0,r.jsx)(_,{primary:!0,disabled:!i.trim(),onClick:()=>o(i.trim()),children:"Save as new"})]})]})})}var W=a(5625),Z=a(679),q=a(4872);let X=s().div`
  position: relative;
`,Q=s().button`
  display: flex;
  align-items: center;
...
`;function od({appId:o,onLoad:e}){let[a,t]=(0,n.useState)(!1),[i,l]=(0,n.useState)([]),s=(0,n.useRef)(null),d=(0,n.useCallback)(()=>{C.listDocs(o).then(l).catch(()=>{})},[o]);(0,n.useEffect)(()=>{if(!a)return;d();let o=o=>{s.current&&!s.current.contains(o.target)&&t(!1)};return document.addEventListener("mousedown",o),()=>document.removeEventListener("mousedown",o)},[a,d]);let c=async(o,e)=>{o.stopPropagation(),await C.deleteDoc(e),l(o=>o.filter(o=>o.id!==e))};return(0,r.jsxs)(X,{ref:s,children:[(0,r.jsxs)(Q,{onClick:()=>t(o=>!o),children:[(0,r.jsx)(W.A,{size:14}),"Saved",(0,r.jsx)(Z.A,{size:13,style:{marginLeft:2}})]}),(0,r.jsxs)(oo,{open:a,children:[(0,r.jsx)(oe,{children:"Saved versions"}),(0,r.jsx)(oa,{children:0===i.length?(0,r.jsx)(ot,{children:"No saved documents yet."}):i.map(o=>{var a;return(0,r.jsxs)(or,{children:[(0,r.jsxs)(on,{onClick:()=>{e(o.content,o.id,o.name),t(!1)},children:[(0,r.jsx)(oi,{children:o.name}),(0,r.jsx)(ol,{children:(a=o.savedAt,new Intl.DateTimeFormat(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}).format(new Date(a)))})]}),(0,r.jsx)(os,{onClick:e=>c(e,o.id),title:"Delete",children:(0,r.jsx)(q.A,{size:13})})]},o.id)})})]})]})}s().div`
