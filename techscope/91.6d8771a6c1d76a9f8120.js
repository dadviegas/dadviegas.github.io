...
`,w=i.default.main`
  ...
  display: flex;
  flex-direction: column;
`,A="atlantis:sidebar-collapsed";function $({sidebar:a,children:e,topBarRight:n,title:i="Atlantis",activeId:d=null}){const[c,$]=(0,t.useState)(()=>{try{return"true"===localStorage.getItem(A)}catch{return!1}}),[v,k]=(0,t.useState)(null),j=(0,t.useRef)(),S=()=>$(a=>{const e=!a;try{localStorage.setItem(A,String(e))}catch{}return e}),M=t.useMemo(()=>t.lazy(()=>Promise.resolve().then(o.bind(o,4914)).then(a=>({default:a.FlyoutPanel}))),[]);return(0,r.jsx)(s.I.Provider,{value:{collapsed:c,toggle:S,flyout:v,openFlyout:(a,e,o)=>{clearTimeout(j.current),k({entry:a,anchorY:e,onSelect:o})},scheduleFlyoutClose:()=>{j.current=setTimeout(()=>k(null),160)},cancelFlyoutClose:()=>clearTimeout(j.current)},children:(0,r.jsxs)(h,{children:[(0,r.jsxs)(m,{children:[a&&(0,r.jsx)(g,{children:(0,r.jsx)(u,{onClick:S,title:c?"Expand sidebar":"Collapse sidebar",children:(0,r.jsx)(l.A,{size:17})})}),(0,r.jsxs)(f,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:["Atl",(0,r.jsx)("span",{children:"antis"})]}),i&&(0,r.jsx)(p,{children:i}),n&&(0,r.jsx)(y,{children:n})]}),(0,r.jsxs)(z,{children:[null!=a&&(0,r.jsx)(x,{collapsed:c,children:(0,r.jsx)(b,{children:a})}),(0,r.jsx)(w,{children:e})]}),v&&(0,r.jsx)(t.Suspense,{fallback:null,children:(0,r.jsx)(M,{activeId:d})})]})})}var v=o(255),k=o(9753),j=o(5185);const S=i.default.div`
  display: grid;
...
//# sourceMappingURL=91.6d8771a6c1d76a9f8120.js.map