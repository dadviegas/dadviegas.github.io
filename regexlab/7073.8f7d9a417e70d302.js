...
`,I=s().div`
  ...
  color: ${t.w4.colors.sidebarTextMuted};
  font-family: ${t.w4.typography.fontFamily};
`;function N({onSave:o,onUpdate:e,onCancel:a,existingDoc:t}){let[n,l]=(0,i.useState)(t?.name??""),s=(0,i.useRef)(null);return(0,i.useEffect)(()=>{s.current?.focus(),t&&s.current?.select()},[t]),(0,r.jsx)(P,{onClick:a,children:(0,r.jsxs)(H,{onClick:o=>o.stopPropagation(),children:[(0,r.jsx)(E,{children:"Save document"}),t&&e&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(I,{children:"Update the current version or save as a new one."}),(0,r.jsxs)(D,{children:[(0,r.jsx)(K,{onClick:a,children:"Cancel"}),(0,r.jsxs)(K,{danger:!0,onClick:e,children:['Update "',t.name,'"']})]}),(0,r.jsx)(V,{})]}),(0,r.jsx)(L,{ref:s,value:n,onChange:o=>l(o.target.value),onKeyDown:r=>{"Enter"===r.key&&n.trim()&&(t&&n.trim()===t.name&&e?e():o(n.trim())),"Escape"===r.key&&a()},placeholder:t?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,r.jsxs)(D,{children:[!t&&(0,r.jsx)(K,{onClick:a,children:"Cancel"}),(0,r.jsx)(K,{primary:!0,disabled:!n.trim(),onClick:()=>o(n.trim()),children:"Save as new"})]})]})})}let G=(0,d.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,Y=(0,d.keyframes)`
