...
`;l().div`
  ...
  border: 1px solid ${d.w4.colors.border};
  border-radius: ${d.w4.borderRadius.lg};
  padding: ${d.w4.spacing.xl} ${d.w4.spacing.lg} ${d.w4.spacing.lg};
