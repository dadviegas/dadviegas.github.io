"use strict";(self.webpackChunk_atlantis_pad=self.webpackChunk_atlantis_pad||[]).push([[240],{74914(e,o,a){a.d(o,{FlyoutPanel:()=>h});var n=a(27359),t=a(53233),r=a(77207),i=a(20255),l=a(217),s=a(15959),d=a(65185),c=a(65723);const m=r.keyframes`
...
`;function f({iconKey:e}){const o=e?d.t[e]??i.A:i.A;return(0,c.jsx)(o,{size:14,strokeWidth:1.75})}function x({entries:e,activeId:o,onSelect:a}){return(0,c.jsx)(c.Fragment,{children:e.map(e=>e.children?(0,c.jsx)(n.Fragment,{children:(0,c.jsx)(x,{entries:e.children,activeId:o,onSelect:a})},e.id):(0,c.jsxs)(u,{active:o===e.id,onClick:()=>a(e),children:[(0,c.jsx)(f,{iconKey:e.icon}),e.name]},e.id))})}function h({activeId:e}){const{flyout:o,scheduleFlyoutClose:a,cancelFlyoutClose:n}=(0,s.c)();if(!o)return null;const t=o.entry.icon?d.t[o.entry.icon]??i.A:i.A;return(0,c.jsxs)(g,{anchorY:o.anchorY,onMouseEnter:n,onMouseLeave:a,children:[(0,c.jsxs)(p,{children:[(0,c.jsx)(t,{size:13,strokeWidth:2}),o.entry.name]}),(0,c.jsx)(x,{entries:o.entry.children??[],activeId:e,onSelect:e=>{o.onSelect(e),a()}})]})}},15959(e,o,a){a.d(o,{c:()=>r});var n=a(27359);const t=(0,n.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),r=()=>(0,n.useContext)(t)},65185(e,o,a){a.d(o,{t:()=>ne});var n=a(49510),t=a(99038),r=a(57400),i=a(28207),l=a(87902),s=a(36896),d=a(37901),c=a(39848),m=a(22164),g=a(3045),p=a(43775),u=a(83539),f=a(41783),x=a(1837),h=a(84494),b=a(82314),y=a(35751),w=a(20255),$=a(69633),z=a(92946),v=a(40822),k=a(36720),A=a(43317),j=a(52709),S=a(89301),M=a(83517),T=a(37032),B=a(6949),C=a(8218),E=a(36829),P=a(15553),F=a(59591),R=a(72820),L=a(14621),D=a(72534),I=a(66673),N=a(49033),H=a(31365),K=a(62937),G=a(65912),W=a(80158),O=a(88641),U=a(48607),Y=a(83249),_=a(1821),V=a(15889),J=a(27170),q=a(19161),Z=a(71849),X=a(61187),Q=a(77747),ee=a(2932),oe=a(24525),ae=a(57230);const ne={activity:s.A,"a-large-small":l.A,"bar-chart-2":n.A,book:c.A,"book-open":d.A,briefcase:g.A,calendar:p.A,clock:f.A,"circle-dot":u.A,compass:x.A,droplets:h.A,feather:b.A,file:w.A,"file-text":y.A,folder:$.A,"git-branch":z.A,github:v.A,globe:k.A,grid:r.A,hash:A.A,heart:j.A,hexagon:S.A,landmark:M.A,layers:i.A,"layout-grid":T.A,leaf:B.A,lightbulb:C.A,list:E.A,map:F.A,"map-pin":P.A,"message-square":R.A,minus:L.A,mountain:D.A,package:I.A,"pen-tool":N.A,"pie-chart":t.A,plus:H.A,ruler:K.A,slash:G.A,square:W.A,star:O.A,sun:U.A,terminal:Y.A,thermometer:_.A,triangle:V.A,truck:J.A,type:q.A,users:Z.A,waves:X.A,wind:Q.A,wrench:ee.A,x:oe.A,zap:ae.A,bot:m.A}},85723(e,o,a){a.d(o,{UO:()=>O,MJ:()=>T,KL:()=>y,w4:()=>n.w4,mZ:()=>w});var n=a(217),t=a(27359),r=a(53233),i=a(65723);r.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,r.default.span`
  ...
  animation: ${c} 10s ease ${({index:e})=>.07*e}s infinite;
...
`,r.default.div`
  ...
  overflow: hidden;
`,r.default.aside`
  width: ${({collapsed:e})=>e?d:s};
  min-width: ${({collapsed:e})=>e?d:s};
  background: ${n.w4.colors.sidebarBg};
  border-right: 1px solid ${n.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,a(74914);var g=a(61920),p=a(48607),u=a(68479);r.default.button`
  display: flex;
  align-items: center;
  justify-content: center;
  width: 32px;
...
`,M=r.default.div`
  ...
  color: ${n.w4.colors.sidebarTextMuted};
  font-family: ${n.w4.typography.fontFamily};
`;function T({onSave:e,onUpdate:o,onCancel:a,existingDoc:n}){const[r,l]=(0,t.useState)(n?.name??""),s=(0,t.useRef)(null);return(0,t.useEffect)(()=>{s.current?.focus(),n&&s.current?.select()},[n]),(0,i.jsx)($,{onClick:a,children:(0,i.jsxs)(z,{onClick:e=>e.stopPropagation(),children:[(0,i.jsx)(v,{children:"Save document"}),n&&o&&(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(M,{children:"Update the current version or save as a new one."}),(0,i.jsxs)(A,{children:[(0,i.jsx)(j,{onClick:a,children:"Cancel"}),(0,i.jsxs)(j,{danger:!0,onClick:o,children:['Update "',n.name,'"']})]}),(0,i.jsx)(S,{})]}),(0,i.jsx)(k,{ref:s,value:r,onChange:e=>l(e.target.value),onKeyDown:t=>{"Enter"===t.key&&r.trim()&&(n&&r.trim()===n.name&&o?o():e(r.trim())),"Escape"===t.key&&a()},placeholder:n?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,i.jsxs)(A,{children:[!n&&(0,i.jsx)(j,{onClick:a,children:"Cancel"}),(0,i.jsx)(j,{primary:!0,disabled:!r.trim(),onClick:()=>e(r.trim()),children:"Save as new"})]})]})})}var B=a(18006),C=a(70679),E=a(54872);const P=r.default.div`
  position: relative;
`,F=r.default.button`
  display: flex;
  align-items: center;
...
`;function O({appId:e,onLoad:o}){const[a,n]=(0,t.useState)(!1),[r,l]=(0,t.useState)([]),s=(0,t.useRef)(null),d=(0,t.useCallback)(()=>{(function(e){return b.listDocs(e)})(e).then(l).catch(()=>{})},[e]);(0,t.useEffect)(()=>{if(!a)return;d();const e=e=>{s.current&&!s.current.contains(e.target)&&n(!1)};return document.addEventListener("mousedown",e),()=>document.removeEventListener("mousedown",e)},[a,d]);return(0,i.jsxs)(P,{ref:s,children:[(0,i.jsxs)(F,{onClick:()=>n(e=>!e),children:[(0,i.jsx)(B.A,{size:14}),"Saved",(0,i.jsx)(C.A,{size:13,style:{marginLeft:2}})]}),(0,i.jsxs)(R,{open:a,children:[(0,i.jsx)(L,{children:"Saved versions"}),(0,i.jsx)(D,{children:0===r.length?(0,i.jsx)(I,{children:"No saved documents yet."}):r.map(e=>{return(0,i.jsxs)(N,{children:[(0,i.jsxs)(H,{onClick:()=>{o(e.content,e.id,e.name),n(!1)},children:[(0,i.jsx)(K,{children:e.name}),(0,i.jsx)(G,{children:(a=e.savedAt,new Intl.DateTimeFormat(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}).format(new Date(a)))})]}),(0,i.jsx)(W,{onClick:o=>(async(e,o)=>{e.stopPropagation(),await function(e){return b.deleteDoc(e)}(o),l(e=>e.filter(e=>e.id!==o))})(o,e.id),title:"Delete",children:(0,i.jsx)(E.A,{size:13})})]},e.id);var a})})]})]})}r.default.div`
...
`;function f({value:e,onChange:o,collapsed:a,onToggleCollapse:n,scrollRef:i,onScroll:f}){return a?(0,l.jsx)("div",{style:{position:"relative",flexShrink:0},children:(0,l.jsxs)(p,{onClick:n,title:"Show editor",children:[(0,l.jsx)(r.A,{size:14}),(0,l.jsx)(u,{children:"Editor"})]})}):(0,l.jsxs)(s,{collapsed:!1,children:[(0,l.jsxs)(d,{children:[(0,l.jsx)(c,{children:"Editor"}),(0,l.jsx)(m,{onClick:n,title:"Collapse editor",children:(0,l.jsx)(t.A,{size:15})})]}),(0,l.jsx)(g,{ref:i,value:e,onChange:e=>o(e.target.value),onScroll:f,placeholder:"Write markdown here…",spellCheck:!1})]})}},61326(e,o,a){a.d(o,{H:()=>h});var n=a(27359),t=a(53233),r=a(37901),i=a(70679),l=a(85723),s=a(35949),d=a(65723);const c=t.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  padding: 5px 12px;
...
`,y=t.default.span`
  ...
  font-family: ${s.w4.typography.fontFamily};
  writing-mode: vertical-rl;
`;function w({code:e,collapsed:o,onToggleCollapse:a}){const[t,s]=(0,n.useState)(""),[m,w]=(0,n.useState)(null),$=(0,n.useRef)(0),z=(0,n.useCallback)(async e=>{if(!e.trim())return s(""),void w(null);const o=++$.current;try{const a="mermaid-"+Date.now(),{svg:n}=await d.default.render(a,e);$.current===o&&(s(n),w(null))}catch(e){$.current===o&&(w(e instanceof Error?e.message:String(e)),s(""))}},[]);return(0,n.useEffect)(()=>{const o=setTimeout(()=>z(e),300);return()=>clearTimeout(o)},[e,z]),o?(0,c.jsxs)(b,{onClick:a,title:"Show preview",children:[(0,c.jsx)(l.A,{size:14}),(0,c.jsx)(y,{children:"Preview"})]}):(0,c.jsxs)(g,{children:[(0,c.jsxs)(p,{children:[(0,c.jsx)(u,{children:"Preview"}),(0,c.jsx)(f,{onClick:a,title:"Collapse preview",children:(0,c.jsx)(i.A,{size:15})})]}),m&&(0,c.jsxs)(h,{children:[(0,c.jsx)(r.A,{size:14,style:{flexShrink:0,marginTop:1}}),m]}),(0,c.jsx)(x,{dangerouslySetInnerHTML:{__html:t}})]})}},98971(e,o,a){a.d(o,{r:()=>me});var n=a(27359),t=a(28976),r=a(18055),i=a(14944),l=a(39895),s=a(6930),d=(a(61385),a(53233)),c=a(49881),m=a(13045),g=a(85723),p=a(65723);d.default.nav`padding: ${g.w4.spacing.sm} 0;`,d.default.div`
  border-bottom: 1px solid ${g.w4.colors.border}60;
  margin-bottom: 2px;
`,d.default.button`
  display: flex;
  align-items: center;
  width: 100%;
  padding: ${({collapsed:e})=>e?"10px 0":`7px ${g.w4.spacing.md}`};
  justify-content: ${({collapsed:e})=>e?"center":"space-between"};
  background: none;
  border: none;
  cursor: pointer;
  ...
  &:hover { color: ${g.w4.colors.sidebarText}; }
`,d.default.span`
  display: flex;
  align-items: center;
...
`,d.default.button`
  ...
  display: flex;
  align-items: center;
  padding: 5px ${g.w4.spacing.md};
  background: ${({active:e})=>e?g.w4.colors.sidebarActiveBg:"none"};
  border: none;
  border-left: 2px solid ${({active:e})=>e?g.w4.colors.sidebarActive:"transparent"};
  cursor: pointer;
  color: ${({active:e})=>e?g.w4.colors.sidebarActive:g.w4.colors.sidebarText};
  ...
  &:hover { background: ${g.w4.colors.sidebarHover}; }
`,d.default.button`
  ...
  border: none;
  cursor: pointer;
  color: ${({active:e})=>e?"#e3b341":g.w4.colors.sidebarTextMuted};
...
`;let x=!1;function h({code:e}){const o=(0,n.useRef)(null),[t,r]=(0,n.useState)(null);return(0,n.useEffect)(()=>{let n=!1;return async function(){const t=(await Promise.resolve().then(a.bind(a,30774))).default;if(x||(t.initialize({startOnLoad:!1,theme:"dark",themeVariables:{background:g.w4.colors.codeBg,primaryColor:g.w4.colors.accent,primaryTextColor:g.w4.colors.mainText,lineColor:g.w4.colors.border}}),x=!0),o.current&&!n)try{const a=`mermaid-${Math.random().toString(36).slice(2)}`,{svg:r}=await t.render(a,e);!n&&o.current&&(o.current.innerHTML=r)}catch(e){n||r(e instanceof Error?e.message:String(e))}}(),()=>{n=!0}},[e]),t?(0,p.jsx)(u,{children:(0,p.jsxs)(f,{children:["Mermaid error: ",t]})}):(0,p.jsx)(u,{ref:o})}const b=["#388bfd","#3fb950","#d29922","#a371f7","#f87171","#22d3ee","#fb923c","#34d399","#f472b6","#818cf8"],y=d.default.div`
  background: ${g.w4.colors.codeBg};
  border: 1px solid ${g.w4.colors.codeBorder};
  border-radius: ${g.w4.borderRadius.md};
  padding: ${g.w4.spacing.lg};
...
`,w=d.default.div`
  ...
  margin-bottom: ${g.w4.spacing.md};
  text-align: center;
`,$=d.default.div`
  display: flex;
  flex-wrap: wrap;
  justify-content: center;
  gap: ${g.w4.spacing.sm} ${g.w4.spacing.md};
  margin-top: ${g.w4.spacing.md};
  font-family: ${g.w4.typography.fontFamily};
  font-size: ${g.w4.typography.fontSizeSm};
...
`,k=d.default.div`
  ...
  font-family: ${g.w4.typography.fontFamilyMono};
  font-size: ${g.w4.typography.fontSizeSm};
`;function A(e){if(e<=0)return 10;const o=Math.pow(10,Math.floor(Math.log10(e)));return Math.ceil(e/o)*o}function j({labels:e,data:o,colors:a}){const n=176,t=A(Math.max(...o,1)),r=Math.min(40,340/e.length*.6),i=340/e.length,l=Array.from({length:6},(e,o)=>t/5*o);return(0,p.jsxs)("svg",{viewBox:"0 0 400 240",width:"100%",style:{maxWidth:400},children:[l.map((e,o)=>{const a=192-e/t*n;return(0,p.jsxs)("g",{children:[(0,p.jsx)("line",{x1:44,y1:a,x2:384,y2:a,stroke:g.w4.colors.border,strokeWidth:.5,strokeDasharray:0===o?"none":"3,3"}),(0,p.jsx)("text",{x:38,y:a+4,fill:g.w4.colors.mainTextMuted,fontSize:10,textAnchor:"end",fontFamily:g.w4.typography.fontFamily,children:Math.round(e)})]},o)}),o.map((o,l)=>{const s=44+i*l+i/2-r/2,d=o/t*n,c=192-d,m=a[l%a.length];return(0,p.jsxs)("g",{children:[(0,p.jsxs)("rect",{x:s,y:c,width:r,height:d,rx:3,fill:m,opacity:.85,children:[(0,p.jsx)("animate",{attributeName:"height",from:"0",to:d,dur:"0.5s",fill:"freeze"}),(0,p.jsx)("animate",{attributeName:"y",from:192,to:c,dur:"0.5s",fill:"freeze"})]}),(0,p.jsx)("text",{x:s+r/2,y:c-4,fill:g.w4.colors.mainText,fontSize:10,fontWeight:600,textAnchor:"middle",fontFamily:g.w4.typography.fontFamily,children:o}),(0,p.jsx)("text",{x:44+i*l+i/2,y:208,fill:g.w4.colors.mainTextMuted,fontSize:10,textAnchor:"middle",fontFamily:g.w4.typography.fontFamily,children:e[l].length>8?e[l].slice(0,7)+"…":e[l]})]},l)})]})}function S({labels:e,data:o,colors:a}){const n=o.reduce((e,o)=>e+o,0)||1;let t=-Math.PI/2;const r=o.map((e,o)=>{const r=e/n*Math.PI*2,i=t;t+=r;const l=t,s=120+90*Math.cos(i),d=120+90*Math.sin(i),c=120+90*Math.cos(l),m=120+90*Math.sin(l),u=r>Math.PI?1:0,f=i+r/2,x=120+58.5*Math.cos(f),h=120+58.5*Math.sin(f),b=Math.round(e/n*100);return(0,p.jsxs)("g",{children:[(0,p.jsx)("path",{d:`M 120 120 L ${s} ${d} A 90 90 0 ${u} 1 ${c} ${m} Z`,fill:a[o%a.length],stroke:g.w4.colors.codeBg,strokeWidth:2,opacity:.85}),b>=5&&(0,p.jsxs)("text",{x,y:h+4,fill:"#fff",fontSize:11,fontWeight:600,textAnchor:"middle",fontFamily:g.w4.typography.fontFamily,children:[b,"%"]})]},o)});return(0,p.jsx)("svg",{viewBox:"0 0 240 240",width:"100%",style:{maxWidth:240},children:r})}function M({labels:e,data:o,colors:a}){const n=176,t=A(Math.max(...o,1)),r=o.length>1?340/(o.length-1):340,i=a[0],l=o.map((e,o)=>({x:44+r*o,y:192-e/t*n})),s=l.map((e,o)=>`${0===o?"M":"L"} ${e.x} ${e.y}`).join(" "),d=Array.from({length:6},(e,o)=>t/5*o);return(0,p.jsxs)("svg",{viewBox:"0 0 400 240",width:"100%",style:{maxWidth:400},children:[d.map((e,o)=>{const a=192-e/t*n;return(0,p.jsxs)("g",{children:[(0,p.jsx)("line",{x1:44,y1:a,x2:384,y2:a,stroke:g.w4.colors.border,strokeWidth:.5,strokeDasharray:0===o?"none":"3,3"}),(0,p.jsx)("text",{x:38,y:a+4,fill:g.w4.colors.mainTextMuted,fontSize:10,textAnchor:"end",fontFamily:g.w4.typography.fontFamily,children:Math.round(e)})]},o)}),(0,p.jsx)("path",{d:s,fill:"none",stroke:i,strokeWidth:2.5,strokeLinecap:"round",strokeLinejoin:"round"}),l.map((a,n)=>(0,p.jsxs)("g",{children:[(0,p.jsx)("circle",{cx:a.x,cy:a.y,r:4,fill:i,stroke:g.w4.colors.codeBg,strokeWidth:2}),(0,p.jsx)("text",{x:a.x,y:a.y-10,fill:g.w4.colors.mainText,fontSize:10,fontWeight:600,textAnchor:"middle",fontFamily:g.w4.typography.fontFamily,children:o[n]}),(0,p.jsx)("text",{x:a.x,y:208,fill:g.w4.colors.mainTextMuted,fontSize:10,textAnchor:"middle",fontFamily:g.w4.typography.fontFamily,children:e[n].length>8?e[n].slice(0,7)+"…":e[n]})]},n))]})}function T({code:e}){const o=(0,n.useMemo)(()=>function(e){const o=e.trim().split("\n");let a,n,t="bar",r=[],i=[];for(const e of o){const[o,...l]=e.split(":"),s=l.join(":").trim();if(s)switch(o.trim().toLowerCase()){case"type":["bar","pie","line"].includes(s.toLowerCase())&&(t=s.toLowerCase());break;case"title":a=s;break;case"labels":r=s.replace(/^\[|\]$/g,"").split(",").map(e=>e.trim());break;case"data":i=s.replace(/^\[|\]$/g,"").split(",").map(e=>parseFloat(e.trim())||0);break;case"colors":n=s.replace(/^\[|\]$/g,"").split(",").map(e=>e.trim())}}return r.length&&i.length?{type:t,title:a,labels:r,data:i,colors:n}:null}(e),[e]);if(!o)return(0,p.jsx)(y,{children:(0,p.jsx)(k,{children:"Invalid chart data"})});const a=o.colors??b;return(0,p.jsxs)(y,{children:[o.title&&(0,p.jsx)(w,{children:o.title}),"bar"===o.type&&(0,p.jsx)(j,{labels:o.labels,data:o.data,colors:a}),"pie"===o.type&&(0,p.jsx)(S,{labels:o.labels,data:o.data,colors:a}),"line"===o.type&&(0,p.jsx)(M,{labels:o.labels,data:o.data,colors:a}),(0,p.jsx)($,{children:o.labels.map((e,o)=>(0,p.jsxs)(z,{children:[(0,p.jsx)(v,{color:a[o%a.length]}),e]},o))})]})}const B=d.default.div`
  background: ${g.w4.colors.codeBg};
  border: 1px solid ${g.w4.colors.codeBorder};
  border-radius: ${g.w4.borderRadius.md};
  padding: ${g.w4.spacing.lg};
...
`,F=d.default.button`
  padding: 6px 14px;
  border: 1px solid ${({active:e})=>e?g.w4.colors.accent:g.w4.colors.border};
  border-radius: ${g.w4.borderRadius.md};
  background: ${({active:e})=>e?g.w4.colors.accentMuted:"transparent"};
  color: ${({active:e})=>e?g.w4.colors.accent:g.w4.colors.mainTextMuted};
  font-family: ${g.w4.typography.fontFamily};
  font-size: ${g.w4.typography.fontSizeSm};
  font-weight: 500;
  cursor: pointer;
  ...
  &:hover {
    border-color: ${g.w4.colors.accent};
...
`,L=d.default.div`
  ...
  color: ${g.w4.colors.mainText};
  text-align: center;
`;function D(e){return e.toString().padStart(2,"0")}function I(e,o,a){if("pt"===a){const a=1===e?"1 hora":`${e} horas`;return 0===o?a:15===o?`${a} e um quarto`:30===o?`${a} e meia`:45===o?`um quarto para as ${12===e?1:e+1}`:`${a} e ${o} minutos`}const n=e<12?"AM":"PM",t=e%12||12;return 0===o?`${t} o'clock ${n}`:15===o?`quarter past ${t} ${n}`:30===o?`half past ${t} ${n}`:45===o?`quarter to ${t%12+1} ${n}`:`${t}:${D(o)} ${n}`}function N({hours:e,minutes:o,seconds:a}){const n=100,t=100,r=e=>e*Math.PI/180,i=a/60*360-90,l=o/60*360+a/60*6-90,s=e%12/12*360+o/60*30-90,d=n+61*Math.cos(r(i)),c=t+61*Math.sin(r(i)),m=n+65*Math.cos(r(l)),u=t+65*Math.sin(r(l)),f=n+45*Math.cos(r(s)),x=t+45*Math.sin(r(s));return(0,p.jsxs)("svg",{viewBox:"0 0 200 200",width:200,height:200,children:[(0,p.jsx)("circle",{cx:n,cy:t,r:85,fill:g.w4.colors.surface,stroke:g.w4.colors.border,strokeWidth:2}),Array.from({length:12},(e,o)=>{const a=o+1,i=a/12*360-90,l=n+69*Math.cos(r(i)),s=t+69*Math.sin(r(i));return(0,p.jsx)("text",{x:l,y:s+4,fill:g.w4.colors.mainText,fontSize:14,fontWeight:600,textAnchor:"middle",fontFamily:g.w4.typography.fontFamily,children:a},a)}),Array.from({length:60},(e,o)=>{const a=o/60*360-90,i=o%5==0,l=i?75:79;return(0,p.jsx)("line",{x1:n+l*Math.cos(r(a)),y1:t+l*Math.sin(r(a)),x2:n+83*Math.cos(r(a)),y2:t+83*Math.sin(r(a)),stroke:i?g.w4.colors.mainTextMuted:g.w4.colors.border,strokeWidth:i?2:1},o)}),(0,p.jsx)("line",{x1:n,y1:t,x2:f,y2:x,stroke:g.w4.colors.mainText,strokeWidth:4,strokeLinecap:"round"}),(0,p.jsx)("line",{x1:n,y1:t,x2:m,y2:u,stroke:g.w4.colors.accent,strokeWidth:2.5,strokeLinecap:"round"}),(0,p.jsx)("line",{x1:n-12*Math.cos(r(i)),y1:t-12*Math.sin(r(i)),x2:d,y2:c,stroke:"#f87171",strokeWidth:1.2,strokeLinecap:"round"}),(0,p.jsx)("circle",{cx:n,cy:t,r:4,fill:g.w4.colors.accent}),(0,p.jsx)("circle",{cx:n,cy:t,r:2,fill:"#f87171"})]})}function H({code:e}){const o=function(e){let o="pt";for(const a of e.trim().split("\n")){const[e,...n]=a.split(":"),t=n.join(":").trim();"locale"===e.trim().toLowerCase()&&(o=t.toLowerCase())}return{locale:o}}(e),[a,t]=(0,n.useState)("live"),[r,i]=(0,n.useState)(()=>(new Date).getHours()),[l,s]=(0,n.useState)(()=>(new Date).getMinutes()),[d,c]=(0,n.useState)(()=>(new Date).getSeconds());(0,n.useEffect)(()=>{if("live"!==a)return;const e=()=>{const e=new Date;i(e.getHours()),s(e.getMinutes()),c(e.getSeconds())};e();const o=setInterval(e,1e3);return()=>clearInterval(o)},[a]);const m=(0,n.useCallback)(e=>{t("manual"),c(0),i(o=>((o+e)%24+24)%24)},[]),g=(0,n.useCallback)(e=>{t("manual"),c(0),s(o=>((o+e)%60+60)%60)},[]),u=(0,n.useCallback)(()=>t("live"),[]);return(0,p.jsxs)(B,{children:[(0,p.jsxs)(C,{children:[(0,p.jsx)(N,{hours:r,minutes:l,seconds:d}),(0,p.jsxs)("div",{children:[(0,p.jsxs)(E,{children:[D(r),":",D(l),(0,p.jsxs)("span",{style:{fontSize:"24px",opacity:.5},children:[":",D(d)]})]}),(0,p.jsx)(L,{children:I(r%12||12,l,o.locale)})]})]}),(0,p.jsxs)(P,{children:[(0,p.jsx)(F,{onClick:()=>m(-1),children:"−1h"}),(0,p.jsx)(F,{onClick:()=>m(1),children:"+1h"}),(0,p.jsx)(F,{onClick:()=>g(-15),children:"−15m"}),(0,p.jsx)(F,{onClick:()=>g(15),children:"+15m"}),(0,p.jsx)(F,{onClick:()=>g(-5),children:"−5m"}),(0,p.jsx)(F,{onClick:()=>g(5),children:"+5m"}),(0,p.jsx)(F,{active:"live"===a,onClick:u,children:"pt"===o.locale?"Agora":"Now"})]}),(0,p.jsx)(R,{children:"pt"===o.locale?"Usa os botões para mudar as horas e os minutos!":"Use the buttons to change the hours and minutes!"}),(0,p.jsx)(P,{children:[{label:"3:00",h:3,m:0},{label:"6:30",h:6,m:30},{label:"9:15",h:9,m:15},{label:"12:00",h:12,m:0},{label:"13:45",h:13,m:45},{label:"15:30",h:15,m:30},{label:"19:00",h:19,m:0},{label:"23:15",h:23,m:15}].map(e=>(0,p.jsx)(F,{onClick:()=>{t("manual"),i(e.h),s(e.m)},children:e.label},e.label))})]})}var K=a(68383),G=a(21426),W=a(25609),O=a(20320);const U=d.default.div`
  margin: ${g.w4.spacing.lg} 0;
  border-radius: ${g.w4.borderRadius.md};
  border: 1px solid ${g.w4.colors.codeBorder};
  overflow: hidden;
...
`,V=d.default.button`
  ...
  padding: 3px 8px;
  background: none;
  border: 1px solid ${({copied:e})=>e?"#3fb950":g.w4.colors.border};
  border-radius: ${g.w4.borderRadius.sm};
  color: ${({copied:e})=>e?"#3fb950":g.w4.colors.sidebarTextMuted};
  font-size: 11px;
  font-family: ${g.w4.typography.fontFamily};
  cursor: pointer;
  transition: color 0.15s, border-color 0.15s;
  &:hover { color: ${g.w4.colors.sidebarText}; border-color: ${g.w4.colors.sidebarText}; }
`,J={...G.A,'pre[class*="language-"]':{...G.A['pre[class*="language-"]'],background:g.w4.colors.codeBg,margin:0,padding:"18px 20px",fontSize:"13px",lineHeight:"1.6",borderRadius:0},'code[class*="language-"]':{...G.A['code[class*="language-"]'],background:"none",fontSize:"13px"}};function q({lang:e="text",code:o}){const[a,t]=(0,n.useState)(!1);return(0,p.jsxs)(U,{children:[(0,p.jsxs)(Y,{children:[(0,p.jsx)(_,{children:e}),(0,p.jsxs)(V,{copied:a,onClick:()=>{navigator.clipboard.writeText(o).then(()=>{t(!0),setTimeout(()=>t(!1),2e3)})},children:[a?(0,p.jsx)(W.A,{size:12}):(0,p.jsx)(O.A,{size:12}),a?"Copied!":"Copy"]})]}),(0,p.jsx)(K.A,{language:e,style:J,showLineNumbers:o.split("\n").length>8,lineNumberStyle:{color:"#484f58",minWidth:"2.5em",paddingRight:"1.5em",userSelect:"none",fontSize:"12px"},customStyle:{margin:0,background:g.w4.colors.codeBg},wrapLongLines:!1,children:o})]})}var Z=a(65569),X=a(8218),Q=a(57230),ee=a(22966),oe=a(21069);function ae(){return e=>{!function e(o){if("blockquote"===o.type){const e=o.children?.[0];if("paragraph"===e?.type){const a=e.children?.[0];if("text"===a?.type){const n=a.value?.match(/^\[!(NOTE|TIP|WARNING|CAUTION|IMPORTANT)\]\s*/i);n&&(a.value=a.value.slice(n[0].length),a.value.trim()||1!==e.children.length||o.children.shift(),o.data=o.data??{},o.data.hName="div",o.data.hProperties={"data-callout":n[1].toUpperCase()})}}}o.children?.forEach(e)}(e)}}Z.A,X.A,Q.A,ee.A,oe.A,d.default.div`
  background: ${({bg:e})=>e};
  border-left: 3px solid ${({border:e})=>e};
  border-radius: 0 ${g.w4.borderRadius.md} ${g.w4.borderRadius.md} 0;
...
`,d.default.nav`
  width: 220px;
  min-width: 220px;
  padding: ${g.w4.spacing.xxl} 0 ${g.w4.spacing.xxl} ${g.w4.spacing.xl};
...
`,d.default.ul`list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 2px;`,d.default.a`
  ...
  font-size: ${g.w4.typography.fontSizeSm};
  font-family: ${g.w4.typography.fontFamily};
  color: ${({active:e})=>e?g.w4.colors.accent:g.w4.colors.sidebarTextMuted};
  text-decoration: none;
  border-left: 2px solid ${({active:e})=>e?g.w4.colors.accent:"transparent"};
  border-radius: 0 ${g.w4.borderRadius.sm} ${g.w4.borderRadius.sm} 0;
  line-height: 1.4;
  transition: color 0.12s, border-color 0.12s, background 0.12s;
  word-break: break-word;
  &:hover { color: ${g.w4.colors.mainText}; background: ${g.w4.colors.sidebarHover}; }
`,d.default.div`
  display: flex;
  align-items: flex-start;
  max-width: 1200px;
  margin: 0 auto;
  padding: 0 ${g.w4.spacing.xl};
  width: 100%;
  box-sizing: border-box;
`,d.default.div`flex: 1; min-width: 0;`,d.default.article`
  padding: ${g.w4.spacing.xxl} 0;
  color: ${g.w4.colors.mainText};
  font-family: ${g.w4.typography.fontFamily};
  font-size: ${g.w4.typography.fontSizeMd};
  ...
  h1, h2, h3, h4, h5, h6 {
    ...
    .heading-anchor {
      opacity: 0; margin-left: 8px; color: ${g.w4.colors.sidebarTextMuted};
  ...
  a { color: ${g.w4.colors.accent}; text-decoration: none; &:hover { text-decoration: underline; color: ${g.w4.colors.accentHover}; } }
  ...
  .katex-display { margin: ${g.w4.spacing.lg} 0; }
`,d.default.div`
  display: flex;
  gap: ${g.w4.spacing.lg};
  padding: ${g.w4.spacing.xxl} 0;
  border-top: 1px solid ${g.w4.colors.border};
  margin-top: ${g.w4.spacing.xxl};
`,d.default.button`
  flex: 1;
  display: flex;
  flex-direction: column;
  ...
  &:hover { border-color: ${g.w4.colors.accent}; background: rgba(88, 166, 255, 0.05); }
`,d.default.div`
  display: flex; align-items: center; gap: 4px;
  font-size: 11px; color: ${g.w4.colors.sidebarTextMuted}; font-family: ${g.w4.typography.fontFamily};
  font-weight: 600; text-transform: uppercase; letter-spacing: 0.06em;
`,d.default.div`
  font-size: ${g.w4.typography.fontSizeBase}; color: ${g.w4.colors.accent};
  font-family: ${g.w4.typography.fontFamily}; font-weight: 500;
`,d.default.div`
  color: ${g.w4.colors.mainTextMuted};
  padding: ${g.w4.spacing.xxl} ${g.w4.spacing.xl};
  font-family: ${g.w4.typography.fontFamily};
`,d.default.div`
  display: flex;
  align-items: center;
...
`,d.default.div`
  ...
  inset: 0;
  background-image:
    linear-gradient(${g.w4.colors.border}40 1px, transparent 1px),
    linear-gradient(90deg, ${g.w4.colors.border}40 1px, transparent 1px);
...
`,d.default.h1`
  ...
  background: linear-gradient(135deg,
    ${g.w4.colors.mainText} 0%,
    ${g.w4.colors.accent} 50%,
    hsl(270, 70%, 70%) 100%
  );
  -webkit-background-clip: text;
  -webkit-text-fill-color: transparent;
...
`,d.default.button`
  ...
  background: ${({active:e})=>e?g.w4.colors.accent:"transparent"};
  color: ${({active:e})=>e?"#0d1117":g.w4.colors.mainTextMuted};
  &:hover {
    color: ${({active:e})=>e?"#0d1117":g.w4.colors.mainText};
  }
`;const ne=d.default.div`
  display: flex;
  flex-direction: column;
  flex: 1;
  min-width: 0;
