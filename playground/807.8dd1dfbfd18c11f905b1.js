"use strict";(self.webpackChunk_atlantis_playground=self.webpackChunk_atlantis_playground||[]).push([[807],{188(e,t,r){var o=r(7359),s=r(8997),n=r(3233),a=r(7207),i=r(894),l=r(7071),c=r(6480),d=r(6135),p=r(9421),u=r(679),f=r(3482),m=r(1530),h=r(5496),g=r(9881),x=r(5426),b=r(9336),w=r(7293),y=r(5723);const $=a.keyframes`from{transform:rotate(0deg)}to{transform:rotate(360deg)}`,k=(0,n.default)(l.A)`animation: ${$} 1s linear infinite;`,j=n.default.div`
  display: flex;
  align-items: center;
  gap: ${i.w4.spacing.sm};
...
//# sourceMappingURL=807.8dd1dfbfd18c11f905b1.js.map