"use strict";(self.webpackChunk_atlantis_forma=self.webpackChunk_atlantis_forma||[]).push([["839"],{90429(e,t,a){a.d(t,{N:()=>F});var r=a(65723),o=a(37991),i=a(36859),n=a.n(i),s=a(72799),l=a(6063),d=a(63236),c=a(69454);let p="#7fb77e",h={month:30,"3m":90,"6m":183,year:365,all:null},m=(0,s.keyframes)`
...
`,j={fast:p,meal:"#58a6ff",weight:"#d29922",walk:"#a371f7"},z={fast:"flame",meal:"utensils",weight:"gauge",walk:"activity"};function T(e){let[t,a,r]=e.split("-").map(e=>parseInt(e,10));return new Date(t,(a??1)-1,r??1).getTime()}function F({data:e,t,locale:a,onEditFast:i,onEditMeal:n,onDuplicateMeal:s,onEditWeight:l,onDeleteFast:p,onDeleteMeal:m,onDeleteWeight:S,onDeleteWalk:C}){let[A,D]=(0,o.useState)("all"),[L,R]=(0,o.useState)("month"),H=(0,o.useMemo)(()=>(function(e,t){let a=[];for(let r of e.sessions){let e=r.endedAt?(r.endedAt-r.startedAt)/36e5:(Date.now()-r.startedAt)/36e5;a.push({kind:"fast",ts:r.startedAt,id:r.id,editable:!0,primary:r.endedAt?`${t("forma.activities.fast.completed")} \xb7 ${e.toFixed(1)}h`:`${t("forma.activities.fast.inProgress")} \xb7 ${e.toFixed(1)}h`,meta:`${r.protocol} \xb7 ${t("forma.activities.fast.target")} ${r.targetHours}h`})}for(let r of e.meals){let e="forma.meal."+r.slot,o=[];r.proteinG&&o.push(`${r.proteinG}g ${t("forma.activities.protein")}`),r.kcal&&o.push(`${r.kcal} kcal`),a.push({kind:"meal",ts:r.createdAt??T(r.date),id:r.id,editable:!0,primary:`${t(e)}${r.notes?` \xb7 ${r.notes}`:""}`,meta:o.length>0?o.join(" \xb7 "):"—"})}for(let r of e.weights)a.push({kind:"weight",ts:T(r.date),id:r.date,editable:!0,primary:`${r.kg.toFixed(1)} kg`,meta:t("forma.activities.weight.entry")});for(let r of e.walks)a.push({kind:"walk",ts:T(r.date),id:r.date,editable:!1,primary:`${r.minutes} min`,meta:t("forma.activities.walk.entry")});return a.sort((e,t)=>t.ts-e.ts),a})(e,t),[e,t]),I=(0,o.useMemo)(()=>{let e=h[L];return null===e?0:Date.now()-864e5*e},[L]),P=(0,o.useMemo)(()=>H.filter(e=>e.ts>=I),[H,I]),B=(0,o.useMemo)(()=>"all"===A?P:P.filter(e=>e.kind===A),[P,A]),W=(0,o.useMemo)(()=>{let e={all:P.length,fast:0,meal:0,weight:0,walk:0};for(let t of P)e[t.kind]+=1;return e},[P]),E=(e,a)=>(0,r.jsxs)(d.vu,{variant:A===e?"selected":"default",dotColor:"all"===e?void 0:j[e],onClick:()=>D(e),children:[t(a)," ",W[e]>0&&`(${W[e]})`]},e);return(0,r.jsxs)(g,{children:[(0,r.jsx)(f,{children:["month","3m","6m","year","all"].map(e=>(0,r.jsx)(d.vu,{variant:L===e?"selected":"default",onClick:()=>R(e),children:t("forma.activities.range."+e)},e))}),(0,r.jsxs)(f,{children:[E("all","forma.activities.filter.all"),E("fast","forma.activities.filter.fast"),E("meal","forma.activities.filter.meal"),E("weight","forma.activities.filter.weight"),E("walk","forma.activities.filter.walk")]}),0===B.length?(0,r.jsx)(c.YG,{mode:"empty",label:t("forma.activities.empty")}):(0,r.jsx)(x,{children:B.map(o=>(0,r.jsxs)(u,{children:[(0,r.jsx)(w,{color:j[o.kind],children:(0,r.jsx)(d.In,{name:z[o.kind],size:14})}),(0,r.jsxs)(y,{children:[(0,r.jsx)(b,{children:o.primary}),(0,r.jsx)($,{children:o.meta})]}),(0,r.jsx)(v,{children:function(e,t,a){let r=new Date(e),o=r.toLocaleDateString("pt"===t?"pt-PT":"en-GB",{day:"2-digit",month:"short"});if(!a)return o;let i=r.toLocaleTimeString("pt"===t?"pt-PT":"en-GB",{hour:"2-digit",minute:"2-digit"});return`${o} ${i}`}(o.ts,a,"fast"===o.kind||"meal"===o.kind)}),(0,r.jsxs)(k,{children:["meal"===o.kind&&s&&(0,r.jsx)(M,{onClick:()=>(t=>{if("meal"!==t.kind||!s)return;let a=e.meals.find(e=>e.id===t.id);a&&s(a)})(o),title:t("forma.activities.duplicateToToday"),"aria-label":t("forma.activities.duplicateToToday"),children:(0,r.jsx)(d.In,{name:"copy",size:14})}),o.editable&&(0,r.jsx)(M,{onClick:()=>(t=>{if(t.editable){if("fast"===t.kind){let a=e.sessions.find(e=>e.id===t.id);a&&i(a)}else if("meal"===t.kind){let a=e.meals.find(e=>e.id===t.id);a&&n(a)}else if("weight"===t.kind){let a=e.weights.find(e=>e.date===t.id);a&&l(a)}}})(o),title:t("forma.activities.edit"),"aria-label":t("forma.activities.edit"),children:(0,r.jsx)(d.In,{name:"edit",size:14})}),(0,r.jsx)(M,{onClick:()=>{let e;return e="forma.activities.confirmDelete."+o.kind,void(window.confirm(t(e))&&("fast"===o.kind&&p(o.id),"meal"===o.kind&&m(o.id),"weight"===o.kind&&S(o.id),"walk"===o.kind&&C(o.id)))},title:t("forma.activities.delete"),"aria-label":t("forma.activities.delete"),children:(0,r.jsx)(d.In,{name:"trash",size:14})})]})]},`${o.kind}:${o.id}`))})]})}},84391(e,t,a){a.d(t,{v:()=>j});var r=a(65723),o=a(37991),i=a(36859),n=a.n(i),s=a(72799),l=a(6063),d=a(69454),c=a(1609);let p="#7fb77e",h="forma:timeline:range",m=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,g=n().div`
  display: flex;
...
`,M=n().div`
  ...
  font-variant-numeric: tabular-nums;
  color: ${p};
`;function j({data:e,t,locale:a}){let[i,n]=(0,o.useState)("1m"),[s,m]=(0,o.useState)(void 0),[z,T]=(0,o.useState)(!1);(0,o.useEffect)(()=>{(0,l.PL)(h).then(e=>{("1m"===e||"3m"===e||"6m"===e||"1y"===e)&&n(e),T(!0)}).catch(()=>T(!0))},[]);let F=(0,o.useCallback)(e=>{n(e),m(void 0),(0,l.Is)(h,e).catch(()=>{})},[]),S=(0,o.useMemo)(()=>(function(e,t){let a=d.zA[t],r=Array(a).fill(0),o=new Date;for(let t=0;t<a;t++){let[i,n,s]=(0,d.x)(t,a,o).split("-").map(e=>parseInt(e,10)),l=new Date(i,(n??1)-1,s??1).getTime(),c=l+864e5,p=0;for(let t of e.sessions){let e=t.startedAt,a=Math.min(t.endedAt??Date.now(),c)-Math.max(e,l);a>0&&(p+=a/36e5)}let h=0;p>=16?h=4:p>=12?h=3:p>=8?h=2:p>0&&(h=1),r[t]=h}return r})(e,i),[e,i]),C=d.zA[i],A=void 0!==s?(0,d.x)(s,C):null,D=(0,o.useMemo)(()=>A?(0,c.Af)(e,A,t,a):null,[e,A,t,a]),L=(0,o.useMemo)(()=>{let t=new Date,a=[];for(let e=0;e<C;e++)a.push((0,d.x)(e,C,t));let r=a[0]??"",o=a[a.length-1]??"",i=0;for(let t of e.sessions){let e=t.startedAt,a=t.endedAt??Date.now(),n=new Date(r).getTime(),s=Math.min(a,new Date(o).getTime()+864e5)-Math.max(e,n);s>0&&(i+=s/36e5)}let n={};for(let t of e.meals)t.date>=r&&t.date<=o&&(n[t.date]=(n[t.date]??0)+(t.proteinG??0));let s=Object.keys(n).length,l=Object.values(n).reduce((e,t)=>e+t,0),c=e.weights.filter(e=>e.date>=r&&e.date<=o).sort((e,t)=>e.date.localeCompare(t.date));return{totalFastHours:i,avgProtein:s>0?l/s:0,weightDelta:c.length>=2?(c[c.length-1]?.kg??0)-(c[0]?.kg??0):null,totalWalkMins:e.walks.filter(e=>e.date>=r&&e.date<=o).reduce((e,t)=>e+t.minutes,0)}},[e,i,C]),R=(0,o.useMemo)(()=>({"1m":t("forma.timeline.range.1m"),"3m":t("forma.timeline.range.3m"),"6m":t("forma.timeline.range.6m"),"1y":t("forma.timeline.range.1y")}),[t]),H=(0,o.useCallback)((r,o)=>{if(0===o)return;let i=(0,d.x)(r,C);return(0,c.Af)(e,i,t,a)},[e,C,t,a]);return z?(0,r.jsxs)(g,{children:[(0,r.jsxs)(f,{children:[(0,r.jsx)(x,{children:t("forma.timeline.title")}),(0,r.jsx)(d.zy,{range:i,onChange:F,labels:R})]}),(0,r.jsx)(u,{children:(0,r.jsx)(d.RT,{data:S,locale:a,showMonthLabels:!0,accent:p,selectedIndex:s,onCellClick:e=>m(t=>t===e?void 0:e),tooltip:H})}),null!==D&&(0,r.jsxs)(w,{children:[(0,r.jsx)(y,{children:t("forma.timeline.selectedDay.title")}),(0,r.jsx)(b,{children:D})]}),(0,r.jsxs)($,{children:[(0,r.jsxs)(v,{children:[(0,r.jsx)(k,{children:t("forma.timeline.kpi.fastHours")}),(0,r.jsxs)(M,{children:[L.totalFastHours.toFixed(0),"h"]})]}),(0,r.jsxs)(v,{children:[(0,r.jsx)(k,{children:t("forma.timeline.kpi.avgProtein")}),(0,r.jsxs)(M,{children:[L.avgProtein.toFixed(0),"g"]})]}),(0,r.jsxs)(v,{children:[(0,r.jsx)(k,{children:t("forma.timeline.kpi.weightDelta")}),(0,r.jsx)(M,{children:null!==L.weightDelta?`${L.weightDelta>=0?"+":""}${L.weightDelta.toFixed(1)} kg`:"—"})]}),(0,r.jsxs)(v,{children:[(0,r.jsx)(k,{children:t("forma.timeline.kpi.walks")}),(0,r.jsxs)(M,{children:[L.totalWalkMins," min"]})]})]})]}):(0,r.jsx)(g,{})}},84964(e,t,a){a.d(t,{Q:()=>e5});var r=a(65723),o=a(37991),i=a(36859),n=a.n(i),s=a(72799),l=a(6063),d=a(63019),c=a(69454),p=a(4406),h=a(1609);let m="#7fb77e";function g(e){return[parseInt(e.slice(1,3),16),parseInt(e.slice(3,5),16),parseInt(e.slice(5,7),16)]}let f=g("#1d2230"),x=g(m);function u(e){let t=Math.round(f[0]+(x[0]-f[0])*e),a=Math.round(f[1]+(x[1]-f[1])*e),r=Math.round(f[2]+(x[2]-f[2])*e);return`rgb(${t},${a},${r})`}let w=new Set([0,4,8,12,16,20]),y=["Mo","Tu","We","Th","Fr","Sa","Su"],b=["Se","Te","Qa","Qi","Sx","S\xe1","Do"],$=n().section`
  background: ${l.w4.colors.surface};
  border: 1px solid ${l.w4.colors.border};
...
`,H=n().div`
  ...
  color: ${l.w4.colors.mainTextMuted};
  margin-top: 2px;
`;function I({data:e,t,locale:a}){let[i,n]=(0,o.useState)(null),s=(0,o.useMemo)(()=>(0,d.mealDayHourMatrix)(e.meals),[e.meals]),l=(0,o.useMemo)(()=>(0,d.mealKcalByHour)(e.meals),[e.meals]),c=(0,o.useMemo)(()=>{let e=0;for(let t of s)for(let a of t)a>e&&(e=a);return e},[s]),p=(0,o.useMemo)(()=>Math.max(0,...l),[l]),m=(0,o.useMemo)(()=>l.reduce((e,t)=>e+t,0),[l]),g="pt"===a?b:y;return(0,r.jsxs)($,{children:[(0,r.jsx)(v,{children:t("forma.mealHeatmap.title")}),(0,r.jsxs)(k,{children:[(0,r.jsxs)(M,{children:[(0,r.jsx)(z,{}),Array.from({length:24},(e,t)=>(0,r.jsx)(j,{children:w.has(t)?String(t).padStart(2,"0"):""},t))]}),s.map((o,s)=>(0,r.jsxs)(T,{children:[(0,r.jsx)(F,{children:g[s]}),o.map((o,l)=>{let d=null!==i&&i.day===s&&i.hour===l;return(0,r.jsx)(S,{type:"button",bg:0===c?u(0):u(o/c),selected:d,"aria-pressed":d,onClick:()=>n(e=>e&&e.day===s&&e.hour===l?null:{day:s,hour:l}),title:(0,h.Cl)(e,s,l,t,a)},l)})]},s)),(0,r.jsxs)(D,{children:[(0,r.jsx)(z,{}),(0,r.jsx)(L,{children:l.map((e,t)=>(0,r.jsx)(R,{pct:0===p?0:e/p},t))})]}),(0,r.jsxs)(H,{children:[(0,r.jsx)("span",{children:"0"}),(0,r.jsxs)("span",{children:[Math.round(m).toLocaleString()," kcal"]})]})]}),i&&(0,r.jsxs)(C,{role:"status","aria-live":"polite",children:[(0,r.jsx)("span",{children:(0,h.Cl)(e,i.day,i.hour,t,a)}),(0,r.jsx)(A,{type:"button",onClick:()=>n(null),"aria-label":t("forma.month.summary.close"),children:"\xd7"})]})]})}var P=a(63236);let B="#7fb77e",W="#1d2230";function E(){let e=new Date;return{year:e.getFullYear(),month:e.getMonth()}}function N(e,t){let a=new Date(e.year,e.month+t,1);return{year:a.getFullYear(),month:a.getMonth()}}function O(e,t){let a=String(e.month+1).padStart(2,"0"),r=String(t).padStart(2,"0");return`${e.year}-${a}-${r}`}function Y(e){return[parseInt(e.slice(1,3),16),parseInt(e.slice(3,5),16),parseInt(e.slice(5,7),16)]}let K=Y(W),G=Y(B),V=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,q=n().section`
  display: flex;
...
`,X=n().button`
  ...
  cursor: pointer;
  transition: border-color 0.14s ease, color 0.14s ease;
  &:hover { border-color: ${B}; color: ${l.w4.colors.mainText}; }
`,Z=n().div`
  display: grid;
...
`,ed=n().button`
  ...
  background: ${({bg:e})=>e};
  border: 1px solid
    ${({today:e,selected:t})=>t?l.w4.colors.accent:e?B:"transparent"};
  outline: ${({selected:e})=>e?`2px solid ${l.w4.colors.accent}`:"none"};
...
`,eb=n().div`
  ...
  background: ${({over:e})=>e?B:l.w4.colors.mainTextMuted};
...
`,e$=n().div`
  ...
  font-family: ${l.w4.typography.fontFamilyMono};
  color: ${l.w4.colors.mainTextMuted};
`;function ev({data:e,t,locale:a}){let i,n,s,l,d,p,h,[m,g]=(0,o.useState)(()=>E()),[f,x]=(0,o.useState)(null),u=(0,o.useCallback)(()=>g(e=>N(e,-1)),[]),w=(0,o.useCallback)(()=>g(e=>N(e,1)),[]),y=(0,o.useCallback)(()=>g(E()),[]),b=(0,o.useMemo)(()=>{let e=E();return m.year===e.year&&m.month===e.month},[m]),{fastHours:$,proteinByDayMap:v,weightByDayMap:k,walkByDayMap:M,checkInDays:j}=(0,o.useMemo)(()=>{let t=function(e,t){let a={};for(let r of e.sessions){if(void 0===r.endedAt)continue;let e=r.startedAt,o=r.endedAt;for(;e<o;){let r=new Date(e);if(r.getFullYear()===t.year&&r.getMonth()===t.month){let i=new Date(r.getFullYear(),r.getMonth(),r.getDate()).getTime()+864e5,n=Math.min(o,i)-e,s=O(t,r.getDate());a[s]=(a[s]??0)+n/36e5,e=i}else e=new Date(r.getFullYear(),r.getMonth(),r.getDate()).getTime()+864e5}}return a}(e,m),a=`${m.year}-${String(m.month+1).padStart(2,"0")}-`,r={};for(let t of e.meals)t.date.startsWith(a)&&(r[t.date]=(r[t.date]??0)+(t.proteinG??0));let o={};for(let t of e.weights)t.date.startsWith(a)&&(o[t.date]=t.kg);let i={};for(let t of e.walks)t.date.startsWith(a)&&(i[t.date]=(i[t.date]??0)+t.minutes);return{fastHours:t,proteinByDayMap:r,weightByDayMap:o,walkByDayMap:i,checkInDays:new Set(e.checkIns.filter(e=>e.date.startsWith(a)).map(e=>e.date))}},[e,m]),z=new Date(m.year,m.month+1,0).getDate(),T=new Date().toISOString().slice(0,10),F=(0,o.useMemo)(()=>Object.values($).reduce((e,t)=>e+t,0),[$]),S=e.goal.proteinG??110,C=Object.values(v),A=C.length?C.reduce((e,t)=>e+t,0)/C.length:0,D=(0,o.useMemo)(()=>{let t=Object.keys(k).sort(),a=String(m.month+1).padStart(2,"0"),r=`${m.year}-${a}-01`,o=e.weights.filter(e=>e.date<r).sort((e,t)=>e.date.localeCompare(t.date)),i=o[o.length-1]?.kg;if(0===t.length&&void 0===i)return{kind:"none"};if(0===t.length)return{kind:"absolute",value:i};let n=k[t[t.length-1]];if(void 0===n)return{kind:"none"};if(void 0!==i)return{kind:"delta",value:n-i};if(t.length>=2){let e=k[t[0]];if(void 0!==e)return{kind:"delta",value:n-e}}return{kind:"absolute",value:n}},[k,e.weights,m]),L=(0,o.useMemo)(()=>Object.values(M).reduce((e,t)=>e+t,0),[M]),R=(new Date(m.year,m.month,1).getDay()+6)%7,H=[];for(let e=0;e<R;e++)H.push({key:`lead-${e}`,day:null,iso:null});for(let e=1;e<=z;e++){let t=O(m,e);H.push({key:t,day:e,iso:t})}for(;H.length%7!=0;)H.push({key:`tail-${H.length}`,day:null,iso:null});let I=Math.max(18,...Object.values($)),Y=[];for(let e=1;e<=z;e++)Y.push(v[O(m,e)]??0);for(;Y.length<31;)Y.push(0);let V=[];for(let e=1;e<=z;e++){let t=k[O(m,e)];void 0!==t&&V.push(t)}return(0,r.jsxs)(q,{children:[(0,r.jsxs)(U,{children:[(0,r.jsx)(_,{children:new Date(m.year,m.month,1).toLocaleDateString("pt"===a?"pt-PT":"en-US",{month:"long",year:"numeric"})}),(0,r.jsxs)(J,{children:[(0,r.jsx)(Q,{onClick:u,"aria-label":t("forma.month.prev"),children:(0,r.jsx)(P.In,{name:"chevron-left",size:16})}),(0,r.jsx)(X,{onClick:y,disabled:b,"aria-label":t("forma.month.today"),children:t("forma.month.today")}),(0,r.jsx)(Q,{onClick:w,disabled:b,"aria-label":t("forma.month.next"),children:(0,r.jsx)(P.In,{name:"chevron-right",size:16})})]})]}),(0,r.jsxs)(Z,{children:[(0,r.jsxs)(ee,{children:[(0,r.jsx)(et,{children:t("forma.month.kpi.fastHours")}),(0,r.jsxs)(ea,{children:[F.toFixed(0),(0,r.jsx)(er,{children:"h"})]})]}),(0,r.jsxs)(ee,{children:[(0,r.jsx)(et,{children:t("forma.month.kpi.avgProtein")}),(0,r.jsxs)(ea,{children:[A.toFixed(0),(0,r.jsxs)(er,{children:["g / ",S,"g"]})]})]}),(0,r.jsxs)(ee,{children:[(0,r.jsx)(et,{children:t("delta"===D.kind?"forma.month.kpi.weightDelta":"forma.month.kpi.weight")}),(0,r.jsxs)(ea,{children:["none"===D.kind?"—":"delta"===D.kind?`${D.value>0?"+":""}${D.value.toFixed(1)}`:D.value.toFixed(1),(0,r.jsx)(er,{children:"kg"})]})]}),(0,r.jsxs)(ee,{children:[(0,r.jsx)(et,{children:t("forma.month.kpi.walks")}),(0,r.jsxs)(ea,{children:[L,(0,r.jsx)(er,{children:"min"})]})]})]}),(0,r.jsxs)(eo,{children:[(0,r.jsxs)(ei,{children:["◉ ",t("forma.month.calendar.title")]}),(0,r.jsxs)(es,{children:[("pt"===a?["S","T","Q","Q","S","S","D"]:["M","T","W","T","F","S","S"]).map((e,t)=>(0,r.jsx)(el,{children:e},`h-${t}`)),H.map(e=>{if(null===e.day||null===e.iso)return(0,r.jsx)(ec,{},e.key);let t=$[e.iso]??0,a=Math.min(1,t/I),o=void 0!==k[e.iso],i=j.has(e.iso),n=(M[e.iso]??0)>0,s=e.iso;return(0,r.jsxs)(ed,{type:"button",bg:function(e){if(e<=0)return W;let t=Math.round(K[0]+(G[0]-K[0])*e),a=Math.round(K[1]+(G[1]-K[1])*e),r=Math.round(K[2]+(G[2]-K[2])*e);return`rgb(${t},${a},${r})`}(a),today:s===T,selected:s===f,onClick:()=>x(e=>e===s?null:s),"aria-pressed":s===f,"aria-label":`${s} \xb7 ${t.toFixed(1)}h fast`,title:`${s} \xb7 ${t.toFixed(1)}h fast`,children:[e.day,t>0&&(0,r.jsx)(ex,{"aria-hidden":"true",children:t>=10?`${Math.round(t)}h`:`${t.toFixed(1)}h`}),(0,r.jsxs)(eu,{children:[o&&(0,r.jsx)(ew,{color:"#58a6ff"}),i&&(0,r.jsx)(ew,{color:"#a371f7"}),n&&(0,r.jsx)(ew,{color:"#d29922"})]})]},e.key)})]}),f&&(i=$[f]??0,n=v[f]??0,s=k[f],l=M[f]??0,d=e.checkIns.find(e=>e.date===f),p=i>0||n>0||void 0!==s||l>0||void 0!==d,h=new Date(f+"T00:00:00").toLocaleDateString("pt"===a?"pt-PT":"en-US",{weekday:"short",month:"short",day:"numeric"}),(0,r.jsxs)(ep,{role:"status","aria-live":"polite",children:[(0,r.jsx)(eh,{children:h}),p?(0,r.jsxs)(r.Fragment,{children:[i>0&&(0,r.jsxs)(em,{children:[(0,r.jsx)("span",{children:i>=10?`${Math.round(i)}h`:`${i.toFixed(1)}h`}),(0,r.jsx)("em",{children:t("forma.month.summary.fast")})]}),n>0&&(0,r.jsxs)(em,{children:[(0,r.jsxs)("span",{children:[Math.round(n),"g"]}),(0,r.jsx)("em",{children:t("forma.month.summary.protein")})]}),void 0!==s&&(0,r.jsxs)(em,{children:[(0,r.jsxs)("span",{children:[s.toFixed(1),"kg"]}),(0,r.jsx)("em",{children:t("forma.month.summary.weight")})]}),l>0&&(0,r.jsxs)(em,{children:[(0,r.jsxs)("span",{children:[l,"min"]}),(0,r.jsx)("em",{children:t("forma.month.summary.walks")})]}),void 0!==d&&(0,r.jsxs)(em,{children:[(0,r.jsx)("span",{"aria-hidden":"true",children:"●"}),(0,r.jsx)("em",{children:t("forma.month.summary.checkIn")})]})]}):(0,r.jsx)(eg,{children:t("forma.month.summary.empty")}),(0,r.jsx)(ef,{type:"button",onClick:()=>x(null),"aria-label":t("forma.month.summary.close"),children:"\xd7"})]}))]}),(0,r.jsxs)(en,{children:[(0,r.jsxs)(eo,{children:[(0,r.jsxs)(ei,{children:["◉ ",t("forma.month.protein.title")]}),0===C.length?(0,r.jsx)(c.YG,{mode:"empty",label:t("forma.analytics.empty")}):(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(ey,{children:Y.slice(0,z).map((e,t)=>(0,r.jsx)(eb,{h:Math.min(100,e/(1.2*S)*100),over:e>=S,title:`${O(m,t+1)} \xb7 ${e.toFixed(0)}g`},t))}),(0,r.jsxs)(e$,{children:[(0,r.jsx)("span",{children:"1"}),(0,r.jsx)("span",{children:Math.ceil(z/2)}),(0,r.jsx)("span",{children:z})]})]})]}),(0,r.jsxs)(eo,{children:[(0,r.jsxs)(ei,{children:["◉ ",t("forma.month.weight.title")]}),V.length<2?(0,r.jsx)(c.YG,{mode:"empty",label:t("forma.analytics.empty")}):(0,r.jsx)(c.OW,{points:V,accent:B,width:260,height:100,fluid:!0})]})]})]})}let ek="#7fb77e",eM="#58a6ff",ej="#d29922",ez="#7fb77e",eT=["Mo","Tu","We","Th","Fr","Sa","Su"],eF=["Se","Te","Qa","Qi","Sx","S\xe1","Do"],eS=new Set([0,4,8,12,16,20]);function eC(e){return[parseInt(e.slice(1,3),16),parseInt(e.slice(3,5),16),parseInt(e.slice(5,7),16)]}let eA=eC("#1d2230"),eD=eC(ek);function eL(e){let t=Math.round(eA[0]+(eD[0]-eA[0])*e),a=Math.round(eA[1]+(eD[1]-eA[1])*e),r=Math.round(eA[2]+(eD[2]-eA[2])*e);return`rgb(${t},${a},${r})`}let eR=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,eH=n().div`
  background: ${l.w4.colors.surface};
  border: 1px solid ${l.w4.colors.border};
  border-left: 2px solid ${ek};
  border-radius: ${l.w4.borderRadius.lg};
  padding: ${l.w4.spacing.md};
  display: flex;
  flex-direction: column;
...
`,eN=n().span`
  ...
  font-family: ${l.w4.typography.fontFamilyMono};
  font-variant-numeric: tabular-nums;
  color: ${({positive:e})=>e?l.w4.colors.danger:ek};
  background: ${({positive:e})=>e?`${l.w4.colors.danger}18`:`${ek}18`};
  border-radius: ${l.w4.borderRadius.sm};
  padding: 2px 6px;
`,eO=n().div`
  overflow-x: auto;
...
`,eX=n().div`
  ...
  background: ${({color:e})=>e};
  flex-shrink: 0;
`,eZ={positive:"#7fb77e",warn:"#facc15",info:l.w4.colors.mainTextMuted},e0=n().div`
  display: flex;
  flex-direction: column;
  gap: ${l.w4.spacing.sm};
`,e1=n().div`
...
`,e2=n().span`
  font-size: 13px;
  color: ${l.w4.colors.mainTextMuted};
`;function e5({data:e,t,locale:a}){let i=new Date().toISOString().slice(0,10),[n,s]=(0,o.useState)(null),[l,m]=(0,o.useState)(null),g=(0,o.useMemo)(()=>(function(e){let t={};for(let a of e){if(!a.endedAt)continue;let e=a.startedAt,r=a.endedAt,o=e;for(;o<r;){let e=new Date(o),a=new Date(e.getFullYear(),e.getMonth(),e.getDate(),0,0,0,0).getTime()+864e5,i=Math.min(r,a)-o,n=e.toISOString().slice(0,10);t[n]=(t[n]??0)+i/36e5,o=a}}let a=[];for(let e=89;e>=0;e--){let r=t[function(e){let t=new Date;return t.setDate(t.getDate()-e),t.toISOString().slice(0,10)}(e)]??0,o=0;r>=18?o=4:r>=14?o=3:r>=8?o=2:r>0&&(o=1),a.push(o)}return a})(e.sessions),[e.sessions]),f=(0,o.useMemo)(()=>(0,d.weightTrend)(e.weights,60),[e.weights]),x=(0,o.useMemo)(()=>[...e.weights].sort((e,t)=>t.date.localeCompare(e.date))[0]??null,[e.weights]),u=(0,o.useMemo)(()=>(0,d.proteinByDay)(e.meals,i),[e.meals,i]),w=(0,o.useMemo)(()=>e.goal.proteinG??110,[e.goal.proteinG]),y=(0,o.useMemo)(()=>(function(e){let t=[],a=new Date,r=new Date(a),o=(a.getDay()+6)%7;r.setDate(a.getDate()-o),r.setHours(0,0,0,0);for(let a=5;a>=0;a--){let o=new Date(r);o.setDate(r.getDate()-7*a);let i=new Date(o);i.setDate(o.getDate()+7);let n=o.toISOString().slice(0,10),s=i.toISOString().slice(0,10),l=e.filter(e=>e.date>=n&&e.date<s),d=l.filter(e=>"lunch"===e.slot).reduce((e,t)=>e+(t.proteinG??0),0),c=l.filter(e=>"snack"===e.slot).reduce((e,t)=>e+(t.proteinG??0),0),p=l.filter(e=>"dinner"===e.slot).reduce((e,t)=>e+(t.proteinG??0),0),h=`${String(o.getDate()).padStart(2,"0")}/${String(o.getMonth()+1).padStart(2,"0")}`;t.push({label:h,segments:[{id:"lunch",value:d,color:eM},{id:"snack",value:c,color:ej},{id:"dinner",value:p,color:ez}]})}return t})(e.meals),[e.meals]),b=(0,o.useMemo)(()=>(0,d.dayHourFastMatrix)(e.sessions),[e.sessions]),$=(0,o.useMemo)(()=>{let e=0;for(let t of b)for(let a of t)a>e&&(e=a);return e},[b]),v=(0,o.useMemo)(()=>(0,d.generateFormaInsights)(e),[e]),k="pt"===a?eF:eT,M=e.weights.length>=2,j=e.meals.length>0,z=e.sessions.some(e=>void 0!==e.endedAt),T=[{id:"insights",defaultSize:"lg",render:()=>(0,r.jsxs)(eH,{children:[(0,r.jsxs)(eI,{children:["◉ ",t("forma.insights.title")]}),0===v.length?(0,r.jsx)(c.YG,{mode:"empty",label:t("forma.insights.empty")}):(0,r.jsx)(e0,{children:v.map(e=>{let a;return"string"==typeof(a={...e.vars??{}}).dayKey&&(a.day=t(a.dayKey)),(0,r.jsxs)(e1,{accent:eZ[e.severity],children:[(0,r.jsx)(e4,{children:t(e.titleKey)}),(0,r.jsx)(e2,{children:t(e.bodyKey,a)})]},e.id)})})]})},{id:"fast-heatmap",defaultSize:"lg",render:()=>(0,r.jsxs)(eH,{children:[(0,r.jsxs)(eI,{children:["◉ ",t("forma.analytics.heatmap.title")]}),z?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(c.RT,{data:g,cellSize:11,gap:2,locale:a,selectedIndex:n??void 0,onCellClick:e=>s(t=>t===e?null:e),tooltip:r=>(0,h.Af)(e,(0,h.EQ)(r,g.length),t,a)}),(0,r.jsxs)(eJ,{children:[(0,r.jsxs)(eQ,{children:[(0,r.jsx)(eX,{color:eL(0)}),(0,r.jsx)("span",{children:t("forma.analytics.heatmap.none")})]}),(0,r.jsxs)(eQ,{children:[(0,r.jsx)(eX,{color:eL(.25)}),(0,r.jsx)("span",{children:"<8h"})]}),(0,r.jsxs)(eQ,{children:[(0,r.jsx)(eX,{color:eL(.5)}),(0,r.jsx)("span",{children:"8–14h"})]}),(0,r.jsxs)(eQ,{children:[(0,r.jsx)(eX,{color:eL(.75)}),(0,r.jsx)("span",{children:"14–18h"})]}),(0,r.jsxs)(eQ,{children:[(0,r.jsx)(eX,{color:eL(1)}),(0,r.jsx)("span",{children:"≥18h"})]})]}),null!==n&&(0,r.jsxs)(eU,{role:"status","aria-live":"polite",children:[(0,r.jsx)("span",{children:(0,h.Af)(e,(0,h.EQ)(n,g.length),t,a)}),(0,r.jsx)(e_,{type:"button",onClick:()=>s(null),"aria-label":t("forma.month.summary.close"),children:"\xd7"})]})]}):(0,r.jsx)(c.YG,{mode:"empty",label:t("forma.analytics.empty")})]})},{id:"weight-trend",defaultSize:"md",render:()=>(0,r.jsxs)(eH,{children:[(0,r.jsxs)(eI,{children:["◉ ",t("forma.analytics.weight.title")]}),M?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(eE,{children:[(0,r.jsx)(eP,{children:x?x.kg.toFixed(1):"—"}),(0,r.jsx)(eW,{children:"kg"}),0!==f.delta&&(0,r.jsxs)(eN,{positive:f.delta>0,children:[f.delta>0?"+":"",f.delta.toFixed(1)," kg"]})]}),void 0!==e.goal.weightKg&&(0,r.jsxs)(eE,{children:[(0,r.jsx)(eB,{children:e.goal.weightKg.toFixed(1)}),(0,r.jsxs)(eW,{children:["kg ",t("forma.weight.target")]})]}),(0,r.jsx)(eW,{children:t("forma.analytics.weight.delta")}),(0,r.jsx)(c.OW,{points:f.ema.length>=2?f.ema:e.weights.map(e=>e.kg),accent:ek,width:260,height:60,fluid:!0})]}):(0,r.jsx)(c.YG,{mode:"empty",label:t("forma.analytics.empty")})]})},{id:"protein-burn",defaultSize:"md",render:()=>(0,r.jsxs)(eH,{children:[(0,r.jsxs)(eI,{children:["◉ ",t("forma.analytics.protein.title")]}),(0,r.jsxs)(eE,{children:[(0,r.jsx)(eP,{children:u.toFixed(0)}),(0,r.jsxs)(eW,{children:["/ ",w,"g ",t("forma.analytics.protein.target")]})]}),j?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(c.kl,{spent:w-u,budget:w,height:60}),(0,r.jsx)(eW,{children:u>=w?t("forma.analytics.protein.achieved"):`${(w-u).toFixed(0)}g ${t("forma.analytics.protein.remaining")}`})]}):(0,r.jsx)(c.YG,{mode:"empty",label:t("forma.analytics.empty")})]})},{id:"weekly-protein",defaultSize:"lg",render:()=>(0,r.jsxs)(eH,{children:[(0,r.jsxs)(eI,{children:["◉ ",t("forma.analytics.weekly.title")]}),j?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(c.ik,{data:y,budget:7*w,height:160}),(0,r.jsxs)(eJ,{children:[(0,r.jsxs)(eQ,{children:[(0,r.jsx)(eX,{color:eM}),(0,r.jsx)("span",{children:t("forma.meal.lunch")})]}),(0,r.jsxs)(eQ,{children:[(0,r.jsx)(eX,{color:ej}),(0,r.jsx)("span",{children:t("forma.meal.snack")})]}),(0,r.jsxs)(eQ,{children:[(0,r.jsx)(eX,{color:ez}),(0,r.jsx)("span",{children:t("forma.meal.dinner")})]})]})]}):(0,r.jsx)(c.YG,{mode:"empty",label:t("forma.analytics.empty")})]})},{id:"meal-heatmap",defaultSize:"lg",render:()=>(0,r.jsx)(I,{data:e,t:t,locale:a})},{id:"fast-times",defaultSize:"lg",render:()=>(0,r.jsxs)(eH,{children:[(0,r.jsxs)(eI,{children:["◉ ",t("forma.analytics.fastTimes.title")]}),z?(0,r.jsxs)(eO,{children:[(0,r.jsxs)(eY,{children:[(0,r.jsx)("div",{}),Array.from({length:24},(e,t)=>(0,r.jsx)(eK,{children:eS.has(t)?String(t).padStart(2,"0"):""},t))]}),b.map((o,i)=>(0,r.jsxs)(eG,{children:[(0,r.jsx)(eV,{children:k[i]}),o.map((o,n)=>{let s=null!==l&&l.day===i&&l.hour===n;return(0,r.jsx)(eq,{type:"button",bg:0===$?eL(0):eL(o/$),selected:s,"aria-pressed":s,onClick:()=>m(e=>e&&e.day===i&&e.hour===n?null:{day:i,hour:n}),title:(0,h.Cl)(e,i,n,t,a)},n)})]},i))]}):(0,r.jsx)(c.YG,{mode:"empty",label:t("forma.analytics.empty")}),l&&(0,r.jsxs)(eU,{role:"status","aria-live":"polite",children:[(0,r.jsx)("span",{children:(0,h.Cl)(e,l.day,l.hour,t,a)}),(0,r.jsx)(e_,{type:"button",onClick:()=>m(null),"aria-label":t("forma.month.summary.close"),children:"\xd7"})]})]})}];return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(ev,{data:e,t:t,locale:a}),(0,r.jsx)(p.C,{t:t,cards:T,storageKey:"forma:layout:analytics"})]})}},69568(e,t,a){a.d(t,{c:()=>F});var r=a(65723),o=a(37991),i=a(36859),n=a.n(i),s=a(72799),l=a(6063),d=a(63236),c=a(63019);let p="#7fb77e",h=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,m=n().section`
  display: flex;
...
`,T=n().p`
  ...
  margin: 0;
  text-align: center;
`;function F({t:e,locale:t}){let{comments:a,addComment:i,updateAnswer:n,removeComment:s}=(0,c.useAskComments)(),[l,h]=(0,o.useState)(""),[S,C]=(0,o.useState)(null),[A,D]=(0,o.useState)(null),L=(0,o.useRef)(null);(0,o.useEffect)(()=>{(0,c.resolveGroqKey)().then(D)},[]);let R=(0,o.useCallback)(async()=>{let e=l.trim();if(!e||!A||S)return;h("");let a=await i(e);if(!a)return;C(a),L.current=new AbortController;let r=`You are a fasting and diet coach assistant for the Forma app.
Answer questions about intermittent fasting, nutrition, weight loss, and wellness.
Be concise, practical, and supportive. Respond in ${"pt"===t?"Portuguese (PT)":"English"}.`;try{let o="";await (0,c.askGroqStream)(e,{key:A,locale:t,system:r,maxTokens:512,signal:L.current.signal,onChunk:e=>{o=e,n(a,e)}}),await n(a,o)}catch{}finally{C(null),L.current=null}},[l,A,S,i,n,t]),H=[...a].reverse();return(0,r.jsxs)(m,{children:[(0,r.jsx)(g,{children:e("forma.ask.title")}),A?(0,r.jsxs)(f,{children:[(0,r.jsx)(x,{value:l,onChange:e=>h(e.target.value),onKeyDown:e=>{"Enter"!==e.key||e.shiftKey||(e.preventDefault(),R())},placeholder:e("forma.ask.chat.placeholder"),disabled:!!S,rows:1}),(0,r.jsx)(d.$n,{variant:"primary",onClick:()=>{R()},disabled:!l.trim()||!!S,children:(0,r.jsx)(d.In,{name:"send",size:14})})]}):(0,r.jsx)(T,{children:e("forma.ask.noKey")}),0===H.length?(0,r.jsx)(z,{children:e("forma.ask.chat.empty")}):(0,r.jsx)(u,{children:H.map(e=>(0,r.jsxs)(w,{children:[(0,r.jsxs)(y,{children:[(0,r.jsx)(b,{children:(0,r.jsx)(d.In,{name:"user",size:12,color:p})}),(0,r.jsx)($,{children:e.question})]}),e.id!==S||e.answer?e.answer?(0,r.jsx)(v,{children:(0,r.jsx)(d.mQ,{children:e.answer})}):null:(0,r.jsx)(v,{children:(0,r.jsxs)(k,{children:[(0,r.jsx)(M,{delay:0}),(0,r.jsx)(M,{delay:200}),(0,r.jsx)(M,{delay:400})]})}),(0,r.jsx)(j,{children:(0,r.jsx)(d.$n,{variant:"ghost",onClick:()=>{s(e.id)},disabled:e.id===S,children:(0,r.jsx)(d.In,{name:"trash",size:13})})})]},e.id))})]})}},37103(e,t,a){a.d(t,{j:()=>u});var r=a(65723),o=a(37991),i=a(36859),n=a.n(i),s=a(6063),l=a(63236),d=a(63019);let c=n().section`
...
`,x="forma:ask:last";function u({data:e,t,locale:a}){let i,n,w,[y,b]=(0,o.useState)(null),[$,v]=(0,o.useState)(""),[k,M]=(0,o.useState)(null),[j,z]=(0,o.useState)(!1),[T,F]=(0,o.useState)(null);(0,o.useEffect)(()=>{(0,d.resolveGroqKey)().then(e=>b(!!e))},[]),(0,o.useEffect)(()=>{(0,s.qj)(x).then(e=>{if(e)try{let t=JSON.parse(e);t.text&&t.ts&&(v(t.text),M(t.ts))}catch{}})},[]);let S=(0,o.useCallback)(async()=>{z(!0),F(null),v("");try{let r,o,i,n,l,c,p,h,m,g,f=await (0,d.resolveGroqKey)();if(!f){F(t("forma.ask.noKey")),z(!1);return}let u=(r=new Date().toISOString().slice(0,10),o=(0,d.proteinByDay)(e.meals,r),i=e.meals.filter(e=>e.date===r).reduce((e,t)=>e+(t.kcal??0),0),n=e.walks.filter(e=>e.date===r).reduce((e,t)=>e+t.minutes,0),l=(function(){let e=[],t=new Date;for(let a=6;a>=0;a-=1){let r=new Date(t);r.setDate(t.getDate()-a),e.push(r.toISOString().slice(0,10))}return e})().map(t=>({date:t,protein:(0,d.proteinByDay)(e.meals,t),kcal:e.meals.filter(e=>e.date===t).reduce((e,t)=>e+(t.kcal??0),0),walk:e.walks.filter(e=>e.date===t).reduce((e,t)=>e+t.minutes,0)})),(c=new Date).setDate(c.getDate()-6),p=(0,d.weeklyAdherence)(e.sessions,c,e.goal.weeklyFasts),h=(0,d.streakDays)(e.sessions,e.goal.targetHours),m=(0,d.avgFastDuration)(e.sessions,30),g=e.meals.filter(e=>e.date>=l[0].date).slice(-15).map(e=>`${e.date} ${e.slot} \xb7 ${e.proteinG??0}g protein \xb7 ${e.kcal??0}kcal \xb7 ${e.notes||""}`).join("\n"),`You are a concise nutrition + habit coach. Reply in ${"pt"===a?"Portuguese (PT-PT)":"English"}, max 5 short bullet points.
...
- avg fast (last 30d): ${m.toFixed(1)}h

RECENT MEALS:
${g||"(none yet)"}

Give 3–5 bullets: what's going well, what to fix, one specific next-meal suggestion.`),w=await (0,d.askGroqStream)(u,{key:f,locale:a,maxTokens:400,onChunk:e=>v(e)}),y=Date.now();M(y),(0,s.pJ)(x,JSON.stringify({text:w,ts:y}))}catch(e){F(e instanceof Error?e.message:t("forma.ask.error"))}finally{z(!1)}},[e,a,t]);if(null===y||!1===y)return null;let C=!!$;return(0,r.jsxs)(c,{children:[(0,r.jsxs)(p,{children:[(0,r.jsxs)(h,{children:["✦ ",t("forma.ask.title")]}),(0,r.jsx)(l.$n,{variant:"accent",icon:(0,r.jsx)(l.In,{name:C?"refresh":"message",size:14}),onClick:()=>void S(),disabled:j,children:j?t("forma.ask.loading"):C?t("forma.ask.regenerate"):t("forma.ask.button")})]}),T&&(0,r.jsx)(g,{children:T}),($||j)&&(0,r.jsx)(m,{children:$?(0,r.jsx)(l.mQ,{children:$}):"…"}),null!==k&&!j&&C&&(0,r.jsxs)(f,{children:[t("forma.ask.generatedAt")," \xb7 ",(i=new Date(k),n=e=>String(e).padStart(2,"0"),w=i.toLocaleDateString("pt"===a?"pt-PT":"en-GB",{day:"2-digit",month:"short"}),`${w}, ${n(i.getHours())}:${n(i.getMinutes())}`)]}),!$&&!j&&!T&&(0,r.jsx)(m,{style:{color:s.w4.colors.mainTextMuted,fontStyle:"italic"},children:t("forma.ask.hint")})]})}},82167(e,t,a){a.d(t,{X:()=>x});var r=a(65723),o=a(37991),i=a(36859),n=a.n(i),s=a(72799),l=a(6063);let d=(0,s.keyframes)`
...
`,f=n().div`
  ...
  min-height: 0;
  overflow-y: auto;
`;function x({open:e,onClose:t,children:a,maxWidth:i=480,ariaLabel:n}){let s=(0,o.useRef)(null);(0,o.useEffect)(()=>{if(!e)return;let a=e=>{"Escape"===e.key&&t()};return window.addEventListener("keydown",a),()=>window.removeEventListener("keydown",a)},[e,t]),(0,o.useEffect)(()=>{if(!e||!s.current)return;let t=s.current.querySelector('button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])');t?.focus()},[e]);let l=(0,o.useRef)(null),d=(0,o.useCallback)(e=>{l.current={y:e.touches[0].clientY}},[]),c=(0,o.useCallback)(e=>{if(!l.current||!s.current)return;let a=e.changedTouches[0].clientY-l.current.y;l.current=null,a>=0||-a/s.current.getBoundingClientRect().height>.3&&t()},[t]),u=(0,o.useRef)(null),w=(0,o.useCallback)(e=>{u.current={y:e.clientY}},[]),y=(0,o.useCallback)(e=>{if(!u.current||!s.current)return;let a=e.clientY-u.current.y;u.current=null,a>=0||-a/s.current.getBoundingClientRect().height>.3&&t()},[t]);return e?(0,r.jsx)(p,{onClick:t,role:"dialog","aria-modal":"true","aria-label":n,children:(0,r.jsxs)(h,{ref:s,maxWidth:i,onClick:e=>e.stopPropagation(),children:[(0,r.jsx)(m,{onTouchStart:d,onTouchEnd:c,onPointerDown:w,onPointerUp:y,"aria-hidden":"true",children:(0,r.jsx)(g,{})}),(0,r.jsx)(f,{children:a})]})}):null}},33499(e,t,a){a.d(t,{N:()=>k});var r=a(65723),o=a(37991),i=a(36859),n=a.n(i),s=a(6063),l=a(63236),d=a(63019),c=a(82167);let p="#7fb77e",h=n().div`
  display: flex;
  flex-direction: column;
  gap: ${s.w4.spacing.lg};
...
`,u=n().button`
  ...
  border: 1px solid ${({active:e})=>e?p:s.w4.colors.border};
  background: ${({active:e})=>e?`${p}22`:s.w4.colors.mainBg};
  color: ${({active:e})=>e?p:s.w4.colors.mainTextMuted};
  font-size: 13px;
...
`,y=n().button`
  ...
  height: 44px;
  border-radius: ${s.w4.borderRadius.md};
  border: 1px solid ${({active:e,danger:t})=>e?t?s.w4.colors.danger:p:s.w4.colors.border};
  background: ${({active:e,danger:t})=>e?t?`${s.w4.colors.danger}22`:`${p}22`:s.w4.colors.mainBg};
  color: ${({active:e,danger:t})=>e?t?s.w4.colors.danger:p:s.w4.colors.mainTextMuted};
  font-size: 13px;
  font-weight: ${({active:e})=>e?600:400};
  cursor: pointer;
  display: flex;
...
`,$=n().div`
  ...
  gap: ${s.w4.spacing.sm};
  justify-content: flex-end;
`,v=[1,2,3,4,5];function k({open:e,onClose:t,t:a}){let{checkIn:i,saveCheckIn:n}=(0,d.useCheckIn)(),[s,p]=(0,o.useState)(i?.hunger??3),[M,j]=(0,o.useState)(i?.energy??3),[z,T]=(0,o.useState)(i?.adherence??!0),[F,S]=(0,o.useState)(i?.note??""),[C,A]=(0,o.useState)(!1),D=(0,o.useCallback)(async()=>{A(!0);try{await n({hunger:s,energy:M,adherence:z,note:F.trim()||void 0}),t()}finally{A(!1)}},[n,s,M,z,F,t]);return(0,r.jsx)(c.X,{open:e,onClose:t,ariaLabel:a("forma.checkin.title"),children:(0,r.jsxs)(h,{children:[(0,r.jsx)(m,{children:a("forma.checkin.title")}),(0,r.jsxs)(g,{children:[(0,r.jsx)(f,{children:a("forma.checkin.hunger")}),(0,r.jsx)(x,{children:v.map(e=>(0,r.jsx)(u,{active:s===e,onClick:()=>p(e),"aria-pressed":s===e,children:e},e))})]}),(0,r.jsxs)(g,{children:[(0,r.jsx)(f,{children:a("forma.checkin.energy")}),(0,r.jsx)(x,{children:v.map(e=>(0,r.jsx)(u,{active:M===e,onClick:()=>j(e),"aria-pressed":M===e,children:e},e))})]}),(0,r.jsxs)(g,{children:[(0,r.jsx)(f,{children:a("forma.checkin.adherence")}),(0,r.jsxs)(w,{children:[(0,r.jsxs)(y,{active:z,onClick:()=>T(!0),"aria-pressed":z,children:[(0,r.jsx)(l.In,{name:"check",size:14}),a("forma.checkin.adherenceYes")]}),(0,r.jsxs)(y,{active:!z,danger:!0,onClick:()=>T(!1),"aria-pressed":!z,children:[(0,r.jsx)(l.In,{name:"close",size:14}),a("forma.checkin.adherenceNo")]})]})]}),(0,r.jsxs)(g,{children:[(0,r.jsx)(f,{children:a("forma.checkin.note")}),(0,r.jsx)(b,{value:F,onChange:e=>S(e.target.value),placeholder:a("forma.checkin.notePlaceholder"),rows:2})]}),(0,r.jsxs)($,{children:[(0,r.jsx)(l.$n,{variant:"ghost",onClick:t,disabled:C,children:a("forma.checkin.cancel")}),(0,r.jsx)(l.$n,{variant:"success",onClick:()=>{D()},disabled:C,children:a("forma.checkin.save")})]})]})})}},24470(e,t,a){a.d(t,{s:()=>v});var r=a(65723),o=a(37991),i=a(36859),n=a.n(i),s=a(72799),l=a(6063),d=a(63236),c=a(63019);let p="#7fb77e",h=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,m=n().section`
  background: ${l.w4.colors.surface};
...
`;function v({t:e}){var t;let{output:a,refresh:i}=(0,c.useCoach)(),[n,s]=(0,o.useState)(!1),h=(0,o.useCallback)(async()=>{s(!0);try{await i()}finally{s(!1)}},[i]),k=()=>{h()};if(!a)return(0,r.jsxs)(m,{accent:p,children:[(0,r.jsx)(g,{children:(0,r.jsx)(f,{children:e("forma.coach.title")})}),(0,r.jsxs)(y,{children:[(0,r.jsx)(d.In,{name:"message",size:24,color:l.w4.colors.mainTextMuted}),(0,r.jsx)(b,{children:e("forma.coach.empty")}),(0,r.jsx)(d.$n,{variant:"accent",onClick:k,disabled:n,children:e("forma.coach.generate")})]})]});let M=(t=a.messageKey,/lowAdherence|hunger/.test(t)?"#f87171":/stall|lowEnergy/.test(t)?"#facc15":p);return(0,r.jsxs)(m,{accent:M,children:[(0,r.jsx)(g,{children:(0,r.jsx)(f,{children:e("forma.coach.title")})}),(0,r.jsx)(x,{children:e(a.messageKey,a.vars)}),a.adjustments.length>0&&(0,r.jsx)(u,{children:a.adjustments.map((t,a)=>(0,r.jsx)(w,{accent:M,children:e(t.reasonKey)},a))}),(0,r.jsx)($,{children:(0,r.jsxs)(d.$n,{variant:"ghost",onClick:k,disabled:n,children:[(0,r.jsx)(d.In,{name:"rotate-cw",size:13}),e("forma.coach.refresh")]})})]})}},72552(e,t,a){a.d(t,{k:()=>j});var r=a(65723),o=a(37991),i=a(36859),n=a.n(i),s=a(6063),l=a(63236),d=a(63019);let c="#7fb77e",p=2*Math.PI*95,h=n().div`
  display: flex;
  flex-direction: column;
  align-items: center;
  gap: ${s.w4.spacing.md};
...
`,M=n().span`
  ...
  text-transform: uppercase;
  letter-spacing: 0.16em;
`;function j({data:e,t,onStart:a,onStop:i,onEditStart:n}){let z,T,F,S,C,[A,D]=(0,o.useState)(Date.now),L=e.sessions.some(e=>void 0===e.endedAt);(0,o.useEffect)(()=>{if(!L)return;let e=setInterval(()=>D(Date.now()),1e3);return()=>clearInterval(e)},[L]);let R=(0,d.currentFast)(e,A),H=R?.percent??0,I=null!==R,P=R?R.hoursElapsed:0,B=R?R.remainingMs:0,W=R?R.session.targetHours:e.goal.targetHours;return(0,r.jsxs)(h,{children:[(0,r.jsxs)(m,{children:[(0,r.jsxs)(g,{width:200,height:200,viewBox:"0 0 200 200","aria-hidden":"true",children:[(0,r.jsx)("circle",{cx:100,cy:100,r:95,fill:"none",stroke:s.w4.colors.border,strokeWidth:10}),(0,r.jsx)("circle",{cx:100,cy:100,r:95,fill:"none",stroke:c,strokeWidth:10,strokeLinecap:"round",strokeDasharray:p,strokeDashoffset:p*(1-H),style:{transition:"stroke-dashoffset 0.6s ease"}})]}),(0,r.jsx)(f,{children:I?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(x,{children:[P.toFixed(1),"h"]}),(0,r.jsx)(u,{children:t("forma.timer.elapsed")})]}):(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(x,{children:[W,"h"]}),(0,r.jsx)(u,{children:t("forma.hero.notFasting")})]})})]}),I&&R&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(b,{children:[(0,r.jsx)(w,{children:R.session.protocol}),n&&(0,r.jsx)($,{type:"button",onClick:()=>n(R.session),title:t("forma.timer.editStart"),children:t("forma.timer.startedAt",{time:(T=String((z=new Date(R.session.startedAt)).getHours()).padStart(2,"0"),F=String(z.getMinutes()).padStart(2,"0"),`${T}:${F}`)})})]}),(0,r.jsxs)(y,{children:[(0,r.jsxs)(v,{children:[(0,r.jsx)(k,{children:(C=Math.floor((S=Math.floor(B/6e4))/60),`${String(C).padStart(2,"0")}:${String(S%60).padStart(2,"0")}`)}),(0,r.jsx)(M,{children:t("forma.timer.remaining")})]}),(0,r.jsxs)(v,{children:[(0,r.jsxs)(k,{children:[Math.round(100*H),"%"]}),(0,r.jsx)(M,{children:t("forma.timer.complete")})]})]})]}),I&&R?(0,r.jsx)(l.$n,{variant:"danger",onClick:()=>i(R.session),children:t("forma.stop")}):(0,r.jsx)(l.$n,{variant:"success",onClick:a,children:t("forma.start")})]})}},4406(e,t,a){a.d(t,{C:()=>w});var r=a(65723),o=a(37991),i=a(36859),n=a.n(i),s=a(6063),l=a(63236);let d="#7fb77e",c=n().div`
  display: grid;
...
`;function f({size:e}){return(0,r.jsxs)("svg",{width:14,height:14,viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:[(0,r.jsx)("rect",{x:1.5,y:4.5,width:11,height:5,rx:1,stroke:"currentColor",strokeWidth:1,opacity:.4}),(0,r.jsx)("rect",{x:2,y:5,width:"sm"===e?4:"md"===e?7:11,height:4,rx:.5,fill:"currentColor"})]})}let x=n().div`
  display: flex;
  flex-wrap: wrap;
  gap: ${s.w4.spacing.xs};
...
`;function w({cards:e,t,storageKey:a="forma:layout"}){let[i,n]=(0,o.useState)(null);(0,o.useEffect)(()=>{let t=!1;return(async()=>{let r=await (0,s.PL)(a),o=null;if(r)try{o=JSON.parse(r)}catch{o=null}t||n(function(e,t){let a=new Set(t.map(e=>e.id)),r=new Set,o=[];if(e)for(let t of e)a.has(t.id)&&(o.push(t),r.add(t.id));for(let e of t)r.has(e.id)||o.push({id:e.id,size:e.defaultSize??"sm",hidden:!1});return o}(o,e))})(),()=>{t=!0}},[a,e.map(e=>e.id).join("|")]);let d=(0,o.useCallback)(e=>{n(e),(0,s.Is)(a,JSON.stringify(e))},[a]),y=(0,o.useCallback)((e,t)=>{if(!i)return;let a=i.filter(e=>!e.hidden),r=a.findIndex(t=>t.id===e);if(-1===r)return;let o=r+t;if(o<0||o>=a.length)return;let n=a[o],s=i.findIndex(t=>t.id===e),l=i.findIndex(e=>e.id===n.id),c=[...i];[c[s],c[l]]=[c[l],c[s]],d(c)},[i,d]),b=(0,o.useCallback)(e=>{i&&d(i.map(t=>{var a;return t.id===e?{...t,size:"sm"===(a=t.size)?"md":"md"===a?"lg":"sm"}:t}))},[i,d]),$=(0,o.useCallback)(e=>{i&&d(i.map(t=>t.id===e?{...t,hidden:!0}:t))},[i,d]),v=(0,o.useCallback)(e=>{i&&d(i.map(t=>t.id===e?{...t,hidden:!1}:t))},[i,d]),k=(0,o.useMemo)(()=>{let t=new Map;for(let a of e)t.set(a.id,a);return t},[e]);if(!i)return(0,r.jsx)(c,{});let M=i.filter(e=>!e.hidden),j=i.filter(e=>e.hidden);return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(c,{children:M.map((e,a)=>{let o=k.get(e.id);return o?(0,r.jsxs)(p,{size:e.size,children:[o.render(),(0,r.jsxs)(h,{className:"forma-grid-controls",children:[a>0&&(0,r.jsx)(m,{onClick:()=>y(e.id,-1),title:t("forma.grid.moveLeft"),"aria-label":t("forma.grid.moveLeft"),children:(0,r.jsx)(l.In,{name:"chevron-left",size:14})}),a<M.length-1&&(0,r.jsx)(m,{onClick:()=>y(e.id,1),title:t("forma.grid.moveRight"),"aria-label":t("forma.grid.moveRight"),children:(0,r.jsx)(l.In,{name:"chevron-right",size:14})}),(0,r.jsx)(m,{onClick:()=>b(e.id),title:t("forma.grid.resize",{size:e.size.toUpperCase()}),"aria-label":t("forma.grid.resize",{size:e.size.toUpperCase()}),children:(0,r.jsx)(f,{size:e.size})}),(0,r.jsx)(g,{onClick:()=>$(e.id),title:t("forma.grid.hide"),"aria-label":t("forma.grid.hide"),children:(0,r.jsx)(l.In,{name:"close",size:14})})]})]},e.id):null})}),j.length>0&&(0,r.jsxs)(x,{children:[(0,r.jsx)("span",{style:{fontSize:11,fontFamily:s.w4.typography.fontFamilyMono,color:s.w4.colors.mainTextMuted,textTransform:"uppercase",letterSpacing:"0.16em",alignSelf:"center",marginRight:8},children:t("forma.grid.hiddenLabel")}),j.map(e=>(0,r.jsxs)(u,{onClick:()=>v(e.id),children:["+ ",t(`forma.grid.card.${e.id}`)]},e.id))]})]})}},17102(e,t,a){a.d(t,{Y:()=>F});var r=a(65723),o=a(37991),i=a(36859),n=a.n(i),s=a(6063),l=a(63236),d=a(63019),c=a(82167);function p(){return new Date().toISOString().slice(0,10)}function h(e){let t=new Date(e),a=e=>String(e).padStart(2,"0");return`${t.getFullYear()}-${a(t.getMonth()+1)}-${a(t.getDate())}T${a(t.getHours())}:${a(t.getMinutes())}`}function m(){return h(Date.now())}function g(e){if(!e)return null;let t=new Date(e).getTime();return Number.isNaN(t)?null:t}let f="#7fb77e",x=n().div`
  padding: ${s.w4.spacing.md};
  display: flex;
  flex-direction: column;
  gap: ${s.w4.spacing.md};
...
`;function F({open:e,onClose:t,data:a,t:i,initialMode:n,editing:f,onStartFast:S,onStopFast:C,onLogPastFast:A,onEditFast:D,onLogMeal:L,onEditMeal:R,onLogWeight:H,onEditWeight:I,onLogWalk:P,onEditWalk:B,onLogWater:W,onEditWater:E}){let[N,O]=(0,o.useState)(n??null),[Y,K]=(0,o.useState)("16:8"),[G,V]=(0,o.useState)("16"),[q,U]=(0,o.useState)("16:8"),[_,J]=(0,o.useState)("16"),[Q,X]=(0,o.useState)(m),[Z,ee]=(0,o.useState)(""),[et,ea]=(0,o.useState)(null),[er,eo]=(0,o.useState)("dinner"),[ei,en]=(0,o.useState)(""),[es,el]=(0,o.useState)(""),[ed,ec]=(0,o.useState)(""),[ep,eh]=(0,o.useState)(p),[em,eg]=(0,o.useState)(""),[ef,ex]=(0,o.useState)(p),[eu,ew]=(0,o.useState)(""),[ey,eb]=(0,o.useState)(p),[e$,ev]=(0,o.useState)(""),[ek,eM]=(0,o.useState)(p);(0,o.useEffect)(()=>{if(e)if(ea(null),f?.kind==="fast"){let e=f.entry;O("pastFast"),U(e.protocol),J(String(e.targetHours)),X(h(e.startedAt)),ee(e.endedAt?h(e.endedAt):"")}else if(f?.kind==="meal"){let e=f.entry;O("meal"),eo(e.slot),en(String(e.proteinG??"")),el(String(e.kcal??"")),ec(e.notes??""),eh(e.date)}else f?.kind==="weight"?(O("weight"),eg(String(f.entry.kg)),ex(f.entry.date)):f?.kind==="walk"?(O("walk"),ew(String(f.entry.minutes)),eb(f.entry.date)):f?.kind==="water"?(O("water"),ev(String(f.entry.ml)),eM(f.entry.date)):n&&(O(n),"pastFast"===n?(U("16:8"),J("16"),X(m()),ee("")):"meal"===n?(eo("dinner"),en(""),el(""),ec(""),eh(p())):"weight"===n?(eg(""),ex(p())):"walk"===n?(ew(""),eb(p())):"water"===n&&(ev(""),eM(p())))},[e,f,n]);let ej=a.sessions.some(e=>void 0===e.endedAt),ez=f?.kind??("startFast"===n||"pastFast"===n?"fast":"meal"===n?"meal":"weight"===n?"weight":"walk"===n?"walk":"water"===n?"water":null),eT=null===ez||"fast"===ez,eF=null===ez||"meal"===ez,eS=null===ez||"weight"===ez,eC=null===ez||"walk"===ez,eA=null===ez||"water"===ez,eD=(0,o.useCallback)(()=>{O(null)},[]),eL=(0,o.useCallback)(()=>{eD(),t()},[eD,t]),eR=(0,o.useCallback)(()=>{let e=g(Q);if(null===e)return;let t=Z.trim(),a=t?g(t):null;if(t&&null===a)return;if(null!==a&&a<=e)return void ea(i("forma.sheet.fastInvalidRange"));let r=parseInt(_,10),o=isNaN(r)||r<1?16:r;f?.kind==="fast"&&D?D(f.entry.id,q,o,e,a??void 0):A&&A(q,o,e,a??void 0),eL()},[f,D,A,q,_,Q,Z,i,eL]),eH=(0,o.useCallback)(()=>{let e=parseInt(G,10);isNaN(e)||e<1||(S(Y,e),eL())},[Y,G,S,eL]),eI=(0,o.useMemo)(()=>(0,d.estimateNutrition)(ed),[ed]),eP=(0,o.useCallback)(()=>{let e=""===ei.trim()?eI.proteinG:parseFloat(ei)||0,t=""===es.trim()?eI.kcal:parseFloat(es)||0;f?.kind==="meal"&&R?R(f.entry.id,er,e,t,ed.trim(),ep):L(er,e,t,ed.trim(),ep),eL()},[f,R,er,ei,es,eI,ed,ep,L,eL]),eB=(0,o.useCallback)(()=>{let e=parseFloat(em.replace(",","."));isNaN(e)||e<=0||(f?.kind==="weight"&&I?I(ef,e):H(e,ef),eL())},[f,I,em,ef,H,eL]),eW=(0,o.useCallback)(()=>{let e=parseInt(eu,10);isNaN(e)||e<=0||(f?.kind==="walk"&&B?B(f.entry.id,e,ey):P(e,ey),eL())},[f,B,eu,ey,P,eL]),eE=(0,o.useCallback)(()=>{let e=parseInt(e$,10);isNaN(e)||e<=0||(f?.kind==="water"&&E?E(f.entry.id,e,ek):W(e,ek),eL())},[f,E,e$,ek,W,eL]);return(0,r.jsx)(c.X,{open:e,onClose:eL,maxWidth:520,ariaLabel:i("forma.sheet.ariaLabel"),children:(0,r.jsxs)(x,{children:[(0,r.jsx)(l.YZ,{children:f?.kind==="fast"?i("forma.sheet.titleEditFast"):f?.kind==="meal"?i("forma.sheet.titleEditMeal"):f?.kind==="weight"?i("forma.sheet.titleEditWeight"):f?.kind==="walk"?i("forma.sheet.titleEditWalk"):f?.kind==="water"?i("forma.sheet.titleEditWater"):"pastFast"===n?i("forma.sheet.titleAddFast"):"meal"===n?i("forma.sheet.titleAddMeal"):"weight"===n?i("forma.sheet.titleAddWeight"):"walk"===n?i("forma.sheet.titleAddWalk"):"water"===n?i("forma.sheet.titleAddWater"):i("forma.sheet.title")}),eT&&(0,r.jsx)(w,{children:(0,r.jsx)(l.YZ,{children:i("forma.sheet.fastSection")})}),eT&&("pastFast"===N?(0,r.jsxs)(u,{children:[(0,r.jsxs)(y,{children:[(0,r.jsx)(b,{htmlFor:"past-fast-protocol",children:i("forma.rail.title")}),(0,r.jsxs)(v,{id:"past-fast-protocol",value:q,onChange:e=>{let t=e.target.value;U(t),"custom"!==t&&J(t.split(":")[0])},children:[(0,r.jsx)("option",{value:"16:8",children:"16:8"}),(0,r.jsx)("option",{value:"18:6",children:"18:6"}),(0,r.jsx)("option",{value:"20:4",children:"20:4"}),(0,r.jsx)("option",{value:"custom",children:i("forma.protocol.custom")})]})]}),"custom"===q&&(0,r.jsxs)(y,{children:[(0,r.jsx)(b,{htmlFor:"past-fast-target",children:i("forma.sheet.fastTargetLabel")}),(0,r.jsx)($,{id:"past-fast-target",type:"number",value:_,min:1,max:72,onChange:e=>J(e.target.value)})]}),(0,r.jsxs)(y,{children:[(0,r.jsx)(b,{htmlFor:"past-fast-start",children:i("forma.sheet.fastStartLabel")}),(0,r.jsx)($,{id:"past-fast-start",type:"datetime-local",value:Q,max:m(),onChange:e=>{X(e.target.value),ea(null)}})]}),(0,r.jsxs)(y,{children:[(0,r.jsx)(b,{htmlFor:"past-fast-end",children:i("forma.sheet.fastEndLabel")}),(0,r.jsx)($,{id:"past-fast-end",type:"datetime-local",value:Z,max:m(),placeholder:i("forma.sheet.fastEndHint"),onChange:e=>{ee(e.target.value),ea(null)}})]}),et&&(0,r.jsx)("div",{style:{fontSize:11,fontFamily:s.w4.typography.fontFamilyMono,color:s.w4.colors.danger},children:et}),(0,r.jsxs)(T,{children:[(0,r.jsx)(l.$n,{variant:"primary",onClick:eR,children:f?.kind==="fast"?i("forma.sheet.saveEdit"):i("forma.sheet.save")}),(0,r.jsx)(l.$n,{variant:"ghost",onClick:eD,children:i("forma.sheet.cancel")})]})]}):ej?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(l.$n,{variant:"danger",onClick:()=>{C(),eL()},children:i("forma.stop")}),(0,r.jsxs)(M,{onClick:()=>O("pastFast"),children:[(0,r.jsx)(l.In,{name:"clock",size:16}),i("forma.sheet.logPastFast")]})]}):"startFast"===N?(0,r.jsxs)(u,{children:[(0,r.jsxs)(y,{children:[(0,r.jsx)(b,{htmlFor:"fast-protocol",children:i("forma.rail.title")}),(0,r.jsxs)(v,{id:"fast-protocol",value:Y,onChange:e=>{let t=e.target.value;K(t),"custom"!==t&&V(t.split(":")[0])},children:[(0,r.jsx)("option",{value:"16:8",children:"16:8"}),(0,r.jsx)("option",{value:"18:6",children:"18:6"}),(0,r.jsx)("option",{value:"20:4",children:"20:4"}),(0,r.jsx)("option",{value:"custom",children:i("forma.protocol.custom")})]})]}),"custom"===Y&&(0,r.jsxs)(y,{children:[(0,r.jsx)(b,{htmlFor:"fast-hours",children:i("forma.timer.target")}),(0,r.jsx)($,{id:"fast-hours",type:"number",value:G,min:1,max:72,onChange:e=>V(e.target.value)})]}),(0,r.jsxs)(T,{children:[(0,r.jsx)(l.$n,{variant:"success",onClick:eH,children:i("forma.start")}),(0,r.jsx)(l.$n,{variant:"ghost",onClick:eD,children:i("forma.sheet.cancel")})]})]}):(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(M,{onClick:()=>O("startFast"),children:[(0,r.jsx)(l.In,{name:"play",size:16}),i("forma.start")]}),(0,r.jsxs)(M,{onClick:()=>O("pastFast"),children:[(0,r.jsx)(l.In,{name:"clock",size:16}),i("forma.sheet.logPastFast")]})]})),eF&&(0,r.jsx)(w,{children:(0,r.jsx)(l.YZ,{children:i("forma.sheet.mealSection")})}),eF&&("meal"===N?(0,r.jsxs)(u,{children:[(0,r.jsxs)(y,{children:[(0,r.jsx)(b,{htmlFor:"meal-slot",children:i("forma.meal.lunch")}),(0,r.jsxs)(k,{id:"meal-slot",value:er,onChange:e=>eo(e.target.value),children:[(0,r.jsx)("option",{value:"lunch",children:i("forma.meal.lunch")}),(0,r.jsx)("option",{value:"dinner",children:i("forma.meal.dinner")}),(0,r.jsx)("option",{value:"snack",children:i("forma.meal.snack")})]})]}),(0,r.jsxs)(y,{children:[(0,r.jsx)(b,{htmlFor:"meal-notes",children:i("forma.meal.template")}),(0,r.jsx)($,{id:"meal-notes",type:"text",value:ed,placeholder:"3 ovos, 100g atum, salada…",onChange:e=>ec(e.target.value)})]}),eI.matched.length>0&&(0,r.jsxs)(j,{children:[i("forma.sheet.estimateHint",{protein:eI.proteinG,kcal:eI.kcal}),eI.unmatched.length>0&&(0,r.jsxs)(z,{children:[" \xb7 ",i("forma.sheet.estimateUnmatched",{items:eI.unmatched.join(", ")})]})]}),(0,r.jsxs)(y,{children:[(0,r.jsx)(b,{htmlFor:"meal-protein",children:i("forma.sheet.proteinLabel")}),(0,r.jsx)($,{id:"meal-protein",type:"number",value:ei,min:0,placeholder:eI.proteinG>0?`≈ ${eI.proteinG}`:"0",onChange:e=>en(e.target.value)})]}),(0,r.jsxs)(y,{children:[(0,r.jsx)(b,{htmlFor:"meal-kcal",children:i("forma.sheet.kcalLabel")}),(0,r.jsx)($,{id:"meal-kcal",type:"number",value:es,min:0,placeholder:eI.kcal>0?`≈ ${eI.kcal}`:"0",onChange:e=>el(e.target.value)})]}),(0,r.jsxs)(y,{children:[(0,r.jsx)(b,{htmlFor:"meal-date",children:i("forma.sheet.dateLabel")}),(0,r.jsx)($,{id:"meal-date",type:"date",value:ep,max:p(),onChange:e=>eh(e.target.value)})]}),(0,r.jsxs)(T,{children:[(0,r.jsx)(l.$n,{variant:"primary",onClick:eP,children:f?.kind==="meal"?i("forma.sheet.saveEdit"):i("forma.sheet.save")}),(0,r.jsx)(l.$n,{variant:"ghost",onClick:eD,children:i("forma.sheet.cancel")})]})]}):(0,r.jsxs)(M,{onClick:()=>O("meal"),children:[(0,r.jsx)(l.In,{name:"utensils",size:16}),i("forma.sheet.logMeal")]})),eS&&(0,r.jsx)(w,{children:(0,r.jsx)(l.YZ,{children:i("forma.sheet.weightSection")})}),eS&&("weight"===N?(0,r.jsxs)(u,{children:[(0,r.jsxs)(y,{children:[(0,r.jsx)(b,{htmlFor:"weight-kg",children:i("forma.sheet.weightLabel")}),(0,r.jsx)($,{id:"weight-kg",type:"number",value:em,min:20,max:300,step:.1,placeholder:"84.2",onChange:e=>eg(e.target.value)})]}),(0,r.jsxs)(y,{children:[(0,r.jsx)(b,{htmlFor:"weight-date",children:i("forma.sheet.dateLabel")}),(0,r.jsx)($,{id:"weight-date",type:"date",value:ef,max:p(),onChange:e=>ex(e.target.value)})]}),(0,r.jsxs)(T,{children:[(0,r.jsx)(l.$n,{variant:"primary",onClick:eB,children:f?.kind==="weight"?i("forma.sheet.saveEdit"):i("forma.sheet.save")}),(0,r.jsx)(l.$n,{variant:"ghost",onClick:eD,children:i("forma.sheet.cancel")})]})]}):(0,r.jsxs)(M,{onClick:()=>O("weight"),children:[(0,r.jsx)(l.In,{name:"trending-up",size:16}),i("forma.sheet.logWeight")]})),eC&&(0,r.jsx)(w,{children:(0,r.jsx)(l.YZ,{children:i("forma.sheet.walkSection")})}),eC&&("walk"===N?(0,r.jsxs)(u,{children:[(0,r.jsxs)(y,{children:[(0,r.jsx)(b,{htmlFor:"walk-min",children:i("forma.sheet.walkLabel")}),(0,r.jsx)($,{id:"walk-min",type:"number",value:eu,min:1,max:600,placeholder:"30",onChange:e=>ew(e.target.value)})]}),(0,r.jsxs)(y,{children:[(0,r.jsx)(b,{htmlFor:"walk-date",children:i("forma.sheet.dateLabel")}),(0,r.jsx)($,{id:"walk-date",type:"date",value:ey,max:p(),onChange:e=>eb(e.target.value)})]}),(0,r.jsxs)(T,{children:[(0,r.jsx)(l.$n,{variant:"primary",onClick:eW,children:f?.kind==="walk"?i("forma.sheet.saveEdit"):i("forma.sheet.save")}),(0,r.jsx)(l.$n,{variant:"ghost",onClick:eD,children:i("forma.sheet.cancel")})]})]}):(0,r.jsxs)(M,{onClick:()=>O("walk"),children:[(0,r.jsx)(l.In,{name:"activity",size:16}),i("forma.sheet.logWalk")]})),eA&&(0,r.jsx)(w,{children:(0,r.jsx)(l.YZ,{children:i("forma.today.water")})}),eA&&("water"===N?(0,r.jsxs)(u,{children:[(0,r.jsxs)(y,{children:[(0,r.jsx)(b,{htmlFor:"water-ml",children:i("forma.sheet.waterLabel")}),(0,r.jsx)($,{id:"water-ml",type:"number",value:e$,min:1,max:5e3,placeholder:i("forma.sheet.waterPlaceholder"),onChange:e=>ev(e.target.value)})]}),(0,r.jsxs)(y,{children:[(0,r.jsx)(b,{htmlFor:"water-date",children:i("forma.sheet.dateLabel")}),(0,r.jsx)($,{id:"water-date",type:"date",value:ek,max:p(),onChange:e=>eM(e.target.value)})]}),(0,r.jsxs)(T,{children:[(0,r.jsx)(l.$n,{variant:"primary",onClick:eE,children:f?.kind==="water"?i("forma.sheet.saveEdit"):i("forma.sheet.save")}),(0,r.jsx)(l.$n,{variant:"ghost",onClick:eD,children:i("forma.sheet.cancel")})]})]}):(0,r.jsxs)(M,{onClick:()=>O("water"),children:[(0,r.jsx)(l.In,{name:"droplets",size:16}),i("forma.water.add250")]}))]})})}},52128(e,t,a){a.d(t,{g:()=>b});var r=a(65723),o=a(37991),i=a(36859),n=a.n(i),s=a(6063),l=a(63019);let d="#7fb77e",c=n().button`
  display: flex;
  flex-direction: column;
  gap: ${s.w4.spacing.sm};
  background: ${s.w4.colors.surface};
...
`;function b({data:e,t,onClick:a}){let[i,n]=(0,o.useState)(Date.now),s=e.sessions.some(e=>void 0===e.endedAt);(0,o.useEffect)(()=>{if(!s)return;let e=setInterval(()=>n(Date.now()),3e4);return()=>clearInterval(e)},[s]);let d=(0,l.currentFast)(e,i),$=d?.percent??0,v=d?Math.max(0,d.session.targetHours-d.hoursElapsed):0,k=d?`${v.toFixed(1)}h ${t("forma.timer.remaining")}`:t("forma.miniFast.noActive");return(0,r.jsxs)(c,{onClick:a,"aria-label":t("forma.miniFast.aria"),children:[(0,r.jsxs)(p,{children:[(0,r.jsxs)(h,{children:["◉ ",t("forma.miniFast.title")]}),d&&(0,r.jsxs)(m,{children:[Math.round(100*$),"%"]})]}),(0,r.jsxs)(g,{children:[(0,r.jsx)(f,{children:d?d.hoursElapsed.toFixed(1):"—"}),(0,r.jsx)(x,{children:d?`h / ${d.session.targetHours}h`:t("forma.miniFast.noActive")})]}),(0,r.jsx)(w,{children:(0,r.jsx)(y,{pct:$})}),(0,r.jsx)(u,{children:k})]})}},59446(e,t,a){a.d(t,{S:()=>w});var r=a(65723),o=a(37991),i=a(36859),n=a.n(i),s=a(6063),l=a(63019),d=a(11533);let c="#7fb77e",p=n().button`
  display: flex;
  flex-direction: column;
  gap: ${s.w4.spacing.sm};
  background: ${s.w4.colors.surface};
...
`,u=n().div`
  flex: 1;
  min-height: 60px;
`;function w({data:e,t,onClick:a}){let i=(0,o.useMemo)(()=>(0,l.weightForecast)(e.weights,60,30),[e.weights]),n=i.history.length>0?i.history[i.history.length-1]:null,c=i.forecast.length>0?i.forecast[i.forecast.length-1]:null,y=n&&c?c.kg-n.kg:0;return(0,r.jsxs)(p,{onClick:a,"aria-label":t("forma.miniWeight.aria"),children:[(0,r.jsxs)(h,{children:[(0,r.jsxs)(m,{children:["◉ ",t("forma.miniWeight.title")]}),c&&(0,r.jsxs)(x,{pos:y>0,children:[y>=0?"+":"",y.toFixed(1),"kg / 30d"]})]}),(0,r.jsxs)(g,{children:[(0,r.jsx)(f,{children:n?n.kg.toFixed(1):"—"}),(0,r.jsx)("span",{style:{color:s.w4.colors.mainTextMuted,fontSize:13,fontFamily:s.w4.typography.fontFamilyMono},children:"kg"}),c&&(0,r.jsxs)("span",{style:{color:s.w4.colors.mainTextMuted,fontSize:12,fontFamily:s.w4.typography.fontFamilyMono},children:["→ ",c.kg.toFixed(1)," kg"]})]}),(0,r.jsx)(u,{children:(0,r.jsx)(d.h,{forecast:i,axes:!1,goalKg:e.goal.weightKg})})]})}},36971(e,t,a){a.d(t,{z:()=>x});var r=a(65723),o=a(36859),i=a.n(o),n=a(72799),s=a(6063),l=a(63236),d=a(63019);let c=(0,n.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,p=i().div`
  background: ${s.w4.colors.surface};
  ...
  &:hover {
    border-color: ${s.w4.colors.borderStrong??s.w4.colors.mainTextMuted};
  }
...
`,y=n().div`
  background: ${({hasCheckIn:e})=>e?`${p}18`:l.w4.colors.surface};
  border: 1px solid ${({isToday:e,hasCheckIn:t})=>e?p:t?`${p}55`:l.w4.colors.border};
  border-radius: ${l.w4.borderRadius.md};
  padding: 8px 6px;
  display: flex;
  flex-direction: column;
...
`,b=n().span`
  ...
  font-family: ${l.w4.typography.fontFamilyMono};
  font-variant-numeric: tabular-nums;
  color: ${({isToday:e})=>e?p:l.w4.colors.mainText};
`,$=n().span`
  font-size: 11px;
  font-family: ${l.w4.typography.fontFamilyMono};
  color: ${l.w4.colors.mainTextMuted};
...
`,k=n().div`
  ...
  height: 14px;
  border-radius: 50%;
  border: 1.5px solid ${({done:e})=>e?p:l.w4.colors.border};
  background: ${({done:e})=>e?p:"transparent"};
  display: flex;
  align-items: center;
  justify-content: center;
`,M=n().div`
...
`,j=n().p`
  ...
  line-height: 1.5;
  margin: 0;
`;function z({t:e}){let{plan:t,dayNumber:a}=(0,c.useProgram)(),{data:i}=(0,c.useForma)(),n=(0,o.useMemo)(()=>i?new Set(i.checkIns.map(e=>e.date)):new Set,[i]);if(!t)return(0,r.jsxs)(M,{children:[(0,r.jsx)(d.In,{name:"calendar",size:24,color:l.w4.colors.mainTextMuted}),(0,r.jsx)(j,{children:e("forma.program.noProgram")})]});let s=t.days.filter(e=>{let a=T(t.startDate,e.day-1);return n.has(a)&&a<h}).length;return(0,r.jsxs)(g,{children:[(0,r.jsxs)(f,{children:[(0,r.jsx)(x,{children:e("forma.program.title")}),(0,r.jsxs)(u,{children:[s," / 30 ",e("forma.program.daysCompleted",{n:s})]})]}),(0,r.jsx)(w,{children:t.days.map(a=>{let o=T(t.startDate,a.day-1),i=o<h,s=o===h,l=n.has(o);return(0,r.jsxs)(y,{isToday:s,isPast:i,hasCheckIn:l,isRefeed:!0===a.refeed,children:[(0,r.jsx)(b,{isToday:s,children:a.day}),(0,r.jsxs)($,{children:[a.walkMin,"m"]}),a.refeed&&(0,r.jsx)(v,{title:e("forma.program.refeed")}),(0,r.jsx)(k,{done:l,children:l&&(0,r.jsx)("svg",{width:"8",height:"8",viewBox:"0 0 8 8",fill:"none",children:(0,r.jsx)("path",{d:"M1.5 4L3.5 6L6.5 2",stroke:"white",strokeWidth:"1.5",strokeLinecap:"round"})})})]},a.day)})})]})}function T(e,t){let a=new Date(e);return a.setDate(a.getDate()+t),a.toISOString().slice(0,10)}},68477(e,t,a){a.d(t,{P:()=>p});var r=a(65723),o=a(36859),i=a.n(o),n=a(6063);let s="#7fb77e",l=["16:8","18:6","20:4","custom"],d=i().div`
  display: flex;
  gap: ${n.w4.spacing.sm};
  overflow-x: auto;
...
`;function p({t:e,active:t,onChange:a}){return(0,r.jsx)(d,{role:"group","aria-label":e("forma.rail.title"),children:l.map(o=>(0,r.jsx)(c,{active:t===o,onClick:()=>a(o),"aria-pressed":t===o,children:e(`forma.protocol.${o}`)},o))})}},71589(e,t,a){a.d(t,{B:()=>g});var r=a(65723),o=a(36859),i=a.n(o),n=a(6063);let s="#7fb77e",l=[{id:"16:8",fastH:16,windowH:8},{id:"18:6",fastH:18,windowH:6},{id:"20:4",fastH:20,windowH:4},{id:"custom",fastH:0,windowH:0}],d=i().aside`
  width: 260px;
  flex-shrink: 0;
...
`,m=i().span`
  ...
  font-family: ${n.w4.typography.fontFamilyMono};
  color: ${n.w4.colors.mainTextMuted};
`;function g({t:e,active:t,onChange:a}){return(0,r.jsxs)(d,{"aria-label":e("forma.rail.title"),children:[(0,r.jsx)(c,{children:e("forma.rail.title")}),l.map(o=>(0,r.jsxs)(p,{active:t===o.id,onClick:()=>a(o.id),"aria-pressed":t===o.id,children:[(0,r.jsx)(h,{active:t===o.id,children:e(`forma.protocol.${o.id}`)}),o.fastH>0&&(0,r.jsxs)(m,{children:[e("forma.rail.hours",{n:o.fastH})," \xb7 ",e("forma.rail.window",{n:o.windowH})]})]},o.id))]})}},25405(e,t,a){a.d(t,{F:()=>p});var r=a(65723),o=a(37991),i=a(36859),n=a.n(i),s=a(6063);let l=n().form`
  display: flex;
  align-items: center;
  gap: ${s.w4.spacing.sm};
  padding: ${s.w4.spacing.sm} ${s.w4.spacing.md};
...
`,c=n().span`
  ...
  color: ${s.w4.colors.mainTextMuted};
  white-space: nowrap;
`;function p({t:e,onParsed:t}){let[a,i]=(0,o.useState)(""),[n,s]=(0,o.useState)(!1),h=(0,o.useCallback)(e=>{e.preventDefault();let r=function(e){let t=e.trim().toLowerCase();if(!t)return null;let a=t.match(/^(?:agua|água|water|bebi)\s+(\d+)/);if(a){let e=parseInt(a[1],10);if(!isNaN(e)&&e>0)return{kind:"water",waterMl:e}}let r=t.match(/^(?:peso|weight)\s+(\d+(?:[.,]\d+)?)/);if(r){let e=parseFloat(r[1].replace(",","."));if(!isNaN(e))return{kind:"weight",weightKg:e}}let o=t.match(/^(?:caminhei|walked|walk|caminhada)\s+(\d+)/);if(o){let e=parseInt(o[1],10);if(!isNaN(e))return{kind:"walk",walkMinutes:e}}let i=t.match(/^(?:jejum|fast)\s+(\d+)/);if(i){let e=parseInt(i[1],10);if(!isNaN(e))return{kind:"fast",fastHours:e,fastProtocol:16===e?"16:8":18===e?"18:6":20===e?"20:4":"custom"}}let n=t.match(/^(jantar|almoço|almoco|dinner|snack|lanche|lunch)\s+(.*)/);if(n){let e=n[1];return{kind:"meal",mealSlot:"jantar"===e||"dinner"===e?"dinner":"almo\xe7o"===e||"almoco"===e||"lunch"===e?"lunch":"snack",mealDesc:n[2].trim()}}return null}(a);if(!r){s(!0),setTimeout(()=>s(!1),1200);return}t(r),i("")},[a,t]);return(0,r.jsxs)(l,{onSubmit:h,children:[(0,r.jsx)(d,{value:a,onChange:e=>i(e.target.value),placeholder:e("forma.quickadd.placeholder"),style:{borderColor:n?"#f85149":void 0},"aria-label":e("forma.quickadd.hint")}),(0,r.jsx)(c,{children:e("forma.quickadd.hint")})]})}},20429(e,t,a){a.d(t,{f:()=>$});var r=a(65723),o=a(37991),i=a(36859),n=a.n(i),s=a(6063),l=a(63236),d=a(63019);let c="#7fb77e",p=n().section`
  display: flex;
  flex-direction: column;
  gap: ${s.w4.spacing.lg};
  max-width: 560px;
...
`,b=n().p`
  ...
  color: ${c};
  margin: 0;
`;function $({data:e,t,onSave:a}){let[i,n]=(0,o.useState)(String(e.goal.proteinG??110)),[s,c]=(0,o.useState)(String(e.goal.kcal??2200)),[v,k]=(0,o.useState)(String(e.goal.walkMin??30)),[M,j]=(0,o.useState)(String(e.goal.weightKg??"")),[z,T]=(0,o.useState)(String(e.goal.targetHours)),[F,S]=(0,o.useState)(String(e.goal.weeklyFasts)),[C,A]=(0,o.useState)(!1),[D,L]=(0,o.useState)(!1),{plan:R,dayNumber:H,startProgram:I,clearProgram:P}=(0,d.useProgram)(),B=(0,o.useCallback)(async()=>{let e=new Date().toISOString().slice(0,10);await I({...d.SEED_PLAN_TUNA_30,startDate:e})},[I]),W=(0,o.useCallback)(async()=>{L(!1),await P()},[P]),E=async()=>{let t={...e,goal:{targetHours:Number(z)||16,weeklyFasts:Number(F)||5,proteinG:Number(i)||void 0,kcal:Number(s)||void 0,walkMin:Number(v)||void 0,weightKg:M?Number(M):void 0}};await a(t),A(!0),setTimeout(()=>A(!1),2e3)};return(0,r.jsxs)(p,{children:[(0,r.jsxs)(h,{children:[(0,r.jsxs)(m,{children:["◉ ",t("forma.settings.foodGoals")]}),(0,r.jsxs)(g,{children:[(0,r.jsx)(f,{children:t("forma.settings.proteinG")}),(0,r.jsx)(x,{type:"number",value:i,onChange:e=>n(e.target.value)})]}),(0,r.jsxs)(g,{children:[(0,r.jsx)(f,{children:t("forma.settings.kcal")}),(0,r.jsx)(x,{type:"number",value:s,onChange:e=>c(e.target.value)})]}),(0,r.jsxs)(g,{children:[(0,r.jsx)(f,{children:t("forma.settings.walkMin")}),(0,r.jsx)(x,{type:"number",value:v,onChange:e=>k(e.target.value)})]}),(0,r.jsxs)(g,{children:[(0,r.jsx)(f,{children:t("forma.settings.weightTarget")}),(0,r.jsx)(x,{type:"number",step:"0.1",value:M,onChange:e=>j(e.target.value)})]})]}),(0,r.jsxs)(h,{children:[(0,r.jsxs)(m,{children:["◉ ",t("forma.settings.fastingGoals")]}),(0,r.jsxs)(g,{children:[(0,r.jsx)(f,{children:t("forma.settings.targetHours")}),(0,r.jsx)(x,{type:"number",value:z,onChange:e=>T(e.target.value)})]}),(0,r.jsxs)(g,{children:[(0,r.jsx)(f,{children:t("forma.settings.weeklyFasts")}),(0,r.jsx)(x,{type:"number",value:F,onChange:e=>S(e.target.value)})]})]}),(0,r.jsxs)(h,{children:[(0,r.jsx)(m,{children:t("forma.program.title")}),R?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(b,{children:t("forma.program.active",{n:H??0})}),(0,r.jsx)(u,{style:{justifyContent:"flex-start"},children:(0,r.jsx)(l.$n,{variant:"danger",onClick:()=>L(!0),children:t("forma.program.clear")})})]}):(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(y,{children:t("forma.program.noProgram")}),(0,r.jsx)(u,{style:{justifyContent:"flex-start"},children:(0,r.jsx)(l.$n,{variant:"accent",onClick:()=>void B(),children:t("forma.program.start")})})]})]}),(0,r.jsxs)(u,{children:[C&&(0,r.jsx)(w,{children:t("forma.settings.saved")}),(0,r.jsx)(l.$n,{variant:"primary",onClick:()=>void E(),children:t("forma.settings.save")})]}),(0,r.jsx)(l.TM,{open:D,title:t("forma.program.confirmClear"),message:t("forma.program.confirmClearBody"),confirmLabel:t("forma.program.clear"),cancelLabel:t("forma.checkin.cancel"),onConfirm:()=>void W(),onCancel:()=>L(!1),danger:!0})]})}},22684(e,t,a){a.d(t,{q:()=>L});var r=a(65723),o=a(37991),i=a(36859),n=a.n(i),s=a(72799),l=a(6063),d=a(63236),c=a(63019);let p="#7fb77e",h="#facc15",m=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,g=n().section`
  background: ${l.w4.colors.surface};
...
`,v=n().div`
  border-radius: 1px;
  background: ${({state:e})=>"today"===e?p:"past"===e?`${p}66`:l.w4.colors.border};
  ${({state:e})=>"today"===e&&`box-shadow: 0 0 0 1px ${p}66;`}
`,k=n().div`
  display: flex;
  flex-direction: column;
  gap: 6px;
...
`,D=n().p`
  ...
  line-height: 1.5;
  margin: 0;
`;function L({t:e,onOpenCheckIn:t,onOpenSettings:a}){let{plan:i,today:n,dayNumber:s}=(0,c.useProgram)(),{checkIn:p}=(0,c.useCheckIn)(),h=(0,o.useMemo)(()=>{if(!n)return"";let t=[`${n.oatsG}g`];return n.banana&&t.push(e("forma.program.breakfast.banana")),t.join(" + ")},[n,e]),m=(0,o.useMemo)(()=>n?e(n.dinnerKey):"",[n,e]);if(!i||null===n||null===s)return(0,r.jsxs)(C,{children:[(0,r.jsx)(w,{children:e("forma.program.title")}),(0,r.jsx)(A,{children:e("forma.program.startTitle")}),(0,r.jsx)(D,{children:e("forma.program.startBody")}),(0,r.jsx)("div",{children:(0,r.jsx)(d.$n,{variant:"primary",onClick:a,children:e("forma.program.start")})})]});let R=Array.from({length:30},(e,t)=>{let a=t+1;return a===s?"today":a<s?"past":"future"});return(0,r.jsxs)(g,{children:[(0,r.jsxs)(f,{children:[(0,r.jsx)(x,{children:s}),(0,r.jsxs)(u,{children:[(0,r.jsx)(w,{children:e("forma.program.dayOf",{n:30})}),(0,r.jsx)(y,{children:e("forma.program.title")}),n.refeed&&(0,r.jsx)(b,{children:e("forma.program.refeed")})]})]}),(0,r.jsx)($,{children:R.map((e,t)=>(0,r.jsx)(v,{state:e},t))}),(0,r.jsxs)(k,{children:[(0,r.jsxs)(M,{children:[(0,r.jsx)(j,{children:(0,r.jsx)(d.In,{name:"leaf",size:16})}),(0,r.jsx)(z,{children:e("forma.program.shake")}),(0,r.jsx)(T,{children:h})]}),(0,r.jsxs)(M,{children:[(0,r.jsx)(j,{children:(0,r.jsx)(d.In,{name:"utensils",size:16})}),(0,r.jsx)(z,{children:e("forma.program.dinner")}),(0,r.jsx)(T,{children:m})]}),(0,r.jsxs)(M,{children:[(0,r.jsx)(j,{children:(0,r.jsx)(d.In,{name:"heart",size:16})}),(0,r.jsx)(z,{children:e("forma.program.walkLabel")}),(0,r.jsx)(T,{children:e("forma.program.walk",{min:n.walkMin})})]})]}),(0,r.jsxs)(F,{children:[p?(0,r.jsxs)(S,{children:[(0,r.jsx)(d.In,{name:"check-circle",size:16}),e("forma.checkin.done")]}):(0,r.jsx)("span",{style:{fontSize:13,color:l.w4.colors.mainTextMuted},children:e("forma.checkin.prompt")}),(0,r.jsx)(d.$n,{variant:p?"ghost":"accent",onClick:t,children:p?e("forma.checkin.update"):e("forma.checkin.title")})]})]})}},7434(e,t,a){a.d(t,{c:()=>b});var r=a(65723),o=a(36859),i=a.n(o),n=a(72799),s=a(6063),l=a(63019);let d="#7fb77e",c=(0,n.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,p=i().section`
  display: flex;
...
`,w=i()(x)`
  ...
  color: ${({active:e})=>e?d:s.w4.colors.mainTextMuted};
`,y=i().span`
  color: ${s.w4.colors.mainText};
  font-weight: 700;
  font-variant-numeric: tabular-nums;
`;function b({data:e,t,userName:a}){let o,i,n,c,$=new Date,v=(0,l.currentFast)(e),k=e.goal.targetHours??16,M=(0,l.streakDays)(e.sessions,k),j=(n=new Date((i=((o=new Date($)).getDay()+6)%7,o.setDate(o.getDate()-i),o.setHours(0,0,0,0),o.toISOString().slice(0,10))).getTime(),e.sessions.filter(e=>void 0!==e.endedAt&&!(e.startedAt<n)&&(e.endedAt-e.startedAt)/36e5>=e.targetHours).length),z=e.goal.weeklyFasts??5,T=new Date().toISOString().slice(0,10),F=e.weights.find(e=>e.date===T),S=[...e.weights].filter(e=>e.date<T).sort((e,t)=>e.date.localeCompare(t.date)).pop(),C=F&&S?F.kg-S.kg:null,A=$.toLocaleDateString(void 0,{weekday:"long",day:"numeric",month:"long"}),D=$.toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit"}),L=null!==v,R=L?t("forma.hero.fastActive",{h:v.hoursElapsed.toFixed(1)}):t("forma.hero.fastIdle"),H=a&&a.trim()?a:t("forma.hero.defaultName");return(0,r.jsxs)(p,{children:[(0,r.jsxs)(h,{children:[(0,r.jsx)(m,{children:t((c=$.getHours())<12?"forma.hero.greet.morning":c<18?"forma.hero.greet.afternoon":"forma.hero.greet.evening",{name:H})}),(0,r.jsxs)(g,{children:[A," \xb7 ",D]})]}),(0,r.jsxs)(f,{children:[(0,r.jsxs)(w,{active:L,title:R,children:[(0,r.jsx)("span",{"aria-hidden":"true",children:"⏱"}),L?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(y,{children:[v.hoursElapsed.toFixed(1),"h"]}),t("forma.hero.fastShort")]}):(0,r.jsx)(r.Fragment,{children:t("forma.hero.fastIdleShort")})]}),(0,r.jsxs)(x,{title:t("forma.hero.weeklyFasts.tooltip",{n:j,total:z}),children:[(0,r.jsx)("span",{"aria-hidden":"true",children:"\uD83D\uDCC5"}),(0,r.jsxs)(y,{children:[j,"/",z]}),t("forma.hero.weeklyShort")]}),(0,r.jsxs)(u,{active:M>0,title:M>0?t("forma.streak",{n:M}):t("forma.streak.none"),children:[(0,r.jsx)("span",{"aria-hidden":"true",children:M>0?"\uD83D\uDD25":"\xb7"}),(0,r.jsx)(y,{children:M}),t("forma.hero.streakShort")]}),F&&(0,r.jsxs)(x,{title:t("forma.weight.label"),children:[(0,r.jsx)("span",{"aria-hidden":"true",children:"⚖"}),(0,r.jsx)(y,{children:F.kg.toFixed(1)}),"kg",null!==C&&Math.abs(C)>=.1&&(0,r.jsxs)("span",{style:{color:C>0?s.w4.colors.mainTextMuted:d},children:[C>0?"+":"",C.toFixed(1)]})]})]})]})}},19652(e,t,a){a.d(t,{_:()=>ee});var r=a(65723),o=a(37991),i=a(36859),n=a.n(i),s=a(6063),l=a(63236),d=a(63019);let c="#7fb77e",p="#58a6ff",h="#facc15",m="#22d3ee",g=84.5,f=68.5,x=52.5,u=36.5,w=n().div`
  display: flex;
  align-items: center;
  gap: ${s.w4.spacing.lg};
  flex-wrap: wrap;
...
`,j=n().dd`
  ...
  margin: 0;
  white-space: nowrap;
`;function z({radius:e,pct:t,color:a}){let o=2*Math.PI*e,i=Math.min(1,Math.max(0,t));return(0,r.jsxs)("g",{children:[(0,r.jsx)("circle",{cx:92,cy:92,r:e,fill:"none",stroke:a,strokeOpacity:.18,strokeWidth:11}),(0,r.jsx)("circle",{cx:92,cy:92,r:e,fill:"none",stroke:a,strokeWidth:11,strokeDasharray:o,strokeDashoffset:o*(1-i),strokeLinecap:"round",transform:"rotate(-90 92 92)",style:{transition:"stroke-dashoffset 0.6s ease"}})]})}function T(e){return .5>Math.abs(e)?"flat":e>0?"up":"down"}function F(e,t,a=0){if(.5>Math.abs(e))return"\xb7";let r=Math.abs(e);return`${e>0?"+":"−"}${r.toFixed(a)}${t}`}function S({t:e,fastPct:t,fastHours:a,fastTargetHours:o,protein:i,proteinTarget:n,proteinYesterday:l,kcal:d,kcalTarget:C,kcalYesterday:A,waterMl:D,waterTargetMl:L,waterYesterdayMl:R}){let H=C>0?d/C:0,I=d>C&&C>0,P=I?h:"#f59e0b",B=i-l,W=d-A,E=D-R;return(0,r.jsxs)(w,{children:[(0,r.jsx)(y,{children:(0,r.jsxs)("svg",{width:184,height:184,viewBox:"0 0 184 184","aria-hidden":"true",children:[(0,r.jsx)(z,{radius:g,pct:t,color:c}),(0,r.jsx)(z,{radius:f,pct:n>0?i/n:0,color:p}),(0,r.jsx)(z,{radius:x,pct:Math.min(1,H),color:P}),(0,r.jsx)(z,{radius:u,pct:L>0?D/L:0,color:m})]})}),(0,r.jsxs)(b,{children:[(0,r.jsxs)($,{children:[(0,r.jsx)(v,{color:c}),(0,r.jsx)(k,{children:e("forma.today.fast")}),(0,r.jsxs)(j,{children:[a>0?a.toFixed(1):"0",(0,r.jsxs)("span",{style:{color:s.w4.colors.mainTextMuted},children:[" / ",o,"h"]})]})]}),(0,r.jsxs)($,{children:[(0,r.jsx)(v,{color:p}),(0,r.jsxs)(k,{children:[e("forma.today.protein"),(0,r.jsx)(M,{tone:T(B),children:F(B,"g")})]}),(0,r.jsxs)(j,{children:[Math.round(i),(0,r.jsxs)("span",{style:{color:s.w4.colors.mainTextMuted},children:[" / ",n,"g"]})]})]}),(0,r.jsxs)($,{children:[(0,r.jsx)(v,{color:P}),(0,r.jsxs)(k,{children:[e(I?"forma.today.kcalOver":"forma.today.kcal"),(0,r.jsx)(M,{tone:T(-W),children:F(W,"")})]}),(0,r.jsxs)(j,{style:{color:I?h:void 0},children:[Math.round(d),(0,r.jsxs)("span",{style:{color:s.w4.colors.mainTextMuted},children:[" / ",C,"kcal"]})]})]}),(0,r.jsxs)($,{children:[(0,r.jsx)(v,{color:m}),(0,r.jsxs)(k,{children:[e("forma.today.water"),(0,r.jsx)(M,{tone:T(E),children:F(E,"ml")})]}),(0,r.jsxs)(j,{children:[D,(0,r.jsxs)("span",{style:{color:s.w4.colors.mainTextMuted},children:[" / ",L,"ml"]})]})]})]})]})}let C="#7fb77e",A=n().section`
  background: ${s.w4.colors.surface};
  border: 1px solid ${s.w4.colors.border};
  border-left: 2px solid ${C};
  border-radius: ${s.w4.borderRadius.lg};
...
`,K=n().button`
  ...
  &:hover {
    border-color: ${s.w4.colors.borderStrong??s.w4.colors.accent};
    background: ${s.w4.colors.sidebarHover};
  }
`,G=n().ul`
  list-style: none;
...
`,Z=n().div`
  ...
  font-family: ${s.w4.typography.fontFamilyMono};
  font-variant-numeric: tabular-nums;
`;function ee({data:e,t,onLogMeal:a,onLogWalk:i,onLogWeight:n,onLogWater:c,onDeleteMeal:p,onEditMeal:h,onTapTemplate:m}){var g;let f=new Date().toISOString().slice(0,10),x=new Date(Date.now()-864e5).toISOString().slice(0,10),u=(0,d.proteinByDay)(e.meals,f),w=(0,d.proteinByDay)(e.meals,x),y=(0,d.kcalByDay)(e.meals,f),b=(0,d.kcalByDay)(e.meals,x),$=(0,d.kcalTargetForDate)(e,f),v=(g=e.walks,g.filter(e=>e.date===f).reduce((e,t)=>e+t.minutes,0)),k=(0,d.waterByDay)(e.water??[],f),M=(0,d.waterByDay)(e.water??[],x),j=e.goal.waterMl??2e3,z=e.meals.filter(e=>e.date===f).sort((e,t)=>e.createdAt-t.createdAt),T=e.goal.proteinG??110,F=(0,d.currentFast)(e),C=e.goal.targetHours??16,et=F?.percent??0,ea=F?.hoursElapsed??0,er=new Date().getDay(),eo=new Set(z.map(e=>e.templateId).filter(e=>!!e)),ei=e.templates.filter(e=>e.weekday===er&&!eo.has(e.id)).sort((e,t)=>("lunch"===e.slot?-1:1)-("lunch"===t.slot?-1:1)),[en,es]=(0,o.useState)(!1),[el,ed]=(0,o.useState)(""),ec=(0,o.useCallback)(()=>{let e=parseInt(el,10);!isNaN(e)&&e>0&&(c(e),ed(""),es(!1))},[el,c]);return(0,r.jsxs)(A,{children:[(0,r.jsx)(S,{t:t,fastPct:et,fastHours:ea,fastTargetHours:C,protein:u,proteinTarget:T,proteinYesterday:w,kcal:y,kcalTarget:$,kcalYesterday:b,waterMl:k,waterTargetMl:j,waterYesterdayMl:M}),(0,r.jsxs)(N,{children:[(0,r.jsx)(l.$n,{variant:"primary",icon:(0,r.jsx)(l.In,{name:"plus",size:14}),onClick:a,children:t("forma.action.logMeal")}),(0,r.jsx)(l.$n,{variant:"ghost",icon:(0,r.jsx)(l.In,{name:"plus",size:14}),onClick:i,children:t("forma.action.logWalk")}),(0,r.jsx)(l.$n,{variant:"ghost",icon:(0,r.jsx)(l.In,{name:"plus",size:14}),onClick:n,children:t("forma.action.logWeight")})]}),(0,r.jsx)(O,{children:en?(0,r.jsxs)("div",{style:{display:"flex",gap:s.w4.spacing.xs},children:[(0,r.jsx)("input",{type:"number",min:1,placeholder:"ml",value:el,onChange:e=>ed(e.target.value),onKeyDown:e=>{"Enter"===e.key&&ec()},style:{flex:1,height:44,background:s.w4.colors.surface,border:`1px solid ${s.w4.colors.border}`,borderRadius:s.w4.borderRadius.md,color:s.w4.colors.mainText,fontSize:13,fontFamily:s.w4.typography.fontFamilyMono,padding:`0 ${s.w4.spacing.sm}`},autoFocus:!0}),(0,r.jsx)(l.$n,{variant:"accent",onClick:ec,children:t("forma.sheet.save")}),(0,r.jsx)(l.$n,{variant:"ghost",onClick:()=>es(!1),children:t("forma.sheet.cancel")})]}):(0,r.jsxs)(Y,{children:[(0,r.jsx)(K,{onClick:()=>c(250),children:t("forma.water.add250")}),(0,r.jsx)(K,{onClick:()=>c(500),children:t("forma.water.add500")}),(0,r.jsx)(K,{onClick:()=>c(1e3),children:t("forma.water.add1000")}),(0,r.jsx)(K,{onClick:()=>es(!0),children:t("forma.water.addCustom")})]})}),m&&ei.length>0&&(0,r.jsxs)(L,{children:[(0,r.jsx)(D,{children:t("forma.today.tapToLog")}),(0,r.jsx)(R,{children:ei.map(e=>(0,r.jsxs)(H,{onClick:()=>m(e),title:t("forma.today.tapToLog"),children:[(0,r.jsx)(I,{children:(0,l.n6)(e.icon)?(0,r.jsx)(l.In,{name:e.icon,size:14}):(0,r.jsx)("span",{children:e.icon})}),(0,r.jsxs)(P,{children:[(0,r.jsx)(B,{children:t(e.nameKey)}),(0,r.jsxs)(W,{children:[e.proteinG,"g \xb7 ",e.kcal,"kcal"]})]}),(0,r.jsx)(E,{children:t(`forma.meal.${e.slot}`)})]},e.id))})]}),0===z.length?(0,r.jsx)(X,{children:t("forma.today.noMealsYet")}):(0,r.jsx)(G,{children:z.map(e=>(0,r.jsxs)(V,{onClick:h?()=>h(e.id):void 0,style:{cursor:h?"pointer":"default"},title:h?t("forma.action.edit"):void 0,children:[(0,r.jsx)(q,{tone:"lunch"===e.slot?"#58a6ff":"dinner"===e.slot?"#f59e0b":"#a371f7",title:t(`forma.meal.${e.slot}`),"aria-label":t(`forma.meal.${e.slot}`),children:(0,r.jsx)(l.In,{name:"lunch"===e.slot?"utensils":"dinner"===e.slot?"flame":"apple",size:12})}),(0,r.jsx)(U,{children:new Date(e.createdAt).toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit"})}),(0,r.jsx)(_,{children:e.notes||"—"}),(0,r.jsxs)(J,{children:[e.proteinG??0,"g \xb7 ",e.kcal??0,"kcal"]}),(0,r.jsx)(Q,{onClick:t=>{t.stopPropagation(),p(e.id)},"aria-label":t("forma.action.delete"),children:(0,r.jsx)(l.In,{name:"trash",size:14})})]},e.id))}),v>0&&(0,r.jsx)(Z,{children:(0,r.jsx)("span",{children:t("forma.today.walkSummary",{min:v})})})]})}},20483(e,t,a){a.d(t,{v:()=>v});var r=a(65723),o=a(36859),i=a.n(o),n=a(72799),s=a(6063),l=a(63236);let d="#7fb77e",c=(0,n.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,p=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],h=["Dom","Seg","Ter","Qua","Qui","Sex","S\xe1b"];function m(e){return e.toISOString().slice(0,10)}let g=i().div`
  animation: ${c} 0.25s ease both;
`,f=i().div`
  font-size: 11px;
  font-weight: 600;
...
`,$=i().div`
  ...
  border-radius: 50%;
  background: ${s.w4.colors.border};
`;function v({data:e,t,locale:a,onTapTemplate:o}){let i,n,s,d=(n=new Date(i=new Date),s=(i.getDay()+6)%7,n.setDate(i.getDate()-s),n.setHours(0,0,0,0),Array.from({length:7},(e,t)=>{let a=new Date(n);return a.setDate(n.getDate()+t),{date:m(a),weekday:a.getDay()}})),c=m(new Date),k="pt"===a?h:p,M=new Map;for(let t of e.templates)M.set(t.weekday,t);return(0,r.jsxs)(g,{children:[(0,r.jsx)(f,{children:t("forma.week.title")}),(0,r.jsx)(x,{children:d.map(({date:a,weekday:i})=>{let n=a===c,s=e.meals.some(e=>e.date===a),d=e.sessions.some(e=>void 0!==e.endedAt&&m(new Date(e.startedAt))===a),p=s||d,h=M.get(i),g=n&&void 0!==h&&void 0!==o&&!s;return(0,r.jsxs)(u,{isToday:n,isDone:p,tappable:g,onClick:()=>{g&&h&&o?.(h)},type:"button",title:g?t("forma.week.tapToLog"):void 0,"aria-label":g?t("forma.week.tapToLog"):void 0,children:[(0,r.jsx)(w,{isToday:n,children:k[i]}),p?(0,r.jsx)(b,{"aria-label":t("forma.week.done"),children:(0,r.jsx)(l.In,{name:"check-circle",size:14})}):h?(0,r.jsx)($,{title:t("forma.week.planned")}):null,h&&(0,r.jsx)(y,{children:t(h.nameKey)})]},a)})})]})}},11533(e,t,a){a.d(t,{h:()=>g});var r=a(65723),o=a(37991),i=a(36859),n=a.n(i),s=a(6063);let l="#7fb77e",d="#58a6ff",c=n().div`
  position: relative;
  width: 100%;
  height: 100%;
  min-height: 160px;
...
`,m=n().text`
  ...
  font-family: ${s.w4.typography.fontFamilyMono};
  fill: ${d};
`;function g({forecast:e,axes:t=!0,goalKg:a}){let i=e.history,n=(0,o.useMemo)(()=>(function(e){if(0===e.length)return[];let t=e[0].kg,a=[];for(let r of e)t=.25*r.kg+.75*t,a.push(t);return a})(i),[i]);if(0===i.length)return(0,r.jsx)(c,{children:(0,r.jsx)("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",height:"100%",color:s.w4.colors.mainTextMuted,fontSize:12,fontFamily:s.w4.typography.fontFamilyMono},children:"—"})});let f=t?40:8,x=t?22:6,u=i.map(e=>e.kg);void 0!==a&&u.push(a);let w=Math.min(...u),y=Math.max(...u),b=Math.max(2,y-w),$=w-.15*b,v=y+.15*b,k=v-$,M=new Date(i[0].date).getTime(),j=new Date(i[i.length-1].date).getTime(),z=Math.max(e.forecast.length?new Date(e.forecast[e.forecast.length-1].date).getTime():j,M+6048e5)-M||1,T=e=>f+(new Date(e).getTime()-M)/z*(600-2*f),F=e=>200-x-(e-$)/k*(200-2*x),S=i.length>=2?i.map((e,t)=>`${0===t?"M":"L"} ${T(e.date).toFixed(1)} ${F(n[t]).toFixed(1)}`).join(" "):"",C=e.forecast.length?`M ${T(i[i.length-1].date).toFixed(1)} ${F(n[n.length-1]).toFixed(1)} `+e.forecast.map(e=>`L ${T(e.date).toFixed(1)} ${F(e.kg).toFixed(1)}`).join(" "):"",A=i[i.length-1],D=e.forecast[e.forecast.length-1];return(0,r.jsx)(c,{children:(0,r.jsxs)(p,{viewBox:"0 0 600 200",preserveAspectRatio:"xMidYMid meet",children:[t&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(h,{x:4,y:x+4,children:v.toFixed(1)}),(0,r.jsx)(h,{x:4,y:200-x+4,children:$.toFixed(1)}),(0,r.jsx)("line",{x1:f,y1:200-x,x2:600-f,y2:200-x,stroke:s.w4.colors.border,strokeWidth:1}),(0,r.jsx)("line",{x1:f,y1:x,x2:f,y2:200-x,stroke:s.w4.colors.border,strokeWidth:1})]}),void 0!==a&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)("line",{x1:f,y1:F(a),x2:600-f,y2:F(a),stroke:d,strokeWidth:1,strokeDasharray:"2 4",opacity:.7}),t&&(0,r.jsx)(m,{x:600-f+4,y:F(a)+3,children:a.toFixed(1)})]}),S&&(0,r.jsx)("path",{d:S,fill:"none",stroke:l,strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"}),C&&(0,r.jsx)("path",{d:C,fill:"none",stroke:l,strokeWidth:2,strokeDasharray:"4 4",strokeLinecap:"round",opacity:.55}),i.map(e=>(0,r.jsx)("circle",{cx:T(e.date),cy:F(e.kg),r:3,fill:s.w4.colors.surface,stroke:l,strokeWidth:1.5,children:(0,r.jsx)("title",{children:`${e.date} \xb7 ${e.kg.toFixed(1)} kg`})},e.date)),D&&(0,r.jsx)("circle",{cx:T(D.date),cy:F(D.kg),r:3,fill:l,opacity:.6}),A&&(0,r.jsx)("circle",{cx:T(A.date),cy:F(A.kg),r:5,fill:l,stroke:s.w4.colors.surface,strokeWidth:1.5})]})})}},92152(e,t,a){a.d(t,{m:()=>M});var r=a(65723),o=a(37991),i=a(36859),n=a.n(i),s=a(6063),l=a(63236),d=a(63019),c=a(11533);let p="#7fb77e",h=n().section`
  display: flex;
  flex-direction: column;
  gap: ${s.w4.spacing.lg};
`,m=n().div`
...
`,w=i().forwardRef(function({variant:e="ghost",size:t="md",icon:a,iconRight:o,children:i,...n},s){return(0,r.jsxs)(u,{ref:s,variant:e,size:t,...n,children:[a,i,o]})}),y={default:l.w4.colors.accent,danger:"#f85149"},b={default:l.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"};s().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`,z=s().span`
  ...
  line-height: 1;
  letter-spacing: 0;
`,T=["#3b82f6","#8b5cf6","#ec4899","#10b981","#f59e0b","#06b6d4"],F=0,S=new Map;function C({member:e,size:t=24}){var a,o;let i,n="shared"===e.id||"shared"===e.role,s=Math.floor(.55*t),d=t<=18?8:t<=22?9:t<=28?11:12;if(n)return(0,r.jsx)(j,{size:t,bg:l.w4.colors.surface,ring:!0,"aria-label":"Shared",title:"Shared",style:{color:l.w4.colors.mainTextMuted},children:(0,r.jsx)(M,{name:"home",size:s,"aria-hidden":!0})});let c=(a=e.id,(o=e.color)?o:(!S.has(a)&&(S.set(a,T[F%T.length]),F++),S.get(a))),p="adult"===e.role,h=(i=e.name.trim().split(/\s+/),((i[0]?.[0]??"")+(i[1]?.[0]??"")).toUpperCase().slice(0,2));return(0,r.jsx)(j,{size:t,bg:c,ring:p,title:e.name,children:(0,r.jsx)(z,{fontSize:d,children:h})})}s().img`
  width: ${({size:e})=>e}px;
  height: ${({size:e})=>e}px;
  border-radius: 50%;
  object-fit: cover;
...
`,R=s().span`
  ...
  background: ${({color:e})=>e};
  display: inline-block;
`,H=i().forwardRef(function({variant:e="default",dotColor:t,children:a,onClick:o,...i},n){return(0,r.jsxs)(L,{ref:n,variant:e,clickable:!!o,onClick:o,type:i.type??"button",...i,children:[t&&(0,r.jsx)(R,{color:t}),a]})}),I={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:l.w4.colors.accentMuted},P={neutral:l.w4.colors.mainTextMuted,live:l.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:l.w4.colors.accent},B=s().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${l.w4.typography.fontFamilyMono};
...
`,W=s().span`
  ...
  display: inline-block;
`;function E({tone:e="neutral",dot:t,children:a,...o}){return(0,r.jsxs)(B,{tone:e,...o,children:[(t??"live"===e)&&(0,r.jsx)(W,{}),a]})}s().kbd`
  font-family: ${l.w4.typography.fontFamilyMono};
  font-size: 10px;
  padding: 2px 6px;
  border: 1px solid ${l.w4.colors.border};
...
`;let N=s().div`
  ...
  align-items: center;
  gap: 8px;
`;function O({children:e,...t}){return(0,r.jsx)(N,{...t,children:e})}s().label`
  display: flex;
  align-items: center;
  gap: 10px;
...
`;function _({title:e,accessory:t,accentColor:a,error:o,errorLabel:i,children:n}){return(0,r.jsxs)(Y,{accentColor:a,"data-widget-shell":!0,children:[(0,r.jsxs)(K,{children:[(0,r.jsx)(O,{children:e}),t&&(0,r.jsx)(G,{children:t})]}),o?(0,r.jsxs)(q,{role:"alert",children:[(0,r.jsx)(U,{children:i??"Error"}),(0,r.jsx)("div",{children:o})]}):(0,r.jsx)(V,{children:n})]})}s().div`
  position: relative;
  display: flex;
  flex-direction: column;
  height: 100%;
...
`;var er=a(54041);let eo="https://cdn.jsdelivr.net/npm/mermaid@11.14.0/dist/mermaid.min.js",ei=null,en="#7fb77e",es=(0,$.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,el=s().div`
  position: relative;
...
`,eb=s().pre`
  ...
  color: ${l.w4.colors.mainTextMuted};
  white-space: pre-wrap;
`;function e$(e){if(e<=0)return 10;let t=Math.pow(10,Math.floor(Math.log10(e)));return Math.ceil(e/t)*t}function ev(e,t,a){let r=Math.max(1,Math.ceil(a/8));return 0!==t&&t!==a-1&&t%r!=0?"":e.length>12?e.slice(0,11)+"…":e}function ek({labels:e,data:t,colors:a}){let o=340,i=176,n=e$(Math.max(...t,1)),s=Math.min(40,o/e.length*.6),d=o/e.length,c=Array.from({length:6},(e,t)=>n/5*t);return(0,r.jsxs)("svg",{viewBox:"0 0 400 240",width:"100%",style:{maxWidth:400},children:[c.map((e,t)=>{let a=16+i-e/n*i;return(0,r.jsxs)("g",{children:[(0,r.jsx)("line",{x1:44,y1:a,x2:384,y2:a,stroke:l.w4.colors.border,strokeWidth:.5,strokeDasharray:0===t?"none":"3,3"}),(0,r.jsx)("text",{x:38,y:a+4,fill:l.w4.colors.mainTextMuted,fontSize:10,textAnchor:"end",fontFamily:l.w4.typography.fontFamily,children:Math.round(e)})]},t)}),t.map((t,o)=>{let c=44+d*o+d/2-s/2,p=t/n*i,h=16+i-p,m=a[o%a.length];return(0,r.jsxs)("g",{children:[(0,r.jsxs)("rect",{x:c,y:h,width:s,height:p,rx:3,fill:m,opacity:.85,children:[(0,r.jsx)("animate",{attributeName:"height",from:"0",to:p,dur:"0.5s",fill:"freeze"}),(0,r.jsx)("animate",{attributeName:"y",from:16+i,to:h,dur:"0.5s",fill:"freeze"})]}),(0,r.jsx)("text",{x:c+s/2,y:h-4,fill:l.w4.colors.mainText,fontSize:10,fontWeight:600,textAnchor:"middle",fontFamily:l.w4.typography.fontFamily,children:t}),(0,r.jsx)("text",{x:44+d*o+d/2,y:208,fill:l.w4.colors.mainTextMuted,fontSize:10,textAnchor:"middle",fontFamily:l.w4.typography.fontFamily,children:ev(e[o],o,e.length)})]},o)})]})}function eM({labels:e,data:t,colors:a}){let o=t.reduce((e,t)=>e+t,0)||1,i=-Math.PI/2,n=t.map((e,t)=>{let n=e/o*Math.PI*2,s=i,d=i+=n,c=120+90*Math.cos(s),p=120+90*Math.sin(s),h=120+90*Math.cos(d),m=120+90*Math.sin(d),g=+(n>Math.PI),f=s+n/2,x=120+58.5*Math.cos(f),u=120+58.5*Math.sin(f),w=Math.round(e/o*100);return(0,r.jsxs)("g",{children:[(0,r.jsx)("path",{d:`M 120 120 L ${c} ${p} A 90 90 0 ${g} 1 ${h} ${m} Z`,fill:a[t%a.length],stroke:l.w4.colors.codeBg,strokeWidth:2,opacity:.85}),w>=5&&(0,r.jsxs)("text",{x:x,y:u+4,fill:"#fff",fontSize:11,fontWeight:600,textAnchor:"middle",fontFamily:l.w4.typography.fontFamily,children:[w,"%"]})]},t)});return(0,r.jsx)("svg",{viewBox:"0 0 240 240",width:"100%",style:{maxWidth:240},children:n})}function ej({labels:e,data:t,colors:a}){let o=340,i=176,n=e$(Math.max(...t,1)),s=t.length>1?o/(t.length-1):o,d=a[0],c=t.map((e,t)=>({x:44+s*t,y:16+i-e/n*i})),p=c.map((e,t)=>`${0===t?"M":"L"} ${e.x} ${e.y}`).join(" "),h=Array.from({length:6},(e,t)=>n/5*t);return(0,r.jsxs)("svg",{viewBox:"0 0 400 240",width:"100%",style:{maxWidth:400},children:[h.map((e,t)=>{let a=16+i-e/n*i;return(0,r.jsxs)("g",{children:[(0,r.jsx)("line",{x1:44,y1:a,x2:384,y2:a,stroke:l.w4.colors.border,strokeWidth:.5,strokeDasharray:0===t?"none":"3,3"}),(0,r.jsx)("text",{x:38,y:a+4,fill:l.w4.colors.mainTextMuted,fontSize:10,textAnchor:"end",fontFamily:l.w4.typography.fontFamily,children:Math.round(e)})]},t)}),(0,r.jsx)("path",{d:p,fill:"none",stroke:d,strokeWidth:2.5,strokeLinecap:"round",strokeLinejoin:"round"}),c.map((a,o)=>(0,r.jsxs)("g",{children:[(0,r.jsx)("circle",{cx:a.x,cy:a.y,r:4,fill:d,stroke:l.w4.colors.codeBg,strokeWidth:2}),(0,r.jsx)("text",{x:a.x,y:a.y-10,fill:l.w4.colors.mainText,fontSize:10,fontWeight:600,textAnchor:"middle",fontFamily:l.w4.typography.fontFamily,children:t[o]}),(0,r.jsx)("text",{x:a.x,y:208,fill:l.w4.colors.mainTextMuted,fontSize:10,textAnchor:"middle",fontFamily:l.w4.typography.fontFamily,children:ev(e[o],o,e.length)})]},o))]})}function ez({code:e}){let t=(0,o.useMemo)(()=>(function(e){let t,a,r=e.trim().split("\n"),o="bar",i=[],n=[];for(let e of r){let[r,...s]=e.split(":"),l=s.join(":").trim();if(l)switch(r.trim().toLowerCase()){case"type":["bar","pie","line"].includes(l.toLowerCase())&&(o=l.toLowerCase());break;case"title":t=l;break;case"labels":i=l.replace(/^\[|\]$/g,"").split(",").map(e=>e.trim()).filter(Boolean);break;case"data":n=l.replace(/^\[|\]$/g,"").split(",").map(e=>e.trim()).filter(Boolean).map(e=>parseFloat(e)||0);break;case"colors":{let e=l.replace(/^\[|\]$/g,"").split(",").map(e=>e.trim()).filter(Boolean);a=e.length?e:void 0}}}return i.length&&n.length?{type:o,title:t,labels:i,data:n,colors:a}:null})(e),[e]);if(!t)return(0,r.jsx)(eb,{children:e.trim()});let a=t.colors??eg;return(0,r.jsxs)(ef,{children:[t.title&&(0,r.jsx)(ex,{children:t.title}),"bar"===t.type&&(0,r.jsx)(ek,{labels:t.labels,data:t.data,colors:a}),"pie"===t.type&&(0,r.jsx)(eM,{labels:t.labels,data:t.data,colors:a}),"line"===t.type&&(0,r.jsx)(ej,{labels:t.labels,data:t.data,colors:a}),(0,r.jsx)(eu,{children:t.labels.map((e,t)=>(0,r.jsxs)(ew,{children:[(0,r.jsx)(ey,{color:a[t%a.length]}),e]},t))})]})}s().div`
  background: ${l.w4.colors.codeBg};
  border: 1px solid ${l.w4.colors.codeBorder};
  border-radius: ${l.w4.borderRadius.md};
  padding: ${l.w4.spacing.lg};
...
`,s().span`
  font-size: ${l.w4.typography.fontSizeBase};
  color: ${l.w4.colors.mainTextMuted};
`;var eS=a(17223),eC=a(21426);let eA=s().div`
  margin: ${l.w4.spacing.lg} 0;
  border-radius: ${l.w4.borderRadius.md};
  border: 1px solid ${l.w4.colors.codeBorder};
  overflow: hidden;
...
`;function eN({type:e,children:t}){let a=eP[e]??eP.NOTE;return(0,r.jsxs)(eB,{bg:a.bg,border:a.border,children:[(0,r.jsxs)(eW,{color:a.color,children:[(0,r.jsx)(M,{name:a.icon,size:15,strokeWidth:2}),a.label]}),(0,r.jsx)(eE,{children:t})]})}s().nav`
  width: 220px;
  min-width: 220px;
...
`;function eV({children:e}){return(0,r.jsx)(eG,{children:(0,r.jsx)(X.oz,{remarkPlugins:[Z.A,ee.A,eK],rehypePlugins:[et.A,ea.A],components:{div({node:e,children:t,...a}){let o=a["data-callout"];return o?(0,r.jsx)(eN,{type:o,children:t}):(0,r.jsx)("div",{...a,children:t})},pre:({children:e})=>(0,r.jsx)(r.Fragment,{children:e}),code({className:e,children:t}){let a=/language-(\w+)/.exec(e??"")?.[1],o=String(t).replace(/\n$/,"");return o.trim()?"mermaid"===a?(0,r.jsx)(em,{code:o}):"chart"===a?(0,r.jsx)(ez,{code:o}):a||o.includes("\n")?(0,r.jsx)(eI,{lang:a,code:o}):(0,r.jsx)("code",{className:e,children:t}):null}},children:e})})}var eq=a(37993);s().nav`
  display: flex;
  flex-direction: column;
  gap: 1px;
  padding: ${l.w4.spacing.sm} 0;
...
`;s().div`
  ...
  pointer-events: none;
  z-index: 200;
  animation: ${eJ} 0.16s cubic-bezier(0.4, 0, 0.2, 1) forwards;
...
`,e5=s().button`
  ...
  &:hover { opacity: 0.88; }
  &:focus-visible { ${l.w4.focusRing} }
`;function e3({open:e,title:t,message:a,confirmLabel:i,cancelLabel:n,onConfirm:s,onCancel:l,danger:d=!1}){return((0,o.useEffect)(()=>{if(!e)return;let t=e=>{"Escape"===e.key&&l(),"Enter"===e.key&&s()};return document.addEventListener("keydown",t),()=>document.removeEventListener("keydown",t)},[e,l,s]),e)?(0,r.jsx)(eZ,{onClick:l,role:"dialog","aria-modal":"true","aria-label":t,children:(0,r.jsxs)(e0,{danger:d,onClick:e=>e.stopPropagation(),children:[(0,r.jsx)(e1,{danger:d,children:t}),(0,r.jsx)(e4,{children:a}),(0,r.jsxs)(e2,{children:[(0,r.jsx)(e5,{onClick:l,children:n}),(0,r.jsx)(e5,{danger:d,primary:!d,onClick:s,autoFocus:!0,children:i})]})]})}):null}let e6=(0,$.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,e8=(0,$.keyframes)`
...
`;s().div`
  ...
  background: ${l.w4.colors.mainBg};
  font-family: ${l.w4.typography.fontFamily};
  animation: ${e6} 0.4s ease 0.15s both;
`,s().div`
  position: relative;
  width: 56px;
  height: 56px;
...
`,s().div`
  position: absolute;
  inset: 0;
  animation: ${e8} 1.4s cubic-bezier(0.4, 0, 0.2, 1) infinite;
...
`,s().div`
  ...
  border-radius: 50%;
  background: ${l.w4.colors.border};
  animation: ${e7} 1.4s ease-in-out infinite;
`,s().span`
  color: ${l.w4.colors.mainTextMuted};
  font-size: ${l.w4.typography.fontSizeSm};
  letter-spacing: 0.04em;
...
`,s().div`
  position: relative;
`;let e9="260px",te="56px",tt="56px",ta=s().header`
  display: flex;
  align-items: center;
  height: calc(${tt} + env(safe-area-inset-top, 0px));
  padding-top: env(safe-area-inset-top, 0px);
  ...
  @media (max-width: ${l.w4.breakpoints.md}) {
    flex-wrap: wrap;
    height: auto;
    min-height: calc(${tt} + env(safe-area-inset-top, 0px));
  }
`,tr=s().div`
  width: ${te};
  min-width: ${te};
...
`,tp=s().div`
  ...
  overflow: hidden;
`,th=s().aside`
  width: ${({collapsed:e})=>e?te:e9};
  min-width: ${({collapsed:e})=>e?te:e9};
  background: ${l.w4.colors.sidebarBg};
  border-right: 1px solid ${l.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,tg=s().main`
  ...
  display: flex;
  flex-direction: column;
`;function tf(){return(0,r.jsxs)(ti,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:[(0,r.jsx)(tn,{"aria-hidden":"true",children:"A"}),(0,r.jsx)(ts,{children:"Atlantis"})]})}let tx="atlantis:sidebar-collapsed";function tu({sidebar:e,children:t,topBarRight:n,title:s="Atlantis",activeId:l=null}){let[d,c]=(0,o.useState)(()=>{try{return"true"===localStorage.getItem(tx)}catch{return!1}}),[p,h]=(0,o.useState)(null),m=(0,o.useRef)(),g=()=>c(e=>{let t=!e;try{localStorage.setItem(tx,String(t))}catch{}return t}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(a.bind(a,45816)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(eq.I.Provider,{value:{collapsed:d,toggle:g,flyout:p,openFlyout:(e,t,a)=>{clearTimeout(m.current),h({entry:e,anchorY:t,onSelect:a})},scheduleFlyoutClose:()=>{m.current=setTimeout(()=>h(null),160)},cancelFlyoutClose:()=>clearTimeout(m.current)},children:(0,r.jsxs)(tp,{children:[(0,r.jsxs)(ta,{children:[e&&(0,r.jsx)(tr,{children:(0,r.jsx)(to,{onClick:g,title:d?"Expand sidebar":"Collapse sidebar",children:(0,r.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,r.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,r.jsx)("path",{d:"M9 3v18"})]})})}),(0,r.jsx)(tf,{}),s&&(0,r.jsx)(tl,{children:s}),n&&(0,r.jsx)(td,{children:n})]}),(0,r.jsxs)(tc,{children:[null!=e&&(0,r.jsx)(th,{collapsed:d,children:(0,r.jsx)(tm,{children:e})}),(0,r.jsx)(tg,{children:t})]}),p&&(0,r.jsx)(i().Suspense,{fallback:null,children:(0,r.jsx)(f,{activeId:l})})]})})}s().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
...
`,s().div`
  flex: 1;
`;let tw={"1m":30,"3m":90,"6m":180,"1y":365};function ty(e,t,a){let r=new Date(a??new Date);return r.setDate(r.getDate()-(t-1-e)),r.toISOString().slice(0,10)}let tb=["#1a2420","#2a4535","#4a7a5a","#6fa77a","#7fb77e"],t$="'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, monospace",tv=["S","T","Q","Q","S","S","D"],tk=["S","M","T","W","T","F","S"];function tM({data:e,cellSize:t=10,gap:a=2,locale:i="pt",tooltip:n,showMonthLabels:s=!1,accent:d,selectedIndex:c,onCellClick:p}){let h=(0,o.useId)();if(!e.length)return null;let m=!!p,g=d??l.w4.colors.accent,f=Math.ceil(e.length/7),x=14*!!s,u=24+f*(t+a),w=x+14+7*(t+a),y=[];if(s&&e.length>0){let r=new Date,o=-1;for(let n=0;n<e.length;n++){let s=Math.floor(n/7);if(0!=n%7)continue;let l=new Date(ty(n,e.length,r)),d=l.getMonth();if(d!==o){o=d;let e=new Intl.DateTimeFormat("pt"===i?"pt-PT":"en-US",{month:"short"}).format(l),r=18+s*(t+a);y.push({label:e.charAt(0).toUpperCase()+e.slice(1),x:r})}}}let b=x+2;return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)("style",{children:`
        @keyframes ${h}_fade { from { opacity: 0; } to { opacity: 1; } }
      `}),(0,r.jsxs)("svg",{viewBox:`0 0 ${u} ${w}`,preserveAspectRatio:"xMidYMid meet",style:{width:"100%",height:"auto",maxHeight:220,display:"block"},"aria-hidden":m?void 0:"true",role:m?"grid":void 0,"aria-label":void 0,children:[s&&(0,r.jsx)("g",{fontFamily:t$,fontSize:"8",fill:l.w4.colors.mainTextMuted,children:y.map(({label:e,x:t},a)=>(0,r.jsx)("text",{x:t,y:10,children:e},a))}),(0,r.jsx)("g",{fontFamily:t$,fontSize:"8",fill:l.w4.colors.mainTextMuted,children:("pt"===i?tv:tk).map((e,o)=>(0,r.jsx)("text",{x:"0",y:b+8+o*(t+a),children:e},o))}),e.map((e,o)=>{let i=18+Math.floor(o/7)*(t+a),s=b+o%7*(t+a),l=tb[Math.max(0,Math.min(4,e))]??tb[0],d=n?.(o,e),f=c===o;return m?(0,r.jsx)("rect",{x:i,y:s,width:t,height:t,fill:l,rx:"1",stroke:f?g:"none",strokeWidth:1.5*!!f,role:"button",tabIndex:0,style:{animation:`${h}_fade 0.3s ease-out ${8*o}ms both`,cursor:"pointer",outline:"none"},onClick:()=>p?.(o,e),onKeyDown:t=>{("Enter"===t.key||" "===t.key)&&(t.preventDefault(),p?.(o,e))},children:d?(0,r.jsx)("title",{children:d}):null},o):(0,r.jsx)("rect",{x:i,y:s,width:t,height:t,fill:l,rx:"1",stroke:f?g:"none",strokeWidth:1.5*!!f,style:{animation:`${h}_fade 0.3s ease-out ${8*o}ms both`},children:d?(0,r.jsx)("title",{children:d}):null},o)})]})]})}let tj=["1m","3m","6m","1y"];function tz({range:e,onChange:t,labels:a}){return(0,r.jsx)("div",{style:{display:"flex",gap:4,flexWrap:"wrap"},children:tj.map(o=>{let i=o===e,n=a?.[o]??o;return(0,r.jsx)("button",{onClick:()=>t(o),style:{height:28,padding:"0 10px",fontSize:11,fontFamily:t$,fontWeight:600,textTransform:"uppercase",letterSpacing:"0.1em",borderRadius:4,border:`1px solid ${i?l.w4.colors.accent:l.w4.colors.border}`,background:i?`${l.w4.colors.accent}18`:"transparent",color:i?l.w4.colors.accent:l.w4.colors.mainTextMuted,cursor:"pointer",transition:"border-color 0.14s ease, color 0.14s ease, background 0.14s ease",outline:"none"},onFocus:e=>{e.currentTarget.style.outline=`2px solid ${l.w4.colors.accent}`,e.currentTarget.style.outlineOffset="2px"},onBlur:e=>{e.currentTarget.style.outline="none"},"aria-pressed":i,children:n},o)})})}},9391(e,t,a){a.d(t,{O:()=>n});var r=a(65723);a(37991);var o=a(63236);let i={sm:20,md:24,lg:28};function n({member:e,size:t="md"}){let a="number"==typeof t?t:i[t];return(0,r.jsx)(o.eu,{member:e,size:a})}},85043(e,t,a){a.d(t,{Y:()=>p});var r=a(65723),o=a(36859),i=a.n(o),n=a(6063);let s=i().div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
`,d().span`
  ...
  flex-shrink: 0;
  text-align: right;
`,a(83090);let c="'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, monospace";function p({data:e,budget:t,height:a=200,animation:r="rise"}){let s=(0,i.useId)();if(!e.length)return null;let l=1.1*Math.max(...e.map(e=>e.segments.reduce((e,t)=>e+t.value,0)+(e.over??0)),t??0)||1,d=472,h=a-20-24,m=472/e.length*.58,g=d/e.length,f="rise"===r?{transformOrigin:"bottom",animation:`${s}_rise 0.45s ease-out both`}:{};return(0,o.jsxs)(o.Fragment,{children:["rise"===r&&(0,o.jsx)("style",{children:`
          @keyframes ${s}_rise {
            from { transform: scaleY(0); }
            to   { transform: scaleY(1); }
          }
        `}),(0,o.jsxs)("svg",{viewBox:`0 0 520 ${a}`,style:{width:"100%",height:a},preserveAspectRatio:"xMidYMid meet","aria-hidden":"true",children:[null!=t?(0,o.jsxs)("g",{children:[(0,o.jsx)("line",{x1:40,x2:40+d,y1:20+h-t/l*h,y2:20+h-t/l*h,stroke:n.w4.colors.border,strokeDasharray:"3 3",strokeWidth:"1"}),(0,o.jsxs)("text",{x:36,y:20+h-t/l*h+3,textAnchor:"end",fontFamily:c,fontSize:"9",fill:n.w4.colors.mainTextMuted,children:["€",t]})]}):null,e.map((e,t)=>{let r,i=40+t*g+(g-m)/2,s=20+h;return(0,o.jsxs)("g",{style:f,children:[e.segments.map(e=>{let t=e.value/l*h;return s-=t,(0,o.jsx)("rect",{x:i,y:s,width:m,height:t,fill:e.color,opacity:.85},e.id)}),null!=e.over&&e.over>0?(r=e.over/l*h,s-=r,(0,o.jsx)("rect",{x:i,y:s,width:m,height:r,fill:"#f85149",opacity:.7},"over")):null,(0,o.jsx)("text",{x:i+m/2,y:a-6,textAnchor:"middle",fontFamily:c,fontSize:"10",fill:n.w4.colors.mainTextMuted,children:e.label})]},e.label)})]})]})}var h=a(63236);function m(e){let t=0;for(let a=1;a<e.length;a++){let r=e[a][0]-e[a-1][0],o=e[a][1]-e[a-1][1];t+=Math.sqrt(r*r+o*o)}return t}function g({spent:e,budget:t,height:a=60}){let r=(0,i.useId)(),s=1.05*t||1,l=Array.from({length:8},(e,a)=>t-t/7*a),d=Math.min(e/(t||1),1),c=Array.from({length:8},(e,a)=>Math.max(0,t-a/7*t*d*1.1)),p=l.map((e,t)=>[320*t/7,a-e/s*(a-5)]),h=c.map((e,t)=>[320*t/7,a-e/s*(a-5)]),f=p.map(e=>e.join(",")).join(" "),x=h.map(e=>e.join(",")).join(" "),u=m(p).toFixed(1),w=m(h).toFixed(1);return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)("style",{children:`
        @keyframes ${r}_i { from { stroke-dashoffset: ${u}; } }
        @keyframes ${r}_a { from { stroke-dashoffset: ${w}; } }
      `}),(0,o.jsxs)("svg",{viewBox:`0 0 320 ${a}`,style:{width:"100%",height:a},preserveAspectRatio:"none","aria-hidden":"true",children:[(0,o.jsx)("line",{x1:"0",x2:320,y1:a-5,y2:a-5,stroke:n.w4.colors.border,strokeDasharray:"3 3",strokeWidth:"1"}),(0,o.jsx)("polyline",{points:f,stroke:n.w4.colors.mainTextMuted,strokeWidth:"1",strokeDasharray:`${u} ${u}`,strokeDashoffset:"0",fill:"none",style:{strokeDasharray:"2 3",animation:`${r}_i 0.45s ease-out both`}}),(0,o.jsx)("polyline",{points:x,stroke:"#7fb77e",strokeWidth:"1.5",strokeDasharray:`${w} ${w}`,strokeDashoffset:"0",fill:"none",strokeLinecap:"round",style:{animation:`${r}_a 0.45s ease-out 0.08s both`}})]})]})}d().div`
  position: relative;
  height: 6px;
