...
`,eb=l().div`
  ...
  padding: 8vh 16px;
  animation: ${eh} ${c.w4.transitions.fast};
`,ex=l().div`
  width: 760px;
  max-width: 100%;
  max-height: 84vh;
  ...
  animation: ${ef} ${c.w4.transitions.base};
  display: flex;
...
`,eC=l().div`
  ...
  gap: 12px;
`,eT=l()("button",{shouldForwardProp:e=>"added"!==e})`
  position: relative;
  display: flex;
  flex-direction: column;
  gap: 8px;
...
`,eD=l()("span",{shouldForwardProp:e=>"swatchColor"!==e})`
  width: 6px;
  height: 6px;
  border-radius: 50%;
...
`,eR=l().div`
  ...
  color: ${c.w4.colors.mainTextMuted};
  font-size: 13px;
`;function eH({open:e,activeIds:t,locale:a,onAdd:r,onRemove:n,onRemoveAll:s,onClose:l}){let d=(0,o.useMemo)(()=>(0,g.Nx)(a,ec),[a]),[c,m]=(0,o.useState)(""),[u,h]=(0,o.useState)("all"),[f,b]=(0,o.useState)(!1),x=(0,o.useRef)(null);(0,o.useEffect)(()=>{e&&(m(""),h("all"),requestAnimationFrame(()=>x.current?.focus()))},[e]),(0,o.useEffect)(()=>{if(!e)return;let t=e=>{"Escape"===e.key&&l()};return document.addEventListener("keydown",t),()=>document.removeEventListener("keydown",t)},[e,l]);let y=(0,o.useMemo)(()=>{let e=c.trim().toLowerCase();return en.filter(t=>{if("all"!==u&&t.suite!==u)return!1;if(!e)return!0;let i="pt"===a?t.labels.pt:t.labels.en,o="pt"===a?t.descriptions.pt:t.descriptions.en;return i.toLowerCase().includes(e)||o.toLowerCase().includes(e)||t.id.toLowerCase().includes(e)||t.suite.toLowerCase().includes(e)})},[c,u,a]);return e?em().createPortal((0,i.jsxs)(eb,{onClick:l,children:[(0,i.jsxs)(ex,{onClick:e=>e.stopPropagation(),role:"dialog","aria-label":d("widgets.picker.title"),children:[(0,i.jsxs)(ey,{children:[(0,i.jsxs)(ew,{children:[(0,i.jsx)(p.YZ,{children:d("widgets.picker.eyebrow")}),(0,i.jsx)(ek,{onClick:l,"aria-label":d("widgets.picker.close"),children:(0,i.jsx)(p.In,{name:"close",size:14,"aria-hidden":"true"})})]}),(0,i.jsx)(ev,{children:d("widgets.picker.title")}),(0,i.jsx)(e$,{children:d("widgets.picker.subtitle")})]}),(0,i.jsxs)(eM,{children:[(0,i.jsx)(p.pd,{ref:x,placeholder:d("widgets.picker.searchPlaceholder"),value:c,onChange:e=>m(e.target.value),before:(0,i.jsx)(p.In,{name:"search",size:14,"aria-hidden":"true"})}),(0,i.jsxs)(ej,{role:"tablist",children:[eg.map(e=>(0,i.jsxs)(ez,{active:u===e.id,chipColor:e.color,onClick:()=>h(e.id),role:"tab","aria-selected":u===e.id,children:[e.color&&(0,i.jsx)("span",{className:"dot"}),d(e.labelKey)]},e.id)),t.size>0&&(0,i.jsxs)(eS,{type:"button",onClick:()=>b(!0),"aria-label":d("widgets.picker.removeAll"),children:[(0,i.jsx)(p.In,{name:"trash",size:12,"aria-hidden":"true"}),d("widgets.picker.removeAll",{n:t.size})]})]})]}),(0,i.jsx)(eC,{children:0===y.length?(0,i.jsx)(eR,{children:d("widgets.picker.empty")}):y.map(e=>{let o=t.has(e.id),s="pt"===a?e.labels.pt:e.labels.en,l="pt"===a?e.descriptions.pt:e.descriptions.en,c=eu[e.suite],m=eg.find(t=>t.id===e.suite);return(0,i.jsxs)(eT,{added:o,onClick:()=>{o?n(e.id):r(e.id)},children:[(0,i.jsxs)(eA,{children:[(0,i.jsx)(eF,{children:e.icon}),(0,i.jsx)(eL,{children:s}),o&&(0,i.jsxs)(eN,{children:[(0,i.jsx)(p.In,{name:"check",size:10,"aria-hidden":"true"}),d("widgets.picker.added")]})]}),(0,i.jsx)(eP,{children:l}),(0,i.jsxs)(eI,{children:[(0,i.jsx)(eD,{swatchColor:c}),m?d(m.labelKey):e.suite]})]},e.id)})})]}),(0,i.jsx)(p.TM,{open:f,title:d("widgets.picker.removeAll",{n:t.size}),message:d("widgets.picker.removeAllConfirm"),confirmLabel:d("widgets.picker.removeAll",{n:t.size}),cancelLabel:d("widgets.picker.close"),danger:!0,onCancel:()=>b(!1),onConfirm:()=>{b(!1),s?s():Array.from(t).forEach(e=>n(e))}})]}),document.body):null}let eE="shell:dashboard-widgets",eK="shell:pending-open-widget-picker",eO=[{id:"w-ask-sessions",widgetId:"ask-sessions"},{id:"w-daily-feed",widgetId:"daily-feed"},{id:"w-techscope",widgetId:"techscope"},{id:"w-weather",widgetId:"weather"},{id:"w-clock",widgetId:"clock"}],eq=(0,d.keyframes)`
  from { opacity: 0; transform: translateY(8px); }
  to { opacity: 1; transform: translateY(0); }
`,eB=l().div`
  margin-bottom: ${c.w4.spacing.xl};
  animation: ${eq} 0.35s ease both;
`,eG=l().div`
  display: flex;
  align-items: center;
  justify-content: space-between;
...
`,e4=l().button`
  ...
  &:focus-visible { ${c.w4.focusRing} }
`,e2=new Set(j.filter(e=>"Developer Toolkit"===e.suite).map(e=>e.id)),e5="pin:";function e3(e){return e.widgetId.startsWith(e5)}function e6(e){return e.widgetId.slice(e5.length)}let e8=new Set(["games","movies","devtools"]);function e7({instance:e,appId:t,meta:a,app:o,idx:r,totalCount:n,tShell:s,recentsOverride:l,onMove:d,onRemove:c,onSelectApp:g}){let u=(0,m.useRecents)(t),h=n>1?(0,i.jsxs)(i.Fragment,{children:[r>0&&(0,i.jsx)(e_,{type:"button",title:s("widgets.moveLeft"),onClick:t=>{t.stopPropagation(),d(e.id,-1)},children:(0,i.jsx)(p.In,{name:"chevron-left",size:13})}),r<n-1&&(0,i.jsx)(e_,{type:"button",title:s("widgets.moveRight"),onClick:t=>{t.stopPropagation(),d(e.id,1)},children:(0,i.jsx)(p.In,{name:"chevron-right",size:13})})]}):void 0;return(0,i.jsx)(p.SV,{vizId:t,label:a.label,description:a.description,hash:o?.hash??a.hash,category:a.category,accentColor:a.color,needsAuth:a.needsAuth,pinned:!0,index:r,onClick:()=>{o?g(o):window.location.hash=a.hash},onHoverIntent:o?()=>x(t):void 0,onTogglePin:()=>c(e.id),reorderControls:h,extra:e8.has(t)?function(e,t,a,o){if(0===e.length)return null;let r=e.slice(0,3);return(0,i.jsxs)(eV,{children:[(0,i.jsx)(eU,{children:a("pinnedCard.recent.label")}),(0,i.jsx)(eJ,{children:r.map(e=>{let a,r,n;return(0,i.jsxs)(eQ,{type:"button",tintColor:e.color??t,title:e.label,onClick:t=>{t.stopPropagation(),window.location.hash=e.hash},children:[(a=function(e){if(e)return C[e.split("?")[0]]??C[e]}(e.hash),r=a?.iconName??e.iconName??o,n=a?.color??e.color??t,r?(0,i.jsx)("span",{className:"glyph","aria-hidden":"true",style:{color:n},children:(0,i.jsx)(p.In,{name:r,size:14})}):e.icon?(0,i.jsx)("span",{className:"glyph","aria-hidden":"true",children:e.icon}):null),(0,i.jsx)("span",{className:"label",children:e.label})]},e.hash)})})]})}(l??u,a.color,s,a.icon):null})}function e9({locale:e,pinnedAppIds:t,recentAppIds:a,apps:r,appMeta:n,onSelectApp:s,onTogglePin:l}){let d=(0,o.useMemo)(()=>(0,g.Nx)(e,ec),[e]),[u,h]=(0,o.useState)([]),[f,b]=(0,o.useState)(!1),[x,y]=(0,o.useState)(!1);(0,o.useEffect)(()=>{let e=()=>{try{sessionStorage.removeItem(eK)}catch{}y(!0)};window.addEventListener("atlantis:open-widget-picker",e);let t=!1;try{t="1"===sessionStorage.getItem(eK)}catch{}if(t){try{sessionStorage.removeItem(eK)}catch{}y(!0)}return()=>window.removeEventListener("atlantis:open-widget-picker",e)},[]),(0,o.useEffect)(()=>{let e=!1;return(async()=>{let t=await (0,c.PL)(eE);if(!e){if(t)try{let e=JSON.parse(t),a=function(e){if(!e.some(e=>"internet-now"===e.widgetId))return e;let t=[];for(let a of e)if("internet-now"===a.widgetId){let e=Date.now();t.push({id:`w-trending-${e}`,widgetId:"trending-searches"},{id:`w-wiki-${e+1}`,widgetId:"wiki-most-read"},{id:`w-hn-${e+2}`,widgetId:"hackernews-hot"})}else t.push(a);return t}(e);h(a),a!==e&&(0,c.Is)(eE,JSON.stringify(a))}catch{h(eO)}else h(eO);b(!0)}})(),()=>{e=!0}},[]),(0,o.useEffect)(()=>{f&&h(e=>{let a=new Set(t),i=new Set(e.filter(e3).map(e6)),o=e.filter(e=>!e3(e)||a.has(e6(e)));for(let e of t)i.has(e)||(o=[...o,{id:`pin-${e}`,widgetId:`${e5}${e}`}]);return o.length!==e.length||o.some((t,a)=>t.id!==e[a]?.id)?((0,c.Is)(eE,JSON.stringify(o)),o):e})},[t,f]);let w=(0,o.useRef)(new Set);(0,o.useEffect)(()=>{if(!f)return;let e=new Set(u.filter(e=>!e3(e)).map(e=>e.widgetId)),t=w.current;for(let a of e){if(t.has(a))continue;let e=es(a);if(e?.notifications?.length){for(let t of e.notifications)m.events.registerCategory({id:t.category,labelKey:t.labelKey??`notifications.source.${t.id}`,badgeColor:e.accentColor??c.w4.colors.mainTextMuted});m.events.registerRules(e.notifications)}}for(let a of t){if(e.has(a))continue;let t=es(a);if(t){if(t.notifications?.length){m.events.unregisterRules(t.notifications.map(e=>e.id));let e=new Set(t.notifications.map(e=>e.category));for(let t of m.events.getItems())e.has(t.category)&&m.events.dismiss(t.id)}for(let e of t.sources.filter(e=>e.cacheKey).map(e=>`widget-cache:${e.cacheKey}`))(0,c.bg)(e);if(t.persistedKeys)for(let e of t.persistedKeys)(0,c.bg)(e);(0,c.jv)(`notifications:${a}:`).then(e=>{for(let t of e)(0,c.bg)(t)}),t.cleanup&&t.cleanup().catch(()=>{})}}w.current=e},[u,f]);let v=(0,o.useCallback)(e=>{h(e),(0,c.Is)(eE,JSON.stringify(e))},[]),k=(0,o.useCallback)(e=>{v([...u,{id:`w-${e}-${Date.now()}`,widgetId:e}])},[u,v]),M=(0,o.useCallback)(e=>{let t=u.find(t=>t.id===e);t&&e3(t)?l(e6(t)):v(u.filter(t=>t.id!==e))},[u,v,l]),j=(0,o.useCallback)(()=>{u.filter(e3).forEach(e=>l(e6(e))),v([])},[u,v,l]),S=(0,o.useCallback)((e,t)=>{let a=u.findIndex(t=>t.id===e);if(a<0)return;let i=a+t;if(i<0||i>=u.length)return;let o=[...u];[o[a],o[i]]=[o[i],o[a]],v(o)},[u,v]),z=(0,o.useCallback)(e=>{let t=u.findIndex(t=>t.id===e);if(t<0)return;let a=u[t];if(e3(a))return;let i=es(a.widgetId);if(!i)return;let o=i.availableSizes??["sm","md","lg"],r=a.size??i.defaultSize,n=o.indexOf(r),s=o[(n+1)%o.length],l=[...u];l[t]={...a,size:s},v(l)},[u,v]),C=(0,o.useMemo)(()=>new Set(u.filter(e=>!e3(e)).map(e=>e.widgetId)),[u]),T=(0,o.useMemo)(()=>new Map,[]);return((0,o.useEffect)(()=>{},[]),f)?(0,i.jsxs)(eB,{children:[(0,i.jsxs)(eG,{children:[(0,i.jsx)(eW,{children:d("widgets.dashboard")}),(0,i.jsxs)(eY,{active:x,onClick:()=>y(!x),children:[(0,i.jsx)(p.In,{name:"plus",size:14}),d("widgets.addWidget")]})]}),(0,i.jsx)(eH,{open:x,activeIds:C,locale:e,onAdd:e=>{k(e)},onRemove:e=>{let t=u.find(t=>!e3(t)&&t.widgetId===e);t&&M(t.id)},onRemoveAll:j,onClose:()=>y(!1)}),0===u.length?(0,i.jsxs)(eX,{children:[(0,i.jsx)(eZ,{children:"✨"}),(0,i.jsx)(e0,{children:d("widgets.empty.title")}),(0,i.jsx)(e1,{children:d("widgets.empty.body")}),(0,i.jsxs)(e4,{onClick:()=>y(!0),children:[(0,i.jsx)(p.In,{name:"plus",size:14}),d("widgets.empty.cta")]})]}):(0,i.jsx)(p.dO,{items:u.flatMap(e=>{if(e3(e))return[{id:e.id,size:"sm",availableSizes:["sm"],minHeight:160}];let t=es(e.widgetId);return t?[{id:e.id,size:e.size??t.defaultSize,availableSizes:t.availableSizes??["sm","md","lg"],minHeight:t.minHeight??160}]:[]}),onReorder:(e,t)=>S(e,t),onCycleSize:e=>z(e),onRemove:e=>M(e),accentColor:e=>{let t=u.find(t=>t.id===e.id);if(!(!t||e3(t)))return es(t.widgetId)?.accentColor},labels:{moveLeft:d("widgets.moveLeft"),moveRight:d("widgets.moveRight"),cycleSize:d("widgets.cycleSize",{size:""}).trim(),remove:d("widgets.remove")},renderPanel:l=>{let c=u.find(e=>e.id===l.id);if(!c)return null;if(e3(c)){let t=e6(c),o="devtools"===t,l=o?{icon:"terminal",label:d("apps.devtools.label"),description:d("apps.devtools.description"),color:"#facc15",category:$("Create",e),hash:"#/playground",needsAuth:!1}:n[t];if(!l)return null;let p=o?null:r.find(e=>e.id===t)??null,m=u.findIndex(e=>e.id===c.id),g=o?a.filter(e=>e2.has(e)).map(e=>{let t=n[e];return{hash:t?.hash??`#/${e}`,label:t?.label??e,iconName:t?.icon,color:t?.color,ts:0}}):void 0;return(0,i.jsx)(e7,{instance:c,appId:t,meta:l,app:p,locale:e,idx:m,totalCount:u.length,tShell:d,recentsOverride:g,onMove:S,onRemove:M,onSelectApp:s})}if("quicklinks"===c.widgetId)return(0,i.jsx)(ed.QuickLinksWidget,{locale:e,pinnedAppIds:t,recentAppIds:a,apps:r,appMeta:n,onSelectApp:s});let p=es(c.widgetId);if(!p)return null;T.has(c.widgetId)||T.set(c.widgetId,(0,o.lazy)(p.load));let m=T.get(c.widgetId);return(0,i.jsx)(o.Suspense,{fallback:null,children:(0,i.jsx)(m,{locale:e})})},showGrip:!1})]}):null}let te={0:"☀️",1:"\uD83C\uDF24️",2:"⛅",3:"☁️",45:"\uD83C\uDF2B️",48:"\uD83C\uDF2B️",51:"\uD83C\uDF26️",53:"\uD83C\uDF26️",55:"\uD83C\uDF27️",61:"\uD83C\uDF27️",63:"\uD83C\uDF27️",65:"\uD83C\uDF27️",71:"\uD83C\uDF28️",73:"\uD83C\uDF28️",75:"\uD83C\uDF28️",80:"\uD83C\uDF26️",81:"\uD83C\uDF27️",82:"\uD83C\uDF27️",95:"⛈️",96:"⛈️",99:"⛈️"},tt={0:"\uD83C\uDF19",1:"\uD83C\uDF19",2:"☁️",3:"☁️"},ta=Object.fromEntries(j.map(e=>[e.id,e.icon])),ti=Object.fromEntries(j.map(e=>[e.id,e.color]));function to(e){return e<10?`0${e}`:String(e)}function tr({locale:e,greeting:t,userName:a,pinnedApps:r,onSelect:n,t:s}){let[l,d]=(0,o.useState)(()=>new Date),{forecast:c}=(0,m.useWeather)({lat:u.j.lisbon.lat,lon:u.j.lisbon.lon,current:"temperature_2m,apparent_temperature,relative_humidity_2m,weather_code,wind_speed_10m,is_day",daily:"temperature_2m_max,temperature_2m_min,sunrise,sunset,uv_index_max",timezone:u.j.lisbon.timezone,cacheKey:"weather-lisbon-v3"});(0,o.useEffect)(()=>{let e=setInterval(()=>d(new Date),3e4);return()=>clearInterval(e)},[]);let g=`${to(l.getHours())} : ${to(l.getMinutes())}`,h=(0,o.useMemo)(()=>{let t,a,i;return t=l.toLocaleDateString("pt"===e?"pt-PT":"en-GB",{weekday:"long"}),a=l.getDate(),i=l.toLocaleDateString("pt"===e?"pt-PT":"en-GB",{month:"long"}),`${t} \xb7 ${a} ${i}`.toUpperCase()},[l,e]),f=r.slice(0,5),b=c?.current?(c.current.is_day?te[c.current.weather_code??0]:tt[c.current.weather_code??0]??te[c.current.weather_code??0])??"\xb7":null;return(0,i.jsxs)(ts,{children:[c?.current&&(0,i.jsxs)(tu,{children:[(0,i.jsx)("span",{className:"ico",children:b}),(0,i.jsxs)("span",{className:"temp",children:[Math.round(c.current.temperature_2m??0),"\xb0"]}),(0,i.jsx)("span",{className:"lbl",children:s("retreat.weather.city")})]}),(0,i.jsxs)(tl,{children:[(0,i.jsx)(td,{children:h}),(0,i.jsxs)(tc,{children:[t,a?(0,i.jsxs)(i.Fragment,{children:[", ",(0,i.jsx)("span",{className:"name",children:a.split(" ")[0]})]}):null,"."]}),(0,i.jsx)(tp,{children:g}),(0,i.jsxs)(tm,{"aria-hidden":!0,children:[(0,i.jsx)("span",{className:"caret",children:"⌘K"}),(0,i.jsx)("span",{className:"txt",children:s("retreat.prompt")})]}),f.length>0&&(0,i.jsx)(tg,{children:f.map((e,t)=>(0,i.jsxs)(th,{onClick:()=>n(e),title:`${t+1} \xb7 ${e.label}`,"aria-label":e.label,children:[(0,i.jsx)("span",{className:"ico",style:{color:ti[e.id]},children:ta[e.id]?(0,i.jsx)(p.In,{name:ta[e.id],size:18,"aria-hidden":"true"}):"\xb7"}),(0,i.jsx)("span",{className:"n",children:t+1})]},e.id))})]})]})}let tn=(0,d.keyframes)`
...
`,tb=l().div`
  ...
  animation: ${tf} 0.25s ${c.w4.transitions.easing} both;
...
`,tz=l().div`
  ...
  color: ${c.w4.colors.mainTextMuted};
  line-height: 1.45;
`;function tC({t:e,onDismiss:t,onOpenPalette:a,onOpenPreferences:o}){let r=[{iconName:"search",titleKey:"onboarding.tip.palette.title",bodyKey:"onboarding.tip.palette.body",kbd:"⌘K",onClick:a},{iconName:"settings",titleKey:"onboarding.tip.preferences.title",bodyKey:"onboarding.tip.preferences.body",onClick:o},{iconName:"check",titleKey:"onboarding.tip.daily.title",bodyKey:"onboarding.tip.daily.body",onClick:()=>{window.location.hash="#/daily"}}];return(0,i.jsxs)(tb,{role:"region","aria-label":e("onboarding.aria"),children:[(0,i.jsxs)(tx,{children:[(0,i.jsxs)(ty,{children:[(0,i.jsx)(p.YZ,{children:e("onboarding.eyebrow")}),(0,i.jsx)(tw,{children:e("onboarding.title")}),(0,i.jsx)(tv,{children:e("onboarding.subtitle")})]}),(0,i.jsx)(t$,{type:"button",title:e("onboarding.dismiss"),"aria-label":e("onboarding.dismiss"),onClick:t,children:(0,i.jsx)(p.In,{name:"close",size:14})})]}),(0,i.jsx)(tk,{children:r.map(t=>(0,i.jsxs)(tM,{type:"button",onClick:t.onClick,disabled:!t.onClick,children:[(0,i.jsx)(tj,{"aria-hidden":!0,children:(0,i.jsx)(p.In,{name:t.iconName,size:18})}),(0,i.jsxs)(tS,{children:[e(t.titleKey),t.kbd&&(0,i.jsx)(p.ue,{children:t.kbd})]}),(0,i.jsx)(tz,{children:e(t.bodyKey)})]},t.titleKey))})]})}let tT=Object.fromEntries(j.map(({id:e,icon:t,labelKey:a,descriptionKey:i,color:o,category:r,suite:n,interest:s,needsAuth:l,hash:d})=>[e,{icon:t,labelKey:a,descriptionKey:i,color:o,category:r,suite:n,interest:s,needsAuth:l,hash:d}])),tA=new Set(j.filter(e=>"default"!==M(e)).map(e=>e.id)),tF=j.filter(e=>e.enabled&&"default"===M(e)),tL=["All","Live","School","Explore","Create","Inspect","Connect","Content","Fun","Lab","Tools"],tN=["Live","AI Lab","Data Studio","Life Dashboard","Learning Hub","Game Room","Entertainment"],tP=tN.filter(e=>tF.some(t=>tT[t.id]?.suite===e));function tI(e,t=new Date){let a=t.getHours();return k(a<12?"greeting.morning":a<19?"greeting.afternoon":"greeting.evening",e)}let tD={0:"☀️",1:"\uD83C\uDF24️",2:"⛅",3:"☁️",45:"\uD83C\uDF2B️",48:"\uD83C\uDF2B️",51:"\uD83C\uDF26️",53:"\uD83C\uDF26️",55:"\uD83C\uDF27️",61:"\uD83C\uDF27️",63:"\uD83C\uDF27️",65:"\uD83C\uDF27️",71:"\uD83C\uDF28️",73:"\uD83C\uDF28️",75:"\uD83C\uDF28️",80:"\uD83C\uDF26️",81:"\uD83C\uDF27️",82:"\uD83C\uDF27️",95:"⛈️",96:"⛈️",99:"⛈️"},tR={0:"\uD83C\uDF19",1:"\uD83C\uDF19",2:"☁️",3:"☁️"},tH=(0,d.keyframes)`
  from { opacity: 0; transform: translateY(8px); }
  to   { opacity: 1; transform: translateY(0); }
`,tE=l().div`
  display: flex;
...
`,tW=l()("nav",{shouldForwardProp:e=>"collapsed"!==e})`
...
`,tY=l()("button",{shouldForwardProp:e=>"collapsed"!==e})`
  display: flex;
  align-items: center;
  justify-content: space-between;
  width: 100%;
...
`,t_=l().span`
  ...
  flex-shrink: 0;
`,tV=l()("div",{shouldForwardProp:e=>"collapsed"!==e})`
  display: grid;
...
`,ai=l().button`
  ...
  &:focus-visible { ${c.w4.focusRing} }
`;function ao({apps:e,recentAppIds:t,pinnedAppIds:a,onTogglePin:r,onMovePinned:n,onSelect:s,user:l,onSignOut:d,onPreferences:h,onClearData:f,onOpenPalette:b,notifications:y}){let v,M,j,[z]=(0,m.useProfile)(),C=(0,o.useMemo)(()=>e.filter(e=>{if(tA.has(e.id))return!1;let t=tT[e.id];return!t||!(0,m.hasInterests)(z)||!t.interest||!!z.interests.includes(t.interest)}),[e,z]),[T,A]=(0,o.useState)("home"),[F,L]=(0,o.useState)("All"),[N,P]=(0,o.useState)(null),[I,D]=(0,o.useState)(()=>new Date),{forecast:R}=(0,m.useWeather)({lat:u.j.lisbon.lat,lon:u.j.lisbon.lon,current:"temperature_2m,apparent_temperature,relative_humidity_2m,weather_code,wind_speed_10m,is_day",daily:"temperature_2m_max,temperature_2m_min,sunrise,sunset,uv_index_max",timezone:u.j.lisbon.timezone,cacheKey:"weather-lisbon-v3"}),[H,E]=(0,o.useState)(!0);(0,o.useEffect)(()=>{let e=!1;return(0,c.PL)("shell:onboarding-dismissed").then(t=>{e||E("true"===t)}).catch(()=>void 0),()=>{e=!0}},[]);let K=(0,o.useCallback)(()=>{E(!0),(0,c.Is)("shell:onboarding-dismissed","true").catch(()=>void 0)},[]);(0,o.useEffect)(()=>{let e=setInterval(()=>D(new Date),6e4),t=()=>{document.hidden||D(new Date)};return document.addEventListener("visibilitychange",t),window.addEventListener("focus",t),()=>{clearInterval(e),document.removeEventListener("visibilitychange",t),window.removeEventListener("focus",t)}},[]);let O=(0,o.useCallback)(()=>{A("home"),L("All"),P(null),(0,c.Is)("shell:home-mode","dashboard")},[]),q=(0,o.useCallback)(()=>{A("retreat"),L("All"),P(null),(0,c.Is)("shell:home-mode","retreat")},[]),B=(0,o.useCallback)(e=>{A("apps"),P(e),L("All")},[]),G=(0,o.useMemo)(()=>({live:"Live",lab:"AI Lab",vida:"Life Dashboard",learn:"Learning Hub",games:"Game Room",ent:"Entertainment"}),[]);(0,o.useEffect)(()=>{let e=()=>{let e=window.location.hash,t=e.indexOf("?");if(t<0)return;let a=new URLSearchParams(e.slice(t+1)).get("suite");if(!a)return;let i=G[a];i&&(A("apps"),P(i),L("All"))};return e(),window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[G]);let[W,Y]=(0,o.useState)(()=>{try{let e=localStorage.getItem("shell:suites-collapsed");return null===e||"true"===e}catch{return!0}}),[_,V]=(0,o.useState)(()=>{try{return"true"===localStorage.getItem("shell:home-sidebar-hidden")}catch{return!1}}),[U]=(0,o.useState)(()=>{try{return"1"===sessionStorage.getItem(eK)}catch{return!1}});(0,o.useEffect)(()=>{let e=!1;return(async()=>{let[t,a,i]=await Promise.all([(0,c.PL)("shell:suites-collapsed"),(0,c.PL)("shell:home-mode"),(0,c.PL)("shell:home-sidebar-hidden")]);if(!e){if(null!==t){Y("true"===t);try{localStorage.setItem("shell:suites-collapsed",t)}catch{}}if(null!==i){V("true"===i);try{localStorage.setItem("shell:home-sidebar-hidden",i)}catch{}}U?(A("home"),(0,c.Is)("shell:home-mode","dashboard").catch(()=>void 0)):"retreat"===a&&A("retreat")}})(),()=>{e=!0}},[U]),(0,o.useEffect)(()=>{let e=()=>{A("home"),L("All"),P(null)};return window.addEventListener("atlantis:open-widget-picker",e),()=>window.removeEventListener("atlantis:open-widget-picker",e)},[]);let J=(0,o.useCallback)(()=>{Y(e=>{let t=!e;try{localStorage.setItem("shell:suites-collapsed",String(t))}catch{}return(0,c.Is)("shell:suites-collapsed",String(t)),t})},[]),Q=(0,o.useCallback)(()=>{V(e=>{let t=!e;try{localStorage.setItem("shell:home-sidebar-hidden",String(t))}catch{}return(0,c.Is)("shell:home-sidebar-hidden",String(t)).catch(()=>void 0),t})},[]),[X,Z]=(0,g.Ym)(),ee=(0,o.useMemo)(()=>(0,g.Nx)(X,ec),[X]),et=(0,o.useMemo)(()=>{let e={};for(let t of C){let a=tT[t.id];a&&(e[t.id]={icon:a.icon,label:ee(a.labelKey),description:ee(a.descriptionKey),color:a.color,category:$(a.category,X),hash:a.hash,needsAuth:!!a.needsAuth})}return e},[C,ee,X]),ea=(0,o.useMemo)(()=>C.filter(e=>{let t=tT[e.id],i="All"===F||t?.category===F,o=!N||t?.suite===N,r="All"===F&&!N&&a.includes(e.id);return i&&o&&!r}),[C,F,N,a]),ei=(0,o.useMemo)(()=>{if("All"!==F)return null;if(N){let e={};for(let t of ea){let a=tT[t.id]?.category??"Other";e[a]||(e[a]=[]),e[a].push(t)}return{type:"category",groups:e}}let e={};for(let t of ea){let a=tT[t.id]?.suite??"Other";e[a]||(e[a]=[]),e[a].push(t)}return{type:"suite",groups:e}},[ea,F,N]),eo=(0,o.useMemo)(()=>{let e={};for(let t of C){let a=tT[t.id]?.suite;a&&(e[a]=(e[a]??0)+1)}return e["AI Lab"]=(e["AI Lab"]??0)+1,e},[C]),er=(0,o.useMemo)(()=>a.flatMap(e=>C.filter(t=>t.id===e)),[a,C]),en=(0,o.useMemo)(()=>t.filter(e=>!a.includes(e)).flatMap(e=>C.filter(t=>t.id===e)).slice(0,6),[t,a,C]),es=0,el=(e,t,o)=>{let l=tT[e.id],d=a.includes(e.id),m=l?ee(l.descriptionKey):"",g=l?.color??c.w4.colors.accent,u=l?$(l.category,X):"",h=o&&o.total>1?(0,i.jsxs)(i.Fragment,{children:[o.pinIdx>0&&(0,i.jsx)(t9,{type:"button",title:ee("pinned.moveLeft"),onClick:t=>{t.stopPropagation(),n(e.id,-1)},children:(0,i.jsx)(p.In,{name:"chevron-left",size:13})}),o.pinIdx<o.total-1&&(0,i.jsx)(t9,{type:"button",title:ee("pinned.moveRight"),onClick:t=>{t.stopPropagation(),n(e.id,1)},children:(0,i.jsx)(p.In,{name:"chevron-right",size:13})})]}):void 0;return(0,i.jsx)(p.SV,{vizId:e.id,label:e.label,description:m,hash:l?.hash??e.hash,category:u,accentColor:g,needsAuth:l?.needsAuth,pinned:d,index:t,onClick:()=>s(e),onHoverIntent:()=>x(e.id),onTogglePin:()=>r(e.id),reorderControls:h},e.id)},ed=e=>{let t=a.includes("devtools");return(0,i.jsx)(p.SV,{vizId:"devtools",label:ee("apps.devtools.label"),description:ee("apps.devtools.description"),hash:"#/playground",category:$("Create",X),accentColor:"#facc15",pinned:t,index:e,onClick:()=>{window.location.hash="#/playground"},onHoverIntent:()=>x("playground"),onTogglePin:()=>r("devtools")})};return(0,i.jsx)(i.Fragment,{children:(0,i.jsxs)(tE,{children:[(0,i.jsxs)(tK,{children:[(0,i.jsx)(tq,{children:(0,i.jsx)(p.K0,{onClick:Q,title:_?ee("sidebar.show"):ee("sidebar.hide"),"aria-label":_?ee("sidebar.show"):ee("sidebar.hide"),"aria-pressed":_,children:(0,i.jsx)(p.In,{name:"panel-left",size:16})})}),(0,i.jsxs)(tO,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:[(0,i.jsx)("span",{children:"Atl"}),(0,i.jsx)("span",{className:"logo-accent",children:"antis"})]}),(0,i.jsx)(tB,{children:(0,i.jsx)(p.Yw,{locale:X,onLocaleChange:Z,notifications:y,onOpenPalette:b,paletteLabel:ee("palette.search"),user:l?{name:l.name,email:l.email,avatarUrl:l.avatarUrl}:void 0,userMenuItems:l?[...h?[{label:ee("userMenu.preferences"),icon:(0,i.jsx)(p.In,{name:"user-cog",size:14}),onClick:h}]:[],{label:ee("userMenu.settings"),icon:(0,i.jsx)(p.In,{name:"settings",size:14}),onClick:()=>{window.location.hash="#/settings"}},...f?[{label:ee("userMenu.clearData"),icon:(0,i.jsx)(p.In,{name:"trash",size:14}),onClick:f,danger:!0}]:[],...d?[{label:ee("userMenu.signOut"),icon:(0,i.jsx)(p.In,{name:"log-out",size:14}),onClick:d,danger:!0}]:[]]:[],userMenuControlLabels:{language:ee("userMenu.language"),theme:ee("userMenu.theme"),themeLight:ee("userMenu.themeLight"),themeDark:ee("userMenu.themeDark"),themeSystem:ee("userMenu.themeSystem")},onSignIn:()=>{window.location.hash="#/home"}})})]}),(0,i.jsxs)(tG,{children:[(0,i.jsxs)(tW,{collapsed:_,children:[(0,i.jsx)(tQ,{active:"home"===T,onClick:O,children:(0,i.jsxs)("span",{style:{display:"flex",alignItems:"center",gap:"8px"},children:[(0,i.jsx)(p.In,{name:"home",size:14}),ee("sidebar.home")]})}),(0,i.jsx)(tQ,{active:"retreat"===T,onClick:q,children:(0,i.jsxs)("span",{style:{display:"flex",alignItems:"center",gap:"8px"},children:[(0,i.jsx)(p.In,{name:"moon",size:14}),ee("sidebar.retreat")]})}),(0,i.jsx)(tZ,{}),tP.length>0&&(0,i.jsxs)(i.Fragment,{children:[W?(0,i.jsx)(tJ,{type:"button",onClick:J,children:ee("sidebar.showSuites")}):(0,i.jsxs)(i.Fragment,{children:[(0,i.jsxs)(tY,{onClick:J,children:[k("suites",X),(0,i.jsx)(t_,{collapsed:W,children:(0,i.jsx)(p.In,{name:"chevron-down",size:14})})]}),(0,i.jsx)(tV,{collapsed:W,children:(0,i.jsx)(tU,{children:tP.map(e=>{let t,a=(t=S.find(t=>t.yamlSuite===e))?{icon:t.icon,color:t.color}:void 0,o="apps"===T&&N===e;return(0,i.jsxs)(tQ,{active:o,onClick:()=>B(e),children:[a&&(0,i.jsx)("span",{style:{display:"inline-flex",color:o?c.w4.colors.accent:a.color,flexShrink:0},children:(0,i.jsx)(p.In,{name:a.icon,size:16,"aria-hidden":"true"})}),(0,i.jsx)("span",{style:{flex:1,textAlign:"left"},children:w[e]?.[X]??e}),(0,i.jsx)(tX,{active:o,children:eo[e]??0})]},e)})})})]}),(0,i.jsx)(tZ,{})]})]}),(0,i.jsx)(t0,{bleed:"retreat"===T,children:"retreat"===T?(0,i.jsx)(tr,{locale:X,greeting:tI(X,I),userName:l?.name,pinnedApps:er,onSelect:s,t:ee}):(0,i.jsxs)(i.Fragment,{children:[(0,i.jsxs)(t1,{children:[(0,i.jsxs)(t4,{children:[(0,i.jsx)(t2,{children:(v=I.toLocaleDateString("pt"===X?"pt-PT":"en-GB",{weekday:"long"}),M=I.getDate(),j=I.toLocaleDateString("pt"===X?"pt-PT":"en-GB",{month:"long"}),`${v} \xb7 ${M} ${j}`.toUpperCase())}),R?.current&&(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(t5,{children:"\xb7"}),(0,i.jsxs)(t3,{children:[(0,i.jsx)("span",{className:"ico",children:(R.current.is_day?tD[R.current.weather_code??0]:tR[R.current.weather_code??0]??tD[R.current.weather_code??0])??"\xb7"}),(0,i.jsxs)("span",{className:"temp",children:[Math.round(R.current.temperature_2m??0),"\xb0"]}),(0,i.jsx)("span",{className:"lbl",children:k("home.weather.city",X)})]})]})]}),(0,i.jsxs)(t6,{children:[tI(X,I),l?.name?(0,i.jsxs)(i.Fragment,{children:[", ",(0,i.jsx)("span",{className:"accent",children:l.name.split(" ")[0]})]}):null,"."]})]}),"home"===T&&!H&&0===er.length&&0===en.length&&(0,i.jsx)(tC,{t:ee,onDismiss:K,onOpenPalette:b,onOpenPreferences:h}),"home"===T&&(0,i.jsx)(e9,{locale:X,pinnedAppIds:a,recentAppIds:t,apps:C,appMeta:et,onSelectApp:s,onTogglePin:r}),"apps"===T&&(0,i.jsxs)(i.Fragment,{children:[0===ea.length&&(null!==N||"All"!==F||(0,m.hasInterests)(z))&&(0,i.jsxs)(ae,{children:[(0,i.jsx)(at,{children:k("home.emptyFiltered.title",X)}),(0,i.jsx)(aa,{children:k("home.emptyFiltered.desc",X)}),(0,i.jsxs)("div",{style:{display:"flex",gap:c.w4.spacing.sm},children:[(null!==N||"All"!==F)&&(0,i.jsx)(ai,{type:"button",onClick:()=>{P(null),L("All")},style:{background:"transparent",color:c.w4.colors.accent,border:`1px solid ${c.w4.colors.border}`},children:k("home.emptyFiltered.clear",X)}),h&&(0,i.jsx)(ai,{type:"button",onClick:h,children:k("home.emptyFiltered.cta",X)})]})]}),"All"===F&&!N&&er.length>0&&(0,i.jsxs)("div",{children:[(0,i.jsx)(t8,{children:k("pinned",X)}),(0,i.jsx)(t7,{children:er.map((e,t)=>el(e,es++,{pinIdx:t,total:er.length}))})]}),"All"===F&&!N&&en.length>0&&(0,i.jsxs)("div",{children:[(0,i.jsx)(t8,{children:k("recentlyUsed",X)}),(0,i.jsx)(t7,{children:en.map(e=>el(e,es++))})]}),ei?[..."suite"===ei.type?tN:tL.slice(1),"Other"].filter(e=>ei.groups[e]?.length>0).map(e=>(0,i.jsxs)("div",{children:[(0,i.jsx)(t8,{children:"suite"===ei.type?w[e]?.[X]??e:$(e,X)}),(0,i.jsxs)(t7,{children:[ei.groups[e].map(e=>el(e,es++)),("suite"===ei.type&&"AI Lab"===e||"category"===ei.type&&"Lab"===e)&&ed(es++)]})]},e)):(0,i.jsxs)(t7,{children:[ea.map(e=>el(e,es++)),"Lab"===F&&ed(es++)]})]})]})})]})]})})}let ar=(0,a(82791).U)("https://eqvzakschpdemcgexjyy.supabase.co","sb_publishable_D_UOsNIA7qD3929ZzReWLw_k8d8MxWL");function an(){return ar.auth.signInWithOAuth({provider:"google",options:{redirectTo:window.location.origin}})}function as(){return ar.auth.signOut()}let al=(0,d.keyframes)`
...
`,ah=()=>(0,i.jsxs)("svg",{width:"18",height:"18",viewBox:"0 0 48 48",children:[(0,i.jsx)("path",{fill:"#EA4335",d:"M24 9.5c3.14 0 5.95 1.08 8.17 2.86l6.1-6.1C34.46 3.19 29.53 1 24 1 14.82 1 7.07 6.48 3.88 14.22l7.1 5.52C12.68 13.55 17.9 9.5 24 9.5z"}),(0,i.jsx)("path",{fill:"#4285F4",d:"M46.52 24.5c0-1.64-.15-3.22-.42-4.75H24v9h12.67c-.55 2.94-2.18 5.44-4.65 7.12l7.19 5.59C43.39 37.48 46.52 31.47 46.52 24.5z"}),(0,i.jsx)("path",{fill:"#FBBC05",d:"M10.98 28.26A14.57 14.57 0 0 1 9.5 24c0-1.48.25-2.91.68-4.26l-7.1-5.52A23.93 23.93 0 0 0 .5 24c0 3.87.93 7.52 2.58 10.74l7.9-6.48z"}),(0,i.jsx)("path",{fill:"#34A853",d:"M24 47c5.52 0 10.15-1.83 13.53-4.97l-7.19-5.59C28.47 37.82 26.36 38.5 24 38.5c-6.1 0-11.32-4.05-13.02-9.74l-7.9 6.48C6.07 42.54 14.45 47 24 47z"})]}),af=l().button`
  background: none;
  border: none;
  color: ${c.w4.colors.mainTextMuted};
  font-family: ${c.w4.typography.fontFamily};
...
`,aE=l().div`
  ...
  justify-content: center;
  padding-top: 10vh;
  animation: ${aR} ${c.w4.transitions.fast};
...
`,aK=l().div`
  ...
  overflow: hidden;
  box-shadow: ${c.w4.elevation.lg};
  animation: ${aH} ${c.w4.transitions.base};
  font-family: ${c.w4.typography.fontFamily};
  color: ${c.w4.colors.mainText};
  display: flex;
  flex-direction: column;
...
`,aU=l().span`
  ...
  font-size: 11px;
  color: ${c.w4.colors.mainTextFaint};
`,aJ=l()("div",{shouldForwardProp:e=>"selected"!==e})`
  display: flex;
  align-items: center;
  gap: 14px;
  padding: 10px 22px;
...
`,aQ=l()("div",{shouldForwardProp:e=>"tintColor"!==e&&"selected"!==e})`
  width: 36px;
  height: 36px;
  border-radius: 9px;
  display: flex;
...
`,aZ=l().div`
  ...
  background: transparent;
  flex-shrink: 0;
`,a0=l()("div",{shouldForwardProp:e=>"tintColor"!==e})`
  width: 36px;
  height: 36px;
  border-radius: 9px;
  display: flex;
...
`,a1=l().div`
  flex: 1;
  min-width: 0;
`,a4=l()("div",{shouldForwardProp:e=>"selected"!==e})`
  font-size: 14px;
  font-weight: 500;
...
`,im=l().span`
  ...
  font-size: 11px;
  color: ${c.w4.colors.mainTextMuted};
`;function ig(e,t){if(!t)return!0;let a=t.toLowerCase();return e.label.toLowerCase().includes(a)||(e.meta?.toLowerCase().includes(a)??!1)}function iu({apps:e,recentIds:t,suites:a=[],games:n=[],actions:s=[],hasAsk:l=!1,groqKey:d,locale:u,initialScope:h,onNavigate:f,onClose:b}){let x=(0,o.useMemo)(()=>(0,g.Nx)(u,ec),[u]),[y,w]=(0,o.useState)(""),[v,$]=(0,o.useState)(()=>"ask"!==h||l?h??"all":"all"),[k,M]=(0,o.useState)(0),[j,S]=(0,o.useState)([]),[z,C]=(0,o.useState)(!1),T=(0,o.useRef)([]),A=(0,o.useRef)(null),F=(0,o.useRef)(null),L=(0,o.useRef)(null),N=(0,o.useRef)(null),[P,I]=(0,o.useState)([]),D=(0,o.useRef)(null);(0,o.useEffect)(()=>{if("ask"!==v)return(null!==D.current&&clearTimeout(D.current),y.trim())?(D.current=setTimeout(()=>{aI(y).then(I)},200),()=>{null!==D.current&&clearTimeout(D.current)}):void I([])},[y,v]),(0,o.useEffect)(()=>(A.current?.focus(),()=>{N.current?.abort()}),[]),(0,o.useEffect)(()=>{T.current=j},[j]),(0,o.useEffect)(()=>{L.current?.scrollIntoView({behavior:"smooth"})},[j,z]);let R=(0,o.useMemo)(()=>{let i=new Set(t),o=e.map(e=>({id:`app:${e.id}`,kind:"app",label:e.label,meta:e.description,isRecent:i.has(e.id),appIcon:{iconName:e.icon,color:e.color},onConfirm:()=>{f(e.hash),b()}}));return[...a.map(e=>({id:`suite:${e.id}`,kind:"suite",label:e.name,meta:e.sub,glyphIcon:{iconName:e.iconName,color:e.color},shortcut:e.shortcut,onConfirm:()=>{e.onConfirm(),b()}})),...o,...n.map(e=>({id:`game:${e.id}`,kind:"game",label:e.name,meta:x("palette.meta.game"),gameGlyph:{iconName:e.iconName,color:e.color},hash:e.hash,onConfirm:()=>{f(e.hash),b()}})),...s.map(e=>({id:`action:${e.id}`,kind:"action",label:e.label,meta:e.meta,glyphIcon:{iconName:e.iconName,color:e.color??c.w4.colors.accent},shortcut:e.shortcut,onConfirm:()=>{e.onClick(),b()}}))]},[e,a,n,s,t,f,b,x]),H=(0,o.useMemo)(()=>P.map(e=>({id:e.id,kind:"action",label:e.label,meta:e.subtitle,glyphIcon:e.iconName?{iconName:e.iconName,color:c.w4.colors.mainTextMuted}:void 0,hash:e.hash,onConfirm:()=>{f(e.hash),b()}})),[P,f,b]),E=(0,o.useMemo)(()=>{if("ask"===v)return[];let e=R.filter(e=>ig(e,y)),a=[],i=(e,t,i)=>{if(0!==i.length)for(let o of(a.push({kind:"header",label:x(t),key:e,count:i.length}),i))a.push({kind:"item",item:o})};return"recent"===v?i("recent","palette.recent",R.filter(e=>"app"===e.kind&&e.isRecent&&ig(e,y)).sort((e,a)=>t.indexOf(e.id.slice(4))-t.indexOf(a.id.slice(4)))):"jump"===v?(i("suites","palette.section.suites",e.filter(e=>"suite"===e.kind)),i("apps","palette.section.apps",e.filter(e=>"app"===e.kind)),i("games","palette.section.games",e.filter(e=>"game"===e.kind))):"actions"===v?(i("actions","palette.section.actions",e.filter(e=>"action"===e.kind)),i("content","palette.section.content",H)):(i("jump","palette.section.jump",e.filter(e=>"suite"===e.kind||"app"===e.kind||"game"===e.kind)),i("actions","palette.section.actions",e.filter(e=>"action"===e.kind)),i("content","palette.section.content",H),l&&d&&i("ask","palette.section.ask",aD.map((e,t)=>({id:`suggest:${t}`,kind:"suggest",label:x(e),meta:x("palette.ask.suggestMeta"),shortcut:["↵"],onConfirm:()=>{$("ask"),setTimeout(()=>{O(x(e))},0)}})))),a},[v,y,R,t,x,l,d,H]),K=(0,o.useMemo)(()=>E.filter(e=>"item"===e.kind),[E]);(0,o.useEffect)(()=>{M(0)},[v,y]),(0,o.useEffect)(()=>{let e=F.current;if(!e)return;let t=e.querySelectorAll("[data-selectable]");t[k]?.scrollIntoView({block:"nearest"})},[k]);let O=(0,o.useCallback)(async e=>{if(!d||!e.trim())return;let t=e.trim(),a=`turn-${Date.now()}`;S(e=>[...e,{id:a,question:t}]),C(!0),w("");let i=[];for(let e of T.current)e.answer&&(i.push({role:"user",content:e.question}),i.push({role:"assistant",content:e.answer}));N.current?.abort();let o=new AbortController;N.current=o;try{let e=await (0,m.askGroq)(t,{key:d,locale:"pt"===u?"pt":"en",signal:o.signal,history:i});o.signal.aborted||S(t=>t.map(t=>t.id===a?{...t,answer:e}:t))}catch(t){if(o.signal.aborted)return;let e=t instanceof Error?t.message:String(t);S(t=>t.map(t=>t.id===a?{...t,error:e}:t))}finally{o.signal.aborted||C(!1)}},[d,u]),q=(0,o.useCallback)(e=>{if("Escape"===e.key){if("ask"===v&&y.trim())return void w("");if("ask"===v&&j.length>0){N.current?.abort(),C(!1),S([]);return}return void b()}if("ask"===v){"Enter"===e.key&&y.trim()&&(e.preventDefault(),O(y.trim()));return}if("ArrowDown"===e.key)e.preventDefault(),M(e=>Math.min(e+1,K.length-1));else if("ArrowUp"===e.key)e.preventDefault(),M(e=>Math.max(e-1,0));else if("Enter"===e.key){let e=K[k];e&&e.item.onConfirm()}},[v,y,j.length,K,k,b,O]),B=(0,o.useCallback)(e=>{e.target===e.currentTarget&&b()},[b]),G="ask"===v?j.length>0?x("palette.ask.followUp"):x("palette.ask.placeholder"):x("palette.placeholder"),W=(0,o.useMemo)(()=>{let e=[{value:"all",label:x("palette.scope.all")},{value:"jump",label:x("palette.scope.jump")},{value:"actions",label:x("palette.scope.actions")}];return l&&d&&e.push({value:"ask",label:x("palette.scope.ask"),highlight:!0}),e.push({value:"recent",label:x("palette.scope.recent")}),e},[x,l,d]),Y=-1;return em().createPortal((0,i.jsx)(aE,{onClick:B,children:(0,i.jsxs)(aK,{onClick:e=>e.stopPropagation(),children:[(0,i.jsxs)(aO,{children:[(0,i.jsx)(aq,{active:"ask"===v,children:(0,i.jsx)(p.In,{name:"ask"===v?"sparkle":"search",size:20,"aria-hidden":"true"})}),(0,i.jsx)(aB,{ref:A,placeholder:G,value:y,onChange:e=>w(e.target.value),onKeyDown:q,"aria-label":x("palette.search")}),(0,i.jsx)(aG,{children:"esc"})]}),(0,i.jsx)(aW,{children:(0,i.jsx)(p.tU,{tabs:W,value:v,onChange:$,"aria-label":x("palette.scope.ariaLabel")})}),"ask"===v?(0,i.jsx)(a8,{children:0!==j.length||z?(0,i.jsxs)(ia,{children:[j.map(e=>(0,i.jsxs)(r().Fragment,{children:[(0,i.jsxs)(ii,{children:[(0,i.jsx)(io,{children:x("palette.ask.you")}),(0,i.jsx)(ir,{children:e.question})]}),(0,i.jsxs)(ii,{children:[(0,i.jsx)(io,{children:x("palette.ask.atlantis")}),void 0!==e.answer?(0,i.jsx)(p.mQ,{children:e.answer}):void 0!==e.error?(0,i.jsx)(id,{children:e.error}):(0,i.jsxs)(il,{"aria-label":x("palette.ask.thinking"),children:[(0,i.jsx)("span",{}),(0,i.jsx)("span",{}),(0,i.jsx)("span",{})]})]})]},e.id)),(0,i.jsx)("div",{ref:L})]}):(0,i.jsxs)(a7,{children:[(0,i.jsx)(a9,{children:x("palette.ask.suggestionsTitle")}),(0,i.jsx)(ie,{children:aD.map(e=>(0,i.jsx)(it,{onClick:()=>{O(x(e))},type:"button",children:x(e)},e))}),(0,i.jsx)(a9,{style:{marginTop:4},children:x("palette.ask.hint")})]})}):(0,i.jsx)(aY,{ref:F,children:0===K.length?(0,i.jsxs)(ic,{children:[(0,i.jsx)("div",{className:"icon",children:(0,i.jsx)(p.In,{name:"search",size:16,"aria-hidden":"true"})}),(0,i.jsxs)("div",{className:"title",children:[x("palette.noMatch")," ",y&&(0,i.jsxs)("span",{className:"query",children:["“",y,"”"]})]}),(0,i.jsx)("div",{className:"hint",children:x("palette.emptyHint")})]}):E.map((e,t)=>{if("header"===e.kind)return(0,i.jsxs)(a_,{children:[(0,i.jsx)(aV,{children:e.label}),(0,i.jsx)(aU,{children:e.count})]},`h-${e.key}`);let a=Y+=1,o=a===k,r=e.item;return(0,i.jsxs)(aJ,{selected:o,"data-selectable":!0,onMouseEnter:()=>M(a),onClick:()=>r.onConfirm(),children:[r.appIcon&&(0,i.jsx)(aQ,{tintColor:r.appIcon.color,selected:o,children:(0,i.jsx)(p.In,{name:r.appIcon.iconName,size:18,"aria-hidden":"true",color:r.appIcon.color})}),r.glyphIcon&&(0,i.jsx)(aX,{tintColor:r.glyphIcon.color,children:(0,i.jsx)(p.In,{name:r.glyphIcon.iconName,size:18,"aria-hidden":"true"})}),r.gameGlyph&&(0,i.jsx)(a0,{tintColor:r.gameGlyph.color,children:(0,i.jsx)(p.In,{name:r.gameGlyph.iconName,size:18,"aria-hidden":"true",color:r.gameGlyph.color})}),"suggest"===r.kind&&(0,i.jsx)(aZ,{children:(0,i.jsx)(p.In,{name:"sparkle",size:18,"aria-hidden":"true"})}),(0,i.jsxs)(a1,{children:[(0,i.jsx)(a4,{selected:o,children:r.label}),r.meta&&(0,i.jsx)(a2,{children:r.meta})]}),r.hash&&(0,i.jsx)(a5,{children:r.hash}),r.shortcut&&r.shortcut.length>0&&(0,i.jsx)(a3,{children:r.shortcut.map((e,t)=>(0,i.jsx)(a6,{children:e},t))})]},r.id+"-"+t)})}),(0,i.jsx)(ip,{children:"ask"===v?(0,i.jsxs)(i.Fragment,{children:[(0,i.jsxs)(im,{children:[(0,i.jsx)(a6,{children:"↵"}),x("palette.hint.ask")]}),(0,i.jsxs)(im,{children:[(0,i.jsx)(a6,{children:"esc"}),x("palette.hint.close")]})]}):(0,i.jsxs)(i.Fragment,{children:[(0,i.jsxs)(im,{children:[(0,i.jsx)(a6,{children:"↑"}),(0,i.jsx)(a6,{children:"↓"}),x("palette.hint.navigate")]}),(0,i.jsxs)(im,{children:[(0,i.jsx)(a6,{children:"↵"}),x("palette.hint.open")]}),(0,i.jsxs)(im,{children:[(0,i.jsx)(a6,{children:"esc"}),x("palette.hint.close")]})]})})]})}),document.body)}let ih="shell:cmdk-hint-dismissed",ib=(0,d.keyframes)`
  from { opacity: 0; transform: translateY(6px); }
  to   { opacity: 1; transform: translateY(0); }
`,ix=l().div`
  position: fixed;
  ...
  overflow: hidden;
  animation: ${ib} 0.25s ${c.w4.transitions.easing} both;
  animation-delay: 1s;
  transition:
    border-color ${c.w4.transitions.fast},
    transform ${c.w4.transitions.fast};
...
`,iw=l().button`
  ...
  &:hover { color: ${c.w4.colors.mainText}; }
  &:focus-visible { ${c.w4.focusRing} }
`;function iv({onOpenPalette:e,t}){let[a,r]=(0,o.useState)(()=>{try{return"1"===localStorage.getItem(ih)}catch{return!1}});return((0,o.useEffect)(()=>{let e=e=>{e.key===ih&&r("1"===e.newValue)};return window.addEventListener("storage",e),()=>window.removeEventListener("storage",e)},[]),a)?null:em().createPortal((0,i.jsxs)(ix,{children:[(0,i.jsxs)(iy,{type:"button","aria-label":t("cmdk.hint.aria"),onClick:e,children:[(0,i.jsx)(p.ue,{children:"⌘K"}),(0,i.jsx)("span",{className:"hint-label",children:t("cmdk.hint.label")})]}),(0,i.jsx)(iw,{type:"button",className:"dismiss","aria-label":t("cmdk.hint.dismiss"),title:t("cmdk.hint.dismiss"),onClick:e=>{e.stopPropagation();try{localStorage.setItem(ih,"1")}catch{}r(!0)},children:"\xd7"})]}),document.body)}var i$=a(16137);let ik=(0,d.keyframes)`
...
`,oi=[{id:"groq",label:"Groq",placeholder:"gsk_...",help:"Used by Prompt Lab and Image Gen (enhance)",linkUrl:"https://console.groq.com/keys",linkLabel:"Get key"},{id:"gemini",label:"Google Gemini",placeholder:"AIza...",help:"Used by Prompt Lab",linkUrl:"https://aistudio.google.com/apikey",linkLabel:"Get key"},{id:"finnhub",label:"Finnhub",placeholder:"pk_...",help:"Stock quotes for the Markets widget",linkUrl:"https://finnhub.io/dashboard",linkLabel:"Get key"},{id:"tmdb",label:"TMDB (The Movie Database)",placeholder:"eyJhbGci...",help:"Movies & Series app — Read Access Token (v4 auth)",linkUrl:"https://www.themoviedb.org/settings/api",linkLabel:"Get key"},{id:"youtube",label:"YouTube Data API v3",placeholder:"AIza...",help:"YouTube Safe Feed app — free quota, no billing required",linkUrl:"https://console.cloud.google.com/apis/credentials",linkLabel:"Get key"}],oo="atlantis:api-keys",or="atlantis:promptlab:keys",on=[{widgetId:"shell",ruleId:"sync.error",labelKey:"notifications.source.syncError",defaultEnabled:!0},{widgetId:"shell",ruleId:"daily.achievement",labelKey:"notifications.source.dailyAchievement",defaultEnabled:!0},{widgetId:"shell",ruleId:"finance.budget",labelKey:"notifications.source.financeBudget",defaultEnabled:!0}],os={groq:"",gemini:"",finnhub:"",tmdb:"",youtube:""};function ol(e,t){return`notifications:${e}:${t}:enabled`}function od({lang:e}){let[t,a]=(0,o.useState)(os),[r,n]=(0,o.useState)({}),[s,l]=(0,o.useState)(!1),[d,u]=(0,o.useState)(!1),[h,f]=(0,o.useState)({}),[b,x]=(0,o.useState)([]),[y,w]=(0,o.useState)({muteAll:!1,windows:[]}),[v,$]=(0,o.useState)([]),k=(0,o.useMemo)(()=>(0,g.Nx)(e,ec),[e]),M="pt"===e;(0,o.useEffect)(()=>{let e=function(){try{let e=localStorage.getItem(oo);if(e)return{...os,...JSON.parse(e)};let t=localStorage.getItem(or);if(t)return{...os,...JSON.parse(t)}}catch{}return{...os}}();a(e),(0,c.PL)(oo).then(t=>{if(t)try{let i={...os,...JSON.parse(t)},o={groq:e.groq||i.groq,gemini:e.gemini||i.gemini,finnhub:e.finnhub||i.finnhub,tmdb:e.tmdb||i.tmdb,youtube:e.youtube||i.youtube};a(o)}catch{}}),(0,m.loadSchedule)().then(e=>w(e)),(0,c.PL)("shell:dashboard-widgets").then(async e=>{let t=[];try{e&&(t=JSON.parse(e))}catch{}let a=new Set(t.map(e=>e.widgetId)),i=en.filter(e=>a.has(e.id)&&e.notifications&&e.notifications.length>0);x(i);let o=i.flatMap(e=>(e.notifications??[]).map(e=>e.category)),r=on.map(e=>e.ruleId),n=new Set,s=[];for(let e of[...o,...r])n.has(e)||(n.add(e),s.push(e));$(s);let l={};await Promise.all(i.flatMap(e=>(e.notifications??[]).map(async t=>{let a=ol(e.id,t.id),i=await (0,c.PL)(a),o=!1!==t.defaultEnabled;l[`${e.id}:${t.id}`]=null===i?o:"false"!==i}))),await Promise.all(on.map(async e=>{let t=ol(e.widgetId,e.ruleId),a=await (0,c.PL)(t);l[`${e.widgetId}:${e.ruleId}`]=null===a?e.defaultEnabled:"false"!==a})),f(l)})},[]);let j=(0,o.useCallback)((e,t)=>{a(a=>({...a,[e]:t})),u(!0),l(!1)},[]),S=(0,o.useCallback)(e=>{a(t=>({...t,[e]:""})),u(!0),l(!1)},[]),z=(0,o.useCallback)(()=>{let e;e=JSON.stringify(t),localStorage.setItem(oo,e),localStorage.setItem(or,e),(0,c.Is)(oo,e),window.dispatchEvent(new CustomEvent("atlantis:api-keys-changed")),u(!1),l(!0),setTimeout(()=>l(!1),2500)},[t]),C=(0,o.useCallback)((e,t,a)=>{let i=`${e}:${t}`;f(e=>({...e,[i]:a})),(0,c.Is)(ol(e,t),a?"true":"false")},[]),T=(0,o.useCallback)(e=>{let t={...y,muteAll:e};w(t),(0,m.saveSchedule)(t)},[y]),A=(0,o.useCallback)(()=>{let e={...y,windows:[...y.windows,{categoryId:"*",start:"22:00",end:"08:00"}]};w(e),(0,m.saveSchedule)(e)},[y]),F=(0,o.useCallback)(e=>{let t={...y,windows:y.windows.filter((t,a)=>a!==e)};w(t),(0,m.saveSchedule)(t)},[y]),L=(0,o.useCallback)((e,t)=>{let a={...y,windows:y.windows.map((a,i)=>i===e?{...a,...t}:a)};w(a),(0,m.saveSchedule)(a)},[y]),N=(0,o.useCallback)(e=>{if("*"===e)return k("notifications.settings.quietHours.global");for(let t of b)for(let a of t.notifications??[])if(a.category===e&&a.labelKey)return k(a.labelKey);for(let t of on)if(t.ruleId===e)return k(t.labelKey);return e},[k,b]);return(0,i.jsx)(iM,{children:(0,i.jsxs)(ij,{children:[(0,i.jsxs)(iS,{children:[(0,i.jsx)(iz,{children:M?"Defini\xe7\xf5es":"Settings"}),(0,i.jsx)(iC,{children:M?"Gere as tuas chaves de API para os servi\xe7os de IA. As chaves s\xe3o guardadas no teu browser e sincronizadas com a tua conta.":"Manage your API keys for AI services. Keys are stored in your browser and synced with your account."})]}),(0,i.jsxs)(iT,{children:[(0,i.jsxs)(iA,{children:[(0,i.jsx)(p.In,{name:"key",size:16}),M?"Chaves de API":"API Keys"]}),(0,i.jsx)(iF,{children:M?"Estas chaves s\xe3o usadas pelo Prompt Lab e Image Gen. Cada servi\xe7o tem um plano gratuito.":"These keys are used by Prompt Lab and Image Gen. Each service has a free tier."}),oi.map(e=>{let a=t[e.id],o=r[e.id]??!1;return(0,i.jsxs)(iL,{children:[(0,i.jsxs)(iN,{children:[e.label,(0,i.jsx)(iP,{active:!!a,children:a?M?"ativa":"active":M?"vazia":"empty"}),(0,i.jsxs)(iI,{children:["— ",e.help]})]}),(0,i.jsxs)(iD,{children:[(0,i.jsxs)(iR,{children:[(0,i.jsx)(iH,{type:o?"text":"password",value:a,onChange:t=>j(e.id,t.target.value),placeholder:e.placeholder,spellCheck:!1,autoComplete:"off"}),(0,i.jsx)(iE,{onClick:()=>n(t=>({...t,[e.id]:!o})),title:o?"Hide":"Show",children:o?(0,i.jsx)(p.In,{name:"eye-off",size:13}):(0,i.jsx)(p.In,{name:"eye",size:13})})]}),(0,i.jsx)(iK,{danger:!0,onClick:()=>S(e.id),title:M?"Limpar":"Clear",children:(0,i.jsx)(p.In,{name:"trash",size:13})}),(0,i.jsx)("a",{href:e.linkUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:(0,i.jsx)(iK,{title:e.linkLabel,children:(0,i.jsx)(p.In,{name:"external-link",size:13})})})]})]},e.id)}),(0,i.jsxs)(iO,{children:[s?(0,i.jsx)(iB,{children:M?"✓ Guardado":"✓ Saved"}):(0,i.jsx)("span",{}),(0,i.jsxs)(iq,{onClick:z,disabled:!d,children:[(0,i.jsx)(p.In,{name:"save",size:13}),M?"Guardar":"Save"]})]})]}),(0,i.jsxs)(iT,{children:[(0,i.jsxs)(iA,{children:[(0,i.jsx)(p.In,{name:"bell",size:16}),k("notifications.settings.title")]}),(0,i.jsx)(iF,{children:k("notifications.settings.desc")}),(0,i.jsxs)(iZ,{children:[(0,i.jsxs)(i0,{children:[(0,i.jsx)(i1,{children:k("notifications.settings.muteAll")}),(0,i.jsx)(i4,{children:k("notifications.settings.muteAll.desc")})]}),(0,i.jsxs)(iQ,{checked:y.muteAll,onClick:()=>T(!y.muteAll),title:k("notifications.settings.muteAll"),children:[(0,i.jsx)("input",{type:"checkbox",checked:y.muteAll,onChange:()=>{},"aria-label":k("notifications.settings.muteAll")}),(0,i.jsx)("span",{className:"track"}),(0,i.jsx)("span",{className:"thumb"})]})]}),0===b.length?(0,i.jsx)(iX,{style:{marginTop:"16px"},children:k("notifications.settings.noWidgets")}):b.map(t=>(0,i.jsxs)(iW,{children:[(0,i.jsxs)(iY,{children:[(0,i.jsx)(i_,{children:t.icon}),(0,i.jsx)(iV,{children:"pt"===e?t.labels.pt:t.labels.en})]}),(t.notifications??[]).map(e=>{let a=`${t.id}:${e.id}`,o=!1!==e.defaultEnabled,r=h[a]??o,n=e.labelKey?k(e.labelKey):e.category;return(0,i.jsxs)(iU,{children:[(0,i.jsx)(iJ,{className:"rule-label",children:n}),(0,i.jsxs)(iQ,{checked:r,onClick:()=>C(t.id,e.id,!r),title:k("notifications.settings.enable"),children:[(0,i.jsx)("input",{type:"checkbox",checked:r,onChange:()=>{},"aria-label":n}),(0,i.jsx)("span",{className:"track"}),(0,i.jsx)("span",{className:"thumb"})]})]},e.id)})]},t.id)),(0,i.jsxs)(iW,{style:{marginTop:"12px"},children:[(0,i.jsxs)(iY,{children:[(0,i.jsx)(i_,{children:"\uD83D\uDD14"}),(0,i.jsx)(iV,{children:k("notifications.settings.shell.title")})]}),(0,i.jsx)("div",{style:{fontSize:"11px",fontFamily:c.w4.typography.fontFamilyMono,color:c.w4.colors.mainTextMuted,marginBottom:"4px"},children:k("notifications.settings.shell.desc")}),on.map(e=>{let t=h[`${e.widgetId}:${e.ruleId}`]??e.defaultEnabled,a=k(e.labelKey);return(0,i.jsxs)(iU,{children:[(0,i.jsx)(iJ,{className:"rule-label",children:a}),(0,i.jsxs)(iQ,{checked:t,onClick:()=>C(e.widgetId,e.ruleId,!t),title:k("notifications.settings.enable"),children:[(0,i.jsx)("input",{type:"checkbox",checked:t,onChange:()=>{},"aria-label":a}),(0,i.jsx)("span",{className:"track"}),(0,i.jsx)("span",{className:"thumb"})]})]},e.ruleId)})]}),(0,i.jsxs)(i2,{children:[(0,i.jsx)(i5,{children:k("notifications.settings.quietHours")}),(0,i.jsx)(i3,{children:k("notifications.settings.quietHours.desc")}),y.windows.map((e,t)=>(0,i.jsxs)(i6,{children:[(0,i.jsxs)(i9,{value:e.categoryId,onChange:e=>L(t,{categoryId:e.target.value}),"aria-label":k("notifications.settings.quietHours.category"),children:[(0,i.jsx)("option",{value:"*",children:k("notifications.settings.quietHours.global")}),v.map(e=>(0,i.jsx)("option",{value:e,children:N(e)},e))]}),(0,i.jsxs)(oe,{children:[(0,i.jsx)("input",{type:"checkbox",checked:e.allDay??!1,onChange:e=>L(t,{allDay:e.target.checked})}),k("notifications.settings.quietHours.allDay")]}),!e.allDay&&(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(i8,{children:k("notifications.settings.quietHours.from")}),(0,i.jsx)(i7,{type:"time",value:e.start,onChange:e=>L(t,{start:e.target.value})}),(0,i.jsx)(i8,{children:k("notifications.settings.quietHours.to")}),(0,i.jsx)(i7,{type:"time",value:e.end,onChange:e=>L(t,{end:e.target.value})})]}),(0,i.jsx)(oa,{type:"button",title:k("notifications.settings.quietHours.remove"),onClick:()=>F(t),children:(0,i.jsx)(p.In,{name:"close",size:13})})]},t)),(0,i.jsxs)(ot,{type:"button",onClick:A,children:[(0,i.jsx)(p.In,{name:"plus",size:13}),k("notifications.settings.quietHours.add")]})]})]}),(0,i.jsxs)(iG,{children:[(0,i.jsx)(p.In,{name:"shield",size:14,style:{flexShrink:0,marginTop:2}}),(0,i.jsx)("span",{children:M?"As chaves s\xe3o enviadas diretamente do teu browser para o servi\xe7o de IA — nunca passam pelos nossos servidores. Podes remov\xea-las a qualquer momento.":"Keys are sent directly from your browser to the AI provider — they never pass through our servers. You can remove them at any time."})]})]})})}let oc=(0,d.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,op=(0,d.keyframes)`
...
`;function oS({open:e,onClose:t,locale:a}){let[r,n]=(0,m.useProfile)(),[s,l]=(0,o.useState)(r),d=(0,o.useMemo)(()=>(0,g.Nx)("pt"===a?"pt":"en",ec),[a]);if((0,o.useEffect)(()=>{e&&l(r)},[e,r]),(0,o.useEffect)(()=>{if(!e)return;let a=e=>{"Escape"===e.key&&t()};return window.addEventListener("keydown",a),()=>window.removeEventListener("keydown",a)},[e,t]),!e)return null;let u=async()=>{let e=s.ageMode!==r.ageMode||s.interests.length!==r.interests.length||s.interests.some(e=>!r.interests.includes(e));await n(s),t(),e&&(await (0,c.sW)("widget-cache:"),window.location.reload())},h="pt"===a?m.INTEREST_LABELS_PT:m.INTEREST_LABELS_EN,f="pt"===a?m.AGE_MODE_LABELS_PT:m.AGE_MODE_LABELS_EN;return em().createPortal((0,i.jsx)(om,{onClick:e=>{e.target===e.currentTarget&&t()},children:(0,i.jsxs)(og,{role:"dialog","aria-modal":"true","aria-labelledby":"profile-title",children:[(0,i.jsxs)(ou,{children:[(0,i.jsx)(oh,{id:"profile-title",children:d("profile.title")}),(0,i.jsx)(of,{onClick:t,"aria-label":d("profile.close"),children:(0,i.jsx)(p.In,{name:"close",size:16})})]}),(0,i.jsxs)(ob,{children:[(0,i.jsxs)(ox,{children:[(0,i.jsx)(oy,{children:d("profile.interests")}),(0,i.jsx)(ow,{children:d("profile.interestsHint")}),(0,i.jsx)(ov,{children:m.ALL_INTERESTS.map(e=>(0,i.jsx)(o$,{active:s.interests.includes(e),onClick:()=>{l(t=>({...t,interests:t.interests.includes(e)?t.interests.filter(t=>t!==e):[...t.interests,e]}))},"aria-pressed":s.interests.includes(e),children:h[e]},e))})]}),(0,i.jsxs)(ox,{children:[(0,i.jsx)(oy,{children:d("profile.ageMode")}),(0,i.jsx)(ow,{children:d("profile.ageModeHint")}),(0,i.jsx)(ov,{children:["kid","teen","adult"].map(e=>(0,i.jsx)(o$,{active:s.ageMode===e,onClick:()=>{l(t=>({...t,ageMode:e}))},"aria-pressed":s.ageMode===e,children:f[e]},e))})]})]}),(0,i.jsxs)(ok,{children:[(0,i.jsx)(oM,{onClick:t,children:d("profile.cancel")}),(0,i.jsx)(oj,{onClick:u,children:d("profile.save")})]})]})}),document.body)}var oz=a(68360);let oC=(0,d.keyframes)`
  from { opacity: 0; transform: translateY(-6px); }
  to   { opacity: 1; transform: translateY(0); }
`,oT=l().div`
  position: fixed;
...
`,oW=l().span`
  ...
  text-align: right;
  white-space: nowrap;
`;function oY({locale:e,state:t,anchor:a}){let r=(0,o.useMemo)(()=>(0,g.Nx)(e,ec),[e]),{open:n,close:s,items:l,markAllRead:d,dismiss:u}=t;if(!n||!a)return null;let h=Math.round(a.bottom+8),f=Math.max(12,Math.round(window.innerWidth-a.right)),b=()=>{s(),window.location.hash="#/daily"};return em().createPortal((0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(oT,{onClick:s}),(0,i.jsxs)(oA,{style:{top:h,right:f},role:"dialog","aria-label":r("notifications.title"),children:[(0,i.jsxs)(oF,{children:[(0,i.jsx)(oL,{children:r("notifications.title")}),(0,i.jsx)(oN,{onClick:d,disabled:0===l.length,children:r("notifications.markAllRead")})]}),(0,i.jsx)(oP,{children:0===l.length?(0,i.jsx)(oq,{children:r("notifications.empty")}):l.slice(0,5).map(e=>{let t=m.defaultStore.getCategory(e.category)?.badgeColor??c.w4.colors.mainTextMuted,a=m.defaultStore.getCategory(e.category)?.labelKey,o=a?r(a):e.category;if("daily.overdue"===e.category){let a=e.meta,n=a?.count??0,s=(a?.missions??[]).slice(0,4),l=1===n?r("notifications.daily.group.one"):r("notifications.daily.group.many",{count:n});return(0,i.jsxs)(oD,{children:[(0,i.jsxs)(oR,{as:"button",type:"button",onClick:b,children:[(0,i.jsxs)(oE,{color:t,children:[(0,i.jsx)("span",{className:"dot"}),o,(0,i.jsx)("span",{className:"time",children:(0,oz.e)(e.ts)})]}),(0,i.jsxs)(oK,{children:[(0,i.jsx)(oO,{children:s.map(e=>(0,p.n6)(e.emoji)?(0,i.jsx)(p.In,{name:e.emoji,size:14,style:{color:e.color??t}},e.id):(0,i.jsx)("span",{children:e.emoji},e.id))}),l]})]}),(0,i.jsx)(oH,{type:"button",className:"dismiss","aria-label":r("notifications.dismiss"),title:r("notifications.dismiss"),onClick:t=>{t.stopPropagation(),u(e.id)},children:"\xd7"})]},e.id)}if("finance.digest.weekly"===e.category){let a=e.meta,n=a?.spend??0,l=a?.budget??0,d=a?.topCategories??[],c=a?.members??[],p=a?.pendingReimbursables??0,m=a?.weekKey??"";return(0,i.jsxs)(oD,{children:[(0,i.jsxs)(oR,{href:"#/finance",onClick:()=>{s(),u(e.id)},children:[(0,i.jsxs)(oE,{color:t,children:[(0,i.jsx)("span",{className:"dot"}),o,(0,i.jsx)("span",{className:"time",children:m})]}),(0,i.jsx)(oK,{children:r("notifications.finance.digest.title")}),(0,i.jsxs)(oB,{children:[(0,i.jsx)(oG,{children:r("notifications.finance.digest.spend")}),(0,i.jsxs)(oW,{children:["€",n.toFixed(2)]}),(0,i.jsx)(oG,{children:r("notifications.finance.digest.budget")}),(0,i.jsxs)(oW,{children:["€",l.toFixed(2)]}),d.length>0&&(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(oG,{children:r("notifications.finance.digest.topCategories")}),(0,i.jsx)(oW,{children:d.map(e=>`€${e.total.toFixed(0)}`).join(" \xb7 ")})]}),c.length>0&&(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(oG,{children:r("notifications.finance.digest.members")}),(0,i.jsx)(oW,{children:c.map(e=>`€${e.total.toFixed(0)}`).join(" \xb7 ")})]}),p>0&&(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(oG,{children:r("notifications.finance.digest.pending")}),(0,i.jsx)(oW,{children:p})]})]})]}),(0,i.jsx)(oH,{type:"button",className:"dismiss","aria-label":r("notifications.dismiss"),title:r("notifications.dismiss"),onClick:t=>{t.stopPropagation(),u(e.id)},children:"\xd7"})]},e.id)}let n=e.link?{href:e.link,target:"_blank",rel:"noopener noreferrer",onClick:()=>{u(e.id)}}:{as:"button",type:"button",onClick:()=>{u(e.id)}};return(0,i.jsxs)(oD,{children:[(0,i.jsxs)(oR,{...n,children:[(0,i.jsxs)(oE,{color:t,children:[(0,i.jsx)("span",{className:"dot"}),o,(0,i.jsx)("span",{className:"time",children:(0,g.aw)(new Date(e.ts).toISOString(),r)})]}),(0,i.jsx)(oK,{children:e.title})]}),(0,i.jsx)(oH,{type:"button",className:"dismiss","aria-label":r("notifications.dismiss"),title:r("notifications.dismiss"),onClick:t=>{t.stopPropagation(),u(e.id)},children:"\xd7"})]},e.id)})}),l.length>0&&(0,i.jsxs)(oI,{type:"button",onClick:()=>{s(),window.location.hash="#/notifications"},children:[(0,i.jsx)("span",{children:r("notifications.seeAll")}),(0,i.jsx)("span",{className:"count",children:l.length>5?`+${l.length-5}`:l.length})]})]})]}),document.body)}let o_=(0,d.keyframes)`
...
`;function o8({locale:e}){let t=(0,o.useMemo)(()=>(0,g.Nx)(e,ec),[e]),a=(0,m.useRegisteredCategories)(),{items:r,byCategory:n}=(0,m.useEvents)({channels:a}),s=(0,o.useMemo)(()=>{let e=new Map;for(let t of a){let a=n[t];a&&a.length>0&&e.set(t,a)}return e},[n,a]),l=(0,o.useCallback)(()=>{m.defaultStore.markAllRead()},[]),d=(0,o.useCallback)(e=>{m.defaultStore.dismiss(e)},[]),p=(0,o.useCallback)(()=>{window.location.hash="#/home"},[]);return(0,i.jsxs)(oV,{children:[(0,i.jsxs)(oU,{children:[(0,i.jsx)(oJ,{children:t("notifications.page.title")}),(0,i.jsx)(oQ,{children:t("notifications.page.subtitle")}),(0,i.jsxs)(oX,{children:[(0,i.jsxs)(oZ,{onClick:p,children:["← ",t("error.remote.goHome")]}),(0,i.jsx)(oZ,{onClick:l,disabled:0===r.length,children:t("notifications.markAllRead")})]})]}),0===r.length?(0,i.jsx)(o0,{children:t("notifications.empty")}):Array.from(s.entries()).map(([e,a])=>{let o;return(0,i.jsxs)("section",{children:[(0,i.jsx)(o1,{children:(o=m.defaultStore.getCategory(e),o?.labelKey?t(o.labelKey):e)}),a.map(a=>{let o=m.defaultStore.getCategory(e)?.badgeColor??c.w4.colors.mainTextMuted;return(0,i.jsxs)(o4,{color:o,children:[(0,i.jsxs)(o2,{href:a.link,target:a.link?"_blank":void 0,rel:a.link?"noopener noreferrer":void 0,children:[(0,i.jsx)(o5,{children:a.title}),(0,i.jsx)(o3,{children:(0,g.aw)(new Date(a.ts).toISOString(),t)})]}),(0,i.jsx)(o6,{type:"button","aria-label":t("notifications.dismiss"),title:t("notifications.dismiss"),onClick:()=>d(a.id),children:"\xd7"})]},a.id)})]},e)})]})}m.events.registerCategory({id:"sync.error",labelKey:"notifications.source.syncError",badgeColor:c.w4.colors.danger}),m.events.registerCategory({id:"daily.achievement",labelKey:"notifications.source.dailyAchievement",badgeColor:"#fb923c"}),m.events.registerCategory({id:"finance.budget",labelKey:"notifications.source.financeBudget",badgeColor:c.w4.colors.warning}),m.events.registerCategory({id:"finance.bills",labelKey:"notifications.source.financeBills",badgeColor:"#fb923c"}),m.events.registerRules([m.billsRule]),m.events.registerCategory({id:"weather.pt.forecast",labelKey:"notifications.source.weatherForecast",badgeColor:"#3b82f6"}),m.events.registerRules([m.ipmaForecastDetailRule]),(0,m.loadSchedule)();{let e=new Map;(0,i$.subscribeRequests)(t=>{if(!t.host)return;if(t.ok)return void e.delete(t.host);let a=(e.get(t.host)??0)+1;if(e.set(t.host,a),3===a){let e=new Date().toISOString().slice(0,10);m.events.push({id:`sync.error:${t.host}:${e}`,category:"sync.error",ts:t.ts,title:`${t.host} — ${t.error??"failed"}`,meta:{host:t.host,status:t.status}})}})}let o7={movies:e=>({apiKey:e.tmdbKey}),youtube:e=>({apiKey:e.youtubeKey}),games:e=>({isAuthenticated:!!e.user})},o9=l().div`
...
`,ra=l().span`
  ...
  flex-shrink: 0;
  animation: ${re} 2s ease-in-out infinite;
`,ri={techscope:9,weather:1,citypulse:1};function ro({count:e}){return(0,i.jsxs)(rt,{title:`${e} live ${1===e?"feed":"feeds"}`,children:[(0,i.jsx)(ra,{}),e,(0,i.jsx)("span",{style:{opacity:.65,fontSize:10},children:"LIVE"})]})}let rr=l().div`
  flex: 1;
  display: flex;
  flex-direction: column;
  align-items: center;
...
`;function rc({name:e,error:t,topBarRight:a,onRetry:r}){let[n]=(0,g.Ym)(),s=(0,o.useMemo)(()=>(0,g.Nx)(n,ec),[n]),l=t.message??"",d=l.startsWith("REMOTE_LOAD_FAILED:"),p=d?l.slice(19):e,m=`apps.${p}.label`,u=s(m),h=u&&u!==m?u:p;return(0,i.jsx)(c.PE,{title:h,sidebar:null,topBarRight:a,children:(0,i.jsxs)(rr,{children:[(0,i.jsx)(rn,{children:"⚠"}),(0,i.jsx)(rs,{children:s("error.remote.title",{name:h})}),(0,i.jsx)(rl,{children:s(d?"error.remote.prodHint":"error.remote.generic")}),d&&!1,(0,i.jsxs)("div",{style:{display:"flex",gap:c.w4.spacing.sm},children:[(0,i.jsx)(rd,{onClick:r,children:s("error.remote.retry")}),(0,i.jsx)(rd,{onClick:()=>{window.location.hash="#/home"},children:s("error.remote.goHome")})]})]})})}class rp extends r().Component{static getDerivedStateFromError(e){return{error:e}}componentDidCatch(e){console.error(`[RemoteErrorBoundary] "${this.props.name}" threw:`,e)}componentDidUpdate(e){e.name!==this.props.name&&this.state.error&&this.setState({error:null})}render(){return this.state.error?(0,i.jsx)(rc,{name:this.props.name,error:this.state.error,topBarRight:this.props.topBarRight,onRetry:()=>this.setState({error:null})}):this.props.children}constructor(...e){super(...e),function(e,t,a){t in e?Object.defineProperty(e,t,{value:a,enumerable:!0,configurable:!0,writable:!0}):e[t]=a}(this,"state",{error:null})}}let rm=(()=>{let e={settings:"settings"};for(let t of j)for(let a of(e[t.hash.replace(/^#\//,"")]=t.id,t.hashAliases??[]))e[a]=t.id;return e})();function rg(e){let t=e.replace(/^#\/?/,"");if(!t||"home"===t)return"home";let a=t.split("/")[0].split("?")[0];return"notifications"===a?"notifications":rm[a]??"home"}let ru="shell:recent",rh="shell:pinned",rf="shell:last-app";function rb(){let e=window.location.hash;if(!e||"#"===e||"#/"===e)try{let e=localStorage.getItem(rf);if(e&&"home"!==e&&f[e]){let t=j.find(t=>t.id===e);if(t)return history.replaceState(null,"",t.hash),e}}catch{}return rg(e)}function rx(e){try{return JSON.parse(e??"[]")}catch{return[]}}let ry=new Set(j.filter(e=>e.needsAuth).map(e=>e.id)),rw="true"===process.env.MOCK_USER?{id:"mock-user",email:"dev@atlantis.local",user_metadata:{full_name:"Dev User",avatar_url:""}}:null,rv=process.env.YOUTUBE_API_KEY||"",r$=document.getElementById("root");if(!r$)throw Error("Root element #root not found");(0,n.createRoot)(r$).render((0,i.jsx)(function(){let e,[t,a]=(0,o.useState)(rb),[r,n]=(0,o.useState)([]),[s,l]=(0,o.useState)([]),[d,u]=(0,o.useState)(rw),[h,b]=(0,o.useState)(!!rw),[x,y]=(0,o.useState)(!1),[w,v]=(0,o.useState)(void 0),[$,k]=(0,o.useState)(!1),[C,T]=(0,o.useState)(!1),[A,F]=(0,g.Ym)(),L=(0,o.useMemo)(()=>(0,g.Nx)(A,ec),[A]),N=function(e={}){let t=(0,m.useRegisteredCategories)(),a=(0,m.useEventBell)({channels:t}),[i,r]=(0,o.useState)(!1),n=(0,o.useRef)(null),s=(0,o.useRef)(e.formatDailyReminder);(0,o.useEffect)(()=>{s.current=e.formatDailyReminder},[e.formatDailyReminder]),(0,o.useEffect)(()=>{let e=()=>{m.defaultStore.refresh()};window.addEventListener("focus",e);let t=m.dailyStore.subscribe(e);return()=>{window.removeEventListener("focus",e),t()}},[]),(0,o.useEffect)(()=>{if("u"<typeof window||!("Notification"in window)||"granted"!==Notification.permission)return;let e=a.items.find(e=>"daily.overdue"===e.category),t=(0,m.todayISO)();if(!e||n.current===t)return;let i=e.meta,o=i?.missions?.[0],r=o?s.current?.(o):void 0;if(r){n.current=t;try{new Notification(r.title,{body:r.body,tag:`atlantis-daily-${t}`,icon:"/manifest-icon.png"})}catch{}}},[a.items]);let l=(0,o.useCallback)(()=>r(e=>!e),[]),d=(0,o.useCallback)(()=>r(!1),[]);return{...a,open:i,toggle:l,close:d}}({formatDailyReminder:(0,o.useCallback)(e=>{let t=(0,m.missionLabel)(e,A),a=e.emoji?`${e.emoji} ${t}`.trim():t;return{title:L("notifications.source.daily"),body:L("notifications.daily.body",{time:e.time??"",name:a})}},[L,A])}),[P,I]=(0,o.useState)(null);(0,o.useEffect)(()=>{if(rw){m.session.setUser(rw),(0,m.resolveApiKeys)().then(e=>m.session.setApiKeys(e));return}ar.auth.getSession().then(({data:e})=>{let t=e.session?.user??null;u(t),(0,c.Fm)(t?ax:null),m.session.setUser(t),(0,m.resolveApiKeys)().then(e=>m.session.setApiKeys(e)),b(!0)});let{data:{subscription:e}}=ar.auth.onAuthStateChange((e,t)=>{let a=t?.user??null;u(a),(0,c.Fm)(a?ax:null),m.session.setUser(a),(0,m.resolveApiKeys)().then(e=>m.session.setApiKeys(e))});return()=>e.unsubscribe()},[]),(0,o.useEffect)(()=>{let e=()=>{(0,m.resolveApiKeys)().then(e=>m.session.setApiKeys(e))};return window.addEventListener("atlantis:api-keys-changed",e),()=>window.removeEventListener("atlantis:api-keys-changed",e)},[]),(0,o.useEffect)(()=>{m.session.setLocale(A)},[A]),(0,o.useEffect)(()=>{(0,c.PL)(ru).then(e=>n(rx(e))),(0,c.PL)(rh).then(e=>l(rx(e)))},[]),(0,o.useEffect)(()=>{let e=e=>{(e.metaKey||e.ctrlKey)&&"k"===e.key&&(e.preventDefault(),v(void 0),y(e=>!e))};return window.addEventListener("keydown",e),()=>window.removeEventListener("keydown",e)},[]),(0,o.useEffect)(()=>{let e=e=>{let t=e.detail;v(t?.scope),y(!0)};return window.addEventListener("atlantis:open-palette",e),()=>window.removeEventListener("atlantis:open-palette",e)},[]),(0,o.useEffect)(()=>{let e=()=>a(rg(window.location.hash));return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[]),(0,o.useEffect)(()=>{if(t&&"home"!==t){try{localStorage.setItem(rf,t)}catch{}n(e=>{let a=[t,...e.filter(e=>e!==t)].slice(0,8);return(0,c.Is)(ru,JSON.stringify(a)),a})}},[t]);let D=(0,o.useCallback)(e=>{window.location.hash=e,y(!1),v(void 0)},[]),R=(0,o.useCallback)(e=>{window.location.hash=`#/home?suite=${encodeURIComponent(e)}`},[]),[H]=(0,m.useProfile)(),E=(0,o.useMemo)(()=>j.filter(e=>e.flag?(0,m.resolveFlag)(e.flag):e.enabled).filter(e=>"hidden"!==M(e)).filter(e=>!(0,m.hasInterests)(H)||!e.interest||H.interests.includes(e.interest)),[H]),K=(0,o.useMemo)(()=>{let e=z.map(e=>({id:e.id,name:L(e.labelKey),iconName:e.iconName,hash:e.hash,accentColor:e.color,onClick:()=>{window.location.hash=e.hash}}));return S.map(t=>{let a=E.filter(e=>e.suite===t.yamlSuite),i="games"===t.id;return{id:t.id,name:L(t.nameKey),subtitle:L(t.subKey),color:t.color,icon:t.icon,count:i?z.length:a.length,onClick:i?void 0:()=>R(t.id),children:i?e:void 0}})},[E,L,R]),O=(0,o.useMemo)(()=>K.filter(e=>e.count>0),[K]),q=(0,o.useMemo)(()=>O.map(e=>({id:e.id,name:e.name,sub:e.subtitle,color:e.color,iconName:e.icon,onConfirm:()=>R(e.id)})),[O,R]),B=(0,o.useMemo)(()=>z.map(e=>({id:e.id,name:L(e.labelKey),iconName:e.iconName,hash:e.hash,color:e.color})),[L]),G=(0,o.useMemo)(()=>[{id:"add-widget",label:L("palette.action.addWidget"),meta:L("palette.action.addWidget.meta"),iconName:"plus",color:c.w4.colors.accent,onClick:()=>{window.location.hash="#/home";try{sessionStorage.setItem(eK,"1")}catch{}window.dispatchEvent(new CustomEvent("atlantis:open-widget-picker"))}},{id:"preferences",label:L("palette.action.preferences"),meta:L("palette.action.preferences.meta"),iconName:"settings",onClick:()=>k(!0)},{id:"settings",label:L("palette.action.settings"),meta:L("palette.action.settings.meta"),iconName:"sparkle",onClick:()=>{window.location.hash="#/settings"}},{id:"language",label:L("palette.action.language"),meta:L("palette.action.language.meta"),iconName:"globe",onClick:()=>F("pt"===A?"en":"pt")},...N.count>0?[{id:"clear-notifications",label:L("palette.action.clearNotifications"),meta:L("palette.action.clearNotifications.meta",{n:N.count}),iconName:"bell",color:c.w4.colors.accent,onClick:()=>{N.markAllRead()}}]:[],...d?[{id:"signout",label:L("palette.action.signout"),meta:d.email??"",iconName:"arrow-up-right",color:c.w4.colors.danger,onClick:()=>{as()}}]:[]],[L,A,F,d,N]),[W,Y]=(0,o.useState)(null);(0,o.useEffect)(()=>{(0,m.resolveGroqKey)().then(Y)},[]);let _=(0,m.hasEnvGroqKey)()||!!W,V=(0,o.useMemo)(()=>E.map(({id:e,labelKey:t,hash:a})=>({id:e,label:L(t),hash:a})),[E,L]),U=(0,o.useMemo)(()=>E.map(({id:e,labelKey:t,descriptionKey:a,hash:i,icon:o,color:r,category:n})=>({id:e,label:L(t),description:L(a),hash:i,icon:o,color:r,category:n})),[E,L]),J=(e=j.find(e=>e.id===t))?L(e.labelKey):t;if(!h)return(0,i.jsx)(c.NP,{children:(0,i.jsx)(p.xx,{})});if(ry.has(t)&&!d)return(0,i.jsx)(c.NP,{children:(0,i.jsx)(ab,{appLabel:J,onBack:()=>{window.location.hash="#/home"}})});let Q=ri[t],X=e=>{I(e.currentTarget.getBoundingClientRect()),N.toggle()},Z=(0,i.jsx)(p.Yw,{locale:A,onLocaleChange:F,before:null!=Q?(0,i.jsx)(ro,{count:Q}):void 0,notifications:{count:N.count,onClick:X,label:L("notifications.bell")},onOpenPalette:()=>{v(void 0),y(!0)},paletteLabel:L("palette.search"),user:d?{name:d.user_metadata?.full_name,email:d.email??"",avatarUrl:d.user_metadata?.avatar_url}:void 0,userMenuItems:d?[{label:L("userMenu.preferences"),icon:(0,i.jsx)(p.In,{name:"user-cog",size:14}),onClick:()=>k(!0)},{label:L("userMenu.settings"),icon:(0,i.jsx)(p.In,{name:"settings",size:14}),onClick:()=>{window.location.hash="#/settings"}},{label:L("userMenu.clearData"),icon:(0,i.jsx)(p.In,{name:"trash",size:14}),onClick:()=>T(!0),danger:!0},{label:L("userMenu.signOut"),icon:(0,i.jsx)(p.In,{name:"log-out",size:14}),onClick:as,danger:!0}]:[],userMenuControlLabels:{language:L("userMenu.language"),theme:L("userMenu.theme"),themeLight:L("userMenu.themeLight"),themeDark:L("userMenu.themeDark"),themeSystem:L("userMenu.themeSystem")},onSignIn:()=>{window.location.hash="#/home"}}),ee=x&&(0,i.jsx)(iu,{apps:U,recentIds:r,suites:q,games:B,actions:G,hasAsk:_,groqKey:W??void 0,locale:A,initialScope:w,onNavigate:D,onClose:()=>{y(!1),v(void 0)}}),et=!x&&(0,i.jsx)(iv,{t:L,onOpenPalette:()=>{v(void 0),y(!0)}}),ea=(0,i.jsx)(oS,{open:$,onClose:()=>k(!1),locale:A}),ei=(0,i.jsx)(p.TM,{open:C,title:L("userMenu.clearData"),message:L("userMenu.clearDataConfirm"),confirmLabel:L("userMenu.clearData"),cancelLabel:L("common.cancel"),danger:!0,onCancel:()=>T(!1),onConfirm:async()=>{T(!1),await (0,c.sW)(""),window.location.reload()}}),eo=(0,i.jsx)(oY,{locale:A,state:N,anchor:P});if("home"===t)return(0,i.jsxs)(c.NP,{children:[(0,i.jsx)(o9,{children:(0,i.jsx)(ao,{apps:V,recentAppIds:r,pinnedAppIds:s,onTogglePin:e=>{l(t=>{let a=t.includes(e)?t.filter(t=>t!==e):[...t,e];return(0,c.Is)(rh,JSON.stringify(a)),a})},onMovePinned:(e,t)=>{l(a=>{let i=a.indexOf(e);if(i<0)return a;let o=i+t;if(o<0||o>=a.length)return a;let r=[...a];return[r[i],r[o]]=[r[o],r[i]],(0,c.Is)(rh,JSON.stringify(r)),r})},onSelect:e=>{window.location.hash=e.hash},user:d?{name:d.user_metadata?.full_name,email:d.email??"",avatarUrl:d.user_metadata?.avatar_url}:null,onSignOut:as,onPreferences:()=>k(!0),onClearData:()=>T(!0),onOpenPalette:()=>{v(void 0),y(!0)},notifications:{count:N.count,onClick:X,label:L("notifications.bell")}})},"home"),ee,et,ea,ei,eo]});let er=f[t],en=o7[t]?.({user:d,tmdbKey:"9b6f2645abf1725625c843aa71e3efd5",youtubeKey:rv})??{};return(0,i.jsxs)(c.NP,{children:[(0,i.jsx)(rp,{name:t,topBarRight:Z,children:(0,i.jsx)(o.Suspense,{fallback:(0,i.jsx)(p.xx,{}),children:(0,i.jsxs)(o9,{children:[er&&(0,i.jsx)(er,{topBarRight:Z,...en}),"settings"===t&&(0,i.jsx)(c.PE,{title:"Settings",sidebar:null,topBarRight:Z,children:(0,i.jsx)(od,{lang:"pt"===A?"pt":"en"})}),"notifications"===t&&(0,i.jsx)(c.PE,{title:L("notifications.page.title"),sidebar:null,topBarRight:Z,children:(0,i.jsx)(o8,{locale:A})})]},t)})}),ee,et,ea,ei,eo]})},{}))},28170(e,t,a){a.d(t,{Ym:()=>c,Nx:()=>p,Fd:()=>x,aw:()=>m});var i=a(37991),o=a(94764);let r={"time.justNow":{en:"just now",pt:"agora mesmo"},"time.mAgo":{en:"{n}m ago",pt:"h\xe1 {n}m"},"time.hAgo":{en:"{n}h ago",pt:"h\xe1 {n}h"},"time.dAgo":{en:"{n}d ago",pt:"h\xe1 {n}d"},updated:{en:"updated {age}",pt:"atualizado {age}"},refresh:{en:"Refresh",pt:"Atualizar"},loading:{en:"Loading…",pt:"A carregar…"},noData:{en:"No data available",pt:"Sem dados dispon\xedveis"},noDescription:{en:"No description provided.",pt:"Sem descri\xe7\xe3o."},failedToFetch:{en:"Failed to fetch",pt:"Erro ao carregar"},perWeek:{en:"/ wk",pt:"/ sem"},"devtools.heading":{en:"Dev Tools",pt:"Ferramentas"},"devtools.playground":{en:"Playground",pt:"Playground"},"devtools.pad":{en:"Pad",pt:"Pad"},"devtools.charts":{en:"Charts",pt:"Gr\xe1ficos"},"devtools.csv":{en:"CSV",pt:"CSV"},"devtools.regex":{en:"Regex",pt:"Regex"},"devtools.json":{en:"JSON",pt:"JSON"},"devtools.diff":{en:"Diff",pt:"Diferen\xe7as"},"devtools.jwt":{en:"JWT",pt:"JWT"},"devtools.cron":{en:"Cron",pt:"Cron"},"devtools.colors":{en:"Colors",pt:"Cores"},"devtools.api":{en:"API",pt:"API"}},n="atlantis:locale",s="shell:locale";function l(e){return"en"===e||"pt"===e}function d(){try{let e=localStorage.getItem(n);if(l(e))return e}catch{}return"en"}function c(){let[e,t]=(0,i.useState)(d),a=(0,i.useCallback)(e=>{t(e);try{localStorage.setItem(n,e)}catch{}(0,o.Is)(s,e).catch(()=>{}),window.dispatchEvent(new CustomEvent("atlantis:locale-change",{detail:e}))},[]);return(0,i.useEffect)(()=>{let e=e=>{t(e.detail)};return window.addEventListener("atlantis:locale-change",e),()=>window.removeEventListener("atlantis:locale-change",e)},[]),(0,i.useEffect)(()=>{(0,o.PL)(s).then(a=>{if(l(a)&&a!==e){try{localStorage.setItem(n,a)}catch{}t(a)}}).catch(()=>{})},[]),[e,a]}function p(e,t){let a=t?{...r,...t}:r;return(t,i)=>{let o=function(e,t){if(!t||!e.includes("|"))return e;let a=null;for(let e of Object.values(t))if("number"==typeof e&&Number.isFinite(e)){a=e;break}if(null===a)return e;let i=e.indexOf("|"),o=e.slice(0,i),r=e.slice(i+1);return 1===a?o:r}(a[t]?.[e]??t,i);return i?Object.entries(i).reduce((e,[t,a])=>e.replace(RegExp(`\\{${t}\\}`,"g"),String(a)),o):o}}function m(e,t){let a=Math.floor((Date.now()-new Date(e).getTime())/6e4);if(a<1)return t("time.justNow");if(a<60)return t("time.mAgo",{n:a});let i=Math.floor(a/60);return i<24?t("time.hAgo",{n:i}):t("time.dAgo",{n:Math.floor(i/24)})}(0,o.PL)(s).then(e=>{if(l(e))try{localStorage.setItem(n,e)}catch{}}).catch(()=>{});var g=a(65723),u=a(36859),h=a.n(u);let f=h().div`
  display: flex;
  gap: 4px;
...
`,eE=s().span`
  ...
  color: ${l.w4.colors.mainTextMuted};
  flex-shrink: 0;
`,eK=r().forwardRef(function({before:e,after:t,...a},o){return(0,i.jsxs)(eR,{children:[e&&(0,i.jsx)(eE,{children:e}),(0,i.jsx)(eH,{ref:o,...a}),t&&(0,i.jsx)(eE,{children:t})]})}),eO=s().div`
  position: relative;
  display: flex;
  flex-direction: column;
  height: 100%;
...
`;function e_({title:e,accessory:t,accentColor:a,error:o,errorLabel:r,children:n}){return(0,i.jsxs)(eO,{accentColor:a,"data-widget-shell":!0,children:[(0,i.jsxs)(eq,{children:[(0,i.jsx)(eD,{children:e}),t&&(0,i.jsx)(eB,{children:t})]}),o?(0,i.jsxs)(eW,{role:"alert",children:[(0,i.jsx)(eY,{children:r??"Error"}),(0,i.jsx)("div",{children:o})]}):(0,i.jsx)(eG,{children:n})]})}s().div`
  position: relative;
  display: flex;
  flex-direction: column;
  height: 100%;
...
`,s().span`
  font-size: ${l.w4.typography.fontSizeBase};
  color: ${l.w4.colors.mainTextMuted};
`;var tb=a(17223),tx=a(21426);let ty=s().div`
  margin: ${l.w4.spacing.lg} 0;
  border-radius: ${l.w4.borderRadius.md};
  border: 1px solid ${l.w4.colors.codeBorder};
  overflow: hidden;
...
`;function tT({type:e,children:t}){let a=tj[e]??tj.NOTE;return(0,i.jsxs)(tS,{bg:a.bg,border:a.border,children:[(0,i.jsxs)(tz,{color:a.color,children:[(0,i.jsx)(F,{name:a.icon,size:15,strokeWidth:2}),a.label]}),(0,i.jsx)(tC,{children:t})]})}s().nav`
  width: 220px;
  min-width: 220px;
...
`;function tB({size:e}){return(0,i.jsxs)("svg",{width:14,height:14,viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:[(0,i.jsx)("rect",{x:1.5,y:4.5,width:11,height:5,rx:1,stroke:"currentColor",strokeWidth:1,opacity:.4}),(0,i.jsx)("rect",{x:2,y:5,width:"sm"===e?4:"md"===e?7:11,height:4,rx:.5,fill:"currentColor"})]})}let tG={sm:1,md:2,lg:"full"};function tW({items:e,onReorder:t,onCycleSize:a,onRemove:o,renderPanel:r,renderAccessory:n,showGrip:s=!0,labels:l,accentColor:d}){return(0,i.jsx)(tD,{children:e.map((c,p)=>{let m=tG[c.size],g="full"===m,u=c.minHeight??160,h=d?.(c),f=(c.availableSizes??["sm","md","lg"]).length>1,b=n?.(c);return(0,i.jsxs)(tR,{colSpan:g?1:m,fullWidth:g,children:[b&&(0,i.jsx)(tH,{children:b}),(0,i.jsxs)(tE,{minH:u,accent:h,"data-grip":s?"true":"false",children:[(0,i.jsxs)(tK,{className:"panel-controls",children:[p>0&&(0,i.jsx)(tO,{type:"button",title:l.moveLeft,onClick:()=>t(c.id,-1),children:(0,i.jsx)(F,{name:"chevron-left",size:14})}),p<e.length-1&&(0,i.jsx)(tO,{type:"button",title:l.moveRight,onClick:()=>t(c.id,1),children:(0,i.jsx)(F,{name:"chevron-right",size:14})}),f&&(0,i.jsx)(tO,{type:"button",title:`${l.cycleSize} \xb7 ${c.size.toUpperCase()}`,onClick:()=>a(c.id),children:(0,i.jsx)(tB,{size:c.size})}),o&&l.remove&&(0,i.jsx)(tq,{type:"button",title:l.remove,onClick:()=>o(c.id),children:(0,i.jsx)(F,{name:"close",size:14})})]}),r(c)]})]},c.id)})})}let tY=(0,C.keyframes)`
...
`,t0=s().button`
  ...
  &:hover { opacity: 0.88; }
  &:focus-visible { ${l.w4.focusRing} }
`;function t1({open:e,title:t,message:a,confirmLabel:r,cancelLabel:n,onConfirm:s,onCancel:l,danger:d=!1}){return((0,o.useEffect)(()=>{if(!e)return;let t=e=>{"Escape"===e.key&&l(),"Enter"===e.key&&s()};return document.addEventListener("keydown",t),()=>document.removeEventListener("keydown",t)},[e,l,s]),e)?(0,i.jsx)(tU,{onClick:l,role:"dialog","aria-modal":"true","aria-label":t,children:(0,i.jsxs)(tJ,{danger:d,onClick:e=>e.stopPropagation(),children:[(0,i.jsx)(tQ,{danger:d,children:t}),(0,i.jsx)(tX,{children:a}),(0,i.jsxs)(tZ,{children:[(0,i.jsx)(t0,{onClick:l,children:n}),(0,i.jsx)(t0,{danger:d,primary:!d,onClick:s,autoFocus:!0,children:r})]})]})}):null}let t4=(0,C.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,t2=(0,C.keyframes)`
...
`,t3=s().div`
  ...
  background: ${l.w4.colors.mainBg};
  font-family: ${l.w4.typography.fontFamily};
  animation: ${t4} 0.4s ease 0.15s both;
`,t6=s().div`
  position: relative;
  width: 56px;
  height: 56px;
...
`,t8=s().div`
  position: absolute;
  inset: 0;
  animation: ${t2} 1.4s cubic-bezier(0.4, 0, 0.2, 1) infinite;
...
`,t7=s().div`
  ...
  border-radius: 50%;
  background: ${l.w4.colors.border};
  animation: ${t5} 1.4s ease-in-out infinite;
`,t9=s().span`
  color: ${l.w4.colors.mainTextMuted};
  font-size: ${l.w4.typography.fontSizeSm};
  letter-spacing: 0.04em;
`;function ae({label:e="Loading…"}){return(0,i.jsxs)(t3,{children:[(0,i.jsxs)(t6,{children:[(0,i.jsx)(t8,{delay:0,size:8,color:l.w4.colors.accent}),(0,i.jsx)(t8,{delay:-.45,size:6,color:"#bc8cff"}),(0,i.jsx)(t8,{delay:-.9,size:5,color:"#3fb950"}),(0,i.jsx)(t7,{})]}),(0,i.jsx)(t9,{children:e})]})}s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
