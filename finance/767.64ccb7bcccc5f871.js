"use strict";(self.webpackChunk_atlantis_finance=self.webpackChunk_atlantis_finance||[]).push([["767"],{7637(e,t,n){n.d(t,{u:()=>$});var o=n(5723),a=n(7991),r=n(6859),i=n.n(r),s=n(4764),l=n(5030),c=n(2906);let d=i().div`
  display: flex;
...
`,v=i().div`
  ...
  border-radius: 1px;
  background: ${({bg:e})=>e};
`,k=new Set([0,4,8,12,16,20]);function M(e){return[parseInt(e.slice(1,3),16),parseInt(e.slice(3,5),16),parseInt(e.slice(5,7),16)]}let j=M("#1d2230"),z=M("#f59e0b");function T(e){let t=Math.round(j[0]+(z[0]-j[0])*e),n=Math.round(j[1]+(z[1]-j[1])*e),o=Math.round(j[2]+(z[2]-j[2])*e);return`rgb(${t},${n},${o})`}let S=function(e=5){return Array.from({length:e},(t,n)=>T(n/(e-1)))}(5),C=["finance.dayHourHeatmap.day.mon","finance.dayHourHeatmap.day.tue","finance.dayHourHeatmap.day.wed","finance.dayHourHeatmap.day.thu","finance.dayHourHeatmap.day.fri","finance.dayHourHeatmap.day.sat","finance.dayHourHeatmap.day.sun"];function F({matrix:e,t}){let n=(0,a.useMemo)(()=>{let t=0;for(let n of e)for(let e of n)e>t&&(t=e);return t},[e]);return 0===n?(0,o.jsx)(b,{children:t("finance.dayHourHeatmap.empty")}):(0,o.jsx)(d,{children:(0,o.jsxs)(p,{children:[(0,o.jsxs)(f,{children:[(0,o.jsx)(g,{}),Array.from({length:24},(e,t)=>(0,o.jsx)(m,{children:k.has(t)?String(t).padStart(2,"0"):""},t))]}),e.map((e,a)=>(0,o.jsxs)(u,{children:[(0,o.jsx)(h,{children:t(C[a]??"finance.dayHourHeatmap.day.mon")}),e.map((e,r)=>{let i=T(n>0?e/n:0),s=e>0?`€${e.toFixed(2)}`:"—",l=`${String(r).padStart(2,"0")}:00`,c=t(C[a]??"finance.dayHourHeatmap.day.mon");return(0,o.jsx)(x,{bg:i,title:t("finance.dayHourHeatmap.tooltip",{day:c,hour:l,amount:s}),"aria-label":`${c} ${l} — ${s}`},r)})]},a)),(0,o.jsxs)(y,{children:[(0,o.jsx)(w,{children:"0"}),(0,o.jsx)($,{children:S.map((e,t)=>(0,o.jsx)(v,{bg:e},t))}),(0,o.jsxs)(w,{children:["€",n.toFixed(0)]})]})]})})}},8635(e,t,n){n.d(t,{f:()=>W,z:()=>Y});var o=n(5723),a=n(7991),r=n(6859),i=n.n(r),s=n(2799),l=n(4764),c=n(8170),d=n(5030),p=n(9454),f=n(2906),m=n(948);let g="#7fb77e",u="#f85149",h=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,x=i().div`
  background: ${l.w4.colors.surface};
...
`,c=r().p`
  ...
  margin: 0;
  line-height: 1.5;
`,d={loading:"◌ Loading",empty:"◎ Empty",error:"◎ Offline"};function p({mode:e,label:t,body:n}){return(0,o.jsxs)(s,{children:[(0,o.jsx)(l,{mode:e,children:t??d[e]}),n&&(0,o.jsx)(c,{children:n})]})}},6246(e,t,n){n.d(t,{uj:()=>T,$8:()=>b,OW:()=>s,Xj:()=>L,ik:()=>w,Ru:()=>p,kl:()=>D,RT:()=>R,RJ:()=>v,YG:()=>o.Y});var o=n(5043),a=n(5723),r=n(7991),i=n(4764);function s({points:e,accent:t=i.w4.colors.accent,width:n=60,height:o=28,strokeWidth:l=1.5,fluid:c=!1}){let d=(0,r.useMemo)(()=>{if(e.length<2)return"";let t=Math.min(...e),a=Math.max(...e)-t||1,r=n-2*l,i=o-2*l;return e.map((n,o)=>{let s=l+o/(e.length-1)*r,c=l+i-(n-t)/a*i;return`${0===o?"M":"L"} ${s.toFixed(1)} ${c.toFixed(1)}`}).join(" ")},[e,n,o,l]),p=(0,r.useMemo)(()=>{if(e.length<1)return null;let t=e[e.length-1],a=Math.min(...e),r=n-2*l,i=o-2*l;return{x:l+r,y:l+i-(t-a)/(Math.max(...e)-a||1)*i}},[e,n,o,l]);return d?(0,a.jsxs)("svg",{width:c?"100%":n,height:c?"auto":o,viewBox:`0 0 ${n} ${o}`,preserveAspectRatio:"xMidYMid meet","aria-hidden":"true",style:{display:"block",flexShrink:+!!c},children:[(0,a.jsx)("path",{d:d,fill:"none",stroke:t,strokeWidth:l,strokeLinecap:"round",strokeLinejoin:"round",opacity:.7}),p&&(0,a.jsx)("circle",{cx:p.x,cy:p.y,r:l+1,fill:t})]}):null}var l=n(6859),c=n.n(l);let d=c().span`
  font-family: ${i.w4.typography.fontFamilyMono};
  font-size: 11px;
  font-weight: 500;
  font-variant-numeric: tabular-nums;
