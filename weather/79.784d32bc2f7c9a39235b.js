...
`,x=t.default.main`
  ...
  display: flex;
  flex-direction: column;
`,w="atlantis:sidebar-collapsed";function v({sidebar:a,children:e,topBarRight:o,title:t="Atlantis",activeId:g=null}){const[c,v]=(0,i.useState)(()=>{try{return"true"===localStorage.getItem(w)}catch{return!1}}),[S,k]=(0,i.useState)(null),M=(0,i.useRef)(),B=()=>v(a=>{const e=!a;try{localStorage.setItem(w,String(e))}catch{}return e}),$=i.useMemo(()=>i.lazy(()=>Promise.resolve().then(n.bind(n,4914)).then(a=>({default:a.FlyoutPanel}))),[]);return(0,l.jsx)(m.I.Provider,{value:{collapsed:c,toggle:B,flyout:S,openFlyout:(a,e,n)=>{clearTimeout(M.current),k({entry:a,anchorY:e,onSelect:n})},scheduleFlyoutClose:()=>{M.current=setTimeout(()=>k(null),160)},cancelFlyoutClose:()=>clearTimeout(M.current)},children:(0,l.jsxs)(b,{children:[(0,l.jsxs)(d,{children:[(0,l.jsx)(s,{children:(0,l.jsx)(f,{onClick:B,title:c?"Expand sidebar":"Collapse sidebar",children:(0,l.jsx)(r.A,{size:17})})}),(0,l.jsxs)(u,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:["Atl",(0,l.jsx)("span",{children:"antis"})]}),t&&(0,l.jsx)(p,{children:t}),o&&(0,l.jsx)(z,{children:o})]}),(0,l.jsxs)(y,{children:[null!=a&&(0,l.jsx)(h,{collapsed:c,children:(0,l.jsx)(A,{children:a})}),(0,l.jsx)(x,{children:e})]}),S&&(0,l.jsx)(i.Suspense,{fallback:null,children:(0,l.jsx)($,{activeId:g})})]})})}var S=n(255),k=n(9753),M=n(5185);const B=t.default.div`
  display: grid;
...
//# sourceMappingURL=79.784d32bc2f7c9a39235b.js.map