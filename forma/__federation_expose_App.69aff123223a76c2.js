"use strict";(self.webpackChunk_atlantis_forma=self.webpackChunk_atlantis_forma||[]).push([["362"],{3935(e,a,t){t.r(a),t.d(a,{default:()=>N});var i=t(5723),s=t(7991),o=t(6859),l=t.n(o),n=t(2799),r=t(4764),d=t(5030),c=t(8170),g=t(6527),m=t(4041),p=t(948),w=t(2552),f=t(1589),h=t(8477),x=t(5405),u=t(483),b=t(9276),k=t(5742),y=t(7103),v=t(2128),j=t(9446),$=t(950),C=t(2152),S=t(429);let D="#7fb77e",M=(0,n.keyframes)`
...
`;function N({topBarRight:e}){let[a]=(0,c.Ym)(),t=(0,s.useMemo)(()=>(0,c.Nx)(a,p.A),[a]),{data:o,loaded:l,save:n}=(0,g.useForma)(),[D,M]=(0,s.useState)("16:8"),[B,G]=(0,s.useState)(!1),[R,K]=(0,s.useState)(void 0),[Q,U]=(0,s.useState)(null),[q,J]=(0,s.useState)("today"),V=(0,s.useCallback)((e,a)=>{K(e),U(a??null),G(!0)},[]),X=(0,s.useCallback)(()=>{G(!1),K(void 0),U(null)},[]),Z=o??{sessions:[],meals:[],weights:[],walks:[],templates:g.DEFAULT_TEMPLATES,goal:{targetHours:16,weeklyFasts:5}},ee=(0,s.useCallback)(async(e,a)=>{let t={...Z,sessions:[...Z.sessions,{id:(0,m.z)(),startedAt:Date.now(),targetHours:a,protocol:e}]};await n(t)},[Z,n]),ea=(0,s.useCallback)(async e=>{let a={...Z,sessions:Z.sessions.map(a=>a.id===e.id?{...a,endedAt:Date.now()}:a)};await n(a)},[Z,n]),et=(0,s.useCallback)(async()=>{let e=Z.sessions.find(e=>void 0===e.endedAt);e&&await ea(e)},[Z,ea]),ei=(0,s.useCallback)(async e=>{let a=new Date(e.startedAt),i=e=>String(e).padStart(2,"0"),s=`${a.getFullYear()}-${i(a.getMonth()+1)}-${i(a.getDate())}T${i(a.getHours())}:${i(a.getMinutes())}`,o=window.prompt(t("forma.timer.editStartPrompt"),s);if(!o)return;let l=new Date(o);if(Number.isNaN(l.getTime()))return;let r=l.getTime();if(r>Date.now())return;let d={...Z,sessions:Z.sessions.map(a=>a.id===e.id?{...a,startedAt:r}:a)};await n(d)},[Z,n,t]),es=(0,s.useCallback)(async(e,a,t,i,s=new Date().toISOString().slice(0,10))=>{let o={...Z,meals:[...Z.meals,{id:(0,m.z)(),date:s,slot:e,proteinG:a,kcal:t,notes:i||void 0,createdAt:Date.now()}]};await n(o)},[Z,n]),eo=(0,s.useCallback)(async(e,a,t,i,s,o)=>{let l={...Z,meals:Z.meals.map(l=>l.id===e?{...l,slot:a,proteinG:t,kcal:i,notes:s||void 0,date:o}:l)};await n(l)},[Z,n]),el=(0,s.useCallback)(async(e,a=new Date().toISOString().slice(0,10))=>{let t=Z.weights.filter(e=>e.date!==a),i={...Z,weights:[...t,{date:a,kg:e}]};await n(i)},[Z,n]),en=(0,s.useCallback)(async(e,a)=>{let t={...Z,weights:Z.weights.filter(a=>a.date!==e).concat({date:e,kg:a})};await n(t)},[Z,n]),er=(0,s.useCallback)(async(e,a=new Date().toISOString().slice(0,10))=>{let t={...Z,walks:[...Z.walks,{id:(0,m.z)(),date:a,minutes:e}]};await n(t)},[Z,n]),ed=(0,s.useCallback)(async(e,a,t)=>{let i={...Z,walks:Z.walks.map(i=>i.id===e?{...i,minutes:a,date:t}:i)};await n(i)},[Z,n]),ec=(0,s.useCallback)(async e=>{let a=new Date().toISOString().slice(0,10),t={...Z,meals:[...Z.meals,{id:(0,m.z)(),date:a,slot:e.slot,templateId:e.id,proteinG:e.proteinG,kcal:e.kcal,notes:void 0,createdAt:Date.now()}]};await n(t)},[Z,n]),eg=(0,s.useCallback)(async e=>{let a={...Z,meals:Z.meals.filter(a=>a.id!==e)};await n(a)},[Z,n]),em=(0,s.useCallback)(async e=>{let a={...Z,weights:Z.weights.filter(a=>a.date!==e)};await n(a)},[Z,n]),ep=(0,s.useCallback)(()=>V("meal"),[V]),ew=(0,s.useCallback)(()=>V("walk"),[V]),ef=(0,s.useCallback)(()=>V("weight"),[V]),eh=(0,s.useCallback)(e=>{let a=Z.meals.find(a=>a.id===e);a&&V("meal",{kind:"meal",entry:a})},[Z.meals,V]),ex=(0,s.useCallback)(e=>{let a=Z.weights.find(a=>a.date===e);a&&V("weight",{kind:"weight",entry:a})},[Z.weights,V]),eu=(0,s.useCallback)(async e=>{switch(e.kind){case"fast":await ee(e.fastProtocol??"custom",e.fastHours??16);break;case"meal":await es(e.mealSlot??"dinner",0,0,e.mealDesc??"");break;case"weight":void 0!==e.weightKg&&await el(e.weightKg);break;case"walk":void 0!==e.walkMinutes&&await er(e.walkMinutes)}},[ee,es,el,er]),eb=(0,g.streakDays)(Z.sessions,Z.goal.targetHours),ek=(0,g.avgFastDuration)(Z.sessions,30),ey=Z.weights.find(e=>e.date===new Date().toISOString().slice(0,10));return(0,i.jsx)(r.PE,{title:t("forma.appTitle"),sidebar:null,topBarRight:e,children:(0,i.jsxs)(F,{children:[(0,i.jsxs)(O,{role:"tablist","aria-label":t("forma.tabs.aria"),children:[(0,i.jsx)(Y,{role:"tab","aria-selected":"today"===q,active:"today"===q,onClick:()=>J("today"),children:t("forma.tab.today")}),(0,i.jsx)(Y,{role:"tab","aria-selected":"fasting"===q,active:"fasting"===q,onClick:()=>J("fasting"),children:t("forma.tab.fasting")}),(0,i.jsx)(Y,{role:"tab","aria-selected":"weight"===q,active:"weight"===q,onClick:()=>J("weight"),children:t("forma.tab.weight")}),(0,i.jsx)(Y,{role:"tab","aria-selected":"settings"===q,active:"settings"===q,onClick:()=>J("settings"),children:t("forma.tab.settings")})]}),(0,i.jsxs)(T,{children:["fasting"===q&&(0,i.jsx)(f.B,{t:t,active:D,onChange:M}),(0,i.jsx)(A,{children:(0,i.jsxs)(E,{children:["today"===q&&(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(x.F,{t:t,onParsed:e=>void eu(e)}),(0,i.jsxs)(_,{children:[(0,i.jsx)(v.g,{data:Z,t:t,onClick:()=>J("fasting")}),(0,i.jsx)(j.S,{data:Z,t:t,onClick:()=>J("weight")})]}),(0,i.jsx)(k._,{data:Z,t:t,onLogMeal:ep,onLogWalk:ew,onLogWeight:ef,onDeleteMeal:e=>void eg(e),onEditMeal:eh}),(0,i.jsx)(y.j,{data:Z,t:t,locale:a}),(0,i.jsx)($.M,{data:Z,t:t,locale:a}),(0,i.jsx)(u.v,{data:Z,t:t,locale:a,onTapTemplate:e=>void ec(e)}),(0,i.jsxs)(z,{children:[(0,i.jsxs)(W,{children:[(0,i.jsx)(P,{children:eb}),(0,i.jsx)(I,{children:t("forma.streak",{n:eb})})]}),(0,i.jsxs)(W,{children:[(0,i.jsx)(P,{children:ek>0?ek.toFixed(1):"—"}),(0,i.jsx)(I,{children:t("forma.hero.avgDuration")})]}),ey&&(0,i.jsxs)(W,{children:[(0,i.jsx)(P,{children:ey.kg.toFixed(1)}),(0,i.jsx)(I,{children:t("forma.weight.label")})]})]})]}),"fasting"===q&&(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(h.P,{t:t,active:D,onChange:M}),(0,i.jsx)(L,{children:(0,i.jsx)(w.k,{data:Z,t:t,onStart:()=>{let e="16:8"===D?16:"18:6"===D?18:"20:4"===D?20:Z.goal.targetHours;ee(D,e)},onStop:e=>void ea(e),onEditStart:e=>void ei(e)})}),(0,i.jsx)(u.v,{data:Z,t:t,locale:a,onTapTemplate:e=>void ec(e)})]}),"weight"===q&&(0,i.jsx)(C.m,{data:Z,t:t,onLogWeight:ef,onDeleteWeight:e=>void em(e),onEditWeight:ex}),"settings"===q&&(0,i.jsx)(S.f,{data:Z,t:t,onSave:n})]})})]}),(0,i.jsx)(H,{"aria-label":t("forma.log"),onClick:()=>V(),children:(0,i.jsx)(d.In,{name:"plus",size:24,color:"#fff"})}),(0,i.jsx)(b.Y,{open:B,onClose:X,data:Z,t:t,initialMode:R,editing:Q,onStartFast:(e,a)=>void ee(e,a),onStopFast:()=>void et(),onLogMeal:(e,a,t,i,s)=>void es(e,a,t,i,s),onEditMeal:(e,a,t,i,s,o)=>void eo(e,a,t,i,s,o),onLogWeight:(e,a)=>void el(e,a),onEditWeight:(e,a)=>void en(e,a),onLogWalk:(e,a)=>void er(e,a),onEditWalk:(e,a,t)=>void ed(e,a,t)})]})})}}}]);