...
`,w=i.default.main`
  ...
  display: flex;
  flex-direction: column;
`,A="atlantis:sidebar-collapsed";function v({sidebar:e,children:a,topBarRight:n,title:i="Atlantis",activeId:d=null}){const[c,v]=(0,t.useState)(()=>{try{return"true"===localStorage.getItem(A)}catch{return!1}}),[$,S]=(0,t.useState)(null),j=(0,t.useRef)(),k=()=>v(e=>{const a=!e;try{localStorage.setItem(A,String(a))}catch{}return a}),M=t.useMemo(()=>t.lazy(()=>Promise.resolve().then(o.bind(o,4914)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(s.I.Provider,{value:{collapsed:c,toggle:k,flyout:$,openFlyout:(e,a,o)=>{clearTimeout(j.current),S({entry:e,anchorY:a,onSelect:o})},scheduleFlyoutClose:()=>{j.current=setTimeout(()=>S(null),160)},cancelFlyoutClose:()=>clearTimeout(j.current)},children:(0,r.jsxs)(y,{children:[(0,r.jsxs)(m,{children:[(0,r.jsx)(g,{children:(0,r.jsx)(u,{onClick:k,title:c?"Expand sidebar":"Collapse sidebar",children:(0,r.jsx)(l.A,{size:17})})}),(0,r.jsxs)(f,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:["Atl",(0,r.jsx)("span",{children:"antis"})]}),i&&(0,r.jsx)(p,{children:i}),n&&(0,r.jsx)(h,{children:n})]}),(0,r.jsxs)(x,{children:[null!=e&&(0,r.jsx)(b,{collapsed:c,children:(0,r.jsx)(z,{children:e})}),(0,r.jsx)(w,{children:a})]}),$&&(0,r.jsx)(t.Suspense,{fallback:null,children:(0,r.jsx)(M,{activeId:d})})]})})}var $=o(255),S=o(9753),j=o(5185);const k=i.default.div`
  display: grid;
...
//# sourceMappingURL=779.2b2818968e9e9abbb53d.js.map