...
`},7330(o,e,a){a.d(e,{FlyoutPanel:()=>oP});var t=a(5723),r=a(7991),i=a.n(r),n=a(6859),l=a.n(n),s=a(2799),d=a(255),c=a(1316),p=a(814),g=a(6896),m=a(7902),f=a(3013),x=a(2887),u=a(9510),b=a(9848),h=a(7901),y=a(3045),w=a(3775),$=a(1783),z=a(3539),v=a(9416),k=a(1837),M=a(7167),A=a(4494),T=a(2314),S=a(5751),F=a(9633),j=a(2946),B=a(822),R=a(6720),P=a(7400),E=a(8456),C=a(3317),H=a(2709),L=a(8006),D=a(9301),N=a(7561),V=a(3517),Y=a(8207),I=a(7032),G=a(6949),K=a(8218),_=a(6829),O=a(9591),J=a(5553),W=a(9923),U=a(2820),Z=a(4621),q=a(8479),X=a(2534),Q=a(6673),oo=a(7490),oe=a(9033),oa=a(9038),ot=a(5775),or=a(1365),oi=a(2937),on=a(9821),ol=a(5912),os=a(158),od=a(8641),oc=a(8607),op=a(3249),og=a(1821),om=a(5889),of=a(9655),ox=a(7170),ou=a(9161),ob=a(1849),oh=a(1604),oy=a(3142),ow=a(1187),o$=a(7747),oz=a(2932),ov=a(4525),ok=a(7230),oM=a(2164);let oA={activity:g.A,"a-large-small":m.A,apple:f.A,"arrow-right":x.A,"bar-chart-2":u.A,book:b.A,"book-open":h.A,briefcase:y.A,calendar:w.A,clock:$.A,"circle-dot":z.A,cloud:v.A,compass:k.A,cpu:M.A,droplets:A.A,feather:T.A,file:d.A,"file-text":S.A,folder:F.A,"git-branch":j.A,github:B.A,globe:R.A,grid:P.A,hand:E.A,hash:C.A,heart:H.A,key:L.A,hexagon:D.A,home:N.A,landmark:V.A,layers:Y.A,"layout-grid":I.A,leaf:G.A,lightbulb:K.A,list:_.A,map:O.A,"map-pin":J.A,"message-circle":W.A,"message-square":U.A,minus:Z.A,monitor:q.A,mountain:X.A,package:Q.A,palette:oo.A,"pen-tool":oe.A,"pie-chart":oa.A,plane:ot.A,plus:or.A,ruler:oi.A,shirt:on.A,slash:ol.A,square:os.A,star:od.A,sun:oc.A,terminal:op.A,thermometer:og.A,triangle:om.A,trophy:of.A,truck:ox.A,type:ou.A,users:ob.A,"volume-2":oh.A,watch:oy.A,waves:ow.A,wind:o$.A,wrench:oz.A,x:ov.A,zap:ok.A,bot:oM.A},oT=(0,s.keyframes)`
...
`;function oB({iconKey:o}){let e=o?oA[o]??d.A:d.A;return(0,t.jsx)(e,{size:14,strokeWidth:1.75})}function oR({entries:o,activeId:e,onSelect:a}){return(0,t.jsx)(t.Fragment,{children:o.map(o=>o.children?(0,t.jsx)(i().Fragment,{children:(0,t.jsx)(oR,{entries:o.children,activeId:e,onSelect:a})},o.id):(0,t.jsxs)(oj,{active:e===o.id,onClick:()=>a(o),children:[(0,t.jsx)(oB,{iconKey:o.icon}),o.name]},o.id))})}function oP({activeId:o}){let{flyout:e,scheduleFlyoutClose:a,cancelFlyoutClose:r}=(0,p.c)();if(!e)return null;let i=e.entry.icon?oA[e.entry.icon]??d.A:d.A;return(0,t.jsxs)(oS,{anchorY:e.anchorY,onMouseEnter:r,onMouseLeave:a,children:[(0,t.jsxs)(oF,{children:[(0,t.jsx)(i,{size:13,strokeWidth:2}),e.entry.name]}),(0,t.jsx)(oR,{entries:e.entry.children??[],activeId:o,onSelect:o=>{e.onSelect(o),a()}})]})}},814(o,e,a){a.d(e,{I:()=>r,c:()=>i});var t=a(7991);let r=(0,t.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),i=()=>(0,t.useContext)(r)},246(o,e,a){a.d(e,{Is:()=>P.putSetting,w4:()=>t.w4,pJ:()=>P.putLocalSetting,PE:()=>B,qj:()=>P.getLocalSetting,PL:()=>P.getSetting});var t=a(1316),r=a(5723),i=a(7991),n=a.n(i),l=a(6859),s=a.n(l);s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,s().div`
  position: relative;
`;var d=a(2799),c=a(3661),p=a(814);let g="260px",m="56px",f="48px",x=s().header`
  display: flex;
  align-items: center;
...
`,T=s().main`
  ...
  display: flex;
  flex-direction: column;
`,S=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function F(){return(0,r.jsx)(y,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:S.map((o,e)=>(0,r.jsx)(w,{index:e,accent:o.accent,children:o.char},e))})}let j="atlantis:sidebar-collapsed";function B({sidebar:o,children:e,topBarRight:t,title:l="Atlantis",activeId:s=null}){let[d,g]=(0,i.useState)(()=>{try{return"true"===localStorage.getItem(j)}catch{return!1}}),[m,f]=(0,i.useState)(null),h=(0,i.useRef)(),y=()=>g(o=>{let e=!o;try{localStorage.setItem(j,String(e))}catch{}return e}),w=n().useMemo(()=>n().lazy(()=>Promise.resolve().then(a.bind(a,7330)).then(o=>({default:o.FlyoutPanel}))),[]);return(0,r.jsx)(p.I.Provider,{value:{collapsed:d,toggle:y,flyout:m,openFlyout:(o,e,a)=>{clearTimeout(h.current),f({entry:o,anchorY:e,onSelect:a})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>f(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,r.jsxs)(k,{children:[(0,r.jsxs)(x,{children:[o&&(0,r.jsx)(u,{children:(0,r.jsx)(b,{onClick:y,title:d?"Expand sidebar":"Collapse sidebar",children:(0,r.jsx)(c.A,{size:17})})}),(0,r.jsx)(F,{}),l&&(0,r.jsx)($,{children:l}),t&&(0,r.jsx)(z,{children:t})]}),(0,r.jsxs)(v,{children:[null!=o&&(0,r.jsx)(M,{collapsed:d,children:(0,r.jsx)(A,{children:o})}),(0,r.jsx)(T,{children:e})]}),m&&(0,r.jsx)(n().Suspense,{fallback:null,children:(0,r.jsx)(w,{activeId:s})})]})})}s().div`
  display: grid;
...
`,s().div`
  ...
  flex-direction: column;
  gap: 14px;
  animation: ${C} 0.18s cubic-bezier(0.22, 1, 0.36, 1) both;
`,s().div`
  font-size: ${t.w4.typography.fontSizeMd};
  font-weight: 700;
...
`,h=i().forwardRef(function({variant:o="ghost",size:e="md",icon:a,iconRight:r,children:i,...n},l){return(0,t.jsxs)(b,{ref:l,variant:o,size:e,...n,children:[a,i,r]})}),y={default:s.w4.colors.accent,danger:"#f85149"},w={default:s.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"},$=l().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`,z=i().forwardRef(function({active:o=!1,shape:e="square",tone:a="default",children:r,...i},n){return(0,t.jsx)($,{ref:n,active:o,shape:e,tone:a,...i,children:r})});l().div`
  position: relative;
  display: inline-flex;
`,l().div`
  position: absolute;
...
`,l().span`
  ...
  background: ${({color:o})=>o};
  display: inline-block;
`;let j={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:s.w4.colors.accentMuted},B={neutral:s.w4.colors.mainTextMuted,live:s.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:s.w4.colors.accent};l().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${s.w4.typography.fontFamilyMono};
...
`;let R=l().div`
  ...
  align-items: center;
  gap: 8px;
`;function P({children:o,...e}){return(0,t.jsx)(R,{...e,children:o})}l().label`
  display: flex;
  align-items: center;
  gap: 10px;
