...
`,l().span`
  ...
  display: inline-block;
`;let H={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:s.w4.colors.accentMuted},R={neutral:s.w4.colors.mainTextMuted,live:s.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:s.w4.colors.accent};l().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${s.w4.typography.fontFamilyMono};
...
`,l().p`
  ...
  font-size: 12.5px;
  line-height: 1.45;
`;var N=r(11352),D=r(76710),O=r(4311),W=r(73639),Y=r(40080);r(75406),l().nav`padding: ${s.w4.spacing.sm} 0;`,l().div`
...
`;var q=r(54041);let G="https://cdn.jsdelivr.net/npm/mermaid@11.14.0/dist/mermaid.min.js",_=null,K="#7fb77e",U=(0,F.keyframes)`
...
`;function eL({type:e,children:o}){let r=eA[e]??eA.NOTE,a=r.icon;return(0,t.jsxs)(eB,{bg:r.bg,border:r.border,children:[(0,t.jsxs)(eH,{color:r.color,children:[(0,t.jsx)(a,{size:15,strokeWidth:2}),r.label]}),(0,t.jsx)(eR,{children:o})]})}l().nav`
  width: 220px;
  min-width: 220px;
