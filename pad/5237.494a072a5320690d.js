...
`,eC=({size:e=14,strokeWidth:o=1.75})=>(0,r.jsxs)("svg",{width:e,height:e,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:o,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,r.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,r.jsx)("polyline",{points:"14 2 14 8 20 8"})]});function eF({iconKey:e}){let o=e?eA[e]:null;return o?(0,r.jsx)(o,{size:14,strokeWidth:1.75}):(0,r.jsx)(eC,{})}function eL({entries:e,activeId:o,onSelect:a}){return(0,r.jsx)(r.Fragment,{children:e.map(e=>e.children?(0,r.jsx)(i().Fragment,{children:(0,r.jsx)(eL,{entries:e.children,activeId:o,onSelect:a})},e.id):(0,r.jsxs)(eB,{active:o===e.id,onClick:()=>a(e),children:[(0,r.jsx)(eF,{iconKey:e.icon}),e.name]},e.id))})}function eR({activeId:e}){let{flyout:o,scheduleFlyoutClose:a,cancelFlyoutClose:t}=(0,c.c)();if(!o)return null;let i=o.entry.icon?eA[o.entry.icon]:null;return(0,r.jsxs)(ej,{anchorY:o.anchorY,onMouseEnter:t,onMouseLeave:a,children:[(0,r.jsxs)(eS,{children:[i?(0,r.jsx)(i,{size:13,strokeWidth:2}):(0,r.jsx)(eC,{size:13,strokeWidth:2}),o.entry.name]}),(0,r.jsx)(eL,{entries:o.entry.children??[],activeId:e,onSelect:e=>{o.onSelect(e),a()}})]})}},40814(e,o,a){a.d(o,{I:()=>t,c:()=>i});var r=a(37991);let t=(0,r.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),i=()=>(0,r.useContext)(t)},89874(e,o,a){a.d(o,{PL:()=>F.getSetting,MJ:()=>V,mZ:()=>F.updateDoc,KL:()=>F.saveDoc,cL:()=>c.c,Is:()=>F.putSetting,UO:()=>eo,PE:()=>B,w4:()=>r.w4});var r=a(81316),t=a(65723),i=a(37991),n=a.n(i),l=a(36859),s=a.n(l);s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
