...
`,w=i.default.main`
  ...
  display: flex;
  flex-direction: column;
`,v="atlantis:sidebar-collapsed";function k({sidebar:e,children:o,topBarRight:n,title:i="Atlantis",activeId:d=null}){const[c,k]=(0,t.useState)(()=>{try{return"true"===localStorage.getItem(v)}catch{return!1}}),[A,$]=(0,t.useState)(null),j=(0,t.useRef)(),S=()=>k(e=>{const o=!e;try{localStorage.setItem(v,String(o))}catch{}return o}),M=t.useMemo(()=>t.lazy(()=>Promise.resolve().then(a.bind(a,4914)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(s.I.Provider,{value:{collapsed:c,toggle:S,flyout:A,openFlyout:(e,o,a)=>{clearTimeout(j.current),$({entry:e,anchorY:o,onSelect:a})},scheduleFlyoutClose:()=>{j.current=setTimeout(()=>$(null),160)},cancelFlyoutClose:()=>clearTimeout(j.current)},children:(0,r.jsxs)(b,{children:[(0,r.jsxs)(m,{children:[(0,r.jsx)(u,{children:(0,r.jsx)(p,{onClick:S,title:c?"Expand sidebar":"Collapse sidebar",children:(0,r.jsx)(l.A,{size:17})})}),(0,r.jsxs)(g,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:["Atl",(0,r.jsx)("span",{children:"antis"})]}),i&&(0,r.jsx)(f,{children:i}),n&&(0,r.jsx)(x,{children:n})]}),(0,r.jsxs)(h,{children:[null!=e&&(0,r.jsx)(y,{collapsed:c,children:(0,r.jsx)(z,{children:e})}),(0,r.jsx)(w,{children:o})]}),A&&(0,r.jsx)(t.Suspense,{fallback:null,children:(0,r.jsx)(M,{activeId:d})})]})})}a(5185),i.default.div`
  display: grid;
...
//# sourceMappingURL=913.02cce2c6181e3b639c2b.js.map