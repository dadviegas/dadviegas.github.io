"use strict";(self.webpackChunk_atlantis_csvexplorer=self.webpackChunk_atlantis_csvexplorer||[]).push([[554],{4914(a,o,n){n.d(o,{FlyoutPanel:()=>y});var e=n(7359),i=n(3233),t=n(7207),l=n(255),r=n(217),m=n(5959),c=n(5185),s=n(5723);const g=t.keyframes`
...
`,d=i.default.div`
  ...
  min-width: 210px;
  overflow-y: auto;
  animation: ${g} 0.18s cubic-bezier(0.4, 0, 0.2, 1) forwards;
...
`;function z({iconKey:a}){const o=a?c.t[a]??l.A:l.A;return(0,s.jsx)(o,{size:14,strokeWidth:1.75})}function p({entries:a,activeId:o,onSelect:n}){return(0,s.jsx)(s.Fragment,{children:a.map(a=>a.children?(0,s.jsx)(e.Fragment,{children:(0,s.jsx)(p,{entries:a.children,activeId:o,onSelect:n})},a.id):(0,s.jsxs)(f,{active:o===a.id,onClick:()=>n(a),children:[(0,s.jsx)(z,{iconKey:a.icon}),a.name]},a.id))})}function y({activeId:a}){const{flyout:o,scheduleFlyoutClose:n,cancelFlyoutClose:e}=(0,m.c)();if(!o)return null;const i=o.entry.icon?c.t[o.entry.icon]??l.A:l.A;return(0,s.jsxs)(d,{anchorY:o.anchorY,onMouseEnter:e,onMouseLeave:n,children:[(0,s.jsxs)(u,{children:[(0,s.jsx)(i,{size:13,strokeWidth:2}),o.entry.name]}),(0,s.jsx)(p,{entries:o.entry.children??[],activeId:a,onSelect:a=>{o.onSelect(a),n()}})]})}},5959(a,o,n){n.d(o,{c:()=>t});var e=n(7359);const i=(0,e.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),t=()=>(0,e.useContext)(i)},5185(a,o,n){n.d(o,{t:()=>R});var e=n(9038),i=n(6896),t=n(7901),l=n(9848),r=n(2164),m=n(3539),c=n(1783),s=n(1837),g=n(2314),d=n(5751),u=n(255),f=n(9633),z=n(2946),p=n(822),y=n(3317),b=n(2709),h=n(3517),A=n(7032),x=n(6949),w=n(8218),k=n(6829),v=n(5553),S=n(9591),M=n(2820),B=n(4621),$=n(6673),E=n(9033),P=n(1365),T=n(5912),C=n(8641),j=n(3249),L=n(9161),N=n(2932),D=n(4525),K=n(7230);const R={activity:i.A,book:l.A,clock:c.A,"book-open":t.A,"circle-dot":m.A,feather:g.A,"file-text":d.A,hash:y.A,heart:b.A,landmark:h.A,leaf:x.A,map:S.A,package:$.A,compass:s.A,"git-branch":z.A,github:p.A,minus:B.A,terminal:j.A,"pie-chart":e.A,plus:P.A,slash:T.A,star:C.A,zap:K.A,bot:r.A,lightbulb:w.A,"message-square":M.A,wrench:N.A,x:D.A,"layout-grid":A.A,list:k.A,file:u.A,folder:f.A,"map-pin":v.A,"pen-tool":E.A,type:L.A}},906(a,o,n){n.d(o,{w4:()=>e.w});var e=n(217),i=(n(7359),n(3233));n(5723),i.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
