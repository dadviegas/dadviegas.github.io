...
`;function _({title:e,icon:a,entries:o,activeId:i,onSelect:n,favorites:l,onToggleFav:s,collapsed:d}){let[c,p]=(0,r.useState)(!1);return o.length?(0,t.jsxs)(P,{children:[(0,t.jsxs)(V,{collapsed:d,onClick:()=>{d||p(e=>!e)},children:[(0,t.jsxs)(O,{collapsed:d,children:[a,(0,t.jsx)(N,{collapsed:d,children:e})]}),(0,t.jsx)(D,{open:c,collapsed:d,children:(0,t.jsx)(w,{name:"chevron-right",size:12})})]}),(0,t.jsx)(I,{open:c&&!d,children:(0,t.jsx)(Y,{children:o.map(e=>{let a=l.some(a=>a.id===e.id);return(0,t.jsxs)(G,{children:[(0,t.jsx)(W,{active:i===e.id,onClick:()=>n(e),children:e.name}),(0,t.jsx)(K,{active:a,title:a?"Remover dos favoritos":"Adicionar aos favoritos",onClick:a=>{a.stopPropagation(),s(e)},children:(0,t.jsx)(w,{name:"star",size:12})})]},e.id)})})})]}):null}function U({config:e,activeId:a,onSelect:o,hashPrefix:n}){let l=`atlantis-recent-${n}`,s=`atlantis-fav-${n}`,{collapsed:d}=(0,i.cL)(),[c,p]=(0,r.useState)(()=>R(l)),[m,g]=(0,r.useState)(()=>R(s)),h=(0,r.useCallback)(e=>{e.file&&p(a=>{let o;return o=[e,...a.filter(a=>a.id!==e.id)].slice(0,10),localStorage.setItem(l,JSON.stringify(o)),o}),o(e)},[o,l]),f=(0,r.useCallback)(e=>{g(a=>{let o;return o=a.some(a=>a.id===e.id)?a.filter(a=>a.id!==e.id):[...a,e],localStorage.setItem(s,JSON.stringify(o)),o})},[s]);return(0,t.jsxs)(E,{children:[(0,t.jsx)(_,{title:"Recentes",icon:(0,t.jsx)(w,{name:"clock",size:13}),entries:c,activeId:a,onSelect:h,favorites:m,onToggleFav:f,collapsed:d}),(0,t.jsx)(_,{title:"Favoritos",icon:(0,t.jsx)(w,{name:"star",size:13}),entries:m,activeId:a,onSelect:h,favorites:m,onToggleFav:f,collapsed:d}),(0,t.jsx)(i.CD,{entries:e.entries,activeId:a,onSelect:h})]})}var q=o(1352),J=o(6710),Z=o(3639),X=o(80),Q=o(4311);let ee="https://cdn.jsdelivr.net/npm/mermaid@11.14.0/dist/mermaid.min.js",ea=null,eo="#7fb77e",et=(0,y.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,er=l().div`
  position: relative;
...
`,eA=l().div`
  ...
  color: ${i.w4.colors.mainText};
  text-align: center;
`;function eC(e){return e.toString().padStart(2,"0")}function eB({hours:e,minutes:a,seconds:o}){let r=e=>e*Math.PI/180,n=o/60*360-90,l=a/60*360+o/60*6-90,s=e%12/12*360+a/60*30-90,d=100+61*Math.cos(r(n)),c=100+61*Math.sin(r(n)),p=100+65*Math.cos(r(l)),m=100+65*Math.sin(r(l)),g=100+45*Math.cos(r(s)),h=100+45*Math.sin(r(s));return(0,t.jsxs)("svg",{viewBox:"0 0 200 200",width:200,height:200,children:[(0,t.jsx)("circle",{cx:100,cy:100,r:85,fill:i.w4.colors.surface,stroke:i.w4.colors.border,strokeWidth:2}),Array.from({length:12},(e,a)=>{let o=a+1,n=o/12*360-90,l=100+69*Math.cos(r(n)),s=100+69*Math.sin(r(n));return(0,t.jsx)("text",{x:l,y:s+4,fill:i.w4.colors.mainText,fontSize:14,fontWeight:600,textAnchor:"middle",fontFamily:i.w4.typography.fontFamily,children:o},o)}),Array.from({length:60},(e,a)=>{let o=a/60*360-90,n=a%5==0,l=n?75:79;return(0,t.jsx)("line",{x1:100+l*Math.cos(r(o)),y1:100+l*Math.sin(r(o)),x2:100+83*Math.cos(r(o)),y2:100+83*Math.sin(r(o)),stroke:n?i.w4.colors.mainTextMuted:i.w4.colors.border,strokeWidth:n?2:1},a)}),(0,t.jsx)("line",{x1:100,y1:100,x2:g,y2:h,stroke:i.w4.colors.mainText,strokeWidth:4,strokeLinecap:"round"}),(0,t.jsx)("line",{x1:100,y1:100,x2:p,y2:m,stroke:i.w4.colors.accent,strokeWidth:2.5,strokeLinecap:"round"}),(0,t.jsx)("line",{x1:100-12*Math.cos(r(n)),y1:100-12*Math.sin(r(n)),x2:d,y2:c,stroke:"#f87171",strokeWidth:1.2,strokeLinecap:"round"}),(0,t.jsx)("circle",{cx:100,cy:100,r:4,fill:i.w4.colors.accent}),(0,t.jsx)("circle",{cx:100,cy:100,r:2,fill:"#f87171"})]})}function eF({code:e}){let a=function(e){let a="pt";for(let o of e.trim().split("\n")){let[e,...t]=o.split(":"),r=t.join(":").trim();"locale"===e.trim().toLowerCase()&&(a=r.toLowerCase())}return{locale:a}}(e),[o,i]=(0,r.useState)("live"),[n,l]=(0,r.useState)(()=>new Date().getHours()),[s,d]=(0,r.useState)(()=>new Date().getMinutes()),[c,p]=(0,r.useState)(()=>new Date().getSeconds());(0,r.useEffect)(()=>{if("live"!==o)return;let e=()=>{let e=new Date;l(e.getHours()),d(e.getMinutes()),p(e.getSeconds())};e();let a=setInterval(e,1e3);return()=>clearInterval(a)},[o]);let m=(0,r.useCallback)(e=>{i("manual"),p(0),l(a=>((a+e)%24+24)%24)},[]),g=(0,r.useCallback)(e=>{i("manual"),p(0),d(a=>((a+e)%60+60)%60)},[]),h=(0,r.useCallback)(()=>i("live"),[]);return(0,t.jsxs)(ez,{children:[(0,t.jsxs)(eM,{children:[(0,t.jsx)(eB,{hours:n,minutes:s,seconds:c}),(0,t.jsxs)("div",{children:[(0,t.jsxs)(ek,{children:[eC(n),":",eC(s),(0,t.jsxs)("span",{style:{fontSize:"24px",opacity:.5},children:[":",eC(c)]})]}),(0,t.jsx)(eA,{children:function(e,a,o){if("pt"===o){let o=1===e?"1 hora":`${e} horas`;return 0===a?o:15===a?`${o} e um quarto`:30===a?`${o} e meia`:45===a?`um quarto para as ${12===e?1:e+1}`:`${o} e ${a} minutos`}let t=e<12?"AM":"PM",r=e%12||12;return 0===a?`${r} o'clock ${t}`:15===a?`quarter past ${r} ${t}`:30===a?`half past ${r} ${t}`:45===a?`quarter to ${r%12+1} ${t}`:`${r}:${eC(a)} ${t}`}(n%12||12,s,a.locale)})]})]}),(0,t.jsxs)(ej,{children:[(0,t.jsx)(eT,{onClick:()=>m(-1),children:"−1h"}),(0,t.jsx)(eT,{onClick:()=>m(1),children:"+1h"}),(0,t.jsx)(eT,{onClick:()=>g(-15),children:"−15m"}),(0,t.jsx)(eT,{onClick:()=>g(15),children:"+15m"}),(0,t.jsx)(eT,{onClick:()=>g(-5),children:"−5m"}),(0,t.jsx)(eT,{onClick:()=>g(5),children:"+5m"}),(0,t.jsx)(eT,{active:"live"===o,onClick:h,children:"pt"===a.locale?"Agora":"Now"})]}),(0,t.jsx)(eS,{children:"pt"===a.locale?"Usa os bot\xf5es para mudar as horas e os minutos!":"Use the buttons to change the hours and minutes!"}),(0,t.jsx)(ej,{children:[{label:"3:00",h:3,m:0},{label:"6:30",h:6,m:30},{label:"9:15",h:9,m:15},{label:"12:00",h:12,m:0},{label:"13:45",h:13,m:45},{label:"15:30",h:15,m:30},{label:"19:00",h:19,m:0},{label:"23:15",h:23,m:15}].map(e=>(0,t.jsx)(eT,{onClick:()=>{i("manual"),l(e.h),d(e.m)},children:e.label},e.label))})]})}let eL=["Samantha","Karen","Daniel","Moira","Rishi","Google UK English Female","Google US English"],eH=["Joana","Luciana","Catarina","Google portugu\xeas do Brasil"];function eR(e,a){if(!window.speechSynthesis)return;window.speechSynthesis.cancel();let o=new SpeechSynthesisUtterance(e);o.lang="pt"===a?"pt-PT":"en-US",o.rate=1,o.pitch=1;let t=function(e,a){let o="en"===a?"en":"pt";for(let t of"en"===a?eL:eH){let a=e.find(e=>e.name.includes(t)&&e.lang.startsWith(o));if(a)return a}return e.find(e=>e.lang.startsWith(o))}(window.speechSynthesis.getVoices(),a);t&&(o.voice=t,o.lang=t.lang),window.speechSynthesis.speak(o)}let eE=(0,y.keyframes)`
...
`,eK=l().span`
  font-size: ${i.w4.typography.fontSizeBase};
  color: ${i.w4.colors.mainTextMuted};
`;function e_({code:e}){let a=e.split("\n").map(e=>e.trim()).filter(e=>e&&e.includes("|")).map(e=>{let[a,o]=e.split("|").map(e=>e.trim());return{en:a??"",pt:o??""}}).filter(e=>e.en&&e.pt),o=(0,r.useRef)(null),i=(0,r.useRef)(!1),n=(0,r.useCallback)(e=>{o.current={x:e.touches[0].clientX,y:e.touches[0].clientY}},[]),l=(0,r.useCallback)((e,a)=>t=>{if(!o.current)return;let r=Math.abs(t.changedTouches[0].clientX-o.current.x),n=Math.abs(t.changedTouches[0].clientY-o.current.y);o.current=null,r>8||n>8||(i.current=!0,eR(e,a))},[]),s=(0,r.useCallback)((e,a)=>()=>{if(i.current){i.current=!1;return}eR(e,a)},[]);return a.length?(0,t.jsxs)(eP,{children:[(0,t.jsxs)(eV,{children:[(0,t.jsx)(w,{name:"volume-2",size:12}),"Words to Listen / Palavras para Ouvir"]}),(0,t.jsx)(eO,{children:a.map(e=>(0,t.jsxs)(eN,{children:[(0,t.jsxs)(eI,{accentColor:"#58a6ff",onTouchStart:n,onTouchEnd:l(e.en,"en"),onClick:s(e.en,"en"),title:`Listen: ${e.en}`,children:[(0,t.jsx)(eG,{accentColor:"#58a6ff",children:(0,t.jsx)(w,{name:"volume-2",size:16})}),(0,t.jsx)(eW,{children:e.en})]}),(0,t.jsxs)(eY,{accentColor:"#3fb950",onTouchStart:n,onTouchEnd:l(e.pt,"pt"),onClick:s(e.pt,"pt"),title:`Ouvir: ${e.pt}`,children:[(0,t.jsx)(eG,{accentColor:"#3fb950",children:(0,t.jsx)(w,{name:"volume-2",size:16})}),(0,t.jsx)(eK,{children:e.pt})]})]},e.en))})]}):null}var eU=o(7223),eq=o(1426);let eJ=l().div`
  margin: ${i.w4.spacing.lg} 0;
  border-radius: ${i.w4.borderRadius.md};
  border: 1px solid ${i.w4.colors.codeBorder};
  overflow: hidden;
...
`;function e6({type:e,children:a}){let o=e2[e]??e2.NOTE;return(0,t.jsxs)(e4,{bg:o.bg,border:o.border,children:[(0,t.jsxs)(e5,{color:o.color,children:[(0,t.jsx)(w,{name:o.icon,size:15,strokeWidth:2}),o.label]}),(0,t.jsx)(e3,{children:a})]})}let e8=l().nav`
  width: 220px;
  min-width: 220px;
...
`;function aa({headings:e,activeId:a}){return e.length<2?null:(0,t.jsxs)(e8,{children:[(0,t.jsx)(e7,{children:"On this page"}),(0,t.jsx)(e9,{children:e.map(e=>(0,t.jsx)("li",{children:(0,t.jsx)(ae,{href:`#${e.id}`,active:a===e.id,level:e.level,onClick:a=>{a.preventDefault(),document.getElementById(e.id)?.scrollIntoView({behavior:"smooth",block:"start"})},children:e.text})},e.id))})]})}function ao(e){return e.toLowerCase().replace(/[*_`[\]()#]/g,"").replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-").trim()}function at(){return e=>{!function e(a){if("blockquote"===a.type){let e=a.children?.[0];if(e?.type==="paragraph"){let o=e.children?.[0];if(o?.type==="text"){let t=o.value?.match(/^\[!(NOTE|TIP|WARNING|CAUTION|IMPORTANT)\]\s*/i);t&&(o.value=o.value.slice(t[0].length),o.value.trim()||1!==e.children.length||a.children.shift(),a.data=a.data??{},a.data.hName="div",a.data.hProperties={"data-callout":t[1].toUpperCase()})}}}a.children?.forEach(e)}(e)}}let ar=l().div`
  display: flex;
  align-items: flex-start;
  max-width: 1200px;
  margin: 0 auto;
...
`,ap=l().div`
  ...
  font-family: ${i.w4.typography.fontFamily};
`;function am(e){return function({children:a,...o}){let i=`h${e}`,n=function e(a){return r.Children.toArray(a).map(a=>"string"==typeof a?a:"number"==typeof a?String(a):(0,r.isValidElement)(a)?e(a.props.children??""):"").join("")}(a),l=ao(n);return(0,t.jsxs)(i,{id:l,...o,children:[a,(0,t.jsx)("a",{className:"heading-anchor",href:`#${l}`,"aria-label":`Link to "${n}"`,children:(0,t.jsx)(w,{name:"link",size:14})})]})}}function ag({file:e,prevEntry:a,nextEntry:i,onNavigate:n,scrollToId:l,onScrolled:s}){let[d,c]=(0,r.useState)(null),[p,m]=(0,r.useState)(null),g=(0,r.useRef)(null);if((0,r.useEffect)(()=>{c(null),fetch(`${o.p}content/${e}`).then(e=>{if(!e.ok)throw Error(`${e.status} ${e.statusText}`);return e.text()}).then(c).catch(a=>c(`> **Error loading \`${e}\`:** ${a.message}`))},[e]),(0,r.useEffect)(()=>{if(!l||!d||!g.current)return;let e=setTimeout(()=>{let e=g.current?.querySelector(`#${CSS.escape(l)}`);e&&(e.scrollIntoView({behavior:"smooth",block:"start"}),m(l),s?.())},150);return()=>clearTimeout(e)},[l,d,s]),(0,r.useEffect)(()=>{if(!d||!g.current)return;let e=g.current,a=Array.from(e.querySelectorAll("h2[id], h3[id]"));if(!a.length)return;let o=e.parentElement;for(;o;){let{overflowY:e}=getComputedStyle(o);if(("auto"===e||"scroll"===e)&&o.scrollHeight>o.clientHeight)break;o=o.parentElement}let t=o??window,r=()=>{let e=a[0].id;for(let o of a)if(o.getBoundingClientRect().top-120<=0)e=o.id;else break;m(e)};return r(),t.addEventListener("scroll",r,{passive:!0}),window.addEventListener("resize",r),()=>{t.removeEventListener("scroll",r),window.removeEventListener("resize",r)}},[d]),null===d)return(0,t.jsx)(ap,{children:"Loading…"});let h=function(e){let a,o=[],t=/^(#{2,3})\s+(.+)$/gm;for(;null!==(a=t.exec(e));){let e=a[1].length,t=a[2].trim().replace(/\*\*(.+?)\*\*/g,"$1").replace(/\*(.+?)\*/g,"$1").replace(/`(.+?)`/g,"$1").replace(/\[(.+?)\]\(.+?\)/g,"$1");o.push({level:e,text:t,id:ao(t)})}return o}(d),f=a||i;return(0,t.jsxs)(ar,{children:[(0,t.jsxs)(ai,{children:[(0,t.jsx)(an,{ref:g,children:(0,t.jsx)(q.oz,{remarkPlugins:[J.A,Q.A,at],rehypePlugins:[Z.A,X.A],components:{div({node:e,children:a,...o}){let r=o["data-callout"];return r?(0,t.jsx)(e6,{type:r,children:a}):(0,t.jsx)("div",{...o,children:a})},h1:am(1),h2:am(2),h3:am(3),h4:am(4),pre:({children:e})=>(0,t.jsx)(t.Fragment,{children:e}),code({className:e,children:a}){let o=/language-(\w+)/.exec(e??"")?.[1],r=String(a).replace(/\n$/,"");return"mermaid"===o?(0,t.jsx)(ed,{code:r}):"chart"===o?(0,t.jsx)(e$,{code:r}):"clock"===o?(0,t.jsx)(eF,{code:r}):"vocabulary"===o?(0,t.jsx)(e_,{code:r}):o||r.includes("\n")?(0,t.jsx)(e0,{lang:o,code:r}):(0,t.jsx)("code",{className:e,children:a})}},children:d})}),f&&(0,t.jsxs)(al,{children:[a?(0,t.jsxs)(as,{align:"left",onClick:()=>n?.(a),children:[(0,t.jsxs)(ad,{children:[(0,t.jsx)(w,{name:"chevron-left",size:13})," Previous"]}),(0,t.jsx)(ac,{children:a.name})]}):(0,t.jsx)("div",{style:{flex:1}}),i?(0,t.jsxs)(as,{align:"right",onClick:()=>n?.(i),children:[(0,t.jsxs)(ad,{children:["Next ",(0,t.jsx)(w,{name:"chevron-right",size:13})]}),(0,t.jsx)(ac,{children:i.name})]}):(0,t.jsx)("div",{style:{flex:1}})]})]}),(0,t.jsx)(aa,{headings:h,activeId:p})]})}let ah=(0,y.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,af=(0,y.keyframes)`
...
`,aH=l().div`
  ...
  font-size: ${i.w4.typography.fontSizeSm};
  text-align: center;
`,aR=new Map;async function aE(e){let a=aR.get(e);if(void 0!==a)return a;try{let a=await fetch(`${o.p}content/${e}`);if(!a.ok)return"";let t=await a.text();return aR.set(e,t),t}catch{return aR.set(e,""),""}}function aP(e){return e.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,"")}function aV({open:e,onClose:a,entries:o,activeId:n,onSelect:l}){let[s,d]=(0,r.useState)(""),[c,p]=(0,r.useState)([]),[m,g]=(0,r.useState)(!1),[h,f]=(0,r.useState)(0),u=(0,r.useRef)(null),x=(0,r.useRef)(),y=(0,r.useMemo)(()=>(function e(a,o=""){return a.flatMap(a=>a.children?e(a.children,a.name):a.file?[{entry:a,parentName:o}]:[])})(o),[o]);(0,r.useEffect)(()=>{e&&(d(""),p([]),f(0),setTimeout(()=>u.current?.focus(),50))},[e]),(0,r.useEffect)(()=>{if(!e)return;let o=e=>{"Escape"===e.key&&(e.preventDefault(),a())};return window.addEventListener("keydown",o),()=>window.removeEventListener("keydown",o)},[e,a]);let b=(0,r.useCallback)(async e=>{if(e.length<2){p([]),g(!1);return}g(!0);let a=await Promise.all(y.map(async({entry:e,parentName:a})=>{let o=await aE(e.file);return{entry:e,parentName:a,text:o}})),o=[];for(let{entry:t,parentName:r,text:i}of a){let a=aP(t.name),n=aP(i),l=aP(e);if(!a.includes(l)&&!n.includes(l))continue;let{snippet:s,count:d,headingSlug:c,headingText:p}=function(e,a){let o=aP(e),t=aP(a),r=e.split("\n"),i=0,n=0;for(;-1!==(n=o.indexOf(t,n));)i++,n+=t.length;let l=null;for(let e of r){let o=e.match(/^#{1,4}\s+(.+)/);if(o&&(l=o[1].trim()),!e.trim()||e.startsWith("```")||e.startsWith("|--"))continue;let r=e.replace(/^#{1,6}\s*/,"").replace(/[*_`|]/g,"").trim(),n=r.normalize("NFD"),s=[],d=0;for(let e=0;e<n.length;e++){let a=n.charCodeAt(e);(!(a>=768)||!(a<=879))&&(s.push(d),d++)}s.push(d);let c=aP(r).indexOf(t);if(-1===c)continue;let p=s[c]??c,m=s[c+t.length]??p+a.length,g=Math.max(0,p-50),h=Math.min(r.length,m+70),f=g>0?"…":"",u=h<r.length?"…":"",x=r.slice(g,p),y=r.slice(p,m),b=r.slice(m,h);return{snippet:`${f}${x}<mark>${y}</mark>${b}${u}`,count:i,headingSlug:l?l.toLowerCase().replace(/[*_`[\]()#]/g,"").replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-").trim():null,headingText:l}}return{snippet:"",count:i,headingSlug:null,headingText:null}}(i,e),m=a.includes(l);o.push({entry:t,parentName:r,snippet:s||(m?t.name:""),matchCount:d+10*!!m,headingSlug:c,headingText:p})}o.sort((e,a)=>a.matchCount-e.matchCount),p(o),f(0),g(!1)},[y]);(0,r.useEffect)(()=>(clearTimeout(x.current),s.trim())?(x.current=setTimeout(()=>b(s.trim()),250),()=>clearTimeout(x.current)):void p([]),[s,b]);let v=(0,r.useCallback)(e=>{"ArrowDown"===e.key?(e.preventDefault(),f(e=>Math.min(e+1,c.length-1))):"ArrowUp"===e.key?(e.preventDefault(),f(e=>Math.max(e-1,0))):"Enter"===e.key&&c[h]&&(e.preventDefault(),l(c[h].entry,c[h].headingSlug),a())},[c,h,l,a]);return e?(0,t.jsx)(au,{onClick:e=>{e.target===e.currentTarget&&a()},children:(0,t.jsxs)(ax,{onKeyDown:v,children:[(0,t.jsxs)(ay,{children:[(0,t.jsx)(w,{name:"search",size:18,color:i.w4.colors.accent,style:{flexShrink:0}}),(0,t.jsx)(ab,{ref:u,placeholder:"Pesquisar em todo o conte\xfado…",value:s,onChange:e=>d(e.target.value)}),(0,t.jsx)(aw,{onClick:a,title:"Fechar (Esc)",children:(0,t.jsx)(w,{name:"close",size:14})})]}),(0,t.jsxs)(av,{children:[m&&(0,t.jsxs)(a$,{children:[(0,t.jsx)(az,{children:(0,t.jsx)(w,{name:"loader",size:14})}),"A pesquisar ",y.length," ficheiros…"]}),!m&&s.length>=2&&c.length>0&&(0,t.jsxs)(a$,{children:[(0,t.jsx)(w,{name:"file-text",size:13}),c.length," ",1===c.length?"resultado":"resultados"," encontrados"]}),!m&&s.length>=2&&0===c.length&&(0,t.jsxs)(aH,{children:[(0,t.jsx)(w,{name:"search",size:32,strokeWidth:1.2}),'Nenhum resultado para "',(0,t.jsx)("strong",{children:s}),'"']}),!m&&s.length<2&&(0,t.jsxs)(aH,{children:[(0,t.jsx)(w,{name:"search",size:32,strokeWidth:1.2}),"Escreve pelo menos 2 caracteres para pesquisar"]}),c.map((e,o)=>(0,t.jsxs)(aM,{selected:o===h,onClick:()=>{l(e.entry,e.headingSlug),a()},onMouseEnter:()=>f(o),children:[(0,t.jsx)(ak,{selected:o===h,children:(0,t.jsx)(w,{name:"file-text",size:15})}),(0,t.jsxs)(aj,{children:[(0,t.jsxs)(aT,{children:[e.entry.name,e.matchCount>0&&(0,t.jsx)(aA,{children:e.matchCount>10?e.matchCount-10:e.matchCount})]}),(e.parentName||e.headingText)&&(0,t.jsxs)(aS,{children:[e.parentName,e.parentName&&e.headingText?" › ":"",e.headingText]}),e.snippet&&(0,t.jsx)(aC,{dangerouslySetInnerHTML:{__html:e.snippet}})]}),(0,t.jsx)(aB,{selected:o===h,children:(0,t.jsx)(w,{name:"arrow-right",size:14})})]},e.entry.id))]}),(0,t.jsxs)(aF,{children:[(0,t.jsxs)("span",{children:[(0,t.jsx)(aL,{children:"↑"})," ",(0,t.jsx)(aL,{children:"↓"})," navegar"]}),(0,t.jsxs)("span",{children:[(0,t.jsx)(aL,{children:"↵"})," abrir"]}),(0,t.jsxs)("span",{children:[(0,t.jsx)(aL,{children:"esc"})," fechar"]})]})]})}):null}function aO(e,a){for(let o of e){if(o.id===a)return o;if(o.children){let e=aO(o.children,a);if(e)return e}}}function aN(e){return e.flatMap(e=>e.children?aN(e.children):e.file?[e]:[])}let aD=l().div`
  display: flex;
  align-items: center;
  justify-content: center;
  height: 100%;
...
`,aq={en:"Browse the sidebar",pt:"Explora o menu lateral"};function aJ({title:e,sub:a,lang:o}){return(0,t.jsxs)(aD,{children:[(0,t.jsx)(aY,{}),(0,t.jsx)(aI,{size:500,x:10,y:-10,hue:210,dur:7}),(0,t.jsx)(aI,{size:400,x:60,y:50,hue:270,dur:9}),(0,t.jsx)(aI,{size:300,x:30,y:70,hue:190,dur:6}),(0,t.jsxs)(aG,{children:[(0,t.jsx)(aW,{children:e}),(0,t.jsx)(aK,{children:a}),(0,t.jsxs)(a_,{children:[(0,t.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round",children:(0,t.jsx)("polyline",{points:"15 18 9 12 15 6"})}),aq[o]??aq.en]})]})]})}function aZ(e,a,o){return"string"==typeof e?e:e[a]??e[o]??Object.values(e)[0]??""}function aX({navigation:e,languages:a,defaultLang:o,locale:n,hashPrefix:l,topBarRight:s,welcomeTitle:d="Blog",welcomeSub:c="Notes, guides, and references — pick a topic from the sidebar to get started."}){let p=a?Object.keys(a):[];p.length;let[m,g]=(0,r.useState)(()=>o??p[0]??"");(0,r.useEffect)(()=>{n&&p.includes(n)&&n!==m&&g(n)},[n]);let h=(0,r.useMemo)(()=>a&&m?a[m].navigation:e??{entries:[]},[a,e,m]);(0,r.useMemo)(()=>aN(h.entries),[h]);let f=(0,r.useCallback)(e=>{let a=e.match(RegExp(`^#\\/${l}\\/(.+)$`));if(a)return aO(h.entries,a[1])},[h,l]),[u,x]=(0,r.useState)(()=>f(window.location.hash)??null);(0,r.useEffect)(()=>{u&&x(aO(h.entries,u.id)??null)},[m,h]),(0,r.useEffect)(()=>{let e=()=>{let e=f(window.location.hash);e&&x(e)};return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[f]);let y=(0,r.useCallback)(e=>{e.file&&(x(e),window.location.hash=`#/${l}/${e.id}`)},[l]),b=(0,r.useMemo)(()=>aN(h.entries),[h]),v=b.findIndex(e=>e.id===u?.id),$=v>0?b[v-1]:null,z=v<b.length-1?b[v+1]:null,[M,k]=(0,r.useState)(!1),[j,T]=(0,r.useState)(null);(0,r.useEffect)(()=>{let e=e=>{(e.metaKey||e.ctrlKey)&&"f"===e.key&&(e.preventDefault(),k(!0))};return window.addEventListener("keydown",e),()=>window.removeEventListener("keydown",e)},[]);let S=u?.label??u?.name??l,A=aZ(d,m,o??p[0]??""),C=aZ(c,m,o??p[0]??""),B=(0,t.jsxs)(aU,{onClick:()=>k(!0),title:"Pesquisar (Ctrl+F)",children:[(0,t.jsx)(w,{name:"search",size:14}),(0,t.jsx)("span",{children:"Pesquisar"}),(0,t.jsx)("kbd",{children:"⌘F"})]}),F=(0,t.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:"8px"},children:[B,s]});return(0,t.jsxs)(i.PE,{title:S,activeId:u?.id??null,topBarRight:F,sidebar:(0,t.jsx)(U,{config:h,activeId:u?.id??null,onSelect:y,hashPrefix:l}),children:[u?.file?(0,t.jsx)(ag,{file:u.file,prevEntry:$,nextEntry:z,onNavigate:y,scrollToId:j,onScrolled:()=>T(null)}):(0,t.jsx)(aJ,{title:A,sub:C,lang:m}),(0,t.jsx)(aV,{open:M,onClose:()=>k(!1),entries:h.entries,activeId:u?.id??null,onSelect:(e,a)=>{y(e),T(a??null)}})]})}l().div`
  display: flex;
  gap: 4px;
  background: ${i.w4.colors.surface};
  border: 1px solid ${i.w4.colors.border};
...
`,l().span`
  ...
  font-weight: 600;
  margin-left: auto;
`},8170(e,a,o){o.d(a,{Ym:()=>d});var t=o(7991),r=o(4764);let i="atlantis:locale",n="shell:locale";function l(e){return"en"===e||"pt"===e}function s(){try{let e=localStorage.getItem(i);if(l(e))return e}catch{}return"en"}function d(){let[e,a]=(0,t.useState)(s),o=(0,t.useCallback)(e=>{a(e);try{localStorage.setItem(i,e)}catch{}(0,r.Is)(n,e).catch(()=>{}),window.dispatchEvent(new CustomEvent("atlantis:locale-change",{detail:e}))},[]);return(0,t.useEffect)(()=>{let e=e=>{a(e.detail)};return window.addEventListener("atlantis:locale-change",e),()=>window.removeEventListener("atlantis:locale-change",e)},[]),(0,t.useEffect)(()=>{(0,r.PL)(n).then(o=>{if(l(o)&&o!==e){try{localStorage.setItem(i,o)}catch{}a(o)}}).catch(()=>{})},[]),[e,o]}(0,r.PL)(n).then(e=>{if(l(e))try{localStorage.setItem(i,e)}catch{}}).catch(()=>{}),o(5723);var c=o(6859),p=o.n(c);p().div`
  display: flex;
  gap: 4px;
...
`},8859(e,a,o){o.d(a,{FlyoutPanel:()=>b});var t=o(5723),r=o(7991),i=o.n(r),n=o(6859),l=o.n(n),s=o(2799),d=o(1316),c=o(814),p=o(6140);let m=(0,s.keyframes)`
...
`,j=s().main`
  ...
  display: flex;
  flex-direction: column;
`,T=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function S(){return(0,r.jsx)(y,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:T.map((e,a)=>(0,r.jsx)(b,{index:a,accent:e.accent,children:e.char},a))})}let A="atlantis:sidebar-collapsed";function C({sidebar:e,children:a,topBarRight:t,title:l="Atlantis",activeId:s=null}){let[d,p]=(0,i.useState)(()=>{try{return"true"===localStorage.getItem(A)}catch{return!1}}),[m,g]=(0,i.useState)(null),x=(0,i.useRef)(),y=()=>p(e=>{let a=!e;try{localStorage.setItem(A,String(a))}catch{}return a}),b=n().useMemo(()=>n().lazy(()=>Promise.resolve().then(o.bind(o,8859)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(c.I.Provider,{value:{collapsed:d,toggle:y,flyout:m,openFlyout:(e,a,o)=>{clearTimeout(x.current),g({entry:e,anchorY:a,onSelect:o})},scheduleFlyoutClose:()=>{x.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(x.current)},children:(0,r.jsxs)(z,{children:[(0,r.jsxs)(h,{children:[e&&(0,r.jsx)(f,{children:(0,r.jsx)(u,{onClick:y,title:d?"Expand sidebar":"Collapse sidebar",children:(0,r.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,r.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,r.jsx)("path",{d:"M9 3v18"})]})})}),(0,r.jsx)(S,{}),l&&(0,r.jsx)(w,{children:l}),t&&(0,r.jsx)(v,{children:t})]}),(0,r.jsxs)($,{children:[null!=e&&(0,r.jsx)(M,{collapsed:d,children:(0,r.jsx)(k,{children:e})}),(0,r.jsx)(j,{children:a})]}),m&&(0,r.jsx)(n().Suspense,{fallback:null,children:(0,r.jsx)(b,{activeId:s})})]})})}var B=o(6140);let F=s().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
...
`;function D({iconKey:e,size:a=16}){let o=e?B.X[e]:void 0;return o?(0,r.jsx)("svg",{width:a,height:a,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,dangerouslySetInnerHTML:{__html:o}}):e?(0,r.jsx)("span",{style:{fontSize:a,lineHeight:1,display:"flex",alignItems:"center"},children:e}):(0,r.jsxs)("svg",{width:a,height:a,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,children:[(0,r.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,r.jsx)("polyline",{points:"14 2 14 8 20 8"})]})}function I({entry:e,activeId:a,onSelect:o}){let[t,n]=(0,i.useState)(e.defaultOpen??!0),{collapsed:l,openFlyout:s,scheduleFlyoutClose:d,cancelFlyoutClose:p}=(0,c.c)();return e.children&&e.children.length>0?(0,r.jsxs)(R,{children:[(0,r.jsxs)(E,{collapsed:l,onClick:()=>{l||n(e=>!e)},onMouseEnter:l?a=>{s(e,a.currentTarget.getBoundingClientRect().top,o)}:void 0,onMouseLeave:l?d:void 0,children:[(0,r.jsxs)(P,{collapsed:l,children:[(0,r.jsx)(D,{iconKey:e.icon,size:16}),(0,r.jsx)(V,{collapsed:l,children:e.name})]}),(0,r.jsx)(O,{open:t,collapsed:l,children:(0,r.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round",children:(0,r.jsx)("path",{d:"M9 6l6 6-6 6"})})})]}),(0,r.jsx)(F,{open:t&&!l,children:(0,r.jsx)(L,{children:(0,r.jsx)(H,{children:e.children.map(e=>(0,r.jsx)(I,{entry:e,activeId:a,onSelect:o},e.id))})})})]}):(0,r.jsxs)(N,{active:a===e.id,collapsed:l,onClick:()=>o(e),onMouseEnter:l?a=>{let t=a.currentTarget.getBoundingClientRect();s({id:e.id,name:e.name,icon:e.icon,file:e.file,children:[e]},t.top,o)}:void 0,onMouseLeave:l?d:void 0,children:[(0,r.jsx)(D,{iconKey:e.icon,size:15}),(0,r.jsx)(V,{collapsed:l,children:e.name})]})}function Y({entries:e,activeId:a,onSelect:o}){return(0,r.jsx)("div",{children:e.map(e=>(0,r.jsx)(I,{entry:e,activeId:a,onSelect:o},e.id))})}o(8859),s().button`
  display: flex;
  align-items: center;
  justify-content: center;
  width: 32px;
