...
ReactDOM.createRoot(document.getElementById('root')!).render(<App />);`}]},7330(o,e,t){t.d(e,{FlyoutPanel:()=>oR});var a=t(5723),r=t(7991),n=t.n(r),i=t(6859),l=t.n(i),s=t(2799),d=t(255),c=t(1316),p=t(814),g=t(6896),m=t(7902),f=t(3013),x=t(2887),u=t(9510),b=t(9848),h=t(7901),y=t(3045),w=t(3775),$=t(1783),v=t(3539),z=t(9416),k=t(1837),M=t(7167),A=t(4494),T=t(2314),S=t(5751),j=t(9633),F=t(2946),B=t(822),C=t(6720),R=t(7400),E=t(8456),L=t(3317),P=t(2709),H=t(8006),D=t(9301),I=t(7561),N=t(3517),K=t(8207),V=t(7032),Y=t(6949),G=t(8218),_=t(6829),O=t(9591),W=t(5553),J=t(9923),U=t(2820),Z=t(4621),q=t(8479),X=t(2534),Q=t(6673),oo=t(7490),oe=t(9033),ot=t(9038),oa=t(5775),or=t(1365),on=t(2937),oi=t(9821),ol=t(5912),os=t(158),od=t(8641),oc=t(8607),op=t(3249),og=t(1821),om=t(5889),of=t(9655),ox=t(7170),ou=t(9161),ob=t(1849),oh=t(1604),oy=t(3142),ow=t(1187),o$=t(7747),ov=t(2932),oz=t(4525),ok=t(7230),oM=t(2164);let oA={activity:g.A,"a-large-small":m.A,apple:f.A,"arrow-right":x.A,"bar-chart-2":u.A,book:b.A,"book-open":h.A,briefcase:y.A,calendar:w.A,clock:$.A,"circle-dot":v.A,cloud:z.A,compass:k.A,cpu:M.A,droplets:A.A,feather:T.A,file:d.A,"file-text":S.A,folder:j.A,"git-branch":F.A,github:B.A,globe:C.A,grid:R.A,hand:E.A,hash:L.A,heart:P.A,key:H.A,hexagon:D.A,home:I.A,landmark:N.A,layers:K.A,"layout-grid":V.A,leaf:Y.A,lightbulb:G.A,list:_.A,map:O.A,"map-pin":W.A,"message-circle":J.A,"message-square":U.A,minus:Z.A,monitor:q.A,mountain:X.A,package:Q.A,palette:oo.A,"pen-tool":oe.A,"pie-chart":ot.A,plane:oa.A,plus:or.A,ruler:on.A,shirt:oi.A,slash:ol.A,square:os.A,star:od.A,sun:oc.A,terminal:op.A,thermometer:og.A,triangle:om.A,trophy:of.A,truck:ox.A,type:ou.A,users:ob.A,"volume-2":oh.A,watch:oy.A,waves:ow.A,wind:o$.A,wrench:ov.A,x:oz.A,zap:ok.A,bot:oM.A},oT=(0,s.keyframes)`
...
`,s().div`
  position: relative;
`;var d=t(2799),c=t(3661),p=t(814);let g="260px",m="56px",f="48px",x=s().header`
  display: flex;
  align-items: center;
...
`,K=s().div`
  ...
  color: ${a.w4.colors.sidebarTextMuted};
  font-family: ${a.w4.typography.fontFamily};
`;function V({onSave:o,onUpdate:e,onCancel:t,existingDoc:a}){let[i,l]=(0,n.useState)(a?.name??""),s=(0,n.useRef)(null);return(0,n.useEffect)(()=>{s.current?.focus(),a&&s.current?.select()},[a]),(0,r.jsx)(E,{onClick:t,children:(0,r.jsxs)(L,{onClick:o=>o.stopPropagation(),children:[(0,r.jsx)(P,{children:"Save document"}),a&&e&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(K,{children:"Update the current version or save as a new one."}),(0,r.jsxs)(D,{children:[(0,r.jsx)(I,{onClick:t,children:"Cancel"}),(0,r.jsxs)(I,{danger:!0,onClick:e,children:['Update "',a.name,'"']})]}),(0,r.jsx)(N,{})]}),(0,r.jsx)(H,{ref:s,value:i,onChange:o=>l(o.target.value),onKeyDown:r=>{"Enter"===r.key&&i.trim()&&(a&&i.trim()===a.name&&e?e():o(i.trim())),"Escape"===r.key&&t()},placeholder:a?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,r.jsxs)(D,{children:[!a&&(0,r.jsx)(I,{onClick:t,children:"Cancel"}),(0,r.jsx)(I,{primary:!0,disabled:!i.trim(),onClick:()=>o(i.trim()),children:"Save as new"})]})]})})}let Y=(0,d.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,G=(0,d.keyframes)`
...
`;var _=t(5625),O=t(679),W=t(4872);let J=s().div`
  position: relative;
`,U=s().button`
  display: flex;
  align-items: center;
...
`;function on({appId:o,onLoad:e}){let[t,a]=(0,n.useState)(!1),[i,l]=(0,n.useState)([]),s=(0,n.useRef)(null),d=(0,n.useCallback)(()=>{(0,R.listDocs)(o).then(l).catch(()=>{})},[o]);(0,n.useEffect)(()=>{if(!t)return;d();let o=o=>{s.current&&!s.current.contains(o.target)&&a(!1)};return document.addEventListener("mousedown",o),()=>document.removeEventListener("mousedown",o)},[t,d]);let c=async(o,e)=>{o.stopPropagation(),await (0,R.deleteDoc)(e),l(o=>o.filter(o=>o.id!==e))};return(0,r.jsxs)(J,{ref:s,children:[(0,r.jsxs)(U,{onClick:()=>a(o=>!o),children:[(0,r.jsx)(_.A,{size:14}),"Saved",(0,r.jsx)(O.A,{size:13,style:{marginLeft:2}})]}),(0,r.jsxs)(Z,{open:t,children:[(0,r.jsx)(q,{children:"Saved versions"}),(0,r.jsx)(X,{children:0===i.length?(0,r.jsx)(Q,{children:"No saved documents yet."}):i.map(o=>{var t;return(0,r.jsxs)(oo,{children:[(0,r.jsxs)(oe,{onClick:()=>{e(o.content,o.id,o.name),a(!1)},children:[(0,r.jsx)(ot,{children:o.name}),(0,r.jsx)(oa,{children:(t=o.savedAt,new Intl.DateTimeFormat(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}).format(new Date(t)))})]}),(0,r.jsx)(or,{onClick:e=>c(e,o.id),title:"Delete",children:(0,r.jsx)(W.A,{size:13})})]},o.id)})})]})]})}s().div`
...
`;s().div`
  ...
  background: ${a.w4.colors.mainBg};
  font-family: ${a.w4.typography.fontFamily};
  animation: ${oi} 0.4s ease 0.15s both;
`,s().div`
  position: relative;
  width: 56px;
  height: 56px;
