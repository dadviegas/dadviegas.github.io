"use strict";(self.webpackChunk_atlantis_weather=self.webpackChunk_atlantis_weather||[]).push([[458],{4914(a,e,o){o.d(e,{FlyoutPanel:()=>z});var n=o(7359),i=o(3233),t=o(7207),l=o(255),r=o(217),m=o(5959),c=o(5185),s=o(5723);const d=t.keyframes`
...
`;function D({iconKey:a,size:e=16}){if(a&&!(a in E.t))return(0,l.jsx)("span",{style:{fontSize:e,lineHeight:1,display:"flex",alignItems:"center"},children:a});const o=a?E.t[a]??T.A:T.A;return(0,l.jsx)(o,{size:e,strokeWidth:1.75})}function H({entry:a,activeId:e,onSelect:o}){const[n,t]=(0,i.useState)(a.defaultOpen??!0),{collapsed:r,openFlyout:m,scheduleFlyoutClose:s,cancelFlyoutClose:d}=(0,c.c)();return a.children&&a.children.length>0?(0,l.jsxs)(R,{children:[(0,l.jsxs)(N,{collapsed:r,onClick:()=>{r||t(a=>!a)},onMouseEnter:r?e=>{const n=e.currentTarget.getBoundingClientRect();m(a,n.top,o)}:void 0,onMouseLeave:r?s:void 0,children:[(0,l.jsxs)(G,{collapsed:r,children:[(0,l.jsx)(D,{iconKey:a.icon,size:16}),(0,l.jsx)(I,{collapsed:r,children:a.name})]}),(0,l.jsx)(K,{open:n,collapsed:r,children:(0,l.jsx)(C.A,{size:13})})]}),(0,l.jsx)(j,{open:n&&!r,children:(0,l.jsx)(P,{children:(0,l.jsx)(L,{children:a.children.map(a=>(0,l.jsx)(H,{entry:a,activeId:e,onSelect:o},a.id))})})})]}):(0,l.jsxs)(F,{active:e===a.id,collapsed:r,onClick:()=>o(a),onMouseEnter:r?e=>{const n=e.currentTarget.getBoundingClientRect();m({id:a.id,name:a.name,icon:a.icon,file:a.file,children:[a]},n.top,o)}:void 0,onMouseLeave:r?s:void 0,children:[(0,l.jsx)(D,{iconKey:a.icon,size:15}),(0,l.jsx)(I,{collapsed:r,children:a.name})]})}function V({entries:a,activeId:e,onSelect:o}){return(0,l.jsx)("div",{children:a.map(a=>(0,l.jsx)(H,{entry:a,activeId:e,onSelect:o},a.id))})}const Y=r.keyframes`
