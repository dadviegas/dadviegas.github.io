"use strict";(self.webpackChunk_atlantis_codediff=self.webpackChunk_atlantis_codediff||[]).push([[449],{4914(e,o,a){a.d(o,{FlyoutPanel:()=>z});var n=a(7359),t=a(3233),i=a(7207),r=a(255),l=a(217),s=a(5959),c=a(5185),d=a(8104);const m=i.keyframes`
...
`;function p({iconKey:e}){const o=e?c.t[e]??r.A:r.A;return(0,d.jsx)(o,{size:14,strokeWidth:1.75})}function y({entries:e,activeId:o,onSelect:a}){return(0,d.jsx)(d.Fragment,{children:e.map(e=>e.children?(0,d.jsx)(n.Fragment,{children:(0,d.jsx)(y,{entries:e.children,activeId:o,onSelect:a})},e.id):(0,d.jsxs)(f,{active:o===e.id,onClick:()=>a(e),children:[(0,d.jsx)(p,{iconKey:e.icon}),e.name]},e.id))})}function z({activeId:e}){const{flyout:o,scheduleFlyoutClose:a,cancelFlyoutClose:n}=(0,s.c)();if(!o)return null;const t=o.entry.icon?c.t[o.entry.icon]??r.A:r.A;return(0,d.jsxs)(u,{anchorY:o.anchorY,onMouseEnter:n,onMouseLeave:a,children:[(0,d.jsxs)(g,{children:[(0,d.jsx)(t,{size:13,strokeWidth:2}),o.entry.name]}),(0,d.jsx)(y,{entries:o.entry.children??[],activeId:e,onSelect:e=>{o.onSelect(e),a()}})]})}},5959(e,o,a){a.d(o,{c:()=>i});var n=a(7359);const t=(0,n.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),i=()=>(0,n.useContext)(t)},5185(e,o,a){a.d(o,{t:()=>ne});var n=a(9510),t=a(9038),i=a(7400),r=a(8207),l=a(7902),s=a(6896),c=a(7901),d=a(9848),m=a(2164),u=a(3045),g=a(3775),f=a(3539),p=a(1783),y=a(1837),z=a(4494),b=a(2314),h=a(5751),x=a(255),w=a(9633),A=a(2946),v=a(822),$=a(6720),k=a(3317),S=a(2709),M=a(9301),j=a(3517),B=a(7032),T=a(6949),P=a(8218),E=a(6829),L=a(5553),C=a(9591),N=a(2820),D=a(4621),R=a(2534),F=a(6673),_=a(9033),K=a(1365),G=a(2937),H=a(5912),I=a(158),U=a(8641),Y=a(8607),V=a(3249),O=a(1821),J=a(5889),Z=a(7170),W=a(9161),q=a(1849),X=a(1187),Q=a(7747),ee=a(2932),oe=a(4525),ae=a(7230);const ne={activity:s.A,"a-large-small":l.A,"bar-chart-2":n.A,book:d.A,"book-open":c.A,briefcase:u.A,calendar:g.A,clock:p.A,"circle-dot":f.A,compass:y.A,droplets:z.A,feather:b.A,file:x.A,"file-text":h.A,folder:w.A,"git-branch":A.A,github:v.A,globe:$.A,grid:i.A,hash:k.A,heart:S.A,hexagon:M.A,landmark:j.A,layers:r.A,"layout-grid":B.A,leaf:T.A,lightbulb:P.A,list:E.A,map:C.A,"map-pin":L.A,"message-square":N.A,minus:D.A,mountain:R.A,package:F.A,"pen-tool":_.A,"pie-chart":t.A,plus:K.A,ruler:G.A,slash:H.A,square:I.A,star:U.A,sun:Y.A,terminal:V.A,thermometer:O.A,triangle:J.A,truck:Z.A,type:W.A,users:q.A,waves:X.A,wind:Q.A,wrench:ee.A,x:oe.A,zap:ae.A,bot:m.A}},5723(e,o,a){a.d(o,{UO:()=>U,MJ:()=>B,KL:()=>h,w4:()=>n.w4,mZ:()=>x});var n=a(217),t=a(7359),i=a(3233),r=a(8104);i.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,i.default.span`
  ...
  animation: ${d} 10s ease ${({index:e})=>.07*e}s infinite;
...
`,j=i.default.div`
  ...
  color: ${n.w4.colors.sidebarTextMuted};
  font-family: ${n.w4.typography.fontFamily};
`;function B({onSave:e,onUpdate:o,onCancel:a,existingDoc:n}){const[i,l]=(0,t.useState)(n?.name??""),s=(0,t.useRef)(null);return(0,t.useEffect)(()=>{s.current?.focus(),n&&s.current?.select()},[n]),(0,r.jsx)(w,{onClick:a,children:(0,r.jsxs)(A,{onClick:e=>e.stopPropagation(),children:[(0,r.jsx)(v,{children:"Save document"}),n&&o&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(j,{children:"Update the current version or save as a new one."}),(0,r.jsxs)(k,{children:[(0,r.jsx)(S,{onClick:a,children:"Cancel"}),(0,r.jsxs)(S,{danger:!0,onClick:o,children:['Update "',n.name,'"']})]}),(0,r.jsx)(M,{})]}),(0,r.jsx)($,{ref:s,value:i,onChange:e=>l(e.target.value),onKeyDown:t=>{"Enter"===t.key&&i.trim()&&(n&&i.trim()===n.name&&o?o():e(i.trim())),"Escape"===t.key&&a()},placeholder:n?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,r.jsxs)(k,{children:[!n&&(0,r.jsx)(S,{onClick:a,children:"Cancel"}),(0,r.jsx)(S,{primary:!0,disabled:!i.trim(),onClick:()=>e(i.trim()),children:"Save as new"})]})]})})}var T=a(8006),P=a(679),E=a(4872);const L=i.default.div`
  position: relative;
`,C=i.default.button`
  display: flex;
  align-items: center;
...
`;function U({appId:e,onLoad:o}){const[a,n]=(0,t.useState)(!1),[i,l]=(0,t.useState)([]),s=(0,t.useRef)(null),c=(0,t.useCallback)(()=>{(function(e){return b.listDocs(e)})(e).then(l).catch(()=>{})},[e]);(0,t.useEffect)(()=>{if(!a)return;c();const e=e=>{s.current&&!s.current.contains(e.target)&&n(!1)};return document.addEventListener("mousedown",e),()=>document.removeEventListener("mousedown",e)},[a,c]);return(0,r.jsxs)(L,{ref:s,children:[(0,r.jsxs)(C,{onClick:()=>n(e=>!e),children:[(0,r.jsx)(T.A,{size:14}),"Saved",(0,r.jsx)(P.A,{size:13,style:{marginLeft:2}})]}),(0,r.jsxs)(N,{open:a,children:[(0,r.jsx)(D,{children:"Saved versions"}),(0,r.jsx)(R,{children:0===i.length?(0,r.jsx)(F,{children:"No saved documents yet."}):i.map(e=>{return(0,r.jsxs)(_,{children:[(0,r.jsxs)(K,{onClick:()=>{o(e.content,e.id,e.name),n(!1)},children:[(0,r.jsx)(G,{children:e.name}),(0,r.jsx)(H,{children:(a=e.savedAt,new Intl.DateTimeFormat(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}).format(new Date(a)))})]}),(0,r.jsx)(I,{onClick:o=>(async(e,o)=>{e.stopPropagation(),await function(e){return b.deleteDoc(e)}(o),l(e=>e.filter(e=>e.id!==o))})(o,e.id),title:"Delete",children:(0,r.jsx)(E.A,{size:13})})]},e.id);var a})})]})]})}i.default.div`
...
//# sourceMappingURL=449.8a2620858cd8de424b9d.js.map