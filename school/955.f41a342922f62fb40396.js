"use strict";(self.webpackChunk_atlantis_school=self.webpackChunk_atlantis_school||[]).push([[955],{65744(e,o,a){a.d(o,{WO:()=>eo});var i=a(27359),t=a(85723),n=a(53233),r=a(69753),l=a(88641),s=a(41783),d=a(65723);function c(e){try{return JSON.parse(localStorage.getItem(e)??"[]")}catch{return[]}}const m=n.default.nav`padding: ${t.w4.spacing.sm} 0;`,u=n.default.div`
...
`,y=n.default.div`overflow: hidden;`,b=n.default.div`
  display: flex;
  align-items: center;
...
`;function z({title:e,icon:o,entries:a,activeId:t,onSelect:n,favorites:s,onToggleFav:c,collapsed:m}){const[z,j]=(0,i.useState)(!1);return a.length?(0,d.jsxs)(u,{children:[(0,d.jsxs)(p,{collapsed:m,onClick:()=>{m||j(e=>!e)},children:[(0,d.jsxs)(f,{collapsed:m,children:[o,(0,d.jsx)(g,{collapsed:m,children:e})]}),(0,d.jsx)(h,{open:z,collapsed:m,children:(0,d.jsx)(r.A,{size:12})})]}),(0,d.jsx)(x,{open:z&&!m,children:(0,d.jsx)(y,{children:a.map(e=>{const o=s.some(o=>o.id===e.id);return(0,d.jsxs)(b,{children:[(0,d.jsx)(w,{active:t===e.id,onClick:()=>n(e),children:e.name}),(0,d.jsx)(v,{active:o,title:o?"Remover dos favoritos":"Adicionar aos favoritos",onClick:o=>{o.stopPropagation(),c(e)},children:(0,d.jsx)(l.A,{size:12,fill:o?"currentColor":"none"})})]},e.id)})})})]}):null}function j({config:e,activeId:o,onSelect:a,hashPrefix:n}){const r=`atlantis-recent-${n}`,u=`atlantis-fav-${n}`,{collapsed:p}=(0,t.cL)(),[f,g]=(0,i.useState)(()=>c(r)),[h,x]=(0,i.useState)(()=>c(u)),y=(0,i.useCallback)(e=>{e.file&&g(o=>function(e,o,a){const i=[o,...a.filter(e=>e.id!==o.id)].slice(0,10);return localStorage.setItem(e,JSON.stringify(i)),i}(r,e,o)),a(e)},[a,r]),b=(0,i.useCallback)(e=>{x(o=>function(e,o,a){const i=a.some(e=>e.id===o.id)?a.filter(e=>e.id!==o.id):[...a,o];return localStorage.setItem(e,JSON.stringify(i)),i}(u,e,o))},[u]);return(0,d.jsxs)(m,{children:[(0,d.jsx)(z,{title:"Recentes",icon:(0,d.jsx)(s.A,{size:13}),entries:f,activeId:o,onSelect:y,favorites:h,onToggleFav:b,collapsed:p}),(0,d.jsx)(z,{title:"Favoritos",icon:(0,d.jsx)(l.A,{size:13}),entries:h,activeId:o,onSelect:y,favorites:h,onToggleFav:b,collapsed:p}),(0,d.jsx)(t.CD,{entries:e.entries,activeId:o,onSelect:y})]})}var $=a(28976),A=a(18055),k=a(66225),S=a(302),M=a(39895),T=a(6930),C=a(14944);const B=n.default.div`
...
`;let O=!1;function P({code:e}){const o=(0,i.useRef)(null),[n,r]=(0,i.useState)(null);return(0,i.useEffect)(()=>{let i=!1;return async function(){const n=(await a.e(774).then(a.bind(a,30774))).default;if(O||(n.initialize({startOnLoad:!1,theme:"dark",themeVariables:{background:t.w4.colors.codeBg,primaryColor:t.w4.colors.accent,primaryTextColor:t.w4.colors.mainText,lineColor:t.w4.colors.border}}),O=!0),o.current&&!i)try{const a=`mermaid-${Math.random().toString(36).slice(2)}`,{svg:t}=await n.render(a,e);!i&&o.current&&(o.current.innerHTML=t)}catch(e){i||r(e instanceof Error?e.message:String(e))}}(),()=>{i=!0}},[e]),n?(0,d.jsx)(B,{children:(0,d.jsxs)(E,{children:["Mermaid error: ",n]})}):(0,d.jsx)(B,{ref:o})}const L=["#388bfd","#3fb950","#d29922","#a371f7","#f87171","#22d3ee","#fb923c","#34d399","#f472b6","#818cf8"],R=n.default.div`
  background: ${t.w4.colors.codeBg};
  border: 1px solid ${t.w4.colors.codeBorder};
  border-radius: ${t.w4.borderRadius.md};
  padding: ${t.w4.spacing.lg};
...
`,G=n.default.div`
  ...
  font-family: ${t.w4.typography.fontFamilyMono};
  font-size: ${t.w4.typography.fontSizeSm};
`;function V(e){if(e<=0)return 10;const o=Math.pow(10,Math.floor(Math.log10(e)));return Math.ceil(e/o)*o}function H({labels:e,data:o,colors:a}){const i=176,n=V(Math.max(...o,1)),r=Math.min(40,340/e.length*.6),l=340/e.length,s=Array.from({length:6},(e,o)=>n/5*o);return(0,d.jsxs)("svg",{viewBox:"0 0 400 240",width:"100%",style:{maxWidth:400},children:[s.map((e,o)=>{const a=192-e/n*i;return(0,d.jsxs)("g",{children:[(0,d.jsx)("line",{x1:44,y1:a,x2:384,y2:a,stroke:t.w4.colors.border,strokeWidth:.5,strokeDasharray:0===o?"none":"3,3"}),(0,d.jsx)("text",{x:38,y:a+4,fill:t.w4.colors.mainTextMuted,fontSize:10,textAnchor:"end",fontFamily:t.w4.typography.fontFamily,children:Math.round(e)})]},o)}),o.map((o,s)=>{const c=44+l*s+l/2-r/2,m=o/n*i,u=192-m,p=a[s%a.length];return(0,d.jsxs)("g",{children:[(0,d.jsxs)("rect",{x:c,y:u,width:r,height:m,rx:3,fill:p,opacity:.85,children:[(0,d.jsx)("animate",{attributeName:"height",from:"0",to:m,dur:"0.5s",fill:"freeze"}),(0,d.jsx)("animate",{attributeName:"y",from:192,to:u,dur:"0.5s",fill:"freeze"})]}),(0,d.jsx)("text",{x:c+r/2,y:u-4,fill:t.w4.colors.mainText,fontSize:10,fontWeight:600,textAnchor:"middle",fontFamily:t.w4.typography.fontFamily,children:o}),(0,d.jsx)("text",{x:44+l*s+l/2,y:208,fill:t.w4.colors.mainTextMuted,fontSize:10,textAnchor:"middle",fontFamily:t.w4.typography.fontFamily,children:e[s].length>8?e[s].slice(0,7)+"…":e[s]})]},s)})]})}function U({labels:e,data:o,colors:a}){const i=o.reduce((e,o)=>e+o,0)||1;let n=-Math.PI/2;const r=o.map((e,o)=>{const r=e/i*Math.PI*2,l=n;n+=r;const s=n,c=120+90*Math.cos(l),m=120+90*Math.sin(l),u=120+90*Math.cos(s),p=120+90*Math.sin(s),f=r>Math.PI?1:0,g=l+r/2,h=120+58.5*Math.cos(g),x=120+58.5*Math.sin(g),y=Math.round(e/i*100);return(0,d.jsxs)("g",{children:[(0,d.jsx)("path",{d:`M 120 120 L ${c} ${m} A 90 90 0 ${f} 1 ${u} ${p} Z`,fill:a[o%a.length],stroke:t.w4.colors.codeBg,strokeWidth:2,opacity:.85}),y>=5&&(0,d.jsxs)("text",{x:h,y:x+4,fill:"#fff",fontSize:11,fontWeight:600,textAnchor:"middle",fontFamily:t.w4.typography.fontFamily,children:[y,"%"]})]},o)});return(0,d.jsx)("svg",{viewBox:"0 0 240 240",width:"100%",style:{maxWidth:240},children:r})}function Y({labels:e,data:o,colors:a}){const i=176,n=V(Math.max(...o,1)),r=o.length>1?340/(o.length-1):340,l=a[0],s=o.map((e,o)=>({x:44+r*o,y:192-e/n*i})),c=s.map((e,o)=>`${0===o?"M":"L"} ${e.x} ${e.y}`).join(" "),m=Array.from({length:6},(e,o)=>n/5*o);return(0,d.jsxs)("svg",{viewBox:"0 0 400 240",width:"100%",style:{maxWidth:400},children:[m.map((e,o)=>{const a=192-e/n*i;return(0,d.jsxs)("g",{children:[(0,d.jsx)("line",{x1:44,y1:a,x2:384,y2:a,stroke:t.w4.colors.border,strokeWidth:.5,strokeDasharray:0===o?"none":"3,3"}),(0,d.jsx)("text",{x:38,y:a+4,fill:t.w4.colors.mainTextMuted,fontSize:10,textAnchor:"end",fontFamily:t.w4.typography.fontFamily,children:Math.round(e)})]},o)}),(0,d.jsx)("path",{d:c,fill:"none",stroke:l,strokeWidth:2.5,strokeLinecap:"round",strokeLinejoin:"round"}),s.map((a,i)=>(0,d.jsxs)("g",{children:[(0,d.jsx)("circle",{cx:a.x,cy:a.y,r:4,fill:l,stroke:t.w4.colors.codeBg,strokeWidth:2}),(0,d.jsx)("text",{x:a.x,y:a.y-10,fill:t.w4.colors.mainText,fontSize:10,fontWeight:600,textAnchor:"middle",fontFamily:t.w4.typography.fontFamily,children:o[i]}),(0,d.jsx)("text",{x:a.x,y:208,fill:t.w4.colors.mainTextMuted,fontSize:10,textAnchor:"middle",fontFamily:t.w4.typography.fontFamily,children:e[i].length>8?e[i].slice(0,7)+"…":e[i]})]},i))]})}function W({code:e}){const o=(0,i.useMemo)(()=>function(e){const o=e.trim().split("\n");let a,i,t="bar",n=[],r=[];for(const e of o){const[o,...l]=e.split(":"),s=l.join(":").trim();if(s)switch(o.trim().toLowerCase()){case"type":["bar","pie","line"].includes(s.toLowerCase())&&(t=s.toLowerCase());break;case"title":a=s;break;case"labels":n=s.replace(/^\[|\]$/g,"").split(",").map(e=>e.trim());break;case"data":r=s.replace(/^\[|\]$/g,"").split(",").map(e=>parseFloat(e.trim())||0);break;case"colors":i=s.replace(/^\[|\]$/g,"").split(",").map(e=>e.trim())}}return n.length&&r.length?{type:t,title:a,labels:n,data:r,colors:i}:null}(e),[e]);if(!o)return(0,d.jsx)(R,{children:(0,d.jsx)(G,{children:"Invalid chart data"})});const a=o.colors??L;return(0,d.jsxs)(R,{children:[o.title&&(0,d.jsx)(F,{children:o.title}),"bar"===o.type&&(0,d.jsx)(H,{labels:o.labels,data:o.data,colors:a}),"pie"===o.type&&(0,d.jsx)(U,{labels:o.labels,data:o.data,colors:a}),"line"===o.type&&(0,d.jsx)(Y,{labels:o.labels,data:o.data,colors:a}),(0,d.jsx)(I,{children:o.labels.map((e,o)=>(0,d.jsxs)(N,{children:[(0,d.jsx)(D,{color:a[o%a.length]}),e]},o))})]})}const K=n.default.div`
  background: ${t.w4.colors.codeBg};
  border: 1px solid ${t.w4.colors.codeBorder};
  border-radius: ${t.w4.borderRadius.md};
  padding: ${t.w4.spacing.lg};
...
`,X=n.default.div`
  ...
  color: ${t.w4.colors.mainText};
  text-align: center;
`;function ee(e){return e.toString().padStart(2,"0")}function oe(e,o,a){if("pt"===a){const a=1===e?"1 hora":`${e} horas`;return 0===o?a:15===o?`${a} e um quarto`:30===o?`${a} e meia`:45===o?`um quarto para as ${12===e?1:e+1}`:`${a} e ${o} minutos`}const i=e<12?"AM":"PM",t=e%12||12;return 0===o?`${t} o'clock ${i}`:15===o?`quarter past ${t} ${i}`:30===o?`half past ${t} ${i}`:45===o?`quarter to ${t%12+1} ${i}`:`${t}:${ee(o)} ${i}`}function ae({hours:e,minutes:o,seconds:a}){const i=100,n=100,r=e=>e*Math.PI/180,l=a/60*360-90,s=o/60*360+a/60*6-90,c=e%12/12*360+o/60*30-90,m=i+61*Math.cos(r(l)),u=n+61*Math.sin(r(l)),p=i+65*Math.cos(r(s)),f=n+65*Math.sin(r(s)),g=i+45*Math.cos(r(c)),h=n+45*Math.sin(r(c));return(0,d.jsxs)("svg",{viewBox:"0 0 200 200",width:200,height:200,children:[(0,d.jsx)("circle",{cx:i,cy:n,r:85,fill:t.w4.colors.surface,stroke:t.w4.colors.border,strokeWidth:2}),Array.from({length:12},(e,o)=>{const a=o+1,l=a/12*360-90,s=i+69*Math.cos(r(l)),c=n+69*Math.sin(r(l));return(0,d.jsx)("text",{x:s,y:c+4,fill:t.w4.colors.mainText,fontSize:14,fontWeight:600,textAnchor:"middle",fontFamily:t.w4.typography.fontFamily,children:a},a)}),Array.from({length:60},(e,o)=>{const a=o/60*360-90,l=o%5==0,s=l?75:79;return(0,d.jsx)("line",{x1:i+s*Math.cos(r(a)),y1:n+s*Math.sin(r(a)),x2:i+83*Math.cos(r(a)),y2:n+83*Math.sin(r(a)),stroke:l?t.w4.colors.mainTextMuted:t.w4.colors.border,strokeWidth:l?2:1},o)}),(0,d.jsx)("line",{x1:i,y1:n,x2:g,y2:h,stroke:t.w4.colors.mainText,strokeWidth:4,strokeLinecap:"round"}),(0,d.jsx)("line",{x1:i,y1:n,x2:p,y2:f,stroke:t.w4.colors.accent,strokeWidth:2.5,strokeLinecap:"round"}),(0,d.jsx)("line",{x1:i-12*Math.cos(r(l)),y1:n-12*Math.sin(r(l)),x2:m,y2:u,stroke:"#f87171",strokeWidth:1.2,strokeLinecap:"round"}),(0,d.jsx)("circle",{cx:i,cy:n,r:4,fill:t.w4.colors.accent}),(0,d.jsx)("circle",{cx:i,cy:n,r:2,fill:"#f87171"})]})}function ie({code:e}){const o=function(e){let o="pt";for(const a of e.trim().split("\n")){const[e,...i]=a.split(":"),t=i.join(":").trim();"locale"===e.trim().toLowerCase()&&(o=t.toLowerCase())}return{locale:o}}(e),[a,t]=(0,i.useState)("live"),[n,r]=(0,i.useState)(()=>(new Date).getHours()),[l,s]=(0,i.useState)(()=>(new Date).getMinutes()),[c,m]=(0,i.useState)(()=>(new Date).getSeconds());(0,i.useEffect)(()=>{if("live"!==a)return;const e=()=>{const e=new Date;r(e.getHours()),s(e.getMinutes()),m(e.getSeconds())};e();const o=setInterval(e,1e3);return()=>clearInterval(o)},[a]);const u=(0,i.useCallback)(e=>{t("manual"),m(0),r(o=>((o+e)%24+24)%24)},[]),p=(0,i.useCallback)(e=>{t("manual"),m(0),s(o=>((o+e)%60+60)%60)},[]),f=(0,i.useCallback)(()=>t("live"),[]);return(0,d.jsxs)(K,{children:[(0,d.jsxs)(J,{children:[(0,d.jsx)(ae,{hours:n,minutes:l,seconds:c}),(0,d.jsxs)("div",{children:[(0,d.jsxs)(_,{children:[ee(n),":",ee(l),(0,d.jsxs)("span",{style:{fontSize:"24px",opacity:.5},children:[":",ee(c)]})]}),(0,d.jsx)(X,{children:oe(n%12||12,l,o.locale)})]})]}),(0,d.jsxs)(q,{children:[(0,d.jsx)(Z,{onClick:()=>u(-1),children:"−1h"}),(0,d.jsx)(Z,{onClick:()=>u(1),children:"+1h"}),(0,d.jsx)(Z,{onClick:()=>p(-15),children:"−15m"}),(0,d.jsx)(Z,{onClick:()=>p(15),children:"+15m"}),(0,d.jsx)(Z,{onClick:()=>p(-5),children:"−5m"}),(0,d.jsx)(Z,{onClick:()=>p(5),children:"+5m"}),(0,d.jsx)(Z,{active:"live"===a,onClick:f,children:"pt"===o.locale?"Agora":"Now"})]}),(0,d.jsx)(Q,{children:"pt"===o.locale?"Usa os botões para mudar as horas e os minutos!":"Use the buttons to change the hours and minutes!"}),(0,d.jsx)(q,{children:[{label:"3:00",h:3,m:0},{label:"6:30",h:6,m:30},{label:"9:15",h:9,m:15},{label:"12:00",h:12,m:0},{label:"13:45",h:13,m:45},{label:"15:30",h:15,m:30},{label:"19:00",h:19,m:0},{label:"23:15",h:23,m:15}].map(e=>(0,d.jsx)(Z,{onClick:()=>{t("manual"),r(e.h),s(e.m)},children:e.label},e.label))})]})}var te=a(68383),ne=a(21426),re=a(25609),le=a(20320);const se=n.default.div`
  margin: ${t.w4.spacing.lg} 0;
  border-radius: ${t.w4.borderRadius.md};
  border: 1px solid ${t.w4.colors.codeBorder};
  overflow: hidden;
...
`,ue={...ne.A,'pre[class*="language-"]':{...ne.A['pre[class*="language-"]'],background:t.w4.colors.codeBg,margin:0,padding:"18px 20px",fontSize:"13px",lineHeight:"1.6",borderRadius:0},'code[class*="language-"]':{...ne.A['code[class*="language-"]'],background:"none",fontSize:"13px"}};function pe({lang:e="text",code:o}){const[a,n]=(0,i.useState)(!1);return(0,d.jsxs)(se,{children:[(0,d.jsxs)(de,{children:[(0,d.jsx)(ce,{children:e}),(0,d.jsxs)(me,{copied:a,onClick:()=>{navigator.clipboard.writeText(o).then(()=>{n(!0),setTimeout(()=>n(!1),2e3)})},children:[a?(0,d.jsx)(re.A,{size:12}):(0,d.jsx)(le.A,{size:12}),a?"Copied!":"Copy"]})]}),(0,d.jsx)(te.A,{language:e,style:ue,showLineNumbers:o.split("\n").length>8,lineNumberStyle:{color:"#484f58",minWidth:"2.5em",paddingRight:"1.5em",userSelect:"none",fontSize:"12px"},customStyle:{margin:0,background:t.w4.colors.codeBg},wrapLongLines:!1,children:o})]})}var fe=a(65569),ge=a(8218),he=a(57230),xe=a(22966),ye=a(21069);const be={NOTE:{bg:"rgba(88, 166, 255, 0.08)",border:"#58a6ff",icon:fe.A,label:"Note",color:"#58a6ff"},TIP:{bg:"rgba(63, 185, 80, 0.08)",border:"#3fb950",icon:ge.A,label:"Tip",color:"#3fb950"},IMPORTANT:{bg:"rgba(163, 113, 247, 0.08)",border:"#a371f7",icon:he.A,label:"Important",color:"#a371f7"},WARNING:{bg:"rgba(210, 153, 34, 0.08)",border:"#d29922",icon:xe.A,label:"Warning",color:"#d29922"},CAUTION:{bg:"rgba(248, 81, 73, 0.08)",border:"#f85149",icon:ye.A,label:"Caution",color:"#f85149"}},we=n.default.div`
  background: ${({bg:e})=>e};
...
`;function je({type:e,children:o}){const a=be[e]??be.NOTE,i=a.icon;return(0,d.jsxs)(we,{bg:a.bg,border:a.border,children:[(0,d.jsxs)(ve,{color:a.color,children:[(0,d.jsx)(i,{size:15,strokeWidth:2}),a.label]}),(0,d.jsx)(ze,{children:o})]})}const $e=n.default.nav`
  width: 220px;
  min-width: 220px;
...
`,Ae=n.default.div`
  ...
  font-family: ${t.w4.typography.fontFamily};
  margin-bottom: ${t.w4.spacing.md};
`,ke=n.default.ul`list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 2px;`,Se=n.default.a`
  display: block;
  padding: 4px 8px;
...
`;function Me({headings:e,activeId:o}){return e.length<2?null:(0,d.jsxs)($e,{children:[(0,d.jsx)(Ae,{children:"On this page"}),(0,d.jsx)(ke,{children:e.map(e=>(0,d.jsx)("li",{children:(0,d.jsx)(Se,{href:`#${e.id}`,active:o===e.id,level:e.level,onClick:o=>{o.preventDefault(),document.getElementById(e.id)?.scrollIntoView({behavior:"smooth",block:"start"})},children:e.text})},e.id))})]})}function Te(e){return e.toLowerCase().replace(/[*_`[\]()#]/g,"").replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-").trim()}function Ce(e){const{Children:o,isValidElement:i}=a(27359);return o.toArray(e).map(e=>"string"==typeof e?e:"number"==typeof e?String(e):i(e)?Ce(e.props.children??""):"").join("")}function Be(){return e=>{!function e(o){if("blockquote"===o.type){const e=o.children?.[0];if("paragraph"===e?.type){const a=e.children?.[0];if("text"===a?.type){const i=a.value?.match(/^\[!(NOTE|TIP|WARNING|CAUTION|IMPORTANT)\]\s*/i);i&&(a.value=a.value.slice(i[0].length),a.value.trim()||1!==e.children.length||o.children.shift(),o.data=o.data??{},o.data.hName="div",o.data.hProperties={"data-callout":i[1].toUpperCase()})}}}o.children?.forEach(e)}(e)}}const Ee=n.default.div`
  display: flex;
...
`,Oe=n.default.div`flex: 1; min-width: 0;`,Pe=n.default.article`
...
`,Ne=n.default.div`
  ...
  font-family: ${t.w4.typography.fontFamily};
`;function De(e){return function({children:o,...a}){const i=`h${e}`,t=Ce(o),n=Te(t);return(0,d.jsxs)(i,{id:n,...a,children:[o,(0,d.jsx)("a",{className:"heading-anchor",href:`#${n}`,"aria-label":`Link to "${t}"`,children:(0,d.jsx)(k.A,{size:14})})]})}}function Ge({file:e,prevEntry:o,nextEntry:t,onNavigate:n}){const[l,s]=(0,i.useState)(null),[c,m]=(0,i.useState)(null),u=(0,i.useRef)(null);if((0,i.useEffect)(()=>{s(null),fetch(`${a.p}content/${e}`).then(e=>{if(!e.ok)throw new Error(`${e.status} ${e.statusText}`);return e.text()}).then(s).catch(o=>s(`> **Error loading \`${e}\`:** ${o.message}`))},[e]),(0,i.useEffect)(()=>{if(!l||!u.current)return;const e=u.current.querySelectorAll("h2[id], h3[id]");if(!e.length)return;const o=new IntersectionObserver(e=>{const o=e.filter(e=>e.isIntersecting);o.length&&m(o[0].target.id)},{rootMargin:"-10% 0% -60% 0%",threshold:0});return e.forEach(e=>o.observe(e)),()=>o.disconnect()},[l]),null===l)return(0,d.jsx)(Ne,{children:"Loading…"});const p=function(e){const o=[],a=/^(#{2,3})\s+(.+)$/gm;let i;for(;null!==(i=a.exec(e));){const e=i[1].length,a=i[2].trim().replace(/\*\*(.+?)\*\*/g,"$1").replace(/\*(.+?)\*/g,"$1").replace(/`(.+?)`/g,"$1").replace(/\[(.+?)\]\(.+?\)/g,"$1");o.push({level:e,text:a,id:Te(a)})}return o}(l),f=o||t;return(0,d.jsxs)(Ee,{children:[(0,d.jsxs)(Oe,{children:[(0,d.jsx)(Pe,{ref:u,children:(0,d.jsx)($.oz,{remarkPlugins:[A.A,C.A,Be],rehypePlugins:[M.A,T.A],components:{div({node:e,children:o,...a}){const i=a["data-callout"];return i?(0,d.jsx)(je,{type:i,children:o}):(0,d.jsx)("div",{...a,children:o})},h1:De(1),h2:De(2),h3:De(3),h4:De(4),pre:({children:e})=>(0,d.jsx)(d.Fragment,{children:e}),code({className:e,children:o}){const a=/language-(\w+)/.exec(e??"")?.[1],i=String(o).replace(/\n$/,"");return"mermaid"===a?(0,d.jsx)(P,{code:i}):"chart"===a?(0,d.jsx)(W,{code:i}):"clock"===a?(0,d.jsx)(ie,{code:i}):a||i.includes("\n")?(0,d.jsx)(pe,{lang:a,code:i}):(0,d.jsx)("code",{className:e,children:o})}},children:l})}),f&&(0,d.jsxs)(Le,{children:[o?(0,d.jsxs)(Re,{align:"left",onClick:()=>n?.(o),children:[(0,d.jsxs)(Fe,{children:[(0,d.jsx)(S.A,{size:13})," Previous"]}),(0,d.jsx)(Ie,{children:o.name})]}):(0,d.jsx)("div",{style:{flex:1}}),t?(0,d.jsxs)(Re,{align:"right",onClick:()=>n?.(t),children:[(0,d.jsxs)(Fe,{children:["Next ",(0,d.jsx)(r.A,{size:13})]}),(0,d.jsx)(Ie,{children:t.name})]}):(0,d.jsx)("div",{style:{flex:1}})]})]}),(0,d.jsx)(Me,{headings:p,activeId:c})]})}function Ve(e,o){for(const a of e){if(a.id===o)return a;if(a.children){const e=Ve(a.children,o);if(e)return e}}}function He(e){return e.flatMap(e=>e.children?He(e.children):e.file?[e]:[])}const Ue=n.default.div`
  display: flex;
  align-items: center;
  justify-content: center;
  height: 100%;
...
`,Ze={en:"Browse the sidebar",pt:"Explora o menu lateral"};function Qe({title:e,sub:o,lang:a}){return(0,d.jsxs)(Ue,{children:[(0,d.jsx)(We,{}),(0,d.jsx)(Ye,{size:500,x:10,y:-10,hue:210,dur:7}),(0,d.jsx)(Ye,{size:400,x:60,y:50,hue:270,dur:9}),(0,d.jsx)(Ye,{size:300,x:30,y:70,hue:190,dur:6}),(0,d.jsxs)(Ke,{children:[(0,d.jsx)(Je,{children:e}),(0,d.jsx)(_e,{children:o}),(0,d.jsxs)(qe,{children:[(0,d.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round",children:(0,d.jsx)("polyline",{points:"15 18 9 12 15 6"})}),Ze[a]??Ze.en]})]})]})}function Xe(e,o,a){return"string"==typeof e?e:e[o]??e[a]??Object.values(e)[0]??""}function eo({navigation:e,languages:o,defaultLang:a,locale:n,hashPrefix:r,topBarRight:l,welcomeTitle:s="Blog",welcomeSub:c="Notes, guides, and references — pick a topic from the sidebar to get started."}){const m=o?Object.keys(o):[],[u,p]=(m.length,(0,i.useState)(()=>a??m[0]??""));(0,i.useEffect)(()=>{n&&m.includes(n)&&n!==u&&p(n)},[n]);const f=(0,i.useMemo)(()=>o&&u?o[u].navigation:e??{entries:[]},[o,e,u]),g=((0,i.useMemo)(()=>He(f.entries),[f]),(0,i.useCallback)(e=>{const o=e.match(new RegExp(`^#\\/${r}\\/(.+)$`));if(o)return Ve(f.entries,o[1])},[f,r])),[h,x]=(0,i.useState)(()=>g(window.location.hash)??null);(0,i.useEffect)(()=>{if(!h)return;const e=Ve(f.entries,h.id);x(e??null)},[u,f]),(0,i.useEffect)(()=>{const e=()=>{const e=g(window.location.hash);e&&x(e)};return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[g]);const y=(0,i.useCallback)(e=>{e.file&&(x(e),window.location.hash=`#/${r}/${e.id}`)},[r]),b=(0,i.useMemo)(()=>He(f.entries),[f]),w=b.findIndex(e=>e.id===h?.id),v=w>0?b[w-1]:null,z=w<b.length-1?b[w+1]:null,$=h?.label??h?.name??r,A=Xe(s,u,a??m[0]??""),k=Xe(c,u,a??m[0]??"");return(0,d.jsx)(t.PE,{title:$,activeId:h?.id??null,topBarRight:l,sidebar:(0,d.jsx)(j,{config:f,activeId:h?.id??null,onSelect:y,hashPrefix:r}),children:h?.file?(0,d.jsx)(Ge,{file:h.file,prevEntry:v,nextEntry:z,onNavigate:y}):(0,d.jsx)(Qe,{title:A,sub:k,lang:u})})}n.default.div`
  display: flex;
  gap: 4px;
  background: ${t.w4.colors.surface};
  border: 1px solid ${t.w4.colors.border};
...
`;function g({iconKey:e}){const o=e?d.t[e]??r.A:r.A;return(0,c.jsx)(o,{size:14,strokeWidth:1.75})}function h({entries:e,activeId:o,onSelect:a}){return(0,c.jsx)(c.Fragment,{children:e.map(e=>e.children?(0,c.jsx)(i.Fragment,{children:(0,c.jsx)(h,{entries:e.children,activeId:o,onSelect:a})},e.id):(0,c.jsxs)(f,{active:o===e.id,onClick:()=>a(e),children:[(0,c.jsx)(g,{iconKey:e.icon}),e.name]},e.id))})}function x({activeId:e}){const{flyout:o,scheduleFlyoutClose:a,cancelFlyoutClose:i}=(0,s.c)();if(!o)return null;const t=o.entry.icon?d.t[o.entry.icon]??r.A:r.A;return(0,c.jsxs)(u,{anchorY:o.anchorY,onMouseEnter:i,onMouseLeave:a,children:[(0,c.jsxs)(p,{children:[(0,c.jsx)(t,{size:13,strokeWidth:2}),o.entry.name]}),(0,c.jsx)(h,{entries:o.entry.children??[],activeId:e,onSelect:e=>{o.onSelect(e),a()}})]})}},15959(e,o,a){a.d(o,{I:()=>t,c:()=>n});var i=a(27359);const t=(0,i.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),n=()=>(0,i.useContext)(t)},65185(e,o,a){a.d(o,{t:()=>ie});var i=a(49510),t=a(99038),n=a(57400),r=a(28207),l=a(87902),s=a(36896),d=a(37901),c=a(39848),m=a(22164),u=a(3045),p=a(43775),f=a(83539),g=a(41783),h=a(1837),x=a(84494),y=a(82314),b=a(35751),w=a(20255),v=a(69633),z=a(92946),j=a(40822),$=a(36720),A=a(43317),k=a(52709),S=a(89301),M=a(83517),T=a(37032),C=a(6949),B=a(8218),E=a(36829),O=a(15553),P=a(59591),L=a(72820),R=a(14621),F=a(72534),I=a(66673),N=a(49033),D=a(31365),G=a(62937),V=a(65912),H=a(80158),U=a(88641),Y=a(48607),W=a(83249),K=a(1821),J=a(15889),_=a(27170),q=a(19161),Z=a(71849),Q=a(61187),X=a(77747),ee=a(2932),oe=a(24525),ae=a(57230);const ie={activity:s.A,"a-large-small":l.A,"bar-chart-2":i.A,book:c.A,"book-open":d.A,briefcase:u.A,calendar:p.A,clock:g.A,"circle-dot":f.A,compass:h.A,droplets:x.A,feather:y.A,file:w.A,"file-text":b.A,folder:v.A,"git-branch":z.A,github:j.A,globe:$.A,grid:n.A,hash:A.A,heart:k.A,hexagon:S.A,landmark:M.A,layers:r.A,"layout-grid":T.A,leaf:C.A,lightbulb:B.A,list:E.A,map:P.A,"map-pin":O.A,"message-square":L.A,minus:R.A,mountain:F.A,package:I.A,"pen-tool":N.A,"pie-chart":t.A,plus:D.A,ruler:G.A,slash:V.A,square:H.A,star:U.A,sun:Y.A,terminal:W.A,thermometer:K.A,triangle:J.A,truck:_.A,type:q.A,users:Z.A,waves:Q.A,wind:X.A,wrench:ee.A,x:oe.A,zap:ae.A,bot:m.A}},85723(e,o,a){a.d(o,{PE:()=>M,CD:()=>H,PL:()=>X,Is:()=>Q,w4:()=>i.w4,cL:()=>d.c});var i=a(217),t=a(27359),n=a(53233),r=a(65723);n.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,$=n.default.main`
  ...
  display: flex;
  flex-direction: column;
`,A=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function k(){return(0,r.jsx)(h,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:A.map((e,o)=>(0,r.jsx)(x,{index:o,accent:e.accent,children:e.char},o))})}const S="atlantis:sidebar-collapsed";function M({sidebar:e,children:o,topBarRight:i,title:n="Atlantis",activeId:l=null}){const[c,m]=(0,t.useState)(()=>{try{return"true"===localStorage.getItem(S)}catch{return!1}}),[g,h]=(0,t.useState)(null),x=(0,t.useRef)(),A=()=>m(e=>{const o=!e;try{localStorage.setItem(S,String(o))}catch{}return o}),M=t.useMemo(()=>t.lazy(()=>Promise.resolve().then(a.bind(a,74914)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(d.I.Provider,{value:{collapsed:c,toggle:A,flyout:g,openFlyout:(e,o,a)=>{clearTimeout(x.current),h({entry:e,anchorY:o,onSelect:a})},scheduleFlyoutClose:()=>{x.current=setTimeout(()=>h(null),160)},cancelFlyoutClose:()=>clearTimeout(x.current)},children:(0,r.jsxs)(v,{children:[(0,r.jsxs)(u,{children:[e&&(0,r.jsx)(p,{children:(0,r.jsx)(f,{onClick:A,title:c?"Expand sidebar":"Collapse sidebar",children:(0,r.jsx)(s.A,{size:17})})}),(0,r.jsx)(k,{}),n&&(0,r.jsx)(y,{children:n}),i&&(0,r.jsx)(b,{children:i})]}),(0,r.jsxs)(w,{children:[null!=e&&(0,r.jsx)(z,{collapsed:c,children:(0,r.jsx)(j,{children:e})}),(0,r.jsx)($,{children:o})]}),g&&(0,r.jsx)(t.Suspense,{fallback:null,children:(0,r.jsx)(M,{activeId:l})})]})})}var T=a(20255),C=a(69753),B=a(65185);const E=n.default.div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
...
`;function G({iconKey:e,size:o=16}){if(e&&!(e in B.t))return(0,r.jsx)("span",{style:{fontSize:o,lineHeight:1,display:"flex",alignItems:"center"},children:e});const a=e?B.t[e]??T.A:T.A;return(0,r.jsx)(a,{size:o,strokeWidth:1.75})}function V({entry:e,activeId:o,onSelect:a}){const[i,n]=(0,t.useState)(e.defaultOpen??!0),{collapsed:l,openFlyout:s,scheduleFlyoutClose:c,cancelFlyoutClose:m}=(0,d.c)();return e.children&&e.children.length>0?(0,r.jsxs)(L,{children:[(0,r.jsxs)(R,{collapsed:l,onClick:()=>{l||n(e=>!e)},onMouseEnter:l?o=>{const i=o.currentTarget.getBoundingClientRect();s(e,i.top,a)}:void 0,onMouseLeave:l?c:void 0,children:[(0,r.jsxs)(F,{collapsed:l,children:[(0,r.jsx)(G,{iconKey:e.icon,size:16}),(0,r.jsx)(I,{collapsed:l,children:e.name})]}),(0,r.jsx)(N,{open:i,collapsed:l,children:(0,r.jsx)(C.A,{size:13})})]}),(0,r.jsx)(E,{open:i&&!l,children:(0,r.jsx)(O,{children:(0,r.jsx)(P,{children:e.children.map(e=>(0,r.jsx)(V,{entry:e,activeId:o,onSelect:a},e.id))})})})]}):(0,r.jsxs)(D,{active:o===e.id,collapsed:l,onClick:()=>a(e),onMouseEnter:l?o=>{const i=o.currentTarget.getBoundingClientRect();s({id:e.id,name:e.name,icon:e.icon,file:e.file,children:[e]},i.top,a)}:void 0,onMouseLeave:l?c:void 0,children:[(0,r.jsx)(G,{iconKey:e.icon,size:15}),(0,r.jsx)(I,{collapsed:l,children:e.name})]})}function H({entries:e,activeId:o,onSelect:a}){return(0,r.jsx)("div",{children:e.map(e=>(0,r.jsx)(V,{entry:e,activeId:o,onSelect:a},e.id))})}const U=l.keyframes`
...
`,a(74914);var Y=a(61920),W=a(48607),K=a(68479);n.default.button`
  display: flex;
  align-items: center;
  justify-content: center;
  width: 32px;
...
`,x=t.default.div`position: relative; z-index: 1;`,y=t.default.div`
  display: flex;
  align-items: center;
  justify-content: space-between;
  margin-bottom: 18px;
...
`,E=t.default.span`font-size: 36px;`,O=t.default.div`
  flex: 1;
  text-align: left;
`,P=t.default.div`
  font-size: 18px;
  font-weight: 900;
  color: #fff;
`,L=t.default.div`font-size: 14px; font-weight: 600; color: #f9a8d4;`,R=t.default.div`color: #fb7185; font-size: 24px;`,F=(t.default.div`
...
`,G=t.default.div`
  ...
  justify-content: space-between;
  margin-bottom: 10px;
`,V=t.default.div`font-size: 48px; line-height: 1; filter: drop-shadow(0 2px 6px #00000040);`,H=t.default.div`
  font-size: 11px;
  font-weight: 800;
  color: ${({color:e})=>e};
  background: ${({color:e})=>e}25;
...
`,Q=t.default.span`font-size: 26px;`,X=t.default.span`
  ...
  font-weight: 800;
  color: #e2d9ff;
`;function ee({progress:e,speechDebug:o,onSelectLesson:a,onOpenFavorites:i,onSpeechTest:t}){const n=l.length,m=Object.values(e.lessons).filter(e=>e.completed).length,u=Math.round(m/n*100);return(0,c.jsxs)(g,{children:[(0,c.jsx)(h,{children:(0,c.jsxs)(x,{children:[(0,c.jsxs)(y,{children:[(0,c.jsxs)("div",{children:[(0,c.jsx)(b,{children:"LêBem"}),(0,c.jsx)(w,{children:"Vamos aprender a ler! 🚀✨"})]}),(0,c.jsx)(v,{children:"🦉"})]}),(0,c.jsxs)(z,{children:[(0,c.jsxs)(j,{color:"#f59e0b",children:[(0,c.jsx)($,{children:"⭐"}),(0,c.jsx)(A,{children:e.totalStars}),(0,c.jsx)(k,{children:"estrelas"})]}),(0,c.jsxs)(j,{color:"#7c3aed",children:[(0,c.jsx)($,{children:"🏆"}),(0,c.jsxs)(A,{children:["Nível ",e.level]})]}),(0,c.jsxs)(j,{color:"#10b981",children:[(0,c.jsx)($,{children:"🔥"}),(0,c.jsx)(A,{children:e.streak}),(0,c.jsx)(k,{children:"dias"})]})]}),(0,c.jsx)(S,{children:(0,c.jsx)(M,{pct:u})}),(0,c.jsxs)(T,{children:[(0,c.jsxs)("span",{children:[m," de ",n," lições"]}),(0,c.jsxs)("span",{children:[u,"% completo"]})]})]})}),(0,c.jsxs)(C,{children:[!1,(0,c.jsxs)(B,{onClick:i,children:[(0,c.jsx)(E,{children:"❤️"}),(0,c.jsxs)(O,{children:[(0,c.jsx)(P,{children:"Os meus Favoritos"}),(0,c.jsxs)(L,{children:[e.favorites.length," cartões guardados"]})]}),(0,c.jsx)(R,{children:(0,c.jsx)(r.A,{size:20})})]}),s.map((o,i)=>{const t=o.ids.map(e=>l.find(o=>o.id===e)).filter(Boolean);return(0,c.jsxs)(F,{index:i,children:[(0,c.jsx)(I,{children:o.label}),(0,c.jsx)(N,{children:t.map(o=>{const i=e.lessons[o.id],t=i?.stars??0,n=i?.completed??!1;return(0,c.jsxs)(D,{color:o.color,done:n,onClick:()=>a(o.id),children:[(0,c.jsxs)(G,{children:[(0,c.jsx)(V,{children:o.icon}),n&&(0,c.jsx)(H,{color:o.color,children:"✓ Feito"})]}),(0,c.jsx)(U,{children:o.title}),(0,c.jsx)(Y,{children:o.subtitle}),(0,c.jsxs)(W,{children:[[1,2,3].map(e=>(0,c.jsx)(K,{lit:t>=e,color:o.color,delay:80*e,children:"⭐"},e)),(0,c.jsxs)(J,{children:[o.cards.length," cartões"]})]})]},o.id)})})]},o.label)}),e.badges.length>0&&(0,c.jsxs)(_,{children:[(0,c.jsx)(I,{children:"🏅 Conquistas"}),(0,c.jsx)(q,{children:e.badges.map(e=>{const o=d[e];return o?(0,c.jsxs)(Z,{title:o.desc,children:[(0,c.jsx)(Q,{children:o.emoji}),(0,c.jsx)(X,{children:o.label})]},e):null})})]})]})]})}var oe=a(77180),ae=a(41604),ie=a(52709),te=a(32887),ne=a(70947),re=a(76680),le=a(85723);let se=null,de=null,ce=[],me=!1,ue=null,pe="idle",fe=null;const ge=new Set,he=["Joana","Luciana","Eddy","Flo","Grandma","Grandpa","Reed","Rocko","Sandy","Shelley"];function xe(){return/Chrome/i.test(window.navigator.userAgent)&&!/Edg|OPR|CriOS/i.test(window.navigator.userAgent)}function ye(){const e=ze();for(const o of ge)o(e)}function be(){return 0===ce.length&&(ce=window.speechSynthesis.getVoices()),ce}function we(){if(ce=window.speechSynthesis.getVoices(),fe&&ce.length>0){const e=fe;fe=null,window.setTimeout(()=>je(e),0)}return ye(),ce}function ve(){const e=be();if(xe())return e.find(e=>e.default&&e.lang.toLowerCase().startsWith("pt"))??e.find(e=>"pt-br"===e.lang.toLowerCase())??e.find(e=>"pt-pt"===e.lang.toLowerCase())??e.find(e=>e.lang.toLowerCase().startsWith("pt"))??null;for(const o of he){const a=e.find(e=>e.name.toLowerCase()===o.toLowerCase());if(a)return a}return e.find(e=>"pt-pt"===e.lang.toLowerCase())??e.find(e=>"pt-br"===e.lang.toLowerCase())??e.find(e=>e.lang.toLowerCase().startsWith("pt"))??e.find(e=>e.default)??null}function ze(){if(!("speechSynthesis"in window))return{supported:!1,voicesCount:0,preferredVoiceName:null,preferredVoiceLang:null,availableVoiceNames:[],speaking:!1,pending:!1,paused:!1,lastEvent:pe,lastError:ue};const e=window.speechSynthesis,o=ve(),a=be();return{supported:!0,voicesCount:a.length,preferredVoiceName:o?.name??null,preferredVoiceLang:o?.lang??null,availableVoiceNames:a.filter(e=>e.lang.toLowerCase().startsWith("pt")).slice(0,6).map(e=>`${e.name} (${e.lang})`),speaking:e.speaking,pending:e.pending,paused:e.paused,lastEvent:pe,lastError:ue}}function je(e){const o=window.speechSynthesis,a=e.trim(),i=be();if(!a)return;if(0===i.length)return fe=a,pe="waiting-for-voices",ye(),void window.setTimeout(()=>{fe===a&&(fe=null,je(a))},400);null!==de&&(window.clearTimeout(de),de=null),ue=null,pe="queued",se=new SpeechSynthesisUtterance(a),se.lang=xe()?"pt-BR":"pt-PT",se.rate=.8,se.pitch=1.1;const t=ve();t&&!xe()?(se.voice=t,se.lang=t.lang):t&&(se.lang=t.lang),se.onstart=()=>{pe="start",ye()},se.onend=()=>{se=null,pe="end",ye()},se.onerror=e=>{se=null,pe="error",ue=e.error,ye()},o.resume(),o.speak(se),ye()}function $e(e){if(!("speechSynthesis"in window))return;const o=window.speechSynthesis,a=e.trim();if(a){if(null!==de&&(window.clearTimeout(de),de=null),o.speaking||o.pending)return pe="cancel",o.cancel(),de=window.setTimeout(()=>je(a),150),void ye();je(a)}}function Ae(){$e("Ola, teste de voz do LeBem. Esta e a voz do leitor.")}n.keyframes`from { opacity: 0; transform: scale(0.95); } to { opacity: 1; transform: scale(1); }`;const ke=n.keyframes`0%,100%{ transform: translateX(0); } 25%{ transform: translateX(-10px); } 75%{ transform: translateX(10px); }`,Se=n.keyframes`0%{ transform: scale(1); } 50%{ transform: scale(1.2); } 100%{ transform: scale(1); }`,Me=n.keyframes`from{ transform: translateY(0) scale(1); opacity: 1; } to{ transform: translateY(-120px) scale(0.3) rotate(360deg); opacity: 0; }`,Te=n.keyframes`0%,100%{ transform: translateY(0); } 50%{ transform: translateY(-12px); }`,Ce=t.default.div`
  display: flex;
  flex-direction: column;
  height: 100%;
...
`,Ze=t.default.div`font-size: 80px; line-height: 1;`,Qe=t.default.div`
  font-size: 20px;
  font-weight: 700;
  color: ${le.w4.colors.mainText};
`,Xe=t.default.div`
...
`,uo=t.default.button`
  ...
  transition: opacity 0.15s, transform 0.15s;
  &:hover { opacity: 0.9; transform: translateY(-2px); }
`;function po({lessonId:e,progress:o,onBack:a,onComplete:t,onToggleFavorite:n}){const r=(s=e,l.find(e=>e.id===s));var s;const[d,m]=(0,i.useState)("learn"),[u,p]=(0,i.useState)(0),[f,g]=(0,i.useState)([]),[h,x]=(0,i.useState)(0),[y,b]=(0,i.useState)([]),[w,v]=(0,i.useState)(null),[z,j]=(0,i.useState)(0),[$,A]=(0,i.useState)(!1),[k,S]=(0,i.useState)(!1),[M,T]=(0,i.useState)(!1),C=(0,i.useCallback)(e=>{$e(e),T(!0),setTimeout(()=>T(!1),1200)},[]),B=(0,i.useCallback)(()=>{const e=function(e){const o=[...e.cards].sort(()=>Math.random()-.5).slice(0,5),a="palavras"===e.id||"frases"===e.id;return o.map(o=>{const i=e.cards.filter(e=>e.id!==o.id).sort(()=>Math.random()-.5).slice(0,3);if(a){const e=[{emoji:o.emoji},...i.map(e=>({emoji:e.emoji}))].sort(()=>Math.random()-.5);return{type:"word-to-emoji",cardId:o.id,promptWord:o.letter,label:"Qual é a imagem?",options:e,correctIndex:e.findIndex(e=>e.emoji===o.emoji)}}if(Math.random()>.5){const a=[{letter:o.letter},...i.map(e=>({letter:e.letter}))].sort(()=>Math.random()-.5);return{type:"emoji-to-letter",cardId:o.id,promptEmoji:o.emoji,promptWord:o.word,label:"vogais"===e.id?"Começa com que letra?":"Começa com que sílaba?",options:a,correctIndex:a.findIndex(e=>e.letter===o.letter)}}const t=[{emoji:o.emoji},...i.map(e=>({emoji:e.emoji}))].sort(()=>Math.random()-.5);return{type:"letter-to-emoji",cardId:o.id,promptLetter:o.letter,label:"Qual é a imagem?",options:t,correctIndex:t.findIndex(e=>e.emoji===o.emoji)}})}(r);g(e),x(0),b([]),v(null),j(0),m("quiz")},[r]),E=(0,i.useCallback)(e=>{if(null!==w||!f[h])return;const o=e===f[h].correctIndex;v(e),o?(j(e=>e+1),b(e=>[...e,"correct"]),setTimeout(()=>$e(f[h]?.promptWord??f[h]?.promptLetter??""),200)):(A(!0),b(e=>[...e,"wrong"]),setTimeout(()=>A(!1),500)),setTimeout(()=>{h+1>=f.length?(m("result"),S(!0)):(x(e=>e+1),v(null))},900)},[w,f,h]),O=(0,i.useCallback)(()=>{t(e,z,f.length)},[e,z,f.length,t]);if(!r)return null;const P=r.cards[u],L=`${e}:${P?.id}`,R=o.favorites.includes(L),F=z>=f.length?3:z>=f.length-1?2:z>=Math.ceil(f.length/2)?1:0;if("learn"===d)return(0,c.jsxs)(Ce,{children:[(0,c.jsxs)(Be,{children:[(0,c.jsx)(Ee,{onClick:a,children:(0,c.jsx)(oe.A,{size:18})}),(0,c.jsx)(Oe,{children:r.title}),(0,c.jsx)(Pe,{children:r.cards.map((e,o)=>(0,c.jsx)(Le,{active:o===u,done:o<u,color:r.color},o))})]}),(0,c.jsxs)(Re,{children:[(0,c.jsx)(Fe,{color:r.color,onClick:()=>C(P.word),children:P.emoji}),(0,c.jsx)(Ie,{color:r.color,children:P.letter}),(0,c.jsx)(Ne,{children:P.word}),P.hint&&(0,c.jsx)(De,{children:P.hint}),(0,c.jsxs)(Ge,{children:[(0,c.jsx)(Ve,{type:"button",color:"#f59e0b",active:M,title:"Ouvir",onClick:()=>C(P.word),children:(0,c.jsx)(ae.A,{size:22,color:"#f59e0b"})}),(0,c.jsx)(Ve,{type:"button",color:"#ef4444",active:R,title:R?"Remover dos favoritos":"Adicionar aos favoritos",onClick:()=>n(L),children:(0,c.jsx)(ie.A,{size:22,fill:R?"#ef4444":"none",color:"#ef4444"})})]})]}),(0,c.jsxs)(He,{children:[(0,c.jsxs)(Ue,{color:r.color,disabled:0===u,onClick:()=>{u>0&&p(e=>e-1)},children:[(0,c.jsx)(oe.A,{size:18})," Anterior"]}),u<r.cards.length-1?(0,c.jsxs)(Ue,{color:r.color,onClick:()=>{p(e=>e+1),C(r.cards[u+1].word)},children:["Próxima ",(0,c.jsx)(te.A,{size:18})]}):(0,c.jsx)(Ye,{color:r.color,onClick:B,children:"Fazer Quiz 🎯"})]})]});if("quiz"===d){const e=f[h];return e?(0,c.jsxs)(Ce,{children:[(0,c.jsxs)(Be,{children:[(0,c.jsx)(Ee,{onClick:a,children:(0,c.jsx)(oe.A,{size:18})}),(0,c.jsxs)(Oe,{children:["Quiz — ",r.title]})]}),(0,c.jsxs)(We,{children:[(0,c.jsx)(Ke,{children:f.map((e,o)=>(0,c.jsx)(Je,{color:r.color,state:o<y.length?y[o]:o===h?"current":"pending"},o))}),(0,c.jsx)(_e,{children:e.label}),(0,c.jsxs)(qe,{isShaking:$,color:r.color,children:[e.promptEmoji&&(0,c.jsx)(Ze,{children:e.promptEmoji}),e.promptWord&&"word-to-emoji"!==e.type&&(0,c.jsx)(Qe,{children:e.promptWord}),"word-to-emoji"===e.type&&(0,c.jsx)(Xe,{color:r.color,children:e.promptWord}),e.promptLetter&&(0,c.jsx)(Xe,{color:r.color,children:e.promptLetter})]}),(0,c.jsx)(eo,{count:e.options.length,children:e.options.map((o,a)=>{const i=null===w?"idle":a===e.correctIndex?"correct":a===w&&w!==e.correctIndex?"wrong":"idle";return(0,c.jsxs)(oo,{state:i,isShaking:"wrong"===i&&$,disabled:null!==w,onClick:()=>E(a),children:[o.emoji&&(0,c.jsx)(ao,{children:o.emoji}),o.letter&&(0,c.jsx)(io,{color:r.color,children:o.letter})]},a)})}),(0,c.jsxs)(to,{children:[null!==w&&w===e.correctIndex&&(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)(ne.A,{size:22,color:"#10b981"})," ",(0,c.jsx)("span",{style:{color:"#10b981"},children:"Muito bem! 🎉"})]}),null!==w&&w!==e.correctIndex&&(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)(re.A,{size:22,color:"#ef4444"})," ",(0,c.jsxs)("span",{style:{color:"#ef4444"},children:["Era ",e.options[e.correctIndex]?.letter??e.options[e.correctIndex]?.emoji,"!"]})]})]})]})]}):null}const I=F>0?["⭐","✨","🌟","💫","⭐","✨"].map((e,o)=>({emoji:e,x:10+15*o,delay:.15*o})):[];return(0,c.jsxs)(Ce,{children:[(0,c.jsxs)(Be,{children:[(0,c.jsx)(Ee,{onClick:a,children:(0,c.jsx)(oe.A,{size:18})}),(0,c.jsx)(Oe,{children:"Resultado"})]}),(0,c.jsxs)(no,{children:[k&&I.map((e,o)=>(0,c.jsx)(ro,{x:e.x,delay:e.delay,children:e.emoji},o)),(0,c.jsx)(lo,{children:3===F?"🏆":2===F?"🎉":1===F?"👍":"😅"}),(0,c.jsx)(so,{color:r.color,children:3===F?"Perfeito!":2===F?"Muito bem!":1===F?"Bom esforço!":"Continua a tentar!"}),(0,c.jsxs)(co,{children:[z," de ",f.length," acertos"]}),(0,c.jsx)(mo,{children:[1,2,3].map(e=>(0,c.jsx)("span",{style:{opacity:F>=e?1:.2},children:"⭐"},e))}),(0,c.jsx)(uo,{color:r.color,onClick:O,children:"Continuar →"})]})]})}const fo=n.keyframes`from { opacity: 0; transform: translateY(12px); } to { opacity: 1; transform: translateY(0); }`,go=t.default.div`
  display: flex;
  flex-direction: column;
  height: 100%;
  background: ${le.w4.colors.mainBg};
