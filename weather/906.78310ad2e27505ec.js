"use strict";(self.webpackChunk_atlantis_weather=self.webpackChunk_atlantis_weather||[]).push([["906"],{2787(o,e,r){r.d(e,{FlyoutPanel:()=>u});var t=r(5723),a=r(7991),i=r.n(a),n=r(6859),s=r.n(n),l=r(2799),d=r(6063),p=r(7993),c=r(4971);let g=(0,l.keyframes)`
...
`,s().button`
  ...
  border: none;
  cursor: pointer;
  color: ${({active:o})=>o?"#facc15":l.w4.colors.sidebarTextMuted};
...
`,s().div`
  position: relative;
`;let W="260px",O="56px",_="44px",E=s().header`
  display: flex;
  align-items: center;
...
`,oo=s().div`
  ...
  overflow: hidden;
`,oe=s().aside`
  width: ${({collapsed:o})=>o?O:W};
  min-width: ${({collapsed:o})=>o?O:W};
  background: ${l.w4.colors.sidebarBg};
  border-right: 1px solid ${l.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,ot=s().main`
  ...
  display: flex;
  flex-direction: column;
`;function oa(){return(0,t.jsxs)(G,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:[(0,t.jsx)(Z,{"aria-hidden":"true",children:"A"}),(0,t.jsx)(U,{children:"Atlantis"})]})}let oi="atlantis:sidebar-collapsed";function on({sidebar:o,children:e,topBarRight:n,title:s="Atlantis",activeId:l=null}){let[d,p]=(0,a.useState)(()=>{try{return"true"===localStorage.getItem(oi)}catch{return!1}}),[c,g]=(0,a.useState)(null),x=(0,a.useRef)(),f=()=>p(o=>{let e=!o;try{localStorage.setItem(oi,String(e))}catch{}return e}),h=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(r.bind(r,2787)).then(o=>({default:o.FlyoutPanel}))),[]);return(0,t.jsx)(L.I.Provider,{value:{collapsed:d,toggle:f,flyout:c,openFlyout:(o,e,r)=>{clearTimeout(x.current),g({entry:o,anchorY:e,onSelect:r})},scheduleFlyoutClose:()=>{x.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(x.current)},children:(0,t.jsxs)(oo,{children:[(0,t.jsxs)(E,{children:[o&&(0,t.jsx)(D,{children:(0,t.jsx)(K,{onClick:f,title:d?"Expand sidebar":"Collapse sidebar",children:(0,t.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("path",{d:"M9 3v18"})]})})}),(0,t.jsx)(oa,{}),s&&(0,t.jsx)(N,{children:s}),n&&(0,t.jsx)(Q,{children:n})]}),(0,t.jsxs)(J,{children:[null!=o&&(0,t.jsx)(oe,{collapsed:d,children:(0,t.jsx)(or,{children:o})}),(0,t.jsx)(ot,{children:e})]}),c&&(0,t.jsx)(i().Suspense,{fallback:null,children:(0,t.jsx)(h,{activeId:l})})]})})}var os=r(4971);let ol=s().div`
  display: grid;
  grid-template-rows: ${({open:o})=>o?"1fr":"0fr"};
...
`;function ow({iconKey:o,size:e=16}){let r=o?os.X[o]:void 0;return r?(0,t.jsx)("svg",{width:e,height:e,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,dangerouslySetInnerHTML:{__html:r}}):o?(0,t.jsx)("span",{style:{fontSize:e,lineHeight:1,display:"flex",alignItems:"center"},children:o}):(0,t.jsxs)("svg",{width:e,height:e,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,children:[(0,t.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,t.jsx)("polyline",{points:"14 2 14 8 20 8"})]})}function om({entry:o,activeId:e,onSelect:r}){let[i,n]=(0,a.useState)(o.defaultOpen??!0),{collapsed:s,openFlyout:l,scheduleFlyoutClose:d,cancelFlyoutClose:p}=(0,L.c)();return o.children&&o.children.length>0?(0,t.jsxs)(oc,{children:[(0,t.jsxs)(og,{collapsed:s,onClick:()=>{s||n(o=>!o)},onMouseEnter:s?e=>{l(o,e.currentTarget.getBoundingClientRect().top,r)}:void 0,onMouseLeave:s?d:void 0,children:[(0,t.jsxs)(ox,{collapsed:s,children:[(0,t.jsx)(ow,{iconKey:o.icon,size:16}),(0,t.jsx)(of,{collapsed:s,children:o.name})]}),(0,t.jsx)(oh,{open:i,collapsed:s,children:(0,t.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round",children:(0,t.jsx)("path",{d:"M9 6l6 6-6 6"})})})]}),(0,t.jsx)(ol,{open:i&&!s,children:(0,t.jsx)(od,{children:(0,t.jsx)(op,{children:o.children.map(o=>(0,t.jsx)(om,{entry:o,activeId:e,onSelect:r},o.id))})})})]}):(0,t.jsxs)(ob,{active:e===o.id,collapsed:s,onClick:()=>r(o),onMouseEnter:s?e=>{let t=e.currentTarget.getBoundingClientRect();l({id:o.id,name:o.name,icon:o.icon,file:o.file,children:[o]},t.top,r)}:void 0,onMouseLeave:s?d:void 0,children:[(0,t.jsx)(ow,{iconKey:o.icon,size:15}),(0,t.jsx)(of,{collapsed:s,children:o.name})]})}function ou({entries:o,activeId:e,onSelect:r}){return(0,t.jsx)("div",{children:o.map(o=>(0,t.jsx)(om,{entry:o,activeId:e,onSelect:r},o.id))})}r(2787),s().div`
