...
`,w=i().forwardRef(function({variant:e="ghost",size:o="md",icon:t,iconRight:a,children:i,...n},l){return(0,r.jsxs)(b,{ref:l,variant:e,size:o,...n,children:[t,i,a]})}),u={default:s.w4.colors.accent,danger:"#f85149"},y={default:s.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"},$=l().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
