"use strict";(self.webpackChunk_atlantis_codediff=self.webpackChunk_atlantis_codediff||[]).push([[449],{4914(o,e,a){a.d(e,{FlyoutPanel:()=>z});var n=a(7359),t=a(3233),i=a(7207),r=a(255),l=a(217),s=a(5959),c=a(5185),d=a(8104);const m=i.keyframes`
...
`;function p({iconKey:o}){const e=o?c.t[o]??r.A:r.A;return(0,d.jsx)(e,{size:14,strokeWidth:1.75})}function y({entries:o,activeId:e,onSelect:a}){return(0,d.jsx)(d.Fragment,{children:o.map(o=>o.children?(0,d.jsx)(n.Fragment,{children:(0,d.jsx)(y,{entries:o.children,activeId:e,onSelect:a})},o.id):(0,d.jsxs)(f,{active:e===o.id,onClick:()=>a(o),children:[(0,d.jsx)(p,{iconKey:o.icon}),o.name]},o.id))})}function z({activeId:o}){const{flyout:e,scheduleFlyoutClose:a,cancelFlyoutClose:n}=(0,s.c)();if(!e)return null;const t=e.entry.icon?c.t[e.entry.icon]??r.A:r.A;return(0,d.jsxs)(u,{anchorY:e.anchorY,onMouseEnter:n,onMouseLeave:a,children:[(0,d.jsxs)(g,{children:[(0,d.jsx)(t,{size:13,strokeWidth:2}),e.entry.name]}),(0,d.jsx)(y,{entries:e.entry.children??[],activeId:o,onSelect:o=>{e.onSelect(o),a()}})]})}},5959(o,e,a){a.d(e,{c:()=>i});var n=a(7359);const t=(0,n.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),i=()=>(0,n.useContext)(t)},5185(o,e,a){a.d(e,{t:()=>Y});var n=a(9510),t=a(9038),i=a(8207),r=a(6896),l=a(7901),s=a(9848),c=a(2164),d=a(3775),m=a(3539),u=a(1783),g=a(1837),f=a(2314),p=a(5751),y=a(255),z=a(9633),b=a(2946),h=a(822),x=a(6720),w=a(3317),A=a(2709),v=a(3517),$=a(7032),k=a(6949),S=a(8218),M=a(6829),j=a(5553),B=a(9591),T=a(2820),P=a(4621),E=a(6673),L=a(9033),C=a(1365),N=a(5912),D=a(8641),R=a(3249),F=a(1821),_=a(9161),K=a(1849),G=a(7747),H=a(2932),I=a(4525),U=a(7230);const Y={activity:r.A,"bar-chart-2":n.A,book:s.A,"book-open":l.A,calendar:d.A,clock:u.A,"circle-dot":m.A,feather:f.A,"file-text":p.A,globe:x.A,hash:w.A,heart:A.A,landmark:v.A,layers:i.A,leaf:k.A,map:B.A,package:E.A,compass:g.A,"git-branch":b.A,github:h.A,minus:P.A,terminal:R.A,thermometer:F.A,users:K.A,wind:G.A,"pie-chart":t.A,plus:C.A,slash:N.A,star:D.A,zap:U.A,bot:c.A,lightbulb:S.A,"message-square":T.A,wrench:H.A,x:I.A,"layout-grid":$.A,list:M.A,file:y.A,folder:z.A,"map-pin":j.A,"pen-tool":L.A,type:_.A}},5723(o,e,a){a.d(e,{UO:()=>U,MJ:()=>B,KL:()=>h,w4:()=>n.w4,mZ:()=>x});var n=a(217),t=a(7359),i=a(3233),r=a(8104);i.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,i.default.div`
  position: relative;
`;var l=a(7207);a(5959);const s="260px",c="56px",d=(i.default.header`
  display: flex;
  align-items: center;
  height: ${"48px"};
...
`,i.default.span`
  ...
  animation: ${d} 10s ease ${({index:o})=>.07*o}s infinite;
...
`,i.default.div`
  ...
  overflow: hidden;
`,i.default.aside`
  width: ${({collapsed:o})=>o?c:s};
  min-width: ${({collapsed:o})=>o?c:s};
  background: ${n.w4.colors.sidebarBg};
  border-right: 1px solid ${n.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,a(4914);var u=a(1920),g=a(8607),f=a(8479);i.default.button`
  display: flex;
  align-items: center;
  justify-content: center;
  width: 32px;
...
`,j=i.default.div`
  ...
  color: ${n.w4.colors.sidebarTextMuted};
  font-family: ${n.w4.typography.fontFamily};
`;function B({onSave:o,onUpdate:e,onCancel:a,existingDoc:n}){const[i,l]=(0,t.useState)(n?.name??""),s=(0,t.useRef)(null);return(0,t.useEffect)(()=>{s.current?.focus(),n&&s.current?.select()},[n]),(0,r.jsx)(w,{onClick:a,children:(0,r.jsxs)(A,{onClick:o=>o.stopPropagation(),children:[(0,r.jsx)(v,{children:"Save document"}),n&&e&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(j,{children:"Update the current version or save as a new one."}),(0,r.jsxs)(k,{children:[(0,r.jsx)(S,{onClick:a,children:"Cancel"}),(0,r.jsxs)(S,{danger:!0,onClick:e,children:['Update "',n.name,'"']})]}),(0,r.jsx)(M,{})]}),(0,r.jsx)($,{ref:s,value:i,onChange:o=>l(o.target.value),onKeyDown:t=>{"Enter"===t.key&&i.trim()&&(n&&i.trim()===n.name&&e?e():o(i.trim())),"Escape"===t.key&&a()},placeholder:n?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,r.jsxs)(k,{children:[!n&&(0,r.jsx)(S,{onClick:a,children:"Cancel"}),(0,r.jsx)(S,{primary:!0,disabled:!i.trim(),onClick:()=>o(i.trim()),children:"Save as new"})]})]})})}var T=a(8006),P=a(679),E=a(4872);const L=i.default.div`
  position: relative;
`,C=i.default.button`
  display: flex;
  align-items: center;
...
`;function U({appId:o,onLoad:e}){const[a,n]=(0,t.useState)(!1),[i,l]=(0,t.useState)([]),s=(0,t.useRef)(null),c=(0,t.useCallback)(()=>{(function(o){return b.listDocs(o)})(o).then(l).catch(()=>{})},[o]);(0,t.useEffect)(()=>{if(!a)return;c();const o=o=>{s.current&&!s.current.contains(o.target)&&n(!1)};return document.addEventListener("mousedown",o),()=>document.removeEventListener("mousedown",o)},[a,c]);return(0,r.jsxs)(L,{ref:s,children:[(0,r.jsxs)(C,{onClick:()=>n(o=>!o),children:[(0,r.jsx)(T.A,{size:14}),"Saved",(0,r.jsx)(P.A,{size:13,style:{marginLeft:2}})]}),(0,r.jsxs)(N,{open:a,children:[(0,r.jsx)(D,{children:"Saved versions"}),(0,r.jsx)(R,{children:0===i.length?(0,r.jsx)(F,{children:"No saved documents yet."}):i.map(o=>{return(0,r.jsxs)(_,{children:[(0,r.jsxs)(K,{onClick:()=>{e(o.content,o.id,o.name),n(!1)},children:[(0,r.jsx)(G,{children:o.name}),(0,r.jsx)(H,{children:(a=o.savedAt,new Intl.DateTimeFormat(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}).format(new Date(a)))})]}),(0,r.jsx)(I,{onClick:e=>(async(o,e)=>{o.stopPropagation(),await function(o){return b.deleteDoc(o)}(e),l(o=>o.filter(o=>o.id!==e))})(e,o.id),title:"Delete",children:(0,r.jsx)(E.A,{size:13})})]},o.id);var a})})]})]})}i.default.div`
