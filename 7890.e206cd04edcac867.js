...
`;function j({locale:e}){let a,t="pt"===e?"pt":"en",n=(0,s.useMemo)(()=>(0,y.Nx)(t,m.A),[t]),[r,o]=(0,s.useState)(new Date);(0,s.useEffect)(()=>{let e=setInterval(()=>o(new Date),6e4);return()=>clearInterval(e)},[]);let d=(a=new Date().getHours())>=20||a<7,b=(60*r.getHours()+r.getMinutes())/1440*360;return(0,i.jsx)(x.rl,{title:n("nightSky.title"),accessory:(0,i.jsx)(h,{children:n("astro.location")}),accentColor:g.A.accentColor,children:(0,i.jsxs)(p,{children:[(0,i.jsx)(f,{children:d?(0,i.jsxs)("svg",{width:"100%",height:"100%",viewBox:"0 0 260 260",preserveAspectRatio:"xMidYMid meet",children:[(0,i.jsx)("circle",{cx:130,cy:130,r:122,fill:"none",stroke:l.w4.colors.borderSubtle,strokeWidth:"1",strokeDasharray:"2 4",opacity:"0.45"}),[0,90,180,270].map(e=>{let a=e*Math.PI/180,t=130+122*Math.cos(a),s=130+122*Math.sin(a),n=130+116*Math.cos(a),r=130+116*Math.sin(a);return(0,i.jsx)("line",{x1:t,y1:s,x2:n,y2:r,stroke:l.w4.colors.mainTextFaint,strokeWidth:"1",opacity:"0.4"},e)}),(0,i.jsx)("g",{transform:`rotate(${b} 130 130)`,children:c.map(e=>{let a=e.stars.map(e=>({cx:16+228*e.x,cy:16+228*e.y,r:Math.max(.8,2.6-.6*e.mag)}));return(0,i.jsxs)("g",{children:[e.lines.map(([e,t],s)=>(0,i.jsx)("line",{x1:a[e].cx,y1:a[e].cy,x2:a[t].cx,y2:a[t].cy,stroke:"rgba(139,123,255,0.25)",strokeWidth:"0.6"},s)),a.map((e,a)=>(0,i.jsx)(w,{cx:e.cx,cy:e.cy,r:e.r,fill:"#f2ecd8",style:{animationDelay:`${a%6*.4}s`}},a))]},e.id)})})]}):(0,i.jsx)(k,{children:n("nightSky.dayTitle")})}),d&&(0,i.jsx)(u,{children:n("nightSky.nightLegend",{count:c.length})})]})})}}}]);