...
`,B=n().div`
  ...
  font-family: ${l.w4.typography.fontFamilyMono};
  text-align: center;
`;function P(){let e=(0,a.useRef)(null),o=(0,a.useRef)(null),[r,i]=(0,a.useState)(480),[n,p]=(0,a.useState)(0),[P,V]=(0,a.useState)(new Date),{data:E}=(0,d.so)(5e3),{location:Y,status:G}=(0,d.mJ)(),[O,D]=(0,a.useState)(48.85),[W,q]=(0,a.useState)(2.35),[N,U]=(0,a.useState)("48.85"),[Z,_]=(0,a.useState)("2.35");(0,a.useEffect)(()=>{Y&&(D(Y.lat),q(Y.lon),U(Y.lat.toFixed(3)),_(Y.lon.toFixed(3)))},[Y]),(0,a.useEffect)(()=>{let e=o.current;if(!e)return;let r=new ResizeObserver(e=>{i(Math.max(280,Math.min(e[0].contentRect.width,540)))});return r.observe(e),()=>r.disconnect()},[]),(0,a.useEffect)(()=>{let e=setInterval(()=>{p(e=>e+1),V(new Date)},1e4);return()=>clearInterval(e)},[]);let X=(0,a.useCallback)(()=>{let o=e.current;if(!o)return;let t=o.getContext("2d");if(!t)return;let a=new Date,i=r/2,n=r/2,s=r/2-18;t.clearRect(0,0,r,r);let d=t.createRadialGradient(i,n,0,i,n,s);for(let e of(d.addColorStop(0,"#06060f"),d.addColorStop(.7,"#08091a"),d.addColorStop(1,"#0b0c1e"),t.save(),t.beginPath(),t.arc(i,n,s,0,2*Math.PI),t.clip(),t.fillStyle=d,t.fillRect(0,0,r,r),t.restore(),[30,60])){let o=s*(1-e/90);t.beginPath(),t.arc(i,n,o,0,2*Math.PI),t.strokeStyle="rgba(255,255,255,0.04)",t.lineWidth=.8,t.stroke()}if(t.beginPath(),t.arc(i,n,s,0,2*Math.PI),t.strokeStyle="rgba(255,255,255,0.12)",t.lineWidth=1,t.stroke(),m.forEach(e=>{t.strokeStyle=e.color+"50",t.lineWidth=.9,e.lines.forEach(([e,o])=>{let r=f[e],l=f[o];if(!r||!l)return;let d=c(r.ra,r.dec,O,W,a),p=c(l.ra,l.dec,O,W,a);if(d.alt<0||p.alt<0)return;let g=x(d.az,d.alt,i,n,s),h=x(p.az,p.alt,i,n,s);g&&h&&(t.beginPath(),t.moveTo(g.x,g.y),t.lineTo(h.x,h.y),t.stroke())})}),h.forEach(e=>{let o=c(e.ra,e.dec,O,W,a);if(o.alt<0)return;let r=x(o.az,o.alt,i,n,s);if(!r)return;let l=Math.max(.4,2.8-.55*e.mag),d=Math.min(1,Math.max(.25,1-(e.mag- -1.5)*.12));if(e.mag<1.5){let e=t.createRadialGradient(r.x,r.y,0,r.x,r.y,3*l);e.addColorStop(0,`rgba(255,255,220,${.5*d})`),e.addColorStop(1,"rgba(255,255,220,0)"),t.beginPath(),t.arc(r.x,r.y,3*l,0,2*Math.PI),t.fillStyle=e,t.fill()}t.beginPath(),t.arc(r.x,r.y,l,0,2*Math.PI),t.fillStyle=`rgba(255,255,220,${d})`,t.fill()}),E){let e=g(O,W,E.latitude,E.longitude,E.altitude);if(e.el>0){let o=x(e.az,e.el,i,n,s);if(o){let r=t.createRadialGradient(o.x,o.y,0,o.x,o.y,12);r.addColorStop(0,"rgba(255,215,0,0.4)"),r.addColorStop(1,"rgba(255,215,0,0)"),t.beginPath(),t.arc(o.x,o.y,12,0,2*Math.PI),t.fillStyle=r,t.fill(),t.beginPath(),t.arc(o.x,o.y,5,0,2*Math.PI),t.fillStyle="#ffd700",t.fill(),t.strokeStyle="#fffacd",t.lineWidth=1,t.stroke(),t.font=`bold 11px ${l.w4.typography.fontFamilyMono}`,t.fillStyle="#ffd700",t.fillText("ISS",o.x+8,o.y+4),t.font=`10px ${l.w4.typography.fontFamilyMono}`,t.fillStyle="#ffd70099",t.fillText(`${e.el.toFixed(1)}\xb0 el`,o.x+8,o.y+16)}}}t.font="bold 11px sans-serif",t.textAlign="center",t.textBaseline="middle",[{az:0,label:"N"},{az:90,label:"E"},{az:180,label:"S"},{az:270,label:"W"}].forEach(({az:e,label:o})=>{let r=Math.PI/180*e,a=i+(s+12)*Math.sin(r),l=n-(s+12)*Math.cos(r);t.fillStyle="N"===o?"#58a6ff":"#8b949e",t.fillText(o,a,l)}),t.font="9px sans-serif",t.fillStyle="rgba(255,255,255,0.15)",t.textAlign="center",t.fillText("Zenith",i,n+4),t.textAlign="left",t.textBaseline="alphabetic"},[O,W,E,r]);(0,a.useEffect)(()=>{X()},[X,n]);let K=E?g(O,W,E.latitude,E.longitude,E.altitude):null,J=K&&K.el>0;return(0,t.jsxs)(b,{children:[(0,t.jsxs)(u,{children:[(0,t.jsxs)(w,{children:[(0,t.jsx)(s.In,{name:"star",size:18,color:"#ffd700"}),"Night Sky"]}),(0,t.jsxs)(y,{children:[(0,t.jsxs)($,{children:[(0,t.jsx)(s.In,{name:"map-pin",size:12}),(0,t.jsx)(M,{children:"Lat"}),(0,t.jsx)(v,{type:"number",value:N,onChange:e=>{U(e.target.value);let o=parseFloat(e.target.value);!isNaN(o)&&o>=-90&&o<=90&&D(o)},step:"0.001",min:"-90",max:"90"}),(0,t.jsx)(M,{children:"Lon"}),(0,t.jsx)(v,{type:"number",value:Z,onChange:e=>{_(e.target.value);let o=parseFloat(e.target.value);!isNaN(o)&&o>=-180&&o<=180&&q(o)},step:"0.001",min:"-180",max:"180"})]}),"granted"===G&&(0,t.jsxs)($,{style:{color:"#3fb950"},children:[(0,t.jsx)(s.In,{name:"map-pin",size:11}),"GPS"]}),(0,t.jsx)(s.$n,{variant:"ghost",size:"sm",icon:(0,t.jsx)(s.In,{name:"refresh",size:11}),onClick:()=>{p(e=>e+1),V(new Date)},children:"Refresh"})]})]}),(0,t.jsxs)(k,{children:[(0,t.jsx)(z,{ref:o,children:(0,t.jsx)(S,{ref:e,width:r,height:r})}),(0,t.jsxs)(T,{children:[(0,t.jsxs)(j,{children:[(0,t.jsx)(F,{children:"ISS Visibility"}),E&&K?J?(0,t.jsxs)(H,{children:[(0,t.jsxs)(I,{children:[(0,t.jsx)(A,{children:"Elevation"}),(0,t.jsxs)("span",{children:[K.el.toFixed(1),"\xb0"]})]}),(0,t.jsxs)(I,{children:[(0,t.jsx)(A,{children:"Azimuth"}),(0,t.jsxs)("span",{children:[K.az.toFixed(1),"\xb0"]})]}),(0,t.jsxs)(I,{children:[(0,t.jsx)(A,{children:"Range"}),(0,t.jsxs)("span",{children:[K.range_km.toFixed(0)," km"]})]}),(0,t.jsxs)(I,{children:[(0,t.jsx)(A,{children:"Sun"}),(0,t.jsx)("span",{children:E.visibility})]})]}):(0,t.jsxs)(L,{children:["ISS is currently below the horizon.",(0,t.jsx)("br",{}),"El: ",K.el.toFixed(1),"\xb0"]}):(0,t.jsx)(L,{children:"Loading ISS data…"})]}),(0,t.jsxs)(j,{children:[(0,t.jsx)(F,{children:"Constellations"}),m.map(e=>(0,t.jsxs)(R,{children:[(0,t.jsx)(C,{color:e.color}),e.name]},e.name))]}),(0,t.jsxs)(j,{children:[(0,t.jsx)(F,{children:"How to read"}),(0,t.jsx)(L,{children:"Centre = zenith (directly overhead). Edge = horizon. N is up. Stars are sized by brightness. ISS shown in gold when visible."})]})]})]}),(0,t.jsxs)(B,{children:["UTC ",P.toUTCString().split(" ")[4]," \xb7 Observer ",O.toFixed(3),"\xb0 ",O>=0?"N":"S",","," ",Math.abs(W).toFixed(3),"\xb0 ",W>=0?"E":"W"]})]})}},1150(e,o,r){r.d(o,{A:()=>$});var t=r(5723),a=r(7991),i=r(6859),n=r.n(i),l=r(4764),s=r(9522);let d=[{category:"station",label:"Space Stations",examples:"ISS, Tiangong"},{category:"observation",label:"Earth Observation",examples:"Terra, Aqua, Landsat-9"},{category:"navigation",label:"Navigation",examples:"GPS III, GPS IIF"},{category:"communications",label:"Communications",examples:"Starlink"},{category:"scientific",label:"Scientific",examples:"Hubble"},{category:"weather",label:"Weather",examples:"GOES-16, GOES-18"}],c=n().div`
  display: flex;
  flex-direction: column;
  height: 100%;
`,p=n().div`
...
`;function y(e){let o=s.IT[e.category];return`
  ...
  `}function $(){let e=(0,a.useRef)(null),o=(0,a.useRef)(null),r=(0,a.useRef)(null),i=(0,a.useRef)(null),n=(0,a.useRef)(null),l=(0,a.useRef)(new Map),[$,v]=(0,a.useState)(!1),{data:M}=(0,s.so)(5e3),k=(0,s.Ey)(15e3),{trail:z,addPoint:S}=(0,s.wB)(80);return(0,a.useEffect)(()=>{var e;!function(e){if(document.querySelector(`link[href="${e}"]`))return;let o=document.createElement("link");o.rel="stylesheet",o.href=e,document.head.appendChild(o)}("https://unpkg.com/leaflet@1.9.4/dist/leaflet.css"),(e="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js",new Promise((o,r)=>{if(document.querySelector(`script[src="${e}"]`))return void o();let t=document.createElement("script");t.src=e,t.onload=()=>o(),t.onerror=r,document.head.appendChild(t)})).then(()=>v(!0))},[]),(0,a.useEffect)(()=>{if(!$||!e.current||o.current)return;let t=window.L,a=t.map(e.current,{center:[20,0],zoom:2,zoomControl:!0,attributionControl:!1,minZoom:2});t.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{maxZoom:10}).addTo(a);let d=t.circleMarker([20,0],{radius:8,color:s.IT.station,fillColor:s.IT.station,fillOpacity:1,weight:2,pane:"markerPane"}).addTo(a);return d.bindPopup("Loading ISS…",{maxWidth:260,minWidth:200}),d.bindTooltip("\uD83D\uDEF0 ISS \xb7 International Space Station",{direction:"top",offset:[0,-8]}),r.current=d,i.current=t.polyline([],{color:`${s.IT.station}55`,weight:1.5,dashArray:"4 4"}).addTo(a),n.current=t.circle([20,0],{radius:0,color:`${s.IT.station}22`,fillColor:`${s.IT.station}08`,fillOpacity:1,weight:1}).addTo(a),o.current=a,()=>{a.remove(),o.current=null,r.current=null,i.current=null,n.current=null,l.current.clear()}},[$]),(0,a.useEffect)(()=>{if(!M||!o.current)return;let e=[M.latitude,M.longitude];S(M.latitude,M.longitude),r.current?.setLatLng(e),r.current?.setPopupContent(y({...M,norad:25544,category:"station",name:"ISS"})),n.current?.setLatLng(e),n.current?.setRadius(M.footprint/2*1e3)},[M,S]),(0,a.useEffect)(()=>{i.current?.setLatLngs(z)},[z]),(0,a.useEffect)(()=>{if(!o.current||!window.L)return;let e=window.L,r=o.current,t=l.current;k.forEach(o=>{if(25544===o.norad)return;let a=[o.latitude,o.longitude],i=s.IT[o.category],n=`🛰 ${o.name} \xb7 ${o.altitude.toFixed(0)} km`;if(t.has(o.norad)){let e=t.get(o.norad);e.setLatLng(a),e.setPopupContent(y(o)),e.setTooltipContent(n)}else{let l=e.circleMarker(a,{radius:5,color:i,fillColor:i,fillOpacity:.85,weight:1.5}).addTo(r);l.bindPopup(y(o),{maxWidth:260,minWidth:200}),l.bindTooltip(n,{direction:"top",offset:[0,-6]}),t.set(o.norad,l)}})},[k]),(0,t.jsxs)(c,{children:[(0,t.jsx)(p,{children:(0,t.jsx)(g,{children:(0,t.jsx)("div",{ref:e,style:{height:"100%",width:"100%"}})})}),(0,t.jsxs)(x,{children:[(0,t.jsx)(h,{children:"Legend"}),d.map(({category:e,label:o,examples:r})=>(0,t.jsxs)(f,{children:[(0,t.jsx)(m,{color:s.IT[e]}),o,(0,t.jsxs)(b,{children:["\xb7 ",r]})]},e))]}),(0,t.jsxs)(u,{children:[(0,t.jsx)(w,{live:!!M}),(0,t.jsx)("span",{children:"ISS"}),M&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)("span",{children:"\xb7"}),(0,t.jsxs)("span",{children:[M.latitude.toFixed(3),"\xb0, ",M.longitude.toFixed(3),"\xb0"]}),(0,t.jsx)("span",{children:"\xb7"}),(0,t.jsxs)("span",{children:[M.altitude.toFixed(1)," km"]}),(0,t.jsx)("span",{children:"\xb7"}),(0,t.jsxs)("span",{children:[(M.velocity/3600).toFixed(2)," km/s"]})]}),(0,t.jsxs)("span",{style:{marginLeft:"auto"},children:[k.length," satellites tracked \xb7 click any marker for details \xa0\xb7\xa0",(0,t.jsx)("a",{href:"https://www.openstreetmap.org/copyright",target:"_blank",rel:"noopener noreferrer",style:{color:"inherit",textDecoration:"underline",opacity:.7},children:"\xa9 OpenStreetMap contributors"})]})]})]})}},6080(e,o,r){r.d(o,{A:()=>C});var t=r(5723);r(7991);var a=r(6859),i=r.n(a),n=r(2799),l=r(4764),s=r(18),d=r(9522);let c=(0,n.keyframes)`
  0%, 100% { opacity: 1; }
  50% { opacity: 0.4; }
`,p=i().div`
  display: flex;
...
`;function F(e,o=2){return void 0===e?"—":e.toFixed(o)}function R(e,o,r){return`${Math.abs(e).toFixed(4)}\xb0 ${e>=0?o:r}`}function C(){let{data:e,loading:o}=(0,d.so)(5e3);return(0,t.jsxs)(p,{children:[(0,t.jsxs)(g,{children:[(0,t.jsxs)(x,{children:[(0,t.jsx)(s.In,{name:"activity",size:18,color:"#58a6ff"}),"Space Metrics"]}),(0,t.jsxs)(h,{active:!o&&!!e,children:[(0,t.jsx)(f,{active:!o&&!!e}),o?"Connecting…":e?"Live":"Offline"]})]}),(0,t.jsx)(T,{children:"ISS Telemetry"}),(0,t.jsxs)(m,{children:[(0,t.jsxs)(b,{children:[(0,t.jsx)(u,{color:"#58a6ff",children:(0,t.jsx)(s.In,{name:"globe",size:16})}),(0,t.jsx)(w,{children:"Position"}),o?(0,t.jsx)(v,{}):e?(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(y,{children:R(e.latitude,"N","S")}),(0,t.jsx)($,{children:R(e.longitude,"E","W")})]}):(0,t.jsx)(y,{children:"—"})]}),(0,t.jsxs)(b,{children:[(0,t.jsx)(u,{color:"#3fb950",children:(0,t.jsx)(s.In,{name:"gauge",size:16})}),(0,t.jsx)(w,{children:"Altitude"}),o?(0,t.jsx)(v,{}):(0,t.jsxs)(t.Fragment,{children:[(0,t.jsxs)(y,{children:[F(e?.altitude)," km"]}),(0,t.jsxs)($,{children:["~",F(e?.621371*e.altitude:void 0)," mi"]})]})]}),(0,t.jsxs)(b,{children:[(0,t.jsx)(u,{color:"#e3b341",children:(0,t.jsx)(s.In,{name:"zap",size:16})}),(0,t.jsx)(w,{children:"Velocity"}),o?(0,t.jsx)(v,{}):(0,t.jsxs)(t.Fragment,{children:[(0,t.jsxs)(y,{children:[F(e?.velocity,0)," km/h"]}),(0,t.jsxs)($,{children:[F(e?e.velocity/3600:void 0,2)," km/s"]})]})]}),(0,t.jsxs)(b,{children:[(0,t.jsx)(u,{color:"#bc8cff",children:(0,t.jsx)(s.In,{name:"radio",size:16})}),(0,t.jsx)(w,{children:"Signal Footprint"}),o?(0,t.jsx)(v,{}):(0,t.jsxs)(t.Fragment,{children:[(0,t.jsxs)(y,{children:[F(e?.footprint,0)," km"]}),(0,t.jsx)($,{children:"diameter visible from ISS"})]})]}),(0,t.jsxs)(b,{children:[(0,t.jsx)(u,{color:"#ff7b72",children:(0,t.jsx)(s.In,{name:"eye",size:16})}),(0,t.jsx)(w,{children:"Sun Visibility"}),o?(0,t.jsx)(v,{}):e?(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(y,{children:(0,t.jsx)(j,{vis:e.visibility,children:e.visibility.charAt(0).toUpperCase()+e.visibility.slice(1)})}),(0,t.jsxs)($,{children:["Solar lat ",F(e.solar_lat,1),"\xb0 \xb7 lon ",F(e.solar_lon,1),"\xb0"]})]}):(0,t.jsx)(y,{children:"—"})]}),(0,t.jsxs)(b,{children:[(0,t.jsx)(u,{color:"#39d353",children:(0,t.jsx)(s.In,{name:"activity",size:16})}),(0,t.jsx)(w,{children:"Orbit Period"}),(0,t.jsx)(y,{children:"92.68 min"}),(0,t.jsx)($,{children:"15.5 orbits per day"})]})]}),(0,t.jsx)(T,{children:"In Orbit Right Now"}),(0,t.jsxs)(M,{children:[(0,t.jsxs)(k,{children:[(0,t.jsx)(z,{children:"Tracked Objects"}),(0,t.jsx)(S,{children:"~27,000+"})]}),(0,t.jsxs)(k,{children:[(0,t.jsx)(z,{children:"Active Satellites"}),(0,t.jsx)(S,{children:"~9,000+"})]}),(0,t.jsxs)(k,{children:[(0,t.jsx)(z,{children:"ISS Inclination"}),(0,t.jsx)(S,{children:"51.64\xb0"})]}),(0,t.jsxs)(k,{children:[(0,t.jsx)(z,{children:"ISS Mass"}),(0,t.jsx)(S,{children:"~420,000 kg"})]}),(0,t.jsxs)(k,{children:[(0,t.jsx)(z,{children:"ISS Size"}),(0,t.jsx)(S,{children:"109 \xd7 73 m"})]}),(0,t.jsxs)(k,{children:[(0,t.jsx)(z,{children:"LEO Range"}),(0,t.jsx)(S,{children:"160–2,000 km"})]}),(0,t.jsxs)(k,{children:[(0,t.jsx)(z,{children:"Orbital Velocity"}),(0,t.jsx)(S,{children:"~7.66 km/s"})]}),(0,t.jsxs)(k,{children:[(0,t.jsx)(z,{children:"ISS Crew"}),(0,t.jsx)(S,{children:"~7 people"})]})]})]})}},9522(e,o,r){r.d(o,{Ey:()=>g,IT:()=>d,mJ:()=>l,so:()=>n,wB:()=>x});var t=r(7991),a=r(5523),i=r(5881);function n(e=5e3){let{data:o,loading:r,failed:t,refresh:i}=(0,a.useIssPosition)({refreshMs:e});return{data:o,loading:r,error:t?"Fetch failed":null,refresh:i}}function l(){let[e,o]=(0,t.useState)(null),[r,a]=(0,t.useState)("pending");return(0,t.useEffect)(()=>{navigator.geolocation?navigator.geolocation.getCurrentPosition(e=>{o({lat:e.coords.latitude,lon:e.coords.longitude}),a("granted")},()=>a("denied"),{timeout:8e3}):a("denied")},[]),{location:e,status:r}}let s=[{norad:25544,name:"ISS",category:"station"},{norad:48274,name:"Tiangong",category:"station"},{norad:25994,name:"Terra",category:"observation"},{norad:27424,name:"Aqua",category:"observation"},{norad:49260,name:"Landsat-9",category:"observation"},{norad:43873,name:"GPS III-1",category:"navigation"},{norad:45854,name:"GPS III-4",category:"navigation"},{norad:40534,name:"GPS IIF-10",category:"navigation"},{norad:44713,name:"Starlink-24",category:"communications"},{norad:44914,name:"Starlink-60",category:"communications"},{norad:45178,name:"Starlink-100",category:"communications"},{norad:20580,name:"Hubble",category:"scientific"},{norad:37820,name:"Suomi NPP",category:"scientific"},{norad:41866,name:"GOES-16",category:"weather"},{norad:44914,name:"GOES-18",category:"weather"}],d={station:"#ffd700",observation:"#58a6ff",navigation:"#3fb950",communications:"#e3b341",scientific:"#bc8cff",weather:"#79c0ff"},c=new Map;function p(e,o,r){try{let t=(0,i.jl)(e,o),a=(0,i.gv)(t,r);if(!a.position||"boolean"==typeof a.position)return null;let n=(0,i.Y0)(r),l=(0,i.$6)(a.position,n);return{latitude:(0,i.Zr)(l.latitude),longitude:(0,i.yy)(l.longitude),altitude:l.height}}catch{return null}}function g(e=5e3){let[o,r]=(0,t.useState)([]),i=(0,t.useCallback)(async()=>{let e=await Promise.allSettled(s.map(async(e,o)=>(await new Promise(e=>setTimeout(e,120*o)),(0,a.fetchCachedTle)(e.norad)))),o=new Date,t=[];e.forEach((e,r)=>{if("fulfilled"!==e.status||!e.value)return;let{line1:a,line2:i}=e.value;c.set(s[r].norad,{line1:a,line2:i});let n=p(a,i,o);if(n){let e=s[r];t.push({norad:e.norad,name:e.name,category:e.category,...n})}}),t.length>0&&r(t)},[]);return(0,t.useEffect)(()=>{i();let e=setInterval(i,36e5);return()=>clearInterval(e)},[i]),(0,t.useEffect)(()=>{let o=setInterval(()=>{let e=new Date,o=[];s.forEach(r=>{let t=c.get(r.norad);if(!t)return;let a=p(t.line1,t.line2,e);a&&o.push({norad:r.norad,name:r.name,category:r.category,...a})}),o.length>0&&r(o)},e);return()=>clearInterval(o)},[e]),o}function x(e=60){let o=(0,t.useRef)([]),[r,a]=(0,t.useState)([]);return{trail:r,addPoint:(0,t.useCallback)((r,t)=>{o.current=[...o.current,[r,t]].slice(-e),a([...o.current])},[e])}}},18(e,o,r){r.d(o,{$n:()=>u,In:()=>M});var t=r(5723),a=r(7991),i=r.n(a),n=r(6859),l=r.n(n),s=r(4764);let d={ghost:"transparent",accent:"transparent",primary:s.w4.colors.accent,success:"#238636",danger:"#da3633"},c={ghost:s.w4.colors.sidebarHover,accent:"rgba(88,166,255,0.10)",primary:s.w4.colors.accentHover,success:"#2ea043",danger:"#f85149"},p={ghost:s.w4.colors.border,accent:s.w4.colors.accent,primary:s.w4.colors.accent,success:"#238636",danger:"#da3633"},g={ghost:s.w4.colors.mainTextMuted,accent:s.w4.colors.accent,primary:"#fff",success:"#fff",danger:"#fff"},x={ghost:s.w4.colors.mainText,accent:s.w4.colors.accent,primary:"#fff",success:"#fff",danger:"#fff"},h={sm:"28px",md:"30px"},f={sm:"0 10px",md:"0 12px"},m={sm:"12px",md:"12px"},b=l().button`
  display: inline-flex;
  align-items: center;
  justify-content: center;
  gap: 6px;
...
`,l().span`
  ...
  background: ${({color:e})=>e};
  display: inline-block;
`;let T={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:s.w4.colors.accentMuted},j={neutral:s.w4.colors.mainTextMuted,live:s.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:s.w4.colors.accent};l().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${s.w4.typography.fontFamilyMono};
...
`,A.A,A.A['pre[class*="language-"]'],s.w4.colors.codeBg,A.A['code[class*="language-"]'],l().div`
  background: ${({bg:e})=>e};
