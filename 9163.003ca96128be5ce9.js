...
`,ef=l().div`
  ...
  animation: ${em} ${c.w4.transitions.base};
  display: flex;
...
`,tg=l().div`
  ...
  animation: ${tm} 0.25s ${c.w4.transitions.easing} both;
...
`,ig=l().div`
  ...
  overflow: hidden;
  animation: ${im} 0.25s ${c.w4.transitions.easing} both;
  animation-delay: 1s;
  transition:
    border-color ${c.w4.transitions.fast},
    transform ${c.w4.transitions.fast};
...
`,ix=l().button`
  ...
  &:hover { color: ${c.w4.colors.mainText}; }
  &:focus-visible { ${c.w4.focusRing} }
`;function iy({onOpenPalette:e,t}){let[a,r]=(0,o.useState)(()=>{try{return"1"===localStorage.getItem(ih)}catch{return!1}});return((0,o.useEffect)(()=>{let e=e=>{e.key===ih&&r("1"===e.newValue)};return window.addEventListener("storage",e),()=>window.removeEventListener("storage",e)},[]),a)?null:ec().createPortal((0,i.jsxs)(ig,{children:[(0,i.jsxs)(ib,{type:"button","aria-label":t("cmdk.hint.aria"),onClick:e,children:[(0,i.jsx)(p.ue,{children:"⌘K"}),(0,i.jsx)("span",{className:"hint-label",children:t("cmdk.hint.label")})]}),(0,i.jsx)(ix,{type:"button",className:"dismiss","aria-label":t("cmdk.hint.dismiss"),title:t("cmdk.hint.dismiss"),onClick:e=>{e.stopPropagation();try{localStorage.setItem(ih,"1")}catch{}r(!0)},children:"\xd7"})]}),document.body)}var iw=a(8933);let iv=(0,d.keyframes)`
...
`;function x({locale:e,onChange:t}){return(0,h.jsxs)(f,{children:[(0,h.jsx)(b,{active:"pt"===e,onClick:()=>t("pt"),children:"PT"}),(0,h.jsx)(b,{active:"en"===e,onClick:()=>t("en"),children:"EN"})]})}},45030(e,t,a){a.d(t,{YZ:()=>eX,n6:()=>A,Yw:()=>ez,SV:()=>eB,rl:()=>e9,dO:()=>t3,TM:()=>ar,pd:()=>e4,mQ:()=>tV,tU:()=>j,xx:()=>am,ue:()=>eJ,Ex:()=>eV,$n:()=>x,In:()=>L,K0:()=>$,eu:()=>O});var i=a(65723),o=a(37991),r=a.n(o),n=a(36859),s=a.n(n),l=a(94764);let d={ghost:"transparent",accent:"transparent",primary:l.w4.colors.accent,success:"#238636",danger:"#da3633"},c={ghost:l.w4.colors.sidebarHover,accent:"rgba(88,166,255,0.10)",primary:l.w4.colors.accentHover,success:"#2ea043",danger:"#f85149"},p={ghost:l.w4.colors.border,accent:l.w4.colors.accent,primary:l.w4.colors.accent,success:"#238636",danger:"#da3633"},u={ghost:l.w4.colors.mainTextMuted,accent:l.w4.colors.accent,primary:"#fff",success:"#fff",danger:"#fff"},h={ghost:l.w4.colors.mainText,accent:l.w4.colors.accent,primary:"#fff",success:"#fff",danger:"#fff"},m={sm:"28px",md:"30px"},g={sm:"0 10px",md:"0 12px"},f={sm:"12px",md:"12px"},b=s().button`
  display: inline-flex;
  align-items: center;
  justify-content: center;
  gap: 6px;
...
`,eh=s().span`
  ...
  letter-spacing: 0.06em;
  text-transform: uppercase;
`,em=s()("span",{shouldForwardProp:e=>"accent"!==e})`
  font-family: ${l.w4.typography.fontFamilyMono};
  font-size: 10.5px;
  min-width: 24px;
  height: 22px;
...
`;function ez({locale:e,onLocaleChange:t,user:a,userMenuItems:o=[],userMenuControlLabels:r,suites:n,onPreferences:s,notifications:d,onOpenPalette:c,paletteLabel:p="Search",onSignIn:u,signInLabel:h="Sign in",before:m,after:g}){let f=function(){if("u"<typeof navigator)return"Ctrl";let e=navigator,t=e.userAgentData?.platform??navigator.platform??navigator.userAgent??"";return/Mac|iPod|iPhone|iPad/i.test(t)?"⌘":"Ctrl"}(),b="⌘"===f?`${f}K`:`${f}+K`;return(0,i.jsxs)(ew,{children:[m,n&&n.entries.length>0&&(0,i.jsx)(ey,{label:n.label,ariaLabel:n.ariaLabel,appsLabel:n.appsLabel,suites:n.entries}),c&&(0,i.jsxs)(e$,{onClick:c,"aria-label":p,title:`${p} (${b})`,children:[(0,i.jsx)(L,{name:"search",size:14}),(0,i.jsx)("span",{className:"kbd header-kbd",children:b})]}),!a&&(0,i.jsx)(ei.Fd,{locale:e,onChange:t}),!a&&(0,i.jsx)("span",{className:"header-hide-md",children:(0,i.jsx)(l.UW,{})}),d&&(0,i.jsxs)(ek,{children:[(0,i.jsx)(ev,{onClick:d.onClick,"aria-label":d.label,title:d.label,children:(0,i.jsx)(L,{name:"bell",size:16})}),d.count>0&&(0,i.jsx)(eM,{"aria-hidden":"true",children:d.count>9?"9+":d.count})]}),s&&(0,i.jsx)("span",{className:"header-hide-md",children:(0,i.jsx)(ev,{onClick:s,"aria-label":"User preferences",title:"Preferences",children:(0,i.jsx)(L,{name:"user-cog",size:16})})}),a?(0,i.jsx)(ea,{user:a,items:o,locale:e,onLocaleChange:t,controlLabels:r}):u?(0,i.jsxs)(ej,{onClick:u,"aria-label":h,children:[(0,i.jsx)(L,{name:"log-in",size:14}),h]}):null,g]})}s().div`
  position: fixed;
  inset: 0;
  pointer-events: none;
  z-index: 900;
...
`;s().div`
  ...
  pointer-events: none;
  z-index: 200;
  animation: ${t8} 0.16s cubic-bezier(0.4, 0, 0.2, 1) forwards;
...
`,ah=s().span`
  ...
  font-size: ${l.w4.typography.fontSizeSm};
  letter-spacing: 0.04em;
`;function am({label:e="Loading…"}){return(0,i.jsxs)(ad,{children:[(0,i.jsxs)(ac,{children:[(0,i.jsx)(ap,{delay:0,size:8,color:l.w4.colors.accent}),(0,i.jsx)(ap,{delay:-.45,size:6,color:"#bc8cff"}),(0,i.jsx)(ap,{delay:-.9,size:5,color:"#3fb950"}),(0,i.jsx)(au,{})]}),(0,i.jsx)(ah,{children:e})]})}s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
