"use strict";(self.webpackChunk_atlantis_pad=self.webpackChunk_atlantis_pad||[]).push([["5237"],{53804(e,o,a){a.d(o,{M:()=>f});var t=a(65723);a(37991);var r=a(36859),i=a.n(r),n=a(94764),l=a(42907);let s=i().div`
  display: flex;
...
`,l().span`
  font-size: ${i.w4.typography.fontSizeBase};
  color: ${i.w4.colors.mainTextMuted};
`;var W=a(17223),O=a(21426);let U=l().div`
  margin: ${i.w4.spacing.lg} 0;
  border-radius: ${i.w4.borderRadius.md};
  border: 1px solid ${i.w4.colors.codeBorder};
  overflow: hidden;
...
`,T=s().main`
  ...
  display: flex;
  flex-direction: column;
`,j=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function S(){return(0,r.jsx)(b,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:j.map((e,o)=>(0,r.jsx)(w,{index:o,accent:e.accent,children:e.char},o))})}let A="atlantis:sidebar-collapsed";function C({sidebar:e,children:o,topBarRight:t,title:l="Atlantis",activeId:s=null}){let[d,p]=(0,i.useState)(()=>{try{return"true"===localStorage.getItem(A)}catch{return!1}}),[g,h]=(0,i.useState)(null),u=(0,i.useRef)(),b=()=>p(e=>{let o=!e;try{localStorage.setItem(A,String(o))}catch{}return o}),w=n().useMemo(()=>n().lazy(()=>Promise.resolve().then(a.bind(a,87330)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(c.I.Provider,{value:{collapsed:d,toggle:b,flyout:g,openFlyout:(e,o,a)=>{clearTimeout(u.current),h({entry:e,anchorY:o,onSelect:a})},scheduleFlyoutClose:()=>{u.current=setTimeout(()=>h(null),160)},cancelFlyoutClose:()=>clearTimeout(u.current)},children:(0,r.jsxs)(z,{children:[(0,r.jsxs)(m,{children:[e&&(0,r.jsx)(f,{children:(0,r.jsx)(x,{onClick:b,title:d?"Expand sidebar":"Collapse sidebar",children:(0,r.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,r.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,r.jsx)("path",{d:"M9 3v18"})]})})}),(0,r.jsx)(S,{}),l&&(0,r.jsx)(y,{children:l}),t&&(0,r.jsx)($,{children:t})]}),(0,r.jsxs)(v,{children:[null!=e&&(0,r.jsx)(M,{collapsed:d,children:(0,r.jsx)(k,{children:e})}),(0,r.jsx)(T,{children:o})]}),g&&(0,r.jsx)(n().Suspense,{fallback:null,children:(0,r.jsx)(w,{activeId:s})})]})})}s().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
...
`;function Y({appId:e,onLoad:o}){let[a,t]=(0,i.useState)(!1),[n,l]=(0,i.useState)([]),s=(0,i.useRef)(null),d=(0,i.useCallback)(()=>{(0,B.listDocs)(e).then(l).catch(()=>{})},[e]);(0,i.useEffect)(()=>{if(!a)return;d();let e=e=>{s.current&&!s.current.contains(e.target)&&t(!1)};return document.addEventListener("mousedown",e),()=>document.removeEventListener("mousedown",e)},[a,d]);let c=async(e,o)=>{e.stopPropagation(),await (0,B.deleteDoc)(o),l(e=>e.filter(e=>e.id!==o))};return(0,r.jsxs)(F,{ref:s,children:[(0,r.jsxs)(L,{onClick:()=>t(e=>!e),children:[(0,r.jsx)("svg",{width:14,height:14,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:(0,r.jsx)("path",{d:"M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"})}),"Saved",(0,r.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",style:{marginLeft:2},children:(0,r.jsx)("path",{d:"M6 9l6 6 6-6"})})]}),(0,r.jsxs)(H,{open:a,children:[(0,r.jsx)(R,{children:"Saved versions"}),(0,r.jsx)(E,{children:0===n.length?(0,r.jsx)(P,{children:"No saved documents yet."}):n.map(e=>{var a;return(0,r.jsxs)(I,{children:[(0,r.jsxs)(V,{onClick:()=>{o(e.content,e.id,e.name),t(!1)},children:[(0,r.jsx)(D,{children:e.name}),(0,r.jsx)(N,{children:(a=e.savedAt,new Intl.DateTimeFormat(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}).format(new Date(a)))})]}),(0,r.jsx)(K,{onClick:o=>c(o,e.id),title:"Delete",children:(0,r.jsxs)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,r.jsx)("polyline",{points:"3 6 5 6 21 6"}),(0,r.jsx)("path",{d:"M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6M10 11v6M14 11v6"}),(0,r.jsx)("path",{d:"M9 6V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2"})]})})]},e.id)})})]})]})}s().div`
...
`,n().span`
  ...
  background: ${({color:e})=>e};
  display: inline-block;
`;let S={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:l.w4.colors.accentMuted},A={neutral:l.w4.colors.mainTextMuted,live:l.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:l.w4.colors.accent};n().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${l.w4.typography.fontFamilyMono};
...
`;function I({activeAppId:e}){let{collapsed:o}=(0,l.cL)(),[a]=function(){let[e,o]=(0,r.useState)(T),a=(0,r.useCallback)(e=>{o(e);try{localStorage.setItem(z,e)}catch{}(0,l.Is)(M,e).catch(()=>{}),window.dispatchEvent(new CustomEvent("atlantis:locale-change",{detail:e}))},[]);return(0,r.useEffect)(()=>{let e=e=>{o(e.detail)};return window.addEventListener("atlantis:locale-change",e),()=>window.removeEventListener("atlantis:locale-change",e)},[]),(0,r.useEffect)(()=>{(0,l.PL)(M).then(a=>{if(k(a)&&a!==e){try{localStorage.setItem(z,a)}catch{}o(a)}}).catch(()=>{})},[]),[e,a]}(),i=(0,r.useMemo)(()=>(e,o)=>{let t=function(e,o){if(!o||!e.includes("|"))return e;let a=null;for(let e of Object.values(o))if("number"==typeof e&&Number.isFinite(e)){a=e;break}if(null===a)return e;let t=e.indexOf("|"),r=e.slice(0,t),i=e.slice(t+1);return 1===a?r:i}(v[e]?.[a]??e,o);return o?Object.entries(o).reduce((e,[o,a])=>e.replace(RegExp(`\\{${o}\\}`,"g"),String(a)),t):t},[a]),n=(0,r.useRef)(null),s=e=>{n.current!==e&&(n.current=e,document.activeElement?.blur(),window.location.hash=e,setTimeout(()=>{n.current=null},50))};return(0,t.jsxs)(L,{children:[(0,t.jsx)(H,{collapsed:o,children:i("devtools.heading")}),F.map(a=>{let r=i(a.labelKey);return(0,t.jsxs)(R,{active:e===a.id,collapsed:o,onPointerDown:e=>{0===e.button&&s(a.hash)},onClick:()=>s(a.hash),title:r,children:[(0,t.jsx)(E,{children:(0,t.jsx)(y,{name:a.icon,size:16})}),(0,t.jsx)(P,{collapsed:o,children:r})]},a.id)})]})}let V=(0,b.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`;n().div`
  display: grid;
...
`,q=n().div`
  ...
  color: ${l.w4.colors.sidebarTextMuted};
  font-family: ${l.w4.typography.fontFamily};
`;function J({onSave:e,onUpdate:o,onCancel:a,existingDoc:i}){let[n,l]=(0,r.useState)(i?.name??""),s=(0,r.useRef)(null);return(0,r.useEffect)(()=>{s.current?.focus(),i&&s.current?.select()},[i]),(0,t.jsx)(K,{onClick:a,children:(0,t.jsxs)(Y,{onClick:e=>e.stopPropagation(),children:[(0,t.jsx)(G,{children:"Save document"}),i&&o&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(q,{children:"Update the current version or save as a new one."}),(0,t.jsxs)(O,{children:[(0,t.jsx)(U,{onClick:a,children:"Cancel"}),(0,t.jsxs)(U,{danger:!0,onClick:o,children:['Update "',i.name,'"']})]}),(0,t.jsx)(_,{})]}),(0,t.jsx)(W,{ref:s,value:n,onChange:e=>l(e.target.value),onKeyDown:t=>{"Enter"===t.key&&n.trim()&&(i&&n.trim()===i.name&&o?o():e(n.trim())),"Escape"===t.key&&a()},placeholder:i?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,t.jsxs)(O,{children:[!i&&(0,t.jsx)(U,{onClick:a,children:"Cancel"}),(0,t.jsx)(U,{primary:!0,disabled:!n.trim(),onClick:()=>e(n.trim()),children:"Save as new"})]})]})})}let Z=(0,b.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,X=(0,b.keyframes)`
