...
`},7330(o,e,a){a.d(e,{FlyoutPanel:()=>oL});var t=a(5723),r=a(7991),i=a.n(r),n=a(6859),l=a.n(n),s=a(2799),d=a(1316),c=a(814),p=a(6896),g=a(7902),m=a(3013),f=a(2887),x=a(9510),u=a(9848),h=a(7901),b=a(3045),y=a(3775),w=a(1783),$=a(3539),v=a(9416),z=a(1837),k=a(7167),M=a(4494),A=a(2314),T=a(255),S=a(5751),j=a(9633),F=a(2946),B=a(822),C=a(6720),H=a(7400),L=a(8456),R=a(3317),P=a(2709),E=a(8006),V=a(9301),D=a(7561),N=a(3517),Y=a(8207),I=a(7032),G=a(6949),K=a(8218),O=a(6829),_=a(9591),W=a(5553),J=a(9923),Z=a(2820),U=a(4621),q=a(8479),X=a(2534),Q=a(6673),oo=a(7490),oe=a(9033),oa=a(9038),ot=a(5775),or=a(1365),oi=a(2937),on=a(9821),ol=a(5912),os=a(158),od=a(8641),oc=a(8607),op=a(3249),og=a(1821),om=a(5889),of=a(9655),ox=a(7170),ou=a(9161),oh=a(1849),ob=a(1604),oy=a(3142),ow=a(1187),o$=a(7747),ov=a(2932),oz=a(4525),ok=a(7230),oM=a(2164);let oA={activity:p.A,"a-large-small":g.A,apple:m.A,"arrow-right":f.A,"bar-chart-2":x.A,book:u.A,"book-open":h.A,briefcase:b.A,calendar:y.A,clock:w.A,"circle-dot":$.A,cloud:v.A,compass:z.A,cpu:k.A,droplets:M.A,feather:A.A,file:T.A,"file-text":S.A,folder:j.A,"git-branch":F.A,github:B.A,globe:C.A,grid:H.A,hand:L.A,hash:R.A,heart:P.A,key:E.A,hexagon:V.A,home:D.A,landmark:N.A,layers:Y.A,"layout-grid":I.A,leaf:G.A,lightbulb:K.A,list:O.A,map:_.A,"map-pin":W.A,"message-circle":J.A,"message-square":Z.A,minus:U.A,monitor:q.A,mountain:X.A,package:Q.A,palette:oo.A,"pen-tool":oe.A,"pie-chart":oa.A,plane:ot.A,plus:or.A,ruler:oi.A,shirt:on.A,slash:ol.A,square:os.A,star:od.A,sun:oc.A,terminal:op.A,thermometer:og.A,triangle:om.A,trophy:of.A,truck:ox.A,type:ou.A,users:oh.A,"volume-2":ob.A,watch:oy.A,waves:ow.A,wind:o$.A,wrench:ov.A,x:oz.A,zap:ok.A,bot:oM.A},oT=(0,s.keyframes)`
...
`,oB=({size:o=14,strokeWidth:e=1.75})=>(0,t.jsxs)("svg",{width:o,height:o,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:e,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,t.jsx)("polyline",{points:"14 2 14 8 20 8"})]});function oC({iconKey:o}){let e=o?oA[o]:null;return e?(0,t.jsx)(e,{size:14,strokeWidth:1.75}):(0,t.jsx)(oB,{})}function oH({entries:o,activeId:e,onSelect:a}){return(0,t.jsx)(t.Fragment,{children:o.map(o=>o.children?(0,t.jsx)(i().Fragment,{children:(0,t.jsx)(oH,{entries:o.children,activeId:e,onSelect:a})},o.id):(0,t.jsxs)(oF,{active:e===o.id,onClick:()=>a(o),children:[(0,t.jsx)(oC,{iconKey:o.icon}),o.name]},o.id))})}function oL({activeId:o}){let{flyout:e,scheduleFlyoutClose:a,cancelFlyoutClose:r}=(0,c.c)();if(!e)return null;let i=e.entry.icon?oA[e.entry.icon]:null;return(0,t.jsxs)(oS,{anchorY:e.anchorY,onMouseEnter:r,onMouseLeave:a,children:[(0,t.jsxs)(oj,{children:[i?(0,t.jsx)(i,{size:13,strokeWidth:2}):(0,t.jsx)(oB,{size:13,strokeWidth:2}),e.entry.name]}),(0,t.jsx)(oH,{entries:e.entry.children??[],activeId:o,onSelect:o=>{e.onSelect(o),a()}})]})}},814(o,e,a){a.d(e,{I:()=>r,c:()=>i});var t=a(7991);let r=(0,t.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),i=()=>(0,t.useContext)(r)},3930(o,e,a){a.d(e,{Is:()=>C.putSetting,w4:()=>t.w4,pJ:()=>C.putLocalSetting,PE:()=>F,qj:()=>C.getLocalSetting,PL:()=>C.getSetting});var t=a(1316),r=a(5723),i=a(7991),n=a.n(i),l=a(6859),s=a.n(l);s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,v=i().forwardRef(function({active:o=!1,shape:e="square",tone:a="default",children:r,...i},n){return(0,t.jsx)($,{ref:n,active:o,shape:e,tone:a,...i,children:r})});l().div`
  position: relative;
  display: inline-flex;
`,l().div`
  position: absolute;
...
`,a(2727);var z=a(2799);let k=(0,z.keyframes)`
...
`;let C=l().div`
  ...
  align-items: center;
  gap: 8px;
`;function H({children:o,...e}){return(0,t.jsx)(C,{...e,children:o})}l().label`
  display: flex;
  align-items: center;
  gap: 10px;
