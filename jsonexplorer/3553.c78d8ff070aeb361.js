"use strict";(self.webpackChunk_atlantis_jsonexplorer=self.webpackChunk_atlantis_jsonexplorer||[]).push([["3553"],{5151(o,e,a){a.d(e,{k:()=>r});let r=[{label:"GitHub API response",json:JSON.stringify({id:1296269,name:"atlantis",full_name:"octocat/atlantis",owner:{login:"octocat",id:1,type:"User"},private:!1,description:"A monorepo of mini web apps",fork:!1,created_at:"2024-01-15T12:00:00Z",stargazers_count:42,watchers_count:42,language:"TypeScript",topics:["react","typescript","webpack","module-federation"],license:{key:"mit",name:"MIT License"}},null,2)},{label:"Users list",json:JSON.stringify({total:3,page:1,users:[{id:1,name:"Alice",email:"alice@example.com",role:"admin",active:!0,score:98.5},{id:2,name:"Bob",email:"bob@example.com",role:"user",active:!0,score:74.2},{id:3,name:"Charlie",email:"charlie@example.com",role:"user",active:!1,score:61}],meta:{hasNext:!1,hasPrev:!1}},null,2)},{label:"Config file",json:JSON.stringify({app:{name:"Atlantis",version:"1.0.0",env:"production"},server:{host:"0.0.0.0",port:3e3,cors:!0},database:{primary:{host:"db.example.com",port:5432,name:"atlantis_prod"},replica:{host:"replica.example.com",port:5432,name:"atlantis_prod"}},features:{darkMode:!0,analytics:!1,betaFeatures:["newDashboard","aiSuggestions"]},limits:{maxUploadMB:100,rateLimit:1e3,timeout:3e4}},null,2)},{label:"Package.json",json:JSON.stringify({name:"@atlantis/shell",version:"1.0.0",scripts:{dev:"webpack serve",build:"webpack",typecheck:"tsc --noEmit"},dependencies:{"@atlantis/shared":"workspace:*",react:"^18.3.1","react-dom":"^18.3.1"},devDependencies:{typescript:"^5.7.3",webpack:"^5.97.1"}},null,2)},{label:"Nested deep object",json:JSON.stringify({level1:{level2:{level3:{level4:{value:"deep nested value",array:[1,2,{nested:!0,items:[null,!1,"string"]}]}}},siblings:[{id:"a",data:[1,2,3]},{id:"b",data:[4,5,6]}]},metadata:{created:"2024-01-01",tags:["a","b","c"],active:null}},null,2)}]},3173(o,e,a){a.d(e,{Y:()=>r});function r(o,e){if(!(e=e.trim())||"$"===e)return[{path:"$",value:o}];let a=[];return!function o(e,r,t){if(!r)return void a.push({path:t,value:e});if(r.startsWith("..")){let a=r.slice(2);if(o(e,"."+a,t),Array.isArray(e))e.forEach((e,r)=>o(e,".."+a,`${t}[${r}]`));else if(null!==e&&"object"==typeof e)for(let r of Object.keys(e))o(e[r],".."+a,`${t}.${r}`);return}let i=r.match(/^\.(\*|[^.[*\]]+)(.*)/s);if(i){let[,a,r]=i;if("*"===a){if(Array.isArray(e))e.forEach((e,a)=>o(e,r,`${t}[${a}]`));else if(null!==e&&"object"==typeof e)for(let a of Object.keys(e))o(e[a],r,`${t}.${a}`)}else if(null===e||"object"!=typeof e||Array.isArray(e))Array.isArray(e)&&e.forEach((e,i)=>{if(null!==e&&"object"==typeof e&&!Array.isArray(e)){let n=e[a];void 0!==n&&o(n,r,`${t}[${i}].${a}`)}});else{let i=e[a];void 0!==i&&o(i,r,`${t}.${a}`)}return}let n=r.match(/^\[(\*|\d+|'[^']*'|"[^"]*")\](.*)/s);if(n){let[,a,r]=n;if("*"===a){if(Array.isArray(e))e.forEach((e,a)=>o(e,r,`${t}[${a}]`));else if(null!==e&&"object"==typeof e)for(let a of Object.keys(e))o(e[a],r,`${t}['${a}']`)}else if(/^\d+$/.test(a)){let i=parseInt(a,10);Array.isArray(e)&&i<e.length&&o(e[i],r,`${t}[${i}]`)}else{let i=a.slice(1,-1);if(null!==e&&"object"==typeof e&&!Array.isArray(e)){let a=e[i];void 0!==a&&o(a,r,`${t}['${i}']`)}}return}}(o,e.startsWith("$")?e.slice(1):e,"$"),a}},7330(o,e,a){a.d(e,{FlyoutPanel:()=>oP});var r=a(5723),t=a(7991),i=a.n(t),n=a(6859),l=a.n(n),s=a(2799),d=a(255),c=a(1316),p=a(814),g=a(6896),m=a(7902),f=a(3013),x=a(2887),u=a(9510),b=a(9848),h=a(7901),w=a(3045),y=a(3775),$=a(1783),z=a(3539),v=a(9416),k=a(1837),M=a(7167),A=a(4494),T=a(2314),S=a(5751),j=a(9633),F=a(2946),B=a(822),R=a(6720),P=a(7400),C=a(8456),E=a(3317),H=a(2709),L=a(8006),D=a(9301),N=a(7561),K=a(3517),I=a(8207),Y=a(7032),V=a(6949),G=a(8218),_=a(6829),O=a(9591),J=a(5553),U=a(9923),W=a(2820),Z=a(4621),q=a(8479),X=a(2534),Q=a(6673),oo=a(7490),oe=a(9033),oa=a(9038),or=a(5775),ot=a(1365),oi=a(2937),on=a(9821),ol=a(5912),os=a(158),od=a(8641),oc=a(8607),op=a(3249),og=a(1821),om=a(5889),of=a(9655),ox=a(7170),ou=a(9161),ob=a(1849),oh=a(1604),ow=a(3142),oy=a(1187),o$=a(7747),oz=a(2932),ov=a(4525),ok=a(7230),oM=a(2164);let oA={activity:g.A,"a-large-small":m.A,apple:f.A,"arrow-right":x.A,"bar-chart-2":u.A,book:b.A,"book-open":h.A,briefcase:w.A,calendar:y.A,clock:$.A,"circle-dot":z.A,cloud:v.A,compass:k.A,cpu:M.A,droplets:A.A,feather:T.A,file:d.A,"file-text":S.A,folder:j.A,"git-branch":F.A,github:B.A,globe:R.A,grid:P.A,hand:C.A,hash:E.A,heart:H.A,key:L.A,hexagon:D.A,home:N.A,landmark:K.A,layers:I.A,"layout-grid":Y.A,leaf:V.A,lightbulb:G.A,list:_.A,map:O.A,"map-pin":J.A,"message-circle":U.A,"message-square":W.A,minus:Z.A,monitor:q.A,mountain:X.A,package:Q.A,palette:oo.A,"pen-tool":oe.A,"pie-chart":oa.A,plane:or.A,plus:ot.A,ruler:oi.A,shirt:on.A,slash:ol.A,square:os.A,star:od.A,sun:oc.A,terminal:op.A,thermometer:og.A,triangle:om.A,trophy:of.A,truck:ox.A,type:ou.A,users:ob.A,"volume-2":oh.A,watch:ow.A,waves:oy.A,wind:o$.A,wrench:oz.A,x:ov.A,zap:ok.A,bot:oM.A},oT=(0,s.keyframes)`
...
`;function oB({iconKey:o}){let e=o?oA[o]??d.A:d.A;return(0,r.jsx)(e,{size:14,strokeWidth:1.75})}function oR({entries:o,activeId:e,onSelect:a}){return(0,r.jsx)(r.Fragment,{children:o.map(o=>o.children?(0,r.jsx)(i().Fragment,{children:(0,r.jsx)(oR,{entries:o.children,activeId:e,onSelect:a})},o.id):(0,r.jsxs)(oF,{active:e===o.id,onClick:()=>a(o),children:[(0,r.jsx)(oB,{iconKey:o.icon}),o.name]},o.id))})}function oP({activeId:o}){let{flyout:e,scheduleFlyoutClose:a,cancelFlyoutClose:t}=(0,p.c)();if(!e)return null;let i=e.entry.icon?oA[e.entry.icon]??d.A:d.A;return(0,r.jsxs)(oS,{anchorY:e.anchorY,onMouseEnter:t,onMouseLeave:a,children:[(0,r.jsxs)(oj,{children:[(0,r.jsx)(i,{size:13,strokeWidth:2}),e.entry.name]}),(0,r.jsx)(oR,{entries:e.entry.children??[],activeId:o,onSelect:o=>{e.onSelect(o),a()}})]})}},814(o,e,a){a.d(e,{I:()=>t,c:()=>i});var r=a(7991);let t=(0,r.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),i=()=>(0,r.useContext)(t)},5726(o,e,a){a.d(e,{PL:()=>K,MJ:()=>W,mZ:()=>D,KL:()=>L,cL:()=>p.c,Is:()=>N,UO:()=>og,PE:()=>B,w4:()=>r.w4});var r=a(1316),t=a(5723),i=a(7991),n=a.n(i),l=a(6859),s=a.n(l);s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,U=s().div`
  ...
  color: ${r.w4.colors.sidebarTextMuted};
  font-family: ${r.w4.typography.fontFamily};
`;function W({onSave:o,onUpdate:e,onCancel:a,existingDoc:r}){let[n,l]=(0,i.useState)(r?.name??""),s=(0,i.useRef)(null);return(0,i.useEffect)(()=>{s.current?.focus(),r&&s.current?.select()},[r]),(0,t.jsx)(I,{onClick:a,children:(0,t.jsxs)(Y,{onClick:o=>o.stopPropagation(),children:[(0,t.jsx)(V,{children:"Save document"}),r&&e&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(U,{children:"Update the current version or save as a new one."}),(0,t.jsxs)(_,{children:[(0,t.jsx)(O,{onClick:a,children:"Cancel"}),(0,t.jsxs)(O,{danger:!0,onClick:e,children:['Update "',r.name,'"']})]}),(0,t.jsx)(J,{})]}),(0,t.jsx)(G,{ref:s,value:n,onChange:o=>l(o.target.value),onKeyDown:t=>{"Enter"===t.key&&n.trim()&&(r&&n.trim()===r.name&&e?e():o(n.trim())),"Escape"===t.key&&a()},placeholder:r?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,t.jsxs)(_,{children:[!r&&(0,t.jsx)(O,{onClick:a,children:"Cancel"}),(0,t.jsx)(O,{primary:!0,disabled:!n.trim(),onClick:()=>o(n.trim()),children:"Save as new"})]})]})})}let Z=(0,d.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,q=(0,d.keyframes)`
...
`;var X=a(5625),Q=a(679),oo=a(4872);let oe=s().div`
  position: relative;
`,oa=s().button`
  display: flex;
  align-items: center;
...
`;function og({appId:o,onLoad:e}){let[a,r]=(0,i.useState)(!1),[n,l]=(0,i.useState)([]),s=(0,i.useRef)(null),d=(0,i.useCallback)(()=>{H.listDocs(o).then(l).catch(()=>{})},[o]);(0,i.useEffect)(()=>{if(!a)return;d();let o=o=>{s.current&&!s.current.contains(o.target)&&r(!1)};return document.addEventListener("mousedown",o),()=>document.removeEventListener("mousedown",o)},[a,d]);let c=async(o,e)=>{o.stopPropagation(),await H.deleteDoc(e),l(o=>o.filter(o=>o.id!==e))};return(0,t.jsxs)(oe,{ref:s,children:[(0,t.jsxs)(oa,{onClick:()=>r(o=>!o),children:[(0,t.jsx)(X.A,{size:14}),"Saved",(0,t.jsx)(Q.A,{size:13,style:{marginLeft:2}})]}),(0,t.jsxs)(or,{open:a,children:[(0,t.jsx)(ot,{children:"Saved versions"}),(0,t.jsx)(oi,{children:0===n.length?(0,t.jsx)(on,{children:"No saved documents yet."}):n.map(o=>{var a;return(0,t.jsxs)(ol,{children:[(0,t.jsxs)(os,{onClick:()=>{e(o.content,o.id,o.name),r(!1)},children:[(0,t.jsx)(od,{children:o.name}),(0,t.jsx)(oc,{children:(a=o.savedAt,new Intl.DateTimeFormat(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}).format(new Date(a)))})]}),(0,t.jsx)(op,{onClick:e=>c(e,o.id),title:"Delete",children:(0,t.jsx)(oo.A,{size:13})})]},o.id)})})]})]})}s().div`
...
`;let u={default:l.w4.colors.accent,danger:"#f85149"},b={default:l.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"};n().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`,C.A,C.A['pre[class*="language-"]'],l.w4.colors.codeBg,C.A['code[class*="language-"]'],n().div`
  background: ${({bg:o})=>o};
...
`;function V({activeAppId:o}){let{collapsed:e}=(0,l.cL)(),[a]=function(){let[o,e]=(0,t.useState)(k),a=(0,t.useCallback)(o=>{e(o);try{localStorage.setItem($,o)}catch{}(0,l.Is)(z,o).catch(()=>{}),window.dispatchEvent(new CustomEvent("atlantis:locale-change",{detail:o}))},[]);return(0,t.useEffect)(()=>{let o=o=>{e(o.detail)};return window.addEventListener("atlantis:locale-change",o),()=>window.removeEventListener("atlantis:locale-change",o)},[]),(0,t.useEffect)(()=>{(0,l.PL)(z).then(a=>{if(v(a)&&a!==o){try{localStorage.setItem($,a)}catch{}e(a)}}).catch(()=>{})},[]),[o,a]}(),i=(0,t.useMemo)(()=>(o,e)=>{let r=y[o]?.[a]??o;return e?Object.entries(e).reduce((o,[e,a])=>o.replace(RegExp(`\\{${e}\\}`,"g"),String(a)),r):r},[a]),n=(0,t.useRef)(null),s=o=>{n.current!==o&&(n.current=o,document.activeElement?.blur(),window.location.hash=o,setTimeout(()=>{n.current=null},50))};return(0,r.jsxs)(D,{children:[(0,r.jsx)(N,{collapsed:e,children:i("devtools.heading")}),L.map(a=>{let t=i(a.labelKey);return(0,r.jsxs)(K,{active:o===a.id,collapsed:e,onPointerDown:o=>{0===o.button&&s(a.hash)},onClick:()=>s(a.hash),title:t,children:[(0,r.jsx)(I,{children:(0,r.jsx)(A,{name:a.icon,size:16})}),(0,r.jsx)(Y,{collapsed:e,children:t})]},a.id)})]})}}}]);