...
`,b=n().p`
  ...
  position: relative;
  z-index: 1;
  animation: ${u} 0.5s ease 0.1s both;
`,y=n().div`
  display: grid;
  ...
  position: relative;
  z-index: 1;
  animation: ${u} 0.5s ease 0.2s both;
...
`,$=n().h2`
  ...
  position: relative;
  z-index: 1;
  animation: ${u} 0.5s ease 0.25s both;
`,k=(0,s.keyframes)`
...
`,v=n().div`
  ...
  border-radius: 50%;
  background: white;
  animation: ${k} ${({dur:e})=>e}s ease-in-out infinite;
...
`,j=n().div`
  ...
  opacity: 0;
  pointer-events: none;
  animation: ${z} ${({delay:e})=>e}s ease-out infinite;
...
`,T=[{x:3,y:5,size:1.5,delay:0,dur:3.2},{x:8,y:35,size:2,delay:1.8,dur:3.4},{x:12,y:70,size:1.5,delay:.6,dur:4.1},{x:18,y:15,size:2.5,delay:2.4,dur:3},{x:22,y:55,size:1.5,delay:.3,dur:4.5},{x:28,y:88,size:2,delay:1.1,dur:3.6},{x:33,y:25,size:1.5,delay:2.8,dur:4},{x:40,y:60,size:2,delay:.9,dur:3.3},{x:45,y:8,size:2.5,delay:1.5,dur:3.8},{x:50,y:45,size:1.5,delay:2.1,dur:4.3},{x:55,y:78,size:2,delay:.4,dur:3.1},{x:60,y:18,size:1.5,delay:1.7,dur:4.6},{x:65,y:50,size:2.5,delay:2.6,dur:3.5},{x:70,y:85,size:1.5,delay:.2,dur:3.9},{x:75,y:30,size:2,delay:1.3,dur:4.2},{x:80,y:65,size:1.5,delay:2.9,dur:3.7},{x:85,y:10,size:2,delay:.7,dur:3.4},{x:88,y:42,size:2.5,delay:1.9,dur:4.4},{x:92,y:75,size:1.5,delay:.5,dur:3.2},{x:96,y:22,size:2,delay:2.3,dur:3.8}],S=n().button`
  ...
  position: relative;
  overflow: hidden;
  transition: border-color ${d.w4.transitions.slow}, transform 0.3s cubic-bezier(0.34, 1.56, 0.64, 1), box-shadow ${d.w4.transitions.slow};
  ...
  &::before {
    ...
    opacity: 0.5;
    transition: opacity ${d.w4.transitions.slow};
  }
  ...
  &:hover {
    ...
    background: linear-gradient(
      ...
      ${d.w4.colors.surfaceRaised} 45%,
      ${d.w4.colors.surfaceRaised} 100%
    );
...
`,P=n().span`
  ...
  transition: filter ${d.w4.transitions.slow};
`,E=n().span`
  font-size: ${d.w4.typography.fontSizeMd};
  font-weight: 700;
  color: ${d.w4.colors.mainText};
...
`,n().button`
  ...
  font-family: ${d.w4.typography.fontFamily};
  cursor: pointer;
  transition: background ${d.w4.transitions.base}, color ${d.w4.transitions.base}, box-shadow ${d.w4.transitions.base};
  white-space: nowrap;
...
`,R=n().div`
  ...
  align-items: center;
  gap: ${d.w4.spacing.sm};
`,X={pt:"O que vamos aprender hoje?",en:"What shall we learn today?"},N={pt:"Escolhe uma disciplina para come\xe7ar",en:"Pick a subject to get started"};function C({topBarRight:e}){let[a,t]=(0,i.useState)(m),[r]=(0,c.Ym)(),n="pt"===r?"pt":"en";if((0,i.useEffect)(()=>{let e=()=>t(m());return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[]),!a)return(0,o.jsx)(d.PE,{title:"School",sidebar:null,topBarRight:e,children:(0,o.jsxs)(w,{children:[T.map((e,a)=>(0,o.jsx)(v,{x:e.x,y:e.y,size:e.size,delay:e.delay,dur:e.dur},a)),(0,o.jsx)(j,{top:15,delay:12}),(0,o.jsx)(j,{top:55,delay:25}),(0,o.jsx)(f,{children:X[n]}),(0,o.jsx)(b,{children:N[n]}),(0,o.jsx)($,{children:"pt"===n?"Disciplinas":"Subjects"}),(0,o.jsx)(y,{columns:4,children:p.map((e,a)=>(0,o.jsxs)(S,{accentColor:e.color,onClick:()=>{t(e.key),window.location.hash=`#/${e.hashPrefix}`},children:[(0,o.jsx)(P,{className:"card-emoji",delay:.4*a,children:e.emoji}),(0,o.jsx)(E,{children:e.label[n]}),(0,o.jsx)(M,{children:e.description[n]})]},e.key))})]})});let s=(0,o.jsxs)(R,{children:[(0,o.jsxs)(Y,{onClick:()=>{t(null),window.location.hash="#/school"},children:["←",(0,o.jsxs)("span",{className:"back-label",children:[" ","pt"===n?"Disciplinas":"Subjects"]})]}),e]}),g=p.find(e=>e.key===a);return(0,o.jsx)(l.WO,{hashPrefix:g.hashPrefix,defaultLang:"pt",locale:r,languages:g.languages,welcomeTitle:g.welcomeTitle,welcomeSub:g.welcomeSub,topBarRight:s},a)}}}]);