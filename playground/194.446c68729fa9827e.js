...
`,T=d().main`
  ...
  display: flex;
  flex-direction: column;
`,A=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function S(){return(0,r.jsx)(b,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:A.map((e,o)=>(0,r.jsx)(y,{index:o,accent:e.accent,children:e.char},o))})}let j="atlantis:sidebar-collapsed";function F({sidebar:e,children:o,topBarRight:a,title:l="Atlantis",activeId:d=null}){let[s,p]=(0,i.useState)(()=>{try{return"true"===localStorage.getItem(j)}catch{return!1}}),[g,m]=(0,i.useState)(null),u=(0,i.useRef)(),b=()=>p(e=>{let o=!e;try{localStorage.setItem(j,String(o))}catch{}return o}),y=n().useMemo(()=>n().lazy(()=>Promise.resolve().then(t.bind(t,7330)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(c.I.Provider,{value:{collapsed:s,toggle:b,flyout:g,openFlyout:(e,o,t)=>{clearTimeout(u.current),m({entry:e,anchorY:o,onSelect:t})},scheduleFlyoutClose:()=>{u.current=setTimeout(()=>m(null),160)},cancelFlyoutClose:()=>clearTimeout(u.current)},children:(0,r.jsxs)(z,{children:[(0,r.jsxs)(h,{children:[e&&(0,r.jsx)(f,{children:(0,r.jsx)(x,{onClick:b,title:s?"Expand sidebar":"Collapse sidebar",children:(0,r.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,r.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,r.jsx)("path",{d:"M9 3v18"})]})})}),(0,r.jsx)(S,{}),l&&(0,r.jsx)(w,{children:l}),a&&(0,r.jsx)(v,{children:a})]}),(0,r.jsxs)($,{children:[null!=e&&(0,r.jsx)(M,{collapsed:s,children:(0,r.jsx)(k,{children:e})}),(0,r.jsx)(T,{children:o})]}),g&&(0,r.jsx)(n().Suspense,{fallback:null,children:(0,r.jsx)(y,{activeId:d})})]})})}d().div`
  display: grid;
...
`;function Y({appId:e,onLoad:o}){let[t,a]=(0,i.useState)(!1),[n,l]=(0,i.useState)([]),d=(0,i.useRef)(null),s=(0,i.useCallback)(()=>{(0,B.listDocs)(e).then(l).catch(()=>{})},[e]);(0,i.useEffect)(()=>{if(!t)return;s();let e=e=>{d.current&&!d.current.contains(e.target)&&a(!1)};return document.addEventListener("mousedown",e),()=>document.removeEventListener("mousedown",e)},[t,s]);let c=async(e,o)=>{e.stopPropagation(),await (0,B.deleteDoc)(o),l(e=>e.filter(e=>e.id!==o))};return(0,r.jsxs)(C,{ref:d,children:[(0,r.jsxs)(L,{onClick:()=>a(e=>!e),children:[(0,r.jsx)("svg",{width:14,height:14,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:(0,r.jsx)("path",{d:"M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"})}),"Saved",(0,r.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",style:{marginLeft:2},children:(0,r.jsx)("path",{d:"M6 9l6 6 6-6"})})]}),(0,r.jsxs)(H,{open:t,children:[(0,r.jsx)(R,{children:"Saved versions"}),(0,r.jsx)(E,{children:0===n.length?(0,r.jsx)(P,{children:"No saved documents yet."}):n.map(e=>{var t;return(0,r.jsxs)(V,{children:[(0,r.jsxs)(D,{onClick:()=>{o(e.content,e.id,e.name),a(!1)},children:[(0,r.jsx)(I,{children:e.name}),(0,r.jsx)(N,{children:(t=e.savedAt,new Intl.DateTimeFormat(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}).format(new Date(t)))})]}),(0,r.jsx)(K,{onClick:o=>c(o,e.id),title:"Delete",children:(0,r.jsxs)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,r.jsx)("polyline",{points:"3 6 5 6 21 6"}),(0,r.jsx)("path",{d:"M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6M10 11v6M14 11v6"}),(0,r.jsx)("path",{d:"M9 6V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2"})]})})]},e.id)})})]})]})}d().div`
...
`;l().div`
  ...
  pointer-events: none;
  z-index: 200;
  animation: ${er} 0.16s cubic-bezier(0.4, 0, 0.2, 1) forwards;
...
`,eg=l().div`
  ...
  color: ${d.w4.colors.sidebarTextMuted};
  font-family: ${d.w4.typography.fontFamily};
`;function em({onSave:e,onUpdate:o,onCancel:t,existingDoc:i}){let[n,l]=(0,r.useState)(i?.name??""),d=(0,r.useRef)(null);return(0,r.useEffect)(()=>{d.current?.focus(),i&&d.current?.select()},[i]),(0,a.jsx)(ei,{onClick:t,children:(0,a.jsxs)(en,{onClick:e=>e.stopPropagation(),children:[(0,a.jsx)(el,{children:"Save document"}),i&&o&&(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(eg,{children:"Update the current version or save as a new one."}),(0,a.jsxs)(es,{children:[(0,a.jsx)(ec,{onClick:t,children:"Cancel"}),(0,a.jsxs)(ec,{danger:!0,onClick:o,children:['Update "',i.name,'"']})]}),(0,a.jsx)(ep,{})]}),(0,a.jsx)(ed,{ref:d,value:n,onChange:e=>l(e.target.value),onKeyDown:a=>{"Enter"===a.key&&n.trim()&&(i&&n.trim()===i.name&&o?o():e(n.trim())),"Escape"===a.key&&t()},placeholder:i?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,a.jsxs)(es,{children:[!i&&(0,a.jsx)(ec,{onClick:t,children:"Cancel"}),(0,a.jsx)(ec,{primary:!0,disabled:!n.trim(),onClick:()=>e(n.trim()),children:"Save as new"})]})]})})}let eh=(0,S.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,ef=(0,S.keyframes)`
...
`,l().div`
  position: absolute;
  inset: 0;
  animation: ${eu} 1.4s cubic-bezier(0.4, 0, 0.2, 1) infinite;
