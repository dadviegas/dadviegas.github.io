...
`;function z(e){let a=s.IT[e.category];return`
  ...
  `}function w(){let e=(0,t.useRef)(null),a=(0,t.useRef)(null),o=(0,t.useRef)(null),i=(0,t.useRef)(null),r=(0,t.useRef)(null),l=(0,t.useRef)(new Map),[w,A]=(0,t.useState)(!1),{data:$}=(0,s.so)(5e3),v=(0,s.Ey)(15e3),{trail:k,addPoint:S}=(0,s.wB)(80);return(0,t.useEffect)(()=>{var e;!function(e){if(document.querySelector(`link[href="${e}"]`))return;let a=document.createElement("link");a.rel="stylesheet",a.href=e,document.head.appendChild(a)}("https://unpkg.com/leaflet@1.9.4/dist/leaflet.css"),(e="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js",new Promise((a,o)=>{if(document.querySelector(`script[src="${e}"]`))return void a();let n=document.createElement("script");n.src=e,n.onload=()=>a(),n.onerror=o,document.head.appendChild(n)})).then(()=>A(!0))},[]),(0,t.useEffect)(()=>{if(!w||!e.current||a.current)return;let n=window.L,t=n.map(e.current,{center:[20,0],zoom:2,zoomControl:!0,attributionControl:!1,minZoom:2});n.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{maxZoom:10}).addTo(t);let c=n.circleMarker([20,0],{radius:8,color:s.IT.station,fillColor:s.IT.station,fillOpacity:1,weight:2,pane:"markerPane"}).addTo(t);return c.bindPopup("Loading ISS…",{maxWidth:260,minWidth:200}),c.bindTooltip("\uD83D\uDEF0 ISS \xb7 International Space Station",{direction:"top",offset:[0,-8]}),o.current=c,i.current=n.polyline([],{color:`${s.IT.station}55`,weight:1.5,dashArray:"4 4"}).addTo(t),r.current=n.circle([20,0],{radius:0,color:`${s.IT.station}22`,fillColor:`${s.IT.station}08`,fillOpacity:1,weight:1}).addTo(t),a.current=t,()=>{t.remove(),a.current=null,o.current=null,i.current=null,r.current=null,l.current.clear()}},[w]),(0,t.useEffect)(()=>{if(!$||!a.current)return;let e=[$.latitude,$.longitude];S($.latitude,$.longitude),o.current?.setLatLng(e),o.current?.setPopupContent(z({...$,norad:25544,category:"station",name:"ISS"})),r.current?.setLatLng(e),r.current?.setRadius($.footprint/2*1e3)},[$,S]),(0,t.useEffect)(()=>{i.current?.setLatLngs(k)},[k]),(0,t.useEffect)(()=>{if(!a.current||!window.L)return;let e=window.L,o=a.current,n=l.current;v.forEach(a=>{if(25544===a.norad)return;let t=[a.latitude,a.longitude],i=s.IT[a.category],r=`🛰 ${a.name} \xb7 ${a.altitude.toFixed(0)} km`;if(n.has(a.norad)){let e=n.get(a.norad);e.setLatLng(t),e.setPopupContent(z(a)),e.setTooltipContent(r)}else{let l=e.circleMarker(t,{radius:5,color:i,fillColor:i,fillOpacity:.85,weight:1.5}).addTo(o);l.bindPopup(z(a),{maxWidth:260,minWidth:200}),l.bindTooltip(r,{direction:"top",offset:[0,-6]}),n.set(a.norad,l)}})},[v]),(0,n.jsxs)(d,{children:[(0,n.jsx)(m,{children:(0,n.jsx)(g,{children:(0,n.jsx)("div",{ref:e,style:{height:"100%",width:"100%"}})})}),(0,n.jsxs)(u,{children:[(0,n.jsx)(p,{children:"Legend"}),c.map(({category:e,label:a,examples:o})=>(0,n.jsxs)(f,{children:[(0,n.jsx)(h,{color:s.IT[e]}),a,(0,n.jsxs)(x,{children:["\xb7 ",o]})]},e))]}),(0,n.jsxs)(y,{children:[(0,n.jsx)(b,{live:!!$}),(0,n.jsx)("span",{children:"ISS"}),$&&(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)("span",{children:"\xb7"}),(0,n.jsxs)("span",{children:[$.latitude.toFixed(3),"\xb0, ",$.longitude.toFixed(3),"\xb0"]}),(0,n.jsx)("span",{children:"\xb7"}),(0,n.jsxs)("span",{children:[$.altitude.toFixed(1)," km"]}),(0,n.jsx)("span",{children:"\xb7"}),(0,n.jsxs)("span",{children:[($.velocity/3600).toFixed(2)," km/s"]})]}),(0,n.jsxs)("span",{style:{marginLeft:"auto"},children:[v.length," satellites tracked \xb7 click any marker for details \xa0\xb7\xa0",(0,n.jsx)("a",{href:"https://www.openstreetmap.org/copyright",target:"_blank",rel:"noopener noreferrer",style:{color:"inherit",textDecoration:"underline",opacity:.7},children:"\xa9 OpenStreetMap contributors"})]})]})]})}},6080(e,a,o){o.d(a,{A:()=>F});var n=o(5723);o(7991);var t=o(6859),i=o.n(t),r=o(2799),l=o(2719),s=o(6896),c=o(6720),d=o(6494),m=o(7230),g=o(4558),u=o(140),p=o(9522);let f=(0,r.keyframes)`
  0%, 100% { opacity: 1; }
  50% { opacity: 0.4; }
`,h=i().div`
  display: flex;
...
`;function I(e,a=2){return void 0===e?"—":e.toFixed(a)}function L(e,a,o){return`${Math.abs(e).toFixed(4)}\xb0 ${e>=0?a:o}`}function F(){let{data:e,loading:a}=(0,p.so)(5e3);return(0,n.jsxs)(h,{children:[(0,n.jsxs)(x,{children:[(0,n.jsxs)(y,{children:[(0,n.jsx)(s.A,{size:18,color:"#58a6ff"}),"Space Metrics"]}),(0,n.jsxs)(b,{active:!a&&!!e,children:[(0,n.jsx)(z,{active:!a&&!!e}),a?"Connecting…":e?"Live":"Offline"]})]}),(0,n.jsx)(B,{children:"ISS Telemetry"}),(0,n.jsxs)(w,{children:[(0,n.jsxs)(A,{children:[(0,n.jsx)($,{color:"#58a6ff",children:(0,n.jsx)(c.A,{size:16})}),(0,n.jsx)(v,{children:"Position"}),a?(0,n.jsx)(j,{}):e?(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(k,{children:L(e.latitude,"N","S")}),(0,n.jsx)(S,{children:L(e.longitude,"E","W")})]}):(0,n.jsx)(k,{children:"—"})]}),(0,n.jsxs)(A,{children:[(0,n.jsx)($,{color:"#3fb950",children:(0,n.jsx)(d.A,{size:16})}),(0,n.jsx)(v,{children:"Altitude"}),a?(0,n.jsx)(j,{}):(0,n.jsxs)(n.Fragment,{children:[(0,n.jsxs)(k,{children:[I(e?.altitude)," km"]}),(0,n.jsxs)(S,{children:["~",I(e?.621371*e.altitude:void 0)," mi"]})]})]}),(0,n.jsxs)(A,{children:[(0,n.jsx)($,{color:"#e3b341",children:(0,n.jsx)(m.A,{size:16})}),(0,n.jsx)(v,{children:"Velocity"}),a?(0,n.jsx)(j,{}):(0,n.jsxs)(n.Fragment,{children:[(0,n.jsxs)(k,{children:[I(e?.velocity,0)," km/h"]}),(0,n.jsxs)(S,{children:[I(e?e.velocity/3600:void 0,2)," km/s"]})]})]}),(0,n.jsxs)(A,{children:[(0,n.jsx)($,{color:"#bc8cff",children:(0,n.jsx)(g.A,{size:16})}),(0,n.jsx)(v,{children:"Signal Footprint"}),a?(0,n.jsx)(j,{}):(0,n.jsxs)(n.Fragment,{children:[(0,n.jsxs)(k,{children:[I(e?.footprint,0)," km"]}),(0,n.jsx)(S,{children:"diameter visible from ISS"})]})]}),(0,n.jsxs)(A,{children:[(0,n.jsx)($,{color:"#ff7b72",children:(0,n.jsx)(u.A,{size:16})}),(0,n.jsx)(v,{children:"Sun Visibility"}),a?(0,n.jsx)(j,{}):e?(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(k,{children:(0,n.jsx)(C,{vis:e.visibility,children:e.visibility.charAt(0).toUpperCase()+e.visibility.slice(1)})}),(0,n.jsxs)(S,{children:["Solar lat ",I(e.solar_lat,1),"\xb0 \xb7 lon ",I(e.solar_lon,1),"\xb0"]})]}):(0,n.jsx)(k,{children:"—"})]}),(0,n.jsxs)(A,{children:[(0,n.jsx)($,{color:"#39d353",children:(0,n.jsx)(s.A,{size:16})}),(0,n.jsx)(v,{children:"Orbit Period"}),(0,n.jsx)(k,{children:"92.68 min"}),(0,n.jsx)(S,{children:"15.5 orbits per day"})]})]}),(0,n.jsx)(B,{children:"In Orbit Right Now"}),(0,n.jsxs)(M,{children:[(0,n.jsxs)(T,{children:[(0,n.jsx)(E,{children:"Tracked Objects"}),(0,n.jsx)(P,{children:"~27,000+"})]}),(0,n.jsxs)(T,{children:[(0,n.jsx)(E,{children:"Active Satellites"}),(0,n.jsx)(P,{children:"~9,000+"})]}),(0,n.jsxs)(T,{children:[(0,n.jsx)(E,{children:"ISS Inclination"}),(0,n.jsx)(P,{children:"51.64\xb0"})]}),(0,n.jsxs)(T,{children:[(0,n.jsx)(E,{children:"ISS Mass"}),(0,n.jsx)(P,{children:"~420,000 kg"})]}),(0,n.jsxs)(T,{children:[(0,n.jsx)(E,{children:"ISS Size"}),(0,n.jsx)(P,{children:"109 \xd7 73 m"})]}),(0,n.jsxs)(T,{children:[(0,n.jsx)(E,{children:"LEO Range"}),(0,n.jsx)(P,{children:"160–2,000 km"})]}),(0,n.jsxs)(T,{children:[(0,n.jsx)(E,{children:"Orbital Velocity"}),(0,n.jsx)(P,{children:"~7.66 km/s"})]}),(0,n.jsxs)(T,{children:[(0,n.jsx)(E,{children:"ISS Crew"}),(0,n.jsx)(P,{children:"~7 people"})]})]})]})}},9522(e,a,o){o.d(a,{Ey:()=>g,IT:()=>s,mJ:()=>r,so:()=>i,wB:()=>u});var n=o(7991),t=o(5881);function i(e=5e3){let[a,o]=(0,n.useState)(null),[t,r]=(0,n.useState)(!0),[l,s]=(0,n.useState)(null),c=(0,n.useCallback)(async()=>{try{let e=await fetch("https://api.wheretheiss.at/v1/satellites/25544");if(!e.ok)throw Error(`HTTP ${e.status}`);let a=await e.json();o(a),s(null)}catch(e){s(e instanceof Error?e.message:"Fetch failed")}finally{r(!1)}},[]);return(0,n.useEffect)(()=>{c();let a=setInterval(c,e);return()=>clearInterval(a)},[c,e]),{data:a,loading:t,error:l,refresh:c}}function r(){let[e,a]=(0,n.useState)(null),[o,t]=(0,n.useState)("pending");return(0,n.useEffect)(()=>{navigator.geolocation?navigator.geolocation.getCurrentPosition(e=>{a({lat:e.coords.latitude,lon:e.coords.longitude}),t("granted")},()=>t("denied"),{timeout:8e3}):t("denied")},[]),{location:e,status:o}}let l=[{norad:25544,name:"ISS",category:"station"},{norad:48274,name:"Tiangong",category:"station"},{norad:25994,name:"Terra",category:"observation"},{norad:27424,name:"Aqua",category:"observation"},{norad:49260,name:"Landsat-9",category:"observation"},{norad:43873,name:"GPS III-1",category:"navigation"},{norad:45854,name:"GPS III-4",category:"navigation"},{norad:40534,name:"GPS IIF-10",category:"navigation"},{norad:44713,name:"Starlink-24",category:"communications"},{norad:44914,name:"Starlink-60",category:"communications"},{norad:45178,name:"Starlink-100",category:"communications"},{norad:20580,name:"Hubble",category:"scientific"},{norad:37820,name:"Suomi NPP",category:"scientific"},{norad:41866,name:"GOES-16",category:"weather"},{norad:44914,name:"GOES-18",category:"weather"}],s={station:"#ffd700",observation:"#58a6ff",navigation:"#3fb950",communications:"#e3b341",scientific:"#bc8cff",weather:"#79c0ff"},c=new Map;async function d(e){let a=c.get(e);if(a&&Date.now()-a.fetchedAt<36e5)return{line1:a.line1,line2:a.line2};try{let a=await fetch(`https://tle.ivanstanojevic.me/api/tle/${e}`);if(!a.ok)throw Error(`HTTP ${a.status}`);let o=await a.json();if(!o.line1||!o.line2)throw Error("No TLE lines");return c.set(e,{line1:o.line1,line2:o.line2,fetchedAt:Date.now()}),{line1:o.line1,line2:o.line2}}catch{return null}}function m(e,a,o){try{let n=(0,t.jl)(e,a),i=(0,t.gv)(n,o);if(!i.position||"boolean"==typeof i.position)return null;let r=(0,t.Y0)(o),l=(0,t.$6)(i.position,r);return{latitude:(0,t.Zr)(l.latitude),longitude:(0,t.yy)(l.longitude),altitude:l.height}}catch{return null}}function g(e=5e3){let[a,o]=(0,n.useState)([]),t=(0,n.useCallback)(async()=>{let e=await Promise.allSettled(l.map(async(e,a)=>(await new Promise(e=>setTimeout(e,120*a)),d(e.norad)))),a=new Date,n=[];e.forEach((e,o)=>{if("fulfilled"!==e.status||!e.value)return;let t=l[o],i=m(e.value.line1,e.value.line2,a);i&&n.push({norad:t.norad,name:t.name,category:t.category,...i})}),n.length>0&&o(n)},[]);return(0,n.useEffect)(()=>{t();let e=setInterval(t,36e5);return()=>clearInterval(e)},[t]),(0,n.useEffect)(()=>{let a=setInterval(()=>{let e=new Date,a=[];l.forEach(o=>{let n=c.get(o.norad);if(!n)return;let t=m(n.line1,n.line2,e);t&&a.push({norad:o.norad,name:o.name,category:o.category,...t})}),a.length>0&&o(a)},e);return()=>clearInterval(a)},[e]),a}function u(e=60){let a=(0,n.useRef)([]),[o,t]=(0,n.useState)([]);return{trail:o,addPoint:(0,n.useCallback)((o,n)=>{a.current=[...a.current,[o,n]].slice(-e),t([...a.current])},[e])}}},8859(e,a,o){o.d(a,{FlyoutPanel:()=>b});var n=o(5723),t=o(7991),i=o.n(t),r=o(6859),l=o.n(r),s=o(2799),c=o(255),d=o(1316),m=o(814),g=o(6140);let u=(0,s.keyframes)`
...
`,s().div`
  position: relative;
`;var c=o(2799),d=o(3661),m=o(814);let g="260px",u="56px",p=s().header`
  display: flex;
  align-items: center;
...
`,S=s().main`
  ...
  display: flex;
  flex-direction: column;
`,j=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function M(){return(0,t.jsx)(y,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:j.map((e,a)=>(0,t.jsx)(b,{index:a,accent:e.accent,children:e.char},a))})}let T="atlantis:sidebar-collapsed";function E({sidebar:e,children:a,topBarRight:n,title:l="Atlantis",activeId:s=null}){let[c,g]=(0,i.useState)(()=>{try{return"true"===localStorage.getItem(T)}catch{return!1}}),[u,x]=(0,i.useState)(null),y=(0,i.useRef)(),b=()=>g(e=>{let a=!e;try{localStorage.setItem(T,String(a))}catch{}return a}),j=r().useMemo(()=>r().lazy(()=>Promise.resolve().then(o.bind(o,8859)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,t.jsx)(m.I.Provider,{value:{collapsed:c,toggle:b,flyout:u,openFlyout:(e,a,o)=>{clearTimeout(y.current),x({entry:e,anchorY:a,onSelect:o})},scheduleFlyoutClose:()=>{y.current=setTimeout(()=>x(null),160)},cancelFlyoutClose:()=>clearTimeout(y.current)},children:(0,t.jsxs)($,{children:[(0,t.jsxs)(p,{children:[e&&(0,t.jsx)(f,{children:(0,t.jsx)(h,{onClick:b,title:c?"Expand sidebar":"Collapse sidebar",children:(0,t.jsx)(d.A,{size:17})})}),(0,t.jsx)(M,{}),l&&(0,t.jsx)(z,{children:l}),n&&(0,t.jsx)(w,{children:n})]}),(0,t.jsxs)(A,{children:[null!=e&&(0,t.jsx)(v,{collapsed:c,children:(0,t.jsx)(k,{children:e})}),(0,t.jsx)(S,{children:a})]}),u&&(0,t.jsx)(r().Suspense,{fallback:null,children:(0,t.jsx)(j,{activeId:s})})]})})}var P=o(255),B=o(9753),C=o(6140);let I=s().div`
  display: grid;
...
`;function O({iconKey:e,size:a=16}){if(e&&!(e in C.t))return(0,t.jsx)("span",{style:{fontSize:a,lineHeight:1,display:"flex",alignItems:"center"},children:e});let o=e?C.t[e]??P.A:P.A;return(0,t.jsx)(o,{size:a,strokeWidth:1.75})}function V({entry:e,activeId:a,onSelect:o}){let[n,r]=(0,i.useState)(e.defaultOpen??!0),{collapsed:l,openFlyout:s,scheduleFlyoutClose:c,cancelFlyoutClose:d}=(0,m.c)();return e.children&&e.children.length>0?(0,t.jsxs)(R,{children:[(0,t.jsxs)(D,{collapsed:l,onClick:()=>{l||r(e=>!e)},onMouseEnter:l?a=>{s(e,a.currentTarget.getBoundingClientRect().top,o)}:void 0,onMouseLeave:l?c:void 0,children:[(0,t.jsxs)(G,{collapsed:l,children:[(0,t.jsx)(O,{iconKey:e.icon,size:16}),(0,t.jsx)(N,{collapsed:l,children:e.name})]}),(0,t.jsx)(K,{open:n,collapsed:l,children:(0,t.jsx)(B.A,{size:13})})]}),(0,t.jsx)(I,{open:n&&!l,children:(0,t.jsx)(L,{children:(0,t.jsx)(F,{children:e.children.map(e=>(0,t.jsx)(V,{entry:e,activeId:a,onSelect:o},e.id))})})})]}):(0,t.jsxs)(H,{active:a===e.id,collapsed:l,onClick:()=>o(e),onMouseEnter:l?a=>{let n=a.currentTarget.getBoundingClientRect();s({id:e.id,name:e.name,icon:e.icon,file:e.file,children:[e]},n.top,o)}:void 0,onMouseLeave:l?c:void 0,children:[(0,t.jsx)(O,{iconKey:e.icon,size:15}),(0,t.jsx)(N,{collapsed:l,children:e.name})]})}function _({entries:e,activeId:a,onSelect:o}){return(0,t.jsx)("div",{children:e.map(e=>(0,t.jsx)(V,{entry:e,activeId:a,onSelect:o},e.id))})}let W=(0,c.keyframes)`
  from { opacity: 0; transform: translateY(-50%) translateX(-6px); }
  to   { opacity: 1; transform: translateY(-50%) translateX(0); }
`;function Y({title:e,sections:a,topBarRight:o,children:n}){let[r,l]=(0,i.useState)(null),s=(0,i.useCallback)(e=>{l(e.id),document.getElementById(e.id)?.scrollIntoView({behavior:"smooth",block:"start"})},[]),c=(0,t.jsx)(_,{entries:a,activeId:r,onSelect:s});return(0,t.jsx)(E,{title:e,sidebar:c,activeId:r,topBarRight:o,children:n})}s().div`
  position: absolute;
  left: calc(100% + 10px);
  top: 50%;
  transform: translateY(-50%);
