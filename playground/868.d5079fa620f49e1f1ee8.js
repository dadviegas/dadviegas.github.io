...
`,o(4914);var d=o(1920),m=o(8607),u=o(8479);i.default.button`
  display: flex;
  align-items: center;
  justify-content: center;
  width: 32px;
...
`,S=i.default.div`
  ...
  color: ${a.w4.colors.sidebarTextMuted};
  font-family: ${a.w4.typography.fontFamily};
`;function M({onSave:n,onUpdate:e,onCancel:o,existingDoc:a}){const[i,l]=(0,t.useState)(a?.name??""),s=(0,t.useRef)(null);return(0,t.useEffect)(()=>{s.current?.focus(),a&&s.current?.select()},[a]),(0,r.jsx)(h,{onClick:o,children:(0,r.jsxs)(z,{onClick:n=>n.stopPropagation(),children:[(0,r.jsx)(w,{children:"Save document"}),a&&e&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(S,{children:"Update the current version or save as a new one."}),(0,r.jsxs)(A,{children:[(0,r.jsx)(k,{onClick:o,children:"Cancel"}),(0,r.jsxs)(k,{danger:!0,onClick:e,children:['Update "',a.name,'"']})]}),(0,r.jsx)($,{})]}),(0,r.jsx)(v,{ref:s,value:i,onChange:n=>l(n.target.value),onKeyDown:t=>{"Enter"===t.key&&i.trim()&&(a&&i.trim()===a.name&&e?e():n(i.trim())),"Escape"===t.key&&o()},placeholder:a?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,r.jsxs)(A,{children:[!a&&(0,r.jsx)(k,{onClick:o,children:"Cancel"}),(0,r.jsx)(k,{primary:!0,disabled:!i.trim(),onClick:()=>n(i.trim()),children:"Save as new"})]})]})})}var j=o(8006),T=o(679),B=o(4872);const C=i.default.div`
  position: relative;
`,E=i.default.button`
  display: flex;
  align-items: center;
