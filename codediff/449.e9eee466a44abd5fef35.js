"use strict";(self.webpackChunk_atlantis_codediff=self.webpackChunk_atlantis_codediff||[]).push([[449],{4914(e,a,o){o.d(a,{FlyoutPanel:()=>z});var n=o(7359),t=o(3233),i=o(7207),r=o(255),l=o(217),s=o(5959),c=o(5185),d=o(8104);const m=i.keyframes`
...
`,V=i.default.div`
  ...
  color: ${n.w4.colors.sidebarTextMuted};
  font-family: ${n.w4.typography.fontFamily};
`;function O({onSave:e,onUpdate:a,onCancel:o,existingDoc:n}){const[i,l]=(0,t.useState)(n?.name??""),s=(0,t.useRef)(null);return(0,t.useEffect)(()=>{s.current?.focus(),n&&s.current?.select()},[n]),(0,r.jsx)(_,{onClick:o,children:(0,r.jsxs)(K,{onClick:e=>e.stopPropagation(),children:[(0,r.jsx)(I,{children:"Save document"}),n&&a&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(V,{children:"Update the current version or save as a new one."}),(0,r.jsxs)(G,{children:[(0,r.jsx)(Y,{onClick:o,children:"Cancel"}),(0,r.jsxs)(Y,{danger:!0,onClick:a,children:['Update "',n.name,'"']})]}),(0,r.jsx)(U,{})]}),(0,r.jsx)(H,{ref:s,value:i,onChange:e=>l(e.target.value),onKeyDown:t=>{"Enter"===t.key&&i.trim()&&(n&&i.trim()===n.name&&a?a():e(i.trim())),"Escape"===t.key&&o()},placeholder:n?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,r.jsxs)(G,{children:[!n&&(0,r.jsx)(Y,{onClick:o,children:"Cancel"}),(0,r.jsx)(Y,{primary:!0,disabled:!i.trim(),onClick:()=>e(i.trim()),children:"Save as new"})]})]})})}var J=o(8006),Z=o(679),W=o(4872);const q=i.default.div`
  position: relative;
`,X=i.default.button`
  display: flex;
  align-items: center;
...
`;function se({appId:e,onLoad:a}){const[o,n]=(0,t.useState)(!1),[i,l]=(0,t.useState)([]),s=(0,t.useRef)(null),c=(0,t.useCallback)(()=>{(function(e){return D.listDocs(e)})(e).then(l).catch(()=>{})},[e]);(0,t.useEffect)(()=>{if(!o)return;c();const e=e=>{s.current&&!s.current.contains(e.target)&&n(!1)};return document.addEventListener("mousedown",e),()=>document.removeEventListener("mousedown",e)},[o,c]);return(0,r.jsxs)(q,{ref:s,children:[(0,r.jsxs)(X,{onClick:()=>n(e=>!e),children:[(0,r.jsx)(J.A,{size:14}),"Saved",(0,r.jsx)(Z.A,{size:13,style:{marginLeft:2}})]}),(0,r.jsxs)(Q,{open:o,children:[(0,r.jsx)(ee,{children:"Saved versions"}),(0,r.jsx)(ae,{children:0===i.length?(0,r.jsx)(oe,{children:"No saved documents yet."}):i.map(e=>{return(0,r.jsxs)(ne,{children:[(0,r.jsxs)(te,{onClick:()=>{a(e.content,e.id,e.name),n(!1)},children:[(0,r.jsx)(ie,{children:e.name}),(0,r.jsx)(re,{children:(o=e.savedAt,new Intl.DateTimeFormat(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}).format(new Date(o)))})]}),(0,r.jsx)(le,{onClick:a=>(async(e,a)=>{e.stopPropagation(),await function(e){return D.deleteDoc(e)}(a),l(e=>e.filter(e=>e.id!==a))})(a,e.id),title:"Delete",children:(0,r.jsx)(W.A,{size:13})})]},e.id);var o})})]})]})}i.default.div`
