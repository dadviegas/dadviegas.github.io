"use strict";(self.webpackChunk_atlantis_colorlab=self.webpackChunk_atlantis_colorlab||[]).push([["5512"],{8997(r,e,s){var o=s(2727);e.createRoot=o.createRoot,o.hydrateRoot},3611(r,e,s){var o=s(5723),i=s(7991),l=s(8997),t=s(6859),n=s.n(t),a=s(3930),d=s(1638),c=s(5609),x=s(320),h=s(5628);let p=`
...
`,w=n().div`padding: ${a.w4.spacing.md}; display: flex; flex-direction: column; gap: ${a.w4.spacing.sm};`,j=n().div`font-size: 11px; font-weight: 700; letter-spacing: 0.06em; text-transform: uppercase; color: ${a.w4.colors.mainTextMuted};`,m=n().div`display: flex; align-items: center; gap: ${a.w4.spacing.sm};`,$=n().input`
