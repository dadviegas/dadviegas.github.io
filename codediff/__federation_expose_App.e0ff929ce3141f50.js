"use strict";(self.webpackChunk_atlantis_codediff=self.webpackChunk_atlantis_codediff||[]).push([["6362"],{3935(e,i,r){r.r(i),r.d(i,{default:()=>O});var o=r(5723),n=r(7991),t=r(6859),d=r.n(t),a=r(4174),l=r(1638),s=r(1344),c=r(6480),p=r(679),x=r(2946),g=r(1315),h=r(5151);let f=d().span`
  font-size: 12px;
  padding: 2px 8px;
  border-radius: 10px;
  font-weight: 600;
