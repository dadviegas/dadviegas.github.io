"use strict";(self.webpackChunk_atlantis_csvexplorer=self.webpackChunk_atlantis_csvexplorer||[]).push([[188],{188(e,o,r){var s=r(7359),t=r(8997),n=r(3233),l=r(458),i=r(3317),a=r(3775),d=r(9161),c=r(1344),p=r(679),u=r(4525),x=r(5426),h=r(668),m=r(4490),w=r(9336),f=r(5723);const g=`&::-webkit-scrollbar{width:6px;height:6px}&::-webkit-scrollbar-track{background:transparent}&::-webkit-scrollbar-thumb{background:${l.w4.colors.border};border-radius:3px}scrollbar-width:thin;scrollbar-color:${l.w4.colors.border} transparent;`,b=n.default.div`display:flex;flex:1;overflow:hidden;`,$=n.default.div`
...
//# sourceMappingURL=188.8ee4477722a2593bdacb.js.map