"use strict";(self.webpackChunk_atlantis_pad=self.webpackChunk_atlantis_pad||[]).push([["3499"],{53804(o,e,a){a.d(e,{M:()=>x});var t=a(65723);a(37991);var r=a(36859),i=a.n(r),n=a(51530),l=a(15496),s=a(29336);let d=i().div`
  display: flex;
...
`;function x({value:o,onChange:e,collapsed:a,onToggleCollapse:r,scrollRef:i,onScroll:s}){return a?(0,t.jsx)("div",{style:{position:"relative",flexShrink:0},children:(0,t.jsxs)(f,{onClick:r,title:"Show editor",children:[(0,t.jsx)(n.A,{size:14}),(0,t.jsx)(u,{children:"Editor"})]})}):(0,t.jsxs)(d,{collapsed:!1,children:[(0,t.jsxs)(c,{children:[(0,t.jsx)(p,{children:"Editor"}),(0,t.jsx)(g,{onClick:r,title:"Collapse editor",children:(0,t.jsx)(l.A,{size:15})})]}),(0,t.jsx)(m,{ref:i,value:o,onChange:o=>e(o.target.value),onScroll:s,placeholder:"Write markdown here…",spellCheck:!1})]})}},7279(o,e,a){a.d(e,{H:()=>b});var t=a(65723),r=a(37991),i=a(36859),n=a.n(i),l=a(37901),s=a(70679),d=a(29336);let c=[{id:"showcase",label:"Full Showcase",description:"All supported features in one document",content:`# Markdown Editor — Feature Showcase
...
`,h=n().div`
  position: relative;
`;function b({onSelect:o}){let[e,a]=(0,r.useState)(!1),i=(0,r.useRef)(null);return(0,r.useEffect)(()=>{if(!e)return;let o=o=>{i.current&&!i.current.contains(o.target)&&a(!1)};return document.addEventListener("mousedown",o),()=>document.removeEventListener("mousedown",o)},[e]),(0,t.jsxs)(h,{ref:i,children:[(0,t.jsxs)(p,{onClick:()=>a(o=>!o),children:[(0,t.jsx)(l.A,{size:14}),"Examples",(0,t.jsx)(s.A,{size:13,style:{marginLeft:2}})]}),(0,t.jsxs)(g,{open:e,children:[(0,t.jsx)(m,{children:"Load an example"}),c.map(e=>(0,t.jsxs)(f,{onClick:()=>{o(e.content),a(!1)},children:[(0,t.jsx)(u,{children:e.label}),(0,t.jsx)(x,{children:e.description})]},e.id))]})]})}},56666(o,e,a){a.d(e,{C:()=>x});var t=a(65723),r=a(37991),i=a(36859),n=a.n(i),l=a(37901),s=a(70679),d=a(29336);let c=[{label:"Flowchart",code:`flowchart TD
...
`,u=n().div`
  position: relative;
`;function x({onSelect:o}){let[e,a]=(0,r.useState)(!1),i=(0,r.useRef)(null);return(0,r.useEffect)(()=>{if(!e)return;let o=o=>{i.current&&!i.current.contains(o.target)&&a(!1)};return document.addEventListener("mousedown",o),()=>document.removeEventListener("mousedown",o)},[e]),(0,t.jsxs)(u,{ref:i,children:[(0,t.jsxs)(p,{onClick:()=>a(o=>!o),children:[(0,t.jsx)(l.A,{size:14}),"Examples",(0,t.jsx)(s.A,{size:13,style:{marginLeft:2}})]}),(0,t.jsxs)(g,{open:e,children:[(0,t.jsx)(m,{children:"Load a diagram"}),c.map(e=>(0,t.jsx)(f,{onClick:()=>{o(e.code),a(!1)},children:e.label},e.label))]})]})}},65320(o,e,a){a.d(e,{u:()=>$});var t=a(65723),r=a(37991),i=a(36859),n=a.n(i),l=a(49881),s=a(13045),d=a(52534),c=a(29336),p=a(29738);p.default.initialize({startOnLoad:!1,theme:"dark",securityLevel:"loose"});let g=`
...
`,y=n().span`
  ...
  font-family: ${c.w4.typography.fontFamily};
  writing-mode: vertical-rl;
`;function $({code:o,collapsed:e,onToggleCollapse:a}){let[i,n]=(0,r.useState)(""),[c,g]=(0,r.useState)(null),v=(0,r.useRef)(0),z=(0,r.useCallback)(async o=>{if(!o.trim()){n(""),g(null);return}let e=++v.current;try{let a="mermaid-"+Date.now(),{svg:t}=await p.default.render(a,o);v.current===e&&(n(t),g(null))}catch(o){v.current===e&&(g(o instanceof Error?o.message:String(o)),n(""))}},[]);return((0,r.useEffect)(()=>{let e=setTimeout(()=>z(o),300);return()=>clearTimeout(e)},[o,z]),e)?(0,t.jsxs)(w,{onClick:a,title:"Show preview",children:[(0,t.jsx)(l.A,{size:14}),(0,t.jsx)(y,{children:"Preview"})]}):(0,t.jsxs)(m,{children:[(0,t.jsxs)(f,{children:[(0,t.jsx)(u,{children:"Preview"}),(0,t.jsx)(x,{onClick:a,title:"Collapse preview",children:(0,t.jsx)(s.A,{size:15})})]}),c&&(0,t.jsxs)(b,{children:[(0,t.jsx)(d.A,{size:14,style:{flexShrink:0,marginTop:1}}),c]}),(0,t.jsx)(h,{dangerouslySetInnerHTML:{__html:i}})]})}},2099(o,e,a){a.d(e,{r:()=>k});var t=a(65723);a(37991);var r=a(11352),i=a(76710),n=a(4311),l=a(73639),s=a(8411);a(75406);var d=a(36859),c=a.n(d),p=a(49881),g=a(13045),m=a(29336),f=a(61318);function u(){return o=>{!function o(e){if("blockquote"===e.type){let o=e.children?.[0];if(o?.type==="paragraph"){let a=o.children?.[0];if(a?.type==="text"){let t=a.value?.match(/^\[!(NOTE|TIP|WARNING|CAUTION|IMPORTANT)\]\s*/i);t&&(a.value=a.value.slice(t[0].length),a.value.trim()||1!==o.children.length||e.children.shift(),e.data=e.data??{},e.data.hName="div",e.data.hProperties={"data-callout":t[1].toUpperCase()})}}}e.children?.forEach(o)}(o)}}let x=c().div`
  display: flex;
  flex-direction: column;
  flex: 1;
  min-width: 0;
...
`,z=c().span`
  ...
  font-family: ${m.w4.typography.fontFamily};
  writing-mode: vertical-rl;
`;function k({content:o,collapsed:e,onToggleCollapse:a,scrollRef:d,onScroll:c}){return e?(0,t.jsxs)(v,{onClick:a,title:"Show preview",children:[(0,t.jsx)(p.A,{size:14}),(0,t.jsx)(z,{children:"Preview"})]}):(0,t.jsxs)(x,{children:[(0,t.jsxs)(h,{children:[(0,t.jsx)(b,{children:"Preview"}),(0,t.jsx)(w,{onClick:a,title:"Collapse preview",children:(0,t.jsx)(g.A,{size:15})})]}),(0,t.jsx)(y,{ref:d,onScroll:c,children:(0,t.jsx)($,{children:(0,t.jsx)(r.oz,{remarkPlugins:[i.A,n.A,u],rehypePlugins:[l.A,s.A],components:{div({node:o,children:e,...a}){let r=a["data-callout"];return r?(0,t.jsx)("div",{"data-callout":r,children:e}):(0,t.jsx)("div",{...a,children:e})},pre:({children:o})=>(0,t.jsx)(t.Fragment,{children:o}),code({className:o,children:e}){let a=/language-(\w+)/.exec(o??"")?.[1],r=String(e).replace(/\n$/,"");return"mermaid"===a?(0,t.jsx)(f.t,{code:r}):"chart"===a?(0,t.jsx)(f.MX,{code:r}):"clock"===a?(0,t.jsx)(f.sc,{code:r}):a||r.includes("\n")?(0,t.jsx)(f.NG,{lang:a,code:r}):(0,t.jsx)("code",{className:o,children:e})}},children:o})})})]})}},61318(o,e,a){a.d(e,{MX:()=>k,t:()=>g,sc:()=>P,NG:()=>_});var t=a(65723),r=a(37991),i=a(29336),n=a(36859),l=a.n(n);l().nav`padding: ${i.w4.spacing.sm} 0;`,l().div`
...
`,c=!1;function p(o){if("u"<typeof window)return o;let e=o.match(/^var\((--[-\w]+)\)$/);return e&&getComputedStyle(document.documentElement).getPropertyValue(e[1]).trim()||o}function g({code:o}){let e=(0,r.useRef)(null),[n,l]=(0,r.useState)(null),[m,f]=(0,r.useState)(!1);return((0,r.useEffect)(()=>{let t=!1;if(l(null),f(!1),!o.trim())return void f(!0);let r=o.trim().split(/\r?\n/)[0]?.trim()??"";return/^(?:---[\s\S]*?---\s*)?(?:graph|flowchart|sequenceDiagram|classDiagram|stateDiagram(?:-v2)?|erDiagram|pie|gantt|journey|mindmap|gitGraph|sankey(?:-beta)?|quadrantChart|requirementDiagram|timeline|xychart-beta|block-beta|C4Context|C4Container|C4Component|C4Dynamic|C4Deployment)\b/.test(r)?(async function(){let r=(await Promise.resolve().then(a.bind(a,29738))).default;if(c||(r.initialize({startOnLoad:!1,theme:"dark",themeVariables:{background:p(i.w4.colors.codeBg),primaryColor:p(i.w4.colors.accent),primaryTextColor:p(i.w4.colors.mainText),lineColor:p(i.w4.colors.border)}}),c=!0),e.current&&!t)try{let a=`mermaid-${Math.random().toString(36).slice(2)}`,{svg:i}=await r.render(a,o);if(t||!e.current)return;if(/aria-roledescription="error"|class="error-icon"|>Syntax error/i.test(i))return void f(!0);e.current.innerHTML=i,requestAnimationFrame(()=>{if(t||!e.current)return;let o=e.current.querySelector("svg");if(!o)return void f(!0);let a=o.getBoundingClientRect();(a.width<40||a.height<40)&&f(!0)})}catch(o){t||l(o instanceof Error?o.message:String(o))}}(),()=>{t=!0}):void f(!0)},[o]),n||m)?(0,t.jsx)(d,{children:o.trim()}):(0,t.jsx)(s,{ref:e})}let m=["#388bfd","#3fb950","#d29922","#a371f7","#f87171","#22d3ee","#fb923c","#34d399","#f472b6","#818cf8"],f=l().div`
  background: ${i.w4.colors.codeBg};
  border: 1px solid ${i.w4.colors.codeBorder};
  border-radius: ${i.w4.borderRadius.md};
  padding: ${i.w4.spacing.lg};
...
`,w=l().pre`
  ...
  color: ${i.w4.colors.mainTextMuted};
  white-space: pre-wrap;
`;function y(o){if(o<=0)return 10;let e=Math.pow(10,Math.floor(Math.log10(o)));return Math.ceil(o/e)*e}function $({labels:o,data:e,colors:a}){let r=340,n=176,l=y(Math.max(...e,1)),s=Math.min(40,r/o.length*.6),d=r/o.length,c=Array.from({length:6},(o,e)=>l/5*e);return(0,t.jsxs)("svg",{viewBox:"0 0 400 240",width:"100%",style:{maxWidth:400},children:[c.map((o,e)=>{let a=16+n-o/l*n;return(0,t.jsxs)("g",{children:[(0,t.jsx)("line",{x1:44,y1:a,x2:384,y2:a,stroke:i.w4.colors.border,strokeWidth:.5,strokeDasharray:0===e?"none":"3,3"}),(0,t.jsx)("text",{x:38,y:a+4,fill:i.w4.colors.mainTextMuted,fontSize:10,textAnchor:"end",fontFamily:i.w4.typography.fontFamily,children:Math.round(o)})]},e)}),e.map((e,r)=>{let c=44+d*r+d/2-s/2,p=e/l*n,g=16+n-p,m=a[r%a.length];return(0,t.jsxs)("g",{children:[(0,t.jsxs)("rect",{x:c,y:g,width:s,height:p,rx:3,fill:m,opacity:.85,children:[(0,t.jsx)("animate",{attributeName:"height",from:"0",to:p,dur:"0.5s",fill:"freeze"}),(0,t.jsx)("animate",{attributeName:"y",from:16+n,to:g,dur:"0.5s",fill:"freeze"})]}),(0,t.jsx)("text",{x:c+s/2,y:g-4,fill:i.w4.colors.mainText,fontSize:10,fontWeight:600,textAnchor:"middle",fontFamily:i.w4.typography.fontFamily,children:e}),(0,t.jsx)("text",{x:44+d*r+d/2,y:208,fill:i.w4.colors.mainTextMuted,fontSize:10,textAnchor:"middle",fontFamily:i.w4.typography.fontFamily,children:o[r].length>8?o[r].slice(0,7)+"…":o[r]})]},r)})]})}function v({labels:o,data:e,colors:a}){let r=e.reduce((o,e)=>o+e,0)||1,n=-Math.PI/2,l=e.map((o,e)=>{let l=o/r*Math.PI*2,s=n,d=n+=l,c=120+90*Math.cos(s),p=120+90*Math.sin(s),g=120+90*Math.cos(d),m=120+90*Math.sin(d),f=+(l>Math.PI),u=s+l/2,x=120+58.5*Math.cos(u),h=120+58.5*Math.sin(u),b=Math.round(o/r*100);return(0,t.jsxs)("g",{children:[(0,t.jsx)("path",{d:`M 120 120 L ${c} ${p} A 90 90 0 ${f} 1 ${g} ${m} Z`,fill:a[e%a.length],stroke:i.w4.colors.codeBg,strokeWidth:2,opacity:.85}),b>=5&&(0,t.jsxs)("text",{x:x,y:h+4,fill:"#fff",fontSize:11,fontWeight:600,textAnchor:"middle",fontFamily:i.w4.typography.fontFamily,children:[b,"%"]})]},e)});return(0,t.jsx)("svg",{viewBox:"0 0 240 240",width:"100%",style:{maxWidth:240},children:l})}function z({labels:o,data:e,colors:a}){let r=340,n=176,l=y(Math.max(...e,1)),s=e.length>1?r/(e.length-1):r,d=a[0],c=e.map((o,e)=>({x:44+s*e,y:16+n-o/l*n})),p=c.map((o,e)=>`${0===e?"M":"L"} ${o.x} ${o.y}`).join(" "),g=Array.from({length:6},(o,e)=>l/5*e);return(0,t.jsxs)("svg",{viewBox:"0 0 400 240",width:"100%",style:{maxWidth:400},children:[g.map((o,e)=>{let a=16+n-o/l*n;return(0,t.jsxs)("g",{children:[(0,t.jsx)("line",{x1:44,y1:a,x2:384,y2:a,stroke:i.w4.colors.border,strokeWidth:.5,strokeDasharray:0===e?"none":"3,3"}),(0,t.jsx)("text",{x:38,y:a+4,fill:i.w4.colors.mainTextMuted,fontSize:10,textAnchor:"end",fontFamily:i.w4.typography.fontFamily,children:Math.round(o)})]},e)}),(0,t.jsx)("path",{d:p,fill:"none",stroke:d,strokeWidth:2.5,strokeLinecap:"round",strokeLinejoin:"round"}),c.map((a,r)=>(0,t.jsxs)("g",{children:[(0,t.jsx)("circle",{cx:a.x,cy:a.y,r:4,fill:d,stroke:i.w4.colors.codeBg,strokeWidth:2}),(0,t.jsx)("text",{x:a.x,y:a.y-10,fill:i.w4.colors.mainText,fontSize:10,fontWeight:600,textAnchor:"middle",fontFamily:i.w4.typography.fontFamily,children:e[r]}),(0,t.jsx)("text",{x:a.x,y:208,fill:i.w4.colors.mainTextMuted,fontSize:10,textAnchor:"middle",fontFamily:i.w4.typography.fontFamily,children:o[r].length>8?o[r].slice(0,7)+"…":o[r]})]},r))]})}function k({code:o}){let e=(0,r.useMemo)(()=>(function(o){let e,a,t=o.trim().split("\n"),r="bar",i=[],n=[];for(let o of t){let[t,...l]=o.split(":"),s=l.join(":").trim();if(s)switch(t.trim().toLowerCase()){case"type":["bar","pie","line"].includes(s.toLowerCase())&&(r=s.toLowerCase());break;case"title":e=s;break;case"labels":i=s.replace(/^\[|\]$/g,"").split(",").map(o=>o.trim());break;case"data":n=s.replace(/^\[|\]$/g,"").split(",").map(o=>parseFloat(o.trim())||0);break;case"colors":a=s.replace(/^\[|\]$/g,"").split(",").map(o=>o.trim())}}return i.length&&n.length?{type:r,title:e,labels:i,data:n,colors:a}:null})(o),[o]);if(!e)return(0,t.jsx)(w,{children:o.trim()});let a=e.colors??m;return(0,t.jsxs)(f,{children:[e.title&&(0,t.jsx)(u,{children:e.title}),"bar"===e.type&&(0,t.jsx)($,{labels:e.labels,data:e.data,colors:a}),"pie"===e.type&&(0,t.jsx)(v,{labels:e.labels,data:e.data,colors:a}),"line"===e.type&&(0,t.jsx)(z,{labels:e.labels,data:e.data,colors:a}),(0,t.jsx)(x,{children:e.labels.map((o,e)=>(0,t.jsxs)(h,{children:[(0,t.jsx)(b,{color:a[e%a.length]}),o]},e))})]})}let M=l().div`
  background: ${i.w4.colors.codeBg};
  border: 1px solid ${i.w4.colors.codeBorder};
  border-radius: ${i.w4.borderRadius.md};
  padding: ${i.w4.spacing.lg};
...
`,B=l().div`
  ...
  color: ${i.w4.colors.mainText};
  text-align: center;
`;function C(o){return o.toString().padStart(2,"0")}function R({hours:o,minutes:e,seconds:a}){let r=o=>o*Math.PI/180,n=a/60*360-90,l=e/60*360+a/60*6-90,s=o%12/12*360+e/60*30-90,d=100+61*Math.cos(r(n)),c=100+61*Math.sin(r(n)),p=100+65*Math.cos(r(l)),g=100+65*Math.sin(r(l)),m=100+45*Math.cos(r(s)),f=100+45*Math.sin(r(s));return(0,t.jsxs)("svg",{viewBox:"0 0 200 200",width:200,height:200,children:[(0,t.jsx)("circle",{cx:100,cy:100,r:85,fill:i.w4.colors.surface,stroke:i.w4.colors.border,strokeWidth:2}),Array.from({length:12},(o,e)=>{let a=e+1,n=a/12*360-90,l=100+69*Math.cos(r(n)),s=100+69*Math.sin(r(n));return(0,t.jsx)("text",{x:l,y:s+4,fill:i.w4.colors.mainText,fontSize:14,fontWeight:600,textAnchor:"middle",fontFamily:i.w4.typography.fontFamily,children:a},a)}),Array.from({length:60},(o,e)=>{let a=e/60*360-90,n=e%5==0,l=n?75:79;return(0,t.jsx)("line",{x1:100+l*Math.cos(r(a)),y1:100+l*Math.sin(r(a)),x2:100+83*Math.cos(r(a)),y2:100+83*Math.sin(r(a)),stroke:n?i.w4.colors.mainTextMuted:i.w4.colors.border,strokeWidth:n?2:1},e)}),(0,t.jsx)("line",{x1:100,y1:100,x2:m,y2:f,stroke:i.w4.colors.mainText,strokeWidth:4,strokeLinecap:"round"}),(0,t.jsx)("line",{x1:100,y1:100,x2:p,y2:g,stroke:i.w4.colors.accent,strokeWidth:2.5,strokeLinecap:"round"}),(0,t.jsx)("line",{x1:100-12*Math.cos(r(n)),y1:100-12*Math.sin(r(n)),x2:d,y2:c,stroke:"#f87171",strokeWidth:1.2,strokeLinecap:"round"}),(0,t.jsx)("circle",{cx:100,cy:100,r:4,fill:i.w4.colors.accent}),(0,t.jsx)("circle",{cx:100,cy:100,r:2,fill:"#f87171"})]})}function P({code:o}){let e=function(o){let e="pt";for(let a of o.trim().split("\n")){let[o,...t]=a.split(":"),r=t.join(":").trim();"locale"===o.trim().toLowerCase()&&(e=r.toLowerCase())}return{locale:e}}(o),[a,i]=(0,r.useState)("live"),[n,l]=(0,r.useState)(()=>new Date().getHours()),[s,d]=(0,r.useState)(()=>new Date().getMinutes()),[c,p]=(0,r.useState)(()=>new Date().getSeconds());(0,r.useEffect)(()=>{if("live"!==a)return;let o=()=>{let o=new Date;l(o.getHours()),d(o.getMinutes()),p(o.getSeconds())};o();let e=setInterval(o,1e3);return()=>clearInterval(e)},[a]);let g=(0,r.useCallback)(o=>{i("manual"),p(0),l(e=>((e+o)%24+24)%24)},[]),m=(0,r.useCallback)(o=>{i("manual"),p(0),d(e=>((e+o)%60+60)%60)},[]),f=(0,r.useCallback)(()=>i("live"),[]);return(0,t.jsxs)(M,{children:[(0,t.jsxs)(A,{children:[(0,t.jsx)(R,{hours:n,minutes:s,seconds:c}),(0,t.jsxs)("div",{children:[(0,t.jsxs)(T,{children:[C(n),":",C(s),(0,t.jsxs)("span",{style:{fontSize:"24px",opacity:.5},children:[":",C(c)]})]}),(0,t.jsx)(B,{children:function(o,e,a){if("pt"===a){let a=1===o?"1 hora":`${o} horas`;return 0===e?a:15===e?`${a} e um quarto`:30===e?`${a} e meia`:45===e?`um quarto para as ${12===o?1:o+1}`:`${a} e ${e} minutos`}let t=o<12?"AM":"PM",r=o%12||12;return 0===e?`${r} o'clock ${t}`:15===e?`quarter past ${r} ${t}`:30===e?`half past ${r} ${t}`:45===e?`quarter to ${r%12+1} ${t}`:`${r}:${C(e)} ${t}`}(n%12||12,s,e.locale)})]})]}),(0,t.jsxs)(j,{children:[(0,t.jsx)(S,{onClick:()=>g(-1),children:"−1h"}),(0,t.jsx)(S,{onClick:()=>g(1),children:"+1h"}),(0,t.jsx)(S,{onClick:()=>m(-15),children:"−15m"}),(0,t.jsx)(S,{onClick:()=>m(15),children:"+15m"}),(0,t.jsx)(S,{onClick:()=>m(-5),children:"−5m"}),(0,t.jsx)(S,{onClick:()=>m(5),children:"+5m"}),(0,t.jsx)(S,{active:"live"===a,onClick:f,children:"pt"===e.locale?"Agora":"Now"})]}),(0,t.jsx)(F,{children:"pt"===e.locale?"Usa os bot\xf5es para mudar as horas e os minutos!":"Use the buttons to change the hours and minutes!"}),(0,t.jsx)(j,{children:[{label:"3:00",h:3,m:0},{label:"6:30",h:6,m:30},{label:"9:15",h:9,m:15},{label:"12:00",h:12,m:0},{label:"13:45",h:13,m:45},{label:"15:30",h:15,m:30},{label:"19:00",h:19,m:0},{label:"23:15",h:23,m:15}].map(o=>(0,t.jsx)(S,{onClick:()=>{i("manual"),l(o.h),d(o.m)},children:o.label},o.label))})]})}var E=a(72799);let L=(0,E.keyframes)`
...
`,V={...I.A,'pre[class*="language-"]':{...I.A['pre[class*="language-"]'],background:i.w4.colors.codeBg,margin:0,padding:"18px 20px",fontSize:"13px",lineHeight:"1.6",borderRadius:0},'code[class*="language-"]':{...I.A['code[class*="language-"]'],background:"none",fontSize:"13px"}};function _({lang:o="text",code:e}){let[a,n]=(0,r.useState)(!1);return(0,t.jsxs)(G,{children:[(0,t.jsxs)(Y,{children:[(0,t.jsx)(W,{children:o}),(0,t.jsxs)(O,{copied:a,onClick:()=>{navigator.clipboard.writeText(e).then(()=>{n(!0),setTimeout(()=>n(!1),2e3)})},children:[a?(0,t.jsx)(N.A,{size:12}):(0,t.jsx)(K.A,{size:12}),a?"Copied!":"Copy"]})]}),(0,t.jsx)(D.A,{language:o,style:V,showLineNumbers:e.split("\n").length>8,lineNumberStyle:{color:"#484f58",minWidth:"2.5em",paddingRight:"1.5em",userSelect:"none",fontSize:"12px"},customStyle:{margin:0,background:i.w4.colors.codeBg},wrapLongLines:!1,children:e})]})}l().div`
  background: ${({bg:o})=>o};
...
`,l().span`
  ...
  font-weight: 600;
  margin-left: auto;
`},87330(o,e,a){a.d(e,{FlyoutPanel:()=>oR});var t=a(65723),r=a(37991),i=a.n(r),n=a(36859),l=a.n(n),s=a(72799),d=a(20255),c=a(81316),p=a(40814),g=a(36896),m=a(87902),f=a(53013),u=a(32887),x=a(49510),h=a(39848),b=a(37901),w=a(3045),y=a(43775),$=a(41783),v=a(83539),z=a(39416),k=a(1837),M=a(57167),A=a(84494),T=a(82314),j=a(35751),S=a(69633),F=a(92946),B=a(40822),C=a(36720),R=a(57400),P=a(58456),E=a(43317),L=a(52709),H=a(8006),D=a(89301),I=a(37561),N=a(83517),K=a(28207),G=a(37032),Y=a(6949),W=a(8218),O=a(36829),V=a(59591),_=a(15553),U=a(69923),q=a(72820),J=a(14621),X=a(68479),Z=a(72534),Q=a(66673),oo=a(67490),oe=a(49033),oa=a(99038),ot=a(45775),or=a(31365),oi=a(62937),on=a(9821),ol=a(65912),os=a(80158),od=a(88641),oc=a(48607),op=a(83249),og=a(1821),om=a(15889),of=a(89655),ou=a(27170),ox=a(19161),oh=a(71849),ob=a(41604),ow=a(13142),oy=a(61187),o$=a(77747),ov=a(2932),oz=a(24525),ok=a(57230),oM=a(22164);let oA={activity:g.A,"a-large-small":m.A,apple:f.A,"arrow-right":u.A,"bar-chart-2":x.A,book:h.A,"book-open":b.A,briefcase:w.A,calendar:y.A,clock:$.A,"circle-dot":v.A,cloud:z.A,compass:k.A,cpu:M.A,droplets:A.A,feather:T.A,file:d.A,"file-text":j.A,folder:S.A,"git-branch":F.A,github:B.A,globe:C.A,grid:R.A,hand:P.A,hash:E.A,heart:L.A,key:H.A,hexagon:D.A,home:I.A,landmark:N.A,layers:K.A,"layout-grid":G.A,leaf:Y.A,lightbulb:W.A,list:O.A,map:V.A,"map-pin":_.A,"message-circle":U.A,"message-square":q.A,minus:J.A,monitor:X.A,mountain:Z.A,package:Q.A,palette:oo.A,"pen-tool":oe.A,"pie-chart":oa.A,plane:ot.A,plus:or.A,ruler:oi.A,shirt:on.A,slash:ol.A,square:os.A,star:od.A,sun:oc.A,terminal:op.A,thermometer:og.A,triangle:om.A,trophy:of.A,truck:ou.A,type:ox.A,users:oh.A,"volume-2":ob.A,watch:ow.A,waves:oy.A,wind:o$.A,wrench:ov.A,x:oz.A,zap:ok.A,bot:oM.A},oT=(0,s.keyframes)`
...
`;function oB({iconKey:o}){let e=o?oA[o]??d.A:d.A;return(0,t.jsx)(e,{size:14,strokeWidth:1.75})}function oC({entries:o,activeId:e,onSelect:a}){return(0,t.jsx)(t.Fragment,{children:o.map(o=>o.children?(0,t.jsx)(i().Fragment,{children:(0,t.jsx)(oC,{entries:o.children,activeId:e,onSelect:a})},o.id):(0,t.jsxs)(oF,{active:e===o.id,onClick:()=>a(o),children:[(0,t.jsx)(oB,{iconKey:o.icon}),o.name]},o.id))})}function oR({activeId:o}){let{flyout:e,scheduleFlyoutClose:a,cancelFlyoutClose:r}=(0,p.c)();if(!e)return null;let i=e.entry.icon?oA[e.entry.icon]??d.A:d.A;return(0,t.jsxs)(oj,{anchorY:e.anchorY,onMouseEnter:r,onMouseLeave:a,children:[(0,t.jsxs)(oS,{children:[(0,t.jsx)(i,{size:13,strokeWidth:2}),e.entry.name]}),(0,t.jsx)(oC,{entries:e.entry.children??[],activeId:o,onSelect:o=>{e.onSelect(o),a()}})]})}},40814(o,e,a){a.d(e,{I:()=>r,c:()=>i});var t=a(37991);let r=(0,t.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),i=()=>(0,t.useContext)(r)},29336(o,e,a){a.d(e,{PL:()=>I,MJ:()=>U,mZ:()=>H,KL:()=>L,cL:()=>p.c,Is:()=>D,UO:()=>od,PE:()=>F,w4:()=>t.w4});var t=a(81316),r=a(65723),i=a(37991),n=a.n(i),l=a(36859),s=a.n(l);s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,A=s().main`
  ...
  display: flex;
  flex-direction: column;
`,T=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function j(){return(0,r.jsx)(b,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:T.map((o,e)=>(0,r.jsx)(w,{index:e,accent:o.accent,children:o.char},e))})}let S="atlantis:sidebar-collapsed";function F({sidebar:o,children:e,topBarRight:t,title:l="Atlantis",activeId:s=null}){let[d,g]=(0,i.useState)(()=>{try{return"true"===localStorage.getItem(S)}catch{return!1}}),[m,h]=(0,i.useState)(null),b=(0,i.useRef)(),w=()=>g(o=>{let e=!o;try{localStorage.setItem(S,String(e))}catch{}return e}),T=n().useMemo(()=>n().lazy(()=>Promise.resolve().then(a.bind(a,87330)).then(o=>({default:o.FlyoutPanel}))),[]);return(0,r.jsx)(p.I.Provider,{value:{collapsed:d,toggle:w,flyout:m,openFlyout:(o,e,a)=>{clearTimeout(b.current),h({entry:o,anchorY:e,onSelect:a})},scheduleFlyoutClose:()=>{b.current=setTimeout(()=>h(null),160)},cancelFlyoutClose:()=>clearTimeout(b.current)},children:(0,r.jsxs)(z,{children:[(0,r.jsxs)(f,{children:[o&&(0,r.jsx)(u,{children:(0,r.jsx)(x,{onClick:w,title:d?"Expand sidebar":"Collapse sidebar",children:(0,r.jsx)(c.A,{size:17})})}),(0,r.jsx)(j,{}),l&&(0,r.jsx)(y,{children:l}),t&&(0,r.jsx)($,{children:t})]}),(0,r.jsxs)(v,{children:[null!=o&&(0,r.jsx)(k,{collapsed:d,children:(0,r.jsx)(M,{children:o})}),(0,r.jsx)(A,{children:e})]}),m&&(0,r.jsx)(n().Suspense,{fallback:null,children:(0,r.jsx)(T,{activeId:s})})]})})}s().div`
  display: grid;
  grid-template-rows: ${({open:o})=>o?"1fr":"0fr"};
...
`,_=s().div`
  ...
  color: ${t.w4.colors.sidebarTextMuted};
  font-family: ${t.w4.typography.fontFamily};
`;function U({onSave:o,onUpdate:e,onCancel:a,existingDoc:t}){let[n,l]=(0,i.useState)(t?.name??""),s=(0,i.useRef)(null);return(0,i.useEffect)(()=>{s.current?.focus(),t&&s.current?.select()},[t]),(0,r.jsx)(N,{onClick:a,children:(0,r.jsxs)(K,{onClick:o=>o.stopPropagation(),children:[(0,r.jsx)(G,{children:"Save document"}),t&&e&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(_,{children:"Update the current version or save as a new one."}),(0,r.jsxs)(W,{children:[(0,r.jsx)(O,{onClick:a,children:"Cancel"}),(0,r.jsxs)(O,{danger:!0,onClick:e,children:['Update "',t.name,'"']})]}),(0,r.jsx)(V,{})]}),(0,r.jsx)(Y,{ref:s,value:n,onChange:o=>l(o.target.value),onKeyDown:r=>{"Enter"===r.key&&n.trim()&&(t&&n.trim()===t.name&&e?e():o(n.trim())),"Escape"===r.key&&a()},placeholder:t?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,r.jsxs)(W,{children:[!t&&(0,r.jsx)(O,{onClick:a,children:"Cancel"}),(0,r.jsx)(O,{primary:!0,disabled:!n.trim(),onClick:()=>o(n.trim()),children:"Save as new"})]})]})})}var q=a(18006),J=a(70679),X=a(54872);let Z=s().div`
  position: relative;
`,Q=s().button`
  display: flex;
  align-items: center;
...
`;function od({appId:o,onLoad:e}){let[a,t]=(0,i.useState)(!1),[n,l]=(0,i.useState)([]),s=(0,i.useRef)(null),d=(0,i.useCallback)(()=>{E.listDocs(o).then(l).catch(()=>{})},[o]);(0,i.useEffect)(()=>{if(!a)return;d();let o=o=>{s.current&&!s.current.contains(o.target)&&t(!1)};return document.addEventListener("mousedown",o),()=>document.removeEventListener("mousedown",o)},[a,d]);let c=async(o,e)=>{o.stopPropagation(),await E.deleteDoc(e),l(o=>o.filter(o=>o.id!==e))};return(0,r.jsxs)(Z,{ref:s,children:[(0,r.jsxs)(Q,{onClick:()=>t(o=>!o),children:[(0,r.jsx)(q.A,{size:14}),"Saved",(0,r.jsx)(J.A,{size:13,style:{marginLeft:2}})]}),(0,r.jsxs)(oo,{open:a,children:[(0,r.jsx)(oe,{children:"Saved versions"}),(0,r.jsx)(oa,{children:0===n.length?(0,r.jsx)(ot,{children:"No saved documents yet."}):n.map(o=>{var a;return(0,r.jsxs)(or,{children:[(0,r.jsxs)(oi,{onClick:()=>{e(o.content,o.id,o.name),t(!1)},children:[(0,r.jsx)(on,{children:o.name}),(0,r.jsx)(ol,{children:(a=o.savedAt,new Intl.DateTimeFormat(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}).format(new Date(a)))})]}),(0,r.jsx)(os,{onClick:e=>c(e,o.id),title:"Delete",children:(0,r.jsx)(X.A,{size:13})})]},o.id)})})]})]})}s().div`
...
`;s().div`
  ...
  background: ${t.w4.colors.mainBg};
  font-family: ${t.w4.typography.fontFamily};
  animation: ${oc} 0.4s ease 0.15s both;
`,s().div`
  position: relative;
  width: 56px;
  height: 56px;
...
`,s().div`
  position: absolute;
  inset: 0;
  animation: ${op} 1.4s cubic-bezier(0.4, 0, 0.2, 1) infinite;
...
`;let x={default:l.w4.colors.accent,danger:"#f85149"},h={default:l.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"};n().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`;var b=a(72799);let w=(0,b.keyframes)`
...
`;function D({activeAppId:o}){let{collapsed:e}=(0,l.cL)(),[a]=function(){let[o,e]=(0,r.useState)(k),a=(0,r.useCallback)(o=>{e(o);try{localStorage.setItem($,o)}catch{}(0,l.Is)(v,o).catch(()=>{}),window.dispatchEvent(new CustomEvent("atlantis:locale-change",{detail:o}))},[]);return(0,r.useEffect)(()=>{let o=o=>{e(o.detail)};return window.addEventListener("atlantis:locale-change",o),()=>window.removeEventListener("atlantis:locale-change",o)},[]),(0,r.useEffect)(()=>{(0,l.PL)(v).then(a=>{if(z(a)&&a!==o){try{localStorage.setItem($,a)}catch{}e(a)}}).catch(()=>{})},[]),[o,a]}(),i=(0,r.useMemo)(()=>(o,e)=>{let t=y[o]?.[a]??o;return e?Object.entries(e).reduce((o,[e,a])=>o.replace(RegExp(`\\{${e}\\}`,"g"),String(a)),t):t},[a]),n=(0,r.useRef)(null),s=o=>{n.current!==o&&(n.current=o,document.activeElement?.blur(),window.location.hash=o,setTimeout(()=>{n.current=null},50))};return(0,t.jsxs)(R,{children:[(0,t.jsx)(P,{collapsed:e,children:i("devtools.heading")}),C.map(a=>{let r=i(a.labelKey);return(0,t.jsxs)(E,{active:o===a.id,collapsed:e,onPointerDown:o=>{0===o.button&&s(a.hash)},onClick:()=>s(a.hash),title:r,children:[(0,t.jsx)(L,{children:(0,t.jsx)(A,{name:a.icon,size:16})}),(0,t.jsx)(H,{collapsed:e,children:r})]},a.id)})]})}}}]);