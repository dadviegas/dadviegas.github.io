...
`,A=i.default.div`
  ...
  color: ${e.w.colors.sidebarTextMuted};
  font-family: ${e.w.typography.fontFamily};
`;function v({onSave:n,onUpdate:a,onCancel:o,existingDoc:e}){const[i,l]=(0,t.useState)(e?.name??""),s=(0,t.useRef)(null);return(0,t.useEffect)(()=>{s.current?.focus(),e&&s.current?.select()},[e]),(0,r.jsx)(p,{onClick:o,children:(0,r.jsxs)(y,{onClick:n=>n.stopPropagation(),children:[(0,r.jsx)(z,{children:"Save document"}),e&&a&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(A,{children:"Update the current version or save as a new one."}),(0,r.jsxs)(x,{children:[(0,r.jsx)(h,{onClick:o,children:"Cancel"}),(0,r.jsxs)(h,{danger:!0,onClick:a,children:['Update "',e.name,'"']})]}),(0,r.jsx)(w,{})]}),(0,r.jsx)(b,{ref:s,value:i,onChange:n=>l(n.target.value),onKeyDown:t=>{"Enter"===t.key&&i.trim()&&(e&&i.trim()===e.name&&a?a():n(i.trim())),"Escape"===t.key&&o()},placeholder:e?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,r.jsxs)(x,{children:[!e&&(0,r.jsx)(h,{onClick:o,children:"Cancel"}),(0,r.jsx)(h,{primary:!0,disabled:!i.trim(),onClick:()=>n(i.trim()),children:"Save as new"})]})]})})}var k=o(8006),$=o(679),S=o(4872);const M=i.default.div`
  position: relative;
`,B=i.default.button`
  display: flex;
  align-items: center;
