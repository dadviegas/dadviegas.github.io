"use strict";(self.webpackChunk_atlantis_forma=self.webpackChunk_atlantis_forma||[]).push([["971"],{2810(e,t,o){o.d(t,{N:()=>T});var r=o(5723),a=o(7991),i=o(6859),n=o.n(i),s=o(2799),l=o(4764),d=o(5030),c=o(1496);let p="#7fb77e",g=(0,s.keyframes)`
...
`,M={fast:p,meal:"#58a6ff",weight:"#d29922",walk:"#a371f7"},j={fast:"flame",meal:"utensils",weight:"gauge",walk:"activity"};function z(e){let[t,o,r]=e.split("-").map(e=>parseInt(e,10));return new Date(t,(o??1)-1,r??1).getTime()}function T({data:e,t,locale:o,onEditFast:i,onEditMeal:n,onEditWeight:s,onDeleteFast:l,onDeleteMeal:p,onDeleteWeight:g,onDeleteWalk:F}){let[S,C]=(0,a.useState)("all"),A=(0,a.useMemo)(()=>(function(e,t){let o=[];for(let r of e.sessions){let e=r.endedAt?(r.endedAt-r.startedAt)/36e5:(Date.now()-r.startedAt)/36e5;o.push({kind:"fast",ts:r.startedAt,id:r.id,editable:!0,primary:r.endedAt?`${t("forma.activities.fast.completed")} \xb7 ${e.toFixed(1)}h`:`${t("forma.activities.fast.inProgress")} \xb7 ${e.toFixed(1)}h`,meta:`${r.protocol} \xb7 ${t("forma.activities.fast.target")} ${r.targetHours}h`})}for(let r of e.meals){let e="forma.meal."+r.slot,a=[];r.proteinG&&a.push(`${r.proteinG}g ${t("forma.activities.protein")}`),r.kcal&&a.push(`${r.kcal} kcal`),o.push({kind:"meal",ts:r.createdAt??z(r.date),id:r.id,editable:!0,primary:`${t(e)}${r.notes?` \xb7 ${r.notes}`:""}`,meta:a.length>0?a.join(" \xb7 "):"—"})}for(let r of e.weights)o.push({kind:"weight",ts:z(r.date),id:r.date,editable:!0,primary:`${r.kg.toFixed(1)} kg`,meta:t("forma.activities.weight.entry")});for(let r of e.walks)o.push({kind:"walk",ts:z(r.date),id:r.date,editable:!1,primary:`${r.minutes} min`,meta:t("forma.activities.walk.entry")});return o.sort((e,t)=>t.ts-e.ts),o})(e,t),[e,t]),H=(0,a.useMemo)(()=>"all"===S?A:A.filter(e=>e.kind===S),[A,S]),D=(0,a.useMemo)(()=>{let e={all:A.length,fast:0,meal:0,weight:0,walk:0};for(let t of A)e[t.kind]+=1;return e},[A]),R=(e,o)=>(0,r.jsxs)(d.vu,{variant:S===e?"selected":"default",dotColor:"all"===e?void 0:M[e],onClick:()=>C(e),children:[t(o)," ",D[e]>0&&`(${D[e]})`]},e);return(0,r.jsxs)(f,{children:[(0,r.jsxs)(h,{children:[R("all","forma.activities.filter.all"),R("fast","forma.activities.filter.fast"),R("meal","forma.activities.filter.meal"),R("weight","forma.activities.filter.weight"),R("walk","forma.activities.filter.walk")]}),0===H.length?(0,r.jsx)(c.YG,{mode:"empty",label:t("forma.activities.empty")}):(0,r.jsx)(m,{children:H.map(a=>(0,r.jsxs)(x,{children:[(0,r.jsx)(u,{color:M[a.kind],children:(0,r.jsx)(d.In,{name:j[a.kind],size:14})}),(0,r.jsxs)(w,{children:[(0,r.jsx)(b,{children:a.primary}),(0,r.jsx)(y,{children:a.meta})]}),(0,r.jsx)($,{children:function(e,t,o){let r=new Date(e),a=r.toLocaleDateString("pt"===t?"pt-PT":"en-GB",{day:"2-digit",month:"short"});if(!o)return a;let i=r.toLocaleTimeString("pt"===t?"pt-PT":"en-GB",{hour:"2-digit",minute:"2-digit"});return`${a} ${i}`}(a.ts,o,"fast"===a.kind||"meal"===a.kind)}),(0,r.jsxs)(v,{children:[a.editable&&(0,r.jsx)(k,{onClick:()=>(t=>{if(t.editable){if("fast"===t.kind){let o=e.sessions.find(e=>e.id===t.id);o&&i(o)}else if("meal"===t.kind){let o=e.meals.find(e=>e.id===t.id);o&&n(o)}else if("weight"===t.kind){let o=e.weights.find(e=>e.date===t.id);o&&s(o)}}})(a),title:t("forma.activities.edit"),"aria-label":t("forma.activities.edit"),children:(0,r.jsx)(d.In,{name:"edit",size:14})}),(0,r.jsx)(k,{onClick:()=>{let e;return e="forma.activities.confirmDelete."+a.kind,void(window.confirm(t(e))&&("fast"===a.kind&&l(a.id),"meal"===a.kind&&p(a.id),"weight"===a.kind&&g(a.id),"walk"===a.kind&&F(a.id)))},title:t("forma.activities.delete"),"aria-label":t("forma.activities.delete"),children:(0,r.jsx)(d.In,{name:"trash",size:14})})]})]},`${a.kind}:${a.id}`))})]})}},9624(e,t,o){o.d(t,{Q:()=>E});var r=o(5723),a=o(7991),i=o(6859),n=o.n(i),s=o(2799),l=o(4764),d=o(3650),c=o(1496),p=o(4406);let g="#7fb77e",f="#58a6ff",h="#d29922",m="#7fb77e",x=["Mo","Tu","We","Th","Fr","Sa","Su"],u=["Se","Te","Qa","Qi","Sx","S\xe1","Do"],w=new Set([0,4,8,12,16,20]);function b(e){return[parseInt(e.slice(1,3),16),parseInt(e.slice(3,5),16),parseInt(e.slice(5,7),16)]}let y=b("#1d2230"),$=b(g);function v(e){let t=Math.round(y[0]+($[0]-y[0])*e),o=Math.round(y[1]+($[1]-y[1])*e),r=Math.round(y[2]+($[2]-y[2])*e);return`rgb(${t},${o},${r})`}let k=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,M=n().div`
  background: ${l.w4.colors.surface};
...
`,N=n().div`
  ...
  flex-shrink: 0;
`;function E({data:e,t,locale:o}){let i=new Date().toISOString().slice(0,10),n=(0,a.useMemo)(()=>(function(e){let t={};for(let o of e){if(!o.endedAt)continue;let e=o.startedAt,r=o.endedAt,a=e;for(;a<r;){let e=new Date(a),o=new Date(e.getFullYear(),e.getMonth(),e.getDate(),0,0,0,0).getTime()+864e5,i=Math.min(r,o)-a,n=e.toISOString().slice(0,10);t[n]=(t[n]??0)+i/36e5,a=o}}let o=[];for(let e=89;e>=0;e--){let r=t[function(e){let t=new Date;return t.setDate(t.getDate()-e),t.toISOString().slice(0,10)}(e)]??0,a=0;r>=18?a=4:r>=14?a=3:r>=8?a=2:r>0&&(a=1),o.push(a)}return o})(e.sessions),[e.sessions]),s=(0,a.useMemo)(()=>(0,d.weightTrend)(e.weights,60),[e.weights]),l=(0,a.useMemo)(()=>[...e.weights].sort((e,t)=>t.date.localeCompare(e.date))[0]??null,[e.weights]),b=(0,a.useMemo)(()=>(0,d.proteinByDay)(e.meals,i),[e.meals,i]),y=(0,a.useMemo)(()=>e.goal.proteinG??110,[e.goal.proteinG]),$=(0,a.useMemo)(()=>(function(e){let t=[],o=new Date,r=new Date(o),a=(o.getDay()+6)%7;r.setDate(o.getDate()-a),r.setHours(0,0,0,0);for(let o=5;o>=0;o--){let a=new Date(r);a.setDate(r.getDate()-7*o);let i=new Date(a);i.setDate(a.getDate()+7);let n=a.toISOString().slice(0,10),s=i.toISOString().slice(0,10),l=e.filter(e=>e.date>=n&&e.date<s),d=l.filter(e=>"lunch"===e.slot).reduce((e,t)=>e+(t.proteinG??0),0),c=l.filter(e=>"snack"===e.slot).reduce((e,t)=>e+(t.proteinG??0),0),p=l.filter(e=>"dinner"===e.slot).reduce((e,t)=>e+(t.proteinG??0),0),g=`${String(a.getDate()).padStart(2,"0")}/${String(a.getMonth()+1).padStart(2,"0")}`;t.push({label:g,segments:[{id:"lunch",value:d,color:f},{id:"snack",value:c,color:h},{id:"dinner",value:p,color:m}]})}return t})(e.meals),[e.meals]),k=(0,a.useMemo)(()=>(0,d.dayHourFastMatrix)(e.sessions),[e.sessions]),B=(0,a.useMemo)(()=>{let e=0;for(let t of k)for(let o of t)o>e&&(e=o);return e},[k]),O="pt"===o?u:x,Y=e.weights.length>=2,K=e.meals.length>0,G=e.sessions.some(e=>void 0!==e.endedAt),V=[{id:"fast-heatmap",defaultSize:"lg",render:()=>(0,r.jsxs)(M,{children:[(0,r.jsxs)(j,{children:["◉ ",t("forma.analytics.heatmap.title")]}),G?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(c.RT,{data:n,cellSize:11,gap:2,locale:o}),(0,r.jsxs)(W,{children:[(0,r.jsxs)(I,{children:[(0,r.jsx)(N,{color:v(0)}),(0,r.jsx)("span",{children:t("forma.analytics.heatmap.none")})]}),(0,r.jsxs)(I,{children:[(0,r.jsx)(N,{color:v(.25)}),(0,r.jsx)("span",{children:"<8h"})]}),(0,r.jsxs)(I,{children:[(0,r.jsx)(N,{color:v(.5)}),(0,r.jsx)("span",{children:"8–14h"})]}),(0,r.jsxs)(I,{children:[(0,r.jsx)(N,{color:v(.75)}),(0,r.jsx)("span",{children:"14–18h"})]}),(0,r.jsxs)(I,{children:[(0,r.jsx)(N,{color:v(1)}),(0,r.jsx)("span",{children:"≥18h"})]})]})]}):(0,r.jsx)(c.YG,{mode:"empty",label:t("forma.analytics.empty")})]})},{id:"weight-trend",defaultSize:"md",render:()=>(0,r.jsxs)(M,{children:[(0,r.jsxs)(j,{children:["◉ ",t("forma.analytics.weight.title")]}),Y?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(S,{children:[(0,r.jsx)(z,{children:l?l.kg.toFixed(1):"—"}),(0,r.jsx)(F,{children:"kg"}),0!==s.delta&&(0,r.jsxs)(C,{positive:s.delta>0,children:[s.delta>0?"+":"",s.delta.toFixed(1)," kg"]})]}),void 0!==e.goal.weightKg&&(0,r.jsxs)(S,{children:[(0,r.jsx)(T,{children:e.goal.weightKg.toFixed(1)}),(0,r.jsxs)(F,{children:["kg ",t("forma.weight.target")]})]}),(0,r.jsx)(F,{children:t("forma.analytics.weight.delta")}),(0,r.jsx)(c.OW,{points:s.ema.length>=2?s.ema:e.weights.map(e=>e.kg),accent:g,width:260,height:60})]}):(0,r.jsx)(c.YG,{mode:"empty",label:t("forma.analytics.empty")})]})},{id:"protein-burn",defaultSize:"md",render:()=>(0,r.jsxs)(M,{children:[(0,r.jsxs)(j,{children:["◉ ",t("forma.analytics.protein.title")]}),(0,r.jsxs)(S,{children:[(0,r.jsx)(z,{children:b.toFixed(0)}),(0,r.jsxs)(F,{children:["/ ",y,"g ",t("forma.analytics.protein.target")]})]}),K?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(c.kl,{spent:y-b,budget:y,height:60}),(0,r.jsx)(F,{children:b>=y?t("forma.analytics.protein.achieved"):`${(y-b).toFixed(0)}g ${t("forma.analytics.protein.remaining")}`})]}):(0,r.jsx)(c.YG,{mode:"empty",label:t("forma.analytics.empty")})]})},{id:"weekly-protein",defaultSize:"lg",render:()=>(0,r.jsxs)(M,{children:[(0,r.jsxs)(j,{children:["◉ ",t("forma.analytics.weekly.title")]}),K?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(c.ik,{data:$,budget:7*y,height:160}),(0,r.jsxs)(W,{children:[(0,r.jsxs)(I,{children:[(0,r.jsx)(N,{color:f}),(0,r.jsx)("span",{children:t("forma.meal.lunch")})]}),(0,r.jsxs)(I,{children:[(0,r.jsx)(N,{color:h}),(0,r.jsx)("span",{children:t("forma.meal.snack")})]}),(0,r.jsxs)(I,{children:[(0,r.jsx)(N,{color:m}),(0,r.jsx)("span",{children:t("forma.meal.dinner")})]})]})]}):(0,r.jsx)(c.YG,{mode:"empty",label:t("forma.analytics.empty")})]})},{id:"fast-times",defaultSize:"lg",render:()=>(0,r.jsxs)(M,{children:[(0,r.jsxs)(j,{children:["◉ ",t("forma.analytics.fastTimes.title")]}),G?(0,r.jsxs)(A,{children:[(0,r.jsxs)(H,{children:[(0,r.jsx)("div",{}),Array.from({length:24},(e,t)=>(0,r.jsx)(D,{children:w.has(t)?String(t).padStart(2,"0"):""},t))]}),k.map((e,t)=>(0,r.jsxs)(R,{children:[(0,r.jsx)(L,{children:O[t]}),e.map((e,o)=>(0,r.jsx)(P,{bg:0===B?v(0):v(e/B),title:e>0?`${O[t]} ${String(o).padStart(2,"0")}:00 — ${e}\xd7`:void 0},o))]},t))]}):(0,r.jsx)(c.YG,{mode:"empty",label:t("forma.analytics.empty")})]})}];return(0,r.jsx)(p.C,{t:t,cards:V,storageKey:"forma:layout:analytics"})}},7103(e,t,o){o.d(t,{j:()=>m});var r=o(5723),a=o(7991),i=o(6859),n=o.n(i),s=o(4764),l=o(5030),d=o(3650);let c=n().section`
...
`,M=n().span`
  ...
  text-transform: uppercase;
  letter-spacing: 0.16em;
`;function j({data:e,t,onStart:o,onStop:i,onEditStart:n}){let z,T,F,S,C,[A,H]=(0,a.useState)(Date.now),D=e.sessions.some(e=>void 0===e.endedAt);(0,a.useEffect)(()=>{if(!D)return;let e=setInterval(()=>H(Date.now()),1e3);return()=>clearInterval(e)},[D]);let R=(0,d.currentFast)(e,A),L=R?.percent??0,P=null!==R,W=R?R.hoursElapsed:0,I=R?R.remainingMs:0,N=R?R.session.targetHours:e.goal.targetHours;return(0,r.jsxs)(g,{children:[(0,r.jsxs)(f,{children:[(0,r.jsxs)(h,{width:200,height:200,viewBox:"0 0 200 200","aria-hidden":"true",children:[(0,r.jsx)("circle",{cx:100,cy:100,r:95,fill:"none",stroke:s.w4.colors.border,strokeWidth:10}),(0,r.jsx)("circle",{cx:100,cy:100,r:95,fill:"none",stroke:c,strokeWidth:10,strokeLinecap:"round",strokeDasharray:p,strokeDashoffset:p*(1-L),style:{transition:"stroke-dashoffset 0.6s ease"}})]}),(0,r.jsx)(m,{children:P?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(x,{children:[W.toFixed(1),"h"]}),(0,r.jsx)(u,{children:t("forma.timer.elapsed")})]}):(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(x,{children:[N,"h"]}),(0,r.jsx)(u,{children:t("forma.hero.notFasting")})]})})]}),P&&R&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(y,{children:[(0,r.jsx)(w,{children:R.session.protocol}),n&&(0,r.jsx)($,{type:"button",onClick:()=>n(R.session),title:t("forma.timer.editStart"),children:t("forma.timer.startedAt",{time:(T=String((z=new Date(R.session.startedAt)).getHours()).padStart(2,"0"),F=String(z.getMinutes()).padStart(2,"0"),`${T}:${F}`)})})]}),(0,r.jsxs)(b,{children:[(0,r.jsxs)(v,{children:[(0,r.jsx)(k,{children:(C=Math.floor((S=Math.floor(I/6e4))/60),`${String(C).padStart(2,"0")}:${String(S%60).padStart(2,"0")}`)}),(0,r.jsx)(M,{children:t("forma.timer.remaining")})]}),(0,r.jsxs)(v,{children:[(0,r.jsxs)(k,{children:[Math.round(100*L),"%"]}),(0,r.jsx)(M,{children:t("forma.timer.complete")})]})]})]}),P&&R?(0,r.jsx)(l.$n,{variant:"danger",onClick:()=>i(R.session),children:t("forma.stop")}):(0,r.jsx)(l.$n,{variant:"success",onClick:o,children:t("forma.start")})]})}},4406(e,t,o){o.d(t,{C:()=>x});var r=o(5723),a=o(7991),i=o(6859),n=o.n(i),s=o(4764),l=o(5030);let d="#7fb77e",c=n().div`
  display: grid;
...
`;function x({cards:e,t,storageKey:o="forma:layout"}){let[i,n]=(0,a.useState)(null);(0,a.useEffect)(()=>{let t=!1;return(async()=>{let r=await (0,s.PL)(o),a=null;if(r)try{a=JSON.parse(r)}catch{a=null}t||n(function(e,t){let o=new Set(t.map(e=>e.id)),r=new Set,a=[];if(e)for(let t of e)o.has(t.id)&&(a.push(t),r.add(t.id));for(let e of t)r.has(e.id)||a.push({id:e.id,size:e.defaultSize??"sm",hidden:!1});return a}(a,e))})(),()=>{t=!0}},[o,e.map(e=>e.id).join("|")]);let d=(0,a.useCallback)(e=>{n(e),(0,s.Is)(o,JSON.stringify(e))},[o]),u=(0,a.useCallback)((e,t)=>{if(!i)return;let o=i.filter(e=>!e.hidden),r=o.findIndex(t=>t.id===e);if(-1===r)return;let a=r+t;if(a<0||a>=o.length)return;let n=o[a],s=i.findIndex(t=>t.id===e),l=i.findIndex(e=>e.id===n.id),c=[...i];[c[s],c[l]]=[c[l],c[s]],d(c)},[i,d]),w=(0,a.useCallback)(e=>{i&&d(i.map(t=>{var o;return t.id===e?{...t,size:"sm"===(o=t.size)?"md":"md"===o?"lg":"sm"}:t}))},[i,d]),b=(0,a.useCallback)(e=>{i&&d(i.map(t=>t.id===e?{...t,hidden:!0}:t))},[i,d]),y=(0,a.useCallback)(e=>{i&&d(i.map(t=>t.id===e?{...t,hidden:!1}:t))},[i,d]),$=(0,a.useMemo)(()=>{let t=new Map;for(let o of e)t.set(o.id,o);return t},[e]);if(!i)return(0,r.jsx)(c,{});let v=i.filter(e=>!e.hidden),k=i.filter(e=>e.hidden);return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(c,{children:v.map((e,o)=>{let a=$.get(e.id);return a?(0,r.jsxs)(p,{size:e.size,children:[a.render(),(0,r.jsxs)(g,{className:"forma-grid-controls",children:[(0,r.jsx)(f,{onClick:()=>u(e.id,-1),disabled:0===o,title:t("forma.grid.moveLeft"),"aria-label":t("forma.grid.moveLeft"),children:(0,r.jsx)(l.In,{name:"chevron-left",size:14})}),(0,r.jsx)(f,{onClick:()=>u(e.id,1),disabled:o===v.length-1,title:t("forma.grid.moveRight"),"aria-label":t("forma.grid.moveRight"),children:(0,r.jsx)(l.In,{name:"chevron-right",size:14})}),(0,r.jsx)(f,{onClick:()=>w(e.id),title:t("forma.grid.resize",{size:e.size.toUpperCase()}),"aria-label":t("forma.grid.resize",{size:e.size.toUpperCase()}),children:(0,r.jsx)(l.In,{name:"grid",size:14})}),(0,r.jsx)(f,{onClick:()=>b(e.id),title:t("forma.grid.hide"),"aria-label":t("forma.grid.hide"),children:(0,r.jsx)(l.In,{name:"close",size:14})})]})]},e.id):null})}),k.length>0&&(0,r.jsxs)(h,{children:[(0,r.jsx)("span",{style:{fontSize:11,fontFamily:s.w4.typography.fontFamilyMono,color:s.w4.colors.mainTextMuted,textTransform:"uppercase",letterSpacing:"0.16em",alignSelf:"center",marginRight:8},children:t("forma.grid.hiddenLabel")}),k.map(e=>(0,r.jsxs)(m,{onClick:()=>y(e.id),children:["+ ",t(`forma.grid.card.${e.id}`)]},e.id))]})]})}},9276(e,t,o){o.d(t,{Y:()=>C});var r=o(5723),a=o(7991),i=o(6859),n=o.n(i),s=o(4764),l=o(5030),d=o(2799);let c=(0,d.keyframes)`
...
`,S=i().forwardRef(function({variant:e="default",dotColor:t,children:o,onClick:a,...i},n){return(0,r.jsxs)(T,{ref:n,variant:e,clickable:!!a,onClick:a,type:i.type??"button",...i,children:[t&&(0,r.jsx)(F,{color:t}),o]})}),C={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:l.w4.colors.accentMuted},A={neutral:l.w4.colors.mainTextMuted,live:l.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:l.w4.colors.accent},H=s().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${l.w4.typography.fontFamilyMono};
...
`,D=s().span`
  ...
  display: inline-block;
`;function R({tone:e="neutral",dot:t,children:o,...a}){return(0,r.jsxs)(H,{tone:e,...a,children:[(t??"live"===e)&&(0,r.jsx)(D,{}),o]})}s().kbd`
  font-family: ${l.w4.typography.fontFamilyMono};
  font-size: 10px;
  padding: 2px 6px;
  border: 1px solid ${l.w4.colors.border};
...
`;let L=s().div`
  ...
  align-items: center;
  gap: 8px;
`;function P({children:e,...t}){return(0,r.jsx)(L,{...t,children:e})}s().label`
  display: flex;
  align-items: center;
  gap: 10px;
...
`;function Y({title:e,accessory:t,accentColor:o,error:a,errorLabel:i,children:n}){return(0,r.jsxs)(W,{accentColor:o,"data-widget-shell":!0,children:[(0,r.jsxs)(I,{children:[(0,r.jsx)(P,{children:e}),t&&(0,r.jsx)(N,{children:t})]}),a?(0,r.jsxs)(B,{role:"alert",children:[(0,r.jsx)(O,{children:i??"Error"}),(0,r.jsx)("div",{children:a})]}):(0,r.jsx)(E,{children:n})]})}s().div`
  position: relative;
  display: flex;
  flex-direction: column;
  height: 100%;
