"use strict";(self.webpackChunk_atlantis_pad=self.webpackChunk_atlantis_pad||[]).push([[853],{74914(e,o,a){a.d(o,{FlyoutPanel:()=>x});var n=a(27359),t=a(53233),r=a(77207),i=a(20255),l=a(217),s=a(15959),d=a(65185),c=a(65723);const m=r.keyframes`
...
`;function f({iconKey:e}){const o=e?d.t[e]??i.A:i.A;return(0,c.jsx)(o,{size:14,strokeWidth:1.75})}function b({entries:e,activeId:o,onSelect:a}){return(0,c.jsx)(c.Fragment,{children:e.map(e=>e.children?(0,c.jsx)(n.Fragment,{children:(0,c.jsx)(b,{entries:e.children,activeId:o,onSelect:a})},e.id):(0,c.jsxs)(p,{active:o===e.id,onClick:()=>a(e),children:[(0,c.jsx)(f,{iconKey:e.icon}),e.name]},e.id))})}function x({activeId:e}){const{flyout:o,scheduleFlyoutClose:a,cancelFlyoutClose:n}=(0,s.c)();if(!o)return null;const t=o.entry.icon?d.t[o.entry.icon]??i.A:i.A;return(0,c.jsxs)(g,{anchorY:o.anchorY,onMouseEnter:n,onMouseLeave:a,children:[(0,c.jsxs)(u,{children:[(0,c.jsx)(t,{size:13,strokeWidth:2}),o.entry.name]}),(0,c.jsx)(b,{entries:o.entry.children??[],activeId:e,onSelect:e=>{o.onSelect(e),a()}})]})}},15959(e,o,a){a.d(o,{c:()=>r});var n=a(27359);const t=(0,n.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),r=()=>(0,n.useContext)(t)},65185(e,o,a){a.d(o,{t:()=>U});var n=a(49510),t=a(99038),r=a(28207),i=a(36896),l=a(37901),s=a(39848),d=a(22164),c=a(43775),m=a(83539),g=a(41783),u=a(1837),p=a(82314),f=a(35751),b=a(20255),x=a(69633),y=a(92946),h=a(40822),w=a(36720),z=a(43317),$=a(52709),v=a(83517),A=a(37032),k=a(6949),S=a(8218),j=a(36829),T=a(15553),M=a(59591),B=a(72820),C=a(14621),E=a(66673),P=a(49033),R=a(31365),D=a(65912),L=a(88641),F=a(83249),N=a(1821),I=a(19161),H=a(71849),K=a(77747),G=a(2932),O=a(24525),Y=a(57230);const U={activity:i.A,"bar-chart-2":n.A,book:s.A,"book-open":l.A,calendar:c.A,clock:g.A,"circle-dot":m.A,feather:p.A,"file-text":f.A,globe:w.A,hash:z.A,heart:$.A,landmark:v.A,layers:r.A,leaf:k.A,map:M.A,package:E.A,compass:u.A,"git-branch":y.A,github:h.A,minus:C.A,terminal:F.A,thermometer:N.A,users:H.A,wind:K.A,"pie-chart":t.A,plus:R.A,slash:D.A,star:L.A,zap:Y.A,bot:d.A,lightbulb:S.A,"message-square":B.A,wrench:G.A,x:O.A,"layout-grid":A.A,list:j.A,file:b.A,folder:x.A,"map-pin":T.A,"pen-tool":P.A,type:I.A}},85723(e,o,a){a.d(o,{UO:()=>Y,MJ:()=>M,KL:()=>h,w4:()=>n.w4,mZ:()=>w});var n=a(217),t=a(27359),r=a(53233),i=a(65723);r.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,T=r.default.div`
  ...
  color: ${n.w4.colors.sidebarTextMuted};
  font-family: ${n.w4.typography.fontFamily};
`;function M({onSave:e,onUpdate:o,onCancel:a,existingDoc:n}){const[r,l]=(0,t.useState)(n?.name??""),s=(0,t.useRef)(null);return(0,t.useEffect)(()=>{s.current?.focus(),n&&s.current?.select()},[n]),(0,i.jsx)(z,{onClick:a,children:(0,i.jsxs)($,{onClick:e=>e.stopPropagation(),children:[(0,i.jsx)(v,{children:"Save document"}),n&&o&&(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(T,{children:"Update the current version or save as a new one."}),(0,i.jsxs)(k,{children:[(0,i.jsx)(S,{onClick:a,children:"Cancel"}),(0,i.jsxs)(S,{danger:!0,onClick:o,children:['Update "',n.name,'"']})]}),(0,i.jsx)(j,{})]}),(0,i.jsx)(A,{ref:s,value:r,onChange:e=>l(e.target.value),onKeyDown:t=>{"Enter"===t.key&&r.trim()&&(n&&r.trim()===n.name&&o?o():e(r.trim())),"Escape"===t.key&&a()},placeholder:n?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,i.jsxs)(k,{children:[!n&&(0,i.jsx)(S,{onClick:a,children:"Cancel"}),(0,i.jsx)(S,{primary:!0,disabled:!r.trim(),onClick:()=>e(r.trim()),children:"Save as new"})]})]})})}var B=a(18006),C=a(70679),E=a(54872);const P=r.default.div`
  position: relative;
`,R=r.default.button`
  display: flex;
  align-items: center;
...
`;function Y({appId:e,onLoad:o}){const[a,n]=(0,t.useState)(!1),[r,l]=(0,t.useState)([]),s=(0,t.useRef)(null),d=(0,t.useCallback)(()=>{(function(e){return y.listDocs(e)})(e).then(l).catch(()=>{})},[e]);(0,t.useEffect)(()=>{if(!a)return;d();const e=e=>{s.current&&!s.current.contains(e.target)&&n(!1)};return document.addEventListener("mousedown",e),()=>document.removeEventListener("mousedown",e)},[a,d]);return(0,i.jsxs)(P,{ref:s,children:[(0,i.jsxs)(R,{onClick:()=>n(e=>!e),children:[(0,i.jsx)(B.A,{size:14}),"Saved",(0,i.jsx)(C.A,{size:13,style:{marginLeft:2}})]}),(0,i.jsxs)(D,{open:a,children:[(0,i.jsx)(L,{children:"Saved versions"}),(0,i.jsx)(F,{children:0===r.length?(0,i.jsx)(N,{children:"No saved documents yet."}):r.map(e=>{return(0,i.jsxs)(I,{children:[(0,i.jsxs)(H,{onClick:()=>{o(e.content,e.id,e.name),n(!1)},children:[(0,i.jsx)(K,{children:e.name}),(0,i.jsx)(G,{children:(a=e.savedAt,new Intl.DateTimeFormat(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}).format(new Date(a)))})]}),(0,i.jsx)(O,{onClick:o=>(async(e,o)=>{e.stopPropagation(),await function(e){return y.deleteDoc(e)}(o),l(e=>e.filter(e=>e.id!==o))})(o,e.id),title:"Delete",children:(0,i.jsx)(E.A,{size:13})})]},e.id);var a})})]})]})}r.default.div`
...
`,b=t.default.div`
  position: relative;
`;function x({onSelect:e}){const[o,a]=(0,n.useState)(!1),t=(0,n.useRef)(null);return(0,n.useEffect)(()=>{if(!o)return;const e=e=>{t.current&&!t.current.contains(e.target)&&a(!1)};return document.addEventListener("mousedown",e),()=>document.removeEventListener("mousedown",e)},[o]),(0,d.jsxs)(b,{ref:t,children:[(0,d.jsxs)(c,{onClick:()=>a(e=>!e),children:[(0,d.jsx)(r.A,{size:14}),"Examples",(0,d.jsx)(i.A,{size:13,style:{marginLeft:2}})]}),(0,d.jsxs)(m,{open:o,children:[(0,d.jsx)(g,{children:"Load an example"}),s.S.map(o=>(0,d.jsxs)(u,{onClick:()=>{e(o.content),a(!1)},children:[(0,d.jsx)(p,{children:o.label}),(0,d.jsx)(f,{children:o.description})]},o.id))]})]})}},27665(e,o,a){a.d(o,{C:()=>f});var n=a(27359),t=a(53233),r=a(37901),i=a(70679),l=a(85723),s=a(35339),d=a(65723);const c=t.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  padding: 5px 12px;
...
`,h=t.default.span`
  ...
  font-family: ${s.w4.typography.fontFamily};
  writing-mode: vertical-rl;
`;function w({code:e,collapsed:o,onToggleCollapse:a}){const[t,s]=(0,n.useState)(""),[m,w]=(0,n.useState)(null),z=(0,n.useRef)(0),$=(0,n.useCallback)(async e=>{if(!e.trim())return s(""),void w(null);const o=++z.current;try{const a="mermaid-"+Date.now(),{svg:n}=await d.default.render(a,e);z.current===o&&(s(n),w(null))}catch(e){z.current===o&&(w(e instanceof Error?e.message:String(e)),s(""))}},[]);return(0,n.useEffect)(()=>{const o=setTimeout(()=>$(e),300);return()=>clearTimeout(o)},[e,$]),o?(0,c.jsxs)(y,{onClick:a,title:"Show preview",children:[(0,c.jsx)(l.A,{size:14}),(0,c.jsx)(h,{children:"Preview"})]}):(0,c.jsxs)(g,{children:[(0,c.jsxs)(u,{children:[(0,c.jsx)(p,{children:"Preview"}),(0,c.jsx)(f,{onClick:a,title:"Collapse preview",children:(0,c.jsx)(i.A,{size:15})})]}),m&&(0,c.jsxs)(x,{children:[(0,c.jsx)(r.A,{size:14,style:{flexShrink:0,marginTop:1}}),m]}),(0,c.jsx)(b,{dangerouslySetInnerHTML:{__html:t}})]})}},89654(e,o,a){a.d(o,{r:()=>F});var n=a(27359),t=a(28976),r=a(18055),i=a(14944),l=a(39895),s=a(6930),d=(a(61385),a(53233)),c=a(49881),m=a(13045),g=a(85723),u=a(65723);const p=d.default.div`
...
`;let b=!1;function x({code:e}){const o=(0,n.useRef)(null),[t,r]=(0,n.useState)(null);return(0,n.useEffect)(()=>{let n=!1;return r(null),async function(){const t=(await Promise.resolve().then(a.bind(a,30774))).default;if(b||(t.initialize({startOnLoad:!1,theme:"dark",themeVariables:{background:g.w4.colors.codeBg,primaryColor:g.w4.colors.accent,primaryTextColor:g.w4.colors.mainText,lineColor:g.w4.colors.border}}),b=!0),o.current&&!n)try{const a=`mermaid-${Math.random().toString(36).slice(2)}`,{svg:r}=await t.render(a,e);!n&&o.current&&(o.current.innerHTML=r)}catch(e){n||r(e instanceof Error?e.message:String(e))}}(),()=>{n=!0}},[e]),t?(0,u.jsx)(p,{children:(0,u.jsxs)(f,{children:["Mermaid error: ",t]})}):(0,u.jsx)(p,{ref:o})}var y=a(68383),h=a(21426),w=a(25609),z=a(20320);const $=d.default.div`
  margin: ${g.w4.spacing.lg} 0;
  border-radius: ${g.w4.borderRadius.md};
  border: 1px solid ${g.w4.colors.codeBorder};
  overflow: hidden;
...
`,S={...h.A,'pre[class*="language-"]':{...h.A['pre[class*="language-"]'],background:g.w4.colors.codeBg,margin:0,padding:"18px 20px",fontSize:"13px",lineHeight:"1.6",borderRadius:0},'code[class*="language-"]':{...h.A['code[class*="language-"]'],background:"none",fontSize:"13px"}};function j({lang:e="text",code:o}){const[a,t]=(0,n.useState)(!1),r=o.split("\n").length>8;return(0,u.jsxs)($,{children:[(0,u.jsxs)(v,{children:[(0,u.jsx)(A,{children:e}),(0,u.jsxs)(k,{copied:a,onClick:()=>{navigator.clipboard.writeText(o).then(()=>{t(!0),setTimeout(()=>t(!1),2e3)})},children:[a?(0,u.jsx)(w.A,{size:12}):(0,u.jsx)(z.A,{size:12}),a?"Copied!":"Copy"]})]}),(0,u.jsx)(y.A,{language:e,style:S,showLineNumbers:r,lineNumberStyle:{color:"#484f58",minWidth:"2.5em",paddingRight:"1.5em",userSelect:"none",fontSize:"12px"},customStyle:{margin:0,background:g.w4.colors.codeBg},wrapLongLines:!1,children:o})]})}function T(){return e=>{!function e(o){if("blockquote"===o.type){const e=o.children?.[0];if("paragraph"===e?.type){const a=e.children?.[0];if("text"===a?.type){const n=a.value?.match(/^\[!(NOTE|TIP|WARNING|CAUTION|IMPORTANT)\]\s*/i);n&&(a.value=a.value.slice(n[0].length),a.value.trim()||1!==e.children.length||o.children.shift(),o.data=o.data??{},o.data.hName="div",o.data.hProperties={"data-callout":n[1].toUpperCase()})}}}o.children?.forEach(e)}(e)}}const M=d.default.div`
  display: flex;
  flex-direction: column;
  flex: 1;
  min-width: 0;
