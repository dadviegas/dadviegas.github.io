...
`,x=({size:o=14,strokeWidth:e=1.75})=>(0,a.jsxs)("svg",{width:o,height:o,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:e,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,a.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,a.jsx)("polyline",{points:"14 2 14 8 20 8"})]});function u({iconKey:o}){let e=o?p[o]:void 0;return e?(0,a.jsx)("svg",{width:14,height:14,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,dangerouslySetInnerHTML:{__html:e}}):(0,a.jsx)(x,{})}function b({entries:o,activeId:e,onSelect:t}){return(0,a.jsx)(a.Fragment,{children:o.map(o=>o.children?(0,a.jsx)(i().Fragment,{children:(0,a.jsx)(b,{entries:o.children,activeId:e,onSelect:t})},o.id):(0,a.jsxs)(f,{active:e===o.id,onClick:()=>t(o),children:[(0,a.jsx)(u,{iconKey:o.icon}),o.name]},o.id))})}function y({activeId:o}){let{flyout:e,scheduleFlyoutClose:t,cancelFlyoutClose:r}=(0,c.c)();if(!e)return null;let i=e.entry.icon?p[e.entry.icon]:void 0;return(0,a.jsxs)(m,{anchorY:e.anchorY,onMouseEnter:r,onMouseLeave:t,children:[(0,a.jsxs)(h,{children:[i?(0,a.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,dangerouslySetInnerHTML:{__html:i}}):(0,a.jsx)(x,{size:13,strokeWidth:2}),e.entry.name]}),(0,a.jsx)(b,{entries:e.entry.children??[],activeId:o,onSelect:o=>{e.onSelect(o),t()}})]})}},814(o,e,t){t.d(e,{I:()=>r,c:()=>i});var a=t(7991);let r=(0,a.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),i=()=>(0,a.useContext)(r)},4764(o,e,t){t.d(e,{PL:()=>B.getSetting,mZ:()=>B.updateDoc,KL:()=>B.saveDoc,cL:()=>c.c,Is:()=>B.putSetting,UO:()=>Y,PE:()=>F,w4:()=>a.w4});var a=t(1316),r=t(5723),i=t(7991),n=t.n(i),l=t(6859),d=t.n(l),s=t(2799),c=t(814);let p="260px",g="56px",m="48px",h=d().header`
  display: flex;
  align-items: center;
...
`,T=d().main`
  ...
  display: flex;
  flex-direction: column;
`,A=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function S(){return(0,r.jsx)(b,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:A.map((o,e)=>(0,r.jsx)(y,{index:e,accent:o.accent,children:o.char},e))})}let j="atlantis:sidebar-collapsed";function F({sidebar:o,children:e,topBarRight:a,title:l="Atlantis",activeId:d=null}){let[s,p]=(0,i.useState)(()=>{try{return"true"===localStorage.getItem(j)}catch{return!1}}),[g,m]=(0,i.useState)(null),u=(0,i.useRef)(),b=()=>p(o=>{let e=!o;try{localStorage.setItem(j,String(e))}catch{}return e}),y=n().useMemo(()=>n().lazy(()=>Promise.resolve().then(t.bind(t,7330)).then(o=>({default:o.FlyoutPanel}))),[]);return(0,r.jsx)(c.I.Provider,{value:{collapsed:s,toggle:b,flyout:g,openFlyout:(o,e,t)=>{clearTimeout(u.current),m({entry:o,anchorY:e,onSelect:t})},scheduleFlyoutClose:()=>{u.current=setTimeout(()=>m(null),160)},cancelFlyoutClose:()=>clearTimeout(u.current)},children:(0,r.jsxs)(z,{children:[(0,r.jsxs)(h,{children:[o&&(0,r.jsx)(f,{children:(0,r.jsx)(x,{onClick:b,title:s?"Expand sidebar":"Collapse sidebar",children:(0,r.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,r.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,r.jsx)("path",{d:"M9 3v18"})]})})}),(0,r.jsx)(S,{}),l&&(0,r.jsx)(w,{children:l}),a&&(0,r.jsx)(v,{children:a})]}),(0,r.jsxs)($,{children:[null!=o&&(0,r.jsx)(M,{collapsed:s,children:(0,r.jsx)(k,{children:o})}),(0,r.jsx)(T,{children:e})]}),g&&(0,r.jsx)(n().Suspense,{fallback:null,children:(0,r.jsx)(y,{activeId:d})})]})})}d().div`
  display: grid;
...
`;function Y({appId:o,onLoad:e}){let[t,a]=(0,i.useState)(!1),[n,l]=(0,i.useState)([]),d=(0,i.useRef)(null),s=(0,i.useCallback)(()=>{(0,B.listDocs)(o).then(l).catch(()=>{})},[o]);(0,i.useEffect)(()=>{if(!t)return;s();let o=o=>{d.current&&!d.current.contains(o.target)&&a(!1)};return document.addEventListener("mousedown",o),()=>document.removeEventListener("mousedown",o)},[t,s]);let c=async(o,e)=>{o.stopPropagation(),await (0,B.deleteDoc)(e),l(o=>o.filter(o=>o.id!==e))};return(0,r.jsxs)(C,{ref:d,children:[(0,r.jsxs)(L,{onClick:()=>a(o=>!o),children:[(0,r.jsx)("svg",{width:14,height:14,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:(0,r.jsx)("path",{d:"M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"})}),"Saved",(0,r.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",style:{marginLeft:2},children:(0,r.jsx)("path",{d:"M6 9l6 6 6-6"})})]}),(0,r.jsxs)(H,{open:t,children:[(0,r.jsx)(R,{children:"Saved versions"}),(0,r.jsx)(E,{children:0===n.length?(0,r.jsx)(P,{children:"No saved documents yet."}):n.map(o=>{var t;return(0,r.jsxs)(V,{children:[(0,r.jsxs)(D,{onClick:()=>{e(o.content,o.id,o.name),a(!1)},children:[(0,r.jsx)(I,{children:o.name}),(0,r.jsx)(N,{children:(t=o.savedAt,new Intl.DateTimeFormat(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}).format(new Date(t)))})]}),(0,r.jsx)(K,{onClick:e=>c(e,o.id),title:"Delete",children:(0,r.jsxs)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,r.jsx)("polyline",{points:"3 6 5 6 21 6"}),(0,r.jsx)("path",{d:"M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6M10 11v6M14 11v6"}),(0,r.jsx)("path",{d:"M9 6V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2"})]})})]},o.id)})})]})]})}d().div`
...
`,b=i().forwardRef(function({variant:o="ghost",size:e="md",icon:t,iconRight:r,children:i,...n},l){return(0,a.jsxs)(u,{ref:l,variant:o,size:e,...n,children:[t,i,r]})}),y={default:d.w4.colors.accent,danger:"#f85149"},w={default:d.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"},v=l().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`,$=i().forwardRef(function({active:o=!1,shape:e="square",tone:t="default",children:r,...i},n){return(0,a.jsx)(v,{ref:n,active:o,shape:e,tone:t,...i,children:r})}),z=l().div`
  position: relative;
  display: inline-flex;
`,M=l().div`
  position: absolute;
  ...
  z-index: 2000;
  overflow: hidden;
`;function k({trigger:o,children:e,align:t="right",open:n,onOpenChange:l}){let[d,s]=(0,r.useState)(!1),c=n??d,p=o=>{l&&l(o),void 0===n&&s(o)},g=(0,r.useRef)(null);(0,r.useEffect)(()=>{if(!c)return;let o=o=>{g.current&&!g.current.contains(o.target)&&p(!1)};return document.addEventListener("mousedown",o),()=>document.removeEventListener("mousedown",o)},[c]);let m=i().cloneElement(o,{onClick:e=>{o.props.onClick?.(e),p(!c)},"aria-expanded":c,"aria-haspopup":"menu"});return(0,a.jsxs)(z,{ref:g,children:[m,c&&(0,a.jsx)(M,{align:t,role:"menu",children:e})]})}let T=l().button`
  display: flex;
  align-items: center;
  gap: 10px;
  padding: 8px 12px;
...
`,l().span`
  ...
  display: inline-block;
`;let V={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:d.w4.colors.accentMuted},D={neutral:d.w4.colors.mainTextMuted,live:d.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:d.w4.colors.accent};l().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${d.w4.typography.fontFamilyMono};
...
`,l().p`
  ...
  font-size: 12.5px;
  line-height: 1.45;
`,t(5406),l().nav`padding: ${d.w4.spacing.sm} 0;`,l().div`
...
`,W.A,W.A['pre[class*="language-"]'],d.w4.colors.codeBg,W.A['code[class*="language-"]'],l().div`
  background: ${({bg:o})=>o};
...
`,l().button`
  ...
  width: 100%;
  padding: 10px 18px;
  background: ${({selected:o})=>o?d.w4.colors.accentMuted:"transparent"};
  border: none;
  cursor: pointer;
  text-align: left;
...
`,l().div`
  ...
  justify-content: center;
  border-radius: ${d.w4.borderRadius.md};
  background: ${({selected:o})=>o?`${d.w4.colors.accent}20`:d.w4.colors.sidebarHover};
  color: ${({selected:o})=>o?d.w4.colors.accent:d.w4.colors.sidebarTextMuted};
  flex-shrink: 0;
  margin-top: 1px;
`,l().div`
  flex: 1;
...
`,l().div`
  display: flex;
  align-items: center;
  color: ${({selected:o})=>o?d.w4.colors.accent:"transparent"};
  margin-top: 8px;
...
`,l().div`
  padding: ${({collapsed:o})=>o?"8px 4px":`8px ${d.w4.spacing.md}`};
  border-bottom: 1px solid ${d.w4.colors.border}60;
`,l().div`
  display: flex;
  align-items: center;
  ...
  justify-content: ${({collapsed:o})=>o?"center":"flex-start"};
  background: ${({focused:o})=>o?`${d.w4.colors.accent}10`:d.w4.colors.sidebarHover};
  border: 1px solid ${({focused:o})=>o?`${d.w4.colors.accent}40`:"transparent"};
  border-radius: ${d.w4.borderRadius.md};
...
`;function oe({activeAppId:o}){let{collapsed:e}=(0,d.cL)(),[t]=function(){let[o,e]=(0,r.useState)(E),t=(0,r.useCallback)(o=>{e(o);try{localStorage.setItem(L,o)}catch{}(0,d.Is)(H,o).catch(()=>{}),window.dispatchEvent(new CustomEvent("atlantis:locale-change",{detail:o}))},[]);return(0,r.useEffect)(()=>{let o=o=>{e(o.detail)};return window.addEventListener("atlantis:locale-change",o),()=>window.removeEventListener("atlantis:locale-change",o)},[]),(0,r.useEffect)(()=>{(0,d.PL)(H).then(t=>{if(R(t)&&t!==o){try{localStorage.setItem(L,t)}catch{}e(t)}}).catch(()=>{})},[]),[o,t]}(),i=(0,r.useMemo)(()=>(o,e)=>{let a=function(o,e){if(!e||!o.includes("|"))return o;let t=null;for(let o of Object.values(e))if("number"==typeof o&&Number.isFinite(o)){t=o;break}if(null===t)return o;let a=o.indexOf("|"),r=o.slice(0,a),i=o.slice(a+1);return 1===t?r:i}(C[o]?.[t]??o,e);return e?Object.entries(e).reduce((o,[e,t])=>o.replace(RegExp(`\\{${e}\\}`,"g"),String(t)),a):a},[t]),n=(0,r.useRef)(null),l=o=>{n.current!==o&&(n.current=o,document.activeElement?.blur(),window.location.hash=o,setTimeout(()=>{n.current=null},50))};return(0,a.jsxs)(Z,{children:[(0,a.jsx)(q,{collapsed:e,children:i("devtools.heading")}),U.map(t=>{let r=i(t.labelKey);return(0,a.jsxs)(X,{active:o===t.id,collapsed:e,onPointerDown:o=>{0===o.button&&l(t.hash)},onClick:()=>l(t.hash),title:r,children:[(0,a.jsx)(Q,{children:(0,a.jsx)(F,{name:t.icon,size:16})}),(0,a.jsx)(oo,{collapsed:e,children:r})]},t.id)})]})}let ot=(0,S.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`;l().div`
  display: grid;
...
`,og=l().div`
  ...
  color: ${d.w4.colors.sidebarTextMuted};
  font-family: ${d.w4.typography.fontFamily};
`;function om({onSave:o,onUpdate:e,onCancel:t,existingDoc:i}){let[n,l]=(0,r.useState)(i?.name??""),d=(0,r.useRef)(null);return(0,r.useEffect)(()=>{d.current?.focus(),i&&d.current?.select()},[i]),(0,a.jsx)(oi,{onClick:t,children:(0,a.jsxs)(on,{onClick:o=>o.stopPropagation(),children:[(0,a.jsx)(ol,{children:"Save document"}),i&&e&&(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(og,{children:"Update the current version or save as a new one."}),(0,a.jsxs)(os,{children:[(0,a.jsx)(oc,{onClick:t,children:"Cancel"}),(0,a.jsxs)(oc,{danger:!0,onClick:e,children:['Update "',i.name,'"']})]}),(0,a.jsx)(op,{})]}),(0,a.jsx)(od,{ref:d,value:n,onChange:o=>l(o.target.value),onKeyDown:a=>{"Enter"===a.key&&n.trim()&&(i&&n.trim()===i.name&&e?e():o(n.trim())),"Escape"===a.key&&t()},placeholder:i?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,a.jsxs)(os,{children:[!i&&(0,a.jsx)(oc,{onClick:t,children:"Cancel"}),(0,a.jsx)(oc,{primary:!0,disabled:!n.trim(),onClick:()=>o(n.trim()),children:"Save as new"})]})]})})}let oh=(0,S.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,of=(0,S.keyframes)`
...
`,l().div`
  ...
  flex-direction: column;
  gap: 14px;
  animation: ${of} 0.18s cubic-bezier(0.22, 1, 0.36, 1) both;
`,l().div`
  font-size: ${d.w4.typography.fontSizeMd};
  font-weight: 700;
...
`;l().div`
  ...
  background: ${d.w4.colors.mainBg};
  font-family: ${d.w4.typography.fontFamily};
  animation: ${ox} 0.4s ease 0.15s both;
`,l().div`
  position: relative;
  width: 56px;
  height: 56px;
...
`,l().div`
  position: absolute;
  inset: 0;
  animation: ${ou} 1.4s cubic-bezier(0.4, 0, 0.2, 1) infinite;
