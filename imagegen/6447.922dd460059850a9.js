"use strict";(self.webpackChunk_atlantis_imagegen=self.webpackChunk_atlantis_imagegen||[]).push([["6447"],{3758(o,e,a){a.d(e,{Vi:()=>n,fG:()=>t,i4:()=>r.buildPollinationsUrl});var r=a(8294);async function t(o,e){return(await (0,r.askGroq)(e,{key:o,system:"You are an expert at writing image generation prompts. Enhance the user's prompt to be more descriptive and visually compelling. Include details about lighting, style, composition, and mood. Return ONLY the enhanced prompt text, no explanation or quotes.",maxTokens:200})).trim()||e}function n(){return(0,r.loadApiKeysSync)().groq??""}},3487(o,e,a){a.d(e,{Z:()=>h});var r=a(5723),t=a(7991),n=a(6859),i=a.n(n),l=a(2799),s=a(3930),d=a(4525),c=a(6665);let p=(0,l.keyframes)`
...
`,w=i().div`
  ...
  opacity: 0;
  transition: opacity ${s.w4.transitions.base};
`;function y({item:o,onSelect:e,onDelete:a}){let n=function(o){let e=`https://image.pollinations.ai/prompt/${encodeURIComponent(o.prompt)}?width=200&height=200&seed=${o.seed}&model=${o.model}&nologo=true`,[a,r]=(0,t.useState)(e);return(0,t.useEffect)(()=>{let e=null;return(0,c.if)(o.id).then(o=>{o&&(e=o,r(o))}),()=>{e&&URL.revokeObjectURL(e)}},[o.id]),a}(o);return(0,r.jsxs)(x,{onClick:e,children:[(0,r.jsx)(u,{src:n,alt:o.prompt,loading:"lazy",referrerPolicy:"no-referrer"}),(0,r.jsx)(b,{className:"delete-btn",role:"button",onClick:o=>{o.stopPropagation(),a()},children:(0,r.jsx)(d.A,{size:12})}),(0,r.jsx)(w,{className:"prompt-label",children:o.prompt})]})}function h({items:o,onSelect:e,onDelete:a}){return 0===o.length?null:(0,r.jsxs)(g,{children:[(0,r.jsx)(m,{children:"Recent Generations"}),(0,r.jsx)(f,{children:o.map(o=>(0,r.jsx)(y,{item:o,onSelect:()=>e(o),onDelete:()=>a(o.id)},o.id))})]})}},9610(o,e,a){a.d(e,{e:()=>v});var r=a(5723),t=a(6859),n=a.n(t),i=a(2799),l=a(3930),s=a(8311),d=a(153),c=a(889),p=a(9421);let g=(0,i.keyframes)`
...
`,b=n().div`
  ...
  background: linear-gradient(
    90deg,
    ${l.w4.colors.codeBg} 0%,
    ${l.w4.colors.surface} 50%,
    ${l.w4.colors.codeBg} 100%
  );
...
`;function v({url:o,status:e,width:a,height:t,onLoad:n,onError:i,onReroll:l,onRetry:g}){return(0,r.jsxs)(f,{children:[(0,r.jsx)(x,{ratio:a/t,children:(0,r.jsxs)(u,{children:["idle"===e&&(0,r.jsxs)(y,{children:[(0,r.jsx)("span",{style:{fontSize:40,opacity:.3},children:"\uD83C\uDFA8"}),"Generate an image to get started"]}),"loading"===e&&(0,r.jsx)(b,{}),"error"===e&&(0,r.jsxs)(h,{children:[(0,r.jsx)(d.A,{size:32}),"Failed to generate image",(0,r.jsx)(s.$n,{variant:"ghost",size:"sm",onClick:g,children:"Try Again"})]}),o&&("loaded"===e||"loading"===e)&&(0,r.jsx)(w,{src:o,alt:"Generated image",crossOrigin:"anonymous",referrerPolicy:"no-referrer",onLoad:o=>n(o.currentTarget),onError:i,style:{display:"loaded"===e?"block":"none"}})]})}),"loaded"===e&&(0,r.jsxs)($,{className:"overlay",children:[(0,r.jsxs)(z,{onClick:()=>{o&&window.open(o,"_blank","noopener")},children:[(0,r.jsx)(c.A,{size:14})," Download"]}),(0,r.jsxs)(z,{onClick:l,children:[(0,r.jsx)(p.A,{size:14})," New Variation"]})]})]})}},6396(o,e,a){a.d(e,{q:()=>z});var r=a(5723),t=a(6859),n=a.n(t),i=a(2799),l=a(3930),s=a(8311),d=a(7071),c=a(3482),p=a(2569),g=a(8294);let m=(0,i.keyframes)`
...
`,y=n().select`
  ...
  cursor: pointer;
  outline: none;
`,h=[{label:"Square 1:1",w:1024,h:1024},{label:"Landscape 16:9",w:1344,h:768},{label:"Portrait 9:16",w:768,h:1344},{label:"Wide 21:9",w:1344,h:576}],$=g.POLLINATIONS_MODELS;function z({prompt:o,onPromptChange:e,width:a,height:t,model:n,onSizeChange:i,onModelChange:l,onGenerate:d,onEnhance:g,generating:m,enhancing:v,canEnhance:k}){let A=!!o.trim()&&!m;return(0,r.jsxs)(f,{children:[(0,r.jsxs)(x,{children:[(0,r.jsx)(u,{placeholder:"Describe the image you want to create...",value:o,onChange:o=>e(o.target.value),onKeyDown:o=>{"Enter"===o.key&&A&&(o.preventDefault(),d())}}),(0,r.jsx)(s.$n,{variant:"ghost",icon:v?(0,r.jsx)(b,{size:14}):(0,r.jsx)(c.A,{size:14}),disabled:!k||v||!o.trim(),onClick:g,title:k?"Enhance prompt with AI":"Add a Groq key in Prompt Lab to enable",children:"Enhance"}),(0,r.jsx)(s.$n,{variant:"primary",icon:m?(0,r.jsx)(b,{size:14}):(0,r.jsx)(p.A,{size:14}),disabled:!A,onClick:d,children:"Generate"})]}),(0,r.jsxs)(w,{children:[h.map(o=>(0,r.jsx)(s.vu,{variant:a===o.w&&t===o.h?"selected":"default",onClick:()=>i(o.w,o.h),children:o.label},o.label)),(0,r.jsx)(y,{value:n,onChange:o=>l(o.target.value),children:$.map(o=>(0,r.jsx)("option",{value:o.id,children:o.label},o.id))})]})]})}},6665(o,e,a){a.d(e,{CJ:()=>n,XZ:()=>l,if:()=>i});let r="images";function t(){return new Promise((o,e)=>{let a=indexedDB.open("atlantis-imagegen-cache",1);a.onupgradeneeded=()=>{let o=a.result;o.objectStoreNames.contains(r)||o.createObjectStore(r,{keyPath:"id"})},a.onsuccess=()=>o(a.result),a.onerror=()=>e(a.error)})}async function n(o,e){try{let a=await new Promise(o=>{try{let a=document.createElement("canvas");a.width=e.naturalWidth,a.height=e.naturalHeight;let r=a.getContext("2d");if(!r)return void o(null);r.drawImage(e,0,0),a.toBlob(e=>o(e),"image/png")}catch{o(null)}});if(!a)return;let n=await t(),i=n.transaction(r,"readwrite").objectStore(r);i.put({id:o,blob:a,cachedAt:Date.now()});let l=i.getAll();l.onsuccess=()=>{let o=l.result;if(o.length>10)for(let e of(o.sort((o,e)=>e.cachedAt-o.cachedAt),o.slice(10)))i.delete(e.id)},n.close()}catch{}}async function i(o){try{let e=await t();return new Promise(a=>{let t=e.transaction(r,"readonly").objectStore(r).get(o);t.onsuccess=()=>{e.close();let o=t.result;o?.blob?a(URL.createObjectURL(o.blob)):a(null)},t.onerror=()=>{e.close(),a(null)}})}catch{return null}}async function l(o){try{let e=await t();e.transaction(r,"readwrite").objectStore(r).delete(o),e.close()}catch{}}},7871(o,e,a){a.d(e,{$5:()=>n,DZ:()=>p,M5:()=>c,Qd:()=>i,vI:()=>l});var r=a(8294);let t="atlantis:imagegen:gallery";function n(){try{return JSON.parse(localStorage.getItem(t)??"[]")}catch{return[]}}function i(o){let e=n().filter(e=>e.id!==o.id),a=[o,...e].slice(0,50);try{localStorage.setItem(t,JSON.stringify(a))}catch{}return a}function l(o){let e=n().filter(e=>e.id!==o);try{localStorage.setItem(t,JSON.stringify(e))}catch{}return e}let s={width:1024,height:1024,model:r.DEFAULT_POLLINATIONS_MODEL_ID},d="atlantis:imagegen:settings";function c(){try{return{...s,...JSON.parse(localStorage.getItem(d)??"{}")}}catch{return s}}function p(o){try{localStorage.setItem(d,JSON.stringify(o))}catch{}}},7330(o,e,a){a.d(e,{FlyoutPanel:()=>oE});var r=a(5723),t=a(7991),n=a.n(t),i=a(6859),l=a.n(i),s=a(2799),d=a(1316),c=a(814),p=a(6896),g=a(7902),m=a(3013),f=a(2887),x=a(9510),u=a(9848),b=a(7901),w=a(3045),y=a(3775),h=a(1783),$=a(3539),z=a(9416),v=a(1837),k=a(7167),A=a(4494),M=a(2314),T=a(255),S=a(5751),j=a(9633),F=a(2946),B=a(822),R=a(6720),P=a(7400),E=a(8456),C=a(3317),L=a(2709),H=a(8006),N=a(9301),D=a(7561),I=a(3517),Y=a(8207),G=a(7032),K=a(6949),O=a(8218),_=a(6829),V=a(9591),U=a(5553),J=a(9923),W=a(2820),Z=a(4621),q=a(8479),X=a(2534),Q=a(6673),oo=a(7490),oe=a(9033),oa=a(9038),or=a(5775),ot=a(1365),on=a(2937),oi=a(9821),ol=a(5912),os=a(158),od=a(8641),oc=a(8607),op=a(3249),og=a(1821),om=a(5889),of=a(9655),ox=a(7170),ou=a(9161),ob=a(1849),ow=a(1604),oy=a(3142),oh=a(1187),o$=a(7747),oz=a(2932),ov=a(4525),ok=a(7230),oA=a(2164);let oM={activity:p.A,"a-large-small":g.A,apple:m.A,"arrow-right":f.A,"bar-chart-2":x.A,book:u.A,"book-open":b.A,briefcase:w.A,calendar:y.A,clock:h.A,"circle-dot":$.A,cloud:z.A,compass:v.A,cpu:k.A,droplets:A.A,feather:M.A,file:T.A,"file-text":S.A,folder:j.A,"git-branch":F.A,github:B.A,globe:R.A,grid:P.A,hand:E.A,hash:C.A,heart:L.A,key:H.A,hexagon:N.A,home:D.A,landmark:I.A,layers:Y.A,"layout-grid":G.A,leaf:K.A,lightbulb:O.A,list:_.A,map:V.A,"map-pin":U.A,"message-circle":J.A,"message-square":W.A,minus:Z.A,monitor:q.A,mountain:X.A,package:Q.A,palette:oo.A,"pen-tool":oe.A,"pie-chart":oa.A,plane:or.A,plus:ot.A,ruler:on.A,shirt:oi.A,slash:ol.A,square:os.A,star:od.A,sun:oc.A,terminal:op.A,thermometer:og.A,triangle:om.A,trophy:of.A,truck:ox.A,type:ou.A,users:ob.A,"volume-2":ow.A,watch:oy.A,waves:oh.A,wind:o$.A,wrench:oz.A,x:ov.A,zap:ok.A,bot:oA.A},oT=(0,s.keyframes)`
...
`,oB=({size:o=14,strokeWidth:e=1.75})=>(0,r.jsxs)("svg",{width:o,height:o,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:e,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,r.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,r.jsx)("polyline",{points:"14 2 14 8 20 8"})]});function oR({iconKey:o}){let e=o?oM[o]:null;return e?(0,r.jsx)(e,{size:14,strokeWidth:1.75}):(0,r.jsx)(oB,{})}function oP({entries:o,activeId:e,onSelect:a}){return(0,r.jsx)(r.Fragment,{children:o.map(o=>o.children?(0,r.jsx)(n().Fragment,{children:(0,r.jsx)(oP,{entries:o.children,activeId:e,onSelect:a})},o.id):(0,r.jsxs)(oF,{active:e===o.id,onClick:()=>a(o),children:[(0,r.jsx)(oR,{iconKey:o.icon}),o.name]},o.id))})}function oE({activeId:o}){let{flyout:e,scheduleFlyoutClose:a,cancelFlyoutClose:t}=(0,c.c)();if(!e)return null;let n=e.entry.icon?oM[e.entry.icon]:null;return(0,r.jsxs)(oS,{anchorY:e.anchorY,onMouseEnter:t,onMouseLeave:a,children:[(0,r.jsxs)(oj,{children:[n?(0,r.jsx)(n,{size:13,strokeWidth:2}):(0,r.jsx)(oB,{size:13,strokeWidth:2}),e.entry.name]}),(0,r.jsx)(oP,{entries:e.entry.children??[],activeId:o,onSelect:o=>{e.onSelect(o),a()}})]})}},814(o,e,a){a.d(e,{I:()=>t,c:()=>n});var r=a(7991);let t=(0,r.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),n=()=>(0,r.useContext)(t)},3930(o,e,a){a.d(e,{w4:()=>r.w4,PE:()=>F,PL:()=>R.getSetting});var r=a(1316),t=a(5723),n=a(7991),i=a.n(n),l=a(6859),s=a.n(l);s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,M=s().main`
  ...
  display: flex;
  flex-direction: column;
`,T=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function S(){return(0,t.jsx)(w,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:T.map((o,e)=>(0,t.jsx)(y,{index:e,accent:o.accent,children:o.char},e))})}let j="atlantis:sidebar-collapsed";function F({sidebar:o,children:e,topBarRight:r,title:l="Atlantis",activeId:s=null}){let[d,p]=(0,n.useState)(()=>{try{return"true"===localStorage.getItem(j)}catch{return!1}}),[g,m]=(0,n.useState)(null),b=(0,n.useRef)(),w=()=>p(o=>{let e=!o;try{localStorage.setItem(j,String(e))}catch{}return e}),y=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(a.bind(a,7330)).then(o=>({default:o.FlyoutPanel}))),[]);return(0,t.jsx)(c.I.Provider,{value:{collapsed:d,toggle:w,flyout:g,openFlyout:(o,e,a)=>{clearTimeout(b.current),m({entry:o,anchorY:e,onSelect:a})},scheduleFlyoutClose:()=>{b.current=setTimeout(()=>m(null),160)},cancelFlyoutClose:()=>clearTimeout(b.current)},children:(0,t.jsxs)(v,{children:[(0,t.jsxs)(f,{children:[o&&(0,t.jsx)(x,{children:(0,t.jsx)(u,{onClick:w,title:d?"Expand sidebar":"Collapse sidebar",children:(0,t.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("path",{d:"M9 3v18"})]})})}),(0,t.jsx)(S,{}),l&&(0,t.jsx)(h,{children:l}),r&&(0,t.jsx)($,{children:r})]}),(0,t.jsxs)(z,{children:[null!=o&&(0,t.jsx)(k,{collapsed:d,children:(0,t.jsx)(A,{children:o})}),(0,t.jsx)(M,{children:e})]}),g&&(0,t.jsx)(i().Suspense,{fallback:null,children:(0,t.jsx)(y,{activeId:s})})]})})}s().div`
  display: grid;
...
`,w=n().forwardRef(function({variant:o="ghost",size:e="md",icon:a,iconRight:t,children:n,...i},l){return(0,r.jsxs)(b,{ref:l,variant:o,size:e,...i,children:[a,n,t]})}),y={default:s.w4.colors.accent,danger:"#f85149"},h={default:s.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"};l().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`,a(2727);var $=a(2799);let z=(0,$.keyframes)`
...
`,(0,s.PL)("shell:locale").then(o=>{if("en"===o||"pt"===o)try{localStorage.setItem("atlantis:locale",o)}catch{}}).catch(()=>{}),l().div`
  display: flex;
  gap: 4px;
  background: ${s.w4.colors.surface};
  border: 1px solid ${s.w4.colors.border};
...
`,M=l().span`
  ...
  background: ${({color:o})=>o};
  display: inline-block;
`,T=n().forwardRef(function({variant:o="default",dotColor:e,children:a,onClick:t,...n},i){return(0,r.jsxs)(A,{ref:i,variant:o,clickable:!!t,onClick:t,type:n.type??"button",...n,children:[e&&(0,r.jsx)(M,{color:e}),a]})}),S={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:s.w4.colors.accentMuted},j={neutral:s.w4.colors.mainTextMuted,live:s.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:s.w4.colors.accent};l().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${s.w4.typography.fontFamilyMono};
...
`,P.A,P.A['pre[class*="language-"]'],s.w4.colors.codeBg,P.A['code[class*="language-"]'],l().div`
  background: ${({bg:o})=>o};
...
`,l().span`
  ...
  line-height: 1;
  letter-spacing: 0;
`},4041(o,e,a){a.d(e,{z:()=>r});function r(){return"u">typeof crypto&&"function"==typeof crypto.randomUUID?crypto.randomUUID().replace(/-/g,"").slice(0,8):Math.random().toString(36).slice(2,10).padEnd(8,"0")}}}]);