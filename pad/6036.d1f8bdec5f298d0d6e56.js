"use strict";(self.webpackChunk_atlantis_pad=self.webpackChunk_atlantis_pad||[]).push([[6036],{46036(e,r,t){t.r(r),t.d(r,{default:()=>v});var o=t(27359),n=t(53233),a=t(71344),s=t(76480),i=t(59200),l=t(21030),c=t(78967),d=t(22402),u=t(69835),p=t(47579),m=t(15933),g=t(65723);function f(){const e=window.location.hash.toLowerCase();return e.startsWith("#/mermaidpad")||e.startsWith("#/mermaid")?"mermaid":"markdown"}const w=n.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  padding: 5px 12px;
