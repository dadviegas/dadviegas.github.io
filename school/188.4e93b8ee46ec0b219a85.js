...
`,R=i.default.div`
  ...
  border-radius: 50%;
  background: white;
  animation: ${P} ${({dur:e})=>e}s ease-in-out infinite;
...
`,L=[{x:4,y:10,size:1.5,delay:.2,dur:3.1},{x:12,y:80,size:2,delay:1.4,dur:4},{x:22,y:25,size:2.5,delay:.6,dur:3.5},{x:35,y:70,size:1.5,delay:2,dur:4.3},{x:48,y:15,size:2,delay:.9,dur:3.2},{x:58,y:85,size:1.5,delay:1.7,dur:3.9},{x:68,y:35,size:2,delay:2.5,dur:4.1},{x:78,y:60,size:2.5,delay:.3,dur:3.4},{x:88,y:20,size:1.5,delay:1.1,dur:3.7},{x:94,y:75,size:2,delay:2.3,dur:4.5}],X=i.default.h2`
  font-size: ${l.w4.typography.fontSizeSm};
  font-weight: 700;
  text-transform: uppercase;
...
`),H=i.default.div`
  ...
  align-items: center;
  gap: ${l.w4.spacing.sm};
`,q={pt:"O que vamos aprender hoje?",en:"What shall we learn today?"},A={pt:"Escolhe uma disciplina para começar",en:"Pick a subject to get started"};function G({topBarRight:e}){const[a,t]=(0,r.useState)(w),[o]=(0,d.Ym)(),i="pt"===o?"pt":"en";if((0,r.useEffect)(()=>{const e=()=>t(w());return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[]),!a)return(0,f.jsx)(l.PE,{title:"School",sidebar:null,topBarRight:e,children:(0,f.jsxs)(v,{children:[N.map((e,a)=>(0,f.jsx)(R,{x:e.x,y:e.y,size:e.size,delay:e.delay,dur:e.dur},a)),(0,f.jsx)(Y,{top:15,delay:12}),(0,f.jsx)(Y,{top:55,delay:25}),(0,f.jsx)(j,{children:q[i]}),(0,f.jsx)(T,{children:A[i]}),(0,f.jsx)(C,{children:"pt"===i?"Disciplinas":"Subjects"}),(0,f.jsx)(S,{columns:3,children:y.map((e,a)=>(0,f.jsxs)(W,{accentColor:e.color,onClick:()=>{t(e.key),window.location.hash=`#/${e.hashPrefix}`},children:[(0,f.jsx)(O,{className:"card-emoji",delay:.4*a,children:e.emoji}),(0,f.jsx)(_,{children:e.label[i]}),(0,f.jsx)(F,{children:e.description[i]})]},e.key))}),(0,f.jsxs)(B,{children:[L.map((e,a)=>(0,f.jsx)(R,{x:e.x,y:e.y,size:e.size,delay:e.delay,dur:e.dur},a)),(0,f.jsx)(X,{children:"pt"===i?"Jogos":"Games"}),(0,f.jsx)(S,{columns:3,children:(0,f.jsxs)(W,{accentColor:"#f97583",onClick:()=>{t("lebem"),window.location.hash="#/lebem"},children:[(0,f.jsx)(O,{className:"card-emoji",delay:1.2,children:"🎮"}),(0,f.jsx)(_,{children:"pt"===i?"Ler a Brincar":"Read & Play"}),(0,f.jsx)(F,{children:"pt"===i?"Aprende a ler com jogos divertidos":"Learn to read with fun games"})]})})]})]})});const n=(0,f.jsxs)(H,{children:[(0,f.jsxs)(D,{onClick:()=>{t(null),window.location.hash="#/school"},children:["← ","pt"===i?"Disciplinas":"Subjects"]}),e]});if("lebem"===a)return(0,f.jsx)(l.PE,{title:"LêBem",sidebar:null,topBarRight:n,children:(0,f.jsx)(h.f,{onBack:()=>{t(null),window.location.hash="#/school"}})});const c=y.find(e=>e.key===a);return(0,f.jsx)(s.WO,{hashPrefix:c.hashPrefix,defaultLang:"pt",locale:o,languages:c.languages,welcomeTitle:c.welcomeTitle,welcomeSub:c.welcomeSub,topBarRight:n},a)}const I=document.getElementById("root");if(!I)throw new Error("Root element #root not found");(0,o.H)(I).render((0,f.jsx)(G,{}))},58997(e,a,t){var o=t(48991);a.H=o.createRoot,o.hydrateRoot}}]);
//# sourceMappingURL=188.4e93b8ee46ec0b219a85.js.map