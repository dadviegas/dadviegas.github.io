"use strict";(self.webpackChunk_atlantis_music=self.webpackChunk_atlantis_music||[]).push([["362"],{3935(e,t,s){s.r(t),s.d(t,{default:()=>N});var i=s(5723),n=s(7991),a=s(6859),l=s.n(a),r=s(2799),o=s(4764),c=s(8170),d=s(5030),m=s(948);let h="music:history",p="music:playlists";function u(){return Math.random().toString(36).slice(2,10)}function x(e){return`music://music.apple.com/search?term=${encodeURIComponent(e)}`}let y=(0,r.keyframes)`
