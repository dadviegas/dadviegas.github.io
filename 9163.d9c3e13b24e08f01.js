...
`,e$=l().div`
  ...
  flex-wrap: wrap;
  gap: 6px;
`,ej=l()("button",{shouldForwardProp:e=>"active"!==e&&"chipColor"!==e})`
  display: inline-flex;
  align-items: center;
  gap: 6px;
  height: 28px;
...
`,eM=l().div`
  ...
  gap: 12px;
`,eS=l()("button",{shouldForwardProp:e=>"added"!==e})`
  position: relative;
  display: flex;
  flex-direction: column;
  gap: 8px;
...
`,eP=l().div`
  ...
  color: ${c.w4.colors.mainTextMuted};
  font-size: 13px;
`;function eI({open:e,activeIds:t,locale:a,onAdd:n,onRemove:r,onClose:s}){let l=(0,o.useMemo)(()=>(0,m.Nx)(a,el),[a]),[d,c]=(0,o.useState)(""),[p,g]=(0,o.useState)("all"),h=(0,o.useRef)(null);(0,o.useEffect)(()=>{e&&(c(""),g("all"),requestAnimationFrame(()=>h.current?.focus()))},[e]),(0,o.useEffect)(()=>{if(!e)return;let t=e=>{"Escape"===e.key&&s()};return document.addEventListener("keydown",t),()=>document.removeEventListener("keydown",t)},[e,s]);let f=(0,o.useMemo)(()=>{let e=d.trim().toLowerCase();return eo.filter(t=>{if("all"!==p&&t.suite!==p)return!1;if(!e)return!0;let i="pt"===a?t.labels.pt:t.labels.en,o="pt"===a?t.descriptions.pt:t.descriptions.en;return i.toLowerCase().includes(e)||o.toLowerCase().includes(e)||t.id.toLowerCase().includes(e)||t.suite.toLowerCase().includes(e)})},[d,p,a]);return e?ec().createPortal((0,i.jsx)(eh,{onClick:s,children:(0,i.jsxs)(ef,{onClick:e=>e.stopPropagation(),role:"dialog","aria-label":l("widgets.picker.title"),children:[(0,i.jsxs)(eb,{children:[(0,i.jsxs)(ex,{children:[(0,i.jsx)(u.YZ,{children:l("widgets.picker.eyebrow")}),(0,i.jsx)(ev,{onClick:s,"aria-label":l("widgets.picker.close"),children:(0,i.jsx)(u.In,{name:"close",size:14,"aria-hidden":"true"})})]}),(0,i.jsx)(ey,{children:l("widgets.picker.title")}),(0,i.jsx)(ew,{children:l("widgets.picker.subtitle")})]}),(0,i.jsxs)(ek,{children:[(0,i.jsx)(u.pd,{ref:h,placeholder:l("widgets.picker.searchPlaceholder"),value:d,onChange:e=>c(e.target.value),before:(0,i.jsx)(u.In,{name:"search",size:14,"aria-hidden":"true"})}),(0,i.jsx)(e$,{role:"tablist",children:ep.map(e=>(0,i.jsxs)(ej,{active:p===e.id,chipColor:e.color,onClick:()=>g(e.id),role:"tab","aria-selected":p===e.id,children:[e.color&&(0,i.jsx)("span",{className:"dot"}),l(e.labelKey)]},e.id))})]}),(0,i.jsx)(eM,{children:0===f.length?(0,i.jsx)(eP,{children:l("widgets.picker.empty")}):f.map(e=>{let o=t.has(e.id),s="pt"===a?e.labels.pt:e.labels.en,d="pt"===a?e.descriptions.pt:e.descriptions.en,c=eu[e.suite],p=ep.find(t=>t.id===e.suite);return(0,i.jsxs)(eS,{added:o,onClick:()=>{o?r(e.id):n(e.id)},children:[(0,i.jsxs)(ez,{children:[(0,i.jsx)(eC,{children:e.icon}),(0,i.jsx)(eT,{children:s}),o&&(0,i.jsxs)(eA,{children:[(0,i.jsx)(u.In,{name:"check",size:10,"aria-hidden":"true"}),l("widgets.picker.added")]})]}),(0,i.jsx)(eL,{children:d}),(0,i.jsxs)(eF,{children:[(0,i.jsx)(eN,{swatchColor:c}),p?l(p.labelKey):e.suite]})]},e.id)})})]})}),document.body):null}let eD="shell:dashboard-widgets",eR="shell:pending-open-widget-picker",eH=[{id:"w-ask-sessions",widgetId:"ask-sessions"},{id:"w-daily-feed",widgetId:"daily-feed"},{id:"w-techscope",widgetId:"techscope"},{id:"w-weather",widgetId:"weather"},{id:"w-clock",widgetId:"clock"}],eE=(0,d.keyframes)`
  from { opacity: 0; transform: translateY(8px); }
  to { opacity: 1; transform: translateY(0); }
`,eO=l().div`
  margin-bottom: ${c.w4.spacing.xl};
  animation: ${eE} 0.35s ease both;
`,eK=l().div`
  display: flex;
  align-items: center;
  justify-content: space-between;
...
`,e5=l().button`
  ...
  &:focus-visible { ${c.w4.focusRing} }
`,e3=new Set(M.filter(e=>"Developer Toolkit"===e.suite).map(e=>e.id)),e8="pin:",e6={sm:{colSpan:1},md:{colSpan:2},lg:{colSpan:"full"}};function e7({size:e}){return(0,i.jsxs)("svg",{width:14,height:14,viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:[(0,i.jsx)("rect",{x:1.5,y:4.5,width:11,height:5,rx:1,stroke:"currentColor",strokeWidth:1,opacity:.4}),(0,i.jsx)("rect",{x:2,y:5,width:"sm"===e?4:"md"===e?7:11,height:4,rx:.5,fill:"currentColor"})]})}function e9(e){return e.widgetId.startsWith(e8)}function te(e){return e.widgetId.slice(e8.length)}let tt=new Set(["games","movies","devtools"]);function ta({instance:e,appId:t,meta:a,app:o,idx:n,totalCount:r,tShell:s,recentsOverride:l,onMove:d,onRemove:c,onSelectApp:m}){let g=(0,p.useRecents)(t),h=r>1?(0,i.jsxs)(i.Fragment,{children:[n>0&&(0,i.jsx)(eU,{type:"button",title:s("widgets.moveLeft"),onClick:t=>{t.stopPropagation(),d(e.id,-1)},children:(0,i.jsx)(u.In,{name:"chevron-left",size:13})}),n<r-1&&(0,i.jsx)(eU,{type:"button",title:s("widgets.moveRight"),onClick:t=>{t.stopPropagation(),d(e.id,1)},children:(0,i.jsx)(u.In,{name:"chevron-right",size:13})})]}):void 0;return(0,i.jsx)(u.SV,{vizId:t,label:a.label,description:a.description,hash:o?.hash??a.hash,category:a.category,accentColor:a.color,needsAuth:a.needsAuth,pinned:!0,index:n,onClick:()=>{o?m(o):window.location.hash=a.hash},onHoverIntent:o?()=>x(t):void 0,onTogglePin:()=>c(e.id),reorderControls:h,extra:tt.has(t)?function(e,t,a,o){if(0===e.length)return null;let n=e.slice(0,3);return(0,i.jsxs)(eJ,{children:[(0,i.jsx)(eQ,{children:a("pinnedCard.recent.label")}),(0,i.jsx)(eZ,{children:n.map(e=>{let a,n,r;return(0,i.jsxs)(eX,{type:"button",tintColor:e.color??t,title:e.label,onClick:t=>{t.stopPropagation(),window.location.hash=e.hash},children:[(a=function(e){if(e)return C[e.split("?")[0]]??C[e]}(e.hash),n=a?.iconName??e.iconName??o,r=a?.color??e.color??t,n?(0,i.jsx)("span",{className:"glyph","aria-hidden":"true",style:{color:r},children:(0,i.jsx)(u.In,{name:n,size:14})}):e.icon?(0,i.jsx)("span",{className:"glyph","aria-hidden":"true",children:e.icon}):null),(0,i.jsx)("span",{className:"label",children:e.label})]},e.hash)})})]})}(l??g,a.color,s,a.icon):null})}function ti({locale:e,pinnedAppIds:t,recentAppIds:a,apps:n,appMeta:r,onSelectApp:s,onTogglePin:l}){let d=(0,o.useMemo)(()=>(0,m.Nx)(e,el),[e]),[g,h]=(0,o.useState)([]),[f,b]=(0,o.useState)(!1),[x,y]=(0,o.useState)(!1);(0,o.useEffect)(()=>{let e=()=>{try{sessionStorage.removeItem(eR)}catch{}y(!0)};window.addEventListener("atlantis:open-widget-picker",e);let t=!1;try{t="1"===sessionStorage.getItem(eR)}catch{}if(t){try{sessionStorage.removeItem(eR)}catch{}y(!0)}return()=>window.removeEventListener("atlantis:open-widget-picker",e)},[]),(0,o.useEffect)(()=>{let e=!1;return(async()=>{let t=await (0,c.PL)(eD);if(!e){if(t)try{let e=JSON.parse(t),a=function(e){if(!e.some(e=>"internet-now"===e.widgetId))return e;let t=[];for(let a of e)if("internet-now"===a.widgetId){let e=Date.now();t.push({id:`w-trending-${e}`,widgetId:"trending-searches"},{id:`w-wiki-${e+1}`,widgetId:"wiki-most-read"},{id:`w-hn-${e+2}`,widgetId:"hackernews-hot"})}else t.push(a);return t}(e);h(a),a!==e&&(0,c.Is)(eD,JSON.stringify(a))}catch{h(eH)}else h(eH);b(!0)}})(),()=>{e=!0}},[]),(0,o.useEffect)(()=>{f&&h(e=>{let a=new Set(t),i=new Set(e.filter(e9).map(te)),o=e.filter(e=>!e9(e)||a.has(te(e)));for(let e of t)i.has(e)||(o=[...o,{id:`pin-${e}`,widgetId:`${e8}${e}`}]);return o.length!==e.length||o.some((t,a)=>t.id!==e[a]?.id)?((0,c.Is)(eD,JSON.stringify(o)),o):e})},[t,f]);let w=(0,o.useRef)(new Set);(0,o.useEffect)(()=>{if(!f)return;let e=new Set(g.filter(e=>!e9(e)).map(e=>e.widgetId)),t=w.current;for(let a of e){if(t.has(a))continue;let e=en(a);if(e?.notifications?.length){for(let t of e.notifications)p.events.registerCategory({id:t.category,labelKey:t.labelKey??`notifications.source.${t.id}`,badgeColor:e.accentColor??c.w4.colors.mainTextMuted});p.events.registerRules(e.notifications)}}for(let a of t){if(e.has(a))continue;let t=en(a);if(t){if(t.notifications?.length){p.events.unregisterRules(t.notifications.map(e=>e.id));let e=new Set(t.notifications.map(e=>e.category));for(let t of p.events.getItems())e.has(t.category)&&p.events.dismiss(t.id)}for(let e of t.sources.filter(e=>e.cacheKey).map(e=>`widget-cache:${e.cacheKey}`))(0,c.bg)(e);if(t.persistedKeys)for(let e of t.persistedKeys)(0,c.bg)(e);(0,c.jv)(`notifications:${a}:`).then(e=>{for(let t of e)(0,c.bg)(t)}),t.cleanup&&t.cleanup().catch(()=>{})}}w.current=e},[g,f]);let v=(0,o.useCallback)(e=>{h(e),(0,c.Is)(eD,JSON.stringify(e))},[]),$=(0,o.useCallback)(e=>{v([...g,{id:`w-${e}-${Date.now()}`,widgetId:e}])},[g,v]),j=(0,o.useCallback)(e=>{let t=g.find(t=>t.id===e);t&&e9(t)?l(te(t)):v(g.filter(t=>t.id!==e))},[g,v,l]),M=(0,o.useCallback)((e,t)=>{let a=g.findIndex(t=>t.id===e);if(a<0)return;let i=a+t;if(i<0||i>=g.length)return;let o=[...g];[o[a],o[i]]=[o[i],o[a]],v(o)},[g,v]),S=(0,o.useCallback)(e=>{let t=g.findIndex(t=>t.id===e);if(t<0)return;let a=g[t];if(e9(a))return;let i=en(a.widgetId);if(!i)return;let o=i.availableSizes??["sm","md","lg"],n=a.size??i.defaultSize,r=o.indexOf(n),s=o[(r+1)%o.length],l=[...g];l[t]={...a,size:s},v(l)},[g,v]),z=(0,o.useMemo)(()=>new Set(g.filter(e=>!e9(e)).map(e=>e.widgetId)),[g]),C=(0,o.useMemo)(()=>new Map,[]);return((0,o.useEffect)(()=>{},[]),f)?(0,i.jsxs)(eO,{children:[(0,i.jsxs)(eK,{children:[(0,i.jsx)(eq,{children:d("widgets.dashboard")}),(0,i.jsxs)(eB,{active:x,onClick:()=>y(!x),children:[(0,i.jsx)(u.In,{name:"plus",size:14}),d("widgets.addWidget")]})]}),(0,i.jsx)(eI,{open:x,activeIds:z,locale:e,onAdd:e=>{$(e)},onRemove:e=>{let t=g.find(t=>!e9(t)&&t.widgetId===e);t&&j(t.id)},onClose:()=>y(!1)}),0===g.length?(0,i.jsxs)(e0,{children:[(0,i.jsx)(e1,{children:"✨"}),(0,i.jsx)(e4,{children:d("widgets.empty.title")}),(0,i.jsx)(e2,{children:d("widgets.empty.body")}),(0,i.jsxs)(e5,{onClick:()=>y(!0),children:[(0,i.jsx)(u.In,{name:"plus",size:14}),d("widgets.empty.cta")]})]}):(0,i.jsx)(eG,{children:g.map((l,c)=>{if(e9(l)){let t=te(l),o="devtools"===t,p=o?{icon:"terminal",label:d("apps.devtools.label"),description:d("apps.devtools.description"),color:"#facc15",category:k("Create",e),hash:"#/playground",needsAuth:!1}:r[t];if(!p)return null;let u=o?null:n.find(e=>e.id===t)??null,m=o?a.filter(e=>e3.has(e)).map(e=>{let t=r[e];return{hash:t?.hash??`#/${e}`,label:t?.label??e,iconName:t?.icon,color:t?.color,ts:0}}):void 0;return(0,i.jsx)(ta,{instance:l,appId:t,meta:p,app:u,locale:e,idx:c,totalCount:g.length,tShell:d,recentsOverride:m,onMove:M,onRemove:j,onSelectApp:s},l.id)}let p=en(l.widgetId);if(!p)return null;let m=l.size??p.defaultSize,h=e6[m],f="full"===h.colSpan,b=f?1:h.colSpan,x=(p.availableSizes??["sm","md","lg"]).length>1;return(0,i.jsxs)(eW,{colSpan:b,fullWidth:f,minH:p.minHeight,accent:p.accentColor,children:[(0,i.jsxs)(eY,{className:"widget-controls",children:[c>0&&(0,i.jsx)(e_,{title:d("widgets.moveLeft"),onClick:()=>M(l.id,-1),children:(0,i.jsx)(u.In,{name:"chevron-left",size:14})}),c<g.length-1&&(0,i.jsx)(e_,{title:d("widgets.moveRight"),onClick:()=>M(l.id,1),children:(0,i.jsx)(u.In,{name:"chevron-right",size:14})}),x&&(0,i.jsx)(e_,{title:d("widgets.cycleSize",{size:m.toUpperCase()}),onClick:()=>S(l.id),children:(0,i.jsx)(e7,{size:m})}),(0,i.jsx)(eV,{title:d("widgets.remove"),onClick:()=>j(l.id),children:(0,i.jsx)(u.In,{name:"close",size:14})})]}),(l=>{if("quicklinks"===l.widgetId)return(0,i.jsx)(es.QuickLinksWidget,{locale:e,pinnedAppIds:t,recentAppIds:a,apps:n,appMeta:r,onSelectApp:s});let d=en(l.widgetId);if(!d)return null;C.has(l.widgetId)||C.set(l.widgetId,(0,o.lazy)(d.load));let c=C.get(l.widgetId);return(0,i.jsx)(o.Suspense,{fallback:null,children:(0,i.jsx)(c,{locale:e})})})(l)]},l.id)})})]}):null}let to={0:"☀️",1:"\uD83C\uDF24️",2:"⛅",3:"☁️",45:"\uD83C\uDF2B️",48:"\uD83C\uDF2B️",51:"\uD83C\uDF26️",53:"\uD83C\uDF26️",55:"\uD83C\uDF27️",61:"\uD83C\uDF27️",63:"\uD83C\uDF27️",65:"\uD83C\uDF27️",71:"\uD83C\uDF28️",73:"\uD83C\uDF28️",75:"\uD83C\uDF28️",80:"\uD83C\uDF26️",81:"\uD83C\uDF27️",82:"\uD83C\uDF27️",95:"⛈️",96:"⛈️",99:"⛈️"},tn={0:"\uD83C\uDF19",1:"\uD83C\uDF19",2:"☁️",3:"☁️"},tr=Object.fromEntries(M.map(e=>[e.id,e.icon])),ts=Object.fromEntries(M.map(e=>[e.id,e.color]));function tl(e){return e<10?`0${e}`:String(e)}function td({locale:e,greeting:t,userName:a,pinnedApps:n,onSelect:r,t:s}){let[l,d]=(0,o.useState)(()=>new Date),{forecast:c}=(0,p.useWeather)({lat:g.j.lisbon.lat,lon:g.j.lisbon.lon,current:"temperature_2m,apparent_temperature,relative_humidity_2m,weather_code,wind_speed_10m,is_day",daily:"temperature_2m_max,temperature_2m_min,sunrise,sunset,uv_index_max",timezone:g.j.lisbon.timezone,cacheKey:"weather-lisbon-v3"});(0,o.useEffect)(()=>{let e=setInterval(()=>d(new Date),3e4);return()=>clearInterval(e)},[]);let m=`${tl(l.getHours())} : ${tl(l.getMinutes())}`,h=(0,o.useMemo)(()=>{let t,a,i;return t=l.toLocaleDateString("pt"===e?"pt-PT":"en-GB",{weekday:"long"}),a=l.getDate(),i=l.toLocaleDateString("pt"===e?"pt-PT":"en-GB",{month:"long"}),`${t} \xb7 ${a} ${i}`.toUpperCase()},[l,e]),f=n.slice(0,5),b=c?.current?(c.current.is_day?to[c.current.weather_code??0]:tn[c.current.weather_code??0]??to[c.current.weather_code??0])??"\xb7":null;return(0,i.jsxs)(tp,{children:[c?.current&&(0,i.jsxs)(tx,{children:[(0,i.jsx)("span",{className:"ico",children:b}),(0,i.jsxs)("span",{className:"temp",children:[Math.round(c.current.temperature_2m??0),"\xb0"]}),(0,i.jsx)("span",{className:"lbl",children:s("retreat.weather.city")})]}),(0,i.jsxs)(tu,{children:[(0,i.jsx)(tm,{children:h}),(0,i.jsxs)(tg,{children:[t,a?(0,i.jsxs)(i.Fragment,{children:[", ",(0,i.jsx)("span",{className:"name",children:a.split(" ")[0]})]}):null,"."]}),(0,i.jsx)(th,{children:m}),(0,i.jsxs)(tf,{"aria-hidden":!0,children:[(0,i.jsx)("span",{className:"caret",children:"⌘K"}),(0,i.jsx)("span",{className:"txt",children:s("retreat.prompt")})]}),f.length>0&&(0,i.jsx)(tb,{children:f.map((e,t)=>(0,i.jsxs)(ty,{onClick:()=>r(e),title:`${t+1} \xb7 ${e.label}`,"aria-label":e.label,children:[(0,i.jsx)("span",{className:"ico",style:{color:ts[e.id]},children:tr[e.id]?(0,i.jsx)(u.In,{name:tr[e.id],size:18,"aria-hidden":"true"}):"\xb7"}),(0,i.jsx)("span",{className:"n",children:t+1})]},e.id))})]})]})}let tc=(0,d.keyframes)`
...
`,tv=l().div`
  ...
  animation: ${tw} 0.25s ${c.w4.transitions.easing} both;
...
`,tL=l().div`
  ...
  color: ${c.w4.colors.mainTextMuted};
  line-height: 1.45;
`;function tF({t:e,onDismiss:t,onOpenPalette:a,onOpenPreferences:o}){let n=[{iconName:"search",titleKey:"onboarding.tip.palette.title",bodyKey:"onboarding.tip.palette.body",kbd:"⌘K",onClick:a},{iconName:"settings",titleKey:"onboarding.tip.preferences.title",bodyKey:"onboarding.tip.preferences.body",onClick:o},{iconName:"check",titleKey:"onboarding.tip.daily.title",bodyKey:"onboarding.tip.daily.body",onClick:()=>{window.location.hash="#/daily"}}];return(0,i.jsxs)(tv,{role:"region","aria-label":e("onboarding.aria"),children:[(0,i.jsxs)(tk,{children:[(0,i.jsxs)(t$,{children:[(0,i.jsx)(u.YZ,{children:e("onboarding.eyebrow")}),(0,i.jsx)(tj,{children:e("onboarding.title")}),(0,i.jsx)(tM,{children:e("onboarding.subtitle")})]}),(0,i.jsx)(tS,{type:"button",title:e("onboarding.dismiss"),"aria-label":e("onboarding.dismiss"),onClick:t,children:(0,i.jsx)(u.In,{name:"close",size:14})})]}),(0,i.jsx)(tz,{children:n.map(t=>(0,i.jsxs)(tC,{type:"button",onClick:t.onClick,disabled:!t.onClick,children:[(0,i.jsx)(tT,{"aria-hidden":!0,children:(0,i.jsx)(u.In,{name:t.iconName,size:18})}),(0,i.jsxs)(tA,{children:[e(t.titleKey),t.kbd&&(0,i.jsx)(u.ue,{children:t.kbd})]}),(0,i.jsx)(tL,{children:e(t.bodyKey)})]},t.titleKey))})]})}let tN=Object.fromEntries(M.map(({id:e,icon:t,labelKey:a,descriptionKey:i,color:o,category:n,suite:r,interest:s,needsAuth:l,hash:d})=>[e,{icon:t,labelKey:a,descriptionKey:i,color:o,category:n,suite:r,interest:s,needsAuth:l,hash:d}])),tP=new Set(M.filter(e=>"default"!==j(e)).map(e=>e.id)),tI=M.filter(e=>e.enabled&&"default"===j(e)),tD=["All","Live","School","Explore","Create","Inspect","Connect","Content","Fun","Lab","Tools"],tR=["AI Lab","Data Studio","Life Dashboard","Learning Hub","Game Room","Entertainment"],tH=tR.filter(e=>tI.some(t=>tN[t.id]?.suite===e));function tE(e,t=new Date){let a=t.getHours();return $(a<12?"greeting.morning":a<19?"greeting.afternoon":"greeting.evening",e)}let tO={0:"☀️",1:"\uD83C\uDF24️",2:"⛅",3:"☁️",45:"\uD83C\uDF2B️",48:"\uD83C\uDF2B️",51:"\uD83C\uDF26️",53:"\uD83C\uDF26️",55:"\uD83C\uDF27️",61:"\uD83C\uDF27️",63:"\uD83C\uDF27️",65:"\uD83C\uDF27️",71:"\uD83C\uDF28️",73:"\uD83C\uDF28️",75:"\uD83C\uDF28️",80:"\uD83C\uDF26️",81:"\uD83C\uDF27️",82:"\uD83C\uDF27️",95:"⛈️",96:"⛈️",99:"⛈️"},tK={0:"\uD83C\uDF19",1:"\uD83C\uDF19",2:"☁️",3:"☁️"},tq=(0,d.keyframes)`
  from { opacity: 0; transform: translateY(8px); }
  to   { opacity: 1; transform: translateY(0); }
`,tB=l().div`
  display: flex;
...
`,tU=l()("nav",{shouldForwardProp:e=>"collapsed"!==e})`
...
`,tJ=l()("button",{shouldForwardProp:e=>"collapsed"!==e})`
  display: flex;
  align-items: center;
  justify-content: space-between;
  width: 100%;
...
`,tQ=l().span`
  ...
  flex-shrink: 0;
`,tZ=l()("div",{shouldForwardProp:e=>"collapsed"!==e})`
  display: grid;
...
`,as=l().button`
  ...
  &:focus-visible { ${c.w4.focusRing} }
`;function al({apps:e,recentAppIds:t,pinnedAppIds:a,onTogglePin:n,onMovePinned:r,onSelect:s,user:l,onSignOut:d,onPreferences:h,onClearData:f,onOpenPalette:b,notifications:y,suites:v}){let j,M,z,[C]=(0,p.useProfile)(),T=(0,o.useMemo)(()=>e.filter(e=>{if(tP.has(e.id))return!1;let t=tN[e.id];return!t||!(0,p.hasInterests)(C)||!t.interest||!!C.interests.includes(t.interest)}),[e,C]),[A,L]=(0,o.useState)("home"),[F,N]=(0,o.useState)("All"),[P,I]=(0,o.useState)(null),[D,R]=(0,o.useState)(()=>new Date),{forecast:H}=(0,p.useWeather)({lat:g.j.lisbon.lat,lon:g.j.lisbon.lon,current:"temperature_2m,apparent_temperature,relative_humidity_2m,weather_code,wind_speed_10m,is_day",daily:"temperature_2m_max,temperature_2m_min,sunrise,sunset,uv_index_max",timezone:g.j.lisbon.timezone,cacheKey:"weather-lisbon-v3"}),[E,O]=(0,o.useState)(!0);(0,o.useEffect)(()=>{let e=!1;return(0,c.PL)("shell:onboarding-dismissed").then(t=>{e||O("true"===t)}).catch(()=>void 0),()=>{e=!0}},[]);let K=(0,o.useCallback)(()=>{O(!0),(0,c.Is)("shell:onboarding-dismissed","true").catch(()=>void 0)},[]);(0,o.useEffect)(()=>{let e=setInterval(()=>R(new Date),6e4),t=()=>{document.hidden||R(new Date)};return document.addEventListener("visibilitychange",t),window.addEventListener("focus",t),()=>{clearInterval(e),document.removeEventListener("visibilitychange",t),window.removeEventListener("focus",t)}},[]);let q=(0,o.useCallback)(()=>{L("home"),N("All"),I(null),(0,c.Is)("shell:home-mode","dashboard")},[]),B=(0,o.useCallback)(()=>{L("retreat"),N("All"),I(null),(0,c.Is)("shell:home-mode","retreat")},[]),G=(0,o.useCallback)(e=>{L("apps"),I(e),N("All")},[]),W=(0,o.useMemo)(()=>({lab:"AI Lab",vida:"Life Dashboard",learn:"Learning Hub",games:"Game Room",ent:"Entertainment"}),[]);(0,o.useEffect)(()=>{let e=()=>{let e=window.location.hash,t=e.indexOf("?");if(t<0)return;let a=new URLSearchParams(e.slice(t+1)).get("suite");if(!a)return;let i=W[a];i&&(L("apps"),I(i),N("All"))};return e(),window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[W]);let[Y,_]=(0,o.useState)(()=>{try{let e=localStorage.getItem("shell:suites-collapsed");return null===e||"true"===e}catch{return!0}}),[V,U]=(0,o.useState)(()=>{try{return"true"===localStorage.getItem("shell:home-sidebar-hidden")}catch{return!1}}),[J]=(0,o.useState)(()=>{try{return"1"===sessionStorage.getItem(eR)}catch{return!1}});(0,o.useEffect)(()=>{let e=!1;return(async()=>{let[t,a,i]=await Promise.all([(0,c.PL)("shell:suites-collapsed"),(0,c.PL)("shell:home-mode"),(0,c.PL)("shell:home-sidebar-hidden")]);if(!e){if(null!==t){_("true"===t);try{localStorage.setItem("shell:suites-collapsed",t)}catch{}}if(null!==i){U("true"===i);try{localStorage.setItem("shell:home-sidebar-hidden",i)}catch{}}J?(L("home"),(0,c.Is)("shell:home-mode","dashboard").catch(()=>void 0)):"retreat"===a&&L("retreat")}})(),()=>{e=!0}},[J]),(0,o.useEffect)(()=>{let e=()=>{L("home"),N("All"),I(null)};return window.addEventListener("atlantis:open-widget-picker",e),()=>window.removeEventListener("atlantis:open-widget-picker",e)},[]);let Q=(0,o.useCallback)(()=>{_(e=>{let t=!e;try{localStorage.setItem("shell:suites-collapsed",String(t))}catch{}return(0,c.Is)("shell:suites-collapsed",String(t)),t})},[]),Z=(0,o.useCallback)(()=>{U(e=>{let t=!e;try{localStorage.setItem("shell:home-sidebar-hidden",String(t))}catch{}return(0,c.Is)("shell:home-sidebar-hidden",String(t)).catch(()=>void 0),t})},[]),[X,ee]=(0,m.Ym)(),et=(0,o.useMemo)(()=>(0,m.Nx)(X,el),[X]),ea=(0,o.useMemo)(()=>{let e={};for(let t of T){let a=tN[t.id];a&&(e[t.id]={icon:a.icon,label:et(a.labelKey),description:et(a.descriptionKey),color:a.color,category:k(a.category,X),hash:a.hash,needsAuth:!!a.needsAuth})}return e},[T,et,X]),ei=(0,o.useMemo)(()=>T.filter(e=>{let t=tN[e.id],i="All"===F||t?.category===F,o=!P||t?.suite===P,n="All"===F&&!P&&a.includes(e.id);return i&&o&&!n}),[T,F,P,a]),eo=(0,o.useMemo)(()=>{if("All"!==F)return null;if(P){let e={};for(let t of ei){let a=tN[t.id]?.category??"Other";e[a]||(e[a]=[]),e[a].push(t)}return{type:"category",groups:e}}let e={};for(let t of ei){let a=tN[t.id]?.suite??"Other";e[a]||(e[a]=[]),e[a].push(t)}return{type:"suite",groups:e}},[ei,F,P]),en=(0,o.useMemo)(()=>{let e={};for(let t of T){let a=tN[t.id]?.suite;a&&(e[a]=(e[a]??0)+1)}return e["AI Lab"]=(e["AI Lab"]??0)+1,e},[T]),er=(0,o.useMemo)(()=>a.flatMap(e=>T.filter(t=>t.id===e)),[a,T]),es=(0,o.useMemo)(()=>t.filter(e=>!a.includes(e)).flatMap(e=>T.filter(t=>t.id===e)).slice(0,6),[t,a,T]),ed=0,ec=(e,t,o)=>{let l=tN[e.id],d=a.includes(e.id),p=l?et(l.descriptionKey):"",m=l?.color??c.w4.colors.accent,g=l?k(l.category,X):"",h=o&&o.total>1?(0,i.jsxs)(i.Fragment,{children:[o.pinIdx>0&&(0,i.jsx)(ai,{type:"button",title:et("pinned.moveLeft"),onClick:t=>{t.stopPropagation(),r(e.id,-1)},children:(0,i.jsx)(u.In,{name:"chevron-left",size:13})}),o.pinIdx<o.total-1&&(0,i.jsx)(ai,{type:"button",title:et("pinned.moveRight"),onClick:t=>{t.stopPropagation(),r(e.id,1)},children:(0,i.jsx)(u.In,{name:"chevron-right",size:13})})]}):void 0;return(0,i.jsx)(u.SV,{vizId:e.id,label:e.label,description:p,hash:l?.hash??e.hash,category:g,accentColor:m,needsAuth:l?.needsAuth,pinned:d,index:t,onClick:()=>s(e),onHoverIntent:()=>x(e.id),onTogglePin:()=>n(e.id),reorderControls:h},e.id)},ep=e=>{let t=a.includes("devtools");return(0,i.jsx)(u.SV,{vizId:"devtools",label:et("apps.devtools.label"),description:et("apps.devtools.description"),hash:"#/playground",category:k("Create",X),accentColor:"#facc15",pinned:t,index:e,onClick:()=>{window.location.hash="#/playground"},onHoverIntent:()=>x("playground"),onTogglePin:()=>n("devtools")})};return(0,i.jsx)(i.Fragment,{children:(0,i.jsxs)(tB,{children:[(0,i.jsxs)(tG,{children:[(0,i.jsx)(tY,{children:(0,i.jsx)(u.K0,{onClick:Z,title:V?et("sidebar.show"):et("sidebar.hide"),"aria-label":V?et("sidebar.show"):et("sidebar.hide"),"aria-pressed":V,children:(0,i.jsx)(u.In,{name:"panel-left",size:16})})}),(0,i.jsxs)(tW,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:[(0,i.jsx)("span",{children:"Atl"}),(0,i.jsx)("span",{className:"logo-accent",children:"antis"})]}),(0,i.jsx)(t_,{children:(0,i.jsx)(u.Yw,{locale:X,onLocaleChange:ee,suites:v,notifications:y,onOpenPalette:b,paletteLabel:et("palette.search"),user:l?{name:l.name,email:l.email,avatarUrl:l.avatarUrl}:void 0,userMenuItems:l?[...h?[{label:et("userMenu.preferences"),icon:(0,i.jsx)(u.In,{name:"user-cog",size:14}),onClick:h}]:[],{label:et("userMenu.settings"),icon:(0,i.jsx)(u.In,{name:"settings",size:14}),onClick:()=>{window.location.hash="#/settings"}},...f?[{label:et("userMenu.clearData"),icon:(0,i.jsx)(u.In,{name:"trash",size:14}),onClick:f,danger:!0}]:[],...d?[{label:et("userMenu.signOut"),icon:(0,i.jsx)(u.In,{name:"log-out",size:14}),onClick:d,danger:!0}]:[]]:[],userMenuControlLabels:{language:et("userMenu.language"),theme:et("userMenu.theme"),themeLight:et("userMenu.themeLight"),themeDark:et("userMenu.themeDark"),themeSystem:et("userMenu.themeSystem")},onSignIn:()=>{window.location.hash="#/home"}})})]}),(0,i.jsxs)(tV,{children:[(0,i.jsxs)(tU,{collapsed:V,children:[(0,i.jsx)(t1,{active:"home"===A,onClick:q,children:(0,i.jsxs)("span",{style:{display:"flex",alignItems:"center",gap:"8px"},children:[(0,i.jsx)(u.In,{name:"home",size:14}),et("sidebar.home")]})}),(0,i.jsx)(t1,{active:"retreat"===A,onClick:B,children:(0,i.jsxs)("span",{style:{display:"flex",alignItems:"center",gap:"8px"},children:[(0,i.jsx)(u.In,{name:"moon",size:14}),et("sidebar.retreat")]})}),(0,i.jsx)(t2,{}),tH.length>0&&(0,i.jsxs)(i.Fragment,{children:[Y?(0,i.jsx)(t0,{type:"button",onClick:Q,children:et("sidebar.showSuites")}):(0,i.jsxs)(i.Fragment,{children:[(0,i.jsxs)(tJ,{onClick:Q,children:[$("suites",X),(0,i.jsx)(tQ,{collapsed:Y,children:(0,i.jsx)(u.In,{name:"chevron-down",size:14})})]}),(0,i.jsx)(tZ,{collapsed:Y,children:(0,i.jsx)(tX,{children:tH.map(e=>{let t,a=(t=S.find(t=>t.yamlSuite===e))?{icon:t.icon,color:t.color}:void 0,o="apps"===A&&P===e;return(0,i.jsxs)(t1,{active:o,onClick:()=>G(e),children:[a&&(0,i.jsx)("span",{style:{display:"inline-flex",color:o?c.w4.colors.accent:a.color,flexShrink:0},children:(0,i.jsx)(u.In,{name:a.icon,size:16,"aria-hidden":"true"})}),(0,i.jsx)("span",{style:{flex:1,textAlign:"left"},children:w[e]?.[X]??e}),(0,i.jsx)(t4,{active:o,children:en[e]??0})]},e)})})})]}),(0,i.jsx)(t2,{})]})]}),(0,i.jsx)(t5,{bleed:"retreat"===A,children:"retreat"===A?(0,i.jsx)(td,{locale:X,greeting:tE(X,D),userName:l?.name,pinnedApps:er,onSelect:s,t:et}):(0,i.jsxs)(i.Fragment,{children:[(0,i.jsxs)(t3,{children:[(0,i.jsxs)(t8,{children:[(0,i.jsx)(t6,{children:(j=D.toLocaleDateString("pt"===X?"pt-PT":"en-GB",{weekday:"long"}),M=D.getDate(),z=D.toLocaleDateString("pt"===X?"pt-PT":"en-GB",{month:"long"}),`${j} \xb7 ${M} ${z}`.toUpperCase())}),H?.current&&(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(t7,{children:"\xb7"}),(0,i.jsxs)(t9,{children:[(0,i.jsx)("span",{className:"ico",children:(H.current.is_day?tO[H.current.weather_code??0]:tK[H.current.weather_code??0]??tO[H.current.weather_code??0])??"\xb7"}),(0,i.jsxs)("span",{className:"temp",children:[Math.round(H.current.temperature_2m??0),"\xb0"]}),(0,i.jsx)("span",{className:"lbl",children:$("home.weather.city",X)})]})]})]}),(0,i.jsxs)(ae,{children:[tE(X,D),l?.name?(0,i.jsxs)(i.Fragment,{children:[", ",(0,i.jsx)("span",{className:"accent",children:l.name.split(" ")[0]})]}):null,"."]})]}),"home"===A&&!E&&0===er.length&&0===es.length&&(0,i.jsx)(tF,{t:et,onDismiss:K,onOpenPalette:b,onOpenPreferences:h}),"home"===A&&(0,i.jsx)(ti,{locale:X,pinnedAppIds:a,recentAppIds:t,apps:T,appMeta:ea,onSelectApp:s,onTogglePin:n}),"apps"===A&&(0,i.jsxs)(i.Fragment,{children:[0===ei.length&&(null!==P||"All"!==F||(0,p.hasInterests)(C))&&(0,i.jsxs)(ao,{children:[(0,i.jsx)(an,{children:$("home.emptyFiltered.title",X)}),(0,i.jsx)(ar,{children:$("home.emptyFiltered.desc",X)}),(0,i.jsxs)("div",{style:{display:"flex",gap:c.w4.spacing.sm},children:[(null!==P||"All"!==F)&&(0,i.jsx)(as,{type:"button",onClick:()=>{I(null),N("All")},style:{background:"transparent",color:c.w4.colors.accent,border:`1px solid ${c.w4.colors.border}`},children:$("home.emptyFiltered.clear",X)}),h&&(0,i.jsx)(as,{type:"button",onClick:h,children:$("home.emptyFiltered.cta",X)})]})]}),"All"===F&&!P&&er.length>0&&(0,i.jsxs)("div",{children:[(0,i.jsx)(at,{children:$("pinned",X)}),(0,i.jsx)(aa,{children:er.map((e,t)=>ec(e,ed++,{pinIdx:t,total:er.length}))})]}),"All"===F&&!P&&es.length>0&&(0,i.jsxs)("div",{children:[(0,i.jsx)(at,{children:$("recentlyUsed",X)}),(0,i.jsx)(aa,{children:es.map(e=>ec(e,ed++))})]}),eo?[..."suite"===eo.type?tR:tD.slice(1),"Other"].filter(e=>eo.groups[e]?.length>0).map(e=>(0,i.jsxs)("div",{children:[(0,i.jsx)(at,{children:"suite"===eo.type?w[e]?.[X]??e:k(e,X)}),(0,i.jsxs)(aa,{children:[eo.groups[e].map(e=>ec(e,ed++)),("suite"===eo.type&&"AI Lab"===e||"category"===eo.type&&"Lab"===e)&&ep(ed++)]})]},e)):(0,i.jsxs)(aa,{children:[ei.map(e=>ec(e,ed++)),"Lab"===F&&ep(ed++)]})]})]})})]})]})})}let ad=(0,a(82791).U)("https://eqvzakschpdemcgexjyy.supabase.co","sb_publishable_D_UOsNIA7qD3929ZzReWLw_k8d8MxWL");function ac(){return ad.auth.signInWithOAuth({provider:"google",options:{redirectTo:window.location.origin}})}function ap(){return ad.auth.signOut()}let au=(0,d.keyframes)`
...
`,ay=()=>(0,i.jsxs)("svg",{width:"18",height:"18",viewBox:"0 0 48 48",children:[(0,i.jsx)("path",{fill:"#EA4335",d:"M24 9.5c3.14 0 5.95 1.08 8.17 2.86l6.1-6.1C34.46 3.19 29.53 1 24 1 14.82 1 7.07 6.48 3.88 14.22l7.1 5.52C12.68 13.55 17.9 9.5 24 9.5z"}),(0,i.jsx)("path",{fill:"#4285F4",d:"M46.52 24.5c0-1.64-.15-3.22-.42-4.75H24v9h12.67c-.55 2.94-2.18 5.44-4.65 7.12l7.19 5.59C43.39 37.48 46.52 31.47 46.52 24.5z"}),(0,i.jsx)("path",{fill:"#FBBC05",d:"M10.98 28.26A14.57 14.57 0 0 1 9.5 24c0-1.48.25-2.91.68-4.26l-7.1-5.52A23.93 23.93 0 0 0 .5 24c0 3.87.93 7.52 2.58 10.74l7.9-6.48z"}),(0,i.jsx)("path",{fill:"#34A853",d:"M24 47c5.52 0 10.15-1.83 13.53-4.97l-7.19-5.59C28.47 37.82 26.36 38.5 24 38.5c-6.1 0-11.32-4.05-13.02-9.74l-7.9 6.48C6.07 42.54 14.45 47 24 47z"})]}),aw=l().button`
  background: none;
  border: none;
  color: ${c.w4.colors.mainTextMuted};
  font-family: ${c.w4.typography.fontFamily};
...
`,aB=l().div`
  ...
  justify-content: center;
  padding-top: 10vh;
  animation: ${aK} ${c.w4.transitions.fast};
...
`,aG=l().div`
  ...
  overflow: hidden;
  box-shadow: ${c.w4.elevation.lg};
  animation: ${aq} ${c.w4.transitions.base};
  font-family: ${c.w4.typography.fontFamily};
  color: ${c.w4.colors.mainText};
  display: flex;
  flex-direction: column;
...
`,a1=l()("div",{shouldForwardProp:e=>"tintColor"!==e&&"selected"!==e})`
  width: 36px;
  height: 36px;
  border-radius: 9px;
  display: flex;
  ...
  transition: ${c.w4.transitions.fast};
`,a4=l()("div",{shouldForwardProp:e=>"tintColor"!==e})`
  width: 36px;
  height: 36px;
  border-radius: 9px;
...
`,a2=l().div`
  ...
  background: transparent;
  flex-shrink: 0;
`,a5=l()("div",{shouldForwardProp:e=>"tintColor"!==e})`
  width: 36px;
  height: 36px;
  border-radius: 9px;
  display: flex;
...
`,a3=l().div`
  flex: 1;
  min-width: 0;
`,a8=l()("div",{shouldForwardProp:e=>"selected"!==e})`
  font-size: 14px;
  font-weight: 500;
...
`,ib=l().span`
  ...
  font-size: 11px;
  color: ${c.w4.colors.mainTextMuted};
`;function ix(e,t){if(!t)return!0;let a=t.toLowerCase();return e.label.toLowerCase().includes(a)||(e.meta?.toLowerCase().includes(a)??!1)}function iy({apps:e,recentIds:t,suites:a=[],games:r=[],actions:s=[],hasAsk:l=!1,groqKey:d,locale:g,initialScope:h,onNavigate:f,onClose:b}){let x=(0,o.useMemo)(()=>(0,m.Nx)(g,el),[g]),[y,w]=(0,o.useState)(""),[v,k]=(0,o.useState)(()=>"ask"!==h||l?h??"all":"all"),[$,j]=(0,o.useState)(0),[M,S]=(0,o.useState)([]),[z,C]=(0,o.useState)(!1),T=(0,o.useRef)([]),A=(0,o.useRef)(null),L=(0,o.useRef)(null),F=(0,o.useRef)(null),N=(0,o.useRef)(null),[P,I]=(0,o.useState)([]),D=(0,o.useRef)(null);(0,o.useEffect)(()=>{if("ask"!==v)return(null!==D.current&&clearTimeout(D.current),y.trim())?(D.current=setTimeout(()=>{aE(y).then(I)},200),()=>{null!==D.current&&clearTimeout(D.current)}):void I([])},[y,v]),(0,o.useEffect)(()=>(A.current?.focus(),()=>{N.current?.abort()}),[]),(0,o.useEffect)(()=>{T.current=M},[M]),(0,o.useEffect)(()=>{F.current?.scrollIntoView({behavior:"smooth"})},[M,z]);let R=(0,o.useMemo)(()=>{let i=new Set(t),o=e.map(e=>({id:`app:${e.id}`,kind:"app",label:e.label,meta:e.description,isRecent:i.has(e.id),appIcon:{iconName:e.icon,color:e.color},onConfirm:()=>{f(e.hash),b()}}));return[...a.map(e=>({id:`suite:${e.id}`,kind:"suite",label:e.name,meta:e.sub,glyphIcon:{iconName:e.iconName,color:e.color},shortcut:e.shortcut,onConfirm:()=>{e.onConfirm(),b()}})),...o,...r.map(e=>({id:`game:${e.id}`,kind:"game",label:e.name,meta:x("palette.meta.game"),gameGlyph:{iconName:e.iconName,color:e.color},hash:e.hash,onConfirm:()=>{f(e.hash),b()}})),...s.map(e=>({id:`action:${e.id}`,kind:"action",label:e.label,meta:e.meta,glyphIcon:{iconName:e.iconName,color:e.color??c.w4.colors.accent},shortcut:e.shortcut,onConfirm:()=>{e.onClick(),b()}}))]},[e,a,r,s,t,f,b,x]),H=(0,o.useMemo)(()=>P.map(e=>({id:e.id,kind:"action",label:e.label,meta:e.subtitle,glyphIcon:e.iconName?{iconName:e.iconName,color:c.w4.colors.mainTextMuted}:void 0,hash:e.hash,onConfirm:()=>{f(e.hash),b()}})),[P,f,b]),E=(0,o.useMemo)(()=>{if("ask"===v)return[];let e=R.filter(e=>ix(e,y)),a=[],i=(e,t,i)=>{if(0!==i.length)for(let o of(a.push({kind:"header",label:x(t),key:e,count:i.length}),i))a.push({kind:"item",item:o})};return"recent"===v?i("recent","palette.recent",R.filter(e=>"app"===e.kind&&e.isRecent&&ix(e,y)).sort((e,a)=>t.indexOf(e.id.slice(4))-t.indexOf(a.id.slice(4)))):"jump"===v?(i("suites","palette.section.suites",e.filter(e=>"suite"===e.kind)),i("apps","palette.section.apps",e.filter(e=>"app"===e.kind)),i("games","palette.section.games",e.filter(e=>"game"===e.kind))):"actions"===v?(i("actions","palette.section.actions",e.filter(e=>"action"===e.kind)),i("content","palette.section.content",H)):(i("jump","palette.section.jump",e.filter(e=>"suite"===e.kind||"app"===e.kind||"game"===e.kind)),i("actions","palette.section.actions",e.filter(e=>"action"===e.kind)),i("content","palette.section.content",H),l&&d&&i("ask","palette.section.ask",aO.map((e,t)=>({id:`suggest:${t}`,kind:"suggest",label:x(e),meta:x("palette.ask.suggestMeta"),shortcut:["↵"],onConfirm:()=>{k("ask"),setTimeout(()=>{K(x(e))},0)}})))),a},[v,y,R,t,x,l,d,H]),O=(0,o.useMemo)(()=>E.filter(e=>"item"===e.kind),[E]);(0,o.useEffect)(()=>{j(0)},[v,y]),(0,o.useEffect)(()=>{let e=L.current;if(!e)return;let t=e.querySelectorAll("[data-selectable]");t[$]?.scrollIntoView({block:"nearest"})},[$]);let K=(0,o.useCallback)(async e=>{if(!d||!e.trim())return;let t=e.trim(),a=`turn-${Date.now()}`;S(e=>[...e,{id:a,question:t}]),C(!0),w("");let i=[];for(let e of T.current)e.answer&&(i.push({role:"user",content:e.question}),i.push({role:"assistant",content:e.answer}));N.current?.abort();let o=new AbortController;N.current=o;try{let e=await (0,p.askGroq)(t,{key:d,locale:"pt"===g?"pt":"en",signal:o.signal,history:i});o.signal.aborted||S(t=>t.map(t=>t.id===a?{...t,answer:e}:t))}catch(t){if(o.signal.aborted)return;let e=t instanceof Error?t.message:String(t);S(t=>t.map(t=>t.id===a?{...t,error:e}:t))}finally{o.signal.aborted||C(!1)}},[d,g]),q=(0,o.useCallback)(e=>{if("Escape"===e.key){if("ask"===v&&y.trim())return void w("");if("ask"===v&&M.length>0){N.current?.abort(),C(!1),S([]);return}return void b()}if("ask"===v){"Enter"===e.key&&y.trim()&&(e.preventDefault(),K(y.trim()));return}if("ArrowDown"===e.key)e.preventDefault(),j(e=>Math.min(e+1,O.length-1));else if("ArrowUp"===e.key)e.preventDefault(),j(e=>Math.max(e-1,0));else if("Enter"===e.key){let e=O[$];e&&e.item.onConfirm()}},[v,y,M.length,O,$,b,K]),B=(0,o.useCallback)(e=>{e.target===e.currentTarget&&b()},[b]),G="ask"===v?M.length>0?x("palette.ask.followUp"):x("palette.ask.placeholder"):x("palette.placeholder"),W=(0,o.useMemo)(()=>{let e=[{value:"all",label:x("palette.scope.all")},{value:"jump",label:x("palette.scope.jump")},{value:"actions",label:x("palette.scope.actions")}];return l&&d&&e.push({value:"ask",label:x("palette.scope.ask"),highlight:!0}),e.push({value:"recent",label:x("palette.scope.recent")}),e},[x,l,d]),Y=-1;return ec().createPortal((0,i.jsx)(aB,{onClick:B,children:(0,i.jsxs)(aG,{onClick:e=>e.stopPropagation(),children:[(0,i.jsxs)(aW,{children:[(0,i.jsx)(aY,{active:"ask"===v,children:(0,i.jsx)(u.In,{name:"ask"===v?"sparkle":"search",size:20,"aria-hidden":"true"})}),(0,i.jsx)(a_,{ref:A,placeholder:G,value:y,onChange:e=>w(e.target.value),onKeyDown:q,"aria-label":x("palette.search")}),(0,i.jsx)(aV,{children:"esc"})]}),(0,i.jsx)(aU,{children:(0,i.jsx)(u.tU,{tabs:W,value:v,onChange:k,"aria-label":x("palette.scope.ariaLabel")})}),"ask"===v?(0,i.jsx)(it,{children:0!==M.length||z?(0,i.jsxs)(is,{children:[M.map(e=>(0,i.jsxs)(n().Fragment,{children:[(0,i.jsxs)(il,{children:[(0,i.jsx)(id,{children:x("palette.ask.you")}),(0,i.jsx)(ic,{children:e.question})]}),(0,i.jsxs)(il,{children:[(0,i.jsx)(id,{children:x("palette.ask.atlantis")}),void 0!==e.answer?(0,i.jsx)(u.mQ,{children:e.answer}):void 0!==e.error?(0,i.jsx)(im,{children:e.error}):(0,i.jsxs)(iu,{"aria-label":x("palette.ask.thinking"),children:[(0,i.jsx)("span",{}),(0,i.jsx)("span",{}),(0,i.jsx)("span",{})]})]})]},e.id)),(0,i.jsx)("div",{ref:F})]}):(0,i.jsxs)(ia,{children:[(0,i.jsx)(ii,{children:x("palette.ask.suggestionsTitle")}),(0,i.jsx)(io,{children:aO.map(e=>(0,i.jsx)(ir,{onClick:()=>{K(x(e))},type:"button",children:x(e)},e))}),(0,i.jsx)(ii,{style:{marginTop:4},children:x("palette.ask.hint")})]})}):(0,i.jsx)(aJ,{ref:L,children:0===O.length?(0,i.jsxs)(ig,{children:[(0,i.jsx)("div",{className:"icon",children:(0,i.jsx)(u.In,{name:"search",size:16,"aria-hidden":"true"})}),(0,i.jsxs)("div",{className:"title",children:[x("palette.noMatch")," ",y&&(0,i.jsxs)("span",{className:"query",children:["“",y,"”"]})]}),(0,i.jsx)("div",{className:"hint",children:x("palette.emptyHint")})]}):E.map((e,t)=>{if("header"===e.kind)return(0,i.jsxs)(aQ,{children:[(0,i.jsx)(aZ,{children:e.label}),(0,i.jsx)(aX,{children:e.count})]},`h-${e.key}`);let a=Y+=1,o=a===$,n=e.item;return(0,i.jsxs)(a0,{selected:o,"data-selectable":!0,onMouseEnter:()=>j(a),onClick:()=>n.onConfirm(),children:[n.appIcon&&(0,i.jsx)(a1,{tintColor:n.appIcon.color,selected:o,children:(0,i.jsx)(u.In,{name:n.appIcon.iconName,size:18,"aria-hidden":"true",color:n.appIcon.color})}),n.glyphIcon&&(0,i.jsx)(a4,{tintColor:n.glyphIcon.color,children:(0,i.jsx)(u.In,{name:n.glyphIcon.iconName,size:18,"aria-hidden":"true"})}),n.gameGlyph&&(0,i.jsx)(a5,{tintColor:n.gameGlyph.color,children:(0,i.jsx)(u.In,{name:n.gameGlyph.iconName,size:18,"aria-hidden":"true",color:n.gameGlyph.color})}),"suggest"===n.kind&&(0,i.jsx)(a2,{children:(0,i.jsx)(u.In,{name:"sparkle",size:18,"aria-hidden":"true"})}),(0,i.jsxs)(a3,{children:[(0,i.jsx)(a8,{selected:o,children:n.label}),n.meta&&(0,i.jsx)(a6,{children:n.meta})]}),n.hash&&(0,i.jsx)(a7,{children:n.hash}),n.shortcut&&n.shortcut.length>0&&(0,i.jsx)(a9,{children:n.shortcut.map((e,t)=>(0,i.jsx)(ie,{children:e},t))})]},n.id+"-"+t)})}),(0,i.jsx)(ih,{children:"ask"===v?(0,i.jsxs)(i.Fragment,{children:[(0,i.jsxs)(ib,{children:[(0,i.jsx)(ie,{children:"↵"}),x("palette.hint.ask")]}),(0,i.jsxs)(ib,{children:[(0,i.jsx)(ie,{children:"esc"}),x("palette.hint.close")]})]}):(0,i.jsxs)(i.Fragment,{children:[(0,i.jsxs)(ib,{children:[(0,i.jsx)(ie,{children:"↑"}),(0,i.jsx)(ie,{children:"↓"}),x("palette.hint.navigate")]}),(0,i.jsxs)(ib,{children:[(0,i.jsx)(ie,{children:"↵"}),x("palette.hint.open")]}),(0,i.jsxs)(ib,{children:[(0,i.jsx)(ie,{children:"esc"}),x("palette.hint.close")]})]})})]})}),document.body)}let iw="shell:cmdk-hint-dismissed",iv=(0,d.keyframes)`
  from { opacity: 0; transform: translateY(6px); }
  to   { opacity: 1; transform: translateY(0); }
`,ik=l().div`
  position: fixed;
  ...
  overflow: hidden;
  animation: ${iv} 0.25s ${c.w4.transitions.easing} both;
  animation-delay: 1s;
  transition:
    border-color ${c.w4.transitions.fast},
    transform ${c.w4.transitions.fast};
...
`,ij=l().button`
  ...
  &:hover { color: ${c.w4.colors.mainText}; }
  &:focus-visible { ${c.w4.focusRing} }
`;function iM({onOpenPalette:e,t}){let[a,n]=(0,o.useState)(()=>{try{return"1"===localStorage.getItem(iw)}catch{return!1}});return((0,o.useEffect)(()=>{let e=e=>{e.key===iw&&n("1"===e.newValue)};return window.addEventListener("storage",e),()=>window.removeEventListener("storage",e)},[]),a)?null:ec().createPortal((0,i.jsxs)(ik,{children:[(0,i.jsxs)(i$,{type:"button","aria-label":t("cmdk.hint.aria"),onClick:e,children:[(0,i.jsx)(u.ue,{children:"⌘K"}),(0,i.jsx)("span",{className:"hint-label",children:t("cmdk.hint.label")})]}),(0,i.jsx)(ij,{type:"button",className:"dismiss","aria-label":t("cmdk.hint.dismiss"),title:t("cmdk.hint.dismiss"),onClick:e=>{e.stopPropagation();try{localStorage.setItem(iw,"1")}catch{}n(!0)},children:"\xd7"})]}),document.body)}var iS=a(1310);let iz=(0,d.keyframes)`
...
`,os=[{id:"groq",label:"Groq",placeholder:"gsk_...",help:"Used by Prompt Lab and Image Gen (enhance)",linkUrl:"https://console.groq.com/keys",linkLabel:"Get key"},{id:"gemini",label:"Google Gemini",placeholder:"AIza...",help:"Used by Prompt Lab",linkUrl:"https://aistudio.google.com/apikey",linkLabel:"Get key"},{id:"finnhub",label:"Finnhub",placeholder:"pk_...",help:"Stock quotes for the Markets widget",linkUrl:"https://finnhub.io/dashboard",linkLabel:"Get key"},{id:"tmdb",label:"TMDB (The Movie Database)",placeholder:"eyJhbGci...",help:"Movies & Series app — Read Access Token (v4 auth)",linkUrl:"https://www.themoviedb.org/settings/api",linkLabel:"Get key"},{id:"youtube",label:"YouTube Data API v3",placeholder:"AIza...",help:"YouTube Safe Feed app — free quota, no billing required",linkUrl:"https://console.cloud.google.com/apis/credentials",linkLabel:"Get key"}],ol="atlantis:api-keys",od="atlantis:promptlab:keys",oc=[{widgetId:"shell",ruleId:"sync.error",labelKey:"notifications.source.syncError",defaultEnabled:!0},{widgetId:"shell",ruleId:"daily.achievement",labelKey:"notifications.source.dailyAchievement",defaultEnabled:!0},{widgetId:"shell",ruleId:"finance.budget",labelKey:"notifications.source.financeBudget",defaultEnabled:!0}],op={groq:"",gemini:"",finnhub:"",tmdb:"",youtube:""};function ou(e,t){return`notifications:${e}:${t}:enabled`}function om({lang:e}){let[t,a]=(0,o.useState)(op),[n,r]=(0,o.useState)({}),[s,l]=(0,o.useState)(!1),[d,g]=(0,o.useState)(!1),[h,f]=(0,o.useState)({}),[b,x]=(0,o.useState)([]),[y,w]=(0,o.useState)({muteAll:!1,windows:[]}),[v,k]=(0,o.useState)([]),$=(0,o.useMemo)(()=>(0,m.Nx)(e,el),[e]),j="pt"===e;(0,o.useEffect)(()=>{let e=function(){try{let e=localStorage.getItem(ol);if(e)return{...op,...JSON.parse(e)};let t=localStorage.getItem(od);if(t)return{...op,...JSON.parse(t)}}catch{}return{...op}}();a(e),(0,c.PL)(ol).then(t=>{if(t)try{let i={...op,...JSON.parse(t)},o={groq:e.groq||i.groq,gemini:e.gemini||i.gemini,finnhub:e.finnhub||i.finnhub,tmdb:e.tmdb||i.tmdb,youtube:e.youtube||i.youtube};a(o)}catch{}}),(0,p.loadSchedule)().then(e=>w(e)),(0,c.PL)("shell:dashboard-widgets").then(async e=>{let t=[];try{e&&(t=JSON.parse(e))}catch{}let a=new Set(t.map(e=>e.widgetId)),i=eo.filter(e=>a.has(e.id)&&e.notifications&&e.notifications.length>0);x(i);let o=i.flatMap(e=>(e.notifications??[]).map(e=>e.category)),n=oc.map(e=>e.ruleId),r=new Set,s=[];for(let e of[...o,...n])r.has(e)||(r.add(e),s.push(e));k(s);let l={};await Promise.all(i.flatMap(e=>(e.notifications??[]).map(async t=>{let a=ou(e.id,t.id),i=await (0,c.PL)(a),o=!1!==t.defaultEnabled;l[`${e.id}:${t.id}`]=null===i?o:"false"!==i}))),await Promise.all(oc.map(async e=>{let t=ou(e.widgetId,e.ruleId),a=await (0,c.PL)(t);l[`${e.widgetId}:${e.ruleId}`]=null===a?e.defaultEnabled:"false"!==a})),f(l)})},[]);let M=(0,o.useCallback)((e,t)=>{a(a=>({...a,[e]:t})),g(!0),l(!1)},[]),S=(0,o.useCallback)(e=>{a(t=>({...t,[e]:""})),g(!0),l(!1)},[]),z=(0,o.useCallback)(()=>{let e;e=JSON.stringify(t),localStorage.setItem(ol,e),localStorage.setItem(od,e),(0,c.Is)(ol,e),g(!1),l(!0),setTimeout(()=>l(!1),2500)},[t]),C=(0,o.useCallback)((e,t,a)=>{let i=`${e}:${t}`;f(e=>({...e,[i]:a})),(0,c.Is)(ou(e,t),a?"true":"false")},[]),T=(0,o.useCallback)(e=>{let t={...y,muteAll:e};w(t),(0,p.saveSchedule)(t)},[y]),A=(0,o.useCallback)(()=>{let e={...y,windows:[...y.windows,{categoryId:"*",start:"22:00",end:"08:00"}]};w(e),(0,p.saveSchedule)(e)},[y]),L=(0,o.useCallback)(e=>{let t={...y,windows:y.windows.filter((t,a)=>a!==e)};w(t),(0,p.saveSchedule)(t)},[y]),F=(0,o.useCallback)((e,t)=>{let a={...y,windows:y.windows.map((a,i)=>i===e?{...a,...t}:a)};w(a),(0,p.saveSchedule)(a)},[y]),N=(0,o.useCallback)(e=>{if("*"===e)return $("notifications.settings.quietHours.global");for(let t of b)for(let a of t.notifications??[])if(a.category===e&&a.labelKey)return $(a.labelKey);for(let t of oc)if(t.ruleId===e)return $(t.labelKey);return e},[$,b]);return(0,i.jsx)(iC,{children:(0,i.jsxs)(iT,{children:[(0,i.jsxs)(iA,{children:[(0,i.jsx)(iL,{children:j?"Defini\xe7\xf5es":"Settings"}),(0,i.jsx)(iF,{children:j?"Gere as tuas chaves de API para os servi\xe7os de IA. As chaves s\xe3o guardadas no teu browser e sincronizadas com a tua conta.":"Manage your API keys for AI services. Keys are stored in your browser and synced with your account."})]}),(0,i.jsxs)(iN,{children:[(0,i.jsxs)(iP,{children:[(0,i.jsx)(u.In,{name:"key",size:16}),j?"Chaves de API":"API Keys"]}),(0,i.jsx)(iI,{children:j?"Estas chaves s\xe3o usadas pelo Prompt Lab e Image Gen. Cada servi\xe7o tem um plano gratuito.":"These keys are used by Prompt Lab and Image Gen. Each service has a free tier."}),os.map(e=>{let a=t[e.id],o=n[e.id]??!1;return(0,i.jsxs)(iD,{children:[(0,i.jsxs)(iR,{children:[e.label,(0,i.jsx)(iH,{active:!!a,children:a?j?"ativa":"active":j?"vazia":"empty"}),(0,i.jsxs)(iE,{children:["— ",e.help]})]}),(0,i.jsxs)(iO,{children:[(0,i.jsxs)(iK,{children:[(0,i.jsx)(iq,{type:o?"text":"password",value:a,onChange:t=>M(e.id,t.target.value),placeholder:e.placeholder,spellCheck:!1,autoComplete:"off"}),(0,i.jsx)(iB,{onClick:()=>r(t=>({...t,[e.id]:!o})),title:o?"Hide":"Show",children:o?(0,i.jsx)(u.In,{name:"eye-off",size:13}):(0,i.jsx)(u.In,{name:"eye",size:13})})]}),(0,i.jsx)(iG,{danger:!0,onClick:()=>S(e.id),title:j?"Limpar":"Clear",children:(0,i.jsx)(u.In,{name:"trash",size:13})}),(0,i.jsx)("a",{href:e.linkUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:(0,i.jsx)(iG,{title:e.linkLabel,children:(0,i.jsx)(u.In,{name:"external-link",size:13})})})]})]},e.id)}),(0,i.jsxs)(iW,{children:[s?(0,i.jsx)(i_,{children:j?"✓ Guardado":"✓ Saved"}):(0,i.jsx)("span",{}),(0,i.jsxs)(iY,{onClick:z,disabled:!d,children:[(0,i.jsx)(u.In,{name:"save",size:13}),j?"Guardar":"Save"]})]})]}),(0,i.jsxs)(iN,{children:[(0,i.jsxs)(iP,{children:[(0,i.jsx)(u.In,{name:"bell",size:16}),$("notifications.settings.title")]}),(0,i.jsx)(iI,{children:$("notifications.settings.desc")}),(0,i.jsxs)(i2,{children:[(0,i.jsxs)(i5,{children:[(0,i.jsx)(i3,{children:$("notifications.settings.muteAll")}),(0,i.jsx)(i8,{children:$("notifications.settings.muteAll.desc")})]}),(0,i.jsxs)(i1,{checked:y.muteAll,onClick:()=>T(!y.muteAll),title:$("notifications.settings.muteAll"),children:[(0,i.jsx)("input",{type:"checkbox",checked:y.muteAll,onChange:()=>{},"aria-label":$("notifications.settings.muteAll")}),(0,i.jsx)("span",{className:"track"}),(0,i.jsx)("span",{className:"thumb"})]})]}),0===b.length?(0,i.jsx)(i4,{style:{marginTop:"16px"},children:$("notifications.settings.noWidgets")}):b.map(t=>(0,i.jsxs)(iU,{children:[(0,i.jsxs)(iJ,{children:[(0,i.jsx)(iQ,{children:t.icon}),(0,i.jsx)(iZ,{children:"pt"===e?t.labels.pt:t.labels.en})]}),(t.notifications??[]).map(e=>{let a=`${t.id}:${e.id}`,o=!1!==e.defaultEnabled,n=h[a]??o,r=e.labelKey?$(e.labelKey):e.category;return(0,i.jsxs)(iX,{children:[(0,i.jsx)(i0,{className:"rule-label",children:r}),(0,i.jsxs)(i1,{checked:n,onClick:()=>C(t.id,e.id,!n),title:$("notifications.settings.enable"),children:[(0,i.jsx)("input",{type:"checkbox",checked:n,onChange:()=>{},"aria-label":r}),(0,i.jsx)("span",{className:"track"}),(0,i.jsx)("span",{className:"thumb"})]})]},e.id)})]},t.id)),(0,i.jsxs)(iU,{style:{marginTop:"12px"},children:[(0,i.jsxs)(iJ,{children:[(0,i.jsx)(iQ,{children:"\uD83D\uDD14"}),(0,i.jsx)(iZ,{children:$("notifications.settings.shell.title")})]}),(0,i.jsx)("div",{style:{fontSize:"11px",fontFamily:c.w4.typography.fontFamilyMono,color:c.w4.colors.mainTextMuted,marginBottom:"4px"},children:$("notifications.settings.shell.desc")}),oc.map(e=>{let t=h[`${e.widgetId}:${e.ruleId}`]??e.defaultEnabled,a=$(e.labelKey);return(0,i.jsxs)(iX,{children:[(0,i.jsx)(i0,{className:"rule-label",children:a}),(0,i.jsxs)(i1,{checked:t,onClick:()=>C(e.widgetId,e.ruleId,!t),title:$("notifications.settings.enable"),children:[(0,i.jsx)("input",{type:"checkbox",checked:t,onChange:()=>{},"aria-label":a}),(0,i.jsx)("span",{className:"track"}),(0,i.jsx)("span",{className:"thumb"})]})]},e.ruleId)})]}),(0,i.jsxs)(i6,{children:[(0,i.jsx)(i7,{children:$("notifications.settings.quietHours")}),(0,i.jsx)(i9,{children:$("notifications.settings.quietHours.desc")}),y.windows.map((e,t)=>(0,i.jsxs)(oe,{children:[(0,i.jsxs)(oi,{value:e.categoryId,onChange:e=>F(t,{categoryId:e.target.value}),"aria-label":$("notifications.settings.quietHours.category"),children:[(0,i.jsx)("option",{value:"*",children:$("notifications.settings.quietHours.global")}),v.map(e=>(0,i.jsx)("option",{value:e,children:N(e)},e))]}),(0,i.jsxs)(oo,{children:[(0,i.jsx)("input",{type:"checkbox",checked:e.allDay??!1,onChange:e=>F(t,{allDay:e.target.checked})}),$("notifications.settings.quietHours.allDay")]}),!e.allDay&&(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(ot,{children:$("notifications.settings.quietHours.from")}),(0,i.jsx)(oa,{type:"time",value:e.start,onChange:e=>F(t,{start:e.target.value})}),(0,i.jsx)(ot,{children:$("notifications.settings.quietHours.to")}),(0,i.jsx)(oa,{type:"time",value:e.end,onChange:e=>F(t,{end:e.target.value})})]}),(0,i.jsx)(or,{type:"button",title:$("notifications.settings.quietHours.remove"),onClick:()=>L(t),children:(0,i.jsx)(u.In,{name:"close",size:13})})]},t)),(0,i.jsxs)(on,{type:"button",onClick:A,children:[(0,i.jsx)(u.In,{name:"plus",size:13}),$("notifications.settings.quietHours.add")]})]})]}),(0,i.jsxs)(iV,{children:[(0,i.jsx)(u.In,{name:"shield",size:14,style:{flexShrink:0,marginTop:2}}),(0,i.jsx)("span",{children:j?"As chaves s\xe3o enviadas diretamente do teu browser para o servi\xe7o de IA — nunca passam pelos nossos servidores. Podes remov\xea-las a qualquer momento.":"Keys are sent directly from your browser to the AI provider — they never pass through our servers. You can remove them at any time."})]})]})})}let og=(0,d.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,oh=(0,d.keyframes)`
...
`;function oA({open:e,onClose:t,locale:a}){let[n,r]=(0,p.useProfile)(),[s,l]=(0,o.useState)(n),d=(0,o.useMemo)(()=>(0,m.Nx)("pt"===a?"pt":"en",el),[a]);if((0,o.useEffect)(()=>{e&&l(n)},[e,n]),(0,o.useEffect)(()=>{if(!e)return;let a=e=>{"Escape"===e.key&&t()};return window.addEventListener("keydown",a),()=>window.removeEventListener("keydown",a)},[e,t]),!e)return null;let g=async()=>{let e=s.ageMode!==n.ageMode||s.interests.length!==n.interests.length||s.interests.some(e=>!n.interests.includes(e));await r(s),t(),e&&(await (0,c.sW)("widget-cache:"),window.location.reload())},h="pt"===a?p.INTEREST_LABELS_PT:p.INTEREST_LABELS_EN,f="pt"===a?p.AGE_MODE_LABELS_PT:p.AGE_MODE_LABELS_EN;return ec().createPortal((0,i.jsx)(of,{onClick:e=>{e.target===e.currentTarget&&t()},children:(0,i.jsxs)(ob,{role:"dialog","aria-modal":"true","aria-labelledby":"profile-title",children:[(0,i.jsxs)(ox,{children:[(0,i.jsx)(oy,{id:"profile-title",children:d("profile.title")}),(0,i.jsx)(ow,{onClick:t,"aria-label":d("profile.close"),children:(0,i.jsx)(u.In,{name:"close",size:16})})]}),(0,i.jsxs)(ov,{children:[(0,i.jsxs)(ok,{children:[(0,i.jsx)(o$,{children:d("profile.interests")}),(0,i.jsx)(oj,{children:d("profile.interestsHint")}),(0,i.jsx)(oM,{children:p.ALL_INTERESTS.map(e=>(0,i.jsx)(oS,{active:s.interests.includes(e),onClick:()=>{l(t=>({...t,interests:t.interests.includes(e)?t.interests.filter(t=>t!==e):[...t.interests,e]}))},"aria-pressed":s.interests.includes(e),children:h[e]},e))})]}),(0,i.jsxs)(ok,{children:[(0,i.jsx)(o$,{children:d("profile.ageMode")}),(0,i.jsx)(oj,{children:d("profile.ageModeHint")}),(0,i.jsx)(oM,{children:["kid","teen","adult"].map(e=>(0,i.jsx)(oS,{active:s.ageMode===e,onClick:()=>{l(t=>({...t,ageMode:e}))},"aria-pressed":s.ageMode===e,children:f[e]},e))})]})]}),(0,i.jsxs)(oz,{children:[(0,i.jsx)(oC,{onClick:t,children:d("profile.cancel")}),(0,i.jsx)(oT,{onClick:g,children:d("profile.save")})]})]})}),document.body)}var oL=a(68360);let oF=(0,d.keyframes)`
  from { opacity: 0; transform: translateY(-6px); }
  to   { opacity: 1; transform: translateY(0); }
`,oN=l().div`
  position: fixed;
...
`,oY=l().div`
  ...
  font-size: 13px;
  color: ${c.w4.colors.mainTextMuted};
`;function o_({locale:e,state:t,anchor:a}){let n=(0,o.useMemo)(()=>(0,m.Nx)(e,el),[e]),{open:r,close:s,items:l,markAllRead:d,dismiss:g}=t;if(!r||!a)return null;let h=Math.round(a.bottom+8),f=Math.max(12,Math.round(window.innerWidth-a.right)),b=()=>{s(),window.location.hash="#/daily"};return ec().createPortal((0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(oN,{onClick:s}),(0,i.jsxs)(oP,{style:{top:h,right:f},role:"dialog","aria-label":n("notifications.title"),children:[(0,i.jsxs)(oI,{children:[(0,i.jsx)(oD,{children:n("notifications.title")}),(0,i.jsx)(oR,{onClick:d,disabled:0===l.length,children:n("notifications.markAllRead")})]}),(0,i.jsx)(oH,{children:0===l.length?(0,i.jsx)(oY,{children:n("notifications.empty")}):l.slice(0,5).map(e=>{let t=p.defaultStore.getCategory(e.category)?.badgeColor??c.w4.colors.mainTextMuted,a=p.defaultStore.getCategory(e.category)?.labelKey,o=a?n(a):e.category;if("daily.overdue"===e.category){let a=e.meta,r=a?.count??0,s=(a?.missions??[]).slice(0,4),l=1===r?n("notifications.daily.group.one"):n("notifications.daily.group.many",{count:r});return(0,i.jsxs)(oO,{children:[(0,i.jsxs)(oK,{as:"button",type:"button",onClick:b,children:[(0,i.jsxs)(oB,{color:t,children:[(0,i.jsx)("span",{className:"dot"}),o,(0,i.jsx)("span",{className:"time",children:(0,oL.e)(e.ts)})]}),(0,i.jsxs)(oG,{children:[(0,i.jsx)(oW,{children:s.map(e=>(0,u.n6)(e.emoji)?(0,i.jsx)(u.In,{name:e.emoji,size:14,style:{color:e.color??t}},e.id):(0,i.jsx)("span",{children:e.emoji},e.id))}),l]})]}),(0,i.jsx)(oq,{type:"button",className:"dismiss","aria-label":n("notifications.dismiss"),title:n("notifications.dismiss"),onClick:t=>{t.stopPropagation(),g(e.id)},children:"\xd7"})]},e.id)}let r=e.link?{href:e.link,target:"_blank",rel:"noopener noreferrer",onClick:()=>{g(e.id)}}:{as:"button",type:"button",onClick:()=>{g(e.id)}};return(0,i.jsxs)(oO,{children:[(0,i.jsxs)(oK,{...r,children:[(0,i.jsxs)(oB,{color:t,children:[(0,i.jsx)("span",{className:"dot"}),o,(0,i.jsx)("span",{className:"time",children:(0,m.aw)(new Date(e.ts).toISOString(),n)})]}),(0,i.jsx)(oG,{children:e.title})]}),(0,i.jsx)(oq,{type:"button",className:"dismiss","aria-label":n("notifications.dismiss"),title:n("notifications.dismiss"),onClick:t=>{t.stopPropagation(),g(e.id)},children:"\xd7"})]},e.id)})}),l.length>0&&(0,i.jsxs)(oE,{type:"button",onClick:()=>{s(),window.location.hash="#/notifications"},children:[(0,i.jsx)("span",{children:n("notifications.seeAll")}),(0,i.jsx)("span",{className:"count",children:l.length>5?`+${l.length-5}`:l.length})]})]})]}),document.body)}let oV=(0,d.keyframes)`
...
`;function o7({locale:e}){let t=(0,o.useMemo)(()=>(0,m.Nx)(e,el),[e]),a=(0,p.useRegisteredCategories)(),{items:n,byCategory:r}=(0,p.useEvents)({channels:a}),s=(0,o.useMemo)(()=>{let e=new Map;for(let t of a){let a=r[t];a&&a.length>0&&e.set(t,a)}return e},[r,a]),l=(0,o.useCallback)(()=>{p.defaultStore.markAllRead()},[]),d=(0,o.useCallback)(e=>{p.defaultStore.dismiss(e)},[]),u=(0,o.useCallback)(()=>{window.location.hash="#/home"},[]);return(0,i.jsxs)(oU,{children:[(0,i.jsxs)(oJ,{children:[(0,i.jsx)(oQ,{children:t("notifications.page.title")}),(0,i.jsx)(oZ,{children:t("notifications.page.subtitle")}),(0,i.jsxs)(oX,{children:[(0,i.jsxs)(o0,{onClick:u,children:["← ",t("error.remote.goHome")]}),(0,i.jsx)(o0,{onClick:l,disabled:0===n.length,children:t("notifications.markAllRead")})]})]}),0===n.length?(0,i.jsx)(o1,{children:t("notifications.empty")}):Array.from(s.entries()).map(([e,a])=>{let o;return(0,i.jsxs)("section",{children:[(0,i.jsx)(o4,{children:(o=p.defaultStore.getCategory(e),o?.labelKey?t(o.labelKey):e)}),a.map(a=>{let o=p.defaultStore.getCategory(e)?.badgeColor??c.w4.colors.mainTextMuted;return(0,i.jsxs)(o2,{color:o,children:[(0,i.jsxs)(o5,{href:a.link,target:a.link?"_blank":void 0,rel:a.link?"noopener noreferrer":void 0,children:[(0,i.jsx)(o3,{children:a.title}),(0,i.jsx)(o8,{children:(0,m.aw)(new Date(a.ts).toISOString(),t)})]}),(0,i.jsx)(o6,{type:"button","aria-label":t("notifications.dismiss"),title:t("notifications.dismiss"),onClick:()=>d(a.id),children:"\xd7"})]},a.id)})]},e)})]})}let o9={"stockpulse.enabled":!0};p.events.registerCategory({id:"sync.error",labelKey:"notifications.source.syncError",badgeColor:c.w4.colors.danger}),p.events.registerCategory({id:"daily.achievement",labelKey:"notifications.source.dailyAchievement",badgeColor:"#fb923c"}),p.events.registerCategory({id:"finance.budget",labelKey:"notifications.source.financeBudget",badgeColor:c.w4.colors.warning}),p.events.registerCategory({id:"finance.bills",labelKey:"notifications.source.financeBills",badgeColor:"#fb923c"}),p.events.registerRules([p.billsRule]),(0,p.loadSchedule)();{let e=new Map;(0,iS.subscribeRequests)(t=>{if(!t.host)return;if(t.ok)return void e.delete(t.host);let a=(e.get(t.host)??0)+1;if(e.set(t.host,a),3===a){let e=new Date().toISOString().slice(0,10);p.events.push({id:`sync.error:${t.host}:${e}`,category:"sync.error",ts:t.ts,title:`${t.host} — ${t.error??"failed"}`,meta:{host:t.host,status:t.status}})}})}let ne={movies:e=>({apiKey:e.tmdbKey}),youtube:e=>({apiKey:e.youtubeKey}),games:e=>({isAuthenticated:!!e.user})},nt=l().div`
...
`,nn={techscope:9,weather:1,citypulse:1};function nr({count:e}){return(0,i.jsxs)(ni,{title:`${e} live ${1===e?"feed":"feeds"}`,children:[(0,i.jsx)(no,{}),e,(0,i.jsx)("span",{style:{opacity:.65,fontSize:10},children:"LIVE"})]})}let ns=l().div`
  flex: 1;
  display: flex;
  flex-direction: column;
  align-items: center;
...
`;function nu({name:e,error:t,topBarRight:a,onRetry:n}){let[r]=(0,m.Ym)(),s=(0,o.useMemo)(()=>(0,m.Nx)(r,el),[r]),l=t.message??"",d=l.startsWith("REMOTE_LOAD_FAILED:"),p=d?l.slice(19):e,u=`apps.${p}.label`,g=s(u),h=g&&g!==u?g:p;return(0,i.jsx)(c.PE,{title:h,sidebar:null,topBarRight:a,children:(0,i.jsxs)(ns,{children:[(0,i.jsx)(nl,{children:"⚠"}),(0,i.jsx)(nd,{children:s("error.remote.title",{name:h})}),(0,i.jsx)(nc,{children:s(d?"error.remote.prodHint":"error.remote.generic")}),d&&!1,(0,i.jsxs)("div",{style:{display:"flex",gap:c.w4.spacing.sm},children:[(0,i.jsx)(np,{onClick:n,children:s("error.remote.retry")}),(0,i.jsx)(np,{onClick:()=>{window.location.hash="#/home"},children:s("error.remote.goHome")})]})]})})}class nm extends n().Component{static getDerivedStateFromError(e){return{error:e}}componentDidCatch(e){console.error(`[RemoteErrorBoundary] "${this.props.name}" threw:`,e)}componentDidUpdate(e){e.name!==this.props.name&&this.state.error&&this.setState({error:null})}render(){return this.state.error?(0,i.jsx)(nu,{name:this.props.name,error:this.state.error,topBarRight:this.props.topBarRight,onRetry:()=>this.setState({error:null})}):this.props.children}constructor(...e){super(...e),function(e,t,a){t in e?Object.defineProperty(e,t,{value:a,enumerable:!0,configurable:!0,writable:!0}):e[t]=a}(this,"state",{error:null})}}let ng=(()=>{let e={settings:"settings"};for(let t of M)for(let a of(e[t.hash.replace(/^#\//,"")]=t.id,t.hashAliases??[]))e[a]=t.id;return e})();function nh(e){let t=e.replace(/^#\/?/,"");if(!t||"home"===t)return"home";let a=t.split("/")[0].split("?")[0];return"notifications"===a?"notifications":ng[a]??"home"}let nf="shell:recent",nb="shell:pinned",nx="shell:last-app";function ny(){let e=window.location.hash;if(!e||"#"===e||"#/"===e)try{let e=localStorage.getItem(nx);if(e&&"home"!==e&&f[e]){let t=M.find(t=>t.id===e);if(t)return history.replaceState(null,"",t.hash),e}}catch{}return nh(e)}function nw(e){try{return JSON.parse(e??"[]")}catch{return[]}}let nv=new Set(M.filter(e=>e.needsAuth).map(e=>e.id)),nk="true"===process.env.MOCK_USER?{id:"mock-user",email:"dev@atlantis.local",user_metadata:{full_name:"Dev User",avatar_url:""}}:null,n$=process.env.YOUTUBE_API_KEY||"",nj=document.getElementById("root");if(!nj)throw Error("Root element #root not found");(0,r.createRoot)(nj).render((0,i.jsx)(function(){let e,[t,a]=(0,o.useState)(ny),[n,r]=(0,o.useState)([]),[s,l]=(0,o.useState)([]),[d,g]=(0,o.useState)(nk),[h,b]=(0,o.useState)(!!nk),[x,y]=(0,o.useState)(!1),[w,v]=(0,o.useState)(void 0),[k,$]=(0,o.useState)(!1),[C,T]=(0,o.useState)(!1),[A,L]=(0,m.Ym)(),F=(0,o.useMemo)(()=>(0,m.Nx)(A,el),[A]),N=function(e={}){let t=(0,p.useRegisteredCategories)(),a=(0,p.useEventBell)({channels:t}),[i,n]=(0,o.useState)(!1),r=(0,o.useRef)(null),s=(0,o.useRef)(e.formatDailyReminder);(0,o.useEffect)(()=>{s.current=e.formatDailyReminder},[e.formatDailyReminder]),(0,o.useEffect)(()=>{let e=()=>{p.defaultStore.refresh()};window.addEventListener("focus",e);let t=p.dailyStore.subscribe(e);return()=>{window.removeEventListener("focus",e),t()}},[]),(0,o.useEffect)(()=>{if("u"<typeof window||!("Notification"in window)||"granted"!==Notification.permission)return;let e=a.items.find(e=>"daily.overdue"===e.category),t=(0,p.todayISO)();if(!e||r.current===t)return;let i=e.meta,o=i?.missions?.[0],n=o?s.current?.(o):void 0;if(n){r.current=t;try{new Notification(n.title,{body:n.body,tag:`atlantis-daily-${t}`,icon:"/manifest-icon.png"})}catch{}}},[a.items]);let l=(0,o.useCallback)(()=>n(e=>!e),[]),d=(0,o.useCallback)(()=>n(!1),[]);return{...a,open:i,toggle:l,close:d}}({formatDailyReminder:(0,o.useCallback)(e=>{let t=(0,p.missionLabel)(e,A),a=e.emoji?`${e.emoji} ${t}`.trim():t;return{title:F("notifications.source.daily"),body:F("notifications.daily.body",{time:e.time??"",name:a})}},[F,A])}),[P,I]=(0,o.useState)(null);(0,o.useEffect)(()=>{if(nk)return;ad.auth.getSession().then(({data:e})=>{let t=e.session?.user??null;g(t),(0,c.Fm)(t?ak:null),b(!0)});let{data:{subscription:e}}=ad.auth.onAuthStateChange((e,t)=>{let a=t?.user??null;g(a),(0,c.Fm)(a?ak:null)});return()=>e.unsubscribe()},[]),(0,o.useEffect)(()=>{(0,c.PL)(nf).then(e=>r(nw(e))),(0,c.PL)(nb).then(e=>l(nw(e)))},[]),(0,o.useEffect)(()=>{let e=e=>{(e.metaKey||e.ctrlKey)&&"k"===e.key&&(e.preventDefault(),v(void 0),y(e=>!e))};return window.addEventListener("keydown",e),()=>window.removeEventListener("keydown",e)},[]),(0,o.useEffect)(()=>{let e=e=>{let t=e.detail;v(t?.scope),y(!0)};return window.addEventListener("atlantis:open-palette",e),()=>window.removeEventListener("atlantis:open-palette",e)},[]),(0,o.useEffect)(()=>{let e=()=>a(nh(window.location.hash));return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[]),(0,o.useEffect)(()=>{if(t&&"home"!==t){try{localStorage.setItem(nx,t)}catch{}r(e=>{let a=[t,...e.filter(e=>e!==t)].slice(0,8);return(0,c.Is)(nf,JSON.stringify(a)),a})}},[t]);let D=(0,o.useCallback)(e=>{window.location.hash=e,y(!1),v(void 0)},[]),R=(0,o.useCallback)(e=>{window.location.hash=`#/home?suite=${encodeURIComponent(e)}`},[]),[H]=(0,p.useProfile)(),E=(0,o.useMemo)(()=>M.filter(e=>e.flag?function(e){try{let t=localStorage.getItem("shell:flag:"+e);if("true"===t)return!0;if("false"===t)return!1}catch{}return o9[e]??!1}(e.flag):e.enabled).filter(e=>"hidden"!==j(e)).filter(e=>!(0,p.hasInterests)(H)||!e.interest||H.interests.includes(e.interest)),[H]),O=(0,o.useMemo)(()=>{let e=z.map(e=>({id:e.id,name:F(e.labelKey),iconName:e.iconName,hash:e.hash,accentColor:e.color,onClick:()=>{window.location.hash=e.hash}}));return S.map(t=>{let a=E.filter(e=>e.suite===t.yamlSuite),i="games"===t.id;return{id:t.id,name:F(t.nameKey),subtitle:F(t.subKey),color:t.color,icon:t.icon,count:i?z.length:a.length,onClick:i?void 0:()=>R(t.id),children:i?e:void 0}})},[E,F,R]),K=(0,o.useMemo)(()=>O.filter(e=>e.count>0),[O]),q=(0,o.useMemo)(()=>K.map(e=>({id:e.id,name:e.name,sub:e.subtitle,color:e.color,iconName:e.icon,onConfirm:()=>R(e.id)})),[K,R]),B=(0,o.useMemo)(()=>z.map(e=>({id:e.id,name:F(e.labelKey),iconName:e.iconName,hash:e.hash,color:e.color})),[F]),G=(0,o.useMemo)(()=>[{id:"add-widget",label:F("palette.action.addWidget"),meta:F("palette.action.addWidget.meta"),iconName:"plus",color:c.w4.colors.accent,onClick:()=>{window.location.hash="#/home";try{sessionStorage.setItem(eR,"1")}catch{}window.dispatchEvent(new CustomEvent("atlantis:open-widget-picker"))}},{id:"preferences",label:F("palette.action.preferences"),meta:F("palette.action.preferences.meta"),iconName:"settings",onClick:()=>$(!0)},{id:"settings",label:F("palette.action.settings"),meta:F("palette.action.settings.meta"),iconName:"sparkle",onClick:()=>{window.location.hash="#/settings"}},{id:"language",label:F("palette.action.language"),meta:F("palette.action.language.meta"),iconName:"globe",onClick:()=>L("pt"===A?"en":"pt")},...N.count>0?[{id:"clear-notifications",label:F("palette.action.clearNotifications"),meta:F("palette.action.clearNotifications.meta",{n:N.count}),iconName:"bell",color:c.w4.colors.accent,onClick:()=>{N.markAllRead()}}]:[],...d?[{id:"signout",label:F("palette.action.signout"),meta:d.email??"",iconName:"arrow-up-right",color:c.w4.colors.danger,onClick:()=>{ap()}}]:[]],[F,A,L,d,N]),[W,Y]=(0,o.useState)(null);(0,o.useEffect)(()=>{(0,p.resolveGroqKey)().then(Y)},[]);let _=(0,p.hasEnvGroqKey)()||!!W,V=(0,o.useMemo)(()=>E.map(({id:e,labelKey:t,hash:a})=>({id:e,label:F(t),hash:a})),[E,F]),U=(0,o.useMemo)(()=>E.map(({id:e,labelKey:t,descriptionKey:a,hash:i,icon:o,color:n,category:r})=>({id:e,label:F(t),description:F(a),hash:i,icon:o,color:n,category:r})),[E,F]),J=(e=M.find(e=>e.id===t))?F(e.labelKey):t;if(!h)return(0,i.jsx)(c.NP,{children:(0,i.jsx)(c.xx,{})});if(nv.has(t)&&!d)return(0,i.jsx)(c.NP,{children:(0,i.jsx)(av,{appLabel:J,onBack:()=>{window.location.hash="#/home"}})});let Q=nn[t],Z=e=>{I(e.currentTarget.getBoundingClientRect()),N.toggle()},X=(0,i.jsx)(u.Yw,{locale:A,onLocaleChange:L,before:null!=Q?(0,i.jsx)(nr,{count:Q}):void 0,suites:{entries:K,label:F("suites.label"),ariaLabel:F("suites.aria"),appsLabel:F("suites.appsCount")},notifications:{count:N.count,onClick:Z,label:F("notifications.bell")},onOpenPalette:()=>{v(void 0),y(!0)},paletteLabel:F("palette.search"),user:d?{name:d.user_metadata?.full_name,email:d.email??"",avatarUrl:d.user_metadata?.avatar_url}:void 0,userMenuItems:d?[{label:F("userMenu.preferences"),icon:(0,i.jsx)(u.In,{name:"user-cog",size:14}),onClick:()=>$(!0)},{label:F("userMenu.settings"),icon:(0,i.jsx)(u.In,{name:"settings",size:14}),onClick:()=>{window.location.hash="#/settings"}},{label:F("userMenu.clearData"),icon:(0,i.jsx)(u.In,{name:"trash",size:14}),onClick:()=>T(!0),danger:!0},{label:F("userMenu.signOut"),icon:(0,i.jsx)(u.In,{name:"log-out",size:14}),onClick:ap,danger:!0}]:[],userMenuControlLabels:{language:F("userMenu.language"),theme:F("userMenu.theme"),themeLight:F("userMenu.themeLight"),themeDark:F("userMenu.themeDark"),themeSystem:F("userMenu.themeSystem")},onSignIn:()=>{window.location.hash="#/home"}}),ee=x&&(0,i.jsx)(iy,{apps:U,recentIds:n,suites:q,games:B,actions:G,hasAsk:_,groqKey:W??void 0,locale:A,initialScope:w,onNavigate:D,onClose:()=>{y(!1),v(void 0)}}),et=!x&&(0,i.jsx)(iM,{t:F,onOpenPalette:()=>{v(void 0),y(!0)}}),ea=(0,i.jsx)(oA,{open:k,onClose:()=>$(!1),locale:A}),ei=(0,i.jsx)(c.TM,{open:C,title:F("userMenu.clearData"),message:F("userMenu.clearDataConfirm"),confirmLabel:F("userMenu.clearData"),cancelLabel:F("common.cancel"),danger:!0,onCancel:()=>T(!1),onConfirm:async()=>{T(!1),await (0,c.sW)(""),window.location.reload()}}),eo=(0,i.jsx)(o_,{locale:A,state:N,anchor:P});if("home"===t)return(0,i.jsxs)(c.NP,{children:[(0,i.jsx)(nt,{children:(0,i.jsx)(al,{apps:V,recentAppIds:n,pinnedAppIds:s,onTogglePin:e=>{l(t=>{let a=t.includes(e)?t.filter(t=>t!==e):[...t,e];return(0,c.Is)(nb,JSON.stringify(a)),a})},onMovePinned:(e,t)=>{l(a=>{let i=a.indexOf(e);if(i<0)return a;let o=i+t;if(o<0||o>=a.length)return a;let n=[...a];return[n[i],n[o]]=[n[o],n[i]],(0,c.Is)(nb,JSON.stringify(n)),n})},onSelect:e=>{window.location.hash=e.hash},user:d?{name:d.user_metadata?.full_name,email:d.email??"",avatarUrl:d.user_metadata?.avatar_url}:null,onSignOut:ap,onPreferences:()=>$(!0),onClearData:()=>T(!0),onOpenPalette:()=>{v(void 0),y(!0)},notifications:{count:N.count,onClick:Z,label:F("notifications.bell")},suites:{entries:K,label:F("suites.label"),ariaLabel:F("suites.aria"),appsLabel:F("suites.appsCount")}})},"home"),ee,et,ea,ei,eo]});let en=f[t],er=ne[t]?.({user:d,tmdbKey:"9b6f2645abf1725625c843aa71e3efd5",youtubeKey:n$})??{};return(0,i.jsxs)(c.NP,{children:[(0,i.jsx)(nm,{name:t,topBarRight:X,children:(0,i.jsx)(o.Suspense,{fallback:(0,i.jsx)(c.xx,{}),children:(0,i.jsxs)(nt,{children:[en&&(0,i.jsx)(en,{topBarRight:X,...er}),"settings"===t&&(0,i.jsx)(c.PE,{title:"Settings",sidebar:null,topBarRight:X,children:(0,i.jsx)(om,{lang:"pt"===A?"pt":"en"})}),"notifications"===t&&(0,i.jsx)(c.PE,{title:F("notifications.page.title"),sidebar:null,topBarRight:X,children:(0,i.jsx)(o7,{locale:A})})]},t)})}),ee,et,ea,ei,eo]})},{}))},28170(e,t,a){a.d(t,{Ym:()=>c,Nx:()=>p,Fd:()=>x,aw:()=>u});var i=a(37991),o=a(89874);let n={"time.justNow":{en:"just now",pt:"agora mesmo"},"time.mAgo":{en:"{n}m ago",pt:"h\xe1 {n}m"},"time.hAgo":{en:"{n}h ago",pt:"h\xe1 {n}h"},"time.dAgo":{en:"{n}d ago",pt:"h\xe1 {n}d"},updated:{en:"updated {age}",pt:"atualizado {age}"},refresh:{en:"Refresh",pt:"Atualizar"},loading:{en:"Loading…",pt:"A carregar…"},noData:{en:"No data available",pt:"Sem dados dispon\xedveis"},noDescription:{en:"No description provided.",pt:"Sem descri\xe7\xe3o."},failedToFetch:{en:"Failed to fetch",pt:"Erro ao carregar"},perWeek:{en:"/ wk",pt:"/ sem"},"devtools.heading":{en:"Dev Tools",pt:"Ferramentas"},"devtools.playground":{en:"Playground",pt:"Playground"},"devtools.pad":{en:"Pad",pt:"Pad"},"devtools.charts":{en:"Charts",pt:"Gr\xe1ficos"},"devtools.csv":{en:"CSV",pt:"CSV"},"devtools.regex":{en:"Regex",pt:"Regex"},"devtools.json":{en:"JSON",pt:"JSON"},"devtools.diff":{en:"Diff",pt:"Diferen\xe7as"},"devtools.jwt":{en:"JWT",pt:"JWT"},"devtools.cron":{en:"Cron",pt:"Cron"},"devtools.colors":{en:"Colors",pt:"Cores"},"devtools.api":{en:"API",pt:"API"}},r="atlantis:locale",s="shell:locale";function l(e){return"en"===e||"pt"===e}function d(){try{let e=localStorage.getItem(r);if(l(e))return e}catch{}return"en"}function c(){let[e,t]=(0,i.useState)(d),a=(0,i.useCallback)(e=>{t(e);try{localStorage.setItem(r,e)}catch{}(0,o.Is)(s,e).catch(()=>{}),window.dispatchEvent(new CustomEvent("atlantis:locale-change",{detail:e}))},[]);return(0,i.useEffect)(()=>{let e=e=>{t(e.detail)};return window.addEventListener("atlantis:locale-change",e),()=>window.removeEventListener("atlantis:locale-change",e)},[]),(0,i.useEffect)(()=>{(0,o.PL)(s).then(a=>{if(l(a)&&a!==e){try{localStorage.setItem(r,a)}catch{}t(a)}}).catch(()=>{})},[]),[e,a]}function p(e,t){let a=t?{...n,...t}:n;return(t,i)=>{let o=function(e,t){if(!t||!e.includes("|"))return e;let a=null;for(let e of Object.values(t))if("number"==typeof e&&Number.isFinite(e)){a=e;break}if(null===a)return e;let i=e.indexOf("|"),o=e.slice(0,i),n=e.slice(i+1);return 1===a?o:n}(a[t]?.[e]??t,i);return i?Object.entries(i).reduce((e,[t,a])=>e.replace(RegExp(`\\{${t}\\}`,"g"),String(a)),o):o}}function u(e,t){let a=Math.floor((Date.now()-new Date(e).getTime())/6e4);if(a<1)return t("time.justNow");if(a<60)return t("time.mAgo",{n:a});let i=Math.floor(a/60);return i<24?t("time.hAgo",{n:i}):t("time.dAgo",{n:Math.floor(i/24)})}(0,o.PL)(s).then(e=>{if(l(e))try{localStorage.setItem(r,e)}catch{}}).catch(()=>{});var m=a(65723),g=a(36859),h=a.n(g);let f=h().div`
  display: flex;
  gap: 4px;
...
`,x=n().forwardRef(function({variant:e="ghost",size:t="md",icon:a,iconRight:o,children:n,...r},s){return(0,i.jsxs)(b,{ref:s,variant:e,size:t,...r,children:[a,n,o]})}),y={default:l.w4.colors.accent,danger:"#f85149"},w={default:l.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"},v=s().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`,k=n().forwardRef(function({active:e=!1,shape:t="square",tone:a="default",children:o,...n},r){return(0,i.jsx)(v,{ref:r,active:e,shape:t,tone:a,...n,children:o})});s().div`
  position: relative;
  display: inline-flex;
`,s().div`
  position: absolute;
...
`;function P({name:e,email:t,avatarUrl:a,size:o=26}){let n=e??t.split("@")[0]??t;if(a)return(0,i.jsx)(F,{src:a,alt:n,size:o});let r=((e??t.split("@")[0]??"")[0]??"?").toUpperCase();return(0,i.jsx)(N,{size:o,"aria-label":n,title:n,children:r})}let I=(0,C.keyframes)`
...
`;function U({labels:e}){let{mode:t,setMode:a}=(0,l.eP)(),o=[{value:"light",label:e?.themeLight??"Light"},{value:"dark",label:e?.themeDark??"Dark"},{value:"system",label:e?.themeSystem??"System"}];return(0,i.jsxs)(G,{children:[(0,i.jsx)(W,{children:e?.theme??"Theme"}),(0,i.jsx)(Y,{role:"radiogroup","aria-label":e?.theme??"Theme",children:o.map(({value:e,label:o})=>(0,i.jsx)(_,{active:t===e,onClick:()=>a(e),role:"radio","aria-checked":t===e,children:o},e))})]})}function J({user:e,items:t,compact:a=!1,locale:n,onLocaleChange:r,controlLabels:s,showThemeControl:l=!0}){let[d,c]=(0,o.useState)(!1),[p,u]=(0,o.useState)(null),m=(0,o.useRef)(null),g=(0,o.useRef)(null),h=(0,o.useRef)(null);(0,o.useEffect)(()=>{if(!d)return;let e=e=>{let t=e.target;m.current?.contains(t)||h.current?.contains(t)||c(!1)};return document.addEventListener("mousedown",e),()=>document.removeEventListener("mousedown",e)},[d]),(0,o.useEffect)(()=>{d?g.current&&u(g.current.getBoundingClientRect()):u(null)},[d]);let f=e.name??e.email.split("@")[0],b=p?{top:Math.round(p.bottom+8),right:Math.max(12,Math.round(window.innerWidth-p.right))}:{top:0,right:12};return(0,i.jsxs)(D,{ref:m,children:[(0,i.jsxs)(R,{ref:g,onClick:()=>c(e=>!e),children:[(0,i.jsx)(P,{name:e.name,email:e.email,avatarUrl:e.avatarUrl,size:26}),!a&&(0,i.jsx)(H,{children:f})]}),d&&z().createPortal((0,i.jsxs)(E,{ref:h,style:b,children:[(0,i.jsxs)(O,{children:[(0,i.jsx)(K,{children:(0,i.jsx)(P,{name:e.name,email:e.email,avatarUrl:e.avatarUrl,size:40})}),(0,i.jsx)(q,{children:f}),(0,i.jsx)(B,{children:e.email})]}),void 0!==n&&r&&(0,i.jsxs)(G,{children:[(0,i.jsx)(W,{children:s?.language??"Language"}),(0,i.jsxs)(Y,{role:"radiogroup","aria-label":s?.language??"Language",children:[(0,i.jsx)(_,{active:"pt"===n,onClick:()=>r("pt"),role:"radio","aria-checked":"pt"===n,children:"Portugu\xeas"}),(0,i.jsx)(_,{active:"en"===n,onClick:()=>r("en"),role:"radio","aria-checked":"en"===n,children:"English"})]})]}),l&&(0,i.jsx)(U,{labels:s}),t.map((e,t)=>(0,i.jsxs)(V,{danger:e.danger,onClick:()=>{c(!1),e.onClick()},children:[e.icon,e.label]},t))]}),document.body)]})}var Q=a(28170);let Z=s().div`
  position: relative;
  display: inline-block;
`,X=s().button`
  display: inline-flex;
...
`,ei=s()("button",{shouldForwardProp:e=>"accent"!==e&&"expanded"!==e})`
  width: 100%;
  display: grid;
  ...
  &:focus-visible { ${l.w4.focusRing} }
`,eo=s()("span",{shouldForwardProp:e=>"accent"!==e})`
  width: 36px;
  height: 36px;
  border-radius: 9px;
...
`,eu=s().span`
  ...
  letter-spacing: 0.02em;
  flex-shrink: 0;
`;function em({label:e,ariaLabel:t,appsLabel:a,suites:r}){let[s,l]=(0,o.useState)(!1),[d,c]=(0,o.useState)(null),p=(0,o.useRef)(null);(0,o.useEffect)(()=>{if(!s)return;let e=e=>{p.current&&!p.current.contains(e.target)&&(l(!1),c(null))},t=e=>{"Escape"===e.key&&(l(!1),c(null))};return document.addEventListener("mousedown",e),document.addEventListener("keydown",t),()=>{document.removeEventListener("mousedown",e),document.removeEventListener("keydown",t)}},[s]);let u=r.reduce((e,t)=>e+t.count,0);return(0,i.jsxs)(Z,{ref:p,children:[(0,i.jsxs)(X,{open:s,onClick:()=>l(e=>!e),"aria-haspopup":"menu","aria-expanded":s,"aria-label":t,children:[(0,i.jsx)("span",{children:e}),(0,i.jsx)(ee,{title:`${u} ${a}`,"aria-label":`${u} ${a}`,children:u}),(0,i.jsx)(L,{name:"chevron-down",size:12,"aria-hidden":"true"})]}),s&&(0,i.jsx)(ea,{role:"menu",children:r.map(e=>{let t=d===e.id,o=!!(e.children&&e.children.length>0);return(0,i.jsxs)(n().Fragment,{children:[(0,i.jsxs)(ei,{accent:e.color,expanded:t,onClick:()=>{e.children&&e.children.length>0?c(t=>t===e.id?null:e.id):(e.onClick?.(),l(!1))},role:"menuitem","aria-expanded":o?t:void 0,children:[(0,i.jsx)(eo,{accent:e.color,children:(0,i.jsx)(L,{name:e.icon,size:18,"aria-hidden":"true"})}),(0,i.jsxs)(en,{children:[(0,i.jsx)(er,{children:e.name}),e.subtitle&&(0,i.jsx)(es,{children:e.subtitle})]}),(0,i.jsx)(el,{accent:e.color,title:`${e.count} ${a}`,"aria-label":`${e.count} ${a}`,children:e.count})]}),t&&o&&(0,i.jsx)(ed,{children:e.children.map(e=>(0,i.jsxs)(ec,{onClick:()=>{e.onClick(),l(!1),c(null)},role:"menuitem",children:[e.iconName?(0,i.jsx)(ep,{accent:e.accentColor,children:(0,i.jsx)(L,{name:e.iconName,size:14,"aria-hidden":"true"})}):e.glyph?(0,i.jsx)(ep,{accent:e.accentColor,children:e.glyph}):null,(0,i.jsx)("span",{children:e.name}),e.hash&&(0,i.jsx)(eu,{children:e.hash})]},e.id))})]},e.id)})})]})}let eg=s().div`
  display: flex;
  align-items: center;
  gap: ${l.w4.spacing.sm};
...
`;function ew({locale:e,onLocaleChange:t,user:a,userMenuItems:o=[],userMenuControlLabels:n,suites:r,onPreferences:s,notifications:d,onOpenPalette:c,paletteLabel:p="Search",onSignIn:u,signInLabel:m="Sign in",before:g,after:h}){let f=function(){if("u"<typeof navigator)return"Ctrl";let e=navigator,t=e.userAgentData?.platform??navigator.platform??navigator.userAgent??"";return/Mac|iPod|iPhone|iPad/i.test(t)?"⌘":"Ctrl"}(),b="⌘"===f?`${f}K`:`${f}+K`;return(0,i.jsxs)(eg,{children:[g,r&&r.entries.length>0&&(0,i.jsx)(em,{label:r.label,ariaLabel:r.ariaLabel,appsLabel:r.appsLabel,suites:r.entries}),c&&(0,i.jsxs)(ef,{onClick:c,"aria-label":p,title:`${p} (${b})`,children:[(0,i.jsx)(L,{name:"search",size:14}),(0,i.jsx)("span",{className:"kbd header-kbd",children:b})]}),!a&&(0,i.jsx)(Q.Fd,{locale:e,onChange:t}),!a&&(0,i.jsx)("span",{className:"header-hide-md",children:(0,i.jsx)(l.UW,{})}),d&&(0,i.jsxs)(eb,{children:[(0,i.jsx)(eh,{onClick:d.onClick,"aria-label":d.label,title:d.label,children:(0,i.jsx)(L,{name:"bell",size:16})}),d.count>0&&(0,i.jsx)(ex,{"aria-hidden":"true",children:d.count>9?"9+":d.count})]}),s&&(0,i.jsx)("span",{className:"header-hide-md",children:(0,i.jsx)(eh,{onClick:s,"aria-label":"User preferences",title:"Preferences",children:(0,i.jsx)(L,{name:"user-cog",size:16})})}),a?(0,i.jsx)(J,{user:a,items:o,locale:e,onLocaleChange:t,controlLabels:n}):u?(0,i.jsxs)(ey,{onClick:u,"aria-label":m,children:[(0,i.jsx)(L,{name:"log-in",size:14}),m]}):null,h]})}s().div`
  position: fixed;
  inset: 0;
  pointer-events: none;
  z-index: 900;
...
`,s().span`
  ...
  background: ${({color:e})=>e};
  display: inline-block;
`;let eH={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:l.w4.colors.accentMuted},eE={neutral:l.w4.colors.mainTextMuted,live:l.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:l.w4.colors.accent},eO=s().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${l.w4.typography.fontFamilyMono};
...
`,eK=s().span`
  ...
  background: currentColor;
  display: inline-block;
`;function eq({tone:e="neutral",dot:t,children:a,...o}){return(0,i.jsxs)(eO,{tone:e,...o,children:[(t??"live"===e)&&(0,i.jsx)(eK,{}),a]})}let eB=s().kbd`
  font-family: ${l.w4.typography.fontFamilyMono};
  font-size: 10px;
  padding: 2px 6px;
  border: 1px solid ${l.w4.colors.border};
  ...
  white-space: nowrap;
`;function eG({children:e,...t}){return(0,i.jsx)(eB,{...t,children:e})}let eW=s().div`
  font-family: ${l.w4.typography.fontFamilyMono};
  font-size: 11px;
  letter-spacing: 0.16em;
  text-transform: uppercase;
  ...
  align-items: center;
  gap: 8px;
`;function eY({children:e,...t}){return(0,i.jsx)(eW,{...t,children:e})}let e_=s().label`
  display: flex;
  align-items: center;
  gap: 10px;
...
`,eU=s().span`
  ...
  color: ${l.w4.colors.mainTextMuted};
  flex-shrink: 0;
`,eJ=n().forwardRef(function({before:e,after:t,...a},o){return(0,i.jsxs)(e_,{children:[e&&(0,i.jsx)(eU,{children:e}),(0,i.jsx)(eV,{ref:o,...a}),t&&(0,i.jsx)(eU,{children:t})]})}),eQ=s().div`
  position: relative;
  display: flex;
  flex-direction: column;
  height: 100%;
...
`;function e2({title:e,accessory:t,accentColor:a,error:o,errorLabel:n,children:r}){return(0,i.jsxs)(eQ,{accentColor:a,"data-widget-shell":!0,children:[(0,i.jsxs)(eZ,{children:[(0,i.jsx)(eY,{children:e}),t&&(0,i.jsx)(eX,{children:t})]}),o?(0,i.jsxs)(e1,{role:"alert",children:[(0,i.jsx)(e4,{children:n??"Error"}),(0,i.jsx)("div",{children:o})]}):(0,i.jsx)(e0,{children:r})]})}s().div`
  position: relative;
  display: flex;
  flex-direction: column;
  height: 100%;
...
`,s().p`
  ...
  font-size: 12.5px;
  line-height: 1.45;
`;var e3=a(11352),e8=a(76710),e6=a(4311),e7=a(73639),e9=a(40080);a(75406),s().nav`padding: ${l.w4.spacing.sm} 0;`,s().div`
...
`;var te=a(54041);let tt="https://cdn.jsdelivr.net/npm/mermaid@11.14.0/dist/mermaid.min.js",ta=null,ti="#7fb77e",to=(0,C.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,tn=s().div`
  position: relative;
...
`,s().span`
  font-size: ${l.w4.typography.fontSizeBase};
  color: ${l.w4.colors.mainTextMuted};
`;var tM=a(17223),tS=a(21426),tz=a(25609),tC=a(20320);let tT=s().div`
  margin: ${l.w4.spacing.lg} 0;
  border-radius: ${l.w4.borderRadius.md};
  border: 1px solid ${l.w4.colors.codeBorder};
  overflow: hidden;
...
`,tN={...tS.A,'pre[class*="language-"]':{...tS.A['pre[class*="language-"]'],background:l.w4.colors.codeBg,margin:0,padding:"18px 20px",fontSize:"13px",lineHeight:"1.6",borderRadius:0},'code[class*="language-"]':{...tS.A['code[class*="language-"]'],background:"none",fontSize:"13px"}};function tP({lang:e="text",code:t}){let[a,n]=(0,o.useState)(!1);return(0,i.jsxs)(tT,{children:[(0,i.jsxs)(tA,{children:[(0,i.jsx)(tL,{children:e}),(0,i.jsxs)(tF,{copied:a,onClick:()=>{navigator.clipboard.writeText(t).then(()=>{n(!0),setTimeout(()=>n(!1),2e3)})},children:[a?(0,i.jsx)(tz.A,{size:12}):(0,i.jsx)(tC.A,{size:12}),a?"Copied!":"Copy"]})]}),(0,i.jsx)(tM.A,{language:e,style:tN,showLineNumbers:t.split("\n").length>8,lineNumberStyle:{color:"#484f58",minWidth:"2.5em",paddingRight:"1.5em",userSelect:"none",fontSize:"12px"},customStyle:{margin:0,background:l.w4.colors.codeBg},wrapLongLines:!1,children:t})]})}var tI=a(65569),tD=a(8218),tR=a(57230),tH=a(22966),tE=a(21069);let tO={NOTE:{bg:"rgba(88, 166, 255, 0.08)",border:"#58a6ff",icon:tI.A,label:"Note",color:"#58a6ff"},TIP:{bg:"rgba(63, 185, 80, 0.08)",border:"#3fb950",icon:tD.A,label:"Tip",color:"#3fb950"},IMPORTANT:{bg:"rgba(163, 113, 247, 0.08)",border:"#a371f7",icon:tR.A,label:"Important",color:"#a371f7"},WARNING:{bg:"rgba(210, 153, 34, 0.08)",border:"#d29922",icon:tH.A,label:"Warning",color:"#d29922"},CAUTION:{bg:"rgba(248, 81, 73, 0.08)",border:"#f85149",icon:tE.A,label:"Caution",color:"#f85149"}},tK=s().div`
  background: ${({bg:e})=>e};
...
`;function tG({type:e,children:t}){let a=tO[e]??tO.NOTE,o=a.icon;return(0,i.jsxs)(tK,{bg:a.bg,border:a.border,children:[(0,i.jsxs)(tq,{color:a.color,children:[(0,i.jsx)(o,{size:15,strokeWidth:2}),a.label]}),(0,i.jsx)(tB,{children:t})]})}s().nav`
  width: 220px;
  min-width: 220px;
...
`;function tU({children:e}){return(0,i.jsx)(tV,{children:(0,i.jsx)(e3.oz,{remarkPlugins:[e8.A,e6.A,t_],rehypePlugins:[e7.A,e9.A],components:{div({node:e,children:t,...a}){let o=a["data-callout"];return o?(0,i.jsx)(tG,{type:o,children:t}):(0,i.jsx)("div",{...a,children:t})},pre:({children:e})=>(0,i.jsx)(i.Fragment,{children:e}),code({className:e,children:t}){let a=/language-(\w+)/.exec(e??"")?.[1],o=String(t).replace(/\n$/,"");return o.trim()?"mermaid"===a?(0,i.jsx)(tc,{code:o}):"chart"===a?(0,i.jsx)(tk,{code:o}):a||o.includes("\n")?(0,i.jsx)(tP,{lang:a,code:o}):(0,i.jsx)("code",{className:e,children:t}):null}},children:e})})}s().nav`
  display: flex;
  flex-direction: column;
  gap: 1px;
  padding: ${l.w4.spacing.sm} 0;
...
`},85043(e,t,a){a.d(t,{Y:()=>p});var i=a(65723),o=a(36859),n=a.n(o),r=a(89874);let s=n().div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
`,d=n().p`
  ...
  margin: 0;
  line-height: 1.5;
`,c={loading:"◌ Loading",empty:"◎ Empty",error:"◎ Offline"};function p({mode:e,label:t,body:a}){return(0,i.jsxs)(s,{children:[(0,i.jsx)(l,{mode:e,children:t??c[e]}),a&&(0,i.jsx)(d,{children:a})]})}},57669(e,t,a){a.d(t,{YG:()=>i.Y});var i=a(85043);a(65723),a(37991);var o=a(89874),n=a(36859),r=a.n(n);r().span`
  font-family: ${o.w4.typography.fontFamilyMono};
  font-size: 11px;
  font-weight: 500;
  font-variant-numeric: tabular-nums;
