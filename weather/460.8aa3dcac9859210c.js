"use strict";(self.webpackChunk_atlantis_weather=self.webpackChunk_atlantis_weather||[]).push([["460"],{2787(o,e,r){r.d(e,{FlyoutPanel:()=>u});var t=r(5723),a=r(7991),i=r.n(a),n=r(6859),s=r.n(n),l=r(2799),d=r(6063),p=r(7993),c=r(4971);let g=(0,l.keyframes)`
...
`,s().div`
  ...
  flex-direction: column;
  gap: 14px;
  animation: ${A} 0.18s cubic-bezier(0.22, 1, 0.36, 1) both;
`,s().div`
  font-size: ${l.w4.typography.fontSizeMd};
  font-weight: 700;
...
`,s().div`
  position: relative;
`;let X="260px",q="56px",W="48px",_=s().header`
  display: flex;
  align-items: center;
...
`,oe=s().main`
  ...
  display: flex;
  flex-direction: column;
`,or=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function ot(){return(0,t.jsx)(K,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:or.map((o,e)=>(0,t.jsx)(G,{index:e,accent:o.accent,children:o.char},e))})}let oa="atlantis:sidebar-collapsed";function oi({sidebar:o,children:e,topBarRight:n,title:s="Atlantis",activeId:l=null}){let[d,p]=(0,a.useState)(()=>{try{return"true"===localStorage.getItem(oa)}catch{return!1}}),[c,g]=(0,a.useState)(null),x=(0,a.useRef)(),f=()=>p(o=>{let e=!o;try{localStorage.setItem(oa,String(e))}catch{}return e}),h=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(r.bind(r,2787)).then(o=>({default:o.FlyoutPanel}))),[]);return(0,t.jsx)(R.I.Provider,{value:{collapsed:d,toggle:f,flyout:c,openFlyout:(o,e,r)=>{clearTimeout(x.current),g({entry:o,anchorY:e,onSelect:r})},scheduleFlyoutClose:()=>{x.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(x.current)},children:(0,t.jsxs)(Q,{children:[(0,t.jsxs)(_,{children:[o&&(0,t.jsx)(E,{children:(0,t.jsx)(O,{onClick:f,title:d?"Expand sidebar":"Collapse sidebar",children:(0,t.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("path",{d:"M9 3v18"})]})})}),(0,t.jsx)(ot,{}),s&&(0,t.jsx)(Z,{children:s}),n&&(0,t.jsx)(U,{children:n})]}),(0,t.jsxs)(N,{children:[null!=o&&(0,t.jsx)(J,{collapsed:d,children:(0,t.jsx)(oo,{children:o})}),(0,t.jsx)(oe,{children:e})]}),c&&(0,t.jsx)(i().Suspense,{fallback:null,children:(0,t.jsx)(h,{activeId:l})})]})})}var on=r(4971);let os=s().div`
  display: grid;
  grid-template-rows: ${({open:o})=>o?"1fr":"0fr"};
...
`;function ob({iconKey:o,size:e=16}){let r=o?on.X[o]:void 0;return r?(0,t.jsx)("svg",{width:e,height:e,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,dangerouslySetInnerHTML:{__html:r}}):o?(0,t.jsx)("span",{style:{fontSize:e,lineHeight:1,display:"flex",alignItems:"center"},children:o}):(0,t.jsxs)("svg",{width:e,height:e,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,children:[(0,t.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,t.jsx)("polyline",{points:"14 2 14 8 20 8"})]})}function ow({entry:o,activeId:e,onSelect:r}){let[i,n]=(0,a.useState)(o.defaultOpen??!0),{collapsed:s,openFlyout:l,scheduleFlyoutClose:d,cancelFlyoutClose:p}=(0,R.c)();return o.children&&o.children.length>0?(0,t.jsxs)(op,{children:[(0,t.jsxs)(oc,{collapsed:s,onClick:()=>{s||n(o=>!o)},onMouseEnter:s?e=>{l(o,e.currentTarget.getBoundingClientRect().top,r)}:void 0,onMouseLeave:s?d:void 0,children:[(0,t.jsxs)(og,{collapsed:s,children:[(0,t.jsx)(ob,{iconKey:o.icon,size:16}),(0,t.jsx)(ox,{collapsed:s,children:o.name})]}),(0,t.jsx)(of,{open:i,collapsed:s,children:(0,t.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round",children:(0,t.jsx)("path",{d:"M9 6l6 6-6 6"})})})]}),(0,t.jsx)(os,{open:i&&!s,children:(0,t.jsx)(ol,{children:(0,t.jsx)(od,{children:o.children.map(o=>(0,t.jsx)(ow,{entry:o,activeId:e,onSelect:r},o.id))})})})]}):(0,t.jsxs)(oh,{active:e===o.id,collapsed:s,onClick:()=>r(o),onMouseEnter:s?e=>{let t=e.currentTarget.getBoundingClientRect();l({id:o.id,name:o.name,icon:o.icon,file:o.file,children:[o]},t.top,r)}:void 0,onMouseLeave:s?d:void 0,children:[(0,t.jsx)(ob,{iconKey:o.icon,size:15}),(0,t.jsx)(ox,{collapsed:s,children:o.name})]})}function om({entries:o,activeId:e,onSelect:r}){return(0,t.jsx)("div",{children:o.map(o=>(0,t.jsx)(ow,{entry:o,activeId:e,onSelect:r},o.id))})}r(2787),s().div`
