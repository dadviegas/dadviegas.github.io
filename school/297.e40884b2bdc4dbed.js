"use strict";(self.webpackChunk_atlantis_school=self.webpackChunk_atlantis_school||[]).push([["297"],{9685(e,a,o){o.d(a,{WO:()=>aW});var i=o(5723),n=o(7991),r=o(9874),t=o(6859),l=o.n(t),s=o(7681),c=o(9753),d=o(8641),m=o(1783);function p(e){try{return JSON.parse(localStorage.getItem(e)??"[]")}catch{return[]}}let g=l().nav`padding: ${r.w4.spacing.sm} 0;`,u=l().div`
...
`;function k({title:e,icon:a,entries:o,activeId:r,onSelect:t,favorites:l,onToggleFav:s,collapsed:m}){let[p,g]=(0,n.useState)(!1);return o.length?(0,i.jsxs)(u,{children:[(0,i.jsxs)(f,{collapsed:m,onClick:()=>{m||g(e=>!e)},children:[(0,i.jsxs)(y,{collapsed:m,children:[a,(0,i.jsx)(h,{collapsed:m,children:e})]}),(0,i.jsx)(x,{open:p,collapsed:m,children:(0,i.jsx)(c.A,{size:12})})]}),(0,i.jsx)(b,{open:p&&!m,children:(0,i.jsx)(w,{children:o.map(e=>{let a=l.some(a=>a.id===e.id);return(0,i.jsxs)($,{children:[(0,i.jsx)(z,{active:r===e.id,onClick:()=>t(e),children:e.name}),(0,i.jsx)(v,{active:a,title:a?"Remover dos favoritos":"Adicionar aos favoritos",onClick:a=>{a.stopPropagation(),s(e)},children:(0,i.jsx)(d.A,{size:12,fill:a?"currentColor":"none"})})]},e.id)})})})]}):null}function A({config:e,activeId:a,onSelect:o,hashPrefix:t}){let l=`atlantis-recent-${t}`,s=`atlantis-fav-${t}`,{collapsed:c}=(0,r.cL)(),[u,f]=(0,n.useState)(()=>p(l)),[y,h]=(0,n.useState)(()=>p(s)),x=(0,n.useCallback)(e=>{e.file&&f(a=>{let o;return o=[e,...a.filter(a=>a.id!==e.id)].slice(0,10),localStorage.setItem(l,JSON.stringify(o)),o}),o(e)},[o,l]),b=(0,n.useCallback)(e=>{h(a=>{let o;return o=a.some(a=>a.id===e.id)?a.filter(a=>a.id!==e.id):[...a,e],localStorage.setItem(s,JSON.stringify(o)),o})},[s]);return(0,i.jsxs)(g,{children:[(0,i.jsx)(k,{title:"Recentes",icon:(0,i.jsx)(m.A,{size:13}),entries:u,activeId:a,onSelect:x,favorites:y,onToggleFav:b,collapsed:c}),(0,i.jsx)(k,{title:"Favoritos",icon:(0,i.jsx)(d.A,{size:13}),entries:y,activeId:a,onSelect:x,favorites:y,onToggleFav:b,collapsed:c}),(0,i.jsx)(r.CD,{entries:e.entries,activeId:a,onSelect:x})]})}var j=o(1352),S=o(6710),M=o(6225),T=o(302),C=o(3639),B=o(80),E=o(4311),F=o(2799);let R="https://cdn.jsdelivr.net/npm/mermaid@11.14.0/dist/mermaid.min.js",L=null,P="#7fb77e",O=(0,F.keyframes)`
...
`,H=!1,G=/^(?:---[\s\S]*?---\s*)?(?:graph|flowchart|sequenceDiagram|classDiagram|stateDiagram(?:-v2)?|erDiagram|pie|gantt|journey|mindmap|gitGraph|sankey(?:-beta)?|quadrantChart|requirementDiagram|timeline|xychart-beta|block-beta|C4Context|C4Container|C4Component|C4Dynamic|C4Deployment)\b/;function W({code:e}){let[a,o]=(0,n.useState)(""),[r,t]=(0,n.useState)(!1);return((0,n.useEffect)(()=>{let a=!1;t(!1),o("");let i=e.trim();if(!i)return void t(!0);let n=i.split(/\r?\n/)[0]?.trim()??"";if(!G.test(n))return void t(!0);let r=setTimeout(()=>{a||(console.error("[MermaidBlock] render timed out after 5s"),t(!0))},5e3);return(async()=>{try{let e=await (L||(L=new Promise((e,a)=>{let o=globalThis.mermaid;if(o)return void e(o);let i=document.createElement("script");i.src=R,i.async=!0,i.onload=()=>{let o=globalThis.mermaid;o?e(o):a(Error("mermaid loaded but globalThis.mermaid missing"))},i.onerror=()=>a(Error(`failed to load ${R}`)),document.head.appendChild(i)})));if(console.debug("[MermaidBlock] mermaid ready",{initialized:H}),!H){let a="#141820",o="#1c2332",i="#343c4f",n="#e8edf5",r="#9aa5b8",t="#7fb77e",l="#6aa8d8",s="#8b7bff",c="#e89a5c",d="#f87171";e.initialize({startOnLoad:!1,theme:"base",securityLevel:"loose",themeVariables:{fontFamily:"-apple-system, BlinkMacSystemFont, Segoe UI, Helvetica, Arial, sans-serif",background:a,mainBkg:o,primaryColor:t,primaryTextColor:n,primaryBorderColor:t,secondaryColor:s,secondaryTextColor:n,secondaryBorderColor:s,tertiaryColor:l,tertiaryTextColor:n,tertiaryBorderColor:l,lineColor:r,textColor:n,nodeBorder:i,clusterBkg:a,clusterBorder:i,edgeLabelBackground:o,labelBackground:o,labelBorder:i,relationLabelBackground:o,relationLabelColor:n,pie1:t,pie2:s,pie3:l,pie4:c,pie5:"#ff6fa9",pie6:"#2dd4bf",pie7:d,pie8:t,pieStrokeColor:a,pieStrokeWidth:"2px",pieTitleTextSize:"18px",pieSectionTextSize:"13px",pieLegendTextSize:"13px",actorBkg:t,actorBorder:t,actorTextColor:a,signalColor:n,signalTextColor:n,labelBoxBkgColor:o,labelBoxBorderColor:i,labelTextColor:n,loopTextColor:n,noteBkgColor:c,noteBorderColor:c,noteTextColor:a,stateBkg:o,altBackground:a,attributeBackgroundColorOdd:o,attributeBackgroundColorEven:a,rowOdd:o,rowEven:a,gridColor:i,sectionBkgColor:o,sectionBkgColor2:a,taskBkgColor:s,taskTextColor:n,taskTextDarkColor:n,taskTextLightColor:n,taskTextOutsideColor:n,activeTaskBkgColor:t,activeTaskBorderColor:t,doneTaskBkgColor:r,doneTaskBorderColor:r,critBkgColor:d,critBorderColor:d}}),H=!0}console.debug("[MermaidBlock] calling mermaid.render");let{svg:n}=await e.render(`mermaid-${"u">typeof crypto&&"function"==typeof crypto.randomUUID?crypto.randomUUID().replace(/-/g,"").slice(0,8):Math.random().toString(36).slice(2,10).padEnd(8,"0")}`,i);if(clearTimeout(r),console.debug("[MermaidBlock] render returned",{length:n?.length??0}),a)return;if(!n||/aria-roledescription="error"/i.test(n))return void t(!0);o(n)}catch(e){clearTimeout(r),console.error("[MermaidBlock] render failed",e),a||t(!0)}})(),()=>{a=!0,clearTimeout(r)}},[e]),r)?(0,i.jsx)(I,{children:e.trim()}):a?(0,i.jsx)(N,{dangerouslySetInnerHTML:{__html:a}}):(0,i.jsx)(N,{children:(0,i.jsx)(D,{"aria-hidden":!0})})}let Y=["#388bfd","#3fb950","#d29922","#a371f7","#f87171","#22d3ee","#fb923c","#34d399","#f472b6","#818cf8"],V=l().div`
  background: ${r.w4.colors.codeBg};
  border: 1px solid ${r.w4.colors.codeBorder};
  border-radius: ${r.w4.borderRadius.md};
...
`,q=l().pre`
  ...
  color: ${r.w4.colors.mainTextMuted};
  white-space: pre-wrap;
`;function Z(e){if(e<=0)return 10;let a=Math.pow(10,Math.floor(Math.log10(e)));return Math.ceil(e/a)*a}function X({labels:e,data:a,colors:o}){let n=340,t=176,l=Z(Math.max(...a,1)),s=Math.min(40,n/e.length*.6),c=n/e.length,d=Array.from({length:6},(e,a)=>l/5*a);return(0,i.jsxs)("svg",{viewBox:"0 0 400 240",width:"100%",style:{maxWidth:400},children:[d.map((e,a)=>{let o=16+t-e/l*t;return(0,i.jsxs)("g",{children:[(0,i.jsx)("line",{x1:44,y1:o,x2:384,y2:o,stroke:r.w4.colors.border,strokeWidth:.5,strokeDasharray:0===a?"none":"3,3"}),(0,i.jsx)("text",{x:38,y:o+4,fill:r.w4.colors.mainTextMuted,fontSize:10,textAnchor:"end",fontFamily:r.w4.typography.fontFamily,children:Math.round(e)})]},a)}),a.map((a,n)=>{let d=44+c*n+c/2-s/2,m=a/l*t,p=16+t-m,g=o[n%o.length];return(0,i.jsxs)("g",{children:[(0,i.jsxs)("rect",{x:d,y:p,width:s,height:m,rx:3,fill:g,opacity:.85,children:[(0,i.jsx)("animate",{attributeName:"height",from:"0",to:m,dur:"0.5s",fill:"freeze"}),(0,i.jsx)("animate",{attributeName:"y",from:16+t,to:p,dur:"0.5s",fill:"freeze"})]}),(0,i.jsx)("text",{x:d+s/2,y:p-4,fill:r.w4.colors.mainText,fontSize:10,fontWeight:600,textAnchor:"middle",fontFamily:r.w4.typography.fontFamily,children:a}),(0,i.jsx)("text",{x:44+c*n+c/2,y:208,fill:r.w4.colors.mainTextMuted,fontSize:10,textAnchor:"middle",fontFamily:r.w4.typography.fontFamily,children:e[n].length>8?e[n].slice(0,7)+"…":e[n]})]},n)})]})}function Q({labels:e,data:a,colors:o}){let n=a.reduce((e,a)=>e+a,0)||1,t=-Math.PI/2,l=a.map((e,a)=>{let l=e/n*Math.PI*2,s=t,c=t+=l,d=120+90*Math.cos(s),m=120+90*Math.sin(s),p=120+90*Math.cos(c),g=120+90*Math.sin(c),u=+(l>Math.PI),f=s+l/2,y=120+58.5*Math.cos(f),h=120+58.5*Math.sin(f),x=Math.round(e/n*100);return(0,i.jsxs)("g",{children:[(0,i.jsx)("path",{d:`M 120 120 L ${d} ${m} A 90 90 0 ${u} 1 ${p} ${g} Z`,fill:o[a%o.length],stroke:r.w4.colors.codeBg,strokeWidth:2,opacity:.85}),x>=5&&(0,i.jsxs)("text",{x:y,y:h+4,fill:"#fff",fontSize:11,fontWeight:600,textAnchor:"middle",fontFamily:r.w4.typography.fontFamily,children:[x,"%"]})]},a)});return(0,i.jsx)("svg",{viewBox:"0 0 240 240",width:"100%",style:{maxWidth:240},children:l})}function ee({labels:e,data:a,colors:o}){let n=340,t=176,l=Z(Math.max(...a,1)),s=a.length>1?n/(a.length-1):n,c=o[0],d=a.map((e,a)=>({x:44+s*a,y:16+t-e/l*t})),m=d.map((e,a)=>`${0===a?"M":"L"} ${e.x} ${e.y}`).join(" "),p=Array.from({length:6},(e,a)=>l/5*a);return(0,i.jsxs)("svg",{viewBox:"0 0 400 240",width:"100%",style:{maxWidth:400},children:[p.map((e,a)=>{let o=16+t-e/l*t;return(0,i.jsxs)("g",{children:[(0,i.jsx)("line",{x1:44,y1:o,x2:384,y2:o,stroke:r.w4.colors.border,strokeWidth:.5,strokeDasharray:0===a?"none":"3,3"}),(0,i.jsx)("text",{x:38,y:o+4,fill:r.w4.colors.mainTextMuted,fontSize:10,textAnchor:"end",fontFamily:r.w4.typography.fontFamily,children:Math.round(e)})]},a)}),(0,i.jsx)("path",{d:m,fill:"none",stroke:c,strokeWidth:2.5,strokeLinecap:"round",strokeLinejoin:"round"}),d.map((o,n)=>(0,i.jsxs)("g",{children:[(0,i.jsx)("circle",{cx:o.x,cy:o.y,r:4,fill:c,stroke:r.w4.colors.codeBg,strokeWidth:2}),(0,i.jsx)("text",{x:o.x,y:o.y-10,fill:r.w4.colors.mainText,fontSize:10,fontWeight:600,textAnchor:"middle",fontFamily:r.w4.typography.fontFamily,children:a[n]}),(0,i.jsx)("text",{x:o.x,y:208,fill:r.w4.colors.mainTextMuted,fontSize:10,textAnchor:"middle",fontFamily:r.w4.typography.fontFamily,children:e[n].length>8?e[n].slice(0,7)+"…":e[n]})]},n))]})}function ea({code:e}){let a=(0,n.useMemo)(()=>(function(e){let a,o,i=e.trim().split("\n"),n="bar",r=[],t=[];for(let e of i){let[i,...l]=e.split(":"),s=l.join(":").trim();if(s)switch(i.trim().toLowerCase()){case"type":["bar","pie","line"].includes(s.toLowerCase())&&(n=s.toLowerCase());break;case"title":a=s;break;case"labels":r=s.replace(/^\[|\]$/g,"").split(",").map(e=>e.trim());break;case"data":t=s.replace(/^\[|\]$/g,"").split(",").map(e=>parseFloat(e.trim())||0);break;case"colors":o=s.replace(/^\[|\]$/g,"").split(",").map(e=>e.trim())}}return r.length&&t.length?{type:n,title:a,labels:r,data:t,colors:o}:null})(e),[e]);if(!a)return(0,i.jsx)(q,{children:e.trim()});let o=a.colors??Y;return(0,i.jsxs)(V,{children:[a.title&&(0,i.jsx)(K,{children:a.title}),"bar"===a.type&&(0,i.jsx)(X,{labels:a.labels,data:a.data,colors:o}),"pie"===a.type&&(0,i.jsx)(Q,{labels:a.labels,data:a.data,colors:o}),"line"===a.type&&(0,i.jsx)(ee,{labels:a.labels,data:a.data,colors:o}),(0,i.jsx)(_,{children:a.labels.map((e,a)=>(0,i.jsxs)(U,{children:[(0,i.jsx)(J,{color:o[a%o.length]}),e]},a))})]})}let eo=l().div`
  background: ${r.w4.colors.codeBg};
  border: 1px solid ${r.w4.colors.codeBorder};
  border-radius: ${r.w4.borderRadius.md};
  padding: ${r.w4.spacing.lg};
...
`,es=l().div`
  ...
  color: ${r.w4.colors.mainText};
  text-align: center;
`;function ec(e){return e.toString().padStart(2,"0")}function ed({hours:e,minutes:a,seconds:o}){let n=e=>e*Math.PI/180,t=o/60*360-90,l=a/60*360+o/60*6-90,s=e%12/12*360+a/60*30-90,c=100+61*Math.cos(n(t)),d=100+61*Math.sin(n(t)),m=100+65*Math.cos(n(l)),p=100+65*Math.sin(n(l)),g=100+45*Math.cos(n(s)),u=100+45*Math.sin(n(s));return(0,i.jsxs)("svg",{viewBox:"0 0 200 200",width:200,height:200,children:[(0,i.jsx)("circle",{cx:100,cy:100,r:85,fill:r.w4.colors.surface,stroke:r.w4.colors.border,strokeWidth:2}),Array.from({length:12},(e,a)=>{let o=a+1,t=o/12*360-90,l=100+69*Math.cos(n(t)),s=100+69*Math.sin(n(t));return(0,i.jsx)("text",{x:l,y:s+4,fill:r.w4.colors.mainText,fontSize:14,fontWeight:600,textAnchor:"middle",fontFamily:r.w4.typography.fontFamily,children:o},o)}),Array.from({length:60},(e,a)=>{let o=a/60*360-90,t=a%5==0,l=t?75:79;return(0,i.jsx)("line",{x1:100+l*Math.cos(n(o)),y1:100+l*Math.sin(n(o)),x2:100+83*Math.cos(n(o)),y2:100+83*Math.sin(n(o)),stroke:t?r.w4.colors.mainTextMuted:r.w4.colors.border,strokeWidth:t?2:1},a)}),(0,i.jsx)("line",{x1:100,y1:100,x2:g,y2:u,stroke:r.w4.colors.mainText,strokeWidth:4,strokeLinecap:"round"}),(0,i.jsx)("line",{x1:100,y1:100,x2:m,y2:p,stroke:r.w4.colors.accent,strokeWidth:2.5,strokeLinecap:"round"}),(0,i.jsx)("line",{x1:100-12*Math.cos(n(t)),y1:100-12*Math.sin(n(t)),x2:c,y2:d,stroke:"#f87171",strokeWidth:1.2,strokeLinecap:"round"}),(0,i.jsx)("circle",{cx:100,cy:100,r:4,fill:r.w4.colors.accent}),(0,i.jsx)("circle",{cx:100,cy:100,r:2,fill:"#f87171"})]})}function em({code:e}){let a=function(e){let a="pt";for(let o of e.trim().split("\n")){let[e,...i]=o.split(":"),n=i.join(":").trim();"locale"===e.trim().toLowerCase()&&(a=n.toLowerCase())}return{locale:a}}(e),[o,r]=(0,n.useState)("live"),[t,l]=(0,n.useState)(()=>new Date().getHours()),[s,c]=(0,n.useState)(()=>new Date().getMinutes()),[d,m]=(0,n.useState)(()=>new Date().getSeconds());(0,n.useEffect)(()=>{if("live"!==o)return;let e=()=>{let e=new Date;l(e.getHours()),c(e.getMinutes()),m(e.getSeconds())};e();let a=setInterval(e,1e3);return()=>clearInterval(a)},[o]);let p=(0,n.useCallback)(e=>{r("manual"),m(0),l(a=>((a+e)%24+24)%24)},[]),g=(0,n.useCallback)(e=>{r("manual"),m(0),c(a=>((a+e)%60+60)%60)},[]),u=(0,n.useCallback)(()=>r("live"),[]);return(0,i.jsxs)(eo,{children:[(0,i.jsxs)(ei,{children:[(0,i.jsx)(ed,{hours:t,minutes:s,seconds:d}),(0,i.jsxs)("div",{children:[(0,i.jsxs)(en,{children:[ec(t),":",ec(s),(0,i.jsxs)("span",{style:{fontSize:"24px",opacity:.5},children:[":",ec(d)]})]}),(0,i.jsx)(es,{children:function(e,a,o){if("pt"===o){let o=1===e?"1 hora":`${e} horas`;return 0===a?o:15===a?`${o} e um quarto`:30===a?`${o} e meia`:45===a?`um quarto para as ${12===e?1:e+1}`:`${o} e ${a} minutos`}let i=e<12?"AM":"PM",n=e%12||12;return 0===a?`${n} o'clock ${i}`:15===a?`quarter past ${n} ${i}`:30===a?`half past ${n} ${i}`:45===a?`quarter to ${n%12+1} ${i}`:`${n}:${ec(a)} ${i}`}(t%12||12,s,a.locale)})]})]}),(0,i.jsxs)(er,{children:[(0,i.jsx)(et,{onClick:()=>p(-1),children:"−1h"}),(0,i.jsx)(et,{onClick:()=>p(1),children:"+1h"}),(0,i.jsx)(et,{onClick:()=>g(-15),children:"−15m"}),(0,i.jsx)(et,{onClick:()=>g(15),children:"+15m"}),(0,i.jsx)(et,{onClick:()=>g(-5),children:"−5m"}),(0,i.jsx)(et,{onClick:()=>g(5),children:"+5m"}),(0,i.jsx)(et,{active:"live"===o,onClick:u,children:"pt"===a.locale?"Agora":"Now"})]}),(0,i.jsx)(el,{children:"pt"===a.locale?"Usa os bot\xf5es para mudar as horas e os minutos!":"Use the buttons to change the hours and minutes!"}),(0,i.jsx)(er,{children:[{label:"3:00",h:3,m:0},{label:"6:30",h:6,m:30},{label:"9:15",h:9,m:15},{label:"12:00",h:12,m:0},{label:"13:45",h:13,m:45},{label:"15:30",h:15,m:30},{label:"19:00",h:19,m:0},{label:"23:15",h:23,m:15}].map(e=>(0,i.jsx)(et,{onClick:()=>{r("manual"),l(e.h),c(e.m)},children:e.label},e.label))})]})}var ep=o(1604);let eg=["Samantha","Karen","Daniel","Moira","Rishi","Google UK English Female","Google US English"],eu=["Joana","Luciana","Catarina","Google portugu\xeas do Brasil"];function ef(e,a){if(!window.speechSynthesis)return;window.speechSynthesis.cancel();let o=new SpeechSynthesisUtterance(e);o.lang="pt"===a?"pt-PT":"en-US",o.rate=1,o.pitch=1;let i=function(e,a){let o="en"===a?"en":"pt";for(let i of"en"===a?eg:eu){let a=e.find(e=>e.name.includes(i)&&e.lang.startsWith(o));if(a)return a}return e.find(e=>e.lang.startsWith(o))}(window.speechSynthesis.getVoices(),a);i&&(o.voice=i,o.lang=i.lang),window.speechSynthesis.speak(o)}let ey=(0,F.keyframes)`
...
`,ej=l().span`
  font-size: ${r.w4.typography.fontSizeBase};
  color: ${r.w4.colors.mainTextMuted};
`;function eS({code:e}){let a=e.split("\n").map(e=>e.trim()).filter(e=>e&&e.includes("|")).map(e=>{let[a,o]=e.split("|").map(e=>e.trim());return{en:a??"",pt:o??""}}).filter(e=>e.en&&e.pt),o=(0,n.useRef)(null),r=(0,n.useRef)(!1),t=(0,n.useCallback)(e=>{o.current={x:e.touches[0].clientX,y:e.touches[0].clientY}},[]),l=(0,n.useCallback)((e,a)=>i=>{if(!o.current)return;let n=Math.abs(i.changedTouches[0].clientX-o.current.x),t=Math.abs(i.changedTouches[0].clientY-o.current.y);o.current=null,n>8||t>8||(r.current=!0,ef(e,a))},[]),s=(0,n.useCallback)((e,a)=>()=>{if(r.current){r.current=!1;return}ef(e,a)},[]);return a.length?(0,i.jsxs)(eh,{children:[(0,i.jsxs)(ex,{children:[(0,i.jsx)(ep.A,{size:12}),"Words to Listen / Palavras para Ouvir"]}),(0,i.jsx)(eb,{children:a.map(e=>(0,i.jsxs)(ew,{children:[(0,i.jsxs)(ez,{accentColor:"#58a6ff",onTouchStart:t,onTouchEnd:l(e.en,"en"),onClick:s(e.en,"en"),title:`Listen: ${e.en}`,children:[(0,i.jsx)(ek,{accentColor:"#58a6ff",children:(0,i.jsx)(ep.A,{size:16})}),(0,i.jsx)(eA,{children:e.en})]}),(0,i.jsxs)(ev,{accentColor:"#3fb950",onTouchStart:t,onTouchEnd:l(e.pt,"pt"),onClick:s(e.pt,"pt"),title:`Ouvir: ${e.pt}`,children:[(0,i.jsx)(ek,{accentColor:"#3fb950",children:(0,i.jsx)(ep.A,{size:16})}),(0,i.jsx)(ej,{children:e.pt})]})]},e.en))})]}):null}var eM=o(7223),eT=o(1426),eC=o(5609),eB=o(320);let eE=l().div`
  margin: ${r.w4.spacing.lg} 0;
  border-radius: ${r.w4.borderRadius.md};
  border: 1px solid ${r.w4.colors.codeBorder};
  overflow: hidden;
...
`,eP={...eT.A,'pre[class*="language-"]':{...eT.A['pre[class*="language-"]'],background:r.w4.colors.codeBg,margin:0,padding:"18px 20px",fontSize:"13px",lineHeight:"1.6",borderRadius:0},'code[class*="language-"]':{...eT.A['code[class*="language-"]'],background:"none",fontSize:"13px"}};function eO({lang:e="text",code:a}){let[o,t]=(0,n.useState)(!1);return(0,i.jsxs)(eE,{children:[(0,i.jsxs)(eF,{children:[(0,i.jsx)(eR,{children:e}),(0,i.jsxs)(eL,{copied:o,onClick:()=>{navigator.clipboard.writeText(a).then(()=>{t(!0),setTimeout(()=>t(!1),2e3)})},children:[o?(0,i.jsx)(eC.A,{size:12}):(0,i.jsx)(eB.A,{size:12}),o?"Copied!":"Copy"]})]}),(0,i.jsx)(eM.A,{language:e,style:eP,showLineNumbers:a.split("\n").length>8,lineNumberStyle:{color:"#484f58",minWidth:"2.5em",paddingRight:"1.5em",userSelect:"none",fontSize:"12px"},customStyle:{margin:0,background:r.w4.colors.codeBg},wrapLongLines:!1,children:a})]})}var eN=o(5569),eD=o(8218),eI=o(7230),eH=o(2966),eG=o(1069);let eW={NOTE:{bg:"rgba(88, 166, 255, 0.08)",border:"#58a6ff",icon:eN.A,label:"Note",color:"#58a6ff"},TIP:{bg:"rgba(63, 185, 80, 0.08)",border:"#3fb950",icon:eD.A,label:"Tip",color:"#3fb950"},IMPORTANT:{bg:"rgba(163, 113, 247, 0.08)",border:"#a371f7",icon:eI.A,label:"Important",color:"#a371f7"},WARNING:{bg:"rgba(210, 153, 34, 0.08)",border:"#d29922",icon:eH.A,label:"Warning",color:"#d29922"},CAUTION:{bg:"rgba(248, 81, 73, 0.08)",border:"#f85149",icon:eG.A,label:"Caution",color:"#f85149"}},eY=l().div`
  background: ${({bg:e})=>e};
...
`;function e_({type:e,children:a}){let o=eW[e]??eW.NOTE,n=o.icon;return(0,i.jsxs)(eY,{bg:o.bg,border:o.border,children:[(0,i.jsxs)(eV,{color:o.color,children:[(0,i.jsx)(n,{size:15,strokeWidth:2}),o.label]}),(0,i.jsx)(eK,{children:a})]})}let eU=l().nav`
  width: 220px;
  min-width: 220px;
...
`,eJ=l().div`
  ...
  font-family: ${r.w4.typography.fontFamily};
  margin-bottom: ${r.w4.spacing.md};
`,eq=l().ul`list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 2px;`,eZ=l().a`
  display: block;
  padding: 4px 8px;
...
`;function eX({headings:e,activeId:a}){return e.length<2?null:(0,i.jsxs)(eU,{children:[(0,i.jsx)(eJ,{children:"On this page"}),(0,i.jsx)(eq,{children:e.map(e=>(0,i.jsx)("li",{children:(0,i.jsx)(eZ,{href:`#${e.id}`,active:a===e.id,level:e.level,onClick:a=>{a.preventDefault(),document.getElementById(e.id)?.scrollIntoView({behavior:"smooth",block:"start"})},children:e.text})},e.id))})]})}function eQ(e){return e.toLowerCase().replace(/[*_`[\]()#]/g,"").replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-").trim()}function e0(){return e=>{!function e(a){if("blockquote"===a.type){let e=a.children?.[0];if(e?.type==="paragraph"){let o=e.children?.[0];if(o?.type==="text"){let i=o.value?.match(/^\[!(NOTE|TIP|WARNING|CAUTION|IMPORTANT)\]\s*/i);i&&(o.value=o.value.slice(i[0].length),o.value.trim()||1!==e.children.length||a.children.shift(),a.data=a.data??{},a.data.hName="div",a.data.hProperties={"data-callout":i[1].toUpperCase()})}}}a.children?.forEach(e)}(e)}}let e1=l().div`
  display: flex;
...
`,e4=l().div`flex: 1; min-width: 0;`,e2=l().article`
...
`,e9=l().div`
  ...
  font-family: ${r.w4.typography.fontFamily};
`;function e7(e){return function({children:a,...o}){let r=`h${e}`,t=function e(a){return n.Children.toArray(a).map(a=>"string"==typeof a?a:"number"==typeof a?String(a):(0,n.isValidElement)(a)?e(a.props.children??""):"").join("")}(a),l=eQ(t);return(0,i.jsxs)(r,{id:l,...o,children:[a,(0,i.jsx)("a",{className:"heading-anchor",href:`#${l}`,"aria-label":`Link to "${t}"`,children:(0,i.jsx)(M.A,{size:14})})]})}}function ae({file:e,prevEntry:a,nextEntry:r,onNavigate:t,scrollToId:l,onScrolled:s}){let[d,m]=(0,n.useState)(null),[p,g]=(0,n.useState)(null),u=(0,n.useRef)(null);if((0,n.useEffect)(()=>{m(null),fetch(`${o.p}content/${e}`).then(e=>{if(!e.ok)throw Error(`${e.status} ${e.statusText}`);return e.text()}).then(m).catch(a=>m(`> **Error loading \`${e}\`:** ${a.message}`))},[e]),(0,n.useEffect)(()=>{if(!l||!d||!u.current)return;let e=setTimeout(()=>{let e=u.current?.querySelector(`#${CSS.escape(l)}`);e&&(e.scrollIntoView({behavior:"smooth",block:"start"}),g(l),s?.())},150);return()=>clearTimeout(e)},[l,d,s]),(0,n.useEffect)(()=>{if(!d||!u.current)return;let e=u.current,a=Array.from(e.querySelectorAll("h2[id], h3[id]"));if(!a.length)return;let o=e.parentElement;for(;o;){let{overflowY:e}=getComputedStyle(o);if(("auto"===e||"scroll"===e)&&o.scrollHeight>o.clientHeight)break;o=o.parentElement}let i=o??window,n=()=>{let e=a[0].id;for(let o of a)if(o.getBoundingClientRect().top-120<=0)e=o.id;else break;g(e)};return n(),i.addEventListener("scroll",n,{passive:!0}),window.addEventListener("resize",n),()=>{i.removeEventListener("scroll",n),window.removeEventListener("resize",n)}},[d]),null===d)return(0,i.jsx)(e9,{children:"Loading…"});let f=function(e){let a,o=[],i=/^(#{2,3})\s+(.+)$/gm;for(;null!==(a=i.exec(e));){let e=a[1].length,i=a[2].trim().replace(/\*\*(.+?)\*\*/g,"$1").replace(/\*(.+?)\*/g,"$1").replace(/`(.+?)`/g,"$1").replace(/\[(.+?)\]\(.+?\)/g,"$1");o.push({level:e,text:i,id:eQ(i)})}return o}(d),y=a||r;return(0,i.jsxs)(e1,{children:[(0,i.jsxs)(e4,{children:[(0,i.jsx)(e2,{ref:u,children:(0,i.jsx)(j.oz,{remarkPlugins:[S.A,E.A,e0],rehypePlugins:[C.A,B.A],components:{div({node:e,children:a,...o}){let n=o["data-callout"];return n?(0,i.jsx)(e_,{type:n,children:a}):(0,i.jsx)("div",{...o,children:a})},h1:e7(1),h2:e7(2),h3:e7(3),h4:e7(4),pre:({children:e})=>(0,i.jsx)(i.Fragment,{children:e}),code({className:e,children:a}){let o=/language-(\w+)/.exec(e??"")?.[1],n=String(a).replace(/\n$/,"");return"mermaid"===o?(0,i.jsx)(W,{code:n}):"chart"===o?(0,i.jsx)(ea,{code:n}):"clock"===o?(0,i.jsx)(em,{code:n}):"vocabulary"===o?(0,i.jsx)(eS,{code:n}):o||n.includes("\n")?(0,i.jsx)(eO,{lang:o,code:n}):(0,i.jsx)("code",{className:e,children:a})}},children:d})}),y&&(0,i.jsxs)(e3,{children:[a?(0,i.jsxs)(e5,{align:"left",onClick:()=>t?.(a),children:[(0,i.jsxs)(e8,{children:[(0,i.jsx)(T.A,{size:13})," Previous"]}),(0,i.jsx)(e6,{children:a.name})]}):(0,i.jsx)("div",{style:{flex:1}}),r?(0,i.jsxs)(e5,{align:"right",onClick:()=>t?.(r),children:[(0,i.jsxs)(e8,{children:["Next ",(0,i.jsx)(c.A,{size:13})]}),(0,i.jsx)(e6,{children:r.name})]}):(0,i.jsx)("div",{style:{flex:1}})]})]}),(0,i.jsx)(eX,{headings:f,activeId:p})]})}var aa=o(4525),ao=o(7071),ai=o(5751),an=o(2887);let ar=(0,F.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,at=(0,F.keyframes)`
...
`,aA=l().div`
  ...
  font-size: ${r.w4.typography.fontSizeSm};
  text-align: center;
`,aj=new Map;async function aS(e){let a=aj.get(e);if(void 0!==a)return a;try{let a=await fetch(`${o.p}content/${e}`);if(!a.ok)return"";let i=await a.text();return aj.set(e,i),i}catch{return aj.set(e,""),""}}function aM(e){return e.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,"")}function aT({open:e,onClose:a,entries:o,activeId:t,onSelect:l}){let[c,d]=(0,n.useState)(""),[m,p]=(0,n.useState)([]),[g,u]=(0,n.useState)(!1),[f,y]=(0,n.useState)(0),h=(0,n.useRef)(null),x=(0,n.useRef)(),b=(0,n.useMemo)(()=>(function e(a,o=""){return a.flatMap(a=>a.children?e(a.children,a.name):a.file?[{entry:a,parentName:o}]:[])})(o),[o]);(0,n.useEffect)(()=>{e&&(d(""),p([]),y(0),setTimeout(()=>h.current?.focus(),50))},[e]),(0,n.useEffect)(()=>{if(!e)return;let o=e=>{"Escape"===e.key&&(e.preventDefault(),a())};return window.addEventListener("keydown",o),()=>window.removeEventListener("keydown",o)},[e,a]);let w=(0,n.useCallback)(async e=>{if(e.length<2){p([]),u(!1);return}u(!0);let a=await Promise.all(b.map(async({entry:e,parentName:a})=>{let o=await aS(e.file);return{entry:e,parentName:a,text:o}})),o=[];for(let{entry:i,parentName:n,text:r}of a){let a=aM(i.name),t=aM(r),l=aM(e);if(!a.includes(l)&&!t.includes(l))continue;let{snippet:s,count:c,headingSlug:d,headingText:m}=function(e,a){let o=aM(e),i=aM(a),n=e.split("\n"),r=0,t=0;for(;-1!==(t=o.indexOf(i,t));)r++,t+=i.length;let l=null;for(let e of n){let o=e.match(/^#{1,4}\s+(.+)/);if(o&&(l=o[1].trim()),!e.trim()||e.startsWith("```")||e.startsWith("|--"))continue;let n=e.replace(/^#{1,6}\s*/,"").replace(/[*_`|]/g,"").trim(),t=n.normalize("NFD"),s=[],c=0;for(let e=0;e<t.length;e++){let a=t.charCodeAt(e);(!(a>=768)||!(a<=879))&&(s.push(c),c++)}s.push(c);let d=aM(n).indexOf(i);if(-1===d)continue;let m=s[d]??d,p=s[d+i.length]??m+a.length,g=Math.max(0,m-50),u=Math.min(n.length,p+70),f=g>0?"…":"",y=u<n.length?"…":"",h=n.slice(g,m),x=n.slice(m,p),b=n.slice(p,u);return{snippet:`${f}${h}<mark>${x}</mark>${b}${y}`,count:r,headingSlug:l?l.toLowerCase().replace(/[*_`[\]()#]/g,"").replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-").trim():null,headingText:l}}return{snippet:"",count:r,headingSlug:null,headingText:null}}(r,e),p=a.includes(l);o.push({entry:i,parentName:n,snippet:s||(p?i.name:""),matchCount:c+10*!!p,headingSlug:d,headingText:m})}o.sort((e,a)=>a.matchCount-e.matchCount),p(o),y(0),u(!1)},[b]);(0,n.useEffect)(()=>(clearTimeout(x.current),c.trim())?(x.current=setTimeout(()=>w(c.trim()),250),()=>clearTimeout(x.current)):void p([]),[c,w]);let $=(0,n.useCallback)(e=>{"ArrowDown"===e.key?(e.preventDefault(),y(e=>Math.min(e+1,m.length-1))):"ArrowUp"===e.key?(e.preventDefault(),y(e=>Math.max(e-1,0))):"Enter"===e.key&&m[f]&&(e.preventDefault(),l(m[f].entry,m[f].headingSlug),a())},[m,f,l,a]);return e?(0,i.jsx)(al,{onClick:e=>{e.target===e.currentTarget&&a()},children:(0,i.jsxs)(as,{onKeyDown:$,children:[(0,i.jsxs)(ac,{children:[(0,i.jsx)(s.A,{size:18,color:r.w4.colors.accent,style:{flexShrink:0}}),(0,i.jsx)(ad,{ref:h,placeholder:"Pesquisar em todo o conte\xfado…",value:c,onChange:e=>d(e.target.value)}),(0,i.jsx)(am,{onClick:a,title:"Fechar (Esc)",children:(0,i.jsx)(aa.A,{size:14})})]}),(0,i.jsxs)(ap,{children:[g&&(0,i.jsxs)(ag,{children:[(0,i.jsx)(au,{children:(0,i.jsx)(ao.A,{size:14})}),"A pesquisar ",b.length," ficheiros…"]}),!g&&c.length>=2&&m.length>0&&(0,i.jsxs)(ag,{children:[(0,i.jsx)(ai.A,{size:13}),m.length," ",1===m.length?"resultado":"resultados"," encontrados"]}),!g&&c.length>=2&&0===m.length&&(0,i.jsxs)(aA,{children:[(0,i.jsx)(s.A,{size:32,strokeWidth:1.2}),'Nenhum resultado para "',(0,i.jsx)("strong",{children:c}),'"']}),!g&&c.length<2&&(0,i.jsxs)(aA,{children:[(0,i.jsx)(s.A,{size:32,strokeWidth:1.2}),"Escreve pelo menos 2 caracteres para pesquisar"]}),m.map((e,o)=>(0,i.jsxs)(af,{selected:o===f,onClick:()=>{l(e.entry,e.headingSlug),a()},onMouseEnter:()=>y(o),children:[(0,i.jsx)(ay,{selected:o===f,children:(0,i.jsx)(ai.A,{size:15})}),(0,i.jsxs)(ah,{children:[(0,i.jsxs)(ax,{children:[e.entry.name,e.matchCount>0&&(0,i.jsx)(aw,{children:e.matchCount>10?e.matchCount-10:e.matchCount})]}),(e.parentName||e.headingText)&&(0,i.jsxs)(ab,{children:[e.parentName,e.parentName&&e.headingText?" › ":"",e.headingText]}),e.snippet&&(0,i.jsx)(a$,{dangerouslySetInnerHTML:{__html:e.snippet}})]}),(0,i.jsx)(az,{selected:o===f,children:(0,i.jsx)(an.A,{size:14})})]},e.entry.id))]}),(0,i.jsxs)(av,{children:[(0,i.jsxs)("span",{children:[(0,i.jsx)(ak,{children:"↑"})," ",(0,i.jsx)(ak,{children:"↓"})," navegar"]}),(0,i.jsxs)("span",{children:[(0,i.jsx)(ak,{children:"↵"})," abrir"]}),(0,i.jsxs)("span",{children:[(0,i.jsx)(ak,{children:"esc"})," fechar"]})]})]})}):null}function aC(e,a){for(let o of e){if(o.id===a)return o;if(o.children){let e=aC(o.children,a);if(e)return e}}}function aB(e){return e.flatMap(e=>e.children?aB(e.children):e.file?[e]:[])}let aE=l().div`
  display: flex;
  align-items: center;
  justify-content: center;
  height: 100%;
...
`,aI={en:"Browse the sidebar",pt:"Explora o menu lateral"};function aH({title:e,sub:a,lang:o}){return(0,i.jsxs)(aE,{children:[(0,i.jsx)(aR,{}),(0,i.jsx)(aF,{size:500,x:10,y:-10,hue:210,dur:7}),(0,i.jsx)(aF,{size:400,x:60,y:50,hue:270,dur:9}),(0,i.jsx)(aF,{size:300,x:30,y:70,hue:190,dur:6}),(0,i.jsxs)(aL,{children:[(0,i.jsx)(aP,{children:e}),(0,i.jsx)(aO,{children:a}),(0,i.jsxs)(aN,{children:[(0,i.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round",children:(0,i.jsx)("polyline",{points:"15 18 9 12 15 6"})}),aI[o]??aI.en]})]})]})}function aG(e,a,o){return"string"==typeof e?e:e[a]??e[o]??Object.values(e)[0]??""}function aW({navigation:e,languages:a,defaultLang:o,locale:t,hashPrefix:l,topBarRight:c,welcomeTitle:d="Blog",welcomeSub:m="Notes, guides, and references — pick a topic from the sidebar to get started."}){let p=a?Object.keys(a):[];p.length;let[g,u]=(0,n.useState)(()=>o??p[0]??"");(0,n.useEffect)(()=>{t&&p.includes(t)&&t!==g&&u(t)},[t]);let f=(0,n.useMemo)(()=>a&&g?a[g].navigation:e??{entries:[]},[a,e,g]);(0,n.useMemo)(()=>aB(f.entries),[f]);let y=(0,n.useCallback)(e=>{let a=e.match(RegExp(`^#\\/${l}\\/(.+)$`));if(a)return aC(f.entries,a[1])},[f,l]),[h,x]=(0,n.useState)(()=>y(window.location.hash)??null);(0,n.useEffect)(()=>{h&&x(aC(f.entries,h.id)??null)},[g,f]),(0,n.useEffect)(()=>{let e=()=>{let e=y(window.location.hash);e&&x(e)};return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[y]);let b=(0,n.useCallback)(e=>{e.file&&(x(e),window.location.hash=`#/${l}/${e.id}`)},[l]),w=(0,n.useMemo)(()=>aB(f.entries),[f]),$=w.findIndex(e=>e.id===h?.id),z=$>0?w[$-1]:null,v=$<w.length-1?w[$+1]:null,[k,j]=(0,n.useState)(!1),[S,M]=(0,n.useState)(null);(0,n.useEffect)(()=>{let e=e=>{(e.metaKey||e.ctrlKey)&&"f"===e.key&&(e.preventDefault(),j(!0))};return window.addEventListener("keydown",e),()=>window.removeEventListener("keydown",e)},[]);let T=h?.label??h?.name??l,C=aG(d,g,o??p[0]??""),B=aG(m,g,o??p[0]??""),E=(0,i.jsxs)(aD,{onClick:()=>j(!0),title:"Pesquisar (Ctrl+F)",children:[(0,i.jsx)(s.A,{size:14}),(0,i.jsx)("span",{children:"Pesquisar"}),(0,i.jsx)("kbd",{children:"⌘F"})]}),F=(0,i.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:"8px"},children:[E,c]});return(0,i.jsxs)(r.PE,{title:T,activeId:h?.id??null,topBarRight:F,sidebar:(0,i.jsx)(A,{config:f,activeId:h?.id??null,onSelect:b,hashPrefix:l}),children:[h?.file?(0,i.jsx)(ae,{file:h.file,prevEntry:z,nextEntry:v,onNavigate:b,scrollToId:S,onScrolled:()=>M(null)}):(0,i.jsx)(aH,{title:C,sub:B,lang:g}),(0,i.jsx)(aT,{open:k,onClose:()=>j(!1),entries:f.entries,activeId:h?.id??null,onSelect:(e,a)=>{b(e),M(a??null)}})]})}l().div`
  display: flex;
  gap: 4px;
  background: ${r.w4.colors.surface};
  border: 1px solid ${r.w4.colors.border};
...
`,l().span`
  ...
  font-weight: 600;
  margin-left: auto;
`},8170(e,a,o){o.d(a,{Ym:()=>c});var i=o(7991),n=o(9874);let r="atlantis:locale",t="shell:locale";function l(e){return"en"===e||"pt"===e}function s(){try{let e=localStorage.getItem(r);if(l(e))return e}catch{}return"en"}function c(){let[e,a]=(0,i.useState)(s),o=(0,i.useCallback)(e=>{a(e);try{localStorage.setItem(r,e)}catch{}(0,n.Is)(t,e).catch(()=>{}),window.dispatchEvent(new CustomEvent("atlantis:locale-change",{detail:e}))},[]);return(0,i.useEffect)(()=>{let e=e=>{a(e.detail)};return window.addEventListener("atlantis:locale-change",e),()=>window.removeEventListener("atlantis:locale-change",e)},[]),(0,i.useEffect)(()=>{(0,n.PL)(t).then(o=>{if(l(o)&&o!==e){try{localStorage.setItem(r,o)}catch{}a(o)}}).catch(()=>{})},[]),[e,o]}(0,n.PL)(t).then(e=>{if(l(e))try{localStorage.setItem(r,e)}catch{}}).catch(()=>{}),o(5723);var d=o(6859),m=o.n(d);m().div`
  display: flex;
  gap: 4px;
...
`},8859(e,a,o){o.d(a,{FlyoutPanel:()=>b});var i=o(5723),n=o(7991),r=o.n(n),t=o(6859),l=o.n(t),s=o(2799),c=o(1316),d=o(814),m=o(6140);let p=(0,s.keyframes)`
...
`,y=({size:e=14,strokeWidth:a=1.75})=>(0,i.jsxs)("svg",{width:e,height:e,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:a,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,i.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,i.jsx)("polyline",{points:"14 2 14 8 20 8"})]});function h({iconKey:e}){let a=e?m.t[e]:null;return a?(0,i.jsx)(a,{size:14,strokeWidth:1.75}):(0,i.jsx)(y,{})}function x({entries:e,activeId:a,onSelect:o}){return(0,i.jsx)(i.Fragment,{children:e.map(e=>e.children?(0,i.jsx)(r().Fragment,{children:(0,i.jsx)(x,{entries:e.children,activeId:a,onSelect:o})},e.id):(0,i.jsxs)(f,{active:a===e.id,onClick:()=>o(e),children:[(0,i.jsx)(h,{iconKey:e.icon}),e.name]},e.id))})}function b({activeId:e}){let{flyout:a,scheduleFlyoutClose:o,cancelFlyoutClose:n}=(0,d.c)();if(!a)return null;let r=a.entry.icon?m.t[a.entry.icon]:null;return(0,i.jsxs)(g,{anchorY:a.anchorY,onMouseEnter:n,onMouseLeave:o,children:[(0,i.jsxs)(u,{children:[r?(0,i.jsx)(r,{size:13,strokeWidth:2}):(0,i.jsx)(y,{size:13,strokeWidth:2}),a.entry.name]}),(0,i.jsx)(x,{entries:a.entry.children??[],activeId:e,onSelect:e=>{a.onSelect(e),o()}})]})}},814(e,a,o){o.d(a,{I:()=>n,c:()=>r});var i=o(7991);let n=(0,i.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),r=()=>(0,i.useContext)(n)},6140(e,a,o){o.d(a,{t:()=>eb});var i=o(6896),n=o(7902),r=o(3013),t=o(2887),l=o(9510),s=o(9848),c=o(7901),d=o(3045),m=o(3775),p=o(1783),g=o(3539),u=o(9416),f=o(1837),y=o(7167),h=o(4494),x=o(2314),b=o(255),w=o(5751),$=o(9633),z=o(2946),v=o(822),k=o(6720),A=o(7400),j=o(8456),S=o(3317),M=o(2709),T=o(8006),C=o(9301),B=o(7561),E=o(3517),F=o(8207),R=o(7032),L=o(6949),P=o(8218),O=o(6829),N=o(9591),D=o(5553),I=o(9923),H=o(2820),G=o(4621),W=o(8479),Y=o(2534),V=o(6673),K=o(7490),_=o(9033),U=o(9038),J=o(5775),q=o(1365),Z=o(4893),X=o(2937),Q=o(9821),ee=o(5912),ea=o(158),eo=o(8641),ei=o(8607),en=o(3249),er=o(1821),et=o(5889),el=o(9655),es=o(7170),ec=o(9161),ed=o(1849),em=o(1604),ep=o(3142),eg=o(1187),eu=o(7747),ef=o(2932),ey=o(4525),eh=o(7230),ex=o(2164);let eb={activity:i.A,"a-large-small":n.A,apple:r.A,"arrow-right":t.A,"bar-chart-2":l.A,book:s.A,"book-open":c.A,briefcase:d.A,calendar:m.A,clock:p.A,"circle-dot":g.A,cloud:u.A,compass:f.A,cpu:y.A,droplets:h.A,feather:x.A,file:b.A,"file-text":w.A,folder:$.A,"git-branch":z.A,github:v.A,globe:k.A,grid:A.A,hand:j.A,hash:S.A,heart:M.A,key:T.A,hexagon:C.A,home:B.A,landmark:E.A,layers:F.A,"layout-grid":R.A,leaf:L.A,lightbulb:P.A,list:O.A,map:N.A,"map-pin":D.A,"message-circle":I.A,"message-square":H.A,minus:G.A,monitor:W.A,mountain:Y.A,package:V.A,palette:K.A,"pen-tool":_.A,"pie-chart":U.A,plane:J.A,plus:q.A,puzzle:Z.A,ruler:X.A,shirt:Q.A,slash:ee.A,square:ea.A,star:eo.A,sun:ei.A,terminal:en.A,thermometer:er.A,triangle:et.A,trophy:el.A,truck:es.A,type:ec.A,users:ed.A,"volume-2":em.A,watch:ep.A,waves:eg.A,wind:eu.A,wrench:ef.A,x:ey.A,zap:eh.A,bot:ex.A}},9874(e,a,o){o.d(a,{w4:()=>i.w4,cL:()=>d.c,CD:()=>W,PE:()=>C,Is:()=>V.putSetting,PL:()=>V.getSetting});var i=o(1316),n=o(5723),r=o(7991),t=o.n(r),l=o(6859),s=o.n(l);s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,s().div`
  position: relative;
`;var c=o(2799),d=o(814);let m="260px",p="56px",g="48px",u=s().header`
  display: flex;
  align-items: center;
