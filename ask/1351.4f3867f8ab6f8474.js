...
`,oF=({size:o=14,strokeWidth:e=1.75})=>(0,t.jsxs)("svg",{width:o,height:o,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:e,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,t.jsx)("polyline",{points:"14 2 14 8 20 8"})]});function oC({iconKey:o}){let e=o?oA[o]:null;return e?(0,t.jsx)(e,{size:14,strokeWidth:1.75}):(0,t.jsx)(oF,{})}function oR({entries:o,activeId:e,onSelect:a}){return(0,t.jsx)(t.Fragment,{children:o.map(o=>o.children?(0,t.jsx)(i().Fragment,{children:(0,t.jsx)(oR,{entries:o.children,activeId:e,onSelect:a})},o.id):(0,t.jsxs)(oB,{active:e===o.id,onClick:()=>a(o),children:[(0,t.jsx)(oC,{iconKey:o.icon}),o.name]},o.id))})}function oL({activeId:o}){let{flyout:e,scheduleFlyoutClose:a,cancelFlyoutClose:r}=(0,c.c)();if(!e)return null;let i=e.entry.icon?oA[e.entry.icon]:null;return(0,t.jsxs)(oS,{anchorY:e.anchorY,onMouseEnter:r,onMouseLeave:a,children:[(0,t.jsxs)(oj,{children:[i?(0,t.jsx)(i,{size:13,strokeWidth:2}):(0,t.jsx)(oF,{size:13,strokeWidth:2}),e.entry.name]}),(0,t.jsx)(oR,{entries:e.entry.children??[],activeId:o,onSelect:o=>{e.onSelect(o),a()}})]})}},40814(o,e,a){a.d(e,{I:()=>r,c:()=>i});var t=a(37991);let r=(0,t.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),i=()=>(0,t.useContext)(r)},23930(o,e,a){a.d(e,{kd:()=>C.deleteDoc,PL:()=>C.getSetting,mZ:()=>C.updateDoc,KL:()=>C.saveDoc,cL:()=>c.c,Is:()=>C.putSetting,Iu:()=>C.listDocs,PE:()=>B,fy:()=>H,w4:()=>t.w4});var t=a(81316),r=a(65723),i=a(37991),n=a.n(i),l=a(36859),s=a.n(l);s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,b=i().forwardRef(function({variant:o="ghost",size:e="md",icon:a,iconRight:r,children:i,...n},l){return(0,t.jsxs)(h,{ref:l,variant:o,size:e,...n,children:[a,i,r]})}),y={default:s.w4.colors.accent,danger:"#f85149"},w={default:s.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"},$=l().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`,v=i().forwardRef(function({active:o=!1,shape:e="square",tone:a="default",children:r,...i},n){return(0,t.jsx)($,{ref:n,active:o,shape:e,tone:a,...i,children:r})}),z=l().div`
  position: relative;
  display: inline-flex;
`,k=l().div`
  position: absolute;
  ...
  z-index: 2000;
  overflow: hidden;
`;function M({trigger:o,children:e,align:a="right",open:n,onOpenChange:l}){let[s,d]=(0,r.useState)(!1),c=n??s,p=o=>{l&&l(o),void 0===n&&d(o)},g=(0,r.useRef)(null);(0,r.useEffect)(()=>{if(!c)return;let o=o=>{g.current&&!g.current.contains(o.target)&&p(!1)};return document.addEventListener("mousedown",o),()=>document.removeEventListener("mousedown",o)},[c]);let m=i().cloneElement(o,{onClick:e=>{o.props.onClick?.(e),p(!c)},"aria-expanded":c,"aria-haspopup":"menu"});return(0,t.jsxs)(z,{ref:g,children:[m,c&&(0,t.jsx)(k,{align:a,role:"menu",children:e})]})}let A=l().button`
  display: flex;
  align-items: center;
  gap: 10px;
  padding: 8px 12px;
...
`,a(62727);var T=a(72799);let S=(0,T.keyframes)`
...
`,Z=!1,J=/^(?:---[\s\S]*?---\s*)?(?:graph|flowchart|sequenceDiagram|classDiagram|stateDiagram(?:-v2)?|erDiagram|pie|gantt|journey|mindmap|gitGraph|sankey(?:-beta)?|quadrantChart|requirementDiagram|timeline|xychart-beta|block-beta|C4Context|C4Container|C4Component|C4Dynamic|C4Deployment)\b/;function X({code:o}){let[e,i]=(0,r.useState)(""),[n,l]=(0,r.useState)(!1);return((0,r.useEffect)(()=>{let e=!1;l(!1),i("");let t=o.trim();if(!t)return void l(!0);let r=t.split(/\r?\n/)[0]?.trim()??"";return J.test(r)?((async()=>{try{let o=(await a.e("6087").then(a.bind(a,29738))).default;if(!Z){let e="#141820",a="#1c2332",t="#343c4f",r="#e8edf5",i="#9aa5b8",n="#7fb77e",l="#6aa8d8",s="#8b7bff",d="#e89a5c",c="#f87171";o.initialize({startOnLoad:!1,theme:"base",securityLevel:"loose",themeVariables:{fontFamily:"-apple-system, BlinkMacSystemFont, Segoe UI, Helvetica, Arial, sans-serif",background:e,mainBkg:a,primaryColor:n,primaryTextColor:r,primaryBorderColor:n,secondaryColor:s,secondaryTextColor:r,secondaryBorderColor:s,tertiaryColor:l,tertiaryTextColor:r,tertiaryBorderColor:l,lineColor:i,textColor:r,nodeBorder:t,clusterBkg:e,clusterBorder:t,edgeLabelBackground:a,labelBackground:a,labelBorder:t,relationLabelBackground:a,relationLabelColor:r,pie1:n,pie2:s,pie3:l,pie4:d,pie5:"#ff6fa9",pie6:"#2dd4bf",pie7:c,pie8:n,pieStrokeColor:e,pieStrokeWidth:"2px",pieTitleTextSize:"18px",pieSectionTextSize:"13px",pieLegendTextSize:"13px",actorBkg:n,actorBorder:n,actorTextColor:e,signalColor:r,signalTextColor:r,labelBoxBkgColor:a,labelBoxBorderColor:t,labelTextColor:r,loopTextColor:r,noteBkgColor:d,noteBorderColor:d,noteTextColor:e,stateBkg:a,altBackground:e,attributeBackgroundColorOdd:a,attributeBackgroundColorEven:e,rowOdd:a,rowEven:e,gridColor:t,sectionBkgColor:a,sectionBkgColor2:e,taskBkgColor:s,taskTextColor:r,taskTextDarkColor:r,taskTextLightColor:r,taskTextOutsideColor:r,activeTaskBkgColor:n,activeTaskBorderColor:n,doneTaskBkgColor:i,doneTaskBorderColor:i,critBkgColor:c,critBorderColor:c}}),Z=!0}let{svg:r}=await o.render(`mermaid-${(0,O.z)()}`,t);if(e)return;if(!r||/aria-roledescription="error"/i.test(r))return void l(!0);i(r)}catch(o){console.error("[MermaidBlock] render failed",o),e||l(!0)}})(),()=>{e=!0}):void l(!0)},[o]),n)?(0,t.jsx)(q,{children:o.trim()}):(0,t.jsx)(U,{dangerouslySetInnerHTML:{__html:e}})}let Q=["#388bfd","#3fb950","#d29922","#a371f7","#f87171","#22d3ee","#fb923c","#34d399","#f472b6","#818cf8"],oo=l().div`
  background: ${s.w4.colors.codeBg};
  border: 1px solid ${s.w4.colors.codeBorder};
  border-radius: ${s.w4.borderRadius.md};
...
`;function oP(){let o=/^\[!(NOTE|TIP|WARNING|CAUTION|IMPORTANT)\]\s*/i;return e=>{function a(e,a,t){let r=a.children?.[0];r?.type==="text"&&(r.value=r.value.replace(o,""),r.value.trim()||1!==a.children.length||a.children.shift()),e.data=e.data??{},e.data.hName="div",e.data.hProperties={"data-callout":t.toUpperCase()}}!function e(t){if("blockquote"===t.type){let e=t.children?.[0];if(e?.type==="paragraph"){let r=e.children?.[0],i=r?.type==="text"&&r.value?.match(o);i&&a(t,e,i[1])}}if("paragraph"===t.type){let e=t.children?.[0],r=e?.type==="text"&&e.value?.match(o);if(r){let e=[...t.children];t.children=[{type:"paragraph",children:e}],a(t,t.children[0],r[1]);let i=e[0];i?.type==="text"&&(i.value=i.value.replace(o,""),i.value.trim()||1!==e.length||e.shift());return}}t.children?.forEach(e)}(e)}}l().div`
  position: fixed;
  inset: 0;
  z-index: 9999;
