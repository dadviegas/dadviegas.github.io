...
`,u=i().forwardRef(function({variant:e="ghost",size:o="md",icon:t,iconRight:a,children:i,...n},l){return(0,r.jsxs)(b,{ref:l,variant:e,size:o,...n,children:[t,i,a]})}),w={default:s.w4.colors.accent,danger:"#f85149"},y={default:s.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"},$=l().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`,v=i().forwardRef(function({active:e=!1,shape:o="square",tone:t="default",children:a,...i},n){return(0,r.jsx)($,{ref:n,active:e,shape:o,tone:t,...i,children:a})}),M=l().div`
  position: relative;
  display: inline-flex;
`,k=l().div`
  position: absolute;
  ...
  z-index: 2000;
  overflow: hidden;
`;function z({trigger:e,children:o,align:t="right",open:n,onOpenChange:l}){let[s,d]=(0,a.useState)(!1),c=n??s,p=e=>{l&&l(e),void 0===n&&d(e)},g=(0,a.useRef)(null);(0,a.useEffect)(()=>{if(!c)return;let e=e=>{g.current&&!g.current.contains(e.target)&&p(!1)};return document.addEventListener("mousedown",e),()=>document.removeEventListener("mousedown",e)},[c]);let h=i().cloneElement(e,{onClick:o=>{e.props.onClick?.(o),p(!c)},"aria-expanded":c,"aria-haspopup":"menu"});return(0,r.jsxs)(M,{ref:g,children:[h,c&&(0,r.jsx)(k,{align:t,role:"menu",children:o})]})}let T=l().button`
  display: flex;
  align-items: center;
  gap: 10px;
  padding: 8px 12px;
...
`;let L=l().kbd`
  ...
  white-space: nowrap;
`;function R({children:e,...o}){return(0,r.jsx)(L,{...o,children:e})}let V=l().div`
  font-family: ${s.w4.typography.fontFamilyMono};
  font-size: 11px;
  ...
  align-items: center;
  gap: 8px;
`;function P({children:e,...o}){return(0,r.jsx)(V,{...o,children:e})}l().label`
  display: flex;
  align-items: center;
  gap: 10px;
...
`,l().p`
  ...
  font-size: 12.5px;
  line-height: 1.45;
`;var Y=t(1352),N=t(6710),W=t(4311),D=t(3639),O=t(80);t(5406),l().nav`padding: ${s.w4.spacing.sm} 0;`,l().div`
...
`;var q=t(4041);let G="https://cdn.jsdelivr.net/npm/mermaid@11.14.0/dist/mermaid.min.js",X=null,_="#7fb77e",K=(0,j.keyframes)`
...
`,Q=!1,ee=/^(?:---[\s\S]*?---\s*)?(?:graph|flowchart|sequenceDiagram|classDiagram|stateDiagram(?:-v2)?|erDiagram|pie|gantt|journey|mindmap|gitGraph|sankey(?:-beta)?|quadrantChart|requirementDiagram|timeline|xychart-beta|block-beta|C4Context|C4Container|C4Component|C4Dynamic|C4Deployment)\b/;function eo({code:e}){let[o,t]=(0,a.useState)(""),[i,n]=(0,a.useState)(!1);return((0,a.useEffect)(()=>{let o=!1;n(!1),t("");let r=e.trim();if(!r)return void n(!0);let a=r.split(/\r?\n/)[0]?.trim()??"";if(!ee.test(a))return void n(!0);let i=setTimeout(()=>{o||(console.error("[MermaidBlock] render timed out after 5s"),n(!0))},5e3);return(async()=>{try{let e=await (X||(X=new Promise((e,o)=>{let t=globalThis.mermaid;if(t)return void e(t);let r=document.createElement("script");r.src=G,r.async=!0,r.onload=()=>{let t=globalThis.mermaid;t?e(t):o(Error("mermaid loaded but globalThis.mermaid missing"))},r.onerror=()=>o(Error(`failed to load ${G}`)),document.head.appendChild(r)})));if(console.debug("[MermaidBlock] mermaid ready",{initialized:Q}),!Q){let o="#141820",t="#1c2332",r="#343c4f",a="#e8edf5",i="#9aa5b8",n="#7fb77e",l="#6aa8d8",s="#8b7bff",d="#e89a5c",c="#f87171";e.initialize({startOnLoad:!1,theme:"base",securityLevel:"loose",themeVariables:{fontFamily:"-apple-system, BlinkMacSystemFont, Segoe UI, Helvetica, Arial, sans-serif",background:o,mainBkg:t,primaryColor:n,primaryTextColor:a,primaryBorderColor:n,secondaryColor:s,secondaryTextColor:a,secondaryBorderColor:s,tertiaryColor:l,tertiaryTextColor:a,tertiaryBorderColor:l,lineColor:i,textColor:a,nodeBorder:r,clusterBkg:o,clusterBorder:r,edgeLabelBackground:t,labelBackground:t,labelBorder:r,relationLabelBackground:t,relationLabelColor:a,pie1:n,pie2:s,pie3:l,pie4:d,pie5:"#ff6fa9",pie6:"#2dd4bf",pie7:c,pie8:n,pieStrokeColor:o,pieStrokeWidth:"2px",pieTitleTextSize:"18px",pieSectionTextSize:"13px",pieLegendTextSize:"13px",actorBkg:n,actorBorder:n,actorTextColor:o,signalColor:a,signalTextColor:a,labelBoxBkgColor:t,labelBoxBorderColor:r,labelTextColor:a,loopTextColor:a,noteBkgColor:d,noteBorderColor:d,noteTextColor:o,stateBkg:t,altBackground:o,attributeBackgroundColorOdd:t,attributeBackgroundColorEven:o,rowOdd:t,rowEven:o,gridColor:r,sectionBkgColor:t,sectionBkgColor2:o,taskBkgColor:s,taskTextColor:a,taskTextDarkColor:a,taskTextLightColor:a,taskTextOutsideColor:a,activeTaskBkgColor:n,activeTaskBorderColor:n,doneTaskBkgColor:i,doneTaskBorderColor:i,critBkgColor:c,critBorderColor:c}}),Q=!0}console.debug("[MermaidBlock] calling mermaid.render");let{svg:a}=await e.render(`mermaid-${(0,q.z)()}`,r);if(clearTimeout(i),console.debug("[MermaidBlock] render returned",{length:a?.length??0}),o)return;let l=/aria-roledescription="error"/i.test(a)||/class="error-(?:icon|text)"/i.test(a)||/>Syntax error in text</i.test(a);if(!a||l)return void n(!0);t(a)}catch(e){clearTimeout(i),console.error("[MermaidBlock] render failed",e),o||n(!0)}})(),()=>{o=!0,clearTimeout(i)}},[e]),i)?(0,r.jsx)(J,{children:e.trim()}):o?(0,r.jsx)(Z,{dangerouslySetInnerHTML:{__html:o}}):(0,r.jsx)(Z,{children:(0,r.jsx)(U,{"aria-hidden":!0})})}let et=["#388bfd","#3fb950","#d29922","#a371f7","#f87171","#22d3ee","#fb923c","#34d399","#f472b6","#818cf8"],er=l().div`
  background: ${s.w4.colors.codeBg};
  border: 1px solid ${s.w4.colors.codeBorder};
  border-radius: ${s.w4.borderRadius.md};
...
`,es=l().pre`
  ...
  color: ${s.w4.colors.mainTextMuted};
  white-space: pre-wrap;
`;function ed(e){if(e<=0)return 10;let o=Math.pow(10,Math.floor(Math.log10(e)));return Math.ceil(e/o)*o}function ec(e,o,t){let r=Math.max(1,Math.ceil(t/8));return 0!==o&&o!==t-1&&o%r!=0?"":e.length>12?e.slice(0,11)+"…":e}function ep({labels:e,data:o,colors:t}){let a=340,i=176,n=ed(Math.max(...o,1)),l=Math.min(40,a/e.length*.6),d=a/e.length,c=Array.from({length:6},(e,o)=>n/5*o);return(0,r.jsxs)("svg",{viewBox:"0 0 400 240",width:"100%",style:{maxWidth:400},children:[c.map((e,o)=>{let t=16+i-e/n*i;return(0,r.jsxs)("g",{children:[(0,r.jsx)("line",{x1:44,y1:t,x2:384,y2:t,stroke:s.w4.colors.border,strokeWidth:.5,strokeDasharray:0===o?"none":"3,3"}),(0,r.jsx)("text",{x:38,y:t+4,fill:s.w4.colors.mainTextMuted,fontSize:10,textAnchor:"end",fontFamily:s.w4.typography.fontFamily,children:Math.round(e)})]},o)}),o.map((o,a)=>{let c=44+d*a+d/2-l/2,p=o/n*i,g=16+i-p,h=t[a%t.length];return(0,r.jsxs)("g",{children:[(0,r.jsxs)("rect",{x:c,y:g,width:l,height:p,rx:3,fill:h,opacity:.85,children:[(0,r.jsx)("animate",{attributeName:"height",from:"0",to:p,dur:"0.5s",fill:"freeze"}),(0,r.jsx)("animate",{attributeName:"y",from:16+i,to:g,dur:"0.5s",fill:"freeze"})]}),(0,r.jsx)("text",{x:c+l/2,y:g-4,fill:s.w4.colors.mainText,fontSize:10,fontWeight:600,textAnchor:"middle",fontFamily:s.w4.typography.fontFamily,children:o}),(0,r.jsx)("text",{x:44+d*a+d/2,y:208,fill:s.w4.colors.mainTextMuted,fontSize:10,textAnchor:"middle",fontFamily:s.w4.typography.fontFamily,children:ec(e[a],a,e.length)})]},a)})]})}function eg({labels:e,data:o,colors:t}){let a=o.reduce((e,o)=>e+o,0)||1,i=-Math.PI/2,n=o.map((e,o)=>{let n=e/a*Math.PI*2,l=i,d=i+=n,c=120+90*Math.cos(l),p=120+90*Math.sin(l),g=120+90*Math.cos(d),h=120+90*Math.sin(d),x=+(n>Math.PI),f=l+n/2,m=120+58.5*Math.cos(f),b=120+58.5*Math.sin(f),u=Math.round(e/a*100);return(0,r.jsxs)("g",{children:[(0,r.jsx)("path",{d:`M 120 120 L ${c} ${p} A 90 90 0 ${x} 1 ${g} ${h} Z`,fill:t[o%t.length],stroke:s.w4.colors.codeBg,strokeWidth:2,opacity:.85}),u>=5&&(0,r.jsxs)("text",{x:m,y:b+4,fill:"#fff",fontSize:11,fontWeight:600,textAnchor:"middle",fontFamily:s.w4.typography.fontFamily,children:[u,"%"]})]},o)});return(0,r.jsx)("svg",{viewBox:"0 0 240 240",width:"100%",style:{maxWidth:240},children:n})}function eh({labels:e,data:o,colors:t}){let a=340,i=176,n=ed(Math.max(...o,1)),l=o.length>1?a/(o.length-1):a,d=t[0],c=o.map((e,o)=>({x:44+l*o,y:16+i-e/n*i})),p=c.map((e,o)=>`${0===o?"M":"L"} ${e.x} ${e.y}`).join(" "),g=Array.from({length:6},(e,o)=>n/5*o);return(0,r.jsxs)("svg",{viewBox:"0 0 400 240",width:"100%",style:{maxWidth:400},children:[g.map((e,o)=>{let t=16+i-e/n*i;return(0,r.jsxs)("g",{children:[(0,r.jsx)("line",{x1:44,y1:t,x2:384,y2:t,stroke:s.w4.colors.border,strokeWidth:.5,strokeDasharray:0===o?"none":"3,3"}),(0,r.jsx)("text",{x:38,y:t+4,fill:s.w4.colors.mainTextMuted,fontSize:10,textAnchor:"end",fontFamily:s.w4.typography.fontFamily,children:Math.round(e)})]},o)}),(0,r.jsx)("path",{d:p,fill:"none",stroke:d,strokeWidth:2.5,strokeLinecap:"round",strokeLinejoin:"round"}),c.map((t,a)=>(0,r.jsxs)("g",{children:[(0,r.jsx)("circle",{cx:t.x,cy:t.y,r:4,fill:d,stroke:s.w4.colors.codeBg,strokeWidth:2}),(0,r.jsx)("text",{x:t.x,y:t.y-10,fill:s.w4.colors.mainText,fontSize:10,fontWeight:600,textAnchor:"middle",fontFamily:s.w4.typography.fontFamily,children:o[a]}),(0,r.jsx)("text",{x:t.x,y:208,fill:s.w4.colors.mainTextMuted,fontSize:10,textAnchor:"middle",fontFamily:s.w4.typography.fontFamily,children:ec(e[a],a,e.length)})]},a))]})}function ex({code:e}){let o=(0,a.useMemo)(()=>(function(e){let o,t,r=e.trim().split("\n"),a="bar",i=[],n=[];for(let e of r){let[r,...l]=e.split(":"),s=l.join(":").trim();if(s)switch(r.trim().toLowerCase()){case"type":["bar","pie","line"].includes(s.toLowerCase())&&(a=s.toLowerCase());break;case"title":o=s;break;case"labels":i=s.replace(/^\[|\]$/g,"").split(",").map(e=>e.trim()).filter(Boolean);break;case"data":n=s.replace(/^\[|\]$/g,"").split(",").map(e=>e.trim()).filter(Boolean).map(e=>parseFloat(e)||0);break;case"colors":{let e=s.replace(/^\[|\]$/g,"").split(",").map(e=>e.trim()).filter(Boolean);t=e.length?e:void 0}}}return i.length&&n.length?{type:a,title:o,labels:i,data:n,colors:t}:null})(e),[e]);if(!o)return(0,r.jsx)(es,{children:e.trim()});let t=o.colors??et;return(0,r.jsxs)(er,{children:[o.title&&(0,r.jsx)(ea,{children:o.title}),"bar"===o.type&&(0,r.jsx)(ep,{labels:o.labels,data:o.data,colors:t}),"pie"===o.type&&(0,r.jsx)(eg,{labels:o.labels,data:o.data,colors:t}),"line"===o.type&&(0,r.jsx)(eh,{labels:o.labels,data:o.data,colors:t}),(0,r.jsx)(ei,{children:o.labels.map((e,o)=>(0,r.jsxs)(en,{children:[(0,r.jsx)(el,{color:t[o%t.length]}),e]},o))})]})}l().div`
  background: ${s.w4.colors.codeBg};
  border: 1px solid ${s.w4.colors.codeBorder};
  border-radius: ${s.w4.borderRadius.md};
  padding: ${s.w4.spacing.lg};
...
`,l().span`
  font-size: ${s.w4.typography.fontSizeBase};
  color: ${s.w4.colors.mainTextMuted};
`;var eb=t(7223),eu=t(1426);let ew=l().div`
  margin: ${s.w4.spacing.lg} 0;
  border-radius: ${s.w4.borderRadius.md};
  border: 1px solid ${s.w4.colors.codeBorder};
  overflow: hidden;
...
`,eM={...eu.A,'pre[class*="language-"]':{...eu.A['pre[class*="language-"]'],background:s.w4.colors.codeBg,margin:0,padding:"18px 20px",fontSize:"13px",lineHeight:"1.6",borderRadius:0},'code[class*="language-"]':{...eu.A['code[class*="language-"]'],background:"none",fontSize:"13px"}};function ek({lang:e="text",code:o}){let[t,i]=(0,a.useState)(!1);return(0,r.jsxs)(ew,{children:[(0,r.jsxs)(ey,{children:[(0,r.jsx)(e$,{children:e}),(0,r.jsxs)(ev,{copied:t,onClick:()=>{navigator.clipboard.writeText(o).then(()=>{i(!0),setTimeout(()=>i(!1),2e3)})},children:[t?(0,r.jsx)(F,{name:"check",size:12}):(0,r.jsx)(F,{name:"copy",size:12}),t?"Copied!":"Copy"]})]}),(0,r.jsx)(eb.A,{language:e,style:eM,showLineNumbers:o.split("\n").length>8,lineNumberStyle:{color:"#484f58",minWidth:"2.5em",paddingRight:"1.5em",userSelect:"none",fontSize:"12px"},customStyle:{margin:0,background:s.w4.colors.codeBg},wrapLongLines:!1,children:o})]})}let ez={NOTE:{bg:"rgba(88, 166, 255, 0.08)",border:"#58a6ff",icon:"info",label:"Note",color:"#58a6ff"},TIP:{bg:"rgba(63, 185, 80, 0.08)",border:"#3fb950",icon:"lightbulb",label:"Tip",color:"#3fb950"},IMPORTANT:{bg:"rgba(163, 113, 247, 0.08)",border:"#a371f7",icon:"zap",label:"Important",color:"#a371f7"},WARNING:{bg:"rgba(210, 153, 34, 0.08)",border:"#d29922",icon:"alert-triangle",label:"Warning",color:"#d29922"},CAUTION:{bg:"rgba(248, 81, 73, 0.08)",border:"#f85149",icon:"alert-octagon",label:"Caution",color:"#f85149"}},eT=l().div`
  background: ${({bg:e})=>e};
...
`;function eF({type:e,children:o}){let t=ez[e]??ez.NOTE;return(0,r.jsxs)(eT,{bg:t.bg,border:t.border,children:[(0,r.jsxs)(ej,{color:t.color,children:[(0,r.jsx)(F,{name:t.icon,size:15,strokeWidth:2}),t.label]}),(0,r.jsx)(eS,{children:o})]})}l().nav`
  width: 220px;
  min-width: 220px;
...
`;function eH(){let e=/^\[!(NOTE|TIP|WARNING|CAUTION|IMPORTANT)\]\s*/i;return o=>{function t(o,t,r){let a=t.children?.[0];a?.type==="text"&&(a.value=a.value.replace(e,""),a.value.trim()||1!==t.children.length||t.children.shift()),o.data=o.data??{},o.data.hName="div",o.data.hProperties={"data-callout":r.toUpperCase()}}!function o(r){if("blockquote"===r.type){let o=r.children?.[0];if(o?.type==="paragraph"){let a=o.children?.[0],i=a?.type==="text"&&a.value?.match(e);i&&t(r,o,i[1])}}if("paragraph"===r.type){let o=r.children?.[0],a=o?.type==="text"&&o.value?.match(e);if(a){let o=[...r.children];r.children=[{type:"paragraph",children:o}],t(r,r.children[0],a[1]);let i=o[0];i?.type==="text"&&(i.value=i.value.replace(e,""),i.value.trim()||1!==o.length||o.shift());return}}r.children?.forEach(o)}(o)}}l().div`
  position: fixed;
  inset: 0;
...
`;function eL({children:e}){return(0,r.jsx)(eA,{children:(0,r.jsx)(Y.oz,{remarkPlugins:[N.A,W.A,eH],rehypePlugins:[D.A,O.A],components:{div({node:e,children:o,...t}){let a=t["data-callout"];return a?(0,r.jsx)(eF,{type:a,children:o}):(0,r.jsx)("div",{...t,children:o})},pre:({children:e})=>(0,r.jsx)(r.Fragment,{children:e}),code({className:e,children:o}){let t=/language-(\w+)/.exec(e??"")?.[1],a=String(o).replace(/\n$/,"");return a.trim()?"mermaid"===t?(0,r.jsx)(eo,{code:a}):"chart"===t?(0,r.jsx)(ex,{code:a}):t||a.includes("\n")?(0,r.jsx)(ek,{lang:t,code:a}):(0,r.jsx)("code",{className:e,children:o}):null}},children:e})})}var eR=t(7993);l().nav`
  display: flex;
  flex-direction: column;
  gap: 1px;
...
`,e3=l().main`
  ...
  display: flex;
  flex-direction: column;
`,e6=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function e8(){return(0,r.jsx)(eU,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:e6.map((e,o)=>(0,r.jsx)(eJ,{index:o,accent:e.accent,children:e.char},o))})}let e7="atlantis:sidebar-collapsed";function e9({sidebar:e,children:o,topBarRight:n,title:l="Atlantis",activeId:s=null}){let[d,c]=(0,a.useState)(()=>{try{return"true"===localStorage.getItem(e7)}catch{return!1}}),[p,g]=(0,a.useState)(null),h=(0,a.useRef)(),x=()=>c(e=>{let o=!e;try{localStorage.setItem(e7,String(o))}catch{}return o}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(t.bind(t,5816)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(eR.I.Provider,{value:{collapsed:d,toggle:x,flyout:p,openFlyout:(e,o,t)=>{clearTimeout(h.current),g({entry:e,anchorY:o,onSelect:t})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,r.jsxs)(e2,{children:[(0,r.jsxs)(eX,{children:[e&&(0,r.jsx)(e_,{children:(0,r.jsx)(eK,{onClick:x,title:d?"Expand sidebar":"Collapse sidebar",children:(0,r.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,r.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,r.jsx)("path",{d:"M9 3v18"})]})})}),(0,r.jsx)(e8,{}),l&&(0,r.jsx)(eQ,{children:l}),n&&(0,r.jsx)(e0,{children:n})]}),(0,r.jsxs)(e1,{children:[null!=e&&(0,r.jsx)(e4,{collapsed:d,children:(0,r.jsx)(e5,{children:e})}),(0,r.jsx)(e3,{children:o})]}),p&&(0,r.jsx)(i().Suspense,{fallback:null,children:(0,r.jsx)(f,{activeId:s})})]})})}l().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
