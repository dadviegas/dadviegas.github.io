"use strict";(self.webpackChunk_atlantis_imagegen=self.webpackChunk_atlantis_imagegen||[]).push([["787"],{3758(o,r,e){e.d(r,{Vi:()=>i,fG:()=>a,i4:()=>t.buildPollinationsUrl});var t=e(5523);async function a(o,r){return(await (0,t.askGroq)(r,{key:o,system:"You are an expert at writing image generation prompts. Enhance the user's prompt to be more descriptive and visually compelling. Include details about lighting, style, composition, and mood. Return ONLY the enhanced prompt text, no explanation or quotes.",maxTokens:200})).trim()||r}function i(){return(0,t.loadApiKeysSync)().groq??""}},3487(o,r,e){e.d(r,{Z:()=>y});var t=e(5723),a=e(7991),i=e(6859),n=e.n(i),l=e(2799),d=e(4764),s=e(18),p=e(6665);let c=(0,l.keyframes)`
...
`,f=n().div`
  ...
  scrollbar-color: ${d.w4.colors.border} transparent;
`,h=n().button`
  position: relative;
  flex-shrink: 0;
  width: 100px;
  ...
  cursor: pointer;
  padding: 0;
  transition: border-color ${d.w4.transitions.base}, transform ${d.w4.transitions.base};
...
`,w=n().div`
  ...
  opacity: 0;
  transition: opacity ${d.w4.transitions.base};
`;function u({item:o,onSelect:r,onDelete:e}){let i=function(o){let r=`https://image.pollinations.ai/prompt/${encodeURIComponent(o.prompt)}?width=200&height=200&seed=${o.seed}&model=${o.model}&nologo=true`,[e,t]=(0,a.useState)(r);return(0,a.useEffect)(()=>{let r=null;return(0,p.if)(o.id).then(o=>{o&&(r=o,t(o))}),()=>{r&&URL.revokeObjectURL(r)}},[o.id]),e}(o);return(0,t.jsxs)(h,{onClick:r,children:[(0,t.jsx)(b,{src:i,alt:o.prompt,loading:"lazy",referrerPolicy:"no-referrer"}),(0,t.jsx)(m,{className:"delete-btn",role:"button",onClick:o=>{o.stopPropagation(),e()},children:(0,t.jsx)(s.In,{name:"close",size:12})}),(0,t.jsx)(w,{className:"prompt-label",children:o.prompt})]})}function y({items:o,onSelect:r,onDelete:e}){return 0===o.length?null:(0,t.jsxs)(g,{children:[(0,t.jsx)(x,{children:"Recent Generations"}),(0,t.jsx)(f,{children:o.map(o=>(0,t.jsx)(u,{item:o,onSelect:()=>r(o),onDelete:()=>e(o.id)},o.id))})]})}},9610(o,r,e){e.d(r,{e:()=>y});var t=e(5723),a=e(6859),i=e.n(a),n=e(2799),l=e(4764),d=e(18);let s=(0,n.keyframes)`
...
`;function y({url:o,status:r,width:e,height:a,onLoad:i,onError:n,onReroll:l,onRetry:s}){return(0,t.jsxs)(c,{children:[(0,t.jsx)(g,{ratio:e/a,children:(0,t.jsxs)(x,{children:["idle"===r&&(0,t.jsxs)(b,{children:[(0,t.jsx)("span",{style:{fontSize:40,opacity:.3},children:"\uD83C\uDFA8"}),"Generate an image to get started"]}),"loading"===r&&(0,t.jsx)(f,{}),"error"===r&&(0,t.jsxs)(m,{children:[(0,t.jsx)(d.In,{name:"alert-circle",size:32}),"Failed to generate image",(0,t.jsx)(d.$n,{variant:"ghost",size:"sm",onClick:s,children:"Try Again"})]}),o&&("loaded"===r||"loading"===r)&&(0,t.jsx)(h,{src:o,alt:"Generated image",crossOrigin:"anonymous",referrerPolicy:"no-referrer",onLoad:o=>i(o.currentTarget),onError:n,style:{display:"loaded"===r?"block":"none"}})]})}),"loaded"===r&&(0,t.jsxs)(w,{className:"overlay",children:[(0,t.jsxs)(u,{onClick:()=>{o&&window.open(o,"_blank","noopener")},children:[(0,t.jsx)(d.In,{name:"download",size:14})," Download"]}),(0,t.jsxs)(u,{onClick:l,children:[(0,t.jsx)(d.In,{name:"refresh-cw",size:14})," New Variation"]})]})]})}},6396(o,r,e){e.d(r,{q:()=>u});var t=e(5723),a=e(6859),i=e.n(a),n=e(2799),l=e(4764),d=e(18),s=e(5523);let p=(0,n.keyframes)`
...
`,b=i().select`
  ...
  cursor: pointer;
  outline: none;
`,m=[{label:"Square 1:1",w:1024,h:1024},{label:"Landscape 16:9",w:1344,h:768},{label:"Portrait 9:16",w:768,h:1344},{label:"Wide 21:9",w:1344,h:576}],w=s.POLLINATIONS_MODELS;function u({prompt:o,onPromptChange:r,width:e,height:a,model:i,onSizeChange:n,onModelChange:l,onGenerate:s,onEnhance:p,generating:y,enhancing:$,canEnhance:v}){let M=!!o.trim()&&!y;return(0,t.jsxs)(c,{children:[(0,t.jsxs)(g,{children:[(0,t.jsx)(x,{placeholder:"Describe the image you want to create...",value:o,onChange:o=>r(o.target.value),onKeyDown:o=>{"Enter"===o.key&&M&&(o.preventDefault(),s())}}),(0,t.jsx)(d.$n,{variant:"ghost",icon:$?(0,t.jsx)(f,{children:(0,t.jsx)(d.In,{name:"loader",size:14})}):(0,t.jsx)(d.In,{name:"sparkle",size:14}),disabled:!v||$||!o.trim(),onClick:p,title:v?"Enhance prompt with AI":"Add a Groq key in Prompt Lab to enable",children:"Enhance"}),(0,t.jsx)(d.$n,{variant:"primary",icon:y?(0,t.jsx)(f,{children:(0,t.jsx)(d.In,{name:"loader",size:14})}):(0,t.jsx)(d.In,{name:"image-plus",size:14}),disabled:!M,onClick:s,children:"Generate"})]}),(0,t.jsxs)(h,{children:[m.map(o=>(0,t.jsx)(d.vu,{variant:e===o.w&&a===o.h?"selected":"default",onClick:()=>n(o.w,o.h),children:o.label},o.label)),(0,t.jsx)(b,{value:i,onChange:o=>l(o.target.value),children:w.map(o=>(0,t.jsx)("option",{value:o.id,children:o.label},o.id))})]})]})}},6665(o,r,e){e.d(r,{CJ:()=>i,XZ:()=>l,if:()=>n});let t="images";function a(){return new Promise((o,r)=>{let e=indexedDB.open("atlantis-imagegen-cache",1);e.onupgradeneeded=()=>{let o=e.result;o.objectStoreNames.contains(t)||o.createObjectStore(t,{keyPath:"id"})},e.onsuccess=()=>o(e.result),e.onerror=()=>r(e.error)})}async function i(o,r){try{let e=await new Promise(o=>{try{let e=document.createElement("canvas");e.width=r.naturalWidth,e.height=r.naturalHeight;let t=e.getContext("2d");if(!t)return void o(null);t.drawImage(r,0,0),e.toBlob(r=>o(r),"image/png")}catch{o(null)}});if(!e)return;let i=await a(),n=i.transaction(t,"readwrite").objectStore(t);n.put({id:o,blob:e,cachedAt:Date.now()});let l=n.getAll();l.onsuccess=()=>{let o=l.result;if(o.length>10)for(let r of(o.sort((o,r)=>r.cachedAt-o.cachedAt),o.slice(10)))n.delete(r.id)},i.close()}catch{}}async function n(o){try{let r=await a();return new Promise(e=>{let a=r.transaction(t,"readonly").objectStore(t).get(o);a.onsuccess=()=>{r.close();let o=a.result;o?.blob?e(URL.createObjectURL(o.blob)):e(null)},a.onerror=()=>{r.close(),e(null)}})}catch{return null}}async function l(o){try{let r=await a();r.transaction(t,"readwrite").objectStore(t).delete(o),r.close()}catch{}}},7871(o,r,e){e.d(r,{$5:()=>i,DZ:()=>c,M5:()=>p,Qd:()=>n,vI:()=>l});var t=e(5523);let a="atlantis:imagegen:gallery";function i(){try{return JSON.parse(localStorage.getItem(a)??"[]")}catch{return[]}}function n(o){let r=i().filter(r=>r.id!==o.id),e=[o,...r].slice(0,50);try{localStorage.setItem(a,JSON.stringify(e))}catch{}return e}function l(o){let r=i().filter(r=>r.id!==o);try{localStorage.setItem(a,JSON.stringify(r))}catch{}return r}let d={width:1024,height:1024,model:t.DEFAULT_POLLINATIONS_MODEL_ID},s="atlantis:imagegen:settings";function p(){try{return{...d,...JSON.parse(localStorage.getItem(s)??"{}")}}catch{return d}}function c(o){try{localStorage.setItem(s,JSON.stringify(o))}catch{}}},18(o,r,e){e.d(r,{$n:()=>w,vu:()=>j,In:()=>M});var t=e(5723),a=e(7991),i=e.n(a),n=e(6859),l=e.n(n),d=e(4764);let s={ghost:"transparent",accent:"transparent",primary:d.w4.colors.accent,success:"#238636",danger:"#da3633"},p={ghost:d.w4.colors.sidebarHover,accent:"rgba(88,166,255,0.10)",primary:d.w4.colors.accentHover,success:"#2ea043",danger:"#f85149"},c={ghost:d.w4.colors.border,accent:d.w4.colors.accent,primary:d.w4.colors.accent,success:"#238636",danger:"#da3633"},g={ghost:d.w4.colors.mainTextMuted,accent:d.w4.colors.accent,primary:"#fff",success:"#fff",danger:"#fff"},x={ghost:d.w4.colors.mainText,accent:d.w4.colors.accent,primary:"#fff",success:"#fff",danger:"#fff"},f={sm:"28px",md:"30px"},h={sm:"0 10px",md:"0 12px"},b={sm:"12px",md:"12px"},m=l().button`
  display: inline-flex;
  align-items: center;
  justify-content: center;
  gap: 6px;
...
`,w=i().forwardRef(function({variant:o="ghost",size:r="md",icon:e,iconRight:a,children:i,...n},l){return(0,t.jsxs)(m,{ref:l,variant:o,size:r,...n,children:[e,i,a]})}),u={default:d.w4.colors.accent,danger:"#f85149"},y={default:d.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"};l().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`,l()("button",{shouldForwardProp:o=>"active"!==o&&"highlight"!==o})`
  ...
  border: 1px solid
    ${({active:o,highlight:r})=>o||r?d.w4.colors.accent:"transparent"};
  color: ${({active:o,highlight:r})=>o||r?d.w4.colors.accent:d.w4.colors.mainTextMuted};
  font-family: ${d.w4.typography.fontFamily};
  font-size: 12px;
  font-weight: 500;
  cursor: pointer;
...
`,S=l().span`
  ...
  display: inline-block;
`,j=i().forwardRef(function({variant:o="default",dotColor:r,children:e,onClick:a,...i},n){return(0,t.jsxs)(F,{ref:n,variant:o,clickable:!!a,onClick:a,type:i.type??"button",...i,children:[r&&(0,t.jsx)(S,{color:r}),e]})}),H={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:d.w4.colors.accentMuted},R={neutral:d.w4.colors.mainTextMuted,live:d.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:d.w4.colors.accent};l().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${d.w4.typography.fontFamilyMono};
...
`,l().button`
  ...
  border-radius: 20px;
  background: ${({primary:o,danger:r})=>r?"rgba(248,81,73,0.12)":o?d.w4.colors.accent:"none"};
  color: ${({primary:o,danger:r})=>r?d.w4.colors.danger:o?"#fff":d.w4.colors.mainText};
  border: 1px solid ${({primary:o,danger:r})=>r?d.w4.colors.danger:o?d.w4.colors.accent:d.w4.colors.border};
...
`,l().button`
  ...
  background: ${({primary:o,danger:r})=>r?d.w4.colors.danger:o?d.w4.colors.accent:"transparent"};
  color: ${({primary:o,danger:r})=>r||o?"#fff":d.w4.colors.mainText};
  border: 1px solid
    ${({primary:o,danger:r})=>r?d.w4.colors.danger:o?d.w4.colors.accent:d.w4.colors.border};
