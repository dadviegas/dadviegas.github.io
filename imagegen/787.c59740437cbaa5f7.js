...
`;function y({url:o,status:r,width:e,height:a,onLoad:i,onError:n,onReroll:l,onRetry:d}){return(0,t.jsxs)(c,{children:[(0,t.jsx)(g,{ratio:e/a,children:(0,t.jsxs)(x,{children:["idle"===r&&(0,t.jsxs)(b,{children:[(0,t.jsx)("span",{style:{fontSize:40,opacity:.3},children:"\uD83C\uDFA8"}),"Generate an image to get started"]}),"loading"===r&&(0,t.jsx)(f,{}),"error"===r&&(0,t.jsxs)(m,{children:[(0,t.jsx)(s.In,{name:"alert-circle",size:32}),"Failed to generate image",(0,t.jsx)(s.$n,{variant:"ghost",size:"sm",onClick:d,children:"Try Again"})]}),o&&("loaded"===r||"loading"===r)&&(0,t.jsx)(h,{src:o,alt:"Generated image",crossOrigin:"anonymous",referrerPolicy:"no-referrer",onLoad:o=>i(o.currentTarget),onError:n,style:{display:"loaded"===r?"block":"none"}})]})}),"loaded"===r&&(0,t.jsxs)(w,{className:"overlay",children:[(0,t.jsxs)(u,{onClick:()=>{o&&window.open(o,"_blank","noopener")},children:[(0,t.jsx)(s.In,{name:"download",size:14})," Download"]}),(0,t.jsxs)(u,{onClick:l,children:[(0,t.jsx)(s.In,{name:"refresh-cw",size:14})," New Variation"]})]})]})}},6396(o,r,e){e.d(r,{q:()=>u});var t=e(5723),a=e(6859),i=e.n(a),n=e(2799),l=e(4764),s=e(18),d=e(2445);let p=(0,n.keyframes)`
...
`,b=i().select`
  ...
  cursor: pointer;
  outline: none;
`,m=[{label:"Square 1:1",w:1024,h:1024},{label:"Landscape 16:9",w:1344,h:768},{label:"Portrait 9:16",w:768,h:1344},{label:"Wide 21:9",w:1344,h:576}],w=d.POLLINATIONS_MODELS;function u({prompt:o,onPromptChange:r,width:e,height:a,model:i,onSizeChange:n,onModelChange:l,onGenerate:d,onEnhance:p,generating:y,enhancing:$,canEnhance:v}){let M=!!o.trim()&&!y;return(0,t.jsxs)(c,{children:[(0,t.jsxs)(g,{children:[(0,t.jsx)(x,{placeholder:"Describe the image you want to create...",value:o,onChange:o=>r(o.target.value),onKeyDown:o=>{"Enter"===o.key&&M&&(o.preventDefault(),d())}}),(0,t.jsx)(s.$n,{variant:"ghost",icon:$?(0,t.jsx)(f,{children:(0,t.jsx)(s.In,{name:"loader",size:14})}):(0,t.jsx)(s.In,{name:"sparkle",size:14}),disabled:!v||$||!o.trim(),onClick:p,title:v?"Enhance prompt with AI":"Add a Groq key in Prompt Lab to enable",children:"Enhance"}),(0,t.jsx)(s.$n,{variant:"primary",icon:y?(0,t.jsx)(f,{children:(0,t.jsx)(s.In,{name:"loader",size:14})}):(0,t.jsx)(s.In,{name:"image-plus",size:14}),disabled:!M,onClick:d,children:"Generate"})]}),(0,t.jsxs)(h,{children:[m.map(o=>(0,t.jsx)(s.vu,{variant:e===o.w&&a===o.h?"selected":"default",onClick:()=>n(o.w,o.h),children:o.label},o.label)),(0,t.jsx)(b,{value:i,onChange:o=>l(o.target.value),children:w.map(o=>(0,t.jsx)("option",{value:o.id,children:o.label},o.id))})]})]})}},6665(o,r,e){e.d(r,{CJ:()=>i,XZ:()=>l,if:()=>n});let t="images";function a(){return new Promise((o,r)=>{let e=indexedDB.open("atlantis-imagegen-cache",1);e.onupgradeneeded=()=>{let o=e.result;o.objectStoreNames.contains(t)||o.createObjectStore(t,{keyPath:"id"})},e.onsuccess=()=>o(e.result),e.onerror=()=>r(e.error)})}async function i(o,r){try{let e=await new Promise(o=>{try{let e=document.createElement("canvas");e.width=r.naturalWidth,e.height=r.naturalHeight;let t=e.getContext("2d");if(!t)return void o(null);t.drawImage(r,0,0),e.toBlob(r=>o(r),"image/png")}catch{o(null)}});if(!e)return;let i=await a(),n=i.transaction(t,"readwrite").objectStore(t);n.put({id:o,blob:e,cachedAt:Date.now()});let l=n.getAll();l.onsuccess=()=>{let o=l.result;if(o.length>10)for(let r of(o.sort((o,r)=>r.cachedAt-o.cachedAt),o.slice(10)))n.delete(r.id)},i.close()}catch{}}async function n(o){try{let r=await a();return new Promise(e=>{let a=r.transaction(t,"readonly").objectStore(t).get(o);a.onsuccess=()=>{r.close();let o=a.result;o?.blob?e(URL.createObjectURL(o.blob)):e(null)},a.onerror=()=>{r.close(),e(null)}})}catch{return null}}async function l(o){try{let r=await a();r.transaction(t,"readwrite").objectStore(t).delete(o),r.close()}catch{}}},7871(o,r,e){e.d(r,{$5:()=>i,DZ:()=>c,M5:()=>p,Qd:()=>n,vI:()=>l});var t=e(2445);let a="atlantis:imagegen:gallery";function i(){try{return JSON.parse(localStorage.getItem(a)??"[]")}catch{return[]}}function n(o){let r=i().filter(r=>r.id!==o.id),e=[o,...r].slice(0,50);try{localStorage.setItem(a,JSON.stringify(e))}catch{}return e}function l(o){let r=i().filter(r=>r.id!==o);try{localStorage.setItem(a,JSON.stringify(r))}catch{}return r}let s={width:1024,height:1024,model:t.DEFAULT_POLLINATIONS_MODEL_ID},d="atlantis:imagegen:settings";function p(){try{return{...s,...JSON.parse(localStorage.getItem(d)??"{}")}}catch{return s}}function c(o){try{localStorage.setItem(d,JSON.stringify(o))}catch{}}},18(o,r,e){e.d(r,{$n:()=>w,vu:()=>S,In:()=>M});var t=e(5723),a=e(7991),i=e.n(a),n=e(6859),l=e.n(n),s=e(4764);let d={ghost:"transparent",accent:"transparent",primary:s.w4.colors.accent,success:"#238636",danger:"#da3633"},p={ghost:s.w4.colors.sidebarHover,accent:"rgba(88,166,255,0.10)",primary:s.w4.colors.accentHover,success:"#2ea043",danger:"#f85149"},c={ghost:s.w4.colors.border,accent:s.w4.colors.accent,primary:s.w4.colors.accent,success:"#238636",danger:"#da3633"},g={ghost:s.w4.colors.mainTextMuted,accent:s.w4.colors.accent,primary:"#fff",success:"#fff",danger:"#fff"},x={ghost:s.w4.colors.mainText,accent:s.w4.colors.accent,primary:"#fff",success:"#fff",danger:"#fff"},f={sm:"28px",md:"30px"},h={sm:"0 10px",md:"0 12px"},b={sm:"12px",md:"12px"},m=l().button`
  display: inline-flex;
  align-items: center;
  justify-content: center;
  gap: 6px;
...
`,w=i().forwardRef(function({variant:o="ghost",size:r="md",icon:e,iconRight:a,children:i,...n},l){return(0,t.jsxs)(m,{ref:l,variant:o,size:r,...n,children:[e,i,a]})}),u={default:s.w4.colors.accent,danger:"#f85149"},y={default:s.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"};l().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`,l()("button",{shouldForwardProp:o=>"active"!==o&&"highlight"!==o})`
  ...
  border: 1px solid
    ${({active:o,highlight:r})=>o||r?s.w4.colors.accent:"transparent"};
  color: ${({active:o,highlight:r})=>o||r?s.w4.colors.accent:s.w4.colors.mainTextMuted};
  font-family: ${s.w4.typography.fontFamily};
  font-size: 12px;
  font-weight: 500;
  cursor: pointer;
...
`,S=i().forwardRef(function({variant:o="default",dotColor:r,children:e,onClick:a,...i},n){return(0,t.jsxs)(T,{ref:n,variant:o,clickable:!!a,onClick:a,type:i.type??"button",...i,children:[r&&(0,t.jsx)(F,{color:r}),e]})}),j={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:s.w4.colors.accentMuted},H={neutral:s.w4.colors.mainTextMuted,live:s.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:s.w4.colors.accent};l().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${s.w4.typography.fontFamilyMono};
...
`,l().p`
  ...
  font-size: 12.5px;
  line-height: 1.45;
`,e(5406),l().nav`padding: ${s.w4.spacing.sm} 0;`,l().div`
...
`,l().button`
  ...
  border-radius: 20px;
  background: ${({primary:o,danger:r})=>r?"rgba(248,81,73,0.12)":o?s.w4.colors.accent:"none"};
  color: ${({primary:o,danger:r})=>r?s.w4.colors.danger:o?"#fff":s.w4.colors.mainText};
  border: 1px solid ${({primary:o,danger:r})=>r?s.w4.colors.danger:o?s.w4.colors.accent:s.w4.colors.border};
...
`,l().button`
  ...
  background: ${({primary:o,danger:r})=>r?s.w4.colors.danger:o?s.w4.colors.accent:"transparent"};
  color: ${({primary:o,danger:r})=>r||o?"#fff":s.w4.colors.mainText};
  border: 1px solid
    ${({primary:o,danger:r})=>r?s.w4.colors.danger:o?s.w4.colors.accent:s.w4.colors.border};
