...
`;function ew({locale:e,onLocaleChange:t,user:a,userMenuItems:o=[],userMenuControlLabels:r,suites:n,onPreferences:s,notifications:d,onOpenPalette:c,paletteLabel:p="Search",onSignIn:u,signInLabel:m="Sign in",before:g,after:h}){let f=function(){if("u"<typeof navigator)return"Ctrl";let e=navigator,t=e.userAgentData?.platform??navigator.platform??navigator.userAgent??"";return/Mac|iPod|iPhone|iPad/i.test(t)?"⌘":"Ctrl"}(),b="⌘"===f?`${f}K`:`${f}+K`;return(0,i.jsxs)(eg,{children:[g,n&&n.entries.length>0&&(0,i.jsx)(em,{label:n.label,ariaLabel:n.ariaLabel,appsLabel:n.appsLabel,suites:n.entries}),c&&(0,i.jsxs)(ef,{onClick:c,"aria-label":p,title:`${p} (${b})`,children:[(0,i.jsx)(L,{name:"search",size:14}),(0,i.jsx)("span",{className:"kbd header-kbd",children:b})]}),!a&&(0,i.jsx)(Q.Fd,{locale:e,onChange:t}),!a&&(0,i.jsx)("span",{className:"header-hide-md",children:(0,i.jsx)(l.UW,{})}),d&&(0,i.jsxs)(eb,{children:[(0,i.jsx)(eh,{onClick:d.onClick,"aria-label":d.label,title:d.label,children:(0,i.jsx)(L,{name:"bell",size:16})}),d.count>0&&(0,i.jsx)(ex,{"aria-hidden":"true",children:d.count>9?"9+":d.count})]}),s&&(0,i.jsx)("span",{className:"header-hide-md",children:(0,i.jsx)(eh,{onClick:s,"aria-label":"User preferences",title:"Preferences",children:(0,i.jsx)(L,{name:"user-cog",size:16})})}),a?(0,i.jsx)(J,{user:a,items:o,locale:e,onLocaleChange:t,controlLabels:r}):u?(0,i.jsxs)(ey,{onClick:u,"aria-label":m,children:[(0,i.jsx)(L,{name:"log-in",size:14}),m]}):null,h]})}s().div`
  position: fixed;
  inset: 0;
  pointer-events: none;
  z-index: 900;
