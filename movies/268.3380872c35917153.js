...
`,m=n().p`
  ...
  text-align: center;
  margin: 0;
`;function u({onSave:e}){let[r,o]=(0,a.useState)(""),[i,n]=(0,a.useState)(!1),[l,w]=(0,a.useState)(""),y=async()=>{let o=r.trim();if(o){n(!0),w("");try{if(!(await fetch(`https://api.themoviedb.org/3/configuration?api_key=${o}`)).ok)throw Error("Invalid key");e(o)}catch{w("Could not validate API key. Check it and try again.")}finally{n(!1)}}};return(0,t.jsx)(s,{children:(0,t.jsxs)(d,{children:[(0,t.jsx)(c,{children:"\uD83C\uDFAC"}),(0,t.jsx)(p,{children:"Movies & Series"}),(0,t.jsxs)(g,{children:["This app uses the free"," ",(0,t.jsx)(x,{href:"https://www.themoviedb.org/settings/api",target:"_blank",rel:"noreferrer",children:"TMDB API"})," ","to browse movies, TV shows, and documentaries — including where to stream them.",(0,t.jsx)("br",{}),(0,t.jsx)("br",{}),"Create a free account on TMDB and paste your ",(0,t.jsx)("strong",{children:"API Key (v3)"})," below."]}),(0,t.jsxs)("div",{style:{display:"flex",flexDirection:"column",gap:8},children:[(0,t.jsx)(h,{htmlFor:"apikey",children:"TMDB API Key (v3)"}),(0,t.jsx)(f,{id:"apikey",type:"password",placeholder:"e.g. a1b2c3d4e5f6...",value:r,onChange:e=>o(e.target.value),onKeyDown:e=>"Enter"===e.key&&y(),autoFocus:!0})]}),l&&(0,t.jsx)(m,{children:l}),(0,t.jsx)(b,{onClick:y,disabled:!r.trim()||i,children:i?"Validating…":"Connect"})]})})}},6250(e,r,o){o.d(r,{U:()=>N});var t=o(5723),a=o(7991),i=o(6859),n=o.n(i),l=o(6063),s=o(132),d=o(2727),c=o.n(d),p=o(2799),g=o(1801);let x=n().div`
  position: relative;
  width: 150px;
  flex-shrink: 0;
  cursor: pointer;
...
`;function V({item:e,rect:r,onOpen:o,onMouseEnter:a,onMouseLeave:i,withBackdrop:n,onBackdropTap:l}){let d=function(e){let r=window.innerWidth,o=window.innerHeight;if(r<500){let t=Math.max(8,(r-300)/2);return{top:Math.max(8,Math.min(e.bottom+8,o-310-8)),left:t}}let t=e.right+10;t+300>r-8&&(t=e.left-300-10),t=Math.max(8,Math.min(t,r-300-8));let a=e.top+e.height/2-155;return{top:a=Math.max(8,Math.min(a,o-310-8)),left:t}}(r),p=(0,g.rS)(e),x=(0,g.Ox)(e),h=(0,g.U7)(e.backdrop_path,"w780");return c().createPortal((0,t.jsxs)(t.Fragment,{children:[n&&(0,t.jsx)("div",{style:{position:"fixed",inset:0,zIndex:9998},onClick:l}),(0,t.jsxs)(z,{top:d.top,left:d.left,onMouseEnter:a,onMouseLeave:i,onClick:o,style:{cursor:"pointer"},children:[h?(0,t.jsx)(j,{src:h}):(0,t.jsx)(T,{}),(0,t.jsxs)(F,{children:[(0,t.jsx)(S,{children:p}),(0,t.jsxs)(C,{children:[(0,t.jsxs)(H,{children:[(0,t.jsx)(s.In,{name:"star",size:11,fill:"currentColor"}),e.vote_average.toFixed(1)]}),x&&(0,t.jsx)(_,{children:x}),(0,t.jsx)(B,{kind:e.media_type,children:"movie"===e.media_type?"Film":"TV"})]}),e.overview&&(0,t.jsx)(R,{children:e.overview}),(0,t.jsxs)(A,{onClick:o,children:[(0,t.jsx)(s.In,{name:"info",size:13}),"More Info"]})]})]})]}),document.body)}function L({item:e,onClick:r}){let o=(0,g.rS)(e),i=(0,g.Ox)(e),n=(0,g.HD)(e.poster_path),l=(0,a.useRef)(null),d=(0,a.useRef)(),c=(0,a.useRef)(),p=(0,a.useRef)(null),k=(0,a.useRef)(!1),[z,j]=(0,a.useState)(!1),[T,F]=(0,a.useState)(null),[S,C]=(0,a.useState)(!1);(0,a.useEffect)(()=>()=>{clearTimeout(d.current),clearTimeout(c.current)},[]);let H=(0,a.useCallback)((e,r)=>{F(e),j(!0),C(r)},[]),_=(0,a.useCallback)(()=>{j(!1),F(null),C(!1)},[]),B=(0,a.useCallback)(()=>{_(),r(e)},[e,r,_]),R=(0,a.useCallback)(()=>{clearTimeout(c.current)},[]),A=(0,a.useCallback)(()=>{clearTimeout(d.current),c.current=setTimeout(_,180)},[_]),I=(0,a.useCallback)(()=>{clearTimeout(c.current)},[]),P=(0,a.useCallback)(()=>{_()},[_]),D=(0,a.useCallback)(e=>{z||(p.current={x:e.touches[0].clientX,y:e.touches[0].clientY})},[z]),Y=(0,a.useCallback)(o=>{if(z||!p.current)return;let t=o.changedTouches[0],a=Math.abs(t.clientX-p.current.x),i=Math.abs(t.clientY-p.current.y);if(p.current=null,a>8||i>8)return;if(k.current=!0,window.innerWidth<768)return void r(e);let n=l.current?.getBoundingClientRect();n&&H(n,!0)},[z,e,r,H]),E=(0,a.useCallback)(()=>{if(k.current){k.current=!1;return}z||S||B()},[z,S,B]);return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsxs)(x,{ref:l,onClick:E,onMouseEnter:R,onMouseLeave:A,onTouchStart:D,onTouchEnd:Y,title:o,role:"button",tabIndex:0,onKeyDown:e=>{("Enter"===e.key||" "===e.key)&&B()},children:[(0,t.jsx)($,{kind:e.media_type,children:"movie"===e.media_type?"Film":"TV"}),(0,t.jsx)(M,{"data-eye":!0,onClick:e=>{e.stopPropagation();let r=l.current?.getBoundingClientRect();r&&H(r,!1)},title:"Preview",children:(0,t.jsx)(s.In,{name:"eye",size:14})}),n?(0,t.jsx)(h,{src:n,alt:o,loading:"lazy"}):(0,t.jsxs)(f,{children:["\uD83C\uDFAC",(0,t.jsx)(b,{children:o})]}),(0,t.jsxs)(m,{children:[(0,t.jsx)(u,{children:o}),(0,t.jsxs)(w,{children:[(0,t.jsxs)(y,{children:[(0,t.jsx)(s.In,{name:"star",size:9,fill:"currentColor"}),e.vote_average.toFixed(1)]}),i&&(0,t.jsx)(v,{children:i})]})]})]}),z&&T&&(0,t.jsx)(V,{item:e,rect:T,onOpen:B,onMouseEnter:I,onMouseLeave:P,withBackdrop:S,onBackdropTap:_})]})}let I=n().div`
  display: flex;
  flex-direction: column;
  gap: ${l.w4.spacing.md};
...
`;function X(e){return Math.max(320,Math.round(.85*e.clientWidth))}function N({title:e,items:r,loading:o,onSelect:i}){let n=(0,a.useRef)(null),[l,d]=(0,a.useState)(!1),[c,p]=(0,a.useState)(!0),g=(0,a.useCallback)(()=>{let e=n.current;e&&(d(e.scrollLeft>0),p(e.scrollLeft+e.clientWidth<e.scrollWidth-4))},[]);(0,a.useEffect)(()=>{g();let e=()=>g();return window.addEventListener("resize",e),()=>window.removeEventListener("resize",e)},[r,g]);let x=()=>{let e=n.current;e&&e.scrollBy({left:-X(e),behavior:"smooth"})},h=()=>{let e=n.current;e&&e.scrollBy({left:X(e),behavior:"smooth"})};return(0,t.jsxs)(I,{children:[(0,t.jsxs)(P,{children:[(0,t.jsx)(D,{children:e}),(0,t.jsxs)(Y,{children:[(0,t.jsx)(E,{onClick:x,disabled:!l,"aria-label":"Scroll left",children:(0,t.jsx)(s.In,{name:"chevron-left",size:16})}),(0,t.jsx)(E,{onClick:h,disabled:!c||0===r.length,"aria-label":"Scroll right",children:(0,t.jsx)(s.In,{name:"chevron-right",size:16})})]})]}),(0,t.jsx)(U,{children:o?(0,t.jsx)(q,{children:Array.from({length:10}).map((e,r)=>(0,t.jsx)(O,{},r))}):0===r.length?(0,t.jsx)(W,{children:"No results found"}):(0,t.jsx)(q,{ref:n,onScroll:g,onKeyDown:e=>{if("ArrowRight"===e.key)e.preventDefault(),h();else if("ArrowLeft"===e.key)e.preventDefault(),x();else if("Home"===e.key)e.preventDefault(),n.current?.scrollTo({left:0,behavior:"smooth"});else if("End"===e.key){e.preventDefault();let r=n.current;r&&r.scrollTo({left:r.scrollWidth,behavior:"smooth"})}},tabIndex:0,role:"region","aria-label":e,children:r.map(e=>(0,t.jsx)(L,{item:e,onClick:i},`${e.media_type}-${e.id}`))})})]})}},2819(e,r,o){o.d(r,{P:()=>ec});var t=o(5723),a=o(7991),i=o(6859),n=o.n(i),l=o(2799),s=o(6063),d=o(132),c=o(1801),p=o(4956);let g=(0,l.keyframes)`
...
`,l().div`
  position: relative;
`;let q="260px",W="56px",O="44px",X=l().header`
  display: flex;
  align-items: center;
...
`,ei=l().main`
  ...
  display: flex;
  flex-direction: column;
`;function en(){return(0,t.jsxs)(G,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:[(0,t.jsx)(Z,{"aria-hidden":"true",children:"A"}),(0,t.jsx)(J,{children:"Atlantis"})]})}let el="atlantis:sidebar-collapsed";function es({sidebar:e,children:r,topBarRight:n,title:l="Atlantis",activeId:s=null}){let[d,c]=(0,a.useState)(()=>{try{return"true"===localStorage.getItem(el)}catch{return!1}}),[p,g]=(0,a.useState)(null),x=(0,a.useRef)(),h=()=>c(e=>{let r=!e;try{localStorage.setItem(el,String(r))}catch{}return r}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(o.bind(o,5816)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,t.jsx)(A.I.Provider,{value:{collapsed:d,toggle:h,flyout:p,openFlyout:(e,r,o)=>{clearTimeout(x.current),g({entry:e,anchorY:r,onSelect:o})},scheduleFlyoutClose:()=>{x.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(x.current)},children:(0,t.jsxs)(eo,{children:[(0,t.jsxs)(X,{children:[e&&(0,t.jsx)(N,{children:(0,t.jsx)(K,{onClick:h,title:d?"Expand sidebar":"Collapse sidebar",children:(0,t.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("path",{d:"M9 3v18"})]})})}),(0,t.jsx)(en,{}),l&&(0,t.jsx)(Q,{children:l}),n&&(0,t.jsx)(ee,{children:n})]}),(0,t.jsxs)(er,{children:[null!=e&&(0,t.jsx)(et,{collapsed:d,children:(0,t.jsx)(ea,{children:e})}),(0,t.jsx)(ei,{children:r})]}),p&&(0,t.jsx)(i().Suspense,{fallback:null,children:(0,t.jsx)(f,{activeId:s})})]})})}l().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
