...
`,C.A,C.A['pre[class*="language-"]'],d.w4.colors.codeBg,C.A['code[class*="language-"]'],l().div`
  background: ${({bg:e})=>e};
...
`,l().div`
  position: relative;
`;let X="260px",N="56px",W="48px",_=l().header`
  display: flex;
  align-items: center;
...
`,et=l().div`
  ...
  overflow: hidden;
`,er=l().aside`
  width: ${({collapsed:e})=>e?N:X};
  min-width: ${({collapsed:e})=>e?N:X};
  background: ${d.w4.colors.sidebarBg};
  border-right: 1px solid ${d.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,ei=l().main`
  ...
  display: flex;
  flex-direction: column;
`,en=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function el(){return(0,r.jsx)(J,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:en.map((e,o)=>(0,r.jsx)(U,{index:o,accent:e.accent,children:e.char},o))})}let ed="atlantis:sidebar-collapsed";function es({sidebar:e,children:o,topBarRight:n,title:l="Atlantis",activeId:d=null}){let[s,c]=(0,a.useState)(()=>{try{return"true"===localStorage.getItem(ed)}catch{return!1}}),[p,h]=(0,a.useState)(null),g=(0,a.useRef)(),x=()=>c(e=>{let o=!e;try{localStorage.setItem(ed,String(o))}catch{}return o}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(t.bind(t,5816)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(R.I.Provider,{value:{collapsed:s,toggle:x,flyout:p,openFlyout:(e,o,t)=>{clearTimeout(g.current),h({entry:e,anchorY:o,onSelect:t})},scheduleFlyoutClose:()=>{g.current=setTimeout(()=>h(null),160)},cancelFlyoutClose:()=>clearTimeout(g.current)},children:(0,r.jsxs)(et,{children:[(0,r.jsxs)(_,{children:[e&&(0,r.jsx)(K,{children:(0,r.jsx)(G,{onClick:x,title:s?"Expand sidebar":"Collapse sidebar",children:(0,r.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,r.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,r.jsx)("path",{d:"M9 3v18"})]})})}),(0,r.jsx)(el,{}),l&&(0,r.jsx)(Q,{children:l}),n&&(0,r.jsx)(ee,{children:n})]}),(0,r.jsxs)(eo,{children:[null!=e&&(0,r.jsx)(er,{collapsed:s,children:(0,r.jsx)(ea,{children:e})}),(0,r.jsx)(ei,{children:o})]}),p&&(0,r.jsx)(i().Suspense,{fallback:null,children:(0,r.jsx)(f,{activeId:d})})]})})}l().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
