...
`,X=r().div`
  ...
  align-items: center;
  gap: ${l.w4.spacing.sm};
`,H=[{x:3,y:5,size:1.5,delay:0,dur:3.2},{x:8,y:35,size:2,delay:1.8,dur:3.4},{x:12,y:70,size:1.5,delay:.6,dur:4.1},{x:18,y:15,size:2.5,delay:2.4,dur:3},{x:22,y:55,size:1.5,delay:.3,dur:4.5},{x:28,y:88,size:2,delay:1.1,dur:3.6},{x:33,y:25,size:1.5,delay:2.8,dur:4},{x:40,y:60,size:2,delay:.9,dur:3.3},{x:45,y:8,size:2.5,delay:1.5,dur:3.8},{x:50,y:45,size:1.5,delay:2.1,dur:4.3},{x:55,y:78,size:2,delay:.4,dur:3.1},{x:60,y:18,size:1.5,delay:1.7,dur:4.6},{x:65,y:50,size:2.5,delay:2.6,dur:3.5},{x:70,y:85,size:1.5,delay:.2,dur:3.9},{x:75,y:30,size:2,delay:1.3,dur:4.2},{x:80,y:65,size:1.5,delay:2.9,dur:3.7},{x:85,y:10,size:2,delay:.7,dur:3.4},{x:88,y:42,size:2.5,delay:1.9,dur:4.4},{x:92,y:75,size:1.5,delay:.5,dur:3.2},{x:96,y:22,size:2,delay:2.3,dur:3.8}];function Y({topBarRight:e,isAuthenticated:a=!1}){let[t,n]=(0,i.useState)(O),[r,s]=(0,i.useState)("all"),[T]=(0,p.Ym)(),M="pt"===T?"pt":"en";if((0,i.useEffect)(()=>{document.activeElement?.blur()},[t]),(0,i.useEffect)(()=>{let e=()=>n(O());return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[]),!t)return(0,o.jsx)(l.PE,{title:"pt"===M?"Jogos":"Games",sidebar:null,topBarRight:e,children:(0,o.jsxs)(G,{children:[H.map((e,a)=>(0,o.jsx)(q,{x:e.x,y:e.y,size:e.size,delay:e.delay,dur:e.dur},a)),(0,o.jsx)(D,{top:15,delay:12}),(0,o.jsx)(D,{top:55,delay:25}),(0,o.jsx)(A,{children:"pt"===M?"Vamos jogar!":"Let’s play!"}),(0,o.jsx)(J,{children:"pt"===M?"Escolhe um jogo para come\xe7ar":"Pick a game to get started"}),(0,o.jsxs)(I,{children:[(0,o.jsxs)(Q,{active:"all"===r,onClick:()=>s("all"),children:["\uD83C\uDFAE ","pt"===M?"Todos":"All"]}),(0,o.jsx)(Q,{active:"online"===r,chipColor:"#3fb950",onClick:()=>s("online"),children:"\uD83C\uDF10 Online"}),(0,o.jsxs)(Q,{active:"multiplayer"===r,chipColor:"#d2a8ff",onClick:()=>s("multiplayer"),children:["\uD83D\uDC65 3+ ","pt"===M?"Jogadores":"Players"]}),(0,o.jsxs)(Q,{active:"solo"===r,chipColor:"#f59e0b",onClick:()=>s("solo"),children:["\uD83C\uDFAF ","pt"===M?"Sozinho":"Solo"]})]}),(0,o.jsx)(F,{children:N.filter(e=>"online"===r?e.online:"multiplayer"===r?e.maxPlayers>=3:"solo"!==r||1===e.maxPlayers).map((e,t)=>{let i=1===e.maxPlayers?"pt"===M?"JOGO \xb7 SOLO":"GAME \xb7 SOLO":2===e.maxPlayers?"pt"===M?"JOGO \xb7 2P":"GAME \xb7 2P":"pt"===M?`JOGO \xb7 2-${e.maxPlayers}P`:`GAME \xb7 2-${e.maxPlayers}P`,r=e.maxPlayers>1?2===e.maxPlayers?"2":`2-${e.maxPlayers}`:void 0,s=E[e.id]?.[M];return(0,o.jsx)(c.Xl,{label:e.label[M],description:e.description[M],iconName:e.iconName,hash:e.hash,category:i,accentColor:e.color,playerCount:r,online:a&&e.online,onlineLabel:"ONLINE",vizId:e.id,vizLabel:s,index:t,onClick:()=>{n(e.id),window.location.hash=e.hash,d.recents.record("games",{hash:e.hash,label:e.label[M]??e.label.en,iconName:e.iconName,color:e.color})}},e.id)})})]})});let W=(0,o.jsxs)(X,{children:[(0,o.jsxs)(R,{onClick:()=>{n(null),window.location.hash="#/games"},children:["←",(0,o.jsxs)("span",{className:"back-label",children:[" ","pt"===M?"Jogos":"Games"]})]}),e]}),L=N.find(e=>e.id===t),Z=()=>{n(null),window.location.hash="#/games"};if("lebem"===t)return(0,o.jsx)(l.PE,{title:"L\xeaBem",sidebar:null,topBarRight:W,children:(0,o.jsx)(m.f,{onBack:Z})});let _={tictactoe:(0,o.jsx)(h.t,{lang:M,onBack:Z,canOnline:a}),soundhunter:(0,o.jsx)(u.m,{lang:M,onBack:Z}),familyquiz:(0,o.jsx)(x.i,{lang:M,onBack:Z,canOnline:a}),adventure:(0,o.jsx)(y.a,{lang:M,onBack:Z}),pixelboard:(0,o.jsx)(b.H,{lang:M,onBack:Z}),stopgame:(0,o.jsx)(g.z,{lang:M,onBack:Z,canOnline:a}),spotit:(0,o.jsx)(f.O,{lang:M,onBack:Z,canOnline:a}),memory:(0,o.jsx)(w.Y,{lang:M,onBack:Z,canOnline:a}),tapit:(0,o.jsx)(k.n,{lang:M,onBack:Z,canOnline:a}),jumpparty:(0,o.jsx)(j.v,{lang:M,onBack:Z}),drawguess:(0,o.jsx)(z.c,{lang:M,onBack:Z,canOnline:a}),animalarena:(0,o.jsx)(v.m,{lang:M,onBack:Z}),crazykitchen:(0,o.jsx)(P.A,{lang:M,onBack:Z}),miniparty:(0,o.jsx)($.k,{lang:M,onBack:Z}),hideseek:(0,o.jsx)(B.p,{lang:M,onBack:Z}),buttonmayhem:(0,o.jsx)(S.M,{lang:M,onBack:Z}),bombbrawl:(0,o.jsx)(C.$,{lang:M,onBack:Z,canOnline:a})};return(0,o.jsx)(l.PE,{title:L.title[M],sidebar:null,topBarRight:W,children:_[t]})}}}]);