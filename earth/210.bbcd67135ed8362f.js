    ...
    <div style="font-family:monospace;font-size:12px;line-height:1.75;min-width:180px;">
      ...
      ">🛸</div>`,u=s.divIcon({html:g,className:"",iconSize:[24,24],iconAnchor:[12,12]}),f=`
        <div style="font-family:monospace;font-size:12px;line-height:1.75;min-width:165px;">
          ...
          </div>`,{maxWidth:240}),u.addTo(e),o.current.set(a.id,u)}o.current.forEach((e,a)=>{l.has(a)||(e.remove(),o.current.delete(a))})}catch{}},[e,a]);return(0,n.useEffect)(()=>{if(!a)return void t();i();let e=setInterval(i,18e5);return()=>{clearInterval(e),t()}},[a,i,t]),null}},{id:"radar",label:"\uD83C\uDF27 Radar",title:"Weather radar — RainViewer",defaultEnabled:!1,component:function({map:e,enabled:a}){let o=(0,n.useRef)(null),t=(0,n.useCallback)(()=>{o.current?.remove(),o.current=null},[]),i=(0,n.useCallback)(async()=>{if(e&&a)try{let n=await fetch("https://api.rainviewer.com/public/weather-maps.json");if(!n.ok)return;let t=await n.json();if(!e||!a)return;let i=t.radar.past;if(!i?.length)return;let r=i[i.length-1],l=`${t.host}${r.path}/256/{z}/{x}/{y}/2/1_1.png`;o.current?.remove(),o.current=window.L.tileLayer(l,{opacity:.6,attribution:'<a href="https://www.rainviewer.com">RainViewer</a>'}).addTo(e)}catch{}},[e,a]);return(0,n.useEffect)(()=>{if(!a)return void t();i();let e=setInterval(i,3e5);return()=>{clearInterval(e),t()}},[a,i,t]),null}},{id:"flights",label:"✈ Flights",title:"Live flight traffic — altitude-coded",defaultEnabled:!1,component:function({map:e,enabled:a,zoom:o}){let t=(0,n.useRef)(new Map),i=(0,n.useRef)(new Map),s=(0,n.useRef)(new Map),c=(0,n.useRef)(new Map),d=(0,n.useRef)(new Map),m=(0,n.useRef)(null),g=(0,n.useRef)(null);(0,n.useEffect)(()=>(window.__atlantisFlightFollow=e=>{g.current=g.current===e?null:e},()=>{delete window.__atlantisFlightFollow}),[]);let u=(0,n.useCallback)(()=>{t.current.forEach(e=>e.remove()),t.current.clear(),i.current.forEach(e=>e.remove()),i.current.clear(),s.current.forEach(e=>e.remove()),s.current.clear(),c.current.clear(),d.current.clear(),g.current=null},[]),f=(0,n.useCallback)(async()=>{let n,u,f,p,h,y;if(!e||!a||o<5)return;let x=e.getCenter(),b=(n=e.getBounds(),u=e.getCenter(),f=n.getNorthEast(),p=u.lat*Math.PI/180,h=f.lat*Math.PI/180,Math.min(Math.ceil(6880.13*Math.atan2(Math.sqrt(y=Math.sin((f.lat-u.lat)*Math.PI/180/2)**2+Math.cos(p)*Math.cos(h)*Math.sin((f.lng-u.lng)*Math.PI/180/2)**2),Math.sqrt(1-y))),250)),w=`https://api.airplanes.live/v2/point/${x.lat.toFixed(4)}/${x.lng.toFixed(4)}/${b}`;m.current?.abort(),m.current=new AbortController;try{let o=await fetch(w,{signal:m.current.signal});if(!o.ok)return;let n=await o.json();if(!e||!a)return;let u=window.L,f=Date.now();for(let a of n.ac??[]){let o=null==a.lat||null==a.lon?null:{icao24:a.hex,callsign:a.flight?.trim()||null,lat:a.lat,lon:a.lon,altFt:"number"==typeof a.alt_baro?a.alt_baro:null,speedKts:a.gs??null,heading:a.track??null,vrateFpm:a.baro_rate??null,reg:a.r??null,type:a.t??null};if(!o||null==o.altFt)continue;let n=o.heading??0,m=r(o.altFt),p=g.current===o.icao24,h=u.divIcon({html:function(e,a,o){let n=o?`filter:drop-shadow(0 0 5px ${a}) drop-shadow(0 0 10px ${a});`:"filter:drop-shadow(0 1px 3px rgba(0,0,0,.9));";return`<div style="
...
`;function O({iconKey:e,size:a=16}){if(e&&!(e in F.t))return(0,t.jsx)("span",{style:{fontSize:a,lineHeight:1,display:"flex",alignItems:"center"},children:e});let o=e?F.t[e]??E.A:E.A;return(0,t.jsx)(o,{size:a,strokeWidth:1.75})}function V({entry:e,activeId:a,onSelect:o}){let[n,r]=(0,i.useState)(e.defaultOpen??!0),{collapsed:l,openFlyout:s,scheduleFlyoutClose:c,cancelFlyoutClose:d}=(0,m.c)();return e.children&&e.children.length>0?(0,t.jsxs)(_,{children:[(0,t.jsxs)(G,{collapsed:l,onClick:()=>{l||r(e=>!e)},onMouseEnter:l?a=>{s(e,a.currentTarget.getBoundingClientRect().top,o)}:void 0,onMouseLeave:l?c:void 0,children:[(0,t.jsxs)(N,{collapsed:l,children:[(0,t.jsx)(O,{iconKey:e.icon,size:16}),(0,t.jsx)(D,{collapsed:l,children:e.name})]}),(0,t.jsx)(K,{open:n,collapsed:l,children:(0,t.jsx)(L.A,{size:13})})]}),(0,t.jsx)(P,{open:n&&!l,children:(0,t.jsx)(R,{children:(0,t.jsx)(I,{children:e.children.map(e=>(0,t.jsx)(V,{entry:e,activeId:a,onSelect:o},e.id))})})})]}):(0,t.jsxs)(H,{active:a===e.id,collapsed:l,onClick:()=>o(e),onMouseEnter:l?a=>{let n=a.currentTarget.getBoundingClientRect();s({id:e.id,name:e.name,icon:e.icon,file:e.file,children:[e]},n.top,o)}:void 0,onMouseLeave:l?c:void 0,children:[(0,t.jsx)(O,{iconKey:e.icon,size:15}),(0,t.jsx)(D,{collapsed:l,children:e.name})]})}function U({entries:e,activeId:a,onSelect:o}){return(0,t.jsx)("div",{children:e.map(e=>(0,t.jsx)(V,{entry:e,activeId:a,onSelect:o},e.id))})}let W=(0,c.keyframes)`
