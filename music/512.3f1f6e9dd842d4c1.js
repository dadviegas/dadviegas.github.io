"use strict";(self.webpackChunk_atlantis_music=self.webpackChunk_atlantis_music||[]).push([["512"],{8997(e,t,s){var i=s(2727);t.createRoot=i.createRoot,i.hydrateRoot},3611(e,t,s){var i=s(5723),n=s(8997),a=s(7991),r=s(6859),l=s.n(r),o=s(2799),c=s(6063),d=s(4e3),m=s(8170),h=s(948);let p="music:history",u="music:playlists";function x(){return Math.random().toString(36).slice(2,10)}function y(e){return`music://music.apple.com/search?term=${encodeURIComponent(e)}`}let f=(0,o.keyframes)`
