"use strict";(self.webpackChunk_atlantis_csvexplorer=self.webpackChunk_atlantis_csvexplorer||[]).push([[188],{188(e,o,r){var s=r(7359),n=r(8997),t=r(3233),l=r(894),a=r(3317),i=r(3775),d=r(9161),c=r(679),p=r(4525),u=r(5426),x=r(668),h=r(4490),m=r(9336),w=r(5723);const f=`&::-webkit-scrollbar{width:6px;height:6px}&::-webkit-scrollbar-track{background:transparent}&::-webkit-scrollbar-thumb{background:${l.w4.colors.border};border-radius:3px}scrollbar-width:thin;scrollbar-color:${l.w4.colors.border} transparent;`,g=t.default.div`display:flex;flex:1;overflow:hidden;`,b=t.default.div`
...
//# sourceMappingURL=188.dbd41927122980a59837.js.map