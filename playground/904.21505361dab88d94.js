"use strict";(self.webpackChunk_atlantis_playground=self.webpackChunk_atlantis_playground||[]).push([["904"],{676(e,o,t){t.d(o,{A:()=>f});var a=t(5723),r=t(7991),i=t(7410),n=t(6030),l=t(1861),d=t(6004),s=t(5099),c=t(9194),p=t(6880),g=t(9282),h=t(6063);let m=i.Lz.theme({"&":{flex:"1",minHeight:"0",height:"100%",fontSize:"13px",fontFamily:"'JetBrains Mono', 'Fira Code', 'Cascadia Code', 'Consolas', monospace",background:h.w4.colors.mainBg},".cm-scroller":{overflow:"auto",lineHeight:"1.7",fontFamily:"inherit"},".cm-content":{padding:"16px",caretColor:h.w4.colors.accent},".cm-gutters":{background:h.w4.colors.mainBg,border:"none",borderRight:`1px solid ${h.w4.colors.border}`,color:h.w4.colors.sidebarTextMuted},".cm-activeLineGutter":{background:"transparent"},".cm-activeLine":{background:"rgba(88,166,255,0.04)"},".cm-selectionBackground, ::selection":{background:"rgba(88,166,255,0.2) !important"},".cm-cursor":{borderLeftColor:h.w4.colors.accent},"&::-webkit-scrollbar":{width:"6px",height:"6px"},"&::-webkit-scrollbar-track":{background:"transparent"},"&::-webkit-scrollbar-thumb":{background:h.w4.colors.border,borderRadius:"3px"}});function f({value:e,onChange:o,lang:t}){let h=(0,r.useRef)(null),x=(0,r.useRef)(null),u=(0,r.useRef)(o);return u.current=o,(0,r.useEffect)(()=>{if(!h.current)return;let o=new i.Lz({state:l.$t.create({doc:e,extensions:[n.oQ,d.bM,m,function(e){switch(e){case"html":return(0,s.qy)();case"css":return(0,c.AH)();case"ts":return(0,p.Q2)({typescript:!0});case"react":return(0,p.Q2)({jsx:!0,typescript:!0});default:return(0,p.Q2)()}}(t),i.w4.of([g.Yc]),i.Lz.updateListener.of(e=>{e.docChanged&&u.current(e.state.doc.toString())})]}),parent:h.current});return x.current=o,()=>{o.destroy(),x.current=null}},[t]),(0,r.useEffect)(()=>{let o=x.current;if(!o)return;let t=o.state.doc.toString();t!==e&&o.dispatch({changes:{from:0,to:t.length,insert:e}})},[e]),(0,a.jsx)("div",{ref:h,style:{flex:1,minHeight:0,overflow:"hidden",display:"flex",flexDirection:"column"}})}},5151(e,o,t){t.d(o,{k:()=>a});let a=[{label:"Hello World",html:`<h1>Hello, World!</h1>
...
`,x=({size:e=14,strokeWidth:o=1.75})=>(0,a.jsxs)("svg",{width:e,height:e,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:o,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,a.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,a.jsx)("polyline",{points:"14 2 14 8 20 8"})]});function u({iconKey:e}){let o=e?p[e]:void 0;return o?(0,a.jsx)("svg",{width:14,height:14,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,dangerouslySetInnerHTML:{__html:o}}):(0,a.jsx)(x,{})}function b({entries:e,activeId:o,onSelect:t}){return(0,a.jsx)(a.Fragment,{children:e.map(e=>e.children?(0,a.jsx)(i().Fragment,{children:(0,a.jsx)(b,{entries:e.children,activeId:o,onSelect:t})},e.id):(0,a.jsxs)(f,{active:o===e.id,onClick:()=>t(e),children:[(0,a.jsx)(u,{iconKey:e.icon}),e.name]},e.id))})}function y({activeId:e}){let{flyout:o,scheduleFlyoutClose:t,cancelFlyoutClose:r}=(0,c.c)();if(!o)return null;let i=o.entry.icon?p[o.entry.icon]:void 0;return(0,a.jsxs)(h,{anchorY:o.anchorY,onMouseEnter:r,onMouseLeave:t,children:[(0,a.jsxs)(m,{children:[i?(0,a.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,dangerouslySetInnerHTML:{__html:i}}):(0,a.jsx)(x,{size:13,strokeWidth:2}),o.entry.name]}),(0,a.jsx)(b,{entries:o.entry.children??[],activeId:e,onSelect:e=>{o.onSelect(e),t()}})]})}},7993(e,o,t){t.d(o,{I:()=>r,c:()=>i});var a=t(7991);let r=(0,a.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),i=()=>(0,a.useContext)(r)},132(e,o,t){t.d(o,{tz:()=>et,ms:()=>k,MJ:()=>em,$n:()=>b,tJ:()=>A,In:()=>B,K0:()=>$,PE:()=>eV,M7:()=>T});var a=t(5723),r=t(7991),i=t.n(r),n=t(6859),l=t.n(n),d=t(6063);let s={ghost:"transparent",accent:"transparent",primary:d.w4.colors.accent,success:"#238636",danger:"#da3633"},c={ghost:d.w4.colors.sidebarHover,accent:"rgba(88,166,255,0.10)",primary:d.w4.colors.accentHover,success:"#2ea043",danger:"#f85149"},p={ghost:d.w4.colors.border,accent:d.w4.colors.accent,primary:d.w4.colors.accent,success:"#238636",danger:"#da3633"},g={ghost:d.w4.colors.mainTextMuted,accent:d.w4.colors.accent,primary:"#fff",success:"#fff",danger:"#fff"},h={ghost:d.w4.colors.mainText,accent:d.w4.colors.accent,primary:"#fff",success:"#fff",danger:"#fff"},m={sm:"28px",md:"30px"},f={sm:"0 10px",md:"0 12px"},x={sm:"12px",md:"12px"},u=l().button`
  display: inline-flex;
  align-items: center;
  justify-content: center;
  gap: 6px;
...
`,b=i().forwardRef(function({variant:e="ghost",size:o="md",icon:t,iconRight:r,children:i,...n},l){return(0,a.jsxs)(u,{ref:l,variant:e,size:o,...n,children:[t,i,r]})}),y={default:d.w4.colors.accent,danger:"#f85149"},w={default:d.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"},v=l().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`,$=i().forwardRef(function({active:e=!1,shape:o="square",tone:t="default",children:r,...i},n){return(0,a.jsx)(v,{ref:n,active:e,shape:o,tone:t,...i,children:r})}),z=l().div`
  position: relative;
  display: inline-flex;
`,M=l().div`
  position: absolute;
  ...
  z-index: 2000;
  overflow: hidden;
`;function k({trigger:e,children:o,align:t="right",open:n,onOpenChange:l}){let[d,s]=(0,r.useState)(!1),c=n??d,p=e=>{l&&l(e),void 0===n&&s(e)},g=(0,r.useRef)(null);(0,r.useEffect)(()=>{if(!c)return;let e=e=>{g.current&&!g.current.contains(e.target)&&p(!1)};return document.addEventListener("mousedown",e),()=>document.removeEventListener("mousedown",e)},[c]);let h=i().cloneElement(e,{onClick:o=>{e.props.onClick?.(o),p(!c)},"aria-expanded":c,"aria-haspopup":"menu"});return(0,a.jsxs)(z,{ref:g,children:[h,c&&(0,a.jsx)(M,{align:t,role:"menu",children:o})]})}let A=l().button`
  display: flex;
  align-items: center;
  gap: 10px;
  padding: 8px 12px;
...
`,l().aside`
  ...
  display: flex;
  flex-direction: column;
  animation: ${q} 0.22s cubic-bezier(0.4, 0, 0.2, 1) both;
...
`;function et({activeAppId:e}){let{collapsed:o}=(0,J.c)(),[t]=function(){let[e,o]=(0,r.useState)(E),t=(0,r.useCallback)(e=>{o(e);try{localStorage.setItem(L,e)}catch{}(0,d.Is)(H,e).catch(()=>{}),window.dispatchEvent(new CustomEvent("atlantis:locale-change",{detail:e}))},[]);return(0,r.useEffect)(()=>{let e=e=>{o(e.detail)};return window.addEventListener("atlantis:locale-change",e),()=>window.removeEventListener("atlantis:locale-change",e)},[]),(0,r.useEffect)(()=>{(0,d.PL)(H).then(t=>{if(R(t)&&t!==e){try{localStorage.setItem(L,t)}catch{}o(t)}}).catch(()=>{})},[]),[e,t]}(),i=(0,r.useMemo)(()=>(e,o)=>{let a=function(e,o){if(!o||!e.includes("|"))return e;let t=null;for(let e of Object.values(o))if("number"==typeof e&&Number.isFinite(e)){t=e;break}if(null===t)return e;let a=e.indexOf("|"),r=e.slice(0,a),i=e.slice(a+1);return 1===t?r:i}(F[e]?.[t]??e,o);return o?Object.entries(o).reduce((e,[o,t])=>e.replace(RegExp(`\\{${o}\\}`,"g"),String(t)),a):a},[t]),n=(0,r.useRef)(null),l=e=>{n.current!==e&&(n.current=e,document.activeElement?.blur(),window.location.hash=e,setTimeout(()=>{n.current=null},50))};return(0,a.jsxs)(Z,{children:[(0,a.jsx)(X,{collapsed:o,children:i("devtools.heading")}),U.map(t=>{let r=i(t.labelKey);return(0,a.jsxs)(Q,{active:e===t.id,collapsed:o,onPointerDown:e=>{0===e.button&&l(t.hash)},onClick:()=>l(t.hash),title:r,children:[(0,a.jsx)(ee,{children:(0,a.jsx)(B,{name:t.icon,size:16})}),(0,a.jsx)(eo,{collapsed:o,children:r})]},t.id)})]})}let ea=(0,S.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`;l().div`
  display: grid;
...
`,eh=l().div`
  ...
  color: ${d.w4.colors.sidebarTextMuted};
  font-family: ${d.w4.typography.fontFamily};
`;function em({onSave:e,onUpdate:o,onCancel:t,existingDoc:i}){let[n,l]=(0,r.useState)(i?.name??""),d=(0,r.useRef)(null);return(0,r.useEffect)(()=>{d.current?.focus(),i&&d.current?.select()},[i]),(0,a.jsx)(en,{onClick:t,children:(0,a.jsxs)(el,{onClick:e=>e.stopPropagation(),children:[(0,a.jsx)(ed,{children:"Save document"}),i&&o&&(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(eh,{children:"Update the current version or save as a new one."}),(0,a.jsxs)(ec,{children:[(0,a.jsx)(ep,{onClick:t,children:"Cancel"}),(0,a.jsxs)(ep,{danger:!0,onClick:o,children:['Update "',i.name,'"']})]}),(0,a.jsx)(eg,{})]}),(0,a.jsx)(es,{ref:d,value:n,onChange:e=>l(e.target.value),onKeyDown:a=>{"Enter"===a.key&&n.trim()&&(i&&n.trim()===i.name&&o?o():e(n.trim())),"Escape"===a.key&&t()},placeholder:i?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,a.jsxs)(ec,{children:[!i&&(0,a.jsx)(ep,{onClick:t,children:"Cancel"}),(0,a.jsx)(ep,{primary:!0,disabled:!n.trim(),onClick:()=>e(n.trim()),children:"Save as new"})]})]})})}let ef=(0,S.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,ex=(0,S.keyframes)`
...
`,l().div`
  position: absolute;
  inset: 0;
  animation: ${eb} 1.4s cubic-bezier(0.4, 0, 0.2, 1) infinite;
...
`,l().div`
  ...
  border-radius: 50%;
  background: ${d.w4.colors.border};
  animation: ${ey} 1.4s ease-in-out infinite;
`,l().span`
  color: ${d.w4.colors.mainTextMuted};
  font-size: ${d.w4.typography.fontSizeSm};
  letter-spacing: 0.04em;
...
`,l().div`
  position: relative;
`;let ew="260px",ev="56px",e$="44px",ez=l().header`
  display: flex;
  align-items: center;
...
`,eF=l().div`
  ...
  overflow: hidden;
`,eL=l().aside`
  width: ${({collapsed:e})=>e?ev:ew};
  min-width: ${({collapsed:e})=>e?ev:ew};
  background: ${d.w4.colors.sidebarBg};
  border-right: 1px solid ${d.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,eR=l().main`
  ...
  display: flex;
  flex-direction: column;
`;function eE(){return(0,a.jsxs)(eA,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:[(0,a.jsx)(eT,{"aria-hidden":"true",children:"A"}),(0,a.jsx)(eS,{children:"Atlantis"})]})}let eP="atlantis:sidebar-collapsed";function eV({sidebar:e,children:o,topBarRight:n,title:l="Atlantis",activeId:d=null}){let[s,c]=(0,r.useState)(()=>{try{return"true"===localStorage.getItem(eP)}catch{return!1}}),[p,g]=(0,r.useState)(null),h=(0,r.useRef)(),m=()=>c(e=>{let o=!e;try{localStorage.setItem(eP,String(o))}catch{}return o}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(t.bind(t,5816)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,a.jsx)(J.I.Provider,{value:{collapsed:s,toggle:m,flyout:p,openFlyout:(e,o,t)=>{clearTimeout(h.current),g({entry:e,anchorY:o,onSelect:t})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,a.jsxs)(eF,{children:[(0,a.jsxs)(ez,{children:[e&&(0,a.jsx)(eM,{children:(0,a.jsx)(ek,{onClick:m,title:s?"Expand sidebar":"Collapse sidebar",children:(0,a.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,a.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,a.jsx)("path",{d:"M9 3v18"})]})})}),(0,a.jsx)(eE,{}),l&&(0,a.jsx)(ej,{children:l}),n&&(0,a.jsx)(eB,{children:n})]}),(0,a.jsxs)(eC,{children:[null!=e&&(0,a.jsx)(eL,{collapsed:s,children:(0,a.jsx)(eH,{children:e})}),(0,a.jsx)(eR,{children:o})]}),p&&(0,a.jsx)(i().Suspense,{fallback:null,children:(0,a.jsx)(f,{activeId:d})})]})})}l().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
