"use strict";(self.webpackChunk_atlantis_playground=self.webpackChunk_atlantis_playground||[]).push([[188],{188(e,t,r){var o=r(7359),s=r(8997),n=r(3233),a=r(7207),i=r(6879),l=r(1264),c=r(7071),d=r(6480),p=r(6135),u=r(9421),f=r(679),h=r(3482),m=r(1530),x=r(5496),g=r(9881),b=r(5426),w=r(9336),y=r(7293),$=r(5723);const j=a.keyframes`from{transform:rotate(0deg)}to{transform:rotate(360deg)}`,k=(0,n.default)(c.A)`animation: ${j} 1s linear infinite;`,v=n.default.div`
  display: flex;
  align-items: center;
  gap: ${i.w4.spacing.sm};
...
//# sourceMappingURL=188.cff07eab3e608ab3b332.js.map