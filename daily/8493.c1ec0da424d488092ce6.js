...
`;function u({iconKey:o}){const e=o?d.t[o]??i.A:i.A;return(0,c.jsx)(e,{size:14,strokeWidth:1.75})}function x({entries:o,activeId:e,onSelect:a}){return(0,c.jsx)(c.Fragment,{children:o.map(o=>o.children?(0,c.jsx)(t.Fragment,{children:(0,c.jsx)(x,{entries:o.children,activeId:e,onSelect:a})},o.id):(0,c.jsxs)(m,{active:e===o.id,onClick:()=>a(o),children:[(0,c.jsx)(u,{iconKey:o.icon}),o.name]},o.id))})}function b({activeId:o}){const{flyout:e,scheduleFlyoutClose:a,cancelFlyoutClose:t}=(0,s.c)();if(!e)return null;const n=e.entry.icon?d.t[e.entry.icon]??i.A:i.A;return(0,c.jsxs)(g,{anchorY:e.anchorY,onMouseEnter:t,onMouseLeave:a,children:[(0,c.jsxs)(f,{children:[(0,c.jsx)(n,{size:13,strokeWidth:2}),e.entry.name]}),(0,c.jsx)(x,{entries:e.entry.children??[],activeId:o,onSelect:o=>{e.onSelect(o),a()}})]})}},5959(o,e,a){a.d(e,{I:()=>n,c:()=>r});var t=a(7359);const n=(0,t.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),r=()=>(0,t.useContext)(n)},5185(o,e,a){a.d(e,{t:()=>wo});var t=a(9510),n=a(9038),r=a(7400),i=a(7561),l=a(8207),s=a(7902),d=a(6896),c=a(3013),p=a(2887),g=a(7901),f=a(9848),m=a(2164),u=a(3045),x=a(3775),b=a(3539),y=a(1783),w=a(9416),h=a(1837),$=a(7167),z=a(4494),v=a(2314),k=a(5751),A=a(255),M=a(9633),S=a(2946),T=a(822),F=a(6720),j=a(8456),B=a(3317),P=a(2709),C=a(9301),R=a(8006),E=a(3517),D=a(7032),L=a(6949),H=a(8218),N=a(6829),I=a(5553),Y=a(9591),G=a(9923),K=a(2820),O=a(4621),V=a(8479),_=a(2534),J=a(6673),W=a(7490),U=a(9033),Z=a(5775),X=a(1365),q=a(2937),Q=a(9821),oo=a(5912),eo=a(158),ao=a(8641),to=a(8607),no=a(3249),ro=a(1821),io=a(5889),lo=a(9655),so=a(7170),co=a(9161),po=a(1849),go=a(1604),fo=a(3142),mo=a(1187),uo=a(7747),xo=a(2932),bo=a(4525),yo=a(7230);const wo={activity:d.A,"a-large-small":s.A,apple:c.A,"arrow-right":p.A,"bar-chart-2":t.A,book:f.A,"book-open":g.A,briefcase:u.A,calendar:x.A,clock:y.A,"circle-dot":b.A,cloud:w.A,compass:h.A,cpu:$.A,droplets:z.A,feather:v.A,file:A.A,"file-text":k.A,folder:M.A,"git-branch":S.A,github:T.A,globe:F.A,grid:r.A,hand:j.A,hash:B.A,heart:P.A,key:R.A,hexagon:C.A,home:i.A,landmark:E.A,layers:l.A,"layout-grid":D.A,leaf:L.A,lightbulb:H.A,list:N.A,map:Y.A,"map-pin":I.A,"message-circle":G.A,"message-square":K.A,minus:O.A,monitor:V.A,mountain:_.A,package:J.A,palette:W.A,"pen-tool":U.A,"pie-chart":n.A,plane:Z.A,plus:X.A,ruler:q.A,shirt:Q.A,slash:oo.A,square:eo.A,star:ao.A,sun:to.A,terminal:no.A,thermometer:ro.A,triangle:io.A,trophy:lo.A,truck:so.A,type:co.A,users:po.A,"volume-2":go.A,watch:fo.A,waves:mo.A,wind:uo.A,wrench:xo.A,x:bo.A,zap:yo.A,bot:m.A}},9200(o,e,a){a.d(e,{PE:()=>T,WD:()=>ao,Up:()=>Q,yI:()=>eo,qj:()=>H,PL:()=>Y,Fy:()=>oo,pJ:()=>L,Is:()=>I,sg:()=>to,w4:()=>t.w4,dR:()=>q,xc:()=>J});var t=a(217),n=a(7359),r=a(3233),i=a(5723);r.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`;const S=n.default.div`
  ...
  align-items: center;
  gap: 8px;
`;function T({children:o,...e}){return(0,i.jsx)(S,{...e,children:o})}n.default.label`
  display: flex;
  align-items: center;
  gap: 10px;
...
`,n.default.p`
  ...
  font-size: 12.5px;
  line-height: 1.45;
`,a(1385),n.default.nav`padding: ${r.w4.spacing.sm} 0;`,n.default.div`
