...
`,A=i.default.main`
  ...
  display: flex;
  flex-direction: column;
`,k=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function j(){return(0,r.jsx)(y,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:k.map((e,o)=>(0,r.jsx)(b,{index:o,accent:e.accent,children:e.char},o))})}const S="atlantis:sidebar-collapsed";function M({sidebar:e,children:o,topBarRight:t,title:i="Atlantis",activeId:l=null}){const[d,m]=(0,n.useState)(()=>{try{return"true"===localStorage.getItem(S)}catch{return!1}}),[p,y]=(0,n.useState)(null),b=(0,n.useRef)(),k=()=>m(e=>{const o=!e;try{localStorage.setItem(S,String(o))}catch{}return o}),M=n.useMemo(()=>n.lazy(()=>Promise.resolve().then(a.bind(a,74914)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(c.I.Provider,{value:{collapsed:d,toggle:k,flyout:p,openFlyout:(e,o,a)=>{clearTimeout(b.current),y({entry:e,anchorY:o,onSelect:a})},scheduleFlyoutClose:()=>{b.current=setTimeout(()=>y(null),160)},cancelFlyoutClose:()=>clearTimeout(b.current)},children:(0,r.jsxs)(w,{children:[(0,r.jsxs)(g,{children:[e&&(0,r.jsx)(u,{children:(0,r.jsx)(f,{onClick:k,title:d?"Expand sidebar":"Collapse sidebar",children:(0,r.jsx)(s.A,{size:17})})}),(0,r.jsx)(j,{}),i&&(0,r.jsx)(h,{children:i}),t&&(0,r.jsx)(x,{children:t})]}),(0,r.jsxs)(z,{children:[null!=e&&(0,r.jsx)($,{collapsed:d,children:(0,r.jsx)(v,{children:e})}),(0,r.jsx)(A,{children:o})]}),p&&(0,r.jsx)(n.Suspense,{fallback:null,children:(0,r.jsx)(M,{activeId:l})})]})})}var T=a(20255),B=a(69753),E=a(65185);const C=i.default.div`
  display: grid;
...
`,bo={en:"Browse the sidebar",pt:"Explora o menu lateral"};function ho({title:e,sub:o,lang:a}){return(0,r.jsxs)(co,{children:[(0,r.jsx)(go,{}),(0,r.jsx)(mo,{size:500,x:10,y:-10,hue:210,dur:7}),(0,r.jsx)(mo,{size:400,x:60,y:50,hue:270,dur:9}),(0,r.jsx)(mo,{size:300,x:30,y:70,hue:190,dur:6}),(0,r.jsxs)(uo,{children:[(0,r.jsx)(fo,{children:e}),(0,r.jsx)(po,{children:o}),(0,r.jsxs)(yo,{children:[(0,r.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round",children:(0,r.jsx)("polyline",{points:"15 18 9 12 15 6"})}),bo[a]??bo.en]})]})]})}function xo(e,o,a){return"string"==typeof e?e:e[o]??e[a]??Object.values(e)[0]??""}function zo({navigation:e,languages:o,defaultLang:a,locale:t,hashPrefix:i,topBarRight:l,welcomeTitle:s="Blog",welcomeSub:c="Notes, guides, and references — pick a topic from the sidebar to get started."}){const d=o?Object.keys(o):[],[m,g]=(d.length,(0,n.useState)(()=>a??d[0]??""));(0,n.useEffect)(()=>{t&&d.includes(t)&&t!==m&&g(t)},[t]);const u=(0,n.useMemo)(()=>o&&m?o[m].navigation:e??{entries:[]},[o,e,m]),f=((0,n.useMemo)(()=>so(u.entries),[u]),(0,n.useCallback)(e=>{const o=e.match(new RegExp(`^#\\/${i}\\/(.+)$`));if(o)return lo(u.entries,o[1])},[u,i])),[p,y]=(0,n.useState)(()=>f(window.location.hash)??null);(0,n.useEffect)(()=>{if(!p)return;const e=lo(u.entries,p.id);y(e??null)},[m,u]),(0,n.useEffect)(()=>{const e=()=>{const e=f(window.location.hash);e&&y(e)};return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[f]);const b=(0,n.useCallback)(e=>{e.file&&(y(e),window.location.hash=`#/${i}/${e.id}`)},[i]),h=(0,n.useMemo)(()=>so(u.entries),[u]),x=h.findIndex(e=>e.id===p?.id),z=x>0?h[x-1]:null,w=x<h.length-1?h[x+1]:null,$=p?.label??p?.name??i,v=xo(s,m,a??d[0]??""),A=xo(c,m,a??d[0]??"");return(0,r.jsx)(M,{title:$,activeId:p?.id??null,topBarRight:l,sidebar:(0,r.jsx)(me,{config:u,activeId:p?.id??null,onSelect:b,hashPrefix:i}),children:p?.file?(0,r.jsx)(ro,{file:p.file,prevEntry:z,nextEntry:w,onNavigate:b}):(0,r.jsx)(ho,{title:v,sub:A,lang:m})})}i.default.div`
  display: flex;
  gap: 4px;
  background: ${t.w4.colors.surface};
  border: 1px solid ${t.w4.colors.border};
