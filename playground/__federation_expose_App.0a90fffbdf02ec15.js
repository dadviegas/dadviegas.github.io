"use strict";(self.webpackChunk_atlantis_playground=self.webpackChunk_atlantis_playground||[]).push([["6362"],{3935(e,t,r){r.r(t),r.d(t,{default:()=>Z});var o=r(5723),s=r(7991),i=r(6859),n=r.n(i),a=r(2799),l=r(4174),c=r(1638),d=r(7071),p=r(6480),u=r(6135),h=r(9421),m=r(679),x=r(3482),f=r(1530),g=r(5496),b=r(9881),w=r(5426),y=r(5151),$=r(676);let k=`You are a code generator. The user describes what they want and you return ONLY a JSON object with the code. No explanation, no markdown fences, no extra text — just the raw JSON.
