...
`;function q(e,o,r){return`<!DOCTYPE html>\n<html>\n<head>\n<meta charset="UTF-8">\n<style>*, *::before, *::after { box-sizing: border-box; }\n${o}\n</style>\n</head>\n<body>\n${e}\n<script>\n(function() {\n  const send = (kind, args) => {\n    window.parent.postMessage({ type: 'console', kind, text: args.map(a => {\n      try { return typeof a === 'object' ? JSON.stringify(a) : String(a); } catch { return String(a); }\n    }).join(' ') }, '*');\n  };\n  ['log','warn','error'].forEach(m => {\n    const orig = console[m].bind(console);\n    console[m] = (...args) => { orig(...args); send(m, args); };\n  });\n  window.addEventListener('error', e => send('error', [e.message + ' (' + e.filename + ':' + e.lineno + ')']));\n})();\n<\/script>\n<script>${r}<\/script>\n</body>\n</html>`}function G({topBarRight:e}){const o=x.k[0],[r,n]=(0,t.useState)(o.html),[b,G]=(0,t.useState)(o.css),[Q,V]=(0,t.useState)(o.js),[W,Z]=(0,t.useState)("html"),[ee,oe]=(0,t.useState)(()=>q(o.html,o.css,o.js)),[re,te]=(0,t.useState)(!1),[ne,ie]=(0,t.useState)(!1),[se,ae]=(0,t.useState)([]),[le,de]=(0,t.useState)(!1),[ce,pe]=(0,t.useState)(!1),[fe,ue]=(0,t.useState)(null),xe=(0,t.useRef)(null),ge=(0,t.useRef)(0);(0,t.useEffect)(()=>{const e=e=>{xe.current&&!xe.current.contains(e.target)&&de(!1)};return document.addEventListener("mousedown",e),()=>document.removeEventListener("mousedown",e)},[]),(0,t.useEffect)(()=>{const e=e=>{"console"===e.data?.type&&ae(o=>[...o.slice(-49),{kind:e.data.kind,text:e.data.text,id:ge.current++}])};return window.addEventListener("message",e),()=>window.removeEventListener("message",e)},[]);const be=(0,t.useCallback)(()=>{ae([]),oe(q(r,b,Q))},[r,b,Q]),he=()=>{!re&&ne&&ie(!1),te(e=>!e)},we=()=>{!ne&&re&&te(!1),ie(e=>!e)},me="html"===W?r:"css"===W?b:Q,$e="html"===W?n:"css"===W?G:V;return(0,g.jsxs)(h,{children:[(0,g.jsxs)(w,{children:[(0,g.jsxs)(m,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:["Atl",(0,g.jsx)("span",{children:"antis"})]}),(0,g.jsx)($,{children:"/"}),(0,g.jsxs)(y,{children:["Playground",(0,g.jsx)(k,{children:"HTML · CSS · JS"})]}),(0,g.jsx)(v,{}),(0,g.jsx)(T,{onClick:()=>{n(""),G(""),V(""),ae([]),oe(q("","",""))},title:"Clear all panels",children:"New"}),(0,g.jsx)(i.UO,{appId:"playground",onLoad:(e,o,r)=>{ue(o&&r?{id:o,name:r}:null);try{const{html:o,css:r,js:t}=JSON.parse(e);n(o??""),G(r??""),V(t??""),oe(q(o??"",r??"",t??"")),ae([])}catch{}}}),(0,g.jsxs)(j,{onClick:()=>pe(!0),children:[(0,g.jsx)(u.A,{size:13})," Save"]}),(0,g.jsxs)(z,{onClick:be,children:[(0,g.jsx)(p.A,{size:13})," Run"]}),(0,g.jsx)(S,{onClick:()=>ae([]),title:"Clear console",children:(0,g.jsx)(f.A,{size:13})}),(0,g.jsxs)(C,{ref:xe,children:[(0,g.jsxs)(T,{onClick:()=>de(e=>!e),children:["Examples ",(0,g.jsx)(l.A,{size:12})]}),le&&(0,g.jsx)(B,{children:x.k.map(e=>(0,g.jsx)(E,{onClick:()=>(e=>{n(e.html),G(e.css),V(e.js),ae([]),oe(q(e.html,e.css,e.js)),de(!1)})(e),children:e.label},e.label))})]}),e]}),ce&&(0,g.jsx)(i.MJ,{onSave:async e=>{pe(!1),await(0,i.KL)("playground",e,JSON.stringify({html:r,css:b,js:Q})),ue(null)},onCancel:()=>pe(!1)}),(0,g.jsxs)(M,{children:[re?(0,g.jsx)("div",{style:{position:"relative",flexShrink:0},children:(0,g.jsxs)(F,{onClick:he,title:"Show editors",children:[(0,g.jsx)(a.A,{size:14}),(0,g.jsx)(A,{children:"Editor"})]})}):(0,g.jsxs)(R,{collapsed:!1,children:[(0,g.jsxs)(L,{children:[["html","css","js"].map(e=>(0,g.jsxs)(O,{lang:e,active:W===e,onClick:()=>Z(e),children:[(0,g.jsx)(D,{lang:e}),e.toUpperCase()]},e)),(0,g.jsx)(J,{onClick:he,title:"Collapse editors",children:(0,g.jsx)(s.A,{size:14})})]}),(0,g.jsx)(P,{value:me,onChange:e=>$e(e.target.value),onKeyDown:e=>{if("Tab"===e.key){e.preventDefault();const o=e.currentTarget,r=o.selectionStart,t=o.value.substring(0,r)+"  "+o.value.substring(o.selectionEnd),n=Object.getOwnPropertyDescriptor(window.HTMLTextAreaElement.prototype,"value")?.set;n&&(n.call(o,t),o.dispatchEvent(new Event("input",{bubbles:!0}))),o.selectionStart=o.selectionEnd=r+2}},spellCheck:!1},W)]}),ne?(0,g.jsx)("div",{style:{position:"relative",flexShrink:0},children:(0,g.jsxs)(_,{onClick:we,title:"Show preview",children:[(0,g.jsx)(c.A,{size:14}),(0,g.jsx)(A,{children:"Preview"})]})}):(0,g.jsxs)(N,{collapsed:!1,children:[(0,g.jsxs)(H,{children:[(0,g.jsx)(U,{children:"Preview"}),(0,g.jsx)(J,{onClick:we,title:"Collapse preview",children:(0,g.jsx)(d.A,{size:14})})]}),(0,g.jsx)(Y,{children:(0,g.jsx)(K,{srcDoc:ee,sandbox:"allow-scripts",title:"preview"},ee)}),se.length>0&&(0,g.jsx)(X,{children:se.map(e=>(0,g.jsxs)(I,{kind:e.kind,children:["[",e.kind,"] ",e.text]},e.id))})]})]})]})}}}]);
//# sourceMappingURL=36.9f1ba9cbc7ab45f4a245.js.map