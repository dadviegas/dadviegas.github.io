"use strict";(self.webpackChunk_atlantis_pad=self.webpackChunk_atlantis_pad||[]).push([[6036],{46036(e,r,t){t.r(r),t.d(r,{default:()=>b});var o=t(27359),n=t(53233),a=t(71344),s=t(76480),i=t(26879),l=t(78967),c=t(51036),d=t(69835),u=t(47579),p=t(15933),m=t(65723);function g(){const e=window.location.hash.toLowerCase();return e.startsWith("#/mermaidpad")||e.startsWith("#/mermaid")?"mermaid":"markdown"}const f=n.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  padding: 5px 12px;
...
//# sourceMappingURL=6036.13bb14811563248f4604.js.map