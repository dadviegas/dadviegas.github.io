...
`,ee=s().main`
  ...
  display: flex;
  flex-direction: column;
`;function eo(){return(0,t.jsxs)(Y,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:[(0,t.jsx)(K,{"aria-hidden":"true",children:"A"}),(0,t.jsx)(_,{children:"Atlantis"})]})}let ea="atlantis:sidebar-collapsed";function et({sidebar:e,children:o,topBarRight:n,title:l="Atlantis",activeId:s=null}){let[d,c]=(0,r.useState)(()=>{try{return"true"===localStorage.getItem(ea)}catch{return!1}}),[p,g]=(0,r.useState)(null),h=(0,r.useRef)(),m=()=>c(e=>{let o=!e;try{localStorage.setItem(ea,String(o))}catch{}return o}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(a.bind(a,2787)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,t.jsx)(C.I.Provider,{value:{collapsed:d,toggle:m,flyout:p,openFlyout:(e,o,a)=>{clearTimeout(h.current),g({entry:e,anchorY:o,onSelect:a})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,t.jsxs)(J,{children:[(0,t.jsxs)(W,{children:[e&&(0,t.jsx)(O,{children:(0,t.jsx)(G,{onClick:m,title:d?"Expand sidebar":"Collapse sidebar",children:(0,t.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("path",{d:"M9 3v18"})]})})}),(0,t.jsx)(eo,{}),l&&(0,t.jsx)(q,{children:l}),n&&(0,t.jsx)(U,{children:n})]}),(0,t.jsxs)(Z,{children:[null!=e&&(0,t.jsx)(X,{collapsed:d,children:(0,t.jsx)(Q,{children:e})}),(0,t.jsx)(ee,{children:o})]}),p&&(0,t.jsx)(i().Suspense,{fallback:null,children:(0,t.jsx)(f,{activeId:s})})]})})}var er=a(4971);let ei=s().div`
  display: grid;
...
`,oH=s().div`
  ...
  font-family: ${n.w4.typography.fontFamily};
  margin-bottom: ${n.w4.spacing.md};
`,oP=s().ul`list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 2px;`,oR=s().a`
  display: block;
  padding: 4px 8px;
...
`,oQ=s().aside`
  ...
  display: flex;
  flex-direction: column;
  animation: ${oJ} 0.22s cubic-bezier(0.4, 0, 0.2, 1) both;
