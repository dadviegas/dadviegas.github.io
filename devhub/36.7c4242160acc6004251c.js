"use strict";(self.webpackChunk_atlantis_devhub=self.webpackChunk_atlantis_devhub||[]).push([[36],{36(e,i,d){d.r(i),d.d(i,{default:()=>m});var a=d(359),s=d(233),l=d(365),t=d(910),r=d(591),c=d(202),n=d(808),o=d(723);const h=[{id:"dashboard",name:"Dashboard",icon:"layout-grid",children:[{id:"package-radar",name:"Package Radar",icon:"package"},{id:"community-feed",name:"Community Feed",icon:"users"},{id:"dev-pulse",name:"Dev Pulse",icon:"activity"},{id:"tech-articles",name:"Tech Articles",icon:"book-open"}]}],u=s.default.div`
...
//# sourceMappingURL=36.7c4242160acc6004251c.js.map