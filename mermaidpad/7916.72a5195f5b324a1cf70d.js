...
`;function h({onSave:a,onCancel:o}){const[e,n]=(0,i.useState)(""),t=(0,i.useRef)(null);return(0,i.useEffect)(()=>{t.current?.focus()},[]),(0,r.jsx)(u,{onClick:o,children:(0,r.jsxs)(f,{onClick:a=>a.stopPropagation(),children:[(0,r.jsx)(p,{children:"Save document"}),(0,r.jsx)(z,{ref:t,value:e,onChange:a=>n(a.target.value),onKeyDown:n=>{"Enter"===n.key&&e.trim()&&a(e.trim()),"Escape"===n.key&&o()},placeholder:"Give this version a name…",maxLength:80}),(0,r.jsxs)(y,{children:[(0,r.jsx)(b,{onClick:o,children:"Cancel"}),(0,r.jsx)(b,{primary:!0,disabled:!e.trim(),onClick:()=>a(e.trim()),children:"Save"})]})]})})}var x=e(8006),A=e(679),w=e(4872);const k=t.default.div`
  position: relative;
`,v=t.default.button`
  display: flex;
  align-items: center;
