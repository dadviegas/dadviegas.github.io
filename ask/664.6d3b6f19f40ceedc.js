...
`,l().span`
  font-size: ${s.w4.typography.fontSizeBase};
  color: ${s.w4.colors.mainTextMuted};
`;var em=t(7223),eb=t(1426);let eu=l().div`
  margin: ${s.w4.spacing.lg} 0;
  border-radius: ${s.w4.borderRadius.md};
  border: 1px solid ${s.w4.colors.codeBorder};
  overflow: hidden;
...
`,ev={...eb.A,'pre[class*="language-"]':{...eb.A['pre[class*="language-"]'],background:s.w4.colors.codeBg,margin:0,padding:"18px 20px",fontSize:"13px",lineHeight:"1.6",borderRadius:0},'code[class*="language-"]':{...eb.A['code[class*="language-"]'],background:"none",fontSize:"13px"}};function ek({lang:e="text",code:o}){let[t,i]=(0,a.useState)(!1);return(0,r.jsxs)(eu,{children:[(0,r.jsxs)(ew,{children:[(0,r.jsx)(ey,{children:e}),(0,r.jsxs)(e$,{copied:t,onClick:()=>{navigator.clipboard.writeText(o).then(()=>{i(!0),setTimeout(()=>i(!1),2e3)})},children:[t?(0,r.jsx)(j,{name:"check",size:12}):(0,r.jsx)(j,{name:"copy",size:12}),t?"Copied!":"Copy"]})]}),(0,r.jsx)(em.A,{language:e,style:ev,showLineNumbers:o.split("\n").length>8,lineNumberStyle:{color:"#484f58",minWidth:"2.5em",paddingRight:"1.5em",userSelect:"none",fontSize:"12px"},customStyle:{margin:0,background:s.w4.colors.codeBg},wrapLongLines:!1,children:o})]})}let eM={NOTE:{bg:"rgba(88, 166, 255, 0.08)",border:"#58a6ff",icon:"info",label:"Note",color:"#58a6ff"},TIP:{bg:"rgba(63, 185, 80, 0.08)",border:"#3fb950",icon:"lightbulb",label:"Tip",color:"#3fb950"},IMPORTANT:{bg:"rgba(163, 113, 247, 0.08)",border:"#a371f7",icon:"zap",label:"Important",color:"#a371f7"},WARNING:{bg:"rgba(210, 153, 34, 0.08)",border:"#d29922",icon:"alert-triangle",label:"Warning",color:"#d29922"},CAUTION:{bg:"rgba(248, 81, 73, 0.08)",border:"#f85149",icon:"alert-octagon",label:"Caution",color:"#f85149"}},ez=l().div`
  background: ${({bg:e})=>e};
...
`;function eF({type:e,children:o}){let t=eM[e]??eM.NOTE;return(0,r.jsxs)(ez,{bg:t.bg,border:t.border,children:[(0,r.jsxs)(eT,{color:t.color,children:[(0,r.jsx)(j,{name:t.icon,size:15,strokeWidth:2}),t.label]}),(0,r.jsx)(eS,{children:o})]})}l().nav`
  width: 220px;
  min-width: 220px;
...
`;l().div`
  ...
  background: ${s.w4.colors.mainBg};
  font-family: ${s.w4.typography.fontFamily};
  animation: ${eI} 0.4s ease 0.15s both;
`,l().div`
  position: relative;
  width: 56px;
  height: 56px;
