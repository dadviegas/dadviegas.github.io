"use strict";(self.webpackChunk_atlantis_forma=self.webpackChunk_atlantis_forma||[]).push([["36"],{7103(e,o,t){t.d(o,{j:()=>h});var r=t(5723),a=t(7991),i=t(6859),n=t.n(i),s=t(4764),l=t(5030),d=t(9463);let c=n().section`
...
`,M=n().span`
  ...
  text-transform: uppercase;
  letter-spacing: 0.16em;
`;function z({data:e,t:o,onStart:t,onStop:i,onEditStart:n}){let j,F,T,S,C,[H,R]=(0,a.useState)(Date.now),L=e.sessions.some(e=>void 0===e.endedAt);(0,a.useEffect)(()=>{if(!L)return;let e=setInterval(()=>R(Date.now()),1e3);return()=>clearInterval(e)},[L]);let A=(0,d.currentFast)(e,H),D=A?.percent??0,B=null!==A,P=A?A.hoursElapsed:0,Y=A?A.remainingMs:0,V=A?A.session.targetHours:e.goal.targetHours;return(0,r.jsxs)(g,{children:[(0,r.jsxs)(f,{children:[(0,r.jsxs)(x,{width:200,height:200,viewBox:"0 0 200 200","aria-hidden":"true",children:[(0,r.jsx)("circle",{cx:100,cy:100,r:95,fill:"none",stroke:s.w4.colors.border,strokeWidth:10}),(0,r.jsx)("circle",{cx:100,cy:100,r:95,fill:"none",stroke:c,strokeWidth:10,strokeLinecap:"round",strokeDasharray:p,strokeDashoffset:p*(1-D),style:{transition:"stroke-dashoffset 0.6s ease"}})]}),(0,r.jsx)(h,{children:B?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(m,{children:[P.toFixed(1),"h"]}),(0,r.jsx)(u,{children:o("forma.timer.elapsed")})]}):(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(m,{children:[V,"h"]}),(0,r.jsx)(u,{children:o("forma.hero.notFasting")})]})})]}),B&&A&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(y,{children:[(0,r.jsx)(w,{children:A.session.protocol}),n&&(0,r.jsx)($,{type:"button",onClick:()=>n(A.session),title:o("forma.timer.editStart"),children:o("forma.timer.startedAt",{time:(F=String((j=new Date(A.session.startedAt)).getHours()).padStart(2,"0"),T=String(j.getMinutes()).padStart(2,"0"),`${F}:${T}`)})})]}),(0,r.jsxs)(b,{children:[(0,r.jsxs)(v,{children:[(0,r.jsx)(k,{children:(C=Math.floor((S=Math.floor(Y/6e4))/60),`${String(C).padStart(2,"0")}:${String(S%60).padStart(2,"0")}`)}),(0,r.jsx)(M,{children:o("forma.timer.remaining")})]}),(0,r.jsxs)(v,{children:[(0,r.jsxs)(k,{children:[Math.round(100*D),"%"]}),(0,r.jsx)(M,{children:o("forma.timer.complete")})]})]})]}),B&&A?(0,r.jsx)(l.$n,{variant:"danger",onClick:()=>i(A.session),children:o("forma.stop")}):(0,r.jsx)(l.$n,{variant:"success",onClick:t,children:o("forma.start")})]})}},9276(e,o,t){t.d(o,{Y:()=>S});var r=t(5723),a=t(7991),i=t(6859),n=t.n(i),s=t(4764),l=t(5030),d=t(2799);let c=(0,d.keyframes)`
...
`;function S({open:e,onClose:o,data:t,t:i,onStartFast:n,onStopFast:s,onLogMeal:d,onLogWeight:c,onLogWalk:p}){let[g,f]=(0,a.useState)(null),[x,h]=(0,a.useState)("16:8"),[m,w]=(0,a.useState)("16"),[C,H]=(0,a.useState)("dinner"),[R,L]=(0,a.useState)(""),[A,D]=(0,a.useState)(""),[B,P]=(0,a.useState)(""),[Y,V]=(0,a.useState)(""),[I,W]=(0,a.useState)(""),E=t.sessions.some(e=>void 0===e.endedAt),N=(0,a.useCallback)(()=>{f(null)},[]),O=(0,a.useCallback)(()=>{N(),o()},[N,o]),G=(0,a.useCallback)(()=>{let e=parseInt(m,10);isNaN(e)||e<1||(n(x,e),O())},[x,m,n,O]),q=(0,a.useCallback)(()=>{d(C,parseFloat(R)||0,parseFloat(A)||0,B.trim()),O()},[C,R,A,B,d,O]),K=(0,a.useCallback)(()=>{let e=parseFloat(Y.replace(",","."));isNaN(e)||e<=0||(c(e),O())},[Y,c,O]),J=(0,a.useCallback)(()=>{let e=parseInt(I,10);isNaN(e)||e<=0||(p(e),O())},[I,p,O]);return(0,r.jsx)(u,{open:e,onClose:O,maxWidth:520,ariaLabel:i("forma.sheet.ariaLabel"),children:(0,r.jsxs)(b,{children:[(0,r.jsx)(l.YZ,{children:i("forma.sheet.title")}),(0,r.jsx)($,{children:(0,r.jsx)(l.YZ,{children:i("forma.sheet.fastSection")})}),E?(0,r.jsx)(l.$n,{variant:"danger",onClick:()=>{s(),O()},children:i("forma.stop")}):"startFast"===g?(0,r.jsxs)(y,{children:[(0,r.jsxs)(v,{children:[(0,r.jsx)(k,{htmlFor:"fast-protocol",children:i("forma.rail.title")}),(0,r.jsxs)(z,{id:"fast-protocol",value:x,onChange:e=>{let o=e.target.value;h(o),"custom"!==o&&w(o.split(":")[0])},children:[(0,r.jsx)("option",{value:"16:8",children:"16:8"}),(0,r.jsx)("option",{value:"18:6",children:"18:6"}),(0,r.jsx)("option",{value:"20:4",children:"20:4"}),(0,r.jsx)("option",{value:"custom",children:i("forma.protocol.custom")})]})]}),"custom"===x&&(0,r.jsxs)(v,{children:[(0,r.jsx)(k,{htmlFor:"fast-hours",children:i("forma.timer.target")}),(0,r.jsx)(M,{id:"fast-hours",type:"number",value:m,min:1,max:72,onChange:e=>w(e.target.value)})]}),(0,r.jsxs)(T,{children:[(0,r.jsx)(l.$n,{variant:"success",onClick:G,children:i("forma.start")}),(0,r.jsx)(l.$n,{variant:"ghost",onClick:N,children:i("forma.sheet.cancel")})]})]}):(0,r.jsxs)(F,{onClick:()=>f("startFast"),children:[(0,r.jsx)(l.In,{name:"play",size:16}),i("forma.start")]}),(0,r.jsx)($,{children:(0,r.jsx)(l.YZ,{children:i("forma.sheet.mealSection")})}),"meal"===g?(0,r.jsxs)(y,{children:[(0,r.jsxs)(v,{children:[(0,r.jsx)(k,{htmlFor:"meal-slot",children:i("forma.meal.lunch")}),(0,r.jsxs)(j,{id:"meal-slot",value:C,onChange:e=>H(e.target.value),children:[(0,r.jsx)("option",{value:"lunch",children:i("forma.meal.lunch")}),(0,r.jsx)("option",{value:"dinner",children:i("forma.meal.dinner")}),(0,r.jsx)("option",{value:"snack",children:i("forma.meal.snack")})]})]}),(0,r.jsxs)(v,{children:[(0,r.jsx)(k,{htmlFor:"meal-protein",children:i("forma.sheet.proteinLabel")}),(0,r.jsx)(M,{id:"meal-protein",type:"number",value:R,min:0,placeholder:"0",onChange:e=>L(e.target.value)})]}),(0,r.jsxs)(v,{children:[(0,r.jsx)(k,{htmlFor:"meal-kcal",children:i("forma.sheet.kcalLabel")}),(0,r.jsx)(M,{id:"meal-kcal",type:"number",value:A,min:0,placeholder:"0",onChange:e=>D(e.target.value)})]}),(0,r.jsxs)(v,{children:[(0,r.jsx)(k,{htmlFor:"meal-notes",children:i("forma.meal.template")}),(0,r.jsx)(M,{id:"meal-notes",type:"text",value:B,placeholder:"ovos, frango…",onChange:e=>P(e.target.value)})]}),(0,r.jsxs)(T,{children:[(0,r.jsx)(l.$n,{variant:"primary",onClick:q,children:i("forma.sheet.save")}),(0,r.jsx)(l.$n,{variant:"ghost",onClick:N,children:i("forma.sheet.cancel")})]})]}):(0,r.jsxs)(F,{onClick:()=>f("meal"),children:[(0,r.jsx)(l.In,{name:"utensils",size:16}),i("forma.sheet.logMeal")]}),(0,r.jsx)($,{children:(0,r.jsx)(l.YZ,{children:i("forma.sheet.weightSection")})}),"weight"===g?(0,r.jsxs)(y,{children:[(0,r.jsxs)(v,{children:[(0,r.jsx)(k,{htmlFor:"weight-kg",children:i("forma.sheet.weightLabel")}),(0,r.jsx)(M,{id:"weight-kg",type:"number",value:Y,min:20,max:300,step:.1,placeholder:"84.2",onChange:e=>V(e.target.value)})]}),(0,r.jsxs)(T,{children:[(0,r.jsx)(l.$n,{variant:"primary",onClick:K,children:i("forma.sheet.save")}),(0,r.jsx)(l.$n,{variant:"ghost",onClick:N,children:i("forma.sheet.cancel")})]})]}):(0,r.jsxs)(F,{onClick:()=>f("weight"),children:[(0,r.jsx)(l.In,{name:"trending-up",size:16}),i("forma.sheet.logWeight")]}),(0,r.jsx)($,{children:(0,r.jsx)(l.YZ,{children:i("forma.sheet.walkSection")})}),"walk"===g?(0,r.jsxs)(y,{children:[(0,r.jsxs)(v,{children:[(0,r.jsx)(k,{htmlFor:"walk-min",children:i("forma.sheet.walkLabel")}),(0,r.jsx)(M,{id:"walk-min",type:"number",value:I,min:1,max:600,placeholder:"30",onChange:e=>W(e.target.value)})]}),(0,r.jsxs)(T,{children:[(0,r.jsx)(l.$n,{variant:"primary",onClick:J,children:i("forma.sheet.save")}),(0,r.jsx)(l.$n,{variant:"ghost",onClick:N,children:i("forma.sheet.cancel")})]})]}):(0,r.jsxs)(F,{onClick:()=>f("walk"),children:[(0,r.jsx)(l.In,{name:"activity",size:16}),i("forma.sheet.logWalk")]})]})})}},950(e,o,t){t.d(o,{M:()=>S});var r=t(5723),a=t(7991),i=t(6859),n=t.n(i),s=t(4764),l=t(9463);let d="#7fb77e";function c(e){return[parseInt(e.slice(1,3),16),parseInt(e.slice(3,5),16),parseInt(e.slice(5,7),16)]}let p=c("#1d2230"),g=c(d);function f(e){let o=Math.round(p[0]+(g[0]-p[0])*e),t=Math.round(p[1]+(g[1]-p[1])*e),r=Math.round(p[2]+(g[2]-p[2])*e);return`rgb(${o},${t},${r})`}let x=new Set([0,4,8,12,16,20]),h=["Mo","Tu","We","Th","Fr","Sa","Su"],m=["Se","Te","Qa","Qi","Sx","S\xe1","Do"],u=n().section`
  background: ${s.w4.colors.surface};
  border: 1px solid ${s.w4.colors.border};
...
`,u=n().span`
  ...
  color: ${d};
  align-self: center;
`;function w({data:e,t:o,onSave:t}){let[i,n]=(0,a.useState)(String(e.goal.proteinG??110)),[s,d]=(0,a.useState)(String(e.goal.kcal??2200)),[b,y]=(0,a.useState)(String(e.goal.walkMin??30)),[$,v]=(0,a.useState)(String(e.goal.weightKg??"")),[k,M]=(0,a.useState)(String(e.goal.targetHours)),[z,j]=(0,a.useState)(String(e.goal.weeklyFasts)),[F,T]=(0,a.useState)(!1),S=async()=>{let o={...e,goal:{targetHours:Number(k)||16,weeklyFasts:Number(z)||5,proteinG:Number(i)||void 0,kcal:Number(s)||void 0,walkMin:Number(b)||void 0,weightKg:$?Number($):void 0}};await t(o),T(!0),setTimeout(()=>T(!1),2e3)};return(0,r.jsxs)(c,{children:[(0,r.jsxs)(p,{children:[(0,r.jsxs)(g,{children:["◉ ",o("forma.settings.foodGoals")]}),(0,r.jsxs)(f,{children:[(0,r.jsx)(x,{children:o("forma.settings.proteinG")}),(0,r.jsx)(h,{type:"number",value:i,onChange:e=>n(e.target.value)})]}),(0,r.jsxs)(f,{children:[(0,r.jsx)(x,{children:o("forma.settings.kcal")}),(0,r.jsx)(h,{type:"number",value:s,onChange:e=>d(e.target.value)})]}),(0,r.jsxs)(f,{children:[(0,r.jsx)(x,{children:o("forma.settings.walkMin")}),(0,r.jsx)(h,{type:"number",value:b,onChange:e=>y(e.target.value)})]}),(0,r.jsxs)(f,{children:[(0,r.jsx)(x,{children:o("forma.settings.weightTarget")}),(0,r.jsx)(h,{type:"number",step:"0.1",value:$,onChange:e=>v(e.target.value)})]})]}),(0,r.jsxs)(p,{children:[(0,r.jsxs)(g,{children:["◉ ",o("forma.settings.fastingGoals")]}),(0,r.jsxs)(f,{children:[(0,r.jsx)(x,{children:o("forma.settings.targetHours")}),(0,r.jsx)(h,{type:"number",value:k,onChange:e=>M(e.target.value)})]}),(0,r.jsxs)(f,{children:[(0,r.jsx)(x,{children:o("forma.settings.weeklyFasts")}),(0,r.jsx)(h,{type:"number",value:z,onChange:e=>j(e.target.value)})]})]}),(0,r.jsxs)(m,{children:[F&&(0,r.jsx)(u,{children:o("forma.settings.saved")}),(0,r.jsx)(l.$n,{variant:"primary",onClick:()=>void S(),children:o("forma.settings.save")})]})]})}},5742(e,o,t){t.d(o,{_:()=>T});var r=t(5723),a=t(6859),i=t.n(a),n=t(4764),s=t(5030),l=t(9463);let d="#7fb77e",c=i().section`
...
`,F=i().div`
  ...
  font-family: ${n.w4.typography.fontFamilyMono};
  font-variant-numeric: tabular-nums;
`;function T({data:e,t:o,onLogMeal:t,onLogWalk:a,onLogWeight:i,onDeleteMeal:d,onEditMeal:S}){var C,H;let R=new Date().toISOString().slice(0,10),L=(0,l.proteinByDay)(e.meals,R),A=(C=e.meals,C.filter(e=>e.date===R).reduce((e,o)=>e+(o.kcal??0),0)),D=(H=e.walks,H.filter(e=>e.date===R).reduce((e,o)=>e+o.minutes,0)),B=e.meals.filter(e=>e.date===R).sort((e,o)=>e.createdAt-o.createdAt),P=e.goal.proteinG??110;return(0,r.jsxs)(c,{children:[(0,r.jsxs)(p,{children:[(0,r.jsxs)(g,{children:["◉ ",o("forma.today.title")]}),(0,r.jsx)(g,{children:new Date().toLocaleDateString(void 0,{weekday:"long",day:"numeric",month:"short"})})]}),(0,r.jsxs)(f,{children:[(0,r.jsxs)(x,{children:[(0,r.jsxs)(h,{children:[Math.round(L),(0,r.jsxs)("span",{style:{fontSize:14,color:n.w4.colors.mainTextMuted,marginLeft:4},children:["/ ",P,"g"]})]}),(0,r.jsx)(m,{children:o("forma.today.protein")})]}),(0,r.jsxs)(x,{children:[(0,r.jsx)(h,{children:Math.round(A)}),(0,r.jsx)(m,{children:o("forma.today.kcal")})]}),(0,r.jsxs)(x,{children:[(0,r.jsxs)(h,{children:[D,(0,r.jsx)("span",{style:{fontSize:14,color:n.w4.colors.mainTextMuted,marginLeft:4},children:"min"})]}),(0,r.jsx)(m,{children:o("forma.today.walk")})]})]}),(0,r.jsx)(u,{children:(0,r.jsx)(w,{pct:L/P*100})}),(0,r.jsxs)(b,{children:[(0,r.jsx)(s.$n,{variant:"primary",icon:(0,r.jsx)(s.In,{name:"plus",size:14}),onClick:t,children:o("forma.action.logMeal")}),(0,r.jsx)(s.$n,{variant:"ghost",icon:(0,r.jsx)(s.In,{name:"plus",size:14}),onClick:a,children:o("forma.action.logWalk")}),(0,r.jsx)(s.$n,{variant:"ghost",icon:(0,r.jsx)(s.In,{name:"plus",size:14}),onClick:i,children:o("forma.action.logWeight")})]}),0===B.length?(0,r.jsx)(j,{children:o("forma.today.noMealsYet")}):(0,r.jsx)(y,{children:B.map(e=>(0,r.jsxs)($,{children:[(0,r.jsx)(v,{children:o(`forma.meal.${e.slot}`)}),(0,r.jsx)(k,{children:e.notes||"—"}),(0,r.jsxs)(M,{children:[e.proteinG??0,"g \xb7 ",e.kcal??0,"kcal"]}),(0,r.jsx)(z,{onClick:()=>d(e.id),"aria-label":o("forma.action.delete"),children:(0,r.jsx)(s.In,{name:"trash",size:14})})]},e.id))}),D>0&&(0,r.jsx)(F,{children:(0,r.jsx)("span",{children:o("forma.today.walkSummary",{min:D})})})]})}},483(e,o,t){t.d(o,{v:()=>v});var r=t(5723),a=t(6859),i=t.n(a),n=t(2799),s=t(4764),l=t(5030);let d="#7fb77e",c=(0,n.keyframes)`
...
`;function v({data:e,t:o,locale:t}){let a,i,n,s=(i=new Date(a=new Date),n=(a.getDay()+6)%7,i.setDate(a.getDate()-n),i.setHours(0,0,0,0),Array.from({length:7},(e,o)=>{let t=new Date(i);return t.setDate(i.getDate()+o),{date:f(t),weekday:t.getDay()}})),d=f(new Date),c="pt"===t?g:p,k=new Map;for(let o of e.templates)k.set(o.weekday,o);return(0,r.jsxs)(x,{children:[(0,r.jsx)(h,{children:o("forma.week.title")}),(0,r.jsx)(m,{children:s.map(({date:t,weekday:a})=>{let i=t===d,n=e.meals.some(e=>e.date===t),s=e.sessions.some(e=>void 0!==e.endedAt&&f(new Date(e.startedAt))===t),p=n||s,g=k.get(a);return(0,r.jsxs)(u,{isToday:i,isDone:p,children:[(0,r.jsx)(w,{isToday:i,children:c[a]}),p?(0,r.jsx)(y,{"aria-label":o("forma.week.done"),children:(0,r.jsx)(l.In,{name:"check-circle",size:14})}):g?(0,r.jsx)($,{title:o("forma.week.planned")}):null,g&&(0,r.jsx)(b,{children:o(g.nameKey)})]},t)})})]})}},1533(e,o,t){t.d(o,{h:()=>g});var r=t(5723),a=t(7991),i=t(6859),n=t.n(i),s=t(4764);let l="#7fb77e",d=n().div`
  position: relative;
  width: 100%;
  height: 100%;
  min-height: 140px;
...
`;let j={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:l.w4.colors.accentMuted},F={neutral:l.w4.colors.mainTextMuted,live:l.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:l.w4.colors.accent};s().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${l.w4.typography.fontFamilyMono};
...
`;let T=s().div`
  ...
  align-items: center;
  gap: 8px;
`;function S({children:e,...o}){return(0,r.jsx)(T,{...o,children:e})}s().label`
  display: flex;
  align-items: center;
  gap: 10px;
...
`,s().div`
  ...
  flex-direction: column;
  gap: 14px;
  animation: ${N} 0.18s cubic-bezier(0.22, 1, 0.36, 1) both;
`,s().div`
  font-size: ${l.w4.typography.fontSizeMd};
  font-weight: 700;
