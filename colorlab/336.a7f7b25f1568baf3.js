...
`,l().div`
  position: relative;
`;let oe="260px",ot="56px",or="44px",oi=l().header`
  display: flex;
  align-items: center;
...
`,ou=l().main`
  ...
  display: flex;
  flex-direction: column;
`;function ob(){return(0,t.jsxs)(od,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:[(0,t.jsx)(os,{"aria-hidden":"true",children:"A"}),(0,t.jsx)(oc,{children:"Atlantis"})]})}let oy="atlantis:sidebar-collapsed";function ow({sidebar:o,children:a,topBarRight:n,title:l="Atlantis",activeId:d=null}){let[s,c]=(0,r.useState)(()=>{try{return"true"===localStorage.getItem(oy)}catch{return!1}}),[p,g]=(0,r.useState)(null),h=(0,r.useRef)(),m=()=>c(o=>{let a=!o;try{localStorage.setItem(oy,String(a))}catch{}return a}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(e.bind(e,5816)).then(o=>({default:o.FlyoutPanel}))),[]);return(0,t.jsx)(K.I.Provider,{value:{collapsed:s,toggle:m,flyout:p,openFlyout:(o,a,e)=>{clearTimeout(h.current),g({entry:o,anchorY:a,onSelect:e})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,t.jsxs)(om,{children:[(0,t.jsxs)(oi,{children:[o&&(0,t.jsx)(on,{children:(0,t.jsx)(ol,{onClick:m,title:s?"Expand sidebar":"Collapse sidebar",children:(0,t.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("path",{d:"M9 3v18"})]})})}),(0,t.jsx)(ob,{}),l&&(0,t.jsx)(op,{children:l}),n&&(0,t.jsx)(og,{children:n})]}),(0,t.jsxs)(oh,{children:[null!=o&&(0,t.jsx)(of,{collapsed:s,children:(0,t.jsx)(ox,{children:o})}),(0,t.jsx)(ou,{children:a})]}),p&&(0,t.jsx)(i().Suspense,{fallback:null,children:(0,t.jsx)(f,{activeId:d})})]})})}l().div`
  display: grid;
  grid-template-rows: ${({open:o})=>o?"1fr":"0fr"};
