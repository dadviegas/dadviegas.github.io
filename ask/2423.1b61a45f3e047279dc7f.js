"use strict";(self.webpackChunk_atlantis_ask=self.webpackChunk_atlantis_ask||[]).push([[2423],{30894(e,o,a){a.d(o,{Nx:()=>p,aw:()=>g,Ym:()=>c});var t=a(27359),r=a(59200);const n={"time.justNow":{en:"just now",pt:"agora mesmo"},"time.mAgo":{en:"{n}m ago",pt:"há {n}m"},"time.hAgo":{en:"{n}h ago",pt:"há {n}h"},"time.dAgo":{en:"{n}d ago",pt:"há {n}d"},updated:{en:"updated {age}",pt:"atualizado {age}"},refresh:{en:"Refresh",pt:"Atualizar"},loading:{en:"Loading…",pt:"A carregar…"},noData:{en:"No data available",pt:"Sem dados disponíveis"},noDescription:{en:"No description provided.",pt:"Sem descrição."},failedToFetch:{en:"Failed to fetch",pt:"Erro ao carregar"},perWeek:{en:"/ wk",pt:"/ sem"},"devtools.heading":{en:"Dev Tools",pt:"Ferramentas"},"devtools.playground":{en:"Playground",pt:"Playground"},"devtools.pad":{en:"Pad",pt:"Pad"},"devtools.charts":{en:"Charts",pt:"Gráficos"},"devtools.csv":{en:"CSV",pt:"CSV"},"devtools.regex":{en:"Regex",pt:"Regex"},"devtools.json":{en:"JSON",pt:"JSON"},"devtools.diff":{en:"Diff",pt:"Diferenças"},"devtools.jwt":{en:"JWT",pt:"JWT"},"devtools.cron":{en:"Cron",pt:"Cron"},"devtools.colors":{en:"Colors",pt:"Cores"},"devtools.api":{en:"API",pt:"API"}},i="atlantis:locale",l="shell:locale";function s(e){return"en"===e||"pt"===e}function d(){try{const e=localStorage.getItem(i);if(s(e))return e}catch{}return"en"}function c(){const[e,o]=(0,t.useState)(d),a=(0,t.useCallback)(e=>{o(e),function(e){try{localStorage.setItem(i,e)}catch{}(0,r.Is)(l,e).catch(()=>{})}(e),window.dispatchEvent(new CustomEvent("atlantis:locale-change",{detail:e}))},[]);return(0,t.useEffect)(()=>{const e=e=>{const a=e.detail;o(a)};return window.addEventListener("atlantis:locale-change",e),()=>window.removeEventListener("atlantis:locale-change",e)},[]),(0,t.useEffect)(()=>{(0,r.PL)(l).then(a=>{if(s(a)&&a!==e){try{localStorage.setItem(i,a)}catch{}o(a)}}).catch(()=>{})},[]),[e,a]}function p(e,o){const a=o?{...n,...o}:n;return(o,t)=>{const r=a[o]?.[e]??o;return t?Object.entries(t).reduce((e,[o,a])=>e.replace(new RegExp(`\\{${o}\\}`,"g"),String(a)),r):r}}function g(e,o){const a=Date.now()-new Date(e).getTime(),t=Math.floor(a/6e4);if(t<1)return o("time.justNow");if(t<60)return o("time.mAgo",{n:t});const r=Math.floor(t/60);return r<24?o("time.hAgo",{n:r}):o("time.dAgo",{n:Math.floor(r/24)})}(0,r.PL)(l).then(e=>{if(s(e))try{localStorage.setItem(i,e)}catch{}}).catch(()=>{});var f=a(53233);a(65723),f.default.div`
  display: flex;
  gap: 4px;
...
`},74914(e,o,a){a.d(o,{FlyoutPanel:()=>h});var t=a(27359),r=a(53233),n=a(77207),i=a(20255),l=a(217),s=a(15959),d=a(65185),c=a(65723);const p=n.keyframes`
...
`;function u({iconKey:e}){const o=e?d.t[e]??i.A:i.A;return(0,c.jsx)(o,{size:14,strokeWidth:1.75})}function x({entries:e,activeId:o,onSelect:a}){return(0,c.jsx)(c.Fragment,{children:e.map(e=>e.children?(0,c.jsx)(t.Fragment,{children:(0,c.jsx)(x,{entries:e.children,activeId:o,onSelect:a})},e.id):(0,c.jsxs)(m,{active:o===e.id,onClick:()=>a(e),children:[(0,c.jsx)(u,{iconKey:e.icon}),e.name]},e.id))})}function h({activeId:e}){const{flyout:o,scheduleFlyoutClose:a,cancelFlyoutClose:t}=(0,s.c)();if(!o)return null;const r=o.entry.icon?d.t[o.entry.icon]??i.A:i.A;return(0,c.jsxs)(g,{anchorY:o.anchorY,onMouseEnter:t,onMouseLeave:a,children:[(0,c.jsxs)(f,{children:[(0,c.jsx)(r,{size:13,strokeWidth:2}),o.entry.name]}),(0,c.jsx)(x,{entries:o.entry.children??[],activeId:e,onSelect:e=>{o.onSelect(e),a()}})]})}},15959(e,o,a){a.d(o,{I:()=>r,c:()=>n});var t=a(27359);const r=(0,t.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),n=()=>(0,t.useContext)(r)},65185(e,o,a){a.d(o,{t:()=>be});var t=a(49510),r=a(99038),n=a(57400),i=a(37561),l=a(28207),s=a(87902),d=a(36896),c=a(53013),p=a(32887),g=a(37901),f=a(39848),m=a(22164),u=a(3045),x=a(43775),h=a(83539),b=a(41783),y=a(39416),w=a(1837),$=a(57167),v=a(84494),z=a(82314),k=a(35751),M=a(20255),A=a(69633),T=a(92946),S=a(40822),j=a(36720),F=a(58456),B=a(43317),C=a(52709),R=a(89301),P=a(8006),E=a(83517),L=a(37032),H=a(6949),N=a(8218),I=a(36829),D=a(15553),Y=a(59591),G=a(69923),K=a(72820),V=a(14621),O=a(68479),q=a(72534),W=a(66673),_=a(67490),U=a(49033),J=a(45775),Z=a(31365),X=a(62937),Q=a(9821),ee=a(65912),oe=a(80158),ae=a(88641),te=a(48607),re=a(83249),ne=a(1821),ie=a(15889),le=a(89655),se=a(27170),de=a(19161),ce=a(71849),pe=a(41604),ge=a(13142),fe=a(61187),me=a(77747),ue=a(2932),xe=a(24525),he=a(57230);const be={activity:d.A,"a-large-small":s.A,apple:c.A,"arrow-right":p.A,"bar-chart-2":t.A,book:f.A,"book-open":g.A,briefcase:u.A,calendar:x.A,clock:b.A,"circle-dot":h.A,cloud:y.A,compass:w.A,cpu:$.A,droplets:v.A,feather:z.A,file:M.A,"file-text":k.A,folder:A.A,"git-branch":T.A,github:S.A,globe:j.A,grid:n.A,hand:F.A,hash:B.A,heart:C.A,key:P.A,hexagon:R.A,home:i.A,landmark:E.A,layers:l.A,"layout-grid":L.A,leaf:H.A,lightbulb:N.A,list:I.A,map:Y.A,"map-pin":D.A,"message-circle":G.A,"message-square":K.A,minus:V.A,monitor:O.A,mountain:q.A,package:W.A,palette:_.A,"pen-tool":U.A,"pie-chart":r.A,plane:J.A,plus:Z.A,ruler:X.A,shirt:Q.A,slash:ee.A,square:oe.A,star:ae.A,sun:te.A,terminal:re.A,thermometer:ne.A,triangle:ie.A,trophy:le.A,truck:se.A,type:de.A,users:ce.A,"volume-2":pe.A,watch:ge.A,waves:fe.A,wind:me.A,wrench:ue.A,x:xe.A,zap:he.A,bot:m.A}},59200(e,o,a){a.d(o,{PE:()=>S,Zf:()=>J,kd:()=>D,PL:()=>G,Iu:()=>I,Is:()=>Y,hY:()=>U,KL:()=>H,w4:()=>t.w4,mZ:()=>N,fy:()=>V,cL:()=>d.c});var t=a(217),r=a(27359),n=a(53233),i=a(65723);n.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,k=n.default.main`
  ...
  display: flex;
  flex-direction: column;
`,M=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function A(){return(0,i.jsx)(x,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:M.map((e,o)=>(0,i.jsx)(h,{index:o,accent:e.accent,children:e.char},o))})}const T="atlantis:sidebar-collapsed";function S({sidebar:e,children:o,topBarRight:t,title:n="Atlantis",activeId:l=null}){const[c,p]=(0,r.useState)(()=>{try{return"true"===localStorage.getItem(T)}catch{return!1}}),[u,x]=(0,r.useState)(null),h=(0,r.useRef)(),M=()=>p(e=>{const o=!e;try{localStorage.setItem(T,String(o))}catch{}return o}),S=r.useMemo(()=>r.lazy(()=>Promise.resolve().then(a.bind(a,74914)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,i.jsx)(d.I.Provider,{value:{collapsed:c,toggle:M,flyout:u,openFlyout:(e,o,a)=>{clearTimeout(h.current),x({entry:e,anchorY:o,onSelect:a})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>x(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,i.jsxs)($,{children:[(0,i.jsxs)(g,{children:[e&&(0,i.jsx)(f,{children:(0,i.jsx)(m,{onClick:M,title:c?"Expand sidebar":"Collapse sidebar",children:(0,i.jsx)(s.A,{size:17})})}),(0,i.jsx)(A,{}),n&&(0,i.jsx)(b,{children:n}),t&&(0,i.jsx)(y,{children:t})]}),(0,i.jsxs)(w,{children:[null!=e&&(0,i.jsx)(v,{collapsed:c,children:(0,i.jsx)(z,{children:e})}),(0,i.jsx)(k,{children:o})]}),u&&(0,i.jsx)(r.Suspense,{fallback:null,children:(0,i.jsx)(S,{activeId:l})})]})})}a(65185),n.default.div`
  display: grid;
...
`,x=t.forwardRef(function({variant:e="ghost",size:o="md",icon:a,iconRight:t,children:r,...n},l){return(0,i.jsxs)(u,{ref:l,variant:e,size:o,...n,children:[a,r,t]})}),h={default:n.w4.colors.accent,danger:"#f85149"},b={default:n.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"},y=r.default.button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`,w=t.forwardRef(function({active:e=!1,shape:o="square",tone:a="default",children:t,...r},n){return(0,i.jsx)(y,{ref:n,active:e,shape:o,tone:a,...r,children:t})}),$=r.default.div`
  position: relative;
  display: inline-flex;
`,v=r.default.div`
  position: absolute;
...
`,r.default.span`
  ...
  flex-shrink: 0;
`;var M=a(77207);const A=M.keyframes`
...
`,r.default.span`
  ...
  background: ${({color:e})=>e};
  display: inline-block;
`;const B={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:n.w4.colors.accentMuted},C={neutral:n.w4.colors.mainTextMuted,live:n.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:n.w4.colors.accent};r.default.span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${n.w4.typography.fontFamilyMono};
...
`;const R=r.default.kbd`
  ...
  white-space: nowrap;
`;function P({children:e,...o}){return(0,i.jsx)(R,{...o,children:e})}const E=r.default.div`
  font-family: ${n.w4.typography.fontFamilyMono};
  font-size: 11px;
  ...
  align-items: center;
  gap: 8px;
`;function L({children:e,...o}){return(0,i.jsx)(E,{...o,children:e})}r.default.label`
  display: flex;
  align-items: center;
  gap: 10px;
...
`,r.default.p`
  ...
  font-size: 12.5px;
  line-height: 1.45;
`;var N=a(28976),I=a(18055),D=a(14944),Y=a(39895),G=a(6930);a(61385),r.default.nav`padding: ${n.w4.spacing.sm} 0;`,r.default.div`
...
`;let O=!1;function q(e){if("undefined"==typeof window)return e;const o=e.match(/^var\((--[-\w]+)\)$/);return o&&getComputedStyle(document.documentElement).getPropertyValue(o[1]).trim()||e}function W({code:e}){const o=(0,t.useRef)(null),[r,l]=(0,t.useState)(null),[s,d]=(0,t.useState)(!1);return(0,t.useEffect)(()=>{let t=!1;if(l(null),d(!1),!e.trim())return void d(!0);const r=e.trim().split(/\r?\n/)[0]?.trim()??"";if(/^(?:---[\s\S]*?---\s*)?(?:graph|flowchart|sequenceDiagram|classDiagram|stateDiagram(?:-v2)?|erDiagram|pie|gantt|journey|mindmap|gitGraph|sankey(?:-beta)?|quadrantChart|requirementDiagram|timeline|xychart-beta|block-beta|C4Context|C4Container|C4Component|C4Dynamic|C4Deployment)\b/.test(r))return async function(){const r=(await a.e(774).then(a.bind(a,30774))).default;if(O||(r.initialize({startOnLoad:!1,theme:"dark",themeVariables:{background:q(n.w4.colors.codeBg),primaryColor:q(n.w4.colors.accent),primaryTextColor:q(n.w4.colors.mainText),lineColor:q(n.w4.colors.border)}}),O=!0),o.current&&!t)try{const a=`mermaid-${Math.random().toString(36).slice(2)}`,{svg:n}=await r.render(a,e);if(t||!o.current)return;if(/aria-roledescription="error"|class="error-icon"|>Syntax error/i.test(n))return void d(!0);o.current.innerHTML=n,requestAnimationFrame(()=>{if(t||!o.current)return;const e=o.current.querySelector("svg");if(!e)return void d(!0);const a=e.getBoundingClientRect();(a.width<40||a.height<40)&&d(!0)})}catch(e){t||l(e instanceof Error?e.message:String(e))}}(),()=>{t=!0};d(!0)},[e]),r||s?(0,i.jsx)(V,{children:e.trim()}):(0,i.jsx)(K,{ref:o})}const _=["#388bfd","#3fb950","#d29922","#a371f7","#f87171","#22d3ee","#fb923c","#34d399","#f472b6","#818cf8"],U=r.default.div`
  background: ${n.w4.colors.codeBg};
  border: 1px solid ${n.w4.colors.codeBorder};
  border-radius: ${n.w4.borderRadius.md};
  padding: ${n.w4.spacing.lg};
...
`,ee=r.default.pre`
  ...
  color: ${n.w4.colors.mainTextMuted};
  white-space: pre-wrap;
`;function oe(e){if(e<=0)return 10;const o=Math.pow(10,Math.floor(Math.log10(e)));return Math.ceil(e/o)*o}function ae({labels:e,data:o,colors:a}){const t=176,r=oe(Math.max(...o,1)),l=Math.min(40,340/e.length*.6),s=340/e.length,d=Array.from({length:6},(e,o)=>r/5*o);return(0,i.jsxs)("svg",{viewBox:"0 0 400 240",width:"100%",style:{maxWidth:400},children:[d.map((e,o)=>{const a=192-e/r*t;return(0,i.jsxs)("g",{children:[(0,i.jsx)("line",{x1:44,y1:a,x2:384,y2:a,stroke:n.w4.colors.border,strokeWidth:.5,strokeDasharray:0===o?"none":"3,3"}),(0,i.jsx)("text",{x:38,y:a+4,fill:n.w4.colors.mainTextMuted,fontSize:10,textAnchor:"end",fontFamily:n.w4.typography.fontFamily,children:Math.round(e)})]},o)}),o.map((o,d)=>{const c=44+s*d+s/2-l/2,p=o/r*t,g=192-p,f=a[d%a.length];return(0,i.jsxs)("g",{children:[(0,i.jsxs)("rect",{x:c,y:g,width:l,height:p,rx:3,fill:f,opacity:.85,children:[(0,i.jsx)("animate",{attributeName:"height",from:"0",to:p,dur:"0.5s",fill:"freeze"}),(0,i.jsx)("animate",{attributeName:"y",from:192,to:g,dur:"0.5s",fill:"freeze"})]}),(0,i.jsx)("text",{x:c+l/2,y:g-4,fill:n.w4.colors.mainText,fontSize:10,fontWeight:600,textAnchor:"middle",fontFamily:n.w4.typography.fontFamily,children:o}),(0,i.jsx)("text",{x:44+s*d+s/2,y:208,fill:n.w4.colors.mainTextMuted,fontSize:10,textAnchor:"middle",fontFamily:n.w4.typography.fontFamily,children:e[d].length>8?e[d].slice(0,7)+"…":e[d]})]},d)})]})}function te({labels:e,data:o,colors:a}){const t=o.reduce((e,o)=>e+o,0)||1;let r=-Math.PI/2;const l=o.map((e,o)=>{const l=e/t*Math.PI*2,s=r;r+=l;const d=r,c=120+90*Math.cos(s),p=120+90*Math.sin(s),g=120+90*Math.cos(d),f=120+90*Math.sin(d),m=l>Math.PI?1:0,u=s+l/2,x=120+58.5*Math.cos(u),h=120+58.5*Math.sin(u),b=Math.round(e/t*100);return(0,i.jsxs)("g",{children:[(0,i.jsx)("path",{d:`M 120 120 L ${c} ${p} A 90 90 0 ${m} 1 ${g} ${f} Z`,fill:a[o%a.length],stroke:n.w4.colors.codeBg,strokeWidth:2,opacity:.85}),b>=5&&(0,i.jsxs)("text",{x,y:h+4,fill:"#fff",fontSize:11,fontWeight:600,textAnchor:"middle",fontFamily:n.w4.typography.fontFamily,children:[b,"%"]})]},o)});return(0,i.jsx)("svg",{viewBox:"0 0 240 240",width:"100%",style:{maxWidth:240},children:l})}function re({labels:e,data:o,colors:a}){const t=176,r=oe(Math.max(...o,1)),l=o.length>1?340/(o.length-1):340,s=a[0],d=o.map((e,o)=>({x:44+l*o,y:192-e/r*t})),c=d.map((e,o)=>`${0===o?"M":"L"} ${e.x} ${e.y}`).join(" "),p=Array.from({length:6},(e,o)=>r/5*o);return(0,i.jsxs)("svg",{viewBox:"0 0 400 240",width:"100%",style:{maxWidth:400},children:[p.map((e,o)=>{const a=192-e/r*t;return(0,i.jsxs)("g",{children:[(0,i.jsx)("line",{x1:44,y1:a,x2:384,y2:a,stroke:n.w4.colors.border,strokeWidth:.5,strokeDasharray:0===o?"none":"3,3"}),(0,i.jsx)("text",{x:38,y:a+4,fill:n.w4.colors.mainTextMuted,fontSize:10,textAnchor:"end",fontFamily:n.w4.typography.fontFamily,children:Math.round(e)})]},o)}),(0,i.jsx)("path",{d:c,fill:"none",stroke:s,strokeWidth:2.5,strokeLinecap:"round",strokeLinejoin:"round"}),d.map((a,t)=>(0,i.jsxs)("g",{children:[(0,i.jsx)("circle",{cx:a.x,cy:a.y,r:4,fill:s,stroke:n.w4.colors.codeBg,strokeWidth:2}),(0,i.jsx)("text",{x:a.x,y:a.y-10,fill:n.w4.colors.mainText,fontSize:10,fontWeight:600,textAnchor:"middle",fontFamily:n.w4.typography.fontFamily,children:o[t]}),(0,i.jsx)("text",{x:a.x,y:208,fill:n.w4.colors.mainTextMuted,fontSize:10,textAnchor:"middle",fontFamily:n.w4.typography.fontFamily,children:e[t].length>8?e[t].slice(0,7)+"…":e[t]})]},t))]})}function ne({code:e}){const o=(0,t.useMemo)(()=>function(e){const o=e.trim().split("\n");let a,t,r="bar",n=[],i=[];for(const e of o){const[o,...l]=e.split(":"),s=l.join(":").trim();if(s)switch(o.trim().toLowerCase()){case"type":["bar","pie","line"].includes(s.toLowerCase())&&(r=s.toLowerCase());break;case"title":a=s;break;case"labels":n=s.replace(/^\[|\]$/g,"").split(",").map(e=>e.trim());break;case"data":i=s.replace(/^\[|\]$/g,"").split(",").map(e=>parseFloat(e.trim())||0);break;case"colors":t=s.replace(/^\[|\]$/g,"").split(",").map(e=>e.trim())}}return n.length&&i.length?{type:r,title:a,labels:n,data:i,colors:t}:null}(e),[e]);if(!o)return(0,i.jsx)(ee,{children:e.trim()});const a=o.colors??_;return(0,i.jsxs)(U,{children:[o.title&&(0,i.jsx)(J,{children:o.title}),"bar"===o.type&&(0,i.jsx)(ae,{labels:o.labels,data:o.data,colors:a}),"pie"===o.type&&(0,i.jsx)(te,{labels:o.labels,data:o.data,colors:a}),"line"===o.type&&(0,i.jsx)(re,{labels:o.labels,data:o.data,colors:a}),(0,i.jsx)(Z,{children:o.labels.map((e,o)=>(0,i.jsxs)(X,{children:[(0,i.jsx)(Q,{color:a[o%a.length]}),e]},o))})]})}r.default.div`
  background: ${n.w4.colors.codeBg};
  border: 1px solid ${n.w4.colors.codeBorder};
  border-radius: ${n.w4.borderRadius.md};
  padding: ${n.w4.spacing.lg};
...
`,r.default.span`
  font-size: ${n.w4.typography.fontSizeBase};
  color: ${n.w4.colors.mainTextMuted};
`;var se=a(68383),de=a(21426),ce=a(25609),pe=a(20320);const ge=r.default.div`
  margin: ${n.w4.spacing.lg} 0;
  border-radius: ${n.w4.borderRadius.md};
  border: 1px solid ${n.w4.colors.codeBorder};
  overflow: hidden;
...
`,xe={...de.A,'pre[class*="language-"]':{...de.A['pre[class*="language-"]'],background:n.w4.colors.codeBg,margin:0,padding:"18px 20px",fontSize:"13px",lineHeight:"1.6",borderRadius:0},'code[class*="language-"]':{...de.A['code[class*="language-"]'],background:"none",fontSize:"13px"}};function he({lang:e="text",code:o}){const[a,r]=(0,t.useState)(!1);return(0,i.jsxs)(ge,{children:[(0,i.jsxs)(fe,{children:[(0,i.jsx)(me,{children:e}),(0,i.jsxs)(ue,{copied:a,onClick:()=>{navigator.clipboard.writeText(o).then(()=>{r(!0),setTimeout(()=>r(!1),2e3)})},children:[a?(0,i.jsx)(ce.A,{size:12}):(0,i.jsx)(pe.A,{size:12}),a?"Copied!":"Copy"]})]}),(0,i.jsx)(se.A,{language:e,style:xe,showLineNumbers:o.split("\n").length>8,lineNumberStyle:{color:"#484f58",minWidth:"2.5em",paddingRight:"1.5em",userSelect:"none",fontSize:"12px"},customStyle:{margin:0,background:n.w4.colors.codeBg},wrapLongLines:!1,children:o})]})}var be=a(65569),ye=a(8218),we=a(57230),$e=a(22966),ve=a(21069);const ze={NOTE:{bg:"rgba(88, 166, 255, 0.08)",border:"#58a6ff",icon:be.A,label:"Note",color:"#58a6ff"},TIP:{bg:"rgba(63, 185, 80, 0.08)",border:"#3fb950",icon:ye.A,label:"Tip",color:"#3fb950"},IMPORTANT:{bg:"rgba(163, 113, 247, 0.08)",border:"#a371f7",icon:we.A,label:"Important",color:"#a371f7"},WARNING:{bg:"rgba(210, 153, 34, 0.08)",border:"#d29922",icon:$e.A,label:"Warning",color:"#d29922"},CAUTION:{bg:"rgba(248, 81, 73, 0.08)",border:"#f85149",icon:ve.A,label:"Caution",color:"#f85149"}},ke=r.default.div`
  background: ${({bg:e})=>e};
...
`;function Te({type:e,children:o}){const a=ze[e]??ze.NOTE,t=a.icon;return(0,i.jsxs)(ke,{bg:a.bg,border:a.border,children:[(0,i.jsxs)(Me,{color:a.color,children:[(0,i.jsx)(t,{size:15,strokeWidth:2}),a.label]}),(0,i.jsx)(Ae,{children:o})]})}r.default.nav`
  width: 220px;
  min-width: 220px;
...
`,r.default.div`
  ...
  font-family: ${n.w4.typography.fontFamily};
`;const Se=M.keyframes`
  from { opacity: 0; }
  to   { opacity: 1; }
`,je=M.keyframes`
  from { opacity: 0; transform: translateY(16px) scale(0.98); }
  to   { opacity: 1; transform: translateY(0) scale(1); }
`;function Fe(){const e=/^\[!(NOTE|TIP|WARNING|CAUTION|IMPORTANT)\]\s*/i;return o=>{function a(o,a,t){const r=a.children?.[0];"text"===r?.type&&(r.value=r.value.replace(e,""),r.value.trim()||1!==a.children.length||a.children.shift()),o.data=o.data??{},o.data.hName="div",o.data.hProperties={"data-callout":t.toUpperCase()}}!function o(t){if("blockquote"===t.type){const o=t.children?.[0];if("paragraph"===o?.type){const r=o.children?.[0],n="text"===r?.type&&r.value?.match(e);n&&a(t,o,n[1])}}if("paragraph"===t.type){const o=t.children?.[0],r="text"===o?.type&&o.value?.match(e);if(r){const o=[...t.children];t.children=[{type:"paragraph",children:o}],a(t,t.children[0],r[1]);const n=o[0];return void("text"===n?.type&&(n.value=n.value.replace(e,""),n.value.trim()||1!==o.length||o.shift()))}}t.children?.forEach(o)}(o)}}r.default.div`
  position: fixed;
  inset: 0;
  z-index: 9999;
...
`,r.default.span`
  ...
  font-weight: 600;
  margin-left: auto;
`,new Map;const Be=r.default.div`
  font-size: 14px;
  color: ${n.w4.colors.mainText};
  line-height: 1.65;
...
`;function Ce({children:e}){return(0,i.jsx)(Be,{children:(0,i.jsx)(N.oz,{remarkPlugins:[I.A,D.A,Fe],rehypePlugins:[Y.A,G.A],components:{div({node:e,children:o,...a}){const t=a["data-callout"];return t?(0,i.jsx)(Te,{type:t,children:o}):(0,i.jsx)("div",{...a,children:o})},pre:({children:e})=>(0,i.jsx)(i.Fragment,{children:e}),code({className:e,children:o}){const a=/language-(\w+)/.exec(e??"")?.[1],t=String(o).replace(/\n$/,"");return t.trim()?"mermaid"===a?(0,i.jsx)(W,{code:t}):"chart"===a?(0,i.jsx)(ne,{code:t}):a||t.includes("\n")?(0,i.jsx)(he,{lang:a,code:t}):(0,i.jsx)("code",{className:e,children:o}):null}},children:e})})}r.default.nav`
  display: flex;
  flex-direction: column;
  gap: 1px;
  padding: ${n.w4.spacing.sm} 0;
