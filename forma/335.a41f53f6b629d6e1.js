...
`,M=n().input`
  display: none;
`;function z({data:e,t,onSave:a}){let[i,n]=(0,o.useState)(String(e.goal.proteinG??110)),[s,c]=(0,o.useState)(String(e.goal.kcal??2200)),[T,F]=(0,o.useState)(String(e.goal.walkMin??30)),[S,C]=(0,o.useState)(String(e.goal.weightKg??"")),[A,D]=(0,o.useState)(String(e.goal.targetHours)),[R,I]=(0,o.useState)(String(e.goal.weeklyFasts)),[L,E]=(0,o.useState)(!1),[H,P]=(0,o.useState)(!1),[B,W]=(0,o.useState)(null),[O,N]=(0,o.useState)(null),[Y,K]=(0,o.useState)(),J=(0,o.useRef)(null),G=(0,o.useRef)(null),V=(0,o.useRef)(null),q=(0,o.useRef)(null),U=(0,o.useRef)(null),{plan:_,dayNumber:Q,startProgram:X,clearProgram:Z}=(0,d.useProgram)(),ee=(0,o.useCallback)(async()=>{let e=new Date().toISOString().slice(0,10);await X({...d.SEED_PLAN_TUNA_30,startDate:e})},[X]),et=(0,o.useCallback)(async()=>{P(!1),await Z()},[Z]),ea=async()=>{let t={...e,goal:{targetHours:Number(A)||16,weeklyFasts:Number(R)||5,proteinG:Number(i)||void 0,kcal:Number(s)||void 0,walkMin:Number(T)||void 0,weightKg:S?Number(S):void 0}};await a(t),E(!0),setTimeout(()=>E(!1),2e3)},er=(0,o.useCallback)(t=>{let a=(0,d.exportFormaCSV)(e),r=(0,d.todayISODate)();(0,d.downloadCsv)(a[t],`forma-${t}-${r}.csv`)},[e]),eo=(0,o.useCallback)((a,r)=>{if(!r)return;let o=new FileReader;o.onload=r=>{let o=r.target?.result;if("string"!=typeof o){N(t("forma.data.importError",{msg:"Could not read file"})),K("error");return}N(null),K(void 0);try{let r=0,i=e;if("sessions"===a){let a=(0,d.importFormaCSV)("sessions",o);if(!a.ok){N(t("forma.data.importError",{msg:a.error})),K("error");return}let n=(0,d.mergeFormaSessions)(e.sessions,a.entries);r=n.length-e.sessions.length,i={...e,sessions:n}}else if("meals"===a){let a=(0,d.importFormaCSV)("meals",o);if(!a.ok){N(t("forma.data.importError",{msg:a.error})),K("error");return}let n=(0,d.mergeFormaMeals)(e.meals,a.entries);r=n.length-e.meals.length,i={...e,meals:n}}else if("weights"===a){let a=(0,d.importFormaCSV)("weights",o);if(!a.ok){N(t("forma.data.importError",{msg:a.error})),K("error");return}let n=(0,d.mergeFormaWeights)(e.weights,a.entries);r=n.length-e.weights.length,i={...e,weights:n}}else if("walks"===a){let a=(0,d.importFormaCSV)("walks",o);if(!a.ok){N(t("forma.data.importError",{msg:a.error})),K("error");return}let n=(0,d.mergeFormaWalks)(e.walks,a.entries);r=n.length-e.walks.length,i={...e,walks:n}}else if("water"===a){let a=(0,d.importFormaCSV)("water",o);if(!a.ok){N(t("forma.data.importError",{msg:a.error})),K("error");return}let n=(0,d.mergeFormaWater)(e.water,a.entries);r=n.length-e.water.length,i={...e,water:n}}if(0===r){N(t("forma.data.importNoNew")),K("error");return}W({kind:a,newCount:r,mergedData:i})}catch{N(t("forma.data.importError",{msg:"Unexpected parse error"})),K("error")}},o.readAsText(r)},[e,t]),ei=(0,o.useCallback)(async()=>{if(!B)return;let{newCount:e,mergedData:r}=B;W(null),await a(r),N(t("forma.data.importDone",{n:e})),K("success"),setTimeout(()=>{N(null),K(void 0)},4e3)},[B,a,t]),en=(0,o.useCallback)(()=>{W(null)},[]),es=[{kind:"sessions",exportLabel:t("forma.data.exportSessions"),importLabel:t("forma.data.importSessions")},{kind:"meals",exportLabel:t("forma.data.exportMeals"),importLabel:t("forma.data.importMeals")},{kind:"weights",exportLabel:t("forma.data.exportWeights"),importLabel:t("forma.data.importWeights")},{kind:"walks",exportLabel:t("forma.data.exportWalks"),importLabel:t("forma.data.importWalks")},{kind:"water",exportLabel:t("forma.data.exportWater"),importLabel:t("forma.data.importWater")}];return(0,r.jsxs)(m,{children:[(0,r.jsxs)(g,{children:[(0,r.jsxs)(h,{children:["◉ ",t("forma.settings.foodGoals")]}),(0,r.jsxs)(f,{children:[(0,r.jsx)(x,{children:t("forma.settings.proteinG")}),(0,r.jsx)(u,{type:"number",value:i,onChange:e=>n(e.target.value)})]}),(0,r.jsxs)(f,{children:[(0,r.jsx)(x,{children:t("forma.settings.kcal")}),(0,r.jsx)(u,{type:"number",value:s,onChange:e=>c(e.target.value)})]}),(0,r.jsxs)(f,{children:[(0,r.jsx)(x,{children:t("forma.settings.walkMin")}),(0,r.jsx)(u,{type:"number",value:T,onChange:e=>F(e.target.value)})]}),(0,r.jsxs)(f,{children:[(0,r.jsx)(x,{children:t("forma.settings.weightTarget")}),(0,r.jsx)(u,{type:"number",step:"0.1",value:S,onChange:e=>C(e.target.value)})]}),(0,r.jsx)(p.I,{variant:"compact"})]}),(0,r.jsxs)(g,{children:[(0,r.jsxs)(h,{children:["◉ ",t("forma.settings.fastingGoals")]}),(0,r.jsxs)(f,{children:[(0,r.jsx)(x,{children:t("forma.settings.targetHours")}),(0,r.jsx)(u,{type:"number",value:A,onChange:e=>D(e.target.value)})]}),(0,r.jsxs)(f,{children:[(0,r.jsx)(x,{children:t("forma.settings.weeklyFasts")}),(0,r.jsx)(u,{type:"number",value:R,onChange:e=>I(e.target.value)})]}),(0,r.jsx)(p.I,{variant:"compact"})]}),(0,r.jsxs)(g,{children:[(0,r.jsx)(h,{children:t("forma.program.title")}),_?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)($,{children:t("forma.program.active",{n:Q??0})}),(0,r.jsx)(w,{style:{justifyContent:"flex-start"},children:(0,r.jsx)(l.$n,{variant:"danger",onClick:()=>P(!0),children:t("forma.program.clear")})})]}):(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(y,{children:t("forma.program.noProgram")}),(0,r.jsx)(w,{style:{justifyContent:"flex-start"},children:(0,r.jsx)(l.$n,{variant:"accent",onClick:()=>void ee(),children:t("forma.program.start")})})]}),(0,r.jsx)(p.I,{variant:"compact"})]}),(0,r.jsxs)(g,{children:[(0,r.jsx)(h,{children:t("forma.data.title")}),es.map(({kind:e,exportLabel:t,importLabel:a})=>(0,r.jsx)(v,{children:(0,r.jsxs)(k,{style:{flex:1,justifyContent:"flex-end"},children:[(0,r.jsx)(l.$n,{variant:"ghost",onClick:()=>er(e),children:t}),(0,r.jsx)(l.$n,{variant:"accent",onClick:()=>(e=>{switch(e){case"sessions":return J;case"meals":return G;case"weights":return V;case"walks":return q;case"water":return U}})(e).current?.click(),children:a})]})},e)),O&&(0,r.jsx)(j,{$tone:Y,children:O}),(0,r.jsx)(M,{ref:J,type:"file",accept:".csv,text/csv",onChange:e=>{eo("sessions",e.target.files?.[0]),e.target.value=""}}),(0,r.jsx)(M,{ref:G,type:"file",accept:".csv,text/csv",onChange:e=>{eo("meals",e.target.files?.[0]),e.target.value=""}}),(0,r.jsx)(M,{ref:V,type:"file",accept:".csv,text/csv",onChange:e=>{eo("weights",e.target.files?.[0]),e.target.value=""}}),(0,r.jsx)(M,{ref:q,type:"file",accept:".csv,text/csv",onChange:e=>{eo("walks",e.target.files?.[0]),e.target.value=""}}),(0,r.jsx)(M,{ref:U,type:"file",accept:".csv,text/csv",onChange:e=>{eo("water",e.target.files?.[0]),e.target.value=""}}),(0,r.jsx)(p.I,{variant:"compact"})]}),(0,r.jsxs)(w,{children:[L&&(0,r.jsx)(b,{children:t("forma.settings.saved")}),(0,r.jsx)(l.$n,{variant:"success",onClick:()=>void ea(),children:t("forma.settings.save")})]}),(0,r.jsx)(l.TM,{open:H,title:t("forma.program.confirmClear"),message:t("forma.program.confirmClearBody"),confirmLabel:t("forma.program.clear"),cancelLabel:t("forma.checkin.cancel"),onConfirm:()=>void et(),onCancel:()=>P(!1),danger:!0}),(0,r.jsx)(l.TM,{open:null!==B,title:t("forma.data.confirmTitle"),message:B?t("forma.data.confirmBody",{n:B.newCount,kind:t(`forma.data.kind.${B.kind}`)}):"",confirmLabel:t("forma.data.confirmOk"),cancelLabel:t("forma.data.confirmCancel"),onConfirm:()=>void ei(),onCancel:en})]})}},359(e,t,a){a.d(t,{e:()=>M});var r=a(65723),o=a(37991),i=a(36859),n=a.n(i),s=a(72799),l=a(6063),d=a(63236);let c=[{id:"banana-power",nameKey:"forma.shake.banana-power.name",ingredientsKey:"forma.shake.banana-power.ingredients",proteinG:32,kcal:310,slot:"snack"},{id:"berry-burn",nameKey:"forma.shake.berry-burn.name",ingredientsKey:"forma.shake.berry-burn.ingredients",proteinG:28,kcal:190,slot:"snack"},{id:"choco-cafe",nameKey:"forma.shake.choco-cafe.name",ingredientsKey:"forma.shake.choco-cafe.ingredients",proteinG:28,kcal:150,slot:"snack"},{id:"verde-detox",nameKey:"forma.shake.verde-detox.name",ingredientsKey:"forma.shake.verde-detox.ingredients",proteinG:28,kcal:200,slot:"snack"},{id:"tropical-lean",nameKey:"forma.shake.tropical-lean.name",ingredientsKey:"forma.shake.tropical-lean.ingredients",proteinG:27,kcal:220,slot:"snack"},{id:"pb-strawberry",nameKey:"forma.shake.pb-strawberry.name",ingredientsKey:"forma.shake.pb-strawberry.ingredients",proteinG:32,kcal:210,slot:"snack"}];var p=a(21571),m=a(32988);let g=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,h=n().section`
  position: relative;
...
`,s().span`
  font-size: ${l.w4.typography.fontSizeBase};
  color: ${l.w4.colors.mainTextMuted};
`;var eL=a(17223),eE=a(21426);let eH=s().div`
  margin: ${l.w4.spacing.lg} 0;
  border-radius: ${l.w4.borderRadius.md};
  border: 1px solid ${l.w4.colors.codeBorder};
  overflow: hidden;
