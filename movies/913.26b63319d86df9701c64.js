...
`,L=300;function R({item:e,rect:o,onOpen:a,onMouseEnter:n,onMouseLeave:t,withBackdrop:i,onBackdropTap:r}){const l=function(e){const o=window.innerWidth,a=window.innerHeight;if(o<500){const n=Math.max(8,(o-L)/2);return{top:Math.max(8,Math.min(e.bottom+8,a-310-8)),left:n}}let n=e.right+10;n+L>o-8&&(n=e.left-L-10),n=Math.max(8,Math.min(n,o-L-8));let t=e.top+e.height/2-155;return t=Math.max(8,Math.min(t,a-310-8)),{top:t,left:n}}(o),d=(0,u.rS)(e),g=(0,u.Ox)(e),f=(0,u.U7)(e.backdrop_path,"w780");return s.createPortal((0,p.jsxs)(p.Fragment,{children:[i&&(0,p.jsx)("div",{style:{position:"fixed",inset:0,zIndex:9998},onClick:r}),(0,p.jsxs)($,{top:l.top,left:l.left,onMouseEnter:n,onMouseLeave:t,children:[f?(0,p.jsx)(j,{src:f}):(0,p.jsx)(S,{}),(0,p.jsxs)(M,{children:[(0,p.jsx)(T,{children:d}),(0,p.jsxs)(C,{children:[(0,p.jsxs)(_,{children:[(0,p.jsx)(c.A,{size:11,fill:"currentColor"}),e.vote_average.toFixed(1)]}),g&&(0,p.jsx)(B,{children:g}),(0,p.jsx)(P,{kind:e.media_type,children:"movie"===e.media_type?"Film":"TV"})]}),e.overview&&(0,p.jsx)(E,{children:e.overview}),(0,p.jsxs)(F,{onClick:a,children:[(0,p.jsx)(m.A,{size:13}),"More Info"]})]})]})]}),document.body)}function D({item:e,onClick:o}){const a=(0,u.rS)(e),t=(0,u.Ox)(e),i=(0,u.HD)(e.poster_path),r=(0,n.useRef)(null),l=(0,n.useRef)(),s=(0,n.useRef)(),[d,m]=(0,n.useState)(!1),[A,$]=(0,n.useState)(!1),[j,S]=(0,n.useState)(null),[M,T]=(0,n.useState)(!1);(0,n.useEffect)(()=>()=>{clearTimeout(l.current),clearTimeout(s.current)},[]);const C=(0,n.useCallback)((e,o)=>{S(e),$(!0),T(o)},[]),_=(0,n.useCallback)(()=>{$(!1),S(null),T(!1)},[]),B=(0,n.useCallback)(()=>{_(),o(e)},[e,o,_]),P=(0,n.useCallback)(()=>{m(!0),clearTimeout(s.current),l.current=setTimeout(()=>{const e=r.current?.getBoundingClientRect();e&&C(e,!1)},400)},[C]),E=(0,n.useCallback)(()=>{m(!1),clearTimeout(l.current),s.current=setTimeout(_,180)},[_]),F=(0,n.useCallback)(()=>{clearTimeout(s.current)},[]),L=(0,n.useCallback)(()=>{_()},[_]),D=(0,n.useCallback)(a=>{if(A)return;if(window.innerWidth<360)return void o(e);a.preventDefault();const n=r.current?.getBoundingClientRect();n&&C(n,!0)},[A,e,o,C]),I=(0,n.useCallback)(()=>{A||M||B()},[A,M,B]);return(0,p.jsxs)(p.Fragment,{children:[(0,p.jsxs)(g,{ref:r,onClick:I,onMouseEnter:P,onMouseLeave:E,onTouchStart:D,title:a,role:"button",tabIndex:0,onKeyDown:e=>{"Enter"!==e.key&&" "!==e.key||B()},children:[(0,p.jsx)(k,{kind:e.media_type,children:"movie"===e.media_type?"Film":"TV"}),i?(0,p.jsx)(f,{src:i,alt:a,loading:"lazy"}):(0,p.jsxs)(x,{children:["🎬",(0,p.jsx)(h,{children:a})]}),(0,p.jsxs)(b,{visible:d,children:[(0,p.jsx)(y,{children:a}),(0,p.jsxs)(z,{children:[(0,p.jsxs)(w,{children:[(0,p.jsx)(c.A,{size:9,fill:"currentColor"}),e.vote_average.toFixed(1)]}),t&&(0,p.jsx)(v,{children:t})]})]})]}),A&&j&&(0,p.jsx)(R,{item:e,rect:j,onOpen:B,onMouseEnter:F,onMouseLeave:L,withBackdrop:M,onBackdropTap:_})]})}const I=t.default.div`
  display: flex;
  flex-direction: column;
  gap: ${i.w4.spacing.md};
