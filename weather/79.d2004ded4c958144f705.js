"use strict";(self.webpackChunk_atlantis_weather=self.webpackChunk_atlantis_weather||[]).push([[79],{4914(a,e,o){o.d(e,{FlyoutPanel:()=>y});var n=o(7359),i=o(3233),t=o(7207),l=o(255),r=o(217),m=o(5959),g=o(5185),c=o(5723);const d=t.keyframes`
...
`,A=t.default.main`
  ...
  display: flex;
  flex-direction: column;
`,w="atlantis:sidebar-collapsed";function v({sidebar:a,children:e,topBarRight:n,title:t="Atlantis",activeId:g=null}){const[c,v]=(0,i.useState)(()=>{try{return"true"===localStorage.getItem(w)}catch{return!1}}),[k,S]=(0,i.useState)(null),M=(0,i.useRef)(),$=()=>v(a=>{const e=!a;try{localStorage.setItem(w,String(e))}catch{}return e}),B=i.useMemo(()=>i.lazy(()=>Promise.resolve().then(o.bind(o,4914)).then(a=>({default:a.FlyoutPanel}))),[]);return(0,l.jsx)(m.I.Provider,{value:{collapsed:c,toggle:$,flyout:k,openFlyout:(a,e,o)=>{clearTimeout(M.current),S({entry:a,anchorY:e,onSelect:o})},scheduleFlyoutClose:()=>{M.current=setTimeout(()=>S(null),160)},cancelFlyoutClose:()=>clearTimeout(M.current)},children:(0,l.jsxs)(b,{children:[(0,l.jsxs)(d,{children:[(0,l.jsx)(s,{children:(0,l.jsx)(f,{onClick:$,title:c?"Expand sidebar":"Collapse sidebar",children:(0,l.jsx)(r.A,{size:17})})}),(0,l.jsxs)(u,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:["Atl",(0,l.jsx)("span",{children:"antis"})]}),t&&(0,l.jsx)(p,{children:t}),n&&(0,l.jsx)(z,{children:n})]}),(0,l.jsxs)(y,{children:[(0,l.jsx)(h,{collapsed:c,children:(0,l.jsx)(x,{children:a})}),(0,l.jsx)(A,{children:e})]}),k&&(0,l.jsx)(i.Suspense,{fallback:null,children:(0,l.jsx)(B,{activeId:g})})]})})}var k=o(255),S=o(9753),M=o(5185);const $=t.default.div`
  display: grid;
...
`;function N({iconKey:a,size:e=16}){if(a&&!(a in M.t))return(0,l.jsx)("span",{style:{fontSize:e,lineHeight:1,display:"flex",alignItems:"center"},children:a});const o=a?M.t[a]??k.A:k.A;return(0,l.jsx)(o,{size:e,strokeWidth:1.75})}function G({entry:a,activeId:e,onSelect:o}){const[n,t]=(0,i.useState)(a.defaultOpen??!0),{collapsed:r,openFlyout:g,scheduleFlyoutClose:c,cancelFlyoutClose:d}=(0,m.c)();return a.children&&a.children.length>0?(0,l.jsxs)(C,{children:[(0,l.jsxs)(E,{collapsed:r,onClick:()=>{r||t(a=>!a)},onMouseEnter:r?e=>{const n=e.currentTarget.getBoundingClientRect();g(a,n.top,o)}:void 0,onMouseLeave:r?c:void 0,children:[(0,l.jsxs)(P,{collapsed:r,children:[(0,l.jsx)(N,{iconKey:a.icon,size:16}),(0,l.jsx)(j,{collapsed:r,children:a.name})]}),(0,l.jsx)(L,{open:n,collapsed:r,children:(0,l.jsx)(S.A,{size:13})})]}),(0,l.jsx)($,{open:n&&!r,children:(0,l.jsx)(B,{children:(0,l.jsx)(T,{children:a.children.map(a=>(0,l.jsx)(G,{entry:a,activeId:e,onSelect:o},a.id))})})})]}):(0,l.jsxs)(R,{active:e===a.id,collapsed:r,onClick:()=>o(a),onMouseEnter:r?e=>{const n=e.currentTarget.getBoundingClientRect();g({id:a.id,name:a.name,icon:a.icon,file:a.file,children:[a]},n.top,o)}:void 0,onMouseLeave:r?c:void 0,children:[(0,l.jsx)(N,{iconKey:a.icon,size:15}),(0,l.jsx)(j,{collapsed:r,children:a.name})]})}function K({entries:a,activeId:e,onSelect:o}){return(0,l.jsx)("div",{children:a.map(a=>(0,l.jsx)(G,{entry:a,activeId:e,onSelect:o},a.id))})}const I=o(7207).keyframes`
...
//# sourceMappingURL=79.d2004ded4c958144f705.js.map