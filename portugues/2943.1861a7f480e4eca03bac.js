"use strict";(self.webpackChunk_atlantis_portugues=self.webpackChunk_atlantis_portugues||[]).push([[2943],{1312(e,o,a){a.d(o,{WO:()=>mo});var n=a(27359),i=a(217),t=a(53233),r=a(65723);t.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,t.default.span`
  ...
  margin-right: 6px;
  flex-shrink: 0;
`;var l=a(73661),d=a(15959);const c="260px",s="56px",m=t.default.header`
  display: flex;
  align-items: center;
  height: ${"48px"};
...
`,x=t.default.div`
  ...
  overflow: hidden;
`,h=t.default.aside`
  width: ${({collapsed:e})=>e?s:c};
  min-width: ${({collapsed:e})=>e?s:c};
  background: ${i.w.colors.sidebarBg};
  border-right: 1px solid ${i.w.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,w=t.default.main`
  ...
  display: flex;
  flex-direction: column;
`,$="atlantis:sidebar-collapsed";function v({sidebar:e,children:o,topBarRight:i,title:t="Atlantis",activeId:c=null}){const[s,v]=(0,n.useState)(()=>{try{return"true"===localStorage.getItem($)}catch{return!1}}),[A,k]=(0,n.useState)(null),j=(0,n.useRef)(),S=()=>v(e=>{const o=!e;try{localStorage.setItem($,String(o))}catch{}return o}),T=n.useMemo(()=>n.lazy(()=>Promise.resolve().then(a.bind(a,74914)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(d.I.Provider,{value:{collapsed:s,toggle:S,flyout:A,openFlyout:(e,o,a)=>{clearTimeout(j.current),k({entry:e,anchorY:o,onSelect:a})},scheduleFlyoutClose:()=>{j.current=setTimeout(()=>k(null),160)},cancelFlyoutClose:()=>clearTimeout(j.current)},children:(0,r.jsxs)(x,{children:[(0,r.jsxs)(m,{children:[(0,r.jsx)(g,{children:(0,r.jsx)(u,{onClick:S,title:s?"Expand sidebar":"Collapse sidebar",children:(0,r.jsx)(l.A,{size:17})})}),(0,r.jsxs)(p,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:["Atl",(0,r.jsx)("span",{children:"antis"})]}),t&&(0,r.jsx)(f,{children:t}),i&&(0,r.jsx)(y,{children:i})]}),(0,r.jsxs)(b,{children:[(0,r.jsx)(h,{collapsed:s,children:(0,r.jsx)(z,{children:e})}),(0,r.jsx)(w,{children:o})]}),A&&(0,r.jsx)(n.Suspense,{fallback:null,children:(0,r.jsx)(T,{activeId:c})})]})})}var A=a(20255),k=a(69753),j=a(65185);const S=t.default.div`
  display: grid;
...
`;function F({iconKey:e,size:o=16}){if(e&&!(e in j.t))return(0,r.jsx)("span",{style:{fontSize:o,lineHeight:1,display:"flex",alignItems:"center"},children:e});const a=e?j.t[e]??A.A:A.A;return(0,r.jsx)(a,{size:o,strokeWidth:1.75})}function N({entry:e,activeId:o,onSelect:a}){const[i,t]=(0,n.useState)(e.defaultOpen??!0),{collapsed:l,openFlyout:c,scheduleFlyoutClose:s,cancelFlyoutClose:m}=(0,d.c)();return e.children&&e.children.length>0?(0,r.jsxs)(B,{children:[(0,r.jsxs)(E,{collapsed:l,onClick:()=>{l||t(e=>!e)},onMouseEnter:l?o=>{const n=o.currentTarget.getBoundingClientRect();c(e,n.top,a)}:void 0,onMouseLeave:l?s:void 0,children:[(0,r.jsxs)(C,{collapsed:l,children:[(0,r.jsx)(F,{iconKey:e.icon,size:16}),(0,r.jsx)(P,{collapsed:l,children:e.name})]}),(0,r.jsx)(R,{open:i,collapsed:l,children:(0,r.jsx)(k.A,{size:13})})]}),(0,r.jsx)(S,{open:i&&!l,children:(0,r.jsx)(T,{children:(0,r.jsx)(M,{children:e.children.map(e=>(0,r.jsx)(N,{entry:e,activeId:o,onSelect:a},e.id))})})})]}):(0,r.jsxs)(L,{active:o===e.id,collapsed:l,onClick:()=>a(e),onMouseEnter:l?o=>{const n=o.currentTarget.getBoundingClientRect();c({id:e.id,name:e.name,icon:e.icon,file:e.file,children:[e]},n.top,a)}:void 0,onMouseLeave:l?s:void 0,children:[(0,r.jsx)(F,{iconKey:e.icon,size:15}),(0,r.jsx)(P,{collapsed:l,children:e.name})]})}function I({entries:e,activeId:o,onSelect:a}){return(0,r.jsx)("div",{children:e.map(e=>(0,r.jsx)(N,{entry:e,activeId:o,onSelect:a},e.id))})}const K=a(77207).keyframes`
...
`;var G=a(88641),D=a(41783);function H(e){try{return JSON.parse(localStorage.getItem(e)??"[]")}catch{return[]}}const O=t.default.nav`padding: ${i.w.spacing.sm} 0;`,V=t.default.div`
...
`;function Q({title:e,icon:o,entries:a,activeId:i,onSelect:t,favorites:l,onToggleFav:d}){const[c,s]=(0,n.useState)(!1);return a.length?(0,r.jsxs)(V,{children:[(0,r.jsxs)(Y,{onClick:()=>s(e=>!e),children:[(0,r.jsxs)(_,{children:[o,e]}),(0,r.jsx)(W,{open:c,children:(0,r.jsx)(k.A,{size:12})})]}),(0,r.jsx)(J,{open:c,children:(0,r.jsx)(U,{children:a.map(e=>{const o=l.some(o=>o.id===e.id);return(0,r.jsxs)(Z,{children:[(0,r.jsx)(X,{active:i===e.id,onClick:()=>t(e),children:e.name}),(0,r.jsx)(q,{active:o,title:o?"Remover dos favoritos":"Adicionar aos favoritos",onClick:o=>{o.stopPropagation(),d(e)},children:(0,r.jsx)(G.A,{size:12,fill:o?"currentColor":"none"})})]},e.id)})})})]}):null}function ee({config:e,activeId:o,onSelect:a,hashPrefix:i}){const t=`atlantis-recent-${i}`,l=`atlantis-fav-${i}`,[d,c]=(0,n.useState)(()=>H(t)),[s,m]=(0,n.useState)(()=>H(l)),g=(0,n.useCallback)(e=>{e.file&&c(o=>function(e,o,a){const n=[o,...a.filter(e=>e.id!==o.id)].slice(0,10);return localStorage.setItem(e,JSON.stringify(n)),n}(t,e,o)),a(e)},[a,t]),u=(0,n.useCallback)(e=>{m(o=>function(e,o,a){const n=a.some(e=>e.id===o.id)?a.filter(e=>e.id!==o.id):[...a,o];return localStorage.setItem(e,JSON.stringify(n)),n}(l,e,o))},[l]);return(0,r.jsxs)(O,{children:[(0,r.jsx)(Q,{title:"Recentes",icon:(0,r.jsx)(D.A,{size:13}),entries:d,activeId:o,onSelect:g,favorites:s,onToggleFav:u}),(0,r.jsx)(Q,{title:"Favoritos",icon:(0,r.jsx)(G.A,{size:13}),entries:s,activeId:o,onSelect:g,favorites:s,onToggleFav:u}),(0,r.jsx)(I,{entries:e.entries,activeId:o,onSelect:g})]})}var oe=a(28976),ae=a(18055),ne=a(66225),ie=a(302),te=a(39895),re=a(6930),le=a(14944);const de=t.default.div`
...
`;let se=!1;function me({code:e}){const o=(0,n.useRef)(null),[t,l]=(0,n.useState)(null);return(0,n.useEffect)(()=>{let n=!1;return async function(){const t=(await a.e(774).then(a.bind(a,30774))).default;if(se||(t.initialize({startOnLoad:!1,theme:"dark",themeVariables:{background:i.w.colors.codeBg,primaryColor:i.w.colors.accent,primaryTextColor:i.w.colors.mainText,lineColor:i.w.colors.border}}),se=!0),o.current&&!n)try{const a=`mermaid-${Math.random().toString(36).slice(2)}`,{svg:i}=await t.render(a,e);!n&&o.current&&(o.current.innerHTML=i)}catch(e){n||l(e instanceof Error?e.message:String(e))}}(),()=>{n=!0}},[e]),t?(0,r.jsx)(de,{children:(0,r.jsxs)(ce,{children:["Mermaid error: ",t]})}):(0,r.jsx)(de,{ref:o})}var ge=a(68383),ue=a(21426),pe=a(25609),fe=a(20320);const ye=t.default.div`
  margin: ${i.w.spacing.lg} 0;
  border-radius: ${i.w.borderRadius.md};
  border: 1px solid ${i.w.colors.codeBorder};
  overflow: hidden;
...
`;function Fe({headings:e,activeId:o}){return e.length<2?null:(0,r.jsxs)(Ce,{children:[(0,r.jsx)(Pe,{children:"On this page"}),(0,r.jsx)(Re,{children:e.map(e=>(0,r.jsx)("li",{children:(0,r.jsx)(Le,{href:`#${e.id}`,active:o===e.id,level:e.level,onClick:o=>{o.preventDefault(),document.getElementById(e.id)?.scrollIntoView({behavior:"smooth",block:"start"})},children:e.text})},e.id))})]})}function Ne(e){return e.toLowerCase().replace(/[*_`[\]()#]/g,"").replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-").trim()}function Ie(e){const{Children:o,isValidElement:n}=a(27359);return o.toArray(e).map(e=>"string"==typeof e?e:"number"==typeof e?String(e):n(e)?Ie(e.props.children??""):"").join("")}function Ke(){return e=>{!function e(o){if("blockquote"===o.type){const e=o.children?.[0];if("paragraph"===e?.type){const a=e.children?.[0];if("text"===a?.type){const n=a.value?.match(/^\[!(NOTE|TIP|WARNING|CAUTION|IMPORTANT)\]\s*/i);n&&(a.value=a.value.slice(n[0].length),a.value.trim()||1!==e.children.length||o.children.shift(),o.data=o.data??{},o.data.hName="div",o.data.hProperties={"data-callout":n[1].toUpperCase()})}}}o.children?.forEach(e)}(e)}}const Ge=t.default.div`
  display: flex;
...
`,We=t.default.div`
  ...
  font-family: ${i.w.typography.fontFamily};
`;function Je(e){return function({children:o,...a}){const n=`h${e}`,i=Ie(o),t=Ne(i);return(0,r.jsxs)(n,{id:t,...a,children:[o,(0,r.jsx)("a",{className:"heading-anchor",href:`#${t}`,"aria-label":`Link to "${i}"`,children:(0,r.jsx)(ne.A,{size:14})})]})}}function Ue({file:e,prevEntry:o,nextEntry:i,onNavigate:t}){const[l,d]=(0,n.useState)(null),[c,s]=(0,n.useState)(null),m=(0,n.useRef)(null);if((0,n.useEffect)(()=>{d(null),fetch(`${a.p}content/${e}`).then(e=>{if(!e.ok)throw new Error(`${e.status} ${e.statusText}`);return e.text()}).then(d).catch(o=>d(`> **Error loading \`${e}\`:** ${o.message}`))},[e]),(0,n.useEffect)(()=>{if(!l||!m.current)return;const e=m.current.querySelectorAll("h2[id], h3[id]");if(!e.length)return;const o=new IntersectionObserver(e=>{const o=e.filter(e=>e.isIntersecting);o.length&&s(o[0].target.id)},{rootMargin:"-10% 0% -60% 0%",threshold:0});return e.forEach(e=>o.observe(e)),()=>o.disconnect()},[l]),null===l)return(0,r.jsx)(We,{children:"Loading…"});const g=function(e){const o=[],a=/^(#{2,3})\s+(.+)$/gm;let n;for(;null!==(n=a.exec(e));){const e=n[1].length,a=n[2].trim().replace(/\*\*(.+?)\*\*/g,"$1").replace(/\*(.+?)\*/g,"$1").replace(/`(.+?)`/g,"$1").replace(/\[(.+?)\]\(.+?\)/g,"$1");o.push({level:e,text:a,id:Ne(a)})}return o}(l),u=o||i;return(0,r.jsxs)(Ge,{children:[(0,r.jsxs)(De,{children:[(0,r.jsx)(He,{ref:m,children:(0,r.jsx)(oe.oz,{remarkPlugins:[ae.A,le.A,Ke],rehypePlugins:[te.A,re.A],components:{div({node:e,children:o,...a}){const n=a["data-callout"];return n?(0,r.jsx)(Ee,{type:n,children:o}):(0,r.jsx)("div",{...a,children:o})},h1:Je(1),h2:Je(2),h3:Je(3),h4:Je(4),pre:({children:e})=>(0,r.jsx)(r.Fragment,{children:e}),code({className:e,children:o}){const a=/language-(\w+)/.exec(e??"")?.[1],n=String(o).replace(/\n$/,"");return"mermaid"===a?(0,r.jsx)(me,{code:n}):a||n.includes("\n")?(0,r.jsx)(we,{lang:a,code:n}):(0,r.jsx)("code",{className:e,children:o})}},children:l})}),u&&(0,r.jsxs)(Oe,{children:[o?(0,r.jsxs)(Ve,{align:"left",onClick:()=>t?.(o),children:[(0,r.jsxs)(Ye,{children:[(0,r.jsx)(ie.A,{size:13})," Previous"]}),(0,r.jsx)(_e,{children:o.name})]}):(0,r.jsx)("div",{style:{flex:1}}),i?(0,r.jsxs)(Ve,{align:"right",onClick:()=>t?.(i),children:[(0,r.jsxs)(Ye,{children:["Next ",(0,r.jsx)(k.A,{size:13})]}),(0,r.jsx)(_e,{children:i.name})]}):(0,r.jsx)("div",{style:{flex:1}})]})]}),(0,r.jsx)(Fe,{headings:g,activeId:c})]})}const Ze=t.default.div`
  display: flex;
  gap: 4px;
  background: ${i.w.colors.surface};
  border: 1px solid ${i.w.colors.border};
...
`;function co({title:e,sub:o}){return(0,r.jsxs)(oo,{children:[(0,r.jsx)(no,{}),(0,r.jsx)(ao,{size:500,x:10,y:-10,hue:210,dur:7}),(0,r.jsx)(ao,{size:400,x:60,y:50,hue:270,dur:9}),(0,r.jsx)(ao,{size:300,x:30,y:70,hue:190,dur:6}),(0,r.jsxs)(io,{children:[(0,r.jsx)(to,{children:e}),(0,r.jsx)(ro,{children:o}),(0,r.jsxs)(lo,{children:[(0,r.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round",children:(0,r.jsx)("polyline",{points:"15 18 9 12 15 6"})}),"Browse the sidebar"]})]})]})}function so(e,o,a){return"string"==typeof e?e:e[o]??e[a]??Object.values(e)[0]??""}function mo({navigation:e,languages:o,defaultLang:a,hashPrefix:i,topBarRight:t,welcomeTitle:l="Blog",welcomeSub:d="Notes, guides, and references — pick a topic from the sidebar to get started."}){const c=o?Object.keys(o):[],s=c.length>1,[m,g]=(0,n.useState)(()=>a??c[0]??""),u=(0,n.useMemo)(()=>o&&m?o[m].navigation:e??{entries:[]},[o,e,m]),p=((0,n.useMemo)(()=>eo(u.entries),[u]),(0,n.useCallback)(e=>{const o=e.match(new RegExp(`^#\\/${i}\\/(.+)$`));if(o)return Qe(u.entries,o[1])},[u,i])),[f,y]=(0,n.useState)(()=>p(window.location.hash)??null);(0,n.useEffect)(()=>{y(null)},[m]),(0,n.useEffect)(()=>{const e=()=>{const e=p(window.location.hash);e&&y(e)};return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[p]);const b=(0,n.useCallback)(e=>{e.file&&(y(e),window.location.hash=`#/${i}/${e.id}`)},[i]),x=(0,n.useMemo)(()=>eo(u.entries),[u]),h=x.findIndex(e=>e.id===f?.id),z=h>0?x[h-1]:null,w=h<x.length-1?x[h+1]:null,$=f?.label??f?.name??i,A=so(l,m,a??c[0]??""),k=so(d,m,a??c[0]??""),j=s&&o?(0,r.jsx)(qe,{languages:Object.fromEntries(c.map(e=>[e,{label:o[e].label}])),activeLang:m,onChange:g}):null;return(0,r.jsx)(v,{title:$,activeId:f?.id??null,topBarRight:(0,r.jsxs)(r.Fragment,{children:[j,t]}),sidebar:(0,r.jsx)(ee,{config:u,activeId:f?.id??null,onSelect:b,hashPrefix:i}),children:f?.file?(0,r.jsx)(Ue,{file:f.file,prevEntry:z,nextEntry:w,onNavigate:b}):(0,r.jsx)(co,{title:A,sub:k})})}},74914(e,o,a){a.d(o,{FlyoutPanel:()=>b});var n=a(27359),i=a(53233),t=a(77207),r=a(20255),l=a(217),d=a(15959),c=a(65185),s=a(65723);const m=t.keyframes`
