...
`;let C=l().div`
  ...
  align-items: center;
  gap: 8px;
`;function L({children:e,...o}){return(0,r.jsx)(C,{...o,children:e})}l().label`
  display: flex;
  align-items: center;
  gap: 10px;
...
`,l().div`
  position: relative;
`;let U="260px",J="56px",Q="48px",ee=l().header`
  display: flex;
  align-items: center;
...
`,ei=l().span`
  ...
  animation: ${er} 10s ease ${({index:e})=>.07*e}s infinite;
...
`,eg=l().main`
  ...
  display: flex;
  flex-direction: column;
`,eh=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function ex(){return(0,r.jsx)(ea,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:eh.map((e,o)=>(0,r.jsx)(ei,{index:o,accent:e.accent,children:e.char},o))})}let ef="atlantis:sidebar-collapsed";function eb({sidebar:e,children:o,topBarRight:n,title:l="Atlantis",activeId:d=null}){let[s,p]=(0,a.useState)(()=>{try{return"true"===localStorage.getItem(ef)}catch{return!1}}),[c,g]=(0,a.useState)(null),h=(0,a.useRef)(),x=()=>p(e=>{let o=!e;try{localStorage.setItem(ef,String(o))}catch{}return o}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(t.bind(t,5816)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(I.I.Provider,{value:{collapsed:s,toggle:x,flyout:c,openFlyout:(e,o,t)=>{clearTimeout(h.current),g({entry:e,anchorY:o,onSelect:t})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,r.jsxs)(es,{children:[(0,r.jsxs)(ee,{children:[e&&(0,r.jsx)(eo,{children:(0,r.jsx)(et,{onClick:x,title:s?"Expand sidebar":"Collapse sidebar",children:(0,r.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,r.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,r.jsx)("path",{d:"M9 3v18"})]})})}),(0,r.jsx)(ex,{}),l&&(0,r.jsx)(en,{children:l}),n&&(0,r.jsx)(el,{children:n})]}),(0,r.jsxs)(ed,{children:[null!=e&&(0,r.jsx)(ep,{collapsed:s,children:(0,r.jsx)(ec,{children:e})}),(0,r.jsx)(eg,{children:o})]}),c&&(0,r.jsx)(i().Suspense,{fallback:null,children:(0,r.jsx)(f,{activeId:d})})]})})}l().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
