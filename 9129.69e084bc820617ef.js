...
`,m=r().div`
  ...
  height: 100%;
  animation: ${c} 0.3s ease both;
`,p=r().div`
  font-size: 11px;
  font-weight: 600;
  font-family: ${h.w4.typography.fontFamilyMono};
  color: ${h.w4.colors.mainTextMuted};
...
`,g=r().div`
  font-size: 13px;
  line-height: 1.65;
  color: ${h.w4.colors.mainText};
  font-family: ${h.w4.typography.fontFamily};
  font-style: italic;
  opacity: 0.9;
...
`;function y({locale:e}){let t,a,n=(0,i.useMemo)(()=>(0,l.Nx)("pt"===e?"pt":"en",u.A),[e]),r=(a=new Date((t=new Date).getFullYear(),0,0),Math.floor((t.getTime()-a.getTime())/864e5)%d.length),s=d[r],h="pt"===e&&s.textPt?s.textPt:s.text;return(0,o.jsxs)(m,{children:[(0,o.jsx)(p,{children:n("quotes.title")}),(0,o.jsxs)(x,{children:[(0,o.jsx)(g,{children:h}),(0,o.jsxs)(f,{children:["— ",s.author]})]})]})}}}]);