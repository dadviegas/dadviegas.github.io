"use strict";(self.webpackChunk_atlantis_citypulse=self.webpackChunk_atlantis_citypulse||[]).push([["7206"],{3819(o,e,a){a.d(e,{Mq:()=>t,QH:()=>i});var r=a(3930);let t=["lisbon","ponta-delgada","lourinha","new-york","san-francisco","london","paris","berlin","tokyo","dubai","singapore","sao-paulo","sydney"].map(o=>r.rh.find(e=>e.id===o)).filter(o=>void 0!==o).map(function(o){return{id:o.id,name:o.name,country:o.country,lat:o.lat,lon:o.lng,timezone:o.timezone}});function i(o){return o<=20?{label:"Good",color:"#3fb950"}:o<=40?{label:"Fair",color:"#d29922"}:o<=60?{label:"Moderate",color:"#f0883e"}:o<=80?{label:"Poor",color:"#f85149"}:{label:"Very Poor",color:"#8957e5"}}},5332(o,e,a){a.d(e,{A:()=>u});var r=a(5723),t=a(7991),i=a.n(t),n=a(6859),l=a.n(n),s=a(3930),d=a(3819);let c=l().div`
  display: flex;
...
`,x=l().div`
  ...
  white-space: nowrap;
  z-index: 10;
`;function u({airQuality:o,loading:e}){let[a,n]=i().useState(null),l=i().useRef(null),h=(0,t.useMemo)(()=>{if(!o)return[];let e=o.european_aqi,a=Math.max(...e.filter(Boolean),1),r=114,t=792/e.length;return e.map((e,i)=>{let n=e??0,l=n/Math.max(a,80)*r;return{x:4+i*t+.1*t,y:22+r-l,w:.8*t,h:l,val:n,color:(0,d.QH)(n).color,time:o.time[i]?.slice(11,16)??""}})},[o]);return(0,r.jsxs)(c,{children:[(0,r.jsx)("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"baseline"},children:(0,r.jsx)(p,{children:"Air Quality (EU AQI)"})}),(0,r.jsx)(g,{children:[0,21,41,61,81].map(o=>{let{label:e,color:a}=(0,d.QH)(o);return(0,r.jsx)(m,{color:a,children:e},e)})}),e?(0,r.jsx)(f,{}):(0,r.jsxs)("div",{style:{position:"relative"},children:[(0,r.jsxs)("svg",{ref:l,viewBox:"0 0 800 160",width:"100%",height:160,style:{display:"block",cursor:"crosshair"},onMouseLeave:()=>n(null),children:[[.5,1].map(o=>(0,r.jsx)("line",{x1:4,y1:22+114*(1-o),x2:796,y2:22+114*(1-o),stroke:s.w4.colors.border,strokeWidth:1},o)),h.map((o,e)=>(0,r.jsxs)("g",{children:[(0,r.jsx)("rect",{x:o.x,y:o.y,width:o.w,height:o.h,rx:2,fill:o.color,opacity:a?.i===e?1:.75,onMouseEnter:()=>{if(!l.current)return;let a=l.current.getBoundingClientRect(),r=a.width/800;n({i:e,x:(o.x+o.w/2)*r,y:o.y*(a.height/160)})}}),o.val>0&&(0,r.jsx)("text",{x:o.x+o.w/2,y:Math.max(18,o.y-4),textAnchor:"middle",fontSize:9,fontWeight:"600",fill:o.color,children:o.val})]},e)),[0,6,12,18,23].map(o=>h[o]?(0,r.jsx)("text",{x:h[o].x+h[o].w/2,y:156,textAnchor:"middle",fontSize:10,fill:s.w4.colors.mainTextMuted,children:h[o].time},o):null)]}),a&&h[a.i]&&(0,r.jsxs)(x,{x:a.x,y:a.y,children:[h[a.i].time," — AQI ",h[a.i].val," (",(0,d.QH)(h[a.i].val).label,")"]})]})]})}},4439(o,e,a){a.d(e,{A:()=>k});var r=a(5723),t=a(7991),i=a.n(t),n=a(6859),l=a.n(n),s=a(3930),d=a(3819),c=a(9522),p=a(1951);let g=l().div`
  display: flex;
  flex-direction: column;
  gap: ${s.w4.spacing.lg};
`,m=l().h3`
...
`;function z({city:o}){let{snapshot:e,loading:a}=(0,c.n)(o),t=e?[{label:"Temperature",value:`${e.currentTemp}\xb0C`,pct:(e.currentTemp+20)/70*100,color:"#58a6ff"},{label:"Air Quality (AQI)",value:`${e.currentAqi}`,pct:e.currentAqi/100*100,color:(0,d.QH)(e.currentAqi).color},{label:"Wind Speed",value:`${e.currentWind} km/h`,pct:e.currentWind/120*100,color:"#d29922"},{label:"Rain Probability",value:`${e.precipProb}%`,pct:e.precipProb,color:"#79c0ff"}]:[];return(0,r.jsxs)(x,{children:[(0,r.jsxs)(u,{children:[(0,r.jsx)(h,{children:o.name}),(0,r.jsx)("span",{style:{fontSize:s.w4.typography.fontSizeSm,color:s.w4.colors.mainTextMuted},children:o.country})]}),a?[1,2,3,4].map(o=>(0,r.jsxs)(b,{children:[(0,r.jsx)(y,{children:(0,r.jsx)("span",{children:"Loading…"})}),(0,r.jsx)(v,{})]},o)):t.map(o=>(0,r.jsxs)(b,{children:[(0,r.jsxs)(y,{children:[(0,r.jsx)("span",{children:o.label}),(0,r.jsx)("span",{style:{color:s.w4.colors.mainText,fontWeight:600},children:o.value})]}),(0,r.jsx)(w,{children:(0,r.jsx)($,{pct:o.pct,color:o.color})})]},o.label))]})}function k(){let[o,e]=i().useState(d.Mq["0"]),[a,t]=i().useState(d.Mq["1"]);return(0,r.jsxs)(g,{children:[(0,r.jsx)(m,{children:"City Comparison"}),(0,r.jsxs)(f,{children:[(0,r.jsxs)("div",{style:{display:"flex",flexDirection:"column",gap:s.w4.spacing.md},children:[(0,r.jsx)(p.A,{value:o.id,onChange:e}),(0,r.jsx)(z,{city:o})]}),(0,r.jsxs)("div",{style:{display:"flex",flexDirection:"column",gap:s.w4.spacing.md},children:[(0,r.jsx)(p.A,{value:a.id,onChange:t}),(0,r.jsx)(z,{city:a})]})]})]})}},751(o,e,a){a.d(e,{A:()=>V});var r=a(5723);a(7991);var t=a(6859),i=a.n(t),n=a(3930);let l={ghost:"transparent",accent:"transparent",primary:n.w4.colors.accent,success:"#238636",danger:"#da3633"},s={ghost:n.w4.colors.sidebarHover,accent:"rgba(88,166,255,0.10)",primary:n.w4.colors.accentHover,success:"#2ea043",danger:"#f85149"},d={ghost:n.w4.colors.border,accent:n.w4.colors.accent,primary:n.w4.colors.accent,success:"#238636",danger:"#da3633"},c={ghost:n.w4.colors.mainTextMuted,accent:n.w4.colors.accent,primary:"#fff",success:"#fff",danger:"#fff"},p={ghost:n.w4.colors.mainText,accent:n.w4.colors.accent,primary:"#fff",success:"#fff",danger:"#fff"},g={sm:"28px",md:"30px"},m={sm:"0 10px",md:"0 12px"},f={sm:"12px",md:"12px"};i().button`
  display: inline-flex;
  align-items: center;
...
`,i().div`
  ...
  gap: 4px;
  flex-wrap: wrap;
`,i()("button",{shouldForwardProp:o=>"active"!==o&&"highlight"!==o})`
  padding: 6px 14px;
  height: 28px;
  border-radius: 999px;
  background: ${({active:o})=>o?n.w4.colors.accentMuted:"transparent"};
  border: 1px solid
    ${({active:o,highlight:e})=>o||e?n.w4.colors.accent:"transparent"};
  color: ${({active:o,highlight:e})=>o||e?n.w4.colors.accent:n.w4.colors.mainTextMuted};
  font-family: ${n.w4.typography.fontFamily};
  font-size: 12px;
  font-weight: 500;
  cursor: pointer;
...
`,i().button`
  ...
  &:hover {
    color: ${({active:o})=>o?n.w4.colors.accent:n.w4.colors.mainText};
    background: ${({active:o})=>o?n.w4.colors.accentMuted:n.w4.colors.sidebarHover};
  }
`,i().button`
  width: 100%;
  display: flex;
...
`,(0,n.PL)("shell:locale").then(o=>{if("en"===o||"pt"===o)try{localStorage.setItem("atlantis:locale",o)}catch{}}).catch(()=>{}),i().div`
  display: flex;
  gap: 4px;
  background: ${n.w4.colors.surface};
  border: 1px solid ${n.w4.colors.border};
...
`,i()("button",{shouldForwardProp:o=>"accent"!==o&&"expanded"!==o})`
  width: 100%;
  display: grid;
  ...
  &:focus-visible { ${n.w4.focusRing} }
`,i()("span",{shouldForwardProp:o=>"accent"!==o})`
  width: 36px;
  height: 36px;
  border-radius: 9px;
...
`;i()("div",{shouldForwardProp:o=>"accentColor"!==o&&"pinned"!==o&&"index"!==o})`
  --acc: ${({accentColor:o})=>o};
  position: relative;
  display: flex;
  flex-direction: column;
...
`;let M=(0,h.keyframes)`
  from { opacity: 0; transform: translateY(8px); }
  to   { opacity: 1; transform: translateY(0); }
`;i()("div",{shouldForwardProp:o=>"accentColor"!==o&&"index"!==o})`
  --acc: ${({accentColor:o})=>o};
  position: relative;
  display: flex;
  flex-direction: column;
...
`,i()("div",{shouldForwardProp:o=>"accentColor"!==o})`
  --acc: ${({accentColor:o})=>o};
  height: 120px;
  position: relative;
  overflow: hidden;
...
`,i().span`
  ...
  border-radius: 50%;
  background: ${({bg:o})=>o};
  border: ${({ring:o})=>o?`1px solid ${n.w4.colors.border}`:"none"};
  flex-shrink: 0;
  overflow: hidden;
  user-select: none;
`,i().span`
...
`,H=i().div`
  ...
  &::before {
    ...
    right: 0;
    height: 2px;
    background: ${({accentColor:o})=>o??n.w4.colors.accent};
  }
`,R=i().div`
  font-size: ${n.w4.typography.fontSizeSm};
  color: ${n.w4.colors.mainTextMuted};
...
`;function V({snapshot:o,loading:e}){let a=o?(0,B.QH)(o.currentAqi):null;return(0,r.jsxs)(C,{children:[(0,r.jsxs)(H,{accentColor:"#58a6ff",children:[(0,r.jsxs)(R,{children:[(0,r.jsx)(w,{name:"thermometer",size:14})," Temperature"]}),e?(0,r.jsx)(E,{}):(0,r.jsxs)(L,{children:[o?.currentTemp,"\xb0C"]}),!e&&(0,r.jsxs)(P,{children:["Feels like ",o?.apparentTemp,"\xb0C"]})]}),(0,r.jsxs)(H,{accentColor:a?.color??"#3fb950",children:[(0,r.jsxs)(R,{children:[(0,r.jsx)(w,{name:"activity",size:14})," Air Quality (EU AQI)"]}),e?(0,r.jsx)(E,{}):(0,r.jsx)(L,{style:{color:a?.color},children:o?.currentAqi}),!e&&(0,r.jsx)(P,{children:a?.label})]}),(0,r.jsxs)(H,{accentColor:"#d29922",children:[(0,r.jsxs)(R,{children:[(0,r.jsx)(w,{name:"wind",size:14})," Wind Speed"]}),e?(0,r.jsx)(E,{}):(0,r.jsx)(L,{children:o?.currentWind}),!e&&(0,r.jsx)(P,{children:"km/h"})]}),(0,r.jsxs)(H,{accentColor:"#79c0ff",children:[(0,r.jsxs)(R,{children:[(0,r.jsx)(w,{name:"droplets",size:14})," Precipitation"]}),e?(0,r.jsx)(E,{}):(0,r.jsxs)(L,{children:[o?.precipProb,"%"]}),!e&&(0,r.jsx)(P,{children:"Chance of rain"})]})]})}},1951(o,e,a){a.d(e,{A:()=>d});var r=a(5723);a(7991);var t=a(6859),i=a.n(t),n=a(3930),l=a(3819);let s=i().select`
  background: ${n.w4.colors.surface};
  border: 1px solid ${n.w4.colors.border};
  border-radius: ${n.w4.borderRadius.md};
  color: ${n.w4.colors.mainText};
...
`;function d({value:o,onChange:e}){return(0,r.jsx)(s,{value:o,onChange:o=>e(l.Mq.find(e=>e.id===o.target.value)),children:l.Mq.map(o=>(0,r.jsxs)("option",{value:o.id,children:[o.name,", ",o.country]},o.id))})}},7912(o,e,a){a.d(e,{A:()=>f});var r=a(5723),t=a(7991),i=a(6859),n=a.n(i),l=a(3930);let s=n().div`
  display: flex;
  flex-direction: column;
  gap: ${l.w4.spacing.md};
`,d=n().h3`
...
`;function f({weather:o,loading:e}){let{path:a,areaPath:i,points:n,tickLabels:x,minT:u,maxT:h}=(0,t.useMemo)(()=>{if(!o)return{path:"",areaPath:"",points:[],tickLabels:[],minT:0,maxT:0};let e=o.temperature_2m,a=o.time,r=Math.min(...e)-2,t=Math.max(...e)+2,i=792,n=104,l=e.map((o,a)=>({x:4+a/(e.length-1)*i,y:28+n-(o-r)/(t-r)*n,temp:Math.round(o)})),s=function(o){if(o.length<2)return"";let e=`M ${o[0].x.toFixed(2)} ${o[0].y.toFixed(2)}`;for(let a=1;a<o.length;a++){let r=o[a-1],t=o[a],i=((r.x+t.x)/2).toFixed(2);e+=` C ${i} ${r.y.toFixed(2)} ${i} ${t.y.toFixed(2)} ${t.x.toFixed(2)} ${t.y.toFixed(2)}`}return e}(l),d=s+` L ${l[l.length-1].x.toFixed(2)} 132.00`+` L ${l[0].x.toFixed(2)} 132.00 Z`;return{path:s,areaPath:d,points:l,tickLabels:[0,6,12,18,23].map(o=>({x:4+o/(e.length-1)*i,label:a[o]?a[o].slice(11,16):""})),minT:r,maxT:t}},[o]),b=`${Math.round(u+2)}\xb0 – ${Math.round(h-2)}\xb0C`;return(0,r.jsxs)(s,{children:[(0,r.jsxs)("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"baseline"},children:[(0,r.jsx)(d,{children:"24h Temperature"}),o&&(0,r.jsx)("span",{style:{fontSize:l.w4.typography.fontSizeSm,color:l.w4.colors.mainTextMuted},children:b})]}),e?(0,r.jsx)(m,{}):(0,r.jsxs)(c,{children:[(0,r.jsxs)("svg",{viewBox:"0 0 800 140",width:"100%",height:140,style:{display:"block",overflow:"visible"},children:[(0,r.jsx)("defs",{children:(0,r.jsxs)("linearGradient",{id:"tempGrad",x1:"0",y1:"0",x2:"0",y2:"1",children:[(0,r.jsx)("stop",{offset:"0%",stopColor:"#58a6ff",stopOpacity:"0.35"}),(0,r.jsx)("stop",{offset:"100%",stopColor:"#58a6ff",stopOpacity:"0"})]})}),[.25,.5,.75].map(o=>(0,r.jsx)("line",{x1:4,y1:28+104*o,x2:796,y2:28+104*o,stroke:l.w4.colors.border,strokeWidth:1},o)),(0,r.jsx)("path",{d:i,fill:"url(#tempGrad)"}),(0,r.jsx)("path",{d:a,fill:"none",stroke:"#58a6ff",strokeWidth:2,strokeLinecap:"round"}),n.filter((o,e)=>e%3==0).map((o,e)=>(0,r.jsxs)("g",{children:[(0,r.jsx)("circle",{cx:o.x,cy:o.y,r:3,fill:"#58a6ff"}),(0,r.jsxs)("text",{x:o.x,y:Math.max(22,o.y-10),textAnchor:"middle",fontSize:11,fontWeight:"600",fill:"#79c0ff",children:[o.temp,"\xb0"]})]},e))]}),(0,r.jsx)(p,{children:x.map(o=>(0,r.jsx)(g,{children:o.label},o.label))})]})]})}},9522(o,e,a){a.d(e,{n:()=>t});var r=a(7991);function t(o){let[e,a]=(0,r.useState)(0),t=(0,r.useCallback)(()=>a(o=>o+1),[]),[i,n]=(0,r.useState)({snapshot:null,weather:null,airQuality:null,loading:!0,error:null});return(0,r.useEffect)(()=>{let e=!1;n({snapshot:null,weather:null,airQuality:null,loading:!0,error:null});let a=`https://api.open-meteo.com/v1/forecast?latitude=${o.lat}&longitude=${o.lon}&hourly=temperature_2m,apparent_temperature,precipitation_probability,windspeed_10m&forecast_days=1&timezone=${encodeURIComponent(o.timezone)}`,r=`https://air-quality-api.open-meteo.com/v1/air-quality?latitude=${o.lat}&longitude=${o.lon}&hourly=european_aqi,pm2_5,pm10&timezone=${encodeURIComponent(o.timezone)}&forecast_days=1`;return Promise.all([fetch(a).then(o=>o.json()),fetch(r).then(o=>o.json())]).then(([o,a])=>{var r;let t,i,l;if(e)return;let s=o.hourly,d=a.hourly,c=(r=s.time,t=new Date,i=`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,"0")}-${String(t.getDate()).padStart(2,"0")}T${String(t.getHours()).padStart(2,"0")}:00`,(l=r.indexOf(i))>=0?l:Math.min(r.length-1,12));n({snapshot:{currentTemp:Math.round(s.temperature_2m[c]),apparentTemp:Math.round(s.apparent_temperature[c]),currentAqi:Math.round(d.european_aqi[c]??0),currentWind:Math.round(s.windspeed_10m[c]),precipProb:s.precipitation_probability[c]},weather:s,airQuality:d,loading:!1,error:null})}).catch(o=>{e||n({snapshot:null,weather:null,airQuality:null,loading:!1,error:String(o)})}),()=>{e=!0}},[o.id,e]),{...i,retry:t}}},8859(o,e,a){a.d(e,{FlyoutPanel:()=>y});var r=a(5723),t=a(7991),i=a.n(t),n=a(6859),l=a.n(n),s=a(2799),d=a(1316),c=a(814),p=a(6140);let g=(0,s.keyframes)`
...
`,u=({size:o=14,strokeWidth:e=1.75})=>(0,r.jsxs)("svg",{width:o,height:o,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:e,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,r.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,r.jsx)("polyline",{points:"14 2 14 8 20 8"})]});function h({iconKey:o}){let e=o?p.t[o]:null;return e?(0,r.jsx)(e,{size:14,strokeWidth:1.75}):(0,r.jsx)(u,{})}function b({entries:o,activeId:e,onSelect:a}){return(0,r.jsx)(r.Fragment,{children:o.map(o=>o.children?(0,r.jsx)(i().Fragment,{children:(0,r.jsx)(b,{entries:o.children,activeId:e,onSelect:a})},o.id):(0,r.jsxs)(x,{active:e===o.id,onClick:()=>a(o),children:[(0,r.jsx)(h,{iconKey:o.icon}),o.name]},o.id))})}function y({activeId:o}){let{flyout:e,scheduleFlyoutClose:a,cancelFlyoutClose:t}=(0,c.c)();if(!e)return null;let i=e.entry.icon?p.t[e.entry.icon]:null;return(0,r.jsxs)(m,{anchorY:e.anchorY,onMouseEnter:t,onMouseLeave:a,children:[(0,r.jsxs)(f,{children:[i?(0,r.jsx)(i,{size:13,strokeWidth:2}):(0,r.jsx)(u,{size:13,strokeWidth:2}),e.entry.name]}),(0,r.jsx)(b,{entries:e.entry.children??[],activeId:o,onSelect:o=>{e.onSelect(o),a()}})]})}},814(o,e,a){a.d(e,{I:()=>t,c:()=>i});var r=a(7991);let t=(0,r.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),i=()=>(0,r.useContext)(t)},6140(o,e,a){a.d(e,{t:()=>ob});var r=a(6896),t=a(7902),i=a(3013),n=a(2887),l=a(9510),s=a(9848),d=a(7901),c=a(3045),p=a(3775),g=a(1783),m=a(3539),f=a(9416),x=a(1837),u=a(7167),h=a(4494),b=a(2314),y=a(255),w=a(5751),$=a(9633),v=a(2946),z=a(822),k=a(6720),M=a(7400),A=a(8456),j=a(3317),T=a(2709),S=a(8006),F=a(9301),B=a(7561),C=a(3517),H=a(8207),R=a(7032),L=a(6949),P=a(8218),E=a(6829),V=a(9591),I=a(5553),Y=a(9923),D=a(2820),_=a(4621),K=a(8479),G=a(2534),N=a(6673),W=a(7490),O=a(9033),q=a(9038),Q=a(5775),U=a(1365),Z=a(2937),J=a(9821),X=a(5912),oo=a(158),oe=a(8641),oa=a(8607),or=a(3249),ot=a(1821),oi=a(5889),on=a(9655),ol=a(7170),os=a(9161),od=a(1849),oc=a(1604),op=a(3142),og=a(1187),om=a(7747),of=a(2932),ox=a(4525),ou=a(7230),oh=a(2164);let ob={activity:r.A,"a-large-small":t.A,apple:i.A,"arrow-right":n.A,"bar-chart-2":l.A,book:s.A,"book-open":d.A,briefcase:c.A,calendar:p.A,clock:g.A,"circle-dot":m.A,cloud:f.A,compass:x.A,cpu:u.A,droplets:h.A,feather:b.A,file:y.A,"file-text":w.A,folder:$.A,"git-branch":v.A,github:z.A,globe:k.A,grid:M.A,hand:A.A,hash:j.A,heart:T.A,key:S.A,hexagon:F.A,home:B.A,landmark:C.A,layers:H.A,"layout-grid":R.A,leaf:L.A,lightbulb:P.A,list:E.A,map:V.A,"map-pin":I.A,"message-circle":Y.A,"message-square":D.A,minus:_.A,monitor:K.A,mountain:G.A,package:N.A,palette:W.A,"pen-tool":O.A,"pie-chart":q.A,plane:Q.A,plus:U.A,ruler:Z.A,shirt:J.A,slash:X.A,square:oo.A,star:oe.A,sun:oa.A,terminal:or.A,thermometer:ot.A,triangle:oi.A,trophy:on.A,truck:ol.A,type:os.A,users:od.A,"volume-2":oc.A,watch:op.A,waves:og.A,wind:om.A,wrench:of.A,x:ox.A,zap:ou.A,bot:oh.A}},3930(o,e,a){a.d(e,{wi:()=>U,PH:()=>J,NI:()=>Q,rh:()=>N,w4:()=>r.w4,KW:()=>Z,PL:()=>W.getSetting});var r=a(1316),t=a(5723),i=a(7991),n=a.n(i),l=a(6859),s=a.n(l);s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,A=s().main`
  ...
  display: flex;
  flex-direction: column;
`,j=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function T(){return(0,t.jsx)(b,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:j.map((o,e)=>(0,t.jsx)(y,{index:e,accent:o.accent,children:o.char},e))})}let S="atlantis:sidebar-collapsed";function F({sidebar:o,children:e,topBarRight:r,title:l="Atlantis",activeId:s=null}){let[d,p]=(0,i.useState)(()=>{try{return"true"===localStorage.getItem(S)}catch{return!1}}),[g,m]=(0,i.useState)(null),h=(0,i.useRef)(),b=()=>p(o=>{let e=!o;try{localStorage.setItem(S,String(e))}catch{}return e}),y=n().useMemo(()=>n().lazy(()=>Promise.resolve().then(a.bind(a,8859)).then(o=>({default:o.FlyoutPanel}))),[]);return(0,t.jsx)(c.I.Provider,{value:{collapsed:d,toggle:b,flyout:g,openFlyout:(o,e,a)=>{clearTimeout(h.current),m({entry:o,anchorY:e,onSelect:a})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>m(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,t.jsxs)(z,{children:[(0,t.jsxs)(f,{children:[o&&(0,t.jsx)(x,{children:(0,t.jsx)(u,{onClick:b,title:d?"Expand sidebar":"Collapse sidebar",children:(0,t.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("path",{d:"M9 3v18"})]})})}),(0,t.jsx)(T,{}),l&&(0,t.jsx)(w,{children:l}),r&&(0,t.jsx)($,{children:r})]}),(0,t.jsxs)(v,{children:[null!=o&&(0,t.jsx)(k,{collapsed:d,children:(0,t.jsx)(M,{children:o})}),(0,t.jsx)(A,{children:e})]}),g&&(0,t.jsx)(n().Suspense,{fallback:null,children:(0,t.jsx)(y,{activeId:s})})]})})}var B=a(6140);let C=s().div`
  display: grid;
  grid-template-rows: ${({open:o})=>o?"1fr":"0fr"};
...
`;function D({iconKey:o,size:e=16}){if(o&&!(o in B.t))return(0,t.jsx)("span",{style:{fontSize:e,lineHeight:1,display:"flex",alignItems:"center"},children:o});let a=o?B.t[o]:null;return a?(0,t.jsx)(a,{size:e,strokeWidth:1.75}):(0,t.jsxs)("svg",{width:e,height:e,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,t.jsx)("polyline",{points:"14 2 14 8 20 8"})]})}function _({entry:o,activeId:e,onSelect:a}){let[r,n]=(0,i.useState)(o.defaultOpen??!0),{collapsed:l,openFlyout:s,scheduleFlyoutClose:d,cancelFlyoutClose:p}=(0,c.c)();return o.children&&o.children.length>0?(0,t.jsxs)(L,{children:[(0,t.jsxs)(P,{collapsed:l,onClick:()=>{l||n(o=>!o)},onMouseEnter:l?e=>{s(o,e.currentTarget.getBoundingClientRect().top,a)}:void 0,onMouseLeave:l?d:void 0,children:[(0,t.jsxs)(E,{collapsed:l,children:[(0,t.jsx)(D,{iconKey:o.icon,size:16}),(0,t.jsx)(V,{collapsed:l,children:o.name})]}),(0,t.jsx)(I,{open:r,collapsed:l,children:(0,t.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round",children:(0,t.jsx)("path",{d:"M9 6l6 6-6 6"})})})]}),(0,t.jsx)(C,{open:r&&!l,children:(0,t.jsx)(H,{children:(0,t.jsx)(R,{children:o.children.map(o=>(0,t.jsx)(_,{entry:o,activeId:e,onSelect:a},o.id))})})})]}):(0,t.jsxs)(Y,{active:e===o.id,collapsed:l,onClick:()=>a(o),onMouseEnter:l?e=>{let r=e.currentTarget.getBoundingClientRect();s({id:o.id,name:o.name,icon:o.icon,file:o.file,children:[o]},r.top,a)}:void 0,onMouseLeave:l?d:void 0,children:[(0,t.jsx)(D,{iconKey:o.icon,size:15}),(0,t.jsx)(V,{collapsed:l,children:o.name})]})}function K({entries:o,activeId:e,onSelect:a}){return(0,t.jsx)("div",{children:o.map(o=>(0,t.jsx)(_,{entry:o,activeId:e,onSelect:a},o.id))})}let G=(0,d.keyframes)`
...
`,q=(0,d.keyframes)`
  ...
  to   { opacity: 1; transform: scale(1)    translateY(0);   }
`;function Q({title:o,sections:e,topBarRight:a,children:r}){let[n,l]=(0,i.useState)(null),s=(0,i.useCallback)(o=>{l(o.id),document.getElementById(o.id)?.scrollIntoView({behavior:"smooth",block:"start"})},[]),d=(0,t.jsx)(K,{entries:e,activeId:n,onSelect:s});return(0,t.jsx)(F,{title:o,sidebar:d,activeId:n,topBarRight:a,children:r})}s().div`
  position: fixed;
  inset: 0;
