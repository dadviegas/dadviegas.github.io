"use strict";(self.webpackChunk_atlantis_earth=self.webpackChunk_atlantis_earth||[]).push([["512"],{8997(e,t,r){var o=r(2727);t.createRoot=o.createRoot,o.hydrateRoot},3611(e,t,r){var o=r(5723),n=r(7991),i=r.n(n),a=r(8997),s=r(6859),l=r.n(s),d=r(9874),c=r(6455),p=r(8311),u=r(7777),x=r(1112);let f="earth";function h(){return new Set((0,x.xy)().filter(e=>e.defaultEnabled).map(e=>e.id))}let g="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",m=l().div`
  flex: 1;
  min-height: 0;
  height: 100%;
  width: 100%;
