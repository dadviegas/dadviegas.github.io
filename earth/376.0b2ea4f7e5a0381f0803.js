...
`;function N({iconKey:e,size:a=16}){if(e&&!(e in B.t))return(0,r.jsx)("span",{style:{fontSize:a,lineHeight:1,display:"flex",alignItems:"center"},children:e});const n=e?B.t[e]??T.A:T.A;return(0,r.jsx)(n,{size:a,strokeWidth:1.75})}function K({entry:e,activeId:a,onSelect:n}){const[o,i]=(0,t.useState)(e.defaultOpen??!0),{collapsed:l,openFlyout:s,scheduleFlyoutClose:d,cancelFlyoutClose:m}=(0,c.c)();return e.children&&e.children.length>0?(0,r.jsxs)(P,{children:[(0,r.jsxs)(R,{collapsed:l,onClick:()=>{l||i(e=>!e)},onMouseEnter:l?a=>{const o=a.currentTarget.getBoundingClientRect();s(e,o.top,n)}:void 0,onMouseLeave:l?d:void 0,children:[(0,r.jsxs)(I,{collapsed:l,children:[(0,r.jsx)(N,{iconKey:e.icon,size:16}),(0,r.jsx)(_,{collapsed:l,children:e.name})]}),(0,r.jsx)(D,{open:o,collapsed:l,children:(0,r.jsx)(C.A,{size:13})})]}),(0,r.jsx)(E,{open:o&&!l,children:(0,r.jsx)(L,{children:(0,r.jsx)(F,{children:e.children.map(e=>(0,r.jsx)(K,{entry:e,activeId:a,onSelect:n},e.id))})})})]}):(0,r.jsxs)(G,{active:a===e.id,collapsed:l,onClick:()=>n(e),onMouseEnter:l?a=>{const o=a.currentTarget.getBoundingClientRect();s({id:e.id,name:e.name,icon:e.icon,file:e.file,children:[e]},o.top,n)}:void 0,onMouseLeave:l?d:void 0,children:[(0,r.jsx)(N,{iconKey:e.icon,size:15}),(0,r.jsx)(_,{collapsed:l,children:e.name})]})}function H({entries:e,activeId:a,onSelect:n}){return(0,r.jsx)("div",{children:e.map(e=>(0,r.jsx)(K,{entry:e,activeId:a,onSelect:n},e.id))})}const O=l.keyframes`
...
`,n(4914);var V=n(1920),U=n(8607),W=n(8479);i.default.button`
  display: flex;
  align-items: center;
  justify-content: center;
  width: 32px;
