"use strict";(self.webpackChunk_atlantis_techscope=self.webpackChunk_atlantis_techscope||[]).push([[36],{36(e,i,d){d.r(i),d.d(i,{default:()=>m});var a=d(359),s=d(233),l=d(365),n=d(69),t=d(656),r=d(18),c=d(738),o=d(723);const h=[{id:"dashboard",name:"Dashboard",icon:"layout-grid",children:[{id:"live-pulse",name:"Live Pulse",icon:"zap"},{id:"ai-radar",name:"AI Radar",icon:"bot"},{id:"today-in-tech",name:"Today in Tech",icon:"compass"},{id:"experiment-zone",name:"Experiment Zone",icon:"lightbulb"}]}],p=s.default.div`
...
//# sourceMappingURL=36.fa0f43540907e7fdd124.js.map