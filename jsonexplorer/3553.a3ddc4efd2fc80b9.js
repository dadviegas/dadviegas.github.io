...
`,A=s().main`
  ...
  display: flex;
  flex-direction: column;
`,T=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function S(){return(0,r.jsx)(h,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:T.map((o,e)=>(0,r.jsx)(w,{index:e,accent:o.accent,children:o.char},e))})}let j="atlantis:sidebar-collapsed";function F({sidebar:o,children:e,topBarRight:t,title:l="Atlantis",activeId:s=null}){let[d,g]=(0,n.useState)(()=>{try{return"true"===localStorage.getItem(j)}catch{return!1}}),[m,b]=(0,n.useState)(null),h=(0,n.useRef)(),w=()=>g(o=>{let e=!o;try{localStorage.setItem(j,String(e))}catch{}return e}),T=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(a.bind(a,7330)).then(o=>({default:o.FlyoutPanel}))),[]);return(0,r.jsx)(p.I.Provider,{value:{collapsed:d,toggle:w,flyout:m,openFlyout:(o,e,a)=>{clearTimeout(h.current),b({entry:o,anchorY:e,onSelect:a})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>b(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,r.jsxs)(v,{children:[(0,r.jsxs)(f,{children:[o&&(0,r.jsx)(u,{children:(0,r.jsx)(x,{onClick:w,title:d?"Expand sidebar":"Collapse sidebar",children:(0,r.jsx)(c.A,{size:17})})}),(0,r.jsx)(S,{}),l&&(0,r.jsx)(y,{children:l}),t&&(0,r.jsx)($,{children:t})]}),(0,r.jsxs)(z,{children:[null!=o&&(0,r.jsx)(k,{collapsed:d,children:(0,r.jsx)(M,{children:o})}),(0,r.jsx)(A,{children:e})]}),m&&(0,r.jsx)(i().Suspense,{fallback:null,children:(0,r.jsx)(T,{activeId:s})})]})})}s().div`
  display: grid;
...
`;var h=a(2799);let w=(0,h.keyframes)`
