...
`;function p({iconKey:e}){const a=e?c.t[e]??r.A:r.A;return(0,d.jsx)(a,{size:14,strokeWidth:1.75})}function h({entries:e,activeId:a,onSelect:n}){return(0,d.jsx)(d.Fragment,{children:e.map(e=>e.children?(0,d.jsx)(o.Fragment,{children:(0,d.jsx)(h,{entries:e.children,activeId:a,onSelect:n})},e.id):(0,d.jsxs)(g,{active:a===e.id,onClick:()=>n(e),children:[(0,d.jsx)(p,{iconKey:e.icon}),e.name]},e.id))})}function y({activeId:e}){const{flyout:a,scheduleFlyoutClose:n,cancelFlyoutClose:o}=(0,s.c)();if(!a)return null;const t=a.entry.icon?c.t[a.entry.icon]??r.A:r.A;return(0,d.jsxs)(u,{anchorY:a.anchorY,onMouseEnter:o,onMouseLeave:n,children:[(0,d.jsxs)(f,{children:[(0,d.jsx)(t,{size:13,strokeWidth:2}),a.entry.name]}),(0,d.jsx)(h,{entries:a.entry.children??[],activeId:e,onSelect:e=>{a.onSelect(e),n()}})]})}},5959(e,a,n){n.d(a,{I:()=>t,c:()=>i});var o=n(7359);const t=(0,o.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),i=()=>(0,o.useContext)(t)},5185(e,a,n){n.d(a,{t:()=>xe});var o=n(9510),t=n(9038),i=n(7400),r=n(7561),l=n(8207),s=n(7902),c=n(6896),d=n(3013),m=n(2887),u=n(7901),f=n(9848),g=n(2164),p=n(3045),h=n(3775),y=n(3539),x=n(1783),b=n(9416),w=n(1837),z=n(7167),v=n(4494),$=n(2314),A=n(5751),k=n(255),M=n(9633),S=n(2946),j=n(822),T=n(6720),C=n(8456),B=n(3317),E=n(2709),L=n(9301),F=n(8006),P=n(3517),R=n(7032),I=n(6949),_=n(8218),D=n(6829),N=n(5553),G=n(9591),K=n(9923),H=n(2820),O=n(4621),U=n(8479),V=n(2534),W=n(6673),Y=n(7490),Z=n(9033),J=n(5775),q=n(1365),Q=n(2937),X=n(9821),ee=n(5912),ae=n(158),ne=n(8641),oe=n(8607),te=n(3249),ie=n(1821),re=n(5889),le=n(9655),se=n(7170),ce=n(9161),de=n(1849),me=n(1604),ue=n(3142),fe=n(1187),ge=n(7747),pe=n(2932),he=n(4525),ye=n(7230);const xe={activity:c.A,"a-large-small":s.A,apple:d.A,"arrow-right":m.A,"bar-chart-2":o.A,book:f.A,"book-open":u.A,briefcase:p.A,calendar:h.A,clock:x.A,"circle-dot":y.A,cloud:b.A,compass:w.A,cpu:z.A,droplets:v.A,feather:$.A,file:k.A,"file-text":A.A,folder:M.A,"git-branch":S.A,github:j.A,globe:T.A,grid:i.A,hand:C.A,hash:B.A,heart:E.A,key:F.A,hexagon:L.A,home:r.A,landmark:P.A,layers:l.A,"layout-grid":R.A,leaf:I.A,lightbulb:_.A,list:D.A,map:G.A,"map-pin":N.A,"message-circle":K.A,"message-square":H.A,minus:O.A,monitor:U.A,mountain:V.A,package:W.A,palette:Y.A,"pen-tool":Z.A,"pie-chart":t.A,plane:J.A,plus:q.A,ruler:Q.A,shirt:X.A,slash:ee.A,square:ae.A,star:ne.A,sun:oe.A,terminal:te.A,thermometer:ie.A,triangle:re.A,trophy:le.A,truck:se.A,type:ce.A,users:de.A,"volume-2":me.A,watch:ue.A,waves:fe.A,wind:ge.A,wrench:pe.A,x:he.A,zap:ye.A,bot:g.A}},9178(e,a,n){n.d(a,{rh:()=>Z,PE:()=>j,CD:()=>H,MJ:()=>ye,qs:()=>ee,kd:()=>se,$L:()=>q,w3:()=>J,u6:()=>Q,Iu:()=>le,KL:()=>ie,w4:()=>o.w4,mZ:()=>re,fy:()=>we,rz:()=>xe});var o=n(217),t=n(7359),i=n(3233),r=n(5723);i.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,i.default.div`
  position: relative;
`;var l=n(7207),s=n(3661),c=n(5959);const d="260px",m="56px",u=i.default.header`
  display: flex;
  align-items: center;
...
`,A=i.default.main`
  ...
  display: flex;
  flex-direction: column;
`,k=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function M(){return(0,r.jsx)(h,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:k.map((e,a)=>(0,r.jsx)(y,{index:a,accent:e.accent,children:e.char},a))})}const S="atlantis:sidebar-collapsed";function j({sidebar:e,children:a,topBarRight:o,title:i="Atlantis",activeId:l=null}){const[d,m]=(0,t.useState)(()=>{try{return"true"===localStorage.getItem(S)}catch{return!1}}),[p,h]=(0,t.useState)(null),y=(0,t.useRef)(),k=()=>m(e=>{const a=!e;try{localStorage.setItem(S,String(a))}catch{}return a}),j=t.useMemo(()=>t.lazy(()=>Promise.resolve().then(n.bind(n,4914)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(c.I.Provider,{value:{collapsed:d,toggle:k,flyout:p,openFlyout:(e,a,n)=>{clearTimeout(y.current),h({entry:e,anchorY:a,onSelect:n})},scheduleFlyoutClose:()=>{y.current=setTimeout(()=>h(null),160)},cancelFlyoutClose:()=>clearTimeout(y.current)},children:(0,r.jsxs)(z,{children:[(0,r.jsxs)(u,{children:[e&&(0,r.jsx)(f,{children:(0,r.jsx)(g,{onClick:k,title:d?"Expand sidebar":"Collapse sidebar",children:(0,r.jsx)(s.A,{size:17})})}),(0,r.jsx)(M,{}),i&&(0,r.jsx)(x,{children:i}),o&&(0,r.jsx)(b,{children:o})]}),(0,r.jsxs)(w,{children:[null!=e&&(0,r.jsx)(v,{collapsed:d,children:(0,r.jsx)($,{children:e})}),(0,r.jsx)(A,{children:a})]}),p&&(0,r.jsx)(t.Suspense,{fallback:null,children:(0,r.jsx)(j,{activeId:l})})]})})}var T=n(255),C=n(9753),B=n(5185);const E=i.default.div`
  display: grid;
...
`;function G({iconKey:e,size:a=16}){if(e&&!(e in B.t))return(0,r.jsx)("span",{style:{fontSize:a,lineHeight:1,display:"flex",alignItems:"center"},children:e});const n=e?B.t[e]??T.A:T.A;return(0,r.jsx)(n,{size:a,strokeWidth:1.75})}function K({entry:e,activeId:a,onSelect:n}){const[o,i]=(0,t.useState)(e.defaultOpen??!0),{collapsed:l,openFlyout:s,scheduleFlyoutClose:d,cancelFlyoutClose:m}=(0,c.c)();return e.children&&e.children.length>0?(0,r.jsxs)(P,{children:[(0,r.jsxs)(R,{collapsed:l,onClick:()=>{l||i(e=>!e)},onMouseEnter:l?a=>{const o=a.currentTarget.getBoundingClientRect();s(e,o.top,n)}:void 0,onMouseLeave:l?d:void 0,children:[(0,r.jsxs)(I,{collapsed:l,children:[(0,r.jsx)(G,{iconKey:e.icon,size:16}),(0,r.jsx)(_,{collapsed:l,children:e.name})]}),(0,r.jsx)(D,{open:o,collapsed:l,children:(0,r.jsx)(C.A,{size:13})})]}),(0,r.jsx)(E,{open:o&&!l,children:(0,r.jsx)(L,{children:(0,r.jsx)(F,{children:e.children.map(e=>(0,r.jsx)(K,{entry:e,activeId:a,onSelect:n},e.id))})})})]}):(0,r.jsxs)(N,{active:a===e.id,collapsed:l,onClick:()=>n(e),onMouseEnter:l?a=>{const o=a.currentTarget.getBoundingClientRect();s({id:e.id,name:e.name,icon:e.icon,file:e.file,children:[e]},o.top,n)}:void 0,onMouseLeave:l?d:void 0,children:[(0,r.jsx)(G,{iconKey:e.icon,size:15}),(0,r.jsx)(_,{collapsed:l,children:e.name})]})}function H({entries:e,activeId:a,onSelect:n}){return(0,r.jsx)("div",{children:e.map(e=>(0,r.jsx)(K,{entry:e,activeId:a,onSelect:n},e.id))})}const O=l.keyframes`
...
`,n(4914);var U=n(1920),V=n(8607),W=n(8479);i.default.button`
  display: flex;
  align-items: center;
  justify-content: center;
  width: 32px;
...
`,he=i.default.div`
  ...
  color: ${o.w4.colors.sidebarTextMuted};
  font-family: ${o.w4.typography.fontFamily};
`;function ye({onSave:e,onUpdate:a,onCancel:n,existingDoc:o}){const[i,l]=(0,t.useState)(o?.name??""),s=(0,t.useRef)(null);return(0,t.useEffect)(()=>{s.current?.focus(),o&&s.current?.select()},[o]),(0,r.jsx)(ce,{onClick:n,children:(0,r.jsxs)(de,{onClick:e=>e.stopPropagation(),children:[(0,r.jsx)(me,{children:"Save document"}),o&&a&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(he,{children:"Update the current version or save as a new one."}),(0,r.jsxs)(fe,{children:[(0,r.jsx)(ge,{onClick:n,children:"Cancel"}),(0,r.jsxs)(ge,{danger:!0,onClick:a,children:['Update "',o.name,'"']})]}),(0,r.jsx)(pe,{})]}),(0,r.jsx)(ue,{ref:s,value:i,onChange:e=>l(e.target.value),onKeyDown:t=>{"Enter"===t.key&&i.trim()&&(o&&i.trim()===o.name&&a?a():e(i.trim())),"Escape"===t.key&&n()},placeholder:o?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,r.jsxs)(fe,{children:[!o&&(0,r.jsx)(ge,{onClick:n,children:"Cancel"}),(0,r.jsx)(ge,{primary:!0,disabled:!i.trim(),onClick:()=>e(i.trim()),children:"Save as new"})]})]})})}function xe(e,a=8){const[n,o]=(0,t.useState)(()=>function(e){try{return JSON.parse(localStorage.getItem(e)??"[]")}catch{return[]}}(e));return{recent:n,addRecent:(0,t.useCallback)(n=>{o(o=>{const t=[n,...o.filter(e=>e!==n)].slice(0,a);return function(e,a){try{localStorage.setItem(e,JSON.stringify(a))}catch{}}(e,t),t})},[e,a])}}function be(){const e="undefined"!=typeof window?window.location.hash:"",a=e.indexOf("?");if(-1===a)return{};const n={};for(const o of e.slice(a+1).split("&")){if(!o)continue;const e=o.indexOf("=");-1===e?n[decodeURIComponent(o)]="":n[decodeURIComponent(o.slice(0,e))]=decodeURIComponent(o.slice(e+1))}return n}function we(){const[e,a]=(0,t.useState)(be);return(0,t.useEffect)(()=>{const e=()=>a(be());return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[]),e}i.default.div`
  position: relative;
`,i.default.button`
  display: flex;
  align-items: center;
...
`;i.default.div`
  ...
  background: ${o.w4.colors.mainBg};
  font-family: ${o.w4.typography.fontFamily};
  animation: ${ze} 0.4s ease 0.15s both;
`,i.default.div`
  position: relative;
  width: 56px;
  height: 56px;
...
`,i.default.div`
  position: absolute;
  inset: 0;
  animation: ${ve} 1.4s cubic-bezier(0.4, 0, 0.2, 1) infinite;
...
`,i.default.div`
  ...
  letter-spacing: 0.06em;
  text-transform: uppercase;
  padding: ${o.w4.spacing.xs} ${o.w4.spacing.md};
  margin-bottom: 4px;
  white-space: nowrap;
  overflow: hidden;
  text-overflow: ellipsis;
...
`,i.default.button`
  ...
  color: ${({active:e})=>e?o.w4.colors.accent:o.w4.colors.sidebarText};
  font-family: ${o.w4.typography.fontFamily};
  font-size: ${o.w4.typography.fontSizeSm};
  font-weight: ${({active:e})=>e?"600":"400"};
  cursor: pointer;
