"use strict";(self.webpackChunk_atlantis_playground=self.webpackChunk_atlantis_playground||[]).push([["8714"],{676(o,e,t){t.d(e,{A:()=>u});var a=t(5723),r=t(7991),n=t(7410),i=t(6030),l=t(1861),s=t(6004),d=t(5099),c=t(9194),p=t(6880),g=t(9282),m=t(5726);let f=n.Lz.theme({"&":{flex:"1",minHeight:"0",height:"100%",fontSize:"13px",fontFamily:"'JetBrains Mono', 'Fira Code', 'Cascadia Code', 'Consolas', monospace",background:m.w4.colors.mainBg},".cm-scroller":{overflow:"auto",lineHeight:"1.7",fontFamily:"inherit"},".cm-content":{padding:"16px",caretColor:m.w4.colors.accent},".cm-gutters":{background:m.w4.colors.mainBg,border:"none",borderRight:`1px solid ${m.w4.colors.border}`,color:m.w4.colors.sidebarTextMuted},".cm-activeLineGutter":{background:"transparent"},".cm-activeLine":{background:"rgba(88,166,255,0.04)"},".cm-selectionBackground, ::selection":{background:"rgba(88,166,255,0.2) !important"},".cm-cursor":{borderLeftColor:m.w4.colors.accent},"&::-webkit-scrollbar":{width:"6px",height:"6px"},"&::-webkit-scrollbar-track":{background:"transparent"},"&::-webkit-scrollbar-thumb":{background:m.w4.colors.border,borderRadius:"3px"}});function u({value:o,onChange:e,lang:t}){let m=(0,r.useRef)(null),x=(0,r.useRef)(null),b=(0,r.useRef)(e);return b.current=e,(0,r.useEffect)(()=>{if(!m.current)return;let e=new n.Lz({state:l.$t.create({doc:o,extensions:[i.oQ,s.bM,f,function(o){switch(o){case"html":return(0,d.qy)();case"css":return(0,c.AH)();case"ts":return(0,p.Q2)({typescript:!0});case"react":return(0,p.Q2)({jsx:!0,typescript:!0});default:return(0,p.Q2)()}}(t),n.w4.of([g.Yc]),n.Lz.updateListener.of(o=>{o.docChanged&&b.current(o.state.doc.toString())})]}),parent:m.current});return x.current=e,()=>{e.destroy(),x.current=null}},[t]),(0,r.useEffect)(()=>{let e=x.current;if(!e)return;let t=e.state.doc.toString();t!==o&&e.dispatch({changes:{from:0,to:t.length,insert:o}})},[o]),(0,a.jsx)("div",{ref:m,style:{flex:1,minHeight:0,overflow:"hidden",display:"flex",flexDirection:"column"}})}},5151(o,e,t){t.d(e,{k:()=>a});let a=[{label:"Hello World",html:`<h1>Hello, World!</h1>
      ...
      <ul>
        {todos.map(todo => (
          <li key={todo.id} className={todo.done ? 'done' : ''}>
            ...
            <span className="del" onClick={() => remove(todo.id)}>\xd7</span>
          </li>
        ))}
      </ul>
...
ReactDOM.createRoot(document.getElementById('root')!).render(<App />);`}]},7330(o,e,t){t.d(e,{FlyoutPanel:()=>oR});var a=t(5723),r=t(7991),n=t.n(r),i=t(6859),l=t.n(i),s=t(2799),d=t(255),c=t(1316),p=t(814),g=t(6896),m=t(7902),f=t(3013),u=t(2887),x=t(9510),b=t(9848),h=t(7901),w=t(3045),y=t(3775),$=t(1783),v=t(3539),z=t(9416),k=t(1837),M=t(7167),A=t(4494),T=t(2314),S=t(5751),j=t(9633),F=t(2946),B=t(822),C=t(6720),R=t(7400),E=t(8456),P=t(3317),L=t(2709),H=t(8006),D=t(9301),I=t(7561),N=t(3517),K=t(8207),Y=t(7032),V=t(6949),G=t(8218),_=t(6829),O=t(9591),W=t(5553),J=t(9923),U=t(2820),q=t(4621),Z=t(8479),X=t(2534),Q=t(6673),oo=t(7490),oe=t(9033),ot=t(9038),oa=t(5775),or=t(1365),on=t(2937),oi=t(9821),ol=t(5912),os=t(158),od=t(8641),oc=t(8607),op=t(3249),og=t(1821),om=t(5889),of=t(9655),ou=t(7170),ox=t(9161),ob=t(1849),oh=t(1604),ow=t(3142),oy=t(1187),o$=t(7747),ov=t(2932),oz=t(4525),ok=t(7230),oM=t(2164);let oA={activity:g.A,"a-large-small":m.A,apple:f.A,"arrow-right":u.A,"bar-chart-2":x.A,book:b.A,"book-open":h.A,briefcase:w.A,calendar:y.A,clock:$.A,"circle-dot":v.A,cloud:z.A,compass:k.A,cpu:M.A,droplets:A.A,feather:T.A,file:d.A,"file-text":S.A,folder:j.A,"git-branch":F.A,github:B.A,globe:C.A,grid:R.A,hand:E.A,hash:P.A,heart:L.A,key:H.A,hexagon:D.A,home:I.A,landmark:N.A,layers:K.A,"layout-grid":Y.A,leaf:V.A,lightbulb:G.A,list:_.A,map:O.A,"map-pin":W.A,"message-circle":J.A,"message-square":U.A,minus:q.A,monitor:Z.A,mountain:X.A,package:Q.A,palette:oo.A,"pen-tool":oe.A,"pie-chart":ot.A,plane:oa.A,plus:or.A,ruler:on.A,shirt:oi.A,slash:ol.A,square:os.A,star:od.A,sun:oc.A,terminal:op.A,thermometer:og.A,triangle:om.A,trophy:of.A,truck:ou.A,type:ox.A,users:ob.A,"volume-2":oh.A,watch:ow.A,waves:oy.A,wind:o$.A,wrench:ov.A,x:oz.A,zap:ok.A,bot:oM.A},oT=(0,s.keyframes)`
...
`;function oB({iconKey:o}){let e=o?oA[o]??d.A:d.A;return(0,a.jsx)(e,{size:14,strokeWidth:1.75})}function oC({entries:o,activeId:e,onSelect:t}){return(0,a.jsx)(a.Fragment,{children:o.map(o=>o.children?(0,a.jsx)(n().Fragment,{children:(0,a.jsx)(oC,{entries:o.children,activeId:e,onSelect:t})},o.id):(0,a.jsxs)(oF,{active:e===o.id,onClick:()=>t(o),children:[(0,a.jsx)(oB,{iconKey:o.icon}),o.name]},o.id))})}function oR({activeId:o}){let{flyout:e,scheduleFlyoutClose:t,cancelFlyoutClose:r}=(0,p.c)();if(!e)return null;let n=e.entry.icon?oA[e.entry.icon]??d.A:d.A;return(0,a.jsxs)(oS,{anchorY:e.anchorY,onMouseEnter:r,onMouseLeave:t,children:[(0,a.jsxs)(oj,{children:[(0,a.jsx)(n,{size:13,strokeWidth:2}),e.entry.name]}),(0,a.jsx)(oC,{entries:e.entry.children??[],activeId:o,onSelect:o=>{e.onSelect(o),t()}})]})}},814(o,e,t){t.d(e,{I:()=>r,c:()=>n});var a=t(7991);let r=(0,a.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),n=()=>(0,a.useContext)(r)},5726(o,e,t){t.d(e,{PL:()=>N,MJ:()=>U,mZ:()=>D,KL:()=>H,cL:()=>p.c,Is:()=>I,UO:()=>og,PE:()=>B,w4:()=>a.w4});var a=t(1316),r=t(5723),n=t(7991),i=t.n(n),l=t(6859),s=t.n(l);s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,s().div`
  position: relative;
`;var d=t(2799),c=t(3661),p=t(814);let g="260px",m="56px",f="48px",u=s().header`
  display: flex;
  align-items: center;
...
`,T=s().main`
  ...
  display: flex;
  flex-direction: column;
`,S=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function j(){return(0,r.jsx)(w,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:S.map((o,e)=>(0,r.jsx)(y,{index:e,accent:o.accent,children:o.char},e))})}let F="atlantis:sidebar-collapsed";function B({sidebar:o,children:e,topBarRight:a,title:l="Atlantis",activeId:s=null}){let[d,g]=(0,n.useState)(()=>{try{return"true"===localStorage.getItem(F)}catch{return!1}}),[m,f]=(0,n.useState)(null),h=(0,n.useRef)(),w=()=>g(o=>{let e=!o;try{localStorage.setItem(F,String(e))}catch{}return e}),y=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(t.bind(t,7330)).then(o=>({default:o.FlyoutPanel}))),[]);return(0,r.jsx)(p.I.Provider,{value:{collapsed:d,toggle:w,flyout:m,openFlyout:(o,e,t)=>{clearTimeout(h.current),f({entry:o,anchorY:e,onSelect:t})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>f(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,r.jsxs)(k,{children:[(0,r.jsxs)(u,{children:[o&&(0,r.jsx)(x,{children:(0,r.jsx)(b,{onClick:w,title:d?"Expand sidebar":"Collapse sidebar",children:(0,r.jsx)(c.A,{size:17})})}),(0,r.jsx)(j,{}),l&&(0,r.jsx)($,{children:l}),a&&(0,r.jsx)(v,{children:a})]}),(0,r.jsxs)(z,{children:[null!=o&&(0,r.jsx)(M,{collapsed:d,children:(0,r.jsx)(A,{children:o})}),(0,r.jsx)(T,{children:e})]}),m&&(0,r.jsx)(i().Suspense,{fallback:null,children:(0,r.jsx)(y,{activeId:s})})]})})}s().div`
  display: grid;
...
`,s().button`
  ...
  align-items: center;
  width: 100%;
  padding: ${({collapsed:o})=>o?"10px 0":`${a.w4.spacing.sm} ${a.w4.spacing.md}`};
  justify-content: ${({collapsed:o})=>o?"center":"space-between"};
  gap: ${({collapsed:o})=>o?"0":a.w4.spacing.sm};
  background: none;
  border: none;
  cursor: pointer;
  color: ${a.w4.colors.sidebarTextMuted};
...
`,s().button`
  ...
  align-items: center;
  width: 100%;
  padding: ${({collapsed:o})=>o?"9px 0":`7px ${a.w4.spacing.md}`};
  justify-content: ${({collapsed:o})=>o?"center":"flex-start"};
  gap: ${({collapsed:o})=>o?"0":"8px"};
  background: ${({active:o})=>o?a.w4.colors.accentMuted:"none"};
  border: none;
  border-left: ${({collapsed:o})=>o?"none":"2px"} solid
    ${({active:o})=>o?a.w4.colors.sidebarActive:"transparent"};
  cursor: pointer;
  color: ${({active:o})=>o?a.w4.colors.sidebarActive:a.w4.colors.sidebarText};
  font-size: ${a.w4.typography.fontSizeBase};
  font-weight: ${({active:o})=>o?"600":"400"};
  font-family: ${a.w4.typography.fontFamily};
  text-align: left;
  border-radius: ${({collapsed:o})=>o?"0":`0 ${a.w4.borderRadius.md} ${a.w4.borderRadius.md} 0`};
...
`,O=s().button`
  ...
  border-radius: 20px;
  background: ${({primary:o,danger:e})=>e?"rgba(248,81,73,0.12)":o?a.w4.colors.accent:"none"};
  color: ${({primary:o,danger:e})=>e?a.w4.colors.danger:o?"#fff":a.w4.colors.mainText};
  border: 1px solid ${({primary:o,danger:e})=>e?a.w4.colors.danger:o?a.w4.colors.accent:a.w4.colors.border};
...
`,J=s().div`
  ...
  color: ${a.w4.colors.sidebarTextMuted};
  font-family: ${a.w4.typography.fontFamily};
`;function U({onSave:o,onUpdate:e,onCancel:t,existingDoc:a}){let[i,l]=(0,n.useState)(a?.name??""),s=(0,n.useRef)(null);return(0,n.useEffect)(()=>{s.current?.focus(),a&&s.current?.select()},[a]),(0,r.jsx)(K,{onClick:t,children:(0,r.jsxs)(Y,{onClick:o=>o.stopPropagation(),children:[(0,r.jsx)(V,{children:"Save document"}),a&&e&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(J,{children:"Update the current version or save as a new one."}),(0,r.jsxs)(_,{children:[(0,r.jsx)(O,{onClick:t,children:"Cancel"}),(0,r.jsxs)(O,{danger:!0,onClick:e,children:['Update "',a.name,'"']})]}),(0,r.jsx)(W,{})]}),(0,r.jsx)(G,{ref:s,value:i,onChange:o=>l(o.target.value),onKeyDown:r=>{"Enter"===r.key&&i.trim()&&(a&&i.trim()===a.name&&e?e():o(i.trim())),"Escape"===r.key&&t()},placeholder:a?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,r.jsxs)(_,{children:[!a&&(0,r.jsx)(O,{onClick:t,children:"Cancel"}),(0,r.jsx)(O,{primary:!0,disabled:!i.trim(),onClick:()=>o(i.trim()),children:"Save as new"})]})]})})}let q=(0,d.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,Z=(0,d.keyframes)`
...
`,s().div`
  background: ${a.w4.colors.sidebarBg};
  border: 1px solid ${({danger:o})=>o?a.w4.colors.danger+"55":a.w4.colors.sidebarBorder};
  border-radius: ${a.w4.borderRadius.lg};
  padding: 24px;
  width: 400px;
  max-width: 100%;
...
`,s().div`
  font-size: ${a.w4.typography.fontSizeMd};
  font-weight: 700;
  color: ${({danger:o})=>o?a.w4.colors.danger:a.w4.colors.mainText};
  font-family: ${a.w4.typography.fontFamily};
`,s().div`
  font-size: ${a.w4.typography.fontSizeBase};
  line-height: 1.5;
...
`,s().button`
  ...
  background: ${({primary:o,danger:e})=>e?a.w4.colors.danger:o?a.w4.colors.accent:"transparent"};
  color: ${({primary:o,danger:e})=>e||o?"#fff":a.w4.colors.mainText};
  border: 1px solid
    ${({primary:o,danger:e})=>e?a.w4.colors.danger:o?a.w4.colors.accent:a.w4.colors.border};

  &:hover { opacity: 0.88; }
  &:focus-visible { ${a.w4.focusRing} }
`;var X=t(5625),Q=t(679),oo=t(4872);let oe=s().div`
  position: relative;
`,ot=s().button`
  display: flex;
  align-items: center;
...
`;function og({appId:o,onLoad:e}){let[t,a]=(0,n.useState)(!1),[i,l]=(0,n.useState)([]),s=(0,n.useRef)(null),d=(0,n.useCallback)(()=>{L.listDocs(o).then(l).catch(()=>{})},[o]);(0,n.useEffect)(()=>{if(!t)return;d();let o=o=>{s.current&&!s.current.contains(o.target)&&a(!1)};return document.addEventListener("mousedown",o),()=>document.removeEventListener("mousedown",o)},[t,d]);let c=async(o,e)=>{o.stopPropagation(),await L.deleteDoc(e),l(o=>o.filter(o=>o.id!==e))};return(0,r.jsxs)(oe,{ref:s,children:[(0,r.jsxs)(ot,{onClick:()=>a(o=>!o),children:[(0,r.jsx)(X.A,{size:14}),"Saved",(0,r.jsx)(Q.A,{size:13,style:{marginLeft:2}})]}),(0,r.jsxs)(oa,{open:t,children:[(0,r.jsx)(or,{children:"Saved versions"}),(0,r.jsx)(on,{children:0===i.length?(0,r.jsx)(oi,{children:"No saved documents yet."}):i.map(o=>{var t;return(0,r.jsxs)(ol,{children:[(0,r.jsxs)(os,{onClick:()=>{e(o.content,o.id,o.name),a(!1)},children:[(0,r.jsx)(od,{children:o.name}),(0,r.jsx)(oc,{children:(t=o.savedAt,new Intl.DateTimeFormat(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}).format(new Date(t)))})]}),(0,r.jsx)(op,{onClick:e=>c(e,o.id),title:"Delete",children:(0,r.jsx)(oo.A,{size:13})})]},o.id)})})]})]})}s().div`
...
`;s().div`
  ...
  background: ${a.w4.colors.mainBg};
  font-family: ${a.w4.typography.fontFamily};
  animation: ${om} 0.4s ease 0.15s both;
`,s().div`
  position: relative;
  width: 56px;
  height: 56px;
...
`,s().div`
  position: absolute;
  inset: 0;
  animation: ${of} 1.4s cubic-bezier(0.4, 0, 0.2, 1) infinite;
...
`,h=n().forwardRef(function({variant:o="ghost",size:e="md",icon:t,iconRight:r,children:n,...i},l){return(0,a.jsxs)(b,{ref:l,variant:o,size:e,...i,children:[t,n,r]})}),w={default:s.w4.colors.accent,danger:"#f85149"},y={default:s.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"},$=l().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`,v=n().forwardRef(function({active:o=!1,shape:e="square",tone:t="default",children:r,...n},i){return(0,a.jsx)($,{ref:i,active:o,shape:e,tone:t,...n,children:r})}),z=l().div`
  position: relative;
  display: inline-flex;
`,k=l().div`
  position: absolute;
  ...
  z-index: 2000;
  overflow: hidden;
`;function M({trigger:o,children:e,align:t="right",open:i,onOpenChange:l}){let[s,d]=(0,r.useState)(!1),c=i??s,p=o=>{l&&l(o),void 0===i&&d(o)},g=(0,r.useRef)(null);(0,r.useEffect)(()=>{if(!c)return;let o=o=>{g.current&&!g.current.contains(o.target)&&p(!1)};return document.addEventListener("mousedown",o),()=>document.removeEventListener("mousedown",o)},[c]);let m=n().cloneElement(o,{onClick:e=>{o.props.onClick?.(e),p(!c)},"aria-expanded":c,"aria-haspopup":"menu"});return(0,a.jsxs)(z,{ref:g,children:[m,c&&(0,a.jsx)(k,{align:t,role:"menu",children:e})]})}let A=l().button`
  display: flex;
  align-items: center;
  gap: 10px;
  padding: 8px 12px;
...
`,t(2727);var S=t(2799);let j=(0,S.keyframes)`
...
`,l().span`
  ...
  background: ${({color:o})=>o};
  display: inline-block;
`;let I={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:s.w4.colors.accentMuted},N={neutral:s.w4.colors.mainTextMuted,live:s.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:s.w4.colors.accent};l().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${s.w4.typography.fontFamilyMono};
...
`,G.A,G.A['pre[class*="language-"]'],s.w4.colors.codeBg,G.A['code[class*="language-"]'],l().div`
  background: ${({bg:o})=>o};
...
`;function Q({activeAppId:o}){let{collapsed:e}=(0,s.cL)(),[t]=function(){let[o,e]=(0,r.useState)(E),t=(0,r.useCallback)(o=>{e(o);try{localStorage.setItem(B,o)}catch{}(0,s.Is)(C,o).catch(()=>{}),window.dispatchEvent(new CustomEvent("atlantis:locale-change",{detail:o}))},[]);return(0,r.useEffect)(()=>{let o=o=>{e(o.detail)};return window.addEventListener("atlantis:locale-change",o),()=>window.removeEventListener("atlantis:locale-change",o)},[]),(0,r.useEffect)(()=>{(0,s.PL)(C).then(t=>{if(R(t)&&t!==o){try{localStorage.setItem(B,t)}catch{}e(t)}}).catch(()=>{})},[]),[o,t]}(),n=(0,r.useMemo)(()=>(o,e)=>{let a=F[o]?.[t]??o;return e?Object.entries(e).reduce((o,[e,t])=>o.replace(RegExp(`\\{${e}\\}`,"g"),String(t)),a):a},[t]),i=(0,r.useRef)(null),l=o=>{i.current!==o&&(i.current=o,document.activeElement?.blur(),window.location.hash=o,setTimeout(()=>{i.current=null},50))};return(0,a.jsxs)(J,{children:[(0,a.jsx)(U,{collapsed:e,children:n("devtools.heading")}),W.map(t=>{let r=n(t.labelKey);return(0,a.jsxs)(q,{active:o===t.id,collapsed:e,onPointerDown:o=>{0===o.button&&l(t.hash)},onClick:()=>l(t.hash),title:r,children:[(0,a.jsx)(Z,{children:(0,a.jsx)(L,{name:t.icon,size:16})}),(0,a.jsx)(X,{collapsed:e,children:r})]},t.id)})]})}}}]);