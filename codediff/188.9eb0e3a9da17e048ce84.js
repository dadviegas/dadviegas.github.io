...
`,N=t.default.div`
  ...
  color: ${d.w4.colors.mainTextMuted};
  font-size: 13px;
`;function O({topBarRight:e}){const[o,i]=(0,n.useState)(p.k[0].original),[r,t]=(0,n.useState)(p.k[0].modified),[O,P]=(0,n.useState)(!1),[_,H]=(0,n.useState)(!1),[J,D]=(0,n.useState)(null),I=(0,n.useRef)(null);(0,n.useEffect)(()=>{const e=e=>{I.current&&!I.current.contains(e.target)&&P(!1)};return document.addEventListener("mousedown",e),()=>document.removeEventListener("mousedown",e)},[]);const K=(0,n.useMemo)(()=>(0,c.P)(o,r),[o,r]),U=(0,n.useMemo)(()=>(0,c.h)(K),[K]);return(0,f.jsxs)(x,{children:[(0,f.jsxs)(g,{children:[(0,f.jsxs)(h,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:["Atl",(0,f.jsx)("span",{children:"antis"})]}),(0,f.jsx)(u,{children:"/"}),(0,f.jsx)(m,{children:"Code Diff"}),(0,f.jsxs)(w,{kind:"add",children:["+",U.added]}),(0,f.jsxs)(w,{kind:"del",children:["−",U.removed]}),(0,f.jsxs)(w,{kind:"mod",children:["~",U.changed]}),(0,f.jsx)(b,{}),(0,f.jsx)(d.UO,{appId:"codediff",onLoad:(e,o,n)=>{D(o&&n?{id:o,name:n}:null);try{const{original:o,modified:n}=JSON.parse(e);void 0!==o&&i(o),void 0!==n&&t(n)}catch{}}}),(0,f.jsxs)(y,{onClick:()=>H(!0),children:[(0,f.jsx)(a.A,{size:14}),"Save"]}),(0,f.jsxs)(k,{ref:I,children:[(0,f.jsxs)($,{onClick:()=>P(e=>!e),children:["Examples ",(0,f.jsx)(l.A,{size:12})]}),O&&(0,f.jsx)(j,{children:p.k.map(e=>(0,f.jsx)(v,{onClick:()=>{i(e.original),t(e.modified),P(!1)},children:e.label},e.label))})]}),e]}),_&&(0,f.jsx)(d.MJ,{onSave:async e=>{H(!1),await(0,d.KL)("codediff",e,JSON.stringify({original:o,modified:r})),D(null)},onCancel:()=>H(!1)}),(0,f.jsxs)(z,{children:[(0,f.jsxs)(T,{children:[(0,f.jsxs)(C,{children:[(0,f.jsx)(M,{children:"Original"}),(0,f.jsx)(S,{value:o,onChange:e=>i(e.target.value),placeholder:"Paste original text here…",spellCheck:!1})]}),(0,f.jsxs)(C,{children:[(0,f.jsx)(M,{children:"Modified"}),(0,f.jsx)(S,{value:r,onChange:e=>t(e.target.value),placeholder:"Paste modified text here…",spellCheck:!1})]})]}),(0,f.jsx)(B,{children:0===K.length?(0,f.jsxs)(N,{children:[(0,f.jsx)(s.A,{size:32,strokeWidth:1}),(0,f.jsx)("span",{children:"Paste text in both panes to see the diff"})]}):(0,f.jsx)(R,{children:(0,f.jsx)("tbody",{children:K.map((e,o)=>{return(0,f.jsxs)(L,{kind:e.type,children:[(0,f.jsx)(F,{children:e.oldNum??" "}),(0,f.jsx)(F,{children:e.newNum??" "}),(0,f.jsx)(E,{kind:e.type,children:(i=e.type,"insert"===i?"+":"delete"===i?"−":"replace"===i?"~":" ")}),(0,f.jsx)(A,{children:"replace"===e.type?(0,f.jsxs)(f.Fragment,{children:[(0,f.jsx)("span",{style:{background:"rgba(248,113,113,0.2)",borderRadius:2,textDecoration:"line-through",opacity:.7,marginRight:4},children:e.oldLine}),(0,f.jsx)("span",{style:{background:"rgba(63,185,80,0.2)",borderRadius:2},children:e.newLine})]}):"delete"===e.type?e.oldLine:e.newLine??e.oldLine})]},o);var i})})})})]})]})}const P=document.getElementById("root");if(!P)throw new Error("Root element #root not found");(0,r.H)(P).render((0,f.jsx)(O,{}))},8997(e,o,i){var n=i(8991);o.H=n.createRoot,n.hydrateRoot}}]);
//# sourceMappingURL=188.9eb0e3a9da17e048ce84.js.map