"use strict";(self.webpackChunk_atlantis_playground=self.webpackChunk_atlantis_playground||[]).push([[868],{4914(n,e,o){o.d(e,{FlyoutPanel:()=>b});var a=o(7359),t=o(3233),i=o(7207),r=o(255),l=o(217),s=o(5959),d=o(5185),c=o(8104);const m=i.keyframes`
...
`,i.default.div`
  position: relative;
`;var l=o(7207);o(5959);const s="260px",d="56px",c=(i.default.header`
  display: flex;
  align-items: center;
  height: ${"48px"};
...
`,i.default.span`
  ...
  animation: ${c} 10s ease ${({index:n})=>.07*n}s infinite;
...
`,i.default.div`
  ...
  overflow: hidden;
`,i.default.aside`
  width: ${({collapsed:n})=>n?d:s};
  min-width: ${({collapsed:n})=>n?d:s};
  background: ${a.w4.colors.sidebarBg};
  border-right: 1px solid ${a.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,o(4914);var u=o(1920),g=o(8607),p=o(8479);i.default.button`
  display: flex;
  align-items: center;
  justify-content: center;
  width: 32px;
...
`,T=i.default.div`
  ...
  color: ${a.w4.colors.sidebarTextMuted};
  font-family: ${a.w4.typography.fontFamily};
`;function B({onSave:n,onUpdate:e,onCancel:o,existingDoc:a}){const[i,l]=(0,t.useState)(a?.name??""),s=(0,t.useRef)(null);return(0,t.useEffect)(()=>{s.current?.focus(),a&&s.current?.select()},[a]),(0,r.jsx)(w,{onClick:o,children:(0,r.jsxs)(v,{onClick:n=>n.stopPropagation(),children:[(0,r.jsx)(k,{children:"Save document"}),a&&e&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(T,{children:"Update the current version or save as a new one."}),(0,r.jsxs)($,{children:[(0,r.jsx)(S,{onClick:o,children:"Cancel"}),(0,r.jsxs)(S,{danger:!0,onClick:e,children:['Update "',a.name,'"']})]}),(0,r.jsx)(M,{})]}),(0,r.jsx)(A,{ref:s,value:i,onChange:n=>l(n.target.value),onKeyDown:t=>{"Enter"===t.key&&i.trim()&&(a&&i.trim()===a.name&&e?e():n(i.trim())),"Escape"===t.key&&o()},placeholder:a?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,r.jsxs)($,{children:[!a&&(0,r.jsx)(S,{onClick:o,children:"Cancel"}),(0,r.jsx)(S,{primary:!0,disabled:!i.trim(),onClick:()=>n(i.trim()),children:"Save as new"})]})]})})}var j=o(8006),C=o(679),E=o(4872);const P=i.default.div`
  position: relative;
`,R=i.default.button`
  display: flex;
  align-items: center;
...
`;function _({appId:n,onLoad:e}){const[o,a]=(0,t.useState)(!1),[i,l]=(0,t.useState)([]),s=(0,t.useRef)(null),d=(0,t.useCallback)(()=>{(function(n){return x.listDocs(n)})(n).then(l).catch(()=>{})},[n]);(0,t.useEffect)(()=>{if(!o)return;d();const n=n=>{s.current&&!s.current.contains(n.target)&&a(!1)};return document.addEventListener("mousedown",n),()=>document.removeEventListener("mousedown",n)},[o,d]);return(0,r.jsxs)(P,{ref:s,children:[(0,r.jsxs)(R,{onClick:()=>a(n=>!n),children:[(0,r.jsx)(j.A,{size:14}),"Saved",(0,r.jsx)(C.A,{size:13,style:{marginLeft:2}})]}),(0,r.jsxs)(L,{open:o,children:[(0,r.jsx)(D,{children:"Saved versions"}),(0,r.jsx)(N,{children:0===i.length?(0,r.jsx)(I,{children:"No saved documents yet."}):i.map(n=>{return(0,r.jsxs)(F,{children:[(0,r.jsxs)(K,{onClick:()=>{e(n.content,n.id,n.name),a(!1)},children:[(0,r.jsx)(H,{children:n.name}),(0,r.jsx)(G,{children:(o=n.savedAt,new Intl.DateTimeFormat(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}).format(new Date(o)))})]}),(0,r.jsx)(Y,{onClick:e=>(async(n,e)=>{n.stopPropagation(),await function(n){return x.deleteDoc(n)}(e),l(n=>n.filter(n=>n.id!==e))})(e,n.id),title:"Delete",children:(0,r.jsx)(E.A,{size:13})})]},n.id);var o})})]})]})}i.default.div`
