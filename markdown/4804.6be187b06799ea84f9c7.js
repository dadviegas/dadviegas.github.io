"use strict";(self.webpackChunk_atlantis_markdown=self.webpackChunk_atlantis_markdown||[]).push([[4804],{80264(e,o,a){a.d(o,{WO:()=>Da});var t=a(27359),n=a(217),i=a(53233),r=a(65723);i.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,ba=i.default.div`
  ...
  font-size: ${n.w4.typography.fontSizeSm};
  text-align: center;
`;function wa(e){return e.toLowerCase().replace(/[*_`[\]()#]/g,"").replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-").trim()}const za=new Map;function $a(e){return e.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,"")}function va(e,o=""){return e.flatMap(e=>e.children?va(e.children,e.name):e.file?[{entry:e,parentName:o}]:[])}function ka(e,o){const a=$a(e),t=$a(o),n=e.split("\n");let i=0,r=0;for(;-1!==(r=a.indexOf(t,r));)i++,r+=t.length;let l=null;for(const e of n){const a=e.match(/^#{1,4}\s+(.+)/);if(a&&(l=a[1].trim()),!e.trim()||e.startsWith("```")||e.startsWith("|--"))continue;const n=e.replace(/^#{1,6}\s*/,"").replace(/[*_`|]/g,"").trim(),r=n.normalize("NFD"),s=[];let c=0;for(let e=0;e<r.length;e++){const o=r.charCodeAt(e);o>=768&&o<=879||(s.push(c),c++)}s.push(c);const d=$a(n).indexOf(t);if(-1===d)continue;const m=s[d]??d,p=s[d+t.length]??m+o.length,g=Math.max(0,m-50),u=Math.min(n.length,p+70),f=g>0?"…":"",h=u<n.length?"…":"";return{snippet:`${f}${n.slice(g,m)}<mark>${n.slice(m,p)}</mark>${n.slice(p,u)}${h}`,count:i,headingSlug:l?wa(l):null,headingText:l}}return{snippet:"",count:i,headingSlug:null,headingText:null}}function Aa({open:e,onClose:o,entries:i,activeId:l,onSelect:s}){const[c,d]=(0,t.useState)(""),[m,p]=(0,t.useState)([]),[g,u]=(0,t.useState)(!1),[f,h]=(0,t.useState)(0),x=(0,t.useRef)(null),y=(0,t.useRef)(),b=(0,t.useMemo)(()=>va(i),[i]);(0,t.useEffect)(()=>{e&&(d(""),p([]),h(0),setTimeout(()=>x.current?.focus(),50))},[e]),(0,t.useEffect)(()=>{if(!e)return;const a=e=>{"Escape"===e.key&&(e.preventDefault(),o())};return window.addEventListener("keydown",a),()=>window.removeEventListener("keydown",a)},[e,o]);const w=(0,t.useCallback)(async e=>{if(e.length<2)return p([]),void u(!1);u(!0);const o=await Promise.all(b.map(async({entry:e,parentName:o})=>{const t=await async function(e){const o=za.get(e);if(void 0!==o)return o;try{const o=await fetch(`${a.p}content/${e}`);if(!o.ok)return"";const t=await o.text();return za.set(e,t),t}catch{return za.set(e,""),""}}(e.file);return{entry:e,parentName:o,text:t}})),t=[];for(const{entry:a,parentName:n,text:i}of o){const o=$a(a.name),r=$a(i),l=$a(e);if(!o.includes(l)&&!r.includes(l))continue;const{snippet:s,count:c,headingSlug:d,headingText:m}=ka(i,e),p=o.includes(l);t.push({entry:a,parentName:n,snippet:s||(p?a.name:""),matchCount:c+(p?10:0),headingSlug:d,headingText:m})}t.sort((e,o)=>o.matchCount-e.matchCount),p(t),h(0),u(!1)},[b]);(0,t.useEffect)(()=>{if(clearTimeout(y.current),c.trim())return y.current=setTimeout(()=>w(c.trim()),250),()=>clearTimeout(y.current);p([])},[c,w]);const z=(0,t.useCallback)(e=>{"ArrowDown"===e.key?(e.preventDefault(),h(e=>Math.min(e+1,m.length-1))):"ArrowUp"===e.key?(e.preventDefault(),h(e=>Math.max(e-1,0))):"Enter"===e.key&&m[f]&&(e.preventDefault(),s(m[f].entry,m[f].headingSlug),o())},[m,f,s,o]);return e?(0,r.jsx)(oa,{onClick:e=>{e.target===e.currentTarget&&o()},children:(0,r.jsxs)(aa,{onKeyDown:z,children:[(0,r.jsxs)(ta,{children:[(0,r.jsx)(Z.A,{size:18,color:n.w4.colors.accent,style:{flexShrink:0}}),(0,r.jsx)(na,{ref:x,placeholder:"Pesquisar em todo o conteúdo…",value:c,onChange:e=>d(e.target.value)}),(0,r.jsx)(ia,{onClick:o,title:"Fechar (Esc)",children:(0,r.jsx)(Jo.A,{size:14})})]}),(0,r.jsxs)(ra,{children:[g&&(0,r.jsxs)(la,{children:[(0,r.jsx)(sa,{children:(0,r.jsx)(qo.A,{size:14})}),"A pesquisar ",b.length," ficheiros…"]}),!g&&c.length>=2&&m.length>0&&(0,r.jsxs)(la,{children:[(0,r.jsx)(Zo.A,{size:13}),m.length," ",1===m.length?"resultado":"resultados"," encontrados"]}),!g&&c.length>=2&&0===m.length&&(0,r.jsxs)(ba,{children:[(0,r.jsx)(Z.A,{size:32,strokeWidth:1.2}),'Nenhum resultado para "',(0,r.jsx)("strong",{children:c}),'"']}),!g&&c.length<2&&(0,r.jsxs)(ba,{children:[(0,r.jsx)(Z.A,{size:32,strokeWidth:1.2}),"Escreve pelo menos 2 caracteres para pesquisar"]}),m.map((e,a)=>(0,r.jsxs)(ca,{selected:a===f,onClick:()=>{s(e.entry,e.headingSlug),o()},onMouseEnter:()=>h(a),children:[(0,r.jsx)(da,{selected:a===f,children:(0,r.jsx)(Zo.A,{size:15})}),(0,r.jsxs)(ma,{children:[(0,r.jsxs)(pa,{children:[e.entry.name,e.matchCount>0&&(0,r.jsx)(ua,{children:e.matchCount>10?e.matchCount-10:e.matchCount})]}),(e.parentName||e.headingText)&&(0,r.jsxs)(ga,{children:[e.parentName,e.parentName&&e.headingText?" › ":"",e.headingText]}),e.snippet&&(0,r.jsx)(fa,{dangerouslySetInnerHTML:{__html:e.snippet}})]}),(0,r.jsx)(ha,{selected:a===f,children:(0,r.jsx)(Xo.A,{size:14})})]},e.entry.id))]}),(0,r.jsxs)(xa,{children:[(0,r.jsxs)("span",{children:[(0,r.jsx)(ya,{children:"↑"})," ",(0,r.jsx)(ya,{children:"↓"})," navegar"]}),(0,r.jsxs)("span",{children:[(0,r.jsx)(ya,{children:"↵"})," abrir"]}),(0,r.jsxs)("span",{children:[(0,r.jsx)(ya,{children:"esc"})," fechar"]})]})]})}):null}function ja(e,o){for(const a of e){if(a.id===o)return a;if(a.children){const e=ja(a.children,o);if(e)return e}}}function Sa(e){return e.flatMap(e=>e.children?Sa(e.children):e.file?[e]:[])}const Ma=i.default.div`
  display: flex;
  align-items: center;
  justify-content: center;
  height: 100%;
