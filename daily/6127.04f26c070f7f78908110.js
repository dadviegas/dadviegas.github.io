"use strict";(self.webpackChunk_atlantis_daily=self.webpackChunk_atlantis_daily||[]).push([[6127],{894(o,e,a){a.d(e,{Nx:()=>p,Ym:()=>c});var t=a(7359),n=a(9200);const r={"time.justNow":{en:"just now",pt:"agora mesmo"},"time.mAgo":{en:"{n}m ago",pt:"há {n}m"},"time.hAgo":{en:"{n}h ago",pt:"há {n}h"},"time.dAgo":{en:"{n}d ago",pt:"há {n}d"},updated:{en:"updated {age}",pt:"atualizado {age}"},refresh:{en:"Refresh",pt:"Atualizar"},loading:{en:"Loading…",pt:"A carregar…"},noData:{en:"No data available",pt:"Sem dados disponíveis"},noDescription:{en:"No description provided.",pt:"Sem descrição."},failedToFetch:{en:"Failed to fetch",pt:"Erro ao carregar"},perWeek:{en:"/ wk",pt:"/ sem"},"devtools.heading":{en:"Dev Tools",pt:"Ferramentas"},"devtools.playground":{en:"Playground",pt:"Playground"},"devtools.pad":{en:"Pad",pt:"Pad"},"devtools.charts":{en:"Charts",pt:"Gráficos"},"devtools.csv":{en:"CSV",pt:"CSV"},"devtools.regex":{en:"Regex",pt:"Regex"},"devtools.json":{en:"JSON",pt:"JSON"},"devtools.diff":{en:"Diff",pt:"Diferenças"},"devtools.jwt":{en:"JWT",pt:"JWT"},"devtools.cron":{en:"Cron",pt:"Cron"},"devtools.colors":{en:"Colors",pt:"Cores"},"devtools.api":{en:"API",pt:"API"}},i="atlantis:locale",l="shell:locale";function s(o){return"en"===o||"pt"===o}function d(){try{const o=localStorage.getItem(i);if(s(o))return o}catch{}return"en"}function c(){const[o,e]=(0,t.useState)(d),a=(0,t.useCallback)(o=>{e(o),function(o){try{localStorage.setItem(i,o)}catch{}(0,n.Is)(l,o).catch(()=>{})}(o),window.dispatchEvent(new CustomEvent("atlantis:locale-change",{detail:o}))},[]);return(0,t.useEffect)(()=>{const o=o=>{const a=o.detail;e(a)};return window.addEventListener("atlantis:locale-change",o),()=>window.removeEventListener("atlantis:locale-change",o)},[]),(0,t.useEffect)(()=>{(0,n.PL)(l).then(a=>{if(s(a)&&a!==o){try{localStorage.setItem(i,a)}catch{}e(a)}}).catch(()=>{})},[]),[o,a]}function p(o,e){const a=e?{...r,...e}:r;return(e,t)=>{const n=a[e]?.[o]??e;return t?Object.entries(t).reduce((o,[e,a])=>o.replace(new RegExp(`\\{${e}\\}`,"g"),String(a)),n):n}}(0,n.PL)(l).then(o=>{if(s(o))try{localStorage.setItem(i,o)}catch{}}).catch(()=>{});var g=a(3233);a(5723),g.default.div`
  display: flex;
  gap: 4px;
...
`},4914(o,e,a){a.d(e,{FlyoutPanel:()=>b});var t=a(7359),n=a(3233),r=a(7207),i=a(255),l=a(217),s=a(5959),d=a(5185),c=a(5723);const p=r.keyframes`
...
`;function u({iconKey:o}){const e=o?d.t[o]??i.A:i.A;return(0,c.jsx)(e,{size:14,strokeWidth:1.75})}function x({entries:o,activeId:e,onSelect:a}){return(0,c.jsx)(c.Fragment,{children:o.map(o=>o.children?(0,c.jsx)(t.Fragment,{children:(0,c.jsx)(x,{entries:o.children,activeId:e,onSelect:a})},o.id):(0,c.jsxs)(m,{active:e===o.id,onClick:()=>a(o),children:[(0,c.jsx)(u,{iconKey:o.icon}),o.name]},o.id))})}function b({activeId:o}){const{flyout:e,scheduleFlyoutClose:a,cancelFlyoutClose:t}=(0,s.c)();if(!e)return null;const n=e.entry.icon?d.t[e.entry.icon]??i.A:i.A;return(0,c.jsxs)(g,{anchorY:e.anchorY,onMouseEnter:t,onMouseLeave:a,children:[(0,c.jsxs)(f,{children:[(0,c.jsx)(n,{size:13,strokeWidth:2}),e.entry.name]}),(0,c.jsx)(x,{entries:e.entry.children??[],activeId:o,onSelect:o=>{e.onSelect(o),a()}})]})}},5959(o,e,a){a.d(e,{I:()=>n,c:()=>r});var t=a(7359);const n=(0,t.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),r=()=>(0,t.useContext)(n)},5185(o,e,a){a.d(e,{t:()=>wo});var t=a(9510),n=a(9038),r=a(7400),i=a(7561),l=a(8207),s=a(7902),d=a(6896),c=a(3013),p=a(2887),g=a(7901),f=a(9848),m=a(2164),u=a(3045),x=a(3775),b=a(3539),y=a(1783),w=a(9416),h=a(1837),$=a(7167),z=a(4494),v=a(2314),k=a(5751),A=a(255),M=a(9633),T=a(2946),S=a(822),F=a(6720),j=a(8456),B=a(3317),P=a(2709),C=a(9301),R=a(8006),E=a(3517),D=a(7032),L=a(6949),H=a(8218),N=a(6829),I=a(5553),Y=a(9591),G=a(9923),K=a(2820),V=a(4621),O=a(8479),_=a(2534),J=a(6673),W=a(7490),U=a(9033),Z=a(5775),q=a(1365),X=a(2937),Q=a(9821),oo=a(5912),eo=a(158),ao=a(8641),to=a(8607),no=a(3249),ro=a(1821),io=a(5889),lo=a(9655),so=a(7170),co=a(9161),po=a(1849),go=a(1604),fo=a(3142),mo=a(1187),uo=a(7747),xo=a(2932),bo=a(4525),yo=a(7230);const wo={activity:d.A,"a-large-small":s.A,apple:c.A,"arrow-right":p.A,"bar-chart-2":t.A,book:f.A,"book-open":g.A,briefcase:u.A,calendar:x.A,clock:y.A,"circle-dot":b.A,cloud:w.A,compass:h.A,cpu:$.A,droplets:z.A,feather:v.A,file:A.A,"file-text":k.A,folder:M.A,"git-branch":T.A,github:S.A,globe:F.A,grid:r.A,hand:j.A,hash:B.A,heart:P.A,key:R.A,hexagon:C.A,home:i.A,landmark:E.A,layers:l.A,"layout-grid":D.A,leaf:L.A,lightbulb:H.A,list:N.A,map:Y.A,"map-pin":I.A,"message-circle":G.A,"message-square":K.A,minus:V.A,monitor:O.A,mountain:_.A,package:J.A,palette:W.A,"pen-tool":U.A,"pie-chart":n.A,plane:Z.A,plus:q.A,ruler:X.A,shirt:Q.A,slash:oo.A,square:eo.A,star:ao.A,sun:to.A,terminal:no.A,thermometer:ro.A,triangle:io.A,trophy:lo.A,truck:so.A,type:co.A,users:po.A,"volume-2":go.A,watch:fo.A,waves:mo.A,wind:uo.A,wrench:xo.A,x:bo.A,zap:yo.A,bot:m.A}},9200(o,e,a){a.d(e,{PE:()=>S,WD:()=>ao,Up:()=>Q,yI:()=>eo,qj:()=>H,PL:()=>Y,Fy:()=>oo,pJ:()=>L,Is:()=>I,sg:()=>to,w4:()=>t.w4,dR:()=>X,xc:()=>J});var t=a(217),n=a(7359),r=a(3233),i=a(5723);r.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,r.default.div`
  position: relative;
`;var l=a(7207),s=a(3661),d=a(5959);const c="260px",p="56px",g=r.default.header`
  display: flex;
  align-items: center;
...
`,k=r.default.main`
  ...
  display: flex;
  flex-direction: column;
`,A=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function M(){return(0,i.jsx)(x,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:A.map((o,e)=>(0,i.jsx)(b,{index:e,accent:o.accent,children:o.char},e))})}const T="atlantis:sidebar-collapsed";function S({sidebar:o,children:e,topBarRight:t,title:r="Atlantis",activeId:l=null}){const[c,p]=(0,n.useState)(()=>{try{return"true"===localStorage.getItem(T)}catch{return!1}}),[u,x]=(0,n.useState)(null),b=(0,n.useRef)(),A=()=>p(o=>{const e=!o;try{localStorage.setItem(T,String(e))}catch{}return e}),S=n.useMemo(()=>n.lazy(()=>Promise.resolve().then(a.bind(a,4914)).then(o=>({default:o.FlyoutPanel}))),[]);return(0,i.jsx)(d.I.Provider,{value:{collapsed:c,toggle:A,flyout:u,openFlyout:(o,e,a)=>{clearTimeout(b.current),x({entry:o,anchorY:e,onSelect:a})},scheduleFlyoutClose:()=>{b.current=setTimeout(()=>x(null),160)},cancelFlyoutClose:()=>clearTimeout(b.current)},children:(0,i.jsxs)($,{children:[(0,i.jsxs)(g,{children:[o&&(0,i.jsx)(f,{children:(0,i.jsx)(m,{onClick:A,title:c?"Expand sidebar":"Collapse sidebar",children:(0,i.jsx)(s.A,{size:17})})}),(0,i.jsx)(M,{}),r&&(0,i.jsx)(y,{children:r}),t&&(0,i.jsx)(w,{children:t})]}),(0,i.jsxs)(h,{children:[null!=o&&(0,i.jsx)(z,{collapsed:c,children:(0,i.jsx)(v,{children:o})}),(0,i.jsx)(k,{children:e})]}),u&&(0,i.jsx)(n.Suspense,{fallback:null,children:(0,i.jsx)(S,{activeId:l})})]})})}a(5185),r.default.div`
  display: grid;
...
`,a(4914);var j=a(1920),B=a(8607),P=a(8479);r.default.button`
  display: flex;
  align-items: center;
  justify-content: center;
  width: 32px;
...
`;const G="shell:profile",K="atlantis:profile-change",V=["tech","movies","learning","games","news","space"],O={interests:[],ageMode:"adult"};function _(o){if(!o||"object"!=typeof o)return O;const e=o;return{interests:Array.isArray(e.interests)?e.interests.filter(o=>V.includes(o)):[],ageMode:"kid"===e.ageMode||"teen"===e.ageMode||"adult"===e.ageMode?e.ageMode:"adult"}}function J(){const[o,e]=(0,n.useState)(O);return(0,n.useEffect)(()=>{let o=!1;Y(G).then(a=>{if(!o&&a)try{e(_(JSON.parse(a)))}catch{}});const a=o=>{const a=o.detail;a&&e(a)};return window.addEventListener(K,a),()=>{o=!0,window.removeEventListener(K,a)}},[]),[o,(0,n.useCallback)(async o=>{const a=_(o);e(a),window.dispatchEvent(new CustomEvent(K,{detail:a})),await I(G,JSON.stringify(a))},[])]}new Set([10751]),new Set([27]),r.default.div`
...
`;const q="daily:progress";function X(){return(new Date).toISOString().slice(0,10)}function Q(o,e=3){return function(o){if(0===o.length)return 0;const e=[...new Set(o)].sort().reverse();let a=0,t=X();for(const o of e){if(o!==t)break;{a++;const o=new Date(t);o.setDate(o.getDate()-1),t=o.toISOString().slice(0,10)}}return a}(function(o,e=3){if(!o)return[];const a=[];for(const[t,n]of Object.entries(o))n&&n.length>=e&&a.push(t);return a}(o,e))}async function oo(){try{const o=await Y(q);return o?JSON.parse(o):null}catch{return null}}function eo(o,e){return function(o,e=new Date){const a=[];for(let t=o-1;t>=0;t--){const o=new Date(e);o.setDate(o.getDate()-t),a.push(o.toISOString().slice(0,10))}return a}(e).map(e=>{const a=o.history[e]??[];return{date:e,completedIds:a,count:a.length}})}const ao={"daily.mission.brushTeeth":{en:"Brush teeth",pt:"Lavar os dentes"},"daily.mission.makeBed":{en:"Make bed",pt:"Fazer a cama"},"daily.mission.read":{en:"Read for 15 min",pt:"Ler 15 minutos"},"daily.mission.tidyRoom":{en:"Tidy room",pt:"Arrumar o quarto"},"daily.mission.setTable":{en:"Help set table",pt:"Ajudar a pôr a mesa"},"daily.mission.schoolBag":{en:"Pack school bag",pt:"Preparar a mochila"},"daily.mission.vegetables":{en:"Eat vegetables",pt:"Comer legumes"},"daily.mission.clothesAway":{en:"Put clothes away",pt:"Guardar a roupa"},"daily.mission.homework":{en:"Do homework",pt:"Fazer os trabalhos"},"daily.mission.draw":{en:"Draw or paint",pt:"Desenhar ou pintar"},"daily.mission.beKind":{en:"Be kind to someone",pt:"Ser gentil com alguém"}};async function to(o){try{await I(q,JSON.stringify(o)),"undefined"!=typeof window&&window.dispatchEvent(new CustomEvent("atlantis:daily-progress-change",{detail:o}))}catch{}}},217(o,e,a){a.d(e,{w4:()=>r});const t={sidebarBg:"#0c1018",sidebarText:"#c5cdd8",sidebarTextMuted:"#5a6577",sidebarActive:"#6366f1",sidebarActiveBg:"#141820",sidebarHover:"#1a2030",sidebarBorder:"#1e2535",mainBg:"#0a0e14",mainText:"#e8edf5",mainTextMuted:"#9aa5b8",mainTextFaint:"rgba(232,237,245,0.38)",accent:"#6366f1",accentHover:"#818cf8",accentMuted:"rgba(99,102,241,0.18)",codeBg:"#0f1520",codeBorder:"#2a3040",border:"#343c4f",borderStrong:"rgba(255,255,255,0.16)",borderSubtle:"#1e2535",surface:"#141820",surfaceRaised:"#1c2332",surfaceHover:"#1d2138",success:"#34d399",warning:"#fbbf24",danger:"#f87171",shadow:"rgba(0, 0, 0, 0.35)",shadowStrong:"rgba(0, 0, 0, 0.45)",suiteLab:"#8b7bff",suiteVida:"#7fb77e",suiteLearn:"#6aa8d8",suiteGames:"#ff6fa9",suiteEnt:"#e89a5c"},n="--at-",r={colors:function(){const o={};for(const e of Object.keys(t))o[e]=`var(${n}${e})`;return o}(),spacing:{xs:"4px",sm:"8px",md:"16px",lg:"24px",xl:"32px",xxl:"48px"},sidebar:{width:"260px"},topbar:{height:"56px"},typography:{fontFamily:"'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif",fontFamilyMono:"'JetBrains Mono', 'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, monospace",fontFamilySerif:"'Cormorant Garamond', 'Iowan Old Style', 'Palatino Linotype', Palatino, Georgia, serif",fontSizeSm:"13px",fontSizeBase:"14px",fontSizeMd:"16px",fontSizeLg:"20px",fontSizeXl:"24px",fontSizeHero:"32px",lineHeightBase:"1.6"},suites:{lab:`var(${n}suiteLab)`,vida:`var(${n}suiteVida)`,learn:`var(${n}suiteLearn)`,games:`var(${n}suiteGames)`,ent:`var(${n}suiteEnt)`},borderRadius:{sm:"4px",md:"6px",lg:"12px",xl:"16px"},breakpoints:{md:"768px",lg:"1024px",xl:"1280px"},sizes:{fullHeight:"100dvh",md:"768px",lg:"1024px",xl:"1280px"},zIndex:{sticky:100,dropdown:1e3,flyout:1200,modal:1500,tooltip:1600},elevation:{sm:"0 2px 8px var(--at-shadow), 0 1px 2px var(--at-shadow)",md:"0 8px 24px var(--at-shadow), 0 2px 4px var(--at-shadow)",lg:"0 16px 48px var(--at-shadowStrong), 0 4px 12px var(--at-shadow)",glow:"0 0 0 1px rgba(99,102,241,0.30), 0 8px 24px rgba(99,102,241,0.15)"},transitions:{fast:"0.1s cubic-bezier(0.4, 0, 0.2, 1)",base:"0.2s cubic-bezier(0.4, 0, 0.2, 1)",slow:"0.35s cubic-bezier(0.4, 0, 0.2, 1)",easing:"cubic-bezier(0.4, 0, 0.2, 1)"},focusRing:"\n    outline: 2px solid var(--at-accent);\n    outline-offset: 2px;\n  "}},9763(o,e,a){a.d(e,{$n:()=>x,YZ:()=>S,K0:()=>h});var t=a(7359),n=a(3233),r=a(9200),i=a(5723);const l={ghost:"transparent",accent:"transparent",primary:r.w4.colors.accent,success:"#238636",danger:"#da3633"},s={ghost:r.w4.colors.sidebarHover,accent:"rgba(88,166,255,0.10)",primary:r.w4.colors.accentHover,success:"#2ea043",danger:"#f85149"},d={ghost:r.w4.colors.border,accent:r.w4.colors.accent,primary:r.w4.colors.accent,success:"#238636",danger:"#da3633"},c={ghost:r.w4.colors.mainTextMuted,accent:r.w4.colors.accent,primary:"#fff",success:"#fff",danger:"#fff"},p={ghost:r.w4.colors.mainText,accent:r.w4.colors.accent,primary:"#fff",success:"#fff",danger:"#fff"},g={sm:"28px",md:"30px"},f={sm:"0 10px",md:"0 12px"},m={sm:"12px",md:"12px"},u=n.default.button`
  ...
  &:hover:not(:disabled) {
    ...
    color: ${({variant:o})=>p[o]};
    border-color: ${({variant:o})=>"ghost"===o?r.w4.colors.accent:d[o]};
  }
...
`,x=t.forwardRef(function({variant:o="ghost",size:e="md",icon:a,iconRight:t,children:n,...r},l){return(0,i.jsxs)(u,{ref:l,variant:o,size:e,...r,children:[a,n,t]})}),b={default:r.w4.colors.accent,danger:"#f85149"},y={default:r.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"},w=n.default.button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`,h=t.forwardRef(function({active:o=!1,shape:e="square",tone:a="default",children:t,...n},r){return(0,i.jsx)(w,{ref:r,active:o,shape:e,tone:a,...n,children:t})});n.default.div`
  position: relative;
  display: inline-flex;
`,n.default.div`
  position: absolute;
...
`,n.default.div`
  ...
  gap: 4px;
  flex-wrap: wrap;
`,(0,n.default)("button",{shouldForwardProp:o=>"active"!==o&&"highlight"!==o})`
  padding: 6px 14px;
  height: 28px;
  border-radius: 999px;
  background: ${({active:o})=>o?r.w4.colors.accentMuted:"transparent"};
  border: 1px solid
    ${({active:o,highlight:e})=>o||e?r.w4.colors.accent:"transparent"};
  color: ${({active:o,highlight:e})=>o||e?r.w4.colors.accent:r.w4.colors.mainTextMuted};
  font-family: ${r.w4.typography.fontFamily};
  font-size: 12px;
  font-weight: 500;
  cursor: pointer;
  ...
  &:hover:not(:disabled) { color: ${r.w4.colors.mainText}; }
  &:disabled { opacity: 0.45; cursor: not-allowed; }
  &:focus-visible { ${r.w4.focusRing} }
`;var $=a(7207);const z=$.keyframes`
...
`,(0,n.default)("button",{shouldForwardProp:o=>"accent"!==o&&"expanded"!==o})`
  width: 100%;
  display: grid;
  ...
  &:focus-visible { ${r.w4.focusRing} }
`,(0,n.default)("span",{shouldForwardProp:o=>"accent"!==o})`
  width: 36px;
  height: 36px;
  border-radius: 9px;
...
`,n.default.button`
  ...
  .kbd {
    ...
    color: ${r.w4.colors.mainTextMuted};
    letter-spacing: 0.04em;
    transition: color ${r.w4.transitions.fast}, border-color ${r.w4.transitions.fast}, background ${r.w4.transitions.fast};
  }
...
`,n.default.button`
  ...
  transition: transform 0.08s ease, box-shadow ${r.w4.transitions.fast};
...
`;(0,n.default)("div",{shouldForwardProp:o=>"accentColor"!==o&&"pinned"!==o&&"index"!==o})`
  --acc: ${({accentColor:o})=>o};
  position: relative;
  display: flex;
  flex-direction: column;
...
`,n.default.button`
  ...
  cursor: pointer;
  transition: opacity ${r.w4.transitions.fast}, color ${r.w4.transitions.fast}, border-color ${r.w4.transitions.fast};
  z-index: 3;
  padding: 0;
...
`,n.default.span`
  ...
  background: ${({color:o})=>o};
  display: inline-block;
`;const A={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:r.w4.colors.accentMuted},M={neutral:r.w4.colors.mainTextMuted,live:r.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:r.w4.colors.accent};n.default.span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${r.w4.typography.fontFamilyMono};
...
`;const T=n.default.div`
  ...
  align-items: center;
  gap: 8px;
`;function S({children:o,...e}){return(0,i.jsx)(T,{...e,children:o})}n.default.label`
  display: flex;
  align-items: center;
  gap: 10px;
...
`;const F=$.keyframes`
  from { opacity: 0; transform: translateY(8px); }
  to   { opacity: 1; transform: translateY(0); }
`;(0,n.default)("div",{shouldForwardProp:o=>"accentColor"!==o&&"index"!==o})`
  --acc: ${({accentColor:o})=>o};
  position: relative;
  display: flex;
  flex-direction: column;
...
`,(0,n.default)("div",{shouldForwardProp:o=>"accentColor"!==o})`
  --acc: ${({accentColor:o})=>o};
  height: 120px;
  position: relative;
  overflow: hidden;
...
`,n.default.p`
  ...
  font-size: 12.5px;
  line-height: 1.45;
`,a(5406),n.default.nav`padding: ${r.w4.spacing.sm} 0;`,n.default.div`
...
`,P.A,P.A['pre[class*="language-"]'],r.w4.colors.codeBg,P.A['code[class*="language-"]'];var C=a(5569),R=a(8218),E=a(7230),D=a(2966),L=a(1069);C.A,R.A,E.A,D.A,L.A,n.default.div`
  background: ${({bg:o})=>o};
...
`,n.default.button`
  ...
  border-radius: ${r.w4.borderRadius.md};
  background: ${({active:o})=>o?r.w4.colors.accentMuted:"transparent"};
  color: ${({active:o})=>o?r.w4.colors.accent:r.w4.colors.sidebarText};
  font-family: ${r.w4.typography.fontFamily};
  font-size: ${r.w4.typography.fontSizeSm};
  font-weight: ${({active:o})=>o?"600":"400"};
  cursor: pointer;
  ...
  white-space: nowrap;
  overflow: hidden;
  transition: background ${r.w4.transitions.fast}, color ${r.w4.transitions.fast};
...
`},8887(o,e,a){a.d(e,{A:()=>t});const t={...a(9200).WD,"daily.title":{en:"Daily Manager",pt:"Gestor Diário"},"daily.subtitle":{en:"Build good habits, one day at a time.",pt:"Constrói bons hábitos, um dia de cada vez."},"daily.level":{en:"Level {n}",pt:"Nível {n}"},"daily.points":{en:"points",pt:"pontos"},"daily.xp":{en:"XP",pt:"XP"},"daily.sectionMissions":{en:"🎯 Today's Missions",pt:"🎯 Missões de Hoje"},"daily.sectionStats":{en:"📊 Your Stats",pt:"📊 As Tuas Estatísticas"},"daily.sectionWeek":{en:"🗓️ Last 7 Days",pt:"🗓️ Últimos 7 Dias"},"daily.weekHint":{en:"Dots show missions completed each day",pt:"Os pontos mostram missões concluídas em cada dia"},"daily.stat.completed":{en:"Missions\ncompleted",pt:"Missões\nconcluídas"},"daily.stat.points":{en:"Points\nearned",pt:"Pontos\nganhos"},"daily.stat.streak":{en:"Day\nstreak",pt:"Dias\nseguidos"},"daily.welcomeTitle":{en:"Your adventure starts today!",pt:"A tua aventura começa hoje!"},"daily.welcomeBody":{en:"Complete missions to earn points and level up. The more you do, the stronger you get!",pt:"Completa missões para ganhar pontos e subir de nível. Quanto mais fizeres, mais forte ficas!"},"daily.edit":{en:"Edit list",pt:"Editar lista"},"daily.done":{en:"Done",pt:"Pronto"},"daily.addMission":{en:"Add mission",pt:"Adicionar missão"},"daily.placeholderEmoji":{en:"Emoji",pt:"Emoji"},"daily.placeholderName":{en:"Mission name",pt:"Nome da missão"},"daily.placeholderPoints":{en:"pts",pt:"pts"},"daily.add":{en:"Add",pt:"Adicionar"},"daily.delete":{en:"Remove",pt:"Remover"},"daily.resetDay":{en:"Reset day",pt:"Novo dia"},"daily.resetConfirm":{en:"Are you sure? This clears today's missions but keeps your points.",pt:"Tens a certeza? As missões de hoje serão limpas, mas os teus pontos ficam."},"daily.confirm":{en:"Confirm",pt:"Confirmar"},"daily.cancel":{en:"Cancel",pt:"Cancelar"},"daily.levelUp":{en:"🎉 Level Up!",pt:"🎉 Subiste de nível!"},"daily.level.recruit":{en:"Recruit",pt:"Recruta"},"daily.level.explorer":{en:"Explorer",pt:"Explorador"},"daily.level.adventurer":{en:"Adventurer",pt:"Aventureiro"},"daily.level.hero":{en:"Hero",pt:"Herói"},"daily.level.champion":{en:"Champion",pt:"Campeão"},"daily.level.legend":{en:"Legend",pt:"Lenda"},"daily.newMission.title":{en:"New mission",pt:"Nova missão"},"daily.newMission.preview":{en:"Preview",pt:"Pré-visualização"},"daily.newMission.name":{en:"Name",pt:"Nome"},"daily.newMission.namePlaceholder":{en:"e.g. Drink water",pt:"ex. Beber água"},"daily.newMission.emoji":{en:"Emoji",pt:"Emoji"},"daily.newMission.frame":{en:"Frame",pt:"Moldura"},"daily.newMission.color":{en:"Color",pt:"Cor"},"daily.newMission.points":{en:"Points",pt:"Pontos"},"daily.newMission.time":{en:"Time (optional)",pt:"Hora (opcional)"},"daily.newMission.timeClear":{en:"Clear",pt:"Limpar"},"daily.newMission.save":{en:"Create",pt:"Criar"},"daily.editMission.title":{en:"Edit mission",pt:"Editar missão"},"daily.editMission.save":{en:"Save",pt:"Guardar"},"daily.editMission.open":{en:"Edit mission",pt:"Editar missão"},"daily.summary.pointsToday":{en:"pts today",pt:"pts hoje"},"daily.summary.missions":{en:"missions",pt:"missões"},"daily.summary.streak":{en:"day streak",pt:"dia(s) seguidos"},"daily.greet.morning":{en:"Good morning, {name}.",pt:"Bom dia, {name}."},"daily.greet.afternoon":{en:"Good afternoon, {name}.",pt:"Boa tarde, {name}."},"daily.greet.evening":{en:"Good evening, {name}.",pt:"Boa noite, {name}."},"daily.greet.defaultName":{en:"Explorer",pt:"Explorador"},"daily.greet.remaining":{en:"{n} of {total} missions left",pt:"{n} de {total} missões por fazer"},"daily.greet.allDone":{en:"All done — enjoy your day.",pt:"Tudo pronto — aproveita o dia."},"daily.focus.nextUp":{en:"Next up",pt:"A seguir"},"daily.focus.dayComplete":{en:"Day complete",pt:"Dia concluído"},"daily.focus.markDone":{en:"Mark done",pt:"Marcar como feito"},"daily.focus.skip":{en:"Skip",pt:"Saltar"},"daily.focus.allDone":{en:"All missions complete!",pt:"Todas as missões concluídas!"},"daily.focus.allDoneBody":{en:"Come back tomorrow for a new set.",pt:"Volta amanhã para um novo conjunto."},"daily.focus.timeChip":{en:"⏰ {time}",pt:"⏰ {time}"},"daily.progress.today":{en:"today",pt:"hoje"},"daily.progress.tooltip":{en:"{streak}-day streak · Level {level}",pt:"{streak} dias seguidos · Nível {level}"},"daily.chapter.morning":{en:"☀️ Morning",pt:"☀️ Manhã"},"daily.chapter.afternoon":{en:"🌤️ Afternoon",pt:"🌤️ Tarde"},"daily.chapter.evening":{en:"🌙 Evening",pt:"🌙 Noite"},"daily.chapter.count":{en:"{done}/{total}",pt:"{done}/{total}"},"daily.sparkline.label":{en:"Last 7 days",pt:"Últimos 7 dias"},"daily.chip.level":{en:"Lv{n}",pt:"Nv{n}"},"daily.chip.points":{en:"{n} pts",pt:"{n} pts"},"daily.chip.streak":{en:"{n} day streak",pt:"{n} dias"},"daily.chip.streakSingle":{en:"{n} day streak",pt:"{n} dia"},"daily.chip.done":{en:"{n} done",pt:"{n} feitas"},"daily.chip.xpHint":{en:"Progress to next level",pt:"Progresso para o próximo nível"}}}}]);