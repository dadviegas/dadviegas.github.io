...
`,i.default.button`
  ...
  background: ${({active:n})=>n?a.w.colors.sidebarActiveBg:"transparent"};
  border: none;
  color: ${({active:n})=>n?a.w.colors.accent:a.w.colors.mainText};
  font-family: ${a.w.typography.fontFamily};
  font-size: ${a.w.typography.fontSizeSm};
...
`,i.default.span`
  ...
  height: 6px;
  border-radius: 50%;
  background: ${({active:n})=>n?a.w.colors.accent:a.w.colors.sidebarTextMuted};
  margin-right: 6px;
  flex-shrink: 0;
