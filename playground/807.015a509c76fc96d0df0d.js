"use strict";(self.webpackChunk_atlantis_playground=self.webpackChunk_atlantis_playground||[]).push([[807],{188(e,r,t){var o=t(7359),n=t(8997),s=t(3233),i=t(5723),a=t(6480),l=t(6135),d=t(9421),c=t(679),p=t(1530),f=t(5496),u=t(9881),x=t(5426),g=t(9336),h=t(7293),m=t(8104);const b=`\n  &::-webkit-scrollbar { width: 6px; height: 6px; }\n  &::-webkit-scrollbar-track { background: transparent; }\n  &::-webkit-scrollbar-thumb { background: ${i.w4.colors.border}; border-radius: 3px; }\n  &::-webkit-scrollbar-thumb:hover { background: ${i.w4.colors.mainTextMuted}; }\n  scrollbar-width: thin;\n  scrollbar-color: ${i.w4.colors.border} transparent;\n`,w=s.default.div`
  display: flex;
...
//# sourceMappingURL=807.015a509c76fc96d0df0d.js.map