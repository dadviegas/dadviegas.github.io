...
`,eh=s().div`
  ...
  font-size: ${t.w4.typography.fontSizeSm};
  text-align: center;
`;function ey({t:e}){let{data:o,loading:a,lastUpdated:t,refresh:i}=(0,c.st)("https://hn.algolia.com/api/v1/search?tags=front_page&hitsPerPage=12"),r=o?.hits??[];return(0,n.jsxs)("div",{children:[(0,n.jsx)(k,{title:e("nav.todayInTech"),color:er,lastUpdated:t,loading:a,onRefresh:i,t:e}),r.length?(0,n.jsx)(el,{children:r.map((e,o)=>{let a=e.url??`https://news.ycombinator.com/item?id=${e.objectID}`;return(0,n.jsx)(es,{children:(0,n.jsxs)(ed,{href:a,target:"_blank",rel:"noopener noreferrer",children:[(0,n.jsxs)(ec,{children:[o+1,"."]}),(0,n.jsxs)(ep,{children:[(0,n.jsx)(em,{children:e.title}),(0,n.jsxs)(eg,{children:[(0,n.jsxs)(eu,{children:[(0,n.jsx)(et.A,{size:11}),e.points??0]}),(0,n.jsxs)(ef,{children:[(0,n.jsx)(ei.A,{size:11}),e.num_comments??0]}),(0,n.jsx)(ex,{children:(0,c.FB)(e.url)})]})]})]})},e.objectID)})}):(0,n.jsx)(eh,{children:e(a?"todayInTech.loading":"todayInTech.empty")})]})}var eb=a(2743);let ew="#58a6ff",ez=s().div`
  display: flex;
  flex-direction: column;
  gap: 2px;
`,e$=s().a`
  ...
  border: 1px solid ${ew}18;
  border-radius: ${t.w4.borderRadius.sm};
  background: linear-gradient(165deg, ${ew}0b 0%, ${t.w4.colors.surface} 55%, ${t.w4.colors.surface} 100%);
  text-decoration: none;
  transition: background 0.2s, border-color 0.2s, transform 0.2s;

  &:hover {
    background: linear-gradient(165deg, ${ew}14 0%, ${t.w4.colors.surfaceRaised} 55%, ${t.w4.colors.surfaceRaised} 100%);
    border-color: ${ew}5c;
    transform: translateX(2px);
  }
`,ev=s().div`
...
`,A=s().main`
  ...
  display: flex;
  flex-direction: column;
`,S=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function M(){return(0,t.jsx)(y,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:S.map((e,o)=>(0,t.jsx)(b,{index:o,accent:e.accent,children:e.char},o))})}let T="atlantis:sidebar-collapsed";function P({sidebar:e,children:o,topBarRight:n,title:l="Atlantis",activeId:s=null}){let[d,m]=(0,i.useState)(()=>{try{return"true"===localStorage.getItem(T)}catch{return!1}}),[g,h]=(0,i.useState)(null),y=(0,i.useRef)(),b=()=>m(e=>{let o=!e;try{localStorage.setItem(T,String(o))}catch{}return o}),S=r().useMemo(()=>r().lazy(()=>Promise.resolve().then(a.bind(a,8859)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,t.jsx)(p.I.Provider,{value:{collapsed:d,toggle:b,flyout:g,openFlyout:(e,o,a)=>{clearTimeout(y.current),h({entry:e,anchorY:o,onSelect:a})},scheduleFlyoutClose:()=>{y.current=setTimeout(()=>h(null),160)},cancelFlyoutClose:()=>clearTimeout(y.current)},children:(0,t.jsxs)(v,{children:[(0,t.jsxs)(u,{children:[e&&(0,t.jsx)(f,{children:(0,t.jsx)(x,{onClick:b,title:d?"Expand sidebar":"Collapse sidebar",children:(0,t.jsx)(c.A,{size:17})})}),(0,t.jsx)(M,{}),l&&(0,t.jsx)(w,{children:l}),n&&(0,t.jsx)(z,{children:n})]}),(0,t.jsxs)($,{children:[null!=e&&(0,t.jsx)(j,{collapsed:d,children:(0,t.jsx)(k,{children:e})}),(0,t.jsx)(A,{children:o})]}),g&&(0,t.jsx)(r().Suspense,{fallback:null,children:(0,t.jsx)(S,{activeId:s})})]})})}var B=a(255),F=a(9753),R=a(6140);let D=s().div`
  display: grid;
