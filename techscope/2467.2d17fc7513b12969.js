"use strict";(self.webpackChunk_atlantis_techscope=self.webpackChunk_atlantis_techscope||[]).push([["2467"],{5748(e,o,a){a.d(o,{W:()=>oN});var t=a(5723),r=a(3930),i=a(7991),n=a.n(i),l=a(6859),s=a.n(l),d=a(8395),c=a(8294),p=a(9522),g=a(2799),m=a(8170);let f=(0,g.keyframes)`
  0%, 100% { opacity: 1; }
  50% { opacity: 0.3; }
`,x=(0,g.keyframes)`
...
`,_=s().a`
  ...
  gap: 10px;
  padding: ${r.w4.spacing.md};
  background: linear-gradient(168deg, ${E}10 0%, ${r.w4.colors.surface} 44%, ${r.w4.colors.surface} 100%);
  border: 1px solid ${E}2d;
  border-radius: ${r.w4.borderRadius.md};
  text-decoration: none;
  transition: border-color ${r.w4.transitions.base}, background ${r.w4.transitions.base}, transform ${r.w4.transitions.base}, box-shadow ${r.w4.transitions.base};
  position: relative;
  ...
  &::before {
    ...
    right: 0;
    height: 2px;
    background: linear-gradient(90deg, transparent, ${E}, transparent);
    opacity: 0.45;
    transition: opacity ${r.w4.transitions.base};
  }
  ...
  &:hover {
    border-color: ${E}66;
    background: linear-gradient(168deg, ${E}1c 0%, ${r.w4.colors.surfaceRaised} 44%, ${r.w4.colors.surfaceRaised} 100%);
    box-shadow: 0 0 18px ${E}24, 0 10px 26px rgba(0, 0, 0, 0.28);
    transform: translateY(-2px);
  }
...
`,Z=s().span`
  ...
  height: 10px;
  border-radius: 50%;
  background: ${({lang:e})=>D[e]??r.w4.colors.mainTextMuted};
  flex-shrink: 0;
`,X=s().span`
  font-size: ${r.w4.typography.fontSizeSm};
  color: ${r.w4.colors.mainTextMuted};
...
`;function _({iconKey:e,size:o=16}){if(e&&!(e in B.t))return(0,r.jsx)("span",{style:{fontSize:o,lineHeight:1,display:"flex",alignItems:"center"},children:e});let a=e?B.t[e]:null;return a?(0,r.jsx)(a,{size:o,strokeWidth:1.75}):(0,r.jsxs)("svg",{width:o,height:o,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,r.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,r.jsx)("polyline",{points:"14 2 14 8 20 8"})]})}function N({entry:e,activeId:o,onSelect:a}){let[t,n]=(0,i.useState)(e.defaultOpen??!0),{collapsed:l,openFlyout:s,scheduleFlyoutClose:d,cancelFlyoutClose:p}=(0,c.c)();return e.children&&e.children.length>0?(0,r.jsxs)(C,{children:[(0,r.jsxs)(L,{collapsed:l,onClick:()=>{l||n(e=>!e)},onMouseEnter:l?o=>{s(e,o.currentTarget.getBoundingClientRect().top,a)}:void 0,onMouseLeave:l?d:void 0,children:[(0,r.jsxs)(I,{collapsed:l,children:[(0,r.jsx)(_,{iconKey:e.icon,size:16}),(0,r.jsx)(E,{collapsed:l,children:e.name})]}),(0,r.jsx)(D,{open:t,collapsed:l,children:(0,r.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round",children:(0,r.jsx)("path",{d:"M9 6l6 6-6 6"})})})]}),(0,r.jsx)(R,{open:t&&!l,children:(0,r.jsx)(P,{children:(0,r.jsx)(H,{children:e.children.map(e=>(0,r.jsx)(N,{entry:e,activeId:o,onSelect:a},e.id))})})})]}):(0,r.jsxs)(V,{active:o===e.id,collapsed:l,onClick:()=>a(e),onMouseEnter:l?o=>{let t=o.currentTarget.getBoundingClientRect();s({id:e.id,name:e.name,icon:e.icon,file:e.file,children:[e]},t.top,a)}:void 0,onMouseLeave:l?d:void 0,children:[(0,r.jsx)(_,{iconKey:e.icon,size:15}),(0,r.jsx)(E,{collapsed:l,children:e.name})]})}function K({entries:e,activeId:o,onSelect:a}){return(0,r.jsx)("div",{children:e.map(e=>(0,r.jsx)(N,{entry:e,activeId:o,onSelect:a},e.id))})}let Y=(0,d.keyframes)`
