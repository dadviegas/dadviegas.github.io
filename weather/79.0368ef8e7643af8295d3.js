"use strict";(self.webpackChunk_atlantis_weather=self.webpackChunk_atlantis_weather||[]).push([[79],{4914(a,e,n){n.d(e,{FlyoutPanel:()=>y});var o=n(7359),i=n(3233),t=n(7207),l=n(255),r=n(217),m=n(5959),g=n(5185),d=n(5723);const c=t.keyframes`
...
`;function p({iconKey:a}){const e=a?g.t[a]??l.A:l.A;return(0,d.jsx)(e,{size:14,strokeWidth:1.75})}function z({entries:a,activeId:e,onSelect:n}){return(0,d.jsx)(d.Fragment,{children:a.map(a=>a.children?(0,d.jsx)(o.Fragment,{children:(0,d.jsx)(z,{entries:a.children,activeId:e,onSelect:n})},a.id):(0,d.jsxs)(u,{active:e===a.id,onClick:()=>n(a),children:[(0,d.jsx)(p,{iconKey:a.icon}),a.name]},a.id))})}function y({activeId:a}){const{flyout:e,scheduleFlyoutClose:n,cancelFlyoutClose:o}=(0,m.c)();if(!e)return null;const i=e.entry.icon?g.t[e.entry.icon]??l.A:l.A;return(0,d.jsxs)(s,{anchorY:e.anchorY,onMouseEnter:o,onMouseLeave:n,children:[(0,d.jsxs)(f,{children:[(0,d.jsx)(i,{size:13,strokeWidth:2}),e.entry.name]}),(0,d.jsx)(z,{entries:e.entry.children??[],activeId:a,onSelect:a=>{e.onSelect(a),n()}})]})}},5959(a,e,n){n.d(e,{I:()=>i,c:()=>t});var o=n(7359);const i=(0,o.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),t=()=>(0,o.useContext)(i)},5185(a,e,n){n.d(e,{t:()=>Y});var o=n(9510),i=n(9038),t=n(8207),l=n(6896),r=n(7901),m=n(9848),g=n(2164),d=n(3775),c=n(3539),s=n(1783),f=n(1837),u=n(2314),p=n(5751),z=n(255),y=n(9633),b=n(2946),h=n(822),A=n(6720),x=n(3317),w=n(2709),v=n(3517),S=n(7032),k=n(6949),M=n(8218),B=n(6829),$=n(5553),T=n(9591),C=n(2820),E=n(4621),P=n(6673),j=n(9033),L=n(1365),R=n(5912),N=n(8641),G=n(3249),K=n(1821),I=n(9161),F=n(1849),D=n(7747),H=n(2932),V=n(4525),U=n(7230);const Y={activity:l.A,"bar-chart-2":o.A,book:m.A,"book-open":r.A,calendar:d.A,clock:s.A,"circle-dot":c.A,feather:u.A,"file-text":p.A,globe:A.A,hash:x.A,heart:w.A,landmark:v.A,layers:t.A,leaf:k.A,map:T.A,package:P.A,compass:f.A,"git-branch":b.A,github:h.A,minus:E.A,terminal:G.A,thermometer:K.A,users:F.A,wind:D.A,"pie-chart":i.A,plus:L.A,slash:R.A,star:N.A,zap:U.A,bot:g.A,lightbulb:M.A,"message-square":C.A,wrench:H.A,x:V.A,"layout-grid":S.A,list:B.A,file:z.A,folder:y.A,"map-pin":$.A,"pen-tool":j.A,type:I.A}},4079(a,e,n){n.d(e,{rh:()=>D,PE:()=>v,CD:()=>K,qs:()=>V});var o=n(217),i=n(7359),t=n(3233),l=n(5723);t.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,t.default.div`
  position: relative;
`;var r=n(3661),m=n(5959);const g="260px",d="56px",c=t.default.header`
  display: flex;
  align-items: center;
  height: ${"48px"};
...
`,x=t.default.main`
  ...
  display: flex;
  flex-direction: column;
`,w="atlantis:sidebar-collapsed";function v({sidebar:a,children:e,topBarRight:o,title:t="Atlantis",activeId:g=null}){const[d,v]=(0,i.useState)(()=>{try{return"true"===localStorage.getItem(w)}catch{return!1}}),[S,k]=(0,i.useState)(null),M=(0,i.useRef)(),B=()=>v(a=>{const e=!a;try{localStorage.setItem(w,String(e))}catch{}return e}),$=i.useMemo(()=>i.lazy(()=>Promise.resolve().then(n.bind(n,4914)).then(a=>({default:a.FlyoutPanel}))),[]);return(0,l.jsx)(m.I.Provider,{value:{collapsed:d,toggle:B,flyout:S,openFlyout:(a,e,n)=>{clearTimeout(M.current),k({entry:a,anchorY:e,onSelect:n})},scheduleFlyoutClose:()=>{M.current=setTimeout(()=>k(null),160)},cancelFlyoutClose:()=>clearTimeout(M.current)},children:(0,l.jsxs)(b,{children:[(0,l.jsxs)(c,{children:[a&&(0,l.jsx)(s,{children:(0,l.jsx)(f,{onClick:B,title:d?"Expand sidebar":"Collapse sidebar",children:(0,l.jsx)(r.A,{size:17})})}),(0,l.jsxs)(u,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:["Atl",(0,l.jsx)("span",{children:"antis"})]}),t&&(0,l.jsx)(p,{children:t}),o&&(0,l.jsx)(z,{children:o})]}),(0,l.jsxs)(y,{children:[null!=a&&(0,l.jsx)(h,{collapsed:d,children:(0,l.jsx)(A,{children:a})}),(0,l.jsx)(x,{children:e})]}),S&&(0,l.jsx)(i.Suspense,{fallback:null,children:(0,l.jsx)($,{activeId:g})})]})})}var S=n(255),k=n(9753),M=n(5185);const B=t.default.div`
  display: grid;
...
`;function N({iconKey:a,size:e=16}){if(a&&!(a in M.t))return(0,l.jsx)("span",{style:{fontSize:e,lineHeight:1,display:"flex",alignItems:"center"},children:a});const n=a?M.t[a]??S.A:S.A;return(0,l.jsx)(n,{size:e,strokeWidth:1.75})}function G({entry:a,activeId:e,onSelect:n}){const[o,t]=(0,i.useState)(a.defaultOpen??!0),{collapsed:r,openFlyout:g,scheduleFlyoutClose:d,cancelFlyoutClose:c}=(0,m.c)();return a.children&&a.children.length>0?(0,l.jsxs)(C,{children:[(0,l.jsxs)(E,{collapsed:r,onClick:()=>{r||t(a=>!a)},onMouseEnter:r?e=>{const o=e.currentTarget.getBoundingClientRect();g(a,o.top,n)}:void 0,onMouseLeave:r?d:void 0,children:[(0,l.jsxs)(P,{collapsed:r,children:[(0,l.jsx)(N,{iconKey:a.icon,size:16}),(0,l.jsx)(j,{collapsed:r,children:a.name})]}),(0,l.jsx)(L,{open:o,collapsed:r,children:(0,l.jsx)(k.A,{size:13})})]}),(0,l.jsx)(B,{open:o&&!r,children:(0,l.jsx)($,{children:(0,l.jsx)(T,{children:a.children.map(a=>(0,l.jsx)(G,{entry:a,activeId:e,onSelect:n},a.id))})})})]}):(0,l.jsxs)(R,{active:e===a.id,collapsed:r,onClick:()=>n(a),onMouseEnter:r?e=>{const o=e.currentTarget.getBoundingClientRect();g({id:a.id,name:a.name,icon:a.icon,file:a.file,children:[a]},o.top,n)}:void 0,onMouseLeave:r?d:void 0,children:[(0,l.jsx)(N,{iconKey:a.icon,size:15}),(0,l.jsx)(j,{collapsed:r,children:a.name})]})}function K({entries:a,activeId:e,onSelect:n}){return(0,l.jsx)("div",{children:a.map(a=>(0,l.jsx)(G,{entry:a,activeId:e,onSelect:n},a.id))})}const I=n(7207).keyframes`
...
`,t.default.button`
  ...
  background: ${({primary:a,danger:e})=>e?"rgba(248,81,73,0.15)":a?o.w.colors.accent:"none"};
  color: ${({primary:a,danger:e})=>e?"#f85149":a?"#fff":o.w.colors.mainText};
  border: 1px solid ${({primary:a,danger:e})=>e?"#f85149":a?o.w.colors.accent:o.w.colors.border};
