"use strict";(self.webpackChunk_atlantis_cosmos=self.webpackChunk_atlantis_cosmos||[]).push([[779],{4914(e,a,o){o.d(a,{FlyoutPanel:()=>x});var n=o(7359),t=o(3233),i=o(7207),r=o(255),l=o(217),s=o(5959),c=o(5185),d=o(5723);const m=i.keyframes`
...
`,w=i.default.main`
  ...
  display: flex;
  flex-direction: column;
`,A="atlantis:sidebar-collapsed";function $({sidebar:e,children:a,topBarRight:n,title:i="Atlantis",activeId:c=null}){const[d,$]=(0,t.useState)(()=>{try{return"true"===localStorage.getItem(A)}catch{return!1}}),[v,k]=(0,t.useState)(null),S=(0,t.useRef)(),j=()=>$(e=>{const a=!e;try{localStorage.setItem(A,String(a))}catch{}return a}),M=t.useMemo(()=>t.lazy(()=>Promise.resolve().then(o.bind(o,4914)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(s.I.Provider,{value:{collapsed:d,toggle:j,flyout:v,openFlyout:(e,a,o)=>{clearTimeout(S.current),k({entry:e,anchorY:a,onSelect:o})},scheduleFlyoutClose:()=>{S.current=setTimeout(()=>k(null),160)},cancelFlyoutClose:()=>clearTimeout(S.current)},children:(0,r.jsxs)(y,{children:[(0,r.jsxs)(m,{children:[e&&(0,r.jsx)(g,{children:(0,r.jsx)(u,{onClick:j,title:d?"Expand sidebar":"Collapse sidebar",children:(0,r.jsx)(l.A,{size:17})})}),(0,r.jsxs)(f,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:["Atl",(0,r.jsx)("span",{children:"antis"})]}),i&&(0,r.jsx)(p,{children:i}),n&&(0,r.jsx)(h,{children:n})]}),(0,r.jsxs)(x,{children:[null!=e&&(0,r.jsx)(b,{collapsed:d,children:(0,r.jsx)(z,{children:e})}),(0,r.jsx)(w,{children:a})]}),v&&(0,r.jsx)(t.Suspense,{fallback:null,children:(0,r.jsx)(M,{activeId:c})})]})})}var v=o(255),k=o(9753),S=o(5185);const j=i.default.div`
  display: grid;
...
`;function L({iconKey:e,size:a=16}){if(e&&!(e in S.t))return(0,r.jsx)("span",{style:{fontSize:a,lineHeight:1,display:"flex",alignItems:"center"},children:e});const o=e?S.t[e]??v.A:v.A;return(0,r.jsx)(o,{size:a,strokeWidth:1.75})}function R({entry:e,activeId:a,onSelect:o}){const[n,i]=(0,t.useState)(e.defaultOpen??!0),{collapsed:l,openFlyout:c,scheduleFlyoutClose:d,cancelFlyoutClose:m}=(0,s.c)();return e.children&&e.children.length>0?(0,r.jsxs)(P,{children:[(0,r.jsxs)(E,{collapsed:l,onClick:()=>{l||i(e=>!e)},onMouseEnter:l?a=>{const n=a.currentTarget.getBoundingClientRect();c(e,n.top,o)}:void 0,onMouseLeave:l?d:void 0,children:[(0,r.jsxs)(C,{collapsed:l,children:[(0,r.jsx)(L,{iconKey:e.icon,size:16}),(0,r.jsx)(B,{collapsed:l,children:e.name})]}),(0,r.jsx)(I,{open:n,collapsed:l,children:(0,r.jsx)(k.A,{size:13})})]}),(0,r.jsx)(j,{open:n&&!l,children:(0,r.jsx)(M,{children:(0,r.jsx)(T,{children:e.children.map(e=>(0,r.jsx)(R,{entry:e,activeId:a,onSelect:o},e.id))})})})]}):(0,r.jsxs)(F,{active:a===e.id,collapsed:l,onClick:()=>o(e),onMouseEnter:l?a=>{const n=a.currentTarget.getBoundingClientRect();c({id:e.id,name:e.name,icon:e.icon,file:e.file,children:[e]},n.top,o)}:void 0,onMouseLeave:l?d:void 0,children:[(0,r.jsx)(L,{iconKey:e.icon,size:15}),(0,r.jsx)(B,{collapsed:l,children:e.name})]})}function D({entries:e,activeId:a,onSelect:o}){return(0,r.jsx)("div",{children:e.map(e=>(0,r.jsx)(R,{entry:e,activeId:a,onSelect:o},e.id))})}const G=o(7207).keyframes`
...
`,o(4914);var N=o(1920),K=o(8607),H=o(8479);i.default.button`
  display: flex;
  align-items: center;
  justify-content: center;
  width: 32px;
