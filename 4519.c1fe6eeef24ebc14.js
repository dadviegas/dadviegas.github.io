...
`,eS=l().div`
  ...
  min-width: 210px;
  overflow-y: auto;
  animation: ${e$} 0.18s cubic-bezier(0.22, 1, 0.36, 1) forwards;
...
`,eL=({size:e=14,strokeWidth:a=1.75})=>(0,t.jsxs)("svg",{width:e,height:e,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:a,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,t.jsx)("polyline",{points:"14 2 14 8 20 8"})]});function eB({iconKey:e}){let a=e?eM[e]:null;return a?(0,t.jsx)(a,{size:14,strokeWidth:1.75}):(0,t.jsx)(eL,{})}function eU({entries:e,activeId:a,onSelect:o}){return(0,t.jsx)(t.Fragment,{children:e.map(e=>e.children?(0,t.jsx)(i().Fragment,{children:(0,t.jsx)(eU,{entries:e.children,activeId:a,onSelect:o})},e.id):(0,t.jsxs)(e_,{active:a===e.id,onClick:()=>o(e),children:[(0,t.jsx)(eB,{iconKey:e.icon}),e.name]},e.id))})}function ej({activeId:e}){let{flyout:a,scheduleFlyoutClose:o,cancelFlyoutClose:n}=(0,c.c)();if(!a)return null;let i=a.entry.icon?eM[a.entry.icon]:null;return(0,t.jsxs)(eS,{anchorY:a.anchorY,onMouseEnter:n,onMouseLeave:o,children:[(0,t.jsxs)(eE,{children:[i?(0,t.jsx)(i,{size:13,strokeWidth:2}):(0,t.jsx)(eL,{size:13,strokeWidth:2}),a.entry.name]}),(0,t.jsx)(eU,{entries:a.entry.children??[],activeId:e,onSelect:e=>{a.onSelect(e),o()}})]})}},40814(e,a,o){o.d(a,{I:()=>n,c:()=>i});var t=o(37991);let n=(0,t.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),i=()=>(0,t.useContext)(n)},89874(e,a,o){o.d(a,{jv:()=>K.listSettingsByPrefix,NP:()=>C,Fm:()=>K.setStorageProvider,Iu:()=>K.listDocs,TM:()=>ee,eP:()=>P,PL:()=>K.getSetting,xx:()=>ec,VJ:()=>ea,UW:()=>H,Is:()=>K.putSetting,sW:()=>K.clearSettingsByPrefix,PE:()=>_,bg:()=>K.deleteLocalSetting,w4:()=>t.w4});var t=o(81316),n=o(65723),i=o(37991),r=o.n(i),l=o(36859),s=o.n(l);s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
