...
`,j=a().span`
  ...
  color: ${d.w4.colors.mainTextMuted};
  opacity: 0.6;
  transition: opacity ${d.w4.transitions.base}, color ${d.w4.transitions.base};

  &:hover {
    opacity: 1;
    color: ${d.w4.colors.accent};
  }
`;function v({title:e,description:t}){let[i,s]=(0,o.useState)(null),a=(0,o.useRef)(),l=(0,o.useRef)(null);return(0,r.jsxs)(g,{onMouseEnter:()=>{if(clearTimeout(a.current),l.current){let e=l.current.getBoundingClientRect();s({x:e.right+10,y:e.top+e.height/2})}},onMouseLeave:()=>{a.current=setTimeout(()=>s(null),120)},children:[(0,r.jsx)(j,{ref:l,role:"img","aria-label":e,children:(0,r.jsx)(c.In,{name:"info",size:14})}),i&&(0,n.createPortal)((0,r.jsx)(f,{x:i.x,y:i.y,children:(0,r.jsxs)(b,{children:[(0,r.jsx)(y,{children:e}),(0,r.jsx)(w,{children:t})]})}),document.body)]})}let S=a().div`
  display: flex;
  align-items: center;
  gap: ${d.w4.spacing.sm};
...
`,I=a()(c.PH)`
  ...
  padding: 0;
  overflow: hidden;
`;function P({topBarRight:e}){return(0,r.jsx)(c.NI,{title:"Cosmos",sections:m,topBarRight:e,children:(0,r.jsxs)(c.wi,{children:[(0,r.jsxs)(c.KW,{id:"space-metrics",children:[(0,r.jsx)($,{...z}),(0,r.jsx)(c.PH,{children:(0,r.jsx)(p.A,{})})]}),(0,r.jsxs)(M,{id:"satellite-map",children:[(0,r.jsx)($,{...T}),(0,r.jsx)(I,{style:{height:"calc(100% - 36px)"},children:(0,r.jsx)(h.A,{})})]}),(0,r.jsxs)(c.KW,{id:"night-sky",children:[(0,r.jsx)($,{...C}),(0,r.jsx)(c.PH,{children:(0,r.jsx)(x.A,{})})]})]})})}}}]);