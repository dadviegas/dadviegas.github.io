...
`,je=n.default.button`
  ...
  transition: all 0.15s;
  &:hover { border-color: ${s.w4.colors.accent}; color: ${s.w4.colors.accent}; }
`;function ve({topBarRight:e}){const[o,r]=(0,t.useState)(g[0].req),[n,u]=(0,t.useState)(null),[m,ve]=(0,t.useState)(!1),[ke,Te]=(0,t.useState)(null),[ze,Ce]=(0,t.useState)("params"),[Se,Me]=(0,t.useState)("body"),[Ee,Be]=(0,t.useState)(y),[Ae,Fe]=(0,t.useState)(!1),[Oe,He]=(0,t.useState)(!1),Re=(0,t.useRef)(null),Pe=(0,t.useCallback)((e,o)=>{r(r=>({...r,[e]:o}))},[]),qe=(e,r,t)=>{const n=[...o.headers];n[e][r]=t,Pe("headers",n)},Je=(e,r,t)=>{const n=[...o.params];n[e][r]=t,Pe("params",n)},Ne=(0,t.useCallback)(async()=>{if(!o.url.trim())return;Re.current?.abort();const e=new AbortController;Re.current=e,ve(!0),Te(null),u(null);const r=performance.now();try{const t=function(e,o){const r=o.filter(e=>e.enabled&&e.key.trim());if(!r.length)return e;const t=r.map(e=>`${encodeURIComponent(e.key)}=${encodeURIComponent(e.value)}`).join("&");return e.includes("?")?`${e}&${t}`:`${e}?${t}`}(o.url.trim(),o.params),n={};let s;o.headers.filter(e=>e.enabled&&e.key.trim()).forEach(e=>{n[e.key.trim()]=e.value}),"none"!==o.bodyType&&"GET"!==o.method&&"HEAD"!==o.method&&(s=o.body,"json"!==o.bodyType||n["Content-Type"]||n["content-type"]||(n["Content-Type"]="application/json"));const a=await fetch(t,{method:o.method,headers:n,body:s,signal:e.signal}),l=await a.text(),i=Math.round(performance.now()-r),d=(new TextEncoder).encode(l).length,c={};a.headers.forEach((e,o)=>{c[o]=e});const p={status:a.status,statusText:a.statusText,headers:c,body:l,timing:i,size:d};u(p);const h={id:`${Date.now()}-${Math.random()}`,method:o.method,url:o.url,timestamp:Date.now(),status:a.status};Be(e=>{const o=[h,...e];return b(o),o})}catch(e){if("AbortError"===e.name)return;Te(e instanceof Error?e.message:"Request failed")}finally{ve(!1)}},[o]);(0,t.useEffect)(()=>{const e=e=>{(e.ctrlKey||e.metaKey)&&"Enter"===e.key&&(e.preventDefault(),Ne())};return window.addEventListener("keydown",e),()=>window.removeEventListener("keydown",e)},[Ne]);const{pretty:Ie,isJson:De}=n?w(n.body):{pretty:"",isJson:!1},Le=o.headers.filter(e=>e.enabled&&e.key.trim()).length,_e=o.params.filter(e=>e.enabled&&e.key.trim()).length;return(0,x.jsxs)($,{children:[(0,x.jsxs)(j,{children:[(0,x.jsxs)(v,{onClick:()=>{window.location.hash="#/home"},children:["Atl",(0,x.jsx)("span",{children:"antis"})]}),(0,x.jsx)(k,{children:"/"}),(0,x.jsx)(T,{children:"API Explorer"}),(0,x.jsx)(z,{}),(0,x.jsxs)(C,{children:[(0,x.jsx)(s.UO,{appId:f,onLoad:e=>{try{const o=JSON.parse(e);1===o.version&&r(o.request)}catch{}}}),(0,x.jsxs)(je,{onClick:()=>He(!0),children:[(0,x.jsx)(c.A,{size:13}),"Save"]}),e]})]}),(0,x.jsxs)(S,{children:[(0,x.jsxs)(M,{children:[(0,x.jsxs)(E,{children:["History",Ee.length>0&&(0,x.jsx)(B,{title:"Clear history",onClick:()=>{Be([]),b([])},children:(0,x.jsx)(h.A,{size:12})})]}),(0,x.jsxs)(A,{style:{flex:Ee.length?1:0},children:[0===Ee.length&&(0,x.jsx)("div",{style:{padding:"8px 12px",fontSize:11,color:s.w4.colors.sidebarTextMuted},children:"No requests yet"}),Ee.map(e=>(0,x.jsxs)(F,{onClick:()=>r(o=>({...o,method:e.method,url:e.url})),children:[(0,x.jsxs)(O,{children:[e.status&&(0,x.jsx)(q,{status:e.status}),(0,x.jsx)(H,{method:e.method,children:e.method}),(0,x.jsx)(R,{children:e.url.replace(/^https?:\/\//,"")})]}),(0,x.jsxs)(P,{children:[e.status&&(0,x.jsxs)("span",{children:[e.status," · "]}),new Date(e.timestamp).toLocaleTimeString()]})]},e.id))]}),(0,x.jsxs)(J,{children:[(0,x.jsx)(E,{children:"Examples"}),g.map(e=>(0,x.jsxs)(N,{onClick:()=>r(e.req),children:[(0,x.jsx)(H,{method:e.req.method,children:e.req.method}),(0,x.jsx)(I,{children:e.label})]},e.label))]})]}),(0,x.jsxs)(D,{children:[(0,x.jsxs)(L,{children:[(0,x.jsx)(_,{method:o.method,value:o.method,onChange:e=>Pe("method",e.target.value),children:["GET","POST","PUT","PATCH","DELETE","HEAD","OPTIONS"].map(e=>(0,x.jsx)("option",{value:e,children:e},e))}),(0,x.jsx)(G,{value:o.url,onChange:e=>Pe("url",e.target.value),placeholder:"https://api.example.com/endpoint",onKeyDown:e=>{"Enter"!==e.key||e.shiftKey||Ne()}}),(0,x.jsxs)(K,{loading:m,onClick:Ne,disabled:m,children:[(0,x.jsx)(p.A,{size:14}),m?"Sending…":"Send"]})]}),(0,x.jsxs)(le,{children:[(0,x.jsxs)(ie,{children:[(0,x.jsxs)(U,{children:[(0,x.jsxs)(W,{active:"params"===ze,onClick:()=>Ce("params"),children:["Params",_e>0&&(0,x.jsx)(Z,{children:_e})]}),(0,x.jsxs)(W,{active:"headers"===ze,onClick:()=>Ce("headers"),children:["Headers",Le>0&&(0,x.jsx)(Z,{children:Le})]}),(0,x.jsx)(W,{active:"body"===ze,onClick:()=>Ce("body"),children:"Body"})]}),"params"===ze&&(0,x.jsxs)(Q,{children:[o.params.map((e,r)=>(0,x.jsxs)(V,{children:[(0,x.jsx)(X,{type:"checkbox",checked:e.enabled,onChange:e=>Je(r,"enabled",e.target.checked)}),(0,x.jsx)(Y,{mono:!0,placeholder:"key",value:e.key,onChange:e=>Je(r,"key",e.target.value)}),(0,x.jsx)(Y,{mono:!0,placeholder:"value",value:e.value,onChange:e=>Je(r,"value",e.target.value)}),(0,x.jsx)(ee,{onClick:()=>(e=>Pe("params",o.params.filter((o,r)=>r!==e)))(r),children:(0,x.jsx)(h.A,{size:12})})]},r)),(0,x.jsxs)(oe,{onClick:()=>Pe("params",[...o.params,{key:"",value:"",enabled:!0}]),children:[(0,x.jsx)(d.A,{size:12})," Add param"]})]}),"headers"===ze&&(0,x.jsxs)(Q,{children:[o.headers.map((e,r)=>(0,x.jsxs)(V,{children:[(0,x.jsx)(X,{type:"checkbox",checked:e.enabled,onChange:e=>qe(r,"enabled",e.target.checked)}),(0,x.jsx)(Y,{mono:!0,placeholder:"Header-Name",value:e.key,onChange:e=>qe(r,"key",e.target.value)}),(0,x.jsx)(Y,{mono:!0,placeholder:"value",value:e.value,onChange:e=>qe(r,"value",e.target.value)}),(0,x.jsx)(ee,{onClick:()=>(e=>Pe("headers",o.headers.filter((o,r)=>r!==e)))(r),children:(0,x.jsx)(h.A,{size:12})})]},r)),(0,x.jsxs)(oe,{onClick:()=>Pe("headers",[...o.headers,{key:"",value:"",enabled:!0}]),children:[(0,x.jsx)(d.A,{size:12})," Add header"]})]}),"body"===ze&&(0,x.jsxs)(re,{children:[(0,x.jsxs)(te,{children:[(0,x.jsx)(ne,{children:"Body type:"}),["none","json","text","form"].map(e=>(0,x.jsx)(se,{active:o.bodyType===e,onClick:()=>Pe("bodyType",e),children:e},e))]}),"none"!==o.bodyType?(0,x.jsx)(ae,{value:o.body,onChange:e=>Pe("body",e.target.value),placeholder:"json"===o.bodyType?'{\n  "key": "value"\n}':"Request body…",spellCheck:!1}):(0,x.jsxs)(ge,{style:{flex:1},children:[(0,x.jsx)(me,{children:"⊘"}),(0,x.jsx)("span",{children:"No body"})]})]})]}),(0,x.jsxs)(de,{children:[ke&&(0,x.jsxs)(x.Fragment,{children:[(0,x.jsxs)(ce,{children:[(0,x.jsx)(pe,{status:0,children:"Error"}),(0,x.jsx)(he,{children:ke})]}),(0,x.jsxs)(ge,{children:[(0,x.jsx)(me,{children:"⚠"}),(0,x.jsx)("span",{style:{color:"#f85149"},children:ke}),(0,x.jsx)("span",{style:{fontSize:12,marginTop:4},children:"Check the URL or CORS headers on the server."})]})]}),!n&&!ke&&!m&&(0,x.jsxs)(ge,{children:[(0,x.jsx)(me,{children:"🛰"}),(0,x.jsx)("span",{children:"Hit Send to fire a request"}),(0,x.jsx)("span",{style:{fontSize:12},children:"⌘↵ / Ctrl↵ to send"})]}),m&&(0,x.jsxs)(ge,{children:[(0,x.jsx)(me,{style:{animation:"spin 1s linear infinite"},children:"⟳"}),(0,x.jsx)("span",{children:"Waiting for response…"}),(0,x.jsx)("style",{children:"@keyframes spin { to { transform: rotate(360deg); } }"})]}),n&&!m&&(0,x.jsxs)(x.Fragment,{children:[(0,x.jsxs)(ce,{children:[(0,x.jsxs)(pe,{status:n.status,children:[n.status," ",n.statusText]}),(0,x.jsxs)(he,{children:[(0,x.jsx)(l.A,{size:11,style:{display:"inline",marginRight:3}}),n.timing," ms"]}),(0,x.jsx)(he,{children:(Ke=n.size,Ke<1024?`${Ke} B`:Ke<1048576?`${(Ke/1024).toFixed(1)} KB`:`${(Ke/1048576).toFixed(1)} MB`)}),(0,x.jsx)(xe,{copied:Ae,onClick:()=>{if(!n)return;const{pretty:e}=w(n.body);navigator.clipboard.writeText(e).then(()=>{Fe(!0),setTimeout(()=>Fe(!1),1500)})},children:Ae?(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(a.A,{size:11})," Copied"]}):(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(i.A,{size:11})," Copy"]})})]}),(0,x.jsxs)(U,{children:[(0,x.jsx)(W,{active:"body"===Se,onClick:()=>Me("body"),children:"Body"}),(0,x.jsxs)(W,{active:"headers"===Se,onClick:()=>Me("headers"),children:["Headers",(0,x.jsx)(Z,{children:Object.keys(n.headers).length})]})]}),"body"===Se&&(0,x.jsx)(fe,{children:De?(0,x.jsx)(ue,{dangerouslySetInnerHTML:{__html:(Ge=Ie,Ge.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/("(\\u[a-zA-Z0-9]{4}|\\[^u]|[^\\"])*"(\s*:)?|\b(true|false|null)\b|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?)/g,e=>/^"/.test(e)?/:$/.test(e)?`<span style="color:#79c0ff">${e}</span>`:`<span style="color:#a5d6ff">${e}</span>`:/true|false/.test(e)?`<span style="color:#79c0ff">${e}</span>`:/null/.test(e)?`<span style="color:#8b949e">${e}</span>`:`<span style="color:#f2cc60">${e}</span>`))}}):(0,x.jsx)(ue,{children:Ie})}),"headers"===Se&&(0,x.jsx)(fe,{children:(0,x.jsx)(ye,{children:Object.entries(n.headers).map(([e,o])=>(0,x.jsxs)(be,{children:[(0,x.jsx)(we,{children:e}),(0,x.jsx)($e,{children:o})]},e))})})]})]})]})]})]}),Oe&&(0,x.jsx)(s.MJ,{onSave:async e=>{const r={version:1,request:o};await(0,s.KL)(f,e,JSON.stringify(r)),He(!1)},onCancel:()=>He(!1)})]});var Ge,Ke}}}]);
//# sourceMappingURL=36.fbd2f2410d329f880689.js.map