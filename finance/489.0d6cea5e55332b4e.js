"use strict";(self.webpackChunk_atlantis_finance=self.webpackChunk_atlantis_finance||[]).push([["489"],{8501(e,t,n){n.d(t,{J:()=>P});var o=n(5723),a=n(7991),r=n(6859),i=n.n(r),s=n(2799),l=n(4764),c=n(8170),d=n(5030),p=n(1496),g=n(8113),f=n(948);let u="#fb923c",m="#f85149",x="#facc15",h=(0,s.keyframes)`
...
`,w=i().div`
  ...
  color: ${({tone:e})=>"overdue"===e?m:"upcoming"===e?x:l.w4.colors.mainTextMuted};
...
`,N=i().button`
  ...
  &:focus-visible { outline: 2px solid ${l.w4.colors.accent}; outline-offset: 2px; }
`;function I({data:e,onSave:t,onCancel:n,t:r}){let[i,s]=(0,a.useState)(""),[l,c]=(0,a.useState)(""),[d,p]=(0,a.useState)(""),[f,u]=(0,a.useState)(""),[m,x]=(0,a.useState)(""),[h,b]=(0,a.useState)("");async function y(){let n=parseFloat(l);if(!i.trim()||isNaN(n)||n<=0||!d)return;let o=(0,g.addBill)(e,{payee:i.trim(),amount:n,dueDate:d,categoryId:f||void 0,memberId:m||void 0,notes:h.trim()||void 0});(0,g.pushUndo)({id:`bill-add-${Date.now()}`,snapshot:e,labelKey:"finance.undo.label.added",ts:Date.now()}),await t(o)}let w=i.trim().length>0&&parseFloat(l)>0&&d.length>0;return(0,o.jsxs)(F,{children:[(0,o.jsxs)(A,{children:[(0,o.jsx)(D,{type:"text",placeholder:r("finance.bills.payee"),value:i,onChange:e=>s(e.target.value),autoFocus:!0,"aria-label":r("finance.bills.payee")}),(0,o.jsx)(D,{type:"number",min:"0.01",step:"0.01",placeholder:r("finance.bills.amount"),value:l,onChange:e=>c(e.target.value),"aria-label":r("finance.bills.amount"),style:{maxWidth:120}})]}),(0,o.jsxs)(A,{children:[(0,o.jsx)(D,{type:"date",placeholder:r("finance.bills.dueDate"),value:d,onChange:e=>p(e.target.value),"aria-label":r("finance.bills.dueDate"),min:new Date().toISOString().slice(0,10)}),(0,o.jsxs)(E,{value:f,onChange:e=>u(e.target.value),"aria-label":r("finance.bills.category"),children:[(0,o.jsx)("option",{value:"",children:r("finance.bills.category")}),g.DEFAULT_CATEGORIES.map(e=>(0,o.jsx)("option",{value:e.id,children:e.labelEn},e.id))]})]}),e.familyMembers.length>0&&(0,o.jsxs)(A,{children:[(0,o.jsxs)(E,{value:m,onChange:e=>x(e.target.value),"aria-label":r("finance.bills.member"),children:[(0,o.jsx)("option",{value:"",children:r("finance.bills.member")}),e.familyMembers.map(e=>(0,o.jsx)("option",{value:e.id,children:e.name},e.id))]}),(0,o.jsx)(D,{type:"text",placeholder:r("finance.bills.notes"),value:h,onChange:e=>b(e.target.value),"aria-label":r("finance.bills.notes")})]}),(0,o.jsxs)(B,{children:[(0,o.jsx)(H,{type:"button",onClick:n,children:r("finance.bills.cancel")}),(0,o.jsx)(H,{type:"button",primary:!0,disabled:!w,onClick:()=>{y()},children:r("finance.bills.save")})]})]})}function L({bill:e,data:t,onSave:n,t:a}){let r,i=(0,g.daysUntilDue)(e);async function s(){let o=(0,g.markBillPaid)(t,e.id);(0,g.pushUndo)({id:`bill-paid-${Date.now()}`,snapshot:t,labelKey:"finance.undo.label.edited",ts:Date.now()}),await n(o)}async function l(){let o=(0,g.deleteBill)(t,e.id);(0,g.pushUndo)({id:`bill-del-${Date.now()}`,snapshot:t,labelKey:"finance.undo.label.deleted",ts:Date.now()}),await n(o)}return(0,o.jsxs)($,{children:[(0,o.jsxs)(v,{children:[(0,o.jsx)(k,{children:e.payee}),(0,o.jsxs)(M,{children:[(0,o.jsx)(d.Ex,{tone:"neutral",style:i<0?{color:m,borderColor:`${m}44`}:0===i?{color:x,borderColor:`${x}44`}:i<=3?{color:u,borderColor:`${u}44`}:{},children:(r=(0,g.daysUntilDue)(e))<0?a("finance.bills.overdueBy",{n:Math.abs(r)}):0===r?a("finance.bills.dueToday"):1===r?a("finance.bills.due1"):3===r?a("finance.bills.due3"):e.dueDate}),e.paid&&(0,o.jsx)(d.Ex,{tone:"accent",children:a("finance.bills.paid")})]})]}),(0,o.jsxs)(z,{children:[(0,o.jsxs)(j,{children:["€",e.amount.toFixed(2)]}),!e.paid&&(0,o.jsx)(T,{type:"button",onClick:()=>{s()},"aria-label":`${a("finance.bills.markPaid")} — ${e.payee}`,children:a("finance.bills.markPaid")}),(0,o.jsx)(S,{type:"button",className:"bill-delete",title:a("finance.bills.delete"),"aria-label":`${a("finance.bills.delete")} — ${e.payee}`,onClick:()=>{l()},children:(0,o.jsx)(d.In,{name:"trash",size:13})})]})]})}function P(){let[e]=(0,c.Ym)(),t=(0,a.useMemo)(()=>(0,c.Nx)(e,f.A),[e]),{data:n,loaded:r,save:i}=(0,g.useFinance)(),[s,l]=(0,a.useState)(!1),[u,x]=(0,a.useState)(!1);if(!r||null===n)return(0,o.jsxs)(b,{children:[(0,o.jsx)(d.YZ,{children:t("finance.bills.title")}),(0,o.jsx)(p.YG,{mode:"loading",label:t("loading")})]});let h=n.bills??[],$=new Date,v=(0,g.overdueBills)(h,$),k=(0,g.upcomingBills)(h,$),M=h.filter(e=>!e.paid).sort((e,t)=>e.dueDate.localeCompare(t.dueDate)),j=h.filter(e=>e.paid).sort((e,t)=>(t.paidAt??0)-(e.paidAt??0)),z=M.filter(e=>!v.find(t=>t.id===e.id)&&!k.find(t=>t.id===e.id));async function T(e){await i(e)}let S=h.length>0;return(0,o.jsxs)(b,{children:[(0,o.jsxs)(y,{children:[(0,o.jsx)(d.YZ,{children:t("finance.bills.title")}),v.length>0&&(0,o.jsx)(d.Ex,{tone:"neutral",style:{color:m,borderColor:`${m}44`},children:v.length})]}),S||s?(0,o.jsxs)(o.Fragment,{children:[v.length>0&&(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(w,{tone:"overdue",children:t("finance.bills.overdue")}),v.map(e=>(0,o.jsx)(L,{bill:e,data:n,onSave:T,t:t},e.id))]}),k.length>0&&(0,o.jsxs)(o.Fragment,{children:[v.length>0&&(0,o.jsx)(C,{}),(0,o.jsx)(w,{tone:"upcoming",children:t("finance.bills.upcoming")}),k.map(e=>(0,o.jsx)(L,{bill:e,data:n,onSave:T,t:t},e.id))]}),(z.length>0||j.length>0)&&(0,o.jsxs)(o.Fragment,{children:[(v.length>0||k.length>0)&&(0,o.jsx)(C,{}),(0,o.jsxs)(R,{type:"button",onClick:()=>x(e=>!e),"aria-expanded":u,children:[u?"▾":"▸"," ",t("finance.bills.all")," (",z.length+j.length,")"]}),u&&(0,o.jsxs)(o.Fragment,{children:[z.map(e=>(0,o.jsx)(L,{bill:e,data:n,onSave:T,t:t},e.id)),j.map(e=>(0,o.jsx)(L,{bill:e,data:n,onSave:T,t:t},e.id))]})]})]}):(0,o.jsx)(p.YG,{mode:"empty",label:t("finance.bills.empty")}),s?(0,o.jsx)(I,{data:n,onSave:async e=>{await T(e),l(!1)},onCancel:()=>l(!1),t:t}):(0,o.jsxs)(N,{type:"button",onClick:()=>l(!0),children:[(0,o.jsx)(d.In,{name:"plus",size:14,"aria-hidden":!0}),t("finance.bills.add")]})]})}},2167(e,t,n){n.d(t,{X:()=>x});var o=n(5723),a=n(7991),r=n(6859),i=n.n(r),s=n(2799),l=n(4764);let c=(0,s.keyframes)`
...
`,m=i().div`
  ...
  min-height: 0;
  overflow-y: auto;
`;function x({open:e,onClose:t,children:n,maxWidth:r=480,ariaLabel:i}){let s=(0,a.useRef)(null);(0,a.useEffect)(()=>{if(!e)return;let n=e=>{"Escape"===e.key&&t()};return window.addEventListener("keydown",n),()=>window.removeEventListener("keydown",n)},[e,t]),(0,a.useEffect)(()=>{if(!e||!s.current)return;let t=s.current.querySelector('button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])');t?.focus()},[e]);let l=(0,a.useRef)(null),c=(0,a.useCallback)(e=>{l.current={y:e.touches[0].clientY}},[]),d=(0,a.useCallback)(e=>{if(!l.current||!s.current)return;let n=e.changedTouches[0].clientY-l.current.y;l.current=null,n<=0||n/s.current.getBoundingClientRect().height>.3&&t()},[t]),h=(0,a.useRef)(null),b=(0,a.useCallback)(e=>{h.current={y:e.clientY}},[]),y=(0,a.useCallback)(e=>{if(!h.current||!s.current)return;let n=e.clientY-h.current.y;h.current=null,n<=0||n/s.current.getBoundingClientRect().height>.3&&t()},[t]);return e?(0,o.jsx)(p,{onClick:t,role:"dialog","aria-modal":"true","aria-label":i,children:(0,o.jsxs)(g,{ref:s,maxWidth:r,onClick:e=>e.stopPropagation(),children:[(0,o.jsx)(f,{onTouchStart:c,onTouchEnd:d,onPointerDown:b,onPointerUp:y,"aria-hidden":"true",children:(0,o.jsx)(u,{})}),(0,o.jsx)(m,{children:n})]})}):null}},6376(e,t,n){n.d(t,{S:()=>S});var o=n(5723),a=n(7991),r=n(6859),i=n.n(r),s=n(2799),l=n(4764),c=n(5030),d=n(8113);let p=(0,s.keyframes)`
...
`,T=i().div`
  ...
  color: ${l.w4.colors.mainText};
  line-height: 1.5;
`;function S({selectionCount:e,visibleIds:t,selectedIds:n,categories:r,locale:i,t:s,onCancel:p,onSelectAll:C,onCategorise:R,onDelete:F,onMarkReimbursed:A}){let[D,E]=(0,a.useState)(!1),[B,H]=(0,a.useState)(""),[N,I]=(0,a.useState)(!1),[L,P]=(0,a.useState)(!1),[W,O]=(0,a.useState)(!1),Y=(0,a.useRef)(null);(0,a.useEffect)(()=>{D||H("")},[D]),(0,a.useEffect)(()=>{let e=e=>{if("Escape"===e.key){if(D)return void E(!1);if(N)return void I(!1);L&&P(!1)}};return window.addEventListener("keydown",e),()=>window.removeEventListener("keydown",e)},[D,N,L]);let K=(0,a.useCallback)(()=>{B&&(R(B),E(!1))},[B,R]),G=(0,a.useCallback)(()=>{F(),I(!1)},[F]),V=(0,a.useCallback)(()=>{A(),P(!1)},[A]),U=t.length>0&&t.every(e=>n.has(e));return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(g,{role:"toolbar","aria-label":s("finance.bulk.barLabel"),children:(0,o.jsxs)(f,{children:[(0,o.jsx)(u,{children:s("finance.bulk.selected",{n:e})}),(0,o.jsx)(c.$n,{variant:"ghost",style:{height:36,fontSize:12},onClick:U?p:C,children:s(U?"finance.bulk.deselectAll":"finance.bulk.selectAll")}),(0,o.jsx)(m,{}),(0,o.jsx)(c.$n,{variant:"ghost",style:{height:36,fontSize:12},disabled:0===e,onClick:()=>E(!0),children:s("finance.bulk.categorise")}),(0,o.jsx)(c.$n,{variant:"ghost",style:{height:36,fontSize:12},disabled:0===e,onClick:()=>P(!0),children:s("finance.bulk.reimburse")}),(0,o.jsxs)(x,{onMouseEnter:()=>O(!0),onMouseLeave:()=>O(!1),onFocus:()=>O(!0),onBlur:()=>O(!1),children:[(0,o.jsx)("button",{ref:Y,type:"button",disabled:!0,style:{height:36,padding:"0 12px",background:"transparent",border:`1px solid ${l.w4.colors.border}`,borderRadius:l.w4.borderRadius.md,color:l.w4.colors.mainTextMuted,fontSize:12,fontFamily:l.w4.typography.fontFamily,cursor:"not-allowed",opacity:.45},"aria-label":s("finance.bulk.tagComingSoon"),children:s("finance.bulk.tag")}),W&&(0,o.jsx)(h,{role:"tooltip",children:s("finance.bulk.tagComingSoon")})]}),(0,o.jsx)(c.$n,{variant:"danger",style:{height:36,fontSize:12},disabled:0===e,onClick:()=>I(!0),children:s("finance.bulk.delete")}),(0,o.jsx)(c.$n,{variant:"ghost",style:{height:36,fontSize:12},onClick:p,children:s("finance.bulk.cancel")})]})}),D&&(0,o.jsx)(b,{onClick:()=>E(!1),children:(0,o.jsxs)(y,{onClick:e=>e.stopPropagation(),children:[(0,o.jsx)(w,{children:s("finance.bulk.categoriseTitle")}),(0,o.jsx)($,{children:r.map(e=>(0,o.jsxs)(v,{type:"button",selected:B===e.id,catColor:e.color,onClick:()=>H(e.id),children:[(0,o.jsx)(k,{"aria-hidden":!0,children:(0,c.n6)(e.icon)?(0,o.jsx)(c.In,{name:e.icon,size:16,"aria-hidden":!0}):e.icon}),(0,o.jsx)(M,{children:(0,d.categoryLabel)(e,i)})]},e.id))}),(0,o.jsxs)(j,{children:[(0,o.jsx)(c.$n,{variant:"ghost",onClick:()=>E(!1),style:{height:36},children:s("finance.member.cancel")}),(0,o.jsx)(c.$n,{variant:"primary",disabled:!B,onClick:K,style:{height:36},children:s("finance.bulk.applyCategory")})]})]})}),N&&(0,o.jsx)(b,{onClick:()=>I(!1),children:(0,o.jsxs)(z,{onClick:e=>e.stopPropagation(),children:[(0,o.jsx)(w,{children:s("finance.bulk.deleteTitle")}),(0,o.jsx)(T,{children:s("finance.bulk.deleteConfirm",{n:e})}),(0,o.jsxs)(j,{children:[(0,o.jsx)(c.$n,{variant:"ghost",onClick:()=>I(!1),style:{height:36},children:s("finance.member.cancel")}),(0,o.jsx)(c.$n,{variant:"danger",onClick:G,style:{height:36},children:s("finance.bulk.deleteConfirmBtn")})]})]})}),L&&(0,o.jsx)(b,{onClick:()=>P(!1),children:(0,o.jsxs)(z,{onClick:e=>e.stopPropagation(),children:[(0,o.jsx)(w,{children:s("finance.bulk.reimburseTitle")}),(0,o.jsx)(T,{children:s("finance.bulk.reimburseConfirm",{n:e})}),(0,o.jsxs)(j,{children:[(0,o.jsx)(c.$n,{variant:"ghost",onClick:()=>P(!1),style:{height:36},children:s("finance.member.cancel")}),(0,o.jsx)(c.$n,{variant:"primary",onClick:V,style:{height:36},children:s("finance.bulk.reimburseConfirmBtn")})]})]})})]})}},9419(e,t,n){n.d(t,{b:()=>x});var o=n(5723),a=n(7991),r=n(6859),i=n.n(r),s=n(4764);let l="#58a6ff",c="#facc15",d="'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, monospace",p=i().div`
  display: flex;
  flex-direction: column;
  gap: ${s.w4.spacing.sm};
`,g=i().div`
...
`;function m(e){let t=Math.abs(e);return(e<0?"-":"")+(t>=1e3?`€${(t/1e3).toFixed(1)}k`:`€${Math.round(t)}`)}function x({forecast:e,firstNegDate:t,t:n,locale:r,height:i=120}){let h=(0,a.useId)();if(0===e.length)return null;let b=344,y=i-12-28,w=e.map(e=>e.balance),$=Math.min(...w,0),v=Math.max(...w,0)-$||1;function k(e){return 12+y-(e-$)/v*y}let M=b/Math.max(e.length-1,1),j=e.filter(e=>!e.isProjected),z=e.filter(e=>e.isProjected),T=j.length-1,S=e.map((e,t)=>[8+t*M,k(e.balance)]),C=S.slice(0,j.length).map(e=>e.join(",")).join(" "),R=S.slice(Math.max(T,0)).map(e=>e.join(",")).join(" "),F=k(0),A=(0,a.useMemo)(()=>{let t=e.slice(Math.max(T,0));if(t.length<2)return null;let n=Math.max(T,0),o=t.map((e,t)=>[8+(n+t)*M,k(e.balance)]);if(!t.some(e=>e.balance<0))return null;let a=[],r=!1;for(let e=0;e<o.length;e++){let[n,i]=o[e],s=t[e]?.balance??0;if(s<0&&!r){let l=t[e-1]?.balance??0,c=o[e-1]?.[0]??n;if(l>=0&&e>0){let e=c+l/(l-s)*(n-c);a.push(`M${e},${F} L${n},${i}`)}else a.push(`M${n},${i}`);r=!0}else if(s<0&&r)a.push(`L${n},${i}`);else if(s>=0&&r){let i=t[e-1]?.balance??0,l=o[e-1]?.[0]??n;if(i<0){let e=l+Math.abs(i)/(Math.abs(i)+s)*(n-l);a.push(`L${e},${F}`)}r=!1}}if(r){let e=o[o.length-1];e&&a.push(`L${e[0]},${F}`)}return a.join(" ")},[e,T]),D=(0,a.useMemo)(()=>{let t=new Set,n=[];return(e.forEach((e,o)=>{let a=e.date.slice(0,7);!t.has(a)&&(t.add(a),n.push({x:8+o*M,label:function(e,t){let[n,o]=e.split("-").map(Number);return new Date(n,o-1,1).toLocaleDateString("pt"===t?"pt-PT":"en-GB",{month:"short"})}(e.date,r),key:a}))}),n.length>=9)?n.filter((e,t)=>t%2==0):n},[e,r]),E=T>=0?8+T*M:null,B=j[j.length-1]?.balance??0,H=z[z.length-1]?.balance??B;return(0,o.jsxs)(p,{children:[t&&(0,o.jsxs)(g,{role:"alert",children:["⚠ ",n("finance.forecast.projectedNegative")," ",function(e,t){let[n,o,a]=e.split("-").map(Number);return new Date(n,o-1,a).toLocaleDateString("pt"===t?"pt-PT":"en-GB",{day:"2-digit",month:"2-digit"})}(t,r)]}),(0,o.jsxs)("svg",{viewBox:`0 0 360 ${i}`,style:{width:"100%",height:i,display:"block"},preserveAspectRatio:"none","aria-hidden":"true",children:[(0,o.jsx)("defs",{children:(0,o.jsx)("clipPath",{id:`${h}-clip`,children:(0,o.jsx)("rect",{x:0,y:0,width:360,height:i})})}),A&&(0,o.jsx)("path",{d:A,fill:c,opacity:.12,clipPath:`url(#${h}-clip)`}),null!==E&&(0,o.jsx)("rect",{x:E,y:12,width:360-E-8,height:y,fill:s.w4.colors.accent,opacity:.03}),$<0&&(0,o.jsx)("line",{x1:8,x2:8+b,y1:F,y2:F,stroke:c,strokeWidth:"0.75",strokeDasharray:"3 3",opacity:.5}),(0,o.jsx)("line",{x1:8,x2:8+b,y1:12+y,y2:12+y,stroke:s.w4.colors.border,strokeWidth:"1"}),C&&(0,o.jsx)("polyline",{points:C,stroke:l,strokeWidth:"1.5",fill:"none",strokeLinecap:"round",strokeLinejoin:"round",clipPath:`url(#${h}-clip)`}),R&&z.length>0&&(0,o.jsx)("polyline",{points:R,stroke:l,strokeWidth:"1.5",fill:"none",strokeLinecap:"round",strokeLinejoin:"round",strokeDasharray:"4 3",opacity:.75,clipPath:`url(#${h}-clip)`}),null!==E&&(0,o.jsx)("line",{x1:E,x2:E,y1:12,y2:12+y,stroke:s.w4.colors.border,strokeWidth:"1",strokeDasharray:"2 3"}),(0,o.jsx)("g",{fontFamily:d,fontSize:"9",fill:"#8b949e",style:{fontVariantNumeric:"tabular-nums"},children:D.map(e=>(0,o.jsx)("text",{x:e.x,y:i-6,textAnchor:"middle",children:e.label},e.key))}),(0,o.jsx)("text",{fontFamily:d,fontSize:"9",fill:l,x:null!==E?E-3:8,y:20,textAnchor:"end",style:{fontVariantNumeric:"tabular-nums"},children:m(B)}),z.length>0&&(0,o.jsx)("text",{fontFamily:d,fontSize:"9",fill:H<0?c:l,x:8+b,y:Math.max(20,Math.min(12+y-2,k(H)-3)),textAnchor:"end",style:{fontVariantNumeric:"tabular-nums"},children:m(H)})]}),(0,o.jsxs)(f,{children:[(0,o.jsx)(u,{color:l,children:n("finance.forecast.historical")}),(0,o.jsx)(u,{color:l,dashed:!0,children:n("finance.forecast.projected")})]})]})}},341(e,t,n){n.d(t,{z:()=>Q});var o=n(5723),a=n(7991),r=n(6859),i=n.n(r),s=n(2799),l=n(4764),c=n(8170),d=n(5030),p=n(1496),g=n(8113),f=n(948);let u="#7fb77e",m="#facc15",x="#f85149",h=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,b=i().div`
  background: ${l.w4.colors.surface};
...
`,M=i().div`
  ...
  ${({over:e})=>e?`border-left: 2px solid ${x}; padding-left: 6px;`:""}
`,j=i().div`
  display: flex;
  align-items: center;
  gap: ${l.w4.spacing.sm};
...
`,F=i().span`
  ...
  ${({status:e})=>"over"===e?`background: ${x}22; color: ${x};`:"warn"===e?`background: ${m}22; color: ${m};`:`background: ${u}18; color: ${u};`}
`,A=i().div`
  margin-top: 5px;
  height: 4px;
  border-radius: 2px;
...
`,D=i().div`
  ...
  border-radius: 2px;
  background: ${({status:e})=>"over"===e?x:"warn"===e?m:u};
...
`,L=i().button`
  ...
  padding: 4px 10px;
  border-radius: ${l.w4.borderRadius.sm};
  border: 1px solid ${({danger:e})=>e?x:l.w4.colors.border};
  background: none;
  color: ${({danger:e})=>e?x:l.w4.colors.mainText};
  cursor: pointer;
  transition: background 120ms ease, border-color 120ms ease;

  &:hover {
    background: ${({danger:e})=>e?`${x}18`:l.w4.colors.sidebarHover};
    border-color: ${({danger:e})=>e?x:l.w4.colors.mainTextMuted};
  }
`,P=i().button`
  font-family: ${l.w4.typography.fontFamilyMono};
  font-size: 11px;
...
`;function q(e,t){let n=g.DEFAULT_CATEGORIES.find(t=>t.id===e);return n?(0,g.categoryLabel)(n,t):e}function Z(e){return g.DEFAULT_CATEGORIES.find(t=>t.id===e)?.icon??"coins"}function X({progress:e,locale:t,t:n,onSave:r,onRemove:i}){let{categoryId:s,spent:c,budget:p,carryover:g,percent:f,status:u}=e,[m,x]=(0,a.useState)(!1),[h,b]=(0,a.useState)(String(p-g)),[y,w]=(0,a.useState)(!1),[$,v]=(0,a.useState)(!1),k=(0,a.useCallback)(()=>{$||(b(String(p-g)),v(!0)),x(e=>!e)},[$,p,g]),W=(0,a.useCallback)(()=>{let e=parseFloat(h.replace(",","."));isNaN(e)||e<0||(r(s,{amount:e,rollover:y}),x(!1))},[h,y,s,r]),O=q(s,t),Y=Z(s);return(0,o.jsxs)(M,{over:"over"===u,onClick:m?void 0:k,children:[(0,o.jsxs)(j,{children:[(0,o.jsx)(z,{children:(0,d.n6)(Y)?(0,o.jsx)(d.In,{name:Y,size:16,"aria-hidden":!0}):(0,o.jsx)("span",{"aria-hidden":!0,children:Y})}),(0,o.jsx)(T,{children:O}),(0,o.jsxs)(S,{children:[(0,o.jsxs)(C,{children:["€",Math.round(c)]}),(0,o.jsx)(R,{children:"/"}),(0,o.jsxs)(C,{muted:!0,children:["€",Math.round(p)]}),(0,o.jsx)(F,{status:u,children:n("over"===u?"finance.categoryBudgets.statusOver":"warn"===u?"finance.categoryBudgets.statusWarn":"finance.categoryBudgets.statusGood")}),(0,o.jsx)("span",{style:{cursor:"pointer",color:l.w4.colors.mainTextMuted,fontSize:12},onClick:e=>{e.stopPropagation(),k()},"aria-label":n("finance.categoryBudgets.edit"),children:m?"▴":"▾"})]})]}),(0,o.jsx)(A,{children:(0,o.jsx)(D,{pct:f,status:u})}),g>0&&(0,o.jsxs)(E,{children:["+€",g.toFixed(2)," ",n("finance.categoryBudgets.carryoverNote")]}),m&&(0,o.jsxs)(B,{onClick:e=>e.stopPropagation(),children:[(0,o.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:6},children:[(0,o.jsx)("span",{style:{fontSize:13,color:l.w4.colors.mainTextMuted},children:"€"}),(0,o.jsx)(H,{type:"number",min:"0",step:"10",value:h,onChange:e=>b(e.target.value),"aria-label":n("finance.categoryBudgets.amount"),autoFocus:!0})]}),(0,o.jsxs)(N,{children:[(0,o.jsx)("input",{type:"checkbox",checked:y,onChange:e=>w(e.target.checked)}),n("finance.categoryBudgets.rollover")]}),(0,o.jsxs)(I,{children:[(0,o.jsx)(L,{type:"button",danger:!0,onClick:()=>{i(s),x(!1)},children:n("finance.categoryBudgets.remove")}),(0,o.jsx)(L,{type:"button",onClick:()=>x(!1),children:n("finance.categoryBudgets.cancel")}),(0,o.jsx)(P,{type:"button",onClick:W,children:n("finance.categoryBudgets.save")})]})]})]})}function J({catId:e,entry:t,locale:n,t:r,onChange:i,onRemove:s}){let l,[c,p]=(0,a.useState)(String(t.amount)),[g,f]=(0,a.useState)(t.rollover??!1),m=(0,a.useCallback)((t,n)=>{let o=parseFloat(t.replace(",","."));!isNaN(o)&&o>=0&&i(e,{amount:o,rollover:n})},[e,i]);return(0,o.jsxs)("tr",{children:[(0,o.jsxs)("td",{children:[(l=Z(e),(0,d.n6)(l)?(0,o.jsx)(d.In,{name:l,size:14,"aria-hidden":!0,style:{marginRight:6,verticalAlign:"middle"}}):(0,o.jsx)("span",{style:{marginRight:6},"aria-hidden":!0,children:l})),q(e,n)]}),(0,o.jsx)("td",{children:(0,o.jsx)(H,{type:"number",min:"0",step:"10",value:c,onChange:e=>{p(e.target.value),m(e.target.value,g)},"aria-label":r("finance.categoryBudgets.amount"),style:{width:80}})}),(0,o.jsx)("td",{style:{textAlign:"center"},children:(0,o.jsx)("input",{type:"checkbox",checked:g,style:{accentColor:u},onChange:e=>{f(e.target.checked),m(c,e.target.checked)},"aria-label":r("finance.categoryBudgets.rollover")})}),(0,o.jsx)("td",{style:{textAlign:"right"},children:(0,o.jsx)(L,{type:"button",danger:!0,onClick:()=>s(e),children:"\xd7"})})]})}function Q(){let{data:e,loaded:t,save:n}=(0,g.useFinance)(),[r]=(0,c.Ym)(),i=(0,a.useMemo)(()=>(0,c.Nx)(r,f.A),[r]),s=(0,g.thisMonthKey)(),[u,m]=(0,a.useState)(!1),[x,h]=(0,a.useState)(!1),[M,j]=(0,a.useState)(null),z=(0,a.useMemo)(()=>e?(0,g.allCategoryProgress)(e,s):[],[e,s]),T=(0,a.useMemo)(()=>new Set(Object.keys(e?.budget.categoryBudgets??{})),[e]),S=(0,a.useMemo)(()=>g.DEFAULT_CATEGORIES.filter(e=>!T.has(e.id)),[T]),C=(0,a.useCallback)(async(t,o)=>{e&&((0,g.pushUndo)({id:`catbudget-${t}-${Date.now()}`,snapshot:e,labelKey:"finance.undo.label.edited",ts:Date.now()}),await n((0,g.setCategoryBudget)(e,t,o)))},[e,n]),R=(0,a.useCallback)(async t=>{e&&((0,g.pushUndo)({id:`catbudget-rm-${t}-${Date.now()}`,snapshot:e,labelKey:"finance.undo.label.deleted",ts:Date.now()}),await n((0,g.removeCategoryBudget)(e,t)))},[e,n]),F=(0,a.useCallback)(async t=>{e&&(await n((0,g.setCategoryBudget)(e,t,{amount:0,rollover:!1})),h(!1))},[e,n]),A=(0,a.useCallback)(()=>{if(!e)return;let t={};for(let[n,o]of Object.entries(e.budget.categoryBudgets))t[n]="number"==typeof o?{amount:o,rollover:!1}:o;j(t),m(!0)},[e]),D=(0,a.useCallback)((e,t)=>{j(n=>({...n??{},[e]:t}))},[]),E=(0,a.useCallback)(e=>{j(t=>{if(!t)return t;let n={...t};return delete n[e],n})},[]),B=(0,a.useCallback)(async()=>{if(!e||!M)return;(0,g.pushUndo)({id:`catbudget-bulk-${Date.now()}`,snapshot:e,labelKey:"finance.undo.label.edited",ts:Date.now()});let t={...e,budget:{...e.budget,categoryBudgets:M}};await n(t),m(!1),j(null)},[e,M,n]),H=(0,a.useCallback)(()=>{m(!1),j(null)},[]);if(!t)return(0,o.jsxs)(b,{children:[(0,o.jsx)(y,{children:(0,o.jsx)(d.YZ,{children:i("finance.categoryBudgets.title")})}),(0,o.jsx)(k,{children:(0,o.jsx)(p.YG,{mode:"loading",label:i("loading")})})]});let N=e?(0,g.formatMonthLabel)(s,r):"";return(0,o.jsxs)(b,{children:[(0,o.jsxs)(y,{children:[(0,o.jsx)(d.YZ,{children:i("finance.categoryBudgets.title")}),(0,o.jsxs)(w,{children:[(0,o.jsx)("span",{style:{fontFamily:l.w4.typography.fontFamilyMono,fontSize:11,color:l.w4.colors.mainTextMuted,letterSpacing:"0.05em"},children:N}),(0,o.jsx)($,{type:"button",className:u?"active":"",onClick:u?H:A,children:u?i("finance.categoryBudgets.cancelEdit"):i("finance.categoryBudgets.editBudgets")})]})]}),(0,o.jsxs)(k,{children:[!u&&0===z.length&&(0,o.jsx)("div",{style:{textAlign:"center",padding:`${l.w4.spacing.md} 0`},children:(0,o.jsx)(p.YG,{mode:"empty",label:i("finance.categoryBudgets.empty")})}),!u&&z.map(e=>(0,o.jsx)(X,{progress:e,locale:r,t:i,onSave:C,onRemove:R},e.categoryId)),u&&M&&(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(W,{children:(0,o.jsxs)(O,{children:[(0,o.jsx)(Y,{children:(0,o.jsxs)("tr",{children:[(0,o.jsx)("th",{children:i("finance.categoryBudgets.category")}),(0,o.jsx)("th",{children:i("finance.categoryBudgets.amount")}),(0,o.jsx)("th",{style:{textAlign:"center"},children:i("finance.categoryBudgets.rollover")}),(0,o.jsx)("th",{})]})}),(0,o.jsx)(K,{children:Object.keys(M).map(e=>(0,o.jsx)(J,{catId:e,entry:M[e]??{amount:0,rollover:!1},locale:r,t:i,onChange:D,onRemove:E},e))})]})}),(0,o.jsxs)(G,{children:[(0,o.jsx)(L,{type:"button",onClick:H,children:i("finance.categoryBudgets.cancel")}),(0,o.jsx)(P,{type:"button",onClick:B,children:i("finance.categoryBudgets.saveAll")})]})]})]}),!u&&S.length>0&&(0,o.jsxs)(V,{children:[(0,o.jsxs)(v,{type:"button",onClick:()=>h(e=>!e),children:[x?"▴ ":"▾ ",i("finance.categoryBudgets.addBudget")]}),x&&(0,o.jsx)(U,{children:S.map(e=>(0,o.jsxs)(_,{type:"button",onClick:()=>F(e.id),children:[(0,d.n6)(e.icon)?(0,o.jsx)(d.In,{name:e.icon,size:14,"aria-hidden":!0}):(0,o.jsx)("span",{"aria-hidden":!0,children:e.icon}),(0,o.jsx)("span",{style:{fontSize:12,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:(0,g.categoryLabel)(e,r)})]},e.id))})]})]})}},9378(e,t,n){n.d(t,{K:()=>Y});var o=n(5723),a=n(7991),r=n(6859),i=n.n(r),s=n(2799),l=n(4764),c=n(8170),d=n(5030),p=n(1496),g=n(8113),f=n(948),u=n(4041);let m="#7fb77e",x="#f85149",h=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,b=i().div`
  background: ${l.w4.colors.surface};
...
`,T=i().button`
  ...
  border-radius: ${l.w4.borderRadius.sm};
  cursor: pointer;
  color: ${({danger:e})=>e?x:l.w4.colors.mainTextMuted};
...
`,E=i().input`
  ...
  min-width: 120px;
  background: ${l.w4.colors.mainBg};
  border: 1px solid ${({invalid:e})=>e?x:l.w4.colors.border};
  border-radius: ${l.w4.borderRadius.md};
  color: ${l.w4.colors.mainText};
  font-size: 13px;
  font-family: ${l.w4.typography.fontFamilyMono};
  ...
  &:focus { border-color: ${({invalid:e})=>e?x:l.w4.colors.accent}; }
  &::placeholder { color: ${l.w4.colors.mainTextMuted}; }
`,B=i().select`
  flex: 1;
  min-width: 100px;
...
`,W=i().button`
  ...
  &:focus-visible { outline: 2px solid ${l.w4.colors.accent}; outline-offset: 2px; }
`;function O(){return{match:"",matchKind:"substring",categoryId:"other",memberId:""}}function Y(){let[e]=(0,c.Ym)(),t=(0,a.useMemo)(()=>(0,c.Nx)(e,f.A),[e]),{data:n,loaded:r,save:i}=(0,g.useFinance)(),[s,m]=(0,a.useState)(!1),[x,h]=(0,a.useState)(null),[Y,K]=(0,a.useState)(O),G=(0,a.useMemo)(()=>n?.categoryRules??[],[n]),V=Y.match.trim().length>0&&!(0,g.isValidPattern)(Y.match,Y.matchKind),U=Y.match.trim().length>0&&!V,_=(0,a.useCallback)(()=>{h(null),K(O()),m(!0)},[]),q=(0,a.useCallback)(e=>{h(e.id),K({match:e.match,matchKind:e.matchKind,categoryId:e.categoryId,memberId:e.memberId??""}),m(!0)},[]),Z=(0,a.useCallback)(()=>{m(!1),h(null)},[]),X=(0,a.useCallback)(async()=>{if(!n||!U)return;let e=Date.now();if(x){let t=(n.categoryRules??[]).find(e=>e.id===x);if(!t)return;let o={...t,match:Y.match.trim(),matchKind:Y.matchKind,categoryId:Y.categoryId,memberId:Y.memberId||void 0};(0,g.pushUndo)({id:(0,u.z)(),snapshot:n,labelKey:"finance.undo.label.edited",ts:e}),await i({...n,categoryRules:(n.categoryRules??[]).map(e=>e.id===o.id?o:e)})}else{let t={id:(0,u.z)(),match:Y.match.trim(),matchKind:Y.matchKind,categoryId:Y.categoryId,memberId:Y.memberId||void 0,createdAt:e};(0,g.pushUndo)({id:(0,u.z)(),snapshot:n,labelKey:"finance.undo.label.added",ts:e}),await i({...n,categoryRules:[t,...n.categoryRules??[]]})}Z()},[n,Y,x,U,i,Z]),J=(0,a.useCallback)(async e=>{n&&((0,g.pushUndo)({id:(0,u.z)(),snapshot:n,labelKey:"finance.undo.label.deleted",ts:Date.now()}),await i({...n,categoryRules:(n.categoryRules??[]).filter(t=>t.id!==e)}))},[n,i]),Q=(0,a.useCallback)(async(e,t)=>{n&&await i(function(e,t,n){let o=[...e.categoryRules??[]],a=o.findIndex(e=>e.id===t);if(a<0)return e;let r="up"===n?a-1:a+1;return r<0||r>=o.length?e:([o[a],o[r]]=[o[r],o[a]],{...e,categoryRules:o})}(n,e,t))},[n,i]);return r?(0,o.jsxs)(b,{children:[(0,o.jsxs)(y,{children:[(0,o.jsx)(d.YZ,{children:t("finance.categoryRules.title")}),(0,o.jsx)("span",{style:{fontSize:11,fontFamily:l.w4.typography.fontFamilyMono,color:l.w4.colors.mainTextMuted},children:t("finance.categoryRules.orderNote")})]}),0===G.length&&!s&&(0,o.jsx)(p.YG,{mode:"empty",label:t("finance.categoryRules.empty")}),G.map((n,a)=>{let r=g.DEFAULT_CATEGORIES.find(e=>e.id===n.categoryId),i=r?(0,g.categoryLabel)(r,e):n.categoryId;return(0,o.jsxs)(w,{children:[(0,o.jsxs)("div",{style:{display:"flex",flexDirection:"column",gap:1},children:[(0,o.jsx)(W,{type:"button",disabled:0===a,title:t("finance.categoryRules.moveUp"),"aria-label":t("finance.categoryRules.moveUp"),onClick:()=>{Q(n.id,"up")},children:(0,o.jsx)(d.In,{name:"chevron-up",size:12})}),(0,o.jsx)(W,{type:"button",disabled:a===G.length-1,title:t("finance.categoryRules.moveDown"),"aria-label":t("finance.categoryRules.moveDown"),onClick:()=>{Q(n.id,"down")},children:(0,o.jsx)(d.In,{name:"chevron-down",size:12})})]}),(0,o.jsxs)($,{children:[(0,o.jsx)(v,{children:n.match}),(0,o.jsxs)(k,{children:[(0,o.jsx)(M,{children:"regex"===n.matchKind?t("finance.categoryRules.kindRegex"):t("finance.categoryRules.kindSubstring")}),(0,o.jsx)(j,{children:"→"}),(0,o.jsxs)(M,{accent:!0,children:[r?.icon??""," ",i]}),n.memberId&&(0,o.jsxs)(j,{children:["@ ",n.memberId]})]})]}),(0,o.jsxs)(z,{className:"rule-actions",children:[(0,o.jsx)(T,{type:"button",title:t("finance.categoryRules.edit"),"aria-label":t("finance.categoryRules.edit"),onClick:()=>q(n),children:(0,o.jsx)(d.In,{name:"edit",size:14})}),(0,o.jsx)(T,{type:"button",danger:!0,title:t("finance.categoryRules.delete"),"aria-label":t("finance.categoryRules.delete"),onClick:()=>{J(n.id)},children:(0,o.jsx)(d.In,{name:"trash",size:14})})]})]},n.id)}),s&&(0,o.jsxs)(C,{children:[(0,o.jsx)(R,{children:x?t("finance.categoryRules.editTitle"):t("finance.categoryRules.addTitle")}),(0,o.jsxs)(D,{children:[(0,o.jsxs)(A,{style:{flex:2,minWidth:160},children:[(0,o.jsx)(F,{htmlFor:"cr-match",children:t("finance.categoryRules.match")}),(0,o.jsx)(E,{id:"cr-match",invalid:V,value:Y.match,onChange:e=>K(t=>({...t,match:e.target.value})),placeholder:"regex"===Y.matchKind?"^continente":"continente"}),V&&(0,o.jsx)(I,{children:t("finance.categoryRules.invalidRegex")})]}),(0,o.jsxs)(A,{children:[(0,o.jsx)(F,{children:t("finance.categoryRules.matchKind")}),(0,o.jsxs)(H,{children:[(0,o.jsx)(N,{type:"button",active:"substring"===Y.matchKind,onClick:()=>K(e=>({...e,matchKind:"substring"})),children:t("finance.categoryRules.kindSubstring")}),(0,o.jsx)(N,{type:"button",active:"regex"===Y.matchKind,onClick:()=>K(e=>({...e,matchKind:"regex"})),children:t("finance.categoryRules.kindRegex")})]})]})]}),(0,o.jsxs)(D,{children:[(0,o.jsxs)(A,{style:{flex:1,minWidth:120},children:[(0,o.jsx)(F,{htmlFor:"cr-category",children:t("finance.categoryRules.categorize")}),(0,o.jsx)(B,{id:"cr-category",value:Y.categoryId,onChange:e=>K(t=>({...t,categoryId:e.target.value})),children:g.DEFAULT_CATEGORIES.map(t=>(0,o.jsx)("option",{value:t.id,children:(0,g.categoryLabel)(t,e)},t.id))})]}),n&&n.familyMembers.length>0&&(0,o.jsxs)(A,{style:{flex:1,minWidth:120},children:[(0,o.jsx)(F,{htmlFor:"cr-member",children:t("finance.categoryRules.asMember")}),(0,o.jsxs)(B,{id:"cr-member",value:Y.memberId,onChange:e=>K(t=>({...t,memberId:e.target.value})),children:[(0,o.jsx)("option",{value:"",children:t("finance.categoryRules.noMember")}),n.familyMembers.map(e=>(0,o.jsx)("option",{value:e.id,children:e.name},e.id))]})]})]}),(0,o.jsxs)(L,{children:[(0,o.jsx)(P,{type:"button",onClick:Z,children:t("finance.categoryRules.cancel")}),(0,o.jsx)(P,{type:"button",primary:!0,disabled:!U,onClick:()=>{X()},children:t("finance.categoryRules.save")})]})]}),!s&&(0,o.jsxs)(S,{type:"button",onClick:_,children:[(0,o.jsx)(d.In,{name:"plus",size:14}),t("finance.categoryRules.addRule")]})]}):(0,o.jsxs)(b,{children:[(0,o.jsx)(d.YZ,{children:t("finance.categoryRules.title")}),(0,o.jsx)(p.YG,{mode:"loading",label:t("loading")})]})}},2405(e,t,n){n.d(t,{D:()=>C});var o=n(5723),a=n(7991),r=n(6859),i=n.n(r),s=n(2799),l=n(4764);let c=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,d=i().div`
  display: flex;
...
`,$=i().div`
  ...
  border-radius: 1px;
  background: ${({bg:e})=>e};
`,v=new Set([0,4,8,12,16,20]);function k(e){return[parseInt(e.slice(1,3),16),parseInt(e.slice(3,5),16),parseInt(e.slice(5,7),16)]}let M=k("#1d2230"),j=k("#f59e0b");function z(e){let t=Math.round(M[0]+(j[0]-M[0])*e),n=Math.round(M[1]+(j[1]-M[1])*e),o=Math.round(M[2]+(j[2]-M[2])*e);return`rgb(${t},${n},${o})`}let T=function(e=5){return Array.from({length:e},(t,n)=>z(n/(e-1)))}(5),S=["finance.dayHourHeatmap.day.mon","finance.dayHourHeatmap.day.tue","finance.dayHourHeatmap.day.wed","finance.dayHourHeatmap.day.thu","finance.dayHourHeatmap.day.fri","finance.dayHourHeatmap.day.sat","finance.dayHourHeatmap.day.sun"];function C({matrix:e,t}){let n=(0,a.useMemo)(()=>{let t=0;for(let n of e)for(let e of n)e>t&&(t=e);return t},[e]);return 0===n?(0,o.jsx)(h,{children:t("finance.dayHourHeatmap.empty")}):(0,o.jsxs)(d,{children:[(0,o.jsxs)(p,{children:[(0,o.jsx)(f,{}),Array.from({length:24},(e,t)=>(0,o.jsx)(g,{children:v.has(t)?String(t).padStart(2,"0"):""},t))]}),e.map((e,a)=>(0,o.jsxs)(u,{children:[(0,o.jsx)(m,{children:t(S[a]??"finance.dayHourHeatmap.day.mon")}),e.map((e,r)=>{let i=z(n>0?e/n:0),s=e>0?`€${e.toFixed(2)}`:"—",l=`${String(r).padStart(2,"0")}:00`,c=t(S[a]??"finance.dayHourHeatmap.day.mon");return(0,o.jsx)(x,{bg:i,title:t("finance.dayHourHeatmap.tooltip",{day:c,hour:l,amount:s}),"aria-label":`${c} ${l} — ${s}`},r)})]},a)),(0,o.jsxs)(b,{children:[(0,o.jsx)(y,{children:"0"}),(0,o.jsx)(w,{children:T.map((e,t)=>(0,o.jsx)($,{bg:e},t))}),(0,o.jsxs)(y,{children:["€",n.toFixed(0)]})]})]})}},8635(e,t,n){n.d(t,{f:()=>O,z:()=>Y});var o=n(5723),a=n(7991),r=n(6859),i=n.n(r),s=n(2799),l=n(4764),c=n(8170),d=n(5030),p=n(1496),g=n(8113),f=n(948);let u="#7fb77e",m="#f85149",x=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,h=i().div`
  background: ${l.w4.colors.surface};
...
`,H=i().div`
  ...
  color: ${l.w4.colors.mainTextMuted};
  margin-bottom: ${l.w4.spacing.xs};
`;function N({percent:e,color:t,size:n=36}){let a=(n-3)/2,r=2*Math.PI*a,i=r*(1-Math.min(e,1));return(0,o.jsxs)("svg",{width:n,height:n,viewBox:`0 0 ${n} ${n}`,"aria-hidden":!0,style:{flexShrink:0,transform:"rotate(-90deg)"},children:[(0,o.jsx)("circle",{cx:n/2,cy:n/2,r:a,fill:"none",stroke:l.w4.colors.border,strokeWidth:3}),(0,o.jsx)("circle",{cx:n/2,cy:n/2,r:a,fill:"none",stroke:t,strokeWidth:3,strokeDasharray:r,strokeDashoffset:i,strokeLinecap:"round",style:{transition:"stroke-dashoffset 0.4s ease"}})]})}function I({status:e,t}){return"achieved"===e?(0,o.jsx)(d.Ex,{tone:"accent",children:t("finance.goals.achieved")}):"behind"===e?(0,o.jsx)(d.Ex,{tone:"neutral",style:{color:m,borderColor:`${m}44`},children:t("finance.goals.behind")}):(0,o.jsx)(d.Ex,{tone:"neutral",style:{color:u,borderColor:`${u}44`},children:t("finance.goals.onTrack")})}function L(){return new Date().toISOString().slice(0,10)}function P({data:e,onSave:t,onCancel:n,t:r}){let[i,s]=(0,a.useState)(""),[l,c]=(0,a.useState)(""),[d,p]=(0,a.useState)(""),[f,u]=(0,a.useState)("");async function m(){let n=parseFloat(l);if(!i.trim()||isNaN(n)||n<=0)return;let o=(0,g.addGoal)(e,{name:i.trim(),target:n,deadline:d||void 0,memberId:f||void 0});await t(o)}let x=i.trim().length>0&&parseFloat(l)>0;return(0,o.jsxs)(T,{children:[(0,o.jsxs)(S,{children:[(0,o.jsx)(C,{type:"text",placeholder:r("finance.goals.name"),value:i,onChange:e=>s(e.target.value),autoFocus:!0,"aria-label":r("finance.goals.name")}),(0,o.jsx)(C,{type:"number",min:"1",placeholder:r("finance.goals.target"),value:l,onChange:e=>c(e.target.value),"aria-label":r("finance.goals.target"),style:{maxWidth:130}})]}),(0,o.jsxs)(S,{children:[(0,o.jsx)(C,{type:"date",placeholder:r("finance.goals.deadline"),value:d,onChange:e=>p(e.target.value),"aria-label":r("finance.goals.deadline"),min:L()}),e.familyMembers.length>0&&(0,o.jsxs)(R,{value:f,onChange:e=>u(e.target.value),"aria-label":r("finance.goals.member"),children:[(0,o.jsx)("option",{value:"",children:r("finance.goals.member")}),e.familyMembers.map(e=>(0,o.jsx)("option",{value:e.id,children:e.name},e.id))]})]}),(0,o.jsxs)(F,{children:[(0,o.jsx)(A,{type:"button",onClick:n,children:r("finance.goals.cancel")}),(0,o.jsx)(A,{type:"button",primary:!0,disabled:!x,onClick:()=>{m()},children:r("finance.goals.save")})]})]})}function W({goal:e,data:t,onSave:n,onClose:r,t:i}){let[s,c]=(0,a.useState)("");async function d(){let o=parseFloat(s);if(isNaN(o)||o<=0)return;let a=(0,g.contributeToGoal)(t,e.id,o,L());await n(a),r()}let p=parseFloat(s)>0;return(0,o.jsx)(E,{onClick:r,children:(0,o.jsxs)(B,{onClick:e=>e.stopPropagation(),children:[(0,o.jsx)(H,{children:i("finance.goals.contribute")}),(0,o.jsx)("div",{style:{fontSize:16,fontWeight:600,color:l.w4.colors.mainText},children:e.name}),(0,o.jsx)(C,{type:"number",min:"0.01",step:"0.01",placeholder:i("finance.goals.amount"),value:s,onChange:e=>c(e.target.value),autoFocus:!0,"aria-label":i("finance.goals.amount"),style:{width:"100%",maxWidth:"100%"}}),(0,o.jsxs)(F,{children:[(0,o.jsx)(A,{type:"button",onClick:r,children:i("finance.goals.cancel")}),(0,o.jsx)(A,{type:"button",primary:!0,disabled:!p,onClick:()=>{d()},children:i("finance.goals.contribute")})]})]})})}function O(){let[e]=(0,c.Ym)(),t=(0,a.useMemo)(()=>(0,c.Nx)(e,f.A),[e]),{data:n,loaded:r,save:i}=(0,g.useFinance)(),[s,l]=(0,a.useState)(!1),[x,T]=(0,a.useState)(null);if(!r||null===n)return(0,o.jsxs)(h,{children:[(0,o.jsx)(d.YZ,{children:t("finance.goals.title")}),(0,o.jsx)(p.YG,{mode:"loading",label:t("loading")})]});let S=(0,g.recomputeGoalCurrents)(n),C=S.goals;async function R(e){(0,g.pushUndo)({id:`goal-${Date.now()}`,snapshot:n,labelKey:"finance.undo.label.edited",ts:Date.now()}),await i(e)}async function F(e){let t=(0,g.deleteGoal)(S,e);(0,g.pushUndo)({id:`goal-del-${Date.now()}`,snapshot:S,labelKey:"finance.undo.label.deleted",ts:Date.now()}),await i(t)}return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsxs)(h,{children:[(0,o.jsx)(b,{children:(0,o.jsx)(d.YZ,{children:t("finance.goals.title")})}),0!==C.length||s?C.map(e=>{let n=(0,g.goalProgress)(e),a=(0,g.goalStatus)(e),r=e.color??("achieved"===a?u:"behind"===a?m:u),i=Math.round(100*n.percent);return(0,o.jsxs)(y,{children:[(0,o.jsx)(N,{percent:n.percent,color:r}),(0,o.jsxs)(w,{children:[(0,o.jsx)($,{children:e.name}),(0,o.jsxs)(v,{children:[(0,o.jsxs)(k,{children:[i,"% ",t("finance.goals.progress",{pct:i,target:Math.round(e.target)}).replace(String(i)+"% ","")]}),(0,o.jsx)(I,{status:a,t:t}),void 0!==n.monthlyNeeded&&(0,o.jsx)(k,{children:t("finance.goals.monthlyNeeded",{n:n.monthlyNeeded})})]})]}),(0,o.jsxs)(M,{children:["achieved"!==a&&(0,o.jsx)(j,{type:"button",onClick:()=>T(e),"aria-label":`${t("finance.goals.contribute")} — ${e.name}`,children:t("finance.goals.contribute")}),(0,o.jsx)(z,{type:"button",className:"goal-delete",title:t("finance.goals.delete"),"aria-label":`${t("finance.goals.delete")} — ${e.name}`,onClick:()=>{F(e.id)},children:(0,o.jsx)(d.In,{name:"trash",size:13})})]})]},e.id)}):(0,o.jsx)(p.YG,{mode:"empty",label:t("finance.goals.empty")}),s?(0,o.jsx)(P,{data:n,onSave:async e=>{await R(e),l(!1)},onCancel:()=>l(!1),t:t}):(0,o.jsxs)(D,{type:"button",onClick:()=>l(!0),children:[(0,o.jsx)(d.In,{name:"plus",size:14,"aria-hidden":!0}),t("finance.goals.add")]})]}),null!==x&&(0,o.jsx)(W,{goal:x,data:n,onSave:R,onClose:()=>T(null),t:t})]})}function Y({percent:e,color:t,label:n}){let a=2*Math.PI*5,r=a*(1-Math.min(e,1));return(0,o.jsxs)("svg",{width:12,height:12,viewBox:"0 0 12 12","aria-label":n,style:{flexShrink:0,transform:"rotate(-90deg)"},children:[(0,o.jsx)("circle",{cx:6,cy:6,r:5,fill:"none",stroke:l.w4.colors.border,strokeWidth:2}),(0,o.jsx)("circle",{cx:6,cy:6,r:5,fill:"none",stroke:t,strokeWidth:2,strokeDasharray:a,strokeDashoffset:r,strokeLinecap:"round"})]})}},719(e,t,n){n.d(t,{TA:()=>E,a8:()=>f,jb:()=>B});var o=n(5723),a=n(7991),r=n(6859),i=n.n(r),s=n(4764),l=n(5030),c=n(1496),d=n(8113),p=n(8635);let g=["#3b82f6","#8b5cf6","#ec4899","#10b981","#f59e0b","#06b6d4"];function f(e,t){return e.color??g[t%g.length]}let u="#7fb77e",m=i().nav`
  display: flex;
  flex-direction: column;
  width: 100%;
  height: 100%;
...
`,D=i().span`
  ...
  font-variant-numeric: tabular-nums;
  color: ${s.w4.colors.mainTextMuted};
`;function E({data:e,activeMemberId:t,onSelectMember:n,onSaveData:r,t:i,locale:u}){let[F,A]=(0,a.useState)(!1),[D,B]=(0,a.useState)(""),[H,N]=(0,a.useState)("adult"),[I,L]=(0,a.useState)(g[0]),P=(0,d.thisMonthKey)(),W=(()=>{let[e,t]=P.split("-").map(Number),n=new Date(e,t-2,1);return`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,"0")}`})(),O=[{id:"all",name:i("finance.member.all"),role:"shared",color:void 0},{id:"shared",name:i("finance.member.shared"),role:"shared",color:void 0},...e.familyMembers.map((e,t)=>({...e,color:f(e,t)}))];return(0,o.jsxs)(m,{"aria-label":i("finance.nav.ariaLabel"),children:[O.map(a=>{var r;let i,g,f=a.id===t,m=a.color??s.w4.colors.mainTextMuted,v=(0,d.monthlyTotalByMember)(e,a.id,P),k=(r=a.id,i=(0,d.monthlyTotalByMember)(e,r,P),0===(g=(0,d.monthlyTotalByMember)(e,r,W))?0:Math.round((i-g)/g*100)),M=function(e,t){let n=new Date,o=[];for(let a=5;a>=0;a--){let r=new Date(n);r.setDate(n.getDate()-7*a-n.getDay()),r.setHours(0,0,0,0);let i=new Date(r);i.setDate(r.getDate()+7);let s=(0,d.expensesForMember)(e.expenses,t).filter(e=>{let t=new Date(e.date+"T00:00:00");return t>=r&&t<i}).reduce((e,t)=>e+t.amount,0);o.push(s)}return o}(e,a.id),j={id:a.id,name:a.name,role:a.role,color:a.color},z=(0,d.recomputeGoalCurrents)(e).goals.find(e=>e.memberId===a.id),T=z?(0,d.goalProgress)(z):null,S=z?(0,d.goalStatus)(z):null,C=z&&"behind"===S?"#f85149":"#7fb77e";return(0,o.jsxs)(x,{active:f,onClick:()=>n(a.id),type:"button","aria-pressed":f,children:[(0,o.jsxs)("div",{style:{position:"relative",flexShrink:0},children:[(0,o.jsx)(l.eu,{member:j,size:26}),null!==T&&(0,o.jsx)("div",{style:{position:"absolute",bottom:-2,right:-2},children:(0,o.jsx)(p.z,{percent:T.percent,color:C,label:z?.name??""})})]}),(0,o.jsxs)(h,{children:[(0,o.jsx)(b,{active:f,children:a.name}),(0,o.jsxs)(y,{children:[(0,o.jsx)(w,{children:`€${Math.round(v).toLocaleString("pt"===u?"pt-PT":"en-GB")}`}),0!==k&&(0,o.jsxs)($,{positive:k>0,children:[k>0?"↑":"↓",Math.abs(k),"%"]})]})]}),M.some(e=>e>0)&&(0,o.jsx)(c.OW,{points:M,accent:m,width:48,height:24})]},a.id)}),F?(0,o.jsxs)(k,{children:[(0,o.jsx)(M,{type:"text",placeholder:i("finance.member.name"),value:D,onChange:e=>B(e.target.value),autoFocus:!0,"aria-label":i("finance.member.name")}),(0,o.jsxs)(j,{children:[(0,o.jsx)(z,{type:"button",active:"adult"===H,onClick:()=>N("adult"),children:i("finance.member.role.adult")}),(0,o.jsx)(z,{type:"button",active:"child"===H,onClick:()=>N("child"),children:i("finance.member.role.child")})]}),(0,o.jsx)(T,{children:g.map(e=>(0,o.jsx)(S,{type:"button",bg:e,active:I===e,onClick:()=>L(e),"aria-label":e},e))}),(0,o.jsxs)(C,{children:[(0,o.jsx)(R,{type:"button",onClick:()=>A(!1),children:i("finance.member.cancel")}),(0,o.jsx)(R,{type:"button",primary:!0,onClick:function(){if(!D.trim())return;let t={id:`m_${Date.now()}`,name:D.trim(),role:H,color:I};r({...e,familyMembers:[...e.familyMembers,t]}),B(""),N("adult"),L(g[0]),A(!1)},disabled:!D.trim(),children:i("finance.member.save")})]})]}):(0,o.jsxs)(v,{type:"button",onClick:()=>A(!0),children:[(0,o.jsx)(l.In,{name:"user-plus",size:14,"aria-hidden":!0}),i("finance.member.add")]})]})}function B({data:e,activeMemberId:t,onSelectMember:n,t:a,locale:r}){let i=(0,d.thisMonthKey)(),c=[{id:"all",name:a("finance.member.all"),role:"shared",color:void 0},{id:"shared",name:a("finance.member.shared"),role:"shared",color:void 0},...e.familyMembers.map((e,t)=>({...e,color:f(e,t)}))];return(0,o.jsx)(F,{role:"tablist","aria-label":a("finance.nav.ariaLabel"),children:c.map(a=>{let c=a.id===t,p=a.color??s.w4.colors.mainTextMuted,g=(0,d.monthlyTotalByMember)(e,a.id,i),f={id:a.id,name:a.name,role:a.role,color:a.color};return(0,o.jsxs)(A,{active:c,color:p,onClick:()=>n(a.id),type:"button",role:"tab","aria-selected":c,children:[(0,o.jsx)(l.eu,{member:f,size:20}),(0,o.jsx)("span",{children:a.name}),(0,o.jsx)(D,{children:`€${Math.round(g).toLocaleString("pt"===r?"pt-PT":"en-GB")}`})]},a.id)})})}},8989(e,t,n){n.d(t,{f:()=>b});var o=n(5723),a=n(7991),r=n(6859),i=n.n(r),s=n(4764),l=n(8113);function c(e,t){let[n,o]=e.split("-"),a=new Date(parseInt(n),parseInt(o)-1,1),r=a.toLocaleDateString("pt"===t?"pt-PT":"en-GB",{month:"short"}),i=r.charAt(0).toUpperCase()+r.slice(1).replace(".","");return 0===a.getMonth()?`${i} '${String(a.getFullYear()).slice(2)}`:i}let d=i().div`
  background: ${s.w4.colors.mainBg};
  border-bottom: 1px solid ${s.w4.colors.border};
  flex-shrink: 0;
  overflow: hidden;
...
`,h=i().div`
  ...
  opacity: 0.4;
  pointer-events: none;
`;function b({data:e,selectedMonth:t,onSelectMonth:n,locale:r}){let i=(0,a.useRef)(null),y=(0,a.useRef)(null),w=(0,a.useMemo)(()=>(function(){let e=[],t=new Date;for(let n=11;n>=0;n--){let o=new Date(t.getFullYear(),t.getMonth()-n,1);e.push(`${o.getFullYear()}-${String(o.getMonth()+1).padStart(2,"0")}`)}return e})(),[]),$=(0,a.useMemo)(()=>w.map(t=>(0,l.expensesForMonth)(e.expenses,t).reduce((e,t)=>e+t.amount,0)),[w,e.expenses]),v=e.budget.monthlyBudget,k=(0,a.useMemo)(()=>Math.max(...$,0),[$]),M=(0,a.useMemo)(()=>0===k||v<=0?-1:22+Math.round(28*Math.min(v/k,1)),[k,v]);return(0,a.useEffect)(()=>{let e=y.current,t=i.current;if(!e||!t)return;let n=e.offsetLeft,o=n+e.offsetWidth,a=t.scrollLeft,r=a+t.clientWidth;(n<a||o>r)&&t.scrollTo({left:n-t.clientWidth/2+e.offsetWidth/2,behavior:"smooth"})},[t]),(0,o.jsx)(d,{role:"navigation","aria-label":"Month picker",children:(0,o.jsxs)(p,{ref:i,children:[M>=0&&(0,o.jsx)(h,{bottom:M,role:"presentation","aria-hidden":!0}),w.map((e,a)=>{let i=$[a]??0,l=e===t,d=i>v&&v>0,p=k>0?Math.round(i/k*28):0,h=0;return d&&k>0&&v>0&&(h=Math.max(0,p-Math.round(v/k*28))),(0,o.jsxs)(g,{active:l,ref:l?y:void 0,onClick:()=>n(e),"aria-label":`${c(e,r)} — €${Math.round(i)}`,"aria-pressed":l,type:"button",children:[(0,o.jsx)(f,{"aria-hidden":!0,children:p>0?(0,o.jsx)(u,{height:p,color:"#7fb77e",active:l,children:h>0&&(0,o.jsx)(m,{height:h})}):(0,o.jsx)("div",{style:{width:"100%",height:2,background:s.w4.colors.border,borderRadius:2}})}),(0,o.jsx)(x,{active:l,children:c(e,r)})]},e)})]})})}},216(e,t,n){n.d(t,{S:()=>eo});var o=n(5723),a=n(7991),r=n(6859),i=n.n(r),s=n(2799),l=n(4764),c=n(8170),d=n(5030),p=n(1496),g=n(8113),f=n(948);let u="#7fb77e",m="#f85149",x="#58a6ff",h=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,b=i().div`
  background: ${l.w4.colors.surface};
  border: 1px solid ${l.w4.colors.border};
  border-left: 2px solid ${x};
  border-radius: ${l.w4.borderRadius.lg};
  padding: ${l.w4.spacing.lg};
  animation: ${h} 0.25s ease both;
  min-width: 0;
...
`,L=i().button`
  ...
  &:hover { background: ${x}30; border-color: ${x}; }
  &:focus-visible { outline: 2px solid ${l.w4.colors.accent}; outline-offset: 2px; }
`,P=i().div`
  position: fixed;
  inset: 0;
...
`,X=i().button`
  ...
  min-height: 36px;
  border-radius: ${l.w4.borderRadius.md};
  border: 1px solid ${({primary:e})=>e?x:l.w4.colors.border};
  background: ${({primary:e})=>e?`${x}22`:"transparent"};
  color: ${({primary:e})=>e?x:l.w4.colors.mainTextMuted};
  font-size: 13px;
  cursor: pointer;
  transition: all 120ms ease;
  font-family: ${l.w4.typography.fontFamily};
  ...
  &:disabled { opacity: 0.4; cursor: not-allowed; }
  &:focus-visible { outline: 2px solid ${l.w4.colors.accent}; outline-offset: 2px; }
`;function J(){return new Date().toISOString().slice(0,10)}function Q(e,t){let n=Math.abs(e);return`${e<0?"−":""}€${Math.round(n).toLocaleString("pt"===t?"pt-PT":"en-GB")}`}function ee({series:e,locale:t,t:n}){let a,r;if(!e.some(e=>!e.estimated||0!==e.net))return(0,o.jsx)(R,{children:n("finance.netWorth.noSnapshots")});let i=e.length,s=e.map(e=>e.net),c=e.map(e=>e.assets),d=e.map(e=>e.liabilities),p=[...s,...c,...d],g=Math.min(0,...p),f=Math.max(0,...p),h=f-g||1,b=e=>0+e/(i-1)*400,y=e=>6+(f-e)/h*70;function w(e){return e.map((e,t)=>`${b(t)},${y(e)}`).join(" ")}let $=y(0);return(0,o.jsxs)(T,{children:[(0,o.jsxs)("svg",{viewBox:"0 0 400 80",preserveAspectRatio:"none",style:{width:"100%",height:"80px",display:"block",overflow:"visible"},"aria-label":n("finance.netWorth.change12m"),children:[g<0&&f>0&&(0,o.jsx)("line",{x1:0,y1:$,x2:400,y2:$,stroke:l.w4.colors.border,strokeWidth:1,strokeDasharray:"3 3"}),(0,o.jsx)("polyline",{points:w(c),fill:"none",stroke:`${u}88`,strokeWidth:1.5,strokeLinejoin:"round",strokeLinecap:"round"}),(0,o.jsx)("polyline",{points:w(d),fill:"none",stroke:`${m}88`,strokeWidth:1.5,strokeLinejoin:"round",strokeLinecap:"round"}),(0,o.jsx)("polyline",{points:w(s),fill:"none",stroke:x,strokeWidth:2,strokeLinejoin:"round",strokeLinecap:"round"}),(r=s[a=i-1],(0,o.jsx)("circle",{cx:b(a),cy:y(r),r:3,fill:x,stroke:l.w4.colors.surface,strokeWidth:1}))]}),(0,o.jsx)(S,{children:e.filter((e,t)=>0===t||t===Math.floor(i/2)||t===i-1).map(e=>(0,o.jsx)(C,{children:function(e,t){let[n,o]=e.split("-"),a=new Date(parseInt(n),parseInt(o)-1,1),r=a.toLocaleDateString("pt"===t?"pt-PT":"en-GB",{month:"short"}),i=r.charAt(0).toUpperCase()+r.slice(1).replace(".","");return 0===a.getMonth()?`${i}'${String(a.getFullYear()).slice(2)}`:i}(e.month,t)},e.month))})]})}function et({kind:e,data:t,onSave:n,onCancel:r,t:i}){let[s,l]=(0,a.useState)("");async function c(){if(!s.trim())return;let o=(0,g.addNetWorthItem)(t,{label:s.trim(),kind:e});await n(o),r()}return(0,o.jsxs)(B,{children:[(0,o.jsx)(H,{type:"text",autoFocus:!0,placeholder:i("finance.netWorth.itemName"),value:s,onChange:e=>l(e.target.value),onKeyDown:e=>{"Enter"===e.key&&c(),"Escape"===e.key&&r()},"aria-label":i("finance.netWorth.itemName")}),(0,o.jsx)(X,{type:"button",onClick:r,children:i("finance.netWorth.cancel")}),(0,o.jsx)(X,{type:"button",primary:!0,disabled:!s.trim(),onClick:()=>{c()},children:i("finance.netWorth.save")})]})}function en({data:e,onSave:t,onClose:n,t:r}){let[i,s]=(0,a.useState)(J),[l,c]=(0,a.useState)(""),d=(0,a.useMemo)(()=>e.netWorthSnapshots[e.netWorthSnapshots.length-1],[e.netWorthSnapshots]),[p,f]=(0,a.useState)(()=>{let t={};for(let n of e.netWorthItems)t[n.id]=d?String(d.values[n.id]??""):"";return t});function u(e,t){f(n=>({...n,[e]:t}))}async function m(){let o={};for(let t of e.netWorthItems){let e=parseFloat(p[t.id]??"");!isNaN(e)&&e>=0&&(o[t.id]=e)}let a={date:i,values:o,notes:l.trim()||void 0,createdAt:Date.now()},r=(0,g.addOrUpdateSnapshot)(e,a);await t(r),n()}let x=e.netWorthItems.filter(e=>"asset"===e.kind),h=e.netWorthItems.filter(e=>"liability"===e.kind),b=e.netWorthItems.length>0;return(0,o.jsx)(P,{onClick:n,children:(0,o.jsxs)(W,{onClick:e=>e.stopPropagation(),children:[(0,o.jsx)(O,{children:r("finance.netWorth.updateSnapshot")}),(0,o.jsxs)(Y,{children:[(0,o.jsx)(K,{htmlFor:"nw-snap-date",children:r("finance.netWorth.snapshotDate")}),(0,o.jsx)(G,{id:"nw-snap-date",type:"date",value:i,onChange:e=>s(e.target.value),max:J()})]}),x.length>0&&(0,o.jsxs)(Y,{children:[(0,o.jsx)(K,{children:r("finance.netWorth.assets")}),x.map(e=>(0,o.jsxs)(U,{children:[(0,o.jsx)(_,{kind:"asset",children:e.label}),(0,o.jsx)(q,{type:"number",min:"0",step:"0.01",placeholder:"0",value:p[e.id]??"",onChange:t=>u(e.id,t.target.value),"aria-label":e.label})]},e.id))]}),h.length>0&&(0,o.jsxs)(Y,{children:[(0,o.jsx)(K,{children:r("finance.netWorth.liabilities")}),h.map(e=>(0,o.jsxs)(U,{children:[(0,o.jsx)(_,{kind:"liability",children:e.label}),(0,o.jsx)(q,{type:"number",min:"0",step:"0.01",placeholder:"0",value:p[e.id]??"",onChange:t=>u(e.id,t.target.value),"aria-label":e.label})]},e.id))]}),(0,o.jsxs)(Y,{children:[(0,o.jsx)(K,{htmlFor:"nw-snap-notes",children:r("finance.netWorth.notes")}),(0,o.jsx)(V,{id:"nw-snap-notes",placeholder:r("finance.netWorth.notes"),value:l,onChange:e=>c(e.target.value)})]}),(0,o.jsxs)(Z,{children:[(0,o.jsx)(X,{type:"button",onClick:n,children:r("finance.netWorth.cancel")}),(0,o.jsx)(X,{type:"button",primary:!0,disabled:!b||!i,onClick:()=>{m()},children:r("finance.netWorth.save")})]})]})})}function eo(){let[e]=(0,c.Ym)(),t=(0,a.useMemo)(()=>(0,c.Nx)(e,f.A),[e]),{data:n,loaded:r,save:i}=(0,g.useFinance)(),[s,l]=(0,a.useState)(null),[u,m]=(0,a.useState)(!1),x=(0,a.useCallback)(async e=>{n&&((0,g.pushUndo)({id:`nw-${Date.now()}`,snapshot:n,labelKey:"finance.undo.label.edited",ts:Date.now()}),await i(e))},[n,i]);if(!r||null===n)return(0,o.jsxs)(b,{children:[(0,o.jsx)(d.YZ,{children:t("finance.netWorth.title")}),(0,o.jsx)(p.YG,{mode:"loading",label:t("loading")})]});let h=n.netWorthItems,T=n.netWorthSnapshots,S=h.filter(e=>"asset"===e.kind),C=h.filter(e=>"liability"===e.kind),R=(0,g.netWorthSeries)(T,h),B=T[T.length-1],H=B?(0,g.currentNetWorth)(B,h):null,P=async e=>{let t=(0,g.removeNetWorthItem)(n,e);(0,g.pushUndo)({id:`nw-del-${Date.now()}`,snapshot:n,labelKey:"finance.undo.label.deleted",ts:Date.now()}),await i(t)},W=0===h.length;return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsxs)(b,{children:[(0,o.jsxs)(y,{children:[(0,o.jsxs)(w,{children:[(0,o.jsx)(d.YZ,{children:t("finance.netWorth.title")}),null!==H&&(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)($,{positive:H.net>=0,children:Q(H.net,e)}),(0,o.jsx)(v,{children:t("finance.netWorth.current")})]})]}),null!==H&&(0,o.jsxs)(k,{children:[(0,o.jsxs)(M,{children:[(0,o.jsx)(j,{children:t("finance.netWorth.assets")}),(0,o.jsx)(z,{kind:"asset",children:Q(H.assets,e)})]}),(0,o.jsxs)(M,{children:[(0,o.jsx)(j,{children:t("finance.netWorth.liabilities")}),(0,o.jsx)(z,{kind:"liability",children:Q(H.liabilities,e)})]})]})]}),!W&&(0,o.jsx)(ee,{series:R,locale:e,t:t}),W&&(0,o.jsx)(p.YG,{mode:"empty",label:t("finance.netWorth.empty")}),!W&&(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(I,{}),(0,o.jsx)(F,{children:t("finance.netWorth.assets")}),S.map(e=>(0,o.jsxs)(A,{children:[(0,o.jsx)(D,{children:e.label}),(0,o.jsx)(E,{type:"button",className:"nw-delete",title:t("finance.netWorth.delete"),"aria-label":`${t("finance.netWorth.delete")} — ${e.label}`,onClick:()=>{P(e.id)},children:(0,o.jsx)(d.In,{name:"trash",size:13})})]},e.id))]}),"asset"===s?(0,o.jsx)(et,{kind:"asset",data:n,onSave:x,onCancel:()=>l(null),t:t}):(0,o.jsx)(N,{kind:"asset",type:"button",onClick:()=>l("asset"),children:t("finance.netWorth.addAsset")}),!W&&(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(I,{}),(0,o.jsx)(F,{children:t("finance.netWorth.liabilities")}),C.map(e=>(0,o.jsxs)(A,{children:[(0,o.jsx)(D,{children:e.label}),(0,o.jsx)(E,{type:"button",className:"nw-delete",title:t("finance.netWorth.delete"),"aria-label":`${t("finance.netWorth.delete")} — ${e.label}`,onClick:()=>{P(e.id)},children:(0,o.jsx)(d.In,{name:"trash",size:13})})]},e.id))]}),"liability"===s?(0,o.jsx)(et,{kind:"liability",data:n,onSave:x,onCancel:()=>l(null),t:t}):(0,o.jsx)(N,{kind:"liability",type:"button",onClick:()=>l("liability"),children:t("finance.netWorth.addLiability")}),(0,o.jsxs)(L,{type:"button",onClick:()=>m(!0),children:[(0,o.jsx)(d.In,{name:"save",size:13,"aria-hidden":!0}),t("finance.netWorth.updateSnapshot")]})]}),u&&(0,o.jsx)(en,{data:n,onSave:x,onClose:()=>m(!1),t:t})]})}},6579(e,t,n){n.d(t,{J:()=>g,j:()=>d});var o=n(5723),a=n(7991),r=n(6859),i=n.n(r),s=n(4764),l=n(5030),c=n(8113);function d(e,t=6,n=60){let o,a=((o=new Date).setDate(o.getDate()-n),o.toISOString().slice(0,10)),r={};for(let t of e)t.date>=a&&(r[t.categoryId]=(r[t.categoryId]??0)+1);let i=[...Object.entries(r).sort(([,e],[,t])=>t-e).map(([e])=>e)];for(let e of c.DEFAULT_CATEGORIES){if(i.length>=t)break;i.includes(e.id)||i.push(e.id)}return i.slice(0,t)}let p=i().div`
  display: flex;
  gap: ${s.w4.spacing.xs};
  overflow-x: auto;
...
`;function g({expenses:e,storedOrder:t,lockedCategoryId:n,onToggle:r,locale:i,groupLabel:s}){let f=(0,a.useMemo)(()=>(t&&t.length>0?t:d(e)).map(e=>c.DEFAULT_CATEGORIES.find(t=>t.id===e)).filter(e=>void 0!==e),[t,e]);return 0===f.length?null:(0,o.jsx)(p,{role:"group","aria-label":s,children:f.map(e=>{let t=n===e.id,a=(0,c.categoryLabel)(e,i),s="pt"===i?" — selecionado":" — selected";return(0,o.jsxs)(l.vu,{variant:t?"selected":"default",dotColor:e.color,onClick:()=>r(e.id),"aria-pressed":t,"aria-label":`${a}${t?s:""}`,title:a,children:[(0,l.n6)(e.icon)?(0,o.jsx)(l.In,{name:e.icon,size:14,"aria-hidden":!0,style:{marginRight:4}}):(0,o.jsx)("span",{"aria-hidden":!0,style:{marginRight:2},children:e.icon}),a]},e.id)})})}},1789(e,t,n){n.d(t,{b:()=>Q});var o=n(5723),a=n(7991),r=n(6859),i=n.n(r),s=n(2799),l=n(4764),c=n(8170),d=n(5030),p=n(1496),g=n(8113),f=n(948),u=n(4041);let m="#7fb77e",x="#f85149",h=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,b=i().div`
  background: ${l.w4.colors.surface};
...
`,U=i().button`
  ...
  &:disabled { opacity: 0.4; cursor: not-allowed; }
  &:focus-visible { outline: 2px solid ${l.w4.colors.accent}; outline-offset: 2px; }
`;function _(e){return e.toFixed(2)}function q(e){return new Date(e).toLocaleDateString(void 0,{day:"2-digit",month:"short",year:"2-digit"})}function Z(e){let t=new Date(e),n=t.getFullYear(),o=String(t.getMonth()+1).padStart(2,"0"),a=String(t.getDate()).padStart(2,"0");return`${n}-${o}-${a}`}function X(e){return new Date(e+"T00:00:00").getTime()}function J(e){return{description:"",amount:"",categoryId:"other",cadence:"monthly",nextDueAt:Z(e),endsAt:"",memberId:""}}function Q(){let[e]=(0,c.Ym)(),t=(0,a.useMemo)(()=>(0,c.Nx)(e,f.A),[e]),{data:n,loaded:r,save:i}=(0,g.useFinance)(),[s,m]=(0,a.useState)(!1),[x,h]=(0,a.useState)(null),[Q,ee]=(0,a.useState)(()=>J(Date.now())),[et,en]=(0,a.useState)(!1),[eo,ea]=(0,a.useState)(new Set),er=(0,a.useMemo)(()=>(n?.recurringRules??[]).slice().sort((e,t)=>t.createdAt-e.createdAt),[n]),ei=(0,a.useMemo)(()=>n?(0,g.proposeRecurringRules)(n):[],[n]),es=(0,a.useCallback)(()=>{h(null),ee(J(Date.now())),m(!0),en(!1)},[]),el=(0,a.useCallback)(e=>{h(e.id),ee({description:e.description,amount:_(e.amount),categoryId:e.categoryId,cadence:e.cadence,nextDueAt:Z(e.nextDueAt),endsAt:e.endsAt?Z(e.endsAt):"",memberId:e.memberId??""}),m(!0),en(!1)},[]),ec=(0,a.useCallback)(()=>{m(!1),h(null)},[]),ed=(0,a.useCallback)(async()=>{if(!n)return;let e=parseFloat(Q.amount);if(!Q.description.trim()||isNaN(e)||e<=0)return;let t=Date.now(),o=Q.nextDueAt?X(Q.nextDueAt):t,a=Q.endsAt?X(Q.endsAt):void 0;if(x){let r=(n.recurringRules??[]).find(e=>e.id===x);if(!r)return;let s={...r,description:Q.description.trim(),amount:e,categoryId:Q.categoryId,cadence:Q.cadence,nextDueAt:o,endsAt:a,memberId:Q.memberId||void 0};(0,g.pushUndo)({id:(0,u.z)(),snapshot:n,labelKey:"finance.undo.label.edited",ts:t}),await i({...n,recurringRules:(n.recurringRules??[]).map(e=>e.id===s.id?s:e)})}else{let r={id:(0,u.z)(),description:Q.description.trim(),amount:e,categoryId:Q.categoryId,cadence:Q.cadence,nextDueAt:o,endsAt:a,memberId:Q.memberId||void 0,createdAt:t};(0,g.pushUndo)({id:(0,u.z)(),snapshot:n,labelKey:"finance.undo.label.added",ts:t}),await i({...n,recurringRules:[r,...n.recurringRules??[]]})}ec()},[n,Q,x,i,ec]),ep=(0,a.useCallback)(async e=>{if(!n)return;let t=Date.now();(0,g.pushUndo)({id:(0,u.z)(),snapshot:n,labelKey:"finance.undo.label.deleted",ts:t}),await i({...n,recurringRules:(n.recurringRules??[]).filter(t=>t.id!==e)})},[n,i]),eg=(0,a.useCallback)(async e=>{n&&await i({...n,recurringRules:(n.recurringRules??[]).map(t=>t.id===e?{...t,paused:!t.paused}:t)})},[n,i]),ef=(0,a.useCallback)(async()=>{let e;if(!n||0===eo.size)return;let t=ei.filter(e=>eo.has(e.id)),o=Date.now();(0,g.pushUndo)({id:(0,u.z)(),snapshot:n,labelKey:"finance.undo.label.added",ts:o}),await i((e=t.map(e=>({id:(0,u.z)(),description:e.merchant,amount:e.amount,categoryId:e.categoryId,cadence:e.cadence,nextDueAt:e.suggestedNextDueAt,memberId:e.memberId,createdAt:o})),{...n,recurringRules:[...e,...n.recurringRules??[]]})),ea(new Set),en(!1)},[n,ei,eo,i]),eu=(0,a.useCallback)(e=>{ea(t=>{let n=new Set(t);return n.has(e)?n.delete(e):n.add(e),n})},[]);return r?(0,o.jsxs)(b,{children:[(0,o.jsxs)(y,{children:[(0,o.jsx)(d.YZ,{children:t("finance.recurring.title")}),(0,o.jsx)(w,{children:ei.length>0&&(0,o.jsx)($,{type:"button",onClick:()=>{en(e=>!e),m(!1)},"aria-expanded":et,children:t("finance.recurring.proposeFromHistory")})})]}),0===er.length&&!s&&(0,o.jsx)(p.YG,{mode:"empty",label:t("finance.recurring.empty")}),er.map(e=>{var n;return(0,o.jsxs)(v,{paused:e.paused,children:[(0,o.jsxs)(k,{children:[(0,o.jsx)(M,{children:e.description}),(0,o.jsxs)(j,{children:[(0,o.jsx)(d.Ex,{tone:"neutral",children:t("weekly"===(n=e.cadence)?"finance.recurring.cadence.weekly":"yearly"===n?"finance.recurring.cadence.yearly":"finance.recurring.cadence.monthly")}),(0,o.jsxs)(z,{children:[t("finance.recurring.nextDue")," ",q(e.nextDueAt)]}),e.paused&&(0,o.jsx)(d.Ex,{tone:"neutral",style:{color:"#facc15"},children:t("finance.recurring.paused")})]})]}),(0,o.jsxs)(T,{children:["€",_(e.amount)]}),(0,o.jsxs)(S,{className:"rule-actions",children:[(0,o.jsx)(C,{type:"button",title:t("finance.recurring.edit"),"aria-label":t("finance.recurring.edit"),onClick:()=>el(e),children:(0,o.jsx)(d.In,{name:"edit",size:14})}),(0,o.jsx)(C,{type:"button",title:e.paused?t("finance.recurring.resume"):t("finance.recurring.pause"),"aria-label":e.paused?t("finance.recurring.resume"):t("finance.recurring.pause"),onClick:()=>{eg(e.id)},children:(0,o.jsx)(d.In,{name:e.paused?"play":"pause",size:14})}),(0,o.jsx)(C,{type:"button",danger:!0,title:t("finance.recurring.delete"),"aria-label":t("finance.recurring.delete"),onClick:()=>{ep(e.id)},children:(0,o.jsx)(d.In,{name:"trash",size:14})})]})]},e.id)}),s&&(0,o.jsxs)(R,{children:[(0,o.jsx)(L,{children:x?t("finance.recurring.editTitle"):t("finance.recurring.newTitle")}),(0,o.jsxs)(D,{children:[(0,o.jsxs)(A,{style:{flex:2,minWidth:160},children:[(0,o.jsx)(F,{htmlFor:"rec-desc",children:t("finance.recurring.description")}),(0,o.jsx)(E,{id:"rec-desc",value:Q.description,onChange:e=>ee(t=>({...t,description:e.target.value})),placeholder:"Continente, Netflix…"})]}),(0,o.jsxs)(A,{style:{flex:1,minWidth:100},children:[(0,o.jsx)(F,{htmlFor:"rec-amount",children:t("finance.recurring.amount")}),(0,o.jsx)(E,{id:"rec-amount",type:"number",min:"0.01",step:"0.01",value:Q.amount,onChange:e=>ee(t=>({...t,amount:e.target.value})),placeholder:"12.50",style:{fontFamily:l.w4.typography.fontFamilyMono}})]})]}),(0,o.jsxs)(D,{children:[(0,o.jsxs)(A,{style:{flex:1,minWidth:120},children:[(0,o.jsx)(F,{htmlFor:"rec-cadence",children:t("finance.recurring.frequency")}),(0,o.jsxs)(B,{id:"rec-cadence",value:Q.cadence,onChange:e=>ee(t=>({...t,cadence:e.target.value})),children:[(0,o.jsx)("option",{value:"weekly",children:t("finance.recurring.cadence.weekly")}),(0,o.jsx)("option",{value:"monthly",children:t("finance.recurring.cadence.monthly")}),(0,o.jsx)("option",{value:"yearly",children:t("finance.recurring.cadence.yearly")})]})]}),(0,o.jsxs)(A,{style:{flex:1,minWidth:120},children:[(0,o.jsx)(F,{htmlFor:"rec-category",children:t("finance.recurring.category")}),(0,o.jsx)(B,{id:"rec-category",value:Q.categoryId,onChange:e=>ee(t=>({...t,categoryId:e.target.value})),children:g.DEFAULT_CATEGORIES.map(t=>(0,o.jsx)("option",{value:t.id,children:(0,g.categoryLabel)(t,e)},t.id))})]})]}),(0,o.jsxs)(D,{children:[(0,o.jsxs)(A,{style:{flex:1,minWidth:120},children:[(0,o.jsx)(F,{htmlFor:"rec-nextdue",children:t("finance.recurring.nextDue")}),(0,o.jsx)(E,{id:"rec-nextdue",type:"date",value:Q.nextDueAt,onChange:e=>ee(t=>({...t,nextDueAt:e.target.value}))})]}),(0,o.jsxs)(A,{style:{flex:1,minWidth:120},children:[(0,o.jsx)(F,{htmlFor:"rec-endsat",children:t("finance.recurring.endsAt")}),(0,o.jsx)(E,{id:"rec-endsat",type:"date",value:Q.endsAt,onChange:e=>ee(t=>({...t,endsAt:e.target.value}))})]})]}),(0,o.jsxs)(H,{children:[(0,o.jsx)(N,{type:"button",onClick:ec,children:t("finance.recurring.cancel")}),(0,o.jsx)(N,{type:"button",primary:!0,onClick:()=>{ed()},disabled:!Q.description.trim()||!parseFloat(Q.amount),children:t("finance.recurring.save")})]})]}),!s&&(0,o.jsxs)(I,{type:"button",onClick:es,children:[(0,o.jsx)(d.In,{name:"plus",size:14}),t("finance.recurring.addRule")]}),et&&(0,o.jsxs)(P,{children:[(0,o.jsx)(L,{children:t("finance.recurring.proposeTitle")}),0===ei.length?(0,o.jsx)(p.YG,{mode:"empty",label:t("finance.recurring.proposeEmpty")}):(0,o.jsxs)(o.Fragment,{children:[ei.map(e=>(0,o.jsxs)(W,{children:[(0,o.jsx)(O,{type:"checkbox",id:`prop-${e.id}`,checked:eo.has(e.id),onChange:()=>eu(e.id)}),(0,o.jsxs)(Y,{children:[(0,o.jsx)(K,{children:e.merchant}),(0,o.jsxs)(G,{children:[(0,o.jsx)(z,{children:t("finance.recurring.occurrences",{n:e.occurrences})}),(0,o.jsx)(z,{children:t("finance.recurring.lastSeen",{date:q(e.lastSeen)})})]})]}),(0,o.jsxs)(V,{children:["€",_(e.amount)]})]},e.id)),(0,o.jsxs)(U,{type:"button",disabled:0===eo.size,onClick:()=>{ef()},children:[t("finance.recurring.accept")," (",eo.size,")"]})]})]})]}):(0,o.jsxs)(b,{children:[(0,o.jsx)(d.YZ,{children:t("finance.recurring.title")}),(0,o.jsx)(p.YG,{mode:"loading",label:t("loading")})]})}},5854(e,t,n){n.d(t,{m:()=>M});var o=n(5723),a=n(7991),r=n(2727),i=n.n(r),s=n(6859),l=n.n(s),c=n(2799),d=n(4764),p=n(5030);let g=(0,c.keyframes)`
...
`;function j(e){return e.toFixed(2)}function z(e){return 7===e?"finance.subs.cadence.weekly":365===e?"finance.subs.cadence.yearly":"finance.subs.cadence.monthly"}function T(e){return e.amount*(30/e.cadenceDays)}function S(){let[e]=(0,c.Ym)(),t=(0,a.useMemo)(()=>(0,c.Nx)(e,f.A),[e]),{candidates:n,monthlyTotal:r,cancelCandidates:i,loaded:s}=(0,g.useSubscriptions)();if(!s)return(0,o.jsxs)(m,{children:[(0,o.jsx)(d.YZ,{children:t("finance.subs.title")}),(0,o.jsx)(p.YG,{mode:"loading",label:t("loading")})]});if(0===n.length)return(0,o.jsxs)(m,{children:[(0,o.jsx)(d.YZ,{children:t("finance.subs.title")}),(0,o.jsx)(p.YG,{mode:"empty",label:t("finance.subs.empty")})]});let u=n.filter(e=>e.staleDays<=60).sort((e,t)=>T(t)-T(e)).slice(0,5);return(0,o.jsxs)(m,{children:[(0,o.jsxs)(x,{children:[(0,o.jsxs)("div",{children:[(0,o.jsx)(d.YZ,{children:t("finance.subs.title")}),(0,o.jsx)(b,{children:t("finance.subs.monthlyTotal")})]}),(0,o.jsxs)(h,{children:["€",j(r)]})]}),u.length>0&&(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(y,{children:t("finance.subs.activeHeader")}),u.map(e=>(0,o.jsx)(p.$8,{label:e.description,sub:(0,o.jsx)(d.Ex,{tone:"neutral",children:t(z(e.cadenceDays))}),value:(0,o.jsxs)(v,{children:["€",j(T(e)),(0,o.jsx)("span",{style:{fontSize:10,color:l.w4.colors.mainTextMuted},children:"/mo"})]})},e.id))]}),i.length>0&&(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(M,{}),(0,o.jsx)(w,{children:t("finance.subs.staleHeader")}),i.slice(0,5).map(e=>(0,o.jsx)(p.$8,{label:e.description,sub:(0,o.jsx)(d.Ex,{tone:"neutral",children:t(z(e.cadenceDays))}),value:(0,o.jsxs)($,{children:[(0,o.jsx)(k,{children:t("finance.subs.staleDays",{n:e.staleDays})}),(0,o.jsxs)(v,{children:["€",j(e.amount)]})]})},e.id))]})]})}},9546(e,t,n){n.d(t,{S:()=>m});var o=n(5723),a=n(7991),r=n(6859),i=n.n(r),s=n(2799),l=n(4764);let c=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(12px); }
  to   { opacity: 1; transform: translateY(0); }
`,d=(0,s.keyframes)`
...
`,b=r().forwardRef(function({variant:e="ghost",size:t="md",icon:n,iconRight:a,children:r,...i},s){return(0,o.jsxs)(h,{ref:s,variant:e,size:t,...i,children:[n,r,a]})}),y={default:l.w4.colors.accent,danger:"#f85149"},w={default:l.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"},$=s().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`,M=s().div`
  ...
  z-index: 2000;
  overflow: hidden;
`;function j({trigger:e,children:t,align:n="right",open:i,onOpenChange:s}){let[l,c]=(0,a.useState)(!1),d=i??l,p=e=>{s&&s(e),void 0===i&&c(e)},g=(0,a.useRef)(null);(0,a.useEffect)(()=>{if(!d)return;let e=e=>{g.current&&!g.current.contains(e.target)&&p(!1)};return document.addEventListener("mousedown",e),()=>document.removeEventListener("mousedown",e)},[d]);let f=r().cloneElement(e,{onClick:t=>{e.props.onClick?.(t),p(!d)},"aria-expanded":d,"aria-haspopup":"menu"});return(0,o.jsxs)(k,{ref:g,children:[f,d&&(0,o.jsx)(M,{align:n,role:"menu",children:t})]})}let z=s().button`
  display: flex;
  align-items: center;
  gap: 10px;
  padding: 8px 12px;
...
`,B=s().span`
  ...
  line-height: 1;
  letter-spacing: 0;
`,H=["#3b82f6","#8b5cf6","#ec4899","#10b981","#f59e0b","#06b6d4"],N=0,I=new Map;function L({member:e,size:t=24}){var n,a;let r,i="shared"===e.id||"shared"===e.role,s=Math.floor(.55*t),c=t<=18?8:t<=22?9:t<=28?11:12;if(i)return(0,o.jsx)(E,{size:t,bg:l.w4.colors.surface,ring:!0,"aria-label":"Shared",title:"Shared",style:{color:l.w4.colors.mainTextMuted},children:(0,o.jsx)(D,{name:"home",size:s,"aria-hidden":!0})});let d=(n=e.id,(a=e.color)?a:(!I.has(n)&&(I.set(n,H[N%H.length]),N++),I.get(n))),p="adult"===e.role,g=(r=e.name.trim().split(/\s+/),((r[0]?.[0]??"")+(r[1]?.[0]??"")).toUpperCase().slice(0,2));return(0,o.jsx)(E,{size:t,bg:d,ring:p,title:e.name,children:(0,o.jsx)(B,{fontSize:c,children:g})})}s().img`
  width: ${({size:e})=>e}px;
  height: ${({size:e})=>e}px;
  border-radius: 50%;
  object-fit: cover;
...
`,K=s().span`
  ...
  background: ${({color:e})=>e};
  display: inline-block;
`,G=r().forwardRef(function({variant:e="default",dotColor:t,children:n,onClick:a,...r},i){return(0,o.jsxs)(Y,{ref:i,variant:e,clickable:!!a,onClick:a,type:r.type??"button",...r,children:[t&&(0,o.jsx)(K,{color:t}),n]})}),V={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:l.w4.colors.accentMuted},U={neutral:l.w4.colors.mainTextMuted,live:l.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:l.w4.colors.accent},_=s().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${l.w4.typography.fontFamilyMono};
...
`,q=s().span`
  ...
  display: inline-block;
`;function Z({tone:e="neutral",dot:t,children:n,...a}){return(0,o.jsxs)(_,{tone:e,...a,children:[(t??"live"===e)&&(0,o.jsx)(q,{}),n]})}let X=s().kbd`
  font-family: ${l.w4.typography.fontFamilyMono};
  font-size: 10px;
  padding: 2px 6px;
  border: 1px solid ${l.w4.colors.border};
  ...
  white-space: nowrap;
`;function J({children:e,...t}){return(0,o.jsx)(X,{...t,children:e})}let Q=s().div`
  font-family: ${l.w4.typography.fontFamilyMono};
  font-size: 11px;
  letter-spacing: 0.16em;
  text-transform: uppercase;
  ...
  align-items: center;
  gap: 8px;
`;function ee({children:e,...t}){return(0,o.jsx)(Q,{...t,children:e})}s().label`
  display: flex;
  align-items: center;
  gap: 10px;
...
`;function es({title:e,accessory:t,accentColor:n,error:a,errorLabel:r,children:i}){return(0,o.jsxs)(et,{accentColor:n,"data-widget-shell":!0,children:[(0,o.jsxs)(en,{children:[(0,o.jsx)(ee,{children:e}),t&&(0,o.jsx)(eo,{children:t})]}),a?(0,o.jsxs)(er,{role:"alert",children:[(0,o.jsx)(ei,{children:r??"Error"}),(0,o.jsx)("div",{children:a})]}):(0,o.jsx)(ea,{children:i})]})}s().div`
  position: relative;
  display: flex;
  flex-direction: column;
  height: 100%;
...
`,ef.A,ef.A['pre[class*="language-"]'],l.w4.colors.codeBg,ef.A['code[class*="language-"]'],s().div`
  background: ${({bg:e})=>e};
...
`;function eM({size:e}){return(0,o.jsxs)("svg",{width:14,height:14,viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:[(0,o.jsx)("rect",{x:1.5,y:4.5,width:11,height:5,rx:1,stroke:"currentColor",strokeWidth:1,opacity:.4}),(0,o.jsx)("rect",{x:2,y:5,width:"sm"===e?4:"md"===e?7:11,height:4,rx:.5,fill:"currentColor"})]})}let ej={sm:1,md:2,lg:"full"};function ez({items:e,onReorder:t,onCycleSize:n,onRemove:a,renderPanel:r,renderAccessory:i,showGrip:s=!0,labels:l,accentColor:c}){return(0,o.jsx)(eh,{children:e.map((d,p)=>{let g=ej[d.size],f="full"===g,u=d.minHeight??160,m=c?.(d),x=(d.availableSizes??["sm","md","lg"]).length>1,h=i?.(d);return(0,o.jsxs)(eb,{colSpan:f?1:g,fullWidth:f,children:[h&&(0,o.jsx)(ey,{children:h}),(0,o.jsxs)(ew,{minH:u,accent:m,"data-grip":s?"true":"false",children:[(0,o.jsxs)(e$,{className:"panel-controls",children:[p>0&&(0,o.jsx)(ev,{type:"button",title:l.moveLeft,onClick:()=>t(d.id,-1),children:(0,o.jsx)(D,{name:"chevron-left",size:14})}),p<e.length-1&&(0,o.jsx)(ev,{type:"button",title:l.moveRight,onClick:()=>t(d.id,1),children:(0,o.jsx)(D,{name:"chevron-right",size:14})}),x&&(0,o.jsx)(ev,{type:"button",title:`${l.cycleSize} \xb7 ${d.size.toUpperCase()}`,onClick:()=>n(d.id),children:(0,o.jsx)(eM,{size:d.size})}),a&&l.remove&&(0,o.jsx)(ek,{type:"button",title:l.remove,onClick:()=>a(d.id),children:(0,o.jsx)(D,{name:"close",size:14})})]}),r(d)]})]},d.id)})})}let eT=(0,C.keyframes)`
...
`,s().div`
  position: relative;
`},2188(e,t,n){n.d(t,{OW:()=>f,$8:()=>v,ik:()=>M,Xj:()=>H,Ru:()=>m,kl:()=>A,RT:()=>R,RJ:()=>z,YG:()=>p});var o=n(5723),a=n(6859),r=n.n(a),i=n(4764);let s=r().div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
`,c=r().p`
  ...
  margin: 0;
  line-height: 1.5;
`,d={loading:"◌ Loading",empty:"◎ Empty",error:"◎ Offline"};function p({mode:e,label:t,body:n}){return(0,o.jsxs)(s,{children:[(0,o.jsx)(l,{mode:e,children:t??d[e]}),n&&(0,o.jsx)(c,{children:n})]})}var g=n(7991);function f({points:e,accent:t=i.w4.colors.accent,width:n=60,height:a=28,strokeWidth:r=1.5}){let s=(0,g.useMemo)(()=>{if(e.length<2)return"";let t=Math.min(...e),o=Math.max(...e)-t||1,i=n-2*r,s=a-2*r;return e.map((n,a)=>{let l=r+a/(e.length-1)*i,c=r+s-(n-t)/o*s;return`${0===a?"M":"L"} ${l.toFixed(1)} ${c.toFixed(1)}`}).join(" ")},[e,n,a,r]),l=(0,g.useMemo)(()=>{if(e.length<1)return null;let t=e[e.length-1],o=Math.min(...e),i=n-2*r,s=a-2*r;return{x:r+i,y:r+s-(t-o)/(Math.max(...e)-o||1)*s}},[e,n,a,r]);return s?(0,o.jsxs)("svg",{width:n,height:a,viewBox:`0 0 ${n} ${a}`,"aria-hidden":"true",style:{display:"block",flexShrink:0},children:[(0,o.jsx)("path",{d:s,fill:"none",stroke:t,strokeWidth:r,strokeLinecap:"round",strokeLinejoin:"round",opacity:.7}),l&&(0,o.jsx)("circle",{cx:l.x,cy:l.y,r:r+1,fill:t})]}):null}let u=r().span`
  font-family: ${i.w4.typography.fontFamilyMono};
  font-size: 11px;
  font-weight: 500;
  font-variant-numeric: tabular-nums;
  ...
  white-space: nowrap;
`;function m({value:e,format:t="pct",decimals:n=2}){let a=e>0?"pos":e<0?"neg":"zero",r=Math.abs(e).toFixed(n);return(0,o.jsxs)(u,{sign:a,children:["pos"===a?"▲":"neg"===a?"▼":"—"," ",r,"pct"===t?"%":""]})}let x=r().div`
  display: flex;
  align-items: baseline;
  justify-content: space-between;
  gap: ${i.w4.spacing.sm};
...
`,$=r().span`
  ...
  flex-shrink: 0;
  text-align: right;
`;function v({label:e,value:t,sub:n,href:a,onClick:r}){let i=(0,o.jsxs)(o.Fragment,{children:[(0,o.jsxs)(b,{children:[(0,o.jsx)(y,{children:e}),n&&(0,o.jsx)(w,{children:n})]}),void 0!==t&&(0,o.jsx)($,{children:t})]});return a?(0,o.jsx)(h,{href:a,target:"_blank",rel:"noopener noreferrer",children:i}):(0,o.jsx)(x,{onClick:r,children:i})}n(3090);let k="'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, monospace";function M({data:e,budget:t,height:n=200,animation:a="rise"}){let r=(0,g.useId)();if(!e.length)return null;let s=1.1*Math.max(...e.map(e=>e.segments.reduce((e,t)=>e+t.value,0)+(e.over??0)),t??0)||1,l=472,c=n-20-24,d=472/e.length*.58,p=l/e.length,f="rise"===a?{transformOrigin:"bottom",animation:`${r}_rise 0.45s ease-out both`}:{};return(0,o.jsxs)(o.Fragment,{children:["rise"===a&&(0,o.jsx)("style",{children:`
          @keyframes ${r}_rise {
            from { transform: scaleY(0); }
            to   { transform: scaleY(1); }
          }
        `}),(0,o.jsxs)("svg",{viewBox:`0 0 520 ${n}`,style:{width:"100%",height:n},preserveAspectRatio:"xMidYMid meet","aria-hidden":"true",children:[null!=t?(0,o.jsxs)("g",{children:[(0,o.jsx)("line",{x1:40,x2:40+l,y1:20+c-t/s*c,y2:20+c-t/s*c,stroke:i.w4.colors.border,strokeDasharray:"3 3",strokeWidth:"1"}),(0,o.jsxs)("text",{x:36,y:20+c-t/s*c+3,textAnchor:"end",fontFamily:k,fontSize:"9",fill:i.w4.colors.mainTextMuted,children:["€",t]})]}):null,e.map((e,t)=>{let a,r=40+t*p+(p-d)/2,l=20+c;return(0,o.jsxs)("g",{style:f,children:[e.segments.map(e=>{let t=e.value/s*c;return l-=t,(0,o.jsx)("rect",{x:r,y:l,width:d,height:t,fill:e.color,opacity:.85},e.id)}),null!=e.over&&e.over>0?(a=e.over/s*c,l-=a,(0,o.jsx)("rect",{x:r,y:l,width:d,height:a,fill:"#f85149",opacity:.7},"over")):null,(0,o.jsx)("text",{x:r+d/2,y:n-6,textAnchor:"middle",fontFamily:k,fontSize:"10",fill:i.w4.colors.mainTextMuted,children:e.label})]},e.label)})]})]})}let j="'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, monospace";function z({data:e,total:t,size:n=110,thickness:a=14,centerLabel:r,centerValue:s}){let l=(0,g.useId)(),c=n/2-a/2-2,d=2*Math.PI*c,p=e.reduce((e,t)=>e+t.value,0)||1,f=0;return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)("style",{children:`
        @keyframes ${l}_dash {
          from { stroke-dasharray: 0 ${d.toFixed(1)}; }
        }
      `}),(0,o.jsxs)("svg",{viewBox:`0 0 ${n} ${n}`,style:{width:n,height:n,flexShrink:0},"aria-hidden":"true",children:[(0,o.jsx)("circle",{cx:n/2,cy:n/2,r:c,fill:"none",stroke:i.w4.colors.border,strokeWidth:a}),e.map((e,t)=>{let r=e.value/p*d,i=60*t,s=(0,o.jsx)("circle",{cx:n/2,cy:n/2,r:c,fill:"none",stroke:e.color,strokeWidth:a,strokeDasharray:`${r.toFixed(1)} ${d.toFixed(1)}`,strokeDashoffset:(-f).toFixed(1),transform:`rotate(-90 ${n/2} ${n/2})`,style:{animation:`${l}_dash 0.45s ease-out ${i}ms both`}},t);return f+=r,s}),r?(0,o.jsx)("text",{x:n/2,y:n/2-4,textAnchor:"middle",fontFamily:j,fontSize:"9",fill:i.w4.colors.mainTextMuted,letterSpacing:"0.12em",textDecoration:"none",children:r.toUpperCase()}):null,s?(0,o.jsx)("text",{x:n/2,y:r?n/2+11:n/2+4,textAnchor:"middle",fontFamily:j,fontSize:"13",fontWeight:"700",fill:i.w4.colors.mainText,children:s}):null]})]})}let T=["#1a2420","#2a4535","#4a7a5a","#6fa77a","#7fb77e"],S=["S","T","Q","Q","S","S","D"],C=["S","M","T","W","T","F","S"];function R({data:e,cellSize:t=10,gap:n=2,locale:a="pt"}){let r=(0,g.useId)();if(!e.length)return null;let s=24+Math.ceil(e.length/7)*(t+n),l=14+7*(t+n);return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)("style",{children:`
        @keyframes ${r}_fade { from { opacity: 0; } to { opacity: 1; } }
      `}),(0,o.jsxs)("svg",{viewBox:`0 0 ${s} ${l}`,style:{width:"100%",height:"auto",maxHeight:l+4},"aria-hidden":"true",children:[(0,o.jsx)("g",{fontFamily:"'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, monospace",fontSize:"8",fill:i.w4.colors.mainTextMuted,children:("pt"===a?S:C).map((e,a)=>(0,o.jsx)("text",{x:"0",y:10+a*(t+n),children:e},a))}),e.map((e,a)=>{let i=18+Math.floor(a/7)*(t+n),s=2+a%7*(t+n),l=T[Math.max(0,Math.min(4,e))]??T[0];return(0,o.jsx)("rect",{x:i,y:s,width:t,height:t,fill:l,rx:"1",style:{animation:`${r}_fade 0.3s ease-out ${8*a}ms both`}},a)})]})]})}function F(e){let t=0;for(let n=1;n<e.length;n++){let o=e[n][0]-e[n-1][0],a=e[n][1]-e[n-1][1];t+=Math.sqrt(o*o+a*a)}return t}function A({spent:e,budget:t,height:n=60}){let a=(0,g.useId)(),r=1.05*t||1,s=Array.from({length:8},(e,n)=>t-t/7*n),l=Math.min(e/(t||1),1),c=Array.from({length:8},(e,n)=>Math.max(0,t-n/7*t*l*1.1)),d=s.map((e,t)=>[320*t/7,n-e/r*(n-5)]),p=c.map((e,t)=>[320*t/7,n-e/r*(n-5)]),f=d.map(e=>e.join(",")).join(" "),u=p.map(e=>e.join(",")).join(" "),m=F(d).toFixed(1),x=F(p).toFixed(1);return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)("style",{children:`
        @keyframes ${a}_i { from { stroke-dashoffset: ${m}; } }
        @keyframes ${a}_a { from { stroke-dashoffset: ${x}; } }
      `}),(0,o.jsxs)("svg",{viewBox:`0 0 320 ${n}`,style:{width:"100%",height:n},preserveAspectRatio:"none","aria-hidden":"true",children:[(0,o.jsx)("line",{x1:"0",x2:320,y1:n-5,y2:n-5,stroke:i.w4.colors.border,strokeDasharray:"3 3",strokeWidth:"1"}),(0,o.jsx)("polyline",{points:f,stroke:i.w4.colors.mainTextMuted,strokeWidth:"1",strokeDasharray:`${m} ${m}`,strokeDashoffset:"0",fill:"none",style:{strokeDasharray:"2 3",animation:`${a}_i 0.45s ease-out both`}}),(0,o.jsx)("polyline",{points:u,stroke:"#7fb77e",strokeWidth:"1.5",strokeDasharray:`${x} ${x}`,strokeDashoffset:"0",fill:"none",strokeLinecap:"round",style:{animation:`${a}_a 0.45s ease-out 0.08s both`}})]})]})}let D=r().div`
  position: relative;
  height: 6px;
...
`,B=r().div`
  ...
  opacity: 0.7;
  transition: width 400ms ease;
`;function H({pct:e,over:t=0,color:n="#7fb77e"}){let a=Math.min(100,e),r=100-t;return(0,o.jsxs)(D,{children:[(0,o.jsx)(E,{pct:a,color:n}),t>0&&(0,o.jsx)(B,{left:Math.max(0,r),width:t})]})}n(5030),r().button`
  display: inline-flex;
  align-items: center;
  gap: 6px;
  padding: 0 10px;
