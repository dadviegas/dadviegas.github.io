"use strict";(self.webpackChunk_atlantis_mdpad=self.webpackChunk_atlantis_mdpad||[]).push([[5773],{74914(a,n,e){e.d(n,{FlyoutPanel:()=>y});var o=e(27359),i=e(53233),r=e(77207),t=e(20255),l=e(217),s=e(15959),c=e(65185),d=e(65723);const m=r.keyframes`
...
`;function f({iconKey:a}){const n=a?c.t[a]??t.A:t.A;return(0,d.jsx)(n,{size:14,strokeWidth:1.75})}function b({entries:a,activeId:n,onSelect:e}){return(0,d.jsx)(d.Fragment,{children:a.map(a=>a.children?(0,d.jsx)(o.Fragment,{children:(0,d.jsx)(b,{entries:a.children,activeId:n,onSelect:e})},a.id):(0,d.jsxs)(p,{active:n===a.id,onClick:()=>e(a),children:[(0,d.jsx)(f,{iconKey:a.icon}),a.name]},a.id))})}function y({activeId:a}){const{flyout:n,scheduleFlyoutClose:e,cancelFlyoutClose:o}=(0,s.c)();if(!n)return null;const i=n.entry.icon?c.t[n.entry.icon]??t.A:t.A;return(0,d.jsxs)(u,{anchorY:n.anchorY,onMouseEnter:o,onMouseLeave:e,children:[(0,d.jsxs)(g,{children:[(0,d.jsx)(i,{size:13,strokeWidth:2}),n.entry.name]}),(0,d.jsx)(b,{entries:n.entry.children??[],activeId:a,onSelect:a=>{n.onSelect(a),e()}})]})}},15959(a,n,e){e.d(n,{c:()=>r});var o=e(27359);const i=(0,o.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),r=()=>(0,o.useContext)(i)},65185(a,n,e){e.d(n,{t:()=>q});var o=e(49510),i=e(99038),r=e(28207),t=e(36896),l=e(37901),s=e(39848),c=e(22164),d=e(43775),m=e(83539),u=e(41783),g=e(1837),p=e(82314),f=e(35751),b=e(20255),y=e(69633),h=e(92946),x=e(40822),w=e(36720),z=e(43317),$=e(52709),A=e(83517),v=e(37032),k=e(6949),S=e(8218),T=e(36829),M=e(15553),B=e(59591),j=e(72820),C=e(14621),E=e(66673),P=e(49033),R=e(31365),L=e(65912),N=e(88641),D=e(83249),F=e(1821),I=e(19161),G=e(71849),K=e(77747),H=e(2932),_=e(24525),U=e(57230);const q={activity:t.A,"bar-chart-2":o.A,book:s.A,"book-open":l.A,calendar:d.A,clock:u.A,"circle-dot":m.A,feather:p.A,"file-text":f.A,globe:w.A,hash:z.A,heart:$.A,landmark:A.A,layers:r.A,leaf:k.A,map:B.A,package:E.A,compass:g.A,"git-branch":h.A,github:x.A,minus:C.A,terminal:D.A,thermometer:F.A,users:G.A,wind:K.A,"pie-chart":i.A,plus:R.A,slash:L.A,star:N.A,zap:U.A,bot:c.A,lightbulb:S.A,"message-square":j.A,wrench:H.A,x:_.A,"layout-grid":v.A,list:T.A,file:b.A,folder:y.A,"map-pin":M.A,"pen-tool":P.A,type:I.A}},14191(a,n,e){e.d(n,{UO:()=>H,MJ:()=>T,KL:()=>y,w4:()=>o.w4,mZ:()=>h});var o=e(217),i=e(27359),r=e(53233),t=e(65723);r.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,r.default.div`
  position: relative;
`,e(15959);const l="260px",s="56px";r.default.header`
  display: flex;
  align-items: center;
  height: ${"48px"};
...
`,r.default.button`
  ...
  align-items: center;
  width: 100%;
  padding: ${({collapsed:a})=>a?"10px 0":`${o.w4.spacing.sm} ${o.w4.spacing.md}`};
  justify-content: ${({collapsed:a})=>a?"center":"space-between"};
  gap: ${({collapsed:a})=>a?"0":o.w4.spacing.sm};
  background: none;
  border: none;
  cursor: pointer;
  color: ${o.w4.colors.sidebarTextMuted};
...
`,r.default.button`
  ...
  align-items: center;
  width: 100%;
  padding: ${({collapsed:a})=>a?"9px 0":`7px ${o.w4.spacing.md}`};
  justify-content: ${({collapsed:a})=>a?"center":"flex-start"};
  gap: ${({collapsed:a})=>a?"0":"8px"};
  background: ${({active:a})=>a?o.w4.colors.accentMuted:"none"};
  border: none;
  border-left: ${({collapsed:a})=>a?"none":"2px"} solid
    ${({active:a})=>a?o.w4.colors.sidebarActive:"transparent"};
  cursor: pointer;
  color: ${({active:a})=>a?o.w4.colors.sidebarActive:o.w4.colors.sidebarText};
  font-size: ${o.w4.typography.fontSizeBase};
  font-weight: ${({active:a})=>a?"600":"400"};
  font-family: ${o.w4.typography.fontFamily};
  text-align: left;
  border-radius: ${({collapsed:a})=>a?"0":`0 ${o.w4.borderRadius.md} ${o.w4.borderRadius.md} 0`};
...
`,e(74914);var d=e(61920),m=e(48607),u=e(68479);r.default.button`
  display: flex;
  align-items: center;
  justify-content: center;
  width: 32px;
...
`,v=r.default.button`
  ...
  border-radius: 20px;
  background: ${({primary:a,danger:n})=>n?"rgba(248,81,73,0.12)":a?o.w4.colors.accent:"none"};
  color: ${({primary:a,danger:n})=>n?o.w4.colors.danger:a?"#fff":o.w4.colors.mainText};
  border: 1px solid ${({primary:a,danger:n})=>n?o.w4.colors.danger:a?o.w4.colors.accent:o.w4.colors.border};
...
`,S=r.default.div`
  ...
  color: ${o.w4.colors.sidebarTextMuted};
  font-family: ${o.w4.typography.fontFamily};
`;function T({onSave:a,onUpdate:n,onCancel:e,existingDoc:o}){const[r,l]=(0,i.useState)(o?.name??""),s=(0,i.useRef)(null);return(0,i.useEffect)(()=>{s.current?.focus(),o&&s.current?.select()},[o]),(0,t.jsx)(x,{onClick:e,children:(0,t.jsxs)(w,{onClick:a=>a.stopPropagation(),children:[(0,t.jsx)(z,{children:"Save document"}),o&&n&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(S,{children:"Update the current version or save as a new one."}),(0,t.jsxs)(A,{children:[(0,t.jsx)(v,{onClick:e,children:"Cancel"}),(0,t.jsxs)(v,{danger:!0,onClick:n,children:['Update "',o.name,'"']})]}),(0,t.jsx)(k,{})]}),(0,t.jsx)($,{ref:s,value:r,onChange:a=>l(a.target.value),onKeyDown:i=>{"Enter"===i.key&&r.trim()&&(o&&r.trim()===o.name&&n?n():a(r.trim())),"Escape"===i.key&&e()},placeholder:o?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,t.jsxs)(A,{children:[!o&&(0,t.jsx)(v,{onClick:e,children:"Cancel"}),(0,t.jsx)(v,{primary:!0,disabled:!r.trim(),onClick:()=>a(r.trim()),children:"Save as new"})]})]})})}var M=e(18006),B=e(70679),j=e(54872);const C=r.default.div`
  position: relative;
`,E=r.default.button`
  display: flex;
  align-items: center;
...
`;function H({appId:a,onLoad:n}){const[e,o]=(0,i.useState)(!1),[r,l]=(0,i.useState)([]),s=(0,i.useRef)(null),c=(0,i.useCallback)(()=>{(function(a){return b.listDocs(a)})(a).then(l).catch(()=>{})},[a]);(0,i.useEffect)(()=>{if(!e)return;c();const a=a=>{s.current&&!s.current.contains(a.target)&&o(!1)};return document.addEventListener("mousedown",a),()=>document.removeEventListener("mousedown",a)},[e,c]);return(0,t.jsxs)(C,{ref:s,children:[(0,t.jsxs)(E,{onClick:()=>o(a=>!a),children:[(0,t.jsx)(M.A,{size:14}),"Saved",(0,t.jsx)(B.A,{size:13,style:{marginLeft:2}})]}),(0,t.jsxs)(P,{open:e,children:[(0,t.jsx)(R,{children:"Saved versions"}),(0,t.jsx)(L,{children:0===r.length?(0,t.jsx)(N,{children:"No saved documents yet."}):r.map(a=>{return(0,t.jsxs)(D,{children:[(0,t.jsxs)(F,{onClick:()=>{n(a.content,a.id,a.name),o(!1)},children:[(0,t.jsx)(I,{children:a.name}),(0,t.jsx)(G,{children:(e=a.savedAt,new Intl.DateTimeFormat(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}).format(new Date(e)))})]}),(0,t.jsx)(K,{onClick:n=>(async(a,n)=>{a.stopPropagation(),await function(a){return b.deleteDoc(a)}(n),l(a=>a.filter(a=>a.id!==n))})(n,a.id),title:"Delete",children:(0,t.jsx)(j.A,{size:13})})]},a.id);var e})})]})]})}},217(a,n,e){e.d(n,{w4:()=>i});const o={sidebarBg:"#0c1018",sidebarText:"#c5cdd8",sidebarTextMuted:"#5a6577",sidebarActive:"#6366f1",sidebarActiveBg:"#141820",sidebarHover:"#1a2030",sidebarBorder:"#1e2535",mainBg:"#0a0e14",mainText:"#e8edf5",mainTextMuted:"#7a8599",accent:"#6366f1",accentHover:"#818cf8",accentMuted:"rgba(99,102,241,0.15)",codeBg:"#0f1520",codeBorder:"#2a3040",border:"#2a3040",borderSubtle:"#1e2535",surface:"#141820",surfaceRaised:"#1a2030",success:"#34d399",warning:"#fbbf24",danger:"#f87171"},i={colors:function(){const a={};for(const n of Object.keys(o))a[n]=`var(--at-${n})`;return a}(),spacing:{xs:"4px",sm:"8px",md:"16px",lg:"24px",xl:"32px",xxl:"48px"},sidebar:{width:"260px"},topbar:{height:"56px"},typography:{fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif",fontFamilyMono:"'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, monospace",fontSizeSm:"13px",fontSizeBase:"14px",fontSizeMd:"16px",fontSizeLg:"20px",fontSizeXl:"24px",fontSizeHero:"32px",lineHeightBase:"1.6"},borderRadius:{sm:"4px",md:"6px",lg:"12px",xl:"16px"},breakpoints:{md:"768px",lg:"1024px",xl:"1280px"},sizes:{fullHeight:"100dvh",md:"768px",lg:"1024px",xl:"1280px"}}},78967(a,n,e){e.d(n,{M:()=>f}),e(27359);var o=e(53233),i=e(15496),r=e(51530),t=e(14191),l=e(65723);const s=o.default.div`
  display: flex;
  flex-direction: column;
...
`,u=o.default.textarea`
  ...
  line-height: 1.7;
  tab-size: 2;
  caret-color: ${t.w4.colors.accent};
  overflow-y: scroll;
  -webkit-overflow-scrolling: touch;
...
`;function f({value:a,onChange:n,collapsed:e,onToggleCollapse:o,scrollRef:t,onScroll:f}){return e?(0,l.jsx)("div",{style:{position:"relative",flexShrink:0},children:(0,l.jsxs)(g,{onClick:o,title:"Show editor",children:[(0,l.jsx)(r.A,{size:14}),(0,l.jsx)(p,{children:"Editor"})]})}):(0,l.jsxs)(s,{collapsed:!1,children:[(0,l.jsxs)(c,{children:[(0,l.jsx)(d,{children:"Editor"}),(0,l.jsx)(m,{onClick:o,title:"Collapse editor",children:(0,l.jsx)(i.A,{size:15})})]}),(0,l.jsx)(u,{ref:t,value:a,onChange:a=>n(a.target.value),onScroll:f,placeholder:"Write markdown here…",spellCheck:!1})]})}},61326(a,n,e){e.d(n,{H:()=>y});var o=e(27359),i=e(53233),r=e(37901),t=e(70679),l=e(14191),s=e(9336),c=e(65723);const d=i.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  padding: 5px 12px;
...
`,b=i.default.div`
  position: relative;
`;function y({onSelect:a}){const[n,e]=(0,o.useState)(!1),i=(0,o.useRef)(null);return(0,o.useEffect)(()=>{if(!n)return;const a=a=>{i.current&&!i.current.contains(a.target)&&e(!1)};return document.addEventListener("mousedown",a),()=>document.removeEventListener("mousedown",a)},[n]),(0,c.jsxs)(b,{ref:i,children:[(0,c.jsxs)(d,{onClick:()=>e(a=>!a),children:[(0,c.jsx)(r.A,{size:14}),"Examples",(0,c.jsx)(t.A,{size:13,style:{marginLeft:2}})]}),(0,c.jsxs)(m,{open:n,children:[(0,c.jsx)(u,{children:"Load an example"}),s.k.map(n=>(0,c.jsxs)(g,{onClick:()=>{a(n.content),e(!1)},children:[(0,c.jsx)(p,{children:n.label}),(0,c.jsx)(f,{children:n.description})]},n.id))]})]})}},89654(a,n,e){e.d(n,{r:()=>D});var o=e(27359),i=e(28976),r=e(18055),t=e(14944),l=e(39895),s=e(6930),c=(e(61385),e(53233)),d=e(49881),m=e(13045),u=e(14191),g=e(65723);const p=c.default.div`
...
`;let b=!1;function y({code:a}){const n=(0,o.useRef)(null),[i,r]=(0,o.useState)(null);return(0,o.useEffect)(()=>{let o=!1;return r(null),async function(){const i=(await e.e(774).then(e.bind(e,30774))).default;if(b||(i.initialize({startOnLoad:!1,theme:"dark",themeVariables:{background:u.w4.colors.codeBg,primaryColor:u.w4.colors.accent,primaryTextColor:u.w4.colors.mainText,lineColor:u.w4.colors.border}}),b=!0),n.current&&!o)try{const e=`mermaid-${Math.random().toString(36).slice(2)}`,{svg:r}=await i.render(e,a);!o&&n.current&&(n.current.innerHTML=r)}catch(a){o||r(a instanceof Error?a.message:String(a))}}(),()=>{o=!0}},[a]),i?(0,g.jsx)(p,{children:(0,g.jsxs)(f,{children:["Mermaid error: ",i]})}):(0,g.jsx)(p,{ref:n})}var h=e(68383),x=e(21426),w=e(25609),z=e(20320);const $=c.default.div`
  margin: ${u.w4.spacing.lg} 0;
  border-radius: ${u.w4.borderRadius.md};
  border: 1px solid ${u.w4.colors.codeBorder};
  overflow: hidden;
...
`,S={...x.A,'pre[class*="language-"]':{...x.A['pre[class*="language-"]'],background:u.w4.colors.codeBg,margin:0,padding:"18px 20px",fontSize:"13px",lineHeight:"1.6",borderRadius:0},'code[class*="language-"]':{...x.A['code[class*="language-"]'],background:"none",fontSize:"13px"}};function T({lang:a="text",code:n}){const[e,i]=(0,o.useState)(!1),r=n.split("\n").length>8;return(0,g.jsxs)($,{children:[(0,g.jsxs)(A,{children:[(0,g.jsx)(v,{children:a}),(0,g.jsxs)(k,{copied:e,onClick:()=>{navigator.clipboard.writeText(n).then(()=>{i(!0),setTimeout(()=>i(!1),2e3)})},children:[e?(0,g.jsx)(w.A,{size:12}):(0,g.jsx)(z.A,{size:12}),e?"Copied!":"Copy"]})]}),(0,g.jsx)(h.A,{language:a,style:S,showLineNumbers:r,lineNumberStyle:{color:"#484f58",minWidth:"2.5em",paddingRight:"1.5em",userSelect:"none",fontSize:"12px"},customStyle:{margin:0,background:u.w4.colors.codeBg},wrapLongLines:!1,children:n})]})}function M(){return a=>{!function a(n){if("blockquote"===n.type){const a=n.children?.[0];if("paragraph"===a?.type){const e=a.children?.[0];if("text"===e?.type){const o=e.value?.match(/^\[!(NOTE|TIP|WARNING|CAUTION|IMPORTANT)\]\s*/i);o&&(e.value=e.value.slice(o[0].length),e.value.trim()||1!==a.children.length||n.children.shift(),n.data=n.data??{},n.data.hName="div",n.data.hProperties={"data-callout":o[1].toUpperCase()})}}}n.children?.forEach(a)}(a)}}const B=c.default.div`
  display: flex;
  flex-direction: column;
  flex: 1;
  min-width: 0;
