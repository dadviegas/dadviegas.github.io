...
`},87330(o,e,a){a.d(e,{FlyoutPanel:()=>oC});var t=a(65723),r=a(37991),n=a.n(r),i=a(36859),l=a.n(i),s=a(72799),d=a(20255),c=a(81316),p=a(40814),g=a(36896),m=a(87902),f=a(53013),x=a(32887),u=a(49510),h=a(39848),b=a(37901),w=a(3045),y=a(43775),$=a(41783),v=a(83539),z=a(39416),k=a(1837),M=a(57167),A=a(84494),T=a(82314),S=a(35751),j=a(69633),F=a(92946),B=a(40822),R=a(36720),C=a(57400),P=a(58456),E=a(43317),L=a(52709),H=a(8006),N=a(89301),I=a(37561),D=a(83517),V=a(28207),Y=a(37032),G=a(6949),K=a(8218),W=a(36829),O=a(59591),_=a(15553),U=a(69923),q=a(72820),J=a(14621),Z=a(68479),X=a(72534),Q=a(66673),oo=a(67490),oe=a(49033),oa=a(99038),ot=a(45775),or=a(31365),on=a(62937),oi=a(9821),ol=a(65912),os=a(80158),od=a(88641),oc=a(48607),op=a(83249),og=a(1821),om=a(15889),of=a(89655),ox=a(27170),ou=a(19161),oh=a(71849),ob=a(41604),ow=a(13142),oy=a(61187),o$=a(77747),ov=a(2932),oz=a(24525),ok=a(57230),oM=a(22164);let oA={activity:g.A,"a-large-small":m.A,apple:f.A,"arrow-right":x.A,"bar-chart-2":u.A,book:h.A,"book-open":b.A,briefcase:w.A,calendar:y.A,clock:$.A,"circle-dot":v.A,cloud:z.A,compass:k.A,cpu:M.A,droplets:A.A,feather:T.A,file:d.A,"file-text":S.A,folder:j.A,"git-branch":F.A,github:B.A,globe:R.A,grid:C.A,hand:P.A,hash:E.A,heart:L.A,key:H.A,hexagon:N.A,home:I.A,landmark:D.A,layers:V.A,"layout-grid":Y.A,leaf:G.A,lightbulb:K.A,list:W.A,map:O.A,"map-pin":_.A,"message-circle":U.A,"message-square":q.A,minus:J.A,monitor:Z.A,mountain:X.A,package:Q.A,palette:oo.A,"pen-tool":oe.A,"pie-chart":oa.A,plane:ot.A,plus:or.A,ruler:on.A,shirt:oi.A,slash:ol.A,square:os.A,star:od.A,sun:oc.A,terminal:op.A,thermometer:og.A,triangle:om.A,trophy:of.A,truck:ox.A,type:ou.A,users:oh.A,"volume-2":ob.A,watch:ow.A,waves:oy.A,wind:o$.A,wrench:ov.A,x:oz.A,zap:ok.A,bot:oM.A},oT=(0,s.keyframes)`
...
`;function oB({iconKey:o}){let e=o?oA[o]??d.A:d.A;return(0,t.jsx)(e,{size:14,strokeWidth:1.75})}function oR({entries:o,activeId:e,onSelect:a}){return(0,t.jsx)(t.Fragment,{children:o.map(o=>o.children?(0,t.jsx)(n().Fragment,{children:(0,t.jsx)(oR,{entries:o.children,activeId:e,onSelect:a})},o.id):(0,t.jsxs)(oF,{active:e===o.id,onClick:()=>a(o),children:[(0,t.jsx)(oB,{iconKey:o.icon}),o.name]},o.id))})}function oC({activeId:o}){let{flyout:e,scheduleFlyoutClose:a,cancelFlyoutClose:r}=(0,p.c)();if(!e)return null;let n=e.entry.icon?oA[e.entry.icon]??d.A:d.A;return(0,t.jsxs)(oS,{anchorY:e.anchorY,onMouseEnter:r,onMouseLeave:a,children:[(0,t.jsxs)(oj,{children:[(0,t.jsx)(n,{size:13,strokeWidth:2}),e.entry.name]}),(0,t.jsx)(oR,{entries:e.entry.children??[],activeId:o,onSelect:o=>{e.onSelect(o),a()}})]})}},40814(o,e,a){a.d(e,{I:()=>r,c:()=>n});var t=a(37991);let r=(0,t.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),n=()=>(0,t.useContext)(r)},23930(o,e,a){a.d(e,{kd:()=>C.deleteDoc,PL:()=>C.getSetting,mZ:()=>C.updateDoc,KL:()=>C.saveDoc,cL:()=>p.c,Is:()=>C.putSetting,Iu:()=>C.listDocs,PE:()=>B,fy:()=>H,w4:()=>t.w4});var t=a(81316),r=a(65723),n=a(37991),i=a.n(n),l=a(36859),s=a.n(l);s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,T=s().main`
  ...
  display: flex;
  flex-direction: column;
`,S=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function j(){return(0,r.jsx)(w,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:S.map((o,e)=>(0,r.jsx)(y,{index:e,accent:o.accent,children:o.char},e))})}let F="atlantis:sidebar-collapsed";function B({sidebar:o,children:e,topBarRight:t,title:l="Atlantis",activeId:s=null}){let[d,g]=(0,n.useState)(()=>{try{return"true"===localStorage.getItem(F)}catch{return!1}}),[m,f]=(0,n.useState)(null),b=(0,n.useRef)(),w=()=>g(o=>{let e=!o;try{localStorage.setItem(F,String(e))}catch{}return e}),y=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(a.bind(a,87330)).then(o=>({default:o.FlyoutPanel}))),[]);return(0,r.jsx)(p.I.Provider,{value:{collapsed:d,toggle:w,flyout:m,openFlyout:(o,e,a)=>{clearTimeout(b.current),f({entry:o,anchorY:e,onSelect:a})},scheduleFlyoutClose:()=>{b.current=setTimeout(()=>f(null),160)},cancelFlyoutClose:()=>clearTimeout(b.current)},children:(0,r.jsxs)(k,{children:[(0,r.jsxs)(x,{children:[o&&(0,r.jsx)(u,{children:(0,r.jsx)(h,{onClick:w,title:d?"Expand sidebar":"Collapse sidebar",children:(0,r.jsx)(c.A,{size:17})})}),(0,r.jsx)(j,{}),l&&(0,r.jsx)($,{children:l}),t&&(0,r.jsx)(v,{children:t})]}),(0,r.jsxs)(z,{children:[null!=o&&(0,r.jsx)(M,{collapsed:d,children:(0,r.jsx)(A,{children:o})}),(0,r.jsx)(T,{children:e})]}),m&&(0,r.jsx)(i().Suspense,{fallback:null,children:(0,r.jsx)(y,{activeId:s})})]})})}s().div`
  display: grid;
...
`,b=n().forwardRef(function({variant:o="ghost",size:e="md",icon:a,iconRight:r,children:n,...i},l){return(0,t.jsxs)(h,{ref:l,variant:o,size:e,...i,children:[a,n,r]})}),w={default:s.w4.colors.accent,danger:"#f85149"},y={default:s.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"},$=l().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`,l().span`
  ...
  background: ${({color:o})=>o};
  display: inline-block;
`;let C={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:s.w4.colors.accentMuted},P={neutral:s.w4.colors.mainTextMuted,live:s.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:s.w4.colors.accent};l().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${s.w4.typography.fontFamilyMono};
...
`,U=!1;function q(o){if("u"<typeof window)return o;let e=o.match(/^var\((--[-\w]+)\)$/);return e&&getComputedStyle(document.documentElement).getPropertyValue(e[1]).trim()||o}function J({code:o}){let e=(0,r.useRef)(null),[n,i]=(0,r.useState)(null),[l,d]=(0,r.useState)(!1);return((0,r.useEffect)(()=>{let t=!1;if(i(null),d(!1),!o.trim())return void d(!0);let r=o.trim().split(/\r?\n/)[0]?.trim()??"";return/^(?:---[\s\S]*?---\s*)?(?:graph|flowchart|sequenceDiagram|classDiagram|stateDiagram(?:-v2)?|erDiagram|pie|gantt|journey|mindmap|gitGraph|sankey(?:-beta)?|quadrantChart|requirementDiagram|timeline|xychart-beta|block-beta|C4Context|C4Container|C4Component|C4Dynamic|C4Deployment)\b/.test(r)?(async function(){let r=(await a.e("6087").then(a.bind(a,29738))).default;if(U||(r.initialize({startOnLoad:!1,theme:"dark",themeVariables:{background:q(s.w4.colors.codeBg),primaryColor:q(s.w4.colors.accent),primaryTextColor:q(s.w4.colors.mainText),lineColor:q(s.w4.colors.border)}}),U=!0),e.current&&!t)try{let a=`mermaid-${(0,W.z)()}`,{svg:n}=await r.render(a,o);if(t||!e.current)return;if(/aria-roledescription="error"|class="error-icon"|>Syntax error/i.test(n))return void d(!0);e.current.innerHTML=n,requestAnimationFrame(()=>{if(t||!e.current)return;let o=e.current.querySelector("svg");if(!o)return void d(!0);let a=o.getBoundingClientRect();(a.width<40||a.height<40)&&d(!0)})}catch(o){t||i(o instanceof Error?o.message:String(o))}}(),()=>{t=!0}):void d(!0)},[o]),n||l)?(0,t.jsx)(_,{children:o.trim()}):(0,t.jsx)(O,{ref:e})}let Z=["#388bfd","#3fb950","#d29922","#a371f7","#f87171","#22d3ee","#fb923c","#34d399","#f472b6","#818cf8"],X=l().div`
  background: ${s.w4.colors.codeBg};
  border: 1px solid ${s.w4.colors.codeBorder};
  border-radius: ${s.w4.borderRadius.md};
  padding: ${s.w4.spacing.lg};
