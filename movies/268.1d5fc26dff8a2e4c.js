...
`,l().div`
  position: relative;
`;let W="260px",O="56px",q="48px",X=l().header`
  display: flex;
  align-items: center;
  height: calc(${q} + env(safe-area-inset-top, 0px));
  ...
  @media (max-width: ${s.w4.breakpoints.md}) {
    flex-wrap: wrap;
    height: auto;
    min-height: calc(${q} + env(safe-area-inset-top, 0px));
  }
`,N=l().div`
  width: ${O};
  min-width: ${O};
...
`,eo=l().div`
  ...
  overflow: hidden;
`,et=l().aside`
  width: ${({collapsed:e})=>e?O:W};
  min-width: ${({collapsed:e})=>e?O:W};
  background: ${s.w4.colors.sidebarBg};
  border-right: 1px solid ${s.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,ei=l().main`
  ...
  display: flex;
  flex-direction: column;
`,en=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function el(){return(0,t.jsx)(Z,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:en.map((e,r)=>(0,t.jsx)(J,{index:r,accent:e.accent,children:e.char},r))})}let es="atlantis:sidebar-collapsed";function ed({sidebar:e,children:r,topBarRight:n,title:l="Atlantis",activeId:s=null}){let[d,c]=(0,a.useState)(()=>{try{return"true"===localStorage.getItem(es)}catch{return!1}}),[p,h]=(0,a.useState)(null),x=(0,a.useRef)(),g=()=>c(e=>{let r=!e;try{localStorage.setItem(es,String(r))}catch{}return r}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(o.bind(o,5816)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,t.jsx)(A.I.Provider,{value:{collapsed:d,toggle:g,flyout:p,openFlyout:(e,r,o)=>{clearTimeout(x.current),h({entry:e,anchorY:r,onSelect:o})},scheduleFlyoutClose:()=>{x.current=setTimeout(()=>h(null),160)},cancelFlyoutClose:()=>clearTimeout(x.current)},children:(0,t.jsxs)(eo,{children:[(0,t.jsxs)(X,{children:[e&&(0,t.jsx)(N,{children:(0,t.jsx)(K,{onClick:g,title:d?"Expand sidebar":"Collapse sidebar",children:(0,t.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("path",{d:"M9 3v18"})]})})}),(0,t.jsx)(el,{}),l&&(0,t.jsx)(Q,{children:l}),n&&(0,t.jsx)(ee,{children:n})]}),(0,t.jsxs)(er,{children:[null!=e&&(0,t.jsx)(et,{collapsed:d,children:(0,t.jsx)(ea,{children:e})}),(0,t.jsx)(ei,{children:r})]}),p&&(0,t.jsx)(i().Suspense,{fallback:null,children:(0,t.jsx)(f,{activeId:s})})]})})}l().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
