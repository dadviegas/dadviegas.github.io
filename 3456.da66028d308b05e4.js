...
`,tf=l().div`
  ...
  padding: 8vh 16px;
  animation: ${tm} ${c.w4.transitions.fast};
`,tx=l().div`
  width: 760px;
  max-width: 100%;
  max-height: 84vh;
  ...
  animation: ${tu} ${c.w4.transitions.base};
  display: flex;
...
`,tz=l()("button",{shouldForwardProp:e=>"active"!==e&&"chipColor"!==e})`
  display: inline-flex;
  align-items: center;
  gap: 6px;
  height: 28px;
...
`,tS=l().div`
  ...
  gap: 12px;
`,tC=l()("button",{shouldForwardProp:e=>"added"!==e})`
  position: relative;
  display: flex;
  flex-direction: column;
  gap: 8px;
...
`,tI=l()("span",{shouldForwardProp:e=>"swatchColor"!==e})`
  width: 6px;
  height: 6px;
  border-radius: 50%;
...
`,tR=l().div`
  ...
  color: ${c.w4.colors.mainTextMuted};
  font-size: 13px;
`;function tD({open:e,activeIds:t,locale:a,onAdd:r,onRemove:n,onRemoveAll:s,onClose:l}){let d=(0,o.useMemo)(()=>(0,g.Nx)(a,td),[a]),[c,h]=(0,o.useState)(""),[m,u]=(0,o.useState)("all"),[f,x]=(0,o.useState)(!1),b=(0,o.useRef)(null);(0,o.useEffect)(()=>{e&&(h(""),u("all"),requestAnimationFrame(()=>b.current?.focus()))},[e]),(0,o.useEffect)(()=>{if(!e)return;let t=e=>{"Escape"===e.key&&l()};return document.addEventListener("keydown",t),()=>document.removeEventListener("keydown",t)},[e,l]);let y=(0,o.useMemo)(()=>{let e=c.trim().toLowerCase();return tr.filter(t=>{if("all"!==m&&t.suite!==m)return!1;if(!e)return!0;let i="pt"===a?t.labels.pt:t.labels.en,o="pt"===a?t.descriptions.pt:t.descriptions.en;return i.toLowerCase().includes(e)||o.toLowerCase().includes(e)||t.id.toLowerCase().includes(e)||t.suite.toLowerCase().includes(e)})},[c,m,a]);return e?tp().createPortal((0,i.jsxs)(tf,{onClick:l,children:[(0,i.jsxs)(tx,{onClick:e=>e.stopPropagation(),role:"dialog","aria-label":d("widgets.picker.title"),children:[(0,i.jsxs)(tb,{children:[(0,i.jsxs)(ty,{children:[(0,i.jsx)(p.YZ,{children:d("widgets.picker.eyebrow")}),(0,i.jsx)(tk,{onClick:l,"aria-label":d("widgets.picker.close"),children:(0,i.jsx)(p.In,{name:"close",size:14,"aria-hidden":"true"})})]}),(0,i.jsx)(tw,{children:d("widgets.picker.title")}),(0,i.jsx)(tv,{children:d("widgets.picker.subtitle")})]}),(0,i.jsxs)(t$,{children:[(0,i.jsx)(p.pd,{ref:b,placeholder:d("widgets.picker.searchPlaceholder"),value:c,onChange:e=>h(e.target.value),before:(0,i.jsx)(p.In,{name:"search",size:14,"aria-hidden":"true"})}),(0,i.jsxs)(tM,{role:"tablist",children:[th.map(e=>(0,i.jsxs)(tz,{active:m===e.id,chipColor:e.color,onClick:()=>u(e.id),role:"tab","aria-selected":m===e.id,children:[e.color&&(0,i.jsx)("span",{className:"dot"}),d(e.labelKey)]},e.id)),t.size>0&&(0,i.jsxs)(tj,{type:"button",onClick:()=>x(!0),"aria-label":d("widgets.picker.removeAll"),children:[(0,i.jsx)(p.In,{name:"trash",size:12,"aria-hidden":"true"}),d("widgets.picker.removeAll",{n:t.size})]})]})]}),(0,i.jsx)(tS,{children:0===y.length?(0,i.jsx)(tR,{children:d("widgets.picker.empty")}):y.map(e=>{let o=t.has(e.id),s="pt"===a?e.labels.pt:e.labels.en,l="pt"===a?e.descriptions.pt:e.descriptions.en,c=tg[e.suite],h=th.find(t=>t.id===e.suite);return(0,i.jsxs)(tC,{added:o,onClick:()=>{o?n(e.id):r(e.id)},children:[(0,i.jsxs)(tT,{children:[(0,i.jsx)(tA,{children:e.icon}),(0,i.jsx)(tF,{children:s}),o&&(0,i.jsxs)(tN,{children:[(0,i.jsx)(p.In,{name:"check",size:10,"aria-hidden":"true"}),d("widgets.picker.added")]})]}),(0,i.jsx)(tL,{children:l}),(0,i.jsxs)(tP,{children:[(0,i.jsx)(tI,{swatchColor:c}),h?d(h.labelKey):e.suite]})]},e.id)})})]}),(0,i.jsx)(p.TM,{open:f,title:d("widgets.picker.removeAll",{n:t.size}),message:d("widgets.picker.removeAllConfirm"),confirmLabel:d("widgets.picker.removeAll",{n:t.size}),cancelLabel:d("widgets.picker.close"),danger:!0,onCancel:()=>x(!1),onConfirm:()=>{x(!1),s?s():Array.from(t).forEach(e=>n(e))}})]}),document.body):null}let tH="shell:dashboard-widgets",tE="shell:pending-open-widget-picker",tO=[{id:"w-ask-sessions",widgetId:"ask-sessions"},{id:"w-daily-feed",widgetId:"daily-feed"},{id:"w-techscope",widgetId:"techscope"},{id:"w-weather",widgetId:"weather"},{id:"w-clock",widgetId:"clock"}],tq=(0,d.keyframes)`
  from { opacity: 0; transform: translateY(8px); }
  to { opacity: 1; transform: translateY(0); }
`,tB=l().div`
  margin-bottom: ${c.w4.spacing.xl};
  animation: ${tq} 0.35s ease both;
`,tK=l().div`
  display: flex;
  align-items: center;
  justify-content: space-between;
...
`,t1=l().button`
  ...
  &:focus-visible { ${c.w4.focusRing} }
`,t4=new Set(eL.filter(e=>"Developer Toolkit"===e.suite).map(e=>e.id)),t2="pin:";function t5(e){return e.widgetId.startsWith(t2)}function t3(e){return e.widgetId.slice(t2.length)}let t6=new Set(["games","movies","devtools"]);function t8({instance:e,appId:t,meta:a,app:o,idx:r,totalCount:n,tShell:s,recentsOverride:l,onMove:d,onRemove:c,onSelectApp:g}){let m=(0,h.useRecents)(t),u=n>1?(0,i.jsxs)(i.Fragment,{children:[r>0&&(0,i.jsx)(tV,{type:"button",title:s("widgets.moveLeft"),onClick:t=>{t.stopPropagation(),d(e.id,-1)},children:(0,i.jsx)(p.In,{name:"chevron-left",size:13})}),r<n-1&&(0,i.jsx)(tV,{type:"button",title:s("widgets.moveRight"),onClick:t=>{t.stopPropagation(),d(e.id,1)},children:(0,i.jsx)(p.In,{name:"chevron-right",size:13})})]}):void 0;return(0,i.jsx)(p.SV,{vizId:t,label:a.label,description:a.description,hash:o?.hash??a.hash,category:a.category,accentColor:a.color,needsAuth:a.needsAuth,pinned:!0,index:r,onClick:()=>{o?g(o):window.location.hash=a.hash},onHoverIntent:o?()=>b(t):void 0,onTogglePin:()=>c(e.id),reorderControls:u,extra:t6.has(t)?function(e,t,a,o){if(0===e.length)return null;let r=e.slice(0,3);return(0,i.jsxs)(tY,{children:[(0,i.jsx)(t_,{children:a("pinnedCard.recent.label")}),(0,i.jsx)(tU,{children:r.map(e=>{let a,r,n;return(0,i.jsxs)(tJ,{type:"button",tintColor:e.color??t,title:e.label,onClick:t=>{t.stopPropagation(),window.location.hash=e.hash},children:[(a=function(e){if(e)return eR[e.split("?")[0]]??eR[e]}(e.hash),r=a?.iconName??e.iconName??o,n=a?.color??e.color??t,r?(0,i.jsx)("span",{className:"glyph","aria-hidden":"true",style:{color:n},children:(0,i.jsx)(p.In,{name:r,size:14})}):e.icon?(0,i.jsx)("span",{className:"glyph","aria-hidden":"true",children:e.icon}):null),(0,i.jsx)("span",{className:"label",children:e.label})]},e.hash)})})]})}(l??m,a.color,s,a.icon):null})}function t7({locale:e,pinnedAppIds:t,recentAppIds:a,apps:r,appMeta:n,onSelectApp:s,onTogglePin:l}){let d=(0,o.useMemo)(()=>(0,g.Nx)(e,td),[e]),[m,u]=(0,o.useState)([]),[f,x]=(0,o.useState)(!1),[b,y]=(0,o.useState)(!1);(0,o.useEffect)(()=>{let e=()=>{try{sessionStorage.removeItem(tE)}catch{}y(!0)};window.addEventListener("atlantis:open-widget-picker",e);let t=!1;try{t="1"===sessionStorage.getItem(tE)}catch{}if(t){try{sessionStorage.removeItem(tE)}catch{}y(!0)}return()=>window.removeEventListener("atlantis:open-widget-picker",e)},[]),(0,o.useEffect)(()=>{let e=!1;return(async()=>{let t=await (0,c.PL)(tH);if(!e){if(t)try{let e=JSON.parse(t),a=function(e){if(!e.some(e=>"internet-now"===e.widgetId))return e;let t=[];for(let a of e)if("internet-now"===a.widgetId){let e=Date.now();t.push({id:`w-trending-${e}`,widgetId:"trending-searches"},{id:`w-wiki-${e+1}`,widgetId:"wiki-most-read"},{id:`w-hn-${e+2}`,widgetId:"hackernews-hot"})}else t.push(a);return t}(e);u(a),a!==e&&(0,c.Is)(tH,JSON.stringify(a))}catch{u(tO)}else u(tO);x(!0)}})(),()=>{e=!0}},[]),(0,o.useEffect)(()=>{f&&u(e=>{let a=new Set(t),i=new Set(e.filter(t5).map(t3)),o=e.filter(e=>!t5(e)||a.has(t3(e)));for(let e of t)i.has(e)||(o=[...o,{id:`pin-${e}`,widgetId:`${t2}${e}`}]);return o.length!==e.length||o.some((t,a)=>t.id!==e[a]?.id)?((0,c.Is)(tH,JSON.stringify(o)),o):e})},[t,f]);let w=(0,o.useRef)(new Set);(0,o.useEffect)(()=>{if(!f)return;let e=new Set(m.filter(e=>!t5(e)).map(e=>e.widgetId)),t=w.current;for(let a of e){if(t.has(a))continue;let e=tn(a);if(e?.notifications?.length){for(let t of e.notifications)h.events.registerCategory({id:t.category,labelKey:t.labelKey??`notifications.source.${t.id}`,badgeColor:e.accentColor??c.w4.colors.mainTextMuted});h.events.registerRules(e.notifications)}}for(let a of t){if(e.has(a))continue;let t=tn(a);if(t){if(t.notifications?.length){h.events.unregisterRules(t.notifications.map(e=>e.id));let e=new Set(t.notifications.map(e=>e.category));for(let t of h.events.getItems())e.has(t.category)&&h.events.dismiss(t.id)}for(let e of t.sources.filter(e=>e.cacheKey).map(e=>`widget-cache:${e.cacheKey}`))(0,c.bg)(e);if(t.persistedKeys)for(let e of t.persistedKeys)(0,c.bg)(e);(0,c.jv)(`notifications:${a}:`).then(e=>{for(let t of e)(0,c.bg)(t)}),t.cleanup&&t.cleanup().catch(()=>{})}}w.current=e},[m,f]);let v=(0,o.useCallback)(e=>{u(e),(0,c.Is)(tH,JSON.stringify(e))},[]),$=(0,o.useCallback)(e=>{v([...m,{id:`w-${e}-${Date.now()}`,widgetId:e}])},[m,v]),M=(0,o.useCallback)(e=>{let t=m.find(t=>t.id===e);t&&t5(t)?l(t3(t)):v(m.filter(t=>t.id!==e))},[m,v,l]),j=(0,o.useCallback)(()=>{m.filter(t5).forEach(e=>l(t3(e))),v([])},[m,v,l]),z=(0,o.useCallback)((e,t)=>{let a=m.findIndex(t=>t.id===e);if(a<0)return;let i=a+t;if(i<0||i>=m.length)return;let o=[...m];[o[a],o[i]]=[o[i],o[a]],v(o)},[m,v]),S=(0,o.useCallback)(e=>{let t=m.findIndex(t=>t.id===e);if(t<0)return;let a=m[t];if(t5(a))return;let i=tn(a.widgetId);if(!i)return;let o=i.availableSizes??["sm","md","lg"],r=a.size??i.defaultSize,n=o.indexOf(r),s=o[(n+1)%o.length],l=[...m];l[t]={...a,size:s},v(l)},[m,v]),C=(0,o.useMemo)(()=>new Set(m.filter(e=>!t5(e)).map(e=>e.widgetId)),[m]),T=(0,o.useMemo)(()=>new Map,[]);return((0,o.useEffect)(()=>{},[]),f)?(0,i.jsxs)(tB,{children:[(0,i.jsxs)(tK,{children:[(0,i.jsx)(tW,{children:d("widgets.dashboard")}),(0,i.jsxs)(tG,{active:b,onClick:()=>y(!b),children:[(0,i.jsx)(p.In,{name:"plus",size:14}),d("widgets.addWidget")]})]}),(0,i.jsx)(tD,{open:b,activeIds:C,locale:e,onAdd:e=>{$(e)},onRemove:e=>{let t=m.find(t=>!t5(t)&&t.widgetId===e);t&&M(t.id)},onRemoveAll:j,onClose:()=>y(!1)}),0===m.length?(0,i.jsxs)(tQ,{children:[(0,i.jsx)(tX,{children:"✨"}),(0,i.jsx)(tZ,{children:d("widgets.empty.title")}),(0,i.jsx)(t0,{children:d("widgets.empty.body")}),(0,i.jsxs)(t1,{onClick:()=>y(!0),children:[(0,i.jsx)(p.In,{name:"plus",size:14}),d("widgets.empty.cta")]})]}):(0,i.jsx)(p.dO,{items:m.flatMap(e=>{if(t5(e))return[{id:e.id,size:"sm",availableSizes:["sm"],minHeight:160}];let t=tn(e.widgetId);return t?[{id:e.id,size:e.size??t.defaultSize,availableSizes:t.availableSizes??["sm","md","lg"],minHeight:t.minHeight??160}]:[]}),onReorder:(e,t)=>z(e,t),onCycleSize:e=>S(e),onRemove:e=>M(e),accentColor:e=>{let t=m.find(t=>t.id===e.id);if(!(!t||t5(t)))return tn(t.widgetId)?.accentColor},labels:{moveLeft:d("widgets.moveLeft"),moveRight:d("widgets.moveRight"),cycleSize:d("widgets.cycleSize",{size:""}).trim(),remove:d("widgets.remove")},renderPanel:l=>{let c=m.find(e=>e.id===l.id);if(!c)return null;if(t5(c)){let t=t3(c),o="devtools"===t,l=o?{icon:"terminal",label:d("apps.devtools.label"),description:d("apps.devtools.description"),color:"#facc15",category:k("Create",e),hash:"#/playground",needsAuth:!1}:n[t];if(!l)return null;let p=o?null:r.find(e=>e.id===t)??null,h=m.findIndex(e=>e.id===c.id),g=o?a.filter(e=>t4.has(e)).map(e=>{let t=n[e];return{hash:t?.hash??`#/${e}`,label:t?.label??e,iconName:t?.icon,color:t?.color,ts:0}}):void 0;return(0,i.jsx)(t8,{instance:c,appId:t,meta:l,app:p,locale:e,idx:h,totalCount:m.length,tShell:d,recentsOverride:g,onMove:z,onRemove:M,onSelectApp:s})}if("quicklinks"===c.widgetId)return(0,i.jsx)(tl.QuickLinksWidget,{locale:e,pinnedAppIds:t,recentAppIds:a,apps:r,appMeta:n,onSelectApp:s});let p=tn(c.widgetId);if(!p)return null;T.has(c.widgetId)||T.set(c.widgetId,(0,o.lazy)(p.load));let h=T.get(c.widgetId);return(0,i.jsx)(o.Suspense,{fallback:null,children:(0,i.jsx)(h,{locale:e})})},showGrip:!1})]}):null}let t9={0:"☀️",1:"\uD83C\uDF24️",2:"⛅",3:"☁️",45:"\uD83C\uDF2B️",48:"\uD83C\uDF2B️",51:"\uD83C\uDF26️",53:"\uD83C\uDF26️",55:"\uD83C\uDF27️",61:"\uD83C\uDF27️",63:"\uD83C\uDF27️",65:"\uD83C\uDF27️",71:"\uD83C\uDF28️",73:"\uD83C\uDF28️",75:"\uD83C\uDF28️",80:"\uD83C\uDF26️",81:"\uD83C\uDF27️",82:"\uD83C\uDF27️",95:"⛈️",96:"⛈️",99:"⛈️"},ae={0:"\uD83C\uDF19",1:"\uD83C\uDF19",2:"☁️",3:"☁️"},at=Object.fromEntries(eL.map(e=>[e.id,e.icon])),aa=Object.fromEntries(eL.map(e=>[e.id,e.color]));function ai(e){return e<10?`0${e}`:String(e)}function ao({locale:e,greeting:t,userName:a,pinnedApps:r,onSelect:n,t:s}){let[l,d]=(0,o.useState)(()=>new Date),{forecast:c}=(0,h.useWeather)({lat:m.j.lisbon.lat,lon:m.j.lisbon.lon,current:"temperature_2m,apparent_temperature,relative_humidity_2m,weather_code,wind_speed_10m,is_day",daily:"temperature_2m_max,temperature_2m_min,sunrise,sunset,uv_index_max",timezone:m.j.lisbon.timezone,cacheKey:"weather-lisbon-v3"});(0,o.useEffect)(()=>{let e=setInterval(()=>d(new Date),3e4);return()=>clearInterval(e)},[]);let g=`${ai(l.getHours())} : ${ai(l.getMinutes())}`,u=(0,o.useMemo)(()=>{let t,a,i;return t=l.toLocaleDateString("pt"===e?"pt-PT":"en-GB",{weekday:"long"}),a=l.getDate(),i=l.toLocaleDateString("pt"===e?"pt-PT":"en-GB",{month:"long"}),`${t} \xb7 ${a} ${i}`.toUpperCase()},[l,e]),f=r.slice(0,5),x=c?.current?(c.current.is_day?t9[c.current.weather_code??0]:ae[c.current.weather_code??0]??t9[c.current.weather_code??0])??"\xb7":null;return(0,i.jsxs)(an,{children:[c?.current&&(0,i.jsxs)(ag,{children:[(0,i.jsx)("span",{className:"ico",children:x}),(0,i.jsxs)("span",{className:"temp",children:[Math.round(c.current.temperature_2m??0),"\xb0"]}),(0,i.jsx)("span",{className:"lbl",children:s("retreat.weather.city")})]}),(0,i.jsxs)(as,{children:[(0,i.jsx)(al,{children:u}),(0,i.jsxs)(ad,{children:[t,a?(0,i.jsxs)(i.Fragment,{children:[", ",(0,i.jsx)("span",{className:"name",children:a.split(" ")[0]})]}):null,"."]}),(0,i.jsx)(ac,{children:g}),(0,i.jsxs)(ap,{"aria-hidden":!0,children:[(0,i.jsx)("span",{className:"caret",children:"⌘K"}),(0,i.jsx)("span",{className:"txt",children:s("retreat.prompt")})]}),f.length>0&&(0,i.jsx)(ah,{children:f.map((e,t)=>(0,i.jsxs)(am,{onClick:()=>n(e),title:`${t+1} \xb7 ${e.label}`,"aria-label":e.label,children:[(0,i.jsx)("span",{className:"ico",style:{color:aa[e.id]},children:at[e.id]?(0,i.jsx)(p.In,{name:at[e.id],size:18,"aria-hidden":"true"}):"\xb7"}),(0,i.jsx)("span",{className:"n",children:t+1})]},e.id))})]})]})}let ar=(0,d.keyframes)`
...
`,af=l().div`
  ...
  animation: ${au} 0.25s ${c.w4.transitions.easing} both;
...
`,az=l().div`
  ...
  color: ${c.w4.colors.mainTextMuted};
  line-height: 1.45;
`;function aS({t:e,onDismiss:t,onOpenPalette:a,onOpenPreferences:o}){let r=[{iconName:"search",titleKey:"onboarding.tip.palette.title",bodyKey:"onboarding.tip.palette.body",kbd:"⌘K",onClick:a},{iconName:"settings",titleKey:"onboarding.tip.preferences.title",bodyKey:"onboarding.tip.preferences.body",onClick:o},{iconName:"check",titleKey:"onboarding.tip.daily.title",bodyKey:"onboarding.tip.daily.body",onClick:()=>{window.location.hash="#/daily"}}];return(0,i.jsxs)(af,{role:"region","aria-label":e("onboarding.aria"),children:[(0,i.jsxs)(ax,{children:[(0,i.jsxs)(ab,{children:[(0,i.jsx)(p.YZ,{children:e("onboarding.eyebrow")}),(0,i.jsx)(ay,{children:e("onboarding.title")}),(0,i.jsx)(aw,{children:e("onboarding.subtitle")})]}),(0,i.jsx)(av,{type:"button",title:e("onboarding.dismiss"),"aria-label":e("onboarding.dismiss"),onClick:t,children:(0,i.jsx)(p.In,{name:"close",size:14})})]}),(0,i.jsx)(ak,{children:r.map(t=>(0,i.jsxs)(a$,{type:"button",onClick:t.onClick,disabled:!t.onClick,children:[(0,i.jsx)(aM,{"aria-hidden":!0,children:(0,i.jsx)(p.In,{name:t.iconName,size:18})}),(0,i.jsxs)(aj,{children:[e(t.titleKey),t.kbd&&(0,i.jsx)(p.ue,{children:t.kbd})]}),(0,i.jsx)(az,{children:e(t.bodyKey)})]},t.titleKey))})]})}let aC=Object.fromEntries(eL.map(({id:e,icon:t,labelKey:a,descriptionKey:i,color:o,category:r,suite:n,interest:s,needsAuth:l,hash:d})=>[e,{icon:t,labelKey:a,descriptionKey:i,color:o,category:r,suite:n,interest:s,needsAuth:l,hash:d}])),aT=new Set(eL.filter(e=>"default"!==eN(e)).map(e=>e.id)),aA=eL.filter(e=>e.enabled&&"default"===eN(e)),aF=["All","Live","School","Explore","Create","Inspect","Connect","Content","Video","Music","Entertainment","Fun","Lab","Tools"],aN=["Live","AI Lab","Data Studio","Life Dashboard","Learning Hub","Game Room","Entertainment"],aL=aN.filter(e=>aA.some(t=>aC[t.id]?.suite===e));function aP(e,t=new Date){let a=t.getHours();return $(a<12?"greeting.morning":a<19?"greeting.afternoon":"greeting.evening",e)}let aI={0:"☀️",1:"\uD83C\uDF24️",2:"⛅",3:"☁️",45:"\uD83C\uDF2B️",48:"\uD83C\uDF2B️",51:"\uD83C\uDF26️",53:"\uD83C\uDF26️",55:"\uD83C\uDF27️",61:"\uD83C\uDF27️",63:"\uD83C\uDF27️",65:"\uD83C\uDF27️",71:"\uD83C\uDF28️",73:"\uD83C\uDF28️",75:"\uD83C\uDF28️",80:"\uD83C\uDF26️",81:"\uD83C\uDF27️",82:"\uD83C\uDF27️",95:"⛈️",96:"⛈️",99:"⛈️"},aR={0:"\uD83C\uDF19",1:"\uD83C\uDF19",2:"☁️",3:"☁️"},aD=(0,d.keyframes)`
  from { opacity: 0; transform: translateY(8px); }
  to   { opacity: 1; transform: translateY(0); }
`,aH=l().div`
  display: flex;
...
`,aO=l().button`
  ...
  .logo-tile {
    ...
    box-shadow:
      ...
      0 6px 18px -4px ${c.w4.colors.accent}88;
...
`,aW=l()("nav",{shouldForwardProp:e=>"collapsed"!==e})`
...
`,a1=l().div`
  ...
  .dot {
    ...
    border-radius: 50%;
    background: #7fb77e;
    box-shadow: 0 0 6px rgba(127, 183, 126, 0.7);
  }
  .name { color: ${c.w4.colors.mainText}; }
  .sep  { opacity: 0.5; }
...
`,a4=l().p`
  margin: ${c.w4.spacing.md} 0 ${c.w4.spacing.lg};
  max-width: 560px;
  font-family: ${c.w4.typography.fontFamily};
  font-size: 16px;
  line-height: 1.55;
...
`,a5=l().button`
  ...
  ${({variant:e})=>"primary"===e?`
        ...
        &:hover { background: ${c.w4.colors.accentHover}; transform: translateY(-1px); }
      `:`
        background: ${c.w4.colors.surface};
        color: ${c.w4.colors.mainText};
        border: 1px solid ${c.w4.colors.border};
        &:hover { border-color: ${c.w4.colors.accent}; background: ${c.w4.colors.surfaceRaised}; }
      `}

  .arrow { font-family: ${c.w4.typography.fontFamilyMono}; }
`,a3=l().h1`
...
`,ia=l().button`
  ...
  &:focus-visible { ${c.w4.focusRing} }
`;function ii({apps:e,recentAppIds:t,pinnedAppIds:a,onTogglePin:r,onMovePinned:n,onSelect:s,user:l,onSignOut:d,onPreferences:u,onClearData:f,onOpenPalette:x,notifications:y}){let v,M,j,[z]=(0,h.useProfile)(),S=(0,o.useMemo)(()=>e.filter(e=>{if(aT.has(e.id))return!1;let t=aC[e.id];return!t||!(0,h.hasInterests)(z)||!t.interest||!!z.interests.includes(t.interest)}),[e,z]),[C,T]=(0,o.useState)("home"),[A,F]=(0,o.useState)("All"),[N,L]=(0,o.useState)(null),[P,I]=(0,o.useState)(()=>new Date),{forecast:R}=(0,h.useWeather)({lat:m.j.lisbon.lat,lon:m.j.lisbon.lon,current:"temperature_2m,apparent_temperature,relative_humidity_2m,weather_code,wind_speed_10m,is_day",daily:"temperature_2m_max,temperature_2m_min,sunrise,sunset,uv_index_max",timezone:m.j.lisbon.timezone,cacheKey:"weather-lisbon-v3"}),[D,H]=(0,o.useState)(!0);(0,o.useEffect)(()=>{let e=!1;return(0,c.PL)("shell:onboarding-dismissed").then(t=>{e||H("true"===t)}).catch(()=>void 0),()=>{e=!0}},[]);let E=(0,o.useCallback)(()=>{H(!0),(0,c.Is)("shell:onboarding-dismissed","true").catch(()=>void 0)},[]);(0,o.useEffect)(()=>{let e=setInterval(()=>I(new Date),6e4),t=()=>{document.hidden||I(new Date)};return document.addEventListener("visibilitychange",t),window.addEventListener("focus",t),()=>{clearInterval(e),document.removeEventListener("visibilitychange",t),window.removeEventListener("focus",t)}},[]);let O=(0,o.useCallback)(()=>{T("home"),F("All"),L(null),(0,c.Is)("shell:home-mode","dashboard")},[]),q=(0,o.useCallback)(()=>{T("retreat"),F("All"),L(null),(0,c.Is)("shell:home-mode","retreat")},[]),B=(0,o.useCallback)(e=>{T("apps"),L(e),F("All")},[]),K=(0,o.useMemo)(()=>({live:"Live",lab:"AI Lab",vida:"Life Dashboard",learn:"Learning Hub",games:"Game Room",ent:"Entertainment"}),[]);(0,o.useEffect)(()=>{let e=()=>{let e=window.location.hash,t=e.indexOf("?");if(t<0)return;let a=new URLSearchParams(e.slice(t+1)).get("suite");if(!a)return;let i=K[a];i&&(T("apps"),L(i),F("All"))};return e(),window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[K]);let[W,G]=(0,o.useState)(()=>{try{let e=localStorage.getItem("shell:suites-collapsed");return null===e||"true"===e}catch{return!0}}),[V,Y]=(0,o.useState)(()=>{try{return"true"===localStorage.getItem("shell:home-sidebar-hidden")}catch{return!1}}),[_]=(0,o.useState)(()=>{try{return"1"===sessionStorage.getItem(tE)}catch{return!1}});(0,o.useEffect)(()=>{let e=!1;return(async()=>{let[t,a,i]=await Promise.all([(0,c.PL)("shell:suites-collapsed"),(0,c.PL)("shell:home-mode"),(0,c.PL)("shell:home-sidebar-hidden")]);if(!e){if(null!==t){G("true"===t);try{localStorage.setItem("shell:suites-collapsed",t)}catch{}}if(null!==i){Y("true"===i);try{localStorage.setItem("shell:home-sidebar-hidden",i)}catch{}}_?(T("home"),(0,c.Is)("shell:home-mode","dashboard").catch(()=>void 0)):"retreat"===a&&T("retreat")}})(),()=>{e=!0}},[_]),(0,o.useEffect)(()=>{let e=()=>{T("home"),F("All"),L(null)};return window.addEventListener("atlantis:open-widget-picker",e),()=>window.removeEventListener("atlantis:open-widget-picker",e)},[]);let U=(0,o.useCallback)(()=>{G(e=>{let t=!e;try{localStorage.setItem("shell:suites-collapsed",String(t))}catch{}return(0,c.Is)("shell:suites-collapsed",String(t)),t})},[]),J=(0,o.useCallback)(()=>{Y(e=>{let t=!e;try{localStorage.setItem("shell:home-sidebar-hidden",String(t))}catch{}return(0,c.Is)("shell:home-sidebar-hidden",String(t)).catch(()=>void 0),t})},[]),[Q,X]=(0,g.Ym)(),Z=(0,o.useMemo)(()=>(0,g.Nx)(Q,td),[Q]),ee=(0,o.useMemo)(()=>{let e={};for(let t of S){let a=aC[t.id];a&&(e[t.id]={icon:a.icon,label:Z(a.labelKey),description:Z(a.descriptionKey),color:a.color,category:k(a.category,Q),hash:a.hash,needsAuth:!!a.needsAuth})}return e},[S,Z,Q]),et=(0,o.useMemo)(()=>S.filter(e=>{let t=aC[e.id],i="All"===A||t?.category===A,o=!N||t?.suite===N,r="All"===A&&!N&&a.includes(e.id);return i&&o&&!r}),[S,A,N,a]),ea=(0,o.useMemo)(()=>{if("All"!==A)return null;if(N){let e={};for(let t of et){let a=aC[t.id]?.category??"Other";e[a]||(e[a]=[]),e[a].push(t)}return{type:"category",groups:e}}let e={};for(let t of et){let a=aC[t.id]?.suite??"Other";e[a]||(e[a]=[]),e[a].push(t)}return{type:"suite",groups:e}},[et,A,N]),ei=(0,o.useMemo)(()=>{let e={};for(let t of S){let a=aC[t.id]?.suite;a&&(e[a]=(e[a]??0)+1)}return e["AI Lab"]=(e["AI Lab"]??0)+1,e},[S]),eo=(0,o.useMemo)(()=>a.flatMap(e=>S.filter(t=>t.id===e)),[a,S]),er=(0,o.useMemo)(()=>t.filter(e=>!a.includes(e)).flatMap(e=>S.filter(t=>t.id===e)).slice(0,6),[t,a,S]),en=0,es=(e,t,o)=>{let l=aC[e.id],d=a.includes(e.id),h=l?Z(l.descriptionKey):"",g=l?.color??c.w4.colors.accent,m=l?k(l.category,Q):"",u=o&&o.total>1?(0,i.jsxs)(i.Fragment,{children:[o.pinIdx>0&&(0,i.jsx)(a7,{type:"button",title:Z("pinned.moveLeft"),onClick:t=>{t.stopPropagation(),n(e.id,-1)},children:(0,i.jsx)(p.In,{name:"chevron-left",size:13})}),o.pinIdx<o.total-1&&(0,i.jsx)(a7,{type:"button",title:Z("pinned.moveRight"),onClick:t=>{t.stopPropagation(),n(e.id,1)},children:(0,i.jsx)(p.In,{name:"chevron-right",size:13})})]}):void 0;return(0,i.jsx)(p.SV,{vizId:e.id,label:e.label,description:h,hash:l?.hash??e.hash,category:m,accentColor:g,needsAuth:l?.needsAuth,pinned:d,index:t,onClick:()=>s(e),onHoverIntent:()=>b(e.id),onTogglePin:()=>r(e.id),reorderControls:u},e.id)},el=e=>{let t=a.includes("devtools");return(0,i.jsx)(p.SV,{vizId:"devtools",label:Z("apps.devtools.label"),description:Z("apps.devtools.description"),hash:"#/playground",category:k("Create",Q),accentColor:"#facc15",pinned:t,index:e,onClick:()=>{window.location.hash="#/playground"},onHoverIntent:()=>b("playground"),onTogglePin:()=>r("devtools")})};return(0,i.jsx)(i.Fragment,{children:(0,i.jsxs)(aH,{children:[(0,i.jsxs)(aE,{children:[(0,i.jsx)(aq,{children:(0,i.jsx)(p.K0,{onClick:J,title:V?Z("sidebar.show"):Z("sidebar.hide"),"aria-label":V?Z("sidebar.show"):Z("sidebar.hide"),"aria-pressed":V,children:(0,i.jsx)(p.In,{name:"panel-left",size:16})})}),(0,i.jsxs)(aO,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:[(0,i.jsx)("span",{className:"logo-tile","aria-hidden":"true",children:"A"}),(0,i.jsx)("span",{className:"logo-wordmark",children:"Atlantis"})]}),(0,i.jsx)(aB,{children:(0,i.jsx)(p.Yw,{locale:Q,onLocaleChange:X,notifications:y,onOpenPalette:x,paletteLabel:Z("palette.search"),user:l?{name:l.name,email:l.email,avatarUrl:l.avatarUrl}:void 0,userMenuItems:l?[...u?[{label:Z("userMenu.preferences"),icon:(0,i.jsx)(p.In,{name:"user-cog",size:14}),onClick:u}]:[],{label:Z("userMenu.settings"),icon:(0,i.jsx)(p.In,{name:"settings",size:14}),onClick:()=>{window.location.hash="#/settings"}},...f?[{label:Z("userMenu.clearData"),icon:(0,i.jsx)(p.In,{name:"trash",size:14}),onClick:f,danger:!0}]:[],...d?[{label:Z("userMenu.signOut"),icon:(0,i.jsx)(p.In,{name:"log-out",size:14}),onClick:d,danger:!0}]:[]]:[],userMenuControlLabels:{language:Z("userMenu.language"),theme:Z("userMenu.theme"),themeLight:Z("userMenu.themeLight"),themeDark:Z("userMenu.themeDark"),themeSystem:Z("userMenu.themeSystem")},onSignIn:()=>{window.location.hash="#/home"}})})]}),(0,i.jsxs)(aK,{children:[(0,i.jsxs)(aW,{collapsed:V,children:[(0,i.jsx)(aJ,{active:"home"===C,onClick:O,children:(0,i.jsxs)("span",{style:{display:"flex",alignItems:"center",gap:"8px"},children:[(0,i.jsx)(p.In,{name:"home",size:14}),Z("sidebar.home")]})}),(0,i.jsx)(aJ,{active:"retreat"===C,onClick:q,children:(0,i.jsxs)("span",{style:{display:"flex",alignItems:"center",gap:"8px"},children:[(0,i.jsx)(p.In,{name:"moon",size:14}),Z("sidebar.retreat")]})}),(0,i.jsx)(aX,{}),aL.length>0&&(0,i.jsxs)(i.Fragment,{children:[W?(0,i.jsx)(aU,{type:"button",onClick:U,children:Z("sidebar.showSuites")}):(0,i.jsxs)(i.Fragment,{children:[(0,i.jsxs)(aG,{onClick:U,children:[$("suites",Q),(0,i.jsx)(aV,{collapsed:W,children:(0,i.jsx)(p.In,{name:"chevron-down",size:14})})]}),(0,i.jsx)(aY,{collapsed:W,children:(0,i.jsx)(a_,{children:aL.map(e=>{let t,a=(t=eP.find(t=>t.yamlSuite===e))?{icon:t.icon,color:t.color}:void 0,o="apps"===C&&N===e;return(0,i.jsxs)(aJ,{active:o,onClick:()=>B(e),children:[a&&(0,i.jsx)("span",{style:{display:"inline-flex",color:o?c.w4.colors.accent:a.color,flexShrink:0},children:(0,i.jsx)(p.In,{name:a.icon,size:16,"aria-hidden":"true"})}),(0,i.jsx)("span",{style:{flex:1,textAlign:"left"},children:w[e]?.[Q]??e}),(0,i.jsx)(aQ,{active:o,children:ei[e]??0})]},e)})})})]}),(0,i.jsx)(aX,{})]})]}),(0,i.jsx)(aZ,{bleed:"retreat"===C,children:"retreat"===C?(0,i.jsx)(ao,{locale:Q,greeting:aP(Q,P),userName:l?.name,pinnedApps:eo,onSelect:s,t:Z}):(0,i.jsxs)(i.Fragment,{children:["home"===C&&(0,i.jsxs)(a0,{children:[(0,i.jsxs)(a1,{children:[(0,i.jsx)("span",{className:"dot"}),aP(Q,P),l?.name?(0,i.jsxs)(i.Fragment,{children:[",\xa0",(0,i.jsx)("span",{className:"name",children:l.name.split(" ")[0]})]}):null,(0,i.jsx)("span",{className:"sep",children:"\xb7"}),(v=P.toLocaleDateString("pt"===Q?"pt-PT":"en-GB",{weekday:"long"}),M=P.getDate(),j=P.toLocaleDateString("pt"===Q?"pt-PT":"en-GB",{month:"long"}),`${v} \xb7 ${M} ${j}`.toUpperCase()),R?.current&&(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)("span",{className:"sep",children:"\xb7"}),(0,i.jsx)("span",{className:"ico",children:(R.current.is_day?aI[R.current.weather_code??0]:aR[R.current.weather_code??0]??aI[R.current.weather_code??0])??"\xb7"}),(0,i.jsxs)("span",{className:"temp",children:[Math.round(R.current.temperature_2m??0),"\xb0"]})]})]}),(0,i.jsxs)(a3,{children:[Z("home.hero.tagline"),(0,i.jsx)("br",{}),(0,i.jsx)("span",{className:"accent",children:Z("home.hero.taglineAccent")})]}),(0,i.jsx)(a4,{children:Z("home.hero.lede")}),(0,i.jsxs)(a2,{children:[(eo[0]??er[0])&&(0,i.jsxs)(a5,{variant:"primary",type:"button",onClick:()=>s(eo[0]??er[0]),children:[Z("home.hero.continue")," \xb7 ",(eo[0]??er[0]).label,(0,i.jsx)("span",{className:"arrow",children:"→"})]}),(0,i.jsx)(a5,{variant:"ghost",type:"button",onClick:()=>T("apps"),children:Z("home.hero.browse")})]})]}),"home"===C&&!D&&0===eo.length&&0===er.length&&(0,i.jsx)(aS,{t:Z,onDismiss:E,onOpenPalette:x,onOpenPreferences:u}),"home"===C&&(0,i.jsx)(t7,{locale:Q,pinnedAppIds:a,recentAppIds:t,apps:S,appMeta:ee,onSelectApp:s,onTogglePin:r}),"apps"===C&&(0,i.jsxs)(i.Fragment,{children:[0===et.length&&(null!==N||"All"!==A||(0,h.hasInterests)(z))&&(0,i.jsxs)(a9,{children:[(0,i.jsx)(ie,{children:$("home.emptyFiltered.title",Q)}),(0,i.jsx)(it,{children:$("home.emptyFiltered.desc",Q)}),(0,i.jsxs)("div",{style:{display:"flex",gap:c.w4.spacing.sm},children:[(null!==N||"All"!==A)&&(0,i.jsx)(ia,{type:"button",onClick:()=>{L(null),F("All")},style:{background:"transparent",color:c.w4.colors.accent,border:`1px solid ${c.w4.colors.border}`},children:$("home.emptyFiltered.clear",Q)}),u&&(0,i.jsx)(ia,{type:"button",onClick:u,children:$("home.emptyFiltered.cta",Q)})]})]}),"All"===A&&!N&&eo.length>0&&(0,i.jsxs)("div",{children:[(0,i.jsx)(a6,{children:$("pinned",Q)}),(0,i.jsx)(a8,{children:eo.map((e,t)=>es(e,en++,{pinIdx:t,total:eo.length}))})]}),"All"===A&&!N&&er.length>0&&(0,i.jsxs)("div",{children:[(0,i.jsx)(a6,{children:$("recentlyUsed",Q)}),(0,i.jsx)(a8,{children:er.map(e=>es(e,en++))})]}),ea?[..."suite"===ea.type?aN:aF.slice(1),"Other"].filter(e=>ea.groups[e]?.length>0).map(e=>(0,i.jsxs)("div",{children:[(0,i.jsx)(a6,{children:"suite"===ea.type?w[e]?.[Q]??e:k(e,Q)}),(0,i.jsxs)(a8,{children:[ea.groups[e].map(e=>es(e,en++)),("suite"===ea.type&&"AI Lab"===e||"category"===ea.type&&"Lab"===e)&&el(en++)]})]},e)):(0,i.jsxs)(a8,{children:[et.map(e=>es(e,en++)),"Lab"===A&&el(en++)]})]})]})})]})]})})}let io=(0,a(82791).U)("https://eqvzakschpdemcgexjyy.supabase.co","sb_publishable_D_UOsNIA7qD3929ZzReWLw_k8d8MxWL");function ir(){return io.auth.signInWithOAuth({provider:"google",options:{redirectTo:window.location.origin}})}function is(){return io.auth.signOut()}let il=(0,d.keyframes)`
...
`,iu=()=>(0,i.jsxs)("svg",{width:"18",height:"18",viewBox:"0 0 48 48",children:[(0,i.jsx)("path",{fill:"#EA4335",d:"M24 9.5c3.14 0 5.95 1.08 8.17 2.86l6.1-6.1C34.46 3.19 29.53 1 24 1 14.82 1 7.07 6.48 3.88 14.22l7.1 5.52C12.68 13.55 17.9 9.5 24 9.5z"}),(0,i.jsx)("path",{fill:"#4285F4",d:"M46.52 24.5c0-1.64-.15-3.22-.42-4.75H24v9h12.67c-.55 2.94-2.18 5.44-4.65 7.12l7.19 5.59C43.39 37.48 46.52 31.47 46.52 24.5z"}),(0,i.jsx)("path",{fill:"#FBBC05",d:"M10.98 28.26A14.57 14.57 0 0 1 9.5 24c0-1.48.25-2.91.68-4.26l-7.1-5.52A23.93 23.93 0 0 0 .5 24c0 3.87.93 7.52 2.58 10.74l7.9-6.48z"}),(0,i.jsx)("path",{fill:"#34A853",d:"M24 47c5.52 0 10.15-1.83 13.53-4.97l-7.19-5.59C28.47 37.82 26.36 38.5 24 38.5c-6.1 0-11.32-4.05-13.02-9.74l-7.9 6.48C6.07 42.54 14.45 47 24 47z"})]}),ix=l().button`
  background: none;
  border: none;
  color: ${c.w4.colors.mainTextMuted};
  font-family: ${c.w4.typography.fontFamily};
...
`,iO=l().div`
  ...
  justify-content: center;
  padding-top: 10vh;
  animation: ${iH} ${c.w4.transitions.fast};
...
`,iq=l().div`
  ...
  overflow: hidden;
  box-shadow: ${c.w4.elevation.lg};
  animation: ${iE} ${c.w4.transitions.base};
  font-family: ${c.w4.typography.fontFamily};
  color: ${c.w4.colors.mainText};
  display: flex;
  flex-direction: column;
...
`,iJ=l().span`
  ...
  font-size: 11px;
  color: ${c.w4.colors.mainTextFaint};
`,iQ=l()("div",{shouldForwardProp:e=>"selected"!==e})`
  display: flex;
  align-items: center;
  gap: 14px;
  padding: 10px 22px;
...
`,iX=l()("div",{shouldForwardProp:e=>"tintColor"!==e&&"selected"!==e})`
  width: 36px;
  height: 36px;
  border-radius: 9px;
  display: flex;
  ...
  transition: ${c.w4.transitions.fast};
`,iZ=l()("div",{shouldForwardProp:e=>"tintColor"!==e})`
  width: 36px;
  height: 36px;
  border-radius: 9px;
...
`,i0=l().div`
  ...
  background: transparent;
  flex-shrink: 0;
`,i1=l()("div",{shouldForwardProp:e=>"tintColor"!==e})`
  width: 36px;
  height: 36px;
  border-radius: 9px;
  display: flex;
...
`,i4=l().div`
  flex: 1;
  min-width: 0;
`,i2=l()("div",{shouldForwardProp:e=>"selected"!==e})`
  font-size: 14px;
  font-weight: 500;
...
`,oh=l().span`
  ...
  font-size: 11px;
  color: ${c.w4.colors.mainTextMuted};
`;function og(e,t){if(!t)return!0;let a=t.toLowerCase();return e.label.toLowerCase().includes(a)||(e.meta?.toLowerCase().includes(a)??!1)}async function om(){let e;try{e=await h.forma.load()}catch{return null}if(!e)return null;let t=new Date().toISOString().slice(0,10),a=(0,h.proteinByDay)(e.meals,t),i=e.meals.filter(e=>e.date===t).reduce((e,t)=>e+(t.kcal??0),0),o=e.walks.filter(e=>e.date===t).reduce((e,t)=>e+t.minutes,0),r=[];for(let e=6;e>=0;e-=1){let t=new Date;t.setDate(t.getDate()-e),r.push(t.toISOString().slice(0,10))}let n=r.map(t=>({date:t,protein:(0,h.proteinByDay)(e.meals,t),kcal:e.meals.filter(e=>e.date===t).reduce((e,t)=>e+(t.kcal??0),0),walk:e.walks.filter(e=>e.date===t).reduce((e,t)=>e+t.minutes,0)})),s=new Date;s.setDate(s.getDate()-6);let l=(0,h.weeklyAdherence)(e.sessions,s,e.goal.weeklyFasts),d=(0,h.streakDays)(e.sessions,e.goal.targetHours),c=(0,h.avgFastDuration)(e.sessions,30),p=e.meals.filter(e=>e.date>=r[0]).slice(-10).map(e=>`${e.date} ${e.slot} \xb7 ${e.proteinG??0}g protein \xb7 ${e.kcal??0}kcal`).join("\n");return["FORMA (fasting + diet tracker) snapshot for this user — use it when the question is about meals, protein, weight, fasting, walks, streak, or daily routine:",`TODAY (${t}): ${Math.round(a)}g protein \xb7 ${Math.round(i)}kcal \xb7 walk ${o}min`,"LAST 7 DAYS:",n.map(e=>`- ${e.date}: ${Math.round(e.protein)}g \xb7 ${Math.round(e.kcal)}kcal \xb7 walk ${e.walk}min`).join("\n"),`Weekly fast adherence: ${Math.round(100*l)}% (target ${e.goal.weeklyFasts}/wk) \xb7 streak ${d}d \xb7 avg fast (30d) ${c.toFixed(1)}h`,`Recent meals:
${p||"(none)"}`].join("\n")}function ou({apps:e,recentIds:t,suites:a=[],games:n=[],actions:s=[],hasAsk:l=!1,groqKey:d,locale:m,initialScope:u,onNavigate:f,onClose:x}){let b=(0,o.useMemo)(()=>(0,g.Nx)(m,td),[m]),[y,w]=(0,o.useState)(""),[v,k]=(0,o.useState)(()=>"ask"!==u||l?u??"all":"all"),[$,M]=(0,o.useState)(0),[j,z]=(0,o.useState)([]),[S,C]=(0,o.useState)(!1),T=(0,o.useRef)([]),A=(0,o.useRef)(null),F=(0,o.useRef)(null),N=(0,o.useRef)(null),L=(0,o.useRef)(null),[P,I]=(0,o.useState)([]),R=(0,o.useRef)(null);(0,o.useEffect)(()=>{if("ask"!==v)return(null!==R.current&&clearTimeout(R.current),y.trim())?(R.current=setTimeout(()=>{iR(y).then(I)},200),()=>{null!==R.current&&clearTimeout(R.current)}):void I([])},[y,v]),(0,o.useEffect)(()=>(A.current?.focus(),()=>{L.current?.abort()}),[]),(0,o.useEffect)(()=>{T.current=j},[j]),(0,o.useEffect)(()=>{N.current?.scrollIntoView({behavior:"smooth"})},[j,S]);let D=(0,o.useMemo)(()=>{let i=new Set(t),o=e.map(e=>({id:`app:${e.id}`,kind:"app",label:e.label,meta:e.description,isRecent:i.has(e.id),appIcon:{iconName:e.icon,color:e.color},onConfirm:()=>{f(e.hash),x()}}));return[...a.map(e=>({id:`suite:${e.id}`,kind:"suite",label:e.name,meta:e.sub,glyphIcon:{iconName:e.iconName,color:e.color},shortcut:e.shortcut,onConfirm:()=>{e.onConfirm(),x()}})),...o,...n.map(e=>({id:`game:${e.id}`,kind:"game",label:e.name,meta:b("palette.meta.game"),gameGlyph:{iconName:e.iconName,color:e.color},hash:e.hash,onConfirm:()=>{f(e.hash),x()}})),...s.map(e=>({id:`action:${e.id}`,kind:"action",label:e.label,meta:e.meta,glyphIcon:{iconName:e.iconName,color:e.color??c.w4.colors.accent},shortcut:e.shortcut,onConfirm:()=>{e.onClick(),x()}}))]},[e,a,n,s,t,f,x,b]),H=(0,o.useMemo)(()=>P.map(e=>({id:e.id,kind:"action",label:e.label,meta:e.subtitle,glyphIcon:e.iconName?{iconName:e.iconName,color:c.w4.colors.mainTextMuted}:void 0,hash:e.hash,onConfirm:()=>{f(e.hash),x()}})),[P,f,x]),E=(0,o.useMemo)(()=>{if("ask"===v)return[];let e=D.filter(e=>og(e,y)),a=[],i=(e,t,i)=>{if(0!==i.length)for(let o of(a.push({kind:"header",label:b(t),key:e,count:i.length}),i))a.push({kind:"item",item:o})};return"recent"===v?i("recent","palette.recent",D.filter(e=>"app"===e.kind&&e.isRecent&&og(e,y)).sort((e,a)=>t.indexOf(e.id.slice(4))-t.indexOf(a.id.slice(4)))):"jump"===v?(i("suites","palette.section.suites",e.filter(e=>"suite"===e.kind)),i("apps","palette.section.apps",e.filter(e=>"app"===e.kind)),i("games","palette.section.games",e.filter(e=>"game"===e.kind))):"actions"===v?(i("actions","palette.section.actions",e.filter(e=>"action"===e.kind)),i("content","palette.section.content",H)):(i("jump","palette.section.jump",e.filter(e=>"suite"===e.kind||"app"===e.kind||"game"===e.kind)),i("actions","palette.section.actions",e.filter(e=>"action"===e.kind)),i("content","palette.section.content",H),l&&d&&i("ask","palette.section.ask",iD.map((e,t)=>({id:`suggest:${t}`,kind:"suggest",label:b(e),meta:b("palette.ask.suggestMeta"),shortcut:["↵"],onConfirm:()=>{k("ask"),setTimeout(()=>{q(b(e))},0)}})))),a},[v,y,D,t,b,l,d,H]),O=(0,o.useMemo)(()=>E.filter(e=>"item"===e.kind),[E]);(0,o.useEffect)(()=>{M(0)},[v,y]),(0,o.useEffect)(()=>{let e=F.current;if(!e)return;let t=e.querySelectorAll("[data-selectable]");t[$]?.scrollIntoView({block:"nearest"})},[$]);let q=(0,o.useCallback)(async e=>{if(!d||!e.trim())return;let t=e.trim(),a=`turn-${Date.now()}`;z(e=>[...e,{id:a,question:t}]),C(!0),w("");let i=[];for(let e of T.current)e.answer&&(i.push({role:"user",content:e.question}),i.push({role:"assistant",content:e.answer}));L.current?.abort();let o=new AbortController;L.current=o;try{let e=await om(),r="pt"===m?"Portuguese":"English",n=["You are Atlantis, a personal-dashboard assistant in the command palette.",`Be concise and direct. Answer in ${r}. Markdown is rendered — use bullets, **bold**, and `,"`> [!TIP]` callouts. Skip headings unless the answer is long.",e?`
${e}`:""].join("\n"),s=await (0,h.askGroq)(t,{key:d,locale:"pt"===m?"pt":"en",signal:o.signal,history:i,system:n});o.signal.aborted||z(e=>e.map(e=>e.id===a?{...e,answer:s}:e))}catch(t){if(o.signal.aborted)return;let e=t instanceof Error?t.message:String(t);z(t=>t.map(t=>t.id===a?{...t,error:e}:t))}finally{o.signal.aborted||C(!1)}},[d,m]),B=(0,o.useCallback)(e=>{if("Escape"===e.key){if("ask"===v&&y.trim())return void w("");if("ask"===v&&j.length>0){L.current?.abort(),C(!1),z([]);return}return void x()}if("ask"===v){"Enter"===e.key&&y.trim()&&(e.preventDefault(),q(y.trim()));return}if("ArrowDown"===e.key)e.preventDefault(),M(e=>Math.min(e+1,O.length-1));else if("ArrowUp"===e.key)e.preventDefault(),M(e=>Math.max(e-1,0));else if("Enter"===e.key){let e=O[$];e&&e.item.onConfirm()}},[v,y,j.length,O,$,x,q]),K=(0,o.useCallback)(e=>{e.target===e.currentTarget&&x()},[x]),W="ask"===v?j.length>0?b("palette.ask.followUp"):b("palette.ask.placeholder"):b("palette.placeholder"),G=(0,o.useMemo)(()=>{let e=[{value:"all",label:b("palette.scope.all")},{value:"jump",label:b("palette.scope.jump")},{value:"actions",label:b("palette.scope.actions")}];return l&&d&&e.push({value:"ask",label:b("palette.scope.ask"),highlight:!0}),e.push({value:"recent",label:b("palette.scope.recent")}),e},[b,l,d]),V=-1;return tp().createPortal((0,i.jsx)(iO,{onClick:K,children:(0,i.jsxs)(iq,{onClick:e=>e.stopPropagation(),children:[(0,i.jsxs)(iB,{children:[(0,i.jsx)(iK,{active:"ask"===v,children:(0,i.jsx)(p.In,{name:"ask"===v?"sparkle":"search",size:20,"aria-hidden":"true"})}),(0,i.jsx)(iW,{ref:A,placeholder:W,value:y,onChange:e=>w(e.target.value),onKeyDown:B,"aria-label":b("palette.search")}),(0,i.jsx)(iG,{children:"esc"})]}),(0,i.jsx)(iV,{children:(0,i.jsx)(p.tU,{tabs:G,value:v,onChange:k,"aria-label":b("palette.scope.ariaLabel")})}),"ask"===v?(0,i.jsx)(i7,{children:0!==j.length||S?(0,i.jsxs)(oi,{children:[j.map(e=>(0,i.jsxs)(r().Fragment,{children:[(0,i.jsxs)(oo,{children:[(0,i.jsx)(or,{children:b("palette.ask.you")}),(0,i.jsx)(on,{children:e.question})]}),(0,i.jsxs)(oo,{children:[(0,i.jsx)(or,{children:b("palette.ask.atlantis")}),void 0!==e.answer?(0,i.jsx)(p.mQ,{children:e.answer}):void 0!==e.error?(0,i.jsx)(od,{children:e.error}):(0,i.jsxs)(ol,{"aria-label":b("palette.ask.thinking"),children:[(0,i.jsx)("span",{}),(0,i.jsx)("span",{}),(0,i.jsx)("span",{})]})]})]},e.id)),(0,i.jsx)("div",{ref:N})]}):(0,i.jsxs)(i9,{children:[(0,i.jsx)(oe,{children:b("palette.ask.suggestionsTitle")}),(0,i.jsx)(ot,{children:iD.map(e=>(0,i.jsx)(oa,{onClick:()=>{q(b(e))},type:"button",children:b(e)},e))}),(0,i.jsx)(oe,{style:{marginTop:4},children:b("palette.ask.hint")})]})}):(0,i.jsx)(iY,{ref:F,children:0===O.length?(0,i.jsxs)(oc,{children:[(0,i.jsx)("div",{className:"icon",children:(0,i.jsx)(p.In,{name:"search",size:16,"aria-hidden":"true"})}),(0,i.jsxs)("div",{className:"title",children:[b("palette.noMatch")," ",y&&(0,i.jsxs)("span",{className:"query",children:["“",y,"”"]})]}),(0,i.jsx)("div",{className:"hint",children:b("palette.emptyHint")})]}):E.map((e,t)=>{if("header"===e.kind)return(0,i.jsxs)(i_,{children:[(0,i.jsx)(iU,{children:e.label}),(0,i.jsx)(iJ,{children:e.count})]},`h-${e.key}`);let a=V+=1,o=a===$,r=e.item;return(0,i.jsxs)(iQ,{selected:o,"data-selectable":!0,onMouseEnter:()=>M(a),onClick:()=>r.onConfirm(),children:[r.appIcon&&(0,i.jsx)(iX,{tintColor:r.appIcon.color,selected:o,children:(0,i.jsx)(p.In,{name:r.appIcon.iconName,size:18,"aria-hidden":"true",color:r.appIcon.color})}),r.glyphIcon&&(0,i.jsx)(iZ,{tintColor:r.glyphIcon.color,children:(0,i.jsx)(p.In,{name:r.glyphIcon.iconName,size:18,"aria-hidden":"true"})}),r.gameGlyph&&(0,i.jsx)(i1,{tintColor:r.gameGlyph.color,children:(0,i.jsx)(p.In,{name:r.gameGlyph.iconName,size:18,"aria-hidden":"true",color:r.gameGlyph.color})}),"suggest"===r.kind&&(0,i.jsx)(i0,{children:(0,i.jsx)(p.In,{name:"sparkle",size:18,"aria-hidden":"true"})}),(0,i.jsxs)(i4,{children:[(0,i.jsx)(i2,{selected:o,children:r.label}),r.meta&&(0,i.jsx)(i5,{children:r.meta})]}),r.hash&&(0,i.jsx)(i3,{children:r.hash}),r.shortcut&&r.shortcut.length>0&&(0,i.jsx)(i6,{children:r.shortcut.map((e,t)=>(0,i.jsx)(i8,{children:e},t))})]},r.id+"-"+t)})}),(0,i.jsx)(op,{children:"ask"===v?(0,i.jsxs)(i.Fragment,{children:[(0,i.jsxs)(oh,{children:[(0,i.jsx)(i8,{children:"↵"}),b("palette.hint.ask")]}),(0,i.jsxs)(oh,{children:[(0,i.jsx)(i8,{children:"esc"}),b("palette.hint.close")]})]}):(0,i.jsxs)(i.Fragment,{children:[(0,i.jsxs)(oh,{children:[(0,i.jsx)(i8,{children:"↑"}),(0,i.jsx)(i8,{children:"↓"}),b("palette.hint.navigate")]}),(0,i.jsxs)(oh,{children:[(0,i.jsx)(i8,{children:"↵"}),b("palette.hint.open")]}),(0,i.jsxs)(oh,{children:[(0,i.jsx)(i8,{children:"esc"}),b("palette.hint.close")]})]})})]})}),document.body)}let of="shell:cmdk-hint-dismissed",ox=(0,d.keyframes)`
  from { opacity: 0; transform: translateY(6px); }
  to   { opacity: 1; transform: translateY(0); }
`,ob=l().div`
  position: fixed;
  ...
  overflow: hidden;
  animation: ${ox} 0.25s ${c.w4.transitions.easing} both;
  animation-delay: 1s;
  transition:
    border-color ${c.w4.transitions.fast},
    transform ${c.w4.transitions.fast};
...
`,ow=l().button`
  ...
  &:hover { color: ${c.w4.colors.mainText}; }
  &:focus-visible { ${c.w4.focusRing} }
`;function ov({onOpenPalette:e,t}){let[a,r]=(0,o.useState)(()=>{try{return"1"===localStorage.getItem(of)}catch{return!1}});return((0,o.useEffect)(()=>{let e=e=>{e.key===of&&r("1"===e.newValue)};return window.addEventListener("storage",e),()=>window.removeEventListener("storage",e)},[]),a)?null:tp().createPortal((0,i.jsxs)(ob,{children:[(0,i.jsxs)(oy,{type:"button","aria-label":t("cmdk.hint.aria"),onClick:e,children:[(0,i.jsx)(p.ue,{children:"⌘K"}),(0,i.jsx)("span",{className:"hint-label",children:t("cmdk.hint.label")})]}),(0,i.jsx)(ow,{type:"button",className:"dismiss","aria-label":t("cmdk.hint.dismiss"),title:t("cmdk.hint.dismiss"),onClick:e=>{e.stopPropagation();try{localStorage.setItem(of,"1")}catch{}r(!0)},children:"\xd7"})]}),document.body)}var ok=a(98478);let o$=(0,d.keyframes)`
...
`,ri=[{id:"groq",label:"Groq",placeholder:"gsk_...",help:"Used by Prompt Lab and Image Gen (enhance)",linkUrl:"https://console.groq.com/keys",linkLabel:"Get key"},{id:"gemini",label:"Google Gemini",placeholder:"AIza...",help:"Used by Prompt Lab",linkUrl:"https://aistudio.google.com/apikey",linkLabel:"Get key"},{id:"finnhub",label:"Finnhub",placeholder:"pk_...",help:"Stock quotes for the Markets widget",linkUrl:"https://finnhub.io/dashboard",linkLabel:"Get key"},{id:"tmdb",label:"TMDB (The Movie Database)",placeholder:"eyJhbGci...",help:"Movies & Series app — Read Access Token (v4 auth)",linkUrl:"https://www.themoviedb.org/settings/api",linkLabel:"Get key"},{id:"youtube",label:"YouTube Data API v3",placeholder:"AIza...",help:"YouTube Safe Feed app — free quota, no billing required",linkUrl:"https://console.cloud.google.com/apis/credentials",linkLabel:"Get key"}],ro="atlantis:api-keys",rr="atlantis:promptlab:keys",rn=[{widgetId:"shell",ruleId:"sync.error",labelKey:"notifications.source.syncError",defaultEnabled:!0},{widgetId:"shell",ruleId:"daily.achievement",labelKey:"notifications.source.dailyAchievement",defaultEnabled:!0},{widgetId:"shell",ruleId:"finance.budget",labelKey:"notifications.source.financeBudget",defaultEnabled:!0}],rs={groq:"",gemini:"",finnhub:"",tmdb:"",youtube:""};function rl(e,t){return`notifications:${e}:${t}:enabled`}function rd({lang:e}){let[t,a]=(0,o.useState)(rs),[r,n]=(0,o.useState)({}),[s,l]=(0,o.useState)(!1),[d,m]=(0,o.useState)(!1),[u,f]=(0,o.useState)({}),[x,b]=(0,o.useState)([]),[y,w]=(0,o.useState)({muteAll:!1,windows:[]}),[v,k]=(0,o.useState)([]),$=(0,o.useMemo)(()=>(0,g.Nx)(e,td),[e]),M="pt"===e;(0,o.useEffect)(()=>{let e=function(){try{let e=localStorage.getItem(ro);if(e)return{...rs,...JSON.parse(e)};let t=localStorage.getItem(rr);if(t)return{...rs,...JSON.parse(t)}}catch{}return{...rs}}();a(e),(0,c.PL)(ro).then(t=>{if(t)try{let i={...rs,...JSON.parse(t)},o={groq:e.groq||i.groq,gemini:e.gemini||i.gemini,finnhub:e.finnhub||i.finnhub,tmdb:e.tmdb||i.tmdb,youtube:e.youtube||i.youtube};a(o)}catch{}}),(0,h.loadSchedule)().then(e=>w(e)),(0,c.PL)("shell:dashboard-widgets").then(async e=>{let t=[];try{e&&(t=JSON.parse(e))}catch{}let a=new Set(t.map(e=>e.widgetId)),i=tr.filter(e=>a.has(e.id)&&e.notifications&&e.notifications.length>0);b(i);let o=i.flatMap(e=>(e.notifications??[]).map(e=>e.category)),r=rn.map(e=>e.ruleId),n=new Set,s=[];for(let e of[...o,...r])n.has(e)||(n.add(e),s.push(e));k(s);let l={};await Promise.all(i.flatMap(e=>(e.notifications??[]).map(async t=>{let a=rl(e.id,t.id),i=await (0,c.PL)(a),o=!1!==t.defaultEnabled;l[`${e.id}:${t.id}`]=null===i?o:"false"!==i}))),await Promise.all(rn.map(async e=>{let t=rl(e.widgetId,e.ruleId),a=await (0,c.PL)(t);l[`${e.widgetId}:${e.ruleId}`]=null===a?e.defaultEnabled:"false"!==a})),f(l)})},[]);let j=(0,o.useCallback)((e,t)=>{a(a=>({...a,[e]:t})),m(!0),l(!1)},[]),z=(0,o.useCallback)(e=>{a(t=>({...t,[e]:""})),m(!0),l(!1)},[]),S=(0,o.useCallback)(()=>{let e;e=JSON.stringify(t),localStorage.setItem(ro,e),localStorage.setItem(rr,e),(0,c.Is)(ro,e),window.dispatchEvent(new CustomEvent("atlantis:api-keys-changed")),m(!1),l(!0),setTimeout(()=>l(!1),2500)},[t]),C=(0,o.useCallback)((e,t,a)=>{let i=`${e}:${t}`;f(e=>({...e,[i]:a})),(0,c.Is)(rl(e,t),a?"true":"false")},[]),T=(0,o.useCallback)(e=>{let t={...y,muteAll:e};w(t),(0,h.saveSchedule)(t)},[y]),A=(0,o.useCallback)(()=>{let e={...y,windows:[...y.windows,{categoryId:"*",start:"22:00",end:"08:00"}]};w(e),(0,h.saveSchedule)(e)},[y]),F=(0,o.useCallback)(e=>{let t={...y,windows:y.windows.filter((t,a)=>a!==e)};w(t),(0,h.saveSchedule)(t)},[y]),N=(0,o.useCallback)((e,t)=>{let a={...y,windows:y.windows.map((a,i)=>i===e?{...a,...t}:a)};w(a),(0,h.saveSchedule)(a)},[y]),L=(0,o.useCallback)(e=>{if("*"===e)return $("notifications.settings.quietHours.global");for(let t of x)for(let a of t.notifications??[])if(a.category===e&&a.labelKey)return $(a.labelKey);for(let t of rn)if(t.ruleId===e)return $(t.labelKey);return e},[$,x]);return(0,i.jsx)(oM,{children:(0,i.jsxs)(oj,{children:[(0,i.jsxs)(oz,{children:[(0,i.jsx)(oS,{children:M?"Defini\xe7\xf5es":"Settings"}),(0,i.jsx)(oC,{children:M?"Gere as tuas chaves de API para os servi\xe7os de IA. As chaves s\xe3o guardadas no teu browser e sincronizadas com a tua conta.":"Manage your API keys for AI services. Keys are stored in your browser and synced with your account."})]}),(0,i.jsxs)(oT,{children:[(0,i.jsxs)(oA,{children:[(0,i.jsx)(p.In,{name:"key",size:16}),M?"Chaves de API":"API Keys"]}),(0,i.jsx)(oF,{children:M?"Estas chaves s\xe3o usadas pelo Prompt Lab e Image Gen. Cada servi\xe7o tem um plano gratuito.":"These keys are used by Prompt Lab and Image Gen. Each service has a free tier."}),ri.map(e=>{let a=t[e.id],o=r[e.id]??!1;return(0,i.jsxs)(oN,{children:[(0,i.jsxs)(oL,{children:[e.label,(0,i.jsx)(oP,{active:!!a,children:a?M?"ativa":"active":M?"vazia":"empty"}),(0,i.jsxs)(oI,{children:["— ",e.help]})]}),(0,i.jsxs)(oR,{children:[(0,i.jsxs)(oD,{children:[(0,i.jsx)(oH,{type:o?"text":"password",value:a,onChange:t=>j(e.id,t.target.value),placeholder:e.placeholder,spellCheck:!1,autoComplete:"off"}),(0,i.jsx)(oE,{onClick:()=>n(t=>({...t,[e.id]:!o})),title:o?"Hide":"Show",children:o?(0,i.jsx)(p.In,{name:"eye-off",size:13}):(0,i.jsx)(p.In,{name:"eye",size:13})})]}),(0,i.jsx)(oO,{danger:!0,onClick:()=>z(e.id),title:M?"Limpar":"Clear",children:(0,i.jsx)(p.In,{name:"trash",size:13})}),(0,i.jsx)("a",{href:e.linkUrl,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none"},children:(0,i.jsx)(oO,{title:e.linkLabel,children:(0,i.jsx)(p.In,{name:"external-link",size:13})})})]})]},e.id)}),(0,i.jsxs)(oq,{children:[s?(0,i.jsx)(oK,{children:M?"✓ Guardado":"✓ Saved"}):(0,i.jsx)("span",{}),(0,i.jsxs)(oB,{onClick:S,disabled:!d,children:[(0,i.jsx)(p.In,{name:"save",size:13}),M?"Guardar":"Save"]})]})]}),(0,i.jsxs)(oT,{children:[(0,i.jsxs)(oA,{children:[(0,i.jsx)(p.In,{name:"bell",size:16}),$("notifications.settings.title")]}),(0,i.jsx)(oF,{children:$("notifications.settings.desc")}),(0,i.jsxs)(oZ,{children:[(0,i.jsxs)(o0,{children:[(0,i.jsx)(o1,{children:$("notifications.settings.muteAll")}),(0,i.jsx)(o4,{children:$("notifications.settings.muteAll.desc")})]}),(0,i.jsxs)(oQ,{checked:y.muteAll,onClick:()=>T(!y.muteAll),title:$("notifications.settings.muteAll"),children:[(0,i.jsx)("input",{type:"checkbox",checked:y.muteAll,onChange:()=>{},"aria-label":$("notifications.settings.muteAll")}),(0,i.jsx)("span",{className:"track"}),(0,i.jsx)("span",{className:"thumb"})]})]}),0===x.length?(0,i.jsx)(oX,{style:{marginTop:"16px"},children:$("notifications.settings.noWidgets")}):x.map(t=>(0,i.jsxs)(oG,{children:[(0,i.jsxs)(oV,{children:[(0,i.jsx)(oY,{children:t.icon}),(0,i.jsx)(o_,{children:"pt"===e?t.labels.pt:t.labels.en})]}),(t.notifications??[]).map(e=>{let a=`${t.id}:${e.id}`,o=!1!==e.defaultEnabled,r=u[a]??o,n=e.labelKey?$(e.labelKey):e.category;return(0,i.jsxs)(oU,{children:[(0,i.jsx)(oJ,{className:"rule-label",children:n}),(0,i.jsxs)(oQ,{checked:r,onClick:()=>C(t.id,e.id,!r),title:$("notifications.settings.enable"),children:[(0,i.jsx)("input",{type:"checkbox",checked:r,onChange:()=>{},"aria-label":n}),(0,i.jsx)("span",{className:"track"}),(0,i.jsx)("span",{className:"thumb"})]})]},e.id)})]},t.id)),(0,i.jsxs)(oG,{style:{marginTop:"12px"},children:[(0,i.jsxs)(oV,{children:[(0,i.jsx)(oY,{children:"\uD83D\uDD14"}),(0,i.jsx)(o_,{children:$("notifications.settings.shell.title")})]}),(0,i.jsx)("div",{style:{fontSize:"11px",fontFamily:c.w4.typography.fontFamilyMono,color:c.w4.colors.mainTextMuted,marginBottom:"4px"},children:$("notifications.settings.shell.desc")}),rn.map(e=>{let t=u[`${e.widgetId}:${e.ruleId}`]??e.defaultEnabled,a=$(e.labelKey);return(0,i.jsxs)(oU,{children:[(0,i.jsx)(oJ,{className:"rule-label",children:a}),(0,i.jsxs)(oQ,{checked:t,onClick:()=>C(e.widgetId,e.ruleId,!t),title:$("notifications.settings.enable"),children:[(0,i.jsx)("input",{type:"checkbox",checked:t,onChange:()=>{},"aria-label":a}),(0,i.jsx)("span",{className:"track"}),(0,i.jsx)("span",{className:"thumb"})]})]},e.ruleId)})]}),(0,i.jsxs)(o2,{children:[(0,i.jsx)(o5,{children:$("notifications.settings.quietHours")}),(0,i.jsx)(o3,{children:$("notifications.settings.quietHours.desc")}),y.windows.map((e,t)=>(0,i.jsxs)(o6,{children:[(0,i.jsxs)(o9,{value:e.categoryId,onChange:e=>N(t,{categoryId:e.target.value}),"aria-label":$("notifications.settings.quietHours.category"),children:[(0,i.jsx)("option",{value:"*",children:$("notifications.settings.quietHours.global")}),v.map(e=>(0,i.jsx)("option",{value:e,children:L(e)},e))]}),(0,i.jsxs)(re,{children:[(0,i.jsx)("input",{type:"checkbox",checked:e.allDay??!1,onChange:e=>N(t,{allDay:e.target.checked})}),$("notifications.settings.quietHours.allDay")]}),!e.allDay&&(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(o8,{children:$("notifications.settings.quietHours.from")}),(0,i.jsx)(o7,{type:"time",value:e.start,onChange:e=>N(t,{start:e.target.value})}),(0,i.jsx)(o8,{children:$("notifications.settings.quietHours.to")}),(0,i.jsx)(o7,{type:"time",value:e.end,onChange:e=>N(t,{end:e.target.value})})]}),(0,i.jsx)(ra,{type:"button",title:$("notifications.settings.quietHours.remove"),onClick:()=>F(t),children:(0,i.jsx)(p.In,{name:"close",size:13})})]},t)),(0,i.jsxs)(rt,{type:"button",onClick:A,children:[(0,i.jsx)(p.In,{name:"plus",size:13}),$("notifications.settings.quietHours.add")]})]})]}),(0,i.jsxs)(oW,{children:[(0,i.jsx)(p.In,{name:"shield",size:14,style:{flexShrink:0,marginTop:2}}),(0,i.jsx)("span",{children:M?"As chaves s\xe3o enviadas diretamente do teu browser para o servi\xe7o de IA — nunca passam pelos nossos servidores. Podes remov\xea-las a qualquer momento.":"Keys are sent directly from your browser to the AI provider — they never pass through our servers. You can remove them at any time."})]})]})})}let rc=(0,d.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,rp=(0,d.keyframes)`
...
`;function rz({open:e,onClose:t,locale:a}){let[r,n]=(0,h.useProfile)(),[s,l]=(0,o.useState)(r),d=(0,o.useMemo)(()=>(0,g.Nx)("pt"===a?"pt":"en",td),[a]);if((0,o.useEffect)(()=>{e&&l(r)},[e,r]),(0,o.useEffect)(()=>{if(!e)return;let a=e=>{"Escape"===e.key&&t()};return window.addEventListener("keydown",a),()=>window.removeEventListener("keydown",a)},[e,t]),!e)return null;let m=async()=>{let e=s.ageMode!==r.ageMode||s.interests.length!==r.interests.length||s.interests.some(e=>!r.interests.includes(e));await n(s),t(),e&&(await (0,c.sW)("widget-cache:"),window.location.reload())},u="pt"===a?h.INTEREST_LABELS_PT:h.INTEREST_LABELS_EN,f="pt"===a?h.AGE_MODE_LABELS_PT:h.AGE_MODE_LABELS_EN;return tp().createPortal((0,i.jsx)(rh,{onClick:e=>{e.target===e.currentTarget&&t()},children:(0,i.jsxs)(rg,{role:"dialog","aria-modal":"true","aria-labelledby":"profile-title",children:[(0,i.jsxs)(rm,{children:[(0,i.jsx)(ru,{id:"profile-title",children:d("profile.title")}),(0,i.jsx)(rf,{onClick:t,"aria-label":d("profile.close"),children:(0,i.jsx)(p.In,{name:"close",size:16})})]}),(0,i.jsxs)(rx,{children:[(0,i.jsxs)(rb,{children:[(0,i.jsx)(ry,{children:d("profile.interests")}),(0,i.jsx)(rw,{children:d("profile.interestsHint")}),(0,i.jsx)(rv,{children:h.ALL_INTERESTS.map(e=>(0,i.jsx)(rk,{active:s.interests.includes(e),onClick:()=>{l(t=>({...t,interests:t.interests.includes(e)?t.interests.filter(t=>t!==e):[...t.interests,e]}))},"aria-pressed":s.interests.includes(e),children:u[e]},e))})]}),(0,i.jsxs)(rb,{children:[(0,i.jsx)(ry,{children:d("profile.ageMode")}),(0,i.jsx)(rw,{children:d("profile.ageModeHint")}),(0,i.jsx)(rv,{children:["kid","teen","adult"].map(e=>(0,i.jsx)(rk,{active:s.ageMode===e,onClick:()=>{l(t=>({...t,ageMode:e}))},"aria-pressed":s.ageMode===e,children:f[e]},e))})]})]}),(0,i.jsxs)(r$,{children:[(0,i.jsx)(rM,{onClick:t,children:d("profile.cancel")}),(0,i.jsx)(rj,{onClick:m,children:d("profile.save")})]})]})}),document.body)}var rS=a(68360);let rC=(0,d.keyframes)`
  from { opacity: 0; transform: translateY(-6px); }
  to   { opacity: 1; transform: translateY(0); }
`,rT=l().div`
  position: fixed;
...
`,rG=l().span`
  ...
  text-align: right;
  white-space: nowrap;
`;function rV({locale:e,state:t,anchor:a}){let r=(0,o.useMemo)(()=>(0,g.Nx)(e,td),[e]),{open:n,close:s,items:l,markAllRead:d,dismiss:m}=t;if(!n||!a)return null;let u=Math.round(a.bottom+8),f=Math.max(12,Math.round(window.innerWidth-a.right)),x=()=>{s(),window.location.hash="#/daily"};return tp().createPortal((0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(rT,{onClick:s}),(0,i.jsxs)(rA,{style:{top:u,right:f},role:"dialog","aria-label":r("notifications.title"),children:[(0,i.jsxs)(rF,{children:[(0,i.jsx)(rN,{children:r("notifications.title")}),(0,i.jsx)(rL,{onClick:d,disabled:0===l.length,children:r("notifications.markAllRead")})]}),(0,i.jsx)(rP,{children:0===l.length?(0,i.jsx)(rB,{children:r("notifications.empty")}):l.slice(0,5).map(e=>{let t=h.defaultStore.getCategory(e.category)?.badgeColor??c.w4.colors.mainTextMuted,a=h.defaultStore.getCategory(e.category)?.labelKey,o=a?r(a):e.category;if("daily.overdue"===e.category){let a=e.meta,n=a?.count??0,s=(a?.missions??[]).slice(0,4),l=1===n?r("notifications.daily.group.one"):r("notifications.daily.group.many",{count:n});return(0,i.jsxs)(rR,{children:[(0,i.jsxs)(rD,{as:"button",type:"button",onClick:x,children:[(0,i.jsxs)(rE,{color:t,children:[(0,i.jsx)("span",{className:"dot"}),o,(0,i.jsx)("span",{className:"time",children:(0,rS.e)(e.ts)})]}),(0,i.jsxs)(rO,{children:[(0,i.jsx)(rq,{children:s.map(e=>(0,p.n6)(e.emoji)?(0,i.jsx)(p.In,{name:e.emoji,size:14,style:{color:e.color??t}},e.id):(0,i.jsx)("span",{children:e.emoji},e.id))}),l]})]}),(0,i.jsx)(rH,{type:"button",className:"dismiss","aria-label":r("notifications.dismiss"),title:r("notifications.dismiss"),onClick:t=>{t.stopPropagation(),m(e.id)},children:"\xd7"})]},e.id)}if("finance.digest.weekly"===e.category){let a=e.meta,n=a?.spend??0,l=a?.budget??0,d=a?.topCategories??[],c=a?.members??[],p=a?.pendingReimbursables??0,h=a?.weekKey??"";return(0,i.jsxs)(rR,{children:[(0,i.jsxs)(rD,{href:"#/finance",onClick:()=>{s(),m(e.id)},children:[(0,i.jsxs)(rE,{color:t,children:[(0,i.jsx)("span",{className:"dot"}),o,(0,i.jsx)("span",{className:"time",children:h})]}),(0,i.jsx)(rO,{children:r("notifications.finance.digest.title")}),(0,i.jsxs)(rK,{children:[(0,i.jsx)(rW,{children:r("notifications.finance.digest.spend")}),(0,i.jsxs)(rG,{children:["€",n.toFixed(2)]}),(0,i.jsx)(rW,{children:r("notifications.finance.digest.budget")}),(0,i.jsxs)(rG,{children:["€",l.toFixed(2)]}),d.length>0&&(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(rW,{children:r("notifications.finance.digest.topCategories")}),(0,i.jsx)(rG,{children:d.map(e=>`€${e.total.toFixed(0)}`).join(" \xb7 ")})]}),c.length>0&&(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(rW,{children:r("notifications.finance.digest.members")}),(0,i.jsx)(rG,{children:c.map(e=>`€${e.total.toFixed(0)}`).join(" \xb7 ")})]}),p>0&&(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(rW,{children:r("notifications.finance.digest.pending")}),(0,i.jsx)(rG,{children:p})]})]})]}),(0,i.jsx)(rH,{type:"button",className:"dismiss","aria-label":r("notifications.dismiss"),title:r("notifications.dismiss"),onClick:t=>{t.stopPropagation(),m(e.id)},children:"\xd7"})]},e.id)}if("forma.digest.weekly"===e.category){let a=e.meta,n=a?.avgFastHours??0,l=a?.walkMinutes??0,d=a?.weightDelta,c=a?.adherencePct??0,p=a?.weekKey??"";return(0,i.jsxs)(rR,{children:[(0,i.jsxs)(rD,{href:"#/forma",onClick:()=>{s(),m(e.id)},children:[(0,i.jsxs)(rE,{color:t,children:[(0,i.jsx)("span",{className:"dot"}),o,(0,i.jsx)("span",{className:"time",children:p})]}),(0,i.jsx)(rO,{children:r("notifications.forma.digest.title")}),(0,i.jsxs)(rK,{children:[(0,i.jsx)(rW,{children:r("notifications.forma.digest.avgFast")}),(0,i.jsxs)(rG,{children:[n.toFixed(1),"h"]}),(0,i.jsx)(rW,{children:r("notifications.forma.digest.walk")}),(0,i.jsxs)(rG,{children:[l,"min"]}),(0,i.jsx)(rW,{children:r("notifications.forma.digest.adherence")}),(0,i.jsxs)(rG,{children:[c,"%"]}),null!=d&&(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(rW,{children:r("notifications.forma.digest.weight")}),(0,i.jsxs)(rG,{children:[d>=0?"+":"",d.toFixed(1),"kg"]})]})]})]}),(0,i.jsx)(rH,{type:"button",className:"dismiss","aria-label":r("notifications.dismiss"),title:r("notifications.dismiss"),onClick:t=>{t.stopPropagation(),m(e.id)},children:"\xd7"})]},e.id)}if("forma.streak"===e.category){let a=e.meta,n=a?.milestone??0,l=r(`notifications.forma.streak.milestone.${n}`);return(0,i.jsxs)(rR,{children:[(0,i.jsxs)(rD,{href:"#/forma",onClick:()=>{s(),m(e.id)},children:[(0,i.jsxs)(rE,{color:t,children:[(0,i.jsx)("span",{className:"dot"}),o,(0,i.jsx)("span",{className:"time",children:(0,g.aw)(new Date(e.ts).toISOString(),r)})]}),(0,i.jsx)(rO,{children:l})]}),(0,i.jsx)(rH,{type:"button",className:"dismiss","aria-label":r("notifications.dismiss"),title:r("notifications.dismiss"),onClick:t=>{t.stopPropagation(),m(e.id)},children:"\xd7"})]},e.id)}if("finance.streak"===e.category){let a=e.meta,n=a?.milestone??0,l=r(`notifications.finance.streak.milestone.${n}`);return(0,i.jsxs)(rR,{children:[(0,i.jsxs)(rD,{href:"#/finance",onClick:()=>{s(),m(e.id)},children:[(0,i.jsxs)(rE,{color:t,children:[(0,i.jsx)("span",{className:"dot"}),o,(0,i.jsx)("span",{className:"time",children:(0,g.aw)(new Date(e.ts).toISOString(),r)})]}),(0,i.jsx)(rO,{children:l})]}),(0,i.jsx)(rH,{type:"button",className:"dismiss","aria-label":r("notifications.dismiss"),title:r("notifications.dismiss"),onClick:t=>{t.stopPropagation(),m(e.id)},children:"\xd7"})]},e.id)}let n=e.link?{href:e.link,target:"_blank",rel:"noopener noreferrer",onClick:()=>{m(e.id)}}:{as:"button",type:"button",onClick:()=>{m(e.id)}};return(0,i.jsxs)(rR,{children:[(0,i.jsxs)(rD,{...n,children:[(0,i.jsxs)(rE,{color:t,children:[(0,i.jsx)("span",{className:"dot"}),o,(0,i.jsx)("span",{className:"time",children:(0,g.aw)(new Date(e.ts).toISOString(),r)})]}),(0,i.jsx)(rO,{children:e.title})]}),(0,i.jsx)(rH,{type:"button",className:"dismiss","aria-label":r("notifications.dismiss"),title:r("notifications.dismiss"),onClick:t=>{t.stopPropagation(),m(e.id)},children:"\xd7"})]},e.id)})}),l.length>0&&(0,i.jsxs)(rI,{type:"button",onClick:()=>{s(),window.location.hash="#/notifications"},children:[(0,i.jsx)("span",{children:r("notifications.seeAll")}),(0,i.jsx)("span",{className:"count",children:l.length>5?`+${l.length-5}`:l.length})]})]})]}),document.body)}let rY=(0,d.keyframes)`
...
`;function r8({locale:e}){let t=(0,o.useMemo)(()=>(0,g.Nx)(e,td),[e]),a=(0,h.useRegisteredCategories)(),{items:r,byCategory:n}=(0,h.useEvents)({channels:a}),s=(0,o.useMemo)(()=>{let e=new Map;for(let t of a){let a=n[t];a&&a.length>0&&e.set(t,a)}return e},[n,a]),l=(0,o.useCallback)(()=>{h.defaultStore.markAllRead()},[]),d=(0,o.useCallback)(e=>{h.defaultStore.dismiss(e)},[]),p=(0,o.useCallback)(()=>{window.location.hash="#/home"},[]);return(0,i.jsxs)(r_,{children:[(0,i.jsxs)(rU,{children:[(0,i.jsx)(rJ,{children:t("notifications.page.title")}),(0,i.jsx)(rQ,{children:t("notifications.page.subtitle")}),(0,i.jsxs)(rX,{children:[(0,i.jsxs)(rZ,{onClick:p,children:["← ",t("error.remote.goHome")]}),(0,i.jsx)(rZ,{onClick:l,disabled:0===r.length,children:t("notifications.markAllRead")})]})]}),0===r.length?(0,i.jsx)(r0,{children:t("notifications.empty")}):Array.from(s.entries()).map(([e,a])=>{let o;return(0,i.jsxs)("section",{children:[(0,i.jsx)(r1,{children:(o=h.defaultStore.getCategory(e),o?.labelKey?t(o.labelKey):e)}),a.map(a=>{let o=h.defaultStore.getCategory(e)?.badgeColor??c.w4.colors.mainTextMuted;return(0,i.jsxs)(r4,{color:o,children:[(0,i.jsxs)(r2,{href:a.link,target:a.link?"_blank":void 0,rel:a.link?"noopener noreferrer":void 0,children:[(0,i.jsx)(r5,{children:a.title}),(0,i.jsx)(r3,{children:(0,g.aw)(new Date(a.ts).toISOString(),t)})]}),(0,i.jsx)(r6,{type:"button","aria-label":t("notifications.dismiss"),title:t("notifications.dismiss"),onClick:()=>d(a.id),children:"\xd7"})]},a.id)})]},e)})]})}h.events.registerCategory({id:"sync.error",labelKey:"notifications.source.syncError",badgeColor:c.w4.colors.danger}),h.events.registerCategory({id:"daily.achievement",labelKey:"notifications.source.dailyAchievement",badgeColor:"#fb923c"}),h.events.registerCategory({id:"finance.budget",labelKey:"notifications.source.financeBudget",badgeColor:c.w4.colors.warning}),h.events.registerCategory({id:"finance.bills",labelKey:"notifications.source.financeBills",badgeColor:"#fb923c"}),h.events.registerRules([h.billsRule]),h.events.registerCategory({id:"weather.pt.forecast",labelKey:"notifications.source.weatherForecast",badgeColor:"#3b82f6"}),h.events.registerRules([h.ipmaForecastDetailRule]),h.events.registerCategory({id:"forma.coach",labelKey:"notifications.source.formaCoach",badgeColor:"#7fb77e"}),h.events.registerRules([{id:"forma-coach",category:"forma.coach",labelKey:"notifications.source.formaCoach",producer:(0,h.formaCoachProducer)(),start(){},stop(){}}]),h.events.registerCategory({id:"forma.digest.weekly",labelKey:"notifications.source.formaDigest",badgeColor:"#7fb77e"}),h.events.registerRules([h.formaDigestRule]),h.events.registerCategory({id:"forma.streak",labelKey:"notifications.source.formaStreak",badgeColor:"#7fb77e"}),h.events.registerRules([h.formaStreakRule]),h.events.registerCategory({id:"finance.streak",labelKey:"notifications.source.financeStreak",badgeColor:"#7fb77e"}),h.events.registerRules([h.financeStreakRule]),(0,h.loadSchedule)();{let e=new Map;(0,ok.subscribeRequests)(t=>{if(!t.host)return;if(t.ok)return void e.delete(t.host);let a=(e.get(t.host)??0)+1;if(e.set(t.host,a),3===a){let e=new Date().toISOString().slice(0,10);h.events.push({id:`sync.error:${t.host}:${e}`,category:"sync.error",ts:t.ts,title:`${t.host} — ${t.error??"failed"}`,meta:{host:t.host,status:t.status}})}})}let r7={movies:e=>({apiKey:e.tmdbKey}),youtube:e=>({apiKey:e.youtubeKey}),games:e=>({isAuthenticated:!!e.user})},r9=l().div`
...
`,na=l().span`
  ...
  flex-shrink: 0;
  animation: ${ne} 2s ease-in-out infinite;
`,ni={techscope:9,weather:1,citypulse:1};function no({count:e}){return(0,i.jsxs)(nt,{title:`${e} live ${1===e?"feed":"feeds"}`,children:[(0,i.jsx)(na,{}),e,(0,i.jsx)("span",{style:{opacity:.65,fontSize:10},children:"LIVE"})]})}let nr=l().div`
  flex: 1;
  display: flex;
  flex-direction: column;
  align-items: center;
...
`;function nc({name:e,error:t,topBarRight:a,onRetry:r}){let[n]=(0,g.Ym)(),s=(0,o.useMemo)(()=>(0,g.Nx)(n,td),[n]),l=t.message??"",d=l.startsWith("REMOTE_LOAD_FAILED:"),h=d?l.slice(19):e,m=`apps.${h}.label`,u=s(m),f=u&&u!==m?u:h;return(0,i.jsx)(p.PE,{title:f,sidebar:null,topBarRight:a,children:(0,i.jsxs)(nr,{children:[(0,i.jsx)(nn,{children:"⚠"}),(0,i.jsx)(ns,{children:s("error.remote.title",{name:f})}),(0,i.jsx)(nl,{children:s(d?"error.remote.prodHint":"error.remote.generic")}),d&&!1,(0,i.jsxs)("div",{style:{display:"flex",gap:c.w4.spacing.sm},children:[(0,i.jsx)(nd,{onClick:r,children:s("error.remote.retry")}),(0,i.jsx)(nd,{onClick:()=>{window.location.hash="#/home"},children:s("error.remote.goHome")})]})]})})}class np extends r().Component{static getDerivedStateFromError(e){return{error:e}}componentDidCatch(e){console.error(`[RemoteErrorBoundary] "${this.props.name}" threw:`,e)}componentDidUpdate(e){e.name!==this.props.name&&this.state.error&&this.setState({error:null})}render(){return this.state.error?(0,i.jsx)(nc,{name:this.props.name,error:this.state.error,topBarRight:this.props.topBarRight,onRetry:()=>this.setState({error:null})}):this.props.children}constructor(...e){super(...e),function(e,t,a){t in e?Object.defineProperty(e,t,{value:a,enumerable:!0,configurable:!0,writable:!0}):e[t]=a}(this,"state",{error:null})}}let nh=(()=>{let e={settings:"settings"};for(let t of eL)for(let a of(e[t.hash.replace(/^#\//,"")]=t.id,t.hashAliases??[]))e[a]=t.id;return e})();function ng(e){let t=e.replace(/^#\/?/,"");if(!t||"home"===t)return"home";let a=t.split("/")[0].split("?")[0];return"notifications"===a?"notifications":nh[a]??"home"}let nm="shell:recent",nu="shell:pinned",nf="shell:last-app";function nx(){let e=window.location.hash;if(!e||"#"===e||"#/"===e)try{let e=localStorage.getItem(nf);if(e&&"home"!==e&&f[e]){let t=eL.find(t=>t.id===e);if(t)return history.replaceState(null,"",t.hash),e}}catch{}return ng(e)}function nb(e){try{return JSON.parse(e??"[]")}catch{return[]}}let ny=new Set(eL.filter(e=>e.needsAuth).map(e=>e.id)),nw="true"===process.env.MOCK_USER?{id:"mock-user",email:"dev@atlantis.local",user_metadata:{full_name:"Dev User",avatar_url:""}}:null,nv=process.env.YOUTUBE_API_KEY||"",nk=document.getElementById("root");if(!nk)throw Error("Root element #root not found");(0,n.createRoot)(nk).render((0,i.jsx)(function(){let e,[t,a]=(0,o.useState)(nx),[r,n]=(0,o.useState)([]),[s,l]=(0,o.useState)([]),[d,m]=(0,o.useState)(nw),[u,x]=(0,o.useState)(!!nw),[b,y]=(0,o.useState)(!1),[w,v]=(0,o.useState)(void 0),[k,$]=(0,o.useState)(!1),[M,j]=(0,o.useState)(!1),[z,S]=(0,g.Ym)(),C=(0,o.useMemo)(()=>(0,g.Nx)(z,td),[z]),T=function(e={}){let t=(0,h.useRegisteredCategories)(),a=(0,h.useEventBell)({channels:t}),[i,r]=(0,o.useState)(!1),n=(0,o.useRef)(null),s=(0,o.useRef)(e.formatDailyReminder);(0,o.useEffect)(()=>{s.current=e.formatDailyReminder},[e.formatDailyReminder]),(0,o.useEffect)(()=>{let e=()=>{h.defaultStore.refresh()};window.addEventListener("focus",e);let t=h.dailyStore.subscribe(e);return()=>{window.removeEventListener("focus",e),t()}},[]),(0,o.useEffect)(()=>{if("u"<typeof window||!("Notification"in window)||"granted"!==Notification.permission)return;let e=a.items.find(e=>"daily.overdue"===e.category),t=(0,h.todayISO)();if(!e||n.current===t)return;let i=e.meta,o=i?.missions?.[0],r=o?s.current?.(o):void 0;if(r){n.current=t;try{new Notification(r.title,{body:r.body,tag:`atlantis-daily-${t}`,icon:"/manifest-icon.png"})}catch{}}},[a.items]);let l=(0,o.useCallback)(()=>r(e=>!e),[]),d=(0,o.useCallback)(()=>r(!1),[]);return{...a,open:i,toggle:l,close:d}}({formatDailyReminder:(0,o.useCallback)(e=>{let t=(0,h.missionLabel)(e,z),a=e.emoji?`${e.emoji} ${t}`.trim():t;return{title:C("notifications.source.daily"),body:C("notifications.daily.body",{time:e.time??"",name:a})}},[C,z])}),[A,F]=(0,o.useState)(null);(0,o.useEffect)(()=>{if(nw){h.session.setUser(nw),(0,h.resolveApiKeys)().then(e=>h.session.setApiKeys(e));return}io.auth.getSession().then(({data:e})=>{let t=e.session?.user??null;m(t),(0,c.Fm)(t?iy:null),h.session.setUser(t),(0,h.resolveApiKeys)().then(e=>h.session.setApiKeys(e)),x(!0)});let{data:{subscription:e}}=io.auth.onAuthStateChange((e,t)=>{let a=t?.user??null;m(a),(0,c.Fm)(a?iy:null),h.session.setUser(a),(0,h.resolveApiKeys)().then(e=>h.session.setApiKeys(e))});return()=>e.unsubscribe()},[]),(0,o.useEffect)(()=>{let e=()=>{(0,h.resolveApiKeys)().then(e=>h.session.setApiKeys(e))};return window.addEventListener("atlantis:api-keys-changed",e),()=>window.removeEventListener("atlantis:api-keys-changed",e)},[]),(0,o.useEffect)(()=>{h.session.setLocale(z)},[z]),(0,o.useEffect)(()=>{(0,c.PL)(nm).then(e=>n(nb(e))),(0,c.PL)(nu).then(e=>l(nb(e)))},[]),(0,o.useEffect)(()=>{let e=e=>{(e.metaKey||e.ctrlKey)&&"k"===e.key&&(e.preventDefault(),v(void 0),y(e=>!e))};return window.addEventListener("keydown",e),()=>window.removeEventListener("keydown",e)},[]),(0,o.useEffect)(()=>{let e=e=>{let t=e.detail;v(t?.scope),y(!0)};return window.addEventListener("atlantis:open-palette",e),()=>window.removeEventListener("atlantis:open-palette",e)},[]),(0,o.useEffect)(()=>{let e=()=>a(ng(window.location.hash));return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[]),(0,o.useEffect)(()=>{if(t&&"home"!==t){try{localStorage.setItem(nf,t)}catch{}n(e=>{let a=[t,...e.filter(e=>e!==t)].slice(0,8);return(0,c.Is)(nm,JSON.stringify(a)),a})}},[t]);let N=(0,o.useCallback)(e=>{window.location.hash=e,y(!1),v(void 0)},[]),L=(0,o.useCallback)(e=>{window.location.hash=`#/home?suite=${encodeURIComponent(e)}`},[]),[P]=(0,h.useProfile)(),I=(0,o.useMemo)(()=>eL.filter(e=>e.flag?(0,h.resolveFlag)(e.flag):e.enabled).filter(e=>"hidden"!==eN(e)).filter(e=>!(0,h.hasInterests)(P)||!e.interest||P.interests.includes(e.interest)),[P]),R=(0,o.useMemo)(()=>{let e=eI.map(e=>({id:e.id,name:C(e.labelKey),iconName:e.iconName,hash:e.hash,accentColor:e.color,onClick:()=>{window.location.hash=e.hash}}));return eP.map(t=>{let a=I.filter(e=>e.suite===t.yamlSuite),i="games"===t.id;return{id:t.id,name:C(t.nameKey),subtitle:C(t.subKey),color:t.color,icon:t.icon,count:i?eI.length:a.length,onClick:i?void 0:()=>L(t.id),children:i?e:void 0}})},[I,C,L]),D=(0,o.useMemo)(()=>R.filter(e=>e.count>0),[R]),H=(0,o.useMemo)(()=>D.map(e=>({id:e.id,name:e.name,sub:e.subtitle,color:e.color,iconName:e.icon,onConfirm:()=>L(e.id)})),[D,L]),E=(0,o.useMemo)(()=>eI.map(e=>({id:e.id,name:C(e.labelKey),iconName:e.iconName,hash:e.hash,color:e.color})),[C]),O=(0,o.useMemo)(()=>[{id:"add-widget",label:C("palette.action.addWidget"),meta:C("palette.action.addWidget.meta"),iconName:"plus",color:c.w4.colors.accent,onClick:()=>{window.location.hash="#/home";try{sessionStorage.setItem(tE,"1")}catch{}window.dispatchEvent(new CustomEvent("atlantis:open-widget-picker"))}},{id:"preferences",label:C("palette.action.preferences"),meta:C("palette.action.preferences.meta"),iconName:"settings",onClick:()=>$(!0)},{id:"settings",label:C("palette.action.settings"),meta:C("palette.action.settings.meta"),iconName:"sparkle",onClick:()=>{window.location.hash="#/settings"}},{id:"language",label:C("palette.action.language"),meta:C("palette.action.language.meta"),iconName:"globe",onClick:()=>S("pt"===z?"en":"pt")},...T.count>0?[{id:"clear-notifications",label:C("palette.action.clearNotifications"),meta:C("palette.action.clearNotifications.meta",{n:T.count}),iconName:"bell",color:c.w4.colors.accent,onClick:()=>{T.markAllRead()}}]:[],...d?[{id:"signout",label:C("palette.action.signout"),meta:d.email??"",iconName:"arrow-up-right",color:c.w4.colors.danger,onClick:()=>{is()}}]:[]],[C,z,S,d,T]),[q,B]=(0,o.useState)(null);(0,o.useEffect)(()=>{(0,h.resolveGroqKey)().then(B)},[]);let K=(0,h.hasEnvGroqKey)()||!!q,W=(0,o.useMemo)(()=>I.map(({id:e,labelKey:t,hash:a})=>({id:e,label:C(t),hash:a})),[I,C]),G=(0,o.useMemo)(()=>I.map(({id:e,labelKey:t,descriptionKey:a,hash:i,icon:o,color:r,category:n})=>({id:e,label:C(t),description:C(a),hash:i,icon:o,color:r,category:n})),[I,C]),V=(e=eL.find(e=>e.id===t))?C(e.labelKey):t;if(!u)return(0,i.jsx)(c.NP,{children:(0,i.jsx)(p.xx,{})});if(ny.has(t)&&!d)return(0,i.jsx)(c.NP,{children:(0,i.jsx)(ib,{appLabel:V,onBack:()=>{window.location.hash="#/home"}})});let Y=ni[t],_=e=>{F(e.currentTarget.getBoundingClientRect()),T.toggle()},U=(0,i.jsx)(p.Yw,{locale:z,onLocaleChange:S,before:null!=Y?(0,i.jsx)(no,{count:Y}):void 0,notifications:{count:T.count,onClick:_,label:C("notifications.bell")},onOpenPalette:()=>{v(void 0),y(!0)},paletteLabel:C("palette.search"),user:d?{name:d.user_metadata?.full_name,email:d.email??"",avatarUrl:d.user_metadata?.avatar_url}:void 0,userMenuItems:d?[{label:C("userMenu.preferences"),icon:(0,i.jsx)(p.In,{name:"user-cog",size:14}),onClick:()=>$(!0)},{label:C("userMenu.settings"),icon:(0,i.jsx)(p.In,{name:"settings",size:14}),onClick:()=>{window.location.hash="#/settings"}},{label:C("userMenu.clearData"),icon:(0,i.jsx)(p.In,{name:"trash",size:14}),onClick:()=>j(!0),danger:!0},{label:C("userMenu.signOut"),icon:(0,i.jsx)(p.In,{name:"log-out",size:14}),onClick:is,danger:!0}]:[],userMenuControlLabels:{language:C("userMenu.language"),theme:C("userMenu.theme"),themeLight:C("userMenu.themeLight"),themeDark:C("userMenu.themeDark"),themeSystem:C("userMenu.themeSystem")},onSignIn:()=>{window.location.hash="#/home"}}),J=b&&(0,i.jsx)(ou,{apps:G,recentIds:r,suites:H,games:E,actions:O,hasAsk:K,groqKey:q??void 0,locale:z,initialScope:w,onNavigate:N,onClose:()=>{y(!1),v(void 0)}}),Q=!b&&(0,i.jsx)(ov,{t:C,onOpenPalette:()=>{v(void 0),y(!0)}}),X=(0,i.jsx)(rz,{open:k,onClose:()=>$(!1),locale:z}),Z=(0,i.jsx)(p.TM,{open:M,title:C("userMenu.clearData"),message:C("userMenu.clearDataConfirm"),confirmLabel:C("userMenu.clearData"),cancelLabel:C("common.cancel"),danger:!0,onCancel:()=>j(!1),onConfirm:async()=>{j(!1),await (0,c.sW)(""),window.location.reload()}}),ee=(0,i.jsx)(rV,{locale:z,state:T,anchor:A});if("home"===t)return(0,i.jsxs)(c.NP,{children:[(0,i.jsx)(r9,{children:(0,i.jsx)(ii,{apps:W,recentAppIds:r,pinnedAppIds:s,onTogglePin:e=>{l(t=>{let a=t.includes(e)?t.filter(t=>t!==e):[...t,e];return(0,c.Is)(nu,JSON.stringify(a)),a})},onMovePinned:(e,t)=>{l(a=>{let i=a.indexOf(e);if(i<0)return a;let o=i+t;if(o<0||o>=a.length)return a;let r=[...a];return[r[i],r[o]]=[r[o],r[i]],(0,c.Is)(nu,JSON.stringify(r)),r})},onSelect:e=>{window.location.hash=e.hash},user:d?{name:d.user_metadata?.full_name,email:d.email??"",avatarUrl:d.user_metadata?.avatar_url}:null,onSignOut:is,onPreferences:()=>$(!0),onClearData:()=>j(!0),onOpenPalette:()=>{v(void 0),y(!0)},notifications:{count:T.count,onClick:_,label:C("notifications.bell")}})},"home"),J,Q,X,Z,ee]});let et=f[t],ea=r7[t]?.({user:d,tmdbKey:"9b6f2645abf1725625c843aa71e3efd5",youtubeKey:nv})??{};return(0,i.jsxs)(c.NP,{children:[(0,i.jsx)(np,{name:t,topBarRight:U,children:(0,i.jsx)(o.Suspense,{fallback:(0,i.jsx)(p.xx,{}),children:(0,i.jsxs)(r9,{children:[et&&(0,i.jsx)(et,{topBarRight:U,...ea}),"settings"===t&&(0,i.jsx)(p.PE,{title:"Settings",sidebar:null,topBarRight:U,children:(0,i.jsx)(rd,{lang:"pt"===z?"pt":"en"})}),"notifications"===t&&(0,i.jsx)(p.PE,{title:C("notifications.page.title"),sidebar:null,topBarRight:U,children:(0,i.jsx)(r8,{locale:z})})]},t)})}),J,Q,X,Z,ee]})},{}))},28170(e,t,a){a.d(t,{Ym:()=>c,Nx:()=>p,Fd:()=>b,aw:()=>h});var i=a(37991),o=a(6063);let r={"time.justNow":{en:"just now",pt:"agora mesmo"},"time.mAgo":{en:"{n}m ago",pt:"h\xe1 {n}m"},"time.hAgo":{en:"{n}h ago",pt:"h\xe1 {n}h"},"time.dAgo":{en:"{n}d ago",pt:"h\xe1 {n}d"},updated:{en:"updated {age}",pt:"atualizado {age}"},refresh:{en:"Refresh",pt:"Atualizar"},loading:{en:"Loading…",pt:"A carregar…"},noData:{en:"No data available",pt:"Sem dados dispon\xedveis"},noDescription:{en:"No description provided.",pt:"Sem descri\xe7\xe3o."},failedToFetch:{en:"Failed to fetch",pt:"Erro ao carregar"},perWeek:{en:"/ wk",pt:"/ sem"},"devtools.heading":{en:"Dev Tools",pt:"Ferramentas"},"devtools.playground":{en:"Playground",pt:"Playground"},"devtools.pad":{en:"Pad",pt:"Pad"},"devtools.charts":{en:"Charts",pt:"Gr\xe1ficos"},"devtools.csv":{en:"CSV",pt:"CSV"},"devtools.regex":{en:"Regex",pt:"Regex"},"devtools.json":{en:"JSON",pt:"JSON"},"devtools.diff":{en:"Diff",pt:"Diferen\xe7as"},"devtools.jwt":{en:"JWT",pt:"JWT"},"devtools.cron":{en:"Cron",pt:"Cron"},"devtools.colors":{en:"Colors",pt:"Cores"},"devtools.api":{en:"API",pt:"API"}},n="atlantis:locale",s="shell:locale";function l(e){return"en"===e||"pt"===e}function d(){try{let e=localStorage.getItem(n);if(l(e))return e}catch{}return"en"}function c(){let[e,t]=(0,i.useState)(d),a=(0,i.useCallback)(e=>{t(e);try{localStorage.setItem(n,e)}catch{}(0,o.Is)(s,e).catch(()=>{}),window.dispatchEvent(new CustomEvent("atlantis:locale-change",{detail:e}))},[]);return(0,i.useEffect)(()=>{let e=e=>{t(e.detail)};return window.addEventListener("atlantis:locale-change",e),()=>window.removeEventListener("atlantis:locale-change",e)},[]),(0,i.useEffect)(()=>{(0,o.PL)(s).then(a=>{if(l(a)&&a!==e){try{localStorage.setItem(n,a)}catch{}t(a)}}).catch(()=>{})},[]),[e,a]}function p(e,t){let a=t?{...r,...t}:r;return(t,i)=>{let o=function(e,t){if(!t||!e.includes("|"))return e;let a=null;for(let e of Object.values(t))if("number"==typeof e&&Number.isFinite(e)){a=e;break}if(null===a)return e;let i=e.indexOf("|"),o=e.slice(0,i),r=e.slice(i+1);return 1===a?o:r}(a[t]?.[e]??t,i);return i?Object.entries(i).reduce((e,[t,a])=>e.replace(RegExp(`\\{${t}\\}`,"g"),String(a)),o):o}}function h(e,t){let a=Math.floor((Date.now()-new Date(e).getTime())/6e4);if(a<1)return t("time.justNow");if(a<60)return t("time.mAgo",{n:a});let i=Math.floor(a/60);return i<24?t("time.hAgo",{n:i}):t("time.dAgo",{n:Math.floor(i/24)})}(0,o.PL)(s).then(e=>{if(l(e))try{localStorage.setItem(n,e)}catch{}}).catch(()=>{});var g=a(65723),m=a(36859),u=a.n(m);let f=u().div`
  display: flex;
  gap: 4px;
...
`,f=({size:e=14,strokeWidth:t=1.75})=>(0,i.jsxs)("svg",{width:e,height:e,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:t,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,i.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,i.jsx)("polyline",{points:"14 2 14 8 20 8"})]});function x({iconKey:e}){let t=e?p[e]:void 0;return t?(0,i.jsx)("svg",{width:14,height:14,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,dangerouslySetInnerHTML:{__html:t}}):(0,i.jsx)(f,{})}function b({entries:e,activeId:t,onSelect:a}){return(0,i.jsx)(i.Fragment,{children:e.map(e=>e.children?(0,i.jsx)(r().Fragment,{children:(0,i.jsx)(b,{entries:e.children,activeId:t,onSelect:a})},e.id):(0,i.jsxs)(u,{active:t===e.id,onClick:()=>a(e),children:[(0,i.jsx)(x,{iconKey:e.icon}),e.name]},e.id))})}function y({activeId:e}){let{flyout:t,scheduleFlyoutClose:a,cancelFlyoutClose:o}=(0,c.c)();if(!t)return null;let r=t.entry.icon?p[t.entry.icon]:void 0;return(0,i.jsxs)(g,{anchorY:t.anchorY,onMouseEnter:o,onMouseLeave:a,children:[(0,i.jsxs)(m,{children:[r?(0,i.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,dangerouslySetInnerHTML:{__html:r}}):(0,i.jsx)(f,{size:13,strokeWidth:2}),t.entry.name]}),(0,i.jsx)(b,{entries:t.entry.children??[],activeId:e,onSelect:e=>{t.onSelect(e),a()}})]})}},37993(e,t,a){a.d(t,{I:()=>o,c:()=>r});var i=a(37991);let o=(0,i.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),r=()=>(0,i.useContext)(o)},63236(e,t,a){a.d(t,{YZ:()=>eR,n6:()=>A,Yw:()=>ec,SV:()=>eS,rl:()=>eY,dO:()=>tV,mQ:()=>tP,TM:()=>t4,pd:()=>eO,tU:()=>j,xx:()=>at,ue:()=>eP,Ex:()=>eN,$n:()=>b,In:()=>F,K0:()=>k,PE:()=>aw,eu:()=>O});var i=a(65723),o=a(37991),r=a.n(o),n=a(36859),s=a.n(n),l=a(6063);let d={ghost:"transparent",accent:"transparent",primary:l.w4.colors.accent,success:"#238636",danger:"#da3633"},c={ghost:l.w4.colors.sidebarHover,accent:"rgba(88,166,255,0.10)",primary:l.w4.colors.accentHover,success:"#2ea043",danger:"#f85149"},p={ghost:l.w4.colors.border,accent:l.w4.colors.accent,primary:l.w4.colors.accent,success:"#238636",danger:"#da3633"},h={ghost:l.w4.colors.mainTextMuted,accent:l.w4.colors.accent,primary:"#fff",success:"#fff",danger:"#fff"},g={ghost:l.w4.colors.mainText,accent:l.w4.colors.accent,primary:"#fff",success:"#fff",danger:"#fff"},m={sm:"28px",md:"30px"},u={sm:"0 10px",md:"0 12px"},f={sm:"12px",md:"12px"},x=s().button`
  display: inline-flex;
  align-items: center;
  justify-content: center;
  gap: 6px;
...
`,b=r().forwardRef(function({variant:e="ghost",size:t="md",icon:a,iconRight:o,children:r,...n},s){return(0,i.jsxs)(x,{ref:s,variant:e,size:t,...n,children:[a,r,o]})}),y={default:l.w4.colors.accent,danger:"#f85149"},w={default:l.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"},v=s().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`,k=r().forwardRef(function({active:e=!1,shape:t="square",tone:a="default",children:o,...r},n){return(0,i.jsx)(v,{ref:n,active:e,shape:t,tone:a,...r,children:o})});s().div`
  position: relative;
  display: inline-flex;
`,s().div`
  position: absolute;
...
`,L=s().span`
  ...
  line-height: 1;
  letter-spacing: 0;
`,P=["#3b82f6","#8b5cf6","#ec4899","#10b981","#f59e0b","#06b6d4"],I=0,R=new Map,D=s().img`
  width: ${({size:e})=>e}px;
  height: ${({size:e})=>e}px;
  border-radius: 50%;
  object-fit: cover;
...
`;function E({name:e,email:t,avatarUrl:a,size:o=26}){let r=e??t.split("@")[0]??t;if(a)return(0,i.jsx)(D,{src:a,alt:r,size:o});let n=((e??t.split("@")[0]??"")[0]??"?").toUpperCase();return(0,i.jsx)(H,{size:o,"aria-label":r,title:r,children:n})}function O({member:e,size:t=24}){var a,o;let r,n="shared"===e.id||"shared"===e.role,s=Math.floor(.55*t),d=t<=18?8:t<=22?9:t<=28?11:12;if(n)return(0,i.jsx)(N,{size:t,bg:l.w4.colors.surface,ring:!0,"aria-label":"Shared",title:"Shared",style:{color:l.w4.colors.mainTextMuted},children:(0,i.jsx)(F,{name:"home",size:s,"aria-hidden":!0})});let c=(a=e.id,(o=e.color)?o:(!R.has(a)&&(R.set(a,P[I%P.length]),I++),R.get(a))),p="adult"===e.role,h=(r=e.name.trim().split(/\s+/),((r[0]?.[0]??"")+(r[1]?.[0]??"")).toUpperCase().slice(0,2));return(0,i.jsx)(N,{size:t,bg:c,ring:p,title:e.name,children:(0,i.jsx)(L,{fontSize:d,children:h})})}let q=(0,C.keyframes)`
...
`;function ec({locale:e,onLocaleChange:t,user:a,userMenuItems:o=[],userMenuControlLabels:r,onPreferences:n,notifications:s,onOpenPalette:d,paletteLabel:c="Search",onSignIn:p,signInLabel:h="Sign in",before:g,after:m}){let u=function(){if("u"<typeof navigator)return"Ctrl";let e=navigator,t=e.userAgentData?.platform??navigator.platform??navigator.userAgent??"";return/Mac|iPod|iPhone|iPad/i.test(t)?"⌘":"Ctrl"}(),f="⌘"===u?`${u}K`:`${u}+K`;return(0,i.jsxs)(eo,{children:[g,d&&(0,i.jsxs)(en,{onClick:d,"aria-label":c,title:`${c} (${f})`,children:[(0,i.jsx)(F,{name:"search",size:14}),(0,i.jsx)("span",{className:"label",children:c}),(0,i.jsx)("span",{className:"kbd header-kbd",children:f})]}),!a&&(0,i.jsx)(ei.Fd,{locale:e,onChange:t}),!a&&(0,i.jsx)("span",{className:"header-hide-md",children:(0,i.jsx)(l.UW,{})}),s&&(0,i.jsxs)(es,{children:[(0,i.jsx)(er,{onClick:s.onClick,"aria-label":s.label,title:s.label,children:(0,i.jsx)(F,{name:"bell",size:16})}),s.count>0&&(0,i.jsx)(el,{"aria-hidden":"true",children:s.count>9?"9+":s.count})]}),n&&(0,i.jsx)("span",{className:"header-hide-md",children:(0,i.jsx)(er,{onClick:n,"aria-label":"User preferences",title:"Preferences",children:(0,i.jsx)(F,{name:"user-cog",size:16})})}),a?(0,i.jsx)(ea,{user:a,items:o,locale:e,onLocaleChange:t,controlLabels:r}):p?(0,i.jsxs)(ed,{onClick:p,"aria-label":h,children:[(0,i.jsx)(F,{name:"log-in",size:14}),h]}):null,m]})}s().div`
  position: fixed;
  inset: 0;
  pointer-events: none;
  z-index: 900;
...
`;let ep=(0,C.keyframes)`
  from { opacity: 0; transform: translateY(8px); }
  to   { opacity: 1; transform: translateY(0); }
`,eh=s()("div",{shouldForwardProp:e=>"accentColor"!==e&&"pinned"!==e&&"index"!==e})`
  --acc: ${({accentColor:e})=>e};
  position: relative;
  display: flex;
  flex-direction: column;
...
`,s().span`
  ...
  background: ${({color:e})=>e};
  display: inline-block;
`;let eC={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:l.w4.colors.accentMuted},eT={neutral:l.w4.colors.mainTextMuted,live:l.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:l.w4.colors.accent},eA=s().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${l.w4.typography.fontFamilyMono};
...
`,eF=s().span`
  ...
  background: currentColor;
  display: inline-block;
`;function eN({tone:e="neutral",dot:t,children:a,...o}){return(0,i.jsxs)(eA,{tone:e,...o,children:[(t??"live"===e)&&(0,i.jsx)(eF,{}),a]})}let eL=s().kbd`
  font-family: ${l.w4.typography.fontFamilyMono};
  font-size: 10px;
  padding: 2px 6px;
  border: 1px solid ${l.w4.colors.border};
  ...
  white-space: nowrap;
`;function eP({children:e,...t}){return(0,i.jsx)(eL,{...t,children:e})}let eI=s().div`
  font-family: ${l.w4.typography.fontFamilyMono};
  font-size: 11px;
  letter-spacing: 0.16em;
  text-transform: uppercase;
  ...
  align-items: center;
  gap: 8px;
`;function eR({children:e,...t}){return(0,i.jsx)(eI,{...t,children:e})}let eD=s().label`
  display: flex;
  align-items: center;
  gap: 10px;
...
`,eE=s().span`
  ...
  color: ${l.w4.colors.mainTextMuted};
  flex-shrink: 0;
`,eO=r().forwardRef(function({before:e,after:t,...a},o){return(0,i.jsxs)(eD,{children:[e&&(0,i.jsx)(eE,{children:e}),(0,i.jsx)(eH,{ref:o,...a}),t&&(0,i.jsx)(eE,{children:t})]})}),eq=s().div`
  position: relative;
  display: flex;
  flex-direction: column;
  height: 100%;
...
`;function eY({title:e,accessory:t,accentColor:a,error:o,errorLabel:r,children:n}){return(0,i.jsxs)(eq,{accentColor:a,"data-widget-shell":!0,children:[(0,i.jsxs)(eB,{children:[(0,i.jsx)(eR,{children:e}),t&&(0,i.jsx)(eK,{children:t})]}),o?(0,i.jsxs)(eG,{role:"alert",children:[(0,i.jsx)(eV,{children:r??"Error"}),(0,i.jsx)("div",{children:o})]}):(0,i.jsx)(eW,{children:n})]})}s().div`
  position: relative;
  display: flex;
  flex-direction: column;
  height: 100%;
...
`,s().p`
  ...
  font-size: 12.5px;
  line-height: 1.45;
`;var eJ=a(11352),eQ=a(76710),eX=a(4311),eZ=a(73639),e0=a(40080);a(75406),s().nav`padding: ${l.w4.spacing.sm} 0;`,s().div`
...
`;var e1=a(54041);let e4="https://cdn.jsdelivr.net/npm/mermaid@11.14.0/dist/mermaid.min.js",e2=null,e5="#7fb77e",e3=(0,C.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,e6=s().div`
  position: relative;
...
`,e9=!1,te=/^(?:---[\s\S]*?---\s*)?(?:graph|flowchart|sequenceDiagram|classDiagram|stateDiagram(?:-v2)?|erDiagram|pie|gantt|journey|mindmap|gitGraph|sankey(?:-beta)?|quadrantChart|requirementDiagram|timeline|xychart-beta|block-beta|C4Context|C4Container|C4Component|C4Dynamic|C4Deployment)\b/;function tt({code:e}){let[t,a]=(0,o.useState)(""),[r,n]=(0,o.useState)(!1);return((0,o.useEffect)(()=>{let t=!1;n(!1),a("");let i=e.trim();if(!i)return void n(!0);let o=i.split(/\r?\n/)[0]?.trim()??"";if(!te.test(o))return void n(!0);let r=setTimeout(()=>{t||(console.error("[MermaidBlock] render timed out after 5s"),n(!0))},5e3);return(async()=>{try{let e=await (e2||(e2=new Promise((e,t)=>{let a=globalThis.mermaid;if(a)return void e(a);let i=document.createElement("script");i.src=e4,i.async=!0,i.onload=()=>{let a=globalThis.mermaid;a?e(a):t(Error("mermaid loaded but globalThis.mermaid missing"))},i.onerror=()=>t(Error(`failed to load ${e4}`)),document.head.appendChild(i)})));if(console.debug("[MermaidBlock] mermaid ready",{initialized:e9}),!e9){let t="#141820",a="#1c2332",i="#343c4f",o="#e8edf5",r="#9aa5b8",n="#7fb77e",s="#6aa8d8",l="#8b7bff",d="#e89a5c",c="#f87171";e.initialize({startOnLoad:!1,theme:"base",securityLevel:"loose",themeVariables:{fontFamily:"-apple-system, BlinkMacSystemFont, Segoe UI, Helvetica, Arial, sans-serif",background:t,mainBkg:a,primaryColor:n,primaryTextColor:o,primaryBorderColor:n,secondaryColor:l,secondaryTextColor:o,secondaryBorderColor:l,tertiaryColor:s,tertiaryTextColor:o,tertiaryBorderColor:s,lineColor:r,textColor:o,nodeBorder:i,clusterBkg:t,clusterBorder:i,edgeLabelBackground:a,labelBackground:a,labelBorder:i,relationLabelBackground:a,relationLabelColor:o,pie1:n,pie2:l,pie3:s,pie4:d,pie5:"#ff6fa9",pie6:"#2dd4bf",pie7:c,pie8:n,pieStrokeColor:t,pieStrokeWidth:"2px",pieTitleTextSize:"18px",pieSectionTextSize:"13px",pieLegendTextSize:"13px",actorBkg:n,actorBorder:n,actorTextColor:t,signalColor:o,signalTextColor:o,labelBoxBkgColor:a,labelBoxBorderColor:i,labelTextColor:o,loopTextColor:o,noteBkgColor:d,noteBorderColor:d,noteTextColor:t,stateBkg:a,altBackground:t,attributeBackgroundColorOdd:a,attributeBackgroundColorEven:t,rowOdd:a,rowEven:t,gridColor:i,sectionBkgColor:a,sectionBkgColor2:t,taskBkgColor:l,taskTextColor:o,taskTextDarkColor:o,taskTextLightColor:o,taskTextOutsideColor:o,activeTaskBkgColor:n,activeTaskBorderColor:n,doneTaskBkgColor:r,doneTaskBorderColor:r,critBkgColor:c,critBorderColor:c}}),e9=!0}console.debug("[MermaidBlock] calling mermaid.render");let{svg:o}=await e.render(`mermaid-${(0,e1.z)()}`,i);if(clearTimeout(r),console.debug("[MermaidBlock] render returned",{length:o?.length??0}),t)return;let s=/aria-roledescription="error"/i.test(o)||/class="error-(?:icon|text)"/i.test(o)||/>Syntax error in text</i.test(o);if(!o||s)return void n(!0);a(o)}catch(e){clearTimeout(r),console.error("[MermaidBlock] render failed",e),t||n(!0)}})(),()=>{t=!0,clearTimeout(r)}},[e]),r)?(0,i.jsx)(e7,{children:e.trim()}):t?(0,i.jsx)(e6,{dangerouslySetInnerHTML:{__html:t}}):(0,i.jsx)(e6,{children:(0,i.jsx)(e8,{"aria-hidden":!0})})}let ta=["#388bfd","#3fb950","#d29922","#a371f7","#f87171","#22d3ee","#fb923c","#34d399","#f472b6","#818cf8"],ti=s().div`
  background: ${l.w4.colors.codeBg};
  border: 1px solid ${l.w4.colors.codeBorder};
  border-radius: ${l.w4.borderRadius.md};
...
`,tl=s().pre`
  ...
  color: ${l.w4.colors.mainTextMuted};
  white-space: pre-wrap;
`;function td(e){if(e<=0)return 10;let t=Math.pow(10,Math.floor(Math.log10(e)));return Math.ceil(e/t)*t}function tc(e,t,a){let i=Math.max(1,Math.ceil(a/8));return 0!==t&&t!==a-1&&t%i!=0?"":e.length>12?e.slice(0,11)+"…":e}function tp({labels:e,data:t,colors:a}){let o=340,r=176,n=td(Math.max(...t,1)),s=Math.min(40,o/e.length*.6),d=o/e.length,c=Array.from({length:6},(e,t)=>n/5*t);return(0,i.jsxs)("svg",{viewBox:"0 0 400 240",width:"100%",style:{maxWidth:400},children:[c.map((e,t)=>{let a=16+r-e/n*r;return(0,i.jsxs)("g",{children:[(0,i.jsx)("line",{x1:44,y1:a,x2:384,y2:a,stroke:l.w4.colors.border,strokeWidth:.5,strokeDasharray:0===t?"none":"3,3"}),(0,i.jsx)("text",{x:38,y:a+4,fill:l.w4.colors.mainTextMuted,fontSize:10,textAnchor:"end",fontFamily:l.w4.typography.fontFamily,children:Math.round(e)})]},t)}),t.map((t,o)=>{let c=44+d*o+d/2-s/2,p=t/n*r,h=16+r-p,g=a[o%a.length];return(0,i.jsxs)("g",{children:[(0,i.jsxs)("rect",{x:c,y:h,width:s,height:p,rx:3,fill:g,opacity:.85,children:[(0,i.jsx)("animate",{attributeName:"height",from:"0",to:p,dur:"0.5s",fill:"freeze"}),(0,i.jsx)("animate",{attributeName:"y",from:16+r,to:h,dur:"0.5s",fill:"freeze"})]}),(0,i.jsx)("text",{x:c+s/2,y:h-4,fill:l.w4.colors.mainText,fontSize:10,fontWeight:600,textAnchor:"middle",fontFamily:l.w4.typography.fontFamily,children:t}),(0,i.jsx)("text",{x:44+d*o+d/2,y:208,fill:l.w4.colors.mainTextMuted,fontSize:10,textAnchor:"middle",fontFamily:l.w4.typography.fontFamily,children:tc(e[o],o,e.length)})]},o)})]})}function th({labels:e,data:t,colors:a}){let o=t.reduce((e,t)=>e+t,0)||1,r=-Math.PI/2,n=t.map((e,t)=>{let n=e/o*Math.PI*2,s=r,d=r+=n,c=120+90*Math.cos(s),p=120+90*Math.sin(s),h=120+90*Math.cos(d),g=120+90*Math.sin(d),m=+(n>Math.PI),u=s+n/2,f=120+58.5*Math.cos(u),x=120+58.5*Math.sin(u),b=Math.round(e/o*100);return(0,i.jsxs)("g",{children:[(0,i.jsx)("path",{d:`M 120 120 L ${c} ${p} A 90 90 0 ${m} 1 ${h} ${g} Z`,fill:a[t%a.length],stroke:l.w4.colors.codeBg,strokeWidth:2,opacity:.85}),b>=5&&(0,i.jsxs)("text",{x:f,y:x+4,fill:"#fff",fontSize:11,fontWeight:600,textAnchor:"middle",fontFamily:l.w4.typography.fontFamily,children:[b,"%"]})]},t)});return(0,i.jsx)("svg",{viewBox:"0 0 240 240",width:"100%",style:{maxWidth:240},children:n})}function tg({labels:e,data:t,colors:a}){let o=340,r=176,n=td(Math.max(...t,1)),s=t.length>1?o/(t.length-1):o,d=a[0],c=t.map((e,t)=>({x:44+s*t,y:16+r-e/n*r})),p=c.map((e,t)=>`${0===t?"M":"L"} ${e.x} ${e.y}`).join(" "),h=Array.from({length:6},(e,t)=>n/5*t);return(0,i.jsxs)("svg",{viewBox:"0 0 400 240",width:"100%",style:{maxWidth:400},children:[h.map((e,t)=>{let a=16+r-e/n*r;return(0,i.jsxs)("g",{children:[(0,i.jsx)("line",{x1:44,y1:a,x2:384,y2:a,stroke:l.w4.colors.border,strokeWidth:.5,strokeDasharray:0===t?"none":"3,3"}),(0,i.jsx)("text",{x:38,y:a+4,fill:l.w4.colors.mainTextMuted,fontSize:10,textAnchor:"end",fontFamily:l.w4.typography.fontFamily,children:Math.round(e)})]},t)}),(0,i.jsx)("path",{d:p,fill:"none",stroke:d,strokeWidth:2.5,strokeLinecap:"round",strokeLinejoin:"round"}),c.map((a,o)=>(0,i.jsxs)("g",{children:[(0,i.jsx)("circle",{cx:a.x,cy:a.y,r:4,fill:d,stroke:l.w4.colors.codeBg,strokeWidth:2}),(0,i.jsx)("text",{x:a.x,y:a.y-10,fill:l.w4.colors.mainText,fontSize:10,fontWeight:600,textAnchor:"middle",fontFamily:l.w4.typography.fontFamily,children:t[o]}),(0,i.jsx)("text",{x:a.x,y:208,fill:l.w4.colors.mainTextMuted,fontSize:10,textAnchor:"middle",fontFamily:l.w4.typography.fontFamily,children:tc(e[o],o,e.length)})]},o))]})}function tm({code:e}){let t=(0,o.useMemo)(()=>(function(e){let t,a,i=e.trim().split("\n"),o="bar",r=[],n=[];for(let e of i){let[i,...s]=e.split(":"),l=s.join(":").trim();if(l)switch(i.trim().toLowerCase()){case"type":["bar","pie","line"].includes(l.toLowerCase())&&(o=l.toLowerCase());break;case"title":t=l;break;case"labels":r=l.replace(/^\[|\]$/g,"").split(",").map(e=>e.trim()).filter(Boolean);break;case"data":n=l.replace(/^\[|\]$/g,"").split(",").map(e=>e.trim()).filter(Boolean).map(e=>parseFloat(e)||0);break;case"colors":{let e=l.replace(/^\[|\]$/g,"").split(",").map(e=>e.trim()).filter(Boolean);a=e.length?e:void 0}}}return r.length&&n.length?{type:o,title:t,labels:r,data:n,colors:a}:null})(e),[e]);if(!t)return(0,i.jsx)(tl,{children:e.trim()});let a=t.colors??ta;return(0,i.jsxs)(ti,{children:[t.title&&(0,i.jsx)(to,{children:t.title}),"bar"===t.type&&(0,i.jsx)(tp,{labels:t.labels,data:t.data,colors:a}),"pie"===t.type&&(0,i.jsx)(th,{labels:t.labels,data:t.data,colors:a}),"line"===t.type&&(0,i.jsx)(tg,{labels:t.labels,data:t.data,colors:a}),(0,i.jsx)(tr,{children:t.labels.map((e,t)=>(0,i.jsxs)(tn,{children:[(0,i.jsx)(ts,{color:a[t%a.length]}),e]},t))})]})}s().div`
  background: ${l.w4.colors.codeBg};
  border: 1px solid ${l.w4.colors.codeBorder};
  border-radius: ${l.w4.borderRadius.md};
  padding: ${l.w4.spacing.lg};
...
`,s().span`
  font-size: ${l.w4.typography.fontSizeBase};
  color: ${l.w4.colors.mainTextMuted};
`;var tx=a(17223),tb=a(21426);let ty=s().div`
  margin: ${l.w4.spacing.lg} 0;
  border-radius: ${l.w4.borderRadius.md};
  border: 1px solid ${l.w4.colors.codeBorder};
  overflow: hidden;
...
`,t$={...tb.A,'pre[class*="language-"]':{...tb.A['pre[class*="language-"]'],background:l.w4.colors.codeBg,margin:0,padding:"18px 20px",fontSize:"13px",lineHeight:"1.6",borderRadius:0},'code[class*="language-"]':{...tb.A['code[class*="language-"]'],background:"none",fontSize:"13px"}};function tM({lang:e="text",code:t}){let[a,r]=(0,o.useState)(!1);return(0,i.jsxs)(ty,{children:[(0,i.jsxs)(tw,{children:[(0,i.jsx)(tv,{children:e}),(0,i.jsxs)(tk,{copied:a,onClick:()=>{navigator.clipboard.writeText(t).then(()=>{r(!0),setTimeout(()=>r(!1),2e3)})},children:[a?(0,i.jsx)(F,{name:"check",size:12}):(0,i.jsx)(F,{name:"copy",size:12}),a?"Copied!":"Copy"]})]}),(0,i.jsx)(tx.A,{language:e,style:t$,showLineNumbers:t.split("\n").length>8,lineNumberStyle:{color:"#484f58",minWidth:"2.5em",paddingRight:"1.5em",userSelect:"none",fontSize:"12px"},customStyle:{margin:0,background:l.w4.colors.codeBg},wrapLongLines:!1,children:t})]})}let tj={NOTE:{bg:"rgba(88, 166, 255, 0.08)",border:"#58a6ff",icon:"info",label:"Note",color:"#58a6ff"},TIP:{bg:"rgba(63, 185, 80, 0.08)",border:"#3fb950",icon:"lightbulb",label:"Tip",color:"#3fb950"},IMPORTANT:{bg:"rgba(163, 113, 247, 0.08)",border:"#a371f7",icon:"zap",label:"Important",color:"#a371f7"},WARNING:{bg:"rgba(210, 153, 34, 0.08)",border:"#d29922",icon:"alert-triangle",label:"Warning",color:"#d29922"},CAUTION:{bg:"rgba(248, 81, 73, 0.08)",border:"#f85149",icon:"alert-octagon",label:"Caution",color:"#f85149"}},tz=s().div`
  background: ${({bg:e})=>e};
...
`;function tT({type:e,children:t}){let a=tj[e]??tj.NOTE;return(0,i.jsxs)(tz,{bg:a.bg,border:a.border,children:[(0,i.jsxs)(tS,{color:a.color,children:[(0,i.jsx)(F,{name:a.icon,size:15,strokeWidth:2}),a.label]}),(0,i.jsx)(tC,{children:t})]})}s().nav`
  width: 220px;
  min-width: 220px;
...
`,s().aside`
  ...
  display: flex;
  flex-direction: column;
  animation: ${tF} 0.22s cubic-bezier(0.4, 0, 0.2, 1) both;
...
`;function tP({children:e}){return(0,i.jsx)(tL,{children:(0,i.jsx)(eJ.oz,{remarkPlugins:[eQ.A,eX.A,tN],rehypePlugins:[eZ.A,e0.A],components:{div({node:e,children:t,...a}){let o=a["data-callout"];return o?(0,i.jsx)(tT,{type:o,children:t}):(0,i.jsx)("div",{...a,children:t})},pre:({children:e})=>(0,i.jsx)(i.Fragment,{children:e}),code({className:e,children:t}){let a=/language-(\w+)/.exec(e??"")?.[1],o=String(t).replace(/\n$/,"");return o.trim()?"mermaid"===a?(0,i.jsx)(tt,{code:o}):"chart"===a?(0,i.jsx)(tm,{code:o}):a||o.includes("\n")?(0,i.jsx)(tM,{lang:a,code:o}):(0,i.jsx)("code",{className:e,children:t}):null}},children:e})})}var tI=a(37993);s().nav`
  display: flex;
  flex-direction: column;
  gap: 1px;
...
`;function tW({size:e}){return(0,i.jsxs)("svg",{width:14,height:14,viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:[(0,i.jsx)("rect",{x:1.5,y:4.5,width:11,height:5,rx:1,stroke:"currentColor",strokeWidth:1,opacity:.4}),(0,i.jsx)("rect",{x:2,y:5,width:"sm"===e?4:"md"===e?7:11,height:4,rx:.5,fill:"currentColor"})]})}let tG={sm:1,md:2,lg:"full"};function tV({items:e,onReorder:t,onCycleSize:a,onRemove:o,renderPanel:r,renderAccessory:n,showGrip:s=!0,labels:l,accentColor:d}){return(0,i.jsx)(tD,{children:e.map((c,p)=>{let h=tG[c.size],g="full"===h,m=c.minHeight??160,u=d?.(c),f=(c.availableSizes??["sm","md","lg"]).length>1,x=n?.(c);return(0,i.jsxs)(tH,{colSpan:g?1:h,fullWidth:g,children:[x&&(0,i.jsx)(tE,{children:x}),(0,i.jsxs)(tO,{minH:m,accent:u,"data-grip":s?"true":"false",children:[(0,i.jsxs)(tq,{className:"panel-controls",children:[p>0&&(0,i.jsx)(tB,{type:"button",title:l.moveLeft,onClick:()=>t(c.id,-1),children:(0,i.jsx)(F,{name:"chevron-left",size:14})}),p<e.length-1&&(0,i.jsx)(tB,{type:"button",title:l.moveRight,onClick:()=>t(c.id,1),children:(0,i.jsx)(F,{name:"chevron-right",size:14})}),f&&(0,i.jsx)(tB,{type:"button",title:`${l.cycleSize} \xb7 ${c.size.toUpperCase()}`,onClick:()=>a(c.id),children:(0,i.jsx)(tW,{size:c.size})}),o&&l.remove&&(0,i.jsx)(tK,{type:"button",title:l.remove,onClick:()=>o(c.id),children:(0,i.jsx)(F,{name:"close",size:14})})]}),r(c)]})]},c.id)})})}let tY=(0,C.keyframes)`
...
`;s().div`
  ...
  pointer-events: none;
  z-index: 200;
  animation: ${tY} 0.16s cubic-bezier(0.4, 0, 0.2, 1) forwards;
...
`,tQ=s().div`
  ...
  flex-direction: column;
  gap: 14px;
  animation: ${tU} 0.18s cubic-bezier(0.22, 1, 0.36, 1) both;
`,tX=s().div`
  font-size: ${l.w4.typography.fontSizeMd};
  font-weight: 700;
...
`,t1=s().button`
  ...
  &:hover { opacity: 0.88; }
  &:focus-visible { ${l.w4.focusRing} }
`;function t4({open:e,title:t,message:a,confirmLabel:r,cancelLabel:n,onConfirm:s,onCancel:l,danger:d=!1}){return((0,o.useEffect)(()=>{if(!e)return;let t=e=>{"Escape"===e.key&&l(),"Enter"===e.key&&s()};return document.addEventListener("keydown",t),()=>document.removeEventListener("keydown",t)},[e,l,s]),e)?(0,i.jsx)(tJ,{onClick:l,role:"dialog","aria-modal":"true","aria-label":t,children:(0,i.jsxs)(tQ,{danger:d,onClick:e=>e.stopPropagation(),children:[(0,i.jsx)(tX,{danger:d,children:t}),(0,i.jsx)(tZ,{children:a}),(0,i.jsxs)(t0,{children:[(0,i.jsx)(t1,{onClick:l,children:n}),(0,i.jsx)(t1,{danger:d,primary:!d,onClick:s,autoFocus:!0,children:r})]})]})}):null}let t2=(0,C.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,t5=(0,C.keyframes)`
...
`,t6=s().div`
  ...
  background: ${l.w4.colors.mainBg};
  font-family: ${l.w4.typography.fontFamily};
  animation: ${t2} 0.4s ease 0.15s both;
`,t8=s().div`
  position: relative;
  width: 56px;
  height: 56px;
...
`,t7=s().div`
  position: absolute;
  inset: 0;
  animation: ${t5} 1.4s cubic-bezier(0.4, 0, 0.2, 1) infinite;
...
`,t9=s().div`
  ...
  border-radius: 50%;
  background: ${l.w4.colors.border};
  animation: ${t3} 1.4s ease-in-out infinite;
`,ae=s().span`
  color: ${l.w4.colors.mainTextMuted};
  font-size: ${l.w4.typography.fontSizeSm};
  letter-spacing: 0.04em;
`;function at({label:e="Loading…"}){return(0,i.jsxs)(t6,{children:[(0,i.jsxs)(t8,{children:[(0,i.jsx)(t7,{delay:0,size:8,color:l.w4.colors.accent}),(0,i.jsx)(t7,{delay:-.45,size:6,color:"#bc8cff"}),(0,i.jsx)(t7,{delay:-.9,size:5,color:"#3fb950"}),(0,i.jsx)(t9,{})]}),(0,i.jsx)(ae,{children:e})]})}s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,s().div`
  position: relative;
`;let aa="260px",ai="56px",ao="44px",ar=s().header`
  display: flex;
  align-items: center;
  height: calc(${ao} + env(safe-area-inset-top, 0px));
  padding-top: env(safe-area-inset-top, 0px);
  padding-left: env(safe-area-inset-left, 0px);
  padding-right: env(safe-area-inset-right, 0px);
  background: ${l.w4.colors.sidebarBg};
  ...
  @media (max-width: ${l.w4.breakpoints.md}) {
    flex-wrap: wrap;
    height: auto;
    min-height: calc(${ao} + env(safe-area-inset-top, 0px));
  }
`,an=s().div`
  width: ${ai};
  min-width: ${ai};
...
`,am=s().div`
  ...
  overflow: hidden;
`,au=s().aside`
  width: ${({collapsed:e})=>e?ai:aa};
  min-width: ${({collapsed:e})=>e?ai:aa};
  background: ${l.w4.colors.sidebarBg};
  border-right: 1px solid ${l.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,ax=s().main`
  ...
  display: flex;
  flex-direction: column;
`;function ab(){return(0,i.jsxs)(al,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:[(0,i.jsx)(ad,{"aria-hidden":"true",children:"A"}),(0,i.jsx)(ac,{children:"Atlantis"})]})}let ay="atlantis:sidebar-collapsed";function aw({sidebar:e,children:t,topBarRight:n,title:s="Atlantis",activeId:l=null}){let[d,c]=(0,o.useState)(()=>{try{return"true"===localStorage.getItem(ay)}catch{return!1}}),[p,h]=(0,o.useState)(null),g=(0,o.useRef)(),m=()=>c(e=>{let t=!e;try{localStorage.setItem(ay,String(t))}catch{}return t}),u=r().useMemo(()=>r().lazy(()=>Promise.resolve().then(a.bind(a,45816)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,i.jsx)(tI.I.Provider,{value:{collapsed:d,toggle:m,flyout:p,openFlyout:(e,t,a)=>{clearTimeout(g.current),h({entry:e,anchorY:t,onSelect:a})},scheduleFlyoutClose:()=>{g.current=setTimeout(()=>h(null),160)},cancelFlyoutClose:()=>clearTimeout(g.current)},children:(0,i.jsxs)(am,{children:[(0,i.jsxs)(ar,{children:[e&&(0,i.jsx)(an,{children:(0,i.jsx)(as,{onClick:m,title:d?"Expand sidebar":"Collapse sidebar",children:(0,i.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,i.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,i.jsx)("path",{d:"M9 3v18"})]})})}),(0,i.jsx)(ab,{}),s&&(0,i.jsx)(ap,{children:s}),n&&(0,i.jsx)(ah,{children:n})]}),(0,i.jsxs)(ag,{children:[null!=e&&(0,i.jsx)(au,{collapsed:d,children:(0,i.jsx)(af,{children:e})}),(0,i.jsx)(ax,{children:t})]}),p&&(0,i.jsx)(r().Suspense,{fallback:null,children:(0,i.jsx)(u,{activeId:l})})]})})}s().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
...
`,s().div`
  flex: 1;
`},74170(e,t,a){a.d(t,{X:()=>c});var i=a(65723);a(37991);var o=a(36859),r=a.n(o),n=a(6063);let s=r().div`
  position: relative;
  height: 6px;
...
`,d=r().div`
  ...
  opacity: 0.7;
  transition: width 400ms ease;
`;function c({pct:e,over:t=0,color:a="#7fb77e"}){let o=Math.min(100,e),r=100-t;return(0,i.jsxs)(s,{children:[(0,i.jsx)(l,{pct:o,color:a}),t>0&&(0,i.jsx)(d,{left:Math.max(0,r),width:t})]})}},9391(e,t,a){a.d(t,{O:()=>n});var i=a(65723);a(37991);var o=a(63236);let r={sm:20,md:24,lg:28};function n({member:e,size:t="md"}){let a="number"==typeof t?t:r[t];return(0,i.jsx)(o.eu,{member:e,size:a})}},64392(e,t,a){a.d(t,{$:()=>g});var i=a(65723),o=a(36859),r=a.n(o),n=a(6063);let s=r().div`
  display: flex;
  align-items: baseline;
  justify-content: space-between;
  gap: ${n.w4.spacing.sm};
...
`,h=r().span`
  ...
  flex-shrink: 0;
  text-align: right;
`;function g({label:e,value:t,sub:a,href:o,onClick:r}){let n=(0,i.jsxs)(i.Fragment,{children:[(0,i.jsxs)(d,{children:[(0,i.jsx)(c,{children:e}),a&&(0,i.jsx)(p,{children:a})]}),void 0!==t&&(0,i.jsx)(h,{children:t})]});return o?(0,i.jsx)(l,{href:o,target:"_blank",rel:"noopener noreferrer",children:n}):(0,i.jsx)(s,{onClick:r,children:n})}},85043(e,t,a){a.d(t,{Y:()=>p});var i=a(65723),o=a(36859),r=a.n(o),n=a(6063);let s=r().div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
`,d=r().p`
  ...
  margin: 0;
  line-height: 1.5;
`,c={loading:"◌ Loading",empty:"◎ Empty",error:"◎ Offline"};function p({mode:e,label:t,body:a}){return(0,i.jsxs)(s,{children:[(0,i.jsx)(l,{mode:e,children:t??c[e]}),a&&(0,i.jsx)(d,{children:a})]})}},64443(e,t,a){a.d(t,{OW:()=>s,YG:()=>i.Y});var i=a(85043),o=a(65723),r=a(37991),n=a(6063);function s({points:e,accent:t=n.w4.colors.accent,width:a=60,height:i=28,strokeWidth:l=1.5,fluid:d=!1}){let c=(0,r.useMemo)(()=>{if(e.length<2)return"";let t=Math.min(...e),o=Math.max(...e)-t||1,r=a-2*l,n=i-2*l;return e.map((a,i)=>{let s=l+i/(e.length-1)*r,d=l+n-(a-t)/o*n;return`${0===i?"M":"L"} ${s.toFixed(1)} ${d.toFixed(1)}`}).join(" ")},[e,a,i,l]),p=(0,r.useMemo)(()=>{if(e.length<1)return null;let t=e[e.length-1],o=Math.min(...e),r=a-2*l,n=i-2*l;return{x:l+r,y:l+n-(t-o)/(Math.max(...e)-o||1)*n}},[e,a,i,l]);return c?(0,o.jsxs)("svg",{width:d?"100%":a,height:d?"auto":i,viewBox:`0 0 ${a} ${i}`,preserveAspectRatio:"xMidYMid meet","aria-hidden":"true",style:{display:"block",flexShrink:+!!d},children:[(0,o.jsx)("path",{d:c,fill:"none",stroke:t,strokeWidth:l,strokeLinecap:"round",strokeLinejoin:"round",opacity:.7}),p&&(0,o.jsx)("circle",{cx:p.x,cy:p.y,r:l+1,fill:t})]}):null}var l=a(36859),d=a.n(l);d().span`
  font-family: ${n.w4.typography.fontFamilyMono};
  font-size: 11px;
  font-weight: 500;
  font-variant-numeric: tabular-nums;
  ...
  white-space: nowrap;
`,a(64392),a(83090),a(63236),a(74170),a(9391),d().button`
  display: inline-flex;
  align-items: center;
  gap: 6px;
  padding: 0 10px;
...
`,u=n().button`
  ...
  border-radius: ${l.w4.borderRadius.md};
  cursor: pointer;
  transition: background ${l.w4.transitions.fast}, border-color ${l.w4.transitions.fast}, transform ${l.w4.transitions.fast};
