...
`,oC=({size:o=14,strokeWidth:e=1.75})=>(0,t.jsxs)("svg",{width:o,height:o,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:e,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,t.jsx)("polyline",{points:"14 2 14 8 20 8"})]});function oL({iconKey:o}){let e=o?oT[o]:null;return e?(0,t.jsx)(e,{size:14,strokeWidth:1.75}):(0,t.jsx)(oC,{})}function oH({entries:o,activeId:e,onSelect:a}){return(0,t.jsx)(t.Fragment,{children:o.map(o=>o.children?(0,t.jsx)(i().Fragment,{children:(0,t.jsx)(oH,{entries:o.children,activeId:e,onSelect:a})},o.id):(0,t.jsxs)(oB,{active:e===o.id,onClick:()=>a(o),children:[(0,t.jsx)(oL,{iconKey:o.icon}),o.name]},o.id))})}function oR({activeId:o}){let{flyout:e,scheduleFlyoutClose:a,cancelFlyoutClose:r}=(0,c.c)();if(!e)return null;let i=e.entry.icon?oT[e.entry.icon]:null;return(0,t.jsxs)(oj,{anchorY:e.anchorY,onMouseEnter:r,onMouseLeave:a,children:[(0,t.jsxs)(oF,{children:[i?(0,t.jsx)(i,{size:13,strokeWidth:2}):(0,t.jsx)(oC,{size:13,strokeWidth:2}),e.entry.name]}),(0,t.jsx)(oH,{entries:e.entry.children??[],activeId:o,onSelect:o=>{e.onSelect(o),a()}})]})}},814(o,e,a){a.d(e,{I:()=>r,c:()=>i});var t=a(7991);let r=(0,t.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),i=()=>(0,t.useContext)(r)},4764(o,e,a){a.d(e,{PL:()=>B.getSetting,mZ:()=>B.updateDoc,KL:()=>B.saveDoc,cL:()=>c.c,Is:()=>B.putSetting,UO:()=>I,PE:()=>F,w4:()=>t.w4});var t=a(1316),r=a(5723),i=a(7991),n=a.n(i),l=a(6859),s=a.n(l),d=a(2799),c=a(814);let p="260px",g="56px",m="48px",f=s().header`
  display: flex;
  align-items: center;
