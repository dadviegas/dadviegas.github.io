...
`,ei=l().main`
  ...
  display: flex;
  flex-direction: column;
`;function en(){return(0,t.jsxs)(U,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:[(0,t.jsx)(Q,{"aria-hidden":"true",children:"A"}),(0,t.jsx)(X,{children:"Atlantis"})]})}let el="atlantis:sidebar-collapsed";function ed({sidebar:e,children:o,topBarRight:n,title:l="Atlantis",activeId:d=null}){let[s,c]=(0,r.useState)(()=>{try{return"true"===localStorage.getItem(el)}catch{return!1}}),[p,g]=(0,r.useState)(null),h=(0,r.useRef)(),m=()=>c(e=>{let o=!e;try{localStorage.setItem(el,String(o))}catch{}return o}),x=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(a.bind(a,2787)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,t.jsx)(R.I.Provider,{value:{collapsed:s,toggle:m,flyout:p,openFlyout:(e,o,a)=>{clearTimeout(h.current),g({entry:e,anchorY:o,onSelect:a})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,t.jsxs)(ea,{children:[(0,t.jsxs)(W,{children:[e&&(0,t.jsx)(O,{children:(0,t.jsx)(Z,{onClick:m,title:s?"Expand sidebar":"Collapse sidebar",children:(0,t.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("path",{d:"M9 3v18"})]})})}),(0,t.jsx)(en,{}),l&&(0,t.jsx)(J,{children:l}),n&&(0,t.jsx)(ee,{children:n})]}),(0,t.jsxs)(eo,{children:[null!=e&&(0,t.jsx)(et,{collapsed:s,children:(0,t.jsx)(er,{children:e})}),(0,t.jsx)(ei,{children:o})]}),p&&(0,t.jsx)(i().Suspense,{fallback:null,children:(0,t.jsx)(x,{activeId:d})})]})})}var es=a(4971);let ec=l().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
