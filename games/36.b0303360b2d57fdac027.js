...
`,L=i.default.h1`
  ...
  animation: ${T} 0.5s ease both, ${W} 6s linear infinite;
`,A=i.default.p`
...
`,V=i.default.div`
  ...
  align-items: center;
  gap: ${r.w4.spacing.sm};
`,N=[{x:3,y:5,size:1.5,delay:0,dur:3.2},{x:8,y:35,size:2,delay:1.8,dur:3.4},{x:12,y:70,size:1.5,delay:.6,dur:4.1},{x:18,y:15,size:2.5,delay:2.4,dur:3},{x:22,y:55,size:1.5,delay:.3,dur:4.5},{x:28,y:88,size:2,delay:1.1,dur:3.6},{x:33,y:25,size:1.5,delay:2.8,dur:4},{x:40,y:60,size:2,delay:.9,dur:3.3},{x:45,y:8,size:2.5,delay:1.5,dur:3.8},{x:50,y:45,size:1.5,delay:2.1,dur:4.3},{x:55,y:78,size:2,delay:.4,dur:3.1},{x:60,y:18,size:1.5,delay:1.7,dur:4.6},{x:65,y:50,size:2.5,delay:2.6,dur:3.5},{x:70,y:85,size:1.5,delay:.2,dur:3.9},{x:75,y:30,size:2,delay:1.3,dur:4.2},{x:80,y:65,size:1.5,delay:2.9,dur:3.7},{x:85,y:10,size:2,delay:.7,dur:3.4},{x:88,y:42,size:2.5,delay:1.9,dur:4.4},{x:92,y:75,size:1.5,delay:.5,dur:3.2},{x:96,y:22,size:2,delay:2.3,dur:3.8}];function U({topBarRight:e,isAuthenticated:a=!1}){const[t,i]=(0,o.useState)(B),[n,S]=(0,o.useState)("all"),[T]=(0,s.Ym)(),E="pt"===T?"pt":"en";if((0,o.useEffect)(()=>{document.activeElement?.blur()},[t]),(0,o.useEffect)(()=>{const e=()=>i(B());return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[]),!t)return(0,P.jsx)(r.PE,{title:"pt"===E?"Jogos":"Games",sidebar:null,topBarRight:e,children:(0,P.jsxs)(J,{children:[N.map((e,a)=>(0,P.jsx)(G,{x:e.x,y:e.y,size:e.size,delay:e.delay,dur:e.dur},a)),(0,P.jsx)(X,{top:15,delay:12}),(0,P.jsx)(X,{top:55,delay:25}),(0,P.jsx)(L,{children:"pt"===E?"Vamos jogar!":"Let’s play!"}),(0,P.jsx)(A,{children:"pt"===E?"Escolhe um jogo para começar":"Pick a game to get started"}),(0,P.jsxs)(Z,{children:[(0,P.jsxs)(_,{active:"all"===n,onClick:()=>S("all"),children:["🎮 ","pt"===E?"Todos":"All"]}),(0,P.jsx)(_,{active:"online"===n,chipColor:"#3fb950",onClick:()=>S("online"),children:"🌐 Online"}),(0,P.jsxs)(_,{active:"multiplayer"===n,chipColor:"#d2a8ff",onClick:()=>S("multiplayer"),children:["👥 3+ ","pt"===E?"Jogadores":"Players"]}),(0,P.jsxs)(_,{active:"solo"===n,chipColor:"#f59e0b",onClick:()=>S("solo"),children:["🎯 ","pt"===E?"Sozinho":"Solo"]})]}),(0,P.jsx)(Y,{children:C.filter(e=>"online"===n?e.online:"multiplayer"===n?e.maxPlayers>=3:"solo"!==n||1===e.maxPlayers).map((e,t)=>(0,P.jsxs)(D,{accentColor:e.color,onClick:()=>{i(e.id),window.location.hash=e.hash},children:[a&&e.online&&(0,P.jsx)(I,{children:"🌐 Online"}),e.maxPlayers>1&&(0,P.jsxs)(Q,{children:["👥 ",2===e.maxPlayers?"2":`2-${e.maxPlayers}`]}),(0,P.jsx)(R,{className:"card-emoji",delay:.4*t,children:e.emoji}),(0,P.jsx)(q,{children:e.label[E]}),(0,P.jsx)(H,{children:e.description[E]})]},e.id))})]})});const M=(0,P.jsxs)(V,{children:[(0,P.jsxs)(K,{onClick:()=>{i(null),window.location.hash="#/games"},children:["← ","pt"===E?"Jogos":"Games"]}),e]}),W=C.find(e=>e.id===t),F=()=>{i(null),window.location.hash="#/games"};if("lebem"===t)return(0,P.jsx)(r.PE,{title:"LêBem",sidebar:null,topBarRight:M,children:(0,P.jsx)(l.f,{onBack:F})});const O={tictactoe:(0,P.jsx)(d.t,{lang:E,onBack:F,canOnline:a}),soundhunter:(0,P.jsx)(c.m,{lang:E,onBack:F}),familyquiz:(0,P.jsx)(p.i,{lang:E,onBack:F,canOnline:a}),adventure:(0,P.jsx)(m.a,{lang:E,onBack:F}),pixelboard:(0,P.jsx)(h.H,{lang:E,onBack:F}),stopgame:(0,P.jsx)(u.z,{lang:E,onBack:F,canOnline:a}),spotit:(0,P.jsx)(x.O,{lang:E,onBack:F,canOnline:a}),memory:(0,P.jsx)(y.Y,{lang:E,onBack:F,canOnline:a}),tapit:(0,P.jsx)(g.n,{lang:E,onBack:F,canOnline:a}),jumpparty:(0,P.jsx)(f.v,{lang:E,onBack:F}),drawguess:(0,P.jsx)(b.c,{lang:E,onBack:F,canOnline:a}),animalarena:(0,P.jsx)(w.m,{lang:E,onBack:F}),crazykitchen:(0,P.jsx)(k.A,{lang:E,onBack:F}),miniparty:(0,P.jsx)(j.k,{lang:E,onBack:F}),hideseek:(0,P.jsx)($.p,{lang:E,onBack:F}),buttonmayhem:(0,P.jsx)(z.M,{lang:E,onBack:F}),bombbrawl:(0,P.jsx)(v.$,{lang:E,onBack:F,canOnline:a})};return(0,P.jsx)(r.PE,{title:W.title[E],sidebar:null,topBarRight:M,children:O[t]})}}}]);
//# sourceMappingURL=36.b0303360b2d57fdac027.js.map