...
`,l().p`
  ...
  font-size: 12.5px;
  line-height: 1.45;
`;var q=o(1352),Y=o(6710),N=o(4311),W=o(3639),D=o(80);o(5406),l().nav`padding: ${s.w4.spacing.sm} 0;`,l().div`
...
`;l().div`
  ...
  background: ${s.w4.colors.mainBg};
  font-family: ${s.w4.typography.fontFamily};
  animation: ${eY} 0.4s ease 0.15s both;
`,l().div`
  position: relative;
  width: 56px;
  height: 56px;
...
`,l().div`
  position: relative;
`;let eD="260px",eO="56px",eG="44px",eX=l().header`
  display: flex;
  align-items: center;
