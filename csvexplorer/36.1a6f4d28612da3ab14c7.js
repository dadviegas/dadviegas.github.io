"use strict";(self.webpackChunk_atlantis_csvexplorer=self.webpackChunk_atlantis_csvexplorer||[]).push([[36],{6036(e,o,r){r.r(o),r.d(o,{default:()=>U});var s=r(7359),n=r(3233),l=r(894),t=r(3775),a=r(679),i=r(5426),d=r(668),c=r(3317),p=r(9161),u=r(4525),x=r(4490),h=r(9336),m=r(5723);const w=`&::-webkit-scrollbar{width:6px;height:6px}&::-webkit-scrollbar-track{background:transparent}&::-webkit-scrollbar-thumb{background:${l.w4.colors.border};border-radius:3px}scrollbar-width:thin;scrollbar-color:${l.w4.colors.border} transparent;`,f=n.default.div`display:flex;flex:1;overflow:hidden;`,g=n.default.div`
...
//# sourceMappingURL=36.1a6f4d28612da3ab14c7.js.map