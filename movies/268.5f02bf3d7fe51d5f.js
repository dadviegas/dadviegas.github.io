...
`;function I({item:e,rect:o,onOpen:r,onMouseEnter:a,onMouseLeave:i,withBackdrop:n,onBackdropTap:s}){let d=function(e){let o=window.innerWidth,r=window.innerHeight;if(o<500){let t=Math.max(8,(o-300)/2);return{top:Math.max(8,Math.min(e.bottom+8,r-310-8)),left:t}}let t=e.right+10;t+300>o-8&&(t=e.left-300-10),t=Math.max(8,Math.min(t,o-300-8));let a=e.top+e.height/2-155;return{top:a=Math.max(8,Math.min(a,r-310-8)),left:t}}(o),p=(0,g.rS)(e),x=(0,g.Ox)(e),f=(0,g.U7)(e.backdrop_path,"w780");return c().createPortal((0,t.jsxs)(t.Fragment,{children:[n&&(0,t.jsx)("div",{style:{position:"fixed",inset:0,zIndex:9998},onClick:s}),(0,t.jsxs)(z,{top:d.top,left:d.left,onMouseEnter:a,onMouseLeave:i,onClick:r,style:{cursor:"pointer"},children:[f?(0,t.jsx)(j,{src:f}):(0,t.jsx)(T,{}),(0,t.jsxs)(F,{children:[(0,t.jsx)(S,{children:p}),(0,t.jsxs)(C,{children:[(0,t.jsxs)(_,{children:[(0,t.jsx)(l.In,{name:"star",size:11,fill:"currentColor"}),e.vote_average.toFixed(1)]}),x&&(0,t.jsx)(H,{children:x}),(0,t.jsx)(R,{kind:e.media_type,children:"movie"===e.media_type?"Film":"TV"})]}),e.overview&&(0,t.jsx)(B,{children:e.overview}),(0,t.jsxs)(A,{onClick:r,children:[(0,t.jsx)(l.In,{name:"info",size:13}),"More Info"]})]})]})]}),document.body)}function V({item:e,onClick:o}){let r=(0,g.rS)(e),i=(0,g.Ox)(e),n=(0,g.HD)(e.poster_path),s=(0,a.useRef)(null),d=(0,a.useRef)(),c=(0,a.useRef)(),p=(0,a.useRef)(null),M=(0,a.useRef)(!1),[z,j]=(0,a.useState)(!1),[T,F]=(0,a.useState)(null),[S,C]=(0,a.useState)(!1);(0,a.useEffect)(()=>()=>{clearTimeout(d.current),clearTimeout(c.current)},[]);let _=(0,a.useCallback)((e,o)=>{F(e),j(!0),C(o)},[]),H=(0,a.useCallback)(()=>{j(!1),F(null),C(!1)},[]),R=(0,a.useCallback)(()=>{H(),o(e)},[e,o,H]),B=(0,a.useCallback)(()=>{clearTimeout(c.current)},[]),A=(0,a.useCallback)(()=>{clearTimeout(d.current),c.current=setTimeout(H,180)},[H]),L=(0,a.useCallback)(()=>{clearTimeout(c.current)},[]),D=(0,a.useCallback)(()=>{H()},[H]),Y=(0,a.useCallback)(e=>{z||(p.current={x:e.touches[0].clientX,y:e.touches[0].clientY})},[z]),P=(0,a.useCallback)(r=>{if(z||!p.current)return;let t=r.changedTouches[0],a=Math.abs(t.clientX-p.current.x),i=Math.abs(t.clientY-p.current.y);if(p.current=null,a>8||i>8)return;if(M.current=!0,window.innerWidth<768)return void o(e);let n=s.current?.getBoundingClientRect();n&&_(n,!0)},[z,e,o,_]),E=(0,a.useCallback)(()=>{if(M.current){M.current=!1;return}z||S||R()},[z,S,R]);return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsxs)(x,{ref:s,onClick:E,onMouseEnter:B,onMouseLeave:A,onTouchStart:Y,onTouchEnd:P,title:r,role:"button",tabIndex:0,onKeyDown:e=>{("Enter"===e.key||" "===e.key)&&R()},children:[(0,t.jsx)(v,{kind:e.media_type,children:"movie"===e.media_type?"Film":"TV"}),(0,t.jsx)(k,{"data-eye":!0,onClick:e=>{e.stopPropagation();let o=s.current?.getBoundingClientRect();o&&_(o,!1)},title:"Preview",children:(0,t.jsx)(l.In,{name:"eye",size:14})}),n?(0,t.jsx)(f,{src:n,alt:r,loading:"lazy"}):(0,t.jsxs)(h,{children:["\uD83C\uDFAC",(0,t.jsx)(b,{children:r})]}),(0,t.jsxs)(m,{children:[(0,t.jsx)(u,{children:r}),(0,t.jsxs)(w,{children:[(0,t.jsxs)(y,{children:[(0,t.jsx)(l.In,{name:"star",size:9,fill:"currentColor"}),e.vote_average.toFixed(1)]}),i&&(0,t.jsx)($,{children:i})]})]})]}),z&&T&&(0,t.jsx)(I,{item:e,rect:T,onOpen:R,onMouseEnter:L,onMouseLeave:D,withBackdrop:S,onBackdropTap:H})]})}let L=n().div`
  display: flex;
  flex-direction: column;
  gap: ${s.w4.spacing.md};
