...
`,l().div`
  position: relative;
`;let er="260px",ei="56px",en="44px",el=l().header`
  display: flex;
  align-items: center;
...
`,ew=l().main`
  ...
  display: flex;
  flex-direction: column;
`;function ey(){return(0,t.jsxs)(ec,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:[(0,t.jsx)(ep,{"aria-hidden":"true",children:"A"}),(0,t.jsx)(eg,{children:"Atlantis"})]})}let e$="atlantis:sidebar-collapsed";function ev({sidebar:e,children:o,topBarRight:n,title:l="Atlantis",activeId:s=null}){let[d,c]=(0,r.useState)(()=>{try{return"true"===localStorage.getItem(e$)}catch{return!1}}),[p,g]=(0,r.useState)(null),h=(0,r.useRef)(),m=()=>c(e=>{let o=!e;try{localStorage.setItem(e$,String(o))}catch{}return o}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(a.bind(a,45816)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,t.jsx)(L.I.Provider,{value:{collapsed:d,toggle:m,flyout:p,openFlyout:(e,o,a)=>{clearTimeout(h.current),g({entry:e,anchorY:o,onSelect:a})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,t.jsxs)(ex,{children:[(0,t.jsxs)(el,{children:[e&&(0,t.jsx)(es,{children:(0,t.jsx)(ed,{onClick:m,title:d?"Expand sidebar":"Collapse sidebar",children:(0,t.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("path",{d:"M9 3v18"})]})})}),(0,t.jsx)(ey,{}),l&&(0,t.jsx)(eh,{children:l}),n&&(0,t.jsx)(em,{children:n})]}),(0,t.jsxs)(ef,{children:[null!=e&&(0,t.jsx)(eu,{collapsed:d,children:(0,t.jsx)(eb,{children:e})}),(0,t.jsx)(ew,{children:o})]}),p&&(0,t.jsx)(i().Suspense,{fallback:null,children:(0,t.jsx)(f,{activeId:s})})]})})}l().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
