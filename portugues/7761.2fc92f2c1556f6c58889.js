"use strict";(self.webpackChunk_atlantis_portugues=self.webpackChunk_atlantis_portugues||[]).push([[7761],{16710(e,o,a){a.d(o,{WO:()=>po});var n=a(27359),i=a(217),t=a(53233),r=a(65723);t.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,t.default.div`
  position: relative;
`;var l=a(73661),c=a(15959);const d="260px",s="56px",m=t.default.header`
  display: flex;
  align-items: center;
  height: ${"48px"};
...
`,w=t.default.main`
  ...
  display: flex;
  flex-direction: column;
`,$="atlantis:sidebar-collapsed";function v({sidebar:e,children:o,topBarRight:i,title:t="Atlantis",activeId:d=null}){const[s,v]=(0,n.useState)(()=>{try{return"true"===localStorage.getItem($)}catch{return!1}}),[A,k]=(0,n.useState)(null),j=(0,n.useRef)(),S=()=>v(e=>{const o=!e;try{localStorage.setItem($,String(o))}catch{}return o}),T=n.useMemo(()=>n.lazy(()=>Promise.resolve().then(a.bind(a,74914)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(c.I.Provider,{value:{collapsed:s,toggle:S,flyout:A,openFlyout:(e,o,a)=>{clearTimeout(j.current),k({entry:e,anchorY:o,onSelect:a})},scheduleFlyoutClose:()=>{j.current=setTimeout(()=>k(null),160)},cancelFlyoutClose:()=>clearTimeout(j.current)},children:(0,r.jsxs)(x,{children:[(0,r.jsxs)(m,{children:[e&&(0,r.jsx)(g,{children:(0,r.jsx)(u,{onClick:S,title:s?"Expand sidebar":"Collapse sidebar",children:(0,r.jsx)(l.A,{size:17})})}),(0,r.jsxs)(p,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:["Atl",(0,r.jsx)("span",{children:"antis"})]}),t&&(0,r.jsx)(f,{children:t}),i&&(0,r.jsx)(y,{children:i})]}),(0,r.jsxs)(b,{children:[null!=e&&(0,r.jsx)(h,{collapsed:s,children:(0,r.jsx)(z,{children:e})}),(0,r.jsx)(w,{children:o})]}),A&&(0,r.jsx)(n.Suspense,{fallback:null,children:(0,r.jsx)(T,{activeId:d})})]})})}var A=a(20255),k=a(69753),j=a(65185);const S=t.default.div`
  display: grid;
...
`;function F({iconKey:e,size:o=16}){if(e&&!(e in j.t))return(0,r.jsx)("span",{style:{fontSize:o,lineHeight:1,display:"flex",alignItems:"center"},children:e});const a=e?j.t[e]??A.A:A.A;return(0,r.jsx)(a,{size:o,strokeWidth:1.75})}function N({entry:e,activeId:o,onSelect:a}){const[i,t]=(0,n.useState)(e.defaultOpen??!0),{collapsed:l,openFlyout:d,scheduleFlyoutClose:s,cancelFlyoutClose:m}=(0,c.c)();return e.children&&e.children.length>0?(0,r.jsxs)(B,{children:[(0,r.jsxs)(E,{collapsed:l,onClick:()=>{l||t(e=>!e)},onMouseEnter:l?o=>{const n=o.currentTarget.getBoundingClientRect();d(e,n.top,a)}:void 0,onMouseLeave:l?s:void 0,children:[(0,r.jsxs)(C,{collapsed:l,children:[(0,r.jsx)(F,{iconKey:e.icon,size:16}),(0,r.jsx)(P,{collapsed:l,children:e.name})]}),(0,r.jsx)(R,{open:i,collapsed:l,children:(0,r.jsx)(k.A,{size:13})})]}),(0,r.jsx)(S,{open:i&&!l,children:(0,r.jsx)(T,{children:(0,r.jsx)(M,{children:e.children.map(e=>(0,r.jsx)(N,{entry:e,activeId:o,onSelect:a},e.id))})})})]}):(0,r.jsxs)(L,{active:o===e.id,collapsed:l,onClick:()=>a(e),onMouseEnter:l?o=>{const n=o.currentTarget.getBoundingClientRect();d({id:e.id,name:e.name,icon:e.icon,file:e.file,children:[e]},n.top,a)}:void 0,onMouseLeave:l?s:void 0,children:[(0,r.jsx)(F,{iconKey:e.icon,size:15}),(0,r.jsx)(P,{collapsed:l,children:e.name})]})}function I({entries:e,activeId:o,onSelect:a}){return(0,r.jsx)("div",{children:e.map(e=>(0,r.jsx)(N,{entry:e,activeId:o,onSelect:a},e.id))})}const K=a(77207).keyframes`
...
`,a(74914);var G=a(61920),D=a(48607),H=a(68479);t.default.button`
  display: flex;
  align-items: center;
  justify-content: center;
  width: 32px;
...
`;var O=a(88641),V=a(41783);function Y(e){try{return JSON.parse(localStorage.getItem(e)??"[]")}catch{return[]}}const _=t.default.nav`padding: ${i.w4.spacing.sm} 0;`,W=t.default.div`
...
`;function ae({title:e,icon:o,entries:a,activeId:i,onSelect:t,favorites:l,onToggleFav:c}){const[d,s]=(0,n.useState)(!1);return a.length?(0,r.jsxs)(W,{children:[(0,r.jsxs)(J,{onClick:()=>s(e=>!e),children:[(0,r.jsxs)(U,{children:[o,e]}),(0,r.jsx)(Z,{open:d,children:(0,r.jsx)(k.A,{size:12})})]}),(0,r.jsx)(X,{open:d,children:(0,r.jsx)(q,{children:a.map(e=>{const o=l.some(o=>o.id===e.id);return(0,r.jsxs)(Q,{children:[(0,r.jsx)(ee,{active:i===e.id,onClick:()=>t(e),children:e.name}),(0,r.jsx)(oe,{active:o,title:o?"Remover dos favoritos":"Adicionar aos favoritos",onClick:o=>{o.stopPropagation(),c(e)},children:(0,r.jsx)(O.A,{size:12,fill:o?"currentColor":"none"})})]},e.id)})})})]}):null}function ne({config:e,activeId:o,onSelect:a,hashPrefix:i}){const t=`atlantis-recent-${i}`,l=`atlantis-fav-${i}`,[c,d]=(0,n.useState)(()=>Y(t)),[s,m]=(0,n.useState)(()=>Y(l)),g=(0,n.useCallback)(e=>{e.file&&d(o=>function(e,o,a){const n=[o,...a.filter(e=>e.id!==o.id)].slice(0,10);return localStorage.setItem(e,JSON.stringify(n)),n}(t,e,o)),a(e)},[a,t]),u=(0,n.useCallback)(e=>{m(o=>function(e,o,a){const n=a.some(e=>e.id===o.id)?a.filter(e=>e.id!==o.id):[...a,o];return localStorage.setItem(e,JSON.stringify(n)),n}(l,e,o))},[l]);return(0,r.jsxs)(_,{children:[(0,r.jsx)(ae,{title:"Recentes",icon:(0,r.jsx)(V.A,{size:13}),entries:c,activeId:o,onSelect:g,favorites:s,onToggleFav:u}),(0,r.jsx)(ae,{title:"Favoritos",icon:(0,r.jsx)(O.A,{size:13}),entries:s,activeId:o,onSelect:g,favorites:s,onToggleFav:u}),(0,r.jsx)(I,{entries:e.entries,activeId:o,onSelect:g})]})}var ie=a(28976),te=a(18055),re=a(66225),le=a(302),ce=a(39895),de=a(6930),se=a(14944);const me=t.default.div`
...
`;let ue=!1;function pe({code:e}){const o=(0,n.useRef)(null),[t,l]=(0,n.useState)(null);return(0,n.useEffect)(()=>{let n=!1;return async function(){const t=(await a.e(774).then(a.bind(a,30774))).default;if(ue||(t.initialize({startOnLoad:!1,theme:"dark",themeVariables:{background:i.w4.colors.codeBg,primaryColor:i.w4.colors.accent,primaryTextColor:i.w4.colors.mainText,lineColor:i.w4.colors.border}}),ue=!0),o.current&&!n)try{const a=`mermaid-${Math.random().toString(36).slice(2)}`,{svg:i}=await t.render(a,e);!n&&o.current&&(o.current.innerHTML=i)}catch(e){n||l(e instanceof Error?e.message:String(e))}}(),()=>{n=!0}},[e]),t?(0,r.jsx)(me,{children:(0,r.jsxs)(ge,{children:["Mermaid error: ",t]})}):(0,r.jsx)(me,{ref:o})}var fe=a(68383),ye=a(21426),be=a(25609),xe=a(20320);const he=t.default.div`
  margin: ${i.w4.spacing.lg} 0;
  border-radius: ${i.w4.borderRadius.md};
  border: 1px solid ${i.w4.colors.codeBorder};
  overflow: hidden;
...
`,ve={...ye.A,'pre[class*="language-"]':{...ye.A['pre[class*="language-"]'],background:i.w4.colors.codeBg,margin:0,padding:"18px 20px",fontSize:"13px",lineHeight:"1.6",borderRadius:0},'code[class*="language-"]':{...ye.A['code[class*="language-"]'],background:"none",fontSize:"13px"}};function Ae({lang:e="text",code:o}){const[a,t]=(0,n.useState)(!1);return(0,r.jsxs)(he,{children:[(0,r.jsxs)(ze,{children:[(0,r.jsx)(we,{children:e}),(0,r.jsxs)($e,{copied:a,onClick:()=>{navigator.clipboard.writeText(o).then(()=>{t(!0),setTimeout(()=>t(!1),2e3)})},children:[a?(0,r.jsx)(be.A,{size:12}):(0,r.jsx)(xe.A,{size:12}),a?"Copied!":"Copy"]})]}),(0,r.jsx)(fe.A,{language:e,style:ve,showLineNumbers:o.split("\n").length>8,lineNumberStyle:{color:"#484f58",minWidth:"2.5em",paddingRight:"1.5em",userSelect:"none",fontSize:"12px"},customStyle:{margin:0,background:i.w4.colors.codeBg},wrapLongLines:!1,children:o})]})}var ke=a(65569),je=a(8218),Se=a(57230),Te=a(22966),Me=a(21069);const Be={NOTE:{bg:"rgba(88, 166, 255, 0.08)",border:"#58a6ff",icon:ke.A,label:"Note",color:"#58a6ff"},TIP:{bg:"rgba(63, 185, 80, 0.08)",border:"#3fb950",icon:je.A,label:"Tip",color:"#3fb950"},IMPORTANT:{bg:"rgba(163, 113, 247, 0.08)",border:"#a371f7",icon:Se.A,label:"Important",color:"#a371f7"},WARNING:{bg:"rgba(210, 153, 34, 0.08)",border:"#d29922",icon:Te.A,label:"Warning",color:"#d29922"},CAUTION:{bg:"rgba(248, 81, 73, 0.08)",border:"#f85149",icon:Me.A,label:"Caution",color:"#f85149"}},Ee=t.default.div`
  background: ${({bg:e})=>e};
...
`;function Re({type:e,children:o}){const a=Be[e]??Be.NOTE,n=a.icon;return(0,r.jsxs)(Ee,{bg:a.bg,border:a.border,children:[(0,r.jsxs)(Ce,{color:a.color,children:[(0,r.jsx)(n,{size:15,strokeWidth:2}),a.label]}),(0,r.jsx)(Pe,{children:o})]})}const Le=t.default.nav`
  width: 220px;
  min-width: 220px;
...
`;function Ke({headings:e,activeId:o}){return e.length<2?null:(0,r.jsxs)(Le,{children:[(0,r.jsx)(Fe,{children:"On this page"}),(0,r.jsx)(Ne,{children:e.map(e=>(0,r.jsx)("li",{children:(0,r.jsx)(Ie,{href:`#${e.id}`,active:o===e.id,level:e.level,onClick:o=>{o.preventDefault(),document.getElementById(e.id)?.scrollIntoView({behavior:"smooth",block:"start"})},children:e.text})},e.id))})]})}function Ge(e){return e.toLowerCase().replace(/[*_`[\]()#]/g,"").replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-").trim()}function De(e){const{Children:o,isValidElement:n}=a(27359);return o.toArray(e).map(e=>"string"==typeof e?e:"number"==typeof e?String(e):n(e)?De(e.props.children??""):"").join("")}function He(){return e=>{!function e(o){if("blockquote"===o.type){const e=o.children?.[0];if("paragraph"===e?.type){const a=e.children?.[0];if("text"===a?.type){const n=a.value?.match(/^\[!(NOTE|TIP|WARNING|CAUTION|IMPORTANT)\]\s*/i);n&&(a.value=a.value.slice(n[0].length),a.value.trim()||1!==e.children.length||o.children.shift(),o.data=o.data??{},o.data.hName="div",o.data.hProperties={"data-callout":n[1].toUpperCase()})}}}o.children?.forEach(e)}(e)}}const Oe=t.default.div`
  display: flex;
  ...
  width: 100%;
  box-sizing: border-box;
`,Ve=t.default.div`flex: 1; min-width: 0;`,Ye=t.default.article`
...
`,Ze=t.default.div`
  ...
  font-family: ${i.w4.typography.fontFamily};
`;function Xe(e){return function({children:o,...a}){const n=`h${e}`,i=De(o),t=Ge(i);return(0,r.jsxs)(n,{id:t,...a,children:[o,(0,r.jsx)("a",{className:"heading-anchor",href:`#${t}`,"aria-label":`Link to "${i}"`,children:(0,r.jsx)(re.A,{size:14})})]})}}function qe({file:e,prevEntry:o,nextEntry:i,onNavigate:t}){const[l,c]=(0,n.useState)(null),[d,s]=(0,n.useState)(null),m=(0,n.useRef)(null);if((0,n.useEffect)(()=>{c(null),fetch(`${a.p}content/${e}`).then(e=>{if(!e.ok)throw new Error(`${e.status} ${e.statusText}`);return e.text()}).then(c).catch(o=>c(`> **Error loading \`${e}\`:** ${o.message}`))},[e]),(0,n.useEffect)(()=>{if(!l||!m.current)return;const e=m.current.querySelectorAll("h2[id], h3[id]");if(!e.length)return;const o=new IntersectionObserver(e=>{const o=e.filter(e=>e.isIntersecting);o.length&&s(o[0].target.id)},{rootMargin:"-10% 0% -60% 0%",threshold:0});return e.forEach(e=>o.observe(e)),()=>o.disconnect()},[l]),null===l)return(0,r.jsx)(Ze,{children:"Loading…"});const g=function(e){const o=[],a=/^(#{2,3})\s+(.+)$/gm;let n;for(;null!==(n=a.exec(e));){const e=n[1].length,a=n[2].trim().replace(/\*\*(.+?)\*\*/g,"$1").replace(/\*(.+?)\*/g,"$1").replace(/`(.+?)`/g,"$1").replace(/\[(.+?)\]\(.+?\)/g,"$1");o.push({level:e,text:a,id:Ge(a)})}return o}(l),u=o||i;return(0,r.jsxs)(Oe,{children:[(0,r.jsxs)(Ve,{children:[(0,r.jsx)(Ye,{ref:m,children:(0,r.jsx)(ie.oz,{remarkPlugins:[te.A,se.A,He],rehypePlugins:[ce.A,de.A],components:{div({node:e,children:o,...a}){const n=a["data-callout"];return n?(0,r.jsx)(Re,{type:n,children:o}):(0,r.jsx)("div",{...a,children:o})},h1:Xe(1),h2:Xe(2),h3:Xe(3),h4:Xe(4),pre:({children:e})=>(0,r.jsx)(r.Fragment,{children:e}),code({className:e,children:o}){const a=/language-(\w+)/.exec(e??"")?.[1],n=String(o).replace(/\n$/,"");return"mermaid"===a?(0,r.jsx)(pe,{code:n}):a||n.includes("\n")?(0,r.jsx)(Ae,{lang:a,code:n}):(0,r.jsx)("code",{className:e,children:o})}},children:l})}),u&&(0,r.jsxs)(_e,{children:[o?(0,r.jsxs)(We,{align:"left",onClick:()=>t?.(o),children:[(0,r.jsxs)(Je,{children:[(0,r.jsx)(le.A,{size:13})," Previous"]}),(0,r.jsx)(Ue,{children:o.name})]}):(0,r.jsx)("div",{style:{flex:1}}),i?(0,r.jsxs)(We,{align:"right",onClick:()=>t?.(i),children:[(0,r.jsxs)(Je,{children:["Next ",(0,r.jsx)(k.A,{size:13})]}),(0,r.jsx)(Ue,{children:i.name})]}):(0,r.jsx)("div",{style:{flex:1}})]})]}),(0,r.jsx)(Ke,{headings:g,activeId:d})]})}const Qe=t.default.div`
  display: flex;
  gap: 4px;
  background: ${i.w4.colors.surface};
  border: 1px solid ${i.w4.colors.border};
...
`;function go({title:e,sub:o}){return(0,r.jsxs)(io,{children:[(0,r.jsx)(ro,{}),(0,r.jsx)(to,{size:500,x:10,y:-10,hue:210,dur:7}),(0,r.jsx)(to,{size:400,x:60,y:50,hue:270,dur:9}),(0,r.jsx)(to,{size:300,x:30,y:70,hue:190,dur:6}),(0,r.jsxs)(lo,{children:[(0,r.jsx)(co,{children:e}),(0,r.jsx)(so,{children:o}),(0,r.jsxs)(mo,{children:[(0,r.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round",children:(0,r.jsx)("polyline",{points:"15 18 9 12 15 6"})}),"Browse the sidebar"]})]})]})}function uo(e,o,a){return"string"==typeof e?e:e[o]??e[a]??Object.values(e)[0]??""}function po({navigation:e,languages:o,defaultLang:a,hashPrefix:i,topBarRight:t,welcomeTitle:l="Blog",welcomeSub:c="Notes, guides, and references — pick a topic from the sidebar to get started."}){const d=o?Object.keys(o):[],s=d.length>1,[m,g]=(0,n.useState)(()=>a??d[0]??""),u=(0,n.useMemo)(()=>o&&m?o[m].navigation:e??{entries:[]},[o,e,m]),p=((0,n.useMemo)(()=>no(u.entries),[u]),(0,n.useCallback)(e=>{const o=e.match(new RegExp(`^#\\/${i}\\/(.+)$`));if(o)return ao(u.entries,o[1])},[u,i])),[f,y]=(0,n.useState)(()=>p(window.location.hash)??null);(0,n.useEffect)(()=>{y(null)},[m]),(0,n.useEffect)(()=>{const e=()=>{const e=p(window.location.hash);e&&y(e)};return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[p]);const b=(0,n.useCallback)(e=>{e.file&&(y(e),window.location.hash=`#/${i}/${e.id}`)},[i]),x=(0,n.useMemo)(()=>no(u.entries),[u]),h=x.findIndex(e=>e.id===f?.id),z=h>0?x[h-1]:null,w=h<x.length-1?x[h+1]:null,$=f?.label??f?.name??i,A=uo(l,m,a??d[0]??""),k=uo(c,m,a??d[0]??""),j=s&&o?(0,r.jsx)(oo,{languages:Object.fromEntries(d.map(e=>[e,{label:o[e].label}])),activeLang:m,onChange:g}):null;return(0,r.jsx)(v,{title:$,activeId:f?.id??null,topBarRight:(0,r.jsxs)(r.Fragment,{children:[j,t]}),sidebar:(0,r.jsx)(ne,{config:u,activeId:f?.id??null,onSelect:b,hashPrefix:i}),children:f?.file?(0,r.jsx)(qe,{file:f.file,prevEntry:z,nextEntry:w,onNavigate:b}):(0,r.jsx)(go,{title:A,sub:k})})}},74914(e,o,a){a.d(o,{FlyoutPanel:()=>b});var n=a(27359),i=a(53233),t=a(77207),r=a(20255),l=a(217),c=a(15959),d=a(65185),s=a(65723);const m=t.keyframes`
