"use strict";(self.webpackChunk_atlantis_markdown=self.webpackChunk_atlantis_markdown||[]).push([[9153],{33767(e,o,a){a.d(o,{WO:()=>zo});var n=a(27359),t=a(217),i=a(53233),r=a(65723);i.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,A=i.default.main`
  ...
  display: flex;
  flex-direction: column;
`,k=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function j(){return(0,r.jsx)(y,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:k.map((e,o)=>(0,r.jsx)(h,{index:o,accent:e.accent,children:e.char},o))})}const S="atlantis:sidebar-collapsed";function M({sidebar:e,children:o,topBarRight:t,title:i="Atlantis",activeId:l=null}){const[d,m]=(0,n.useState)(()=>{try{return"true"===localStorage.getItem(S)}catch{return!1}}),[p,y]=(0,n.useState)(null),h=(0,n.useRef)(),k=()=>m(e=>{const o=!e;try{localStorage.setItem(S,String(o))}catch{}return o}),M=n.useMemo(()=>n.lazy(()=>Promise.resolve().then(a.bind(a,74914)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(c.I.Provider,{value:{collapsed:d,toggle:k,flyout:p,openFlyout:(e,o,a)=>{clearTimeout(h.current),y({entry:e,anchorY:o,onSelect:a})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>y(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,r.jsxs)(w,{children:[(0,r.jsxs)(g,{children:[e&&(0,r.jsx)(u,{children:(0,r.jsx)(f,{onClick:k,title:d?"Expand sidebar":"Collapse sidebar",children:(0,r.jsx)(s.A,{size:17})})}),(0,r.jsx)(j,{}),i&&(0,r.jsx)(b,{children:i}),t&&(0,r.jsx)(x,{children:t})]}),(0,r.jsxs)(z,{children:[null!=e&&(0,r.jsx)($,{collapsed:d,children:(0,r.jsx)(v,{children:e})}),(0,r.jsx)(A,{children:o})]}),p&&(0,r.jsx)(n.Suspense,{fallback:null,children:(0,r.jsx)(M,{activeId:l})})]})})}var T=a(20255),B=a(69753),E=a(65185);const C=i.default.div`
  display: grid;
...
`;function K({iconKey:e,size:o=16}){if(e&&!(e in E.t))return(0,r.jsx)("span",{style:{fontSize:o,lineHeight:1,display:"flex",alignItems:"center"},children:e});const a=e?E.t[e]??T.A:T.A;return(0,r.jsx)(a,{size:o,strokeWidth:1.75})}function G({entry:e,activeId:o,onSelect:a}){const[t,i]=(0,n.useState)(e.defaultOpen??!0),{collapsed:l,openFlyout:s,scheduleFlyoutClose:d,cancelFlyoutClose:m}=(0,c.c)();return e.children&&e.children.length>0?(0,r.jsxs)(F,{children:[(0,r.jsxs)(L,{collapsed:l,onClick:()=>{l||i(e=>!e)},onMouseEnter:l?o=>{const n=o.currentTarget.getBoundingClientRect();s(e,n.top,a)}:void 0,onMouseLeave:l?d:void 0,children:[(0,r.jsxs)(I,{collapsed:l,children:[(0,r.jsx)(K,{iconKey:e.icon,size:16}),(0,r.jsx)(N,{collapsed:l,children:e.name})]}),(0,r.jsx)(D,{open:t,collapsed:l,children:(0,r.jsx)(B.A,{size:13})})]}),(0,r.jsx)(C,{open:t&&!l,children:(0,r.jsx)(P,{children:(0,r.jsx)(R,{children:e.children.map(e=>(0,r.jsx)(G,{entry:e,activeId:o,onSelect:a},e.id))})})})]}):(0,r.jsxs)(H,{active:o===e.id,collapsed:l,onClick:()=>a(e),onMouseEnter:l?o=>{const n=o.currentTarget.getBoundingClientRect();s({id:e.id,name:e.name,icon:e.icon,file:e.file,children:[e]},n.top,a)}:void 0,onMouseLeave:l?d:void 0,children:[(0,r.jsx)(K,{iconKey:e.icon,size:15}),(0,r.jsx)(N,{collapsed:l,children:e.name})]})}function O({entries:e,activeId:o,onSelect:a}){return(0,r.jsx)("div",{children:e.map(e=>(0,r.jsx)(G,{entry:e,activeId:o,onSelect:a},e.id))})}const Y=l.keyframes`
...
`,a(74914);var _=a(61920),V=a(48607),W=a(68479);i.default.button`
  display: flex;
  align-items: center;
  justify-content: center;
  width: 32px;
...
`;var X=a(88641),q=a(41783);function Q(e){try{return JSON.parse(localStorage.getItem(e)??"[]")}catch{return[]}}const ee=i.default.nav`padding: ${t.w4.spacing.sm} 0;`,oe=i.default.div`
...
`,re=i.default.div`overflow: hidden;`,le=i.default.div`
  display: flex;
  align-items: center;
...
`;function de({title:e,icon:o,entries:a,activeId:t,onSelect:i,favorites:l,onToggleFav:s}){const[c,d]=(0,n.useState)(!1);return a.length?(0,r.jsxs)(oe,{children:[(0,r.jsxs)(ae,{onClick:()=>d(e=>!e),children:[(0,r.jsxs)(ne,{children:[o,e]}),(0,r.jsx)(te,{open:c,children:(0,r.jsx)(B.A,{size:12})})]}),(0,r.jsx)(ie,{open:c,children:(0,r.jsx)(re,{children:a.map(e=>{const o=l.some(o=>o.id===e.id);return(0,r.jsxs)(le,{children:[(0,r.jsx)(se,{active:t===e.id,onClick:()=>i(e),children:e.name}),(0,r.jsx)(ce,{active:o,title:o?"Remover dos favoritos":"Adicionar aos favoritos",onClick:o=>{o.stopPropagation(),s(e)},children:(0,r.jsx)(X.A,{size:12,fill:o?"currentColor":"none"})})]},e.id)})})})]}):null}function me({config:e,activeId:o,onSelect:a,hashPrefix:t}){const i=`atlantis-recent-${t}`,l=`atlantis-fav-${t}`,[s,c]=(0,n.useState)(()=>Q(i)),[d,m]=(0,n.useState)(()=>Q(l)),g=(0,n.useCallback)(e=>{e.file&&c(o=>function(e,o,a){const n=[o,...a.filter(e=>e.id!==o.id)].slice(0,10);return localStorage.setItem(e,JSON.stringify(n)),n}(i,e,o)),a(e)},[a,i]),u=(0,n.useCallback)(e=>{m(o=>function(e,o,a){const n=a.some(e=>e.id===o.id)?a.filter(e=>e.id!==o.id):[...a,o];return localStorage.setItem(e,JSON.stringify(n)),n}(l,e,o))},[l]);return(0,r.jsxs)(ee,{children:[(0,r.jsx)(de,{title:"Recentes",icon:(0,r.jsx)(q.A,{size:13}),entries:s,activeId:o,onSelect:g,favorites:d,onToggleFav:u}),(0,r.jsx)(de,{title:"Favoritos",icon:(0,r.jsx)(X.A,{size:13}),entries:d,activeId:o,onSelect:g,favorites:d,onToggleFav:u}),(0,r.jsx)(O,{entries:e.entries,activeId:o,onSelect:g})]})}var ge=a(28976),ue=a(18055),fe=a(66225),pe=a(302),ye=a(39895),he=a(6930),be=a(14944);const xe=i.default.div`
...
`;let we=!1;function $e({code:e}){const o=(0,n.useRef)(null),[i,l]=(0,n.useState)(null);return(0,n.useEffect)(()=>{let n=!1;return async function(){const i=(await a.e(774).then(a.bind(a,30774))).default;if(we||(i.initialize({startOnLoad:!1,theme:"dark",themeVariables:{background:t.w4.colors.codeBg,primaryColor:t.w4.colors.accent,primaryTextColor:t.w4.colors.mainText,lineColor:t.w4.colors.border}}),we=!0),o.current&&!n)try{const a=`mermaid-${Math.random().toString(36).slice(2)}`,{svg:t}=await i.render(a,e);!n&&o.current&&(o.current.innerHTML=t)}catch(e){n||l(e instanceof Error?e.message:String(e))}}(),()=>{n=!0}},[e]),i?(0,r.jsx)(xe,{children:(0,r.jsxs)(ze,{children:["Mermaid error: ",i]})}):(0,r.jsx)(xe,{ref:o})}var ve=a(68383),Ae=a(21426),ke=a(25609),je=a(20320);const Se=i.default.div`
  margin: ${t.w4.spacing.lg} 0;
  border-radius: ${t.w4.borderRadius.md};
  border: 1px solid ${t.w4.colors.codeBorder};
  overflow: hidden;
...
`,Ee={...Ae.A,'pre[class*="language-"]':{...Ae.A['pre[class*="language-"]'],background:t.w4.colors.codeBg,margin:0,padding:"18px 20px",fontSize:"13px",lineHeight:"1.6",borderRadius:0},'code[class*="language-"]':{...Ae.A['code[class*="language-"]'],background:"none",fontSize:"13px"}};function Ce({lang:e="text",code:o}){const[a,i]=(0,n.useState)(!1);return(0,r.jsxs)(Se,{children:[(0,r.jsxs)(Me,{children:[(0,r.jsx)(Te,{children:e}),(0,r.jsxs)(Be,{copied:a,onClick:()=>{navigator.clipboard.writeText(o).then(()=>{i(!0),setTimeout(()=>i(!1),2e3)})},children:[a?(0,r.jsx)(ke.A,{size:12}):(0,r.jsx)(je.A,{size:12}),a?"Copied!":"Copy"]})]}),(0,r.jsx)(ve.A,{language:e,style:Ee,showLineNumbers:o.split("\n").length>8,lineNumberStyle:{color:"#484f58",minWidth:"2.5em",paddingRight:"1.5em",userSelect:"none",fontSize:"12px"},customStyle:{margin:0,background:t.w4.colors.codeBg},wrapLongLines:!1,children:o})]})}var Pe=a(65569),Re=a(8218),Fe=a(57230),Le=a(22966),Ie=a(21069);const Ne={NOTE:{bg:"rgba(88, 166, 255, 0.08)",border:"#58a6ff",icon:Pe.A,label:"Note",color:"#58a6ff"},TIP:{bg:"rgba(63, 185, 80, 0.08)",border:"#3fb950",icon:Re.A,label:"Tip",color:"#3fb950"},IMPORTANT:{bg:"rgba(163, 113, 247, 0.08)",border:"#a371f7",icon:Fe.A,label:"Important",color:"#a371f7"},WARNING:{bg:"rgba(210, 153, 34, 0.08)",border:"#d29922",icon:Le.A,label:"Warning",color:"#d29922"},CAUTION:{bg:"rgba(248, 81, 73, 0.08)",border:"#f85149",icon:Ie.A,label:"Caution",color:"#f85149"}},De=i.default.div`
  background: ${({bg:e})=>e};
...
`;function Ge({type:e,children:o}){const a=Ne[e]??Ne.NOTE,n=a.icon;return(0,r.jsxs)(De,{bg:a.bg,border:a.border,children:[(0,r.jsxs)(He,{color:a.color,children:[(0,r.jsx)(n,{size:15,strokeWidth:2}),a.label]}),(0,r.jsx)(Ke,{children:o})]})}const Oe=i.default.nav`
  width: 220px;
  min-width: 220px;
...
`,_e=i.default.ul`list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 2px;`,Ve=i.default.a`
  display: block;
  padding: 4px 8px;
...
`;function We({headings:e,activeId:o}){return e.length<2?null:(0,r.jsxs)(Oe,{children:[(0,r.jsx)(Ye,{children:"On this page"}),(0,r.jsx)(_e,{children:e.map(e=>(0,r.jsx)("li",{children:(0,r.jsx)(Ve,{href:`#${e.id}`,active:o===e.id,level:e.level,onClick:o=>{o.preventDefault(),document.getElementById(e.id)?.scrollIntoView({behavior:"smooth",block:"start"})},children:e.text})},e.id))})]})}function Ue(e){return e.toLowerCase().replace(/[*_`[\]()#]/g,"").replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-").trim()}function Je(e){const{Children:o,isValidElement:n}=a(27359);return o.toArray(e).map(e=>"string"==typeof e?e:"number"==typeof e?String(e):n(e)?Je(e.props.children??""):"").join("")}function Ze(){return e=>{!function e(o){if("blockquote"===o.type){const e=o.children?.[0];if("paragraph"===e?.type){const a=e.children?.[0];if("text"===a?.type){const n=a.value?.match(/^\[!(NOTE|TIP|WARNING|CAUTION|IMPORTANT)\]\s*/i);n&&(a.value=a.value.slice(n[0].length),a.value.trim()||1!==e.children.length||o.children.shift(),o.data=o.data??{},o.data.hName="div",o.data.hProperties={"data-callout":n[1].toUpperCase()})}}}o.children?.forEach(e)}(e)}}const Xe=i.default.div`
  display: flex;
  ...
  width: 100%;
  box-sizing: border-box;
`,qe=i.default.div`flex: 1; min-width: 0;`,Qe=i.default.article`
...
`,to=i.default.div`
  ...
  font-family: ${t.w4.typography.fontFamily};
`;function io(e){return function({children:o,...a}){const n=`h${e}`,t=Je(o),i=Ue(t);return(0,r.jsxs)(n,{id:i,...a,children:[o,(0,r.jsx)("a",{className:"heading-anchor",href:`#${i}`,"aria-label":`Link to "${t}"`,children:(0,r.jsx)(fe.A,{size:14})})]})}}function ro({file:e,prevEntry:o,nextEntry:t,onNavigate:i}){const[l,s]=(0,n.useState)(null),[c,d]=(0,n.useState)(null),m=(0,n.useRef)(null);if((0,n.useEffect)(()=>{s(null),fetch(`${a.p}content/${e}`).then(e=>{if(!e.ok)throw new Error(`${e.status} ${e.statusText}`);return e.text()}).then(s).catch(o=>s(`> **Error loading \`${e}\`:** ${o.message}`))},[e]),(0,n.useEffect)(()=>{if(!l||!m.current)return;const e=m.current.querySelectorAll("h2[id], h3[id]");if(!e.length)return;const o=new IntersectionObserver(e=>{const o=e.filter(e=>e.isIntersecting);o.length&&d(o[0].target.id)},{rootMargin:"-10% 0% -60% 0%",threshold:0});return e.forEach(e=>o.observe(e)),()=>o.disconnect()},[l]),null===l)return(0,r.jsx)(to,{children:"Loading…"});const g=function(e){const o=[],a=/^(#{2,3})\s+(.+)$/gm;let n;for(;null!==(n=a.exec(e));){const e=n[1].length,a=n[2].trim().replace(/\*\*(.+?)\*\*/g,"$1").replace(/\*(.+?)\*/g,"$1").replace(/`(.+?)`/g,"$1").replace(/\[(.+?)\]\(.+?\)/g,"$1");o.push({level:e,text:a,id:Ue(a)})}return o}(l),u=o||t;return(0,r.jsxs)(Xe,{children:[(0,r.jsxs)(qe,{children:[(0,r.jsx)(Qe,{ref:m,children:(0,r.jsx)(ge.oz,{remarkPlugins:[ue.A,be.A,Ze],rehypePlugins:[ye.A,he.A],components:{div({node:e,children:o,...a}){const n=a["data-callout"];return n?(0,r.jsx)(Ge,{type:n,children:o}):(0,r.jsx)("div",{...a,children:o})},h1:io(1),h2:io(2),h3:io(3),h4:io(4),pre:({children:e})=>(0,r.jsx)(r.Fragment,{children:e}),code({className:e,children:o}){const a=/language-(\w+)/.exec(e??"")?.[1],n=String(o).replace(/\n$/,"");return"mermaid"===a?(0,r.jsx)($e,{code:n}):a||n.includes("\n")?(0,r.jsx)(Ce,{lang:a,code:n}):(0,r.jsx)("code",{className:e,children:o})}},children:l})}),u&&(0,r.jsxs)(eo,{children:[o?(0,r.jsxs)(oo,{align:"left",onClick:()=>i?.(o),children:[(0,r.jsxs)(ao,{children:[(0,r.jsx)(pe.A,{size:13})," Previous"]}),(0,r.jsx)(no,{children:o.name})]}):(0,r.jsx)("div",{style:{flex:1}}),t?(0,r.jsxs)(oo,{align:"right",onClick:()=>i?.(t),children:[(0,r.jsxs)(ao,{children:["Next ",(0,r.jsx)(B.A,{size:13})]}),(0,r.jsx)(no,{children:t.name})]}):(0,r.jsx)("div",{style:{flex:1}})]})]}),(0,r.jsx)(We,{headings:g,activeId:c})]})}function lo(e,o){for(const a of e){if(a.id===o)return a;if(a.children){const e=lo(a.children,o);if(e)return e}}}function so(e){return e.flatMap(e=>e.children?so(e.children):e.file?[e]:[])}const co=i.default.div`
  display: flex;
  align-items: center;
  justify-content: center;
  height: 100%;
...
`,ho={en:"Browse the sidebar",pt:"Explora o menu lateral"};function bo({title:e,sub:o,lang:a}){return(0,r.jsxs)(co,{children:[(0,r.jsx)(go,{}),(0,r.jsx)(mo,{size:500,x:10,y:-10,hue:210,dur:7}),(0,r.jsx)(mo,{size:400,x:60,y:50,hue:270,dur:9}),(0,r.jsx)(mo,{size:300,x:30,y:70,hue:190,dur:6}),(0,r.jsxs)(uo,{children:[(0,r.jsx)(fo,{children:e}),(0,r.jsx)(po,{children:o}),(0,r.jsxs)(yo,{children:[(0,r.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round",children:(0,r.jsx)("polyline",{points:"15 18 9 12 15 6"})}),ho[a]??ho.en]})]})]})}function xo(e,o,a){return"string"==typeof e?e:e[o]??e[a]??Object.values(e)[0]??""}function zo({navigation:e,languages:o,defaultLang:a,locale:t,hashPrefix:i,topBarRight:l,welcomeTitle:s="Blog",welcomeSub:c="Notes, guides, and references — pick a topic from the sidebar to get started."}){const d=o?Object.keys(o):[],[m,g]=(d.length,(0,n.useState)(()=>a??d[0]??""));(0,n.useEffect)(()=>{t&&d.includes(t)&&t!==m&&g(t)},[t]);const u=(0,n.useMemo)(()=>o&&m?o[m].navigation:e??{entries:[]},[o,e,m]),f=((0,n.useMemo)(()=>so(u.entries),[u]),(0,n.useCallback)(e=>{const o=e.match(new RegExp(`^#\\/${i}\\/(.+)$`));if(o)return lo(u.entries,o[1])},[u,i])),[p,y]=(0,n.useState)(()=>f(window.location.hash)??null);(0,n.useEffect)(()=>{if(!p)return;const e=lo(u.entries,p.id);y(e??null)},[m,u]),(0,n.useEffect)(()=>{const e=()=>{const e=f(window.location.hash);e&&y(e)};return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[f]);const h=(0,n.useCallback)(e=>{e.file&&(y(e),window.location.hash=`#/${i}/${e.id}`)},[i]),b=(0,n.useMemo)(()=>so(u.entries),[u]),x=b.findIndex(e=>e.id===p?.id),z=x>0?b[x-1]:null,w=x<b.length-1?b[x+1]:null,$=p?.label??p?.name??i,v=xo(s,m,a??d[0]??""),A=xo(c,m,a??d[0]??"");return(0,r.jsx)(M,{title:$,activeId:p?.id??null,topBarRight:l,sidebar:(0,r.jsx)(me,{config:u,activeId:p?.id??null,onSelect:h,hashPrefix:i}),children:p?.file?(0,r.jsx)(ro,{file:p.file,prevEntry:z,nextEntry:w,onNavigate:h}):(0,r.jsx)(bo,{title:v,sub:A,lang:m})})}i.default.div`
  display: flex;
  gap: 4px;
  background: ${t.w4.colors.surface};
  border: 1px solid ${t.w4.colors.border};
