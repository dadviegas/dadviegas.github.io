"use strict";(self.webpackChunk_atlantis_pad=self.webpackChunk_atlantis_pad||[]).push([["5512"],{58997(e,r,t){var o=t(62727);r.createRoot=o.createRoot,o.hydrateRoot},13611(e,r,t){var o=t(65723),n=t(58997),a=t(37991),i=t(36859),l=t.n(i),s=t(94764),c=t(42907),d=t(53804),u=t(2099),p=t(65320),m=t(7279),w=t(56666);function g(){let e=window.location.hash.toLowerCase();return e.startsWith("#/mermaidpad")||e.startsWith("#/mermaid")?"mermaid":"markdown"}let x=l().button`
  display: flex;
  align-items: center;
  gap: 6px;
  padding: 5px 12px;
