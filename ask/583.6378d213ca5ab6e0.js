...
`;let H={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:s.w4.colors.accentMuted},L={neutral:s.w4.colors.mainTextMuted,live:s.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:s.w4.colors.accent};l().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${s.w4.typography.fontFamilyMono};
...
`;let A=l().kbd`
  ...
  white-space: nowrap;
`;function R({children:e,...t}){return(0,r.jsx)(A,{...t,children:e})}let V=l().div`
  font-family: ${s.w4.typography.fontFamilyMono};
  font-size: 11px;
...
`;var O=o(4041);let G="https://cdn.jsdelivr.net/npm/mermaid@11.14.0/dist/mermaid.min.js",X=null,_="#7fb77e",Z=(0,j.keyframes)`
...
`,e3=l().main`
  ...
  display: flex;
  flex-direction: column;
`;function e8(){return(0,r.jsxs)(eK,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:[(0,r.jsx)(eU,{"aria-hidden":"true",children:"A"}),(0,r.jsx)(eJ,{children:"Atlantis"})]})}let e6="atlantis:sidebar-collapsed";function e7({sidebar:e,children:t,topBarRight:n,title:l="Atlantis",activeId:s=null}){let[d,c]=(0,a.useState)(()=>{try{return"true"===localStorage.getItem(e6)}catch{return!1}}),[p,g]=(0,a.useState)(null),h=(0,a.useRef)(),x=()=>c(e=>{let t=!e;try{localStorage.setItem(e6,String(t))}catch{}return t}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(o.bind(o,5816)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(eR.I.Provider,{value:{collapsed:d,toggle:x,flyout:p,openFlyout:(e,t,o)=>{clearTimeout(h.current),g({entry:e,anchorY:t,onSelect:o})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,r.jsxs)(e2,{children:[(0,r.jsxs)(eX,{children:[e&&(0,r.jsx)(e_,{children:(0,r.jsx)(eZ,{onClick:x,title:d?"Expand sidebar":"Collapse sidebar",children:(0,r.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,r.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,r.jsx)("path",{d:"M9 3v18"})]})})}),(0,r.jsx)(e8,{}),l&&(0,r.jsx)(eQ,{children:l}),n&&(0,r.jsx)(e0,{children:n})]}),(0,r.jsxs)(e1,{children:[null!=e&&(0,r.jsx)(e4,{collapsed:d,children:(0,r.jsx)(e5,{children:e})}),(0,r.jsx)(e3,{children:t})]}),p&&(0,r.jsx)(i().Suspense,{fallback:null,children:(0,r.jsx)(f,{activeId:s})})]})})}l().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
