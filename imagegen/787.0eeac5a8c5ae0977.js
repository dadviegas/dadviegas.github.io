...
`,w=n().div`
  ...
  opacity: 0;
  transition: opacity ${s.w4.transitions.base};
`;function u({item:o,onSelect:e,onDelete:r}){let i=function(o){let e=`https://image.pollinations.ai/prompt/${encodeURIComponent(o.prompt)}?width=200&height=200&seed=${o.seed}&model=${o.model}&nologo=true`,[r,t]=(0,a.useState)(e);return(0,a.useEffect)(()=>{let e=null;return(0,p.if)(o.id).then(o=>{o&&(e=o,t(o))}),()=>{e&&URL.revokeObjectURL(e)}},[o.id]),r}(o);return(0,t.jsxs)(h,{onClick:e,children:[(0,t.jsx)(b,{src:i,alt:o.prompt,loading:"lazy",referrerPolicy:"no-referrer"}),(0,t.jsx)(m,{className:"delete-btn",role:"button",onClick:o=>{o.stopPropagation(),r()},children:(0,t.jsx)(d.In,{name:"close",size:12})}),(0,t.jsx)(w,{className:"prompt-label",children:o.prompt})]})}function y({items:o,onSelect:e,onDelete:r}){return 0===o.length?null:(0,t.jsxs)(g,{children:[(0,t.jsx)(x,{children:"Recent Generations"}),(0,t.jsx)(f,{children:o.map(o=>(0,t.jsx)(u,{item:o,onSelect:()=>e(o),onDelete:()=>r(o.id)},o.id))})]})}},9610(o,e,r){r.d(e,{e:()=>y});var t=r(5723),a=r(6859),i=r.n(a),n=r(2799),l=r(4764),s=r(18);let d=(0,n.keyframes)`
...
`;function y({url:o,status:e,width:r,height:a,onLoad:i,onError:n,onReroll:l,onRetry:d}){return(0,t.jsxs)(c,{children:[(0,t.jsx)(g,{ratio:r/a,children:(0,t.jsxs)(x,{children:["idle"===e&&(0,t.jsxs)(b,{children:[(0,t.jsx)("span",{style:{fontSize:40,opacity:.3},children:"\uD83C\uDFA8"}),"Generate an image to get started"]}),"loading"===e&&(0,t.jsx)(f,{}),"error"===e&&(0,t.jsxs)(m,{children:[(0,t.jsx)(s.In,{name:"alert-circle",size:32}),"Failed to generate image",(0,t.jsx)(s.$n,{variant:"ghost",size:"sm",onClick:d,children:"Try Again"})]}),o&&("loaded"===e||"loading"===e)&&(0,t.jsx)(h,{src:o,alt:"Generated image",crossOrigin:"anonymous",referrerPolicy:"no-referrer",onLoad:o=>i(o.currentTarget),onError:n,style:{display:"loaded"===e?"block":"none"}})]})}),"loaded"===e&&(0,t.jsxs)(w,{className:"overlay",children:[(0,t.jsxs)(u,{onClick:()=>{o&&window.open(o,"_blank","noopener")},children:[(0,t.jsx)(s.In,{name:"download",size:14})," Download"]}),(0,t.jsxs)(u,{onClick:l,children:[(0,t.jsx)(s.In,{name:"refresh-cw",size:14})," New Variation"]})]})]})}},6396(o,e,r){r.d(e,{q:()=>u});var t=r(5723),a=r(6859),i=r.n(a),n=r(2799),l=r(4764),s=r(18),d=r(2906);let p=(0,n.keyframes)`
...
`,b=i().select`
  ...
  cursor: pointer;
  outline: none;
`,m=[{label:"Square 1:1",w:1024,h:1024},{label:"Landscape 16:9",w:1344,h:768},{label:"Portrait 9:16",w:768,h:1344},{label:"Wide 21:9",w:1344,h:576}],w=d.POLLINATIONS_MODELS;function u({prompt:o,onPromptChange:e,width:r,height:a,model:i,onSizeChange:n,onModelChange:l,onGenerate:d,onEnhance:p,generating:y,enhancing:$,canEnhance:v}){let M=!!o.trim()&&!y;return(0,t.jsxs)(c,{children:[(0,t.jsxs)(g,{children:[(0,t.jsx)(x,{placeholder:"Describe the image you want to create...",value:o,onChange:o=>e(o.target.value),onKeyDown:o=>{"Enter"===o.key&&M&&(o.preventDefault(),d())}}),(0,t.jsx)(s.$n,{variant:"ghost",icon:$?(0,t.jsx)(f,{children:(0,t.jsx)(s.In,{name:"loader",size:14})}):(0,t.jsx)(s.In,{name:"sparkle",size:14}),disabled:!v||$||!o.trim(),onClick:p,title:v?"Enhance prompt with AI":"Add a Groq key in Prompt Lab to enable",children:"Enhance"}),(0,t.jsx)(s.$n,{variant:"primary",icon:y?(0,t.jsx)(f,{children:(0,t.jsx)(s.In,{name:"loader",size:14})}):(0,t.jsx)(s.In,{name:"image-plus",size:14}),disabled:!M,onClick:d,children:"Generate"})]}),(0,t.jsxs)(h,{children:[m.map(o=>(0,t.jsx)(s.vu,{variant:r===o.w&&a===o.h?"selected":"default",onClick:()=>n(o.w,o.h),children:o.label},o.label)),(0,t.jsx)(b,{value:i,onChange:o=>l(o.target.value),children:w.map(o=>(0,t.jsx)("option",{value:o.id,children:o.label},o.id))})]})]})}},6665(o,e,r){r.d(e,{CJ:()=>i,XZ:()=>l,if:()=>n});let t="images";function a(){return new Promise((o,e)=>{let r=indexedDB.open("atlantis-imagegen-cache",1);r.onupgradeneeded=()=>{let o=r.result;o.objectStoreNames.contains(t)||o.createObjectStore(t,{keyPath:"id"})},r.onsuccess=()=>o(r.result),r.onerror=()=>e(r.error)})}async function i(o,e){try{let r=await new Promise(o=>{try{let r=document.createElement("canvas");r.width=e.naturalWidth,r.height=e.naturalHeight;let t=r.getContext("2d");if(!t)return void o(null);t.drawImage(e,0,0),r.toBlob(e=>o(e),"image/png")}catch{o(null)}});if(!r)return;let i=await a(),n=i.transaction(t,"readwrite").objectStore(t);n.put({id:o,blob:r,cachedAt:Date.now()});let l=n.getAll();l.onsuccess=()=>{let o=l.result;if(o.length>10)for(let e of(o.sort((o,e)=>e.cachedAt-o.cachedAt),o.slice(10)))n.delete(e.id)},i.close()}catch{}}async function n(o){try{let e=await a();return new Promise(r=>{let a=e.transaction(t,"readonly").objectStore(t).get(o);a.onsuccess=()=>{e.close();let o=a.result;o?.blob?r(URL.createObjectURL(o.blob)):r(null)},a.onerror=()=>{e.close(),r(null)}})}catch{return null}}async function l(o){try{let e=await a();e.transaction(t,"readwrite").objectStore(t).delete(o),e.close()}catch{}}},7871(o,e,r){r.d(e,{$5:()=>i,DZ:()=>c,M5:()=>p,Qd:()=>n,vI:()=>l});var t=r(2906);let a="atlantis:imagegen:gallery";function i(){try{return JSON.parse(localStorage.getItem(a)??"[]")}catch{return[]}}function n(o){let e=i().filter(e=>e.id!==o.id),r=[o,...e].slice(0,50);try{localStorage.setItem(a,JSON.stringify(r))}catch{}return r}function l(o){let e=i().filter(e=>e.id!==o);try{localStorage.setItem(a,JSON.stringify(e))}catch{}return e}let s={width:1024,height:1024,model:t.DEFAULT_POLLINATIONS_MODEL_ID},d="atlantis:imagegen:settings";function p(){try{return{...s,...JSON.parse(localStorage.getItem(d)??"{}")}}catch{return s}}function c(o){try{localStorage.setItem(d,JSON.stringify(o))}catch{}}},18(o,e,r){r.d(e,{$n:()=>w,vu:()=>S,In:()=>M});var t=r(5723),a=r(7991),i=r.n(a),n=r(6859),l=r.n(n),s=r(4764);let d={ghost:"transparent",accent:"transparent",primary:s.w4.colors.accent,success:"#238636",danger:"#da3633"},p={ghost:s.w4.colors.sidebarHover,accent:"rgba(88,166,255,0.10)",primary:s.w4.colors.accentHover,success:"#2ea043",danger:"#f85149"},c={ghost:s.w4.colors.border,accent:s.w4.colors.accent,primary:s.w4.colors.accent,success:"#238636",danger:"#da3633"},g={ghost:s.w4.colors.mainTextMuted,accent:s.w4.colors.accent,primary:"#fff",success:"#fff",danger:"#fff"},x={ghost:s.w4.colors.mainText,accent:s.w4.colors.accent,primary:"#fff",success:"#fff",danger:"#fff"},f={sm:"28px",md:"30px"},h={sm:"0 10px",md:"0 12px"},b={sm:"12px",md:"12px"},m=l().button`
  display: inline-flex;
  align-items: center;
  justify-content: center;
  gap: 6px;
...
`,S=i().forwardRef(function({variant:o="default",dotColor:e,children:r,onClick:a,...i},n){return(0,t.jsxs)(T,{ref:n,variant:o,clickable:!!a,onClick:a,type:i.type??"button",...i,children:[e&&(0,t.jsx)(F,{color:e}),r]})}),j={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:s.w4.colors.accentMuted},H={neutral:s.w4.colors.mainTextMuted,live:s.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:s.w4.colors.accent};l().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${s.w4.typography.fontFamilyMono};
