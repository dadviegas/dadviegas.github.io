...
`,Q=i.default.div`
  ...
  align-items: center;
  gap: ${r.w4.spacing.sm};
`,X=[{x:3,y:5,size:1.5,delay:0,dur:3.2},{x:8,y:35,size:2,delay:1.8,dur:3.4},{x:12,y:70,size:1.5,delay:.6,dur:4.1},{x:18,y:15,size:2.5,delay:2.4,dur:3},{x:22,y:55,size:1.5,delay:.3,dur:4.5},{x:28,y:88,size:2,delay:1.1,dur:3.6},{x:33,y:25,size:1.5,delay:2.8,dur:4},{x:40,y:60,size:2,delay:.9,dur:3.3},{x:45,y:8,size:2.5,delay:1.5,dur:3.8},{x:50,y:45,size:1.5,delay:2.1,dur:4.3},{x:55,y:78,size:2,delay:.4,dur:3.1},{x:60,y:18,size:1.5,delay:1.7,dur:4.6},{x:65,y:50,size:2.5,delay:2.6,dur:3.5},{x:70,y:85,size:1.5,delay:.2,dur:3.9},{x:75,y:30,size:2,delay:1.3,dur:4.2},{x:80,y:65,size:1.5,delay:2.9,dur:3.7},{x:85,y:10,size:2,delay:.7,dur:3.4},{x:88,y:42,size:2.5,delay:1.9,dur:4.4},{x:92,y:75,size:1.5,delay:.5,dur:3.2},{x:96,y:22,size:2,delay:2.3,dur:3.8}];function H({topBarRight:e,isAuthenticated:a=!1}){const[t,i]=(0,o.useState)(C),[n,E]=(0,o.useState)("all"),[T]=(0,l.Ym)(),M="pt"===T?"pt":"en";if((0,o.useEffect)(()=>{document.activeElement?.blur()},[t]),(0,o.useEffect)(()=>{const e=()=>i(C());return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[]),!t)return(0,B.jsx)(r.PE,{title:"pt"===M?"Jogos":"Games",sidebar:null,topBarRight:e,children:(0,B.jsxs)(L,{children:[X.map((e,a)=>(0,B.jsx)(J,{x:e.x,y:e.y,size:e.size,delay:e.delay,dur:e.dur},a)),(0,B.jsx)(q,{top:15,delay:12}),(0,B.jsx)(q,{top:55,delay:25}),(0,B.jsx)(A,{children:"pt"===M?"Vamos jogar!":"Let’s play!"}),(0,B.jsx)(G,{children:"pt"===M?"Escolhe um jogo para começar":"Pick a game to get started"}),(0,B.jsxs)(D,{children:[(0,B.jsxs)(R,{active:"all"===n,onClick:()=>E("all"),children:["🎮 ","pt"===M?"Todos":"All"]}),(0,B.jsx)(R,{active:"online"===n,chipColor:"#3fb950",onClick:()=>E("online"),children:"🌐 Online"}),(0,B.jsxs)(R,{active:"multiplayer"===n,chipColor:"#d2a8ff",onClick:()=>E("multiplayer"),children:["👥 3+ ","pt"===M?"Jogadores":"Players"]}),(0,B.jsxs)(R,{active:"solo"===n,chipColor:"#f59e0b",onClick:()=>E("solo"),children:["🎯 ","pt"===M?"Sozinho":"Solo"]})]}),(0,B.jsx)(F,{children:S.filter(e=>"online"===n?e.online:"multiplayer"===n?e.maxPlayers>=3:"solo"!==n||1===e.maxPlayers).map((e,t)=>{const o=1===e.maxPlayers?"pt"===M?"JOGO · SOLO":"GAME · SOLO":2===e.maxPlayers?"pt"===M?"JOGO · 2P":"GAME · 2P":"pt"===M?`JOGO · 2-${e.maxPlayers}P`:`GAME · 2-${e.maxPlayers}P`,n=e.maxPlayers>1?2===e.maxPlayers?"2":`2-${e.maxPlayers}`:void 0,l=O[e.id]?.[M];return(0,B.jsx)(s.Xl,{label:e.label[M],description:e.description[M],emoji:e.emoji,hash:e.hash,category:o,accentColor:e.color,playerCount:n,online:a&&e.online,onlineLabel:"ONLINE",vizId:e.id,vizLabel:l,index:t,onClick:()=>{i(e.id),window.location.hash=e.hash,(0,r.VF)("games",{hash:e.hash,label:e.label[M]??e.label.en,icon:e.emoji,color:e.color})}},e.id)})})]})});const W=(0,B.jsxs)(Q,{children:[(0,B.jsxs)(I,{onClick:()=>{i(null),window.location.hash="#/games"},children:["← ","pt"===M?"Jogos":"Games"]}),e]}),H=S.find(e=>e.id===t),Y=()=>{i(null),window.location.hash="#/games"};if("lebem"===t)return(0,B.jsx)(r.PE,{title:"LêBem",sidebar:null,topBarRight:W,children:(0,B.jsx)(d.f,{onBack:Y})});const Z={tictactoe:(0,B.jsx)(c.t,{lang:M,onBack:Y,canOnline:a}),soundhunter:(0,B.jsx)(p.m,{lang:M,onBack:Y}),familyquiz:(0,B.jsx)(m.i,{lang:M,onBack:Y,canOnline:a}),adventure:(0,B.jsx)(h.a,{lang:M,onBack:Y}),pixelboard:(0,B.jsx)(u.H,{lang:M,onBack:Y}),stopgame:(0,B.jsx)(x.z,{lang:M,onBack:Y,canOnline:a}),spotit:(0,B.jsx)(y.O,{lang:M,onBack:Y,canOnline:a}),memory:(0,B.jsx)(b.Y,{lang:M,onBack:Y,canOnline:a}),tapit:(0,B.jsx)(g.n,{lang:M,onBack:Y,canOnline:a}),jumpparty:(0,B.jsx)(f.v,{lang:M,onBack:Y}),drawguess:(0,B.jsx)(w.c,{lang:M,onBack:Y,canOnline:a}),animalarena:(0,B.jsx)(j.m,{lang:M,onBack:Y}),crazykitchen:(0,B.jsx)(k.A,{lang:M,onBack:Y}),miniparty:(0,B.jsx)(z.k,{lang:M,onBack:Y}),hideseek:(0,B.jsx)(v.p,{lang:M,onBack:Y}),buttonmayhem:(0,B.jsx)(P.M,{lang:M,onBack:Y}),bombbrawl:(0,B.jsx)($.$,{lang:M,onBack:Y,canOnline:a})};return(0,B.jsx)(r.PE,{title:H.title[M],sidebar:null,topBarRight:W,children:Z[t]})}}}]);