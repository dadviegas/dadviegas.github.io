"use strict";(self.webpackChunk_atlantis_csvexplorer=self.webpackChunk_atlantis_csvexplorer||[]).push([["512"],{8997(e,o,r){var n=r(2727);o.createRoot=n.createRoot,n.hydrateRoot},3611(e,o,r){var n=r(5723),s=r(7991),t=r(8997),l=r(6859),i=r.n(l),a=r(6063),c=r(132),d=r(457),p=r(5151);let x=`&::-webkit-scrollbar{width:6px;height:6px}&::-webkit-scrollbar-track{background:transparent}&::-webkit-scrollbar-thumb{background:${a.w4.colors.border};border-radius:3px}scrollbar-width:thin;scrollbar-color:${a.w4.colors.border} transparent;`,u=i().div`display:flex;flex:1;overflow:hidden;`,h=i().div`
