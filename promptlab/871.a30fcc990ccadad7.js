"use strict";(self.webpackChunk_atlantis_promptlab=self.webpackChunk_atlantis_promptlab||[]).push([["871"],{3758(e,o,r){r.d(o,{L:()=>a});var t=r(5256);async function a(e,o,r,a,i,n,l){let s="",d=e=>{e.length<=s.length||(n(e.slice(s.length)),s=e)};"groq"===e?await (0,t.askGroqStream)(i,{key:o,model:r,system:a,onChunk:d,signal:l}):await (0,t.streamGemini)(i,{key:o,model:r,system:a,onChunk:d,signal:l})}},7613(e,o,r){r.d(o,{H:()=>v});var t=r(5723),a=r(7991),i=r(6859),n=r.n(i),l=r(6063),s=r(997),d=r(8035);let c=n().div`
  display: flex;
...
`,l().aside`
  ...
  display: flex;
  flex-direction: column;
  animation: ${V} 0.22s cubic-bezier(0.4, 0, 0.2, 1) both;
...
`,K=l().div`
  ...
  color: ${s.w4.colors.sidebarTextMuted};
  font-family: ${s.w4.typography.fontFamily};
`;function D({onSave:e,onUpdate:o,onCancel:r,existingDoc:i}){let[n,l]=(0,a.useState)(i?.name??""),s=(0,a.useRef)(null);return(0,a.useEffect)(()=>{s.current?.focus(),i&&s.current?.select()},[i]),(0,t.jsx)(q,{onClick:r,children:(0,t.jsxs)(P,{onClick:e=>e.stopPropagation(),children:[(0,t.jsx)(E,{children:"Save document"}),i&&o&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(K,{children:"Update the current version or save as a new one."}),(0,t.jsxs)(O,{children:[(0,t.jsx)(X,{onClick:r,children:"Cancel"}),(0,t.jsxs)(X,{danger:!0,onClick:o,children:['Update "',i.name,'"']})]}),(0,t.jsx)(_,{})]}),(0,t.jsx)(G,{ref:s,value:n,onChange:e=>l(e.target.value),onKeyDown:t=>{"Enter"===t.key&&n.trim()&&(i&&n.trim()===i.name&&o?o():e(n.trim())),"Escape"===t.key&&r()},placeholder:i?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,t.jsxs)(O,{children:[!i&&(0,t.jsx)(X,{onClick:r,children:"Cancel"}),(0,t.jsx)(X,{primary:!0,disabled:!n.trim(),onClick:()=>e(n.trim()),children:"Save as new"})]})]})})}let W=(0,u.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,Z=(0,u.keyframes)`
...
`,l().div`
  position: relative;
`;let J="260px",ee="56px",eo="48px",er=l().header`
  display: flex;
  align-items: center;
...
`,ex=l().main`
  ...
  display: flex;
  flex-direction: column;
`,ef=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function eb(){return(0,t.jsx)(en,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:ef.map((e,o)=>(0,t.jsx)(el,{index:o,accent:e.accent,children:e.char},o))})}let em="atlantis:sidebar-collapsed";function ew({sidebar:e,children:o,topBarRight:n,title:l="Atlantis",activeId:s=null}){let[d,c]=(0,a.useState)(()=>{try{return"true"===localStorage.getItem(em)}catch{return!1}}),[p,g]=(0,a.useState)(null),h=(0,a.useRef)(),x=()=>c(e=>{let o=!e;try{localStorage.setItem(em,String(o))}catch{}return o}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(r.bind(r,5816)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,t.jsx)(L.I.Provider,{value:{collapsed:d,toggle:x,flyout:p,openFlyout:(e,o,r)=>{clearTimeout(h.current),g({entry:e,anchorY:o,onSelect:r})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,t.jsxs)(ep,{children:[(0,t.jsxs)(er,{children:[e&&(0,t.jsx)(et,{children:(0,t.jsx)(ea,{onClick:x,title:d?"Expand sidebar":"Collapse sidebar",children:(0,t.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("path",{d:"M9 3v18"})]})})}),(0,t.jsx)(eb,{}),l&&(0,t.jsx)(es,{children:l}),n&&(0,t.jsx)(ed,{children:n})]}),(0,t.jsxs)(ec,{children:[null!=e&&(0,t.jsx)(eg,{collapsed:d,children:(0,t.jsx)(eh,{children:e})}),(0,t.jsx)(ex,{children:o})]}),p&&(0,t.jsx)(i().Suspense,{fallback:null,children:(0,t.jsx)(f,{activeId:s})})]})})}l().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
