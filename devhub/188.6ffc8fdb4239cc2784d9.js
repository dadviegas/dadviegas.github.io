"use strict";(self.webpackChunk_atlantis_devhub=self.webpackChunk_atlantis_devhub||[]).push([[188],{188(e,i,d){var a=d(359),t=d(997),r=d(233),s=d(365),n=d(910),l=d(591),c=d(202),o=d(808),h=d(723);const u=[{id:"dashboard",name:"Dashboard",icon:"layout-grid",children:[{id:"package-radar",name:"Package Radar",icon:"package"},{id:"community-feed",name:"Community Feed",icon:"users"},{id:"dev-pulse",name:"Dev Pulse",icon:"activity"},{id:"tech-articles",name:"Tech Articles",icon:"book-open"}]}],g=r.default.div`
