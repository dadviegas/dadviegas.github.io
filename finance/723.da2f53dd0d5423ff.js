"use strict";(self.webpackChunk_atlantis_finance=self.webpackChunk_atlantis_finance||[]).push([["723"],{6376(e,t,o){o.d(t,{S:()=>T});var a=o(5723),r=o(7991),n=o(6859),i=o.n(n),s=o(2799),l=o(9874),d=o(8395);let c=(0,s.keyframes)`
...
`,j=i().div`
  ...
  color: ${l.w4.colors.mainText};
  line-height: 1.5;
`;function T({selectionCount:e,visibleIds:t,selectedIds:o,categories:n,locale:i,t:s,onCancel:c,onSelectAll:S,onCategorise:F,onDelete:C,onMarkReimbursed:A}){let[H,R]=(0,r.useState)(!1),[D,E]=(0,r.useState)(""),[L,B]=(0,r.useState)(!1),[P,N]=(0,r.useState)(!1),[O,K]=(0,r.useState)(!1),I=(0,r.useRef)(null);(0,r.useEffect)(()=>{H||E("")},[H]),(0,r.useEffect)(()=>{let e=e=>{if("Escape"===e.key){if(H)return void R(!1);if(L)return void B(!1);P&&N(!1)}};return window.addEventListener("keydown",e),()=>window.removeEventListener("keydown",e)},[H,L,P]);let Y=(0,r.useCallback)(()=>{D&&(F(D),R(!1))},[D,F]),V=(0,r.useCallback)(()=>{C(),B(!1)},[C]),W=(0,r.useCallback)(()=>{A(),N(!1)},[A]),_=t.length>0&&t.every(e=>o.has(e));return(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(p,{role:"toolbar","aria-label":s("finance.bulk.barLabel"),children:(0,a.jsxs)(f,{children:[(0,a.jsx)(g,{children:s("finance.bulk.selected",{n:e})}),(0,a.jsx)(d.$n,{variant:"ghost",style:{height:36,fontSize:12},onClick:_?c:S,children:s(_?"finance.bulk.deselectAll":"finance.bulk.selectAll")}),(0,a.jsx)(h,{}),(0,a.jsx)(d.$n,{variant:"ghost",style:{height:36,fontSize:12},disabled:0===e,onClick:()=>R(!0),children:s("finance.bulk.categorise")}),(0,a.jsx)(d.$n,{variant:"ghost",style:{height:36,fontSize:12},disabled:0===e,onClick:()=>N(!0),children:s("finance.bulk.reimburse")}),(0,a.jsxs)(x,{onMouseEnter:()=>K(!0),onMouseLeave:()=>K(!1),onFocus:()=>K(!0),onBlur:()=>K(!1),children:[(0,a.jsx)("button",{ref:I,type:"button",disabled:!0,style:{height:36,padding:"0 12px",background:"transparent",border:`1px solid ${l.w4.colors.border}`,borderRadius:l.w4.borderRadius.md,color:l.w4.colors.mainTextMuted,fontSize:12,fontFamily:l.w4.typography.fontFamily,cursor:"not-allowed",opacity:.45},"aria-label":s("finance.bulk.tagComingSoon"),children:s("finance.bulk.tag")}),O&&(0,a.jsx)(u,{role:"tooltip",children:s("finance.bulk.tagComingSoon")})]}),(0,a.jsx)(d.$n,{variant:"danger",style:{height:36,fontSize:12},disabled:0===e,onClick:()=>B(!0),children:s("finance.bulk.delete")}),(0,a.jsx)(d.$n,{variant:"ghost",style:{height:36,fontSize:12},onClick:c,children:s("finance.bulk.cancel")})]})}),H&&(0,a.jsx)(m,{onClick:()=>R(!1),children:(0,a.jsxs)(b,{onClick:e=>e.stopPropagation(),children:[(0,a.jsx)(w,{children:s("finance.bulk.categoriseTitle")}),(0,a.jsx)(y,{children:n.map(e=>(0,a.jsxs)($,{type:"button",selected:D===e.id,catColor:e.color,onClick:()=>E(e.id),children:[(0,a.jsx)(v,{"aria-hidden":!0,children:e.icon}),(0,a.jsx)(k,{children:"pt"===i?e.labelPt:e.labelEn})]},e.id))}),(0,a.jsxs)(M,{children:[(0,a.jsx)(d.$n,{variant:"ghost",onClick:()=>R(!1),style:{height:36},children:s("finance.member.cancel")}),(0,a.jsx)(d.$n,{variant:"primary",disabled:!D,onClick:Y,style:{height:36},children:s("finance.bulk.applyCategory")})]})]})}),L&&(0,a.jsx)(m,{onClick:()=>B(!1),children:(0,a.jsxs)(z,{onClick:e=>e.stopPropagation(),children:[(0,a.jsx)(w,{children:s("finance.bulk.deleteTitle")}),(0,a.jsx)(j,{children:s("finance.bulk.deleteConfirm",{n:e})}),(0,a.jsxs)(M,{children:[(0,a.jsx)(d.$n,{variant:"ghost",onClick:()=>B(!1),style:{height:36},children:s("finance.member.cancel")}),(0,a.jsx)(d.$n,{variant:"danger",onClick:V,style:{height:36},children:s("finance.bulk.deleteConfirmBtn")})]})]})}),P&&(0,a.jsx)(m,{onClick:()=>N(!1),children:(0,a.jsxs)(z,{onClick:e=>e.stopPropagation(),children:[(0,a.jsx)(w,{children:s("finance.bulk.reimburseTitle")}),(0,a.jsx)(j,{children:s("finance.bulk.reimburseConfirm",{n:e})}),(0,a.jsxs)(M,{children:[(0,a.jsx)(d.$n,{variant:"ghost",onClick:()=>N(!1),style:{height:36},children:s("finance.member.cancel")}),(0,a.jsx)(d.$n,{variant:"primary",onClick:W,style:{height:36},children:s("finance.bulk.reimburseConfirmBtn")})]})]})})]})}},2405(e,t,o){o.d(t,{D:()=>F});var a=o(5723),r=o(7991),n=o(6859),i=o.n(n),s=o(2799),l=o(9874);let d=(0,s.keyframes)`
...
`,$=i().div`
  ...
  border-radius: 1px;
  background: ${({bg:e})=>e};
`,v=new Set([0,4,8,12,16,20]);function k(e){return[parseInt(e.slice(1,3),16),parseInt(e.slice(3,5),16),parseInt(e.slice(5,7),16)]}let M=k("#1d2230"),z=k("#f59e0b");function j(e){let t=Math.round(M[0]+(z[0]-M[0])*e),o=Math.round(M[1]+(z[1]-M[1])*e),a=Math.round(M[2]+(z[2]-M[2])*e);return`rgb(${t},${o},${a})`}let T=function(e=5){return Array.from({length:e},(t,o)=>j(o/(e-1)))}(5),S=["finance.dayHourHeatmap.day.mon","finance.dayHourHeatmap.day.tue","finance.dayHourHeatmap.day.wed","finance.dayHourHeatmap.day.thu","finance.dayHourHeatmap.day.fri","finance.dayHourHeatmap.day.sat","finance.dayHourHeatmap.day.sun"];function F({matrix:e,t}){let o=(0,r.useMemo)(()=>{let t=0;for(let o of e)for(let e of o)e>t&&(t=e);return t},[e]);return 0===o?(0,a.jsx)(m,{children:t("finance.dayHourHeatmap.empty")}):(0,a.jsxs)(c,{children:[(0,a.jsxs)(p,{children:[(0,a.jsx)(g,{}),Array.from({length:24},(e,t)=>(0,a.jsx)(f,{children:v.has(t)?String(t).padStart(2,"0"):""},t))]}),e.map((e,r)=>(0,a.jsxs)(h,{children:[(0,a.jsx)(x,{children:t(S[r]??"finance.dayHourHeatmap.day.mon")}),e.map((e,n)=>{let i=j(o>0?e/o:0),s=e>0?`€${e.toFixed(2)}`:"—",l=`${String(n).padStart(2,"0")}:00`,d=t(S[r]??"finance.dayHourHeatmap.day.mon");return(0,a.jsx)(u,{bg:i,title:t("finance.dayHourHeatmap.tooltip",{day:d,hour:l,amount:s}),"aria-label":`${d} ${l} — ${s}`},n)})]},r)),(0,a.jsxs)(b,{children:[(0,a.jsx)(w,{children:"0"}),(0,a.jsx)(y,{children:T.map((e,t)=>(0,a.jsx)($,{bg:e},t))}),(0,a.jsxs)(w,{children:["€",o.toFixed(0)]})]})]})}},719(e,t,o){o.d(t,{TA:()=>R,a8:()=>f,jb:()=>D});var a=o(5723),r=o(7991),n=o(6859),i=o.n(n),s=o(9874),l=o(8395),d=o(1496),c=o(3400);let p=["#3b82f6","#8b5cf6","#ec4899","#10b981","#f59e0b","#06b6d4"];function f(e,t){return e.color??p[t%p.length]}let g="#7fb77e",h=i().nav`
  display: flex;
  flex-direction: column;
  width: 100%;
  height: 100%;
...
`,H=i().span`
  ...
  font-variant-numeric: tabular-nums;
  color: ${s.w4.colors.mainTextMuted};
`;function R({data:e,activeMemberId:t,onSelectMember:o,onSaveData:n,t:i,locale:g}){let[C,A]=(0,r.useState)(!1),[H,D]=(0,r.useState)(""),[E,L]=(0,r.useState)("adult"),[B,P]=(0,r.useState)(p[0]),N=(0,c.thisMonthKey)(),O=(()=>{let[e,t]=N.split("-").map(Number),o=new Date(e,t-2,1);return`${o.getFullYear()}-${String(o.getMonth()+1).padStart(2,"0")}`})(),K=[{id:"all",name:i("finance.member.all"),role:"shared",color:void 0},{id:"shared",name:i("finance.member.shared"),role:"shared",color:void 0},...e.familyMembers.map((e,t)=>({...e,color:f(e,t)}))];return(0,a.jsxs)(h,{"aria-label":i("finance.nav.ariaLabel"),children:[K.map(r=>{var n;let i,p,f=r.id===t,h=r.color??s.w4.colors.mainTextMuted,$=(0,c.monthlyTotalByMember)(e,r.id,N),v=(n=r.id,i=(0,c.monthlyTotalByMember)(e,n,N),0===(p=(0,c.monthlyTotalByMember)(e,n,O))?0:Math.round((i-p)/p*100)),k=function(e,t){let o=new Date,a=[];for(let r=5;r>=0;r--){let n=new Date(o);n.setDate(o.getDate()-7*r-o.getDay()),n.setHours(0,0,0,0);let i=new Date(n);i.setDate(n.getDate()+7);let s=(0,c.expensesForMember)(e.expenses,t).filter(e=>{let t=new Date(e.date+"T00:00:00");return t>=n&&t<i}).reduce((e,t)=>e+t.amount,0);a.push(s)}return a}(e,r.id),M={id:r.id,name:r.name,role:r.role,color:r.color};return(0,a.jsxs)(x,{active:f,onClick:()=>o(r.id),type:"button","aria-pressed":f,children:[(0,a.jsx)(l.eu,{member:M,size:26}),(0,a.jsxs)(u,{children:[(0,a.jsx)(m,{active:f,children:r.name}),(0,a.jsxs)(b,{children:[(0,a.jsx)(w,{children:`€${Math.round($).toLocaleString("pt"===g?"pt-PT":"en-GB")}`}),0!==v&&(0,a.jsxs)(y,{positive:v>0,children:[v>0?"↑":"↓",Math.abs(v),"%"]})]})]}),k.some(e=>e>0)&&(0,a.jsx)(d.OW,{points:k,accent:h,width:48,height:24})]},r.id)}),C?(0,a.jsxs)(v,{children:[(0,a.jsx)(k,{type:"text",placeholder:i("finance.member.name"),value:H,onChange:e=>D(e.target.value),autoFocus:!0,"aria-label":i("finance.member.name")}),(0,a.jsxs)(M,{children:[(0,a.jsx)(z,{type:"button",active:"adult"===E,onClick:()=>L("adult"),children:i("finance.member.role.adult")}),(0,a.jsx)(z,{type:"button",active:"child"===E,onClick:()=>L("child"),children:i("finance.member.role.child")})]}),(0,a.jsx)(j,{children:p.map(e=>(0,a.jsx)(T,{type:"button",bg:e,active:B===e,onClick:()=>P(e),"aria-label":e},e))}),(0,a.jsxs)(S,{children:[(0,a.jsx)(F,{type:"button",onClick:()=>A(!1),children:i("finance.member.cancel")}),(0,a.jsx)(F,{type:"button",primary:!0,onClick:function(){if(!H.trim())return;let t={id:`m_${Date.now()}`,name:H.trim(),role:E,color:B};n({...e,familyMembers:[...e.familyMembers,t]}),D(""),L("adult"),P(p[0]),A(!1)},disabled:!H.trim(),children:i("finance.member.save")})]})]}):(0,a.jsxs)($,{type:"button",onClick:()=>A(!0),children:[(0,a.jsx)(l.In,{name:"user-plus",size:14,"aria-hidden":!0}),i("finance.member.add")]})]})}function D({data:e,activeMemberId:t,onSelectMember:o,t:r,locale:n}){let i=(0,c.thisMonthKey)(),d=[{id:"all",name:r("finance.member.all"),role:"shared",color:void 0},{id:"shared",name:r("finance.member.shared"),role:"shared",color:void 0},...e.familyMembers.map((e,t)=>({...e,color:f(e,t)}))];return(0,a.jsx)(C,{role:"tablist","aria-label":r("finance.nav.ariaLabel"),children:d.map(r=>{let d=r.id===t,p=r.color??s.w4.colors.mainTextMuted,f=(0,c.monthlyTotalByMember)(e,r.id,i),g={id:r.id,name:r.name,role:r.role,color:r.color};return(0,a.jsxs)(A,{active:d,color:p,onClick:()=>o(r.id),type:"button",role:"tab","aria-selected":d,children:[(0,a.jsx)(l.eu,{member:g,size:20}),(0,a.jsx)("span",{children:r.name}),(0,a.jsx)(H,{children:`€${Math.round(f).toLocaleString("pt"===n?"pt-PT":"en-GB")}`})]},r.id)})})}},8989(e,t,o){o.d(t,{f:()=>b});var a=o(5723),r=o(7991),n=o(6859),i=o.n(n),s=o(9874),l=o(3400);function d(e,t){let[o,a]=e.split("-"),r=new Date(parseInt(o),parseInt(a)-1,1),n=r.toLocaleDateString("pt"===t?"pt-PT":"en-GB",{month:"short"}),i=n.charAt(0).toUpperCase()+n.slice(1).replace(".","");return 0===r.getMonth()?`${i} '${String(r.getFullYear()).slice(2)}`:i}let c=i().div`
  background: ${s.w4.colors.mainBg};
  border-bottom: 1px solid ${s.w4.colors.border};
  flex-shrink: 0;
  overflow: hidden;
...
`,m=i().div`
  ...
  opacity: 0.4;
  pointer-events: none;
`;function b({data:e,selectedMonth:t,onSelectMonth:o,locale:n}){let i=(0,r.useRef)(null),w=(0,r.useRef)(null),y=(0,r.useMemo)(()=>(function(){let e=[],t=new Date;for(let o=11;o>=0;o--){let a=new Date(t.getFullYear(),t.getMonth()-o,1);e.push(`${a.getFullYear()}-${String(a.getMonth()+1).padStart(2,"0")}`)}return e})(),[]),$=(0,r.useMemo)(()=>y.map(t=>(0,l.expensesForMonth)(e.expenses,t).reduce((e,t)=>e+t.amount,0)),[y,e.expenses]),v=e.budget.monthlyBudget,k=(0,r.useMemo)(()=>Math.max(...$,0),[$]),M=(0,r.useMemo)(()=>0===k||v<=0?-1:22+Math.round(28*Math.min(v/k,1)),[k,v]);return(0,r.useEffect)(()=>{let e=w.current,t=i.current;if(!e||!t)return;let o=e.offsetLeft,a=o+e.offsetWidth,r=t.scrollLeft,n=r+t.clientWidth;(o<r||a>n)&&t.scrollTo({left:o-t.clientWidth/2+e.offsetWidth/2,behavior:"smooth"})},[t]),(0,a.jsx)(c,{role:"navigation","aria-label":"Month picker",children:(0,a.jsxs)(p,{ref:i,children:[M>=0&&(0,a.jsx)(m,{bottom:M,role:"presentation","aria-hidden":!0}),y.map((e,r)=>{let i=$[r]??0,l=e===t,c=i>v&&v>0,p=k>0?Math.round(i/k*28):0,m=0;return c&&k>0&&v>0&&(m=Math.max(0,p-Math.round(v/k*28))),(0,a.jsxs)(f,{active:l,ref:l?w:void 0,onClick:()=>o(e),"aria-label":`${d(e,n)} — €${Math.round(i)}`,"aria-pressed":l,type:"button",children:[(0,a.jsx)(g,{"aria-hidden":!0,children:p>0?(0,a.jsx)(h,{height:p,color:"#7fb77e",active:l,children:m>0&&(0,a.jsx)(x,{height:m})}):(0,a.jsx)("div",{style:{width:"100%",height:2,background:s.w4.colors.border,borderRadius:2}})}),(0,a.jsx)(u,{active:l,children:d(e,n)})]},e)})]})})}},6579(e,t,o){o.d(t,{J:()=>f,j:()=>c});var a=o(5723),r=o(7991),n=o(6859),i=o.n(n),s=o(9874),l=o(8395),d=o(3400);function c(e,t=6,o=60){let a,r=((a=new Date).setDate(a.getDate()-o),a.toISOString().slice(0,10)),n={};for(let t of e)t.date>=r&&(n[t.categoryId]=(n[t.categoryId]??0)+1);let i=[...Object.entries(n).sort(([,e],[,t])=>t-e).map(([e])=>e)];for(let e of d.DEFAULT_CATEGORIES){if(i.length>=t)break;i.includes(e.id)||i.push(e.id)}return i.slice(0,t)}let p=i().div`
  display: flex;
  gap: ${s.w4.spacing.xs};
  overflow-x: auto;
...
`;function f({expenses:e,storedOrder:t,lockedCategoryId:o,onToggle:n,locale:i,groupLabel:s}){let g=(0,r.useMemo)(()=>(t&&t.length>0?t:c(e)).map(e=>d.DEFAULT_CATEGORIES.find(t=>t.id===e)).filter(e=>void 0!==e),[t,e]);return 0===g.length?null:(0,a.jsx)(p,{role:"group","aria-label":s,children:g.map(e=>{let t=o===e.id,r="pt"===i?e.labelPt:e.labelEn;return(0,a.jsxs)(l.vu,{variant:t?"selected":"default",dotColor:e.color,onClick:()=>n(e.id),"aria-pressed":t,"aria-label":`${r}${t?"pt"===i?" — selecionado":" — selected":""}`,title:r,children:[e.icon," ",r]},e.id)})})}},5854(e,t,o){o.d(t,{m:()=>M});var a=o(5723),r=o(7991),n=o(2727),i=o.n(n),s=o(6859),l=o.n(s),d=o(2799),c=o(9874),p=o(8395);let f=(0,d.keyframes)`
...
`,k=[{key:"n",descKey:"finance.shortcuts.newExpense"},{key:"/",descKey:"finance.shortcuts.search"},{key:"m",descKey:"finance.shortcuts.changeMember"},{key:"g",descKey:"finance.shortcuts.goToMonth"},{key:"?",descKey:"finance.shortcuts.openOverlay"},{key:"Esc",descKey:"finance.shortcuts.close"}];function M({t:e,onClose:t}){let o=(0,r.useRef)(null);return(0,r.useEffect)(()=>{let e=e=>{"Escape"===e.key&&(e.preventDefault(),e.stopPropagation(),t())};return document.addEventListener("keydown",e,!0),()=>document.removeEventListener("keydown",e,!0)},[t]),(0,r.useEffect)(()=>{o.current?.querySelector("[data-autofocus]")?.focus()},[]),i().createPortal((0,a.jsx)(g,{role:"dialog","aria-modal":"true","aria-label":e("finance.shortcuts.title"),onClick:e=>{e.target===e.currentTarget&&t()},children:(0,a.jsxs)(h,{ref:o,children:[(0,a.jsxs)(x,{children:[(0,a.jsx)(u,{children:e("finance.shortcuts.title")}),(0,a.jsx)(m,{onClick:t,"aria-label":e("finance.shortcuts.closeBtn"),"data-autofocus":"",children:"\xd7"})]}),(0,a.jsx)(v,{}),(0,a.jsx)(b,{children:k.map(({key:t,descKey:o})=>(0,a.jsxs)(w,{children:[(0,a.jsx)(y,{children:e(o)}),(0,a.jsx)($,{children:(0,a.jsx)(p.ue,{children:t})})]},t))}),(0,a.jsx)(v,{}),(0,a.jsx)("div",{style:{fontSize:11,fontFamily:c.w4.typography.fontFamilyMono,color:c.w4.colors.mainTextMuted,textTransform:"uppercase",letterSpacing:"0.12em"},children:e("finance.shortcuts.note")})]})}),document.body)}},7737(e,t,o){o.d(t,{n:()=>S});var a=o(5723),r=o(7991),n=o(6859),i=o.n(n),s=o(2799),l=o(9874),d=o(8170),c=o(8395),p=o(1496),f=o(3400),g=o(948);let h=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,x=i().div`
  background: ${l.w4.colors.surface};
...
`;function z(e){return e.toFixed(2)}function j(e){return 7===e?"finance.subs.cadence.weekly":365===e?"finance.subs.cadence.yearly":"finance.subs.cadence.monthly"}function T(e){return e.amount*(30/e.cadenceDays)}function S(){let[e]=(0,d.Ym)(),t=(0,r.useMemo)(()=>(0,d.Nx)(e,g.A),[e]),{candidates:o,monthlyTotal:n,cancelCandidates:i,loaded:s}=(0,f.useSubscriptions)();if(!s)return(0,a.jsxs)(x,{children:[(0,a.jsx)(c.YZ,{children:t("finance.subs.title")}),(0,a.jsx)(p.YG,{mode:"loading",label:t("loading")})]});if(0===o.length)return(0,a.jsxs)(x,{children:[(0,a.jsx)(c.YZ,{children:t("finance.subs.title")}),(0,a.jsx)(p.YG,{mode:"empty",label:t("finance.subs.empty")})]});let h=o.filter(e=>e.staleDays<=60).sort((e,t)=>T(t)-T(e)).slice(0,5);return(0,a.jsxs)(x,{children:[(0,a.jsxs)(u,{children:[(0,a.jsxs)("div",{children:[(0,a.jsx)(c.YZ,{children:t("finance.subs.title")}),(0,a.jsx)(b,{children:t("finance.subs.monthlyTotal")})]}),(0,a.jsxs)(m,{children:["€",z(n)]})]}),h.length>0&&(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(w,{children:t("finance.subs.activeHeader")}),h.map(e=>(0,a.jsx)(p.$8,{label:e.description,sub:(0,a.jsx)(c.Ex,{tone:"neutral",children:t(j(e.cadenceDays))}),value:(0,a.jsxs)(v,{children:["€",z(T(e)),(0,a.jsx)("span",{style:{fontSize:10,color:l.w4.colors.mainTextMuted},children:"/mo"})]})},e.id))]}),i.length>0&&(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(M,{}),(0,a.jsx)(y,{children:t("finance.subs.staleHeader")}),i.slice(0,5).map(e=>(0,a.jsx)(p.$8,{label:e.description,sub:(0,a.jsx)(c.Ex,{tone:"neutral",children:t(j(e.cadenceDays))}),value:(0,a.jsxs)($,{children:[(0,a.jsx)(k,{children:t("finance.subs.staleDays",{n:e.staleDays})}),(0,a.jsxs)(v,{children:["€",z(e.amount)]})]})},e.id))]})]})}},9546(e,t,o){o.d(t,{S:()=>x});var a=o(5723),r=o(7991),n=o(6859),i=o.n(n),s=o(2799),l=o(9874);let d=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(12px); }
  to   { opacity: 1; transform: translateY(0); }
`,c=(0,s.keyframes)`
...
`,b=n().forwardRef(function({variant:e="ghost",size:t="md",icon:o,iconRight:r,children:n,...i},s){return(0,a.jsxs)(m,{ref:s,variant:e,size:t,...i,children:[o,n,r]})}),w={default:l.w4.colors.accent,danger:"#f85149"},y={default:l.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"},$=s().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`,v=n().forwardRef(function({active:e=!1,shape:t="square",tone:o="default",children:r,...n},i){return(0,a.jsx)($,{ref:i,active:e,shape:t,tone:o,...n,children:r})});s().div`
  position: relative;
  display: inline-flex;
`,s().div`
  position: absolute;
...
`,A=s().span`
  ...
  line-height: 1;
  letter-spacing: 0;
`,H=["#3b82f6","#8b5cf6","#ec4899","#10b981","#f59e0b","#06b6d4"],R=0,D=new Map;function E({member:e,size:t=24}){var o,r;let n,i="shared"===e.id||"shared"===e.role,s=Math.floor(.55*t),d=t<=18?8:t<=22?9:t<=28?11:12;if(i)return(0,a.jsx)(C,{size:t,bg:l.w4.colors.surface,ring:!0,"aria-label":"Shared",title:"Shared",style:{color:l.w4.colors.mainTextMuted},children:(0,a.jsx)(F,{name:"home",size:s,"aria-hidden":!0})});let c=(o=e.id,(r=e.color)?r:(!D.has(o)&&(D.set(o,H[R%H.length]),R++),D.get(o))),p="adult"===e.role,f=(n=e.name.trim().split(/\s+/),((n[0]?.[0]??"")+(n[1]?.[0]??"")).toUpperCase().slice(0,2));return(0,a.jsx)(C,{size:t,bg:c,ring:p,title:e.name,children:(0,a.jsx)(A,{fontSize:d,children:f})})}s().img`
  width: ${({size:e})=>e}px;
  height: ${({size:e})=>e}px;
  border-radius: 50%;
  object-fit: cover;
...
`,O=s().span`
  ...
  background: ${({color:e})=>e};
  display: inline-block;
`,K=n().forwardRef(function({variant:e="default",dotColor:t,children:o,onClick:r,...n},i){return(0,a.jsxs)(N,{ref:i,variant:e,clickable:!!r,onClick:r,type:n.type??"button",...n,children:[t&&(0,a.jsx)(O,{color:t}),o]})}),I={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:l.w4.colors.accentMuted},Y={neutral:l.w4.colors.mainTextMuted,live:l.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:l.w4.colors.accent},V=s().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${l.w4.typography.fontFamilyMono};
...
`,W=s().span`
  ...
  display: inline-block;
`;function _({tone:e="neutral",dot:t,children:o,...r}){return(0,a.jsxs)(V,{tone:e,...r,children:[(t??"live"===e)&&(0,a.jsx)(W,{}),o]})}let q=s().kbd`
  font-family: ${l.w4.typography.fontFamilyMono};
  font-size: 10px;
  padding: 2px 6px;
  border: 1px solid ${l.w4.colors.border};
  ...
  white-space: nowrap;
`;function G({children:e,...t}){return(0,a.jsx)(q,{...t,children:e})}let U=s().div`
  font-family: ${l.w4.typography.fontFamilyMono};
  font-size: 11px;
  letter-spacing: 0.16em;
  text-transform: uppercase;
  ...
  align-items: center;
  gap: 8px;
`;function X({children:e,...t}){return(0,a.jsx)(U,{...t,children:e})}s().label`
  display: flex;
  align-items: center;
  gap: 10px;
...
`;function ea({title:e,accessory:t,accentColor:o,error:r,errorLabel:n,children:i}){return(0,a.jsxs)(Z,{accentColor:o,"data-widget-shell":!0,children:[(0,a.jsxs)(J,{children:[(0,a.jsx)(X,{children:e}),t&&(0,a.jsx)(Q,{children:t})]}),r?(0,a.jsxs)(et,{role:"alert",children:[(0,a.jsx)(eo,{children:n??"Error"}),(0,a.jsx)("div",{children:r})]}):(0,a.jsx)(ee,{children:i})]})}s().div`
  position: relative;
  display: flex;
  flex-direction: column;
  height: 100%;
...
`;let en="#7fb77e",ei=(0,j.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`;s().div`
  position: relative;
...
`},2188(e,t,o){o.d(t,{uj:()=>C,$8:()=>v,OW:()=>g,Xj:()=>O,ik:()=>M,Ru:()=>x,kl:()=>L,RT:()=>D,RJ:()=>j,YG:()=>p});var a=o(5723),r=o(6859),n=o.n(r),i=o(9874);let s=n().div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
`,d=n().p`
  ...
  margin: 0;
  line-height: 1.5;
`,c={loading:"◌ Loading",empty:"◎ Empty",error:"◎ Offline"};function p({mode:e,label:t,body:o}){return(0,a.jsxs)(s,{children:[(0,a.jsx)(l,{mode:e,children:t??c[e]}),o&&(0,a.jsx)(d,{children:o})]})}var f=o(7991);function g({points:e,accent:t=i.w4.colors.accent,width:o=60,height:r=28,strokeWidth:n=1.5}){let s=(0,f.useMemo)(()=>{if(e.length<2)return"";let t=Math.min(...e),a=Math.max(...e)-t||1,i=o-2*n,s=r-2*n;return e.map((o,r)=>{let l=n+r/(e.length-1)*i,d=n+s-(o-t)/a*s;return`${0===r?"M":"L"} ${l.toFixed(1)} ${d.toFixed(1)}`}).join(" ")},[e,o,r,n]),l=(0,f.useMemo)(()=>{if(e.length<1)return null;let t=e[e.length-1],a=Math.min(...e),i=o-2*n,s=r-2*n;return{x:n+i,y:n+s-(t-a)/(Math.max(...e)-a||1)*s}},[e,o,r,n]);return s?(0,a.jsxs)("svg",{width:o,height:r,viewBox:`0 0 ${o} ${r}`,"aria-hidden":"true",style:{display:"block",flexShrink:0},children:[(0,a.jsx)("path",{d:s,fill:"none",stroke:t,strokeWidth:n,strokeLinecap:"round",strokeLinejoin:"round",opacity:.7}),l&&(0,a.jsx)("circle",{cx:l.x,cy:l.y,r:n+1,fill:t})]}):null}let h=n().span`
  font-family: ${i.w4.typography.fontFamilyMono};
  font-size: 11px;
  font-weight: 500;
  font-variant-numeric: tabular-nums;
  ...
  white-space: nowrap;
`;function x({value:e,format:t="pct",decimals:o=2}){let r=e>0?"pos":e<0?"neg":"zero",n=Math.abs(e).toFixed(o);return(0,a.jsxs)(h,{sign:r,children:["pos"===r?"▲":"neg"===r?"▼":"—"," ",n,"pct"===t?"%":""]})}let u=n().div`
  display: flex;
  align-items: baseline;
  justify-content: space-between;
  gap: ${i.w4.spacing.sm};
...
`,$=n().span`
  ...
  flex-shrink: 0;
  text-align: right;
`;function v({label:e,value:t,sub:o,href:r,onClick:n}){let i=(0,a.jsxs)(a.Fragment,{children:[(0,a.jsxs)(b,{children:[(0,a.jsx)(w,{children:e}),o&&(0,a.jsx)(y,{children:o})]}),void 0!==t&&(0,a.jsx)($,{children:t})]});return r?(0,a.jsx)(m,{href:r,target:"_blank",rel:"noopener noreferrer",children:i}):(0,a.jsx)(u,{onClick:n,children:i})}o(3090);let k="'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, monospace";function M({data:e,budget:t,height:o=200,animation:r="rise"}){let n=(0,f.useId)();if(!e.length)return null;let s=1.1*Math.max(...e.map(e=>e.segments.reduce((e,t)=>e+t.value,0)+(e.over??0)),t??0)||1,l=472,d=o-20-24,c=472/e.length*.58,p=l/e.length,g="rise"===r?{transformOrigin:"bottom",animation:`${n}_rise 0.45s ease-out both`}:{};return(0,a.jsxs)(a.Fragment,{children:["rise"===r&&(0,a.jsx)("style",{children:`
          @keyframes ${n}_rise {
            from { transform: scaleY(0); }
            to   { transform: scaleY(1); }
          }
        `}),(0,a.jsxs)("svg",{viewBox:`0 0 520 ${o}`,style:{width:"100%",height:o},preserveAspectRatio:"xMidYMid meet","aria-hidden":"true",children:[null!=t?(0,a.jsxs)("g",{children:[(0,a.jsx)("line",{x1:40,x2:40+l,y1:20+d-t/s*d,y2:20+d-t/s*d,stroke:i.w4.colors.border,strokeDasharray:"3 3",strokeWidth:"1"}),(0,a.jsxs)("text",{x:36,y:20+d-t/s*d+3,textAnchor:"end",fontFamily:k,fontSize:"9",fill:i.w4.colors.mainTextMuted,children:["€",t]})]}):null,e.map((e,t)=>{let r,n=40+t*p+(p-c)/2,l=20+d;return(0,a.jsxs)("g",{style:g,children:[e.segments.map(e=>{let t=e.value/s*d;return l-=t,(0,a.jsx)("rect",{x:n,y:l,width:c,height:t,fill:e.color,opacity:.85},e.id)}),null!=e.over&&e.over>0?(r=e.over/s*d,l-=r,(0,a.jsx)("rect",{x:n,y:l,width:c,height:r,fill:"#f85149",opacity:.7},"over")):null,(0,a.jsx)("text",{x:n+c/2,y:o-6,textAnchor:"middle",fontFamily:k,fontSize:"10",fill:i.w4.colors.mainTextMuted,children:e.label})]},e.label)})]})]})}let z="'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, monospace";function j({data:e,total:t,size:o=110,thickness:r=14,centerLabel:n,centerValue:s}){let l=(0,f.useId)(),d=o/2-r/2-2,c=2*Math.PI*d,p=e.reduce((e,t)=>e+t.value,0)||1,g=0;return(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)("style",{children:`
        @keyframes ${l}_dash {
          from { stroke-dasharray: 0 ${c.toFixed(1)}; }
        }
      `}),(0,a.jsxs)("svg",{viewBox:`0 0 ${o} ${o}`,style:{width:o,height:o,flexShrink:0},"aria-hidden":"true",children:[(0,a.jsx)("circle",{cx:o/2,cy:o/2,r:d,fill:"none",stroke:i.w4.colors.border,strokeWidth:r}),e.map((e,t)=>{let n=e.value/p*c,i=60*t,s=(0,a.jsx)("circle",{cx:o/2,cy:o/2,r:d,fill:"none",stroke:e.color,strokeWidth:r,strokeDasharray:`${n.toFixed(1)} ${c.toFixed(1)}`,strokeDashoffset:(-g).toFixed(1),transform:`rotate(-90 ${o/2} ${o/2})`,style:{animation:`${l}_dash 0.45s ease-out ${i}ms both`}},t);return g+=n,s}),n?(0,a.jsx)("text",{x:o/2,y:o/2-4,textAnchor:"middle",fontFamily:z,fontSize:"9",fill:i.w4.colors.mainTextMuted,letterSpacing:"0.12em",textDecoration:"none",children:n.toUpperCase()}):null,s?(0,a.jsx)("text",{x:o/2,y:n?o/2+11:o/2+4,textAnchor:"middle",fontFamily:z,fontSize:"13",fontWeight:"700",fill:i.w4.colors.mainText,children:s}):null]})]})}let T="#7fb77e",S="#f85149";function F(e){let t=0;for(let o=1;o<e.length;o++){let a=e[o][0]-e[o-1][0],r=e[o][1]-e[o-1][1];t+=Math.sqrt(a*a+r*r)}return t}function C({data:e,height:t=170,legendIn:o,legendOut:r}){let n=(0,f.useId)();if(!e.length)return null;let s=288,l=t-10-32,d=1.1*Math.max(...e.map(e=>e.inc),...e.map(e=>e.exp))||1,c=s/Math.max(e.length-1,1),p=(0,f.useMemo)(()=>e.map((e,t)=>[6+t*c,10+l-e.inc/d*l]),[e,t]),g=(0,f.useMemo)(()=>e.map((e,t)=>[6+t*c,10+l-e.exp/d*l]),[e,t]),h=p.map(e=>e.join(",")).join(" "),x=g.map(e=>e.join(",")).join(" "),u=[`M${p[0][0]},${10+l}`,...p.map(e=>`L${e[0]},${e[1]}`),`L${p[p.length-1][0]},${10+l}`,"Z"].join(" "),m=F(p).toFixed(1),b=F(g).toFixed(1),w=e.reduce((e,t)=>e+t.inc,0),y=e.reduce((e,t)=>e+t.exp,0),$=e=>e>=1e3?`€${(e/1e3).toFixed(1)}k`:`€${Math.round(e)}`;return(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)("style",{children:`
        @keyframes ${n}_inc { from { stroke-dashoffset: ${m}; } }
        @keyframes ${n}_exp { from { stroke-dashoffset: ${b}; } }
      `}),(0,a.jsxs)("svg",{viewBox:`0 0 300 ${t}`,style:{width:"100%",height:t},preserveAspectRatio:"none","aria-hidden":"true",children:[(0,a.jsx)("path",{d:u,fill:T,opacity:.1}),(0,a.jsx)("polyline",{points:h,stroke:T,strokeWidth:"1.25",fill:"none",strokeLinecap:"round",strokeLinejoin:"round",strokeDasharray:m,strokeDashoffset:"0",style:{animation:`${n}_inc 0.5s ease-out both`}}),(0,a.jsx)("polyline",{points:x,stroke:S,strokeWidth:"1.25",fill:"none",strokeLinecap:"round",strokeLinejoin:"round",strokeDasharray:b,strokeDashoffset:"0",style:{animation:`${n}_exp 0.5s ease-out 0.1s both`}}),(0,a.jsx)("line",{x1:6,x2:6+s,y1:10+l,y2:10+l,stroke:i.w4.colors.border,strokeWidth:"1"}),(0,a.jsxs)("g",{fontFamily:"'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, monospace",fontSize:"10",style:{fontVariantNumeric:"tabular-nums"},children:[(0,a.jsxs)("text",{x:6,y:t-14,fill:T,children:["● ",o??"in"," ",$(w)]}),(0,a.jsxs)("text",{x:6+s/2+4,y:t-14,fill:S,children:["● ",r??"out"," ",$(y)]}),(0,a.jsx)("text",{x:6,y:t-2,fill:i.w4.colors.mainTextMuted,children:"90D"})]})]})]})}let A=["#1a2420","#2a4535","#4a7a5a","#6fa77a","#7fb77e"],H=["S","T","Q","Q","S","S","D"],R=["S","M","T","W","T","F","S"];function D({data:e,cellSize:t=10,gap:o=2,locale:r="pt"}){let n=(0,f.useId)();if(!e.length)return null;let s=24+Math.ceil(e.length/7)*(t+o),l=14+7*(t+o);return(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)("style",{children:`
        @keyframes ${n}_fade { from { opacity: 0; } to { opacity: 1; } }
      `}),(0,a.jsxs)("svg",{viewBox:`0 0 ${s} ${l}`,style:{width:"100%",height:"auto",maxHeight:l+4},"aria-hidden":"true",children:[(0,a.jsx)("g",{fontFamily:"'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, monospace",fontSize:"8",fill:i.w4.colors.mainTextMuted,children:("pt"===r?H:R).map((e,r)=>(0,a.jsx)("text",{x:"0",y:10+r*(t+o),children:e},r))}),e.map((e,r)=>{let i=18+Math.floor(r/7)*(t+o),s=2+r%7*(t+o),l=A[Math.max(0,Math.min(4,e))]??A[0];return(0,a.jsx)("rect",{x:i,y:s,width:t,height:t,fill:l,rx:"1",style:{animation:`${n}_fade 0.3s ease-out ${8*r}ms both`}},r)})]})]})}function E(e){let t=0;for(let o=1;o<e.length;o++){let a=e[o][0]-e[o-1][0],r=e[o][1]-e[o-1][1];t+=Math.sqrt(a*a+r*r)}return t}function L({spent:e,budget:t,height:o=60}){let r=(0,f.useId)(),n=1.05*t||1,s=Array.from({length:8},(e,o)=>t-t/7*o),l=Math.min(e/(t||1),1),d=Array.from({length:8},(e,o)=>Math.max(0,t-o/7*t*l*1.1)),c=s.map((e,t)=>[320*t/7,o-e/n*(o-5)]),p=d.map((e,t)=>[320*t/7,o-e/n*(o-5)]),g=c.map(e=>e.join(",")).join(" "),h=p.map(e=>e.join(",")).join(" "),x=E(c).toFixed(1),u=E(p).toFixed(1);return(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)("style",{children:`
        @keyframes ${r}_i { from { stroke-dashoffset: ${x}; } }
        @keyframes ${r}_a { from { stroke-dashoffset: ${u}; } }
      `}),(0,a.jsxs)("svg",{viewBox:`0 0 320 ${o}`,style:{width:"100%",height:o},preserveAspectRatio:"none","aria-hidden":"true",children:[(0,a.jsx)("line",{x1:"0",x2:320,y1:o-5,y2:o-5,stroke:i.w4.colors.border,strokeDasharray:"3 3",strokeWidth:"1"}),(0,a.jsx)("polyline",{points:g,stroke:i.w4.colors.mainTextMuted,strokeWidth:"1",strokeDasharray:`${x} ${x}`,strokeDashoffset:"0",fill:"none",style:{strokeDasharray:"2 3",animation:`${r}_i 0.45s ease-out both`}}),(0,a.jsx)("polyline",{points:h,stroke:"#7fb77e",strokeWidth:"1.5",strokeDasharray:`${u} ${u}`,strokeDashoffset:"0",fill:"none",strokeLinecap:"round",style:{animation:`${r}_a 0.45s ease-out 0.08s both`}})]})]})}let B=n().div`
  position: relative;
  height: 6px;
...
`,N=n().div`
  ...
  opacity: 0.7;
  transition: width 400ms ease;
`;function O({pct:e,over:t=0,color:o="#7fb77e"}){let r=Math.min(100,e),n=100-t;return(0,a.jsxs)(B,{children:[(0,a.jsx)(P,{pct:r,color:o}),t>0&&(0,a.jsx)(N,{left:Math.max(0,n),width:t})]})}o(8395),n().button`
  display: inline-flex;
  align-items: center;
  gap: 6px;
  padding: 0 10px;
