...
`,k=r.default.main`
  ...
  display: flex;
  flex-direction: column;
`,A=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function S(){return(0,i.jsx)(x,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:A.map((e,o)=>(0,i.jsx)(b,{index:o,accent:e.accent,children:e.char},o))})}const j="atlantis:sidebar-collapsed";function M({sidebar:e,children:o,topBarRight:n,title:r="Atlantis",activeId:l=null}){const[c,p]=(0,t.useState)(()=>{try{return"true"===localStorage.getItem(j)}catch{return!1}}),[f,x]=(0,t.useState)(null),b=(0,t.useRef)(),A=()=>p(e=>{const o=!e;try{localStorage.setItem(j,String(o))}catch{}return o}),M=t.useMemo(()=>t.lazy(()=>Promise.resolve().then(a.bind(a,74914)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,i.jsx)(d.I.Provider,{value:{collapsed:c,toggle:A,flyout:f,openFlyout:(e,o,a)=>{clearTimeout(b.current),x({entry:e,anchorY:o,onSelect:a})},scheduleFlyoutClose:()=>{b.current=setTimeout(()=>x(null),160)},cancelFlyoutClose:()=>clearTimeout(b.current)},children:(0,i.jsxs)($,{children:[(0,i.jsxs)(m,{children:[e&&(0,i.jsx)(g,{children:(0,i.jsx)(u,{onClick:A,title:c?"Expand sidebar":"Collapse sidebar",children:(0,i.jsx)(s.A,{size:17})})}),(0,i.jsx)(S,{}),r&&(0,i.jsx)(h,{children:r}),n&&(0,i.jsx)(w,{children:n})]}),(0,i.jsxs)(y,{children:[null!=e&&(0,i.jsx)(z,{collapsed:c,children:(0,i.jsx)(v,{children:e})}),(0,i.jsx)(k,{children:o})]}),f&&(0,i.jsx)(t.Suspense,{fallback:null,children:(0,i.jsx)(M,{activeId:l})})]})})}a(65185),r.default.div`
  display: grid;
...
`,V=r.default.div`
  ...
  color: ${n.w4.colors.sidebarTextMuted};
  font-family: ${n.w4.typography.fontFamily};
`;function q({onSave:e,onUpdate:o,onCancel:a,existingDoc:n}){const[r,l]=(0,t.useState)(n?.name??""),s=(0,t.useRef)(null);return(0,t.useEffect)(()=>{s.current?.focus(),n&&s.current?.select()},[n]),(0,i.jsx)(G,{onClick:a,children:(0,i.jsxs)(K,{onClick:e=>e.stopPropagation(),children:[(0,i.jsx)(W,{children:"Save document"}),n&&o&&(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(V,{children:"Update the current version or save as a new one."}),(0,i.jsxs)(Y,{children:[(0,i.jsx)(U,{onClick:a,children:"Cancel"}),(0,i.jsxs)(U,{danger:!0,onClick:o,children:['Update "',n.name,'"']})]}),(0,i.jsx)(_,{})]}),(0,i.jsx)(O,{ref:s,value:r,onChange:e=>l(e.target.value),onKeyDown:t=>{"Enter"===t.key&&r.trim()&&(n&&r.trim()===n.name&&o?o():e(r.trim())),"Escape"===t.key&&a()},placeholder:n?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,i.jsxs)(Y,{children:[!n&&(0,i.jsx)(U,{onClick:a,children:"Cancel"}),(0,i.jsx)(U,{primary:!0,disabled:!r.trim(),onClick:()=>e(r.trim()),children:"Save as new"})]})]})})}var J=a(18006),Z=a(70679),X=a(54872);const Q=r.default.div`
  position: relative;
`,ee=r.default.button`
  display: flex;
  align-items: center;
...
`;function ce({appId:e,onLoad:o}){const[a,n]=(0,t.useState)(!1),[r,l]=(0,t.useState)([]),s=(0,t.useRef)(null),d=(0,t.useCallback)(()=>{(function(e){return L.listDocs(e)})(e).then(l).catch(()=>{})},[e]);(0,t.useEffect)(()=>{if(!a)return;d();const e=e=>{s.current&&!s.current.contains(e.target)&&n(!1)};return document.addEventListener("mousedown",e),()=>document.removeEventListener("mousedown",e)},[a,d]);return(0,i.jsxs)(Q,{ref:s,children:[(0,i.jsxs)(ee,{onClick:()=>n(e=>!e),children:[(0,i.jsx)(J.A,{size:14}),"Saved",(0,i.jsx)(Z.A,{size:13,style:{marginLeft:2}})]}),(0,i.jsxs)(oe,{open:a,children:[(0,i.jsx)(ae,{children:"Saved versions"}),(0,i.jsx)(ne,{children:0===r.length?(0,i.jsx)(te,{children:"No saved documents yet."}):r.map(e=>{return(0,i.jsxs)(re,{children:[(0,i.jsxs)(ie,{onClick:()=>{o(e.content,e.id,e.name),n(!1)},children:[(0,i.jsx)(le,{children:e.name}),(0,i.jsx)(se,{children:(a=e.savedAt,new Intl.DateTimeFormat(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}).format(new Date(a)))})]}),(0,i.jsx)(de,{onClick:o=>(async(e,o)=>{e.stopPropagation(),await function(e){return L.deleteDoc(e)}(o),l(e=>e.filter(e=>e.id!==o))})(o,e.id),title:"Delete",children:(0,i.jsx)(X.A,{size:13})})]},e.id);var a})})]})]})}new Set([10751]),new Set([27]),r.default.div`
...
`,w=t.default.span`
  ...
  font-family: ${s.w4.typography.fontFamily};
  writing-mode: vertical-rl;
`;function y({code:e,collapsed:o,onToggleCollapse:a}){const[t,s]=(0,n.useState)(""),[p,y]=(0,n.useState)(null),$=(0,n.useRef)(0),z=(0,n.useCallback)(async e=>{if(!e.trim())return s(""),void y(null);const o=++$.current;try{const a="mermaid-"+Date.now(),{svg:n}=await d.default.render(a,e);$.current===o&&(s(n),y(null))}catch(e){$.current===o&&(y(e instanceof Error?e.message:String(e)),s(""))}},[]);return(0,n.useEffect)(()=>{const o=setTimeout(()=>z(e),300);return()=>clearTimeout(o)},[e,z]),o?(0,c.jsxs)(h,{onClick:a,title:"Show preview",children:[(0,c.jsx)(l.A,{size:14}),(0,c.jsx)(w,{children:"Preview"})]}):(0,c.jsxs)(m,{children:[(0,c.jsxs)(g,{children:[(0,c.jsx)(u,{children:"Preview"}),(0,c.jsx)(f,{onClick:a,title:"Collapse preview",children:(0,c.jsx)(i.A,{size:15})})]}),p&&(0,c.jsxs)(b,{children:[(0,c.jsx)(r.A,{size:14,style:{flexShrink:0,marginTop:1}}),p]}),(0,c.jsx)(x,{dangerouslySetInnerHTML:{__html:t}})]})}},51036(e,o,a){a.d(o,{r:()=>be});var n=a(27359),t=a(28976),r=a(18055),i=a(14944),l=a(39895),s=a(6930),d=(a(61385),a(53233)),c=a(49881),p=a(13045),m=a(26879),g=a(65723);d.default.nav`padding: ${m.w4.spacing.sm} 0;`,d.default.div`
...
`,x=d.default.pre`
  ...
  white-space: pre-wrap;
`;let b=!1;function h({code:e}){const o=(0,n.useRef)(null),[t,r]=(0,n.useState)(null),[i,l]=(0,n.useState)(!1);return(0,n.useEffect)(()=>{let n=!1;if(r(null),l(!1),!e.trim())return void l(!0);const t=e.trim().split(/\r?\n/)[0]?.trim()??"";if(/^(?:---[\s\S]*?---\s*)?(?:graph|flowchart|sequenceDiagram|classDiagram|stateDiagram(?:-v2)?|erDiagram|pie|gantt|journey|mindmap|gitGraph|sankey(?:-beta)?|quadrantChart|requirementDiagram|timeline|xychart-beta|block-beta|C4Context|C4Container|C4Component|C4Dynamic|C4Deployment)\b/.test(t))return async function(){const t=(await Promise.resolve().then(a.bind(a,30774))).default;if(b||(t.initialize({startOnLoad:!1,theme:"dark",themeVariables:{background:m.w4.colors.codeBg,primaryColor:m.w4.colors.accent,primaryTextColor:m.w4.colors.mainText,lineColor:m.w4.colors.border}}),b=!0),o.current&&!n)try{const a=`mermaid-${Math.random().toString(36).slice(2)}`,{svg:r}=await t.render(a,e);if(n||!o.current)return;o.current.innerHTML=r,requestAnimationFrame(()=>{if(n||!o.current)return;const e=o.current.querySelector("svg");if(!e)return void l(!0);const a=e.getBoundingClientRect();(a.width<40||a.height<40)&&l(!0)})}catch(e){n||r(e instanceof Error?e.message:String(e))}}(),()=>{n=!0};l(!0)},[e]),t?(0,g.jsx)(u,{children:(0,g.jsxs)(f,{children:["Mermaid error: ",t]})}):i?(0,g.jsx)(x,{children:e.trim()}):(0,g.jsx)(u,{ref:o})}const w=["#388bfd","#3fb950","#d29922","#a371f7","#f87171","#22d3ee","#fb923c","#34d399","#f472b6","#818cf8"],y=d.default.div`
  background: ${m.w4.colors.codeBg};
  border: 1px solid ${m.w4.colors.codeBorder};
  border-radius: ${m.w4.borderRadius.md};
  padding: ${m.w4.spacing.lg};
...
`,d.default.span`
  font-size: ${m.w4.typography.fontSizeBase};
  color: ${m.w4.colors.mainTextMuted};
`;var Y=a(68383),U=a(21426),_=a(25609),V=a(20320);const q=d.default.div`
  margin: ${m.w4.spacing.lg} 0;
  border-radius: ${m.w4.borderRadius.md};
  border: 1px solid ${m.w4.colors.codeBorder};
  overflow: hidden;
...
`,Q={...U.A,'pre[class*="language-"]':{...U.A['pre[class*="language-"]'],background:m.w4.colors.codeBg,margin:0,padding:"18px 20px",fontSize:"13px",lineHeight:"1.6",borderRadius:0},'code[class*="language-"]':{...U.A['code[class*="language-"]'],background:"none",fontSize:"13px"}};function ee({lang:e="text",code:o}){const[a,t]=(0,n.useState)(!1);return(0,g.jsxs)(q,{children:[(0,g.jsxs)(J,{children:[(0,g.jsx)(Z,{children:e}),(0,g.jsxs)(X,{copied:a,onClick:()=>{navigator.clipboard.writeText(o).then(()=>{t(!0),setTimeout(()=>t(!1),2e3)})},children:[a?(0,g.jsx)(_.A,{size:12}):(0,g.jsx)(V.A,{size:12}),a?"Copied!":"Copy"]})]}),(0,g.jsx)(Y.A,{language:e,style:Q,showLineNumbers:o.split("\n").length>8,lineNumberStyle:{color:"#484f58",minWidth:"2.5em",paddingRight:"1.5em",userSelect:"none",fontSize:"12px"},customStyle:{margin:0,background:m.w4.colors.codeBg},wrapLongLines:!1,children:o})]})}var oe=a(65569),ae=a(8218),ne=a(57230),te=a(22966),re=a(21069);oe.A,ae.A,ne.A,te.A,re.A,d.default.div`
  background: ${({bg:e})=>e};
...
`,d.default.span`
  ...
  font-weight: 600;
  margin-left: auto;
`,new Map;const de=d.default.div`
  display: flex;
  flex-direction: column;
  flex: 1;
  min-width: 0;
...
`,xe=d.default.span`
  ...
  font-family: ${m.w4.typography.fontFamily};
  writing-mode: vertical-rl;
`;function be({content:e,collapsed:o,onToggleCollapse:a,scrollRef:n,onScroll:d}){return o?(0,g.jsxs)(fe,{onClick:a,title:"Show preview",children:[(0,g.jsx)(c.A,{size:14}),(0,g.jsx)(xe,{children:"Preview"})]}):(0,g.jsxs)(de,{children:[(0,g.jsxs)(ce,{children:[(0,g.jsx)(pe,{children:"Preview"}),(0,g.jsx)(me,{onClick:a,title:"Collapse preview",children:(0,g.jsx)(p.A,{size:15})})]}),(0,g.jsx)(ge,{ref:n,onScroll:d,children:(0,g.jsx)(ue,{children:(0,g.jsx)(t.oz,{remarkPlugins:[r.A,i.A,se],rehypePlugins:[l.A,s.A],components:{div({node:e,children:o,...a}){const n=a["data-callout"];return n?(0,g.jsx)("div",{"data-callout":n,children:o}):(0,g.jsx)("div",{...a,children:o})},pre:({children:e})=>(0,g.jsx)(g.Fragment,{children:e}),code({className:e,children:o}){const a=/language-(\w+)/.exec(e??"")?.[1],n=String(o).replace(/\n$/,"");return"mermaid"===a?(0,g.jsx)(h,{code:n}):"chart"===a?(0,g.jsx)(B,{code:n}):"clock"===a?(0,g.jsx)(G,{code:n}):a||n.includes("\n")?(0,g.jsx)(ee,{lang:a,code:n}):(0,g.jsx)("code",{className:e,children:o})}},children:e})})})]})}}}]);
//# sourceMappingURL=1714.167217f86823a2bd539a.js.map