...
`,X=n().div`
  ...
  align-items: center;
  gap: ${d.w4.spacing.sm};
`,N={pt:"O que vamos aprender hoje?",en:"What shall we learn today?"},C={pt:"Escolhe uma disciplina para come\xe7ar",en:"Pick a subject to get started"};function L({topBarRight:e}){let[a,t]=(0,i.useState)(g),[r]=(0,p.Ym)(),n="pt"===r?"pt":"en";if((0,i.useEffect)(()=>{let e=()=>t(g());return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[]),!a)return(0,o.jsx)(c.PE,{title:"School",sidebar:null,topBarRight:e,children:(0,o.jsxs)(f,{children:[S.map((e,a)=>(0,o.jsx)(z,{x:e.x,y:e.y,size:e.size,delay:e.delay,dur:e.dur},a)),(0,o.jsx)(T,{top:15,delay:12}),(0,o.jsx)(T,{top:55,delay:25}),(0,o.jsx)(b,{children:N[n]}),(0,o.jsx)(y,{children:C[n]}),(0,o.jsx)(k,{children:"pt"===n?"Disciplinas":"Subjects"}),(0,o.jsx)($,{columns:4,children:m.map((e,a)=>(0,o.jsxs)(P,{accentColor:e.color,onClick:()=>{t(e.key),window.location.hash=`#/${e.hashPrefix}`},children:[(0,o.jsx)(E,{className:"card-emoji",delay:.4*a,children:e.emoji}),(0,o.jsx)(M,{children:e.label[n]}),(0,o.jsx)(Y,{children:e.description[n]})]},e.key))})]})});let s=(0,o.jsxs)(X,{children:[(0,o.jsxs)(R,{onClick:()=>{t(null),window.location.hash="#/school"},children:["←",(0,o.jsxs)("span",{className:"back-label",children:[" ","pt"===n?"Disciplinas":"Subjects"]})]}),e]}),d=m.find(e=>e.key===a);return(0,o.jsx)(l.WO,{hashPrefix:d.hashPrefix,defaultLang:"pt",locale:r,languages:d.languages,welcomeTitle:d.welcomeTitle,welcomeSub:d.welcomeSub,topBarRight:s},a)}}}]);