...
`,ie={genres:[],providerIds:[],decades:[]};function oe({topBarRight:e,apiKey:t}){const[i]=(0,a.xc)();(0,y.zJ)(i.ageMode);const[r,n]=(0,o.useState)(()=>S(t)),[l,d]=(0,o.useState)("discover"),[c,p]=(0,o.useState)(ie),[g,f]=(0,o.useState)(!1),[T,z]=(0,o.useState)([]),[oe,re]=(0,o.useState)([]),[ne,ae]=(0,o.useState)(0),[se,le]=(0,o.useState)(null),de=(0,o.useCallback)(e=>{e&&history.pushState({movieDetail:!0},""),le(e)},[]);(0,o.useEffect)(()=>{const e=()=>{se&&le(null)};return window.addEventListener("popstate",e),()=>window.removeEventListener("popstate",e)},[se]);const[ce,pe]=(0,o.useState)(0),[ge,xe]=(0,o.useState)(""),[ue,fe]=(0,o.useState)([]),[me,he]=(0,o.useState)(!1),be=(0,o.useRef)(),we=(0,o.useRef)(),ve=(0,o.useCallback)(()=>pe(e=>e+1),[]);(0,o.useEffect)(()=>{n(S(t))},[t]),(0,o.useEffect)(()=>{if(!(oe.length<2))return we.current=setInterval(()=>{ae(e=>(e+1)%oe.length)},7e3),()=>clearInterval(we.current)},[oe.length]),(0,o.useEffect)(()=>{r&&(clearTimeout(be.current),ge.trim()?(he(!0),be.current=setTimeout(async()=>{try{const e=await(0,y.$P)(r,ge.trim());fe(e)}catch{fe([])}finally{he(!1)}},380)):fe([]))},[r,ge]);const ye=c.genres.length>0||c.providerIds.length>0||c.decades.length>0,ke=(0,o.useCallback)(async(e,t,i)=>{if("favorites"===t){const e=(0,k.qx)();return void z([{title:"My Favorites",items:e,loading:!1}])}if("seen"===t){const e=(0,k.GB)();return void z([{title:"Recently Seen",items:e,loading:!1}])}if(i.genres.length>0||i.providerIds.length>0||i.decades.length>0){const o="movies"===t?"movie":"tv"===t?"tv":"documentaries"===t?"movie":"all",r="documentaries"===t?[...i.genres,99]:i.genres,n=r.length>0?r:[28,35,18,878,27,10749,53,16],a=n.map(e=>({title:y.N2[e]??"Other",items:[],loading:!0}));z(a);const s=await Promise.all(n.map(t=>(0,y.NE)(e,o,{...i,genres:[t]}))),l=n.map((e,t)=>({title:y.N2[e]??"Other",items:s[t]??[],loading:!1})).filter(e=>e.items.length>0);return void z(l.length>0?l:[{title:"No Results",items:[],loading:!1}])}if("documentaries"===t){z([{title:"Documentaries",items:[],loading:!0}]);const t=await(0,y.ag)(e);return void z([{title:"Documentaries",items:t,loading:!1}])}if("movies"===t){z([{title:"Popular Movies",items:[],loading:!0},{title:"Top Rated Movies",items:[],loading:!0}]);const[t,i]=await Promise.all([(0,y.Zy)(e),(0,y.Kk)(e,"movie")]);return void z([{title:"Popular Movies",items:t,loading:!1},{title:"Top Rated Movies",items:i,loading:!1}])}if("tv"===t){z([{title:"Popular TV Shows",items:[],loading:!0},{title:"Top Rated TV Shows",items:[],loading:!0}]);const[t,i]=await Promise.all([(0,y.eN)(e),(0,y.Kk)(e,"tv")]);return void z([{title:"Popular TV Shows",items:t,loading:!1},{title:"Top Rated TV Shows",items:i,loading:!1}])}const o=function(e,t=2){const i={};for(const t of e)for(const e of t.genre_ids??[])i[e]=(i[e]??0)+1;return Object.entries(i).sort((e,t)=>Number(t[1])-Number(e[1])).slice(0,t).map(([e])=>Number(e))}([...(0,k.qx)(),...(0,k.GB)()],2),r=[{title:"Trending This Week",loading:!0,items:[]},{title:"Popular Movies",loading:!0,items:[]},{title:"Popular TV Shows",loading:!0,items:[]},{title:"Top Rated Movies",loading:!0,items:[]},{title:"Documentaries",loading:!0,items:[]},...o.map(e=>({title:`More ${y.N2[e]??"Great"} Content`,loading:!0,items:[]}))];z(r);const[n,a,s,l,d,...c]=await Promise.all([(0,y._F)(e),(0,y.Zy)(e),(0,y.eN)(e),(0,y.Kk)(e,"movie"),(0,y.ag)(e),...o.map(t=>(0,y.NE)(e,"all",{genres:[t],providerIds:[],decades:[]}))]),p=n.filter(e=>e.backdrop_path).slice(0,5);re(p),ae(0),z([{title:"Trending This Week",items:n,loading:!1},{title:"Popular Movies",items:a,loading:!1},{title:"Popular TV Shows",items:s,loading:!1},{title:"Top Rated Movies",items:l,loading:!1},{title:"Documentaries",items:d,loading:!1},...o.map((e,t)=>({title:`More ${y.N2[e]??"Great"} Content`,items:c[t]??[],loading:!1}))])},[]);(0,o.useEffect)(()=>{r&&("discover"!==l&&re([]),ke(r,l,c).catch(()=>{}))},[r,l,c,ke,ce,i.ageMode]);const je=(0,o.useCallback)(e=>{d(e),xe("")},[]),$e=(0,o.useCallback)(e=>{p(e)},[]),Te=ge.trim().length>0,Se=oe[ne]??null,Me=("favorites"===l||"seen"===l)&&!T[0]?.loading&&0===T[0]?.items.length,ze=c.genres.length+c.providerIds.length+c.decades.length;if(!r)return(0,j.jsx)(h.H,{onSave:e=>{!function(e){try{localStorage.setItem($,e)}catch{}}(e),n(e)}});const Ce=(0,j.jsxs)(U,{children:[(0,j.jsx)(x.A,{size:14,color:a.w4.colors.mainTextMuted}),(0,j.jsx)(Y,{placeholder:"Search…",value:ge,onChange:e=>xe(e.target.value)}),ge&&(0,j.jsx)(Z,{onClick:()=>xe(""),"aria-label":"Clear",children:(0,j.jsx)(m.A,{size:13})})]});if(se){const t=(0,j.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:8},children:[(0,j.jsxs)("button",{onClick:()=>history.back(),title:"Back",style:{display:"flex",alignItems:"center",gap:6,padding:"5px 14px",background:"none",border:`1px solid ${a.w4.colors.border}`,borderRadius:a.w4.borderRadius.md,color:a.w4.colors.sidebarTextMuted,cursor:"pointer",fontSize:a.w4.typography.fontSizeSm,fontFamily:a.w4.typography.fontFamily,fontWeight:500,transition:"color 0.15s, border-color 0.15s"},onMouseEnter:e=>{e.currentTarget.style.color=a.w4.colors.mainText,e.currentTarget.style.borderColor=a.w4.colors.mainText},onMouseLeave:e=>{e.currentTarget.style.color=a.w4.colors.sidebarTextMuted,e.currentTarget.style.borderColor=a.w4.colors.border},children:[(0,j.jsx)(s.A,{size:14})," Back"]}),e]});return(0,j.jsx)(a.PE,{title:(0,y.rS)(se),sidebar:null,topBarRight:t,children:(0,j.jsx)(w.P,{item:se,apiKey:r,onBack:()=>history.back(),onLibraryChange:ve,onSelect:de})})}return(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(a.PE,{title:"Movies & Series",sidebar:null,topBarRight:(0,j.jsxs)(j.Fragment,{children:[Ce,e]}),children:(0,j.jsxs)(C,{children:[(0,j.jsxs)(G,{children:[M.map(({id:e,label:t,Icon:i})=>(0,j.jsxs)(L,{active:l===e,onClick:()=>je(e),children:[(0,j.jsx)(i,{size:14}),t]},e)),(0,j.jsx)(O,{children:(0,j.jsxs)(W,{hasFilters:ze>0,onClick:()=>f(!0),children:[(0,j.jsx)(u.A,{size:13}),"Filter",ze>0&&(0,j.jsx)(q,{children:ze})]})})]}),Te?(0,j.jsxs)(H,{children:[(0,j.jsx)(J,{children:(0,j.jsx)(Q,{children:me?"Searching…":ue.length>0?`Results for "${ge}"`:`No results for "${ge}"`})}),me||0!==ue.length?(0,j.jsx)(b.U,{title:"",items:ue,loading:me,onSelect:de}):(0,j.jsxs)(X,{children:[(0,j.jsx)("span",{style:{fontSize:44},children:"🔍"}),"Nothing found — try a different title"]})]}):(0,j.jsxs)(H,{children:["discover"===l&&Se&&!ye&&(0,j.jsx)(I,{children:oe.map((e,t)=>{const i=e.backdrop_path?`https://image.tmdb.org/t/p/w1280${e.backdrop_path}`:"";return(0,j.jsx)(_,{src:i,active:t===ne,children:(0,j.jsxs)(N,{children:[(0,j.jsx)(R,{kind:e.media_type,children:"movie"===e.media_type?"Film":"TV Show"}),(0,j.jsx)(P,{children:(0,y.rS)(e)}),(0,j.jsxs)(F,{children:[(0,j.jsxs)(E,{children:["★ ",e.vote_average.toFixed(1)]}),(e.release_date||e.first_air_date)&&(0,j.jsx)(A,{children:(e.release_date??e.first_air_date??"").slice(0,4)})]}),e.overview&&(0,j.jsx)(B,{children:e.overview}),(0,j.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:12},children:[(0,j.jsx)(D,{onClick:()=>de(e),children:"▶ More Info"}),(0,j.jsx)(V,{children:oe.map((e,t)=>(0,j.jsx)(K,{active:t===ne,onClick:()=>{clearInterval(we.current),ae(t)}},t))})]})]})},e.id)})}),ye&&(0,j.jsxs)(ee,{children:[(0,j.jsx)("span",{style:{fontSize:12,color:a.w4.colors.mainTextMuted},children:"Active filters:"}),c.genres.map(e=>(0,j.jsx)(te,{children:y.N2[e]??e},e)),c.providerIds.map(e=>(0,j.jsx)(te,{children:y.Mw.find(t=>t.id===e)?.name??e},e)),c.decades.map(e=>(0,j.jsx)(te,{children:e},e)),(0,j.jsx)("button",{style:{background:"none",border:"none",color:a.w4.colors.mainTextMuted,fontSize:11,cursor:"pointer",textDecoration:"underline"},onClick:()=>p(ie),children:"Clear all"})]}),"discover"!==l&&(0,j.jsx)(J,{children:(0,j.jsx)(Q,{children:M.find(e=>e.id===l)?.label??""})}),Me?(0,j.jsxs)(X,{children:[(0,j.jsx)("span",{style:{fontSize:44},children:"favorites"===l?"❤️":"👁️"}),"favorites"===l?"No favorites yet — open any title and hit ❤️":"No seen titles yet — mark a title as seen to track it here"]}):T.map(e=>(0,j.jsx)(b.U,{title:e.title,items:e.items,loading:e.loading,onSelect:de},e.title))]},l)]})}),g&&(0,j.jsx)(v.K,{filters:c,onChange:$e,onClose:()=>f(!1)})]})}}}]);
//# sourceMappingURL=36.58b3f5038b0cbe7e9e34.js.map