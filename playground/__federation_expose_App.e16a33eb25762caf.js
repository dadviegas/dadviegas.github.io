"use strict";(self.webpackChunk_atlantis_playground=self.webpackChunk_atlantis_playground||[]).push([["362"],{3935(e,t,r){r.r(t),r.d(t,{default:()=>A});var s=r(5723),o=r(7991),n=r(6859),a=r.n(n),i=r(2799),l=r(6063),c=r(3501),d=r(5643),p=r.n(d),h=r(5151),u=r(676);let m=p()??d,f=`You are a code generator. The user describes what they want and you return ONLY a JSON object with the code. No explanation, no markdown fences, no extra text — just the raw JSON.
