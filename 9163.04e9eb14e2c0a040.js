...
`,t7=s().span`
  ...
  font-size: ${l.w4.typography.fontSizeSm};
  letter-spacing: 0.04em;
`;function t9({label:e="Loading…"}){return(0,i.jsxs)(t5,{children:[(0,i.jsxs)(t3,{children:[(0,i.jsx)(t8,{delay:0,size:8,color:l.w4.colors.accent}),(0,i.jsx)(t8,{delay:-.45,size:6,color:"#bc8cff"}),(0,i.jsx)(t8,{delay:-.9,size:5,color:"#3fb950"}),(0,i.jsx)(t6,{})]}),(0,i.jsx)(t7,{children:e})]})}s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
