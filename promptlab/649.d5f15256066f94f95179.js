"use strict";(self.webpackChunk_atlantis_promptlab=self.webpackChunk_atlantis_promptlab||[]).push([[649],{4914(e,o,a){a.d(o,{FlyoutPanel:()=>b});var n=a(7359),t=a(3233),i=a(7207),r=a(255),l=a(217),s=a(5959),c=a(5185),d=a(5723);const m=i.keyframes`
...
`,$=i.default.main`
  ...
  display: flex;
  flex-direction: column;
`,k=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function j(){return(0,r.jsx)(y,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:k.map((e,o)=>(0,r.jsx)(b,{index:o,accent:e.accent,children:e.char},o))})}const S="atlantis:sidebar-collapsed";function M({sidebar:e,children:o,topBarRight:n,title:i="Atlantis",activeId:l=null}){const[d,m]=(0,t.useState)(()=>{try{return"true"===localStorage.getItem(S)}catch{return!1}}),[p,y]=(0,t.useState)(null),b=(0,t.useRef)(),k=()=>m(e=>{const o=!e;try{localStorage.setItem(S,String(o))}catch{}return o}),M=t.useMemo(()=>t.lazy(()=>Promise.resolve().then(a.bind(a,4914)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(c.I.Provider,{value:{collapsed:d,toggle:k,flyout:p,openFlyout:(e,o,a)=>{clearTimeout(b.current),y({entry:e,anchorY:o,onSelect:a})},scheduleFlyoutClose:()=>{b.current=setTimeout(()=>y(null),160)},cancelFlyoutClose:()=>clearTimeout(b.current)},children:(0,r.jsxs)(w,{children:[(0,r.jsxs)(u,{children:[e&&(0,r.jsx)(g,{children:(0,r.jsx)(f,{onClick:k,title:d?"Expand sidebar":"Collapse sidebar",children:(0,r.jsx)(s.A,{size:17})})}),(0,r.jsx)(j,{}),i&&(0,r.jsx)(x,{children:i}),n&&(0,r.jsx)(h,{children:n})]}),(0,r.jsxs)(z,{children:[null!=e&&(0,r.jsx)(A,{collapsed:d,children:(0,r.jsx)(v,{children:e})}),(0,r.jsx)($,{children:o})]}),p&&(0,r.jsx)(t.Suspense,{fallback:null,children:(0,r.jsx)(M,{activeId:l})})]})})}a(5185),i.default.div`
  display: grid;
...
`,z=t.default.p`
  ...
  text-align: center;
  margin: 0;
`;function w({onSave:e}){const[o,a]=(0,n.useState)(""),[t,i]=(0,n.useState)(""),w=Boolean(o.trim()||t.trim());return(0,s.jsx)(c,{children:(0,s.jsxs)(d,{children:[(0,s.jsx)(m,{children:"🧠"}),(0,s.jsx)(u,{children:"Prompt Lab"}),(0,s.jsx)(g,{children:"Enter at least one API key to get started. Keys are stored locally in your browser — never sent to our servers."}),l.x.map(e=>{const n="groq"===e.id?o:t,l="groq"===e.id?a:i;return(0,s.jsxs)(f,{children:[(0,s.jsxs)(p,{children:[(0,s.jsx)(y,{children:e.label}),(0,s.jsxs)(b,{href:e.url,target:"_blank",rel:"noopener noreferrer",children:["Get key ",(0,s.jsx)(r.A,{size:11})]})]}),(0,s.jsx)(x,{type:"password",placeholder:`Paste your ${e.label} API key`,value:n,onChange:e=>l(e.target.value)})]},e.id)}),(0,s.jsx)(h,{disabled:!w,onClick:()=>{w&&e({groq:o.trim(),gemini:t.trim()})},children:"Get Started"}),(0,s.jsx)(z,{children:"You can add more keys later in Settings."})]})})}},891(e,o,a){a.d(o,{W:()=>b});var n=a(7359),t=a(3233),i=a(9200),r=a(679),l=a(9753),s=a(6135),c=a(5723);const d=t.default.div`
  display: flex;
  flex-direction: column;
  gap: ${i.w4.spacing.md};
  height: 100%;
...
`,y=t.default.div`
  ...
  text-transform: uppercase;
  letter-spacing: 0.06em;
`;function b({systemPrompt:e,userPrompt:o,onSystemChange:a,onUserChange:t,onRun:i,running:u,canRun:b}){const[x,h]=(0,n.useState)(Boolean(e));return(0,c.jsxs)(d,{children:[(0,c.jsxs)(m,{onClick:()=>h(e=>!e),children:[x?(0,c.jsx)(r.A,{size:14}):(0,c.jsx)(l.A,{size:14}),"System Prompt"]}),x&&(0,c.jsx)(g,{placeholder:"Optional system prompt...",value:e,onChange:e=>a(e.target.value)}),(0,c.jsx)(y,{children:"User Prompt"}),(0,c.jsx)(f,{placeholder:"Enter your prompt here...",value:o,onChange:e=>t(e.target.value),onKeyDown:e=>{"Enter"===e.key&&(e.metaKey||e.ctrlKey)&&b&&!u&&(e.preventDefault(),i())}}),(0,c.jsxs)(p,{disabled:!b||u,onClick:i,children:[(0,c.jsx)(s.A,{size:14}),u?"Running...":"Run"]})]})}},1881(e,o,a){a.d(o,{c:()=>k});var n=a(3233),t=a(7207),i=a(9200),r=a(5609),l=a(320),s=a(7359),c=a(7782),d=a(5723);const m=t.keyframes`
  0%, 100% { opacity: 1; }
  50% { opacity: 0; }
`,u=n.default.div`
  display: flex;
