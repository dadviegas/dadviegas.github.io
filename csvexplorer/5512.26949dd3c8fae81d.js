"use strict";(self.webpackChunk_atlantis_csvexplorer=self.webpackChunk_atlantis_csvexplorer||[]).push([["5512"],{8997(e,o,r){var s=r(2727);o.createRoot=s.createRoot,s.hydrateRoot},3611(e,o,r){var s=r(5723),n=r(7991),t=r(8997),l=r(6859),i=r.n(l),a=r(3930),d=r(1638),c=r(3317),p=r(3775),x=r(9161),u=r(1344),h=r(679),m=r(4525),w=r(5426),g=r(668),b=r(457),f=r(5151);let $=`&::-webkit-scrollbar{width:6px;height:6px}&::-webkit-scrollbar-track{background:transparent}&::-webkit-scrollbar-thumb{background:${a.w4.colors.border};border-radius:3px}scrollbar-width:thin;scrollbar-color:${a.w4.colors.border} transparent;`,j=i().div`display:flex;flex:1;overflow:hidden;`,v=i().div`
