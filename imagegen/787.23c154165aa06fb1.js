"use strict";(self.webpackChunk_atlantis_imagegen=self.webpackChunk_atlantis_imagegen||[]).push([["787"],{3758(e,o,r){r.d(o,{Vi:()=>i,fG:()=>a,i4:()=>t.buildPollinationsUrl});var t=r(5256);async function a(e,o){return(await (0,t.askGroq)(o,{key:e,system:"You are an expert at writing image generation prompts. Enhance the user's prompt to be more descriptive and visually compelling. Include details about lighting, style, composition, and mood. Return ONLY the enhanced prompt text, no explanation or quotes.",maxTokens:200})).trim()||o}function i(){return(0,t.loadApiKeysSync)().groq??""}},3487(e,o,r){r.d(o,{Z:()=>y});var t=r(5723),a=r(7991),i=r(6859),n=r.n(i),l=r(2799),s=r(6063),d=r(997),c=r(6665);let p=(0,l.keyframes)`
...
`,w=n().div`
  ...
  opacity: 0;
  transition: opacity ${s.w4.transitions.base};
`;function u({item:e,onSelect:o,onDelete:r}){let i=function(e){let o=`https://image.pollinations.ai/prompt/${encodeURIComponent(e.prompt)}?width=200&height=200&seed=${e.seed}&model=${e.model}&nologo=true`,[r,t]=(0,a.useState)(o);return(0,a.useEffect)(()=>{let o=null;return(0,c.if)(e.id).then(e=>{e&&(o=e,t(e))}),()=>{o&&URL.revokeObjectURL(o)}},[e.id]),r}(e);return(0,t.jsxs)(f,{onClick:o,children:[(0,t.jsx)(b,{src:i,alt:e.prompt,loading:"lazy",referrerPolicy:"no-referrer"}),(0,t.jsx)(m,{className:"delete-btn",role:"button",onClick:e=>{e.stopPropagation(),r()},children:(0,t.jsx)(d.In,{name:"close",size:12})}),(0,t.jsx)(w,{className:"prompt-label",children:e.prompt})]})}function y({items:e,onSelect:o,onDelete:r}){return 0===e.length?null:(0,t.jsxs)(g,{children:[(0,t.jsx)(h,{children:"Recent Generations"}),(0,t.jsx)(x,{children:e.map(e=>(0,t.jsx)(u,{item:e,onSelect:()=>o(e),onDelete:()=>r(e.id)},e.id))})]})}},9610(e,o,r){r.d(o,{e:()=>y});var t=r(5723),a=r(6859),i=r.n(a),n=r(2799),l=r(6063),s=r(997);let d=(0,n.keyframes)`
...
`,g=i().div`
  position: relative;
  width: 100%;
  padding-bottom: ${({ratio:e})=>1/e*100}%;
`,h=i().div`
  position: absolute;
  inset: 0;
  display: flex;
...
`;function y({url:e,status:o,width:r,height:a,onLoad:i,onError:n,onReroll:l,onRetry:d}){return(0,t.jsxs)(p,{children:[(0,t.jsx)(g,{ratio:r/a,children:(0,t.jsxs)(h,{children:["idle"===o&&(0,t.jsxs)(b,{children:[(0,t.jsx)("span",{style:{fontSize:40,opacity:.3},children:"\uD83C\uDFA8"}),"Generate an image to get started"]}),"loading"===o&&(0,t.jsx)(x,{}),"error"===o&&(0,t.jsxs)(m,{children:[(0,t.jsx)(s.In,{name:"alert-circle",size:32}),"Failed to generate image",(0,t.jsx)(s.$n,{variant:"ghost",size:"sm",onClick:d,children:"Try Again"})]}),e&&("loaded"===o||"loading"===o)&&(0,t.jsx)(f,{src:e,alt:"Generated image",crossOrigin:"anonymous",referrerPolicy:"no-referrer",onLoad:e=>i(e.currentTarget),onError:n,style:{display:"loaded"===o?"block":"none"}})]})}),"loaded"===o&&(0,t.jsxs)(w,{className:"overlay",children:[(0,t.jsxs)(u,{onClick:()=>{e&&window.open(e,"_blank","noopener")},children:[(0,t.jsx)(s.In,{name:"download",size:14})," Download"]}),(0,t.jsxs)(u,{onClick:l,children:[(0,t.jsx)(s.In,{name:"refresh-cw",size:14})," New Variation"]})]})]})}},6396(e,o,r){r.d(o,{q:()=>u});var t=r(5723),a=r(6859),i=r.n(a),n=r(2799),l=r(6063),s=r(997),d=r(5256);let c=(0,n.keyframes)`
...
`,w=i().forwardRef(function({variant:e="ghost",size:o="md",icon:r,iconRight:a,children:i,...n},l){return(0,t.jsxs)(m,{ref:l,variant:e,size:o,...n,children:[r,i,a]})}),u={default:s.w4.colors.accent,danger:"#f85149"},y={default:s.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"};l().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`,F=i().forwardRef(function({variant:e="default",dotColor:o,children:r,onClick:a,...i},n){return(0,t.jsxs)(T,{ref:n,variant:e,clickable:!!a,onClick:a,type:i.type??"button",...i,children:[o&&(0,t.jsx)(j,{color:o}),r]})}),S={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:s.w4.colors.accentMuted},H={neutral:s.w4.colors.mainTextMuted,live:s.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:s.w4.colors.accent};l().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${s.w4.typography.fontFamilyMono};
...
`,l().aside`
  ...
  display: flex;
  flex-direction: column;
  animation: ${P} 0.22s cubic-bezier(0.4, 0, 0.2, 1) both;
...
`,l().div`
  position: relative;
`;let U="260px",Z="56px",J="48px",K=l().header`
  display: flex;
  align-items: center;
  height: calc(${J} + env(safe-area-inset-top, 0px));
  ...
  @media (max-width: ${s.w4.breakpoints.md}) {
    flex-wrap: wrap;
    height: auto;
    min-height: calc(${J} + env(safe-area-inset-top, 0px));
  }
`,Q=l().div`
  width: ${Z};
  min-width: ${Z};
...
`,et=l().span`
  ...
  animation: ${eo} 10s ease ${({index:e})=>.07*e}s infinite;
...
`,el=l().div`
  ...
  overflow: hidden;
`,es=l().aside`
  width: ${({collapsed:e})=>e?Z:U};
  min-width: ${({collapsed:e})=>e?Z:U};
  background: ${s.w4.colors.sidebarBg};
  border-right: 1px solid ${s.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,ec=l().main`
  ...
  display: flex;
  flex-direction: column;
`,ep=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function eg(){return(0,t.jsx)(er,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:ep.map((e,o)=>(0,t.jsx)(et,{index:o,accent:e.accent,children:e.char},o))})}let eh="atlantis:sidebar-collapsed";function ex({sidebar:e,children:o,topBarRight:n,title:l="Atlantis",activeId:s=null}){let[d,c]=(0,a.useState)(()=>{try{return"true"===localStorage.getItem(eh)}catch{return!1}}),[p,g]=(0,a.useState)(null),h=(0,a.useRef)(),x=()=>c(e=>{let o=!e;try{localStorage.setItem(eh,String(o))}catch{}return o}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(r.bind(r,5816)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,t.jsx)(O.I.Provider,{value:{collapsed:d,toggle:x,flyout:p,openFlyout:(e,o,r)=>{clearTimeout(h.current),g({entry:e,anchorY:o,onSelect:r})},scheduleFlyoutClose:()=>{h.current=setTimeout(()=>g(null),160)},cancelFlyoutClose:()=>clearTimeout(h.current)},children:(0,t.jsxs)(el,{children:[(0,t.jsxs)(K,{children:[e&&(0,t.jsx)(Q,{children:(0,t.jsx)(ee,{onClick:x,title:d?"Expand sidebar":"Collapse sidebar",children:(0,t.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,t.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,t.jsx)("path",{d:"M9 3v18"})]})})}),(0,t.jsx)(eg,{}),l&&(0,t.jsx)(ea,{children:l}),n&&(0,t.jsx)(ei,{children:n})]}),(0,t.jsxs)(en,{children:[null!=e&&(0,t.jsx)(es,{collapsed:d,children:(0,t.jsx)(ed,{children:e})}),(0,t.jsx)(ec,{children:o})]}),p&&(0,t.jsx)(i().Suspense,{fallback:null,children:(0,t.jsx)(f,{activeId:s})})]})})}l().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
