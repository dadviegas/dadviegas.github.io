"use strict";(self.webpackChunk_atlantis_movies=self.webpackChunk_atlantis_movies||[]).push([[36],{6036(e,t,i){i.r(t),i.d(t,{default:()=>ie});var o=i(7359),n=i(3233),a=i(7207),r=i(4191),s=i(7901),l=i(1783),d=i(1511),c=i(2709),p=i(7032),g=i(7681),x=i(7308),u=i(5031),f=i(4525),h=i(5056),m=i(6127),b=i(6260),w=i(1385),v=i(7390),y=i(2053),k=i(5723);const j="atlantis:movies:apikey",$="9b6f2645abf1725625c843aa71e3efd5";function S(e){if(e)return e;if($)return $;try{return localStorage.getItem(j)}catch{return null}}const T=[{id:"discover",label:"Discover",Icon:p.A},{id:"movies",label:"Movies",Icon:d.A},{id:"tv",label:"TV Shows",Icon:u.A},{id:"documentaries",label:"Documentaries",Icon:s.A},{id:"favorites",label:"My Favorites",Icon:c.A},{id:"seen",label:"Recently Seen",Icon:l.A}],M=a.keyframes`
...
//# sourceMappingURL=36.977fb4808316a9f8f2c9.js.map