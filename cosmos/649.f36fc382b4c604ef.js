...
`,I.A,I.A['pre[class*="language-"]'],s.w4.colors.codeBg,I.A['code[class*="language-"]'],l().div`
  background: ${({bg:e})=>e};
...
`,l().div`
  position: relative;
`;let D="260px",q="56px",_="48px",N=l().header`
  display: flex;
  align-items: center;
  height: calc(${_} + env(safe-area-inset-top, 0px));
  ...
  @media (max-width: ${s.w4.breakpoints.md}) {
    flex-wrap: wrap;
    height: auto;
    min-height: calc(${_} + env(safe-area-inset-top, 0px));
  }
`,X=l().div`
  width: ${q};
  min-width: ${q};
...
`,eo=l().div`
  ...
  overflow: hidden;
`,er=l().aside`
  width: ${({collapsed:e})=>e?q:D};
  min-width: ${({collapsed:e})=>e?q:D};
  background: ${s.w4.colors.sidebarBg};
  border-right: 1px solid ${s.w4.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
...
`,ei=l().main`
  ...
  display: flex;
  flex-direction: column;
`,en=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function el(){return(0,r.jsx)(K,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:en.map((e,t)=>(0,r.jsx)(J,{index:t,accent:e.accent,children:e.char},t))})}let es="atlantis:sidebar-collapsed";function ed({sidebar:e,children:t,topBarRight:n,title:l="Atlantis",activeId:s=null}){let[d,c]=(0,a.useState)(()=>{try{return"true"===localStorage.getItem(es)}catch{return!1}}),[p,h]=(0,a.useState)(null),g=(0,a.useRef)(),x=()=>c(e=>{let t=!e;try{localStorage.setItem(es,String(t))}catch{}return t}),f=i().useMemo(()=>i().lazy(()=>Promise.resolve().then(o.bind(o,2787)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,r.jsx)(B.I.Provider,{value:{collapsed:d,toggle:x,flyout:p,openFlyout:(e,t,o)=>{clearTimeout(g.current),h({entry:e,anchorY:t,onSelect:o})},scheduleFlyoutClose:()=>{g.current=setTimeout(()=>h(null),160)},cancelFlyoutClose:()=>clearTimeout(g.current)},children:(0,r.jsxs)(eo,{children:[(0,r.jsxs)(N,{children:[e&&(0,r.jsx)(X,{children:(0,r.jsx)(Z,{onClick:x,title:d?"Expand sidebar":"Collapse sidebar",children:(0,r.jsxs)("svg",{width:17,height:17,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",children:[(0,r.jsx)("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),(0,r.jsx)("path",{d:"M9 3v18"})]})})}),(0,r.jsx)(el,{}),l&&(0,r.jsx)(Q,{children:l}),n&&(0,r.jsx)(ee,{children:n})]}),(0,r.jsxs)(et,{children:[null!=e&&(0,r.jsx)(er,{collapsed:d,children:(0,r.jsx)(ea,{children:e})}),(0,r.jsx)(ei,{children:t})]}),p&&(0,r.jsx)(i().Suspense,{fallback:null,children:(0,r.jsx)(f,{activeId:s})})]})})}var ec=o(4971);let ep=l().div`
  display: grid;
  grid-template-rows: ${({open:e})=>e?"1fr":"0fr"};
...
`;function ey({iconKey:e,size:t=16}){let o=e?ec.X[e]:void 0;return o?(0,r.jsx)("svg",{width:t,height:t,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,dangerouslySetInnerHTML:{__html:o}}):e?(0,r.jsx)("span",{style:{fontSize:t,lineHeight:1,display:"flex",alignItems:"center"},children:e}):(0,r.jsxs)("svg",{width:t,height:t,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,children:[(0,r.jsx)("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),(0,r.jsx)("polyline",{points:"14 2 14 8 20 8"})]})}function e$({entry:e,activeId:t,onSelect:o}){let[i,n]=(0,a.useState)(e.defaultOpen??!0),{collapsed:l,openFlyout:s,scheduleFlyoutClose:d,cancelFlyoutClose:c}=(0,B.c)();return e.children&&e.children.length>0?(0,r.jsxs)(ex,{children:[(0,r.jsxs)(ef,{collapsed:l,onClick:()=>{l||n(e=>!e)},onMouseEnter:l?t=>{s(e,t.currentTarget.getBoundingClientRect().top,o)}:void 0,onMouseLeave:l?d:void 0,children:[(0,r.jsxs)(em,{collapsed:l,children:[(0,r.jsx)(ey,{iconKey:e.icon,size:16}),(0,r.jsx)(eb,{collapsed:l,children:e.name})]}),(0,r.jsx)(eu,{open:i,collapsed:l,children:(0,r.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:1.75,strokeLinecap:"round",strokeLinejoin:"round",children:(0,r.jsx)("path",{d:"M9 6l6 6-6 6"})})})]}),(0,r.jsx)(ep,{open:i&&!l,children:(0,r.jsx)(eh,{children:(0,r.jsx)(eg,{children:e.children.map(e=>(0,r.jsx)(e$,{entry:e,activeId:t,onSelect:o},e.id))})})})]}):(0,r.jsxs)(ew,{active:t===e.id,collapsed:l,onClick:()=>o(e),onMouseEnter:l?t=>{let r=t.currentTarget.getBoundingClientRect();s({id:e.id,name:e.name,icon:e.icon,file:e.file,children:[e]},r.top,o)}:void 0,onMouseLeave:l?d:void 0,children:[(0,r.jsx)(ey,{iconKey:e.icon,size:15}),(0,r.jsx)(eb,{collapsed:l,children:e.name})]})}function ev({entries:e,activeId:t,onSelect:o}){return(0,r.jsx)("div",{children:e.map(e=>(0,r.jsx)(e$,{entry:e,activeId:t,onSelect:o},e.id))})}function eM({title:e,sections:t,topBarRight:o,children:i}){let[n,l]=(0,a.useState)(null),s=(0,a.useCallback)(e=>{l(e.id),document.getElementById(e.id)?.scrollIntoView({behavior:"smooth",block:"start"})},[]),d=(0,r.jsx)(ev,{entries:t,activeId:n,onSelect:s});return(0,r.jsx)(ed,{title:e,sidebar:d,activeId:n,topBarRight:o,children:i})}o(2787);let ek=l().div`
