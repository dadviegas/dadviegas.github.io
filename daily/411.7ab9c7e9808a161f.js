"use strict";(self.webpackChunk_atlantis_daily=self.webpackChunk_atlantis_daily||[]).push([["411"],{3436(e,o,t){t.d(o,{R:()=>b});var r=t(5723),a=t(7991),i=t(6859),n=t.n(i),l=t(2799),s=t(6063),d=t(6197);let p=(0,l.keyframes)`
...
`,x=n().div`
  ...
  z-index: 10;
  animation: ${({active:e})=>e?`${c} 1.6s ease-in-out infinite`:"none"};
`,f=n().div`
