"use strict";(self.webpackChunk_atlantis_forma=self.webpackChunk_atlantis_forma||[]).push([["216"],{90429(e,t,a){a.d(t,{N:()=>S});var r=a(65723),o=a(37991),i=a(36859),n=a.n(i),s=a(72799),l=a(6063),d=a(63236),c=a(69454);let p="#7fb77e",h={month:30,"3m":90,"6m":183,year:365,all:null},m=(0,s.keyframes)`
...
`,u=n().div`
  flex: 1;
  min-height: 60px;
`;function w({data:e,t,onClick:a}){let i=(0,o.useMemo)(()=>(0,l.weightForecast)(e.weights,60,30),[e.weights]),n=i.history.length>0?i.history[i.history.length-1]:null,c=i.forecast.length>0?i.forecast[i.forecast.length-1]:null,y=n&&c?c.kg-n.kg:0;return(0,r.jsxs)(p,{onClick:a,"aria-label":t("forma.miniWeight.aria"),children:[(0,r.jsxs)(h,{children:[(0,r.jsxs)(m,{children:["◉ ",t("forma.miniWeight.title")]}),c&&(0,r.jsxs)(x,{pos:y>0,children:[y>=0?"+":"",y.toFixed(1),"kg / 30d"]})]}),(0,r.jsxs)(g,{children:[(0,r.jsx)(f,{children:n?n.kg.toFixed(1):"—"}),(0,r.jsx)("span",{style:{color:s.w4.colors.mainTextMuted,fontSize:13,fontFamily:s.w4.typography.fontFamilyMono},children:"kg"}),c&&(0,r.jsxs)("span",{style:{color:s.w4.colors.mainTextMuted,fontSize:12,fontFamily:s.w4.typography.fontFamilyMono},children:["→ ",c.kg.toFixed(1)," kg"]})]}),(0,r.jsx)(u,{children:(0,r.jsx)(d.h,{forecast:i,axes:!1})})]})}},86704(e,t,a){a.d(t,{g:()=>z});var r=a(65723),o=a(37991),i=a(36859),n=a.n(i),s=a(72799),l=a(6063),d=a(63236),c=a(71730);let p="#7fb77e",h=new Date().toISOString().slice(0,10),m=(0,s.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
`,g=n().section`
  display: flex;
...
`,D=n().div`
  ...
  font-family: ${s.w4.typography.fontFamilyMono};
  font-variant-numeric: tabular-nums;
`;function L({data:e,t,onLogMeal:a,onLogWalk:i,onLogWeight:n,onLogWater:c,onDeleteMeal:H,onEditMeal:R}){var I;let P=new Date().toISOString().slice(0,10),B=(0,d.proteinByDay)(e.meals,P),E=(0,d.kcalByDay)(e.meals,P),W=(0,d.kcalTargetForDate)(e,P),N=(I=e.walks,I.filter(e=>e.date===P).reduce((e,t)=>e+t.minutes,0)),O=(0,d.waterByDay)(e.water??[],P),Y=e.goal.waterMl??2e3,G=e.meals.filter(e=>e.date===P).sort((e,t)=>e.createdAt-t.createdAt),K=e.goal.proteinG??110,V=E>W&&W>0,q=O/Y*100,[_,J]=(0,o.useState)(!1),[Q,U]=(0,o.useState)(""),X=(0,o.useCallback)(()=>{let e=parseInt(Q,10);!isNaN(e)&&e>0&&(c(e),U(""),J(!1))},[Q,c]);return(0,r.jsxs)(p,{children:[(0,r.jsxs)(h,{children:[(0,r.jsxs)(m,{children:["◉ ",t("forma.today.title")]}),(0,r.jsx)(m,{children:new Date().toLocaleDateString(void 0,{weekday:"long",day:"numeric",month:"short"})})]}),(0,r.jsxs)(g,{children:[(0,r.jsxs)(f,{children:[(0,r.jsxs)(x,{children:[Math.round(B),(0,r.jsxs)("span",{style:{fontSize:14,color:s.w4.colors.mainTextMuted,marginLeft:4},children:["/ ",K,"g"]})]}),(0,r.jsx)(u,{children:t("forma.today.protein")})]}),(0,r.jsxs)(f,{children:[(0,r.jsxs)(x,{style:{color:V?"#facc15":void 0},children:[Math.round(E),(0,r.jsxs)("span",{style:{fontSize:14,color:s.w4.colors.mainTextMuted,marginLeft:4},children:["/ ",W,"kcal"]})]}),(0,r.jsx)(u,{children:V?t("forma.today.kcalOver"):t("forma.today.kcal")})]}),(0,r.jsxs)(f,{children:[(0,r.jsxs)(x,{children:[O,(0,r.jsxs)("span",{style:{fontSize:14,color:s.w4.colors.mainTextMuted,marginLeft:4},children:["/ ",Y,"ml"]})]}),(0,r.jsx)(u,{children:t("forma.today.water")})]}),(0,r.jsxs)(f,{children:[(0,r.jsxs)(x,{children:[N,(0,r.jsx)("span",{style:{fontSize:14,color:s.w4.colors.mainTextMuted,marginLeft:4},children:"min"})]}),(0,r.jsx)(u,{children:t("forma.today.walk")})]})]}),(0,r.jsx)(w,{children:(0,r.jsx)(y,{pct:B/K*100})}),(0,r.jsx)(w,{children:(0,r.jsx)(y,{pct:W>0?E/W*100:0,over:V})}),(0,r.jsxs)(b,{children:[(0,r.jsx)(l.$n,{variant:"primary",icon:(0,r.jsx)(l.In,{name:"plus",size:14}),onClick:a,children:t("forma.action.logMeal")}),(0,r.jsx)(l.$n,{variant:"ghost",icon:(0,r.jsx)(l.In,{name:"plus",size:14}),onClick:i,children:t("forma.action.logWalk")}),(0,r.jsx)(l.$n,{variant:"ghost",icon:(0,r.jsx)(l.In,{name:"plus",size:14}),onClick:n,children:t("forma.action.logWeight")})]}),(0,r.jsxs)($,{children:[(0,r.jsxs)(v,{children:[(0,r.jsxs)(m,{children:[(0,r.jsx)(l.In,{name:"droplets",size:12,style:{verticalAlign:"middle",marginRight:4}}),t("forma.today.water")]}),(0,r.jsxs)("span",{style:{fontSize:11,fontFamily:s.w4.typography.fontFamilyMono,fontVariantNumeric:"tabular-nums",color:s.w4.colors.mainTextMuted},children:[O," / ",Y," ml"]})]}),(0,r.jsx)(w,{children:(0,r.jsx)(y,{pct:q})}),_?(0,r.jsxs)("div",{style:{display:"flex",gap:s.w4.spacing.xs},children:[(0,r.jsx)("input",{type:"number",min:1,placeholder:"ml",value:Q,onChange:e=>U(e.target.value),onKeyDown:e=>{"Enter"===e.key&&X()},style:{flex:1,height:44,background:s.w4.colors.surface,border:`1px solid ${s.w4.colors.border}`,borderRadius:s.w4.borderRadius.md,color:s.w4.colors.mainText,fontSize:13,fontFamily:s.w4.typography.fontFamilyMono,padding:`0 ${s.w4.spacing.sm}`},autoFocus:!0}),(0,r.jsx)(l.$n,{variant:"accent",onClick:X,children:t("forma.sheet.save")}),(0,r.jsx)(l.$n,{variant:"ghost",onClick:()=>J(!1),children:t("forma.sheet.cancel")})]}):(0,r.jsxs)(k,{children:[(0,r.jsx)(M,{onClick:()=>c(250),children:t("forma.water.add250")}),(0,r.jsx)(M,{onClick:()=>c(500),children:t("forma.water.add500")}),(0,r.jsx)(M,{onClick:()=>c(1e3),children:t("forma.water.add1000")}),(0,r.jsx)(M,{onClick:()=>J(!0),children:t("forma.water.addCustom")})]})]}),0===G.length?(0,r.jsx)(A,{children:t("forma.today.noMealsYet")}):(0,r.jsx)(j,{children:G.map(e=>(0,r.jsxs)(z,{onClick:R?()=>R(e.id):void 0,style:{cursor:R?"pointer":"default"},title:R?t("forma.action.edit"):void 0,children:[(0,r.jsx)(T,{children:t(`forma.meal.${e.slot}`)}),(0,r.jsx)(S,{children:e.notes||"—"}),(0,r.jsxs)(F,{children:[e.proteinG??0,"g \xb7 ",e.kcal??0,"kcal"]}),(0,r.jsx)(C,{onClick:t=>{t.stopPropagation(),H(e.id)},"aria-label":t("forma.action.delete"),children:(0,r.jsx)(l.In,{name:"trash",size:14})})]},e.id))}),N>0&&(0,r.jsx)(D,{children:(0,r.jsx)("span",{children:t("forma.today.walkSummary",{min:N})})})]})}},20483(e,t,a){a.d(t,{v:()=>v});var r=a(65723),o=a(36859),i=a.n(o),n=a(72799),s=a(6063),l=a(63236);let d="#7fb77e",c=(0,n.keyframes)`
  from { opacity: 0; transform: translateY(4px); }
  to   { opacity: 1; transform: translateY(0); }
