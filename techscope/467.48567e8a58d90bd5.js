"use strict";(self.webpackChunk_atlantis_techscope=self.webpackChunk_atlantis_techscope||[]).push([["467"],{5748(e,o,r){r.d(o,{W:()=>oY});var t=r(5723),a=r(4764),i=r(7991),n=r.n(i),s=r(6859),l=r.n(s),d=r(5030),p=r(8527),c=r(9522),g=r(2799),x=r(8170);let f=(0,g.keyframes)`
  0%, 100% { opacity: 1; }
  50% { opacity: 0.3; }
`,h=(0,g.keyframes)`
