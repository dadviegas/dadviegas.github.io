...
`;let B=s().div`
  ...
  align-items: center;
  gap: 8px;
`;function O({children:e,...t}){return(0,a.jsx)(B,{...t,children:e})}s().label`
  display: flex;
  align-items: center;
  gap: 10px;
...
`;function J({title:e,accessory:t,accentColor:o,error:r,errorLabel:i,children:n}){return(0,a.jsxs)(Y,{accentColor:o,"data-widget-shell":!0,children:[(0,a.jsxs)(K,{children:[(0,a.jsx)(O,{children:e}),t&&(0,a.jsx)(G,{children:t})]}),r?(0,a.jsxs)(_,{role:"alert",children:[(0,a.jsx)(q,{children:i??"Error"}),(0,a.jsx)("div",{children:r})]}):(0,a.jsx)(V,{children:n})]})}s().div`
  position: relative;
  display: flex;
  flex-direction: column;
  height: 100%;
...
`,d=i().p`
  ...
  margin: 0;
  line-height: 1.5;
`,c={loading:"◌ Loading",empty:"◎ Empty",error:"◎ Offline"};function p({mode:e,label:t,body:o}){return(0,a.jsxs)(s,{children:[(0,a.jsx)(l,{mode:e,children:t??c[e]}),o&&(0,a.jsx)(d,{children:o})]})}},6246(e,t,o){o.d(t,{OW:()=>s,ik:()=>p,kl:()=>u,RT:()=>m,YG:()=>a.Y});var a=o(5043),r=o(5723),i=o(7991),n=o(4764);function s({points:e,accent:t=n.w4.colors.accent,width:o=60,height:a=28,strokeWidth:l=1.5}){let d=(0,i.useMemo)(()=>{if(e.length<2)return"";let t=Math.min(...e),r=Math.max(...e)-t||1,i=o-2*l,n=a-2*l;return e.map((o,a)=>{let s=l+a/(e.length-1)*i,d=l+n-(o-t)/r*n;return`${0===a?"M":"L"} ${s.toFixed(1)} ${d.toFixed(1)}`}).join(" ")},[e,o,a,l]),c=(0,i.useMemo)(()=>{if(e.length<1)return null;let t=e[e.length-1],r=Math.min(...e),i=o-2*l,n=a-2*l;return{x:l+i,y:l+n-(t-r)/(Math.max(...e)-r||1)*n}},[e,o,a,l]);return d?(0,r.jsxs)("svg",{width:o,height:a,viewBox:`0 0 ${o} ${a}`,"aria-hidden":"true",style:{display:"block",flexShrink:0},children:[(0,r.jsx)("path",{d:d,fill:"none",stroke:t,strokeWidth:l,strokeLinecap:"round",strokeLinejoin:"round",opacity:.7}),c&&(0,r.jsx)("circle",{cx:c.x,cy:c.y,r:l+1,fill:t})]}):null}var l=o(6859),d=o.n(l);d().span`
  font-family: ${n.w4.typography.fontFamilyMono};
  font-size: 11px;
  font-weight: 500;
  font-variant-numeric: tabular-nums;
