...
`;function Z({place:e,onClose:a}){var o;let[i,r]=(0,t.useState)(null),[c,d]=(0,t.useState)(null),[m,u]=(0,t.useState)(!1),[g,f]=(0,t.useState)(null),[p,h]=(0,t.useState)(0);(0,t.useEffect)(()=>{if(!e){r(null),d(null);return}u(!0),f(null),r(null),d(null);let a=`https://api.open-meteo.com/v1/forecast?latitude=${e.lat}&longitude=${e.lng}&current_weather=true&hourly=temperature_2m,apparent_temperature,relativehumidity_2m,windspeed_10m,winddirection_10m&daily=weathercode,temperature_2m_max,temperature_2m_min,precipitation_sum,windspeed_10m_max,winddirection_10m_dominant&timezone=auto&forecast_days=7`,o=`https://air-quality-api.open-meteo.com/v1/air-quality?latitude=${e.lat}&longitude=${e.lng}&current=pm2_5,pm10,european_aqi,us_aqi`;Promise.all([fetch(a).then(e=>{if(!e.ok)throw Error(`HTTP ${e.status}`);return e.json()}),fetch(o).then(e=>e.ok?e.json():null).catch(()=>null)]).then(([e,a])=>{r(e),d(a),u(!1)}).catch(e=>{f(e.message),u(!1)})},[e?.id,p]);let y=i?s(i.current_weather.weathercode):null,x=i?i.hourly.windspeed_10m.slice(0,24):[],b=i?i.hourly.temperature_2m.slice(0,24):[],J=i?i.hourly.apparent_temperature.slice(0,24):[],q=new Date().getHours(),Q=i?i.hourly.relativehumidity_2m[q]:null,X=i?i.hourly.apparent_temperature[q]:null,ee=c?(o=c.current.us_aqi)<=50?{label:"Good",color:"#3fb950"}:o<=100?{label:"Moderate",color:"#d29922"}:o<=150?{label:"Unhealthy (sensitive)",color:"#f0883e"}:o<=200?{label:"Unhealthy",color:"#f85149"}:{label:"Hazardous",color:"#b44ac0"}:null;return(0,n.jsxs)($,{visible:!!e,children:[(0,n.jsxs)(A,{children:[(0,n.jsx)(k,{children:e?.name??""}),(0,n.jsx)(M,{onClick:a,title:"Close",children:"✕"})]}),(0,n.jsxs)(S,{children:[m&&(0,n.jsx)(Y,{children:"Loading weather…"}),g&&(0,n.jsxs)(Y,{children:[(0,n.jsx)("div",{children:"Weather unavailable — the API may be temporarily down."}),(0,n.jsx)("button",{onClick:()=>h(e=>e+1),style:{marginTop:12,padding:"6px 16px",cursor:"pointer",background:"none",border:`1px solid ${l.w4.colors.border}`,borderRadius:6,color:l.w4.colors.mainText,fontFamily:"inherit",fontSize:12},children:"Retry"})]}),i&&y&&(0,n.jsxs)(n.Fragment,{children:[(0,n.jsxs)(j,{children:[(0,n.jsxs)(T,{children:[(0,n.jsxs)("div",{children:[(0,n.jsxs)(C,{children:[Math.round(i.current_weather.temperature),"\xb0C"]}),(0,n.jsx)(E,{children:y.label})]}),(0,n.jsx)(B,{children:y.emoji})]}),(0,n.jsxs)(L,{children:[(0,n.jsxs)(F,{children:["\uD83D\uDCA8 ",Math.round(i.current_weather.windspeed)," km/h"]}),(0,n.jsxs)(F,{children:["\uD83C\uDF21 ",Math.round(i.daily.temperature_2m_max[0]),"\xb0 / ",Math.round(i.daily.temperature_2m_min[0]),"\xb0"]}),null!=X&&(0,n.jsxs)(F,{children:["\uD83C\uDF2C Feels ",Math.round(X),"\xb0"]}),null!=Q&&(0,n.jsxs)(F,{children:["\uD83D\uDCA7 ",Q,"% RH"]})]}),ee&&c&&(0,n.jsxs)(P,{color:ee.color,children:["\uD83C\uDFED AQI ",c.current.us_aqi," \xb7 ",ee.label]})]}),b.length>0&&(0,n.jsxs)("div",{children:[(0,n.jsx)(R,{children:"Temperature today (hourly)"}),(0,n.jsxs)(I,{children:[(0,n.jsx)(_,{children:"\xb0C \xb7 dot = current hour"}),(0,n.jsx)(w,{temps:b,feelsLike:J})]})]}),(0,n.jsxs)("div",{children:[(0,n.jsx)(R,{children:"Wind today (hourly)"}),(0,n.jsxs)(I,{children:[(0,n.jsx)(_,{children:"Speed km/h \xb7 dot = current hour"}),(0,n.jsx)(z,{speeds:x})]})]}),(0,n.jsxs)("div",{children:[(0,n.jsx)(R,{children:"Wind this week (daily max)"}),(0,n.jsxs)(I,{children:[(0,n.jsx)(_,{children:"Max speed km/h \xb7 arrows = dominant direction"}),(0,n.jsx)(v,{speeds:i.daily.windspeed_10m_max,directions:i.daily.winddirection_10m_dominant,dayLabels:i.daily.time.map((e,a)=>0===a?"Today":new Date(e).toLocaleDateString("en-GB",{weekday:"short"}))})]})]}),(0,n.jsxs)("div",{children:[(0,n.jsx)(R,{children:"7-Day Forecast"}),i.daily.time.map((e,a)=>{let{emoji:o,label:t}=s(i.daily.weathercode[a]);return(0,n.jsxs)(D,{children:[(0,n.jsx)(G,{children:o}),(0,n.jsxs)(N,{children:[(0,n.jsx)(K,{children:0===a?"Today":1===a?"Tomorrow":new Date(e).toLocaleDateString("en-GB",{weekday:"short",month:"short",day:"numeric"})}),(0,n.jsx)(H,{children:t})]}),(0,n.jsx)(W,{children:i.daily.precipitation_sum[a]>0&&(0,n.jsxs)(n.Fragment,{children:["\uD83D\uDCA7 ",i.daily.precipitation_sum[a].toFixed(1)]})}),(0,n.jsxs)(O,{children:[(0,n.jsxs)(V,{children:[Math.round(i.daily.temperature_2m_max[a]),"\xb0"]}),(0,n.jsxs)(U,{children:[Math.round(i.daily.temperature_2m_min[a]),"\xb0"]})]})]},e)})]})]})]})]})}},1112(e,a,o){o.d(a,{xy:()=>c});var n=o(7991);function t(e){return e*Math.PI/180}function i(e){return e<20?"#00e676":e<40?"#69ff47":e<60?"#b2ff59":e<80?"#ffea00":"#ff6d00"}function r(e){return null==e||e<1e3?"#8b949e":e<1e4?"#f0883e":e<25e3?"#d29922":"#58a6ff"}function l(e){let a=r(e.altFt),o=null!=e.altFt?`${Math.round(.3048*e.altFt).toLocaleString()} m`:"—",n=null!=e.speedKts?`${Math.round(1.852*e.speedKts)} km/h`:"—",t=null!=e.heading?`${Math.round(e.heading)}\xb0`:"—",i=null!=e.vrateFpm?`${e.vrateFpm>0?"↑":"↓"} ${Math.abs(Math.round(.00508*e.vrateFpm))} m/s`:"—";return`
    <div style="font-family:monospace;font-size:12px;line-height:1.75;min-width:180px;">
      ...
      <div style="margin-top:6px">
        <button
          ...
          ">📍 Follow</button>
    ...
    </div>`}let s=new Map([{id:"night",label:"\uD83C\uDF11 Night",title:"Day/night terminator",defaultEnabled:!1,component:function({map:e,enabled:a}){let o=(0,n.useRef)(null),i=(0,n.useRef)(),r=(0,n.useCallback)(()=>{clearInterval(i.current),o.current?.remove(),o.current=null},[]),l=(0,n.useCallback)(()=>{if(!e||!a)return;let n=function(e){let a,o,n,i,r,l,s,c=(n=t((280.46+.9856474*(o=(a=e.getTime()/864e5+2440587.5)-2451545))%360),i=t((357.528+.9856003*o)%360),r=n+t(1.915*Math.sin(i)+.02*Math.sin(2*i)),s=Math.atan2(Math.cos(l=t(23.439-4e-7*o))*Math.sin(r),Math.cos(r)),{ra:s,dec:Math.asin(Math.sin(l)*Math.sin(r)),gmst:t((280.46061837+360.98564736629*(a-2451545))%360)}),d=[];for(let e=-180;e<=180;e++){var m;let a=(m=t(e),Math.atan(-Math.cos(c.gmst+m-c.ra)/Math.tan(c.dec)));d.push([180*a/Math.PI,e])}let u=c.dec>0?-90:90;return d.push([u,180]),d.push([u,-180]),d}(new Date);o.current?o.current.setLatLngs(n):o.current=window.L.polygon(n,{color:"transparent",fillColor:"#000",fillOpacity:.3,interactive:!1}).addTo(e)},[e,a]);return(0,n.useEffect)(()=>e&&a?(l(),i.current=setInterval(l,3e4),r):void r(),[e,a,l,r]),null}},{id:"aurora",label:"\uD83C\uDF0C Aurora",title:"Aurora forecast — NOAA SWPC",defaultEnabled:!1,component:function({map:e,enabled:a}){let o=(0,n.useRef)([]),t=(0,n.useRef)(null),r=(0,n.useCallback)(()=>{o.current.forEach(e=>e.remove()),o.current=[],t.current&&(t.current.remove(),t.current=null)},[]),l=(0,n.useCallback)(async()=>{if(e&&a)try{let[n,r]=await Promise.all([fetch("https://services.swpc.noaa.gov/json/ovation_aurora_latest.json"),fetch("https://services.swpc.noaa.gov/json/planetary_k_index_1m.json")]);if(!n.ok||!r.ok||!e||!a)return;let l=await n.json(),s=await r.json(),c=s[s.length-1]?.kp_index??0,d=window.L;for(let[a,n,t]of(o.current.forEach(e=>e.remove()),o.current=[],l.coordinates)){if(t<5||45>Math.abs(n))continue;let r=d.circleMarker([n,a],{radius:3,color:i(t),fillColor:i(t),fillOpacity:Math.min(.85,.15+t/100*.7),weight:0,interactive:!1});r.addTo(e),o.current.push(r)}t.current&&t.current.remove();let m=c>=7?"#f85149":c>=5?"#f0883e":c>=3?"#d29922":"#3fb950";t.current=new(d.Control.extend({onAdd(){let e=d.DomUtil.create("div");return e.innerHTML=`
            <div style="
            ...
            </div>`,e},onRemove(){}}))({position:"bottomleft"}),t.current.addTo(e)}catch{}},[e,a]);return(0,n.useEffect)(()=>{if(!a)return void r();l();let e=setInterval(l,3e5);return()=>{clearInterval(e),r()}},[a,l,r]),null}},{id:"iss",label:"\uD83D\uDEF8 ISS",title:"ISS live position + footprint",defaultEnabled:!1,component:function({map:e,enabled:a}){let o=(0,n.useRef)(null),t=(0,n.useRef)(null),i=(0,n.useRef)(null),r=(0,n.useRef)([]),l=(0,n.useCallback)(()=>{o.current?.remove(),o.current=null,t.current?.remove(),t.current=null,i.current?.remove(),i.current=null,r.current=[]},[]),s=(0,n.useCallback)(async()=>{if(e&&a)try{let n=await fetch("https://api.wheretheiss.at/v1/satellites/25544");if(!n.ok)return;let l=await n.json();if(!e||!a)return;let s=window.L,c=l.latitude,d=l.longitude,m=r.current;if(m.length>0){let[,e]=m[m.length-1];Math.abs(d-e)>180&&(r.current=[])}r.current=[...r.current,[c,d]].slice(-80);let u=`<div style="
        font-size:22px;
      ...
      ">🛸</div>`,g=s.divIcon({html:u,className:"",iconSize:[24,24],iconAnchor:[12,12]}),f=`
        <div style="font-family:monospace;font-size:12px;line-height:1.75;min-width:165px;">
        ...
        </div>`;o.current?(o.current.setLatLng([c,d]),o.current.getPopup()?.setContent(f)):o.current=s.marker([c,d],{icon:g,zIndexOffset:2e3}).bindPopup(f,{maxWidth:220}).addTo(e),t.current?t.current.setLatLngs(r.current):t.current=s.polyline(r.current,{color:"#f0c040",weight:1.5,opacity:.55,dashArray:"3 7"}).addTo(e),i.current?i.current.setLatLng([c,d]):i.current=s.circle([c,d],{radius:2316e3,color:"#f0c040",fillColor:"#f0c040",fillOpacity:.04,weight:1,opacity:.25,dashArray:"5 8",interactive:!1}).addTo(e)}catch{}},[e,a]);return(0,n.useEffect)(()=>{let e;if(!a)return void l();let o=!1,n=async()=>{await s(),o||(e=setTimeout(n,5e3))};return n(),()=>{o=!0,clearTimeout(e),l()}},[a,s,l]),null}},{id:"quakes",label:"\uD83C\uDF0D Quakes",title:"Earthquakes — USGS past month",defaultEnabled:!1,component:function({map:e,enabled:a}){let o=(0,n.useRef)(new Map),t=(0,n.useCallback)(()=>{o.current.forEach(e=>e.remove()),o.current.clear()},[]),i=(0,n.useCallback)(async()=>{if(e&&a)try{let n=await fetch("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_month.geojson");if(!n.ok)return;let t=await n.json();if(!e||!a)return;let i=window.L,r=Date.now(),l=new Set;for(let a of t.features){let[n,t,s]=a.geometry.coordinates,{mag:c,place:d,time:m,type:u}=a.properties;if("earthquake"!==u||null==c||null==t||null==n)continue;l.add(a.id);let g=r-m,f=c<2?"#3fb950":c<3?"#7ee787":c<4?"#d29922":c<5?"#f0883e":c<6?"#f85149":"#ff4444",p=Math.min(40,Math.max(3,1.5*Math.pow(2,c-1)));if(o.current.has(a.id))continue;let h=i.circleMarker([t,n],{radius:p,color:f,fillColor:f,fillOpacity:Math.max(.25,.7-g/2592e6),weight:1});h.bindPopup(`
          ...
          </div>`,{maxWidth:250}),h.addTo(e),o.current.set(a.id,h)}o.current.forEach((e,a)=>{l.has(a)||(e.remove(),o.current.delete(a))})}catch{}},[e,a]);return(0,n.useEffect)(()=>{if(!a)return void t();i();let e=setInterval(i,6e5);return()=>{clearInterval(e),t()}},[a,i,t]),null}},{id:"fires",label:"\uD83D\uDD25 Fires",title:"Active wildfires — NASA EONET",defaultEnabled:!1,component:function({map:e,enabled:a}){let o=(0,n.useRef)(new Map),t=(0,n.useCallback)(()=>{o.current.forEach(e=>e.remove()),o.current.clear()},[]),i=(0,n.useCallback)(async()=>{if(e&&a)try{let t=await fetch("https://eonet.gsfc.nasa.gov/api/v3/events?category=wildfires&status=open&limit=500");if(!t.ok||!e||!a)return;let i=await t.json(),r=window.L,l=new Set;for(let a of i.events){var n;let t=a.geometry[a.geometry.length-1];if(!t||"Point"!==t.type)continue;let[i,s]=t.coordinates;if(l.add(a.id),o.current.has(a.id))continue;let c=(n=t.date,Date.now()-new Date(n).getTime()),d=Math.max(.4,1-c/2592e6),m=a.title.replace(/^Wildfire\s*[-–]\s*/i,""),u=r.divIcon({html:`<div style="
          ...
          </div>`,{maxWidth:240}),g.addTo(e),o.current.set(a.id,g)}o.current.forEach((e,a)=>{l.has(a)||(e.remove(),o.current.delete(a))})}catch{}},[e,a]);return(0,n.useEffect)(()=>{if(!a)return void t();i();let e=setInterval(i,18e5);return()=>{clearInterval(e),t()}},[a,i,t]),null}},{id:"radar",label:"\uD83C\uDF27 Radar",title:"Weather radar — RainViewer",defaultEnabled:!1,component:function({map:e,enabled:a}){let o=(0,n.useRef)(null),t=(0,n.useCallback)(()=>{o.current?.remove(),o.current=null},[]),i=(0,n.useCallback)(async()=>{if(e&&a)try{let n=await fetch("https://api.rainviewer.com/public/weather-maps.json");if(!n.ok)return;let t=await n.json();if(!e||!a)return;let i=t.radar.past;if(!i?.length)return;let r=i[i.length-1],l=`${t.host}${r.path}/256/{z}/{x}/{y}/2/1_1.png`;o.current?.remove(),o.current=window.L.tileLayer(l,{opacity:.6,attribution:'<a href="https://www.rainviewer.com">RainViewer</a>'}).addTo(e)}catch{}},[e,a]);return(0,n.useEffect)(()=>{if(!a)return void t();i();let e=setInterval(i,3e5);return()=>{clearInterval(e),t()}},[a,i,t]),null}},{id:"flights",label:"✈ Flights",title:"Live flight traffic — altitude-coded",defaultEnabled:!1,component:function({map:e,enabled:a,zoom:o}){let t=(0,n.useRef)(new Map),i=(0,n.useRef)(new Map),s=(0,n.useRef)(new Map),c=(0,n.useRef)(new Map),d=(0,n.useRef)(new Map),m=(0,n.useRef)(null),u=(0,n.useRef)(null);(0,n.useEffect)(()=>(window.__atlantisFlightFollow=e=>{u.current=u.current===e?null:e},()=>{delete window.__atlantisFlightFollow}),[]);let g=(0,n.useCallback)(()=>{t.current.forEach(e=>e.remove()),t.current.clear(),i.current.forEach(e=>e.remove()),i.current.clear(),s.current.forEach(e=>e.remove()),s.current.clear(),c.current.clear(),d.current.clear(),u.current=null},[]),f=(0,n.useCallback)(async()=>{let n,g,f,p,h,y;if(!e||!a||o<5)return;let x=e.getCenter(),b=(n=e.getBounds(),g=e.getCenter(),f=n.getNorthEast(),p=g.lat*Math.PI/180,h=f.lat*Math.PI/180,Math.min(Math.ceil(6880.13*Math.atan2(Math.sqrt(y=Math.sin((f.lat-g.lat)*Math.PI/180/2)**2+Math.cos(p)*Math.cos(h)*Math.sin((f.lng-g.lng)*Math.PI/180/2)**2),Math.sqrt(1-y))),250)),w=`https://api.airplanes.live/v2/point/${x.lat.toFixed(4)}/${x.lng.toFixed(4)}/${b}`;m.current?.abort(),m.current=new AbortController;try{let o=await fetch(w,{signal:m.current.signal});if(!o.ok)return;let n=await o.json();if(!e||!a)return;let g=window.L,f=Date.now();for(let a of n.ac??[]){let o=null==a.lat||null==a.lon?null:{icao24:a.hex,callsign:a.flight?.trim()||null,lat:a.lat,lon:a.lon,altFt:"number"==typeof a.alt_baro?a.alt_baro:null,speedKts:a.gs??null,heading:a.track??null,vrateFpm:a.baro_rate??null,reg:a.r??null,type:a.t??null};if(!o||null==o.altFt)continue;let n=o.heading??0,m=r(o.altFt),p=u.current===o.icao24,h=g.divIcon({html:function(e,a,o){let n=o?`filter:drop-shadow(0 0 5px ${a}) drop-shadow(0 0 10px ${a});`:"filter:drop-shadow(0 1px 3px rgba(0,0,0,.9));";return`<div style="
  ...
  </div>`}(n,m,p),className:"",iconSize:[22,22],iconAnchor:[11,11]}),y=[...c.current.get(o.icao24)??[],[o.lat,o.lon]].slice(-15);c.current.set(o.icao24,y),d.current.set(o.icao24,f);let x=null!=o.speedKts&&null!=o.heading,b=x?1.852*o.speedKts*.5:0,[w,z]=x?function(e,a,o,n){let t=n/6371,i=e*Math.PI/180,r=o*Math.PI/180,l=Math.asin(Math.sin(i)*Math.cos(t)+Math.cos(i)*Math.sin(t)*Math.cos(r)),s=a*Math.PI/180+Math.atan2(Math.sin(r)*Math.sin(t)*Math.cos(i),Math.cos(t)-Math.sin(i)*Math.sin(l));return[180*l/Math.PI,180*s/Math.PI]}(o.lat,o.lon,o.heading,b):[o.lat,o.lon],v=t.current.get(o.icao24);if(v)v.setLatLng([o.lat,o.lon]),v.setIcon(h),v.getPopup()?.setContent(l(o)),i.current.get(o.icao24)?.setLatLngs([[o.lat,o.lon],[w,z]]),s.current.get(o.icao24)?.setLatLngs(y);else{let a=g.marker([o.lat,o.lon],{icon:h});if(a.bindPopup(l(o),{maxWidth:240}),a.addTo(e),t.current.set(o.icao24,a),x){let a=g.polyline([[o.lat,o.lon],[w,z]],{color:m,weight:1.5,opacity:.35,dashArray:"4 7",interactive:!1});a.addTo(e),i.current.set(o.icao24,a)}if(y.length>1){let a=g.polyline(y,{color:m,weight:1.5,opacity:.45,interactive:!1});a.addTo(e),s.current.set(o.icao24,a)}}}if(t.current.forEach((e,a)=>{let o=d.current.get(a)??0;f-o>5e4&&(e.remove(),t.current.delete(a),i.current.get(a)?.remove(),i.current.delete(a),s.current.get(a)?.remove(),s.current.delete(a),c.current.delete(a),d.current.delete(a),u.current===a&&(u.current=null))}),u.current){let a=t.current.get(u.current);a&&e.panTo(a.getLatLng(),{animate:!0,duration:.5})}}catch(e){if(e instanceof Error&&"AbortError"===e.name)return}},[e,a,o]);return(0,n.useEffect)(()=>{let e;if(!a||o<5)return void g();let n=!1,t=async()=>{await f(),n||(e=setTimeout(t,2e4))};return t(),()=>{n=!0,clearTimeout(e)}},[a,f,g]),(0,n.useEffect)(()=>{let o;if(!e||!a)return;let n=()=>{clearTimeout(o),o=setTimeout(f,1200)};return e.on("moveend",n),()=>{clearTimeout(o),e.off("moveend",n)}},[e,a,f]),null}},{id:"measure",label:"\uD83D\uDCCF Measure",title:"Click two points to measure great-circle distance",defaultEnabled:!1,component:function({map:e,enabled:a}){let o=(0,n.useRef)([]),t=(0,n.useRef)([]),i=(0,n.useRef)([]),r=(0,n.useRef)(null),l=(0,n.useCallback)(()=>{t.current.forEach(e=>e.remove()),t.current=[],i.current.forEach(e=>e.remove()),i.current=[],r.current?.remove(),r.current=null,o.current=[]},[]);return(0,n.useEffect)(()=>{if(!e||!a)return void l();let n=window.L,s=n.divIcon({html:`<div style="
        width:10px;height:10px;
        background:#58a6ff;
        border:2px solid #fff;
        border-radius:50%;
        box-shadow:0 0 6px rgba(88,166,255,.85);
      "></div>`,className:"",iconSize:[10,10],iconAnchor:[5,5]}),c=a=>{let{lat:c,lng:d}=a.latlng;o.current.length>=2&&l(),o.current=[...o.current,[c,d]];let m=n.marker([c,d],{icon:s,interactive:!1}).addTo(e);if(t.current.push(m),2===o.current.length){var u,g,f;let a,[t,l]=o.current,s=n.polyline([t,l],{color:"#58a6ff",weight:2,dashArray:"6 5",opacity:.85,interactive:!1}).addTo(e);i.current.push(s);let c=(u=t[0],g=t[1],12742*Math.atan2(Math.sqrt(a=Math.sin(((f=l[0])-u)*Math.PI/180/2)**2+Math.cos(u*Math.PI/180)*Math.cos(f*Math.PI/180)*Math.sin((l[1]-g)*Math.PI/180/2)**2),Math.sqrt(1-a))),d=(t[0]+l[0])/2,m=(t[1]+l[1])/2;r.current=n.popup({closeButton:!0,autoClose:!1,className:"",offset:[0,-4]}).setLatLng([d,m]).setContent(`
            ...
            </div>`).addTo(e)}};return e.on("click",c),e.getContainer().style.cursor="crosshair",()=>{e.off("click",c),e.getContainer().style.cursor="",l()}},[e,a,l]),null}}].map(e=>[e.id,e]));function c(){return Array.from(s.values())}},8859(e,a,o){o.d(a,{FlyoutPanel:()=>b});var n=o(5723),t=o(7991),i=o.n(t),r=o(6859),l=o.n(r),s=o(2799),c=o(255),d=o(1316),m=o(814),u=o(6140);let g=(0,s.keyframes)`
...
`;function y({iconKey:e}){let a=e?u.t[e]??c.A:c.A;return(0,n.jsx)(a,{size:14,strokeWidth:1.75})}function x({entries:e,activeId:a,onSelect:o}){return(0,n.jsx)(n.Fragment,{children:e.map(e=>e.children?(0,n.jsx)(i().Fragment,{children:(0,n.jsx)(x,{entries:e.children,activeId:a,onSelect:o})},e.id):(0,n.jsxs)(h,{active:a===e.id,onClick:()=>o(e),children:[(0,n.jsx)(y,{iconKey:e.icon}),e.name]},e.id))})}function b({activeId:e}){let{flyout:a,scheduleFlyoutClose:o,cancelFlyoutClose:t}=(0,m.c)();if(!a)return null;let i=a.entry.icon?u.t[a.entry.icon]??c.A:c.A;return(0,n.jsxs)(f,{anchorY:a.anchorY,onMouseEnter:t,onMouseLeave:o,children:[(0,n.jsxs)(p,{children:[(0,n.jsx)(i,{size:13,strokeWidth:2}),a.entry.name]}),(0,n.jsx)(x,{entries:a.entry.children??[],activeId:e,onSelect:e=>{a.onSelect(e),o()}})]})}},814(e,a,o){o.d(a,{I:()=>t,c:()=>i});var n=o(7991);let t=(0,n.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),i=()=>(0,n.useContext)(t)},6140(e,a,o){o.d(a,{t:()=>ex});var n=o(6896),t=o(7902),i=o(3013),r=o(2887),l=o(9510),s=o(9848),c=o(7901),d=o(3045),m=o(3775),u=o(1783),g=o(3539),f=o(9416),p=o(1837),h=o(7167),y=o(4494),x=o(2314),b=o(255),w=o(5751),z=o(9633),v=o(2946),$=o(822),A=o(6720),k=o(7400),M=o(8456),S=o(3317),j=o(2709),T=o(8006),B=o(9301),C=o(7561),E=o(3517),L=o(8207),F=o(7032),P=o(6949),R=o(8218),I=o(6829),_=o(9591),D=o(5553),G=o(9923),N=o(2820),K=o(4621),H=o(8479),O=o(2534),V=o(6673),U=o(7490),W=o(9033),Y=o(9038),Z=o(5775),J=o(1365),q=o(2937),Q=o(9821),X=o(5912),ee=o(158),ea=o(8641),eo=o(8607),en=o(3249),et=o(1821),ei=o(5889),er=o(9655),el=o(7170),es=o(9161),ec=o(1849),ed=o(1604),em=o(3142),eu=o(1187),eg=o(7747),ef=o(2932),ep=o(4525),eh=o(7230),ey=o(2164);let ex={activity:n.A,"a-large-small":t.A,apple:i.A,"arrow-right":r.A,"bar-chart-2":l.A,book:s.A,"book-open":c.A,briefcase:d.A,calendar:m.A,clock:u.A,"circle-dot":g.A,cloud:f.A,compass:p.A,cpu:h.A,droplets:y.A,feather:x.A,file:b.A,"file-text":w.A,folder:z.A,"git-branch":v.A,github:$.A,globe:A.A,grid:k.A,hand:M.A,hash:S.A,heart:j.A,key:T.A,hexagon:B.A,home:C.A,landmark:E.A,layers:L.A,"layout-grid":F.A,leaf:P.A,lightbulb:R.A,list:I.A,map:_.A,"map-pin":D.A,"message-circle":G.A,"message-square":N.A,minus:K.A,monitor:H.A,mountain:O.A,package:V.A,palette:U.A,"pen-tool":W.A,"pie-chart":Y.A,plane:Z.A,plus:J.A,ruler:q.A,shirt:Q.A,slash:X.A,square:ee.A,star:ea.A,sun:eo.A,terminal:en.A,thermometer:et.A,triangle:ei.A,trophy:er.A,truck:el.A,type:es.A,users:ec.A,"volume-2":ed.A,watch:em.A,waves:eu.A,wind:eg.A,wrench:ef.A,x:ep.A,zap:eh.A,bot:ey.A}},5726(e,a,o){o.d(a,{kd:()=>es,u6:()=>Q,MJ:()=>ey,rh:()=>Z,KL:()=>ei,w3:()=>J,Iu:()=>el,fy:()=>ev,rz:()=>ew,$L:()=>q,CD:()=>U,qs:()=>ee,mZ:()=>er,PE:()=>C,w4:()=>n.w4});var n=o(1316),t=o(5723),i=o(7991),r=o.n(i),l=o(6859),s=o.n(l);s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,s().div`
  position: relative;
`;var c=o(2799),d=o(3661),m=o(814);let u="260px",g="56px",f="48px",p=s().header`
  display: flex;
  align-items: center;
...
`,S=s().main`
  ...
  display: flex;
  flex-direction: column;
`,j=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function T(){return(0,t.jsx)(b,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:j.map((e,a)=>(0,t.jsx)(w,{index:a,accent:e.accent,children:e.char},a))})}let B="atlantis:sidebar-collapsed";function C({sidebar:e,children:a,topBarRight:n,title:l="Atlantis",activeId:s=null}){let[c,u]=(0,i.useState)(()=>{try{return"true"===localStorage.getItem(B)}catch{return!1}}),[g,f]=(0,i.useState)(null),x=(0,i.useRef)(),b=()=>u(e=>{let a=!e;try{localStorage.setItem(B,String(a))}catch{}return a}),w=r().useMemo(()=>r().lazy(()=>Promise.resolve().then(o.bind(o,8859)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,t.jsx)(m.I.Provider,{value:{collapsed:c,toggle:b,flyout:g,openFlyout:(e,a,o)=>{clearTimeout(x.current),f({entry:e,anchorY:a,onSelect:o})},scheduleFlyoutClose:()=>{x.current=setTimeout(()=>f(null),160)},cancelFlyoutClose:()=>clearTimeout(x.current)},children:(0,t.jsxs)(A,{children:[(0,t.jsxs)(p,{children:[e&&(0,t.jsx)(h,{children:(0,t.jsx)(y,{onClick:b,title:c?"Expand sidebar":"Collapse sidebar",children:(0,t.jsx)(d.A,{size:17})})}),(0,t.jsx)(T,{}),l&&(0,t.jsx)(z,{children:l}),n&&(0,t.jsx)(v,{children:n})]}),(0,t.jsxs)($,{children:[null!=e&&(0,t.jsx)(k,{collapsed:c,children:(0,t.jsx)(M,{children:e})}),(0,t.jsx)(S,{children:a})]}),g&&(0,t.jsx)(r().Suspense,{fallback:null,children:(0,t.jsx)(w,{activeId:s})})]})})}var E=o(255),L=o(9753),F=o(6140);let P=s().div`
  display: grid;
...
`;function O({iconKey:e,size:a=16}){if(e&&!(e in F.t))return(0,t.jsx)("span",{style:{fontSize:a,lineHeight:1,display:"flex",alignItems:"center"},children:e});let o=e?F.t[e]??E.A:E.A;return(0,t.jsx)(o,{size:a,strokeWidth:1.75})}function V({entry:e,activeId:a,onSelect:o}){let[n,r]=(0,i.useState)(e.defaultOpen??!0),{collapsed:l,openFlyout:s,scheduleFlyoutClose:c,cancelFlyoutClose:d}=(0,m.c)();return e.children&&e.children.length>0?(0,t.jsxs)(_,{children:[(0,t.jsxs)(D,{collapsed:l,onClick:()=>{l||r(e=>!e)},onMouseEnter:l?a=>{s(e,a.currentTarget.getBoundingClientRect().top,o)}:void 0,onMouseLeave:l?c:void 0,children:[(0,t.jsxs)(G,{collapsed:l,children:[(0,t.jsx)(O,{iconKey:e.icon,size:16}),(0,t.jsx)(N,{collapsed:l,children:e.name})]}),(0,t.jsx)(K,{open:n,collapsed:l,children:(0,t.jsx)(L.A,{size:13})})]}),(0,t.jsx)(P,{open:n&&!l,children:(0,t.jsx)(R,{children:(0,t.jsx)(I,{children:e.children.map(e=>(0,t.jsx)(V,{entry:e,activeId:a,onSelect:o},e.id))})})})]}):(0,t.jsxs)(H,{active:a===e.id,collapsed:l,onClick:()=>o(e),onMouseEnter:l?a=>{let n=a.currentTarget.getBoundingClientRect();s({id:e.id,name:e.name,icon:e.icon,file:e.file,children:[e]},n.top,o)}:void 0,onMouseLeave:l?c:void 0,children:[(0,t.jsx)(O,{iconKey:e.icon,size:15}),(0,t.jsx)(N,{collapsed:l,children:e.name})]})}function U({entries:e,activeId:a,onSelect:o}){return(0,t.jsx)("div",{children:e.map(e=>(0,t.jsx)(V,{entry:e,activeId:a,onSelect:o},e.id))})}let W=(0,c.keyframes)`
...
`,eh=s().div`
  ...
  color: ${n.w4.colors.sidebarTextMuted};
  font-family: ${n.w4.typography.fontFamily};
`;function ey({onSave:e,onUpdate:a,onCancel:o,existingDoc:n}){let[r,l]=(0,i.useState)(n?.name??""),s=(0,i.useRef)(null);return(0,i.useEffect)(()=>{s.current?.focus(),n&&s.current?.select()},[n]),(0,t.jsx)(ec,{onClick:o,children:(0,t.jsxs)(ed,{onClick:e=>e.stopPropagation(),children:[(0,t.jsx)(em,{children:"Save document"}),n&&a&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(eh,{children:"Update the current version or save as a new one."}),(0,t.jsxs)(eg,{children:[(0,t.jsx)(ef,{onClick:o,children:"Cancel"}),(0,t.jsxs)(ef,{danger:!0,onClick:a,children:['Update "',n.name,'"']})]}),(0,t.jsx)(ep,{})]}),(0,t.jsx)(eu,{ref:s,value:r,onChange:e=>l(e.target.value),onKeyDown:t=>{"Enter"===t.key&&r.trim()&&(n&&r.trim()===n.name&&a?a():e(r.trim())),"Escape"===t.key&&o()},placeholder:n?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,t.jsxs)(eg,{children:[!n&&(0,t.jsx)(ef,{onClick:o,children:"Cancel"}),(0,t.jsx)(ef,{primary:!0,disabled:!r.trim(),onClick:()=>e(r.trim()),children:"Save as new"})]})]})})}let ex=(0,c.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,eb=(0,c.keyframes)`
  from { opacity: 0; transform: scale(0.96) translateY(6px); }
  to   { opacity: 1; transform: scale(1)    translateY(0);   }
`;function ew(e,a=8){let[o,n]=(0,i.useState)(()=>(function(e){try{return JSON.parse(localStorage.getItem(e)??"[]")}catch{return[]}})(e));return{recent:o,addRecent:(0,i.useCallback)(o=>{n(n=>{let t=[o,...n.filter(e=>e!==o)].slice(0,a);try{localStorage.setItem(e,JSON.stringify(t))}catch{}return t})},[e,a])}}function ez(){let e="u">typeof window?window.location.hash:"",a=e.indexOf("?");if(-1===a)return{};let o={};for(let n of e.slice(a+1).split("&")){if(!n)continue;let e=n.indexOf("=");-1===e?o[decodeURIComponent(n)]="":o[decodeURIComponent(n.slice(0,e))]=decodeURIComponent(n.slice(e+1))}return o}function ev(){let[e,a]=(0,i.useState)(ez);return(0,i.useEffect)(()=>{let e=()=>a(ez());return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[]),e}s().div`
  position: fixed;
  inset: 0;
...
`,s().div`
  ...
  flex-direction: column;
  gap: 14px;
  animation: ${eb} 0.18s cubic-bezier(0.22, 1, 0.36, 1) both;
`,s().div`
  font-size: ${n.w4.typography.fontSizeMd};
  font-weight: 700;
