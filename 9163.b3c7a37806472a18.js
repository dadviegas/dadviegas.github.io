...
`,s().span`
  font-size: ${l.w4.typography.fontSizeBase};
  color: ${l.w4.colors.mainTextMuted};
`;var tf=a(17223),tb=a(21426);let tx=s().div`
  margin: ${l.w4.spacing.lg} 0;
  border-radius: ${l.w4.borderRadius.md};
  border: 1px solid ${l.w4.colors.codeBorder};
  overflow: hidden;
...
`,t$={...tb.A,'pre[class*="language-"]':{...tb.A['pre[class*="language-"]'],background:l.w4.colors.codeBg,margin:0,padding:"18px 20px",fontSize:"13px",lineHeight:"1.6",borderRadius:0},'code[class*="language-"]':{...tb.A['code[class*="language-"]'],background:"none",fontSize:"13px"}};function tk({lang:e="text",code:t}){let[a,r]=(0,o.useState)(!1);return(0,i.jsxs)(tx,{children:[(0,i.jsxs)(ty,{children:[(0,i.jsx)(tw,{children:e}),(0,i.jsxs)(tv,{copied:a,onClick:()=>{navigator.clipboard.writeText(t).then(()=>{r(!0),setTimeout(()=>r(!1),2e3)})},children:[a?(0,i.jsx)(F,{name:"check",size:12}):(0,i.jsx)(F,{name:"copy",size:12}),a?"Copied!":"Copy"]})]}),(0,i.jsx)(tf.A,{language:e,style:t$,showLineNumbers:t.split("\n").length>8,lineNumberStyle:{color:"#484f58",minWidth:"2.5em",paddingRight:"1.5em",userSelect:"none",fontSize:"12px"},customStyle:{margin:0,background:l.w4.colors.codeBg},wrapLongLines:!1,children:t})]})}let tM={NOTE:{bg:"rgba(88, 166, 255, 0.08)",border:"#58a6ff",icon:"info",label:"Note",color:"#58a6ff"},TIP:{bg:"rgba(63, 185, 80, 0.08)",border:"#3fb950",icon:"lightbulb",label:"Tip",color:"#3fb950"},IMPORTANT:{bg:"rgba(163, 113, 247, 0.08)",border:"#a371f7",icon:"zap",label:"Important",color:"#a371f7"},WARNING:{bg:"rgba(210, 153, 34, 0.08)",border:"#d29922",icon:"alert-triangle",label:"Warning",color:"#d29922"},CAUTION:{bg:"rgba(248, 81, 73, 0.08)",border:"#f85149",icon:"alert-octagon",label:"Caution",color:"#f85149"}},tj=s().div`
  background: ${({bg:e})=>e};
...
`;function tC({type:e,children:t}){let a=tM[e]??tM.NOTE;return(0,i.jsxs)(tj,{bg:a.bg,border:a.border,children:[(0,i.jsxs)(tz,{color:a.color,children:[(0,i.jsx)(F,{name:a.icon,size:15,strokeWidth:2}),a.label]}),(0,i.jsx)(tS,{children:t})]})}s().nav`
  width: 220px;
  min-width: 220px;
...
`;function tN({children:e}){return(0,i.jsx)(tL,{children:(0,i.jsx)(eJ.oz,{remarkPlugins:[eQ.A,eX.A,tF],rehypePlugins:[eZ.A,e0.A],components:{div({node:e,children:t,...a}){let o=a["data-callout"];return o?(0,i.jsx)(tC,{type:o,children:t}):(0,i.jsx)("div",{...a,children:t})},pre:({children:e})=>(0,i.jsx)(i.Fragment,{children:e}),code({className:e,children:t}){let a=/language-(\w+)/.exec(e??"")?.[1],o=String(t).replace(/\n$/,"");return o.trim()?"mermaid"===a?(0,i.jsx)(tt,{code:o}):"chart"===a?(0,i.jsx)(tm,{code:o}):a||o.includes("\n")?(0,i.jsx)(tk,{lang:a,code:o}):(0,i.jsx)("code",{className:e,children:t}):null}},children:e})})}s().nav`
  display: flex;
  flex-direction: column;
  gap: 1px;
  padding: ${l.w4.spacing.sm} 0;
...
`;function tq({size:e}){return(0,i.jsxs)("svg",{width:14,height:14,viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:[(0,i.jsx)("rect",{x:1.5,y:4.5,width:11,height:5,rx:1,stroke:"currentColor",strokeWidth:1,opacity:.4}),(0,i.jsx)("rect",{x:2,y:5,width:"sm"===e?4:"md"===e?7:11,height:4,rx:.5,fill:"currentColor"})]})}let tB={sm:1,md:2,lg:"full"};function tG({items:e,onReorder:t,onCycleSize:a,onRemove:o,renderPanel:r,renderAccessory:n,showGrip:s=!0,labels:l,accentColor:d}){return(0,i.jsx)(tI,{children:e.map((c,p)=>{let u=tB[c.size],m="full"===u,g=c.minHeight??160,h=d?.(c),f=(c.availableSizes??["sm","md","lg"]).length>1,b=n?.(c);return(0,i.jsxs)(tD,{colSpan:m?1:u,fullWidth:m,children:[b&&(0,i.jsx)(tR,{children:b}),(0,i.jsxs)(tH,{minH:g,accent:h,"data-grip":s?"true":"false",children:[(0,i.jsxs)(tE,{className:"panel-controls",children:[p>0&&(0,i.jsx)(tO,{type:"button",title:l.moveLeft,onClick:()=>t(c.id,-1),children:(0,i.jsx)(F,{name:"chevron-left",size:14})}),p<e.length-1&&(0,i.jsx)(tO,{type:"button",title:l.moveRight,onClick:()=>t(c.id,1),children:(0,i.jsx)(F,{name:"chevron-right",size:14})}),f&&(0,i.jsx)(tO,{type:"button",title:`${l.cycleSize} \xb7 ${c.size.toUpperCase()}`,onClick:()=>a(c.id),children:(0,i.jsx)(tq,{size:c.size})}),o&&l.remove&&(0,i.jsx)(tK,{type:"button",title:l.remove,onClick:()=>o(c.id),children:(0,i.jsx)(F,{name:"close",size:14})})]}),r(c)]})]},c.id)})})}let tW=(0,C.keyframes)`
...
`,tU=s().div`
  ...
  flex-direction: column;
  gap: 14px;
  animation: ${t_} 0.18s cubic-bezier(0.22, 1, 0.36, 1) both;
`,tJ=s().div`
  font-size: ${l.w4.typography.fontSizeMd};
  font-weight: 700;
...
`,tZ=s().button`
  ...
  &:hover { opacity: 0.88; }
  &:focus-visible { ${l.w4.focusRing} }
`;function t0({open:e,title:t,message:a,confirmLabel:r,cancelLabel:n,onConfirm:s,onCancel:l,danger:d=!1}){return((0,o.useEffect)(()=>{if(!e)return;let t=e=>{"Escape"===e.key&&l(),"Enter"===e.key&&s()};return document.addEventListener("keydown",t),()=>document.removeEventListener("keydown",t)},[e,l,s]),e)?(0,i.jsx)(tV,{onClick:l,role:"dialog","aria-modal":"true","aria-label":t,children:(0,i.jsxs)(tU,{danger:d,onClick:e=>e.stopPropagation(),children:[(0,i.jsx)(tJ,{danger:d,children:t}),(0,i.jsx)(tQ,{children:a}),(0,i.jsxs)(tX,{children:[(0,i.jsx)(tZ,{onClick:l,children:n}),(0,i.jsx)(tZ,{danger:d,primary:!d,onClick:s,autoFocus:!0,children:r})]})]})}):null}let t1=(0,C.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,t4=(0,C.keyframes)`
