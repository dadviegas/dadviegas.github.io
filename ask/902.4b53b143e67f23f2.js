...
`,u=i().forwardRef(function({variant:e="ghost",size:o="md",icon:r,iconRight:a,children:i,...n},l){return(0,t.jsxs)(b,{ref:l,variant:e,size:o,...n,children:[r,i,a]})}),w={default:s.w4.colors.accent,danger:"#f85149"},y={default:s.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"},$=l().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`,v=i().forwardRef(function({active:e=!1,shape:o="square",tone:r="default",children:a,...i},n){return(0,t.jsx)($,{ref:n,active:e,shape:o,tone:r,...i,children:a})}),k=l().div`
  position: relative;
  display: inline-flex;
`,M=l().div`
  position: absolute;
  ...
  z-index: 2000;
  overflow: hidden;
`;function z({trigger:e,children:o,align:r="right",open:n,onOpenChange:l}){let[s,d]=(0,a.useState)(!1),p=n??s,c=e=>{l&&l(e),void 0===n&&d(e)},g=(0,a.useRef)(null);(0,a.useEffect)(()=>{if(!p)return;let e=e=>{g.current&&!g.current.contains(e.target)&&c(!1)};return document.addEventListener("mousedown",e),()=>document.removeEventListener("mousedown",e)},[p]);let x=i().cloneElement(e,{onClick:o=>{e.props.onClick?.(o),c(!p)},"aria-expanded":p,"aria-haspopup":"menu"});return(0,t.jsxs)(k,{ref:g,children:[x,p&&(0,t.jsx)(M,{align:r,role:"menu",children:o})]})}let T=l().button`
  display: flex;
  align-items: center;
  gap: 10px;
  padding: 8px 12px;
...
`,l().span`
  ...
  display: inline-block;
`;let R={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:s.w4.colors.accentMuted},H={neutral:s.w4.colors.mainTextMuted,live:s.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:s.w4.colors.accent};l().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${s.w4.typography.fontFamilyMono};
...
`;let L=l().kbd`
  ...
  white-space: nowrap;
`;function P({children:e,...o}){return(0,t.jsx)(L,{...o,children:e})}let V=l().div`
  font-family: ${s.w4.typography.fontFamilyMono};
  font-size: 11px;
  ...
  align-items: center;
  gap: 8px;
`;function E({children:e,...o}){return(0,t.jsx)(V,{...o,children:e})}l().label`
  display: flex;
  align-items: center;
  gap: 10px;
...
`,l().p`
  ...
  font-size: 12.5px;
  line-height: 1.45;
`;var Y=r(11352),N=r(76710),D=r(4311),O=r(73639),W=r(40080);r(75406),l().nav`padding: ${s.w4.spacing.sm} 0;`,l().div`
...
`;var q=r(54041);let G="https://cdn.jsdelivr.net/npm/mermaid@11.14.0/dist/mermaid.min.js",X=null,_="#7fb77e",K=(0,S.keyframes)`
...
`,Q=!1,ee=/^(?:---[\s\S]*?---\s*)?(?:graph|flowchart|sequenceDiagram|classDiagram|stateDiagram(?:-v2)?|erDiagram|pie|gantt|journey|mindmap|gitGraph|sankey(?:-beta)?|quadrantChart|requirementDiagram|timeline|xychart-beta|block-beta|C4Context|C4Container|C4Component|C4Dynamic|C4Deployment)\b/;function eo({code:e}){let[o,r]=(0,a.useState)(""),[i,n]=(0,a.useState)(!1);return((0,a.useEffect)(()=>{let o=!1;n(!1),r("");let t=e.trim();if(!t)return void n(!0);let a=t.split(/\r?\n/)[0]?.trim()??"";if(!ee.test(a))return void n(!0);let i=setTimeout(()=>{o||(console.error("[MermaidBlock] render timed out after 5s"),n(!0))},5e3);return(async()=>{try{let e=await (X||(X=new Promise((e,o)=>{let r=globalThis.mermaid;if(r)return void e(r);let t=document.createElement("script");t.src=G,t.async=!0,t.onload=()=>{let r=globalThis.mermaid;r?e(r):o(Error("mermaid loaded but globalThis.mermaid missing"))},t.onerror=()=>o(Error(`failed to load ${G}`)),document.head.appendChild(t)})));if(console.debug("[MermaidBlock] mermaid ready",{initialized:Q}),!Q){let o="#141820",r="#1c2332",t="#343c4f",a="#e8edf5",i="#9aa5b8",n="#7fb77e",l="#6aa8d8",s="#8b7bff",d="#e89a5c",p="#f87171";e.initialize({startOnLoad:!1,theme:"base",securityLevel:"loose",themeVariables:{fontFamily:"-apple-system, BlinkMacSystemFont, Segoe UI, Helvetica, Arial, sans-serif",background:o,mainBkg:r,primaryColor:n,primaryTextColor:a,primaryBorderColor:n,secondaryColor:s,secondaryTextColor:a,secondaryBorderColor:s,tertiaryColor:l,tertiaryTextColor:a,tertiaryBorderColor:l,lineColor:i,textColor:a,nodeBorder:t,clusterBkg:o,clusterBorder:t,edgeLabelBackground:r,labelBackground:r,labelBorder:t,relationLabelBackground:r,relationLabelColor:a,pie1:n,pie2:s,pie3:l,pie4:d,pie5:"#ff6fa9",pie6:"#2dd4bf",pie7:p,pie8:n,pieStrokeColor:o,pieStrokeWidth:"2px",pieTitleTextSize:"18px",pieSectionTextSize:"13px",pieLegendTextSize:"13px",actorBkg:n,actorBorder:n,actorTextColor:o,signalColor:a,signalTextColor:a,labelBoxBkgColor:r,labelBoxBorderColor:t,labelTextColor:a,loopTextColor:a,noteBkgColor:d,noteBorderColor:d,noteTextColor:o,stateBkg:r,altBackground:o,attributeBackgroundColorOdd:r,attributeBackgroundColorEven:o,rowOdd:r,rowEven:o,gridColor:t,sectionBkgColor:r,sectionBkgColor2:o,taskBkgColor:s,taskTextColor:a,taskTextDarkColor:a,taskTextLightColor:a,taskTextOutsideColor:a,activeTaskBkgColor:n,activeTaskBorderColor:n,doneTaskBkgColor:i,doneTaskBorderColor:i,critBkgColor:p,critBorderColor:p}}),Q=!0}console.debug("[MermaidBlock] calling mermaid.render");let{svg:a}=await e.render(`mermaid-${(0,q.z)()}`,t);if(clearTimeout(i),console.debug("[MermaidBlock] render returned",{length:a?.length??0}),o)return;if(!a||/aria-roledescription="error"/i.test(a))return void n(!0);r(a)}catch(e){clearTimeout(i),console.error("[MermaidBlock] render failed",e),o||n(!0)}})(),()=>{o=!0,clearTimeout(i)}},[e]),i)?(0,t.jsx)(J,{children:e.trim()}):o?(0,t.jsx)(U,{dangerouslySetInnerHTML:{__html:o}}):(0,t.jsx)(U,{children:(0,t.jsx)(Z,{"aria-hidden":!0})})}let er=["#388bfd","#3fb950","#d29922","#a371f7","#f87171","#22d3ee","#fb923c","#34d399","#f472b6","#818cf8"],et=l().div`
  background: ${s.w4.colors.codeBg};
  border: 1px solid ${s.w4.colors.codeBorder};
  border-radius: ${s.w4.borderRadius.md};
...
`,es=l().pre`
  ...
  color: ${s.w4.colors.mainTextMuted};
  white-space: pre-wrap;
`;function ed(e){if(e<=0)return 10;let o=Math.pow(10,Math.floor(Math.log10(e)));return Math.ceil(e/o)*o}function ep({labels:e,data:o,colors:r}){let a=340,i=176,n=ed(Math.max(...o,1)),l=Math.min(40,a/e.length*.6),d=a/e.length,p=Array.from({length:6},(e,o)=>n/5*o);return(0,t.jsxs)("svg",{viewBox:"0 0 400 240",width:"100%",style:{maxWidth:400},children:[p.map((e,o)=>{let r=16+i-e/n*i;return(0,t.jsxs)("g",{children:[(0,t.jsx)("line",{x1:44,y1:r,x2:384,y2:r,stroke:s.w4.colors.border,strokeWidth:.5,strokeDasharray:0===o?"none":"3,3"}),(0,t.jsx)("text",{x:38,y:r+4,fill:s.w4.colors.mainTextMuted,fontSize:10,textAnchor:"end",fontFamily:s.w4.typography.fontFamily,children:Math.round(e)})]},o)}),o.map((o,a)=>{let p=44+d*a+d/2-l/2,c=o/n*i,g=16+i-c,x=r[a%r.length];return(0,t.jsxs)("g",{children:[(0,t.jsxs)("rect",{x:p,y:g,width:l,height:c,rx:3,fill:x,opacity:.85,children:[(0,t.jsx)("animate",{attributeName:"height",from:"0",to:c,dur:"0.5s",fill:"freeze"}),(0,t.jsx)("animate",{attributeName:"y",from:16+i,to:g,dur:"0.5s",fill:"freeze"})]}),(0,t.jsx)("text",{x:p+l/2,y:g-4,fill:s.w4.colors.mainText,fontSize:10,fontWeight:600,textAnchor:"middle",fontFamily:s.w4.typography.fontFamily,children:o}),(0,t.jsx)("text",{x:44+d*a+d/2,y:208,fill:s.w4.colors.mainTextMuted,fontSize:10,textAnchor:"middle",fontFamily:s.w4.typography.fontFamily,children:e[a].length>8?e[a].slice(0,7)+"…":e[a]})]},a)})]})}function ec({labels:e,data:o,colors:r}){let a=o.reduce((e,o)=>e+o,0)||1,i=-Math.PI/2,n=o.map((e,o)=>{let n=e/a*Math.PI*2,l=i,d=i+=n,p=120+90*Math.cos(l),c=120+90*Math.sin(l),g=120+90*Math.cos(d),x=120+90*Math.sin(d),f=+(n>Math.PI),h=l+n/2,m=120+58.5*Math.cos(h),b=120+58.5*Math.sin(h),u=Math.round(e/a*100);return(0,t.jsxs)("g",{children:[(0,t.jsx)("path",{d:`M 120 120 L ${p} ${c} A 90 90 0 ${f} 1 ${g} ${x} Z`,fill:r[o%r.length],stroke:s.w4.colors.codeBg,strokeWidth:2,opacity:.85}),u>=5&&(0,t.jsxs)("text",{x:m,y:b+4,fill:"#fff",fontSize:11,fontWeight:600,textAnchor:"middle",fontFamily:s.w4.typography.fontFamily,children:[u,"%"]})]},o)});return(0,t.jsx)("svg",{viewBox:"0 0 240 240",width:"100%",style:{maxWidth:240},children:n})}function eg({labels:e,data:o,colors:r}){let a=340,i=176,n=ed(Math.max(...o,1)),l=o.length>1?a/(o.length-1):a,d=r[0],p=o.map((e,o)=>({x:44+l*o,y:16+i-e/n*i})),c=p.map((e,o)=>`${0===o?"M":"L"} ${e.x} ${e.y}`).join(" "),g=Array.from({length:6},(e,o)=>n/5*o);return(0,t.jsxs)("svg",{viewBox:"0 0 400 240",width:"100%",style:{maxWidth:400},children:[g.map((e,o)=>{let r=16+i-e/n*i;return(0,t.jsxs)("g",{children:[(0,t.jsx)("line",{x1:44,y1:r,x2:384,y2:r,stroke:s.w4.colors.border,strokeWidth:.5,strokeDasharray:0===o?"none":"3,3"}),(0,t.jsx)("text",{x:38,y:r+4,fill:s.w4.colors.mainTextMuted,fontSize:10,textAnchor:"end",fontFamily:s.w4.typography.fontFamily,children:Math.round(e)})]},o)}),(0,t.jsx)("path",{d:c,fill:"none",stroke:d,strokeWidth:2.5,strokeLinecap:"round",strokeLinejoin:"round"}),p.map((r,a)=>(0,t.jsxs)("g",{children:[(0,t.jsx)("circle",{cx:r.x,cy:r.y,r:4,fill:d,stroke:s.w4.colors.codeBg,strokeWidth:2}),(0,t.jsx)("text",{x:r.x,y:r.y-10,fill:s.w4.colors.mainText,fontSize:10,fontWeight:600,textAnchor:"middle",fontFamily:s.w4.typography.fontFamily,children:o[a]}),(0,t.jsx)("text",{x:r.x,y:208,fill:s.w4.colors.mainTextMuted,fontSize:10,textAnchor:"middle",fontFamily:s.w4.typography.fontFamily,children:e[a].length>8?e[a].slice(0,7)+"…":e[a]})]},a))]})}function ex({code:e}){let o=(0,a.useMemo)(()=>(function(e){let o,r,t=e.trim().split("\n"),a="bar",i=[],n=[];for(let e of t){let[t,...l]=e.split(":"),s=l.join(":").trim();if(s)switch(t.trim().toLowerCase()){case"type":["bar","pie","line"].includes(s.toLowerCase())&&(a=s.toLowerCase());break;case"title":o=s;break;case"labels":i=s.replace(/^\[|\]$/g,"").split(",").map(e=>e.trim());break;case"data":n=s.replace(/^\[|\]$/g,"").split(",").map(e=>parseFloat(e.trim())||0);break;case"colors":r=s.replace(/^\[|\]$/g,"").split(",").map(e=>e.trim())}}return i.length&&n.length?{type:a,title:o,labels:i,data:n,colors:r}:null})(e),[e]);if(!o)return(0,t.jsx)(es,{children:e.trim()});let r=o.colors??er;return(0,t.jsxs)(et,{children:[o.title&&(0,t.jsx)(ea,{children:o.title}),"bar"===o.type&&(0,t.jsx)(ep,{labels:o.labels,data:o.data,colors:r}),"pie"===o.type&&(0,t.jsx)(ec,{labels:o.labels,data:o.data,colors:r}),"line"===o.type&&(0,t.jsx)(eg,{labels:o.labels,data:o.data,colors:r}),(0,t.jsx)(ei,{children:o.labels.map((e,o)=>(0,t.jsxs)(en,{children:[(0,t.jsx)(el,{color:r[o%r.length]}),e]},o))})]})}l().div`
  background: ${s.w4.colors.codeBg};
  border: 1px solid ${s.w4.colors.codeBorder};
  border-radius: ${s.w4.borderRadius.md};
  padding: ${s.w4.spacing.lg};
...
`,l().span`
  font-size: ${s.w4.typography.fontSizeBase};
  color: ${s.w4.colors.mainTextMuted};
`;var em=r(17223),eb=r(21426),eu=r(25609),ew=r(20320);let ey=l().div`
  margin: ${s.w4.spacing.lg} 0;
  border-radius: ${s.w4.borderRadius.md};
  border: 1px solid ${s.w4.colors.codeBorder};
  overflow: hidden;
...
`,eM={...eb.A,'pre[class*="language-"]':{...eb.A['pre[class*="language-"]'],background:s.w4.colors.codeBg,margin:0,padding:"18px 20px",fontSize:"13px",lineHeight:"1.6",borderRadius:0},'code[class*="language-"]':{...eb.A['code[class*="language-"]'],background:"none",fontSize:"13px"}};function ez({lang:e="text",code:o}){let[r,i]=(0,a.useState)(!1);return(0,t.jsxs)(ey,{children:[(0,t.jsxs)(e$,{children:[(0,t.jsx)(ev,{children:e}),(0,t.jsxs)(ek,{copied:r,onClick:()=>{navigator.clipboard.writeText(o).then(()=>{i(!0),setTimeout(()=>i(!1),2e3)})},children:[r?(0,t.jsx)(eu.A,{size:12}):(0,t.jsx)(ew.A,{size:12}),r?"Copied!":"Copy"]})]}),(0,t.jsx)(em.A,{language:e,style:eM,showLineNumbers:o.split("\n").length>8,lineNumberStyle:{color:"#484f58",minWidth:"2.5em",paddingRight:"1.5em",userSelect:"none",fontSize:"12px"},customStyle:{margin:0,background:s.w4.colors.codeBg},wrapLongLines:!1,children:o})]})}var eT=r(65569),eS=r(8218),eF=r(57230),ej=r(22966),eC=r(21069);let eB={NOTE:{bg:"rgba(88, 166, 255, 0.08)",border:"#58a6ff",icon:eT.A,label:"Note",color:"#58a6ff"},TIP:{bg:"rgba(63, 185, 80, 0.08)",border:"#3fb950",icon:eS.A,label:"Tip",color:"#3fb950"},IMPORTANT:{bg:"rgba(163, 113, 247, 0.08)",border:"#a371f7",icon:eF.A,label:"Important",color:"#a371f7"},WARNING:{bg:"rgba(210, 153, 34, 0.08)",border:"#d29922",icon:ej.A,label:"Warning",color:"#d29922"},CAUTION:{bg:"rgba(248, 81, 73, 0.08)",border:"#f85149",icon:eC.A,label:"Caution",color:"#f85149"}},eA=l().div`
  background: ${({bg:e})=>e};
...
`;function eL({type:e,children:o}){let r=eB[e]??eB.NOTE,a=r.icon;return(0,t.jsxs)(eA,{bg:r.bg,border:r.border,children:[(0,t.jsxs)(eR,{color:r.color,children:[(0,t.jsx)(a,{size:15,strokeWidth:2}),r.label]}),(0,t.jsx)(eH,{children:o})]})}l().nav`
  width: 220px;
  min-width: 220px;
...
`,l().div`
  ...
  font-family: ${s.w4.typography.fontFamily};
`;let eP=(0,S.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,eV=(0,S.keyframes)`
  from { opacity: 0; transform: translateY(16px) scale(0.98); }
  to   { opacity: 1; transform: translateY(0) scale(1); }
`;function eE(){let e=/^\[!(NOTE|TIP|WARNING|CAUTION|IMPORTANT)\]\s*/i;return o=>{function r(o,r,t){let a=r.children?.[0];a?.type==="text"&&(a.value=a.value.replace(e,""),a.value.trim()||1!==r.children.length||r.children.shift()),o.data=o.data??{},o.data.hName="div",o.data.hProperties={"data-callout":t.toUpperCase()}}!function o(t){if("blockquote"===t.type){let o=t.children?.[0];if(o?.type==="paragraph"){let a=o.children?.[0],i=a?.type==="text"&&a.value?.match(e);i&&r(t,o,i[1])}}if("paragraph"===t.type){let o=t.children?.[0],a=o?.type==="text"&&o.value?.match(e);if(a){let o=[...t.children];t.children=[{type:"paragraph",children:o}],r(t,t.children[0],a[1]);let i=o[0];i?.type==="text"&&(i.value=i.value.replace(e,""),i.value.trim()||1!==o.length||o.shift());return}}t.children?.forEach(o)}(o)}}l().div`
  position: fixed;
  inset: 0;
  z-index: 9999;
...
`;function eY({children:e}){return(0,t.jsx)(eI,{children:(0,t.jsx)(Y.oz,{remarkPlugins:[N.A,D.A,eE],rehypePlugins:[O.A,W.A],components:{div({node:e,children:o,...r}){let a=r["data-callout"];return a?(0,t.jsx)(eL,{type:a,children:o}):(0,t.jsx)("div",{...r,children:o})},pre:({children:e})=>(0,t.jsx)(t.Fragment,{children:e}),code({className:e,children:o}){let r=/language-(\w+)/.exec(e??"")?.[1],a=String(o).replace(/\n$/,"");return a.trim()?"mermaid"===r?(0,t.jsx)(eo,{code:a}):"chart"===r?(0,t.jsx)(ex,{code:a}):r||a.includes("\n")?(0,t.jsx)(ez,{lang:r,code:a}):(0,t.jsx)("code",{className:e,children:o}):null}},children:e})})}l().nav`
  display: flex;
  flex-direction: column;
  gap: 1px;
  padding: ${s.w4.spacing.sm} 0;
...
`;l().div`
  ...
  pointer-events: none;
  z-index: 200;
  animation: ${eO} 0.16s cubic-bezier(0.4, 0, 0.2, 1) forwards;
...
`;l().div`
  ...
  background: ${s.w4.colors.mainBg};
  font-family: ${s.w4.typography.fontFamily};
  animation: ${eG} 0.4s ease 0.15s both;
`,l().div`
  position: relative;
  width: 56px;
  height: 56px;
...
`,l().div`
  ...
  border-radius: 50%;
  background: ${s.w4.colors.border};
  animation: ${e_} 1.4s ease-in-out infinite;
`,l().span`
  color: ${s.w4.colors.mainTextMuted};
  font-size: ${s.w4.typography.fontSizeSm};
  letter-spacing: 0.04em;
