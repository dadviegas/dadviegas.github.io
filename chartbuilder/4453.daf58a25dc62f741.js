"use strict";(self.webpackChunk_atlantis_chartbuilder=self.webpackChunk_atlantis_chartbuilder||[]).push([["4453"],{1317(o,e,a){a.d(e,{Cd:()=>i,LH:()=>t,Qh:()=>r,YH:()=>l,YL:()=>n,aT:()=>s});let t={Default:["#388bfd","#3fb950","#d29922","#a371f7","#f87171","#22d3ee","#fb923c","#34d399"],Sunset:["#f97316","#ef4444","#ec4899","#a855f7","#8b5cf6","#6366f1","#f59e0b","#10b981"],Ocean:["#06b6d4","#0ea5e9","#3b82f6","#6366f1","#8b5cf6","#a855f7","#0891b2","#1d4ed8"],Forest:["#22c55e","#16a34a","#15803d","#86efac","#4ade80","#bbf7d0","#166534","#14532d"]};function r(o){let e=o.trim().split("\n").filter(o=>o.trim());return e.length<2?{headers:[],rows:[]}:{headers:e[0].split(",").map(o=>o.trim()),rows:e.slice(1).map(o=>{let e=o.split(",").map(o=>o.trim());return{label:e[0]??"",values:e.slice(1).map(o=>parseFloat(o)||0)}})}}function n(o,e){let a={top:30,right:20,bottom:50,left:60};return{pad:a,w:o-a.left-a.right,h:e-a.top-a.bottom}}function i(o){if(o<=0)return 10;let e=Math.pow(10,Math.floor(Math.log10(o)));return Math.ceil(o/e)*e}function l(o,e=5){let a=i(o)/e;return Array.from({length:e+1},(o,e)=>e*a)}function s(o){return Math.abs(o)>=1e6?(o/1e6).toFixed(1)+"M":Math.abs(o)>=1e3?(o/1e3).toFixed(0)+"k":String(Math.round(10*o)/10)}},5151(o,e,a){a.d(e,{k:()=>t});let t=[{label:"Monthly Revenue (Bar)",type:"bar",xCol:"Month",yCols:["Revenue"],title:"Monthly Revenue 2024",csv:`Month,Revenue
Jan,42500
Feb,38200
Mar,51300
Apr,47800
...
188,92
190,95
192,98`}]},7330(o,e,a){a.d(e,{FlyoutPanel:()=>oP});var t=a(5723),r=a(7991),n=a.n(r),i=a(6859),l=a.n(i),s=a(2799),d=a(255),c=a(1316),p=a(814),g=a(6896),m=a(7902),f=a(3013),u=a(2887),x=a(9510),b=a(9848),h=a(7901),y=a(3045),w=a(3775),$=a(1783),z=a(3539),v=a(9416),k=a(1837),M=a(7167),A=a(4494),T=a(2314),S=a(5751),F=a(9633),j=a(2946),B=a(822),R=a(6720),P=a(7400),H=a(8456),C=a(3317),L=a(2709),E=a(8006),D=a(9301),K=a(7561),N=a(3517),I=a(8207),Y=a(7032),V=a(6949),G=a(8218),_=a(6829),J=a(9591),O=a(5553),W=a(9923),Z=a(2820),U=a(4621),q=a(8479),X=a(2534),Q=a(6673),oo=a(7490),oe=a(9033),oa=a(9038),ot=a(5775),or=a(1365),on=a(2937),oi=a(9821),ol=a(5912),os=a(158),od=a(8641),oc=a(8607),op=a(3249),og=a(1821),om=a(5889),of=a(9655),ou=a(7170),ox=a(9161),ob=a(1849),oh=a(1604),oy=a(3142),ow=a(1187),o$=a(7747),oz=a(2932),ov=a(4525),ok=a(7230),oM=a(2164);let oA={activity:g.A,"a-large-small":m.A,apple:f.A,"arrow-right":u.A,"bar-chart-2":x.A,book:b.A,"book-open":h.A,briefcase:y.A,calendar:w.A,clock:$.A,"circle-dot":z.A,cloud:v.A,compass:k.A,cpu:M.A,droplets:A.A,feather:T.A,file:d.A,"file-text":S.A,folder:F.A,"git-branch":j.A,github:B.A,globe:R.A,grid:P.A,hand:H.A,hash:C.A,heart:L.A,key:E.A,hexagon:D.A,home:K.A,landmark:N.A,layers:I.A,"layout-grid":Y.A,leaf:V.A,lightbulb:G.A,list:_.A,map:J.A,"map-pin":O.A,"message-circle":W.A,"message-square":Z.A,minus:U.A,monitor:q.A,mountain:X.A,package:Q.A,palette:oo.A,"pen-tool":oe.A,"pie-chart":oa.A,plane:ot.A,plus:or.A,ruler:on.A,shirt:oi.A,slash:ol.A,square:os.A,star:od.A,sun:oc.A,terminal:op.A,thermometer:og.A,triangle:om.A,trophy:of.A,truck:ou.A,type:ox.A,users:ob.A,"volume-2":oh.A,watch:oy.A,waves:ow.A,wind:o$.A,wrench:oz.A,x:ov.A,zap:ok.A,bot:oM.A},oT=(0,s.keyframes)`
