...
`;function oB({iconKey:o}){let e=o?oA[o]??d.A:d.A;return(0,r.jsx)(e,{size:14,strokeWidth:1.75})}function oR({entries:o,activeId:e,onSelect:a}){return(0,r.jsx)(r.Fragment,{children:o.map(o=>o.children?(0,r.jsx)(i().Fragment,{children:(0,r.jsx)(oR,{entries:o.children,activeId:e,onSelect:a})},o.id):(0,r.jsxs)(oF,{active:e===o.id,onClick:()=>a(o),children:[(0,r.jsx)(oB,{iconKey:o.icon}),o.name]},o.id))})}function oI({activeId:o}){let{flyout:e,scheduleFlyoutClose:a,cancelFlyoutClose:t}=(0,p.c)();if(!e)return null;let i=e.entry.icon?oA[e.entry.icon]??d.A:d.A;return(0,r.jsxs)(oS,{anchorY:e.anchorY,onMouseEnter:t,onMouseLeave:a,children:[(0,r.jsxs)(oj,{children:[(0,r.jsx)(i,{size:13,strokeWidth:2}),e.entry.name]}),(0,r.jsx)(oR,{entries:e.entry.children??[],activeId:o,onSelect:o=>{e.onSelect(o),a()}})]})}},814(o,e,a){a.d(e,{I:()=>t,c:()=>i});var r=a(7991);let t=(0,r.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),i=()=>(0,r.useContext)(t)},5726(o,e,a){a.d(e,{w4:()=>r.w4,cL:()=>p.c,PE:()=>B,Is:()=>L,PL:()=>E});var r=a(1316),t=a(5723),i=a(7991),n=a.n(i),l=a(6859),s=a.n(l);s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
