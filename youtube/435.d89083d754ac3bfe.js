...
`;let w={default:d.w4.colors.accent,danger:"#f85149"},m={default:d.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"};l().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`,L.A,L.A['pre[class*="language-"]'],d.w4.colors.codeBg,L.A['code[class*="language-"]'],l().div`
  background: ${({bg:e})=>e};
...
`,l().aside`
  ...
  display: flex;
  flex-direction: column;
  animation: ${B} 0.22s cubic-bezier(0.4, 0, 0.2, 1) both;
...
`,l().div`
  position: relative;
`;let X="260px",N="56px",W="44px",_=l().header`
  display: flex;
  align-items: center;
