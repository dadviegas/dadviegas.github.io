...
`},5030(o,e,r){r.d(e,{K0:()=>v,YZ:()=>C,$n:()=>w,n6:()=>z,In:()=>T});var t=r(5723),a=r(7991),i=r.n(a),n=r(6859),l=r.n(n),d=r(4764);let s={ghost:"transparent",accent:"transparent",primary:d.w4.colors.accent,success:"#238636",danger:"#da3633"},p={ghost:d.w4.colors.sidebarHover,accent:"rgba(88,166,255,0.10)",primary:d.w4.colors.accentHover,success:"#2ea043",danger:"#f85149"},c={ghost:d.w4.colors.border,accent:d.w4.colors.accent,primary:d.w4.colors.accent,success:"#238636",danger:"#da3633"},g={ghost:d.w4.colors.mainTextMuted,accent:d.w4.colors.accent,primary:"#fff",success:"#fff",danger:"#fff"},x={ghost:d.w4.colors.mainText,accent:d.w4.colors.accent,primary:"#fff",success:"#fff",danger:"#fff"},f={sm:"28px",md:"30px"},h={sm:"0 10px",md:"0 12px"},b={sm:"12px",md:"12px"},m=l().button`
  ...
  &:hover:not(:disabled) {
    ...
    color: ${({variant:o})=>x[o]};
    border-color: ${({variant:o})=>"ghost"===o?d.w4.colors.accent:c[o]};
  }
...
`,w=i().forwardRef(function({variant:o="ghost",size:e="md",icon:r,iconRight:a,children:i,...n},l){return(0,t.jsxs)(m,{ref:l,variant:o,size:e,...n,children:[r,i,a]})}),u={default:d.w4.colors.accent,danger:"#f85149"},y={default:d.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"},$=l().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`;let H={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:d.w4.colors.accentMuted},j={neutral:d.w4.colors.mainTextMuted,live:d.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:d.w4.colors.accent};l().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${d.w4.typography.fontFamilyMono};
...
`,E.A,E.A['pre[class*="language-"]'],d.w4.colors.codeBg,E.A['code[class*="language-"]'],l().div`
  background: ${({bg:o})=>o};
