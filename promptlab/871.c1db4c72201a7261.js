"use strict";(self.webpackChunk_atlantis_promptlab=self.webpackChunk_atlantis_promptlab||[]).push([["871"],{3758(e,o,r){r.d(o,{L:()=>a});var t=r(1855);async function a(e,o,r,a,i,n,l){let s="",d=e=>{e.length<=s.length||(n(e.slice(s.length)),s=e)};"groq"===e?await (0,t.askGroqStream)(i,{key:o,model:r,system:a,onChunk:d,signal:l}):await (0,t.streamGemini)(i,{key:o,model:r,system:a,onChunk:d,signal:l})}},7613(e,o,r){r.d(o,{H:()=>v});var t=r(5723),a=r(7991),i=r(6859),n=r.n(i),l=r(6063),s=r(132),d=r(8035);let c=n().div`
  display: flex;
