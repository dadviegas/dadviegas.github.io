...
`,S=l().span`
  ...
  display: inline-block;
`,j=i().forwardRef(function({variant:o="default",dotColor:r,children:e,onClick:a,...i},n){return(0,t.jsxs)(F,{ref:n,variant:o,clickable:!!a,onClick:a,type:i.type??"button",...i,children:[r&&(0,t.jsx)(S,{color:r}),e]})}),H={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:s.w4.colors.accentMuted},R={neutral:s.w4.colors.mainTextMuted,live:s.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:s.w4.colors.accent};l().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${s.w4.typography.fontFamilyMono};
