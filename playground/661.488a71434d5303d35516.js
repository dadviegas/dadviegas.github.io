"use strict";(self.webpackChunk_atlantis_playground=self.webpackChunk_atlantis_playground||[]).push([[661],{4914(n,a,o){o.d(a,{FlyoutPanel:()=>y});var e=o(7359),t=o(3233),i=o(7207),l=o(255),r=o(217),m=o(5959),c=o(5185),d=o(5723);const s=i.keyframes`
...
`;function p({iconKey:n}){const a=n?c.t[n]??l.A:l.A;return(0,d.jsx)(a,{size:14,strokeWidth:1.75})}function z({entries:n,activeId:a,onSelect:o}){return(0,d.jsx)(d.Fragment,{children:n.map(n=>n.children?(0,d.jsx)(e.Fragment,{children:(0,d.jsx)(z,{entries:n.children,activeId:a,onSelect:o})},n.id):(0,d.jsxs)(f,{active:a===n.id,onClick:()=>o(n),children:[(0,d.jsx)(p,{iconKey:n.icon}),n.name]},n.id))})}function y({activeId:n}){const{flyout:a,scheduleFlyoutClose:o,cancelFlyoutClose:e}=(0,m.c)();if(!a)return null;const t=a.entry.icon?c.t[a.entry.icon]??l.A:l.A;return(0,d.jsxs)(g,{anchorY:a.anchorY,onMouseEnter:e,onMouseLeave:o,children:[(0,d.jsxs)(u,{children:[(0,d.jsx)(t,{size:13,strokeWidth:2}),a.entry.name]}),(0,d.jsx)(z,{entries:a.entry.children??[],activeId:n,onSelect:n=>{a.onSelect(n),o()}})]})}},5959(n,a,o){o.d(a,{c:()=>i});var e=o(7359);const t=(0,e.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),i=()=>(0,e.useContext)(t)},5185(n,a,o){o.d(a,{t:()=>V});var e=o(9510),t=o(9038),i=o(8207),l=o(6896),r=o(7901),m=o(9848),c=o(2164),d=o(3775),s=o(3539),g=o(1783),u=o(1837),f=o(2314),p=o(5751),z=o(255),y=o(9633),b=o(2946),h=o(822),x=o(6720),A=o(3317),w=o(2709),v=o(3517),k=o(7032),M=o(6949),S=o(8218),$=o(6829),B=o(5553),E=o(9591),P=o(2820),T=o(4621),C=o(6673),j=o(9033),L=o(1365),R=o(5912),D=o(8641),I=o(3249),N=o(1821),K=o(9161),F=o(1849),G=o(7747),H=o(2932),_=o(4525),Y=o(7230);const V={activity:l.A,"bar-chart-2":e.A,book:m.A,"book-open":r.A,calendar:d.A,clock:g.A,"circle-dot":s.A,feather:f.A,"file-text":p.A,globe:x.A,hash:A.A,heart:w.A,landmark:v.A,layers:i.A,leaf:M.A,map:E.A,package:C.A,compass:u.A,"git-branch":b.A,github:h.A,minus:T.A,terminal:I.A,thermometer:N.A,users:F.A,wind:G.A,"pie-chart":t.A,plus:L.A,slash:R.A,star:D.A,zap:Y.A,bot:c.A,lightbulb:S.A,"message-square":P.A,wrench:H.A,x:_.A,"layout-grid":k.A,list:$.A,file:z.A,folder:y.A,"map-pin":B.A,"pen-tool":j.A,type:K.A}},906(n,a,o){o.d(a,{w4:()=>e.w});var e=o(217),t=(o(7359),o(3233));o(5723),t.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,t.default.span`
  ...
  margin-right: 6px;
  flex-shrink: 0;
`,o(5959);const i="260px",l="56px";t.default.header`
  display: flex;
  align-items: center;
  height: ${"48px"};
...
`,t.default.div`
  ...
  overflow: hidden;
`,t.default.aside`
  width: ${({collapsed:n})=>n?l:i};
  min-width: ${({collapsed:n})=>n?l:i};
  background: ${e.w.colors.sidebarBg};
  border-right: 1px solid ${e.w.colors.sidebarBorder};
  display: flex;
  flex-direction: column;
