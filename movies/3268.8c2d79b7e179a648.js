"use strict";(self.webpackChunk_atlantis_movies=self.webpackChunk_atlantis_movies||[]).push([["3268"],{7613(e,o,a){a.d(o,{H:()=>b});var r=a(5723),t=a(7991),i=a(6859),n=a.n(i),l=a(3930);let s=n().div`
  display: flex;
...
`,a(2727);var h=a(2799);let b=(0,h.keyframes)`
...
`,T.A,T.A['pre[class*="language-"]'],n.w4.colors.codeBg,T.A['code[class*="language-"]'],i().div`
  background: ${({bg:e})=>e};
