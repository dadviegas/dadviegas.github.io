"use strict";(self.webpackChunk_atlantis_citypulse=self.webpackChunk_atlantis_citypulse||[]).push([["362"],{3935(e,i,a){a.r(i),a.d(i,{default:()=>g});var n=a(5723),t=a(7991),r=a(6859),l=a.n(r),s=a(6063),o=a(3501),d=a(3819),c=a(9522),h=a(1951),p=a(6305),x=a(7912),u=a(5332),m=a(4439);let y=[{id:"dashboard",name:"Dashboard",icon:"layout-grid",children:[{id:"overview",name:"City Overview",icon:"map-pin"},{id:"weather",name:"Weather Timeline",icon:"thermometer"},{id:"air-quality",name:"Air Quality",icon:"wind"},{id:"compare",name:"Compare Cities",icon:"bar-chart-2"}]}],w=l().h2`
