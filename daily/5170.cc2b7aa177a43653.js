"use strict";(self.webpackChunk_atlantis_daily=self.webpackChunk_atlantis_daily||[]).push([["5170"],{948(o,e,a){a.d(e,{A:()=>t});let t={...a(4486).WD,"daily.title":{en:"Daily Manager",pt:"Gestor Di\xe1rio"},"daily.subtitle":{en:"Build good habits, one day at a time.",pt:"Constr\xf3i bons h\xe1bitos, um dia de cada vez."},"daily.level":{en:"Level {n}",pt:"N\xedvel {n}"},"daily.points":{en:"points",pt:"pontos"},"daily.xp":{en:"XP",pt:"XP"},"daily.sectionMissions":{en:"\uD83C\uDFAF Today's Missions",pt:"\uD83C\uDFAF Miss\xf5es de Hoje"},"daily.sectionStats":{en:"\uD83D\uDCCA Your Stats",pt:"\uD83D\uDCCA As Tuas Estat\xedsticas"},"daily.sectionWeek":{en:"\uD83D\uDDD3️ Last 7 Days",pt:"\uD83D\uDDD3️ \xdaltimos 7 Dias"},"daily.weekHint":{en:"Dots show missions completed each day",pt:"Os pontos mostram miss\xf5es conclu\xeddas em cada dia"},"daily.stat.completed":{en:"Missions\ncompleted",pt:"Miss\xf5es\nconclu\xeddas"},"daily.stat.points":{en:"Points\nearned",pt:"Pontos\nganhos"},"daily.stat.streak":{en:"Day\nstreak",pt:"Dias\nseguidos"},"daily.welcomeTitle":{en:"Your adventure starts today!",pt:"A tua aventura come\xe7a hoje!"},"daily.welcomeBody":{en:"Complete missions to earn points and level up. The more you do, the stronger you get!",pt:"Completa miss\xf5es para ganhar pontos e subir de n\xedvel. Quanto mais fizeres, mais forte ficas!"},"daily.edit":{en:"Edit list",pt:"Editar lista"},"daily.done":{en:"Done",pt:"Pronto"},"daily.addMission":{en:"Add mission",pt:"Adicionar miss\xe3o"},"daily.placeholderEmoji":{en:"Emoji",pt:"Emoji"},"daily.placeholderName":{en:"Mission name",pt:"Nome da miss\xe3o"},"daily.placeholderPoints":{en:"pts",pt:"pts"},"daily.add":{en:"Add",pt:"Adicionar"},"daily.delete":{en:"Remove",pt:"Remover"},"daily.resetDay":{en:"Reset day",pt:"Novo dia"},"daily.resetConfirm":{en:"Are you sure? This clears today's missions but keeps your points.",pt:"Tens a certeza? As miss\xf5es de hoje ser\xe3o limpas, mas os teus pontos ficam."},"daily.confirm":{en:"Confirm",pt:"Confirmar"},"daily.cancel":{en:"Cancel",pt:"Cancelar"},"daily.levelUp":{en:"\uD83C\uDF89 Level Up!",pt:"\uD83C\uDF89 Subiste de n\xedvel!"},"daily.level.recruit":{en:"Recruit",pt:"Recruta"},"daily.level.explorer":{en:"Explorer",pt:"Explorador"},"daily.level.adventurer":{en:"Adventurer",pt:"Aventureiro"},"daily.level.hero":{en:"Hero",pt:"Her\xf3i"},"daily.level.champion":{en:"Champion",pt:"Campe\xe3o"},"daily.level.legend":{en:"Legend",pt:"Lenda"},"daily.newMission.title":{en:"New mission",pt:"Nova miss\xe3o"},"daily.newMission.preview":{en:"Preview",pt:"Pr\xe9-visualiza\xe7\xe3o"},"daily.newMission.name":{en:"Name",pt:"Nome"},"daily.newMission.namePlaceholder":{en:"e.g. Drink water",pt:"ex. Beber \xe1gua"},"daily.newMission.emoji":{en:"Emoji",pt:"Emoji"},"daily.newMission.frame":{en:"Frame",pt:"Moldura"},"daily.newMission.color":{en:"Color",pt:"Cor"},"daily.newMission.points":{en:"Points",pt:"Pontos"},"daily.newMission.time":{en:"Time (optional)",pt:"Hora (opcional)"},"daily.newMission.timeClear":{en:"Clear",pt:"Limpar"},"daily.newMission.save":{en:"Create",pt:"Criar"},"daily.editMission.title":{en:"Edit mission",pt:"Editar miss\xe3o"},"daily.editMission.save":{en:"Save",pt:"Guardar"},"daily.editMission.open":{en:"Edit mission",pt:"Editar miss\xe3o"},"daily.summary.pointsToday":{en:"pts today",pt:"pts hoje"},"daily.summary.missions":{en:"missions",pt:"miss\xf5es"},"daily.summary.streak":{en:"day streak",pt:"dia(s) seguidos"},"daily.greet.morning":{en:"Good morning, {name}.",pt:"Bom dia, {name}."},"daily.greet.afternoon":{en:"Good afternoon, {name}.",pt:"Boa tarde, {name}."},"daily.greet.evening":{en:"Good evening, {name}.",pt:"Boa noite, {name}."},"daily.greet.defaultName":{en:"Explorer",pt:"Explorador"},"daily.greet.remaining":{en:"{n} of {total} missions left",pt:"{n} de {total} miss\xf5es por fazer"},"daily.greet.allDone":{en:"All done — enjoy your day.",pt:"Tudo pronto — aproveita o dia."},"daily.focus.nextUp":{en:"Next up",pt:"A seguir"},"daily.focus.dayComplete":{en:"Day complete",pt:"Dia conclu\xeddo"},"daily.focus.markDone":{en:"Mark done",pt:"Marcar como feito"},"daily.focus.skip":{en:"Skip",pt:"Saltar"},"daily.focus.allDone":{en:"All missions complete!",pt:"Todas as miss\xf5es conclu\xeddas!"},"daily.focus.allDoneBody":{en:"Come back tomorrow for a new set.",pt:"Volta amanh\xe3 para um novo conjunto."},"daily.focus.timeChip":{en:"⏰ {time}",pt:"⏰ {time}"},"daily.progress.today":{en:"today",pt:"hoje"},"daily.progress.tooltip":{en:"{streak}-day streak \xb7 Level {level}",pt:"{streak} dias seguidos \xb7 N\xedvel {level}"},"daily.chapter.morning":{en:"☀️ Morning",pt:"☀️ Manh\xe3"},"daily.chapter.afternoon":{en:"\uD83C\uDF24️ Afternoon",pt:"\uD83C\uDF24️ Tarde"},"daily.chapter.evening":{en:"\uD83C\uDF19 Evening",pt:"\uD83C\uDF19 Noite"},"daily.chapter.count":{en:"{done}/{total}",pt:"{done}/{total}"},"daily.sparkline.label":{en:"Last 7 days",pt:"\xdaltimos 7 dias"},"daily.chip.level":{en:"Lv{n}",pt:"Nv{n}"},"daily.chip.points":{en:"{n} pts",pt:"{n} pts"},"daily.chip.streak":{en:"{n} day streak",pt:"{n} dias"},"daily.chip.streakSingle":{en:"{n} day streak",pt:"{n} dia"},"daily.chip.done":{en:"{n} done",pt:"{n} feitas"},"daily.chip.xpHint":{en:"Progress to next level",pt:"Progresso para o pr\xf3ximo n\xedvel"}}},8170(o,e,a){a.d(e,{Ym:()=>c,Nx:()=>p});var t=a(7991),r=a(4486);let n={"time.justNow":{en:"just now",pt:"agora mesmo"},"time.mAgo":{en:"{n}m ago",pt:"h\xe1 {n}m"},"time.hAgo":{en:"{n}h ago",pt:"h\xe1 {n}h"},"time.dAgo":{en:"{n}d ago",pt:"h\xe1 {n}d"},updated:{en:"updated {age}",pt:"atualizado {age}"},refresh:{en:"Refresh",pt:"Atualizar"},loading:{en:"Loading…",pt:"A carregar…"},noData:{en:"No data available",pt:"Sem dados dispon\xedveis"},noDescription:{en:"No description provided.",pt:"Sem descri\xe7\xe3o."},failedToFetch:{en:"Failed to fetch",pt:"Erro ao carregar"},perWeek:{en:"/ wk",pt:"/ sem"},"devtools.heading":{en:"Dev Tools",pt:"Ferramentas"},"devtools.playground":{en:"Playground",pt:"Playground"},"devtools.pad":{en:"Pad",pt:"Pad"},"devtools.charts":{en:"Charts",pt:"Gr\xe1ficos"},"devtools.csv":{en:"CSV",pt:"CSV"},"devtools.regex":{en:"Regex",pt:"Regex"},"devtools.json":{en:"JSON",pt:"JSON"},"devtools.diff":{en:"Diff",pt:"Diferen\xe7as"},"devtools.jwt":{en:"JWT",pt:"JWT"},"devtools.cron":{en:"Cron",pt:"Cron"},"devtools.colors":{en:"Colors",pt:"Cores"},"devtools.api":{en:"API",pt:"API"}},i="atlantis:locale",l="shell:locale";function s(o){return"en"===o||"pt"===o}function d(){try{let o=localStorage.getItem(i);if(s(o))return o}catch{}return"en"}function c(){let[o,e]=(0,t.useState)(d),a=(0,t.useCallback)(o=>{e(o);try{localStorage.setItem(i,o)}catch{}(0,r.Is)(l,o).catch(()=>{}),window.dispatchEvent(new CustomEvent("atlantis:locale-change",{detail:o}))},[]);return(0,t.useEffect)(()=>{let o=o=>{e(o.detail)};return window.addEventListener("atlantis:locale-change",o),()=>window.removeEventListener("atlantis:locale-change",o)},[]),(0,t.useEffect)(()=>{(0,r.PL)(l).then(a=>{if(s(a)&&a!==o){try{localStorage.setItem(i,a)}catch{}e(a)}}).catch(()=>{})},[]),[o,a]}function p(o,e){let a=e?{...n,...e}:n;return(e,t)=>{let r=a[e]?.[o]??e;return t?Object.entries(t).reduce((o,[e,a])=>o.replace(RegExp(`\\{${e}\\}`,"g"),String(a)),r):r}}(0,r.PL)(l).then(o=>{if(s(o))try{localStorage.setItem(i,o)}catch{}}).catch(()=>{}),a(5723);var g=a(6859),m=a.n(g);m().div`
  display: flex;
  gap: 4px;
...
`},7330(o,e,a){a.d(e,{FlyoutPanel:()=>oR});var t=a(5723),r=a(7991),n=a.n(r),i=a(6859),l=a.n(i),s=a(2799),d=a(255),c=a(1316),p=a(814),g=a(6896),m=a(7902),f=a(3013),u=a(2887),x=a(9510),b=a(9848),h=a(7901),y=a(3045),w=a(3775),$=a(1783),z=a(3539),v=a(9416),k=a(1837),M=a(7167),A=a(4494),T=a(2314),S=a(5751),j=a(9633),F=a(2946),B=a(822),P=a(6720),R=a(7400),E=a(8456),C=a(3317),H=a(2709),L=a(8006),D=a(9301),N=a(7561),I=a(3517),V=a(8207),Y=a(7032),G=a(6949),K=a(8218),O=a(6829),_=a(9591),J=a(5553),W=a(9923),U=a(2820),Z=a(4621),q=a(8479),X=a(2534),Q=a(6673),oo=a(7490),oe=a(9033),oa=a(9038),ot=a(5775),or=a(1365),on=a(2937),oi=a(9821),ol=a(5912),os=a(158),od=a(8641),oc=a(8607),op=a(3249),og=a(1821),om=a(5889),of=a(9655),ou=a(7170),ox=a(9161),ob=a(1849),oh=a(1604),oy=a(3142),ow=a(1187),o$=a(7747),oz=a(2932),ov=a(4525),ok=a(7230),oM=a(2164);let oA={activity:g.A,"a-large-small":m.A,apple:f.A,"arrow-right":u.A,"bar-chart-2":x.A,book:b.A,"book-open":h.A,briefcase:y.A,calendar:w.A,clock:$.A,"circle-dot":z.A,cloud:v.A,compass:k.A,cpu:M.A,droplets:A.A,feather:T.A,file:d.A,"file-text":S.A,folder:j.A,"git-branch":F.A,github:B.A,globe:P.A,grid:R.A,hand:E.A,hash:C.A,heart:H.A,key:L.A,hexagon:D.A,home:N.A,landmark:I.A,layers:V.A,"layout-grid":Y.A,leaf:G.A,lightbulb:K.A,list:O.A,map:_.A,"map-pin":J.A,"message-circle":W.A,"message-square":U.A,minus:Z.A,monitor:q.A,mountain:X.A,package:Q.A,palette:oo.A,"pen-tool":oe.A,"pie-chart":oa.A,plane:ot.A,plus:or.A,ruler:on.A,shirt:oi.A,slash:ol.A,square:os.A,star:od.A,sun:oc.A,terminal:op.A,thermometer:og.A,triangle:om.A,trophy:of.A,truck:ou.A,type:ox.A,users:ob.A,"volume-2":oh.A,watch:oy.A,waves:ow.A,wind:o$.A,wrench:oz.A,x:ov.A,zap:ok.A,bot:oM.A},oT=(0,s.keyframes)`
...
`,s().div`
  position: relative;
`;var d=a(2799),c=a(3661),p=a(814);let g="260px",m="56px",f="48px",u=s().header`
  display: flex;
  align-items: center;
...
`;let G="shell:profile",K="atlantis:profile-change",O=["tech","movies","learning","games","news","space"],_={interests:[],ageMode:"adult"};function J(o){return o&&"object"==typeof o?{interests:Array.isArray(o.interests)?o.interests.filter(o=>O.includes(o)):[],ageMode:"kid"===o.ageMode||"teen"===o.ageMode||"adult"===o.ageMode?o.ageMode:"adult"}:_}function W(){let[o,e]=(0,n.useState)(_);return(0,n.useEffect)(()=>{let o=!1;I(G).then(a=>{if(!o&&a)try{e(J(JSON.parse(a)))}catch{}});let a=o=>{let a=o.detail;a&&e(a)};return window.addEventListener(K,a),()=>{o=!0,window.removeEventListener(K,a)}},[]),[o,(0,n.useCallback)(async o=>{let a=J(o);e(a),window.dispatchEvent(new CustomEvent(K,{detail:a})),await N(G,JSON.stringify(a))},[])]}s().div`
...
`,h=n().forwardRef(function({variant:o="ghost",size:e="md",icon:a,iconRight:r,children:n,...i},l){return(0,t.jsxs)(b,{ref:l,variant:o,size:e,...i,children:[a,n,r]})}),y={default:s.w4.colors.accent,danger:"#f85149"},w={default:s.w4.colors.sidebarHover,danger:"rgba(248,81,73,0.12)"},$=l().button`
  position: relative;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`,z=n().forwardRef(function({active:o=!1,shape:e="square",tone:a="default",children:r,...n},i){return(0,t.jsx)($,{ref:i,active:o,shape:e,tone:a,...n,children:r})});l().div`
  position: relative;
  display: inline-flex;
`,l().div`
  position: absolute;
...
`,a(2727);var v=a(2799);let k=(0,v.keyframes)`
...
`,l().span`
  ...
  background: ${({color:o})=>o};
  display: inline-block;
`;let F={neutral:"rgba(255,255,255,0.06)",live:"rgba(127,183,126,0.16)",film:"rgba(232,154,92,0.18)",tv:"rgba(106,168,216,0.18)",accent:s.w4.colors.accentMuted},B={neutral:s.w4.colors.mainTextMuted,live:s.w4.colors.success,film:"#e89a5c",tv:"#6aa8d8",accent:s.w4.colors.accent};l().span`
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-family: ${s.w4.typography.fontFamilyMono};
...
`;let P=l().div`
  ...
  align-items: center;
  gap: 8px;
`;function R({children:o,...e}){return(0,t.jsx)(P,{...e,children:o})}l().label`
  display: flex;
  align-items: center;
  gap: 10px;
