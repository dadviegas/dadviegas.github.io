"use strict";(self.webpackChunk_atlantis_markdown=self.webpackChunk_atlantis_markdown||[]).push([[3828],{98936(e,o,a){a.d(o,{WO:()=>va});var t=a(27359),n=a(217),i=a(53233),r=a(65723);i.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`;function K({iconKey:e,size:o=16}){if(e&&!(e in C.t))return(0,r.jsx)("span",{style:{fontSize:o,lineHeight:1,display:"flex",alignItems:"center"},children:e});const a=e?C.t[e]??T.A:T.A;return(0,r.jsx)(a,{size:o,strokeWidth:1.75})}function W({entry:e,activeId:o,onSelect:a}){const[n,i]=(0,t.useState)(e.defaultOpen??!0),{collapsed:l,openFlyout:s,scheduleFlyoutClose:d,cancelFlyoutClose:m}=(0,c.c)();return e.children&&e.children.length>0?(0,r.jsxs)(R,{children:[(0,r.jsxs)(L,{collapsed:l,onClick:()=>{l||i(e=>!e)},onMouseEnter:l?o=>{const t=o.currentTarget.getBoundingClientRect();s(e,t.top,a)}:void 0,onMouseLeave:l?d:void 0,children:[(0,r.jsxs)(I,{collapsed:l,children:[(0,r.jsx)(K,{iconKey:e.icon,size:16}),(0,r.jsx)(N,{collapsed:l,children:e.name})]}),(0,r.jsx)(D,{open:n,collapsed:l,children:(0,r.jsx)(B.A,{size:13})})]}),(0,r.jsx)(E,{open:n&&!l,children:(0,r.jsx)(F,{children:(0,r.jsx)(P,{children:e.children.map(e=>(0,r.jsx)(W,{entry:e,activeId:o,onSelect:a},e.id))})})})]}):(0,r.jsxs)(H,{active:o===e.id,collapsed:l,onClick:()=>a(e),onMouseEnter:l?o=>{const t=o.currentTarget.getBoundingClientRect();s({id:e.id,name:e.name,icon:e.icon,file:e.file,children:[e]},t.top,a)}:void 0,onMouseLeave:l?d:void 0,children:[(0,r.jsx)(K,{iconKey:e.icon,size:15}),(0,r.jsx)(N,{collapsed:l,children:e.name})]})}function G({entries:e,activeId:o,onSelect:a}){return(0,r.jsx)("div",{children:e.map(e=>(0,r.jsx)(W,{entry:e,activeId:o,onSelect:a},e.id))})}const O=l.keyframes`
...
`,a(74914);var _=a(61920),Y=a(48607),V=a(68479);i.default.button`
  display: flex;
  align-items: center;
  justify-content: center;
  width: 32px;
...
`;function ge({title:e,icon:o,entries:a,activeId:n,onSelect:i,favorites:l,onToggleFav:s,collapsed:c}){const[d,m]=(0,t.useState)(!1);return a.length?(0,r.jsxs)(ae,{children:[(0,r.jsxs)(te,{collapsed:c,onClick:()=>{c||m(e=>!e)},children:[(0,r.jsxs)(ne,{collapsed:c,children:[o,(0,r.jsx)(ie,{collapsed:c,children:e})]}),(0,r.jsx)(re,{open:d,collapsed:c,children:(0,r.jsx)(B.A,{size:12})})]}),(0,r.jsx)(le,{open:d&&!c,children:(0,r.jsx)(se,{children:a.map(e=>{const o=l.some(o=>o.id===e.id);return(0,r.jsxs)(ce,{children:[(0,r.jsx)(de,{active:n===e.id,onClick:()=>i(e),children:e.name}),(0,r.jsx)(me,{active:o,title:o?"Remover dos favoritos":"Adicionar aos favoritos",onClick:o=>{o.stopPropagation(),s(e)},children:(0,r.jsx)(X.A,{size:12,fill:o?"currentColor":"none"})})]},e.id)})})})]}):null}function ue({config:e,activeId:o,onSelect:a,hashPrefix:n}){const i=`atlantis-recent-${n}`,l=`atlantis-fav-${n}`,{collapsed:s}=(0,c.c)(),[d,m]=(0,t.useState)(()=>ee(i)),[g,u]=(0,t.useState)(()=>ee(l)),p=(0,t.useCallback)(e=>{e.file&&m(o=>function(e,o,a){const t=[o,...a.filter(e=>e.id!==o.id)].slice(0,10);return localStorage.setItem(e,JSON.stringify(t)),t}(i,e,o)),a(e)},[a,i]),f=(0,t.useCallback)(e=>{u(o=>function(e,o,a){const t=a.some(e=>e.id===o.id)?a.filter(e=>e.id!==o.id):[...a,o];return localStorage.setItem(e,JSON.stringify(t)),t}(l,e,o))},[l]);return(0,r.jsxs)(oe,{children:[(0,r.jsx)(ge,{title:"Recentes",icon:(0,r.jsx)(Q.A,{size:13}),entries:d,activeId:o,onSelect:p,favorites:g,onToggleFav:f,collapsed:s}),(0,r.jsx)(ge,{title:"Favoritos",icon:(0,r.jsx)(X.A,{size:13}),entries:g,activeId:o,onSelect:p,favorites:g,onToggleFav:f,collapsed:s}),(0,r.jsx)(G,{entries:e.entries,activeId:o,onSelect:p})]})}var pe=a(28976),fe=a(18055),xe=a(66225),he=a(302),ye=a(39895),be=a(6930),we=a(14944);const ze=i.default.div`
...
`,ao={...Je.A,'pre[class*="language-"]':{...Je.A['pre[class*="language-"]'],background:n.w4.colors.codeBg,margin:0,padding:"18px 20px",fontSize:"13px",lineHeight:"1.6",borderRadius:0},'code[class*="language-"]':{...Je.A['code[class*="language-"]'],background:"none",fontSize:"13px"}};function to({lang:e="text",code:o}){const[a,i]=(0,t.useState)(!1);return(0,r.jsxs)(Xe,{children:[(0,r.jsxs)(Qe,{children:[(0,r.jsx)(eo,{children:e}),(0,r.jsxs)(oo,{copied:a,onClick:()=>{navigator.clipboard.writeText(o).then(()=>{i(!0),setTimeout(()=>i(!1),2e3)})},children:[a?(0,r.jsx)(qe.A,{size:12}):(0,r.jsx)(Ze.A,{size:12}),a?"Copied!":"Copy"]})]}),(0,r.jsx)(Ue.A,{language:e,style:ao,showLineNumbers:o.split("\n").length>8,lineNumberStyle:{color:"#484f58",minWidth:"2.5em",paddingRight:"1.5em",userSelect:"none",fontSize:"12px"},customStyle:{margin:0,background:n.w4.colors.codeBg},wrapLongLines:!1,children:o})]})}var no=a(65569),io=a(8218),ro=a(57230),lo=a(22966),so=a(21069);const co={NOTE:{bg:"rgba(88, 166, 255, 0.08)",border:"#58a6ff",icon:no.A,label:"Note",color:"#58a6ff"},TIP:{bg:"rgba(63, 185, 80, 0.08)",border:"#3fb950",icon:io.A,label:"Tip",color:"#3fb950"},IMPORTANT:{bg:"rgba(163, 113, 247, 0.08)",border:"#a371f7",icon:ro.A,label:"Important",color:"#a371f7"},WARNING:{bg:"rgba(210, 153, 34, 0.08)",border:"#d29922",icon:lo.A,label:"Warning",color:"#d29922"},CAUTION:{bg:"rgba(248, 81, 73, 0.08)",border:"#f85149",icon:so.A,label:"Caution",color:"#f85149"}},mo=i.default.div`
  background: ${({bg:e})=>e};
...
`;function po({type:e,children:o}){const a=co[e]??co.NOTE,t=a.icon;return(0,r.jsxs)(mo,{bg:a.bg,border:a.border,children:[(0,r.jsxs)(go,{color:a.color,children:[(0,r.jsx)(t,{size:15,strokeWidth:2}),a.label]}),(0,r.jsx)(uo,{children:o})]})}const fo=i.default.nav`
  width: 220px;
  min-width: 220px;
...
`,xo=i.default.div`
  ...
  font-family: ${n.w4.typography.fontFamily};
  margin-bottom: ${n.w4.spacing.md};
`,ho=i.default.ul`list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 2px;`,yo=i.default.a`
  display: block;
  padding: 4px 8px;
...
`;function bo({headings:e,activeId:o}){return e.length<2?null:(0,r.jsxs)(fo,{children:[(0,r.jsx)(xo,{children:"On this page"}),(0,r.jsx)(ho,{children:e.map(e=>(0,r.jsx)("li",{children:(0,r.jsx)(yo,{href:`#${e.id}`,active:o===e.id,level:e.level,onClick:o=>{o.preventDefault(),document.getElementById(e.id)?.scrollIntoView({behavior:"smooth",block:"start"})},children:e.text})},e.id))})]})}function wo(e){return e.toLowerCase().replace(/[*_`[\]()#]/g,"").replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-").trim()}function zo(e){const{Children:o,isValidElement:t}=a(27359);return o.toArray(e).map(e=>"string"==typeof e?e:"number"==typeof e?String(e):t(e)?zo(e.props.children??""):"").join("")}function $o(){return e=>{!function e(o){if("blockquote"===o.type){const e=o.children?.[0];if("paragraph"===e?.type){const a=e.children?.[0];if("text"===a?.type){const t=a.value?.match(/^\[!(NOTE|TIP|WARNING|CAUTION|IMPORTANT)\]\s*/i);t&&(a.value=a.value.slice(t[0].length),a.value.trim()||1!==e.children.length||o.children.shift(),o.data=o.data??{},o.data.hName="div",o.data.hProperties={"data-callout":t[1].toUpperCase()})}}}o.children?.forEach(e)}(e)}}const vo=i.default.div`
  display: flex;
  ...
  width: 100%;
  box-sizing: border-box;
`,ko=i.default.div`flex: 1; min-width: 0;`,Ao=i.default.article`
...
`,Bo=i.default.div`
  ...
  font-family: ${n.w4.typography.fontFamily};
`;function Co(e){return function({children:o,...a}){const t=`h${e}`,n=zo(o),i=wo(n);return(0,r.jsxs)(t,{id:i,...a,children:[o,(0,r.jsx)("a",{className:"heading-anchor",href:`#${i}`,"aria-label":`Link to "${n}"`,children:(0,r.jsx)(xe.A,{size:14})})]})}}function Eo({file:e,prevEntry:o,nextEntry:n,onNavigate:i,scrollToId:l,onScrolled:s}){const[c,d]=(0,t.useState)(null),[m,g]=(0,t.useState)(null),u=(0,t.useRef)(null);if((0,t.useEffect)(()=>{d(null),fetch(`${a.p}content/${e}`).then(e=>{if(!e.ok)throw new Error(`${e.status} ${e.statusText}`);return e.text()}).then(d).catch(o=>d(`> **Error loading \`${e}\`:** ${o.message}`))},[e]),(0,t.useEffect)(()=>{if(!l||!c||!u.current)return;const e=setTimeout(()=>{const e=u.current?.querySelector(`#${CSS.escape(l)}`);e&&(e.scrollIntoView({behavior:"smooth",block:"start"}),g(l),s?.())},150);return()=>clearTimeout(e)},[l,c,s]),(0,t.useEffect)(()=>{if(!c||!u.current)return;const e=u.current.querySelectorAll("h2[id], h3[id]");if(!e.length)return;const o=new IntersectionObserver(e=>{const o=e.filter(e=>e.isIntersecting);o.length&&g(o[0].target.id)},{rootMargin:"-10% 0% -60% 0%",threshold:0});return e.forEach(e=>o.observe(e)),()=>o.disconnect()},[c]),null===c)return(0,r.jsx)(Bo,{children:"Loading…"});const p=function(e){const o=[],a=/^(#{2,3})\s+(.+)$/gm;let t;for(;null!==(t=a.exec(e));){const e=t[1].length,a=t[2].trim().replace(/\*\*(.+?)\*\*/g,"$1").replace(/\*(.+?)\*/g,"$1").replace(/`(.+?)`/g,"$1").replace(/\[(.+?)\]\(.+?\)/g,"$1");o.push({level:e,text:a,id:wo(a)})}return o}(c),f=o||n;return(0,r.jsxs)(vo,{children:[(0,r.jsxs)(ko,{children:[(0,r.jsx)(Ao,{ref:u,children:(0,r.jsx)(pe.oz,{remarkPlugins:[fe.A,we.A,$o],rehypePlugins:[ye.A,be.A],components:{div({node:e,children:o,...a}){const t=a["data-callout"];return t?(0,r.jsx)(po,{type:t,children:o}):(0,r.jsx)("div",{...a,children:o})},h1:Co(1),h2:Co(2),h3:Co(3),h4:Co(4),pre:({children:e})=>(0,r.jsx)(r.Fragment,{children:e}),code({className:e,children:o}){const a=/language-(\w+)/.exec(e??"")?.[1],t=String(o).replace(/\n$/,"");return"mermaid"===a?(0,r.jsx)(ke,{code:t}):"chart"===a?(0,r.jsx)(Le,{code:t}):"clock"===a?(0,r.jsx)(Ve,{code:t}):a||t.includes("\n")?(0,r.jsx)(to,{lang:a,code:t}):(0,r.jsx)("code",{className:e,children:o})}},children:c})}),f&&(0,r.jsxs)(jo,{children:[o?(0,r.jsxs)(So,{align:"left",onClick:()=>i?.(o),children:[(0,r.jsxs)(Mo,{children:[(0,r.jsx)(he.A,{size:13})," Previous"]}),(0,r.jsx)(To,{children:o.name})]}):(0,r.jsx)("div",{style:{flex:1}}),n?(0,r.jsxs)(So,{align:"right",onClick:()=>i?.(n),children:[(0,r.jsxs)(Mo,{children:["Next ",(0,r.jsx)(B.A,{size:13})]}),(0,r.jsx)(To,{children:n.name})]}):(0,r.jsx)("div",{style:{flex:1}})]})]}),(0,r.jsx)(bo,{headings:p,activeId:m})]})}var Fo=a(24525),Po=a(87071),Ro=a(35751),Lo=a(32887);const Io=l.keyframes`
  from { opacity: 0; }
  to   { opacity: 1; }
`,No=l.keyframes`
...
`,ta=i.default.div`
  ...
  font-size: ${n.w4.typography.fontSizeSm};
  text-align: center;
`;function na(e){return e.toLowerCase().replace(/[*_`[\]()#]/g,"").replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-").trim()}const ia=new Map;function ra(e){return e.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,"")}function la(e,o=""){return e.flatMap(e=>e.children?la(e.children,e.name):e.file?[{entry:e,parentName:o}]:[])}function sa(e,o){const a=ra(e),t=ra(o),n=e.split("\n");let i=0,r=0;for(;-1!==(r=a.indexOf(t,r));)i++,r+=t.length;let l=null;for(const e of n){const a=e.match(/^#{1,4}\s+(.+)/);if(a&&(l=a[1].trim()),!e.trim()||e.startsWith("```")||e.startsWith("|--"))continue;const n=e.replace(/^#{1,6}\s*/,"").replace(/[*_`|]/g,"").trim(),r=n.normalize("NFD"),s=[];let c=0;for(let e=0;e<r.length;e++){const o=r.charCodeAt(e);o>=768&&o<=879||(s.push(c),c++)}s.push(c);const d=ra(n).indexOf(t);if(-1===d)continue;const m=s[d]??d,g=s[d+t.length]??m+o.length,u=Math.max(0,m-50),p=Math.min(n.length,g+70),f=u>0?"…":"",x=p<n.length?"…":"";return{snippet:`${f}${n.slice(u,m)}<mark>${n.slice(m,g)}</mark>${n.slice(g,p)}${x}`,count:i,headingSlug:l?na(l):null,headingText:l}}return{snippet:"",count:i,headingSlug:null,headingText:null}}function ca({open:e,onClose:o,entries:i,activeId:l,onSelect:s}){const[c,d]=(0,t.useState)(""),[m,g]=(0,t.useState)([]),[u,p]=(0,t.useState)(!1),[f,x]=(0,t.useState)(0),h=(0,t.useRef)(null),y=(0,t.useRef)(),b=(0,t.useMemo)(()=>la(i),[i]);(0,t.useEffect)(()=>{e&&(d(""),g([]),x(0),setTimeout(()=>h.current?.focus(),50))},[e]),(0,t.useEffect)(()=>{if(!e)return;const a=e=>{"Escape"===e.key&&(e.preventDefault(),o())};return window.addEventListener("keydown",a),()=>window.removeEventListener("keydown",a)},[e,o]);const w=(0,t.useCallback)(async e=>{if(e.length<2)return g([]),void p(!1);p(!0);const o=await Promise.all(b.map(async({entry:e,parentName:o})=>{const t=await async function(e){const o=ia.get(e);if(void 0!==o)return o;try{const o=await fetch(`${a.p}content/${e}`);if(!o.ok)return"";const t=await o.text();return ia.set(e,t),t}catch{return ia.set(e,""),""}}(e.file);return{entry:e,parentName:o,text:t}})),t=[];for(const{entry:a,parentName:n,text:i}of o){const o=ra(a.name),r=ra(i),l=ra(e);if(!o.includes(l)&&!r.includes(l))continue;const{snippet:s,count:c,headingSlug:d,headingText:m}=sa(i,e),g=o.includes(l);t.push({entry:a,parentName:n,snippet:s||(g?a.name:""),matchCount:c+(g?10:0),headingSlug:d,headingText:m})}t.sort((e,o)=>o.matchCount-e.matchCount),g(t),x(0),p(!1)},[b]);(0,t.useEffect)(()=>{if(clearTimeout(y.current),c.trim())return y.current=setTimeout(()=>w(c.trim()),250),()=>clearTimeout(y.current);g([])},[c,w]);const z=(0,t.useCallback)(e=>{"ArrowDown"===e.key?(e.preventDefault(),x(e=>Math.min(e+1,m.length-1))):"ArrowUp"===e.key?(e.preventDefault(),x(e=>Math.max(e-1,0))):"Enter"===e.key&&m[f]&&(e.preventDefault(),s(m[f].entry,m[f].headingSlug),o())},[m,f,s,o]);return e?(0,r.jsx)(Do,{onClick:e=>{e.target===e.currentTarget&&o()},children:(0,r.jsxs)(Ho,{onKeyDown:z,children:[(0,r.jsxs)(Ko,{children:[(0,r.jsx)(Z.A,{size:18,color:n.w4.colors.accent,style:{flexShrink:0}}),(0,r.jsx)(Wo,{ref:h,placeholder:"Pesquisar em todo o conteúdo…",value:c,onChange:e=>d(e.target.value)}),(0,r.jsx)(Go,{onClick:o,title:"Fechar (Esc)",children:(0,r.jsx)(Fo.A,{size:14})})]}),(0,r.jsxs)(Oo,{children:[u&&(0,r.jsxs)(_o,{children:[(0,r.jsx)(Yo,{children:(0,r.jsx)(Po.A,{size:14})}),"A pesquisar ",b.length," ficheiros…"]}),!u&&c.length>=2&&m.length>0&&(0,r.jsxs)(_o,{children:[(0,r.jsx)(Ro.A,{size:13}),m.length," ",1===m.length?"resultado":"resultados"," encontrados"]}),!u&&c.length>=2&&0===m.length&&(0,r.jsxs)(ta,{children:[(0,r.jsx)(Z.A,{size:32,strokeWidth:1.2}),'Nenhum resultado para "',(0,r.jsx)("strong",{children:c}),'"']}),!u&&c.length<2&&(0,r.jsxs)(ta,{children:[(0,r.jsx)(Z.A,{size:32,strokeWidth:1.2}),"Escreve pelo menos 2 caracteres para pesquisar"]}),m.map((e,a)=>(0,r.jsxs)(Vo,{selected:a===f,onClick:()=>{s(e.entry,e.headingSlug),o()},onMouseEnter:()=>x(a),children:[(0,r.jsx)(Uo,{selected:a===f,children:(0,r.jsx)(Ro.A,{size:15})}),(0,r.jsxs)(Jo,{children:[(0,r.jsxs)(qo,{children:[e.entry.name,e.matchCount>0&&(0,r.jsx)(Xo,{children:e.matchCount>10?e.matchCount-10:e.matchCount})]}),(e.parentName||e.headingText)&&(0,r.jsxs)(Zo,{children:[e.parentName,e.parentName&&e.headingText?" › ":"",e.headingText]}),e.snippet&&(0,r.jsx)(Qo,{dangerouslySetInnerHTML:{__html:e.snippet}})]}),(0,r.jsx)(ea,{selected:a===f,children:(0,r.jsx)(Lo.A,{size:14})})]},e.entry.id))]}),(0,r.jsxs)(oa,{children:[(0,r.jsxs)("span",{children:[(0,r.jsx)(aa,{children:"↑"})," ",(0,r.jsx)(aa,{children:"↓"})," navegar"]}),(0,r.jsxs)("span",{children:[(0,r.jsx)(aa,{children:"↵"})," abrir"]}),(0,r.jsxs)("span",{children:[(0,r.jsx)(aa,{children:"esc"})," fechar"]})]})]})}):null}function da(e,o){for(const a of e){if(a.id===o)return a;if(a.children){const e=da(a.children,o);if(e)return e}}}function ma(e){return e.flatMap(e=>e.children?ma(e.children):e.file?[e]:[])}const ga=i.default.div`
  display: flex;
  align-items: center;
  justify-content: center;
  height: 100%;
...
`,wa={en:"Browse the sidebar",pt:"Explora o menu lateral"};function za({title:e,sub:o,lang:a}){return(0,r.jsxs)(ga,{children:[(0,r.jsx)(pa,{}),(0,r.jsx)(ua,{size:500,x:10,y:-10,hue:210,dur:7}),(0,r.jsx)(ua,{size:400,x:60,y:50,hue:270,dur:9}),(0,r.jsx)(ua,{size:300,x:30,y:70,hue:190,dur:6}),(0,r.jsxs)(fa,{children:[(0,r.jsx)(xa,{children:e}),(0,r.jsx)(ha,{children:o}),(0,r.jsxs)(ya,{children:[(0,r.jsx)("svg",{width:13,height:13,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round",children:(0,r.jsx)("polyline",{points:"15 18 9 12 15 6"})}),wa[a]??wa.en]})]})]})}function $a(e,o,a){return"string"==typeof e?e:e[o]??e[a]??Object.values(e)[0]??""}function va({navigation:e,languages:o,defaultLang:a,locale:n,hashPrefix:i,topBarRight:l,welcomeTitle:s="Blog",welcomeSub:c="Notes, guides, and references — pick a topic from the sidebar to get started."}){const d=o?Object.keys(o):[],[m,g]=(d.length,(0,t.useState)(()=>a??d[0]??""));(0,t.useEffect)(()=>{n&&d.includes(n)&&n!==m&&g(n)},[n]);const u=(0,t.useMemo)(()=>o&&m?o[m].navigation:e??{entries:[]},[o,e,m]),p=((0,t.useMemo)(()=>ma(u.entries),[u]),(0,t.useCallback)(e=>{const o=e.match(new RegExp(`^#\\/${i}\\/(.+)$`));if(o)return da(u.entries,o[1])},[u,i])),[f,x]=(0,t.useState)(()=>p(window.location.hash)??null);(0,t.useEffect)(()=>{if(!f)return;const e=da(u.entries,f.id);x(e??null)},[m,u]),(0,t.useEffect)(()=>{const e=()=>{const e=p(window.location.hash);e&&x(e)};return window.addEventListener("hashchange",e),()=>window.removeEventListener("hashchange",e)},[p]);const h=(0,t.useCallback)(e=>{e.file&&(x(e),window.location.hash=`#/${i}/${e.id}`)},[i]),y=(0,t.useMemo)(()=>ma(u.entries),[u]),b=y.findIndex(e=>e.id===f?.id),w=b>0?y[b-1]:null,z=b<y.length-1?y[b+1]:null,[$,v]=(0,t.useState)(!1),[k,A]=(0,t.useState)(null);(0,t.useEffect)(()=>{const e=e=>{(e.metaKey||e.ctrlKey)&&"f"===e.key&&(e.preventDefault(),v(!0))};return window.addEventListener("keydown",e),()=>window.removeEventListener("keydown",e)},[]);const j=f?.label??f?.name??i,S=$a(s,m,a??d[0]??""),T=$a(c,m,a??d[0]??""),B=(0,r.jsxs)(ba,{onClick:()=>v(!0),title:"Pesquisar (Ctrl+F)",children:[(0,r.jsx)(Z.A,{size:14}),(0,r.jsx)("span",{children:"Pesquisar"}),(0,r.jsx)("kbd",{children:"⌘F"})]}),C=(0,r.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:"8px"},children:[B,l]});return(0,r.jsxs)(M,{title:j,activeId:f?.id??null,topBarRight:C,sidebar:(0,r.jsx)(ue,{config:u,activeId:f?.id??null,onSelect:h,hashPrefix:i}),children:[f?.file?(0,r.jsx)(Eo,{file:f.file,prevEntry:w,nextEntry:z,onNavigate:h,scrollToId:k,onScrolled:()=>A(null)}):(0,r.jsx)(za,{title:S,sub:T,lang:m}),(0,r.jsx)(ca,{open:$,onClose:()=>v(!1),entries:u.entries,activeId:f?.id??null,onSelect:(e,o)=>{h(e),A(o??null)}})]})}i.default.div`
  display: flex;
  gap: 4px;
  background: ${n.w4.colors.surface};
  border: 1px solid ${n.w4.colors.border};
