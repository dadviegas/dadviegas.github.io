"use strict";(self.webpackChunk_atlantis_regexlab=self.webpackChunk_atlantis_regexlab||[]).push([[36],{36(e,o,r){r.r(o),r.d(o,{default:()=>N});var n=r(359),t=r(233),l=r(807),s=r(534),a=r(947),i=r(679),d=r(336),c=r(723);const p=[{bg:"rgba(56,139,253,0.25)",border:"#388bfd",label:"#388bfd"},{bg:"rgba(63,185,80,0.25)",border:"#3fb950",label:"#3fb950"},{bg:"rgba(210,153,34,0.25)",border:"#d29922",label:"#d29922"},{bg:"rgba(163,113,247,0.25)",border:"#a371f7",label:"#a371f7"},{bg:"rgba(248,113,113,0.25)",border:"#f87171",label:"#f87171"},{bg:"rgba(34,211,238,0.25)",border:"#22d3ee",label:"#22d3ee"}],g=["g","i","m","s","u"],x=t.default.div`
  display: flex;
...
//# sourceMappingURL=36.c1bacad3293da87056c4.js.map