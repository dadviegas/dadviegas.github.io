"use strict";(self.webpackChunk_atlantis_colorlab=self.webpackChunk_atlantis_colorlab||[]).push([["7074"],{5628(o,e,a){function r(o){let e=o.replace("#","");if(3===e.length){let o=parseInt(e[0]+e[0],16);return{r:o,g:parseInt(e[1]+e[1],16),b:parseInt(e[2]+e[2],16)}}if(6===e.length){let o=parseInt(e.slice(0,2),16);return{r:o,g:parseInt(e.slice(2,4),16),b:parseInt(e.slice(4,6),16)}}return null}function t(o,e,a){return"#"+[o,e,a].map(o=>Math.round(Math.max(0,Math.min(255,o))).toString(16).padStart(2,"0")).join("")}function n(o,e,a){let r=o/255,t=e/255,n=a/255,i=Math.max(r,t,n),l=Math.min(r,t,n),s=(i+l)/2;if(i===l)return{h:0,s:0,l:Math.round(100*s)};let d=i-l;return{h:Math.round(360*(i===r?((t-n)/d+6*(t<n))/6:i===t?((n-r)/d+2)/6:((r-t)/d+4)/6)),s:Math.round(100*(s>.5?d/(2-i-l):d/(i+l))),l:Math.round(100*s)}}function i(o,e,a){let r=a/100,t=e/100*(1-Math.abs(2*r-1)),n=t*(1-Math.abs(o/60%2-1)),i=r-t/2,l=0,s=0,d=0;return o<60?(l=t,s=n,d=0):o<120?(l=n,s=t,d=0):o<180?(l=0,s=t,d=n):o<240?(l=0,s=n,d=t):o<300?(l=n,s=0,d=t):(l=t,s=0,d=n),{r:Math.round((l+i)*255),g:Math.round((s+i)*255),b:Math.round((d+i)*255)}}function l(o,e,a){let r=o=>{let e=o/255;return e<=.04045?e/12.92:Math.pow((e+.055)/1.055,2.4)};return .2126*r(o)+.7152*r(e)+.0722*r(a)}function s(o,e){let a=l(o.r,o.g,o.b),r=l(e.r,e.g,e.b);return parseFloat(((Math.max(a,r)+.05)/(Math.min(a,r)+.05)).toFixed(2))}function d(o,e){return[10,20,30,40,50,60,70,80,90].map(a=>({h:o,s:Math.min(e,90),l:a}))}function c(o,e,a){return{h:(o+180)%360,s:e,l:a}}function p(o,e,a){return[{h:(o+30)%360,s:e,l:a},{h:(o-30+360)%360,s:e,l:a}]}function g(o,e,a){return[{h:o,s:e,l:a},{h:(o+120)%360,s:e,l:a},{h:(o+240)%360,s:e,l:a}]}a.d(e,{E2:()=>r,Hg:()=>c,K6:()=>n,Lt:()=>g,Ob:()=>t,YL:()=>i,eM:()=>s,iW:()=>d,mW:()=>p})},7330(o,e,a){a.d(e,{FlyoutPanel:()=>oP});var r=a(5723),t=a(7991),n=a.n(t),i=a(6859),l=a.n(i),s=a(2799),d=a(255),c=a(1316),p=a(814),g=a(6896),m=a(7902),f=a(3013),x=a(2887),u=a(9510),b=a(9848),h=a(7901),w=a(3045),y=a(3775),$=a(1783),z=a(3539),v=a(9416),k=a(1837),M=a(7167),A=a(4494),T=a(2314),S=a(5751),F=a(9633),j=a(2946),B=a(822),R=a(6720),P=a(7400),H=a(8456),E=a(3317),C=a(2709),L=a(8006),D=a(9301),I=a(7561),K=a(3517),N=a(8207),Y=a(7032),V=a(6949),G=a(8218),_=a(6829),O=a(9591),W=a(5553),J=a(9923),Z=a(2820),U=a(4621),q=a(8479),X=a(2534),Q=a(6673),oo=a(7490),oe=a(9033),oa=a(9038),or=a(5775),ot=a(1365),on=a(2937),oi=a(9821),ol=a(5912),os=a(158),od=a(8641),oc=a(8607),op=a(3249),og=a(1821),om=a(5889),of=a(9655),ox=a(7170),ou=a(9161),ob=a(1849),oh=a(1604),ow=a(3142),oy=a(1187),o$=a(7747),oz=a(2932),ov=a(4525),ok=a(7230),oM=a(2164);let oA={activity:g.A,"a-large-small":m.A,apple:f.A,"arrow-right":x.A,"bar-chart-2":u.A,book:b.A,"book-open":h.A,briefcase:w.A,calendar:y.A,clock:$.A,"circle-dot":z.A,cloud:v.A,compass:k.A,cpu:M.A,droplets:A.A,feather:T.A,file:d.A,"file-text":S.A,folder:F.A,"git-branch":j.A,github:B.A,globe:R.A,grid:P.A,hand:H.A,hash:E.A,heart:C.A,key:L.A,hexagon:D.A,home:I.A,landmark:K.A,layers:N.A,"layout-grid":Y.A,leaf:V.A,lightbulb:G.A,list:_.A,map:O.A,"map-pin":W.A,"message-circle":J.A,"message-square":Z.A,minus:U.A,monitor:q.A,mountain:X.A,package:Q.A,palette:oo.A,"pen-tool":oe.A,"pie-chart":oa.A,plane:or.A,plus:ot.A,ruler:on.A,shirt:oi.A,slash:ol.A,square:os.A,star:od.A,sun:oc.A,terminal:op.A,thermometer:og.A,triangle:om.A,trophy:of.A,truck:ox.A,type:ou.A,users:ob.A,"volume-2":oh.A,watch:ow.A,waves:oy.A,wind:o$.A,wrench:oz.A,x:ov.A,zap:ok.A,bot:oM.A},oT=(0,s.keyframes)`
...
`;function oB({iconKey:o}){let e=o?oA[o]??d.A:d.A;return(0,r.jsx)(e,{size:14,strokeWidth:1.75})}function oR({entries:o,activeId:e,onSelect:a}){return(0,r.jsx)(r.Fragment,{children:o.map(o=>o.children?(0,r.jsx)(n().Fragment,{children:(0,r.jsx)(oR,{entries:o.children,activeId:e,onSelect:a})},o.id):(0,r.jsxs)(oj,{active:e===o.id,onClick:()=>a(o),children:[(0,r.jsx)(oB,{iconKey:o.icon}),o.name]},o.id))})}function oP({activeId:o}){let{flyout:e,scheduleFlyoutClose:a,cancelFlyoutClose:t}=(0,p.c)();if(!e)return null;let n=e.entry.icon?oA[e.entry.icon]??d.A:d.A;return(0,r.jsxs)(oS,{anchorY:e.anchorY,onMouseEnter:t,onMouseLeave:a,children:[(0,r.jsxs)(oF,{children:[(0,r.jsx)(n,{size:13,strokeWidth:2}),e.entry.name]}),(0,r.jsx)(oR,{entries:e.entry.children??[],activeId:o,onSelect:o=>{e.onSelect(o),a()}})]})}},814(o,e,a){a.d(e,{I:()=>t,c:()=>n});var r=a(7991);let t=(0,r.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),n=()=>(0,r.useContext)(t)},5726(o,e,a){a.d(e,{w4:()=>r.w4,cL:()=>p.c,PE:()=>B,Is:()=>L,PL:()=>D});var r=a(1316),t=a(5723),n=a(7991),i=a.n(n),l=a(6859),s=a.n(l);s().button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
...
`,H.A,H.A['pre[class*="language-"]'],l.w4.colors.codeBg,H.A['code[class*="language-"]'],i().div`
  background: ${({bg:o})=>o};
