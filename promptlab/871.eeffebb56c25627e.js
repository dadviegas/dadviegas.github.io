...
`,S=s().main`
  ...
  display: flex;
  flex-direction: column;
`,M=[{char:"A",accent:!1},{char:"t",accent:!1},{char:"l",accent:!1},{char:"a",accent:!0},{char:"n",accent:!0},{char:"t",accent:!0},{char:"i",accent:!0},{char:"s",accent:!0}];function B(){return(0,t.jsx)(h,{onClick:()=>{window.location.hash="#/home"},title:"Home",children:M.map((e,o)=>(0,t.jsx)(z,{index:o,accent:e.accent,children:e.char},o))})}let T="atlantis:sidebar-collapsed";function P({sidebar:e,children:o,topBarRight:n,title:l="Atlantis",activeId:s=null}){let[c,g]=(0,i.useState)(()=>{try{return"true"===localStorage.getItem(T)}catch{return!1}}),[u,p]=(0,i.useState)(null),x=(0,i.useRef)(),h=()=>g(e=>{let o=!e;try{localStorage.setItem(T,String(o))}catch{}return o}),z=r().useMemo(()=>r().lazy(()=>Promise.resolve().then(a.bind(a,7330)).then(e=>({default:e.FlyoutPanel}))),[]);return(0,t.jsx)(m.I.Provider,{value:{collapsed:c,toggle:h,flyout:u,openFlyout:(e,o,a)=>{clearTimeout(x.current),p({entry:e,anchorY:o,onSelect:a})},scheduleFlyoutClose:()=>{x.current=setTimeout(()=>p(null),160)},cancelFlyoutClose:()=>clearTimeout(x.current)},children:(0,t.jsxs)(v,{children:[(0,t.jsxs)(f,{children:[e&&(0,t.jsx)(y,{children:(0,t.jsx)(b,{onClick:h,title:c?"Expand sidebar":"Collapse sidebar",children:(0,t.jsx)(d.A,{size:17})})}),(0,t.jsx)(B,{}),l&&(0,t.jsx)(w,{children:l}),n&&(0,t.jsx)($,{children:n})]}),(0,t.jsxs)(A,{children:[null!=e&&(0,t.jsx)(k,{collapsed:c,children:(0,t.jsx)(j,{children:e})}),(0,t.jsx)(S,{children:o})]}),u&&(0,t.jsx)(r().Suspense,{fallback:null,children:(0,t.jsx)(z,{activeId:s})})]})})}s().div`
  display: grid;
...
`,q=s().div`
  ...
  color: ${n.w4.colors.sidebarTextMuted};
  font-family: ${n.w4.typography.fontFamily};
`;function V({onSave:e,onUpdate:o,onCancel:a,existingDoc:n}){let[r,l]=(0,i.useState)(n?.name??""),s=(0,i.useRef)(null);return(0,i.useEffect)(()=>{s.current?.focus(),n&&s.current?.select()},[n]),(0,t.jsx)(G,{onClick:a,children:(0,t.jsxs)(I,{onClick:e=>e.stopPropagation(),children:[(0,t.jsx)(K,{children:"Save document"}),n&&o&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(q,{children:"Update the current version or save as a new one."}),(0,t.jsxs)(O,{children:[(0,t.jsx)(Y,{onClick:a,children:"Cancel"}),(0,t.jsxs)(Y,{danger:!0,onClick:o,children:['Update "',n.name,'"']})]}),(0,t.jsx)(_,{})]}),(0,t.jsx)(H,{ref:s,value:r,onChange:e=>l(e.target.value),onKeyDown:t=>{"Enter"===t.key&&r.trim()&&(n&&r.trim()===n.name&&o?o():e(r.trim())),"Escape"===t.key&&a()},placeholder:n?"Or save as a new version…":"Give this version a name…",maxLength:80}),(0,t.jsxs)(O,{children:[!n&&(0,t.jsx)(Y,{onClick:a,children:"Cancel"}),(0,t.jsx)(Y,{primary:!0,disabled:!r.trim(),onClick:()=>e(r.trim()),children:"Save as new"})]})]})})}let J=(0,c.keyframes)`
  from { opacity: 0; }
  to   { opacity: 1; }
`,U=(0,c.keyframes)`
...
`;var W=a(5625),Z=a(679),X=a(4872);let Q=s().div`
  position: relative;
`,ee=s().button`
  display: flex;
  align-items: center;
...
`;function ed({appId:e,onLoad:o}){let[a,n]=(0,i.useState)(!1),[r,l]=(0,i.useState)([]),s=(0,i.useRef)(null),c=(0,i.useCallback)(()=>{F.listDocs(e).then(l).catch(()=>{})},[e]);(0,i.useEffect)(()=>{if(!a)return;c();let e=e=>{s.current&&!s.current.contains(e.target)&&n(!1)};return document.addEventListener("mousedown",e),()=>document.removeEventListener("mousedown",e)},[a,c]);let d=async(e,o)=>{e.stopPropagation(),await F.deleteDoc(o),l(e=>e.filter(e=>e.id!==o))};return(0,t.jsxs)(Q,{ref:s,children:[(0,t.jsxs)(ee,{onClick:()=>n(e=>!e),children:[(0,t.jsx)(W.A,{size:14}),"Saved",(0,t.jsx)(Z.A,{size:13,style:{marginLeft:2}})]}),(0,t.jsxs)(eo,{open:a,children:[(0,t.jsx)(ea,{children:"Saved versions"}),(0,t.jsx)(en,{children:0===r.length?(0,t.jsx)(et,{children:"No saved documents yet."}):r.map(e=>{var a;return(0,t.jsxs)(ei,{children:[(0,t.jsxs)(er,{onClick:()=>{o(e.content,e.id,e.name),n(!1)},children:[(0,t.jsx)(el,{children:e.name}),(0,t.jsx)(es,{children:(a=e.savedAt,new Intl.DateTimeFormat(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}).format(new Date(a)))})]}),(0,t.jsx)(ec,{onClick:o=>d(o,e.id),title:"Delete",children:(0,t.jsx)(X.A,{size:13})})]},e.id)})})]})]})}s().div`
