"use strict";(self.webpackChunk_atlantis_earth=self.webpackChunk_atlantis_earth||[]).push([[375],{4914(a,e,n){n.d(e,{FlyoutPanel:()=>h});var o=n(7359),i=n(3233),t=n(7207),l=n(255),r=n(217),m=n(5959),s=n(5185),d=n(5723);const c=t.keyframes`
...
`;function p({iconKey:a}){const e=a?s.t[a]??l.A:l.A;return(0,d.jsx)(e,{size:14,strokeWidth:1.75})}function y({entries:a,activeId:e,onSelect:n}){return(0,d.jsx)(d.Fragment,{children:a.map(a=>a.children?(0,d.jsx)(o.Fragment,{children:(0,d.jsx)(y,{entries:a.children,activeId:e,onSelect:n})},a.id):(0,d.jsxs)(u,{active:e===a.id,onClick:()=>n(a),children:[(0,d.jsx)(p,{iconKey:a.icon}),a.name]},a.id))})}function h({activeId:a}){const{flyout:e,scheduleFlyoutClose:n,cancelFlyoutClose:o}=(0,m.c)();if(!e)return null;const i=e.entry.icon?s.t[e.entry.icon]??l.A:l.A;return(0,d.jsxs)(g,{anchorY:e.anchorY,onMouseEnter:o,onMouseLeave:n,children:[(0,d.jsxs)(f,{children:[(0,d.jsx)(i,{size:13,strokeWidth:2}),e.entry.name]}),(0,d.jsx)(y,{entries:e.entry.children??[],activeId:a,onSelect:a=>{e.onSelect(a),n()}})]})}},5959(a,e,n){n.d(e,{I:()=>i,c:()=>t});var o=n(7359);const i=(0,o.createContext)({collapsed:!1,toggle:()=>{},flyout:null,openFlyout:()=>{},scheduleFlyoutClose:()=>{},cancelFlyoutClose:()=>{}}),t=()=>(0,o.useContext)(i)},5185(a,e,n){n.d(e,{t:()=>U});var o=n(9510),i=n(9038),t=n(8207),l=n(6896),r=n(7901),m=n(9848),s=n(2164),d=n(3775),c=n(3539),g=n(1783),f=n(1837),u=n(2314),p=n(5751),y=n(255),h=n(9633),z=n(2946),x=n(822),b=n(6720),w=n(3317),A=n(2709),v=n(3517),S=n(7032),k=n(6949),$=n(8218),j=n(6829),M=n(5553),B=n(9591),T=n(2820),C=n(4621),E=n(6673),L=n(9033),P=n(1365),F=n(5912),G=n(8641),R=n(3249),N=n(1821),D=n(9161),K=n(1849),I=n(7747),_=n(2932),H=n(4525),V=n(7230);const U={activity:l.A,"bar-chart-2":o.A,book:m.A,"book-open":r.A,calendar:d.A,clock:g.A,"circle-dot":c.A,feather:u.A,"file-text":p.A,globe:b.A,hash:w.A,heart:A.A,landmark:v.A,layers:t.A,leaf:k.A,map:B.A,package:E.A,compass:f.A,"git-branch":z.A,github:x.A,minus:C.A,terminal:R.A,thermometer:N.A,users:K.A,wind:I.A,"pie-chart":i.A,plus:P.A,slash:F.A,star:G.A,zap:V.A,bot:s.A,lightbulb:$.A,"message-square":T.A,wrench:_.A,x:H.A,"layout-grid":S.A,list:j.A,file:y.A,folder:h.A,"map-pin":M.A,"pen-tool":L.A,type:D.A}},906(a,e,n){n.d(e,{rh:()=>I,PE:()=>v,CD:()=>N,qs:()=>Y,$L:()=>H,w3:()=>_,u6:()=>V,w4:()=>o.w});var o=n(217),i=n(7359),t=n(3233),l=n(5723);t.default.button`
  display: flex;
  align-items: center;
  gap: 6px;
  height: 32px;
